...
module FAU ( 
  ...
  aoi21  g041(.a(new_n85_), .b(x08), .c(x26), .O(z3));
  nor2   g042(.a(x26), .b(new_n45_), .O(new_n87_));
  ...
  aoi21  g059(.a(new_n103_), .b(x08), .c(x26), .O(z6));
  ...
  nand3  g096(.a(new_n110_), .b(new_n50_), .c(x31), .O(new_n141_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n140_), .c(new_n53_), .O(new_n148_));
  inv1   g104(.a(x00), .O(new_n149_));
  nor3   g105(.a(new_n126_), .b(new_n125_), .c(new_n53_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n154_), .b(x08), .c(x26), .O(z9));
endmodule
