...
module FAU ( 
  ...
  nand3  g035(.a(new_n60_), .b(new_n45_), .c(x25), .O(new_n80_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n82_), .c(new_n47_), .O(z6));
  ...
  nand3  g061(.a(new_n73_), .b(x18), .c(x14), .O(new_n106_));
  ...
  nor3   g075(.a(new_n119_), .b(new_n73_), .c(x15), .O(new_n120_));
  ...
  aoi22  g084(.a(new_n89_), .b(x29), .c(new_n54_), .d(new_n98_), .O(new_n129_));
  ...
  nand2  g089(.a(new_n133_), .b(new_n73_), .O(new_n134_));
  nand2  g090(.a(new_n73_), .b(x14), .O(new_n135_));
  ...
  nand2  g104(.a(new_n148_), .b(new_n47_), .O(z8));
  aoi21  g105(.a(x31), .b(x30), .c(new_n125_), .O(new_n150_));
  nand2  g106(.a(new_n121_), .b(new_n98_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n125_), .c(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n120_), .b(new_n117_), .c(new_n152_), .O(new_n153_));
  nand4  g109(.a(new_n152_), .b(new_n142_), .c(new_n140_), .d(x33), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n138_), .c(new_n147_), .O(new_n155_));
  aoi21  g111(.a(new_n153_), .b(new_n50_), .c(new_n155_), .O(z9));
endmodule
