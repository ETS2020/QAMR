...
module FAU ( 
  ...
  aoi22  g030(.a(new_n74_), .b(new_n72_), .c(new_n73_), .d(new_n71_), .O(new_n75_));
  nor2   g031(.a(x22), .b(x17), .O(new_n76_));
  oai22  g032(.a(x23), .b(x18), .c(x21), .d(x16), .O(new_n77_));
  nor2   g033(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g034(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  and2   g035(.a(new_n79_), .b(new_n62_), .O(new_n80_));
  nand2  g036(.a(x25), .b(x01), .O(new_n81_));
  nor2   g037(.a(new_n81_), .b(x26), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n80_), .c(new_n70_), .O(new_n83_));
  ...
  nand4  g044(.a(new_n88_), .b(new_n87_), .c(new_n82_), .d(new_n80_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z4));
  nand2  g046(.a(new_n82_), .b(new_n80_), .O(new_n91_));
  ...
  inv1   g053(.a(new_n79_), .O(new_n98_));
  nand2  g054(.a(new_n73_), .b(new_n71_), .O(new_n99_));
  ...
  aoi21  g058(.a(x03), .b(x02), .c(new_n81_), .O(new_n103_));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n117_), .c(new_n71_), .O(new_n122_));
  ...
  aoi22  g089(.a(new_n88_), .b(x29), .c(new_n54_), .d(new_n100_), .O(new_n134_));
  ...
  nand2  g094(.a(new_n138_), .b(new_n72_), .O(new_n139_));
  ...
  nand2  g102(.a(new_n45_), .b(x00), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n132_), .c(new_n147_), .O(z8));
  nand3  g104(.a(new_n130_), .b(new_n126_), .c(new_n100_), .O(new_n149_));
  nand3  g105(.a(new_n101_), .b(new_n88_), .c(x31), .O(new_n150_));
