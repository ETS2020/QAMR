...
module FAU ( 
  ...
  oai21  g046(.a(new_n90_), .b(new_n83_), .c(new_n45_), .O(z4));
  ...
  oai21  g051(.a(new_n95_), .b(new_n83_), .c(new_n45_), .O(z5));
  ...
  oai21  g056(.a(new_n100_), .b(new_n83_), .c(new_n45_), .O(z6));
  xor2a  g057(.a(new_n97_), .b(x31), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n82_), .c(new_n79_), .O(new_n103_));
  xnor2a g059(.a(new_n103_), .b(new_n45_), .O(z7));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n113_), .c(new_n73_), .O(new_n118_));
  ...
  nand2  g080(.a(new_n124_), .b(new_n98_), .O(new_n125_));
  ...
  aoi22  g085(.a(new_n89_), .b(x29), .c(new_n50_), .d(new_n98_), .O(new_n130_));
  ...
  nand2  g091(.a(new_n106_), .b(x14), .O(new_n136_));
  ...
  nand2  g107(.a(new_n122_), .b(new_n98_), .O(new_n152_));
  ...
  aoi21  g112(.a(new_n154_), .b(new_n47_), .c(new_n156_), .O(z9));
endmodule
