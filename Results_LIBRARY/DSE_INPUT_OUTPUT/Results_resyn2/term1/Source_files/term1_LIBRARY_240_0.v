...
module FAU ( 
  ...
  and2   g039(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(new_n96_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n46_), .O(z6));
  xor2a  g062(.a(new_n104_), .b(x31), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n96_), .c(new_n45_), .O(z7));
  ...
  nor3   g080(.a(new_n124_), .b(new_n77_), .c(x15), .O(new_n125_));
  ...
  nand2  g085(.a(new_n91_), .b(x29), .O(new_n130_));
  ...
  aoi22  g089(.a(new_n91_), .b(x29), .c(new_n53_), .d(new_n102_), .O(new_n134_));
  ...
  nand2  g094(.a(new_n138_), .b(new_n77_), .O(new_n139_));
  ...
  nor3   g109(.a(new_n143_), .b(new_n142_), .c(new_n49_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n151_), .c(new_n141_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  aoi21  g112(.a(new_n152_), .b(new_n49_), .c(new_n156_), .O(z9));
endmodule
