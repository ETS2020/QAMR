...
module FAU ( 
  ...
  nand2  g051(.a(x30), .b(x09), .O(new_n96_));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n82_), .c(new_n46_), .O(z7));
  ...
  aoi21  g083(.a(new_n126_), .b(new_n45_), .c(new_n127_), .O(new_n128_));
  ...
  nor4   g097(.a(new_n141_), .b(new_n46_), .c(x32), .d(new_n120_), .O(new_n142_));
