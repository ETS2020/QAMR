...
module FAU ( 
  ...
  aoi22  g016(.a(new_n60_), .b(new_n59_), .c(new_n49_), .d(x01), .O(new_n61_));
  nor2   g017(.a(new_n61_), .b(new_n54_), .O(new_n62_));
  nand2  g018(.a(new_n61_), .b(new_n54_), .O(new_n63_));
  nand3  g019(.a(new_n63_), .b(new_n45_), .c(x08), .O(new_n64_));
  oai21  g020(.a(new_n64_), .b(new_n62_), .c(new_n47_), .O(z2));
  ...
  nand2  g040(.a(new_n84_), .b(new_n78_), .O(new_n85_));
  nor2   g041(.a(new_n84_), .b(new_n78_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n77_), .c(new_n47_), .O(z4));
  nand4  g045(.a(new_n81_), .b(new_n76_), .c(new_n66_), .d(new_n47_), .O(new_n90_));
  ...
  nand3  g059(.a(new_n103_), .b(new_n86_), .c(x29), .O(new_n104_));
  nand2  g060(.a(new_n92_), .b(x31), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n104_), .c(new_n91_), .O(z7));
  aoi21  g062(.a(new_n84_), .b(new_n78_), .c(new_n93_), .O(new_n107_));
  ...
  nand4  g069(.a(x19), .b(new_n113_), .c(x13), .d(new_n45_), .O(new_n114_));
  ...
  nor4   g081(.a(new_n125_), .b(new_n70_), .c(new_n113_), .d(x15), .O(new_n126_));
  ...
  nand2  g089(.a(new_n70_), .b(x14), .O(new_n134_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n70_), .c(new_n113_), .O(new_n141_));
  ...
  nand3  g105(.a(new_n149_), .b(x19), .c(new_n113_), .O(new_n150_));
  ...
  aoi21  g116(.a(new_n160_), .b(new_n148_), .c(new_n113_), .O(new_n161_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n113_), .c(new_n166_), .O(new_n168_));
