...
module FAU ( 
  ...
  aoi21  g043(.a(new_n87_), .b(x00), .c(x26), .O(z4));
  nand3  g044(.a(new_n80_), .b(new_n46_), .c(x00), .O(new_n89_));
  ...
  nand3  g049(.a(new_n93_), .b(new_n92_), .c(new_n90_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z5));
  inv1   g051(.a(x30), .O(new_n96_));
  nand2  g052(.a(new_n93_), .b(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n84_), .b(x30), .c(x29), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n97_), .c(new_n90_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z6));
  xor2a  g056(.a(new_n98_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n90_), .O(z7));
  ...
  aoi21  g084(.a(new_n83_), .b(new_n70_), .c(new_n91_), .O(new_n129_));
  aoi21  g085(.a(new_n52_), .b(new_n96_), .c(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n115_), .b(x16), .c(x15), .O(new_n131_));
  ...
  nand2  g090(.a(new_n105_), .b(x14), .O(new_n135_));
  ...
  aoi21  g101(.a(new_n130_), .b(new_n128_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n127_), .c(x26), .O(z8));
  nand2  g103(.a(x31), .b(x30), .O(new_n148_));
  aoi21  g104(.a(new_n121_), .b(new_n96_), .c(new_n129_), .O(new_n149_));
  aoi21  g105(.a(new_n148_), .b(new_n129_), .c(new_n149_), .O(new_n150_));
  oai21  g106(.a(new_n120_), .b(new_n117_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n49_), .O(new_n152_));
  nand4  g108(.a(new_n150_), .b(new_n142_), .c(new_n140_), .d(x33), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n138_), .c(new_n152_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(x00), .c(x26), .O(z9));
endmodule
