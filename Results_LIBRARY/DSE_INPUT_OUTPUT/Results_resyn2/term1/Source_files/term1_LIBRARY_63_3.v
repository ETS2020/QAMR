...
module FAU ( 
  ...
  nand4  g044(.a(new_n88_), .b(new_n87_), .c(new_n81_), .d(new_n45_), .O(new_n89_));
  ...
  oai21  g050(.a(new_n94_), .b(new_n82_), .c(new_n48_), .O(z5));
  inv1   g051(.a(x30), .O(new_n96_));
  oai21  g052(.a(new_n91_), .b(new_n96_), .c(new_n45_), .O(new_n97_));
  ...
  xor2a  g056(.a(new_n97_), .b(new_n46_), .O(new_n101_));
  oai21  g057(.a(new_n81_), .b(new_n47_), .c(new_n101_), .O(z7));
  ...
  nor2   g080(.a(new_n55_), .b(x26), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(x30), .c(new_n124_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand3  g084(.a(new_n118_), .b(x16), .c(x15), .O(new_n129_));
  oai21  g085(.a(new_n115_), .b(x16), .c(x19), .O(new_n130_));
  ...
  aoi21  g090(.a(new_n105_), .b(x14), .c(new_n129_), .O(new_n135_));
  aoi21  g091(.a(new_n119_), .b(new_n103_), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n134_), .c(new_n131_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n46_), .c(new_n125_), .O(new_n138_));
  nand2  g094(.a(new_n122_), .b(x30), .O(new_n139_));
  inv1   g095(.a(new_n124_), .O(new_n140_));
  aoi21  g096(.a(new_n126_), .b(new_n96_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n138_), .c(new_n128_), .O(new_n143_));
  ...
  nand3  g102(.a(new_n124_), .b(new_n46_), .c(new_n96_), .O(new_n147_));
  nand3  g103(.a(new_n140_), .b(x31), .c(x30), .O(new_n148_));
  and2   g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  aoi21  g105(.a(new_n46_), .b(x26), .c(new_n51_), .O(new_n150_));
  ...
  nand2  g112(.a(new_n156_), .b(new_n48_), .O(z9));
endmodule
