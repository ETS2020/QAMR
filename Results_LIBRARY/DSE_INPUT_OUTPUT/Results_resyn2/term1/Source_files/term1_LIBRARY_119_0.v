...
module FAU ( 
  ...
  nor2   g000(.a(x28), .b(x26), .O(new_n45_));
  ...
  nand3  g037(.a(new_n81_), .b(x28), .c(new_n79_), .O(new_n82_));
  or2    g038(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(x28), .c(x26), .O(z3));
  ...
  nand2  g049(.a(new_n89_), .b(new_n79_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n93_), .c(new_n91_), .d(new_n81_), .O(new_n95_));
  nor2   g051(.a(new_n95_), .b(new_n78_), .O(z5));
  aoi21  g052(.a(x03), .b(x02), .c(new_n80_), .O(new_n97_));
  inv1   g053(.a(x30), .O(new_n98_));
  nand2  g054(.a(new_n91_), .b(new_n98_), .O(new_n99_));
  nand2  g055(.a(new_n90_), .b(x30), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n99_), .c(new_n97_), .d(new_n77_), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(x28), .c(x26), .O(z6));
  inv1   g058(.a(new_n77_), .O(new_n103_));
  nor2   g059(.a(new_n100_), .b(x31), .O(new_n104_));
  nand2  g060(.a(new_n100_), .b(x31), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n97_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n92_), .c(new_n85_), .O(z7));
  ...
  nand3  g069(.a(new_n71_), .b(x18), .c(x14), .O(new_n114_));
  ...
  nor3   g083(.a(new_n127_), .b(new_n71_), .c(x15), .O(new_n128_));
  aoi21  g084(.a(new_n125_), .b(x15), .c(new_n128_), .O(new_n129_));
  or2    g085(.a(new_n129_), .b(new_n112_), .O(new_n130_));
  inv1   g086(.a(new_n127_), .O(new_n131_));
  nand2  g087(.a(new_n122_), .b(new_n121_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(x15), .c(new_n131_), .O(new_n133_));
  nand2  g089(.a(x18), .b(x12), .O(new_n134_));
  oai21  g090(.a(x18), .b(x13), .c(x17), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g092(.a(new_n71_), .b(x14), .O(new_n137_));
  nand3  g093(.a(new_n126_), .b(x16), .c(x15), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g096(.a(new_n138_), .b(new_n71_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(new_n136_), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n133_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n111_), .c(x32), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n93_), .c(x00), .O(new_n145_));
  aoi21  g101(.a(new_n130_), .b(new_n52_), .c(new_n145_), .O(z8));
  nor3   g102(.a(x31), .b(x30), .c(x29), .O(new_n147_));
  nor2   g103(.a(new_n98_), .b(new_n89_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(x31), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n129_), .c(new_n48_), .O(new_n150_));
  inv1   g106(.a(x00), .O(new_n151_));
  nor2   g107(.a(new_n149_), .b(new_n48_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n143_), .c(new_n151_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(x28), .c(x26), .O(z9));
endmodule
