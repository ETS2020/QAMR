...
module FAU ( 
  ...
  nor2   g002(.a(new_n46_), .b(x07), .O(new_n47_));
  ...
  inv1   g018(.a(new_n47_), .O(new_n63_));
  nand3  g019(.a(new_n63_), .b(new_n62_), .c(x08), .O(new_n64_));
  nor2   g020(.a(new_n64_), .b(new_n61_), .O(z2));
  ...
  aoi21  g032(.a(x03), .b(x02), .c(new_n47_), .O(new_n77_));
  ...
  oai21  g049(.a(new_n54_), .b(new_n56_), .c(new_n80_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  and2   g051(.a(new_n95_), .b(new_n76_), .O(new_n96_));
  nand3  g052(.a(new_n84_), .b(x30), .c(x29), .O(new_n97_));
  nand2  g053(.a(new_n91_), .b(new_n46_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n63_), .O(z6));
  xor2a  g056(.a(new_n97_), .b(x31), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n96_), .c(new_n47_), .O(z7));
  ...
  aoi21  g063(.a(new_n107_), .b(x19), .c(new_n104_), .O(new_n108_));
  ...
  nand2  g068(.a(new_n70_), .b(x14), .O(new_n113_));
  ...
  nor2   g078(.a(new_n122_), .b(x30), .O(new_n123_));
  oai21  g079(.a(new_n121_), .b(new_n46_), .c(x31), .O(new_n124_));
  or2    g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n120_), .c(new_n48_), .O(new_n126_));
  inv1   g082(.a(x17), .O(new_n127_));
  nand3  g083(.a(new_n70_), .b(x18), .c(x14), .O(new_n128_));
  ...
  nand3  g092(.a(new_n136_), .b(new_n105_), .c(x11), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n134_), .c(new_n115_), .O(new_n138_));
  nand3  g094(.a(x16), .b(new_n115_), .c(x10), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  inv1   g096(.a(x07), .O(new_n141_));
  nor2   g097(.a(new_n46_), .b(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n122_), .c(new_n45_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n124_), .O(new_n144_));
  ...
  oai21  g104(.a(new_n118_), .b(new_n108_), .c(new_n63_), .O(new_n149_));
  inv1   g105(.a(x31), .O(new_n150_));
  nand2  g106(.a(new_n123_), .b(new_n150_), .O(new_n151_));
  nor2   g107(.a(new_n121_), .b(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n141_), .c(x30), .O(new_n153_));
  ...
  oai21  g114(.a(new_n140_), .b(new_n138_), .c(new_n158_), .O(new_n159_));
