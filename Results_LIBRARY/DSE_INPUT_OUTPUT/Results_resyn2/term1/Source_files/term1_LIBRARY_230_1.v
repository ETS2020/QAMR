...
module FAU ( 
  ...
  nand3  g031(.a(new_n56_), .b(new_n45_), .c(x25), .O(new_n76_));
  ...
  nor2   g036(.a(new_n80_), .b(new_n68_), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  nand2  g038(.a(new_n80_), .b(new_n68_), .O(new_n83_));
  ...
  nand2  g050(.a(new_n94_), .b(new_n47_), .O(z6));
  xor2a  g051(.a(new_n91_), .b(x31), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n77_), .O(new_n97_));
  xor2a  g053(.a(new_n97_), .b(new_n46_), .O(z7));
  ...
  nor2   g065(.a(new_n103_), .b(new_n100_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(x19), .c(new_n109_), .d(x11), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n108_), .c(new_n99_), .O(new_n112_));
  nand3  g068(.a(x18), .b(x16), .c(x10), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x17), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n101_), .c(x15), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(x32), .b(new_n117_), .O(new_n118_));
  oai21  g074(.a(new_n116_), .b(new_n112_), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n92_), .O(new_n120_));
  nand2  g076(.a(new_n83_), .b(x29), .O(new_n121_));
  aoi21  g077(.a(new_n51_), .b(x30), .c(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g079(.a(new_n119_), .b(x30), .O(new_n124_));
  aoi22  g080(.a(new_n83_), .b(x29), .c(new_n51_), .d(new_n92_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g082(.a(new_n101_), .b(x14), .O(new_n127_));
  ...
  oai21  g087(.a(new_n130_), .b(new_n127_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(x18), .b(x11), .O(new_n133_));
  oai21  g089(.a(x18), .b(x13), .c(x16), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n117_), .O(new_n135_));
  aoi22  g091(.a(new_n128_), .b(new_n100_), .c(new_n113_), .d(new_n99_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n135_), .c(new_n132_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x32), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n126_), .c(new_n123_), .O(new_n139_));
  inv1   g095(.a(x00), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  inv1   g098(.a(x12), .O(new_n143_));
  nand2  g099(.a(x16), .b(x15), .O(new_n144_));
  nand3  g100(.a(x32), .b(new_n100_), .c(x00), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(new_n45_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n142_), .O(z8));
  inv1   g104(.a(x33), .O(new_n149_));
  aoi21  g105(.a(x31), .b(x30), .c(new_n121_), .O(new_n150_));
  nand2  g106(.a(new_n117_), .b(new_n92_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n121_), .c(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n116_), .b(new_n112_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n115_), .b(new_n99_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n152_), .c(x33), .O(new_n155_));
  nand2  g111(.a(x18), .b(x12), .O(new_n156_));
  oai21  g112(.a(x18), .b(x13), .c(x17), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n109_), .O(new_n158_));
  nand2  g114(.a(new_n110_), .b(x11), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(new_n132_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n155_), .c(new_n141_), .O(new_n162_));
  aoi21  g118(.a(new_n153_), .b(new_n149_), .c(new_n162_), .O(z9));
endmodule
