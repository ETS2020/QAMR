...
module FAU ( 
  ...
  nand2  g051(.a(new_n95_), .b(new_n57_), .O(z6));
  xor2a  g052(.a(x31), .b(x30), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n84_), .c(x29), .O(new_n98_));
  nand2  g054(.a(new_n89_), .b(x31), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n98_), .c(new_n80_), .O(z7));
  ...
  nor3   g073(.a(new_n117_), .b(new_n104_), .c(x15), .O(new_n118_));
  oai21  g074(.a(x28), .b(x27), .c(x29), .O(new_n119_));
  xor2a  g075(.a(new_n119_), .b(x30), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n45_), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n126_), .b(x16), .c(new_n114_), .O(new_n127_));
  nand2  g083(.a(new_n104_), .b(x14), .O(new_n128_));
  ...
  nand2  g087(.a(new_n117_), .b(new_n102_), .O(new_n132_));
  nand2  g088(.a(new_n129_), .b(new_n104_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n127_), .O(new_n135_));
  nor2   g091(.a(new_n120_), .b(new_n101_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n123_), .O(new_n137_));
  nand2  g093(.a(new_n78_), .b(x00), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n137_), .b(new_n45_), .c(new_n139_), .O(new_n140_));
  aoi21  g096(.a(new_n122_), .b(new_n101_), .c(new_n140_), .O(z8));
  inv1   g097(.a(new_n97_), .O(new_n142_));
  and2   g098(.a(new_n120_), .b(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n118_), .b(new_n116_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n54_), .O(new_n145_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n57_), .O(z9));
endmodule
