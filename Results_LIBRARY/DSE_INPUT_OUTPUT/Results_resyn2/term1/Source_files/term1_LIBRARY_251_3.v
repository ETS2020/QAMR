...
module FAU ( 
  ...
  nand2  g034(.a(new_n78_), .b(new_n48_), .O(z3));
  nand2  g035(.a(x28), .b(x27), .O(new_n80_));
  inv1   g036(.a(x28), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n69_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n80_), .c(new_n77_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n48_), .O(z4));
  inv1   g040(.a(new_n80_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(x29), .O(new_n86_));
  inv1   g042(.a(x29), .O(new_n87_));
  aoi21  g043(.a(new_n80_), .b(new_n87_), .c(new_n47_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n86_), .c(new_n77_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z5));
  nand2  g046(.a(new_n72_), .b(x19), .O(new_n91_));
  nand2  g047(.a(new_n80_), .b(new_n45_), .O(new_n92_));
  aoi21  g048(.a(new_n92_), .b(x29), .c(new_n46_), .O(new_n93_));
  aoi21  g049(.a(x30), .b(new_n45_), .c(new_n86_), .O(new_n94_));
  aoi22  g050(.a(new_n94_), .b(new_n73_), .c(new_n93_), .d(new_n91_), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n75_), .c(new_n48_), .O(z6));
  inv1   g052(.a(x31), .O(new_n97_));
  inv1   g053(.a(new_n86_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n97_), .c(x30), .O(new_n99_));
  nand2  g055(.a(new_n98_), .b(x30), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(x31), .c(new_n47_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n77_), .O(z7));
  nand2  g058(.a(new_n74_), .b(x00), .O(new_n103_));
  ...
  xor2a  g079(.a(new_n123_), .b(new_n46_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n52_), .c(x31), .O(new_n125_));
  ...
  nand2  g085(.a(new_n106_), .b(x14), .O(new_n130_));
  nand4  g086(.a(new_n119_), .b(new_n130_), .c(x16), .d(x15), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n129_), .c(new_n127_), .O(new_n132_));
  nand2  g088(.a(x18), .b(x12), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n105_), .O(new_n134_));
  inv1   g090(.a(x13), .O(new_n135_));
  nand2  g091(.a(new_n108_), .b(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n134_), .c(new_n124_), .d(x31), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n132_), .c(x32), .O(new_n138_));
  oai21  g094(.a(new_n125_), .b(new_n122_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n104_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n48_), .O(z8));
  inv1   g097(.a(x33), .O(new_n142_));
  xor2a  g098(.a(new_n123_), .b(new_n97_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n124_), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n122_), .c(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n144_), .b(new_n136_), .c(new_n134_), .d(x33), .O(new_n147_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n48_), .O(z9));
endmodule
