...
module FAU ( 
  ...
  nand2  g046(.a(new_n86_), .b(new_n45_), .O(new_n91_));
  inv1   g047(.a(new_n86_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(x30), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n91_), .c(new_n77_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n67_), .O(z6));
  ...
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n77_), .d(new_n67_), .O(z7));
  inv1   g056(.a(x00), .O(new_n101_));
  nor2   g057(.a(x26), .b(new_n101_), .O(new_n102_));
  inv1   g058(.a(x32), .O(new_n103_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n108_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n117_), .c(new_n105_), .O(new_n120_));
  nor2   g076(.a(new_n97_), .b(new_n45_), .O(new_n121_));
  oai21  g077(.a(new_n120_), .b(new_n110_), .c(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n103_), .O(new_n123_));
  aoi21  g079(.a(new_n80_), .b(new_n66_), .c(new_n87_), .O(new_n124_));
  aoi21  g080(.a(x32), .b(x30), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g082(.a(x32), .b(x30), .O(new_n127_));
  nand3  g083(.a(new_n118_), .b(new_n108_), .c(x11), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n117_), .c(new_n105_), .O(new_n129_));
  nand3  g085(.a(new_n103_), .b(x31), .c(new_n45_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n129_), .b(new_n110_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n108_), .b(x15), .O(new_n137_));
  ...
  oai21  g098(.a(new_n139_), .b(new_n136_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n139_), .b(new_n111_), .O(new_n144_));
  inv1   g100(.a(x11), .O(new_n145_));
  inv1   g101(.a(new_n108_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(new_n104_), .O(new_n147_));
  nand3  g103(.a(new_n108_), .b(x16), .c(x10), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n105_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n147_), .c(new_n144_), .d(x31), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n143_), .c(x32), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n134_), .c(new_n126_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n102_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n67_), .O(z8));
  inv1   g110(.a(new_n124_), .O(new_n155_));
  nor2   g111(.a(x31), .b(x30), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n138_), .c(new_n155_), .d(new_n118_), .O(new_n157_));
  oai21  g113(.a(new_n155_), .b(new_n122_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g117(.a(new_n156_), .b(x16), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n124_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n161_), .c(x33), .O(new_n164_));
  nand2  g120(.a(new_n146_), .b(new_n104_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n149_), .c(new_n144_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n143_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n46_), .O(new_n168_));
  nand2  g124(.a(new_n124_), .b(x31), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(x30), .c(x11), .O(new_n170_));
  oai21  g126(.a(x16), .b(x11), .c(new_n97_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n124_), .c(new_n45_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n170_), .c(x33), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n168_), .c(new_n102_), .O(new_n174_));
  aoi21  g130(.a(new_n164_), .b(new_n159_), .c(new_n174_), .O(z9));
endmodule
