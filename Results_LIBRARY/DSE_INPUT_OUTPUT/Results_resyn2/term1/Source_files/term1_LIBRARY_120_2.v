...
module FAU ( 
  ...
  nand3  g034(.a(new_n78_), .b(new_n76_), .c(new_n47_), .O(new_n79_));
  ...
  nand2  g044(.a(new_n78_), .b(new_n76_), .O(new_n89_));
  inv1   g045(.a(x30), .O(new_n90_));
  nand2  g046(.a(new_n84_), .b(x29), .O(new_n91_));
  oai21  g047(.a(new_n83_), .b(new_n68_), .c(new_n45_), .O(new_n92_));
  oai21  g048(.a(new_n91_), .b(new_n90_), .c(new_n92_), .O(new_n93_));
  aoi21  g049(.a(new_n89_), .b(new_n47_), .c(new_n93_), .O(z5));
  nand4  g050(.a(new_n91_), .b(new_n78_), .c(new_n76_), .d(x30), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z6));
  nand2  g052(.a(new_n89_), .b(new_n47_), .O(new_n97_));
  inv1   g053(.a(x31), .O(new_n98_));
  aoi21  g054(.a(new_n91_), .b(new_n98_), .c(new_n46_), .O(new_n99_));
  oai21  g055(.a(new_n91_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n97_), .O(z7));
  ...
  and2   g071(.a(new_n115_), .b(x15), .O(new_n116_));
  nor2   g072(.a(new_n105_), .b(new_n102_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x16), .c(x10), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n103_), .c(x15), .O(new_n119_));
  oai21  g075(.a(new_n85_), .b(new_n45_), .c(x31), .O(new_n120_));
  or2    g076(.a(new_n120_), .b(x32), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n119_), .b(new_n116_), .c(new_n122_), .O(new_n123_));
  oai21  g079(.a(new_n113_), .b(x16), .c(x15), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n118_), .O(new_n125_));
  nand3  g081(.a(new_n117_), .b(x16), .c(x15), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n103_), .O(new_n127_));
  inv1   g083(.a(x14), .O(new_n128_));
  nor2   g084(.a(x19), .b(new_n128_), .O(new_n129_));
  or2    g085(.a(new_n126_), .b(new_n129_), .O(new_n130_));
  nand2  g086(.a(x18), .b(x12), .O(new_n131_));
  oai21  g087(.a(x18), .b(x13), .c(x17), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n120_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n130_), .c(new_n127_), .d(new_n125_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(x32), .c(new_n90_), .O(new_n135_));
  inv1   g091(.a(x00), .O(new_n136_));
  nor2   g092(.a(x26), .b(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n51_), .b(x29), .c(new_n90_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  aoi21  g095(.a(new_n135_), .b(new_n123_), .c(new_n139_), .O(z8));
  inv1   g096(.a(x33), .O(new_n141_));
  aoi21  g097(.a(new_n115_), .b(x15), .c(new_n119_), .O(new_n142_));
  oai21  g098(.a(x31), .b(new_n90_), .c(new_n120_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(new_n144_));
  oai21  g100(.a(new_n126_), .b(new_n129_), .c(new_n127_), .O(new_n145_));
  aoi21  g101(.a(new_n124_), .b(new_n118_), .c(new_n145_), .O(new_n146_));
  inv1   g102(.a(new_n137_), .O(new_n147_));
  nand2  g103(.a(new_n132_), .b(new_n131_), .O(new_n148_));
  oai21  g104(.a(new_n85_), .b(new_n98_), .c(x29), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n148_), .c(x33), .O(new_n150_));
  nor2   g106(.a(new_n150_), .b(new_n143_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n146_), .c(new_n147_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n47_), .O(z9));
endmodule
