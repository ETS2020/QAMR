...
module FAU ( 
  ...
  nand2  g049(.a(new_n84_), .b(new_n47_), .O(new_n94_));
  ...
  aoi21  g061(.a(new_n80_), .b(new_n77_), .c(new_n83_), .O(new_n106_));
  xor2a  g062(.a(new_n101_), .b(x31), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n106_), .c(new_n46_), .O(z7));
  ...
  nor2   g074(.a(new_n111_), .b(new_n113_), .O(new_n119_));
  and2   g075(.a(x16), .b(x10), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n119_), .c(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n54_), .b(x31), .O(new_n122_));
  aoi21  g078(.a(new_n121_), .b(new_n118_), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n88_), .b(x29), .O(new_n124_));
  aoi21  g080(.a(new_n54_), .b(x30), .c(new_n124_), .O(new_n125_));
  oai21  g081(.a(new_n123_), .b(x30), .c(new_n125_), .O(new_n126_));
  aoi22  g082(.a(new_n88_), .b(x29), .c(new_n54_), .d(new_n102_), .O(new_n127_));
  oai21  g083(.a(new_n123_), .b(new_n102_), .c(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n111_), .b(x14), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(x17), .c(x16), .d(x15), .O(new_n130_));
  aoi21  g086(.a(x17), .b(x11), .c(x16), .O(new_n131_));
  aoi21  g087(.a(x17), .b(x16), .c(x19), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nor2   g089(.a(x17), .b(x12), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n130_), .d(x31), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x32), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n128_), .c(new_n126_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x18), .O(new_n139_));
  nand3  g095(.a(new_n120_), .b(new_n119_), .c(x18), .O(new_n140_));
  and2   g096(.a(new_n140_), .b(new_n45_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n109_), .O(z8));
  nand2  g099(.a(new_n141_), .b(x33), .O(new_n144_));
  xor2a  g100(.a(new_n124_), .b(x30), .O(new_n145_));
  xor2a  g101(.a(x31), .b(x30), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  aoi21  g104(.a(new_n121_), .b(new_n118_), .c(new_n148_), .O(new_n149_));
  nor3   g105(.a(new_n146_), .b(new_n134_), .c(new_n50_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n145_), .c(new_n133_), .d(new_n130_), .O(new_n151_));
  and2   g107(.a(new_n151_), .b(x18), .O(new_n152_));
  oai21  g108(.a(new_n149_), .b(x33), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n144_), .c(new_n109_), .O(z9));
endmodule
