...
module FAU ( 
  ...
  nand3  g037(.a(new_n60_), .b(new_n81_), .c(x25), .O(new_n82_));
  aoi21  g038(.a(new_n80_), .b(new_n76_), .c(new_n82_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n58_), .c(new_n73_), .O(new_n84_));
  ...
  nand2  g051(.a(new_n95_), .b(new_n58_), .O(z5));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n83_), .c(new_n47_), .O(z7));
  ...
  nand3  g084(.a(new_n128_), .b(new_n115_), .c(new_n114_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n125_), .c(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n117_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x32), .O(new_n132_));
  inv1   g088(.a(x16), .O(new_n133_));
  nand3  g089(.a(new_n119_), .b(x17), .c(x14), .O(new_n134_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n140_), .c(x06), .O(new_n143_));
  oai21  g099(.a(new_n110_), .b(x18), .c(new_n54_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n116_), .O(new_n145_));
  ...
  nand2  g104(.a(new_n110_), .b(new_n104_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n46_), .O(new_n150_));
  nand2  g106(.a(new_n128_), .b(new_n104_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n125_), .c(new_n45_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x33), .O(new_n154_));
  nand2  g110(.a(x33), .b(new_n97_), .O(new_n155_));
  nand2  g111(.a(new_n142_), .b(new_n140_), .O(new_n156_));
  nand3  g112(.a(x31), .b(x30), .c(x18), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n156_), .c(new_n50_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n155_), .c(x06), .O(new_n160_));
  nand2  g116(.a(new_n110_), .b(new_n50_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n101_), .c(new_n155_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n46_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n113_), .O(new_n164_));
  nand2  g120(.a(x33), .b(x30), .O(new_n165_));
  nand3  g121(.a(new_n102_), .b(new_n97_), .c(x18), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n156_), .c(new_n50_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n165_), .c(x06), .O(new_n169_));
  oai21  g125(.a(new_n161_), .b(new_n103_), .c(new_n165_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n46_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n112_), .O(new_n172_));
  oai22  g128(.a(new_n172_), .b(new_n169_), .c(new_n164_), .d(new_n160_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n154_), .c(new_n147_), .O(z9));
endmodule
