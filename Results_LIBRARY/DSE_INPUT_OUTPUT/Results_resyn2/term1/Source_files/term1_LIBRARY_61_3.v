...
module FAU ( 
  ...
  xor2a  g017(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  oai21  g018(.a(new_n62_), .b(x01), .c(new_n57_), .O(new_n63_));
  xor2a  g019(.a(new_n63_), .b(new_n56_), .O(new_n64_));
  nor4   g020(.a(new_n64_), .b(new_n47_), .c(x09), .d(new_n55_), .O(z2));
  ...
  nand3  g043(.a(new_n87_), .b(new_n86_), .c(new_n80_), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n77_), .c(new_n48_), .O(z4));
  inv1   g045(.a(new_n81_), .O(new_n90_));
  nand2  g046(.a(new_n86_), .b(new_n46_), .O(new_n91_));
  nand2  g047(.a(new_n85_), .b(x29), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(z5));
  nand3  g050(.a(new_n85_), .b(x30), .c(x29), .O(new_n95_));
  nand2  g051(.a(x30), .b(new_n45_), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n92_), .c(new_n79_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n77_), .c(new_n48_), .O(z6));
  ...
  nand3  g059(.a(new_n70_), .b(x18), .c(x14), .O(new_n104_));
  inv1   g060(.a(x18), .O(new_n105_));
  nand3  g061(.a(x19), .b(new_n105_), .c(x13), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  ...
  nor2   g071(.a(new_n105_), .b(new_n103_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x16), .c(x10), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n70_), .c(x15), .O(new_n118_));
  ...
  oai21  g078(.a(x32), .b(x30), .c(new_n122_), .O(new_n123_));
  aoi21  g079(.a(new_n121_), .b(x30), .c(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n113_), .b(x16), .c(x15), .O(new_n125_));
  inv1   g081(.a(x14), .O(new_n126_));
  nor2   g082(.a(x19), .b(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n116_), .b(x16), .c(x15), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n70_), .O(new_n129_));
  oai21  g085(.a(new_n128_), .b(new_n127_), .c(new_n129_), .O(new_n130_));
  aoi21  g086(.a(new_n125_), .b(new_n117_), .c(new_n130_), .O(new_n131_));
  aoi21  g087(.a(x18), .b(x12), .c(x17), .O(new_n132_));
  nor2   g088(.a(x18), .b(x13), .O(new_n133_));
  nor3   g089(.a(new_n133_), .b(new_n132_), .c(new_n119_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(new_n52_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n124_), .c(new_n45_), .O(new_n136_));
  inv1   g092(.a(x30), .O(new_n137_));
  nand2  g093(.a(new_n121_), .b(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n52_), .b(x30), .c(new_n122_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x00), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n48_), .O(z8));
  inv1   g099(.a(x33), .O(new_n144_));
  aoi21  g100(.a(x31), .b(x30), .c(new_n122_), .O(new_n145_));
  nand2  g101(.a(new_n119_), .b(new_n137_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n122_), .c(new_n145_), .O(new_n147_));
  oai21  g103(.a(new_n118_), .b(new_n115_), .c(new_n147_), .O(new_n148_));
  nor3   g104(.a(new_n133_), .b(new_n132_), .c(new_n144_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n147_), .c(new_n131_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n45_), .c(x00), .O(new_n151_));
  aoi21  g107(.a(new_n148_), .b(new_n144_), .c(new_n151_), .O(z9));
endmodule
