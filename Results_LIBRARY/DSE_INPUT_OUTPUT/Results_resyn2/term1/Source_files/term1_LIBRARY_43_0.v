...
module FAU ( 
  ...
  nand2  g051(.a(new_n95_), .b(new_n56_), .O(z6));
  xor2a  g052(.a(x31), .b(x30), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n83_), .c(x29), .O(new_n98_));
  nand2  g054(.a(new_n88_), .b(x31), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n98_), .c(new_n79_), .O(z7));
  inv1   g056(.a(x32), .O(new_n101_));
  oai21  g057(.a(x28), .b(x27), .c(x29), .O(new_n102_));
  xor2a  g058(.a(new_n102_), .b(new_n93_), .O(new_n103_));
  ...
  aoi21  g093(.a(x32), .b(x25), .c(x31), .O(new_n138_));
  ...
  nor2   g097(.a(new_n103_), .b(new_n97_), .O(new_n142_));
  oai21  g098(.a(new_n121_), .b(new_n118_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n53_), .O(new_n144_));
  nand2  g100(.a(new_n142_), .b(x33), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n132_), .c(new_n137_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n56_), .O(z9));
endmodule
