...
module FAU ( 
  ...
  nor2   g024(.a(new_n46_), .b(x24), .O(new_n69_));
  ...
  aoi21  g033(.a(new_n77_), .b(new_n46_), .c(new_n69_), .O(z3));
  inv1   g034(.a(x19), .O(new_n79_));
  oai21  g035(.a(x27), .b(new_n45_), .c(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n72_), .O(new_n81_));
  inv1   g037(.a(x28), .O(new_n82_));
  nor2   g038(.a(new_n82_), .b(new_n46_), .O(new_n83_));
  inv1   g039(.a(new_n83_), .O(new_n84_));
  nand2  g040(.a(new_n82_), .b(new_n46_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n84_), .c(new_n81_), .d(new_n76_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n48_), .O(z4));
  and2   g043(.a(new_n73_), .b(new_n48_), .O(new_n88_));
  nand2  g044(.a(new_n83_), .b(x29), .O(new_n89_));
  inv1   g045(.a(x29), .O(new_n90_));
  nand2  g046(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n76_), .O(new_n92_));
  ...
  aoi21  g052(.a(new_n96_), .b(x30), .c(new_n75_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n95_), .c(new_n88_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z6));
  nand2  g055(.a(x29), .b(x28), .O(new_n100_));
  nand2  g056(.a(new_n69_), .b(x30), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n100_), .c(x31), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x30), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n100_), .c(new_n45_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x27), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n102_), .c(new_n76_), .d(new_n73_), .O(z7));
  inv1   g063(.a(x15), .O(new_n108_));
  inv1   g064(.a(x17), .O(new_n109_));
  nand3  g065(.a(new_n79_), .b(x18), .c(x14), .O(new_n110_));
  ...
  nor3   g079(.a(new_n123_), .b(new_n79_), .c(x15), .O(new_n124_));
  ...
  aoi21  g088(.a(new_n52_), .b(new_n94_), .c(new_n132_), .O(new_n133_));
  ...
  nand2  g104(.a(new_n74_), .b(x00), .O(new_n149_));
  ...
  nand2  g110(.a(new_n103_), .b(new_n94_), .O(new_n155_));
  ...
  nand2  g117(.a(new_n161_), .b(new_n48_), .O(z9));
endmodule
