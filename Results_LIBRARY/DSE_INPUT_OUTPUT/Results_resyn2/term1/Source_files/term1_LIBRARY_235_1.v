...
module FAU ( 
  ...
  aoi22  g083(.a(new_n87_), .b(x29), .c(new_n53_), .d(new_n96_), .O(new_n128_));
  ...
  nor2   g101(.a(x26), .b(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n57_), .O(z8));
  aoi21  g104(.a(x31), .b(x30), .c(new_n124_), .O(new_n149_));
  nand2  g105(.a(new_n120_), .b(new_n96_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n124_), .c(new_n149_), .O(new_n151_));
  oai21  g107(.a(new_n119_), .b(new_n116_), .c(new_n151_), .O(new_n152_));
  nand4  g108(.a(new_n151_), .b(new_n141_), .c(new_n139_), .d(x33), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n137_), .c(new_n146_), .O(new_n154_));
  aoi21  g110(.a(new_n152_), .b(new_n49_), .c(new_n154_), .O(z9));
endmodule
