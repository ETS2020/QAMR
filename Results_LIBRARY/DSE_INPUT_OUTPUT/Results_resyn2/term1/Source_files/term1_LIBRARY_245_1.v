...
module FAU ( 
  ...
  nand4  g103(.a(x19), .b(new_n74_), .c(x17), .d(x13), .O(new_n148_));
  ...
  nand2  g112(.a(x16), .b(x13), .O(new_n157_));
  oai21  g113(.a(x16), .b(x11), .c(x18), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g115(.a(new_n115_), .b(new_n108_), .O(new_n160_));
  oai21  g116(.a(new_n135_), .b(new_n74_), .c(new_n127_), .O(new_n161_));
