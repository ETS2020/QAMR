...
module FAU ( 
  ...
  nor2   g040(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nor2   g042(.a(new_n86_), .b(new_n81_), .O(z3));
  inv1   g043(.a(new_n84_), .O(new_n88_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n81_), .c(new_n48_), .O(z4));
  oai21  g050(.a(x20), .b(x15), .c(x23), .O(new_n95_));
  nand2  g051(.a(x18), .b(x15), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n95_), .c(new_n78_), .O(new_n97_));
  inv1   g053(.a(x15), .O(new_n98_));
  nand2  g054(.a(x18), .b(new_n98_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n97_), .c(new_n84_), .O(new_n100_));
  nand2  g056(.a(new_n90_), .b(x29), .O(new_n101_));
  inv1   g057(.a(x29), .O(new_n102_));
  nand2  g058(.a(new_n91_), .b(new_n102_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n101_), .c(new_n100_), .O(new_n104_));
  ...
  nand3  g064(.a(new_n108_), .b(new_n106_), .c(new_n100_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n48_), .O(z6));
  inv1   g066(.a(new_n97_), .O(new_n111_));
  xor2a  g067(.a(new_n106_), .b(x31), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n111_), .c(new_n85_), .O(z7));
  inv1   g069(.a(x17), .O(new_n114_));
  inv1   g070(.a(x19), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x18), .c(x14), .O(new_n116_));
  nand3  g072(.a(x19), .b(new_n45_), .c(x13), .O(new_n117_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n121_), .c(new_n98_), .O(new_n126_));
  nand4  g082(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n127_));
  nor3   g083(.a(new_n127_), .b(new_n115_), .c(x15), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nor2   g085(.a(x32), .b(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n128_), .b(new_n126_), .c(new_n130_), .O(new_n131_));
  ...
  aoi21  g093(.a(new_n55_), .b(new_n107_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  oai21  g095(.a(new_n124_), .b(x16), .c(x15), .O(new_n140_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n114_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  nand2  g105(.a(new_n45_), .b(new_n149_), .O(new_n150_));
  ...
  aoi21  g113(.a(x31), .b(x30), .c(new_n133_), .O(new_n158_));
  nand2  g114(.a(new_n129_), .b(new_n107_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n133_), .c(new_n158_), .O(new_n160_));
  oai21  g116(.a(new_n128_), .b(new_n126_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n51_), .O(new_n162_));
  aoi21  g118(.a(new_n45_), .b(new_n149_), .c(new_n51_), .O(new_n163_));
  ...
  nand2  g121(.a(new_n165_), .b(new_n48_), .O(z9));
endmodule
