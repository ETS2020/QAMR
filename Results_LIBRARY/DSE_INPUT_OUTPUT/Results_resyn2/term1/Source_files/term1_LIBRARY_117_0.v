...
module FAU ( 
  ...
  oai21  g000(.a(x26), .b(x23), .c(x32), .O(z0));
  nor2   g001(.a(x26), .b(x23), .O(new_n46_));
  ...
  nand3  g030(.a(new_n74_), .b(new_n69_), .c(x23), .O(new_n75_));
  ...
  nand3  g053(.a(new_n90_), .b(new_n97_), .c(x30), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n96_), .c(new_n74_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x23), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n69_), .O(z7));
  ...
  aoi22  g082(.a(new_n82_), .b(x29), .c(new_n52_), .d(new_n92_), .O(new_n127_));
  oai21  g083(.a(new_n114_), .b(x16), .c(x15), .O(new_n128_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n118_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(x18), .b(x12), .c(x17), .O(new_n135_));
  nor2   g091(.a(x18), .b(x13), .O(new_n136_));
  nor3   g092(.a(new_n136_), .b(new_n135_), .c(new_n97_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n134_), .c(new_n52_), .O(new_n138_));
  aoi21  g094(.a(new_n127_), .b(new_n126_), .c(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n69_), .b(x23), .c(x00), .O(new_n140_));
  aoi21  g096(.a(new_n139_), .b(new_n125_), .c(new_n140_), .O(z8));
  aoi21  g097(.a(x31), .b(x30), .c(new_n123_), .O(new_n142_));
  nand2  g098(.a(new_n97_), .b(new_n92_), .O(new_n143_));
  ...
  nor3   g102(.a(new_n136_), .b(new_n135_), .c(new_n48_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n144_), .c(new_n134_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  aoi21  g105(.a(new_n145_), .b(new_n48_), .c(new_n149_), .O(z9));
endmodule
