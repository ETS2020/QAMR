...
module FAU ( 
  ...
  inv1   g027(.a(x00), .O(new_n72_));
  nor2   g028(.a(x26), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g036(.a(new_n58_), .b(x25), .O(new_n81_));
  ...
  nand3  g051(.a(new_n95_), .b(new_n93_), .c(new_n82_), .O(new_n96_));
  ...
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n84_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(z6));
  xor2a  g058(.a(new_n98_), .b(x31), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n82_), .c(new_n72_), .O(new_n104_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n140_), .c(new_n73_), .O(new_n155_));
