...
module FAU ( 
  ...
  oai21  g034(.a(new_n78_), .b(x30), .c(x22), .O(new_n79_));
  inv1   g035(.a(x26), .O(new_n80_));
  nand3  g036(.a(new_n60_), .b(new_n80_), .c(x25), .O(new_n81_));
  aoi21  g037(.a(new_n78_), .b(x17), .c(new_n81_), .O(new_n82_));
  and2   g038(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  ...
  aoi21  g043(.a(new_n87_), .b(new_n78_), .c(new_n81_), .O(new_n88_));
  ...
  nand2  g049(.a(new_n93_), .b(new_n58_), .O(z4));
  ...
  nand2  g057(.a(new_n96_), .b(x30), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z6));
  nand2  g060(.a(new_n102_), .b(x31), .O(new_n105_));
  inv1   g061(.a(x31), .O(new_n106_));
  nand3  g062(.a(new_n96_), .b(new_n106_), .c(x30), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n105_), .c(new_n88_), .d(new_n58_), .O(z7));
  ...
  nand4  g071(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n116_));
  ...
  nor2   g079(.a(new_n113_), .b(new_n86_), .O(new_n124_));
  ...
  xor2a  g084(.a(new_n128_), .b(new_n46_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n54_), .c(x31), .O(new_n130_));
  ...
  nand2  g094(.a(new_n138_), .b(new_n86_), .O(new_n139_));
  ...
  nand2  g101(.a(new_n145_), .b(new_n58_), .O(z8));
  xor2a  g102(.a(new_n128_), .b(new_n106_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n129_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n127_), .c(new_n50_), .O(new_n150_));
  nand4  g106(.a(new_n148_), .b(new_n141_), .c(new_n139_), .d(x33), .O(new_n151_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n58_), .O(z9));
endmodule
