...
module FAU ( 
  ...
  oai21  g040(.a(new_n84_), .b(new_n79_), .c(new_n47_), .O(z3));
  inv1   g041(.a(new_n79_), .O(new_n86_));
  nand3  g042(.a(new_n83_), .b(new_n86_), .c(new_n47_), .O(new_n87_));
  ...
  or2    g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g078(.a(new_n92_), .b(x29), .O(new_n123_));
  xor2a  g079(.a(new_n123_), .b(new_n101_), .O(new_n124_));
  inv1   g080(.a(x16), .O(new_n125_));
  nand2  g081(.a(x17), .b(x11), .O(new_n126_));
  oai22  g082(.a(x19), .b(x18), .c(x17), .d(x12), .O(new_n127_));
  aoi21  g083(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n124_), .c(new_n122_), .O(new_n129_));
  aoi21  g085(.a(new_n117_), .b(new_n112_), .c(new_n129_), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n51_), .O(new_n131_));
  inv1   g087(.a(x17), .O(new_n132_));
  nand3  g088(.a(new_n114_), .b(new_n132_), .c(x12), .O(new_n133_));
  oai21  g089(.a(x19), .b(new_n118_), .c(x18), .O(new_n134_));
  aoi21  g090(.a(new_n113_), .b(new_n72_), .c(new_n132_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n125_), .O(new_n137_));
  nand2  g093(.a(new_n114_), .b(new_n125_), .O(new_n138_));
  ...
  nand3  g097(.a(new_n116_), .b(new_n114_), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n124_), .b(new_n51_), .c(x31), .O(new_n143_));
  aoi21  g099(.a(new_n142_), .b(new_n140_), .c(new_n143_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n131_), .c(x13), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n111_), .c(new_n110_), .O(z8));
  inv1   g102(.a(new_n110_), .O(new_n147_));
  nor2   g103(.a(x31), .b(x30), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  nand2  g105(.a(new_n119_), .b(x18), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n133_), .c(new_n149_), .O(new_n151_));
  oai21  g107(.a(new_n138_), .b(new_n126_), .c(new_n142_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n148_), .O(new_n153_));
  aoi21  g109(.a(new_n142_), .b(new_n140_), .c(new_n153_), .O(new_n154_));
  inv1   g110(.a(new_n123_), .O(new_n155_));
  inv1   g111(.a(x33), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(x31), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  oai21  g114(.a(new_n154_), .b(x33), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n106_), .b(new_n156_), .O(new_n160_));
  aoi21  g116(.a(new_n142_), .b(new_n140_), .c(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n157_), .c(new_n155_), .O(new_n162_));
  nand3  g118(.a(x18), .b(x17), .c(x11), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand2  g120(.a(x17), .b(x13), .O(new_n165_));
  oai21  g121(.a(x17), .b(x12), .c(x18), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n165_), .c(new_n125_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n164_), .c(x15), .O(new_n168_));
  oai21  g124(.a(new_n115_), .b(new_n72_), .c(new_n168_), .O(new_n169_));
  nand2  g125(.a(new_n121_), .b(new_n113_), .O(new_n170_));
  or2    g126(.a(new_n148_), .b(new_n106_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n170_), .c(new_n169_), .d(new_n122_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x33), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n162_), .c(new_n159_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n147_), .O(new_n175_));
