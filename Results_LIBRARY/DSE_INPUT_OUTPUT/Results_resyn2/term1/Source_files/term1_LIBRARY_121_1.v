...
module FAU ( 
  ...
  aoi21  g045(.a(x24), .b(x23), .c(x19), .O(new_n90_));
  ...
  nand3  g062(.a(new_n67_), .b(x18), .c(x14), .O(new_n107_));
  ...
  nor3   g076(.a(new_n120_), .b(new_n67_), .c(x15), .O(new_n121_));
  ...
  nand2  g092(.a(new_n136_), .b(new_n67_), .O(new_n137_));
