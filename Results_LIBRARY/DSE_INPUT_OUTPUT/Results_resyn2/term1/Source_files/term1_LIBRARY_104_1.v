...
module FAU ( 
  ...
  nand2  g074(.a(new_n118_), .b(new_n92_), .O(new_n119_));
  nand2  g075(.a(new_n83_), .b(x29), .O(new_n120_));
  aoi21  g076(.a(new_n51_), .b(x30), .c(new_n120_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g078(.a(new_n118_), .b(x30), .O(new_n123_));
  aoi22  g079(.a(new_n83_), .b(x29), .c(new_n51_), .d(new_n92_), .O(new_n124_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n99_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  nand2  g092(.a(new_n102_), .b(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(x31), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n133_), .c(x32), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n125_), .c(new_n122_), .O(new_n140_));
  inv1   g096(.a(x00), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n47_), .O(z8));
  inv1   g100(.a(x33), .O(new_n145_));
  aoi21  g101(.a(x31), .b(x30), .c(new_n120_), .O(new_n146_));
  nand2  g102(.a(new_n116_), .b(new_n92_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n120_), .c(new_n146_), .O(new_n148_));
  oai21  g104(.a(new_n115_), .b(new_n112_), .c(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n148_), .b(new_n137_), .c(new_n135_), .d(x33), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n133_), .c(new_n142_), .O(new_n151_));
