...
module FAU ( 
  ...
  nand3  g31(.a(new_n58_), .b(new_n75_), .c(x25), .O(new_n76_));
  nor2   g32(.a(new_n76_), .b(new_n47_), .O(new_n77_));
  nor2   g33(.a(x21), .b(x16), .O(new_n78_));
  oai22  g34(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n79_));
  ...
  nand3  g40(.a(new_n84_), .b(new_n77_), .c(new_n74_), .O(new_n85_));
  inv1   g41(.a(new_n85_), .O(z3));
  inv1   g42(.a(new_n76_), .O(new_n87_));
  inv1   g43(.a(x28), .O(new_n88_));
  nor2   g44(.a(new_n88_), .b(new_n74_), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  nand2  g46(.a(new_n88_), .b(new_n74_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n90_), .c(new_n84_), .d(new_n87_), .O(new_n92_));
  ...
  nand4  g52(.a(new_n96_), .b(new_n94_), .c(new_n84_), .d(new_n77_), .O(new_n97_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n100_), .c(new_n84_), .d(new_n77_), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(z6));
  inv1   g59(.a(x23), .O(new_n104_));
  nand2  g60(.a(x20), .b(x18), .O(new_n105_));
  oai21  g61(.a(new_n82_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n80_), .O(new_n107_));
  xor2a  g63(.a(new_n101_), .b(x31), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n107_), .c(new_n77_), .O(z7));
  nand3  g65(.a(new_n91_), .b(x30), .c(x29), .O(new_n110_));
  nand2  g66(.a(x18), .b(x10), .O(new_n111_));
  nand2  g67(.a(x15), .b(x13), .O(new_n112_));
  nand3  g68(.a(x19), .b(x17), .c(x16), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(new_n111_), .c(new_n113_), .O(new_n114_));
  oai21  g70(.a(x28), .b(x27), .c(x29), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n99_), .O(new_n116_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n120_), .c(new_n118_), .d(new_n45_), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(z8));
  inv1   g80(.a(x31), .O(new_n125_));
  nand3  g81(.a(new_n115_), .b(new_n125_), .c(new_n99_), .O(new_n126_));
  nand4  g82(.a(new_n91_), .b(x31), .c(x30), .d(x29), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  inv1   g84(.a(x15), .O(new_n129_));
  nand3  g85(.a(x18), .b(new_n129_), .c(x10), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n112_), .c(new_n113_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(new_n49_), .O(new_n132_));
  nand2  g88(.a(new_n114_), .b(new_n49_), .O(new_n133_));
  aoi21  g89(.a(new_n127_), .b(new_n126_), .c(new_n133_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n132_), .c(new_n122_), .O(new_n135_));
