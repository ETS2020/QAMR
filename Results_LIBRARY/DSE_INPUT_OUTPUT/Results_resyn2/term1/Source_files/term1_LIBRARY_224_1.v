...
module FAU ( 
  ...
  xor2a  g054(.a(new_n98_), .b(new_n46_), .O(z7));
  ...
  aoi22  g082(.a(new_n84_), .b(x29), .c(new_n122_), .d(new_n93_), .O(new_n127_));
  ...
  nand2  g095(.a(new_n104_), .b(new_n139_), .O(new_n140_));
  ...
  nand2  g104(.a(new_n118_), .b(new_n93_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n123_), .c(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n117_), .b(new_n114_), .c(new_n150_), .O(new_n151_));
  nand4  g107(.a(new_n150_), .b(new_n140_), .c(new_n138_), .d(x33), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n136_), .c(new_n145_), .O(new_n153_));
  aoi21  g109(.a(new_n151_), .b(new_n54_), .c(new_n153_), .O(z9));
endmodule
