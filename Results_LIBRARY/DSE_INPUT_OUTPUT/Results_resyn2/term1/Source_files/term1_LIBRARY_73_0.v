...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n91_), .c(new_n88_), .d(new_n47_), .O(new_n94_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n88_), .c(new_n45_), .O(z7));
  nand2  g063(.a(new_n83_), .b(x00), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  inv1   g065(.a(x18), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  ...
  nand3  g073(.a(new_n111_), .b(x16), .c(x15), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  oai22  g075(.a(new_n119_), .b(new_n117_), .c(new_n113_), .d(x15), .O(new_n120_));
  ...
  xor2a  g081(.a(new_n125_), .b(new_n101_), .O(new_n126_));
  inv1   g082(.a(x13), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  aoi21  g084(.a(new_n110_), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n126_), .c(new_n124_), .d(new_n122_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n120_), .c(x32), .O(new_n131_));
  nand3  g087(.a(new_n115_), .b(x18), .c(x14), .O(new_n132_));
  nand3  g088(.a(x19), .b(new_n110_), .c(x13), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n76_), .O(new_n134_));
  nand4  g090(.a(x19), .b(x18), .c(new_n76_), .d(x12), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n134_), .c(x16), .O(new_n137_));
  inv1   g093(.a(new_n116_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x19), .c(new_n114_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nor3   g096(.a(new_n112_), .b(new_n115_), .c(x15), .O(new_n141_));
  aoi21  g097(.a(new_n140_), .b(x15), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n126_), .b(new_n49_), .c(x31), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n131_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n109_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n47_), .O(z8));
  inv1   g102(.a(new_n125_), .O(new_n147_));
  nand2  g103(.a(x33), .b(new_n101_), .O(new_n148_));
  nand3  g104(.a(new_n52_), .b(x31), .c(x30), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n142_), .c(new_n148_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  oai21  g107(.a(new_n125_), .b(new_n128_), .c(x30), .O(new_n152_));
  aoi22  g108(.a(x31), .b(new_n101_), .c(new_n110_), .d(new_n127_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n152_), .c(new_n124_), .d(new_n122_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n120_), .c(x33), .O(new_n155_));
