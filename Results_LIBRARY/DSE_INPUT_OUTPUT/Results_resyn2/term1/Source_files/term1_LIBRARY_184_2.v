...
module FAU ( 
  ...
  oai22  g030(.a(x23), .b(x18), .c(x20), .d(x15), .O(new_n75_));
  ...
  oai21  g037(.a(new_n81_), .b(new_n76_), .c(new_n65_), .O(z3));
  oai21  g038(.a(x23), .b(x18), .c(x20), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(new_n45_), .c(new_n74_), .O(new_n84_));
  ...
  nand4  g045(.a(new_n89_), .b(new_n88_), .c(new_n85_), .d(new_n80_), .O(new_n90_));
  ...
  nor2   g050(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n85_), .c(new_n80_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z5));
  inv1   g053(.a(x30), .O(new_n98_));
  aoi21  g054(.a(new_n93_), .b(new_n98_), .c(new_n79_), .O(new_n99_));
  oai21  g055(.a(new_n93_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n76_), .c(new_n65_), .O(z6));
  xor2a  g057(.a(x31), .b(x30), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  nand2  g059(.a(new_n93_), .b(x31), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n103_), .c(new_n85_), .d(new_n80_), .O(z7));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n68_), .c(new_n108_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand3  g067(.a(new_n89_), .b(x30), .c(x29), .O(new_n112_));
  ...
  nand2  g077(.a(new_n112_), .b(new_n107_), .O(new_n122_));
  ...
  nand3  g089(.a(new_n68_), .b(x17), .c(x14), .O(new_n134_));
