...
module FAU ( 
  ...
  nand3  g033(.a(new_n55_), .b(new_n45_), .c(x25), .O(new_n78_));
  ...
  nand2  g042(.a(new_n86_), .b(new_n47_), .O(z4));
  ...
  nand2  g077(.a(new_n85_), .b(x29), .O(new_n122_));
  aoi21  g078(.a(new_n51_), .b(x30), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g080(.a(new_n120_), .b(x30), .O(new_n125_));
  inv1   g081(.a(new_n122_), .O(new_n126_));
  aoi21  g082(.a(new_n51_), .b(new_n94_), .c(new_n126_), .O(new_n127_));
  ...
  aoi21  g103(.a(x31), .b(x30), .c(new_n122_), .O(new_n148_));
  nand2  g104(.a(new_n118_), .b(new_n94_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n122_), .c(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n117_), .b(new_n114_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  aoi21  g108(.a(new_n104_), .b(new_n138_), .c(new_n147_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n150_), .c(new_n137_), .d(new_n135_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n152_), .c(new_n144_), .O(new_n155_));
