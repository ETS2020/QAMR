...
module FAU ( 
  ...
  nand2  g026(.a(new_n70_), .b(new_n56_), .O(z2));
  ...
  oai21  g038(.a(new_n82_), .b(new_n77_), .c(new_n56_), .O(z3));
  oai21  g039(.a(x20), .b(x15), .c(x23), .O(new_n84_));
  ...
  oai21  g058(.a(new_n102_), .b(new_n77_), .c(new_n56_), .O(z6));
  ...
  oai21  g065(.a(new_n109_), .b(new_n52_), .c(new_n45_), .O(new_n110_));
  ...
  aoi21  g097(.a(new_n52_), .b(new_n98_), .c(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n126_), .b(new_n98_), .c(new_n142_), .O(new_n143_));
  ...
  aoi21  g126(.a(new_n127_), .b(new_n98_), .c(new_n46_), .O(new_n171_));
  oai21  g127(.a(new_n127_), .b(new_n98_), .c(new_n171_), .O(new_n172_));
