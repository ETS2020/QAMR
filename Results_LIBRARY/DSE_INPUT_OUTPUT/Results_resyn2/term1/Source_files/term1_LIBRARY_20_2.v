...
module FAU ( 
  ...
  nor2   g006(.a(x32), .b(new_n50_), .O(new_n51_));
  inv1   g007(.a(new_n51_), .O(new_n52_));
  inv1   g008(.a(x33), .O(new_n53_));
  inv1   g009(.a(x02), .O(new_n54_));
  aoi21  g010(.a(x32), .b(new_n46_), .c(new_n54_), .O(new_n55_));
  oai21  g011(.a(new_n53_), .b(new_n46_), .c(new_n55_), .O(new_n56_));
  nand3  g012(.a(new_n56_), .b(new_n52_), .c(new_n49_), .O(z1));
  ...
  nand3  g038(.a(new_n82_), .b(new_n52_), .c(new_n72_), .O(new_n83_));
  ...
  nor2   g059(.a(new_n103_), .b(new_n51_), .O(new_n104_));
  ...
  nand2  g079(.a(new_n47_), .b(x31), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n123_), .c(new_n50_), .O(new_n125_));
  nand2  g081(.a(new_n88_), .b(x29), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  oai21  g083(.a(new_n117_), .b(x16), .c(x15), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n121_), .O(new_n129_));
  inv1   g085(.a(x14), .O(new_n130_));
  nor2   g086(.a(x19), .b(new_n130_), .O(new_n131_));
  nand3  g087(.a(new_n120_), .b(x16), .c(x15), .O(new_n132_));
  ...
  nand2  g093(.a(new_n126_), .b(new_n50_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(x31), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n129_), .c(new_n47_), .O(new_n141_));
  aoi21  g097(.a(new_n127_), .b(new_n125_), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n80_), .b(x00), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n52_), .O(z8));
  xnor2a g100(.a(x31), .b(x30), .O(new_n145_));
  xor2a  g101(.a(new_n126_), .b(new_n50_), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n123_), .c(new_n53_), .O(new_n149_));
  nand3  g105(.a(new_n145_), .b(new_n137_), .c(x33), .O(new_n150_));
  nor3   g106(.a(new_n150_), .b(new_n146_), .c(new_n134_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n129_), .c(new_n143_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n52_), .O(z9));
endmodule
