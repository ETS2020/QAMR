...
module FAU ( 
  ...
  nand2  g058(.a(new_n101_), .b(new_n100_), .O(new_n103_));
  ...
  nand4  g073(.a(x19), .b(x17), .c(new_n73_), .d(x11), .O(new_n118_));
  ...
  nor2   g077(.a(new_n110_), .b(new_n73_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(x19), .c(new_n109_), .d(x10), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n45_), .O(new_n124_));
  nor2   g080(.a(x32), .b(new_n101_), .O(new_n125_));
  ...
  nand3  g090(.a(new_n122_), .b(x19), .c(x13), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand2  g092(.a(x17), .b(x11), .O(new_n137_));
  nand2  g093(.a(new_n122_), .b(x15), .O(new_n138_));
  oai21  g094(.a(x17), .b(x12), .c(x16), .O(new_n139_));
  aoi22  g095(.a(new_n139_), .b(new_n137_), .c(new_n138_), .d(new_n111_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(x18), .c(new_n136_), .O(new_n141_));
  nand2  g097(.a(new_n122_), .b(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n45_), .c(new_n109_), .O(new_n143_));
  nand2  g099(.a(new_n111_), .b(x14), .O(new_n144_));
  nand4  g100(.a(new_n122_), .b(new_n144_), .c(x18), .d(x15), .O(new_n145_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n104_), .c(new_n154_), .d(x19), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n153_), .c(x18), .O(new_n158_));
  inv1   g114(.a(x06), .O(new_n159_));
  nand2  g115(.a(new_n110_), .b(x12), .O(new_n160_));
  oai21  g116(.a(x19), .b(x17), .c(x16), .O(new_n161_));
  aoi21  g117(.a(new_n160_), .b(new_n144_), .c(new_n161_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n119_), .c(x15), .O(new_n163_));
  nand2  g119(.a(new_n154_), .b(x18), .O(new_n164_));
  aoi21  g120(.a(new_n163_), .b(new_n123_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n104_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n153_), .c(new_n159_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n158_), .c(new_n128_), .O(new_n168_));
  nor2   g124(.a(new_n154_), .b(x30), .O(new_n169_));
  nand3  g125(.a(new_n102_), .b(new_n154_), .c(x19), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n155_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(new_n45_), .O(new_n172_));
  aoi21  g128(.a(new_n165_), .b(new_n102_), .c(new_n169_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n159_), .c(new_n172_), .O(new_n174_));
  inv1   g130(.a(new_n140_), .O(new_n175_));
  nand2  g131(.a(new_n142_), .b(new_n109_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n145_), .c(new_n105_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n175_), .c(x06), .O(new_n178_));
  nand3  g134(.a(new_n156_), .b(new_n105_), .c(x19), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n45_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n178_), .c(new_n154_), .O(new_n181_));
  aoi21  g137(.a(new_n174_), .b(new_n132_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n168_), .c(new_n149_), .O(z9));
endmodule
