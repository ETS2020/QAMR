...
module FAU ( 
  ...
  nand2  g063(.a(new_n82_), .b(x00), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n54_), .c(new_n76_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n45_), .O(new_n110_));
  nand3  g066(.a(new_n91_), .b(x30), .c(x29), .O(new_n111_));
  inv1   g067(.a(x31), .O(new_n112_));
  oai21  g068(.a(x28), .b(x27), .c(x29), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n101_), .c(new_n112_), .O(new_n114_));
  ...
  nand4  g074(.a(x19), .b(new_n76_), .c(x15), .d(x13), .O(new_n119_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n117_), .c(x14), .O(new_n131_));
  nand2  g087(.a(new_n125_), .b(new_n124_), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n54_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n114_), .c(new_n111_), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n134_), .c(new_n108_), .O(new_n140_));
  oai21  g096(.a(new_n128_), .b(x32), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n110_), .O(z8));
  oai21  g098(.a(new_n108_), .b(new_n50_), .c(new_n76_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n45_), .O(new_n144_));
  inv1   g100(.a(new_n108_), .O(new_n145_));
  nand3  g101(.a(new_n113_), .b(new_n112_), .c(new_n101_), .O(new_n146_));
  nand4  g102(.a(new_n91_), .b(x31), .c(x30), .d(x29), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n50_), .O(new_n149_));
  aoi21  g105(.a(new_n127_), .b(new_n123_), .c(new_n149_), .O(new_n150_));
  aoi22  g106(.a(new_n136_), .b(new_n135_), .c(new_n133_), .d(new_n131_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n148_), .c(new_n50_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n150_), .c(new_n145_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n144_), .O(z9));
endmodule
