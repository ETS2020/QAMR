...
module FAU ( 
  ...
  nor2   g006(.a(x32), .b(x30), .O(new_n51_));
  ...
  nand2  g016(.a(x06), .b(new_n54_), .O(new_n61_));
  aoi21  g017(.a(x05), .b(new_n47_), .c(new_n61_), .O(new_n62_));
  nand3  g018(.a(new_n61_), .b(x05), .c(new_n47_), .O(new_n63_));
  ...
  nand2  g026(.a(new_n70_), .b(new_n52_), .O(z2));
  inv1   g027(.a(x27), .O(new_n72_));
  inv1   g028(.a(x26), .O(new_n73_));
  nand3  g029(.a(new_n59_), .b(new_n73_), .c(x25), .O(new_n74_));
  nor2   g030(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  ...
  nand3  g041(.a(new_n85_), .b(new_n75_), .c(new_n72_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(z3));
  inv1   g043(.a(new_n74_), .O(new_n88_));
  and2   g044(.a(new_n85_), .b(new_n88_), .O(new_n89_));
  ...
  nand2  g050(.a(new_n94_), .b(new_n52_), .O(z4));
  nand2  g051(.a(new_n91_), .b(x29), .O(new_n96_));
  inv1   g052(.a(x29), .O(new_n97_));
  nand2  g053(.a(new_n92_), .b(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n96_), .c(new_n85_), .d(new_n75_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z5));
  nand2  g056(.a(new_n96_), .b(x30), .O(new_n101_));
  nor2   g057(.a(new_n48_), .b(x30), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n96_), .c(new_n101_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z6));
  aoi21  g062(.a(new_n103_), .b(new_n101_), .c(x31), .O(new_n107_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n107_), .c(new_n89_), .O(z7));
  nand2  g068(.a(new_n93_), .b(x29), .O(new_n113_));
  inv1   g069(.a(x17), .O(new_n114_));
  nand3  g070(.a(new_n79_), .b(x18), .c(x14), .O(new_n115_));
  ...
  nor2   g082(.a(new_n116_), .b(new_n114_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x16), .c(x10), .O(new_n128_));
  nor3   g084(.a(new_n128_), .b(new_n79_), .c(x15), .O(new_n129_));
  aoi21  g085(.a(new_n126_), .b(x15), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n48_), .b(x31), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(x30), .O(new_n132_));
  inv1   g088(.a(new_n128_), .O(new_n133_));
  nand2  g089(.a(new_n123_), .b(new_n122_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(x15), .c(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n79_), .b(x14), .O(new_n136_));
  nand3  g092(.a(new_n127_), .b(x16), .c(x15), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g095(.a(new_n137_), .b(new_n79_), .O(new_n140_));
  ...
  nor2   g100(.a(new_n144_), .b(new_n135_), .O(new_n145_));
  inv1   g101(.a(new_n113_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(x30), .c(new_n108_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n145_), .c(new_n48_), .O(new_n148_));
  aoi21  g104(.a(new_n132_), .b(new_n113_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n73_), .b(x00), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n52_), .O(z8));
  nand2  g107(.a(new_n146_), .b(new_n110_), .O(new_n152_));
  oai21  g108(.a(x31), .b(x30), .c(new_n113_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n130_), .c(new_n53_), .O(new_n155_));
  nand3  g111(.a(new_n153_), .b(new_n152_), .c(x33), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n145_), .c(new_n150_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n52_), .O(z9));
endmodule
