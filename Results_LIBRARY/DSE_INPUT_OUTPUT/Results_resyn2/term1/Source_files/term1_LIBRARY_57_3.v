...
module FAU ( 
  ...
  nand2  g045(.a(new_n89_), .b(new_n79_), .O(z5));
  ...
  nand2  g050(.a(new_n94_), .b(new_n79_), .O(z6));
  ...
  nand2  g077(.a(new_n83_), .b(x29), .O(new_n122_));
  ...
  aoi22  g081(.a(new_n83_), .b(x29), .c(new_n121_), .d(new_n92_), .O(new_n126_));
  oai21  g082(.a(new_n111_), .b(x16), .c(x15), .O(new_n127_));
  ...
  nand2  g086(.a(new_n101_), .b(x14), .O(new_n131_));
  ...
  aoi21  g097(.a(new_n126_), .b(new_n125_), .c(new_n141_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n124_), .c(new_n45_), .O(z8));
  aoi21  g099(.a(x31), .b(x30), .c(new_n122_), .O(new_n144_));
  nand2  g100(.a(new_n117_), .b(new_n92_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n122_), .c(new_n144_), .O(new_n146_));
  oai21  g102(.a(new_n116_), .b(new_n113_), .c(new_n146_), .O(new_n147_));
  nand4  g103(.a(new_n146_), .b(new_n138_), .c(new_n136_), .d(x33), .O(new_n148_));
  nor2   g104(.a(x26), .b(new_n45_), .O(new_n149_));
  oai21  g105(.a(new_n148_), .b(new_n134_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n147_), .b(new_n54_), .c(new_n150_), .O(z9));
endmodule
