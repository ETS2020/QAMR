...
module FAU ( 
  ...
  nand2  g024(.a(new_n68_), .b(new_n53_), .O(z2));
  ...
  oai21  g039(.a(new_n83_), .b(x27), .c(new_n53_), .O(z3));
  ...
  oai21  g047(.a(new_n91_), .b(new_n83_), .c(new_n53_), .O(z4));
  inv1   g048(.a(x29), .O(new_n93_));
  xor2a  g049(.a(new_n87_), .b(new_n93_), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n83_), .c(new_n53_), .O(z5));
  inv1   g051(.a(x30), .O(new_n96_));
  nand2  g052(.a(new_n88_), .b(new_n96_), .O(new_n97_));
  nand2  g053(.a(new_n87_), .b(x30), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n93_), .O(new_n99_));
  aoi21  g055(.a(new_n83_), .b(new_n53_), .c(new_n99_), .O(z6));
  inv1   g056(.a(new_n83_), .O(new_n101_));
  oai21  g057(.a(new_n83_), .b(x31), .c(x30), .O(new_n102_));
  nand3  g058(.a(new_n87_), .b(x30), .c(x29), .O(new_n103_));
  nor2   g059(.a(new_n98_), .b(x31), .O(new_n104_));
  aoi21  g060(.a(new_n103_), .b(x31), .c(new_n104_), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(new_n101_), .c(new_n102_), .d(new_n93_), .O(z7));
  nand4  g062(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n107_));
  ...
  aoi21  g067(.a(new_n111_), .b(x19), .c(new_n108_), .O(new_n112_));
  ...
  nand2  g079(.a(new_n123_), .b(new_n113_), .O(new_n124_));
  xor2a  g080(.a(new_n89_), .b(new_n96_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n93_), .c(x31), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(new_n47_), .O(new_n127_));
  inv1   g083(.a(x17), .O(new_n128_));
  nand3  g084(.a(new_n73_), .b(x18), .c(x14), .O(new_n129_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n109_), .c(x11), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n119_), .O(new_n139_));
  nand3  g095(.a(x16), .b(new_n119_), .c(x10), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  oai21  g097(.a(new_n89_), .b(new_n93_), .c(x30), .O(new_n142_));
  nand3  g098(.a(new_n90_), .b(new_n96_), .c(x29), .O(new_n143_));
  nand2  g099(.a(new_n45_), .b(x31), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n144_), .O(new_n145_));
  oai21  g101(.a(new_n141_), .b(new_n139_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n80_), .b(x00), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n127_), .c(new_n147_), .O(z8));
  oai21  g104(.a(new_n122_), .b(new_n112_), .c(new_n53_), .O(new_n149_));
  inv1   g105(.a(x31), .O(new_n150_));
  nand2  g106(.a(new_n89_), .b(new_n150_), .O(new_n151_));
  nor2   g107(.a(x30), .b(new_n93_), .O(new_n152_));
  nand2  g108(.a(new_n150_), .b(x30), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n142_), .O(new_n154_));
  aoi21  g110(.a(new_n152_), .b(new_n151_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n149_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x33), .O(new_n157_));
  nand2  g113(.a(new_n90_), .b(x30), .O(new_n158_));
  inv1   g114(.a(x33), .O(new_n159_));
  nand3  g115(.a(new_n153_), .b(new_n159_), .c(x29), .O(new_n160_));
  aoi21  g116(.a(new_n151_), .b(new_n158_), .c(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n141_), .b(new_n139_), .c(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n157_), .c(new_n147_), .O(z9));
endmodule
