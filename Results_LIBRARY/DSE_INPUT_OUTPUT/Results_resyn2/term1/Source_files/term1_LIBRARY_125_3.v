...
module FAU ( 
  ...
  oai21  g034(.a(x24), .b(x19), .c(new_n78_), .O(new_n79_));
  inv1   g035(.a(x26), .O(new_n80_));
  nand4  g036(.a(new_n49_), .b(new_n80_), .c(x25), .d(x01), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n79_), .c(new_n70_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n58_), .O(z3));
  aoi21  g040(.a(new_n46_), .b(x24), .c(x19), .O(new_n85_));
  nor2   g041(.a(new_n46_), .b(new_n70_), .O(new_n86_));
  nor2   g042(.a(x28), .b(x27), .O(new_n87_));
  nor3   g043(.a(new_n87_), .b(new_n86_), .c(new_n81_), .O(new_n88_));
  oai21  g044(.a(new_n85_), .b(new_n77_), .c(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n58_), .O(z4));
  aoi21  g046(.a(new_n77_), .b(new_n46_), .c(new_n45_), .O(new_n91_));
  inv1   g047(.a(x19), .O(new_n92_));
  oai21  g048(.a(new_n77_), .b(new_n92_), .c(new_n82_), .O(new_n93_));
  nor2   g049(.a(new_n86_), .b(x29), .O(new_n94_));
  nand2  g050(.a(new_n86_), .b(x29), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nor4   g052(.a(new_n96_), .b(new_n94_), .c(new_n93_), .d(new_n91_), .O(z5));
  oai21  g053(.a(new_n96_), .b(x24), .c(x30), .O(new_n98_));
  aoi21  g054(.a(new_n77_), .b(x24), .c(new_n98_), .O(new_n99_));
  inv1   g055(.a(new_n93_), .O(new_n100_));
  oai21  g056(.a(new_n96_), .b(x30), .c(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(new_n58_), .O(z6));
  inv1   g058(.a(x31), .O(new_n103_));
  and2   g059(.a(x30), .b(x29), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(x27), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n45_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x28), .O(new_n107_));
  nand2  g063(.a(new_n104_), .b(new_n86_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(x31), .c(new_n81_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n107_), .c(new_n79_), .O(z7));
  inv1   g066(.a(x30), .O(new_n111_));
  inv1   g067(.a(x15), .O(new_n112_));
  inv1   g068(.a(x17), .O(new_n113_));
  nand3  g069(.a(new_n92_), .b(x18), .c(x14), .O(new_n114_));
  ...
  nor3   g083(.a(new_n127_), .b(new_n92_), .c(x15), .O(new_n128_));
  nor2   g084(.a(x32), .b(new_n103_), .O(new_n129_));
  oai21  g085(.a(new_n128_), .b(new_n125_), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n111_), .O(new_n131_));
  inv1   g087(.a(x32), .O(new_n132_));
  oai21  g088(.a(x28), .b(x27), .c(x29), .O(new_n133_));
  aoi21  g089(.a(new_n132_), .b(x30), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g091(.a(new_n130_), .b(x30), .O(new_n136_));
  inv1   g092(.a(new_n133_), .O(new_n137_));
  aoi21  g093(.a(new_n132_), .b(new_n111_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  oai21  g095(.a(new_n123_), .b(x16), .c(x15), .O(new_n140_));
  inv1   g096(.a(x14), .O(new_n141_));
  nor2   g097(.a(x19), .b(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n126_), .b(x16), .c(x15), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n92_), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(new_n142_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n140_), .b(new_n127_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(x18), .b(x12), .c(x17), .O(new_n147_));
  nor2   g103(.a(x18), .b(x13), .O(new_n148_));
  nor3   g104(.a(new_n148_), .b(new_n147_), .c(new_n103_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n139_), .c(new_n135_), .O(new_n152_));
  nand2  g108(.a(new_n80_), .b(x00), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n58_), .O(z8));
  nor2   g112(.a(new_n128_), .b(new_n125_), .O(new_n157_));
  nor2   g113(.a(x31), .b(x30), .O(new_n158_));
  nor2   g114(.a(new_n87_), .b(new_n103_), .O(new_n159_));
  aoi22  g115(.a(new_n159_), .b(new_n104_), .c(new_n158_), .d(new_n133_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n157_), .c(new_n55_), .O(new_n161_));
  nor4   g117(.a(new_n160_), .b(new_n148_), .c(new_n147_), .d(new_n55_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n146_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n161_), .c(new_n154_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n58_), .O(z9));
endmodule
