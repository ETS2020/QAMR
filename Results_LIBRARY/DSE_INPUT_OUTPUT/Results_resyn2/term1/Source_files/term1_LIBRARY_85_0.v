...
module FAU ( 
  ...
  nor2   g000(.a(x16), .b(x09), .O(new_n45_));
  ...
  nand3  g023(.a(new_n65_), .b(new_n63_), .c(new_n58_), .O(new_n68_));
  nand3  g024(.a(new_n68_), .b(new_n67_), .c(x08), .O(new_n69_));
  aoi21  g025(.a(new_n69_), .b(x16), .c(x09), .O(z2));
  inv1   g026(.a(new_n45_), .O(new_n71_));
  ...
  oai21  g041(.a(new_n85_), .b(x27), .c(new_n71_), .O(z3));
  nor2   g042(.a(new_n83_), .b(new_n45_), .O(new_n87_));
  ...
  oai21  g054(.a(new_n98_), .b(new_n85_), .c(new_n71_), .O(z5));
  xor2a  g055(.a(new_n95_), .b(x30), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n85_), .c(new_n71_), .O(z6));
  ...
  inv1   g081(.a(x09), .O(new_n126_));
  nand2  g082(.a(x15), .b(x11), .O(new_n127_));
  nand3  g083(.a(x19), .b(x18), .c(x17), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(new_n110_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n124_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n126_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n125_), .c(x32), .O(new_n133_));
  inv1   g089(.a(x17), .O(new_n134_));
  nand3  g090(.a(new_n75_), .b(x18), .c(x14), .O(new_n135_));
  inv1   g091(.a(x18), .O(new_n136_));
  nand3  g092(.a(x19), .b(new_n136_), .c(x13), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(new_n134_), .O(new_n138_));
  nand4  g094(.a(x19), .b(x18), .c(new_n134_), .d(x12), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n138_), .c(x15), .O(new_n141_));
  inv1   g097(.a(x15), .O(new_n142_));
  inv1   g098(.a(new_n128_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n142_), .c(x10), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n141_), .c(x16), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n131_), .c(z0), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n133_), .c(new_n109_), .O(z8));
  inv1   g103(.a(new_n122_), .O(new_n148_));
  nand2  g104(.a(x33), .b(x30), .O(new_n149_));
  nor3   g105(.a(x33), .b(new_n75_), .c(new_n136_), .O(new_n150_));
  nand4  g106(.a(x17), .b(new_n110_), .c(x15), .d(x11), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n150_), .c(new_n104_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n149_), .c(new_n126_), .O(new_n154_));
  aoi21  g110(.a(new_n144_), .b(new_n141_), .c(x33), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n104_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n149_), .c(new_n110_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n154_), .c(new_n148_), .O(new_n158_));
  inv1   g114(.a(new_n103_), .O(new_n159_));
  nand3  g115(.a(new_n152_), .b(new_n150_), .c(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n48_), .b(x30), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x09), .O(new_n162_));
  nor2   g118(.a(new_n48_), .b(x30), .O(new_n163_));
  aoi21  g119(.a(new_n155_), .b(new_n159_), .c(new_n163_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n110_), .c(new_n162_), .O(new_n165_));
  nand2  g121(.a(new_n121_), .b(new_n106_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x16), .O(new_n167_));
  nand2  g123(.a(new_n129_), .b(new_n106_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x09), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n167_), .c(new_n48_), .O(new_n170_));
  aoi21  g126(.a(new_n165_), .b(new_n122_), .c(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n158_), .c(new_n109_), .O(z9));
endmodule
