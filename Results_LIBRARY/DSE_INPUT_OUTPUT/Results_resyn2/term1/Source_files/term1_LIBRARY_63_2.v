...
module FAU ( 
  ...
  nand4  g043(.a(new_n87_), .b(new_n86_), .c(new_n80_), .d(new_n45_), .O(new_n88_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n81_), .c(new_n47_), .O(z5));
  ...
  oai21  g054(.a(new_n98_), .b(new_n81_), .c(new_n47_), .O(z6));
  nand2  g055(.a(x31), .b(new_n45_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n97_), .O(new_n102_));
  aoi21  g058(.a(new_n97_), .b(x31), .c(new_n102_), .O(new_n103_));
  oai21  g059(.a(new_n80_), .b(new_n46_), .c(new_n103_), .O(z7));
  inv1   g060(.a(x31), .O(new_n105_));
  nand2  g061(.a(x32), .b(x00), .O(new_n106_));
  ...
  nand3  g083(.a(new_n87_), .b(x30), .c(x29), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(x31), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n125_), .c(new_n54_), .O(new_n130_));
  nand4  g086(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n131_));
  oai21  g087(.a(new_n120_), .b(x16), .c(x19), .O(new_n132_));
  ...
  aoi21  g093(.a(new_n110_), .b(x14), .c(new_n131_), .O(new_n138_));
  aoi21  g094(.a(new_n123_), .b(new_n137_), .c(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n136_), .c(new_n133_), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n128_), .b(new_n127_), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n54_), .O(new_n143_));
  ...
  nand2  g102(.a(new_n146_), .b(new_n108_), .O(z8));
  nand3  g103(.a(new_n126_), .b(new_n105_), .c(new_n95_), .O(new_n148_));
  oai21  g104(.a(new_n128_), .b(new_n100_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n50_), .O(new_n150_));
  inv1   g106(.a(new_n148_), .O(new_n151_));
  nor2   g107(.a(new_n128_), .b(new_n105_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  aoi21  g109(.a(x31), .b(x26), .c(new_n50_), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n140_), .c(new_n154_), .O(new_n155_));
  oai21  g111(.a(new_n150_), .b(new_n125_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x00), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n47_), .O(z9));
endmodule
