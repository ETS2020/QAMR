...
module FAU ( 
  ...
  aoi21  g050(.a(new_n88_), .b(new_n94_), .c(new_n46_), .O(new_n95_));
  ...
  aoi21  g055(.a(new_n45_), .b(new_n85_), .c(new_n99_), .O(new_n100_));
  aoi21  g056(.a(new_n93_), .b(x30), .c(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n83_), .c(new_n47_), .O(z6));
  nor2   g058(.a(new_n98_), .b(new_n94_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x28), .O(new_n104_));
  xor2a  g060(.a(new_n104_), .b(x31), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n92_), .c(z3), .O(z7));
  inv1   g062(.a(new_n103_), .O(new_n107_));
  nand2  g063(.a(new_n98_), .b(new_n94_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(x31), .O(new_n109_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n109_), .c(new_n51_), .O(new_n127_));
  nand2  g083(.a(new_n80_), .b(x00), .O(new_n128_));
  aoi21  g084(.a(new_n119_), .b(new_n118_), .c(new_n73_), .O(new_n129_));
  nand3  g085(.a(new_n123_), .b(x16), .c(x15), .O(new_n130_));
  ...
  nand2  g092(.a(new_n124_), .b(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n73_), .b(x14), .O(new_n138_));
  ...
  or2    g097(.a(new_n109_), .b(new_n51_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n141_), .c(new_n128_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n127_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n47_), .O(z8));
  nand2  g102(.a(new_n89_), .b(x29), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n45_), .c(new_n98_), .O(new_n148_));
  oai21  g104(.a(new_n107_), .b(new_n45_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  inv1   g106(.a(x33), .O(new_n151_));
  nor2   g107(.a(new_n46_), .b(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  aoi21  g109(.a(new_n121_), .b(new_n117_), .c(new_n136_), .O(new_n154_));
  nand3  g110(.a(new_n103_), .b(x31), .c(x27), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n148_), .c(x33), .O(new_n156_));
  oai21  g112(.a(new_n125_), .b(new_n154_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n153_), .c(new_n128_), .O(z9));
endmodule
