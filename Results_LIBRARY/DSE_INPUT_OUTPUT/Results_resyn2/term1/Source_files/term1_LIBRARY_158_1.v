...
module FAU ( 
  ...
  aoi21  g032(.a(new_n45_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n75_), .O(new_n108_));
  nand4  g064(.a(x19), .b(x18), .c(new_n75_), .d(x12), .O(new_n109_));
  ...
  nor2   g072(.a(new_n106_), .b(new_n75_), .O(new_n117_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n75_), .O(new_n140_));
  inv1   g096(.a(x13), .O(new_n141_));
  nand2  g097(.a(new_n106_), .b(new_n141_), .O(new_n142_));
  ...
  aoi21  g110(.a(new_n106_), .b(new_n141_), .c(new_n54_), .O(new_n155_));
