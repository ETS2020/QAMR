...
module FAU ( 
  ...
  nand2  g014(.a(new_n49_), .b(new_n58_), .O(new_n59_));
  ...
  nand2  g018(.a(x06), .b(new_n58_), .O(new_n63_));
  xor2a  g019(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g020(.a(new_n64_), .b(new_n57_), .c(new_n61_), .O(new_n65_));
  xor2a  g021(.a(new_n65_), .b(new_n56_), .O(new_n66_));
  ...
  oai21  g040(.a(new_n84_), .b(x27), .c(new_n68_), .O(z3));
  ...
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n83_), .d(new_n81_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n68_), .O(z4));
  nand2  g048(.a(new_n88_), .b(x29), .O(new_n93_));
  inv1   g049(.a(x30), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n45_), .c(new_n89_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n84_), .c(new_n68_), .O(z5));
  inv1   g053(.a(new_n84_), .O(new_n98_));
  nand3  g054(.a(new_n93_), .b(new_n98_), .c(x30), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z6));
  nand2  g056(.a(new_n93_), .b(x31), .O(new_n101_));
  inv1   g057(.a(x31), .O(new_n102_));
  nand3  g058(.a(new_n88_), .b(new_n102_), .c(x29), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n101_), .c(new_n98_), .d(new_n68_), .O(z7));
  ...
  aoi21  g076(.a(new_n90_), .b(x29), .c(new_n102_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n52_), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  oai21  g079(.a(new_n120_), .b(new_n118_), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n115_), .b(new_n114_), .O(new_n125_));
  ...
  aoi21  g093(.a(new_n137_), .b(x32), .c(new_n94_), .O(new_n138_));
  inv1   g094(.a(x00), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n139_), .O(new_n140_));
  oai21  g096(.a(new_n52_), .b(x29), .c(new_n94_), .O(new_n141_));
  ...
  nand2  g100(.a(new_n90_), .b(x31), .O(new_n145_));
  ...
  nor2   g104(.a(new_n94_), .b(x29), .O(new_n149_));
