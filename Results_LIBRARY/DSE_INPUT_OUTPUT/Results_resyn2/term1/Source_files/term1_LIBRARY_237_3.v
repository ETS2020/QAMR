...
module FAU ( 
  ...
  nand2  g000(.a(x26), .b(x08), .O(new_n45_));
  ...
  aoi21  g023(.a(new_n64_), .b(new_n63_), .c(new_n67_), .O(new_n68_));
  oai21  g024(.a(new_n64_), .b(new_n63_), .c(new_n68_), .O(new_n69_));
  ...
  nand3  g036(.a(new_n55_), .b(new_n66_), .c(x25), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(x27), .c(new_n45_), .O(z3));
  ...
  oai21  g057(.a(new_n101_), .b(new_n83_), .c(new_n45_), .O(z6));
  ...
  aoi21  g081(.a(new_n87_), .b(new_n86_), .c(new_n94_), .O(new_n126_));
  ...
  aoi21  g086(.a(new_n50_), .b(new_n99_), .c(new_n126_), .O(new_n131_));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(new_n50_), .O(new_n142_));
  aoi21  g098(.a(new_n131_), .b(new_n130_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n66_), .b(x00), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n129_), .c(new_n144_), .O(z8));
  nand2  g101(.a(x31), .b(x30), .O(new_n146_));
  aoi21  g102(.a(new_n122_), .b(new_n99_), .c(new_n126_), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n126_), .c(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n121_), .b(new_n118_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n47_), .O(new_n150_));
  nor3   g106(.a(new_n140_), .b(new_n139_), .c(new_n47_), .O(new_n151_));
