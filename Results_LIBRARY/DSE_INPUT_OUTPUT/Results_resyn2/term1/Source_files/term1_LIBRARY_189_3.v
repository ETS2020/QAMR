...
module FAU ( 
  ...
  nand3  g038(.a(new_n82_), .b(new_n48_), .c(new_n72_), .O(new_n83_));
  ...
  aoi21  g052(.a(x30), .b(new_n45_), .c(new_n96_), .O(new_n97_));
  aoi21  g053(.a(new_n96_), .b(x30), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g059(.a(new_n91_), .b(x31), .c(new_n103_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n82_), .c(new_n47_), .O(z7));
  ...
  nor3   g082(.a(new_n126_), .b(new_n46_), .c(x09), .O(new_n127_));
  ...
  nor4   g097(.a(new_n141_), .b(new_n47_), .c(x32), .d(new_n120_), .O(new_n142_));
  oai21  g098(.a(new_n140_), .b(new_n139_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n80_), .b(x00), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n130_), .c(new_n144_), .O(z8));
  and2   g101(.a(new_n141_), .b(new_n102_), .O(new_n146_));
  oai21  g102(.a(new_n140_), .b(new_n139_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n51_), .O(new_n148_));
  nor3   g104(.a(new_n122_), .b(new_n121_), .c(new_n51_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n119_), .c(new_n116_), .d(new_n110_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n146_), .c(new_n144_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n48_), .O(z9));
endmodule
