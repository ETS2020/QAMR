...
module FAU ( 
  ...
  nand4  g035(.a(new_n79_), .b(new_n58_), .c(new_n69_), .d(x25), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(x27), .c(new_n68_), .O(z3));
  ...
  oai21  g043(.a(new_n87_), .b(new_n80_), .c(new_n68_), .O(z4));
  ...
  oai21  g048(.a(new_n92_), .b(new_n80_), .c(new_n68_), .O(z5));
  inv1   g049(.a(x30), .O(new_n94_));
  nand2  g050(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nor2   g051(.a(new_n94_), .b(new_n90_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n84_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n80_), .c(new_n68_), .O(z6));
  nand2  g055(.a(new_n80_), .b(new_n68_), .O(new_n100_));
  xor2a  g056(.a(new_n97_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(z7));
  nand2  g058(.a(new_n69_), .b(x00), .O(new_n103_));
  inv1   g059(.a(x17), .O(new_n104_));
  nand3  g060(.a(new_n73_), .b(x18), .c(x14), .O(new_n105_));
  ...
  nor3   g074(.a(new_n118_), .b(new_n73_), .c(x15), .O(new_n119_));
  aoi21  g075(.a(new_n116_), .b(x15), .c(new_n119_), .O(new_n120_));
  nand2  g076(.a(new_n86_), .b(x29), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n94_), .O(new_n122_));
  nand3  g078(.a(new_n86_), .b(x30), .c(x29), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(new_n52_), .O(new_n124_));
  inv1   g080(.a(x15), .O(new_n125_));
  nand2  g081(.a(new_n118_), .b(new_n125_), .O(new_n126_));
  nand3  g082(.a(new_n117_), .b(x16), .c(x15), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  aoi21  g084(.a(new_n113_), .b(new_n112_), .c(new_n73_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n128_), .c(new_n126_), .O(new_n130_));
  nand2  g086(.a(new_n73_), .b(x14), .O(new_n131_));
  nand4  g087(.a(new_n117_), .b(new_n131_), .c(x16), .d(x15), .O(new_n132_));
  nand2  g088(.a(x18), .b(x12), .O(new_n133_));
  oai21  g089(.a(x18), .b(x13), .c(x17), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n96_), .b(x27), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n135_), .c(new_n132_), .d(new_n122_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n130_), .c(x32), .O(new_n138_));
  oai21  g094(.a(new_n124_), .b(new_n120_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x31), .O(new_n140_));
  oai21  g096(.a(new_n94_), .b(new_n90_), .c(x31), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x32), .c(x28), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n140_), .c(new_n103_), .O(z8));
  inv1   g099(.a(x31), .O(new_n144_));
  inv1   g100(.a(new_n103_), .O(new_n145_));
  nor2   g101(.a(new_n48_), .b(x27), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x29), .c(new_n144_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n141_), .c(new_n135_), .d(new_n132_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n130_), .c(x33), .O(new_n150_));
  nand2  g106(.a(new_n123_), .b(x31), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n148_), .c(new_n48_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n120_), .c(new_n150_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n145_), .O(new_n154_));
  oai21  g110(.a(new_n147_), .b(x28), .c(new_n154_), .O(z9));
endmodule
