...
module FAU ( 
  ...
  oai21  g017(.a(new_n51_), .b(new_n55_), .c(new_n61_), .O(new_n62_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n81_), .c(new_n77_), .O(z6));
  inv1   g055(.a(x31), .O(new_n100_));
  xor2a  g056(.a(new_n97_), .b(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n82_), .c(new_n81_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x25), .O(z7));
  ...
  oai21  g078(.a(new_n121_), .b(new_n118_), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n95_), .O(new_n124_));
  nand2  g080(.a(new_n85_), .b(x29), .O(new_n125_));
  ...
  aoi21  g085(.a(new_n50_), .b(new_n95_), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  oai21  g087(.a(new_n116_), .b(x16), .c(x15), .O(new_n132_));
  inv1   g088(.a(x14), .O(new_n133_));
  nor2   g089(.a(x19), .b(new_n133_), .O(new_n134_));
  nand3  g090(.a(new_n119_), .b(x16), .c(x15), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n106_), .O(new_n136_));
  oai21  g092(.a(new_n135_), .b(new_n134_), .c(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n132_), .b(new_n120_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(x18), .b(x12), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n105_), .O(new_n140_));
  inv1   g096(.a(x13), .O(new_n141_));
  nand2  g097(.a(new_n108_), .b(new_n141_), .O(new_n142_));
  ...
  nand2  g104(.a(new_n148_), .b(new_n45_), .O(z8));
  ...
  oai21  g108(.a(new_n121_), .b(new_n118_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n47_), .O(new_n154_));
  aoi21  g110(.a(new_n108_), .b(new_n141_), .c(new_n47_), .O(new_n155_));
  ...
  nand2  g113(.a(new_n157_), .b(new_n45_), .O(z9));
endmodule
