...
module FAU ( 
  ...
  oai22  g020(.a(x24), .b(x19), .c(x21), .d(x16), .O(new_n65_));
  ...
  nor2   g025(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  ...
  nand3  g030(.a(new_n74_), .b(new_n70_), .c(new_n64_), .O(new_n75_));
  inv1   g031(.a(new_n75_), .O(z3));
  inv1   g032(.a(x28), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(new_n64_), .O(new_n78_));
  nor2   g034(.a(new_n77_), .b(new_n64_), .O(new_n79_));
  ...
  nor2   g038(.a(new_n73_), .b(new_n69_), .O(new_n83_));
  nand2  g039(.a(new_n79_), .b(x29), .O(new_n84_));
  inv1   g040(.a(x29), .O(new_n85_));
  nand2  g041(.a(new_n80_), .b(new_n85_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n47_), .O(z5));
  inv1   g044(.a(x30), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(new_n45_), .c(new_n79_), .O(new_n90_));
  oai21  g046(.a(new_n68_), .b(new_n67_), .c(new_n90_), .O(new_n91_));
  inv1   g047(.a(x15), .O(new_n92_));
  nor2   g048(.a(new_n80_), .b(x30), .O(new_n93_));
  oai21  g049(.a(new_n67_), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(new_n91_), .c(new_n85_), .O(new_n95_));
  nor3   g051(.a(new_n69_), .b(new_n89_), .c(x29), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n95_), .c(new_n74_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n47_), .O(z6));
  oai22  g054(.a(new_n84_), .b(new_n89_), .c(new_n46_), .d(x31), .O(new_n99_));
  inv1   g055(.a(x31), .O(new_n100_));
  nand4  g056(.a(new_n79_), .b(new_n100_), .c(x30), .d(x29), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(new_n83_), .O(z7));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n111_), .c(new_n92_), .O(new_n116_));
  ...
  and2   g076(.a(new_n120_), .b(new_n89_), .O(new_n121_));
  nor2   g077(.a(new_n120_), .b(new_n89_), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n121_), .c(new_n100_), .O(new_n123_));
  oai21  g079(.a(new_n119_), .b(new_n116_), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n50_), .O(new_n125_));
  nand2  g081(.a(new_n71_), .b(x00), .O(new_n126_));
  nand3  g082(.a(new_n117_), .b(x16), .c(x15), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  aoi21  g084(.a(new_n113_), .b(new_n112_), .c(new_n104_), .O(new_n129_));
  ...
  nand2  g099(.a(new_n122_), .b(x31), .O(new_n144_));
  nand2  g100(.a(new_n121_), .b(new_n100_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n138_), .O(new_n147_));
  inv1   g103(.a(x33), .O(new_n148_));
  nor2   g104(.a(new_n46_), .b(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g106(.a(new_n121_), .b(new_n100_), .c(new_n45_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n144_), .c(x33), .O(new_n152_));
  oai21  g108(.a(new_n119_), .b(new_n116_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n150_), .c(new_n126_), .O(z9));
endmodule
