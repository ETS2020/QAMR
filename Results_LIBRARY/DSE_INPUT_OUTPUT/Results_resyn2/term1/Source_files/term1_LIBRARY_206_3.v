...
module FAU ( 
  ...
  aoi21  g006(.a(new_n49_), .b(new_n50_), .c(new_n47_), .O(new_n51_));
  ...
  xor2a  g019(.a(new_n63_), .b(new_n54_), .O(new_n64_));
  nor4   g020(.a(new_n64_), .b(new_n47_), .c(x09), .d(new_n53_), .O(z2));
  ...
  aoi21  g033(.a(x03), .b(x02), .c(new_n77_), .O(new_n78_));
  and2   g034(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  ...
  inv1   g051(.a(new_n79_), .O(new_n96_));
  nor2   g052(.a(new_n91_), .b(x30), .O(new_n97_));
  inv1   g053(.a(x30), .O(new_n98_));
  oai21  g054(.a(new_n90_), .b(new_n98_), .c(new_n45_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n97_), .c(new_n96_), .O(z6));
  xor2a  g056(.a(new_n99_), .b(new_n46_), .O(new_n101_));
  oai21  g057(.a(new_n79_), .b(new_n47_), .c(new_n101_), .O(z7));
  inv1   g058(.a(new_n47_), .O(new_n103_));
  ...
  xor2a  g078(.a(new_n122_), .b(new_n98_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n121_), .c(x31), .O(new_n124_));
  oai21  g080(.a(new_n114_), .b(x16), .c(x15), .O(new_n125_));
  ...
  nand2  g084(.a(new_n104_), .b(x14), .O(new_n129_));
  nand4  g085(.a(new_n117_), .b(new_n129_), .c(x16), .d(x15), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(new_n126_), .O(new_n131_));
  nand2  g087(.a(x18), .b(x12), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n70_), .O(new_n133_));
  inv1   g089(.a(x13), .O(new_n134_));
  nand2  g090(.a(new_n106_), .b(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n123_), .d(x31), .O(new_n136_));
  nor2   g092(.a(new_n121_), .b(x26), .O(new_n137_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n103_), .O(z8));
  and2   g097(.a(new_n116_), .b(x15), .O(new_n142_));
  xor2a  g098(.a(new_n122_), .b(new_n46_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n123_), .O(new_n144_));
  oai21  g100(.a(new_n119_), .b(new_n142_), .c(new_n144_), .O(new_n145_));
  ...
  oai21  g104(.a(new_n146_), .b(new_n131_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n145_), .b(new_n50_), .c(new_n149_), .O(z9));
endmodule
