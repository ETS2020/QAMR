...
module FAU ( 
  ...
  nand2  g038(.a(new_n61_), .b(new_n82_), .O(new_n83_));
  inv1   g039(.a(new_n83_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n46_), .c(x25), .O(new_n87_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n102_), .c(new_n88_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z6));
  inv1   g062(.a(new_n102_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n85_), .c(new_n46_), .O(new_n108_));
  ...
  nor2   g082(.a(x32), .b(new_n46_), .O(new_n127_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n103_), .O(new_n129_));
  aoi21  g085(.a(new_n91_), .b(new_n71_), .c(new_n97_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  aoi21  g087(.a(new_n55_), .b(x30), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g089(.a(new_n124_), .b(x16), .c(x15), .O(new_n134_));
  oai21  g090(.a(new_n121_), .b(x16), .c(x19), .O(new_n135_));
  ...
  aoi21  g095(.a(new_n75_), .b(x14), .c(new_n134_), .O(new_n140_));
  aoi21  g096(.a(new_n125_), .b(new_n110_), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n139_), .c(new_n136_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n46_), .c(x32), .O(new_n143_));
  nand2  g099(.a(new_n128_), .b(x30), .O(new_n144_));
  aoi21  g100(.a(new_n55_), .b(new_n103_), .c(new_n130_), .O(new_n145_));
  ...
  nor3   g108(.a(new_n130_), .b(x31), .c(x30), .O(new_n153_));
  aoi21  g109(.a(new_n152_), .b(new_n130_), .c(new_n153_), .O(new_n154_));
  nor2   g110(.a(new_n47_), .b(new_n51_), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n142_), .c(new_n155_), .O(new_n156_));
  or2    g112(.a(new_n126_), .b(new_n123_), .O(new_n157_));
  inv1   g113(.a(new_n153_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x25), .O(new_n159_));
  nor2   g115(.a(new_n154_), .b(x33), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n159_), .c(new_n157_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n156_), .c(new_n148_), .O(z9));
endmodule
