...
module FAU ( 
  ...
  aoi21  g024(.a(x20), .b(new_n45_), .c(x15), .O(new_n69_));
  ...
  oai21  g034(.a(new_n75_), .b(new_n69_), .c(new_n78_), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(x27), .c(new_n48_), .O(z3));
  ...
  oai21  g042(.a(new_n86_), .b(new_n79_), .c(new_n48_), .O(z4));
  oai21  g043(.a(new_n73_), .b(new_n72_), .c(new_n48_), .O(new_n88_));
  inv1   g044(.a(x15), .O(new_n89_));
  aoi21  g045(.a(new_n46_), .b(new_n89_), .c(new_n70_), .O(new_n90_));
  inv1   g046(.a(x29), .O(new_n91_));
  nand2  g047(.a(new_n84_), .b(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n83_), .b(x29), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n92_), .c(new_n78_), .O(new_n94_));
  aoi21  g050(.a(new_n90_), .b(new_n88_), .c(new_n94_), .O(z5));
  nand3  g051(.a(new_n83_), .b(x30), .c(x29), .O(new_n96_));
  inv1   g052(.a(x30), .O(new_n97_));
  nand2  g053(.a(new_n93_), .b(new_n97_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n79_), .c(new_n48_), .O(z6));
  inv1   g056(.a(new_n75_), .O(new_n101_));
  oai21  g057(.a(x20), .b(x15), .c(new_n101_), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  inv1   g059(.a(new_n96_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n103_), .c(new_n78_), .O(new_n105_));
  aoi21  g061(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n102_), .c(new_n47_), .O(z7));
  inv1   g063(.a(x17), .O(new_n108_));
  inv1   g064(.a(x19), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x18), .c(x14), .O(new_n110_));
  nand3  g066(.a(x19), .b(new_n45_), .c(x13), .O(new_n111_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n115_), .c(new_n89_), .O(new_n120_));
  nor2   g076(.a(new_n45_), .b(new_n108_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x16), .c(x10), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n109_), .c(x15), .O(new_n123_));
  nor2   g079(.a(x32), .b(new_n103_), .O(new_n124_));
  oai21  g080(.a(new_n123_), .b(new_n120_), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g087(.a(new_n52_), .b(new_n97_), .c(new_n131_), .O(new_n132_));
  ...
  aoi21  g095(.a(new_n134_), .b(new_n122_), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n48_), .O(z8));
  inv1   g107(.a(x33), .O(new_n152_));
  aoi21  g108(.a(x31), .b(x30), .c(new_n127_), .O(new_n153_));
  nand2  g109(.a(new_n103_), .b(new_n97_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n127_), .c(new_n153_), .O(new_n155_));
  oai21  g111(.a(new_n123_), .b(new_n120_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  aoi21  g113(.a(new_n45_), .b(new_n143_), .c(new_n152_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n155_), .c(new_n142_), .d(new_n140_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n157_), .c(new_n149_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n48_), .O(z9));
endmodule
