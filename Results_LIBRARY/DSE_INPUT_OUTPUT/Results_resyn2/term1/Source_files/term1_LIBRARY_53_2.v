...
module FAU ( 
  ...
  and2   g019(.a(new_n54_), .b(x01), .O(new_n64_));
  ...
  oai21  g025(.a(new_n69_), .b(new_n66_), .c(new_n48_), .O(z2));
  ...
  nor3   g037(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(new_n82_));
  ...
  oai21  g058(.a(new_n93_), .b(x31), .c(new_n45_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x30), .O(new_n104_));
  nand2  g060(.a(new_n100_), .b(x31), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n82_), .O(new_n106_));
  ...
  nor2   g078(.a(new_n112_), .b(new_n73_), .O(new_n123_));
  ...
  aoi21  g086(.a(new_n49_), .b(x30), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g088(.a(new_n128_), .b(x30), .O(new_n133_));
  aoi22  g089(.a(new_n90_), .b(x29), .c(new_n49_), .d(new_n98_), .O(new_n134_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(new_n49_), .O(new_n145_));
  ...
  nand2  g105(.a(new_n126_), .b(new_n98_), .O(new_n150_));
  ...
  nor3   g109(.a(new_n143_), .b(new_n142_), .c(new_n56_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n151_), .c(new_n141_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  aoi21  g112(.a(new_n152_), .b(new_n56_), .c(new_n156_), .O(z9));
endmodule
