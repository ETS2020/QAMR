...
module FAU ( 
  ...
  oai22  g28(.a(x24), .b(x19), .c(x21), .d(x16), .O(new_n73_));
  nor2   g29(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  inv1   g30(.a(x18), .O(new_n75_));
  inv1   g31(.a(x23), .O(new_n76_));
  oai21  g32(.a(new_n75_), .b(x17), .c(new_n76_), .O(new_n77_));
  ...
  nor2   g42(.a(new_n74_), .b(new_n47_), .O(new_n87_));
  oai21  g43(.a(x23), .b(x18), .c(new_n80_), .O(new_n88_));
  nor2   g44(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  inv1   g45(.a(x28), .O(new_n90_));
  nor2   g46(.a(new_n90_), .b(new_n71_), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  nand2  g48(.a(new_n90_), .b(new_n71_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(new_n92_), .c(new_n84_), .O(new_n94_));
  nor2   g50(.a(new_n94_), .b(new_n89_), .O(z4));
  nand2  g51(.a(new_n91_), .b(x29), .O(new_n96_));
  inv1   g52(.a(x29), .O(new_n97_));
  nand2  g53(.a(new_n92_), .b(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n96_), .c(new_n84_), .d(new_n81_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n45_), .O(z5));
  inv1   g56(.a(x30), .O(new_n101_));
  nand2  g57(.a(new_n96_), .b(new_n101_), .O(new_n102_));
  nand3  g58(.a(new_n91_), .b(x30), .c(x29), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n102_), .c(new_n84_), .O(new_n104_));
  nor2   g60(.a(new_n104_), .b(new_n89_), .O(z6));
  aoi21  g61(.a(new_n103_), .b(x31), .c(new_n83_), .O(new_n106_));
  inv1   g62(.a(new_n88_), .O(new_n107_));
  nor2   g63(.a(new_n103_), .b(x31), .O(new_n108_));
  aoi21  g64(.a(new_n107_), .b(new_n74_), .c(new_n108_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n106_), .c(new_n47_), .O(z7));
  nand3  g66(.a(new_n93_), .b(x30), .c(x29), .O(new_n111_));
  nand2  g67(.a(x18), .b(x12), .O(new_n112_));
  nand2  g68(.a(x17), .b(x13), .O(new_n113_));
  nand3  g69(.a(x19), .b(x16), .c(x15), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(new_n112_), .c(new_n114_), .O(new_n115_));
  oai21  g71(.a(x28), .b(x27), .c(x29), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n115_), .c(new_n111_), .d(x31), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n53_), .O(new_n119_));
  and2   g75(.a(new_n117_), .b(new_n115_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n111_), .c(x32), .d(x31), .O(new_n121_));
  inv1   g77(.a(x00), .O(new_n122_));
  nor2   g78(.a(x26), .b(new_n122_), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n121_), .c(new_n119_), .d(new_n45_), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(z8));
  inv1   g81(.a(x31), .O(new_n126_));
  nand3  g82(.a(new_n116_), .b(new_n126_), .c(new_n101_), .O(new_n127_));
  nand4  g83(.a(new_n93_), .b(x31), .c(x30), .d(x29), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g85(.a(x18), .b(new_n78_), .c(x12), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n113_), .c(new_n114_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n129_), .c(new_n49_), .O(new_n132_));
  nand2  g88(.a(new_n115_), .b(new_n49_), .O(new_n133_));
  aoi21  g89(.a(new_n128_), .b(new_n127_), .c(new_n133_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n132_), .c(new_n123_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n45_), .O(z9));
endmodule
