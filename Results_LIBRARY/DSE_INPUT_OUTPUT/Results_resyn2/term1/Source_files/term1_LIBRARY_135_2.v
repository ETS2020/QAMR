...
module FAU ( 
  ...
  nand3  g036(.a(new_n80_), .b(new_n46_), .c(new_n70_), .O(new_n81_));
  ...
  nand2  g049(.a(new_n89_), .b(new_n45_), .O(new_n94_));
  nand3  g050(.a(new_n84_), .b(x30), .c(x29), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n94_), .c(new_n80_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n46_), .O(z6));
  xor2a  g053(.a(new_n95_), .b(x31), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n80_), .c(new_n47_), .O(z7));
  nand2  g055(.a(new_n86_), .b(x29), .O(new_n100_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n117_), .c(new_n101_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  inv1   g077(.a(x10), .O(new_n122_));
  nand4  g078(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n123_));
  nor3   g079(.a(new_n123_), .b(x15), .c(new_n122_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n117_), .c(new_n121_), .O(new_n126_));
  ...
  nand2  g088(.a(new_n113_), .b(new_n112_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n130_), .O(new_n134_));
  nand2  g090(.a(new_n104_), .b(x14), .O(new_n135_));
  inv1   g091(.a(new_n131_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n102_), .O(new_n137_));
  nand2  g093(.a(x32), .b(x31), .O(new_n138_));
  aoi21  g094(.a(new_n119_), .b(new_n101_), .c(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n137_), .b(new_n124_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n78_), .b(x00), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n47_), .O(new_n142_));
  oai21  g098(.a(new_n140_), .b(new_n134_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n127_), .b(new_n54_), .c(new_n143_), .O(z8));
  nand3  g100(.a(x33), .b(new_n45_), .c(new_n122_), .O(new_n145_));
  nor3   g101(.a(x33), .b(new_n121_), .c(new_n45_), .O(new_n146_));
  oai21  g102(.a(new_n124_), .b(new_n116_), .c(new_n146_), .O(new_n147_));
  ...
  nand4  g106(.a(new_n50_), .b(new_n121_), .c(new_n45_), .d(new_n122_), .O(new_n151_));
  ...
  nand2  g110(.a(x31), .b(new_n45_), .O(new_n155_));
  nor2   g111(.a(new_n123_), .b(x15), .O(new_n156_));
  aoi21  g112(.a(new_n155_), .b(new_n137_), .c(new_n156_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n121_), .c(x30), .O(new_n158_));
  nand2  g114(.a(new_n155_), .b(new_n137_), .O(new_n159_));
  aoi22  g115(.a(new_n159_), .b(new_n122_), .c(new_n134_), .d(new_n46_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n158_), .c(new_n50_), .O(new_n161_));
  aoi21  g117(.a(new_n154_), .b(new_n100_), .c(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n149_), .c(new_n141_), .O(z9));
endmodule
