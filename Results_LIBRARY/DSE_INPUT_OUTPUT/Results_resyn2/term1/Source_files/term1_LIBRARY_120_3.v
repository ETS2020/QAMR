...
module FAU ( 
  ...
  nand2  g015(.a(new_n47_), .b(x01), .O(new_n60_));
  ...
  nand2  g021(.a(new_n65_), .b(new_n45_), .O(z2));
  inv1   g022(.a(x27), .O(new_n67_));
  nand2  g023(.a(x03), .b(x02), .O(new_n68_));
  ...
  and2   g034(.a(new_n78_), .b(new_n68_), .O(new_n79_));
  nand2  g035(.a(x25), .b(x01), .O(new_n80_));
  nor2   g036(.a(new_n80_), .b(x26), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n79_), .c(new_n45_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n67_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(z3));
  inv1   g041(.a(x28), .O(new_n86_));
  nor2   g042(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand2  g044(.a(new_n86_), .b(new_n67_), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n88_), .c(new_n83_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z4));
  inv1   g047(.a(new_n79_), .O(new_n92_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n92_), .c(new_n45_), .O(z5));
  ...
  nand2  g058(.a(new_n81_), .b(new_n102_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n79_), .c(new_n50_), .O(z7));
  inv1   g061(.a(x17), .O(new_n106_));
  inv1   g062(.a(x19), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x18), .c(x14), .O(new_n108_));
  nand3  g064(.a(x19), .b(new_n72_), .c(x13), .O(new_n109_));
  ...
  and2   g074(.a(new_n118_), .b(x15), .O(new_n119_));
  nand4  g075(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n120_));
  nor3   g076(.a(new_n120_), .b(new_n107_), .c(x15), .O(new_n121_));
  aoi21  g077(.a(new_n89_), .b(x29), .c(x30), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n102_), .O(new_n123_));
  oai21  g079(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n116_), .b(x16), .c(x15), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n120_), .O(new_n126_));
  nand4  g082(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n127_));
  aoi21  g083(.a(new_n107_), .b(x14), .c(new_n127_), .O(new_n128_));
  aoi21  g084(.a(new_n127_), .b(new_n107_), .c(new_n128_), .O(new_n129_));
  ...
  nand2  g090(.a(x32), .b(x31), .O(new_n135_));
  aoi21  g091(.a(new_n72_), .b(new_n134_), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n133_), .c(new_n131_), .O(new_n137_));
  inv1   g093(.a(x00), .O(new_n138_));
  nor2   g094(.a(x26), .b(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n45_), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  oai21  g097(.a(new_n137_), .b(new_n130_), .c(new_n141_), .O(new_n142_));
  aoi21  g098(.a(new_n124_), .b(new_n49_), .c(new_n142_), .O(z8));
  aoi21  g099(.a(new_n118_), .b(x15), .c(new_n121_), .O(new_n144_));
  nor2   g100(.a(x33), .b(x31), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n122_), .O(new_n146_));
  aoi21  g102(.a(new_n72_), .b(new_n134_), .c(x31), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n133_), .c(new_n122_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n130_), .c(x33), .O(new_n149_));
  oai21  g105(.a(new_n146_), .b(new_n144_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n139_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n45_), .O(z9));
endmodule
