...
module FAU ( 
  ...
  nand3  g026(.a(new_n55_), .b(new_n70_), .c(x25), .O(new_n71_));
  ...
  aoi22  g079(.a(new_n85_), .b(x29), .c(new_n51_), .d(new_n103_), .O(new_n124_));
  ...
  nor2   g097(.a(new_n115_), .b(new_n112_), .O(new_n142_));
  xor2a  g098(.a(new_n120_), .b(x30), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n98_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n142_), .c(new_n141_), .O(new_n145_));
  inv1   g101(.a(new_n98_), .O(new_n146_));
  nor3   g102(.a(new_n129_), .b(new_n146_), .c(new_n141_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n143_), .c(new_n128_), .d(new_n127_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n145_), .c(x18), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n140_), .c(new_n102_), .O(z9));
endmodule
