...
module FAU ( 
  ...
  nand2  g030(.a(new_n45_), .b(new_n74_), .O(new_n75_));
  ...
  nor4   g035(.a(new_n79_), .b(new_n77_), .c(new_n46_), .d(x27), .O(z3));
  inv1   g036(.a(new_n46_), .O(new_n81_));
  nand2  g037(.a(new_n72_), .b(new_n81_), .O(new_n82_));
  ...
  aoi21  g045(.a(new_n82_), .b(new_n75_), .c(new_n89_), .O(z4));
  nand2  g046(.a(x29), .b(x27), .O(new_n91_));
  nand2  g047(.a(new_n73_), .b(x21), .O(new_n92_));
  aoi21  g048(.a(new_n92_), .b(new_n91_), .c(new_n85_), .O(new_n93_));
  aoi21  g049(.a(new_n73_), .b(x16), .c(new_n79_), .O(new_n94_));
  oai21  g050(.a(new_n86_), .b(x29), .c(new_n94_), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n93_), .c(new_n81_), .O(z5));
  inv1   g052(.a(new_n91_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x30), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n92_), .c(new_n85_), .O(new_n99_));
  inv1   g055(.a(x30), .O(new_n100_));
  nand2  g056(.a(new_n97_), .b(x28), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n99_), .c(new_n81_), .O(z6));
  nand2  g060(.a(new_n83_), .b(new_n76_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(x31), .c(new_n45_), .O(new_n107_));
  inv1   g063(.a(x31), .O(new_n108_));
  nand2  g064(.a(new_n98_), .b(new_n108_), .O(new_n109_));
  nor2   g065(.a(new_n108_), .b(new_n100_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n101_), .c(new_n109_), .O(new_n112_));
  aoi22  g068(.a(new_n112_), .b(new_n106_), .c(new_n107_), .d(new_n85_), .O(z7));
  ...
  nand3  g080(.a(new_n124_), .b(x19), .c(new_n74_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nor2   g082(.a(new_n117_), .b(new_n114_), .O(new_n127_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(new_n100_), .O(new_n133_));
  nand2  g089(.a(new_n88_), .b(x29), .O(new_n134_));
  aoi21  g090(.a(new_n131_), .b(x30), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  oai21  g092(.a(new_n132_), .b(new_n130_), .c(x30), .O(new_n137_));
  aoi22  g093(.a(new_n88_), .b(x29), .c(new_n131_), .d(new_n100_), .O(new_n138_));
  ...
  nand2  g099(.a(new_n115_), .b(x14), .O(new_n144_));
  inv1   g100(.a(new_n142_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n143_), .c(new_n141_), .O(new_n147_));
  ...
  nand2  g112(.a(new_n156_), .b(new_n81_), .O(z8));
  inv1   g113(.a(x15), .O(new_n158_));
  aoi21  g114(.a(new_n125_), .b(new_n122_), .c(new_n158_), .O(new_n159_));
  nor2   g115(.a(x31), .b(x30), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n53_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  oai21  g118(.a(new_n129_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n110_), .b(x29), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n160_), .c(new_n150_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n147_), .c(x33), .O(new_n167_));
  oai21  g123(.a(new_n163_), .b(x29), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n81_), .O(new_n169_));
  oai21  g125(.a(new_n130_), .b(new_n111_), .c(new_n53_), .O(new_n170_));
  nand2  g126(.a(x27), .b(new_n45_), .O(new_n171_));
  nand2  g127(.a(x33), .b(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x29), .O(new_n173_));
  aoi21  g129(.a(new_n171_), .b(new_n85_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n172_), .b(new_n163_), .O(new_n175_));
  nor2   g131(.a(new_n88_), .b(x21), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(new_n175_), .c(new_n174_), .d(new_n170_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n169_), .c(new_n154_), .O(z9));
endmodule
