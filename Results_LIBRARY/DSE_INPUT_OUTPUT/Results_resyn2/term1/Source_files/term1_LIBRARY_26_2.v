...
module FAU ( 
  ...
  nor2   g055(.a(new_n93_), .b(x29), .O(new_n100_));
  ...
  nand2  g059(.a(new_n99_), .b(x30), .O(new_n104_));
  ...
  nand2  g063(.a(new_n107_), .b(new_n47_), .O(z6));
  nand2  g064(.a(new_n104_), .b(x31), .O(new_n109_));
  inv1   g065(.a(x31), .O(new_n110_));
  nand3  g066(.a(new_n99_), .b(new_n110_), .c(x30), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n109_), .c(new_n97_), .d(new_n47_), .O(z7));
  nand2  g068(.a(new_n92_), .b(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(x17), .O(new_n115_));
  nand3  g071(.a(new_n78_), .b(x18), .c(x14), .O(new_n116_));
  ...
  nor3   g085(.a(new_n129_), .b(new_n78_), .c(x15), .O(new_n130_));
  aoi21  g086(.a(new_n127_), .b(x15), .c(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n114_), .c(new_n54_), .O(new_n132_));
  oai21  g088(.a(new_n125_), .b(x16), .c(x15), .O(new_n133_));
  and2   g089(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand2  g090(.a(x18), .b(x12), .O(new_n135_));
  oai21  g091(.a(x18), .b(x13), .c(x17), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g093(.a(new_n78_), .b(x14), .O(new_n138_));
  nand3  g094(.a(new_n128_), .b(x16), .c(x15), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g097(.a(new_n139_), .b(new_n78_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n141_), .c(new_n137_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n134_), .O(new_n144_));
  nand3  g100(.a(new_n113_), .b(x32), .c(x31), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n144_), .c(x26), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n132_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(x30), .c(new_n45_), .O(z8));
  nand3  g105(.a(new_n92_), .b(x31), .c(x29), .O(new_n150_));
  or2    g106(.a(new_n150_), .b(new_n131_), .O(new_n151_));
  nor2   g107(.a(new_n150_), .b(new_n50_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(x30), .c(new_n86_), .d(x00), .O(new_n154_));
