...
module FAU ( 
  ...
  nand2  g041(.a(new_n85_), .b(x25), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n70_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z3));
  inv1   g045(.a(x28), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n70_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n90_), .b(new_n70_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n86_), .c(new_n47_), .O(z4));
  ...
  aoi21  g058(.a(new_n101_), .b(x30), .c(new_n102_), .O(new_n103_));
  oai21  g059(.a(new_n101_), .b(x30), .c(new_n103_), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n84_), .O(z6));
  xor2a  g061(.a(new_n103_), .b(x31), .O(new_n106_));
  oai21  g062(.a(new_n85_), .b(new_n46_), .c(new_n106_), .O(z7));
  inv1   g063(.a(x30), .O(new_n108_));
  inv1   g064(.a(x15), .O(new_n109_));
  inv1   g065(.a(x17), .O(new_n110_));
  nand3  g066(.a(new_n74_), .b(x18), .c(x14), .O(new_n111_));
  ...
  nor3   g080(.a(new_n124_), .b(new_n74_), .c(x15), .O(new_n125_));
  nor2   g081(.a(x32), .b(new_n45_), .O(new_n126_));
  oai21  g082(.a(new_n125_), .b(new_n122_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n108_), .O(new_n128_));
  aoi21  g084(.a(new_n90_), .b(new_n70_), .c(new_n97_), .O(new_n129_));
  ...
  nand3  g088(.a(new_n123_), .b(x16), .c(x15), .O(new_n133_));
  oai21  g089(.a(new_n120_), .b(x16), .c(x19), .O(new_n134_));
  ...
  aoi21  g094(.a(new_n74_), .b(x14), .c(new_n133_), .O(new_n139_));
  aoi21  g095(.a(new_n124_), .b(new_n109_), .c(new_n139_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n138_), .c(new_n135_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n45_), .c(x32), .O(new_n142_));
  nand2  g098(.a(new_n127_), .b(x30), .O(new_n143_));
  aoi21  g099(.a(new_n54_), .b(new_n108_), .c(new_n129_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n142_), .c(new_n132_), .O(new_n146_));
  ...
  nor2   g106(.a(new_n45_), .b(new_n108_), .O(new_n151_));
  nor3   g107(.a(new_n129_), .b(x31), .c(x30), .O(new_n152_));
  aoi21  g108(.a(new_n151_), .b(new_n129_), .c(new_n152_), .O(new_n153_));
  nor2   g109(.a(new_n46_), .b(new_n50_), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n141_), .c(new_n154_), .O(new_n155_));
  or2    g111(.a(new_n125_), .b(new_n122_), .O(new_n156_));
  inv1   g112(.a(new_n152_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n102_), .O(new_n158_));
  nor2   g114(.a(new_n153_), .b(x33), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n158_), .c(new_n156_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n155_), .c(new_n147_), .O(z9));
endmodule
