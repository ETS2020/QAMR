...
module FAU ( 
  ...
  nand3  g033(.a(new_n56_), .b(new_n45_), .c(x25), .O(new_n78_));
  ...
  oai21  g043(.a(new_n87_), .b(new_n80_), .c(new_n47_), .O(z4));
  ...
  oai21  g048(.a(new_n92_), .b(new_n80_), .c(new_n47_), .O(z5));
  ...
  xor2a  g057(.a(new_n101_), .b(new_n46_), .O(z7));
  inv1   g058(.a(x15), .O(new_n103_));
  inv1   g059(.a(x17), .O(new_n104_));
  nand3  g060(.a(new_n71_), .b(x18), .c(x14), .O(new_n105_));
  ...
  nor2   g072(.a(new_n106_), .b(new_n104_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x16), .c(x10), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n71_), .c(x15), .O(new_n119_));
  ...
  aoi21  g080(.a(new_n51_), .b(x30), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g082(.a(new_n122_), .b(x30), .O(new_n127_));
  aoi22  g083(.a(new_n86_), .b(x29), .c(new_n51_), .d(new_n95_), .O(new_n128_));
  ...
  nand2  g088(.a(new_n132_), .b(new_n71_), .O(new_n133_));
  ...
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n51_), .O(new_n139_));
  ...
  aoi21  g099(.a(x31), .b(x30), .c(new_n124_), .O(new_n144_));
  nand2  g100(.a(new_n120_), .b(new_n95_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n124_), .c(new_n144_), .O(new_n146_));
  oai21  g102(.a(new_n119_), .b(new_n116_), .c(new_n146_), .O(new_n147_));
  inv1   g103(.a(new_n141_), .O(new_n148_));
  nor3   g104(.a(new_n137_), .b(new_n136_), .c(new_n143_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n146_), .c(new_n135_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g107(.a(new_n147_), .b(new_n143_), .c(new_n151_), .O(z9));
endmodule
