...
module FAU ( 
  ...
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n85_), .d(new_n47_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z4));
  nand2  g049(.a(new_n88_), .b(x29), .O(new_n94_));
  nand2  g050(.a(new_n89_), .b(new_n45_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n83_), .c(new_n47_), .O(z5));
  ...
  oai21  g057(.a(new_n101_), .b(new_n83_), .c(new_n47_), .O(z6));
  aoi21  g058(.a(new_n100_), .b(x31), .c(new_n46_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n85_), .O(z7));
  inv1   g060(.a(x31), .O(new_n105_));
  nor2   g061(.a(new_n51_), .b(new_n98_), .O(new_n106_));
  ...
  nand3  g068(.a(new_n73_), .b(x18), .c(x14), .O(new_n113_));
  ...
  nor2   g080(.a(new_n114_), .b(new_n112_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x16), .c(x10), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n73_), .c(x15), .O(new_n127_));
  aoi21  g083(.a(new_n124_), .b(x15), .c(new_n127_), .O(new_n128_));
  nand2  g084(.a(x31), .b(x30), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n128_), .c(new_n51_), .O(new_n130_));
  nor2   g086(.a(new_n90_), .b(new_n45_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n106_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  aoi21  g089(.a(new_n121_), .b(new_n120_), .c(new_n73_), .O(new_n134_));
  ...
  nand2  g097(.a(new_n126_), .b(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n73_), .b(x14), .O(new_n143_));
  ...
  nand2  g102(.a(new_n51_), .b(new_n98_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n128_), .c(new_n107_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n131_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n146_), .c(new_n133_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n111_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n110_), .O(z8));
  oai21  g108(.a(new_n145_), .b(new_n137_), .c(new_n47_), .O(new_n153_));
  nand2  g109(.a(new_n91_), .b(x30), .O(new_n154_));
  aoi22  g110(.a(new_n154_), .b(x31), .c(x30), .d(new_n45_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x33), .O(new_n157_));
  inv1   g113(.a(x33), .O(new_n158_));
  nor3   g114(.a(new_n129_), .b(new_n90_), .c(new_n45_), .O(new_n159_));
  nor3   g115(.a(x31), .b(x30), .c(x29), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n158_), .O(new_n161_));
  or2    g117(.a(new_n161_), .b(new_n128_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n157_), .c(new_n108_), .O(z9));
endmodule
