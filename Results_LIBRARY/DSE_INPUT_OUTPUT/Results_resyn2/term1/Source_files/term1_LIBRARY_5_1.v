...
module FAU ( 
  ...
  aoi22  g030(.a(new_n45_), .b(new_n73_), .c(new_n74_), .d(new_n72_), .O(new_n75_));
  ...
  nand3  g058(.a(new_n90_), .b(x30), .c(x29), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n102_), .c(new_n100_), .d(new_n47_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z6));
  xor2a  g061(.a(new_n103_), .b(x31), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n100_), .c(new_n46_), .O(z7));
  inv1   g063(.a(x15), .O(new_n108_));
  inv1   g064(.a(x17), .O(new_n109_));
  nand3  g065(.a(new_n73_), .b(x18), .c(x14), .O(new_n110_));
  nand3  g066(.a(x19), .b(new_n72_), .c(x13), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  nand4  g068(.a(x19), .b(x18), .c(new_n109_), .d(x12), .O(new_n113_));
  ...
  nand3  g073(.a(new_n117_), .b(x19), .c(new_n76_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n115_), .c(new_n108_), .O(new_n119_));
  nor2   g075(.a(new_n72_), .b(new_n109_), .O(new_n120_));
  ...
  aoi21  g082(.a(new_n89_), .b(new_n88_), .c(new_n96_), .O(new_n127_));
  ...
  aoi21  g087(.a(new_n54_), .b(new_n101_), .c(new_n127_), .O(new_n132_));
  ...
  nand3  g100(.a(new_n47_), .b(new_n83_), .c(x00), .O(new_n145_));
  aoi21  g101(.a(new_n144_), .b(new_n130_), .c(new_n145_), .O(z8));
  nand2  g102(.a(x31), .b(x30), .O(new_n147_));
  aoi21  g103(.a(new_n123_), .b(new_n101_), .c(new_n127_), .O(new_n148_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n151_), .c(new_n83_), .d(x00), .O(new_n154_));
