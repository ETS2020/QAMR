...
module FAU ( 
  ...
  aoi21  g001(.a(x26), .b(new_n45_), .c(x32), .O(z0));
  nand2  g002(.a(x26), .b(new_n45_), .O(new_n47_));
  ...
  aoi22  g029(.a(new_n73_), .b(new_n72_), .c(new_n45_), .d(new_n71_), .O(new_n74_));
  ...
  and2   g034(.a(new_n78_), .b(new_n49_), .O(new_n79_));
  nand2  g035(.a(x25), .b(x01), .O(new_n80_));
  nor2   g036(.a(new_n80_), .b(x26), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n79_), .c(new_n70_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(z3));
  inv1   g039(.a(x28), .O(new_n84_));
  nor2   g040(.a(new_n84_), .b(new_n70_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nor2   g042(.a(x28), .b(x27), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n86_), .c(new_n81_), .d(new_n79_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z4));
  nand2  g046(.a(new_n81_), .b(new_n79_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  inv1   g048(.a(x29), .O(new_n93_));
  nand2  g049(.a(new_n86_), .b(new_n93_), .O(new_n94_));
  nand2  g050(.a(new_n85_), .b(x29), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n94_), .c(new_n92_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z5));
  inv1   g053(.a(new_n78_), .O(new_n98_));
  nand2  g054(.a(new_n45_), .b(new_n71_), .O(new_n99_));
  inv1   g055(.a(x30), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(x26), .O(new_n102_));
  aoi21  g058(.a(x03), .b(x02), .c(new_n80_), .O(new_n103_));
  nand2  g059(.a(new_n95_), .b(new_n100_), .O(new_n104_));
  nand3  g060(.a(new_n85_), .b(x30), .c(x29), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n102_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n98_), .c(new_n47_), .O(z6));
  xor2a  g063(.a(new_n105_), .b(x31), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n92_), .O(z7));
  ...
  nand3  g076(.a(new_n120_), .b(x19), .c(new_n71_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n118_), .c(new_n110_), .O(new_n122_));
  nor2   g078(.a(new_n113_), .b(new_n111_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x16), .c(x10), .O(new_n124_));
  nor3   g080(.a(new_n124_), .b(new_n72_), .c(x15), .O(new_n125_));
  ...
  nor2   g085(.a(new_n87_), .b(new_n93_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  aoi21  g087(.a(new_n48_), .b(x30), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand2  g089(.a(new_n128_), .b(x30), .O(new_n134_));
  aoi21  g090(.a(new_n48_), .b(new_n100_), .c(new_n130_), .O(new_n135_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n72_), .O(new_n140_));
  nand2  g096(.a(new_n72_), .b(x14), .O(new_n141_));
  ...
  nand2  g103(.a(new_n113_), .b(new_n147_), .O(new_n148_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n47_), .O(z8));
  nand2  g111(.a(new_n126_), .b(new_n100_), .O(new_n156_));
  nand3  g112(.a(new_n101_), .b(new_n88_), .c(x31), .O(new_n157_));
  oai21  g113(.a(new_n156_), .b(new_n130_), .c(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n125_), .b(new_n122_), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n158_), .b(new_n148_), .c(new_n146_), .d(x33), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n144_), .c(new_n153_), .O(new_n161_));
  aoi21  g117(.a(new_n159_), .b(new_n55_), .c(new_n161_), .O(z9));
endmodule
