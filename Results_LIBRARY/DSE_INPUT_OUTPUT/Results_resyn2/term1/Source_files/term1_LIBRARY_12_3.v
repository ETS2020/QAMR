...
module FAU ( 
  ...
  aoi21  g080(.a(new_n80_), .b(new_n67_), .c(new_n87_), .O(new_n125_));
  aoi21  g081(.a(new_n120_), .b(new_n92_), .c(new_n125_), .O(new_n126_));
  ...
  aoi21  g100(.a(new_n116_), .b(new_n92_), .c(new_n125_), .O(new_n145_));
