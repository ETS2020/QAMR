...
module FAU ( 
  ...
  nor2   g005(.a(z0), .b(new_n49_), .O(new_n50_));
  ...
  nand3  g037(.a(new_n81_), .b(new_n51_), .c(new_n71_), .O(new_n82_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n101_), .c(new_n81_), .d(new_n51_), .O(z7));
  ...
  nand2  g079(.a(new_n123_), .b(new_n49_), .O(new_n124_));
  nand2  g080(.a(z0), .b(new_n49_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n87_), .c(x29), .O(new_n126_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n120_), .c(new_n133_), .O(new_n134_));
  nor2   g090(.a(new_n123_), .b(new_n102_), .O(new_n135_));
  nand2  g091(.a(x18), .b(x12), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n106_), .O(new_n137_));
  inv1   g093(.a(x13), .O(new_n138_));
  nand2  g094(.a(new_n109_), .b(new_n138_), .O(new_n139_));
  and2   g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n135_), .c(new_n134_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  oai21  g098(.a(new_n127_), .b(new_n122_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n79_), .b(x00), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n51_), .O(z8));
  nand2  g103(.a(new_n135_), .b(x30), .O(new_n148_));
  nand3  g104(.a(new_n123_), .b(new_n102_), .c(new_n49_), .O(new_n149_));
  and2   g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n122_), .c(new_n52_), .O(new_n151_));
  nand3  g107(.a(new_n139_), .b(new_n137_), .c(x33), .O(new_n152_));
  aoi21  g108(.a(new_n149_), .b(new_n148_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n134_), .c(new_n144_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n51_), .O(z9));
endmodule
