...
module FAU ( 
  ...
  nand3  g023(.a(new_n55_), .b(new_n67_), .c(x25), .O(new_n68_));
  ...
  oai21  g032(.a(x20), .b(x15), .c(new_n76_), .O(new_n77_));
  or2    g033(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand2  g034(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(x27), .c(new_n46_), .O(z3));
  ...
  oai21  g053(.a(new_n97_), .b(new_n79_), .c(new_n46_), .O(z6));
  aoi22  g054(.a(new_n76_), .b(x20), .c(x18), .d(x15), .O(new_n99_));
  nor2   g055(.a(new_n94_), .b(x31), .O(new_n100_));
  nand2  g056(.a(new_n94_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n69_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n100_), .c(new_n46_), .O(new_n103_));
  oai21  g059(.a(new_n99_), .b(new_n73_), .c(new_n103_), .O(z7));
  ...
  nand3  g064(.a(x19), .b(new_n74_), .c(x13), .O(new_n109_));
  ...
  nor3   g075(.a(new_n119_), .b(new_n107_), .c(x15), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nor2   g077(.a(x32), .b(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n120_), .b(new_n118_), .c(new_n122_), .O(new_n123_));
  ...
  aoi22  g087(.a(new_n119_), .b(new_n105_), .c(new_n115_), .d(new_n114_), .O(new_n132_));
  nand4  g088(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n107_), .O(new_n134_));
  nand2  g090(.a(new_n107_), .b(x14), .O(new_n135_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n106_), .O(new_n140_));
  inv1   g096(.a(x13), .O(new_n141_));
  nand2  g097(.a(new_n74_), .b(new_n141_), .O(new_n142_));
  ...
  nand2  g101(.a(new_n67_), .b(x00), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n46_), .O(z8));
  or2    g105(.a(new_n120_), .b(new_n118_), .O(new_n150_));
  aoi21  g106(.a(x31), .b(x30), .c(new_n125_), .O(new_n151_));
  nand2  g107(.a(new_n121_), .b(new_n95_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n125_), .c(new_n151_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n150_), .c(x33), .O(new_n154_));
  nand4  g110(.a(new_n153_), .b(new_n142_), .c(new_n140_), .d(x33), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n138_), .c(new_n147_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(new_n46_), .O(z9));
endmodule
