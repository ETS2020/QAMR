...
module FAU ( 
  ...
  nand3  g030(.a(new_n48_), .b(x25), .c(x01), .O(new_n75_));
  aoi21  g031(.a(new_n74_), .b(new_n70_), .c(new_n75_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(x33), .c(new_n67_), .O(new_n77_));
  ...
  nor2   g037(.a(new_n81_), .b(new_n66_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n81_), .b(new_n66_), .O(new_n84_));
  nand3  g040(.a(new_n84_), .b(new_n83_), .c(new_n76_), .O(new_n85_));
  aoi21  g041(.a(new_n85_), .b(x33), .c(x26), .O(z4));
  nand2  g042(.a(new_n82_), .b(x29), .O(new_n87_));
  inv1   g043(.a(x29), .O(new_n88_));
  nand2  g044(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n87_), .c(new_n76_), .O(new_n90_));
  aoi21  g046(.a(new_n90_), .b(x33), .c(x26), .O(z5));
  ...
  nand2  g054(.a(new_n98_), .b(x33), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n67_), .O(z7));
  ...
  nand2  g078(.a(new_n84_), .b(x29), .O(new_n123_));
  ...
  nand2  g085(.a(new_n117_), .b(new_n101_), .O(new_n130_));
  aoi21  g086(.a(new_n112_), .b(new_n111_), .c(new_n103_), .O(new_n131_));
  ...
  nand2  g090(.a(new_n103_), .b(x14), .O(new_n135_));
  nand2  g091(.a(x18), .b(x12), .O(new_n136_));
  oai21  g092(.a(x18), .b(x13), .c(x17), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n136_), .c(new_n133_), .d(new_n135_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x31), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n134_), .c(x32), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n129_), .c(new_n125_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x00), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(x33), .c(x26), .O(z8));
  oai21  g099(.a(new_n123_), .b(new_n119_), .c(x30), .O(new_n144_));
  oai21  g100(.a(new_n127_), .b(x31), .c(new_n92_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n144_), .c(new_n138_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n134_), .O(new_n147_));
  nand3  g103(.a(x33), .b(new_n67_), .c(x00), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n147_), .O(z9));
endmodule
