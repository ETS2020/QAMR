...
module FAU ( 
  ...
  aoi21  g039(.a(new_n83_), .b(x31), .c(x26), .O(z3));
  ...
  nor2   g044(.a(new_n85_), .b(new_n68_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n82_), .O(new_n91_));
  ...
  aoi21  g057(.a(new_n101_), .b(x31), .c(x26), .O(z6));
  inv1   g058(.a(x26), .O(new_n103_));
  oai21  g059(.a(new_n100_), .b(new_n81_), .c(x31), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(z7));
  ...
  aoi21  g079(.a(new_n85_), .b(new_n68_), .c(new_n94_), .O(new_n124_));
  nand2  g080(.a(x32), .b(new_n98_), .O(new_n125_));
