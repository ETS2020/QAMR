...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n163_;
  nand2  g000(.a(x31), .b(x18), .O(new_n45_));
  ...
  nand3  g036(.a(new_n80_), .b(new_n77_), .c(new_n70_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n45_), .O(z3));
  nand2  g038(.a(new_n77_), .b(new_n45_), .O(new_n83_));
  ...
  or2    g044(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z4));
  nand2  g046(.a(new_n85_), .b(x29), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nor2   g048(.a(new_n85_), .b(x29), .O(new_n93_));
  nor4   g049(.a(new_n93_), .b(new_n92_), .c(new_n83_), .d(new_n79_), .O(z5));
  nor2   g050(.a(new_n92_), .b(x30), .O(new_n95_));
  nand2  g051(.a(new_n92_), .b(x30), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  nor4   g053(.a(new_n97_), .b(new_n95_), .c(new_n83_), .d(new_n79_), .O(z6));
  inv1   g054(.a(x31), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(x18), .c(new_n97_), .O(new_n100_));
  nand2  g056(.a(new_n96_), .b(x31), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(new_n80_), .d(new_n77_), .O(z7));
  inv1   g058(.a(x18), .O(new_n103_));
  inv1   g059(.a(x30), .O(new_n104_));
  nand2  g060(.a(x16), .b(x15), .O(new_n105_));
  nand3  g061(.a(x19), .b(x17), .c(x13), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x31), .c(new_n104_), .O(new_n108_));
  oai21  g064(.a(x28), .b(x27), .c(x29), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  oai21  g066(.a(new_n50_), .b(x30), .c(new_n110_), .O(new_n111_));
  aoi21  g067(.a(new_n108_), .b(new_n50_), .c(new_n111_), .O(new_n112_));
  nand2  g068(.a(x31), .b(x30), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(x32), .O(new_n114_));
  aoi22  g070(.a(new_n114_), .b(new_n107_), .c(x32), .d(new_n104_), .O(new_n115_));
  oai22  g071(.a(new_n115_), .b(new_n110_), .c(new_n107_), .d(new_n50_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n112_), .c(new_n103_), .O(new_n117_));
  nand2  g073(.a(x32), .b(new_n99_), .O(new_n118_));
  nand2  g074(.a(new_n78_), .b(x00), .O(new_n119_));
  aoi21  g075(.a(new_n118_), .b(new_n117_), .c(new_n119_), .O(z8));
  inv1   g076(.a(new_n119_), .O(new_n121_));
  nand2  g077(.a(x16), .b(x10), .O(new_n122_));
  nand2  g078(.a(x15), .b(x11), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g080(.a(x18), .b(x17), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n124_), .c(new_n105_), .d(x19), .O(new_n127_));
  inv1   g083(.a(new_n105_), .O(new_n128_));
  inv1   g084(.a(x17), .O(new_n129_));
  inv1   g085(.a(x19), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x18), .c(x14), .O(new_n131_));
  nand4  g087(.a(new_n99_), .b(x19), .c(new_n103_), .d(x13), .O(new_n132_));
  ...
  nand3  g092(.a(new_n109_), .b(new_n47_), .c(new_n104_), .O(new_n137_));
  aoi21  g093(.a(new_n136_), .b(new_n127_), .c(new_n137_), .O(new_n138_));
  inv1   g094(.a(x13), .O(new_n139_));
  nor2   g095(.a(x18), .b(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n130_), .b(x14), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n128_), .c(x17), .O(new_n142_));
  nor2   g098(.a(x30), .b(new_n103_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n142_), .c(new_n140_), .O(new_n144_));
  nand2  g100(.a(new_n109_), .b(x31), .O(new_n145_));
  aoi21  g101(.a(x18), .b(x12), .c(x17), .O(new_n146_));
  xor2a  g102(.a(x31), .b(x30), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g104(.a(new_n125_), .b(new_n105_), .c(new_n130_), .O(new_n149_));
  inv1   g105(.a(x15), .O(new_n150_));
  inv1   g106(.a(x16), .O(new_n151_));
  nand3  g107(.a(x18), .b(x17), .c(x11), .O(new_n152_));
  nand4  g108(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(new_n150_), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n149_), .c(new_n148_), .d(new_n145_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n144_), .c(x33), .O(new_n156_));
  oai21  g112(.a(new_n99_), .b(x18), .c(x33), .O(new_n157_));
  nor2   g113(.a(new_n113_), .b(x33), .O(new_n158_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n138_), .c(new_n121_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n45_), .O(z9));
endmodule
