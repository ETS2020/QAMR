...
module FAU ( 
  ...
  nand3  g038(.a(new_n82_), .b(new_n81_), .c(new_n75_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n78_), .O(z4));
  ...
  nand2  g051(.a(new_n95_), .b(new_n75_), .O(z7));
  ...
  nand2  g078(.a(new_n117_), .b(x30), .O(new_n123_));
  inv1   g079(.a(new_n120_), .O(new_n124_));
  aoi21  g080(.a(new_n119_), .b(new_n91_), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  oai21  g082(.a(new_n109_), .b(x16), .c(x15), .O(new_n127_));
  ...
  aoi21  g088(.a(new_n127_), .b(new_n113_), .c(new_n132_), .O(new_n133_));
  nand2  g089(.a(x18), .b(x12), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n98_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  nand2  g092(.a(new_n101_), .b(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n133_), .d(x31), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x32), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n126_), .c(new_n122_), .O(new_n140_));
  nand2  g096(.a(new_n45_), .b(x00), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n78_), .O(z8));
  aoi21  g100(.a(x31), .b(x30), .c(new_n120_), .O(new_n145_));
  nand2  g101(.a(new_n115_), .b(new_n91_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n120_), .c(new_n145_), .O(new_n147_));
  oai21  g103(.a(new_n114_), .b(new_n111_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n53_), .O(new_n149_));
  aoi21  g105(.a(new_n101_), .b(new_n136_), .c(new_n53_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n147_), .c(new_n135_), .d(new_n133_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n142_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n78_), .O(z9));
endmodule
