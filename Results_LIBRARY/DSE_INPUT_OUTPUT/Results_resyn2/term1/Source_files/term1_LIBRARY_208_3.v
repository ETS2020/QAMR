...
module FAU ( 
  ...
  aoi21  g018(.a(x05), .b(new_n51_), .c(new_n62_), .O(new_n63_));
  nand3  g019(.a(new_n62_), .b(x05), .c(new_n51_), .O(new_n64_));
  nand2  g020(.a(new_n64_), .b(new_n58_), .O(new_n65_));
  oai21  g021(.a(new_n65_), .b(new_n63_), .c(new_n60_), .O(new_n66_));
  ...
  nand2  g043(.a(new_n87_), .b(new_n48_), .O(z3));
  inv1   g044(.a(x28), .O(new_n89_));
  nor2   g045(.a(new_n89_), .b(new_n73_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n89_), .b(new_n73_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n91_), .c(new_n86_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n48_), .O(z4));
  ...
  nand2  g054(.a(new_n98_), .b(new_n48_), .O(z5));
  ...
  nand3  g059(.a(new_n103_), .b(new_n101_), .c(new_n86_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n48_), .O(z6));
  inv1   g061(.a(new_n103_), .O(new_n106_));
  oai21  g062(.a(new_n46_), .b(x08), .c(new_n106_), .O(new_n107_));
  nand2  g063(.a(new_n103_), .b(x31), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n86_), .O(z7));
  ...
  nor2   g083(.a(new_n127_), .b(new_n46_), .O(new_n128_));
  oai21  g084(.a(new_n125_), .b(new_n123_), .c(new_n128_), .O(new_n129_));
  and2   g085(.a(x18), .b(x17), .O(new_n130_));
  nand2  g086(.a(new_n120_), .b(new_n119_), .O(new_n131_));
  and2   g087(.a(x16), .b(x15), .O(new_n132_));
  aoi22  g088(.a(new_n132_), .b(new_n130_), .c(new_n131_), .d(x19), .O(new_n133_));
  nand2  g089(.a(x18), .b(x12), .O(new_n134_));
  oai21  g090(.a(x18), .b(x13), .c(x17), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g092(.a(new_n124_), .b(new_n110_), .O(new_n137_));
  nand2  g093(.a(new_n76_), .b(x14), .O(new_n138_));
  nand3  g094(.a(new_n132_), .b(new_n130_), .c(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n137_), .c(new_n136_), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n133_), .O(new_n141_));
  nor2   g097(.a(new_n127_), .b(new_n54_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n141_), .c(x08), .O(new_n143_));
  nand2  g099(.a(new_n84_), .b(x00), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  oai21  g101(.a(new_n143_), .b(new_n46_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n129_), .b(new_n54_), .c(new_n146_), .O(z8));
  nand3  g103(.a(new_n126_), .b(new_n46_), .c(new_n100_), .O(new_n148_));
  nor2   g104(.a(new_n126_), .b(new_n100_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x31), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n141_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n48_), .c(x33), .O(new_n153_));
  nand3  g109(.a(new_n149_), .b(x31), .c(new_n45_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n148_), .c(x33), .O(new_n155_));
  oai21  g111(.a(new_n125_), .b(new_n123_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n153_), .c(new_n144_), .O(z9));
endmodule
