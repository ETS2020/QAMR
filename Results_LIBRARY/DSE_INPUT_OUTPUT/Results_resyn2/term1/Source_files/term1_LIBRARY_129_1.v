...
module FAU ( 
  ...
  nand3  g066(.a(new_n110_), .b(new_n90_), .c(x29), .O(new_n111_));
  nand2  g067(.a(new_n98_), .b(x31), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n111_), .c(new_n97_), .O(z7));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n78_), .O(new_n119_));
  nand4  g075(.a(x19), .b(x18), .c(new_n78_), .d(x12), .O(new_n120_));
  ...
  nor2   g083(.a(new_n78_), .b(new_n123_), .O(new_n128_));
  ...
  oai21  g097(.a(new_n129_), .b(new_n115_), .c(new_n114_), .O(new_n142_));
  ...
  aoi21  g106(.a(new_n54_), .b(new_n103_), .c(new_n150_), .O(new_n151_));
  ...
  nand3  g114(.a(new_n50_), .b(x19), .c(new_n115_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n128_), .b(x15), .c(x13), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n160_), .c(new_n109_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n158_), .c(x22), .O(new_n164_));
  nand4  g120(.a(x19), .b(x17), .c(new_n123_), .d(x11), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n78_), .b(x12), .O(new_n167_));
  oai21  g123(.a(x19), .b(x17), .c(x16), .O(new_n168_));
  aoi21  g124(.a(new_n167_), .b(new_n145_), .c(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n166_), .c(x15), .O(new_n170_));
  nand4  g126(.a(new_n128_), .b(x19), .c(new_n114_), .d(x10), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(x33), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n109_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n158_), .c(new_n115_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n164_), .c(new_n135_), .O(new_n175_));
  nor2   g131(.a(new_n50_), .b(x30), .O(new_n176_));
  nand2  g132(.a(new_n162_), .b(new_n108_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n159_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n176_), .c(new_n45_), .O(new_n179_));
  aoi21  g135(.a(new_n172_), .b(new_n108_), .c(new_n176_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n115_), .c(new_n179_), .O(new_n181_));
  nor2   g137(.a(new_n143_), .b(new_n145_), .O(new_n182_));
  nand2  g138(.a(new_n143_), .b(x19), .O(new_n183_));
  aoi21  g139(.a(new_n129_), .b(new_n114_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(x17), .b(x11), .c(x16), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n138_), .O(new_n186_));
  oai21  g142(.a(new_n184_), .b(new_n182_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x18), .O(new_n188_));
  nand2  g144(.a(new_n162_), .b(x19), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n115_), .c(new_n110_), .O(new_n190_));
  nand2  g146(.a(new_n47_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n190_), .b(new_n188_), .c(new_n191_), .O(new_n192_));
  aoi21  g148(.a(new_n181_), .b(new_n150_), .c(new_n192_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n175_), .c(new_n154_), .O(z9));
endmodule
