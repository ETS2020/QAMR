...
module FAU ( 
  ...
  and2   g019(.a(new_n53_), .b(x01), .O(new_n64_));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n74_), .O(new_n110_));
  nand4  g066(.a(x19), .b(x18), .c(new_n74_), .d(x12), .O(new_n111_));
  ...
  nor2   g074(.a(new_n108_), .b(new_n74_), .O(new_n119_));
  ...
  nand2  g082(.a(new_n89_), .b(x29), .O(new_n127_));
  ...
  aoi21  g099(.a(new_n132_), .b(new_n130_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n46_), .b(x00), .O(new_n145_));
  aoi21  g101(.a(new_n144_), .b(new_n129_), .c(new_n145_), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n127_), .O(new_n147_));
  nand2  g103(.a(new_n122_), .b(new_n99_), .O(new_n148_));
  ...
  nor3   g107(.a(new_n141_), .b(new_n140_), .c(new_n55_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n149_), .c(new_n139_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n46_), .c(new_n45_), .O(z9));
endmodule
