...
module FAU ( 
  ...
  nand2  g042(.a(new_n86_), .b(new_n46_), .O(z3));
  ...
  nand4  g052(.a(new_n96_), .b(new_n95_), .c(new_n85_), .d(new_n46_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z5));
  nand2  g054(.a(new_n96_), .b(new_n45_), .O(new_n99_));
  nand3  g055(.a(new_n89_), .b(x30), .c(x29), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n99_), .c(new_n85_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n46_), .O(z6));
  xor2a  g058(.a(new_n100_), .b(x31), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n85_), .O(z7));
  nand2  g060(.a(new_n91_), .b(x29), .O(new_n105_));
  ...
  nor3   g076(.a(new_n120_), .b(new_n75_), .c(x15), .O(new_n121_));
  aoi21  g077(.a(new_n119_), .b(x15), .c(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n106_), .c(new_n54_), .O(new_n123_));
  nand2  g079(.a(new_n83_), .b(x00), .O(new_n124_));
  nand2  g080(.a(new_n116_), .b(new_n115_), .O(new_n125_));
  ...
  nand2  g088(.a(new_n120_), .b(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n75_), .b(x14), .O(new_n134_));
  nand2  g090(.a(new_n127_), .b(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n131_), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n128_), .O(new_n137_));
  nand3  g093(.a(new_n105_), .b(x32), .c(x31), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n137_), .c(new_n124_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n123_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n46_), .O(z8));
  aoi21  g098(.a(new_n118_), .b(new_n114_), .c(new_n132_), .O(new_n143_));
  nor2   g099(.a(new_n105_), .b(x31), .O(new_n144_));
  aoi21  g100(.a(new_n105_), .b(x30), .c(new_n144_), .O(new_n145_));
  oai21  g101(.a(new_n121_), .b(new_n143_), .c(new_n145_), .O(new_n146_));
  inv1   g102(.a(new_n124_), .O(new_n147_));
  inv1   g103(.a(new_n145_), .O(new_n148_));
  aoi21  g104(.a(new_n137_), .b(x33), .c(new_n48_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n147_), .O(new_n150_));
  aoi21  g106(.a(new_n146_), .b(new_n50_), .c(new_n150_), .O(z9));
endmodule
