...
module FAU ( 
  ...
  oai21  g028(.a(x23), .b(x18), .c(x15), .O(new_n73_));
  ...
  aoi22  g043(.a(new_n87_), .b(new_n86_), .c(new_n45_), .d(new_n85_), .O(new_n88_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n115_), .c(new_n85_), .O(new_n120_));
  nor2   g076(.a(new_n86_), .b(new_n108_), .O(new_n121_));
  ...
  nand2  g083(.a(new_n93_), .b(x29), .O(new_n128_));
  aoi21  g084(.a(new_n54_), .b(x30), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g086(.a(new_n126_), .b(x30), .O(new_n131_));
  inv1   g087(.a(new_n128_), .O(new_n132_));
  aoi21  g088(.a(new_n54_), .b(new_n102_), .c(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  oai21  g090(.a(new_n118_), .b(x16), .c(x15), .O(new_n135_));
  ...
  aoi21  g096(.a(new_n135_), .b(new_n122_), .c(new_n140_), .O(new_n141_));
  ...
  nand2  g109(.a(new_n124_), .b(new_n102_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n128_), .c(new_n153_), .O(new_n155_));
  oai21  g111(.a(new_n123_), .b(new_n120_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n50_), .O(new_n157_));
  aoi21  g113(.a(new_n86_), .b(new_n144_), .c(new_n50_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n155_), .c(new_n143_), .d(new_n141_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n157_), .c(new_n150_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n47_), .O(z9));
endmodule
