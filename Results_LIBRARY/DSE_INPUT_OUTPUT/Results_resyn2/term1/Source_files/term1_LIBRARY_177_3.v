...
module FAU ( 
  ...
  nand4  g25(.a(new_n69_), .b(new_n67_), .c(new_n64_), .d(new_n45_), .O(new_n70_));
  ...
  nand3  g39(.a(new_n83_), .b(new_n80_), .c(new_n72_), .O(new_n84_));
  inv1   g40(.a(new_n84_), .O(z3));
  inv1   g41(.a(new_n82_), .O(new_n86_));
  and2   g42(.a(new_n86_), .b(new_n80_), .O(new_n87_));
  inv1   g43(.a(x28), .O(new_n88_));
  nor2   g44(.a(new_n88_), .b(new_n72_), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  nand2  g46(.a(new_n88_), .b(new_n72_), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(new_n90_), .c(new_n87_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n45_), .O(z4));
  nand2  g49(.a(new_n89_), .b(x29), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(new_n95_));
  nor2   g51(.a(new_n89_), .b(x29), .O(new_n96_));
  nor2   g52(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n87_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n102_), .b(new_n100_), .c(new_n83_), .d(new_n80_), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(z6));
  xor2a  g60(.a(new_n100_), .b(x31), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n83_), .c(new_n80_), .O(z7));
  nand2  g62(.a(new_n81_), .b(x00), .O(new_n107_));
  oai21  g63(.a(x28), .b(x27), .c(x29), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n101_), .c(x31), .O(new_n109_));
  aoi21  g65(.a(new_n108_), .b(new_n101_), .c(new_n109_), .O(new_n110_));
  ...
  nand2  g71(.a(new_n108_), .b(new_n101_), .O(new_n116_));
  nand3  g72(.a(new_n91_), .b(x30), .c(x29), .O(new_n117_));
  ...
  inv1   g80(.a(new_n107_), .O(new_n125_));
  inv1   g81(.a(x33), .O(new_n126_));
  inv1   g82(.a(x31), .O(new_n127_));
  nand3  g83(.a(new_n108_), .b(new_n127_), .c(new_n101_), .O(new_n128_));
  nand4  g84(.a(new_n91_), .b(x31), .c(x30), .d(x29), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n115_), .c(new_n126_), .O(new_n131_));
  nand2  g87(.a(new_n120_), .b(new_n126_), .O(new_n132_));
  aoi21  g88(.a(new_n129_), .b(new_n128_), .c(new_n132_), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n131_), .c(new_n125_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n45_), .O(z9));
endmodule
