...
module FAU ( 
  ...
  inv1   g040(.a(new_n58_), .O(new_n85_));
  nand2  g041(.a(x25), .b(x15), .O(new_n86_));
  nor3   g042(.a(new_n86_), .b(new_n85_), .c(x26), .O(new_n87_));
  and2   g043(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n71_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z3));
  inv1   g046(.a(x28), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n71_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n91_), .b(new_n71_), .O(new_n94_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n103_), .c(new_n88_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand3  g064(.a(new_n102_), .b(new_n108_), .c(x30), .O(new_n109_));
  nand2  g065(.a(new_n103_), .b(x31), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n109_), .c(new_n88_), .O(z7));
  nand3  g067(.a(new_n94_), .b(x30), .c(x29), .O(new_n112_));
  oai21  g068(.a(x28), .b(x27), .c(x29), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n104_), .c(new_n108_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g071(.a(new_n81_), .b(x18), .c(x14), .O(new_n116_));
  nand3  g072(.a(x19), .b(new_n78_), .c(x13), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(new_n75_), .O(new_n118_));
  nand4  g074(.a(x19), .b(x18), .c(new_n75_), .d(x12), .O(new_n119_));
  ...
  nand3  g079(.a(new_n123_), .b(x19), .c(new_n72_), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n121_), .c(new_n115_), .O(new_n125_));
  inv1   g081(.a(x00), .O(new_n126_));
  nand2  g082(.a(x18), .b(x12), .O(new_n127_));
  oai21  g083(.a(x18), .b(x13), .c(x17), .O(new_n128_));
  nand3  g084(.a(x18), .b(x17), .c(x16), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n81_), .c(x14), .O(new_n131_));
  nand2  g087(.a(new_n122_), .b(new_n72_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n129_), .c(x19), .O(new_n133_));
  aoi22  g089(.a(new_n133_), .b(new_n131_), .c(new_n128_), .d(new_n127_), .O(new_n134_));
  nand3  g090(.a(new_n114_), .b(new_n112_), .c(x32), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n134_), .c(new_n126_), .O(new_n137_));
  oai21  g093(.a(new_n125_), .b(x32), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(x15), .c(x26), .O(z8));
  nand3  g095(.a(new_n113_), .b(new_n108_), .c(new_n104_), .O(new_n140_));
  nand4  g096(.a(new_n94_), .b(x31), .c(x30), .d(x29), .O(new_n141_));
  and2   g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  aoi21  g098(.a(new_n124_), .b(new_n121_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n141_), .b(new_n140_), .c(new_n48_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n134_), .c(new_n126_), .O(new_n145_));
  oai21  g101(.a(new_n143_), .b(x33), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(x15), .c(x26), .O(z9));
endmodule
