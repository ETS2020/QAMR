...
module FAU ( 
  ...
  nor2   g044(.a(new_n87_), .b(new_n69_), .O(new_n89_));
  ...
  nand3  g055(.a(new_n99_), .b(new_n82_), .c(new_n80_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n45_), .O(z6));
  inv1   g057(.a(x31), .O(new_n102_));
  nand2  g058(.a(new_n82_), .b(new_n102_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n80_), .c(new_n46_), .O(z7));
  inv1   g061(.a(x17), .O(new_n106_));
  inv1   g062(.a(x19), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x18), .c(x14), .O(new_n108_));
  nand3  g064(.a(x19), .b(new_n73_), .c(x13), .O(new_n109_));
  ...
  aoi21  g076(.a(new_n118_), .b(x15), .c(new_n120_), .O(new_n121_));
  aoi21  g077(.a(new_n88_), .b(x29), .c(x30), .O(new_n122_));
  ...
  aoi21  g086(.a(new_n125_), .b(new_n119_), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n98_), .b(new_n94_), .O(new_n132_));
  inv1   g088(.a(x13), .O(new_n133_));
  nand2  g089(.a(new_n73_), .b(new_n133_), .O(new_n134_));
  ...
  oai21  g093(.a(new_n88_), .b(new_n94_), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g097(.a(new_n124_), .b(new_n121_), .c(new_n141_), .O(new_n142_));
  inv1   g098(.a(x00), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n45_), .O(z8));
  nand2  g102(.a(new_n122_), .b(new_n102_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n121_), .c(new_n49_), .O(new_n148_));
  inv1   g104(.a(new_n144_), .O(new_n149_));
  nand3  g105(.a(new_n137_), .b(new_n134_), .c(x33), .O(new_n150_));
  nor2   g106(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n131_), .c(new_n149_), .O(new_n152_));
