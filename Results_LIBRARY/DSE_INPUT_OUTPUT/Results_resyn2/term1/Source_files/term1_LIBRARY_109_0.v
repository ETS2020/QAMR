...
module FAU ( 
  ...
  and2   g021(.a(x25), .b(x01), .O(new_n66_));
  ...
  and2   g032(.a(new_n76_), .b(new_n47_), .O(new_n77_));
  ...
  nand3  g037(.a(new_n81_), .b(new_n79_), .c(new_n65_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(z3));
  nand2  g039(.a(new_n81_), .b(new_n66_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  inv1   g041(.a(x28), .O(new_n86_));
  nor2   g042(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand2  g044(.a(new_n86_), .b(new_n65_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n88_), .c(new_n85_), .d(new_n77_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z4));
  inv1   g047(.a(new_n77_), .O(new_n92_));
  nor2   g048(.a(new_n87_), .b(x29), .O(new_n93_));
  nand2  g049(.a(new_n87_), .b(x29), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nor4   g051(.a(new_n95_), .b(new_n93_), .c(new_n84_), .d(new_n92_), .O(z5));
  nand2  g052(.a(new_n95_), .b(x30), .O(new_n97_));
  ...
  aoi21  g056(.a(new_n100_), .b(x00), .c(x26), .O(z6));
  inv1   g057(.a(x26), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  xor2a  g059(.a(new_n97_), .b(new_n103_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n78_), .c(x00), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n102_), .O(z7));
  inv1   g062(.a(new_n81_), .O(new_n107_));
  ...
  nand3  g067(.a(x19), .b(new_n70_), .c(x13), .O(new_n112_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n98_), .c(new_n133_), .O(new_n134_));
  ...
  nor3   g099(.a(new_n143_), .b(new_n142_), .c(new_n103_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(new_n128_), .O(new_n145_));
  ...
  nand2  g104(.a(new_n103_), .b(new_n98_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n129_), .c(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n124_), .b(new_n121_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n52_), .O(new_n152_));
  nor3   g108(.a(new_n143_), .b(new_n142_), .c(new_n52_), .O(new_n153_));
