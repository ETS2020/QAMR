...
module FAU ( 
  ...
  and2   g029(.a(new_n73_), .b(new_n69_), .O(new_n74_));
  ...
  nand2  g042(.a(new_n78_), .b(new_n60_), .O(new_n87_));
  ...
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n74_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z5));
  nand3  g049(.a(new_n89_), .b(new_n73_), .c(x30), .O(new_n94_));
  inv1   g050(.a(x30), .O(new_n95_));
  inv1   g051(.a(new_n72_), .O(new_n96_));
  inv1   g052(.a(new_n89_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(x22), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n94_), .c(new_n87_), .O(z6));
  inv1   g055(.a(x17), .O(new_n100_));
  nor2   g056(.a(new_n96_), .b(new_n100_), .O(new_n101_));
  ...
  oai21  g060(.a(new_n102_), .b(x30), .c(new_n96_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(x22), .c(new_n87_), .O(new_n106_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n100_), .O(new_n113_));
  nand4  g069(.a(x19), .b(x18), .c(new_n100_), .d(x12), .O(new_n114_));
  ...
  nor2   g077(.a(new_n111_), .b(new_n100_), .O(new_n122_));
  ...
  and2   g081(.a(new_n125_), .b(new_n95_), .O(new_n126_));
  nor2   g082(.a(new_n125_), .b(new_n95_), .O(new_n127_));
  nor3   g083(.a(new_n127_), .b(new_n126_), .c(new_n102_), .O(new_n128_));
  oai21  g084(.a(new_n124_), .b(new_n121_), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n52_), .O(new_n130_));
  inv1   g086(.a(x26), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x00), .O(new_n132_));
  nand3  g088(.a(new_n122_), .b(x16), .c(x15), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  aoi21  g090(.a(new_n118_), .b(new_n117_), .c(new_n109_), .O(new_n135_));
  ...
  nand2  g096(.a(new_n134_), .b(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n123_), .b(new_n108_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n141_), .c(new_n139_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n136_), .O(new_n144_));
  nand2  g100(.a(new_n128_), .b(x32), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n144_), .c(new_n132_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n130_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n69_), .O(z8));
  nand2  g105(.a(new_n127_), .b(x31), .O(new_n150_));
  nand2  g106(.a(new_n126_), .b(new_n102_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  nor2   g109(.a(new_n45_), .b(new_n48_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n126_), .b(new_n102_), .c(x22), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n150_), .c(x33), .O(new_n157_));
  oai21  g113(.a(new_n124_), .b(new_n121_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n155_), .c(new_n132_), .O(z9));
endmodule
