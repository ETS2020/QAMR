...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n81_), .c(new_n47_), .O(z6));
  ...
  nand3  g058(.a(new_n71_), .b(x18), .c(x14), .O(new_n103_));
  ...
  nor3   g071(.a(new_n115_), .b(new_n71_), .c(x15), .O(new_n116_));
  ...
  aoi21  g080(.a(new_n124_), .b(x16), .c(new_n112_), .O(new_n125_));
  nand2  g081(.a(new_n71_), .b(x14), .O(new_n126_));
