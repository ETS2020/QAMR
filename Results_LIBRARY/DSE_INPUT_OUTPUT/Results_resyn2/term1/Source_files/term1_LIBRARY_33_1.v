...
module FAU ( 
  ...
  nand4  g033(.a(new_n61_), .b(new_n77_), .c(x25), .d(x01), .O(new_n78_));
  inv1   g034(.a(new_n78_), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  aoi21  g036(.a(new_n75_), .b(new_n72_), .c(new_n80_), .O(new_n81_));
  ...
  aoi21  g046(.a(new_n90_), .b(new_n75_), .c(new_n78_), .O(new_n91_));
  ...
  nor2   g061(.a(new_n105_), .b(new_n92_), .O(new_n106_));
  aoi21  g062(.a(new_n92_), .b(x31), .c(new_n106_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n91_), .c(new_n46_), .O(z7));
  inv1   g064(.a(x15), .O(new_n109_));
  nand2  g065(.a(new_n77_), .b(x00), .O(new_n110_));
  ...
  nand2  g083(.a(new_n85_), .b(x29), .O(new_n128_));
  ...
  aoi21  g098(.a(new_n52_), .b(new_n97_), .c(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n127_), .b(new_n97_), .c(new_n143_), .O(new_n144_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n102_), .c(new_n45_), .O(new_n151_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n101_), .c(new_n151_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n142_), .O(new_n160_));
  oai22  g116(.a(new_n136_), .b(new_n116_), .c(new_n114_), .d(new_n122_), .O(new_n161_));
  nand2  g117(.a(new_n123_), .b(new_n122_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n161_), .c(new_n139_), .d(new_n105_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x15), .O(new_n164_));
  oai21  g120(.a(new_n149_), .b(new_n104_), .c(new_n45_), .O(new_n165_));
  aoi21  g121(.a(new_n128_), .b(new_n97_), .c(new_n46_), .O(new_n166_));
  oai21  g122(.a(new_n128_), .b(new_n97_), .c(new_n166_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n165_), .c(new_n164_), .O(new_n168_));
  nand2  g124(.a(new_n150_), .b(new_n45_), .O(new_n169_));
  nand2  g125(.a(new_n128_), .b(new_n103_), .O(new_n170_));
