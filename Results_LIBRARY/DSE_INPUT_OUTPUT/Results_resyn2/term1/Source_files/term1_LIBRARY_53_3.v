...
module FAU ( 
  ...
  oai21  g013(.a(new_n54_), .b(new_n53_), .c(new_n57_), .O(new_n58_));
  nand3  g014(.a(new_n58_), .b(new_n56_), .c(new_n49_), .O(z1));
  xor2a  g015(.a(x07), .b(x04), .O(new_n60_));
  nand2  g016(.a(x05), .b(new_n52_), .O(new_n61_));
  nand2  g017(.a(x06), .b(new_n51_), .O(new_n62_));
  xor2a  g018(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nor2   g019(.a(new_n63_), .b(x01), .O(new_n64_));
  and2   g020(.a(new_n55_), .b(x01), .O(new_n65_));
  nor2   g021(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g022(.a(new_n66_), .b(new_n60_), .O(new_n67_));
  inv1   g023(.a(x09), .O(new_n68_));
  nand2  g024(.a(new_n66_), .b(new_n60_), .O(new_n69_));
  nand3  g025(.a(new_n69_), .b(new_n68_), .c(x08), .O(new_n70_));
  oai21  g026(.a(new_n70_), .b(new_n67_), .c(new_n49_), .O(z2));
  ...
  oai21  g034(.a(new_n76_), .b(new_n72_), .c(new_n78_), .O(new_n79_));
  or2    g035(.a(new_n79_), .b(x26), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(x27), .c(new_n49_), .O(z3));
  ...
  oai21  g054(.a(x31), .b(x26), .c(new_n46_), .O(new_n99_));
  nand2  g055(.a(new_n90_), .b(x31), .O(new_n100_));
  oai21  g056(.a(new_n96_), .b(x31), .c(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n79_), .c(new_n45_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n99_), .O(z7));
  ...
  aoi22  g085(.a(new_n87_), .b(x29), .c(new_n50_), .d(new_n46_), .O(new_n130_));
  ...
  nand2  g101(.a(new_n122_), .b(new_n46_), .O(new_n146_));
  ...
  nor3   g105(.a(new_n139_), .b(new_n138_), .c(new_n57_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n147_), .c(new_n137_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  aoi21  g108(.a(new_n148_), .b(new_n57_), .c(new_n152_), .O(z9));
endmodule
