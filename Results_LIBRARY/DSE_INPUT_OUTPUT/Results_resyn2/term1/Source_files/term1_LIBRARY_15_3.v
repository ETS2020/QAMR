...
module FAU ( 
  ...
  nand2  g043(.a(new_n87_), .b(new_n45_), .O(z4));
  ...
  nand2  g055(.a(new_n99_), .b(new_n80_), .O(z7));
  ...
  nor2   g079(.a(new_n50_), .b(x26), .O(new_n124_));
  ...
  oai21  g084(.a(new_n113_), .b(x16), .c(x19), .O(new_n129_));
  ...
  aoi21  g089(.a(new_n103_), .b(x14), .c(new_n128_), .O(new_n134_));
  aoi21  g090(.a(new_n117_), .b(new_n101_), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n130_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n119_), .c(new_n124_), .O(new_n137_));
  nand2  g093(.a(new_n121_), .b(x30), .O(new_n138_));
  inv1   g094(.a(new_n123_), .O(new_n139_));
  aoi21  g095(.a(new_n125_), .b(new_n94_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n137_), .c(new_n127_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x00), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n45_), .O(z8));
  nor2   g100(.a(new_n118_), .b(new_n115_), .O(new_n145_));
  nand3  g101(.a(new_n123_), .b(new_n119_), .c(new_n94_), .O(new_n146_));
  nand3  g102(.a(new_n139_), .b(x31), .c(x30), .O(new_n147_));
  and2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g104(.a(new_n119_), .b(x26), .c(new_n47_), .O(new_n149_));
