...
module FAU ( 
  ...
  oai21  g042(.a(new_n86_), .b(x27), .c(new_n58_), .O(z3));
  ...
  oai21  g049(.a(new_n93_), .b(new_n86_), .c(new_n58_), .O(z4));
  ...
  oai21  g054(.a(new_n98_), .b(new_n86_), .c(new_n58_), .O(z5));
  nand2  g055(.a(new_n95_), .b(new_n46_), .O(new_n100_));
  inv1   g056(.a(new_n95_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x30), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n86_), .c(new_n58_), .O(z6));
  ...
  nand4  g064(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n58_), .O(z7));
  inv1   g065(.a(x17), .O(new_n110_));
  nand3  g066(.a(new_n76_), .b(x18), .c(x14), .O(new_n111_));
  ...
  nor2   g073(.a(new_n76_), .b(new_n112_), .O(new_n118_));
  inv1   g074(.a(x11), .O(new_n119_));
  nor2   g075(.a(x16), .b(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n118_), .c(x17), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  nand2  g078(.a(new_n118_), .b(x17), .O(new_n123_));
  ...
  aoi21  g086(.a(new_n113_), .b(new_n111_), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n120_), .b(new_n118_), .O(new_n132_));
  ...
  nand3  g093(.a(x30), .b(x17), .c(new_n45_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n128_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  oai21  g096(.a(new_n129_), .b(new_n126_), .c(new_n140_), .O(new_n141_));
  nor2   g097(.a(x32), .b(new_n107_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  inv1   g099(.a(x15), .O(new_n144_));
  oai21  g100(.a(new_n124_), .b(new_n112_), .c(new_n144_), .O(new_n145_));
  nor2   g101(.a(new_n130_), .b(new_n144_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x18), .O(new_n147_));
  oai21  g103(.a(x18), .b(x13), .c(x16), .O(new_n148_));
  oai21  g104(.a(new_n112_), .b(new_n119_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x19), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n145_), .c(new_n47_), .O(new_n152_));
  oai21  g108(.a(new_n127_), .b(new_n46_), .c(x17), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n45_), .O(new_n154_));
  nand2  g110(.a(new_n146_), .b(new_n118_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n110_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n128_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n46_), .O(new_n158_));
  inv1   g114(.a(new_n147_), .O(new_n159_));
  nand2  g115(.a(new_n46_), .b(new_n110_), .O(new_n160_));
  aoi21  g116(.a(new_n76_), .b(x14), .c(new_n47_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(new_n159_), .O(new_n162_));
  nand2  g118(.a(new_n58_), .b(new_n107_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n158_), .d(new_n154_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n152_), .c(x32), .O(new_n165_));
  nand2  g121(.a(new_n83_), .b(x00), .O(new_n166_));
  aoi21  g122(.a(new_n165_), .b(new_n143_), .c(new_n166_), .O(z8));
  nand3  g123(.a(new_n127_), .b(new_n107_), .c(new_n46_), .O(new_n168_));
  or2    g124(.a(new_n168_), .b(new_n126_), .O(new_n169_));
  nor3   g125(.a(new_n138_), .b(new_n127_), .c(new_n107_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n137_), .c(x33), .O(new_n171_));
  inv1   g127(.a(new_n166_), .O(new_n172_));
  aoi21  g128(.a(new_n128_), .b(x31), .c(new_n46_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n110_), .c(new_n45_), .O(new_n174_));
  nand3  g130(.a(new_n156_), .b(new_n127_), .c(new_n107_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n46_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n174_), .c(new_n162_), .d(x33), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n152_), .c(new_n172_), .O(new_n178_));
  aoi21  g134(.a(new_n171_), .b(new_n169_), .c(new_n178_), .O(z9));
endmodule
