...
module FAU ( 
  ...
  oai21  g067(.a(new_n111_), .b(new_n99_), .c(new_n86_), .O(z5));
  inv1   g068(.a(new_n99_), .O(new_n113_));
  inv1   g069(.a(x30), .O(new_n114_));
  nand2  g070(.a(new_n108_), .b(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n103_), .b(x30), .c(x29), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n115_), .c(new_n113_), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(z6));
  xor2a  g074(.a(new_n116_), .b(x31), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n113_), .O(new_n120_));
  ...
  aoi21  g103(.a(new_n53_), .b(new_n114_), .c(new_n147_), .O(new_n148_));
  ...
  nand2  g124(.a(new_n139_), .b(new_n114_), .O(new_n169_));
