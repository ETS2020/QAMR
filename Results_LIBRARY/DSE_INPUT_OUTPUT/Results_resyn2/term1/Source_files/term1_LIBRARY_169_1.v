...
module FAU ( 
  ...
  aoi21  g033(.a(new_n45_), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  ...
  nand2  g055(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  and2   g057(.a(x31), .b(x30), .O(new_n102_));
  ...
  nand2  g061(.a(new_n94_), .b(x31), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n105_), .c(new_n87_), .O(z7));
  aoi21  g063(.a(new_n88_), .b(new_n72_), .c(new_n95_), .O(new_n108_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n119_), .c(new_n76_), .O(new_n124_));
  ...
  nand2  g084(.a(new_n80_), .b(x00), .O(new_n129_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n76_), .O(new_n134_));
  ...
  inv1   g103(.a(new_n108_), .O(new_n148_));
  nand2  g104(.a(x33), .b(x30), .O(new_n149_));
  nand3  g105(.a(new_n49_), .b(x19), .c(new_n114_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n137_), .c(new_n103_), .d(x13), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n149_), .c(x20), .O(new_n153_));
  ...
  nand4  g113(.a(new_n125_), .b(x19), .c(new_n76_), .d(x10), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(x33), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n103_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n149_), .c(new_n114_), .O(new_n161_));
  ...
  aoi21  g127(.a(new_n171_), .b(new_n169_), .c(new_n49_), .O(new_n172_));
  aoi21  g128(.a(new_n168_), .b(new_n108_), .c(new_n172_), .O(new_n173_));
