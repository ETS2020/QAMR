...
module FAU ( 
  ...
  aoi21  g042(.a(new_n84_), .b(new_n83_), .c(new_n46_), .O(new_n87_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n80_), .c(new_n45_), .O(z5));
  aoi21  g050(.a(new_n85_), .b(x29), .c(x30), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n80_), .c(new_n45_), .O(z6));
  inv1   g052(.a(x31), .O(new_n97_));
  aoi21  g053(.a(new_n82_), .b(new_n97_), .c(new_n46_), .O(z7));
  nand2  g054(.a(new_n77_), .b(x00), .O(new_n99_));
  nand2  g055(.a(x18), .b(x17), .O(new_n100_));
  nand2  g056(.a(x16), .b(x10), .O(new_n101_));
  oai21  g057(.a(x18), .b(x13), .c(x17), .O(new_n102_));
  nand2  g058(.a(x18), .b(x12), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x15), .O(new_n105_));
  oai21  g061(.a(new_n101_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  inv1   g062(.a(x19), .O(new_n107_));
  nand4  g063(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n108_));
  aoi21  g064(.a(new_n107_), .b(x14), .c(new_n108_), .O(new_n109_));
  aoi21  g065(.a(new_n108_), .b(new_n107_), .c(new_n109_), .O(new_n110_));
  inv1   g066(.a(x11), .O(new_n111_));
  inv1   g067(.a(x16), .O(new_n112_));
  oai21  g068(.a(new_n100_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n110_), .c(new_n106_), .d(x31), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n45_), .O(new_n115_));
  inv1   g071(.a(x30), .O(new_n116_));
  oai21  g072(.a(x28), .b(x27), .c(x29), .O(new_n117_));
  nor2   g073(.a(new_n90_), .b(new_n84_), .O(new_n118_));
  nor2   g074(.a(new_n116_), .b(x27), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n116_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n115_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x32), .O(new_n122_));
  nand3  g078(.a(new_n107_), .b(x18), .c(x14), .O(new_n123_));
  inv1   g079(.a(x18), .O(new_n124_));
  nand3  g080(.a(x19), .b(new_n124_), .c(x13), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n123_), .c(new_n70_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x18), .c(new_n70_), .d(x12), .O(new_n127_));
  ...
  nand3  g087(.a(new_n131_), .b(new_n112_), .c(x11), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  and2   g089(.a(new_n133_), .b(x15), .O(new_n134_));
  nor3   g090(.a(new_n130_), .b(new_n101_), .c(x15), .O(new_n135_));
  nand2  g091(.a(new_n118_), .b(x30), .O(new_n136_));
  nor2   g092(.a(x32), .b(new_n97_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n45_), .O(new_n138_));
  aoi21  g094(.a(new_n117_), .b(new_n116_), .c(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n135_), .b(new_n134_), .c(new_n139_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n122_), .c(new_n99_), .O(z8));
  nand2  g097(.a(x33), .b(x29), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n99_), .c(new_n116_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x27), .O(new_n144_));
  inv1   g100(.a(new_n99_), .O(new_n145_));
  aoi21  g101(.a(new_n133_), .b(x15), .c(new_n135_), .O(new_n146_));
  nand2  g102(.a(new_n110_), .b(new_n106_), .O(new_n147_));
  oai21  g103(.a(new_n118_), .b(x31), .c(new_n116_), .O(new_n148_));
  nand2  g104(.a(new_n118_), .b(x31), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x30), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n148_), .c(new_n113_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n147_), .c(x33), .O(new_n152_));
  nand2  g108(.a(new_n117_), .b(new_n97_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n116_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n150_), .c(new_n53_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n146_), .c(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n145_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n144_), .O(z9));
endmodule
