...
module FAU ( 
  ...
  aoi21  g035(.a(new_n74_), .b(new_n71_), .c(new_n79_), .O(new_n80_));
  ...
  and2   g054(.a(new_n96_), .b(x31), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n71_), .c(x22), .O(new_n100_));
  nand2  g056(.a(new_n71_), .b(x17), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n96_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n45_), .c(new_n77_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n100_), .c(new_n46_), .O(z7));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n72_), .O(new_n110_));
  nand4  g066(.a(x19), .b(x18), .c(new_n72_), .d(x12), .O(new_n111_));
  ...
  and2   g080(.a(x18), .b(x17), .O(new_n125_));
  nand2  g081(.a(new_n115_), .b(new_n114_), .O(new_n126_));
  and2   g082(.a(x16), .b(x15), .O(new_n127_));
  aoi22  g083(.a(new_n127_), .b(new_n125_), .c(new_n126_), .d(x19), .O(new_n128_));
  ...
  nand2  g088(.a(new_n106_), .b(x14), .O(new_n133_));
  nand3  g089(.a(new_n127_), .b(new_n125_), .c(new_n133_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(new_n131_), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n128_), .O(new_n136_));
  nor2   g092(.a(new_n122_), .b(new_n49_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n136_), .c(new_n73_), .O(new_n138_));
  nand2  g094(.a(new_n75_), .b(x00), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  oai21  g096(.a(new_n138_), .b(new_n45_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n124_), .b(new_n49_), .c(new_n141_), .O(z8));
  and2   g098(.a(new_n121_), .b(new_n94_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n45_), .O(new_n144_));
  nor3   g100(.a(new_n121_), .b(new_n45_), .c(new_n94_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x22), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n144_), .c(x33), .O(new_n147_));
  oai21  g103(.a(new_n120_), .b(new_n118_), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(new_n144_), .O(new_n149_));
  oai21  g105(.a(new_n145_), .b(new_n149_), .c(new_n136_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n48_), .c(x33), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n148_), .c(new_n139_), .O(z9));
endmodule
