...
module FAU ( 
  ...
  aoi21  g058(.a(new_n94_), .b(new_n102_), .c(new_n46_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z6));
  inv1   g061(.a(x10), .O(new_n106_));
  nor2   g062(.a(new_n45_), .b(new_n106_), .O(new_n107_));
  oai21  g063(.a(new_n99_), .b(new_n85_), .c(new_n107_), .O(new_n108_));
  oai21  g064(.a(new_n101_), .b(x31), .c(new_n108_), .O(z7));
  ...
  xor2a  g082(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x31), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(x32), .O(new_n130_));
  nand2  g086(.a(new_n82_), .b(x00), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n75_), .b(x14), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  inv1   g090(.a(new_n123_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x15), .O(new_n136_));
  oai22  g092(.a(new_n136_), .b(new_n134_), .c(new_n120_), .d(x16), .O(new_n137_));
  inv1   g093(.a(x15), .O(new_n138_));
  nand2  g094(.a(new_n123_), .b(new_n138_), .O(new_n139_));
  nand2  g095(.a(x18), .b(x12), .O(new_n140_));
  oai21  g096(.a(x18), .b(x13), .c(x17), .O(new_n141_));
  and2   g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nor3   g098(.a(new_n142_), .b(new_n54_), .c(new_n45_), .O(new_n143_));
  nand2  g099(.a(new_n136_), .b(new_n75_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n139_), .d(new_n127_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n137_), .c(new_n132_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n130_), .c(new_n47_), .O(z8));
  aoi21  g103(.a(new_n121_), .b(new_n117_), .c(new_n138_), .O(new_n148_));
  nor2   g104(.a(x31), .b(x30), .O(new_n149_));
  and2   g105(.a(new_n124_), .b(x10), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n148_), .c(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n50_), .O(new_n152_));
  nand2  g108(.a(x33), .b(new_n45_), .O(new_n153_));
  and2   g109(.a(new_n153_), .b(new_n126_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  inv1   g111(.a(new_n126_), .O(new_n156_));
  nand3  g112(.a(new_n50_), .b(x31), .c(x30), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n125_), .c(new_n153_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  inv1   g115(.a(new_n142_), .O(new_n160_));
  oai21  g116(.a(new_n123_), .b(new_n106_), .c(new_n138_), .O(new_n161_));
  xnor2a g117(.a(x31), .b(x30), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n161_), .c(new_n144_), .d(new_n160_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n137_), .c(x33), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n159_), .c(new_n155_), .O(new_n165_));
