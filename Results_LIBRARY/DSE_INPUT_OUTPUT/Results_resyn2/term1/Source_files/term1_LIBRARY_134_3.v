...
module FAU ( 
  ...
  oai21  g038(.a(new_n82_), .b(x27), .c(new_n52_), .O(z3));
  ...
  oai21  g056(.a(new_n100_), .b(new_n82_), .c(new_n52_), .O(z6));
  ...
  aoi21  g085(.a(new_n48_), .b(new_n98_), .c(new_n125_), .O(new_n130_));
  ...
  aoi21  g096(.a(new_n140_), .b(new_n137_), .c(new_n48_), .O(new_n141_));
  ...
  aoi21  g101(.a(new_n121_), .b(new_n98_), .c(new_n125_), .O(new_n146_));
  ...
  nor3   g105(.a(new_n139_), .b(new_n138_), .c(new_n53_), .O(new_n150_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n52_), .O(z9));
endmodule
