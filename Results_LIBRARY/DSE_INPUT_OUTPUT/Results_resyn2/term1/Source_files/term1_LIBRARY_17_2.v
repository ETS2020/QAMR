...
module FAU ( 
  ...
  nand3  g035(.a(new_n79_), .b(new_n51_), .c(new_n69_), .O(new_n80_));
  ...
  nand2  g042(.a(new_n86_), .b(new_n51_), .O(z4));
  ...
  nand2  g047(.a(new_n91_), .b(new_n51_), .O(z5));
  nand2  g048(.a(new_n88_), .b(x32), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(x30), .O(new_n94_));
  nand2  g050(.a(new_n88_), .b(new_n49_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n94_), .c(new_n79_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z6));
  nor4   g053(.a(new_n88_), .b(z0), .c(x31), .d(new_n49_), .O(new_n98_));
  aoi21  g054(.a(new_n94_), .b(x31), .c(new_n98_), .O(new_n99_));
  oai21  g055(.a(new_n79_), .b(new_n50_), .c(new_n99_), .O(z7));
  ...
  aoi21  g073(.a(new_n114_), .b(x15), .c(new_n117_), .O(new_n118_));
  nand2  g074(.a(z0), .b(x31), .O(new_n119_));
  ...
  aoi21  g078(.a(new_n111_), .b(new_n110_), .c(new_n102_), .O(new_n123_));
  nand3  g079(.a(new_n115_), .b(x16), .c(x15), .O(new_n124_));
  ...
  nand2  g086(.a(new_n116_), .b(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n102_), .b(x14), .O(new_n132_));
  nand2  g088(.a(new_n125_), .b(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n131_), .c(new_n129_), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n126_), .O(new_n135_));
  inv1   g091(.a(x31), .O(new_n136_));
  aoi21  g092(.a(new_n121_), .b(new_n49_), .c(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(z0), .O(new_n138_));
  aoi21  g094(.a(new_n122_), .b(new_n120_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n77_), .b(x00), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(new_n51_), .O(z8));
  nand3  g097(.a(new_n122_), .b(x31), .c(x30), .O(new_n142_));
  nand3  g098(.a(new_n121_), .b(new_n136_), .c(new_n49_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n135_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n51_), .c(x33), .O(new_n146_));
  nand4  g102(.a(new_n122_), .b(x32), .c(x31), .d(x30), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n52_), .O(new_n149_));
  or2    g105(.a(new_n149_), .b(new_n118_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n146_), .c(new_n140_), .O(z9));
endmodule
