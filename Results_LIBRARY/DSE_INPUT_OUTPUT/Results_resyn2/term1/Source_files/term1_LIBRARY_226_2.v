...
module FAU ( 
  ...
  oai21  g029(.a(x23), .b(x18), .c(x17), .O(new_n74_));
  ...
  aoi22  g084(.a(new_n86_), .b(x29), .c(new_n54_), .d(new_n97_), .O(new_n129_));
  ...
  aoi21  g095(.a(new_n139_), .b(new_n136_), .c(new_n54_), .O(new_n140_));
  aoi21  g096(.a(new_n129_), .b(new_n128_), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n73_), .b(new_n45_), .c(x00), .O(new_n142_));
  ...
  nor3   g104(.a(new_n138_), .b(new_n137_), .c(new_n50_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n146_), .c(new_n136_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g107(.a(new_n147_), .b(new_n50_), .c(new_n151_), .O(z9));
endmodule
