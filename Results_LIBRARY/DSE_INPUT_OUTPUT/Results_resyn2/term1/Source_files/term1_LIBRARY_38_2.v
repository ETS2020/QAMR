...
module FAU ( 
  ...
  nor2   g028(.a(x26), .b(x24), .O(new_n73_));
  oai21  g029(.a(x22), .b(x17), .c(x19), .O(new_n74_));
  ...
  nor2   g042(.a(new_n85_), .b(new_n72_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n86_), .c(new_n80_), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(new_n45_), .c(x26), .O(z4));
  ...
  nand3  g051(.a(new_n87_), .b(x30), .c(x29), .O(new_n96_));
  ...
  aoi22  g084(.a(new_n86_), .b(x29), .c(new_n53_), .d(new_n97_), .O(new_n129_));
  ...
  aoi21  g103(.a(x31), .b(x30), .c(new_n125_), .O(new_n148_));
  nand2  g104(.a(new_n121_), .b(new_n97_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n125_), .c(new_n148_), .O(new_n150_));
  ...
  nand2  g108(.a(new_n73_), .b(x00), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n152_), .b(new_n138_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n151_), .b(new_n49_), .c(new_n155_), .O(z9));
endmodule
