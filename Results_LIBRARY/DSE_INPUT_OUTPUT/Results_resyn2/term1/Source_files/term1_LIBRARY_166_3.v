...
module FAU ( 
  ...
  aoi21  g22(.a(new_n64_), .b(new_n63_), .c(new_n66_), .O(new_n67_));
  ...
  nand3  g36(.a(new_n54_), .b(new_n80_), .c(x25), .O(new_n81_));
  ...
  aoi21  g62(.a(new_n106_), .b(new_n100_), .c(new_n50_), .O(z7));
  ...
  oai21  g74(.a(new_n115_), .b(new_n50_), .c(new_n118_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(x32), .O(new_n120_));
  nand2  g76(.a(x18), .b(x12), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n116_), .c(new_n50_), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n115_), .c(new_n49_), .O(new_n123_));
  ...
  nand2  g87(.a(new_n122_), .b(new_n131_), .O(new_n132_));
  or2    g88(.a(new_n132_), .b(new_n127_), .O(new_n133_));
  aoi21  g89(.a(new_n133_), .b(new_n130_), .c(new_n108_), .O(z9));
endmodule
