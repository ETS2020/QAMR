...
module FAU ( 
  ...
  nand3  g034(.a(new_n62_), .b(new_n78_), .c(x01), .O(new_n79_));
  aoi21  g035(.a(new_n77_), .b(new_n73_), .c(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  aoi21  g037(.a(new_n81_), .b(new_n46_), .c(new_n45_), .O(z3));
  ...
  aoi21  g043(.a(new_n87_), .b(new_n46_), .c(new_n45_), .O(z4));
  ...
  aoi21  g094(.a(new_n54_), .b(new_n94_), .c(new_n124_), .O(new_n139_));
  ...
  nand2  g100(.a(new_n144_), .b(new_n102_), .O(z8));
  nor2   g101(.a(new_n46_), .b(new_n94_), .O(new_n146_));
  nor3   g102(.a(new_n124_), .b(x31), .c(x30), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n124_), .c(new_n147_), .O(new_n148_));
  nor2   g104(.a(new_n47_), .b(new_n50_), .O(new_n149_));
