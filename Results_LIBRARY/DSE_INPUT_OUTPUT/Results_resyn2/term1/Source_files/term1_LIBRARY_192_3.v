...
module FAU ( 
  ...
  nand2  g033(.a(new_n60_), .b(x25), .O(new_n78_));
  aoi21  g034(.a(new_n77_), .b(new_n73_), .c(new_n78_), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(x27), .c(new_n70_), .O(z3));
  ...
  nand4  g042(.a(new_n86_), .b(new_n85_), .c(new_n79_), .d(new_n45_), .O(new_n87_));
  ...
  oai21  g048(.a(new_n92_), .b(new_n80_), .c(new_n70_), .O(z5));
  inv1   g049(.a(x30), .O(new_n94_));
  oai21  g050(.a(new_n89_), .b(new_n94_), .c(new_n45_), .O(new_n95_));
  aoi21  g051(.a(new_n89_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n79_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n70_), .O(z6));
  xor2a  g054(.a(new_n95_), .b(new_n46_), .O(new_n99_));
  oai21  g055(.a(new_n79_), .b(new_n47_), .c(new_n99_), .O(z7));
  ...
  nor2   g074(.a(x32), .b(new_n46_), .O(new_n119_));
  oai21  g075(.a(new_n118_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n94_), .O(new_n121_));
  aoi21  g077(.a(new_n83_), .b(new_n82_), .c(new_n90_), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  aoi21  g079(.a(new_n54_), .b(x30), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand3  g081(.a(new_n116_), .b(x16), .c(x15), .O(new_n126_));
  oai21  g082(.a(new_n113_), .b(x16), .c(x19), .O(new_n127_));
  ...
  nand2  g087(.a(new_n103_), .b(x14), .O(new_n132_));
  inv1   g088(.a(new_n126_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g090(.a(new_n117_), .b(new_n101_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n134_), .c(new_n131_), .d(new_n128_), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(x31), .c(new_n54_), .O(new_n138_));
  nand2  g094(.a(new_n120_), .b(x30), .O(new_n139_));
  aoi21  g095(.a(new_n54_), .b(new_n94_), .c(new_n122_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n138_), .O(new_n141_));
  nand2  g097(.a(new_n45_), .b(x00), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(new_n125_), .c(new_n142_), .O(z8));
  nor2   g099(.a(new_n118_), .b(new_n115_), .O(new_n144_));
  nand3  g100(.a(new_n123_), .b(new_n46_), .c(new_n94_), .O(new_n145_));
  nand3  g101(.a(new_n122_), .b(x31), .c(x30), .O(new_n146_));
  and2   g102(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  aoi21  g103(.a(new_n46_), .b(x26), .c(new_n50_), .O(new_n148_));
  oai21  g104(.a(new_n147_), .b(new_n136_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n146_), .b(x26), .O(new_n150_));
  nor2   g106(.a(new_n147_), .b(x33), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n144_), .c(new_n149_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x00), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n70_), .O(z9));
endmodule
