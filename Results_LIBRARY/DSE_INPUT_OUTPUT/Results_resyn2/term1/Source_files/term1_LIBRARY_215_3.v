...
module FAU ( 
  ...
  nor2   g025(.a(x26), .b(new_n60_), .O(new_n70_));
  ...
  and2   g036(.a(new_n80_), .b(new_n49_), .O(new_n81_));
  ...
  nand3  g041(.a(new_n70_), .b(new_n46_), .c(x25), .O(new_n86_));
  ...
  inv1   g049(.a(new_n81_), .O(new_n94_));
  nor2   g050(.a(new_n89_), .b(x29), .O(new_n95_));
  nand2  g051(.a(new_n89_), .b(x29), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  nor4   g053(.a(new_n97_), .b(new_n95_), .c(new_n86_), .d(new_n94_), .O(z5));
  nand2  g054(.a(new_n97_), .b(new_n83_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n46_), .c(new_n45_), .O(z6));
  inv1   g056(.a(x31), .O(new_n101_));
  nand3  g057(.a(new_n87_), .b(new_n81_), .c(new_n101_), .O(z7));
  ...
  nand3  g081(.a(new_n125_), .b(new_n123_), .c(x31), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n121_), .c(new_n104_), .O(new_n127_));
  inv1   g083(.a(x26), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x00), .O(new_n129_));
  nand3  g085(.a(new_n118_), .b(x16), .c(x15), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  aoi21  g087(.a(new_n114_), .b(new_n113_), .c(new_n106_), .O(new_n132_));
  ...
  nand2  g102(.a(new_n146_), .b(new_n103_), .O(z8));
  nand3  g103(.a(new_n122_), .b(new_n101_), .c(new_n46_), .O(new_n148_));
  oai21  g104(.a(new_n125_), .b(new_n101_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n142_), .O(new_n150_));
  nor2   g106(.a(new_n47_), .b(new_n54_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  aoi21  g108(.a(new_n116_), .b(new_n112_), .c(new_n139_), .O(new_n153_));
  nand4  g109(.a(new_n124_), .b(x31), .c(x30), .d(new_n45_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n148_), .c(x33), .O(new_n155_));
  oai21  g111(.a(new_n120_), .b(new_n153_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n152_), .c(new_n129_), .O(z9));
endmodule
