...
module FAU ( 
  ...
  oai21  g002(.a(new_n46_), .b(new_n45_), .c(x32), .O(z0));
  nor2   g003(.a(new_n46_), .b(new_n45_), .O(new_n48_));
  ...
  nor4   g024(.a(new_n68_), .b(new_n48_), .c(x09), .d(new_n58_), .O(z2));
  inv1   g025(.a(x27), .O(new_n70_));
  inv1   g026(.a(x17), .O(new_n71_));
  inv1   g027(.a(x18), .O(new_n72_));
  inv1   g028(.a(x22), .O(new_n73_));
  aoi22  g029(.a(new_n45_), .b(new_n72_), .c(new_n73_), .d(new_n71_), .O(new_n74_));
  ...
  nand3  g034(.a(new_n60_), .b(new_n46_), .c(x25), .O(new_n79_));
  ...
  xor2a  g056(.a(new_n100_), .b(new_n48_), .O(z7));
  inv1   g057(.a(x15), .O(new_n102_));
  inv1   g058(.a(x19), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x18), .c(x14), .O(new_n104_));
  nand3  g060(.a(x19), .b(new_n72_), .c(x13), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n104_), .c(new_n71_), .O(new_n106_));
  nand4  g062(.a(x19), .b(x18), .c(new_n71_), .d(x12), .O(new_n107_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n109_), .c(new_n102_), .O(new_n114_));
  nor2   g070(.a(new_n72_), .b(new_n71_), .O(new_n115_));
  ...
  aoi21  g078(.a(new_n54_), .b(x30), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g080(.a(new_n120_), .b(x30), .O(new_n125_));
  aoi22  g081(.a(new_n86_), .b(x29), .c(new_n54_), .d(new_n94_), .O(new_n126_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n54_), .O(new_n137_));
  ...
  nand2  g097(.a(new_n118_), .b(new_n94_), .O(new_n142_));
  ...
  nor3   g101(.a(new_n135_), .b(new_n134_), .c(new_n50_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n143_), .c(new_n133_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  aoi21  g104(.a(new_n144_), .b(new_n50_), .c(new_n148_), .O(z9));
endmodule
