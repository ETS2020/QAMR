...
module FAU ( 
  ...
  nand4  g034(.a(new_n49_), .b(new_n46_), .c(x25), .d(x01), .O(new_n79_));
  ...
  nand2  g043(.a(new_n87_), .b(new_n58_), .O(z4));
  ...
  nand2  g053(.a(new_n97_), .b(new_n58_), .O(z6));
  ...
  aoi22  g084(.a(new_n86_), .b(x29), .c(new_n124_), .d(new_n95_), .O(new_n129_));
  ...
  nand2  g103(.a(new_n120_), .b(new_n95_), .O(new_n148_));
  ...
  aoi21  g109(.a(new_n150_), .b(new_n55_), .c(new_n153_), .O(z9));
endmodule
