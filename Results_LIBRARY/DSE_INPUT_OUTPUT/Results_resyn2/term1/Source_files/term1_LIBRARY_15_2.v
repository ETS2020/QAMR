...
module FAU ( 
  ...
  nand2  g057(.a(x32), .b(x00), .O(new_n102_));
  ...
  nand3  g079(.a(new_n87_), .b(x30), .c(x29), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n123_), .c(x31), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n121_), .c(new_n51_), .O(new_n126_));
  nand4  g082(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n127_));
  oai21  g083(.a(new_n116_), .b(x16), .c(x19), .O(new_n128_));
  ...
  aoi21  g089(.a(new_n106_), .b(x14), .c(new_n127_), .O(new_n134_));
  aoi21  g090(.a(new_n119_), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n132_), .c(new_n129_), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n124_), .b(new_n123_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n51_), .O(new_n139_));
  nand2  g095(.a(new_n79_), .b(x00), .O(new_n140_));
  aoi21  g096(.a(new_n139_), .b(new_n137_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n126_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n104_), .O(z8));
  nand3  g099(.a(new_n122_), .b(new_n45_), .c(new_n95_), .O(new_n144_));
  oai21  g100(.a(new_n124_), .b(new_n45_), .c(new_n144_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  aoi21  g102(.a(x31), .b(x26), .c(new_n48_), .O(new_n147_));
  oai21  g103(.a(new_n146_), .b(new_n136_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n144_), .b(x26), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n145_), .c(new_n48_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n121_), .c(new_n148_), .O(new_n151_));
