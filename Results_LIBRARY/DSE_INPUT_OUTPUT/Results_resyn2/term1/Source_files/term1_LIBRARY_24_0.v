...
module FAU ( 
  ...
  inv1   g033(.a(new_n58_), .O(new_n78_));
  inv1   g034(.a(x26), .O(new_n79_));
  inv1   g035(.a(x27), .O(new_n80_));
  nand4  g036(.a(new_n80_), .b(new_n79_), .c(x25), .d(x00), .O(new_n81_));
  nor2   g037(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  and2   g038(.a(new_n82_), .b(new_n77_), .O(z3));
  nand2  g039(.a(new_n58_), .b(x25), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  and2   g041(.a(new_n85_), .b(new_n77_), .O(new_n86_));
  inv1   g042(.a(x28), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n80_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n87_), .b(new_n80_), .O(new_n90_));
  ...
  nand2  g060(.a(new_n104_), .b(x00), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n79_), .O(z7));
  ...
  aoi21  g087(.a(new_n87_), .b(new_n80_), .c(new_n94_), .O(new_n132_));
  aoi21  g088(.a(new_n52_), .b(new_n99_), .c(new_n132_), .O(new_n133_));
  ...
  nand2  g092(.a(new_n136_), .b(new_n71_), .O(new_n137_));
  ...
  aoi21  g104(.a(new_n133_), .b(new_n131_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n130_), .c(x26), .O(z8));
  nand2  g106(.a(x31), .b(x30), .O(new_n151_));
  aoi21  g107(.a(new_n124_), .b(new_n99_), .c(new_n132_), .O(new_n152_));
  aoi21  g108(.a(new_n151_), .b(new_n132_), .c(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n123_), .b(new_n120_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n48_), .O(new_n155_));
  nand4  g111(.a(new_n153_), .b(new_n145_), .c(new_n143_), .d(x33), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n141_), .c(new_n155_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(x00), .c(x26), .O(z9));
endmodule
