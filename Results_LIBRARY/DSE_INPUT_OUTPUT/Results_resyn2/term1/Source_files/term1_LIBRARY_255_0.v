...
module FAU ( 
  ...
  nand3  g035(.a(new_n79_), .b(new_n70_), .c(x07), .O(new_n80_));
  ...
  nor2   g041(.a(new_n84_), .b(new_n69_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n85_), .c(new_n79_), .O(new_n88_));
  aoi21  g044(.a(new_n88_), .b(x07), .c(x26), .O(z4));
  inv1   g045(.a(x29), .O(new_n90_));
  nand2  g046(.a(new_n87_), .b(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n86_), .b(x29), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n91_), .c(new_n79_), .O(new_n93_));
  aoi21  g049(.a(new_n93_), .b(x07), .c(x26), .O(z5));
  ...
  nand2  g079(.a(new_n85_), .b(x29), .O(new_n124_));
  ...
  aoi21  g084(.a(new_n48_), .b(new_n96_), .c(new_n128_), .O(new_n129_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n104_), .O(new_n135_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n139_), .c(new_n137_), .d(x31), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x32), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n130_), .c(new_n126_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x00), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(x07), .c(x26), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n124_), .O(new_n147_));
  nand2  g103(.a(new_n120_), .b(new_n96_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n124_), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n119_), .b(new_n116_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n55_), .O(new_n151_));
  aoi21  g107(.a(new_n106_), .b(new_n140_), .c(new_n55_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n149_), .c(new_n139_), .d(new_n137_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n151_), .c(x00), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(x07), .c(x26), .O(z9));
endmodule
