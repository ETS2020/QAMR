...
module FAU ( 
  ...
  nand4  g070(.a(new_n45_), .b(x18), .c(x17), .d(x14), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n112_), .O(new_n116_));
  nand4  g072(.a(x19), .b(x17), .c(new_n112_), .d(x11), .O(new_n117_));
  ...
  nand4  g077(.a(new_n121_), .b(x19), .c(x17), .d(new_n120_), .O(new_n122_));
  ...
  nand2  g092(.a(x16), .b(x14), .O(new_n137_));
  ...
  nand3  g113(.a(x18), .b(x17), .c(x14), .O(new_n158_));
