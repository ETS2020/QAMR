...
module FAU ( 
  ...
  xor2a  g048(.a(new_n88_), .b(x29), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n84_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n68_), .O(z5));
  nand2  g051(.a(new_n89_), .b(new_n45_), .O(new_n96_));
  nand2  g052(.a(new_n88_), .b(x30), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n84_), .d(x29), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z6));
  nand2  g055(.a(new_n97_), .b(x31), .O(new_n100_));
  nor2   g056(.a(x31), .b(new_n45_), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n88_), .c(new_n46_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n100_), .c(new_n84_), .O(z7));
  ...
  nand2  g068(.a(new_n74_), .b(x14), .O(new_n113_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n109_), .c(new_n68_), .O(new_n119_));
  nand2  g075(.a(new_n90_), .b(x29), .O(new_n120_));
  ...
  nand3  g082(.a(new_n74_), .b(x18), .c(x14), .O(new_n127_));
  ...
  nand3  g095(.a(new_n45_), .b(new_n87_), .c(new_n71_), .O(new_n140_));
  nand2  g096(.a(new_n90_), .b(x30), .O(new_n141_));
  ...
  nand2  g100(.a(new_n82_), .b(x00), .O(new_n145_));
