...
module FAU ( 
  ...
  and2   g031(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  inv1   g032(.a(x15), .O(new_n77_));
  inv1   g033(.a(x20), .O(new_n78_));
  nand2  g034(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  aoi21  g035(.a(new_n79_), .b(new_n76_), .c(new_n46_), .O(new_n80_));
  ...
  nand3  g040(.a(new_n84_), .b(new_n82_), .c(new_n68_), .O(new_n85_));
  ...
  nand2  g048(.a(new_n84_), .b(new_n69_), .O(new_n93_));
  ...
  nor3   g055(.a(new_n95_), .b(new_n93_), .c(x15), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(x30), .c(new_n78_), .O(new_n101_));
  inv1   g057(.a(new_n76_), .O(new_n102_));
  xor2a  g058(.a(new_n95_), .b(new_n45_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n94_), .c(new_n102_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n101_), .O(z6));
  oai21  g061(.a(new_n79_), .b(x31), .c(new_n76_), .O(new_n106_));
  nor2   g062(.a(new_n93_), .b(new_n46_), .O(new_n107_));
  xor2a  g063(.a(x31), .b(x30), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n88_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n95_), .b(x31), .O(new_n110_));
  ...
  xor2a  g088(.a(new_n132_), .b(new_n45_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n51_), .c(x31), .O(new_n134_));
  oai21  g090(.a(new_n125_), .b(x16), .c(x15), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n129_), .O(new_n136_));
  nand3  g092(.a(new_n128_), .b(x16), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n115_), .O(new_n138_));
  nand2  g094(.a(new_n115_), .b(x14), .O(new_n139_));
  nand4  g095(.a(new_n128_), .b(new_n139_), .c(x16), .d(x15), .O(new_n140_));
  ...
  nand2  g100(.a(new_n117_), .b(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n143_), .c(new_n133_), .d(x31), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n141_), .c(x32), .O(new_n147_));
  oai21  g103(.a(new_n134_), .b(new_n131_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n113_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n47_), .O(z8));
  inv1   g106(.a(x33), .O(new_n151_));
  nor2   g107(.a(new_n133_), .b(new_n108_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n131_), .c(new_n151_), .O(new_n154_));
  inv1   g110(.a(new_n113_), .O(new_n155_));
  nand4  g111(.a(new_n152_), .b(new_n145_), .c(new_n143_), .d(x33), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(new_n141_), .O(new_n157_));
