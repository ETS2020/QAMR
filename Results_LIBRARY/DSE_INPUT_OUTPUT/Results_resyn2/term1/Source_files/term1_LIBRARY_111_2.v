...
module FAU ( 
  ...
  nand2  g001(.a(new_n45_), .b(x04), .O(new_n46_));
  ...
  nor2   g027(.a(x26), .b(x04), .O(new_n72_));
  ...
  nand2  g038(.a(new_n56_), .b(x25), .O(new_n83_));
  ...
  aoi21  g057(.a(new_n101_), .b(new_n97_), .c(x26), .O(z5));
  ...
  nand2  g063(.a(new_n98_), .b(x31), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(new_n98_), .c(new_n108_), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n85_), .c(new_n97_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n45_), .O(z7));
  nand2  g067(.a(new_n94_), .b(x29), .O(new_n112_));
  xor2a  g068(.a(new_n112_), .b(new_n103_), .O(new_n113_));
  ...
  aoi22  g077(.a(new_n121_), .b(new_n116_), .c(new_n120_), .d(new_n115_), .O(new_n122_));
  nand3  g078(.a(new_n119_), .b(x16), .c(x15), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n76_), .O(new_n124_));
  inv1   g080(.a(new_n123_), .O(new_n125_));
  nand2  g081(.a(new_n76_), .b(x14), .O(new_n126_));
  ...
  nand4  g086(.a(new_n130_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n114_), .c(x32), .O(new_n132_));
  nand3  g088(.a(new_n76_), .b(x18), .c(x14), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n118_), .c(x13), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n117_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x18), .c(new_n117_), .d(x12), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(x16), .O(new_n138_));
  inv1   g094(.a(new_n121_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(x19), .c(new_n116_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nor3   g097(.a(new_n120_), .b(new_n76_), .c(x15), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(x15), .c(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n113_), .b(new_n51_), .c(x31), .O(new_n144_));
  or2    g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n72_), .b(x00), .O(new_n146_));
  aoi21  g102(.a(new_n145_), .b(new_n132_), .c(new_n146_), .O(z8));
  inv1   g103(.a(new_n107_), .O(new_n148_));
  nor2   g104(.a(new_n113_), .b(new_n148_), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n143_), .c(new_n48_), .O(new_n151_));
  inv1   g107(.a(x00), .O(new_n152_));
  nor3   g108(.a(new_n129_), .b(new_n128_), .c(new_n48_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n149_), .c(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n97_), .c(x26), .O(z9));
endmodule
