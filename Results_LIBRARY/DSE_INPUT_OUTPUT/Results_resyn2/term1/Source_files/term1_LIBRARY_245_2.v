...
module FAU ( 
  ...
  nand3  g025(.a(new_n67_), .b(new_n64_), .c(new_n58_), .O(new_n70_));
  ...
  oai21  g032(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nor2   g033(.a(x20), .b(x15), .O(new_n78_));
  oai22  g034(.a(x24), .b(x19), .c(x21), .d(x16), .O(new_n79_));
  nor2   g035(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  aoi21  g036(.a(new_n80_), .b(new_n77_), .c(new_n48_), .O(new_n81_));
  nand2  g037(.a(x25), .b(x01), .O(new_n82_));
  nor2   g038(.a(new_n82_), .b(x26), .O(new_n83_));
  nand4  g039(.a(new_n83_), .b(new_n81_), .c(new_n65_), .d(new_n73_), .O(new_n84_));
  ...
  nand4  g045(.a(new_n89_), .b(new_n83_), .c(new_n81_), .d(new_n65_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z4));
  nand2  g047(.a(new_n83_), .b(new_n65_), .O(new_n92_));
  aoi21  g048(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(new_n93_));
  aoi21  g049(.a(new_n93_), .b(new_n80_), .c(new_n92_), .O(new_n94_));
  nand2  g050(.a(new_n87_), .b(x29), .O(new_n95_));
  inv1   g051(.a(x29), .O(new_n96_));
  nand2  g052(.a(new_n86_), .b(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n46_), .O(z5));
  ...
  nor2   g078(.a(new_n108_), .b(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(x16), .d(x12), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n120_), .c(new_n74_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n119_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x32), .O(new_n127_));
  nand3  g083(.a(x19), .b(new_n74_), .c(x12), .O(new_n128_));
  nand3  g084(.a(new_n108_), .b(x17), .c(x14), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x16), .O(new_n131_));
  inv1   g087(.a(x16), .O(new_n132_));
  nand4  g088(.a(x19), .b(x17), .c(new_n132_), .d(x11), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n131_), .c(new_n122_), .O(new_n134_));
  nand2  g090(.a(x16), .b(x10), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(x15), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x19), .c(x17), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n121_), .b(new_n54_), .O(new_n139_));
  ...
  aoi21  g099(.a(new_n141_), .b(new_n127_), .c(new_n143_), .O(z8));
  oai21  g100(.a(new_n143_), .b(new_n50_), .c(new_n74_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n45_), .O(new_n146_));
  inv1   g102(.a(new_n133_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n74_), .d(x12), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n129_), .c(new_n132_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n147_), .c(x15), .O(new_n150_));
  xnor2a g106(.a(x31), .b(x30), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n120_), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(new_n137_), .c(new_n152_), .O(new_n153_));
  inv1   g109(.a(new_n152_), .O(new_n154_));
  nor2   g110(.a(x19), .b(new_n114_), .O(new_n155_));
  oai21  g111(.a(new_n115_), .b(new_n155_), .c(x33), .O(new_n156_));
  nand2  g112(.a(x16), .b(x12), .O(new_n157_));
  oai21  g113(.a(x16), .b(x11), .c(x17), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g115(.a(new_n115_), .b(new_n108_), .O(new_n160_));
  oai21  g116(.a(new_n135_), .b(new_n74_), .c(new_n122_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(new_n159_), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n156_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n154_), .c(new_n143_), .O(new_n164_));
  oai21  g120(.a(new_n153_), .b(x33), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n146_), .O(z9));
endmodule
