...
module FAU ( 
  ...
  aoi21  g035(.a(new_n45_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  ...
  nor2   g056(.a(new_n93_), .b(x30), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n82_), .c(new_n47_), .O(z6));
  inv1   g059(.a(x31), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x30), .O(new_n105_));
  nand2  g061(.a(x31), .b(new_n98_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n100_), .c(new_n105_), .d(new_n99_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n85_), .c(new_n74_), .O(z7));
  ...
  xor2a  g070(.a(new_n114_), .b(x30), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n104_), .O(new_n116_));
  ...
  aoi21  g079(.a(new_n123_), .b(x19), .c(new_n119_), .O(new_n124_));
  aoi21  g080(.a(new_n78_), .b(x14), .c(new_n111_), .O(new_n125_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n124_), .c(x18), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n118_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x32), .O(new_n132_));
  nand2  g088(.a(x18), .b(x17), .O(new_n133_));
  nor4   g089(.a(new_n133_), .b(new_n122_), .c(new_n78_), .d(x15), .O(new_n134_));
  nand3  g090(.a(x18), .b(x17), .c(x11), .O(new_n135_));
  nor3   g091(.a(new_n135_), .b(new_n78_), .c(x16), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand4  g093(.a(x19), .b(x18), .c(new_n121_), .d(x12), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n78_), .b(x18), .c(x14), .O(new_n140_));
  nand3  g096(.a(x19), .b(new_n110_), .c(x13), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(new_n121_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n137_), .c(new_n120_), .O(new_n144_));
  nand3  g100(.a(new_n140_), .b(new_n138_), .c(x24), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nor2   g102(.a(new_n136_), .b(new_n134_), .O(new_n147_));
  nand2  g103(.a(new_n116_), .b(new_n54_), .O(new_n148_));
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n144_), .b(new_n134_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n72_), .b(x00), .O(new_n151_));
  aoi21  g107(.a(new_n150_), .b(new_n132_), .c(new_n151_), .O(z8));
  nand2  g108(.a(new_n143_), .b(new_n137_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(x15), .c(new_n134_), .O(new_n154_));
  nand3  g110(.a(new_n115_), .b(new_n106_), .c(new_n105_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(new_n50_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  oai21  g113(.a(new_n133_), .b(new_n157_), .c(new_n78_), .O(new_n158_));
  inv1   g114(.a(x16), .O(new_n159_));
  nand2  g115(.a(new_n135_), .b(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n133_), .b(new_n122_), .c(new_n120_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  nand2  g118(.a(new_n125_), .b(x18), .O(new_n163_));
  nand2  g119(.a(x18), .b(x12), .O(new_n164_));
  oai21  g120(.a(x18), .b(x13), .c(x17), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nor2   g122(.a(new_n107_), .b(new_n50_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n166_), .c(new_n163_), .d(new_n115_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n162_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n151_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n156_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n47_), .O(z9));
endmodule
