...
module FAU ( 
  ...
  nand4  g043(.a(new_n87_), .b(new_n84_), .c(new_n57_), .d(new_n74_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z3));
  and2   g045(.a(new_n87_), .b(new_n84_), .O(new_n90_));
  inv1   g046(.a(x28), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n74_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n91_), .b(new_n74_), .O(new_n94_));
  ...
  nand2  g057(.a(new_n84_), .b(new_n57_), .O(new_n102_));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n90_), .c(new_n46_), .O(z7));
  ...
  nor2   g078(.a(new_n45_), .b(new_n78_), .O(new_n123_));
  ...
  aoi21  g090(.a(new_n53_), .b(new_n103_), .c(new_n134_), .O(new_n135_));
  ...
  nand2  g102(.a(new_n45_), .b(new_n146_), .O(new_n147_));
  ...
  nand2  g106(.a(new_n85_), .b(x00), .O(new_n151_));
  ...
  nand2  g111(.a(new_n126_), .b(new_n103_), .O(new_n156_));
  ...
  aoi21  g115(.a(new_n45_), .b(new_n146_), .c(new_n49_), .O(new_n160_));
  ...
  nand2  g118(.a(new_n162_), .b(new_n57_), .O(z9));
endmodule
