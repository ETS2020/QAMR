...
module FAU ( 
  ...
  nand2  g055(.a(new_n99_), .b(new_n84_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  inv1   g057(.a(x31), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nand2  g059(.a(new_n102_), .b(new_n98_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  or2    g061(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n93_), .O(new_n107_));
  aoi21  g063(.a(new_n93_), .b(x31), .c(new_n107_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n82_), .c(new_n46_), .O(z7));
  ...
  nand3  g069(.a(x19), .b(new_n45_), .c(x13), .O(new_n114_));
  ...
  nand4  g075(.a(x19), .b(x17), .c(new_n119_), .d(x11), .O(new_n120_));
  ...
  nor2   g079(.a(new_n111_), .b(new_n119_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x19), .c(new_n110_), .d(x10), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nor2   g082(.a(x32), .b(new_n102_), .O(new_n127_));
  ...
  aoi21  g090(.a(new_n54_), .b(new_n98_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g092(.a(new_n124_), .b(x19), .c(x13), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand2  g094(.a(x17), .b(x11), .O(new_n139_));
  nand2  g095(.a(new_n124_), .b(x15), .O(new_n140_));
  oai21  g096(.a(x17), .b(x12), .c(x16), .O(new_n141_));
  aoi22  g097(.a(new_n141_), .b(new_n139_), .c(new_n140_), .d(new_n112_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(x18), .c(new_n138_), .O(new_n143_));
  nand2  g099(.a(new_n124_), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n45_), .c(new_n110_), .O(new_n145_));
  nand2  g101(.a(new_n112_), .b(x14), .O(new_n146_));
  nand4  g102(.a(new_n124_), .b(new_n146_), .c(x18), .d(x15), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n145_), .c(x31), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n143_), .c(x32), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n136_), .c(new_n132_), .O(new_n150_));
  nand2  g106(.a(new_n80_), .b(x00), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n47_), .O(z8));
  nand2  g110(.a(x33), .b(x30), .O(new_n155_));
  nand3  g111(.a(new_n124_), .b(x15), .c(x13), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n105_), .c(new_n50_), .d(x19), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n155_), .c(x18), .O(new_n159_));
  inv1   g115(.a(x08), .O(new_n160_));
  nand2  g116(.a(new_n111_), .b(x12), .O(new_n161_));
  oai21  g117(.a(x19), .b(x17), .c(x16), .O(new_n162_));
  aoi21  g118(.a(new_n161_), .b(new_n146_), .c(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n121_), .c(x15), .O(new_n164_));
  nand2  g120(.a(new_n50_), .b(x18), .O(new_n165_));
  aoi21  g121(.a(new_n164_), .b(new_n125_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n105_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n155_), .c(new_n160_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n159_), .c(new_n130_), .O(new_n169_));
  nor2   g125(.a(new_n50_), .b(x30), .O(new_n170_));
  nand3  g126(.a(new_n103_), .b(new_n50_), .c(x19), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n156_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n170_), .c(new_n45_), .O(new_n173_));
  aoi21  g129(.a(new_n166_), .b(new_n103_), .c(new_n170_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n160_), .c(new_n173_), .O(new_n175_));
  inv1   g131(.a(new_n142_), .O(new_n176_));
  nand2  g132(.a(new_n144_), .b(new_n110_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n147_), .c(new_n106_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n176_), .c(x08), .O(new_n179_));
  nand3  g135(.a(new_n157_), .b(new_n106_), .c(x19), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n45_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(new_n50_), .O(new_n182_));
  aoi21  g138(.a(new_n175_), .b(new_n134_), .c(new_n182_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n169_), .c(new_n151_), .O(z9));
endmodule
