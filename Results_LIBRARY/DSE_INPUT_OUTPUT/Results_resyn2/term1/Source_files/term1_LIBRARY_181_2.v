...
module FAU ( 
  ...
  nor2   g051(.a(x30), .b(x29), .O(new_n96_));
  aoi21  g052(.a(new_n94_), .b(x30), .c(new_n96_), .O(z6));
  xor2a  g053(.a(new_n93_), .b(x31), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n83_), .c(new_n51_), .O(z7));
  nand2  g055(.a(x31), .b(x30), .O(new_n100_));
  aoi21  g056(.a(new_n89_), .b(x29), .c(new_n100_), .O(new_n101_));
  inv1   g057(.a(x15), .O(new_n102_));
  inv1   g058(.a(x17), .O(new_n103_));
  nand3  g059(.a(new_n74_), .b(x18), .c(x14), .O(new_n104_));
  ...
  nor3   g072(.a(new_n116_), .b(new_n74_), .c(x15), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n115_), .c(new_n101_), .O(new_n118_));
  ...
  nand2  g081(.a(new_n116_), .b(new_n102_), .O(new_n126_));
  nand2  g082(.a(new_n74_), .b(x14), .O(new_n127_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n101_), .c(x32), .O(new_n131_));
  nand2  g087(.a(new_n81_), .b(x00), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n51_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  aoi21  g090(.a(new_n118_), .b(new_n50_), .c(new_n134_), .O(z8));
  ...
  nand2  g094(.a(new_n89_), .b(x31), .O(new_n139_));
  ...
  nand4  g098(.a(new_n89_), .b(x31), .c(x30), .d(x29), .O(new_n143_));
  nand2  g099(.a(new_n96_), .b(new_n137_), .O(new_n144_));
