...
module FAU ( 
  ...
  nand3  g032(.a(new_n59_), .b(new_n45_), .c(x25), .O(new_n77_));
  ...
  inv1   g042(.a(new_n46_), .O(new_n87_));
  nand2  g043(.a(new_n82_), .b(x29), .O(new_n88_));
  inv1   g044(.a(x29), .O(new_n89_));
  nand2  g045(.a(new_n83_), .b(new_n89_), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n88_), .c(new_n78_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n87_), .O(z5));
  nand3  g048(.a(new_n82_), .b(x30), .c(x29), .O(new_n93_));
  ...
  nand2  g054(.a(new_n98_), .b(new_n78_), .O(z7));
  ...
  nor2   g070(.a(new_n104_), .b(new_n101_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x16), .c(x10), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n102_), .c(x15), .O(new_n117_));
  ...
  aoi21  g078(.a(new_n53_), .b(x30), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g080(.a(new_n120_), .b(x30), .O(new_n125_));
  inv1   g081(.a(new_n122_), .O(new_n126_));
  aoi21  g082(.a(new_n53_), .b(new_n94_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  oai21  g084(.a(new_n112_), .b(x16), .c(x15), .O(new_n129_));
  inv1   g085(.a(x14), .O(new_n130_));
  nor2   g086(.a(x19), .b(new_n130_), .O(new_n131_));
  nand3  g087(.a(new_n115_), .b(x16), .c(x15), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n102_), .O(new_n133_));
  oai21  g089(.a(new_n132_), .b(new_n131_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(new_n129_), .b(new_n116_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(x18), .b(x12), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n101_), .O(new_n137_));
  inv1   g093(.a(x13), .O(new_n138_));
  nand2  g094(.a(new_n104_), .b(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n137_), .c(new_n135_), .d(x31), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x32), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n128_), .c(new_n124_), .O(new_n142_));
  nand2  g098(.a(new_n45_), .b(x00), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n87_), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n122_), .O(new_n147_));
  nand2  g103(.a(new_n118_), .b(new_n94_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n122_), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n117_), .b(new_n114_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n49_), .O(new_n151_));
  aoi21  g107(.a(new_n104_), .b(new_n138_), .c(new_n49_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n149_), .c(new_n137_), .d(new_n135_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n151_), .c(new_n144_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n87_), .O(z9));
endmodule
