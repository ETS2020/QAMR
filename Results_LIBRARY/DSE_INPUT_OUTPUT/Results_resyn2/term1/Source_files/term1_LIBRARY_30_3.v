...
module FAU ( 
  ...
  oai21  g056(.a(new_n100_), .b(new_n83_), .c(new_n58_), .O(z6));
  xor2a  g057(.a(new_n97_), .b(x31), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n82_), .c(new_n80_), .O(z7));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n74_), .O(new_n109_));
  nand4  g065(.a(x19), .b(x18), .c(new_n74_), .d(x12), .O(new_n110_));
  ...
  nor2   g073(.a(new_n107_), .b(new_n74_), .O(new_n118_));
  ...
  aoi21  g085(.a(new_n86_), .b(new_n85_), .c(new_n93_), .O(new_n130_));
  aoi21  g086(.a(new_n125_), .b(new_n98_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g091(.a(new_n105_), .b(x14), .O(new_n136_));
  ...
  aoi21  g103(.a(new_n147_), .b(new_n128_), .c(new_n45_), .O(z8));
  nand2  g104(.a(x31), .b(x30), .O(new_n149_));
  aoi21  g105(.a(new_n121_), .b(new_n98_), .c(new_n130_), .O(new_n150_));
  aoi21  g106(.a(new_n149_), .b(new_n130_), .c(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n120_), .b(new_n117_), .c(new_n151_), .O(new_n152_));
  ...
  aoi21  g111(.a(new_n155_), .b(new_n46_), .c(new_n45_), .O(z9));
endmodule
