...
module FAU ( 
  ...
  aoi21  g021(.a(new_n46_), .b(new_n53_), .c(new_n58_), .O(new_n66_));
  ...
  nand2  g058(.a(new_n102_), .b(new_n51_), .O(z6));
  ...
  oai21  g079(.a(new_n123_), .b(x30), .c(new_n47_), .O(new_n124_));
  nand2  g080(.a(new_n89_), .b(x29), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand2  g082(.a(x32), .b(new_n99_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n126_), .c(new_n124_), .O(new_n128_));
  nand2  g084(.a(new_n47_), .b(x30), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n123_), .c(new_n127_), .O(new_n130_));
  nand2  g086(.a(x18), .b(x12), .O(new_n131_));
  oai21  g087(.a(x18), .b(x13), .c(x17), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(x16), .c(new_n117_), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n120_), .b(x16), .c(x15), .O(new_n136_));
  aoi21  g092(.a(new_n107_), .b(x14), .c(new_n136_), .O(new_n137_));
  inv1   g093(.a(new_n121_), .O(new_n138_));
  nand2  g094(.a(new_n136_), .b(new_n107_), .O(new_n139_));
  oai21  g095(.a(new_n138_), .b(x15), .c(new_n139_), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n135_), .c(new_n47_), .O(new_n142_));
  aoi21  g098(.a(new_n130_), .b(new_n125_), .c(new_n142_), .O(new_n143_));
  nand3  g099(.a(x31), .b(new_n81_), .c(x00), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n128_), .c(new_n144_), .O(z8));
  oai21  g101(.a(new_n50_), .b(new_n99_), .c(new_n126_), .O(new_n146_));
  oai21  g102(.a(x31), .b(x30), .c(new_n125_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n123_), .c(new_n52_), .O(new_n149_));
  nand3  g105(.a(new_n147_), .b(new_n146_), .c(x33), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n141_), .c(new_n135_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n149_), .c(new_n81_), .d(x00), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n51_), .O(z9));
endmodule
