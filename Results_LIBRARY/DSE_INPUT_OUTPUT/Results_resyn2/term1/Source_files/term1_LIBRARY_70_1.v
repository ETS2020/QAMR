...
module FAU ( 
  ...
  nand2  g001(.a(x23), .b(new_n45_), .O(new_n46_));
  ...
  aoi21  g032(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n77_));
  ...
  xor2a  g040(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n110_), .c(new_n46_), .O(new_n113_));
  ...
  nand2  g118(.a(new_n162_), .b(new_n50_), .O(new_n163_));
  aoi21  g119(.a(new_n45_), .b(new_n150_), .c(new_n50_), .O(new_n164_));
