...
module FAU ( 
  ...
  oai21  g026(.a(x22), .b(x17), .c(x18), .O(new_n71_));
  ...
  nand2  g031(.a(new_n59_), .b(x25), .O(new_n76_));
  nor2   g032(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n70_), .c(new_n45_), .O(new_n78_));
  ...
  nand2  g054(.a(new_n98_), .b(new_n77_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n45_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n70_), .O(z7));
  ...
  aoi22  g083(.a(new_n85_), .b(x29), .c(new_n53_), .d(new_n94_), .O(new_n128_));
  ...
  nor3   g103(.a(new_n137_), .b(new_n136_), .c(new_n49_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n145_), .c(new_n135_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  aoi21  g106(.a(new_n146_), .b(new_n49_), .c(new_n150_), .O(z9));
endmodule
