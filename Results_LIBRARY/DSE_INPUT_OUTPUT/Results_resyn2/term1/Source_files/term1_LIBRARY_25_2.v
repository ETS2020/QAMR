...
module FAU ( 
  ...
  nand3  g024(.a(new_n56_), .b(new_n68_), .c(x25), .O(new_n69_));
  ...
  oai21  g034(.a(new_n78_), .b(x27), .c(new_n47_), .O(z3));
  ...
  oai21  g041(.a(new_n85_), .b(new_n78_), .c(new_n47_), .O(z4));
  ...
  nor2   g048(.a(new_n92_), .b(new_n46_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n88_), .d(new_n70_), .O(new_n94_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n78_), .c(new_n47_), .O(z6));
  inv1   g056(.a(new_n78_), .O(new_n101_));
  xor2a  g057(.a(new_n96_), .b(x31), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n101_), .c(new_n46_), .O(z7));
  ...
  nand3  g063(.a(x19), .b(new_n45_), .c(x13), .O(new_n108_));
  ...
  nor2   g073(.a(new_n45_), .b(new_n105_), .O(new_n118_));
  ...
  aoi21  g085(.a(new_n51_), .b(new_n97_), .c(new_n129_), .O(new_n130_));
  ...
  nand2  g107(.a(new_n121_), .b(new_n97_), .O(new_n152_));
  ...
  aoi21  g111(.a(new_n45_), .b(new_n141_), .c(new_n150_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n153_), .c(new_n140_), .d(new_n138_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n155_), .c(new_n147_), .O(new_n158_));
