...
module FAU ( 
  ...
  aoi21  g007(.a(x33), .b(new_n48_), .c(x02), .O(new_n52_));
  oai21  g008(.a(new_n51_), .b(new_n48_), .c(new_n52_), .O(new_n53_));
  aoi21  g009(.a(new_n53_), .b(new_n50_), .c(new_n45_), .O(z1));
  inv1   g010(.a(new_n45_), .O(new_n55_));
  ...
  nand2  g025(.a(new_n69_), .b(new_n55_), .O(z2));
  ...
  nand3  g035(.a(new_n57_), .b(new_n79_), .c(x25), .O(new_n80_));
  inv1   g036(.a(new_n80_), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n78_), .c(new_n71_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n55_), .O(z3));
  ...
  nand4  g049(.a(new_n93_), .b(new_n91_), .c(new_n81_), .d(new_n78_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n55_), .O(z5));
  ...
  nand4  g055(.a(new_n99_), .b(new_n97_), .c(new_n84_), .d(new_n81_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  oai21  g057(.a(x31), .b(new_n72_), .c(new_n99_), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  nand3  g059(.a(new_n98_), .b(new_n103_), .c(x30), .O(new_n104_));
  oai21  g060(.a(new_n74_), .b(new_n103_), .c(new_n77_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n104_), .c(new_n102_), .d(new_n81_), .O(z7));
  oai21  g062(.a(x28), .b(x27), .c(x29), .O(new_n107_));
  and2   g063(.a(new_n107_), .b(new_n96_), .O(new_n108_));
  nor2   g064(.a(new_n107_), .b(new_n96_), .O(new_n109_));
  ...
  nand3  g070(.a(x19), .b(new_n72_), .c(x13), .O(new_n115_));
  ...
  nand4  g076(.a(x19), .b(x17), .c(new_n120_), .d(x11), .O(new_n121_));
  ...
  nand2  g080(.a(new_n111_), .b(x10), .O(new_n125_));
  nand4  g081(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n124_), .c(new_n110_), .O(new_n128_));
  nand3  g084(.a(x17), .b(x16), .c(x15), .O(new_n129_));
  nand3  g085(.a(x17), .b(x16), .c(x10), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand2  g087(.a(x17), .b(x11), .O(new_n132_));
  nand2  g088(.a(x16), .b(x12), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n111_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n131_), .c(x19), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n129_), .O(new_n136_));
  aoi21  g092(.a(new_n113_), .b(x14), .c(new_n129_), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n103_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(new_n72_), .O(new_n139_));
  nand3  g095(.a(x19), .b(x17), .c(x16), .O(new_n140_));
  nand2  g096(.a(x15), .b(x13), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(new_n72_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n110_), .c(x32), .O(new_n143_));
  aoi21  g099(.a(x32), .b(x18), .c(x31), .O(new_n144_));
  nand2  g100(.a(new_n79_), .b(x00), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  oai21  g102(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n128_), .b(new_n51_), .c(new_n147_), .O(z8));
  nor3   g104(.a(new_n107_), .b(new_n103_), .c(new_n96_), .O(new_n149_));
  oai21  g105(.a(new_n127_), .b(new_n124_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n113_), .b(x14), .O(new_n151_));
  nand2  g107(.a(new_n112_), .b(x12), .O(new_n152_));
  oai21  g108(.a(x19), .b(x17), .c(x16), .O(new_n153_));
  aoi21  g109(.a(new_n152_), .b(new_n151_), .c(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n122_), .c(x15), .O(new_n155_));
  oai21  g111(.a(new_n140_), .b(new_n125_), .c(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n108_), .b(new_n103_), .c(x18), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n156_), .c(x33), .O(new_n159_));
  inv1   g115(.a(new_n145_), .O(new_n160_));
  aoi21  g116(.a(new_n107_), .b(new_n96_), .c(x31), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n137_), .c(x18), .O(new_n162_));
  nand2  g118(.a(new_n142_), .b(new_n109_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x31), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n162_), .c(new_n136_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n55_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x33), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n160_), .O(new_n168_));
  aoi21  g124(.a(new_n159_), .b(new_n150_), .c(new_n168_), .O(z9));
endmodule
