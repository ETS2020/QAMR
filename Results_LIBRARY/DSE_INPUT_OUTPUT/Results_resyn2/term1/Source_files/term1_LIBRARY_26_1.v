...
module FAU ( 
  ...
  xor2a  g058(.a(new_n98_), .b(new_n45_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n97_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n47_), .O(z6));
  xor2a  g061(.a(x31), .b(x30), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n93_), .c(x29), .O(new_n107_));
  aoi21  g063(.a(new_n98_), .b(x31), .c(new_n46_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n97_), .O(z7));
  ...
  oai21  g071(.a(new_n115_), .b(x16), .c(x15), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand3  g073(.a(new_n112_), .b(x16), .c(x15), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n78_), .O(new_n119_));
  nand2  g075(.a(new_n78_), .b(x14), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n112_), .c(x16), .d(x15), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n119_), .c(new_n117_), .O(new_n122_));
  ...
  nand2  g083(.a(new_n111_), .b(new_n127_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n126_), .c(new_n124_), .d(x31), .O(new_n129_));
  inv1   g085(.a(x00), .O(new_n130_));
  aoi21  g086(.a(new_n45_), .b(new_n130_), .c(new_n54_), .O(new_n131_));
  oai21  g087(.a(new_n129_), .b(new_n122_), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n78_), .b(x18), .c(x14), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n111_), .c(x13), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n110_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x18), .c(new_n110_), .d(x12), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(x16), .O(new_n138_));
  inv1   g094(.a(x16), .O(new_n139_));
  nand3  g095(.a(new_n115_), .b(x19), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nor3   g097(.a(new_n113_), .b(new_n78_), .c(x15), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(x15), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n45_), .b(new_n130_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n124_), .c(new_n54_), .d(x31), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n143_), .c(new_n132_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n86_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n47_), .O(z8));
  and2   g104(.a(new_n141_), .b(x15), .O(new_n149_));
  nor2   g105(.a(new_n124_), .b(new_n106_), .O(new_n150_));
  oai21  g106(.a(new_n142_), .b(new_n149_), .c(new_n150_), .O(new_n151_));
  nand4  g107(.a(new_n150_), .b(new_n128_), .c(new_n126_), .d(x33), .O(new_n152_));
  nor2   g108(.a(x26), .b(new_n130_), .O(new_n153_));
  oai21  g109(.a(new_n152_), .b(new_n122_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n151_), .b(new_n50_), .c(new_n154_), .O(z9));
endmodule
