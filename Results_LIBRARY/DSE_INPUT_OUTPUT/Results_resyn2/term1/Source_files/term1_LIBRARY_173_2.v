...
module FAU ( 
  ...
  oai21  g041(.a(x20), .b(x15), .c(x23), .O(new_n86_));
  ...
  aoi21  g088(.a(new_n53_), .b(new_n101_), .c(new_n132_), .O(new_n133_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n57_), .O(z8));
  aoi21  g108(.a(x31), .b(x30), .c(new_n128_), .O(new_n153_));
  nand2  g109(.a(new_n124_), .b(new_n101_), .O(new_n154_));
  ...
  aoi21  g113(.a(new_n45_), .b(new_n144_), .c(new_n49_), .O(new_n158_));
  ...
  nand2  g116(.a(new_n160_), .b(new_n57_), .O(z9));
endmodule
