...
module FAU ( 
  ...
  oai22  g019(.a(x24), .b(x19), .c(x23), .d(x18), .O(new_n64_));
  oai22  g020(.a(x22), .b(x17), .c(x21), .d(x16), .O(new_n65_));
  nor2   g021(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  inv1   g022(.a(x15), .O(new_n67_));
  inv1   g023(.a(x20), .O(new_n68_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n108_), .c(new_n67_), .O(new_n113_));
  ...
  and2   g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nor2   g075(.a(new_n118_), .b(new_n117_), .O(new_n120_));
  nor3   g076(.a(new_n120_), .b(new_n119_), .c(new_n97_), .O(new_n121_));
  oai21  g077(.a(new_n116_), .b(new_n113_), .c(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n49_), .O(new_n123_));
  nand2  g079(.a(new_n71_), .b(x00), .O(new_n124_));
  nand3  g080(.a(new_n114_), .b(x16), .c(x15), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  aoi21  g082(.a(new_n110_), .b(new_n109_), .c(new_n101_), .O(new_n127_));
  ...
  nand2  g087(.a(new_n101_), .b(x14), .O(new_n132_));
  nand2  g088(.a(new_n126_), .b(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n115_), .b(new_n67_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n133_), .c(new_n131_), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n128_), .O(new_n136_));
  nand2  g092(.a(new_n121_), .b(x32), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(new_n124_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n123_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n46_), .O(z8));
  nand2  g097(.a(new_n120_), .b(x31), .O(new_n142_));
  nand2  g098(.a(new_n119_), .b(new_n97_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n136_), .O(new_n145_));
  inv1   g101(.a(x33), .O(new_n146_));
  nor2   g102(.a(new_n45_), .b(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g104(.a(new_n119_), .b(new_n97_), .c(x20), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n142_), .c(x33), .O(new_n150_));
  oai21  g106(.a(new_n116_), .b(new_n113_), .c(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n148_), .c(new_n124_), .O(z9));
endmodule
