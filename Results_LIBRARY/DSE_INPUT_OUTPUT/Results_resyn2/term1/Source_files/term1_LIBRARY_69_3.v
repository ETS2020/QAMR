...
module FAU ( 
  ...
  nand2  g000(.a(x18), .b(x11), .O(new_n45_));
  ...
  nand3  g022(.a(new_n45_), .b(new_n66_), .c(x08), .O(new_n67_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n95_), .c(new_n93_), .d(new_n45_), .O(new_n97_));
  ...
  oai21  g058(.a(new_n102_), .b(new_n84_), .c(new_n45_), .O(z6));
  xor2a  g059(.a(new_n99_), .b(x31), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n93_), .c(new_n47_), .O(z7));
  aoi21  g061(.a(new_n87_), .b(new_n86_), .c(new_n94_), .O(new_n106_));
  ...
  nand3  g072(.a(x18), .b(x17), .c(x10), .O(new_n117_));
  ...
  nor2   g078(.a(x30), .b(new_n74_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(new_n120_), .O(new_n124_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n133_), .c(new_n127_), .O(new_n144_));
  ...
  nand2  g104(.a(new_n123_), .b(new_n121_), .O(new_n149_));
  aoi21  g105(.a(new_n119_), .b(new_n115_), .c(new_n149_), .O(new_n150_));
  nor2   g106(.a(new_n49_), .b(x30), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n106_), .O(new_n152_));
  oai21  g108(.a(new_n150_), .b(x33), .c(new_n152_), .O(new_n153_));
  nand3  g109(.a(new_n129_), .b(new_n49_), .c(x31), .O(new_n154_));
  aoi21  g110(.a(new_n119_), .b(new_n115_), .c(new_n154_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n151_), .c(new_n106_), .O(new_n156_));
  xor2a  g112(.a(x31), .b(x30), .O(new_n157_));
  nor3   g113(.a(new_n157_), .b(new_n140_), .c(new_n139_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n138_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x33), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n156_), .c(new_n153_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n146_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n45_), .O(z9));
endmodule
