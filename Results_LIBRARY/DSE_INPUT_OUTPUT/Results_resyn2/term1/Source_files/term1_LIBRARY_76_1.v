...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n86_), .c(new_n58_), .O(z4));
  inv1   g051(.a(x29), .O(new_n96_));
  xor2a  g052(.a(new_n90_), .b(new_n96_), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n86_), .c(new_n58_), .O(z5));
  nand2  g054(.a(new_n90_), .b(new_n96_), .O(new_n99_));
  nand2  g055(.a(new_n90_), .b(x30), .O(new_n100_));
  nand2  g056(.a(new_n91_), .b(new_n46_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n86_), .c(new_n58_), .O(z6));
  ...
  nand3  g065(.a(new_n76_), .b(x18), .c(x14), .O(new_n110_));
  ...
  nor3   g079(.a(new_n123_), .b(new_n76_), .c(x15), .O(new_n124_));
  nor2   g080(.a(new_n92_), .b(new_n46_), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n92_), .b(new_n46_), .O(new_n127_));
  and2   g083(.a(x31), .b(x29), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n45_), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n124_), .b(new_n121_), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n123_), .b(new_n108_), .O(new_n132_));
  nand2  g088(.a(new_n118_), .b(new_n117_), .O(new_n133_));
  oai21  g089(.a(new_n92_), .b(new_n96_), .c(new_n46_), .O(new_n134_));
  ...
  nand2  g095(.a(new_n138_), .b(new_n76_), .O(new_n140_));
  nand2  g096(.a(x18), .b(x12), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n109_), .O(new_n142_));
  inv1   g098(.a(x13), .O(new_n143_));
  nand2  g099(.a(new_n111_), .b(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x31), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n125_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n142_), .c(new_n140_), .d(new_n139_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n135_), .c(new_n48_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n131_), .c(new_n107_), .O(z8));
  nand2  g105(.a(new_n120_), .b(new_n116_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(x15), .c(new_n124_), .O(new_n151_));
  aoi21  g107(.a(new_n127_), .b(x29), .c(x31), .O(new_n152_));
  aoi21  g108(.a(new_n125_), .b(x31), .c(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(new_n51_), .O(new_n154_));
  nand2  g110(.a(x31), .b(new_n46_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n144_), .c(new_n142_), .d(x33), .O(new_n156_));
  nand2  g112(.a(new_n133_), .b(new_n132_), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  oai21  g114(.a(new_n138_), .b(new_n137_), .c(new_n140_), .O(new_n159_));
  nand2  g115(.a(new_n125_), .b(x31), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n134_), .c(new_n159_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n158_), .c(new_n107_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n154_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n58_), .O(z9));
endmodule
