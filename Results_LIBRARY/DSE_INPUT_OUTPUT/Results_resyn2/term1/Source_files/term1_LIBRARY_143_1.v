...
module FAU ( 
  ...
  xor2a  g073(.a(new_n117_), .b(x30), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n45_), .O(new_n119_));
  oai21  g075(.a(new_n116_), .b(new_n114_), .c(new_n119_), .O(new_n120_));
  inv1   g076(.a(x25), .O(new_n121_));
  and2   g077(.a(x18), .b(x17), .O(new_n122_));
  nand2  g078(.a(new_n111_), .b(new_n110_), .O(new_n123_));
  and2   g079(.a(x16), .b(x15), .O(new_n124_));
  aoi22  g080(.a(new_n124_), .b(new_n122_), .c(new_n123_), .d(x19), .O(new_n125_));
  nand2  g081(.a(x18), .b(x12), .O(new_n126_));
  oai21  g082(.a(x18), .b(x13), .c(x17), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g084(.a(new_n115_), .b(new_n100_), .O(new_n129_));
  nand2  g085(.a(new_n102_), .b(x14), .O(new_n130_));
  nand3  g086(.a(new_n124_), .b(new_n122_), .c(new_n130_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n125_), .O(new_n133_));
  nor2   g089(.a(new_n118_), .b(new_n99_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n121_), .O(new_n135_));
  nand2  g091(.a(new_n76_), .b(x00), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n135_), .b(new_n45_), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n120_), .b(new_n99_), .c(new_n138_), .O(z8));
  and2   g095(.a(new_n117_), .b(new_n92_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n45_), .O(new_n141_));
  nor3   g097(.a(new_n117_), .b(new_n45_), .c(new_n92_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x25), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n141_), .c(x33), .O(new_n144_));
  oai21  g100(.a(new_n116_), .b(new_n114_), .c(new_n144_), .O(new_n145_));
  inv1   g101(.a(new_n141_), .O(new_n146_));
  oai21  g102(.a(new_n142_), .b(new_n146_), .c(new_n133_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n65_), .c(x33), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n145_), .c(new_n136_), .O(z9));
endmodule
