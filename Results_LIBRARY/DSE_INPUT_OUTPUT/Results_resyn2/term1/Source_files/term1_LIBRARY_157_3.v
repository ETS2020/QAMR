...
module FAU ( 
  ...
  nand4  g031(.a(new_n49_), .b(new_n46_), .c(x25), .d(x01), .O(new_n76_));
  ...
  nor2   g036(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  nand2  g038(.a(new_n80_), .b(new_n70_), .O(new_n83_));
  ...
  nand2  g050(.a(new_n94_), .b(new_n58_), .O(z6));
  ...
  aoi22  g080(.a(new_n83_), .b(x29), .c(new_n120_), .d(new_n92_), .O(new_n125_));
  ...
  nand2  g100(.a(new_n144_), .b(new_n58_), .O(z8));
  ...
  nand4  g105(.a(new_n148_), .b(new_n138_), .c(new_n136_), .d(x33), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n134_), .c(new_n143_), .O(new_n151_));
  aoi21  g107(.a(new_n149_), .b(new_n55_), .c(new_n151_), .O(z9));
endmodule
