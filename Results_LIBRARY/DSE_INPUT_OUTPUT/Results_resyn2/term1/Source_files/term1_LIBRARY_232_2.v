...
module FAU ( 
  ...
  oai21  g029(.a(x23), .b(x18), .c(x15), .O(new_n74_));
  nor2   g030(.a(x21), .b(x16), .O(new_n75_));
  nor2   g031(.a(x22), .b(x17), .O(new_n76_));
  nor2   g032(.a(x24), .b(x19), .O(new_n77_));
  nor4   g033(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(new_n78_));
  nand2  g034(.a(new_n59_), .b(x25), .O(new_n79_));
  nor2   g035(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g036(.a(new_n80_), .b(new_n73_), .c(new_n45_), .O(new_n81_));
  ...
  nand3  g049(.a(new_n93_), .b(new_n91_), .c(new_n80_), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(new_n45_), .c(x26), .O(z5));
  ...
  nand2  g082(.a(new_n88_), .b(x29), .O(new_n127_));
  ...
  aoi22  g086(.a(new_n88_), .b(x29), .c(new_n54_), .d(new_n97_), .O(new_n131_));
  ...
  aoi21  g093(.a(new_n132_), .b(new_n121_), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(x18), .b(x12), .c(x17), .O(new_n139_));
  nor2   g095(.a(x18), .b(x13), .O(new_n140_));
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n123_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(new_n54_), .O(new_n142_));
  aoi21  g098(.a(new_n131_), .b(new_n130_), .c(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n73_), .b(new_n45_), .c(x00), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n129_), .c(new_n144_), .O(z8));
  aoi21  g101(.a(x31), .b(x30), .c(new_n127_), .O(new_n146_));
  nand2  g102(.a(new_n123_), .b(new_n97_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n127_), .c(new_n146_), .O(new_n148_));
  oai21  g104(.a(new_n122_), .b(new_n119_), .c(new_n148_), .O(new_n149_));
  inv1   g105(.a(new_n144_), .O(new_n150_));
  nor3   g106(.a(new_n140_), .b(new_n139_), .c(new_n50_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n148_), .c(new_n138_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  aoi21  g109(.a(new_n149_), .b(new_n50_), .c(new_n153_), .O(z9));
endmodule
