...
module FAU ( 
  ...
  aoi21  g013(.a(new_n57_), .b(new_n54_), .c(new_n48_), .O(z1));
  ...
  nand2  g051(.a(new_n90_), .b(new_n45_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n95_), .c(new_n85_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n47_), .O(z5));
  inv1   g054(.a(new_n95_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x30), .O(new_n100_));
  nand2  g056(.a(new_n95_), .b(new_n46_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n85_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(z6));
  nor2   g059(.a(x31), .b(new_n46_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n99_), .O(new_n105_));
  oai21  g061(.a(new_n48_), .b(x31), .c(new_n100_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n105_), .c(new_n85_), .O(z7));
  ...
  nand2  g073(.a(new_n75_), .b(x14), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n109_), .O(new_n119_));
  inv1   g075(.a(x15), .O(new_n120_));
  nand2  g076(.a(x16), .b(x10), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n112_), .c(new_n120_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n119_), .c(new_n117_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n114_), .c(new_n47_), .O(new_n124_));
  inv1   g080(.a(x31), .O(new_n125_));
  nand2  g081(.a(new_n92_), .b(x30), .O(new_n126_));
  nand2  g082(.a(new_n91_), .b(new_n46_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  aoi22  g084(.a(new_n128_), .b(x29), .c(new_n47_), .d(new_n125_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n124_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x32), .O(new_n131_));
  inv1   g087(.a(x17), .O(new_n132_));
  nand3  g088(.a(new_n75_), .b(x18), .c(x14), .O(new_n133_));
  ...
  nand4  g092(.a(x19), .b(x18), .c(new_n132_), .d(x12), .O(new_n137_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n120_), .O(new_n143_));
  nor3   g099(.a(new_n140_), .b(new_n121_), .c(x15), .O(new_n144_));
  oai21  g100(.a(new_n91_), .b(new_n45_), .c(x30), .O(new_n145_));
  nand3  g101(.a(new_n92_), .b(new_n46_), .c(x29), .O(new_n146_));
  nand2  g102(.a(new_n55_), .b(x31), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n145_), .c(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n144_), .b(new_n143_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n83_), .b(x00), .O(new_n150_));
  aoi21  g106(.a(new_n149_), .b(new_n131_), .c(new_n150_), .O(z8));
  nand2  g107(.a(new_n91_), .b(new_n125_), .O(new_n152_));
  nor2   g108(.a(x30), .b(new_n45_), .O(new_n153_));
  inv1   g109(.a(new_n104_), .O(new_n154_));
  nand2  g110(.a(new_n145_), .b(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n153_), .b(new_n152_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n124_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x33), .O(new_n158_));
  nand3  g114(.a(new_n154_), .b(new_n51_), .c(x29), .O(new_n159_));
  aoi21  g115(.a(new_n152_), .b(new_n126_), .c(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n144_), .b(new_n143_), .c(new_n160_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n158_), .c(new_n150_), .O(z9));
endmodule
