...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n84_), .c(new_n46_), .O(z3));
  ...
  nand2  g051(.a(new_n87_), .b(new_n65_), .O(new_n96_));
  ...
  oai21  g057(.a(new_n101_), .b(new_n82_), .c(new_n46_), .O(z5));
  nand3  g058(.a(new_n91_), .b(x30), .c(x29), .O(new_n103_));
  inv1   g059(.a(x30), .O(new_n104_));
  nand2  g060(.a(new_n98_), .b(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n103_), .c(new_n97_), .d(new_n46_), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n82_), .O(z6));
  aoi21  g063(.a(x19), .b(x07), .c(x24), .O(new_n108_));
  nor2   g064(.a(new_n103_), .b(x31), .O(new_n109_));
  nand2  g065(.a(new_n103_), .b(x31), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n97_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n109_), .c(new_n46_), .O(new_n112_));
  oai21  g068(.a(new_n108_), .b(new_n81_), .c(new_n112_), .O(z7));
  ...
  aoi21  g091(.a(new_n90_), .b(new_n85_), .c(new_n99_), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n53_), .b(x30), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g095(.a(new_n134_), .b(x30), .O(new_n140_));
  aoi21  g096(.a(new_n53_), .b(new_n104_), .c(new_n136_), .O(new_n141_));
  ...
  nor3   g106(.a(new_n150_), .b(new_n149_), .c(new_n132_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n148_), .c(new_n53_), .O(new_n152_));
  aoi21  g108(.a(new_n141_), .b(new_n140_), .c(new_n152_), .O(new_n153_));
  inv1   g109(.a(x26), .O(new_n154_));
  nand3  g110(.a(new_n46_), .b(new_n154_), .c(x00), .O(new_n155_));
  aoi21  g111(.a(new_n153_), .b(new_n139_), .c(new_n155_), .O(z8));
  nand2  g112(.a(x31), .b(x30), .O(new_n157_));
  aoi21  g113(.a(new_n132_), .b(new_n104_), .c(new_n136_), .O(new_n158_));
  aoi21  g114(.a(new_n157_), .b(new_n136_), .c(new_n158_), .O(new_n159_));
  oai21  g115(.a(new_n131_), .b(new_n128_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n49_), .O(new_n161_));
  nor3   g117(.a(new_n150_), .b(new_n149_), .c(new_n49_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n159_), .c(new_n148_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n161_), .c(new_n154_), .d(x00), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n46_), .O(z9));
endmodule
