...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n88_), .c(new_n83_), .d(new_n47_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z4));
  inv1   g047(.a(x29), .O(new_n92_));
  nand2  g048(.a(new_n87_), .b(new_n45_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g050(.a(new_n87_), .b(x29), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n94_), .c(new_n83_), .O(new_n96_));
  ...
  inv1   g060(.a(new_n102_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n104_), .c(new_n46_), .O(new_n106_));
  ...
  nand2  g081(.a(new_n104_), .b(x29), .O(new_n126_));
  ...
  nand3  g085(.a(new_n73_), .b(x18), .c(x14), .O(new_n130_));
  ...
  nand3  g098(.a(new_n45_), .b(new_n86_), .c(new_n70_), .O(new_n143_));
  nand2  g099(.a(new_n89_), .b(x30), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(x29), .O(new_n145_));
  nor3   g101(.a(new_n145_), .b(x32), .c(new_n104_), .O(new_n146_));
  ...
  nor2   g113(.a(new_n46_), .b(new_n49_), .O(new_n158_));
