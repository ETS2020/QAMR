...
module FAU ( 
  ...
  aoi22  g032(.a(new_n45_), .b(new_n75_), .c(new_n76_), .d(new_n74_), .O(new_n77_));
  ...
  nand2  g058(.a(new_n102_), .b(new_n83_), .O(z7));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n75_), .O(new_n109_));
  nand4  g065(.a(x19), .b(x18), .c(new_n75_), .d(x12), .O(new_n110_));
  ...
  nand3  g070(.a(new_n114_), .b(x19), .c(new_n74_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n112_), .c(new_n104_), .O(new_n116_));
  nor2   g072(.a(new_n107_), .b(new_n75_), .O(new_n117_));
  ...
  nand2  g079(.a(new_n89_), .b(x29), .O(new_n124_));
  ...
  aoi22  g083(.a(new_n89_), .b(x29), .c(new_n55_), .d(new_n98_), .O(new_n128_));
  ...
  nor3   g093(.a(new_n137_), .b(new_n136_), .c(new_n120_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n55_), .O(new_n139_));
  aoi21  g095(.a(new_n128_), .b(new_n127_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n46_), .b(x00), .O(new_n141_));
  aoi21  g097(.a(new_n140_), .b(new_n126_), .c(new_n141_), .O(z8));
  aoi21  g098(.a(x31), .b(x30), .c(new_n124_), .O(new_n143_));
  nand2  g099(.a(new_n120_), .b(new_n98_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n124_), .c(new_n143_), .O(new_n145_));
  oai21  g101(.a(new_n119_), .b(new_n116_), .c(new_n145_), .O(new_n146_));
  inv1   g102(.a(new_n141_), .O(new_n147_));
  nor3   g103(.a(new_n137_), .b(new_n136_), .c(new_n51_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n145_), .c(new_n135_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  aoi21  g106(.a(new_n146_), .b(new_n51_), .c(new_n150_), .O(z9));
endmodule
