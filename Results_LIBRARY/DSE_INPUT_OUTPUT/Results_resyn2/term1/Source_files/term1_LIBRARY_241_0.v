...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n80_), .c(new_n46_), .O(z5));
  xor2a  g049(.a(new_n89_), .b(x30), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n80_), .c(new_n46_), .O(z6));
  ...
  xnor2a g056(.a(new_n100_), .b(x30), .O(new_n101_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n115_), .c(new_n101_), .O(new_n119_));
  nand2  g075(.a(x18), .b(x12), .O(new_n120_));
  oai21  g076(.a(x18), .b(x13), .c(x17), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(x16), .c(new_n113_), .O(new_n123_));
  nand3  g079(.a(new_n116_), .b(x16), .c(x15), .O(new_n124_));
  aoi21  g080(.a(new_n70_), .b(x14), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n117_), .b(new_n102_), .O(new_n126_));
  nand2  g082(.a(new_n124_), .b(new_n70_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nor3   g084(.a(new_n128_), .b(new_n125_), .c(new_n123_), .O(new_n129_));
  inv1   g085(.a(new_n101_), .O(new_n130_));
  nand2  g086(.a(x32), .b(x31), .O(new_n131_));
  ...
  aoi21  g090(.a(x32), .b(x25), .c(x31), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  aoi21  g093(.a(new_n119_), .b(new_n50_), .c(new_n137_), .O(z8));
  inv1   g094(.a(x33), .O(new_n139_));
  nor2   g095(.a(new_n101_), .b(new_n96_), .O(new_n140_));
  oai21  g096(.a(new_n118_), .b(new_n115_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g098(.a(new_n140_), .b(x33), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n129_), .c(new_n134_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n46_), .O(z9));
endmodule
