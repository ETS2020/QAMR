...
module FAU ( 
  ...
  inv1   g026(.a(x00), .O(new_n71_));
  nor2   g027(.a(x26), .b(new_n71_), .O(new_n72_));
  ...
  nor3   g039(.a(new_n83_), .b(new_n82_), .c(new_n51_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n72_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n70_), .O(new_n87_));
  ...
  nand3  g048(.a(new_n92_), .b(new_n91_), .c(new_n84_), .O(new_n93_));
  ...
  nand3  g053(.a(new_n97_), .b(new_n96_), .c(new_n86_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n102_), .b(new_n100_), .c(new_n84_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(x00), .c(x26), .O(z6));
  xor2a  g060(.a(new_n100_), .b(x31), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n84_), .c(new_n71_), .O(new_n106_));
  or2    g062(.a(new_n106_), .b(x26), .O(z7));
  ...
  aoi22  g088(.a(new_n92_), .b(x29), .c(new_n48_), .d(new_n101_), .O(new_n133_));
  ...
  aoi21  g104(.a(new_n133_), .b(new_n132_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n131_), .c(x26), .O(z8));
  aoi21  g106(.a(x31), .b(x30), .c(new_n129_), .O(new_n151_));
  nand2  g107(.a(new_n125_), .b(new_n101_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n129_), .c(new_n151_), .O(new_n153_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n141_), .c(new_n72_), .O(new_n156_));
