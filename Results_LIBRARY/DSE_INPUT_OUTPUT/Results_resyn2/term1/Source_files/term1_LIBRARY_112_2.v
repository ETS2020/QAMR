...
module FAU ( 
  ...
  nand3  g41(.a(new_n85_), .b(new_n83_), .c(new_n75_), .O(new_n86_));
  aoi21  g42(.a(new_n86_), .b(new_n45_), .c(x26), .O(z3));
  nor2   g43(.a(x26), .b(x00), .O(new_n88_));
  and2   g44(.a(x28), .b(x27), .O(new_n89_));
  nor2   g45(.a(x28), .b(x27), .O(new_n90_));
  nor2   g46(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n83_), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(z4));
  xor2a  g49(.a(new_n89_), .b(x29), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n85_), .c(new_n83_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n45_), .c(x26), .O(z5));
  aoi21  g52(.a(new_n89_), .b(x29), .c(x30), .O(new_n97_));
  nand3  g53(.a(new_n89_), .b(x30), .c(x29), .O(new_n98_));
  inv1   g54(.a(new_n98_), .O(new_n99_));
  nor2   g55(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n88_), .c(new_n85_), .d(new_n83_), .O(new_n101_));
