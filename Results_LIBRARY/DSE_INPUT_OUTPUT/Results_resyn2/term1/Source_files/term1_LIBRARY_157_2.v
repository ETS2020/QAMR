...
module FAU ( 
  ...
  and2   g039(.a(new_n83_), .b(new_n48_), .O(new_n84_));
  inv1   g040(.a(x26), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(x25), .c(new_n45_), .d(x01), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n84_), .c(new_n69_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z3));
  inv1   g045(.a(x28), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n69_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n90_), .b(new_n69_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n87_), .d(new_n84_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z4));
  nand2  g051(.a(new_n87_), .b(new_n84_), .O(new_n96_));
  ...
  aoi21  g061(.a(new_n100_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n84_), .O(new_n107_));
  ...
  nand3  g067(.a(x19), .b(new_n80_), .c(x13), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n71_), .O(new_n113_));
  nand4  g069(.a(x19), .b(x18), .c(new_n71_), .d(x12), .O(new_n114_));
  ...
  nand3  g074(.a(new_n118_), .b(x19), .c(new_n70_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n116_), .c(new_n74_), .O(new_n120_));
  nor2   g076(.a(new_n80_), .b(new_n71_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x16), .c(x10), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n77_), .c(x15), .O(new_n123_));
  ...
  aoi22  g088(.a(new_n93_), .b(x29), .c(new_n128_), .d(new_n103_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n137_), .b(new_n77_), .O(new_n138_));
  nand2  g094(.a(new_n77_), .b(x14), .O(new_n139_));
  ...
  nand2  g101(.a(new_n80_), .b(new_n145_), .O(new_n146_));
  ...
  nand2  g108(.a(new_n124_), .b(new_n103_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n129_), .c(new_n152_), .O(new_n154_));
  oai21  g110(.a(new_n123_), .b(new_n120_), .c(new_n154_), .O(new_n155_));
  nand4  g111(.a(new_n154_), .b(new_n146_), .c(new_n144_), .d(x33), .O(new_n156_));
  nand3  g112(.a(new_n85_), .b(new_n45_), .c(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n156_), .b(new_n142_), .c(new_n158_), .O(new_n159_));
