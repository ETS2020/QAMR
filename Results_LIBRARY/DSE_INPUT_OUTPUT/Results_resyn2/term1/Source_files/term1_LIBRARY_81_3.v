...
module FAU ( 
  ...
  nand3  g030(.a(new_n49_), .b(x25), .c(x01), .O(new_n75_));
  aoi21  g031(.a(new_n74_), .b(new_n70_), .c(new_n75_), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n45_), .O(new_n77_));
  oai21  g033(.a(new_n77_), .b(x27), .c(new_n67_), .O(z3));
  inv1   g034(.a(new_n77_), .O(new_n79_));
  ...
  nand3  g040(.a(new_n84_), .b(new_n83_), .c(new_n79_), .O(new_n85_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n87_), .c(new_n79_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z5));
  inv1   g047(.a(x30), .O(new_n92_));
  oai21  g048(.a(new_n87_), .b(new_n92_), .c(new_n45_), .O(new_n93_));
  aoi21  g049(.a(new_n87_), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n67_), .O(z6));
  xor2a  g052(.a(new_n93_), .b(new_n46_), .O(new_n97_));
  oai21  g053(.a(new_n76_), .b(new_n47_), .c(new_n97_), .O(z7));
  ...
  nor2   g072(.a(x32), .b(new_n46_), .O(new_n117_));
  oai21  g073(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n92_), .O(new_n119_));
  inv1   g075(.a(x32), .O(new_n120_));
  nand2  g076(.a(new_n84_), .b(x29), .O(new_n121_));
  ...
  aoi22  g080(.a(new_n84_), .b(x29), .c(new_n120_), .d(new_n92_), .O(new_n125_));
  oai21  g081(.a(new_n111_), .b(x16), .c(x15), .O(new_n126_));
  inv1   g082(.a(x14), .O(new_n127_));
  nor2   g083(.a(x19), .b(new_n127_), .O(new_n128_));
  nand3  g084(.a(new_n114_), .b(x16), .c(x15), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n101_), .O(new_n130_));
  oai21  g086(.a(new_n129_), .b(new_n128_), .c(new_n130_), .O(new_n131_));
  aoi21  g087(.a(new_n126_), .b(new_n115_), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(x18), .b(x12), .c(x17), .O(new_n133_));
  nor2   g089(.a(x18), .b(x13), .O(new_n134_));
  nor3   g090(.a(new_n134_), .b(new_n133_), .c(new_n46_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n132_), .c(new_n120_), .O(new_n136_));
  aoi21  g092(.a(new_n125_), .b(new_n124_), .c(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n45_), .b(x00), .O(new_n138_));
  aoi21  g094(.a(new_n137_), .b(new_n123_), .c(new_n138_), .O(z8));
  aoi21  g095(.a(x31), .b(x30), .c(new_n121_), .O(new_n140_));
  nand2  g096(.a(new_n46_), .b(new_n92_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n121_), .c(new_n140_), .O(new_n142_));
  oai21  g098(.a(new_n116_), .b(new_n113_), .c(new_n142_), .O(new_n143_));
  inv1   g099(.a(new_n138_), .O(new_n144_));
  nor3   g100(.a(new_n134_), .b(new_n133_), .c(new_n54_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n142_), .c(new_n132_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  aoi21  g103(.a(new_n143_), .b(new_n54_), .c(new_n147_), .O(z9));
endmodule
