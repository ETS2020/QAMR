...
module FAU ( 
  ...
  oai21  g037(.a(x23), .b(x18), .c(x20), .O(new_n82_));
  ...
  aoi22  g084(.a(new_n88_), .b(x29), .c(new_n53_), .d(new_n96_), .O(new_n129_));
  oai21  g085(.a(new_n125_), .b(new_n96_), .c(new_n129_), .O(new_n130_));
  ...
  aoi21  g094(.a(new_n134_), .b(new_n113_), .c(new_n102_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n138_), .c(new_n137_), .O(new_n140_));
  ...
  nand2  g100(.a(new_n123_), .b(new_n120_), .O(new_n145_));
  nand2  g101(.a(new_n123_), .b(new_n106_), .O(new_n146_));
  xor2a  g102(.a(new_n126_), .b(new_n96_), .O(new_n147_));
  xor2a  g103(.a(x31), .b(x30), .O(new_n148_));
  ...
  oai21  g110(.a(new_n148_), .b(new_n154_), .c(new_n45_), .O(new_n155_));
  nand2  g111(.a(new_n147_), .b(new_n69_), .O(new_n156_));
