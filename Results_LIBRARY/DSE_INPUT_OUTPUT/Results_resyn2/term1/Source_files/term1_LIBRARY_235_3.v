...
module FAU ( 
  ...
  nand2  g055(.a(new_n99_), .b(new_n58_), .O(z6));
  xor2a  g056(.a(new_n96_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n82_), .O(z7));
  ...
  aoi22  g084(.a(new_n88_), .b(x29), .c(new_n54_), .d(new_n97_), .O(new_n129_));
  oai21  g085(.a(new_n115_), .b(x16), .c(x15), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n119_), .O(new_n131_));
  nand3  g087(.a(new_n118_), .b(x16), .c(x15), .O(new_n132_));
  ...
  aoi21  g100(.a(new_n129_), .b(new_n128_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n127_), .c(new_n45_), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n125_), .O(new_n147_));
  nand2  g103(.a(new_n121_), .b(new_n97_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n125_), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n120_), .b(new_n117_), .c(new_n149_), .O(new_n150_));
  nand4  g106(.a(new_n149_), .b(new_n141_), .c(new_n139_), .d(x33), .O(new_n151_));
  nor2   g107(.a(x26), .b(new_n45_), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(new_n137_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n150_), .b(new_n50_), .c(new_n153_), .O(z9));
endmodule
