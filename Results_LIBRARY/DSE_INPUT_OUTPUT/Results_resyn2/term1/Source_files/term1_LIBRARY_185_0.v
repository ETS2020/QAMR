...
module FAU ( 
  ...
  aoi22  g031(.a(new_n75_), .b(new_n74_), .c(new_n46_), .d(new_n73_), .O(new_n76_));
  ...
  nor2   g059(.a(new_n103_), .b(new_n94_), .O(new_n104_));
  aoi21  g060(.a(new_n94_), .b(x31), .c(new_n104_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n85_), .O(z7));
  nand3  g062(.a(x17), .b(x16), .c(x15), .O(new_n107_));
  nand2  g063(.a(x19), .b(x13), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n107_), .c(new_n45_), .O(new_n109_));
  ...
  nand2  g070(.a(new_n114_), .b(x20), .O(new_n115_));
  inv1   g071(.a(new_n107_), .O(new_n116_));
  inv1   g072(.a(x17), .O(new_n117_));
  nand2  g073(.a(x16), .b(x10), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n73_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(x19), .c(new_n116_), .O(new_n120_));
  aoi21  g076(.a(new_n74_), .b(x14), .c(new_n107_), .O(new_n121_));
  ...
  nand2  g104(.a(new_n139_), .b(new_n133_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(x15), .c(new_n130_), .O(new_n150_));
  nand2  g106(.a(new_n112_), .b(new_n103_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n150_), .c(new_n49_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x15), .O(new_n153_));
  oai21  g109(.a(new_n129_), .b(new_n153_), .c(new_n74_), .O(new_n154_));
  inv1   g110(.a(x16), .O(new_n155_));
  nand2  g111(.a(new_n131_), .b(new_n155_), .O(new_n156_));
  oai21  g112(.a(new_n129_), .b(new_n118_), .c(new_n73_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n156_), .c(new_n154_), .O(new_n158_));
  nand2  g114(.a(new_n121_), .b(x18), .O(new_n159_));
  nand2  g115(.a(x18), .b(x12), .O(new_n160_));
  oai21  g116(.a(x18), .b(x13), .c(x17), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nor2   g118(.a(new_n102_), .b(new_n49_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n159_), .d(new_n112_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n158_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n147_), .O(new_n166_));
