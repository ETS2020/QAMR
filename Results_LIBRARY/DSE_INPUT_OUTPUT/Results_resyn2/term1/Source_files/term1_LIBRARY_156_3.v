...
module FAU ( 
  ...
  nand3  g037(.a(new_n81_), .b(new_n58_), .c(new_n73_), .O(new_n82_));
  ...
  nand2  g049(.a(new_n93_), .b(new_n58_), .O(z5));
  inv1   g050(.a(new_n90_), .O(new_n95_));
  aoi21  g051(.a(new_n76_), .b(x18), .c(new_n46_), .O(new_n96_));
  aoi21  g052(.a(new_n95_), .b(new_n77_), .c(new_n96_), .O(new_n97_));
  oai21  g053(.a(new_n90_), .b(new_n46_), .c(new_n80_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n97_), .c(new_n58_), .O(z6));
  xnor2a g055(.a(x31), .b(x30), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n95_), .O(new_n102_));
  aoi21  g058(.a(new_n90_), .b(x31), .c(new_n47_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n102_), .c(new_n81_), .O(z7));
  ...
  aoi22  g065(.a(new_n109_), .b(new_n107_), .c(new_n108_), .d(new_n106_), .O(new_n110_));
  ...
  inv1   g072(.a(new_n115_), .O(new_n117_));
  nand2  g073(.a(new_n111_), .b(x14), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  aoi21  g076(.a(x18), .b(x12), .c(x17), .O(new_n121_));
  nor2   g077(.a(x18), .b(x13), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n119_), .c(new_n116_), .d(new_n110_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n58_), .O(new_n125_));
  nand2  g081(.a(new_n87_), .b(x29), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n46_), .c(x23), .O(new_n127_));
  aoi21  g083(.a(new_n126_), .b(new_n46_), .c(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x32), .O(new_n130_));
  nand3  g086(.a(new_n111_), .b(x18), .c(x14), .O(new_n131_));
  nand3  g087(.a(x19), .b(new_n113_), .c(x13), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n112_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n112_), .d(x12), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(x16), .O(new_n136_));
  inv1   g092(.a(new_n109_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x19), .c(new_n107_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(new_n106_), .O(new_n139_));
  nor3   g095(.a(new_n108_), .b(new_n111_), .c(x15), .O(new_n140_));
  xor2a  g096(.a(new_n126_), .b(x30), .O(new_n141_));
  ...
  and2   g101(.a(new_n141_), .b(new_n100_), .O(new_n146_));
  oai21  g102(.a(new_n140_), .b(new_n139_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n50_), .O(new_n148_));
  nor3   g104(.a(new_n122_), .b(new_n121_), .c(new_n50_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n119_), .c(new_n116_), .d(new_n110_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n146_), .c(new_n105_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n58_), .O(z9));
endmodule
