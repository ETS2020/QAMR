...
module FAU ( 
  ...
  nand4  g035(.a(new_n79_), .b(new_n76_), .c(new_n73_), .d(new_n70_), .O(new_n80_));
  inv1   g036(.a(x26), .O(new_n81_));
  nand4  g037(.a(new_n47_), .b(new_n81_), .c(x25), .d(x01), .O(new_n82_));
  ...
  nand3  g048(.a(new_n83_), .b(new_n80_), .c(new_n56_), .O(new_n93_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n84_), .c(new_n56_), .O(z6));
  ...
  nand3  g071(.a(new_n115_), .b(x19), .c(new_n71_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n113_), .c(new_n68_), .O(new_n117_));
  nor2   g073(.a(new_n108_), .b(new_n74_), .O(new_n118_));
  ...
  aoi21  g086(.a(new_n125_), .b(new_n101_), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  oai21  g088(.a(new_n115_), .b(x16), .c(x15), .O(new_n133_));
  inv1   g089(.a(x14), .O(new_n134_));
  nor2   g090(.a(x19), .b(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n118_), .b(x16), .c(x15), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n77_), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(new_n135_), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n133_), .b(new_n119_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(x18), .b(x12), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n74_), .O(new_n141_));
  ...
  nand2  g107(.a(new_n121_), .b(new_n101_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n126_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n120_), .b(new_n117_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n53_), .O(new_n155_));
  aoi21  g111(.a(new_n108_), .b(new_n142_), .c(new_n53_), .O(new_n156_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n56_), .O(z9));
endmodule
