...
module FAU ( 
  ...
  nor2   g034(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  ...
  nand2  g041(.a(new_n83_), .b(new_n76_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(new_n87_));
  ...
  nand4  g047(.a(new_n91_), .b(new_n90_), .c(new_n82_), .d(new_n58_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z5));
  inv1   g049(.a(new_n91_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x30), .O(new_n95_));
  inv1   g051(.a(x30), .O(new_n96_));
  nand2  g052(.a(new_n91_), .b(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n95_), .c(new_n82_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n58_), .O(z6));
  nand2  g055(.a(new_n95_), .b(x31), .O(new_n100_));
  inv1   g056(.a(x31), .O(new_n101_));
  nand3  g057(.a(new_n94_), .b(new_n101_), .c(x30), .O(new_n102_));
  inv1   g058(.a(x15), .O(new_n103_));
  oai22  g059(.a(new_n74_), .b(new_n73_), .c(new_n45_), .d(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n72_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n102_), .c(new_n100_), .d(new_n79_), .O(z7));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n114_), .c(new_n103_), .O(new_n119_));
  ...
  aoi21  g086(.a(new_n125_), .b(new_n96_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n107_), .O(new_n141_));
  ...
  nand2  g107(.a(new_n101_), .b(new_n96_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n126_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n121_), .b(new_n119_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n58_), .O(z9));
endmodule
