...
module FAU ( 
  ...
  aoi21  g009(.a(new_n53_), .b(new_n45_), .c(new_n46_), .O(new_n54_));
  oai21  g010(.a(new_n53_), .b(x32), .c(new_n54_), .O(z1));
  ...
  nand4  g036(.a(new_n48_), .b(new_n80_), .c(x25), .d(x01), .O(new_n81_));
  nor2   g037(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n56_), .c(new_n69_), .O(new_n83_));
  ...
  nand2  g045(.a(new_n89_), .b(new_n56_), .O(z4));
  ...
  nand2  g051(.a(new_n91_), .b(x30), .O(new_n96_));
  inv1   g052(.a(x30), .O(new_n97_));
  nand2  g053(.a(new_n45_), .b(new_n97_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n91_), .c(new_n96_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n82_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  oai21  g057(.a(new_n91_), .b(new_n97_), .c(x31), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  nand3  g059(.a(new_n98_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n102_), .c(new_n82_), .O(z7));
  nand2  g061(.a(new_n80_), .b(x00), .O(new_n106_));
  inv1   g062(.a(x15), .O(new_n107_));
  inv1   g063(.a(x17), .O(new_n108_));
  nand3  g064(.a(new_n72_), .b(x18), .c(x14), .O(new_n109_));
  ...
  nand3  g078(.a(new_n88_), .b(x30), .c(x29), .O(new_n123_));
  ...
  nor2   g085(.a(new_n110_), .b(new_n108_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x16), .c(x15), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n72_), .c(new_n103_), .O(new_n132_));
  nand2  g088(.a(new_n72_), .b(x14), .O(new_n133_));
  inv1   g089(.a(new_n131_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n117_), .b(new_n116_), .O(new_n136_));
  nand2  g092(.a(x18), .b(x12), .O(new_n137_));
  oai21  g093(.a(x18), .b(x13), .c(x17), .O(new_n138_));
  aoi22  g094(.a(new_n138_), .b(new_n137_), .c(new_n121_), .d(new_n107_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n136_), .c(new_n135_), .d(new_n132_), .O(new_n140_));
  nand2  g096(.a(new_n126_), .b(new_n123_), .O(new_n141_));
  inv1   g097(.a(x32), .O(new_n142_));
  nor2   g098(.a(new_n46_), .b(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n141_), .b(new_n140_), .c(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n129_), .c(new_n106_), .O(z8));
  nand2  g101(.a(new_n124_), .b(new_n45_), .O(new_n146_));
  aoi21  g102(.a(new_n126_), .b(new_n103_), .c(new_n146_), .O(new_n147_));
  oai21  g103(.a(new_n122_), .b(new_n120_), .c(new_n147_), .O(new_n148_));
  nor2   g104(.a(new_n45_), .b(new_n97_), .O(new_n149_));
  oai21  g105(.a(new_n140_), .b(new_n125_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n148_), .c(new_n106_), .O(z9));
endmodule
