...
module FAU ( 
  ...
  nand3  g029(.a(new_n73_), .b(x18), .c(new_n72_), .O(new_n74_));
  oai22  g030(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n75_));
  oai22  g031(.a(x23), .b(x18), .c(x21), .d(x16), .O(new_n76_));
  nor2   g032(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  inv1   g033(.a(x26), .O(new_n78_));
  nand3  g034(.a(new_n58_), .b(new_n78_), .c(x25), .O(new_n79_));
  ...
  nand2  g040(.a(new_n73_), .b(new_n72_), .O(new_n85_));
  aoi21  g041(.a(new_n77_), .b(new_n85_), .c(new_n79_), .O(new_n86_));
  ...
  nand2  g059(.a(new_n103_), .b(new_n82_), .O(z7));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n113_), .c(new_n72_), .O(new_n118_));
  ...
  aoi21  g086(.a(new_n53_), .b(new_n99_), .c(new_n130_), .O(new_n131_));
  ...
  aoi21  g111(.a(new_n108_), .b(new_n142_), .c(new_n49_), .O(new_n156_));
