...
module FAU ( 
  ...
  nor2   g028(.a(x26), .b(new_n45_), .O(new_n73_));
  ...
  aoi21  g057(.a(new_n101_), .b(x04), .c(x26), .O(z5));
  ...
  oai21  g065(.a(new_n109_), .b(new_n86_), .c(x04), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n46_), .O(z7));
  nand2  g067(.a(new_n95_), .b(x29), .O(new_n112_));
  ...
  nand2  g079(.a(new_n123_), .b(new_n77_), .O(new_n124_));
  inv1   g080(.a(new_n123_), .O(new_n125_));
  nand2  g081(.a(new_n77_), .b(x14), .O(new_n126_));
  ...
  nand3  g088(.a(new_n77_), .b(x18), .c(x14), .O(new_n133_));
  ...
  nor3   g097(.a(new_n120_), .b(new_n77_), .c(x15), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(x15), .c(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n113_), .b(new_n52_), .c(x31), .O(new_n144_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n143_), .c(new_n49_), .O(new_n151_));
  inv1   g107(.a(x00), .O(new_n152_));
  nor3   g108(.a(new_n129_), .b(new_n128_), .c(new_n49_), .O(new_n153_));
  ...
  aoi21  g113(.a(new_n157_), .b(x04), .c(x26), .O(z9));
endmodule
