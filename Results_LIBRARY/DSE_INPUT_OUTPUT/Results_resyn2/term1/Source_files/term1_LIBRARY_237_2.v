...
module FAU ( 
  ...
  nand3  g022(.a(x26), .b(new_n66_), .c(x08), .O(new_n67_));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n71_), .c(x26), .O(z6));
  ...
  nand2  g064(.a(new_n93_), .b(x29), .O(new_n109_));
  xor2a  g065(.a(new_n109_), .b(new_n101_), .O(new_n110_));
  ...
  aoi22  g074(.a(new_n118_), .b(new_n113_), .c(new_n117_), .d(new_n112_), .O(new_n119_));
  nand3  g075(.a(new_n116_), .b(x16), .c(x15), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n75_), .O(new_n121_));
  inv1   g077(.a(new_n120_), .O(new_n122_));
  nand2  g078(.a(new_n75_), .b(x14), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  aoi21  g080(.a(x18), .b(x12), .c(x17), .O(new_n125_));
  nor2   g081(.a(x18), .b(x13), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n124_), .c(new_n121_), .d(new_n119_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n111_), .c(x32), .O(new_n129_));
  nand3  g085(.a(new_n75_), .b(x18), .c(x14), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n115_), .c(x13), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n114_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n114_), .d(x12), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(x16), .O(new_n135_));
  inv1   g091(.a(new_n118_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x19), .c(new_n113_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nor3   g094(.a(new_n117_), .b(new_n75_), .c(x15), .O(new_n139_));
  aoi21  g095(.a(new_n138_), .b(x15), .c(new_n139_), .O(new_n140_));
  nand3  g096(.a(new_n110_), .b(new_n49_), .c(x31), .O(new_n141_));
  or2    g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g098(.a(new_n87_), .b(x00), .O(new_n143_));
  aoi21  g099(.a(new_n142_), .b(new_n129_), .c(new_n143_), .O(z8));
  inv1   g100(.a(new_n105_), .O(new_n145_));
  nor2   g101(.a(new_n110_), .b(new_n145_), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n140_), .c(new_n52_), .O(new_n148_));
  inv1   g104(.a(x00), .O(new_n149_));
  nor3   g105(.a(new_n126_), .b(new_n125_), .c(new_n52_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n124_), .c(new_n121_), .d(new_n119_), .O(new_n151_));
  ...
  aoi21  g110(.a(new_n154_), .b(new_n71_), .c(x26), .O(z9));
endmodule
