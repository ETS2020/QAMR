...
module FAU ( 
  ...
  nand4  g032(.a(new_n48_), .b(new_n45_), .c(x25), .d(x01), .O(new_n77_));
  ...
  nand2  g041(.a(new_n85_), .b(new_n57_), .O(z4));
  ...
  nand2  g046(.a(new_n90_), .b(new_n57_), .O(z5));
  ...
  nand2  g053(.a(new_n97_), .b(new_n78_), .O(z7));
  ...
  aoi21  g082(.a(new_n121_), .b(new_n93_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  oai21  g084(.a(new_n111_), .b(x16), .c(x15), .O(new_n129_));
  inv1   g085(.a(x14), .O(new_n130_));
  nor2   g086(.a(x19), .b(new_n130_), .O(new_n131_));
  nand3  g087(.a(new_n114_), .b(x16), .c(x15), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n101_), .O(new_n133_));
  oai21  g089(.a(new_n132_), .b(new_n131_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(new_n129_), .b(new_n115_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(x18), .b(x12), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n100_), .O(new_n137_));
  inv1   g093(.a(x13), .O(new_n138_));
  nand2  g094(.a(new_n103_), .b(new_n138_), .O(new_n139_));
  ...
  nand2  g101(.a(new_n145_), .b(new_n57_), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n122_), .O(new_n147_));
  nand2  g103(.a(new_n117_), .b(new_n93_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n122_), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n116_), .b(new_n113_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n54_), .O(new_n151_));
  aoi21  g107(.a(new_n103_), .b(new_n138_), .c(new_n54_), .O(new_n152_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n57_), .O(z9));
endmodule
