...
module FAU ( 
  ...
  nand2  g030(.a(x23), .b(x15), .O(new_n75_));
  oai21  g031(.a(x20), .b(x15), .c(x18), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  and2   g034(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  ...
  oai22  g047(.a(x23), .b(x18), .c(x20), .d(x15), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n73_), .c(new_n72_), .O(new_n93_));
  nand2  g049(.a(new_n83_), .b(new_n71_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand2  g051(.a(new_n87_), .b(x29), .O(new_n96_));
  inv1   g052(.a(x29), .O(new_n97_));
  nand2  g053(.a(new_n88_), .b(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n96_), .c(new_n95_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n93_), .c(new_n47_), .O(z5));
  inv1   g056(.a(x30), .O(new_n101_));
  nand2  g057(.a(new_n96_), .b(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n87_), .b(x30), .c(x29), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n102_), .c(new_n95_), .d(new_n79_), .O(new_n104_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n106_), .c(new_n47_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n78_), .O(z7));
  ...
  nand2  g072(.a(new_n45_), .b(x10), .O(new_n117_));
  nand2  g073(.a(new_n46_), .b(x13), .O(new_n118_));
  nand2  g074(.a(x19), .b(x17), .O(new_n119_));
  aoi21  g075(.a(new_n118_), .b(new_n117_), .c(new_n119_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n116_), .c(x16), .O(new_n121_));
  inv1   g077(.a(x16), .O(new_n122_));
  nand3  g078(.a(x18), .b(x17), .c(x11), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x19), .c(new_n122_), .d(x15), .O(new_n125_));
  ...
  aoi22  g086(.a(new_n89_), .b(x29), .c(new_n52_), .d(new_n101_), .O(new_n131_));
  oai21  g087(.a(new_n127_), .b(new_n101_), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(x18), .b(x17), .c(x16), .O(new_n133_));
  aoi22  g089(.a(new_n133_), .b(new_n111_), .c(new_n123_), .d(new_n122_), .O(new_n134_));
  ...
  inv1   g093(.a(new_n133_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(x15), .O(new_n139_));
  ...
  nand2  g107(.a(new_n125_), .b(new_n121_), .O(new_n152_));
  aoi21  g108(.a(x31), .b(x30), .c(new_n128_), .O(new_n153_));
  inv1   g109(.a(x31), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n101_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n128_), .c(new_n153_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n152_), .c(x33), .O(new_n157_));
  nand4  g113(.a(new_n156_), .b(new_n144_), .c(new_n142_), .d(x33), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n140_), .c(new_n149_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n157_), .c(new_n47_), .O(z9));
endmodule
