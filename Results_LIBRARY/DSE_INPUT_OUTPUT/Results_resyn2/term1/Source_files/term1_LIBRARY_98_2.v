...
module FAU ( 
  ...
  nand3  g075(.a(x18), .b(new_n119_), .c(x12), .O(new_n120_));
  nand4  g076(.a(x19), .b(new_n45_), .c(x17), .d(x13), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(new_n122_));
  nand4  g078(.a(x18), .b(x17), .c(new_n118_), .d(x11), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(x15), .O(new_n125_));
  inv1   g081(.a(x15), .O(new_n126_));
  nand3  g082(.a(x18), .b(x16), .c(x10), .O(new_n127_));
  ...
  nand2  g092(.a(x18), .b(x11), .O(new_n137_));
