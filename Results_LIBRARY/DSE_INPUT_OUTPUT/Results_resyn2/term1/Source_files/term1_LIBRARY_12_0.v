...
module FAU ( 
  ...
  inv1   g031(.a(x00), .O(new_n76_));
  nand3  g032(.a(new_n47_), .b(x25), .c(x01), .O(new_n77_));
  nor3   g033(.a(new_n77_), .b(x26), .c(new_n76_), .O(new_n78_));
  and2   g034(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(new_n65_), .O(new_n80_));
  inv1   g036(.a(new_n80_), .O(z3));
  inv1   g037(.a(new_n77_), .O(new_n82_));
  inv1   g038(.a(x28), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n65_), .O(new_n84_));
  nor2   g040(.a(new_n83_), .b(new_n65_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(new_n84_), .c(new_n82_), .d(new_n75_), .O(new_n87_));
  ...
  nand3  g049(.a(new_n85_), .b(x30), .c(x29), .O(new_n94_));
  ...
  nand3  g058(.a(new_n69_), .b(x18), .c(x14), .O(new_n103_));
  inv1   g059(.a(x18), .O(new_n104_));
  nand3  g060(.a(x19), .b(new_n104_), .c(x13), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(new_n106_));
  ...
  nor2   g070(.a(new_n104_), .b(new_n102_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x16), .c(x10), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n69_), .c(x15), .O(new_n117_));
  ...
  nand2  g076(.a(new_n120_), .b(new_n95_), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n83_), .b(new_n65_), .c(new_n90_), .O(new_n127_));
  aoi21  g083(.a(new_n122_), .b(new_n95_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g087(.a(new_n131_), .b(new_n69_), .O(new_n132_));
  nand2  g088(.a(new_n69_), .b(x14), .O(new_n133_));
  ...
  aoi21  g102(.a(new_n118_), .b(new_n95_), .c(new_n127_), .O(new_n147_));
