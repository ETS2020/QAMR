...
module FAU ( 
  ...
  and2   g037(.a(new_n81_), .b(new_n48_), .O(new_n82_));
  inv1   g038(.a(x31), .O(new_n83_));
  nor2   g039(.a(new_n83_), .b(new_n45_), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n82_), .c(new_n71_), .d(x01), .O(new_n85_));
  ...
  nor2   g050(.a(new_n90_), .b(x29), .O(new_n95_));
  ...
  nand2  g056(.a(new_n97_), .b(x30), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  nand2  g058(.a(new_n71_), .b(x01), .O(new_n103_));
  aoi21  g059(.a(new_n96_), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n101_), .c(new_n82_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(x31), .c(new_n45_), .O(z6));
  inv1   g062(.a(new_n101_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n86_), .O(z7));
  inv1   g064(.a(x32), .O(new_n109_));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n75_), .O(new_n118_));
  ...
  nor2   g082(.a(new_n116_), .b(new_n75_), .O(new_n127_));
  ...
  aoi21  g089(.a(new_n133_), .b(x16), .c(new_n124_), .O(new_n134_));
  nand3  g090(.a(new_n127_), .b(x16), .c(x15), .O(new_n135_));
  aoi21  g091(.a(new_n114_), .b(x14), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n128_), .b(new_n113_), .O(new_n137_));
  nand2  g093(.a(new_n135_), .b(new_n114_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(new_n136_), .c(new_n134_), .O(new_n140_));
  nor3   g096(.a(new_n111_), .b(new_n109_), .c(new_n83_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g098(.a(new_n71_), .b(x00), .O(new_n143_));
  nand2  g099(.a(x32), .b(new_n45_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n83_), .c(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  aoi21  g102(.a(new_n130_), .b(new_n109_), .c(new_n146_), .O(z8));
  xor2a  g103(.a(new_n110_), .b(new_n83_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n112_), .O(new_n149_));
  oai21  g105(.a(new_n129_), .b(new_n126_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n54_), .O(new_n151_));
