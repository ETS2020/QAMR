...
module FAU ( 
  ...
  xor2a  g055(.a(x31), .b(x30), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n91_), .O(new_n102_));
  aoi21  g058(.a(new_n91_), .b(x31), .c(new_n102_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n79_), .c(new_n46_), .O(z7));
  nand2  g060(.a(new_n71_), .b(x00), .O(new_n105_));
  ...
  nand4  g067(.a(x19), .b(x17), .c(new_n106_), .d(x11), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n111_), .c(x15), .O(new_n114_));
  nor2   g070(.a(new_n107_), .b(new_n109_), .O(new_n115_));
  and2   g071(.a(x16), .b(x10), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n115_), .c(new_n45_), .O(new_n117_));
  nand2  g073(.a(new_n54_), .b(x31), .O(new_n118_));
  aoi21  g074(.a(new_n117_), .b(new_n114_), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n88_), .b(x29), .O(new_n120_));
  aoi21  g076(.a(new_n54_), .b(x30), .c(new_n120_), .O(new_n121_));
  oai21  g077(.a(new_n119_), .b(x30), .c(new_n121_), .O(new_n122_));
  aoi22  g078(.a(new_n88_), .b(x29), .c(new_n54_), .d(new_n96_), .O(new_n123_));
  oai21  g079(.a(new_n119_), .b(new_n96_), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n107_), .b(x14), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x17), .c(x16), .d(x15), .O(new_n126_));
  aoi21  g082(.a(x17), .b(x11), .c(x16), .O(new_n127_));
  aoi21  g083(.a(x17), .b(x16), .c(x19), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nor2   g085(.a(x17), .b(x12), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n129_), .c(new_n126_), .d(x31), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x32), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n124_), .c(new_n122_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x18), .O(new_n135_));
  nand3  g091(.a(new_n116_), .b(new_n115_), .c(x18), .O(new_n136_));
  and2   g092(.a(new_n136_), .b(new_n45_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x32), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n105_), .O(z8));
  nand2  g095(.a(new_n137_), .b(x33), .O(new_n140_));
  xor2a  g096(.a(new_n120_), .b(x30), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n101_), .O(new_n142_));
  aoi21  g098(.a(new_n117_), .b(new_n114_), .c(new_n142_), .O(new_n143_));
  nor3   g099(.a(new_n130_), .b(new_n100_), .c(new_n50_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n141_), .c(new_n129_), .d(new_n126_), .O(new_n145_));
  and2   g101(.a(new_n145_), .b(x18), .O(new_n146_));
  oai21  g102(.a(new_n143_), .b(x33), .c(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n140_), .c(new_n105_), .O(z9));
endmodule
