...
module FAU ( 
  ...
  nand4  g038(.a(new_n61_), .b(new_n82_), .c(x25), .d(x01), .O(new_n83_));
  ...
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n84_), .d(new_n46_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z4));
  inv1   g048(.a(x29), .O(new_n93_));
  oai21  g049(.a(new_n45_), .b(new_n93_), .c(new_n89_), .O(new_n94_));
  nand2  g050(.a(new_n88_), .b(x29), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n94_), .c(new_n84_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z5));
  aoi21  g053(.a(new_n95_), .b(new_n84_), .c(new_n45_), .O(new_n98_));
  aoi21  g054(.a(new_n45_), .b(new_n93_), .c(new_n98_), .O(z6));
  xor2a  g055(.a(new_n95_), .b(x31), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n84_), .c(new_n47_), .O(z7));
  nand2  g057(.a(x31), .b(x30), .O(new_n102_));
  aoi21  g058(.a(new_n90_), .b(x29), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n117_), .c(new_n103_), .O(new_n120_));
  nand2  g076(.a(new_n114_), .b(new_n113_), .O(new_n121_));
  nand4  g077(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  aoi21  g079(.a(new_n121_), .b(x19), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(x18), .b(x12), .O(new_n125_));
  oai21  g081(.a(x18), .b(x13), .c(x17), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g083(.a(new_n118_), .b(new_n104_), .O(new_n128_));
  nand2  g084(.a(new_n105_), .b(x14), .O(new_n129_));
  nand2  g085(.a(new_n123_), .b(new_n129_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n124_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n103_), .c(x32), .O(new_n133_));
  nand2  g089(.a(new_n82_), .b(x00), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  aoi21  g092(.a(new_n120_), .b(new_n53_), .c(new_n136_), .O(z8));
  oai21  g093(.a(new_n131_), .b(new_n124_), .c(new_n46_), .O(new_n138_));
  nand2  g094(.a(new_n90_), .b(x31), .O(new_n139_));
  aoi22  g095(.a(new_n139_), .b(x30), .c(x31), .d(new_n93_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x33), .O(new_n142_));
  nand4  g098(.a(new_n90_), .b(x31), .c(x30), .d(x29), .O(new_n143_));
  inv1   g099(.a(x31), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n45_), .c(new_n93_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n143_), .c(x33), .O(new_n146_));
  oai21  g102(.a(new_n119_), .b(new_n117_), .c(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n142_), .c(new_n134_), .O(z9));
endmodule
