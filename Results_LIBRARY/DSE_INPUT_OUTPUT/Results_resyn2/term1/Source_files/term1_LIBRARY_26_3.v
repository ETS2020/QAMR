...
module FAU ( 
  ...
  and2   g041(.a(new_n85_), .b(new_n48_), .O(new_n86_));
  inv1   g042(.a(x26), .O(new_n87_));
  nand4  g043(.a(new_n67_), .b(new_n87_), .c(x25), .d(x01), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n86_), .c(new_n75_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z3));
  inv1   g047(.a(x28), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n75_), .O(new_n93_));
  nor2   g049(.a(new_n92_), .b(new_n75_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n93_), .c(new_n89_), .d(new_n86_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z4));
  and2   g053(.a(new_n89_), .b(new_n85_), .O(new_n98_));
  nand2  g054(.a(new_n94_), .b(x29), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n94_), .b(x29), .O(new_n101_));
  ...
  nand2  g060(.a(new_n99_), .b(new_n46_), .O(new_n105_));
  nand2  g061(.a(new_n100_), .b(x30), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n105_), .c(new_n98_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n48_), .O(z6));
  nand2  g064(.a(new_n106_), .b(x31), .O(new_n109_));
  or2    g065(.a(new_n106_), .b(x31), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n109_), .c(new_n98_), .d(new_n48_), .O(z7));
  nand3  g067(.a(new_n93_), .b(x31), .c(x29), .O(new_n112_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n112_), .c(new_n55_), .O(new_n130_));
  ...
  nand2  g092(.a(new_n79_), .b(x14), .O(new_n137_));
  ...
  nand2  g096(.a(new_n138_), .b(new_n79_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(new_n136_), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n133_), .O(new_n143_));
  nor2   g099(.a(new_n112_), .b(new_n55_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(x26), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n130_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n46_), .c(new_n45_), .O(z8));
  aoi21  g103(.a(new_n93_), .b(x29), .c(x31), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  or2    g105(.a(new_n149_), .b(new_n129_), .O(new_n150_));
  nand3  g106(.a(new_n148_), .b(new_n143_), .c(x33), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n46_), .c(new_n87_), .d(x00), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(new_n51_), .c(new_n152_), .O(z9));
endmodule
