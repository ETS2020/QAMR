...
module FAU ( 
  ...
  oai21  g046(.a(new_n84_), .b(new_n70_), .c(new_n90_), .O(new_n91_));
  nand2  g047(.a(x28), .b(x26), .O(new_n92_));
  nand2  g048(.a(new_n85_), .b(x29), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n79_), .O(new_n94_));
  ...
  nand3  g054(.a(new_n98_), .b(new_n96_), .c(new_n81_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z6));
  inv1   g056(.a(x31), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(x30), .c(x29), .d(x27), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n45_), .c(new_n84_), .O(new_n103_));
  nand2  g059(.a(new_n96_), .b(x31), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n79_), .c(x26), .O(new_n105_));
  or2    g061(.a(new_n105_), .b(new_n103_), .O(z7));
  ...
  nor2   g080(.a(new_n101_), .b(new_n97_), .O(new_n125_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  nor2   g083(.a(new_n86_), .b(new_n90_), .O(new_n128_));
  aoi21  g084(.a(x32), .b(x30), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nor2   g086(.a(new_n124_), .b(new_n121_), .O(new_n131_));
  nand3  g087(.a(new_n54_), .b(x31), .c(new_n97_), .O(new_n132_));
  oai22  g088(.a(new_n132_), .b(new_n131_), .c(new_n54_), .d(new_n97_), .O(new_n133_));
  oai21  g089(.a(new_n119_), .b(x16), .c(x15), .O(new_n134_));
  nand3  g090(.a(new_n122_), .b(x16), .c(x15), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n109_), .O(new_n136_));
  nand2  g092(.a(new_n109_), .b(x14), .O(new_n137_));
  ...
  aoi21  g096(.a(new_n134_), .b(new_n123_), .c(new_n140_), .O(new_n141_));
  inv1   g097(.a(x13), .O(new_n142_));
  nand2  g098(.a(new_n111_), .b(new_n142_), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(x17), .c(x18), .d(x12), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n101_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n141_), .c(new_n54_), .O(new_n146_));
  aoi21  g102(.a(new_n133_), .b(new_n128_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n45_), .b(x00), .O(new_n148_));
  aoi21  g104(.a(new_n147_), .b(new_n130_), .c(new_n148_), .O(z8));
  nand2  g105(.a(x33), .b(x30), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n128_), .O(new_n151_));
  aoi21  g107(.a(new_n126_), .b(new_n50_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n101_), .b(new_n97_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(x33), .O(new_n154_));
  oai21  g110(.a(new_n124_), .b(new_n121_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n134_), .b(new_n123_), .O(new_n156_));
  nand2  g112(.a(new_n125_), .b(x29), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n153_), .c(new_n144_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n139_), .c(new_n136_), .d(new_n156_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x33), .O(new_n160_));
  oai21  g116(.a(new_n155_), .b(x29), .c(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n152_), .c(new_n45_), .O(new_n162_));
  nand2  g118(.a(new_n155_), .b(new_n150_), .O(new_n163_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n47_), .O(z9));
endmodule
