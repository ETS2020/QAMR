...
module FAU ( 
  ...
  nand2  g049(.a(new_n93_), .b(new_n64_), .O(z5));
  ...
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n107_), .O(new_n124_));
  nand4  g080(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n125_));
  nor2   g081(.a(new_n111_), .b(new_n70_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(x11), .c(x16), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n109_), .c(new_n125_), .O(new_n128_));
  nand2  g084(.a(x17), .b(x13), .O(new_n129_));
  oai21  g085(.a(x17), .b(x12), .c(x18), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  aoi21  g087(.a(new_n109_), .b(x14), .c(new_n125_), .O(new_n132_));
  nand3  g088(.a(new_n126_), .b(x16), .c(x10), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n108_), .c(new_n132_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n131_), .c(new_n128_), .O(new_n135_));
  nand2  g091(.a(new_n107_), .b(x32), .O(new_n136_));
  nand2  g092(.a(new_n78_), .b(x00), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n45_), .O(new_n138_));
  oai21  g094(.a(new_n136_), .b(new_n135_), .c(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n124_), .b(new_n102_), .c(new_n139_), .O(z8));
  inv1   g096(.a(x31), .O(new_n141_));
  nand3  g097(.a(new_n103_), .b(new_n141_), .c(new_n95_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n104_), .b(x31), .c(new_n143_), .O(new_n144_));
  nor2   g100(.a(new_n45_), .b(new_n52_), .O(new_n145_));
  oai21  g101(.a(new_n144_), .b(new_n135_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n104_), .b(x31), .O(new_n147_));
  nand2  g103(.a(new_n143_), .b(x25), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(x33), .O(new_n149_));
  oai21  g105(.a(new_n123_), .b(new_n121_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n146_), .c(new_n137_), .O(z9));
endmodule
