...
module FAU ( 
  ...
  oai21  g024(.a(x22), .b(x17), .c(x18), .O(new_n69_));
  nor2   g025(.a(x20), .b(x15), .O(new_n70_));
  nor2   g026(.a(x21), .b(x16), .O(new_n71_));
  nor2   g027(.a(x24), .b(x19), .O(new_n72_));
  nor4   g028(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n73_));
  nand2  g029(.a(x25), .b(x01), .O(new_n74_));
  nor3   g030(.a(new_n74_), .b(new_n73_), .c(new_n60_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  aoi21  g032(.a(new_n76_), .b(new_n45_), .c(x26), .O(z3));
  ...
  aoi21  g038(.a(new_n82_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g039(.a(x26), .O(new_n84_));
  nand3  g040(.a(new_n75_), .b(new_n84_), .c(new_n45_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  inv1   g042(.a(x29), .O(new_n87_));
  nand2  g043(.a(new_n80_), .b(new_n87_), .O(new_n88_));
  nand2  g044(.a(new_n79_), .b(x29), .O(new_n89_));
  ...
  nand3  g049(.a(new_n79_), .b(x30), .c(x29), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(new_n86_), .O(new_n95_));
  ...
  nand2  g055(.a(new_n99_), .b(new_n84_), .O(z7));
  ...
  nand2  g078(.a(new_n81_), .b(x29), .O(new_n123_));
  aoi21  g079(.a(new_n53_), .b(x30), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g081(.a(new_n121_), .b(x30), .O(new_n126_));
  inv1   g082(.a(new_n123_), .O(new_n127_));
  aoi21  g083(.a(new_n53_), .b(new_n92_), .c(new_n127_), .O(new_n128_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n45_), .c(x26), .O(z8));
  ...
  nand2  g105(.a(new_n149_), .b(new_n49_), .O(new_n150_));
  aoi21  g106(.a(new_n105_), .b(new_n139_), .c(new_n49_), .O(new_n151_));
  ...
  aoi21  g109(.a(new_n153_), .b(new_n45_), .c(x26), .O(z9));
endmodule
