...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n91_), .c(new_n82_), .O(new_n95_));
  ...
  aoi22  g055(.a(new_n99_), .b(x29), .c(new_n80_), .d(new_n66_), .O(z6));
  inv1   g056(.a(x31), .O(new_n101_));
  nor2   g057(.a(new_n97_), .b(new_n92_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n85_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n66_), .c(new_n101_), .O(new_n104_));
  nand3  g060(.a(new_n102_), .b(new_n85_), .c(x31), .O(new_n105_));
  ...
  nor2   g073(.a(new_n111_), .b(new_n70_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x19), .c(new_n117_), .d(x11), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand3  g076(.a(new_n118_), .b(x16), .c(x10), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n109_), .c(x15), .O(new_n122_));
  aoi21  g078(.a(new_n120_), .b(x15), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n88_), .b(new_n97_), .O(new_n124_));
  aoi21  g080(.a(new_n87_), .b(x30), .c(new_n92_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x31), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n123_), .c(new_n108_), .O(new_n128_));
  nand2  g084(.a(new_n77_), .b(x00), .O(new_n129_));
  nand2  g085(.a(new_n118_), .b(x15), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n117_), .c(new_n109_), .O(new_n131_));
  inv1   g087(.a(x15), .O(new_n132_));
  nand2  g088(.a(new_n121_), .b(new_n132_), .O(new_n133_));
  nand2  g089(.a(x18), .b(x12), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n70_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  nand2  g092(.a(new_n111_), .b(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n133_), .d(new_n131_), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n118_), .b(new_n117_), .c(x11), .O(new_n140_));
  inv1   g096(.a(x14), .O(new_n141_));
  nor2   g097(.a(x19), .b(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n130_), .b(new_n142_), .c(x16), .O(new_n143_));
  nand2  g099(.a(new_n102_), .b(new_n88_), .O(new_n144_));
  nand2  g100(.a(new_n87_), .b(new_n97_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(x32), .d(x31), .O(new_n146_));
  aoi21  g102(.a(new_n143_), .b(new_n140_), .c(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n139_), .c(new_n129_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n128_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n66_), .O(z8));
  oai21  g106(.a(new_n129_), .b(new_n52_), .c(x30), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n92_), .O(new_n152_));
  nand2  g108(.a(new_n144_), .b(x31), .O(new_n153_));
  nand2  g109(.a(new_n145_), .b(new_n101_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n123_), .c(new_n52_), .O(new_n156_));
  oai21  g112(.a(new_n87_), .b(new_n101_), .c(x30), .O(new_n157_));
  aoi21  g113(.a(x31), .b(new_n97_), .c(new_n52_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n157_), .c(new_n124_), .O(new_n159_));
  aoi21  g115(.a(new_n143_), .b(new_n140_), .c(new_n159_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n139_), .c(new_n129_), .O(new_n161_));
