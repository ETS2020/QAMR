...
module FAU ( 
  ...
  inv1   g037(.a(new_n46_), .O(new_n82_));
  inv1   g038(.a(x28), .O(new_n83_));
  nor2   g039(.a(new_n83_), .b(new_n69_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  nand2  g041(.a(new_n83_), .b(new_n69_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n82_), .O(z4));
  ...
  nand2  g048(.a(new_n92_), .b(new_n82_), .O(z5));
  inv1   g049(.a(x30), .O(new_n94_));
  xor2a  g050(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n79_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n82_), .O(z6));
  xor2a  g053(.a(x31), .b(x30), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n84_), .c(x29), .O(new_n99_));
  nand2  g055(.a(new_n89_), .b(x31), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n99_), .c(new_n79_), .O(z7));
  nand2  g057(.a(new_n77_), .b(x00), .O(new_n102_));
  ...
  aoi21  g076(.a(new_n117_), .b(x15), .c(new_n120_), .O(new_n121_));
  oai21  g077(.a(x28), .b(x27), .c(x29), .O(new_n122_));
  xor2a  g078(.a(new_n122_), .b(new_n94_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n53_), .c(x31), .O(new_n124_));
  oai21  g080(.a(new_n115_), .b(x16), .c(x15), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n119_), .O(new_n126_));
  nand3  g082(.a(new_n118_), .b(x16), .c(x15), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n105_), .O(new_n128_));
  nand2  g084(.a(new_n105_), .b(x14), .O(new_n129_));
  nand4  g085(.a(new_n118_), .b(new_n129_), .c(x16), .d(x15), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(new_n126_), .O(new_n131_));
  nand2  g087(.a(x18), .b(x12), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n104_), .O(new_n133_));
  inv1   g089(.a(x13), .O(new_n134_));
  nand2  g090(.a(new_n107_), .b(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n123_), .d(x31), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n131_), .c(x32), .O(new_n137_));
  oai21  g093(.a(new_n124_), .b(new_n121_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n103_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n82_), .O(z8));
  nor2   g096(.a(new_n123_), .b(new_n98_), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n121_), .c(new_n49_), .O(new_n143_));
  nand4  g099(.a(new_n141_), .b(new_n135_), .c(new_n133_), .d(x33), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n131_), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n102_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n82_), .O(z9));
endmodule
