...
module FAU ( 
  ...
  aoi21  g05(.a(new_n48_), .b(new_n49_), .c(z9), .O(new_n50_));
  oai21  g06(.a(new_n48_), .b(x32), .c(new_n50_), .O(z1));
  inv1   g07(.a(z9), .O(new_n52_));
  ...
  and2   g48(.a(new_n83_), .b(new_n81_), .O(new_n93_));
  xor2a  g49(.a(new_n87_), .b(x29), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n45_), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(z5));
  nand3  g52(.a(new_n87_), .b(x30), .c(x29), .O(new_n97_));
  inv1   g53(.a(x30), .O(new_n98_));
  nand2  g54(.a(new_n87_), .b(x29), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n97_), .c(new_n83_), .d(new_n81_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n45_), .c(x26), .O(z6));
  xor2a  g58(.a(new_n97_), .b(x31), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n93_), .c(new_n92_), .d(new_n45_), .O(z7));
  zero   g60(.O(z8));
endmodule
