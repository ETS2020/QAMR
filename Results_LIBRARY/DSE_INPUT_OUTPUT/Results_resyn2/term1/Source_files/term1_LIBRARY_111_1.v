...
module FAU ( 
  ...
  nand3  g035(.a(new_n56_), .b(new_n79_), .c(x25), .O(new_n80_));
  ...
  aoi21  g080(.a(new_n84_), .b(new_n71_), .c(new_n91_), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  aoi21  g082(.a(new_n51_), .b(x30), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand2  g084(.a(new_n123_), .b(x30), .O(new_n129_));
  aoi21  g085(.a(new_n51_), .b(new_n95_), .c(new_n125_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n105_), .O(new_n135_));
  oai21  g091(.a(new_n134_), .b(new_n133_), .c(new_n135_), .O(new_n136_));
  aoi21  g092(.a(new_n131_), .b(new_n119_), .c(new_n136_), .O(new_n137_));
  aoi21  g093(.a(x18), .b(x12), .c(x17), .O(new_n138_));
  nor2   g094(.a(x18), .b(x13), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(new_n138_), .c(new_n121_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n137_), .c(new_n51_), .O(new_n141_));
  ...
  aoi21  g101(.a(new_n121_), .b(new_n95_), .c(new_n125_), .O(new_n146_));
  ...
  nor3   g105(.a(new_n139_), .b(new_n138_), .c(new_n48_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n137_), .c(new_n143_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n46_), .O(z9));
endmodule
