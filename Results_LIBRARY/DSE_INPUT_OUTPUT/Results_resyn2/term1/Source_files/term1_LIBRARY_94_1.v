...
module FAU ( 
  ...
  oai21  g041(.a(new_n85_), .b(x27), .c(new_n47_), .O(z3));
  ...
  oai21  g048(.a(new_n92_), .b(new_n85_), .c(new_n47_), .O(z4));
  ...
  oai21  g053(.a(new_n97_), .b(new_n85_), .c(new_n47_), .O(z5));
  ...
  oai21  g058(.a(new_n102_), .b(new_n85_), .c(new_n47_), .O(z6));
  xor2a  g059(.a(new_n101_), .b(x31), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n84_), .c(new_n81_), .O(z7));
  ...
  nand3  g085(.a(new_n120_), .b(x16), .c(x15), .O(new_n130_));
  oai21  g086(.a(new_n117_), .b(x16), .c(x19), .O(new_n131_));
  ...
  aoi21  g091(.a(new_n75_), .b(x14), .c(new_n130_), .O(new_n136_));
  aoi21  g092(.a(new_n121_), .b(new_n106_), .c(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(new_n132_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n45_), .c(x32), .O(new_n139_));
  nand2  g095(.a(new_n124_), .b(x30), .O(new_n140_));
  aoi21  g096(.a(new_n54_), .b(new_n99_), .c(new_n126_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n139_), .c(new_n129_), .O(new_n143_));
  ...
  nor2   g103(.a(new_n45_), .b(new_n99_), .O(new_n148_));
  nor3   g104(.a(new_n126_), .b(x31), .c(x30), .O(new_n149_));
  aoi21  g105(.a(new_n148_), .b(new_n126_), .c(new_n149_), .O(new_n150_));
  nor2   g106(.a(new_n46_), .b(new_n50_), .O(new_n151_));
  oai21  g107(.a(new_n150_), .b(new_n138_), .c(new_n151_), .O(new_n152_));
  or2    g108(.a(new_n122_), .b(new_n119_), .O(new_n153_));
  or2    g109(.a(new_n149_), .b(x25), .O(new_n154_));
  nor2   g110(.a(new_n150_), .b(x33), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n154_), .c(new_n153_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n152_), .c(new_n144_), .O(z9));
endmodule
