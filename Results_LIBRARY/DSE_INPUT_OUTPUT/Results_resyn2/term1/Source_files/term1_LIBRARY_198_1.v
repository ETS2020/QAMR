...
module FAU ( 
  ...
  nor2   g037(.a(new_n81_), .b(new_n52_), .O(new_n82_));
  ...
  oai21  g048(.a(new_n92_), .b(new_n85_), .c(new_n48_), .O(z4));
  ...
  oai21  g053(.a(new_n97_), .b(new_n85_), .c(new_n48_), .O(z5));
  inv1   g054(.a(x30), .O(new_n99_));
  nand2  g055(.a(new_n94_), .b(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n90_), .b(x30), .c(x29), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n45_), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n83_), .O(z6));
  inv1   g059(.a(new_n85_), .O(new_n104_));
  xor2a  g060(.a(new_n101_), .b(x31), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n104_), .c(new_n46_), .O(z7));
  ...
  aoi21  g067(.a(new_n111_), .b(new_n109_), .c(new_n74_), .O(new_n112_));
  nand4  g068(.a(x19), .b(x18), .c(new_n74_), .d(x12), .O(new_n113_));
  ...
  nor2   g076(.a(new_n110_), .b(new_n74_), .O(new_n121_));
  ...
  aoi22  g087(.a(new_n89_), .b(x29), .c(new_n49_), .d(new_n99_), .O(new_n132_));
  ...
  nand2  g100(.a(new_n110_), .b(new_n144_), .O(new_n145_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n48_), .O(z8));
  aoi21  g108(.a(x31), .b(x30), .c(new_n128_), .O(new_n153_));
  nand2  g109(.a(new_n124_), .b(new_n99_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n128_), .c(new_n153_), .O(new_n155_));
  oai21  g111(.a(new_n123_), .b(new_n120_), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n155_), .b(new_n145_), .c(new_n143_), .d(x33), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n141_), .c(new_n150_), .O(new_n158_));
  aoi21  g114(.a(new_n156_), .b(new_n56_), .c(new_n158_), .O(z9));
endmodule
