...
module FAU ( 
  ...
  nor2   g019(.a(x24), .b(x19), .O(new_n64_));
  ...
  nand2  g037(.a(new_n81_), .b(new_n46_), .O(z4));
  nand2  g038(.a(new_n70_), .b(new_n65_), .O(new_n83_));
  nand2  g039(.a(new_n79_), .b(x29), .O(new_n84_));
  inv1   g040(.a(x29), .O(new_n85_));
  nand2  g041(.a(new_n80_), .b(new_n85_), .O(new_n86_));
  nor2   g042(.a(new_n73_), .b(new_n45_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n83_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z5));
  inv1   g045(.a(new_n73_), .O(new_n90_));
  nand2  g046(.a(new_n84_), .b(new_n83_), .O(new_n91_));
  nor2   g047(.a(new_n64_), .b(x30), .O(new_n92_));
  inv1   g048(.a(x30), .O(new_n93_));
  inv1   g049(.a(new_n84_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  oai22  g051(.a(new_n95_), .b(new_n70_), .c(new_n92_), .d(new_n91_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n90_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n46_), .O(z6));
  inv1   g054(.a(x31), .O(new_n99_));
  nand3  g055(.a(new_n94_), .b(new_n99_), .c(x30), .O(new_n100_));
  oai21  g056(.a(new_n84_), .b(new_n93_), .c(x31), .O(new_n101_));
  oai21  g057(.a(new_n65_), .b(new_n93_), .c(new_n70_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n87_), .O(z7));
  ...
  aoi21  g078(.a(new_n119_), .b(x15), .c(new_n122_), .O(new_n123_));
  oai21  g079(.a(x28), .b(x27), .c(x29), .O(new_n124_));
  xor2a  g080(.a(new_n124_), .b(new_n93_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n49_), .c(x31), .O(new_n126_));
  oai21  g082(.a(new_n117_), .b(x16), .c(x15), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n121_), .O(new_n128_));
  nand3  g084(.a(new_n120_), .b(x16), .c(x15), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n107_), .O(new_n130_));
  nand2  g086(.a(new_n107_), .b(x14), .O(new_n131_));
  nand4  g087(.a(new_n120_), .b(new_n131_), .c(x16), .d(x15), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n128_), .O(new_n133_));
  nand2  g089(.a(x18), .b(x12), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n106_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  nand2  g092(.a(new_n109_), .b(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n125_), .d(x31), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n133_), .c(x32), .O(new_n139_));
  oai21  g095(.a(new_n126_), .b(new_n123_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n105_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n46_), .O(z8));
  inv1   g098(.a(x33), .O(new_n143_));
  xor2a  g099(.a(new_n124_), .b(new_n99_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n125_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n123_), .c(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n145_), .b(new_n137_), .c(new_n135_), .d(x33), .O(new_n148_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n46_), .O(z9));
endmodule
