...
module FAU ( 
  ...
  nand3  g041(.a(new_n85_), .b(x31), .c(x25), .O(new_n86_));
  ...
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(new_n85_), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(x31), .c(new_n90_), .O(z4));
  nor2   g052(.a(new_n92_), .b(x29), .O(new_n97_));
  ...
  nand2  g058(.a(new_n99_), .b(x30), .O(new_n103_));
  ...
  oai21  g063(.a(new_n103_), .b(new_n84_), .c(x31), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x25), .O(z7));
  nand2  g065(.a(new_n81_), .b(x00), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n54_), .c(new_n90_), .O(new_n111_));
  ...
  aoi21  g078(.a(new_n74_), .b(x14), .c(new_n114_), .O(new_n123_));
  nand4  g079(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n122_), .c(new_n123_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n121_), .c(new_n118_), .O(new_n126_));
  nand2  g082(.a(new_n94_), .b(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n104_), .O(new_n128_));
  nand3  g084(.a(new_n94_), .b(x30), .c(x29), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n126_), .c(x32), .O(new_n131_));
  inv1   g087(.a(x17), .O(new_n132_));
  nand3  g088(.a(new_n74_), .b(x18), .c(x14), .O(new_n133_));
  ...
  nand3  g096(.a(new_n116_), .b(x19), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nor3   g098(.a(new_n124_), .b(new_n74_), .c(x15), .O(new_n143_));
  aoi21  g099(.a(new_n142_), .b(x15), .c(new_n143_), .O(new_n144_));
  and2   g100(.a(new_n129_), .b(x31), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n128_), .c(new_n54_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(new_n131_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n113_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n112_), .O(z8));
  aoi21  g105(.a(new_n141_), .b(new_n139_), .c(new_n122_), .O(new_n150_));
  aoi21  g106(.a(new_n127_), .b(new_n104_), .c(x31), .O(new_n151_));
  nand2  g107(.a(new_n46_), .b(new_n50_), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n151_), .c(new_n145_), .O(new_n153_));
  oai21  g109(.a(new_n143_), .b(new_n150_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n126_), .b(new_n46_), .O(new_n155_));
  aoi21  g111(.a(new_n151_), .b(new_n90_), .c(new_n145_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x33), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n154_), .c(new_n110_), .O(z9));
endmodule
