...
module FAU ( 
  ...
  oai21  g061(.a(x19), .b(new_n105_), .c(x17), .O(new_n106_));
  inv1   g062(.a(x16), .O(new_n107_));
  nand2  g063(.a(x19), .b(x12), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n45_), .c(new_n107_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand4  g066(.a(x19), .b(x17), .c(new_n107_), .d(x11), .O(new_n111_));
  ...
  nor2   g092(.a(new_n136_), .b(x17), .O(new_n137_));
  ...
  nand3  g103(.a(new_n147_), .b(new_n144_), .c(x18), .O(new_n148_));
