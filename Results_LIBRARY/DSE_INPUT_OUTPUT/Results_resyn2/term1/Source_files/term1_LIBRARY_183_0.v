...
module FAU ( 
  ...
  aoi21  g040(.a(new_n84_), .b(x23), .c(x26), .O(z4));
  ...
  aoi21  g045(.a(new_n89_), .b(x23), .c(x26), .O(z5));
  ...
  aoi21  g051(.a(new_n95_), .b(x23), .c(x26), .O(z6));
  nor2   g052(.a(new_n92_), .b(x31), .O(new_n97_));
  nand2  g053(.a(new_n92_), .b(x31), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n77_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n97_), .c(x23), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n46_), .O(z7));
  ...
  nand2  g078(.a(new_n122_), .b(new_n93_), .O(new_n123_));
  ...
  aoi22  g083(.a(new_n83_), .b(x29), .c(new_n52_), .d(new_n93_), .O(new_n128_));
  ...
  aoi21  g101(.a(new_n145_), .b(x23), .c(x26), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n124_), .O(new_n147_));
  nand2  g103(.a(new_n120_), .b(new_n93_), .O(new_n148_));
