...
module FAU ( 
  ...
  nor2   g001(.a(new_n45_), .b(x31), .O(new_n46_));
  ...
  nand4  g033(.a(new_n62_), .b(new_n77_), .c(x25), .d(x01), .O(new_n78_));
  inv1   g034(.a(new_n78_), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n47_), .c(new_n76_), .O(new_n80_));
  aoi21  g036(.a(new_n75_), .b(new_n72_), .c(new_n80_), .O(z3));
  aoi21  g037(.a(new_n75_), .b(new_n72_), .c(new_n78_), .O(new_n82_));
  inv1   g038(.a(x28), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  nor2   g040(.a(new_n83_), .b(new_n76_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n84_), .c(new_n82_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n47_), .O(z4));
  nand2  g044(.a(new_n82_), .b(new_n47_), .O(new_n89_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n53_), .c(new_n45_), .O(new_n105_));
  ...
  aoi21  g080(.a(new_n84_), .b(x29), .c(x30), .O(new_n125_));
  nand2  g081(.a(new_n84_), .b(x29), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n96_), .c(x31), .O(new_n127_));
  or2    g083(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n124_), .c(new_n53_), .O(new_n129_));
  nand2  g085(.a(x18), .b(x12), .O(new_n130_));
  oai21  g086(.a(x18), .b(x13), .c(x17), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(x16), .c(new_n118_), .O(new_n133_));
  nand3  g089(.a(new_n121_), .b(x16), .c(x15), .O(new_n134_));
  aoi21  g090(.a(new_n108_), .b(x14), .c(new_n134_), .O(new_n135_));
  inv1   g091(.a(x15), .O(new_n136_));
  nand2  g092(.a(new_n122_), .b(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n134_), .b(new_n108_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(new_n135_), .c(new_n133_), .O(new_n140_));
  nor2   g096(.a(new_n126_), .b(new_n96_), .O(new_n141_));
  nor3   g097(.a(new_n141_), .b(new_n125_), .c(new_n53_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n140_), .c(new_n104_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n129_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n106_), .O(z8));
  nand2  g101(.a(new_n140_), .b(new_n141_), .O(new_n146_));
  nor2   g102(.a(new_n45_), .b(new_n103_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g104(.a(new_n119_), .b(new_n115_), .c(new_n136_), .O(new_n149_));
  nor2   g105(.a(new_n125_), .b(x31), .O(new_n150_));
  nand2  g106(.a(new_n127_), .b(new_n45_), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  oai21  g108(.a(new_n123_), .b(new_n149_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n148_), .c(new_n104_), .O(z9));
endmodule
