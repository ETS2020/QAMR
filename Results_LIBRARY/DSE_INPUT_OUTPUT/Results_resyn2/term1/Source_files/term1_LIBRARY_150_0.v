...
module FAU ( 
  ...
  aoi21  g042(.a(new_n68_), .b(x00), .c(new_n86_), .O(new_n87_));
  aoi21  g043(.a(new_n86_), .b(new_n68_), .c(new_n87_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n85_), .c(new_n78_), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(x00), .c(x26), .O(z4));
  nand3  g046(.a(x29), .b(x28), .c(x27), .O(new_n91_));
  inv1   g047(.a(x29), .O(new_n92_));
  oai21  g048(.a(new_n86_), .b(new_n68_), .c(new_n92_), .O(new_n93_));
  ...
  nand2  g104(.a(new_n121_), .b(new_n98_), .O(new_n149_));
