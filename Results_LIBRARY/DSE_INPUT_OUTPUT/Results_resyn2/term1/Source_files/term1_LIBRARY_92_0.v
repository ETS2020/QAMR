// Benchmark "FAU" written by ABC on Tue Aug 11 21:13:37 2020
...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x09), .O(new_n45_));
  ...
  oai21  g040(.a(new_n84_), .b(x27), .c(new_n46_), .O(z3));
  ...
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n86_), .d(new_n46_), .O(new_n92_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n84_), .c(new_n46_), .O(z5));
  xor2a  g054(.a(new_n94_), .b(x30), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n84_), .c(new_n46_), .O(z6));
  inv1   g056(.a(new_n94_), .O(new_n101_));
  inv1   g057(.a(x31), .O(new_n102_));
  nor2   g058(.a(new_n101_), .b(new_n102_), .O(new_n103_));
  inv1   g059(.a(x30), .O(new_n104_));
  nor2   g060(.a(new_n102_), .b(new_n104_), .O(new_n105_));
  nor2   g061(.a(x31), .b(x30), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n101_), .c(new_n103_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n86_), .c(new_n45_), .O(z7));
  ...
  nand3  g077(.a(new_n121_), .b(x19), .c(new_n74_), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n119_), .c(new_n110_), .O(new_n123_));
  nor2   g079(.a(new_n111_), .b(new_n74_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x10), .O(new_n125_));
  nand3  g081(.a(x19), .b(x18), .c(new_n110_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nor2   g083(.a(x32), .b(new_n102_), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n123_), .c(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n104_), .O(new_n130_));
  nand2  g086(.a(new_n89_), .b(x29), .O(new_n131_));
  aoi21  g087(.a(new_n53_), .b(x30), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nor2   g089(.a(x17), .b(x12), .O(new_n134_));
  nand2  g090(.a(x17), .b(x13), .O(new_n135_));
  oai21  g091(.a(new_n134_), .b(new_n112_), .c(new_n135_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(x16), .c(new_n121_), .O(new_n137_));
  oai21  g093(.a(new_n125_), .b(new_n112_), .c(new_n110_), .O(new_n138_));
  nand2  g094(.a(new_n124_), .b(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n112_), .c(new_n114_), .O(new_n140_));
  nand2  g096(.a(new_n114_), .b(x14), .O(new_n141_));
  nand4  g097(.a(new_n124_), .b(new_n141_), .c(x18), .d(x15), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n140_), .c(new_n138_), .d(x31), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n137_), .c(x32), .O(new_n144_));
  nand2  g100(.a(new_n129_), .b(x30), .O(new_n145_));
  inv1   g101(.a(new_n131_), .O(new_n146_));
  aoi21  g102(.a(new_n53_), .b(new_n104_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n144_), .c(new_n133_), .O(new_n149_));
  ...
  nand3  g110(.a(new_n49_), .b(x19), .c(new_n112_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n124_), .b(x15), .c(x13), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n156_), .c(new_n106_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n154_), .c(new_n66_), .O(new_n160_));
  nand4  g116(.a(x19), .b(x17), .c(new_n74_), .d(x11), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n111_), .b(x12), .O(new_n163_));
  oai21  g119(.a(x19), .b(x17), .c(x16), .O(new_n164_));
  aoi21  g120(.a(new_n163_), .b(new_n141_), .c(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n162_), .c(x15), .O(new_n166_));
  nand4  g122(.a(new_n124_), .b(x19), .c(new_n110_), .d(x10), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n166_), .c(x33), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n106_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n154_), .c(new_n112_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n160_), .c(new_n131_), .O(new_n171_));
  nor2   g127(.a(new_n49_), .b(x30), .O(new_n172_));
  nand2  g128(.a(new_n158_), .b(new_n105_), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n155_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n172_), .c(x09), .O(new_n175_));
  aoi21  g131(.a(new_n168_), .b(new_n105_), .c(new_n172_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n112_), .c(new_n175_), .O(new_n177_));
  nor2   g133(.a(new_n139_), .b(new_n141_), .O(new_n178_));
  nand2  g134(.a(new_n139_), .b(x19), .O(new_n179_));
  aoi21  g135(.a(new_n125_), .b(new_n110_), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(x17), .b(x11), .c(x16), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n134_), .O(new_n182_));
  ...
  aoi21  g141(.a(new_n185_), .b(new_n112_), .c(new_n107_), .O(new_n186_));
  nand2  g142(.a(new_n46_), .b(x33), .O(new_n187_));
  aoi21  g143(.a(new_n186_), .b(new_n184_), .c(new_n187_), .O(new_n188_));
  aoi21  g144(.a(new_n177_), .b(new_n146_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n171_), .c(new_n150_), .O(z9));
endmodule
