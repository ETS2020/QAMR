...
module FAU ( 
  ...
  nor2   g000(.a(x26), .b(x17), .O(new_n45_));
  ...
  nor2   g042(.a(new_n86_), .b(new_n51_), .O(new_n87_));
  and2   g043(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n72_), .c(new_n70_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z3));
  inv1   g046(.a(x28), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n70_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n91_), .b(new_n70_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n93_), .c(new_n88_), .d(new_n72_), .O(new_n95_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n97_), .c(new_n88_), .d(new_n72_), .O(new_n100_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n103_), .c(new_n88_), .d(new_n72_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z6));
  inv1   g063(.a(x26), .O(new_n108_));
  nand2  g064(.a(new_n103_), .b(x31), .O(new_n109_));
  inv1   g065(.a(x31), .O(new_n110_));
  nand3  g066(.a(new_n102_), .b(new_n110_), .c(x30), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n109_), .c(new_n88_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x17), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n108_), .O(z7));
  nand3  g070(.a(x18), .b(x16), .c(x15), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n82_), .c(x14), .O(new_n117_));
  nand3  g073(.a(x18), .b(x16), .c(x10), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n79_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n115_), .c(x19), .O(new_n120_));
  nand2  g076(.a(x18), .b(x11), .O(new_n121_));
  oai21  g077(.a(x18), .b(x13), .c(x16), .O(new_n122_));
  aoi22  g078(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n117_), .O(new_n123_));
  oai21  g079(.a(x28), .b(x27), .c(x29), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n104_), .O(new_n125_));
  and2   g081(.a(new_n124_), .b(new_n104_), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n125_), .c(new_n110_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x32), .O(new_n129_));
  nand3  g085(.a(new_n82_), .b(x18), .c(x14), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n76_), .c(x13), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n73_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n73_), .d(x11), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(x15), .O(new_n135_));
  inv1   g091(.a(new_n118_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x19), .c(new_n79_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n127_), .c(new_n48_), .O(new_n139_));
  nand2  g095(.a(new_n72_), .b(x00), .O(new_n140_));
  aoi21  g096(.a(new_n139_), .b(new_n129_), .c(new_n140_), .O(z8));
  nand3  g097(.a(new_n124_), .b(new_n110_), .c(new_n104_), .O(new_n142_));
  nand4  g098(.a(new_n94_), .b(x31), .c(x30), .d(x29), .O(new_n143_));
  and2   g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  aoi21  g100(.a(new_n137_), .b(new_n135_), .c(new_n144_), .O(new_n145_));
  inv1   g101(.a(x00), .O(new_n146_));
  aoi21  g102(.a(new_n143_), .b(new_n142_), .c(new_n55_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n123_), .c(new_n146_), .O(new_n148_));
  oai21  g104(.a(new_n145_), .b(x33), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(x17), .c(x26), .O(z9));
endmodule
