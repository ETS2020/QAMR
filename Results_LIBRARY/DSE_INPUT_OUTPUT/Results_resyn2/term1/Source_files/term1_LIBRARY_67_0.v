...
module FAU ( 
  ...
  aoi21  g051(.a(new_n89_), .b(new_n95_), .c(new_n45_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(z5));
  nand2  g054(.a(new_n94_), .b(new_n93_), .O(new_n99_));
  inv1   g055(.a(x31), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(x30), .O(new_n101_));
  inv1   g057(.a(new_n94_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n93_), .O(new_n103_));
  aoi22  g059(.a(new_n103_), .b(new_n101_), .c(new_n99_), .d(x30), .O(z6));
  nand2  g060(.a(new_n94_), .b(x31), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  aoi21  g062(.a(new_n102_), .b(new_n100_), .c(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n105_), .c(new_n93_), .O(z7));
  nand2  g064(.a(new_n81_), .b(x00), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n53_), .c(x30), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n100_), .O(new_n111_));
  inv1   g067(.a(new_n109_), .O(new_n112_));
  inv1   g068(.a(x17), .O(new_n113_));
  nand3  g069(.a(new_n74_), .b(x18), .c(x14), .O(new_n114_));
  ...
  nor3   g083(.a(new_n127_), .b(new_n74_), .c(x15), .O(new_n128_));
  aoi21  g084(.a(new_n125_), .b(x15), .c(new_n128_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(x30), .c(new_n53_), .O(new_n130_));
  nand2  g086(.a(new_n90_), .b(x29), .O(new_n131_));
  aoi21  g087(.a(x32), .b(new_n106_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g089(.a(x32), .b(new_n106_), .O(new_n134_));
  nand3  g090(.a(new_n53_), .b(x31), .c(x30), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n129_), .c(new_n134_), .O(new_n136_));
  ...
  nand2  g096(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n122_), .O(new_n142_));
  nand2  g098(.a(new_n74_), .b(x14), .O(new_n143_));
  nand3  g099(.a(new_n126_), .b(x16), .c(x15), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  inv1   g102(.a(x15), .O(new_n147_));
  nand2  g103(.a(new_n127_), .b(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n144_), .b(new_n74_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n148_), .c(new_n146_), .d(new_n142_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n137_), .c(new_n133_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n112_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n111_), .O(z8));
  nand3  g110(.a(new_n90_), .b(x31), .c(x29), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n150_), .c(x33), .O(new_n156_));
  inv1   g112(.a(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n49_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n129_), .c(new_n156_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x30), .O(new_n160_));
  nand2  g116(.a(new_n101_), .b(x33), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n160_), .c(new_n109_), .O(z9));
endmodule
