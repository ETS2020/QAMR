...
module FAU ( 
  ...
  nand3  g038(.a(new_n82_), .b(new_n47_), .c(new_n72_), .O(new_n83_));
  ...
  oai21  g047(.a(new_n85_), .b(new_n72_), .c(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n86_), .b(x29), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n82_), .d(new_n47_), .O(new_n94_));
  ...
  nor2   g056(.a(x33), .b(x31), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(x29), .O(new_n102_));
  ...
  oai21  g061(.a(new_n102_), .b(new_n82_), .c(new_n105_), .O(z7));
  nand2  g062(.a(new_n80_), .b(x00), .O(new_n107_));
  oai21  g063(.a(x33), .b(new_n97_), .c(new_n91_), .O(new_n108_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n114_), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n111_), .b(new_n126_), .c(new_n103_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n125_), .c(new_n123_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n121_), .c(new_n108_), .O(new_n129_));
  nor2   g085(.a(new_n87_), .b(new_n91_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x30), .O(new_n132_));
  nand2  g088(.a(new_n130_), .b(new_n97_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n129_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x32), .O(new_n136_));
  nand3  g092(.a(new_n116_), .b(x18), .c(x14), .O(new_n137_));
  nand3  g093(.a(x19), .b(new_n111_), .c(x13), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n137_), .c(new_n110_), .O(new_n139_));
  nand4  g095(.a(x19), .b(x18), .c(new_n110_), .d(x12), .O(new_n140_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n142_), .c(new_n109_), .O(new_n145_));
  nor3   g101(.a(new_n113_), .b(new_n116_), .c(x15), .O(new_n146_));
  or2    g102(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  oai21  g103(.a(new_n132_), .b(new_n46_), .c(new_n133_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n53_), .d(x31), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n136_), .c(new_n107_), .O(z8));
  nand3  g106(.a(new_n45_), .b(x31), .c(x30), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n146_), .b(new_n145_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(x33), .b(new_n97_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n87_), .O(new_n155_));
  oai21  g111(.a(new_n87_), .b(new_n103_), .c(x30), .O(new_n156_));
  aoi22  g112(.a(x31), .b(new_n97_), .c(new_n111_), .d(new_n126_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n156_), .c(new_n125_), .d(new_n123_), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n121_), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n45_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n155_), .c(x29), .O(new_n161_));
  nand4  g117(.a(new_n147_), .b(new_n131_), .c(new_n101_), .d(new_n97_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n107_), .O(z9));
endmodule
