...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n92_), .d(new_n47_), .O(new_n96_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n105_), .O(new_n116_));
  nor2   g072(.a(new_n109_), .b(new_n106_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x16), .c(x10), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n107_), .c(x15), .O(new_n119_));
  ...
  nand2  g078(.a(new_n122_), .b(new_n99_), .O(new_n123_));
  ...
  aoi21  g106(.a(x31), .b(x30), .c(new_n124_), .O(new_n151_));
  nand2  g107(.a(new_n120_), .b(new_n99_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n124_), .c(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n119_), .b(new_n116_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n50_), .O(new_n155_));
  aoi21  g111(.a(new_n109_), .b(new_n142_), .c(new_n50_), .O(new_n156_));
