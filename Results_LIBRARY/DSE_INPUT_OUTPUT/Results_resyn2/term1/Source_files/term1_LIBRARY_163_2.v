...
module FAU ( 
  ...
  oai21  g035(.a(new_n79_), .b(new_n75_), .c(new_n47_), .O(z3));
  ...
  oai21  g042(.a(new_n86_), .b(new_n75_), .c(new_n47_), .O(z4));
  inv1   g043(.a(x30), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(new_n45_), .O(new_n89_));
  nor2   g045(.a(new_n89_), .b(new_n82_), .O(new_n90_));
  nand2  g046(.a(new_n78_), .b(new_n64_), .O(new_n91_));
  aoi21  g047(.a(new_n82_), .b(x29), .c(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n74_), .O(new_n93_));
  or2    g049(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z5));
  oai21  g051(.a(new_n93_), .b(new_n88_), .c(new_n47_), .O(z6));
  oai21  g052(.a(new_n83_), .b(x31), .c(x30), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x29), .O(new_n98_));
  nand2  g054(.a(new_n89_), .b(new_n82_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(x31), .c(new_n91_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n74_), .O(z7));
  oai21  g057(.a(new_n84_), .b(new_n45_), .c(x31), .O(new_n102_));
  or2    g058(.a(new_n102_), .b(new_n88_), .O(new_n103_));
  inv1   g059(.a(x17), .O(new_n104_));
  nand3  g060(.a(new_n68_), .b(x18), .c(x14), .O(new_n105_));
  ...
  nor3   g074(.a(new_n118_), .b(new_n68_), .c(x15), .O(new_n119_));
  aoi21  g075(.a(new_n116_), .b(x15), .c(new_n119_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n103_), .c(new_n50_), .O(new_n121_));
  ...
  nand2  g083(.a(new_n127_), .b(new_n68_), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n126_), .c(new_n128_), .O(new_n129_));
  aoi21  g085(.a(new_n124_), .b(new_n118_), .c(new_n129_), .O(new_n130_));
  ...
  nor2   g090(.a(new_n134_), .b(new_n103_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n130_), .c(new_n123_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n121_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n47_), .O(z8));
  inv1   g094(.a(x33), .O(new_n139_));
  oai21  g095(.a(x31), .b(new_n88_), .c(new_n102_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n120_), .c(new_n139_), .O(new_n141_));
  aoi21  g097(.a(new_n85_), .b(x31), .c(new_n45_), .O(new_n142_));
  nand2  g098(.a(new_n133_), .b(x33), .O(new_n143_));
  nor3   g099(.a(new_n143_), .b(new_n142_), .c(new_n140_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n130_), .c(new_n123_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n47_), .O(z9));
endmodule
