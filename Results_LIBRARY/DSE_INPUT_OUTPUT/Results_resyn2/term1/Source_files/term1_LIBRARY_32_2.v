...
module FAU ( 
  ...
  nor2   g035(.a(new_n79_), .b(x27), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n65_), .O(z3));
  nor2   g038(.a(new_n79_), .b(new_n46_), .O(new_n83_));
  and2   g039(.a(new_n83_), .b(new_n77_), .O(new_n84_));
  ...
  nand3  g058(.a(new_n102_), .b(new_n87_), .c(x29), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n101_), .c(new_n84_), .O(z7));
  inv1   g060(.a(x19), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x14), .O(new_n106_));
  nand3  g062(.a(x17), .b(x16), .c(x15), .O(new_n107_));
  inv1   g063(.a(x15), .O(new_n108_));
  nand3  g064(.a(x17), .b(x16), .c(x10), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n107_), .c(x19), .O(new_n111_));
  oai21  g067(.a(new_n107_), .b(new_n106_), .c(new_n111_), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  aoi21  g069(.a(new_n86_), .b(new_n85_), .c(new_n93_), .O(new_n114_));
  xor2a  g070(.a(new_n114_), .b(new_n97_), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g072(.a(x17), .b(x11), .O(new_n117_));
  oai21  g073(.a(x17), .b(x12), .c(x16), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n116_), .c(new_n112_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x32), .O(new_n121_));
  inv1   g077(.a(x32), .O(new_n122_));
  nand3  g078(.a(new_n105_), .b(x17), .c(x14), .O(new_n123_));
  inv1   g079(.a(x17), .O(new_n124_));
  nand3  g080(.a(x19), .b(new_n124_), .c(x12), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n123_), .c(new_n71_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x17), .c(new_n71_), .d(x11), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(x15), .O(new_n129_));
  inv1   g085(.a(new_n109_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x19), .c(new_n108_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n116_), .c(new_n122_), .O(new_n133_));
  nand3  g089(.a(new_n78_), .b(x18), .c(x00), .O(new_n134_));
  aoi21  g090(.a(new_n133_), .b(new_n121_), .c(new_n134_), .O(z8));
  nor2   g091(.a(x31), .b(x30), .O(new_n136_));
  aoi21  g092(.a(new_n114_), .b(x30), .c(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n89_), .b(new_n113_), .c(x29), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n119_), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n112_), .c(new_n53_), .O(new_n141_));
  nor2   g097(.a(new_n102_), .b(x33), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n115_), .O(new_n143_));
  aoi21  g099(.a(new_n131_), .b(new_n129_), .c(new_n143_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n141_), .c(new_n78_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(x18), .c(new_n45_), .O(z9));
endmodule
