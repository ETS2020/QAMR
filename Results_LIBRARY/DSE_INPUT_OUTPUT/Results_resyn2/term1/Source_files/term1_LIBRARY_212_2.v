...
module FAU ( 
  ...
  and2   g039(.a(new_n83_), .b(new_n61_), .O(new_n84_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n87_), .d(new_n84_), .O(new_n96_));
  ...
  nand3  g074(.a(new_n118_), .b(x19), .c(new_n74_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n116_), .c(new_n70_), .O(new_n120_));
  ...
  aoi22  g087(.a(new_n95_), .b(x29), .c(new_n53_), .d(new_n103_), .O(new_n132_));
  ...
  nand3  g100(.a(new_n85_), .b(new_n45_), .c(x00), .O(new_n145_));
