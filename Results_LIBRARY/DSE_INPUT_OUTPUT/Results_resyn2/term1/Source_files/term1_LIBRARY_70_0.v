...
module FAU ( 
  ...
  nand3  g031(.a(new_n58_), .b(new_n75_), .c(x25), .O(new_n76_));
  nor2   g032(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  ...
  nand2  g047(.a(new_n91_), .b(new_n56_), .O(z5));
  ...
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n77_), .O(new_n102_));
  and2   g058(.a(new_n102_), .b(new_n56_), .O(z7));
  ...
  nor2   g077(.a(x32), .b(new_n99_), .O(new_n122_));
  ...
  nand2  g101(.a(new_n75_), .b(x00), .O(new_n146_));
  ...
  nand2  g106(.a(new_n99_), .b(new_n95_), .O(new_n151_));
  ...
  aoi21  g110(.a(new_n108_), .b(new_n141_), .c(new_n48_), .O(new_n155_));
