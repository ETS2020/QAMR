...
module FAU ( 
  ...
  nand2  g026(.a(x25), .b(x01), .O(new_n71_));
  nor2   g027(.a(new_n71_), .b(x26), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  oai21  g029(.a(new_n73_), .b(new_n69_), .c(new_n47_), .O(z3));
  inv1   g030(.a(x28), .O(new_n75_));
  nor2   g031(.a(new_n75_), .b(new_n70_), .O(new_n76_));
  inv1   g032(.a(new_n76_), .O(new_n77_));
  nand2  g033(.a(new_n75_), .b(new_n70_), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(new_n69_), .c(new_n47_), .O(z4));
  nand2  g036(.a(new_n72_), .b(new_n64_), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  inv1   g038(.a(x29), .O(new_n83_));
  nand2  g039(.a(new_n77_), .b(new_n83_), .O(new_n84_));
  nand2  g040(.a(new_n76_), .b(x29), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nor2   g042(.a(new_n86_), .b(new_n46_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n84_), .c(new_n82_), .d(new_n68_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z5));
  nor2   g045(.a(new_n85_), .b(x19), .O(new_n90_));
  aoi21  g046(.a(new_n90_), .b(new_n82_), .c(x30), .O(new_n91_));
  nor2   g047(.a(new_n81_), .b(new_n67_), .O(new_n92_));
  nand2  g048(.a(new_n86_), .b(x30), .O(new_n93_));
  nand2  g049(.a(new_n85_), .b(new_n45_), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  oai21  g051(.a(new_n91_), .b(x24), .c(new_n95_), .O(z6));
  oai21  g052(.a(new_n93_), .b(new_n67_), .c(x31), .O(new_n97_));
  inv1   g053(.a(x31), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n45_), .O(new_n99_));
  oai21  g055(.a(new_n85_), .b(x31), .c(x24), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n97_), .c(new_n82_), .d(new_n68_), .O(z7));
  ...
  nand2  g096(.a(new_n140_), .b(new_n47_), .O(z8));
  inv1   g097(.a(x33), .O(new_n142_));
  xor2a  g098(.a(x31), .b(x30), .O(new_n143_));
  ...
  inv1   g102(.a(new_n104_), .O(new_n147_));
  nand4  g103(.a(new_n144_), .b(new_n136_), .c(new_n134_), .d(x33), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n132_), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n146_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n47_), .O(z9));
endmodule
