...
module FAU ( 
  ...
  aoi21  g032(.a(new_n75_), .b(new_n45_), .c(new_n76_), .O(new_n77_));
  ...
  oai21  g039(.a(new_n83_), .b(new_n78_), .c(new_n47_), .O(z3));
  oai21  g040(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n85_));
  aoi21  g041(.a(new_n85_), .b(new_n74_), .c(new_n46_), .O(new_n86_));
  inv1   g042(.a(x28), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n79_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n87_), .b(new_n79_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n86_), .d(new_n82_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z4));
  nor2   g048(.a(new_n81_), .b(new_n78_), .O(new_n93_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(new_n86_), .d(new_n82_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(z6));
  xor2a  g059(.a(new_n101_), .b(x31), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n93_), .c(new_n46_), .O(z7));
  ...
  nand2  g079(.a(new_n53_), .b(x31), .O(new_n124_));
  ...
  aoi22  g084(.a(new_n90_), .b(x29), .c(new_n53_), .d(new_n99_), .O(new_n129_));
  oai21  g085(.a(new_n125_), .b(new_n99_), .c(new_n129_), .O(new_n130_));
  inv1   g086(.a(x31), .O(new_n131_));
  nand2  g087(.a(new_n113_), .b(x14), .O(new_n132_));
  nand3  g088(.a(x17), .b(x16), .c(x15), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g090(.a(new_n133_), .b(x19), .O(new_n135_));
  aoi21  g091(.a(new_n121_), .b(new_n45_), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(x17), .b(x11), .O(new_n137_));
  oai21  g093(.a(x17), .b(x12), .c(x16), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  oai21  g095(.a(new_n136_), .b(new_n134_), .c(new_n139_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n131_), .c(x32), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n130_), .c(new_n128_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n108_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n111_), .O(z8));
  aoi21  g100(.a(new_n108_), .b(x33), .c(x15), .O(new_n145_));
  nand2  g101(.a(new_n123_), .b(new_n120_), .O(new_n146_));
  aoi21  g102(.a(x31), .b(x30), .c(new_n126_), .O(new_n147_));
  nand2  g103(.a(new_n131_), .b(new_n99_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n126_), .c(new_n147_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n146_), .c(x33), .O(new_n150_));
  nand2  g106(.a(new_n149_), .b(x33), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n140_), .c(new_n108_), .O(new_n152_));
  oai22  g108(.a(new_n152_), .b(new_n150_), .c(new_n145_), .d(x18), .O(z9));
endmodule
