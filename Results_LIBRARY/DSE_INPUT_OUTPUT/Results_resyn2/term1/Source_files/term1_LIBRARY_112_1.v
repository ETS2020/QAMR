...
module FAU ( 
  ...
  nand2  g060(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  xor2a  g061(.a(new_n105_), .b(new_n46_), .O(z7));
  ...
  aoi22  g087(.a(new_n91_), .b(x29), .c(new_n54_), .d(new_n99_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n136_), .b(new_n75_), .O(new_n137_));
  nand2  g093(.a(new_n75_), .b(x14), .O(new_n138_));
  ...
  aoi21  g114(.a(new_n156_), .b(new_n50_), .c(new_n158_), .O(z9));
endmodule
