...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n86_), .d(new_n48_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z5));
  nand3  g055(.a(new_n90_), .b(x30), .c(x29), .O(new_n100_));
  nand2  g056(.a(new_n97_), .b(new_n45_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n86_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n48_), .O(z6));
  nand3  g059(.a(new_n100_), .b(new_n86_), .c(new_n46_), .O(z7));
  nand3  g060(.a(new_n92_), .b(x31), .c(x29), .O(new_n105_));
  inv1   g061(.a(x17), .O(new_n106_));
  nand3  g062(.a(new_n76_), .b(x18), .c(x14), .O(new_n107_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n105_), .c(new_n55_), .O(new_n123_));
  nand2  g079(.a(new_n84_), .b(x00), .O(new_n124_));
  oai21  g080(.a(new_n116_), .b(x16), .c(x15), .O(new_n125_));
  inv1   g081(.a(x14), .O(new_n126_));
  nor2   g082(.a(x19), .b(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n119_), .b(x16), .c(x15), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n76_), .O(new_n129_));
  oai21  g085(.a(new_n128_), .b(new_n127_), .c(new_n129_), .O(new_n130_));
  aoi21  g086(.a(new_n125_), .b(new_n120_), .c(new_n130_), .O(new_n131_));
  inv1   g087(.a(x13), .O(new_n132_));
  nand2  g088(.a(new_n108_), .b(new_n132_), .O(new_n133_));
  aoi22  g089(.a(new_n133_), .b(x17), .c(x18), .d(x12), .O(new_n134_));
  nor3   g090(.a(new_n134_), .b(new_n105_), .c(new_n55_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n131_), .c(new_n124_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n123_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n48_), .O(z8));
  and2   g094(.a(new_n118_), .b(x15), .O(new_n139_));
  nand2  g095(.a(new_n92_), .b(x29), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n51_), .c(new_n46_), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n121_), .b(new_n139_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n125_), .b(new_n120_), .O(new_n144_));
  or2    g100(.a(new_n128_), .b(new_n127_), .O(new_n145_));
  nand2  g101(.a(new_n140_), .b(new_n46_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n134_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n129_), .d(new_n144_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(x33), .c(x30), .O(new_n149_));
  oai21  g105(.a(new_n51_), .b(x31), .c(x30), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n84_), .c(x00), .O(new_n151_));
  aoi21  g107(.a(new_n149_), .b(new_n143_), .c(new_n151_), .O(z9));
endmodule
