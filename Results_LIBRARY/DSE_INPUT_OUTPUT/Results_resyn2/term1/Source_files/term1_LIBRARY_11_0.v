...
module FAU ( 
  ...
  oai21  g061(.a(new_n105_), .b(x30), .c(x31), .O(new_n106_));
  aoi21  g062(.a(new_n105_), .b(x30), .c(new_n106_), .O(new_n107_));
  ...
  nor2   g073(.a(new_n112_), .b(new_n109_), .O(new_n118_));
  inv1   g074(.a(x11), .O(new_n119_));
  nor2   g075(.a(x16), .b(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n118_), .c(x19), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n117_), .c(new_n108_), .O(new_n122_));
  nand2  g078(.a(new_n118_), .b(x19), .O(new_n123_));
  nand3  g079(.a(x16), .b(new_n108_), .c(x10), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n122_), .c(new_n107_), .O(new_n126_));
  nand2  g082(.a(new_n79_), .b(x00), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand3  g084(.a(x18), .b(x17), .c(x10), .O(new_n129_));
  ...
  aoi21  g089(.a(new_n133_), .b(x15), .c(new_n130_), .O(new_n134_));
  nand3  g090(.a(x18), .b(x17), .c(x15), .O(new_n135_));
  ...
  nand3  g095(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand4  g096(.a(new_n120_), .b(x19), .c(x17), .d(x15), .O(new_n141_));
  oai21  g097(.a(new_n140_), .b(new_n134_), .c(new_n141_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n107_), .c(new_n45_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n53_), .c(new_n128_), .O(new_n144_));
  aoi21  g100(.a(new_n126_), .b(new_n53_), .c(new_n144_), .O(z8));
  aoi21  g101(.a(x31), .b(x30), .c(new_n104_), .O(new_n146_));
  inv1   g102(.a(x31), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n97_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n104_), .c(new_n146_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n142_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n46_), .c(x33), .O(new_n151_));
  nand2  g107(.a(new_n149_), .b(new_n49_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n125_), .b(new_n122_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n151_), .c(new_n127_), .O(z9));
endmodule
