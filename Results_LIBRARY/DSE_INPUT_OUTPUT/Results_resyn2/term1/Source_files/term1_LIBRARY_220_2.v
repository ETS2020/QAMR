...
module FAU ( 
  ...
  oai21  g025(.a(x24), .b(x19), .c(x23), .O(new_n70_));
  ...
  oai21  g035(.a(new_n79_), .b(new_n75_), .c(new_n58_), .O(z3));
  inv1   g036(.a(x28), .O(new_n81_));
  nor2   g037(.a(new_n81_), .b(new_n76_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n81_), .b(new_n76_), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n83_), .c(new_n78_), .d(new_n74_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n58_), .O(z4));
  nand2  g042(.a(new_n78_), .b(new_n51_), .O(new_n87_));
  nor3   g043(.a(new_n87_), .b(new_n73_), .c(new_n46_), .O(new_n88_));
  ...
  aoi21  g051(.a(new_n89_), .b(new_n95_), .c(new_n87_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n58_), .c(new_n73_), .O(z6));
  xor2a  g054(.a(new_n94_), .b(x31), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n88_), .O(z7));
  ...
  nor2   g100(.a(x26), .b(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n58_), .O(z8));
  aoi21  g103(.a(x31), .b(x30), .c(new_n123_), .O(new_n148_));
  nand2  g104(.a(new_n118_), .b(new_n95_), .O(new_n149_));
  ...
  aoi21  g108(.a(new_n45_), .b(new_n139_), .c(new_n55_), .O(new_n153_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n58_), .O(z9));
endmodule
