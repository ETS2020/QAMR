...
module FAU ( 
  ...
  nor2   g052(.a(new_n96_), .b(new_n45_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n95_), .c(new_n94_), .d(new_n89_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z4));
  nand2  g055(.a(new_n93_), .b(x29), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nor2   g057(.a(new_n93_), .b(x29), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n89_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(x31), .c(new_n45_), .O(z5));
  inv1   g061(.a(x30), .O(new_n106_));
  nand2  g062(.a(new_n100_), .b(new_n106_), .O(new_n107_));
  nand2  g063(.a(new_n101_), .b(x30), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n89_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x31), .c(new_n45_), .O(z6));
  oai21  g066(.a(new_n108_), .b(new_n88_), .c(x31), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x25), .O(z7));
  nand2  g068(.a(new_n95_), .b(x29), .O(new_n113_));
  ...
  aoi21  g092(.a(new_n136_), .b(x16), .c(new_n127_), .O(new_n137_));
  nand3  g093(.a(new_n130_), .b(x16), .c(x15), .O(new_n138_));
  aoi21  g094(.a(new_n117_), .b(x14), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n131_), .b(new_n116_), .O(new_n140_));
  nand2  g096(.a(new_n138_), .b(new_n117_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nor3   g098(.a(new_n142_), .b(new_n139_), .c(new_n137_), .O(new_n143_));
  nor3   g099(.a(new_n114_), .b(new_n53_), .c(new_n96_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n85_), .b(x00), .O(new_n146_));
  nand2  g102(.a(x32), .b(new_n45_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n96_), .c(new_n146_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  aoi21  g105(.a(new_n133_), .b(new_n53_), .c(new_n149_), .O(z8));
  nand2  g106(.a(new_n128_), .b(new_n124_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(x15), .c(new_n132_), .O(new_n152_));
  xor2a  g108(.a(new_n113_), .b(x31), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n114_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(new_n49_), .O(new_n155_));
  nand3  g111(.a(new_n153_), .b(new_n114_), .c(x33), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n143_), .c(new_n146_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n57_), .O(z9));
endmodule
