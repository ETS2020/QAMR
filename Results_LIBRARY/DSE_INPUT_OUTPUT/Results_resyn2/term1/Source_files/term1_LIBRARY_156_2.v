...
module FAU ( 
  ...
  nand3  g036(.a(new_n80_), .b(new_n46_), .c(new_n72_), .O(new_n81_));
  ...
  aoi21  g049(.a(new_n75_), .b(x18), .c(new_n89_), .O(new_n94_));
  aoi21  g050(.a(new_n76_), .b(x30), .c(new_n94_), .O(new_n95_));
  nand3  g051(.a(new_n84_), .b(x30), .c(x29), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n79_), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n95_), .c(new_n46_), .O(z6));
  inv1   g054(.a(x31), .O(new_n99_));
  nand3  g055(.a(new_n96_), .b(new_n46_), .c(new_n99_), .O(new_n100_));
  nand2  g056(.a(x31), .b(x30), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n89_), .c(new_n100_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n80_), .O(z7));
  ...
  nand3  g080(.a(new_n124_), .b(z0), .c(x31), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  oai21  g082(.a(new_n122_), .b(new_n119_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n124_), .b(x31), .O(new_n128_));
  nand3  g084(.a(new_n120_), .b(x16), .c(x15), .O(new_n129_));
  oai21  g085(.a(new_n117_), .b(x16), .c(x19), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  aoi21  g087(.a(x18), .b(x12), .c(x17), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n105_), .c(new_n121_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n109_), .b(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n136_), .c(new_n133_), .d(new_n131_), .O(new_n139_));
  nor2   g095(.a(new_n47_), .b(new_n54_), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(new_n128_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n127_), .c(new_n104_), .O(z8));
  nand2  g098(.a(new_n99_), .b(new_n45_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n101_), .c(new_n124_), .O(new_n144_));
  oai21  g100(.a(new_n122_), .b(new_n119_), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n50_), .O(new_n146_));
  inv1   g102(.a(new_n139_), .O(new_n147_));
  nand2  g103(.a(new_n144_), .b(x33), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n147_), .c(new_n104_), .O(new_n150_));
