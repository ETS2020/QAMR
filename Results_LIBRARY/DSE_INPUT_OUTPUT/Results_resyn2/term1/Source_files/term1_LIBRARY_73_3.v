...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n57_), .O(new_n90_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n82_), .c(new_n57_), .O(z5));
  nand2  g052(.a(new_n92_), .b(new_n45_), .O(new_n97_));
  nand3  g053(.a(new_n88_), .b(x30), .c(x29), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n82_), .c(new_n57_), .O(z6));
  xor2a  g056(.a(new_n98_), .b(x31), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n84_), .c(new_n47_), .O(z7));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n72_), .O(new_n108_));
  nand4  g064(.a(x19), .b(x18), .c(new_n72_), .d(x12), .O(new_n109_));
  ...
  nor2   g072(.a(new_n106_), .b(new_n72_), .O(new_n117_));
  ...
  aoi22  g084(.a(new_n87_), .b(x29), .c(new_n124_), .d(new_n45_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g086(.a(x18), .b(x12), .c(x17), .O(new_n131_));
  aoi21  g087(.a(new_n118_), .b(new_n103_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n134_), .b(new_n104_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n132_), .O(new_n138_));
  nand2  g094(.a(new_n113_), .b(new_n112_), .O(new_n139_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n138_), .c(x32), .O(new_n143_));
  ...
  oai22  g104(.a(new_n125_), .b(x30), .c(new_n119_), .d(new_n116_), .O(new_n149_));
  nand2  g105(.a(new_n46_), .b(x31), .O(new_n150_));
  nand4  g106(.a(new_n141_), .b(new_n139_), .c(x33), .d(new_n120_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n138_), .c(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n125_), .O(new_n153_));
  aoi21  g109(.a(new_n150_), .b(x30), .c(new_n145_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  aoi21  g111(.a(new_n149_), .b(new_n46_), .c(new_n155_), .O(z9));
endmodule
