...
module FAU ( 
  ...
  xor2a  g046(.a(new_n87_), .b(x29), .O(new_n91_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n82_), .d(x29), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z6));
  nand2  g053(.a(new_n95_), .b(x31), .O(new_n98_));
  nor2   g054(.a(x31), .b(new_n45_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n87_), .c(new_n46_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n82_), .O(z7));
  nand4  g057(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  inv1   g059(.a(x16), .O(new_n104_));
  nand3  g060(.a(x18), .b(x17), .c(x11), .O(new_n105_));
  ...
  nand2  g066(.a(new_n72_), .b(x14), .O(new_n111_));
  ...
  nand3  g071(.a(new_n115_), .b(new_n112_), .c(new_n110_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n107_), .c(new_n47_), .O(new_n117_));
  nand2  g073(.a(new_n86_), .b(x29), .O(new_n118_));
  ...
  nand3  g080(.a(new_n72_), .b(x18), .c(x14), .O(new_n125_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n104_), .c(x11), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(new_n113_), .O(new_n135_));
  nand3  g091(.a(x16), .b(new_n113_), .c(x10), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g093(.a(new_n45_), .b(new_n85_), .c(new_n69_), .O(new_n138_));
  nand2  g094(.a(new_n86_), .b(x30), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n138_), .c(x29), .O(new_n140_));
  nor3   g096(.a(new_n140_), .b(x32), .c(new_n120_), .O(new_n141_));
  oai21  g097(.a(new_n137_), .b(new_n135_), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n80_), .b(x00), .O(new_n143_));
  aoi21  g099(.a(new_n142_), .b(new_n123_), .c(new_n143_), .O(z8));
  nor2   g100(.a(new_n120_), .b(x30), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n99_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n49_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n119_), .O(new_n148_));
  oai21  g104(.a(new_n137_), .b(new_n135_), .c(new_n148_), .O(new_n149_));
  inv1   g105(.a(new_n107_), .O(new_n150_));
  inv1   g106(.a(new_n116_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n146_), .b(new_n140_), .O(new_n153_));
  nor2   g109(.a(new_n46_), .b(new_n49_), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n152_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n149_), .c(new_n143_), .O(z9));
endmodule
