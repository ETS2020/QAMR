...
module FAU ( 
  ...
  aoi22  g086(.a(new_n90_), .b(x29), .c(new_n54_), .d(new_n100_), .O(new_n131_));
  oai21  g087(.a(new_n127_), .b(new_n100_), .c(new_n131_), .O(new_n132_));
  ...
  xor2a  g104(.a(new_n128_), .b(new_n100_), .O(new_n149_));
