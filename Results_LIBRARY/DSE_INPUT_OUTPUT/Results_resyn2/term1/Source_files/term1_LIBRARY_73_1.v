...
module FAU ( 
  ...
  oai21  g038(.a(new_n82_), .b(x27), .c(new_n56_), .O(z3));
  ...
  nand4  g045(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n56_), .O(new_n90_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n82_), .c(new_n56_), .O(z5));
  ...
  oai21  g056(.a(new_n100_), .b(new_n82_), .c(new_n56_), .O(z6));
  xor2a  g057(.a(new_n97_), .b(x31), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n84_), .c(new_n46_), .O(z7));
  nand2  g059(.a(new_n79_), .b(x00), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand2  g061(.a(x18), .b(x17), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  inv1   g063(.a(x15), .O(new_n108_));
  nand3  g064(.a(x16), .b(new_n108_), .c(x10), .O(new_n109_));
  inv1   g065(.a(x16), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x15), .c(x11), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n107_), .O(new_n113_));
  nor2   g069(.a(new_n110_), .b(new_n108_), .O(new_n114_));
  inv1   g070(.a(x14), .O(new_n115_));
  nor2   g071(.a(x19), .b(new_n115_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n106_), .c(new_n114_), .O(new_n117_));
  ...
  nand2  g078(.a(new_n114_), .b(new_n107_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n118_), .c(x31), .O(new_n125_));
  aoi21  g081(.a(new_n86_), .b(new_n85_), .c(new_n93_), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n98_), .O(new_n128_));
  nand2  g084(.a(new_n126_), .b(x30), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n125_), .c(x32), .O(new_n131_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n72_), .O(new_n136_));
  nand4  g092(.a(x19), .b(x18), .c(new_n72_), .d(x12), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(x16), .O(new_n139_));
  nand4  g095(.a(new_n107_), .b(x19), .c(new_n110_), .d(x11), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nor3   g097(.a(new_n109_), .b(new_n106_), .c(new_n132_), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(x15), .c(new_n142_), .O(new_n143_));
  inv1   g099(.a(x32), .O(new_n144_));
  nand4  g100(.a(new_n129_), .b(new_n128_), .c(new_n144_), .d(x31), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n143_), .c(new_n131_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n105_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n56_), .O(z8));
  nor2   g104(.a(new_n45_), .b(new_n98_), .O(new_n149_));
  oai21  g105(.a(new_n127_), .b(new_n125_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n140_), .b(new_n139_), .c(new_n108_), .O(new_n151_));
  inv1   g107(.a(x31), .O(new_n152_));
  nand2  g108(.a(new_n129_), .b(x31), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n45_), .O(new_n154_));
  aoi21  g110(.a(new_n128_), .b(new_n152_), .c(new_n154_), .O(new_n155_));
  oai21  g111(.a(new_n142_), .b(new_n151_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n150_), .c(new_n104_), .O(z9));
endmodule
