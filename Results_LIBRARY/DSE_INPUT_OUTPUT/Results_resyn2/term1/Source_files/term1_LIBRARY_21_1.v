...
module FAU ( 
  ...
  nand3  g083(.a(x19), .b(x16), .c(x15), .O(new_n128_));
  ...
  nand2  g089(.a(x19), .b(x11), .O(new_n134_));
  oai21  g090(.a(x19), .b(x14), .c(x16), .O(new_n135_));
