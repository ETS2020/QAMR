...
module FAU ( 
  ...
  nand2  g036(.a(new_n60_), .b(x25), .O(new_n81_));
  ...
  nand2  g042(.a(new_n75_), .b(x26), .O(new_n87_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n88_), .c(new_n47_), .O(z4));
  ...
  inv1   g060(.a(new_n88_), .O(new_n105_));
  xor2a  g061(.a(new_n100_), .b(x31), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n46_), .O(z7));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n116_), .c(new_n73_), .O(new_n121_));
  ...
  aoi22  g088(.a(new_n92_), .b(x29), .c(new_n54_), .d(new_n101_), .O(new_n133_));
  oai21  g089(.a(new_n119_), .b(x16), .c(x15), .O(new_n134_));
  inv1   g090(.a(x14), .O(new_n135_));
  nor2   g091(.a(x19), .b(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n122_), .b(x16), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n109_), .O(new_n138_));
  oai21  g094(.a(new_n137_), .b(new_n136_), .c(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n134_), .b(new_n123_), .c(new_n139_), .O(new_n140_));
  aoi21  g096(.a(x18), .b(x12), .c(x17), .O(new_n141_));
  nor2   g097(.a(x18), .b(x13), .O(new_n142_));
  nor3   g098(.a(new_n142_), .b(new_n141_), .c(new_n125_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(new_n54_), .O(new_n144_));
  aoi21  g100(.a(new_n133_), .b(new_n132_), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n45_), .b(x00), .O(new_n146_));
  aoi21  g102(.a(new_n145_), .b(new_n131_), .c(new_n146_), .O(z8));
  ...
  nor3   g108(.a(new_n142_), .b(new_n141_), .c(new_n50_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n150_), .c(new_n140_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  aoi21  g111(.a(new_n151_), .b(new_n50_), .c(new_n155_), .O(z9));
endmodule
