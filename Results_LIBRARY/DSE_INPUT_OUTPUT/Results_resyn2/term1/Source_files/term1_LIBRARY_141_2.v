...
module FAU ( 
  ...
  nor2   g036(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n91_), .c(new_n81_), .d(new_n78_), .O(new_n93_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n95_), .c(new_n81_), .d(new_n78_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z6));
  inv1   g055(.a(new_n95_), .O(new_n100_));
  nand2  g056(.a(new_n77_), .b(x22), .O(new_n101_));
  ...
  aoi21  g061(.a(new_n77_), .b(x17), .c(new_n80_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n103_), .c(new_n46_), .O(z7));
  inv1   g065(.a(x32), .O(new_n110_));
  oai21  g066(.a(x28), .b(x27), .c(x29), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n96_), .O(new_n112_));
  nand2  g068(.a(new_n111_), .b(new_n96_), .O(new_n113_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(new_n115_), .O(new_n133_));
  nand4  g089(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n134_));
  nor2   g090(.a(new_n120_), .b(new_n117_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(x11), .c(x16), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n118_), .c(new_n134_), .O(new_n137_));
  nand2  g093(.a(x17), .b(x13), .O(new_n138_));
  oai21  g094(.a(x17), .b(x12), .c(x18), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  aoi21  g096(.a(new_n118_), .b(x14), .c(new_n134_), .O(new_n141_));
  nand3  g097(.a(new_n135_), .b(x16), .c(x10), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n116_), .c(new_n141_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n140_), .c(new_n137_), .O(new_n144_));
  nand2  g100(.a(new_n115_), .b(x32), .O(new_n145_));
  nand2  g101(.a(new_n79_), .b(x00), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n46_), .O(new_n147_));
  oai21  g103(.a(new_n145_), .b(new_n144_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n133_), .b(new_n110_), .c(new_n148_), .O(z8));
  nand3  g105(.a(new_n111_), .b(new_n104_), .c(new_n96_), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n112_), .b(x31), .c(new_n151_), .O(new_n152_));
  nor2   g108(.a(new_n46_), .b(new_n54_), .O(new_n153_));
  oai21  g109(.a(new_n152_), .b(new_n144_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n112_), .b(x31), .O(new_n155_));
  nand2  g111(.a(new_n151_), .b(new_n45_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(x33), .O(new_n157_));
  oai21  g113(.a(new_n132_), .b(new_n130_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n154_), .c(new_n146_), .O(z9));
endmodule
