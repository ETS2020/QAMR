...
module FAU ( 
  ...
  aoi21  g020(.a(new_n46_), .b(new_n52_), .c(new_n57_), .O(new_n65_));
  ...
  nand4  g036(.a(new_n64_), .b(new_n80_), .c(x25), .d(x01), .O(new_n81_));
  ...
  nand2  g057(.a(new_n101_), .b(new_n50_), .O(z6));
  ...
  nor3   g096(.a(new_n140_), .b(new_n139_), .c(new_n49_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(z0), .O(new_n142_));
  aoi21  g098(.a(new_n131_), .b(new_n130_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n80_), .b(x00), .O(new_n144_));
  aoi21  g100(.a(new_n143_), .b(new_n129_), .c(new_n144_), .O(z8));
  nand2  g101(.a(x31), .b(x30), .O(new_n146_));
  aoi21  g102(.a(new_n49_), .b(new_n98_), .c(new_n126_), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n126_), .c(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n122_), .b(new_n119_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n51_), .O(new_n150_));
  nor3   g106(.a(new_n140_), .b(new_n139_), .c(new_n51_), .O(new_n151_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n50_), .O(z9));
endmodule
