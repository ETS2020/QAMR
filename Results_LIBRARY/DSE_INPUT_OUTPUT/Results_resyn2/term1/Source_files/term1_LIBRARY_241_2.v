...
module FAU ( 
  ...
  aoi21  g041(.a(new_n85_), .b(x31), .c(new_n45_), .O(z4));
  ...
  aoi21  g046(.a(new_n90_), .b(x31), .c(new_n45_), .O(z5));
  ...
  aoi21  g051(.a(new_n95_), .b(x31), .c(new_n45_), .O(z6));
  inv1   g052(.a(x31), .O(new_n97_));
  nor3   g053(.a(new_n94_), .b(new_n97_), .c(new_n45_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n78_), .O(z7));
  oai21  g055(.a(x28), .b(x27), .c(x29), .O(new_n100_));
  xor2a  g056(.a(new_n100_), .b(new_n92_), .O(new_n101_));
