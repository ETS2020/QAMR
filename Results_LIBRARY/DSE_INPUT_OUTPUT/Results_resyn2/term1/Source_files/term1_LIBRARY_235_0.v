...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(x00), .c(x26), .O(z4));
  ...
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n82_), .O(new_n101_));
  ...
  nand2  g081(.a(new_n125_), .b(new_n99_), .O(new_n126_));
  ...
  aoi22  g086(.a(new_n90_), .b(x29), .c(new_n52_), .d(new_n99_), .O(new_n131_));
  ...
  aoi21  g102(.a(new_n131_), .b(new_n130_), .c(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n129_), .c(x26), .O(z8));
  aoi21  g104(.a(x31), .b(x30), .c(new_n127_), .O(new_n149_));
  nand2  g105(.a(new_n123_), .b(new_n99_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n127_), .c(new_n149_), .O(new_n151_));
  oai21  g107(.a(new_n122_), .b(new_n119_), .c(new_n151_), .O(new_n152_));
  nand4  g108(.a(new_n151_), .b(new_n143_), .c(new_n141_), .d(x33), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n139_), .c(new_n73_), .O(new_n154_));
  aoi21  g110(.a(new_n152_), .b(new_n48_), .c(new_n154_), .O(z9));
endmodule
