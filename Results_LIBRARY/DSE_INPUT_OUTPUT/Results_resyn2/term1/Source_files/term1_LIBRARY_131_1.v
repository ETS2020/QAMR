...
module FAU ( 
  ...
  nor3   g083(.a(new_n127_), .b(new_n78_), .c(x15), .O(new_n128_));
  aoi21  g084(.a(new_n125_), .b(x15), .c(new_n128_), .O(new_n129_));
  oai21  g085(.a(x28), .b(x27), .c(x29), .O(new_n130_));
  xor2a  g086(.a(new_n130_), .b(new_n45_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n54_), .c(x31), .O(new_n132_));
  ...
  nand2  g092(.a(new_n78_), .b(x14), .O(new_n137_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n129_), .c(new_n50_), .O(new_n151_));
