...
module FAU ( 
  ...
  nand3  g037(.a(new_n56_), .b(new_n81_), .c(x25), .O(new_n82_));
  ...
  oai21  g058(.a(new_n102_), .b(new_n84_), .c(new_n46_), .O(z6));
  ...
  nand3  g063(.a(new_n74_), .b(x18), .c(x14), .O(new_n108_));
  ...
  nor3   g077(.a(new_n121_), .b(new_n74_), .c(x15), .O(new_n122_));
  ...
  aoi22  g086(.a(new_n91_), .b(x29), .c(new_n51_), .d(new_n100_), .O(new_n131_));
  ...
  nand2  g091(.a(new_n135_), .b(new_n74_), .O(new_n136_));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(new_n51_), .O(new_n142_));
  aoi21  g098(.a(new_n131_), .b(new_n130_), .c(new_n142_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n45_), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n143_), .b(new_n129_), .c(new_n145_), .O(z8));
  aoi21  g102(.a(x31), .b(x30), .c(new_n127_), .O(new_n147_));
  nand2  g103(.a(new_n123_), .b(new_n100_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n127_), .c(new_n147_), .O(new_n149_));
  oai21  g105(.a(new_n122_), .b(new_n119_), .c(new_n149_), .O(new_n150_));
  nor3   g106(.a(new_n140_), .b(new_n139_), .c(new_n48_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n138_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  aoi21  g109(.a(new_n150_), .b(new_n48_), .c(new_n153_), .O(z9));
endmodule
