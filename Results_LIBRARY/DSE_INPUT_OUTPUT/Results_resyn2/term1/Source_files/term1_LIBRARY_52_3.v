...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n151_, new_n152_;
  nand2  g000(.a(x26), .b(x18), .O(new_n45_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n83_), .c(new_n45_), .O(z5));
  ...
  aoi22  g085(.a(new_n90_), .b(x29), .c(new_n50_), .d(new_n99_), .O(new_n130_));
  ...
  nand2  g101(.a(new_n122_), .b(new_n99_), .O(new_n146_));
  ...
  nor3   g105(.a(new_n139_), .b(new_n138_), .c(new_n47_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n147_), .c(new_n137_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  aoi21  g108(.a(new_n148_), .b(new_n47_), .c(new_n152_), .O(z9));
endmodule
