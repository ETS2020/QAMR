...
module FAU ( 
  ...
  oai21  g046(.a(new_n90_), .b(new_n83_), .c(new_n69_), .O(z4));
  ...
  oai21  g051(.a(new_n95_), .b(new_n83_), .c(new_n69_), .O(z5));
  ...
  nand2  g059(.a(new_n103_), .b(new_n97_), .O(z7));
  inv1   g060(.a(x15), .O(new_n105_));
  inv1   g061(.a(x17), .O(new_n106_));
  nand3  g062(.a(new_n73_), .b(x18), .c(x14), .O(new_n107_));
  ...
  nor3   g076(.a(new_n120_), .b(new_n73_), .c(x15), .O(new_n121_));
  nor2   g077(.a(x32), .b(new_n45_), .O(new_n122_));
  ...
  aoi21  g082(.a(new_n53_), .b(x30), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand3  g084(.a(new_n119_), .b(x16), .c(x15), .O(new_n129_));
  oai21  g085(.a(new_n116_), .b(x16), .c(x19), .O(new_n130_));
  ...
  aoi21  g090(.a(new_n73_), .b(x14), .c(new_n129_), .O(new_n135_));
  aoi21  g091(.a(new_n120_), .b(new_n105_), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n134_), .c(new_n131_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n45_), .c(x32), .O(new_n138_));
  nand2  g094(.a(new_n123_), .b(x30), .O(new_n139_));
  aoi21  g095(.a(new_n53_), .b(new_n98_), .c(new_n125_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n138_), .c(new_n128_), .O(new_n142_));
  nand2  g098(.a(new_n80_), .b(x00), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n69_), .O(z8));
  nor2   g102(.a(new_n45_), .b(new_n98_), .O(new_n147_));
  nor3   g103(.a(new_n125_), .b(x31), .c(x30), .O(new_n148_));
  aoi21  g104(.a(new_n147_), .b(new_n125_), .c(new_n148_), .O(new_n149_));
  nor2   g105(.a(new_n46_), .b(new_n49_), .O(new_n150_));
  oai21  g106(.a(new_n149_), .b(new_n137_), .c(new_n150_), .O(new_n151_));
  or2    g107(.a(new_n121_), .b(new_n118_), .O(new_n152_));
  or2    g108(.a(new_n148_), .b(x25), .O(new_n153_));
  nor2   g109(.a(new_n149_), .b(x33), .O(new_n154_));
