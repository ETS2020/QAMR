...
module FAU ( 
  ...
  nand3  g037(.a(new_n81_), .b(x31), .c(new_n45_), .O(new_n82_));
  ...
  aoi21  g046(.a(new_n90_), .b(x31), .c(x26), .O(z4));
  ...
  oai21  g077(.a(new_n121_), .b(x30), .c(new_n52_), .O(new_n122_));
  nand2  g078(.a(new_n89_), .b(x29), .O(new_n123_));
  aoi21  g079(.a(x32), .b(new_n97_), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g081(.a(x32), .b(new_n97_), .O(new_n126_));
  nand2  g082(.a(new_n52_), .b(x30), .O(new_n127_));
  ...
  aoi21  g088(.a(new_n132_), .b(x16), .c(new_n115_), .O(new_n133_));
  ...
  nand2  g094(.a(new_n119_), .b(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n135_), .b(new_n105_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n139_), .c(new_n137_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n133_), .c(x32), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n129_), .c(new_n125_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x00), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(x31), .c(x26), .O(z8));
  nand3  g101(.a(new_n89_), .b(x30), .c(x29), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n121_), .c(new_n49_), .O(new_n147_));
  nor2   g103(.a(new_n141_), .b(new_n133_), .O(new_n148_));
  nor2   g104(.a(new_n146_), .b(new_n49_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n147_), .c(x00), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(x31), .c(x26), .O(z9));
endmodule
