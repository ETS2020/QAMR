...
module FAU ( 
  ...
  nand2  g032(.a(new_n58_), .b(x25), .O(new_n77_));
  aoi21  g033(.a(new_n76_), .b(new_n72_), .c(new_n77_), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n69_), .c(x00), .O(new_n79_));
  ...
  nand3  g042(.a(new_n86_), .b(new_n84_), .c(new_n78_), .O(new_n87_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n89_), .c(new_n78_), .O(new_n92_));
  aoi21  g048(.a(new_n92_), .b(x00), .c(x26), .O(z5));
  ...
  nand2  g055(.a(new_n99_), .b(new_n78_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(x00), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n69_), .O(z7));
  ...
  aoi21  g084(.a(new_n83_), .b(new_n68_), .c(new_n90_), .O(new_n129_));
  ...
  aoi21  g104(.a(new_n121_), .b(new_n95_), .c(new_n129_), .O(new_n149_));
