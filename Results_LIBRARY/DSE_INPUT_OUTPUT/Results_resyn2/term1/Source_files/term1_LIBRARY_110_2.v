...
module FAU ( 
  ...
  oai21  g043(.a(new_n77_), .b(new_n76_), .c(new_n45_), .O(new_n88_));
  inv1   g044(.a(new_n72_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n47_), .O(new_n90_));
  aoi21  g046(.a(new_n88_), .b(new_n75_), .c(new_n90_), .O(new_n91_));
  inv1   g047(.a(x29), .O(new_n92_));
  nand2  g048(.a(new_n84_), .b(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n83_), .b(x29), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z5));
  inv1   g052(.a(x30), .O(new_n97_));
  xor2a  g053(.a(new_n94_), .b(new_n97_), .O(new_n98_));
  ...
  nor3   g059(.a(new_n103_), .b(new_n102_), .c(new_n94_), .O(new_n104_));
  aoi21  g060(.a(new_n94_), .b(x31), .c(new_n104_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n79_), .c(new_n46_), .O(z7));
  inv1   g062(.a(x19), .O(new_n107_));
  nand2  g063(.a(new_n71_), .b(x00), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n51_), .c(new_n45_), .O(new_n109_));
  ...
  nand4  g070(.a(x19), .b(new_n45_), .c(x17), .d(x13), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n112_), .O(new_n116_));
  nand4  g072(.a(x18), .b(x17), .c(new_n112_), .d(x11), .O(new_n117_));
  ...
  nand4  g077(.a(new_n121_), .b(x18), .c(x17), .d(new_n120_), .O(new_n122_));
  nand2  g078(.a(new_n51_), .b(x31), .O(new_n123_));
  aoi21  g079(.a(new_n122_), .b(new_n119_), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n85_), .b(x29), .O(new_n125_));
  aoi21  g081(.a(new_n51_), .b(x30), .c(new_n125_), .O(new_n126_));
  oai21  g082(.a(new_n124_), .b(x30), .c(new_n126_), .O(new_n127_));
  inv1   g083(.a(new_n125_), .O(new_n128_));
  aoi21  g084(.a(new_n51_), .b(new_n97_), .c(new_n128_), .O(new_n129_));
  oai21  g085(.a(new_n124_), .b(new_n97_), .c(new_n129_), .O(new_n130_));
  nand3  g086(.a(x18), .b(x16), .c(x15), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  inv1   g088(.a(new_n121_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n45_), .c(new_n120_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(x17), .c(new_n132_), .O(new_n135_));
  nor2   g091(.a(x16), .b(x11), .O(new_n136_));
  nand2  g092(.a(x16), .b(x13), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(new_n45_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n113_), .b(x12), .O(new_n139_));
  nand2  g095(.a(new_n132_), .b(new_n139_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n138_), .c(x31), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n135_), .c(x32), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n130_), .c(new_n127_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n111_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n110_), .O(z8));
  nand2  g101(.a(x33), .b(new_n97_), .O(new_n146_));
  nand3  g102(.a(new_n121_), .b(x17), .c(new_n120_), .O(new_n147_));
  nand3  g103(.a(x17), .b(new_n112_), .c(x11), .O(new_n148_));
  nand3  g104(.a(new_n113_), .b(x16), .c(x12), .O(new_n149_));
  ...
  nor2   g108(.a(x33), .b(new_n45_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(new_n102_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n146_), .c(new_n107_), .O(new_n155_));
  inv1   g111(.a(x33), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  nand3  g113(.a(x19), .b(x17), .c(x13), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n102_), .c(new_n156_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n146_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n45_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n128_), .O(new_n163_));
  nand2  g119(.a(x33), .b(x30), .O(new_n164_));
  nand3  g120(.a(new_n153_), .b(new_n152_), .c(new_n103_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n164_), .c(new_n107_), .O(new_n166_));
  nand3  g122(.a(new_n159_), .b(new_n103_), .c(new_n156_), .O(new_n167_));
  ...
  oai22  g126(.a(new_n170_), .b(new_n166_), .c(new_n163_), .d(new_n155_), .O(new_n171_));
  oai21  g127(.a(new_n158_), .b(new_n157_), .c(new_n45_), .O(new_n172_));
  nor2   g128(.a(new_n103_), .b(new_n102_), .O(new_n173_));
  nor2   g129(.a(new_n136_), .b(new_n173_), .O(new_n174_));
  aoi22  g130(.a(new_n157_), .b(new_n113_), .c(new_n133_), .d(new_n120_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n174_), .c(new_n172_), .d(new_n140_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n47_), .c(x33), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n171_), .c(new_n108_), .O(z9));
endmodule
