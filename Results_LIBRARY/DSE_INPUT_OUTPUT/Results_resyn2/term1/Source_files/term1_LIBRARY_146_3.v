...
module FAU ( 
  ...
  oai21  g32(.a(new_n75_), .b(x15), .c(new_n76_), .O(new_n77_));
  inv1   g33(.a(x15), .O(new_n78_));
  inv1   g34(.a(x20), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g36(.a(new_n80_), .b(new_n77_), .c(new_n74_), .O(new_n81_));
  inv1   g37(.a(x26), .O(new_n82_));
  nand3  g38(.a(new_n58_), .b(new_n82_), .c(x25), .O(new_n83_));
  inv1   g39(.a(new_n83_), .O(new_n84_));
  nand3  g40(.a(new_n84_), .b(new_n81_), .c(new_n71_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n45_), .O(z3));
  oai21  g42(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(new_n87_));
  aoi22  g43(.a(new_n76_), .b(new_n75_), .c(new_n79_), .d(new_n78_), .O(new_n88_));
  inv1   g44(.a(x28), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n71_), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(new_n91_));
  nand2  g47(.a(new_n89_), .b(new_n71_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n84_), .O(new_n93_));
  aoi21  g49(.a(new_n88_), .b(new_n87_), .c(new_n93_), .O(z4));
  nand2  g50(.a(new_n90_), .b(x29), .O(new_n95_));
  inv1   g51(.a(x29), .O(new_n96_));
  nand2  g52(.a(new_n91_), .b(new_n96_), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n95_), .c(new_n84_), .d(new_n81_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n45_), .O(z5));
  aoi21  g55(.a(new_n88_), .b(new_n74_), .c(new_n83_), .O(new_n100_));
  ...
  nand3  g63(.a(new_n92_), .b(x30), .c(x29), .O(new_n108_));
  nand2  g64(.a(x18), .b(x10), .O(new_n109_));
  nand2  g65(.a(x15), .b(x13), .O(new_n110_));
  nand3  g66(.a(x19), .b(x17), .c(x16), .O(new_n111_));
  aoi21  g67(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(new_n112_));
  oai21  g68(.a(x28), .b(x27), .c(x29), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n102_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n112_), .c(new_n108_), .d(x31), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n53_), .O(new_n116_));
  and2   g72(.a(new_n114_), .b(new_n112_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n108_), .c(x32), .d(x31), .O(new_n118_));
  inv1   g74(.a(x00), .O(new_n119_));
  nor2   g75(.a(x26), .b(new_n119_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n118_), .c(new_n116_), .d(new_n45_), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(z8));
  inv1   g78(.a(x31), .O(new_n123_));
  nand3  g79(.a(new_n113_), .b(new_n123_), .c(new_n102_), .O(new_n124_));
  nand4  g80(.a(new_n92_), .b(x31), .c(x30), .d(x29), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand3  g82(.a(x18), .b(new_n78_), .c(x10), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n110_), .c(new_n111_), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n126_), .c(new_n49_), .O(new_n129_));
  nand2  g85(.a(new_n112_), .b(new_n49_), .O(new_n130_));
  aoi21  g86(.a(new_n125_), .b(new_n124_), .c(new_n130_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n129_), .c(new_n120_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n45_), .O(z9));
endmodule
