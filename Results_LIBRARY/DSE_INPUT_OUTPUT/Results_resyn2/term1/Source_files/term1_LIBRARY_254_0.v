...
module FAU ( 
  ...
  nor3   g037(.a(new_n81_), .b(new_n80_), .c(new_n51_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n70_), .O(new_n83_));
  aoi21  g039(.a(new_n83_), .b(x00), .c(x26), .O(z3));
  ...
  aoi21  g045(.a(new_n89_), .b(x00), .c(x26), .O(z4));
  inv1   g046(.a(x00), .O(new_n91_));
  nor2   g047(.a(x26), .b(new_n91_), .O(new_n92_));
  ...
  nand2  g052(.a(new_n86_), .b(x29), .O(new_n97_));
  ...
  nand3  g058(.a(new_n102_), .b(new_n100_), .c(new_n82_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(x00), .c(x26), .O(z6));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(new_n48_), .O(new_n145_));
  aoi21  g101(.a(new_n134_), .b(new_n132_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n131_), .c(new_n107_), .O(z8));
  aoi21  g103(.a(x31), .b(x30), .c(new_n129_), .O(new_n148_));
  nand2  g104(.a(new_n125_), .b(new_n101_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n129_), .c(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n124_), .b(new_n121_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n55_), .O(new_n152_));
  nor3   g108(.a(new_n143_), .b(new_n142_), .c(new_n55_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n150_), .c(new_n141_), .O(new_n154_));
