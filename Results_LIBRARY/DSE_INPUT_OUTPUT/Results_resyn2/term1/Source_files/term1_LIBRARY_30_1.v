...
module FAU ( 
  ...
  nand4  g034(.a(new_n48_), .b(new_n45_), .c(x25), .d(x01), .O(new_n79_));
  inv1   g035(.a(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(x27), .c(new_n57_), .O(z3));
  ...
  oai21  g044(.a(new_n88_), .b(new_n81_), .c(new_n57_), .O(z4));
  ...
  oai21  g049(.a(new_n93_), .b(new_n81_), .c(new_n57_), .O(z5));
  ...
  oai21  g054(.a(new_n98_), .b(new_n81_), .c(new_n57_), .O(z6));
  xor2a  g055(.a(new_n95_), .b(x31), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n80_), .c(new_n78_), .O(z7));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n72_), .O(new_n107_));
  nand4  g063(.a(x19), .b(x18), .c(new_n72_), .d(x12), .O(new_n108_));
  ...
  nor2   g071(.a(new_n105_), .b(new_n72_), .O(new_n116_));
  ...
  nand2  g105(.a(new_n119_), .b(new_n96_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n124_), .c(new_n149_), .O(new_n151_));
  oai21  g107(.a(new_n118_), .b(new_n115_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n54_), .O(new_n153_));
  aoi21  g109(.a(new_n105_), .b(new_n140_), .c(new_n54_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n151_), .c(new_n139_), .d(new_n137_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n153_), .c(new_n146_), .O(new_n156_));
