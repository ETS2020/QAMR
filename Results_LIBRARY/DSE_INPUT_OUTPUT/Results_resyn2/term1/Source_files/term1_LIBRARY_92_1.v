...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n90_), .c(new_n87_), .d(new_n47_), .O(new_n93_));
  ...
  oai21  g054(.a(new_n98_), .b(new_n85_), .c(new_n47_), .O(z5));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n87_), .c(new_n46_), .O(z7));
  ...
  aoi21  g090(.a(new_n54_), .b(new_n102_), .c(new_n134_), .O(new_n135_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n45_), .c(new_n111_), .O(new_n145_));
  ...
  nand4  g113(.a(new_n157_), .b(new_n106_), .c(new_n50_), .d(x19), .O(new_n158_));
  ...
  nand2  g119(.a(new_n50_), .b(x18), .O(new_n164_));
  aoi21  g120(.a(new_n163_), .b(new_n125_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n106_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n155_), .c(new_n67_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n159_), .c(new_n130_), .O(new_n168_));
  nor2   g124(.a(new_n50_), .b(x30), .O(new_n169_));
  nand3  g125(.a(new_n104_), .b(new_n50_), .c(x19), .O(new_n170_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n67_), .c(new_n172_), .O(new_n174_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n175_), .c(x09), .O(new_n178_));
  nand3  g134(.a(new_n157_), .b(new_n107_), .c(x19), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n45_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n178_), .c(new_n50_), .O(new_n181_));
