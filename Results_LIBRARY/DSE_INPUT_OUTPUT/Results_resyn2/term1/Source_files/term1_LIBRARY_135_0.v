...
module FAU ( 
  ...
  nand2  g040(.a(new_n82_), .b(new_n68_), .O(new_n85_));
  nand3  g041(.a(new_n85_), .b(new_n84_), .c(new_n79_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n69_), .O(z4));
  ...
  nand2  g047(.a(new_n91_), .b(new_n69_), .O(z5));
  ...
  nand2  g052(.a(new_n96_), .b(new_n69_), .O(z6));
  xor2a  g053(.a(new_n93_), .b(x31), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n79_), .c(new_n45_), .O(z7));
  nand2  g055(.a(new_n77_), .b(x00), .O(new_n100_));
  ...
  nor3   g072(.a(new_n113_), .b(new_n112_), .c(x15), .O(new_n117_));
  nand2  g073(.a(new_n85_), .b(x29), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(x30), .O(new_n119_));
  oai21  g075(.a(new_n117_), .b(new_n116_), .c(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n118_), .b(new_n117_), .c(x30), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n120_), .c(new_n101_), .O(new_n122_));
  nand3  g078(.a(new_n118_), .b(x30), .c(x15), .O(new_n123_));
  aoi21  g079(.a(new_n115_), .b(new_n111_), .c(new_n123_), .O(new_n124_));
  ...
  nor2   g083(.a(new_n106_), .b(new_n103_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x16), .O(new_n129_));
  nand2  g085(.a(new_n128_), .b(x11), .O(new_n130_));
  ...
  nand3  g093(.a(new_n128_), .b(x16), .c(x15), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n104_), .O(new_n139_));
  oai21  g095(.a(new_n138_), .b(new_n137_), .c(new_n139_), .O(new_n140_));
  aoi21  g096(.a(new_n135_), .b(new_n129_), .c(new_n140_), .O(new_n141_));
  aoi21  g097(.a(new_n102_), .b(new_n101_), .c(new_n94_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n118_), .c(new_n119_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n125_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n69_), .c(x32), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n127_), .c(new_n100_), .O(z8));
  nor2   g103(.a(new_n117_), .b(new_n116_), .O(new_n148_));
  nand2  g104(.a(new_n117_), .b(x30), .O(new_n149_));
  nand3  g105(.a(new_n118_), .b(new_n125_), .c(new_n94_), .O(new_n150_));
  nand3  g106(.a(new_n85_), .b(x31), .c(x29), .O(new_n151_));
  oai22  g107(.a(new_n151_), .b(new_n149_), .c(new_n150_), .d(new_n148_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x10), .O(new_n153_));
  nand2  g109(.a(new_n115_), .b(new_n111_), .O(new_n154_));
  nor3   g110(.a(new_n151_), .b(new_n94_), .c(new_n102_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(x33), .O(new_n156_));
  inv1   g112(.a(new_n100_), .O(new_n157_));
  inv1   g113(.a(new_n142_), .O(new_n158_));
  oai21  g114(.a(new_n151_), .b(new_n158_), .c(new_n150_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n141_), .c(new_n45_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n48_), .c(new_n157_), .O(new_n161_));
  aoi21  g117(.a(new_n156_), .b(new_n153_), .c(new_n161_), .O(z9));
endmodule
