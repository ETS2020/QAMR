...
module FAU ( 
  ...
  nand3  g034(.a(new_n61_), .b(new_n45_), .c(x25), .O(new_n79_));
  ...
  aoi22  g083(.a(new_n86_), .b(x29), .c(new_n54_), .d(new_n94_), .O(new_n128_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n48_), .O(z8));
  aoi21  g104(.a(x31), .b(x30), .c(new_n124_), .O(new_n149_));
  nand2  g105(.a(new_n120_), .b(new_n94_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n152_), .b(new_n46_), .c(new_n154_), .O(z9));
endmodule
