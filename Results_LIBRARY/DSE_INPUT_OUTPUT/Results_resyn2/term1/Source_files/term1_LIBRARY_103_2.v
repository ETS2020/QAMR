...
module FAU ( 
  ...
  and2   g037(.a(new_n81_), .b(new_n62_), .O(new_n82_));
  nor2   g038(.a(x26), .b(new_n60_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n82_), .c(new_n71_), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(x31), .c(new_n70_), .O(z3));
  inv1   g041(.a(x28), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n71_), .O(new_n87_));
  nor2   g043(.a(new_n86_), .b(new_n71_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n87_), .c(new_n83_), .d(new_n82_), .O(new_n90_));
  aoi21  g046(.a(new_n90_), .b(x31), .c(new_n70_), .O(z4));
  nand2  g047(.a(new_n88_), .b(x29), .O(new_n92_));
  inv1   g048(.a(x29), .O(new_n93_));
  nand2  g049(.a(new_n89_), .b(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n92_), .c(new_n83_), .d(new_n82_), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(x31), .c(new_n70_), .O(z5));
  nand4  g052(.a(new_n83_), .b(new_n82_), .c(x31), .d(x25), .O(new_n97_));
  ...
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n98_), .O(new_n102_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n54_), .c(new_n70_), .O(new_n109_));
  ...
  oai21  g069(.a(new_n113_), .b(x16), .c(x19), .O(new_n114_));
  ...
  aoi21  g075(.a(new_n75_), .b(x14), .c(new_n111_), .O(new_n120_));
  nand4  g076(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n119_), .c(new_n120_), .O(new_n122_));
  ...
  nand3  g081(.a(new_n87_), .b(x30), .c(x29), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n123_), .c(x32), .O(new_n128_));
  inv1   g084(.a(x17), .O(new_n129_));
  nand3  g085(.a(new_n75_), .b(x18), .c(x14), .O(new_n130_));
  ...
  nand3  g093(.a(new_n113_), .b(x19), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nor3   g095(.a(new_n121_), .b(new_n75_), .c(x15), .O(new_n140_));
  aoi21  g096(.a(new_n139_), .b(x15), .c(new_n140_), .O(new_n141_));
  and2   g097(.a(new_n126_), .b(x31), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n125_), .c(new_n54_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n141_), .c(new_n128_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n107_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n110_), .O(z8));
  aoi21  g102(.a(new_n138_), .b(new_n136_), .c(new_n119_), .O(new_n147_));
  aoi21  g103(.a(new_n124_), .b(new_n99_), .c(x31), .O(new_n148_));
  nand2  g104(.a(new_n46_), .b(new_n50_), .O(new_n149_));
  nor3   g105(.a(new_n149_), .b(new_n148_), .c(new_n142_), .O(new_n150_));
  oai21  g106(.a(new_n140_), .b(new_n147_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n123_), .b(new_n46_), .O(new_n152_));
  aoi21  g108(.a(new_n148_), .b(new_n70_), .c(new_n142_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x33), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n151_), .c(new_n108_), .O(z9));
endmodule
