...
module FAU ( 
  ...
  aoi21  g036(.a(new_n77_), .b(x27), .c(new_n80_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n47_), .O(z3));
  ...
  aoi22  g043(.a(new_n87_), .b(new_n74_), .c(new_n76_), .d(x28), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n80_), .c(new_n47_), .O(z4));
  nand2  g045(.a(new_n85_), .b(x29), .O(new_n90_));
  inv1   g046(.a(x29), .O(new_n91_));
  oai21  g047(.a(new_n84_), .b(new_n45_), .c(new_n91_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n90_), .c(new_n74_), .d(new_n47_), .O(new_n93_));
  nand3  g049(.a(new_n76_), .b(x29), .c(new_n45_), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(new_n93_), .c(new_n80_), .O(z5));
  inv1   g051(.a(x30), .O(new_n96_));
  nand2  g052(.a(new_n90_), .b(new_n96_), .O(new_n97_));
  nand2  g053(.a(new_n85_), .b(new_n91_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(x30), .c(x28), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n97_), .c(new_n74_), .d(x24), .O(new_n100_));
  nand3  g056(.a(new_n78_), .b(x30), .c(new_n45_), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n100_), .c(new_n80_), .O(z6));
  inv1   g058(.a(new_n80_), .O(new_n103_));
  nor2   g059(.a(new_n46_), .b(x31), .O(new_n104_));
  oai21  g060(.a(new_n90_), .b(new_n96_), .c(new_n104_), .O(new_n105_));
  nand3  g061(.a(x31), .b(x30), .c(x24), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n90_), .c(new_n105_), .O(new_n107_));
  oai21  g063(.a(new_n77_), .b(x31), .c(new_n75_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n103_), .O(z7));
  ...
  nand2  g086(.a(new_n130_), .b(new_n96_), .O(new_n131_));
  nor2   g087(.a(new_n86_), .b(new_n91_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n51_), .b(x30), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g091(.a(new_n130_), .b(x30), .O(new_n136_));
  aoi21  g092(.a(new_n51_), .b(new_n96_), .c(new_n132_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n138_), .c(new_n135_), .O(new_n152_));
  nand2  g108(.a(new_n79_), .b(x00), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n47_), .O(z8));
  inv1   g112(.a(x33), .O(new_n157_));
  nand2  g113(.a(x31), .b(x30), .O(new_n158_));
  aoi21  g114(.a(new_n128_), .b(new_n96_), .c(new_n132_), .O(new_n159_));
  aoi21  g115(.a(new_n132_), .b(new_n158_), .c(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n127_), .b(new_n124_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  aoi21  g118(.a(new_n114_), .b(new_n148_), .c(new_n157_), .O(new_n163_));
