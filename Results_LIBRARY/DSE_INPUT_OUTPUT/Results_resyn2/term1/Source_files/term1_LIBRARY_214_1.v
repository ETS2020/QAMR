...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n81_), .c(new_n67_), .O(z4));
  ...
  oai21  g049(.a(new_n93_), .b(new_n81_), .c(new_n67_), .O(z5));
  xor2a  g050(.a(new_n90_), .b(x30), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n81_), .c(new_n67_), .O(z6));
  xor2a  g052(.a(x31), .b(x30), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n85_), .c(x29), .O(new_n98_));
  nand2  g054(.a(new_n90_), .b(x31), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n98_), .c(new_n80_), .d(new_n77_), .O(z7));
  inv1   g056(.a(x32), .O(new_n101_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n71_), .O(new_n107_));
  nand4  g063(.a(x19), .b(x18), .c(new_n71_), .d(x12), .O(new_n108_));
  ...
  xor2a  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n45_), .O(new_n120_));
  oai21  g076(.a(new_n117_), .b(new_n115_), .c(new_n120_), .O(new_n121_));
  ...
  aoi21  g081(.a(new_n125_), .b(x16), .c(new_n113_), .O(new_n126_));
  ...
  nand2  g086(.a(new_n116_), .b(new_n102_), .O(new_n131_));
  nand2  g087(.a(new_n128_), .b(new_n103_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n131_), .c(new_n130_), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n126_), .O(new_n134_));
  nor2   g090(.a(new_n119_), .b(new_n101_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n134_), .c(new_n122_), .O(new_n136_));
  nand2  g092(.a(new_n78_), .b(x00), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  oai21  g094(.a(new_n136_), .b(new_n45_), .c(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n121_), .b(new_n101_), .c(new_n139_), .O(z8));
  inv1   g096(.a(new_n97_), .O(new_n141_));
  and2   g097(.a(new_n119_), .b(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n117_), .b(new_n115_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n53_), .O(new_n144_));
  nand2  g100(.a(new_n142_), .b(x33), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n134_), .c(new_n137_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n67_), .O(z9));
endmodule
