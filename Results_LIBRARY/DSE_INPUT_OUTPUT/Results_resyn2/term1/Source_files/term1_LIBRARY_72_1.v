...
module FAU ( 
  ...
  oai21  g027(.a(x20), .b(x15), .c(x23), .O(new_n72_));
  nor2   g028(.a(x24), .b(x19), .O(new_n73_));
  nor2   g029(.a(x22), .b(x17), .O(new_n74_));
  nor2   g030(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  oai21  g031(.a(x21), .b(x16), .c(new_n75_), .O(new_n76_));
  aoi21  g032(.a(new_n72_), .b(new_n45_), .c(new_n76_), .O(new_n77_));
  ...
  nor2   g056(.a(new_n96_), .b(x31), .O(new_n101_));
  nand2  g057(.a(new_n96_), .b(x31), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n80_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(new_n47_), .O(new_n104_));
  inv1   g060(.a(x15), .O(new_n105_));
  inv1   g061(.a(x20), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(x18), .c(new_n105_), .O(new_n107_));
  oai21  g063(.a(x23), .b(x18), .c(new_n107_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n76_), .c(new_n104_), .O(z7));
  inv1   g065(.a(x19), .O(new_n110_));
  nand2  g066(.a(x17), .b(x16), .O(new_n111_));
  aoi22  g067(.a(x17), .b(x11), .c(x16), .d(x12), .O(new_n112_));
  ...
  and2   g079(.a(x15), .b(x13), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(x31), .d(x19), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n122_), .c(new_n45_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n110_), .b(x18), .c(x14), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x17), .O(new_n133_));
  inv1   g089(.a(x17), .O(new_n134_));
  nand4  g090(.a(x19), .b(x18), .c(new_n134_), .d(x12), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n129_), .O(new_n136_));
  nand2  g092(.a(x17), .b(x11), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(x16), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x19), .c(x18), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand3  g096(.a(new_n54_), .b(x31), .c(x15), .O(new_n141_));
  ...
  nand4  g104(.a(x19), .b(new_n45_), .c(x15), .d(x13), .O(new_n149_));
  ...
  nand2  g113(.a(x17), .b(x13), .O(new_n158_));
  oai21  g114(.a(x17), .b(x12), .c(x18), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g116(.a(new_n117_), .b(new_n110_), .O(new_n161_));
  oai21  g117(.a(new_n137_), .b(new_n45_), .c(new_n129_), .O(new_n162_));
