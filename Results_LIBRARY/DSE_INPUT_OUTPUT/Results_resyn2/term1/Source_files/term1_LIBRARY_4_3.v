...
module FAU ( 
  ...
  nand2  g045(.a(new_n89_), .b(new_n48_), .O(z4));
  ...
  nand3  g061(.a(new_n105_), .b(new_n104_), .c(new_n82_), .O(new_n106_));
  xor2a  g062(.a(new_n106_), .b(new_n47_), .O(z7));
  inv1   g063(.a(x00), .O(new_n108_));
  nand3  g064(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  and2   g066(.a(x16), .b(x10), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n110_), .c(x15), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n88_), .b(x29), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x30), .O(new_n116_));
  aoi21  g072(.a(new_n114_), .b(new_n96_), .c(new_n100_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n116_), .c(new_n113_), .O(new_n118_));
  ...
  aoi22  g081(.a(new_n125_), .b(x16), .c(new_n122_), .d(x11), .O(new_n126_));
  nand2  g082(.a(new_n122_), .b(x16), .O(new_n127_));
  inv1   g083(.a(x19), .O(new_n128_));
  nand2  g084(.a(new_n127_), .b(new_n128_), .O(new_n129_));
  inv1   g085(.a(x14), .O(new_n130_));
  nor2   g086(.a(x19), .b(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n127_), .c(new_n129_), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n126_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n45_), .c(new_n119_), .O(new_n134_));
  nand3  g090(.a(new_n128_), .b(x18), .c(x14), .O(new_n135_));
  nand3  g091(.a(x19), .b(new_n121_), .c(x13), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n120_), .O(new_n137_));
  nand4  g093(.a(x19), .b(x18), .c(new_n120_), .d(x12), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(x16), .O(new_n140_));
  inv1   g096(.a(x16), .O(new_n141_));
  nand3  g097(.a(new_n110_), .b(new_n141_), .c(x11), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g099(.a(new_n122_), .b(new_n111_), .O(new_n144_));
  nor4   g100(.a(new_n144_), .b(x26), .c(new_n128_), .d(x15), .O(new_n145_));
  aoi21  g101(.a(new_n143_), .b(x15), .c(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n117_), .b(new_n116_), .c(new_n55_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g104(.a(new_n134_), .b(x32), .c(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n108_), .c(new_n48_), .O(z8));
  nand2  g106(.a(x33), .b(x30), .O(new_n151_));
  nand3  g107(.a(new_n111_), .b(x17), .c(new_n45_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nor3   g109(.a(x33), .b(new_n128_), .c(new_n121_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n153_), .c(new_n102_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n151_), .c(x26), .O(new_n156_));
  nand3  g112(.a(new_n143_), .b(new_n102_), .c(new_n51_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n151_), .c(new_n45_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n114_), .O(new_n159_));
  nand2  g115(.a(x33), .b(new_n96_), .O(new_n160_));
  nand3  g116(.a(new_n154_), .b(new_n153_), .c(new_n101_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n160_), .c(x26), .O(new_n162_));
  nand3  g118(.a(new_n143_), .b(new_n101_), .c(new_n51_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n160_), .c(new_n45_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n162_), .c(new_n115_), .O(new_n165_));
  aoi21  g121(.a(new_n133_), .b(new_n103_), .c(new_n45_), .O(new_n166_));
  aoi21  g122(.a(new_n113_), .b(new_n103_), .c(x26), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n166_), .c(x33), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n165_), .c(new_n159_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x00), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n48_), .O(z9));
endmodule
