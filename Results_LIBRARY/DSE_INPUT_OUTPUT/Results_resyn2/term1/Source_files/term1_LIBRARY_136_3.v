...
module FAU ( 
  ...
  nand3  g033(.a(new_n60_), .b(new_n46_), .c(x25), .O(new_n78_));
  ...
  inv1   g043(.a(new_n47_), .O(new_n88_));
  ...
  nand2  g048(.a(new_n92_), .b(new_n88_), .O(z5));
  ...
  aoi21  g082(.a(new_n82_), .b(new_n70_), .c(new_n90_), .O(new_n127_));
  aoi21  g083(.a(new_n54_), .b(new_n95_), .c(new_n127_), .O(new_n128_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n125_), .c(new_n45_), .O(z8));
  nand2  g101(.a(x31), .b(x30), .O(new_n146_));
  aoi21  g102(.a(new_n119_), .b(new_n95_), .c(new_n127_), .O(new_n147_));
  ...
  aoi21  g108(.a(new_n152_), .b(new_n46_), .c(new_n45_), .O(z9));
endmodule
