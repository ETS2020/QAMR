...
module FAU ( 
  ...
  nand4  g041(.a(new_n85_), .b(new_n84_), .c(new_n78_), .d(new_n45_), .O(new_n86_));
  ...
  oai21  g047(.a(new_n91_), .b(new_n79_), .c(new_n69_), .O(z5));
  ...
  oai21  g052(.a(new_n96_), .b(new_n79_), .c(new_n69_), .O(z6));
  inv1   g053(.a(x31), .O(new_n98_));
  nor2   g054(.a(new_n95_), .b(x26), .O(new_n99_));
  xor2a  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  oai21  g056(.a(new_n78_), .b(new_n46_), .c(new_n100_), .O(z7));
  ...
  nor2   g075(.a(x32), .b(new_n98_), .O(new_n120_));
  oai21  g076(.a(new_n119_), .b(new_n116_), .c(new_n120_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n93_), .O(new_n122_));
  aoi21  g078(.a(new_n82_), .b(new_n81_), .c(new_n89_), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  aoi21  g080(.a(new_n53_), .b(x30), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand3  g082(.a(new_n117_), .b(x16), .c(x15), .O(new_n127_));
  oai21  g083(.a(new_n114_), .b(x16), .c(x19), .O(new_n128_));
  ...
  inv1   g089(.a(new_n127_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n118_), .b(new_n102_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n135_), .c(new_n132_), .d(new_n129_), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(x31), .c(new_n53_), .O(new_n139_));
  nand2  g095(.a(new_n121_), .b(x30), .O(new_n140_));
  aoi21  g096(.a(new_n53_), .b(new_n93_), .c(new_n123_), .O(new_n141_));
  ...
  nor2   g100(.a(new_n119_), .b(new_n116_), .O(new_n145_));
  nand3  g101(.a(new_n123_), .b(x31), .c(x30), .O(new_n146_));
  nand3  g102(.a(new_n124_), .b(new_n98_), .c(new_n93_), .O(new_n147_));
  and2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g104(.a(x31), .b(x26), .c(new_n49_), .O(new_n149_));
  oai21  g105(.a(new_n148_), .b(new_n137_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n147_), .b(x26), .O(new_n151_));
  nor2   g107(.a(new_n148_), .b(x33), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n145_), .c(new_n150_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x00), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n69_), .O(z9));
endmodule
