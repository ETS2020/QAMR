...
module FAU ( 
  ...
  nand2  g000(.a(x18), .b(x07), .O(new_n45_));
  ...
  nand2  g027(.a(new_n71_), .b(new_n45_), .O(z2));
  ...
  nand4  g042(.a(new_n86_), .b(new_n83_), .c(new_n45_), .d(new_n73_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(z3));
  and2   g044(.a(new_n86_), .b(new_n83_), .O(new_n89_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(new_n77_), .O(new_n114_));
  ...
  nor2   g078(.a(new_n112_), .b(new_n77_), .O(new_n123_));
  ...
  aoi21  g090(.a(new_n53_), .b(new_n102_), .c(new_n134_), .O(new_n135_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n143_), .d(x31), .O(new_n148_));
  ...
  nand2  g109(.a(new_n153_), .b(new_n45_), .O(z8));
  aoi21  g110(.a(x31), .b(x30), .c(new_n130_), .O(new_n155_));
  nand2  g111(.a(new_n126_), .b(new_n102_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n130_), .c(new_n155_), .O(new_n157_));
  oai21  g113(.a(new_n125_), .b(new_n122_), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n49_), .O(new_n159_));
  aoi21  g115(.a(new_n112_), .b(new_n146_), .c(new_n49_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n157_), .c(new_n145_), .d(new_n143_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n159_), .c(new_n152_), .O(new_n162_));
