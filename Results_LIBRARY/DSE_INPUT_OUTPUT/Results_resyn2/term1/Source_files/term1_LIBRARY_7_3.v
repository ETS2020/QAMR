...
module FAU ( 
  ...
  nand2  g000(.a(x31), .b(x10), .O(new_n45_));
  ...
  nand2  g025(.a(new_n69_), .b(new_n45_), .O(z2));
  ...
  oai21  g040(.a(new_n84_), .b(x27), .c(new_n45_), .O(z3));
  ...
  oai21  g047(.a(new_n91_), .b(new_n84_), .c(new_n45_), .O(z4));
  ...
  oai21  g052(.a(new_n96_), .b(new_n84_), .c(new_n45_), .O(z5));
  ...
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(new_n45_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(z6));
  xor2a  g059(.a(new_n101_), .b(x31), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n98_), .c(new_n47_), .O(z7));
  nand2  g061(.a(new_n90_), .b(x29), .O(new_n106_));
  ...
  nor2   g073(.a(new_n74_), .b(new_n111_), .O(new_n118_));
  ...
  nor2   g079(.a(x30), .b(new_n123_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n122_), .c(new_n120_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n108_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n107_), .O(new_n127_));
  nor2   g083(.a(new_n99_), .b(new_n123_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n122_), .c(new_n120_), .O(new_n129_));
  nand2  g085(.a(x32), .b(new_n99_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n106_), .O(new_n132_));
  nand3  g088(.a(x18), .b(x17), .c(x16), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n74_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x15), .O(new_n135_));
  aoi21  g091(.a(new_n74_), .b(x14), .c(new_n133_), .O(new_n136_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n109_), .O(new_n141_));
  inv1   g097(.a(x13), .O(new_n142_));
  aoi21  g098(.a(new_n111_), .b(new_n142_), .c(new_n121_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n141_), .c(new_n139_), .d(new_n137_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n135_), .c(x32), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n132_), .c(new_n127_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n81_), .c(x00), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n45_), .O(z8));
  nand2  g104(.a(new_n81_), .b(x00), .O(new_n149_));
  nor2   g105(.a(x31), .b(new_n123_), .O(new_n150_));
  nand4  g106(.a(new_n118_), .b(x17), .c(x16), .d(x10), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(x15), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(new_n120_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n49_), .b(new_n99_), .O(new_n154_));
  nand2  g110(.a(x33), .b(x31), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n153_), .c(new_n155_), .O(new_n156_));
  nor2   g112(.a(new_n49_), .b(x31), .O(new_n157_));
  nand3  g113(.a(new_n128_), .b(new_n49_), .c(x31), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n120_), .c(new_n157_), .O(new_n160_));
  nand2  g116(.a(new_n151_), .b(new_n135_), .O(new_n161_));
  nand2  g117(.a(new_n136_), .b(x15), .O(new_n162_));
  nand2  g118(.a(new_n111_), .b(new_n142_), .O(new_n163_));
  oai21  g119(.a(new_n99_), .b(new_n123_), .c(x31), .O(new_n164_));
  nand2  g120(.a(new_n121_), .b(x30), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n141_), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n162_), .c(new_n161_), .d(new_n139_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x33), .O(new_n169_));
  oai21  g125(.a(new_n160_), .b(new_n106_), .c(new_n169_), .O(new_n170_));
  aoi21  g126(.a(new_n156_), .b(new_n106_), .c(new_n170_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n149_), .c(new_n45_), .O(z9));
endmodule
