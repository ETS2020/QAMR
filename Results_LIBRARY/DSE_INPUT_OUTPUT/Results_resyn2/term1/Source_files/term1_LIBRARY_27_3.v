...
module FAU ( 
  ...
  nand2  g000(.a(x16), .b(x05), .O(new_n45_));
  ...
  nand4  g014(.a(x06), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(new_n59_));
  oai21  g015(.a(new_n59_), .b(new_n55_), .c(new_n53_), .O(new_n60_));
  inv1   g016(.a(x09), .O(new_n61_));
  nand2  g017(.a(new_n61_), .b(x08), .O(new_n62_));
  aoi21  g018(.a(new_n60_), .b(x05), .c(new_n62_), .O(new_n63_));
  aoi21  g019(.a(x03), .b(x02), .c(new_n56_), .O(new_n64_));
  oai21  g020(.a(x03), .b(x02), .c(new_n64_), .O(new_n65_));
  nand2  g021(.a(x06), .b(new_n57_), .O(new_n66_));
  nand2  g022(.a(x05), .b(new_n58_), .O(new_n67_));
  nand3  g023(.a(new_n67_), .b(new_n66_), .c(new_n56_), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  xnor2a g026(.a(new_n67_), .b(new_n66_), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n56_), .O(new_n72_));
  nand3  g028(.a(new_n72_), .b(new_n65_), .c(new_n55_), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(new_n70_), .c(new_n63_), .O(new_n74_));
  ...
  nand3  g042(.a(new_n64_), .b(new_n86_), .c(x25), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(x27), .c(new_n45_), .O(z3));
  nand2  g046(.a(new_n85_), .b(new_n45_), .O(new_n91_));
  ...
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n92_), .d(new_n88_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z4));
  nor2   g055(.a(new_n95_), .b(x29), .O(new_n100_));
  nand2  g056(.a(new_n95_), .b(x29), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nor4   g058(.a(new_n102_), .b(new_n100_), .c(new_n91_), .d(new_n87_), .O(z5));
  nand2  g059(.a(new_n102_), .b(x30), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nand2  g061(.a(new_n101_), .b(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n89_), .c(new_n45_), .O(z6));
  inv1   g064(.a(new_n89_), .O(new_n109_));
  xor2a  g065(.a(new_n104_), .b(x31), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n50_), .O(z7));
  inv1   g067(.a(x15), .O(new_n112_));
  inv1   g068(.a(x17), .O(new_n113_));
  nand3  g069(.a(new_n79_), .b(x18), .c(x14), .O(new_n114_));
  ...
  nand3  g078(.a(new_n122_), .b(x19), .c(new_n53_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(new_n112_), .O(new_n124_));
  nor2   g080(.a(new_n115_), .b(new_n113_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x16), .c(x10), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n79_), .c(x15), .O(new_n127_));
  ...
  nand2  g087(.a(new_n97_), .b(x29), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n49_), .b(new_n105_), .c(new_n136_), .O(new_n137_));
  ...
  nand2  g098(.a(new_n142_), .b(new_n79_), .O(new_n143_));
  ...
  nand2  g102(.a(new_n146_), .b(new_n113_), .O(new_n147_));
  ...
  nand2  g108(.a(new_n86_), .b(x00), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n45_), .O(z8));
  inv1   g112(.a(x33), .O(new_n157_));
  aoi21  g113(.a(x31), .b(x30), .c(new_n132_), .O(new_n158_));
  nand2  g114(.a(new_n128_), .b(new_n105_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n132_), .c(new_n158_), .O(new_n160_));
  oai21  g116(.a(new_n127_), .b(new_n124_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  aoi21  g118(.a(new_n115_), .b(new_n148_), .c(new_n157_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n160_), .c(new_n147_), .d(new_n145_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n162_), .c(new_n154_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n45_), .O(z9));
endmodule
