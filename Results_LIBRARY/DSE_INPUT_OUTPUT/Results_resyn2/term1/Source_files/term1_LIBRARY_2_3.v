...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n151_, new_n152_;
  nand2  g000(.a(x26), .b(x25), .O(new_n45_));
  ...
  nor2   g031(.a(x27), .b(x26), .O(new_n76_));
  nand4  g032(.a(new_n76_), .b(new_n75_), .c(x25), .d(x01), .O(new_n77_));
  inv1   g033(.a(new_n77_), .O(z3));
  inv1   g034(.a(x25), .O(new_n79_));
  inv1   g035(.a(x26), .O(new_n80_));
  inv1   g036(.a(new_n76_), .O(new_n81_));
  oai21  g037(.a(x28), .b(x27), .c(x01), .O(new_n82_));
  aoi21  g038(.a(new_n81_), .b(x28), .c(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n75_), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n80_), .c(new_n79_), .O(z4));
  nand4  g041(.a(new_n75_), .b(new_n80_), .c(x25), .d(x01), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  aoi21  g043(.a(x28), .b(x27), .c(x29), .O(new_n88_));
  nand3  g044(.a(x29), .b(x28), .c(x27), .O(new_n89_));
  ...
  nand2  g051(.a(new_n90_), .b(x30), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n95_), .c(new_n75_), .d(x01), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n80_), .c(new_n79_), .O(z6));
  xor2a  g054(.a(new_n96_), .b(x31), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n87_), .O(z7));
  ...
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n50_), .O(new_n139_));
  aoi21  g095(.a(new_n128_), .b(new_n126_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n80_), .b(x00), .O(new_n141_));
  aoi21  g097(.a(new_n140_), .b(new_n125_), .c(new_n141_), .O(z8));
  aoi21  g098(.a(x31), .b(x30), .c(new_n123_), .O(new_n143_));
  nand2  g099(.a(new_n119_), .b(new_n94_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n123_), .c(new_n143_), .O(new_n145_));
  oai21  g101(.a(new_n118_), .b(new_n115_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n47_), .O(new_n147_));
  nor3   g103(.a(new_n137_), .b(new_n136_), .c(new_n47_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n135_), .c(new_n141_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n45_), .O(z9));
endmodule
