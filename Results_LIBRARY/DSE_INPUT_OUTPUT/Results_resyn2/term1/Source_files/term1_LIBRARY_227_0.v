...
module FAU ( 
  ...
  nand2  g038(.a(new_n57_), .b(x25), .O(new_n83_));
  nor2   g039(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g040(.a(new_n84_), .b(x28), .c(new_n72_), .O(new_n85_));
  aoi21  g041(.a(new_n85_), .b(x28), .c(x26), .O(z3));
  ...
  aoi21  g050(.a(new_n94_), .b(x28), .c(x26), .O(z5));
  ...
  aoi21  g056(.a(new_n100_), .b(x28), .c(x26), .O(z6));
  nand3  g057(.a(x31), .b(x30), .c(x29), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n72_), .c(new_n98_), .d(x31), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x28), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n45_), .O(z7));
  inv1   g062(.a(x31), .O(new_n107_));
  xnor2a g063(.a(x30), .b(x29), .O(new_n108_));
  ...
  nor2   g079(.a(new_n113_), .b(new_n111_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x16), .c(x10), .O(new_n125_));
  nor3   g081(.a(new_n125_), .b(new_n75_), .c(x15), .O(new_n126_));
  aoi21  g082(.a(new_n123_), .b(x15), .c(new_n126_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n110_), .c(new_n52_), .O(new_n128_));
  inv1   g084(.a(x00), .O(new_n129_));
  inv1   g085(.a(new_n125_), .O(new_n130_));
  nand2  g086(.a(new_n120_), .b(new_n119_), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(x15), .c(new_n130_), .O(new_n132_));
  nand2  g088(.a(x18), .b(x12), .O(new_n133_));
  oai21  g089(.a(x18), .b(x13), .c(x17), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n75_), .b(x14), .O(new_n136_));
  nand3  g092(.a(new_n124_), .b(x16), .c(x15), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g095(.a(new_n137_), .b(new_n75_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n139_), .c(new_n135_), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n132_), .O(new_n142_));
  nand2  g098(.a(new_n109_), .b(x32), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n142_), .c(new_n129_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n128_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(x28), .c(x26), .O(z8));
  inv1   g103(.a(new_n102_), .O(new_n148_));
  nor2   g104(.a(x30), .b(x29), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n107_), .c(new_n148_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n127_), .c(new_n49_), .O(new_n151_));
  nor2   g107(.a(new_n150_), .b(new_n49_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n142_), .c(new_n129_), .O(new_n153_));
