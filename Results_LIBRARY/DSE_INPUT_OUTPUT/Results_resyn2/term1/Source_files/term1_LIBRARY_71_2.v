...
module FAU ( 
  ...
  oai22  g026(.a(x24), .b(x19), .c(x21), .d(x16), .O(new_n71_));
  ...
  and2   g030(.a(new_n74_), .b(new_n46_), .O(new_n75_));
  ...
  nand2  g043(.a(new_n79_), .b(new_n70_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n83_), .b(x29), .O(new_n90_));
  inv1   g046(.a(x29), .O(new_n91_));
  nand2  g047(.a(new_n84_), .b(new_n91_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n75_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(z5));
  inv1   g050(.a(new_n90_), .O(new_n95_));
  nor2   g051(.a(new_n95_), .b(new_n45_), .O(new_n96_));
  nand2  g052(.a(new_n91_), .b(x20), .O(new_n97_));
  oai22  g053(.a(new_n97_), .b(new_n73_), .c(new_n90_), .d(x30), .O(new_n98_));
  nand2  g054(.a(new_n73_), .b(x15), .O(new_n99_));
  aoi22  g055(.a(new_n99_), .b(new_n98_), .c(new_n96_), .d(new_n74_), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n88_), .c(new_n46_), .O(z6));
  nand2  g057(.a(x31), .b(x30), .O(new_n102_));
  inv1   g058(.a(x31), .O(new_n103_));
  nand2  g059(.a(new_n95_), .b(x30), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n46_), .c(new_n103_), .O(new_n105_));
  oai21  g061(.a(new_n102_), .b(new_n90_), .c(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n89_), .c(new_n74_), .O(z7));
  ...
  xor2a  g084(.a(new_n128_), .b(new_n45_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n51_), .c(x31), .O(new_n130_));
  oai21  g086(.a(new_n121_), .b(x16), .c(x15), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n125_), .O(new_n132_));
  nand3  g088(.a(new_n124_), .b(x16), .c(x15), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n111_), .O(new_n134_));
  nand2  g090(.a(new_n111_), .b(x14), .O(new_n135_));
  nand4  g091(.a(new_n124_), .b(new_n135_), .c(x16), .d(x15), .O(new_n136_));
  ...
  nand2  g096(.a(new_n113_), .b(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n139_), .c(new_n129_), .d(x31), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n137_), .c(x32), .O(new_n143_));
  oai21  g099(.a(new_n130_), .b(new_n127_), .c(new_n143_), .O(new_n144_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n127_), .c(new_n48_), .O(new_n150_));
  inv1   g106(.a(new_n109_), .O(new_n151_));
  nand4  g107(.a(new_n148_), .b(new_n141_), .c(new_n139_), .d(x33), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n137_), .O(new_n153_));
