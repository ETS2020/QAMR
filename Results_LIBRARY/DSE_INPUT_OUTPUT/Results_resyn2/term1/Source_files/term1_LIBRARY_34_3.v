...
module FAU ( 
  ...
  nand2  g034(.a(new_n60_), .b(new_n78_), .O(new_n79_));
  nor4   g035(.a(new_n79_), .b(new_n77_), .c(x31), .d(new_n45_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n73_), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(z3));
  inv1   g038(.a(x28), .O(new_n83_));
  nor2   g039(.a(new_n83_), .b(new_n73_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  nand2  g041(.a(new_n83_), .b(new_n73_), .O(new_n86_));
  ...
  nand2  g052(.a(new_n90_), .b(x30), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n96_), .c(new_n80_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z6));
  inv1   g055(.a(new_n97_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n79_), .c(new_n77_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(x31), .c(x25), .O(z7));
  ...
  nor2   g077(.a(new_n121_), .b(new_n46_), .O(new_n122_));
  ...
  aoi21  g082(.a(new_n126_), .b(x16), .c(new_n115_), .O(new_n127_));
  nand2  g083(.a(new_n105_), .b(x14), .O(new_n128_));
  ...
  nand2  g087(.a(new_n118_), .b(new_n103_), .O(new_n132_));
  nand2  g088(.a(new_n129_), .b(new_n105_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n127_), .O(new_n135_));
  nor2   g091(.a(new_n121_), .b(new_n54_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(x25), .O(new_n137_));
  nand2  g093(.a(new_n78_), .b(x00), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n137_), .b(new_n46_), .c(new_n139_), .O(new_n140_));
  aoi21  g096(.a(new_n123_), .b(new_n54_), .c(new_n140_), .O(z8));
  xor2a  g097(.a(new_n120_), .b(x31), .O(new_n142_));
  and2   g098(.a(new_n142_), .b(new_n121_), .O(new_n143_));
  oai21  g099(.a(new_n119_), .b(new_n117_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n50_), .O(new_n145_));
  nand2  g101(.a(new_n143_), .b(x33), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n135_), .c(new_n138_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n58_), .O(z9));
endmodule
