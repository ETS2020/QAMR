...
module FAU ( 
  ...
  oai21  g018(.a(new_n61_), .b(new_n59_), .c(new_n62_), .O(new_n63_));
  oai21  g019(.a(new_n53_), .b(new_n57_), .c(new_n63_), .O(new_n64_));
  ...
  aoi22  g033(.a(new_n77_), .b(new_n73_), .c(x03), .d(x02), .O(new_n78_));
  nor3   g034(.a(x26), .b(new_n45_), .c(new_n57_), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n78_), .c(new_n70_), .O(new_n80_));
  inv1   g036(.a(new_n80_), .O(z3));
  nand2  g037(.a(new_n78_), .b(x01), .O(new_n82_));
  ...
  aoi21  g054(.a(new_n98_), .b(x25), .c(x26), .O(z6));
  inv1   g055(.a(x31), .O(new_n100_));
  xor2a  g056(.a(new_n97_), .b(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n82_), .c(x25), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n46_), .O(z7));
  ...
  aoi21  g085(.a(new_n52_), .b(new_n95_), .c(new_n129_), .O(new_n130_));
  ...
  aoi21  g102(.a(new_n146_), .b(x25), .c(x26), .O(z8));
  aoi21  g103(.a(x31), .b(x30), .c(new_n125_), .O(new_n148_));
  nand2  g104(.a(new_n100_), .b(new_n95_), .O(new_n149_));
  ...
  aoi21  g108(.a(new_n108_), .b(new_n141_), .c(new_n49_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n150_), .c(new_n140_), .d(new_n138_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n152_), .c(x00), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(x25), .c(x26), .O(z9));
endmodule
