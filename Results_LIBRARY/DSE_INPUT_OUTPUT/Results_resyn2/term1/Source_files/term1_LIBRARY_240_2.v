...
module FAU ( 
  ...
  and2   g040(.a(new_n84_), .b(new_n46_), .O(new_n85_));
  inv1   g041(.a(x26), .O(new_n86_));
  nand4  g042(.a(new_n65_), .b(new_n86_), .c(x25), .d(x01), .O(new_n87_));
  ...
  nand2  g059(.a(new_n98_), .b(new_n45_), .O(new_n104_));
  nand2  g060(.a(new_n99_), .b(x30), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n104_), .c(new_n97_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n46_), .O(z6));
  xor2a  g063(.a(new_n105_), .b(x31), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n97_), .c(new_n48_), .O(z7));
  inv1   g065(.a(x31), .O(new_n110_));
  aoi21  g066(.a(new_n92_), .b(x29), .c(new_n110_), .O(new_n111_));
  ...
  nor3   g082(.a(new_n126_), .b(new_n78_), .c(x15), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n125_), .c(new_n111_), .O(new_n128_));
  nand3  g084(.a(x30), .b(new_n86_), .c(x00), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n123_), .b(x16), .c(x15), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n126_), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n78_), .b(x14), .c(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n136_), .b(new_n78_), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n135_), .c(new_n132_), .O(new_n139_));
  nand2  g095(.a(new_n111_), .b(x32), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(new_n130_), .O(new_n141_));
  aoi21  g097(.a(new_n128_), .b(new_n54_), .c(new_n141_), .O(z8));
  nand2  g098(.a(new_n92_), .b(x29), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n110_), .O(new_n144_));
  oai21  g100(.a(new_n127_), .b(new_n125_), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n144_), .b(x33), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n139_), .c(new_n130_), .O(new_n147_));
  aoi21  g103(.a(new_n145_), .b(new_n50_), .c(new_n147_), .O(z9));
endmodule
