...
module FAU ( 
  ...
  nand3  g040(.a(new_n61_), .b(new_n46_), .c(x25), .O(new_n85_));
  ...
  aoi22  g089(.a(new_n94_), .b(x29), .c(new_n55_), .d(new_n103_), .O(new_n134_));
  ...
  nand2  g095(.a(new_n78_), .b(x14), .O(new_n140_));
  ...
  nand4  g114(.a(new_n157_), .b(new_n147_), .c(new_n145_), .d(x33), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n143_), .c(new_n152_), .O(new_n160_));
  aoi21  g116(.a(new_n158_), .b(new_n51_), .c(new_n160_), .O(z9));
endmodule
