...
module FAU ( 
  ...
  nor2   g043(.a(new_n87_), .b(x27), .O(z3));
  ...
  oai21  g049(.a(new_n93_), .b(new_n85_), .c(new_n56_), .O(z4));
  xnor2a g050(.a(x29), .b(x28), .O(new_n95_));
  oai22  g051(.a(new_n95_), .b(new_n85_), .c(new_n87_), .d(x27), .O(z5));
  nor2   g052(.a(new_n71_), .b(new_n90_), .O(new_n97_));
  xnor2a g053(.a(x30), .b(x28), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g055(.a(new_n97_), .b(x30), .c(new_n99_), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n85_), .c(new_n56_), .O(z6));
  oai21  g057(.a(new_n85_), .b(x31), .c(x27), .O(new_n102_));
  nand3  g058(.a(x30), .b(x28), .c(x27), .O(new_n103_));
  aoi21  g059(.a(x31), .b(x29), .c(new_n103_), .O(new_n104_));
  aoi21  g060(.a(new_n103_), .b(x31), .c(new_n104_), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(new_n86_), .c(new_n102_), .d(new_n71_), .O(z7));
  nand2  g062(.a(new_n82_), .b(x00), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  inv1   g064(.a(x17), .O(new_n109_));
  nand3  g065(.a(new_n75_), .b(x18), .c(x14), .O(new_n110_));
  ...
  nor3   g079(.a(new_n123_), .b(new_n75_), .c(x15), .O(new_n124_));
  ...
  nor2   g085(.a(new_n127_), .b(new_n126_), .O(new_n130_));
  nor3   g086(.a(new_n130_), .b(x32), .c(new_n129_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  oai21  g088(.a(new_n119_), .b(x16), .c(x15), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n123_), .O(new_n134_));
  ...
  nand4  g093(.a(new_n122_), .b(new_n137_), .c(x16), .d(x15), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n136_), .c(new_n134_), .O(new_n139_));
  nand2  g095(.a(new_n98_), .b(new_n90_), .O(new_n140_));
  nand2  g096(.a(x18), .b(x12), .O(new_n141_));
  oai21  g097(.a(x18), .b(x13), .c(x17), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g099(.a(new_n97_), .b(x30), .O(new_n144_));
  aoi21  g100(.a(new_n126_), .b(new_n71_), .c(new_n129_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n140_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n139_), .c(x32), .O(new_n147_));
  oai21  g103(.a(new_n132_), .b(new_n125_), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n108_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n56_), .O(z8));
  nand2  g106(.a(new_n128_), .b(new_n129_), .O(new_n151_));
  oai21  g107(.a(new_n130_), .b(new_n129_), .c(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n125_), .c(new_n48_), .O(new_n153_));
  nand2  g109(.a(x31), .b(x29), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(x30), .c(new_n48_), .O(new_n155_));
  or2    g111(.a(new_n98_), .b(x27), .O(new_n156_));
  oai21  g112(.a(new_n97_), .b(x31), .c(new_n126_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n143_), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n139_), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n107_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n153_), .O(new_n161_));
