...
module FAU ( 
  ...
  nand3  g029(.a(new_n47_), .b(x25), .c(x01), .O(new_n74_));
  aoi21  g030(.a(new_n73_), .b(new_n69_), .c(new_n74_), .O(new_n75_));
  nand3  g031(.a(new_n75_), .b(new_n66_), .c(x00), .O(new_n76_));
  inv1   g032(.a(new_n76_), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(new_n65_), .O(new_n78_));
  inv1   g034(.a(new_n78_), .O(z3));
  inv1   g035(.a(x28), .O(new_n80_));
  nor2   g036(.a(new_n80_), .b(new_n65_), .O(new_n81_));
  inv1   g037(.a(new_n81_), .O(new_n82_));
  nand2  g038(.a(new_n80_), .b(new_n65_), .O(new_n83_));
  ...
  nand2  g052(.a(new_n96_), .b(new_n75_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x00), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n66_), .O(z7));
  ...
  nand2  g076(.a(new_n120_), .b(new_n92_), .O(new_n121_));
  inv1   g077(.a(x32), .O(new_n122_));
  nand2  g078(.a(new_n83_), .b(x29), .O(new_n123_));
  aoi21  g079(.a(new_n122_), .b(x30), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g081(.a(new_n120_), .b(x30), .O(new_n126_));
  aoi21  g082(.a(new_n80_), .b(new_n65_), .c(new_n87_), .O(new_n127_));
  aoi21  g083(.a(new_n122_), .b(new_n92_), .c(new_n127_), .O(new_n128_));
  oai21  g084(.a(new_n112_), .b(x16), .c(x15), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n116_), .O(new_n130_));
  nand3  g086(.a(new_n115_), .b(x16), .c(x15), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n102_), .O(new_n132_));
  nand2  g088(.a(new_n102_), .b(x14), .O(new_n133_));
  ...
  aoi21  g099(.a(new_n128_), .b(new_n126_), .c(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n125_), .c(x26), .O(z8));
  nand2  g101(.a(x31), .b(x30), .O(new_n146_));
  aoi21  g102(.a(new_n118_), .b(new_n92_), .c(new_n127_), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n127_), .c(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n117_), .b(new_n114_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n52_), .O(new_n150_));
  nand4  g106(.a(new_n148_), .b(new_n140_), .c(new_n138_), .d(x33), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n136_), .c(new_n150_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(x00), .c(x26), .O(z9));
endmodule
