...
module FAU ( 
  ...
  aoi21  g060(.a(new_n104_), .b(new_n91_), .c(new_n46_), .O(z7));
  ...
  aoi22  g084(.a(new_n85_), .b(x29), .c(new_n53_), .d(new_n97_), .O(new_n129_));
