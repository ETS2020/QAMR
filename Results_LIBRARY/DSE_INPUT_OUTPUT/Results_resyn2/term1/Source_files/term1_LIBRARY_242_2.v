...
module FAU ( 
  ...
  nand3  g064(.a(x18), .b(x16), .c(x15), .O(new_n109_));
  ...
  and2   g071(.a(x17), .b(x13), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n115_), .c(x31), .d(x19), .O(new_n117_));
  ...
  nand3  g077(.a(x18), .b(new_n102_), .c(x12), .O(new_n122_));
  ...
  nand4  g082(.a(x18), .b(x17), .c(new_n126_), .d(x11), .O(new_n127_));
  ...
  nand3  g086(.a(new_n130_), .b(x18), .c(x17), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand2  g088(.a(x31), .b(x19), .O(new_n133_));
  ...
  nand4  g096(.a(x19), .b(new_n74_), .c(x17), .d(x13), .O(new_n141_));
  ...
  nand2  g105(.a(x16), .b(x13), .O(new_n150_));
  oai21  g106(.a(x16), .b(x11), .c(x18), .O(new_n151_));
