...
module FAU ( 
  ...
  nand2  g086(.a(new_n125_), .b(x30), .O(new_n131_));
  aoi21  g087(.a(new_n51_), .b(new_n100_), .c(new_n127_), .O(new_n132_));
  ...
  aoi21  g094(.a(new_n133_), .b(new_n121_), .c(new_n138_), .O(new_n139_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n51_), .O(new_n143_));
  ...
  aoi21  g103(.a(new_n123_), .b(new_n100_), .c(new_n127_), .O(new_n148_));
  ...
  nor3   g107(.a(new_n141_), .b(new_n140_), .c(new_n48_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n139_), .c(new_n145_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n46_), .O(z9));
endmodule
