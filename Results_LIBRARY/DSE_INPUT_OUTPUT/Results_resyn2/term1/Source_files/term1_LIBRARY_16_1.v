...
module FAU ( 
  ...
  aoi21  g029(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  ...
  nand4  g050(.a(new_n94_), .b(new_n93_), .c(new_n85_), .d(new_n83_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z5));
  inv1   g052(.a(x30), .O(new_n97_));
  xor2a  g053(.a(new_n94_), .b(new_n97_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n80_), .O(new_n99_));
  ...
  nor2   g061(.a(new_n101_), .b(new_n102_), .O(new_n106_));
  aoi21  g062(.a(new_n105_), .b(new_n101_), .c(new_n106_), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(new_n80_), .c(new_n84_), .d(new_n46_), .O(z7));
  inv1   g064(.a(x15), .O(new_n109_));
  inv1   g065(.a(x17), .O(new_n110_));
  nand3  g066(.a(x19), .b(new_n71_), .c(x13), .O(new_n111_));
  nand3  g067(.a(new_n72_), .b(x18), .c(x14), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand4  g069(.a(x19), .b(x18), .c(new_n110_), .d(x12), .O(new_n114_));
  ...
  aoi21  g076(.a(new_n120_), .b(new_n116_), .c(new_n109_), .O(new_n121_));
  nor2   g077(.a(new_n110_), .b(new_n117_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x10), .O(new_n123_));
  nand3  g079(.a(x19), .b(x18), .c(new_n109_), .O(new_n124_));
  ...
  nand2  g083(.a(new_n127_), .b(new_n97_), .O(new_n128_));
  ...
  oai21  g089(.a(new_n132_), .b(new_n71_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(x16), .c(new_n119_), .O(new_n135_));
  oai21  g091(.a(new_n123_), .b(new_n71_), .c(new_n109_), .O(new_n136_));
  nand2  g092(.a(new_n122_), .b(x15), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n71_), .c(new_n72_), .O(new_n138_));
  nand2  g094(.a(new_n72_), .b(x14), .O(new_n139_));
  ...
  nand3  g108(.a(new_n122_), .b(x15), .c(x13), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand3  g110(.a(new_n50_), .b(x19), .c(new_n71_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n154_), .c(new_n104_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n152_), .c(x23), .O(new_n158_));
  nand4  g114(.a(x19), .b(x17), .c(new_n117_), .d(x11), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n110_), .b(x12), .O(new_n161_));
  oai21  g117(.a(x19), .b(x17), .c(x16), .O(new_n162_));
  aoi21  g118(.a(new_n161_), .b(new_n139_), .c(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n160_), .c(x15), .O(new_n164_));
  nand4  g120(.a(new_n122_), .b(x19), .c(new_n109_), .d(x10), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n164_), .c(x33), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n104_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n152_), .c(new_n71_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n158_), .c(new_n129_), .O(new_n169_));
  nor2   g125(.a(new_n50_), .b(x30), .O(new_n170_));
  nand2  g126(.a(new_n156_), .b(new_n103_), .O(new_n171_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n71_), .c(new_n173_), .O(new_n175_));
  nor2   g131(.a(new_n137_), .b(new_n139_), .O(new_n176_));
  nand2  g132(.a(new_n137_), .b(x19), .O(new_n177_));
  aoi21  g133(.a(new_n123_), .b(new_n109_), .c(new_n177_), .O(new_n178_));
  ...
  nand2  g138(.a(new_n154_), .b(x19), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n71_), .c(new_n105_), .O(new_n184_));
  nand2  g140(.a(new_n47_), .b(x33), .O(new_n185_));
  aoi21  g141(.a(new_n184_), .b(new_n182_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n175_), .b(new_n144_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n169_), .c(new_n148_), .O(z9));
endmodule
