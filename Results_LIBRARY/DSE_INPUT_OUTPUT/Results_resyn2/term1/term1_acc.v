...
module FAU ( 
  ...
  nand4  g57(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n101_), .c(x10), .O(new_n104_));
  inv1   g60(.a(x16), .O(new_n105_));
  inv1   g61(.a(x12), .O(new_n106_));
  inv1   g62(.a(x17), .O(new_n107_));
  nand2  g63(.a(x19), .b(x18), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n106_), .c(new_n107_), .O(new_n109_));
  ...
  aoi21  g72(.a(new_n116_), .b(new_n109_), .c(new_n105_), .O(new_n117_));
  nand2  g73(.a(x17), .b(x11), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n108_), .c(new_n105_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(x15), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n117_), .c(new_n104_), .O(new_n121_));
  oai21  g77(.a(x28), .b(x27), .c(x29), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(new_n95_), .O(new_n123_));
  nand2  g79(.a(new_n122_), .b(new_n95_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(x31), .O(new_n125_));
  nor2   g81(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  inv1   g83(.a(x00), .O(new_n128_));
  nor2   g84(.a(x26), .b(new_n128_), .O(new_n129_));
  oai21  g85(.a(new_n103_), .b(new_n101_), .c(new_n104_), .O(new_n130_));
  nand3  g86(.a(new_n114_), .b(new_n112_), .c(new_n109_), .O(new_n131_));
  inv1   g87(.a(new_n131_), .O(new_n132_));
  nand3  g88(.a(new_n132_), .b(new_n130_), .c(new_n119_), .O(new_n133_));
  nand2  g89(.a(new_n126_), .b(x32), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n133_), .c(new_n129_), .O(new_n135_));
  aoi21  g91(.a(new_n127_), .b(z0), .c(new_n135_), .O(z8));
  nand2  g92(.a(new_n123_), .b(x31), .O(new_n137_));
  oai21  g93(.a(new_n124_), .b(x31), .c(new_n137_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n121_), .O(new_n139_));
  nand2  g95(.a(new_n138_), .b(x33), .O(new_n140_));
  oai21  g96(.a(new_n140_), .b(new_n133_), .c(new_n129_), .O(new_n141_));
  aoi21  g97(.a(new_n139_), .b(new_n47_), .c(new_n141_), .O(z9));
endmodule
