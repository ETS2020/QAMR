...
module FAU ( 
  ...
  inv1   g087(.a(new_n101_), .O(new_n104_));
  nand2  g088(.a(new_n104_), .b(new_n75_), .O(new_n105_));
  aoi21  g089(.a(new_n105_), .b(new_n103_), .c(new_n20_), .O(new_n106_));
  inv1   g090(.a(new_n50_), .O(new_n107_));
  aoi22  g091(.a(new_n75_), .b(x9), .c(new_n22_), .d(x7), .O(new_n108_));
  oai21  g092(.a(new_n108_), .b(new_n90_), .c(new_n107_), .O(new_n109_));
  oai21  g093(.a(new_n109_), .b(new_n106_), .c(x3), .O(new_n110_));
  nand2  g094(.a(x7), .b(x6), .O(new_n111_));
  nand2  g095(.a(x4), .b(x0), .O(new_n112_));
  aoi21  g096(.a(new_n112_), .b(x9), .c(new_n111_), .O(new_n113_));
  nand3  g097(.a(x9), .b(new_n17_), .c(new_n21_), .O(new_n114_));
  inv1   g098(.a(new_n114_), .O(new_n115_));
  aoi21  g099(.a(new_n115_), .b(new_n91_), .c(new_n113_), .O(new_n116_));
  nand3  g100(.a(new_n116_), .b(new_n110_), .c(new_n99_), .O(new_n117_));
  nand2  g101(.a(new_n117_), .b(x1), .O(new_n118_));
  inv1   g102(.a(x1), .O(new_n119_));
  nand3  g103(.a(new_n82_), .b(new_n22_), .c(x8), .O(new_n120_));
  oai21  g104(.a(new_n17_), .b(new_n43_), .c(x8), .O(new_n121_));
  nand2  g105(.a(new_n27_), .b(new_n81_), .O(new_n122_));
  nand2  g106(.a(new_n122_), .b(x4), .O(new_n123_));
  nand3  g107(.a(new_n123_), .b(new_n121_), .c(new_n21_), .O(new_n124_));
  aoi21  g108(.a(new_n124_), .b(new_n120_), .c(new_n73_), .O(new_n125_));
  oai21  g109(.a(x7), .b(new_n73_), .c(x6), .O(new_n126_));
  nand4  g110(.a(new_n126_), .b(x8), .c(x3), .d(new_n43_), .O(new_n127_));
  nand3  g111(.a(new_n27_), .b(new_n81_), .c(x2), .O(new_n128_));
  nand2  g112(.a(new_n128_), .b(new_n26_), .O(new_n129_));
  nand3  g113(.a(new_n17_), .b(x6), .c(new_n81_), .O(new_n130_));
  nand3  g114(.a(new_n130_), .b(new_n129_), .c(new_n28_), .O(new_n131_));
  aoi21  g115(.a(new_n131_), .b(new_n127_), .c(new_n33_), .O(new_n132_));
  oai21  g116(.a(new_n132_), .b(new_n125_), .c(x9), .O(new_n133_));
  inv1   g117(.a(new_n122_), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(new_n75_), .c(x6), .O(new_n135_));
  nand3  g119(.a(x9), .b(x4), .c(x3), .O(new_n136_));
  inv1   g120(.a(new_n136_), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n28_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n135_), .c(x2), .O(new_n139_));
  oai21  g123(.a(new_n82_), .b(new_n21_), .c(new_n137_), .O(new_n140_));
  nand2  g124(.a(new_n122_), .b(new_n20_), .O(new_n141_));
  nand3  g125(.a(new_n141_), .b(new_n56_), .c(new_n33_), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n140_), .c(new_n28_), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n139_), .c(new_n73_), .O(new_n144_));
  nand3  g128(.a(new_n21_), .b(new_n33_), .c(x3), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(x5), .O(new_n146_));
  nand3  g130(.a(x7), .b(new_n21_), .c(x3), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(x4), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nor2   g133(.a(x7), .b(x3), .O(new_n150_));
  oai21  g134(.a(new_n22_), .b(new_n27_), .c(new_n150_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n149_), .c(x9), .O(new_n152_));
  nand2  g136(.a(x7), .b(x4), .O(new_n153_));
  nand2  g137(.a(new_n134_), .b(new_n74_), .O(new_n154_));
  aoi21  g138(.a(new_n153_), .b(new_n83_), .c(new_n154_), .O(new_n155_));
  nor2   g139(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n144_), .c(new_n133_), .O(new_n157_));
  nand2  g141(.a(new_n17_), .b(new_n21_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n58_), .c(new_n70_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(x3), .O(new_n160_));
  aoi21  g144(.a(new_n134_), .b(new_n44_), .c(new_n48_), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  aoi21  g146(.a(new_n157_), .b(new_n119_), .c(new_n162_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n118_), .O(z1));
  nand2  g148(.a(x3), .b(x1), .O(new_n165_));
  nand2  g149(.a(new_n81_), .b(new_n119_), .O(new_n166_));
  aoi21  g150(.a(new_n166_), .b(new_n165_), .c(new_n48_), .O(z2));
  oai21  g151(.a(new_n20_), .b(new_n27_), .c(new_n165_), .O(z3));
  ...
  nand3  g162(.a(new_n56_), .b(x3), .c(new_n119_), .O(new_n179_));
  ...
  aoi21  g166(.a(new_n182_), .b(new_n111_), .c(new_n33_), .O(new_n183_));
  nand2  g167(.a(new_n147_), .b(new_n130_), .O(new_n184_));
  ...
  oai21  g172(.a(new_n104_), .b(new_n84_), .c(z2), .O(new_n189_));
