...
module FAU ( 
  ...
  nand2  g163(.a(new_n33_), .b(x5), .O(new_n180_));
  xor2a  g164(.a(x3), .b(x1), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n180_), .O(z2));
  oai21  g166(.a(new_n74_), .b(new_n147_), .c(new_n180_), .O(z3));
  nor2   g167(.a(x8), .b(x6), .O(new_n184_));
  oai22  g168(.a(x3), .b(new_n18_), .c(x2), .d(new_n147_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g170(.a(x2), .b(new_n18_), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n17_), .O(new_n188_));
  aoi21  g172(.a(new_n188_), .b(new_n107_), .c(new_n147_), .O(new_n189_));
  oai21  g173(.a(new_n102_), .b(new_n17_), .c(new_n53_), .O(new_n190_));
  oai21  g174(.a(new_n63_), .b(new_n17_), .c(x0), .O(new_n191_));
  aoi21  g175(.a(new_n191_), .b(new_n190_), .c(x3), .O(new_n192_));
  oai21  g176(.a(new_n192_), .b(new_n189_), .c(x7), .O(new_n193_));
  aoi21  g177(.a(new_n193_), .b(new_n186_), .c(x4), .O(new_n194_));
  nor2   g178(.a(new_n74_), .b(x1), .O(new_n195_));
  nor2   g179(.a(new_n195_), .b(new_n23_), .O(new_n196_));
  oai22  g180(.a(new_n196_), .b(new_n111_), .c(new_n102_), .d(new_n53_), .O(new_n197_));
  oai21  g181(.a(new_n74_), .b(new_n147_), .c(new_n87_), .O(new_n198_));
  nand2  g182(.a(new_n198_), .b(x7), .O(new_n199_));
  nand2  g183(.a(new_n174_), .b(new_n22_), .O(new_n200_));
  nand3  g184(.a(x6), .b(new_n74_), .c(x1), .O(new_n201_));
  nand3  g185(.a(new_n201_), .b(new_n200_), .c(new_n199_), .O(new_n202_));
  aoi21  g186(.a(new_n197_), .b(new_n27_), .c(new_n202_), .O(new_n203_));
  oai21  g187(.a(new_n203_), .b(new_n194_), .c(x5), .O(new_n204_));
  nand2  g188(.a(new_n184_), .b(x2), .O(new_n205_));
  aoi21  g189(.a(new_n205_), .b(new_n107_), .c(new_n27_), .O(new_n206_));
  oai21  g190(.a(new_n34_), .b(new_n74_), .c(new_n77_), .O(new_n207_));
  oai21  g191(.a(new_n207_), .b(new_n206_), .c(x1), .O(new_n208_));
  nand2  g192(.a(new_n54_), .b(new_n17_), .O(new_n209_));
  inv1   g193(.a(new_n209_), .O(new_n210_));
  nand2  g194(.a(new_n17_), .b(x3), .O(new_n211_));
  oai21  g195(.a(new_n57_), .b(x0), .c(new_n211_), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(x2), .O(new_n213_));
  nand2  g197(.a(new_n195_), .b(new_n54_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n213_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(x4), .c(new_n210_), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n208_), .c(x5), .O(new_n217_));
  nand2  g201(.a(new_n27_), .b(x1), .O(new_n218_));
  or2    g202(.a(new_n218_), .b(new_n94_), .O(new_n219_));
  nand2  g203(.a(new_n100_), .b(new_n147_), .O(new_n220_));
  nor2   g204(.a(new_n21_), .b(new_n19_), .O(new_n221_));
  oai21  g205(.a(new_n221_), .b(new_n184_), .c(new_n220_), .O(new_n222_));
  nand3  g206(.a(new_n98_), .b(new_n67_), .c(x6), .O(new_n223_));
  aoi21  g207(.a(new_n223_), .b(new_n222_), .c(x5), .O(new_n224_));
  inv1   g208(.a(new_n184_), .O(new_n225_));
  nand3  g209(.a(x7), .b(x6), .c(new_n53_), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n225_), .c(new_n218_), .O(new_n227_));
  oai21  g211(.a(new_n227_), .b(new_n224_), .c(x0), .O(new_n228_));
  nand2  g212(.a(new_n228_), .b(new_n219_), .O(new_n229_));
  nor2   g213(.a(new_n229_), .b(new_n217_), .O(new_n230_));
  aoi21  g214(.a(new_n230_), .b(new_n204_), .c(new_n33_), .O(z4));
  inv1   g215(.a(new_n79_), .O(new_n232_));
  nand2  g216(.a(new_n187_), .b(new_n232_), .O(new_n233_));
  oai21  g217(.a(new_n233_), .b(new_n181_), .c(new_n180_), .O(z5));
endmodule
