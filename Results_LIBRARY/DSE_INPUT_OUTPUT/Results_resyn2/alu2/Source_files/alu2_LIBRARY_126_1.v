...
module FAU ( 
  ...
  nand2  g111(.a(x9), .b(new_n19_), .O(new_n128_));
  oai21  g112(.a(new_n120_), .b(new_n93_), .c(new_n128_), .O(z3));
  or2    g113(.a(z3), .b(new_n127_), .O(z2));
  ...
  nor2   g143(.a(new_n120_), .b(new_n93_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n127_), .c(new_n147_), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n128_), .O(z5));
endmodule
