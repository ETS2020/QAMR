...
module FAU ( 
  ...
  inv1   g123(.a(new_n135_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(new_n139_), .O(z3));
  inv1   g125(.a(new_n97_), .O(new_n142_));
  nor2   g126(.a(new_n136_), .b(new_n142_), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n89_), .c(new_n26_), .O(new_n144_));
  nand3  g128(.a(new_n136_), .b(x5), .c(new_n51_), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n144_), .c(x7), .O(new_n146_));
  nand2  g130(.a(new_n86_), .b(new_n35_), .O(new_n147_));
  nand2  g131(.a(x1), .b(new_n51_), .O(new_n148_));
  oai22  g132(.a(new_n148_), .b(new_n147_), .c(new_n82_), .d(new_n17_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(x3), .O(new_n150_));
  oai21  g134(.a(x5), .b(x4), .c(new_n62_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(new_n104_), .c(new_n51_), .O(new_n152_));
  aoi21  g136(.a(new_n18_), .b(x5), .c(new_n60_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  oai21  g138(.a(new_n70_), .b(new_n30_), .c(new_n78_), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n17_), .c(x0), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n154_), .c(new_n150_), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n146_), .c(x6), .O(new_n158_));
  nand2  g142(.a(new_n62_), .b(new_n60_), .O(new_n159_));
  nand2  g143(.a(x5), .b(x4), .O(new_n160_));
  nand4  g144(.a(new_n160_), .b(new_n22_), .c(x3), .d(x1), .O(new_n161_));
  oai21  g145(.a(new_n159_), .b(new_n147_), .c(new_n161_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(x7), .O(new_n163_));
  oai21  g147(.a(new_n114_), .b(x8), .c(new_n17_), .O(new_n164_));
  nand3  g148(.a(new_n35_), .b(x1), .c(x0), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n26_), .O(new_n166_));
  aoi21  g150(.a(new_n74_), .b(x7), .c(x6), .O(new_n167_));
  nand3  g151(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand2  g152(.a(x4), .b(new_n60_), .O(new_n169_));
  aoi21  g153(.a(new_n26_), .b(new_n51_), .c(new_n169_), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n65_), .c(x2), .O(new_n171_));
  nand3  g155(.a(new_n171_), .b(new_n168_), .c(new_n163_), .O(new_n172_));
  inv1   g156(.a(new_n172_), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n158_), .c(new_n21_), .O(z4));
  xor2a  g158(.a(x2), .b(x0), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n137_), .c(new_n140_), .O(z5));
endmodule
