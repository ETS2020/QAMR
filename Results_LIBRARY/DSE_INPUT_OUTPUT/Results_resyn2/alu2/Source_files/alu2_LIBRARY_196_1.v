...
module FAU ( 
  ...
  nor3   g108(.a(new_n60_), .b(new_n65_), .c(new_n90_), .O(z3));
  oai22  g109(.a(new_n22_), .b(x4), .c(new_n17_), .d(x1), .O(new_n126_));
  oai21  g110(.a(new_n62_), .b(new_n42_), .c(new_n90_), .O(new_n127_));
  nand2  g111(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g112(.a(new_n17_), .b(new_n42_), .O(new_n129_));
  nor2   g113(.a(new_n129_), .b(x1), .O(new_n130_));
  oai21  g114(.a(new_n21_), .b(new_n22_), .c(new_n130_), .O(new_n131_));
  aoi21  g115(.a(new_n131_), .b(new_n128_), .c(new_n18_), .O(new_n132_));
  nand2  g116(.a(new_n67_), .b(new_n18_), .O(new_n133_));
  nand2  g117(.a(new_n25_), .b(x2), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n24_), .O(new_n135_));
  nand3  g119(.a(new_n135_), .b(new_n45_), .c(x0), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n132_), .c(new_n65_), .O(new_n138_));
  nand2  g122(.a(new_n23_), .b(x8), .O(new_n139_));
  nand2  g123(.a(new_n129_), .b(new_n113_), .O(new_n140_));
  oai21  g124(.a(x2), .b(new_n42_), .c(x6), .O(new_n141_));
  aoi22  g125(.a(new_n141_), .b(x7), .c(new_n140_), .d(new_n139_), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n65_), .c(new_n133_), .O(new_n143_));
  nor2   g127(.a(x4), .b(new_n90_), .O(new_n144_));
  aoi21  g128(.a(x3), .b(x2), .c(new_n18_), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n62_), .c(x0), .O(new_n146_));
  oai21  g130(.a(new_n118_), .b(new_n117_), .c(x1), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(new_n146_), .c(x4), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(x5), .O(new_n149_));
  aoi21  g133(.a(new_n144_), .b(new_n143_), .c(new_n149_), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n138_), .c(new_n29_), .O(z4));
  inv1   g135(.a(new_n60_), .O(new_n152_));
  inv1   g136(.a(new_n140_), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n123_), .c(new_n152_), .O(z5));
endmodule
