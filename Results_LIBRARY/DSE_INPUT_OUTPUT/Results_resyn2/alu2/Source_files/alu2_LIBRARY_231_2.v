...
module FAU ( 
  ...
  nor2   g180(.a(x6), .b(new_n22_), .O(new_n197_));
  inv1   g181(.a(new_n197_), .O(new_n198_));
  nand2  g182(.a(x3), .b(new_n87_), .O(new_n199_));
  nand2  g183(.a(new_n111_), .b(x1), .O(new_n200_));
  nand2  g184(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(new_n198_), .O(z2));
  nor3   g186(.a(new_n197_), .b(new_n111_), .c(new_n87_), .O(z3));
  nand2  g187(.a(new_n87_), .b(new_n17_), .O(new_n204_));
  nand2  g188(.a(new_n204_), .b(new_n111_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(x8), .O(new_n206_));
  aoi21  g190(.a(new_n200_), .b(x2), .c(x4), .O(new_n207_));
  oai21  g191(.a(new_n204_), .b(new_n20_), .c(x7), .O(new_n208_));
  aoi21  g192(.a(new_n207_), .b(new_n206_), .c(new_n208_), .O(new_n209_));
  oai21  g193(.a(new_n141_), .b(x0), .c(new_n199_), .O(new_n210_));
  nand2  g194(.a(new_n210_), .b(new_n20_), .O(new_n211_));
  nand2  g195(.a(new_n200_), .b(new_n168_), .O(new_n212_));
  aoi21  g196(.a(new_n212_), .b(new_n39_), .c(new_n22_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(new_n211_), .O(new_n214_));
  inv1   g198(.a(new_n100_), .O(new_n215_));
  oai21  g199(.a(x2), .b(new_n87_), .c(x8), .O(new_n216_));
  nand4  g200(.a(new_n216_), .b(new_n199_), .c(new_n215_), .d(x7), .O(new_n217_));
  oai21  g201(.a(new_n214_), .b(new_n209_), .c(new_n217_), .O(new_n218_));
  nand2  g202(.a(new_n218_), .b(x6), .O(new_n219_));
  aoi21  g203(.a(x4), .b(x3), .c(x1), .O(new_n220_));
  oai21  g204(.a(x6), .b(x2), .c(x7), .O(new_n221_));
  aoi21  g205(.a(new_n221_), .b(new_n94_), .c(new_n220_), .O(new_n222_));
  aoi21  g206(.a(new_n19_), .b(new_n20_), .c(new_n26_), .O(new_n223_));
  nor2   g207(.a(new_n223_), .b(new_n68_), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n222_), .c(x0), .O(new_n225_));
  nand2  g209(.a(new_n19_), .b(x3), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n99_), .c(new_n32_), .O(new_n227_));
  or2    g211(.a(new_n199_), .b(new_n65_), .O(new_n228_));
  inv1   g212(.a(new_n228_), .O(new_n229_));
  oai21  g213(.a(new_n229_), .b(new_n227_), .c(x4), .O(new_n230_));
  nand2  g214(.a(new_n77_), .b(x2), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n186_), .c(new_n20_), .O(new_n232_));
  nand2  g216(.a(new_n70_), .b(x3), .O(new_n233_));
  oai21  g217(.a(new_n65_), .b(x3), .c(new_n233_), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n232_), .c(x1), .O(new_n235_));
  nand4  g219(.a(new_n235_), .b(new_n230_), .c(new_n225_), .d(new_n105_), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(new_n22_), .O(new_n237_));
  aoi21  g221(.a(new_n237_), .b(new_n219_), .c(new_n18_), .O(z4));
  nand2  g222(.a(x2), .b(new_n17_), .O(new_n239_));
  nand2  g223(.a(new_n168_), .b(new_n239_), .O(new_n240_));
  oai21  g224(.a(new_n240_), .b(new_n201_), .c(new_n198_), .O(z5));
endmodule
