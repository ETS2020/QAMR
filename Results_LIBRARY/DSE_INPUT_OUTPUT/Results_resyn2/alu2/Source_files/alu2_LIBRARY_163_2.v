...
module FAU ( 
  ...
  nand2  g165(.a(new_n34_), .b(x5), .O(new_n182_));
  nand2  g166(.a(x3), .b(new_n166_), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(new_n182_), .c(new_n181_), .O(new_n184_));
  inv1   g168(.a(new_n184_), .O(z2));
  oai21  g169(.a(new_n77_), .b(new_n166_), .c(new_n182_), .O(z3));
  oai22  g170(.a(x3), .b(new_n28_), .c(x2), .d(new_n166_), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n152_), .O(new_n188_));
  oai21  g172(.a(new_n82_), .b(x1), .c(x6), .O(new_n189_));
  oai21  g173(.a(x6), .b(new_n19_), .c(x8), .O(new_n190_));
  aoi21  g174(.a(new_n190_), .b(x0), .c(new_n67_), .O(new_n191_));
  aoi21  g175(.a(new_n191_), .b(new_n189_), .c(x3), .O(new_n192_));
  nand2  g176(.a(new_n20_), .b(x1), .O(new_n193_));
  aoi21  g177(.a(x2), .b(new_n28_), .c(new_n193_), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n192_), .c(x7), .O(new_n195_));
  aoi21  g179(.a(new_n195_), .b(new_n188_), .c(x4), .O(new_n196_));
  oai21  g180(.a(new_n19_), .b(x0), .c(new_n183_), .O(new_n197_));
  oai21  g181(.a(new_n197_), .b(new_n23_), .c(new_n29_), .O(new_n198_));
  oai21  g182(.a(x2), .b(new_n28_), .c(new_n181_), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(x6), .c(x7), .O(new_n200_));
  nand2  g184(.a(new_n200_), .b(new_n198_), .O(new_n201_));
  nand2  g185(.a(new_n87_), .b(x1), .O(new_n202_));
  nand3  g186(.a(new_n202_), .b(new_n148_), .c(x4), .O(new_n203_));
  nand2  g187(.a(new_n86_), .b(new_n67_), .O(new_n204_));
  nand3  g188(.a(new_n204_), .b(new_n203_), .c(new_n201_), .O(new_n205_));
  oai21  g189(.a(new_n205_), .b(new_n196_), .c(x5), .O(new_n206_));
  nand2  g190(.a(new_n113_), .b(new_n20_), .O(new_n207_));
  nand2  g191(.a(x7), .b(x6), .O(new_n208_));
  nand2  g192(.a(new_n152_), .b(x2), .O(new_n209_));
  aoi21  g193(.a(new_n209_), .b(new_n208_), .c(new_n29_), .O(new_n210_));
  nand2  g194(.a(new_n95_), .b(new_n80_), .O(new_n211_));
  oai21  g195(.a(new_n211_), .b(new_n210_), .c(x1), .O(new_n212_));
  nand2  g196(.a(new_n20_), .b(x3), .O(new_n213_));
  nand3  g197(.a(new_n30_), .b(x6), .c(new_n28_), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n213_), .c(new_n19_), .O(new_n215_));
  nand3  g199(.a(new_n113_), .b(x3), .c(new_n166_), .O(new_n216_));
  inv1   g200(.a(new_n216_), .O(new_n217_));
  oai21  g201(.a(new_n217_), .b(new_n215_), .c(x4), .O(new_n218_));
  nand3  g202(.a(new_n218_), .b(new_n212_), .c(new_n207_), .O(new_n219_));
  nand2  g203(.a(new_n219_), .b(new_n17_), .O(new_n220_));
  nand4  g204(.a(new_n133_), .b(new_n29_), .c(x3), .d(x1), .O(new_n221_));
  nand2  g205(.a(new_n101_), .b(new_n166_), .O(new_n222_));
  nor2   g206(.a(new_n59_), .b(new_n30_), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n152_), .c(new_n222_), .O(new_n224_));
  nand2  g208(.a(new_n37_), .b(x4), .O(new_n225_));
  nand3  g209(.a(new_n99_), .b(new_n225_), .c(x6), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n224_), .c(x5), .O(new_n227_));
  nand3  g211(.a(x7), .b(x6), .c(new_n19_), .O(new_n228_));
  nand2  g212(.a(new_n29_), .b(x1), .O(new_n229_));
  aoi21  g213(.a(new_n228_), .b(new_n153_), .c(new_n229_), .O(new_n230_));
  oai21  g214(.a(new_n230_), .b(new_n227_), .c(x0), .O(new_n231_));
  nand3  g215(.a(new_n231_), .b(new_n221_), .c(new_n220_), .O(new_n232_));
  inv1   g216(.a(new_n232_), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n206_), .c(new_n34_), .O(z4));
  oai21  g218(.a(new_n199_), .b(new_n197_), .c(new_n182_), .O(z5));
endmodule
