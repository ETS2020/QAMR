...
module FAU ( 
  ...
  nor2   g113(.a(new_n129_), .b(new_n125_), .O(z2));
  nor2   g114(.a(new_n70_), .b(new_n85_), .O(new_n131_));
  inv1   g115(.a(new_n131_), .O(new_n132_));
  nor2   g116(.a(new_n132_), .b(new_n125_), .O(z3));
  nand3  g117(.a(x7), .b(x3), .c(new_n20_), .O(new_n134_));
  oai21  g118(.a(x8), .b(x6), .c(new_n134_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(x1), .O(new_n136_));
  oai21  g120(.a(new_n25_), .b(x2), .c(x6), .O(new_n137_));
  oai21  g121(.a(new_n25_), .b(new_n20_), .c(new_n68_), .O(new_n138_));
  nand3  g122(.a(new_n138_), .b(new_n137_), .c(new_n70_), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(new_n136_), .c(new_n34_), .O(new_n140_));
  nand2  g124(.a(new_n20_), .b(x0), .O(new_n141_));
  nand2  g125(.a(x2), .b(new_n34_), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nor2   g127(.a(x7), .b(new_n18_), .O(new_n144_));
  nand2  g128(.a(new_n66_), .b(new_n85_), .O(new_n145_));
  aoi21  g129(.a(new_n70_), .b(x1), .c(x8), .O(new_n146_));
  aoi22  g130(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n128_), .O(new_n147_));
  nor2   g131(.a(new_n25_), .b(new_n85_), .O(new_n148_));
  oai21  g132(.a(new_n88_), .b(new_n65_), .c(new_n148_), .O(new_n149_));
  oai21  g133(.a(new_n147_), .b(new_n143_), .c(new_n149_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n140_), .c(new_n36_), .O(new_n151_));
  oai21  g135(.a(new_n131_), .b(new_n97_), .c(x7), .O(new_n152_));
  nand2  g136(.a(new_n141_), .b(new_n126_), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(x6), .c(new_n36_), .O(new_n154_));
  nand3  g138(.a(new_n115_), .b(new_n43_), .c(new_n70_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x5), .O(new_n156_));
  aoi21  g140(.a(new_n154_), .b(new_n152_), .c(new_n156_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n151_), .c(new_n17_), .O(z4));
  inv1   g142(.a(new_n125_), .O(new_n159_));
  oai21  g143(.a(new_n143_), .b(new_n129_), .c(new_n159_), .O(z5));
endmodule
