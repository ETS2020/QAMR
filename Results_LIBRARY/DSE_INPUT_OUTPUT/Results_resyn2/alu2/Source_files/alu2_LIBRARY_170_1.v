...
module FAU ( 
  ...
  nand2  g113(.a(x9), .b(new_n19_), .O(new_n130_));
  oai21  g114(.a(new_n119_), .b(new_n93_), .c(new_n130_), .O(z3));
  ...
  nor2   g143(.a(new_n119_), .b(new_n93_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n129_), .c(new_n152_), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n130_), .O(z5));
endmodule
