...
module FAU ( 
  ...
  oai21  g102(.a(new_n26_), .b(x3), .c(new_n17_), .O(new_n119_));
  inv1   g103(.a(x3), .O(new_n120_));
  nor2   g104(.a(new_n20_), .b(new_n120_), .O(new_n121_));
  nor2   g105(.a(x9), .b(x4), .O(new_n122_));
  aoi22  g106(.a(new_n122_), .b(new_n121_), .c(new_n119_), .d(new_n19_), .O(new_n123_));
  oai21  g107(.a(new_n118_), .b(new_n116_), .c(new_n123_), .O(new_n124_));
  aoi21  g108(.a(new_n115_), .b(new_n93_), .c(new_n124_), .O(new_n125_));
  nand2  g109(.a(new_n125_), .b(new_n92_), .O(z1));
  nor2   g110(.a(new_n17_), .b(x5), .O(new_n127_));
  xor2a  g111(.a(x3), .b(x1), .O(new_n128_));
  nor2   g112(.a(new_n128_), .b(new_n127_), .O(z2));
  nor3   g113(.a(new_n127_), .b(new_n120_), .c(new_n93_), .O(z3));
  oai22  g114(.a(new_n20_), .b(x4), .c(new_n25_), .d(x1), .O(new_n131_));
  nand2  g115(.a(new_n94_), .b(x0), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(new_n93_), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g118(.a(new_n25_), .b(new_n18_), .O(new_n135_));
  nor2   g119(.a(new_n135_), .b(x1), .O(new_n136_));
  oai21  g120(.a(new_n46_), .b(new_n20_), .c(new_n136_), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n134_), .c(new_n26_), .O(new_n138_));
  nand3  g122(.a(new_n46_), .b(new_n26_), .c(new_n25_), .O(new_n139_));
  aoi21  g123(.a(new_n20_), .b(x6), .c(x8), .O(new_n140_));
  nor2   g124(.a(new_n94_), .b(x6), .O(new_n141_));
  nor2   g125(.a(x4), .b(new_n18_), .O(new_n142_));
  oai21  g126(.a(new_n141_), .b(new_n140_), .c(new_n142_), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(new_n138_), .c(new_n120_), .O(new_n145_));
  oai21  g129(.a(x7), .b(new_n26_), .c(x8), .O(new_n146_));
  nand2  g130(.a(new_n135_), .b(new_n74_), .O(new_n147_));
  oai21  g131(.a(x2), .b(new_n18_), .c(x6), .O(new_n148_));
  aoi22  g132(.a(new_n148_), .b(x7), .c(new_n147_), .d(new_n146_), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n120_), .c(new_n139_), .O(new_n150_));
  nor2   g134(.a(x4), .b(new_n93_), .O(new_n151_));
  oai21  g135(.a(new_n120_), .b(new_n25_), .c(x6), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n94_), .c(new_n18_), .O(new_n153_));
  nor2   g137(.a(new_n26_), .b(x3), .O(new_n154_));
  oai21  g138(.a(new_n121_), .b(new_n154_), .c(x1), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x4), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n153_), .c(x5), .O(new_n157_));
  aoi21  g141(.a(new_n151_), .b(new_n150_), .c(new_n157_), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n145_), .c(new_n17_), .O(z4));
  inv1   g143(.a(new_n127_), .O(new_n160_));
  inv1   g144(.a(new_n147_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n128_), .c(new_n160_), .O(z5));
endmodule
