// Benchmark "FAU" written by ABC on Sun Aug  9 00:29:02 2020
...
module FAU ( 
  ...
  nor2   g153(.a(new_n169_), .b(new_n92_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(new_n168_), .O(z2));
  and2   g155(.a(new_n169_), .b(new_n168_), .O(z3));
  inv1   g156(.a(new_n126_), .O(new_n173_));
  aoi21  g157(.a(new_n154_), .b(new_n112_), .c(new_n18_), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(new_n173_), .c(new_n19_), .O(new_n175_));
  nand2  g159(.a(new_n145_), .b(x3), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n175_), .c(x5), .O(new_n177_));
  oai21  g161(.a(x2), .b(new_n112_), .c(x3), .O(new_n178_));
  nand2  g162(.a(x2), .b(new_n18_), .O(new_n179_));
  and2   g163(.a(new_n179_), .b(new_n113_), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n178_), .c(x4), .O(new_n181_));
  aoi21  g165(.a(x2), .b(x0), .c(new_n169_), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n93_), .c(x5), .O(new_n183_));
  oai22  g167(.a(x8), .b(new_n18_), .c(new_n34_), .d(new_n84_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n25_), .c(x1), .O(new_n185_));
  oai21  g169(.a(new_n183_), .b(new_n181_), .c(new_n185_), .O(new_n186_));
  oai21  g170(.a(new_n186_), .b(new_n177_), .c(new_n17_), .O(new_n187_));
  nand2  g171(.a(new_n174_), .b(x7), .O(new_n188_));
  nand3  g172(.a(new_n19_), .b(x4), .c(x3), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n188_), .c(new_n36_), .O(new_n190_));
  nand2  g174(.a(x7), .b(x0), .O(new_n191_));
  nand2  g175(.a(new_n34_), .b(new_n112_), .O(new_n192_));
  aoi21  g176(.a(new_n192_), .b(new_n191_), .c(new_n84_), .O(new_n193_));
  oai21  g177(.a(new_n179_), .b(x7), .c(new_n140_), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n193_), .c(x4), .O(new_n195_));
  nand4  g179(.a(new_n132_), .b(new_n97_), .c(new_n93_), .d(x0), .O(new_n196_));
  nand2  g180(.a(new_n19_), .b(new_n34_), .O(new_n197_));
  oai21  g181(.a(x7), .b(x3), .c(new_n191_), .O(new_n198_));
  nand2  g182(.a(new_n198_), .b(x1), .O(new_n199_));
  nand3  g183(.a(new_n199_), .b(new_n197_), .c(new_n196_), .O(new_n200_));
  inv1   g184(.a(new_n200_), .O(new_n201_));
  aoi21  g185(.a(new_n201_), .b(new_n195_), .c(new_n17_), .O(new_n202_));
  oai21  g186(.a(new_n202_), .b(new_n190_), .c(new_n22_), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(new_n187_), .c(new_n23_), .O(z4));
  inv1   g188(.a(new_n88_), .O(new_n205_));
  oai21  g189(.a(new_n170_), .b(new_n205_), .c(new_n168_), .O(z5));
endmodule
