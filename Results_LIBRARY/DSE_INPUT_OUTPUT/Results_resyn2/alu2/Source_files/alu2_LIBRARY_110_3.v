...
module FAU ( 
  ...
  inv1   g147(.a(new_n160_), .O(new_n164_));
  nor2   g148(.a(new_n164_), .b(new_n159_), .O(z3));
  aoi22  g149(.a(new_n103_), .b(new_n102_), .c(x7), .d(new_n114_), .O(new_n166_));
  oai21  g150(.a(new_n17_), .b(new_n76_), .c(new_n114_), .O(new_n167_));
  nand2  g151(.a(new_n160_), .b(new_n80_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  oai21  g153(.a(new_n71_), .b(new_n114_), .c(x7), .O(new_n170_));
  aoi21  g154(.a(new_n97_), .b(x0), .c(new_n170_), .O(new_n171_));
  aoi21  g155(.a(new_n169_), .b(x8), .c(new_n171_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n166_), .c(x6), .O(new_n173_));
  nand2  g157(.a(new_n167_), .b(new_n131_), .O(new_n174_));
  nand2  g158(.a(new_n160_), .b(x7), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n174_), .c(new_n21_), .O(new_n176_));
  inv1   g160(.a(new_n146_), .O(new_n177_));
  oai21  g161(.a(new_n177_), .b(new_n86_), .c(x1), .O(new_n178_));
  aoi21  g162(.a(new_n86_), .b(x3), .c(x5), .O(new_n179_));
  nand2  g163(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nor2   g164(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n173_), .c(new_n33_), .O(z4));
  inv1   g166(.a(new_n159_), .O(new_n183_));
  nand2  g167(.a(x2), .b(new_n21_), .O(new_n184_));
  nand2  g168(.a(new_n184_), .b(new_n102_), .O(new_n185_));
  oai21  g169(.a(new_n185_), .b(new_n162_), .c(new_n183_), .O(z5));
endmodule
