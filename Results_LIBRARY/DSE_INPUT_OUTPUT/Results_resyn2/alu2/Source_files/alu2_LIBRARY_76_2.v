...
module FAU ( 
  ...
  nand2  g172(.a(x3), .b(new_n150_), .O(new_n189_));
  nor2   g173(.a(x9), .b(new_n21_), .O(new_n190_));
  inv1   g174(.a(new_n190_), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n189_), .c(new_n188_), .O(new_n192_));
  inv1   g176(.a(new_n192_), .O(z2));
  oai21  g177(.a(new_n77_), .b(new_n150_), .c(new_n191_), .O(z3));
  nand2  g178(.a(x2), .b(new_n50_), .O(new_n195_));
  nand3  g179(.a(new_n189_), .b(new_n195_), .c(new_n17_), .O(new_n196_));
  ...
  nand2  g189(.a(new_n189_), .b(new_n195_), .O(new_n206_));
  ...
  nor3   g226(.a(new_n208_), .b(new_n206_), .c(new_n190_), .O(z5));
endmodule
