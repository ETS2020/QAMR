...
module FAU ( 
  ...
  oai21  g144(.a(new_n76_), .b(new_n114_), .c(new_n160_), .O(z3));
  or2    g145(.a(z3), .b(new_n159_), .O(z2));
  aoi22  g146(.a(new_n103_), .b(new_n102_), .c(x7), .d(new_n114_), .O(new_n163_));
  oai21  g147(.a(new_n17_), .b(new_n76_), .c(new_n114_), .O(new_n164_));
  nor2   g148(.a(new_n76_), .b(new_n114_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n80_), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  oai21  g151(.a(new_n71_), .b(new_n114_), .c(x7), .O(new_n168_));
  aoi21  g152(.a(new_n97_), .b(x0), .c(new_n168_), .O(new_n169_));
  aoi21  g153(.a(new_n167_), .b(x8), .c(new_n169_), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n163_), .c(x6), .O(new_n171_));
  nand2  g155(.a(new_n164_), .b(new_n131_), .O(new_n172_));
  nand2  g156(.a(new_n165_), .b(x7), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n172_), .c(new_n21_), .O(new_n174_));
  inv1   g158(.a(new_n146_), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n86_), .c(x1), .O(new_n176_));
  aoi21  g160(.a(new_n86_), .b(x3), .c(x5), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nor2   g162(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n171_), .c(new_n33_), .O(z4));
  nor2   g164(.a(new_n165_), .b(new_n159_), .O(new_n181_));
  nand2  g165(.a(x2), .b(new_n21_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(new_n102_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n181_), .c(new_n160_), .O(z5));
endmodule
