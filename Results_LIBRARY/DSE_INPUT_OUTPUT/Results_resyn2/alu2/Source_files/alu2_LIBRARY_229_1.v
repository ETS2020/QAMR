...
module FAU ( 
  ...
  nand2  g030(.a(x6), .b(x4), .O(new_n47_));
  nand2  g031(.a(x7), .b(x6), .O(new_n48_));
  nand2  g032(.a(x7), .b(new_n29_), .O(new_n49_));
  nand3  g033(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n50_));
  nand2  g034(.a(new_n50_), .b(x0), .O(new_n51_));
  nand2  g035(.a(new_n29_), .b(new_n18_), .O(new_n52_));
  aoi22  g036(.a(new_n52_), .b(x7), .c(new_n19_), .d(x5), .O(new_n53_));
  nand2  g037(.a(new_n53_), .b(new_n31_), .O(new_n54_));
  nor2   g038(.a(new_n22_), .b(x5), .O(new_n55_));
  nor2   g039(.a(new_n55_), .b(x2), .O(new_n56_));
  nand3  g040(.a(new_n56_), .b(new_n54_), .c(new_n51_), .O(new_n57_));
  aoi22  g041(.a(new_n52_), .b(x6), .c(new_n49_), .d(x4), .O(new_n58_));
  nand2  g042(.a(new_n58_), .b(new_n31_), .O(new_n59_));
  aoi22  g043(.a(new_n48_), .b(new_n29_), .c(new_n19_), .d(new_n32_), .O(new_n60_));
  nand2  g044(.a(new_n60_), .b(x0), .O(new_n61_));
  nand2  g045(.a(x7), .b(new_n18_), .O(new_n62_));
  nand4  g046(.a(new_n62_), .b(new_n61_), .c(new_n59_), .d(x2), .O(new_n63_));
  nand3  g047(.a(new_n63_), .b(new_n57_), .c(new_n17_), .O(new_n64_));
  nand2  g048(.a(new_n64_), .b(new_n46_), .O(z0));
  nand2  g049(.a(x9), .b(x3), .O(new_n66_));
  oai21  g050(.a(new_n22_), .b(x3), .c(new_n66_), .O(new_n67_));
  nor2   g051(.a(new_n66_), .b(x8), .O(new_n68_));
  aoi21  g052(.a(new_n67_), .b(x0), .c(new_n68_), .O(new_n69_));
  nor2   g053(.a(new_n22_), .b(x3), .O(new_n70_));
  nor3   g054(.a(x7), .b(x5), .c(x0), .O(new_n71_));
  oai21  g055(.a(new_n71_), .b(new_n24_), .c(new_n70_), .O(new_n72_));
  oai21  g056(.a(new_n69_), .b(new_n32_), .c(new_n72_), .O(new_n73_));
  nand2  g057(.a(new_n73_), .b(x1), .O(new_n74_));
  inv1   g058(.a(x3), .O(new_n75_));
  oai21  g059(.a(new_n24_), .b(new_n75_), .c(new_n29_), .O(new_n76_));
  ...
  nand3  g067(.a(new_n83_), .b(new_n36_), .c(new_n75_), .O(new_n84_));
  ...
  aoi21  g072(.a(new_n88_), .b(new_n74_), .c(new_n18_), .O(new_n89_));
  ...
  nand2  g093(.a(new_n49_), .b(x8), .O(new_n110_));
  ...
  aoi21  g103(.a(new_n119_), .b(new_n114_), .c(new_n75_), .O(new_n120_));
  nand3  g104(.a(x7), .b(x6), .c(new_n29_), .O(new_n121_));
  nand3  g105(.a(x9), .b(new_n22_), .c(new_n75_), .O(new_n122_));
  ...
  nor2   g119(.a(x7), .b(new_n75_), .O(new_n136_));
  nand2  g120(.a(new_n24_), .b(x1), .O(new_n137_));
  oai22  g121(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n79_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n55_), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(new_n134_), .c(new_n107_), .O(new_n140_));
  oai21  g124(.a(new_n140_), .b(new_n89_), .c(x2), .O(new_n141_));
  nand2  g125(.a(new_n50_), .b(x1), .O(new_n142_));
  nand2  g126(.a(new_n53_), .b(new_n78_), .O(new_n143_));
  nor2   g127(.a(new_n55_), .b(x3), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  nand2  g129(.a(new_n58_), .b(new_n78_), .O(new_n146_));
  nand2  g130(.a(new_n60_), .b(x1), .O(new_n147_));
  nand4  g131(.a(new_n147_), .b(new_n146_), .c(new_n62_), .d(x3), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n145_), .c(new_n17_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n141_), .O(z1));
  nor2   g134(.a(new_n17_), .b(x2), .O(new_n151_));
  nand2  g135(.a(x3), .b(x1), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n135_), .c(new_n151_), .O(z2));
  nor2   g137(.a(new_n152_), .b(new_n151_), .O(z3));
  nand2  g138(.a(new_n152_), .b(new_n31_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x7), .O(new_n156_));
  nand2  g140(.a(new_n70_), .b(x1), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n156_), .c(new_n18_), .O(new_n158_));
  aoi21  g142(.a(new_n36_), .b(x8), .c(new_n152_), .O(new_n159_));
  inv1   g143(.a(new_n115_), .O(new_n160_));
  nand2  g144(.a(x8), .b(x7), .O(new_n161_));
  nand3  g145(.a(new_n161_), .b(x6), .c(new_n78_), .O(new_n162_));
  aoi21  g146(.a(new_n162_), .b(new_n160_), .c(x3), .O(new_n163_));
  oai21  g147(.a(new_n163_), .b(new_n159_), .c(x0), .O(new_n164_));
  inv1   g148(.a(new_n157_), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(x7), .c(x4), .O(new_n166_));
  aoi21  g150(.a(new_n166_), .b(new_n164_), .c(new_n158_), .O(new_n167_));
  oai21  g151(.a(x8), .b(x6), .c(new_n48_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(x4), .O(new_n169_));
  nand2  g153(.a(new_n36_), .b(new_n75_), .O(new_n170_));
  oai21  g154(.a(new_n112_), .b(new_n75_), .c(new_n170_), .O(new_n171_));
  nor2   g155(.a(x8), .b(x6), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(x7), .c(x0), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(new_n171_), .c(new_n169_), .O(new_n174_));
  nand2  g158(.a(new_n174_), .b(x1), .O(new_n175_));
  oai22  g159(.a(new_n97_), .b(new_n75_), .c(new_n36_), .d(x0), .O(new_n176_));
  oai21  g160(.a(new_n36_), .b(x8), .c(new_n29_), .O(new_n177_));
  aoi21  g161(.a(new_n176_), .b(x4), .c(new_n177_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  oai21  g163(.a(new_n167_), .b(new_n29_), .c(new_n179_), .O(new_n180_));
  oai22  g164(.a(new_n152_), .b(new_n102_), .c(new_n30_), .d(new_n31_), .O(new_n181_));
  nor4   g165(.a(new_n36_), .b(new_n18_), .c(new_n75_), .d(x1), .O(new_n182_));
  aoi21  g166(.a(new_n181_), .b(new_n18_), .c(new_n182_), .O(new_n183_));
  nand2  g167(.a(x9), .b(x2), .O(new_n184_));
  aoi21  g168(.a(new_n183_), .b(new_n180_), .c(new_n184_), .O(z4));
  xnor2a g169(.a(x2), .b(x0), .O(new_n186_));
  and2   g170(.a(new_n186_), .b(z2), .O(z5));
endmodule
