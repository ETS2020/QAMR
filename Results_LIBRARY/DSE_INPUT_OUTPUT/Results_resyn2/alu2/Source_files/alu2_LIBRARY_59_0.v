...
module FAU ( 
  ...
  nor2   g185(.a(new_n201_), .b(new_n197_), .O(z3));
  nand2  g186(.a(new_n34_), .b(new_n17_), .O(new_n203_));
  oai22  g187(.a(new_n199_), .b(new_n76_), .c(new_n201_), .d(new_n203_), .O(new_n204_));
  nand2  g188(.a(x7), .b(new_n128_), .O(new_n205_));
  aoi21  g189(.a(new_n138_), .b(new_n111_), .c(new_n205_), .O(new_n206_));
  aoi21  g190(.a(new_n204_), .b(new_n172_), .c(new_n206_), .O(new_n207_));
  nand3  g191(.a(new_n154_), .b(x7), .c(x1), .O(new_n208_));
  oai21  g192(.a(new_n207_), .b(new_n18_), .c(new_n208_), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n33_), .O(new_n210_));
  nand2  g194(.a(x7), .b(x0), .O(new_n211_));
  nand2  g195(.a(new_n32_), .b(new_n111_), .O(new_n212_));
  aoi21  g196(.a(new_n212_), .b(new_n211_), .c(new_n128_), .O(new_n213_));
  nand2  g197(.a(x7), .b(x1), .O(new_n214_));
  oai21  g198(.a(new_n92_), .b(x7), .c(new_n214_), .O(new_n215_));
  oai21  g199(.a(new_n215_), .b(new_n213_), .c(x4), .O(new_n216_));
  aoi21  g200(.a(new_n32_), .b(x3), .c(new_n111_), .O(new_n217_));
  oai21  g201(.a(new_n32_), .b(x0), .c(new_n217_), .O(new_n218_));
  oai21  g202(.a(new_n114_), .b(new_n20_), .c(x0), .O(new_n219_));
  nand4  g203(.a(new_n219_), .b(new_n218_), .c(new_n216_), .d(new_n82_), .O(new_n220_));
  nand2  g204(.a(new_n172_), .b(x5), .O(new_n221_));
  nor4   g205(.a(new_n221_), .b(new_n203_), .c(x3), .d(x1), .O(new_n222_));
  aoi21  g206(.a(new_n220_), .b(new_n18_), .c(new_n222_), .O(new_n223_));
  aoi21  g207(.a(new_n223_), .b(new_n210_), .c(new_n27_), .O(new_n224_));
  nand2  g208(.a(new_n157_), .b(x4), .O(new_n225_));
  nor2   g209(.a(new_n129_), .b(x1), .O(new_n226_));
  oai21  g210(.a(new_n226_), .b(new_n211_), .c(new_n225_), .O(new_n227_));
  ...
  oai22  g214(.a(new_n230_), .b(new_n217_), .c(new_n229_), .d(new_n34_), .O(new_n231_));
  ...
  oai21  g228(.a(new_n243_), .b(new_n211_), .c(new_n244_), .O(new_n245_));
  ...
  nor2   g233(.a(new_n187_), .b(new_n143_), .O(new_n250_));
  oai21  g234(.a(new_n250_), .b(new_n199_), .c(new_n198_), .O(z5));
endmodule
