...
module FAU ( 
  ...
  nor2   g192(.a(x9), .b(x8), .O(new_n209_));
  inv1   g193(.a(new_n209_), .O(new_n210_));
  nor2   g194(.a(x3), .b(new_n100_), .O(new_n211_));
  oai21  g195(.a(new_n211_), .b(new_n109_), .c(new_n210_), .O(z2));
  nor3   g196(.a(new_n209_), .b(new_n108_), .c(new_n100_), .O(z3));
  inv1   g197(.a(new_n109_), .O(new_n214_));
  nand3  g198(.a(new_n185_), .b(new_n184_), .c(new_n214_), .O(new_n215_));
  nand2  g199(.a(new_n202_), .b(new_n38_), .O(new_n216_));
  nand2  g200(.a(new_n216_), .b(new_n113_), .O(new_n217_));
  nand2  g201(.a(new_n217_), .b(new_n108_), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(new_n215_), .c(new_n17_), .O(new_n219_));
  nand2  g203(.a(new_n61_), .b(x1), .O(new_n220_));
  nand2  g204(.a(new_n108_), .b(x0), .O(new_n221_));
  nand2  g205(.a(new_n32_), .b(new_n38_), .O(new_n222_));
  aoi21  g206(.a(new_n221_), .b(new_n220_), .c(new_n222_), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n219_), .c(new_n18_), .O(new_n224_));
  nor2   g208(.a(new_n211_), .b(new_n109_), .O(new_n225_));
  nor2   g209(.a(x2), .b(x0), .O(new_n226_));
  oai21  g210(.a(new_n226_), .b(new_n202_), .c(new_n225_), .O(new_n227_));
  nor2   g211(.a(new_n211_), .b(new_n61_), .O(new_n228_));
  oai21  g212(.a(new_n108_), .b(x0), .c(x6), .O(new_n229_));
  oai21  g213(.a(new_n229_), .b(new_n228_), .c(x4), .O(new_n230_));
  oai21  g214(.a(new_n227_), .b(new_n38_), .c(new_n230_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n17_), .O(new_n232_));
  nand2  g216(.a(new_n107_), .b(x0), .O(new_n233_));
  oai21  g217(.a(x6), .b(x3), .c(x1), .O(new_n234_));
  nand3  g218(.a(new_n234_), .b(new_n233_), .c(x4), .O(new_n235_));
  aoi21  g219(.a(new_n159_), .b(new_n92_), .c(new_n30_), .O(new_n236_));
  nand4  g220(.a(new_n236_), .b(new_n235_), .c(new_n232_), .d(new_n224_), .O(new_n237_));
  oai21  g221(.a(new_n162_), .b(new_n32_), .c(x6), .O(new_n238_));
  nand2  g222(.a(new_n194_), .b(x4), .O(new_n239_));
  aoi21  g223(.a(new_n239_), .b(new_n238_), .c(new_n108_), .O(new_n240_));
  nor2   g224(.a(new_n90_), .b(new_n22_), .O(new_n241_));
  nor2   g225(.a(new_n241_), .b(new_n38_), .O(new_n242_));
  oai21  g226(.a(new_n242_), .b(new_n240_), .c(x0), .O(new_n243_));
  aoi21  g227(.a(new_n33_), .b(new_n76_), .c(new_n189_), .O(new_n244_));
  oai22  g228(.a(new_n244_), .b(new_n61_), .c(new_n214_), .d(new_n26_), .O(new_n245_));
  nand2  g229(.a(new_n245_), .b(x4), .O(new_n246_));
  nand3  g230(.a(x8), .b(x7), .c(x0), .O(new_n247_));
  inv1   g231(.a(new_n247_), .O(new_n248_));
  oai21  g232(.a(new_n248_), .b(new_n24_), .c(new_n107_), .O(new_n249_));
  oai21  g233(.a(new_n175_), .b(new_n121_), .c(new_n38_), .O(new_n250_));
  nor2   g234(.a(x7), .b(x3), .O(new_n251_));
  oai21  g235(.a(new_n251_), .b(new_n162_), .c(x6), .O(new_n252_));
  nand3  g236(.a(new_n252_), .b(new_n250_), .c(new_n249_), .O(new_n253_));
  nand2  g237(.a(new_n34_), .b(new_n30_), .O(new_n254_));
  aoi21  g238(.a(new_n253_), .b(x1), .c(new_n254_), .O(new_n255_));
  nand3  g239(.a(new_n255_), .b(new_n246_), .c(new_n243_), .O(new_n256_));
  nand2  g240(.a(new_n256_), .b(new_n237_), .O(new_n257_));
  inv1   g241(.a(new_n250_), .O(new_n258_));
  nand3  g242(.a(new_n258_), .b(new_n18_), .c(x1), .O(new_n259_));
  aoi21  g243(.a(new_n259_), .b(new_n257_), .c(new_n29_), .O(z4));
  nand2  g244(.a(new_n227_), .b(new_n210_), .O(z5));
endmodule
