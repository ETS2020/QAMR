...
module FAU ( 
  ...
  inv1   g128(.a(new_n62_), .O(new_n145_));
  inv1   g129(.a(new_n141_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n145_), .O(z3));
  oai21  g131(.a(new_n17_), .b(new_n26_), .c(new_n32_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n101_), .O(new_n149_));
  nand2  g133(.a(x4), .b(new_n116_), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(x8), .c(new_n17_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(new_n149_), .c(new_n69_), .O(new_n152_));
  aoi21  g136(.a(x7), .b(new_n46_), .c(new_n141_), .O(new_n153_));
  oai21  g137(.a(new_n121_), .b(x1), .c(new_n153_), .O(new_n154_));
  nand2  g138(.a(x7), .b(new_n101_), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n66_), .c(new_n65_), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n154_), .c(new_n152_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(x6), .O(new_n158_));
  nand3  g142(.a(new_n32_), .b(x4), .c(x2), .O(new_n159_));
  oai21  g143(.a(new_n159_), .b(x1), .c(x6), .O(new_n160_));
  nand2  g144(.a(new_n141_), .b(x7), .O(new_n161_));
  aoi21  g145(.a(new_n161_), .b(new_n159_), .c(new_n142_), .O(new_n162_));
  oai21  g146(.a(new_n136_), .b(new_n116_), .c(new_n101_), .O(new_n163_));
  and2   g147(.a(new_n111_), .b(x0), .O(new_n164_));
  aoi22  g148(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n160_), .O(new_n165_));
  nand2  g149(.a(x9), .b(new_n29_), .O(new_n166_));
  aoi21  g150(.a(new_n165_), .b(new_n158_), .c(new_n166_), .O(z4));
  nor2   g151(.a(new_n70_), .b(new_n94_), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n143_), .c(new_n145_), .O(z5));
endmodule
