...
module FAU ( 
  ...
  inv1   g101(.a(new_n60_), .O(new_n118_));
  nor2   g102(.a(x3), .b(x1), .O(new_n119_));
  nor2   g103(.a(new_n66_), .b(new_n69_), .O(new_n120_));
  nor2   g104(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g105(.a(new_n121_), .b(new_n118_), .O(z2));
  inv1   g106(.a(new_n120_), .O(new_n123_));
  nor2   g107(.a(new_n123_), .b(new_n60_), .O(z3));
  nand2  g108(.a(new_n82_), .b(x3), .O(new_n125_));
  inv1   g109(.a(new_n119_), .O(new_n126_));
  nand3  g110(.a(new_n126_), .b(new_n24_), .c(x2), .O(new_n127_));
  nand3  g111(.a(new_n127_), .b(new_n125_), .c(new_n19_), .O(new_n128_));
  oai21  g112(.a(new_n31_), .b(new_n17_), .c(new_n123_), .O(new_n129_));
  nand3  g113(.a(new_n129_), .b(x7), .c(x5), .O(new_n130_));
  nand3  g114(.a(new_n130_), .b(new_n128_), .c(x4), .O(new_n131_));
  nand3  g115(.a(new_n24_), .b(new_n23_), .c(x1), .O(new_n132_));
  nand2  g116(.a(new_n19_), .b(new_n69_), .O(new_n133_));
  nand2  g117(.a(x5), .b(x4), .O(new_n134_));
  nand4  g118(.a(new_n134_), .b(new_n133_), .c(new_n103_), .d(new_n75_), .O(new_n135_));
  aoi21  g119(.a(new_n135_), .b(new_n132_), .c(new_n17_), .O(new_n136_));
  aoi21  g120(.a(new_n23_), .b(x1), .c(new_n66_), .O(new_n137_));
  nand3  g121(.a(new_n134_), .b(new_n120_), .c(x7), .O(new_n138_));
  oai21  g122(.a(new_n137_), .b(new_n83_), .c(new_n138_), .O(new_n139_));
  nor2   g123(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g124(.a(x9), .b(new_n51_), .O(new_n141_));
  aoi21  g125(.a(new_n140_), .b(new_n131_), .c(new_n141_), .O(z4));
  inv1   g126(.a(new_n121_), .O(new_n143_));
  xnor2a g127(.a(x2), .b(x0), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(new_n143_), .c(new_n118_), .O(new_n145_));
