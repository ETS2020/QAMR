...
module FAU ( 
  ...
  nand2  g113(.a(new_n129_), .b(new_n61_), .O(z2));
  ...
  nand2  g125(.a(new_n69_), .b(x1), .O(new_n142_));
  nand2  g126(.a(new_n27_), .b(x0), .O(new_n143_));
  ...
  nand2  g140(.a(new_n143_), .b(new_n141_), .O(new_n157_));
