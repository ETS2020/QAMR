...
module FAU ( 
  ...
  nand3  g152(.a(new_n18_), .b(new_n29_), .c(x4), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n86_), .c(new_n168_), .O(new_n170_));
  nor2   g154(.a(new_n170_), .b(new_n166_), .O(new_n171_));
  nand3  g155(.a(new_n171_), .b(new_n164_), .c(new_n118_), .O(z1));
  nor2   g156(.a(x3), .b(new_n69_), .O(new_n173_));
  nor2   g157(.a(new_n70_), .b(x1), .O(new_n174_));
  or2    g158(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n168_), .O(z2));
  nand2  g160(.a(x3), .b(x1), .O(new_n177_));
  nor2   g161(.a(new_n177_), .b(new_n167_), .O(z3));
  xor2a  g162(.a(x2), .b(x0), .O(new_n179_));
  aoi21  g163(.a(new_n105_), .b(x8), .c(new_n179_), .O(new_n180_));
  nand3  g164(.a(x7), .b(new_n17_), .c(x0), .O(new_n181_));
  inv1   g165(.a(new_n181_), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n180_), .c(x3), .O(new_n183_));
  aoi22  g167(.a(new_n111_), .b(new_n70_), .c(new_n24_), .d(new_n85_), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n183_), .c(new_n69_), .O(new_n185_));
  nand3  g169(.a(x8), .b(x7), .c(x6), .O(new_n186_));
  nand2  g170(.a(x6), .b(x1), .O(new_n187_));
  nand2  g171(.a(new_n18_), .b(new_n29_), .O(new_n188_));
  nand4  g172(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(x2), .O(new_n189_));
  nand2  g173(.a(new_n85_), .b(new_n29_), .O(new_n190_));
  nand2  g174(.a(new_n123_), .b(x6), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n190_), .c(new_n189_), .O(new_n192_));
  nand2  g176(.a(new_n192_), .b(x0), .O(new_n193_));
  nand2  g177(.a(new_n123_), .b(new_n85_), .O(new_n194_));
  aoi21  g178(.a(new_n194_), .b(new_n193_), .c(x3), .O(new_n195_));
  oai21  g179(.a(new_n195_), .b(new_n185_), .c(new_n46_), .O(new_n196_));
  nand3  g180(.a(new_n38_), .b(new_n69_), .c(new_n36_), .O(new_n197_));
  aoi21  g181(.a(new_n197_), .b(new_n190_), .c(new_n109_), .O(new_n198_));
  inv1   g182(.a(new_n97_), .O(new_n199_));
  oai21  g183(.a(new_n173_), .b(new_n199_), .c(x6), .O(new_n200_));
  oai21  g184(.a(new_n17_), .b(new_n36_), .c(new_n177_), .O(new_n201_));
  aoi21  g185(.a(new_n201_), .b(x7), .c(new_n46_), .O(new_n202_));
  aoi21  g186(.a(new_n202_), .b(new_n200_), .c(new_n198_), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(new_n196_), .c(new_n37_), .O(new_n204_));
  nand3  g188(.a(x7), .b(new_n29_), .c(x3), .O(new_n205_));
  nor3   g189(.a(new_n205_), .b(x4), .c(new_n69_), .O(new_n206_));
  oai21  g190(.a(new_n206_), .b(new_n204_), .c(x9), .O(new_n207_));
  aoi22  g191(.a(new_n190_), .b(new_n28_), .c(new_n74_), .d(new_n69_), .O(new_n208_));
  nand2  g192(.a(new_n85_), .b(new_n46_), .O(new_n209_));
  aoi21  g193(.a(new_n209_), .b(new_n22_), .c(new_n29_), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n208_), .c(x0), .O(new_n211_));
  aoi21  g195(.a(new_n38_), .b(new_n85_), .c(new_n65_), .O(new_n212_));
  inv1   g196(.a(new_n111_), .O(new_n213_));
  nand3  g197(.a(new_n85_), .b(new_n29_), .c(x2), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n213_), .c(new_n46_), .O(new_n215_));
  nand2  g199(.a(new_n205_), .b(new_n108_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n215_), .c(x1), .O(new_n217_));
  nand2  g201(.a(new_n38_), .b(new_n36_), .O(new_n218_));
  nand2  g202(.a(new_n85_), .b(x3), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n218_), .c(new_n17_), .O(new_n220_));
  nand2  g204(.a(new_n174_), .b(new_n38_), .O(new_n221_));
  inv1   g205(.a(new_n221_), .O(new_n222_));
  oai21  g206(.a(new_n222_), .b(new_n220_), .c(x4), .O(new_n223_));
  nand4  g207(.a(new_n223_), .b(new_n217_), .c(new_n212_), .d(new_n211_), .O(new_n224_));
  nand2  g208(.a(new_n224_), .b(new_n37_), .O(new_n225_));
  nand2  g209(.a(new_n225_), .b(new_n207_), .O(z4));
  oai21  g210(.a(new_n179_), .b(new_n175_), .c(new_n168_), .O(z5));
endmodule
