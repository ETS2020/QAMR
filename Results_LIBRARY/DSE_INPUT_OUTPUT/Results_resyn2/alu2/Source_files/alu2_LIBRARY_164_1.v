...
module FAU ( 
  ...
  nor2   g115(.a(new_n70_), .b(new_n86_), .O(new_n132_));
  inv1   g116(.a(new_n132_), .O(new_n133_));
  nor2   g117(.a(new_n133_), .b(new_n126_), .O(z3));
  inv1   g118(.a(new_n116_), .O(new_n135_));
  nand3  g119(.a(x7), .b(x3), .c(new_n20_), .O(new_n136_));
  oai21  g120(.a(x8), .b(x6), .c(new_n136_), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(x1), .O(new_n138_));
  oai21  g122(.a(new_n25_), .b(x2), .c(x6), .O(new_n139_));
  oai21  g123(.a(new_n25_), .b(new_n20_), .c(new_n68_), .O(new_n140_));
  nand3  g124(.a(new_n140_), .b(new_n139_), .c(new_n70_), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n138_), .c(new_n34_), .O(new_n142_));
  nand2  g126(.a(new_n20_), .b(x0), .O(new_n143_));
  nand2  g127(.a(x2), .b(new_n34_), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nor2   g129(.a(x7), .b(new_n18_), .O(new_n146_));
  nand2  g130(.a(new_n66_), .b(new_n86_), .O(new_n147_));
  aoi21  g131(.a(new_n70_), .b(x1), .c(x8), .O(new_n148_));
  aoi22  g132(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n129_), .O(new_n149_));
  nor2   g133(.a(new_n25_), .b(new_n86_), .O(new_n150_));
  oai21  g134(.a(new_n89_), .b(new_n65_), .c(new_n150_), .O(new_n151_));
  oai21  g135(.a(new_n149_), .b(new_n145_), .c(new_n151_), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(new_n142_), .c(new_n36_), .O(new_n153_));
  oai21  g137(.a(new_n132_), .b(new_n98_), .c(x7), .O(new_n154_));
  nand2  g138(.a(new_n143_), .b(new_n127_), .O(new_n155_));
  aoi21  g139(.a(new_n155_), .b(x6), .c(new_n36_), .O(new_n156_));
  aoi22  g140(.a(new_n156_), .b(new_n154_), .c(new_n113_), .d(new_n81_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n153_), .c(new_n135_), .O(z4));
  inv1   g142(.a(new_n126_), .O(new_n159_));
  oai21  g143(.a(new_n145_), .b(new_n130_), .c(new_n159_), .O(z5));
endmodule
