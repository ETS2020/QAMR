...
module FAU ( 
  ...
  nand2  g137(.a(x2), .b(new_n98_), .O(new_n154_));
  inv1   g138(.a(new_n154_), .O(new_n155_));
  nand4  g139(.a(new_n155_), .b(new_n19_), .c(new_n22_), .d(new_n105_), .O(new_n156_));
  aoi21  g140(.a(x7), .b(new_n35_), .c(new_n98_), .O(new_n157_));
  aoi21  g141(.a(x7), .b(x4), .c(x8), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n157_), .c(x6), .O(new_n159_));
  nand3  g143(.a(new_n19_), .b(new_n35_), .c(new_n98_), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n159_), .c(x3), .O(new_n161_));
  nand2  g145(.a(new_n19_), .b(x3), .O(new_n162_));
  aoi22  g146(.a(new_n32_), .b(x5), .c(new_n18_), .d(new_n98_), .O(new_n163_));
  nor3   g147(.a(new_n163_), .b(new_n162_), .c(new_n36_), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n161_), .c(new_n31_), .O(new_n165_));
  nand3  g149(.a(x6), .b(new_n22_), .c(new_n98_), .O(new_n166_));
  ...
  nor2   g153(.a(x8), .b(new_n19_), .O(new_n170_));
  xnor2a g154(.a(x5), .b(x4), .O(new_n171_));
  nand2  g155(.a(x8), .b(new_n31_), .O(new_n172_));
  nor2   g156(.a(x6), .b(new_n98_), .O(new_n173_));
  aoi22  g157(.a(new_n173_), .b(new_n172_), .c(new_n171_), .d(new_n170_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n169_), .c(new_n18_), .O(new_n175_));
  nand2  g159(.a(new_n19_), .b(new_n35_), .O(new_n176_));
  nand3  g160(.a(new_n18_), .b(new_n22_), .c(new_n98_), .O(new_n177_));
  aoi21  g161(.a(new_n176_), .b(new_n92_), .c(new_n177_), .O(new_n178_));
  oai21  g162(.a(new_n178_), .b(new_n175_), .c(x3), .O(new_n179_));
  nand4  g163(.a(new_n179_), .b(new_n165_), .c(new_n156_), .d(new_n153_), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(x1), .O(new_n181_));
  nand2  g165(.a(new_n154_), .b(new_n32_), .O(new_n182_));
  ...
  nand2  g169(.a(new_n27_), .b(x0), .O(new_n186_));
  inv1   g170(.a(new_n186_), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n185_), .c(new_n22_), .O(new_n188_));
  nand3  g172(.a(new_n170_), .b(new_n64_), .c(new_n18_), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n188_), .c(new_n105_), .O(new_n190_));
  nand2  g174(.a(new_n22_), .b(new_n105_), .O(new_n191_));
  nand2  g175(.a(new_n32_), .b(x3), .O(new_n192_));
  oai22  g176(.a(new_n192_), .b(new_n96_), .c(new_n191_), .d(new_n92_), .O(new_n193_));
  nand2  g177(.a(new_n193_), .b(new_n98_), .O(new_n194_));
  oai21  g178(.a(new_n81_), .b(new_n32_), .c(new_n19_), .O(new_n195_));
  nand2  g179(.a(new_n132_), .b(x7), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n195_), .c(new_n98_), .O(new_n197_));
  nor3   g181(.a(new_n54_), .b(new_n22_), .c(new_n31_), .O(new_n198_));
  oai21  g182(.a(new_n198_), .b(new_n197_), .c(new_n120_), .O(new_n199_));
  nand2  g183(.a(new_n199_), .b(new_n194_), .O(new_n200_));
  oai21  g184(.a(new_n200_), .b(new_n190_), .c(new_n95_), .O(new_n201_));
  nand2  g185(.a(x2), .b(x0), .O(new_n202_));
  oai21  g186(.a(new_n202_), .b(new_n137_), .c(new_n37_), .O(new_n203_));
  nand2  g187(.a(new_n203_), .b(new_n19_), .O(new_n204_));
  nand3  g188(.a(new_n204_), .b(new_n201_), .c(new_n181_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(x9), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n141_), .O(z1));
  nand2  g191(.a(new_n17_), .b(new_n32_), .O(new_n208_));
  xor2a  g192(.a(x3), .b(x1), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n208_), .O(z2));
  oai21  g194(.a(new_n105_), .b(new_n95_), .c(new_n208_), .O(z3));
  oai22  g195(.a(x3), .b(new_n98_), .c(x2), .d(new_n95_), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(new_n27_), .O(new_n213_));
  nand2  g197(.a(new_n184_), .b(new_n182_), .O(new_n214_));
  ...
  oai21  g209(.a(new_n183_), .b(new_n81_), .c(x0), .O(new_n226_));
  ...
  nand2  g216(.a(new_n170_), .b(new_n18_), .O(new_n233_));
  ...
  aoi21  g224(.a(new_n240_), .b(new_n167_), .c(new_n88_), .O(new_n241_));
  ...
  aoi21  g229(.a(new_n245_), .b(new_n192_), .c(new_n31_), .O(new_n246_));
  ...
  nand2  g237(.a(new_n31_), .b(x0), .O(new_n254_));
  nand3  g238(.a(new_n254_), .b(new_n208_), .c(new_n154_), .O(new_n255_));
  nor2   g239(.a(new_n255_), .b(new_n209_), .O(z5));
endmodule
