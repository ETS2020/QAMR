...
module FAU ( 
  ...
  nor2   g132(.a(new_n148_), .b(new_n63_), .O(z2));
  nor2   g133(.a(new_n145_), .b(new_n63_), .O(z3));
  oai21  g134(.a(new_n28_), .b(x3), .c(x0), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(x7), .c(x8), .O(new_n152_));
  nand2  g136(.a(x7), .b(new_n102_), .O(new_n153_));
  nand3  g137(.a(new_n153_), .b(new_n67_), .c(new_n66_), .O(new_n154_));
  nand2  g138(.a(x7), .b(new_n46_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x3), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(x4), .c(x1), .O(new_n157_));
  oai21  g141(.a(new_n28_), .b(new_n117_), .c(new_n102_), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(new_n155_), .c(new_n145_), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n157_), .c(new_n154_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n152_), .c(x6), .O(new_n161_));
  nand2  g145(.a(new_n158_), .b(new_n112_), .O(new_n162_));
  nand2  g146(.a(new_n146_), .b(x7), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n162_), .c(new_n46_), .O(new_n164_));
  nor2   g148(.a(new_n48_), .b(x8), .O(new_n165_));
  nand3  g149(.a(x7), .b(new_n20_), .c(x3), .O(new_n166_));
  inv1   g150(.a(new_n166_), .O(new_n167_));
  oai21  g151(.a(new_n167_), .b(new_n165_), .c(x1), .O(new_n168_));
  aoi21  g152(.a(new_n165_), .b(x3), .c(x5), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nor2   g154(.a(new_n170_), .b(new_n164_), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(new_n161_), .c(new_n31_), .O(z4));
  inv1   g156(.a(new_n63_), .O(new_n173_));
  nor2   g157(.a(new_n71_), .b(new_n95_), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(new_n148_), .c(new_n173_), .O(z5));
endmodule
