...
module FAU ( 
  ...
  nor2   g176(.a(x3), .b(new_n77_), .O(new_n193_));
  nor2   g177(.a(new_n81_), .b(x1), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n193_), .c(new_n192_), .O(z2));
  nand2  g179(.a(x3), .b(x1), .O(new_n196_));
  nor2   g180(.a(new_n196_), .b(new_n191_), .O(z3));
  oai21  g181(.a(x2), .b(new_n54_), .c(x6), .O(new_n198_));
  nand2  g182(.a(new_n198_), .b(x7), .O(new_n199_));
  oai21  g183(.a(x7), .b(new_n23_), .c(x8), .O(new_n200_));
  nand3  g184(.a(new_n200_), .b(new_n177_), .c(x9), .O(new_n201_));
  aoi21  g185(.a(new_n201_), .b(new_n199_), .c(new_n81_), .O(new_n202_));
  inv1   g186(.a(new_n131_), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(new_n169_), .c(new_n59_), .O(new_n204_));
  ...
  nand2  g192(.a(new_n17_), .b(new_n23_), .O(new_n209_));
  nand3  g193(.a(new_n200_), .b(new_n22_), .c(new_n77_), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n209_), .c(new_n54_), .O(new_n211_));
  oai21  g195(.a(new_n211_), .b(new_n208_), .c(new_n81_), .O(new_n212_));
  aoi21  g196(.a(new_n212_), .b(new_n205_), .c(x4), .O(new_n213_));
  nand2  g197(.a(new_n59_), .b(new_n54_), .O(new_n214_));
  oai21  g198(.a(new_n214_), .b(x1), .c(new_n209_), .O(new_n215_));
  nand3  g199(.a(new_n215_), .b(new_n81_), .c(new_n30_), .O(new_n216_));
  oai21  g200(.a(new_n193_), .b(new_n171_), .c(x6), .O(new_n217_));
  oai21  g201(.a(new_n30_), .b(new_n54_), .c(new_n196_), .O(new_n218_));
  nand2  g202(.a(new_n218_), .b(x7), .O(new_n219_));
  nand3  g203(.a(new_n219_), .b(new_n217_), .c(x4), .O(new_n220_));
  nand3  g204(.a(new_n220_), .b(new_n216_), .c(x9), .O(new_n221_));
  oai21  g205(.a(new_n221_), .b(new_n213_), .c(x5), .O(new_n222_));
  nand2  g206(.a(new_n59_), .b(new_n17_), .O(new_n223_));
  nor2   g207(.a(new_n105_), .b(x1), .O(new_n224_));
  oai21  g208(.a(x6), .b(x2), .c(x7), .O(new_n225_));
  aoi21  g209(.a(new_n225_), .b(new_n209_), .c(new_n224_), .O(new_n226_));
  nand2  g210(.a(new_n69_), .b(x8), .O(new_n227_));
  nand3  g211(.a(new_n227_), .b(new_n70_), .c(x6), .O(new_n228_));
  inv1   g212(.a(new_n228_), .O(new_n229_));
  oai21  g213(.a(new_n229_), .b(new_n226_), .c(x0), .O(new_n230_));
  nand2  g214(.a(new_n17_), .b(x3), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n214_), .c(new_n30_), .O(new_n232_));
  nand2  g216(.a(new_n194_), .b(new_n59_), .O(new_n233_));
  inv1   g217(.a(new_n233_), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n232_), .c(x4), .O(new_n235_));
  nand3  g219(.a(new_n17_), .b(new_n23_), .c(x2), .O(new_n236_));
  aoi21  g220(.a(new_n236_), .b(new_n119_), .c(new_n37_), .O(new_n237_));
  nand2  g221(.a(new_n114_), .b(new_n85_), .O(new_n238_));
  oai21  g222(.a(new_n238_), .b(new_n237_), .c(x1), .O(new_n239_));
  nand4  g223(.a(new_n239_), .b(new_n235_), .c(new_n230_), .d(new_n223_), .O(new_n240_));
  nand3  g224(.a(new_n240_), .b(x9), .c(new_n33_), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(new_n222_), .O(z4));
  nor2   g226(.a(new_n194_), .b(new_n193_), .O(new_n243_));
  nand3  g227(.a(new_n243_), .b(new_n192_), .c(new_n177_), .O(new_n244_));
