...
module FAU ( 
  ...
  nor2   g064(.a(x8), .b(x3), .O(new_n81_));
  ...
  oai21  g068(.a(new_n84_), .b(new_n79_), .c(x5), .O(new_n85_));
  inv1   g069(.a(x1), .O(new_n86_));
  nor2   g070(.a(x5), .b(x3), .O(new_n87_));
  oai21  g071(.a(new_n87_), .b(x6), .c(new_n17_), .O(new_n88_));
  nor2   g072(.a(x6), .b(new_n70_), .O(new_n89_));
  nand2  g073(.a(new_n89_), .b(x2), .O(new_n90_));
  aoi21  g074(.a(new_n90_), .b(new_n26_), .c(new_n34_), .O(new_n91_));
  nand3  g075(.a(new_n64_), .b(new_n62_), .c(new_n19_), .O(new_n92_));
  oai21  g076(.a(x6), .b(x2), .c(new_n36_), .O(new_n93_));
  aoi21  g077(.a(new_n93_), .b(new_n43_), .c(new_n17_), .O(new_n94_));
  aoi21  g078(.a(new_n94_), .b(new_n92_), .c(new_n70_), .O(new_n95_));
  oai21  g079(.a(new_n95_), .b(new_n91_), .c(x5), .O(new_n96_));
  aoi21  g080(.a(new_n96_), .b(new_n88_), .c(new_n86_), .O(new_n97_));
  nor2   g081(.a(new_n20_), .b(new_n34_), .O(new_n98_));
  nand3  g082(.a(new_n98_), .b(new_n18_), .c(x5), .O(new_n99_));
  nand2  g083(.a(new_n99_), .b(x9), .O(new_n100_));
  nand2  g084(.a(new_n100_), .b(new_n36_), .O(new_n101_));
  nand4  g085(.a(new_n17_), .b(new_n18_), .c(new_n21_), .d(new_n86_), .O(new_n102_));
  aoi21  g086(.a(new_n102_), .b(new_n101_), .c(new_n70_), .O(new_n103_));
  oai21  g087(.a(new_n103_), .b(new_n97_), .c(x7), .O(new_n104_));
  inv1   g088(.a(new_n55_), .O(new_n105_));
  nand2  g089(.a(new_n53_), .b(x2), .O(new_n106_));
  nand3  g090(.a(new_n106_), .b(new_n105_), .c(x3), .O(new_n107_));
  oai21  g091(.a(new_n43_), .b(new_n18_), .c(x0), .O(new_n108_));
  nand3  g092(.a(new_n108_), .b(new_n70_), .c(x2), .O(new_n109_));
  aoi21  g093(.a(new_n109_), .b(new_n107_), .c(x4), .O(new_n110_));
  oai21  g094(.a(x7), .b(new_n20_), .c(x0), .O(new_n111_));
  oai21  g095(.a(x4), .b(new_n70_), .c(new_n111_), .O(new_n112_));
  nor2   g096(.a(x6), .b(x2), .O(new_n113_));
  nand2  g097(.a(new_n113_), .b(x4), .O(new_n114_));
  aoi21  g098(.a(new_n114_), .b(new_n112_), .c(new_n43_), .O(new_n115_));
  nor2   g099(.a(new_n17_), .b(new_n21_), .O(new_n116_));
  oai21  g100(.a(new_n115_), .b(new_n110_), .c(new_n116_), .O(new_n117_));
  oai21  g101(.a(new_n89_), .b(new_n21_), .c(new_n36_), .O(new_n118_));
  oai21  g102(.a(new_n31_), .b(x3), .c(new_n118_), .O(new_n119_));
  nand2  g103(.a(new_n119_), .b(new_n17_), .O(new_n120_));
  nand2  g104(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  aoi21  g105(.a(x4), .b(x1), .c(new_n21_), .O(new_n122_));
  nor3   g106(.a(new_n122_), .b(new_n66_), .c(x9), .O(new_n123_));
  aoi21  g107(.a(new_n121_), .b(new_n86_), .c(new_n123_), .O(new_n124_));
  nand3  g108(.a(new_n124_), .b(new_n104_), .c(new_n85_), .O(z1));
  nand2  g109(.a(x9), .b(new_n21_), .O(new_n126_));
  nand2  g110(.a(new_n70_), .b(x1), .O(new_n127_));
  nand2  g111(.a(x3), .b(new_n86_), .O(new_n128_));
  and2   g112(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  inv1   g113(.a(new_n129_), .O(new_n130_));
  nand2  g114(.a(new_n130_), .b(new_n126_), .O(z2));
  oai21  g115(.a(new_n70_), .b(new_n86_), .c(new_n126_), .O(z3));
  inv1   g116(.a(new_n116_), .O(new_n133_));
  ...
  nand2  g128(.a(new_n66_), .b(new_n86_), .O(new_n145_));
  aoi21  g129(.a(new_n70_), .b(x1), .c(x8), .O(new_n146_));
  aoi22  g130(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n129_), .O(new_n147_));
  nor2   g131(.a(new_n25_), .b(new_n86_), .O(new_n148_));
  oai21  g132(.a(new_n89_), .b(new_n65_), .c(new_n148_), .O(new_n149_));
  oai21  g133(.a(new_n147_), .b(new_n143_), .c(new_n149_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n140_), .c(new_n36_), .O(new_n151_));
  nor2   g135(.a(new_n70_), .b(new_n86_), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(new_n98_), .c(x7), .O(new_n153_));
  nand2  g137(.a(new_n141_), .b(new_n127_), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(x6), .c(new_n36_), .O(new_n155_));
  aoi22  g139(.a(new_n155_), .b(new_n153_), .c(new_n113_), .d(new_n81_), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n151_), .c(new_n133_), .O(z4));
  oai21  g141(.a(new_n143_), .b(new_n130_), .c(new_n126_), .O(z5));
endmodule
