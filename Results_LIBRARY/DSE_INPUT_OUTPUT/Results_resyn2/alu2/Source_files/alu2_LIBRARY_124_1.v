...
module FAU ( 
  ...
  nor2   g068(.a(x9), .b(x2), .O(new_n85_));
  aoi22  g069(.a(new_n85_), .b(new_n84_), .c(x9), .d(new_n83_), .O(new_n86_));
  nand3  g070(.a(new_n86_), .b(new_n82_), .c(new_n55_), .O(z0));
  inv1   g071(.a(x1), .O(new_n88_));
  nand2  g072(.a(new_n84_), .b(x8), .O(new_n89_));
  nor2   g073(.a(x6), .b(new_n83_), .O(new_n90_));
  nand2  g074(.a(new_n90_), .b(x7), .O(new_n91_));
  aoi21  g075(.a(new_n91_), .b(new_n89_), .c(new_n20_), .O(new_n92_));
  nor2   g076(.a(new_n33_), .b(new_n25_), .O(new_n93_));
  oai21  g077(.a(new_n90_), .b(new_n93_), .c(new_n28_), .O(new_n94_));
  nand3  g078(.a(new_n93_), .b(x6), .c(new_n20_), .O(new_n95_));
  nand3  g079(.a(new_n84_), .b(x8), .c(x7), .O(new_n96_));
  nand3  g080(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  oai21  g081(.a(new_n97_), .b(new_n92_), .c(x0), .O(new_n98_));
  inv1   g082(.a(new_n90_), .O(new_n99_));
  nand2  g083(.a(new_n99_), .b(x5), .O(new_n100_));
  aoi22  g084(.a(new_n100_), .b(new_n33_), .c(new_n93_), .d(new_n35_), .O(new_n101_));
  aoi21  g085(.a(new_n101_), .b(new_n98_), .c(x4), .O(new_n102_));
  inv1   g086(.a(new_n60_), .O(new_n103_));
  nand2  g087(.a(new_n20_), .b(x0), .O(new_n104_));
  nand2  g088(.a(new_n104_), .b(x8), .O(new_n105_));
  nor2   g089(.a(new_n33_), .b(new_n17_), .O(new_n106_));
  nand3  g090(.a(new_n106_), .b(new_n105_), .c(new_n103_), .O(new_n107_));
  inv1   g091(.a(x0), .O(new_n108_));
  nand4  g092(.a(x8), .b(x6), .c(new_n17_), .d(new_n108_), .O(new_n109_));
  aoi21  g093(.a(new_n109_), .b(new_n107_), .c(x5), .O(new_n110_));
  nand2  g094(.a(x4), .b(x2), .O(new_n111_));
  nand2  g095(.a(new_n93_), .b(x8), .O(new_n112_));
  nand3  g096(.a(new_n19_), .b(new_n33_), .c(new_n83_), .O(new_n113_));
  oai21  g097(.a(new_n112_), .b(new_n111_), .c(new_n113_), .O(new_n114_));
  oai21  g098(.a(new_n114_), .b(new_n110_), .c(new_n21_), .O(new_n115_));
  aoi22  g099(.a(new_n69_), .b(new_n108_), .c(x8), .d(new_n29_), .O(new_n116_));
  nand2  g100(.a(x6), .b(new_n25_), .O(new_n117_));
  nor2   g101(.a(new_n28_), .b(x0), .O(new_n118_));
  oai21  g102(.a(new_n117_), .b(new_n22_), .c(new_n118_), .O(new_n119_));
  oai21  g103(.a(new_n116_), .b(x2), .c(new_n119_), .O(new_n120_));
  nand2  g104(.a(new_n42_), .b(new_n33_), .O(new_n121_));
  nor2   g105(.a(new_n121_), .b(new_n99_), .O(new_n122_));
  aoi21  g106(.a(new_n120_), .b(new_n106_), .c(new_n122_), .O(new_n123_));
  nand2  g107(.a(new_n123_), .b(new_n115_), .O(new_n124_));
  oai21  g108(.a(new_n124_), .b(new_n102_), .c(new_n88_), .O(new_n125_));
  ...
  nand2  g112(.a(new_n36_), .b(new_n108_), .O(new_n129_));
  ...
  nand2  g122(.a(new_n111_), .b(new_n108_), .O(new_n139_));
  ...
  oai21  g143(.a(new_n84_), .b(x9), .c(new_n83_), .O(new_n160_));
  oai21  g144(.a(new_n56_), .b(new_n83_), .c(new_n160_), .O(new_n161_));
  aoi21  g145(.a(new_n159_), .b(new_n106_), .c(new_n161_), .O(new_n162_));
  nand3  g146(.a(new_n162_), .b(new_n158_), .c(new_n125_), .O(z1));
  nand2  g147(.a(x3), .b(x1), .O(new_n164_));
  nand3  g148(.a(new_n33_), .b(new_n83_), .c(new_n88_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n164_), .O(z2));
  oai21  g150(.a(new_n33_), .b(x3), .c(new_n164_), .O(z3));
  xnor2a g151(.a(x2), .b(x0), .O(new_n168_));
  nand3  g152(.a(new_n168_), .b(new_n68_), .c(x3), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n126_), .c(new_n25_), .O(new_n170_));
  aoi21  g154(.a(new_n104_), .b(x6), .c(new_n21_), .O(new_n171_));
  oai21  g155(.a(new_n171_), .b(new_n170_), .c(new_n17_), .O(new_n172_));
  nor2   g156(.a(x8), .b(new_n108_), .O(new_n173_));
  aoi21  g157(.a(x6), .b(new_n108_), .c(new_n21_), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(new_n173_), .c(new_n25_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand2  g160(.a(new_n176_), .b(x1), .O(new_n177_));
  oai21  g161(.a(new_n21_), .b(new_n20_), .c(x8), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(x0), .O(new_n179_));
  nand2  g163(.a(x2), .b(new_n108_), .O(new_n180_));
  nand3  g164(.a(new_n180_), .b(new_n21_), .c(x1), .O(new_n181_));
  aoi21  g165(.a(x7), .b(new_n108_), .c(new_n29_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  aoi21  g167(.a(x7), .b(x1), .c(new_n148_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n183_), .c(new_n179_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n25_), .O(new_n186_));
  oai21  g170(.a(new_n20_), .b(new_n108_), .c(new_n88_), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(x7), .O(new_n188_));
  nand3  g172(.a(x6), .b(new_n20_), .c(x0), .O(new_n189_));
  nand3  g173(.a(new_n189_), .b(new_n188_), .c(x5), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nor2   g175(.a(new_n173_), .b(new_n21_), .O(new_n192_));
  nand2  g176(.a(new_n105_), .b(new_n84_), .O(new_n193_));
  oai21  g177(.a(new_n193_), .b(new_n192_), .c(x3), .O(new_n194_));
  aoi21  g178(.a(new_n191_), .b(x4), .c(new_n194_), .O(new_n195_));
  aoi21  g179(.a(new_n195_), .b(new_n177_), .c(new_n33_), .O(z4));
  and2   g180(.a(new_n168_), .b(z2), .O(z5));
endmodule
