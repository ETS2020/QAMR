...
module FAU ( 
  ...
  nand2  g045(.a(new_n29_), .b(new_n40_), .O(new_n62_));
  oai21  g046(.a(new_n61_), .b(new_n34_), .c(new_n62_), .O(new_n63_));
  inv1   g047(.a(new_n30_), .O(new_n64_));
  nand3  g048(.a(new_n26_), .b(x6), .c(new_n17_), .O(new_n65_));
  nand2  g049(.a(new_n28_), .b(new_n33_), .O(new_n66_));
  oai21  g050(.a(new_n66_), .b(new_n64_), .c(new_n65_), .O(new_n67_));
  nand3  g051(.a(x7), .b(new_n17_), .c(x2), .O(new_n68_));
  nand3  g052(.a(x6), .b(new_n34_), .c(new_n18_), .O(new_n69_));
  aoi21  g053(.a(new_n69_), .b(new_n68_), .c(x9), .O(new_n70_));
  aoi21  g054(.a(new_n67_), .b(new_n63_), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g081(.a(new_n97_), .b(x8), .c(new_n61_), .O(new_n98_));
  nand2  g082(.a(new_n98_), .b(x7), .O(new_n99_));
  aoi21  g083(.a(new_n34_), .b(x2), .c(new_n28_), .O(new_n100_));
  oai21  g084(.a(x6), .b(x2), .c(new_n40_), .O(new_n101_));
  nand3  g085(.a(x8), .b(x2), .c(x0), .O(new_n102_));
  oai21  g086(.a(x7), .b(x0), .c(new_n102_), .O(new_n103_));
  oai21  g087(.a(new_n101_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  aoi21  g088(.a(new_n104_), .b(new_n99_), .c(new_n26_), .O(new_n105_));
  nand3  g089(.a(new_n28_), .b(x7), .c(x5), .O(new_n106_));
  inv1   g090(.a(new_n106_), .O(new_n107_));
  oai21  g091(.a(new_n107_), .b(new_n105_), .c(x4), .O(new_n108_));
  nand3  g092(.a(new_n26_), .b(x7), .c(x5), .O(new_n109_));
  aoi21  g093(.a(new_n109_), .b(new_n108_), .c(new_n96_), .O(new_n110_));
  nand2  g094(.a(new_n20_), .b(x0), .O(new_n111_));
  nor2   g095(.a(new_n64_), .b(x6), .O(new_n112_));
  nand3  g096(.a(new_n112_), .b(new_n111_), .c(new_n50_), .O(new_n113_));
  oai21  g097(.a(new_n27_), .b(x5), .c(new_n113_), .O(new_n114_));
  nand2  g098(.a(new_n114_), .b(new_n96_), .O(new_n115_));
  nand3  g099(.a(new_n112_), .b(x8), .c(new_n47_), .O(new_n116_));
  nand2  g100(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  oai21  g101(.a(new_n117_), .b(new_n110_), .c(x1), .O(new_n118_));
  aoi21  g102(.a(new_n47_), .b(new_n96_), .c(new_n17_), .O(new_n119_));
  oai22  g103(.a(new_n119_), .b(x5), .c(new_n43_), .d(new_n96_), .O(new_n120_));
  nand2  g104(.a(new_n120_), .b(new_n26_), .O(new_n121_));
  nand2  g105(.a(x7), .b(x2), .O(new_n122_));
  aoi21  g106(.a(new_n122_), .b(new_n66_), .c(new_n40_), .O(new_n123_));
  nand2  g107(.a(new_n28_), .b(x2), .O(new_n124_));
  nor2   g108(.a(new_n124_), .b(new_n51_), .O(new_n125_));
  oai21  g109(.a(new_n125_), .b(new_n123_), .c(new_n96_), .O(new_n126_));
  nand3  g110(.a(new_n97_), .b(new_n28_), .c(x3), .O(new_n127_));
  aoi21  g111(.a(new_n127_), .b(new_n126_), .c(x5), .O(new_n128_));
  nand2  g112(.a(new_n47_), .b(new_n40_), .O(new_n129_));
  oai21  g113(.a(new_n129_), .b(new_n22_), .c(x3), .O(new_n130_));
  nand2  g114(.a(new_n130_), .b(new_n34_), .O(new_n131_));
  aoi21  g115(.a(new_n47_), .b(x5), .c(new_n18_), .O(new_n132_));
  nor2   g116(.a(new_n87_), .b(new_n22_), .O(new_n133_));
  oai21  g117(.a(new_n133_), .b(new_n132_), .c(x0), .O(new_n134_));
  nand3  g118(.a(new_n134_), .b(new_n131_), .c(x8), .O(new_n135_));
  inv1   g119(.a(new_n135_), .O(new_n136_));
  oai21  g120(.a(new_n136_), .b(new_n128_), .c(new_n30_), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n121_), .O(new_n138_));
  oai21  g122(.a(new_n27_), .b(x4), .c(new_n116_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(x3), .O(new_n140_));
  nand3  g124(.a(new_n112_), .b(new_n47_), .c(x5), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  aoi21  g126(.a(new_n138_), .b(new_n75_), .c(new_n142_), .O(new_n143_));
  nand3  g127(.a(new_n143_), .b(new_n118_), .c(new_n95_), .O(z1));
  nand2  g128(.a(x9), .b(new_n17_), .O(new_n145_));
  nor2   g129(.a(x3), .b(x1), .O(new_n146_));
  nor2   g130(.a(new_n96_), .b(new_n75_), .O(new_n147_));
  nor2   g131(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g132(.a(new_n148_), .b(new_n145_), .O(z2));
  nand2  g133(.a(x3), .b(x1), .O(new_n150_));
  nand2  g134(.a(new_n150_), .b(new_n145_), .O(z3));
  inv1   g135(.a(new_n97_), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n61_), .c(new_n148_), .O(new_n153_));
  nand2  g137(.a(x3), .b(x0), .O(new_n154_));
  nand3  g138(.a(new_n154_), .b(x7), .c(new_n75_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x6), .O(new_n156_));
  aoi21  g140(.a(new_n153_), .b(x8), .c(new_n156_), .O(new_n157_));
  aoi21  g141(.a(new_n150_), .b(new_n61_), .c(new_n47_), .O(new_n158_));
  aoi21  g142(.a(new_n152_), .b(new_n28_), .c(new_n158_), .O(new_n159_));
  nor2   g143(.a(new_n159_), .b(new_n146_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n157_), .c(new_n34_), .O(new_n161_));
  oai22  g145(.a(x3), .b(new_n75_), .c(x2), .d(new_n40_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(x6), .O(new_n163_));
  nor2   g147(.a(new_n158_), .b(new_n34_), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n163_), .c(new_n17_), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(new_n161_), .c(new_n26_), .O(z4));
  nand2  g150(.a(new_n153_), .b(new_n145_), .O(new_n167_));
