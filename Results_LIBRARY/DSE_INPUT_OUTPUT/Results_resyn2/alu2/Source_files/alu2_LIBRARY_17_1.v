...
module FAU ( 
  ...
  nand2  g125(.a(x9), .b(new_n34_), .O(new_n142_));
  nand3  g126(.a(new_n83_), .b(new_n21_), .c(x3), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  aoi21  g128(.a(new_n141_), .b(new_n92_), .c(new_n144_), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(new_n110_), .c(new_n90_), .O(z1));
  nand2  g130(.a(new_n92_), .b(new_n91_), .O(new_n147_));
  nand2  g131(.a(x3), .b(x1), .O(new_n148_));
  and2   g132(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n142_), .O(z2));
  nand2  g134(.a(new_n148_), .b(new_n142_), .O(z3));
  ...
  oai22  g150(.a(new_n166_), .b(new_n26_), .c(new_n148_), .d(x6), .O(new_n167_));
  ...
  inv1   g161(.a(new_n149_), .O(new_n178_));
  xnor2a g162(.a(x2), .b(x0), .O(new_n179_));
  nand3  g163(.a(new_n179_), .b(new_n178_), .c(new_n142_), .O(new_n180_));
