...
module FAU ( 
  ...
  nand2  g181(.a(new_n26_), .b(new_n17_), .O(new_n198_));
  ...
  oai21  g185(.a(new_n86_), .b(new_n83_), .c(new_n198_), .O(z3));
  oai21  g186(.a(x2), .b(new_n46_), .c(new_n83_), .O(new_n203_));
  nor2   g187(.a(new_n127_), .b(x6), .O(new_n204_));
  aoi21  g188(.a(new_n203_), .b(x6), .c(new_n204_), .O(new_n205_));
  nand2  g189(.a(x2), .b(new_n46_), .O(new_n206_));
  nand3  g190(.a(new_n199_), .b(new_n206_), .c(new_n37_), .O(new_n207_));
  oai21  g191(.a(new_n205_), .b(x3), .c(new_n207_), .O(new_n208_));
  nand2  g192(.a(new_n19_), .b(x1), .O(new_n209_));
  nand2  g193(.a(new_n86_), .b(x0), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n209_), .c(new_n153_), .O(new_n211_));
  aoi21  g195(.a(new_n208_), .b(x7), .c(new_n211_), .O(new_n212_));
  nand2  g196(.a(new_n199_), .b(new_n206_), .O(new_n213_));
  oai21  g197(.a(new_n213_), .b(new_n31_), .c(new_n27_), .O(new_n214_));
  nand2  g198(.a(new_n197_), .b(new_n147_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(x6), .c(x7), .O(new_n216_));
  nand3  g200(.a(new_n95_), .b(new_n37_), .c(new_n19_), .O(new_n217_));
  nor2   g201(.a(new_n95_), .b(new_n83_), .O(new_n218_));
  ...
  aoi21  g205(.a(new_n216_), .b(new_n214_), .c(new_n221_), .O(new_n222_));
  oai21  g206(.a(new_n212_), .b(x4), .c(new_n222_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(x5), .O(new_n224_));
  nand2  g208(.a(new_n74_), .b(x2), .O(new_n225_));
  aoi21  g209(.a(new_n225_), .b(new_n87_), .c(new_n27_), .O(new_n226_));
  nand3  g210(.a(x7), .b(new_n31_), .c(x3), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(new_n111_), .O(new_n228_));
  oai21  g212(.a(new_n228_), .b(new_n226_), .c(x1), .O(new_n229_));
  nand3  g213(.a(new_n17_), .b(x6), .c(new_n46_), .O(new_n230_));
  nand2  g214(.a(new_n37_), .b(x3), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n230_), .c(new_n19_), .O(new_n232_));
  nand4  g216(.a(new_n17_), .b(x6), .c(x3), .d(new_n83_), .O(new_n233_));
  inv1   g217(.a(new_n233_), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n232_), .c(x4), .O(new_n235_));
  nand3  g219(.a(new_n235_), .b(new_n229_), .c(new_n62_), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(new_n22_), .O(new_n237_));
  inv1   g221(.a(new_n227_), .O(new_n238_));
  nor2   g222(.a(x4), .b(new_n83_), .O(new_n239_));
  nand2  g223(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  oai21  g224(.a(x6), .b(x2), .c(x7), .O(new_n241_));
  aoi22  g225(.a(new_n241_), .b(new_n153_), .c(new_n91_), .d(new_n83_), .O(new_n242_));
  nor2   g226(.a(new_n73_), .b(new_n51_), .O(new_n243_));
  nor2   g227(.a(new_n243_), .b(new_n31_), .O(new_n244_));
  oai21  g228(.a(new_n244_), .b(new_n242_), .c(new_n22_), .O(new_n245_));
  nor2   g229(.a(new_n87_), .b(x2), .O(new_n246_));
  oai21  g230(.a(new_n246_), .b(new_n74_), .c(new_n239_), .O(new_n247_));
  nand2  g231(.a(new_n247_), .b(new_n245_), .O(new_n248_));
  nand2  g232(.a(new_n248_), .b(x0), .O(new_n249_));
  nand3  g233(.a(new_n249_), .b(new_n240_), .c(new_n237_), .O(new_n250_));
  inv1   g234(.a(new_n250_), .O(new_n251_));
  aoi21  g235(.a(new_n251_), .b(new_n224_), .c(new_n26_), .O(z4));
  oai21  g236(.a(new_n215_), .b(new_n213_), .c(new_n198_), .O(z5));
endmodule
