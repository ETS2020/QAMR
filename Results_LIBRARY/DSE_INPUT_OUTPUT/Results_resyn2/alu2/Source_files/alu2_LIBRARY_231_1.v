...
module FAU ( 
  ...
  nor2   g140(.a(new_n17_), .b(x5), .O(new_n157_));
  inv1   g141(.a(new_n157_), .O(new_n158_));
  xnor2a g142(.a(x3), .b(x1), .O(new_n159_));
  inv1   g143(.a(new_n159_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(new_n158_), .O(z2));
  nor3   g145(.a(new_n157_), .b(new_n93_), .c(new_n80_), .O(z3));
  nand2  g146(.a(x7), .b(x3), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(new_n82_), .c(new_n81_), .O(new_n164_));
  nand2  g148(.a(new_n37_), .b(x0), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(new_n163_), .c(x4), .O(new_n166_));
  aoi21  g150(.a(new_n164_), .b(new_n44_), .c(new_n166_), .O(new_n167_));
  oai21  g151(.a(x8), .b(new_n25_), .c(new_n82_), .O(new_n168_));
  nor2   g152(.a(new_n88_), .b(x5), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  oai21  g154(.a(new_n167_), .b(new_n80_), .c(new_n170_), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(new_n17_), .O(new_n172_));
  nand2  g156(.a(new_n159_), .b(new_n20_), .O(new_n173_));
  nand2  g157(.a(x3), .b(new_n80_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(x7), .c(x0), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n173_), .c(x2), .O(new_n176_));
  inv1   g160(.a(new_n152_), .O(new_n177_));
  nand4  g161(.a(new_n37_), .b(x2), .c(new_n80_), .d(x0), .O(new_n178_));
  ...
  oai21  g165(.a(new_n181_), .b(new_n152_), .c(x0), .O(new_n182_));
  oai21  g166(.a(new_n64_), .b(new_n80_), .c(new_n182_), .O(new_n183_));
  nor4   g167(.a(new_n35_), .b(x6), .c(x3), .d(new_n34_), .O(new_n184_));
  aoi21  g168(.a(new_n183_), .b(new_n37_), .c(new_n184_), .O(new_n185_));
  aoi21  g169(.a(new_n185_), .b(new_n180_), .c(x4), .O(new_n186_));
  oai21  g170(.a(new_n71_), .b(new_n24_), .c(new_n159_), .O(new_n187_));
  nor2   g171(.a(new_n187_), .b(new_n70_), .O(new_n188_));
  oai21  g172(.a(x2), .b(new_n34_), .c(x3), .O(new_n189_));
  aoi21  g173(.a(x2), .b(new_n80_), .c(new_n17_), .O(new_n190_));
  aoi21  g174(.a(new_n190_), .b(new_n189_), .c(new_n18_), .O(new_n191_));
  oai21  g175(.a(new_n191_), .b(new_n188_), .c(new_n23_), .O(new_n192_));
  oai21  g176(.a(new_n63_), .b(new_n34_), .c(x4), .O(new_n193_));
  inv1   g177(.a(new_n193_), .O(new_n194_));
  nand2  g178(.a(new_n193_), .b(new_n108_), .O(new_n195_));
  aoi22  g179(.a(new_n195_), .b(new_n181_), .c(new_n194_), .d(new_n80_), .O(new_n196_));
  nand2  g180(.a(new_n196_), .b(new_n192_), .O(new_n197_));
  oai21  g181(.a(new_n197_), .b(new_n186_), .c(x5), .O(new_n198_));
  aoi21  g182(.a(new_n198_), .b(new_n172_), .c(new_n22_), .O(z4));
  nand2  g183(.a(new_n187_), .b(new_n158_), .O(z5));
endmodule
