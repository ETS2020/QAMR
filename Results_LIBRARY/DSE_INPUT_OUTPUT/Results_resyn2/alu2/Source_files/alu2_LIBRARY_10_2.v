...
module FAU ( 
  ...
  nor2   g169(.a(new_n185_), .b(new_n180_), .O(z3));
  ...
  nand2  g173(.a(x2), .b(new_n18_), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n17_), .O(new_n191_));
  aoi21  g175(.a(new_n191_), .b(new_n107_), .c(new_n147_), .O(new_n192_));
  oai21  g176(.a(new_n102_), .b(new_n17_), .c(new_n53_), .O(new_n193_));
  oai21  g177(.a(new_n63_), .b(new_n17_), .c(x0), .O(new_n194_));
  ...
  nor2   g181(.a(new_n74_), .b(x1), .O(new_n198_));
  nor2   g182(.a(new_n198_), .b(new_n23_), .O(new_n199_));
  oai22  g183(.a(new_n199_), .b(new_n111_), .c(new_n102_), .d(new_n53_), .O(new_n200_));
  nand2  g184(.a(new_n185_), .b(new_n87_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(x7), .O(new_n202_));
  nand2  g186(.a(new_n174_), .b(new_n22_), .O(new_n203_));
  nand3  g187(.a(x6), .b(new_n74_), .c(x1), .O(new_n204_));
  nand3  g188(.a(new_n204_), .b(new_n203_), .c(new_n202_), .O(new_n205_));
  aoi21  g189(.a(new_n200_), .b(new_n27_), .c(new_n205_), .O(new_n206_));
  oai21  g190(.a(new_n206_), .b(new_n197_), .c(x5), .O(new_n207_));
  nand2  g191(.a(new_n187_), .b(x2), .O(new_n208_));
  aoi21  g192(.a(new_n208_), .b(new_n107_), .c(new_n27_), .O(new_n209_));
  oai21  g193(.a(new_n34_), .b(new_n74_), .c(new_n77_), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n209_), .c(x1), .O(new_n211_));
  nand2  g195(.a(new_n54_), .b(new_n17_), .O(new_n212_));
  inv1   g196(.a(new_n212_), .O(new_n213_));
  nand2  g197(.a(new_n17_), .b(x3), .O(new_n214_));
  oai21  g198(.a(new_n57_), .b(x0), .c(new_n214_), .O(new_n215_));
  nand2  g199(.a(new_n215_), .b(x2), .O(new_n216_));
  nand2  g200(.a(new_n198_), .b(new_n54_), .O(new_n217_));
  nand2  g201(.a(new_n217_), .b(new_n216_), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(x4), .c(new_n213_), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n211_), .c(x5), .O(new_n220_));
  nand2  g204(.a(new_n27_), .b(x1), .O(new_n221_));
  or2    g205(.a(new_n221_), .b(new_n94_), .O(new_n222_));
  nand2  g206(.a(new_n100_), .b(new_n147_), .O(new_n223_));
  nor2   g207(.a(new_n21_), .b(new_n19_), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n187_), .c(new_n223_), .O(new_n225_));
  nand3  g209(.a(new_n98_), .b(new_n67_), .c(x6), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n225_), .c(x5), .O(new_n227_));
  inv1   g211(.a(new_n187_), .O(new_n228_));
  nand3  g212(.a(x7), .b(x6), .c(new_n53_), .O(new_n229_));
  aoi21  g213(.a(new_n229_), .b(new_n228_), .c(new_n221_), .O(new_n230_));
  oai21  g214(.a(new_n230_), .b(new_n227_), .c(x0), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n222_), .O(new_n232_));
  nor2   g216(.a(new_n232_), .b(new_n220_), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n207_), .c(new_n33_), .O(z4));
  inv1   g218(.a(new_n79_), .O(new_n235_));
  nand2  g219(.a(new_n190_), .b(new_n235_), .O(new_n236_));
  oai21  g220(.a(new_n236_), .b(new_n182_), .c(new_n181_), .O(z5));
endmodule
