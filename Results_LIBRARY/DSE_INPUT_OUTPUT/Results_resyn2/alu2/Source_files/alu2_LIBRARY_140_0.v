...
module FAU ( 
  ...
  nor2   g193(.a(x3), .b(new_n84_), .O(new_n210_));
  nor2   g194(.a(new_n109_), .b(x1), .O(new_n211_));
  oai21  g195(.a(new_n211_), .b(new_n210_), .c(new_n209_), .O(z2));
  oai21  g196(.a(new_n109_), .b(new_n84_), .c(new_n209_), .O(z3));
  oai22  g197(.a(x3), .b(new_n85_), .c(x2), .d(new_n84_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n72_), .O(new_n215_));
  inv1   g199(.a(new_n211_), .O(new_n216_));
  nand3  g200(.a(new_n216_), .b(new_n157_), .c(new_n36_), .O(new_n217_));
  inv1   g201(.a(new_n217_), .O(new_n218_));
  nand2  g202(.a(x6), .b(x1), .O(new_n219_));
  nand2  g203(.a(new_n59_), .b(x2), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n86_), .O(new_n221_));
  nand2  g205(.a(new_n221_), .b(x0), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n219_), .c(x3), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n218_), .c(x7), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n215_), .c(x4), .O(new_n225_));
  aoi21  g209(.a(new_n116_), .b(x0), .c(new_n18_), .O(new_n226_));
  nor2   g210(.a(x6), .b(x3), .O(new_n227_));
  oai21  g211(.a(new_n226_), .b(new_n32_), .c(new_n227_), .O(new_n228_));
  nand2  g212(.a(new_n226_), .b(new_n84_), .O(new_n229_));
  nand2  g213(.a(new_n216_), .b(new_n157_), .O(new_n230_));
  oai21  g214(.a(new_n230_), .b(new_n59_), .c(new_n18_), .O(new_n231_));
  oai22  g215(.a(x3), .b(new_n84_), .c(x2), .d(new_n85_), .O(new_n232_));
  ...
  oai21  g220(.a(new_n73_), .b(new_n51_), .c(new_n129_), .O(new_n237_));
  nand2  g221(.a(new_n237_), .b(x1), .O(new_n238_));
  nand2  g222(.a(new_n211_), .b(new_n54_), .O(new_n239_));
  oai22  g223(.a(new_n52_), .b(x0), .c(x8), .d(new_n109_), .O(new_n240_));
  nand2  g224(.a(new_n240_), .b(x2), .O(new_n241_));
  nand3  g225(.a(new_n241_), .b(new_n239_), .c(new_n238_), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(x4), .O(new_n243_));
  nand3  g227(.a(x7), .b(new_n59_), .c(x3), .O(new_n244_));
  oai21  g228(.a(new_n52_), .b(x3), .c(new_n244_), .O(new_n245_));
  aoi22  g229(.a(new_n245_), .b(x1), .c(new_n54_), .d(new_n36_), .O(new_n246_));
  aoi21  g230(.a(new_n246_), .b(new_n243_), .c(x5), .O(new_n247_));
  inv1   g231(.a(new_n244_), .O(new_n248_));
  nor2   g232(.a(x4), .b(new_n84_), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(new_n248_), .O(new_n250_));
  aoi21  g234(.a(x4), .b(x3), .c(x1), .O(new_n251_));
  nand2  g235(.a(new_n116_), .b(x7), .O(new_n252_));
  aoi21  g236(.a(new_n252_), .b(new_n73_), .c(new_n251_), .O(new_n253_));
  nand2  g237(.a(new_n36_), .b(new_n18_), .O(new_n254_));
  aoi21  g238(.a(new_n254_), .b(new_n71_), .c(new_n59_), .O(new_n255_));
  oai21  g239(.a(new_n255_), .b(new_n253_), .c(new_n24_), .O(new_n256_));
  nor2   g240(.a(new_n129_), .b(x2), .O(new_n257_));
  oai21  g241(.a(new_n257_), .b(new_n72_), .c(new_n249_), .O(new_n258_));
  nand2  g242(.a(new_n258_), .b(new_n256_), .O(new_n259_));
  nand2  g243(.a(new_n259_), .b(x0), .O(new_n260_));
  nand2  g244(.a(new_n260_), .b(new_n250_), .O(new_n261_));
  nor2   g245(.a(new_n261_), .b(new_n247_), .O(new_n262_));
  aoi21  g246(.a(new_n262_), .b(new_n236_), .c(new_n17_), .O(z4));
  nor3   g247(.a(new_n232_), .b(new_n230_), .c(new_n208_), .O(z5));
endmodule
