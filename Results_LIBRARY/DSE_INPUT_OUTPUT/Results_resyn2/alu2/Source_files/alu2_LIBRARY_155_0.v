...
module FAU ( 
  ...
  nor2   g177(.a(new_n111_), .b(new_n67_), .O(new_n194_));
  inv1   g178(.a(new_n194_), .O(new_n195_));
  aoi21  g179(.a(new_n102_), .b(new_n20_), .c(new_n195_), .O(z3));
  nand2  g180(.a(x2), .b(new_n17_), .O(new_n197_));
  inv1   g181(.a(new_n197_), .O(new_n198_));
  aoi21  g182(.a(new_n68_), .b(new_n17_), .c(new_n53_), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n198_), .c(x3), .O(new_n200_));
  nand2  g184(.a(x8), .b(x7), .O(new_n201_));
  aoi21  g185(.a(new_n18_), .b(x0), .c(new_n201_), .O(new_n202_));
  nand2  g186(.a(new_n197_), .b(new_n111_), .O(new_n203_));
  oai21  g187(.a(new_n203_), .b(new_n202_), .c(new_n67_), .O(new_n204_));
  nand2  g188(.a(new_n190_), .b(new_n114_), .O(new_n205_));
  aoi21  g189(.a(new_n205_), .b(new_n53_), .c(new_n21_), .O(new_n206_));
  nand3  g190(.a(new_n206_), .b(new_n204_), .c(new_n200_), .O(new_n207_));
  aoi22  g191(.a(x7), .b(x1), .c(new_n21_), .d(new_n111_), .O(new_n208_));
  oai22  g192(.a(new_n208_), .b(new_n17_), .c(new_n59_), .d(new_n67_), .O(new_n209_));
  nor4   g193(.a(new_n136_), .b(new_n53_), .c(x6), .d(new_n17_), .O(new_n210_));
  aoi21  g194(.a(new_n209_), .b(new_n68_), .c(new_n210_), .O(new_n211_));
  aoi21  g195(.a(new_n211_), .b(new_n207_), .c(x4), .O(new_n212_));
  oai21  g196(.a(new_n194_), .b(new_n104_), .c(x7), .O(new_n213_));
  nand2  g197(.a(new_n205_), .b(x6), .O(new_n214_));
  nand3  g198(.a(new_n214_), .b(new_n213_), .c(x4), .O(new_n215_));
  oai21  g199(.a(new_n93_), .b(x3), .c(new_n215_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n212_), .c(x5), .O(new_n217_));
  nand2  g201(.a(x7), .b(x6), .O(new_n218_));
  nand2  g202(.a(new_n92_), .b(x2), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n218_), .c(new_n19_), .O(new_n220_));
  nand3  g204(.a(x7), .b(new_n21_), .c(x3), .O(new_n221_));
  nand2  g205(.a(new_n221_), .b(new_n154_), .O(new_n222_));
  oai21  g206(.a(new_n222_), .b(new_n220_), .c(x1), .O(new_n223_));
  nand2  g207(.a(new_n22_), .b(new_n68_), .O(new_n224_));
  aoi21  g208(.a(new_n22_), .b(new_n17_), .c(new_n144_), .O(new_n225_));
  nand3  g209(.a(new_n22_), .b(x3), .c(new_n67_), .O(new_n226_));
  oai21  g210(.a(new_n225_), .b(new_n18_), .c(new_n226_), .O(new_n227_));
  ...
  inv1   g214(.a(new_n221_), .O(new_n231_));
  nor2   g215(.a(x4), .b(new_n67_), .O(new_n232_));
  nand2  g216(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  inv1   g217(.a(new_n92_), .O(new_n234_));
  aoi21  g218(.a(x4), .b(x3), .c(x1), .O(new_n235_));
  aoi21  g219(.a(new_n234_), .b(new_n60_), .c(new_n235_), .O(new_n236_));
  nand2  g220(.a(new_n68_), .b(new_n19_), .O(new_n237_));
  aoi21  g221(.a(new_n175_), .b(new_n237_), .c(new_n21_), .O(new_n238_));
  oai21  g222(.a(new_n238_), .b(new_n236_), .c(new_n20_), .O(new_n239_));
  nor2   g223(.a(new_n218_), .b(x2), .O(new_n240_));
  oai21  g224(.a(new_n240_), .b(new_n92_), .c(new_n232_), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(new_n239_), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(x0), .O(new_n243_));
  nand3  g227(.a(new_n243_), .b(new_n233_), .c(new_n230_), .O(new_n244_));
  inv1   g228(.a(new_n244_), .O(new_n245_));
  aoi21  g229(.a(new_n245_), .b(new_n217_), .c(new_n102_), .O(z4));
  nand2  g230(.a(new_n191_), .b(new_n197_), .O(new_n247_));
  nor2   g231(.a(new_n247_), .b(new_n205_), .O(z5));
endmodule
