...
module FAU ( 
  ...
  nand2  g133(.a(x9), .b(new_n47_), .O(new_n150_));
  nand2  g134(.a(x3), .b(x1), .O(new_n151_));
  nand2  g135(.a(new_n151_), .b(new_n135_), .O(new_n152_));
  and2   g136(.a(new_n152_), .b(new_n150_), .O(z2));
  nand2  g137(.a(new_n151_), .b(new_n150_), .O(z3));
  nand2  g138(.a(new_n115_), .b(new_n67_), .O(new_n155_));
  nand3  g139(.a(new_n152_), .b(new_n37_), .c(x2), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n155_), .c(new_n31_), .O(new_n157_));
  nand3  g141(.a(x6), .b(new_n67_), .c(x1), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n32_), .c(new_n18_), .O(new_n159_));
  aoi21  g143(.a(x3), .b(x1), .c(x0), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n32_), .c(new_n158_), .O(new_n161_));
  aoi21  g145(.a(new_n161_), .b(x4), .c(new_n29_), .O(new_n162_));
  oai21  g146(.a(new_n159_), .b(new_n157_), .c(new_n162_), .O(new_n163_));
  aoi21  g147(.a(new_n51_), .b(x8), .c(new_n18_), .O(new_n164_));
  aoi22  g148(.a(new_n112_), .b(x3), .c(new_n90_), .d(x0), .O(new_n165_));
  oai21  g149(.a(new_n68_), .b(x7), .c(new_n165_), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n164_), .c(x1), .O(new_n167_));
  inv1   g151(.a(new_n36_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n24_), .O(new_n169_));
  oai22  g153(.a(new_n97_), .b(new_n67_), .c(new_n36_), .d(x0), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x4), .O(new_n171_));
  nand3  g155(.a(new_n171_), .b(new_n169_), .c(new_n167_), .O(new_n172_));
  oai22  g156(.a(new_n151_), .b(new_n102_), .c(new_n30_), .d(new_n31_), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(new_n18_), .O(new_n174_));
  nand4  g158(.a(new_n168_), .b(x4), .c(x3), .d(new_n78_), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(new_n174_), .c(x2), .O(new_n176_));
  aoi21  g160(.a(new_n172_), .b(new_n29_), .c(new_n176_), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(new_n163_), .c(new_n17_), .O(z4));
  xnor2a g162(.a(x2), .b(x0), .O(new_n179_));
  nand2  g163(.a(new_n179_), .b(z2), .O(new_n180_));
