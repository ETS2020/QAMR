...
module FAU ( 
  ...
  nor2   g147(.a(new_n99_), .b(x3), .O(new_n164_));
  nand2  g148(.a(new_n99_), .b(x3), .O(new_n165_));
  nor2   g149(.a(new_n30_), .b(new_n91_), .O(new_n166_));
  aoi21  g150(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  oai22  g151(.a(new_n167_), .b(new_n26_), .c(new_n149_), .d(x6), .O(new_n168_));
  nand2  g152(.a(x5), .b(x4), .O(new_n169_));
  oai21  g153(.a(new_n131_), .b(new_n53_), .c(x3), .O(new_n170_));
  oai21  g154(.a(x8), .b(new_n18_), .c(new_n30_), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(x1), .c(x5), .O(new_n172_));
  nand2  g156(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  oai21  g157(.a(new_n160_), .b(new_n91_), .c(new_n76_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(x5), .c(new_n21_), .O(new_n175_));
  aoi22  g159(.a(new_n175_), .b(new_n173_), .c(new_n169_), .d(new_n168_), .O(new_n176_));
  nand2  g160(.a(x9), .b(x7), .O(new_n177_));
  aoi21  g161(.a(new_n176_), .b(new_n163_), .c(new_n177_), .O(z4));
