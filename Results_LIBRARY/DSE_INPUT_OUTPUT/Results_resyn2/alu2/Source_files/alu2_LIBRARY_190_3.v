...
module FAU ( 
  ...
  nor2   g129(.a(new_n21_), .b(new_n20_), .O(new_n146_));
  inv1   g130(.a(new_n146_), .O(new_n147_));
  nand2  g131(.a(new_n75_), .b(x1), .O(new_n148_));
  nand2  g132(.a(x3), .b(new_n74_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand2  g134(.a(new_n150_), .b(new_n147_), .O(z2));
  nor3   g135(.a(new_n146_), .b(new_n75_), .c(new_n74_), .O(z3));
  nand2  g136(.a(x2), .b(new_n17_), .O(new_n153_));
  aoi21  g137(.a(new_n149_), .b(new_n153_), .c(new_n34_), .O(new_n154_));
  nand2  g138(.a(x2), .b(x1), .O(new_n155_));
  nand2  g139(.a(x3), .b(x0), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n155_), .c(x8), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n154_), .c(x4), .O(new_n158_));
  aoi21  g142(.a(new_n148_), .b(x8), .c(new_n34_), .O(new_n159_));
  nand2  g143(.a(new_n44_), .b(new_n74_), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n130_), .c(new_n159_), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n49_), .O(new_n163_));
  nand2  g147(.a(new_n87_), .b(x4), .O(new_n164_));
  nand3  g148(.a(new_n34_), .b(x1), .c(x0), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(new_n164_), .c(x8), .O(new_n166_));
  nand2  g150(.a(new_n149_), .b(new_n153_), .O(new_n167_));
  nor2   g151(.a(new_n87_), .b(x8), .O(new_n168_));
  nor2   g152(.a(new_n168_), .b(x6), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n167_), .c(new_n30_), .O(new_n170_));
  nand2  g154(.a(new_n148_), .b(new_n81_), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(x6), .c(new_n49_), .O(new_n172_));
  aoi21  g156(.a(new_n172_), .b(new_n170_), .c(new_n166_), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n163_), .c(new_n67_), .O(z4));
  oai21  g158(.a(new_n171_), .b(new_n167_), .c(new_n147_), .O(z5));
endmodule
