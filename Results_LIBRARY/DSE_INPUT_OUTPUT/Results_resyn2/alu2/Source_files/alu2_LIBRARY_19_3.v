...
module FAU ( 
  ...
  nor2   g134(.a(new_n28_), .b(new_n17_), .O(new_n151_));
  inv1   g135(.a(new_n151_), .O(new_n152_));
  nand2  g136(.a(new_n67_), .b(x1), .O(new_n153_));
  nand3  g137(.a(new_n153_), .b(new_n152_), .c(new_n150_), .O(new_n154_));
  inv1   g138(.a(new_n154_), .O(z2));
  nor3   g139(.a(new_n151_), .b(new_n67_), .c(new_n66_), .O(z3));
  aoi21  g140(.a(new_n150_), .b(new_n118_), .c(new_n35_), .O(new_n157_));
  nand2  g141(.a(x2), .b(x1), .O(new_n158_));
  nand2  g142(.a(x3), .b(x0), .O(new_n159_));
  aoi21  g143(.a(new_n159_), .b(new_n158_), .c(x8), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n157_), .c(x4), .O(new_n161_));
  nor2   g145(.a(new_n30_), .b(new_n86_), .O(new_n162_));
  aoi21  g146(.a(new_n153_), .b(x8), .c(new_n35_), .O(new_n163_));
  nand2  g147(.a(new_n21_), .b(new_n66_), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n162_), .c(new_n163_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(new_n18_), .O(new_n167_));
  nand2  g151(.a(new_n82_), .b(x4), .O(new_n168_));
  nand3  g152(.a(new_n35_), .b(x1), .c(x0), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n168_), .c(x8), .O(new_n170_));
  nand2  g154(.a(new_n150_), .b(new_n118_), .O(new_n171_));
  nor2   g155(.a(new_n82_), .b(x8), .O(new_n172_));
  nor2   g156(.a(new_n172_), .b(x6), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n171_), .c(new_n25_), .O(new_n174_));
  nand2  g158(.a(new_n153_), .b(new_n95_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(x6), .c(new_n18_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n174_), .c(new_n170_), .O(new_n177_));
  nand2  g161(.a(x9), .b(new_n17_), .O(new_n178_));
  aoi21  g162(.a(new_n177_), .b(new_n167_), .c(new_n178_), .O(z4));
  oai21  g163(.a(new_n175_), .b(new_n171_), .c(new_n152_), .O(z5));
endmodule
