...
module FAU ( 
  ...
  aoi21  g009(.a(new_n20_), .b(new_n24_), .c(new_n25_), .O(new_n26_));
  oai21  g010(.a(new_n23_), .b(new_n20_), .c(new_n26_), .O(new_n27_));
  inv1   g011(.a(x2), .O(new_n28_));
  oai21  g012(.a(new_n19_), .b(x7), .c(x5), .O(new_n29_));
  aoi21  g013(.a(new_n29_), .b(new_n25_), .c(new_n28_), .O(new_n30_));
  nand2  g014(.a(new_n30_), .b(new_n27_), .O(new_n31_));
  nor2   g015(.a(new_n18_), .b(x2), .O(new_n32_));
  nor2   g016(.a(x9), .b(x4), .O(new_n33_));
  nor2   g017(.a(new_n25_), .b(new_n24_), .O(new_n34_));
  ...
  nand3  g026(.a(new_n24_), .b(new_n21_), .c(x2), .O(new_n43_));
  ...
  oai21  g057(.a(x4), .b(new_n28_), .c(new_n24_), .O(new_n74_));
  ...
  oai21  g062(.a(new_n28_), .b(new_n40_), .c(new_n69_), .O(new_n79_));
  oai21  g063(.a(new_n79_), .b(new_n78_), .c(new_n55_), .O(new_n80_));
  nand2  g064(.a(new_n80_), .b(new_n18_), .O(new_n81_));
  aoi21  g065(.a(new_n81_), .b(new_n77_), .c(new_n25_), .O(new_n82_));
  nand3  g066(.a(new_n24_), .b(x4), .c(new_n69_), .O(new_n83_));
  ...
  oai21  g073(.a(new_n89_), .b(x6), .c(new_n25_), .O(new_n90_));
  nand2  g074(.a(new_n68_), .b(new_n19_), .O(new_n91_));
  oai21  g075(.a(x6), .b(x2), .c(new_n21_), .O(new_n92_));
  aoi21  g076(.a(new_n92_), .b(new_n24_), .c(new_n25_), .O(new_n93_));
  ...
  nor2   g082(.a(new_n28_), .b(new_n40_), .O(new_n99_));
  ...
  nand4  g086(.a(new_n25_), .b(new_n18_), .c(new_n45_), .d(new_n88_), .O(new_n103_));
  ...
  oai21  g092(.a(new_n24_), .b(new_n18_), .c(x0), .O(new_n109_));
  nand3  g093(.a(new_n109_), .b(new_n69_), .c(x2), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n108_), .c(x4), .O(new_n111_));
  oai21  g095(.a(new_n22_), .b(x2), .c(new_n62_), .O(new_n112_));
  oai21  g096(.a(x4), .b(new_n69_), .c(x8), .O(new_n113_));
  aoi21  g097(.a(new_n112_), .b(x0), .c(new_n113_), .O(new_n114_));
  oai21  g098(.a(new_n114_), .b(new_n111_), .c(x5), .O(new_n115_));
  nand2  g099(.a(new_n115_), .b(x9), .O(new_n116_));
  nor2   g100(.a(x7), .b(x3), .O(new_n117_));
  oai21  g101(.a(new_n19_), .b(new_n45_), .c(new_n117_), .O(new_n118_));
  nand2  g102(.a(new_n18_), .b(x3), .O(new_n119_));
  nand2  g103(.a(new_n119_), .b(x5), .O(new_n120_));
  aoi21  g104(.a(new_n120_), .b(new_n21_), .c(x9), .O(new_n121_));
  aoi21  g105(.a(new_n121_), .b(new_n118_), .c(x1), .O(new_n122_));
  ...
  nand3  g116(.a(x7), .b(x3), .c(new_n28_), .O(new_n133_));
  oai21  g117(.a(x8), .b(x6), .c(new_n133_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(x1), .O(new_n135_));
  oai21  g119(.a(new_n17_), .b(x2), .c(x6), .O(new_n136_));
  nand3  g120(.a(new_n62_), .b(x8), .c(new_n18_), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(new_n136_), .c(new_n69_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n135_), .c(new_n40_), .O(new_n139_));
  nand2  g123(.a(x2), .b(new_n40_), .O(new_n140_));
  aoi22  g124(.a(new_n69_), .b(x1), .c(new_n28_), .d(x0), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g126(.a(new_n70_), .b(new_n88_), .O(new_n143_));
  oai21  g127(.a(new_n50_), .b(new_n24_), .c(new_n143_), .O(new_n144_));
  nand2  g128(.a(new_n119_), .b(new_n70_), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(x7), .c(x1), .O(new_n146_));
  oai21  g130(.a(new_n144_), .b(new_n142_), .c(new_n146_), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n139_), .c(new_n21_), .O(new_n148_));
  oai21  g132(.a(new_n127_), .b(new_n99_), .c(x7), .O(new_n149_));
  inv1   g133(.a(new_n141_), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(x6), .c(new_n21_), .O(new_n151_));
  nand3  g135(.a(new_n67_), .b(new_n18_), .c(new_n69_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(x5), .O(new_n153_));
  aoi21  g137(.a(new_n151_), .b(new_n149_), .c(new_n153_), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(new_n148_), .c(new_n25_), .O(z4));
  nand2  g139(.a(new_n28_), .b(x0), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(new_n140_), .O(new_n157_));
