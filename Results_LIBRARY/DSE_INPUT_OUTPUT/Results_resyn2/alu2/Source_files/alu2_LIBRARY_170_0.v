...
module FAU ( 
  ...
  nand2  g157(.a(new_n52_), .b(new_n26_), .O(new_n174_));
  nand3  g158(.a(new_n41_), .b(new_n20_), .c(x4), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n90_), .c(new_n174_), .O(new_n176_));
  aoi21  g160(.a(new_n173_), .b(new_n170_), .c(new_n176_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n150_), .c(new_n124_), .O(z1));
  nand2  g162(.a(new_n67_), .b(x1), .O(new_n179_));
  nand2  g163(.a(x3), .b(new_n66_), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n174_), .O(z2));
  oai21  g166(.a(new_n67_), .b(new_n66_), .c(new_n174_), .O(z3));
  nor2   g167(.a(new_n41_), .b(x6), .O(new_n184_));
  nor2   g168(.a(x8), .b(x1), .O(new_n185_));
  oai21  g169(.a(new_n185_), .b(new_n184_), .c(x2), .O(new_n186_));
  nor2   g170(.a(new_n41_), .b(x2), .O(new_n187_));
  nor2   g171(.a(x8), .b(x6), .O(new_n188_));
  aoi21  g172(.a(new_n187_), .b(x6), .c(new_n188_), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n186_), .c(new_n37_), .O(new_n190_));
  nand2  g174(.a(new_n117_), .b(x1), .O(new_n191_));
  inv1   g175(.a(new_n191_), .O(new_n192_));
  oai21  g176(.a(new_n192_), .b(new_n190_), .c(new_n17_), .O(new_n193_));
  nand3  g177(.a(new_n185_), .b(new_n17_), .c(new_n25_), .O(new_n194_));
  oai21  g178(.a(x6), .b(new_n17_), .c(new_n194_), .O(new_n195_));
  aoi21  g179(.a(x8), .b(new_n17_), .c(new_n39_), .O(new_n196_));
  aoi21  g180(.a(new_n195_), .b(new_n37_), .c(new_n196_), .O(new_n197_));
  aoi21  g181(.a(new_n197_), .b(new_n193_), .c(x3), .O(new_n198_));
  nand2  g182(.a(new_n85_), .b(new_n53_), .O(new_n199_));
  nor3   g183(.a(new_n199_), .b(new_n181_), .c(new_n112_), .O(new_n200_));
  nand2  g184(.a(new_n53_), .b(x7), .O(new_n201_));
  nand2  g185(.a(new_n98_), .b(x1), .O(new_n202_));
  aoi21  g186(.a(new_n201_), .b(new_n39_), .c(new_n202_), .O(new_n203_));
  oai21  g187(.a(new_n203_), .b(new_n200_), .c(new_n17_), .O(new_n204_));
  aoi21  g188(.a(new_n39_), .b(x0), .c(x1), .O(new_n205_));
  nand2  g189(.a(new_n179_), .b(x2), .O(new_n206_));
  aoi21  g190(.a(x3), .b(new_n37_), .c(new_n20_), .O(new_n207_));
  aoi21  g191(.a(new_n207_), .b(new_n206_), .c(x7), .O(new_n208_));
  oai21  g192(.a(new_n208_), .b(new_n205_), .c(x4), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n204_), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n198_), .c(x5), .O(new_n211_));
  nand2  g195(.a(new_n188_), .b(x2), .O(new_n212_));
  aoi21  g196(.a(new_n212_), .b(new_n116_), .c(new_n17_), .O(new_n213_));
  nand2  g197(.a(new_n184_), .b(x3), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n111_), .O(new_n215_));
  oai21  g199(.a(new_n215_), .b(new_n213_), .c(x1), .O(new_n216_));
  nand2  g200(.a(new_n31_), .b(new_n98_), .O(new_n217_));
  nand3  g201(.a(new_n41_), .b(x6), .c(new_n37_), .O(new_n218_));
  nand2  g202(.a(new_n98_), .b(x3), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n218_), .c(new_n25_), .O(new_n220_));
  nand3  g204(.a(new_n31_), .b(x3), .c(new_n66_), .O(new_n221_));
  ...
  nand2  g208(.a(new_n224_), .b(new_n26_), .O(new_n225_));
  nor2   g209(.a(x4), .b(new_n66_), .O(new_n226_));
  nand3  g210(.a(new_n226_), .b(new_n184_), .c(x3), .O(new_n227_));
  inv1   g211(.a(new_n188_), .O(new_n228_));
  aoi21  g212(.a(x4), .b(x3), .c(x1), .O(new_n229_));
  aoi21  g213(.a(new_n228_), .b(new_n84_), .c(new_n229_), .O(new_n230_));
  nand2  g214(.a(new_n98_), .b(new_n17_), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n80_), .c(new_n20_), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n230_), .c(new_n26_), .O(new_n233_));
  inv1   g217(.a(new_n189_), .O(new_n234_));
  nand2  g218(.a(new_n226_), .b(new_n234_), .O(new_n235_));
  nand2  g219(.a(new_n235_), .b(new_n233_), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(x0), .O(new_n237_));
  nand3  g221(.a(new_n237_), .b(new_n227_), .c(new_n225_), .O(new_n238_));
  inv1   g222(.a(new_n238_), .O(new_n239_));
  aoi21  g223(.a(new_n239_), .b(new_n211_), .c(new_n52_), .O(z4));
  oai21  g224(.a(new_n199_), .b(new_n181_), .c(new_n174_), .O(z5));
endmodule
