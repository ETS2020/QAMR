...
module FAU ( 
  ...
  nand3  g060(.a(new_n76_), .b(new_n71_), .c(new_n75_), .O(new_n77_));
  nand2  g061(.a(new_n77_), .b(new_n54_), .O(new_n78_));
  nand2  g062(.a(new_n78_), .b(new_n18_), .O(new_n79_));
  aoi21  g063(.a(new_n79_), .b(new_n74_), .c(new_n28_), .O(new_n80_));
  nand3  g064(.a(new_n23_), .b(x4), .c(new_n75_), .O(new_n81_));
  ...
  aoi21  g073(.a(new_n89_), .b(new_n87_), .c(new_n75_), .O(new_n90_));
  aoi21  g074(.a(new_n18_), .b(new_n27_), .c(new_n39_), .O(new_n91_));
  nand2  g075(.a(new_n18_), .b(new_n75_), .O(new_n92_));
  ...
  oai21  g101(.a(x6), .b(new_n75_), .c(x5), .O(new_n118_));
  ...
  nand2  g109(.a(new_n75_), .b(x1), .O(new_n126_));
  nand2  g110(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g111(.a(new_n127_), .b(new_n60_), .O(z2));
  nor3   g112(.a(new_n59_), .b(new_n75_), .c(new_n86_), .O(z3));
  ...
  nor2   g122(.a(x6), .b(new_n75_), .O(new_n139_));
  ...
  nand2  g128(.a(new_n27_), .b(new_n39_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n76_), .O(new_n146_));
  nand3  g130(.a(new_n146_), .b(new_n126_), .c(new_n125_), .O(new_n147_));
  aoi21  g131(.a(new_n27_), .b(x0), .c(new_n75_), .O(new_n148_));
  oai21  g132(.a(new_n27_), .b(x1), .c(x6), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n148_), .c(x4), .O(new_n150_));
  oai21  g134(.a(new_n147_), .b(new_n24_), .c(new_n150_), .O(new_n151_));
  ...
  aoi21  g140(.a(new_n151_), .b(new_n17_), .c(new_n156_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n144_), .c(new_n28_), .O(z4));
  inv1   g142(.a(new_n147_), .O(new_n159_));
