...
module FAU ( 
  ...
  aoi21  g107(.a(new_n65_), .b(new_n90_), .c(new_n60_), .O(new_n124_));
  nand2  g108(.a(new_n124_), .b(new_n123_), .O(z2));
  oai21  g109(.a(new_n29_), .b(x5), .c(new_n123_), .O(z3));
  ...
  nor2   g136(.a(new_n141_), .b(new_n60_), .O(new_n153_));
  aoi21  g137(.a(new_n124_), .b(new_n123_), .c(new_n153_), .O(z5));
endmodule
