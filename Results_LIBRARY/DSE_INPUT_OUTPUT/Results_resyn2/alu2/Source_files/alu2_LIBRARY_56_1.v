...
module FAU ( 
  ...
  oai21  g146(.a(new_n127_), .b(new_n87_), .c(new_n162_), .O(z2));
  nor2   g147(.a(new_n127_), .b(new_n87_), .O(z3));
  inv1   g148(.a(new_n20_), .O(new_n165_));
  nor2   g149(.a(new_n70_), .b(new_n17_), .O(new_n166_));
  nor2   g150(.a(x2), .b(x0), .O(new_n167_));
  nor2   g151(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  oai21  g152(.a(x6), .b(x4), .c(x3), .O(new_n169_));
  aoi21  g153(.a(new_n168_), .b(new_n102_), .c(new_n169_), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n165_), .c(new_n23_), .O(new_n171_));
  nor2   g155(.a(new_n132_), .b(new_n71_), .O(new_n172_));
  oai22  g156(.a(new_n166_), .b(new_n20_), .c(new_n40_), .d(x4), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n127_), .c(new_n172_), .O(new_n174_));
  nand2  g158(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x5), .O(new_n176_));
  oai21  g160(.a(new_n151_), .b(new_n77_), .c(x2), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(new_n40_), .c(new_n29_), .O(new_n178_));
  oai21  g162(.a(new_n26_), .b(new_n127_), .c(new_n71_), .O(new_n179_));
  inv1   g163(.a(new_n179_), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(new_n178_), .c(new_n25_), .O(new_n181_));
  aoi21  g165(.a(x3), .b(x2), .c(new_n19_), .O(new_n182_));
  oai21  g166(.a(new_n23_), .b(new_n70_), .c(x8), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n182_), .c(x0), .O(new_n184_));
  aoi21  g168(.a(x8), .b(x2), .c(new_n23_), .O(new_n185_));
  nor3   g169(.a(new_n185_), .b(new_n19_), .c(new_n25_), .O(new_n186_));
  aoi21  g170(.a(new_n184_), .b(new_n181_), .c(new_n186_), .O(new_n187_));
  nand3  g171(.a(x7), .b(new_n19_), .c(x3), .O(new_n188_));
  inv1   g172(.a(new_n188_), .O(new_n189_));
  oai21  g173(.a(new_n189_), .b(new_n187_), .c(new_n48_), .O(new_n190_));
  nand2  g174(.a(x9), .b(x1), .O(new_n191_));
  aoi21  g175(.a(new_n190_), .b(new_n176_), .c(new_n191_), .O(z4));
  nor2   g176(.a(x3), .b(x1), .O(new_n193_));
  nor2   g177(.a(new_n193_), .b(z3), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n168_), .c(new_n88_), .O(z5));
endmodule
