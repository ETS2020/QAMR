...
module FAU ( 
  ...
  nand3  g142(.a(new_n64_), .b(new_n103_), .c(new_n111_), .O(new_n159_));
  nor3   g143(.a(new_n63_), .b(new_n103_), .c(new_n111_), .O(z3));
  inv1   g144(.a(z3), .O(new_n161_));
  nand2  g145(.a(new_n161_), .b(new_n159_), .O(z2));
  ...
  aoi21  g165(.a(new_n161_), .b(new_n159_), .c(new_n181_), .O(z5));
endmodule
