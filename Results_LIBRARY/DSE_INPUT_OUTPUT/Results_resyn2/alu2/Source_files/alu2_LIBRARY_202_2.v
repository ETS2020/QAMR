...
module FAU ( 
  ...
  nand2  g166(.a(new_n22_), .b(x5), .O(new_n183_));
  nor2   g167(.a(x3), .b(x1), .O(new_n184_));
  nor2   g168(.a(new_n80_), .b(new_n76_), .O(new_n185_));
  nor2   g169(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g170(.a(new_n186_), .b(new_n183_), .O(z2));
  inv1   g171(.a(new_n185_), .O(new_n188_));
  nand2  g172(.a(new_n188_), .b(new_n183_), .O(z3));
  nand2  g173(.a(x9), .b(new_n17_), .O(new_n190_));
  ...
  nand2  g177(.a(x3), .b(new_n76_), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(new_n35_), .c(x5), .O(new_n195_));
  oai22  g179(.a(new_n195_), .b(new_n193_), .c(new_n190_), .d(x8), .O(new_n196_));
  nand2  g180(.a(new_n196_), .b(new_n28_), .O(new_n197_));
  inv1   g181(.a(new_n190_), .O(new_n198_));
  nand2  g182(.a(new_n97_), .b(new_n76_), .O(new_n199_));
  nand2  g183(.a(new_n18_), .b(x1), .O(new_n200_));
  nand4  g184(.a(new_n200_), .b(new_n199_), .c(new_n192_), .d(new_n35_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(new_n198_), .O(new_n202_));
  aoi21  g186(.a(new_n202_), .b(new_n197_), .c(new_n27_), .O(new_n203_));
  nor2   g187(.a(new_n192_), .b(new_n152_), .O(new_n204_));
  aoi21  g188(.a(new_n199_), .b(x8), .c(x7), .O(new_n205_));
  oai21  g189(.a(new_n205_), .b(new_n204_), .c(new_n198_), .O(new_n206_));
  inv1   g190(.a(new_n184_), .O(new_n207_));
  nand3  g191(.a(new_n28_), .b(x3), .c(x1), .O(new_n208_));
  nand2  g192(.a(new_n144_), .b(x5), .O(new_n209_));
  aoi21  g193(.a(new_n208_), .b(new_n207_), .c(new_n209_), .O(new_n210_));
  nor2   g194(.a(new_n29_), .b(x1), .O(new_n211_));
  nor4   g195(.a(new_n211_), .b(new_n190_), .c(new_n34_), .d(new_n28_), .O(new_n212_));
  oai21  g196(.a(new_n212_), .b(new_n210_), .c(new_n27_), .O(new_n213_));
  inv1   g197(.a(new_n192_), .O(new_n214_));
  nand3  g198(.a(new_n214_), .b(new_n152_), .c(x5), .O(new_n215_));
  nand3  g199(.a(new_n215_), .b(new_n213_), .c(new_n206_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n203_), .c(x6), .O(new_n217_));
  aoi22  g201(.a(new_n118_), .b(new_n76_), .c(new_n46_), .d(x8), .O(new_n218_));
  nand2  g202(.a(new_n185_), .b(x7), .O(new_n219_));
  inv1   g203(.a(new_n219_), .O(new_n220_));
  oai21  g204(.a(new_n220_), .b(new_n218_), .c(x0), .O(new_n221_));
  nand2  g205(.a(new_n66_), .b(x2), .O(new_n222_));
  inv1   g206(.a(new_n222_), .O(new_n223_));
  aoi22  g207(.a(new_n223_), .b(new_n207_), .c(new_n185_), .d(new_n31_), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n221_), .c(new_n190_), .O(new_n225_));
  oai21  g209(.a(x3), .b(x2), .c(x7), .O(new_n226_));
  nand2  g210(.a(new_n226_), .b(x8), .O(new_n227_));
  nand2  g211(.a(new_n148_), .b(new_n109_), .O(new_n228_));
  nand3  g212(.a(new_n228_), .b(new_n227_), .c(new_n194_), .O(new_n229_));
  nand2  g213(.a(new_n229_), .b(new_n28_), .O(new_n230_));
  oai21  g214(.a(x3), .b(x0), .c(x2), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n188_), .c(new_n174_), .O(new_n232_));
  nor2   g216(.a(new_n232_), .b(x6), .O(new_n233_));
  nand2  g217(.a(new_n233_), .b(new_n230_), .O(new_n234_));
  nand2  g218(.a(new_n78_), .b(x1), .O(new_n235_));
  nor2   g219(.a(new_n176_), .b(new_n28_), .O(new_n236_));
  ...
  nand2  g223(.a(new_n239_), .b(new_n217_), .O(z4));
  xor2a  g224(.a(x2), .b(x0), .O(new_n241_));
  oai21  g225(.a(new_n241_), .b(new_n186_), .c(new_n183_), .O(z5));
endmodule
