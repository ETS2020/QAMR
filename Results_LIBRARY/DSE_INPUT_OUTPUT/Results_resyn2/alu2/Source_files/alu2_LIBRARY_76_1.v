...
module FAU ( 
  ...
  inv1   g088(.a(new_n66_), .O(new_n105_));
  nand2  g089(.a(new_n105_), .b(new_n39_), .O(new_n106_));
  ...
  nand3  g093(.a(new_n109_), .b(new_n76_), .c(x2), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n108_), .c(x4), .O(new_n111_));
  oai21  g095(.a(new_n21_), .b(x2), .c(new_n61_), .O(new_n112_));
  oai21  g096(.a(x4), .b(new_n76_), .c(x8), .O(new_n113_));
  aoi21  g097(.a(new_n112_), .b(x0), .c(new_n113_), .O(new_n114_));
  nor2   g098(.a(new_n28_), .b(new_n44_), .O(new_n115_));
  oai21  g099(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  nor2   g100(.a(x6), .b(new_n76_), .O(new_n117_));
  nor2   g101(.a(new_n117_), .b(new_n44_), .O(new_n118_));
  nor2   g102(.a(new_n118_), .b(x4), .O(new_n119_));
  nand2  g103(.a(new_n17_), .b(new_n76_), .O(new_n120_));
  aoi21  g104(.a(new_n24_), .b(x5), .c(new_n120_), .O(new_n121_));
  oai21  g105(.a(new_n121_), .b(new_n119_), .c(new_n28_), .O(new_n122_));
  nand2  g106(.a(new_n122_), .b(new_n116_), .O(new_n123_));
  aoi21  g107(.a(x4), .b(x1), .c(new_n44_), .O(new_n124_));
  nor4   g108(.a(new_n124_), .b(x9), .c(new_n18_), .d(x3), .O(new_n125_));
  aoi21  g109(.a(new_n123_), .b(new_n86_), .c(new_n125_), .O(new_n126_));
  nand3  g110(.a(new_n126_), .b(new_n104_), .c(new_n85_), .O(z1));
  nand2  g111(.a(x3), .b(new_n86_), .O(new_n128_));
  nand2  g112(.a(new_n76_), .b(x1), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nor2   g114(.a(new_n130_), .b(new_n59_), .O(z2));
  oai21  g115(.a(new_n76_), .b(new_n86_), .c(new_n60_), .O(z3));
  inv1   g116(.a(new_n115_), .O(new_n133_));
  nand2  g117(.a(x6), .b(new_n39_), .O(new_n134_));
  oai22  g118(.a(new_n134_), .b(new_n130_), .c(x6), .d(new_n86_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(new_n27_), .O(new_n136_));
  oai21  g120(.a(new_n32_), .b(x3), .c(new_n86_), .O(new_n137_));
  nand3  g121(.a(new_n17_), .b(x6), .c(x1), .O(new_n138_));
  nand3  g122(.a(new_n138_), .b(new_n137_), .c(x0), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(new_n136_), .c(x8), .O(new_n140_));
  nor2   g124(.a(new_n18_), .b(x3), .O(new_n141_));
  oai21  g125(.a(new_n117_), .b(new_n141_), .c(x1), .O(new_n142_));
  nand2  g126(.a(new_n92_), .b(x2), .O(new_n143_));
  nand3  g127(.a(new_n143_), .b(new_n128_), .c(new_n91_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n142_), .c(new_n17_), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n140_), .c(new_n20_), .O(new_n146_));
  xnor2a g130(.a(x2), .b(x0), .O(new_n147_));
  nand4  g131(.a(new_n147_), .b(new_n129_), .c(new_n128_), .d(new_n19_), .O(new_n148_));
  aoi21  g132(.a(new_n76_), .b(x1), .c(new_n27_), .O(new_n149_));
  oai21  g133(.a(new_n76_), .b(x0), .c(x6), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n149_), .c(x4), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n148_), .c(x7), .O(new_n152_));
  nand2  g136(.a(new_n92_), .b(x1), .O(new_n153_));
  nor2   g137(.a(new_n91_), .b(new_n20_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  oai21  g139(.a(new_n92_), .b(new_n105_), .c(new_n155_), .O(new_n156_));
  nor2   g140(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n146_), .c(new_n133_), .O(z4));
  nand2  g142(.a(new_n147_), .b(z2), .O(new_n159_));
