...
module FAU ( 
  ...
  nor2   g144(.a(new_n76_), .b(new_n114_), .O(new_n161_));
  nor2   g145(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n159_), .O(z2));
  and2   g147(.a(new_n161_), .b(new_n159_), .O(z3));
  aoi22  g148(.a(new_n103_), .b(new_n102_), .c(x7), .d(new_n114_), .O(new_n165_));
  oai21  g149(.a(new_n17_), .b(new_n76_), .c(new_n114_), .O(new_n166_));
  nand2  g150(.a(new_n161_), .b(new_n80_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  oai21  g152(.a(new_n71_), .b(new_n114_), .c(x7), .O(new_n169_));
  aoi21  g153(.a(new_n97_), .b(x0), .c(new_n169_), .O(new_n170_));
  aoi21  g154(.a(new_n168_), .b(x8), .c(new_n170_), .O(new_n171_));
  oai21  g155(.a(new_n171_), .b(new_n165_), .c(x6), .O(new_n172_));
  nand2  g156(.a(new_n166_), .b(new_n131_), .O(new_n173_));
  nand2  g157(.a(new_n161_), .b(x7), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n173_), .c(new_n21_), .O(new_n175_));
  inv1   g159(.a(new_n146_), .O(new_n176_));
  oai21  g160(.a(new_n176_), .b(new_n86_), .c(x1), .O(new_n177_));
  aoi21  g161(.a(new_n86_), .b(x3), .c(x5), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nor2   g163(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n172_), .c(new_n33_), .O(z4));
  nand2  g165(.a(x2), .b(new_n21_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(new_n102_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n162_), .c(new_n159_), .O(z5));
endmodule
