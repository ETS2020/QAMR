...
module FAU ( 
  ...
  xor2a  g107(.a(x3), .b(x1), .O(new_n124_));
  nor2   g108(.a(new_n124_), .b(new_n60_), .O(z2));
  nor3   g109(.a(new_n60_), .b(new_n65_), .c(new_n90_), .O(z3));
  nand2  g110(.a(x7), .b(new_n45_), .O(new_n127_));
  nand2  g111(.a(x2), .b(new_n90_), .O(new_n128_));
  nand2  g112(.a(new_n61_), .b(x0), .O(new_n129_));
  aoi21  g113(.a(new_n128_), .b(new_n127_), .c(new_n129_), .O(new_n130_));
  nand2  g114(.a(new_n17_), .b(new_n42_), .O(new_n131_));
  oai21  g115(.a(new_n21_), .b(new_n22_), .c(new_n90_), .O(new_n132_));
  oai22  g116(.a(new_n132_), .b(new_n131_), .c(new_n127_), .d(new_n90_), .O(new_n133_));
  oai21  g117(.a(new_n133_), .b(new_n130_), .c(x6), .O(new_n134_));
  nand2  g118(.a(new_n67_), .b(new_n18_), .O(new_n135_));
  nand2  g119(.a(new_n25_), .b(x2), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(new_n24_), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(new_n45_), .c(x0), .O(new_n138_));
  nand3  g122(.a(new_n138_), .b(new_n135_), .c(new_n134_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n65_), .O(new_n140_));
  oai21  g124(.a(new_n65_), .b(new_n17_), .c(x6), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n61_), .c(new_n42_), .O(new_n142_));
  nor2   g126(.a(new_n119_), .b(new_n118_), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n90_), .c(x4), .O(new_n144_));
  nor2   g128(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g129(.a(new_n23_), .b(x8), .O(new_n146_));
  nand2  g130(.a(new_n131_), .b(new_n113_), .O(new_n147_));
  oai21  g131(.a(x2), .b(new_n42_), .c(x6), .O(new_n148_));
  aoi22  g132(.a(new_n148_), .b(x7), .c(new_n147_), .d(new_n146_), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n65_), .c(new_n135_), .O(new_n150_));
  nor2   g134(.a(x4), .b(new_n90_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(new_n152_));
  nand2  g136(.a(x9), .b(x5), .O(new_n153_));
  aoi21  g137(.a(new_n152_), .b(new_n140_), .c(new_n153_), .O(z4));
  inv1   g138(.a(new_n60_), .O(new_n155_));
  inv1   g139(.a(new_n147_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n124_), .c(new_n155_), .O(z5));
endmodule
