...
module FAU ( 
  ...
  nor3   g114(.a(new_n127_), .b(new_n120_), .c(new_n93_), .O(z3));
  oai22  g115(.a(new_n20_), .b(x4), .c(new_n25_), .d(x1), .O(new_n132_));
  nand2  g116(.a(new_n94_), .b(x0), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g119(.a(new_n25_), .b(new_n18_), .O(new_n136_));
  nor2   g120(.a(new_n136_), .b(x1), .O(new_n137_));
  oai21  g121(.a(new_n46_), .b(new_n20_), .c(new_n137_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n135_), .c(new_n26_), .O(new_n139_));
  nand3  g123(.a(new_n46_), .b(new_n26_), .c(new_n25_), .O(new_n140_));
  aoi21  g124(.a(new_n20_), .b(x6), .c(x8), .O(new_n141_));
  nor2   g125(.a(new_n94_), .b(x6), .O(new_n142_));
  nor2   g126(.a(x4), .b(new_n18_), .O(new_n143_));
  oai21  g127(.a(new_n142_), .b(new_n141_), .c(new_n143_), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n139_), .c(new_n120_), .O(new_n146_));
  oai21  g130(.a(x7), .b(new_n26_), .c(x8), .O(new_n147_));
  nand2  g131(.a(new_n136_), .b(new_n74_), .O(new_n148_));
  oai21  g132(.a(x2), .b(new_n18_), .c(x6), .O(new_n149_));
  aoi22  g133(.a(new_n149_), .b(x7), .c(new_n148_), .d(new_n147_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n120_), .c(new_n140_), .O(new_n151_));
  nor2   g135(.a(x4), .b(new_n93_), .O(new_n152_));
  oai21  g136(.a(new_n120_), .b(new_n25_), .c(x6), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(new_n94_), .c(new_n18_), .O(new_n154_));
  nor2   g138(.a(new_n26_), .b(x3), .O(new_n155_));
  oai21  g139(.a(new_n121_), .b(new_n155_), .c(x1), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(x4), .O(new_n157_));
  oai21  g141(.a(new_n157_), .b(new_n154_), .c(x5), .O(new_n158_));
  aoi21  g142(.a(new_n152_), .b(new_n151_), .c(new_n158_), .O(new_n159_));
  aoi21  g143(.a(new_n159_), .b(new_n146_), .c(new_n17_), .O(z4));
  inv1   g144(.a(new_n148_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n129_), .c(new_n128_), .O(z5));
endmodule
