...
module FAU ( 
  ...
  nand2  g179(.a(new_n19_), .b(x2), .O(new_n196_));
  nor2   g180(.a(new_n85_), .b(x1), .O(new_n197_));
  nor2   g181(.a(x3), .b(new_n77_), .O(new_n198_));
  nor2   g182(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  and2   g183(.a(new_n199_), .b(new_n196_), .O(z2));
  oai21  g184(.a(new_n85_), .b(new_n77_), .c(new_n196_), .O(z3));
  nand2  g185(.a(new_n85_), .b(x0), .O(new_n202_));
  oai22  g186(.a(new_n202_), .b(new_n47_), .c(x8), .d(new_n77_), .O(new_n203_));
  nand2  g187(.a(new_n203_), .b(new_n17_), .O(new_n204_));
  inv1   g188(.a(new_n197_), .O(new_n205_));
  aoi22  g189(.a(new_n198_), .b(x6), .c(new_n205_), .d(new_n125_), .O(new_n206_));
  aoi21  g190(.a(new_n206_), .b(new_n204_), .c(new_n27_), .O(new_n207_));
  inv1   g191(.a(new_n156_), .O(new_n208_));
  nand2  g192(.a(new_n17_), .b(x1), .O(new_n209_));
  aoi21  g193(.a(new_n209_), .b(new_n202_), .c(new_n208_), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n207_), .c(new_n20_), .O(new_n211_));
  nand2  g195(.a(x4), .b(x3), .O(new_n212_));
  nand2  g196(.a(new_n199_), .b(new_n120_), .O(new_n213_));
  ...
  aoi21  g202(.a(new_n218_), .b(new_n211_), .c(new_n23_), .O(new_n219_));
  aoi21  g203(.a(new_n212_), .b(new_n77_), .c(new_n27_), .O(new_n220_));
  ...
  nor4   g212(.a(new_n209_), .b(new_n27_), .c(x4), .d(new_n18_), .O(new_n229_));
  ...
  nor3   g232(.a(new_n202_), .b(new_n103_), .c(x4), .O(new_n249_));
