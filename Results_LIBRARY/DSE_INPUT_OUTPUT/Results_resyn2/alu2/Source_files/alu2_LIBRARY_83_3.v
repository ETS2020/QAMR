...
module FAU ( 
  ...
  nand2  g137(.a(new_n153_), .b(new_n62_), .O(z2));
  nand2  g138(.a(x3), .b(x1), .O(new_n155_));
  nor2   g139(.a(new_n155_), .b(new_n61_), .O(z3));
  ...
  nand3  g143(.a(new_n159_), .b(new_n155_), .c(new_n158_), .O(new_n160_));
  ...
  nor4   g156(.a(new_n172_), .b(new_n153_), .c(new_n133_), .d(new_n61_), .O(z5));
endmodule
