...
module FAU ( 
  ...
  nor2   g155(.a(new_n168_), .b(new_n166_), .O(z3));
  nor2   g156(.a(x8), .b(x1), .O(new_n173_));
  nand2  g157(.a(x6), .b(new_n87_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n18_), .c(new_n42_), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n173_), .c(x3), .O(new_n176_));
  nand2  g160(.a(new_n146_), .b(new_n82_), .O(new_n177_));
  nor2   g161(.a(x8), .b(x6), .O(new_n178_));
  aoi22  g162(.a(new_n178_), .b(x1), .c(new_n177_), .d(x6), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n176_), .c(x5), .O(new_n180_));
  aoi21  g164(.a(new_n168_), .b(new_n42_), .c(new_n18_), .O(new_n181_));
  oai21  g165(.a(new_n76_), .b(new_n87_), .c(x5), .O(new_n182_));
  oai22  g166(.a(new_n182_), .b(new_n181_), .c(new_n145_), .d(new_n174_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n180_), .c(x4), .O(new_n184_));
  nand2  g168(.a(new_n169_), .b(new_n22_), .O(new_n185_));
  nand2  g169(.a(new_n133_), .b(new_n45_), .O(new_n186_));
  ...
  nand2  g173(.a(new_n188_), .b(new_n18_), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n189_), .c(x1), .O(new_n191_));
  oai21  g175(.a(new_n118_), .b(x1), .c(new_n191_), .O(new_n192_));
  oai21  g176(.a(new_n192_), .b(new_n187_), .c(new_n49_), .O(new_n193_));
  nor2   g177(.a(x5), .b(new_n87_), .O(new_n194_));
  oai21  g178(.a(new_n190_), .b(new_n81_), .c(new_n194_), .O(new_n195_));
  nand2  g179(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand2  g180(.a(new_n91_), .b(new_n29_), .O(new_n197_));
  inv1   g181(.a(new_n197_), .O(new_n198_));
  nand2  g182(.a(new_n81_), .b(x5), .O(new_n199_));
  oai21  g183(.a(new_n17_), .b(new_n49_), .c(x7), .O(new_n200_));
  aoi21  g184(.a(new_n199_), .b(new_n156_), .c(new_n200_), .O(new_n201_));
  oai21  g185(.a(new_n201_), .b(new_n198_), .c(x1), .O(new_n202_));
  nand3  g186(.a(new_n202_), .b(new_n20_), .c(x2), .O(new_n203_));
  aoi21  g187(.a(new_n196_), .b(x0), .c(new_n203_), .O(new_n204_));
  aoi21  g188(.a(new_n204_), .b(new_n184_), .c(new_n53_), .O(z4));
  inv1   g189(.a(new_n166_), .O(new_n206_));
  xor2a  g190(.a(x2), .b(x0), .O(new_n207_));
  oai21  g191(.a(new_n207_), .b(new_n170_), .c(new_n206_), .O(z5));
endmodule
