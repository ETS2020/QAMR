...
module FAU ( 
  ...
  and2   g112(.a(new_n128_), .b(new_n125_), .O(z2));
  oai21  g113(.a(new_n70_), .b(new_n85_), .c(new_n125_), .O(z3));
  nand3  g114(.a(x7), .b(x3), .c(new_n20_), .O(new_n131_));
  oai21  g115(.a(x8), .b(x6), .c(new_n131_), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(x1), .O(new_n133_));
  oai21  g117(.a(new_n25_), .b(x2), .c(x6), .O(new_n134_));
  oai21  g118(.a(new_n25_), .b(new_n20_), .c(new_n68_), .O(new_n135_));
  nand3  g119(.a(new_n135_), .b(new_n134_), .c(new_n70_), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n133_), .c(new_n34_), .O(new_n137_));
  nand2  g121(.a(new_n20_), .b(x0), .O(new_n138_));
  nand2  g122(.a(x2), .b(new_n34_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nor2   g124(.a(x7), .b(new_n18_), .O(new_n141_));
  nand2  g125(.a(new_n66_), .b(new_n85_), .O(new_n142_));
  aoi21  g126(.a(new_n70_), .b(x1), .c(x8), .O(new_n143_));
  aoi22  g127(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n128_), .O(new_n144_));
  nor2   g128(.a(new_n25_), .b(new_n85_), .O(new_n145_));
  oai21  g129(.a(new_n88_), .b(new_n65_), .c(new_n145_), .O(new_n146_));
  oai21  g130(.a(new_n144_), .b(new_n140_), .c(new_n146_), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n137_), .c(new_n36_), .O(new_n148_));
  nor2   g132(.a(new_n70_), .b(new_n85_), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n97_), .c(x7), .O(new_n150_));
  nand2  g134(.a(new_n138_), .b(new_n126_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(x6), .c(new_n36_), .O(new_n152_));
  nand3  g136(.a(new_n115_), .b(new_n43_), .c(new_n70_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(x5), .O(new_n154_));
  aoi21  g138(.a(new_n152_), .b(new_n150_), .c(new_n154_), .O(new_n155_));
  aoi21  g139(.a(new_n155_), .b(new_n148_), .c(new_n17_), .O(z4));
  inv1   g140(.a(new_n128_), .O(new_n157_));
  oai21  g141(.a(new_n140_), .b(new_n157_), .c(new_n125_), .O(z5));
endmodule
