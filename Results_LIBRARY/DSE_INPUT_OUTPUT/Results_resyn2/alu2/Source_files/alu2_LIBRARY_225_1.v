...
module FAU ( 
  ...
  aoi21  g042(.a(x5), .b(new_n18_), .c(new_n21_), .O(new_n59_));
  ...
  oai21  g080(.a(new_n35_), .b(x4), .c(x3), .O(new_n97_));
  nand2  g081(.a(new_n18_), .b(new_n68_), .O(new_n98_));
  nand4  g082(.a(new_n98_), .b(new_n97_), .c(new_n19_), .d(x6), .O(new_n99_));
  ...
  nor2   g091(.a(x6), .b(new_n27_), .O(new_n108_));
  nand2  g092(.a(new_n108_), .b(new_n71_), .O(new_n109_));
  nand3  g093(.a(new_n109_), .b(new_n90_), .c(new_n35_), .O(new_n110_));
  nand2  g094(.a(new_n110_), .b(x9), .O(new_n111_));
  nand3  g095(.a(new_n51_), .b(new_n29_), .c(x0), .O(new_n112_));
  oai21  g096(.a(new_n111_), .b(new_n107_), .c(new_n112_), .O(new_n113_));
  nand2  g097(.a(new_n113_), .b(x7), .O(new_n114_));
  inv1   g098(.a(x7), .O(new_n115_));
  nand3  g099(.a(new_n55_), .b(new_n19_), .c(new_n115_), .O(new_n116_));
  aoi21  g100(.a(new_n116_), .b(new_n114_), .c(x3), .O(new_n117_));
  nand2  g101(.a(x8), .b(x7), .O(new_n118_));
  oai21  g102(.a(new_n118_), .b(new_n43_), .c(x9), .O(new_n119_));
  nand3  g103(.a(new_n119_), .b(new_n35_), .c(new_n18_), .O(new_n120_));
  nand2  g104(.a(new_n24_), .b(new_n35_), .O(new_n121_));
  nand2  g105(.a(new_n121_), .b(new_n17_), .O(new_n122_));
  nand2  g106(.a(new_n69_), .b(new_n43_), .O(new_n123_));
  aoi21  g107(.a(x8), .b(x2), .c(new_n35_), .O(new_n124_));
  aoi22  g108(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n108_), .O(new_n125_));
  nand3  g109(.a(x8), .b(new_n21_), .c(new_n17_), .O(new_n126_));
  nand2  g110(.a(new_n126_), .b(x0), .O(new_n127_));
  nand4  g111(.a(new_n127_), .b(new_n76_), .c(x9), .d(x4), .O(new_n128_));
  oai21  g112(.a(new_n125_), .b(x4), .c(new_n128_), .O(new_n129_));
  nand2  g113(.a(new_n49_), .b(new_n19_), .O(new_n130_));
  inv1   g114(.a(new_n130_), .O(new_n131_));
  aoi21  g115(.a(new_n129_), .b(x7), .c(new_n131_), .O(new_n132_));
  oai21  g116(.a(new_n132_), .b(new_n68_), .c(new_n120_), .O(new_n133_));
  oai21  g117(.a(new_n133_), .b(new_n117_), .c(new_n102_), .O(new_n134_));
  ...
  nor2   g122(.a(new_n19_), .b(x7), .O(new_n139_));
  nor2   g123(.a(new_n68_), .b(x1), .O(new_n140_));
  inv1   g124(.a(new_n140_), .O(new_n141_));
  nand2  g125(.a(new_n68_), .b(x1), .O(new_n142_));
  ...
  nand2  g131(.a(new_n24_), .b(x2), .O(new_n148_));
  aoi21  g132(.a(new_n148_), .b(new_n21_), .c(new_n102_), .O(new_n149_));
  aoi21  g133(.a(new_n127_), .b(new_n148_), .c(new_n68_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n149_), .c(new_n35_), .O(new_n151_));
  nand2  g135(.a(new_n104_), .b(x0), .O(new_n152_));
  nand2  g136(.a(new_n21_), .b(new_n68_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(x1), .O(new_n154_));
  nand3  g138(.a(new_n154_), .b(new_n152_), .c(x5), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(x4), .O(new_n157_));
  nand2  g141(.a(new_n153_), .b(new_n141_), .O(new_n158_));
  oai22  g142(.a(new_n158_), .b(new_n75_), .c(new_n121_), .d(new_n21_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(x0), .O(new_n160_));
  nor2   g144(.a(new_n146_), .b(x6), .O(new_n161_));
  oai22  g145(.a(new_n142_), .b(new_n21_), .c(new_n140_), .d(new_n69_), .O(new_n162_));
  aoi21  g146(.a(new_n162_), .b(x5), .c(new_n161_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand3  g148(.a(new_n126_), .b(new_n35_), .c(x1), .O(new_n165_));
  nand3  g149(.a(x5), .b(new_n18_), .c(x2), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n153_), .c(new_n165_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(x0), .O(new_n168_));
  aoi21  g152(.a(new_n161_), .b(new_n35_), .c(new_n115_), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  aoi21  g154(.a(new_n164_), .b(new_n18_), .c(new_n170_), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(new_n157_), .c(new_n19_), .O(z4));
  xor2a  g156(.a(x2), .b(x0), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n143_), .c(new_n145_), .O(z5));
endmodule
