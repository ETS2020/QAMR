...
module FAU ( 
  ...
  inv1   g109(.a(new_n60_), .O(new_n126_));
  oai21  g110(.a(new_n65_), .b(new_n90_), .c(new_n126_), .O(z3));
  ...
  inv1   g139(.a(new_n148_), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n124_), .c(new_n126_), .O(z5));
endmodule
