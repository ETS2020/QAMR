...
module FAU ( 
  ...
  nand2  g134(.a(new_n145_), .b(new_n150_), .O(z3));
  oai21  g135(.a(new_n28_), .b(x3), .c(x0), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(x7), .c(x8), .O(new_n153_));
  nand2  g137(.a(x7), .b(new_n102_), .O(new_n154_));
  nand3  g138(.a(new_n154_), .b(new_n67_), .c(new_n66_), .O(new_n155_));
  nand2  g139(.a(x7), .b(new_n46_), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(x3), .O(new_n157_));
  nand3  g141(.a(new_n157_), .b(x4), .c(x1), .O(new_n158_));
  oai21  g142(.a(new_n28_), .b(new_n117_), .c(new_n102_), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n156_), .c(new_n145_), .O(new_n160_));
  nand3  g144(.a(new_n160_), .b(new_n158_), .c(new_n155_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n153_), .c(x6), .O(new_n162_));
  nand2  g146(.a(new_n159_), .b(new_n112_), .O(new_n163_));
  nand2  g147(.a(new_n146_), .b(x7), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n163_), .c(new_n46_), .O(new_n165_));
  nor2   g149(.a(new_n48_), .b(x8), .O(new_n166_));
  nand3  g150(.a(x7), .b(new_n20_), .c(x3), .O(new_n167_));
  inv1   g151(.a(new_n167_), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n166_), .c(x1), .O(new_n169_));
  aoi21  g153(.a(new_n166_), .b(x3), .c(x5), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nor2   g155(.a(new_n171_), .b(new_n165_), .O(new_n172_));
  aoi21  g156(.a(new_n172_), .b(new_n162_), .c(new_n31_), .O(z4));
  nor2   g157(.a(new_n71_), .b(new_n95_), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(new_n148_), .c(new_n150_), .O(z5));
endmodule
