// Benchmark "FAU" written by ABC on Sun Aug  9 00:27:49 2020
...
module FAU ( 
  ...
  nor2   g178(.a(new_n103_), .b(new_n88_), .O(z3));
  nor2   g179(.a(new_n77_), .b(new_n25_), .O(new_n196_));
  nor2   g180(.a(new_n196_), .b(x2), .O(new_n197_));
  nand2  g181(.a(new_n35_), .b(x3), .O(new_n198_));
  oai21  g182(.a(new_n198_), .b(new_n105_), .c(new_n45_), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n197_), .c(x0), .O(new_n200_));
  or2    g184(.a(new_n198_), .b(new_n122_), .O(new_n201_));
  aoi21  g185(.a(new_n201_), .b(new_n145_), .c(x0), .O(new_n202_));
  nand2  g186(.a(new_n45_), .b(new_n103_), .O(new_n203_));
  oai22  g187(.a(new_n203_), .b(new_n196_), .c(new_n45_), .d(new_n44_), .O(new_n204_));
  nor2   g188(.a(new_n204_), .b(new_n202_), .O(new_n205_));
  aoi21  g189(.a(new_n205_), .b(new_n200_), .c(new_n19_), .O(new_n206_));
  inv1   g190(.a(new_n123_), .O(new_n207_));
  nand2  g191(.a(x7), .b(x3), .O(new_n208_));
  oai21  g192(.a(new_n207_), .b(x8), .c(new_n208_), .O(new_n209_));
  nor3   g193(.a(new_n167_), .b(new_n207_), .c(new_n35_), .O(new_n210_));
  aoi21  g194(.a(new_n209_), .b(new_n19_), .c(new_n210_), .O(new_n211_));
  aoi21  g195(.a(new_n111_), .b(new_n31_), .c(new_n18_), .O(new_n212_));
  aoi21  g196(.a(new_n208_), .b(new_n114_), .c(x6), .O(new_n213_));
  oai21  g197(.a(new_n213_), .b(new_n212_), .c(new_n25_), .O(new_n214_));
  oai21  g198(.a(new_n211_), .b(x4), .c(new_n214_), .O(new_n215_));
  oai21  g199(.a(new_n215_), .b(new_n206_), .c(x1), .O(new_n216_));
  nand3  g200(.a(new_n92_), .b(new_n88_), .c(new_n18_), .O(new_n217_));
  aoi21  g201(.a(x2), .b(new_n88_), .c(new_n77_), .O(new_n218_));
  nand2  g202(.a(new_n111_), .b(x0), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n218_), .c(new_n217_), .O(new_n220_));
  nor2   g204(.a(new_n108_), .b(new_n44_), .O(new_n221_));
  inv1   g205(.a(new_n118_), .O(new_n222_));
  nand3  g206(.a(new_n222_), .b(new_n36_), .c(new_n17_), .O(new_n223_));
  oai22  g207(.a(new_n223_), .b(new_n221_), .c(new_n136_), .d(x6), .O(new_n224_));
  aoi21  g208(.a(new_n220_), .b(x6), .c(new_n224_), .O(new_n225_));
  oai21  g209(.a(z3), .b(new_n135_), .c(x7), .O(new_n226_));
  oai22  g210(.a(x3), .b(new_n88_), .c(x2), .d(new_n18_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(x6), .O(new_n228_));
  nand3  g212(.a(new_n228_), .b(new_n226_), .c(x4), .O(new_n229_));
  oai21  g213(.a(new_n225_), .b(x3), .c(new_n229_), .O(new_n230_));
  nand3  g214(.a(new_n17_), .b(x2), .c(new_n88_), .O(new_n231_));
  oai21  g215(.a(x8), .b(new_n49_), .c(new_n18_), .O(new_n232_));
  aoi21  g216(.a(new_n111_), .b(x8), .c(x6), .O(new_n233_));
  nand2  g217(.a(new_n233_), .b(new_n232_), .O(new_n234_));
  aoi21  g218(.a(new_n234_), .b(new_n231_), .c(new_n103_), .O(new_n235_));
  nor2   g219(.a(new_n193_), .b(new_n118_), .O(new_n236_));
  nor3   g220(.a(new_n236_), .b(new_n41_), .c(new_n19_), .O(new_n237_));
  oai21  g221(.a(new_n237_), .b(new_n235_), .c(x4), .O(new_n238_));
  nand3  g222(.a(new_n17_), .b(new_n44_), .c(new_n88_), .O(new_n239_));
  aoi21  g223(.a(new_n239_), .b(new_n91_), .c(new_n18_), .O(new_n240_));
  oai21  g224(.a(new_n240_), .b(new_n179_), .c(x6), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(new_n238_), .c(x5), .O(new_n242_));
  aoi21  g226(.a(new_n230_), .b(x5), .c(new_n242_), .O(new_n243_));
  aoi21  g227(.a(new_n243_), .b(new_n216_), .c(new_n30_), .O(z4));
  inv1   g228(.a(new_n236_), .O(new_n245_));
  oai22  g229(.a(new_n245_), .b(new_n227_), .c(x9), .d(x1), .O(z5));
endmodule
