...
module FAU ( 
  ...
  nor2   g191(.a(x9), .b(new_n44_), .O(new_n208_));
  aoi21  g192(.a(new_n91_), .b(new_n144_), .c(new_n208_), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n207_), .O(z2));
  inv1   g194(.a(new_n208_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(new_n207_), .O(z3));
  nor2   g196(.a(x8), .b(x6), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(x2), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n138_), .c(new_n34_), .O(new_n215_));
  nand2  g199(.a(new_n50_), .b(x3), .O(new_n216_));
  oai21  g200(.a(new_n24_), .b(x3), .c(new_n216_), .O(new_n217_));
  oai21  g201(.a(new_n217_), .b(new_n215_), .c(x1), .O(new_n218_));
  nand2  g202(.a(new_n20_), .b(new_n44_), .O(new_n219_));
  nand2  g203(.a(new_n44_), .b(x3), .O(new_n220_));
  nand2  g204(.a(new_n20_), .b(new_n17_), .O(new_n221_));
  aoi21  g205(.a(new_n221_), .b(new_n220_), .c(new_n27_), .O(new_n222_));
  nand3  g206(.a(new_n20_), .b(x3), .c(new_n144_), .O(new_n223_));
  inv1   g207(.a(new_n223_), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n222_), .c(x4), .O(new_n225_));
  nand3  g209(.a(new_n225_), .b(new_n219_), .c(new_n218_), .O(new_n226_));
  nand2  g210(.a(new_n226_), .b(new_n18_), .O(new_n227_));
  nand2  g211(.a(new_n150_), .b(x0), .O(new_n228_));
  nand3  g212(.a(new_n228_), .b(x4), .c(new_n144_), .O(new_n229_));
  inv1   g213(.a(new_n59_), .O(new_n230_));
  nand2  g214(.a(x4), .b(new_n144_), .O(new_n231_));
  nor2   g215(.a(x4), .b(new_n144_), .O(new_n232_));
  nand2  g216(.a(new_n232_), .b(new_n44_), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n231_), .c(x2), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n230_), .c(new_n19_), .O(new_n235_));
  nor2   g219(.a(x2), .b(new_n17_), .O(new_n236_));
  nand2  g220(.a(new_n27_), .b(x0), .O(new_n237_));
  nand2  g221(.a(new_n237_), .b(new_n39_), .O(new_n238_));
  nand2  g222(.a(x8), .b(x7), .O(new_n239_));
  nand3  g223(.a(new_n239_), .b(new_n232_), .c(x6), .O(new_n240_));
  oai22  g224(.a(new_n240_), .b(new_n238_), .c(new_n236_), .d(new_n59_), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(x3), .O(new_n242_));
  aoi21  g226(.a(x4), .b(x0), .c(x1), .O(new_n243_));
  nand4  g227(.a(new_n243_), .b(new_n239_), .c(new_n237_), .d(new_n39_), .O(new_n244_));
  nor2   g228(.a(new_n23_), .b(x4), .O(new_n245_));
  oai21  g229(.a(new_n236_), .b(x1), .c(new_n245_), .O(new_n246_));
  nand3  g230(.a(new_n246_), .b(new_n244_), .c(x6), .O(new_n247_));
  nand3  g231(.a(new_n154_), .b(new_n39_), .c(new_n34_), .O(new_n248_));
  nand2  g232(.a(x2), .b(x0), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(x4), .c(x6), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(new_n248_), .O(new_n251_));
  nand3  g235(.a(new_n251_), .b(new_n247_), .c(new_n91_), .O(new_n252_));
  nand4  g236(.a(new_n252_), .b(new_n242_), .c(new_n235_), .d(new_n229_), .O(new_n253_));
  nand2  g237(.a(new_n253_), .b(x5), .O(new_n254_));
  inv1   g238(.a(new_n216_), .O(new_n255_));
  inv1   g239(.a(new_n213_), .O(new_n256_));
  aoi21  g240(.a(x4), .b(x3), .c(x1), .O(new_n257_));
  oai21  g241(.a(x6), .b(x2), .c(x7), .O(new_n258_));
  aoi21  g242(.a(new_n258_), .b(new_n256_), .c(new_n257_), .O(new_n259_));
  aoi21  g243(.a(new_n119_), .b(new_n46_), .c(new_n19_), .O(new_n260_));
  oai21  g244(.a(new_n260_), .b(new_n259_), .c(new_n18_), .O(new_n261_));
  nor2   g245(.a(new_n138_), .b(x2), .O(new_n262_));
  oai21  g246(.a(new_n262_), .b(new_n213_), .c(new_n232_), .O(new_n263_));
  nand2  g247(.a(new_n263_), .b(new_n261_), .O(new_n264_));
  aoi22  g248(.a(new_n264_), .b(x0), .c(new_n232_), .d(new_n255_), .O(new_n265_));
  nand3  g249(.a(new_n265_), .b(new_n254_), .c(new_n227_), .O(new_n266_));
  nand2  g250(.a(new_n266_), .b(x9), .O(new_n267_));
  nand2  g251(.a(new_n267_), .b(new_n211_), .O(z4));
  aoi22  g252(.a(new_n238_), .b(new_n211_), .c(new_n209_), .d(new_n207_), .O(z5));
endmodule
