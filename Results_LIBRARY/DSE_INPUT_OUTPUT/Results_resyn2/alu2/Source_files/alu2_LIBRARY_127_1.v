...
module FAU ( 
  ...
  aoi21  g107(.a(new_n123_), .b(new_n122_), .c(new_n59_), .O(z2));
  oai21  g108(.a(new_n26_), .b(x5), .c(new_n122_), .O(z3));
  nand2  g109(.a(new_n123_), .b(new_n122_), .O(new_n126_));
  nand2  g110(.a(new_n126_), .b(new_n51_), .O(new_n127_));
  nand3  g111(.a(new_n22_), .b(x3), .c(x1), .O(new_n128_));
  nand2  g112(.a(new_n17_), .b(x0), .O(new_n129_));
  ...
  nand2  g116(.a(new_n22_), .b(x6), .O(new_n133_));
  nor3   g117(.a(new_n133_), .b(new_n123_), .c(new_n90_), .O(new_n134_));
  oai21  g118(.a(new_n134_), .b(new_n132_), .c(x5), .O(new_n135_));
  nand3  g119(.a(new_n69_), .b(new_n48_), .c(new_n34_), .O(new_n136_));
  nand3  g120(.a(new_n136_), .b(new_n70_), .c(new_n63_), .O(new_n137_));
  nand2  g121(.a(new_n129_), .b(x3), .O(new_n138_));
  nor2   g122(.a(new_n138_), .b(new_n18_), .O(new_n139_));
  nand2  g123(.a(new_n18_), .b(new_n63_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(x1), .O(new_n141_));
  oai21  g125(.a(new_n141_), .b(new_n139_), .c(new_n137_), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(x7), .O(new_n143_));
  oai22  g127(.a(x3), .b(new_n41_), .c(x2), .d(new_n89_), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(new_n22_), .c(new_n18_), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(new_n143_), .c(new_n135_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n44_), .O(new_n147_));
  nand2  g131(.a(new_n129_), .b(new_n89_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n138_), .c(x6), .O(new_n149_));
  nand2  g133(.a(new_n122_), .b(new_n90_), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(x7), .c(new_n44_), .O(new_n151_));
  oai21  g135(.a(new_n140_), .b(new_n69_), .c(x5), .O(new_n152_));
  aoi21  g136(.a(new_n151_), .b(new_n149_), .c(new_n152_), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(new_n147_), .c(new_n26_), .O(z4));
  inv1   g138(.a(new_n131_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(z2), .O(new_n156_));
