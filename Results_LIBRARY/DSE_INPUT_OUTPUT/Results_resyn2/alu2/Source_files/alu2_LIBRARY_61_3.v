...
module FAU ( 
  ...
  nand2  g139(.a(new_n153_), .b(new_n62_), .O(z3));
  ...
  nand2  g156(.a(x2), .b(new_n72_), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(z2), .c(new_n172_), .O(new_n174_));
  inv1   g158(.a(new_n174_), .O(z5));
endmodule
