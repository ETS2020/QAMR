...
module FAU ( 
  ...
  oai21  g056(.a(new_n72_), .b(x7), .c(new_n67_), .O(new_n73_));
  ...
  aoi21  g107(.a(new_n120_), .b(new_n85_), .c(new_n123_), .O(new_n124_));
  nand3  g108(.a(new_n124_), .b(new_n103_), .c(new_n84_), .O(z1));
  nor2   g109(.a(new_n17_), .b(x5), .O(new_n126_));
  inv1   g110(.a(new_n126_), .O(new_n127_));
  nor2   g111(.a(x3), .b(new_n85_), .O(new_n128_));
  nand2  g112(.a(x3), .b(new_n85_), .O(new_n129_));
  inv1   g113(.a(new_n129_), .O(new_n130_));
  oai21  g114(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(z2));
  nor2   g115(.a(new_n70_), .b(new_n85_), .O(new_n132_));
  inv1   g116(.a(new_n132_), .O(new_n133_));
  nor2   g117(.a(new_n133_), .b(new_n126_), .O(z3));
  nand3  g118(.a(x7), .b(x3), .c(new_n20_), .O(new_n135_));
  oai21  g119(.a(x8), .b(x6), .c(new_n135_), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(x1), .O(new_n137_));
  oai21  g121(.a(new_n25_), .b(x2), .c(x6), .O(new_n138_));
  oai21  g122(.a(new_n25_), .b(new_n20_), .c(new_n68_), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(new_n138_), .c(new_n70_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n137_), .c(new_n34_), .O(new_n141_));
  oai22  g125(.a(x3), .b(new_n85_), .c(x2), .d(new_n34_), .O(new_n142_));
  oai21  g126(.a(new_n20_), .b(x0), .c(new_n129_), .O(new_n143_));
  or2    g127(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  oai21  g128(.a(x7), .b(new_n18_), .c(x8), .O(new_n145_));
  oai21  g129(.a(x6), .b(x1), .c(new_n145_), .O(new_n146_));
  nor2   g130(.a(new_n25_), .b(new_n85_), .O(new_n147_));
  oai21  g131(.a(new_n88_), .b(new_n66_), .c(new_n147_), .O(new_n148_));
  oai21  g132(.a(new_n146_), .b(new_n144_), .c(new_n148_), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n141_), .c(new_n36_), .O(new_n150_));
  oai21  g134(.a(new_n132_), .b(new_n97_), .c(x7), .O(new_n151_));
  aoi21  g135(.a(new_n142_), .b(x6), .c(new_n36_), .O(new_n152_));
  nand3  g136(.a(new_n115_), .b(new_n43_), .c(new_n70_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(x5), .O(new_n154_));
  aoi21  g138(.a(new_n152_), .b(new_n151_), .c(new_n154_), .O(new_n155_));
  aoi21  g139(.a(new_n155_), .b(new_n150_), .c(new_n17_), .O(z4));
  nand2  g140(.a(new_n144_), .b(new_n127_), .O(z5));
endmodule
