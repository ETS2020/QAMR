...
module FAU ( 
  ...
  nor2   g008(.a(x8), .b(new_n19_), .O(new_n25_));
  ...
  aoi21  g025(.a(new_n41_), .b(new_n37_), .c(x0), .O(new_n42_));
  oai21  g026(.a(new_n36_), .b(new_n24_), .c(new_n42_), .O(new_n43_));
  nand2  g027(.a(new_n37_), .b(x7), .O(new_n44_));
  or2    g028(.a(new_n44_), .b(new_n28_), .O(new_n45_));
  nor2   g029(.a(new_n17_), .b(new_n19_), .O(new_n46_));
  nand2  g030(.a(new_n46_), .b(new_n38_), .O(new_n47_));
  aoi21  g031(.a(x6), .b(new_n19_), .c(new_n18_), .O(new_n48_));
  nor2   g032(.a(new_n48_), .b(x8), .O(new_n49_));
  nand2  g033(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  aoi21  g034(.a(new_n48_), .b(x8), .c(new_n37_), .O(new_n51_));
  ...
  nand2  g045(.a(new_n27_), .b(new_n17_), .O(new_n62_));
  ...
  oai21  g050(.a(new_n38_), .b(new_n19_), .c(new_n39_), .O(new_n67_));
  aoi22  g051(.a(new_n67_), .b(x0), .c(x6), .d(new_n17_), .O(new_n68_));
  nor2   g052(.a(new_n18_), .b(x5), .O(new_n69_));
  nand2  g053(.a(new_n69_), .b(new_n19_), .O(new_n70_));
  nand2  g054(.a(new_n70_), .b(new_n37_), .O(new_n71_));
  ...
  nand3  g060(.a(new_n62_), .b(new_n21_), .c(new_n76_), .O(new_n77_));
  nand3  g061(.a(new_n18_), .b(x5), .c(x4), .O(new_n78_));
  nand3  g062(.a(new_n78_), .b(new_n72_), .c(x0), .O(new_n79_));
  nand4  g063(.a(new_n79_), .b(new_n77_), .c(x9), .d(new_n31_), .O(new_n80_));
  nand2  g064(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  nand2  g065(.a(new_n81_), .b(new_n61_), .O(new_n82_));
  nand2  g066(.a(new_n17_), .b(new_n19_), .O(new_n83_));
  aoi21  g067(.a(new_n27_), .b(x9), .c(new_n83_), .O(new_n84_));
  ...
  nor3   g077(.a(new_n93_), .b(new_n19_), .c(x1), .O(new_n94_));
  nand2  g078(.a(x5), .b(x2), .O(new_n95_));
  nor2   g079(.a(new_n19_), .b(new_n61_), .O(new_n96_));
  ...
  oai21  g084(.a(new_n30_), .b(x2), .c(new_n100_), .O(new_n101_));
  ...
  nand2  g094(.a(new_n18_), .b(x1), .O(new_n111_));
  ...
  aoi21  g100(.a(new_n116_), .b(new_n105_), .c(new_n37_), .O(new_n117_));
  nand2  g101(.a(new_n90_), .b(x0), .O(new_n118_));
  nand2  g102(.a(x7), .b(new_n76_), .O(new_n119_));
  nand4  g103(.a(new_n119_), .b(new_n118_), .c(new_n17_), .d(new_n100_), .O(new_n120_));
  nor2   g104(.a(new_n18_), .b(new_n108_), .O(new_n121_));
  ...
  aoi21  g128(.a(x7), .b(new_n17_), .c(new_n76_), .O(new_n145_));
  aoi21  g129(.a(x7), .b(x4), .c(x8), .O(new_n146_));
  oai21  g130(.a(new_n146_), .b(new_n145_), .c(x6), .O(new_n147_));
  nand3  g131(.a(new_n38_), .b(new_n17_), .c(new_n76_), .O(new_n148_));
  aoi21  g132(.a(new_n148_), .b(new_n147_), .c(x3), .O(new_n149_));
  oai21  g133(.a(x7), .b(x0), .c(new_n17_), .O(new_n150_));
  oai21  g134(.a(x8), .b(new_n18_), .c(x5), .O(new_n151_));
  ...
  nand4  g139(.a(new_n18_), .b(x4), .c(new_n108_), .d(x2), .O(new_n156_));
  ...
  nor2   g145(.a(new_n18_), .b(new_n19_), .O(new_n162_));
  ...
  aoi21  g152(.a(x6), .b(new_n17_), .c(new_n108_), .O(new_n169_));
  nand2  g153(.a(x5), .b(new_n61_), .O(new_n170_));
  nand4  g154(.a(new_n170_), .b(new_n169_), .c(new_n18_), .d(new_n76_), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(new_n168_), .c(x4), .O(new_n172_));
  oai21  g156(.a(new_n38_), .b(x4), .c(new_n76_), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n86_), .c(new_n25_), .O(new_n174_));
  ...
  oai21  g171(.a(new_n187_), .b(new_n34_), .c(x3), .O(new_n188_));
  nor2   g172(.a(x5), .b(new_n19_), .O(new_n189_));
  nand4  g173(.a(new_n189_), .b(new_n31_), .c(x3), .d(new_n61_), .O(new_n190_));
  nand4  g174(.a(x5), .b(new_n19_), .c(new_n108_), .d(x2), .O(new_n191_));
  ...
  nand3  g181(.a(new_n96_), .b(new_n27_), .c(new_n31_), .O(new_n198_));
  ...
  nand2  g187(.a(new_n203_), .b(new_n139_), .O(new_n204_));
  aoi21  g188(.a(new_n204_), .b(new_n78_), .c(x6), .O(new_n205_));
  aoi21  g189(.a(new_n201_), .b(new_n100_), .c(new_n205_), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n182_), .O(new_n207_));
  nand2  g191(.a(new_n207_), .b(x9), .O(new_n208_));
  nand2  g192(.a(new_n208_), .b(new_n144_), .O(z1));
  nor2   g193(.a(x9), .b(x8), .O(new_n210_));
  nor2   g194(.a(x3), .b(new_n100_), .O(new_n211_));
  nor3   g195(.a(new_n211_), .b(new_n210_), .c(new_n109_), .O(z2));
  nand2  g196(.a(x3), .b(x1), .O(new_n213_));
  oai21  g197(.a(x9), .b(x8), .c(new_n213_), .O(z3));
  oai21  g198(.a(new_n162_), .b(new_n31_), .c(x6), .O(new_n215_));
  nand2  g199(.a(new_n194_), .b(x4), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n215_), .c(new_n108_), .O(new_n217_));
  nor2   g201(.a(new_n90_), .b(new_n22_), .O(new_n218_));
  nor2   g202(.a(new_n218_), .b(new_n38_), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n217_), .c(x0), .O(new_n220_));
  nand2  g204(.a(new_n31_), .b(x3), .O(new_n221_));
  nand2  g205(.a(new_n32_), .b(new_n76_), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n221_), .c(new_n61_), .O(new_n223_));
  nand2  g207(.a(new_n109_), .b(new_n32_), .O(new_n224_));
  inv1   g208(.a(new_n224_), .O(new_n225_));
  oai21  g209(.a(new_n225_), .b(new_n223_), .c(x4), .O(new_n226_));
  nand3  g210(.a(x8), .b(x7), .c(x0), .O(new_n227_));
  inv1   g211(.a(new_n227_), .O(new_n228_));
  oai21  g212(.a(new_n228_), .b(new_n25_), .c(new_n107_), .O(new_n229_));
  oai21  g213(.a(new_n175_), .b(new_n121_), .c(new_n38_), .O(new_n230_));
  nor2   g214(.a(x7), .b(x3), .O(new_n231_));
  oai21  g215(.a(new_n231_), .b(new_n162_), .c(x6), .O(new_n232_));
  nand3  g216(.a(new_n232_), .b(new_n230_), .c(new_n229_), .O(new_n233_));
  nand2  g217(.a(new_n233_), .b(x1), .O(new_n234_));
  nand4  g218(.a(new_n234_), .b(new_n226_), .c(new_n220_), .d(new_n33_), .O(new_n235_));
  nand2  g219(.a(new_n235_), .b(new_n17_), .O(new_n236_));
  inv1   g220(.a(new_n109_), .O(new_n237_));
  nand3  g221(.a(new_n185_), .b(new_n184_), .c(new_n237_), .O(new_n238_));
  oai21  g222(.a(new_n202_), .b(x6), .c(new_n113_), .O(new_n239_));
  nand2  g223(.a(new_n239_), .b(new_n108_), .O(new_n240_));
  aoi21  g224(.a(new_n240_), .b(new_n238_), .c(new_n18_), .O(new_n241_));
  nand2  g225(.a(new_n61_), .b(x1), .O(new_n242_));
  nand2  g226(.a(new_n108_), .b(x0), .O(new_n243_));
  nand2  g227(.a(new_n31_), .b(new_n38_), .O(new_n244_));
  aoi21  g228(.a(new_n243_), .b(new_n242_), .c(new_n244_), .O(new_n245_));
  oai21  g229(.a(new_n245_), .b(new_n241_), .c(new_n19_), .O(new_n246_));
  aoi21  g230(.a(x6), .b(x0), .c(new_n61_), .O(new_n247_));
  aoi21  g231(.a(new_n237_), .b(x6), .c(new_n159_), .O(new_n248_));
  oai21  g232(.a(new_n248_), .b(new_n247_), .c(new_n19_), .O(new_n249_));
  nand2  g233(.a(new_n18_), .b(x2), .O(new_n250_));
  nand3  g234(.a(new_n250_), .b(new_n107_), .c(x0), .O(new_n251_));
  nand2  g235(.a(new_n213_), .b(new_n53_), .O(new_n252_));
  aoi22  g236(.a(new_n252_), .b(x7), .c(new_n211_), .d(x6), .O(new_n253_));
  nand3  g237(.a(new_n253_), .b(new_n251_), .c(new_n249_), .O(new_n254_));
  nand2  g238(.a(new_n254_), .b(new_n246_), .O(new_n255_));
  nand2  g239(.a(new_n19_), .b(x1), .O(new_n256_));
  or2    g240(.a(new_n256_), .b(new_n230_), .O(new_n257_));
  inv1   g241(.a(new_n257_), .O(new_n258_));
  aoi21  g242(.a(new_n255_), .b(x5), .c(new_n258_), .O(new_n259_));
  aoi21  g243(.a(new_n259_), .b(new_n236_), .c(new_n37_), .O(z4));
  nor2   g244(.a(x2), .b(x0), .O(new_n261_));
  oai21  g245(.a(new_n261_), .b(new_n203_), .c(z2), .O(new_n262_));
