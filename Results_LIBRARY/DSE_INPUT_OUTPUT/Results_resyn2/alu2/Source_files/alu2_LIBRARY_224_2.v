...
module FAU ( 
  ...
  nand2  g181(.a(new_n50_), .b(x8), .O(new_n198_));
  nor2   g182(.a(x3), .b(new_n137_), .O(new_n199_));
  nor2   g183(.a(new_n112_), .b(x1), .O(new_n200_));
  oai21  g184(.a(new_n200_), .b(new_n199_), .c(new_n198_), .O(z2));
  oai21  g185(.a(new_n112_), .b(new_n137_), .c(new_n198_), .O(z3));
  oai22  g186(.a(x3), .b(new_n24_), .c(x2), .d(new_n137_), .O(new_n203_));
  nand2  g187(.a(new_n203_), .b(new_n168_), .O(new_n204_));
  nand2  g188(.a(x6), .b(new_n112_), .O(new_n205_));
  nand2  g189(.a(new_n155_), .b(new_n42_), .O(new_n206_));
  aoi21  g190(.a(new_n206_), .b(new_n205_), .c(new_n137_), .O(new_n207_));
  inv1   g191(.a(new_n163_), .O(new_n208_));
  oai21  g192(.a(new_n55_), .b(new_n42_), .c(x0), .O(new_n209_));
  aoi21  g193(.a(new_n209_), .b(new_n208_), .c(x3), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n207_), .c(x7), .O(new_n211_));
  aoi21  g195(.a(new_n211_), .b(new_n204_), .c(x4), .O(new_n212_));
  oai21  g196(.a(new_n112_), .b(x1), .c(new_n155_), .O(new_n213_));
  oai21  g197(.a(new_n213_), .b(new_n31_), .c(new_n28_), .O(new_n214_));
  oai22  g198(.a(x3), .b(new_n137_), .c(x2), .d(new_n24_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(x6), .c(x7), .O(new_n216_));
  nand2  g200(.a(new_n216_), .b(new_n214_), .O(new_n217_));
  aoi21  g201(.a(new_n31_), .b(new_n112_), .c(new_n137_), .O(new_n218_));
  inv1   g202(.a(new_n218_), .O(new_n219_));
  nand3  g203(.a(new_n219_), .b(new_n151_), .c(x4), .O(new_n220_));
  nand4  g204(.a(new_n42_), .b(new_n31_), .c(new_n112_), .d(new_n21_), .O(new_n221_));
  nand3  g205(.a(new_n221_), .b(new_n220_), .c(new_n217_), .O(new_n222_));
  oai21  g206(.a(new_n222_), .b(new_n212_), .c(x5), .O(new_n223_));
  nand2  g207(.a(new_n168_), .b(x2), .O(new_n224_));
  aoi21  g208(.a(new_n224_), .b(new_n131_), .c(new_n137_), .O(new_n225_));
  nand2  g209(.a(new_n200_), .b(new_n157_), .O(new_n226_));
  aoi22  g210(.a(new_n157_), .b(new_n24_), .c(new_n42_), .d(x3), .O(new_n227_));
  oai21  g211(.a(new_n227_), .b(new_n21_), .c(new_n226_), .O(new_n228_));
  oai21  g212(.a(new_n228_), .b(new_n225_), .c(x4), .O(new_n229_));
  nand2  g213(.a(new_n18_), .b(x3), .O(new_n230_));
  and2   g214(.a(new_n230_), .b(new_n131_), .O(new_n231_));
  aoi22  g215(.a(new_n231_), .b(new_n218_), .c(new_n157_), .d(new_n42_), .O(new_n232_));
  aoi21  g216(.a(new_n232_), .b(new_n229_), .c(x5), .O(new_n233_));
  aoi21  g217(.a(x4), .b(x3), .c(x1), .O(new_n234_));
  nand2  g218(.a(new_n32_), .b(x7), .O(new_n235_));
  aoi21  g219(.a(new_n235_), .b(new_n169_), .c(new_n234_), .O(new_n236_));
  inv1   g220(.a(new_n52_), .O(new_n237_));
  aoi21  g221(.a(new_n114_), .b(new_n237_), .c(new_n31_), .O(new_n238_));
  oai21  g222(.a(new_n238_), .b(new_n236_), .c(new_n17_), .O(new_n239_));
  nor2   g223(.a(new_n131_), .b(x2), .O(new_n240_));
  nor2   g224(.a(x4), .b(new_n137_), .O(new_n241_));
  oai21  g225(.a(new_n240_), .b(new_n168_), .c(new_n241_), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(new_n239_), .O(new_n243_));
  nand2  g227(.a(new_n243_), .b(x0), .O(new_n244_));
  nand4  g228(.a(new_n241_), .b(x7), .c(new_n31_), .d(x3), .O(new_n245_));
  nand2  g229(.a(new_n245_), .b(new_n244_), .O(new_n246_));
  nor2   g230(.a(new_n246_), .b(new_n233_), .O(new_n247_));
  aoi21  g231(.a(new_n247_), .b(new_n223_), .c(new_n50_), .O(z4));
  oai21  g232(.a(new_n215_), .b(new_n213_), .c(new_n198_), .O(z5));
endmodule
