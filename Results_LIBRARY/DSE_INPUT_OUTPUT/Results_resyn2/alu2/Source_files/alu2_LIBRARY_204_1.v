...
module FAU ( 
  ...
  inv1   g086(.a(new_n64_), .O(new_n103_));
  nand2  g087(.a(new_n103_), .b(new_n39_), .O(new_n104_));
  ...
  nand3  g091(.a(new_n107_), .b(new_n74_), .c(x2), .O(new_n108_));
  aoi21  g092(.a(new_n108_), .b(new_n106_), .c(x4), .O(new_n109_));
  oai21  g093(.a(new_n21_), .b(x2), .c(new_n59_), .O(new_n110_));
  oai21  g094(.a(x4), .b(new_n74_), .c(x8), .O(new_n111_));
  aoi21  g095(.a(new_n110_), .b(x0), .c(new_n111_), .O(new_n112_));
  nor2   g096(.a(new_n28_), .b(new_n44_), .O(new_n113_));
  oai21  g097(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(new_n114_));
  nor2   g098(.a(x6), .b(new_n74_), .O(new_n115_));
  nor2   g099(.a(new_n115_), .b(new_n44_), .O(new_n116_));
  nor2   g100(.a(new_n116_), .b(x4), .O(new_n117_));
  nand2  g101(.a(new_n17_), .b(new_n74_), .O(new_n118_));
  aoi21  g102(.a(new_n24_), .b(x5), .c(new_n118_), .O(new_n119_));
  oai21  g103(.a(new_n119_), .b(new_n117_), .c(new_n28_), .O(new_n120_));
  nand2  g104(.a(new_n120_), .b(new_n114_), .O(new_n121_));
  aoi21  g105(.a(x4), .b(x1), .c(new_n44_), .O(new_n122_));
  nor4   g106(.a(new_n122_), .b(x9), .c(new_n18_), .d(x3), .O(new_n123_));
  aoi21  g107(.a(new_n121_), .b(new_n84_), .c(new_n123_), .O(new_n124_));
  nand3  g108(.a(new_n124_), .b(new_n102_), .c(new_n83_), .O(z1));
  nor2   g109(.a(new_n28_), .b(x5), .O(new_n126_));
  nand2  g110(.a(x3), .b(new_n84_), .O(new_n127_));
  ...
  nor3   g114(.a(new_n126_), .b(new_n74_), .c(new_n84_), .O(z3));
  inv1   g115(.a(new_n113_), .O(new_n132_));
  nand2  g116(.a(x6), .b(new_n39_), .O(new_n133_));
  oai22  g117(.a(new_n133_), .b(new_n129_), .c(x6), .d(new_n84_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n27_), .O(new_n135_));
  oai21  g119(.a(new_n32_), .b(x3), .c(new_n84_), .O(new_n136_));
  ...
  oai21  g124(.a(new_n115_), .b(new_n140_), .c(x1), .O(new_n141_));
  nand2  g125(.a(new_n90_), .b(x2), .O(new_n142_));
  nand3  g126(.a(new_n142_), .b(new_n127_), .c(new_n89_), .O(new_n143_));
  ...
  nand4  g130(.a(new_n146_), .b(new_n128_), .c(new_n127_), .d(new_n19_), .O(new_n147_));
  aoi21  g131(.a(new_n74_), .b(x1), .c(new_n27_), .O(new_n148_));
  oai21  g132(.a(new_n74_), .b(x0), .c(x6), .O(new_n149_));
  oai21  g133(.a(new_n149_), .b(new_n148_), .c(x4), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n147_), .c(x7), .O(new_n151_));
  nand2  g135(.a(new_n90_), .b(x1), .O(new_n152_));
  nor2   g136(.a(new_n89_), .b(new_n20_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  oai21  g138(.a(new_n90_), .b(new_n103_), .c(new_n154_), .O(new_n155_));
  nor2   g139(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n145_), .c(new_n132_), .O(z4));
  nand2  g141(.a(new_n146_), .b(z2), .O(new_n158_));
  inv1   g142(.a(new_n158_), .O(z5));
endmodule
