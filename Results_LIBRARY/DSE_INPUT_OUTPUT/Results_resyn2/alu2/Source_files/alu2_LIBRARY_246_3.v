...
module FAU ( 
  ...
  nand2  g121(.a(new_n70_), .b(x1), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n113_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n137_), .O(z2));
  oai21  g124(.a(new_n70_), .b(new_n112_), .c(new_n137_), .O(z3));
  nor2   g125(.a(x3), .b(new_n28_), .O(new_n142_));
  nand2  g126(.a(x4), .b(new_n112_), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(x3), .c(x2), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(new_n142_), .c(new_n32_), .O(new_n145_));
  nand2  g129(.a(new_n138_), .b(new_n28_), .O(new_n146_));
  nor2   g130(.a(new_n89_), .b(new_n18_), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(new_n146_), .c(new_n113_), .O(new_n148_));
  nor3   g132(.a(new_n139_), .b(new_n83_), .c(new_n62_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n68_), .O(new_n150_));
  nand4  g134(.a(new_n150_), .b(new_n148_), .c(new_n145_), .d(new_n19_), .O(new_n151_));
  oai21  g135(.a(x3), .b(x0), .c(x7), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(new_n144_), .c(new_n32_), .O(new_n153_));
  oai21  g137(.a(new_n106_), .b(new_n112_), .c(new_n28_), .O(new_n154_));
  nand3  g138(.a(new_n18_), .b(x2), .c(new_n112_), .O(new_n155_));
  nand4  g139(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(x4), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n151_), .c(x5), .O(new_n157_));
  nand2  g141(.a(x4), .b(x2), .O(new_n158_));
  oai21  g142(.a(new_n114_), .b(new_n28_), .c(new_n158_), .O(new_n159_));
  oai21  g143(.a(new_n158_), .b(x7), .c(x5), .O(new_n160_));
  nand3  g144(.a(new_n160_), .b(new_n159_), .c(x3), .O(new_n161_));
  nand2  g145(.a(x5), .b(x4), .O(new_n162_));
  oai21  g146(.a(x6), .b(x2), .c(x4), .O(new_n163_));
  nand3  g147(.a(new_n163_), .b(new_n129_), .c(new_n28_), .O(new_n164_));
  nand4  g148(.a(new_n164_), .b(new_n162_), .c(new_n20_), .d(x1), .O(new_n165_));
  oai21  g149(.a(x4), .b(new_n28_), .c(x7), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(x6), .c(new_n17_), .O(new_n167_));
  nand4  g151(.a(new_n167_), .b(new_n165_), .c(new_n161_), .d(new_n68_), .O(new_n168_));
  inv1   g152(.a(new_n168_), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n157_), .c(new_n36_), .O(z4));
  nand2  g154(.a(new_n149_), .b(new_n137_), .O(new_n171_));
