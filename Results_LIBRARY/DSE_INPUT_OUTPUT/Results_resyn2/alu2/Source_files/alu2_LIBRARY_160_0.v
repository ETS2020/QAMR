...
module FAU ( 
  ...
  nand2  g178(.a(new_n138_), .b(new_n47_), .O(new_n195_));
  nor2   g179(.a(new_n184_), .b(new_n182_), .O(new_n196_));
  nand2  g180(.a(new_n196_), .b(new_n195_), .O(z2));
  oai21  g181(.a(new_n156_), .b(new_n97_), .c(new_n195_), .O(z3));
  nor2   g182(.a(x8), .b(x6), .O(new_n199_));
  nand2  g183(.a(new_n199_), .b(x2), .O(new_n200_));
  aoi21  g184(.a(new_n200_), .b(new_n150_), .c(new_n47_), .O(new_n201_));
  nand2  g185(.a(new_n20_), .b(x3), .O(new_n202_));
  oai21  g186(.a(new_n56_), .b(x3), .c(new_n202_), .O(new_n203_));
  oai21  g187(.a(new_n203_), .b(new_n201_), .c(x1), .O(new_n204_));
  nand2  g188(.a(new_n36_), .b(x3), .O(new_n205_));
  nand2  g189(.a(new_n57_), .b(new_n29_), .O(new_n206_));
  aoi21  g190(.a(new_n206_), .b(new_n205_), .c(new_n22_), .O(new_n207_));
  nand3  g191(.a(new_n57_), .b(x3), .c(new_n97_), .O(new_n208_));
  inv1   g192(.a(new_n208_), .O(new_n209_));
  oai21  g193(.a(new_n209_), .b(new_n207_), .c(x4), .O(new_n210_));
  nand2  g194(.a(new_n52_), .b(new_n30_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(x8), .O(new_n212_));
  nand2  g196(.a(x4), .b(x3), .O(new_n213_));
  nand3  g197(.a(new_n213_), .b(new_n56_), .c(new_n97_), .O(new_n214_));
  nand3  g198(.a(new_n214_), .b(new_n212_), .c(new_n86_), .O(new_n215_));
  nand4  g199(.a(new_n215_), .b(new_n210_), .c(new_n204_), .d(new_n17_), .O(new_n216_));
  inv1   g200(.a(new_n196_), .O(new_n217_));
  oai21  g201(.a(new_n183_), .b(new_n134_), .c(x4), .O(new_n218_));
  nor2   g202(.a(new_n22_), .b(new_n29_), .O(new_n219_));
  inv1   g203(.a(new_n219_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n134_), .O(new_n221_));
  aoi21  g205(.a(x8), .b(x7), .c(new_n18_), .O(new_n222_));
  nand4  g206(.a(new_n222_), .b(new_n221_), .c(new_n218_), .d(new_n217_), .O(new_n223_));
  oai21  g207(.a(new_n219_), .b(new_n184_), .c(x7), .O(new_n224_));
  ...
  nand2  g211(.a(new_n199_), .b(new_n22_), .O(new_n228_));
  ...
  nand3  g215(.a(new_n231_), .b(new_n216_), .c(x9), .O(new_n232_));
  ...
  inv1   g222(.a(new_n202_), .O(new_n239_));
  ...
  nand3  g229(.a(new_n221_), .b(new_n217_), .c(new_n195_), .O(new_n246_));
