...
module FAU ( 
  ...
  nand2  g134(.a(new_n150_), .b(new_n135_), .O(new_n151_));
  inv1   g135(.a(new_n151_), .O(new_n152_));
  oai21  g136(.a(new_n17_), .b(x2), .c(new_n152_), .O(z2));
  aoi21  g137(.a(x9), .b(new_n47_), .c(new_n150_), .O(z3));
  nand2  g138(.a(new_n115_), .b(new_n67_), .O(new_n155_));
  nand3  g139(.a(new_n151_), .b(new_n37_), .c(x2), .O(new_n156_));
  ...
  oai22  g156(.a(new_n150_), .b(new_n102_), .c(new_n30_), .d(new_n31_), .O(new_n173_));
  ...
  aoi21  g162(.a(new_n17_), .b(new_n47_), .c(x0), .O(new_n179_));
  oai21  g163(.a(x2), .b(new_n31_), .c(new_n151_), .O(new_n180_));
  nor2   g164(.a(new_n180_), .b(new_n179_), .O(z5));
endmodule
