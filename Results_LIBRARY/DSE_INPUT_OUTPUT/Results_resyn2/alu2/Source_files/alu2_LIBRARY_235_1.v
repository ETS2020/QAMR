...
module FAU ( 
  ...
  nor2   g047(.a(new_n21_), .b(new_n29_), .O(new_n64_));
  nand2  g048(.a(new_n54_), .b(new_n18_), .O(new_n65_));
  aoi21  g049(.a(new_n65_), .b(new_n21_), .c(new_n64_), .O(new_n66_));
  aoi21  g050(.a(new_n63_), .b(new_n61_), .c(new_n66_), .O(new_n67_));
  oai21  g051(.a(new_n57_), .b(new_n35_), .c(new_n67_), .O(z0));
  inv1   g052(.a(x3), .O(new_n69_));
  oai21  g053(.a(new_n24_), .b(x2), .c(x8), .O(new_n70_));
  nand2  g054(.a(new_n70_), .b(x0), .O(new_n71_));
  nand3  g055(.a(new_n36_), .b(x5), .c(new_n17_), .O(new_n72_));
  nand3  g056(.a(new_n72_), .b(new_n71_), .c(x6), .O(new_n73_));
  nor2   g057(.a(x5), .b(x2), .O(new_n74_));
  oai21  g058(.a(new_n74_), .b(x8), .c(new_n40_), .O(new_n75_));
  aoi21  g059(.a(x8), .b(new_n17_), .c(x6), .O(new_n76_));
  aoi21  g060(.a(new_n76_), .b(new_n75_), .c(new_n21_), .O(new_n77_));
  nand2  g061(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand3  g062(.a(x6), .b(new_n18_), .c(new_n40_), .O(new_n79_));
  inv1   g063(.a(new_n79_), .O(new_n80_));
  oai21  g064(.a(new_n80_), .b(new_n59_), .c(new_n24_), .O(new_n81_));
  nand3  g065(.a(new_n36_), .b(x6), .c(new_n24_), .O(new_n82_));
  nand4  g066(.a(x9), .b(new_n62_), .c(new_n18_), .d(new_n40_), .O(new_n83_));
  aoi21  g067(.a(new_n83_), .b(new_n82_), .c(new_n17_), .O(new_n84_));
  nor2   g068(.a(new_n21_), .b(x0), .O(new_n85_));
  aoi21  g069(.a(new_n85_), .b(new_n42_), .c(new_n45_), .O(new_n86_));
  nor2   g070(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand3  g071(.a(new_n87_), .b(new_n81_), .c(new_n78_), .O(new_n88_));
  nand2  g072(.a(new_n88_), .b(x1), .O(new_n89_));
  inv1   g073(.a(x1), .O(new_n90_));
  inv1   g074(.a(new_n30_), .O(new_n91_));
  nand3  g075(.a(x8), .b(x6), .c(x0), .O(new_n92_));
  oai21  g076(.a(new_n92_), .b(x5), .c(x7), .O(new_n93_));
  oai21  g077(.a(new_n91_), .b(new_n24_), .c(new_n93_), .O(new_n94_));
  aoi21  g078(.a(x6), .b(new_n17_), .c(new_n36_), .O(new_n95_));
  nand2  g079(.a(new_n30_), .b(x2), .O(new_n96_));
  nand2  g080(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nor2   g081(.a(x4), .b(new_n17_), .O(new_n98_));
  oai21  g082(.a(new_n98_), .b(x8), .c(new_n40_), .O(new_n99_));
  nand3  g083(.a(new_n99_), .b(new_n97_), .c(x5), .O(new_n100_));
  oai21  g084(.a(x8), .b(new_n18_), .c(new_n50_), .O(new_n101_));
  nand2  g085(.a(new_n101_), .b(x2), .O(new_n102_));
  nand3  g086(.a(new_n30_), .b(new_n36_), .c(x0), .O(new_n103_));
  nand3  g087(.a(new_n103_), .b(new_n102_), .c(new_n24_), .O(new_n104_));
  nand3  g088(.a(new_n104_), .b(new_n100_), .c(x9), .O(new_n105_));
  nand2  g089(.a(new_n105_), .b(new_n94_), .O(new_n106_));
  nand2  g090(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  nand3  g091(.a(new_n21_), .b(x6), .c(new_n24_), .O(new_n108_));
  nand3  g092(.a(new_n108_), .b(new_n107_), .c(new_n89_), .O(new_n109_));
  nand2  g093(.a(new_n109_), .b(new_n69_), .O(new_n110_));
  nor2   g094(.a(new_n21_), .b(x7), .O(new_n111_));
  nor2   g095(.a(x4), .b(new_n69_), .O(new_n112_));
  aoi21  g096(.a(new_n112_), .b(new_n59_), .c(new_n111_), .O(new_n113_));
  nand3  g097(.a(x8), .b(new_n62_), .c(new_n17_), .O(new_n114_));
  aoi21  g098(.a(new_n114_), .b(new_n75_), .c(new_n18_), .O(new_n115_));
  ...
  aoi21  g109(.a(new_n125_), .b(new_n121_), .c(new_n69_), .O(new_n126_));
  nand2  g110(.a(new_n24_), .b(new_n18_), .O(new_n127_));
  aoi21  g111(.a(new_n92_), .b(x9), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g115(.a(new_n98_), .b(new_n74_), .c(new_n27_), .O(new_n132_));
  ...
  nand4  g128(.a(new_n144_), .b(new_n129_), .c(new_n113_), .d(new_n110_), .O(z1));
  nand2  g129(.a(x3), .b(x1), .O(new_n146_));
  aoi21  g130(.a(new_n69_), .b(new_n90_), .c(new_n111_), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n146_), .O(z2));
  oai21  g132(.a(new_n21_), .b(x7), .c(new_n146_), .O(z3));
  inv1   g133(.a(new_n64_), .O(new_n150_));
  nand2  g134(.a(new_n24_), .b(x1), .O(new_n151_));
  and2   g135(.a(new_n70_), .b(new_n69_), .O(new_n152_));
  nand2  g136(.a(new_n36_), .b(new_n24_), .O(new_n153_));
  aoi22  g137(.a(new_n153_), .b(new_n90_), .c(x8), .d(x2), .O(new_n154_));
  ...
  nand2  g144(.a(new_n134_), .b(x8), .O(new_n161_));
  aoi21  g145(.a(new_n17_), .b(new_n40_), .c(new_n69_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  oai21  g147(.a(x8), .b(new_n17_), .c(new_n62_), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(x1), .c(x5), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(new_n163_), .c(new_n18_), .O(new_n166_));
  nor2   g150(.a(new_n117_), .b(x3), .O(new_n167_));
  nand2  g151(.a(new_n117_), .b(x3), .O(new_n168_));
  nor2   g152(.a(new_n62_), .b(new_n90_), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n168_), .c(new_n167_), .O(new_n170_));
  oai22  g154(.a(new_n170_), .b(new_n24_), .c(new_n146_), .d(x6), .O(new_n171_));
  oai21  g155(.a(new_n157_), .b(new_n90_), .c(new_n134_), .O(new_n172_));
  nand3  g156(.a(new_n172_), .b(x5), .c(x4), .O(new_n173_));
  oai21  g157(.a(new_n171_), .b(new_n166_), .c(new_n173_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n160_), .c(new_n150_), .O(z4));
  nand2  g159(.a(x2), .b(x0), .O(new_n176_));
  aoi21  g160(.a(new_n17_), .b(new_n40_), .c(new_n111_), .O(new_n177_));
  aoi22  g161(.a(new_n177_), .b(new_n176_), .c(new_n147_), .d(new_n146_), .O(z5));
endmodule
