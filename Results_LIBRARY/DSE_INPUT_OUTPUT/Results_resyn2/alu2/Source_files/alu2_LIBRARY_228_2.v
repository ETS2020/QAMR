...
module FAU ( 
  ...
  nor2   g172(.a(x9), .b(new_n21_), .O(new_n189_));
  inv1   g173(.a(new_n189_), .O(new_n190_));
  nand2  g174(.a(x3), .b(new_n150_), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n190_), .c(new_n188_), .O(new_n192_));
  inv1   g176(.a(new_n192_), .O(z2));
  nor3   g177(.a(new_n189_), .b(new_n77_), .c(new_n150_), .O(z3));
  nand2  g178(.a(x2), .b(new_n50_), .O(new_n195_));
  nand3  g179(.a(new_n191_), .b(new_n195_), .c(new_n17_), .O(new_n196_));
  nand3  g180(.a(new_n130_), .b(x6), .c(new_n150_), .O(new_n197_));
  nor2   g181(.a(new_n171_), .b(x3), .O(new_n198_));
  nand2  g182(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(new_n196_), .c(new_n18_), .O(new_n200_));
  inv1   g184(.a(new_n148_), .O(new_n201_));
  nand2  g185(.a(new_n77_), .b(x0), .O(new_n202_));
  nand2  g186(.a(new_n38_), .b(x1), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(new_n202_), .c(new_n201_), .O(new_n204_));
  oai21  g188(.a(new_n204_), .b(new_n200_), .c(new_n29_), .O(new_n205_));
  nand2  g189(.a(new_n191_), .b(new_n195_), .O(new_n206_));
  oai21  g190(.a(new_n206_), .b(new_n35_), .c(new_n29_), .O(new_n207_));
  nand2  g191(.a(new_n188_), .b(new_n130_), .O(new_n208_));
  aoi21  g192(.a(new_n208_), .b(x6), .c(x7), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n207_), .O(new_n210_));
  nand3  g194(.a(new_n19_), .b(new_n17_), .c(new_n77_), .O(new_n211_));
  oai21  g195(.a(x6), .b(x3), .c(x1), .O(new_n212_));
  nand3  g196(.a(new_n212_), .b(new_n154_), .c(x4), .O(new_n213_));
  nand4  g197(.a(new_n213_), .b(new_n211_), .c(new_n210_), .d(new_n205_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(x5), .O(new_n215_));
  nand2  g199(.a(new_n55_), .b(new_n17_), .O(new_n216_));
  nand2  g200(.a(x7), .b(x6), .O(new_n217_));
  nand2  g201(.a(new_n148_), .b(x2), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(new_n217_), .c(new_n29_), .O(new_n219_));
  nand2  g203(.a(new_n94_), .b(new_n80_), .O(new_n220_));
  oai21  g204(.a(new_n220_), .b(new_n219_), .c(x1), .O(new_n221_));
  nand2  g205(.a(new_n17_), .b(x3), .O(new_n222_));
  nand2  g206(.a(new_n55_), .b(new_n50_), .O(new_n223_));
  aoi21  g207(.a(new_n223_), .b(new_n222_), .c(new_n38_), .O(new_n224_));
  nand3  g208(.a(new_n55_), .b(x3), .c(new_n150_), .O(new_n225_));
  inv1   g209(.a(new_n225_), .O(new_n226_));
  oai21  g210(.a(new_n226_), .b(new_n224_), .c(x4), .O(new_n227_));
  nand3  g211(.a(new_n227_), .b(new_n221_), .c(new_n216_), .O(new_n228_));
  nand2  g212(.a(new_n228_), .b(new_n21_), .O(new_n229_));
  nand2  g213(.a(new_n29_), .b(x1), .O(new_n230_));
  or2    g214(.a(new_n230_), .b(new_n94_), .O(new_n231_));
  nand2  g215(.a(new_n101_), .b(new_n150_), .O(new_n232_));
  nor2   g216(.a(new_n19_), .b(new_n18_), .O(new_n233_));
  oai21  g217(.a(new_n233_), .b(new_n148_), .c(new_n232_), .O(new_n234_));
  nand3  g218(.a(new_n98_), .b(new_n68_), .c(x6), .O(new_n235_));
  aoi21  g219(.a(new_n235_), .b(new_n234_), .c(x5), .O(new_n236_));
  nand3  g220(.a(x7), .b(x6), .c(new_n38_), .O(new_n237_));
  aoi21  g221(.a(new_n237_), .b(new_n201_), .c(new_n230_), .O(new_n238_));
  oai21  g222(.a(new_n238_), .b(new_n236_), .c(x0), .O(new_n239_));
  nand3  g223(.a(new_n239_), .b(new_n231_), .c(new_n229_), .O(new_n240_));
  inv1   g224(.a(new_n240_), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(new_n215_), .c(new_n63_), .O(z4));
  oai21  g226(.a(new_n208_), .b(new_n206_), .c(new_n190_), .O(z5));
endmodule
