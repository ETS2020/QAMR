...
module FAU ( 
  ...
  nor2   g190(.a(x9), .b(new_n44_), .O(new_n207_));
  inv1   g191(.a(new_n207_), .O(new_n208_));
  xor2a  g192(.a(x3), .b(x1), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n208_), .O(z2));
  nor3   g194(.a(new_n207_), .b(new_n91_), .c(new_n144_), .O(z3));
  nor2   g195(.a(x8), .b(x6), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(x2), .O(new_n213_));
  aoi21  g197(.a(new_n213_), .b(new_n138_), .c(new_n34_), .O(new_n214_));
  nand2  g198(.a(new_n50_), .b(x3), .O(new_n215_));
  oai21  g199(.a(new_n24_), .b(x3), .c(new_n215_), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n214_), .c(x1), .O(new_n217_));
  nand2  g201(.a(new_n20_), .b(new_n44_), .O(new_n218_));
  nand2  g202(.a(new_n44_), .b(x3), .O(new_n219_));
  nand2  g203(.a(new_n20_), .b(new_n17_), .O(new_n220_));
  aoi21  g204(.a(new_n220_), .b(new_n219_), .c(new_n27_), .O(new_n221_));
  nand3  g205(.a(new_n20_), .b(x3), .c(new_n144_), .O(new_n222_));
  ...
  nand2  g210(.a(new_n150_), .b(x0), .O(new_n227_));
  nand3  g211(.a(new_n227_), .b(x4), .c(new_n144_), .O(new_n228_));
  inv1   g212(.a(new_n59_), .O(new_n229_));
  nand2  g213(.a(x4), .b(new_n144_), .O(new_n230_));
  nor2   g214(.a(x4), .b(new_n144_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n44_), .O(new_n232_));
  aoi21  g216(.a(new_n232_), .b(new_n230_), .c(x2), .O(new_n233_));
  oai21  g217(.a(new_n233_), .b(new_n229_), .c(new_n19_), .O(new_n234_));
  nor2   g218(.a(x2), .b(new_n17_), .O(new_n235_));
  nand2  g219(.a(new_n27_), .b(x0), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(new_n39_), .O(new_n237_));
  nand2  g221(.a(x8), .b(x7), .O(new_n238_));
  nand3  g222(.a(new_n238_), .b(new_n231_), .c(x6), .O(new_n239_));
  oai22  g223(.a(new_n239_), .b(new_n237_), .c(new_n235_), .d(new_n59_), .O(new_n240_));
  nand2  g224(.a(new_n240_), .b(x3), .O(new_n241_));
  aoi21  g225(.a(x4), .b(x0), .c(x1), .O(new_n242_));
  nand4  g226(.a(new_n242_), .b(new_n238_), .c(new_n236_), .d(new_n39_), .O(new_n243_));
  nor2   g227(.a(new_n23_), .b(x4), .O(new_n244_));
  oai21  g228(.a(new_n235_), .b(x1), .c(new_n244_), .O(new_n245_));
  nand3  g229(.a(new_n245_), .b(new_n243_), .c(x6), .O(new_n246_));
  nand3  g230(.a(new_n154_), .b(new_n39_), .c(new_n34_), .O(new_n247_));
  nand2  g231(.a(x2), .b(x0), .O(new_n248_));
  aoi21  g232(.a(new_n248_), .b(x4), .c(x6), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(new_n247_), .O(new_n250_));
  nand3  g234(.a(new_n250_), .b(new_n246_), .c(new_n91_), .O(new_n251_));
  nand4  g235(.a(new_n251_), .b(new_n241_), .c(new_n234_), .d(new_n228_), .O(new_n252_));
  nand2  g236(.a(new_n252_), .b(x5), .O(new_n253_));
  inv1   g237(.a(new_n215_), .O(new_n254_));
  inv1   g238(.a(new_n212_), .O(new_n255_));
  ...
  aoi21  g242(.a(new_n119_), .b(new_n46_), .c(new_n19_), .O(new_n259_));
  oai21  g243(.a(new_n259_), .b(new_n258_), .c(new_n18_), .O(new_n260_));
  nor2   g244(.a(new_n138_), .b(x2), .O(new_n261_));
  oai21  g245(.a(new_n261_), .b(new_n212_), .c(new_n231_), .O(new_n262_));
  nand2  g246(.a(new_n262_), .b(new_n260_), .O(new_n263_));
  aoi22  g247(.a(new_n263_), .b(x0), .c(new_n231_), .d(new_n254_), .O(new_n264_));
  nand3  g248(.a(new_n264_), .b(new_n253_), .c(new_n226_), .O(new_n265_));
  nand2  g249(.a(new_n265_), .b(x9), .O(new_n266_));
  nand2  g250(.a(new_n266_), .b(new_n208_), .O(z4));
  oai21  g251(.a(new_n237_), .b(new_n209_), .c(new_n208_), .O(z5));
endmodule
