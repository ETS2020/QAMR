...
module FAU ( 
  ...
  nand2  g170(.a(x3), .b(new_n142_), .O(new_n187_));
  nand2  g171(.a(new_n74_), .b(x1), .O(new_n188_));
  and2   g172(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  inv1   g173(.a(new_n189_), .O(new_n190_));
  nand2  g174(.a(new_n190_), .b(new_n186_), .O(z2));
  oai21  g175(.a(new_n74_), .b(new_n142_), .c(new_n186_), .O(z3));
  nand2  g176(.a(new_n28_), .b(new_n17_), .O(new_n193_));
  nand2  g177(.a(new_n146_), .b(x2), .O(new_n194_));
  aoi21  g178(.a(new_n194_), .b(new_n104_), .c(new_n26_), .O(new_n195_));
  nand2  g179(.a(new_n33_), .b(x3), .O(new_n196_));
  nand2  g180(.a(new_n196_), .b(new_n75_), .O(new_n197_));
  oai21  g181(.a(new_n197_), .b(new_n195_), .c(x1), .O(new_n198_));
  nand2  g182(.a(new_n17_), .b(x3), .O(new_n199_));
  nand2  g183(.a(new_n28_), .b(new_n48_), .O(new_n200_));
  aoi21  g184(.a(new_n200_), .b(new_n199_), .c(new_n19_), .O(new_n201_));
  nand3  g185(.a(new_n28_), .b(x3), .c(new_n142_), .O(new_n202_));
  inv1   g186(.a(new_n202_), .O(new_n203_));
  oai21  g187(.a(new_n203_), .b(new_n201_), .c(x4), .O(new_n204_));
  inv1   g188(.a(new_n146_), .O(new_n205_));
  nand2  g189(.a(new_n45_), .b(x7), .O(new_n206_));
  aoi22  g190(.a(new_n206_), .b(new_n205_), .c(new_n98_), .d(new_n142_), .O(new_n207_));
  nand3  g191(.a(new_n96_), .b(new_n65_), .c(x6), .O(new_n208_));
  inv1   g192(.a(new_n208_), .O(new_n209_));
  oai21  g193(.a(new_n209_), .b(new_n207_), .c(x0), .O(new_n210_));
  nand4  g194(.a(new_n210_), .b(new_n204_), .c(new_n198_), .d(new_n193_), .O(new_n211_));
  inv1   g195(.a(new_n211_), .O(new_n212_));
  oai21  g196(.a(x2), .b(new_n48_), .c(new_n188_), .O(new_n213_));
  nand2  g197(.a(new_n213_), .b(x6), .O(new_n214_));
  oai21  g198(.a(new_n74_), .b(new_n142_), .c(new_n175_), .O(new_n215_));
  nand2  g199(.a(new_n215_), .b(x7), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n214_), .c(new_n26_), .O(new_n217_));
  inv1   g201(.a(new_n155_), .O(new_n218_));
  aoi21  g202(.a(x8), .b(x7), .c(new_n54_), .O(new_n219_));
  nor2   g203(.a(new_n138_), .b(new_n77_), .O(new_n220_));
  nand4  g204(.a(new_n220_), .b(new_n219_), .c(new_n189_), .d(new_n218_), .O(new_n221_));
  nand3  g205(.a(new_n213_), .b(new_n187_), .c(x7), .O(new_n222_));
  nand3  g206(.a(new_n222_), .b(new_n221_), .c(x6), .O(new_n223_));
  nor2   g207(.a(x8), .b(new_n142_), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n83_), .c(x0), .O(new_n225_));
  oai21  g209(.a(x8), .b(x2), .c(new_n109_), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(x1), .c(x6), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(new_n225_), .O(new_n228_));
  aoi21  g212(.a(new_n228_), .b(new_n223_), .c(x4), .O(new_n229_));
  nand3  g213(.a(new_n219_), .b(new_n155_), .c(x6), .O(new_n230_));
  nand2  g214(.a(new_n230_), .b(new_n205_), .O(new_n231_));
  nor2   g215(.a(x3), .b(x2), .O(new_n232_));
  aoi21  g216(.a(new_n232_), .b(new_n231_), .c(new_n54_), .O(new_n233_));
  oai21  g217(.a(new_n229_), .b(new_n217_), .c(new_n233_), .O(new_n234_));
  nand2  g218(.a(new_n234_), .b(x5), .O(new_n235_));
  oai21  g219(.a(new_n212_), .b(new_n21_), .c(new_n235_), .O(z4));
  nand3  g220(.a(new_n220_), .b(new_n189_), .c(new_n186_), .O(new_n237_));
