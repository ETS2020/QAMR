...
module FAU ( 
  ...
  oai21  g087(.a(x8), .b(x2), .c(new_n39_), .O(new_n104_));
  ...
  oai21  g093(.a(new_n21_), .b(x2), .c(new_n60_), .O(new_n110_));
  oai21  g094(.a(x4), .b(new_n74_), .c(x8), .O(new_n111_));
  aoi21  g095(.a(new_n110_), .b(x0), .c(new_n111_), .O(new_n112_));
  oai21  g096(.a(new_n112_), .b(new_n109_), .c(x5), .O(new_n113_));
  nand2  g097(.a(new_n113_), .b(x9), .O(new_n114_));
  nor2   g098(.a(x7), .b(x3), .O(new_n115_));
  oai21  g099(.a(new_n19_), .b(new_n44_), .c(new_n115_), .O(new_n116_));
  oai21  g100(.a(x6), .b(new_n74_), .c(x5), .O(new_n117_));
  aoi21  g101(.a(new_n117_), .b(new_n20_), .c(x9), .O(new_n118_));
  aoi21  g102(.a(new_n118_), .b(new_n116_), .c(x1), .O(new_n119_));
  aoi21  g103(.a(x4), .b(x1), .c(new_n44_), .O(new_n120_));
  nor4   g104(.a(new_n120_), .b(x9), .c(new_n18_), .d(x3), .O(new_n121_));
  aoi21  g105(.a(new_n119_), .b(new_n114_), .c(new_n121_), .O(new_n122_));
  nand3  g106(.a(new_n122_), .b(new_n103_), .c(new_n84_), .O(z1));
  nand2  g107(.a(x3), .b(new_n85_), .O(new_n124_));
  nand2  g108(.a(new_n74_), .b(x1), .O(new_n125_));
  nand2  g109(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g110(.a(new_n126_), .b(new_n59_), .O(z2));
  oai21  g111(.a(new_n74_), .b(new_n85_), .c(new_n59_), .O(z3));
  nand3  g112(.a(x6), .b(x5), .c(new_n39_), .O(new_n129_));
  oai22  g113(.a(new_n129_), .b(new_n126_), .c(x6), .d(new_n85_), .O(new_n130_));
  nand2  g114(.a(new_n130_), .b(new_n27_), .O(new_n131_));
  aoi21  g115(.a(new_n17_), .b(x6), .c(new_n85_), .O(new_n132_));
  nand3  g116(.a(x5), .b(x2), .c(new_n85_), .O(new_n133_));
  ...
  nand2  g123(.a(new_n91_), .b(x2), .O(new_n140_));
  nand3  g124(.a(new_n140_), .b(new_n124_), .c(new_n90_), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n139_), .c(new_n17_), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n136_), .c(new_n20_), .O(new_n143_));
  nand2  g127(.a(new_n27_), .b(new_n39_), .O(new_n144_));
  nand2  g128(.a(new_n144_), .b(new_n75_), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(new_n125_), .c(new_n124_), .O(new_n146_));
  aoi21  g130(.a(new_n27_), .b(x0), .c(new_n74_), .O(new_n147_));
  oai21  g131(.a(new_n27_), .b(x1), .c(x6), .O(new_n148_));
  oai21  g132(.a(new_n148_), .b(new_n147_), .c(x4), .O(new_n149_));
  oai21  g133(.a(new_n146_), .b(new_n24_), .c(new_n149_), .O(new_n150_));
  inv1   g134(.a(new_n91_), .O(new_n151_));
  nor2   g135(.a(new_n90_), .b(new_n20_), .O(new_n152_));
  oai21  g136(.a(new_n151_), .b(new_n85_), .c(new_n152_), .O(new_n153_));
  aoi21  g137(.a(new_n151_), .b(new_n65_), .c(new_n44_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  aoi21  g139(.a(new_n150_), .b(new_n17_), .c(new_n155_), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n143_), .c(new_n28_), .O(z4));
  inv1   g141(.a(new_n146_), .O(new_n158_));
