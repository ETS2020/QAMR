...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_,
    ...
    new_n120_, new_n121_, new_n122_, new_n124_, new_n125_, new_n128_,
  ...
  nor2   g102(.a(new_n18_), .b(x3), .O(new_n119_));
  aoi22  g103(.a(new_n119_), .b(new_n33_), .c(new_n118_), .d(new_n37_), .O(new_n120_));
  oai21  g104(.a(new_n116_), .b(new_n29_), .c(new_n120_), .O(new_n121_));
  aoi21  g105(.a(new_n111_), .b(new_n90_), .c(new_n121_), .O(new_n122_));
  nand2  g106(.a(new_n122_), .b(new_n89_), .O(z1));
  nand2  g107(.a(x3), .b(x1), .O(new_n124_));
  aoi21  g108(.a(new_n65_), .b(new_n90_), .c(new_n60_), .O(new_n125_));
  nand2  g109(.a(new_n125_), .b(new_n124_), .O(z2));
  oai21  g110(.a(new_n29_), .b(x5), .c(new_n124_), .O(z3));
  nand2  g111(.a(x7), .b(new_n45_), .O(new_n128_));
  nand2  g112(.a(x2), .b(new_n90_), .O(new_n129_));
  nand2  g113(.a(new_n61_), .b(x0), .O(new_n130_));
  aoi21  g114(.a(new_n129_), .b(new_n128_), .c(new_n130_), .O(new_n131_));
  nand2  g115(.a(new_n17_), .b(new_n42_), .O(new_n132_));
  oai21  g116(.a(new_n21_), .b(new_n22_), .c(new_n90_), .O(new_n133_));
  oai22  g117(.a(new_n133_), .b(new_n132_), .c(new_n128_), .d(new_n90_), .O(new_n134_));
  oai21  g118(.a(new_n134_), .b(new_n131_), .c(x6), .O(new_n135_));
  nand2  g119(.a(new_n67_), .b(new_n18_), .O(new_n136_));
  nand2  g120(.a(new_n25_), .b(x2), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(new_n24_), .O(new_n138_));
  nand3  g122(.a(new_n138_), .b(new_n45_), .c(x0), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(new_n136_), .c(new_n135_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(new_n65_), .O(new_n141_));
  oai21  g125(.a(new_n65_), .b(new_n17_), .c(x6), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n61_), .c(new_n42_), .O(new_n143_));
  nor2   g127(.a(new_n119_), .b(new_n118_), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(new_n90_), .c(x4), .O(new_n145_));
  nor2   g129(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g130(.a(new_n23_), .b(x8), .O(new_n147_));
  nand2  g131(.a(new_n132_), .b(new_n113_), .O(new_n148_));
  oai21  g132(.a(x2), .b(new_n42_), .c(x6), .O(new_n149_));
  aoi22  g133(.a(new_n149_), .b(x7), .c(new_n148_), .d(new_n147_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n65_), .c(new_n136_), .O(new_n151_));
  nor2   g135(.a(x4), .b(new_n90_), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(new_n153_));
  nand2  g137(.a(x9), .b(x5), .O(new_n154_));
  aoi21  g138(.a(new_n153_), .b(new_n141_), .c(new_n154_), .O(z4));
  nor2   g139(.a(new_n148_), .b(new_n60_), .O(new_n156_));
  aoi21  g140(.a(new_n125_), .b(new_n124_), .c(new_n156_), .O(z5));
endmodule
