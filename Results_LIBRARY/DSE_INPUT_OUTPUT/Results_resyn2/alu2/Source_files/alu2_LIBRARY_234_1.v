...
module FAU ( 
  ...
  nor3   g115(.a(new_n129_), .b(new_n119_), .c(new_n93_), .O(z3));
  nand2  g116(.a(x7), .b(new_n21_), .O(new_n133_));
  nand2  g117(.a(x2), .b(new_n93_), .O(new_n134_));
  nand2  g118(.a(new_n94_), .b(x0), .O(new_n135_));
  aoi21  g119(.a(new_n134_), .b(new_n133_), .c(new_n135_), .O(new_n136_));
  nand2  g120(.a(new_n25_), .b(new_n18_), .O(new_n137_));
  oai21  g121(.a(new_n46_), .b(new_n20_), .c(new_n93_), .O(new_n138_));
  oai22  g122(.a(new_n138_), .b(new_n137_), .c(new_n133_), .d(new_n93_), .O(new_n139_));
  oai21  g123(.a(new_n139_), .b(new_n136_), .c(x6), .O(new_n140_));
  nand3  g124(.a(new_n46_), .b(new_n26_), .c(new_n25_), .O(new_n141_));
  oai21  g125(.a(x7), .b(new_n26_), .c(new_n46_), .O(new_n142_));
  oai21  g126(.a(new_n94_), .b(x6), .c(new_n142_), .O(new_n143_));
  nand3  g127(.a(new_n143_), .b(new_n21_), .c(x0), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(new_n141_), .c(new_n140_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n119_), .O(new_n146_));
  oai21  g130(.a(new_n119_), .b(new_n25_), .c(x6), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n94_), .c(new_n18_), .O(new_n148_));
  aoi21  g132(.a(new_n122_), .b(new_n120_), .c(new_n93_), .O(new_n149_));
  nor3   g133(.a(new_n149_), .b(new_n148_), .c(new_n21_), .O(new_n150_));
  oai21  g134(.a(x7), .b(new_n26_), .c(x8), .O(new_n151_));
  nand2  g135(.a(new_n137_), .b(new_n74_), .O(new_n152_));
  oai21  g136(.a(x2), .b(new_n18_), .c(x6), .O(new_n153_));
  aoi22  g137(.a(new_n153_), .b(x7), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  oai21  g138(.a(new_n154_), .b(new_n119_), .c(new_n141_), .O(new_n155_));
  nor2   g139(.a(x4), .b(new_n93_), .O(new_n156_));
  aoi21  g140(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(new_n157_));
  nand2  g141(.a(x9), .b(x5), .O(new_n158_));
  aoi21  g142(.a(new_n157_), .b(new_n146_), .c(new_n158_), .O(z4));
  inv1   g143(.a(new_n129_), .O(new_n160_));
  inv1   g144(.a(new_n152_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n130_), .c(new_n160_), .O(z5));
endmodule
