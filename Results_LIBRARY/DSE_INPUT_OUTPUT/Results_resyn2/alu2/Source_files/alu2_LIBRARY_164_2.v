...
module FAU ( 
  ...
  nand2  g167(.a(x3), .b(new_n166_), .O(new_n184_));
  nand3  g168(.a(new_n184_), .b(new_n183_), .c(new_n181_), .O(new_n185_));
  inv1   g169(.a(new_n185_), .O(z2));
  nor3   g170(.a(new_n182_), .b(new_n77_), .c(new_n166_), .O(z3));
  ...
  oai21  g181(.a(new_n19_), .b(x0), .c(new_n184_), .O(new_n198_));
  ...
  oai21  g219(.a(new_n200_), .b(new_n198_), .c(new_n183_), .O(z5));
endmodule
