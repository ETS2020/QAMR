...
module FAU ( 
  ...
  inv1   g149(.a(new_n132_), .O(new_n166_));
  nor2   g150(.a(new_n87_), .b(new_n90_), .O(new_n167_));
  inv1   g151(.a(new_n167_), .O(new_n168_));
  aoi22  g152(.a(new_n168_), .b(new_n166_), .c(x9), .d(new_n36_), .O(z2));
  aoi21  g153(.a(x9), .b(new_n36_), .c(new_n167_), .O(new_n170_));
  inv1   g154(.a(new_n170_), .O(z3));
  nand3  g155(.a(new_n19_), .b(x5), .c(x3), .O(new_n172_));
  inv1   g156(.a(new_n172_), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n94_), .c(x0), .O(new_n174_));
  nand2  g158(.a(new_n72_), .b(x5), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(new_n152_), .c(new_n87_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n174_), .c(new_n25_), .O(new_n177_));
  nand2  g161(.a(x8), .b(x5), .O(new_n178_));
  aoi22  g162(.a(new_n178_), .b(x0), .c(new_n25_), .d(x3), .O(new_n179_));
  oai21  g163(.a(new_n18_), .b(new_n51_), .c(x7), .O(new_n180_));
  oai21  g164(.a(x6), .b(x4), .c(x5), .O(new_n181_));
  nand3  g165(.a(new_n181_), .b(new_n23_), .c(x0), .O(new_n182_));
  oai21  g166(.a(new_n180_), .b(new_n179_), .c(new_n182_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n177_), .c(x1), .O(new_n184_));
  oai21  g168(.a(x7), .b(x6), .c(x0), .O(new_n185_));
  nand2  g169(.a(new_n106_), .b(x3), .O(new_n186_));
  aoi21  g170(.a(new_n185_), .b(x8), .c(new_n186_), .O(new_n187_));
  nor2   g171(.a(new_n19_), .b(x1), .O(new_n188_));
  nand2  g172(.a(x6), .b(new_n42_), .O(new_n189_));
  oai22  g173(.a(new_n189_), .b(new_n188_), .c(new_n144_), .d(x6), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(new_n187_), .c(new_n18_), .O(new_n191_));
  nand2  g175(.a(new_n21_), .b(new_n90_), .O(new_n192_));
  inv1   g176(.a(new_n192_), .O(new_n193_));
  oai21  g177(.a(new_n167_), .b(x0), .c(x7), .O(new_n194_));
  nor2   g178(.a(new_n106_), .b(x3), .O(new_n195_));
  nor2   g179(.a(new_n195_), .b(new_n18_), .O(new_n196_));
  aoi22  g180(.a(new_n196_), .b(new_n194_), .c(new_n193_), .d(x3), .O(new_n197_));
  nand2  g181(.a(new_n197_), .b(new_n191_), .O(new_n198_));
  inv1   g182(.a(new_n22_), .O(new_n199_));
  nand3  g183(.a(new_n20_), .b(x5), .c(new_n87_), .O(new_n200_));
  nand2  g184(.a(new_n51_), .b(x0), .O(new_n201_));
  aoi21  g185(.a(new_n200_), .b(new_n74_), .c(new_n201_), .O(new_n202_));
  oai21  g186(.a(new_n202_), .b(new_n199_), .c(new_n23_), .O(new_n203_));
  oai21  g187(.a(new_n72_), .b(x6), .c(new_n192_), .O(new_n204_));
  nand4  g188(.a(new_n204_), .b(x5), .c(new_n87_), .d(x0), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(new_n203_), .O(new_n206_));
  aoi21  g190(.a(new_n198_), .b(x4), .c(new_n206_), .O(new_n207_));
  aoi21  g191(.a(new_n207_), .b(new_n184_), .c(new_n59_), .O(z4));
  nand3  g192(.a(new_n17_), .b(new_n36_), .c(x0), .O(new_n209_));
  oai21  g193(.a(new_n36_), .b(x0), .c(new_n209_), .O(new_n210_));
  aoi21  g194(.a(new_n170_), .b(new_n166_), .c(new_n210_), .O(z5));
endmodule
