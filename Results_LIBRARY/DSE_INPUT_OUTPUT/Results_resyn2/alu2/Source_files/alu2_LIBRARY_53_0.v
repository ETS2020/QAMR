...
module FAU ( 
  ...
  oai21  g190(.a(new_n150_), .b(new_n91_), .c(new_n206_), .O(z3));
  nand2  g191(.a(x6), .b(x1), .O(new_n208_));
  nand2  g192(.a(new_n191_), .b(new_n27_), .O(new_n209_));
  aoi21  g193(.a(new_n209_), .b(new_n208_), .c(x3), .O(new_n210_));
  nand2  g194(.a(new_n161_), .b(x6), .O(new_n211_));
  oai21  g195(.a(new_n106_), .b(x8), .c(new_n211_), .O(new_n212_));
  nor2   g196(.a(new_n150_), .b(x1), .O(new_n213_));
  nor2   g197(.a(new_n213_), .b(new_n25_), .O(new_n214_));
  oai21  g198(.a(new_n212_), .b(new_n210_), .c(new_n214_), .O(new_n215_));
  oai22  g199(.a(x3), .b(new_n48_), .c(x2), .d(new_n91_), .O(new_n216_));
  nand3  g200(.a(new_n216_), .b(new_n21_), .c(new_n27_), .O(new_n217_));
  aoi21  g201(.a(new_n217_), .b(new_n215_), .c(x4), .O(new_n218_));
  nand2  g202(.a(new_n208_), .b(x3), .O(new_n219_));
  nor2   g203(.a(x8), .b(x2), .O(new_n220_));
  nor2   g204(.a(new_n106_), .b(new_n27_), .O(new_n221_));
  oai21  g205(.a(new_n221_), .b(new_n220_), .c(new_n219_), .O(new_n222_));
  oai21  g206(.a(new_n191_), .b(new_n43_), .c(x7), .O(new_n223_));
  oai21  g207(.a(new_n198_), .b(new_n195_), .c(x1), .O(new_n224_));
  nand3  g208(.a(new_n224_), .b(new_n223_), .c(new_n211_), .O(new_n225_));
  aoi21  g209(.a(new_n222_), .b(new_n20_), .c(new_n225_), .O(new_n226_));
  oai21  g210(.a(new_n226_), .b(new_n218_), .c(x5), .O(new_n227_));
  nand2  g211(.a(new_n21_), .b(x3), .O(new_n228_));
  nand2  g212(.a(new_n28_), .b(new_n48_), .O(new_n229_));
  aoi21  g213(.a(new_n229_), .b(new_n228_), .c(new_n59_), .O(new_n230_));
  nand2  g214(.a(new_n213_), .b(new_n28_), .O(new_n231_));
  inv1   g215(.a(new_n231_), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n230_), .c(x4), .O(new_n233_));
  nand2  g217(.a(new_n27_), .b(new_n59_), .O(new_n234_));
  nand3  g218(.a(new_n234_), .b(new_n198_), .c(x4), .O(new_n235_));
  nor2   g219(.a(new_n20_), .b(new_n150_), .O(new_n236_));
  oai21  g220(.a(new_n236_), .b(new_n43_), .c(new_n21_), .O(new_n237_));
  nand3  g221(.a(new_n237_), .b(new_n235_), .c(new_n101_), .O(new_n238_));
  nand2  g222(.a(new_n238_), .b(x0), .O(new_n239_));
  nand3  g223(.a(x8), .b(x7), .c(x0), .O(new_n240_));
  nand2  g224(.a(new_n240_), .b(new_n97_), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(new_n234_), .O(new_n242_));
  oai21  g226(.a(x8), .b(new_n48_), .c(new_n197_), .O(new_n243_));
  nand2  g227(.a(new_n243_), .b(new_n27_), .O(new_n244_));
  nand2  g228(.a(new_n25_), .b(x3), .O(new_n245_));
  nand3  g229(.a(new_n245_), .b(new_n54_), .c(x6), .O(new_n246_));
  nand3  g230(.a(new_n246_), .b(new_n244_), .c(new_n242_), .O(new_n247_));
  nand2  g231(.a(new_n247_), .b(x1), .O(new_n248_));
  nand4  g232(.a(new_n248_), .b(new_n239_), .c(new_n233_), .d(new_n26_), .O(new_n249_));
  nand4  g233(.a(new_n243_), .b(new_n27_), .c(new_n20_), .d(x1), .O(new_n250_));
  inv1   g234(.a(new_n250_), .O(new_n251_));
  aoi21  g235(.a(new_n249_), .b(new_n17_), .c(new_n251_), .O(new_n252_));
  aoi21  g236(.a(new_n252_), .b(new_n227_), .c(new_n36_), .O(z4));
  or2    g237(.a(new_n161_), .b(new_n106_), .O(new_n254_));
  oai21  g238(.a(new_n254_), .b(new_n204_), .c(new_n206_), .O(z5));
endmodule
