...
module FAU ( 
  ...
  inv1   g151(.a(new_n147_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(new_n39_), .O(new_n169_));
  nand3  g153(.a(new_n169_), .b(new_n167_), .c(x6), .O(new_n170_));
  nor2   g154(.a(new_n170_), .b(new_n165_), .O(new_n171_));
  nor2   g155(.a(new_n26_), .b(new_n37_), .O(new_n172_));
  oai21  g156(.a(new_n150_), .b(new_n172_), .c(new_n19_), .O(new_n173_));
  oai21  g157(.a(new_n20_), .b(x8), .c(new_n132_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(new_n173_), .c(new_n31_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n86_), .O(new_n176_));
  nand2  g160(.a(new_n32_), .b(new_n17_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n150_), .c(new_n29_), .O(new_n178_));
  nand2  g162(.a(x5), .b(x3), .O(new_n179_));
  nand2  g163(.a(new_n22_), .b(new_n86_), .O(new_n180_));
  nand3  g164(.a(new_n180_), .b(new_n179_), .c(new_n31_), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n26_), .O(new_n182_));
  nand4  g166(.a(x7), .b(x6), .c(x4), .d(x0), .O(new_n183_));
  nand3  g167(.a(x8), .b(new_n17_), .c(new_n31_), .O(new_n184_));
  nand4  g168(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n178_), .O(new_n185_));
  inv1   g169(.a(new_n185_), .O(new_n186_));
  oai21  g170(.a(new_n176_), .b(new_n171_), .c(new_n186_), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n162_), .c(x1), .O(new_n188_));
  nand2  g172(.a(new_n43_), .b(x9), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n17_), .O(new_n190_));
  nand2  g174(.a(new_n184_), .b(x4), .O(new_n191_));
  aoi21  g175(.a(x9), .b(new_n27_), .c(new_n86_), .O(new_n192_));
  nand2  g176(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand4  g177(.a(new_n26_), .b(x6), .c(new_n22_), .d(new_n86_), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(new_n193_), .c(new_n190_), .O(new_n195_));
  inv1   g179(.a(new_n195_), .O(new_n196_));
  nand3  g180(.a(new_n196_), .b(new_n188_), .c(new_n137_), .O(z1));
  nand2  g181(.a(new_n86_), .b(x1), .O(new_n198_));
  nand2  g182(.a(x3), .b(new_n83_), .O(new_n199_));
  nand2  g183(.a(new_n26_), .b(new_n17_), .O(new_n200_));
  nand3  g184(.a(new_n200_), .b(new_n199_), .c(new_n198_), .O(new_n201_));
  inv1   g185(.a(new_n201_), .O(z2));
  oai21  g186(.a(new_n86_), .b(new_n83_), .c(new_n200_), .O(z3));
  ...
  nand3  g191(.a(new_n199_), .b(new_n207_), .c(new_n37_), .O(new_n208_));
  ...
  nand3  g197(.a(new_n199_), .b(new_n207_), .c(x6), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n27_), .O(new_n215_));
  nand2  g199(.a(new_n198_), .b(new_n147_), .O(new_n216_));
  ...
  nor3   g237(.a(new_n201_), .b(new_n168_), .c(new_n138_), .O(z5));
endmodule
