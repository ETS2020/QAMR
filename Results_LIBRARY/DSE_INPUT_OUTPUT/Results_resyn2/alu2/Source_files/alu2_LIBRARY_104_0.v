...
module FAU ( 
  ...
  nand2  g137(.a(new_n22_), .b(new_n105_), .O(new_n154_));
  inv1   g138(.a(new_n154_), .O(new_n155_));
  nand4  g139(.a(new_n155_), .b(new_n19_), .c(x2), .d(new_n98_), .O(new_n156_));
  ...
  oai21  g165(.a(new_n31_), .b(x0), .c(new_n32_), .O(new_n182_));
  ...
  oai22  g175(.a(new_n191_), .b(new_n96_), .c(new_n154_), .d(new_n92_), .O(new_n192_));
  ...
  oai21  g183(.a(new_n199_), .b(new_n190_), .c(new_n95_), .O(new_n200_));
  nor2   g184(.a(new_n31_), .b(new_n98_), .O(new_n201_));
  ...
  nand3  g188(.a(new_n204_), .b(new_n200_), .c(new_n181_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(x9), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n141_), .O(z1));
  nor2   g191(.a(x9), .b(x8), .O(new_n208_));
  nor2   g192(.a(x3), .b(new_n95_), .O(new_n209_));
  nor3   g193(.a(new_n209_), .b(new_n208_), .c(new_n106_), .O(z2));
  oai22  g194(.a(x9), .b(x8), .c(new_n105_), .d(new_n95_), .O(z3));
  ...
  nand2  g198(.a(new_n201_), .b(new_n19_), .O(new_n215_));
  ...
  nor2   g237(.a(x2), .b(x0), .O(new_n254_));
  oai21  g238(.a(new_n254_), .b(new_n201_), .c(z2), .O(new_n255_));
