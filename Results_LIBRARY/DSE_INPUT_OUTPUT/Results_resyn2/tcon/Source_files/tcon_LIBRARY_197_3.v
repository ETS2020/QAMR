...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n40_, new_n43_, new_n46_, new_n47_,
  ...
  nor2   g04(.a(x16), .b(new_n37_), .O(z01));
  and2   g05(.a(new_n35_), .b(x11), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  aoi21  g07(.a(x16), .b(x10), .c(new_n40_), .O(z03));
  ...
  oai21  g16(.a(x16), .b(new_n47_), .c(x10), .O(new_n50_));
  ...
  nand2  g24(.a(new_n40_), .b(new_n47_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n35_), .O(new_n59_));
  inv1   g26(.a(new_n59_), .O(z11));
  ...
  oai21  g36(.a(x10), .b(new_n47_), .c(x16), .O(new_n70_));
