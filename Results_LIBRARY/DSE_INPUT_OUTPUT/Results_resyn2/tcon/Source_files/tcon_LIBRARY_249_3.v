...
module FAU ( 
  ...
  inv1   g21(.a(x10), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n51_), .O(new_n56_));
  ...
  nand2  g29(.a(new_n37_), .b(new_n51_), .O(new_n63_));
  ...
  nand2  g34(.a(new_n40_), .b(new_n51_), .O(new_n68_));
  ...
  nand2  g39(.a(new_n42_), .b(new_n51_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n35_), .O(new_n74_));
  inv1   g41(.a(new_n74_), .O(z12));
  nand2  g42(.a(new_n56_), .b(x05), .O(new_n76_));
  nand2  g43(.a(x14), .b(new_n51_), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(new_n76_), .O(z13));
  nand2  g45(.a(x08), .b(x06), .O(new_n79_));
  nand2  g46(.a(x15), .b(new_n51_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n35_), .O(z14));
  nand2  g48(.a(x08), .b(x07), .O(new_n82_));
  nand2  g49(.a(x16), .b(new_n51_), .O(new_n83_));
  nand3  g50(.a(new_n83_), .b(new_n82_), .c(new_n35_), .O(z15));
  buf    g51(.a(x10), .O(z01));
endmodule
