...
module FAU ( 
  ...
  nor2   g01(.a(x10), .b(x05), .O(new_n35_));
  nor2   g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(new_n37_), .b(x05), .O(z01));
  ...
  nand2  g23(.a(x08), .b(x05), .O(new_n57_));
  aoi22  g24(.a(new_n57_), .b(new_n37_), .c(x08), .d(new_n56_), .O(z09));
  ...
  oai22  g32(.a(x13), .b(x08), .c(x10), .d(x05), .O(new_n66_));
  aoi21  g33(.a(x08), .b(new_n65_), .c(new_n66_), .O(z12));
  nand2  g34(.a(x14), .b(new_n53_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n57_), .c(new_n40_), .O(z13));
  ...
  oai22  g40(.a(x16), .b(x08), .c(x10), .d(x05), .O(new_n74_));
