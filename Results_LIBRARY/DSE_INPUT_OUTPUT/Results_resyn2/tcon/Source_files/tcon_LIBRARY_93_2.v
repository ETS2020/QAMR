...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n55_, new_n57_, new_n58_, new_n60_, new_n62_, new_n63_, new_n65_,
  ...
  nand3  g27(.a(new_n60_), .b(new_n53_), .c(new_n40_), .O(z10));
  ...
  nand2  g39(.a(new_n48_), .b(new_n52_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n40_), .O(new_n74_));
