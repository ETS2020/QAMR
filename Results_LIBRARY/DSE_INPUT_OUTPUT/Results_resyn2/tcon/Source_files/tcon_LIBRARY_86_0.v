...
module FAU ( 
  ...
  oai21  g23(.a(new_n52_), .b(new_n40_), .c(new_n56_), .O(z10));
  inv1   g24(.a(x16), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(x08), .O(new_n59_));
  nor2   g26(.a(new_n51_), .b(x03), .O(new_n60_));
  aoi21  g27(.a(new_n59_), .b(new_n42_), .c(new_n60_), .O(z11));
  nor2   g28(.a(new_n51_), .b(x04), .O(new_n62_));
  aoi21  g29(.a(new_n59_), .b(new_n44_), .c(new_n62_), .O(z12));
  nor2   g30(.a(new_n51_), .b(x05), .O(new_n64_));
  aoi21  g31(.a(new_n59_), .b(new_n46_), .c(new_n64_), .O(z13));
  nor2   g32(.a(new_n51_), .b(x06), .O(new_n66_));
  aoi21  g33(.a(new_n59_), .b(new_n48_), .c(new_n66_), .O(z14));
