...
module FAU ( 
  ...
  aoi21  g06(.a(x16), .b(x01), .c(new_n39_), .O(z02));
  ...
  nor2   g16(.a(new_n49_), .b(x01), .O(z07));
  ...
  nand2  g41(.a(new_n47_), .b(new_n52_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n35_), .O(new_n76_));
  inv1   g43(.a(new_n76_), .O(z14));
  oai21  g44(.a(new_n52_), .b(x01), .c(x16), .O(new_n78_));
