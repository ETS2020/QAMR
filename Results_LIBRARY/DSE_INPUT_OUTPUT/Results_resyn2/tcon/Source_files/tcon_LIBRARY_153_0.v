...
module FAU ( 
  ...
  oai22  g15(.a(x14), .b(x13), .c(x09), .d(x08), .O(new_n49_));
  aoi21  g16(.a(x08), .b(new_n48_), .c(new_n49_), .O(z08));
  inv1   g17(.a(x01), .O(new_n51_));
  oai22  g18(.a(x14), .b(x13), .c(x10), .d(x08), .O(new_n52_));
  ...
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n40_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  oai22  g25(.a(x14), .b(x13), .c(x12), .d(x08), .O(new_n59_));
