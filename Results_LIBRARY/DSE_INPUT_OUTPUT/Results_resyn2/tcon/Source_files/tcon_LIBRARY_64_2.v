...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n43_,
    ...
    new_n56_, new_n58_, new_n60_, new_n61_, new_n63_, new_n65_, new_n67_,
  ...
  nor2   g26(.a(new_n43_), .b(x03), .O(new_n60_));
  nor2   g27(.a(x12), .b(x08), .O(new_n61_));
  aoi21  g28(.a(new_n60_), .b(x12), .c(new_n61_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  oai22  g30(.a(new_n53_), .b(new_n63_), .c(new_n42_), .d(x08), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  oai22  g32(.a(new_n53_), .b(new_n65_), .c(new_n46_), .d(x08), .O(z13));
  nor2   g33(.a(x15), .b(x08), .O(new_n67_));
  nor2   g34(.a(new_n53_), .b(x06), .O(new_n68_));
  nor2   g35(.a(new_n68_), .b(new_n67_), .O(z14));
