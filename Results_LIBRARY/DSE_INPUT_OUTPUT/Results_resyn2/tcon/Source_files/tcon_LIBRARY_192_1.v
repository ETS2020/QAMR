...
module FAU ( 
  ...
  aoi21  g23(.a(new_n35_), .b(x08), .c(x10), .O(new_n57_));
  nor2   g24(.a(new_n53_), .b(x01), .O(new_n58_));
  ...
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(new_n76_));
  inv1   g43(.a(new_n76_), .O(z13));
  oai21  g44(.a(new_n43_), .b(new_n53_), .c(x15), .O(new_n78_));
