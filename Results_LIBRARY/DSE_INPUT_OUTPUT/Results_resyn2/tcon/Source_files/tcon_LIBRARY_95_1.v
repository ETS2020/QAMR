// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:25 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n75_, new_n76_, new_n77_, new_n79_, new_n80_, new_n82_;
  inv1   g00(.a(x09), .O(new_n34_));
  inv1   g01(.a(x07), .O(new_n35_));
  nand2  g02(.a(x13), .b(new_n35_), .O(new_n36_));
  nand2  g03(.a(new_n36_), .b(new_n34_), .O(z00));
  inv1   g04(.a(x10), .O(new_n38_));
  inv1   g05(.a(x13), .O(new_n39_));
  nor2   g06(.a(new_n39_), .b(x07), .O(new_n40_));
  ...
  nand2  g28(.a(new_n42_), .b(new_n54_), .O(new_n62_));
  ...
  nand2  g37(.a(new_n70_), .b(x13), .O(new_n71_));
  nand2  g38(.a(x08), .b(x04), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z12));
  inv1   g40(.a(x05), .O(new_n74_));
  nand2  g41(.a(x08), .b(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n47_), .b(new_n54_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n36_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z13));
  nand2  g45(.a(x08), .b(x06), .O(new_n79_));
  nand2  g46(.a(x15), .b(new_n54_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n36_), .O(z14));
  nand2  g48(.a(x16), .b(new_n54_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n70_), .c(new_n36_), .O(z15));
endmodule
