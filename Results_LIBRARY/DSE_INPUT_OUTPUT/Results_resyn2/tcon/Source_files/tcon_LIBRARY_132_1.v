...
module FAU ( 
  ...
  nand2  g27(.a(new_n35_), .b(new_n53_), .O(new_n61_));
  aoi22  g28(.a(new_n61_), .b(new_n39_), .c(new_n42_), .d(new_n53_), .O(z10));
  inv1   g29(.a(x03), .O(new_n63_));
  nand2  g30(.a(x08), .b(new_n63_), .O(new_n64_));
  nand2  g31(.a(new_n44_), .b(new_n53_), .O(new_n65_));
  ...
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n40_), .O(z14));
  oai21  g45(.a(new_n53_), .b(new_n39_), .c(x16), .O(new_n79_));
