// Benchmark "FAU" written by ABC on Tue Aug 11 19:09:09 2020
...
module FAU ( 
  ...
  nand2  g24(.a(new_n57_), .b(new_n48_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n35_), .O(new_n59_));
  ...
  oai21  g36(.a(x11), .b(new_n48_), .c(x15), .O(new_n70_));
  ...
  nand2  g41(.a(new_n44_), .b(new_n48_), .O(new_n75_));
