...
module FAU ( 
  ...
  nand2  g09(.a(new_n40_), .b(x07), .O(new_n43_));
  ...
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n43_), .O(new_n57_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n43_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z09));
  nand2  g30(.a(x08), .b(x02), .O(new_n64_));
  nand2  g31(.a(x11), .b(new_n55_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n43_), .O(z10));
  inv1   g33(.a(x03), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n67_), .O(new_n68_));
  nand2  g35(.a(new_n42_), .b(new_n55_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n43_), .O(new_n70_));
  inv1   g37(.a(new_n70_), .O(z11));
  nand2  g38(.a(x08), .b(x04), .O(new_n72_));
  nand2  g39(.a(x13), .b(new_n55_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n43_), .O(z12));
  inv1   g41(.a(x05), .O(new_n75_));
  nand2  g42(.a(x08), .b(new_n75_), .O(new_n76_));
  nand2  g43(.a(new_n47_), .b(new_n55_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n43_), .O(new_n78_));
  inv1   g45(.a(new_n78_), .O(z13));
  inv1   g46(.a(x06), .O(new_n80_));
  nand2  g47(.a(x08), .b(new_n80_), .O(new_n81_));
  nand2  g48(.a(new_n49_), .b(new_n55_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(new_n83_));
  inv1   g50(.a(new_n83_), .O(z14));
  nand2  g51(.a(new_n51_), .b(new_n55_), .O(new_n85_));
  nand2  g52(.a(x08), .b(new_n35_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(new_n87_));
