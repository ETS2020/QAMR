...
module FAU ( 
  ...
  nor2   g15(.a(new_n42_), .b(new_n48_), .O(z06));
  ...
  nand2  g41(.a(new_n46_), .b(new_n53_), .O(new_n75_));
  ...
  nand2  g46(.a(new_n48_), .b(new_n53_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n36_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  aoi21  g49(.a(new_n41_), .b(x08), .c(x16), .O(new_n83_));
  nor2   g50(.a(new_n53_), .b(x07), .O(new_n84_));
  nor2   g51(.a(new_n84_), .b(new_n83_), .O(z15));
  buf    g52(.a(x12), .O(z03));
endmodule
