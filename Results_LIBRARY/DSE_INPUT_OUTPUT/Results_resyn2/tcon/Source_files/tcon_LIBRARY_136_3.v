...
module FAU ( 
  ...
  nor2   g03(.a(new_n36_), .b(x10), .O(z02));
  ...
  nor2   g12(.a(new_n39_), .b(new_n45_), .O(z06));
  ...
  nand2  g27(.a(new_n38_), .b(new_n50_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n34_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z11));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand2  g31(.a(x13), .b(new_n50_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n34_), .O(z12));
  ...
  nand2  g43(.a(new_n47_), .b(new_n50_), .O(new_n77_));
