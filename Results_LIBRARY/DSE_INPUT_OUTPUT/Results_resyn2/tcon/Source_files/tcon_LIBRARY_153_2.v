...
module FAU ( 
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n42_), .O(z10));
  ...
  oai21  g36(.a(new_n41_), .b(new_n53_), .c(x13), .O(new_n70_));
  nand2  g37(.a(x08), .b(x04), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z12));
  aoi21  g39(.a(new_n35_), .b(x08), .c(x14), .O(new_n73_));
  ...
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n42_), .O(new_n79_));
