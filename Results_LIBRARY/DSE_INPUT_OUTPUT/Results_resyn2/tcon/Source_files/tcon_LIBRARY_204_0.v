...
module FAU ( 
  ...
  nand2  g05(.a(x15), .b(new_n38_), .O(z01));
  ...
  nand2  g15(.a(new_n48_), .b(x10), .O(z06));
  ...
  nand2  g23(.a(x15), .b(x08), .O(new_n57_));
  aoi22  g24(.a(new_n57_), .b(new_n38_), .c(x08), .d(new_n56_), .O(z09));
