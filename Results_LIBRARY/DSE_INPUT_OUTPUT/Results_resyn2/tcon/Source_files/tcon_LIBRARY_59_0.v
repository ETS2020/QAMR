...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x02), .O(z02));
  ...
  oai22  g19(.a(x11), .b(x02), .c(x09), .d(x08), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  oai22  g22(.a(x11), .b(x02), .c(x10), .d(x08), .O(new_n56_));
  aoi21  g23(.a(x08), .b(new_n55_), .c(new_n56_), .O(z09));
  inv1   g24(.a(x08), .O(new_n58_));
  nand3  g25(.a(new_n39_), .b(new_n58_), .c(x02), .O(new_n59_));
  inv1   g26(.a(x02), .O(new_n60_));
  nand3  g27(.a(x11), .b(x08), .c(new_n60_), .O(new_n61_));
  and2   g28(.a(new_n61_), .b(new_n59_), .O(z10));
  inv1   g29(.a(x03), .O(new_n63_));
  oai22  g30(.a(x12), .b(x08), .c(x11), .d(x02), .O(new_n64_));
  aoi21  g31(.a(x08), .b(new_n63_), .c(new_n64_), .O(z11));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(x13), .b(new_n58_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n58_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n58_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z14));
  inv1   g41(.a(x07), .O(new_n75_));
  oai22  g42(.a(x16), .b(x08), .c(x11), .d(x02), .O(new_n76_));
  aoi21  g43(.a(x08), .b(new_n75_), .c(new_n76_), .O(z15));
endmodule
