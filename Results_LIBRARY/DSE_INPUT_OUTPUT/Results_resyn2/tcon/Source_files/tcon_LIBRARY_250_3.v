...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_, new_n55_,
    new_n56_, new_n58_, new_n60_, new_n62_, new_n63_, new_n65_, new_n66_,
  ...
  nor2   g13(.a(new_n40_), .b(new_n46_), .O(z06));
  ...
  aoi21  g33(.a(new_n55_), .b(new_n65_), .c(new_n66_), .O(z13));
  ...
  aoi21  g38(.a(new_n55_), .b(new_n70_), .c(new_n71_), .O(z15));
  buf    g39(.a(x11), .O(z02));
endmodule
