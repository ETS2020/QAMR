...
module FAU ( 
  ...
  nand2  g15(.a(new_n48_), .b(x11), .O(new_n49_));
  ...
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(new_n57_));
  inv1   g24(.a(new_n57_), .O(z09));
  oai21  g25(.a(new_n48_), .b(new_n51_), .c(x11), .O(new_n59_));
