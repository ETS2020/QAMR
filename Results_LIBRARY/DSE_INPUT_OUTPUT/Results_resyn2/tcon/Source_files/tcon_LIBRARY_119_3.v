...
module FAU ( 
  ...
  nor2   g08(.a(new_n38_), .b(new_n41_), .O(z04));
  ...
  oai22  g33(.a(new_n50_), .b(new_n66_), .c(new_n45_), .d(x08), .O(z14));
  inv1   g34(.a(x07), .O(new_n68_));
  nor2   g35(.a(x16), .b(x08), .O(new_n69_));
  aoi21  g36(.a(new_n56_), .b(new_n68_), .c(new_n69_), .O(z15));
  buf    g37(.a(x12), .O(z03));
endmodule
