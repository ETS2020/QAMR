...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x11), .O(new_n40_));
  ...
  nand2  g14(.a(new_n47_), .b(x11), .O(new_n48_));
  ...
  aoi21  g27(.a(new_n59_), .b(new_n40_), .c(new_n60_), .O(z10));
  ...
  aoi21  g32(.a(new_n59_), .b(new_n47_), .c(new_n65_), .O(z12));
