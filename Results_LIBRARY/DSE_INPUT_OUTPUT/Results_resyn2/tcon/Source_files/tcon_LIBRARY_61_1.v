...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n40_, new_n42_, new_n43_, new_n45_,
  ...
  nand2  g09(.a(x11), .b(new_n34_), .O(new_n43_));
  ...
  aoi21  g14(.a(x11), .b(new_n34_), .c(new_n47_), .O(z06));
  ...
  aoi21  g23(.a(x08), .b(new_n56_), .c(new_n52_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  nand2  g25(.a(new_n52_), .b(x12), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  aoi22  g28(.a(new_n52_), .b(new_n42_), .c(x08), .d(new_n61_), .O(z12));
