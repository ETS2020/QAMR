...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x14), .O(new_n44_));
  ...
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n44_), .O(z12));
  nand2  g42(.a(new_n35_), .b(x08), .O(new_n76_));
  nor2   g43(.a(new_n54_), .b(x05), .O(new_n77_));
  aoi21  g44(.a(new_n76_), .b(new_n48_), .c(new_n77_), .O(z13));
  ...
  nor2   g50(.a(new_n54_), .b(x07), .O(new_n84_));
  aoi21  g51(.a(new_n76_), .b(new_n43_), .c(new_n84_), .O(z15));
  buf    g52(.a(x16), .O(z07));
endmodule
