...
module FAU ( 
  ...
  nand2  g06(.a(x02), .b(new_n39_), .O(new_n40_));
  ...
  nand2  g21(.a(new_n54_), .b(new_n35_), .O(new_n55_));
  aoi22  g22(.a(new_n55_), .b(new_n39_), .c(new_n34_), .d(new_n54_), .O(z08));
  ...
  nand2  g29(.a(x08), .b(new_n35_), .O(new_n63_));
