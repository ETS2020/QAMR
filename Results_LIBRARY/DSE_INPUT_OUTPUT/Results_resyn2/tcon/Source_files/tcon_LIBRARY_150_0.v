...
module FAU ( 
  ...
  nor2   g20(.a(new_n48_), .b(x08), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n34_), .c(new_n53_), .O(z08));
  nor2   g22(.a(new_n52_), .b(x01), .O(new_n56_));
  aoi21  g23(.a(new_n54_), .b(new_n38_), .c(new_n56_), .O(z09));
  nand2  g24(.a(x15), .b(new_n52_), .O(new_n58_));
  ...
  nor2   g29(.a(new_n52_), .b(x04), .O(new_n63_));
  aoi21  g30(.a(new_n54_), .b(new_n44_), .c(new_n63_), .O(z12));
  nor2   g31(.a(new_n52_), .b(x05), .O(new_n65_));
  aoi21  g32(.a(new_n54_), .b(new_n46_), .c(new_n65_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n67_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  oai21  g36(.a(new_n58_), .b(new_n50_), .c(new_n69_), .O(z15));
endmodule
