...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n47_, new_n49_, new_n50_, new_n52_, new_n53_, new_n55_,
  ...
  oai22  g16(.a(x15), .b(x13), .c(x09), .d(x08), .O(new_n50_));
  aoi21  g17(.a(x08), .b(new_n49_), .c(new_n50_), .O(z08));
  inv1   g18(.a(x01), .O(new_n52_));
  oai22  g19(.a(x15), .b(x13), .c(x10), .d(x08), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z09));
  inv1   g21(.a(x02), .O(new_n55_));
  oai22  g22(.a(x15), .b(x13), .c(x11), .d(x08), .O(new_n56_));
  aoi21  g23(.a(x08), .b(new_n55_), .c(new_n56_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  inv1   g25(.a(x08), .O(new_n59_));
  nand2  g26(.a(x12), .b(new_n59_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n58_), .c(new_n37_), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  nand2  g29(.a(x15), .b(x08), .O(new_n63_));
  aoi22  g30(.a(new_n63_), .b(new_n35_), .c(x08), .d(new_n62_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand2  g32(.a(x14), .b(new_n59_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n37_), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  nand2  g35(.a(x13), .b(x08), .O(new_n69_));
  aoi22  g36(.a(new_n69_), .b(new_n36_), .c(x08), .d(new_n68_), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  oai22  g38(.a(x16), .b(x08), .c(x15), .d(x13), .O(new_n72_));
  aoi21  g39(.a(x08), .b(new_n71_), .c(new_n72_), .O(z15));
  buf    g40(.a(x13), .O(z04));
  buf    g41(.a(x15), .O(z06));
endmodule
