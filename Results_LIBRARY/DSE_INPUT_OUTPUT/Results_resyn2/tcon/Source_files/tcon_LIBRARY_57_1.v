...
module FAU ( 
  ...
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n40_), .O(z10));
  nand2  g33(.a(x08), .b(x03), .O(new_n67_));
  nand2  g34(.a(x12), .b(new_n55_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n40_), .O(z11));
  nand2  g36(.a(new_n35_), .b(new_n55_), .O(new_n70_));
  aoi22  g37(.a(new_n70_), .b(new_n39_), .c(new_n46_), .d(new_n55_), .O(z12));
  inv1   g38(.a(x05), .O(new_n72_));
  nand2  g39(.a(x08), .b(new_n72_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n70_), .c(new_n40_), .O(new_n74_));
