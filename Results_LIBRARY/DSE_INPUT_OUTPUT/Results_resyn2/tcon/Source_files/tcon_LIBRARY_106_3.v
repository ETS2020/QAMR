// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:30 2020
...
module FAU ( 
  ...
  aoi21  g06(.a(x15), .b(x10), .c(new_n39_), .O(z03));
  ...
  nand2  g29(.a(new_n39_), .b(new_n48_), .O(new_n63_));
  ...
  nand2  g34(.a(new_n41_), .b(new_n48_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n35_), .O(new_n69_));
  inv1   g36(.a(new_n69_), .O(z12));
  nand2  g37(.a(x08), .b(x05), .O(new_n71_));
  nand2  g38(.a(x14), .b(new_n48_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z13));
  oai21  g40(.a(x10), .b(new_n48_), .c(x15), .O(new_n74_));
  ...
  nand2  g45(.a(new_n44_), .b(new_n48_), .O(new_n79_));
