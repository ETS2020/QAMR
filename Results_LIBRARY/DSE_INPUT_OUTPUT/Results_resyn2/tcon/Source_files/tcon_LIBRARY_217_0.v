...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(new_n40_), .O(z02));
  ...
  nand2  g15(.a(new_n48_), .b(x11), .O(z06));
  ...
  oai22  g23(.a(x15), .b(x11), .c(x10), .d(x08), .O(new_n57_));
  aoi21  g24(.a(x08), .b(new_n56_), .c(new_n57_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  nand2  g26(.a(x15), .b(x08), .O(new_n60_));
  aoi22  g27(.a(new_n60_), .b(new_n40_), .c(x08), .d(new_n59_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  oai22  g29(.a(x15), .b(x11), .c(x12), .d(x08), .O(new_n63_));
  aoi21  g30(.a(x08), .b(new_n62_), .c(new_n63_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  oai22  g32(.a(x15), .b(x11), .c(x13), .d(x08), .O(new_n66_));
  ...
  nand2  g38(.a(x11), .b(x08), .O(new_n72_));
  aoi22  g39(.a(new_n72_), .b(new_n48_), .c(x08), .d(new_n71_), .O(z14));
  inv1   g40(.a(x07), .O(new_n74_));
  oai22  g41(.a(x16), .b(x08), .c(x15), .d(x11), .O(new_n75_));
