...
module FAU ( 
  ...
  nand2  g10(.a(x14), .b(new_n34_), .O(new_n44_));
  nand2  g11(.a(new_n44_), .b(new_n43_), .O(z04));
  and2   g12(.a(x14), .b(x08), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  aoi21  g14(.a(x14), .b(new_n34_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nand2  g16(.a(new_n44_), .b(new_n49_), .O(z07));
  inv1   g17(.a(x00), .O(new_n51_));
  nor2   g18(.a(x14), .b(x08), .O(new_n52_));
  ...
  aoi21  g32(.a(x08), .b(new_n65_), .c(new_n52_), .O(z13));
