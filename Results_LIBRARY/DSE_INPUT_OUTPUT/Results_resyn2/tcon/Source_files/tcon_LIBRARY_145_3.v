...
module FAU ( 
  ...
  nor2   g12(.a(new_n45_), .b(x13), .O(z06));
  ...
  oai21  g33(.a(x15), .b(new_n49_), .c(x13), .O(new_n67_));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z12));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(x14), .b(new_n49_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n34_), .O(z13));
  oai21  g39(.a(x13), .b(new_n49_), .c(x15), .O(new_n73_));
  ...
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n34_), .O(z15));
  buf    g45(.a(x13), .O(z04));
endmodule
