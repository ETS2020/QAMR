...
module FAU ( 
  ...
  oai22  g29(.a(new_n53_), .b(new_n62_), .c(new_n43_), .d(x08), .O(z11));
  ...
  aoi21  g36(.a(new_n56_), .b(new_n68_), .c(new_n69_), .O(z14));
