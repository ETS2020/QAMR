...
module FAU ( 
  ...
  oai22  g19(.a(x15), .b(x03), .c(x09), .d(x08), .O(new_n53_));
  ...
  oai22  g26(.a(x15), .b(x03), .c(x11), .d(x08), .O(new_n60_));
  aoi21  g27(.a(x08), .b(new_n59_), .c(new_n60_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  nor2   g29(.a(x12), .b(x08), .O(new_n63_));
  nand2  g30(.a(x15), .b(new_n56_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n62_), .c(new_n63_), .O(z11));
  inv1   g32(.a(x04), .O(new_n66_));
  oai22  g33(.a(x15), .b(x03), .c(x13), .d(x08), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z12));
  inv1   g35(.a(x05), .O(new_n69_));
  oai22  g36(.a(x15), .b(x03), .c(x14), .d(x08), .O(new_n70_));
  aoi21  g37(.a(x08), .b(new_n69_), .c(new_n70_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  nand2  g39(.a(x08), .b(x03), .O(new_n73_));
  aoi22  g40(.a(new_n73_), .b(new_n48_), .c(x08), .d(new_n72_), .O(z14));
  inv1   g41(.a(x07), .O(new_n75_));
  oai22  g42(.a(x16), .b(x08), .c(x15), .d(x03), .O(new_n76_));
