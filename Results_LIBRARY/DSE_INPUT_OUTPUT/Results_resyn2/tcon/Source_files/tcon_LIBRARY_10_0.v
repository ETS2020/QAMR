...
module FAU ( 
  ...
  oai22  g21(.a(x11), .b(x03), .c(x10), .d(x08), .O(new_n55_));
  ...
  oai22  g30(.a(x13), .b(x08), .c(x11), .d(x03), .O(new_n64_));
  aoi21  g31(.a(x08), .b(new_n63_), .c(new_n64_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(x14), .b(x08), .c(x11), .d(x03), .O(new_n67_));
  ...
  oai22  g39(.a(x16), .b(x08), .c(x11), .d(x03), .O(new_n73_));
