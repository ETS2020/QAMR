...
module FAU ( 
  ...
  aoi22  g21(.a(x16), .b(new_n39_), .c(x10), .d(new_n51_), .O(new_n55_));
  ...
  nand2  g28(.a(new_n44_), .b(new_n51_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n40_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  nand2  g32(.a(x08), .b(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n46_), .b(new_n51_), .O(new_n67_));
  ...
  nand2  g41(.a(new_n48_), .b(new_n51_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n40_), .O(new_n76_));
  inv1   g43(.a(new_n76_), .O(z14));
  nand3  g44(.a(new_n40_), .b(x08), .c(x07), .O(new_n78_));
  nand3  g45(.a(x16), .b(x14), .c(new_n51_), .O(new_n79_));
