...
module FAU ( 
  ...
  nor2   g07(.a(x11), .b(new_n34_), .O(new_n41_));
  ...
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n38_), .O(new_n58_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n38_), .O(z12));
  nand2  g37(.a(x08), .b(x05), .O(new_n71_));
  nand2  g38(.a(x14), .b(new_n51_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n38_), .O(z13));
  ...
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n38_), .O(z15));
  buf    g48(.a(x11), .O(z02));
endmodule
