...
module FAU ( 
  ...
  nor2   g14(.a(new_n39_), .b(new_n35_), .O(z05));
  ...
  nand2  g39(.a(x13), .b(new_n55_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n36_), .O(z12));
  inv1   g41(.a(x05), .O(new_n75_));
  nand2  g42(.a(x08), .b(new_n75_), .O(new_n76_));
  nand2  g43(.a(new_n39_), .b(new_n55_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n36_), .O(new_n78_));
  inv1   g45(.a(new_n78_), .O(z13));
  nand2  g46(.a(x15), .b(new_n55_), .O(new_n80_));
  nand2  g47(.a(x08), .b(x06), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n36_), .O(z14));
