...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(x08), .O(new_n51_));
  oai22  g18(.a(new_n51_), .b(new_n50_), .c(new_n34_), .d(x08), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  and2   g20(.a(x12), .b(x08), .O(new_n54_));
  nor2   g21(.a(x10), .b(x08), .O(new_n55_));
  aoi21  g22(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(z09));
  ...
  oai22  g29(.a(new_n51_), .b(new_n62_), .c(new_n41_), .d(x08), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  nor2   g31(.a(x14), .b(x08), .O(new_n65_));
  aoi21  g32(.a(new_n54_), .b(new_n64_), .c(new_n65_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  oai22  g34(.a(new_n51_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z14));
