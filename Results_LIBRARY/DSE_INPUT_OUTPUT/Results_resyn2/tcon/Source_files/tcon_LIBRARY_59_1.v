...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n43_,
    ...
    new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_, new_n64_,
  ...
  nand2  g10(.a(x11), .b(new_n43_), .O(new_n44_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n43_), .c(new_n35_), .O(z10));
  inv1   g30(.a(x03), .O(new_n64_));
  nand2  g31(.a(x08), .b(new_n64_), .O(new_n65_));
  nand2  g32(.a(new_n40_), .b(new_n54_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n44_), .O(new_n67_));
  inv1   g34(.a(new_n67_), .O(z11));
  nand2  g35(.a(x08), .b(x04), .O(new_n69_));
  nand2  g36(.a(x13), .b(new_n54_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z12));
  nand2  g38(.a(x08), .b(x05), .O(new_n72_));
  nand2  g39(.a(x14), .b(new_n54_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z13));
  nand2  g41(.a(x08), .b(x06), .O(new_n75_));
  nand2  g42(.a(x15), .b(new_n54_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n44_), .O(z14));
  inv1   g44(.a(x07), .O(new_n78_));
  nand2  g45(.a(x08), .b(new_n78_), .O(new_n79_));
  nand2  g46(.a(new_n50_), .b(new_n54_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n44_), .O(new_n81_));
