...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n42_,
    new_n44_, new_n46_, new_n50_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nor2   g14(.a(new_n35_), .b(new_n41_), .O(z05));
  nand2  g15(.a(new_n35_), .b(new_n41_), .O(z06));
