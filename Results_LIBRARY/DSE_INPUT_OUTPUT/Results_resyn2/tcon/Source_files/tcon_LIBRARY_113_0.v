...
module FAU ( 
  ...
  nor2   g20(.a(new_n49_), .b(x01), .O(new_n54_));
  aoi21  g21(.a(new_n52_), .b(new_n37_), .c(new_n54_), .O(z09));
  nand2  g22(.a(x13), .b(new_n49_), .O(new_n56_));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  oai21  g24(.a(new_n56_), .b(new_n39_), .c(new_n57_), .O(z10));
  nand2  g25(.a(x08), .b(x03), .O(new_n59_));
  oai21  g26(.a(new_n56_), .b(new_n41_), .c(new_n59_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  nand2  g28(.a(x08), .b(new_n61_), .O(z12));
  nor2   g29(.a(new_n49_), .b(x05), .O(new_n63_));
  aoi21  g30(.a(new_n52_), .b(new_n43_), .c(new_n63_), .O(z13));
  nor2   g31(.a(new_n49_), .b(x06), .O(new_n65_));
  aoi21  g32(.a(new_n52_), .b(new_n45_), .c(new_n65_), .O(z14));
  nor2   g33(.a(new_n49_), .b(x07), .O(new_n67_));
  aoi21  g34(.a(new_n52_), .b(new_n47_), .c(new_n67_), .O(z15));
  buf    g35(.a(x13), .O(z04));
endmodule
