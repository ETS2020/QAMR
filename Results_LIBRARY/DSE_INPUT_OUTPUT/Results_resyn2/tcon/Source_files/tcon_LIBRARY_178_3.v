...
module FAU ( 
  ...
  nand2  g16(.a(new_n49_), .b(x09), .O(new_n50_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n35_), .O(z09));
  ...
  nand2  g28(.a(new_n39_), .b(new_n54_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n35_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z11));
  nor2   g31(.a(new_n54_), .b(x04), .O(new_n65_));
  aoi21  g32(.a(new_n49_), .b(new_n42_), .c(new_n65_), .O(z12));
