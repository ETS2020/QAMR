...
module FAU ( 
  ...
  nand3  g22(.a(new_n40_), .b(x10), .c(new_n51_), .O(new_n56_));
  oai21  g23(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n51_), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n34_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  nand3  g28(.a(x12), .b(new_n36_), .c(new_n51_), .O(new_n62_));
  oai21  g29(.a(new_n55_), .b(new_n61_), .c(new_n62_), .O(z11));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  aoi22  g31(.a(x13), .b(new_n51_), .c(x12), .d(x10), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  inv1   g33(.a(x05), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n67_), .O(new_n68_));
  nand2  g35(.a(new_n44_), .b(new_n51_), .O(new_n69_));
