...
module FAU ( 
  ...
  nand2  g17(.a(new_n50_), .b(x04), .O(z07));
  ...
  oai22  g23(.a(x16), .b(x04), .c(x10), .d(x08), .O(new_n57_));
  ...
  oai22  g39(.a(x16), .b(x04), .c(x15), .d(x08), .O(new_n73_));
  aoi21  g40(.a(x08), .b(new_n72_), .c(new_n73_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n67_), .c(new_n36_), .O(z15));
endmodule
