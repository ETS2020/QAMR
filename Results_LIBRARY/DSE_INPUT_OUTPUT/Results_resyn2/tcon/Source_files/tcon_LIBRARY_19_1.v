...
module FAU ( 
  ...
  nor2   g10(.a(new_n35_), .b(new_n38_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nand2  g12(.a(x13), .b(new_n38_), .O(new_n46_));
  ...
  aoi21  g24(.a(new_n35_), .b(x08), .c(x10), .O(new_n58_));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n46_), .O(new_n64_));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n46_), .O(new_n69_));
  inv1   g36(.a(new_n69_), .O(z11));
  oai21  g37(.a(new_n38_), .b(new_n54_), .c(x13), .O(new_n71_));
