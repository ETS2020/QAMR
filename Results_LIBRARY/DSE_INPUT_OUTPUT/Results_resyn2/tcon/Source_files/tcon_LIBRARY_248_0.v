...
module FAU ( 
  ...
  oai22  g32(.a(x15), .b(x14), .c(x13), .d(x08), .O(new_n66_));
  aoi21  g33(.a(x08), .b(new_n65_), .c(new_n66_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  nand2  g35(.a(x15), .b(x08), .O(new_n69_));
  aoi22  g36(.a(new_n69_), .b(new_n46_), .c(x08), .d(new_n68_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  nand2  g38(.a(x14), .b(x08), .O(new_n72_));
