...
module FAU ( 
  ...
  nor2   g17(.a(new_n50_), .b(x09), .O(z07));
  inv1   g18(.a(x08), .O(new_n52_));
  oai21  g19(.a(x16), .b(new_n52_), .c(x09), .O(new_n53_));
  ...
  nand2  g24(.a(new_n36_), .b(new_n52_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n37_), .O(new_n59_));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n37_), .O(new_n64_));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n37_), .O(new_n69_));
  inv1   g36(.a(new_n69_), .O(z11));
  inv1   g37(.a(x04), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n71_), .O(new_n72_));
  nand2  g39(.a(new_n44_), .b(new_n52_), .O(new_n73_));
  ...
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n37_), .O(z13));
  inv1   g45(.a(x06), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n48_), .b(new_n52_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n37_), .O(new_n82_));
  inv1   g49(.a(new_n82_), .O(z14));
  oai21  g50(.a(x09), .b(new_n52_), .c(x16), .O(new_n84_));
