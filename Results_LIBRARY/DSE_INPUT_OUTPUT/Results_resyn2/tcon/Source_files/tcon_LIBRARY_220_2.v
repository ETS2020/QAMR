...
module FAU ( 
  ...
  nand2  g18(.a(new_n41_), .b(new_n35_), .O(z07));
  ...
  nand2  g31(.a(new_n44_), .b(new_n54_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n42_), .O(new_n66_));
  inv1   g33(.a(new_n66_), .O(z11));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand2  g35(.a(x13), .b(new_n54_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n42_), .O(z12));
  nand2  g37(.a(new_n48_), .b(new_n54_), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n35_), .O(new_n72_));
