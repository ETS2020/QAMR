...
module FAU ( 
  ...
  oai21  g21(.a(new_n39_), .b(new_n52_), .c(x10), .O(new_n55_));
  ...
  nand2  g32(.a(new_n44_), .b(new_n52_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n40_), .O(new_n67_));
  inv1   g34(.a(new_n67_), .O(z12));
  aoi21  g35(.a(new_n35_), .b(x08), .c(x14), .O(new_n69_));
  nor2   g36(.a(new_n52_), .b(x05), .O(new_n70_));
  nor2   g37(.a(new_n70_), .b(new_n69_), .O(z13));
