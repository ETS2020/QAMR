...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n40_, new_n42_, new_n44_,
  ...
  nand2  g05(.a(new_n36_), .b(x09), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  nand2  g07(.a(new_n37_), .b(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  aoi21  g09(.a(new_n36_), .b(new_n35_), .c(new_n42_), .O(z04));
  ...
  nand3  g19(.a(new_n52_), .b(new_n50_), .c(new_n37_), .O(z08));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand2  g21(.a(x10), .b(new_n51_), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n37_), .O(z09));
  ...
  oai22  g33(.a(x14), .b(x08), .c(x11), .d(x09), .O(new_n67_));
  ...
  oai22  g39(.a(x16), .b(x08), .c(x11), .d(x09), .O(new_n73_));
