...
module FAU ( 
  ...
  oai22  g21(.a(new_n52_), .b(new_n54_), .c(new_n37_), .d(x08), .O(z09));
  inv1   g22(.a(x02), .O(new_n56_));
  inv1   g23(.a(x08), .O(new_n57_));
  nor2   g24(.a(x15), .b(new_n57_), .O(new_n58_));
  ...
  nand2  g34(.a(x15), .b(new_n57_), .O(new_n68_));
  oai21  g35(.a(new_n52_), .b(new_n67_), .c(new_n68_), .O(z14));
