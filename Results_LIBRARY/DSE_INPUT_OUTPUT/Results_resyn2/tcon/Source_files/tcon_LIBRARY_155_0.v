...
module FAU ( 
  ...
  nand2  g20(.a(new_n53_), .b(x01), .O(new_n54_));
  oai21  g21(.a(new_n54_), .b(new_n34_), .c(new_n52_), .O(z08));
  inv1   g22(.a(x01), .O(new_n56_));
  aoi21  g23(.a(new_n38_), .b(new_n53_), .c(new_n56_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  oai21  g25(.a(new_n54_), .b(new_n40_), .c(new_n58_), .O(z10));
  nor2   g26(.a(x08), .b(new_n56_), .O(new_n60_));
  nor2   g27(.a(new_n53_), .b(x03), .O(new_n61_));
  aoi21  g28(.a(new_n60_), .b(new_n42_), .c(new_n61_), .O(z11));
  nor2   g29(.a(new_n53_), .b(x04), .O(new_n63_));
  aoi21  g30(.a(new_n60_), .b(new_n44_), .c(new_n63_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  oai21  g32(.a(new_n54_), .b(new_n46_), .c(new_n65_), .O(z13));
  nor2   g33(.a(new_n53_), .b(x06), .O(new_n67_));
  aoi21  g34(.a(new_n60_), .b(new_n48_), .c(new_n67_), .O(z14));
  nor2   g35(.a(new_n53_), .b(x07), .O(new_n69_));
  aoi21  g36(.a(new_n60_), .b(new_n50_), .c(new_n69_), .O(z15));
endmodule
