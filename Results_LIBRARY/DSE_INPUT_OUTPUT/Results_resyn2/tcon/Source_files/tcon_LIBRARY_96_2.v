...
module FAU ( 
  ...
  nand2  g27(.a(new_n38_), .b(new_n53_), .O(new_n61_));
  ...
  nand2  g39(.a(new_n48_), .b(new_n53_), .O(new_n73_));
  nand2  g40(.a(x08), .b(new_n39_), .O(new_n74_));
  ...
  nand2  g45(.a(new_n50_), .b(new_n53_), .O(new_n79_));
