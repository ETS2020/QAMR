...
module FAU ( 
  ...
  nor2   g19(.a(new_n52_), .b(x01), .O(new_n53_));
  inv1   g20(.a(x09), .O(new_n54_));
  nor2   g21(.a(new_n54_), .b(x08), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n34_), .c(new_n53_), .O(z09));
  nor2   g23(.a(new_n52_), .b(x02), .O(new_n57_));
  aoi21  g24(.a(new_n55_), .b(new_n38_), .c(new_n57_), .O(z10));
  nor2   g25(.a(new_n52_), .b(x03), .O(new_n59_));
  aoi21  g26(.a(new_n55_), .b(new_n40_), .c(new_n59_), .O(z11));
  nor2   g27(.a(new_n52_), .b(x04), .O(new_n61_));
  aoi21  g28(.a(new_n55_), .b(new_n42_), .c(new_n61_), .O(z12));
  nor2   g29(.a(new_n52_), .b(x05), .O(new_n63_));
  aoi21  g30(.a(new_n55_), .b(new_n44_), .c(new_n63_), .O(z13));
  nor2   g31(.a(new_n52_), .b(x06), .O(new_n65_));
  aoi21  g32(.a(new_n55_), .b(new_n46_), .c(new_n65_), .O(z14));
  nand2  g33(.a(x09), .b(new_n52_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x07), .O(new_n68_));
  oai21  g35(.a(new_n67_), .b(new_n48_), .c(new_n68_), .O(z15));
  buf    g36(.a(x09), .O(z00));
endmodule
