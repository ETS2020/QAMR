...
module FAU ( 
  ...
  aoi22  g23(.a(new_n52_), .b(new_n39_), .c(x08), .d(new_n56_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  aoi22  g25(.a(new_n52_), .b(new_n42_), .c(x08), .d(new_n58_), .O(z11));
  inv1   g26(.a(x04), .O(new_n60_));
  aoi21  g27(.a(x08), .b(new_n60_), .c(new_n52_), .O(z12));
