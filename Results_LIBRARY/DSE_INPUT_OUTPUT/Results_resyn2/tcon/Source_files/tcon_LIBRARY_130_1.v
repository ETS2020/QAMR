...
module FAU ( 
  ...
  nor2   g24(.a(x15), .b(x08), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(x11), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n57_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  aoi22  g28(.a(new_n58_), .b(new_n42_), .c(x08), .d(new_n61_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  aoi22  g30(.a(new_n58_), .b(new_n44_), .c(x08), .d(new_n63_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  aoi22  g32(.a(new_n58_), .b(new_n46_), .c(x08), .d(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n36_), .O(z14));
  inv1   g35(.a(x07), .O(new_n69_));
  aoi22  g36(.a(new_n58_), .b(new_n48_), .c(x08), .d(new_n69_), .O(z15));
  buf    g37(.a(x15), .O(z06));
endmodule
