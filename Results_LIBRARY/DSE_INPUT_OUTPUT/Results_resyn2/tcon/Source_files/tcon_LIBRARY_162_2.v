// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:55 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n66_, new_n68_, new_n70_, new_n71_, new_n73_, new_n74_;
  ...
  nor2   g28(.a(new_n39_), .b(x03), .O(new_n62_));
  nor2   g29(.a(x12), .b(x08), .O(new_n63_));
  aoi21  g30(.a(new_n62_), .b(x12), .c(new_n63_), .O(z11));
  nor2   g31(.a(x13), .b(x08), .O(new_n65_));
  nor2   g32(.a(new_n53_), .b(x04), .O(new_n66_));
  ...
  nor2   g37(.a(new_n53_), .b(x06), .O(new_n71_));
  nor2   g38(.a(new_n71_), .b(new_n70_), .O(z14));
  nor2   g39(.a(x16), .b(x08), .O(new_n73_));
  nor2   g40(.a(new_n53_), .b(x07), .O(new_n74_));
