...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n46_, new_n48_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  nor2   g06(.a(new_n39_), .b(x15), .O(new_n40_));
  ...
  nand2  g16(.a(new_n39_), .b(new_n35_), .O(z06));
  nor2   g17(.a(new_n39_), .b(new_n35_), .O(z07));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z12));
  nand2  g38(.a(x08), .b(x05), .O(new_n72_));
  nand2  g39(.a(x14), .b(new_n54_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n36_), .O(z13));
  nand2  g41(.a(x08), .b(x06), .O(new_n75_));
  nand2  g42(.a(x15), .b(x08), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(z06), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(new_n75_), .O(z14));
  nand2  g45(.a(new_n76_), .b(x16), .O(new_n79_));
