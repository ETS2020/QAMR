...
module FAU ( 
  ...
  nand2  g07(.a(new_n40_), .b(x02), .O(z02));
  ...
  oai22  g29(.a(x12), .b(x08), .c(x11), .d(x02), .O(new_n63_));
  ...
  oai22  g35(.a(x14), .b(x08), .c(x11), .d(x02), .O(new_n69_));
  ...
  oai22  g41(.a(x16), .b(x08), .c(x11), .d(x02), .O(new_n75_));
