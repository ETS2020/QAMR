...
module FAU ( 
  ...
  nand2  g35(.a(x12), .b(new_n54_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n36_), .O(z11));
  nand2  g37(.a(x08), .b(new_n39_), .O(new_n71_));
  nand2  g38(.a(new_n46_), .b(new_n54_), .O(new_n72_));
  ...
  nor2   g46(.a(new_n54_), .b(x06), .O(new_n80_));
  aoi21  g47(.a(new_n71_), .b(new_n35_), .c(new_n80_), .O(z14));
  nand2  g48(.a(x08), .b(x07), .O(new_n82_));
  nand2  g49(.a(x16), .b(new_n54_), .O(new_n83_));
  nand3  g50(.a(new_n83_), .b(new_n82_), .c(new_n36_), .O(z15));
  buf    g51(.a(x15), .O(z06));
endmodule
