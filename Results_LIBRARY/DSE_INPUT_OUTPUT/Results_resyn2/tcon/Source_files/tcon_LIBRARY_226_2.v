...
module FAU ( 
  ...
  nand2  g08(.a(x15), .b(x11), .O(new_n42_));
  ...
  aoi22  g20(.a(new_n35_), .b(x11), .c(x09), .d(new_n53_), .O(new_n54_));
  ...
  nand2  g25(.a(new_n39_), .b(x08), .O(new_n59_));
  nor2   g26(.a(new_n53_), .b(x02), .O(new_n60_));
  aoi21  g27(.a(new_n59_), .b(new_n42_), .c(new_n60_), .O(z10));
  ...
  aoi22  g34(.a(new_n35_), .b(x11), .c(x13), .d(new_n53_), .O(new_n68_));
  ...
  aoi21  g40(.a(new_n59_), .b(new_n35_), .c(new_n73_), .O(z14));
