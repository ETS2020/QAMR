...
module FAU ( 
  ...
  nand2  g27(.a(new_n40_), .b(new_n51_), .O(new_n61_));
  ...
  oai21  g40(.a(new_n35_), .b(x08), .c(x05), .O(new_n74_));
  ...
  nand2  g45(.a(new_n48_), .b(new_n51_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n36_), .O(new_n80_));
  inv1   g47(.a(new_n80_), .O(z14));
  inv1   g48(.a(x05), .O(new_n82_));
  aoi21  g49(.a(x08), .b(new_n82_), .c(x16), .O(new_n83_));
  nor2   g50(.a(new_n51_), .b(x07), .O(new_n84_));
