...
module FAU ( 
  ...
  nor2   g16(.a(new_n35_), .b(new_n39_), .O(z06));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n40_), .O(z11));
  ...
  nand2  g50(.a(new_n35_), .b(new_n55_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n40_), .O(new_n85_));
  inv1   g52(.a(new_n85_), .O(z14));
  nand2  g53(.a(x16), .b(new_n55_), .O(new_n87_));
  nand2  g54(.a(x08), .b(x07), .O(new_n88_));
  nand3  g55(.a(new_n88_), .b(new_n87_), .c(new_n40_), .O(z15));
endmodule
