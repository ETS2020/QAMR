...
module FAU ( 
  ...
  oai22  g23(.a(x15), .b(x00), .c(x10), .d(x08), .O(new_n57_));
  aoi21  g24(.a(x08), .b(new_n56_), .c(new_n57_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  oai22  g26(.a(x15), .b(x00), .c(x11), .d(x08), .O(new_n60_));
  ...
  oai22  g32(.a(x15), .b(x00), .c(x13), .d(x08), .O(new_n66_));
  aoi21  g33(.a(x08), .b(new_n65_), .c(new_n66_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(x15), .b(x00), .c(x14), .d(x08), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  aoi22  g38(.a(new_n54_), .b(new_n48_), .c(x08), .d(new_n71_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  oai22  g40(.a(x16), .b(x08), .c(x15), .d(x00), .O(new_n74_));
