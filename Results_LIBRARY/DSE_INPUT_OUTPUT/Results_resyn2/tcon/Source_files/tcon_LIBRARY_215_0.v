...
module FAU ( 
  ...
  nand2  g22(.a(x11), .b(new_n55_), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n38_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  nand2  g25(.a(x12), .b(new_n55_), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n38_), .O(z11));
  nand2  g27(.a(x08), .b(x04), .O(new_n61_));
  nand2  g28(.a(x13), .b(new_n55_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n38_), .O(z12));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n38_), .O(z14));
