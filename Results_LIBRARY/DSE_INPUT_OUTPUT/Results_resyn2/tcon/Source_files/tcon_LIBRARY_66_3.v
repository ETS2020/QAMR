...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x05), .O(new_n35_));
  ...
  aoi21  g08(.a(x16), .b(x05), .c(new_n41_), .O(z03));
  ...
  nand2  g28(.a(new_n39_), .b(new_n52_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n35_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z10));
  inv1   g31(.a(x03), .O(new_n65_));
  nand2  g32(.a(x08), .b(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n41_), .b(new_n52_), .O(new_n67_));
  ...
  nand2  g38(.a(new_n43_), .b(new_n52_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(new_n73_));
  inv1   g40(.a(new_n73_), .O(z12));
  nand2  g41(.a(new_n49_), .b(new_n52_), .O(new_n75_));
  nand2  g42(.a(new_n75_), .b(x05), .O(new_n76_));
  nand2  g43(.a(x14), .b(new_n52_), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(new_n76_), .O(z13));
  inv1   g45(.a(x06), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n47_), .b(new_n52_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n35_), .O(new_n82_));
  inv1   g49(.a(new_n82_), .O(z14));
  inv1   g50(.a(x07), .O(new_n84_));
  nand2  g51(.a(x08), .b(new_n84_), .O(new_n85_));
  nand3  g52(.a(new_n85_), .b(new_n75_), .c(new_n35_), .O(new_n86_));
