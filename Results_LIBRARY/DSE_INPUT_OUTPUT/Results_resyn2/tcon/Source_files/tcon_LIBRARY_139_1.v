...
module FAU ( 
  ...
  nand2  g32(.a(new_n39_), .b(new_n54_), .O(new_n66_));
  aoi22  g33(.a(new_n66_), .b(new_n35_), .c(new_n44_), .d(new_n54_), .O(z11));
  ...
  nand3  g46(.a(new_n79_), .b(new_n66_), .c(new_n36_), .O(new_n80_));
  inv1   g47(.a(new_n80_), .O(z14));
  inv1   g48(.a(x07), .O(new_n82_));
  nand2  g49(.a(x08), .b(new_n82_), .O(new_n83_));
  nand2  g50(.a(new_n50_), .b(new_n54_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n36_), .O(new_n85_));
