...
module FAU ( 
  ...
  aoi21  g41(.a(new_n52_), .b(new_n37_), .c(new_n74_), .O(z13));
  ...
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n38_), .O(z15));
  buf    g50(.a(x14), .O(z05));
endmodule
