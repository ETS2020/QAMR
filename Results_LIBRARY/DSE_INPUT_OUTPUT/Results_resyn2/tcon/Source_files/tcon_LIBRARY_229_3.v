...
module FAU ( 
  ...
  nor2   g11(.a(new_n44_), .b(x06), .O(z04));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n35_), .O(z09));
  ...
  nand2  g32(.a(new_n42_), .b(new_n54_), .O(new_n66_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n69_), .c(new_n35_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z12));
  nand2  g40(.a(x08), .b(x05), .O(new_n74_));
  nand2  g41(.a(x14), .b(new_n54_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n35_), .O(z13));
  nand2  g43(.a(new_n69_), .b(x06), .O(new_n77_));
