...
module FAU ( 
  ...
  nor2   g10(.a(new_n35_), .b(new_n34_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nor2   g12(.a(new_n35_), .b(x09), .O(new_n46_));
  ...
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n38_), .O(new_n65_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n38_), .O(new_n70_));
  inv1   g37(.a(new_n70_), .O(z12));
  nand2  g38(.a(x08), .b(x05), .O(new_n72_));
  nand2  g39(.a(x14), .b(new_n53_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n38_), .O(z13));
  ...
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n38_), .O(z15));
endmodule
