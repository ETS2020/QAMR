...
module FAU ( 
  ...
  aoi21  g31(.a(new_n60_), .b(new_n63_), .c(new_n64_), .O(z12));
  ...
  aoi21  g36(.a(new_n60_), .b(new_n68_), .c(new_n69_), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  nor2   g38(.a(x16), .b(x08), .O(new_n72_));
  aoi21  g39(.a(new_n60_), .b(new_n71_), .c(new_n72_), .O(z15));
endmodule
