...
module FAU ( 
  ...
  nand2  g11(.a(x13), .b(new_n42_), .O(new_n45_));
  ...
  nand2  g28(.a(new_n40_), .b(new_n52_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n45_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z10));
  aoi21  g31(.a(new_n35_), .b(x08), .c(x12), .O(new_n65_));
  nor2   g32(.a(new_n52_), .b(x03), .O(new_n66_));
  nor2   g33(.a(new_n66_), .b(new_n65_), .O(z11));
  oai21  g34(.a(new_n42_), .b(new_n52_), .c(x13), .O(new_n68_));
