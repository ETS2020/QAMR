...
module FAU ( 
  ...
  aoi21  g07(.a(x16), .b(x13), .c(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  nor2   g09(.a(x16), .b(new_n42_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  nand2  g11(.a(new_n34_), .b(new_n44_), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  nand2  g13(.a(new_n34_), .b(new_n46_), .O(z06));
  nand2  g14(.a(x16), .b(new_n42_), .O(new_n48_));
  inv1   g15(.a(new_n48_), .O(z07));
  ...
  nand2  g22(.a(new_n36_), .b(new_n51_), .O(new_n56_));
  ...
  nand2  g27(.a(new_n38_), .b(new_n51_), .O(new_n61_));
  ...
  nand2  g32(.a(new_n40_), .b(new_n51_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n34_), .O(new_n67_));
  ...
  nand2  g41(.a(x14), .b(new_n51_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n34_), .O(z13));
  inv1   g43(.a(x06), .O(new_n77_));
  nand2  g44(.a(x08), .b(new_n77_), .O(new_n78_));
  nand2  g45(.a(new_n46_), .b(new_n51_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n34_), .O(new_n80_));
  inv1   g47(.a(new_n80_), .O(z14));
  nor2   g48(.a(new_n51_), .b(x07), .O(new_n82_));
  aoi21  g49(.a(new_n70_), .b(new_n48_), .c(new_n82_), .O(z15));
endmodule
