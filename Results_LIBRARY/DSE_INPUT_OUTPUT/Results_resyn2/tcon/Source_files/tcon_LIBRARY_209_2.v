...
module FAU ( 
  ...
  nor2   g02(.a(x02), .b(new_n35_), .O(new_n36_));
  ...
  nand2  g22(.a(x08), .b(new_n35_), .O(new_n56_));
  ...
  nand2  g27(.a(new_n38_), .b(new_n54_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n40_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z09));
  nand2  g30(.a(new_n54_), .b(new_n35_), .O(new_n64_));
  aoi22  g31(.a(new_n64_), .b(new_n39_), .c(new_n42_), .d(new_n54_), .O(z10));
  ...
  nand2  g40(.a(new_n48_), .b(new_n54_), .O(new_n74_));
  ...
  nand2  g48(.a(new_n52_), .b(new_n54_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n40_), .O(new_n83_));
