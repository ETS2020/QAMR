...
module FAU ( 
  ...
  oai21  g32(.a(new_n35_), .b(new_n50_), .c(x13), .O(new_n66_));
  ...
  aoi21  g38(.a(new_n44_), .b(x08), .c(x15), .O(new_n72_));
  nor2   g39(.a(new_n50_), .b(x06), .O(new_n73_));
  nor2   g40(.a(new_n73_), .b(new_n72_), .O(z14));
