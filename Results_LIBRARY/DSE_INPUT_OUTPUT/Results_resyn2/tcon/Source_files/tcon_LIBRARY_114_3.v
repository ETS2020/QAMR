...
module FAU ( 
  ...
  aoi21  g08(.a(x16), .b(x06), .c(new_n41_), .O(z04));
  ...
  nor2   g14(.a(new_n47_), .b(x06), .O(z07));
  ...
  nand2  g32(.a(new_n41_), .b(new_n50_), .O(new_n66_));
  ...
  nand2  g37(.a(new_n43_), .b(new_n50_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z13));
  oai21  g40(.a(x16), .b(x08), .c(x06), .O(new_n74_));
  oai21  g41(.a(new_n45_), .b(x08), .c(new_n74_), .O(z14));
  oai21  g42(.a(new_n50_), .b(x06), .c(x16), .O(new_n76_));
