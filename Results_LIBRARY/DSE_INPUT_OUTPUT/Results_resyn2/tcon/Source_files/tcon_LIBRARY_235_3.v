...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n43_, new_n45_,
  ...
  nor2   g12(.a(new_n40_), .b(new_n45_), .O(z06));
  ...
  oai21  g19(.a(x11), .b(x08), .c(x01), .O(new_n53_));
  oai21  g20(.a(new_n37_), .b(x08), .c(new_n53_), .O(z09));
  oai21  g21(.a(new_n50_), .b(x01), .c(x11), .O(new_n55_));
  ...
  nand2  g26(.a(new_n39_), .b(new_n50_), .O(new_n60_));
  ...
  nand2  g34(.a(new_n43_), .b(new_n50_), .O(new_n68_));
  ...
  nand2  g44(.a(new_n47_), .b(new_n50_), .O(new_n78_));
