...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    ...
    new_n58_, new_n59_, new_n61_, new_n63_, new_n65_, new_n67_;
  ...
  nor2   g22(.a(new_n49_), .b(x02), .O(new_n56_));
  aoi21  g23(.a(new_n52_), .b(new_n39_), .c(new_n56_), .O(z10));
  nand2  g24(.a(x13), .b(new_n49_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x03), .O(new_n59_));
  oai21  g26(.a(new_n58_), .b(new_n41_), .c(new_n59_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  nand2  g28(.a(x08), .b(new_n61_), .O(z12));
  nand2  g29(.a(x08), .b(x05), .O(new_n63_));
  oai21  g30(.a(new_n58_), .b(new_n43_), .c(new_n63_), .O(z13));
