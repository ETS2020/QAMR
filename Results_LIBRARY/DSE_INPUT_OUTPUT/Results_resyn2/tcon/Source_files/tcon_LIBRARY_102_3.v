...
module FAU ( 
  ...
  nor2   g15(.a(new_n41_), .b(new_n48_), .O(z07));
  ...
  nand2  g27(.a(new_n38_), .b(new_n52_), .O(new_n61_));
  ...
  nand2  g32(.a(new_n40_), .b(new_n52_), .O(new_n66_));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n35_), .O(z12));
  nand2  g38(.a(new_n44_), .b(new_n52_), .O(new_n72_));
  inv1   g39(.a(x05), .O(new_n73_));
  nand2  g40(.a(x08), .b(new_n73_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n72_), .c(new_n35_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z13));
  nand2  g43(.a(new_n72_), .b(x06), .O(new_n77_));
  ...
  nand2  g48(.a(new_n48_), .b(new_n52_), .O(new_n82_));
