...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x13), .O(new_n35_));
  ...
  nand2  g13(.a(new_n40_), .b(new_n46_), .O(z07));
  inv1   g14(.a(x00), .O(new_n48_));
  oai22  g15(.a(x15), .b(x13), .c(x09), .d(x08), .O(new_n49_));
