...
module FAU ( 
  ...
  nor2   g07(.a(new_n40_), .b(x08), .O(z04));
  ...
  nand2  g28(.a(new_n61_), .b(new_n40_), .O(z12));
  inv1   g29(.a(x05), .O(new_n63_));
  nand2  g30(.a(new_n40_), .b(x08), .O(new_n64_));
  oai22  g31(.a(new_n64_), .b(new_n63_), .c(new_n42_), .d(x08), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  oai22  g33(.a(new_n64_), .b(new_n66_), .c(new_n44_), .d(x08), .O(z14));
