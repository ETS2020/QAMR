...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x14), .O(new_n40_));
  ...
  nand2  g11(.a(new_n40_), .b(new_n44_), .O(z03));
  inv1   g12(.a(x13), .O(new_n46_));
  nor2   g13(.a(new_n36_), .b(new_n46_), .O(z04));
  nand2  g14(.a(x16), .b(x14), .O(new_n48_));
  inv1   g15(.a(new_n48_), .O(z05));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n40_), .O(new_n56_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n40_), .O(new_n61_));
  inv1   g28(.a(new_n61_), .O(z09));
  nand2  g29(.a(x08), .b(x02), .O(new_n63_));
  nand2  g30(.a(x11), .b(new_n54_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n40_), .O(z10));
  nand2  g32(.a(x08), .b(x03), .O(new_n66_));
  nand2  g33(.a(x12), .b(new_n54_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(z11));
  nand2  g35(.a(x08), .b(x04), .O(new_n69_));
  nand2  g36(.a(x13), .b(new_n54_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n40_), .O(z12));
  nand2  g38(.a(new_n35_), .b(x08), .O(new_n72_));
  nor2   g39(.a(new_n54_), .b(x05), .O(new_n73_));
  aoi21  g40(.a(new_n72_), .b(new_n48_), .c(new_n73_), .O(z13));
  nand2  g41(.a(x08), .b(x06), .O(new_n75_));
  nand2  g42(.a(x15), .b(new_n54_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n40_), .O(z14));
  nor2   g44(.a(new_n54_), .b(x07), .O(new_n78_));
  aoi21  g45(.a(new_n72_), .b(new_n39_), .c(new_n78_), .O(z15));
  buf    g46(.a(x16), .O(z07));
endmodule
