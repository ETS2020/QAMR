...
module FAU ( 
  ...
  oai21  g17(.a(x11), .b(new_n50_), .c(x09), .O(new_n51_));
  ...
  oai21  g25(.a(x09), .b(new_n50_), .c(x11), .O(new_n59_));
  ...
  nand2  g30(.a(new_n40_), .b(new_n50_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n37_), .O(new_n65_));
  inv1   g32(.a(new_n65_), .O(z11));
  nand2  g33(.a(x08), .b(x04), .O(new_n67_));
  nand2  g34(.a(x13), .b(new_n50_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n37_), .O(z12));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(x14), .b(new_n50_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n37_), .O(z13));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand2  g40(.a(x15), .b(new_n50_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n37_), .O(z14));
  nand2  g42(.a(x08), .b(x07), .O(new_n76_));
  nand2  g43(.a(x16), .b(new_n50_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n37_), .O(z15));
  buf    g45(.a(x11), .O(z02));
endmodule
