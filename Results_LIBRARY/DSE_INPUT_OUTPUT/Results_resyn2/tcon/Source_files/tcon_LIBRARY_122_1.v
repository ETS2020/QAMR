...
module FAU ( 
  ...
  nor2   g08(.a(new_n35_), .b(new_n40_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  nand2  g10(.a(x12), .b(new_n40_), .O(new_n44_));
  ...
  nand2  g31(.a(new_n64_), .b(z02), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n63_), .O(z10));
  nand2  g33(.a(new_n64_), .b(x12), .O(new_n67_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n44_), .O(z12));
  ...
  nand2  g50(.a(x16), .b(new_n54_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(z15));
endmodule
