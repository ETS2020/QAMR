...
module FAU ( 
  ...
  nor2   g01(.a(new_n34_), .b(x06), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nand2  g03(.a(x09), .b(x06), .O(new_n37_));
  ...
  and2   g12(.a(new_n37_), .b(x14), .O(z05));
  ...
  nand2  g24(.a(x10), .b(new_n57_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n37_), .O(z09));
  inv1   g26(.a(x02), .O(new_n60_));
  nand2  g27(.a(x08), .b(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n39_), .b(new_n57_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n37_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z10));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  nand2  g32(.a(x12), .b(new_n57_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n37_), .O(z11));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand2  g35(.a(x13), .b(new_n57_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n37_), .O(z12));
  nand2  g37(.a(x08), .b(x05), .O(new_n71_));
  nand2  g38(.a(x14), .b(new_n57_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n37_), .O(z13));
  nand2  g40(.a(new_n47_), .b(new_n57_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n52_), .c(new_n37_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z14));
  inv1   g43(.a(x07), .O(new_n77_));
  nand2  g44(.a(x08), .b(new_n77_), .O(new_n78_));
  nand2  g45(.a(new_n49_), .b(new_n57_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n37_), .O(new_n80_));
