...
module FAU ( 
  ...
  nand2  g09(.a(new_n37_), .b(new_n42_), .O(z05));
  inv1   g10(.a(x15), .O(new_n44_));
  nand2  g11(.a(new_n37_), .b(new_n44_), .O(z06));
  inv1   g12(.a(x16), .O(new_n46_));
  nand2  g13(.a(new_n37_), .b(new_n46_), .O(z07));
  inv1   g14(.a(x08), .O(new_n48_));
  oai21  g15(.a(x11), .b(new_n48_), .c(x09), .O(new_n49_));
  ...
  oai21  g21(.a(x09), .b(new_n48_), .c(x11), .O(new_n55_));
  ...
  nand2  g32(.a(new_n42_), .b(new_n48_), .O(new_n66_));
  ...
  nand2  g40(.a(new_n46_), .b(new_n48_), .O(new_n74_));
