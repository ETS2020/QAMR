...
module FAU ( 
  ...
  nand2  g13(.a(x16), .b(new_n46_), .O(new_n47_));
  inv1   g14(.a(new_n47_), .O(z07));
  inv1   g15(.a(x00), .O(new_n49_));
  nor2   g16(.a(x09), .b(x08), .O(new_n50_));
  nor2   g17(.a(x16), .b(new_n46_), .O(new_n51_));
  aoi21  g18(.a(new_n51_), .b(new_n49_), .c(new_n50_), .O(z08));
  ...
  aoi21  g37(.a(new_n51_), .b(new_n69_), .c(new_n70_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai21  g39(.a(new_n64_), .b(new_n72_), .c(new_n47_), .O(z15));
endmodule
