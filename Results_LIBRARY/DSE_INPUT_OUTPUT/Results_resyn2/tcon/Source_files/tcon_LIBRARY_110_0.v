...
module FAU ( 
  ...
  nand2  g10(.a(x15), .b(new_n43_), .O(z04));
  ...
  oai22  g17(.a(x15), .b(x13), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  oai22  g20(.a(x15), .b(x13), .c(x10), .d(x08), .O(new_n54_));
  ...
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n46_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n57_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  nand2  g30(.a(x15), .b(x08), .O(new_n64_));
  aoi22  g31(.a(new_n64_), .b(new_n43_), .c(x08), .d(new_n63_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(x15), .b(x13), .c(x14), .d(x08), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand2  g36(.a(x15), .b(new_n57_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n57_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z15));
  buf    g41(.a(x15), .O(z06));
endmodule
