...
module FAU ( 
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n42_), .O(new_n59_));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n42_), .O(new_n64_));
  inv1   g31(.a(new_n64_), .O(z10));
  nand2  g32(.a(x08), .b(x03), .O(new_n66_));
  nand2  g33(.a(x12), .b(new_n53_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n42_), .O(z11));
  nand2  g35(.a(x13), .b(new_n53_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x04), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n42_), .O(z12));
  ...
  nand2  g43(.a(new_n35_), .b(new_n53_), .O(new_n77_));
  inv1   g44(.a(x06), .O(new_n78_));
  nand2  g45(.a(x08), .b(new_n78_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n77_), .c(new_n42_), .O(new_n80_));
  inv1   g47(.a(new_n80_), .O(z14));
  inv1   g48(.a(x07), .O(new_n82_));
  nand2  g49(.a(x08), .b(new_n82_), .O(new_n83_));
  nand2  g50(.a(new_n50_), .b(new_n53_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n42_), .O(new_n85_));
