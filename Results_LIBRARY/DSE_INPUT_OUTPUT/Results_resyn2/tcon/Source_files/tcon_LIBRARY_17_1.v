// Benchmark "FAU" written by ABC on Tue Aug 11 19:07:49 2020
...
module FAU ( 
  ...
  nor2   g08(.a(new_n41_), .b(x14), .O(new_n42_));
  ...
  nand2  g22(.a(new_n38_), .b(new_n51_), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n36_), .O(new_n57_));
  inv1   g24(.a(new_n57_), .O(z09));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(x11), .b(new_n51_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n36_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  nand2  g29(.a(x08), .b(new_n62_), .O(new_n63_));
  nand2  g30(.a(new_n44_), .b(new_n51_), .O(new_n64_));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n36_), .O(z12));
  aoi21  g36(.a(new_n41_), .b(x08), .c(x14), .O(new_n70_));
  nor2   g37(.a(new_n51_), .b(x05), .O(new_n71_));
  nor2   g38(.a(new_n71_), .b(new_n70_), .O(z13));
  oai21  g39(.a(new_n35_), .b(new_n51_), .c(x15), .O(new_n73_));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n73_), .O(z14));
