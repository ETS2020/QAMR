...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n39_, new_n40_, new_n42_, new_n45_, new_n47_,
  ...
  nor2   g04(.a(new_n37_), .b(x08), .O(z02));
  ...
  oai22  g35(.a(new_n60_), .b(new_n68_), .c(new_n45_), .d(x08), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(new_n60_), .b(new_n70_), .c(new_n47_), .d(x08), .O(z15));
endmodule
