...
module FAU ( 
  ...
  nand2  g40(.a(new_n35_), .b(new_n52_), .O(new_n74_));
  inv1   g41(.a(x05), .O(new_n75_));
  nand2  g42(.a(x08), .b(new_n75_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n74_), .c(new_n40_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z13));
  inv1   g45(.a(x06), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n48_), .b(new_n52_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n40_), .O(new_n82_));
  inv1   g49(.a(new_n82_), .O(z14));
  aoi21  g50(.a(new_n35_), .b(x08), .c(x16), .O(new_n84_));
  nor2   g51(.a(new_n52_), .b(x07), .O(new_n85_));
  nor2   g52(.a(new_n85_), .b(new_n84_), .O(z15));
  buf    g53(.a(x14), .O(z05));
  buf    g54(.a(x16), .O(z07));
endmodule
