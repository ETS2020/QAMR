...
module FAU ( 
  ...
  nand2  g01(.a(x15), .b(x03), .O(new_n35_));
  ...
  inv1   g44(.a(x15), .O(new_n78_));
  nand2  g45(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  inv1   g46(.a(x06), .O(new_n80_));
  nand2  g47(.a(x08), .b(new_n80_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n79_), .c(new_n35_), .O(new_n82_));
  inv1   g49(.a(new_n82_), .O(z14));
  inv1   g50(.a(x07), .O(new_n84_));
  nand2  g51(.a(x08), .b(new_n84_), .O(new_n85_));
  nand2  g52(.a(new_n47_), .b(new_n51_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n85_), .c(new_n35_), .O(new_n87_));
