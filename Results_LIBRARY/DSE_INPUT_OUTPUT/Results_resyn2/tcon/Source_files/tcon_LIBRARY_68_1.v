...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n61_, new_n63_, new_n66_, new_n67_;
  ...
  aoi22  g26(.a(new_n51_), .b(new_n42_), .c(x08), .d(new_n59_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  aoi22  g28(.a(new_n51_), .b(new_n44_), .c(x08), .d(new_n61_), .O(z12));
  inv1   g29(.a(x05), .O(new_n63_));
  aoi22  g30(.a(new_n51_), .b(new_n46_), .c(x08), .d(new_n63_), .O(z13));
  and2   g31(.a(x08), .b(x06), .O(z14));
