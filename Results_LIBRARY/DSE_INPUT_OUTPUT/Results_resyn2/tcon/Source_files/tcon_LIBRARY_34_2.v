...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n45_, new_n46_, new_n48_, new_n50_, new_n52_, new_n54_, new_n55_,
  ...
  nor2   g12(.a(x11), .b(new_n45_), .O(new_n46_));
  ...
  nor2   g19(.a(new_n46_), .b(new_n52_), .O(z07));
  ...
  nor2   g26(.a(new_n45_), .b(x02), .O(new_n60_));
  ...
  oai22  g39(.a(new_n55_), .b(new_n72_), .c(new_n52_), .d(x08), .O(z15));
endmodule
