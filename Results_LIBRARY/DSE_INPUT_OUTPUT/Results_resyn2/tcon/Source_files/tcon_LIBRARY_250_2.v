...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n43_,
    ...
    new_n57_, new_n58_, new_n60_, new_n62_, new_n64_, new_n65_, new_n67_,
  ...
  nor2   g10(.a(x11), .b(new_n43_), .O(new_n44_));
  ...
  nor2   g17(.a(new_n44_), .b(new_n50_), .O(z06));
  ...
  nor2   g26(.a(new_n43_), .b(x02), .O(new_n60_));
  aoi21  g27(.a(new_n60_), .b(x11), .c(new_n40_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  oai22  g29(.a(new_n55_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z11));
  nor2   g30(.a(x13), .b(x08), .O(new_n64_));
  nor2   g31(.a(new_n55_), .b(x04), .O(new_n65_));
