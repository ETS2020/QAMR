...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(x10), .O(new_n35_));
  nor2   g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(x11), .b(new_n37_), .O(z01));
  ...
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n42_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n51_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n42_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(x12), .b(x08), .c(x11), .d(x10), .O(new_n61_));
  aoi21  g28(.a(x08), .b(new_n60_), .c(new_n61_), .O(z11));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n42_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(x15), .b(x08), .c(x11), .d(x10), .O(new_n70_));
  aoi21  g37(.a(x08), .b(new_n69_), .c(new_n70_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(x16), .b(x08), .c(x11), .d(x10), .O(new_n73_));
