...
module FAU ( 
  ...
  aoi21  g13(.a(x11), .b(x08), .c(new_n46_), .O(z07));
  ...
  nand2  g24(.a(new_n57_), .b(new_n54_), .O(z10));
  inv1   g25(.a(x03), .O(new_n59_));
  oai22  g26(.a(new_n55_), .b(new_n59_), .c(new_n39_), .d(x08), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  nor2   g28(.a(x13), .b(x08), .O(new_n62_));
  aoi21  g29(.a(new_n51_), .b(new_n61_), .c(new_n62_), .O(z12));
