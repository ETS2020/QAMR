...
module FAU ( 
  ...
  nor2   g10(.a(new_n36_), .b(new_n43_), .O(z06));
  inv1   g11(.a(x16), .O(new_n45_));
  nor2   g12(.a(new_n36_), .b(new_n45_), .O(z07));
  ...
  oai21  g24(.a(x12), .b(new_n49_), .c(x11), .O(new_n58_));
  ...
  nand2  g30(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  ...
  nand2  g41(.a(new_n43_), .b(new_n49_), .O(new_n75_));
  ...
  nand2  g46(.a(new_n45_), .b(new_n49_), .O(new_n80_));
