...
module FAU ( 
  ...
  nor2   g17(.a(x16), .b(x11), .O(new_n51_));
  ...
  nor2   g28(.a(new_n40_), .b(new_n54_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x02), .O(new_n63_));
  oai21  g30(.a(new_n62_), .b(new_n35_), .c(new_n63_), .O(z10));
  ...
  nand2  g43(.a(new_n47_), .b(new_n54_), .O(new_n77_));
