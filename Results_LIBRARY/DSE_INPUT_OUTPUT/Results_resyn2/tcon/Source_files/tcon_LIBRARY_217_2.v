...
module FAU ( 
  ...
  nand2  g14(.a(new_n35_), .b(new_n43_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nor2   g16(.a(new_n44_), .b(new_n49_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  aoi22  g19(.a(new_n35_), .b(x11), .c(x09), .d(new_n52_), .O(new_n53_));
  ...
  nand2  g26(.a(new_n43_), .b(new_n52_), .O(new_n60_));
  inv1   g27(.a(x02), .O(new_n61_));
  nand2  g28(.a(x08), .b(new_n61_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n60_), .c(new_n36_), .O(new_n63_));
  ...
  aoi22  g42(.a(new_n35_), .b(x11), .c(x14), .d(new_n52_), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(new_n75_), .O(z13));
  aoi21  g44(.a(new_n43_), .b(x08), .c(x15), .O(new_n78_));
  nor2   g45(.a(new_n52_), .b(x06), .O(new_n79_));
