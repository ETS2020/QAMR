// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:17 2020
...
module FAU ( 
  ...
  nor2   g05(.a(new_n38_), .b(new_n35_), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  nor2   g07(.a(new_n38_), .b(x09), .O(new_n41_));
  ...
  nor2   g14(.a(new_n41_), .b(new_n47_), .O(z06));
  ...
  oai21  g26(.a(new_n35_), .b(new_n52_), .c(x11), .O(new_n60_));
