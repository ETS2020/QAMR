...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n44_,
    new_n46_, new_n50_, new_n51_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  nor2   g08(.a(new_n41_), .b(x08), .O(z03));
