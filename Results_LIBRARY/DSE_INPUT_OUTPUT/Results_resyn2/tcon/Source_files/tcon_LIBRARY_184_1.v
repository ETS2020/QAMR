...
module FAU ( 
  ...
  aoi22  g33(.a(new_n66_), .b(new_n44_), .c(x08), .d(new_n65_), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  aoi22  g35(.a(new_n66_), .b(new_n46_), .c(x08), .d(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  aoi22  g37(.a(new_n66_), .b(new_n48_), .c(x08), .d(new_n70_), .O(z15));
  buf    g38(.a(x13), .O(z04));
endmodule
