...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n44_, new_n48_,
  ...
  nand2  g21(.a(new_n35_), .b(x08), .O(new_n55_));
  nand3  g22(.a(new_n42_), .b(x10), .c(new_n50_), .O(new_n56_));
  oai21  g23(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  aoi22  g25(.a(x13), .b(x10), .c(x11), .d(new_n50_), .O(new_n59_));
  ...
  nand3  g31(.a(x13), .b(new_n37_), .c(new_n50_), .O(new_n65_));
  oai21  g32(.a(new_n55_), .b(new_n64_), .c(new_n65_), .O(z12));
