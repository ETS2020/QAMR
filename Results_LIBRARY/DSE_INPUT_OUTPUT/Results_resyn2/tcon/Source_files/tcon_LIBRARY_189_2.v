...
module FAU ( 
  ...
  nor2   g08(.a(x11), .b(x08), .O(new_n42_));
  inv1   g09(.a(new_n42_), .O(z02));
  ...
  nor2   g26(.a(new_n35_), .b(x02), .O(new_n60_));
  aoi21  g27(.a(new_n60_), .b(x11), .c(new_n42_), .O(z10));
  ...
  oai22  g34(.a(new_n55_), .b(new_n67_), .c(new_n48_), .d(x08), .O(z13));
