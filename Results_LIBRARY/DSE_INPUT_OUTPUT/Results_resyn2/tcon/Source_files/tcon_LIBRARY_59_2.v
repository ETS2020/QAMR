...
module FAU ( 
  ...
  nand2  g11(.a(new_n40_), .b(x02), .O(new_n45_));
  ...
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n45_), .O(new_n57_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z09));
  oai21  g30(.a(new_n40_), .b(x08), .c(new_n35_), .O(z10));
  inv1   g31(.a(x03), .O(new_n65_));
  nand2  g32(.a(x08), .b(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n42_), .b(new_n55_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(new_n68_));
  inv1   g35(.a(new_n68_), .O(z11));
  nand2  g36(.a(x08), .b(x04), .O(new_n70_));
  nand2  g37(.a(x13), .b(new_n55_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n45_), .O(z12));
