...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n46_, new_n49_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  inv1   g43(.a(new_n76_), .O(z12));
  nand2  g44(.a(x08), .b(x05), .O(new_n78_));
  nand2  g45(.a(x14), .b(new_n54_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n40_), .O(z13));
  inv1   g47(.a(x06), .O(new_n81_));
  nand2  g48(.a(x08), .b(new_n81_), .O(new_n82_));
  nand2  g49(.a(new_n49_), .b(new_n54_), .O(new_n83_));
  ...
  nand2  g54(.a(x08), .b(new_n87_), .O(new_n88_));
  nand3  g55(.a(new_n88_), .b(new_n86_), .c(new_n40_), .O(new_n89_));
  inv1   g56(.a(new_n89_), .O(z15));
endmodule
