...
module FAU ( 
  ...
  nor2   g06(.a(new_n39_), .b(x00), .O(new_n40_));
  ...
  nand2  g42(.a(new_n48_), .b(new_n52_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n36_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z13));
  nand2  g45(.a(new_n39_), .b(new_n52_), .O(new_n79_));
  ...
  nand2  g52(.a(new_n50_), .b(new_n52_), .O(new_n86_));
