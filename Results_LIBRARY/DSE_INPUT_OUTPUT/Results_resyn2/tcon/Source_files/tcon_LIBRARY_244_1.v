...
module FAU ( 
  ...
  aoi21  g04(.a(x12), .b(new_n34_), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  aoi21  g06(.a(x12), .b(new_n34_), .c(new_n39_), .O(z02));
  inv1   g07(.a(x13), .O(new_n41_));
  nand2  g08(.a(x12), .b(new_n34_), .O(new_n42_));
  nand2  g09(.a(new_n42_), .b(new_n41_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  aoi21  g11(.a(x12), .b(new_n34_), .c(new_n44_), .O(z05));
  ...
  nand2  g30(.a(new_n51_), .b(x14), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  aoi22  g33(.a(new_n51_), .b(new_n46_), .c(x08), .d(new_n66_), .O(z14));
