...
module FAU ( 
  ...
  nand2  g09(.a(new_n40_), .b(x11), .O(new_n43_));
  ...
  nand2  g31(.a(new_n42_), .b(new_n52_), .O(new_n65_));
  ...
  nand2  g40(.a(x14), .b(new_n52_), .O(new_n74_));
