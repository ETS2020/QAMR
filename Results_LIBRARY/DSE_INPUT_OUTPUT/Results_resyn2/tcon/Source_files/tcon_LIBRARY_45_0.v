...
module FAU ( 
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n37_), .O(z15));
  buf    g40(.a(x13), .O(z04));
  buf    g41(.a(x15), .O(z06));
endmodule
