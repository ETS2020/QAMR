...
module FAU ( 
  ...
  nand2  g23(.a(x13), .b(x08), .O(new_n57_));
  ...
  aoi21  g29(.a(new_n54_), .b(new_n61_), .c(new_n62_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  aoi21  g31(.a(x08), .b(new_n64_), .c(new_n35_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(new_n57_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z13));
  ...
  oai22  g38(.a(new_n57_), .b(new_n71_), .c(new_n50_), .d(x08), .O(z15));
endmodule
