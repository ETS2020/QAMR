...
module FAU ( 
  ...
  nand2  g23(.a(new_n38_), .b(new_n52_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n40_), .O(new_n58_));
  ...
  nand2  g31(.a(new_n35_), .b(new_n52_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n40_), .O(new_n66_));
  inv1   g33(.a(new_n66_), .O(z11));
  inv1   g34(.a(x04), .O(new_n68_));
  nand2  g35(.a(x08), .b(new_n68_), .O(new_n69_));
  nand2  g36(.a(new_n45_), .b(new_n52_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n40_), .O(new_n71_));
  inv1   g38(.a(new_n71_), .O(z12));
  nand2  g39(.a(x14), .b(new_n52_), .O(new_n73_));
