...
module FAU ( 
  ...
  aoi22  g22(.a(new_n51_), .b(new_n40_), .c(x08), .d(new_n55_), .O(z10));
  inv1   g23(.a(x03), .O(new_n57_));
  aoi22  g24(.a(new_n51_), .b(new_n42_), .c(x08), .d(new_n57_), .O(z11));
  ...
  aoi21  g32(.a(x08), .b(new_n65_), .c(new_n51_), .O(z14));
