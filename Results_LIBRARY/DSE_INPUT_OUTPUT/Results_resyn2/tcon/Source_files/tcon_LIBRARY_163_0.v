...
module FAU ( 
  ...
  nand3  g17(.a(new_n50_), .b(new_n48_), .c(new_n40_), .O(z08));
  inv1   g18(.a(x01), .O(new_n52_));
  oai22  g19(.a(x14), .b(x11), .c(x10), .d(x08), .O(new_n53_));
  ...
  oai22  g25(.a(x14), .b(x11), .c(x12), .d(x08), .O(new_n59_));
  aoi21  g26(.a(x08), .b(new_n58_), .c(new_n59_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  oai22  g28(.a(x14), .b(x11), .c(x13), .d(x08), .O(new_n62_));
  ...
  oai22  g34(.a(x15), .b(x08), .c(x14), .d(x11), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(x16), .b(x08), .c(x14), .d(x11), .O(new_n71_));
