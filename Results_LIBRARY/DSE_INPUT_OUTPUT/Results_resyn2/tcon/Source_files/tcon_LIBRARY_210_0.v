...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(x02), .O(new_n35_));
  ...
  nand3  g19(.a(new_n52_), .b(new_n50_), .c(new_n38_), .O(z08));
  ...
  oai22  g30(.a(x13), .b(x08), .c(x11), .d(x02), .O(new_n64_));
  aoi21  g31(.a(x08), .b(new_n63_), .c(new_n64_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n51_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n38_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(x15), .b(x08), .c(x11), .d(x02), .O(new_n70_));
  aoi21  g37(.a(x08), .b(new_n69_), .c(new_n70_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n51_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n38_), .O(z15));
  buf    g41(.a(x11), .O(z02));
endmodule
