...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n47_, new_n48_, new_n51_, new_n53_, new_n54_, new_n55_,
  ...
  nor2   g14(.a(x15), .b(new_n47_), .O(new_n48_));
  nor2   g15(.a(new_n48_), .b(new_n46_), .O(z05));
  nand2  g16(.a(new_n37_), .b(new_n47_), .O(z06));
  inv1   g17(.a(x16), .O(new_n51_));
  nor2   g18(.a(new_n48_), .b(new_n51_), .O(z07));
  nand2  g19(.a(new_n47_), .b(x08), .O(new_n53_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n38_), .O(z12));
  ...
  aoi21  g45(.a(new_n53_), .b(new_n37_), .c(new_n78_), .O(z14));
  inv1   g46(.a(x07), .O(new_n80_));
  nand2  g47(.a(x08), .b(new_n80_), .O(new_n81_));
  nand2  g48(.a(new_n51_), .b(new_n54_), .O(new_n82_));
