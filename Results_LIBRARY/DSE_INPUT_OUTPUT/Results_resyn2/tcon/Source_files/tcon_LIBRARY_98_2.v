...
module FAU ( 
  ...
  aoi22  g22(.a(new_n51_), .b(new_n55_), .c(new_n40_), .d(new_n35_), .O(z10));
  inv1   g23(.a(x03), .O(new_n57_));
  nand2  g24(.a(x13), .b(x08), .O(new_n58_));
  oai22  g25(.a(new_n58_), .b(new_n57_), .c(new_n42_), .d(x08), .O(z11));
  ...
  oai22  g30(.a(new_n58_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z13));
