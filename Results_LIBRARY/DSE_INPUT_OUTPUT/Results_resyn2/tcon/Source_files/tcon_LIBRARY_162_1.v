...
module FAU ( 
  ...
  aoi21  g25(.a(x08), .b(new_n58_), .c(new_n52_), .O(z11));
  ...
  aoi22  g32(.a(new_n52_), .b(new_n47_), .c(x08), .d(new_n65_), .O(z14));
  inv1   g33(.a(x07), .O(new_n67_));
  aoi22  g34(.a(new_n52_), .b(new_n49_), .c(x08), .d(new_n67_), .O(z15));
endmodule
