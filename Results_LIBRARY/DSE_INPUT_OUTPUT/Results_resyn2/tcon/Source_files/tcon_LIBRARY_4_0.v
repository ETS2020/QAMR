...
module FAU ( 
  ...
  nand2  g23(.a(x09), .b(new_n52_), .O(new_n57_));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  oai21  g25(.a(new_n57_), .b(new_n37_), .c(new_n58_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  oai21  g27(.a(new_n57_), .b(new_n39_), .c(new_n60_), .O(z11));
  nor2   g28(.a(new_n52_), .b(x04), .O(new_n62_));
  aoi21  g29(.a(new_n55_), .b(new_n42_), .c(new_n62_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  oai21  g31(.a(new_n57_), .b(new_n44_), .c(new_n64_), .O(z13));
  nor2   g32(.a(new_n52_), .b(x06), .O(new_n66_));
