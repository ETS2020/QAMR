...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(new_n39_), .O(z02));
  ...
  nand3  g19(.a(new_n52_), .b(new_n50_), .c(new_n49_), .O(z08));
  inv1   g20(.a(x01), .O(new_n54_));
  oai22  g21(.a(x13), .b(x11), .c(x10), .d(x08), .O(new_n55_));
