...
module FAU ( 
  ...
  nor2   g02(.a(new_n35_), .b(x00), .O(new_n36_));
  ...
  nand2  g18(.a(new_n35_), .b(new_n51_), .O(new_n52_));
  aoi22  g19(.a(new_n52_), .b(new_n50_), .c(new_n34_), .d(new_n51_), .O(z08));
  nand2  g20(.a(x16), .b(new_n50_), .O(new_n54_));
  inv1   g21(.a(x01), .O(new_n55_));
  nand2  g22(.a(x08), .b(new_n55_), .O(new_n56_));
  nand2  g23(.a(new_n38_), .b(new_n51_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(new_n58_));
