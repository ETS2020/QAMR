...
module FAU ( 
  ...
  nand2  g11(.a(new_n38_), .b(new_n44_), .O(z06));
  ...
  oai22  g19(.a(x11), .b(x09), .c(x10), .d(x08), .O(new_n53_));
  ...
  oai22  g25(.a(x12), .b(x08), .c(x11), .d(x09), .O(new_n59_));
