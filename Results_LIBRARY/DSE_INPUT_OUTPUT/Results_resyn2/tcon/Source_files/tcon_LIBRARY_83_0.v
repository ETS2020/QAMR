...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x07), .O(z02));
  ...
  oai22  g19(.a(x11), .b(x07), .c(x09), .d(x08), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  oai22  g22(.a(x11), .b(x07), .c(x10), .d(x08), .O(new_n56_));
