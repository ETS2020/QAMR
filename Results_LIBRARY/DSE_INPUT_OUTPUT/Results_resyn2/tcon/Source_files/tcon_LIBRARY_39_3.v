...
module FAU ( 
  ...
  aoi21  g06(.a(x15), .b(x08), .c(new_n39_), .O(z03));
  ...
  aoi21  g25(.a(new_n54_), .b(new_n57_), .c(new_n58_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(new_n50_), .b(new_n60_), .c(new_n39_), .d(x08), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  nor2   g29(.a(x13), .b(x08), .O(new_n63_));
  aoi21  g30(.a(new_n54_), .b(new_n62_), .c(new_n63_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  oai22  g32(.a(new_n50_), .b(new_n65_), .c(new_n43_), .d(x08), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n45_), .O(z14));
  inv1   g35(.a(x07), .O(new_n69_));
  oai22  g36(.a(new_n50_), .b(new_n69_), .c(new_n47_), .d(x08), .O(z15));
endmodule
