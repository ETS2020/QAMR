...
module FAU ( 
  ...
  aoi22  g21(.a(new_n51_), .b(new_n38_), .c(x08), .d(new_n54_), .O(z09));
  inv1   g22(.a(x02), .O(new_n56_));
  aoi21  g23(.a(x08), .b(new_n56_), .c(new_n51_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  nand2  g25(.a(new_n51_), .b(x12), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  aoi22  g28(.a(new_n51_), .b(new_n42_), .c(x08), .d(new_n61_), .O(z12));
