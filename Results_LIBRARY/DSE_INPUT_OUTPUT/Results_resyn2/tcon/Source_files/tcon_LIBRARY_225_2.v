...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n66_, new_n68_, new_n69_, new_n71_, new_n73_;
  ...
  nand2  g14(.a(new_n47_), .b(x08), .O(new_n48_));
  ...
  nor2   g22(.a(new_n35_), .b(x01), .O(new_n56_));
  nor2   g23(.a(x10), .b(x08), .O(new_n57_));
  aoi21  g24(.a(new_n56_), .b(x10), .c(new_n57_), .O(z09));
  ...
  nor2   g35(.a(new_n53_), .b(x05), .O(new_n69_));
  nor2   g36(.a(new_n69_), .b(new_n68_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  oai22  g38(.a(new_n53_), .b(new_n71_), .c(new_n46_), .d(x08), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  oai22  g40(.a(new_n53_), .b(new_n73_), .c(new_n50_), .d(x08), .O(z15));
  buf    g41(.a(x10), .O(z01));
endmodule
