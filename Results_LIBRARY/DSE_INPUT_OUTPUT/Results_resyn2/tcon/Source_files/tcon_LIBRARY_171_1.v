...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n48_, new_n51_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  nand2  g15(.a(new_n48_), .b(new_n35_), .O(z06));
  nor2   g16(.a(new_n48_), .b(new_n35_), .O(z07));
  ...
  nand2  g41(.a(x15), .b(x08), .O(new_n75_));
  nand2  g42(.a(new_n75_), .b(z06), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(new_n74_), .O(z14));
  nand2  g44(.a(new_n75_), .b(x16), .O(new_n78_));
