...
module FAU ( 
  ...
  nor2   g12(.a(new_n45_), .b(new_n44_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  nor2   g14(.a(new_n45_), .b(new_n47_), .O(z06));
  ...
  nand2  g28(.a(new_n39_), .b(new_n51_), .O(new_n62_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n78_), .c(new_n35_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  inv1   g49(.a(x07), .O(new_n83_));
  nand2  g50(.a(x08), .b(new_n83_), .O(new_n84_));
  inv1   g51(.a(x16), .O(new_n85_));
  nand2  g52(.a(new_n85_), .b(new_n51_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n84_), .c(new_n35_), .O(new_n87_));
  inv1   g54(.a(new_n87_), .O(z15));
  buf    g55(.a(x16), .O(z07));
endmodule
