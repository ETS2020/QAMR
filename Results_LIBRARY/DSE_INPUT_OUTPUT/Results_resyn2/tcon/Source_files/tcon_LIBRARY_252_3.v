// Benchmark "FAU" written by ABC on Tue Aug 11 19:09:36 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n40_, new_n42_, new_n45_, new_n46_, new_n47_,
  ...
  nor2   g14(.a(x16), .b(new_n47_), .O(new_n48_));
  aoi21  g15(.a(new_n48_), .b(new_n45_), .c(new_n46_), .O(z08));
  inv1   g16(.a(x01), .O(new_n50_));
  nor2   g17(.a(x10), .b(x08), .O(new_n51_));
  aoi21  g18(.a(new_n48_), .b(new_n50_), .c(new_n51_), .O(z09));
  inv1   g19(.a(x02), .O(new_n53_));
  nor2   g20(.a(x11), .b(x08), .O(new_n54_));
  aoi21  g21(.a(new_n48_), .b(new_n53_), .c(new_n54_), .O(z10));
  inv1   g22(.a(x03), .O(new_n56_));
  nor2   g23(.a(x12), .b(x08), .O(new_n57_));
  aoi21  g24(.a(new_n48_), .b(new_n56_), .c(new_n57_), .O(z11));
  inv1   g25(.a(x04), .O(new_n59_));
  nor2   g26(.a(x13), .b(x08), .O(new_n60_));
  aoi21  g27(.a(new_n48_), .b(new_n59_), .c(new_n60_), .O(z12));
  inv1   g28(.a(x05), .O(new_n62_));
  inv1   g29(.a(x16), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(x08), .O(new_n64_));
  oai22  g31(.a(new_n64_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  nor2   g33(.a(x15), .b(x08), .O(new_n67_));
  aoi21  g34(.a(new_n48_), .b(new_n66_), .c(new_n67_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n63_), .O(z15));
  buf    g37(.a(x16), .O(z07));
endmodule
