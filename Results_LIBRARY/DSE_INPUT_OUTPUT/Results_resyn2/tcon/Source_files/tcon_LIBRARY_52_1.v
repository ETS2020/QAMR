...
module FAU ( 
  ...
  nand2  g19(.a(new_n39_), .b(new_n52_), .O(new_n53_));
  aoi22  g20(.a(new_n53_), .b(new_n35_), .c(new_n34_), .d(new_n52_), .O(z08));
  ...
  nand3  g41(.a(new_n74_), .b(new_n53_), .c(new_n36_), .O(new_n75_));
  ...
  nand2  g50(.a(new_n50_), .b(new_n52_), .O(new_n84_));
