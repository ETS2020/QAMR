...
module FAU ( 
  ...
  nand2  g35(.a(new_n41_), .b(new_n53_), .O(new_n69_));
  aoi22  g36(.a(new_n69_), .b(new_n35_), .c(new_n46_), .d(new_n53_), .O(z12));
  ...
  nand2  g42(.a(new_n50_), .b(new_n53_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n36_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z14));
  oai21  g45(.a(new_n53_), .b(new_n35_), .c(x16), .O(new_n79_));
