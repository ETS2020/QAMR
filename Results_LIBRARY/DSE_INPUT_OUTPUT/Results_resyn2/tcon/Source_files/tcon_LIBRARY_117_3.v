...
module FAU ( 
  ...
  nor2   g06(.a(x16), .b(new_n39_), .O(z02));
  ...
  oai21  g24(.a(x16), .b(new_n50_), .c(x11), .O(new_n58_));
  ...
  nand2  g29(.a(new_n41_), .b(new_n50_), .O(new_n63_));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n34_), .O(new_n69_));
  ...
  oai21  g47(.a(x11), .b(new_n50_), .c(x16), .O(new_n81_));
