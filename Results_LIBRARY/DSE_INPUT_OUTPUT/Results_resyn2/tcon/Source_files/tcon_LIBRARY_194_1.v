...
module FAU ( 
  ...
  aoi21  g24(.a(new_n40_), .b(x08), .c(x11), .O(new_n58_));
  nor2   g25(.a(new_n51_), .b(x02), .O(new_n59_));
  ...
  oai21  g36(.a(new_n35_), .b(new_n51_), .c(x15), .O(new_n70_));
  ...
  nand2  g41(.a(new_n47_), .b(new_n51_), .O(new_n75_));
