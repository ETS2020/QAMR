// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:44 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n43_, new_n44_,
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n44_), .O(z08));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand2  g23(.a(x10), .b(x08), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(z01), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n56_), .O(z09));
  nand2  g26(.a(new_n57_), .b(x11), .O(new_n60_));
  ...
  nand2  g31(.a(new_n41_), .b(new_n53_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(new_n66_));
  inv1   g33(.a(new_n66_), .O(z11));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand2  g35(.a(x13), .b(new_n53_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(z12));
  nand2  g37(.a(x08), .b(x05), .O(new_n71_));
  nand2  g38(.a(x14), .b(new_n53_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n44_), .O(z13));
  inv1   g40(.a(x06), .O(new_n74_));
  nand2  g41(.a(x08), .b(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n48_), .b(new_n53_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n44_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z14));
  inv1   g45(.a(x07), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n50_), .b(new_n53_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n44_), .O(new_n82_));
