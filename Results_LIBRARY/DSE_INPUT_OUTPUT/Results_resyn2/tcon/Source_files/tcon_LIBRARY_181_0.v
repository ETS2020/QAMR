...
module FAU ( 
  ...
  oai22  g15(.a(x16), .b(x15), .c(x09), .d(x08), .O(new_n49_));
  aoi21  g16(.a(x08), .b(new_n48_), .c(new_n49_), .O(z08));
  inv1   g17(.a(x01), .O(new_n51_));
  oai22  g18(.a(x16), .b(x15), .c(x10), .d(x08), .O(new_n52_));
  ...
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n36_), .O(z10));
  ...
  oai22  g28(.a(x16), .b(x15), .c(x13), .d(x08), .O(new_n62_));
  aoi21  g29(.a(x08), .b(new_n61_), .c(new_n62_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand2  g31(.a(x14), .b(new_n55_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n36_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  aoi21  g34(.a(x16), .b(x08), .c(x15), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  aoi21  g37(.a(x15), .b(x08), .c(x16), .O(new_n71_));
