...
module FAU ( 
  ...
  nand2  g16(.a(new_n49_), .b(x00), .O(new_n50_));
  nand2  g17(.a(x09), .b(new_n47_), .O(new_n51_));
  nand2  g18(.a(new_n51_), .b(new_n50_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  nand2  g20(.a(x08), .b(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n36_), .b(new_n47_), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n37_), .O(new_n56_));
  inv1   g23(.a(new_n56_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n47_), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n37_), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand2  g28(.a(x12), .b(new_n47_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n37_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  nand2  g31(.a(x08), .b(new_n64_), .O(new_n65_));
  nand2  g32(.a(new_n42_), .b(new_n47_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n37_), .O(new_n67_));
  inv1   g34(.a(new_n67_), .O(z12));
  inv1   g35(.a(x05), .O(new_n69_));
  nand2  g36(.a(x08), .b(new_n69_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n49_), .c(new_n37_), .O(new_n71_));
  inv1   g38(.a(new_n71_), .O(z13));
  inv1   g39(.a(x06), .O(new_n73_));
  nand2  g40(.a(x08), .b(new_n73_), .O(new_n74_));
  nand2  g41(.a(new_n44_), .b(new_n47_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n37_), .O(new_n76_));
  inv1   g43(.a(new_n76_), .O(z14));
  nand2  g44(.a(x08), .b(x07), .O(new_n78_));
  nand2  g45(.a(x16), .b(new_n47_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n37_), .O(z15));
  buf    g47(.a(x14), .O(z05));
endmodule
