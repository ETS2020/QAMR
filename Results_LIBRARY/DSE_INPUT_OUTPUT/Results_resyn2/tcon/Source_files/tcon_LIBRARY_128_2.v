...
module FAU ( 
  ...
  nand2  g25(.a(x16), .b(new_n55_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(x01), .O(new_n60_));
  nand2  g27(.a(x10), .b(new_n55_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z09));
  inv1   g29(.a(x02), .O(new_n63_));
  nand2  g30(.a(x08), .b(new_n63_), .O(new_n64_));
  nand2  g31(.a(new_n40_), .b(new_n55_), .O(new_n65_));
