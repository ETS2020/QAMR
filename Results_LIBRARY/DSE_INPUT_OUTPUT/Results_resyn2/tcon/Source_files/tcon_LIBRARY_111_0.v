...
module FAU ( 
  ...
  oai22  g17(.a(x13), .b(x02), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  oai22  g20(.a(x13), .b(x02), .c(x10), .d(x08), .O(new_n54_));
  ...
  oai22  g27(.a(x13), .b(x02), .c(x12), .d(x08), .O(new_n61_));
