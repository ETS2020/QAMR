...
module FAU ( 
  ...
  nand2  g17(.a(new_n35_), .b(new_n34_), .O(z07));
  nand3  g18(.a(new_n45_), .b(x08), .c(x00), .O(new_n52_));
  inv1   g19(.a(x08), .O(new_n53_));
  nand3  g20(.a(x16), .b(x09), .c(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z08));
  nand3  g22(.a(new_n45_), .b(x08), .c(x01), .O(new_n56_));
  nand3  g23(.a(new_n45_), .b(x10), .c(new_n53_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z09));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(x11), .b(new_n53_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n45_), .O(z10));
  ...
  aoi22  g34(.a(new_n35_), .b(x09), .c(x13), .d(new_n53_), .O(new_n68_));
