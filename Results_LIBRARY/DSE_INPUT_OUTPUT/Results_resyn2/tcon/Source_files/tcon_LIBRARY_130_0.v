...
module FAU ( 
  ...
  aoi22  g20(.a(new_n53_), .b(x15), .c(x08), .d(new_n52_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  nor2   g22(.a(x10), .b(x08), .O(new_n56_));
  aoi22  g23(.a(new_n56_), .b(x15), .c(x08), .d(new_n55_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  inv1   g25(.a(x08), .O(new_n59_));
  nand2  g26(.a(x15), .b(new_n59_), .O(new_n60_));
  oai21  g27(.a(new_n60_), .b(new_n40_), .c(new_n58_), .O(z10));
  nor2   g28(.a(new_n48_), .b(x08), .O(new_n62_));
  nor2   g29(.a(new_n59_), .b(x03), .O(new_n63_));
  aoi21  g30(.a(new_n62_), .b(new_n42_), .c(new_n63_), .O(z11));
  nor2   g31(.a(new_n59_), .b(x04), .O(new_n65_));
  aoi21  g32(.a(new_n62_), .b(new_n44_), .c(new_n65_), .O(z12));
  nor2   g33(.a(new_n59_), .b(x05), .O(new_n67_));
  aoi21  g34(.a(new_n62_), .b(new_n46_), .c(new_n67_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  nand2  g36(.a(x08), .b(new_n69_), .O(z14));
  nor2   g37(.a(new_n59_), .b(x07), .O(new_n71_));
  aoi21  g38(.a(new_n62_), .b(new_n50_), .c(new_n71_), .O(z15));
endmodule
