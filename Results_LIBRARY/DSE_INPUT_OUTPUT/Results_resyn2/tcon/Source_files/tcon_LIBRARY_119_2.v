...
module FAU ( 
  ...
  oai22  g24(.a(new_n55_), .b(new_n57_), .c(new_n38_), .d(x08), .O(z09));
  nor2   g25(.a(x11), .b(x08), .O(new_n59_));
  nor2   g26(.a(new_n55_), .b(x02), .O(new_n60_));
  nor2   g27(.a(new_n60_), .b(new_n59_), .O(z10));
  nor2   g28(.a(new_n39_), .b(x03), .O(new_n62_));
  aoi21  g29(.a(new_n62_), .b(x12), .c(new_n44_), .O(z11));
  ...
  nor2   g38(.a(new_n55_), .b(x07), .O(new_n72_));
