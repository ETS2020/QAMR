...
module FAU ( 
  ...
  nor2   g07(.a(new_n35_), .b(x06), .O(new_n41_));
  ...
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n38_), .O(z11));
  ...
  nand2  g40(.a(new_n35_), .b(new_n53_), .O(new_n74_));
  aoi22  g41(.a(new_n74_), .b(new_n34_), .c(new_n49_), .d(new_n53_), .O(z14));
  inv1   g42(.a(x07), .O(new_n76_));
  nand2  g43(.a(x08), .b(new_n76_), .O(new_n77_));
  nand2  g44(.a(new_n51_), .b(new_n53_), .O(new_n78_));
