...
module FAU ( 
  ...
  nor2   g01(.a(x14), .b(x04), .O(new_n35_));
  ...
  oai22  g17(.a(x14), .b(x04), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  oai22  g20(.a(x14), .b(x04), .c(x10), .d(x08), .O(new_n54_));
  aoi21  g21(.a(x08), .b(new_n53_), .c(new_n54_), .O(z09));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  inv1   g23(.a(x08), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n57_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n38_), .O(z10));
  ...
  nand2  g31(.a(x14), .b(new_n57_), .O(new_n65_));
  aoi21  g32(.a(new_n65_), .b(new_n63_), .c(new_n64_), .O(z12));
  inv1   g33(.a(x05), .O(new_n67_));
  aoi21  g34(.a(x08), .b(x04), .c(x14), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  oai22  g37(.a(x15), .b(x08), .c(x14), .d(x04), .O(new_n71_));
  aoi21  g38(.a(x08), .b(new_n70_), .c(new_n71_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  oai22  g40(.a(x16), .b(x08), .c(x14), .d(x04), .O(new_n74_));
