...
module FAU ( 
  ...
  nand2  g20(.a(new_n38_), .b(new_n49_), .O(new_n54_));
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n36_), .O(new_n55_));
  inv1   g22(.a(new_n55_), .O(z09));
  inv1   g23(.a(x15), .O(new_n57_));
  aoi21  g24(.a(new_n57_), .b(x08), .c(x11), .O(new_n58_));
  ...
  nand2  g38(.a(new_n57_), .b(new_n49_), .O(new_n72_));
