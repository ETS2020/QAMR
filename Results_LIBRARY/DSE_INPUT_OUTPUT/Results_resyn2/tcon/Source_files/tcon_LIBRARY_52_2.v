...
module FAU ( 
  ...
  nand2  g19(.a(x08), .b(new_n39_), .O(new_n53_));
  ...
  aoi21  g43(.a(new_n53_), .b(new_n35_), .c(new_n76_), .O(z13));
  inv1   g44(.a(x06), .O(new_n78_));
  nand2  g45(.a(x08), .b(new_n78_), .O(new_n79_));
  nand2  g46(.a(new_n49_), .b(new_n54_), .O(new_n80_));
  ...
  nand2  g51(.a(new_n51_), .b(new_n54_), .O(new_n85_));
