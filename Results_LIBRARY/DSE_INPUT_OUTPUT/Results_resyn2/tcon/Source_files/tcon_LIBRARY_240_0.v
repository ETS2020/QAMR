...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n44_,
    ...
    new_n66_, new_n68_, new_n69_, new_n71_, new_n73_, new_n74_;
  ...
  oai22  g17(.a(x15), .b(x10), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  nand2  g19(.a(x08), .b(x01), .O(new_n53_));
  inv1   g20(.a(x15), .O(new_n54_));
  nand2  g21(.a(x10), .b(x08), .O(new_n55_));
  oai21  g22(.a(new_n54_), .b(x10), .c(new_n55_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n53_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  inv1   g25(.a(x08), .O(new_n59_));
  nand2  g26(.a(x11), .b(new_n59_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n58_), .c(new_n40_), .O(z10));
  ...
  oai22  g32(.a(x15), .b(x10), .c(x13), .d(x08), .O(new_n66_));
  aoi21  g33(.a(x08), .b(new_n65_), .c(new_n66_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(x15), .b(x10), .c(x14), .d(x08), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  aoi22  g38(.a(new_n55_), .b(new_n54_), .c(x08), .d(new_n71_), .O(z14));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand2  g40(.a(x16), .b(new_n59_), .O(new_n74_));
