...
module FAU ( 
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n40_), .O(new_n55_));
  ...
  nand2  g33(.a(new_n35_), .b(new_n53_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(new_n68_));
  inv1   g35(.a(new_n68_), .O(z11));
  nand2  g36(.a(x08), .b(x04), .O(new_n70_));
  nand2  g37(.a(x13), .b(new_n53_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n40_), .O(z12));
  ...
  nand2  g49(.a(new_n49_), .b(new_n53_), .O(new_n83_));
