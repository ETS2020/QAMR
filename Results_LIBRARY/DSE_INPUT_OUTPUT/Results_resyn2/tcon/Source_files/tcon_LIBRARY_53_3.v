...
module FAU ( 
  ...
  oai22  g27(.a(new_n50_), .b(new_n60_), .c(new_n40_), .d(x08), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  oai22  g29(.a(new_n50_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  oai22  g31(.a(new_n50_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n53_), .O(new_n67_));
  oai21  g34(.a(new_n50_), .b(new_n66_), .c(new_n67_), .O(z14));
