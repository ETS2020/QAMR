...
module FAU ( 
  ...
  nand2  g00(.a(x11), .b(x09), .O(new_n34_));
  inv1   g01(.a(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  inv1   g03(.a(x09), .O(new_n37_));
  nor2   g04(.a(x11), .b(new_n37_), .O(new_n38_));
  nor2   g05(.a(new_n38_), .b(new_n36_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n37_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  nand2  g09(.a(new_n40_), .b(x09), .O(new_n43_));
  ...
  nand2  g19(.a(new_n37_), .b(x08), .O(new_n53_));
  inv1   g20(.a(x08), .O(new_n54_));
  nor2   g21(.a(new_n54_), .b(x00), .O(new_n55_));
  aoi21  g22(.a(new_n53_), .b(new_n34_), .c(new_n55_), .O(z08));
  nand3  g23(.a(new_n43_), .b(x08), .c(x01), .O(new_n57_));
  nand3  g24(.a(new_n43_), .b(x10), .c(new_n54_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z09));
  nor2   g26(.a(new_n54_), .b(x02), .O(new_n60_));
  aoi21  g27(.a(new_n53_), .b(new_n40_), .c(new_n60_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  aoi22  g29(.a(x12), .b(new_n54_), .c(new_n40_), .d(x09), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  nand2  g32(.a(x08), .b(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n45_), .b(new_n54_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n43_), .O(new_n68_));
  inv1   g35(.a(new_n68_), .O(z12));
  inv1   g36(.a(x05), .O(new_n70_));
  nand2  g37(.a(x08), .b(new_n70_), .O(new_n71_));
  nand2  g38(.a(new_n47_), .b(new_n54_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n43_), .O(new_n73_));
  inv1   g40(.a(new_n73_), .O(z13));
  nand2  g41(.a(x08), .b(x06), .O(new_n75_));
  nand2  g42(.a(x15), .b(new_n54_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z14));
  nand2  g44(.a(x08), .b(x07), .O(new_n78_));
  nand2  g45(.a(x16), .b(new_n54_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n43_), .O(z15));
endmodule
