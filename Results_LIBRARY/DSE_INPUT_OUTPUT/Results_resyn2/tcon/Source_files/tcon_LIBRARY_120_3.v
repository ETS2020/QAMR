...
module FAU ( 
  ...
  oai22  g25(.a(new_n52_), .b(new_n58_), .c(new_n42_), .d(x08), .O(z11));
  inv1   g26(.a(x04), .O(new_n60_));
  inv1   g27(.a(x08), .O(new_n61_));
  nor2   g28(.a(x16), .b(new_n61_), .O(new_n62_));
  nor2   g29(.a(x13), .b(x08), .O(new_n63_));
  aoi21  g30(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(z12));
  ...
  oai22  g35(.a(new_n52_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  nand2  g37(.a(x16), .b(new_n61_), .O(new_n71_));
  oai21  g38(.a(new_n52_), .b(new_n70_), .c(new_n71_), .O(z15));
  buf    g39(.a(x16), .O(z07));
endmodule
