...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n44_, new_n45_, new_n46_,
  ...
  aoi21  g06(.a(x12), .b(x10), .c(new_n39_), .O(z04));
  and2   g07(.a(new_n35_), .b(x14), .O(z05));
  and2   g08(.a(new_n35_), .b(x15), .O(z06));
  and2   g09(.a(new_n35_), .b(x16), .O(z07));
  inv1   g10(.a(x00), .O(new_n44_));
  nand2  g11(.a(x08), .b(new_n44_), .O(new_n45_));
  inv1   g12(.a(x08), .O(new_n46_));
  nand2  g13(.a(new_n34_), .b(new_n46_), .O(new_n47_));
  nand3  g14(.a(new_n47_), .b(new_n45_), .c(new_n35_), .O(new_n48_));
  inv1   g15(.a(new_n48_), .O(z08));
  oai21  g16(.a(x12), .b(new_n46_), .c(x10), .O(new_n50_));
  ...
  oai21  g22(.a(x10), .b(new_n46_), .c(x12), .O(new_n56_));
