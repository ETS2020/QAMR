...
module FAU ( 
  ...
  nand2  g32(.a(new_n65_), .b(x03), .O(new_n66_));
  nand2  g33(.a(x12), .b(new_n54_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z11));
  ...
  nand3  g39(.a(new_n72_), .b(new_n65_), .c(new_n36_), .O(z13));
  inv1   g40(.a(x06), .O(new_n74_));
  nand2  g41(.a(x08), .b(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n49_), .b(new_n54_), .O(new_n76_));
