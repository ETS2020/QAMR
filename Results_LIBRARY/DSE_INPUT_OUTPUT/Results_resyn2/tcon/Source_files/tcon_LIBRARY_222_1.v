...
module FAU ( 
  ...
  nand2  g27(.a(new_n39_), .b(new_n54_), .O(new_n61_));
  inv1   g28(.a(x02), .O(new_n62_));
  nand2  g29(.a(x08), .b(new_n62_), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n61_), .c(new_n36_), .O(new_n64_));
  ...
  nand2  g42(.a(new_n46_), .b(new_n54_), .O(new_n76_));
  ...
  nand2  g52(.a(new_n50_), .b(new_n54_), .O(new_n86_));
