...
module FAU ( 
  ...
  nand2  g24(.a(x12), .b(x08), .O(new_n58_));
  aoi22  g25(.a(new_n58_), .b(new_n40_), .c(x08), .d(new_n57_), .O(z10));
  ...
  oai22  g30(.a(x13), .b(x08), .c(x12), .d(x11), .O(new_n64_));
  ...
  oai22  g39(.a(x16), .b(x08), .c(x12), .d(x11), .O(new_n73_));
