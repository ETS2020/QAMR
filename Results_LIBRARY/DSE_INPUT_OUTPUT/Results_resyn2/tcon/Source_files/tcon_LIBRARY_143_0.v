...
module FAU ( 
  ...
  aoi22  g20(.a(new_n53_), .b(x16), .c(x08), .d(new_n52_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  nor2   g22(.a(x10), .b(x08), .O(new_n56_));
  aoi22  g23(.a(new_n56_), .b(x16), .c(x08), .d(new_n55_), .O(z09));
  inv1   g24(.a(x02), .O(new_n58_));
  nor2   g25(.a(x11), .b(x08), .O(new_n59_));
  aoi22  g26(.a(new_n59_), .b(x16), .c(x08), .d(new_n58_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  nor2   g28(.a(x12), .b(x08), .O(new_n62_));
  aoi22  g29(.a(new_n62_), .b(x16), .c(x08), .d(new_n61_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  nor2   g31(.a(x13), .b(x08), .O(new_n65_));
  aoi22  g32(.a(new_n65_), .b(x16), .c(x08), .d(new_n64_), .O(z12));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  inv1   g34(.a(x08), .O(new_n68_));
  nand2  g35(.a(x16), .b(new_n68_), .O(new_n69_));
  oai21  g36(.a(new_n69_), .b(new_n46_), .c(new_n67_), .O(z13));
  nor2   g37(.a(new_n50_), .b(x08), .O(new_n71_));
  nor2   g38(.a(new_n68_), .b(x06), .O(new_n72_));
  aoi21  g39(.a(new_n71_), .b(new_n48_), .c(new_n72_), .O(z14));
