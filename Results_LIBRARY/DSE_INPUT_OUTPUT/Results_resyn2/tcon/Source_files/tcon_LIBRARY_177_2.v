...
module FAU ( 
  ...
  nand2  g41(.a(new_n48_), .b(new_n54_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n42_), .O(new_n76_));
  inv1   g43(.a(new_n76_), .O(z13));
  aoi21  g44(.a(x08), .b(new_n35_), .c(x15), .O(new_n78_));
  nor2   g45(.a(new_n54_), .b(x06), .O(new_n79_));
  ...
  nand3  g50(.a(new_n83_), .b(new_n82_), .c(new_n42_), .O(new_n84_));
