...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n58_, new_n60_, new_n62_, new_n63_, new_n65_, new_n68_;
  ...
  aoi21  g13(.a(x15), .b(new_n35_), .c(new_n46_), .O(z05));
  and2   g14(.a(x15), .b(x08), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  aoi21  g16(.a(x15), .b(new_n35_), .c(new_n49_), .O(z07));
  ...
  aoi22  g27(.a(new_n52_), .b(new_n42_), .c(x08), .d(new_n60_), .O(z11));
