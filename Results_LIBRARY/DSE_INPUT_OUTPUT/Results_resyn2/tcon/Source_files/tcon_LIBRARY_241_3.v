...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n40_, new_n44_, new_n46_, new_n48_,
  ...
  oai21  g21(.a(new_n49_), .b(x03), .c(x11), .O(new_n55_));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z10));
  oai21  g24(.a(x11), .b(x08), .c(x03), .O(new_n58_));
  oai21  g25(.a(new_n40_), .b(x08), .c(new_n58_), .O(z11));
  ...
  nand2  g37(.a(new_n46_), .b(new_n49_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z15));
endmodule
