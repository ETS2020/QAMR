...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x06), .O(new_n35_));
  ...
  nand3  g33(.a(new_n66_), .b(new_n64_), .c(new_n36_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(x16), .b(x06), .c(x14), .d(x08), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  nor2   g38(.a(x15), .b(x08), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n65_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n71_), .c(new_n72_), .O(z14));
