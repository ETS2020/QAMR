...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n48_, new_n50_, new_n51_, new_n53_, new_n55_, new_n57_, new_n59_,
  ...
  nand2  g17(.a(new_n40_), .b(x08), .O(new_n51_));
