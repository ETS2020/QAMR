...
module FAU ( 
  ...
  oai22  g26(.a(x14), .b(x12), .c(x11), .d(x08), .O(new_n60_));
  ...
  oai22  g32(.a(x14), .b(x12), .c(x13), .d(x08), .O(new_n66_));
  ...
  oai22  g38(.a(x15), .b(x08), .c(x14), .d(x12), .O(new_n72_));
  aoi21  g39(.a(x08), .b(new_n71_), .c(new_n72_), .O(z14));
  inv1   g40(.a(x07), .O(new_n74_));
  oai22  g41(.a(x16), .b(x08), .c(x14), .d(x12), .O(new_n75_));
