...
module FAU ( 
  ...
  aoi21  g23(.a(new_n54_), .b(new_n37_), .c(new_n56_), .O(z09));
  ...
  oai21  g28(.a(new_n60_), .b(new_n42_), .c(new_n61_), .O(z11));
  ...
  oai21  g34(.a(new_n60_), .b(new_n48_), .c(new_n67_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  oai21  g36(.a(new_n60_), .b(new_n50_), .c(new_n69_), .O(z15));
endmodule
