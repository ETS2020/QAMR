...
module FAU ( 
  ...
  nor2   g18(.a(new_n42_), .b(new_n51_), .O(z07));
  ...
  nand2  g34(.a(x08), .b(new_n41_), .O(new_n68_));
  nor2   g35(.a(new_n55_), .b(x04), .O(new_n69_));
  aoi21  g36(.a(new_n68_), .b(new_n35_), .c(new_n69_), .O(z12));
  nand2  g37(.a(new_n47_), .b(new_n55_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n68_), .c(new_n36_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z13));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand2  g41(.a(x15), .b(new_n55_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n36_), .O(z14));
  nand2  g43(.a(x08), .b(x07), .O(new_n77_));
  nand2  g44(.a(x16), .b(new_n55_), .O(new_n78_));
