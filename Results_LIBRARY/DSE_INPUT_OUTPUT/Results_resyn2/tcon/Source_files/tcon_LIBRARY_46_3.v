...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x04), .O(new_n35_));
  ...
  nor2   g17(.a(new_n50_), .b(x04), .O(z07));
  ...
  oai21  g37(.a(x16), .b(x08), .c(x04), .O(new_n71_));
  oai21  g38(.a(new_n44_), .b(x08), .c(new_n71_), .O(z12));
  inv1   g39(.a(x05), .O(new_n73_));
  nand2  g40(.a(x08), .b(new_n73_), .O(new_n74_));
  nand2  g41(.a(new_n46_), .b(new_n54_), .O(new_n75_));
  ...
  oai21  g49(.a(new_n54_), .b(x04), .c(x16), .O(new_n83_));
  nand2  g50(.a(x08), .b(x07), .O(new_n84_));
  nand2  g51(.a(new_n84_), .b(new_n83_), .O(z15));
endmodule
