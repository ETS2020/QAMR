...
module FAU ( 
  ...
  nor2   g01(.a(x13), .b(x07), .O(new_n35_));
  ...
  nand2  g11(.a(new_n44_), .b(x07), .O(z04));
  ...
  oai22  g19(.a(x13), .b(x07), .c(x09), .d(x08), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  oai22  g22(.a(x13), .b(x07), .c(x10), .d(x08), .O(new_n56_));
  aoi21  g23(.a(x08), .b(new_n55_), .c(new_n56_), .O(z09));
  inv1   g24(.a(x02), .O(new_n58_));
  oai22  g25(.a(x13), .b(x07), .c(x11), .d(x08), .O(new_n59_));
  aoi21  g26(.a(x08), .b(new_n58_), .c(new_n59_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  oai22  g28(.a(x13), .b(x07), .c(x12), .d(x08), .O(new_n62_));
  aoi21  g29(.a(x08), .b(new_n61_), .c(new_n62_), .O(z11));
  inv1   g30(.a(x08), .O(new_n64_));
  nand2  g31(.a(x13), .b(new_n64_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n42_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(x14), .b(x08), .c(x13), .d(x07), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  oai22  g38(.a(x15), .b(x08), .c(x13), .d(x07), .O(new_n72_));
  aoi21  g39(.a(x08), .b(new_n71_), .c(new_n72_), .O(z14));
  inv1   g40(.a(x07), .O(new_n74_));
  nor2   g41(.a(x16), .b(x08), .O(new_n75_));
  aoi21  g42(.a(new_n65_), .b(new_n74_), .c(new_n75_), .O(z15));
endmodule
