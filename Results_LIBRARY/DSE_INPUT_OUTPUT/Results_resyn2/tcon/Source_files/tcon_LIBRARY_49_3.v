...
module FAU ( 
  ...
  nand2  g29(.a(new_n40_), .b(new_n52_), .O(new_n63_));
  ...
  nand2  g34(.a(new_n42_), .b(new_n52_), .O(new_n68_));
  ...
  nand2  g44(.a(new_n44_), .b(new_n52_), .O(new_n78_));
  ...
  nand2  g49(.a(new_n46_), .b(new_n52_), .O(new_n83_));
  nand3  g50(.a(new_n83_), .b(new_n82_), .c(new_n35_), .O(new_n84_));
  inv1   g51(.a(new_n84_), .O(z14));
  nand2  g52(.a(new_n48_), .b(new_n52_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n72_), .c(new_n35_), .O(new_n87_));
