...
module FAU ( 
  ...
  nor2   g10(.a(x15), .b(new_n43_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nand2  g12(.a(new_n35_), .b(new_n45_), .O(z05));
  nand2  g13(.a(x15), .b(new_n43_), .O(new_n47_));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n35_), .O(z13));
  nor2   g41(.a(new_n51_), .b(x06), .O(new_n75_));
  aoi21  g42(.a(new_n68_), .b(new_n47_), .c(new_n75_), .O(z14));
