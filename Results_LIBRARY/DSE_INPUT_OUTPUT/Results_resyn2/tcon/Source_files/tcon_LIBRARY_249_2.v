...
module FAU ( 
  ...
  nor2   g07(.a(x10), .b(new_n38_), .O(new_n41_));
  ...
  aoi21  g25(.a(x08), .b(new_n38_), .c(x10), .O(new_n59_));
  nor2   g26(.a(new_n55_), .b(x01), .O(new_n60_));
  nor2   g27(.a(new_n60_), .b(new_n59_), .O(z09));
  inv1   g28(.a(x02), .O(new_n62_));
  nand2  g29(.a(x08), .b(new_n62_), .O(new_n63_));
  nand2  g30(.a(new_n40_), .b(new_n55_), .O(new_n64_));
  ...
  nand2  g35(.a(new_n43_), .b(new_n55_), .O(new_n69_));
  ...
  nand2  g40(.a(new_n45_), .b(new_n55_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n36_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z12));
  oai21  g43(.a(new_n35_), .b(x08), .c(x05), .O(new_n77_));
  nand2  g44(.a(x14), .b(new_n55_), .O(new_n78_));
  nand2  g45(.a(new_n78_), .b(new_n77_), .O(z13));
