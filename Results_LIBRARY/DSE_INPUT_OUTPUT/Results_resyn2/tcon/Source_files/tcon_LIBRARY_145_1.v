...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n47_, new_n50_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nor2   g15(.a(new_n35_), .b(new_n39_), .O(z06));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n40_), .O(new_n59_));
  inv1   g26(.a(new_n59_), .O(z09));
  inv1   g27(.a(x02), .O(new_n61_));
  nand2  g28(.a(x08), .b(new_n61_), .O(new_n62_));
  nand2  g29(.a(new_n42_), .b(new_n53_), .O(new_n63_));
  ...
  nand2  g34(.a(new_n44_), .b(new_n53_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n40_), .O(new_n69_));
  inv1   g36(.a(new_n69_), .O(z11));
  nand2  g37(.a(x08), .b(x04), .O(new_n71_));
  nand2  g38(.a(x13), .b(x08), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(z04), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n71_), .O(z12));
  nand2  g41(.a(x08), .b(x05), .O(new_n75_));
  nand2  g42(.a(x14), .b(new_n53_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n40_), .O(z13));
  nand2  g44(.a(new_n72_), .b(x15), .O(new_n78_));
