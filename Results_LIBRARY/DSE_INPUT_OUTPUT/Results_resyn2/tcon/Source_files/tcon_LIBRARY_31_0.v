...
module FAU ( 
  ...
  nand2  g08(.a(x16), .b(new_n41_), .O(z03));
  ...
  oai22  g22(.a(x16), .b(x12), .c(x10), .d(x08), .O(new_n56_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n58_), .c(new_n46_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(x12), .b(x08), .O(new_n63_));
  oai21  g30(.a(new_n50_), .b(x12), .c(new_n63_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n62_), .O(z11));
  inv1   g32(.a(x04), .O(new_n66_));
  oai22  g33(.a(x16), .b(x12), .c(x13), .d(x08), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n59_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  oai22  g39(.a(x16), .b(x12), .c(x15), .d(x08), .O(new_n73_));
  aoi21  g40(.a(x08), .b(new_n72_), .c(new_n73_), .O(z14));
  inv1   g41(.a(x07), .O(new_n75_));
  aoi22  g42(.a(new_n63_), .b(new_n50_), .c(x08), .d(new_n75_), .O(z15));
endmodule
