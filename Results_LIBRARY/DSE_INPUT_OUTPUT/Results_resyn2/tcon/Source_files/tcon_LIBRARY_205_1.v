...
module FAU ( 
  ...
  nor2   g16(.a(new_n39_), .b(new_n35_), .O(z06));
  ...
  nand2  g32(.a(new_n42_), .b(new_n55_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n36_), .O(new_n67_));
  inv1   g34(.a(new_n67_), .O(z10));
  nand2  g35(.a(x08), .b(x03), .O(new_n69_));
  nand2  g36(.a(x12), .b(new_n55_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z11));
  nand2  g38(.a(new_n39_), .b(new_n55_), .O(new_n72_));
  aoi22  g39(.a(new_n72_), .b(new_n35_), .c(new_n46_), .d(new_n55_), .O(z12));
  inv1   g40(.a(x05), .O(new_n74_));
  nand2  g41(.a(x08), .b(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n48_), .b(new_n55_), .O(new_n76_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n72_), .c(new_n36_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  nand2  g49(.a(x08), .b(x07), .O(new_n83_));
  nand2  g50(.a(x16), .b(new_n55_), .O(new_n84_));
