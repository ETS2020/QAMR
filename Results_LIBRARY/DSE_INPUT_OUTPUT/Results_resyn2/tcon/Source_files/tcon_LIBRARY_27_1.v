...
module FAU ( 
  ...
  nor2   g12(.a(new_n35_), .b(new_n39_), .O(z05));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n40_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z14));
  inv1   g45(.a(x07), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n49_), .b(new_n52_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n40_), .O(new_n82_));
