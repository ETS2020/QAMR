...
module FAU ( 
  ...
  nand2  g13(.a(new_n46_), .b(x08), .O(z05));
  ...
  nor2   g20(.a(new_n46_), .b(x08), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n34_), .c(new_n53_), .O(z08));
  nand2  g22(.a(x14), .b(new_n52_), .O(new_n56_));
  ...
  nand2  g32(.a(x08), .b(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  oai21  g34(.a(new_n56_), .b(new_n48_), .c(new_n67_), .O(z14));
