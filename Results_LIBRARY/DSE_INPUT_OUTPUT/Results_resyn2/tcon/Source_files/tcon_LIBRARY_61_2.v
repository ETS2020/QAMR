...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x08), .O(new_n44_));
  ...
  nor2   g25(.a(new_n35_), .b(x02), .O(new_n59_));
  nor2   g26(.a(x11), .b(x08), .O(new_n60_));
  aoi21  g27(.a(new_n59_), .b(x11), .c(new_n60_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  oai22  g29(.a(new_n53_), .b(new_n62_), .c(new_n40_), .d(x08), .O(z11));
  ...
  oai22  g39(.a(new_n53_), .b(new_n72_), .c(new_n50_), .d(x08), .O(z15));
  buf    g40(.a(x11), .O(z02));
endmodule
