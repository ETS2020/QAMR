// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:12 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n58_, new_n60_, new_n62_, new_n64_, new_n65_, new_n67_;
  ...
  aoi22  g29(.a(new_n51_), .b(new_n46_), .c(x08), .d(new_n62_), .O(z13));
