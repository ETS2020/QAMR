...
module FAU ( 
  ...
  aoi21  g04(.a(x15), .b(x11), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nor2   g06(.a(x15), .b(new_n39_), .O(z02));
  ...
  aoi22  g17(.a(x15), .b(x11), .c(x09), .d(new_n50_), .O(new_n51_));
  ...
  aoi22  g33(.a(x15), .b(x11), .c(x13), .d(new_n50_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  aoi22  g36(.a(x15), .b(x11), .c(x14), .d(new_n50_), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z13));
  inv1   g38(.a(x15), .O(new_n72_));
  nand3  g39(.a(new_n35_), .b(x08), .c(x06), .O(new_n73_));
  oai21  g40(.a(new_n58_), .b(new_n72_), .c(new_n73_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  aoi22  g42(.a(x16), .b(new_n50_), .c(x15), .d(x11), .O(new_n76_));
