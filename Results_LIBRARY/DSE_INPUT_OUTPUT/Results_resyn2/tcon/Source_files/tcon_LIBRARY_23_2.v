...
module FAU ( 
  ...
  nand2  g07(.a(new_n38_), .b(x05), .O(new_n41_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n41_), .O(z08));
  aoi21  g23(.a(x08), .b(new_n35_), .c(x10), .O(new_n57_));
  nor2   g24(.a(new_n54_), .b(x01), .O(new_n58_));
  ...
  nand2  g34(.a(new_n45_), .b(new_n54_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n41_), .O(new_n69_));
  inv1   g36(.a(new_n69_), .O(z12));
  oai21  g37(.a(new_n38_), .b(x08), .c(x05), .O(new_n71_));
  ...
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n41_), .O(z14));
