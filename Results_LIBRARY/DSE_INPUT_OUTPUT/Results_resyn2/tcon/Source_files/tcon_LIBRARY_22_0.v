...
module FAU ( 
  ...
  nand2  g22(.a(new_n53_), .b(x00), .O(new_n56_));
  oai21  g23(.a(new_n56_), .b(new_n38_), .c(new_n55_), .O(z09));
  nor2   g24(.a(x08), .b(new_n52_), .O(new_n58_));
  ...
  aoi21  g34(.a(new_n58_), .b(new_n48_), .c(new_n67_), .O(z14));
