...
module FAU ( 
  ...
  and2   g20(.a(x16), .b(x08), .O(new_n54_));
  ...
  nand2  g35(.a(x16), .b(x08), .O(new_n69_));
  oai22  g36(.a(new_n69_), .b(new_n68_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  nor2   g38(.a(x15), .b(x08), .O(new_n72_));
  aoi21  g39(.a(new_n54_), .b(new_n71_), .c(new_n72_), .O(z14));
  inv1   g40(.a(x07), .O(new_n74_));
  aoi21  g41(.a(x08), .b(new_n74_), .c(new_n35_), .O(z15));
endmodule
