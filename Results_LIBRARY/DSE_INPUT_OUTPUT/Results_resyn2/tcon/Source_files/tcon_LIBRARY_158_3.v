...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    ...
    new_n57_, new_n58_, new_n59_, new_n60_, new_n62_, new_n64_, new_n66_,
  ...
  nor2   g18(.a(x11), .b(new_n51_), .O(new_n52_));
  ...
  oai21  g27(.a(new_n59_), .b(new_n57_), .c(new_n60_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  oai22  g29(.a(new_n59_), .b(new_n62_), .c(new_n39_), .d(x08), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  oai22  g31(.a(new_n59_), .b(new_n64_), .c(new_n41_), .d(x08), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(new_n59_), .b(new_n66_), .c(new_n43_), .d(x08), .O(z13));
  ...
  aoi21  g38(.a(new_n52_), .b(new_n70_), .c(new_n71_), .O(z15));
  buf    g39(.a(x11), .O(z02));
endmodule
