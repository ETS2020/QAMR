...
module FAU ( 
  ...
  nor2   g11(.a(new_n36_), .b(x08), .O(z04));
  ...
  nor2   g20(.a(x13), .b(new_n35_), .O(new_n54_));
  ...
  nand2  g29(.a(new_n36_), .b(x08), .O(new_n63_));
  oai22  g30(.a(new_n63_), .b(new_n62_), .c(new_n43_), .d(x08), .O(z11));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n36_), .O(z12));
  inv1   g33(.a(x05), .O(new_n67_));
  oai22  g34(.a(new_n63_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  nor2   g36(.a(x15), .b(x08), .O(new_n70_));
  aoi21  g37(.a(new_n54_), .b(new_n69_), .c(new_n70_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  nor2   g39(.a(x16), .b(x08), .O(new_n73_));
  aoi21  g40(.a(new_n54_), .b(new_n72_), .c(new_n73_), .O(z15));
endmodule
