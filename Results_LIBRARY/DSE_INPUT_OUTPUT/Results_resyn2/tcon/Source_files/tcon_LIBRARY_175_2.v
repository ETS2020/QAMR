...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n58_, new_n60_, new_n62_, new_n64_, new_n66_, new_n67_;
  ...
  oai21  g09(.a(x16), .b(new_n35_), .c(new_n42_), .O(z03));
  ...
  and2   g17(.a(x16), .b(x08), .O(new_n51_));
  aoi22  g18(.a(new_n51_), .b(new_n50_), .c(new_n34_), .d(new_n35_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  nand2  g20(.a(x16), .b(x08), .O(new_n54_));
  oai22  g21(.a(new_n54_), .b(new_n53_), .c(new_n38_), .d(x08), .O(z09));
  inv1   g22(.a(x02), .O(new_n56_));
  aoi22  g23(.a(new_n51_), .b(new_n56_), .c(new_n40_), .d(new_n35_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  aoi22  g25(.a(new_n51_), .b(new_n58_), .c(new_n42_), .d(new_n35_), .O(z11));
  inv1   g26(.a(x04), .O(new_n60_));
  aoi22  g27(.a(new_n51_), .b(new_n60_), .c(new_n44_), .d(new_n35_), .O(z12));
  inv1   g28(.a(x05), .O(new_n62_));
  oai22  g29(.a(new_n54_), .b(new_n62_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g30(.a(x06), .O(new_n64_));
  oai22  g31(.a(new_n54_), .b(new_n64_), .c(new_n48_), .d(x08), .O(z14));
  nor2   g32(.a(new_n35_), .b(x07), .O(new_n66_));
  nor2   g33(.a(x16), .b(x08), .O(new_n67_));
  aoi21  g34(.a(new_n66_), .b(x16), .c(new_n67_), .O(z15));
  buf    g35(.a(x16), .O(z07));
endmodule
