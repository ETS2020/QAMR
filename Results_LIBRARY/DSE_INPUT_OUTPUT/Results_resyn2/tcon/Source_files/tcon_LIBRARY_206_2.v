...
module FAU ( 
  ...
  nand2  g17(.a(x10), .b(x08), .O(new_n51_));
  ...
  oai22  g22(.a(new_n51_), .b(new_n55_), .c(new_n38_), .d(x08), .O(z10));
  inv1   g23(.a(x03), .O(new_n57_));
  oai22  g24(.a(new_n51_), .b(new_n57_), .c(new_n40_), .d(x08), .O(z11));
  inv1   g25(.a(x04), .O(new_n59_));
  oai22  g26(.a(new_n51_), .b(new_n59_), .c(new_n42_), .d(x08), .O(z12));
  inv1   g27(.a(x05), .O(new_n61_));
  and2   g28(.a(x10), .b(x08), .O(new_n62_));
  nor2   g29(.a(x14), .b(x08), .O(new_n63_));
  aoi21  g30(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z13));
  inv1   g31(.a(x06), .O(new_n65_));
  oai22  g32(.a(new_n51_), .b(new_n65_), .c(new_n46_), .d(x08), .O(z14));
