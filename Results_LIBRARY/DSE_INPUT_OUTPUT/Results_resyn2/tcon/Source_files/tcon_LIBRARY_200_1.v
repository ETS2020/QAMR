...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_, new_n58_,
  ...
  aoi22  g25(.a(new_n52_), .b(new_n41_), .c(x08), .d(new_n58_), .O(z11));
  nand2  g26(.a(x08), .b(x04), .O(new_n60_));
  nand2  g27(.a(new_n52_), .b(x13), .O(new_n61_));
