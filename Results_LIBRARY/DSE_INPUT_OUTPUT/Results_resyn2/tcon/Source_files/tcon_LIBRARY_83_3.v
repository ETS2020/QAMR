...
module FAU ( 
  ...
  nand2  g01(.a(x11), .b(x07), .O(new_n35_));
  ...
  inv1   g26(.a(x07), .O(new_n60_));
  nand2  g27(.a(x08), .b(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(x11), .O(new_n62_));
  ...
  nand2  g33(.a(new_n40_), .b(new_n51_), .O(new_n67_));
  ...
  nand2  g41(.a(new_n43_), .b(new_n51_), .O(new_n75_));
  ...
  nand2  g46(.a(new_n45_), .b(new_n51_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n35_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  nand2  g49(.a(new_n47_), .b(new_n51_), .O(new_n83_));
  nand3  g50(.a(new_n83_), .b(new_n61_), .c(new_n35_), .O(new_n84_));
