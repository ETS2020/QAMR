// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:58 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n40_, new_n44_, new_n46_, new_n47_,
  ...
  aoi21  g05(.a(x16), .b(x15), .c(new_n38_), .O(z02));
  ...
  nor2   g11(.a(new_n44_), .b(x15), .O(z07));
  inv1   g12(.a(x00), .O(new_n46_));
  nand2  g13(.a(x08), .b(new_n46_), .O(new_n47_));
  inv1   g14(.a(x08), .O(new_n48_));
  nand2  g15(.a(new_n34_), .b(new_n48_), .O(new_n49_));
  nand3  g16(.a(new_n49_), .b(new_n47_), .c(new_n35_), .O(new_n50_));
  inv1   g17(.a(new_n50_), .O(z08));
  ...
  nand2  g23(.a(new_n38_), .b(new_n48_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n35_), .O(new_n58_));
  inv1   g25(.a(new_n58_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n48_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand2  g30(.a(x13), .b(new_n48_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n35_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n48_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n35_), .O(z13));
  oai21  g35(.a(x16), .b(new_n48_), .c(x15), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  oai21  g38(.a(x15), .b(new_n48_), .c(x16), .O(new_n72_));
