...
module FAU ( 
  ...
  nand2  g10(.a(x13), .b(x10), .O(new_n44_));
  ...
  nand2  g24(.a(new_n41_), .b(x08), .O(new_n58_));
  nor2   g25(.a(new_n54_), .b(x01), .O(new_n59_));
  aoi21  g26(.a(new_n58_), .b(new_n35_), .c(new_n59_), .O(z09));
  ...
  aoi21  g34(.a(new_n58_), .b(new_n44_), .c(new_n67_), .O(z12));
