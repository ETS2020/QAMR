...
module FAU ( 
  ...
  nand2  g17(.a(new_n50_), .b(x15), .O(z07));
  inv1   g18(.a(x00), .O(new_n52_));
  oai22  g19(.a(x16), .b(x15), .c(x09), .d(x08), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  oai22  g22(.a(x16), .b(x15), .c(x10), .d(x08), .O(new_n56_));
