...
module FAU ( 
  ...
  oai22  g24(.a(new_n57_), .b(new_n56_), .c(new_n36_), .d(x08), .O(z10));
  inv1   g25(.a(x03), .O(new_n59_));
  oai22  g26(.a(new_n57_), .b(new_n59_), .c(new_n38_), .d(x08), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  nor2   g28(.a(x13), .b(x08), .O(new_n62_));
  aoi21  g29(.a(new_n54_), .b(new_n61_), .c(new_n62_), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  oai22  g31(.a(new_n57_), .b(new_n64_), .c(new_n42_), .d(x08), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  oai22  g33(.a(new_n57_), .b(new_n66_), .c(new_n44_), .d(x08), .O(z14));
  inv1   g34(.a(x07), .O(new_n68_));
  oai22  g35(.a(new_n57_), .b(new_n68_), .c(new_n46_), .d(x08), .O(z15));
  buf    g36(.a(x09), .O(z00));
endmodule
