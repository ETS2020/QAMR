...
module FAU ( 
  ...
  nor2   g06(.a(x09), .b(new_n39_), .O(new_n40_));
  ...
  nor2   g18(.a(new_n39_), .b(x00), .O(new_n52_));
  nor2   g19(.a(x09), .b(x08), .O(new_n53_));
  aoi21  g20(.a(new_n52_), .b(x09), .c(new_n53_), .O(z08));
  nor2   g21(.a(x10), .b(x08), .O(new_n55_));
  nand2  g22(.a(x09), .b(x08), .O(new_n56_));
  nor2   g23(.a(new_n56_), .b(x01), .O(new_n57_));
  nor2   g24(.a(new_n57_), .b(new_n55_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  oai22  g26(.a(new_n56_), .b(new_n59_), .c(new_n38_), .d(x08), .O(z10));
  nor2   g27(.a(x12), .b(x08), .O(new_n61_));
  nor2   g28(.a(new_n56_), .b(x03), .O(new_n62_));
  nor2   g29(.a(new_n62_), .b(new_n61_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  oai22  g31(.a(new_n56_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(new_n56_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z13));
  nor2   g34(.a(x15), .b(x08), .O(new_n68_));
  nor2   g35(.a(new_n56_), .b(x06), .O(new_n69_));
  nor2   g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nor2   g37(.a(x16), .b(x08), .O(new_n71_));
  nor2   g38(.a(new_n56_), .b(x07), .O(new_n72_));
