...
module FAU ( 
  ...
  nand2  g14(.a(new_n42_), .b(new_n47_), .O(z05));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n42_), .O(z09));
  ...
  nand2  g34(.a(x08), .b(new_n35_), .O(new_n68_));
  nor2   g35(.a(new_n55_), .b(x04), .O(new_n69_));
  aoi21  g36(.a(new_n68_), .b(new_n41_), .c(new_n69_), .O(z12));
  nand2  g37(.a(x08), .b(x05), .O(new_n71_));
  nand2  g38(.a(x14), .b(new_n55_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n42_), .O(z13));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand2  g41(.a(x15), .b(new_n55_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n42_), .O(z14));
  nand2  g43(.a(new_n51_), .b(new_n55_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n68_), .c(new_n42_), .O(new_n78_));
