...
module FAU ( 
  ...
  nor2   g16(.a(x15), .b(x08), .O(new_n50_));
  ...
  oai22  g34(.a(new_n55_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z12));
  inv1   g35(.a(x05), .O(new_n69_));
  oai22  g36(.a(new_n55_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z13));
  nor2   g37(.a(new_n39_), .b(x06), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(x15), .c(new_n50_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  oai22  g40(.a(new_n55_), .b(new_n73_), .c(new_n52_), .d(x08), .O(z15));
endmodule
