...
module FAU ( 
  ...
  nand2  g30(.a(new_n62_), .b(x03), .O(new_n64_));
  ...
  nand2  g35(.a(new_n44_), .b(new_n53_), .O(new_n69_));
  ...
  nand2  g40(.a(new_n46_), .b(new_n53_), .O(new_n74_));
  ...
  nand2  g48(.a(new_n50_), .b(new_n53_), .O(new_n82_));
