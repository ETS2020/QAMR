...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n38_, new_n39_, new_n41_, new_n43_, new_n46_,
    ...
    new_n84_, new_n85_;
  nand2  g00(.a(x10), .b(x02), .O(new_n34_));
  and2   g01(.a(new_n34_), .b(x09), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(new_n36_), .b(x02), .O(z01));
  ...
  nand2  g20(.a(new_n36_), .b(new_n51_), .O(new_n54_));
  inv1   g21(.a(x01), .O(new_n55_));
  nand2  g22(.a(x08), .b(new_n55_), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n34_), .O(new_n57_));
  ...
  nand2  g32(.a(new_n41_), .b(new_n51_), .O(new_n66_));
  ...
  nand2  g37(.a(new_n43_), .b(new_n51_), .O(new_n71_));
  ...
  nand2  g50(.a(new_n48_), .b(new_n51_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n34_), .O(new_n85_));
