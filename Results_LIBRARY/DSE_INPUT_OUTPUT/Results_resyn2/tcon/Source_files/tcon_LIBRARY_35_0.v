...
module FAU ( 
  ...
  nor2   g20(.a(new_n50_), .b(x08), .O(new_n54_));
  ...
  aoi21  g25(.a(new_n54_), .b(new_n39_), .c(new_n58_), .O(z10));
  nor2   g26(.a(new_n52_), .b(x03), .O(new_n60_));
  aoi21  g27(.a(new_n54_), .b(new_n42_), .c(new_n60_), .O(z11));
  nor2   g28(.a(new_n52_), .b(x04), .O(new_n62_));
  aoi21  g29(.a(new_n54_), .b(new_n44_), .c(new_n62_), .O(z12));
  nand2  g30(.a(x16), .b(new_n52_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  oai21  g32(.a(new_n64_), .b(new_n46_), .c(new_n65_), .O(z13));
