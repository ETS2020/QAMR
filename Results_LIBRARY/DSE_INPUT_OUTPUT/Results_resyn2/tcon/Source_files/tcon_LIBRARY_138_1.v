...
module FAU ( 
  ...
  nor2   g10(.a(new_n35_), .b(new_n42_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nand2  g12(.a(x13), .b(new_n42_), .O(new_n46_));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z09));
  ...
  nand3  g33(.a(x13), .b(x12), .c(new_n54_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  oai21  g35(.a(new_n68_), .b(new_n36_), .c(new_n67_), .O(z12));
  inv1   g36(.a(x05), .O(new_n70_));
  nand2  g37(.a(x08), .b(new_n70_), .O(new_n71_));
  nand2  g38(.a(new_n45_), .b(new_n54_), .O(new_n72_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n46_), .O(new_n81_));
