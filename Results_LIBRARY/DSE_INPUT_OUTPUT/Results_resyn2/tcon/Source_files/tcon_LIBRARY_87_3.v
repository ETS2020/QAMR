...
module FAU ( 
  ...
  aoi21  g08(.a(x13), .b(x03), .c(new_n41_), .O(z03));
  ...
  nand2  g27(.a(new_n39_), .b(new_n50_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z10));
  oai21  g30(.a(x13), .b(x08), .c(x03), .O(new_n64_));
  oai21  g31(.a(new_n41_), .b(x08), .c(new_n64_), .O(z11));
  oai21  g32(.a(new_n50_), .b(x03), .c(x13), .O(new_n66_));
