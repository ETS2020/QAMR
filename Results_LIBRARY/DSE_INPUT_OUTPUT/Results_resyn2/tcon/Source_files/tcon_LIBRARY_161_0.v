...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n60_, new_n62_, new_n65_, new_n67_, new_n69_;
  ...
  nand2  g25(.a(new_n52_), .b(x04), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  oai21  g27(.a(new_n59_), .b(new_n40_), .c(new_n60_), .O(z10));
  nor2   g28(.a(new_n52_), .b(x03), .O(new_n62_));
  aoi21  g29(.a(new_n55_), .b(new_n42_), .c(new_n62_), .O(z11));
  aoi21  g30(.a(new_n44_), .b(new_n52_), .c(new_n54_), .O(z12));
  nor2   g31(.a(new_n52_), .b(x05), .O(new_n65_));
  aoi21  g32(.a(new_n55_), .b(new_n46_), .c(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  oai21  g34(.a(new_n59_), .b(new_n48_), .c(new_n67_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  oai21  g36(.a(new_n59_), .b(new_n50_), .c(new_n69_), .O(z15));
endmodule
