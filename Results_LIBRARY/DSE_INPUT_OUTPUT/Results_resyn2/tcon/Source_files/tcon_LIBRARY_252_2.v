...
module FAU ( 
  ...
  nor2   g24(.a(x10), .b(x08), .O(new_n58_));
  nor2   g25(.a(new_n55_), .b(x01), .O(new_n59_));
  nor2   g26(.a(new_n59_), .b(new_n58_), .O(z09));
  nor2   g27(.a(x11), .b(x08), .O(new_n61_));
  nor2   g28(.a(new_n55_), .b(x02), .O(new_n62_));
  nor2   g29(.a(new_n62_), .b(new_n61_), .O(z10));
  nor2   g30(.a(x12), .b(x08), .O(new_n64_));
  nor2   g31(.a(new_n55_), .b(x03), .O(new_n65_));
  nor2   g32(.a(new_n65_), .b(new_n64_), .O(z11));
  nor2   g33(.a(x13), .b(x08), .O(new_n67_));
  nor2   g34(.a(new_n55_), .b(x04), .O(new_n68_));
  nor2   g35(.a(new_n68_), .b(new_n67_), .O(z12));
  inv1   g36(.a(x05), .O(new_n70_));
  oai22  g37(.a(new_n55_), .b(new_n70_), .c(new_n48_), .d(x08), .O(z13));
  nor2   g38(.a(x15), .b(x08), .O(new_n72_));
  nor2   g39(.a(new_n55_), .b(x06), .O(new_n73_));
  nor2   g40(.a(new_n73_), .b(new_n72_), .O(z14));
  nor2   g41(.a(new_n39_), .b(x07), .O(new_n75_));
  aoi21  g42(.a(new_n75_), .b(x16), .c(new_n52_), .O(z15));
endmodule
