...
module FAU ( 
  ...
  nor2   g07(.a(new_n35_), .b(x07), .O(new_n41_));
  nor2   g08(.a(new_n41_), .b(new_n40_), .O(z02));
  inv1   g09(.a(x12), .O(new_n43_));
  nor2   g10(.a(new_n41_), .b(new_n43_), .O(z03));
  inv1   g11(.a(x13), .O(new_n45_));
  nand2  g12(.a(new_n38_), .b(new_n45_), .O(z04));
  inv1   g13(.a(x14), .O(new_n47_));
  nor2   g14(.a(new_n41_), .b(new_n47_), .O(z05));
  ...
  nand2  g19(.a(x08), .b(x07), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(x09), .O(new_n54_));
  ...
  nand2  g25(.a(x10), .b(new_n58_), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n57_), .c(new_n38_), .O(z09));
  inv1   g27(.a(x02), .O(new_n61_));
  nand2  g28(.a(x08), .b(new_n61_), .O(new_n62_));
  nand2  g29(.a(new_n40_), .b(new_n58_), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n38_), .O(new_n64_));
  inv1   g31(.a(new_n64_), .O(z10));
  inv1   g32(.a(x03), .O(new_n66_));
  nand2  g33(.a(x08), .b(new_n66_), .O(new_n67_));
  nand2  g34(.a(new_n43_), .b(new_n58_), .O(new_n68_));
  ...
  nand2  g39(.a(new_n45_), .b(new_n58_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n38_), .O(new_n74_));
  inv1   g41(.a(new_n74_), .O(z12));
  inv1   g42(.a(x05), .O(new_n76_));
  nand2  g43(.a(x08), .b(new_n76_), .O(new_n77_));
  nand2  g44(.a(new_n47_), .b(new_n58_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n38_), .O(new_n79_));
  inv1   g46(.a(new_n79_), .O(z13));
  nand2  g47(.a(x08), .b(x06), .O(new_n81_));
  nand2  g48(.a(x15), .b(new_n58_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n38_), .O(z14));
  nand2  g50(.a(x16), .b(new_n58_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n53_), .c(new_n38_), .O(z15));
endmodule
