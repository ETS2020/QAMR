// Benchmark "FAU" written by ABC on Tue Aug 11 19:09:25 2020
...
module FAU ( 
  ...
  nor2   g02(.a(new_n35_), .b(x06), .O(new_n36_));
  nor2   g03(.a(new_n36_), .b(new_n34_), .O(z00));
  inv1   g04(.a(x10), .O(new_n38_));
  inv1   g05(.a(x06), .O(new_n39_));
  nand2  g06(.a(x13), .b(new_n39_), .O(new_n40_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n40_), .O(z09));
  ...
  nand2  g38(.a(new_n35_), .b(new_n55_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n40_), .O(new_n73_));
  ...
  nand2  g44(.a(x15), .b(new_n55_), .O(new_n78_));
  nand2  g45(.a(x08), .b(x06), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n40_), .O(z14));
