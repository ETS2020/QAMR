...
module FAU ( 
  ...
  nor2   g07(.a(new_n40_), .b(x08), .O(z02));
  ...
  nand2  g19(.a(new_n40_), .b(x08), .O(new_n53_));
  ...
  nand2  g24(.a(new_n57_), .b(new_n40_), .O(z10));
  ...
  oai22  g30(.a(new_n53_), .b(new_n63_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g31(.a(x06), .O(new_n65_));
  inv1   g32(.a(x08), .O(new_n66_));
  nor2   g33(.a(x11), .b(new_n66_), .O(new_n67_));
  nor2   g34(.a(x15), .b(x08), .O(new_n68_));
  aoi21  g35(.a(new_n67_), .b(new_n65_), .c(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  nor2   g37(.a(x16), .b(x08), .O(new_n71_));
  aoi21  g38(.a(new_n67_), .b(new_n70_), .c(new_n71_), .O(z15));
endmodule
