...
module FAU ( 
  ...
  nor2   g11(.a(new_n40_), .b(x11), .O(new_n45_));
  ...
  nor2   g27(.a(new_n52_), .b(x02), .O(new_n61_));
  ...
  aoi22  g40(.a(x15), .b(new_n35_), .c(x14), .d(new_n52_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n73_), .O(z13));
  nand2  g42(.a(new_n40_), .b(new_n52_), .O(new_n76_));
  ...
  nand3  g47(.a(new_n36_), .b(x08), .c(x07), .O(new_n81_));
  nand3  g48(.a(new_n36_), .b(x16), .c(new_n52_), .O(new_n82_));
