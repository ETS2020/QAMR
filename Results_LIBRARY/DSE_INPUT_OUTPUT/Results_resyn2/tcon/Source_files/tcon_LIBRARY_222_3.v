...
module FAU ( 
  ...
  nand2  g41(.a(new_n44_), .b(new_n52_), .O(new_n75_));
  ...
  nand2  g46(.a(new_n46_), .b(new_n52_), .O(new_n80_));
  ...
  nand2  g51(.a(new_n48_), .b(new_n52_), .O(new_n85_));
