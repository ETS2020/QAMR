...
module FAU ( 
  ...
  oai22  g15(.a(x13), .b(x12), .c(x09), .d(x08), .O(new_n49_));
  ...
  nand3  g20(.a(new_n53_), .b(new_n51_), .c(new_n36_), .O(z09));
  inv1   g21(.a(x02), .O(new_n55_));
  oai22  g22(.a(x13), .b(x12), .c(x11), .d(x08), .O(new_n56_));
  aoi21  g23(.a(x08), .b(new_n55_), .c(new_n56_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  aoi21  g25(.a(x13), .b(x08), .c(x12), .O(new_n59_));
  ...
  oai22  g34(.a(x15), .b(x08), .c(x13), .d(x12), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(x16), .b(x08), .c(x13), .d(x12), .O(new_n71_));
