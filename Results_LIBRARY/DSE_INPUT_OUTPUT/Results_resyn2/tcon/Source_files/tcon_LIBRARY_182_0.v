...
module FAU ( 
  ...
  oai22  g34(.a(x16), .b(x13), .c(x15), .d(x08), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  aoi21  g37(.a(x13), .b(x08), .c(x16), .O(new_n71_));
