...
module FAU ( 
  ...
  nand2  g01(.a(x10), .b(x00), .O(new_n35_));
  nand2  g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nor2   g04(.a(new_n37_), .b(x00), .O(z01));
  ...
  aoi21  g15(.a(x10), .b(x00), .c(new_n48_), .O(z07));
  inv1   g16(.a(x08), .O(new_n50_));
  nand2  g17(.a(new_n37_), .b(new_n50_), .O(new_n51_));
  ...
  nand3  g23(.a(new_n56_), .b(new_n51_), .c(new_n35_), .O(new_n57_));
  ...
  nand2  g36(.a(new_n44_), .b(new_n50_), .O(new_n70_));
  ...
  nand2  g44(.a(new_n48_), .b(new_n50_), .O(new_n78_));
