...
module FAU ( 
  ...
  aoi21  g09(.a(x13), .b(x05), .c(new_n42_), .O(z05));
  ...
  inv1   g28(.a(x13), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n49_), .O(new_n63_));
  ...
  nand2  g34(.a(new_n42_), .b(new_n49_), .O(new_n68_));
  ...
  nand2  g40(.a(x15), .b(new_n49_), .O(new_n74_));
