...
module FAU ( 
  ...
  nand2  g07(.a(new_n40_), .b(x01), .O(z02));
  ...
  oai22  g29(.a(x12), .b(x08), .c(x11), .d(x01), .O(new_n63_));
  ...
  oai22  g35(.a(x14), .b(x08), .c(x11), .d(x01), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  oai22  g38(.a(x15), .b(x08), .c(x11), .d(x01), .O(new_n72_));
  aoi21  g39(.a(x08), .b(new_n71_), .c(new_n72_), .O(z14));
  inv1   g40(.a(x07), .O(new_n74_));
  oai22  g41(.a(x16), .b(x08), .c(x11), .d(x01), .O(new_n75_));
  aoi21  g42(.a(x08), .b(new_n74_), .c(new_n75_), .O(z15));
endmodule
