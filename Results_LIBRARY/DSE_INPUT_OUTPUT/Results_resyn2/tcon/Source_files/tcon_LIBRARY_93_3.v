...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n45_, new_n47_,
  ...
  aoi21  g01(.a(x11), .b(x00), .c(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nand2  g03(.a(x11), .b(x00), .O(new_n37_));
  nand2  g04(.a(new_n37_), .b(new_n36_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nor2   g06(.a(new_n39_), .b(x00), .O(z02));
  ...
  nand2  g12(.a(new_n37_), .b(new_n45_), .O(z06));
  inv1   g13(.a(x16), .O(new_n47_));
  nand2  g14(.a(new_n37_), .b(new_n47_), .O(z07));
  oai21  g15(.a(x11), .b(x08), .c(x00), .O(new_n49_));
  oai21  g16(.a(new_n34_), .b(x08), .c(new_n49_), .O(z08));
  nand2  g17(.a(x08), .b(x01), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand2  g19(.a(x10), .b(new_n52_), .O(new_n53_));
  nand3  g20(.a(new_n53_), .b(new_n51_), .c(new_n37_), .O(z09));
  oai21  g21(.a(new_n52_), .b(x00), .c(x11), .O(new_n55_));
  ...
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n37_), .O(z12));
  ...
  nand2  g35(.a(new_n45_), .b(new_n52_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n37_), .O(new_n70_));
