...
module FAU ( 
  ...
  nor2   g12(.a(new_n35_), .b(new_n41_), .O(z05));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n42_), .O(z12));
  inv1   g39(.a(x05), .O(new_n73_));
  nand2  g40(.a(x08), .b(new_n73_), .O(new_n74_));
  nand2  g41(.a(new_n35_), .b(new_n53_), .O(new_n75_));
  ...
  nand3  g52(.a(new_n85_), .b(new_n84_), .c(new_n42_), .O(new_n86_));
