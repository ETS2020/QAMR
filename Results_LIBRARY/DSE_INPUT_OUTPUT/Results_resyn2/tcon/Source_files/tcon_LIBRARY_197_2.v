...
module FAU ( 
  ...
  nor2   g07(.a(x16), .b(new_n38_), .O(new_n41_));
  ...
  nor2   g17(.a(x16), .b(x10), .O(new_n51_));
  ...
  nor2   g23(.a(new_n35_), .b(new_n54_), .O(new_n57_));
  nand2  g24(.a(x08), .b(x01), .O(new_n58_));
  oai21  g25(.a(new_n57_), .b(new_n38_), .c(new_n58_), .O(z09));
  ...
  nand2  g31(.a(new_n43_), .b(new_n54_), .O(new_n65_));
  ...
  oai21  g44(.a(new_n57_), .b(new_n51_), .c(new_n77_), .O(z15));
endmodule
