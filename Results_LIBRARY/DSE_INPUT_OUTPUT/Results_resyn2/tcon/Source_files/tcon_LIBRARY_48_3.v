...
module FAU ( 
  ...
  nor2   g13(.a(x16), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n35_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n50_), .b(x14), .O(z07));
  ...
  nand2  g40(.a(x13), .b(new_n54_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n35_), .O(z12));
  inv1   g42(.a(x05), .O(new_n76_));
  nand2  g43(.a(new_n35_), .b(x08), .O(new_n77_));
  nand3  g44(.a(new_n50_), .b(x14), .c(new_n54_), .O(new_n78_));
  oai21  g45(.a(new_n77_), .b(new_n76_), .c(new_n78_), .O(z13));
  inv1   g46(.a(x06), .O(new_n80_));
  nand2  g47(.a(x08), .b(new_n80_), .O(new_n81_));
  nand2  g48(.a(new_n48_), .b(new_n54_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n35_), .O(new_n83_));
  inv1   g50(.a(new_n83_), .O(z14));
  inv1   g51(.a(x07), .O(new_n85_));
  nand3  g52(.a(x16), .b(new_n46_), .c(new_n54_), .O(new_n86_));
  oai21  g53(.a(new_n77_), .b(new_n85_), .c(new_n86_), .O(z15));
endmodule
