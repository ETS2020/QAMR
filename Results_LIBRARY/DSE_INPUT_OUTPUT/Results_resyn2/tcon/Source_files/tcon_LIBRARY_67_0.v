...
module FAU ( 
  ...
  nand2  g05(.a(x12), .b(new_n38_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  nand2  g07(.a(new_n36_), .b(new_n40_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  nand2  g09(.a(new_n42_), .b(x10), .O(z03));
  ...
  oai22  g19(.a(x12), .b(x10), .c(x09), .d(x08), .O(new_n53_));
  ...
  oai22  g32(.a(x13), .b(x08), .c(x12), .d(x10), .O(new_n66_));
