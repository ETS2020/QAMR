...
module FAU ( 
  ...
  oai21  g23(.a(new_n52_), .b(new_n39_), .c(new_n56_), .O(z10));
  inv1   g24(.a(x13), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(x08), .O(new_n59_));
  nor2   g26(.a(new_n51_), .b(x03), .O(new_n60_));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n43_), .c(new_n64_), .O(z13));
