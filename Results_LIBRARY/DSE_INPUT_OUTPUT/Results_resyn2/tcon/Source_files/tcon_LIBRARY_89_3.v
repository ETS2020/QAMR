...
module FAU ( 
  ...
  nor2   g13(.a(new_n41_), .b(new_n46_), .O(z07));
  ...
  nand2  g24(.a(new_n57_), .b(new_n49_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n35_), .O(new_n59_));
  inv1   g26(.a(new_n59_), .O(z10));
  oai21  g27(.a(x11), .b(new_n49_), .c(x12), .O(new_n61_));
  ...
  nand2  g32(.a(new_n40_), .b(new_n49_), .O(new_n66_));
