...
module FAU ( 
  ...
  nor2   g01(.a(x06), .b(x04), .O(new_n35_));
  ...
  oai22  g19(.a(x09), .b(x08), .c(x06), .d(x04), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  oai22  g22(.a(x10), .b(x08), .c(x06), .d(x04), .O(new_n56_));
