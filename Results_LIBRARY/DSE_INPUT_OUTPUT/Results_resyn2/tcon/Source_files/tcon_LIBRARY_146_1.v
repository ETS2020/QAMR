...
module FAU ( 
  ...
  aoi21  g06(.a(x11), .b(new_n34_), .c(new_n39_), .O(z03));
  inv1   g07(.a(x13), .O(new_n41_));
  aoi21  g08(.a(x11), .b(new_n34_), .c(new_n41_), .O(z04));
  inv1   g09(.a(x11), .O(new_n43_));
  inv1   g10(.a(x14), .O(new_n44_));
  oai21  g11(.a(new_n43_), .b(x08), .c(new_n44_), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  aoi21  g13(.a(x11), .b(new_n34_), .c(new_n46_), .O(z06));
  ...
  aoi21  g24(.a(x08), .b(new_n57_), .c(new_n51_), .O(z10));
  inv1   g25(.a(x03), .O(new_n59_));
  aoi22  g26(.a(new_n51_), .b(new_n39_), .c(x08), .d(new_n59_), .O(z11));
  ...
  nand2  g31(.a(new_n51_), .b(x14), .O(new_n65_));
  ...
  aoi22  g37(.a(new_n51_), .b(new_n48_), .c(x08), .d(new_n70_), .O(z15));
  buf    g38(.a(x11), .O(z02));
endmodule
