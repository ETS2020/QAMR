...
module FAU ( 
  ...
  nand2  g27(.a(new_n42_), .b(new_n51_), .O(new_n61_));
  ...
  nand2  g32(.a(new_n44_), .b(new_n51_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n40_), .O(new_n67_));
  inv1   g34(.a(new_n67_), .O(z11));
  oai21  g35(.a(new_n39_), .b(new_n51_), .c(x13), .O(new_n69_));
  nand2  g36(.a(x08), .b(x04), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z12));
