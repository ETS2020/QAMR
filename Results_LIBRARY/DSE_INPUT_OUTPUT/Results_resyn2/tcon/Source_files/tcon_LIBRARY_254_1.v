...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n43_, new_n45_,
    new_n47_, new_n49_, new_n51_, new_n52_, new_n54_, new_n56_, new_n59_,
  ...
  aoi21  g16(.a(x12), .b(new_n34_), .c(new_n49_), .O(z07));
  ...
  aoi22  g23(.a(new_n52_), .b(new_n40_), .c(x08), .d(new_n56_), .O(z10));
  and2   g24(.a(x08), .b(x03), .O(z11));
  nand2  g25(.a(x08), .b(x04), .O(new_n59_));
  nand2  g26(.a(new_n52_), .b(x13), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z12));
  inv1   g28(.a(x05), .O(new_n62_));
  aoi22  g29(.a(new_n52_), .b(new_n45_), .c(x08), .d(new_n62_), .O(z13));
