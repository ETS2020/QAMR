...
module FAU ( 
  ...
  nand2  g35(.a(x13), .b(new_n55_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(x03), .O(new_n70_));
  nand2  g37(.a(x12), .b(new_n55_), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z11));
  nand2  g39(.a(x08), .b(x04), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n69_), .c(new_n36_), .O(z12));
  nand2  g41(.a(x08), .b(x05), .O(new_n75_));
  nand2  g42(.a(x14), .b(new_n55_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n36_), .O(z13));
  nand2  g44(.a(x08), .b(x06), .O(new_n78_));
  nand2  g45(.a(x15), .b(new_n55_), .O(new_n79_));
