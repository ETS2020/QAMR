...
module FAU ( 
  ...
  nand2  g01(.a(x15), .b(x00), .O(new_n35_));
  ...
  nand2  g42(.a(new_n46_), .b(new_n50_), .O(new_n76_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n52_), .c(new_n35_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  inv1   g49(.a(x07), .O(new_n83_));
  nand2  g50(.a(x08), .b(new_n83_), .O(new_n84_));
  nand2  g51(.a(new_n48_), .b(new_n50_), .O(new_n85_));
