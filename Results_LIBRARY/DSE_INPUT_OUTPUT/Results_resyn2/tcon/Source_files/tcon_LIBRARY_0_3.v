...
module FAU ( 
  ...
  nor2   g13(.a(new_n46_), .b(x08), .O(z06));
  ...
  nor2   g19(.a(x15), .b(new_n52_), .O(new_n53_));
  aoi21  g20(.a(new_n53_), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g21(.a(x01), .O(new_n55_));
  nand2  g22(.a(new_n46_), .b(x08), .O(new_n56_));
  oai22  g23(.a(new_n56_), .b(new_n55_), .c(new_n36_), .d(x08), .O(z09));
