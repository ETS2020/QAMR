...
module FAU ( 
  ...
  nor2   g23(.a(new_n35_), .b(x02), .O(new_n57_));
  nor2   g24(.a(x11), .b(x08), .O(new_n58_));
  aoi21  g25(.a(new_n57_), .b(x11), .c(new_n58_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(new_n53_), .b(new_n60_), .c(new_n40_), .d(x08), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  oai22  g29(.a(new_n53_), .b(new_n62_), .c(new_n44_), .d(x08), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  oai22  g31(.a(new_n53_), .b(new_n64_), .c(new_n46_), .d(x08), .O(z13));
  nor2   g32(.a(x15), .b(x08), .O(new_n66_));
  nor2   g33(.a(new_n53_), .b(x06), .O(new_n67_));
  nor2   g34(.a(new_n67_), .b(new_n66_), .O(z14));
  nor2   g35(.a(x16), .b(x08), .O(new_n69_));
  nor2   g36(.a(new_n53_), .b(x07), .O(new_n70_));
