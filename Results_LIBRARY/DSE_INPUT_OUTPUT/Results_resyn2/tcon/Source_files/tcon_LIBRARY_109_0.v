...
module FAU ( 
  ...
  nand2  g11(.a(new_n44_), .b(x06), .O(z04));
  ...
  oai22  g19(.a(x13), .b(x06), .c(x09), .d(x08), .O(new_n53_));
  ...
  oai22  g29(.a(x13), .b(x06), .c(x12), .d(x08), .O(new_n63_));
  ...
  oai22  g41(.a(x16), .b(x08), .c(x13), .d(x06), .O(new_n75_));
