...
module FAU ( 
  ...
  nand2  g11(.a(new_n42_), .b(x12), .O(new_n45_));
  nand2  g12(.a(new_n45_), .b(new_n44_), .O(z04));
  inv1   g13(.a(x14), .O(new_n47_));
  nand2  g14(.a(new_n45_), .b(new_n47_), .O(z05));
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n45_), .O(new_n55_));
  inv1   g22(.a(new_n55_), .O(z08));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  nand2  g24(.a(x10), .b(new_n53_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n45_), .O(z09));
  inv1   g26(.a(x02), .O(new_n60_));
  nand2  g27(.a(x08), .b(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n40_), .b(new_n53_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n45_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z10));
  oai21  g31(.a(new_n42_), .b(new_n53_), .c(x12), .O(new_n65_));
  ...
  nand2  g36(.a(new_n44_), .b(new_n53_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(new_n71_));
  inv1   g38(.a(new_n71_), .O(z12));
  nand2  g39(.a(x08), .b(x05), .O(new_n73_));
  nand2  g40(.a(x14), .b(new_n53_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n45_), .O(z13));
  nand2  g42(.a(x08), .b(x06), .O(new_n76_));
  nand2  g43(.a(x15), .b(new_n53_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n45_), .O(z14));
  inv1   g45(.a(x07), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n49_), .b(new_n53_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(new_n82_));
