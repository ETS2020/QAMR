...
module FAU ( 
  ...
  oai21  g26(.a(x12), .b(new_n51_), .c(x11), .O(new_n60_));
  nand2  g27(.a(x08), .b(x02), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  oai21  g29(.a(x11), .b(new_n51_), .c(x12), .O(new_n63_));
  ...
  nand2  g37(.a(new_n44_), .b(new_n51_), .O(new_n71_));
  ...
  nand2  g42(.a(new_n46_), .b(new_n51_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n35_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z14));
  nand2  g45(.a(x08), .b(x07), .O(new_n79_));
  nand2  g46(.a(x16), .b(new_n51_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n35_), .O(z15));
  buf    g48(.a(x11), .O(z02));
endmodule
