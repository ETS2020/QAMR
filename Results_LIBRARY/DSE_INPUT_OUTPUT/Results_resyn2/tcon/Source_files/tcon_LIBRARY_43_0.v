...
module FAU ( 
  ...
  oai22  g17(.a(x15), .b(x11), .c(x09), .d(x08), .O(new_n51_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n48_), .O(z09));
  inv1   g23(.a(x02), .O(new_n57_));
  nand2  g24(.a(x15), .b(x08), .O(new_n58_));
  aoi22  g25(.a(new_n58_), .b(new_n39_), .c(x08), .d(new_n57_), .O(z10));
  ...
  oai22  g39(.a(x16), .b(x08), .c(x15), .d(x11), .O(new_n73_));
