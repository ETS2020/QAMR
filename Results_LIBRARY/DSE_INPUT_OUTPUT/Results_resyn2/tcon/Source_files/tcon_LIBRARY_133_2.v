...
module FAU ( 
  ...
  nor2   g02(.a(x12), .b(new_n35_), .O(new_n36_));
  ...
  nand2  g17(.a(new_n40_), .b(new_n50_), .O(z06));
  inv1   g18(.a(x16), .O(new_n52_));
  nand2  g19(.a(new_n40_), .b(new_n52_), .O(z07));
  nor2   g20(.a(x09), .b(x08), .O(new_n54_));
  nand2  g21(.a(x12), .b(x08), .O(new_n55_));
  ...
  nor2   g27(.a(new_n55_), .b(x02), .O(new_n61_));
  nor2   g28(.a(new_n61_), .b(new_n60_), .O(z10));
  nor2   g29(.a(new_n35_), .b(x03), .O(new_n63_));
  aoi21  g30(.a(new_n63_), .b(x12), .c(new_n44_), .O(z11));
  nor2   g31(.a(x13), .b(x08), .O(new_n65_));
  nor2   g32(.a(new_n55_), .b(x04), .O(new_n66_));
  nor2   g33(.a(new_n66_), .b(new_n65_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(new_n55_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  oai22  g37(.a(new_n55_), .b(new_n70_), .c(new_n50_), .d(x08), .O(z14));
  nor2   g38(.a(x16), .b(x08), .O(new_n72_));
  nor2   g39(.a(new_n55_), .b(x07), .O(new_n73_));
