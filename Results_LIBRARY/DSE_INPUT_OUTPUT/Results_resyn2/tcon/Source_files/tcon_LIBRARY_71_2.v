...
module FAU ( 
  ...
  nand2  g15(.a(new_n35_), .b(new_n38_), .O(z06));
  ...
  oai21  g24(.a(new_n35_), .b(new_n54_), .c(x10), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n38_), .b(x08), .c(x15), .O(new_n75_));
  nor2   g42(.a(new_n54_), .b(x06), .O(new_n76_));
