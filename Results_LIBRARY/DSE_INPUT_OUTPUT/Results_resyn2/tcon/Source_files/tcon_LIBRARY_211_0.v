...
module FAU ( 
  ...
  aoi21  g24(.a(new_n53_), .b(new_n39_), .c(new_n57_), .O(z10));
  nor2   g25(.a(new_n50_), .b(x03), .O(new_n59_));
  aoi21  g26(.a(new_n53_), .b(new_n42_), .c(new_n59_), .O(z11));
  ...
  oai21  g31(.a(new_n63_), .b(new_n44_), .c(new_n64_), .O(z13));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  oai21  g33(.a(new_n63_), .b(new_n46_), .c(new_n66_), .O(z14));
