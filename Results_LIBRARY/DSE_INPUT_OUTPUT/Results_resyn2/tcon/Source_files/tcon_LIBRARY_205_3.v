...
module FAU ( 
  ...
  nor2   g14(.a(new_n47_), .b(x04), .O(z06));
  ...
  nand2  g25(.a(new_n37_), .b(new_n53_), .O(new_n59_));
  ...
  nand2  g48(.a(new_n47_), .b(new_n53_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n35_), .O(new_n83_));
  inv1   g50(.a(new_n83_), .O(z14));
  nand2  g51(.a(x08), .b(x07), .O(new_n85_));
  nand2  g52(.a(x16), .b(new_n53_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n85_), .c(new_n35_), .O(z15));
endmodule
