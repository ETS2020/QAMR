...
module FAU ( 
  ...
  oai21  g29(.a(new_n54_), .b(new_n41_), .c(x11), .O(new_n63_));
  ...
  nand2  g34(.a(new_n40_), .b(new_n54_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n42_), .O(new_n82_));
  inv1   g49(.a(new_n82_), .O(z14));
  nand2  g50(.a(new_n35_), .b(new_n54_), .O(new_n84_));
  aoi22  g51(.a(new_n84_), .b(new_n41_), .c(new_n50_), .d(new_n54_), .O(z15));
  buf    g52(.a(x11), .O(z02));
endmodule
