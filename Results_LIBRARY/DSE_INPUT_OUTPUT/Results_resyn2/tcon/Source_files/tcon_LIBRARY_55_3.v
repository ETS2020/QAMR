...
module FAU ( 
  ...
  nor2   g05(.a(x12), .b(new_n38_), .O(z02));
  nand2  g06(.a(x12), .b(new_n38_), .O(new_n40_));
  ...
  aoi21  g14(.a(x12), .b(x11), .c(new_n47_), .O(z07));
  ...
  nand2  g24(.a(new_n57_), .b(x11), .O(new_n58_));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nor2   g27(.a(new_n50_), .b(x03), .O(new_n61_));
  aoi21  g28(.a(new_n57_), .b(new_n40_), .c(new_n61_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  nand2  g30(.a(x08), .b(new_n63_), .O(new_n64_));
  nand2  g31(.a(new_n42_), .b(new_n50_), .O(new_n65_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n35_), .O(z13));
  ...
  nand2  g42(.a(new_n47_), .b(new_n50_), .O(new_n76_));
