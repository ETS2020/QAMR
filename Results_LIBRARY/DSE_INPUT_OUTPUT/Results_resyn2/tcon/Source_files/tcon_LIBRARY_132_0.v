...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n67_, new_n69_, new_n70_, new_n72_, new_n73_, new_n75_;
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n38_), .O(z08));
  inv1   g22(.a(x01), .O(new_n56_));
  oai22  g23(.a(x16), .b(x02), .c(x10), .d(x08), .O(new_n57_));
  aoi21  g24(.a(x08), .b(new_n56_), .c(new_n57_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  nor2   g26(.a(x11), .b(x08), .O(new_n60_));
  nand2  g27(.a(x16), .b(new_n53_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n59_), .c(new_n60_), .O(z10));
  inv1   g29(.a(x03), .O(new_n63_));
  oai22  g30(.a(x16), .b(x02), .c(x12), .d(x08), .O(new_n64_));
  ...
  oai22  g36(.a(x16), .b(x02), .c(x14), .d(x08), .O(new_n70_));
  ...
  nand3  g42(.a(new_n75_), .b(new_n61_), .c(new_n38_), .O(z15));
endmodule
