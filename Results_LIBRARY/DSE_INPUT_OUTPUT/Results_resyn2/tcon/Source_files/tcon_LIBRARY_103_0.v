...
module FAU ( 
  ...
  nand2  g11(.a(new_n36_), .b(x05), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(new_n36_), .b(new_n35_), .c(new_n46_), .O(z05));
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n37_), .O(z08));
  inv1   g22(.a(x01), .O(new_n56_));
  oai22  g23(.a(x13), .b(x05), .c(x10), .d(x08), .O(new_n57_));
  ...
  aoi21  g35(.a(new_n65_), .b(new_n35_), .c(new_n68_), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  oai22  g37(.a(x15), .b(x08), .c(x13), .d(x05), .O(new_n71_));
  aoi21  g38(.a(x08), .b(new_n70_), .c(new_n71_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  oai22  g40(.a(x16), .b(x08), .c(x13), .d(x05), .O(new_n74_));
