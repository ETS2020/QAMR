...
module FAU ( 
  ...
  nand2  g14(.a(new_n35_), .b(new_n41_), .O(z06));
  ...
  nand3  g23(.a(new_n36_), .b(x08), .c(x01), .O(new_n57_));
  nand3  g24(.a(x15), .b(x10), .c(new_n53_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z09));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  aoi22  g27(.a(new_n35_), .b(x10), .c(x11), .d(new_n53_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  inv1   g29(.a(x03), .O(new_n63_));
  nand2  g30(.a(x08), .b(new_n63_), .O(new_n64_));
  nand2  g31(.a(new_n40_), .b(new_n53_), .O(new_n65_));
