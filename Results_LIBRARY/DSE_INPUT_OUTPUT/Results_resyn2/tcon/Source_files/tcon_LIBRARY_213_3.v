...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_, new_n56_,
  ...
  oai22  g29(.a(new_n52_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z11));
  ...
  oai22  g34(.a(new_n52_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  nor2   g36(.a(x15), .b(x08), .O(new_n70_));
  aoi21  g37(.a(new_n56_), .b(new_n69_), .c(new_n70_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n49_), .O(z15));
endmodule
