...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n40_, new_n42_, new_n44_, new_n46_, new_n48_,
  ...
  aoi21  g07(.a(x16), .b(x08), .c(new_n40_), .O(z04));
  ...
  nand2  g23(.a(new_n46_), .b(x08), .O(new_n57_));
  ...
  aoi21  g32(.a(new_n51_), .b(new_n64_), .c(new_n65_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  oai22  g34(.a(new_n57_), .b(new_n67_), .c(new_n44_), .d(x08), .O(z14));
