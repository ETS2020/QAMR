...
module FAU ( 
  ...
  and2   g20(.a(x09), .b(x08), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n53_), .O(z09));
  ...
  oai22  g31(.a(new_n57_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z13));
  ...
  oai22  g36(.a(new_n57_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z15));
  buf    g37(.a(x09), .O(z00));
endmodule
