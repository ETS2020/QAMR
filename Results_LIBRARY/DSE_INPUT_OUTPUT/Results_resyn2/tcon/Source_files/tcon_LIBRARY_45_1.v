...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_, new_n56_,
  ...
  nand2  g36(.a(x14), .b(new_n50_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  nand2  g39(.a(x08), .b(new_n72_), .O(new_n73_));
  nand2  g40(.a(new_n46_), .b(new_n50_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n36_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z14));
  nand2  g43(.a(x08), .b(x07), .O(new_n77_));
  nand2  g44(.a(x16), .b(new_n50_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n36_), .O(z15));
  buf    g46(.a(x13), .O(z04));
endmodule
