...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x12), .O(new_n35_));
  ...
  nand2  g15(.a(new_n48_), .b(x12), .O(z07));
  inv1   g16(.a(x00), .O(new_n50_));
  oai22  g17(.a(x16), .b(x12), .c(x09), .d(x08), .O(new_n51_));
  ...
  oai22  g33(.a(x16), .b(x12), .c(x14), .d(x08), .O(new_n67_));
  ...
  nand2  g39(.a(x12), .b(x08), .O(new_n73_));
  aoi22  g40(.a(new_n73_), .b(new_n48_), .c(x08), .d(new_n72_), .O(z15));
  buf    g41(.a(x12), .O(z03));
endmodule
