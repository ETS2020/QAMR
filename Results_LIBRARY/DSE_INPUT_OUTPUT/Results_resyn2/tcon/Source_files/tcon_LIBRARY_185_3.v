...
module FAU ( 
  ...
  nand2  g34(.a(new_n43_), .b(new_n49_), .O(new_n68_));
  ...
  inv1   g42(.a(x15), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(new_n49_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n75_), .c(new_n35_), .O(new_n78_));
  inv1   g45(.a(new_n78_), .O(z14));
  oai21  g46(.a(x15), .b(new_n49_), .c(x16), .O(new_n80_));
