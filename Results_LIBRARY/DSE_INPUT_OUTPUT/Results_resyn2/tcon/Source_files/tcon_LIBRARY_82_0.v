...
module FAU ( 
  ...
  aoi21  g17(.a(x15), .b(x08), .c(x09), .O(new_n51_));
  ...
  oai22  g24(.a(x15), .b(x09), .c(x11), .d(x08), .O(new_n58_));
  aoi21  g25(.a(x08), .b(new_n57_), .c(new_n58_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(x15), .b(x09), .c(x12), .d(x08), .O(new_n61_));
  ...
  oai22  g33(.a(x15), .b(x09), .c(x14), .d(x08), .O(new_n67_));
  ...
  oai22  g39(.a(x16), .b(x08), .c(x15), .d(x09), .O(new_n73_));
