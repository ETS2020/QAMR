...
module FAU ( 
  ...
  oai22  g19(.a(x13), .b(x11), .c(x09), .d(x08), .O(new_n53_));
  ...
  oai21  g27(.a(new_n44_), .b(x11), .c(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n59_), .O(z10));
  inv1   g29(.a(x03), .O(new_n63_));
  oai22  g30(.a(x13), .b(x11), .c(x12), .d(x08), .O(new_n64_));
  aoi21  g31(.a(x08), .b(new_n63_), .c(new_n64_), .O(z11));
  inv1   g32(.a(x04), .O(new_n66_));
  aoi22  g33(.a(new_n60_), .b(new_n44_), .c(x08), .d(new_n66_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(x14), .b(x08), .c(x13), .d(x11), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  oai22  g38(.a(x15), .b(x08), .c(x13), .d(x11), .O(new_n72_));
