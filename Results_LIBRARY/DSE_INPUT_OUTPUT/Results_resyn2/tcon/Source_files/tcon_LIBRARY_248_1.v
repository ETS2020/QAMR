...
module FAU ( 
  ...
  nand2  g14(.a(new_n35_), .b(new_n41_), .O(z05));
  ...
  nand2  g36(.a(new_n46_), .b(new_n53_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n42_), .O(new_n71_));
  ...
  nand2  g44(.a(new_n35_), .b(new_n53_), .O(new_n78_));
  ...
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n42_), .O(z15));
  buf    g50(.a(x15), .O(z06));
endmodule
