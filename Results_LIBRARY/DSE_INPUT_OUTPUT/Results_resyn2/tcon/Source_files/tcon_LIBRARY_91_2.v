...
module FAU ( 
  ...
  oai22  g31(.a(new_n55_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z11));
  nor2   g32(.a(new_n35_), .b(x04), .O(new_n66_));
  aoi21  g33(.a(new_n66_), .b(x13), .c(new_n46_), .O(z12));
  nor2   g34(.a(x14), .b(x08), .O(new_n68_));
  nor2   g35(.a(new_n55_), .b(x05), .O(new_n69_));
  nor2   g36(.a(new_n69_), .b(new_n68_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  oai22  g38(.a(new_n55_), .b(new_n71_), .c(new_n50_), .d(x08), .O(z14));
