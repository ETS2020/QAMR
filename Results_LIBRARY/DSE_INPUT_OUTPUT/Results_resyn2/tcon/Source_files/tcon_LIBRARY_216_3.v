...
module FAU ( 
  ...
  aoi22  g16(.a(x16), .b(x14), .c(x09), .d(new_n49_), .O(new_n50_));
  ...
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n35_), .O(z12));
  nand2  g34(.a(new_n44_), .b(new_n49_), .O(new_n68_));
  inv1   g35(.a(x05), .O(new_n69_));
  nand2  g36(.a(x08), .b(new_n69_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n68_), .c(new_n35_), .O(new_n71_));
  inv1   g38(.a(new_n71_), .O(z13));
  inv1   g39(.a(x06), .O(new_n73_));
  nand2  g40(.a(x08), .b(new_n73_), .O(new_n74_));
  nand2  g41(.a(new_n46_), .b(new_n49_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n35_), .O(new_n76_));
  inv1   g43(.a(new_n76_), .O(z14));
  inv1   g44(.a(x16), .O(new_n78_));
  nand3  g45(.a(new_n35_), .b(x08), .c(x07), .O(new_n79_));
  oai21  g46(.a(new_n68_), .b(new_n78_), .c(new_n79_), .O(z15));
  buf    g47(.a(x16), .O(z07));
endmodule
