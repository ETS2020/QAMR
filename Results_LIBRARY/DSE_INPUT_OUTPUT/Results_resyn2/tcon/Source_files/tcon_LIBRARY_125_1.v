// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:39 2020
...
module FAU ( 
  ...
  nand2  g28(.a(new_n51_), .b(x13), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  aoi22  g31(.a(new_n51_), .b(new_n46_), .c(x08), .d(new_n64_), .O(z13));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  nand2  g33(.a(new_n51_), .b(x15), .O(new_n67_));
