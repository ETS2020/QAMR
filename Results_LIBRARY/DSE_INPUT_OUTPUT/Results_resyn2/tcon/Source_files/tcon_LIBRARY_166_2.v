...
module FAU ( 
  ...
  nand2  g08(.a(new_n41_), .b(x02), .O(new_n42_));
  ...
  aoi21  g24(.a(new_n56_), .b(new_n41_), .c(new_n57_), .O(z09));
  nand2  g25(.a(new_n38_), .b(new_n53_), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n56_), .c(new_n42_), .O(new_n60_));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n42_), .O(z13));
  inv1   g41(.a(x06), .O(new_n75_));
  nand2  g42(.a(x08), .b(new_n75_), .O(new_n76_));
  nand2  g43(.a(new_n48_), .b(new_n53_), .O(new_n77_));
