...
module FAU ( 
  ...
  nor2   g14(.a(new_n42_), .b(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nor2   g16(.a(new_n42_), .b(new_n49_), .O(z07));
  ...
  aoi22  g24(.a(new_n35_), .b(x12), .c(x10), .d(new_n53_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z09));
  nand3  g26(.a(new_n36_), .b(x08), .c(x02), .O(new_n60_));
  nand3  g27(.a(new_n36_), .b(x11), .c(new_n53_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  nand3  g29(.a(new_n36_), .b(x08), .c(x03), .O(new_n63_));
  nand3  g30(.a(x13), .b(x12), .c(new_n53_), .O(new_n64_));
