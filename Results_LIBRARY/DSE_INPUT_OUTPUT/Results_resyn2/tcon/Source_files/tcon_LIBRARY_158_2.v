...
module FAU ( 
  ...
  and2   g20(.a(x11), .b(x08), .O(new_n54_));
  ...
  aoi21  g26(.a(x08), .b(new_n59_), .c(new_n35_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  nand2  g28(.a(x11), .b(x08), .O(new_n62_));
  ...
  oai22  g35(.a(new_n62_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  nor2   g37(.a(x16), .b(x08), .O(new_n71_));
  aoi21  g38(.a(new_n54_), .b(new_n70_), .c(new_n71_), .O(z15));
endmodule
