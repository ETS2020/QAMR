...
module FAU ( 
  ...
  nand2  g17(.a(new_n50_), .b(x01), .O(z07));
  inv1   g18(.a(x00), .O(new_n52_));
  oai22  g19(.a(x16), .b(x01), .c(x09), .d(x08), .O(new_n53_));
  ...
  oai22  g38(.a(x16), .b(x01), .c(x15), .d(x08), .O(new_n72_));
