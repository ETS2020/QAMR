...
module FAU ( 
  ...
  aoi21  g33(.a(new_n54_), .b(new_n65_), .c(new_n66_), .O(z12));
  ...
  oai22  g38(.a(new_n57_), .b(new_n71_), .c(new_n49_), .d(x08), .O(z14));
