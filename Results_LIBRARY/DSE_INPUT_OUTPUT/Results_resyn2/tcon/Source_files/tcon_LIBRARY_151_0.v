...
module FAU ( 
  ...
  oai22  g19(.a(x13), .b(x05), .c(x09), .d(x08), .O(new_n53_));
  ...
  nand2  g35(.a(x13), .b(new_n56_), .O(new_n69_));
  nor2   g36(.a(x14), .b(x08), .O(new_n70_));
  aoi21  g37(.a(new_n69_), .b(new_n68_), .c(new_n70_), .O(z13));
  ...
  nand2  g42(.a(x16), .b(new_n56_), .O(new_n76_));
