...
module FAU ( 
  ...
  nand2  g33(.a(new_n35_), .b(new_n54_), .O(new_n67_));
  inv1   g34(.a(x04), .O(new_n68_));
  nand2  g35(.a(x08), .b(new_n68_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n67_), .c(new_n42_), .O(new_n70_));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n42_), .O(z14));
  aoi22  g44(.a(new_n67_), .b(new_n41_), .c(new_n50_), .d(new_n54_), .O(z15));
  buf    g45(.a(x13), .O(z04));
endmodule
