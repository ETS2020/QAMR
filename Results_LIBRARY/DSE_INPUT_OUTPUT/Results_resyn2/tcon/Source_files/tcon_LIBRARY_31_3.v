...
module FAU ( 
  ...
  nand2  g21(.a(new_n38_), .b(new_n49_), .O(new_n55_));
  ...
  oai21  g27(.a(x16), .b(new_n49_), .c(x12), .O(new_n61_));
  ...
  nand2  g32(.a(new_n41_), .b(new_n49_), .O(new_n66_));
