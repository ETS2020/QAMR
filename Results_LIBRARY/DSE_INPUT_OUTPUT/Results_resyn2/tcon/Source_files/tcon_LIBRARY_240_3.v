...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n74_, new_n75_, new_n77_, new_n79_, new_n80_;
  ...
  nand2  g24(.a(new_n57_), .b(x10), .O(new_n58_));
  ...
  nand2  g35(.a(new_n42_), .b(new_n52_), .O(new_n69_));
  ...
  nand2  g40(.a(new_n44_), .b(new_n52_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n35_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z13));
  nor2   g43(.a(new_n52_), .b(x06), .O(new_n77_));
  aoi21  g44(.a(new_n57_), .b(new_n47_), .c(new_n77_), .O(z14));
