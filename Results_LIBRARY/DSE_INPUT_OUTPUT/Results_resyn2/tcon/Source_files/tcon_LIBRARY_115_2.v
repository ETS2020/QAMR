...
module FAU ( 
  ...
  nand2  g17(.a(x13), .b(x08), .O(new_n51_));
  oai22  g18(.a(new_n51_), .b(new_n50_), .c(new_n34_), .d(x08), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  and2   g20(.a(x13), .b(x08), .O(new_n54_));
  aoi22  g21(.a(new_n54_), .b(new_n53_), .c(new_n38_), .d(new_n35_), .O(z09));
  inv1   g22(.a(x02), .O(new_n56_));
  aoi22  g23(.a(new_n54_), .b(new_n56_), .c(new_n40_), .d(new_n35_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  oai22  g25(.a(new_n51_), .b(new_n58_), .c(new_n42_), .d(x08), .O(z11));
  ...
  oai22  g30(.a(new_n51_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z13));
  inv1   g31(.a(x06), .O(new_n65_));
  aoi22  g32(.a(new_n54_), .b(new_n65_), .c(new_n46_), .d(new_n35_), .O(z14));
  inv1   g33(.a(x07), .O(new_n67_));
  oai22  g34(.a(new_n51_), .b(new_n67_), .c(new_n48_), .d(x08), .O(z15));
  buf    g35(.a(x13), .O(z04));
endmodule
