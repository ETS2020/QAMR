...
module FAU ( 
  ...
  nor2   g16(.a(x16), .b(x13), .O(new_n50_));
  ...
  nor2   g37(.a(new_n39_), .b(new_n54_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x04), .O(new_n72_));
  oai21  g39(.a(new_n71_), .b(new_n35_), .c(new_n72_), .O(z12));
  ...
  oai21  g51(.a(new_n71_), .b(new_n50_), .c(new_n84_), .O(z15));
  buf    g52(.a(x13), .O(z04));
endmodule
