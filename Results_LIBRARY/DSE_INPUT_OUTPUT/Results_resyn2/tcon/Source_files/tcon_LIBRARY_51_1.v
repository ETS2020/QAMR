...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_, new_n58_,
  ...
  nand2  g08(.a(new_n38_), .b(new_n41_), .O(z03));
  ...
  aoi22  g27(.a(new_n52_), .b(new_n43_), .c(x08), .d(new_n60_), .O(z12));
  nand2  g28(.a(x08), .b(x05), .O(new_n62_));
  nand2  g29(.a(new_n52_), .b(x14), .O(new_n63_));
  ...
  nand2  g35(.a(new_n52_), .b(x16), .O(new_n69_));
