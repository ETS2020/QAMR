...
module FAU ( 
  ...
  nor2   g18(.a(x14), .b(new_n51_), .O(new_n52_));
  ...
  nand2  g24(.a(new_n44_), .b(x08), .O(new_n58_));
  oai22  g25(.a(new_n58_), .b(new_n57_), .c(new_n38_), .d(x08), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(new_n58_), .b(new_n60_), .c(new_n40_), .d(x08), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  oai22  g29(.a(new_n58_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n44_), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  oai22  g33(.a(new_n58_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z14));
  inv1   g34(.a(x07), .O(new_n68_));
  nor2   g35(.a(x16), .b(x08), .O(new_n69_));
  aoi21  g36(.a(new_n52_), .b(new_n68_), .c(new_n69_), .O(z15));
endmodule
