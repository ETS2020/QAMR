...
module FAU ( 
  ...
  oai22  g26(.a(new_n54_), .b(new_n59_), .c(new_n40_), .d(x08), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  oai22  g28(.a(new_n54_), .b(new_n61_), .c(new_n42_), .d(x08), .O(z12));
  ...
  oai22  g33(.a(new_n54_), .b(new_n66_), .c(new_n45_), .d(x08), .O(z14));
  nand2  g34(.a(x08), .b(x07), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n53_), .O(z15));
  buf    g36(.a(x16), .O(z07));
endmodule
