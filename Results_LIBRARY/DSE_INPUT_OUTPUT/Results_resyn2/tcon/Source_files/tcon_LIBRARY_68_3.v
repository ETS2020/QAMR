...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n39_, new_n41_, new_n43_, new_n46_,
  ...
  nor2   g13(.a(new_n39_), .b(new_n46_), .O(z07));
  ...
  oai21  g36(.a(new_n50_), .b(new_n68_), .c(new_n69_), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  oai22  g38(.a(new_n50_), .b(new_n71_), .c(new_n46_), .d(x08), .O(z15));
  buf    g39(.a(x15), .O(z06));
endmodule
