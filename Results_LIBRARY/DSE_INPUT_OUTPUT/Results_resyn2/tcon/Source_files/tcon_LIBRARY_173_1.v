...
module FAU ( 
  ...
  nand2  g28(.a(new_n43_), .b(new_n54_), .O(new_n62_));
  ...
  oai21  g36(.a(new_n54_), .b(new_n35_), .c(x14), .O(new_n70_));
  ...
  nand2  g41(.a(new_n49_), .b(new_n54_), .O(new_n75_));
  ...
  nand2  g46(.a(new_n51_), .b(new_n54_), .O(new_n80_));
