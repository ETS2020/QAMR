...
module FAU ( 
  ...
  nand2  g17(.a(new_n50_), .b(new_n35_), .O(z07));
  nand2  g18(.a(new_n50_), .b(x00), .O(new_n52_));
  nand2  g19(.a(x08), .b(new_n35_), .O(new_n53_));
  inv1   g20(.a(x08), .O(new_n54_));
  nand2  g21(.a(new_n34_), .b(new_n54_), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(new_n61_));
  ...
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(new_n79_));
  inv1   g46(.a(new_n79_), .O(z13));
  nand2  g47(.a(x08), .b(x06), .O(new_n81_));
  nand2  g48(.a(x15), .b(new_n54_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n52_), .O(z14));
  nor2   g50(.a(new_n54_), .b(x07), .O(new_n84_));
  aoi21  g51(.a(new_n53_), .b(new_n50_), .c(new_n84_), .O(z15));
endmodule
