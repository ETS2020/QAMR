...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_, new_n46_,
  ...
  nor2   g11(.a(new_n44_), .b(x08), .O(z05));
  ...
  nor2   g19(.a(x14), .b(new_n52_), .O(new_n53_));
  ...
  nand2  g25(.a(new_n44_), .b(x08), .O(new_n59_));
  oai22  g26(.a(new_n59_), .b(new_n58_), .c(new_n37_), .d(x08), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  oai22  g28(.a(new_n59_), .b(new_n61_), .c(new_n40_), .d(x08), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  oai22  g30(.a(new_n59_), .b(new_n63_), .c(new_n42_), .d(x08), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n44_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  oai22  g34(.a(new_n59_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z14));
  inv1   g35(.a(x07), .O(new_n69_));
  oai22  g36(.a(new_n59_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z15));
endmodule
