...
module FAU ( 
  ...
  nor2   g12(.a(x14), .b(x11), .O(new_n46_));
  ...
  nor2   g25(.a(new_n35_), .b(new_n53_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  oai21  g27(.a(new_n59_), .b(new_n39_), .c(new_n60_), .O(z10));
  ...
  oai21  g35(.a(new_n59_), .b(new_n46_), .c(new_n68_), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  nand2  g37(.a(x08), .b(new_n70_), .O(new_n71_));
  nand2  g38(.a(new_n48_), .b(new_n53_), .O(new_n72_));
