...
module FAU ( 
  ...
  nor2   g22(.a(new_n50_), .b(x08), .O(new_n56_));
  nor2   g23(.a(new_n53_), .b(x01), .O(new_n57_));
  aoi21  g24(.a(new_n56_), .b(new_n38_), .c(new_n57_), .O(z09));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  oai21  g26(.a(new_n54_), .b(new_n40_), .c(new_n59_), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  oai21  g28(.a(new_n54_), .b(new_n42_), .c(new_n61_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  oai21  g30(.a(new_n54_), .b(new_n44_), .c(new_n63_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  oai21  g32(.a(new_n54_), .b(new_n46_), .c(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  oai21  g34(.a(new_n54_), .b(new_n48_), .c(new_n67_), .O(z14));
  inv1   g35(.a(x07), .O(new_n69_));
  nand2  g36(.a(x08), .b(new_n69_), .O(z15));
endmodule
