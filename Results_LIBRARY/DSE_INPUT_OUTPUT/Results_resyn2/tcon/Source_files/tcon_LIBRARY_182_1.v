...
module FAU ( 
  ...
  nand2  g28(.a(new_n42_), .b(new_n52_), .O(new_n62_));
  ...
  aoi22  g40(.a(x16), .b(new_n39_), .c(x14), .d(new_n52_), .O(new_n74_));
  ...
  nand3  g47(.a(new_n40_), .b(x08), .c(x07), .O(new_n81_));
  nand3  g48(.a(x16), .b(x13), .c(new_n52_), .O(new_n82_));
