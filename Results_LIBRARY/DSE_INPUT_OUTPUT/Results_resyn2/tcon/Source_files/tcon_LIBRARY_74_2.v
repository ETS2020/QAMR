...
module FAU ( 
  ...
  oai22  g27(.a(new_n55_), .b(new_n60_), .c(new_n40_), .d(x08), .O(z10));
  ...
  nor2   g36(.a(new_n55_), .b(x06), .O(new_n70_));
  nor2   g37(.a(new_n70_), .b(new_n69_), .O(z14));
  nor2   g38(.a(new_n35_), .b(x07), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(x16), .c(new_n52_), .O(z15));
endmodule
