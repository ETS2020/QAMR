...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n58_, new_n60_, new_n62_, new_n63_, new_n64_, new_n66_, new_n68_;
  ...
  nand2  g18(.a(x10), .b(new_n51_), .O(new_n52_));
  oai21  g19(.a(new_n52_), .b(new_n34_), .c(new_n50_), .O(z08));
  inv1   g20(.a(x01), .O(new_n54_));
  aoi21  g21(.a(x08), .b(new_n54_), .c(new_n35_), .O(z09));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  oai21  g23(.a(new_n52_), .b(new_n38_), .c(new_n56_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  oai21  g25(.a(new_n52_), .b(new_n40_), .c(new_n58_), .O(z11));
  nand2  g26(.a(x08), .b(x04), .O(new_n60_));
  oai21  g27(.a(new_n52_), .b(new_n42_), .c(new_n60_), .O(z12));
  inv1   g28(.a(x10), .O(new_n62_));
  nor2   g29(.a(new_n62_), .b(x08), .O(new_n63_));
  nor2   g30(.a(new_n51_), .b(x05), .O(new_n64_));
  aoi21  g31(.a(new_n63_), .b(new_n44_), .c(new_n64_), .O(z13));
