...
module FAU ( 
  ...
  nor2   g24(.a(new_n53_), .b(x02), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(new_n57_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(new_n53_), .b(new_n60_), .c(new_n44_), .d(x08), .O(z11));
  ...
  oai22  g35(.a(new_n53_), .b(new_n68_), .c(new_n50_), .d(x08), .O(z14));
  nor2   g36(.a(new_n35_), .b(x07), .O(new_n70_));
  nor2   g37(.a(x16), .b(x08), .O(new_n71_));
  aoi21  g38(.a(new_n70_), .b(x16), .c(new_n71_), .O(z15));
  buf    g39(.a(x16), .O(z07));
endmodule
