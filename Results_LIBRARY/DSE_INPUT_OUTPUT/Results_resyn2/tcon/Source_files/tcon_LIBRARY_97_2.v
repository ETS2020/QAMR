...
module FAU ( 
  ...
  nand2  g16(.a(new_n40_), .b(new_n49_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand2  g19(.a(x09), .b(new_n52_), .O(new_n53_));
  nand3  g20(.a(new_n53_), .b(new_n51_), .c(new_n40_), .O(z08));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  aoi22  g22(.a(new_n39_), .b(x11), .c(x10), .d(new_n52_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  nand3  g24(.a(new_n40_), .b(x08), .c(x02), .O(new_n58_));
  nand3  g25(.a(x13), .b(x11), .c(new_n52_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  nand2  g28(.a(x08), .b(new_n61_), .O(new_n62_));
  nand2  g29(.a(new_n42_), .b(new_n52_), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n40_), .O(new_n64_));
