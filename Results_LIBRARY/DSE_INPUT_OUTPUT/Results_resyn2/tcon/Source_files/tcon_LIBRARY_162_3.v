...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n39_, new_n42_, new_n45_, new_n47_, new_n48_,
  ...
  nor2   g06(.a(new_n39_), .b(x08), .O(z03));
  and2   g07(.a(new_n35_), .b(x13), .O(z04));
  inv1   g08(.a(x14), .O(new_n42_));
  aoi21  g09(.a(x12), .b(x08), .c(new_n42_), .O(z05));
  ...
  nand2  g25(.a(new_n58_), .b(new_n39_), .O(z11));
  inv1   g26(.a(x04), .O(new_n60_));
  nor2   g27(.a(x13), .b(x08), .O(new_n61_));
  aoi21  g28(.a(new_n50_), .b(new_n60_), .c(new_n61_), .O(z12));
  inv1   g29(.a(x05), .O(new_n63_));
  nand2  g30(.a(new_n39_), .b(x08), .O(new_n64_));
