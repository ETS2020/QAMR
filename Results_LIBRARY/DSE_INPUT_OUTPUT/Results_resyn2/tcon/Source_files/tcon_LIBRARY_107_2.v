...
module FAU ( 
  ...
  oai21  g19(.a(new_n35_), .b(x08), .c(x00), .O(new_n53_));
  ...
  nand2  g30(.a(new_n42_), .b(new_n54_), .O(new_n64_));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n36_), .O(z11));
  ...
  aoi21  g46(.a(x08), .b(new_n39_), .c(x15), .O(new_n80_));
  nor2   g47(.a(new_n54_), .b(x06), .O(new_n81_));
  nor2   g48(.a(new_n81_), .b(new_n80_), .O(z14));
