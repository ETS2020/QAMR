...
module FAU ( 
  ...
  nand2  g18(.a(x11), .b(new_n51_), .O(new_n52_));
  ...
  oai21  g27(.a(new_n52_), .b(new_n40_), .c(new_n60_), .O(z11));
  nor2   g28(.a(new_n51_), .b(x04), .O(new_n62_));
  aoi21  g29(.a(new_n55_), .b(new_n42_), .c(new_n62_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  oai21  g31(.a(new_n52_), .b(new_n44_), .c(new_n64_), .O(z13));
  nor2   g32(.a(new_n51_), .b(x06), .O(new_n66_));
  aoi21  g33(.a(new_n55_), .b(new_n46_), .c(new_n66_), .O(z14));
