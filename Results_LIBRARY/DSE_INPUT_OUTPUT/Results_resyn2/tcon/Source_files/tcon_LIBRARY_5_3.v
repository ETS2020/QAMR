...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n38_, new_n40_, new_n42_, new_n45_,
  ...
  nand2  g03(.a(x11), .b(x09), .O(new_n37_));
  inv1   g04(.a(new_n37_), .O(new_n38_));
  nor2   g05(.a(new_n38_), .b(new_n36_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  nor2   g07(.a(new_n40_), .b(x09), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  nand2  g09(.a(new_n37_), .b(new_n42_), .O(z03));
  ...
  oai21  g18(.a(x11), .b(new_n51_), .c(x09), .O(new_n52_));
  ...
  nand2  g23(.a(new_n36_), .b(new_n51_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n37_), .O(new_n58_));
  inv1   g25(.a(new_n58_), .O(z09));
  oai21  g26(.a(x09), .b(new_n51_), .c(x11), .O(new_n60_));
  ...
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n37_), .O(new_n79_));
  ...
  nand3  g50(.a(new_n83_), .b(new_n82_), .c(new_n37_), .O(new_n84_));
