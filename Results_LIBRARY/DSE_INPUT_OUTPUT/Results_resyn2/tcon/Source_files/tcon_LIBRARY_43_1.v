...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  nor2   g14(.a(new_n35_), .b(new_n40_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nand2  g16(.a(x15), .b(new_n40_), .O(new_n50_));
  ...
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n50_), .O(new_n79_));
