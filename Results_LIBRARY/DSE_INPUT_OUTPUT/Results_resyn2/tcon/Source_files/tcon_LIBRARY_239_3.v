...
module FAU ( 
  ...
  nor2   g08(.a(new_n41_), .b(x02), .O(z03));
  and2   g09(.a(new_n35_), .b(x13), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  aoi21  g11(.a(x12), .b(x02), .c(new_n44_), .O(z05));
  ...
  nand3  g28(.a(new_n61_), .b(new_n59_), .c(new_n35_), .O(new_n62_));
  ...
  nand2  g36(.a(x13), .b(new_n51_), .O(new_n70_));
