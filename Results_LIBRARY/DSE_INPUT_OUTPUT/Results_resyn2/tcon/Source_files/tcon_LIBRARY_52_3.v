...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x00), .O(new_n35_));
  ...
  nand2  g43(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  ...
  nand2  g48(.a(new_n46_), .b(new_n50_), .O(new_n82_));
  ...
  nand2  g53(.a(new_n48_), .b(new_n50_), .O(new_n87_));
  nand3  g54(.a(new_n87_), .b(new_n86_), .c(new_n35_), .O(new_n88_));
