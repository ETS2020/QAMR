...
module FAU ( 
  ...
  nand2  g20(.a(new_n53_), .b(x06), .O(new_n54_));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n44_), .c(new_n64_), .O(z12));
  nor2   g32(.a(new_n53_), .b(x05), .O(new_n66_));
  aoi21  g33(.a(new_n59_), .b(new_n46_), .c(new_n66_), .O(z13));
  aoi21  g34(.a(new_n48_), .b(new_n53_), .c(new_n58_), .O(z14));
