...
module FAU ( 
  ...
  aoi21  g09(.a(new_n35_), .b(x00), .c(new_n42_), .O(z03));
  ...
  aoi21  g17(.a(new_n35_), .b(x00), .c(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nor2   g19(.a(x08), .b(x00), .O(new_n53_));
  ...
  nand2  g28(.a(new_n53_), .b(x12), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand2  g31(.a(new_n53_), .b(x13), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  inv1   g33(.a(x05), .O(new_n67_));
  aoi22  g34(.a(new_n53_), .b(new_n46_), .c(x08), .d(new_n67_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  aoi22  g36(.a(new_n53_), .b(new_n48_), .c(x08), .d(new_n69_), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  aoi22  g38(.a(new_n53_), .b(new_n50_), .c(x08), .d(new_n71_), .O(z15));
endmodule
