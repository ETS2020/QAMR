...
module FAU ( 
  ...
  nand2  g04(.a(x14), .b(new_n37_), .O(z01));
  ...
  nand2  g13(.a(new_n46_), .b(x10), .O(z05));
  ...
  oai21  g24(.a(new_n46_), .b(x10), .c(new_n57_), .O(new_n58_));
  ...
  oai22  g33(.a(x14), .b(x10), .c(x13), .d(x08), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z12));
  inv1   g35(.a(x05), .O(new_n69_));
  aoi22  g36(.a(new_n57_), .b(new_n46_), .c(x08), .d(new_n69_), .O(z13));
