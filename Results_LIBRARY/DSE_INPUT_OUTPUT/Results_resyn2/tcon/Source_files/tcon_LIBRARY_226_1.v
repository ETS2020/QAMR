...
module FAU ( 
  ...
  nand2  g14(.a(x15), .b(x11), .O(new_n48_));
  ...
  aoi21  g27(.a(new_n59_), .b(new_n35_), .c(new_n60_), .O(z10));
  inv1   g28(.a(x03), .O(new_n62_));
  nand2  g29(.a(x08), .b(new_n62_), .O(new_n63_));
  nand2  g30(.a(new_n42_), .b(new_n53_), .O(new_n64_));
  ...
  aoi21  g40(.a(new_n59_), .b(new_n48_), .c(new_n73_), .O(z14));
