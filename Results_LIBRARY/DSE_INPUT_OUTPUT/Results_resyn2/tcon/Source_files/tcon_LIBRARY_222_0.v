...
module FAU ( 
  ...
  oai22  g19(.a(x11), .b(x01), .c(x09), .d(x08), .O(new_n53_));
  ...
  aoi22  g26(.a(new_n57_), .b(new_n40_), .c(x08), .d(new_n59_), .O(z10));
