...
module FAU ( 
  ...
  nor2   g01(.a(x10), .b(x09), .O(new_n35_));
  inv1   g02(.a(new_n35_), .O(new_n36_));
  nand2  g03(.a(new_n36_), .b(new_n34_), .O(z02));
  ...
  nand3  g17(.a(new_n50_), .b(new_n48_), .c(new_n36_), .O(z08));
  inv1   g18(.a(x01), .O(new_n52_));
  aoi21  g19(.a(x09), .b(x08), .c(x10), .O(new_n53_));
  aoi21  g20(.a(x08), .b(new_n52_), .c(new_n53_), .O(z09));
  inv1   g21(.a(x02), .O(new_n55_));
  oai22  g22(.a(x11), .b(x08), .c(x10), .d(x09), .O(new_n56_));
  aoi21  g23(.a(x08), .b(new_n55_), .c(new_n56_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  oai22  g25(.a(x12), .b(x08), .c(x10), .d(x09), .O(new_n59_));
  aoi21  g26(.a(x08), .b(new_n58_), .c(new_n59_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  oai22  g28(.a(x13), .b(x08), .c(x10), .d(x09), .O(new_n62_));
  aoi21  g29(.a(x08), .b(new_n61_), .c(new_n62_), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  oai22  g31(.a(x14), .b(x08), .c(x10), .d(x09), .O(new_n65_));
  aoi21  g32(.a(x08), .b(new_n64_), .c(new_n65_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  oai22  g34(.a(x15), .b(x08), .c(x10), .d(x09), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(x16), .b(x08), .c(x10), .d(x09), .O(new_n71_));
