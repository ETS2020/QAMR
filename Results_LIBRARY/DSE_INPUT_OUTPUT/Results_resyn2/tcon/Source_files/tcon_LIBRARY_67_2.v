...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x10), .O(new_n40_));
  inv1   g07(.a(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  inv1   g09(.a(x10), .O(new_n43_));
  nor2   g10(.a(x12), .b(new_n43_), .O(new_n44_));
  ...
  nor2   g24(.a(new_n35_), .b(new_n54_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x01), .O(new_n59_));
  oai21  g26(.a(new_n58_), .b(new_n43_), .c(new_n59_), .O(z09));
  ...
  oai21  g31(.a(new_n58_), .b(new_n40_), .c(new_n64_), .O(z11));
