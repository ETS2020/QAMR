...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n74_, new_n75_, new_n77_, new_n78_, new_n80_, new_n81_;
  ...
  nor2   g15(.a(x16), .b(new_n48_), .O(z06));
  ...
  nand2  g35(.a(new_n44_), .b(new_n52_), .O(new_n69_));
