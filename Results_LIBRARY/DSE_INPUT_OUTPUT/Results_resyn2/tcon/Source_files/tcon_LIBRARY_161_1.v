...
module FAU ( 
  ...
  and2   g20(.a(x08), .b(x04), .O(new_n54_));
  ...
  aoi21  g32(.a(x08), .b(new_n35_), .c(new_n65_), .O(z12));
  ...
  oai22  g37(.a(new_n60_), .b(new_n70_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(new_n60_), .b(new_n72_), .c(new_n50_), .d(x08), .O(z15));
endmodule
