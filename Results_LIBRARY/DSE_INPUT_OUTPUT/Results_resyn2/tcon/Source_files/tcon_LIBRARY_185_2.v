...
module FAU ( 
  ...
  nand2  g16(.a(new_n35_), .b(new_n41_), .O(z07));
  ...
  nand2  g44(.a(new_n41_), .b(new_n53_), .O(new_n78_));
  inv1   g45(.a(x06), .O(new_n79_));
  nand2  g46(.a(x08), .b(new_n79_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n78_), .c(new_n36_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  nand2  g49(.a(x08), .b(x07), .O(new_n83_));
  nand2  g50(.a(x16), .b(new_n53_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n36_), .O(z15));
  buf    g52(.a(x15), .O(z06));
endmodule
