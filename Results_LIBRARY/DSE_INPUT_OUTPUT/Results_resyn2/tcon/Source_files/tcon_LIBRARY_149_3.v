...
module FAU ( 
  ...
  nand2  g24(.a(new_n57_), .b(new_n39_), .O(z10));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n65_), .c(new_n66_), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  oai22  g35(.a(new_n50_), .b(new_n68_), .c(new_n45_), .d(x08), .O(z14));
