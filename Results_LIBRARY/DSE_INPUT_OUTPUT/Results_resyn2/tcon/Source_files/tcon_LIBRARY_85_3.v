...
module FAU ( 
  ...
  nand3  g16(.a(new_n49_), .b(new_n47_), .c(new_n35_), .O(z08));
  ...
  nand2  g28(.a(new_n42_), .b(new_n48_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n35_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z12));
  inv1   g31(.a(x16), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n48_), .O(new_n66_));
  ...
  nand3  g41(.a(new_n74_), .b(new_n66_), .c(new_n35_), .O(new_n75_));
