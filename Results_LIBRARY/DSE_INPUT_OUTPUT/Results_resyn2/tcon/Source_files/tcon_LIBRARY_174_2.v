...
module FAU ( 
  ...
  nor2   g05(.a(new_n38_), .b(new_n35_), .O(z01));
  inv1   g06(.a(x12), .O(new_n40_));
  nand2  g07(.a(new_n38_), .b(x10), .O(new_n41_));
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n41_), .O(new_n55_));
  inv1   g22(.a(new_n55_), .O(z08));
  oai21  g23(.a(new_n38_), .b(new_n53_), .c(x10), .O(new_n57_));
  nand2  g24(.a(x08), .b(x01), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z09));
  aoi21  g26(.a(new_n35_), .b(x08), .c(x11), .O(new_n60_));
  nor2   g27(.a(new_n53_), .b(x02), .O(new_n61_));
  ...
  nand2  g37(.a(new_n45_), .b(new_n53_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n41_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z13));
  inv1   g40(.a(x06), .O(new_n74_));
  nand2  g41(.a(x08), .b(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n47_), .b(new_n53_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n41_), .O(new_n77_));
  ...
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n41_), .O(new_n82_));
