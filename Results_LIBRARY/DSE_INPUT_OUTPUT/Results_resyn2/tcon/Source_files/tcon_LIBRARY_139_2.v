...
module FAU ( 
  ...
  nand2  g16(.a(new_n35_), .b(new_n39_), .O(z06));
  ...
  nand2  g30(.a(new_n42_), .b(new_n55_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n36_), .O(new_n65_));
  inv1   g32(.a(new_n65_), .O(z10));
  nand2  g33(.a(x08), .b(new_n39_), .O(new_n67_));
  nand2  g34(.a(new_n44_), .b(new_n55_), .O(new_n68_));
  ...
  nand2  g39(.a(new_n46_), .b(new_n55_), .O(new_n73_));
  ...
  nand2  g44(.a(new_n48_), .b(new_n55_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n36_), .O(new_n79_));
  inv1   g46(.a(new_n79_), .O(z13));
  nor2   g47(.a(new_n55_), .b(x06), .O(new_n81_));
  aoi21  g48(.a(new_n67_), .b(new_n35_), .c(new_n81_), .O(z14));
