...
module FAU ( 
  ...
  nor2   g01(.a(new_n34_), .b(x07), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nand2  g03(.a(x09), .b(x07), .O(new_n37_));
  ...
  nand2  g11(.a(new_n37_), .b(new_n44_), .O(z04));
  ...
  oai21  g19(.a(new_n52_), .b(x07), .c(x09), .O(new_n53_));
  ...
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n37_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  nand2  g26(.a(x08), .b(new_n59_), .O(new_n60_));
  nand2  g27(.a(new_n39_), .b(new_n52_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n37_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z10));
  inv1   g30(.a(x03), .O(new_n64_));
  nand2  g31(.a(x08), .b(new_n64_), .O(new_n65_));
  nand2  g32(.a(new_n42_), .b(new_n52_), .O(new_n66_));
  ...
  nand2  g37(.a(new_n44_), .b(new_n52_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n37_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z12));
  inv1   g40(.a(x05), .O(new_n74_));
  nand2  g41(.a(x08), .b(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n46_), .b(new_n52_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n37_), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(z13));
  nand2  g45(.a(x08), .b(x06), .O(new_n79_));
  nand2  g46(.a(x15), .b(new_n52_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n37_), .O(z14));
  oai21  g48(.a(x09), .b(x08), .c(x07), .O(new_n82_));
  oai21  g49(.a(new_n50_), .b(x08), .c(new_n82_), .O(z15));
endmodule
