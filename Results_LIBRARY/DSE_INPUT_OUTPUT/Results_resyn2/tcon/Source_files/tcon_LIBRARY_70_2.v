...
module FAU ( 
  ...
  nand2  g19(.a(new_n36_), .b(new_n52_), .O(z07));
  ...
  nor2   g27(.a(new_n39_), .b(x02), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(x11), .c(new_n42_), .O(z10));
  ...
  oai22  g33(.a(new_n55_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z12));
