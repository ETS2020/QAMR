...
module FAU ( 
  ...
  nand2  g35(.a(new_n42_), .b(new_n53_), .O(new_n69_));
  ...
  nand2  g40(.a(new_n44_), .b(new_n53_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n35_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z12));
  inv1   g43(.a(x16), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(x08), .O(new_n78_));
  nand2  g45(.a(new_n78_), .b(x14), .O(new_n79_));
  nand2  g46(.a(x08), .b(x05), .O(new_n80_));
  nand2  g47(.a(new_n80_), .b(new_n79_), .O(z13));
  inv1   g48(.a(x06), .O(new_n82_));
  nand2  g49(.a(x08), .b(new_n82_), .O(new_n83_));
  nand2  g50(.a(new_n46_), .b(new_n53_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n35_), .O(new_n85_));
  inv1   g52(.a(new_n85_), .O(z14));
  nor2   g53(.a(new_n53_), .b(x07), .O(new_n87_));
  aoi21  g54(.a(new_n78_), .b(new_n49_), .c(new_n87_), .O(z15));
  buf    g55(.a(x14), .O(z05));
endmodule
