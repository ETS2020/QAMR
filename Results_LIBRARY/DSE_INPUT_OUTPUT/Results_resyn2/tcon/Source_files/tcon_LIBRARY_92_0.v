...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n48_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
  ...
  nand2  g13(.a(new_n36_), .b(x11), .O(z06));
  ...
  oai22  g21(.a(x15), .b(x11), .c(x10), .d(x08), .O(new_n55_));
  aoi21  g22(.a(x08), .b(new_n54_), .c(new_n55_), .O(z09));
  inv1   g23(.a(x02), .O(new_n57_));
  nand2  g24(.a(x15), .b(x08), .O(new_n58_));
  aoi22  g25(.a(new_n58_), .b(new_n35_), .c(x08), .d(new_n57_), .O(z10));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n37_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  nand2  g36(.a(x11), .b(x08), .O(new_n70_));
  aoi22  g37(.a(new_n70_), .b(new_n36_), .c(x08), .d(new_n69_), .O(z14));
