...
module FAU ( 
  ...
  aoi21  g06(.a(x16), .b(x14), .c(new_n39_), .O(z03));
  ...
  nand2  g25(.a(new_n39_), .b(new_n48_), .O(new_n59_));
  ...
  oai21  g33(.a(x16), .b(new_n48_), .c(x14), .O(new_n67_));
