...
module FAU ( 
  ...
  nor2   g01(.a(x02), .b(x00), .O(new_n35_));
  ...
  oai22  g37(.a(x14), .b(x08), .c(x02), .d(x00), .O(new_n71_));
  aoi21  g38(.a(x08), .b(new_n70_), .c(new_n71_), .O(z13));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand2  g40(.a(x15), .b(new_n54_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n38_), .O(z14));
  inv1   g42(.a(x07), .O(new_n76_));
  oai22  g43(.a(x16), .b(x08), .c(x02), .d(x00), .O(new_n77_));
  aoi21  g44(.a(x08), .b(new_n76_), .c(new_n77_), .O(z15));
endmodule
