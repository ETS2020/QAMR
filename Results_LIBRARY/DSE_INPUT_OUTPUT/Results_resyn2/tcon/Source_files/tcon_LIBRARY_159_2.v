...
module FAU ( 
  ...
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n43_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z13));
  inv1   g44(.a(x06), .O(new_n78_));
  nand2  g45(.a(x08), .b(new_n78_), .O(new_n79_));
  nand2  g46(.a(new_n49_), .b(new_n51_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  nand2  g49(.a(x08), .b(x07), .O(new_n83_));
  nand2  g50(.a(x16), .b(new_n51_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n43_), .O(z15));
  buf    g52(.a(x16), .O(z07));
endmodule
