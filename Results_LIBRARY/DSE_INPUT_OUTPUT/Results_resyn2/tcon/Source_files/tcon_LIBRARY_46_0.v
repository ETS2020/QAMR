...
module FAU ( 
  ...
  oai22  g17(.a(x16), .b(x04), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  oai22  g20(.a(x16), .b(x04), .c(x10), .d(x08), .O(new_n54_));
  ...
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n40_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(x16), .b(x04), .c(x12), .d(x08), .O(new_n61_));
  ...
  oai22  g33(.a(x16), .b(x04), .c(x14), .d(x08), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(x16), .b(x04), .c(x15), .d(x08), .O(new_n70_));
  aoi21  g37(.a(x08), .b(new_n69_), .c(new_n70_), .O(z14));
  nand2  g38(.a(x16), .b(new_n57_), .O(new_n72_));
