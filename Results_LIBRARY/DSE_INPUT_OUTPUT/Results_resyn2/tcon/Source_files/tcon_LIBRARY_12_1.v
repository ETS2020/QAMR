...
module FAU ( 
  ...
  nand2  g47(.a(new_n45_), .b(new_n54_), .O(new_n81_));
  aoi22  g48(.a(new_n81_), .b(new_n35_), .c(new_n50_), .d(new_n54_), .O(z14));
  inv1   g49(.a(x07), .O(new_n83_));
  nand2  g50(.a(x08), .b(new_n83_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n81_), .c(new_n36_), .O(new_n85_));
