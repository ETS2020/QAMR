...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n58_, new_n59_, new_n61_, new_n62_, new_n64_, new_n66_,
  ...
  nor2   g07(.a(new_n40_), .b(x03), .O(z02));
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n35_), .O(z08));
  inv1   g22(.a(x01), .O(new_n56_));
  nand2  g23(.a(x08), .b(new_n56_), .O(new_n57_));
  nand2  g24(.a(new_n37_), .b(new_n53_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n35_), .O(new_n59_));
  inv1   g26(.a(new_n59_), .O(z09));
  oai21  g27(.a(new_n53_), .b(x03), .c(x11), .O(new_n61_));
  nand2  g28(.a(x08), .b(x02), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z10));
  oai21  g30(.a(x11), .b(x08), .c(x03), .O(new_n64_));
  oai21  g31(.a(new_n42_), .b(x08), .c(new_n64_), .O(z11));
