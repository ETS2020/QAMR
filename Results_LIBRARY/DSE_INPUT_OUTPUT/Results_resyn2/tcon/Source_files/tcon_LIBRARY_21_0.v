...
module FAU ( 
  ...
  oai21  g23(.a(new_n55_), .b(new_n38_), .c(new_n56_), .O(z09));
  nor2   g24(.a(new_n50_), .b(x02), .O(new_n58_));
  aoi21  g25(.a(new_n53_), .b(new_n40_), .c(new_n58_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  aoi21  g27(.a(x08), .b(new_n60_), .c(new_n35_), .O(z11));
  nand2  g28(.a(x08), .b(x04), .O(new_n62_));
  oai21  g29(.a(new_n55_), .b(new_n42_), .c(new_n62_), .O(z12));
