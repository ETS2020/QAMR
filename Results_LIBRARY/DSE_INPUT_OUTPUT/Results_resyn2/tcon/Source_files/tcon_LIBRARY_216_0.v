...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n47_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
  ...
  nand2  g15(.a(new_n36_), .b(x14), .O(z07));
  ...
  oai22  g21(.a(x16), .b(x14), .c(x10), .d(x08), .O(new_n55_));
  ...
  oai22  g27(.a(x16), .b(x14), .c(x12), .d(x08), .O(new_n61_));
  ...
  nand2  g33(.a(x16), .b(x08), .O(new_n67_));
  aoi22  g34(.a(new_n67_), .b(new_n35_), .c(x08), .d(new_n66_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(x16), .b(x14), .c(x15), .d(x08), .O(new_n70_));
  aoi21  g37(.a(x08), .b(new_n69_), .c(new_n70_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  nand2  g39(.a(x14), .b(x08), .O(new_n73_));
  aoi22  g40(.a(new_n73_), .b(new_n36_), .c(x08), .d(new_n72_), .O(z15));
  buf    g41(.a(x14), .O(z05));
endmodule
