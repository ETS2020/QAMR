...
module FAU ( 
  ...
  nand2  g01(.a(x15), .b(x07), .O(new_n35_));
  ...
  nor2   g15(.a(new_n48_), .b(x07), .O(z06));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n35_), .O(z11));
  ...
  nand2  g47(.a(new_n48_), .b(new_n54_), .O(new_n81_));
  ...
  nand2  g52(.a(new_n81_), .b(x07), .O(new_n86_));
  nand2  g53(.a(x16), .b(new_n54_), .O(new_n87_));
  nand2  g54(.a(new_n87_), .b(new_n86_), .O(z15));
endmodule
