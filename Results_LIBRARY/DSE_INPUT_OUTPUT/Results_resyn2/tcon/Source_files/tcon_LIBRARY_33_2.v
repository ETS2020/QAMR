...
module FAU ( 
  ...
  aoi22  g27(.a(new_n41_), .b(x13), .c(x11), .d(new_n53_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  aoi22  g30(.a(new_n41_), .b(x13), .c(x12), .d(new_n53_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z11));
  nand3  g32(.a(new_n42_), .b(x08), .c(x04), .O(new_n66_));
  nand3  g33(.a(x15), .b(x13), .c(new_n53_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  inv1   g35(.a(x05), .O(new_n69_));
  nand2  g36(.a(x08), .b(new_n69_), .O(new_n70_));
  nand2  g37(.a(new_n47_), .b(new_n53_), .O(new_n71_));
