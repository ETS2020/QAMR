...
module FAU ( 
  ...
  nand2  g08(.a(new_n41_), .b(x10), .O(new_n42_));
  ...
  oai21  g20(.a(new_n41_), .b(new_n51_), .c(x10), .O(new_n54_));
  ...
  nand2  g28(.a(new_n38_), .b(new_n51_), .O(new_n62_));
  ...
  nand2  g39(.a(new_n46_), .b(new_n51_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n42_), .O(new_n74_));
  inv1   g41(.a(new_n74_), .O(z14));
  inv1   g42(.a(x07), .O(new_n76_));
  nand2  g43(.a(x08), .b(new_n76_), .O(new_n77_));
  nand2  g44(.a(new_n48_), .b(new_n51_), .O(new_n78_));
