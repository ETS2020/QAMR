...
module FAU ( 
  ...
  nand2  g36(.a(new_n35_), .b(x08), .O(new_n70_));
  nand3  g37(.a(new_n46_), .b(x13), .c(new_n52_), .O(new_n71_));
  oai21  g38(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z12));
  ...
  nand3  g43(.a(x15), .b(new_n42_), .c(new_n52_), .O(new_n77_));
  oai21  g44(.a(new_n70_), .b(new_n76_), .c(new_n77_), .O(z14));
