// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:45 2020
...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x12), .O(new_n44_));
  nand2  g11(.a(new_n44_), .b(new_n42_), .O(z05));
  ...
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n44_), .O(z14));
  inv1   g42(.a(x07), .O(new_n76_));
  nand2  g43(.a(x08), .b(new_n76_), .O(new_n77_));
  nand2  g44(.a(new_n48_), .b(new_n52_), .O(new_n78_));
