...
module FAU ( 
  ...
  nand2  g18(.a(x15), .b(new_n51_), .O(new_n52_));
  ...
  aoi21  g23(.a(new_n55_), .b(new_n38_), .c(new_n56_), .O(z09));
  nor2   g24(.a(new_n51_), .b(x02), .O(new_n58_));
  aoi21  g25(.a(new_n55_), .b(new_n40_), .c(new_n58_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  oai21  g27(.a(new_n52_), .b(new_n42_), .c(new_n60_), .O(z11));
  nor2   g28(.a(new_n51_), .b(x04), .O(new_n62_));
  aoi21  g29(.a(new_n55_), .b(new_n44_), .c(new_n62_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  oai21  g31(.a(new_n52_), .b(new_n46_), .c(new_n64_), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  nand2  g33(.a(x08), .b(new_n66_), .O(z14));
  nand2  g34(.a(x08), .b(x07), .O(new_n68_));
  oai21  g35(.a(new_n52_), .b(new_n48_), .c(new_n68_), .O(z15));
  buf    g36(.a(x15), .O(z06));
endmodule
