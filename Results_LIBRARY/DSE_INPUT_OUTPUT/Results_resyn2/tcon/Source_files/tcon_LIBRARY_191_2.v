...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n56_, new_n57_, new_n59_, new_n60_, new_n62_, new_n64_, new_n65_,
  ...
  oai22  g29(.a(new_n53_), .b(new_n62_), .c(new_n44_), .d(x08), .O(z11));
  ...
  nor2   g34(.a(new_n53_), .b(x05), .O(new_n68_));
  ...
  nor2   g39(.a(new_n39_), .b(x07), .O(new_n73_));
  nor2   g40(.a(x16), .b(x08), .O(new_n74_));
  aoi21  g41(.a(new_n73_), .b(x16), .c(new_n74_), .O(z15));
  buf    g42(.a(x16), .O(z07));
endmodule
