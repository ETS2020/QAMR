...
module FAU ( 
  ...
  nand2  g29(.a(new_n40_), .b(new_n53_), .O(new_n63_));
  ...
  nand2  g34(.a(new_n42_), .b(new_n53_), .O(new_n68_));
  ...
  nand2  g52(.a(new_n50_), .b(new_n53_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n85_), .c(new_n36_), .O(new_n87_));
