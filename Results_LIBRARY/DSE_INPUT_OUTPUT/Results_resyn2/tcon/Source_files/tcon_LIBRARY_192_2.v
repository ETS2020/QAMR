...
module FAU ( 
  ...
  nand2  g11(.a(new_n38_), .b(x10), .O(new_n45_));
  ...
  nand3  g17(.a(new_n45_), .b(x08), .c(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand3  g19(.a(new_n45_), .b(x09), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n51_), .O(z08));
  nand3  g21(.a(new_n45_), .b(x08), .c(x01), .O(new_n55_));
  nand3  g22(.a(x15), .b(x10), .c(new_n52_), .O(new_n56_));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n45_), .O(new_n64_));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n45_), .O(new_n69_));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(new_n74_));
