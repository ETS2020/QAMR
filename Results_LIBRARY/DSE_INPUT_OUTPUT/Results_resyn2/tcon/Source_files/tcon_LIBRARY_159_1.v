...
module FAU ( 
  ...
  nand2  g23(.a(new_n34_), .b(new_n52_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n42_), .O(new_n58_));
  inv1   g25(.a(new_n58_), .O(z09));
  inv1   g26(.a(x02), .O(new_n60_));
  nand2  g27(.a(x08), .b(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n38_), .b(new_n52_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(z10));
  inv1   g31(.a(x03), .O(new_n65_));
  nand2  g32(.a(x08), .b(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n40_), .b(new_n52_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n42_), .O(new_n68_));
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n42_), .O(new_n73_));
  inv1   g40(.a(new_n73_), .O(z12));
  nand2  g41(.a(x08), .b(x05), .O(new_n75_));
  nand2  g42(.a(x14), .b(new_n52_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n42_), .O(z13));
  inv1   g44(.a(x06), .O(new_n78_));
  nand2  g45(.a(x08), .b(new_n78_), .O(new_n79_));
  nand2  g46(.a(new_n48_), .b(new_n52_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n42_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  oai21  g49(.a(new_n41_), .b(new_n52_), .c(x16), .O(new_n83_));
