...
module FAU ( 
  ...
  nand2  g11(.a(x16), .b(x14), .O(new_n45_));
  ...
  nand2  g37(.a(new_n49_), .b(x08), .O(new_n71_));
  nor2   g38(.a(new_n52_), .b(x05), .O(new_n72_));
  aoi21  g39(.a(new_n71_), .b(new_n45_), .c(new_n72_), .O(z13));
  ...
  nor2   g45(.a(new_n52_), .b(x07), .O(new_n79_));
  aoi21  g46(.a(new_n71_), .b(new_n35_), .c(new_n79_), .O(z15));
endmodule
