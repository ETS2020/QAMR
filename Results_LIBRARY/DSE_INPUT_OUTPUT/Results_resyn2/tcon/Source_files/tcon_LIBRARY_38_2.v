...
module FAU ( 
  ...
  aoi21  g09(.a(new_n35_), .b(x10), .c(new_n42_), .O(z03));
  nand2  g10(.a(new_n35_), .b(new_n38_), .O(z04));
  ...
  nand2  g26(.a(new_n40_), .b(new_n52_), .O(new_n60_));
  ...
  aoi21  g34(.a(new_n38_), .b(x08), .c(x13), .O(new_n68_));
  nor2   g35(.a(new_n52_), .b(x04), .O(new_n69_));
  nor2   g36(.a(new_n69_), .b(new_n68_), .O(z12));
  inv1   g37(.a(x05), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n71_), .O(new_n72_));
  nand2  g39(.a(new_n45_), .b(new_n52_), .O(new_n73_));
  ...
  nand2  g48(.a(x16), .b(new_n52_), .O(new_n82_));
