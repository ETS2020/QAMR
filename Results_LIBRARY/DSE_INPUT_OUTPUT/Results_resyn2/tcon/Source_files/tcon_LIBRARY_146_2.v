...
module FAU ( 
  ...
  oai21  g13(.a(x11), .b(new_n35_), .c(new_n46_), .O(z05));
  ...
  aoi21  g24(.a(new_n57_), .b(x11), .c(new_n40_), .O(z10));
  ...
  oai22  g33(.a(new_n53_), .b(new_n66_), .c(new_n48_), .d(x08), .O(z14));
  nor2   g34(.a(x16), .b(x08), .O(new_n68_));
  nor2   g35(.a(new_n53_), .b(x07), .O(new_n69_));
  nor2   g36(.a(new_n69_), .b(new_n68_), .O(z15));
endmodule
