...
module FAU ( 
  ...
  nor2   g21(.a(x08), .b(new_n54_), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n34_), .c(new_n53_), .O(z08));
  nor2   g23(.a(new_n52_), .b(x01), .O(new_n57_));
  aoi21  g24(.a(new_n55_), .b(new_n38_), .c(new_n57_), .O(z09));
  nor2   g25(.a(new_n52_), .b(x02), .O(new_n59_));
  aoi21  g26(.a(new_n55_), .b(new_n40_), .c(new_n59_), .O(z10));
  nand2  g27(.a(new_n52_), .b(x04), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  oai21  g29(.a(new_n61_), .b(new_n42_), .c(new_n62_), .O(z11));
  nor2   g30(.a(new_n52_), .b(x04), .O(new_n64_));
  aoi21  g31(.a(new_n55_), .b(new_n44_), .c(new_n64_), .O(z12));
  nor2   g32(.a(new_n52_), .b(x05), .O(new_n66_));
  aoi21  g33(.a(new_n55_), .b(new_n46_), .c(new_n66_), .O(z13));
  nor2   g34(.a(new_n52_), .b(x06), .O(new_n68_));
  aoi21  g35(.a(new_n55_), .b(new_n48_), .c(new_n68_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  oai21  g37(.a(new_n61_), .b(new_n50_), .c(new_n70_), .O(z15));
endmodule
