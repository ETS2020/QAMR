...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n43_, new_n45_, new_n46_,
  ...
  aoi21  g07(.a(x13), .b(x11), .c(new_n40_), .O(z05));
  ...
  nand3  g14(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z08));
  ...
  nand2  g26(.a(new_n38_), .b(new_n46_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n34_), .O(new_n61_));
  inv1   g28(.a(new_n61_), .O(z11));
  oai21  g29(.a(x11), .b(new_n46_), .c(x13), .O(new_n63_));
