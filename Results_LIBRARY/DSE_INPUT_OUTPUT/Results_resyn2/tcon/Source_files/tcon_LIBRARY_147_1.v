...
module FAU ( 
  ...
  nor2   g27(.a(x15), .b(x08), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(x12), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n60_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  aoi22  g31(.a(new_n61_), .b(new_n44_), .c(x08), .d(new_n64_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  aoi22  g33(.a(new_n61_), .b(new_n46_), .c(x08), .d(new_n66_), .O(z13));
  and2   g34(.a(x08), .b(x06), .O(z14));
  inv1   g35(.a(x07), .O(new_n69_));
  aoi22  g36(.a(new_n61_), .b(new_n48_), .c(x08), .d(new_n69_), .O(z15));
  buf    g37(.a(x15), .O(z06));
endmodule
