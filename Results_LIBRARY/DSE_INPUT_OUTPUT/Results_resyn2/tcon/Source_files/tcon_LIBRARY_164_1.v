...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n59_, new_n60_, new_n62_, new_n64_, new_n66_;
  ...
  aoi22  g31(.a(new_n52_), .b(new_n46_), .c(x08), .d(new_n64_), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  aoi22  g33(.a(new_n52_), .b(new_n48_), .c(x08), .d(new_n66_), .O(z14));
  and2   g34(.a(x08), .b(x07), .O(z15));
endmodule
