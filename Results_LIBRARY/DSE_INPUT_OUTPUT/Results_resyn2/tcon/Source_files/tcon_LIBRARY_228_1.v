...
module FAU ( 
  ...
  nor2   g10(.a(new_n41_), .b(new_n35_), .O(z04));
  ...
  aoi21  g31(.a(new_n41_), .b(x08), .c(x12), .O(new_n65_));
  nor2   g32(.a(new_n53_), .b(x03), .O(new_n66_));
  nor2   g33(.a(new_n66_), .b(new_n65_), .O(z11));
  oai21  g34(.a(new_n35_), .b(new_n53_), .c(x13), .O(new_n68_));
