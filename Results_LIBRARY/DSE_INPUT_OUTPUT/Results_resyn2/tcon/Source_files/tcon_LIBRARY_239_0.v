...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x02), .O(new_n35_));
  ...
  oai22  g34(.a(x14), .b(x08), .c(x12), .d(x02), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  oai22  g37(.a(x15), .b(x08), .c(x12), .d(x02), .O(new_n71_));
