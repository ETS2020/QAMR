...
module FAU ( 
  ...
  nand2  g12(.a(new_n43_), .b(new_n35_), .O(z04));
  inv1   g13(.a(x14), .O(new_n47_));
  nand2  g14(.a(new_n44_), .b(new_n47_), .O(z05));
  ...
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n44_), .O(new_n57_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n44_), .O(new_n62_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n44_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z11));
  nand2  g40(.a(x08), .b(x04), .O(new_n74_));
  nand2  g41(.a(x13), .b(new_n55_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z12));
  inv1   g43(.a(x05), .O(new_n77_));
  nand2  g44(.a(x08), .b(new_n77_), .O(new_n78_));
  nand2  g45(.a(new_n47_), .b(new_n55_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n44_), .O(new_n80_));
  inv1   g47(.a(new_n80_), .O(z13));
  inv1   g48(.a(x06), .O(new_n82_));
  nand2  g49(.a(x08), .b(new_n82_), .O(new_n83_));
  nand2  g50(.a(new_n49_), .b(new_n55_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(new_n85_));
  inv1   g52(.a(new_n85_), .O(z14));
  nand2  g53(.a(new_n51_), .b(new_n55_), .O(new_n87_));
  nand2  g54(.a(x08), .b(new_n35_), .O(new_n88_));
  nand3  g55(.a(new_n88_), .b(new_n87_), .c(new_n44_), .O(new_n89_));
