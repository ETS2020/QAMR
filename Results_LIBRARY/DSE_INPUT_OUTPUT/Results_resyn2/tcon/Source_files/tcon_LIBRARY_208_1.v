...
module FAU ( 
  ...
  nand2  g07(.a(x14), .b(new_n38_), .O(new_n41_));
  ...
  aoi22  g25(.a(x14), .b(new_n38_), .c(x11), .d(new_n52_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  aoi22  g28(.a(x14), .b(new_n38_), .c(x12), .d(new_n52_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  nand3  g30(.a(new_n41_), .b(x08), .c(x04), .O(new_n64_));
  nand3  g31(.a(new_n41_), .b(x13), .c(new_n52_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  nand3  g33(.a(new_n41_), .b(x08), .c(x05), .O(new_n67_));
  nand3  g34(.a(x14), .b(x10), .c(new_n52_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z13));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  aoi22  g37(.a(x15), .b(new_n52_), .c(x14), .d(new_n38_), .O(new_n71_));
