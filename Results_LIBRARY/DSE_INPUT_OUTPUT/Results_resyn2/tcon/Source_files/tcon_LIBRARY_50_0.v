...
module FAU ( 
  ...
  aoi21  g22(.a(new_n53_), .b(new_n38_), .c(new_n55_), .O(z09));
  nand2  g23(.a(x16), .b(new_n50_), .O(new_n57_));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  oai21  g25(.a(new_n57_), .b(new_n40_), .c(new_n58_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  oai21  g27(.a(new_n57_), .b(new_n42_), .c(new_n60_), .O(z11));
  nand2  g28(.a(x08), .b(x04), .O(new_n62_));
  oai21  g29(.a(new_n57_), .b(new_n44_), .c(new_n62_), .O(z12));
  nor2   g30(.a(new_n50_), .b(x05), .O(new_n64_));
  aoi21  g31(.a(new_n53_), .b(new_n46_), .c(new_n64_), .O(z13));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  oai21  g33(.a(new_n57_), .b(new_n48_), .c(new_n66_), .O(z14));
