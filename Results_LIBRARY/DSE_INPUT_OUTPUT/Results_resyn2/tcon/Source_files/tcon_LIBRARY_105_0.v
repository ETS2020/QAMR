...
module FAU ( 
  ...
  oai22  g17(.a(x16), .b(x14), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  oai22  g20(.a(x16), .b(x14), .c(x10), .d(x08), .O(new_n54_));
  aoi21  g21(.a(x08), .b(new_n53_), .c(new_n54_), .O(z09));
  inv1   g22(.a(x02), .O(new_n56_));
  oai22  g23(.a(x16), .b(x14), .c(x11), .d(x08), .O(new_n57_));
  aoi21  g24(.a(x08), .b(new_n56_), .c(new_n57_), .O(z10));
  inv1   g25(.a(x03), .O(new_n59_));
  oai22  g26(.a(x16), .b(x14), .c(x12), .d(x08), .O(new_n60_));
  aoi21  g27(.a(x08), .b(new_n59_), .c(new_n60_), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  oai22  g29(.a(x16), .b(x14), .c(x13), .d(x08), .O(new_n63_));
  aoi21  g30(.a(x08), .b(new_n62_), .c(new_n63_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  inv1   g32(.a(x16), .O(new_n66_));
  nand2  g33(.a(x14), .b(x08), .O(new_n67_));
  oai21  g34(.a(new_n66_), .b(x14), .c(new_n67_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n65_), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  oai22  g37(.a(x16), .b(x14), .c(x15), .d(x08), .O(new_n71_));
  aoi21  g38(.a(x08), .b(new_n70_), .c(new_n71_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  aoi22  g40(.a(new_n67_), .b(new_n66_), .c(x08), .d(new_n73_), .O(z15));
  buf    g41(.a(x16), .O(z07));
endmodule
