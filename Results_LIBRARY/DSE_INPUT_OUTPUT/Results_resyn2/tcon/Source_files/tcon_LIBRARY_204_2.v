...
module FAU ( 
  ...
  nand2  g23(.a(new_n39_), .b(new_n52_), .O(new_n57_));
  ...
  aoi21  g40(.a(new_n39_), .b(x08), .c(x15), .O(new_n74_));
  nor2   g41(.a(new_n52_), .b(x06), .O(new_n75_));
  nor2   g42(.a(new_n75_), .b(new_n74_), .O(z14));
