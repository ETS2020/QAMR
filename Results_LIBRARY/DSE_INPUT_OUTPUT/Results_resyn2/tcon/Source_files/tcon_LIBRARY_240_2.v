...
module FAU ( 
  ...
  nand3  g20(.a(new_n53_), .b(new_n51_), .c(new_n40_), .O(new_n54_));
  inv1   g21(.a(new_n54_), .O(z08));
  oai21  g22(.a(new_n39_), .b(new_n52_), .c(x10), .O(new_n56_));
  ...
  nand2  g33(.a(new_n44_), .b(new_n52_), .O(new_n67_));
  ...
  nand2  g38(.a(new_n46_), .b(new_n52_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n40_), .O(new_n73_));
  inv1   g40(.a(new_n73_), .O(z13));
  aoi21  g41(.a(new_n35_), .b(x08), .c(x15), .O(new_n75_));
  nor2   g42(.a(new_n52_), .b(x06), .O(new_n76_));
  nor2   g43(.a(new_n76_), .b(new_n75_), .O(z14));
  nand2  g44(.a(x08), .b(x07), .O(new_n78_));
  nand2  g45(.a(x16), .b(new_n52_), .O(new_n79_));
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n40_), .O(z15));
  buf    g47(.a(x10), .O(z01));
  buf    g48(.a(x15), .O(z06));
endmodule
