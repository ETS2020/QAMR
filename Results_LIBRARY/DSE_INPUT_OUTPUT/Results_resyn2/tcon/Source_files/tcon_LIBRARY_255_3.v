...
module FAU ( 
  ...
  nor2   g13(.a(new_n38_), .b(new_n46_), .O(z06));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(x12), .b(new_n51_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n35_), .O(z11));
  nand2  g32(.a(new_n42_), .b(new_n51_), .O(new_n66_));
  inv1   g33(.a(x04), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n67_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n66_), .c(new_n35_), .O(new_n69_));
  inv1   g36(.a(new_n69_), .O(z12));
  inv1   g37(.a(x05), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n71_), .O(new_n72_));
  nand2  g39(.a(new_n44_), .b(new_n51_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n35_), .O(new_n74_));
  inv1   g41(.a(new_n74_), .O(z13));
  oai21  g42(.a(x08), .b(x04), .c(x06), .O(new_n76_));
  oai21  g43(.a(new_n46_), .b(x08), .c(new_n76_), .O(z14));
  nand2  g44(.a(x08), .b(x07), .O(new_n78_));
  nand2  g45(.a(x16), .b(new_n51_), .O(new_n79_));
