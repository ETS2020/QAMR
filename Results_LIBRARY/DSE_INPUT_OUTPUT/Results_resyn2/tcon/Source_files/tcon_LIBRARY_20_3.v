...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(new_n39_), .O(new_n40_));
  inv1   g07(.a(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  aoi21  g09(.a(x12), .b(x08), .c(new_n42_), .O(z04));
  ...
  nor2   g18(.a(x12), .b(new_n39_), .O(new_n52_));
  ...
  nand2  g28(.a(new_n61_), .b(x08), .O(new_n62_));
  oai21  g29(.a(new_n62_), .b(new_n60_), .c(new_n40_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  oai22  g31(.a(new_n62_), .b(new_n64_), .c(new_n42_), .d(x08), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  nor2   g33(.a(x14), .b(x08), .O(new_n67_));
  aoi21  g34(.a(new_n52_), .b(new_n66_), .c(new_n67_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  nor2   g36(.a(x15), .b(x08), .O(new_n70_));
  aoi21  g37(.a(new_n52_), .b(new_n69_), .c(new_n70_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  nor2   g39(.a(x16), .b(x08), .O(new_n73_));
  aoi21  g40(.a(new_n52_), .b(new_n72_), .c(new_n73_), .O(z15));
endmodule
