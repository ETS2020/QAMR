...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n45_, new_n47_, new_n49_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  oai21  g30(.a(new_n35_), .b(new_n54_), .c(x12), .O(new_n64_));
  ...
  aoi21  g44(.a(new_n39_), .b(x08), .c(x16), .O(new_n78_));
  nor2   g45(.a(new_n54_), .b(x07), .O(new_n79_));
  nor2   g46(.a(new_n79_), .b(new_n78_), .O(z15));
endmodule
