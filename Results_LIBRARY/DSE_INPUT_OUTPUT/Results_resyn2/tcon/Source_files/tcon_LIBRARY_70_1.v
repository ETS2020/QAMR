...
module FAU ( 
  ...
  aoi21  g22(.a(x08), .b(new_n55_), .c(new_n51_), .O(z10));
  inv1   g23(.a(x03), .O(new_n57_));
  aoi22  g24(.a(new_n51_), .b(new_n40_), .c(x08), .d(new_n57_), .O(z11));
  nand2  g25(.a(x08), .b(x04), .O(new_n59_));
  nand2  g26(.a(new_n51_), .b(x13), .O(new_n60_));
  ...
  aoi22  g35(.a(new_n51_), .b(new_n48_), .c(x08), .d(new_n68_), .O(z15));
  buf    g36(.a(x11), .O(z02));
endmodule
