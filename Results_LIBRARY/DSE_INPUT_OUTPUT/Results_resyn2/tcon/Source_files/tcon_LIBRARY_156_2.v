...
module FAU ( 
  ...
  and2   g18(.a(x12), .b(x08), .O(new_n52_));
  ...
  aoi21  g26(.a(x08), .b(new_n59_), .c(new_n35_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  nor2   g28(.a(x13), .b(x08), .O(new_n62_));
  aoi21  g29(.a(new_n52_), .b(new_n61_), .c(new_n62_), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  oai22  g31(.a(new_n55_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  oai22  g33(.a(new_n55_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z14));
