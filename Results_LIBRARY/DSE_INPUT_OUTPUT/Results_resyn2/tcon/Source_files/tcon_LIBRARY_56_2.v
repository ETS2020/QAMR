...
module FAU ( 
  ...
  nand3  g23(.a(new_n56_), .b(new_n54_), .c(new_n48_), .O(new_n57_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n48_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z09));
  oai21  g30(.a(new_n47_), .b(x08), .c(x02), .O(new_n64_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n48_), .O(new_n70_));
  inv1   g37(.a(new_n70_), .O(z11));
  inv1   g38(.a(x04), .O(new_n72_));
  nand2  g39(.a(x08), .b(new_n72_), .O(new_n73_));
  nand2  g40(.a(new_n44_), .b(new_n55_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z12));
  nand2  g43(.a(x08), .b(x05), .O(new_n77_));
  nand2  g44(.a(x14), .b(new_n55_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n48_), .O(z13));
  nand2  g46(.a(x08), .b(x06), .O(new_n80_));
  nand2  g47(.a(x15), .b(new_n55_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n48_), .O(z14));
  aoi21  g49(.a(x08), .b(new_n35_), .c(x16), .O(new_n83_));
  nor2   g50(.a(new_n55_), .b(x07), .O(new_n84_));
