// Benchmark "FAU" written by ABC on Tue Aug 11 19:09:03 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n74_, new_n75_, new_n77_, new_n78_, new_n80_;
  inv1   g00(.a(x09), .O(new_n34_));
  inv1   g01(.a(x16), .O(new_n35_));
  nand2  g02(.a(new_n35_), .b(x15), .O(new_n36_));
  ...
  nand2  g16(.a(x16), .b(x15), .O(new_n50_));
  inv1   g17(.a(new_n50_), .O(z06));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n36_), .O(new_n61_));
  inv1   g28(.a(new_n61_), .O(z09));
  nand2  g29(.a(x08), .b(x02), .O(new_n63_));
  nand2  g30(.a(x11), .b(new_n54_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n36_), .O(z10));
  nand2  g32(.a(x08), .b(x03), .O(new_n66_));
  nand2  g33(.a(x12), .b(new_n54_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n36_), .O(z11));
  inv1   g35(.a(x04), .O(new_n69_));
  nand2  g36(.a(x08), .b(new_n69_), .O(new_n70_));
  nand2  g37(.a(new_n44_), .b(new_n54_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n36_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z12));
  nand2  g40(.a(x08), .b(x05), .O(new_n74_));
  nand2  g41(.a(x14), .b(new_n54_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n36_), .O(z13));
  nand2  g43(.a(new_n45_), .b(x08), .O(new_n77_));
  nor2   g44(.a(new_n54_), .b(x06), .O(new_n78_));
  aoi21  g45(.a(new_n77_), .b(new_n50_), .c(new_n78_), .O(z14));
  nor2   g46(.a(new_n54_), .b(x07), .O(new_n80_));
  aoi21  g47(.a(new_n77_), .b(new_n35_), .c(new_n80_), .O(z15));
  buf    g48(.a(x16), .O(z07));
endmodule
