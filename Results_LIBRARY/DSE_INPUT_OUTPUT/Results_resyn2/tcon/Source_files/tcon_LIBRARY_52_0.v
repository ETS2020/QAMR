...
module FAU ( 
  ...
  nand2  g21(.a(x14), .b(new_n54_), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n52_), .c(new_n53_), .O(z08));
  inv1   g23(.a(x01), .O(new_n57_));
  oai22  g24(.a(x14), .b(x00), .c(x10), .d(x08), .O(new_n58_));
  aoi21  g25(.a(x08), .b(new_n57_), .c(new_n58_), .O(z09));
  inv1   g26(.a(x02), .O(new_n60_));
  oai22  g27(.a(x14), .b(x00), .c(x11), .d(x08), .O(new_n61_));
  aoi21  g28(.a(x08), .b(new_n60_), .c(new_n61_), .O(z10));
  ...
  oai22  g33(.a(x14), .b(x00), .c(x13), .d(x08), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z12));
  inv1   g35(.a(x05), .O(new_n69_));
  nand2  g36(.a(x08), .b(x00), .O(new_n70_));
  aoi22  g37(.a(new_n70_), .b(new_n46_), .c(x08), .d(new_n69_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  oai22  g39(.a(x15), .b(x08), .c(x14), .d(x00), .O(new_n73_));
  aoi21  g40(.a(x08), .b(new_n72_), .c(new_n73_), .O(z14));
  inv1   g41(.a(x07), .O(new_n75_));
  oai22  g42(.a(x16), .b(x08), .c(x14), .d(x00), .O(new_n76_));
