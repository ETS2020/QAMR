...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n56_, new_n58_, new_n60_, new_n61_, new_n63_, new_n64_, new_n66_,
  ...
  nor2   g30(.a(new_n55_), .b(x03), .O(new_n64_));
  nor2   g31(.a(new_n64_), .b(new_n63_), .O(z11));
  nor2   g32(.a(x13), .b(x08), .O(new_n66_));
  nor2   g33(.a(new_n55_), .b(x04), .O(new_n67_));
  nor2   g34(.a(new_n67_), .b(new_n66_), .O(z12));
  nor2   g35(.a(x14), .b(x08), .O(new_n69_));
  nor2   g36(.a(new_n55_), .b(x05), .O(new_n70_));
  nor2   g37(.a(new_n70_), .b(new_n69_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  oai22  g39(.a(new_n55_), .b(new_n72_), .c(new_n50_), .d(x08), .O(z14));
  nor2   g40(.a(new_n41_), .b(x07), .O(new_n74_));
  aoi21  g41(.a(new_n74_), .b(x16), .c(new_n52_), .O(z15));
endmodule
