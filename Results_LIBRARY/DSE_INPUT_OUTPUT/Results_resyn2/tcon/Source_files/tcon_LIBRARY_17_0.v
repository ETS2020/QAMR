...
module FAU ( 
  ...
  nand2  g13(.a(new_n46_), .b(x14), .O(z06));
  ...
  oai22  g21(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n55_));
  ...
  oai22  g27(.a(x15), .b(x14), .c(x12), .d(x08), .O(new_n61_));
