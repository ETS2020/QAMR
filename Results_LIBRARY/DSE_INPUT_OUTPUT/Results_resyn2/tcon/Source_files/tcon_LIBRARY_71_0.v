...
module FAU ( 
  ...
  nand2  g13(.a(new_n46_), .b(x10), .O(z06));
  ...
  oai22  g30(.a(x15), .b(x10), .c(x13), .d(x08), .O(new_n64_));
  ...
  nand2  g36(.a(x10), .b(x08), .O(new_n70_));
  aoi22  g37(.a(new_n70_), .b(new_n46_), .c(x08), .d(new_n69_), .O(z14));
