...
module FAU ( 
  ...
  nand2  g32(.a(new_n44_), .b(new_n54_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n40_), .O(new_n67_));
  inv1   g34(.a(new_n67_), .O(z11));
  aoi21  g35(.a(x08), .b(new_n35_), .c(x13), .O(new_n69_));
  nor2   g36(.a(new_n54_), .b(x04), .O(new_n70_));
  nor2   g37(.a(new_n70_), .b(new_n69_), .O(z12));
  nand2  g38(.a(x08), .b(x05), .O(new_n72_));
  nand2  g39(.a(x14), .b(new_n54_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n40_), .O(z13));
  oai21  g41(.a(new_n39_), .b(x08), .c(x06), .O(new_n75_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n40_), .O(new_n81_));
