...
module FAU ( 
  ...
  nand2  g20(.a(new_n35_), .b(new_n53_), .O(new_n54_));
  aoi22  g21(.a(new_n54_), .b(new_n39_), .c(new_n34_), .d(new_n53_), .O(z08));
  ...
  nand3  g47(.a(new_n80_), .b(new_n54_), .c(new_n40_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  nand2  g49(.a(x08), .b(x07), .O(new_n83_));
  nand2  g50(.a(x16), .b(new_n53_), .O(new_n84_));
  nand3  g51(.a(new_n84_), .b(new_n83_), .c(new_n40_), .O(z15));
endmodule
