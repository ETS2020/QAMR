...
module FAU ( 
  ...
  nand3  g20(.a(new_n53_), .b(new_n51_), .c(new_n42_), .O(new_n54_));
  ...
  oai21  g27(.a(new_n41_), .b(new_n52_), .c(x11), .O(new_n61_));
  ...
  nand2  g43(.a(new_n46_), .b(new_n52_), .O(new_n77_));
  ...
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n42_), .O(z15));
  buf    g49(.a(x11), .O(z02));
  buf    g50(.a(x12), .O(z03));
endmodule
