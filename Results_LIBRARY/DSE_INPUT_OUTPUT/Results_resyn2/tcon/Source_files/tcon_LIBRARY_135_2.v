...
module FAU ( 
  ...
  nor2   g14(.a(x15), .b(x12), .O(new_n48_));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(z09));
  nand2  g27(.a(x08), .b(x02), .O(new_n61_));
  nand2  g28(.a(x11), .b(new_n54_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z10));
  nor2   g30(.a(new_n41_), .b(new_n54_), .O(new_n64_));
  ...
  oai21  g40(.a(new_n64_), .b(new_n48_), .c(new_n73_), .O(z14));
