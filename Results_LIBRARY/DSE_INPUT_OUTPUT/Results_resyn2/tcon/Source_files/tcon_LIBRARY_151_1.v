...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n65_, new_n67_, new_n68_, new_n69_, new_n70_, new_n73_, new_n74_,
    new_n76_, new_n77_;
  ...
  nand2  g33(.a(new_n41_), .b(new_n54_), .O(new_n67_));
  inv1   g34(.a(x04), .O(new_n68_));
  nand2  g35(.a(x08), .b(new_n68_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n67_), .c(new_n36_), .O(new_n70_));
  inv1   g37(.a(new_n70_), .O(z12));
  aoi22  g38(.a(new_n67_), .b(new_n35_), .c(new_n46_), .d(new_n54_), .O(z13));
