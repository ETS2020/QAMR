...
module FAU ( 
  ...
  nor2   g16(.a(new_n49_), .b(x00), .O(new_n50_));
  inv1   g17(.a(x16), .O(new_n51_));
  nor2   g18(.a(new_n51_), .b(x08), .O(new_n52_));
  aoi21  g19(.a(new_n52_), .b(new_n34_), .c(new_n50_), .O(z08));
  nand2  g20(.a(x16), .b(new_n49_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  oai21  g22(.a(new_n54_), .b(new_n37_), .c(new_n55_), .O(z09));
  nor2   g23(.a(new_n49_), .b(x02), .O(new_n57_));
  aoi21  g24(.a(new_n52_), .b(new_n39_), .c(new_n57_), .O(z10));
  nor2   g25(.a(new_n49_), .b(x03), .O(new_n59_));
  aoi21  g26(.a(new_n52_), .b(new_n41_), .c(new_n59_), .O(z11));
  nor2   g27(.a(new_n49_), .b(x04), .O(new_n61_));
  aoi21  g28(.a(new_n52_), .b(new_n43_), .c(new_n61_), .O(z12));
  nor2   g29(.a(new_n49_), .b(x05), .O(new_n63_));
  aoi21  g30(.a(new_n52_), .b(new_n45_), .c(new_n63_), .O(z13));
  nand2  g31(.a(x08), .b(x06), .O(new_n65_));
  oai21  g32(.a(new_n54_), .b(new_n47_), .c(new_n65_), .O(z14));
  inv1   g33(.a(x07), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n67_), .O(z15));
  buf    g35(.a(x16), .O(z07));
endmodule
