...
module FAU ( 
  ...
  and2   g11(.a(new_n39_), .b(x14), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  nand2  g13(.a(new_n39_), .b(new_n46_), .O(z06));
  inv1   g14(.a(x16), .O(new_n48_));
  nand2  g15(.a(new_n39_), .b(new_n48_), .O(z07));
  inv1   g16(.a(x00), .O(new_n50_));
  nand2  g17(.a(new_n36_), .b(x08), .O(new_n51_));
  oai22  g18(.a(new_n51_), .b(new_n50_), .c(new_n34_), .d(x08), .O(z08));
  nand2  g19(.a(x08), .b(x01), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n36_), .O(z09));
  inv1   g21(.a(x02), .O(new_n55_));
  inv1   g22(.a(x08), .O(new_n56_));
  nor2   g23(.a(x10), .b(new_n56_), .O(new_n57_));
  ...
  oai22  g30(.a(new_n51_), .b(new_n63_), .c(new_n43_), .d(x08), .O(z12));
  ...
  oai22  g35(.a(new_n51_), .b(new_n68_), .c(new_n46_), .d(x08), .O(z14));
