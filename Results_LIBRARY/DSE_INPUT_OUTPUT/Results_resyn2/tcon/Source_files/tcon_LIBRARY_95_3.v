...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x07), .O(new_n35_));
  ...
  nand2  g30(.a(new_n41_), .b(new_n51_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n35_), .O(new_n65_));
  inv1   g32(.a(new_n65_), .O(z11));
  oai21  g33(.a(new_n51_), .b(x07), .c(x13), .O(new_n67_));
  ...
  nand2  g38(.a(new_n45_), .b(new_n51_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(new_n73_));
  inv1   g40(.a(new_n73_), .O(z13));
  nand2  g41(.a(x08), .b(x06), .O(new_n75_));
  nand2  g42(.a(x15), .b(new_n51_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n35_), .O(z14));
  oai21  g44(.a(x13), .b(x08), .c(x07), .O(new_n78_));
  oai21  g45(.a(new_n48_), .b(x08), .c(new_n78_), .O(z15));
endmodule
