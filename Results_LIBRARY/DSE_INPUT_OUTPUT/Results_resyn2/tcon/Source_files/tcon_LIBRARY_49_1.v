// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:03 2020
...
module FAU ( 
  ...
  nand2  g10(.a(x13), .b(new_n43_), .O(new_n44_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n44_), .O(new_n56_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n44_), .O(new_n61_));
  inv1   g28(.a(new_n61_), .O(z09));
  inv1   g29(.a(x02), .O(new_n63_));
  nand2  g30(.a(x08), .b(new_n63_), .O(new_n64_));
  nand2  g31(.a(new_n40_), .b(new_n54_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(new_n66_));
  inv1   g33(.a(new_n66_), .O(z10));
  inv1   g34(.a(x03), .O(new_n68_));
  nand2  g35(.a(x08), .b(new_n68_), .O(new_n69_));
  nand2  g36(.a(new_n42_), .b(new_n54_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(new_n71_));
  inv1   g38(.a(new_n71_), .O(z11));
  oai21  g39(.a(new_n54_), .b(new_n43_), .c(x13), .O(new_n73_));
  ...
  nand2  g44(.a(new_n46_), .b(new_n54_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n44_), .O(new_n79_));
  inv1   g46(.a(new_n79_), .O(z13));
  inv1   g47(.a(x06), .O(new_n81_));
  nand2  g48(.a(x08), .b(new_n81_), .O(new_n82_));
  nand2  g49(.a(new_n48_), .b(new_n54_), .O(new_n83_));
  nand3  g50(.a(new_n83_), .b(new_n82_), .c(new_n44_), .O(new_n84_));
  inv1   g51(.a(new_n84_), .O(z14));
  nand2  g52(.a(new_n35_), .b(new_n54_), .O(new_n86_));
  aoi22  g53(.a(new_n86_), .b(new_n43_), .c(new_n50_), .d(new_n54_), .O(z15));
  buf    g54(.a(x13), .O(z04));
endmodule
