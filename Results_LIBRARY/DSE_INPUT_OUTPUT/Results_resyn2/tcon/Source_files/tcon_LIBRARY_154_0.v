...
module FAU ( 
  ...
  nand2  g15(.a(new_n36_), .b(x04), .O(z06));
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n39_), .O(z08));
  inv1   g22(.a(x01), .O(new_n56_));
  oai22  g23(.a(x15), .b(x04), .c(x10), .d(x08), .O(new_n57_));
  aoi21  g24(.a(x08), .b(new_n56_), .c(new_n57_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  oai22  g26(.a(x15), .b(x04), .c(x11), .d(x08), .O(new_n60_));
  ...
  oai22  g35(.a(x15), .b(x04), .c(x14), .d(x08), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  aoi22  g38(.a(new_n66_), .b(new_n36_), .c(x08), .d(new_n71_), .O(z14));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand2  g40(.a(x16), .b(new_n53_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n39_), .O(z15));
endmodule
