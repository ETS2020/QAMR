...
module FAU ( 
  ...
  aoi21  g17(.a(new_n35_), .b(x01), .c(new_n50_), .O(z07));
  ...
  aoi22  g29(.a(new_n53_), .b(new_n42_), .c(x08), .d(new_n62_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  aoi22  g31(.a(new_n53_), .b(new_n44_), .c(x08), .d(new_n64_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(new_n53_), .b(x14), .O(new_n67_));
