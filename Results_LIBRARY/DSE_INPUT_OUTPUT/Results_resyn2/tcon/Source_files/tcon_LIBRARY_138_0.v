...
module FAU ( 
  ...
  oai22  g17(.a(x13), .b(x12), .c(x09), .d(x08), .O(new_n51_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n44_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n54_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n44_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  inv1   g27(.a(x13), .O(new_n61_));
  nand2  g28(.a(x12), .b(x08), .O(new_n62_));
  oai21  g29(.a(new_n61_), .b(x12), .c(new_n62_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n60_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  aoi22  g32(.a(new_n62_), .b(new_n61_), .c(x08), .d(new_n65_), .O(z12));
  inv1   g33(.a(x05), .O(new_n67_));
  oai22  g34(.a(x14), .b(x08), .c(x13), .d(x12), .O(new_n68_));
  aoi21  g35(.a(x08), .b(new_n67_), .c(new_n68_), .O(z13));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(x15), .b(new_n54_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n44_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  oai22  g40(.a(x16), .b(x08), .c(x13), .d(x12), .O(new_n74_));
