...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n49_, new_n51_, new_n52_, new_n53_, new_n56_, new_n57_,
  ...
  and2   g04(.a(x10), .b(x08), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(new_n36_), .b(new_n39_), .O(z02));
  ...
  aoi21  g12(.a(x10), .b(new_n35_), .c(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  aoi21  g14(.a(x10), .b(new_n35_), .c(new_n47_), .O(z06));
  ...
  aoi22  g32(.a(new_n52_), .b(new_n45_), .c(x08), .d(new_n65_), .O(z13));
