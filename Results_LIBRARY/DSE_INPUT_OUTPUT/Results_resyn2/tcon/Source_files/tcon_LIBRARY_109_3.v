...
module FAU ( 
  ...
  aoi21  g10(.a(x13), .b(x06), .c(new_n43_), .O(z06));
  ...
  oai21  g30(.a(new_n49_), .b(x06), .c(x13), .O(new_n64_));
  ...
  oai21  g36(.a(x13), .b(x08), .c(x06), .O(new_n70_));
  oai21  g37(.a(new_n43_), .b(x08), .c(new_n70_), .O(z14));
