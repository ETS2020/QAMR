...
module FAU ( 
  ...
  nand2  g09(.a(x16), .b(new_n42_), .O(z03));
  ...
  nand2  g17(.a(new_n50_), .b(x12), .O(z07));
  inv1   g18(.a(x00), .O(new_n52_));
  oai22  g19(.a(x16), .b(x12), .c(x09), .d(x08), .O(new_n53_));
  ...
  nand3  g24(.a(new_n57_), .b(new_n55_), .c(new_n36_), .O(z09));
  ...
  nand2  g29(.a(x16), .b(x08), .O(new_n63_));
  aoi22  g30(.a(new_n63_), .b(new_n42_), .c(x08), .d(new_n62_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  oai22  g32(.a(x16), .b(x12), .c(x13), .d(x08), .O(new_n66_));
  aoi21  g33(.a(x08), .b(new_n65_), .c(new_n66_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  oai22  g35(.a(x16), .b(x12), .c(x14), .d(x08), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n68_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  oai22  g38(.a(x16), .b(x12), .c(x15), .d(x08), .O(new_n72_));
  aoi21  g39(.a(x08), .b(new_n71_), .c(new_n72_), .O(z14));
  inv1   g40(.a(x07), .O(new_n74_));
  nand2  g41(.a(x12), .b(x08), .O(new_n75_));
  aoi22  g42(.a(new_n75_), .b(new_n50_), .c(x08), .d(new_n74_), .O(z15));
endmodule
