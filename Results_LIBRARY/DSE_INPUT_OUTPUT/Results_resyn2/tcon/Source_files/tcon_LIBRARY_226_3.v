...
module FAU ( 
  ...
  aoi22  g16(.a(x15), .b(x11), .c(x09), .d(new_n49_), .O(new_n50_));
  ...
  nand2  g22(.a(new_n35_), .b(x08), .O(new_n56_));
  nand3  g23(.a(new_n45_), .b(x11), .c(new_n49_), .O(new_n57_));
  oai21  g24(.a(new_n56_), .b(new_n55_), .c(new_n57_), .O(z10));
  inv1   g25(.a(x03), .O(new_n59_));
  nand2  g26(.a(x08), .b(new_n59_), .O(new_n60_));
  nand2  g27(.a(new_n40_), .b(new_n49_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(new_n62_));
  inv1   g29(.a(new_n62_), .O(z11));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  aoi22  g31(.a(x15), .b(x11), .c(x13), .d(new_n49_), .O(new_n65_));
  ...
  nand3  g37(.a(x15), .b(new_n38_), .c(new_n49_), .O(new_n71_));
  oai21  g38(.a(new_n56_), .b(new_n70_), .c(new_n71_), .O(z14));
