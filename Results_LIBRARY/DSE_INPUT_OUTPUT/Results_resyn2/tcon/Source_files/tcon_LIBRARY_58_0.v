...
module FAU ( 
  ...
  nand2  g21(.a(x08), .b(new_n54_), .O(z09));
  inv1   g22(.a(x10), .O(new_n56_));
  nor2   g23(.a(new_n56_), .b(x08), .O(new_n57_));
  nor2   g24(.a(new_n51_), .b(x02), .O(new_n58_));
  aoi21  g25(.a(new_n57_), .b(new_n37_), .c(new_n58_), .O(z10));
  nor2   g26(.a(new_n51_), .b(x03), .O(new_n60_));
  aoi21  g27(.a(new_n57_), .b(new_n40_), .c(new_n60_), .O(z11));
