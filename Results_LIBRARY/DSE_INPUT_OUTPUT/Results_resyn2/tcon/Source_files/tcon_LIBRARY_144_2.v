...
module FAU ( 
  ...
  nor2   g09(.a(x10), .b(new_n34_), .O(new_n43_));
  ...
  aoi21  g21(.a(new_n34_), .b(x08), .c(x10), .O(new_n55_));
  ...
  nand2  g26(.a(new_n37_), .b(new_n51_), .O(new_n60_));
  ...
  nand2  g36(.a(new_n42_), .b(new_n51_), .O(new_n70_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n38_), .O(new_n81_));
  inv1   g48(.a(new_n81_), .O(z14));
  inv1   g49(.a(x07), .O(new_n83_));
  nand2  g50(.a(x08), .b(new_n83_), .O(new_n84_));
  nand2  g51(.a(new_n49_), .b(new_n51_), .O(new_n85_));
  nand3  g52(.a(new_n85_), .b(new_n84_), .c(new_n38_), .O(new_n86_));
