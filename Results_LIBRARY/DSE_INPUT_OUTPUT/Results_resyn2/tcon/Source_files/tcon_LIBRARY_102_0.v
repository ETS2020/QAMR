...
module FAU ( 
  ...
  nor2   g01(.a(x14), .b(x06), .O(new_n35_));
  ...
  oai22  g17(.a(x14), .b(x06), .c(x09), .d(x08), .O(new_n51_));
  ...
  oai22  g24(.a(x14), .b(x06), .c(x11), .d(x08), .O(new_n58_));
  aoi21  g25(.a(x08), .b(new_n57_), .c(new_n58_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  oai22  g27(.a(x14), .b(x06), .c(x12), .d(x08), .O(new_n61_));
  ...
  inv1   g33(.a(x14), .O(new_n67_));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  aoi22  g35(.a(new_n68_), .b(new_n67_), .c(x08), .d(new_n66_), .O(z13));
  nand2  g36(.a(x15), .b(new_n54_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n68_), .c(new_n36_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(x16), .b(x08), .c(x14), .d(x06), .O(new_n73_));
