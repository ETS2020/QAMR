// Benchmark "FAU" written by ABC on Tue Aug 11 19:08:40 2020
...
module FAU ( 
  ...
  inv1   g05(.a(x09), .O(new_n39_));
  nand2  g06(.a(x11), .b(new_n39_), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n38_), .O(z03));
  ...
  aoi21  g16(.a(new_n35_), .b(x08), .c(x09), .O(new_n50_));
  ...
  nand2  g40(.a(new_n44_), .b(new_n51_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n40_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z13));
  nand2  g43(.a(x08), .b(x06), .O(new_n77_));
  nand2  g44(.a(x15), .b(new_n51_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n40_), .O(z14));
  nand2  g46(.a(x08), .b(x07), .O(new_n80_));
  nand2  g47(.a(x16), .b(new_n51_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n40_), .O(z15));
  buf    g49(.a(x09), .O(z00));
  buf    g50(.a(x11), .O(z02));
endmodule
