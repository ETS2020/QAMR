...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n46_, new_n49_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nand2  g17(.a(new_n35_), .b(new_n39_), .O(z07));
  ...
  nand2  g27(.a(new_n42_), .b(new_n53_), .O(new_n61_));
  ...
  nand2  g38(.a(new_n39_), .b(new_n53_), .O(new_n72_));
