...
module FAU ( 
  ...
  nand2  g23(.a(new_n56_), .b(new_n36_), .O(z09));
  inv1   g24(.a(x01), .O(new_n58_));
  nor2   g25(.a(x08), .b(new_n58_), .O(new_n59_));
  nor2   g26(.a(new_n53_), .b(x02), .O(new_n60_));
  aoi21  g27(.a(new_n59_), .b(new_n40_), .c(new_n60_), .O(z10));
  nor2   g28(.a(new_n53_), .b(x03), .O(new_n62_));
  aoi21  g29(.a(new_n59_), .b(new_n42_), .c(new_n62_), .O(z11));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  oai21  g31(.a(new_n54_), .b(new_n44_), .c(new_n64_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  oai21  g33(.a(new_n54_), .b(new_n46_), .c(new_n66_), .O(z13));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  oai21  g35(.a(new_n54_), .b(new_n48_), .c(new_n68_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  oai21  g37(.a(new_n54_), .b(new_n50_), .c(new_n70_), .O(z15));
endmodule
