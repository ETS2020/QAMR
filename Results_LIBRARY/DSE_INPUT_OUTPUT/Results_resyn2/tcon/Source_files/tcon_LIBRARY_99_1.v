...
module FAU ( 
  ...
  nand2  g37(.a(x13), .b(x08), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(z04), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n70_), .O(z12));
  ...
  nand2  g50(.a(new_n71_), .b(x16), .O(new_n84_));
  nand2  g51(.a(x08), .b(x07), .O(new_n85_));
  nand2  g52(.a(new_n85_), .b(new_n84_), .O(z15));
  buf    g53(.a(x16), .O(z07));
endmodule
