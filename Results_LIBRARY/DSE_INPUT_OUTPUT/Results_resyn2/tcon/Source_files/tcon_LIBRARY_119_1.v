...
module FAU ( 
  ...
  aoi21  g26(.a(x08), .b(new_n59_), .c(new_n51_), .O(z11));
  ...
  aoi22  g31(.a(new_n51_), .b(new_n44_), .c(x08), .d(new_n64_), .O(z13));
  ...
  aoi22  g36(.a(new_n51_), .b(new_n48_), .c(x08), .d(new_n69_), .O(z15));
  buf    g37(.a(x12), .O(z03));
endmodule
