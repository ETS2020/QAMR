...
module FAU ( 
  ...
  oai22  g33(.a(new_n56_), .b(new_n66_), .c(new_n45_), .d(x08), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  oai22  g35(.a(new_n56_), .b(new_n68_), .c(new_n47_), .d(x08), .O(z14));
