...
module FAU ( 
  ...
  nand2  g04(.a(x13), .b(x10), .O(new_n38_));
  ...
  nor2   g25(.a(new_n54_), .b(x01), .O(new_n59_));
  aoi21  g26(.a(new_n58_), .b(new_n38_), .c(new_n59_), .O(z09));
  nand2  g27(.a(x08), .b(x02), .O(new_n61_));
  aoi22  g28(.a(new_n35_), .b(x10), .c(x11), .d(new_n54_), .O(new_n62_));
  ...
  nor2   g33(.a(new_n54_), .b(x04), .O(new_n67_));
  aoi21  g34(.a(new_n58_), .b(new_n35_), .c(new_n67_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  aoi22  g36(.a(x14), .b(new_n54_), .c(new_n35_), .d(x10), .O(new_n70_));
