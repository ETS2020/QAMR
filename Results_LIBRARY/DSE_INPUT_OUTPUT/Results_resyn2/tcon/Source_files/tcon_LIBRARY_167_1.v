...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(x04), .O(new_n44_));
  ...
  nor2   g16(.a(new_n43_), .b(new_n35_), .O(z06));
  ...
  nand2  g34(.a(new_n43_), .b(new_n54_), .O(new_n68_));
  aoi22  g35(.a(new_n68_), .b(new_n35_), .c(new_n46_), .d(new_n54_), .O(z12));
  ...
  nand3  g41(.a(new_n74_), .b(new_n68_), .c(new_n36_), .O(new_n75_));
