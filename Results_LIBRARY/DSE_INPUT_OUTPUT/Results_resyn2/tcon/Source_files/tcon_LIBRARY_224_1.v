...
module FAU ( 
  ...
  and2   g05(.a(x11), .b(x08), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  nand2  g07(.a(x11), .b(new_n34_), .O(new_n41_));
  nand2  g08(.a(new_n41_), .b(new_n40_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  aoi21  g10(.a(x11), .b(new_n34_), .c(new_n43_), .O(z04));
  ...
  aoi21  g25(.a(x08), .b(new_n58_), .c(new_n52_), .O(z10));
  ...
  nand2  g30(.a(new_n52_), .b(x13), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(new_n52_), .b(x14), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  aoi22  g36(.a(new_n52_), .b(new_n47_), .c(x08), .d(new_n69_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand2  g38(.a(new_n52_), .b(x16), .O(new_n72_));
