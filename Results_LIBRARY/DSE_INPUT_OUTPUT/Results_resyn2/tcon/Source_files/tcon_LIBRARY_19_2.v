...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x10), .O(new_n44_));
  ...
  nand3  g16(.a(new_n44_), .b(x08), .c(x00), .O(new_n50_));
  inv1   g17(.a(x08), .O(new_n51_));
  nand3  g18(.a(new_n44_), .b(x09), .c(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z08));
  nand3  g20(.a(new_n44_), .b(x08), .c(x01), .O(new_n54_));
  nand3  g21(.a(x13), .b(x10), .c(new_n51_), .O(new_n55_));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(new_n60_));
  ...
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n44_), .O(new_n65_));
  inv1   g32(.a(new_n65_), .O(z11));
  nand2  g33(.a(x13), .b(new_n51_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n44_), .O(z12));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  aoi22  g37(.a(x14), .b(new_n51_), .c(new_n43_), .d(x10), .O(new_n71_));
