...
module FAU ( 
  ...
  nand2  g01(.a(x15), .b(new_n34_), .O(new_n35_));
  ...
  nand2  g37(.a(new_n45_), .b(new_n50_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(new_n72_));
  inv1   g39(.a(new_n72_), .O(z13));
  inv1   g40(.a(x15), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n50_), .O(new_n75_));
  ...
  nand2  g47(.a(x16), .b(new_n50_), .O(new_n81_));
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n35_), .O(z15));
  buf    g49(.a(x15), .O(z06));
endmodule
