...
module FAU ( 
  ...
  nor2   g10(.a(x15), .b(new_n43_), .O(new_n44_));
  ...
  nand2  g27(.a(new_n40_), .b(new_n53_), .O(new_n61_));
  ...
  nand2  g33(.a(new_n46_), .b(new_n53_), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n43_), .O(new_n68_));
  ...
  nor2   g40(.a(new_n53_), .b(x06), .O(new_n74_));
  aoi21  g41(.a(new_n68_), .b(new_n35_), .c(new_n74_), .O(z14));
  inv1   g42(.a(x07), .O(new_n76_));
  nand2  g43(.a(x08), .b(new_n76_), .O(new_n77_));
  nand2  g44(.a(new_n50_), .b(new_n53_), .O(new_n78_));
