...
module FAU ( 
  ...
  and2   g08(.a(new_n36_), .b(x13), .O(z04));
  ...
  nand2  g24(.a(new_n45_), .b(new_n51_), .O(new_n58_));
  inv1   g25(.a(x02), .O(new_n59_));
  nand2  g26(.a(x08), .b(new_n59_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n58_), .c(new_n36_), .O(new_n61_));
  ...
  nand2  g43(.a(new_n47_), .b(new_n51_), .O(new_n77_));
