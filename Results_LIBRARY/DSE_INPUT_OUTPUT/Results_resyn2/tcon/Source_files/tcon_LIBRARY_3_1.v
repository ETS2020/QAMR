...
module FAU ( 
  ...
  aoi22  g20(.a(new_n53_), .b(new_n39_), .c(new_n34_), .d(new_n52_), .O(z08));
  ...
  nand2  g42(.a(new_n50_), .b(new_n52_), .O(new_n76_));
  ...
  nand3  g47(.a(new_n80_), .b(new_n53_), .c(new_n40_), .O(new_n81_));
