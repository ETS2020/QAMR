...
module FAU ( 
  ...
  nand2  g09(.a(x13), .b(new_n40_), .O(new_n43_));
  nand2  g10(.a(new_n43_), .b(new_n42_), .O(z03));
  nor2   g11(.a(new_n35_), .b(new_n40_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nor2   g13(.a(new_n36_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n43_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nand2  g17(.a(new_n43_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n43_), .O(z08));
  ...
  nand2  g27(.a(new_n60_), .b(z02), .O(new_n61_));
  ...
  nand2  g32(.a(new_n60_), .b(x13), .O(new_n66_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n43_), .O(new_n72_));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(new_n77_));
  ...
  nand3  g48(.a(new_n81_), .b(new_n80_), .c(new_n43_), .O(new_n82_));
