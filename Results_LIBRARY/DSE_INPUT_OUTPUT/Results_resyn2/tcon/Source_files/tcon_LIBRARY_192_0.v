...
module FAU ( 
  ...
  nand2  g13(.a(new_n42_), .b(new_n46_), .O(z07));
  inv1   g14(.a(x00), .O(new_n48_));
  oai22  g15(.a(x15), .b(x10), .c(x09), .d(x08), .O(new_n49_));
  aoi21  g16(.a(x08), .b(new_n48_), .c(new_n49_), .O(z08));
  inv1   g17(.a(x01), .O(new_n51_));
  aoi21  g18(.a(x15), .b(x08), .c(x10), .O(new_n52_));
