...
module FAU ( 
  ...
  aoi21  g47(.a(x08), .b(new_n35_), .c(x15), .O(new_n81_));
  nor2   g48(.a(new_n54_), .b(x06), .O(new_n82_));
  nor2   g49(.a(new_n82_), .b(new_n81_), .O(z14));
  oai21  g50(.a(new_n39_), .b(x08), .c(x07), .O(new_n84_));
