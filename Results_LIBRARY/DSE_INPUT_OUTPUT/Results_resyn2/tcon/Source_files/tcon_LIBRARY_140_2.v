...
module FAU ( 
  ...
  oai22  g33(.a(new_n55_), .b(new_n66_), .c(new_n48_), .d(x08), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  oai22  g35(.a(new_n55_), .b(new_n68_), .c(new_n50_), .d(x08), .O(z14));
  nor2   g36(.a(new_n41_), .b(x07), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(x16), .c(new_n52_), .O(z15));
endmodule
