...
module FAU ( 
  ...
  aoi21  g32(.a(new_n54_), .b(new_n64_), .c(new_n65_), .O(z12));
  ...
  oai22  g37(.a(new_n62_), .b(new_n70_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(new_n62_), .b(new_n72_), .c(new_n50_), .d(x08), .O(z15));
endmodule
