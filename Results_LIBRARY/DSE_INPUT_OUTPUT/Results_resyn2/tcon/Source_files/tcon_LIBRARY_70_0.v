...
module FAU ( 
  ...
  aoi21  g27(.a(new_n54_), .b(new_n42_), .c(new_n60_), .O(z11));
  nand2  g28(.a(x11), .b(new_n52_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  oai21  g30(.a(new_n62_), .b(new_n44_), .c(new_n63_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  oai21  g32(.a(new_n62_), .b(new_n46_), .c(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  oai21  g34(.a(new_n62_), .b(new_n48_), .c(new_n67_), .O(z14));
