...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n67_, new_n68_,
    new_n70_, new_n71_;
  inv1   g00(.a(x08), .O(new_n34_));
  inv1   g01(.a(x09), .O(new_n35_));
  aoi21  g02(.a(new_n34_), .b(x06), .c(new_n35_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(new_n34_), .b(x06), .O(new_n38_));
  nand2  g05(.a(new_n38_), .b(new_n37_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  aoi21  g07(.a(new_n34_), .b(x06), .c(new_n40_), .O(z02));
  ...
  nor2   g19(.a(x08), .b(x06), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(x09), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z08));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand2  g23(.a(new_n53_), .b(x10), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z09));
  inv1   g25(.a(x02), .O(new_n59_));
  aoi22  g26(.a(new_n53_), .b(new_n40_), .c(x08), .d(new_n59_), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  aoi22  g28(.a(new_n53_), .b(new_n42_), .c(x08), .d(new_n61_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  aoi22  g30(.a(new_n53_), .b(new_n44_), .c(x08), .d(new_n63_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  aoi22  g32(.a(new_n53_), .b(new_n46_), .c(x08), .d(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand2  g34(.a(new_n53_), .b(x15), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand2  g37(.a(new_n53_), .b(x16), .O(new_n71_));
