...
module FAU ( 
  ...
  nor2   g01(.a(x13), .b(x06), .O(new_n35_));
  ...
  oai22  g17(.a(x13), .b(x06), .c(x09), .d(x08), .O(new_n51_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n38_), .O(z09));
  ...
  oai22  g27(.a(x13), .b(x06), .c(x12), .d(x08), .O(new_n61_));
  ...
  aoi22  g32(.a(new_n65_), .b(new_n64_), .c(x08), .d(new_n63_), .O(z12));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand2  g34(.a(x14), .b(new_n54_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n38_), .O(z13));
  nand2  g36(.a(x15), .b(new_n54_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n65_), .c(new_n38_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(x16), .b(x08), .c(x13), .d(x06), .O(new_n73_));
