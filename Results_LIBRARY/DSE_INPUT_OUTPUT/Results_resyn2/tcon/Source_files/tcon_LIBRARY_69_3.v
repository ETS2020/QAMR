...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n40_, new_n42_, new_n45_, new_n47_,
  ...
  aoi21  g12(.a(x16), .b(x08), .c(new_n45_), .O(z06));
  ...
  aoi21  g30(.a(new_n50_), .b(new_n62_), .c(new_n63_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  nor2   g32(.a(x14), .b(x08), .O(new_n66_));
  aoi21  g33(.a(new_n50_), .b(new_n65_), .c(new_n66_), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  oai22  g35(.a(new_n54_), .b(new_n68_), .c(new_n45_), .d(x08), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n53_), .O(z15));
  buf    g38(.a(x16), .O(z07));
endmodule
