...
module FAU ( 
  ...
  aoi21  g12(.a(x15), .b(x12), .c(new_n45_), .O(z05));
  ...
  nor2   g28(.a(new_n51_), .b(x03), .O(new_n62_));
  aoi21  g29(.a(new_n61_), .b(new_n41_), .c(new_n62_), .O(z11));
  ...
  nand2  g38(.a(new_n61_), .b(x15), .O(new_n72_));
  ...
  nand2  g43(.a(new_n48_), .b(new_n51_), .O(new_n77_));
