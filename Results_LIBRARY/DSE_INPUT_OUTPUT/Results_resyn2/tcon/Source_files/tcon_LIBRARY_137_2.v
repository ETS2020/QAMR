...
module FAU ( 
  ...
  nor2   g17(.a(x16), .b(x15), .O(new_n51_));
  ...
  nand2  g38(.a(new_n46_), .b(new_n55_), .O(new_n72_));
  ...
  nor2   g46(.a(new_n39_), .b(new_n55_), .O(new_n80_));
  nand2  g47(.a(x08), .b(x06), .O(new_n81_));
  oai21  g48(.a(new_n80_), .b(new_n35_), .c(new_n81_), .O(z14));
  nand2  g49(.a(x08), .b(x07), .O(new_n83_));
  oai21  g50(.a(new_n80_), .b(new_n51_), .c(new_n83_), .O(z15));
endmodule
