...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n75_, new_n77_, new_n78_, new_n79_;
  ...
  nand3  g21(.a(new_n54_), .b(new_n52_), .c(new_n42_), .O(z08));
  ...
  nand2  g36(.a(new_n35_), .b(new_n53_), .O(new_n70_));
  aoi22  g37(.a(new_n70_), .b(new_n41_), .c(new_n48_), .d(new_n53_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  nand2  g39(.a(x08), .b(new_n72_), .O(new_n73_));
  nand2  g40(.a(new_n50_), .b(new_n53_), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n42_), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(z14));
  inv1   g43(.a(x07), .O(new_n77_));
  nand2  g44(.a(x08), .b(new_n77_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n70_), .c(new_n42_), .O(new_n79_));
