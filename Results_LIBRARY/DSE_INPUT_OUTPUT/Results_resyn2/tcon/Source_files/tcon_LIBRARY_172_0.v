...
module FAU ( 
  ...
  nor2   g01(.a(x14), .b(x00), .O(new_n35_));
  ...
  nand2  g13(.a(new_n46_), .b(x00), .O(z05));
  ...
  oai22  g23(.a(x14), .b(x00), .c(x10), .d(x08), .O(new_n57_));
