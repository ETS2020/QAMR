...
module FAU ( 
  ...
  nor2   g06(.a(x06), .b(new_n39_), .O(new_n40_));
  ...
  nand2  g37(.a(new_n46_), .b(new_n56_), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n39_), .O(new_n72_));
