...
module FAU ( 
  ...
  aoi21  g04(.a(new_n34_), .b(new_n36_), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(new_n34_), .b(new_n36_), .O(new_n40_));
  ...
  nor2   g20(.a(new_n36_), .b(x01), .O(new_n54_));
  nor2   g21(.a(new_n34_), .b(x08), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n37_), .c(new_n54_), .O(z09));
  nand2  g23(.a(x09), .b(new_n36_), .O(new_n57_));
