...
module FAU ( 
  ...
  inv1   g32(.a(x13), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n51_), .O(new_n67_));
  ...
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n35_), .O(z14));
  nand2  g42(.a(new_n47_), .b(new_n51_), .O(new_n76_));
  inv1   g43(.a(x07), .O(new_n77_));
  nand2  g44(.a(x08), .b(new_n77_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n76_), .c(new_n35_), .O(new_n79_));
