...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n67_, new_n69_, new_n70_, new_n71_, new_n73_;
  inv1   g00(.a(x09), .O(new_n34_));
  nor2   g01(.a(x15), .b(x07), .O(new_n35_));
  ...
  aoi22  g38(.a(new_n71_), .b(new_n70_), .c(x08), .d(new_n69_), .O(z14));
  nand2  g39(.a(x16), .b(new_n60_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n71_), .c(new_n38_), .O(z15));
  buf    g41(.a(x15), .O(z06));
endmodule
