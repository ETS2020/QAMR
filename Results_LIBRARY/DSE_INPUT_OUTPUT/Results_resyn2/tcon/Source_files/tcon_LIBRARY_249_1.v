...
module FAU ( 
  ...
  nand2  g24(.a(new_n39_), .b(new_n54_), .O(new_n58_));
  ...
  nand2  g31(.a(new_n38_), .b(new_n54_), .O(new_n65_));
  ...
  nand2  g41(.a(new_n44_), .b(new_n54_), .O(new_n75_));
  ...
  nand3  g46(.a(new_n79_), .b(new_n78_), .c(new_n36_), .O(z13));
  nand2  g47(.a(x08), .b(x06), .O(new_n81_));
  nand2  g48(.a(x15), .b(new_n54_), .O(new_n82_));
  nand3  g49(.a(new_n82_), .b(new_n81_), .c(new_n36_), .O(z14));
  nand2  g50(.a(x08), .b(x07), .O(new_n84_));
  nand2  g51(.a(x16), .b(new_n54_), .O(new_n85_));
  nand3  g52(.a(new_n85_), .b(new_n84_), .c(new_n36_), .O(z15));
  buf    g53(.a(x10), .O(z01));
endmodule
