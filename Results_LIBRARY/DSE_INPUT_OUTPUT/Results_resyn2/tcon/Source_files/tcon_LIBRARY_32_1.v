...
module FAU ( 
  ...
  nand2  g31(.a(new_n43_), .b(new_n53_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n36_), .O(new_n66_));
  inv1   g33(.a(new_n66_), .O(z11));
  nand3  g34(.a(new_n36_), .b(x08), .c(x04), .O(new_n68_));
  nand3  g35(.a(x13), .b(x11), .c(new_n53_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z12));
  nand3  g37(.a(new_n36_), .b(x08), .c(x05), .O(new_n71_));
  nand3  g38(.a(new_n36_), .b(x14), .c(new_n53_), .O(new_n72_));
  ...
  aoi22  g46(.a(x16), .b(new_n53_), .c(x13), .d(new_n35_), .O(new_n80_));
