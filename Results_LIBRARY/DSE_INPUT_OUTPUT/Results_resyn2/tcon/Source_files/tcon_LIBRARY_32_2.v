...
module FAU ( 
  ...
  oai21  g26(.a(new_n35_), .b(new_n53_), .c(x11), .O(new_n60_));
  ...
  nand2  g31(.a(new_n42_), .b(new_n53_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n36_), .O(new_n66_));
  inv1   g33(.a(new_n66_), .O(z11));
  aoi21  g34(.a(new_n39_), .b(x08), .c(x13), .O(new_n68_));
  nor2   g35(.a(new_n53_), .b(x04), .O(new_n69_));
  nor2   g36(.a(new_n69_), .b(new_n68_), .O(z12));
  inv1   g37(.a(x05), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n71_), .O(new_n72_));
  nand2  g39(.a(new_n45_), .b(new_n53_), .O(new_n73_));
  ...
  nand2  g44(.a(new_n47_), .b(new_n53_), .O(new_n78_));
