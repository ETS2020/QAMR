...
module FAU ( 
  ...
  aoi21  g05(.a(new_n35_), .b(x11), .c(new_n38_), .O(z01));
  ...
  nand2  g27(.a(new_n48_), .b(x08), .O(new_n61_));
  nor2   g28(.a(new_n53_), .b(x02), .O(new_n62_));
  aoi21  g29(.a(new_n61_), .b(new_n40_), .c(new_n62_), .O(z10));
  ...
  nor2   g39(.a(new_n53_), .b(x06), .O(new_n73_));
  aoi21  g40(.a(new_n61_), .b(new_n35_), .c(new_n73_), .O(z14));
