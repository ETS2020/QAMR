...
module FAU ( 
  ...
  nand2  g08(.a(new_n41_), .b(x14), .O(new_n42_));
  ...
  nand2  g14(.a(new_n41_), .b(new_n35_), .O(z06));
  ...
  aoi22  g29(.a(new_n41_), .b(x14), .c(x11), .d(new_n53_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z10));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  nand2  g32(.a(x12), .b(new_n53_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n42_), .O(z11));
  nand3  g34(.a(new_n42_), .b(x08), .c(x04), .O(new_n68_));
  nand3  g35(.a(new_n42_), .b(x13), .c(new_n53_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z12));
  nand2  g37(.a(new_n35_), .b(new_n53_), .O(new_n71_));
  inv1   g38(.a(x05), .O(new_n72_));
  nand2  g39(.a(x08), .b(new_n72_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n71_), .c(new_n42_), .O(new_n74_));
  inv1   g41(.a(new_n74_), .O(z13));
  aoi21  g42(.a(new_n35_), .b(x08), .c(x15), .O(new_n76_));
  nor2   g43(.a(new_n53_), .b(x06), .O(new_n77_));
  nor2   g44(.a(new_n77_), .b(new_n76_), .O(z14));
  nand2  g45(.a(x08), .b(x07), .O(new_n79_));
  nand2  g46(.a(x16), .b(new_n53_), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n42_), .O(z15));
  buf    g48(.a(x14), .O(z05));
endmodule
