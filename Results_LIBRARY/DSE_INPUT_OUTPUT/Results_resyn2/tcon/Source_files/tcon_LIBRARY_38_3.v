...
module FAU ( 
  ...
  aoi21  g08(.a(x13), .b(x10), .c(new_n41_), .O(z03));
  ...
  oai21  g19(.a(x13), .b(new_n50_), .c(x10), .O(new_n53_));
  ...
  nand2  g33(.a(new_n66_), .b(new_n50_), .O(new_n67_));
  ...
  nand2  g40(.a(new_n43_), .b(new_n50_), .O(new_n74_));
