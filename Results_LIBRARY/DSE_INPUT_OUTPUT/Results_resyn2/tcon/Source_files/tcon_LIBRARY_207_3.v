...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n44_, new_n45_,
  ...
  nor2   g22(.a(x14), .b(new_n44_), .O(new_n56_));
  ...
  oai21  g35(.a(new_n53_), .b(new_n68_), .c(new_n45_), .O(z13));
  inv1   g36(.a(x06), .O(new_n70_));
  oai22  g37(.a(new_n53_), .b(new_n70_), .c(new_n47_), .d(x08), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(new_n53_), .b(new_n72_), .c(new_n49_), .d(x08), .O(z15));
endmodule
