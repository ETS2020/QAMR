...
module FAU ( 
  ...
  nor2   g20(.a(new_n40_), .b(x08), .O(new_n54_));
  ...
  nand2  g26(.a(x08), .b(new_n59_), .O(z10));
  nor2   g27(.a(new_n52_), .b(x03), .O(new_n61_));
  aoi21  g28(.a(new_n54_), .b(new_n42_), .c(new_n61_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  oai21  g30(.a(new_n56_), .b(new_n44_), .c(new_n63_), .O(z12));
  nor2   g31(.a(new_n52_), .b(x05), .O(new_n65_));
  aoi21  g32(.a(new_n54_), .b(new_n46_), .c(new_n65_), .O(z13));
  nor2   g33(.a(new_n52_), .b(x06), .O(new_n67_));
  aoi21  g34(.a(new_n54_), .b(new_n48_), .c(new_n67_), .O(z14));
  nor2   g35(.a(new_n52_), .b(x07), .O(new_n69_));
  aoi21  g36(.a(new_n54_), .b(new_n50_), .c(new_n69_), .O(z15));
endmodule
