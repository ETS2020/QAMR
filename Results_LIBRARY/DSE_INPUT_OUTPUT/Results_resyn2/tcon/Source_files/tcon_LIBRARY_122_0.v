...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(new_n39_), .O(z02));
  ...
  oai22  g17(.a(x12), .b(x11), .c(x09), .d(x08), .O(new_n51_));
  aoi21  g18(.a(x08), .b(new_n50_), .c(new_n51_), .O(z08));
  inv1   g19(.a(x01), .O(new_n53_));
  oai22  g20(.a(x12), .b(x11), .c(x10), .d(x08), .O(new_n54_));
  ...
  nand3  g25(.a(new_n58_), .b(new_n56_), .c(new_n42_), .O(z10));
  ...
  oai22  g33(.a(x14), .b(x08), .c(x12), .d(x11), .O(new_n67_));
  aoi21  g34(.a(x08), .b(new_n66_), .c(new_n67_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(x15), .b(x08), .c(x12), .d(x11), .O(new_n70_));
