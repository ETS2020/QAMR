...
module FAU ( 
  ...
  nand2  g12(.a(x16), .b(new_n44_), .O(new_n46_));
  ...
  nand2  g29(.a(new_n41_), .b(new_n49_), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n34_), .O(new_n64_));
  inv1   g31(.a(new_n64_), .O(z12));
  ...
  nand2  g37(.a(new_n70_), .b(x15), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z14));
  nor2   g40(.a(new_n49_), .b(x07), .O(new_n74_));
  aoi21  g41(.a(new_n70_), .b(new_n46_), .c(new_n74_), .O(z15));
endmodule
