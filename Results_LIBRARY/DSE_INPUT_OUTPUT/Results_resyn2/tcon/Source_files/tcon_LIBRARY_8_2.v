...
module FAU ( 
  ...
  nand2  g18(.a(new_n35_), .b(new_n41_), .O(z07));
  ...
  nand2  g28(.a(new_n40_), .b(new_n54_), .O(new_n62_));
  ...
  nand2  g37(.a(x13), .b(new_n54_), .O(new_n71_));
  ...
  nand2  g42(.a(new_n75_), .b(new_n74_), .O(z13));
  nand2  g43(.a(x08), .b(x06), .O(new_n77_));
  nand2  g44(.a(x15), .b(new_n54_), .O(new_n78_));
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n36_), .O(z14));
  nand2  g46(.a(x08), .b(x07), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n73_), .c(new_n36_), .O(z15));
endmodule
