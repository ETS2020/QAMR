...
module FAU ( 
  ...
  nand2  g23(.a(x13), .b(new_n50_), .O(new_n57_));
  ...
  nand2  g29(.a(x08), .b(new_n62_), .O(z12));
  ...
  nor2   g34(.a(new_n50_), .b(x07), .O(new_n68_));
  aoi21  g35(.a(new_n53_), .b(new_n48_), .c(new_n68_), .O(z15));
  buf    g36(.a(x13), .O(z04));
endmodule
