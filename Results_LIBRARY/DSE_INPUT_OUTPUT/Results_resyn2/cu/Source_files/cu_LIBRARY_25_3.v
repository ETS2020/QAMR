...
module FAU ( 
  ...
  aoi21  g08(.a(new_n33_), .b(new_n26_), .c(new_n30_), .O(z01));
  ...
  aoi21  g16(.a(new_n41_), .b(new_n28_), .c(new_n26_), .O(z02));
  nand3  g17(.a(new_n40_), .b(new_n37_), .c(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n28_), .c(new_n26_), .O(z03));
  nor4   g19(.a(new_n39_), .b(new_n29_), .c(new_n37_), .d(x00), .O(z04));
  nand3  g20(.a(new_n40_), .b(x01), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n28_), .c(new_n26_), .O(z05));
  inv1   g22(.a(new_n32_), .O(new_n48_));
  ...
  nand3  g39(.a(new_n38_), .b(new_n26_), .c(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(new_n48_), .O(z06));
  nor2   g41(.a(new_n39_), .b(new_n29_), .O(z07));
  aoi21  g42(.a(new_n65_), .b(new_n62_), .c(new_n48_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  aoi21  g44(.a(x05), .b(x03), .c(new_n69_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x06), .c(new_n28_), .O(new_n72_));
