...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(new_n29_), .c(new_n27_), .O(z02));
  nand3  g20(.a(new_n43_), .b(new_n40_), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n29_), .c(new_n27_), .O(z03));
  nand3  g22(.a(new_n43_), .b(x01), .c(new_n39_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n29_), .c(new_n27_), .O(z04));
  nand3  g24(.a(new_n29_), .b(x05), .c(x01), .O(new_n50_));
  nor3   g25(.a(new_n50_), .b(new_n42_), .c(new_n39_), .O(z05));
  ...
  aoi21  g42(.a(new_n42_), .b(new_n29_), .c(new_n27_), .O(z07));
