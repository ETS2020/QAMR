...
module FAU ( 
  ...
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n31_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  nor2   g21(.a(new_n30_), .b(new_n26_), .O(new_n47_));
  ...
  oai21  g35(.a(new_n60_), .b(new_n49_), .c(new_n31_), .O(z06));
  ...
  nand2  g41(.a(new_n66_), .b(new_n31_), .O(z09));
