...
module FAU ( 
  ...
  nand2  g00(.a(x12), .b(x11), .O(new_n26_));
  ...
  oai21  g22(.a(new_n47_), .b(new_n39_), .c(new_n26_), .O(z03));
  nor2   g23(.a(new_n43_), .b(new_n45_), .O(z04));
  nor3   g24(.a(new_n41_), .b(new_n45_), .c(new_n34_), .O(z05));
  ...
  nand3  g40(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nor2   g42(.a(new_n38_), .b(x03), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n26_), .O(z06));
  inv1   g45(.a(new_n68_), .O(new_n71_));
  nand3  g46(.a(new_n35_), .b(new_n27_), .c(x02), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n63_), .c(new_n71_), .O(z08));
  nand3  g48(.a(new_n26_), .b(x13), .c(x06), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z09));
  nand3  g50(.a(new_n30_), .b(new_n26_), .c(x06), .O(new_n76_));
