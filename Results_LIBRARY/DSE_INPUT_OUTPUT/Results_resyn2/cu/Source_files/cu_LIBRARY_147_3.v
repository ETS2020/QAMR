...
module FAU ( 
  ...
  inv1   g12(.a(new_n36_), .O(z07));
  nand2  g13(.a(z07), .b(x00), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x01), .O(z03));
  inv1   g15(.a(x00), .O(new_n41_));
  nand4  g16(.a(new_n30_), .b(new_n34_), .c(x01), .d(new_n41_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n26_), .c(new_n27_), .O(z04));
  inv1   g18(.a(x01), .O(new_n44_));
  nor2   g19(.a(new_n39_), .b(new_n44_), .O(z05));
  nand2  g20(.a(x05), .b(x02), .O(new_n46_));
  inv1   g21(.a(x08), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n44_), .c(x00), .O(new_n48_));
  oai21  g23(.a(x10), .b(new_n44_), .c(new_n48_), .O(new_n49_));
  inv1   g24(.a(x11), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(x01), .O(new_n51_));
  inv1   g26(.a(x09), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n44_), .c(new_n41_), .O(new_n53_));
  ...
  nand3  g35(.a(x13), .b(new_n55_), .c(x05), .O(new_n61_));
  oai21  g36(.a(new_n29_), .b(x13), .c(new_n27_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x02), .O(new_n63_));
  oai21  g38(.a(new_n61_), .b(new_n29_), .c(new_n63_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n46_), .O(z09));
  nand3  g41(.a(new_n46_), .b(x06), .c(new_n28_), .O(new_n67_));
