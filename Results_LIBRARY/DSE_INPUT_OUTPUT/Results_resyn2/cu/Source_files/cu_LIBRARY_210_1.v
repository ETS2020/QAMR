...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n65_, new_n66_, new_n68_, new_n70_,
    new_n71_;
  ...
  inv1   g14(.a(new_n32_), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n36_), .c(new_n26_), .d(new_n39_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x01), .O(z02));
  nand3  g17(.a(new_n40_), .b(new_n36_), .c(new_n26_), .O(new_n43_));
  ...
  nor3   g22(.a(new_n43_), .b(new_n44_), .c(new_n39_), .O(z05));
  inv1   g23(.a(x08), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n44_), .c(x00), .O(new_n50_));
  oai21  g25(.a(x10), .b(new_n44_), .c(new_n50_), .O(new_n51_));
  inv1   g26(.a(x11), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(x01), .O(new_n53_));
  inv1   g28(.a(x09), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n44_), .c(new_n39_), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nand4  g32(.a(x13), .b(new_n57_), .c(new_n56_), .d(new_n30_), .O(new_n58_));
  aoi21  g33(.a(new_n55_), .b(new_n53_), .c(new_n58_), .O(new_n59_));
  nor2   g34(.a(x05), .b(new_n30_), .O(new_n60_));
  aoi21  g35(.a(new_n59_), .b(new_n51_), .c(new_n60_), .O(new_n61_));
  nand2  g36(.a(x04), .b(new_n26_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n28_), .O(z06));
  nand2  g38(.a(new_n43_), .b(new_n28_), .O(z07));
  nor2   g39(.a(x12), .b(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(x13), .c(new_n60_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n62_), .c(new_n28_), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(x05), .c(new_n36_), .O(z09));
  nand2  g44(.a(x05), .b(x02), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n28_), .c(x06), .d(new_n26_), .O(new_n71_));
