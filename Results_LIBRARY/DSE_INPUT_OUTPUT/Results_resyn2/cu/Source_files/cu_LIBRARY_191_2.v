...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n43_, new_n45_,
  ...
  nand2  g14(.a(new_n39_), .b(x02), .O(new_n40_));
  nand2  g15(.a(x01), .b(new_n37_), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n35_), .c(new_n40_), .O(z04));
  inv1   g17(.a(x01), .O(new_n43_));
  nor3   g18(.a(new_n35_), .b(new_n43_), .c(new_n37_), .O(z05));
  ...
  nand3  g33(.a(new_n58_), .b(new_n56_), .c(new_n37_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n49_), .c(new_n40_), .O(z06));
  nand2  g36(.a(new_n40_), .b(new_n35_), .O(z07));
  nor2   g37(.a(new_n47_), .b(new_n29_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  aoi21  g39(.a(new_n39_), .b(x02), .c(new_n64_), .O(z09));
  nand2  g40(.a(new_n34_), .b(x06), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n40_), .O(z10));
endmodule
