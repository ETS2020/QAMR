...
module FAU ( 
  ...
  nand4  g19(.a(new_n37_), .b(x05), .c(new_n39_), .d(x00), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n41_), .O(z03));
  ...
  aoi21  g24(.a(new_n49_), .b(new_n37_), .c(new_n27_), .O(z05));
  nand2  g25(.a(x04), .b(new_n26_), .O(new_n51_));
  nand3  g26(.a(new_n40_), .b(new_n27_), .c(x02), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  inv1   g28(.a(x08), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n39_), .c(x00), .O(new_n55_));
  oai21  g30(.a(x10), .b(new_n39_), .c(new_n55_), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(x01), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n39_), .c(new_n38_), .O(new_n60_));
  ...
  oai21  g40(.a(new_n65_), .b(new_n51_), .c(new_n35_), .O(z06));
  aoi21  g41(.a(new_n41_), .b(new_n37_), .c(new_n27_), .O(z07));
  inv1   g42(.a(new_n63_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n37_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n52_), .c(new_n51_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  aoi21  g46(.a(x07), .b(x05), .c(new_n71_), .O(z09));
  nand2  g47(.a(x05), .b(x02), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x06), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n35_), .O(z10));
endmodule
