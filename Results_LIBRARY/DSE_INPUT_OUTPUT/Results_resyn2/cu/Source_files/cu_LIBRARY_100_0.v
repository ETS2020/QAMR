...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n70_, new_n73_, new_n75_, new_n76_;
  inv1   g00(.a(x03), .O(new_n26_));
  inv1   g01(.a(x02), .O(new_n27_));
  inv1   g02(.a(x04), .O(new_n28_));
  nand3  g03(.a(x05), .b(new_n28_), .c(new_n27_), .O(new_n29_));
  inv1   g04(.a(x05), .O(new_n30_));
  nand4  g05(.a(x07), .b(new_n30_), .c(x04), .d(x02), .O(new_n31_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n38_), .O(z04));
  oai21  g26(.a(new_n50_), .b(new_n48_), .c(new_n38_), .O(z05));
  ...
  nand4  g40(.a(new_n65_), .b(new_n62_), .c(new_n57_), .d(new_n37_), .O(new_n66_));
  nand4  g41(.a(new_n43_), .b(x07), .c(new_n30_), .d(x02), .O(new_n67_));
  nand2  g42(.a(x04), .b(new_n26_), .O(new_n68_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(z06));
  nand2  g44(.a(new_n43_), .b(new_n26_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n29_), .c(new_n38_), .O(z07));
  aoi21  g46(.a(new_n67_), .b(new_n64_), .c(new_n68_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n38_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n26_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n38_), .O(z10));
endmodule
