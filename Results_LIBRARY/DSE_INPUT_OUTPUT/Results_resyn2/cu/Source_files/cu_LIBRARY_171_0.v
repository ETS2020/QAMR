...
module FAU ( 
  ...
  oai21  g02(.a(new_n27_), .b(x05), .c(new_n26_), .O(new_n28_));
  aoi21  g03(.a(x05), .b(x02), .c(x03), .O(new_n29_));
  inv1   g04(.a(x05), .O(new_n30_));
  oai21  g05(.a(new_n30_), .b(x04), .c(new_n27_), .O(new_n31_));
  nand3  g06(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(z00));
  nand2  g07(.a(new_n31_), .b(new_n29_), .O(new_n33_));
  ...
  aoi21  g19(.a(new_n44_), .b(x12), .c(x04), .O(z02));
  nand3  g20(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x12), .c(x04), .O(z03));
  nand4  g22(.a(new_n41_), .b(x12), .c(x05), .d(new_n40_), .O(new_n48_));
  nand3  g23(.a(new_n34_), .b(new_n39_), .c(x01), .O(new_n49_));
  nor3   g24(.a(new_n49_), .b(new_n48_), .c(x00), .O(z04));
  nor3   g25(.a(new_n49_), .b(new_n48_), .c(new_n37_), .O(z05));
  ...
  nand3  g31(.a(new_n56_), .b(new_n54_), .c(new_n37_), .O(new_n57_));
  ...
  nand4  g37(.a(x13), .b(new_n26_), .c(x05), .d(new_n39_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n62_), .c(new_n57_), .d(new_n52_), .O(new_n65_));
  nand4  g40(.a(new_n41_), .b(new_n30_), .c(x04), .d(x02), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n42_), .b(x12), .c(x04), .O(z07));
  nand2  g45(.a(new_n66_), .b(new_n63_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n40_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n35_), .O(z08));
  nand2  g48(.a(new_n35_), .b(x06), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(new_n41_), .O(z09));
  inv1   g50(.a(new_n29_), .O(new_n76_));
