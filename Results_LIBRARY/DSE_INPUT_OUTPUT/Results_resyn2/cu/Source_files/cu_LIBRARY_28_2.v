...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_,
    new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n44_, new_n45_,
  ...
  nand4  g11(.a(new_n28_), .b(new_n33_), .c(x05), .d(new_n36_), .O(new_n37_));
  nand2  g12(.a(new_n26_), .b(x02), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  nand2  g14(.a(new_n39_), .b(x00), .O(new_n40_));
  oai21  g15(.a(new_n40_), .b(new_n37_), .c(new_n38_), .O(z03));
  oai21  g16(.a(new_n34_), .b(new_n39_), .c(new_n38_), .O(z04));
  nor3   g17(.a(new_n37_), .b(new_n39_), .c(new_n32_), .O(z05));
  inv1   g18(.a(x07), .O(new_n44_));
  nor2   g19(.a(new_n26_), .b(new_n36_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n54_), .c(new_n32_), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(new_n52_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n47_), .c(new_n38_), .O(z06));
  inv1   g34(.a(new_n37_), .O(z07));
  inv1   g35(.a(new_n28_), .O(new_n61_));
  nand2  g36(.a(new_n46_), .b(new_n45_), .O(new_n62_));
  nor2   g37(.a(new_n62_), .b(new_n61_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  aoi21  g39(.a(new_n26_), .b(x02), .c(new_n64_), .O(z09));
  nand2  g40(.a(new_n28_), .b(x06), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n38_), .O(z10));
endmodule
