...
module FAU ( 
  ...
  aoi21  g27(.a(new_n32_), .b(x01), .c(new_n52_), .O(new_n53_));
  and2   g28(.a(x10), .b(x01), .O(new_n54_));
  inv1   g29(.a(x08), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(x01), .c(new_n39_), .O(new_n56_));
  oai22  g31(.a(new_n56_), .b(new_n54_), .c(new_n53_), .d(new_n39_), .O(new_n57_));
  ...
  oai21  g40(.a(new_n65_), .b(new_n63_), .c(new_n34_), .O(z06));
  nand2  g41(.a(new_n61_), .b(new_n59_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n34_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n33_), .O(z09));
