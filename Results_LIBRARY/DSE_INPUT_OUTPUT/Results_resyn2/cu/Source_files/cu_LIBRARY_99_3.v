...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n71_;
  nand2  g00(.a(x13), .b(x10), .O(new_n26_));
  ...
  oai21  g07(.a(new_n31_), .b(new_n28_), .c(new_n32_), .O(new_n33_));
  ...
  nand4  g32(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x10), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n56_), .O(new_n63_));
  inv1   g38(.a(x03), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n64_), .O(new_n65_));
  aoi21  g40(.a(new_n63_), .b(new_n50_), .c(new_n65_), .O(z06));
  and2   g41(.a(new_n58_), .b(new_n50_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n65_), .c(new_n26_), .O(z08));
  nand3  g43(.a(x13), .b(new_n60_), .c(x06), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z09));
  nand2  g45(.a(new_n32_), .b(x06), .O(new_n71_));
