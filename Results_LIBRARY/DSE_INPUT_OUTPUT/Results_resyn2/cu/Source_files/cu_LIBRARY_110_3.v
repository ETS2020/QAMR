...
module FAU ( 
  ...
  nand2  g00(.a(x11), .b(x07), .O(new_n26_));
  ...
  nor2   g09(.a(new_n27_), .b(x04), .O(new_n35_));
  nor3   g10(.a(x13), .b(x03), .c(x02), .O(new_n36_));
  aoi21  g11(.a(x11), .b(x07), .c(x00), .O(new_n37_));
  ...
  nand2  g15(.a(new_n34_), .b(x00), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n40_), .c(new_n26_), .O(z03));
  nand4  g17(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(x01), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z04));
  nand2  g19(.a(x01), .b(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n40_), .c(new_n26_), .O(z05));
  ...
  nand4  g39(.a(new_n64_), .b(new_n60_), .c(new_n54_), .d(new_n49_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n48_), .O(new_n66_));
  ...
  nand2  g45(.a(new_n40_), .b(new_n26_), .O(z07));
  nand2  g46(.a(new_n63_), .b(new_n48_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n26_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n26_), .O(z09));
  nand3  g51(.a(new_n30_), .b(new_n26_), .c(x06), .O(new_n77_));
