...
module FAU ( 
  ...
  nand3  g04(.a(new_n29_), .b(new_n26_), .c(new_n28_), .O(new_n30_));
  oai21  g05(.a(new_n27_), .b(new_n26_), .c(new_n30_), .O(z00));
  oai21  g06(.a(new_n26_), .b(x04), .c(new_n29_), .O(new_n32_));
  aoi21  g07(.a(x05), .b(x02), .c(x03), .O(new_n33_));
  and2   g08(.a(new_n33_), .b(new_n32_), .O(z01));
  inv1   g09(.a(x00), .O(new_n35_));
  inv1   g10(.a(x01), .O(new_n36_));
  nor2   g11(.a(new_n26_), .b(x04), .O(new_n37_));
  ...
  nand2  g41(.a(new_n38_), .b(new_n37_), .O(new_n67_));
  oai21  g42(.a(x05), .b(new_n28_), .c(new_n67_), .O(z07));
  aoi21  g43(.a(new_n64_), .b(new_n60_), .c(new_n65_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  oai21  g45(.a(x05), .b(new_n28_), .c(new_n70_), .O(z09));
  nand2  g46(.a(new_n33_), .b(x06), .O(new_n72_));
