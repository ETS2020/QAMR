...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n70_, new_n71_, new_n74_;
  ...
  nand2  g06(.a(new_n31_), .b(x06), .O(new_n32_));
  aoi21  g07(.a(new_n32_), .b(new_n27_), .c(x03), .O(z01));
  inv1   g08(.a(z01), .O(z00));
  inv1   g09(.a(x00), .O(new_n35_));
  inv1   g10(.a(x01), .O(new_n36_));
  nor3   g11(.a(x13), .b(x04), .c(x03), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n28_), .c(new_n36_), .d(new_n35_), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(x06), .c(new_n26_), .O(z02));
  inv1   g14(.a(x13), .O(new_n40_));
  inv1   g15(.a(x06), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x03), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n31_), .c(new_n40_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x01), .c(new_n35_), .O(z03));
  nor3   g19(.a(new_n43_), .b(new_n36_), .c(x00), .O(z04));
  nand4  g20(.a(new_n37_), .b(new_n28_), .c(x01), .d(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x06), .c(new_n26_), .O(z05));
  ...
  nand3  g27(.a(new_n52_), .b(new_n50_), .c(new_n35_), .O(new_n53_));
  ...
  nand4  g34(.a(x13), .b(new_n59_), .c(x05), .d(new_n28_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n58_), .c(new_n53_), .d(new_n48_), .O(new_n62_));
  nand3  g37(.a(new_n40_), .b(new_n26_), .c(x02), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nor2   g39(.a(new_n29_), .b(x03), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g41(.a(new_n41_), .b(x05), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  inv1   g43(.a(new_n43_), .O(z07));
  nand2  g44(.a(new_n63_), .b(new_n60_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n65_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n67_), .O(z08));
  oai21  g47(.a(new_n40_), .b(new_n41_), .c(new_n67_), .O(z09));
  oai21  g48(.a(new_n26_), .b(new_n28_), .c(new_n42_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n67_), .O(z10));
endmodule
