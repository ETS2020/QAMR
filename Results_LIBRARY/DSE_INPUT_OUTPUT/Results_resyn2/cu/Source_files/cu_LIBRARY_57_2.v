...
module FAU ( 
  ...
  nand4  g15(.a(new_n28_), .b(new_n27_), .c(new_n40_), .d(x00), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x01), .O(z03));
  nand3  g17(.a(new_n37_), .b(x01), .c(new_n35_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n34_), .c(new_n32_), .O(z04));
  nor2   g19(.a(new_n41_), .b(new_n36_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  and2   g21(.a(x05), .b(x04), .O(new_n47_));
  nor2   g22(.a(new_n40_), .b(x12), .O(new_n48_));
