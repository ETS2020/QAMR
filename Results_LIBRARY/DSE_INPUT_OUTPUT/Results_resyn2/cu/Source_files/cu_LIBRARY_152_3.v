...
module FAU ( 
  ...
  aoi21  g04(.a(x04), .b(x02), .c(new_n29_), .O(new_n30_));
  ...
  aoi21  g16(.a(new_n41_), .b(new_n35_), .c(new_n28_), .O(z03));
  nor3   g17(.a(x13), .b(x03), .c(x02), .O(new_n43_));
  and2   g18(.a(new_n43_), .b(new_n29_), .O(z07));
  ...
  aoi21  g24(.a(new_n49_), .b(new_n37_), .c(x00), .O(new_n50_));
  oai21  g25(.a(x10), .b(new_n37_), .c(new_n50_), .O(new_n51_));
  inv1   g26(.a(x11), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(x01), .O(new_n53_));
  inv1   g28(.a(x09), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n37_), .c(new_n36_), .O(new_n55_));
  ...
  nor2   g34(.a(x13), .b(new_n35_), .O(new_n60_));
  ...
  nand3  g39(.a(x13), .b(new_n57_), .c(x05), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nor2   g41(.a(new_n60_), .b(new_n66_), .O(new_n67_));
  nor3   g42(.a(new_n67_), .b(new_n63_), .c(new_n27_), .O(z08));
  nand3  g43(.a(new_n26_), .b(x13), .c(x06), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z09));
  nand3  g45(.a(new_n26_), .b(x06), .c(new_n62_), .O(new_n71_));
