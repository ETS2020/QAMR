...
module FAU ( 
  ...
  nor2   g10(.a(new_n29_), .b(x03), .O(new_n36_));
  nand4  g11(.a(new_n36_), .b(new_n30_), .c(new_n35_), .d(new_n34_), .O(new_n37_));
  nor2   g12(.a(new_n37_), .b(x01), .O(z02));
  nand4  g13(.a(new_n36_), .b(new_n30_), .c(new_n35_), .d(x00), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x01), .O(z03));
  inv1   g15(.a(x01), .O(new_n41_));
  nor2   g16(.a(new_n37_), .b(new_n41_), .O(z04));
  nor2   g17(.a(new_n39_), .b(new_n41_), .O(z05));
  ...
  nand3  g23(.a(new_n48_), .b(new_n46_), .c(new_n34_), .O(new_n49_));
  ...
  nand4  g33(.a(new_n58_), .b(new_n54_), .c(new_n49_), .d(new_n44_), .O(new_n59_));
  nand3  g34(.a(new_n35_), .b(new_n29_), .c(x02), .O(new_n60_));
  ...
  nor3   g38(.a(new_n63_), .b(x04), .c(x02), .O(z07));
  aoi21  g39(.a(new_n60_), .b(new_n57_), .c(new_n61_), .O(z08));
  nand2  g40(.a(x13), .b(x06), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n27_), .O(z09));
  inv1   g42(.a(new_n27_), .O(new_n68_));
  nand2  g43(.a(x05), .b(x02), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x06), .c(new_n26_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n68_), .O(z10));
endmodule
