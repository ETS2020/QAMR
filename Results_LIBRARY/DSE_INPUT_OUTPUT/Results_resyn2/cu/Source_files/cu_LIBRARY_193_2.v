...
module FAU ( 
  ...
  nor3   g12(.a(new_n33_), .b(new_n37_), .c(x00), .O(z04));
  nand2  g13(.a(x01), .b(x00), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(new_n33_), .c(new_n30_), .O(z05));
  ...
  inv1   g31(.a(new_n33_), .O(z07));
  inv1   g32(.a(new_n27_), .O(new_n58_));
  nand2  g33(.a(new_n43_), .b(new_n42_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(new_n58_), .O(z08));
  nand2  g35(.a(new_n30_), .b(x06), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n32_), .O(z09));
  inv1   g37(.a(x02), .O(new_n63_));
  nor2   g38(.a(new_n29_), .b(new_n63_), .O(new_n64_));
  nor3   g39(.a(new_n64_), .b(new_n61_), .c(x03), .O(z10));
endmodule
