...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n42_, new_n44_, new_n45_,
  ...
  nand4  g09(.a(new_n28_), .b(new_n34_), .c(x05), .d(new_n33_), .O(new_n35_));
  ...
  nand2  g16(.a(x01), .b(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n35_), .c(new_n32_), .O(z05));
  inv1   g18(.a(x07), .O(new_n44_));
  nor2   g19(.a(new_n26_), .b(new_n33_), .O(new_n45_));
  nor2   g20(.a(new_n34_), .b(x12), .O(new_n46_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n54_), .c(new_n36_), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(new_n52_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(new_n47_), .O(z06));
  nand2  g34(.a(new_n35_), .b(new_n32_), .O(z07));
  ...
  nand2  g41(.a(new_n66_), .b(new_n32_), .O(z10));
endmodule
