...
module FAU ( 
  ...
  nand3  g16(.a(new_n41_), .b(new_n28_), .c(x05), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(x01), .c(new_n35_), .O(z03));
  inv1   g18(.a(new_n42_), .O(z07));
  nand2  g19(.a(z07), .b(x01), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x00), .O(z04));
  nor2   g21(.a(new_n45_), .b(new_n35_), .O(z05));
  ...
  nand3  g41(.a(new_n41_), .b(new_n27_), .c(x04), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  oai21  g43(.a(new_n63_), .b(new_n27_), .c(new_n48_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(z08));
  nand2  g45(.a(new_n32_), .b(x06), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(new_n37_), .O(z09));
  oai21  g47(.a(new_n27_), .b(new_n48_), .c(new_n60_), .O(new_n73_));
