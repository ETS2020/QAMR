...
module FAU ( 
  ...
  nor2   g09(.a(x08), .b(x02), .O(new_n35_));
  ...
  nor3   g17(.a(new_n42_), .b(new_n39_), .c(new_n31_), .O(z07));
  ...
  oai21  g28(.a(x09), .b(x01), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n53_), .b(x01), .c(new_n54_), .O(new_n55_));
  nand3  g30(.a(x10), .b(x01), .c(new_n38_), .O(new_n56_));
  nor2   g31(.a(new_n26_), .b(x02), .O(new_n57_));
  nor2   g32(.a(x12), .b(x07), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(x13), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n55_), .c(new_n52_), .O(new_n60_));
  nor2   g35(.a(new_n29_), .b(x03), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n51_), .O(z06));
  inv1   g38(.a(new_n61_), .O(new_n64_));
  nor2   g39(.a(x12), .b(x08), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n57_), .c(x13), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n52_), .c(new_n64_), .O(z08));
  nand2  g42(.a(x13), .b(x06), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n28_), .O(z09));
  nand2  g44(.a(x06), .b(new_n40_), .O(new_n70_));
  aoi21  g45(.a(new_n39_), .b(x05), .c(new_n70_), .O(z10));
endmodule
