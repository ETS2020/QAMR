...
module FAU ( 
  ...
  aoi21  g02(.a(new_n27_), .b(new_n26_), .c(x05), .O(new_n28_));
  inv1   g03(.a(x02), .O(new_n29_));
  inv1   g04(.a(x04), .O(new_n30_));
  nand4  g05(.a(x05), .b(new_n30_), .c(new_n26_), .d(new_n29_), .O(new_n31_));
  inv1   g06(.a(new_n31_), .O(new_n32_));
  nor2   g07(.a(new_n32_), .b(new_n28_), .O(z00));
  inv1   g08(.a(x05), .O(new_n34_));
  nor2   g09(.a(new_n34_), .b(x02), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n30_), .O(new_n36_));
  nand3  g11(.a(new_n34_), .b(x04), .c(x02), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(new_n36_), .c(x03), .O(z01));
  nand2  g13(.a(new_n34_), .b(x03), .O(new_n39_));
  inv1   g14(.a(x00), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nor2   g16(.a(new_n31_), .b(x13), .O(z07));
  nand3  g17(.a(z07), .b(new_n41_), .c(new_n40_), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n39_), .O(z02));
  nand3  g19(.a(z07), .b(new_n41_), .c(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  nand3  g21(.a(z07), .b(x01), .c(new_n40_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z04));
  nand3  g23(.a(z07), .b(x01), .c(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z05));
  inv1   g25(.a(x13), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n34_), .c(x02), .O(new_n52_));
  ...
  nand4  g41(.a(new_n66_), .b(new_n62_), .c(new_n57_), .d(new_n35_), .O(new_n67_));
  nand2  g42(.a(x04), .b(new_n26_), .O(new_n68_));
  aoi21  g43(.a(new_n67_), .b(new_n52_), .c(new_n68_), .O(z06));
  nand2  g44(.a(new_n26_), .b(new_n29_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n64_), .c(x05), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n52_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(x04), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n39_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  aoi21  g50(.a(new_n34_), .b(x03), .c(new_n75_), .O(z09));
  nor2   g51(.a(x06), .b(x03), .O(new_n77_));
  aoi21  g52(.a(new_n70_), .b(x05), .c(new_n77_), .O(z10));
endmodule
