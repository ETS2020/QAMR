...
module FAU ( 
  ...
  nand4  g05(.a(x12), .b(new_n30_), .c(x04), .d(x02), .O(new_n31_));
  ...
  nand4  g38(.a(x13), .b(new_n37_), .c(x05), .d(new_n27_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n63_), .c(new_n58_), .d(new_n53_), .O(new_n66_));
  nand4  g41(.a(new_n43_), .b(x12), .c(new_n30_), .d(x02), .O(new_n67_));
  ...
  nor2   g47(.a(new_n72_), .b(new_n43_), .O(z09));
