...
module FAU ( 
  ...
  nand2  g06(.a(x05), .b(new_n27_), .O(new_n32_));
  oai21  g07(.a(x05), .b(new_n29_), .c(new_n32_), .O(new_n33_));
  nand3  g08(.a(new_n33_), .b(new_n31_), .c(new_n26_), .O(z00));
  inv1   g09(.a(z00), .O(z01));
  inv1   g10(.a(x00), .O(new_n36_));
  inv1   g11(.a(x13), .O(new_n37_));
  nand3  g12(.a(new_n37_), .b(new_n28_), .c(new_n36_), .O(new_n38_));
  nor4   g13(.a(new_n38_), .b(new_n32_), .c(x03), .d(x02), .O(z02));
  inv1   g14(.a(x05), .O(new_n40_));
  nand4  g15(.a(new_n37_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n28_), .c(new_n40_), .O(z03));
  nand2  g19(.a(x05), .b(x01), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(z05));
  nand3  g21(.a(new_n37_), .b(new_n40_), .c(x02), .O(new_n48_));
  inv1   g22(.a(x12), .O(new_n49_));
  nand4  g23(.a(x13), .b(new_n49_), .c(x05), .d(new_n29_), .O(new_n50_));
  ...
  nand2  g28(.a(new_n54_), .b(new_n36_), .O(new_n55_));
  inv1   g29(.a(x09), .O(new_n56_));
  nand2  g30(.a(new_n56_), .b(x00), .O(new_n57_));
  nand2  g31(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  nand2  g32(.a(new_n48_), .b(new_n46_), .O(new_n59_));
  aoi21  g33(.a(new_n58_), .b(new_n53_), .c(new_n59_), .O(new_n60_));
  aoi21  g34(.a(new_n52_), .b(new_n46_), .c(new_n60_), .O(z06));
  aoi21  g35(.a(new_n41_), .b(new_n28_), .c(new_n40_), .O(z07));
  nand2  g36(.a(new_n52_), .b(new_n46_), .O(z08));
  nand2  g37(.a(x13), .b(x06), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(new_n46_), .O(z09));
  nand2  g39(.a(x06), .b(new_n26_), .O(new_n66_));
  aoi21  g40(.a(new_n30_), .b(x05), .c(new_n66_), .O(z10));
  zero   g41(.O(z04));
endmodule
