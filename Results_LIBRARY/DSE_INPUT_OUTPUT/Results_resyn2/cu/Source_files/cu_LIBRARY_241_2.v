...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n38_, new_n40_, new_n42_, new_n43_,
  ...
  nand4  g12(.a(new_n37_), .b(x06), .c(x05), .d(new_n36_), .O(new_n38_));
  nor4   g13(.a(new_n38_), .b(new_n30_), .c(x01), .d(x00), .O(z02));
  inv1   g14(.a(x00), .O(new_n40_));
  nor4   g15(.a(new_n38_), .b(new_n30_), .c(x01), .d(new_n40_), .O(z03));
  nand3  g16(.a(new_n29_), .b(new_n37_), .c(new_n36_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(x01), .c(new_n40_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x06), .c(new_n26_), .O(z04));
  nand4  g20(.a(x06), .b(x05), .c(x01), .d(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n42_), .O(z05));
  ...
  nand3  g29(.a(new_n54_), .b(new_n51_), .c(new_n40_), .O(new_n55_));
  ...
  nand3  g39(.a(new_n37_), .b(new_n26_), .c(x02), .O(new_n65_));
