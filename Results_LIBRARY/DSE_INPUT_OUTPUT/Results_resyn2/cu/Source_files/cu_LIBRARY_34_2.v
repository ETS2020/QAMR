...
module FAU ( 
  ...
  nor2   g14(.a(new_n31_), .b(x13), .O(z07));
  ...
  oai22  g20(.a(new_n45_), .b(new_n44_), .c(x05), .d(new_n26_), .O(z03));
  nand3  g21(.a(z07), .b(x01), .c(new_n38_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z04));
  nand2  g23(.a(x01), .b(x00), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n44_), .O(z05));
  ...
  nand3  g40(.a(new_n43_), .b(new_n35_), .c(x02), .O(new_n66_));
  ...
  oai22  g45(.a(new_n43_), .b(new_n70_), .c(x05), .d(new_n26_), .O(z09));
  nand2  g46(.a(new_n26_), .b(new_n29_), .O(new_n72_));
  aoi22  g47(.a(new_n72_), .b(x05), .c(new_n70_), .d(new_n26_), .O(z10));
endmodule
