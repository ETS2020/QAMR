...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    ...
    new_n44_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    new_n61_, new_n62_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_,
    new_n68_, new_n69_, new_n71_, new_n73_, new_n75_, new_n76_;
  nor3   g00(.a(x08), .b(x04), .c(x02), .O(new_n26_));
  ...
  nand3  g10(.a(new_n35_), .b(x05), .c(new_n30_), .O(new_n36_));
  inv1   g11(.a(new_n36_), .O(new_n37_));
  and2   g12(.a(new_n37_), .b(new_n26_), .O(z07));
  nand2  g13(.a(z07), .b(new_n34_), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x01), .O(z02));
  inv1   g15(.a(x08), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nor2   g17(.a(x02), .b(new_n34_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n37_), .c(new_n42_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n41_), .c(x04), .O(z03));
  nor2   g20(.a(new_n39_), .b(new_n42_), .O(z04));
  nand3  g21(.a(new_n43_), .b(new_n37_), .c(x01), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n41_), .c(x04), .O(z05));
  inv1   g23(.a(x07), .O(new_n49_));
  inv1   g24(.a(x10), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(x01), .O(new_n51_));
  nand2  g26(.a(new_n41_), .b(new_n42_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n51_), .c(new_n34_), .O(new_n53_));
  ...
  nand2  g37(.a(new_n28_), .b(new_n35_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  inv1   g39(.a(x04), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(x03), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nor2   g42(.a(new_n41_), .b(x04), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(z06));
  inv1   g45(.a(new_n66_), .O(new_n71_));
  aoi21  g46(.a(new_n63_), .b(new_n60_), .c(new_n71_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n68_), .O(z09));
