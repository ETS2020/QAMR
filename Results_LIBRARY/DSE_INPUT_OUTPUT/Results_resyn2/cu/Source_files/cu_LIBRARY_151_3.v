...
module FAU ( 
  ...
  oai21  g01(.a(x05), .b(new_n26_), .c(x04), .O(new_n27_));
  inv1   g02(.a(x04), .O(new_n28_));
  nand2  g03(.a(x05), .b(new_n26_), .O(new_n29_));
  aoi21  g04(.a(new_n29_), .b(new_n28_), .c(x03), .O(new_n30_));
  aoi22  g05(.a(new_n30_), .b(new_n27_), .c(x06), .d(x04), .O(z00));
  nand2  g06(.a(x06), .b(x04), .O(new_n32_));
  ...
  nand3  g39(.a(new_n64_), .b(new_n63_), .c(x02), .O(new_n65_));
  inv1   g40(.a(x03), .O(new_n66_));
  inv1   g41(.a(x06), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n66_), .O(new_n68_));
  aoi21  g43(.a(new_n65_), .b(new_n62_), .c(new_n68_), .O(z06));
  inv1   g44(.a(new_n41_), .O(z07));
  aoi21  g45(.a(new_n65_), .b(new_n60_), .c(new_n68_), .O(z08));
  nand3  g46(.a(x13), .b(x06), .c(new_n28_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z09));
  oai21  g48(.a(new_n63_), .b(new_n26_), .c(new_n66_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n28_), .c(new_n67_), .O(z10));
endmodule
