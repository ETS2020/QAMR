...
module FAU ( 
  ...
  nand2  g13(.a(x01), .b(new_n36_), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(new_n34_), .c(new_n38_), .O(z04));
  inv1   g15(.a(x01), .O(new_n41_));
  nor3   g16(.a(new_n34_), .b(new_n41_), .c(new_n36_), .O(z05));
  ...
  nand2  g37(.a(new_n34_), .b(new_n38_), .O(z07));
