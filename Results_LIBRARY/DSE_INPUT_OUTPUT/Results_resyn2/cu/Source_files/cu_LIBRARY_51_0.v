...
module FAU ( 
  ...
  nor2   g08(.a(x13), .b(new_n33_), .O(new_n34_));
  ...
  nor2   g15(.a(x01), .b(new_n40_), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z03));
  nand4  g18(.a(new_n36_), .b(new_n35_), .c(x01), .d(new_n40_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x11), .c(x13), .O(z04));
  nand4  g20(.a(new_n36_), .b(new_n35_), .c(x01), .d(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x11), .c(x13), .O(z05));
  ...
  nand3  g30(.a(new_n55_), .b(new_n52_), .c(new_n40_), .O(new_n56_));
  nand2  g31(.a(new_n33_), .b(x01), .O(new_n57_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n60_), .c(new_n56_), .d(new_n50_), .O(new_n65_));
  nand3  g40(.a(new_n34_), .b(new_n27_), .c(x02), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n49_), .O(z06));
  nand2  g42(.a(new_n36_), .b(new_n35_), .O(new_n68_));
  nor3   g43(.a(new_n68_), .b(x13), .c(new_n33_), .O(z07));
  inv1   g44(.a(new_n26_), .O(new_n70_));
  inv1   g45(.a(x13), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n27_), .c(x02), .O(new_n72_));
  and2   g47(.a(new_n72_), .b(new_n63_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n49_), .c(new_n70_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  aoi21  g50(.a(x13), .b(new_n75_), .c(new_n34_), .O(z09));
  nor2   g51(.a(new_n26_), .b(new_n75_), .O(new_n77_));
  and2   g52(.a(new_n77_), .b(new_n30_), .O(z10));
endmodule
