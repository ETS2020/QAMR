...
module FAU ( 
  ...
  nand2  g17(.a(x09), .b(new_n29_), .O(new_n43_));
  oai21  g18(.a(new_n38_), .b(new_n42_), .c(new_n43_), .O(z04));
  nor2   g19(.a(new_n40_), .b(new_n42_), .O(z05));
  ...
  nand2  g28(.a(new_n30_), .b(new_n42_), .O(new_n54_));
  ...
  nand4  g34(.a(new_n36_), .b(new_n30_), .c(new_n29_), .d(x02), .O(new_n60_));
