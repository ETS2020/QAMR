...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n31_, new_n37_, new_n38_,
    new_n40_;
  ...
  nand3  g10(.a(new_n37_), .b(x04), .c(x02), .O(new_n38_));
  aoi21  g11(.a(new_n38_), .b(new_n27_), .c(x03), .O(z08));
  inv1   g12(.a(x06), .O(new_n40_));
  oai22  g13(.a(new_n37_), .b(new_n40_), .c(new_n27_), .d(x03), .O(z09));
  aoi21  g14(.a(new_n40_), .b(new_n27_), .c(x03), .O(z10));
  zero   g15(.O(z02));
  zero   g16(.O(z03));
