...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n44_, new_n45_, new_n48_, new_n50_, new_n51_, new_n52_,
  ...
  nor2   g06(.a(x03), .b(x02), .O(new_n32_));
  oai21  g07(.a(new_n32_), .b(x05), .c(new_n31_), .O(new_n33_));
  oai21  g08(.a(new_n31_), .b(new_n28_), .c(new_n33_), .O(z00));
  oai21  g09(.a(x05), .b(new_n26_), .c(x04), .O(new_n35_));
  nand2  g10(.a(new_n27_), .b(new_n30_), .O(new_n36_));
  nand3  g11(.a(new_n36_), .b(new_n35_), .c(new_n29_), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(z01));
  inv1   g13(.a(x13), .O(new_n39_));
  nand4  g14(.a(new_n32_), .b(new_n39_), .c(x05), .d(new_n30_), .O(new_n40_));
  nor3   g15(.a(new_n40_), .b(x01), .c(x00), .O(z02));
  nor2   g16(.a(x05), .b(new_n29_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  inv1   g18(.a(x01), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n40_), .c(new_n43_), .O(z03));
  nor3   g21(.a(new_n40_), .b(new_n44_), .c(x00), .O(z04));
  nand2  g22(.a(x01), .b(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n40_), .c(new_n43_), .O(z05));
  inv1   g24(.a(x05), .O(new_n50_));
  nand3  g25(.a(new_n39_), .b(new_n50_), .c(x02), .O(new_n51_));
  ...
  nor2   g40(.a(x07), .b(x03), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n65_), .c(new_n62_), .d(new_n57_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x04), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n43_), .O(z06));
  inv1   g45(.a(new_n40_), .O(z07));
  nand2  g46(.a(x04), .b(new_n29_), .O(new_n72_));
  aoi21  g47(.a(new_n64_), .b(new_n51_), .c(new_n72_), .O(z08));
  inv1   g48(.a(x06), .O(new_n74_));
  nor3   g49(.a(new_n42_), .b(new_n39_), .c(new_n74_), .O(z09));
  nor2   g50(.a(new_n32_), .b(new_n50_), .O(new_n76_));
  aoi21  g51(.a(new_n74_), .b(new_n29_), .c(new_n76_), .O(z10));
endmodule
