...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n43_, new_n44_,
    new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    new_n60_, new_n61_, new_n65_, new_n66_, new_n67_, new_n69_;
  ...
  nor2   g10(.a(new_n27_), .b(x02), .O(new_n36_));
  nand4  g11(.a(new_n36_), .b(new_n30_), .c(new_n35_), .d(new_n34_), .O(new_n37_));
  nor2   g12(.a(new_n37_), .b(x01), .O(z02));
  inv1   g13(.a(x01), .O(new_n39_));
  nand4  g14(.a(new_n30_), .b(new_n35_), .c(new_n39_), .d(x00), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n26_), .c(new_n27_), .O(z03));
  nor2   g16(.a(new_n37_), .b(new_n39_), .O(z04));
  nand2  g17(.a(new_n36_), .b(new_n35_), .O(new_n43_));
  nand2  g18(.a(x01), .b(x00), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(new_n43_), .c(new_n31_), .O(z05));
  ...
  nand3  g35(.a(new_n35_), .b(new_n27_), .c(x02), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n60_), .c(new_n29_), .O(z06));
  nor2   g37(.a(new_n43_), .b(new_n31_), .O(z07));
  aoi21  g38(.a(new_n61_), .b(new_n58_), .c(new_n29_), .O(z08));
  inv1   g39(.a(x06), .O(new_n65_));
  aoi21  g40(.a(x05), .b(x02), .c(new_n65_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(x13), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z09));
  nand2  g43(.a(new_n66_), .b(new_n28_), .O(new_n69_));
