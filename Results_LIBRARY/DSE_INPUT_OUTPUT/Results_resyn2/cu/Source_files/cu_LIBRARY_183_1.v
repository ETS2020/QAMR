...
module FAU ( 
  ...
  aoi22  g07(.a(new_n32_), .b(new_n30_), .c(x06), .d(new_n26_), .O(z00));
  nand2  g08(.a(x06), .b(new_n26_), .O(new_n34_));
  nand2  g09(.a(new_n32_), .b(new_n30_), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n34_), .O(z01));
  inv1   g11(.a(x01), .O(new_n37_));
  nand2  g12(.a(new_n28_), .b(new_n37_), .O(new_n38_));
  ...
  nand4  g18(.a(new_n41_), .b(x05), .c(new_n40_), .d(x00), .O(new_n44_));
  ...
  nand4  g39(.a(new_n41_), .b(new_n64_), .c(new_n26_), .d(x02), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n40_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(z06));
  nand2  g42(.a(new_n40_), .b(new_n27_), .O(new_n68_));
  nand3  g43(.a(new_n41_), .b(x05), .c(new_n31_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n34_), .O(z07));
  aoi21  g45(.a(new_n65_), .b(new_n61_), .c(new_n66_), .O(z08));
  nand3  g46(.a(x13), .b(x06), .c(x05), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z09));
  aoi21  g48(.a(new_n68_), .b(x05), .c(new_n64_), .O(z10));
endmodule
