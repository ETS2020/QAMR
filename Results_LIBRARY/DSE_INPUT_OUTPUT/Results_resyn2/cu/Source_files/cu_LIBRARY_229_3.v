...
module FAU ( 
  ...
  nand4  g07(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(new_n26_), .O(z00));
  ...
  nor2   g16(.a(new_n41_), .b(new_n37_), .O(z02));
  nand2  g17(.a(new_n40_), .b(x00), .O(new_n43_));
  nand2  g18(.a(new_n28_), .b(new_n36_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n43_), .c(new_n32_), .O(z03));
  nand3  g20(.a(new_n28_), .b(x01), .c(new_n35_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n39_), .c(new_n32_), .O(z04));
  nand2  g22(.a(new_n28_), .b(x01), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n43_), .c(new_n32_), .O(z05));
  inv1   g24(.a(x07), .O(new_n50_));
  inv1   g25(.a(x10), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(x00), .c(x01), .O(new_n52_));
  inv1   g27(.a(x08), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n36_), .c(new_n35_), .O(new_n54_));
  ...
  nor2   g35(.a(new_n60_), .b(new_n29_), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n57_), .c(new_n50_), .O(new_n62_));
  inv1   g37(.a(x05), .O(new_n63_));
  nand3  g38(.a(new_n38_), .b(new_n63_), .c(x02), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n26_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n62_), .c(new_n65_), .O(z06));
  nand2  g41(.a(new_n41_), .b(new_n32_), .O(z07));
  inv1   g42(.a(new_n64_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n61_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(new_n65_), .O(z08));
  inv1   g45(.a(x06), .O(new_n71_));
  aoi21  g46(.a(new_n58_), .b(new_n71_), .c(new_n38_), .O(z09));
