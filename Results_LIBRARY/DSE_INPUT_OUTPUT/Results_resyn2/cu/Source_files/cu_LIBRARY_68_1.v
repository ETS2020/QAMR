...
module FAU ( 
  ...
  nor2   g14(.a(new_n39_), .b(new_n30_), .O(z07));
  ...
  oai21  g21(.a(new_n43_), .b(new_n45_), .c(new_n27_), .O(z05));
  ...
  nand2  g42(.a(new_n63_), .b(new_n60_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n27_), .O(z08));
  nand2  g45(.a(new_n27_), .b(x06), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(new_n38_), .O(z09));
  oai21  g47(.a(new_n26_), .b(new_n28_), .c(new_n37_), .O(new_n73_));
