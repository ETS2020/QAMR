...
module FAU ( 
  ...
  nand2  g09(.a(x05), .b(new_n26_), .O(new_n36_));
  inv1   g10(.a(new_n36_), .O(z03));
  nor2   g11(.a(new_n33_), .b(x13), .O(z06));
  oai21  g12(.a(new_n33_), .b(x13), .c(new_n36_), .O(z08));
  nand2  g13(.a(x13), .b(x06), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n36_), .O(z09));
  nand3  g15(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(new_n36_), .O(z10));
  zero   g17(.O(z02));
  zero   g18(.O(z04));
  zero   g19(.O(z07));
  inv1   g20(.a(new_n36_), .O(z05));
endmodule
