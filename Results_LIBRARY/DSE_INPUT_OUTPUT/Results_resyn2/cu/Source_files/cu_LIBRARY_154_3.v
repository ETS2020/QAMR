...
module FAU ( 
  ...
  nand2  g11(.a(x06), .b(x05), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n36_), .O(z01));
  inv1   g13(.a(x01), .O(new_n39_));
  nand2  g14(.a(new_n30_), .b(new_n39_), .O(new_n40_));
  inv1   g15(.a(x00), .O(new_n41_));
  nor2   g16(.a(x13), .b(x03), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n29_), .c(x05), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(new_n41_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n40_), .O(z02));
  nand2  g21(.a(new_n44_), .b(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n40_), .O(z03));
  nand2  g23(.a(new_n30_), .b(x01), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n45_), .O(z04));
  nor2   g25(.a(new_n49_), .b(new_n47_), .O(z05));
  inv1   g26(.a(x13), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n27_), .c(x02), .O(new_n53_));
  ...
  nor2   g38(.a(new_n27_), .b(x02), .O(new_n64_));
  inv1   g39(.a(x07), .O(new_n65_));
  inv1   g40(.a(x12), .O(new_n66_));
  nand3  g41(.a(x13), .b(new_n66_), .c(new_n65_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n64_), .c(new_n63_), .d(new_n58_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n53_), .O(new_n70_));
  nand2  g45(.a(x04), .b(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n37_), .O(z06));
  nand2  g49(.a(new_n42_), .b(new_n30_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n29_), .c(new_n27_), .O(z07));
  nand4  g51(.a(new_n64_), .b(x13), .c(new_n66_), .d(new_n29_), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(new_n53_), .c(new_n71_), .O(z08));
  aoi21  g53(.a(new_n52_), .b(new_n27_), .c(new_n29_), .O(z09));
  nand3  g54(.a(x06), .b(new_n27_), .c(new_n26_), .O(new_n80_));
