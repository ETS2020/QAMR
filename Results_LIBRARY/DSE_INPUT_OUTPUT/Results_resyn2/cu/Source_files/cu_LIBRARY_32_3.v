...
module FAU ( 
  ...
  nand2  g13(.a(new_n26_), .b(new_n38_), .O(new_n39_));
  nor4   g14(.a(new_n39_), .b(new_n37_), .c(x01), .d(x00), .O(z02));
  inv1   g15(.a(new_n37_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand2  g18(.a(new_n38_), .b(new_n43_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n26_), .O(z03));
  inv1   g20(.a(x00), .O(new_n46_));
  nand3  g21(.a(new_n38_), .b(x01), .c(new_n46_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n37_), .c(new_n26_), .O(z04));
  nand2  g23(.a(new_n38_), .b(x01), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n42_), .c(new_n26_), .O(z05));
  nand2  g25(.a(x10), .b(new_n46_), .O(new_n51_));
  inv1   g26(.a(x09), .O(new_n52_));
  nand3  g27(.a(x11), .b(new_n52_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n51_), .c(new_n43_), .O(new_n54_));
  inv1   g29(.a(x07), .O(new_n55_));
  nand2  g30(.a(new_n52_), .b(x00), .O(new_n56_));
