...
module FAU ( 
  ...
  nand4  g16(.a(new_n27_), .b(new_n35_), .c(new_n41_), .d(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x02), .O(z03));
  inv1   g18(.a(new_n36_), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(x01), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n39_), .O(z04));
  nand3  g21(.a(new_n38_), .b(new_n29_), .c(x00), .O(new_n47_));
  ...
  nand4  g35(.a(x13), .b(new_n60_), .c(x04), .d(new_n38_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n59_), .c(new_n54_), .d(new_n49_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(x05), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  nand3  g40(.a(new_n31_), .b(new_n35_), .c(new_n26_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  nand2  g42(.a(new_n27_), .b(new_n35_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(x05), .c(x02), .O(z07));
  oai21  g44(.a(new_n62_), .b(new_n26_), .c(new_n29_), .O(new_n70_));
  ...
  nand2  g49(.a(x06), .b(new_n38_), .O(new_n75_));
  nor2   g50(.a(new_n26_), .b(new_n29_), .O(new_n76_));
  aoi21  g51(.a(new_n75_), .b(new_n72_), .c(new_n76_), .O(z10));
endmodule
