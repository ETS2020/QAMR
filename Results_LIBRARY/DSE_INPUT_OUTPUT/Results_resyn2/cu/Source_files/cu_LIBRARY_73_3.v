...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n45_, new_n46_, new_n50_, new_n51_, new_n52_, new_n53_,
  ...
  oai22  g07(.a(new_n32_), .b(x02), .c(new_n28_), .d(x11), .O(z00));
  nand2  g08(.a(x11), .b(x02), .O(new_n34_));
  inv1   g09(.a(x02), .O(new_n35_));
  oai21  g10(.a(new_n26_), .b(x04), .c(new_n35_), .O(new_n36_));
  nand3  g11(.a(new_n36_), .b(new_n34_), .c(new_n28_), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(z01));
  inv1   g13(.a(x00), .O(new_n39_));
  inv1   g14(.a(x13), .O(new_n40_));
  nand3  g15(.a(new_n32_), .b(new_n40_), .c(new_n35_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z07));
  nand2  g17(.a(z07), .b(new_n39_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(x01), .c(new_n34_), .O(z02));
  inv1   g19(.a(x01), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n41_), .c(new_n34_), .O(z03));
  oai21  g22(.a(new_n43_), .b(new_n45_), .c(new_n34_), .O(z04));
  nor3   g23(.a(new_n41_), .b(new_n45_), .c(new_n39_), .O(z05));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x05), .d(new_n35_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n60_), .c(new_n55_), .d(new_n50_), .O(new_n64_));
  nand3  g39(.a(new_n40_), .b(new_n26_), .c(x02), .O(new_n65_));
  ...
  nand3  g44(.a(new_n67_), .b(new_n40_), .c(new_n26_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n56_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(x02), .O(new_n72_));
  nand2  g47(.a(new_n67_), .b(new_n63_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  aoi21  g50(.a(x11), .b(x02), .c(new_n75_), .O(z09));
