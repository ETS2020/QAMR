...
module FAU ( 
  ...
  nand2  g12(.a(x01), .b(new_n36_), .O(new_n38_));
  oai21  g13(.a(new_n38_), .b(new_n34_), .c(new_n27_), .O(z04));
  inv1   g14(.a(x01), .O(new_n40_));
  nor3   g15(.a(new_n34_), .b(new_n40_), .c(new_n36_), .O(z05));
  ...
  oai21  g38(.a(new_n48_), .b(new_n45_), .c(new_n27_), .O(z08));
