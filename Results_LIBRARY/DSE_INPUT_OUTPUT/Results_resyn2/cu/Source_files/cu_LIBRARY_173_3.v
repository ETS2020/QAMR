...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_, new_n44_,
  ...
  aoi21  g12(.a(new_n37_), .b(new_n26_), .c(new_n33_), .O(z02));
  nand3  g13(.a(new_n36_), .b(new_n35_), .c(x00), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n26_), .c(new_n33_), .O(z03));
  nand3  g15(.a(new_n36_), .b(x01), .c(new_n34_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n26_), .c(new_n33_), .O(z04));
  inv1   g17(.a(x03), .O(new_n43_));
  inv1   g18(.a(x13), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n43_), .c(new_n26_), .O(new_n45_));
  nor4   g20(.a(new_n45_), .b(new_n28_), .c(new_n35_), .d(new_n34_), .O(z05));
  nand2  g21(.a(x04), .b(new_n43_), .O(new_n47_));
  ...
  nor2   g32(.a(x12), .b(new_n33_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  nand3  g34(.a(x13), .b(new_n59_), .c(new_n26_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n58_), .c(new_n57_), .d(new_n52_), .O(new_n62_));
  nand3  g37(.a(new_n44_), .b(new_n33_), .c(x02), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n62_), .c(new_n47_), .O(z06));
  nor2   g39(.a(new_n36_), .b(x02), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n33_), .O(z07));
  oai21  g41(.a(new_n47_), .b(x13), .c(new_n33_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(x02), .O(new_n68_));
  nand4  g43(.a(new_n58_), .b(x13), .c(x04), .d(new_n43_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  oai21  g46(.a(new_n33_), .b(new_n26_), .c(new_n71_), .O(z09));
  nand2  g47(.a(new_n30_), .b(x06), .O(new_n73_));
