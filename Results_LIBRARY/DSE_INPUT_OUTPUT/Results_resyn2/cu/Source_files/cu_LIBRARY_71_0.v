...
module FAU ( 
  ...
  nand3  g18(.a(new_n38_), .b(new_n26_), .c(x00), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x01), .O(z03));
  nand3  g20(.a(new_n26_), .b(x01), .c(new_n40_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n37_), .c(new_n34_), .O(z04));
  oai21  g22(.a(new_n44_), .b(new_n41_), .c(new_n34_), .O(z05));
