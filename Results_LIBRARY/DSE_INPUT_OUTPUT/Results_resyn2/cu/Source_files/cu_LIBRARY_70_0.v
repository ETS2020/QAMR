...
module FAU ( 
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(x04), .d(new_n57_), .O(new_n59_));
  ...
  nand2  g37(.a(new_n62_), .b(new_n29_), .O(new_n63_));
  nor2   g38(.a(x13), .b(x05), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n31_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n63_), .O(z06));
  nor2   g41(.a(new_n37_), .b(new_n26_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  oai21  g43(.a(new_n60_), .b(new_n26_), .c(new_n29_), .O(new_n69_));
  ...
  nand2  g48(.a(x06), .b(new_n57_), .O(new_n74_));
  nor2   g49(.a(new_n26_), .b(new_n29_), .O(new_n75_));
  aoi21  g50(.a(new_n74_), .b(new_n71_), .c(new_n75_), .O(z10));
endmodule
