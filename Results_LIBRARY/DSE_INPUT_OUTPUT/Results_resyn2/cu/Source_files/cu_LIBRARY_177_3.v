...
module FAU ( 
  ...
  nor4   g18(.a(new_n43_), .b(new_n28_), .c(new_n35_), .d(x00), .O(z04));
  nand3  g19(.a(new_n36_), .b(x01), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n26_), .c(new_n33_), .O(z05));
  nand2  g21(.a(x05), .b(x02), .O(new_n47_));
  inv1   g22(.a(x08), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n35_), .c(x00), .O(new_n49_));
  oai21  g24(.a(x10), .b(new_n35_), .c(new_n49_), .O(new_n50_));
  inv1   g25(.a(x11), .O(new_n51_));
  nand2  g26(.a(new_n51_), .b(x01), .O(new_n52_));
  inv1   g27(.a(x09), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n35_), .c(new_n34_), .O(new_n54_));
  ...
  nand2  g35(.a(x04), .b(new_n41_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z06));
  nor2   g37(.a(new_n43_), .b(new_n28_), .O(z07));
  nand3  g38(.a(x13), .b(new_n56_), .c(x05), .O(new_n64_));
  inv1   g39(.a(new_n59_), .O(new_n65_));
  nand2  g40(.a(new_n30_), .b(x04), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z08));
  nand2  g42(.a(x13), .b(x06), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n47_), .O(z09));
  nand2  g44(.a(new_n30_), .b(x06), .O(new_n70_));
