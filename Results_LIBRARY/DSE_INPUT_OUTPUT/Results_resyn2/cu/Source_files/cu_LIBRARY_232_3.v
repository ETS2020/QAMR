...
module FAU ( 
  ...
  nand2  g06(.a(x03), .b(x01), .O(new_n32_));
  ...
  oai21  g17(.a(new_n42_), .b(new_n35_), .c(new_n32_), .O(z02));
  nand2  g18(.a(new_n41_), .b(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n35_), .c(new_n32_), .O(z03));
  nand2  g20(.a(new_n34_), .b(x01), .O(new_n46_));
  ...
  nand3  g38(.a(new_n39_), .b(new_n26_), .c(x02), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n37_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  nor2   g41(.a(new_n40_), .b(x02), .O(z07));
  and2   g42(.a(new_n64_), .b(new_n61_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n65_), .c(new_n32_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  aoi21  g45(.a(x03), .b(x01), .c(new_n70_), .O(z09));
