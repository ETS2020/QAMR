...
module FAU ( 
  ...
  nand4  g11(.a(new_n30_), .b(new_n28_), .c(new_n34_), .d(x00), .O(new_n37_));
  nor2   g12(.a(new_n37_), .b(x01), .O(z03));
  inv1   g13(.a(x01), .O(new_n39_));
  nor2   g14(.a(new_n35_), .b(new_n39_), .O(z04));
  nor2   g15(.a(new_n37_), .b(new_n39_), .O(z05));
  inv1   g16(.a(x10), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(x01), .O(new_n43_));
  inv1   g18(.a(x08), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(new_n39_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n43_), .c(new_n33_), .O(new_n46_));
  ...
  nand4  g31(.a(new_n56_), .b(x05), .c(x04), .d(new_n26_), .O(new_n57_));
  inv1   g32(.a(new_n57_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n55_), .c(new_n51_), .d(new_n46_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(z06));
  nor2   g35(.a(new_n31_), .b(x13), .O(z07));
  nand2  g36(.a(new_n55_), .b(x04), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(x05), .c(x03), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  oai21  g39(.a(x05), .b(x03), .c(new_n64_), .O(z09));
  nand3  g40(.a(new_n30_), .b(x06), .c(new_n52_), .O(new_n66_));
