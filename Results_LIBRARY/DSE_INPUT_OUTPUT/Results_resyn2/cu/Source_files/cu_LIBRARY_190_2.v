...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n37_, new_n38_, new_n39_, new_n42_, new_n44_,
  ...
  nor2   g07(.a(new_n32_), .b(x03), .O(new_n33_));
  aoi21  g08(.a(new_n33_), .b(new_n30_), .c(new_n27_), .O(z00));
  oai21  g09(.a(new_n29_), .b(x00), .c(new_n28_), .O(new_n35_));
  and2   g10(.a(new_n35_), .b(new_n33_), .O(z01));
  inv1   g11(.a(x03), .O(new_n37_));
  inv1   g12(.a(x13), .O(new_n38_));
  nand4  g13(.a(new_n31_), .b(new_n38_), .c(x05), .d(new_n37_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(x01), .c(x00), .O(z02));
  nor3   g15(.a(new_n39_), .b(x01), .c(new_n26_), .O(z03));
  inv1   g16(.a(x01), .O(new_n42_));
  nor3   g17(.a(new_n39_), .b(new_n42_), .c(x00), .O(z04));
  nand4  g18(.a(new_n31_), .b(new_n38_), .c(new_n37_), .d(x01), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(new_n26_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  inv1   g21(.a(x10), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(x01), .O(new_n48_));
  inv1   g23(.a(x08), .O(new_n49_));
  nand2  g24(.a(new_n49_), .b(new_n42_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n48_), .c(new_n26_), .O(new_n51_));
  ...
  nand2  g39(.a(x04), .b(new_n37_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n61_), .c(new_n65_), .O(z06));
  inv1   g41(.a(new_n27_), .O(new_n67_));
  nand2  g42(.a(new_n39_), .b(new_n67_), .O(z07));
  nor2   g43(.a(new_n63_), .b(new_n60_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n65_), .c(new_n67_), .O(z08));
