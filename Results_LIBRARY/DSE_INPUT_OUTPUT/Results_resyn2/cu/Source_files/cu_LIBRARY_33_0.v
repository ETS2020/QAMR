...
module FAU ( 
  ...
  nor2   g00(.a(x07), .b(x05), .O(new_n26_));
  ...
  oai21  g12(.a(new_n37_), .b(x07), .c(new_n34_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(z01));
  inv1   g14(.a(new_n26_), .O(new_n40_));
  inv1   g15(.a(x13), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n32_), .O(new_n42_));
  inv1   g17(.a(x00), .O(new_n43_));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n27_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n42_), .c(new_n40_), .O(z02));
  nand3  g21(.a(new_n27_), .b(new_n44_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n42_), .c(new_n40_), .O(z03));
  nand4  g23(.a(new_n37_), .b(new_n41_), .c(new_n32_), .d(x01), .O(new_n49_));
  ...
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n40_), .O(z06));
  nand2  g42(.a(new_n41_), .b(new_n32_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n36_), .c(new_n40_), .O(z07));
  nand2  g44(.a(new_n53_), .b(x07), .O(new_n70_));
  nand4  g45(.a(x13), .b(new_n62_), .c(x05), .d(new_n27_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n70_), .c(new_n66_), .O(z08));
