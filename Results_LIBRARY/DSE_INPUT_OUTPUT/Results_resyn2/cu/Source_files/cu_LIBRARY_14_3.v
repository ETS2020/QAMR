...
module FAU ( 
  ...
  aoi21  g13(.a(new_n38_), .b(new_n27_), .c(new_n26_), .O(z02));
  nor3   g14(.a(new_n31_), .b(new_n30_), .c(x13), .O(z07));
  nand3  g15(.a(z07), .b(new_n36_), .c(x00), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z03));
  nand3  g17(.a(new_n37_), .b(x01), .c(new_n35_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n27_), .c(new_n26_), .O(z04));
  ...
  nand4  g38(.a(new_n63_), .b(new_n26_), .c(new_n27_), .d(x02), .O(new_n64_));
  ...
  nand2  g43(.a(new_n64_), .b(new_n60_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x04), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n67_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n67_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x06), .c(new_n27_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n67_), .O(z10));
endmodule
