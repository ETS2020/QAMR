...
module FAU ( 
  ...
  oai21  g02(.a(new_n27_), .b(x02), .c(x11), .O(new_n28_));
  inv1   g03(.a(x02), .O(new_n29_));
  oai21  g04(.a(new_n26_), .b(new_n29_), .c(new_n27_), .O(new_n30_));
  aoi21  g05(.a(x05), .b(x02), .c(x03), .O(new_n31_));
  nand3  g06(.a(new_n31_), .b(new_n30_), .c(new_n28_), .O(z00));
  nand2  g07(.a(new_n31_), .b(new_n30_), .O(new_n33_));
  inv1   g08(.a(x05), .O(new_n34_));
  nand2  g09(.a(x11), .b(new_n34_), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n33_), .O(z01));
  inv1   g11(.a(x03), .O(new_n37_));
  inv1   g12(.a(x13), .O(new_n38_));
  nor2   g13(.a(new_n34_), .b(x04), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(new_n40_));
  inv1   g15(.a(x00), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand3  g17(.a(new_n29_), .b(new_n42_), .c(new_n41_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n40_), .c(new_n35_), .O(z02));
  nand3  g19(.a(new_n29_), .b(new_n42_), .c(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n40_), .c(new_n35_), .O(z03));
  nand4  g21(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n29_), .O(new_n47_));
  nand2  g22(.a(x01), .b(new_n41_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n35_), .O(z04));
  ...
  nand4  g37(.a(x13), .b(new_n62_), .c(x05), .d(new_n29_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n56_), .d(new_n51_), .O(new_n65_));
  nand3  g40(.a(new_n38_), .b(new_n34_), .c(x02), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n57_), .O(new_n68_));
  nand2  g43(.a(x04), .b(new_n37_), .O(new_n69_));
  aoi21  g44(.a(new_n68_), .b(new_n65_), .c(new_n69_), .O(z06));
  nand2  g45(.a(new_n47_), .b(new_n35_), .O(z07));
  nor2   g46(.a(new_n67_), .b(new_n64_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n69_), .c(new_n35_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  aoi21  g49(.a(x11), .b(new_n34_), .c(new_n74_), .O(z09));
  nand2  g50(.a(new_n31_), .b(x06), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n35_), .O(z10));
endmodule
