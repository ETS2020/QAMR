...
module FAU ( 
  ...
  nand4  g16(.a(new_n41_), .b(new_n26_), .c(new_n36_), .d(new_n35_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x01), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n41_), .b(new_n44_), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n36_), .c(x13), .O(z03));
  nor2   g21(.a(new_n42_), .b(new_n44_), .O(z04));
  nand3  g22(.a(new_n41_), .b(x01), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n36_), .c(x13), .O(z05));
  nand2  g24(.a(x04), .b(new_n38_), .O(new_n50_));
  inv1   g25(.a(x07), .O(new_n51_));
  nand2  g26(.a(new_n36_), .b(x01), .O(new_n52_));
  inv1   g27(.a(x08), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(new_n44_), .O(new_n54_));
  nand3  g29(.a(new_n54_), .b(new_n52_), .c(new_n35_), .O(new_n55_));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x05), .d(new_n37_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n60_), .c(new_n55_), .d(new_n51_), .O(new_n64_));
  nand4  g39(.a(new_n26_), .b(new_n36_), .c(new_n28_), .d(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(new_n50_), .O(z06));
  nor3   g41(.a(new_n40_), .b(x13), .c(x10), .O(z07));
  nand3  g42(.a(new_n26_), .b(new_n28_), .c(x02), .O(new_n68_));
  and2   g43(.a(new_n68_), .b(new_n62_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n50_), .c(new_n27_), .O(z08));
  and2   g45(.a(x13), .b(x06), .O(z09));
  nand2  g46(.a(new_n31_), .b(x06), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n27_), .O(z10));
endmodule
