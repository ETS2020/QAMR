...
module FAU ( 
  ...
  nor3   g14(.a(new_n34_), .b(new_n36_), .c(x00), .O(z04));
  nor3   g15(.a(new_n34_), .b(new_n36_), .c(new_n35_), .O(z05));
  ...
  inv1   g33(.a(new_n29_), .O(new_n59_));
  nand2  g34(.a(new_n44_), .b(new_n43_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(new_n59_), .O(z08));
  inv1   g36(.a(x06), .O(new_n62_));
  oai21  g37(.a(new_n33_), .b(new_n62_), .c(new_n27_), .O(z09));
  oai21  g38(.a(new_n59_), .b(new_n62_), .c(new_n27_), .O(z10));
endmodule
