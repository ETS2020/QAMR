...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n59_, new_n60_, new_n61_, new_n62_, new_n66_, new_n68_, new_n69_;
  ...
  nand2  g22(.a(x05), .b(x00), .O(new_n48_));
  nor3   g23(.a(new_n44_), .b(new_n48_), .c(new_n42_), .O(z05));
  nand3  g24(.a(new_n43_), .b(new_n31_), .c(x02), .O(new_n50_));
  inv1   g25(.a(x12), .O(new_n51_));
  nand4  g26(.a(x13), .b(new_n51_), .c(x05), .d(new_n29_), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(x04), .c(new_n38_), .O(new_n54_));
  ...
  nand2  g35(.a(new_n50_), .b(new_n27_), .O(new_n61_));
  aoi21  g36(.a(new_n60_), .b(new_n55_), .c(new_n61_), .O(new_n62_));
  aoi21  g37(.a(new_n54_), .b(new_n27_), .c(new_n62_), .O(z06));
  nor2   g38(.a(new_n44_), .b(new_n48_), .O(z07));
  nand2  g39(.a(new_n54_), .b(new_n27_), .O(z08));
  nand2  g40(.a(x13), .b(x06), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n27_), .O(z09));
  nand2  g42(.a(x05), .b(x02), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x06), .c(new_n38_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n27_), .O(z10));
  inv1   g45(.a(new_n27_), .O(z04));
endmodule
