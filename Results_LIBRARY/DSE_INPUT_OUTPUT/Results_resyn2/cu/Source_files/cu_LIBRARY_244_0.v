...
module FAU ( 
  ...
  nand2  g17(.a(new_n37_), .b(new_n36_), .O(new_n43_));
  nand2  g18(.a(x01), .b(new_n35_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n43_), .c(new_n27_), .O(z04));
  nand2  g20(.a(x01), .b(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n43_), .c(new_n27_), .O(z05));
  ...
  nand2  g39(.a(x09), .b(new_n64_), .O(new_n65_));
