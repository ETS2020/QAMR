...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n43_, new_n44_, new_n45_,
  ...
  nand3  g34(.a(new_n59_), .b(new_n57_), .c(new_n36_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n55_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n50_), .c(new_n33_), .O(z06));
  inv1   g37(.a(new_n35_), .O(z07));
  oai21  g38(.a(new_n48_), .b(new_n45_), .c(new_n33_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n27_), .O(z09));
