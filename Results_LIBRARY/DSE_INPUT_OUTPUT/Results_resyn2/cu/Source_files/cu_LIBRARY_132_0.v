...
module FAU ( 
  ...
  nand2  g11(.a(x05), .b(new_n26_), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(new_n38_));
  nand4  g13(.a(new_n38_), .b(new_n31_), .c(new_n36_), .d(new_n35_), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x01), .O(z02));
  inv1   g15(.a(x01), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(x00), .O(new_n42_));
  nor4   g17(.a(new_n42_), .b(new_n37_), .c(new_n30_), .d(x13), .O(z03));
  nor2   g18(.a(new_n39_), .b(new_n41_), .O(z04));
  nand4  g19(.a(new_n31_), .b(new_n36_), .c(x01), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x05), .c(x02), .O(z05));
  inv1   g21(.a(new_n32_), .O(new_n47_));
  nand3  g22(.a(new_n36_), .b(new_n27_), .c(x02), .O(new_n48_));
  ...
  nor2   g33(.a(new_n36_), .b(x12), .O(new_n59_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(z06));
  nor3   g39(.a(new_n37_), .b(new_n30_), .c(x13), .O(z07));
  aoi21  g40(.a(new_n59_), .b(new_n32_), .c(new_n27_), .O(new_n66_));
  nand3  g41(.a(new_n32_), .b(new_n36_), .c(new_n27_), .O(new_n67_));
  ...
  nand2  g46(.a(x06), .b(new_n28_), .O(new_n72_));
  aoi21  g47(.a(new_n71_), .b(new_n37_), .c(new_n72_), .O(z10));
endmodule
