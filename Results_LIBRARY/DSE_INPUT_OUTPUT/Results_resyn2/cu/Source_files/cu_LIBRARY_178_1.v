...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n40_, new_n42_;
  ...
  inv1   g09(.a(x02), .O(new_n37_));
  nand2  g10(.a(x05), .b(new_n37_), .O(new_n38_));
  nand2  g11(.a(new_n35_), .b(new_n38_), .O(z08));
  nand2  g12(.a(x13), .b(x06), .O(new_n40_));
  nor2   g13(.a(new_n40_), .b(z04), .O(z09));
  nand2  g14(.a(new_n34_), .b(x06), .O(new_n42_));
