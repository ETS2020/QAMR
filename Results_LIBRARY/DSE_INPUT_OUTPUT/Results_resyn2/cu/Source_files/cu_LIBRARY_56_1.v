...
module FAU ( 
  ...
  nand3  g19(.a(new_n36_), .b(new_n29_), .c(x02), .O(new_n45_));
  ...
  nand2  g35(.a(new_n60_), .b(new_n30_), .O(new_n61_));
  aoi21  g36(.a(new_n59_), .b(new_n45_), .c(new_n61_), .O(z06));
  nand2  g37(.a(new_n36_), .b(new_n35_), .O(new_n63_));
  nand2  g38(.a(x12), .b(new_n29_), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(new_n28_), .c(new_n64_), .O(z07));
  nand2  g40(.a(x05), .b(new_n26_), .O(new_n66_));
  nand2  g41(.a(x13), .b(new_n30_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n60_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n64_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n64_), .O(z09));
  nand2  g47(.a(new_n30_), .b(new_n29_), .O(new_n73_));
  nand2  g48(.a(x06), .b(new_n35_), .O(new_n74_));
  aoi21  g49(.a(new_n66_), .b(new_n73_), .c(new_n74_), .O(z10));
endmodule
