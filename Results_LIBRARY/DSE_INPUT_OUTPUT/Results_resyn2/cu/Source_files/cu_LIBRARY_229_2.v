...
module FAU ( 
  ...
  nand2  g07(.a(new_n32_), .b(x11), .O(new_n33_));
  nand4  g08(.a(new_n33_), .b(new_n31_), .c(new_n29_), .d(new_n26_), .O(z00));
  inv1   g09(.a(z00), .O(z01));
  nor2   g10(.a(new_n28_), .b(x02), .O(new_n36_));
  nor2   g11(.a(x04), .b(x03), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  inv1   g13(.a(x00), .O(new_n39_));
  nor2   g14(.a(x13), .b(x11), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(new_n38_), .c(x01), .O(z02));
  inv1   g17(.a(x11), .O(new_n43_));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n37_), .b(new_n36_), .c(new_n44_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n43_), .c(x13), .O(z03));
  nand4  g21(.a(new_n37_), .b(new_n36_), .c(x01), .d(new_n39_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n43_), .c(x13), .O(z04));
  nand4  g23(.a(new_n37_), .b(new_n36_), .c(x01), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n43_), .c(x13), .O(z05));
  ...
  nand3  g30(.a(new_n55_), .b(new_n53_), .c(new_n39_), .O(new_n56_));
  nand2  g31(.a(new_n43_), .b(x01), .O(new_n57_));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x05), .d(new_n30_), .O(new_n62_));
  ...
  aoi21  g42(.a(new_n38_), .b(new_n43_), .c(x13), .O(z07));
  aoi21  g43(.a(new_n65_), .b(new_n62_), .c(new_n66_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  aoi21  g45(.a(x13), .b(new_n70_), .c(new_n40_), .O(z09));
