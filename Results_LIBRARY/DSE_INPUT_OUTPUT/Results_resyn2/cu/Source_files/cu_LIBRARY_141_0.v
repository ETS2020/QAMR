...
module FAU ( 
  ...
  nand4  g25(.a(new_n35_), .b(new_n42_), .c(x01), .d(x00), .O(new_n51_));
  ...
  nor2   g37(.a(new_n42_), .b(x12), .O(new_n63_));
  inv1   g38(.a(x07), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n41_), .O(new_n65_));
  ...
  nand3  g44(.a(new_n32_), .b(new_n42_), .c(new_n41_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(z06));
  inv1   g46(.a(new_n43_), .O(z07));
  inv1   g47(.a(new_n63_), .O(new_n73_));
  nand2  g48(.a(new_n27_), .b(x13), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n37_), .O(new_n75_));
  aoi21  g50(.a(new_n73_), .b(new_n29_), .c(new_n75_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n77_));
  oai21  g52(.a(x05), .b(x02), .c(new_n77_), .O(z09));
  nand2  g53(.a(new_n30_), .b(x06), .O(new_n79_));
