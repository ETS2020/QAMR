...
module FAU ( 
  ...
  aoi22  g11(.a(new_n36_), .b(new_n27_), .c(new_n34_), .d(new_n33_), .O(z01));
  inv1   g12(.a(x00), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  inv1   g14(.a(x13), .O(new_n40_));
  nand4  g15(.a(new_n35_), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n27_), .c(new_n33_), .O(z02));
  nand2  g17(.a(new_n35_), .b(new_n40_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n30_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n39_), .c(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  nor4   g21(.a(new_n43_), .b(new_n30_), .c(new_n39_), .d(x00), .O(z04));
  nand3  g22(.a(new_n44_), .b(x01), .c(x00), .O(new_n48_));
  ...
  aoi21  g41(.a(new_n43_), .b(new_n27_), .c(new_n33_), .O(z07));
