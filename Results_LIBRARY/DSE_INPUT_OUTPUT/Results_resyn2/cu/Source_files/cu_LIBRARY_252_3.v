...
module FAU ( 
  ...
  oai21  g03(.a(x11), .b(new_n28_), .c(new_n27_), .O(new_n29_));
  ...
  aoi21  g17(.a(new_n42_), .b(new_n36_), .c(new_n28_), .O(z02));
  nand3  g18(.a(new_n41_), .b(new_n36_), .c(x05), .O(new_n44_));
  ...
  aoi21  g24(.a(new_n49_), .b(new_n36_), .c(new_n28_), .O(z05));
  nand3  g25(.a(new_n39_), .b(new_n28_), .c(x02), .O(new_n51_));
  inv1   g26(.a(x10), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(x00), .c(x01), .O(new_n53_));
  inv1   g28(.a(x08), .O(new_n54_));
  nand3  g29(.a(new_n54_), .b(new_n38_), .c(new_n37_), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(x00), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  nand4  g34(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(new_n61_));
  nor2   g36(.a(x11), .b(x07), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n61_), .c(new_n58_), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n51_), .c(new_n64_), .O(z06));
  aoi21  g40(.a(new_n40_), .b(new_n36_), .c(new_n28_), .O(z07));
  and2   g41(.a(new_n60_), .b(new_n51_), .O(new_n67_));
  nand2  g42(.a(x11), .b(x05), .O(new_n68_));
  oai21  g43(.a(new_n67_), .b(new_n64_), .c(new_n68_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  aoi21  g45(.a(x11), .b(x05), .c(new_n70_), .O(z09));
  nand2  g46(.a(x05), .b(x02), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x06), .c(new_n26_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n68_), .O(z10));
endmodule
