...
module FAU ( 
  ...
  nand2  g13(.a(x13), .b(x06), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(new_n36_), .O(z09));
  nand3  g15(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n45_));
  inv1   g16(.a(new_n45_), .O(z10));
  zero   g17(.O(z02));
  zero   g18(.O(z04));
  zero   g19(.O(z05));
  zero   g20(.O(z07));
