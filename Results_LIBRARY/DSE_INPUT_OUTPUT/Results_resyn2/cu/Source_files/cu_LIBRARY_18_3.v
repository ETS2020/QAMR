...
module FAU ( 
  ...
  wire new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    ...
    new_n59_, new_n60_, new_n64_, new_n66_, new_n67_;
  ...
  nand4  g16(.a(new_n41_), .b(new_n28_), .c(new_n40_), .d(new_n31_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(x05), .c(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x01), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nor2   g21(.a(new_n44_), .b(new_n46_), .O(z04));
  nand3  g22(.a(new_n41_), .b(new_n29_), .c(x02), .O(new_n48_));
  inv1   g23(.a(x12), .O(new_n49_));
  nand4  g24(.a(x13), .b(new_n49_), .c(x05), .d(new_n31_), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(x04), .c(new_n40_), .O(new_n52_));
  ...
  nand2  g33(.a(new_n48_), .b(new_n26_), .O(new_n59_));
  aoi21  g34(.a(new_n58_), .b(new_n53_), .c(new_n59_), .O(new_n60_));
  aoi21  g35(.a(new_n52_), .b(new_n26_), .c(new_n60_), .O(z06));
  aoi21  g36(.a(new_n42_), .b(new_n39_), .c(new_n29_), .O(z07));
  nand2  g37(.a(new_n52_), .b(new_n26_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n26_), .O(z09));
  nand2  g40(.a(x05), .b(x02), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x06), .c(new_n40_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n26_), .O(z10));
  inv1   g43(.a(new_n26_), .O(z05));
endmodule
