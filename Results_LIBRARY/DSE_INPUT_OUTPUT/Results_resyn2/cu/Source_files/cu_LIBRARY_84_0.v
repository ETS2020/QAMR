...
module FAU ( 
  ...
  aoi21  g00(.a(x05), .b(x04), .c(x03), .O(new_n26_));
  ...
  aoi21  g08(.a(new_n30_), .b(new_n33_), .c(new_n28_), .O(new_n34_));
  nor2   g09(.a(new_n30_), .b(x03), .O(new_n35_));
  inv1   g10(.a(new_n35_), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(x02), .c(new_n34_), .O(z01));
  ...
  aoi21  g18(.a(new_n43_), .b(x05), .c(x02), .O(z03));
  nand3  g19(.a(new_n40_), .b(x01), .c(new_n38_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x05), .c(x02), .O(z04));
  nand3  g21(.a(new_n40_), .b(x01), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x05), .c(x02), .O(z05));
  ...
  nor2   g35(.a(new_n49_), .b(x12), .O(new_n61_));
  inv1   g36(.a(x07), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x05), .c(new_n27_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n60_), .d(new_n55_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n50_), .c(new_n36_), .O(z06));
  nor2   g41(.a(new_n40_), .b(new_n28_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  aoi21  g43(.a(new_n61_), .b(new_n35_), .c(new_n28_), .O(new_n69_));
  nand3  g44(.a(new_n35_), .b(new_n49_), .c(new_n28_), .O(new_n70_));
  oai21  g45(.a(new_n69_), .b(x02), .c(new_n70_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  aoi21  g47(.a(new_n28_), .b(new_n27_), .c(new_n72_), .O(z09));
  nand2  g48(.a(x06), .b(new_n33_), .O(new_n74_));
  nor2   g49(.a(new_n28_), .b(new_n27_), .O(new_n75_));
  aoi21  g50(.a(new_n74_), .b(new_n29_), .c(new_n75_), .O(z10));
endmodule
