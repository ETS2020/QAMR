...
module FAU ( 
  ...
  nand2  g14(.a(new_n37_), .b(new_n35_), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n40_), .c(new_n27_), .O(z03));
  nor2   g18(.a(new_n41_), .b(x00), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n37_), .c(new_n35_), .d(new_n27_), .O(new_n45_));
  ...
  nand2  g32(.a(new_n36_), .b(new_n57_), .O(new_n58_));
  ...
  nor2   g40(.a(x11), .b(x07), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n65_), .c(new_n61_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n54_), .c(new_n50_), .O(z06));
  nand2  g43(.a(new_n40_), .b(new_n27_), .O(z07));
  nand3  g44(.a(new_n27_), .b(x04), .c(new_n49_), .O(new_n70_));
  aoi21  g45(.a(new_n64_), .b(new_n52_), .c(new_n70_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  aoi21  g47(.a(x11), .b(new_n26_), .c(new_n72_), .O(z09));
