...
module FAU ( 
  ...
  nand3  g21(.a(new_n30_), .b(new_n29_), .c(x01), .O(new_n47_));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x04), .d(new_n44_), .O(new_n62_));
  ...
  nand4  g41(.a(new_n45_), .b(new_n27_), .c(x04), .d(new_n44_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  nor2   g43(.a(new_n39_), .b(new_n27_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  oai21  g45(.a(new_n63_), .b(new_n27_), .c(new_n29_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n67_), .O(z08));
  nand2  g47(.a(new_n34_), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n45_), .O(z09));
  oai21  g49(.a(new_n27_), .b(new_n29_), .c(new_n44_), .O(new_n75_));
