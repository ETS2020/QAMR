...
module FAU ( 
  ...
  nand4  g15(.a(new_n40_), .b(new_n26_), .c(new_n35_), .d(new_n34_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x00), .O(z02));
  inv1   g17(.a(x00), .O(new_n43_));
  nor2   g18(.a(new_n41_), .b(new_n43_), .O(z03));
  nand3  g19(.a(new_n35_), .b(x01), .c(new_n43_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n39_), .c(new_n26_), .O(z04));
  nand3  g21(.a(new_n35_), .b(x01), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n39_), .c(new_n26_), .O(z05));
  nand3  g23(.a(new_n38_), .b(new_n27_), .c(x02), .O(new_n49_));
  ...
  nand3  g34(.a(new_n59_), .b(new_n57_), .c(new_n43_), .O(new_n60_));
  ...
  nor2   g39(.a(new_n37_), .b(x03), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n64_), .b(new_n49_), .c(new_n66_), .O(z06));
  oai21  g42(.a(new_n39_), .b(x02), .c(new_n26_), .O(z07));
  nand2  g43(.a(new_n62_), .b(new_n49_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n65_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n26_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  aoi21  g47(.a(x09), .b(x07), .c(new_n72_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x06), .c(new_n36_), .O(new_n75_));
