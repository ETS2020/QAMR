...
module FAU ( 
  ...
  nor2   g40(.a(new_n43_), .b(x02), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n26_), .O(z07));
  aoi21  g42(.a(new_n64_), .b(new_n60_), .c(new_n34_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  oai21  g44(.a(new_n26_), .b(new_n28_), .c(new_n69_), .O(z09));
