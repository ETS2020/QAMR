...
module FAU ( 
  ...
  nand2  g06(.a(new_n31_), .b(x09), .O(new_n32_));
  ...
  aoi21  g18(.a(new_n43_), .b(x09), .c(new_n39_), .O(z02));
  nand3  g19(.a(new_n42_), .b(new_n41_), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x09), .c(new_n39_), .O(z03));
  inv1   g21(.a(x01), .O(new_n47_));
  nor2   g22(.a(x13), .b(x03), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n31_), .c(x09), .O(new_n49_));
  nor3   g24(.a(new_n49_), .b(new_n47_), .c(x00), .O(z04));
  nor3   g25(.a(new_n49_), .b(new_n47_), .c(new_n40_), .O(z05));
  inv1   g26(.a(x07), .O(new_n52_));
  nand2  g27(.a(x10), .b(x01), .O(new_n53_));
  nand2  g28(.a(x08), .b(new_n47_), .O(new_n54_));
  ...
  nand3  g35(.a(x13), .b(new_n60_), .c(x09), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n58_), .c(new_n52_), .O(new_n63_));
  inv1   g38(.a(x13), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n39_), .c(x02), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(z06));
  inv1   g42(.a(new_n49_), .O(z07));
  inv1   g43(.a(new_n65_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(new_n62_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n66_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  aoi21  g47(.a(new_n36_), .b(x05), .c(new_n72_), .O(z09));
