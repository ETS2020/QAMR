...
module FAU ( 
  ...
  nand3  g15(.a(new_n28_), .b(new_n27_), .c(new_n40_), .O(new_n41_));
  ...
  nor2   g19(.a(new_n44_), .b(new_n34_), .O(z04));
  ...
  nor2   g24(.a(new_n40_), .b(x12), .O(new_n50_));
  ...
  inv1   g38(.a(new_n41_), .O(z07));
  nand3  g39(.a(new_n50_), .b(new_n49_), .c(new_n28_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n32_), .O(z08));
