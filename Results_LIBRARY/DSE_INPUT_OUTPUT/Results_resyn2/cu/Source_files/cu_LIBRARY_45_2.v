...
module FAU ( 
  ...
  nand4  g39(.a(new_n39_), .b(new_n30_), .c(x02), .d(new_n44_), .O(new_n65_));
  ...
  nand2  g44(.a(new_n36_), .b(x06), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n39_), .O(z09));
  oai21  g46(.a(new_n30_), .b(new_n27_), .c(new_n26_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(new_n70_), .O(z10));
endmodule
