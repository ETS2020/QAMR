...
module FAU ( 
  ...
  nand3  g27(.a(new_n52_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(x10), .b(x00), .c(x01), .O(new_n54_));
  nand2  g29(.a(x09), .b(x00), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(new_n53_), .O(new_n57_));
  nand2  g32(.a(x05), .b(new_n31_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  nand3  g35(.a(x13), .b(new_n60_), .c(new_n59_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n57_), .c(new_n51_), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n26_), .O(new_n64_));
  nand2  g39(.a(x08), .b(x05), .O(new_n65_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  nor2   g41(.a(x12), .b(x08), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(x13), .c(x05), .d(new_n31_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n50_), .c(new_n64_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n65_), .O(z09));
  nand2  g46(.a(new_n28_), .b(new_n31_), .O(new_n72_));
  nand2  g47(.a(x06), .b(new_n26_), .O(new_n73_));
  aoi21  g48(.a(new_n72_), .b(x05), .c(new_n73_), .O(z10));
endmodule
