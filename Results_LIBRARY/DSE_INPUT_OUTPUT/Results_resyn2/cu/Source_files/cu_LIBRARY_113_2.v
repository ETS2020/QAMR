...
module FAU ( 
  ...
  nand4  g38(.a(x13), .b(new_n26_), .c(x05), .d(new_n41_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n63_), .c(new_n58_), .d(new_n53_), .O(new_n66_));
  nand3  g41(.a(new_n37_), .b(new_n29_), .c(x02), .O(new_n67_));
  ...
  nand2  g46(.a(new_n48_), .b(new_n27_), .O(z07));
  ...
  nand3  g50(.a(x13), .b(x12), .c(x06), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z09));
  inv1   g52(.a(x06), .O(new_n78_));
  inv1   g53(.a(new_n28_), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(x12), .c(new_n78_), .O(z10));
endmodule
