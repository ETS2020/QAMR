...
module FAU ( 
  ...
  nand3  g35(.a(new_n60_), .b(new_n58_), .c(new_n44_), .O(new_n61_));
  ...
  inv1   g41(.a(x02), .O(new_n67_));
  nand4  g42(.a(x13), .b(new_n26_), .c(x05), .d(new_n67_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n66_), .c(new_n61_), .d(new_n56_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n55_), .c(new_n51_), .O(z06));
  nor2   g46(.a(new_n40_), .b(new_n27_), .O(z07));
  nor2   g47(.a(new_n69_), .b(new_n54_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n51_), .c(new_n34_), .O(z08));
