...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n69_, new_n73_, new_n75_, new_n76_;
  ...
  nand4  g15(.a(new_n40_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n41_));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(new_n27_), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n41_), .c(new_n38_), .O(z02));
  nand3  g20(.a(new_n27_), .b(new_n43_), .c(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n41_), .c(new_n38_), .O(z03));
  inv1   g22(.a(new_n41_), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n27_), .O(new_n49_));
  nand2  g24(.a(x01), .b(new_n42_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n38_), .O(z04));
  nand2  g26(.a(x01), .b(x00), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n49_), .O(z05));
  inv1   g28(.a(x11), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(x01), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(new_n43_), .O(new_n57_));
