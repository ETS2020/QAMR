...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n63_, new_n64_, new_n66_, new_n69_,
    new_n71_, new_n72_;
  inv1   g00(.a(x03), .O(new_n26_));
  inv1   g01(.a(x02), .O(new_n27_));
  inv1   g02(.a(x04), .O(new_n28_));
  nand2  g03(.a(new_n28_), .b(new_n27_), .O(new_n29_));
  nand3  g04(.a(new_n29_), .b(x05), .c(new_n26_), .O(new_n30_));
  inv1   g05(.a(x05), .O(new_n31_));
  nor2   g06(.a(new_n28_), .b(x03), .O(new_n32_));
  nand2  g07(.a(new_n32_), .b(x02), .O(new_n33_));
  nand2  g08(.a(new_n33_), .b(new_n31_), .O(new_n34_));
  nand2  g09(.a(new_n34_), .b(new_n30_), .O(z00));
  and2   g10(.a(new_n34_), .b(new_n30_), .O(z01));
  inv1   g11(.a(x13), .O(new_n37_));
  nand3  g12(.a(new_n37_), .b(x05), .c(new_n26_), .O(new_n38_));
  nor4   g13(.a(new_n38_), .b(new_n29_), .c(x01), .d(x00), .O(z02));
  inv1   g14(.a(x00), .O(new_n40_));
  nor4   g15(.a(new_n38_), .b(new_n29_), .c(x01), .d(new_n40_), .O(z03));
  nor2   g16(.a(new_n29_), .b(x13), .O(new_n42_));
  ...
  aoi21  g20(.a(new_n45_), .b(new_n26_), .c(new_n31_), .O(z05));
  inv1   g21(.a(new_n32_), .O(new_n47_));
  ...
  nand4  g37(.a(new_n62_), .b(new_n59_), .c(new_n54_), .d(new_n48_), .O(new_n63_));
  nand3  g38(.a(new_n37_), .b(new_n31_), .c(x02), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(z06));
  nor2   g40(.a(new_n42_), .b(x03), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n31_), .O(z07));
  aoi21  g42(.a(new_n64_), .b(new_n61_), .c(new_n47_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  oai21  g44(.a(new_n31_), .b(new_n26_), .c(new_n69_), .O(z09));
