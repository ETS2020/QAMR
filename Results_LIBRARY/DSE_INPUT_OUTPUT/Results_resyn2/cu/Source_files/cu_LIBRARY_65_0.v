...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n51_, new_n53_,
    new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    new_n61_, new_n62_, new_n63_, new_n64_, new_n65_, new_n67_, new_n69_,
    new_n71_;
  nor2   g00(.a(x09), .b(x07), .O(new_n26_));
  ...
  nor3   g24(.a(new_n42_), .b(new_n26_), .c(x02), .O(z07));
  nand3  g25(.a(z07), .b(x01), .c(x00), .O(new_n51_));
  ...
  nand2  g30(.a(x08), .b(new_n35_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n55_), .c(new_n38_), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  nand4  g34(.a(x13), .b(new_n59_), .c(x05), .d(new_n36_), .O(new_n60_));
  ...
  and2   g41(.a(new_n62_), .b(new_n60_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n65_), .c(new_n27_), .O(z08));
