...
module FAU ( 
  ...
  nand2  g18(.a(x08), .b(new_n29_), .O(new_n44_));
  ...
  nand2  g24(.a(new_n30_), .b(new_n42_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n49_), .c(new_n34_), .O(new_n51_));
  ...
  and2   g39(.a(new_n64_), .b(new_n58_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n46_), .c(new_n44_), .O(z08));
  ...
  nand2  g45(.a(x06), .b(new_n35_), .O(new_n71_));
