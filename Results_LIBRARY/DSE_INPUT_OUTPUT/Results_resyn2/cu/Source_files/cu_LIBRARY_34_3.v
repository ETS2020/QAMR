...
module FAU ( 
  ...
  nor2   g15(.a(new_n34_), .b(x03), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z02));
  nand3  g18(.a(new_n40_), .b(new_n39_), .c(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(new_n34_), .O(z03));
  nand4  g20(.a(new_n41_), .b(new_n40_), .c(x01), .d(new_n38_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z04));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(new_n48_));
  nor3   g23(.a(new_n48_), .b(new_n39_), .c(new_n38_), .O(z05));
