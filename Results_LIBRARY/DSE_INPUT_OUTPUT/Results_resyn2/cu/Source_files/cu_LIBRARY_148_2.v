...
module FAU ( 
  ...
  nor2   g02(.a(x05), .b(x00), .O(new_n28_));
  ...
  inv1   g16(.a(new_n28_), .O(new_n42_));
  nand2  g17(.a(x05), .b(x00), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  aoi21  g19(.a(new_n41_), .b(x05), .c(new_n44_), .O(z04));
  aoi21  g20(.a(new_n41_), .b(x05), .c(new_n32_), .O(z05));
