...
module FAU ( 
  ...
  nand4  g10(.a(new_n28_), .b(new_n26_), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  nor4   g11(.a(new_n36_), .b(x13), .c(new_n27_), .d(x04), .O(z02));
  nor2   g12(.a(new_n31_), .b(x13), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(new_n35_), .c(x00), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n26_), .c(new_n27_), .O(z03));
  nand3  g15(.a(new_n38_), .b(x01), .c(new_n34_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n26_), .c(new_n27_), .O(z04));
  nand3  g17(.a(new_n38_), .b(x01), .c(x00), .O(new_n43_));
  ...
  nor2   g34(.a(new_n38_), .b(x02), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(new_n27_), .O(z07));
  nand3  g36(.a(x13), .b(new_n54_), .c(x05), .O(new_n62_));
  inv1   g37(.a(new_n57_), .O(new_n63_));
  nand3  g38(.a(new_n45_), .b(x04), .c(new_n28_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(z08));
  nand3  g40(.a(new_n45_), .b(x13), .c(x06), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z09));
  nand3  g42(.a(new_n45_), .b(x06), .c(new_n28_), .O(new_n68_));
