...
module FAU ( 
  ...
  nand3  g12(.a(new_n37_), .b(new_n36_), .c(new_n34_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(z07));
  nand2  g14(.a(z07), .b(new_n33_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(x01), .O(z02));
  inv1   g16(.a(x01), .O(new_n42_));
  inv1   g17(.a(x04), .O(new_n43_));
  nand4  g18(.a(new_n37_), .b(new_n43_), .c(new_n42_), .d(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(x02), .O(z03));
  nor2   g20(.a(new_n40_), .b(new_n42_), .O(z04));
  nor3   g21(.a(new_n38_), .b(new_n42_), .c(new_n33_), .O(z05));
  ...
  nand4  g34(.a(x13), .b(new_n59_), .c(x04), .d(new_n26_), .O(new_n60_));
  ...
  nand3  g39(.a(new_n37_), .b(new_n35_), .c(x04), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(z06));
  oai21  g41(.a(new_n61_), .b(new_n35_), .c(new_n34_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n65_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(new_n28_), .O(z09));
  nand4  g45(.a(new_n29_), .b(new_n27_), .c(x06), .d(new_n26_), .O(new_n71_));
