...
module FAU ( 
  ...
  nor2   g11(.a(new_n36_), .b(x00), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n33_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(z02));
  nand2  g14(.a(x06), .b(new_n28_), .O(new_n40_));
  nand2  g15(.a(new_n33_), .b(x00), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n36_), .c(new_n40_), .O(z03));
  nand2  g17(.a(new_n37_), .b(x01), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n40_), .O(z04));
  inv1   g19(.a(x00), .O(new_n45_));
  nor3   g20(.a(new_n36_), .b(new_n33_), .c(new_n45_), .O(z05));
  ...
  nand3  g26(.a(new_n51_), .b(new_n49_), .c(new_n45_), .O(new_n52_));
  ...
  nand4  g37(.a(new_n35_), .b(new_n29_), .c(new_n28_), .d(x02), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n34_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(z06));
  nand2  g40(.a(new_n40_), .b(new_n36_), .O(z07));
  aoi21  g41(.a(new_n63_), .b(new_n60_), .c(new_n64_), .O(z08));
  aoi21  g42(.a(new_n35_), .b(x05), .c(new_n29_), .O(z09));
  nand2  g43(.a(new_n34_), .b(new_n58_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x05), .c(new_n29_), .O(z10));
endmodule
