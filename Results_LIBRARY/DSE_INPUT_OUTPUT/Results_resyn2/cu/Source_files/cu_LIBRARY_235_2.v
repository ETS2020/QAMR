...
module FAU ( 
  ...
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n30_), .O(z05));
  ...
  nand2  g36(.a(new_n42_), .b(new_n30_), .O(z07));
  nand3  g37(.a(new_n48_), .b(new_n47_), .c(new_n27_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n30_), .O(z08));
