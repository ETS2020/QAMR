...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n43_, new_n46_,
  ...
  nand3  g14(.a(new_n39_), .b(new_n30_), .c(new_n36_), .O(new_n40_));
  nor3   g15(.a(new_n40_), .b(x01), .c(new_n34_), .O(z03));
  inv1   g16(.a(new_n40_), .O(z07));
  ...
  aoi21  g22(.a(new_n47_), .b(new_n35_), .c(x00), .O(new_n48_));
  oai21  g23(.a(x10), .b(new_n35_), .c(new_n48_), .O(new_n49_));
  inv1   g24(.a(x11), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(x01), .O(new_n51_));
  inv1   g26(.a(x09), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n35_), .c(new_n34_), .O(new_n53_));
  ...
  oai21  g40(.a(new_n36_), .b(new_n65_), .c(new_n46_), .O(z09));
