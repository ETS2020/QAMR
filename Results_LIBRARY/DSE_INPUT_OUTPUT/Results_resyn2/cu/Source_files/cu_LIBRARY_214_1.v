...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    ...
    new_n67_, new_n68_, new_n70_, new_n72_, new_n73_, new_n76_;
  ...
  nand3  g18(.a(new_n39_), .b(new_n38_), .c(x01), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n36_), .O(z04));
  ...
  nand3  g27(.a(new_n52_), .b(new_n50_), .c(new_n34_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n38_), .b(new_n29_), .c(x02), .O(new_n64_));
  ...
  nand2  g43(.a(new_n68_), .b(new_n47_), .O(z06));
  nand3  g44(.a(new_n35_), .b(new_n39_), .c(new_n38_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n47_), .O(z07));
  nand2  g46(.a(new_n64_), .b(new_n61_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n47_), .O(z08));
  aoi21  g49(.a(new_n38_), .b(x01), .c(new_n26_), .O(z09));
  inv1   g50(.a(new_n28_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(x01), .c(new_n26_), .O(z10));
endmodule
