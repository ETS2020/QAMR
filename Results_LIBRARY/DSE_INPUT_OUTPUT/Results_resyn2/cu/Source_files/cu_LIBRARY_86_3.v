...
module FAU ( 
  ...
  nand3  g12(.a(new_n28_), .b(new_n26_), .c(new_n37_), .O(new_n38_));
  nor3   g13(.a(new_n38_), .b(new_n36_), .c(x01), .O(z02));
  inv1   g14(.a(x01), .O(new_n40_));
  nand4  g15(.a(new_n30_), .b(new_n35_), .c(new_n40_), .d(x00), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n26_), .c(new_n27_), .O(z03));
  inv1   g17(.a(new_n36_), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(x01), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n38_), .O(z04));
  nand3  g20(.a(new_n28_), .b(new_n26_), .c(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n44_), .O(z05));
  nand2  g22(.a(x05), .b(x02), .O(new_n48_));
  inv1   g23(.a(x08), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n40_), .c(x00), .O(new_n50_));
  oai21  g25(.a(x10), .b(new_n40_), .c(new_n50_), .O(new_n51_));
  inv1   g26(.a(x11), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(x01), .O(new_n53_));
  inv1   g28(.a(x09), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n40_), .c(new_n37_), .O(new_n55_));
  ...
  nand2  g37(.a(new_n30_), .b(new_n35_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n26_), .c(new_n27_), .O(z07));
  nand3  g39(.a(x13), .b(new_n57_), .c(x05), .O(new_n65_));
  oai21  g40(.a(new_n29_), .b(x13), .c(new_n27_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(x02), .O(new_n67_));
  oai21  g42(.a(new_n65_), .b(new_n29_), .c(new_n67_), .O(z08));
  inv1   g43(.a(x06), .O(new_n69_));
  oai21  g44(.a(new_n35_), .b(new_n69_), .c(new_n48_), .O(z09));
  oai21  g45(.a(new_n69_), .b(x03), .c(new_n48_), .O(z10));
endmodule
