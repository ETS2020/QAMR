...
module FAU ( 
  ...
  nand3  g13(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(new_n39_));
  inv1   g14(.a(x06), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n29_), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(x00), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n39_), .c(new_n41_), .O(z03));
  oai21  g19(.a(new_n37_), .b(new_n42_), .c(new_n41_), .O(z04));
  nand2  g20(.a(x01), .b(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n39_), .O(z05));
  ...
  nand3  g27(.a(new_n52_), .b(new_n50_), .c(new_n33_), .O(new_n53_));
  ...
  nand4  g37(.a(new_n35_), .b(x06), .c(new_n29_), .d(x02), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n34_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(z06));
  nand2  g40(.a(new_n41_), .b(new_n39_), .O(z07));
  aoi21  g41(.a(new_n63_), .b(new_n60_), .c(new_n64_), .O(z08));
  oai21  g42(.a(new_n35_), .b(new_n40_), .c(new_n41_), .O(z09));
  nand2  g43(.a(x06), .b(new_n26_), .O(new_n69_));
  aoi22  g44(.a(new_n69_), .b(x05), .c(x06), .d(x03), .O(z10));
endmodule
