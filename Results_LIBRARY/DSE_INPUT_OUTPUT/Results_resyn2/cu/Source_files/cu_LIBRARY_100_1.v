...
module FAU ( 
  ...
  oai21  g03(.a(new_n28_), .b(new_n26_), .c(x07), .O(new_n29_));
  ...
  nand2  g09(.a(new_n33_), .b(new_n31_), .O(new_n35_));
  nand2  g10(.a(x07), .b(new_n26_), .O(new_n36_));
  ...
  nand4  g16(.a(new_n41_), .b(x05), .c(new_n32_), .d(new_n40_), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n39_), .c(new_n36_), .O(z02));
  nand4  g18(.a(new_n41_), .b(x05), .c(new_n32_), .d(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n39_), .c(new_n36_), .O(z03));
  nand2  g20(.a(new_n30_), .b(x01), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n42_), .c(new_n36_), .O(z04));
  oai21  g22(.a(new_n46_), .b(new_n44_), .c(new_n36_), .O(z05));
  inv1   g23(.a(x13), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n26_), .c(x02), .O(new_n50_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n60_), .c(new_n55_), .O(new_n64_));
  inv1   g39(.a(x03), .O(new_n65_));
  inv1   g40(.a(x07), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n65_), .O(new_n67_));
  aoi21  g42(.a(new_n64_), .b(new_n50_), .c(new_n67_), .O(z06));
  nand3  g43(.a(new_n41_), .b(new_n27_), .c(x05), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n36_), .O(z07));
  nand2  g45(.a(x04), .b(new_n65_), .O(new_n71_));
  inv1   g46(.a(new_n50_), .O(new_n72_));
  ...
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n65_), .O(new_n78_));
