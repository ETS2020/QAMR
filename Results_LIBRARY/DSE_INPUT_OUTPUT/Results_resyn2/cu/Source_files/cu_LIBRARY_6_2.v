...
module FAU ( 
  ...
  aoi21  g16(.a(new_n26_), .b(x07), .c(new_n38_), .O(new_n42_));
  ...
  nand2  g35(.a(new_n26_), .b(x01), .O(new_n61_));
  inv1   g36(.a(x08), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n39_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n61_), .c(new_n38_), .O(new_n64_));
  ...
  nand4  g43(.a(new_n68_), .b(new_n64_), .c(new_n60_), .d(new_n55_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n54_), .c(new_n50_), .O(z06));
  nand2  g45(.a(new_n37_), .b(new_n27_), .O(z07));
  nor2   g46(.a(new_n68_), .b(new_n53_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n50_), .c(new_n27_), .O(z08));
