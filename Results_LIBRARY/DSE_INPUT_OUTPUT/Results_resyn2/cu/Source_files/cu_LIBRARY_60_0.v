...
module FAU ( 
  ...
  nand3  g08(.a(new_n32_), .b(new_n31_), .c(new_n26_), .O(new_n34_));
  ...
  aoi21  g14(.a(new_n39_), .b(x05), .c(x04), .O(z02));
  nor2   g15(.a(new_n28_), .b(x04), .O(new_n41_));
  ...
  aoi21  g19(.a(new_n44_), .b(x05), .c(x04), .O(z04));
  nand4  g20(.a(new_n41_), .b(new_n38_), .c(x01), .d(x00), .O(new_n46_));
  ...
  and2   g41(.a(new_n41_), .b(new_n38_), .O(z07));
  aoi21  g42(.a(new_n64_), .b(new_n60_), .c(new_n65_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n29_), .O(z09));
  nand3  g45(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n29_), .O(z10));
endmodule
