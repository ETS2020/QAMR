...
module FAU ( 
  ...
  nor2   g10(.a(new_n33_), .b(x13), .O(z06));
  nand2  g11(.a(x13), .b(x06), .O(new_n39_));
  nor2   g12(.a(new_n39_), .b(z02), .O(z09));
  nand3  g13(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n41_));
  oai21  g14(.a(new_n27_), .b(x02), .c(new_n41_), .O(z10));
  zero   g15(.O(z04));
  zero   g16(.O(z07));
  nor2   g17(.a(new_n27_), .b(x02), .O(z03));
