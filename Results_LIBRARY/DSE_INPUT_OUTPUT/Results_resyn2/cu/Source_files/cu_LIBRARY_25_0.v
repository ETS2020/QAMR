...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n31_, new_n32_, new_n33_, new_n34_,
    ...
    new_n60_, new_n62_, new_n63_, new_n65_, new_n67_, new_n69_;
  ...
  inv1   g12(.a(new_n33_), .O(new_n38_));
  nand4  g13(.a(x05), .b(new_n26_), .c(x01), .d(new_n31_), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(new_n38_), .O(z04));
  nand3  g15(.a(new_n33_), .b(x01), .c(x00), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(x05), .c(x03), .O(z05));
  inv1   g17(.a(x07), .O(new_n43_));
  nor2   g18(.a(x03), .b(x02), .O(new_n44_));
  inv1   g19(.a(x04), .O(new_n45_));
  nor2   g20(.a(new_n27_), .b(new_n45_), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x12), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n46_), .c(new_n44_), .d(new_n43_), .O(new_n49_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n56_), .c(new_n31_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(new_n49_), .O(z06));
  inv1   g36(.a(new_n44_), .O(new_n62_));
  nand3  g37(.a(new_n47_), .b(x05), .c(new_n45_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n62_), .O(z07));
  nand2  g39(.a(new_n48_), .b(new_n46_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n62_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  aoi21  g42(.a(new_n27_), .b(new_n26_), .c(new_n67_), .O(z09));
  nand3  g43(.a(new_n44_), .b(x06), .c(x05), .O(new_n69_));
