...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n41_, new_n44_, new_n45_,
  ...
  nand2  g15(.a(x01), .b(new_n36_), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n35_), .c(new_n32_), .O(z04));
  nor3   g17(.a(new_n35_), .b(new_n37_), .c(new_n36_), .O(z05));
  ...
  oai21  g33(.a(new_n58_), .b(new_n47_), .c(new_n32_), .O(z06));
  nand2  g34(.a(new_n35_), .b(new_n32_), .O(z07));
  nand3  g35(.a(new_n46_), .b(new_n45_), .c(new_n28_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n32_), .O(z08));
  nand2  g37(.a(x13), .b(x06), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n32_), .O(z09));
  nand2  g39(.a(new_n28_), .b(x06), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n32_), .O(z10));
endmodule
