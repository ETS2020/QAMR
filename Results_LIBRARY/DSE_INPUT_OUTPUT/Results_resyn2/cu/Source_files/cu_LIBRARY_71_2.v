...
module FAU ( 
  ...
  nor2   g03(.a(new_n26_), .b(x02), .O(new_n29_));
  nand3  g04(.a(new_n29_), .b(x06), .c(new_n28_), .O(new_n30_));
  ...
  aoi21  g15(.a(new_n40_), .b(x06), .c(new_n26_), .O(z02));
  nand4  g16(.a(new_n36_), .b(x06), .c(new_n34_), .d(x00), .O(new_n42_));
  nand2  g17(.a(new_n37_), .b(new_n29_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n42_), .O(z03));
  nand3  g19(.a(new_n39_), .b(x01), .c(new_n33_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x06), .c(new_n26_), .O(z04));
  nand3  g21(.a(new_n39_), .b(x01), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x06), .c(new_n26_), .O(z05));
  inv1   g23(.a(x07), .O(new_n49_));
  nand2  g24(.a(x13), .b(x06), .O(new_n50_));
  inv1   g25(.a(x12), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(x05), .c(new_n35_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  ...
  nand3  g37(.a(new_n62_), .b(new_n60_), .c(new_n33_), .O(new_n63_));
  ...
  aoi21  g42(.a(new_n65_), .b(new_n64_), .c(new_n67_), .O(z06));
  aoi21  g43(.a(new_n38_), .b(x06), .c(new_n26_), .O(z07));
  inv1   g44(.a(new_n65_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n53_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(new_n67_), .O(z08));
  inv1   g47(.a(new_n50_), .O(z09));
  oai21  g48(.a(new_n26_), .b(new_n35_), .c(new_n66_), .O(new_n74_));
  nor2   g49(.a(x06), .b(x05), .O(new_n75_));
  aoi21  g50(.a(new_n74_), .b(x06), .c(new_n75_), .O(z10));
endmodule
