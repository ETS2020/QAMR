...
module FAU ( 
  ...
  oai21  g15(.a(new_n40_), .b(new_n37_), .c(new_n27_), .O(z02));
  nor2   g16(.a(x01), .b(new_n38_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n36_), .c(new_n35_), .d(new_n27_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z03));
  nand2  g19(.a(x01), .b(new_n38_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n37_), .c(new_n27_), .O(z04));
  nor2   g21(.a(new_n39_), .b(new_n38_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n36_), .c(new_n35_), .d(new_n27_), .O(new_n48_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n39_), .c(x00), .O(new_n57_));
  ...
  nand2  g44(.a(new_n37_), .b(new_n27_), .O(z07));
  and2   g45(.a(new_n64_), .b(new_n53_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n51_), .c(new_n27_), .O(z08));
