...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n31_, new_n32_, new_n33_, new_n34_,
    ...
    new_n60_, new_n62_, new_n65_, new_n67_;
  ...
  nand3  g06(.a(new_n31_), .b(x05), .c(new_n26_), .O(new_n32_));
  inv1   g07(.a(x01), .O(new_n33_));
  nand2  g08(.a(new_n28_), .b(new_n33_), .O(new_n34_));
  nor3   g09(.a(new_n34_), .b(new_n32_), .c(x00), .O(z02));
  inv1   g10(.a(x00), .O(new_n36_));
  nor3   g11(.a(new_n34_), .b(new_n32_), .c(new_n36_), .O(z03));
  nand4  g12(.a(new_n28_), .b(new_n31_), .c(x01), .d(new_n36_), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(x05), .c(x03), .O(z04));
  nand4  g14(.a(new_n28_), .b(new_n31_), .c(x01), .d(x00), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(x05), .c(x03), .O(z05));
  inv1   g16(.a(x07), .O(new_n42_));
  inv1   g17(.a(x02), .O(new_n43_));
  nand3  g18(.a(x05), .b(new_n26_), .c(new_n43_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  inv1   g20(.a(x12), .O(new_n46_));
  nand3  g21(.a(x13), .b(new_n46_), .c(x04), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n45_), .c(new_n42_), .O(new_n49_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n56_), .c(new_n36_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(new_n49_), .O(z06));
  nand2  g36(.a(new_n28_), .b(new_n31_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(x05), .c(x03), .O(z07));
  nor2   g38(.a(new_n47_), .b(new_n44_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  oai21  g40(.a(x05), .b(x03), .c(new_n65_), .O(z09));
  nand2  g41(.a(new_n45_), .b(x06), .O(new_n67_));
