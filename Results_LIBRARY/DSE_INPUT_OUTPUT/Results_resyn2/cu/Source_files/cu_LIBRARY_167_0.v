...
module FAU ( 
  ...
  nand3  g14(.a(new_n39_), .b(new_n38_), .c(new_n29_), .O(new_n40_));
  inv1   g15(.a(x02), .O(new_n41_));
  nand2  g16(.a(x05), .b(new_n41_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n40_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n26_), .c(new_n37_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z02));
  inv1   g20(.a(new_n40_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n41_), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x05), .c(x01), .O(z03));
  nand3  g23(.a(new_n43_), .b(x01), .c(new_n37_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nand4  g25(.a(new_n39_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n51_));
  nor4   g26(.a(new_n51_), .b(new_n27_), .c(x04), .d(new_n26_), .O(z05));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x10), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(x01), .O(new_n55_));
  inv1   g30(.a(x08), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(new_n26_), .O(new_n57_));
  ...
  nand4  g42(.a(new_n39_), .b(new_n27_), .c(x02), .d(x01), .O(new_n68_));
  nand2  g43(.a(x04), .b(new_n29_), .O(new_n69_));
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(z06));
  oai21  g45(.a(new_n42_), .b(new_n40_), .c(new_n34_), .O(z07));
  aoi21  g46(.a(new_n68_), .b(new_n65_), .c(new_n69_), .O(z08));
  nand2  g47(.a(new_n34_), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n39_), .O(z09));
  oai21  g49(.a(new_n27_), .b(new_n41_), .c(new_n29_), .O(new_n75_));
