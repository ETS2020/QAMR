...
module FAU ( 
  ...
  nor4   g11(.a(new_n36_), .b(x13), .c(new_n32_), .d(x04), .O(z02));
  nor2   g12(.a(new_n27_), .b(x13), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(new_n34_), .c(x00), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(x05), .c(x02), .O(z03));
  nand3  g15(.a(new_n38_), .b(x01), .c(new_n33_), .O(new_n41_));
  ...
  nand4  g34(.a(new_n59_), .b(new_n56_), .c(new_n54_), .d(new_n49_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x05), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n35_), .O(new_n62_));
  nand4  g37(.a(new_n55_), .b(new_n32_), .c(x04), .d(new_n28_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(z06));
  nor2   g39(.a(new_n38_), .b(new_n32_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(x02), .O(z07));
  nand3  g41(.a(new_n56_), .b(x05), .c(new_n35_), .O(new_n67_));
  nand3  g42(.a(new_n55_), .b(new_n32_), .c(x02), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n67_), .c(new_n29_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  aoi21  g45(.a(new_n32_), .b(new_n35_), .c(new_n70_), .O(z09));
  nand2  g46(.a(x05), .b(new_n35_), .O(new_n72_));
  nand2  g47(.a(new_n32_), .b(x02), .O(new_n73_));
