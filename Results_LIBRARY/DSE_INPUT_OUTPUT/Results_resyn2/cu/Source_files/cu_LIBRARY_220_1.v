...
module FAU ( 
  ...
  nor2   g11(.a(new_n36_), .b(x05), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(new_n38_));
  nand2  g13(.a(new_n38_), .b(new_n35_), .O(z01));
  ...
  oai21  g20(.a(new_n45_), .b(new_n42_), .c(new_n38_), .O(z02));
  nand3  g21(.a(new_n30_), .b(new_n44_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n42_), .c(new_n38_), .O(z03));
  inv1   g23(.a(new_n42_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n30_), .c(x01), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x00), .O(z04));
  nor2   g26(.a(new_n50_), .b(new_n43_), .O(z05));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x10), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(x01), .O(new_n55_));
  nand2  g30(.a(new_n36_), .b(new_n44_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n55_), .c(new_n43_), .O(new_n57_));
  ...
  nand3  g41(.a(new_n41_), .b(new_n26_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nor2   g43(.a(new_n31_), .b(x03), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n38_), .O(z06));
  oai21  g46(.a(new_n42_), .b(x02), .c(new_n38_), .O(z07));
  ...
  nor2   g51(.a(new_n76_), .b(new_n37_), .O(z09));
  nand2  g52(.a(new_n29_), .b(x06), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n38_), .O(z10));
endmodule
