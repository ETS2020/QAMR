...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n38_, new_n39_, new_n42_, new_n45_, new_n46_,
  ...
  nor2   g12(.a(new_n27_), .b(x02), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(new_n28_), .c(new_n35_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(x01), .c(new_n33_), .O(z03));
  inv1   g15(.a(new_n39_), .O(z07));
  nand2  g16(.a(z07), .b(x01), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x00), .O(z04));
  nor2   g18(.a(new_n42_), .b(new_n33_), .O(z05));
  ...
  nand3  g37(.a(new_n30_), .b(new_n35_), .c(new_n27_), .O(new_n63_));
  ...
  nand2  g44(.a(x06), .b(new_n56_), .O(new_n70_));
  nor2   g45(.a(new_n27_), .b(new_n26_), .O(new_n71_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(new_n71_), .O(z10));
endmodule
