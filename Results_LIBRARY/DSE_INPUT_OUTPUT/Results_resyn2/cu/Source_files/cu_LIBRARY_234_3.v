...
module FAU ( 
  ...
  nand2  g05(.a(x11), .b(x07), .O(new_n31_));
  ...
  nand4  g11(.a(new_n36_), .b(x05), .c(new_n26_), .d(new_n29_), .O(new_n37_));
  ...
  oai21  g17(.a(new_n42_), .b(new_n39_), .c(new_n31_), .O(z02));
  nand2  g18(.a(new_n31_), .b(new_n41_), .O(new_n44_));
  nor4   g19(.a(new_n44_), .b(new_n37_), .c(x01), .d(new_n35_), .O(z03));
  nand2  g20(.a(new_n41_), .b(x01), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n39_), .c(new_n31_), .O(z04));
  nand3  g22(.a(new_n41_), .b(x01), .c(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n37_), .c(new_n31_), .O(z05));
  inv1   g24(.a(x05), .O(new_n50_));
  nand3  g25(.a(new_n36_), .b(new_n50_), .c(x02), .O(new_n51_));
  ...
  nand3  g36(.a(new_n61_), .b(new_n59_), .c(new_n35_), .O(new_n62_));
  inv1   g37(.a(x12), .O(new_n63_));
  nand4  g38(.a(x13), .b(new_n63_), .c(x05), .d(new_n41_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n62_), .c(new_n57_), .d(new_n52_), .O(new_n66_));
  nor2   g41(.a(new_n26_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n31_), .O(new_n68_));
  aoi21  g43(.a(new_n66_), .b(new_n51_), .c(new_n68_), .O(z06));
  nor2   g44(.a(new_n44_), .b(new_n37_), .O(z07));
  nand2  g45(.a(new_n64_), .b(new_n51_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n67_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n31_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  aoi21  g49(.a(x11), .b(x07), .c(new_n74_), .O(z09));
  inv1   g50(.a(new_n32_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(x06), .O(new_n77_));
