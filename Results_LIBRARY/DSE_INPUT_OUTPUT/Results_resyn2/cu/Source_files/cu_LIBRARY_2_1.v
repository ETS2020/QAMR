...
module FAU ( 
  ...
  oai21  g06(.a(new_n30_), .b(x04), .c(new_n31_), .O(new_n32_));
  ...
  nor2   g14(.a(new_n39_), .b(new_n27_), .O(new_n40_));
  ...
  nor2   g21(.a(new_n45_), .b(new_n43_), .O(z05));
  inv1   g22(.a(new_n27_), .O(new_n48_));
  ...
  nand3  g28(.a(new_n53_), .b(new_n51_), .c(new_n43_), .O(new_n54_));
  nand2  g29(.a(new_n26_), .b(x01), .O(new_n55_));
  ...
  nand3  g38(.a(new_n37_), .b(new_n30_), .c(x02), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nor2   g40(.a(new_n36_), .b(x03), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n48_), .O(z06));
  nand2  g43(.a(new_n39_), .b(new_n48_), .O(z07));
  nand2  g44(.a(new_n28_), .b(x04), .O(new_n70_));
  ...
  nand3  g49(.a(new_n29_), .b(x06), .c(new_n74_), .O(new_n75_));
