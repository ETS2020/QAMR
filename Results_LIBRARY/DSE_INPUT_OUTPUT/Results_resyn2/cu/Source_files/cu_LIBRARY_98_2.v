...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n68_, new_n70_, new_n73_;
  inv1   g00(.a(x13), .O(new_n26_));
  nand2  g01(.a(new_n26_), .b(x12), .O(new_n27_));
  ...
  nor3   g12(.a(x13), .b(x12), .c(x02), .O(new_n38_));
  ...
  nor2   g17(.a(x02), .b(new_n35_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n37_), .c(new_n36_), .d(new_n42_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n41_), .c(x13), .O(z03));
  nor2   g20(.a(new_n39_), .b(new_n42_), .O(z04));
  nand4  g21(.a(new_n43_), .b(new_n37_), .c(new_n36_), .d(x01), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n41_), .c(x13), .O(z05));
  ...
  nand3  g37(.a(new_n62_), .b(new_n58_), .c(new_n53_), .O(new_n63_));
  nand3  g38(.a(new_n26_), .b(new_n28_), .c(x02), .O(new_n64_));
  nand3  g39(.a(new_n41_), .b(x04), .c(new_n36_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  nand2  g41(.a(new_n37_), .b(new_n36_), .O(new_n67_));
  inv1   g42(.a(new_n38_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n67_), .O(z07));
  nand3  g44(.a(x13), .b(x05), .c(new_n59_), .O(new_n70_));
  aoi21  g45(.a(new_n64_), .b(new_n70_), .c(new_n65_), .O(z08));
