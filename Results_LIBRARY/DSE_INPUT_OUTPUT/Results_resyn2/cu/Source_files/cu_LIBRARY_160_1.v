...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n30_, new_n31_, new_n36_, new_n38_;
  ...
  nand2  g09(.a(new_n36_), .b(new_n31_), .O(z09));
  nand3  g10(.a(x06), .b(new_n27_), .c(new_n26_), .O(new_n38_));
  nand2  g11(.a(new_n38_), .b(new_n31_), .O(z10));
  zero   g12(.O(z04));
  zero   g13(.O(z05));
  inv1   g14(.a(new_n31_), .O(z03));
  inv1   g15(.a(new_n31_), .O(z07));
