...
module FAU ( 
  ...
  nor2   g09(.a(new_n34_), .b(new_n31_), .O(z01));
  inv1   g10(.a(z01), .O(z00));
  inv1   g11(.a(x00), .O(new_n37_));
  inv1   g12(.a(x01), .O(new_n38_));
  nor2   g13(.a(new_n32_), .b(x13), .O(new_n39_));
  nand4  g14(.a(new_n39_), .b(new_n33_), .c(new_n38_), .d(new_n37_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z02));
  nand4  g16(.a(new_n39_), .b(new_n33_), .c(new_n38_), .d(x00), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z03));
  nand2  g18(.a(new_n26_), .b(x03), .O(new_n44_));
  nand4  g19(.a(new_n39_), .b(new_n33_), .c(x01), .d(new_n37_), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(new_n44_), .O(z04));
  nand4  g21(.a(new_n39_), .b(new_n33_), .c(x01), .d(x00), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(new_n44_), .O(z05));
  ...
  nand2  g40(.a(x04), .b(new_n29_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(z06));
  nand2  g42(.a(new_n39_), .b(new_n33_), .O(new_n68_));
  nand2  g43(.a(new_n44_), .b(new_n68_), .O(z07));
  aoi21  g44(.a(new_n65_), .b(new_n61_), .c(new_n66_), .O(z08));
