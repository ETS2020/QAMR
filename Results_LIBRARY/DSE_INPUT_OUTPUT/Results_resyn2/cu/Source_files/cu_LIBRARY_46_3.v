...
module FAU ( 
  ...
  oai21  g09(.a(new_n28_), .b(new_n27_), .c(new_n26_), .O(new_n35_));
  aoi21  g10(.a(new_n32_), .b(new_n31_), .c(new_n35_), .O(z01));
  ...
  aoi21  g15(.a(new_n40_), .b(new_n27_), .c(new_n28_), .O(z02));
  ...
  nor4   g20(.a(new_n45_), .b(new_n31_), .c(new_n38_), .d(x00), .O(z04));
  nand3  g21(.a(new_n39_), .b(x01), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n27_), .c(new_n28_), .O(z05));
  ...
  nor2   g41(.a(new_n45_), .b(new_n31_), .O(z07));
  aoi21  g42(.a(new_n64_), .b(new_n61_), .c(new_n65_), .O(z08));
  inv1   g43(.a(x06), .O(new_n69_));
  nor3   g44(.a(new_n29_), .b(new_n44_), .c(new_n69_), .O(z09));
  oai22  g45(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n27_), .O(z10));
endmodule
