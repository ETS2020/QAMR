...
module FAU ( 
  ...
  nand2  g15(.a(new_n40_), .b(new_n30_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nor2   g17(.a(x12), .b(new_n26_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x01), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nand3  g21(.a(new_n42_), .b(new_n46_), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n27_), .c(new_n26_), .O(z03));
  nor2   g23(.a(new_n44_), .b(new_n46_), .O(z04));
  nand2  g24(.a(new_n43_), .b(new_n42_), .O(new_n50_));
  ...
  nand3  g39(.a(x13), .b(x05), .c(new_n29_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nor2   g41(.a(x12), .b(x07), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n66_), .c(new_n64_), .d(new_n59_), .O(new_n68_));
  inv1   g43(.a(x03), .O(new_n69_));
  nand2  g44(.a(x04), .b(new_n69_), .O(new_n70_));
  aoi21  g45(.a(new_n68_), .b(new_n54_), .c(new_n70_), .O(z06));
  inv1   g46(.a(new_n50_), .O(z07));
  and2   g47(.a(new_n65_), .b(new_n54_), .O(new_n73_));
  ...
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n69_), .O(new_n78_));
