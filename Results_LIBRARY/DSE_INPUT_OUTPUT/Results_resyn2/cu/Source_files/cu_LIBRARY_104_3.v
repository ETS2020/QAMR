...
module FAU ( 
  ...
  nand2  g11(.a(x10), .b(x05), .O(new_n37_));
  ...
  nand3  g22(.a(new_n47_), .b(new_n32_), .c(new_n30_), .O(new_n48_));
  ...
  nand3  g28(.a(new_n53_), .b(new_n41_), .c(x00), .O(new_n54_));
  nor2   g29(.a(x08), .b(x00), .O(new_n55_));
  nand2  g30(.a(x11), .b(x00), .O(new_n56_));
  oai21  g31(.a(new_n55_), .b(x01), .c(new_n56_), .O(new_n57_));
  ...
  nand2  g36(.a(new_n30_), .b(new_n61_), .O(new_n62_));
