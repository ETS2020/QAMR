...
module FAU ( 
  ...
  nor3   g10(.a(new_n33_), .b(x01), .c(new_n35_), .O(z03));
  inv1   g11(.a(x03), .O(new_n37_));
  nand4  g12(.a(new_n32_), .b(x05), .c(new_n26_), .d(new_n37_), .O(new_n38_));
  inv1   g13(.a(x02), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(x01), .c(new_n35_), .O(new_n40_));
  oai21  g15(.a(new_n40_), .b(new_n38_), .c(new_n30_), .O(z04));
  nand3  g16(.a(new_n39_), .b(x01), .c(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n38_), .c(new_n30_), .O(z05));
  inv1   g18(.a(x07), .O(new_n44_));
  nor2   g19(.a(new_n29_), .b(new_n26_), .O(new_n45_));
  nor2   g20(.a(new_n32_), .b(x12), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n45_), .c(new_n27_), .d(new_n44_), .O(new_n47_));
  ...
  nand3  g27(.a(new_n52_), .b(new_n49_), .c(x00), .O(new_n53_));
  ...
  nor2   g34(.a(new_n59_), .b(new_n47_), .O(z06));
  nand2  g35(.a(new_n33_), .b(new_n30_), .O(z07));
  inv1   g36(.a(new_n27_), .O(new_n62_));
  nand2  g37(.a(new_n46_), .b(new_n45_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n62_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n30_), .O(z09));
