...
module FAU ( 
  ...
  nand2  g10(.a(x04), .b(new_n26_), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(x02), .c(new_n35_), .O(z01));
  inv1   g12(.a(x00), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  inv1   g14(.a(x13), .O(new_n40_));
  nand2  g15(.a(new_n34_), .b(new_n40_), .O(new_n41_));
  ...
  nor4   g23(.a(new_n41_), .b(new_n30_), .c(new_n39_), .d(new_n38_), .O(z05));
  ...
  nand3  g39(.a(new_n40_), .b(new_n33_), .c(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(new_n36_), .O(z06));
  nor2   g41(.a(new_n41_), .b(new_n30_), .O(z07));
  aoi21  g42(.a(new_n65_), .b(new_n62_), .c(new_n36_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  aoi21  g44(.a(new_n33_), .b(new_n27_), .c(new_n69_), .O(z09));
  nand2  g45(.a(new_n33_), .b(new_n27_), .O(new_n71_));
  nor2   g46(.a(new_n33_), .b(new_n27_), .O(new_n72_));
  nand2  g47(.a(x06), .b(new_n26_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n71_), .c(new_n72_), .O(z10));
endmodule
