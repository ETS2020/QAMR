...
module FAU ( 
  ...
  aoi21  g16(.a(new_n41_), .b(x12), .c(new_n26_), .O(z02));
  nand4  g17(.a(new_n39_), .b(new_n38_), .c(x12), .d(x05), .O(new_n43_));
  inv1   g18(.a(x01), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(x00), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n43_), .O(z03));
  inv1   g21(.a(x00), .O(new_n47_));
  nand2  g22(.a(x01), .b(new_n47_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n43_), .O(z04));
  nand2  g24(.a(x01), .b(x00), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n43_), .O(z05));
  inv1   g26(.a(new_n39_), .O(new_n52_));
  nand3  g27(.a(new_n26_), .b(x04), .c(x02), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(z06));
  nand2  g29(.a(new_n39_), .b(new_n38_), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x12), .c(new_n26_), .O(z07));
  ...
  oai21  g36(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(z08));
endmodule
