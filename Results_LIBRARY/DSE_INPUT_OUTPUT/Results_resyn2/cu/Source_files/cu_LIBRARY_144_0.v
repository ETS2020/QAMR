...
module FAU ( 
  ...
  nand2  g05(.a(x09), .b(new_n30_), .O(new_n31_));
  ...
  nor2   g29(.a(new_n54_), .b(x01), .O(new_n55_));
  nand2  g30(.a(x10), .b(x01), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(x05), .c(new_n41_), .O(new_n57_));
  inv1   g32(.a(x11), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x05), .c(new_n42_), .O(new_n59_));
  oai21  g34(.a(new_n38_), .b(x01), .c(x00), .O(new_n60_));
  oai22  g35(.a(new_n60_), .b(new_n59_), .c(new_n57_), .d(new_n55_), .O(new_n61_));
  inv1   g36(.a(x07), .O(new_n62_));
  inv1   g37(.a(x12), .O(new_n63_));
  nand4  g38(.a(x13), .b(new_n63_), .c(new_n62_), .d(new_n27_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n61_), .c(new_n53_), .O(new_n66_));
  nor2   g41(.a(new_n28_), .b(x03), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n66_), .c(new_n39_), .O(z06));
  nand2  g44(.a(x13), .b(new_n63_), .O(new_n70_));
  ...
  aoi21  g52(.a(new_n71_), .b(new_n31_), .c(new_n77_), .O(z10));
endmodule
