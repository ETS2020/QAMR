...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n39_, new_n42_, new_n44_, new_n46_,
  ...
  nand3  g11(.a(new_n36_), .b(new_n30_), .c(new_n35_), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(z07));
  nand2  g13(.a(z07), .b(new_n34_), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x01), .O(z02));
  nor3   g15(.a(new_n37_), .b(x01), .c(new_n34_), .O(z03));
  inv1   g16(.a(x01), .O(new_n42_));
  nor2   g17(.a(new_n39_), .b(new_n42_), .O(z04));
  nand4  g18(.a(new_n30_), .b(new_n35_), .c(x01), .d(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(new_n27_), .O(z05));
  nand2  g20(.a(x05), .b(x02), .O(new_n46_));
  inv1   g21(.a(x08), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n42_), .c(x00), .O(new_n48_));
  oai21  g23(.a(x10), .b(new_n42_), .c(new_n48_), .O(new_n49_));
  inv1   g24(.a(x11), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(x01), .O(new_n51_));
  inv1   g26(.a(x09), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n42_), .c(new_n34_), .O(new_n53_));
  ...
  nand3  g39(.a(new_n46_), .b(x13), .c(x06), .O(new_n65_));
