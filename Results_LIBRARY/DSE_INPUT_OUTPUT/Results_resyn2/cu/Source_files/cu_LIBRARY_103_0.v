...
module FAU ( 
  ...
  nand3  g11(.a(x05), .b(new_n28_), .c(new_n27_), .O(new_n37_));
  ...
  nand3  g18(.a(new_n28_), .b(new_n32_), .c(new_n27_), .O(new_n44_));
  ...
  nand3  g24(.a(new_n42_), .b(new_n28_), .c(new_n32_), .O(new_n50_));
  nand3  g25(.a(new_n27_), .b(x01), .c(new_n47_), .O(new_n51_));
  ...
  nand2  g30(.a(new_n36_), .b(x01), .O(new_n56_));
  ...
  nand2  g46(.a(new_n71_), .b(x10), .O(new_n72_));
  nand2  g47(.a(x04), .b(new_n32_), .O(new_n73_));
  ...
  nor2   g54(.a(new_n79_), .b(new_n26_), .O(z09));
