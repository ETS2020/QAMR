...
module FAU ( 
  ...
  aoi21  g07(.a(new_n26_), .b(x04), .c(new_n32_), .O(z00));
  ...
  nand4  g14(.a(new_n34_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(x01), .O(z02));
  nand2  g16(.a(new_n26_), .b(x04), .O(new_n42_));
  nand3  g17(.a(new_n34_), .b(new_n39_), .c(new_n38_), .O(new_n43_));
  ...
  nand3  g39(.a(new_n39_), .b(new_n30_), .c(x02), .O(new_n65_));
  nand3  g40(.a(x06), .b(x04), .c(new_n38_), .O(new_n66_));
