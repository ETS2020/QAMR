...
module FAU ( 
  ...
  nand2  g02(.a(x07), .b(new_n27_), .O(new_n28_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n60_), .c(new_n55_), .d(new_n36_), .O(new_n64_));
  ...
  nand2  g43(.a(new_n41_), .b(new_n28_), .O(z07));
  nand2  g44(.a(new_n62_), .b(new_n50_), .O(new_n70_));
