...
module FAU ( 
  ...
  or2    g34(.a(new_n29_), .b(x13), .O(new_n60_));
  nand2  g35(.a(x04), .b(new_n26_), .O(new_n61_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(z06));
  nor2   g37(.a(new_n35_), .b(new_n28_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(x04), .O(z07));
  ...
  nand4  g44(.a(new_n69_), .b(new_n68_), .c(x06), .d(new_n26_), .O(new_n70_));
