...
module FAU ( 
  ...
  nor2   g09(.a(new_n27_), .b(x02), .O(z04));
  nor2   g10(.a(new_n33_), .b(x13), .O(z06));
  nand2  g11(.a(x13), .b(x06), .O(new_n40_));
  oai21  g12(.a(new_n27_), .b(x02), .c(new_n40_), .O(z09));
  nand3  g13(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n42_));
  inv1   g14(.a(new_n42_), .O(z10));
  zero   g15(.O(z02));
  zero   g16(.O(z03));
  zero   g17(.O(z05));
  nor2   g18(.a(new_n27_), .b(x02), .O(z07));
