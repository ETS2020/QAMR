...
module FAU ( 
  ...
  nand3  g17(.a(new_n27_), .b(new_n40_), .c(x00), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n38_), .c(new_n33_), .O(z03));
  nor2   g19(.a(new_n38_), .b(x02), .O(z07));
  nand2  g20(.a(z07), .b(x01), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x00), .O(z04));
  nor2   g22(.a(new_n46_), .b(new_n39_), .O(z05));
  ...
  nand3  g38(.a(new_n37_), .b(new_n26_), .c(x02), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n36_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  aoi21  g41(.a(new_n64_), .b(new_n61_), .c(new_n65_), .O(z08));
  nand3  g42(.a(x13), .b(x06), .c(x05), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z09));
  nand2  g44(.a(new_n37_), .b(new_n26_), .O(new_n70_));
  nand2  g45(.a(x06), .b(new_n36_), .O(new_n71_));
  aoi21  g46(.a(new_n70_), .b(new_n29_), .c(new_n71_), .O(z10));
endmodule
