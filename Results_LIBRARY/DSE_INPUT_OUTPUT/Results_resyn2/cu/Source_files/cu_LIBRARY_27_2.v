...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n30_, new_n31_, new_n33_, new_n34_, new_n35_,
    ...
    new_n60_, new_n63_, new_n64_, new_n66_, new_n68_;
  ...
  nand4  g10(.a(new_n30_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n36_));
  inv1   g11(.a(x01), .O(new_n37_));
  inv1   g12(.a(x02), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(new_n37_), .c(x00), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(new_n36_), .c(new_n34_), .O(z03));
  inv1   g15(.a(x00), .O(new_n41_));
  nand2  g16(.a(x01), .b(new_n41_), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n31_), .c(new_n34_), .O(z04));
  nand3  g18(.a(new_n38_), .b(x01), .c(x00), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n36_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  nor2   g21(.a(new_n33_), .b(new_n26_), .O(new_n47_));
  nor2   g22(.a(new_n30_), .b(x12), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n47_), .c(new_n27_), .d(new_n46_), .O(new_n49_));
  ...
  inv1   g36(.a(new_n31_), .O(z07));
  inv1   g37(.a(new_n27_), .O(new_n63_));
  nand2  g38(.a(new_n48_), .b(new_n47_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(new_n63_), .O(z08));
  nand2  g40(.a(x13), .b(x06), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n34_), .O(z09));
