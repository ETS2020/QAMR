...
module FAU ( 
  ...
  inv1   g05(.a(new_n27_), .O(new_n31_));
  oai21  g06(.a(x05), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  inv1   g07(.a(x04), .O(new_n33_));
  inv1   g08(.a(x05), .O(new_n34_));
  aoi21  g09(.a(new_n34_), .b(new_n33_), .c(x03), .O(new_n35_));
  nand3  g10(.a(new_n35_), .b(new_n32_), .c(new_n29_), .O(z00));
  nand2  g11(.a(new_n35_), .b(new_n32_), .O(new_n37_));
  nand2  g12(.a(new_n26_), .b(new_n34_), .O(new_n38_));
  ...
  nand3  g41(.a(new_n42_), .b(new_n34_), .c(x02), .O(new_n67_));
  ...
  oai21  g46(.a(new_n43_), .b(new_n28_), .c(new_n38_), .O(z07));
  inv1   g47(.a(new_n69_), .O(new_n73_));
  inv1   g48(.a(new_n67_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(x06), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n64_), .c(new_n73_), .O(z08));
  oai21  g51(.a(new_n42_), .b(new_n26_), .c(new_n38_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n41_), .O(new_n79_));
