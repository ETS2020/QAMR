...
module FAU ( 
  ...
  nor2   g32(.a(new_n32_), .b(x03), .O(new_n58_));
  ...
  nand4  g37(.a(new_n62_), .b(new_n58_), .c(new_n57_), .d(new_n52_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(x05), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n26_), .O(new_n65_));
  nor2   g40(.a(x13), .b(x03), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n28_), .c(x04), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n65_), .O(z06));
  nor4   g43(.a(new_n33_), .b(x13), .c(x03), .d(x02), .O(z07));
  nand2  g44(.a(x13), .b(new_n60_), .O(new_n70_));
  nand2  g45(.a(new_n27_), .b(x13), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n58_), .O(new_n72_));
