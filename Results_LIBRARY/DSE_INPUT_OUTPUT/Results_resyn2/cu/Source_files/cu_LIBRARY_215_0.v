...
module FAU ( 
  ...
  nor3   g20(.a(new_n38_), .b(new_n26_), .c(x02), .O(z07));
  nor2   g21(.a(new_n36_), .b(new_n35_), .O(new_n47_));
  and2   g22(.a(new_n47_), .b(z07), .O(z05));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x04), .d(new_n60_), .O(new_n62_));
  ...
  nand2  g40(.a(new_n65_), .b(new_n29_), .O(new_n66_));
  nand3  g41(.a(new_n31_), .b(new_n37_), .c(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  oai21  g43(.a(new_n63_), .b(new_n26_), .c(new_n29_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(z08));
  nor2   g45(.a(x05), .b(x02), .O(new_n71_));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(new_n71_), .O(z09));
  aoi21  g48(.a(x06), .b(new_n60_), .c(new_n71_), .O(new_n74_));
  aoi21  g49(.a(x05), .b(x02), .c(new_n74_), .O(z10));
endmodule
