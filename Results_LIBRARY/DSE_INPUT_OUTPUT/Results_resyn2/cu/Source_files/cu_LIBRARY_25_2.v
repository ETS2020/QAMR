...
module FAU ( 
  ...
  nand3  g11(.a(new_n26_), .b(new_n36_), .c(x05), .O(new_n37_));
  inv1   g12(.a(x00), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  nand3  g14(.a(new_n29_), .b(new_n39_), .c(new_n38_), .O(new_n40_));
  oai21  g15(.a(new_n40_), .b(new_n37_), .c(new_n35_), .O(z02));
  nand3  g16(.a(new_n29_), .b(new_n39_), .c(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n37_), .c(new_n35_), .O(z03));
  inv1   g18(.a(new_n37_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n29_), .c(x01), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x00), .O(z04));
  oai21  g21(.a(new_n45_), .b(new_n38_), .c(new_n35_), .O(z05));
  ...
  nand3  g37(.a(new_n36_), .b(new_n34_), .c(x02), .O(new_n63_));
  inv1   g38(.a(x03), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n64_), .O(new_n65_));
  aoi21  g40(.a(new_n63_), .b(new_n62_), .c(new_n65_), .O(z06));
  nor2   g41(.a(new_n37_), .b(x02), .O(z07));
  aoi21  g42(.a(new_n63_), .b(new_n60_), .c(new_n65_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  aoi21  g44(.a(new_n34_), .b(x03), .c(new_n69_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x06), .c(new_n64_), .O(new_n72_));
