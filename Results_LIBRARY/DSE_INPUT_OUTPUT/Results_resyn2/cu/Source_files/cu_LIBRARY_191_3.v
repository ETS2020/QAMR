...
module FAU ( 
  ...
  inv1   g15(.a(x05), .O(new_n41_));
  nand3  g16(.a(new_n35_), .b(new_n26_), .c(new_n29_), .O(new_n42_));
  inv1   g17(.a(x00), .O(new_n43_));
  nand2  g18(.a(x01), .b(new_n43_), .O(new_n44_));
  or2    g19(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n38_), .c(new_n41_), .O(z04));
  nor4   g21(.a(new_n39_), .b(new_n27_), .c(x13), .d(new_n34_), .O(z05));
  inv1   g22(.a(x08), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n34_), .c(x00), .O(new_n49_));
  oai21  g24(.a(x10), .b(new_n34_), .c(new_n49_), .O(new_n50_));
  inv1   g25(.a(x11), .O(new_n51_));
  nand2  g26(.a(new_n51_), .b(x01), .O(new_n52_));
  inv1   g27(.a(x09), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n34_), .c(new_n43_), .O(new_n54_));
  ...
  nor2   g33(.a(x13), .b(new_n38_), .O(new_n59_));
  ...
  aoi21  g37(.a(new_n42_), .b(new_n38_), .c(new_n41_), .O(z07));
  inv1   g38(.a(new_n30_), .O(new_n64_));
  nand3  g39(.a(x13), .b(new_n56_), .c(x05), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nor2   g41(.a(new_n59_), .b(new_n66_), .O(new_n67_));
  nor3   g42(.a(new_n67_), .b(new_n61_), .c(new_n64_), .O(z08));
  inv1   g43(.a(x06), .O(new_n69_));
  nor3   g44(.a(new_n64_), .b(new_n35_), .c(new_n69_), .O(z09));
  oai21  g45(.a(new_n69_), .b(x03), .c(new_n30_), .O(z10));
endmodule
