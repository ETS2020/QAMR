...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n51_,
  ...
  nor2   g19(.a(new_n44_), .b(new_n41_), .O(z02));
  nand2  g20(.a(new_n40_), .b(x00), .O(new_n46_));
  nand2  g21(.a(new_n35_), .b(new_n43_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n46_), .c(new_n27_), .O(z03));
  nand3  g23(.a(new_n35_), .b(x01), .c(new_n42_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n39_), .c(new_n27_), .O(z04));
  nand2  g25(.a(new_n35_), .b(x01), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n46_), .c(new_n27_), .O(z05));
  nand2  g27(.a(x04), .b(new_n36_), .O(new_n53_));
  nand3  g28(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(new_n27_), .O(new_n56_));
  ...
  nand2  g39(.a(new_n26_), .b(new_n43_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n64_), .c(x00), .O(new_n66_));
  inv1   g41(.a(x12), .O(new_n67_));
  nand4  g42(.a(x13), .b(new_n67_), .c(x05), .d(new_n35_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n66_), .c(new_n62_), .d(new_n57_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n56_), .c(new_n53_), .O(z06));
  nand2  g46(.a(new_n41_), .b(new_n27_), .O(z07));
  nor2   g47(.a(new_n69_), .b(new_n55_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n53_), .c(new_n27_), .O(z08));
  nand2  g49(.a(new_n27_), .b(x06), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(new_n38_), .O(z09));
  inv1   g51(.a(new_n31_), .O(new_n77_));
  nor2   g52(.a(new_n75_), .b(new_n77_), .O(z10));
endmodule
