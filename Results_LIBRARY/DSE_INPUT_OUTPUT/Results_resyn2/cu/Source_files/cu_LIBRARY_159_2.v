...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n35_), .c(x02), .O(new_n63_));
  ...
  nand3  g44(.a(new_n36_), .b(new_n35_), .c(x02), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n59_), .c(new_n66_), .O(z08));
  inv1   g46(.a(x06), .O(new_n72_));
  nor2   g47(.a(new_n62_), .b(new_n72_), .O(z09));
  nor2   g48(.a(new_n27_), .b(new_n72_), .O(new_n74_));
  and2   g49(.a(new_n74_), .b(new_n28_), .O(z10));
endmodule
