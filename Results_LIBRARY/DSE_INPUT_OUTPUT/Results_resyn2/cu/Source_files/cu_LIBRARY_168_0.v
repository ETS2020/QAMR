...
module FAU ( 
  ...
  nor2   g07(.a(x04), .b(x03), .O(new_n33_));
  inv1   g08(.a(new_n33_), .O(new_n34_));
  nand2  g09(.a(x04), .b(new_n26_), .O(new_n35_));
  aoi22  g10(.a(new_n35_), .b(x02), .c(new_n34_), .d(x05), .O(z01));
  inv1   g11(.a(x00), .O(new_n37_));
  inv1   g12(.a(x01), .O(new_n38_));
  inv1   g13(.a(x13), .O(new_n39_));
  nand4  g14(.a(new_n33_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(x05), .c(x02), .O(z02));
  nand2  g16(.a(new_n33_), .b(new_n39_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n30_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nor4   g20(.a(new_n42_), .b(new_n30_), .c(new_n38_), .d(x00), .O(z04));
  nand3  g21(.a(new_n43_), .b(x01), .c(x00), .O(new_n47_));
  ...
  nand3  g28(.a(new_n53_), .b(new_n51_), .c(new_n37_), .O(new_n54_));
  ...
  nand3  g39(.a(new_n39_), .b(new_n64_), .c(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n35_), .O(z06));
  aoi21  g41(.a(new_n42_), .b(x05), .c(x02), .O(z07));
  aoi21  g42(.a(new_n65_), .b(new_n61_), .c(new_n35_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  aoi21  g44(.a(new_n64_), .b(new_n27_), .c(new_n69_), .O(z09));
  nand2  g45(.a(new_n64_), .b(new_n27_), .O(new_n71_));
  nor2   g46(.a(new_n64_), .b(new_n27_), .O(new_n72_));
