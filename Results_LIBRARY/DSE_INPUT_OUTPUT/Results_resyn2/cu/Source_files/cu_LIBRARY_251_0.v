...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n33_), .c(new_n26_), .d(x01), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x00), .O(z04));
  nor2   g20(.a(new_n44_), .b(new_n36_), .O(z05));
  inv1   g21(.a(x03), .O(new_n47_));
  nand2  g22(.a(x04), .b(new_n47_), .O(new_n48_));
  ...
  nand2  g41(.a(new_n33_), .b(new_n26_), .O(new_n67_));
  nor3   g42(.a(new_n67_), .b(x13), .c(x03), .O(z07));
  nor2   g43(.a(new_n31_), .b(x03), .O(new_n69_));
  aoi21  g44(.a(new_n61_), .b(new_n69_), .c(new_n28_), .O(new_n70_));
  nand2  g45(.a(new_n43_), .b(new_n32_), .O(new_n71_));
