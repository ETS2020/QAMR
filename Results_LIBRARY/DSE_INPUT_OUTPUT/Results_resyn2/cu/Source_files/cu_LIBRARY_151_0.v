...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n72_, new_n73_, new_n74_;
  inv1   g00(.a(x03), .O(new_n26_));
  nor2   g01(.a(x06), .b(x04), .O(new_n27_));
  ...
  nand4  g09(.a(x06), .b(x05), .c(new_n31_), .d(new_n30_), .O(new_n35_));
  ...
  aoi21  g19(.a(new_n44_), .b(x06), .c(x04), .O(z03));
  ...
  aoi21  g23(.a(new_n48_), .b(x06), .c(x04), .O(z05));
  ...
  nand2  g49(.a(new_n74_), .b(new_n72_), .O(z10));
endmodule
