...
module FAU ( 
  ...
  nand4  g39(.a(new_n38_), .b(x11), .c(new_n31_), .d(x02), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z06));
  nor3   g42(.a(new_n30_), .b(x13), .c(x03), .O(z07));
