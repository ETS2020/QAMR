...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n67_, new_n71_, new_n72_, new_n74_, new_n75_;
  inv1   g00(.a(x03), .O(new_n26_));
  oai21  g01(.a(x04), .b(x02), .c(new_n26_), .O(new_n27_));
  inv1   g02(.a(x02), .O(new_n28_));
  nor2   g03(.a(x05), .b(new_n28_), .O(new_n29_));
  inv1   g04(.a(x04), .O(new_n30_));
  nor2   g05(.a(new_n30_), .b(x03), .O(new_n31_));
  aoi22  g06(.a(new_n31_), .b(new_n29_), .c(new_n27_), .d(x05), .O(z00));
  oai21  g07(.a(x05), .b(new_n28_), .c(x04), .O(new_n33_));
  inv1   g08(.a(x05), .O(new_n34_));
  oai21  g09(.a(new_n34_), .b(x02), .c(new_n30_), .O(new_n35_));
  nand3  g10(.a(new_n35_), .b(new_n33_), .c(new_n26_), .O(new_n36_));
  inv1   g11(.a(new_n36_), .O(z01));
  inv1   g12(.a(x00), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  inv1   g14(.a(x13), .O(new_n40_));
  nand3  g15(.a(new_n40_), .b(new_n30_), .c(new_n28_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n39_), .c(new_n38_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n26_), .c(new_n34_), .O(z02));
  nand3  g19(.a(new_n42_), .b(new_n39_), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n26_), .c(new_n34_), .O(z03));
  nand3  g21(.a(new_n42_), .b(x01), .c(new_n38_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n26_), .c(new_n34_), .O(z04));
  nand2  g23(.a(x01), .b(x00), .O(new_n49_));
  nor4   g24(.a(new_n49_), .b(new_n41_), .c(new_n34_), .d(x03), .O(z05));
  inv1   g25(.a(new_n31_), .O(new_n51_));
  ...
  nand2  g41(.a(new_n29_), .b(new_n40_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n51_), .O(z06));
  nor3   g43(.a(new_n41_), .b(new_n34_), .c(x03), .O(z07));
  aoi21  g44(.a(new_n67_), .b(new_n64_), .c(new_n51_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nand2  g46(.a(x05), .b(x03), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x06), .c(new_n26_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n72_), .O(z10));
endmodule
