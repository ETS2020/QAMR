...
module FAU ( 
  ...
  nand3  g08(.a(new_n28_), .b(new_n27_), .c(new_n33_), .O(new_n34_));
  inv1   g09(.a(x00), .O(new_n35_));
  inv1   g10(.a(x01), .O(new_n36_));
  nand2  g11(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  oai21  g12(.a(new_n37_), .b(new_n34_), .c(new_n32_), .O(z02));
  ...
  nand3  g18(.a(new_n43_), .b(x01), .c(new_n35_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n32_), .O(z04));
  nand3  g20(.a(new_n43_), .b(x01), .c(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n42_), .c(new_n32_), .O(z05));
  ...
  nand3  g35(.a(new_n60_), .b(new_n58_), .c(new_n35_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n51_), .c(new_n32_), .O(z06));
  inv1   g38(.a(new_n34_), .O(z07));
  ...
  nand2  g43(.a(new_n68_), .b(new_n32_), .O(z09));
