...
module FAU ( 
  ...
  nor3   g12(.a(new_n37_), .b(new_n35_), .c(x00), .O(z02));
  inv1   g13(.a(new_n35_), .O(new_n39_));
  nand2  g14(.a(new_n39_), .b(x00), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n37_), .O(z03));
  inv1   g16(.a(x04), .O(new_n42_));
  nand3  g17(.a(new_n34_), .b(new_n42_), .c(new_n26_), .O(new_n43_));
  ...
  nor2   g23(.a(new_n48_), .b(new_n40_), .O(z05));
  ...
  nor2   g35(.a(new_n42_), .b(x03), .O(new_n61_));
  ...
  nand3  g43(.a(new_n61_), .b(new_n34_), .c(new_n29_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(z06));
  aoi21  g45(.a(new_n43_), .b(x05), .c(x02), .O(z07));
  nand2  g46(.a(new_n34_), .b(new_n29_), .O(new_n72_));
  nand3  g47(.a(x13), .b(new_n63_), .c(new_n50_), .O(new_n73_));
  inv1   g48(.a(new_n27_), .O(new_n74_));
  nand2  g49(.a(new_n61_), .b(new_n74_), .O(new_n75_));
  aoi21  g50(.a(new_n73_), .b(new_n72_), .c(new_n75_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(new_n27_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x06), .c(new_n26_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n74_), .O(z10));
endmodule
