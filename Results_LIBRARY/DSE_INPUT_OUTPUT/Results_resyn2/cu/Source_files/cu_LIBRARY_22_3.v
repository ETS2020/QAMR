...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n68_, new_n71_, new_n73_, new_n74_;
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n41_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n40_), .O(z02));
  nand4  g19(.a(new_n42_), .b(x05), .c(new_n26_), .d(x00), .O(new_n45_));
  ...
  nand2  g40(.a(new_n29_), .b(new_n42_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n50_), .O(z06));
  nand2  g42(.a(new_n39_), .b(new_n42_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n26_), .c(new_n34_), .O(z07));
  aoi21  g44(.a(new_n66_), .b(new_n63_), .c(new_n50_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  oai21  g46(.a(new_n34_), .b(new_n26_), .c(new_n71_), .O(z09));
