...
module FAU ( 
  ...
  oai21  g18(.a(new_n43_), .b(new_n37_), .c(new_n33_), .O(z05));
  ...
  oai21  g35(.a(new_n60_), .b(new_n49_), .c(new_n33_), .O(z06));
  inv1   g36(.a(new_n37_), .O(z07));
  oai21  g37(.a(new_n47_), .b(new_n29_), .c(new_n33_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n33_), .O(z09));
  nand2  g40(.a(new_n36_), .b(x06), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n33_), .O(z10));
endmodule
