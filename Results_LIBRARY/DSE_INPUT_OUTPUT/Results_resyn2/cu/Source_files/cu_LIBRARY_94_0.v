...
module FAU ( 
  ...
  nand4  g14(.a(new_n39_), .b(new_n30_), .c(x05), .d(x00), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(x01), .O(z03));
  nand3  g16(.a(new_n36_), .b(x01), .c(new_n34_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x02), .O(z04));
  nor2   g18(.a(new_n40_), .b(new_n35_), .O(z05));
  ...
  nand4  g32(.a(x13), .b(new_n57_), .c(x04), .d(new_n26_), .O(new_n58_));
  ...
  nand3  g37(.a(new_n39_), .b(new_n29_), .c(x04), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(z06));
  nor2   g39(.a(new_n36_), .b(new_n29_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(x02), .O(z07));
  oai21  g41(.a(new_n59_), .b(new_n29_), .c(new_n45_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n63_), .O(z08));
