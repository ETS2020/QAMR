...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(x13), .O(z02));
  nor3   g20(.a(new_n42_), .b(x13), .c(x07), .O(z07));
  nand2  g21(.a(z07), .b(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x01), .O(z03));
  nand3  g23(.a(new_n43_), .b(x01), .c(new_n40_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n26_), .c(x13), .O(z04));
  nor2   g25(.a(new_n47_), .b(new_n41_), .O(z05));
  inv1   g26(.a(x13), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n33_), .c(x02), .O(new_n53_));
  ...
  nand2  g46(.a(new_n65_), .b(new_n53_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n37_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  oai21  g50(.a(new_n52_), .b(new_n75_), .c(new_n37_), .O(z09));
  nor3   g51(.a(new_n34_), .b(new_n27_), .c(new_n75_), .O(z10));
endmodule
