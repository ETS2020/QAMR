...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n44_, new_n46_, new_n49_, new_n51_, new_n52_, new_n53_,
  ...
  nor2   g06(.a(x11), .b(x09), .O(new_n32_));
  ...
  oai21  g17(.a(new_n42_), .b(new_n37_), .c(new_n33_), .O(z02));
  nand3  g18(.a(new_n30_), .b(new_n36_), .c(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n40_), .c(new_n33_), .O(z03));
  nand2  g20(.a(new_n30_), .b(x01), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n42_), .c(new_n33_), .O(z04));
  nor3   g22(.a(new_n40_), .b(new_n32_), .c(x02), .O(z07));
