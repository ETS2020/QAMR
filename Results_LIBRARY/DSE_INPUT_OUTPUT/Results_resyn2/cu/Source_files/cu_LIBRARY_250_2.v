...
module FAU ( 
  ...
  inv1   g38(.a(new_n33_), .O(z07));
  nand3  g39(.a(new_n50_), .b(new_n49_), .c(new_n28_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n40_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  aoi21  g42(.a(new_n26_), .b(x02), .c(new_n67_), .O(z09));
  nand2  g43(.a(new_n28_), .b(x06), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n40_), .O(z10));
endmodule
