...
module FAU ( 
  ...
  nand3  g14(.a(new_n39_), .b(new_n34_), .c(new_n26_), .O(new_n40_));
  nor3   g15(.a(new_n40_), .b(x01), .c(x00), .O(z02));
  inv1   g16(.a(x01), .O(new_n42_));
  nand3  g17(.a(new_n39_), .b(new_n42_), .c(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n26_), .c(x13), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand3  g20(.a(new_n39_), .b(x01), .c(new_n45_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n26_), .c(x13), .O(z04));
  ...
  nand2  g27(.a(new_n26_), .b(new_n42_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n52_), .c(new_n45_), .O(new_n54_));
  ...
  nand3  g38(.a(new_n34_), .b(new_n28_), .c(x02), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nor2   g40(.a(new_n37_), .b(x03), .O(new_n66_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n49_), .O(z08));
  inv1   g47(.a(x06), .O(new_n73_));
  nor2   g48(.a(new_n34_), .b(new_n73_), .O(z09));
  nor2   g49(.a(new_n27_), .b(new_n73_), .O(new_n75_));
  and2   g50(.a(new_n75_), .b(new_n31_), .O(z10));
endmodule
