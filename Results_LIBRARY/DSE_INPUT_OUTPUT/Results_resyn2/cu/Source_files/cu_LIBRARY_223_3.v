...
module FAU ( 
  ...
  nand3  g10(.a(new_n35_), .b(x05), .c(new_n29_), .O(new_n36_));
  inv1   g11(.a(new_n36_), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n34_), .O(new_n38_));
  inv1   g13(.a(x00), .O(new_n39_));
  nand3  g14(.a(new_n26_), .b(new_n27_), .c(new_n39_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n38_), .O(z02));
  nand3  g16(.a(new_n26_), .b(new_n27_), .c(x00), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n38_), .O(z03));
  nand3  g18(.a(new_n35_), .b(new_n29_), .c(new_n26_), .O(new_n44_));
  ...
  nor3   g22(.a(new_n42_), .b(new_n36_), .c(new_n34_), .O(z05));
  nor2   g23(.a(new_n29_), .b(x03), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand3  g25(.a(new_n35_), .b(new_n30_), .c(x02), .O(new_n51_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n51_), .c(new_n50_), .O(z06));
  aoi21  g43(.a(new_n44_), .b(new_n27_), .c(new_n30_), .O(z07));
  aoi21  g44(.a(new_n49_), .b(new_n35_), .c(x05), .O(new_n70_));
  nand4  g45(.a(new_n49_), .b(x13), .c(new_n64_), .d(x05), .O(new_n71_));
  oai21  g46(.a(new_n70_), .b(new_n27_), .c(new_n71_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  aoi21  g48(.a(x05), .b(x02), .c(new_n73_), .O(z09));
  inv1   g49(.a(x06), .O(new_n75_));
  oai22  g50(.a(new_n75_), .b(x03), .c(new_n30_), .d(new_n27_), .O(z10));
endmodule
