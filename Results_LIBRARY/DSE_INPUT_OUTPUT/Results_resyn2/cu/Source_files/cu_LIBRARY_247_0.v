...
module FAU ( 
  ...
  nor4   g20(.a(new_n37_), .b(new_n35_), .c(new_n39_), .d(new_n43_), .O(z05));
  ...
  nand3  g26(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(new_n52_));
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(x04), .d(new_n29_), .O(new_n59_));
  ...
  nand4  g39(.a(new_n34_), .b(new_n64_), .c(x04), .d(new_n29_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n63_), .O(z06));
  nor2   g41(.a(new_n40_), .b(new_n64_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  oai21  g43(.a(new_n60_), .b(new_n64_), .c(new_n36_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n65_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nand2  g46(.a(new_n64_), .b(new_n36_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(z09));
  inv1   g48(.a(new_n30_), .O(new_n74_));
  nand2  g49(.a(x06), .b(new_n29_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n72_), .c(new_n74_), .O(z10));
endmodule
