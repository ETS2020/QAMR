...
module FAU ( 
  ...
  aoi21  g05(.a(x04), .b(x02), .c(x03), .O(new_n31_));
  inv1   g06(.a(x02), .O(new_n32_));
  inv1   g07(.a(x03), .O(new_n33_));
  inv1   g08(.a(x04), .O(new_n34_));
  nand4  g09(.a(x05), .b(new_n34_), .c(new_n33_), .d(new_n32_), .O(new_n35_));
  oai21  g10(.a(new_n31_), .b(x05), .c(new_n35_), .O(z01));
  ...
  nand2  g17(.a(new_n26_), .b(x03), .O(new_n43_));
  inv1   g18(.a(x01), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n42_), .c(new_n43_), .O(z03));
  oai21  g21(.a(new_n40_), .b(new_n44_), .c(new_n43_), .O(z04));
  nand2  g22(.a(x01), .b(x00), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n42_), .O(z05));
