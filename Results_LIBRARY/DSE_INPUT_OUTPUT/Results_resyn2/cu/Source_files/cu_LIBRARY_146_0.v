...
module FAU ( 
  ...
  oai21  g18(.a(new_n43_), .b(new_n40_), .c(new_n34_), .O(z03));
  nor3   g19(.a(new_n40_), .b(new_n42_), .c(x00), .O(z04));
  inv1   g20(.a(x00), .O(new_n46_));
  nor3   g21(.a(new_n40_), .b(new_n42_), .c(new_n46_), .O(z05));
  nand3  g22(.a(new_n38_), .b(new_n31_), .c(x02), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand2  g24(.a(new_n49_), .b(x12), .O(new_n50_));
  ...
  nor2   g35(.a(new_n38_), .b(x02), .O(new_n61_));
  inv1   g36(.a(x07), .O(new_n62_));
  inv1   g37(.a(x12), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n62_), .c(x05), .O(new_n64_));
  ...
  aoi21  g42(.a(new_n66_), .b(new_n50_), .c(new_n67_), .O(z06));
  inv1   g43(.a(new_n40_), .O(z07));
  nand3  g44(.a(x13), .b(new_n63_), .c(new_n27_), .O(new_n70_));
  and2   g45(.a(new_n70_), .b(new_n48_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n67_), .c(new_n34_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n26_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n37_), .O(new_n76_));
