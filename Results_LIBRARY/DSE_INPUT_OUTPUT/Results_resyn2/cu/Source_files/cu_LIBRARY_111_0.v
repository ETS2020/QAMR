...
module FAU ( 
  ...
  nand2  g17(.a(new_n42_), .b(new_n33_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z02));
  nand4  g19(.a(new_n35_), .b(new_n34_), .c(new_n33_), .d(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n39_), .c(new_n36_), .O(z03));
  nand2  g21(.a(new_n42_), .b(x01), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z04));
  inv1   g23(.a(x00), .O(new_n49_));
  nor3   g24(.a(new_n41_), .b(new_n33_), .c(new_n49_), .O(z05));
  ...
  nand3  g30(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(new_n56_));
