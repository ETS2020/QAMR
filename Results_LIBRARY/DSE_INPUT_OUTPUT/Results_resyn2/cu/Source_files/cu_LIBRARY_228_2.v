...
module FAU ( 
  ...
  nor2   g08(.a(x05), .b(new_n26_), .O(new_n34_));
  inv1   g09(.a(new_n34_), .O(new_n35_));
  inv1   g10(.a(x13), .O(new_n36_));
  nor2   g11(.a(x04), .b(x03), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n36_), .c(x05), .d(new_n27_), .O(new_n38_));
  ...
  nand3  g24(.a(new_n36_), .b(new_n30_), .c(x02), .O(new_n50_));
  ...
  nor2   g38(.a(x07), .b(x03), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n63_), .c(new_n60_), .d(new_n55_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n50_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(x04), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n35_), .O(z06));
  inv1   g43(.a(new_n38_), .O(z07));
  nand2  g44(.a(x04), .b(new_n26_), .O(new_n70_));
  aoi21  g45(.a(new_n62_), .b(new_n50_), .c(new_n70_), .O(z08));
  inv1   g46(.a(x06), .O(new_n72_));
  nor3   g47(.a(new_n34_), .b(new_n36_), .c(new_n72_), .O(z09));
  nand2  g48(.a(new_n26_), .b(new_n27_), .O(new_n74_));
  aoi22  g49(.a(new_n74_), .b(x05), .c(new_n72_), .d(new_n26_), .O(z10));
endmodule
