...
module FAU ( 
  ...
  inv1   g12(.a(new_n37_), .O(z02));
  nand2  g13(.a(new_n36_), .b(new_n34_), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(x00), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n39_), .c(new_n33_), .O(z03));
  inv1   g17(.a(x00), .O(new_n43_));
  nand2  g18(.a(x01), .b(new_n43_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n39_), .c(new_n33_), .O(z04));
  nor2   g20(.a(new_n40_), .b(new_n43_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n36_), .c(new_n34_), .d(new_n33_), .O(new_n47_));
  ...
  nand2  g30(.a(new_n35_), .b(new_n55_), .O(new_n56_));
  ...
  nand2  g39(.a(x10), .b(new_n64_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n60_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n54_), .c(new_n50_), .O(z06));
  nor2   g43(.a(new_n39_), .b(new_n26_), .O(z07));
  and2   g44(.a(new_n63_), .b(new_n52_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n50_), .c(new_n33_), .O(z08));
