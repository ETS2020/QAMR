...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n31_, new_n36_, new_n38_;
  ...
  nand2  g09(.a(x13), .b(x06), .O(new_n36_));
  oai21  g10(.a(new_n27_), .b(x03), .c(new_n36_), .O(z09));
  inv1   g11(.a(x06), .O(new_n38_));
  aoi21  g12(.a(new_n38_), .b(new_n27_), .c(x03), .O(z10));
  zero   g13(.O(z02));
