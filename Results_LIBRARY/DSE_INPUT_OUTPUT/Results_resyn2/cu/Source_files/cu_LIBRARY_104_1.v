...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(new_n26_), .O(new_n36_));
  ...
  oai21  g20(.a(new_n45_), .b(new_n39_), .c(new_n36_), .O(z02));
  nand2  g21(.a(new_n44_), .b(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n39_), .c(new_n36_), .O(z03));
  ...
  nand3  g41(.a(new_n42_), .b(new_n26_), .c(x02), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n53_), .O(new_n69_));
  nand2  g44(.a(x04), .b(new_n41_), .O(new_n70_));
  aoi21  g45(.a(new_n69_), .b(new_n66_), .c(new_n70_), .O(z06));
  nor2   g46(.a(new_n43_), .b(x02), .O(z07));
