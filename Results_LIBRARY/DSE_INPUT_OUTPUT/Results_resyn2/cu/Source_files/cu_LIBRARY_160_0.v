...
module FAU ( 
  ...
  nor2   g41(.a(new_n36_), .b(new_n30_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  aoi21  g43(.a(new_n64_), .b(new_n61_), .c(new_n65_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nand2  g45(.a(new_n30_), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(z09));
  nand2  g47(.a(x06), .b(new_n26_), .O(new_n73_));
  nor2   g48(.a(new_n30_), .b(new_n27_), .O(new_n74_));
  aoi21  g49(.a(new_n73_), .b(new_n71_), .c(new_n74_), .O(z10));
endmodule
