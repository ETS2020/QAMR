...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n71_, new_n74_, new_n75_;
  ...
  nand4  g14(.a(new_n39_), .b(new_n38_), .c(x05), .d(new_n37_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n28_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n36_), .O(new_n42_));
  ...
  nor2   g22(.a(new_n46_), .b(new_n44_), .O(z05));
  ...
  nand3  g29(.a(new_n54_), .b(new_n52_), .c(new_n44_), .O(new_n55_));
  nand2  g30(.a(new_n27_), .b(x01), .O(new_n56_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n59_), .c(new_n55_), .d(new_n50_), .O(new_n64_));
  nand3  g39(.a(new_n38_), .b(new_n31_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g41(.a(new_n37_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n49_), .O(z06));
  nand2  g44(.a(new_n40_), .b(new_n49_), .O(z07));
  nand2  g45(.a(new_n29_), .b(x04), .O(new_n71_));
  aoi21  g46(.a(new_n65_), .b(new_n62_), .c(new_n71_), .O(z08));
  aoi21  g47(.a(new_n38_), .b(new_n27_), .c(new_n26_), .O(z09));
  inv1   g48(.a(x03), .O(new_n74_));
  nand4  g49(.a(new_n30_), .b(new_n27_), .c(x06), .d(new_n74_), .O(new_n75_));
