...
module FAU ( 
  ...
  nand3  g18(.a(x13), .b(new_n43_), .c(x04), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n30_), .c(new_n42_), .O(new_n46_));
  ...
  inv1   g32(.a(x05), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(x02), .O(new_n59_));
  oai21  g34(.a(new_n57_), .b(new_n46_), .c(new_n59_), .O(z06));
  inv1   g35(.a(new_n35_), .O(z07));
  oai21  g36(.a(new_n44_), .b(new_n29_), .c(new_n59_), .O(z08));
  nand2  g37(.a(x13), .b(x06), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n59_), .O(z09));
  nand2  g39(.a(new_n34_), .b(x06), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n59_), .O(z10));
endmodule
