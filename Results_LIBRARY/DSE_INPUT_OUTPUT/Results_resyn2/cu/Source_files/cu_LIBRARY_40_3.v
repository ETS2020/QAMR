...
module FAU ( 
  ...
  oai21  g18(.a(new_n43_), .b(new_n41_), .c(new_n35_), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand2  g20(.a(x01), .b(new_n45_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n41_), .c(new_n35_), .O(z04));
  nor2   g22(.a(new_n42_), .b(new_n45_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n49_));
  ...
  nand2  g28(.a(new_n26_), .b(x01), .O(new_n54_));
  inv1   g29(.a(x08), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(new_n42_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n54_), .c(new_n45_), .O(new_n57_));
  ...
  nand4  g38(.a(x13), .b(new_n27_), .c(x05), .d(new_n63_), .O(new_n64_));
  ...
  aoi21  g44(.a(new_n66_), .b(new_n52_), .c(new_n69_), .O(z06));
  nor2   g45(.a(new_n41_), .b(new_n28_), .O(z07));
  nand2  g46(.a(new_n64_), .b(new_n52_), .O(new_n72_));
