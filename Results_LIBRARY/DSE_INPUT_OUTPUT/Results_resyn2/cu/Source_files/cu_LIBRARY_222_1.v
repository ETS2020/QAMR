...
module FAU ( 
  ...
  nand4  g13(.a(new_n29_), .b(new_n38_), .c(x05), .d(new_n37_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(x01), .c(x00), .O(z02));
  inv1   g15(.a(x00), .O(new_n41_));
  or2    g16(.a(new_n39_), .b(new_n41_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x01), .O(z03));
  inv1   g18(.a(x01), .O(new_n44_));
  nor3   g19(.a(new_n39_), .b(new_n44_), .c(x00), .O(z04));
  inv1   g20(.a(new_n27_), .O(new_n46_));
  oai21  g21(.a(new_n42_), .b(new_n44_), .c(new_n46_), .O(z05));
  inv1   g22(.a(x07), .O(new_n48_));
  nand2  g23(.a(new_n26_), .b(x01), .O(new_n49_));
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n57_), .c(new_n52_), .d(new_n48_), .O(new_n61_));
  nand3  g36(.a(new_n38_), .b(new_n33_), .c(x02), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nor2   g38(.a(new_n32_), .b(x03), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n46_), .O(z06));
  nand2  g41(.a(new_n39_), .b(new_n46_), .O(z07));
  inv1   g42(.a(new_n64_), .O(new_n68_));
  inv1   g43(.a(new_n62_), .O(new_n69_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n46_), .O(z10));
endmodule
