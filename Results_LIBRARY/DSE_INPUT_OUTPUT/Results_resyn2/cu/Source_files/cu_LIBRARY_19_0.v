...
module FAU ( 
  ...
  nand3  g13(.a(new_n38_), .b(new_n27_), .c(new_n26_), .O(new_n39_));
  ...
  nand3  g18(.a(new_n43_), .b(new_n37_), .c(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x06), .c(x13), .O(z03));
  nand2  g20(.a(new_n40_), .b(x01), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x06), .c(x13), .O(z04));
  nand3  g22(.a(new_n43_), .b(x01), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x06), .c(x13), .O(z05));
  ...
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n56_), .d(new_n50_), .O(new_n65_));
  nand3  g40(.a(new_n33_), .b(new_n28_), .c(x02), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n39_), .b(x06), .c(x13), .O(z07));
  ...
  nor2   g49(.a(new_n33_), .b(new_n32_), .O(z09));
