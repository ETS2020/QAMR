...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n45_,
  ...
  nor2   g01(.a(x05), .b(x02), .O(new_n27_));
  nor2   g02(.a(new_n27_), .b(new_n26_), .O(new_n28_));
  inv1   g03(.a(x05), .O(new_n29_));
  nor2   g04(.a(x04), .b(x02), .O(new_n30_));
  aoi21  g05(.a(new_n29_), .b(x04), .c(new_n30_), .O(new_n31_));
  or2    g06(.a(new_n31_), .b(new_n28_), .O(z00));
  nor3   g07(.a(new_n31_), .b(new_n27_), .c(x03), .O(z01));
  ...
  aoi21  g14(.a(new_n39_), .b(x05), .c(x02), .O(z03));
  inv1   g15(.a(x00), .O(new_n41_));
  nand3  g16(.a(new_n38_), .b(x01), .c(new_n41_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x02), .O(z04));
  nor3   g18(.a(new_n35_), .b(new_n37_), .c(new_n41_), .O(z05));
  inv1   g19(.a(x02), .O(new_n45_));
  inv1   g20(.a(x10), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(x01), .O(new_n47_));
  inv1   g22(.a(x08), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n37_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n47_), .c(new_n41_), .O(new_n50_));
  ...
  nand4  g36(.a(new_n61_), .b(new_n57_), .c(new_n55_), .d(new_n50_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x05), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n45_), .O(new_n64_));
  nand3  g39(.a(new_n57_), .b(new_n34_), .c(new_n29_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(z06));
  inv1   g41(.a(new_n35_), .O(z07));
  nand2  g42(.a(new_n34_), .b(new_n29_), .O(new_n68_));
  nand3  g43(.a(x13), .b(new_n59_), .c(new_n45_), .O(new_n69_));
  inv1   g44(.a(new_n27_), .O(new_n70_));
  nand2  g45(.a(new_n57_), .b(new_n70_), .O(new_n71_));
  aoi21  g46(.a(new_n69_), .b(new_n68_), .c(new_n71_), .O(z08));
  ...
  nand2  g51(.a(new_n76_), .b(new_n70_), .O(z10));
endmodule
