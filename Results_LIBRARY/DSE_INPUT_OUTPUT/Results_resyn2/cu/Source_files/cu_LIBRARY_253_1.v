...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n39_, new_n41_;
  ...
  nand2  g15(.a(new_n41_), .b(new_n33_), .O(z10));
  zero   g16(.O(z04));
