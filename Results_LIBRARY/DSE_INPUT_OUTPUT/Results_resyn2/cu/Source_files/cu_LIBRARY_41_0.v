...
module FAU ( 
  ...
  nand2  g22(.a(new_n27_), .b(x01), .O(new_n48_));
  inv1   g23(.a(x08), .O(new_n49_));
  nand2  g24(.a(new_n49_), .b(new_n44_), .O(new_n50_));
  ...
  nand4  g34(.a(new_n59_), .b(new_n56_), .c(new_n51_), .d(new_n47_), .O(new_n60_));
  nand3  g35(.a(new_n39_), .b(new_n26_), .c(x02), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x10), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n38_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n60_), .c(new_n64_), .O(z06));
  nand2  g40(.a(new_n40_), .b(new_n35_), .O(z07));
  nor2   g41(.a(new_n62_), .b(new_n59_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n64_), .c(new_n35_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n35_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x06), .c(new_n38_), .O(new_n72_));
