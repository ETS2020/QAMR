...
module FAU ( 
  ...
  oai21  g21(.a(new_n46_), .b(new_n38_), .c(new_n34_), .O(z03));
  nand2  g22(.a(new_n28_), .b(x01), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n44_), .c(new_n34_), .O(z04));
  ...
  nand4  g41(.a(new_n41_), .b(new_n66_), .c(new_n26_), .d(x02), .O(new_n67_));
  nand2  g42(.a(x04), .b(new_n40_), .O(new_n68_));
  aoi21  g43(.a(new_n67_), .b(new_n65_), .c(new_n68_), .O(z06));
  nor2   g44(.a(new_n42_), .b(new_n29_), .O(z07));
  aoi21  g45(.a(new_n67_), .b(new_n63_), .c(new_n68_), .O(z08));
  nand3  g46(.a(x13), .b(x06), .c(x05), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z09));
  nand4  g48(.a(x06), .b(x05), .c(new_n40_), .d(new_n27_), .O(new_n74_));
