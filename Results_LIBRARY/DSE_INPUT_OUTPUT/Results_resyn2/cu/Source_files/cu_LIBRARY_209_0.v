...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n52_,
  ...
  oai21  g03(.a(new_n28_), .b(x02), .c(new_n26_), .O(new_n29_));
  inv1   g04(.a(x02), .O(new_n30_));
  oai21  g05(.a(new_n27_), .b(new_n30_), .c(new_n28_), .O(new_n31_));
  ...
  nand2  g10(.a(new_n26_), .b(new_n35_), .O(new_n36_));
  nand2  g11(.a(new_n36_), .b(new_n34_), .O(z01));
  inv1   g12(.a(x03), .O(new_n38_));
  inv1   g13(.a(x13), .O(new_n39_));
  nor2   g14(.a(new_n35_), .b(x04), .O(new_n40_));
  nand3  g15(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(new_n41_));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(new_n30_), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n41_), .c(new_n36_), .O(z02));
  nand3  g20(.a(new_n30_), .b(new_n43_), .c(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n41_), .c(new_n36_), .O(z03));
  nand4  g22(.a(new_n40_), .b(new_n39_), .c(new_n38_), .d(new_n30_), .O(new_n48_));
  nand2  g23(.a(x01), .b(new_n42_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n48_), .c(new_n36_), .O(z04));
  nor3   g25(.a(new_n48_), .b(new_n43_), .c(new_n42_), .O(z05));
  ...
  nand2  g32(.a(new_n26_), .b(x01), .O(new_n58_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n57_), .d(new_n52_), .O(new_n65_));
  nand3  g40(.a(new_n39_), .b(new_n35_), .c(x02), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(x11), .O(new_n68_));
  nand2  g43(.a(x04), .b(new_n38_), .O(new_n69_));
  aoi21  g44(.a(new_n68_), .b(new_n65_), .c(new_n69_), .O(z06));
  nand2  g45(.a(new_n48_), .b(new_n36_), .O(z07));
  nor2   g46(.a(new_n67_), .b(new_n64_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n69_), .c(new_n36_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  aoi21  g49(.a(new_n26_), .b(new_n35_), .c(new_n74_), .O(z09));
