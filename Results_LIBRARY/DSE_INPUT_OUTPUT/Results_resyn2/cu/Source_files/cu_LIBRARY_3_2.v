...
module FAU ( 
  ...
  nor2   g05(.a(x03), .b(x02), .O(new_n31_));
  ...
  nand4  g10(.a(new_n31_), .b(new_n35_), .c(x05), .d(new_n28_), .O(new_n36_));
  inv1   g11(.a(x00), .O(new_n37_));
  inv1   g12(.a(x01), .O(new_n38_));
  nand2  g13(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(new_n36_), .c(new_n34_), .O(z02));
  nor3   g15(.a(new_n36_), .b(x01), .c(new_n37_), .O(z03));
  nand2  g16(.a(x01), .b(new_n37_), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n36_), .c(new_n34_), .O(z04));
  nand2  g18(.a(x01), .b(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n36_), .c(new_n34_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  and2   g21(.a(x05), .b(x04), .O(new_n47_));
  nor2   g22(.a(new_n35_), .b(x12), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n47_), .c(new_n31_), .d(new_n46_), .O(new_n49_));
  ...
  nand3  g37(.a(new_n48_), .b(new_n47_), .c(new_n31_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n34_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n27_), .O(z09));
  nand2  g41(.a(new_n31_), .b(x06), .O(new_n67_));
