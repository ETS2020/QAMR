...
module FAU ( 
  ...
  nor3   g06(.a(x13), .b(x03), .c(x02), .O(new_n32_));
  ...
  nand4  g12(.a(new_n32_), .b(new_n28_), .c(new_n35_), .d(x00), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(z03));
  nand2  g14(.a(x01), .b(new_n34_), .O(new_n40_));
  oai21  g15(.a(new_n40_), .b(new_n33_), .c(new_n30_), .O(z04));
  nand4  g16(.a(new_n32_), .b(new_n28_), .c(x01), .d(x00), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n30_), .O(z05));
  inv1   g18(.a(x07), .O(new_n44_));
  and2   g19(.a(x05), .b(x04), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x12), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n45_), .c(new_n26_), .d(new_n44_), .O(new_n48_));
  ...
  inv1   g35(.a(new_n33_), .O(z07));
  inv1   g36(.a(new_n26_), .O(new_n62_));
  nand2  g37(.a(new_n47_), .b(new_n45_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n62_), .O(z08));
  inv1   g39(.a(x06), .O(new_n65_));
  oai21  g40(.a(new_n46_), .b(new_n65_), .c(new_n30_), .O(z09));
  oai21  g41(.a(new_n62_), .b(new_n65_), .c(new_n30_), .O(z10));
endmodule
