...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n45_,
  ...
  nand3  g12(.a(new_n37_), .b(new_n36_), .c(x00), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(x05), .c(x02), .O(z03));
  inv1   g14(.a(x00), .O(new_n40_));
  nand3  g15(.a(new_n37_), .b(x01), .c(new_n40_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(x05), .c(x02), .O(z04));
  nand3  g17(.a(new_n37_), .b(x01), .c(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(x05), .c(x02), .O(z05));
  ...
  inv1   g39(.a(new_n34_), .O(z07));
  oai21  g40(.a(new_n59_), .b(new_n27_), .c(new_n26_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n63_), .O(z08));
  nand2  g42(.a(new_n27_), .b(new_n26_), .O(new_n68_));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(z09));
  nand2  g45(.a(x06), .b(new_n56_), .O(new_n71_));
  nor2   g46(.a(new_n27_), .b(new_n26_), .O(new_n72_));
  aoi21  g47(.a(new_n71_), .b(new_n68_), .c(new_n72_), .O(z10));
endmodule
