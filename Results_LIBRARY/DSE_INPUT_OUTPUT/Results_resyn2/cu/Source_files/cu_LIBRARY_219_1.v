...
module FAU ( 
  ...
  nand2  g09(.a(x05), .b(new_n26_), .O(new_n37_));
  inv1   g10(.a(new_n37_), .O(z04));
  nor2   g11(.a(new_n33_), .b(x13), .O(z06));
  nand2  g12(.a(x13), .b(x06), .O(new_n40_));
  nand2  g13(.a(new_n40_), .b(new_n37_), .O(z09));
  nand3  g14(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n42_));
  nand2  g15(.a(new_n42_), .b(new_n37_), .O(z10));
  zero   g16(.O(z02));
  zero   g17(.O(z03));
  inv1   g18(.a(new_n37_), .O(z05));
  inv1   g19(.a(new_n37_), .O(z07));
  nor2   g20(.a(new_n33_), .b(x13), .O(z08));
endmodule
