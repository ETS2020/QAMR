...
module FAU ( 
  ...
  nand2  g00(.a(x12), .b(x09), .O(new_n26_));
  ...
  nand3  g17(.a(new_n26_), .b(new_n42_), .c(new_n41_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n40_), .O(z02));
  nand2  g19(.a(new_n39_), .b(x00), .O(new_n45_));
  nand2  g20(.a(new_n34_), .b(new_n42_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n26_), .O(z03));
  nand3  g22(.a(new_n34_), .b(x01), .c(new_n41_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n38_), .c(new_n26_), .O(z04));
  nand2  g24(.a(new_n34_), .b(x01), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n45_), .c(new_n26_), .O(z05));
  nand3  g26(.a(new_n37_), .b(new_n27_), .c(x02), .O(new_n52_));
  ...
  nand2  g46(.a(new_n65_), .b(new_n52_), .O(new_n72_));
