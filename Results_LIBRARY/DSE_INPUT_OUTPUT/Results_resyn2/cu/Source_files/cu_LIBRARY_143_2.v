...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n44_, new_n47_, new_n50_, new_n51_, new_n52_, new_n53_,
  ...
  nand2  g18(.a(x09), .b(x05), .O(new_n44_));
  nor4   g19(.a(new_n44_), .b(new_n40_), .c(x01), .d(new_n36_), .O(z03));
  nor2   g20(.a(new_n44_), .b(new_n40_), .O(z07));
  nand2  g21(.a(z07), .b(x01), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x00), .O(z04));
  nor2   g23(.a(new_n47_), .b(new_n36_), .O(z05));
  inv1   g24(.a(new_n27_), .O(new_n50_));
  nand2  g25(.a(x10), .b(x01), .O(new_n51_));
  nand2  g26(.a(x08), .b(new_n37_), .O(new_n52_));
  ...
  nand3  g44(.a(new_n69_), .b(x06), .c(new_n38_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n50_), .O(z10));
endmodule
