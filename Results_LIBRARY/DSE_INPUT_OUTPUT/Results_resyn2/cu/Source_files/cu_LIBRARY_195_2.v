...
module FAU ( 
  ...
  nand4  g14(.a(new_n27_), .b(new_n33_), .c(x05), .d(new_n26_), .O(new_n40_));
  nor3   g15(.a(new_n40_), .b(x01), .c(new_n35_), .O(z03));
  nand3  g16(.a(new_n37_), .b(x01), .c(new_n35_), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n34_), .c(new_n31_), .O(z04));
  nand2  g18(.a(x01), .b(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n40_), .c(new_n31_), .O(z05));
  ...
  inv1   g36(.a(new_n40_), .O(z07));
  nand3  g37(.a(new_n48_), .b(new_n47_), .c(new_n27_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n31_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n31_), .O(z09));
  nand2  g41(.a(new_n27_), .b(x06), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n31_), .O(z10));
endmodule
