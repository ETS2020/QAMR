...
module FAU ( 
  ...
  nand3  g15(.a(new_n40_), .b(x06), .c(new_n36_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n35_), .O(z02));
  nand2  g17(.a(new_n34_), .b(x00), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n41_), .O(z03));
  nand2  g19(.a(new_n40_), .b(x01), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n35_), .O(z04));
  nor2   g21(.a(new_n45_), .b(new_n43_), .O(z05));
  inv1   g22(.a(new_n26_), .O(new_n48_));
  ...
  nand3  g39(.a(new_n38_), .b(new_n27_), .c(x02), .O(new_n65_));
  ...
  inv1   g44(.a(new_n34_), .O(new_n70_));
  oai21  g45(.a(new_n39_), .b(new_n70_), .c(new_n48_), .O(z07));
  nand2  g46(.a(new_n65_), .b(new_n62_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n48_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n48_), .O(z09));
