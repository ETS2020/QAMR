...
module FAU ( 
  ...
  nand2  g00(.a(x04), .b(x03), .O(new_n26_));
  inv1   g01(.a(x05), .O(new_n27_));
  nand2  g02(.a(new_n27_), .b(x02), .O(new_n28_));
  inv1   g03(.a(x03), .O(new_n29_));
  inv1   g04(.a(x04), .O(new_n30_));
  nand2  g05(.a(new_n30_), .b(new_n29_), .O(new_n31_));
  nand3  g06(.a(new_n31_), .b(new_n28_), .c(new_n26_), .O(new_n32_));
  nor2   g07(.a(new_n27_), .b(x02), .O(new_n33_));
  oai21  g08(.a(new_n33_), .b(x04), .c(new_n32_), .O(z00));
  inv1   g09(.a(z00), .O(z01));
  inv1   g10(.a(x00), .O(new_n36_));
  inv1   g11(.a(x01), .O(new_n37_));
  nor2   g12(.a(new_n31_), .b(x13), .O(new_n38_));
  nand4  g13(.a(new_n38_), .b(new_n33_), .c(new_n37_), .d(new_n36_), .O(new_n39_));
  inv1   g14(.a(new_n39_), .O(z02));
  nand4  g15(.a(new_n38_), .b(new_n33_), .c(new_n37_), .d(x00), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z03));
  nand4  g17(.a(new_n38_), .b(new_n33_), .c(x01), .d(new_n36_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z04));
  nand4  g19(.a(new_n38_), .b(new_n33_), .c(x01), .d(x00), .O(new_n45_));
  ...
  and2   g39(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n30_), .O(z06));
  nand2  g41(.a(new_n38_), .b(new_n33_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n26_), .O(z07));
  nand2  g43(.a(x04), .b(new_n29_), .O(new_n69_));
  aoi21  g44(.a(new_n64_), .b(new_n60_), .c(new_n69_), .O(z08));
