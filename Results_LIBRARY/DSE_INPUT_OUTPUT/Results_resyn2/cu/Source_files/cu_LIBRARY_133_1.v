...
module FAU ( 
  ...
  nand4  g08(.a(new_n33_), .b(new_n31_), .c(new_n28_), .d(new_n27_), .O(z00));
  inv1   g09(.a(z00), .O(z01));
  inv1   g10(.a(x13), .O(new_n36_));
  nor2   g11(.a(x04), .b(x03), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n36_), .c(x05), .d(new_n32_), .O(new_n38_));
  ...
  oai21  g20(.a(new_n45_), .b(new_n38_), .c(new_n27_), .O(z04));
  nand3  g21(.a(new_n27_), .b(x01), .c(x00), .O(new_n47_));
  ...
  nand2  g26(.a(x09), .b(new_n40_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n51_), .c(new_n27_), .d(x00), .O(new_n53_));
  nor2   g28(.a(x10), .b(x00), .O(new_n54_));
  oai21  g29(.a(new_n26_), .b(x01), .c(new_n54_), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nand4  g32(.a(x13), .b(new_n57_), .c(x05), .d(new_n32_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x07), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  nand3  g35(.a(new_n36_), .b(new_n30_), .c(x02), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n27_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n50_), .O(z06));
  nand2  g39(.a(new_n38_), .b(new_n27_), .O(z07));
  and2   g40(.a(new_n61_), .b(new_n58_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n50_), .c(new_n27_), .O(z08));
  nand2  g42(.a(x13), .b(x06), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n27_), .O(z09));
  nand3  g44(.a(new_n28_), .b(new_n27_), .c(x06), .O(new_n70_));
