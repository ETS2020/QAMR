...
module FAU ( 
  ...
  nor2   g04(.a(new_n29_), .b(x05), .O(new_n30_));
  ...
  nand2  g25(.a(new_n29_), .b(x01), .O(new_n51_));
  ...
  nand3  g33(.a(new_n30_), .b(new_n36_), .c(x02), .O(new_n59_));
  nand2  g34(.a(x04), .b(new_n35_), .O(new_n60_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z06));
  nor3   g36(.a(new_n28_), .b(x13), .c(x03), .O(z07));
  aoi21  g37(.a(new_n59_), .b(new_n56_), .c(new_n60_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  oai21  g39(.a(x11), .b(new_n26_), .c(new_n64_), .O(z09));
  nor2   g40(.a(new_n30_), .b(new_n26_), .O(new_n66_));
  nand2  g41(.a(x06), .b(new_n35_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(new_n66_), .O(z10));
endmodule
