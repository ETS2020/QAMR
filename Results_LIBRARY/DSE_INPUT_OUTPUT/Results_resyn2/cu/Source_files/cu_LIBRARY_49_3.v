...
module FAU ( 
  ...
  aoi22  g07(.a(new_n32_), .b(new_n30_), .c(new_n28_), .d(new_n26_), .O(z01));
  inv1   g08(.a(z01), .O(z00));
  inv1   g09(.a(x01), .O(new_n35_));
  nand2  g10(.a(new_n29_), .b(new_n35_), .O(new_n36_));
  ...
  nor3   g17(.a(new_n39_), .b(new_n36_), .c(new_n37_), .O(z03));
  nor3   g18(.a(new_n41_), .b(new_n30_), .c(new_n35_), .O(z04));
  nand4  g19(.a(new_n29_), .b(new_n38_), .c(x01), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n27_), .c(new_n26_), .O(z05));
  ...
  nand4  g37(.a(new_n38_), .b(new_n26_), .c(new_n27_), .d(x02), .O(new_n63_));
  ...
  nand2  g42(.a(new_n29_), .b(new_n38_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n27_), .c(new_n26_), .O(z07));
