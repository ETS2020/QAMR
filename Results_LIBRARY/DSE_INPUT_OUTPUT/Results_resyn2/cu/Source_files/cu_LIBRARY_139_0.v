...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n29_), .c(x02), .O(new_n63_));
  ...
  nand2  g42(.a(new_n63_), .b(new_n59_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n34_), .O(z08));
  oai21  g45(.a(new_n62_), .b(new_n33_), .c(new_n34_), .O(z09));
  nand2  g46(.a(x06), .b(new_n26_), .O(new_n72_));
  aoi22  g47(.a(new_n72_), .b(x05), .c(x06), .d(x03), .O(z10));
endmodule
