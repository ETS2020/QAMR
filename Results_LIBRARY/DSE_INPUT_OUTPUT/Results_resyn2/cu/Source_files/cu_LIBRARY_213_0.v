...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n26_), .c(new_n39_), .O(new_n40_));
  nor3   g15(.a(new_n40_), .b(new_n38_), .c(x00), .O(z02));
  inv1   g16(.a(x00), .O(new_n42_));
  nor3   g17(.a(new_n40_), .b(new_n38_), .c(new_n42_), .O(z03));
  nand3  g18(.a(new_n37_), .b(new_n29_), .c(new_n36_), .O(new_n44_));
  nand2  g19(.a(x01), .b(new_n42_), .O(new_n45_));
  or2    g20(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x05), .c(x02), .O(z04));
  nor4   g22(.a(new_n38_), .b(new_n30_), .c(new_n39_), .d(new_n42_), .O(z05));
  ...
  aoi21  g41(.a(new_n44_), .b(x05), .c(x02), .O(z07));
