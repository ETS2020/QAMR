...
module FAU ( 
  ...
  nor2   g06(.a(new_n29_), .b(x03), .O(new_n32_));
  oai22  g07(.a(new_n32_), .b(new_n26_), .c(new_n31_), .d(new_n27_), .O(z00));
  ...
  nand4  g15(.a(new_n40_), .b(x05), .c(new_n26_), .d(x00), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n30_), .O(new_n42_));
  ...
  inv1   g23(.a(new_n32_), .O(new_n49_));
  nand3  g24(.a(new_n40_), .b(new_n27_), .c(x02), .O(new_n50_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n50_), .c(new_n49_), .O(z06));
  inv1   g42(.a(new_n37_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(x05), .c(x02), .O(z07));
  nor2   g44(.a(new_n40_), .b(x12), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n32_), .c(new_n27_), .O(new_n71_));
  nand3  g46(.a(new_n32_), .b(new_n40_), .c(new_n27_), .O(new_n72_));
  oai21  g47(.a(new_n71_), .b(x02), .c(new_n72_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  aoi21  g49(.a(new_n27_), .b(new_n26_), .c(new_n74_), .O(z09));
  nand2  g50(.a(new_n27_), .b(x02), .O(new_n76_));
  inv1   g51(.a(new_n61_), .O(new_n77_));
  nand2  g52(.a(x06), .b(new_n28_), .O(new_n78_));
