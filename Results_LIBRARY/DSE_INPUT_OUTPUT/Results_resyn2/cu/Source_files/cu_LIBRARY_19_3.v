...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x06), .O(new_n32_));
  ...
  nand3  g14(.a(new_n39_), .b(x05), .c(new_n27_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n38_), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n37_), .c(new_n32_), .O(z02));
  nand2  g18(.a(new_n41_), .b(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n37_), .c(new_n32_), .O(z03));
  nand2  g20(.a(new_n26_), .b(x01), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n42_), .c(new_n32_), .O(z04));
  oai21  g22(.a(new_n46_), .b(new_n44_), .c(new_n32_), .O(z05));
  ...
  nand3  g39(.a(new_n64_), .b(new_n29_), .c(x02), .O(new_n65_));
  ...
  oai21  g44(.a(new_n40_), .b(x02), .c(new_n32_), .O(z07));
  ...
  nand3  g49(.a(new_n75_), .b(new_n39_), .c(x06), .O(new_n76_));
