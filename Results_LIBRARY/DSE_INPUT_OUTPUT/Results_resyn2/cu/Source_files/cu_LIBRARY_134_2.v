...
module FAU ( 
  ...
  nand3  g16(.a(new_n41_), .b(new_n35_), .c(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n40_), .c(new_n38_), .O(z03));
  nand2  g18(.a(x01), .b(new_n34_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n33_), .c(new_n38_), .O(z04));
  nand3  g20(.a(new_n41_), .b(x01), .c(x00), .O(new_n46_));
