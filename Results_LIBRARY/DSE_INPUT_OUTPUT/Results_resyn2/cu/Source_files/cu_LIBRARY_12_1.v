...
module FAU ( 
  ...
  nand4  g04(.a(new_n29_), .b(new_n28_), .c(x04), .d(x02), .O(new_n30_));
  aoi21  g05(.a(new_n30_), .b(new_n27_), .c(x03), .O(z01));
  inv1   g06(.a(z01), .O(z00));
  nand2  g07(.a(x06), .b(new_n28_), .O(new_n33_));
  ...
  nor3   g15(.a(new_n36_), .b(x01), .c(new_n37_), .O(z03));
  nor2   g16(.a(new_n36_), .b(new_n38_), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n37_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z04));
  nand2  g19(.a(new_n42_), .b(x00), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(new_n33_), .O(z05));
  ...
  nand3  g37(.a(new_n35_), .b(new_n28_), .c(x02), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n34_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n62_), .c(new_n66_), .O(z06));
  nand2  g42(.a(new_n36_), .b(new_n33_), .O(z07));
  nor2   g43(.a(new_n64_), .b(new_n61_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n66_), .c(new_n33_), .O(z08));
  aoi21  g45(.a(new_n35_), .b(x05), .c(new_n29_), .O(z09));
  nand4  g46(.a(x06), .b(x05), .c(new_n34_), .d(new_n58_), .O(new_n72_));
