...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n44_, new_n45_, new_n46_, new_n48_, new_n51_, new_n52_, new_n53_,
  ...
  nor2   g35(.a(new_n30_), .b(x03), .O(new_n61_));
  ...
  nand2  g42(.a(new_n67_), .b(new_n29_), .O(new_n68_));
  nand4  g43(.a(new_n45_), .b(new_n27_), .c(x04), .d(new_n44_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(z06));
  nand2  g45(.a(x13), .b(new_n63_), .O(new_n71_));
  nand2  g46(.a(new_n27_), .b(x02), .O(new_n72_));
  nand2  g47(.a(x05), .b(new_n29_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(x13), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n61_), .O(new_n75_));
  aoi21  g50(.a(new_n72_), .b(new_n71_), .c(new_n75_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(new_n26_), .O(z09));
  nand2  g53(.a(x06), .b(new_n44_), .O(new_n79_));
