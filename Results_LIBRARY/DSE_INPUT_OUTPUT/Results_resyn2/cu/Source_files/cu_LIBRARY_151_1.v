...
module FAU ( 
  ...
  aoi22  g07(.a(new_n32_), .b(new_n26_), .c(x06), .d(new_n27_), .O(z00));
  inv1   g08(.a(x06), .O(new_n34_));
  nand4  g09(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n30_), .O(new_n35_));
  ...
  nand4  g15(.a(new_n40_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z02));
  nor2   g17(.a(x02), .b(new_n37_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n40_), .c(x05), .d(new_n38_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n34_), .c(x04), .O(z03));
  nand4  g20(.a(new_n40_), .b(new_n39_), .c(x01), .d(new_n37_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z04));
  nand4  g22(.a(new_n43_), .b(new_n40_), .c(x05), .d(x01), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n34_), .c(x04), .O(z05));
  ...
  nand3  g40(.a(new_n65_), .b(new_n28_), .c(x02), .O(new_n66_));
  nand2  g41(.a(x04), .b(new_n26_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n64_), .c(new_n67_), .O(z06));
  nor3   g43(.a(new_n35_), .b(x13), .c(x03), .O(z07));
  aoi21  g44(.a(new_n66_), .b(new_n62_), .c(new_n67_), .O(z08));
  nand3  g45(.a(x13), .b(x06), .c(x04), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z09));
  oai21  g47(.a(new_n28_), .b(new_n30_), .c(new_n26_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(x04), .c(new_n34_), .O(z10));
endmodule
