...
module FAU ( 
  ...
  nand4  g09(.a(x12), .b(x05), .c(new_n31_), .d(new_n30_), .O(new_n35_));
  ...
  nand2  g26(.a(new_n27_), .b(x05), .O(new_n52_));
  oai21  g27(.a(new_n49_), .b(new_n29_), .c(new_n52_), .O(z06));
  nor2   g28(.a(new_n49_), .b(new_n35_), .O(z07));
  nor2   g29(.a(new_n49_), .b(new_n29_), .O(z08));
  nand2  g30(.a(x13), .b(x06), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(new_n52_), .O(z09));
  nand2  g32(.a(x12), .b(new_n30_), .O(new_n58_));
  nand2  g33(.a(x06), .b(new_n26_), .O(new_n59_));
