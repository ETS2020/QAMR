...
module FAU ( 
  ...
  nand3  g39(.a(new_n37_), .b(new_n30_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g41(.a(new_n36_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n48_), .O(z06));
  nand2  g44(.a(new_n39_), .b(new_n48_), .O(z07));
  nand2  g45(.a(new_n28_), .b(x04), .O(new_n71_));
  aoi21  g46(.a(new_n65_), .b(new_n62_), .c(new_n71_), .O(z08));
  aoi21  g47(.a(new_n37_), .b(x11), .c(new_n26_), .O(z09));
  inv1   g48(.a(x03), .O(new_n74_));
  nand4  g49(.a(new_n29_), .b(x11), .c(x06), .d(new_n74_), .O(new_n75_));
