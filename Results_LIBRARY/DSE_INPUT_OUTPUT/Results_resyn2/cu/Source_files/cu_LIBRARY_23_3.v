...
module FAU ( 
  ...
  nand2  g07(.a(x04), .b(new_n26_), .O(new_n33_));
  nor2   g08(.a(x04), .b(x03), .O(new_n34_));
  inv1   g09(.a(new_n34_), .O(new_n35_));
  aoi22  g10(.a(new_n35_), .b(new_n32_), .c(new_n33_), .d(new_n27_), .O(z01));
  inv1   g11(.a(x04), .O(new_n37_));
  inv1   g12(.a(x13), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(x05), .c(new_n37_), .O(new_n39_));
  inv1   g14(.a(x00), .O(new_n40_));
  nand3  g15(.a(new_n26_), .b(new_n32_), .c(new_n40_), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(new_n39_), .c(x01), .O(z02));
  inv1   g17(.a(x01), .O(new_n43_));
  nand4  g18(.a(new_n34_), .b(new_n38_), .c(new_n43_), .d(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n32_), .c(new_n27_), .O(z03));
  inv1   g20(.a(new_n39_), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(x01), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n41_), .O(z04));
  nand3  g23(.a(new_n26_), .b(new_n32_), .c(x00), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n47_), .O(z05));
  inv1   g25(.a(x08), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n43_), .c(x00), .O(new_n52_));
  oai21  g27(.a(x10), .b(new_n43_), .c(new_n52_), .O(new_n53_));
  inv1   g28(.a(x11), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(x01), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n43_), .c(new_n40_), .O(new_n57_));
  ...
  nor2   g36(.a(x13), .b(new_n32_), .O(new_n62_));
  aoi21  g37(.a(new_n61_), .b(new_n53_), .c(new_n62_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n33_), .c(new_n30_), .O(z06));
  nand2  g39(.a(new_n34_), .b(new_n38_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n32_), .c(new_n27_), .O(z07));
  nand3  g41(.a(x13), .b(new_n59_), .c(x05), .O(new_n67_));
  oai21  g42(.a(new_n33_), .b(x13), .c(new_n27_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x02), .O(new_n69_));
  oai21  g44(.a(new_n67_), .b(new_n33_), .c(new_n69_), .O(z08));
  nand3  g45(.a(new_n30_), .b(x13), .c(x06), .O(new_n71_));
