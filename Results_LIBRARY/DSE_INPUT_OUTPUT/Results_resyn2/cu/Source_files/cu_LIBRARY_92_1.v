...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n45_, new_n46_, new_n47_, new_n51_, new_n52_, new_n53_,
  ...
  inv1   g14(.a(new_n31_), .O(new_n40_));
  nand3  g15(.a(new_n40_), .b(new_n39_), .c(new_n26_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z07));
  nand2  g17(.a(z07), .b(new_n38_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x01), .O(z02));
  inv1   g19(.a(new_n28_), .O(new_n45_));
  inv1   g20(.a(x01), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n41_), .c(new_n45_), .O(z03));
  oai21  g23(.a(new_n43_), .b(new_n46_), .c(new_n45_), .O(z04));
  nor3   g24(.a(new_n41_), .b(new_n46_), .c(new_n38_), .O(z05));
  nand3  g25(.a(new_n39_), .b(new_n32_), .c(x02), .O(new_n51_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n58_), .c(new_n38_), .O(new_n61_));
  inv1   g36(.a(x12), .O(new_n62_));
  nand4  g37(.a(x13), .b(new_n62_), .c(x05), .d(new_n29_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n56_), .d(new_n27_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n51_), .O(new_n66_));
  nor2   g41(.a(new_n30_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n45_), .O(z06));
  inv1   g44(.a(new_n67_), .O(new_n70_));
  inv1   g45(.a(new_n51_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n27_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n63_), .c(new_n70_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n45_), .O(z09));
  nand2  g50(.a(new_n27_), .b(new_n32_), .O(new_n76_));
  nand2  g51(.a(x05), .b(new_n29_), .O(new_n77_));
  nand2  g52(.a(x06), .b(new_n26_), .O(new_n78_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n78_), .O(z10));
endmodule
