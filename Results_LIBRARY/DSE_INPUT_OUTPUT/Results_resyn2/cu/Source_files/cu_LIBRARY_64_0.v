...
module FAU ( 
  ...
  nor2   g19(.a(new_n39_), .b(new_n41_), .O(z05));
  ...
  nand2  g28(.a(new_n42_), .b(new_n41_), .O(new_n54_));
  ...
  nand4  g34(.a(new_n35_), .b(x09), .c(new_n29_), .d(x02), .O(new_n60_));
  ...
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n34_), .O(new_n68_));
