...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n29_, new_n30_, new_n37_, new_n38_, new_n40_;
  ...
  inv1   g06(.a(new_n30_), .O(z03));
  oai21  g07(.a(z00), .b(x13), .c(new_n30_), .O(z06));
  inv1   g08(.a(x06), .O(new_n37_));
  oai21  g09(.a(new_n27_), .b(x02), .c(x13), .O(new_n38_));
  nor2   g10(.a(new_n38_), .b(new_n37_), .O(z09));
  nand3  g11(.a(x06), .b(new_n27_), .c(new_n26_), .O(new_n40_));
  inv1   g12(.a(new_n40_), .O(z10));
  zero   g13(.O(z02));
  zero   g14(.O(z04));
  zero   g15(.O(z05));
  inv1   g16(.a(new_n30_), .O(z07));
