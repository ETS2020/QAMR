...
module FAU ( 
  ...
  oai21  g08(.a(x05), .b(x02), .c(new_n32_), .O(new_n34_));
  ...
  nor3   g22(.a(new_n39_), .b(new_n41_), .c(new_n45_), .O(z05));
  ...
  nand2  g47(.a(x06), .b(new_n36_), .O(new_n73_));
