...
module FAU ( 
  ...
  aoi21  g03(.a(new_n27_), .b(x02), .c(new_n28_), .O(new_n29_));
  inv1   g04(.a(x03), .O(new_n30_));
  oai21  g05(.a(x05), .b(x04), .c(new_n30_), .O(new_n31_));
  nor2   g06(.a(new_n31_), .b(new_n29_), .O(new_n32_));
  nor2   g07(.a(new_n32_), .b(new_n26_), .O(z00));
  nand2  g08(.a(new_n28_), .b(x05), .O(new_n34_));
  inv1   g09(.a(new_n34_), .O(new_n35_));
  oai21  g10(.a(new_n35_), .b(x06), .c(new_n32_), .O(new_n36_));
  inv1   g11(.a(new_n36_), .O(z01));
  inv1   g12(.a(new_n26_), .O(new_n38_));
  inv1   g13(.a(x00), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  nor3   g15(.a(new_n34_), .b(x13), .c(x03), .O(z07));
  nand3  g16(.a(z07), .b(new_n40_), .c(new_n39_), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n38_), .O(z02));
  nand2  g18(.a(z07), .b(x00), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x01), .O(z03));
  nand3  g20(.a(z07), .b(x01), .c(new_n39_), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(new_n38_), .O(z04));
  nor2   g22(.a(new_n44_), .b(new_n40_), .O(z05));
  ...
  nand4  g38(.a(new_n63_), .b(new_n59_), .c(new_n54_), .d(new_n49_), .O(new_n64_));
  inv1   g39(.a(x13), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n27_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  inv1   g42(.a(x04), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x03), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n38_), .O(z06));
  nand2  g46(.a(new_n66_), .b(new_n62_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n38_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n38_), .O(z09));
