...
module FAU ( 
  ...
  nand2  g02(.a(new_n27_), .b(x00), .O(new_n28_));
  ...
  nand2  g11(.a(new_n33_), .b(x00), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n36_), .O(z01));
  nor2   g13(.a(x13), .b(x03), .O(new_n39_));
  inv1   g14(.a(new_n39_), .O(new_n40_));
  inv1   g15(.a(x00), .O(new_n41_));
  nand3  g16(.a(new_n26_), .b(x05), .c(new_n41_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(new_n40_), .c(x01), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n39_), .b(new_n26_), .c(new_n44_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x05), .c(new_n41_), .O(z03));
  nand2  g21(.a(new_n39_), .b(x01), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n42_), .c(new_n37_), .O(z04));
  nor3   g23(.a(new_n47_), .b(new_n27_), .c(new_n41_), .O(z05));
  ...
  aoi21  g45(.a(new_n68_), .b(new_n64_), .c(new_n70_), .O(z06));
  nor2   g46(.a(new_n40_), .b(new_n27_), .O(z07));
  nor2   g47(.a(new_n67_), .b(new_n63_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n70_), .c(new_n37_), .O(z08));
  nand2  g49(.a(new_n37_), .b(x06), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(new_n65_), .O(z09));
  oai21  g51(.a(new_n33_), .b(new_n29_), .c(new_n69_), .O(new_n77_));
