...
module FAU ( 
  ...
  nand2  g02(.a(new_n27_), .b(x06), .O(new_n28_));
  ...
  aoi21  g16(.a(new_n41_), .b(new_n34_), .c(x13), .O(z02));
  inv1   g17(.a(new_n39_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n35_), .c(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n34_), .c(x13), .O(z03));
  nand2  g20(.a(new_n40_), .b(x01), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n34_), .c(x13), .O(z04));
  nand3  g22(.a(new_n43_), .b(x01), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n34_), .c(x13), .O(z05));
  ...
  nand4  g40(.a(new_n65_), .b(new_n61_), .c(new_n56_), .d(new_n50_), .O(new_n66_));
  nand3  g41(.a(new_n27_), .b(new_n29_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nor2   g43(.a(new_n37_), .b(x03), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n28_), .O(z06));
  aoi21  g46(.a(new_n39_), .b(new_n34_), .c(x13), .O(z07));
  ...
  nor2   g50(.a(new_n27_), .b(new_n34_), .O(z09));
  nand2  g51(.a(z09), .b(new_n26_), .O(new_n77_));
