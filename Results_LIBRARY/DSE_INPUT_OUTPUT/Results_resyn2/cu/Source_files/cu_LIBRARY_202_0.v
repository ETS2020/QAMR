...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n38_, new_n40_, new_n42_, new_n45_,
  ...
  aoi21  g08(.a(new_n29_), .b(new_n27_), .c(new_n33_), .O(z01));
  inv1   g09(.a(z01), .O(z00));
  inv1   g10(.a(x00), .O(new_n36_));
  nor2   g11(.a(x13), .b(x03), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n26_), .c(x05), .d(new_n36_), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(x01), .O(z02));
  nand4  g14(.a(new_n37_), .b(new_n26_), .c(x05), .d(x00), .O(new_n40_));
  ...
  nand4  g31(.a(x13), .b(new_n56_), .c(x04), .d(new_n30_), .O(new_n57_));
  inv1   g32(.a(new_n57_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n55_), .c(new_n50_), .d(new_n45_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(x05), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n31_), .O(new_n61_));
  nand3  g36(.a(new_n37_), .b(new_n28_), .c(x04), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n61_), .O(z06));
  nor4   g38(.a(new_n27_), .b(x13), .c(new_n28_), .d(x03), .O(z07));
  oai21  g39(.a(new_n58_), .b(new_n28_), .c(new_n31_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n62_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n32_), .O(z09));
  nand2  g43(.a(x06), .b(new_n30_), .O(new_n69_));
  nor2   g44(.a(new_n28_), .b(new_n31_), .O(new_n70_));
  aoi21  g45(.a(new_n69_), .b(new_n32_), .c(new_n70_), .O(z10));
endmodule
