...
module FAU ( 
  ...
  oai21  g14(.a(new_n39_), .b(new_n35_), .c(new_n32_), .O(z02));
  nand4  g15(.a(new_n27_), .b(new_n38_), .c(new_n37_), .d(x00), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n35_), .c(new_n32_), .O(z03));
  nand2  g17(.a(new_n34_), .b(x01), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n39_), .O(z04));
  ...
  oai21  g35(.a(new_n60_), .b(new_n49_), .c(new_n32_), .O(z06));
  nor2   g36(.a(new_n30_), .b(x13), .O(z07));
  nand3  g37(.a(new_n48_), .b(new_n47_), .c(new_n28_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n32_), .O(z08));
