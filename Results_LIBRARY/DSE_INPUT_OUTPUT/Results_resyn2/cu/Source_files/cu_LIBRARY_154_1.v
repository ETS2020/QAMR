...
module FAU ( 
  ...
  nand2  g43(.a(new_n39_), .b(new_n26_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n30_), .c(new_n36_), .O(z07));
  inv1   g45(.a(new_n66_), .O(new_n71_));
  inv1   g46(.a(x06), .O(new_n72_));
  inv1   g47(.a(new_n64_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n61_), .c(new_n71_), .O(z08));
  aoi21  g50(.a(new_n39_), .b(x05), .c(new_n72_), .O(z09));
  nand3  g51(.a(new_n29_), .b(x06), .c(new_n26_), .O(new_n77_));
