...
module FAU ( 
  ...
  aoi21  g13(.a(new_n38_), .b(x05), .c(x03), .O(z02));
  nand3  g14(.a(new_n37_), .b(new_n36_), .c(x00), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(x05), .c(x03), .O(z03));
  nand3  g16(.a(new_n37_), .b(x01), .c(new_n35_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x03), .O(z04));
  inv1   g18(.a(x13), .O(new_n44_));
  nand3  g19(.a(new_n32_), .b(new_n44_), .c(new_n29_), .O(new_n45_));
  nand2  g20(.a(x01), .b(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n45_), .O(z05));
  ...
  nand3  g26(.a(new_n51_), .b(new_n32_), .c(new_n48_), .O(new_n52_));
  ...
  inv1   g39(.a(new_n45_), .O(z07));
  nor2   g40(.a(new_n50_), .b(new_n31_), .O(z08));
