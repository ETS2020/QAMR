...
module FAU ( 
  ...
  nand2  g12(.a(x12), .b(new_n30_), .O(new_n38_));
  ...
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(new_n42_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n41_), .c(new_n38_), .O(z02));
  nand2  g22(.a(new_n45_), .b(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n41_), .c(new_n38_), .O(z03));
  nand2  g24(.a(new_n27_), .b(x01), .O(new_n50_));
  ...
  nand4  g38(.a(x13), .b(new_n63_), .c(x05), .d(new_n27_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n62_), .c(new_n57_), .O(new_n66_));
  nand3  g41(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n67_));
  nand3  g42(.a(new_n31_), .b(x04), .c(new_n26_), .O(new_n68_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(z06));
  nor2   g44(.a(new_n44_), .b(x02), .O(z07));
  nand3  g45(.a(x13), .b(x05), .c(new_n27_), .O(new_n71_));
  aoi21  g46(.a(new_n67_), .b(new_n71_), .c(new_n68_), .O(z08));
  nand2  g47(.a(new_n38_), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n43_), .O(z09));
  oai21  g49(.a(new_n30_), .b(new_n27_), .c(new_n26_), .O(new_n75_));
