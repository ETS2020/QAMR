...
module FAU ( 
  ...
  oai21  g25(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(z05));
  nand3  g26(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  inv1   g28(.a(x08), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n46_), .c(x00), .O(new_n55_));
  oai21  g30(.a(x10), .b(new_n46_), .c(new_n55_), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(x01), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n46_), .c(new_n40_), .O(new_n60_));
  inv1   g35(.a(x07), .O(new_n61_));
  inv1   g36(.a(x12), .O(new_n62_));
  nand4  g37(.a(x13), .b(new_n62_), .c(new_n61_), .d(new_n27_), .O(new_n63_));
  aoi21  g38(.a(new_n60_), .b(new_n58_), .c(new_n63_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n56_), .c(new_n53_), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n32_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n44_), .O(z06));
  nand2  g42(.a(new_n45_), .b(new_n44_), .O(z07));
  nand2  g43(.a(new_n53_), .b(x12), .O(new_n69_));
  nand4  g44(.a(x13), .b(new_n62_), .c(x05), .d(new_n27_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n69_), .c(new_n66_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n44_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x06), .c(new_n32_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n44_), .O(z10));
endmodule
