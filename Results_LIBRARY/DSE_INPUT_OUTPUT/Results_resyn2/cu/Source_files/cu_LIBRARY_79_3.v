...
module FAU ( 
  ...
  nor2   g03(.a(x11), .b(x05), .O(new_n29_));
  ...
  nand3  g33(.a(new_n29_), .b(new_n35_), .c(x02), .O(new_n59_));
  ...
  oai21  g39(.a(new_n50_), .b(new_n26_), .c(new_n64_), .O(z09));
  nor2   g40(.a(new_n29_), .b(new_n26_), .O(new_n66_));
  nand2  g41(.a(x06), .b(new_n34_), .O(new_n67_));
