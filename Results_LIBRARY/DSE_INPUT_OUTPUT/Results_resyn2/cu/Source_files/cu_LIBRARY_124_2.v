...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n45_, new_n46_,
  ...
  nand2  g08(.a(new_n33_), .b(x04), .O(new_n34_));
  ...
  nand2  g14(.a(z07), .b(x00), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(x01), .O(z03));
  inv1   g16(.a(z07), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(new_n36_), .c(x00), .O(z04));
  oai21  g18(.a(new_n40_), .b(new_n36_), .c(new_n34_), .O(z05));
  inv1   g19(.a(x03), .O(new_n45_));
  inv1   g20(.a(x10), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(x01), .c(new_n35_), .O(new_n47_));
  nand2  g22(.a(x11), .b(x01), .O(new_n48_));
  nand2  g23(.a(x09), .b(new_n36_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n50_));
  ...
  aoi21  g30(.a(new_n50_), .b(new_n47_), .c(new_n55_), .O(new_n56_));
  ...
  nand4  g41(.a(new_n66_), .b(new_n34_), .c(x06), .d(new_n45_), .O(new_n67_));
