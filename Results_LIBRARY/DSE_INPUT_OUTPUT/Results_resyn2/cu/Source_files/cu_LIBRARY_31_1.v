...
module FAU ( 
  ...
  aoi21  g05(.a(new_n26_), .b(new_n28_), .c(x03), .O(new_n31_));
  aoi22  g06(.a(new_n31_), .b(new_n30_), .c(x06), .d(new_n26_), .O(z00));
  nand2  g07(.a(x06), .b(new_n26_), .O(new_n33_));
  ...
  nand2  g17(.a(new_n27_), .b(new_n40_), .O(new_n43_));
  inv1   g18(.a(new_n38_), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n33_), .O(z03));
  nand3  g21(.a(new_n37_), .b(x01), .c(new_n39_), .O(new_n47_));
  nor4   g22(.a(new_n47_), .b(new_n29_), .c(new_n26_), .d(x03), .O(z04));
  nand2  g23(.a(new_n27_), .b(x01), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n45_), .c(new_n33_), .O(z05));
  ...
  nand4  g41(.a(new_n37_), .b(new_n66_), .c(new_n26_), .d(x02), .O(new_n67_));
  nand2  g42(.a(x04), .b(new_n36_), .O(new_n68_));
  aoi21  g43(.a(new_n67_), .b(new_n65_), .c(new_n68_), .O(z06));
  oai21  g44(.a(new_n38_), .b(x02), .c(new_n33_), .O(z07));
  aoi21  g45(.a(new_n67_), .b(new_n63_), .c(new_n68_), .O(z08));
  nand3  g46(.a(x13), .b(x06), .c(x05), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z09));
  nand4  g48(.a(x06), .b(x05), .c(new_n36_), .d(new_n27_), .O(new_n74_));
