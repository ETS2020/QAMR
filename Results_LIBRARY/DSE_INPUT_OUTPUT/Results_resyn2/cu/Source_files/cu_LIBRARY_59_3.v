...
module FAU ( 
  ...
  nand3  g07(.a(x04), .b(new_n26_), .c(x02), .O(new_n33_));
  nor2   g08(.a(x04), .b(x02), .O(new_n34_));
  nand2  g09(.a(x05), .b(new_n26_), .O(new_n35_));
  nor2   g10(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  aoi21  g11(.a(new_n33_), .b(new_n30_), .c(new_n36_), .O(z01));
  ...
  aoi21  g18(.a(new_n43_), .b(new_n26_), .c(new_n30_), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand3  g20(.a(new_n42_), .b(x01), .c(new_n45_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n26_), .c(new_n30_), .O(z04));
  nand3  g22(.a(new_n42_), .b(x01), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n26_), .c(new_n30_), .O(z05));
