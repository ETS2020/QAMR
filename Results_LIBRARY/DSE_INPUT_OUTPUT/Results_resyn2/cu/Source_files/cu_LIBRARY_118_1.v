...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    new_n39_, new_n41_;
  ...
  nand2  g10(.a(new_n35_), .b(new_n32_), .O(z06));
  inv1   g11(.a(new_n35_), .O(z08));
  nand2  g12(.a(x13), .b(x06), .O(new_n39_));
  nor2   g13(.a(new_n39_), .b(z02), .O(z09));
  nand2  g14(.a(new_n34_), .b(x06), .O(new_n41_));
  inv1   g15(.a(new_n41_), .O(z10));
  zero   g16(.O(z07));
  nor2   g17(.a(new_n27_), .b(x02), .O(z03));
  nor2   g18(.a(new_n27_), .b(x02), .O(z04));
