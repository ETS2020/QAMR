...
module FAU ( 
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(x04), .d(new_n31_), .O(new_n59_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n29_), .c(x04), .d(new_n31_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n63_), .O(z06));
  nor4   g41(.a(new_n28_), .b(x13), .c(new_n29_), .d(x03), .O(z07));
  oai21  g42(.a(new_n60_), .b(new_n29_), .c(new_n26_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n65_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  aoi21  g45(.a(new_n29_), .b(new_n26_), .c(new_n70_), .O(z09));
  nand2  g46(.a(x06), .b(new_n31_), .O(new_n72_));
  nor2   g47(.a(new_n29_), .b(new_n26_), .O(new_n73_));
  aoi21  g48(.a(new_n72_), .b(new_n32_), .c(new_n73_), .O(z10));
endmodule
