...
module FAU ( 
  ...
  nor3   g15(.a(x13), .b(x03), .c(x02), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(new_n33_), .c(new_n40_), .d(new_n39_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z02));
  nand4  g18(.a(new_n41_), .b(new_n33_), .c(new_n40_), .d(x00), .O(new_n44_));
  ...
  and2   g41(.a(new_n41_), .b(new_n33_), .O(z07));
  aoi21  g42(.a(new_n65_), .b(new_n62_), .c(new_n37_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  oai21  g44(.a(x05), .b(x02), .c(new_n69_), .O(z09));
  nand2  g45(.a(new_n30_), .b(x06), .O(new_n71_));
