...
module FAU ( 
  ...
  nand3  g06(.a(new_n26_), .b(new_n31_), .c(x02), .O(new_n32_));
  nand2  g07(.a(new_n32_), .b(x04), .O(new_n33_));
  ...
  nand2  g16(.a(new_n29_), .b(new_n39_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(new_n37_), .c(new_n38_), .O(z03));
  nor3   g18(.a(new_n40_), .b(new_n28_), .c(new_n36_), .O(z04));
  nand4  g19(.a(new_n27_), .b(new_n39_), .c(x01), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n31_), .c(x04), .O(z05));
  ...
  nand2  g42(.a(new_n47_), .b(x03), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(z06));
  nand2  g44(.a(new_n27_), .b(new_n39_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n31_), .c(x04), .O(z07));
  inv1   g46(.a(new_n48_), .O(new_n72_));
  aoi21  g47(.a(new_n65_), .b(new_n62_), .c(new_n72_), .O(z08));
