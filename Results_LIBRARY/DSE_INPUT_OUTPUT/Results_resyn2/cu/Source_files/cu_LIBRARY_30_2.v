...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n30_, new_n31_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n39_, new_n41_, new_n42_, new_n43_, new_n44_, new_n45_,
  ...
  oai21  g11(.a(new_n36_), .b(new_n31_), .c(new_n34_), .O(z03));
  nor3   g12(.a(new_n31_), .b(new_n35_), .c(x00), .O(z04));
  inv1   g13(.a(x00), .O(new_n39_));
  nor3   g14(.a(new_n31_), .b(new_n35_), .c(new_n39_), .O(z05));
  inv1   g15(.a(x07), .O(new_n41_));
  nor2   g16(.a(new_n33_), .b(new_n26_), .O(new_n42_));
  ...
  nand2  g31(.a(new_n34_), .b(new_n31_), .O(z07));
  ...
  aoi21  g36(.a(new_n33_), .b(x02), .c(new_n61_), .O(z09));
  nand2  g37(.a(new_n27_), .b(x06), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n34_), .O(z10));
endmodule
