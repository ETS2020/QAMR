...
module FAU ( 
  ...
  nand4  g11(.a(new_n36_), .b(new_n26_), .c(new_n35_), .d(new_n34_), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(new_n28_), .c(new_n30_), .O(z02));
  inv1   g13(.a(new_n29_), .O(new_n39_));
  nor2   g14(.a(x13), .b(x03), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x01), .c(new_n34_), .O(z03));
  nor3   g17(.a(new_n41_), .b(new_n35_), .c(x00), .O(z04));
  nand4  g18(.a(new_n36_), .b(new_n26_), .c(x01), .d(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n28_), .c(new_n30_), .O(z05));
  ...
  nand3  g36(.a(new_n61_), .b(new_n30_), .c(x02), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nor2   g38(.a(new_n27_), .b(x03), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g40(.a(x06), .b(x05), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  inv1   g42(.a(new_n41_), .O(z07));
  nand2  g43(.a(new_n62_), .b(new_n58_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n64_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n66_), .O(z08));
  aoi21  g46(.a(new_n61_), .b(new_n30_), .c(new_n28_), .O(z09));
  aoi21  g47(.a(new_n30_), .b(x03), .c(new_n28_), .O(z10));
endmodule
