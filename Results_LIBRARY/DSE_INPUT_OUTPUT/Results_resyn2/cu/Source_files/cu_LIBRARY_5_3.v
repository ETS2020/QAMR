...
module FAU ( 
  ...
  nand2  g15(.a(new_n36_), .b(new_n35_), .O(new_n41_));
  nand2  g16(.a(x01), .b(new_n39_), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n41_), .c(new_n26_), .O(z04));
  nor2   g18(.a(new_n34_), .b(new_n39_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n36_), .c(new_n35_), .d(new_n26_), .O(new_n45_));
  ...
  aoi21  g42(.a(new_n64_), .b(new_n48_), .c(new_n67_), .O(z06));
  nand2  g43(.a(new_n41_), .b(new_n26_), .O(z07));
  nand2  g44(.a(new_n62_), .b(new_n48_), .O(new_n70_));
  ...
  nand3  g49(.a(new_n30_), .b(new_n26_), .c(x06), .O(new_n75_));
