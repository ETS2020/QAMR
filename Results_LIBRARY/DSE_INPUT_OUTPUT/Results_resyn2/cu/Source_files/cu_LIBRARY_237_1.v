...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n45_, new_n46_, new_n49_, new_n51_, new_n52_,
  ...
  nand4  g14(.a(new_n29_), .b(new_n39_), .c(x05), .d(new_n38_), .O(new_n40_));
  inv1   g15(.a(x00), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n40_), .c(new_n37_), .O(z02));
  nor2   g19(.a(new_n40_), .b(new_n41_), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(new_n42_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  nor3   g22(.a(new_n40_), .b(new_n42_), .c(x00), .O(z04));
  nand2  g23(.a(new_n45_), .b(x01), .O(new_n49_));
  ...
  nand4  g37(.a(x13), .b(new_n62_), .c(x05), .d(new_n28_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n56_), .d(new_n51_), .O(new_n65_));
  nand3  g40(.a(new_n39_), .b(new_n33_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nor2   g42(.a(new_n32_), .b(x03), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n37_), .O(z06));
  nand2  g45(.a(new_n40_), .b(new_n37_), .O(z07));
  nand2  g46(.a(new_n66_), .b(new_n63_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n37_), .O(z08));
  aoi21  g49(.a(new_n39_), .b(x05), .c(new_n26_), .O(z09));
  nand4  g50(.a(x06), .b(x05), .c(new_n38_), .d(new_n28_), .O(new_n76_));
