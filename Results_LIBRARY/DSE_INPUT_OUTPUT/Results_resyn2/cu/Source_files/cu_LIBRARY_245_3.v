...
module FAU ( 
  ...
  nor2   g17(.a(new_n28_), .b(new_n39_), .O(new_n43_));
  ...
  nand2  g32(.a(new_n27_), .b(new_n40_), .O(new_n58_));
  ...
  nand2  g46(.a(new_n38_), .b(new_n35_), .O(z07));
  nand2  g47(.a(new_n69_), .b(new_n35_), .O(new_n73_));
  aoi21  g48(.a(new_n66_), .b(new_n62_), .c(new_n73_), .O(z08));
  nand3  g49(.a(x13), .b(new_n27_), .c(x06), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  inv1   g51(.a(new_n29_), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(new_n27_), .c(new_n26_), .O(z10));
endmodule
