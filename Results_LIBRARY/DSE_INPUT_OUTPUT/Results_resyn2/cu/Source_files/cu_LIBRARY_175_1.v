...
module FAU ( 
  ...
  nor2   g07(.a(x05), .b(x03), .O(new_n37_));
  nand4  g08(.a(new_n37_), .b(new_n36_), .c(x04), .d(x02), .O(new_n38_));
  inv1   g09(.a(new_n38_), .O(z06));
  inv1   g10(.a(new_n30_), .O(z07));
  nand2  g11(.a(new_n38_), .b(new_n30_), .O(z08));
