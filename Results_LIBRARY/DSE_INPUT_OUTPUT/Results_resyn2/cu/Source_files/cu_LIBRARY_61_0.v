...
module FAU ( 
  ...
  nand2  g18(.a(new_n43_), .b(new_n29_), .O(new_n44_));
  oai21  g19(.a(new_n39_), .b(new_n41_), .c(new_n44_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  inv1   g21(.a(x10), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(x01), .O(new_n48_));
  nand2  g23(.a(new_n43_), .b(new_n41_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(new_n50_));
  ...
  nand4  g33(.a(new_n58_), .b(new_n55_), .c(new_n50_), .d(new_n46_), .O(new_n59_));
  nand4  g34(.a(new_n35_), .b(x08), .c(new_n29_), .d(x02), .O(new_n60_));
  nand2  g35(.a(x04), .b(new_n34_), .O(new_n61_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(z06));
  nor3   g37(.a(new_n28_), .b(x13), .c(x03), .O(z07));
  nand3  g38(.a(new_n35_), .b(new_n29_), .c(x02), .O(new_n64_));
  and2   g39(.a(new_n64_), .b(new_n57_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n61_), .c(new_n44_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n44_), .O(z09));
  nand2  g43(.a(x08), .b(new_n29_), .O(new_n69_));
  nand2  g44(.a(x05), .b(new_n26_), .O(new_n70_));
  nand2  g45(.a(x06), .b(new_n34_), .O(new_n71_));
  aoi21  g46(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z10));
endmodule
