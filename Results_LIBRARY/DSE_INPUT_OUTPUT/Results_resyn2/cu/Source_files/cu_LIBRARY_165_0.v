...
module FAU ( 
  ...
  aoi21  g03(.a(new_n27_), .b(x04), .c(new_n28_), .O(new_n29_));
  nor2   g04(.a(new_n29_), .b(x03), .O(new_n30_));
  nor2   g05(.a(new_n30_), .b(new_n26_), .O(z00));
  inv1   g06(.a(new_n26_), .O(new_n32_));
  nand2  g07(.a(new_n30_), .b(new_n32_), .O(new_n33_));
  ...
  aoi21  g13(.a(new_n38_), .b(x05), .c(x02), .O(z02));
  inv1   g14(.a(x03), .O(new_n40_));
  inv1   g15(.a(x13), .O(new_n41_));
  nand4  g16(.a(new_n28_), .b(new_n41_), .c(x05), .d(new_n40_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(x01), .c(new_n35_), .O(z03));
  nand3  g18(.a(new_n37_), .b(x01), .c(new_n35_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(x02), .O(z04));
  nand3  g20(.a(new_n37_), .b(x01), .c(x00), .O(new_n46_));
  ...
  nor2   g34(.a(new_n59_), .b(x03), .O(new_n60_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n60_), .c(new_n58_), .d(new_n53_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x05), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n48_), .O(new_n67_));
  nand4  g42(.a(new_n41_), .b(new_n27_), .c(x04), .d(new_n40_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(z06));
  inv1   g44(.a(new_n42_), .O(z07));
  nand2  g45(.a(x13), .b(new_n62_), .O(new_n71_));
  nand2  g46(.a(new_n27_), .b(x02), .O(new_n72_));
  nand2  g47(.a(x05), .b(new_n48_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(x13), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n60_), .O(new_n75_));
  aoi21  g50(.a(new_n72_), .b(new_n71_), .c(new_n75_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n32_), .O(z09));
  nand2  g53(.a(x06), .b(new_n40_), .O(new_n79_));
  aoi21  g54(.a(new_n73_), .b(new_n72_), .c(new_n79_), .O(z10));
endmodule
