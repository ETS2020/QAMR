...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(new_n38_), .c(new_n42_), .d(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n32_), .c(new_n27_), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand4  g20(.a(new_n34_), .b(new_n38_), .c(x01), .d(new_n45_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n32_), .c(new_n27_), .O(z04));
  ...
  aoi21  g29(.a(new_n54_), .b(new_n42_), .c(new_n45_), .O(new_n55_));
  ...
  nor2   g34(.a(x13), .b(new_n32_), .O(new_n60_));
  aoi21  g35(.a(new_n59_), .b(new_n51_), .c(new_n60_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n33_), .c(new_n30_), .O(z06));
  inv1   g37(.a(new_n40_), .O(z07));
  nand3  g38(.a(x13), .b(new_n57_), .c(x05), .O(new_n64_));
  oai21  g39(.a(new_n33_), .b(x13), .c(new_n27_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x02), .O(new_n66_));
  oai21  g41(.a(new_n64_), .b(new_n33_), .c(new_n66_), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  inv1   g43(.a(new_n30_), .O(new_n69_));
  nor3   g44(.a(new_n69_), .b(new_n38_), .c(new_n68_), .O(z09));
  oai21  g45(.a(new_n68_), .b(x03), .c(new_n30_), .O(z10));
endmodule
