...
module FAU ( 
  ...
  nand3  g10(.a(new_n28_), .b(x11), .c(x05), .O(new_n36_));
  ...
  aoi21  g19(.a(new_n44_), .b(x11), .c(new_n26_), .O(z02));
  nand3  g20(.a(new_n43_), .b(new_n39_), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x11), .c(new_n26_), .O(z03));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(new_n48_));
  nor4   g23(.a(new_n48_), .b(new_n36_), .c(new_n39_), .d(x00), .O(z04));
  nand3  g24(.a(new_n43_), .b(x01), .c(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x11), .c(new_n26_), .O(z05));
  inv1   g26(.a(x07), .O(new_n52_));
  inv1   g27(.a(x09), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n39_), .c(x00), .O(new_n54_));
  nand2  g29(.a(x10), .b(x01), .O(new_n55_));
  nand2  g30(.a(x08), .b(new_n39_), .O(new_n56_));
  ...
  nand3  g35(.a(x13), .b(new_n60_), .c(x11), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n58_), .c(new_n52_), .O(new_n63_));
  nand2  g38(.a(new_n30_), .b(new_n41_), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n40_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  nor2   g41(.a(new_n48_), .b(new_n36_), .O(z07));
  aoi21  g42(.a(new_n30_), .b(new_n41_), .c(new_n62_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n65_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n27_), .O(z09));
  nand2  g46(.a(x05), .b(x02), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x06), .c(new_n40_), .O(new_n73_));
  oai21  g48(.a(x11), .b(new_n26_), .c(new_n73_), .O(z10));
endmodule
