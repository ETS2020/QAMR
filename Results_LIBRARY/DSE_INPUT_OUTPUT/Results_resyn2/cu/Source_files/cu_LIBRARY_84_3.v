...
module FAU ( 
  ...
  nor2   g07(.a(new_n29_), .b(x03), .O(new_n33_));
  inv1   g08(.a(new_n33_), .O(new_n34_));
  aoi21  g09(.a(new_n29_), .b(new_n26_), .c(x02), .O(new_n35_));
  aoi21  g10(.a(new_n34_), .b(new_n30_), .c(new_n35_), .O(z01));
  ...
  aoi21  g15(.a(new_n40_), .b(new_n27_), .c(new_n30_), .O(z02));
  nand3  g16(.a(new_n39_), .b(new_n38_), .c(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n27_), .c(new_n30_), .O(z03));
  nand3  g18(.a(new_n39_), .b(x01), .c(new_n37_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n27_), .c(new_n30_), .O(z04));
  nand3  g20(.a(new_n39_), .b(x01), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n27_), .c(new_n30_), .O(z05));
  inv1   g22(.a(x13), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n30_), .c(x02), .O(new_n49_));
  nor2   g24(.a(new_n30_), .b(x02), .O(new_n50_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n60_), .c(new_n55_), .d(new_n50_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n49_), .c(new_n34_), .O(z06));
  nor2   g41(.a(new_n39_), .b(x02), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(new_n30_), .O(z07));
  aoi21  g43(.a(new_n33_), .b(new_n48_), .c(x05), .O(new_n69_));
  nand4  g44(.a(new_n33_), .b(x13), .c(new_n62_), .d(x05), .O(new_n70_));
  oai21  g45(.a(new_n69_), .b(new_n27_), .c(new_n70_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  aoi21  g47(.a(x05), .b(x02), .c(new_n72_), .O(z09));
  inv1   g48(.a(x06), .O(new_n74_));
  oai22  g49(.a(new_n74_), .b(x03), .c(new_n30_), .d(new_n27_), .O(z10));
endmodule
