...
module FAU ( 
  ...
  nand4  g14(.a(new_n39_), .b(x05), .c(new_n29_), .d(new_n38_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n37_), .O(z02));
  nand4  g16(.a(new_n39_), .b(x05), .c(new_n29_), .d(x00), .O(new_n42_));
  ...
  nand3  g38(.a(new_n39_), .b(new_n29_), .c(new_n30_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(x05), .c(x03), .O(z07));
  nor2   g40(.a(new_n49_), .b(new_n31_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  oai21  g42(.a(x05), .b(x03), .c(new_n67_), .O(z09));
  nand2  g43(.a(new_n32_), .b(x06), .O(new_n69_));
