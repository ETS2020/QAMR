...
module FAU ( 
  ...
  nand3  g03(.a(new_n28_), .b(new_n27_), .c(x02), .O(new_n29_));
  ...
  nand2  g11(.a(x13), .b(new_n27_), .O(new_n37_));
  inv1   g12(.a(x01), .O(new_n38_));
  nand2  g13(.a(new_n32_), .b(new_n38_), .O(new_n39_));
  inv1   g14(.a(x00), .O(new_n40_));
  nand4  g15(.a(new_n28_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n40_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n39_), .c(new_n37_), .O(z02));
  nand2  g19(.a(new_n42_), .b(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n39_), .c(new_n37_), .O(z03));
  nand2  g21(.a(new_n32_), .b(x01), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n43_), .c(new_n37_), .O(z04));
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n37_), .O(z05));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n62_));
  ...
  aoi21  g40(.a(new_n64_), .b(new_n29_), .c(new_n65_), .O(z06));
  nor2   g41(.a(new_n41_), .b(x02), .O(z07));
  aoi21  g42(.a(new_n62_), .b(new_n29_), .c(new_n65_), .O(z08));
  nand3  g43(.a(x13), .b(x06), .c(x05), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z09));
  nand2  g45(.a(new_n28_), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(x06), .b(new_n26_), .O(new_n72_));
  aoi21  g47(.a(new_n33_), .b(new_n71_), .c(new_n72_), .O(z10));
endmodule
