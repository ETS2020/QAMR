...
module FAU ( 
  ...
  nand3  g12(.a(new_n37_), .b(new_n29_), .c(x05), .O(new_n38_));
  ...
  nor3   g21(.a(new_n38_), .b(new_n42_), .c(new_n36_), .O(z05));
  nor2   g22(.a(new_n43_), .b(x03), .O(new_n48_));
  ...
  nor2   g44(.a(new_n50_), .b(x12), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n48_), .c(new_n27_), .O(new_n71_));
  ...
  inv1   g50(.a(new_n62_), .O(new_n76_));
