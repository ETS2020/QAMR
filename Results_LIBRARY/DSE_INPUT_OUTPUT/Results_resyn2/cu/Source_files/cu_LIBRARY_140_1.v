...
module FAU ( 
  ...
  aoi21  g09(.a(new_n32_), .b(new_n31_), .c(new_n34_), .O(new_n35_));
  nor2   g10(.a(new_n35_), .b(new_n28_), .O(z00));
  inv1   g11(.a(x12), .O(new_n37_));
  nand3  g12(.a(x05), .b(new_n30_), .c(new_n29_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(new_n37_), .c(new_n35_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x13), .O(new_n43_));
  nand4  g18(.a(new_n39_), .b(new_n43_), .c(new_n33_), .d(new_n42_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x01), .O(z02));
  nand3  g20(.a(new_n39_), .b(new_n43_), .c(new_n33_), .O(new_n46_));
  inv1   g21(.a(x01), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z03));
  nor2   g24(.a(new_n44_), .b(new_n47_), .O(z04));
  ...
  nand3  g38(.a(x13), .b(x05), .c(new_n29_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nor2   g40(.a(x12), .b(x07), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n65_), .c(new_n63_), .d(new_n58_), .O(new_n67_));
  ...
  nand2  g46(.a(new_n46_), .b(new_n27_), .O(z07));
  nand2  g47(.a(new_n69_), .b(new_n37_), .O(new_n73_));
  aoi21  g48(.a(new_n64_), .b(new_n53_), .c(new_n73_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n27_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n33_), .O(new_n78_));
