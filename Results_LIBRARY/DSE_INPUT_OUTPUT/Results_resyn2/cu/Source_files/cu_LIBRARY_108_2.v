...
module FAU ( 
  ...
  oai21  g19(.a(new_n44_), .b(new_n39_), .c(new_n33_), .O(z03));
  ...
  nand3  g40(.a(new_n38_), .b(new_n32_), .c(x02), .O(new_n66_));
  nand2  g41(.a(x04), .b(new_n26_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(z06));
  nand2  g43(.a(new_n39_), .b(new_n33_), .O(z07));
  aoi21  g44(.a(new_n66_), .b(new_n63_), .c(new_n67_), .O(z08));
  inv1   g45(.a(x06), .O(new_n71_));
  oai21  g46(.a(new_n38_), .b(new_n71_), .c(new_n33_), .O(z09));
  nand2  g47(.a(new_n26_), .b(new_n27_), .O(new_n73_));
  aoi22  g48(.a(new_n73_), .b(x05), .c(new_n71_), .d(new_n26_), .O(z10));
endmodule
