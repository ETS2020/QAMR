...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n69_, new_n72_, new_n73_, new_n76_;
  aoi21  g00(.a(x04), .b(x02), .c(x05), .O(new_n26_));
  ...
  nand3  g07(.a(new_n32_), .b(new_n28_), .c(new_n27_), .O(z00));
  inv1   g08(.a(x03), .O(new_n34_));
  inv1   g09(.a(new_n26_), .O(new_n35_));
  nand4  g10(.a(new_n31_), .b(new_n28_), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  ...
  or2    g15(.a(new_n40_), .b(x00), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x01), .O(z02));
  inv1   g17(.a(x01), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n40_), .c(new_n31_), .O(z03));
  oai21  g20(.a(new_n41_), .b(new_n43_), .c(new_n31_), .O(z04));
  inv1   g21(.a(x00), .O(new_n47_));
  nor3   g22(.a(new_n40_), .b(new_n43_), .c(new_n47_), .O(z05));
  ...
  nand3  g39(.a(new_n38_), .b(new_n29_), .c(x02), .O(new_n65_));
  ...
  nand2  g44(.a(new_n69_), .b(new_n31_), .O(z06));
  nand2  g45(.a(new_n40_), .b(new_n31_), .O(z07));
  nand2  g46(.a(new_n65_), .b(new_n62_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n31_), .O(z08));
  oai21  g49(.a(new_n38_), .b(new_n30_), .c(new_n31_), .O(z09));
  nand2  g50(.a(x06), .b(new_n60_), .O(new_n76_));
  aoi22  g51(.a(new_n76_), .b(x05), .c(new_n31_), .d(x03), .O(z10));
endmodule
