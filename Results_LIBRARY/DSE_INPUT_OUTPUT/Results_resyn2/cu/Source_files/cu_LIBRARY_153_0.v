...
module FAU ( 
  ...
  aoi22  g07(.a(new_n32_), .b(new_n29_), .c(new_n27_), .d(new_n26_), .O(z00));
  ...
  inv1   g11(.a(new_n31_), .O(new_n37_));
  ...
  nand4  g18(.a(new_n38_), .b(new_n37_), .c(new_n41_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nand2  g20(.a(x01), .b(new_n40_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n39_), .c(new_n34_), .O(z04));
  nand4  g22(.a(new_n38_), .b(new_n37_), .c(x01), .d(x00), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n34_), .O(z05));
  ...
  inv1   g45(.a(new_n39_), .O(z07));
  nor2   g46(.a(new_n66_), .b(new_n62_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n69_), .c(new_n34_), .O(z08));
