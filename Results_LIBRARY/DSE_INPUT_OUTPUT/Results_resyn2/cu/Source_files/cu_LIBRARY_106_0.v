...
module FAU ( 
  ...
  nor2   g01(.a(x08), .b(x05), .O(new_n27_));
  ...
  nand4  g09(.a(x08), .b(new_n31_), .c(x04), .d(x02), .O(new_n35_));
  aoi21  g10(.a(new_n35_), .b(new_n30_), .c(x03), .O(z01));
  inv1   g11(.a(x00), .O(new_n37_));
  inv1   g12(.a(x01), .O(new_n38_));
  nor3   g13(.a(new_n30_), .b(x13), .c(x03), .O(z07));
  nand3  g14(.a(z07), .b(new_n38_), .c(new_n37_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z02));
  nand2  g16(.a(z07), .b(x00), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x01), .O(z03));
  nor2   g18(.a(new_n38_), .b(x00), .O(new_n44_));
  and2   g19(.a(new_n44_), .b(z07), .O(z04));
  nor2   g20(.a(new_n42_), .b(new_n38_), .O(z05));
  ...
  nand3  g25(.a(new_n50_), .b(x01), .c(new_n37_), .O(new_n51_));
  nand2  g26(.a(x11), .b(x01), .O(new_n52_));
  nand2  g27(.a(x09), .b(new_n38_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n52_), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n51_), .c(new_n31_), .O(new_n55_));
  ...
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n60_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n49_), .O(new_n62_));
  nor2   g37(.a(new_n29_), .b(x03), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n47_), .O(z06));
  inv1   g40(.a(new_n63_), .O(new_n66_));
  nand4  g41(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n67_));
  inv1   g42(.a(new_n49_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x08), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(z08));
  nand2  g45(.a(new_n47_), .b(x06), .O(new_n71_));
