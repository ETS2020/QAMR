...
module FAU ( 
  ...
  nand3  g07(.a(new_n31_), .b(new_n30_), .c(new_n26_), .O(new_n33_));
  ...
  nand3  g18(.a(new_n43_), .b(new_n37_), .c(new_n36_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n35_), .c(new_n28_), .O(z02));
  nand4  g20(.a(new_n43_), .b(new_n35_), .c(x05), .d(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x01), .O(z03));
  nand2  g22(.a(x01), .b(new_n36_), .O(new_n48_));
  nor4   g23(.a(new_n48_), .b(new_n42_), .c(x07), .d(new_n28_), .O(z04));
  nor2   g24(.a(new_n46_), .b(new_n37_), .O(z05));
  nand3  g25(.a(new_n41_), .b(new_n28_), .c(x02), .O(new_n51_));
  inv1   g26(.a(x12), .O(new_n52_));
  nand4  g27(.a(x13), .b(new_n52_), .c(x05), .d(new_n38_), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nor2   g29(.a(new_n40_), .b(x03), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n54_), .c(new_n27_), .O(new_n56_));
  nand2  g31(.a(x11), .b(x01), .O(new_n57_));
  nand2  g32(.a(x09), .b(new_n37_), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nand2  g34(.a(x10), .b(x01), .O(new_n60_));
  aoi21  g35(.a(x08), .b(new_n37_), .c(x00), .O(new_n61_));
  nand2  g36(.a(new_n51_), .b(new_n26_), .O(new_n62_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n59_), .c(new_n56_), .O(z06));
  aoi21  g39(.a(new_n42_), .b(new_n35_), .c(new_n28_), .O(z07));
  inv1   g40(.a(new_n56_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(new_n27_), .O(z09));
  nand2  g43(.a(new_n35_), .b(new_n38_), .O(new_n69_));
  nand2  g44(.a(x06), .b(new_n39_), .O(new_n70_));
