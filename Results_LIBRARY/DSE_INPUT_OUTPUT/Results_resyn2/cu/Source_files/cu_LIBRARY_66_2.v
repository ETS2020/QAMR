...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n44_, new_n45_, new_n46_, new_n49_, new_n51_, new_n52_, new_n53_,
  ...
  inv1   g10(.a(x06), .O(new_n36_));
  inv1   g11(.a(x03), .O(new_n37_));
  inv1   g12(.a(x13), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(new_n30_), .c(new_n37_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(new_n31_), .c(new_n36_), .O(z07));
  nand2  g15(.a(z07), .b(new_n35_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x01), .O(z02));
  inv1   g17(.a(x01), .O(new_n43_));
  inv1   g18(.a(new_n39_), .O(new_n44_));
  nor2   g19(.a(x02), .b(new_n35_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x06), .c(new_n26_), .O(z03));
  nor2   g22(.a(new_n41_), .b(new_n43_), .O(z04));
  nand3  g23(.a(new_n45_), .b(new_n44_), .c(x01), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x06), .c(new_n26_), .O(z05));
  inv1   g25(.a(new_n27_), .O(new_n51_));
  ...
  nand3  g41(.a(new_n38_), .b(new_n26_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nor2   g43(.a(new_n30_), .b(x03), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n51_), .O(z06));
  nand2  g46(.a(new_n67_), .b(new_n64_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n51_), .O(z08));
  nor2   g49(.a(new_n38_), .b(new_n36_), .O(z09));
