...
module FAU ( 
  ...
  nand3  g06(.a(new_n31_), .b(new_n27_), .c(x00), .O(new_n32_));
  nand3  g07(.a(new_n32_), .b(new_n30_), .c(new_n29_), .O(z00));
  inv1   g08(.a(x03), .O(new_n34_));
  nand2  g09(.a(new_n31_), .b(new_n27_), .O(new_n35_));
  ...
  nand4  g15(.a(new_n40_), .b(new_n39_), .c(new_n38_), .d(new_n34_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(x05), .c(x00), .O(z02));
  nand3  g17(.a(new_n39_), .b(x05), .c(new_n38_), .O(new_n43_));
  nand3  g18(.a(new_n40_), .b(new_n34_), .c(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n43_), .c(new_n28_), .O(z03));
  inv1   g20(.a(x01), .O(new_n46_));
  inv1   g21(.a(x02), .O(new_n47_));
  nand4  g22(.a(new_n39_), .b(x05), .c(new_n38_), .d(new_n47_), .O(new_n48_));
  nor4   g23(.a(new_n48_), .b(x03), .c(new_n46_), .d(x00), .O(z04));
  nor4   g24(.a(new_n48_), .b(x03), .c(new_n46_), .d(new_n26_), .O(z05));
  ...
  nand3  g30(.a(new_n55_), .b(new_n53_), .c(new_n26_), .O(new_n56_));
  ...
  nand4  g37(.a(x13), .b(new_n62_), .c(x05), .d(new_n47_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n61_), .c(new_n56_), .d(new_n51_), .O(new_n65_));
  nand4  g40(.a(new_n39_), .b(new_n27_), .c(x02), .d(x00), .O(new_n66_));
  nand2  g41(.a(x04), .b(new_n34_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(z06));
  nor2   g43(.a(new_n48_), .b(x03), .O(z07));
  aoi21  g44(.a(new_n66_), .b(new_n63_), .c(new_n67_), .O(z08));
  nand2  g45(.a(new_n28_), .b(x06), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(new_n39_), .O(z09));
  oai21  g47(.a(new_n27_), .b(new_n47_), .c(new_n34_), .O(new_n73_));
