...
module FAU ( 
  ...
  nand4  g08(.a(new_n33_), .b(x05), .c(new_n26_), .d(new_n32_), .O(new_n34_));
  ...
  nand4  g16(.a(new_n27_), .b(new_n33_), .c(x05), .d(new_n26_), .O(new_n42_));
  nand2  g17(.a(x01), .b(new_n35_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n42_), .c(new_n30_), .O(z04));
  nor3   g19(.a(new_n42_), .b(new_n36_), .c(new_n35_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  nor2   g21(.a(new_n29_), .b(new_n26_), .O(new_n47_));
