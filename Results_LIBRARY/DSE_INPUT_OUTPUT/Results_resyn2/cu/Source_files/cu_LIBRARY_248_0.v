...
module FAU ( 
  ...
  nand2  g06(.a(new_n26_), .b(new_n27_), .O(new_n32_));
  aoi21  g07(.a(new_n32_), .b(x05), .c(x03), .O(z01));
  ...
  nand3  g16(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x03), .O(z03));
  nand3  g18(.a(new_n41_), .b(x01), .c(new_n36_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(x03), .O(z04));
  nand3  g20(.a(new_n38_), .b(x01), .c(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n35_), .O(z05));
  ...
  nand3  g26(.a(new_n51_), .b(new_n30_), .c(new_n48_), .O(new_n52_));
  ...
  nor2   g40(.a(new_n41_), .b(new_n65_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x03), .O(z07));
  nor2   g42(.a(new_n50_), .b(new_n29_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  oai21  g44(.a(x05), .b(x03), .c(new_n69_), .O(z09));
