...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n38_, new_n41_, new_n43_, new_n45_, new_n46_,
  ...
  nand3  g10(.a(new_n35_), .b(new_n28_), .c(new_n34_), .O(new_n36_));
  inv1   g11(.a(new_n36_), .O(z07));
  nand2  g12(.a(z07), .b(new_n33_), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(x01), .O(z02));
  nor3   g14(.a(new_n36_), .b(x01), .c(new_n33_), .O(z03));
  inv1   g15(.a(x01), .O(new_n41_));
  nor2   g16(.a(new_n38_), .b(new_n41_), .O(z04));
  nand4  g17(.a(new_n28_), .b(new_n34_), .c(x01), .d(x00), .O(new_n43_));
  ...
  nand2  g23(.a(new_n48_), .b(new_n41_), .O(new_n49_));
  ...
  nand3  g37(.a(new_n30_), .b(new_n34_), .c(new_n27_), .O(new_n63_));
