...
module FAU ( 
  ...
  nor3   g14(.a(new_n34_), .b(new_n37_), .c(x00), .O(z04));
  inv1   g15(.a(x00), .O(new_n41_));
  nor3   g16(.a(new_n34_), .b(new_n37_), .c(new_n41_), .O(z05));
  ...
  nand3  g34(.a(new_n59_), .b(new_n57_), .c(new_n41_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n55_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n50_), .c(new_n36_), .O(z06));
  nand2  g37(.a(new_n34_), .b(new_n36_), .O(z07));
  oai21  g38(.a(new_n48_), .b(new_n45_), .c(new_n36_), .O(z08));
