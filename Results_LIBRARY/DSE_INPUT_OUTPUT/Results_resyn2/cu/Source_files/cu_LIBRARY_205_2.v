...
module FAU ( 
  ...
  nand2  g14(.a(new_n37_), .b(new_n36_), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n40_), .c(new_n27_), .O(z03));
  nor2   g18(.a(new_n38_), .b(new_n41_), .O(z04));
  nor2   g19(.a(new_n41_), .b(new_n35_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n37_), .c(new_n36_), .d(new_n27_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z05));
  oai21  g22(.a(x08), .b(x01), .c(x10), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n35_), .O(new_n49_));
  nand2  g24(.a(x11), .b(x01), .O(new_n50_));
  nand2  g25(.a(x09), .b(new_n41_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n50_), .c(x00), .O(new_n52_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n28_), .c(x02), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(new_n60_));
  aoi21  g35(.a(new_n57_), .b(new_n53_), .c(new_n60_), .O(new_n61_));
  inv1   g36(.a(x03), .O(new_n62_));
  nand2  g37(.a(x04), .b(new_n62_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n61_), .c(new_n27_), .O(z06));
  nand2  g39(.a(new_n40_), .b(new_n27_), .O(z07));
  and2   g40(.a(new_n59_), .b(new_n56_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n63_), .c(new_n27_), .O(z08));
  nand2  g42(.a(new_n27_), .b(x06), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n58_), .O(z09));
  inv1   g44(.a(new_n31_), .O(new_n70_));
  nor2   g45(.a(new_n68_), .b(new_n70_), .O(z10));
endmodule
