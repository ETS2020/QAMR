...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    ...
    new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_, new_n53_,
  ...
  nand2  g18(.a(new_n43_), .b(new_n34_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z02));
  nand4  g20(.a(new_n39_), .b(new_n38_), .c(new_n34_), .d(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n37_), .c(new_n26_), .O(z03));
  nand2  g22(.a(new_n43_), .b(x01), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z04));
  inv1   g24(.a(x00), .O(new_n50_));
  nor3   g25(.a(new_n42_), .b(new_n34_), .c(new_n50_), .O(z05));
  nand2  g26(.a(x11), .b(x00), .O(new_n52_));
  inv1   g27(.a(x09), .O(new_n53_));
  nand3  g28(.a(x10), .b(new_n53_), .c(new_n50_), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(x01), .O(new_n56_));
  inv1   g31(.a(x08), .O(new_n57_));
  oai21  g32(.a(x10), .b(new_n50_), .c(new_n57_), .O(new_n58_));
  aoi21  g33(.a(new_n53_), .b(x00), .c(x01), .O(new_n59_));
