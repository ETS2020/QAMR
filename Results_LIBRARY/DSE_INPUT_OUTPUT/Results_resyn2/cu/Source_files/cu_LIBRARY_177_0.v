...
module FAU ( 
  ...
  nand3  g20(.a(new_n45_), .b(new_n44_), .c(new_n26_), .O(new_n46_));
  nor4   g21(.a(new_n46_), .b(new_n33_), .c(new_n38_), .d(x00), .O(z04));
  ...
  nor2   g34(.a(new_n32_), .b(x03), .O(new_n60_));
  ...
  nand4  g42(.a(new_n45_), .b(new_n28_), .c(x04), .d(new_n44_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(z06));
  nor2   g44(.a(new_n46_), .b(new_n33_), .O(z07));
  nand2  g45(.a(x13), .b(new_n62_), .O(new_n71_));
  nand2  g46(.a(new_n27_), .b(x13), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n60_), .O(new_n73_));
  aoi21  g48(.a(new_n71_), .b(new_n29_), .c(new_n73_), .O(z08));
