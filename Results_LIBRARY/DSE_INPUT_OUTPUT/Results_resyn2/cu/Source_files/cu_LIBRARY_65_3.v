...
module FAU ( 
  ...
  nand2  g00(.a(x09), .b(x07), .O(new_n26_));
  ...
  nand3  g19(.a(new_n35_), .b(new_n34_), .c(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n41_), .c(new_n26_), .O(z03));
  nand2  g21(.a(new_n35_), .b(x01), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n43_), .c(new_n26_), .O(z04));
  nand2  g23(.a(new_n26_), .b(new_n35_), .O(new_n49_));
  nor4   g24(.a(new_n49_), .b(new_n41_), .c(new_n34_), .d(new_n37_), .O(z05));
  ...
  nand3  g36(.a(new_n61_), .b(new_n59_), .c(new_n37_), .O(new_n62_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n51_), .O(new_n67_));
  nor2   g42(.a(new_n39_), .b(x03), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n26_), .O(z06));
  nor2   g45(.a(new_n49_), .b(new_n41_), .O(z07));
  nand2  g46(.a(new_n64_), .b(new_n51_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n26_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  aoi21  g50(.a(x09), .b(x07), .c(new_n75_), .O(z09));
  nand2  g51(.a(new_n30_), .b(x06), .O(new_n77_));
