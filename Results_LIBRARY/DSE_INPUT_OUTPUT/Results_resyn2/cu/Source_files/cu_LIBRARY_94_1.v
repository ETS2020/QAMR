...
module FAU ( 
  ...
  nand2  g13(.a(new_n40_), .b(new_n35_), .O(z09));
  nand3  g14(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n42_));
  nand2  g15(.a(new_n42_), .b(new_n35_), .O(z10));
  zero   g16(.O(z03));
  zero   g17(.O(z05));
  inv1   g18(.a(new_n35_), .O(z04));
  inv1   g19(.a(new_n35_), .O(z07));
