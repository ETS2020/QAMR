...
module FAU ( 
  ...
  nand2  g18(.a(new_n39_), .b(x06), .O(new_n44_));
  ...
  nand4  g35(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n61_));
  ...
  nand2  g43(.a(new_n40_), .b(new_n48_), .O(z07));
  nand2  g44(.a(new_n64_), .b(new_n61_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n66_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n48_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n48_), .O(z09));
  nand2  g49(.a(new_n31_), .b(x06), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n48_), .O(z10));
endmodule
