...
module FAU ( 
  ...
  nor3   g19(.a(new_n44_), .b(new_n28_), .c(new_n36_), .O(new_n45_));
  ...
  inv1   g24(.a(new_n31_), .O(new_n50_));
  ...
  aoi21  g31(.a(new_n56_), .b(new_n36_), .c(new_n35_), .O(new_n57_));
  ...
  nor2   g36(.a(x13), .b(new_n26_), .O(new_n62_));
  aoi21  g37(.a(new_n61_), .b(new_n53_), .c(new_n62_), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n42_), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n63_), .c(new_n50_), .O(z06));
  nor2   g40(.a(new_n44_), .b(new_n28_), .O(z07));
  nand3  g41(.a(x13), .b(new_n59_), .c(x05), .O(new_n67_));
  inv1   g42(.a(new_n62_), .O(new_n68_));
  nand2  g43(.a(new_n32_), .b(x04), .O(new_n69_));
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(new_n31_), .O(z09));
  nand2  g47(.a(new_n32_), .b(x06), .O(new_n73_));
