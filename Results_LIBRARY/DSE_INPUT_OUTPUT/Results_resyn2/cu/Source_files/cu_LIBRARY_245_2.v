...
module FAU ( 
  ...
  nor2   g09(.a(new_n29_), .b(x04), .O(new_n35_));
  ...
  nor2   g16(.a(new_n27_), .b(new_n38_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n36_), .c(new_n35_), .d(new_n39_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z03));
  nand2  g19(.a(x01), .b(new_n38_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n37_), .c(new_n34_), .O(z04));
  nand4  g21(.a(new_n42_), .b(new_n36_), .c(new_n35_), .d(x01), .O(new_n47_));
  ...
  nand3  g40(.a(new_n65_), .b(new_n29_), .c(x02), .O(new_n66_));
  ...
  nand2  g46(.a(new_n37_), .b(new_n34_), .O(z07));
  nand2  g47(.a(new_n69_), .b(new_n34_), .O(new_n73_));
  aoi21  g48(.a(new_n66_), .b(new_n62_), .c(new_n73_), .O(z08));
  nand3  g49(.a(x13), .b(x09), .c(x06), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  inv1   g51(.a(new_n28_), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(x09), .c(new_n26_), .O(z10));
endmodule
