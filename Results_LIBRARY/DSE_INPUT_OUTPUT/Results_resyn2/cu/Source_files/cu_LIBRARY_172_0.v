...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n41_), .c(new_n43_), .O(z04));
  oai21  g19(.a(new_n39_), .b(new_n41_), .c(new_n43_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  inv1   g21(.a(x10), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(x01), .O(new_n48_));
  inv1   g23(.a(x08), .O(new_n49_));
  nand2  g24(.a(new_n49_), .b(new_n41_), .O(new_n50_));
  ...
  nand4  g34(.a(new_n35_), .b(x11), .c(new_n29_), .d(x02), .O(new_n60_));
  ...
  nand3  g39(.a(new_n35_), .b(new_n29_), .c(x02), .O(new_n65_));
  and2   g40(.a(new_n65_), .b(new_n57_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n61_), .c(new_n43_), .O(z08));
  nand2  g42(.a(x13), .b(x06), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n43_), .O(z09));
  nand2  g44(.a(x11), .b(new_n29_), .O(new_n70_));
  nand2  g45(.a(x05), .b(new_n26_), .O(new_n71_));
  nand2  g46(.a(x06), .b(new_n34_), .O(new_n72_));
