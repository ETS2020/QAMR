...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n29_, new_n30_, new_n37_, new_n39_;
  ...
  nand2  g08(.a(x13), .b(x06), .O(new_n37_));
  nor2   g09(.a(new_n37_), .b(z02), .O(z09));
  nand3  g10(.a(x06), .b(new_n27_), .c(new_n26_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(new_n30_), .O(z10));
  zero   g12(.O(z03));
  zero   g13(.O(z04));
  zero   g14(.O(z05));
  nor2   g15(.a(new_n27_), .b(x02), .O(z07));
