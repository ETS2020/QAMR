...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n42_), .c(new_n35_), .O(new_n44_));
  nor4   g19(.a(new_n44_), .b(new_n29_), .c(x01), .d(new_n37_), .O(z03));
  nand3  g20(.a(new_n39_), .b(x01), .c(new_n37_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n35_), .c(new_n36_), .O(z04));
  nand3  g22(.a(new_n39_), .b(x01), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n35_), .c(new_n36_), .O(z05));
  inv1   g24(.a(x08), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n38_), .c(x00), .O(new_n51_));
  oai21  g26(.a(x10), .b(new_n38_), .c(new_n51_), .O(new_n52_));
  inv1   g27(.a(x11), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(x01), .O(new_n54_));
  inv1   g29(.a(x09), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n38_), .c(new_n37_), .O(new_n56_));
