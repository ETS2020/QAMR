...
module FAU ( 
  ...
  nor2   g13(.a(new_n38_), .b(new_n26_), .O(new_n39_));
  ...
  nand3  g27(.a(new_n52_), .b(new_n50_), .c(new_n42_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n36_), .b(new_n29_), .c(x02), .O(new_n64_));
  ...
  nand2  g43(.a(new_n38_), .b(new_n47_), .O(z07));
  nand2  g44(.a(new_n27_), .b(x04), .O(new_n70_));
  aoi21  g45(.a(new_n64_), .b(new_n61_), .c(new_n70_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n47_), .O(z09));
  inv1   g48(.a(x03), .O(new_n74_));
  nand3  g49(.a(new_n28_), .b(x06), .c(new_n74_), .O(new_n75_));
