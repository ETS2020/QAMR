...
module FAU ( 
  ...
  nand2  g08(.a(x11), .b(new_n29_), .O(new_n34_));
  ...
  nand3  g36(.a(new_n36_), .b(new_n29_), .c(x02), .O(new_n62_));
  ...
  nand2  g41(.a(new_n38_), .b(new_n34_), .O(z07));
  nor2   g42(.a(new_n63_), .b(new_n60_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n65_), .c(new_n34_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  aoi21  g45(.a(x11), .b(new_n29_), .c(new_n70_), .O(z09));
