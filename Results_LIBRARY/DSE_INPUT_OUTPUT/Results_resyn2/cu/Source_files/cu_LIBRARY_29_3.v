...
module FAU ( 
  ...
  nand3  g17(.a(new_n42_), .b(new_n26_), .c(new_n27_), .O(new_n43_));
  nor4   g18(.a(new_n43_), .b(new_n29_), .c(x01), .d(new_n37_), .O(z03));
  nand3  g19(.a(new_n39_), .b(x01), .c(new_n37_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n27_), .c(new_n33_), .O(z04));
  ...
  nor2   g37(.a(new_n43_), .b(new_n29_), .O(z07));
  nand3  g38(.a(x13), .b(new_n57_), .c(x05), .O(new_n64_));
  inv1   g39(.a(new_n60_), .O(new_n65_));
  nand3  g40(.a(new_n31_), .b(x04), .c(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  oai21  g43(.a(new_n42_), .b(new_n68_), .c(new_n31_), .O(z09));
  oai21  g44(.a(new_n68_), .b(x03), .c(new_n31_), .O(z10));
endmodule
