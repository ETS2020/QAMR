...
module FAU ( 
  ...
  nand2  g13(.a(x05), .b(new_n29_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(new_n32_), .c(x13), .O(z07));
  nand3  g15(.a(z07), .b(new_n38_), .c(new_n37_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z02));
  nor2   g17(.a(new_n32_), .b(x13), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n29_), .c(new_n27_), .O(z03));
  nand3  g20(.a(z07), .b(x01), .c(new_n37_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z04));
  nand3  g22(.a(new_n43_), .b(x01), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n29_), .c(new_n27_), .O(z05));
  ...
  nand4  g40(.a(new_n65_), .b(new_n27_), .c(new_n29_), .d(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(x04), .O(new_n68_));
  nor2   g43(.a(new_n27_), .b(new_n29_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n68_), .O(z06));
  nand3  g46(.a(new_n65_), .b(new_n27_), .c(x02), .O(new_n72_));
  nand2  g47(.a(x04), .b(new_n29_), .O(new_n73_));
  aoi21  g48(.a(new_n72_), .b(new_n62_), .c(new_n73_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(new_n69_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n29_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n70_), .O(z10));
endmodule
