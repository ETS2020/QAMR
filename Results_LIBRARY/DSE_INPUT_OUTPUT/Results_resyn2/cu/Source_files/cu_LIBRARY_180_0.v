...
module FAU ( 
  ...
  nand2  g13(.a(new_n30_), .b(new_n38_), .O(new_n39_));
  ...
  oai21  g20(.a(new_n45_), .b(new_n42_), .c(new_n39_), .O(z02));
  nand2  g21(.a(new_n44_), .b(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n42_), .O(z03));
  nand4  g23(.a(new_n35_), .b(new_n41_), .c(new_n26_), .d(x01), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x00), .O(z04));
  nor2   g25(.a(new_n49_), .b(new_n43_), .O(z05));
  ...
  nand3  g31(.a(new_n56_), .b(new_n54_), .c(new_n43_), .O(new_n57_));
  ...
  nand4  g37(.a(x13), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n62_), .c(new_n57_), .d(new_n52_), .O(new_n65_));
  nand3  g40(.a(new_n31_), .b(new_n41_), .c(x02), .O(new_n66_));
  nand2  g41(.a(x04), .b(new_n26_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(z06));
  inv1   g43(.a(new_n42_), .O(z07));
  aoi21  g44(.a(new_n66_), .b(new_n63_), .c(new_n67_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n39_), .O(z09));
  aoi21  g47(.a(x05), .b(new_n27_), .c(new_n31_), .O(new_n73_));
  nand2  g48(.a(x06), .b(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(new_n73_), .O(z10));
endmodule
