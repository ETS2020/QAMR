...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
  ...
  nor3   g19(.a(new_n40_), .b(x01), .c(new_n41_), .O(z03));
  nor3   g20(.a(new_n40_), .b(new_n42_), .c(x00), .O(z04));
  nor3   g21(.a(new_n40_), .b(new_n42_), .c(new_n41_), .O(z05));
  ...
  nand2  g30(.a(new_n26_), .b(new_n42_), .O(new_n56_));
  ...
  nand4  g35(.a(new_n60_), .b(new_n57_), .c(new_n53_), .d(new_n48_), .O(new_n61_));
  nand3  g36(.a(new_n39_), .b(new_n33_), .c(x02), .O(new_n62_));
  ...
  nand2  g44(.a(new_n69_), .b(new_n37_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(new_n27_), .O(z09));
  nand2  g47(.a(x05), .b(x02), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x06), .c(new_n38_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n37_), .O(z10));
endmodule
