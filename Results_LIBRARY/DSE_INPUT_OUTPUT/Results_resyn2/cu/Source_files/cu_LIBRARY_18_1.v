...
module FAU ( 
  ...
  aoi21  g09(.a(x05), .b(new_n26_), .c(new_n34_), .O(z00));
  nand2  g10(.a(new_n28_), .b(new_n26_), .O(new_n36_));
  nand2  g11(.a(new_n36_), .b(new_n34_), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(z01));
  inv1   g13(.a(x01), .O(new_n40_));
  inv1   g14(.a(x13), .O(new_n41_));
  nand4  g15(.a(new_n41_), .b(new_n28_), .c(new_n32_), .d(new_n27_), .O(new_n42_));
  inv1   g16(.a(new_n42_), .O(new_n43_));
  nand2  g17(.a(new_n43_), .b(new_n40_), .O(new_n44_));
  aoi21  g18(.a(new_n44_), .b(x00), .c(new_n30_), .O(z03));
  nand2  g19(.a(new_n43_), .b(x01), .O(new_n47_));
  aoi21  g20(.a(new_n47_), .b(x00), .c(new_n30_), .O(z05));
  nand2  g21(.a(x05), .b(new_n26_), .O(new_n49_));
  nand3  g22(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n50_));
  ...
  nand3  g26(.a(new_n53_), .b(x04), .c(new_n32_), .O(new_n54_));
  inv1   g27(.a(x07), .O(new_n55_));
  inv1   g28(.a(x09), .O(new_n56_));
  nand2  g29(.a(new_n56_), .b(new_n40_), .O(new_n57_));
  inv1   g30(.a(x11), .O(new_n58_));
  nand2  g31(.a(new_n58_), .b(x01), .O(new_n59_));
  nand2  g32(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g33(.a(new_n50_), .b(new_n49_), .O(new_n61_));
  aoi21  g34(.a(new_n60_), .b(new_n55_), .c(new_n61_), .O(new_n62_));
  aoi21  g35(.a(new_n54_), .b(new_n49_), .c(new_n62_), .O(z06));
  aoi21  g36(.a(new_n42_), .b(x00), .c(new_n30_), .O(z07));
  nand2  g37(.a(new_n54_), .b(new_n49_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(new_n49_), .O(z09));
  nand2  g40(.a(x05), .b(x02), .O(new_n68_));
  nand3  g41(.a(new_n68_), .b(x06), .c(new_n32_), .O(new_n69_));
  nand2  g42(.a(new_n69_), .b(new_n49_), .O(z10));
  zero   g43(.O(z02));
  zero   g44(.O(z04));
endmodule
