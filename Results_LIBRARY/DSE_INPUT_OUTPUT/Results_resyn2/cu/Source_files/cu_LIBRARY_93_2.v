...
module FAU ( 
  ...
  aoi21  g06(.a(new_n31_), .b(x05), .c(new_n27_), .O(z00));
  inv1   g07(.a(x05), .O(new_n33_));
  inv1   g08(.a(new_n27_), .O(new_n34_));
  oai21  g09(.a(new_n30_), .b(new_n33_), .c(new_n34_), .O(z01));
  inv1   g10(.a(x01), .O(new_n36_));
  nand2  g11(.a(new_n26_), .b(new_n36_), .O(new_n37_));
  inv1   g12(.a(x00), .O(new_n38_));
  inv1   g13(.a(x03), .O(new_n39_));
  nor2   g14(.a(x13), .b(new_n33_), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n28_), .c(new_n39_), .d(new_n38_), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n37_), .c(new_n34_), .O(z02));
  nand4  g17(.a(new_n40_), .b(new_n28_), .c(new_n39_), .d(x00), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n37_), .c(new_n34_), .O(z03));
  nand2  g19(.a(new_n26_), .b(x01), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n41_), .c(new_n34_), .O(z04));
  oai21  g21(.a(new_n45_), .b(new_n43_), .c(new_n34_), .O(z05));
  inv1   g22(.a(x07), .O(new_n48_));
  nor2   g23(.a(new_n33_), .b(new_n28_), .O(new_n49_));
  inv1   g24(.a(x13), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x12), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n49_), .c(new_n29_), .d(new_n48_), .O(new_n52_));
  ...
  nand2  g39(.a(new_n40_), .b(new_n31_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n34_), .O(z07));
  nand2  g41(.a(new_n39_), .b(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n51_), .b(new_n49_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n67_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  oai21  g45(.a(new_n50_), .b(new_n70_), .c(new_n34_), .O(z09));
  oai21  g46(.a(new_n67_), .b(new_n70_), .c(new_n34_), .O(z10));
endmodule
