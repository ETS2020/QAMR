...
module FAU ( 
  ...
  nor4   g18(.a(new_n43_), .b(new_n27_), .c(new_n35_), .d(x00), .O(z04));
  nand3  g19(.a(new_n36_), .b(x01), .c(x00), .O(new_n45_));
  ...
  nand3  g40(.a(new_n57_), .b(new_n42_), .c(new_n65_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(z06));
  nor2   g42(.a(new_n36_), .b(new_n65_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand2  g44(.a(new_n42_), .b(new_n65_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n59_), .c(new_n41_), .O(new_n71_));
  nand2  g46(.a(new_n65_), .b(new_n41_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n57_), .O(new_n73_));
  aoi21  g48(.a(new_n71_), .b(new_n70_), .c(new_n73_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  aoi21  g50(.a(new_n65_), .b(new_n41_), .c(new_n75_), .O(z09));
  inv1   g51(.a(new_n30_), .O(new_n77_));
  nand2  g52(.a(x06), .b(new_n29_), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(new_n72_), .c(new_n77_), .O(z10));
endmodule
