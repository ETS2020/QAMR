...
module FAU ( 
  ...
  oai21  g21(.a(new_n46_), .b(new_n39_), .c(new_n27_), .O(z04));
  nand2  g22(.a(x01), .b(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n39_), .c(new_n27_), .O(z05));
  nand2  g24(.a(x04), .b(new_n36_), .O(new_n50_));
  nand3  g25(.a(new_n37_), .b(new_n28_), .c(x02), .O(new_n51_));
  ...
  nand4  g35(.a(x13), .b(new_n26_), .c(x05), .d(new_n35_), .O(new_n61_));
  or2    g36(.a(x09), .b(x07), .O(new_n62_));
  nor2   g37(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n53_), .c(new_n50_), .O(z06));
  nand2  g40(.a(new_n39_), .b(new_n27_), .O(z07));
  and2   g41(.a(new_n61_), .b(new_n51_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n50_), .c(new_n27_), .O(z08));
