...
module FAU ( 
  ...
  oai21  g01(.a(x07), .b(x02), .c(x05), .O(new_n27_));
  ...
  nand2  g06(.a(x07), .b(x05), .O(new_n32_));
  ...
  nand4  g16(.a(new_n41_), .b(new_n40_), .c(new_n26_), .d(new_n39_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n38_), .c(new_n37_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n36_), .c(new_n28_), .O(z02));
  nand3  g20(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n36_), .c(new_n28_), .O(z03));
  nand3  g22(.a(new_n43_), .b(x01), .c(new_n37_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n36_), .c(new_n28_), .O(z04));
  nand3  g24(.a(new_n43_), .b(x01), .c(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n36_), .c(new_n28_), .O(z05));
  nand2  g26(.a(new_n36_), .b(new_n39_), .O(new_n52_));
  nand3  g27(.a(new_n41_), .b(new_n28_), .c(x02), .O(new_n53_));
  inv1   g28(.a(x12), .O(new_n54_));
  nand3  g29(.a(x13), .b(new_n54_), .c(x05), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n52_), .c(new_n53_), .O(new_n56_));
  nor2   g31(.a(new_n40_), .b(x03), .O(new_n57_));
  ...
  nand2  g36(.a(x08), .b(new_n38_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n61_), .c(new_n37_), .O(new_n63_));
  ...
  aoi21  g41(.a(new_n42_), .b(new_n36_), .c(new_n28_), .O(z07));
  and2   g42(.a(new_n57_), .b(new_n56_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n32_), .O(z09));
  nand3  g45(.a(new_n33_), .b(x06), .c(new_n26_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n32_), .O(z10));
endmodule
