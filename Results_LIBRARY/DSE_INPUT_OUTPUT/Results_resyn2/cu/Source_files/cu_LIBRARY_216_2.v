...
module FAU ( 
  ...
  nand4  g15(.a(new_n29_), .b(new_n34_), .c(x05), .d(new_n28_), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x01), .c(new_n36_), .O(z03));
  nand3  g17(.a(new_n38_), .b(x01), .c(new_n36_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n35_), .O(z04));
  nand2  g19(.a(x01), .b(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n41_), .c(new_n27_), .O(z05));
