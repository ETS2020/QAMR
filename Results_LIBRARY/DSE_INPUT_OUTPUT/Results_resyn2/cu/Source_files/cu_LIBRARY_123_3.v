...
module FAU ( 
  ...
  oai21  g07(.a(new_n32_), .b(new_n29_), .c(new_n27_), .O(z00));
  nor2   g08(.a(new_n32_), .b(new_n29_), .O(new_n34_));
  inv1   g09(.a(x03), .O(new_n35_));
  nand2  g10(.a(new_n26_), .b(new_n35_), .O(new_n36_));
  nor2   g11(.a(new_n36_), .b(new_n34_), .O(z01));
  inv1   g12(.a(x00), .O(new_n38_));
  nand3  g13(.a(new_n35_), .b(new_n30_), .c(new_n38_), .O(new_n39_));
  ...
  nand3  g18(.a(new_n35_), .b(new_n30_), .c(x00), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n42_), .O(z03));
  nand3  g20(.a(new_n29_), .b(new_n41_), .c(x01), .O(new_n46_));
  ...
  nand3  g38(.a(new_n41_), .b(new_n28_), .c(x02), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n35_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  nand3  g41(.a(new_n41_), .b(new_n31_), .c(new_n35_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n30_), .c(new_n28_), .O(z07));
  aoi21  g43(.a(new_n64_), .b(new_n61_), .c(new_n65_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  oai21  g45(.a(new_n41_), .b(new_n70_), .c(new_n26_), .O(z09));
