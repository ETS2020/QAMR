...
module FAU ( 
  ...
  nor2   g12(.a(x13), .b(new_n32_), .O(new_n38_));
  nand4  g13(.a(new_n38_), .b(new_n29_), .c(new_n37_), .d(new_n28_), .O(new_n39_));
  ...
  nor2   g18(.a(new_n39_), .b(new_n43_), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(new_n36_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  inv1   g21(.a(new_n27_), .O(new_n47_));
  nand2  g22(.a(new_n40_), .b(x01), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n47_), .O(z04));
  nand2  g24(.a(new_n44_), .b(x01), .O(new_n50_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n47_), .O(z06));
  nand2  g47(.a(new_n39_), .b(new_n47_), .O(z07));
  nand2  g48(.a(new_n68_), .b(new_n64_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n70_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n47_), .O(z08));
  nor2   g51(.a(new_n38_), .b(new_n26_), .O(z09));
