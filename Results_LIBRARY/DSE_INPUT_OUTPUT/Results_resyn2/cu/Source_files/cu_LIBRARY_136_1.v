...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(new_n27_), .O(new_n38_));
  ...
  oai21  g20(.a(new_n45_), .b(new_n40_), .c(new_n27_), .O(z04));
  nand2  g21(.a(x01), .b(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n40_), .c(new_n27_), .O(z05));
  ...
  nand2  g28(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  inv1   g29(.a(x10), .O(new_n55_));
  nand3  g30(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x00), .c(new_n41_), .O(new_n58_));
  inv1   g33(.a(x08), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x00), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(new_n61_));
  ...
  aoi21  g43(.a(new_n68_), .b(new_n54_), .c(new_n50_), .O(z06));
  aoi21  g44(.a(x09), .b(new_n26_), .c(new_n40_), .O(z07));
  nand3  g45(.a(new_n27_), .b(x04), .c(new_n49_), .O(new_n71_));
  aoi21  g46(.a(new_n64_), .b(new_n52_), .c(new_n71_), .O(z08));
