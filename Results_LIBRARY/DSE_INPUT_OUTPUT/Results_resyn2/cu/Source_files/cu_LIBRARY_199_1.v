...
module FAU ( 
  ...
  wire new_n26_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_, new_n40_,
    new_n42_;
  ...
  nand2  g10(.a(x13), .b(x06), .O(new_n40_));
  nor2   g11(.a(new_n40_), .b(z03), .O(z09));
  nand2  g12(.a(new_n28_), .b(x06), .O(new_n42_));
  inv1   g13(.a(new_n42_), .O(z10));
  zero   g14(.O(z02));
  zero   g15(.O(z04));
  zero   g16(.O(z05));
  zero   g17(.O(z07));
