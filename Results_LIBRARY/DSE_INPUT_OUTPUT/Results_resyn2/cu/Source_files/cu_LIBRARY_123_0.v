...
module FAU ( 
  ...
  nand2  g09(.a(new_n30_), .b(new_n34_), .O(new_n35_));
  inv1   g10(.a(x00), .O(new_n36_));
  inv1   g11(.a(x13), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(new_n35_), .O(z02));
  nand4  g14(.a(new_n37_), .b(x05), .c(new_n26_), .d(x00), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n35_), .O(z03));
  nand2  g16(.a(new_n30_), .b(x01), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n38_), .O(z04));
  nor2   g18(.a(new_n42_), .b(new_n40_), .O(z05));
  inv1   g19(.a(x07), .O(new_n45_));
  inv1   g20(.a(x10), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(x01), .O(new_n47_));
  inv1   g22(.a(x08), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n34_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n47_), .c(new_n36_), .O(new_n50_));
  ...
  nand3  g39(.a(new_n37_), .b(new_n64_), .c(new_n26_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(x05), .c(x02), .O(z07));
  aoi21  g41(.a(new_n61_), .b(new_n58_), .c(new_n62_), .O(z08));
  inv1   g42(.a(new_n27_), .O(new_n68_));
  ...
  nand2  g47(.a(new_n72_), .b(new_n68_), .O(z10));
endmodule
