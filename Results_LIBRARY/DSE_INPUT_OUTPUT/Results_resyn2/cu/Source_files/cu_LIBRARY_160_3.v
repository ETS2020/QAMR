...
module FAU ( 
  ...
  aoi21  g12(.a(new_n37_), .b(new_n27_), .c(new_n30_), .O(z02));
  nand3  g13(.a(new_n36_), .b(new_n35_), .c(x00), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n27_), .c(new_n30_), .O(z03));
  nand2  g15(.a(new_n27_), .b(x01), .O(new_n41_));
  inv1   g16(.a(x13), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n29_), .d(new_n26_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n41_), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(new_n34_), .O(new_n45_));
  ...
  nand2  g32(.a(new_n57_), .b(new_n35_), .O(new_n58_));
  ...
  oai21  g46(.a(new_n42_), .b(new_n70_), .c(new_n71_), .O(z09));
  oai21  g47(.a(new_n70_), .b(x03), .c(new_n71_), .O(z10));
endmodule
