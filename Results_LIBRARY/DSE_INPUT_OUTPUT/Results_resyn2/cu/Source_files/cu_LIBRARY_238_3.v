...
module FAU ( 
  ...
  aoi21  g15(.a(new_n40_), .b(new_n29_), .c(new_n27_), .O(z02));
  nor2   g16(.a(new_n27_), .b(x03), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n39_), .O(new_n43_));
  nand2  g18(.a(new_n38_), .b(x00), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n43_), .O(z03));
  nand4  g20(.a(new_n42_), .b(new_n39_), .c(x01), .d(new_n37_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z04));
  nand4  g22(.a(new_n42_), .b(new_n39_), .c(x01), .d(x00), .O(new_n48_));
