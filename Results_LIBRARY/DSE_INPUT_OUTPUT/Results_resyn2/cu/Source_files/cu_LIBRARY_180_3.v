...
module FAU ( 
  ...
  nor2   g03(.a(x12), .b(new_n27_), .O(new_n29_));
  ...
  oai21  g09(.a(new_n32_), .b(new_n27_), .c(new_n28_), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n26_), .O(new_n36_));
  nand2  g11(.a(x12), .b(x05), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n36_), .O(z01));
  inv1   g13(.a(x12), .O(new_n39_));
  inv1   g14(.a(x00), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  inv1   g16(.a(x13), .O(new_n42_));
  nand3  g17(.a(new_n31_), .b(new_n42_), .c(new_n26_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n41_), .c(new_n40_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n39_), .c(new_n27_), .O(z02));
  nand2  g21(.a(new_n41_), .b(x00), .O(new_n47_));
  nor3   g22(.a(new_n47_), .b(new_n43_), .c(new_n30_), .O(z03));
  nand3  g23(.a(new_n44_), .b(new_n29_), .c(x01), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x00), .O(z04));
  nor2   g25(.a(new_n49_), .b(new_n40_), .O(z05));
  ...
  nand4  g38(.a(x13), .b(new_n39_), .c(x05), .d(new_n63_), .O(new_n64_));
