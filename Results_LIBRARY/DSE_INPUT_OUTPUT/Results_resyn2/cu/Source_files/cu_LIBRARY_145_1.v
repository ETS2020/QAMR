...
module FAU ( 
  ...
  aoi21  g04(.a(new_n29_), .b(new_n26_), .c(new_n27_), .O(new_n30_));
  ...
  or2    g09(.a(new_n34_), .b(new_n30_), .O(z00));
  nor2   g10(.a(new_n27_), .b(x05), .O(new_n36_));
  ...
  nand2  g20(.a(new_n45_), .b(new_n37_), .O(z02));
  nand2  g21(.a(new_n44_), .b(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x01), .O(z03));
  nand3  g23(.a(new_n26_), .b(x01), .c(new_n39_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n43_), .c(new_n37_), .O(z04));
  oai21  g25(.a(new_n47_), .b(new_n40_), .c(new_n37_), .O(z05));
  nand3  g26(.a(new_n42_), .b(new_n28_), .c(x02), .O(new_n52_));
