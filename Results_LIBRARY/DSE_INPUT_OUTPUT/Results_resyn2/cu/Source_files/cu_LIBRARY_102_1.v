...
module FAU ( 
  ...
  wire new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n35_,
    ...
    new_n50_, new_n51_, new_n52_, new_n53_, new_n56_, new_n58_, new_n59_;
  ...
  nand4  g23(.a(x13), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n47_), .c(new_n42_), .d(new_n35_), .O(new_n51_));
  inv1   g26(.a(x13), .O(new_n52_));
  nand2  g27(.a(new_n29_), .b(new_n52_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n51_), .c(new_n31_), .O(z06));
  aoi21  g29(.a(new_n53_), .b(new_n49_), .c(new_n31_), .O(z08));
  nand2  g30(.a(x13), .b(x06), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(z02), .O(z09));
  nand2  g32(.a(x04), .b(new_n28_), .O(new_n58_));
  nand2  g33(.a(x06), .b(new_n30_), .O(new_n59_));
  aoi21  g34(.a(new_n58_), .b(x05), .c(new_n59_), .O(z10));
  nor2   g35(.a(new_n26_), .b(x04), .O(z03));
  nor2   g36(.a(new_n26_), .b(x04), .O(z04));
  nor2   g37(.a(new_n26_), .b(x04), .O(z05));
  nor2   g38(.a(new_n26_), .b(x04), .O(z07));
endmodule
