...
module FAU ( 
  ...
  aoi21  g12(.a(new_n37_), .b(x05), .c(x02), .O(z02));
  nand3  g13(.a(new_n36_), .b(new_n35_), .c(x00), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(x05), .c(x02), .O(z03));
  nand2  g15(.a(new_n30_), .b(x05), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x13), .c(x03), .O(z07));
  nand2  g17(.a(z07), .b(x01), .O(new_n43_));
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(x04), .d(new_n26_), .O(new_n59_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n29_), .c(x04), .d(new_n26_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n63_), .O(z06));
  oai21  g41(.a(new_n60_), .b(new_n29_), .c(new_n46_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n65_), .O(z08));
  inv1   g43(.a(new_n27_), .O(new_n69_));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(z09));
  nand2  g46(.a(x05), .b(x02), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x06), .c(new_n26_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n69_), .O(z10));
endmodule
