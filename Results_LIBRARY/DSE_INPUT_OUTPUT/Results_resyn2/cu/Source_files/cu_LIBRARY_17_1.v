...
module FAU ( 
  ...
  nor2   g04(.a(x13), .b(x05), .O(new_n30_));
  ...
  nor3   g09(.a(x05), .b(new_n28_), .c(new_n27_), .O(new_n35_));
  oai21  g10(.a(new_n35_), .b(new_n34_), .c(new_n26_), .O(new_n36_));
  ...
  nand4  g16(.a(new_n34_), .b(new_n41_), .c(new_n26_), .d(new_n40_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x01), .O(z02));
  nand4  g18(.a(new_n34_), .b(new_n41_), .c(new_n26_), .d(x00), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x01), .O(z03));
  inv1   g20(.a(x01), .O(new_n46_));
  oai21  g21(.a(new_n42_), .b(new_n46_), .c(new_n38_), .O(z04));
  oai21  g22(.a(new_n44_), .b(new_n46_), .c(new_n38_), .O(z05));
  nand2  g23(.a(x04), .b(new_n26_), .O(new_n49_));
  ...
  nor2   g34(.a(new_n37_), .b(x02), .O(new_n60_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n60_), .c(new_n59_), .d(new_n54_), .O(new_n65_));
  nand2  g40(.a(new_n30_), .b(x02), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n49_), .O(z06));
  nor3   g42(.a(new_n29_), .b(x13), .c(x03), .O(z07));
  nor2   g43(.a(x12), .b(x02), .O(new_n69_));
  aoi22  g44(.a(new_n69_), .b(x13), .c(new_n37_), .d(x02), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n49_), .c(new_n38_), .O(z08));
  inv1   g46(.a(x06), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x05), .c(new_n41_), .O(z09));
  nor2   g48(.a(new_n60_), .b(new_n30_), .O(new_n74_));
  nand2  g49(.a(x06), .b(new_n26_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(new_n74_), .O(z10));
endmodule
