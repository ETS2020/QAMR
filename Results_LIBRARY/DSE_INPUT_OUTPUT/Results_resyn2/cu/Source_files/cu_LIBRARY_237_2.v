...
module FAU ( 
  ...
  nand3  g15(.a(new_n40_), .b(new_n34_), .c(new_n33_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(x06), .c(new_n26_), .O(z02));
  nand4  g17(.a(new_n40_), .b(x06), .c(x05), .d(x00), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x01), .O(z03));
  inv1   g19(.a(x06), .O(new_n45_));
  nand2  g20(.a(x01), .b(new_n33_), .O(new_n46_));
  nor4   g21(.a(new_n46_), .b(new_n39_), .c(new_n45_), .d(new_n26_), .O(z04));
  nor2   g22(.a(new_n43_), .b(new_n34_), .O(z05));
  ...
  nand3  g29(.a(new_n54_), .b(new_n52_), .c(new_n33_), .O(new_n55_));
  ...
  aoi21  g44(.a(new_n39_), .b(x06), .c(new_n26_), .O(z07));
  ...
  oai21  g48(.a(new_n38_), .b(new_n45_), .c(new_n49_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n36_), .O(new_n76_));
