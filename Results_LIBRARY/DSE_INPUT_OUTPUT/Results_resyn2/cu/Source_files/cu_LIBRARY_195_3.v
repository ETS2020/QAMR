...
module FAU ( 
  ...
  nand3  g12(.a(new_n37_), .b(new_n29_), .c(new_n26_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(new_n36_), .c(new_n35_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n27_), .c(new_n34_), .O(z02));
  nor4   g16(.a(new_n38_), .b(new_n30_), .c(x01), .d(new_n35_), .O(z03));
  nand3  g17(.a(new_n39_), .b(x01), .c(new_n35_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n27_), .c(new_n34_), .O(z04));
  nand3  g19(.a(new_n39_), .b(x01), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n27_), .c(new_n34_), .O(z05));
  nor2   g21(.a(new_n29_), .b(x03), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n37_), .b(new_n34_), .c(x02), .O(new_n49_));
  inv1   g24(.a(new_n30_), .O(new_n50_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n49_), .c(new_n48_), .O(z06));
  nor2   g41(.a(new_n38_), .b(new_n30_), .O(z07));
  aoi21  g42(.a(new_n47_), .b(new_n37_), .c(x05), .O(new_n68_));
  ...
  oai21  g47(.a(new_n37_), .b(new_n71_), .c(new_n72_), .O(z09));
  oai21  g48(.a(new_n71_), .b(x03), .c(new_n72_), .O(z10));
endmodule
