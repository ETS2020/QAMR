...
module FAU ( 
  ...
  aoi21  g17(.a(new_n42_), .b(x06), .c(new_n27_), .O(z02));
  inv1   g18(.a(x13), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(x06), .c(new_n26_), .O(new_n45_));
  nor3   g20(.a(new_n45_), .b(new_n31_), .c(new_n39_), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(new_n40_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  nand4  g23(.a(new_n41_), .b(new_n29_), .c(x01), .d(new_n39_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x06), .c(new_n27_), .O(z04));
  nand2  g25(.a(new_n46_), .b(x01), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z05));
  nand3  g27(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n53_));
  ...
  nor2   g41(.a(new_n44_), .b(x07), .O(new_n67_));
  ...
  nor2   g47(.a(new_n45_), .b(new_n31_), .O(z07));
  inv1   g48(.a(new_n70_), .O(new_n74_));
  nand3  g49(.a(new_n66_), .b(x13), .c(x06), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n53_), .c(new_n74_), .O(z08));
  oai21  g51(.a(new_n44_), .b(new_n33_), .c(new_n37_), .O(z09));
