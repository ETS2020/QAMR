...
module FAU ( 
  ...
  inv1   g15(.a(new_n30_), .O(new_n41_));
  inv1   g16(.a(x13), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(x05), .c(new_n26_), .O(new_n43_));
  nor4   g18(.a(new_n43_), .b(new_n41_), .c(new_n35_), .d(x00), .O(z04));
  ...
  nand2  g47(.a(new_n72_), .b(new_n70_), .O(z10));
endmodule
