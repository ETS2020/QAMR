...
module FAU ( 
  ...
  aoi21  g18(.a(new_n43_), .b(x11), .c(new_n32_), .O(z02));
  nor2   g19(.a(x01), .b(new_n37_), .O(new_n45_));
  nor3   g20(.a(new_n41_), .b(new_n26_), .c(new_n32_), .O(z07));
  ...
  nand3  g30(.a(new_n55_), .b(new_n38_), .c(x00), .O(new_n56_));
  nand2  g31(.a(x10), .b(x01), .O(new_n57_));
  nand2  g32(.a(x08), .b(new_n38_), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n57_), .c(new_n37_), .O(new_n59_));
  ...
  nand2  g38(.a(x11), .b(new_n63_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n60_), .O(new_n66_));
  nand2  g41(.a(x04), .b(new_n39_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n54_), .c(new_n67_), .O(z06));
  nand2  g43(.a(new_n62_), .b(new_n54_), .O(new_n69_));
