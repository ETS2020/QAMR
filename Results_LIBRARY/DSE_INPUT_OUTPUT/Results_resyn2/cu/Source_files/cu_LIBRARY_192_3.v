...
module FAU ( 
  ...
  nand3  g07(.a(new_n26_), .b(x04), .c(x02), .O(new_n33_));
  inv1   g08(.a(x04), .O(new_n34_));
  nor2   g09(.a(new_n26_), .b(x02), .O(new_n35_));
  nand3  g10(.a(new_n35_), .b(new_n27_), .c(new_n34_), .O(new_n36_));
  ...
  inv1   g20(.a(new_n36_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x01), .O(z03));
  nand4  g23(.a(new_n41_), .b(new_n40_), .c(x01), .d(new_n38_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n27_), .c(new_n26_), .O(z04));
  nor2   g25(.a(new_n47_), .b(new_n39_), .O(z05));
  inv1   g26(.a(new_n28_), .O(new_n52_));
  ...
  nand3  g42(.a(new_n45_), .b(new_n26_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nor2   g44(.a(new_n34_), .b(x03), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n52_), .O(z06));
  nor3   g47(.a(new_n36_), .b(x13), .c(x03), .O(z07));
  ...
  aoi21  g51(.a(new_n45_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand3  g52(.a(x06), .b(new_n26_), .c(new_n44_), .O(new_n78_));
