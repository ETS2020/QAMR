...
module FAU ( 
  ...
  nand3  g27(.a(new_n52_), .b(new_n50_), .c(new_n44_), .O(new_n53_));
  ...
  nor2   g33(.a(new_n37_), .b(x12), .O(new_n59_));
  inv1   g34(.a(x07), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x05), .c(new_n34_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n59_), .c(new_n58_), .d(new_n53_), .O(new_n63_));
  nor2   g38(.a(new_n35_), .b(x03), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  aoi21  g40(.a(new_n63_), .b(new_n48_), .c(new_n65_), .O(z06));
  nor2   g41(.a(new_n41_), .b(new_n29_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  aoi21  g43(.a(new_n64_), .b(new_n59_), .c(new_n29_), .O(new_n69_));
  nand3  g44(.a(new_n64_), .b(new_n37_), .c(new_n29_), .O(new_n70_));
  ...
  oai21  g50(.a(x05), .b(x02), .c(new_n75_), .O(z10));
endmodule
