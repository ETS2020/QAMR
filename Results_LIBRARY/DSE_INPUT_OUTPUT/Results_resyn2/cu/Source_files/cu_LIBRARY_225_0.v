...
module FAU ( 
  ...
  nand3  g32(.a(new_n57_), .b(x04), .c(new_n56_), .O(new_n58_));
  ...
  nand2  g39(.a(new_n34_), .b(new_n27_), .O(new_n65_));
  nand2  g40(.a(new_n55_), .b(new_n26_), .O(new_n66_));
  nand2  g41(.a(new_n27_), .b(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  aoi21  g43(.a(new_n66_), .b(new_n65_), .c(new_n68_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n67_), .O(z09));
  nand2  g46(.a(x06), .b(new_n56_), .O(new_n72_));
  nor2   g47(.a(new_n27_), .b(new_n26_), .O(new_n73_));
  aoi21  g48(.a(new_n72_), .b(new_n67_), .c(new_n73_), .O(z10));
endmodule
