...
module FAU ( 
  ...
  oai21  g02(.a(new_n27_), .b(x02), .c(x07), .O(new_n28_));
  ...
  nand2  g09(.a(x07), .b(new_n34_), .O(new_n35_));
  ...
  nand3  g26(.a(new_n38_), .b(new_n34_), .c(x02), .O(new_n52_));
  ...
  aoi21  g43(.a(new_n66_), .b(new_n52_), .c(new_n68_), .O(z06));
  nand2  g44(.a(new_n47_), .b(new_n35_), .O(z07));
  nand2  g45(.a(x04), .b(new_n37_), .O(new_n71_));
  inv1   g46(.a(new_n52_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n64_), .c(new_n71_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  aoi21  g50(.a(x07), .b(new_n34_), .c(new_n75_), .O(z09));
