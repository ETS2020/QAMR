...
module FAU ( 
  ...
  nand3  g14(.a(new_n31_), .b(new_n39_), .c(new_n26_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(new_n41_));
  nand3  g16(.a(new_n41_), .b(new_n38_), .c(new_n37_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x11), .c(new_n36_), .O(z02));
  nand2  g18(.a(new_n38_), .b(x00), .O(new_n44_));
  nand3  g19(.a(new_n41_), .b(x11), .c(x05), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n44_), .O(z03));
  nand2  g21(.a(x01), .b(new_n37_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n45_), .O(z04));
  nand3  g23(.a(new_n41_), .b(x01), .c(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x11), .c(new_n36_), .O(z05));
  nand3  g25(.a(new_n39_), .b(new_n36_), .c(x02), .O(new_n51_));
  inv1   g26(.a(x09), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n38_), .c(x00), .O(new_n53_));
  nand2  g28(.a(x10), .b(x01), .O(new_n54_));
  nand2  g29(.a(x08), .b(new_n38_), .O(new_n55_));
  nand3  g30(.a(new_n55_), .b(new_n54_), .c(new_n37_), .O(new_n56_));
  ...
  nand2  g35(.a(x11), .b(new_n60_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n51_), .c(new_n64_), .O(z06));
  aoi21  g40(.a(new_n40_), .b(x11), .c(new_n36_), .O(z07));
  aoi21  g41(.a(new_n59_), .b(new_n51_), .c(new_n64_), .O(new_n67_));
  nor2   g42(.a(x11), .b(new_n36_), .O(new_n68_));
  or2    g43(.a(new_n68_), .b(new_n67_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n68_), .O(z09));
  nand2  g46(.a(x05), .b(x02), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x06), .c(new_n26_), .O(new_n73_));
  oai21  g48(.a(x11), .b(new_n36_), .c(new_n73_), .O(z10));
endmodule
