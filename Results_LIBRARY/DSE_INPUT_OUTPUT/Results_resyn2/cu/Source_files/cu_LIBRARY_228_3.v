...
module FAU ( 
  ...
  nor2   g06(.a(new_n31_), .b(new_n29_), .O(z01));
  ...
  aoi21  g15(.a(new_n40_), .b(new_n30_), .c(new_n34_), .O(z02));
  nor3   g16(.a(new_n38_), .b(new_n34_), .c(x03), .O(z07));
  nor2   g17(.a(x01), .b(new_n35_), .O(new_n43_));
  and2   g18(.a(new_n43_), .b(z07), .O(z03));
  nand3  g19(.a(new_n39_), .b(x01), .c(new_n35_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n30_), .c(new_n34_), .O(z04));
  nand3  g21(.a(new_n39_), .b(x01), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n30_), .c(new_n34_), .O(z05));
  ...
  nand3  g38(.a(new_n28_), .b(new_n37_), .c(new_n30_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x04), .O(new_n66_));
  nor2   g41(.a(new_n34_), .b(new_n30_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n66_), .O(z06));
  nand2  g44(.a(new_n28_), .b(new_n37_), .O(new_n70_));
  nand2  g45(.a(x04), .b(new_n30_), .O(new_n71_));
  aoi21  g46(.a(new_n70_), .b(new_n61_), .c(new_n71_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n67_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n30_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n68_), .O(z10));
endmodule
