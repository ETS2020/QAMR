...
module FAU ( 
  ...
  nand2  g31(.a(new_n26_), .b(new_n40_), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n56_), .c(new_n41_), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n59_), .b(x08), .c(x07), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n66_), .c(new_n63_), .d(new_n58_), .O(new_n68_));
