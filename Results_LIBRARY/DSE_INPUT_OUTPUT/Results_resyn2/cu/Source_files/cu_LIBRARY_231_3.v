...
module FAU ( 
  ...
  nor3   g19(.a(new_n44_), .b(x01), .c(new_n37_), .O(z03));
  nor3   g20(.a(new_n44_), .b(new_n38_), .c(x00), .O(z04));
  nand3  g21(.a(new_n39_), .b(x01), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n35_), .c(new_n36_), .O(z05));
  ...
  inv1   g39(.a(new_n44_), .O(z07));
  nand3  g40(.a(x13), .b(new_n57_), .c(x05), .O(new_n66_));
  oai21  g41(.a(new_n63_), .b(x13), .c(new_n36_), .O(new_n67_));
  ...
  nand3  g46(.a(new_n26_), .b(x06), .c(new_n62_), .O(new_n72_));
