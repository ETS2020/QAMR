...
module FAU ( 
  ...
  nand3  g23(.a(new_n48_), .b(new_n35_), .c(x00), .O(new_n49_));
  ...
  nand2  g28(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  ...
  nand3  g34(.a(new_n59_), .b(new_n28_), .c(x02), .O(new_n60_));
  ...
  nand2  g40(.a(new_n41_), .b(new_n27_), .O(z07));
  and2   g41(.a(new_n60_), .b(new_n57_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n64_), .c(new_n27_), .O(z08));
  inv1   g43(.a(x06), .O(new_n69_));
  oai21  g44(.a(new_n59_), .b(new_n69_), .c(new_n27_), .O(z09));
  nor2   g45(.a(new_n26_), .b(new_n69_), .O(new_n71_));
  and2   g46(.a(new_n71_), .b(new_n31_), .O(z10));
endmodule
