...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n44_, new_n47_, new_n49_, new_n52_, new_n53_,
  ...
  aoi21  g19(.a(new_n44_), .b(new_n37_), .c(new_n33_), .O(z02));
  nor3   g20(.a(new_n42_), .b(x09), .c(new_n33_), .O(z07));
  nand2  g21(.a(z07), .b(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x01), .O(z03));
  nor2   g23(.a(new_n39_), .b(x00), .O(new_n49_));
  and2   g24(.a(new_n49_), .b(z07), .O(z04));
  nor2   g25(.a(new_n47_), .b(new_n39_), .O(z05));
  inv1   g26(.a(x10), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(x01), .c(new_n38_), .O(new_n53_));
  inv1   g28(.a(x11), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x00), .c(new_n39_), .O(new_n55_));
  ...
  nand3  g36(.a(new_n41_), .b(new_n33_), .c(x02), .O(new_n62_));
  ...
  nand3  g46(.a(new_n71_), .b(x06), .c(new_n40_), .O(new_n72_));
