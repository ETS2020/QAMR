...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n29_), .c(new_n34_), .O(new_n44_));
  nor4   g19(.a(new_n44_), .b(new_n27_), .c(new_n37_), .d(x00), .O(z04));
  nand3  g20(.a(new_n38_), .b(x01), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n34_), .c(new_n35_), .O(z05));
  inv1   g22(.a(x08), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n37_), .c(x00), .O(new_n49_));
  oai21  g24(.a(x10), .b(new_n37_), .c(new_n49_), .O(new_n50_));
  inv1   g25(.a(x11), .O(new_n51_));
  nand2  g26(.a(new_n51_), .b(x01), .O(new_n52_));
  inv1   g27(.a(x09), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n37_), .c(new_n36_), .O(new_n54_));
  ...
  nor2   g33(.a(x13), .b(new_n34_), .O(new_n59_));
  ...
  nor2   g37(.a(new_n38_), .b(x02), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n35_), .O(z07));
  inv1   g39(.a(new_n30_), .O(new_n65_));
  nand3  g40(.a(x13), .b(new_n56_), .c(x05), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nor2   g42(.a(new_n59_), .b(new_n67_), .O(new_n68_));
  nor3   g43(.a(new_n68_), .b(new_n61_), .c(new_n65_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  nor3   g45(.a(new_n65_), .b(new_n43_), .c(new_n70_), .O(z09));
