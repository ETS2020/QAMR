...
module FAU ( 
  ...
  nor2   g15(.a(new_n40_), .b(new_n38_), .O(z07));
  nand2  g16(.a(z07), .b(new_n35_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x01), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n39_), .b(new_n44_), .c(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n38_), .c(new_n27_), .O(z03));
  nor2   g21(.a(new_n42_), .b(new_n44_), .O(z04));
  nor4   g22(.a(new_n40_), .b(new_n38_), .c(new_n44_), .d(new_n35_), .O(z05));
  inv1   g23(.a(x07), .O(new_n49_));
  nand2  g24(.a(new_n26_), .b(x01), .O(new_n50_));
  ...
  nand4  g37(.a(new_n62_), .b(new_n58_), .c(new_n53_), .d(new_n49_), .O(new_n63_));
  nand3  g38(.a(new_n37_), .b(new_n28_), .c(x02), .O(new_n64_));
  ...
  nand2  g43(.a(new_n64_), .b(new_n61_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n66_), .O(new_n70_));
