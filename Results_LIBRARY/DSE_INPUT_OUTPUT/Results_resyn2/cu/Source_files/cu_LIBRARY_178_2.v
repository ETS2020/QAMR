...
module FAU ( 
  ...
  nand4  g12(.a(new_n30_), .b(x05), .c(new_n26_), .d(new_n37_), .O(new_n38_));
  inv1   g13(.a(x02), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(x01), .c(new_n33_), .O(new_n40_));
  oai21  g15(.a(new_n40_), .b(new_n38_), .c(new_n36_), .O(z04));
  nand3  g16(.a(new_n39_), .b(x01), .c(x00), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n38_), .c(new_n36_), .O(z05));
  inv1   g18(.a(x07), .O(new_n44_));
  nor2   g19(.a(new_n35_), .b(new_n26_), .O(new_n45_));
  ...
  nand3  g32(.a(new_n57_), .b(new_n55_), .c(new_n33_), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(new_n53_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(new_n47_), .O(z06));
  nand2  g35(.a(new_n36_), .b(new_n31_), .O(z07));
  nand3  g36(.a(new_n46_), .b(new_n45_), .c(new_n27_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n36_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  aoi21  g39(.a(new_n35_), .b(x02), .c(new_n64_), .O(z09));
  nand2  g40(.a(new_n27_), .b(x06), .O(new_n66_));
