...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n30_, new_n31_, new_n33_, new_n35_, new_n36_,
    new_n37_, new_n39_, new_n41_, new_n42_, new_n43_, new_n44_, new_n45_,
    new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    new_n53_, new_n54_, new_n55_, new_n58_, new_n60_, new_n62_;
  ...
  nand2  g11(.a(x01), .b(new_n33_), .O(new_n37_));
  oai21  g12(.a(new_n37_), .b(new_n31_), .c(new_n36_), .O(z04));
  inv1   g13(.a(x01), .O(new_n39_));
  nor3   g14(.a(new_n31_), .b(new_n39_), .c(new_n33_), .O(z05));
  inv1   g15(.a(x07), .O(new_n41_));
  nor2   g16(.a(new_n35_), .b(new_n26_), .O(new_n42_));
  nor2   g17(.a(new_n30_), .b(x12), .O(new_n43_));
  ...
  nand3  g28(.a(new_n53_), .b(new_n51_), .c(new_n33_), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(new_n49_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(new_n44_), .O(z06));
  nand2  g31(.a(new_n36_), .b(new_n31_), .O(z07));
  nand3  g32(.a(new_n43_), .b(new_n42_), .c(new_n27_), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(new_n36_), .O(z08));
  nand2  g34(.a(x13), .b(x06), .O(new_n60_));
  aoi21  g35(.a(new_n35_), .b(x02), .c(new_n60_), .O(z09));
  nand2  g36(.a(new_n27_), .b(x06), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n36_), .O(z10));
endmodule
