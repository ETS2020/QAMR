...
module FAU ( 
  ...
  nor2   g11(.a(x03), .b(x02), .O(new_n37_));
  ...
  nor3   g17(.a(new_n38_), .b(x01), .c(new_n42_), .O(z03));
  nand2  g18(.a(new_n39_), .b(x01), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z04));
  nor3   g20(.a(new_n38_), .b(new_n34_), .c(new_n42_), .O(z05));
  nand3  g21(.a(new_n36_), .b(new_n27_), .c(x02), .O(new_n47_));
  ...
  nor2   g29(.a(x12), .b(x07), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x13), .c(x05), .d(new_n54_), .O(new_n56_));
  aoi21  g31(.a(new_n53_), .b(new_n50_), .c(new_n56_), .O(new_n57_));
  nor2   g32(.a(new_n35_), .b(x03), .O(new_n58_));
  oai21  g33(.a(new_n57_), .b(new_n48_), .c(new_n58_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n26_), .O(z06));
  inv1   g35(.a(new_n38_), .O(z07));
  nor2   g36(.a(x12), .b(x10), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(x05), .d(new_n54_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n47_), .O(new_n64_));
  and2   g39(.a(new_n64_), .b(new_n58_), .O(z08));
  inv1   g40(.a(x10), .O(new_n66_));
  nand3  g41(.a(x13), .b(new_n66_), .c(x06), .O(new_n67_));
