...
module FAU ( 
  ...
  nand3  g13(.a(new_n38_), .b(new_n34_), .c(new_n33_), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n32_), .c(x01), .O(z02));
  nand3  g15(.a(new_n38_), .b(new_n34_), .c(x00), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n32_), .c(x01), .O(z03));
  nand2  g17(.a(new_n32_), .b(x01), .O(new_n43_));
  ...
  nand3  g26(.a(new_n51_), .b(new_n48_), .c(new_n33_), .O(new_n52_));
  ...
  nand4  g35(.a(new_n60_), .b(new_n57_), .c(new_n52_), .d(new_n46_), .O(new_n61_));
  nand3  g36(.a(new_n36_), .b(new_n26_), .c(x02), .O(new_n62_));
  nand2  g37(.a(x04), .b(new_n32_), .O(new_n63_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z06));
  nand3  g39(.a(new_n36_), .b(new_n35_), .c(new_n32_), .O(new_n65_));
  nor3   g40(.a(new_n65_), .b(new_n26_), .c(x02), .O(z07));
  and2   g41(.a(new_n62_), .b(new_n59_), .O(new_n67_));
  oai22  g42(.a(new_n67_), .b(new_n63_), .c(new_n32_), .d(x01), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  aoi21  g44(.a(x03), .b(new_n49_), .c(new_n69_), .O(z09));
