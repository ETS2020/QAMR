...
module FAU ( 
  ...
  nand3  g22(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n48_));
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(new_n57_), .d(new_n28_), .O(new_n59_));
  aoi21  g34(.a(new_n56_), .b(new_n54_), .c(new_n59_), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n52_), .c(new_n49_), .O(new_n61_));
  nand2  g36(.a(x04), .b(new_n26_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n46_), .O(z06));
  nand4  g38(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n64_));
  nand2  g39(.a(new_n49_), .b(x07), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(new_n62_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n46_), .O(z09));
  nand2  g43(.a(x07), .b(new_n31_), .O(new_n69_));
  nand2  g44(.a(x05), .b(new_n28_), .O(new_n70_));
