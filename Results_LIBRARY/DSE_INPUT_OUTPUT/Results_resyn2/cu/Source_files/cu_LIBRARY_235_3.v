...
module FAU ( 
  ...
  nand2  g09(.a(new_n27_), .b(new_n33_), .O(new_n35_));
  aoi22  g10(.a(new_n35_), .b(new_n26_), .c(new_n34_), .d(new_n32_), .O(z01));
  ...
  aoi21  g15(.a(new_n40_), .b(new_n26_), .c(new_n32_), .O(z02));
  nand3  g16(.a(new_n39_), .b(new_n38_), .c(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n26_), .c(new_n32_), .O(z03));
  inv1   g18(.a(x13), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n33_), .c(new_n26_), .O(new_n45_));
  nor4   g20(.a(new_n45_), .b(new_n28_), .c(new_n38_), .d(x00), .O(z04));
  nand3  g21(.a(new_n39_), .b(x01), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n26_), .c(new_n32_), .O(z05));
  ...
  nor2   g33(.a(x12), .b(new_n32_), .O(new_n59_));
  inv1   g34(.a(x07), .O(new_n60_));
  nand3  g35(.a(x13), .b(new_n60_), .c(new_n26_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n59_), .c(new_n58_), .d(new_n53_), .O(new_n63_));
  nand3  g38(.a(new_n44_), .b(new_n32_), .c(x02), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n63_), .c(new_n34_), .O(z06));
  nor2   g40(.a(new_n39_), .b(x02), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n32_), .O(z07));
  oai21  g42(.a(new_n34_), .b(x13), .c(new_n32_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x02), .O(new_n69_));
  nand4  g44(.a(new_n59_), .b(x13), .c(x04), .d(new_n33_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  oai21  g47(.a(new_n32_), .b(new_n26_), .c(new_n72_), .O(z09));
