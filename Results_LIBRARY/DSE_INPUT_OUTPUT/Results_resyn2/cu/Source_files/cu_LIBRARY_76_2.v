...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n31_, new_n32_, new_n33_, new_n35_,
    new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n43_, new_n45_,
  ...
  nand2  g09(.a(new_n27_), .b(x02), .O(new_n35_));
  ...
  oai21  g15(.a(new_n40_), .b(new_n37_), .c(new_n35_), .O(z03));
  nor2   g16(.a(new_n33_), .b(new_n38_), .O(z04));
  nand3  g17(.a(new_n39_), .b(x01), .c(x00), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n37_), .c(new_n35_), .O(z05));
  inv1   g19(.a(x07), .O(new_n45_));
  and2   g20(.a(x05), .b(x04), .O(new_n46_));
  nor2   g21(.a(new_n32_), .b(x12), .O(new_n47_));
  ...
  nand3  g32(.a(new_n57_), .b(new_n55_), .c(new_n31_), .O(new_n58_));
