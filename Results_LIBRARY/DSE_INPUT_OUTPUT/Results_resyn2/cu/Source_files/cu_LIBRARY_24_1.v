...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(new_n36_), .c(x05), .d(new_n28_), .O(new_n38_));
  inv1   g13(.a(x00), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  oai21  g16(.a(new_n41_), .b(new_n38_), .c(new_n35_), .O(z02));
  nor2   g17(.a(new_n38_), .b(new_n39_), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n40_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nand2  g20(.a(x01), .b(new_n39_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n38_), .c(new_n35_), .O(z04));
  nand2  g22(.a(new_n43_), .b(x01), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n35_), .O(z05));
  ...
  nand4  g37(.a(new_n62_), .b(new_n59_), .c(new_n54_), .d(new_n50_), .O(new_n63_));
  inv1   g38(.a(x05), .O(new_n64_));
  nand3  g39(.a(new_n36_), .b(new_n64_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nor2   g41(.a(new_n30_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n35_), .O(z06));
  inv1   g44(.a(new_n38_), .O(z07));
  inv1   g45(.a(new_n67_), .O(new_n71_));
  inv1   g46(.a(new_n65_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n26_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n61_), .c(new_n71_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n35_), .O(z09));
  inv1   g51(.a(x03), .O(new_n77_));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n77_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n35_), .O(z10));
endmodule
