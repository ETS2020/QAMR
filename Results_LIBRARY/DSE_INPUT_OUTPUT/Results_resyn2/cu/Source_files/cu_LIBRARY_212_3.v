...
module FAU ( 
  ...
  nand2  g15(.a(new_n35_), .b(new_n40_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n39_), .c(new_n38_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n27_), .c(new_n33_), .O(z02));
  nand3  g19(.a(new_n42_), .b(new_n39_), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n27_), .c(new_n33_), .O(z03));
  nand3  g21(.a(new_n42_), .b(x01), .c(new_n38_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n27_), .c(new_n33_), .O(z04));
  ...
  oai22  g46(.a(new_n71_), .b(x03), .c(new_n33_), .d(new_n27_), .O(z10));
endmodule
