...
module FAU ( 
  ...
  oai21  g02(.a(new_n27_), .b(x02), .c(x06), .O(new_n28_));
  inv1   g03(.a(x05), .O(new_n29_));
  nand2  g04(.a(new_n29_), .b(x02), .O(new_n30_));
  and2   g05(.a(new_n30_), .b(new_n27_), .O(new_n31_));
  inv1   g06(.a(x02), .O(new_n32_));
  inv1   g07(.a(x03), .O(new_n33_));
  oai21  g08(.a(x04), .b(new_n32_), .c(new_n33_), .O(new_n34_));
  nor2   g09(.a(new_n34_), .b(new_n31_), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n28_), .O(z00));
  nand2  g11(.a(x06), .b(new_n29_), .O(new_n37_));
  oai21  g12(.a(new_n34_), .b(new_n31_), .c(new_n37_), .O(z01));
  ...
  oai21  g19(.a(new_n44_), .b(new_n41_), .c(new_n37_), .O(z02));
  nor3   g20(.a(new_n41_), .b(x01), .c(new_n42_), .O(z03));
  nand2  g21(.a(x01), .b(new_n42_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n41_), .c(new_n37_), .O(z04));
  ...
  inv1   g44(.a(new_n41_), .O(z07));
  inv1   g45(.a(new_n67_), .O(new_n71_));
  inv1   g46(.a(x06), .O(new_n72_));
  inv1   g47(.a(new_n65_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n62_), .c(new_n71_), .O(z08));
  aoi21  g50(.a(new_n39_), .b(x05), .c(new_n72_), .O(z09));
  nand3  g51(.a(new_n40_), .b(x06), .c(x05), .O(new_n77_));
