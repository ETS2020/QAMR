...
module FAU ( 
  ...
  nand3  g25(.a(new_n36_), .b(new_n27_), .c(x02), .O(new_n51_));
  ...
  nand3  g36(.a(new_n61_), .b(new_n59_), .c(new_n46_), .O(new_n62_));
  inv1   g37(.a(x12), .O(new_n63_));
  nand4  g38(.a(x13), .b(new_n63_), .c(x05), .d(new_n38_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n62_), .c(new_n57_), .d(new_n52_), .O(new_n66_));
  nand3  g41(.a(new_n26_), .b(x04), .c(new_n34_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n51_), .c(new_n67_), .O(z06));
  nor2   g43(.a(new_n39_), .b(new_n37_), .O(z07));
  aoi21  g44(.a(new_n64_), .b(new_n51_), .c(new_n67_), .O(z08));
