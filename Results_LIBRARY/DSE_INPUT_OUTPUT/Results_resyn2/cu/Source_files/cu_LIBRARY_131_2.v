...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n38_, new_n39_, new_n40_, new_n43_, new_n45_,
  ...
  nand4  g09(.a(new_n34_), .b(new_n33_), .c(x05), .d(new_n26_), .O(new_n35_));
  ...
  oai21  g15(.a(new_n40_), .b(new_n35_), .c(new_n38_), .O(z03));
  nor3   g16(.a(new_n35_), .b(new_n39_), .c(x00), .O(z04));
  inv1   g17(.a(x00), .O(new_n43_));
  nor3   g18(.a(new_n35_), .b(new_n39_), .c(new_n43_), .O(z05));
  ...
  oai21  g35(.a(new_n60_), .b(new_n49_), .c(new_n38_), .O(z06));
  inv1   g36(.a(new_n35_), .O(z07));
  oai21  g37(.a(new_n47_), .b(new_n29_), .c(new_n38_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  aoi21  g39(.a(new_n37_), .b(x02), .c(new_n64_), .O(z09));
  nand2  g40(.a(new_n34_), .b(x06), .O(new_n66_));
