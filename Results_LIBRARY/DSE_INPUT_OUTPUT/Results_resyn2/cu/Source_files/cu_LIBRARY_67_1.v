...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n36_), .d(new_n28_), .O(new_n38_));
  ...
  nand3  g16(.a(new_n39_), .b(new_n35_), .c(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n30_), .c(x04), .O(z03));
  nand3  g18(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(new_n44_));
  nand4  g19(.a(new_n37_), .b(x05), .c(new_n36_), .d(x01), .O(new_n45_));
  nor3   g20(.a(new_n45_), .b(new_n44_), .c(x00), .O(z04));
  inv1   g21(.a(new_n45_), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n28_), .c(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n30_), .c(x04), .O(z05));
  ...
  nand2  g32(.a(new_n30_), .b(new_n35_), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n38_), .b(new_n30_), .c(x04), .O(z07));
  aoi21  g42(.a(new_n64_), .b(new_n61_), .c(new_n65_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  aoi21  g44(.a(x09), .b(new_n29_), .c(new_n69_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x06), .c(new_n36_), .O(new_n72_));
  oai21  g47(.a(new_n30_), .b(x04), .c(new_n72_), .O(z10));
endmodule
