...
module FAU ( 
  ...
  nand3  g37(.a(new_n38_), .b(new_n29_), .c(x02), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  aoi21  g39(.a(new_n62_), .b(new_n59_), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n36_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n28_), .O(z06));
  nor2   g42(.a(new_n49_), .b(new_n27_), .O(z07));
  and2   g43(.a(new_n63_), .b(new_n61_), .O(new_n69_));
  ...
  nand2  g48(.a(new_n73_), .b(new_n28_), .O(z10));
endmodule
