...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n44_, new_n46_, new_n47_, new_n51_, new_n52_, new_n53_,
  ...
  nor2   g23(.a(new_n44_), .b(new_n46_), .O(z04));
  nor3   g24(.a(new_n42_), .b(new_n46_), .c(new_n40_), .O(z05));
  ...
  nand2  g33(.a(new_n31_), .b(new_n46_), .O(new_n59_));
  ...
  nand3  g39(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n65_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n31_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n62_), .c(new_n70_), .O(z08));
  nand2  g48(.a(new_n38_), .b(x06), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(new_n41_), .O(z09));
  oai21  g50(.a(new_n30_), .b(new_n27_), .c(new_n26_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(new_n74_), .O(z10));
endmodule
