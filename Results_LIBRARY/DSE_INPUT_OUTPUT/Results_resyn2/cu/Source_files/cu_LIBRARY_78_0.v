...
module FAU ( 
  ...
  nor2   g34(.a(new_n48_), .b(x12), .O(new_n60_));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n49_), .c(new_n47_), .O(z06));
  and2   g40(.a(new_n40_), .b(new_n36_), .O(z07));
  aoi21  g41(.a(new_n60_), .b(new_n31_), .c(new_n39_), .O(new_n67_));
  nand3  g42(.a(new_n31_), .b(new_n48_), .c(new_n39_), .O(new_n68_));
  oai21  g43(.a(new_n67_), .b(x02), .c(new_n68_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  aoi21  g45(.a(new_n39_), .b(new_n26_), .c(new_n70_), .O(z09));
  nand2  g46(.a(new_n39_), .b(new_n26_), .O(new_n72_));
  nand2  g47(.a(x06), .b(new_n27_), .O(new_n73_));
  nor2   g48(.a(new_n39_), .b(new_n26_), .O(new_n74_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(z10));
endmodule
