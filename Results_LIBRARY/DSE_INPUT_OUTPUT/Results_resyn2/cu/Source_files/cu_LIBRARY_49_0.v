...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_,
    ...
    new_n53_, new_n54_, new_n55_, new_n56_, new_n58_, new_n61_, new_n63_;
  nor2   g00(.a(x04), .b(x02), .O(new_n26_));
  inv1   g01(.a(new_n26_), .O(new_n27_));
  aoi21  g02(.a(new_n27_), .b(x05), .c(x03), .O(z01));
  inv1   g03(.a(z01), .O(z00));
  inv1   g04(.a(x01), .O(new_n30_));
  nand2  g05(.a(new_n26_), .b(new_n30_), .O(new_n31_));
  inv1   g06(.a(x03), .O(new_n32_));
  inv1   g07(.a(x13), .O(new_n33_));
  nand3  g08(.a(new_n33_), .b(x05), .c(new_n32_), .O(new_n34_));
  nor3   g09(.a(new_n34_), .b(new_n31_), .c(x00), .O(z02));
  inv1   g10(.a(x00), .O(new_n36_));
  nor3   g11(.a(new_n34_), .b(new_n31_), .c(new_n36_), .O(z03));
  nor4   g12(.a(new_n34_), .b(new_n27_), .c(new_n30_), .d(x00), .O(z04));
  nand4  g13(.a(new_n26_), .b(new_n33_), .c(x01), .d(x00), .O(new_n39_));
  ...
  nand2  g19(.a(new_n44_), .b(new_n30_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n43_), .c(new_n36_), .O(new_n46_));
  inv1   g21(.a(x11), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(x01), .O(new_n48_));
  inv1   g23(.a(x09), .O(new_n49_));
  nand2  g24(.a(new_n49_), .b(new_n30_), .O(new_n50_));
  ...
  nand2  g32(.a(new_n26_), .b(new_n33_), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x05), .c(x03), .O(z07));
  aoi21  g34(.a(new_n54_), .b(x05), .c(x03), .O(z08));
  nand2  g35(.a(x13), .b(x06), .O(new_n61_));
  oai21  g36(.a(x05), .b(x03), .c(new_n61_), .O(z09));
