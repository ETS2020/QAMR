...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n71_, new_n73_, new_n75_, new_n76_;
  inv1   g00(.a(x03), .O(new_n26_));
  nand2  g01(.a(x04), .b(x02), .O(new_n27_));
  nor2   g02(.a(new_n27_), .b(x05), .O(new_n28_));
  inv1   g03(.a(x09), .O(new_n29_));
  ...
  oai21  g09(.a(new_n34_), .b(new_n28_), .c(new_n26_), .O(z00));
  oai21  g10(.a(new_n32_), .b(new_n28_), .c(new_n26_), .O(new_n36_));
  ...
  nand3  g17(.a(new_n30_), .b(new_n42_), .c(new_n26_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n41_), .c(new_n40_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n29_), .c(new_n39_), .O(z02));
  nand2  g21(.a(new_n42_), .b(new_n26_), .O(new_n47_));
  nand2  g22(.a(new_n41_), .b(x00), .O(new_n48_));
  nor3   g23(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z03));
  nand3  g24(.a(new_n44_), .b(x01), .c(new_n40_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n29_), .c(new_n39_), .O(z04));
  nand3  g26(.a(new_n44_), .b(x01), .c(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n29_), .c(new_n39_), .O(z05));
  inv1   g28(.a(x10), .O(new_n54_));
  nand3  g29(.a(new_n54_), .b(x01), .c(new_n40_), .O(new_n55_));
  inv1   g30(.a(x11), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x00), .c(new_n41_), .O(new_n57_));
