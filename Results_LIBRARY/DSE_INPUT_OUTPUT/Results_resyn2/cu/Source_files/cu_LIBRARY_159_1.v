...
module FAU ( 
  ...
  nor2   g15(.a(new_n36_), .b(new_n40_), .O(new_n41_));
  ...
  nand3  g21(.a(new_n26_), .b(new_n28_), .c(x02), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  inv1   g23(.a(x08), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n40_), .c(new_n38_), .O(new_n50_));
  ...
  nor2   g32(.a(new_n34_), .b(x03), .O(new_n58_));
  ...
  nor2   g38(.a(new_n28_), .b(x02), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x13), .c(new_n63_), .d(x10), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n47_), .c(new_n62_), .O(z08));
  nand3  g41(.a(x13), .b(x10), .c(x06), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z09));
  inv1   g43(.a(x06), .O(new_n69_));
  nor2   g44(.a(new_n27_), .b(new_n69_), .O(new_n70_));
  and2   g45(.a(new_n70_), .b(new_n31_), .O(z10));
endmodule
