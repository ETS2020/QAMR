...
module FAU ( 
  ...
  nand2  g12(.a(new_n35_), .b(new_n28_), .O(new_n38_));
  nand2  g13(.a(new_n34_), .b(x00), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(new_n38_), .c(new_n27_), .O(z03));
  nand4  g15(.a(new_n35_), .b(new_n28_), .c(x01), .d(new_n33_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n27_), .O(z04));
  nand2  g17(.a(x01), .b(x00), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n38_), .c(new_n27_), .O(z05));
  inv1   g19(.a(x07), .O(new_n45_));
  and2   g20(.a(x05), .b(x04), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x12), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n46_), .c(new_n29_), .d(new_n45_), .O(new_n49_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n56_), .c(new_n33_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n49_), .c(new_n27_), .O(z06));
  inv1   g36(.a(new_n38_), .O(z07));
  nand3  g37(.a(new_n48_), .b(new_n46_), .c(new_n29_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n27_), .O(z08));
  inv1   g39(.a(x06), .O(new_n65_));
  oai21  g40(.a(new_n47_), .b(new_n65_), .c(new_n27_), .O(z09));
  nand2  g41(.a(new_n29_), .b(x06), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n27_), .O(z10));
endmodule
