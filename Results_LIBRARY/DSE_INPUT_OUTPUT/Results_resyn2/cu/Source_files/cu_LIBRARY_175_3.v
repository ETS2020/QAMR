...
module FAU ( 
  ...
  nand3  g12(.a(new_n32_), .b(new_n31_), .c(new_n37_), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  inv1   g14(.a(x13), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(x05), .c(new_n34_), .d(new_n39_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n38_), .O(z02));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(x00), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n41_), .O(z03));
  nand4  g19(.a(new_n40_), .b(x05), .c(new_n34_), .d(x01), .O(new_n45_));
  ...
  nand3  g34(.a(x13), .b(new_n59_), .c(new_n31_), .O(new_n60_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n62_), .c(new_n33_), .O(z06));
  nand3  g39(.a(new_n40_), .b(new_n34_), .c(new_n32_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n31_), .c(new_n26_), .O(z07));
  oai21  g41(.a(new_n33_), .b(x13), .c(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(x02), .O(new_n68_));
  nand4  g43(.a(new_n58_), .b(x13), .c(x04), .d(new_n32_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  oai21  g46(.a(new_n26_), .b(new_n31_), .c(new_n71_), .O(z09));
