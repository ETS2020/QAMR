...
module FAU ( 
  ...
  nand3  g15(.a(new_n34_), .b(x01), .c(x00), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n31_), .O(z05));
  inv1   g17(.a(x07), .O(new_n43_));
  inv1   g18(.a(x04), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x02), .O(new_n45_));
  nor2   g20(.a(new_n34_), .b(x12), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n45_), .c(new_n30_), .d(new_n43_), .O(new_n47_));
  ...
  inv1   g40(.a(x02), .O(new_n66_));
  nand2  g41(.a(x06), .b(new_n66_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(x05), .c(x03), .O(z10));
endmodule
