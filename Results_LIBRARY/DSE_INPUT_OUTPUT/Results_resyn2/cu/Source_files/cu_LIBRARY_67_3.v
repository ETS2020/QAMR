...
module FAU ( 
  ...
  nor3   g20(.a(new_n45_), .b(new_n39_), .c(x00), .O(z04));
  nand2  g21(.a(x01), .b(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z05));
  inv1   g23(.a(x10), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(x01), .c(new_n38_), .O(new_n50_));
  inv1   g25(.a(x11), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x00), .c(new_n39_), .O(new_n52_));
  inv1   g27(.a(x08), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n50_), .O(new_n55_));
  ...
  nand3  g34(.a(new_n36_), .b(new_n29_), .c(x02), .O(new_n60_));
  nand3  g35(.a(new_n30_), .b(x04), .c(new_n35_), .O(new_n61_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(z06));
  nand2  g37(.a(new_n45_), .b(new_n34_), .O(z07));
  aoi21  g38(.a(new_n60_), .b(new_n57_), .c(new_n61_), .O(z08));
  nand2  g39(.a(x13), .b(x06), .O(new_n65_));
  aoi21  g40(.a(x09), .b(x04), .c(new_n65_), .O(z09));
  nand2  g41(.a(x05), .b(x02), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n35_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n34_), .O(z10));
endmodule
