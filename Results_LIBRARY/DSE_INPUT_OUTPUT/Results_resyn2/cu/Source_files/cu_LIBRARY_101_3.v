...
module FAU ( 
  ...
  nand2  g09(.a(new_n31_), .b(x05), .O(new_n35_));
  aoi21  g10(.a(new_n35_), .b(new_n30_), .c(x03), .O(z01));
  inv1   g11(.a(x13), .O(new_n37_));
  nand3  g12(.a(new_n37_), .b(x05), .c(new_n29_), .O(new_n38_));
  nor4   g13(.a(new_n38_), .b(new_n32_), .c(x01), .d(x00), .O(z02));
  inv1   g14(.a(x00), .O(new_n40_));
  nor4   g15(.a(new_n38_), .b(new_n32_), .c(x01), .d(new_n40_), .O(z03));
  nor2   g16(.a(new_n32_), .b(x13), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(x01), .c(new_n40_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n29_), .c(new_n27_), .O(z04));
  nand3  g19(.a(new_n42_), .b(x01), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n29_), .c(new_n27_), .O(z05));
  ...
  nand3  g27(.a(new_n52_), .b(new_n49_), .c(new_n40_), .O(new_n53_));
  ...
  nand4  g37(.a(new_n37_), .b(new_n27_), .c(new_n29_), .d(x02), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(x04), .O(new_n65_));
  nand2  g40(.a(x05), .b(x03), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  nor2   g42(.a(new_n42_), .b(x03), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n27_), .O(z07));
  nand2  g44(.a(new_n63_), .b(new_n60_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(x04), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n66_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n66_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n29_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n66_), .O(z10));
endmodule
