...
module FAU ( 
  ...
  nor3   g18(.a(new_n41_), .b(x01), .c(new_n43_), .O(z03));
  nand2  g19(.a(new_n40_), .b(new_n27_), .O(new_n45_));
  nand3  g20(.a(new_n36_), .b(new_n35_), .c(x01), .O(new_n46_));
  nor3   g21(.a(new_n46_), .b(new_n45_), .c(x00), .O(z04));
  nor3   g22(.a(new_n46_), .b(new_n45_), .c(new_n43_), .O(z05));
  ...
  nand2  g28(.a(new_n53_), .b(new_n26_), .O(new_n54_));
  ...
  nand3  g39(.a(new_n38_), .b(new_n30_), .c(x02), .O(new_n65_));
  ...
  nand2  g44(.a(new_n41_), .b(new_n49_), .O(z07));
  ...
  aoi21  g48(.a(new_n38_), .b(new_n26_), .c(new_n27_), .O(z09));
  inv1   g49(.a(new_n29_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n26_), .c(new_n27_), .O(z10));
endmodule
