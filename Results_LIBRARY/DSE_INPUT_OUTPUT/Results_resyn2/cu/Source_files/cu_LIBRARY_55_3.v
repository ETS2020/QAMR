...
module FAU ( 
  ...
  nand2  g19(.a(x05), .b(x01), .O(new_n45_));
  ...
  nand2  g32(.a(new_n48_), .b(new_n45_), .O(new_n59_));
  aoi21  g33(.a(new_n58_), .b(new_n53_), .c(new_n59_), .O(new_n60_));
  aoi21  g34(.a(new_n52_), .b(new_n45_), .c(new_n60_), .O(z06));
  aoi21  g35(.a(new_n41_), .b(new_n28_), .c(new_n40_), .O(z07));
  nand2  g36(.a(new_n52_), .b(new_n45_), .O(z08));
  nand2  g37(.a(x13), .b(x06), .O(new_n64_));
  nor2   g38(.a(new_n64_), .b(z04), .O(z09));
