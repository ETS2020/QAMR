...
module FAU ( 
  ...
  nor2   g15(.a(new_n27_), .b(x04), .O(new_n41_));
  ...
  aoi21  g20(.a(new_n45_), .b(x05), .c(x04), .O(z05));
  ...
  nand4  g33(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n57_), .c(new_n52_), .d(new_n47_), .O(new_n61_));
  or2    g36(.a(new_n28_), .b(x13), .O(new_n62_));
  inv1   g37(.a(x03), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n63_), .O(new_n64_));
  aoi21  g39(.a(new_n62_), .b(new_n61_), .c(new_n64_), .O(z06));
  inv1   g40(.a(new_n42_), .O(z07));
  aoi21  g41(.a(new_n62_), .b(new_n59_), .c(new_n64_), .O(z08));
  nand2  g42(.a(x13), .b(x06), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n33_), .O(z09));
  nand2  g44(.a(x05), .b(x02), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n33_), .c(x06), .d(new_n63_), .O(new_n71_));
