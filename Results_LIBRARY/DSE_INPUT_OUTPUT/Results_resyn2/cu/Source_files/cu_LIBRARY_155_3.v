...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n63_, new_n64_, new_n68_;
  inv1   g00(.a(x03), .O(new_n26_));
  inv1   g01(.a(x02), .O(new_n27_));
  inv1   g02(.a(x05), .O(new_n28_));
  nor2   g03(.a(new_n28_), .b(new_n27_), .O(new_n29_));
  nor2   g04(.a(new_n28_), .b(x04), .O(new_n30_));
  nand2  g05(.a(x04), .b(x02), .O(new_n31_));
  inv1   g06(.a(new_n31_), .O(new_n32_));
  oai22  g07(.a(new_n32_), .b(new_n30_), .c(new_n29_), .d(new_n26_), .O(z00));
  nor2   g08(.a(new_n32_), .b(new_n30_), .O(new_n34_));
  nor3   g09(.a(new_n34_), .b(new_n29_), .c(x03), .O(z01));
  ...
  nand3  g37(.a(new_n62_), .b(new_n28_), .c(x02), .O(new_n63_));
  nand2  g38(.a(x04), .b(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n63_), .b(new_n61_), .c(new_n64_), .O(z06));
  and2   g40(.a(new_n38_), .b(new_n30_), .O(z07));
  aoi21  g41(.a(new_n63_), .b(new_n59_), .c(new_n64_), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  nor3   g43(.a(new_n29_), .b(new_n62_), .c(new_n68_), .O(z09));
  oai22  g44(.a(new_n68_), .b(x03), .c(new_n28_), .d(new_n27_), .O(z10));
endmodule
