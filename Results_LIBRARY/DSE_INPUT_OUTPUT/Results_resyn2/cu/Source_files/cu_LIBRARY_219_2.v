...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_,
    ...
    new_n60_, new_n61_, new_n62_, new_n65_, new_n66_, new_n68_;
  ...
  nand3  g07(.a(new_n28_), .b(new_n27_), .c(new_n32_), .O(new_n33_));
  inv1   g08(.a(x00), .O(new_n34_));
  inv1   g09(.a(x01), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nor2   g11(.a(new_n36_), .b(new_n33_), .O(z02));
  nand2  g12(.a(new_n35_), .b(x00), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(new_n33_), .O(z03));
  nand2  g14(.a(new_n26_), .b(x02), .O(new_n40_));
  nor2   g15(.a(x13), .b(x03), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n27_), .O(new_n42_));
  inv1   g17(.a(x02), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(x01), .c(new_n34_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n40_), .O(z04));
  nand3  g20(.a(new_n43_), .b(x01), .c(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n42_), .c(new_n40_), .O(z05));
  inv1   g22(.a(x07), .O(new_n48_));
  and2   g23(.a(x05), .b(x04), .O(new_n49_));
  nor2   g24(.a(new_n32_), .b(x12), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n49_), .c(new_n28_), .d(new_n48_), .O(new_n51_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n58_), .c(new_n34_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  nor2   g37(.a(new_n62_), .b(new_n51_), .O(z06));
  nand2  g38(.a(new_n40_), .b(new_n33_), .O(z07));
  inv1   g39(.a(new_n28_), .O(new_n65_));
  nand2  g40(.a(new_n50_), .b(new_n49_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n65_), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  oai21  g43(.a(new_n32_), .b(new_n68_), .c(new_n40_), .O(z09));
  oai21  g44(.a(new_n65_), .b(new_n68_), .c(new_n40_), .O(z10));
endmodule
