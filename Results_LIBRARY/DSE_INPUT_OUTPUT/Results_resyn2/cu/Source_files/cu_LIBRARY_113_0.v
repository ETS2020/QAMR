...
module FAU ( 
  ...
  nor2   g00(.a(x12), .b(x06), .O(new_n26_));
  ...
  oai21  g16(.a(new_n41_), .b(new_n37_), .c(new_n33_), .O(z02));
  ...
  nand3  g22(.a(new_n33_), .b(x01), .c(new_n38_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n47_), .O(z04));
  nand2  g24(.a(new_n40_), .b(x01), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n45_), .c(new_n33_), .O(z05));
  ...
  nand3  g41(.a(new_n36_), .b(new_n27_), .c(x02), .O(new_n67_));
  ...
  nand2  g46(.a(new_n47_), .b(new_n33_), .O(z07));
