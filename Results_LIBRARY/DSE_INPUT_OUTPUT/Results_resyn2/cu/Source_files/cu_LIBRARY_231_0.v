...
module FAU ( 
  ...
  nor3   g18(.a(new_n42_), .b(new_n36_), .c(x00), .O(z04));
  ...
  nand4  g34(.a(x13), .b(new_n59_), .c(x04), .d(new_n40_), .O(new_n60_));
  ...
  nand2  g38(.a(new_n63_), .b(new_n47_), .O(new_n64_));
  nand4  g39(.a(new_n41_), .b(new_n27_), .c(x04), .d(new_n40_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(z06));
  inv1   g41(.a(new_n42_), .O(z07));
  oai21  g42(.a(new_n61_), .b(new_n27_), .c(new_n47_), .O(new_n68_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n32_), .c(x06), .d(new_n40_), .O(new_n73_));
