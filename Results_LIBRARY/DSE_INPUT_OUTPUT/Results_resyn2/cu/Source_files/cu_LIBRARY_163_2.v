...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    ...
    new_n60_, new_n62_, new_n63_, new_n66_, new_n68_;
  ...
  inv1   g36(.a(x05), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x02), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n34_), .O(z07));
  oai21  g39(.a(new_n47_), .b(new_n29_), .c(new_n63_), .O(z08));
  nand2  g40(.a(x13), .b(x06), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n63_), .O(z09));
