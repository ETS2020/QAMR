...
module FAU ( 
  ...
  nor3   g15(.a(new_n37_), .b(new_n27_), .c(x02), .O(z07));
  nor2   g16(.a(x01), .b(new_n34_), .O(new_n42_));
  and2   g17(.a(new_n42_), .b(z07), .O(z03));
  nand3  g18(.a(new_n38_), .b(x01), .c(new_n34_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(new_n27_), .O(z04));
  nand3  g20(.a(new_n38_), .b(x01), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n26_), .c(new_n27_), .O(z05));
  ...
  nand3  g39(.a(new_n48_), .b(x04), .c(new_n28_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z08));
  nand3  g41(.a(new_n48_), .b(x13), .c(x06), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z09));
  nand3  g43(.a(new_n48_), .b(x06), .c(new_n28_), .O(new_n69_));
