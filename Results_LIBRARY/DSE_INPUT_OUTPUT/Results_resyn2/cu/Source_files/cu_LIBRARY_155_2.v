...
module FAU ( 
  ...
  nand4  g04(.a(x05), .b(new_n29_), .c(new_n28_), .d(new_n26_), .O(new_n30_));
  inv1   g05(.a(new_n30_), .O(z01));
  nor2   g06(.a(z01), .b(new_n27_), .O(z00));
  inv1   g07(.a(x13), .O(new_n33_));
  nand3  g08(.a(x05), .b(new_n28_), .c(new_n26_), .O(new_n34_));
  inv1   g09(.a(new_n34_), .O(new_n35_));
  nand3  g10(.a(new_n35_), .b(new_n33_), .c(new_n29_), .O(new_n36_));
  ...
  nor2   g16(.a(new_n41_), .b(new_n36_), .O(z03));
  nand2  g17(.a(x01), .b(new_n37_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n36_), .O(z04));
  ...
  nand3  g25(.a(new_n50_), .b(new_n35_), .c(new_n47_), .O(new_n51_));
  ...
  nor2   g37(.a(new_n62_), .b(new_n51_), .O(z06));
  inv1   g38(.a(new_n36_), .O(z07));
  nor2   g39(.a(new_n49_), .b(new_n34_), .O(z08));
  nand2  g40(.a(x13), .b(x06), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n27_), .O(z09));
  nand3  g42(.a(x06), .b(new_n28_), .c(new_n26_), .O(new_n68_));
  oai21  g43(.a(x05), .b(new_n26_), .c(new_n68_), .O(z10));
endmodule
