...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n42_, new_n43_, new_n44_, new_n46_, new_n49_, new_n51_, new_n52_,
  ...
  aoi21  g11(.a(new_n34_), .b(new_n30_), .c(new_n36_), .O(z01));
  inv1   g12(.a(x00), .O(new_n38_));
  nand3  g13(.a(new_n26_), .b(new_n27_), .c(new_n38_), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  inv1   g15(.a(x13), .O(new_n41_));
  nand3  g16(.a(new_n41_), .b(x05), .c(new_n29_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n40_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n39_), .O(z02));
  nand3  g20(.a(new_n26_), .b(new_n27_), .c(x00), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n44_), .O(z03));
  nor3   g22(.a(new_n42_), .b(new_n39_), .c(new_n40_), .O(z04));
  nand4  g23(.a(new_n35_), .b(new_n41_), .c(x01), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n27_), .c(new_n30_), .O(z05));
  nand3  g25(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n51_));
  nor2   g26(.a(new_n30_), .b(x02), .O(new_n52_));
  ...
  nand4  g41(.a(new_n66_), .b(new_n62_), .c(new_n57_), .d(new_n52_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n51_), .c(new_n34_), .O(z06));
  nand2  g43(.a(new_n35_), .b(new_n41_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n27_), .c(new_n30_), .O(z07));
  aoi21  g45(.a(new_n33_), .b(new_n41_), .c(x05), .O(new_n71_));
  nand4  g46(.a(new_n33_), .b(x13), .c(new_n64_), .d(x05), .O(new_n72_));
  oai21  g47(.a(new_n71_), .b(new_n27_), .c(new_n72_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  aoi21  g49(.a(x05), .b(x02), .c(new_n74_), .O(z09));
  inv1   g50(.a(x06), .O(new_n76_));
  oai22  g51(.a(new_n76_), .b(x03), .c(new_n30_), .d(new_n27_), .O(z10));
endmodule
