...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(new_n36_), .c(x05), .d(new_n29_), .O(new_n38_));
  ...
  nand2  g17(.a(new_n37_), .b(new_n40_), .O(new_n43_));
  nand4  g18(.a(new_n36_), .b(x05), .c(new_n29_), .d(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n43_), .c(new_n27_), .O(z03));
  nand3  g20(.a(new_n28_), .b(new_n36_), .c(x05), .O(new_n46_));
  nor4   g21(.a(new_n46_), .b(x03), .c(new_n40_), .d(x00), .O(z04));
  nand4  g22(.a(new_n37_), .b(new_n36_), .c(new_n29_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x05), .c(new_n40_), .O(z05));
  nand2  g24(.a(new_n30_), .b(new_n36_), .O(new_n50_));
  ...
  nand3  g31(.a(new_n56_), .b(x05), .c(new_n40_), .O(new_n57_));
  ...
  nand4  g37(.a(x13), .b(new_n62_), .c(new_n61_), .d(new_n29_), .O(new_n63_));
  ...
  nand2  g44(.a(new_n38_), .b(new_n27_), .O(z07));
  inv1   g45(.a(new_n67_), .O(new_n71_));
  nand4  g46(.a(x13), .b(new_n62_), .c(x05), .d(new_n29_), .O(new_n72_));
  nand3  g47(.a(new_n30_), .b(new_n36_), .c(new_n40_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z08));
  ...
  nand4  g53(.a(new_n78_), .b(new_n27_), .c(x06), .d(new_n77_), .O(new_n79_));
