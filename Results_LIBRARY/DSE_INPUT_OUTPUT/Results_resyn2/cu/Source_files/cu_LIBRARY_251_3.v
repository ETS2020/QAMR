...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n41_), .c(x01), .d(new_n34_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z04));
  nand4  g19(.a(new_n42_), .b(new_n41_), .c(x01), .d(x00), .O(new_n45_));
  ...
  nor2   g33(.a(x12), .b(new_n33_), .O(new_n59_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n48_), .O(z06));
  and2   g41(.a(new_n42_), .b(new_n41_), .O(z07));
  oai21  g42(.a(new_n48_), .b(x13), .c(new_n33_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x02), .O(new_n69_));
  nand4  g44(.a(new_n59_), .b(x13), .c(x04), .d(new_n47_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  oai21  g47(.a(new_n33_), .b(new_n26_), .c(new_n72_), .O(z09));
