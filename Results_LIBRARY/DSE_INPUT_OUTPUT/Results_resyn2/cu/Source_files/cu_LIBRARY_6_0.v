...
module FAU ( 
  ...
  oai21  g16(.a(new_n41_), .b(new_n38_), .c(new_n28_), .O(z02));
  aoi21  g17(.a(new_n27_), .b(new_n26_), .c(new_n39_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n37_), .c(new_n36_), .d(new_n40_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nand2  g20(.a(x01), .b(new_n39_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n38_), .c(new_n28_), .O(z04));
  nand4  g22(.a(new_n43_), .b(new_n37_), .c(new_n36_), .d(x01), .O(new_n48_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n40_), .c(new_n39_), .O(new_n57_));
  ...
  nand2  g39(.a(x10), .b(new_n26_), .O(new_n65_));
  ...
  nand2  g43(.a(new_n38_), .b(new_n28_), .O(z07));
  and2   g44(.a(new_n64_), .b(new_n53_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n51_), .c(new_n28_), .O(z08));
