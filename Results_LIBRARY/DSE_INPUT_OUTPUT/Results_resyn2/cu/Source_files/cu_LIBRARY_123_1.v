...
module FAU ( 
  ...
  nand2  g10(.a(x05), .b(new_n26_), .O(new_n40_));
  inv1   g11(.a(new_n40_), .O(z07));
  nand2  g12(.a(x13), .b(x06), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(new_n40_), .O(z09));
  nand3  g14(.a(x06), .b(new_n27_), .c(new_n32_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(new_n40_), .O(z10));
  zero   g16(.O(z02));
  zero   g17(.O(z03));
  zero   g18(.O(z04));
  zero   g19(.O(z05));
