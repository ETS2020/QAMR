...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n45_, new_n48_, new_n49_, new_n50_, new_n52_,
  ...
  nor2   g19(.a(x01), .b(new_n37_), .O(new_n45_));
  nor3   g20(.a(new_n41_), .b(x10), .c(new_n31_), .O(z07));
  and2   g21(.a(z07), .b(new_n45_), .O(z03));
  ...
  nand2  g28(.a(new_n29_), .b(new_n40_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n38_), .c(x00), .O(new_n57_));
  ...
  nand4  g36(.a(new_n61_), .b(x13), .c(x05), .d(new_n28_), .O(new_n62_));
  aoi21  g37(.a(new_n60_), .b(new_n57_), .c(new_n62_), .O(new_n63_));
  nor2   g38(.a(new_n30_), .b(x03), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(new_n55_), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n26_), .O(z06));
  inv1   g41(.a(new_n64_), .O(new_n67_));
  nor2   g42(.a(x12), .b(x10), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x13), .c(x05), .d(new_n28_), .O(new_n69_));
