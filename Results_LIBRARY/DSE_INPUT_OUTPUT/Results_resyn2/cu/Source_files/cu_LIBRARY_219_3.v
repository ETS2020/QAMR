...
module FAU ( 
  ...
  and2   g04(.a(x04), .b(x02), .O(new_n30_));
  oai21  g05(.a(new_n30_), .b(new_n29_), .c(new_n27_), .O(z00));
  nor2   g06(.a(new_n30_), .b(new_n29_), .O(new_n32_));
  inv1   g07(.a(x03), .O(new_n33_));
  nand2  g08(.a(new_n26_), .b(new_n33_), .O(new_n34_));
  nor2   g09(.a(new_n34_), .b(new_n32_), .O(z01));
  inv1   g10(.a(x01), .O(new_n36_));
  inv1   g11(.a(x02), .O(new_n37_));
  nor2   g12(.a(x13), .b(x03), .O(new_n38_));
  nand4  g13(.a(new_n38_), .b(new_n29_), .c(new_n37_), .d(new_n36_), .O(new_n39_));
  ...
  aoi21  g19(.a(new_n44_), .b(new_n37_), .c(new_n28_), .O(z04));
  nand3  g20(.a(new_n43_), .b(x01), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n37_), .c(new_n28_), .O(z05));
  ...
  nand4  g34(.a(x13), .b(new_n59_), .c(x05), .d(new_n37_), .O(new_n60_));
  ...
  nand2  g39(.a(x04), .b(new_n33_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n62_), .c(new_n65_), .O(z06));
  nor2   g41(.a(new_n43_), .b(x02), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(new_n28_), .O(z07));
  aoi21  g43(.a(new_n64_), .b(new_n60_), .c(new_n65_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  oai21  g45(.a(new_n63_), .b(new_n70_), .c(new_n26_), .O(z09));
  oai21  g46(.a(new_n70_), .b(x03), .c(new_n26_), .O(z10));
endmodule
