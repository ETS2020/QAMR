...
module FAU ( 
  ...
  aoi21  g18(.a(new_n43_), .b(new_n36_), .c(new_n37_), .O(z03));
  inv1   g19(.a(x13), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n26_), .c(new_n36_), .O(new_n46_));
  nor3   g21(.a(new_n46_), .b(new_n30_), .c(new_n39_), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(new_n38_), .O(new_n48_));
  ...
  nor2   g41(.a(new_n46_), .b(new_n30_), .O(z07));
  nand3  g42(.a(x13), .b(new_n60_), .c(x05), .O(new_n68_));
  oai21  g43(.a(new_n65_), .b(x13), .c(new_n37_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x02), .O(new_n70_));
  oai21  g45(.a(new_n65_), .b(new_n68_), .c(new_n70_), .O(z08));
  inv1   g46(.a(x06), .O(new_n72_));
  oai21  g47(.a(new_n45_), .b(new_n72_), .c(new_n27_), .O(z09));
  oai21  g48(.a(new_n72_), .b(x03), .c(new_n27_), .O(z10));
endmodule
