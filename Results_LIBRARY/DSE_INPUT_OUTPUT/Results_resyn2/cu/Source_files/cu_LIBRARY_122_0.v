...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    ...
    new_n67_, new_n68_, new_n71_, new_n73_, new_n74_, new_n76_, new_n77_;
  ...
  nand3  g09(.a(new_n34_), .b(new_n26_), .c(new_n29_), .O(new_n35_));
  inv1   g10(.a(x00), .O(new_n36_));
  inv1   g11(.a(x01), .O(new_n37_));
  nand2  g12(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  or2    g13(.a(new_n38_), .b(new_n35_), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(x05), .c(x02), .O(z02));
  nor2   g15(.a(x03), .b(x02), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(new_n34_), .c(x05), .d(new_n26_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n36_), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n37_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nor3   g20(.a(new_n42_), .b(new_n37_), .c(x00), .O(z04));
  nand2  g21(.a(new_n43_), .b(x01), .O(new_n47_));
  ...
  nand4  g36(.a(x13), .b(new_n61_), .c(x04), .d(new_n29_), .O(new_n62_));
  ...
  nand2  g40(.a(new_n65_), .b(new_n49_), .O(new_n66_));
  inv1   g41(.a(x05), .O(new_n67_));
  nand4  g42(.a(new_n34_), .b(new_n67_), .c(x04), .d(new_n29_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n66_), .O(z06));
  aoi21  g44(.a(new_n35_), .b(x05), .c(x02), .O(z07));
  oai21  g45(.a(new_n63_), .b(new_n67_), .c(new_n49_), .O(new_n71_));
  ...
  aoi21  g51(.a(x06), .b(new_n29_), .c(new_n73_), .O(new_n77_));
