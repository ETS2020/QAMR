...
module FAU ( 
  ...
  nand4  g13(.a(new_n38_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n39_));
  ...
  nand3  g21(.a(new_n46_), .b(new_n28_), .c(x01), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x00), .O(z04));
  nor2   g23(.a(new_n47_), .b(new_n40_), .O(z05));
  inv1   g24(.a(x05), .O(new_n50_));
  nand3  g25(.a(new_n38_), .b(new_n50_), .c(x02), .O(new_n51_));
  ...
  nor2   g40(.a(new_n30_), .b(x03), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n26_), .O(new_n67_));
  aoi21  g42(.a(new_n65_), .b(new_n51_), .c(new_n67_), .O(z06));
  oai21  g43(.a(new_n39_), .b(x02), .c(new_n34_), .O(z07));
  nand2  g44(.a(x13), .b(new_n26_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n31_), .c(new_n51_), .O(new_n71_));
