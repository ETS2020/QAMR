...
module FAU ( 
  ...
  aoi22  g06(.a(new_n31_), .b(new_n29_), .c(new_n27_), .d(new_n26_), .O(z00));
  nand2  g07(.a(new_n27_), .b(new_n26_), .O(new_n33_));
  nand2  g08(.a(new_n31_), .b(new_n29_), .O(new_n34_));
  ...
  aoi21  g15(.a(new_n40_), .b(x05), .c(x01), .O(z02));
  nand4  g16(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x01), .O(z03));
  nand3  g18(.a(new_n39_), .b(new_n38_), .c(x05), .O(new_n44_));
  nand3  g19(.a(new_n37_), .b(x01), .c(new_n36_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n33_), .O(z04));
  nand3  g21(.a(new_n37_), .b(x01), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n44_), .c(new_n33_), .O(z05));
  inv1   g23(.a(x07), .O(new_n49_));
  inv1   g24(.a(x10), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(x01), .O(new_n51_));
  inv1   g26(.a(x08), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(new_n26_), .O(new_n53_));
  ...
  nand2  g32(.a(new_n57_), .b(new_n26_), .O(new_n58_));
  ...
  nand3  g38(.a(new_n38_), .b(new_n27_), .c(x02), .O(new_n64_));
  ...
  aoi21  g43(.a(new_n66_), .b(new_n63_), .c(new_n68_), .O(z06));
  nor2   g44(.a(new_n44_), .b(x02), .O(z07));
  nor2   g45(.a(new_n65_), .b(new_n62_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n68_), .c(new_n33_), .O(z08));
  nand2  g47(.a(new_n33_), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n38_), .O(z09));
  oai21  g49(.a(new_n27_), .b(new_n37_), .c(new_n67_), .O(new_n75_));
