...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n43_, new_n44_,
  ...
  inv1   g17(.a(new_n27_), .O(new_n43_));
  nand3  g18(.a(z07), .b(x01), .c(new_n34_), .O(new_n44_));
  nand2  g19(.a(new_n44_), .b(new_n43_), .O(z04));
  nand2  g20(.a(x01), .b(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n38_), .c(new_n43_), .O(z05));
  nand3  g22(.a(new_n26_), .b(new_n28_), .c(x02), .O(new_n48_));
  inv1   g23(.a(x09), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n35_), .c(x00), .O(new_n50_));
  nand2  g25(.a(x10), .b(x01), .O(new_n51_));
  nand2  g26(.a(x08), .b(new_n35_), .O(new_n52_));
  ...
  and2   g39(.a(new_n57_), .b(new_n48_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n63_), .c(new_n43_), .O(z08));
  inv1   g41(.a(x06), .O(new_n67_));
  aoi21  g42(.a(x11), .b(new_n67_), .c(new_n26_), .O(z09));
  nor2   g43(.a(new_n27_), .b(new_n67_), .O(new_n69_));
  and2   g44(.a(new_n69_), .b(new_n31_), .O(z10));
endmodule
