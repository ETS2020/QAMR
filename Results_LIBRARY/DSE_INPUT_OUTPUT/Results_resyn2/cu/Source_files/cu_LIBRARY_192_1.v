...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(x05), .c(new_n33_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n30_), .O(z07));
  nand2  g20(.a(z07), .b(new_n42_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(x01), .c(new_n41_), .O(z02));
  nand2  g22(.a(z07), .b(x00), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x01), .O(z03));
  inv1   g24(.a(x01), .O(new_n50_));
  oai21  g25(.a(new_n46_), .b(new_n50_), .c(new_n41_), .O(z04));
  nor2   g26(.a(new_n48_), .b(new_n50_), .O(z05));
  ...
  nand3  g32(.a(new_n57_), .b(new_n55_), .c(new_n42_), .O(new_n58_));
  ...
  nand3  g42(.a(new_n43_), .b(new_n31_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nor2   g44(.a(new_n29_), .b(x03), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n41_), .O(z06));
  nand2  g47(.a(new_n68_), .b(new_n65_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n41_), .O(z08));
  aoi21  g50(.a(new_n43_), .b(x05), .c(new_n26_), .O(z09));
  nand4  g51(.a(x06), .b(x05), .c(new_n33_), .d(new_n28_), .O(new_n77_));
