...
module FAU ( 
  ...
  oai21  g15(.a(new_n40_), .b(new_n37_), .c(new_n33_), .O(z03));
  nor3   g16(.a(new_n37_), .b(new_n39_), .c(x00), .O(z04));
  inv1   g17(.a(x00), .O(new_n43_));
  nor3   g18(.a(new_n37_), .b(new_n39_), .c(new_n43_), .O(z05));
  ...
  nand2  g36(.a(new_n37_), .b(new_n33_), .O(z07));
  oai21  g37(.a(new_n47_), .b(new_n29_), .c(new_n33_), .O(z08));
  nand2  g38(.a(x13), .b(x06), .O(new_n64_));
  aoi21  g39(.a(new_n32_), .b(x02), .c(new_n64_), .O(z09));
