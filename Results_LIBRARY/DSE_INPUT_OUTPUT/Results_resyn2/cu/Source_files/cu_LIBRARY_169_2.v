...
module FAU ( 
  ...
  oai21  g17(.a(new_n42_), .b(new_n38_), .c(new_n34_), .O(z02));
  nand2  g18(.a(new_n41_), .b(new_n40_), .O(new_n44_));
  inv1   g19(.a(new_n38_), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n34_), .O(z03));
  nand2  g22(.a(new_n45_), .b(new_n41_), .O(new_n48_));
  nand3  g23(.a(new_n34_), .b(x01), .c(new_n39_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n48_), .O(z04));
  nand2  g25(.a(new_n41_), .b(x01), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n46_), .c(new_n34_), .O(z05));
  oai21  g27(.a(x08), .b(x00), .c(x09), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(new_n40_), .O(new_n54_));
  nand2  g29(.a(x11), .b(x00), .O(new_n55_));
  nand2  g30(.a(x10), .b(new_n39_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n55_), .c(x01), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  nand4  g34(.a(x13), .b(new_n59_), .c(x05), .d(new_n41_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(x07), .O(new_n61_));
  nand3  g36(.a(new_n37_), .b(new_n28_), .c(x02), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  aoi21  g38(.a(new_n61_), .b(new_n58_), .c(new_n63_), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n35_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n34_), .O(z06));
  nand2  g41(.a(new_n48_), .b(new_n34_), .O(z07));
  and2   g42(.a(new_n62_), .b(new_n60_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n65_), .c(new_n34_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n27_), .O(z09));
  nand2  g46(.a(new_n31_), .b(x06), .O(new_n72_));
