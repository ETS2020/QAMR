...
module FAU ( 
  ...
  nand4  g14(.a(new_n39_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n40_));
  inv1   g15(.a(x00), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand3  g17(.a(new_n29_), .b(new_n42_), .c(new_n41_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n40_), .c(new_n38_), .O(z02));
  nand3  g19(.a(new_n29_), .b(new_n42_), .c(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n40_), .c(new_n38_), .O(z03));
  inv1   g21(.a(new_n31_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n39_), .c(new_n26_), .d(x01), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x00), .O(z04));
  oai21  g24(.a(new_n48_), .b(new_n41_), .c(new_n38_), .O(z05));
  ...
  nand2  g31(.a(new_n27_), .b(x01), .O(new_n57_));
