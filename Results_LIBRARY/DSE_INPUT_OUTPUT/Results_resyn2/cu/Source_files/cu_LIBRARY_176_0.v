...
module FAU ( 
  ...
  aoi21  g11(.a(new_n36_), .b(x05), .c(x00), .O(z02));
  ...
  nand4  g17(.a(new_n42_), .b(new_n34_), .c(new_n33_), .d(x00), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n41_), .c(new_n38_), .O(z03));
  nand3  g19(.a(new_n35_), .b(new_n34_), .c(x01), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x05), .c(x00), .O(z04));
  nand4  g21(.a(new_n42_), .b(new_n34_), .c(x01), .d(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n41_), .O(z05));
  nand3  g23(.a(new_n40_), .b(new_n27_), .c(x02), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand2  g25(.a(x11), .b(x01), .O(new_n51_));
  nand2  g26(.a(x09), .b(new_n33_), .O(new_n52_));
  and2   g27(.a(x05), .b(x00), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  inv1   g29(.a(x00), .O(new_n55_));
  nand2  g30(.a(x10), .b(x01), .O(new_n56_));
  nand2  g31(.a(x08), .b(new_n33_), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  nand4  g35(.a(x13), .b(new_n60_), .c(new_n59_), .d(new_n34_), .O(new_n61_));
  aoi21  g36(.a(new_n58_), .b(new_n54_), .c(new_n61_), .O(new_n62_));
  nor2   g37(.a(new_n39_), .b(x03), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(new_n50_), .c(new_n63_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n38_), .O(z06));
  nor3   g40(.a(new_n41_), .b(x03), .c(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n49_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n38_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n38_), .O(z09));
