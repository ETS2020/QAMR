...
module FAU ( 
  ...
  nand4  g09(.a(x08), .b(new_n27_), .c(x04), .d(x02), .O(new_n35_));
  ...
  nand2  g28(.a(new_n28_), .b(new_n38_), .O(new_n54_));
  ...
  oai21  g49(.a(new_n27_), .b(new_n29_), .c(new_n26_), .O(new_n75_));
