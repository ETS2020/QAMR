...
module FAU ( 
  ...
  nand2  g21(.a(new_n28_), .b(x01), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n43_), .O(z04));
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n27_), .O(z05));
  ...
  nand2  g39(.a(new_n30_), .b(new_n40_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g41(.a(new_n31_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n27_), .O(z06));
  inv1   g44(.a(new_n28_), .O(new_n70_));
  nor2   g45(.a(new_n41_), .b(new_n70_), .O(z07));
  ...
  nand3  g49(.a(x13), .b(x06), .c(x05), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  nand4  g51(.a(x06), .b(x05), .c(new_n39_), .d(new_n29_), .O(new_n77_));
