...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    ...
    new_n60_, new_n61_, new_n64_, new_n65_, new_n67_, new_n69_;
  ...
  nand4  g10(.a(new_n35_), .b(new_n30_), .c(new_n34_), .d(new_n33_), .O(new_n36_));
  inv1   g11(.a(new_n36_), .O(z02));
  inv1   g12(.a(new_n27_), .O(new_n38_));
  nand2  g13(.a(new_n35_), .b(new_n30_), .O(new_n39_));
  nand2  g14(.a(new_n34_), .b(x00), .O(new_n40_));
  oai21  g15(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(z03));
  nand4  g16(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n33_), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n38_), .O(z04));
  nand2  g18(.a(x01), .b(x00), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n39_), .c(new_n38_), .O(z05));
  inv1   g20(.a(x07), .O(new_n46_));
  and2   g21(.a(x05), .b(x04), .O(new_n47_));
  inv1   g22(.a(x13), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x12), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(new_n28_), .d(new_n46_), .O(new_n50_));
  ...
  nand3  g34(.a(new_n59_), .b(new_n57_), .c(new_n33_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n55_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n50_), .c(new_n38_), .O(z06));
  nand2  g37(.a(new_n39_), .b(new_n38_), .O(z07));
  inv1   g38(.a(new_n28_), .O(new_n64_));
  nand2  g39(.a(new_n49_), .b(new_n47_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n64_), .O(z08));
