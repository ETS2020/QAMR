...
module FAU ( 
  ...
  nand3  g29(.a(new_n44_), .b(new_n22_), .c(new_n25_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n21_), .O(z3));
  nand2  g31(.a(x3), .b(new_n25_), .O(new_n47_));
  aoi22  g32(.a(new_n47_), .b(new_n30_), .c(new_n19_), .d(x1), .O(new_n48_));
  nand2  g33(.a(new_n40_), .b(new_n19_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n30_), .O(new_n50_));
  oai21  g35(.a(new_n48_), .b(x0), .c(new_n50_), .O(z4));
  xnor2a g36(.a(x3), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n17_), .c(x5), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n32_), .c(new_n16_), .O(new_n54_));
  nand3  g39(.a(new_n19_), .b(x1), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(z5));
  nand2  g41(.a(new_n53_), .b(new_n16_), .O(new_n57_));
