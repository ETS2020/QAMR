...
module FAU ( 
  ...
  nand4  g17(.a(new_n32_), .b(new_n31_), .c(new_n23_), .d(new_n21_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n30_), .c(x0), .O(z2));
  oai21  g19(.a(x4), .b(x3), .c(x7), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n19_), .c(x1), .O(new_n36_));
  inv1   g21(.a(x5), .O(new_n37_));
  nand4  g22(.a(new_n37_), .b(new_n23_), .c(x2), .d(new_n21_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n16_), .O(new_n40_));
  nand2  g25(.a(new_n21_), .b(x0), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z3));
  nand2  g27(.a(x3), .b(x2), .O(new_n43_));
  and2   g28(.a(new_n20_), .b(new_n43_), .O(new_n44_));
  nor2   g29(.a(x3), .b(x2), .O(new_n45_));
  aoi21  g30(.a(x2), .b(new_n21_), .c(new_n45_), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n44_), .c(x0), .O(z4));
  nand3  g32(.a(new_n24_), .b(new_n20_), .c(new_n43_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n16_), .O(new_n49_));
  nand2  g34(.a(new_n32_), .b(new_n16_), .O(new_n50_));
  ...
  aoi21  g39(.a(new_n54_), .b(new_n38_), .c(x0), .O(z6));
endmodule
