...
module FAU ( 
  ...
  nand3  g48(.a(new_n63_), .b(new_n31_), .c(new_n18_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n56_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  inv1   g51(.a(new_n29_), .O(new_n67_));
  oai21  g52(.a(new_n59_), .b(new_n67_), .c(new_n18_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n24_), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n19_), .c(new_n16_), .O(new_n70_));
