...
module FAU ( 
  ...
  nand4  g23(.a(new_n38_), .b(new_n27_), .c(x2), .d(new_n22_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n16_), .O(new_n41_));
  nand2  g26(.a(new_n22_), .b(x0), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n41_), .O(z3));
  aoi21  g28(.a(x3), .b(x1), .c(new_n20_), .O(new_n44_));
  aoi21  g29(.a(new_n19_), .b(x1), .c(new_n31_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x0), .O(z4));
  oai21  g31(.a(new_n38_), .b(x1), .c(new_n27_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x2), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n25_), .c(x0), .O(z5));
  nor2   g34(.a(x4), .b(x2), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x3), .c(x1), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n39_), .c(x0), .O(z6));
endmodule
