...
module FAU ( 
  ...
  nor2   g18(.a(x5), .b(new_n17_), .O(new_n34_));
  ...
  oai21  g31(.a(new_n46_), .b(new_n19_), .c(new_n16_), .O(new_n47_));
  aoi21  g32(.a(new_n45_), .b(new_n19_), .c(new_n47_), .O(z5));
  nand2  g33(.a(new_n25_), .b(new_n16_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n19_), .O(new_n50_));
  nand2  g35(.a(new_n46_), .b(new_n20_), .O(new_n51_));
