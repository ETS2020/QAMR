...
module FAU ( 
  ...
  nand3  g24(.a(new_n39_), .b(new_n38_), .c(x1), .O(new_n40_));
  inv1   g25(.a(x0), .O(new_n41_));
  nand2  g26(.a(x5), .b(new_n41_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n17_), .c(x2), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n40_), .O(z3));
  aoi21  g29(.a(x3), .b(new_n41_), .c(new_n17_), .O(new_n45_));
  oai21  g30(.a(new_n23_), .b(x1), .c(new_n39_), .O(new_n46_));
  oai21  g31(.a(new_n45_), .b(new_n16_), .c(new_n46_), .O(z4));
  nand3  g32(.a(x6), .b(new_n23_), .c(new_n16_), .O(new_n48_));
  oai21  g33(.a(new_n23_), .b(x0), .c(x2), .O(new_n49_));
  ...
  nand4  g37(.a(new_n52_), .b(new_n50_), .c(new_n48_), .d(new_n18_), .O(z5));
  nand2  g38(.a(x4), .b(new_n23_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n49_), .c(x1), .O(new_n55_));
  nand4  g40(.a(new_n24_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n18_), .O(z6));
endmodule
