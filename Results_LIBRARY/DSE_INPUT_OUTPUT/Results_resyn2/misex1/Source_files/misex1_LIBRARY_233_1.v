...
module FAU ( 
  ...
  nand2  g29(.a(new_n25_), .b(new_n21_), .O(new_n45_));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n31_), .c(x1), .O(new_n47_));
  oai21  g32(.a(new_n45_), .b(new_n44_), .c(new_n47_), .O(z3));
  nand2  g33(.a(new_n19_), .b(x2), .O(new_n49_));
  nand3  g34(.a(x3), .b(new_n21_), .c(new_n20_), .O(new_n50_));
  oai21  g35(.a(new_n16_), .b(x1), .c(x0), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n50_), .c(new_n26_), .O(new_n52_));
  nand2  g37(.a(x5), .b(new_n21_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n52_), .c(new_n49_), .O(z4));
  nor2   g39(.a(new_n21_), .b(x0), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n44_), .O(new_n56_));
  xnor2a g41(.a(x3), .b(x2), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  aoi21  g43(.a(new_n32_), .b(new_n26_), .c(x0), .O(new_n59_));
  nor2   g44(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nor2   g45(.a(x1), .b(new_n20_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n57_), .c(new_n25_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n56_), .O(z5));
  oai21  g48(.a(x4), .b(x2), .c(new_n16_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n55_), .O(new_n65_));
  inv1   g50(.a(new_n44_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n41_), .c(new_n21_), .O(new_n67_));
