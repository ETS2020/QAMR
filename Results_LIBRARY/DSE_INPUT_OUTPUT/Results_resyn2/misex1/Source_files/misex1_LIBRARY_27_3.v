...
module FAU ( 
  ...
  nand2  g31(.a(new_n43_), .b(new_n21_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(x0), .c(new_n46_), .O(new_n48_));
  oai21  g33(.a(x2), .b(new_n24_), .c(x1), .O(new_n49_));
  oai21  g34(.a(new_n18_), .b(x2), .c(new_n24_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(z4));
  nand2  g36(.a(new_n47_), .b(x0), .O(new_n52_));
  nand2  g37(.a(new_n27_), .b(new_n17_), .O(new_n53_));
  nand3  g38(.a(new_n45_), .b(new_n53_), .c(new_n24_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n49_), .c(new_n52_), .O(z5));
  aoi21  g40(.a(x4), .b(new_n18_), .c(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x2), .c(x1), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n48_), .O(z6));
endmodule
