...
module FAU ( 
  ...
  aoi21  g11(.a(new_n26_), .b(new_n25_), .c(new_n21_), .O(new_n27_));
  ...
  aoi21  g44(.a(new_n51_), .b(new_n30_), .c(new_n21_), .O(new_n60_));
  ...
  aoi21  g50(.a(new_n65_), .b(new_n63_), .c(new_n21_), .O(z6));
endmodule
