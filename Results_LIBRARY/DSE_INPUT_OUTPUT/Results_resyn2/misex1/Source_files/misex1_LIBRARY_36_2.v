...
module FAU ( 
  ...
  oai21  g32(.a(new_n43_), .b(new_n31_), .c(new_n17_), .O(new_n48_));
  aoi21  g33(.a(x3), .b(new_n17_), .c(x2), .O(new_n49_));
  nand3  g34(.a(x5), .b(x3), .c(x2), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n49_), .c(new_n22_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n48_), .O(z4));
  aoi21  g38(.a(new_n27_), .b(new_n16_), .c(new_n51_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x0), .c(new_n48_), .O(z5));
  nor2   g40(.a(x3), .b(new_n16_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n39_), .c(new_n23_), .O(new_n57_));
  oai21  g42(.a(x4), .b(x2), .c(new_n20_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n18_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n57_), .c(new_n33_), .O(z6));
endmodule
