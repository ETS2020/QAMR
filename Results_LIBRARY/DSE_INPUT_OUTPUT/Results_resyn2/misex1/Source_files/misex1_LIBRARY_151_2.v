...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_,
    ...
    new_n56_, new_n57_, new_n58_, new_n59_, new_n61_;
  ...
  aoi21  g29(.a(x5), .b(new_n16_), .c(new_n44_), .O(z3));
  nand2  g30(.a(x3), .b(x2), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n19_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nor2   g33(.a(x3), .b(new_n22_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n41_), .c(new_n26_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(z4));
  xor2a  g36(.a(x3), .b(x2), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x0), .O(new_n53_));
  nand3  g38(.a(x5), .b(x2), .c(new_n16_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n26_), .O(new_n56_));
  nand2  g41(.a(new_n46_), .b(new_n24_), .O(new_n57_));
  nor2   g42(.a(x2), .b(new_n26_), .O(new_n58_));
  aoi21  g43(.a(new_n57_), .b(new_n16_), .c(new_n58_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z5));
  aoi22  g45(.a(new_n52_), .b(x0), .c(new_n25_), .d(x2), .O(new_n61_));
  oai22  g46(.a(new_n61_), .b(x1), .c(new_n46_), .d(new_n17_), .O(z6));
endmodule
