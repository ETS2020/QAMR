...
module FAU ( 
  ...
  aoi21  g21(.a(x4), .b(new_n33_), .c(x3), .O(new_n37_));
  inv1   g22(.a(x5), .O(new_n38_));
  nand4  g23(.a(new_n38_), .b(new_n19_), .c(x2), .d(new_n20_), .O(new_n39_));
  oai21  g24(.a(new_n37_), .b(new_n20_), .c(new_n39_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n23_), .c(new_n36_), .O(new_n41_));
  nor2   g26(.a(x6), .b(x3), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n30_), .c(new_n16_), .d(new_n23_), .O(new_n43_));
  oai21  g28(.a(new_n41_), .b(new_n17_), .c(new_n43_), .O(z2));
  oai21  g29(.a(x4), .b(x3), .c(x7), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n21_), .c(new_n33_), .O(new_n46_));
  nor2   g31(.a(x3), .b(new_n33_), .O(new_n47_));
  nand2  g32(.a(x5), .b(new_n23_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n47_), .c(new_n20_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n46_), .c(new_n18_), .O(z3));
  nor2   g35(.a(new_n47_), .b(x0), .O(new_n51_));
  inv1   g36(.a(new_n51_), .O(new_n52_));
  xnor2a g37(.a(x3), .b(x2), .O(new_n53_));
  or2    g38(.a(new_n53_), .b(x1), .O(new_n54_));
  ...
  nor2   g42(.a(new_n53_), .b(new_n23_), .O(new_n58_));
  ...
  nand2  g46(.a(new_n51_), .b(new_n31_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n61_), .c(new_n18_), .O(z5));
  oai21  g48(.a(x4), .b(x2), .c(new_n19_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n21_), .O(new_n65_));
  nand3  g50(.a(new_n38_), .b(new_n19_), .c(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n58_), .c(new_n20_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n65_), .c(new_n17_), .O(z6));
endmodule
