...
module FAU ( 
  ...
  nand4  g19(.a(new_n34_), .b(new_n33_), .c(new_n19_), .d(new_n16_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n32_), .c(x0), .O(z2));
  inv1   g21(.a(x7), .O(new_n37_));
  aoi21  g22(.a(new_n30_), .b(new_n19_), .c(new_n37_), .O(new_n38_));
  nand2  g23(.a(new_n17_), .b(new_n18_), .O(new_n39_));
  inv1   g24(.a(x0), .O(new_n40_));
  nand3  g25(.a(new_n26_), .b(new_n19_), .c(x2), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n16_), .O(new_n43_));
  oai21  g28(.a(new_n39_), .b(new_n38_), .c(new_n43_), .O(z3));
  oai21  g29(.a(new_n19_), .b(x0), .c(new_n16_), .O(new_n45_));
  nand2  g30(.a(new_n20_), .b(new_n40_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n39_), .O(z4));
  aoi21  g32(.a(new_n24_), .b(new_n18_), .c(new_n20_), .O(new_n48_));
  nand2  g33(.a(new_n34_), .b(new_n40_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n16_), .O(new_n50_));
  oai21  g35(.a(new_n48_), .b(x0), .c(new_n50_), .O(z5));
  oai21  g36(.a(x4), .b(x2), .c(new_n19_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n43_), .O(z6));
endmodule
