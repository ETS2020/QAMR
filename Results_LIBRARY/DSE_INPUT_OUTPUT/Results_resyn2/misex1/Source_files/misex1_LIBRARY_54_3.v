...
module FAU ( 
  ...
  nand3  g27(.a(new_n42_), .b(new_n41_), .c(new_n34_), .O(z2));
  nand2  g28(.a(x5), .b(new_n23_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n20_), .c(x4), .O(new_n45_));
  ...
  aoi21  g37(.a(new_n24_), .b(x2), .c(x0), .O(new_n53_));
  oai22  g38(.a(new_n53_), .b(x4), .c(new_n52_), .d(x2), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(z4));
  nand4  g40(.a(x5), .b(new_n28_), .c(x2), .d(new_n23_), .O(new_n56_));
  ...
  nand3  g46(.a(new_n28_), .b(x3), .c(x2), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n26_), .c(new_n23_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n61_), .O(z5));
  nor2   g50(.a(new_n27_), .b(x0), .O(new_n66_));
  oai21  g51(.a(new_n49_), .b(new_n66_), .c(new_n32_), .O(new_n67_));
  ...
  nand3  g55(.a(new_n70_), .b(new_n68_), .c(new_n42_), .O(z6));
endmodule
