...
module FAU ( 
  ...
  nor2   g14(.a(new_n16_), .b(new_n24_), .O(new_n30_));
  inv1   g15(.a(x6), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(x3), .c(new_n17_), .O(new_n32_));
  nor2   g17(.a(x2), .b(x0), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n32_), .c(new_n30_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n29_), .O(z1));
  nand2  g20(.a(x4), .b(new_n24_), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n20_), .c(new_n17_), .O(new_n37_));
  nor2   g22(.a(x3), .b(x1), .O(new_n38_));
  nand2  g23(.a(x6), .b(new_n24_), .O(new_n39_));
  ...
  nor2   g28(.a(x1), .b(new_n19_), .O(new_n44_));
  nand2  g29(.a(x3), .b(new_n24_), .O(new_n45_));
  inv1   g30(.a(new_n45_), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n44_), .c(new_n30_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n43_), .O(z2));
  nand2  g33(.a(x5), .b(new_n19_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n38_), .c(x7), .O(new_n50_));
  oai21  g35(.a(x4), .b(x3), .c(x7), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n33_), .c(x1), .O(new_n52_));
  oai21  g37(.a(new_n50_), .b(new_n24_), .c(new_n52_), .O(z3));
  ...
  nand2  g41(.a(new_n16_), .b(x3), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(x2), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n45_), .b(x1), .c(new_n58_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z4));
  aoi21  g45(.a(new_n54_), .b(new_n45_), .c(new_n19_), .O(new_n61_));
  nand4  g46(.a(new_n16_), .b(x5), .c(x2), .d(new_n19_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n17_), .O(new_n64_));
  oai21  g49(.a(new_n32_), .b(x2), .c(new_n58_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n64_), .O(z5));
  nand3  g51(.a(new_n26_), .b(new_n16_), .c(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n61_), .c(new_n17_), .O(new_n69_));
  nand2  g54(.a(new_n57_), .b(x2), .O(new_n70_));
  nand2  g55(.a(x4), .b(new_n20_), .O(new_n71_));
  nand4  g56(.a(new_n71_), .b(new_n70_), .c(x1), .d(new_n19_), .O(new_n72_));
