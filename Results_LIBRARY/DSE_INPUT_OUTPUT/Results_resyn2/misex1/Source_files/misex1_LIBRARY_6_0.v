...
module FAU ( 
  ...
  nand2  g14(.a(x2), .b(new_n17_), .O(new_n30_));
  aoi21  g15(.a(new_n24_), .b(new_n16_), .c(new_n30_), .O(new_n31_));
  ...
  oai21  g22(.a(new_n18_), .b(x2), .c(new_n21_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n25_), .c(x3), .O(new_n39_));
  inv1   g24(.a(x2), .O(new_n40_));
  nand3  g25(.a(x4), .b(new_n40_), .c(x1), .O(new_n41_));
  nor2   g26(.a(x3), .b(x1), .O(new_n42_));
  nand2  g27(.a(x6), .b(new_n40_), .O(new_n43_));
  nand2  g28(.a(x5), .b(x2), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n43_), .c(new_n42_), .d(new_n25_), .O(new_n45_));
  ...
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n40_), .O(new_n51_));
  nand2  g36(.a(new_n16_), .b(x2), .O(new_n52_));
  aoi21  g37(.a(x5), .b(new_n20_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n17_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n51_), .c(new_n25_), .O(z3));
  nand3  g40(.a(x3), .b(new_n40_), .c(x0), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n35_), .b(new_n17_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n52_), .c(new_n20_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n58_), .c(new_n25_), .O(z4));
  oai21  g46(.a(x5), .b(x4), .c(x3), .O(new_n62_));
  nand2  g47(.a(x5), .b(new_n17_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n62_), .c(new_n40_), .O(new_n64_));
  aoi21  g49(.a(new_n29_), .b(new_n25_), .c(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n23_), .b(new_n20_), .c(new_n24_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n57_), .c(new_n17_), .O(new_n67_));
  oai21  g52(.a(new_n65_), .b(x0), .c(new_n67_), .O(z5));
  nor2   g53(.a(new_n56_), .b(new_n34_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n53_), .c(new_n17_), .O(new_n70_));
  oai21  g55(.a(x4), .b(x2), .c(new_n16_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n49_), .c(new_n34_), .O(new_n72_));
