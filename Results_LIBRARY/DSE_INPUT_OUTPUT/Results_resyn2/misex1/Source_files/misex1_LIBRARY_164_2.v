...
module FAU ( 
  ...
  nand3  g10(.a(x5), .b(x2), .c(new_n25_), .O(new_n26_));
  ...
  nand3  g15(.a(new_n30_), .b(new_n16_), .c(new_n25_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n28_), .O(z1));
  oai21  g17(.a(x4), .b(x3), .c(x1), .O(new_n33_));
  inv1   g18(.a(x3), .O(new_n34_));
  nand3  g19(.a(new_n29_), .b(new_n34_), .c(new_n17_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n33_), .c(x0), .O(new_n36_));
  nand3  g21(.a(x3), .b(new_n17_), .c(x0), .O(new_n37_));
  ...
  nand3  g32(.a(x5), .b(new_n34_), .c(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n24_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n17_), .O(new_n50_));
  nor2   g35(.a(new_n34_), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(new_n52_));
  nand2  g37(.a(x5), .b(x3), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(x2), .c(x0), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n50_), .O(z4));
  oai21  g41(.a(new_n30_), .b(x2), .c(new_n54_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n50_), .O(z5));
  oai21  g43(.a(new_n43_), .b(new_n51_), .c(new_n42_), .O(new_n59_));
  nand2  g44(.a(new_n20_), .b(x2), .O(new_n60_));
  oai21  g45(.a(x4), .b(x2), .c(new_n34_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n18_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z6));
endmodule
