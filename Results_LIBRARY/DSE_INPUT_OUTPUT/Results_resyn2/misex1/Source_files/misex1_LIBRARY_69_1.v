...
module FAU ( 
  ...
  nand3  g17(.a(new_n25_), .b(new_n18_), .c(x2), .O(new_n33_));
  oai21  g18(.a(x4), .b(x3), .c(x7), .O(new_n34_));
  nand4  g19(.a(new_n34_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n33_), .O(z3));
  nand2  g21(.a(x3), .b(new_n16_), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(x1), .c(new_n21_), .O(new_n38_));
  nand3  g23(.a(new_n25_), .b(x3), .c(new_n16_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n38_), .c(new_n33_), .O(z4));
  nand2  g25(.a(new_n18_), .b(x2), .O(new_n41_));
  oai21  g26(.a(new_n37_), .b(new_n21_), .c(new_n41_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n17_), .O(new_n43_));
  oai21  g28(.a(new_n23_), .b(x2), .c(new_n21_), .O(new_n44_));
