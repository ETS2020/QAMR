...
module FAU ( 
  ...
  nor2   g26(.a(x3), .b(new_n27_), .O(new_n42_));
  nand2  g27(.a(x5), .b(new_n17_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n42_), .c(new_n26_), .O(new_n44_));
  inv1   g29(.a(new_n18_), .O(new_n45_));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n27_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n44_), .c(new_n16_), .O(z3));
  nor2   g33(.a(new_n42_), .b(x0), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  xnor2a g35(.a(x3), .b(x2), .O(new_n51_));
  or2    g36(.a(new_n51_), .b(x1), .O(new_n52_));
  nand4  g37(.a(x3), .b(new_n27_), .c(new_n26_), .d(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n16_), .O(new_n54_));
  aoi21  g39(.a(new_n52_), .b(new_n50_), .c(new_n54_), .O(z4));
  oai22  g40(.a(new_n51_), .b(new_n17_), .c(new_n43_), .d(new_n27_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n26_), .O(new_n57_));
  nand2  g42(.a(new_n49_), .b(new_n29_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n57_), .c(new_n16_), .O(z5));
  inv1   g44(.a(new_n16_), .O(new_n60_));
  oai21  g45(.a(x4), .b(x2), .c(new_n20_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n45_), .O(new_n62_));
  oai21  g47(.a(new_n51_), .b(new_n17_), .c(new_n25_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n26_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n62_), .c(new_n60_), .O(z6));
endmodule
