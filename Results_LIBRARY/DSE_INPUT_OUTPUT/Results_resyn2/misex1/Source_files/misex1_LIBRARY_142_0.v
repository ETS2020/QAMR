...
module FAU ( 
  ...
  aoi21  g14(.a(x3), .b(new_n20_), .c(x2), .O(new_n30_));
  aoi21  g15(.a(new_n29_), .b(new_n28_), .c(new_n30_), .O(new_n31_));
  ...
  oai21  g23(.a(new_n38_), .b(x0), .c(new_n34_), .O(z2));
  oai21  g24(.a(x4), .b(x3), .c(x7), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n21_), .c(x6), .d(new_n16_), .O(new_n41_));
  nand2  g26(.a(x5), .b(new_n23_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n29_), .c(new_n19_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(z3));
  inv1   g29(.a(new_n18_), .O(new_n45_));
  oai21  g30(.a(new_n19_), .b(x1), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(x3), .b(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n23_), .c(new_n45_), .O(new_n49_));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n16_), .b(new_n23_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n50_), .c(new_n20_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n49_), .O(z4));
  nand3  g38(.a(x5), .b(x2), .c(new_n23_), .O(new_n54_));
  nand3  g39(.a(new_n50_), .b(new_n18_), .c(x0), .O(new_n55_));
  ...
  nand3  g44(.a(new_n59_), .b(new_n21_), .c(new_n18_), .O(new_n60_));
  aoi21  g45(.a(new_n18_), .b(x0), .c(new_n27_), .O(new_n61_));
  nand2  g46(.a(new_n50_), .b(new_n20_), .O(new_n62_));
