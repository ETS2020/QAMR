...
module FAU ( 
  ...
  nand4  g23(.a(new_n38_), .b(new_n37_), .c(new_n25_), .d(new_n16_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n36_), .O(z2));
  nor2   g25(.a(x3), .b(new_n31_), .O(new_n41_));
  nand2  g26(.a(x5), .b(new_n16_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n41_), .c(new_n25_), .O(new_n43_));
  inv1   g28(.a(new_n19_), .O(new_n44_));
  oai21  g29(.a(x4), .b(x3), .c(x7), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n31_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n43_), .c(new_n22_), .O(z3));
  nand4  g32(.a(x3), .b(new_n31_), .c(new_n25_), .d(new_n16_), .O(new_n48_));
  oai21  g33(.a(x3), .b(new_n31_), .c(new_n16_), .O(new_n49_));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n25_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n48_), .c(new_n22_), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(z4));
  nand2  g39(.a(new_n52_), .b(new_n22_), .O(new_n55_));
  nand2  g40(.a(new_n28_), .b(new_n16_), .O(new_n56_));
  nor2   g41(.a(new_n56_), .b(new_n27_), .O(new_n57_));
  nor2   g42(.a(new_n57_), .b(new_n55_), .O(z5));
  nand3  g43(.a(x3), .b(new_n31_), .c(x0), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  nand2  g45(.a(x6), .b(x0), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(x5), .c(x1), .O(new_n62_));
  oai21  g47(.a(new_n41_), .b(new_n60_), .c(new_n62_), .O(new_n63_));
  oai21  g48(.a(x4), .b(x2), .c(new_n17_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n22_), .c(new_n44_), .O(new_n65_));
