...
module FAU ( 
  ...
  nand3  g21(.a(new_n16_), .b(x1), .c(new_n17_), .O(new_n37_));
  aoi21  g22(.a(new_n36_), .b(x7), .c(new_n37_), .O(z3));
  aoi21  g23(.a(new_n21_), .b(x2), .c(x0), .O(new_n39_));
  oai21  g24(.a(new_n21_), .b(x1), .c(new_n39_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n33_), .O(z4));
  nand2  g26(.a(new_n23_), .b(x3), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n26_), .O(z5));
  nand2  g28(.a(x1), .b(new_n17_), .O(new_n44_));
  aoi21  g29(.a(new_n35_), .b(new_n16_), .c(x3), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n44_), .c(new_n33_), .O(z6));
endmodule
