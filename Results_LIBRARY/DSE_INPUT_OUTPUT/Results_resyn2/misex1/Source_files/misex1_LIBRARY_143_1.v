...
module FAU ( 
  ...
  oai21  g12(.a(new_n27_), .b(new_n20_), .c(new_n26_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  inv1   g14(.a(x4), .O(new_n30_));
  oai21  g15(.a(new_n30_), .b(x2), .c(new_n27_), .O(new_n31_));
  ...
  nand2  g19(.a(new_n30_), .b(new_n27_), .O(new_n35_));
  nand2  g20(.a(new_n17_), .b(new_n26_), .O(new_n36_));
  aoi21  g21(.a(new_n35_), .b(x7), .c(new_n36_), .O(z3));
  aoi21  g22(.a(new_n27_), .b(x2), .c(x0), .O(new_n38_));
  oai21  g23(.a(new_n27_), .b(x1), .c(new_n38_), .O(new_n39_));
  oai21  g24(.a(new_n24_), .b(x2), .c(new_n39_), .O(z4));
  oai21  g25(.a(new_n22_), .b(x2), .c(new_n38_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n29_), .O(z5));
  oai21  g27(.a(x4), .b(x2), .c(new_n27_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n29_), .O(z6));
endmodule
