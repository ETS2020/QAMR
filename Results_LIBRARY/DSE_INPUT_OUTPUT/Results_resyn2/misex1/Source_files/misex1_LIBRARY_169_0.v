...
module FAU ( 
  ...
  oai21  g26(.a(new_n41_), .b(new_n37_), .c(new_n20_), .O(new_n42_));
  nand2  g27(.a(new_n27_), .b(x4), .O(new_n43_));
  ...
  oai21  g32(.a(new_n47_), .b(new_n22_), .c(new_n17_), .O(new_n48_));
  oai21  g33(.a(x7), .b(new_n17_), .c(new_n23_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n26_), .c(new_n20_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(z3));
  nand2  g36(.a(new_n19_), .b(x2), .O(new_n52_));
  nand3  g37(.a(x3), .b(new_n17_), .c(new_n20_), .O(new_n53_));
  oai21  g38(.a(new_n16_), .b(x1), .c(x0), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n53_), .c(new_n26_), .O(new_n55_));
  nand2  g40(.a(new_n22_), .b(new_n17_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n52_), .O(z4));
  xor2a  g42(.a(x3), .b(x2), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x0), .O(new_n59_));
  nand3  g44(.a(x5), .b(x2), .c(new_n20_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n59_), .c(x1), .O(new_n61_));
  nor3   g46(.a(new_n58_), .b(new_n39_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(x4), .O(new_n63_));
  nor2   g48(.a(new_n17_), .b(x0), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n46_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n63_), .O(z5));
  aoi22  g51(.a(new_n58_), .b(x0), .c(new_n32_), .d(x2), .O(new_n67_));
  oai21  g52(.a(x4), .b(x2), .c(new_n16_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n64_), .O(new_n69_));
  oai21  g54(.a(new_n67_), .b(new_n28_), .c(new_n69_), .O(z6));
endmodule
