...
module FAU ( 
  ...
  nand4  g20(.a(new_n35_), .b(new_n34_), .c(new_n19_), .d(new_n16_), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n33_), .c(x0), .O(z2));
  inv1   g22(.a(x5), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n19_), .c(x2), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n24_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n16_), .O(new_n41_));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n17_), .c(new_n18_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(z3));
  nor2   g29(.a(new_n26_), .b(new_n20_), .O(new_n45_));
  xor2a  g30(.a(x3), .b(x1), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n45_), .c(x0), .O(z4));
  oai21  g32(.a(new_n38_), .b(x1), .c(new_n19_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x2), .O(new_n49_));
  nand2  g34(.a(new_n19_), .b(x2), .O(new_n50_));
  aoi22  g35(.a(new_n50_), .b(x1), .c(new_n26_), .d(x6), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n49_), .c(x0), .O(z5));
