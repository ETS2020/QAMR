...
module FAU ( 
  ...
  oai21  g15(.a(new_n19_), .b(x2), .c(new_n26_), .O(new_n31_));
  ...
  nand4  g20(.a(new_n35_), .b(new_n34_), .c(new_n17_), .d(new_n16_), .O(new_n36_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n17_), .c(x2), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n42_), .O(z3));
  oai21  g30(.a(x3), .b(new_n23_), .c(new_n16_), .O(new_n46_));
  xor2a  g31(.a(x3), .b(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n26_), .O(new_n48_));
  xor2a  g33(.a(new_n48_), .b(new_n46_), .O(z4));
  xnor2a g34(.a(x3), .b(x2), .O(new_n50_));
  nand3  g35(.a(x5), .b(x2), .c(new_n16_), .O(new_n51_));
  ...
  nand3  g39(.a(new_n54_), .b(new_n30_), .c(new_n24_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n16_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n53_), .O(z5));
  nor2   g42(.a(x4), .b(x2), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n20_), .c(x1), .O(new_n59_));
  aoi22  g44(.a(new_n47_), .b(x0), .c(new_n25_), .d(x2), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x1), .c(new_n59_), .O(z6));
endmodule
