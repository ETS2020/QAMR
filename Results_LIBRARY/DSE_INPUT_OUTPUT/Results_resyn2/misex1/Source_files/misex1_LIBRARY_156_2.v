...
module FAU ( 
  ...
  nand3  g22(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n38_));
  aoi21  g23(.a(x5), .b(new_n16_), .c(new_n38_), .O(z3));
  xnor2a g24(.a(x3), .b(x2), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n16_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n38_), .c(new_n30_), .O(z4));
  nand3  g27(.a(x5), .b(x2), .c(new_n16_), .O(new_n43_));
  oai21  g28(.a(new_n40_), .b(new_n16_), .c(new_n43_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n18_), .O(new_n45_));
  nand2  g30(.a(new_n25_), .b(x1), .O(new_n46_));
  nand3  g31(.a(new_n40_), .b(new_n33_), .c(new_n16_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(z5));
  nor2   g33(.a(new_n23_), .b(x0), .O(new_n49_));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  oai22  g36(.a(new_n51_), .b(new_n49_), .c(new_n36_), .d(new_n25_), .O(z6));
endmodule
