...
module FAU ( 
  ...
  oai21  g27(.a(new_n42_), .b(new_n38_), .c(new_n26_), .O(new_n43_));
  inv1   g28(.a(new_n24_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n17_), .c(new_n34_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(z2));
  inv1   g31(.a(new_n18_), .O(new_n47_));
  nor2   g32(.a(x4), .b(x2), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n30_), .c(new_n20_), .O(new_n49_));
  nand2  g34(.a(x5), .b(new_n26_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n21_), .c(new_n20_), .O(new_n51_));
  oai22  g36(.a(new_n51_), .b(new_n16_), .c(new_n49_), .d(new_n47_), .O(z3));
  nor2   g37(.a(new_n30_), .b(x2), .O(new_n53_));
  oai21  g38(.a(new_n20_), .b(new_n16_), .c(x1), .O(new_n54_));
  nor2   g39(.a(x3), .b(new_n16_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n54_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n26_), .O(new_n57_));
  oai21  g42(.a(new_n55_), .b(new_n44_), .c(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n57_), .c(new_n35_), .O(z4));
  nand2  g44(.a(x3), .b(new_n16_), .O(new_n60_));
  nand3  g45(.a(x7), .b(new_n30_), .c(x2), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n26_), .O(new_n62_));
  nand4  g47(.a(x7), .b(x5), .c(x2), .d(new_n26_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n17_), .O(new_n65_));
  nand3  g50(.a(x7), .b(x3), .c(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n32_), .c(new_n26_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z5));
  aoi21  g54(.a(new_n55_), .b(new_n50_), .c(new_n44_), .O(new_n70_));
  oai21  g55(.a(x4), .b(x2), .c(new_n30_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n18_), .c(new_n34_), .O(new_n72_));
