...
module FAU ( 
  ...
  aoi22  g14(.a(new_n29_), .b(new_n26_), .c(new_n24_), .d(x2), .O(z1));
  nand2  g15(.a(x3), .b(x1), .O(new_n31_));
  inv1   g16(.a(x5), .O(new_n32_));
  nand4  g17(.a(new_n32_), .b(new_n25_), .c(x2), .d(new_n27_), .O(new_n33_));
  ...
  nand3  g22(.a(new_n37_), .b(new_n25_), .c(new_n27_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n36_), .c(new_n20_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n16_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n35_), .O(z2));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n16_), .c(x1), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n33_), .c(new_n18_), .O(z3));
  inv1   g29(.a(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n28_), .b(new_n16_), .O(new_n46_));
  nand3  g31(.a(x3), .b(x2), .c(new_n20_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(z4));
  nand3  g33(.a(new_n26_), .b(new_n23_), .c(new_n16_), .O(new_n49_));
  nand2  g34(.a(x5), .b(new_n27_), .O(new_n50_));
  nand4  g35(.a(new_n50_), .b(new_n25_), .c(x2), .d(new_n20_), .O(new_n51_));
  nand3  g36(.a(new_n25_), .b(x2), .c(new_n27_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x0), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n51_), .c(new_n49_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(z5));
  inv1   g40(.a(x4), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n16_), .c(x3), .O(new_n57_));
  nor2   g42(.a(new_n32_), .b(x0), .O(new_n58_));
  oai22  g43(.a(new_n58_), .b(new_n52_), .c(new_n57_), .d(new_n21_), .O(z6));
endmodule
