...
module FAU ( 
  ...
  nand4  g11(.a(x5), .b(x3), .c(new_n20_), .d(x0), .O(new_n27_));
  ...
  oai21  g21(.a(x5), .b(x2), .c(x1), .O(new_n37_));
  aoi21  g22(.a(new_n36_), .b(new_n19_), .c(new_n37_), .O(new_n38_));
  ...
  oai21  g27(.a(new_n42_), .b(new_n38_), .c(new_n23_), .O(new_n43_));
  nand2  g28(.a(new_n28_), .b(new_n16_), .O(new_n44_));
  ...
  aoi21  g48(.a(new_n56_), .b(new_n33_), .c(new_n55_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n63_), .O(z5));
  oai21  g50(.a(new_n60_), .b(new_n30_), .c(new_n20_), .O(new_n66_));
  oai21  g51(.a(x4), .b(x2), .c(new_n19_), .O(new_n67_));
  aoi21  g52(.a(new_n67_), .b(new_n21_), .c(new_n55_), .O(new_n68_));
