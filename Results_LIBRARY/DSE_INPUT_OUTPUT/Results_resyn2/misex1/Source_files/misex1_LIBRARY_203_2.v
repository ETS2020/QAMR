...
module FAU ( 
  ...
  oai22  g16(.a(new_n24_), .b(x5), .c(x6), .d(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n19_), .c(new_n16_), .O(new_n33_));
  oai21  g18(.a(new_n19_), .b(x0), .c(x2), .O(new_n34_));
  ...
  nand3  g23(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n39_));
  oai22  g24(.a(new_n39_), .b(new_n38_), .c(x2), .d(new_n18_), .O(z3));
  nand2  g25(.a(new_n19_), .b(x2), .O(new_n41_));
  nand2  g26(.a(x3), .b(new_n25_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n16_), .c(new_n41_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n18_), .O(new_n44_));
  nand2  g29(.a(new_n19_), .b(x1), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n42_), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(z4));
  nand2  g32(.a(x5), .b(x2), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n26_), .c(x0), .O(new_n49_));
  aoi21  g34(.a(new_n42_), .b(new_n41_), .c(new_n16_), .O(new_n50_));
  ...
  aoi22  g39(.a(new_n54_), .b(x0), .c(new_n23_), .d(x2), .O(new_n55_));
  nand2  g40(.a(new_n34_), .b(x1), .O(new_n56_));
