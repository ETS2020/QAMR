...
module FAU ( 
  ...
  aoi21  g03(.a(new_n18_), .b(x0), .c(x4), .O(new_n19_));
  ...
  oai21  g12(.a(new_n27_), .b(x4), .c(new_n22_), .O(new_n28_));
  ...
  nand2  g17(.a(x2), .b(new_n22_), .O(new_n33_));
  aoi21  g18(.a(new_n32_), .b(new_n16_), .c(new_n33_), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(new_n31_), .c(new_n29_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n28_), .O(z1));
  nand2  g21(.a(x4), .b(new_n20_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n16_), .c(new_n22_), .O(new_n38_));
  ...
  nand3  g27(.a(new_n42_), .b(new_n16_), .c(new_n22_), .O(new_n43_));
  aoi21  g28(.a(new_n41_), .b(new_n39_), .c(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n38_), .c(new_n29_), .O(new_n45_));
  nor2   g30(.a(x4), .b(x1), .O(new_n46_));
  ...
  nand2  g35(.a(x5), .b(new_n29_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n46_), .c(new_n18_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n50_), .O(z3));
  oai21  g38(.a(new_n27_), .b(new_n18_), .c(new_n46_), .O(new_n54_));
  nand2  g39(.a(x3), .b(new_n20_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n42_), .c(x1), .O(new_n56_));
  nand2  g41(.a(new_n17_), .b(new_n29_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z4));
  aoi21  g43(.a(new_n55_), .b(new_n17_), .c(new_n29_), .O(new_n59_));
  oai21  g44(.a(new_n51_), .b(new_n20_), .c(new_n42_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n22_), .O(new_n61_));
  oai21  g46(.a(new_n31_), .b(new_n21_), .c(new_n29_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n61_), .O(z5));
  nand3  g48(.a(new_n32_), .b(new_n16_), .c(x2), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n42_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n59_), .c(new_n22_), .O(new_n66_));
