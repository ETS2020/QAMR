...
module FAU ( 
  ...
  nand4  g19(.a(new_n34_), .b(new_n33_), .c(new_n25_), .d(new_n20_), .O(new_n35_));
  ...
  nand4  g24(.a(new_n39_), .b(new_n25_), .c(x2), .d(new_n20_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n38_), .c(x0), .O(z3));
  aoi21  g26(.a(new_n24_), .b(x1), .c(new_n17_), .O(new_n42_));
  nor2   g27(.a(x3), .b(x2), .O(new_n43_));
  aoi21  g28(.a(x2), .b(new_n20_), .c(new_n43_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n42_), .c(x0), .O(z4));
  nand2  g30(.a(x3), .b(x2), .O(new_n46_));
  nand2  g31(.a(new_n24_), .b(x1), .O(new_n47_));
  nand3  g32(.a(new_n26_), .b(new_n47_), .c(new_n46_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n16_), .O(new_n49_));
  nand2  g34(.a(new_n34_), .b(new_n16_), .O(new_n50_));
