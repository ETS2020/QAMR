...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n32_), .c(new_n21_), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n31_), .c(new_n24_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n29_), .O(z1));
  nand2  g21(.a(x4), .b(new_n32_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n20_), .c(new_n21_), .O(new_n38_));
  nand2  g23(.a(x5), .b(x2), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n20_), .c(new_n21_), .O(new_n40_));
  aoi21  g25(.a(x6), .b(new_n32_), .c(new_n40_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(new_n38_), .c(new_n24_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n29_), .O(z2));
  aoi21  g28(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n44_));
  nand3  g29(.a(new_n20_), .b(x2), .c(new_n21_), .O(new_n45_));
  inv1   g30(.a(x4), .O(new_n46_));
  aoi21  g31(.a(new_n30_), .b(new_n46_), .c(new_n17_), .O(new_n47_));
  nand2  g32(.a(new_n22_), .b(new_n32_), .O(new_n48_));
  oai22  g33(.a(new_n48_), .b(new_n47_), .c(new_n45_), .d(new_n44_), .O(z3));
  aoi21  g34(.a(new_n20_), .b(x2), .c(x0), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  xnor2a g36(.a(x3), .b(x2), .O(new_n52_));
  or2    g37(.a(new_n52_), .b(x1), .O(new_n53_));
  nand4  g38(.a(x3), .b(new_n32_), .c(new_n21_), .d(new_n24_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n19_), .O(new_n55_));
  aoi21  g40(.a(new_n53_), .b(new_n51_), .c(new_n55_), .O(z4));
  nor2   g41(.a(new_n52_), .b(new_n24_), .O(new_n57_));
  nand3  g42(.a(x5), .b(new_n20_), .c(x2), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n57_), .c(new_n21_), .O(new_n60_));
  aoi21  g45(.a(new_n50_), .b(new_n34_), .c(new_n18_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n60_), .O(z5));
  nand3  g47(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n57_), .c(new_n21_), .O(new_n65_));
  oai21  g50(.a(x4), .b(x2), .c(new_n20_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n22_), .c(new_n18_), .O(new_n67_));
