...
module FAU ( 
  ...
  nor2   g16(.a(x3), .b(new_n22_), .O(new_n32_));
  nor2   g17(.a(x1), .b(new_n20_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n32_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n31_), .O(z3));
  xor2a  g20(.a(x3), .b(x2), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n33_), .O(new_n37_));
  nand2  g22(.a(new_n29_), .b(new_n17_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n37_), .O(z4));
  nand2  g24(.a(new_n36_), .b(new_n21_), .O(new_n40_));
  oai21  g25(.a(new_n32_), .b(x0), .c(new_n40_), .O(z5));
  oai21  g26(.a(x4), .b(x2), .c(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n29_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n37_), .O(z6));
endmodule
