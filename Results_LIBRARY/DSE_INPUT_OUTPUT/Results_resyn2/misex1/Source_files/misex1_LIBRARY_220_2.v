...
module FAU ( 
  ...
  nand3  g10(.a(x7), .b(x2), .c(new_n17_), .O(new_n26_));
  ...
  nor2   g25(.a(x7), .b(new_n16_), .O(new_n41_));
  ...
  aoi21  g31(.a(new_n46_), .b(new_n28_), .c(new_n20_), .O(new_n47_));
  ...
  oai22  g36(.a(new_n51_), .b(new_n20_), .c(new_n50_), .d(new_n24_), .O(new_n52_));
  ...
  aoi21  g43(.a(new_n51_), .b(new_n50_), .c(new_n24_), .O(new_n59_));
  nand3  g44(.a(x5), .b(x2), .c(new_n24_), .O(new_n60_));
  ...
  aoi22  g51(.a(new_n66_), .b(x0), .c(new_n25_), .d(x2), .O(new_n67_));
