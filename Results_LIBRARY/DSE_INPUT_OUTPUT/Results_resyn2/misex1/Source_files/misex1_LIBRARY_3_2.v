...
module FAU ( 
  ...
  nand3  g11(.a(new_n26_), .b(new_n22_), .c(new_n20_), .O(new_n27_));
  nand3  g12(.a(new_n25_), .b(x3), .c(x0), .O(new_n28_));
  ...
  oai21  g17(.a(new_n25_), .b(new_n23_), .c(x0), .O(new_n33_));
  inv1   g18(.a(x2), .O(new_n34_));
  nor2   g19(.a(x5), .b(new_n34_), .O(new_n35_));
  nor2   g20(.a(x6), .b(x2), .O(new_n36_));
  nor2   g21(.a(x3), .b(x1), .O(new_n37_));
  oai21  g22(.a(new_n36_), .b(new_n35_), .c(new_n37_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n33_), .c(new_n32_), .O(z2));
  oai22  g24(.a(x7), .b(x0), .c(x4), .d(x3), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n34_), .c(x1), .O(new_n41_));
  ...
  oai21  g31(.a(new_n17_), .b(new_n23_), .c(new_n34_), .O(new_n47_));
  nand2  g32(.a(new_n23_), .b(x1), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(x2), .c(new_n20_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n47_), .c(new_n33_), .O(z4));
  nand2  g35(.a(x3), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n34_), .b(x1), .O(new_n52_));
  ...
  nand3  g40(.a(x6), .b(new_n23_), .c(new_n34_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n33_), .O(z5));
  oai21  g42(.a(x4), .b(x2), .c(new_n23_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n37_), .b(new_n35_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n59_), .c(new_n33_), .O(z6));
endmodule
