...
module FAU ( 
  ...
  oai21  g10(.a(x5), .b(x3), .c(new_n19_), .O(new_n26_));
  oai21  g11(.a(new_n26_), .b(new_n24_), .c(new_n25_), .O(new_n27_));
  ...
  aoi21  g44(.a(new_n53_), .b(new_n56_), .c(new_n19_), .O(new_n60_));
  nand4  g45(.a(new_n16_), .b(x5), .c(x2), .d(new_n19_), .O(new_n61_));
  ...
  oai21  g50(.a(new_n65_), .b(new_n30_), .c(new_n19_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  nand2  g52(.a(new_n20_), .b(x2), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n56_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n26_), .c(new_n17_), .O(new_n70_));
