...
module FAU ( 
  ...
  nand2  g16(.a(new_n25_), .b(new_n16_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n19_), .O(new_n33_));
  nor2   g18(.a(new_n20_), .b(new_n23_), .O(new_n34_));
  nor2   g19(.a(x6), .b(x0), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(x3), .c(new_n17_), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(new_n34_), .c(new_n33_), .O(z2));
  nand2  g22(.a(new_n18_), .b(new_n16_), .O(new_n38_));
  aoi21  g23(.a(x5), .b(new_n19_), .c(new_n38_), .O(z3));
  xnor2a g24(.a(x3), .b(x2), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n19_), .c(new_n25_), .O(new_n41_));
  ...
  oai21  g30(.a(new_n29_), .b(new_n18_), .c(x0), .O(new_n46_));
  nand3  g31(.a(new_n27_), .b(new_n25_), .c(new_n19_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n46_), .c(x1), .O(z5));
  inv1   g33(.a(new_n42_), .O(z6));
endmodule
