...
module FAU ( 
  ...
  oai21  g08(.a(new_n16_), .b(new_n18_), .c(new_n23_), .O(new_n24_));
  nor2   g09(.a(x5), .b(x3), .O(new_n25_));
  nand2  g10(.a(new_n16_), .b(new_n18_), .O(new_n26_));
  ...
  nor2   g16(.a(x3), .b(new_n23_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n16_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n30_), .c(x0), .O(z2));
  nand2  g19(.a(x5), .b(new_n18_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n32_), .c(new_n16_), .O(new_n36_));
  ...
  nand2  g26(.a(new_n23_), .b(new_n16_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n41_), .c(new_n18_), .O(new_n43_));
  oai21  g28(.a(new_n41_), .b(x1), .c(new_n43_), .O(z4));
  oai21  g29(.a(new_n31_), .b(x1), .c(new_n19_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n18_), .O(new_n46_));
  nand3  g31(.a(new_n32_), .b(new_n16_), .c(x0), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n24_), .O(z5));
  oai21  g33(.a(x4), .b(x2), .c(new_n19_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n37_), .O(new_n50_));
