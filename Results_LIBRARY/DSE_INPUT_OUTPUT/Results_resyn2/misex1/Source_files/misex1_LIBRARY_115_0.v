...
module FAU ( 
  ...
  nor2   g30(.a(new_n20_), .b(x1), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n45_), .c(new_n30_), .d(x2), .O(new_n47_));
  ...
  nand2  g42(.a(new_n57_), .b(x7), .O(new_n58_));
  aoi21  g43(.a(new_n56_), .b(x0), .c(new_n58_), .O(new_n59_));
  aoi21  g44(.a(new_n30_), .b(x2), .c(x0), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n32_), .O(new_n61_));
  oai21  g46(.a(new_n59_), .b(x1), .c(new_n61_), .O(z5));
  inv1   g47(.a(new_n46_), .O(new_n63_));
  aoi22  g48(.a(new_n56_), .b(x0), .c(new_n28_), .d(x2), .O(new_n64_));
  oai21  g49(.a(x4), .b(x2), .c(new_n30_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n43_), .O(new_n66_));
  oai21  g51(.a(new_n64_), .b(new_n63_), .c(new_n66_), .O(z6));
endmodule
