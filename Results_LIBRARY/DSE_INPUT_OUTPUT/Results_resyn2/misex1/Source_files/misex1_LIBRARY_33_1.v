...
module FAU ( 
  ...
  nand3  g05(.a(new_n20_), .b(new_n19_), .c(new_n16_), .O(new_n21_));
  oai21  g06(.a(x3), .b(x0), .c(x2), .O(new_n22_));
  aoi21  g07(.a(new_n21_), .b(new_n18_), .c(new_n22_), .O(z0));
  nor2   g08(.a(new_n19_), .b(x2), .O(new_n24_));
  aoi21  g09(.a(new_n24_), .b(x0), .c(x7), .O(new_n25_));
  ...
  nand3  g16(.a(new_n31_), .b(new_n28_), .c(new_n26_), .O(new_n32_));
  oai21  g17(.a(new_n25_), .b(x1), .c(new_n32_), .O(z1));
  nand2  g18(.a(new_n24_), .b(x0), .O(new_n34_));
  ...
  aoi21  g25(.a(new_n40_), .b(new_n38_), .c(new_n21_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(new_n36_), .c(new_n26_), .O(new_n42_));
  nor2   g27(.a(x7), .b(x1), .O(new_n43_));
  inv1   g28(.a(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n34_), .c(new_n42_), .O(z2));
  nand2  g30(.a(new_n19_), .b(x2), .O(new_n46_));
  aoi21  g31(.a(x5), .b(new_n26_), .c(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(x7), .c(new_n16_), .O(new_n48_));
  oai21  g33(.a(x4), .b(x3), .c(x7), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n17_), .c(new_n29_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(z3));
  nor2   g36(.a(new_n44_), .b(new_n24_), .O(new_n52_));
  aoi21  g37(.a(new_n46_), .b(x1), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n46_), .b(new_n34_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n43_), .O(new_n55_));
  oai21  g40(.a(new_n53_), .b(x0), .c(new_n55_), .O(z4));
