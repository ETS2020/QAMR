...
module FAU ( 
  ...
  oai21  g15(.a(new_n30_), .b(new_n20_), .c(new_n25_), .O(new_n31_));
  nand3  g16(.a(new_n27_), .b(new_n18_), .c(x0), .O(new_n32_));
  ...
  oai21  g21(.a(new_n27_), .b(new_n22_), .c(new_n18_), .O(new_n37_));
  oai21  g22(.a(new_n22_), .b(x0), .c(new_n37_), .O(z4));
  oai21  g23(.a(new_n19_), .b(x1), .c(x0), .O(new_n39_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n40_), .c(new_n23_), .O(z5));
  aoi21  g29(.a(new_n34_), .b(new_n22_), .c(new_n27_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(x1), .c(new_n21_), .O(z6));
endmodule
