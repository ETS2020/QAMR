...
module FAU ( 
  ...
  nand2  g28(.a(new_n32_), .b(new_n17_), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  inv1   g30(.a(x4), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n16_), .O(new_n47_));
  nand3  g32(.a(x3), .b(new_n16_), .c(new_n19_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n47_), .c(new_n45_), .O(new_n49_));
  nand3  g34(.a(x4), .b(x3), .c(new_n16_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n32_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n44_), .c(new_n19_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n49_), .O(z4));
  aoi21  g38(.a(new_n50_), .b(new_n32_), .c(new_n17_), .O(new_n54_));
