...
module FAU ( 
  ...
  nand2  g09(.a(new_n24_), .b(x7), .O(new_n25_));
  ...
  oai21  g23(.a(new_n38_), .b(new_n35_), .c(new_n27_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n26_), .O(z2));
  oai21  g25(.a(x4), .b(x3), .c(x7), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n18_), .c(new_n16_), .O(new_n42_));
  ...
  nand3  g32(.a(new_n47_), .b(new_n45_), .c(new_n43_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n42_), .O(z3));
  nand2  g34(.a(new_n44_), .b(new_n24_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n47_), .O(new_n51_));
  oai21  g36(.a(new_n23_), .b(new_n46_), .c(new_n17_), .O(new_n52_));
  nor2   g37(.a(new_n45_), .b(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(z4));
  nand2  g40(.a(x3), .b(new_n16_), .O(new_n56_));
  aoi21  g41(.a(new_n44_), .b(new_n56_), .c(new_n27_), .O(new_n57_));
  oai21  g42(.a(new_n43_), .b(new_n16_), .c(x7), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n53_), .b(new_n31_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(z5));
  inv1   g46(.a(new_n47_), .O(new_n62_));
  xor2a  g47(.a(x3), .b(x2), .O(new_n63_));
  aoi22  g48(.a(new_n63_), .b(x0), .c(new_n28_), .d(x2), .O(new_n64_));
  oai21  g49(.a(x4), .b(x2), .c(new_n20_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n18_), .O(new_n66_));
  oai21  g51(.a(new_n64_), .b(new_n62_), .c(new_n66_), .O(z6));
endmodule
