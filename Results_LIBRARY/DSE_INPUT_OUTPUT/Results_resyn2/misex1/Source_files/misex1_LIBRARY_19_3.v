...
module FAU ( 
  ...
  aoi21  g03(.a(new_n18_), .b(x2), .c(x4), .O(new_n19_));
  ...
  nand3  g20(.a(new_n18_), .b(new_n29_), .c(x1), .O(new_n36_));
  ...
  nand2  g32(.a(new_n21_), .b(new_n16_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(z3));
  nand2  g34(.a(new_n29_), .b(x1), .O(new_n50_));
  aoi21  g35(.a(new_n20_), .b(new_n24_), .c(new_n50_), .O(new_n51_));
  ...
  aoi21  g44(.a(new_n17_), .b(x2), .c(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n39_), .b(new_n26_), .c(new_n53_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n24_), .O(new_n62_));
