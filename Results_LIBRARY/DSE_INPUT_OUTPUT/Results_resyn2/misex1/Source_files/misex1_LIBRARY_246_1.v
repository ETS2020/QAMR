...
module FAU ( 
  ...
  nor2   g07(.a(x1), .b(new_n18_), .O(new_n23_));
  aoi21  g08(.a(new_n23_), .b(new_n22_), .c(new_n16_), .O(new_n24_));
  aoi22  g09(.a(new_n24_), .b(new_n21_), .c(new_n17_), .d(new_n16_), .O(z0));
  aoi21  g10(.a(new_n23_), .b(x3), .c(x4), .O(new_n26_));
  ...
  nand3  g16(.a(new_n31_), .b(new_n28_), .c(new_n18_), .O(new_n32_));
  oai21  g17(.a(new_n26_), .b(x2), .c(new_n32_), .O(z1));
  nand2  g18(.a(new_n29_), .b(x0), .O(new_n34_));
  ...
  aoi21  g28(.a(new_n43_), .b(new_n20_), .c(x4), .O(new_n44_));
  nand2  g29(.a(x5), .b(new_n18_), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n22_), .c(x2), .d(new_n29_), .O(new_n46_));
  oai21  g31(.a(new_n44_), .b(x2), .c(new_n46_), .O(z3));
  nand2  g32(.a(new_n22_), .b(x2), .O(new_n48_));
  nand3  g33(.a(new_n17_), .b(x3), .c(new_n16_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n48_), .b(new_n18_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n50_), .c(new_n29_), .O(new_n52_));
  nand3  g37(.a(x3), .b(new_n16_), .c(new_n29_), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  nand3  g39(.a(new_n48_), .b(new_n41_), .c(new_n18_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(z4));
  aoi21  g41(.a(new_n49_), .b(new_n48_), .c(new_n18_), .O(new_n57_));
  nand3  g42(.a(x5), .b(x2), .c(new_n18_), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n57_), .c(new_n29_), .O(new_n60_));
  inv1   g45(.a(new_n55_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n31_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n60_), .O(z5));
  nand2  g48(.a(new_n27_), .b(x2), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n57_), .c(new_n29_), .O(new_n66_));
  nand3  g51(.a(new_n48_), .b(new_n41_), .c(new_n20_), .O(new_n67_));
