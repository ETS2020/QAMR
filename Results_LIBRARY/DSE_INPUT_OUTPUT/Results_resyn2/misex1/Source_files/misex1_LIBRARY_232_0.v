...
module FAU ( 
  ...
  aoi21  g09(.a(new_n19_), .b(new_n18_), .c(new_n24_), .O(z0));
  inv1   g10(.a(x2), .O(new_n26_));
  nand2  g11(.a(x3), .b(new_n26_), .O(new_n27_));
  inv1   g12(.a(new_n27_), .O(new_n28_));
  aoi21  g13(.a(new_n28_), .b(new_n17_), .c(new_n20_), .O(new_n29_));
  ...
  aoi21  g23(.a(new_n38_), .b(new_n31_), .c(new_n22_), .O(new_n39_));
  ...
  nand3  g36(.a(new_n51_), .b(new_n49_), .c(new_n21_), .O(z3));
  ...
  aoi21  g42(.a(new_n57_), .b(new_n55_), .c(new_n20_), .O(z4));
  nor2   g43(.a(new_n56_), .b(new_n54_), .O(new_n59_));
  oai21  g44(.a(new_n34_), .b(x0), .c(new_n21_), .O(new_n60_));
  ...
  aoi21  g49(.a(new_n64_), .b(new_n63_), .c(new_n20_), .O(z6));
endmodule
