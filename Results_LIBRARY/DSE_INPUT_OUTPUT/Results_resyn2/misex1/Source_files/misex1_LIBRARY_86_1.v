...
module FAU ( 
  ...
  nor2   g08(.a(new_n23_), .b(new_n17_), .O(new_n24_));
  aoi22  g09(.a(new_n24_), .b(new_n20_), .c(new_n22_), .d(new_n17_), .O(new_n25_));
  ...
  nand3  g27(.a(x3), .b(x1), .c(new_n17_), .O(new_n43_));
  oai21  g28(.a(new_n25_), .b(x2), .c(new_n43_), .O(z5));
  oai21  g29(.a(x4), .b(x2), .c(new_n23_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n35_), .O(new_n46_));
