...
module FAU ( 
  ...
  oai21  g07(.a(x4), .b(x2), .c(new_n22_), .O(z0));
  ...
  nand2  g13(.a(x4), .b(new_n28_), .O(new_n29_));
  ...
  nand3  g18(.a(new_n33_), .b(x4), .c(new_n28_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n31_), .O(z1));
  aoi21  g20(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n36_));
  nand3  g21(.a(new_n24_), .b(x2), .c(new_n18_), .O(new_n37_));
  ...
  oai21  g27(.a(new_n33_), .b(new_n42_), .c(new_n28_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(z2));
  nand2  g29(.a(x1), .b(new_n16_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(x7), .c(x4), .O(new_n46_));
  ...
  nand3  g36(.a(x4), .b(new_n19_), .c(new_n28_), .O(new_n52_));
  ...
  nand4  g40(.a(new_n55_), .b(x4), .c(x3), .d(new_n28_), .O(new_n56_));
  oai21  g41(.a(new_n54_), .b(new_n18_), .c(new_n56_), .O(new_n57_));
  nor2   g42(.a(new_n57_), .b(new_n53_), .O(z4));
  nand2  g43(.a(new_n19_), .b(x2), .O(new_n59_));
  nand3  g44(.a(x4), .b(x3), .c(new_n28_), .O(new_n60_));
  ...
  oai21  g50(.a(new_n65_), .b(new_n30_), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n64_), .O(z5));
  nand3  g52(.a(new_n24_), .b(new_n19_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n61_), .c(new_n18_), .O(new_n70_));
  inv1   g55(.a(new_n17_), .O(new_n71_));
  aoi21  g56(.a(new_n42_), .b(new_n28_), .c(new_n71_), .O(new_n72_));
