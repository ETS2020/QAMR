...
module FAU ( 
  ...
  aoi21  g05(.a(new_n20_), .b(x0), .c(x4), .O(new_n21_));
  ...
  nand3  g12(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n28_));
  oai21  g13(.a(x4), .b(new_n16_), .c(x1), .O(new_n29_));
  ...
  aoi22  g18(.a(new_n33_), .b(x0), .c(x4), .d(x2), .O(new_n34_));
  ...
  nand3  g25(.a(new_n40_), .b(new_n39_), .c(new_n20_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n38_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n23_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n34_), .O(z2));
  nand2  g29(.a(x5), .b(new_n23_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n20_), .c(x4), .O(new_n46_));
  ...
  aoi21  g34(.a(new_n36_), .b(x3), .c(new_n16_), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n32_), .c(new_n23_), .O(new_n52_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n17_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n52_), .O(z4));
  aoi21  g43(.a(new_n53_), .b(new_n55_), .c(new_n23_), .O(new_n59_));
  nand4  g44(.a(x5), .b(new_n36_), .c(x2), .d(new_n23_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n17_), .O(new_n62_));
  nor2   g47(.a(x2), .b(x1), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n50_), .c(new_n28_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n23_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  nand4  g51(.a(new_n25_), .b(new_n36_), .c(new_n24_), .d(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n59_), .c(new_n17_), .O(new_n69_));
  nand2  g54(.a(x4), .b(new_n24_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n51_), .c(new_n18_), .O(new_n71_));
