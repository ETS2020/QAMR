...
module FAU ( 
  ...
  nand3  g49(.a(new_n64_), .b(new_n42_), .c(new_n30_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n16_), .c(new_n23_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  nand3  g52(.a(new_n39_), .b(new_n19_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n60_), .c(new_n18_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n24_), .c(new_n17_), .O(z6));
endmodule
