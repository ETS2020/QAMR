...
module FAU ( 
  ...
  oai21  g23(.a(new_n35_), .b(new_n38_), .c(new_n20_), .O(new_n39_));
  nand2  g24(.a(new_n24_), .b(x3), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(z4));
  xnor2a g26(.a(x3), .b(x2), .O(new_n42_));
  nand3  g27(.a(x5), .b(x2), .c(new_n19_), .O(new_n43_));
  oai21  g28(.a(new_n42_), .b(new_n19_), .c(new_n43_), .O(new_n44_));
  ...
  oai21  g33(.a(new_n48_), .b(x1), .c(new_n29_), .O(z6));
endmodule
