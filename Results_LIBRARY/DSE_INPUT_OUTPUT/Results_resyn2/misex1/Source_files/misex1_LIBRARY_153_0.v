...
module FAU ( 
  ...
  nand4  g17(.a(new_n28_), .b(x3), .c(new_n20_), .d(x0), .O(new_n33_));
  oai21  g18(.a(new_n32_), .b(x0), .c(new_n33_), .O(z1));
  nand4  g19(.a(x6), .b(x3), .c(new_n16_), .d(x0), .O(new_n35_));
  nand3  g20(.a(new_n29_), .b(new_n19_), .c(x2), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(x0), .c(new_n35_), .O(new_n37_));
  ...
  nor2   g26(.a(new_n19_), .b(new_n16_), .O(new_n42_));
  ...
  nand4  g30(.a(new_n45_), .b(new_n19_), .c(x2), .d(new_n20_), .O(new_n46_));
  oai21  g31(.a(x4), .b(x3), .c(x7), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n28_), .c(new_n21_), .O(new_n48_));
  ...
  aoi21  g37(.a(x3), .b(new_n20_), .c(new_n39_), .O(new_n53_));
  oai21  g38(.a(new_n42_), .b(new_n53_), .c(new_n23_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n52_), .O(z4));
  nand3  g40(.a(x6), .b(x3), .c(new_n16_), .O(new_n56_));
  aoi21  g41(.a(new_n50_), .b(new_n56_), .c(new_n23_), .O(new_n57_));
  ...
  nand2  g45(.a(new_n60_), .b(new_n54_), .O(z5));
  inv1   g46(.a(new_n36_), .O(new_n62_));
  oai21  g47(.a(new_n57_), .b(new_n62_), .c(new_n20_), .O(new_n63_));
  oai21  g48(.a(x4), .b(x2), .c(new_n19_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n21_), .c(new_n18_), .O(new_n65_));
