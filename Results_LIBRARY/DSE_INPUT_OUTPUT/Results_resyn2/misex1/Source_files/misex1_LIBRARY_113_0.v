...
module FAU ( 
  ...
  aoi21  g19(.a(x5), .b(new_n18_), .c(x3), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n25_), .c(new_n16_), .O(new_n36_));
  oai21  g21(.a(x4), .b(x3), .c(x7), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n25_), .c(new_n18_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n36_), .O(z3));
  nor2   g24(.a(x3), .b(new_n25_), .O(new_n40_));
  oai21  g25(.a(new_n19_), .b(new_n25_), .c(new_n16_), .O(new_n41_));
  oai21  g26(.a(new_n40_), .b(x0), .c(new_n41_), .O(z4));
  aoi21  g27(.a(new_n19_), .b(x2), .c(new_n16_), .O(new_n43_));
  aoi21  g28(.a(new_n26_), .b(new_n24_), .c(new_n43_), .O(new_n44_));
