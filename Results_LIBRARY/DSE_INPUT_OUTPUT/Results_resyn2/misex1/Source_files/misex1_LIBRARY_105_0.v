...
module FAU ( 
  ...
  aoi21  g11(.a(new_n26_), .b(new_n21_), .c(new_n23_), .O(new_n27_));
  inv1   g12(.a(x1), .O(new_n28_));
  nand2  g13(.a(x6), .b(new_n17_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n16_), .c(new_n28_), .O(new_n30_));
  ...
  aoi21  g21(.a(new_n36_), .b(new_n17_), .c(new_n28_), .O(new_n37_));
  ...
  nand3  g34(.a(new_n49_), .b(new_n39_), .c(x2), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n24_), .O(z3));
  nor2   g36(.a(x3), .b(new_n16_), .O(new_n52_));
  aoi21  g37(.a(new_n26_), .b(x0), .c(new_n52_), .O(new_n53_));
  aoi21  g38(.a(new_n17_), .b(x2), .c(x0), .O(new_n54_));
  nand3  g39(.a(x3), .b(new_n16_), .c(new_n28_), .O(new_n55_));
  ...
  nand2  g45(.a(new_n60_), .b(new_n28_), .O(new_n61_));
  nand2  g46(.a(new_n54_), .b(new_n30_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n61_), .c(new_n23_), .O(z5));
  oai21  g48(.a(new_n58_), .b(new_n18_), .c(new_n32_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n28_), .O(new_n65_));
  inv1   g50(.a(x4), .O(new_n66_));
  aoi21  g51(.a(new_n47_), .b(new_n66_), .c(new_n20_), .O(new_n67_));
  aoi21  g52(.a(new_n67_), .b(new_n65_), .c(new_n23_), .O(z6));
endmodule
