...
module FAU ( 
  ...
  oai21  g08(.a(x5), .b(x4), .c(x2), .O(new_n24_));
  ...
  nand2  g14(.a(x6), .b(new_n23_), .O(new_n30_));
  ...
  nand2  g26(.a(new_n23_), .b(new_n41_), .O(new_n42_));
  aoi21  g27(.a(new_n40_), .b(new_n38_), .c(new_n42_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n36_), .c(new_n17_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n33_), .c(new_n19_), .O(z2));
  nand2  g30(.a(x5), .b(new_n41_), .O(new_n46_));
  ...
  oai21  g35(.a(new_n48_), .b(x3), .c(new_n50_), .O(z3));
  inv1   g36(.a(x4), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n23_), .c(x2), .O(new_n53_));
  ...
  nand3  g41(.a(x3), .b(new_n16_), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n41_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n55_), .O(z4));
  nand2  g44(.a(x3), .b(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n53_), .b(new_n60_), .c(new_n41_), .O(new_n61_));
  nand3  g46(.a(new_n20_), .b(x5), .c(x2), .O(new_n62_));
  ...
  nand3  g50(.a(new_n65_), .b(new_n56_), .c(new_n41_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n64_), .O(z5));
  nand3  g52(.a(new_n20_), .b(new_n37_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n61_), .c(new_n17_), .O(new_n70_));
  nand2  g55(.a(new_n56_), .b(new_n18_), .O(new_n71_));
