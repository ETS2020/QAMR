...
module FAU ( 
  ...
  nand3  g28(.a(new_n43_), .b(new_n21_), .c(new_n20_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n42_), .O(z3));
  nand2  g30(.a(new_n21_), .b(new_n20_), .O(new_n46_));
  nand2  g31(.a(new_n16_), .b(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n17_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n29_), .c(new_n46_), .O(z4));
  nor2   g34(.a(x3), .b(x0), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n27_), .O(new_n51_));
  oai21  g36(.a(new_n31_), .b(x1), .c(new_n50_), .O(new_n52_));
  oai21  g37(.a(x3), .b(x1), .c(x0), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n52_), .c(x2), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(z5));
  nand4  g40(.a(new_n35_), .b(new_n47_), .c(x1), .d(new_n17_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n44_), .c(new_n29_), .O(z6));
endmodule
