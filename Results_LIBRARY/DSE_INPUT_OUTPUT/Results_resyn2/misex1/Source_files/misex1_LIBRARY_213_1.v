...
module FAU ( 
  ...
  nand2  g14(.a(new_n25_), .b(new_n19_), .O(new_n30_));
  nand4  g15(.a(new_n30_), .b(new_n29_), .c(new_n28_), .d(new_n16_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n26_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n22_), .O(new_n33_));
  nand4  g18(.a(x6), .b(new_n17_), .c(new_n25_), .d(new_n16_), .O(new_n34_));
  ...
  nand3  g23(.a(new_n38_), .b(new_n17_), .c(new_n19_), .O(new_n39_));
  aoi21  g24(.a(x6), .b(new_n25_), .c(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n37_), .c(new_n16_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n26_), .c(new_n22_), .O(z2));
  nor2   g27(.a(new_n19_), .b(x0), .O(new_n43_));
  nor2   g28(.a(x4), .b(x2), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(x6), .O(new_n45_));
  nand2  g30(.a(x5), .b(new_n16_), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n22_), .c(x2), .d(new_n19_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n17_), .O(new_n49_));
  nor2   g34(.a(x7), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n43_), .O(new_n51_));
  ...
  inv1   g41(.a(new_n22_), .O(new_n57_));
  aoi21  g42(.a(new_n17_), .b(x2), .c(x0), .O(new_n58_));
  nor2   g43(.a(x2), .b(x1), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(x3), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n58_), .c(new_n57_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n56_), .O(z4));
  aoi21  g47(.a(new_n54_), .b(new_n53_), .c(new_n16_), .O(new_n63_));
  nor2   g48(.a(new_n38_), .b(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n19_), .O(new_n65_));
  oai21  g50(.a(new_n21_), .b(x3), .c(new_n59_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n58_), .c(new_n57_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n65_), .O(z5));
  inv1   g53(.a(new_n28_), .O(new_n69_));
  oai21  g54(.a(new_n63_), .b(new_n69_), .c(new_n19_), .O(new_n70_));
  oai21  g55(.a(x4), .b(x2), .c(new_n17_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n43_), .c(new_n57_), .O(new_n72_));
