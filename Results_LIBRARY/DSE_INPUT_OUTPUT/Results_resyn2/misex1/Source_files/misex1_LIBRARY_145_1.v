...
module FAU ( 
  ...
  oai21  g18(.a(new_n31_), .b(x6), .c(new_n17_), .O(new_n34_));
  ...
  oai21  g24(.a(new_n39_), .b(x0), .c(new_n34_), .O(z2));
  nand2  g25(.a(x5), .b(new_n24_), .O(new_n41_));
  nor2   g26(.a(x3), .b(new_n16_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x6), .O(new_n43_));
  oai21  g28(.a(x4), .b(x3), .c(x7), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n16_), .c(x1), .d(new_n24_), .O(new_n45_));
  ...
  aoi21  g33(.a(new_n47_), .b(new_n21_), .c(new_n48_), .O(new_n49_));
  oai21  g34(.a(new_n42_), .b(new_n31_), .c(new_n21_), .O(new_n50_));
  oai21  g35(.a(new_n49_), .b(x0), .c(new_n50_), .O(z4));
  inv1   g36(.a(x5), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x1), .c(new_n20_), .O(new_n53_));
  nor2   g38(.a(x6), .b(new_n16_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n48_), .O(new_n55_));
  xor2a  g40(.a(x3), .b(x2), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n21_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n55_), .b(x0), .c(new_n57_), .O(z5));
