...
module FAU ( 
  ...
  nand4  g17(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(new_n23_), .O(new_n33_));
  ...
  aoi22  g30(.a(new_n45_), .b(new_n25_), .c(x3), .d(x2), .O(new_n46_));
  nand2  g31(.a(new_n28_), .b(x2), .O(new_n47_));
  nand3  g32(.a(new_n24_), .b(x3), .c(new_n22_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g34(.a(new_n47_), .b(new_n23_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n16_), .O(new_n51_));
  oai21  g36(.a(new_n46_), .b(x0), .c(new_n51_), .O(z4));
  aoi21  g37(.a(new_n48_), .b(new_n47_), .c(new_n23_), .O(new_n53_));
  nor2   g38(.a(new_n37_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n45_), .b(x1), .O(new_n56_));
  oai21  g41(.a(new_n28_), .b(new_n22_), .c(new_n56_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n23_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n55_), .O(z5));
  inv1   g44(.a(new_n30_), .O(new_n60_));
  oai21  g45(.a(new_n53_), .b(new_n60_), .c(new_n16_), .O(new_n61_));
  oai21  g46(.a(x4), .b(x2), .c(new_n28_), .O(new_n62_));
  nand2  g47(.a(x6), .b(new_n22_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n62_), .c(new_n17_), .O(new_n64_));
