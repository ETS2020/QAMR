...
module FAU ( 
  ...
  aoi21  g03(.a(new_n18_), .b(x0), .c(x6), .O(new_n19_));
  ...
  oai21  g16(.a(new_n31_), .b(new_n27_), .c(new_n20_), .O(new_n32_));
  nand2  g17(.a(new_n21_), .b(new_n29_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n32_), .O(z1));
  inv1   g19(.a(x4), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(x2), .c(new_n16_), .O(new_n36_));
  nor2   g21(.a(x6), .b(x1), .O(new_n37_));
  aoi21  g22(.a(x5), .b(x2), .c(x3), .O(new_n38_));
  aoi22  g23(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(x1), .O(new_n39_));
  inv1   g24(.a(new_n30_), .O(new_n40_));
  nand2  g25(.a(new_n37_), .b(new_n40_), .O(new_n41_));
  oai21  g26(.a(new_n39_), .b(x0), .c(new_n41_), .O(z2));
  inv1   g27(.a(x7), .O(new_n43_));
  aoi21  g28(.a(new_n35_), .b(new_n16_), .c(new_n43_), .O(new_n44_));
  aoi21  g29(.a(x5), .b(new_n25_), .c(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n37_), .O(new_n46_));
  oai21  g31(.a(new_n44_), .b(new_n33_), .c(new_n46_), .O(z3));
  ...
  nand2  g36(.a(x6), .b(new_n20_), .O(new_n52_));
  nor2   g37(.a(x3), .b(x1), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n48_), .c(x2), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n52_), .c(new_n51_), .O(z4));
  nand2  g40(.a(x3), .b(new_n29_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n17_), .c(new_n25_), .O(new_n57_));
  nand3  g42(.a(x5), .b(x2), .c(new_n25_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n28_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n57_), .c(new_n20_), .O(new_n60_));
  nand2  g45(.a(new_n29_), .b(new_n20_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n17_), .c(new_n25_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n60_), .O(z5));
  oai21  g48(.a(new_n45_), .b(new_n40_), .c(new_n37_), .O(new_n64_));
