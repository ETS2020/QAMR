...
module FAU ( 
  ...
  aoi21  g07(.a(new_n22_), .b(x0), .c(x7), .O(new_n23_));
  ...
  oai21  g16(.a(new_n31_), .b(new_n27_), .c(new_n25_), .O(new_n32_));
  ...
  nand3  g22(.a(new_n29_), .b(new_n28_), .c(x2), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n37_), .c(new_n21_), .O(new_n39_));
  nand2  g24(.a(new_n29_), .b(x3), .O(new_n40_));
  ...
  aoi21  g30(.a(new_n45_), .b(new_n22_), .c(x7), .O(new_n46_));
  ...
  nand3  g35(.a(new_n29_), .b(new_n20_), .c(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g37(.a(new_n51_), .b(new_n25_), .O(new_n53_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n25_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n54_), .O(z4));
  aoi21  g43(.a(new_n51_), .b(new_n50_), .c(new_n25_), .O(new_n59_));
  nand4  g44(.a(new_n29_), .b(x5), .c(x2), .d(new_n25_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n29_), .b(x3), .c(x2), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n27_), .c(new_n25_), .O(new_n65_));
  ...
  aoi22  g54(.a(new_n69_), .b(new_n18_), .c(x7), .d(x2), .O(new_n70_));
