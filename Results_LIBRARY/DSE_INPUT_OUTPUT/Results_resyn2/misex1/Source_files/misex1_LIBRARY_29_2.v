...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n32_), .c(new_n17_), .O(z1));
  ...
  oai21  g22(.a(new_n16_), .b(new_n28_), .c(x6), .O(new_n38_));
  ...
  nor2   g27(.a(x3), .b(new_n28_), .O(new_n43_));
  nand2  g28(.a(x5), .b(new_n18_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n27_), .O(new_n45_));
  inv1   g30(.a(new_n19_), .O(new_n46_));
  oai21  g31(.a(x4), .b(x3), .c(x7), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n28_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n45_), .c(new_n17_), .O(z3));
  nor2   g34(.a(new_n43_), .b(x0), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  xnor2a g36(.a(x3), .b(x2), .O(new_n52_));
  or2    g37(.a(new_n52_), .b(x1), .O(new_n53_));
  nand4  g38(.a(x3), .b(new_n28_), .c(new_n27_), .d(new_n18_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n17_), .O(new_n55_));
  aoi21  g40(.a(new_n53_), .b(new_n51_), .c(new_n55_), .O(z4));
  oai22  g41(.a(new_n52_), .b(new_n18_), .c(new_n44_), .d(new_n28_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n27_), .O(new_n58_));
  nand2  g43(.a(new_n50_), .b(new_n30_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n58_), .c(new_n17_), .O(z5));
  inv1   g45(.a(new_n17_), .O(new_n61_));
  oai21  g46(.a(x4), .b(x2), .c(new_n21_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n46_), .O(new_n63_));
  oai21  g48(.a(new_n52_), .b(new_n18_), .c(new_n26_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n27_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n63_), .c(new_n61_), .O(z6));
endmodule
