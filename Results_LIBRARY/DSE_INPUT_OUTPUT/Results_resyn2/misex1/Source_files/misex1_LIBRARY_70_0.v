...
module FAU ( 
  ...
  aoi22  g15(.a(new_n30_), .b(new_n16_), .c(new_n29_), .d(new_n28_), .O(new_n31_));
  oai21  g16(.a(new_n30_), .b(new_n23_), .c(x6), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  oai21  g18(.a(new_n31_), .b(x0), .c(new_n33_), .O(z1));
  nand3  g19(.a(new_n27_), .b(new_n19_), .c(x2), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n20_), .O(new_n36_));
  nand2  g21(.a(x4), .b(new_n16_), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n19_), .c(x1), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n36_), .c(new_n23_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n33_), .O(z2));
  nand2  g25(.a(x5), .b(new_n23_), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n19_), .c(x2), .d(new_n20_), .O(new_n42_));
  oai21  g27(.a(x4), .b(x3), .c(x7), .O(new_n43_));
  nor2   g28(.a(new_n17_), .b(x2), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n21_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n42_), .O(z3));
  nand2  g31(.a(new_n19_), .b(x2), .O(new_n47_));
  nor2   g32(.a(new_n19_), .b(x1), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n16_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n47_), .c(new_n18_), .d(new_n23_), .O(new_n50_));
  nand2  g35(.a(new_n47_), .b(new_n23_), .O(new_n51_));
  nand3  g36(.a(x6), .b(x3), .c(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n47_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n51_), .c(new_n20_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n50_), .O(z4));
  aoi21  g40(.a(new_n52_), .b(new_n47_), .c(new_n23_), .O(new_n56_));
  ...
  nand2  g45(.a(new_n44_), .b(new_n48_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(new_n62_));
