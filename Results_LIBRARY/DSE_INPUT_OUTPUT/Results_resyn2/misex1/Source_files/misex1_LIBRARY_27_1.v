...
module FAU ( 
  ...
  nand2  g17(.a(new_n30_), .b(new_n25_), .O(new_n33_));
  ...
  aoi21  g21(.a(new_n36_), .b(x1), .c(new_n30_), .O(z3));
  oai21  g22(.a(new_n25_), .b(x2), .c(new_n20_), .O(new_n38_));
  inv1   g23(.a(new_n30_), .O(new_n39_));
  aoi21  g24(.a(new_n24_), .b(x2), .c(x0), .O(new_n40_));
  oai21  g25(.a(new_n39_), .b(new_n24_), .c(new_n40_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n38_), .O(z4));
  aoi21  g27(.a(new_n24_), .b(x2), .c(new_n30_), .O(new_n43_));
  nand3  g28(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n43_), .c(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n38_), .O(z5));
  oai21  g32(.a(x4), .b(x2), .c(new_n24_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n39_), .c(new_n17_), .O(new_n49_));
