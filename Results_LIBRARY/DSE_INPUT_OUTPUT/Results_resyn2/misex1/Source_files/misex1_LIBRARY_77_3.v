...
module FAU ( 
  ...
  nand3  g16(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(z1));
  ...
  nand2  g23(.a(new_n18_), .b(new_n20_), .O(new_n39_));
  aoi21  g24(.a(new_n38_), .b(new_n36_), .c(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n34_), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n22_), .O(z2));
  nand2  g27(.a(x7), .b(x3), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n30_), .c(x4), .O(new_n44_));
  ...
  nand3  g35(.a(new_n35_), .b(new_n18_), .c(x2), .O(new_n51_));
  inv1   g36(.a(new_n51_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n50_), .c(new_n17_), .O(new_n53_));
  nand3  g38(.a(new_n21_), .b(x1), .c(new_n20_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  nand3  g41(.a(new_n48_), .b(new_n17_), .c(new_n20_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n53_), .O(z4));
  oai21  g43(.a(new_n50_), .b(new_n26_), .c(new_n17_), .O(new_n59_));
  aoi22  g44(.a(new_n55_), .b(new_n49_), .c(x4), .d(x1), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(z5));
  nand2  g46(.a(new_n56_), .b(new_n53_), .O(z6));
endmodule
