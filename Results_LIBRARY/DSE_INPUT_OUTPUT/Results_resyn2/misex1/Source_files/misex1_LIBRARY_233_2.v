...
module FAU ( 
  ...
  nand2  g16(.a(new_n31_), .b(x5), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(x1), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n30_), .c(new_n29_), .O(z1));
  nand2  g19(.a(x4), .b(x1), .O(new_n35_));
  inv1   g20(.a(x1), .O(new_n36_));
  inv1   g21(.a(x6), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n17_), .c(new_n36_), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n35_), .c(x0), .O(new_n39_));
  nand3  g24(.a(x3), .b(new_n36_), .c(x0), .O(new_n40_));
  ...
  nand3  g29(.a(new_n43_), .b(new_n17_), .c(x2), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  aoi22  g31(.a(new_n46_), .b(new_n18_), .c(new_n43_), .d(x1), .O(new_n47_));
  ...
  nand4  g36(.a(new_n21_), .b(new_n17_), .c(x2), .d(new_n36_), .O(new_n52_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n31_), .c(new_n36_), .O(new_n57_));
  xnor2a g42(.a(x3), .b(x2), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n18_), .O(new_n59_));
  nand4  g44(.a(new_n59_), .b(new_n57_), .c(new_n45_), .d(new_n33_), .O(z4));
  nor2   g45(.a(new_n58_), .b(new_n18_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n27_), .c(new_n36_), .O(new_n62_));
  nand3  g47(.a(new_n55_), .b(new_n22_), .c(x1), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z5));
  oai21  g49(.a(x4), .b(x2), .c(new_n17_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n18_), .c(new_n43_), .O(new_n66_));
  inv1   g51(.a(new_n45_), .O(new_n67_));
  aoi21  g52(.a(new_n56_), .b(new_n19_), .c(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n66_), .b(new_n36_), .c(new_n68_), .O(z6));
endmodule
