...
module FAU ( 
  ...
  nor2   g02(.a(x7), .b(new_n17_), .O(new_n18_));
  ...
  nand4  g34(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n16_), .O(new_n50_));
  nand2  g35(.a(x7), .b(x0), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(x5), .c(x1), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n21_), .c(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n50_), .O(z3));
  nand2  g39(.a(new_n21_), .b(x2), .O(new_n55_));
  oai21  g40(.a(new_n28_), .b(new_n20_), .c(new_n55_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n23_), .O(new_n57_));
  xnor2a g42(.a(x3), .b(x2), .O(new_n58_));
  aoi22  g43(.a(new_n58_), .b(new_n20_), .c(new_n48_), .d(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n57_), .c(new_n18_), .O(z4));
  nand2  g45(.a(new_n55_), .b(new_n28_), .O(new_n61_));
  aoi21  g46(.a(new_n21_), .b(x2), .c(x0), .O(new_n62_));
  aoi22  g47(.a(new_n62_), .b(new_n32_), .c(new_n61_), .d(new_n27_), .O(new_n63_));
  ...
  nand2  g52(.a(new_n56_), .b(new_n52_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n21_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n48_), .c(new_n47_), .O(new_n70_));
