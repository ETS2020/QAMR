...
module FAU ( 
  ...
  nand4  g25(.a(new_n24_), .b(new_n19_), .c(x2), .d(new_n16_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n38_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n17_), .O(z3));
  oai21  g29(.a(new_n19_), .b(x1), .c(new_n18_), .O(new_n45_));
  oai21  g30(.a(x3), .b(new_n16_), .c(x2), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n45_), .c(x0), .O(z4));
  aoi21  g32(.a(new_n28_), .b(new_n18_), .c(new_n20_), .O(new_n48_));
  oai21  g33(.a(new_n24_), .b(new_n18_), .c(new_n38_), .O(new_n49_));
