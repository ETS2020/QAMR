...
module FAU ( 
  ...
  nand2  g11(.a(x3), .b(new_n20_), .O(new_n27_));
  ...
  aoi22  g16(.a(new_n31_), .b(new_n30_), .c(new_n28_), .d(new_n27_), .O(new_n32_));
  nand4  g17(.a(x6), .b(x3), .c(new_n16_), .d(x0), .O(new_n33_));
  inv1   g18(.a(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n20_), .O(new_n35_));
  oai21  g20(.a(new_n32_), .b(x0), .c(new_n35_), .O(z1));
  nand3  g21(.a(new_n29_), .b(new_n19_), .c(x2), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(x0), .c(new_n33_), .O(new_n38_));
  ...
  aoi22  g37(.a(new_n28_), .b(new_n27_), .c(x3), .d(x2), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x0), .c(new_n52_), .O(z4));
  ...
  nand3  g48(.a(new_n63_), .b(new_n59_), .c(new_n18_), .O(z5));
  nand2  g49(.a(new_n56_), .b(new_n37_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n20_), .O(new_n66_));
  oai21  g51(.a(x4), .b(x2), .c(new_n19_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(x1), .c(new_n23_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n66_), .c(new_n18_), .O(z6));
endmodule
