...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n31_), .c(new_n29_), .O(new_n34_));
  ...
  nand2  g31(.a(x5), .b(new_n29_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n21_), .O(new_n48_));
  ...
  nand2  g36(.a(new_n45_), .b(new_n26_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n21_), .O(new_n53_));
  oai21  g38(.a(new_n25_), .b(x7), .c(new_n17_), .O(new_n54_));
  nor2   g39(.a(new_n46_), .b(x0), .O(new_n55_));
