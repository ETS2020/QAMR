...
module FAU ( 
  ...
  nand4  g18(.a(new_n33_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n34_));
  inv1   g19(.a(new_n34_), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n32_), .c(new_n21_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n27_), .O(z2));
  nand2  g22(.a(new_n18_), .b(x2), .O(new_n38_));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n21_), .c(x2), .O(new_n40_));
  nor2   g25(.a(new_n33_), .b(x0), .O(new_n41_));
  oai22  g26(.a(new_n41_), .b(new_n38_), .c(new_n40_), .d(new_n16_), .O(z3));
  ...
  oai21  g31(.a(new_n18_), .b(x1), .c(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n45_), .b(x1), .c(new_n47_), .O(z4));
  nand2  g33(.a(x3), .b(new_n17_), .O(new_n49_));
  aoi21  g34(.a(new_n38_), .b(new_n49_), .c(new_n21_), .O(new_n50_));
  nor2   g35(.a(new_n24_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n23_), .b(new_n21_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z5));
  nand3  g39(.a(new_n33_), .b(new_n18_), .c(x2), .O(new_n55_));
  inv1   g40(.a(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n50_), .b(new_n56_), .c(new_n16_), .O(new_n57_));
  nand2  g42(.a(x4), .b(new_n18_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n46_), .c(x1), .O(new_n59_));
