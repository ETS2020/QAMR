...
module FAU ( 
  ...
  nand2  g11(.a(new_n18_), .b(x1), .O(new_n27_));
  ...
  nand3  g16(.a(new_n22_), .b(new_n24_), .c(new_n19_), .O(new_n32_));
  ...
  nand3  g21(.a(new_n36_), .b(new_n19_), .c(new_n17_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(x2), .c(new_n35_), .O(z3));
  nor2   g23(.a(x3), .b(new_n18_), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(x0), .c(new_n20_), .O(z4));
  oai21  g25(.a(x5), .b(x0), .c(new_n17_), .O(new_n41_));
  aoi22  g26(.a(new_n41_), .b(new_n39_), .c(new_n20_), .d(x0), .O(z5));
  aoi21  g27(.a(new_n29_), .b(new_n18_), .c(x3), .O(new_n43_));
  nand2  g28(.a(x1), .b(new_n16_), .O(new_n44_));
  oai22  g29(.a(new_n44_), .b(new_n43_), .c(new_n37_), .d(new_n18_), .O(z6));
endmodule
