...
module FAU ( 
  ...
  aoi21  g20(.a(new_n35_), .b(new_n31_), .c(x1), .O(z2));
  inv1   g21(.a(x1), .O(new_n37_));
  nand2  g22(.a(x5), .b(new_n18_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n17_), .c(new_n37_), .O(new_n39_));
  inv1   g24(.a(new_n39_), .O(z3));
  nand3  g25(.a(new_n28_), .b(new_n37_), .c(x0), .O(new_n41_));
  nand2  g26(.a(new_n28_), .b(new_n37_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n18_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n41_), .c(new_n39_), .O(z4));
  nand2  g29(.a(new_n26_), .b(new_n24_), .O(new_n45_));
  xor2a  g30(.a(x3), .b(x2), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n18_), .c(new_n37_), .O(new_n47_));
  aoi21  g32(.a(new_n45_), .b(new_n18_), .c(new_n47_), .O(z5));
  nand2  g33(.a(new_n24_), .b(new_n37_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n18_), .O(new_n50_));
  nand2  g35(.a(new_n46_), .b(new_n19_), .O(new_n51_));
