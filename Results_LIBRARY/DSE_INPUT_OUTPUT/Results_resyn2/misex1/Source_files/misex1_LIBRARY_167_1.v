...
module FAU ( 
  ...
  nand3  g23(.a(new_n31_), .b(new_n38_), .c(new_n28_), .O(new_n39_));
  nand2  g24(.a(new_n19_), .b(new_n16_), .O(new_n40_));
  aoi21  g25(.a(new_n39_), .b(new_n37_), .c(new_n40_), .O(new_n41_));
  aoi21  g26(.a(x4), .b(new_n28_), .c(x3), .O(new_n42_));
  oai21  g27(.a(new_n31_), .b(x2), .c(x1), .O(new_n43_));
  ...
  oai21  g32(.a(new_n47_), .b(x7), .c(new_n28_), .O(new_n48_));
  nor2   g33(.a(new_n36_), .b(x0), .O(new_n49_));
  nand3  g34(.a(new_n19_), .b(x2), .c(new_n16_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(z3));
  nand2  g36(.a(new_n19_), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n32_), .b(new_n18_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n16_), .O(new_n54_));
  nor2   g39(.a(new_n31_), .b(x2), .O(new_n55_));
  nand2  g40(.a(new_n33_), .b(new_n16_), .O(new_n56_));
  ...
  aoi21  g44(.a(new_n52_), .b(new_n32_), .c(new_n18_), .O(new_n60_));
  ...
  nand3  g48(.a(new_n23_), .b(new_n28_), .c(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n57_), .c(new_n55_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n63_), .O(z5));
  nand2  g51(.a(new_n26_), .b(x2), .O(new_n67_));
  ...
  aoi21  g55(.a(new_n70_), .b(new_n47_), .c(new_n55_), .O(new_n71_));
