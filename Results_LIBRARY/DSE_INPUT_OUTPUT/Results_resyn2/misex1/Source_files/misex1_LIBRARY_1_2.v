...
module FAU ( 
  ...
  nor2   g07(.a(new_n16_), .b(x1), .O(new_n23_));
  ...
  aoi22  g17(.a(new_n32_), .b(x1), .c(new_n23_), .d(new_n29_), .O(new_n33_));
  ...
  nand2  g21(.a(new_n23_), .b(new_n30_), .O(new_n37_));
  ...
  nand3  g26(.a(new_n41_), .b(new_n40_), .c(x1), .O(new_n42_));
  oai21  g27(.a(new_n39_), .b(new_n37_), .c(new_n42_), .O(z3));
  inv1   g28(.a(x0), .O(new_n44_));
  aoi21  g29(.a(x3), .b(new_n44_), .c(new_n17_), .O(new_n45_));
  oai21  g30(.a(new_n30_), .b(x1), .c(new_n41_), .O(new_n46_));
  oai21  g31(.a(new_n45_), .b(new_n16_), .c(new_n46_), .O(z4));
  oai21  g32(.a(new_n30_), .b(new_n16_), .c(new_n44_), .O(new_n48_));
  aoi21  g33(.a(new_n23_), .b(x5), .c(new_n48_), .O(new_n49_));
  aoi22  g34(.a(new_n49_), .b(new_n27_), .c(new_n37_), .d(x0), .O(z5));
  nand2  g35(.a(new_n23_), .b(new_n29_), .O(new_n51_));
  oai21  g36(.a(x4), .b(x2), .c(new_n30_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n20_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n51_), .c(new_n18_), .O(z6));
endmodule
