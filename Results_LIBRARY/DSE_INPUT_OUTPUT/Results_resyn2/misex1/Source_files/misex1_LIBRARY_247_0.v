...
module FAU ( 
  ...
  aoi22  g17(.a(new_n32_), .b(new_n30_), .c(new_n28_), .d(new_n26_), .O(new_n33_));
  nand4  g18(.a(new_n28_), .b(x3), .c(new_n19_), .d(x0), .O(new_n34_));
  oai21  g19(.a(new_n33_), .b(x0), .c(new_n34_), .O(z1));
  nand3  g20(.a(new_n29_), .b(new_n18_), .c(x2), .O(new_n36_));
  nand3  g21(.a(x3), .b(new_n31_), .c(x0), .O(new_n37_));
  oai22  g22(.a(new_n37_), .b(new_n27_), .c(new_n36_), .d(x0), .O(new_n38_));
  ...
  nor2   g27(.a(new_n18_), .b(new_n31_), .O(new_n43_));
  ...
  nand3  g31(.a(new_n46_), .b(new_n28_), .c(new_n20_), .O(new_n47_));
  ...
  nand2  g36(.a(new_n37_), .b(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n19_), .O(new_n53_));
  nand3  g38(.a(x3), .b(new_n31_), .c(new_n19_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n51_), .c(new_n22_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n53_), .c(new_n17_), .O(z4));
  nand3  g41(.a(x6), .b(x3), .c(new_n31_), .O(new_n57_));
  aoi21  g42(.a(new_n51_), .b(new_n57_), .c(new_n22_), .O(new_n58_));
  ...
  aoi21  g46(.a(x3), .b(new_n19_), .c(new_n40_), .O(new_n62_));
  oai21  g47(.a(new_n43_), .b(new_n62_), .c(new_n22_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n61_), .O(z5));
  inv1   g49(.a(new_n36_), .O(new_n65_));
  oai21  g50(.a(new_n58_), .b(new_n65_), .c(new_n19_), .O(new_n66_));
