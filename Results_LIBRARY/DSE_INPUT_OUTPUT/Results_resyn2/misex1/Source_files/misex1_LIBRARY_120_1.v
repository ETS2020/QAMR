...
module FAU ( 
  ...
  nand3  g29(.a(x3), .b(new_n22_), .c(new_n16_), .O(new_n45_));
  aoi21  g30(.a(new_n28_), .b(x2), .c(x0), .O(new_n46_));
  nand2  g31(.a(x6), .b(new_n22_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n48_));
  nand2  g33(.a(new_n28_), .b(x2), .O(new_n49_));
  nand3  g34(.a(new_n23_), .b(x3), .c(new_n22_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nor2   g36(.a(new_n46_), .b(x1), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n48_), .O(z4));
  aoi21  g39(.a(new_n50_), .b(new_n49_), .c(new_n27_), .O(new_n55_));
  nor2   g40(.a(new_n37_), .b(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n55_), .c(new_n16_), .O(new_n57_));
  aoi22  g42(.a(new_n46_), .b(new_n32_), .c(x6), .d(new_n22_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(z5));
  inv1   g44(.a(new_n30_), .O(new_n60_));
  oai21  g45(.a(new_n55_), .b(new_n60_), .c(new_n16_), .O(new_n61_));
  oai21  g46(.a(x4), .b(x2), .c(new_n28_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n47_), .c(new_n17_), .O(new_n63_));
