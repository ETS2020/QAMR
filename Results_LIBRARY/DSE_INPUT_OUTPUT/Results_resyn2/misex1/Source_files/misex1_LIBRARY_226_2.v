...
module FAU ( 
  ...
  nor2   g13(.a(x7), .b(new_n23_), .O(new_n29_));
  ...
  oai21  g26(.a(new_n41_), .b(new_n36_), .c(new_n18_), .O(new_n42_));
  nor2   g27(.a(x1), .b(new_n18_), .O(new_n43_));
  nand2  g28(.a(x3), .b(new_n23_), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n43_), .c(new_n29_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n42_), .O(z2));
  inv1   g32(.a(x7), .O(new_n48_));
  nand2  g33(.a(x5), .b(new_n18_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n37_), .c(new_n48_), .O(new_n50_));
  oai21  g35(.a(x4), .b(x3), .c(x7), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n32_), .c(x1), .O(new_n52_));
  oai21  g37(.a(new_n50_), .b(new_n23_), .c(new_n52_), .O(z3));
  ...
  nand2  g41(.a(x7), .b(x3), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(x2), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n44_), .b(x1), .c(new_n58_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z4));
  aoi21  g45(.a(new_n54_), .b(new_n44_), .c(new_n18_), .O(new_n61_));
  nand4  g46(.a(x7), .b(x5), .c(x2), .d(new_n18_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n16_), .O(new_n64_));
  oai21  g49(.a(new_n31_), .b(x2), .c(new_n58_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n64_), .O(z5));
  nand3  g51(.a(new_n25_), .b(x7), .c(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n61_), .c(new_n16_), .O(new_n69_));
  nand2  g54(.a(new_n57_), .b(x2), .O(new_n70_));
  nand2  g55(.a(x4), .b(new_n19_), .O(new_n71_));
  nand4  g56(.a(new_n71_), .b(new_n70_), .c(x1), .d(new_n18_), .O(new_n72_));
