...
module FAU ( 
  ...
  nand3  g16(.a(x3), .b(new_n16_), .c(new_n17_), .O(new_n32_));
  ...
  nand3  g22(.a(new_n37_), .b(new_n24_), .c(new_n17_), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n36_), .c(x6), .O(new_n39_));
  nor2   g24(.a(x4), .b(x3), .O(new_n40_));
  nand2  g25(.a(new_n16_), .b(x1), .O(new_n41_));
  nor2   g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n39_), .c(new_n23_), .O(new_n43_));
  ...
  nand4  g32(.a(new_n47_), .b(new_n20_), .c(new_n28_), .d(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(z3));
  oai21  g34(.a(x6), .b(new_n24_), .c(x2), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n32_), .c(new_n23_), .O(new_n51_));
  nand3  g36(.a(new_n28_), .b(new_n24_), .c(x2), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n23_), .O(new_n53_));
  nand2  g38(.a(x3), .b(new_n16_), .O(new_n54_));
  nand2  g39(.a(new_n52_), .b(new_n54_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n53_), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n51_), .O(z4));
  aoi21  g42(.a(new_n52_), .b(new_n54_), .c(new_n23_), .O(new_n58_));
  ...
  nand3  g47(.a(new_n62_), .b(new_n50_), .c(new_n23_), .O(new_n63_));
  ...
  nand3  g53(.a(new_n68_), .b(new_n50_), .c(new_n18_), .O(new_n69_));
