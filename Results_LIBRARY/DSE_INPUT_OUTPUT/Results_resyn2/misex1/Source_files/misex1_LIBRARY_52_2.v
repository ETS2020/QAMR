...
module FAU ( 
  ...
  aoi22  g11(.a(new_n16_), .b(x5), .c(new_n18_), .d(new_n26_), .O(new_n27_));
  nand3  g12(.a(x6), .b(new_n24_), .c(new_n26_), .O(new_n28_));
  ...
  oai21  g23(.a(x5), .b(new_n38_), .c(x6), .O(new_n39_));
  aoi22  g24(.a(new_n39_), .b(new_n20_), .c(new_n37_), .d(x1), .O(new_n40_));
  inv1   g25(.a(new_n17_), .O(new_n41_));
  nand3  g26(.a(x3), .b(new_n38_), .c(x0), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n18_), .c(new_n41_), .O(new_n44_));
  oai21  g29(.a(new_n40_), .b(x0), .c(new_n44_), .O(z2));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n19_), .c(new_n38_), .O(new_n47_));
  nand2  g32(.a(x5), .b(new_n26_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n20_), .c(x2), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n47_), .c(new_n17_), .O(z3));
  nand2  g35(.a(new_n24_), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n42_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  aoi21  g38(.a(new_n24_), .b(x2), .c(x0), .O(new_n54_));
  nand3  g39(.a(x3), .b(new_n38_), .c(new_n18_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n53_), .c(new_n17_), .O(z4));
  nand2  g42(.a(x3), .b(new_n38_), .O(new_n58_));
  aoi21  g43(.a(new_n51_), .b(new_n58_), .c(new_n26_), .O(new_n59_));
  nand3  g44(.a(x5), .b(new_n24_), .c(x2), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n18_), .O(new_n62_));
  nand2  g47(.a(x6), .b(new_n24_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n38_), .c(new_n18_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n54_), .c(new_n41_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  nand3  g51(.a(new_n32_), .b(new_n24_), .c(x2), .O(new_n67_));
  ...
  aoi21  g55(.a(new_n70_), .b(new_n19_), .c(new_n41_), .O(new_n71_));
