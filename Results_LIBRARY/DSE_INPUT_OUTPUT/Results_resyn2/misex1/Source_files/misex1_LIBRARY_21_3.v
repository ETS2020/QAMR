...
module FAU ( 
  ...
  nor2   g04(.a(x5), .b(new_n19_), .O(new_n20_));
  nand2  g05(.a(new_n20_), .b(new_n18_), .O(new_n21_));
  nand3  g06(.a(new_n19_), .b(new_n17_), .c(x0), .O(new_n22_));
  ...
  aoi21  g15(.a(x5), .b(x3), .c(x0), .O(new_n31_));
  ...
  aoi21  g20(.a(new_n35_), .b(new_n19_), .c(new_n17_), .O(new_n36_));
  nand2  g21(.a(x5), .b(x2), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n19_), .c(new_n17_), .O(new_n38_));
  ...
  nand3  g42(.a(new_n41_), .b(x3), .c(new_n16_), .O(new_n58_));
  ...
  inv1   g47(.a(new_n37_), .O(new_n63_));
  aoi21  g48(.a(new_n58_), .b(new_n57_), .c(new_n34_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n17_), .O(new_n65_));
  aoi22  g50(.a(new_n54_), .b(new_n30_), .c(x5), .d(x3), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n65_), .O(z5));
  nand2  g52(.a(new_n27_), .b(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n64_), .c(new_n17_), .O(new_n70_));
  nor3   g55(.a(x4), .b(x3), .c(x2), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n20_), .c(new_n18_), .O(new_n72_));
