...
module FAU ( 
  ...
  nor2   g17(.a(x5), .b(new_n18_), .O(new_n33_));
  ...
  oai21  g24(.a(new_n39_), .b(x1), .c(new_n17_), .O(z3));
  oai21  g25(.a(new_n25_), .b(x2), .c(new_n16_), .O(new_n41_));
  aoi22  g26(.a(new_n38_), .b(new_n19_), .c(new_n29_), .d(x0), .O(new_n42_));
