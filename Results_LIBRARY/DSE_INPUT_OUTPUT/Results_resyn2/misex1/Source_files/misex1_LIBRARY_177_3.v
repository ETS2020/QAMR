...
module FAU ( 
  ...
  aoi21  g13(.a(new_n28_), .b(new_n24_), .c(new_n25_), .O(new_n29_));
  ...
  nand3  g33(.a(new_n48_), .b(new_n46_), .c(new_n21_), .O(z3));
  ...
  aoi21  g45(.a(new_n53_), .b(new_n31_), .c(new_n25_), .O(new_n61_));
  ...
  aoi21  g50(.a(new_n65_), .b(new_n44_), .c(new_n25_), .O(new_n66_));
