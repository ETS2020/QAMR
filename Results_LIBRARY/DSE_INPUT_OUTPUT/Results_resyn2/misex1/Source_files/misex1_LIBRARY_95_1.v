...
module FAU ( 
  ...
  nand4  g18(.a(new_n33_), .b(new_n32_), .c(new_n23_), .d(new_n16_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n30_), .c(x1), .O(z2));
  aoi21  g20(.a(x5), .b(new_n16_), .c(new_n21_), .O(z3));
  nand2  g21(.a(x3), .b(new_n19_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n16_), .O(new_n38_));
  aoi21  g23(.a(new_n29_), .b(x0), .c(new_n20_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n38_), .c(x1), .O(z4));
  aoi21  g25(.a(new_n27_), .b(new_n25_), .c(x1), .O(new_n41_));
  nand2  g26(.a(new_n23_), .b(x2), .O(new_n42_));
  nand2  g27(.a(new_n37_), .b(new_n42_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n18_), .c(x0), .O(new_n44_));
  oai21  g29(.a(new_n41_), .b(x0), .c(new_n44_), .O(z5));
  nand2  g30(.a(new_n43_), .b(x0), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n25_), .c(x1), .O(z6));
endmodule
