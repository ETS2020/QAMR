...
module FAU ( 
  ...
  nand2  g21(.a(x5), .b(new_n36_), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n18_), .c(x2), .O(new_n38_));
  ...
  oai21  g30(.a(x5), .b(x0), .c(x2), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n28_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nor2   g33(.a(new_n23_), .b(x2), .O(new_n49_));
  aoi21  g34(.a(new_n28_), .b(x2), .c(new_n16_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n49_), .c(new_n36_), .O(new_n51_));
