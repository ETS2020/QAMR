...
module FAU ( 
  ...
  oai21  g06(.a(new_n21_), .b(x0), .c(x5), .O(new_n22_));
  ...
  nand3  g23(.a(new_n38_), .b(new_n26_), .c(new_n37_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n36_), .c(x0), .O(new_n40_));
  nand3  g25(.a(x3), .b(new_n37_), .c(x0), .O(new_n41_));
  inv1   g26(.a(new_n41_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n40_), .c(new_n18_), .O(new_n43_));
  inv1   g28(.a(x5), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n26_), .c(x2), .O(new_n45_));
  oai21  g30(.a(new_n26_), .b(new_n37_), .c(new_n45_), .O(new_n46_));
  nor2   g31(.a(x5), .b(new_n37_), .O(new_n47_));
  aoi21  g32(.a(new_n46_), .b(new_n16_), .c(new_n47_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n43_), .O(z2));
  oai21  g34(.a(new_n19_), .b(x1), .c(new_n44_), .O(new_n50_));
  oai21  g35(.a(x4), .b(x3), .c(x7), .O(new_n51_));
  nand4  g36(.a(new_n51_), .b(new_n18_), .c(x1), .d(new_n16_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n50_), .c(new_n20_), .O(z3));
  nand2  g38(.a(new_n26_), .b(x2), .O(new_n54_));
  aoi21  g39(.a(new_n32_), .b(new_n54_), .c(new_n16_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n18_), .c(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n55_), .c(new_n37_), .O(new_n57_));
  oai21  g42(.a(new_n19_), .b(x0), .c(x5), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x1), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n57_), .c(new_n45_), .O(z4));
  nand3  g45(.a(x5), .b(x2), .c(new_n16_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n55_), .c(new_n37_), .O(new_n63_));
  nand2  g48(.a(new_n18_), .b(x1), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n27_), .c(new_n21_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n16_), .c(new_n47_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  oai21  g52(.a(new_n33_), .b(new_n19_), .c(new_n17_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n26_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x1), .c(new_n16_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n68_), .c(new_n50_), .O(z6));
endmodule
