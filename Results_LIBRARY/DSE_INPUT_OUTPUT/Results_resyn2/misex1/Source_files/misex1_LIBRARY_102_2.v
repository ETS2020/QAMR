...
module FAU ( 
  ...
  nand4  g18(.a(new_n33_), .b(new_n32_), .c(new_n22_), .d(new_n19_), .O(new_n34_));
  ...
  oai21  g25(.a(new_n22_), .b(x0), .c(new_n19_), .O(new_n41_));
  ...
  nand2  g31(.a(new_n33_), .b(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n19_), .O(new_n48_));
  nand3  g33(.a(new_n43_), .b(new_n23_), .c(new_n42_), .O(new_n49_));
  ...
  aoi21  g38(.a(new_n53_), .b(new_n39_), .c(x0), .O(z6));
endmodule
