...
module FAU ( 
  ...
  oai21  g11(.a(new_n21_), .b(new_n19_), .c(new_n26_), .O(new_n27_));
  ...
  nand3  g37(.a(x3), .b(new_n25_), .c(new_n20_), .O(new_n53_));
  aoi21  g38(.a(new_n19_), .b(x2), .c(x0), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n52_), .c(new_n41_), .O(z4));
  nand3  g41(.a(new_n26_), .b(x3), .c(new_n25_), .O(new_n57_));
  ...
  nand3  g46(.a(new_n54_), .b(new_n41_), .c(new_n32_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n61_), .O(z5));
  inv1   g48(.a(new_n58_), .O(new_n64_));
  aoi21  g49(.a(new_n54_), .b(new_n41_), .c(new_n20_), .O(new_n65_));
  aoi21  g50(.a(new_n29_), .b(x2), .c(x1), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n64_), .c(new_n65_), .O(z6));
endmodule
