...
module FAU ( 
  ...
  oai21  g36(.a(new_n28_), .b(new_n16_), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n19_), .O(new_n53_));
  aoi21  g38(.a(new_n17_), .b(x2), .c(x0), .O(new_n54_));
  nand3  g39(.a(x3), .b(new_n27_), .c(new_n19_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n54_), .c(new_n22_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n53_), .O(z4));
  aoi21  g42(.a(new_n51_), .b(new_n28_), .c(new_n16_), .O(new_n58_));
  ...
  aoi21  g46(.a(new_n54_), .b(new_n32_), .c(new_n22_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n61_), .O(z5));
  inv1   g48(.a(new_n34_), .O(new_n64_));
  oai21  g49(.a(new_n58_), .b(new_n64_), .c(new_n19_), .O(new_n65_));
  oai21  g50(.a(x4), .b(x2), .c(new_n17_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n45_), .c(new_n22_), .O(new_n67_));
