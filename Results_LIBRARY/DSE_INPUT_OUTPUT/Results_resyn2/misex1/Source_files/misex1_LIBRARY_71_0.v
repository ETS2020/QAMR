...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n31_), .c(new_n23_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n29_), .O(z1));
  nand2  g20(.a(x5), .b(new_n16_), .O(new_n36_));
  nor2   g21(.a(x4), .b(x3), .O(new_n37_));
  oai22  g22(.a(new_n37_), .b(new_n36_), .c(new_n19_), .d(new_n16_), .O(new_n38_));
  oai21  g23(.a(x6), .b(x2), .c(x5), .O(new_n39_));
  nor2   g24(.a(x3), .b(x1), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n39_), .c(new_n18_), .O(new_n41_));
  inv1   g26(.a(new_n41_), .O(new_n42_));
  aoi21  g27(.a(new_n38_), .b(x1), .c(new_n42_), .O(new_n43_));
  inv1   g28(.a(new_n36_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n28_), .O(new_n45_));
  oai21  g30(.a(new_n43_), .b(x0), .c(new_n45_), .O(z2));
  oai21  g31(.a(x4), .b(x3), .c(x7), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n21_), .c(new_n17_), .O(new_n48_));
  nor2   g33(.a(new_n17_), .b(x0), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n40_), .c(x2), .O(new_n51_));
  oai21  g36(.a(new_n48_), .b(x2), .c(new_n51_), .O(z3));
  nand2  g37(.a(x3), .b(new_n20_), .O(new_n53_));
  aoi22  g38(.a(new_n44_), .b(new_n53_), .c(x3), .d(x2), .O(new_n54_));
  nand2  g39(.a(new_n19_), .b(x2), .O(new_n55_));
  oai21  g40(.a(new_n36_), .b(new_n19_), .c(new_n55_), .O(new_n56_));
  aoi21  g41(.a(new_n19_), .b(x2), .c(x0), .O(new_n57_));
  nor2   g42(.a(new_n57_), .b(x1), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  oai21  g44(.a(new_n54_), .b(x0), .c(new_n59_), .O(z4));
  aoi22  g45(.a(new_n56_), .b(x0), .c(new_n49_), .d(x2), .O(new_n61_));
  aoi22  g46(.a(new_n57_), .b(new_n33_), .c(new_n17_), .d(new_n16_), .O(new_n62_));
  oai21  g47(.a(new_n61_), .b(x1), .c(new_n62_), .O(z5));
  nand3  g48(.a(new_n56_), .b(new_n50_), .c(new_n20_), .O(new_n64_));
  oai21  g49(.a(x4), .b(x2), .c(new_n19_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n21_), .c(new_n18_), .O(new_n66_));
