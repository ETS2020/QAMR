...
module FAU ( 
  ...
  nand2  g36(.a(new_n51_), .b(new_n41_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n16_), .O(new_n53_));
  nand3  g38(.a(x3), .b(new_n23_), .c(x0), .O(new_n54_));
  nor2   g39(.a(new_n41_), .b(x0), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n50_), .c(new_n54_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n24_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n53_), .O(z4));
  nor2   g43(.a(new_n20_), .b(x2), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n47_), .c(new_n17_), .O(new_n60_));
  nor2   g45(.a(new_n26_), .b(x2), .O(new_n61_));
  nand2  g46(.a(new_n50_), .b(new_n18_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z5));
  oai21  g48(.a(x4), .b(x2), .c(new_n20_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(x1), .c(x5), .O(new_n65_));
  nand2  g50(.a(new_n54_), .b(new_n50_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n24_), .O(new_n67_));
  oai21  g52(.a(new_n65_), .b(x0), .c(new_n67_), .O(z6));
endmodule
