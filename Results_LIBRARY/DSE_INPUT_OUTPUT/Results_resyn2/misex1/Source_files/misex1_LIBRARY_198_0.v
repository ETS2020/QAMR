...
module FAU ( 
  ...
  nand4  g29(.a(new_n44_), .b(new_n26_), .c(x1), .d(new_n22_), .O(new_n45_));
  nand2  g30(.a(x5), .b(new_n22_), .O(new_n46_));
  nor2   g31(.a(x3), .b(new_n26_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n46_), .c(x4), .d(new_n17_), .O(new_n48_));
  ...
  inv1   g46(.a(new_n47_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(x1), .c(new_n22_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n61_), .O(z5));
  aoi22  g49(.a(new_n20_), .b(new_n26_), .c(x3), .d(x1), .O(new_n65_));
  aoi21  g50(.a(new_n30_), .b(x2), .c(new_n20_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n57_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n17_), .O(new_n68_));
  oai21  g53(.a(new_n65_), .b(x0), .c(new_n68_), .O(z6));
endmodule
