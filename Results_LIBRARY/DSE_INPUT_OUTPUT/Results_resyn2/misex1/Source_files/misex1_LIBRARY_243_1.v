...
module FAU ( 
  ...
  oai21  g19(.a(x6), .b(x0), .c(new_n23_), .O(new_n35_));
  ...
  aoi21  g28(.a(new_n27_), .b(new_n25_), .c(x1), .O(new_n44_));
  oai21  g29(.a(new_n29_), .b(new_n18_), .c(new_n20_), .O(new_n45_));
  oai21  g30(.a(new_n44_), .b(x0), .c(new_n45_), .O(z5));
  nand2  g31(.a(new_n38_), .b(new_n18_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n30_), .c(x1), .O(z6));
endmodule
