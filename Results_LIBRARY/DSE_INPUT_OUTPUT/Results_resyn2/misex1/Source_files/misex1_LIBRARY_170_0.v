...
module FAU ( 
  ...
  nor2   g45(.a(new_n52_), .b(new_n29_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n17_), .O(new_n62_));
  nand4  g47(.a(x6), .b(new_n18_), .c(new_n32_), .d(new_n22_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z5));
  nand2  g49(.a(new_n58_), .b(new_n37_), .O(new_n65_));
