...
module FAU ( 
  ...
  nand3  g07(.a(new_n22_), .b(x1), .c(new_n21_), .O(new_n23_));
  ...
  nand3  g22(.a(new_n37_), .b(new_n25_), .c(x2), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n21_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n16_), .O(new_n40_));
  inv1   g25(.a(new_n23_), .O(new_n41_));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n40_), .O(z3));
  aoi21  g29(.a(new_n22_), .b(x1), .c(new_n18_), .O(new_n45_));
  nor2   g30(.a(x3), .b(x2), .O(new_n46_));
  aoi21  g31(.a(x2), .b(new_n16_), .c(new_n46_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n45_), .c(x0), .O(z4));
  nand2  g33(.a(x3), .b(x2), .O(new_n49_));
  nand2  g34(.a(new_n22_), .b(x1), .O(new_n50_));
  nand3  g35(.a(new_n26_), .b(new_n50_), .c(new_n49_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n21_), .O(new_n52_));
  oai21  g37(.a(new_n37_), .b(new_n22_), .c(new_n21_), .O(new_n53_));
  ...
  nand2  g42(.a(new_n57_), .b(new_n40_), .O(z6));
endmodule
