...
module FAU ( 
  ...
  nor2   g43(.a(new_n20_), .b(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n58_), .b(new_n19_), .c(new_n59_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(z4));
  nand3  g46(.a(new_n32_), .b(new_n26_), .c(new_n21_), .O(new_n62_));
  aoi21  g47(.a(new_n54_), .b(new_n35_), .c(new_n59_), .O(new_n63_));
  ...
  nand3  g52(.a(new_n67_), .b(new_n58_), .c(new_n20_), .O(new_n68_));
