...
module FAU ( 
  ...
  nand3  g24(.a(new_n24_), .b(x2), .c(new_n17_), .O(new_n40_));
  aoi21  g25(.a(x5), .b(new_n21_), .c(new_n40_), .O(z3));
  xnor2a g26(.a(x3), .b(x2), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n21_), .O(new_n43_));
  oai21  g28(.a(new_n28_), .b(x1), .c(new_n22_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n40_), .O(z4));
  nor2   g30(.a(new_n42_), .b(new_n21_), .O(new_n46_));
  aoi21  g31(.a(new_n34_), .b(new_n25_), .c(x0), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n46_), .c(new_n17_), .O(new_n48_));
  nand3  g33(.a(x3), .b(x2), .c(new_n21_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(z5));
  xor2a  g35(.a(x3), .b(x2), .O(new_n51_));
  aoi22  g36(.a(new_n51_), .b(x0), .c(new_n23_), .d(x2), .O(new_n52_));
  nand2  g37(.a(new_n49_), .b(x2), .O(new_n53_));
