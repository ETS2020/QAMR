...
module FAU ( 
  ...
  nand2  g17(.a(new_n30_), .b(x3), .O(new_n33_));
  inv1   g18(.a(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(x0), .O(new_n35_));
  oai21  g20(.a(new_n32_), .b(x0), .c(new_n35_), .O(z2));
  oai21  g21(.a(x4), .b(x3), .c(x7), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n17_), .c(x2), .O(new_n38_));
  aoi21  g23(.a(x2), .b(x1), .c(new_n38_), .O(z3));
  oai21  g24(.a(x3), .b(new_n21_), .c(new_n20_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n34_), .c(new_n24_), .O(z4));
  oai21  g26(.a(new_n40_), .b(new_n25_), .c(new_n35_), .O(z5));
  inv1   g27(.a(new_n17_), .O(new_n43_));
  aoi21  g28(.a(new_n28_), .b(new_n21_), .c(x3), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n43_), .c(new_n35_), .O(z6));
endmodule
