...
module FAU ( 
  ...
  aoi21  g11(.a(new_n26_), .b(new_n24_), .c(new_n25_), .O(new_n27_));
  ...
  nand2  g24(.a(x6), .b(new_n28_), .O(new_n40_));
  ...
  nand3  g33(.a(new_n48_), .b(new_n39_), .c(x2), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n47_), .c(new_n21_), .O(z3));
  aoi21  g35(.a(new_n17_), .b(x2), .c(x0), .O(new_n51_));
  inv1   g36(.a(new_n51_), .O(new_n52_));
  xnor2a g37(.a(x3), .b(x2), .O(new_n53_));
  or2    g38(.a(new_n53_), .b(x1), .O(new_n54_));
  nand4  g39(.a(x3), .b(new_n28_), .c(new_n19_), .d(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  aoi21  g41(.a(new_n54_), .b(new_n52_), .c(new_n56_), .O(z4));
  oai22  g42(.a(new_n53_), .b(new_n16_), .c(new_n48_), .d(new_n28_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n19_), .O(new_n59_));
  aoi21  g44(.a(new_n51_), .b(new_n30_), .c(new_n25_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(z5));
  oai21  g46(.a(x4), .b(x2), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n45_), .O(new_n63_));
  oai21  g48(.a(new_n53_), .b(new_n16_), .c(new_n32_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n63_), .c(new_n25_), .O(z6));
endmodule
