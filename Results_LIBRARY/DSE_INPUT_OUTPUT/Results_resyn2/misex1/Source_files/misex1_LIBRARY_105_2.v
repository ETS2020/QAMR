...
module FAU ( 
  ...
  nand3  g24(.a(new_n39_), .b(new_n17_), .c(new_n29_), .O(new_n40_));
  ...
  nand3  g29(.a(new_n16_), .b(x1), .c(new_n18_), .O(new_n45_));
  ...
  aoi21  g36(.a(new_n27_), .b(x0), .c(new_n51_), .O(new_n52_));
  aoi21  g37(.a(new_n17_), .b(x2), .c(x0), .O(new_n53_));
  nand3  g38(.a(x3), .b(new_n16_), .c(new_n29_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n24_), .O(new_n55_));
  oai21  g40(.a(new_n52_), .b(x1), .c(new_n55_), .O(z4));
  xnor2a g41(.a(x3), .b(x2), .O(new_n57_));
  nand3  g42(.a(x5), .b(new_n17_), .c(x2), .O(new_n58_));
  oai21  g43(.a(new_n57_), .b(new_n18_), .c(new_n58_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n29_), .O(new_n60_));
  nand2  g45(.a(new_n53_), .b(new_n31_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n24_), .O(z5));
  oai21  g47(.a(new_n57_), .b(new_n18_), .c(new_n33_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n29_), .O(new_n64_));
  aoi21  g49(.a(new_n46_), .b(new_n23_), .c(new_n20_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n64_), .c(new_n24_), .O(z6));
endmodule
