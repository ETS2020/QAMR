...
module FAU ( 
  ...
  nand2  g06(.a(new_n18_), .b(new_n21_), .O(new_n22_));
  ...
  nor2   g17(.a(x5), .b(new_n21_), .O(new_n33_));
  ...
  oai22  g26(.a(new_n41_), .b(x1), .c(new_n39_), .d(new_n22_), .O(z3));
  nand3  g27(.a(x3), .b(new_n21_), .c(new_n16_), .O(new_n43_));
