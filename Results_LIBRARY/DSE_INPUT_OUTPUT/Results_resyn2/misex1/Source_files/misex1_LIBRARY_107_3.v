...
module FAU ( 
  ...
  nand3  g12(.a(x6), .b(new_n16_), .c(new_n21_), .O(new_n28_));
  aoi21  g13(.a(new_n28_), .b(new_n27_), .c(x0), .O(new_n29_));
  nand2  g14(.a(new_n28_), .b(x1), .O(new_n30_));
  ...
  oai21  g19(.a(new_n34_), .b(x6), .c(x1), .O(new_n35_));
  ...
  nand3  g32(.a(new_n47_), .b(new_n42_), .c(new_n39_), .O(z2));
  oai21  g33(.a(x4), .b(x3), .c(x7), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n34_), .c(x6), .O(new_n50_));
  nand2  g35(.a(x5), .b(new_n17_), .O(new_n51_));
  nand4  g36(.a(new_n51_), .b(new_n16_), .c(x2), .d(new_n22_), .O(new_n52_));
  oai21  g37(.a(new_n50_), .b(new_n22_), .c(new_n52_), .O(z3));
  nand2  g38(.a(new_n16_), .b(x2), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n32_), .c(new_n17_), .O(new_n55_));
  nand3  g40(.a(new_n43_), .b(new_n16_), .c(x2), .O(new_n56_));
  inv1   g41(.a(new_n56_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n55_), .c(new_n22_), .O(new_n58_));
  nand2  g43(.a(new_n46_), .b(new_n32_), .O(new_n59_));
  aoi21  g44(.a(new_n16_), .b(x2), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x6), .c(x1), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n59_), .c(new_n58_), .O(z4));
  oai21  g47(.a(new_n55_), .b(new_n29_), .c(new_n22_), .O(new_n63_));
  nand2  g48(.a(new_n54_), .b(new_n20_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n63_), .O(z5));
  oai21  g50(.a(x4), .b(x2), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n20_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n58_), .O(z6));
endmodule
