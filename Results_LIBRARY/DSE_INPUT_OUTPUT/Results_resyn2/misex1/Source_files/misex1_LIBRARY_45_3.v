...
module FAU ( 
  ...
  nand3  g35(.a(new_n35_), .b(x1), .c(new_n16_), .O(new_n51_));
  oai21  g36(.a(new_n21_), .b(new_n22_), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n25_), .O(new_n53_));
  nand2  g38(.a(new_n18_), .b(new_n35_), .O(new_n54_));
  nand2  g39(.a(new_n23_), .b(x0), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n26_), .c(new_n20_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n53_), .O(z4));
  xor2a  g42(.a(x3), .b(x2), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x0), .O(new_n59_));
  nand4  g44(.a(new_n39_), .b(new_n26_), .c(new_n28_), .d(new_n16_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n20_), .O(new_n62_));
  oai21  g47(.a(new_n47_), .b(x0), .c(new_n35_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(x1), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n62_), .O(z5));
  nand2  g50(.a(new_n59_), .b(new_n28_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n20_), .O(new_n67_));
  inv1   g52(.a(new_n51_), .O(new_n68_));
