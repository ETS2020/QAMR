...
module FAU ( 
  ...
  oai21  g06(.a(x5), .b(x3), .c(new_n21_), .O(new_n22_));
  inv1   g07(.a(x3), .O(new_n23_));
  oai21  g08(.a(new_n23_), .b(x1), .c(new_n20_), .O(new_n24_));
  ...
  aoi21  g16(.a(x4), .b(new_n20_), .c(x3), .O(new_n32_));
  nand4  g17(.a(new_n26_), .b(new_n23_), .c(new_n20_), .d(new_n16_), .O(new_n33_));
  oai21  g18(.a(new_n32_), .b(new_n16_), .c(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n31_), .O(new_n35_));
  nor2   g20(.a(x5), .b(x3), .O(new_n36_));
  aoi22  g21(.a(new_n24_), .b(x0), .c(new_n21_), .d(new_n36_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n35_), .O(z2));
  aoi21  g23(.a(new_n36_), .b(new_n16_), .c(x0), .O(new_n39_));
  oai21  g24(.a(x4), .b(x3), .c(x7), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n28_), .c(x1), .O(new_n41_));
  oai21  g26(.a(new_n39_), .b(new_n20_), .c(new_n41_), .O(z3));
  or2    g27(.a(new_n24_), .b(x0), .O(new_n43_));
  oai21  g28(.a(x3), .b(new_n16_), .c(x2), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n25_), .O(z4));
  inv1   g30(.a(x5), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(x1), .c(new_n23_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x2), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n29_), .c(new_n25_), .O(z5));
  oai21  g34(.a(x4), .b(x2), .c(new_n23_), .O(new_n50_));
