...
module FAU ( 
  ...
  oai21  g15(.a(new_n30_), .b(new_n26_), .c(new_n24_), .O(z1));
  ...
  and2   g22(.a(new_n37_), .b(new_n24_), .O(new_n38_));
  oai21  g23(.a(new_n36_), .b(x0), .c(new_n38_), .O(z2));
  nand2  g24(.a(x5), .b(new_n27_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n21_), .c(new_n20_), .O(new_n41_));
  ...
  nand2  g29(.a(new_n32_), .b(x2), .O(new_n45_));
  oai21  g30(.a(new_n25_), .b(new_n27_), .c(new_n45_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n17_), .O(new_n47_));
  aoi21  g32(.a(x3), .b(new_n17_), .c(x0), .O(new_n48_));
  aoi21  g33(.a(new_n32_), .b(x2), .c(x0), .O(new_n49_));
  oai22  g34(.a(new_n49_), .b(new_n20_), .c(new_n48_), .d(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n47_), .O(z4));
  nand3  g36(.a(x6), .b(new_n32_), .c(x2), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n25_), .c(new_n27_), .O(new_n53_));
  nand4  g38(.a(x6), .b(x5), .c(x2), .d(new_n27_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(x6), .b(new_n32_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n16_), .c(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n49_), .c(new_n37_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z5));
  xor2a  g45(.a(x3), .b(x2), .O(new_n61_));
  aoi22  g46(.a(new_n61_), .b(x0), .c(new_n28_), .d(x2), .O(new_n62_));
  oai21  g47(.a(x4), .b(x2), .c(new_n32_), .O(new_n63_));
  aoi22  g48(.a(new_n63_), .b(new_n18_), .c(new_n20_), .d(x2), .O(new_n64_));
