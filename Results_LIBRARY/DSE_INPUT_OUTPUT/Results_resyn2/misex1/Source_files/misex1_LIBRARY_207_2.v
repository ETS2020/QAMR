...
module FAU ( 
  ...
  nand3  g03(.a(new_n18_), .b(x5), .c(x3), .O(new_n19_));
  ...
  aoi21  g18(.a(new_n30_), .b(new_n29_), .c(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n27_), .O(z1));
  inv1   g20(.a(x0), .O(new_n36_));
  nand2  g21(.a(x6), .b(new_n16_), .O(new_n37_));
  nand4  g22(.a(new_n37_), .b(new_n25_), .c(new_n20_), .d(new_n17_), .O(new_n38_));
  nand2  g23(.a(new_n20_), .b(x2), .O(new_n39_));
  inv1   g24(.a(x4), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n20_), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n39_), .c(new_n32_), .d(x1), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n38_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n36_), .O(new_n44_));
  nor2   g29(.a(x2), .b(x1), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(x5), .c(x3), .d(x0), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(z2));
  aoi21  g32(.a(new_n20_), .b(x0), .c(new_n31_), .O(new_n48_));
  nor2   g33(.a(new_n16_), .b(x1), .O(new_n49_));
  nor2   g34(.a(new_n49_), .b(x3), .O(new_n50_));
  nand2  g35(.a(new_n41_), .b(x7), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n30_), .c(x1), .O(new_n52_));
  oai21  g37(.a(new_n50_), .b(new_n48_), .c(new_n52_), .O(z3));
  nor2   g38(.a(x5), .b(new_n16_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n24_), .c(new_n17_), .O(new_n55_));
  oai21  g40(.a(new_n49_), .b(new_n30_), .c(new_n20_), .O(new_n56_));
  inv1   g41(.a(new_n45_), .O(new_n57_));
  aoi21  g42(.a(new_n20_), .b(x2), .c(x0), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n57_), .c(new_n33_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n56_), .c(new_n55_), .O(z4));
  nand2  g45(.a(x3), .b(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n39_), .b(new_n61_), .c(new_n36_), .O(new_n62_));
  nor2   g47(.a(new_n25_), .b(x3), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n45_), .b(new_n28_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n58_), .c(new_n33_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n64_), .O(z5));
  oai21  g52(.a(new_n62_), .b(new_n54_), .c(new_n17_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n20_), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n18_), .c(new_n33_), .O(new_n70_));
