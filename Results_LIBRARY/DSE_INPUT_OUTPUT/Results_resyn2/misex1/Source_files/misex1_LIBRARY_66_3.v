...
module FAU ( 
  ...
  oai21  g29(.a(x5), .b(new_n26_), .c(new_n44_), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n20_), .c(new_n21_), .d(new_n16_), .O(new_n46_));
  ...
  oai21  g36(.a(new_n20_), .b(x2), .c(new_n16_), .O(new_n52_));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x0), .O(new_n54_));
  nand2  g39(.a(new_n28_), .b(x2), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n21_), .O(new_n57_));
  nor2   g42(.a(new_n17_), .b(new_n21_), .O(new_n58_));
  nand2  g43(.a(new_n26_), .b(new_n21_), .O(new_n59_));
  aoi21  g44(.a(new_n20_), .b(x2), .c(x0), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  ...
  inv1   g50(.a(new_n53_), .O(new_n66_));
  aoi21  g51(.a(new_n43_), .b(new_n26_), .c(x0), .O(new_n67_));
  aoi22  g52(.a(new_n67_), .b(new_n66_), .c(new_n34_), .d(x1), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z5));
  aoi22  g54(.a(new_n53_), .b(x0), .c(new_n28_), .d(x2), .O(new_n70_));
  nor2   g55(.a(new_n21_), .b(x0), .O(new_n71_));
  oai21  g56(.a(x4), .b(x2), .c(new_n20_), .O(new_n72_));
  aoi21  g57(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(new_n73_));
  oai21  g58(.a(new_n70_), .b(x1), .c(new_n73_), .O(z6));
endmodule
