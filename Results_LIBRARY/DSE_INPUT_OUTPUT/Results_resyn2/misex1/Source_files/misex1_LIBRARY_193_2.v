...
module FAU ( 
  ...
  aoi21  g07(.a(new_n22_), .b(new_n20_), .c(new_n21_), .O(new_n23_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n41_), .c(new_n33_), .O(z3));
  nand2  g29(.a(x3), .b(new_n20_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n40_), .O(new_n46_));
  aoi21  g31(.a(x3), .b(x2), .c(x1), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n45_), .c(new_n46_), .O(z4));
  aoi21  g33(.a(new_n26_), .b(new_n17_), .c(new_n20_), .O(new_n49_));
  oai21  g34(.a(new_n32_), .b(x1), .c(new_n17_), .O(new_n50_));
  ...
  nand2  g38(.a(new_n26_), .b(new_n17_), .O(new_n54_));
  nor2   g39(.a(new_n32_), .b(x0), .O(new_n55_));
  inv1   g40(.a(x4), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n21_), .c(x3), .O(new_n57_));
  nand2  g42(.a(x1), .b(new_n20_), .O(new_n58_));
  oai22  g43(.a(new_n58_), .b(new_n57_), .c(new_n55_), .d(new_n54_), .O(z6));
endmodule
