...
module FAU ( 
  ...
  nand4  g22(.a(new_n24_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n38_));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nor2   g24(.a(x2), .b(x0), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n39_), .c(x1), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n38_), .c(new_n18_), .O(z3));
  inv1   g27(.a(x0), .O(new_n43_));
  aoi21  g28(.a(x3), .b(new_n43_), .c(new_n17_), .O(new_n44_));
  oai21  g29(.a(new_n23_), .b(x1), .c(new_n40_), .O(new_n45_));
  oai21  g30(.a(new_n44_), .b(new_n16_), .c(new_n45_), .O(z4));
  nand3  g31(.a(x6), .b(new_n23_), .c(new_n16_), .O(new_n47_));
  ...
  nand4  g36(.a(new_n51_), .b(new_n49_), .c(new_n47_), .d(new_n18_), .O(z5));
  nand2  g37(.a(x4), .b(new_n23_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n48_), .c(x1), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n38_), .c(new_n18_), .O(z6));
endmodule
