...
module FAU ( 
  ...
  nand2  g07(.a(new_n22_), .b(x7), .O(new_n23_));
  nand2  g08(.a(new_n23_), .b(x1), .O(new_n24_));
  oai21  g09(.a(new_n20_), .b(new_n17_), .c(new_n24_), .O(z0));
  nand2  g10(.a(x3), .b(new_n18_), .O(new_n26_));
  ...
  aoi21  g16(.a(new_n31_), .b(new_n29_), .c(x1), .O(new_n32_));
  inv1   g17(.a(x7), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(x2), .c(x1), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n21_), .O(new_n35_));
  oai22  g20(.a(new_n35_), .b(new_n32_), .c(new_n26_), .d(new_n17_), .O(z1));
  nand2  g21(.a(x1), .b(new_n21_), .O(new_n37_));
  oai21  g22(.a(new_n17_), .b(x2), .c(new_n37_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(x3), .O(new_n39_));
  nand3  g24(.a(x4), .b(new_n18_), .c(new_n21_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(x7), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(x1), .O(new_n42_));
  nand2  g27(.a(new_n30_), .b(new_n18_), .O(new_n43_));
  oai21  g28(.a(x5), .b(new_n18_), .c(new_n43_), .O(new_n44_));
  nor2   g29(.a(x3), .b(x0), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n16_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n42_), .c(new_n39_), .O(z2));
  nor2   g32(.a(x4), .b(x2), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n45_), .c(new_n33_), .O(new_n49_));
  ...
  nand2  g39(.a(new_n54_), .b(new_n29_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n16_), .O(new_n56_));
  nand3  g41(.a(new_n26_), .b(new_n16_), .c(new_n21_), .O(new_n57_));
  oai21  g42(.a(new_n19_), .b(x0), .c(x7), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x1), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(z4));
  nand4  g45(.a(new_n43_), .b(new_n26_), .c(new_n29_), .d(new_n21_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n54_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n16_), .O(new_n63_));
  nand4  g48(.a(new_n20_), .b(x7), .c(x1), .d(new_n21_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n63_), .O(z5));
  oai21  g50(.a(new_n48_), .b(x3), .c(new_n21_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x7), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(x1), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n56_), .O(z6));
endmodule
