...
module FAU ( 
  ...
  nand2  g08(.a(x3), .b(new_n19_), .O(new_n24_));
  ...
  nand2  g16(.a(new_n27_), .b(new_n18_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand3  g18(.a(new_n28_), .b(new_n25_), .c(new_n16_), .O(new_n34_));
  nand3  g19(.a(x3), .b(new_n18_), .c(x0), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n19_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n33_), .O(z2));
  nor2   g23(.a(new_n26_), .b(x0), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(new_n21_), .c(new_n17_), .O(z3));
  nand2  g25(.a(new_n24_), .b(new_n16_), .O(new_n41_));
  xor2a  g26(.a(x3), .b(x2), .O(new_n42_));
  aoi22  g27(.a(new_n42_), .b(x0), .c(new_n20_), .d(new_n26_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n41_), .c(x1), .O(z4));
  nand2  g29(.a(new_n42_), .b(x0), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n30_), .c(x1), .O(z5));
  nor2   g31(.a(new_n43_), .b(x1), .O(z6));
endmodule
