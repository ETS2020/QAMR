...
module FAU ( 
  ...
  oai21  g04(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n20_));
  nand2  g05(.a(new_n20_), .b(x2), .O(new_n21_));
  inv1   g06(.a(x2), .O(new_n22_));
  nand2  g07(.a(x6), .b(new_n22_), .O(new_n23_));
  nand2  g08(.a(new_n23_), .b(new_n21_), .O(z0));
  inv1   g09(.a(x6), .O(new_n25_));
  nand3  g10(.a(new_n25_), .b(new_n22_), .c(x1), .O(new_n26_));
  ...
  nand3  g15(.a(new_n25_), .b(x3), .c(new_n22_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n19_), .c(new_n30_), .O(z1));
  ...
  oai21  g23(.a(new_n19_), .b(new_n33_), .c(new_n25_), .O(new_n39_));
  ...
  nand2  g33(.a(new_n33_), .b(x2), .O(new_n49_));
  nand3  g34(.a(x3), .b(new_n22_), .c(x0), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n18_), .O(new_n52_));
  nand3  g37(.a(x3), .b(new_n22_), .c(new_n18_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n49_), .c(new_n16_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n52_), .c(new_n23_), .O(z4));
  aoi21  g40(.a(new_n49_), .b(new_n31_), .c(new_n16_), .O(new_n56_));
  nor2   g41(.a(new_n36_), .b(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n18_), .O(new_n58_));
  oai21  g43(.a(new_n33_), .b(new_n22_), .c(new_n26_), .O(new_n59_));
  ...
  oai21  g50(.a(new_n42_), .b(x4), .c(new_n25_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n22_), .c(new_n65_), .O(new_n67_));
