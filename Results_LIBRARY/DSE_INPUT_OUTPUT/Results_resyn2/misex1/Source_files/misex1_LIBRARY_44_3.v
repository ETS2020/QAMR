...
module FAU ( 
  ...
  aoi21  g39(.a(new_n24_), .b(x2), .c(x0), .O(new_n55_));
  ...
  nand3  g43(.a(new_n28_), .b(new_n24_), .c(x2), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n58_), .c(new_n23_), .O(new_n60_));
  nand4  g45(.a(new_n28_), .b(x5), .c(x2), .d(new_n23_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n17_), .O(new_n63_));
  nand3  g48(.a(new_n28_), .b(x3), .c(x2), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n26_), .c(new_n23_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  oai21  g52(.a(new_n51_), .b(new_n44_), .c(new_n50_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  oai21  g54(.a(x4), .b(x2), .c(new_n24_), .O(new_n70_));
  aoi22  g55(.a(new_n70_), .b(new_n18_), .c(x6), .d(x2), .O(new_n71_));
