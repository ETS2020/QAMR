...
module FAU ( 
  ...
  nand3  g31(.a(new_n75_), .b(new_n57_), .c(new_n46_), .O(z09));
  ...
  nand3  g38(.a(new_n82_), .b(new_n59_), .c(new_n46_), .O(z10));
  ...
  oai21  g44(.a(new_n77_), .b(x21), .c(new_n50_), .O(new_n89_));
  ...
  nand3  g56(.a(new_n100_), .b(new_n65_), .c(new_n46_), .O(z13));
  ...
  nand4  g61(.a(new_n105_), .b(new_n77_), .c(x24), .d(x23), .O(new_n106_));
  ...
  nor2   g66(.a(new_n52_), .b(new_n98_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(x24), .c(x25), .O(new_n112_));
  and2   g68(.a(x26), .b(x17), .O(new_n113_));
  and2   g69(.a(x25), .b(x24), .O(new_n114_));
  nand4  g70(.a(new_n105_), .b(new_n77_), .c(new_n114_), .d(x23), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n113_), .c(new_n50_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n112_), .c(new_n69_), .O(z15));
  inv1   g73(.a(x18), .O(new_n118_));
  nand2  g74(.a(new_n53_), .b(new_n118_), .O(new_n119_));
  inv1   g75(.a(x26), .O(new_n120_));
  nand2  g76(.a(new_n115_), .b(new_n120_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n119_), .c(new_n50_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n71_), .O(z16));
endmodule
