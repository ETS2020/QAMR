...
module FAU ( 
  ...
  aoi21  g18(.a(new_n46_), .b(new_n62_), .c(new_n45_), .O(z05));
  ...
  oai21  g26(.a(new_n70_), .b(new_n49_), .c(x19), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n48_), .O(new_n72_));
  aoi21  g28(.a(new_n72_), .b(new_n54_), .c(x10), .O(z09));
  nand2  g29(.a(x20), .b(x19), .O(new_n74_));
  nand3  g30(.a(x22), .b(x21), .c(x12), .O(new_n75_));
  nor2   g31(.a(new_n75_), .b(new_n49_), .O(new_n76_));
  nand2  g32(.a(x09), .b(new_n45_), .O(new_n77_));
  nor2   g33(.a(x20), .b(x19), .O(new_n78_));
  nor2   g34(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  oai21  g35(.a(new_n76_), .b(new_n74_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g41(.a(new_n74_), .b(new_n85_), .c(new_n77_), .O(new_n86_));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n92_), .c(new_n77_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n60_), .c(x10), .O(z12));
  nand2  g51(.a(x08), .b(x04), .O(new_n96_));
  inv1   g52(.a(x15), .O(new_n97_));
  nor2   g53(.a(new_n49_), .b(new_n97_), .O(new_n98_));
  ...
  oai21  g73(.a(new_n117_), .b(new_n109_), .c(new_n110_), .O(z15));
  oai21  g74(.a(x10), .b(x07), .c(x08), .O(new_n119_));
  inv1   g75(.a(new_n113_), .O(new_n120_));
  inv1   g76(.a(x18), .O(new_n121_));
  aoi21  g77(.a(new_n51_), .b(new_n121_), .c(new_n109_), .O(new_n122_));
