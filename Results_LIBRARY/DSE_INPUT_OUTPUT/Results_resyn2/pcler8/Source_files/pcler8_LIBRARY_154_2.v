...
module FAU ( 
  ...
  oai21  g37(.a(new_n81_), .b(new_n72_), .c(new_n80_), .O(new_n82_));
  nand3  g38(.a(new_n53_), .b(x09), .c(new_n45_), .O(new_n83_));
  aoi21  g39(.a(new_n79_), .b(new_n78_), .c(new_n83_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  oai21  g41(.a(new_n77_), .b(new_n56_), .c(new_n85_), .O(z10));
  ...
  oai21  g47(.a(new_n80_), .b(x21), .c(new_n91_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n90_), .c(new_n58_), .O(z11));
  ...
  oai22  g52(.a(new_n96_), .b(new_n94_), .c(new_n77_), .d(new_n60_), .O(z12));
  ...
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(new_n91_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n66_), .O(z15));
  oai21  g74(.a(new_n53_), .b(x07), .c(x08), .O(new_n119_));
  ...
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n71_), .O(new_n125_));
