...
module FAU ( 
  ...
  nor2   g24(.a(x10), .b(new_n68_), .O(new_n69_));
  ...
  oai21  g44(.a(new_n47_), .b(x03), .c(x08), .O(new_n89_));
  aoi21  g45(.a(new_n82_), .b(x14), .c(new_n49_), .O(new_n90_));
  inv1   g46(.a(new_n83_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x22), .c(new_n69_), .O(new_n92_));
  ...
  nand3  g70(.a(x10), .b(x08), .c(x06), .O(new_n115_));
  ...
  oai21  g76(.a(new_n120_), .b(new_n117_), .c(new_n65_), .O(z16));
endmodule
