...
module FAU ( 
  ...
  nand2  g19(.a(new_n63_), .b(new_n55_), .O(z05));
  ...
  nand3  g26(.a(new_n45_), .b(x09), .c(new_n54_), .O(new_n71_));
  ...
  nand2  g39(.a(x09), .b(new_n54_), .O(new_n84_));
  ...
  aoi21  g46(.a(new_n90_), .b(new_n80_), .c(new_n89_), .O(new_n91_));
  oai21  g47(.a(new_n88_), .b(x21), .c(new_n85_), .O(new_n92_));
  aoi21  g48(.a(x10), .b(new_n54_), .c(z03), .O(new_n93_));
  oai21  g49(.a(new_n92_), .b(new_n91_), .c(new_n93_), .O(z11));
  inv1   g50(.a(z04), .O(new_n95_));
  aoi21  g51(.a(new_n80_), .b(x14), .c(new_n47_), .O(new_n96_));
  ...
  nor2   g57(.a(new_n73_), .b(new_n101_), .O(new_n102_));
  xor2a  g58(.a(new_n47_), .b(new_n46_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n102_), .c(new_n85_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n63_), .c(new_n55_), .O(z13));
  ...
  oai21  g66(.a(new_n47_), .b(new_n46_), .c(new_n49_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n110_), .c(new_n108_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n84_), .c(new_n106_), .O(z14));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n48_), .c(x25), .d(x24), .O(new_n115_));
  nand2  g71(.a(new_n110_), .b(new_n50_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n85_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n67_), .c(new_n55_), .O(z15));
  inv1   g74(.a(x26), .O(new_n119_));
  nand4  g75(.a(new_n109_), .b(x25), .c(x24), .d(x23), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nor2   g77(.a(new_n47_), .b(x18), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n80_), .c(new_n71_), .O(new_n123_));
