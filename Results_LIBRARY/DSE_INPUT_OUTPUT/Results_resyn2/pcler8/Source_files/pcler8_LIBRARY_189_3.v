...
module FAU ( 
  ...
  oai21  g24(.a(new_n46_), .b(new_n68_), .c(new_n52_), .O(z08));
  ...
  nand3  g36(.a(new_n80_), .b(new_n54_), .c(new_n52_), .O(z10));
  ...
  oai21  g53(.a(new_n56_), .b(new_n62_), .c(new_n97_), .O(z13));
  ...
  nand2  g61(.a(new_n57_), .b(x05), .O(new_n106_));
  oai21  g62(.a(new_n105_), .b(new_n48_), .c(new_n106_), .O(z14));
  oai21  g63(.a(x10), .b(x08), .c(x06), .O(new_n108_));
  inv1   g64(.a(x25), .O(new_n109_));
  nor2   g65(.a(new_n109_), .b(new_n103_), .O(new_n110_));
  ...
  nand2  g69(.a(new_n102_), .b(new_n109_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n70_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n108_), .O(z15));
  aoi21  g72(.a(new_n111_), .b(new_n110_), .c(x26), .O(new_n117_));
  inv1   g73(.a(x18), .O(new_n118_));
  inv1   g74(.a(new_n49_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n82_), .c(new_n118_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n70_), .O(new_n121_));
  oai22  g77(.a(new_n121_), .b(new_n117_), .c(new_n56_), .d(new_n68_), .O(z16));
endmodule
