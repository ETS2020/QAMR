...
module FAU ( 
  ...
  inv1   g30(.a(new_n52_), .O(new_n75_));
  nand3  g31(.a(new_n75_), .b(new_n46_), .c(new_n47_), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(new_n74_), .c(new_n58_), .O(z09));
  inv1   g33(.a(new_n53_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(x12), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n54_), .c(new_n49_), .O(new_n80_));
  aoi21  g36(.a(new_n48_), .b(new_n47_), .c(new_n52_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand3  g38(.a(new_n82_), .b(new_n60_), .c(new_n46_), .O(z10));
  nand3  g39(.a(x21), .b(x20), .c(x19), .O(new_n84_));
  nand3  g40(.a(x23), .b(x22), .c(x13), .O(new_n85_));
  inv1   g41(.a(new_n85_), .O(new_n86_));
  aoi21  g42(.a(new_n86_), .b(new_n78_), .c(new_n84_), .O(new_n87_));
  nor2   g43(.a(new_n52_), .b(new_n45_), .O(new_n88_));
  oai21  g44(.a(new_n49_), .b(x21), .c(new_n88_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n87_), .c(new_n62_), .O(z11));
  inv1   g46(.a(new_n84_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(x22), .O(new_n92_));
  inv1   g48(.a(x23), .O(new_n93_));
  inv1   g49(.a(x24), .O(new_n94_));
  nand3  g50(.a(x26), .b(x25), .c(x14), .O(new_n95_));
  nor3   g51(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  nor2   g52(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  oai21  g53(.a(new_n91_), .b(x22), .c(new_n75_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n97_), .c(new_n64_), .O(z12));
  nand2  g55(.a(new_n78_), .b(x15), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n91_), .c(x23), .d(x22), .O(new_n101_));
  nand2  g57(.a(new_n92_), .b(new_n93_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n101_), .c(new_n75_), .O(new_n103_));
  ...
  nand3  g64(.a(x24), .b(x20), .c(x19), .O(new_n109_));
  nor2   g65(.a(new_n109_), .b(new_n54_), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g67(.a(x23), .b(x22), .O(new_n112_));
  oai21  g68(.a(new_n84_), .b(new_n112_), .c(new_n94_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n111_), .c(new_n75_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n68_), .c(new_n45_), .O(z14));
  nand3  g71(.a(x24), .b(x23), .c(x22), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n91_), .c(x25), .O(new_n118_));
  oai21  g74(.a(new_n116_), .b(new_n84_), .c(new_n105_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n118_), .c(new_n75_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n70_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n46_), .O(new_n122_));
  nand3  g78(.a(new_n107_), .b(new_n75_), .c(x17), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(z15));
  nor3   g80(.a(new_n54_), .b(new_n105_), .c(new_n94_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n49_), .c(x26), .O(new_n126_));
  nor2   g82(.a(new_n106_), .b(x18), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n125_), .c(new_n49_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n75_), .O(new_n129_));
  aoi21  g85(.a(x08), .b(x07), .c(new_n45_), .O(new_n130_));
  oai21  g86(.a(new_n129_), .b(new_n126_), .c(new_n130_), .O(z16));
endmodule
