...
module FAU ( 
  ...
  oai21  g12(.a(new_n56_), .b(new_n48_), .c(new_n47_), .O(z00));
  ...
  nor2   g28(.a(new_n72_), .b(new_n46_), .O(z08));
  oai21  g29(.a(new_n54_), .b(x19), .c(new_n58_), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n47_), .O(new_n75_));
  nand3  g31(.a(x20), .b(x16), .c(x11), .O(new_n76_));
  oai21  g32(.a(new_n76_), .b(new_n56_), .c(new_n75_), .O(z09));
  aoi21  g33(.a(new_n51_), .b(x12), .c(new_n48_), .O(new_n78_));
  oai21  g34(.a(x20), .b(x19), .c(new_n55_), .O(new_n79_));
  aoi21  g35(.a(x08), .b(x01), .c(new_n46_), .O(new_n80_));
  ...
  aoi21  g41(.a(new_n48_), .b(new_n85_), .c(new_n54_), .O(new_n86_));
  oai21  g42(.a(new_n84_), .b(new_n82_), .c(new_n86_), .O(new_n87_));
  aoi21  g43(.a(new_n87_), .b(new_n62_), .c(new_n46_), .O(z11));
  nand4  g44(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  nand2  g46(.a(x23), .b(x14), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n49_), .c(new_n90_), .O(new_n92_));
  inv1   g48(.a(x22), .O(new_n93_));
  aoi21  g49(.a(new_n82_), .b(new_n93_), .c(new_n54_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n64_), .c(new_n46_), .O(z12));
  inv1   g52(.a(new_n49_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(x15), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n90_), .c(x23), .O(new_n99_));
  inv1   g55(.a(x23), .O(new_n100_));
  aoi21  g56(.a(new_n89_), .b(new_n100_), .c(new_n54_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n66_), .c(new_n46_), .O(z13));
  inv1   g59(.a(new_n48_), .O(new_n104_));
  inv1   g60(.a(new_n50_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n104_), .c(x24), .O(new_n106_));
  inv1   g62(.a(x24), .O(new_n107_));
  oai21  g63(.a(new_n50_), .b(new_n48_), .c(new_n107_), .O(new_n108_));
  aoi22  g64(.a(new_n108_), .b(new_n106_), .c(new_n97_), .d(x16), .O(new_n109_));
  aoi21  g65(.a(x08), .b(x05), .c(new_n46_), .O(new_n110_));
  oai21  g66(.a(new_n109_), .b(new_n54_), .c(new_n110_), .O(z14));
  nor2   g67(.a(new_n50_), .b(new_n48_), .O(new_n112_));
  ...
  nand2  g71(.a(new_n106_), .b(new_n113_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n55_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n70_), .c(new_n46_), .O(z15));
  nor2   g74(.a(new_n113_), .b(new_n107_), .O(new_n119_));
  inv1   g75(.a(x26), .O(new_n120_));
  nor2   g76(.a(new_n120_), .b(x18), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n112_), .c(new_n119_), .O(new_n122_));
  nand2  g78(.a(new_n112_), .b(new_n119_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n55_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n72_), .c(new_n47_), .O(z16));
endmodule
