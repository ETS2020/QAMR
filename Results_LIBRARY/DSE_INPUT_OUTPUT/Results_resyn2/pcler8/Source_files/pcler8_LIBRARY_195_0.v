...
module FAU ( 
  ...
  nor2   g29(.a(new_n54_), .b(new_n45_), .O(new_n74_));
  ...
  nand2  g34(.a(new_n78_), .b(new_n58_), .O(z09));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n54_), .O(new_n85_));
  ...
  oai21  g47(.a(new_n82_), .b(x21), .c(new_n74_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(new_n62_), .O(z11));
  inv1   g49(.a(x14), .O(new_n94_));
  inv1   g50(.a(new_n48_), .O(new_n95_));
  oai21  g51(.a(new_n75_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  inv1   g52(.a(x22), .O(new_n97_));
  aoi21  g53(.a(new_n89_), .b(new_n97_), .c(new_n54_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n64_), .c(new_n45_), .O(z12));
  nand2  g56(.a(new_n51_), .b(x15), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n49_), .O(new_n102_));
  aoi21  g58(.a(new_n48_), .b(new_n47_), .c(new_n54_), .O(new_n103_));
  ...
  nand3  g65(.a(new_n95_), .b(x24), .c(x23), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(new_n107_), .O(new_n111_));
  inv1   g67(.a(x05), .O(new_n112_));
  inv1   g68(.a(x17), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(x08), .c(new_n112_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n53_), .c(x09), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n111_), .c(new_n68_), .O(z14));
  inv1   g72(.a(x25), .O(new_n117_));
  nand2  g73(.a(new_n110_), .b(new_n117_), .O(new_n118_));
  aoi21  g74(.a(x26), .b(x17), .c(new_n117_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n49_), .c(x24), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n55_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n70_), .c(new_n46_), .O(z15));
  inv1   g78(.a(x26), .O(new_n123_));
  nand4  g79(.a(new_n95_), .b(x25), .c(x24), .d(x23), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(new_n88_), .b(new_n95_), .c(new_n126_), .O(new_n127_));
