...
module FAU ( 
  ...
  oai21  g20(.a(new_n51_), .b(new_n64_), .c(new_n58_), .O(z03));
  ...
  aoi21  g36(.a(new_n80_), .b(x20), .c(new_n76_), .O(new_n81_));
  inv1   g37(.a(x10), .O(new_n82_));
  nand3  g38(.a(new_n53_), .b(x11), .c(new_n82_), .O(new_n83_));
  oai22  g39(.a(new_n83_), .b(new_n81_), .c(new_n62_), .d(new_n56_), .O(z09));
  ...
  oai22  g45(.a(new_n89_), .b(new_n87_), .c(new_n62_), .d(new_n60_), .O(z10));
  ...
  oai22  g50(.a(new_n94_), .b(new_n93_), .c(new_n62_), .d(new_n64_), .O(z11));
  inv1   g51(.a(x11), .O(new_n96_));
  nand2  g52(.a(new_n79_), .b(x14), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n85_), .c(x22), .d(x21), .O(new_n98_));
  inv1   g54(.a(x22), .O(new_n99_));
  aoi21  g55(.a(new_n91_), .b(new_n99_), .c(new_n52_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n98_), .c(new_n96_), .O(new_n101_));
  oai22  g57(.a(new_n101_), .b(x10), .c(new_n51_), .d(new_n66_), .O(z12));
  nand3  g58(.a(new_n50_), .b(x24), .c(x15), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g60(.a(new_n46_), .b(new_n45_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n104_), .c(new_n88_), .O(new_n106_));
  oai21  g62(.a(new_n62_), .b(new_n68_), .c(new_n106_), .O(z13));
  ...
  nand4  g67(.a(new_n77_), .b(new_n85_), .c(x24), .d(x23), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(new_n109_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n52_), .c(x11), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n82_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n70_), .O(z14));
  nand3  g72(.a(new_n47_), .b(x25), .c(x24), .O(new_n117_));
  nand2  g73(.a(new_n112_), .b(new_n48_), .O(new_n118_));
  aoi22  g74(.a(new_n118_), .b(new_n117_), .c(new_n50_), .d(x17), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n83_), .c(new_n72_), .O(z15));
  nand2  g76(.a(new_n117_), .b(new_n49_), .O(new_n121_));
  nor2   g77(.a(new_n46_), .b(x18), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n79_), .c(new_n52_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n121_), .c(new_n96_), .O(new_n124_));
  oai22  g80(.a(new_n124_), .b(x10), .c(new_n51_), .d(new_n74_), .O(z16));
endmodule
