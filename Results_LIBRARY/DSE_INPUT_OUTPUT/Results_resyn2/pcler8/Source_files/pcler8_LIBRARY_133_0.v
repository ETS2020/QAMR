...
module FAU ( 
  ...
  inv1   g15(.a(new_n59_), .O(z08));
  inv1   g16(.a(new_n46_), .O(z09));
  inv1   g17(.a(new_n48_), .O(z10));
  inv1   g18(.a(new_n53_), .O(z13));
  inv1   g19(.a(new_n55_), .O(z14));
  inv1   g20(.a(new_n57_), .O(z15));
  oai21  g21(.a(x10), .b(x08), .c(new_n59_), .O(z16));
  oai21  g22(.a(x10), .b(x08), .c(new_n50_), .O(z11));
  and2   g23(.a(x08), .b(x03), .O(z12));
endmodule
