...
module FAU ( 
  ...
  nor2   g22(.a(new_n58_), .b(new_n66_), .O(z07));
  inv1   g23(.a(x07), .O(new_n68_));
  oai21  g24(.a(new_n46_), .b(new_n68_), .c(new_n53_), .O(z08));
  ...
  oai21  g29(.a(new_n58_), .b(new_n51_), .c(new_n73_), .O(z09));
  ...
  oai21  g36(.a(new_n58_), .b(new_n55_), .c(new_n80_), .O(z10));
  ...
  oai22  g42(.a(new_n86_), .b(new_n85_), .c(new_n58_), .d(new_n57_), .O(z11));
  ...
  oai22  g46(.a(new_n90_), .b(new_n88_), .c(new_n58_), .d(new_n60_), .O(z12));
  ...
  nand3  g60(.a(new_n53_), .b(x08), .c(x05), .O(new_n105_));
  ...
  nand3  g68(.a(new_n112_), .b(new_n111_), .c(new_n70_), .O(new_n113_));
  nand2  g69(.a(x08), .b(x06), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n53_), .O(z15));
  ...
  oai22  g76(.a(new_n120_), .b(new_n116_), .c(new_n58_), .d(new_n68_), .O(z16));
endmodule
