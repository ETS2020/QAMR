...
module FAU ( 
  ...
  oai21  g18(.a(x10), .b(x08), .c(new_n59_), .O(z16));
  zero   g19(.O(z00));
  oai21  g20(.a(x10), .b(x08), .c(new_n48_), .O(z10));
  oai21  g21(.a(x10), .b(x08), .c(new_n50_), .O(z11));
  and2   g22(.a(x08), .b(x03), .O(z12));
  oai21  g23(.a(x10), .b(x08), .c(new_n57_), .O(z15));
endmodule
