...
module FAU ( 
  ...
  oai21  g10(.a(new_n54_), .b(new_n49_), .c(new_n45_), .O(z00));
  nand2  g11(.a(x08), .b(x00), .O(new_n56_));
  nand2  g12(.a(new_n56_), .b(new_n45_), .O(z01));
  ...
  nor2   g21(.a(new_n65_), .b(new_n58_), .O(z05));
  ...
  nand3  g26(.a(new_n45_), .b(x08), .c(x07), .O(new_n71_));
  inv1   g27(.a(new_n71_), .O(z08));
  oai21  g28(.a(new_n52_), .b(x19), .c(new_n56_), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n45_), .O(new_n74_));
  inv1   g30(.a(x21), .O(new_n75_));
  nand3  g31(.a(x26), .b(x25), .c(x24), .O(new_n76_));
  nor3   g32(.a(new_n76_), .b(new_n46_), .c(new_n75_), .O(new_n77_));
  inv1   g33(.a(x11), .O(new_n78_));
  nor2   g34(.a(x16), .b(new_n78_), .O(new_n79_));
  nand4  g35(.a(new_n79_), .b(new_n77_), .c(new_n53_), .d(x20), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n74_), .O(z09));
  nand2  g37(.a(x20), .b(x19), .O(new_n82_));
  aoi21  g38(.a(new_n77_), .b(x12), .c(new_n82_), .O(new_n83_));
  oai21  g39(.a(x20), .b(x19), .c(new_n53_), .O(new_n84_));
  and2   g40(.a(new_n59_), .b(new_n45_), .O(new_n85_));
  ...
  aoi21  g45(.a(new_n89_), .b(new_n87_), .c(new_n47_), .O(new_n90_));
  nand2  g46(.a(new_n82_), .b(new_n75_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n53_), .O(new_n92_));
  and2   g48(.a(new_n61_), .b(new_n45_), .O(new_n93_));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n87_), .c(new_n95_), .O(new_n97_));
  inv1   g53(.a(new_n47_), .O(new_n98_));
  nand4  g54(.a(new_n45_), .b(new_n51_), .c(x09), .d(new_n50_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  oai21  g56(.a(new_n98_), .b(x22), .c(new_n100_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n97_), .c(new_n63_), .O(z12));
  nand2  g58(.a(new_n87_), .b(x15), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nor2   g60(.a(new_n95_), .b(new_n104_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  aoi21  g62(.a(new_n95_), .b(new_n104_), .c(new_n52_), .O(new_n107_));
  ...
  nand3  g66(.a(new_n110_), .b(new_n48_), .c(x24), .O(new_n111_));
  inv1   g67(.a(x24), .O(new_n112_));
  oai21  g68(.a(new_n47_), .b(new_n46_), .c(new_n112_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n111_), .c(new_n100_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n67_), .O(z14));
  inv1   g71(.a(x25), .O(new_n116_));
  aoi21  g72(.a(x26), .b(x17), .c(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n48_), .c(x24), .O(new_n118_));
  nand2  g74(.a(new_n49_), .b(new_n116_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n118_), .c(new_n53_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n69_), .c(new_n45_), .O(z15));
  inv1   g77(.a(x26), .O(new_n122_));
  nand2  g78(.a(x25), .b(x24), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(x18), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n48_), .c(new_n122_), .O(new_n125_));
  nand4  g81(.a(new_n122_), .b(x25), .c(x24), .d(x23), .O(new_n126_));
  nor2   g82(.a(new_n126_), .b(new_n95_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n125_), .c(new_n100_), .O(new_n128_));
