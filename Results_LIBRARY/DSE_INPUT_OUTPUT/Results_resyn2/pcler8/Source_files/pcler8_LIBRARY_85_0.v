...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n49_, new_n52_, new_n54_, new_n56_, new_n58_;
  ...
  inv1   g16(.a(new_n49_), .O(z11));
  oai21  g17(.a(x10), .b(x08), .c(new_n52_), .O(z13));
  inv1   g18(.a(new_n54_), .O(z14));
  inv1   g19(.a(new_n56_), .O(z15));
  inv1   g20(.a(new_n58_), .O(z16));
  and2   g21(.a(x08), .b(x00), .O(z09));
  and2   g22(.a(x08), .b(x03), .O(z12));
endmodule
