...
module FAU ( 
  ...
  oai22  g10(.a(new_n54_), .b(new_n49_), .c(new_n46_), .d(new_n45_), .O(z00));
  ...
  oai21  g49(.a(new_n50_), .b(new_n93_), .c(new_n53_), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nand2  g51(.a(new_n87_), .b(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n94_), .c(new_n48_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n62_), .c(x10), .O(z12));
  ...
  and2   g61(.a(x25), .b(x24), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(x26), .c(x16), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nor2   g64(.a(new_n52_), .b(new_n102_), .O(new_n109_));
  ...
  nand3  g71(.a(new_n115_), .b(new_n109_), .c(new_n106_), .O(new_n116_));
  ...
  aoi21  g78(.a(new_n109_), .b(new_n106_), .c(x26), .O(new_n123_));
  oai21  g79(.a(new_n54_), .b(x18), .c(new_n90_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(z16));
endmodule
