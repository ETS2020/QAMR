...
module FAU ( 
  ...
  aoi21  g21(.a(new_n45_), .b(x07), .c(new_n65_), .O(z04));
  ...
  aoi21  g29(.a(x16), .b(new_n53_), .c(new_n73_), .O(z08));
  ...
  oai21  g47(.a(new_n80_), .b(x21), .c(new_n56_), .O(new_n92_));
  ...
  oai21  g52(.a(new_n94_), .b(x22), .c(new_n56_), .O(new_n97_));
  and2   g53(.a(new_n65_), .b(new_n46_), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(z12));
  nand3  g55(.a(new_n52_), .b(x26), .c(x15), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n49_), .O(new_n101_));
  aoi21  g57(.a(new_n48_), .b(new_n47_), .c(new_n55_), .O(new_n102_));
  ...
  nand4  g64(.a(new_n108_), .b(new_n80_), .c(x24), .d(x23), .O(new_n109_));
  ...
  aoi21  g68(.a(x26), .b(x17), .c(new_n51_), .O(new_n113_));
  ...
  nand3  g72(.a(new_n116_), .b(new_n71_), .c(new_n46_), .O(z15));
  aoi21  g73(.a(new_n52_), .b(new_n49_), .c(x26), .O(new_n118_));
  nor2   g74(.a(new_n48_), .b(x18), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n88_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n56_), .c(new_n46_), .O(new_n121_));
  nand3  g77(.a(x16), .b(x08), .c(x07), .O(new_n122_));
  oai21  g78(.a(new_n121_), .b(new_n118_), .c(new_n122_), .O(z16));
endmodule
