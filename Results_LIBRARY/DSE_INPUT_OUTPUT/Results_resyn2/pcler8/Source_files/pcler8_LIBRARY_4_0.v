...
module FAU ( 
  ...
  aoi21  g31(.a(new_n75_), .b(new_n56_), .c(new_n45_), .O(z09));
  ...
  aoi21  g39(.a(new_n83_), .b(new_n58_), .c(new_n45_), .O(z10));
  ...
  nand3  g45(.a(new_n89_), .b(new_n88_), .c(new_n50_), .O(new_n90_));
  aoi21  g46(.a(new_n90_), .b(new_n60_), .c(new_n45_), .O(z11));
  aoi21  g47(.a(new_n78_), .b(x14), .c(new_n52_), .O(new_n92_));
  oai21  g48(.a(new_n86_), .b(x22), .c(new_n50_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n92_), .c(new_n62_), .O(z12));
  ...
  nand2  g55(.a(new_n99_), .b(new_n64_), .O(z13));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand4  g58(.a(new_n72_), .b(new_n77_), .c(x24), .d(x23), .O(new_n103_));
  inv1   g59(.a(x24), .O(new_n104_));
  oai21  g60(.a(new_n52_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(new_n106_));
  nand2  g62(.a(new_n50_), .b(new_n46_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n106_), .c(new_n66_), .O(z14));
  nand3  g64(.a(x26), .b(x25), .c(x17), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  nor2   g66(.a(new_n52_), .b(new_n97_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(x25), .c(x24), .O(new_n112_));
  inv1   g68(.a(x25), .O(new_n113_));
  nand2  g69(.a(new_n103_), .b(new_n113_), .O(new_n114_));
  ...
  aoi21  g75(.a(new_n53_), .b(new_n119_), .c(new_n49_), .O(new_n120_));
  oai21  g76(.a(new_n118_), .b(x26), .c(new_n120_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n70_), .c(new_n46_), .O(z16));
endmodule
