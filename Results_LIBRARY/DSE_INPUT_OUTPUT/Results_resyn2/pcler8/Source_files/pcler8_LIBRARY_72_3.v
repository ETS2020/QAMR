...
module FAU ( 
  ...
  nor2   g23(.a(new_n67_), .b(x17), .O(z05));
  nand3  g24(.a(new_n45_), .b(x08), .c(x05), .O(new_n69_));
  ...
  oai21  g37(.a(new_n81_), .b(new_n53_), .c(new_n58_), .O(z09));
  ...
  and2   g42(.a(new_n61_), .b(new_n45_), .O(new_n87_));
  ...
  and2   g50(.a(new_n63_), .b(new_n45_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n101_), .b(new_n98_), .c(new_n102_), .O(z12));
  oai21  g59(.a(x17), .b(x08), .c(x04), .O(new_n104_));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n47_), .c(x23), .O(new_n106_));
  inv1   g62(.a(x23), .O(new_n107_));
  nand2  g63(.a(new_n46_), .b(new_n107_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n106_), .c(new_n85_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n104_), .O(z13));
  nand2  g66(.a(new_n49_), .b(new_n47_), .O(new_n111_));
  nand4  g67(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(new_n113_));
  inv1   g69(.a(x24), .O(new_n114_));
  oai21  g70(.a(new_n46_), .b(new_n107_), .c(new_n114_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n111_), .c(new_n113_), .O(new_n116_));
  nand2  g72(.a(new_n85_), .b(new_n45_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n116_), .c(new_n69_), .O(z14));
  inv1   g74(.a(x25), .O(new_n119_));
  oai21  g75(.a(new_n48_), .b(new_n46_), .c(new_n119_), .O(new_n120_));
  nand3  g76(.a(new_n49_), .b(new_n47_), .c(x25), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n120_), .c(new_n85_), .O(new_n122_));
  aoi21  g78(.a(new_n54_), .b(x17), .c(new_n71_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n122_), .c(new_n60_), .O(z15));
  inv1   g80(.a(x26), .O(new_n125_));
  nor2   g81(.a(new_n125_), .b(x18), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n49_), .c(new_n47_), .d(x25), .O(new_n127_));
  nand2  g83(.a(new_n121_), .b(new_n125_), .O(new_n128_));
  nand3  g84(.a(new_n128_), .b(new_n127_), .c(new_n85_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n74_), .c(new_n45_), .O(z16));
endmodule
