...
module FAU ( 
  ...
  oai21  g19(.a(x10), .b(x08), .c(new_n54_), .O(z13));
  oai21  g20(.a(x10), .b(x08), .c(new_n58_), .O(z15));
  oai21  g21(.a(x10), .b(x08), .c(new_n60_), .O(z16));
  zero   g22(.O(z00));
  oai21  g23(.a(x10), .b(x08), .c(new_n50_), .O(z11));
  oai21  g24(.a(x10), .b(x08), .c(new_n56_), .O(z14));
endmodule
