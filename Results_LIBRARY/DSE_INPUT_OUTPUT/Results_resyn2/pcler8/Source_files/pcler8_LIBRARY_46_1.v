...
module FAU ( 
  ...
  nor2   g16(.a(new_n60_), .b(z00), .O(z07));
  ...
  oai21  g22(.a(new_n66_), .b(x19), .c(new_n64_), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n48_), .O(z09));
  inv1   g24(.a(x08), .O(new_n69_));
  nand3  g25(.a(x20), .b(x09), .c(new_n69_), .O(new_n70_));
  nand2  g26(.a(new_n70_), .b(new_n45_), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(new_n50_), .O(z10));
  nor2   g29(.a(x19), .b(x10), .O(new_n74_));
  nand3  g30(.a(new_n74_), .b(new_n66_), .c(x21), .O(new_n75_));
  oai21  g31(.a(new_n52_), .b(z00), .c(new_n75_), .O(z11));
  nand3  g32(.a(new_n74_), .b(new_n66_), .c(x22), .O(new_n77_));
  oai21  g33(.a(new_n54_), .b(z00), .c(new_n77_), .O(z12));
  nand3  g34(.a(x23), .b(x09), .c(new_n69_), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n56_), .O(z13));
  nand3  g38(.a(new_n74_), .b(new_n66_), .c(x24), .O(new_n83_));
  oai21  g39(.a(new_n58_), .b(z00), .c(new_n83_), .O(z14));
  nand3  g40(.a(x25), .b(x09), .c(new_n69_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n45_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n64_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n60_), .O(z15));
  nand3  g44(.a(new_n74_), .b(new_n66_), .c(x26), .O(new_n89_));
  oai21  g45(.a(new_n62_), .b(z00), .c(new_n89_), .O(z16));
endmodule
