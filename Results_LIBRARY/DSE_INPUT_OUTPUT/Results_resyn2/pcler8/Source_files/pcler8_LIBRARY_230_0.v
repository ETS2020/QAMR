...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n46_, new_n48_, new_n51_, new_n53_, new_n55_, new_n57_;
  ...
  oai21  g15(.a(x10), .b(x08), .c(new_n53_), .O(z13));
  oai21  g16(.a(x10), .b(x08), .c(new_n57_), .O(z15));
  zero   g17(.O(z00));
  oai21  g18(.a(x10), .b(x08), .c(new_n46_), .O(z09));
  and2   g19(.a(x08), .b(x02), .O(z11));
  oai21  g20(.a(x10), .b(x08), .c(new_n51_), .O(z12));
