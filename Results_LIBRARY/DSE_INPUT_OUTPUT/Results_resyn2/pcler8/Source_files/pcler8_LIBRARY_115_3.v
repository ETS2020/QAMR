...
module FAU ( 
  ...
  nand2  g04(.a(x17), .b(x06), .O(new_n49_));
  ...
  nand2  g10(.a(new_n54_), .b(new_n49_), .O(z01));
  inv1   g11(.a(new_n49_), .O(new_n56_));
  nand2  g12(.a(x08), .b(x01), .O(new_n57_));
  nor2   g13(.a(new_n57_), .b(new_n56_), .O(z02));
  nand3  g14(.a(new_n49_), .b(x08), .c(x02), .O(new_n59_));
  inv1   g15(.a(new_n59_), .O(z03));
  nand2  g16(.a(x08), .b(x03), .O(new_n61_));
  nand2  g17(.a(new_n61_), .b(new_n49_), .O(z04));
  nand3  g18(.a(new_n49_), .b(x08), .c(x04), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z05));
  nand3  g20(.a(new_n49_), .b(x08), .c(x05), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z06));
  nand2  g22(.a(x08), .b(x06), .O(new_n67_));
  nor2   g23(.a(new_n67_), .b(x17), .O(z07));
  nand3  g24(.a(new_n49_), .b(x08), .c(x07), .O(new_n69_));
  ...
  nand3  g30(.a(new_n74_), .b(new_n54_), .c(new_n49_), .O(z09));
  ...
  nand3  g38(.a(new_n82_), .b(new_n57_), .c(new_n49_), .O(z10));
  ...
  or2    g43(.a(new_n76_), .b(x21), .O(new_n88_));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n61_), .c(new_n56_), .O(z12));
  inv1   g53(.a(x23), .O(new_n98_));
  xor2a  g54(.a(new_n52_), .b(new_n98_), .O(new_n99_));
  aoi21  g55(.a(new_n77_), .b(x15), .c(new_n99_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n50_), .c(new_n63_), .O(z13));
  nand4  g57(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  nand4  g59(.a(new_n71_), .b(new_n76_), .c(x24), .d(x23), .O(new_n104_));
  ...
  oai21  g63(.a(new_n107_), .b(new_n50_), .c(new_n65_), .O(z14));
  oai21  g64(.a(x17), .b(x08), .c(x06), .O(new_n109_));
  nand3  g65(.a(x26), .b(x25), .c(x17), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand4  g67(.a(new_n92_), .b(x25), .c(x24), .d(x23), .O(new_n112_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n47_), .c(new_n109_), .O(z15));
  inv1   g72(.a(x26), .O(new_n117_));
  nand2  g73(.a(new_n112_), .b(new_n117_), .O(new_n118_));
  inv1   g74(.a(x18), .O(new_n119_));
  nand3  g75(.a(new_n92_), .b(new_n77_), .c(new_n119_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n87_), .O(new_n121_));
