...
module FAU ( 
  ...
  nand2  g43(.a(new_n78_), .b(x21), .O(new_n88_));
  and2   g44(.a(x22), .b(x13), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n87_), .c(new_n88_), .O(new_n90_));
  oai21  g46(.a(new_n78_), .b(x21), .c(new_n72_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n90_), .c(new_n86_), .O(z11));
  aoi21  g48(.a(new_n87_), .b(x14), .c(new_n47_), .O(new_n93_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n93_), .c(new_n62_), .O(z12));
  ...
  oai21  g65(.a(new_n109_), .b(new_n81_), .c(new_n66_), .O(z14));
  ...
  nand3  g70(.a(new_n114_), .b(new_n68_), .c(new_n55_), .O(z15));
  inv1   g71(.a(x26), .O(new_n116_));
  nand4  g72(.a(new_n106_), .b(x25), .c(x24), .d(x23), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nor2   g74(.a(new_n47_), .b(x18), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(new_n87_), .c(new_n71_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  aoi21  g77(.a(x10), .b(new_n54_), .c(z08), .O(new_n122_));
