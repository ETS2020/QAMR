...
module FAU ( 
  ...
  nand2  g41(.a(new_n85_), .b(x02), .O(new_n86_));
  ...
  nand3  g46(.a(new_n53_), .b(x09), .c(new_n45_), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  oai21  g48(.a(new_n87_), .b(x21), .c(new_n92_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n90_), .c(new_n86_), .O(z11));
  oai21  g50(.a(new_n53_), .b(x03), .c(x08), .O(new_n95_));
  aoi21  g51(.a(new_n79_), .b(x14), .c(new_n49_), .O(new_n96_));
  inv1   g52(.a(x22), .O(new_n97_));
  nand2  g53(.a(new_n88_), .b(new_n97_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n71_), .O(new_n99_));
  ...
  nand2  g68(.a(new_n85_), .b(x05), .O(new_n113_));
  oai21  g69(.a(new_n112_), .b(new_n91_), .c(new_n113_), .O(z14));
  ...
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n92_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n66_), .O(z15));
  nand2  g76(.a(new_n85_), .b(x07), .O(new_n121_));
  ...
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n92_), .O(new_n127_));
