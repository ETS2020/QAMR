...
module FAU ( 
  ...
  nand2  g07(.a(x11), .b(x10), .O(new_n52_));
  ...
  oai21  g13(.a(new_n48_), .b(new_n57_), .c(new_n52_), .O(z02));
  inv1   g14(.a(x02), .O(new_n59_));
  oai21  g15(.a(new_n48_), .b(new_n59_), .c(new_n52_), .O(z03));
  nand2  g16(.a(x08), .b(x03), .O(new_n61_));
  nand2  g17(.a(new_n61_), .b(new_n52_), .O(z04));
  nand2  g18(.a(new_n54_), .b(x04), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z05));
  nand2  g20(.a(new_n54_), .b(x05), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z06));
  nand2  g22(.a(x08), .b(x06), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n52_), .O(z07));
  nand2  g24(.a(new_n54_), .b(x07), .O(new_n69_));
  ...
  aoi21  g30(.a(x08), .b(x00), .c(new_n53_), .O(new_n75_));
  ...
  oai21  g39(.a(new_n77_), .b(new_n57_), .c(new_n83_), .O(z10));
  ...
  oai21  g45(.a(new_n78_), .b(x21), .c(new_n89_), .O(new_n90_));
  oai22  g46(.a(new_n90_), .b(new_n88_), .c(new_n77_), .d(new_n59_), .O(z11));
  inv1   g47(.a(z04), .O(new_n92_));
  inv1   g48(.a(new_n86_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(x22), .O(new_n94_));
  aoi21  g50(.a(new_n85_), .b(x14), .c(new_n94_), .O(new_n95_));
  oai21  g51(.a(new_n93_), .b(x22), .c(new_n89_), .O(new_n96_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n50_), .c(new_n65_), .O(z14));
  nand3  g68(.a(x26), .b(x25), .c(x17), .O(new_n113_));
  inv1   g69(.a(new_n113_), .O(new_n114_));
  and2   g70(.a(x22), .b(x21), .O(new_n115_));
  nand4  g71(.a(new_n109_), .b(new_n115_), .c(new_n78_), .d(x25), .O(new_n116_));
  ...
  nand2  g76(.a(new_n54_), .b(x06), .O(new_n121_));
  ...
  nand4  g83(.a(new_n127_), .b(new_n85_), .c(x19), .d(new_n125_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n89_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n124_), .c(new_n69_), .O(z16));
endmodule
