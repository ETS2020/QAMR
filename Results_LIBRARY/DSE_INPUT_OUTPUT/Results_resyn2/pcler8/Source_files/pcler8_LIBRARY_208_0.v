...
module FAU ( 
  ...
  oai21  g11(.a(new_n55_), .b(new_n47_), .c(new_n46_), .O(z00));
  ...
  aoi21  g30(.a(new_n74_), .b(new_n54_), .c(new_n73_), .O(new_n75_));
  aoi21  g31(.a(x08), .b(x00), .c(new_n45_), .O(new_n76_));
  oai21  g32(.a(new_n75_), .b(new_n50_), .c(new_n76_), .O(z09));
  nand4  g33(.a(new_n54_), .b(new_n51_), .c(x19), .d(x12), .O(new_n78_));
  inv1   g34(.a(x20), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n73_), .O(new_n80_));
  nand4  g36(.a(new_n80_), .b(new_n51_), .c(new_n47_), .d(new_n46_), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n78_), .c(new_n59_), .O(z10));
  ...
  oai21  g43(.a(new_n83_), .b(x21), .c(new_n51_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n87_), .c(new_n61_), .O(z11));
  inv1   g45(.a(x22), .O(new_n90_));
  nand2  g46(.a(x24), .b(x23), .O(new_n91_));
  nand3  g47(.a(x26), .b(x25), .c(x14), .O(new_n92_));
  nor2   g48(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nor3   g49(.a(new_n93_), .b(new_n84_), .c(new_n90_), .O(new_n94_));
  nand2  g50(.a(new_n84_), .b(new_n90_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n51_), .O(new_n96_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n103_), .c(new_n50_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n65_), .c(new_n46_), .O(z13));
  inv1   g62(.a(x24), .O(new_n107_));
  oai21  g63(.a(new_n52_), .b(new_n47_), .c(new_n107_), .O(new_n108_));
  inv1   g64(.a(new_n52_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n83_), .c(x24), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n108_), .c(new_n51_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n67_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n46_), .O(new_n113_));
  nand3  g69(.a(new_n98_), .b(new_n51_), .c(x16), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n113_), .O(z14));
  inv1   g71(.a(x25), .O(new_n116_));
  nand4  g72(.a(new_n109_), .b(new_n83_), .c(new_n116_), .d(x24), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  inv1   g74(.a(x17), .O(new_n119_));
  nor2   g75(.a(x25), .b(new_n119_), .O(new_n120_));
  nor2   g76(.a(new_n100_), .b(new_n91_), .O(new_n121_));
  nand2  g77(.a(x26), .b(x17), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n118_), .c(new_n51_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n69_), .c(new_n46_), .O(z15));
  inv1   g81(.a(x26), .O(new_n126_));
  inv1   g82(.a(new_n91_), .O(new_n127_));
  nand3  g83(.a(new_n101_), .b(new_n127_), .c(x25), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nor2   g85(.a(new_n126_), .b(new_n116_), .O(new_n130_));
  aoi21  g86(.a(new_n121_), .b(new_n130_), .c(new_n50_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  and2   g88(.a(x26), .b(x18), .O(new_n133_));
  aoi22  g89(.a(new_n133_), .b(new_n51_), .c(x08), .d(x07), .O(new_n134_));
  aoi21  g90(.a(new_n134_), .b(new_n132_), .c(new_n45_), .O(z16));
endmodule
