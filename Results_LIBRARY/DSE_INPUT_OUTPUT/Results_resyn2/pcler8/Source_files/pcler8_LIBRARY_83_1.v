...
module FAU ( 
  ...
  inv1   g22(.a(new_n46_), .O(new_n67_));
  ...
  nand2  g29(.a(new_n54_), .b(new_n46_), .O(new_n74_));
  ...
  aoi21  g42(.a(new_n86_), .b(new_n59_), .c(new_n67_), .O(z10));
  nand3  g43(.a(x21), .b(x20), .c(x19), .O(new_n88_));
  nand2  g44(.a(x22), .b(x13), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n77_), .O(new_n90_));
  inv1   g46(.a(x21), .O(new_n91_));
  aoi21  g47(.a(new_n82_), .b(new_n91_), .c(new_n53_), .O(new_n92_));
  oai21  g48(.a(new_n90_), .b(new_n88_), .c(new_n92_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n61_), .c(new_n67_), .O(z11));
  nand3  g50(.a(new_n50_), .b(x24), .c(x22), .O(new_n95_));
  ...
  aoi21  g56(.a(new_n88_), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  aoi21  g57(.a(new_n98_), .b(new_n96_), .c(new_n101_), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n74_), .c(new_n63_), .O(z12));
  inv1   g59(.a(new_n49_), .O(new_n104_));
  nand2  g60(.a(new_n48_), .b(new_n47_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n54_), .c(new_n104_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n65_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n46_), .O(new_n108_));
  nand2  g64(.a(new_n97_), .b(new_n88_), .O(new_n109_));
  nand2  g65(.a(new_n54_), .b(x15), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(new_n96_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n108_), .O(z13));
  nand2  g69(.a(new_n50_), .b(x16), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n49_), .c(x24), .O(new_n115_));
  inv1   g71(.a(x24), .O(new_n116_));
  nand2  g72(.a(new_n104_), .b(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n115_), .c(new_n54_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n68_), .c(new_n46_), .O(z14));
  aoi21  g75(.a(new_n49_), .b(x24), .c(x25), .O(new_n120_));
  nand4  g76(.a(new_n100_), .b(x25), .c(x24), .d(x23), .O(new_n121_));
  ...
  nand3  g80(.a(new_n111_), .b(new_n50_), .c(x17), .O(new_n125_));
  ...
  aoi21  g85(.a(new_n129_), .b(new_n128_), .c(new_n53_), .O(new_n130_));
  oai21  g86(.a(new_n127_), .b(x26), .c(new_n130_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n72_), .c(new_n67_), .O(z16));
endmodule
