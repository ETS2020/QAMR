...
module FAU ( 
  ...
  nor2   g23(.a(new_n47_), .b(new_n45_), .O(z08));
  nand2  g24(.a(z08), .b(x05), .O(new_n69_));
  ...
  oai22  g30(.a(new_n74_), .b(new_n51_), .c(new_n58_), .d(new_n57_), .O(z09));
  ...
  nand3  g37(.a(new_n81_), .b(new_n60_), .c(new_n46_), .O(z10));
  ...
  oai21  g43(.a(new_n76_), .b(x21), .c(new_n50_), .O(new_n88_));
  ...
  inv1   g50(.a(new_n83_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(x22), .c(new_n50_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n94_), .c(new_n91_), .O(z12));
  ...
  oai21  g60(.a(x08), .b(new_n45_), .c(x05), .O(new_n105_));
  ...
  oai21  g66(.a(new_n93_), .b(new_n101_), .c(new_n110_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n76_), .b(new_n116_), .c(new_n108_), .d(x25), .O(new_n117_));
  ...
  and2   g77(.a(new_n71_), .b(new_n46_), .O(new_n122_));
  oai21  g78(.a(new_n121_), .b(new_n49_), .c(new_n122_), .O(z15));
  nor2   g79(.a(new_n93_), .b(new_n119_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(x25), .c(x26), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(new_n54_), .b(x19), .c(new_n126_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n50_), .O(new_n128_));
  nor2   g84(.a(z08), .b(new_n57_), .O(new_n129_));
