...
module FAU ( 
  ...
  aoi21  g18(.a(x10), .b(new_n62_), .c(new_n45_), .O(z05));
  ...
  nor2   g31(.a(new_n57_), .b(new_n45_), .O(new_n76_));
  ...
  oai22  g40(.a(new_n84_), .b(new_n83_), .c(new_n77_), .d(new_n55_), .O(z10));
  nand2  g41(.a(new_n57_), .b(x09), .O(new_n86_));
  inv1   g42(.a(new_n79_), .O(new_n87_));
  oai21  g43(.a(x20), .b(x08), .c(x19), .O(new_n88_));
  nand3  g44(.a(x23), .b(x22), .c(x13), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n49_), .c(x21), .O(new_n90_));
  aoi22  g46(.a(new_n90_), .b(new_n87_), .c(new_n88_), .d(x21), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n86_), .c(new_n58_), .O(z11));
  aoi21  g48(.a(new_n80_), .b(x14), .c(new_n47_), .O(new_n93_));
  inv1   g49(.a(x21), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  oai21  g51(.a(new_n79_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  ...
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(new_n102_));
  oai21  g58(.a(new_n77_), .b(new_n62_), .c(new_n102_), .O(z13));
  ...
  nand2  g66(.a(new_n76_), .b(x05), .O(new_n111_));
  oai21  g67(.a(new_n110_), .b(new_n70_), .c(new_n111_), .O(z14));
  nand2  g68(.a(new_n76_), .b(x06), .O(new_n113_));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n48_), .c(x25), .d(x24), .O(new_n115_));
  ...
  oai21  g75(.a(new_n57_), .b(x07), .c(x08), .O(new_n120_));
  inv1   g76(.a(x26), .O(new_n121_));
  nand4  g77(.a(new_n106_), .b(x25), .c(x24), .d(x23), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nor2   g79(.a(new_n49_), .b(x18), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n48_), .c(new_n86_), .O(new_n125_));
