...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_,
    new_n53_, new_n56_, new_n58_, new_n60_, new_n62_, new_n65_, new_n67_,
  ...
  nor2   g06(.a(new_n47_), .b(x08), .O(new_n51_));
  ...
  nand2  g12(.a(new_n56_), .b(new_n52_), .O(z03));
  nand2  g13(.a(x08), .b(x03), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(new_n52_), .O(z04));
  nand2  g15(.a(x08), .b(x04), .O(new_n60_));
  nand2  g16(.a(new_n60_), .b(new_n52_), .O(z05));
  ...
  nand2  g26(.a(new_n70_), .b(new_n53_), .O(z09));
  ...
  nor2   g33(.a(new_n77_), .b(x08), .O(new_n78_));
  oai21  g34(.a(x20), .b(x19), .c(new_n78_), .O(new_n79_));
  nor2   g35(.a(z02), .b(new_n51_), .O(new_n80_));
  oai21  g36(.a(new_n79_), .b(new_n76_), .c(new_n80_), .O(z10));
  ...
  oai21  g41(.a(new_n72_), .b(x21), .c(new_n67_), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n85_), .c(new_n56_), .O(z11));
  ...
  oai21  g46(.a(new_n90_), .b(new_n88_), .c(new_n58_), .O(z12));
  ...
  nand4  g56(.a(new_n100_), .b(new_n72_), .c(x24), .d(x23), .O(new_n101_));
  ...
  nor2   g68(.a(z07), .b(new_n51_), .O(new_n113_));
  ...
  oai22  g75(.a(new_n119_), .b(new_n115_), .c(new_n46_), .d(new_n65_), .O(z16));
endmodule
