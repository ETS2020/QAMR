...
module FAU ( 
  ...
  oai22  g43(.a(new_n87_), .b(new_n86_), .c(new_n71_), .d(new_n55_), .O(z11));
  ...
  oai21  g53(.a(new_n71_), .b(new_n59_), .c(new_n97_), .O(z13));
  ...
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n80_), .O(new_n114_));
  ...
  nand2  g73(.a(new_n117_), .b(new_n83_), .O(new_n118_));
