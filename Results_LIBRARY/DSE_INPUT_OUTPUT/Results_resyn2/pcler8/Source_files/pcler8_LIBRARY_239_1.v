...
module FAU ( 
  ...
  nor2   g28(.a(new_n72_), .b(new_n63_), .O(z08));
  ...
  oai21  g36(.a(new_n80_), .b(new_n53_), .c(new_n74_), .O(z09));
  nand2  g37(.a(x20), .b(x19), .O(new_n82_));
  aoi21  g38(.a(new_n78_), .b(x12), .c(new_n82_), .O(new_n83_));
  oai21  g39(.a(x11), .b(x08), .c(new_n45_), .O(new_n84_));
  inv1   g40(.a(x20), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n75_), .O(new_n86_));
  nand4  g42(.a(new_n86_), .b(new_n84_), .c(new_n52_), .d(x09), .O(new_n87_));
  ...
  aoi21  g51(.a(new_n95_), .b(new_n61_), .c(new_n63_), .O(z11));
  ...
  oai22  g57(.a(new_n101_), .b(new_n98_), .c(new_n64_), .d(new_n63_), .O(z12));
  ...
  oai21  g73(.a(new_n117_), .b(new_n108_), .c(new_n68_), .O(z14));
  inv1   g74(.a(z07), .O(new_n119_));
  nand3  g75(.a(x26), .b(x25), .c(x17), .O(new_n120_));
  inv1   g76(.a(new_n120_), .O(new_n121_));
  nand4  g77(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(x25), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nand2  g79(.a(x24), .b(x23), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n48_), .c(new_n123_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n53_), .c(new_n119_), .O(z15));
  nor2   g83(.a(new_n124_), .b(new_n48_), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(x25), .c(x26), .O(new_n129_));
  inv1   g85(.a(x18), .O(new_n130_));
  nand2  g86(.a(new_n50_), .b(new_n130_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n116_), .c(new_n54_), .O(new_n132_));
  and2   g88(.a(new_n72_), .b(new_n46_), .O(new_n133_));
  oai21  g89(.a(new_n132_), .b(new_n129_), .c(new_n133_), .O(z16));
endmodule
