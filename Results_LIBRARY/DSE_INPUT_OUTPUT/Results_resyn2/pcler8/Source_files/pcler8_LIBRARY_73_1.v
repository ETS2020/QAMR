...
module FAU ( 
  ...
  nor3   g13(.a(new_n57_), .b(new_n53_), .c(new_n52_), .O(z00));
  nand2  g14(.a(x08), .b(x00), .O(new_n59_));
  nor2   g15(.a(new_n59_), .b(new_n50_), .O(z01));
  nand2  g16(.a(x08), .b(x01), .O(new_n61_));
  nor2   g17(.a(new_n61_), .b(new_n50_), .O(z02));
  ...
  nor2   g27(.a(new_n71_), .b(new_n50_), .O(z07));
  ...
  and2   g38(.a(new_n59_), .b(new_n49_), .O(new_n83_));
  ...
  and2   g45(.a(new_n61_), .b(new_n49_), .O(new_n90_));
  ...
  oai21  g51(.a(new_n85_), .b(x21), .c(new_n51_), .O(new_n96_));
  ...
  aoi21  g59(.a(new_n103_), .b(new_n65_), .c(new_n50_), .O(z12));
  nand2  g60(.a(new_n55_), .b(new_n54_), .O(new_n105_));
  aoi22  g61(.a(new_n105_), .b(new_n57_), .c(new_n92_), .d(x15), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n52_), .c(new_n67_), .O(z13));
  nand2  g63(.a(new_n77_), .b(x16), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  xor2a  g65(.a(new_n56_), .b(x24), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n109_), .c(new_n88_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n69_), .c(new_n50_), .O(z14));
  nand3  g68(.a(new_n56_), .b(x25), .c(x24), .O(new_n113_));
  inv1   g69(.a(x25), .O(new_n114_));
  nand2  g70(.a(new_n56_), .b(x24), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n113_), .c(new_n51_), .O(new_n117_));
  nand3  g73(.a(x17), .b(x11), .c(new_n46_), .O(new_n118_));
  nand4  g74(.a(x26), .b(x25), .c(x09), .d(new_n45_), .O(new_n119_));
  ...
  nand3  g81(.a(new_n56_), .b(new_n77_), .c(new_n125_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n88_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n73_), .c(new_n50_), .O(z16));
endmodule
