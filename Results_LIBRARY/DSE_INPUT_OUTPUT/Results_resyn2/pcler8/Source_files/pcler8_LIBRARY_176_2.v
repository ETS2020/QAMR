...
module FAU ( 
  ...
  aoi22  g45(.a(new_n89_), .b(new_n80_), .c(new_n87_), .d(x21), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n70_), .c(new_n58_), .O(z11));
  inv1   g47(.a(new_n72_), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(x14), .c(new_n49_), .O(new_n93_));
  ...
  nand2  g56(.a(new_n95_), .b(new_n45_), .O(new_n101_));
  ...
  inv1   g68(.a(new_n77_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(x06), .O(new_n114_));
  ...
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n94_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n114_), .O(z15));
  nand2  g76(.a(new_n113_), .b(x07), .O(new_n121_));
  ...
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n94_), .O(new_n127_));
