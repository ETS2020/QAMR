...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_,
    new_n55_, new_n57_, new_n59_, new_n61_, new_n64_, new_n66_, new_n67_,
  ...
  nand2  g07(.a(x10), .b(new_n46_), .O(new_n52_));
  ...
  nor2   g20(.a(new_n46_), .b(new_n64_), .O(z08));
  ...
  oai22  g47(.a(new_n91_), .b(new_n89_), .c(new_n46_), .d(new_n57_), .O(z12));
  ...
  nor2   g69(.a(z07), .b(new_n71_), .O(new_n114_));
  ...
  oai22  g76(.a(new_n120_), .b(new_n116_), .c(new_n46_), .d(new_n64_), .O(z16));
endmodule
