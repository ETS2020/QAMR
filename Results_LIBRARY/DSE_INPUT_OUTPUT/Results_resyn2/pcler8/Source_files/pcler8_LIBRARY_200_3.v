...
module FAU ( 
  ...
  oai21  g28(.a(x10), .b(x01), .c(x08), .O(new_n73_));
  ...
  oai21  g43(.a(x10), .b(x03), .c(x08), .O(new_n88_));
  aoi21  g44(.a(new_n75_), .b(x14), .c(new_n49_), .O(new_n89_));
  ...
  oai21  g48(.a(x10), .b(x04), .c(x08), .O(new_n93_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n48_), .c(new_n61_), .O(z14));
