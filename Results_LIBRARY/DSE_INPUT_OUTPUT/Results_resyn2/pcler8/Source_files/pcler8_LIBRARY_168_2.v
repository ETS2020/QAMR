...
module FAU ( 
  ...
  oai21  g12(.a(new_n47_), .b(x03), .c(x08), .O(new_n57_));
  ...
  nor2   g35(.a(new_n47_), .b(new_n46_), .O(new_n80_));
  ...
  oai21  g42(.a(new_n73_), .b(x21), .c(new_n86_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(z11));
  ...
  oai21  g52(.a(new_n96_), .b(new_n94_), .c(new_n68_), .O(new_n97_));
  ...
  nand2  g61(.a(new_n80_), .b(x05), .O(new_n106_));
  oai21  g62(.a(new_n105_), .b(new_n48_), .c(new_n106_), .O(z14));
  nand2  g63(.a(new_n80_), .b(x06), .O(new_n108_));
  ...
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n86_), .O(new_n115_));
