...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x07), .O(new_n45_));
  ...
  oai21  g28(.a(x10), .b(x08), .c(x07), .O(new_n73_));
  ...
  nand2  g34(.a(new_n60_), .b(x00), .O(new_n79_));
  ...
  oai21  g49(.a(new_n81_), .b(x21), .c(new_n54_), .O(new_n94_));
  ...
  aoi21  g55(.a(x08), .b(x03), .c(new_n59_), .O(new_n100_));
  ...
  nand3  g61(.a(new_n105_), .b(new_n67_), .c(new_n45_), .O(z13));
  ...
  nand2  g70(.a(new_n60_), .b(x05), .O(new_n115_));
