...
module FAU ( 
  ...
  nand3  g40(.a(new_n84_), .b(new_n60_), .c(new_n46_), .O(z10));
  ...
  oai21  g54(.a(new_n74_), .b(new_n53_), .c(x17), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g56(.a(new_n48_), .b(new_n47_), .O(new_n101_));
  nor2   g57(.a(new_n53_), .b(new_n49_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n100_), .c(new_n66_), .O(z13));
  ...
  nand3  g66(.a(new_n110_), .b(new_n109_), .c(new_n79_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n108_), .c(new_n106_), .O(new_n112_));
  nand2  g68(.a(new_n54_), .b(new_n46_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n112_), .c(new_n68_), .O(z14));
  inv1   g70(.a(z07), .O(new_n115_));
  nand3  g71(.a(x26), .b(x25), .c(x17), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(new_n117_));
  nand4  g73(.a(new_n110_), .b(new_n109_), .c(new_n79_), .d(x25), .O(new_n118_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n53_), .c(new_n115_), .O(z15));
  nor2   g79(.a(new_n120_), .b(new_n48_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(x25), .c(x26), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand2  g82(.a(new_n50_), .b(new_n126_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n111_), .c(new_n54_), .O(new_n128_));
  and2   g84(.a(new_n72_), .b(new_n46_), .O(new_n129_));
