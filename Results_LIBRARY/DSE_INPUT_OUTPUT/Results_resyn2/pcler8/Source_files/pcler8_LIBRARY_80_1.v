...
module FAU ( 
  ...
  nor2   g33(.a(new_n51_), .b(new_n50_), .O(new_n78_));
  aoi21  g34(.a(new_n78_), .b(x12), .c(new_n48_), .O(new_n79_));
  inv1   g35(.a(new_n54_), .O(new_n80_));
  or2    g36(.a(x20), .b(x19), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n80_), .c(new_n47_), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n79_), .c(new_n60_), .O(z10));
  inv1   g39(.a(z03), .O(new_n84_));
  nand3  g40(.a(x23), .b(x22), .c(x13), .O(new_n85_));
  nor2   g41(.a(new_n85_), .b(new_n50_), .O(new_n86_));
  nand2  g42(.a(new_n49_), .b(x21), .O(new_n87_));
  nor2   g43(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  oai21  g44(.a(new_n49_), .b(x21), .c(new_n80_), .O(new_n89_));
  ...
  nand2  g53(.a(new_n97_), .b(new_n80_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n95_), .c(new_n91_), .O(z12));
  ...
  aoi21  g59(.a(new_n93_), .b(new_n101_), .c(new_n54_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n66_), .c(new_n47_), .O(z13));
  inv1   g62(.a(x24), .O(new_n107_));
  nor2   g63(.a(new_n51_), .b(new_n48_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g65(.a(new_n92_), .b(x16), .O(new_n110_));
  oai21  g66(.a(new_n51_), .b(new_n48_), .c(x24), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n80_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n68_), .c(new_n47_), .O(z14));
  inv1   g70(.a(x25), .O(new_n115_));
  inv1   g71(.a(new_n51_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n49_), .c(x24), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g74(.a(x25), .b(x24), .O(new_n119_));
  aoi21  g75(.a(x26), .b(x17), .c(new_n119_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n108_), .c(new_n54_), .O(new_n121_));
  ...
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n108_), .O(new_n127_));
  nand2  g83(.a(new_n124_), .b(new_n108_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n127_), .c(new_n80_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n72_), .c(new_n47_), .O(z16));
endmodule
