...
module FAU ( 
  ...
  nand3  g51(.a(new_n95_), .b(new_n93_), .c(new_n56_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n63_), .c(new_n45_), .O(z11));
  nand2  g53(.a(new_n91_), .b(x22), .O(new_n98_));
  aoi21  g54(.a(new_n78_), .b(x14), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n103_), .c(new_n56_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n67_), .c(new_n45_), .O(z13));
  inv1   g62(.a(x24), .O(new_n107_));
  nand2  g63(.a(new_n49_), .b(new_n107_), .O(new_n108_));
  nand3  g64(.a(new_n52_), .b(x24), .c(x16), .O(new_n109_));
  nand3  g65(.a(new_n76_), .b(new_n84_), .c(x23), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(x24), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n56_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n69_), .O(z14));
  and2   g70(.a(x24), .b(x23), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n76_), .c(new_n84_), .d(x25), .O(new_n116_));
  nand2  g72(.a(x24), .b(x23), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n48_), .c(new_n50_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n56_), .O(new_n119_));
  ...
  and2   g79(.a(new_n116_), .b(new_n51_), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n52_), .b(x24), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n110_), .c(new_n56_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n124_), .c(new_n73_), .O(z16));
endmodule
