...
module FAU ( 
  ...
  nor3   g21(.a(new_n54_), .b(new_n45_), .c(new_n65_), .O(z05));
  ...
  nand3  g29(.a(new_n73_), .b(x09), .c(new_n45_), .O(new_n74_));
  inv1   g30(.a(new_n74_), .O(new_n75_));
  nand3  g31(.a(new_n51_), .b(x24), .c(x23), .O(new_n76_));
  ...
  nand2  g36(.a(new_n58_), .b(x00), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n80_), .O(z09));
  and2   g38(.a(x20), .b(x19), .O(new_n83_));
  nand2  g39(.a(new_n77_), .b(x12), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n76_), .c(new_n83_), .O(new_n85_));
  nor2   g41(.a(x20), .b(x19), .O(new_n86_));
  nor2   g42(.a(new_n86_), .b(new_n74_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n59_), .O(z10));
  inv1   g45(.a(new_n76_), .O(new_n90_));
  nand2  g46(.a(new_n83_), .b(x21), .O(new_n91_));
  and2   g47(.a(x22), .b(x13), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n90_), .c(new_n91_), .O(new_n93_));
  oai21  g49(.a(new_n83_), .b(x21), .c(new_n75_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n93_), .c(new_n61_), .O(z11));
  aoi21  g51(.a(new_n90_), .b(x14), .c(new_n47_), .O(new_n96_));
  inv1   g52(.a(new_n91_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(x22), .c(new_n75_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n63_), .O(z12));
  inv1   g55(.a(x09), .O(new_n100_));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  aoi21  g58(.a(new_n47_), .b(new_n46_), .c(x08), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(new_n104_));
  oai22  g60(.a(new_n104_), .b(x10), .c(new_n45_), .d(new_n65_), .O(z13));
  nand3  g61(.a(new_n51_), .b(x24), .c(x16), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  inv1   g63(.a(x24), .O(new_n108_));
  oai21  g64(.a(new_n47_), .b(new_n46_), .c(new_n108_), .O(new_n109_));
  nand4  g65(.a(new_n77_), .b(new_n83_), .c(x24), .d(x23), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(new_n107_), .O(new_n111_));
  nand2  g67(.a(new_n58_), .b(x05), .O(new_n112_));
  oai21  g68(.a(new_n111_), .b(new_n74_), .c(new_n112_), .O(z14));
  nand2  g69(.a(new_n51_), .b(x17), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nand3  g71(.a(new_n48_), .b(x25), .c(x24), .O(new_n116_));
  nand2  g72(.a(new_n110_), .b(new_n49_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nand2  g74(.a(new_n58_), .b(x06), .O(new_n119_));
  oai21  g75(.a(new_n118_), .b(new_n74_), .c(new_n119_), .O(z15));
  nand2  g76(.a(new_n116_), .b(new_n50_), .O(new_n121_));
  inv1   g77(.a(x18), .O(new_n122_));
  nand4  g78(.a(new_n51_), .b(new_n48_), .c(x24), .d(new_n122_), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(new_n121_), .c(new_n75_), .O(new_n124_));
