...
module FAU ( 
  ...
  nand2  g01(.a(new_n45_), .b(x07), .O(new_n46_));
  ...
  nor2   g14(.a(x17), .b(new_n58_), .O(new_n59_));
  ...
  nor2   g20(.a(new_n64_), .b(new_n59_), .O(z03));
  nand2  g21(.a(x08), .b(x03), .O(new_n66_));
  nor2   g22(.a(new_n66_), .b(new_n59_), .O(z04));
  nand2  g23(.a(x08), .b(x04), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n59_), .O(z05));
  nand3  g25(.a(new_n46_), .b(x08), .c(x05), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z06));
  nand2  g27(.a(x08), .b(x06), .O(new_n72_));
  nor2   g28(.a(new_n72_), .b(new_n59_), .O(z07));
  nand3  g29(.a(x17), .b(x08), .c(x07), .O(new_n74_));
  ...
  nand3  g35(.a(new_n79_), .b(new_n60_), .c(new_n46_), .O(z09));
  ...
  nand3  g50(.a(new_n94_), .b(new_n55_), .c(new_n46_), .O(new_n95_));
  oai22  g51(.a(new_n95_), .b(new_n91_), .c(new_n64_), .d(new_n59_), .O(z11));
  aoi21  g52(.a(new_n88_), .b(x14), .c(new_n48_), .O(new_n97_));
  inv1   g53(.a(new_n89_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(x22), .c(new_n55_), .O(new_n99_));
  and2   g55(.a(new_n66_), .b(new_n46_), .O(new_n100_));
  oai21  g56(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(z12));
  inv1   g57(.a(x15), .O(new_n102_));
  nor2   g58(.a(new_n76_), .b(new_n102_), .O(new_n103_));
  xor2a  g59(.a(new_n48_), .b(new_n47_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n103_), .c(new_n55_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n68_), .c(new_n46_), .O(z13));
  nor2   g62(.a(new_n54_), .b(new_n59_), .O(new_n107_));
  nand3  g63(.a(x26), .b(x25), .c(x16), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n49_), .c(x24), .O(new_n109_));
  inv1   g65(.a(x24), .O(new_n110_));
  and2   g66(.a(x22), .b(x21), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n81_), .c(x23), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n109_), .c(new_n107_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n70_), .O(z14));
  inv1   g71(.a(x25), .O(new_n116_));
  nand2  g72(.a(x24), .b(x23), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n48_), .c(new_n116_), .O(new_n118_));
  nor2   g74(.a(new_n117_), .b(new_n48_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(x25), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n107_), .O(new_n121_));
  nand3  g77(.a(x26), .b(x25), .c(x17), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(new_n54_), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(z07), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n121_), .O(z15));
  oai21  g81(.a(new_n45_), .b(x08), .c(x07), .O(new_n126_));
  aoi21  g82(.a(new_n119_), .b(x25), .c(x26), .O(new_n127_));
  inv1   g83(.a(x18), .O(new_n128_));
  nand2  g84(.a(new_n51_), .b(new_n128_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n112_), .c(new_n55_), .O(new_n130_));
