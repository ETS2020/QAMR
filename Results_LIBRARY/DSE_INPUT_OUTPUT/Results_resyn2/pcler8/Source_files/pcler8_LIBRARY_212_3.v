...
module FAU ( 
  ...
  nand2  g00(.a(x16), .b(x10), .O(new_n45_));
  ...
  nor2   g13(.a(new_n57_), .b(new_n51_), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(x00), .O(new_n59_));
  inv1   g15(.a(new_n59_), .O(z01));
  inv1   g16(.a(x01), .O(new_n61_));
  oai21  g17(.a(new_n51_), .b(new_n61_), .c(new_n45_), .O(z02));
  ...
  nand2  g42(.a(new_n58_), .b(x01), .O(new_n87_));
  ...
  oai21  g48(.a(new_n81_), .b(x21), .c(new_n54_), .O(new_n93_));
  ...
  oai21  g53(.a(new_n95_), .b(x22), .c(new_n54_), .O(new_n98_));
  aoi21  g54(.a(x08), .b(x03), .c(new_n57_), .O(new_n99_));
  ...
  nand3  g60(.a(new_n104_), .b(new_n67_), .c(new_n45_), .O(z13));
  ...
  nand2  g69(.a(new_n58_), .b(x05), .O(new_n114_));
  ...
  nand2  g79(.a(new_n58_), .b(x06), .O(new_n124_));
  oai21  g80(.a(new_n123_), .b(new_n53_), .c(new_n124_), .O(z15));
  nor2   g81(.a(new_n121_), .b(new_n47_), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(x25), .c(x26), .O(new_n127_));
  inv1   g83(.a(x18), .O(new_n128_));
  nand3  g84(.a(new_n89_), .b(new_n110_), .c(new_n128_), .O(new_n129_));
