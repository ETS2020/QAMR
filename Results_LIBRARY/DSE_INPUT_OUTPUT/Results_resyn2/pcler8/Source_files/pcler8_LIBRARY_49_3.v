...
module FAU ( 
  ...
  oai21  g11(.a(new_n46_), .b(new_n55_), .c(new_n45_), .O(z01));
  ...
  inv1   g28(.a(new_n58_), .O(new_n73_));
  ...
  oai21  g33(.a(new_n73_), .b(new_n55_), .c(new_n77_), .O(z09));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n50_), .c(new_n87_), .O(new_n89_));
  oai21  g45(.a(new_n79_), .b(x21), .c(new_n74_), .O(new_n90_));
  oai22  g46(.a(new_n90_), .b(new_n89_), .c(new_n73_), .d(new_n61_), .O(z11));
  aoi21  g47(.a(new_n50_), .b(x14), .c(new_n51_), .O(new_n92_));
  inv1   g48(.a(new_n87_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(x22), .c(new_n74_), .O(new_n94_));
  aoi21  g50(.a(x08), .b(x03), .c(new_n57_), .O(new_n95_));
  ...
  oai21  g56(.a(new_n100_), .b(new_n98_), .c(new_n74_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n65_), .O(z13));
  inv1   g58(.a(z06), .O(new_n103_));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  nand4  g61(.a(new_n80_), .b(new_n79_), .c(x24), .d(x23), .O(new_n106_));
  inv1   g62(.a(x24), .O(new_n107_));
  oai21  g63(.a(new_n51_), .b(new_n99_), .c(new_n107_), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n48_), .c(new_n103_), .O(z14));
  nor2   g66(.a(new_n51_), .b(new_n99_), .O(new_n111_));
  ...
  aoi21  g73(.a(new_n111_), .b(new_n113_), .c(x26), .O(new_n118_));
  oai21  g74(.a(new_n53_), .b(x18), .c(new_n74_), .O(new_n119_));
  aoi21  g75(.a(x08), .b(x07), .c(new_n57_), .O(new_n120_));
