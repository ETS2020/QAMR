...
module FAU ( 
  ...
  nand3  g35(.a(new_n79_), .b(new_n58_), .c(new_n46_), .O(z09));
  ...
  nand3  g59(.a(new_n103_), .b(new_n102_), .c(new_n46_), .O(z13));
  ...
  oai21  g69(.a(new_n113_), .b(new_n54_), .c(new_n105_), .O(z14));
  nand3  g70(.a(x26), .b(x25), .c(x17), .O(new_n115_));
  inv1   g71(.a(new_n115_), .O(new_n116_));
  and2   g72(.a(x22), .b(x21), .O(new_n117_));
  nand4  g73(.a(new_n111_), .b(new_n117_), .c(new_n81_), .d(x25), .O(new_n118_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n54_), .c(new_n72_), .O(z15));
  nor2   g79(.a(new_n120_), .b(new_n48_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(x25), .c(x26), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(new_n88_), .b(new_n110_), .c(new_n126_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n55_), .O(new_n128_));
  oai22  g84(.a(new_n128_), .b(new_n125_), .c(new_n63_), .d(new_n74_), .O(z16));
endmodule
