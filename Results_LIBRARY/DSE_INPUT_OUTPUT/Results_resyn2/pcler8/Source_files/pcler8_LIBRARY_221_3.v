...
module FAU ( 
  ...
  nand2  g07(.a(x16), .b(x10), .O(new_n52_));
  ...
  aoi21  g31(.a(x08), .b(x00), .c(new_n53_), .O(new_n76_));
  ...
  aoi21  g41(.a(x08), .b(x01), .c(new_n53_), .O(new_n86_));
  ...
  oai21  g52(.a(new_n94_), .b(x22), .c(new_n71_), .O(new_n97_));
  ...
  aoi21  g60(.a(x08), .b(x04), .c(new_n53_), .O(new_n105_));
  ...
  oai21  g69(.a(new_n113_), .b(new_n50_), .c(new_n65_), .O(z14));
  ...
  nand2  g77(.a(new_n54_), .b(x06), .O(new_n122_));
  ...
  nand4  g84(.a(new_n128_), .b(new_n80_), .c(x19), .d(new_n126_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n71_), .O(new_n130_));
  aoi21  g86(.a(x08), .b(x07), .c(new_n53_), .O(new_n131_));
