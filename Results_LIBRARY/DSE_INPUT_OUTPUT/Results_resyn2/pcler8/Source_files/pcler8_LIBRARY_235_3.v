...
module FAU ( 
  ...
  nor2   g58(.a(new_n52_), .b(new_n97_), .O(new_n103_));
  xor2a  g59(.a(new_n103_), .b(x24), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n102_), .c(new_n48_), .O(new_n105_));
  nand2  g61(.a(x08), .b(x05), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n105_), .c(x10), .O(z14));
  nand3  g63(.a(x26), .b(x25), .c(x17), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand3  g65(.a(new_n103_), .b(x25), .c(x24), .O(new_n110_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n49_), .c(new_n68_), .O(z15));
  nand2  g72(.a(x08), .b(x07), .O(new_n117_));
  inv1   g73(.a(x26), .O(new_n118_));
  nand2  g74(.a(new_n110_), .b(new_n118_), .O(new_n119_));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n117_), .c(x10), .O(z16));
endmodule
