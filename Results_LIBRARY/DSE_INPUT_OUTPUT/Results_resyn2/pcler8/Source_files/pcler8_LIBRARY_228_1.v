...
module FAU ( 
  ...
  nand3  g15(.a(new_n56_), .b(x08), .c(x01), .O(new_n60_));
  ...
  nor2   g22(.a(new_n66_), .b(new_n57_), .O(z05));
  ...
  aoi21  g33(.a(new_n77_), .b(new_n52_), .c(x17), .O(new_n78_));
  ...
  nand4  g42(.a(new_n86_), .b(new_n52_), .c(new_n45_), .d(new_n55_), .O(new_n87_));
  ...
  inv1   g48(.a(new_n52_), .O(new_n93_));
  nor2   g49(.a(new_n80_), .b(x21), .O(new_n94_));
  nor2   g50(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n92_), .c(x17), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(x10), .c(new_n62_), .O(z11));
  nand2  g53(.a(new_n82_), .b(x14), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n90_), .c(x22), .O(new_n99_));
  nor2   g55(.a(new_n90_), .b(x22), .O(new_n100_));
  nor2   g56(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n99_), .c(x17), .O(new_n102_));
  ...
  aoi21  g61(.a(new_n47_), .b(new_n46_), .c(new_n93_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n105_), .c(x17), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(x10), .c(new_n66_), .O(z13));
  ...
  oai21  g70(.a(new_n114_), .b(new_n93_), .c(new_n45_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n55_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n68_), .O(z14));
  aoi21  g73(.a(new_n48_), .b(x24), .c(x25), .O(new_n118_));
  nand3  g74(.a(new_n48_), .b(x25), .c(x24), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n52_), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n118_), .c(new_n45_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n55_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n70_), .O(z15));
  inv1   g79(.a(x26), .O(new_n124_));
  nand2  g80(.a(new_n119_), .b(new_n124_), .O(new_n125_));
  nor2   g81(.a(new_n47_), .b(x18), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(new_n82_), .c(new_n93_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n125_), .c(x17), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(x10), .c(new_n72_), .O(z16));
endmodule
