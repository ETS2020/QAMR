...
module FAU ( 
  ...
  nand2  g30(.a(new_n56_), .b(x11), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(new_n50_), .c(x20), .O(new_n77_));
  inv1   g33(.a(x19), .O(new_n78_));
  nand3  g34(.a(new_n56_), .b(new_n47_), .c(new_n78_), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(new_n77_), .c(new_n59_), .O(z09));
  inv1   g36(.a(z02), .O(new_n81_));
  aoi21  g37(.a(new_n50_), .b(x12), .c(new_n51_), .O(new_n82_));
  oai21  g38(.a(x20), .b(x19), .c(new_n56_), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z10));
  ...
  oai21  g46(.a(new_n52_), .b(x21), .c(new_n90_), .O(new_n91_));
  ...
  oai21  g56(.a(new_n94_), .b(x22), .c(new_n56_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n93_), .O(z12));
  nand2  g58(.a(new_n85_), .b(x15), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n94_), .c(x23), .d(x22), .O(new_n104_));
  nand2  g60(.a(new_n95_), .b(new_n96_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n104_), .c(new_n56_), .O(new_n106_));
  ...
  nor3   g67(.a(new_n51_), .b(new_n49_), .c(new_n97_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g69(.a(x23), .b(x22), .O(new_n114_));
  oai21  g70(.a(new_n86_), .b(new_n114_), .c(new_n97_), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n113_), .c(new_n56_), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(new_n69_), .c(new_n46_), .O(z14));
  nand3  g73(.a(x24), .b(x23), .c(x22), .O(new_n118_));
  inv1   g74(.a(new_n118_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n94_), .c(x25), .O(new_n120_));
  oai21  g76(.a(new_n118_), .b(new_n86_), .c(new_n108_), .O(new_n121_));
  ...
  nand3  g80(.a(new_n76_), .b(new_n110_), .c(x17), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n124_), .O(z15));
  nor3   g82(.a(new_n49_), .b(new_n108_), .c(new_n97_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n52_), .c(x26), .O(new_n128_));
  nor2   g84(.a(new_n109_), .b(x18), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n127_), .c(new_n52_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n56_), .O(new_n131_));
