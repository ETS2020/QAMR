...
module FAU ( 
  ...
  oai21  g39(.a(new_n59_), .b(new_n58_), .c(new_n83_), .O(z10));
  ...
  oai22  g44(.a(new_n88_), .b(new_n87_), .c(new_n59_), .d(new_n61_), .O(z11));
  aoi21  g45(.a(new_n51_), .b(x14), .c(new_n52_), .O(new_n90_));
  inv1   g46(.a(new_n85_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x22), .c(new_n73_), .O(new_n92_));
  inv1   g48(.a(new_n46_), .O(new_n93_));
  aoi21  g49(.a(x08), .b(x03), .c(new_n93_), .O(new_n94_));
  oai21  g50(.a(new_n92_), .b(new_n90_), .c(new_n94_), .O(z12));
  ...
  oai21  g56(.a(new_n59_), .b(new_n65_), .c(new_n100_), .O(z13));
  ...
  oai21  g74(.a(new_n54_), .b(x18), .c(new_n73_), .O(new_n119_));
  aoi21  g75(.a(x08), .b(x07), .c(new_n93_), .O(new_n120_));
