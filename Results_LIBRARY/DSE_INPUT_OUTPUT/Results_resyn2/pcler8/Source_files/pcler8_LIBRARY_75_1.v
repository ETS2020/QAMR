...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_,
    new_n53_, new_n54_, new_n59_, new_n60_, new_n62_, new_n64_, new_n66_,
  ...
  oai21  g39(.a(x20), .b(x19), .c(new_n69_), .O(new_n84_));
  nor2   g40(.a(z02), .b(new_n52_), .O(new_n85_));
  ...
  oai21  g45(.a(new_n78_), .b(x21), .c(new_n69_), .O(new_n90_));
  nor2   g46(.a(z03), .b(new_n52_), .O(new_n91_));
  ...
  oai21  g50(.a(new_n94_), .b(x22), .c(new_n69_), .O(new_n95_));
  nor2   g51(.a(z04), .b(new_n52_), .O(new_n96_));
  oai21  g52(.a(new_n95_), .b(new_n93_), .c(new_n96_), .O(z12));
  xor2a  g53(.a(new_n47_), .b(new_n46_), .O(new_n98_));
  aoi21  g54(.a(new_n80_), .b(x15), .c(new_n98_), .O(new_n99_));
  oai22  g55(.a(new_n99_), .b(new_n70_), .c(new_n60_), .d(new_n59_), .O(z13));
  inv1   g56(.a(new_n69_), .O(new_n101_));
  nand4  g57(.a(new_n73_), .b(new_n78_), .c(x24), .d(x23), .O(new_n102_));
  ...
  oai21  g63(.a(new_n107_), .b(new_n101_), .c(new_n62_), .O(z14));
  ...
  nand2  g68(.a(new_n102_), .b(new_n112_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n70_), .c(new_n64_), .O(z15));
  inv1   g71(.a(new_n111_), .O(new_n116_));
  nor2   g72(.a(new_n47_), .b(x18), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n80_), .c(new_n70_), .O(new_n118_));
