// Benchmark "FAU" written by ABC on Tue Aug 11 20:09:26 2020
...
module FAU ( 
  ...
  nor2   g32(.a(x13), .b(new_n48_), .O(new_n77_));
  aoi21  g33(.a(x08), .b(x00), .c(new_n77_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n76_), .O(z09));
  and2   g35(.a(x20), .b(x19), .O(new_n80_));
  nand3  g36(.a(x22), .b(x21), .c(x12), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(new_n51_), .c(new_n80_), .O(new_n82_));
  nor2   g38(.a(x20), .b(x19), .O(new_n83_));
  nor2   g39(.a(new_n83_), .b(new_n49_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g41(.a(new_n85_), .b(new_n59_), .c(new_n46_), .O(z10));
  ...
  oai21  g47(.a(new_n80_), .b(x21), .c(new_n50_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(z11));
  aoi21  g49(.a(new_n88_), .b(x14), .c(new_n52_), .O(new_n94_));
  inv1   g50(.a(new_n89_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(x22), .c(new_n50_), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n94_), .c(new_n57_), .d(new_n63_), .O(z12));
  ...
  oai21  g58(.a(new_n57_), .b(new_n65_), .c(new_n102_), .O(z13));
  ...
  oai21  g66(.a(new_n110_), .b(new_n49_), .c(new_n68_), .O(z14));
  ...
  aoi21  g74(.a(x08), .b(x06), .c(new_n77_), .O(new_n119_));
