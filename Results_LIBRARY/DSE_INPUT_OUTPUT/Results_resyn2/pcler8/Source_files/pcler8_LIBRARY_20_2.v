...
module FAU ( 
  ...
  nand2  g32(.a(new_n47_), .b(x09), .O(new_n77_));
  inv1   g33(.a(new_n77_), .O(new_n78_));
  oai21  g34(.a(x20), .b(x19), .c(new_n78_), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n76_), .c(new_n53_), .O(z10));
  ...
  oai21  g40(.a(new_n72_), .b(x21), .c(new_n67_), .O(new_n85_));
  ...
  oai21  g44(.a(new_n88_), .b(x22), .c(new_n78_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n87_), .c(new_n57_), .O(z12));
  nand3  g46(.a(x10), .b(x08), .c(x04), .O(new_n91_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n72_), .c(x24), .d(x23), .O(new_n102_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n77_), .c(new_n98_), .O(z14));
  nand3  g62(.a(x10), .b(x08), .c(x06), .O(new_n107_));
  ...
  nand2  g75(.a(new_n119_), .b(new_n78_), .O(new_n120_));
