...
module FAU ( 
  ...
  nand3  g08(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n53_));
  nor3   g09(.a(new_n53_), .b(new_n49_), .c(new_n45_), .O(z00));
  inv1   g10(.a(x00), .O(new_n55_));
  nand2  g11(.a(new_n50_), .b(new_n55_), .O(new_n56_));
  ...
  oai21  g23(.a(new_n67_), .b(new_n66_), .c(new_n56_), .O(z05));
  ...
  aoi21  g33(.a(new_n77_), .b(x09), .c(new_n55_), .O(new_n78_));
  ...
  oai21  g38(.a(new_n82_), .b(new_n75_), .c(new_n81_), .O(new_n83_));
  nand2  g39(.a(x09), .b(new_n67_), .O(new_n84_));
  nor2   g40(.a(x20), .b(x19), .O(new_n85_));
  nor2   g41(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  aoi21  g42(.a(new_n86_), .b(new_n83_), .c(new_n55_), .O(new_n87_));
  oai22  g43(.a(new_n87_), .b(x10), .c(new_n67_), .d(new_n59_), .O(z10));
  ...
  aoi21  g50(.a(new_n80_), .b(new_n94_), .c(new_n84_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n93_), .c(new_n55_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(x10), .c(new_n62_), .O(z11));
  nand2  g53(.a(x08), .b(x03), .O(new_n98_));
  inv1   g54(.a(x14), .O(new_n99_));
  inv1   g55(.a(new_n47_), .O(new_n100_));
  oai21  g56(.a(new_n75_), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  inv1   g57(.a(x22), .O(new_n102_));
  aoi21  g58(.a(new_n89_), .b(new_n102_), .c(new_n84_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n101_), .c(new_n55_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(x10), .c(new_n98_), .O(z12));
  inv1   g61(.a(new_n53_), .O(new_n106_));
  inv1   g62(.a(new_n91_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(x15), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n100_), .c(x23), .O(new_n109_));
  inv1   g65(.a(x23), .O(new_n110_));
  nand2  g66(.a(new_n47_), .b(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(new_n106_), .O(new_n112_));
  oai21  g68(.a(new_n60_), .b(new_n66_), .c(new_n112_), .O(z13));
  nand3  g69(.a(new_n100_), .b(x24), .c(x23), .O(new_n114_));
  inv1   g70(.a(x24), .O(new_n115_));
  oai21  g71(.a(new_n47_), .b(new_n110_), .c(new_n115_), .O(new_n116_));
  aoi22  g72(.a(new_n116_), .b(new_n114_), .c(new_n107_), .d(x16), .O(new_n117_));
  inv1   g73(.a(new_n60_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x05), .O(new_n119_));
  oai21  g75(.a(new_n117_), .b(new_n53_), .c(new_n119_), .O(z14));
  nand3  g76(.a(x26), .b(x25), .c(x17), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  oai21  g79(.a(new_n47_), .b(new_n46_), .c(new_n123_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n49_), .c(new_n122_), .O(new_n125_));
  nand2  g81(.a(new_n118_), .b(x06), .O(new_n126_));
  oai21  g82(.a(new_n125_), .b(new_n53_), .c(new_n126_), .O(z15));
  aoi21  g83(.a(new_n48_), .b(x25), .c(x26), .O(new_n128_));
  inv1   g84(.a(x18), .O(new_n129_));
  inv1   g85(.a(new_n75_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n100_), .c(new_n129_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n106_), .O(new_n132_));
  nand2  g88(.a(new_n118_), .b(x07), .O(new_n133_));
  oai21  g89(.a(new_n132_), .b(new_n128_), .c(new_n133_), .O(z16));
endmodule
