...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(new_n51_), .O(new_n54_));
  oai21  g10(.a(new_n46_), .b(new_n53_), .c(new_n54_), .O(z02));
  nand2  g11(.a(x08), .b(x02), .O(new_n56_));
  nand2  g12(.a(new_n56_), .b(new_n54_), .O(z03));
  nand2  g13(.a(x08), .b(x03), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(new_n54_), .O(z04));
  nand2  g15(.a(x08), .b(x04), .O(new_n60_));
  nand2  g16(.a(new_n60_), .b(new_n54_), .O(z05));
  ...
  nand2  g22(.a(new_n54_), .b(x08), .O(new_n67_));
  nor2   g23(.a(new_n67_), .b(new_n66_), .O(z08));
  ...
  oai21  g28(.a(new_n46_), .b(new_n51_), .c(new_n72_), .O(z09));
  ...
  oai21  g35(.a(new_n67_), .b(new_n53_), .c(new_n79_), .O(z10));
  ...
  oai21  g41(.a(new_n74_), .b(x21), .c(new_n69_), .O(new_n86_));
  ...
  oai21  g46(.a(new_n90_), .b(x22), .c(new_n69_), .O(new_n91_));
  ...
  oai21  g52(.a(new_n96_), .b(new_n94_), .c(new_n69_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n60_), .c(new_n54_), .O(z13));
  ...
  nand3  g70(.a(new_n54_), .b(x08), .c(x06), .O(new_n115_));
  ...
  aoi22  g76(.a(x10), .b(new_n51_), .c(x08), .d(x07), .O(new_n121_));
