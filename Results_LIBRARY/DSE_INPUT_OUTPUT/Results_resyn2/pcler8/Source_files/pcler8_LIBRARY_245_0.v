...
module FAU ( 
  ...
  nor2   g00(.a(x18), .b(x13), .O(new_n45_));
  ...
  nor2   g31(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  ...
  nand2  g39(.a(new_n83_), .b(new_n58_), .O(z09));
  ...
  oai21  g45(.a(x20), .b(x19), .c(new_n74_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n89_), .c(new_n60_), .O(z10));
  nand3  g47(.a(x21), .b(x20), .c(x19), .O(new_n92_));
  inv1   g48(.a(x13), .O(new_n93_));
  nor2   g49(.a(new_n79_), .b(new_n93_), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n86_), .c(new_n92_), .O(new_n95_));
  nand2  g51(.a(new_n85_), .b(new_n78_), .O(new_n96_));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n79_), .c(new_n54_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n64_), .c(new_n45_), .O(z12));
  nand2  g61(.a(new_n51_), .b(x15), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n49_), .O(new_n107_));
  aoi21  g63(.a(new_n48_), .b(new_n47_), .c(new_n54_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n66_), .c(new_n46_), .O(z13));
  inv1   g66(.a(new_n74_), .O(new_n111_));
  oai21  g67(.a(new_n48_), .b(new_n47_), .c(new_n75_), .O(new_n112_));
  inv1   g68(.a(new_n48_), .O(new_n113_));
  nand2  g69(.a(new_n76_), .b(new_n113_), .O(new_n114_));
  aoi22  g70(.a(new_n114_), .b(new_n112_), .c(new_n51_), .d(x16), .O(new_n115_));
  ...
  aoi21  g75(.a(new_n114_), .b(new_n119_), .c(new_n54_), .O(new_n120_));
  oai21  g76(.a(new_n118_), .b(new_n114_), .c(new_n120_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n70_), .c(new_n46_), .O(z15));
  inv1   g78(.a(x18), .O(new_n123_));
  inv1   g79(.a(x26), .O(new_n124_));
  inv1   g80(.a(new_n92_), .O(new_n125_));
  ...
  oai21  g85(.a(new_n126_), .b(new_n92_), .c(x26), .O(new_n130_));
  nor2   g86(.a(x26), .b(new_n119_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n76_), .c(new_n113_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n130_), .c(new_n93_), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n129_), .c(new_n55_), .O(new_n134_));
  nand3  g90(.a(new_n46_), .b(x08), .c(x07), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n134_), .O(z16));
endmodule
