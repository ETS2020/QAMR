...
module FAU ( 
  ...
  nor2   g30(.a(new_n61_), .b(new_n74_), .O(z08));
  ...
  oai21  g35(.a(new_n61_), .b(new_n58_), .c(new_n79_), .O(z09));
  ...
  oai21  g42(.a(new_n61_), .b(new_n60_), .c(new_n86_), .O(z10));
  ...
  oai22  g48(.a(new_n92_), .b(new_n91_), .c(new_n61_), .d(new_n63_), .O(z11));
  ...
  nand2  g68(.a(new_n65_), .b(x05), .O(new_n113_));
  ...
  nand4  g73(.a(new_n110_), .b(new_n117_), .c(new_n81_), .d(x25), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand2  g75(.a(x24), .b(x23), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n49_), .c(new_n119_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n118_), .c(new_n116_), .O(new_n122_));
  nand2  g78(.a(new_n65_), .b(x06), .O(new_n123_));
  oai21  g79(.a(new_n122_), .b(new_n54_), .c(new_n123_), .O(z15));
  nor2   g80(.a(new_n120_), .b(new_n49_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(x25), .c(x26), .O(new_n126_));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(new_n88_), .b(new_n109_), .c(new_n127_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n55_), .O(new_n129_));
  oai22  g85(.a(new_n129_), .b(new_n126_), .c(new_n61_), .d(new_n74_), .O(z16));
endmodule
