...
module FAU ( 
  ...
  oai21  g17(.a(new_n55_), .b(x04), .c(x08), .O(new_n62_));
  ...
  nand2  g38(.a(new_n55_), .b(x09), .O(new_n83_));
  inv1   g39(.a(new_n83_), .O(new_n84_));
  oai21  g40(.a(x20), .b(x19), .c(new_n84_), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n82_), .c(new_n56_), .O(z10));
  oai21  g42(.a(new_n55_), .b(x02), .c(x08), .O(new_n87_));
  ...
  nand2  g51(.a(new_n89_), .b(new_n95_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n84_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n94_), .c(new_n60_), .O(z12));
  ...
  nand3  g71(.a(new_n115_), .b(new_n113_), .c(new_n84_), .O(new_n116_));
