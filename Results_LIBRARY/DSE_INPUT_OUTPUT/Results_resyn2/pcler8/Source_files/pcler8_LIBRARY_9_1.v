...
module FAU ( 
  ...
  nand3  g36(.a(new_n80_), .b(new_n55_), .c(new_n52_), .O(z10));
  ...
  inv1   g42(.a(new_n52_), .O(new_n87_));
  aoi21  g43(.a(x08), .b(x02), .c(new_n87_), .O(new_n88_));
  oai21  g44(.a(new_n86_), .b(new_n85_), .c(new_n88_), .O(z11));
  aoi21  g45(.a(new_n82_), .b(x14), .c(new_n49_), .O(new_n90_));
  inv1   g46(.a(new_n83_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x22), .c(new_n70_), .O(new_n92_));
  oai22  g48(.a(new_n92_), .b(new_n90_), .c(new_n58_), .d(new_n60_), .O(z12));
  ...
  oai21  g54(.a(new_n58_), .b(new_n62_), .c(new_n98_), .O(z13));
  ...
  aoi21  g62(.a(x08), .b(x05), .c(new_n87_), .O(new_n107_));
  ...
  and2   g67(.a(x25), .b(x24), .O(new_n112_));
  nand2  g68(.a(x26), .b(x17), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n110_), .c(new_n112_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n70_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n111_), .c(new_n109_), .O(z15));
  aoi21  g72(.a(new_n110_), .b(new_n112_), .c(x26), .O(new_n117_));
  ...
  aoi21  g76(.a(x08), .b(x07), .c(new_n87_), .O(new_n121_));
