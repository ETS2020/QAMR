...
module FAU ( 
  ...
  oai21  g36(.a(new_n74_), .b(new_n53_), .c(new_n80_), .O(z10));
  ...
  oai22  g47(.a(new_n91_), .b(new_n89_), .c(new_n74_), .d(new_n57_), .O(z12));
  oai21  g48(.a(new_n47_), .b(x04), .c(x08), .O(new_n93_));
  nand4  g49(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(x23), .c(new_n49_), .O(new_n95_));
  inv1   g51(.a(x23), .O(new_n96_));
  nand2  g52(.a(new_n83_), .b(new_n46_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(x22), .c(new_n96_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n95_), .c(new_n69_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n93_), .O(z13));
  ...
  nand3  g63(.a(x10), .b(x08), .c(x05), .O(new_n108_));
  oai21  g64(.a(new_n107_), .b(new_n48_), .c(new_n108_), .O(z14));
  oai21  g65(.a(new_n47_), .b(x06), .c(x08), .O(new_n110_));
  inv1   g66(.a(x25), .O(new_n111_));
  nor2   g67(.a(new_n111_), .b(new_n105_), .O(new_n112_));
  nor2   g68(.a(new_n49_), .b(new_n96_), .O(new_n113_));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n115_));
  nand2  g71(.a(new_n104_), .b(new_n111_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n69_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n110_), .O(z15));
  oai21  g74(.a(new_n47_), .b(x07), .c(x08), .O(new_n119_));
  aoi21  g75(.a(new_n113_), .b(new_n112_), .c(x26), .O(new_n120_));
  nor2   g76(.a(new_n49_), .b(x18), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n69_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(z16));
endmodule
