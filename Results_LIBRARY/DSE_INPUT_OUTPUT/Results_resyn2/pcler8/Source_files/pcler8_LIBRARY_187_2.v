...
module FAU ( 
  ...
  nand3  g40(.a(new_n84_), .b(new_n76_), .c(x12), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  aoi21  g42(.a(new_n82_), .b(new_n81_), .c(new_n55_), .O(new_n87_));
  ...
  oai21  g48(.a(new_n83_), .b(x21), .c(new_n56_), .O(new_n93_));
  ...
  oai21  g53(.a(new_n75_), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  inv1   g54(.a(x22), .O(new_n99_));
  aoi21  g55(.a(new_n90_), .b(new_n99_), .c(new_n55_), .O(new_n100_));
  ...
  nand3  g73(.a(new_n117_), .b(new_n50_), .c(x24), .O(new_n118_));
  nand2  g74(.a(new_n113_), .b(new_n116_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n118_), .c(new_n56_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n71_), .c(new_n47_), .O(z15));
  inv1   g77(.a(x26), .O(new_n122_));
  nand4  g78(.a(new_n97_), .b(x25), .c(x24), .d(x23), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nor2   g80(.a(new_n49_), .b(x18), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n84_), .c(new_n55_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n73_), .c(new_n46_), .O(z16));
endmodule
