...
module FAU ( 
  ...
  aoi21  g07(.a(x11), .b(new_n51_), .c(new_n46_), .O(z01));
  inv1   g08(.a(x01), .O(new_n53_));
  aoi21  g09(.a(x11), .b(new_n53_), .c(new_n46_), .O(z02));
  inv1   g10(.a(x02), .O(new_n55_));
  aoi21  g11(.a(x11), .b(new_n55_), .c(new_n46_), .O(z03));
  inv1   g12(.a(x03), .O(new_n57_));
  aoi21  g13(.a(x11), .b(new_n57_), .c(new_n46_), .O(z04));
  nand3  g14(.a(x11), .b(x08), .c(x04), .O(new_n59_));
  inv1   g15(.a(new_n59_), .O(z05));
  nand3  g16(.a(x11), .b(x08), .c(x05), .O(new_n61_));
  inv1   g17(.a(new_n61_), .O(z06));
  inv1   g18(.a(x06), .O(new_n63_));
  aoi21  g19(.a(x11), .b(new_n63_), .c(new_n46_), .O(z07));
  nand3  g20(.a(x11), .b(x08), .c(x07), .O(new_n65_));
  ...
  nand2  g26(.a(x11), .b(x08), .O(new_n71_));
  ...
  oai22  g40(.a(new_n84_), .b(new_n83_), .c(new_n71_), .d(new_n55_), .O(z11));
  aoi21  g41(.a(new_n80_), .b(x14), .c(new_n49_), .O(new_n86_));
  inv1   g42(.a(new_n81_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(x22), .c(new_n67_), .O(new_n88_));
  oai22  g44(.a(new_n88_), .b(new_n86_), .c(new_n71_), .d(new_n57_), .O(z12));
  inv1   g45(.a(x11), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(x04), .c(x08), .O(new_n91_));
  ...
  nand3  g61(.a(x11), .b(x08), .c(x06), .O(new_n106_));
  ...
  oai21  g70(.a(new_n90_), .b(x07), .c(x08), .O(new_n115_));
