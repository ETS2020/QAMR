...
module FAU ( 
  ...
  nand4  g09(.a(new_n53_), .b(new_n49_), .c(new_n48_), .d(x26), .O(new_n54_));
  nand2  g10(.a(new_n54_), .b(new_n45_), .O(z00));
  nand2  g11(.a(x08), .b(x00), .O(new_n56_));
  nor2   g12(.a(new_n56_), .b(x17), .O(z01));
  ...
  oai21  g27(.a(x17), .b(x08), .c(x00), .O(new_n72_));
  ...
  nand3  g39(.a(new_n83_), .b(new_n53_), .c(new_n45_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n81_), .c(new_n58_), .O(z10));
  ...
  oai21  g47(.a(new_n91_), .b(x21), .c(new_n53_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n90_), .c(new_n86_), .O(z11));
  aoi21  g49(.a(new_n87_), .b(x14), .c(new_n47_), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nand2  g51(.a(new_n88_), .b(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n53_), .c(new_n45_), .O(new_n97_));
  ...
  nand3  g59(.a(new_n103_), .b(new_n102_), .c(new_n53_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n64_), .c(new_n99_), .O(z13));
  ...
  nand3  g69(.a(new_n113_), .b(new_n111_), .c(new_n91_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n52_), .c(new_n106_), .O(z14));
  nand2  g72(.a(x26), .b(x17), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n49_), .c(new_n100_), .d(x23), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  oai21  g75(.a(new_n112_), .b(new_n47_), .c(new_n119_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n53_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n68_), .c(new_n99_), .O(z15));
  inv1   g78(.a(z08), .O(new_n123_));
  aoi21  g79(.a(new_n49_), .b(new_n48_), .c(x26), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n87_), .b(new_n100_), .c(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n53_), .O(new_n127_));
