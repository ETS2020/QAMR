...
module FAU ( 
  ...
  oai21  g19(.a(new_n63_), .b(x05), .c(x08), .O(new_n64_));
  ...
  nand3  g25(.a(new_n63_), .b(x09), .c(new_n45_), .O(new_n70_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n70_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  oai21  g40(.a(new_n77_), .b(new_n55_), .c(new_n84_), .O(z10));
  oai21  g41(.a(new_n63_), .b(x02), .c(x08), .O(new_n86_));
  nand2  g42(.a(new_n63_), .b(x09), .O(new_n87_));
  ...
  aoi22  g46(.a(new_n90_), .b(new_n80_), .c(new_n88_), .d(x21), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n87_), .c(new_n86_), .O(z11));
  inv1   g48(.a(new_n72_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(x14), .c(new_n49_), .O(new_n94_));
  nand3  g50(.a(x21), .b(x20), .c(x19), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(x22), .c(new_n71_), .O(new_n97_));
  oai22  g53(.a(new_n97_), .b(new_n94_), .c(new_n77_), .d(new_n59_), .O(z12));
  oai21  g54(.a(new_n63_), .b(x04), .c(x08), .O(new_n99_));
  nand4  g55(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(x23), .c(new_n49_), .O(new_n101_));
  nand2  g57(.a(new_n95_), .b(new_n45_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(x22), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(x23), .c(new_n101_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n87_), .c(new_n99_), .O(z13));
  ...
  oai21  g68(.a(new_n112_), .b(new_n87_), .c(new_n64_), .O(z14));
  ...
  nand3  g75(.a(x10), .b(x08), .c(x07), .O(new_n120_));
  inv1   g76(.a(x26), .O(new_n121_));
  nand4  g77(.a(new_n108_), .b(x25), .c(x24), .d(x23), .O(new_n122_));
  ...
  nand3  g81(.a(new_n125_), .b(new_n123_), .c(new_n71_), .O(new_n126_));
