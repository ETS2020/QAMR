...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n46_, new_n48_, new_n51_, new_n56_;
  ...
  and2   g10(.a(x08), .b(x06), .O(z07));
  nand2  g11(.a(x08), .b(x07), .O(new_n56_));
  oai21  g12(.a(x10), .b(x08), .c(new_n56_), .O(z08));
  oai21  g13(.a(x10), .b(x08), .c(new_n48_), .O(z10));
  oai21  g14(.a(x10), .b(x08), .c(new_n51_), .O(z12));
  inv1   g15(.a(new_n56_), .O(z16));
