...
module FAU ( 
  ...
  aoi21  g17(.a(x10), .b(new_n61_), .c(new_n46_), .O(z06));
  oai21  g18(.a(new_n47_), .b(x06), .c(x08), .O(new_n63_));
  ...
  nand3  g26(.a(x10), .b(x08), .c(x00), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n70_), .O(z09));
  ...
  nor2   g34(.a(x10), .b(new_n78_), .O(new_n79_));
  ...
  oai21  g47(.a(new_n47_), .b(x04), .c(x08), .O(new_n92_));
  ...
  nand2  g54(.a(new_n98_), .b(new_n92_), .O(z13));
  ...
  nand3  g62(.a(x10), .b(x08), .c(x05), .O(new_n107_));
  oai21  g63(.a(new_n106_), .b(new_n48_), .c(new_n107_), .O(z14));
  nor2   g64(.a(new_n49_), .b(new_n95_), .O(new_n109_));
