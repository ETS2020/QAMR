...
module FAU ( 
  ...
  nand3  g30(.a(new_n74_), .b(new_n56_), .c(new_n55_), .O(z09));
  inv1   g31(.a(z02), .O(new_n76_));
  nand2  g32(.a(x20), .b(x19), .O(new_n77_));
  inv1   g33(.a(x22), .O(new_n78_));
  nor2   g34(.a(new_n71_), .b(new_n78_), .O(new_n79_));
  ...
  oai21  g38(.a(new_n82_), .b(new_n81_), .c(new_n76_), .O(z10));
  ...
  oai21  g44(.a(new_n88_), .b(new_n85_), .c(new_n60_), .O(z11));
  inv1   g45(.a(z04), .O(new_n90_));
  inv1   g46(.a(new_n71_), .O(new_n91_));
  aoi21  g47(.a(new_n91_), .b(x14), .c(new_n45_), .O(new_n92_));
  nand2  g48(.a(new_n84_), .b(new_n78_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n51_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n92_), .c(new_n90_), .O(z12));
  inv1   g51(.a(new_n48_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(x15), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n46_), .c(x23), .O(new_n98_));
  inv1   g54(.a(x23), .O(new_n99_));
  nand2  g55(.a(new_n45_), .b(new_n99_), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n98_), .c(new_n51_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n64_), .c(new_n55_), .O(z13));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  inv1   g60(.a(x24), .O(new_n105_));
  oai21  g61(.a(new_n45_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand3  g62(.a(x22), .b(x21), .c(x20), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nand2  g64(.a(x24), .b(x23), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n108_), .c(x19), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n106_), .c(new_n104_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n52_), .c(new_n66_), .O(z14));
  inv1   g69(.a(new_n52_), .O(new_n114_));
  nor2   g70(.a(new_n109_), .b(new_n45_), .O(new_n115_));
  inv1   g71(.a(x25), .O(new_n116_));
  aoi21  g72(.a(x26), .b(x17), .c(new_n116_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g74(.a(new_n111_), .b(new_n116_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n118_), .c(new_n114_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n68_), .O(z15));
  aoi21  g77(.a(new_n115_), .b(x25), .c(x26), .O(new_n122_));
  inv1   g78(.a(x18), .O(new_n123_));
  nand3  g79(.a(new_n91_), .b(new_n46_), .c(new_n123_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n51_), .O(new_n125_));
  aoi21  g81(.a(x10), .b(new_n54_), .c(z08), .O(new_n126_));
