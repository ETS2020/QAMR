...
module FAU ( 
  ...
  aoi21  g06(.a(new_n47_), .b(x09), .c(new_n50_), .O(z02));
  ...
  aoi21  g12(.a(new_n47_), .b(x09), .c(new_n56_), .O(z05));
  ...
  oai21  g20(.a(x10), .b(new_n45_), .c(new_n50_), .O(z10));
  oai21  g21(.a(x10), .b(new_n45_), .c(new_n52_), .O(z11));
  aoi21  g22(.a(new_n47_), .b(x09), .c(new_n54_), .O(z12));
  oai21  g23(.a(x10), .b(new_n45_), .c(new_n56_), .O(z13));
  aoi21  g24(.a(new_n47_), .b(x09), .c(new_n58_), .O(z14));
  oai21  g25(.a(x10), .b(new_n45_), .c(new_n60_), .O(z15));
  aoi21  g26(.a(new_n47_), .b(x09), .c(new_n62_), .O(z16));
endmodule
