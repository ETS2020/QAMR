...
module FAU ( 
  ...
  oai21  g19(.a(new_n45_), .b(x08), .c(new_n63_), .O(z05));
  nand2  g20(.a(x08), .b(x05), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z06));
  and2   g22(.a(x08), .b(x06), .O(z07));
  and2   g23(.a(x08), .b(x07), .O(z08));
  nand3  g24(.a(new_n45_), .b(x09), .c(new_n55_), .O(new_n69_));
  ...
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n74_), .O(z09));
  ...
  nor2   g35(.a(new_n79_), .b(new_n69_), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  oai21  g37(.a(new_n55_), .b(new_n57_), .c(new_n81_), .O(z10));
  inv1   g38(.a(new_n71_), .O(new_n83_));
  ...
  oai22  g43(.a(new_n87_), .b(new_n86_), .c(new_n55_), .d(new_n59_), .O(z11));
  aoi21  g44(.a(new_n83_), .b(x14), .c(new_n47_), .O(new_n89_));
  inv1   g45(.a(x22), .O(new_n90_));
  nand2  g46(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n70_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n89_), .c(new_n61_), .O(z12));
  inv1   g49(.a(x15), .O(new_n94_));
  nor2   g50(.a(new_n71_), .b(new_n94_), .O(new_n95_));
  xor2a  g51(.a(new_n47_), .b(new_n46_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n95_), .c(new_n70_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n63_), .O(z13));
  nand4  g54(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  inv1   g56(.a(new_n47_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x24), .c(x23), .O(new_n102_));
  oai21  g58(.a(new_n47_), .b(new_n46_), .c(new_n49_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n69_), .c(new_n65_), .O(z14));
  nand2  g61(.a(x09), .b(new_n55_), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand2  g63(.a(x26), .b(x17), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n48_), .c(x25), .d(x24), .O(new_n109_));
  nand2  g65(.a(new_n102_), .b(new_n50_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n109_), .c(new_n107_), .O(new_n111_));
  nor2   g67(.a(new_n45_), .b(x08), .O(new_n112_));
  nor2   g68(.a(z07), .b(new_n112_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n111_), .O(z15));
  inv1   g70(.a(x26), .O(new_n115_));
  nand4  g71(.a(new_n101_), .b(x25), .c(x24), .d(x23), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nor2   g73(.a(new_n47_), .b(x18), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n83_), .c(new_n106_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nor2   g76(.a(z08), .b(new_n112_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n120_), .O(z16));
endmodule
