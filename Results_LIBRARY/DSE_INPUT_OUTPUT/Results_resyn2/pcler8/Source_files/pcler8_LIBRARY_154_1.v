...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_,
    new_n53_, new_n54_, new_n56_, new_n58_, new_n60_, new_n63_, new_n65_,
  ...
  nor2   g14(.a(new_n52_), .b(new_n58_), .O(z03));
  ...
  nand3  g29(.a(new_n73_), .b(new_n54_), .c(new_n53_), .O(z09));
  ...
  nand3  g35(.a(new_n45_), .b(x09), .c(new_n52_), .O(new_n80_));
  ...
  nand3  g64(.a(new_n108_), .b(new_n76_), .c(new_n75_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n107_), .c(new_n105_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n68_), .c(new_n103_), .O(z14));
  nand3  g67(.a(x26), .b(x25), .c(x17), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(new_n113_));
  nand4  g69(.a(new_n108_), .b(new_n76_), .c(new_n75_), .d(x25), .O(new_n114_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n80_), .c(new_n65_), .O(z15));
  nor2   g75(.a(new_n116_), .b(new_n47_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(x25), .c(x26), .O(new_n121_));
  inv1   g77(.a(x18), .O(new_n122_));
  nand2  g78(.a(new_n49_), .b(new_n122_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n109_), .c(new_n69_), .O(new_n124_));
  nor2   g80(.a(z08), .b(new_n100_), .O(new_n125_));
