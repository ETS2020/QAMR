...
module FAU ( 
  ...
  oai21  g19(.a(new_n53_), .b(new_n63_), .c(new_n47_), .O(z03));
  and2   g20(.a(x08), .b(x03), .O(z04));
  inv1   g21(.a(x04), .O(new_n66_));
  nor2   g22(.a(new_n59_), .b(new_n66_), .O(z05));
  nor2   g23(.a(new_n46_), .b(new_n53_), .O(new_n68_));
  ...
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n78_), .O(z09));
  ...
  nor2   g41(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  ...
  oai21  g48(.a(new_n80_), .b(x21), .c(new_n55_), .O(new_n93_));
  ...
  aoi21  g52(.a(new_n82_), .b(x14), .c(new_n96_), .O(new_n97_));
  oai21  g53(.a(new_n95_), .b(x22), .c(new_n55_), .O(new_n98_));
  nor2   g54(.a(z04), .b(new_n46_), .O(new_n99_));
  oai21  g55(.a(new_n98_), .b(new_n97_), .c(new_n99_), .O(z12));
  nand2  g56(.a(new_n52_), .b(x15), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n50_), .O(new_n102_));
  aoi21  g58(.a(new_n49_), .b(new_n48_), .c(new_n54_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  aoi21  g60(.a(x08), .b(x04), .c(new_n46_), .O(new_n105_));
  ...
  oai21  g70(.a(new_n114_), .b(new_n54_), .c(new_n69_), .O(z14));
  ...
  oai21  g78(.a(new_n122_), .b(new_n54_), .c(new_n71_), .O(z15));
  nor2   g79(.a(new_n120_), .b(new_n49_), .O(new_n124_));
  ...
  oai22  g84(.a(new_n128_), .b(new_n125_), .c(new_n59_), .d(new_n73_), .O(z16));
endmodule
