...
module FAU ( 
  ...
  nor2   g20(.a(x21), .b(x10), .O(new_n65_));
  inv1   g21(.a(x09), .O(new_n66_));
  nor2   g22(.a(new_n66_), .b(x08), .O(new_n67_));
  nand3  g23(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  oai21  g24(.a(new_n48_), .b(z00), .c(new_n68_), .O(z09));
  inv1   g25(.a(x10), .O(new_n70_));
  nor2   g26(.a(x20), .b(x19), .O(new_n71_));
  inv1   g27(.a(x08), .O(new_n72_));
  nand2  g28(.a(x20), .b(x19), .O(new_n73_));
  nand3  g29(.a(new_n73_), .b(x09), .c(new_n72_), .O(new_n74_));
  oai21  g30(.a(new_n74_), .b(new_n71_), .c(new_n45_), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n70_), .O(new_n76_));
  nand2  g32(.a(new_n76_), .b(new_n50_), .O(z10));
  nand2  g33(.a(x09), .b(new_n72_), .O(new_n78_));
  oai21  g34(.a(new_n73_), .b(new_n78_), .c(new_n45_), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n70_), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n52_), .O(z11));
  aoi21  g37(.a(new_n67_), .b(x22), .c(x21), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(x10), .c(new_n54_), .O(z12));
  nand3  g39(.a(new_n67_), .b(new_n65_), .c(x23), .O(new_n84_));
  oai21  g40(.a(new_n56_), .b(z00), .c(new_n84_), .O(z13));
  nand3  g41(.a(new_n67_), .b(new_n65_), .c(x24), .O(new_n86_));
  oai21  g42(.a(new_n58_), .b(z00), .c(new_n86_), .O(z14));
  aoi21  g43(.a(new_n67_), .b(x25), .c(x21), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(x10), .c(new_n60_), .O(z15));
  nand3  g45(.a(new_n67_), .b(new_n65_), .c(x26), .O(new_n90_));
  oai21  g46(.a(new_n62_), .b(z00), .c(new_n90_), .O(z16));
endmodule
