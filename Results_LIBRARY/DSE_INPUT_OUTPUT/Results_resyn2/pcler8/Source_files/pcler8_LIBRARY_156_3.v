...
module FAU ( 
  ...
  oai21  g15(.a(new_n51_), .b(new_n59_), .c(new_n45_), .O(z02));
  ...
  nand2  g21(.a(new_n65_), .b(new_n45_), .O(z04));
  ...
  inv1   g30(.a(new_n62_), .O(new_n75_));
  ...
  oai21  g35(.a(new_n75_), .b(new_n57_), .c(new_n79_), .O(z09));
  ...
  oai21  g42(.a(new_n75_), .b(new_n59_), .c(new_n86_), .O(z10));
  ...
  oai21  g47(.a(new_n81_), .b(x21), .c(new_n54_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(new_n63_), .O(z11));
  ...
  nand2  g53(.a(new_n62_), .b(x03), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(z12));
  nand2  g55(.a(new_n50_), .b(x15), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  aoi21  g57(.a(new_n47_), .b(new_n46_), .c(new_n53_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  aoi21  g59(.a(x08), .b(x04), .c(new_n61_), .O(new_n104_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n53_), .c(new_n71_), .O(z15));
  ...
  nand2  g84(.a(new_n128_), .b(new_n54_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n126_), .c(new_n73_), .O(z16));
endmodule
