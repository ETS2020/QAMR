...
module FAU ( 
  ...
  nand2  g19(.a(new_n63_), .b(new_n45_), .O(z04));
  ...
  nand3  g36(.a(new_n80_), .b(new_n56_), .c(new_n45_), .O(z09));
  ...
  nand3  g44(.a(new_n88_), .b(new_n59_), .c(new_n45_), .O(z10));
  ...
  and2   g49(.a(new_n61_), .b(new_n45_), .O(new_n94_));
  oai21  g50(.a(new_n93_), .b(new_n92_), .c(new_n94_), .O(z11));
  inv1   g51(.a(x14), .O(new_n96_));
  oai21  g52(.a(new_n76_), .b(new_n96_), .c(new_n53_), .O(new_n97_));
  inv1   g53(.a(x22), .O(new_n98_));
  aoi21  g54(.a(new_n90_), .b(new_n98_), .c(new_n49_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n63_), .c(new_n58_), .O(z12));
  ...
  nand2  g64(.a(new_n108_), .b(new_n66_), .O(z13));
  nand2  g65(.a(new_n53_), .b(new_n51_), .O(new_n110_));
  inv1   g66(.a(x24), .O(new_n111_));
  oai21  g67(.a(new_n52_), .b(new_n106_), .c(new_n111_), .O(new_n112_));
  aoi22  g68(.a(new_n112_), .b(new_n110_), .c(new_n103_), .d(x16), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n49_), .c(new_n69_), .O(z14));
  nand4  g70(.a(new_n77_), .b(new_n82_), .c(new_n51_), .d(x25), .O(new_n115_));
  inv1   g71(.a(x25), .O(new_n116_));
  nand2  g72(.a(new_n110_), .b(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n115_), .c(new_n75_), .O(new_n118_));
  oai21  g74(.a(new_n50_), .b(x11), .c(x17), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n118_), .c(new_n71_), .O(z15));
  inv1   g76(.a(x26), .O(new_n121_));
  nand2  g77(.a(new_n115_), .b(new_n121_), .O(new_n122_));
  inv1   g78(.a(x18), .O(new_n123_));
  nand3  g79(.a(new_n83_), .b(new_n53_), .c(new_n123_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n75_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n73_), .c(new_n58_), .O(z16));
endmodule
