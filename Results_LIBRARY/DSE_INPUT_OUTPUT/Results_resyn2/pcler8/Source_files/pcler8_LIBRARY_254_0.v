...
module FAU ( 
  ...
  nand2  g31(.a(new_n75_), .b(x23), .O(new_n76_));
  ...
  nor2   g35(.a(z01), .b(new_n45_), .O(new_n80_));
  ...
  aoi21  g40(.a(new_n77_), .b(x12), .c(new_n84_), .O(new_n85_));
  aoi21  g41(.a(new_n82_), .b(new_n73_), .c(new_n45_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n50_), .O(new_n87_));
  ...
  aoi21  g50(.a(new_n89_), .b(x14), .c(new_n52_), .O(new_n95_));
  inv1   g51(.a(x22), .O(new_n96_));
  nand2  g52(.a(new_n90_), .b(new_n96_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n50_), .c(new_n46_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n95_), .c(new_n63_), .O(z12));
  ...
  oai21  g59(.a(new_n103_), .b(new_n101_), .c(new_n50_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n65_), .c(new_n45_), .O(z13));
  nor2   g61(.a(new_n52_), .b(new_n102_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(x24), .O(new_n107_));
  inv1   g63(.a(x24), .O(new_n108_));
  nand2  g64(.a(new_n54_), .b(new_n108_), .O(new_n109_));
  aoi22  g65(.a(new_n109_), .b(new_n107_), .c(new_n75_), .d(x16), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n49_), .c(new_n67_), .O(z14));
  aoi21  g67(.a(new_n106_), .b(x24), .c(x25), .O(new_n112_));
  nand4  g68(.a(new_n53_), .b(x25), .c(x24), .d(x23), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n50_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n112_), .c(new_n69_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n46_), .O(new_n116_));
  nand4  g72(.a(new_n50_), .b(x26), .c(x25), .d(x17), .O(new_n117_));
  ...
  nand2  g77(.a(new_n55_), .b(new_n121_), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n120_), .c(new_n50_), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(new_n71_), .c(new_n46_), .O(z16));
endmodule
