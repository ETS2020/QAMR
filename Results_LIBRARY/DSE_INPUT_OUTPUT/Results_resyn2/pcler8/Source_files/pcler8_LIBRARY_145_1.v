...
module FAU ( 
  ...
  nand2  g01(.a(x07), .b(new_n45_), .O(new_n46_));
  ...
  nor2   g21(.a(new_n65_), .b(new_n62_), .O(z05));
  nor2   g22(.a(new_n47_), .b(new_n45_), .O(z06));
  nand2  g23(.a(x08), .b(x06), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n62_), .O(z07));
  inv1   g25(.a(x07), .O(new_n70_));
  aoi21  g26(.a(new_n47_), .b(x05), .c(new_n70_), .O(z08));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n87_), .c(new_n49_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  aoi21  g46(.a(new_n90_), .b(new_n60_), .c(new_n62_), .O(z11));
  inv1   g47(.a(new_n51_), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(x14), .c(new_n52_), .O(new_n93_));
  oai21  g49(.a(new_n84_), .b(x22), .c(new_n50_), .O(new_n94_));
  and2   g50(.a(new_n63_), .b(new_n46_), .O(new_n95_));
  oai21  g51(.a(new_n94_), .b(new_n93_), .c(new_n95_), .O(z12));
  ...
  nand3  g79(.a(new_n123_), .b(new_n50_), .c(new_n46_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(z16));
endmodule
