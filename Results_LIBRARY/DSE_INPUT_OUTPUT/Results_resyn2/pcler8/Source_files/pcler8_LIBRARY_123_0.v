...
module FAU ( 
  ...
  aoi21  g42(.a(new_n47_), .b(new_n86_), .c(new_n53_), .O(new_n87_));
  oai21  g43(.a(new_n85_), .b(new_n83_), .c(new_n87_), .O(new_n88_));
  aoi21  g44(.a(new_n88_), .b(new_n61_), .c(new_n45_), .O(z11));
  nand4  g45(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(new_n91_));
  nand2  g47(.a(x23), .b(x14), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n49_), .c(new_n91_), .O(new_n93_));
  inv1   g49(.a(x22), .O(new_n94_));
  aoi21  g50(.a(new_n83_), .b(new_n94_), .c(new_n53_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n63_), .c(new_n45_), .O(z12));
  inv1   g53(.a(new_n49_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x15), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n91_), .c(x23), .O(new_n100_));
  inv1   g56(.a(x23), .O(new_n101_));
  aoi21  g57(.a(new_n90_), .b(new_n101_), .c(new_n53_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n65_), .c(new_n45_), .O(z13));
  inv1   g60(.a(new_n50_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n48_), .c(x24), .O(new_n106_));
  inv1   g62(.a(x24), .O(new_n107_));
  oai21  g63(.a(new_n50_), .b(new_n47_), .c(new_n107_), .O(new_n108_));
  aoi22  g64(.a(new_n108_), .b(new_n106_), .c(new_n98_), .d(x16), .O(new_n109_));
  aoi21  g65(.a(x08), .b(x05), .c(new_n45_), .O(new_n110_));
  oai21  g66(.a(new_n109_), .b(new_n53_), .c(new_n110_), .O(z14));
  nor2   g67(.a(new_n50_), .b(new_n47_), .O(new_n112_));
  ...
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n79_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n69_), .c(new_n45_), .O(z15));
  ...
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n79_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n71_), .c(new_n46_), .O(z16));
endmodule
