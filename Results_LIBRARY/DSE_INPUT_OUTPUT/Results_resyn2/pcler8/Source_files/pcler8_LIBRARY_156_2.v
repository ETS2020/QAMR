...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(new_n45_), .O(new_n46_));
  ...
  nand3  g09(.a(new_n45_), .b(x09), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g14(.a(new_n53_), .b(new_n58_), .c(new_n47_), .O(z01));
  inv1   g15(.a(x01), .O(new_n60_));
  oai21  g16(.a(new_n53_), .b(new_n60_), .c(new_n47_), .O(z02));
  ...
  nor2   g26(.a(new_n46_), .b(new_n53_), .O(new_n71_));
  ...
  oai21  g35(.a(new_n63_), .b(new_n58_), .c(new_n79_), .O(z09));
  ...
  oai21  g42(.a(new_n63_), .b(new_n60_), .c(new_n86_), .O(z10));
  ...
  oai22  g48(.a(new_n92_), .b(new_n91_), .c(new_n63_), .d(new_n62_), .O(z11));
  ...
  nand2  g53(.a(new_n71_), .b(x03), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(z12));
  nand2  g55(.a(new_n52_), .b(x15), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n50_), .O(new_n101_));
  aoi21  g57(.a(new_n49_), .b(new_n48_), .c(new_n54_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  aoi21  g59(.a(x08), .b(x04), .c(new_n46_), .O(new_n104_));
  ...
  nand2  g69(.a(new_n71_), .b(x05), .O(new_n114_));
  oai21  g70(.a(new_n113_), .b(new_n54_), .c(new_n114_), .O(z14));
  nand3  g71(.a(x26), .b(x25), .c(x17), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(new_n117_));
  and2   g73(.a(x22), .b(x21), .O(new_n118_));
  nand4  g74(.a(new_n111_), .b(new_n118_), .c(new_n81_), .d(x25), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand2  g76(.a(x24), .b(x23), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n49_), .c(new_n120_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n119_), .c(new_n117_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n54_), .c(new_n72_), .O(z15));
  nor2   g80(.a(new_n121_), .b(new_n49_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(x25), .c(x26), .O(new_n126_));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(new_n88_), .b(new_n110_), .c(new_n127_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n55_), .O(new_n129_));
  oai22  g85(.a(new_n129_), .b(new_n126_), .c(new_n63_), .d(new_n74_), .O(z16));
endmodule
