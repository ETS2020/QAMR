...
module FAU ( 
  ...
  nand2  g17(.a(new_n62_), .b(new_n49_), .O(z07));
  ...
  nand3  g23(.a(new_n68_), .b(new_n66_), .c(new_n48_), .O(new_n69_));
  oai22  g24(.a(new_n69_), .b(x19), .c(new_n52_), .d(new_n46_), .O(z09));
  nand2  g25(.a(x08), .b(x01), .O(new_n71_));
  nor2   g26(.a(x20), .b(x19), .O(new_n72_));
  nand2  g27(.a(x20), .b(x19), .O(new_n73_));
  nand3  g28(.a(new_n73_), .b(x09), .c(new_n47_), .O(new_n74_));
  oai21  g29(.a(new_n74_), .b(new_n72_), .c(new_n66_), .O(new_n75_));
  nand2  g30(.a(new_n75_), .b(new_n48_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n71_), .O(z10));
  aoi21  g32(.a(x20), .b(x19), .c(x21), .O(new_n78_));
  nand3  g33(.a(x21), .b(x20), .c(x19), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n68_), .c(new_n66_), .d(new_n48_), .O(new_n80_));
  oai22  g35(.a(new_n80_), .b(new_n78_), .c(new_n52_), .d(new_n54_), .O(z11));
  inv1   g36(.a(new_n79_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n68_), .c(x22), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(x10), .c(new_n56_), .O(z12));
  inv1   g39(.a(x23), .O(new_n85_));
  oai22  g40(.a(new_n69_), .b(new_n85_), .c(new_n52_), .d(new_n58_), .O(z13));
  nand2  g41(.a(x08), .b(x05), .O(new_n87_));
  aoi21  g42(.a(new_n68_), .b(x24), .c(x22), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(x10), .c(new_n87_), .O(z14));
  aoi21  g44(.a(new_n68_), .b(x25), .c(x22), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x10), .c(new_n62_), .O(z15));
  inv1   g46(.a(x26), .O(new_n92_));
  oai22  g47(.a(new_n69_), .b(new_n92_), .c(new_n52_), .d(new_n64_), .O(z16));
  zero   g48(.O(z00));
endmodule
