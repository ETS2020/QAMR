...
module FAU ( 
  ...
  oai21  g17(.a(new_n47_), .b(new_n61_), .c(new_n46_), .O(z03));
  inv1   g18(.a(x03), .O(new_n63_));
  oai21  g19(.a(new_n47_), .b(new_n63_), .c(new_n46_), .O(z04));
  ...
  oai21  g31(.a(new_n57_), .b(new_n56_), .c(new_n75_), .O(z09));
  ...
  oai21  g38(.a(new_n57_), .b(new_n59_), .c(new_n82_), .O(z10));
  ...
  oai22  g44(.a(new_n88_), .b(new_n87_), .c(new_n57_), .d(new_n61_), .O(z11));
  aoi21  g45(.a(new_n84_), .b(x14), .c(new_n52_), .O(new_n90_));
  inv1   g46(.a(new_n85_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x22), .c(new_n50_), .O(new_n92_));
  oai22  g48(.a(new_n92_), .b(new_n90_), .c(new_n57_), .d(new_n63_), .O(z12));
  inv1   g49(.a(x15), .O(new_n94_));
  nor2   g50(.a(new_n51_), .b(new_n94_), .O(new_n95_));
  inv1   g51(.a(x23), .O(new_n96_));
  xor2a  g52(.a(new_n52_), .b(new_n96_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(new_n50_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n65_), .c(new_n46_), .O(z13));
  ...
  oai21  g61(.a(new_n52_), .b(new_n96_), .c(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n49_), .c(new_n100_), .O(z14));
  inv1   g64(.a(z07), .O(new_n109_));
  nor2   g65(.a(new_n52_), .b(new_n96_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(x24), .c(x25), .O(new_n111_));
  and2   g67(.a(x26), .b(x17), .O(new_n112_));
  and2   g68(.a(x25), .b(x24), .O(new_n113_));
  nand4  g69(.a(new_n103_), .b(new_n77_), .c(new_n113_), .d(x23), .O(new_n114_));
  ...
  nand3  g77(.a(new_n121_), .b(new_n71_), .c(new_n46_), .O(z16));
endmodule
