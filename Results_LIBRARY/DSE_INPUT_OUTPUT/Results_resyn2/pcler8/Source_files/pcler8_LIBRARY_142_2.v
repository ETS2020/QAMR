...
module FAU ( 
  ...
  nand2  g38(.a(new_n69_), .b(x09), .O(new_n83_));
  ...
  nand2  g42(.a(x10), .b(x08), .O(new_n87_));
  ...
  oai21  g47(.a(new_n88_), .b(x21), .c(new_n71_), .O(new_n92_));
  oai22  g48(.a(new_n92_), .b(new_n91_), .c(new_n87_), .d(new_n57_), .O(z11));
  oai21  g49(.a(new_n69_), .b(x03), .c(x08), .O(new_n94_));
  ...
  oai21  g59(.a(new_n87_), .b(new_n61_), .c(new_n103_), .O(z13));
  oai21  g60(.a(new_n69_), .b(x05), .c(x08), .O(new_n105_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n83_), .c(new_n105_), .O(z14));
  nand3  g69(.a(x10), .b(x08), .c(x06), .O(new_n114_));
  ...
  nand2  g75(.a(new_n119_), .b(new_n114_), .O(z15));
  oai21  g76(.a(new_n69_), .b(x07), .c(x08), .O(new_n121_));
  inv1   g77(.a(x26), .O(new_n122_));
  nand4  g78(.a(new_n108_), .b(x25), .c(x24), .d(x23), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n50_), .b(new_n47_), .c(new_n125_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n84_), .O(new_n127_));
