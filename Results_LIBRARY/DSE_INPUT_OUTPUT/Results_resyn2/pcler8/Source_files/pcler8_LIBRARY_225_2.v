...
module FAU ( 
  ...
  nand2  g11(.a(new_n56_), .b(new_n53_), .O(z04));
  nand2  g12(.a(x08), .b(x04), .O(new_n58_));
  nand2  g13(.a(new_n58_), .b(new_n53_), .O(z05));
  nand2  g14(.a(x08), .b(x05), .O(new_n60_));
  nand2  g15(.a(new_n60_), .b(new_n53_), .O(z06));
  nand2  g16(.a(x08), .b(x06), .O(new_n62_));
  nand2  g17(.a(new_n62_), .b(new_n53_), .O(z07));
  inv1   g18(.a(x07), .O(new_n64_));
  nor2   g19(.a(new_n48_), .b(new_n64_), .O(z08));
  nor2   g20(.a(x10), .b(new_n47_), .O(new_n66_));
  nor2   g21(.a(new_n54_), .b(new_n66_), .O(z11));
  nor2   g22(.a(new_n60_), .b(new_n66_), .O(z14));
  zero   g23(.O(z00));
  nor2   g24(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g25(.a(new_n48_), .b(new_n50_), .O(z10));
  nand2  g26(.a(new_n56_), .b(new_n53_), .O(z12));
  nand2  g27(.a(new_n58_), .b(new_n53_), .O(z13));
  nand2  g28(.a(new_n62_), .b(new_n53_), .O(z15));
