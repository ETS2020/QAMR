...
module FAU ( 
  ...
  nand3  g54(.a(new_n52_), .b(x26), .c(x15), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n49_), .O(new_n100_));
  aoi21  g56(.a(new_n48_), .b(new_n47_), .c(new_n55_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n67_), .c(new_n46_), .O(z13));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  and2   g61(.a(x22), .b(x21), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n80_), .c(x24), .d(x23), .O(new_n107_));
  oai21  g63(.a(new_n48_), .b(new_n47_), .c(new_n50_), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n107_), .c(new_n105_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n55_), .c(new_n69_), .O(z14));
  aoi21  g66(.a(x26), .b(x17), .c(new_n51_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n49_), .c(x24), .O(new_n112_));
  nand2  g68(.a(new_n107_), .b(new_n51_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n56_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n71_), .c(new_n46_), .O(z15));
  aoi21  g71(.a(new_n52_), .b(new_n49_), .c(x26), .O(new_n116_));
  inv1   g72(.a(x18), .O(new_n117_));
  inv1   g73(.a(new_n48_), .O(new_n118_));
  nand3  g74(.a(new_n87_), .b(new_n118_), .c(new_n117_), .O(new_n119_));
  inv1   g75(.a(x07), .O(new_n120_));
  inv1   g76(.a(x16), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(x08), .c(new_n120_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n119_), .c(new_n54_), .d(x09), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n116_), .c(new_n73_), .O(z16));
endmodule
