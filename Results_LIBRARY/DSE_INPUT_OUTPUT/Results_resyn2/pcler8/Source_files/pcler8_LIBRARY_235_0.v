...
module FAU ( 
  ...
  nand2  g08(.a(x08), .b(x05), .O(new_n53_));
  oai21  g09(.a(x10), .b(x08), .c(new_n53_), .O(z06));
  ...
  oai21  g14(.a(x10), .b(x08), .c(new_n50_), .O(z12));
  inv1   g15(.a(new_n53_), .O(z14));
  inv1   g16(.a(new_n57_), .O(z16));
  and2   g17(.a(x08), .b(x00), .O(z09));
  oai21  g18(.a(x10), .b(x08), .c(new_n47_), .O(z10));
  and2   g19(.a(x08), .b(x02), .O(z11));
  and2   g20(.a(x08), .b(x04), .O(z13));
  oai21  g21(.a(x10), .b(x08), .c(new_n55_), .O(z15));
endmodule
