...
module FAU ( 
  ...
  oai21  g13(.a(new_n57_), .b(x02), .c(x08), .O(new_n58_));
  ...
  oai21  g23(.a(new_n57_), .b(x07), .c(x08), .O(new_n68_));
  inv1   g24(.a(new_n68_), .O(z08));
  nand3  g25(.a(new_n57_), .b(x09), .c(new_n45_), .O(new_n70_));
  ...
  nand2  g31(.a(x10), .b(x08), .O(new_n76_));
  oai21  g32(.a(new_n76_), .b(new_n53_), .c(new_n75_), .O(z09));
  ...
  oai22  g39(.a(new_n83_), .b(new_n82_), .c(new_n76_), .d(new_n55_), .O(z10));
  nand2  g40(.a(new_n57_), .b(x09), .O(new_n85_));
  inv1   g41(.a(new_n78_), .O(new_n86_));
  oai21  g42(.a(x20), .b(x08), .c(x19), .O(new_n87_));
  nand3  g43(.a(x23), .b(x22), .c(x13), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n46_), .c(x21), .O(new_n89_));
  aoi22  g45(.a(new_n89_), .b(new_n86_), .c(new_n87_), .d(x21), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n85_), .c(new_n58_), .O(z11));
  oai21  g47(.a(new_n57_), .b(x03), .c(x08), .O(new_n92_));
  aoi21  g48(.a(new_n79_), .b(x14), .c(new_n49_), .O(new_n93_));
  inv1   g49(.a(new_n85_), .O(new_n94_));
  inv1   g50(.a(x21), .O(new_n95_));
  inv1   g51(.a(x22), .O(new_n96_));
  oai21  g52(.a(new_n78_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n93_), .c(new_n92_), .O(z12));
  oai21  g55(.a(new_n57_), .b(x04), .c(x08), .O(new_n100_));
  inv1   g56(.a(x15), .O(new_n101_));
  nor2   g57(.a(new_n72_), .b(new_n101_), .O(new_n102_));
  xor2a  g58(.a(new_n49_), .b(new_n48_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n102_), .c(new_n94_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n100_), .O(z13));
  oai21  g61(.a(new_n57_), .b(x05), .c(x08), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  inv1   g64(.a(new_n49_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x24), .c(x23), .O(new_n110_));
  ...
  oai21  g69(.a(new_n113_), .b(new_n85_), .c(new_n106_), .O(z14));
  nand2  g70(.a(x26), .b(x17), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n50_), .c(x25), .d(x24), .O(new_n116_));
  ...
  nand2  g75(.a(new_n119_), .b(new_n66_), .O(z15));
  inv1   g76(.a(x26), .O(new_n121_));
  nand4  g77(.a(new_n109_), .b(x25), .c(x24), .d(x23), .O(new_n122_));
  ...
  nand3  g81(.a(new_n125_), .b(new_n123_), .c(new_n94_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n68_), .O(z16));
endmodule
