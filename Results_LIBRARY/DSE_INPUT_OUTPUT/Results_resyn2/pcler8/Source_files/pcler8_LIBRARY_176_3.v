...
module FAU ( 
  ...
  inv1   g49(.a(new_n52_), .O(new_n94_));
  oai21  g50(.a(new_n51_), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  inv1   g51(.a(x22), .O(new_n96_));
  aoi21  g52(.a(new_n87_), .b(new_n96_), .c(new_n81_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n62_), .c(x10), .O(z12));
  inv1   g55(.a(x23), .O(new_n100_));
  xor2a  g56(.a(new_n52_), .b(new_n100_), .O(new_n101_));
  aoi21  g57(.a(new_n86_), .b(x15), .c(new_n101_), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n49_), .c(new_n64_), .O(z13));
  nand3  g59(.a(x26), .b(x25), .c(x24), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  nand4  g61(.a(new_n72_), .b(new_n78_), .c(x24), .d(x23), .O(new_n106_));
  inv1   g62(.a(x24), .O(new_n107_));
  oai21  g63(.a(new_n52_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  aoi22  g64(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(x16), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n49_), .c(new_n66_), .O(z14));
  nand2  g66(.a(x08), .b(x06), .O(new_n111_));
  inv1   g67(.a(x25), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(new_n107_), .O(new_n113_));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n94_), .c(new_n113_), .d(x23), .O(new_n115_));
  nand2  g71(.a(new_n106_), .b(new_n112_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n48_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n111_), .c(x10), .O(z15));
  nand2  g74(.a(x08), .b(x07), .O(new_n119_));
  inv1   g75(.a(x26), .O(new_n120_));
  nand3  g76(.a(new_n94_), .b(new_n113_), .c(x23), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  inv1   g78(.a(x18), .O(new_n123_));
  aoi21  g79(.a(new_n53_), .b(new_n123_), .c(new_n81_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n119_), .c(x10), .O(z16));
endmodule
