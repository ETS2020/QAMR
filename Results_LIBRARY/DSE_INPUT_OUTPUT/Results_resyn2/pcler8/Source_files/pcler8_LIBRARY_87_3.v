...
module FAU ( 
  ...
  and2   g34(.a(new_n57_), .b(new_n45_), .O(new_n79_));
  oai21  g35(.a(new_n78_), .b(new_n49_), .c(new_n79_), .O(z09));
  ...
  nand3  g41(.a(new_n85_), .b(new_n83_), .c(new_n45_), .O(new_n86_));
  ...
  oai21  g46(.a(new_n90_), .b(new_n75_), .c(new_n89_), .O(new_n91_));
  inv1   g47(.a(x21), .O(new_n92_));
  aoi21  g48(.a(new_n81_), .b(new_n92_), .c(new_n49_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n61_), .c(new_n56_), .O(z11));
  inv1   g51(.a(new_n75_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(x14), .c(new_n52_), .O(new_n97_));
  oai21  g53(.a(new_n89_), .b(x22), .c(new_n83_), .O(new_n98_));
  ...
  oai21  g59(.a(new_n103_), .b(new_n102_), .c(new_n83_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n65_), .c(new_n45_), .O(z13));
  aoi21  g61(.a(new_n53_), .b(x24), .c(new_n49_), .O(new_n106_));
  oai21  g62(.a(new_n53_), .b(x24), .c(new_n106_), .O(new_n107_));
  oai21  g63(.a(new_n50_), .b(x17), .c(x16), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n107_), .c(new_n67_), .O(z14));
  aoi21  g65(.a(new_n53_), .b(x24), .c(x25), .O(new_n110_));
  inv1   g66(.a(new_n52_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(x25), .c(x24), .d(x23), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n83_), .c(new_n45_), .O(new_n113_));
  inv1   g69(.a(x16), .O(new_n114_));
  nand4  g70(.a(x26), .b(x25), .c(x17), .d(new_n114_), .O(new_n115_));
  inv1   g71(.a(new_n115_), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(new_n83_), .c(z07), .O(new_n117_));
  oai21  g73(.a(new_n113_), .b(new_n110_), .c(new_n117_), .O(z15));
  inv1   g74(.a(x26), .O(new_n119_));
  nand2  g75(.a(new_n112_), .b(new_n119_), .O(new_n120_));
  nor2   g76(.a(new_n52_), .b(x18), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n96_), .c(new_n49_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n71_), .c(new_n56_), .O(z16));
endmodule
