...
module FAU ( 
  ...
  aoi21  g18(.a(x16), .b(x07), .c(new_n62_), .O(z04));
  ...
  aoi21  g27(.a(new_n71_), .b(new_n47_), .c(new_n70_), .O(z08));
  ...
  nand3  g33(.a(new_n77_), .b(new_n56_), .c(new_n45_), .O(z09));
  ...
  nand3  g42(.a(new_n86_), .b(new_n58_), .c(new_n45_), .O(z10));
  ...
  oai21  g56(.a(new_n46_), .b(new_n100_), .c(new_n53_), .O(new_n101_));
  aoi21  g57(.a(new_n52_), .b(new_n51_), .c(new_n49_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n64_), .c(new_n45_), .O(z13));
  oai21  g60(.a(new_n50_), .b(x07), .c(x16), .O(new_n105_));
  inv1   g61(.a(x24), .O(new_n106_));
  oai21  g62(.a(new_n52_), .b(new_n51_), .c(new_n106_), .O(new_n107_));
  nand2  g63(.a(x24), .b(x23), .O(new_n108_));
  nor2   g64(.a(new_n108_), .b(new_n52_), .O(new_n109_));
  nor2   g65(.a(new_n109_), .b(new_n49_), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n105_), .c(new_n66_), .O(z14));
  ...
  oai21  g74(.a(new_n108_), .b(new_n52_), .c(new_n118_), .O(new_n119_));
  ...
  nor2   g78(.a(new_n52_), .b(x18), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n81_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n73_), .c(new_n45_), .O(new_n125_));
  nand3  g81(.a(new_n71_), .b(x08), .c(x07), .O(new_n126_));
