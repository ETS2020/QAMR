...
module FAU ( 
  ...
  nor2   g18(.a(new_n62_), .b(new_n59_), .O(z03));
  ...
  nand3  g35(.a(new_n79_), .b(new_n57_), .c(new_n46_), .O(z09));
  and2   g36(.a(x20), .b(x19), .O(new_n81_));
  inv1   g37(.a(new_n75_), .O(new_n82_));
  nand3  g38(.a(new_n82_), .b(new_n76_), .c(x12), .O(new_n83_));
  ...
  nand3  g43(.a(new_n87_), .b(new_n60_), .c(new_n46_), .O(z10));
  ...
  oai21  g47(.a(new_n81_), .b(x21), .c(new_n74_), .O(new_n92_));
  and2   g48(.a(new_n62_), .b(new_n46_), .O(new_n93_));
  oai21  g49(.a(new_n92_), .b(new_n91_), .c(new_n93_), .O(z11));
  inv1   g50(.a(x14), .O(new_n95_));
  oai21  g51(.a(new_n75_), .b(new_n95_), .c(new_n54_), .O(new_n96_));
  inv1   g52(.a(x22), .O(new_n97_));
  aoi21  g53(.a(new_n89_), .b(new_n97_), .c(new_n50_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n64_), .c(new_n59_), .O(z12));
  nand3  g56(.a(x26), .b(x25), .c(x24), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(x15), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n54_), .c(x23), .O(new_n104_));
  inv1   g60(.a(x23), .O(new_n105_));
  aoi21  g61(.a(new_n53_), .b(new_n105_), .c(new_n50_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n66_), .c(new_n46_), .O(z13));
  inv1   g64(.a(z06), .O(new_n109_));
  nand2  g65(.a(new_n54_), .b(new_n52_), .O(new_n110_));
  inv1   g66(.a(x24), .O(new_n111_));
  oai21  g67(.a(new_n53_), .b(new_n105_), .c(new_n111_), .O(new_n112_));
  aoi22  g68(.a(new_n112_), .b(new_n110_), .c(new_n102_), .d(x16), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n50_), .c(new_n109_), .O(z14));
  nand4  g70(.a(new_n76_), .b(new_n81_), .c(new_n52_), .d(x25), .O(new_n115_));
  ...
  nand3  g79(.a(new_n82_), .b(new_n54_), .c(new_n123_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n74_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n72_), .c(new_n59_), .O(z16));
endmodule
