...
module FAU ( 
  ...
  nand2  g01(.a(x11), .b(new_n45_), .O(new_n46_));
  ...
  oai21  g19(.a(new_n52_), .b(new_n63_), .c(new_n46_), .O(z03));
  ...
  nor2   g30(.a(x19), .b(new_n45_), .O(new_n75_));
  ...
  nand2  g36(.a(new_n53_), .b(new_n52_), .O(new_n81_));
  inv1   g37(.a(x11), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g39(.a(x08), .b(x00), .c(new_n83_), .O(new_n84_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n84_), .O(z09));
  and2   g41(.a(x20), .b(x19), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  aoi21  g43(.a(new_n78_), .b(x12), .c(new_n87_), .O(new_n88_));
  oai21  g44(.a(x20), .b(x19), .c(new_n55_), .O(new_n89_));
  aoi21  g45(.a(x08), .b(x01), .c(new_n83_), .O(new_n90_));
  ...
  oai21  g51(.a(new_n86_), .b(x21), .c(new_n55_), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n95_), .c(new_n59_), .d(new_n63_), .O(z11));
  inv1   g53(.a(new_n93_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x22), .O(new_n99_));
  aoi21  g55(.a(new_n92_), .b(x14), .c(new_n99_), .O(new_n100_));
  oai21  g56(.a(new_n98_), .b(x22), .c(new_n55_), .O(new_n101_));
  inv1   g57(.a(new_n59_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(x03), .O(new_n103_));
  oai21  g59(.a(new_n101_), .b(new_n100_), .c(new_n103_), .O(z12));
  ...
  aoi21  g64(.a(x08), .b(x04), .c(new_n83_), .O(new_n109_));
  ...
  nand4  g79(.a(new_n117_), .b(new_n123_), .c(new_n86_), .d(x25), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand2  g81(.a(x24), .b(x23), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n48_), .c(new_n125_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n124_), .c(new_n122_), .O(new_n128_));
  nand2  g84(.a(new_n102_), .b(x06), .O(new_n129_));
  oai21  g85(.a(new_n128_), .b(new_n54_), .c(new_n129_), .O(z15));
  inv1   g86(.a(z08), .O(new_n131_));
  nor2   g87(.a(new_n126_), .b(new_n48_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(x25), .c(x26), .O(new_n133_));
  inv1   g89(.a(x18), .O(new_n134_));
  nand3  g90(.a(new_n92_), .b(new_n116_), .c(new_n134_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n55_), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n133_), .c(new_n131_), .O(z16));
endmodule
