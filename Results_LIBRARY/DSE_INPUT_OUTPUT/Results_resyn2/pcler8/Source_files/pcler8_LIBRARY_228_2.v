...
module FAU ( 
  ...
  nor2   g17(.a(new_n61_), .b(new_n56_), .O(z03));
  ...
  nor2   g25(.a(new_n69_), .b(new_n56_), .O(z07));
  ...
  aoi21  g48(.a(new_n78_), .b(x14), .c(new_n52_), .O(new_n93_));
  inv1   g49(.a(new_n86_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(x22), .c(new_n50_), .O(new_n95_));
  ...
  nand4  g60(.a(new_n79_), .b(new_n77_), .c(x24), .d(x23), .O(new_n105_));
  ...
  and2   g64(.a(new_n67_), .b(new_n46_), .O(new_n109_));
  ...
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n50_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n69_), .c(new_n46_), .O(z15));
  inv1   g74(.a(z08), .O(new_n119_));
  inv1   g75(.a(x18), .O(new_n120_));
  nand2  g76(.a(new_n53_), .b(new_n120_), .O(new_n121_));
  inv1   g77(.a(x26), .O(new_n122_));
  nand3  g78(.a(new_n113_), .b(new_n112_), .c(x23), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n121_), .c(new_n50_), .O(new_n125_));
