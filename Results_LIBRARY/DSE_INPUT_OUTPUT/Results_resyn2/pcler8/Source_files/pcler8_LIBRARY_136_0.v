...
module FAU ( 
  ...
  nor2   g07(.a(x18), .b(x09), .O(new_n52_));
  ...
  aoi21  g21(.a(x08), .b(x06), .c(new_n52_), .O(new_n66_));
  ...
  aoi21  g46(.a(x08), .b(x03), .c(new_n52_), .O(new_n91_));
  ...
  nor2   g62(.a(new_n49_), .b(new_n95_), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(x24), .c(x25), .O(new_n108_));
  and2   g64(.a(x25), .b(x24), .O(new_n109_));
  nand2  g65(.a(x26), .b(x17), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n107_), .c(new_n109_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n70_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n108_), .c(new_n66_), .O(z15));
  aoi21  g69(.a(new_n107_), .b(new_n109_), .c(x26), .O(new_n114_));
  inv1   g70(.a(x18), .O(new_n115_));
  inv1   g71(.a(new_n49_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n82_), .c(new_n115_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n70_), .O(new_n118_));
  oai22  g74(.a(new_n118_), .b(new_n114_), .c(new_n56_), .d(new_n68_), .O(z16));
endmodule
