...
module FAU ( 
  ...
  inv1   g17(.a(new_n49_), .O(z11));
  oai21  g18(.a(x10), .b(x08), .c(new_n51_), .O(z12));
  inv1   g19(.a(new_n53_), .O(z13));
  oai21  g20(.a(x10), .b(x08), .c(new_n55_), .O(z14));
  inv1   g21(.a(new_n57_), .O(z15));
  oai21  g22(.a(x10), .b(x08), .c(new_n59_), .O(z16));
  and2   g23(.a(x08), .b(x00), .O(z09));
endmodule
