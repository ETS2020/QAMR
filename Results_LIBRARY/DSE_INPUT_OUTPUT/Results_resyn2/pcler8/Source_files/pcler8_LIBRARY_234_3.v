...
module FAU ( 
  ...
  oai21  g23(.a(x10), .b(x06), .c(x08), .O(new_n68_));
  ...
  oai21  g41(.a(new_n85_), .b(new_n51_), .c(new_n84_), .O(new_n86_));
  inv1   g42(.a(x21), .O(new_n87_));
  nand2  g43(.a(new_n77_), .b(new_n87_), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n86_), .c(new_n48_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n60_), .c(x10), .O(z11));
  oai21  g46(.a(x10), .b(x03), .c(x08), .O(new_n91_));
  aoi21  g47(.a(new_n76_), .b(x14), .c(new_n52_), .O(new_n92_));
  oai21  g48(.a(new_n84_), .b(x22), .c(new_n50_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(z12));
  nand2  g50(.a(x08), .b(x04), .O(new_n95_));
  ...
  aoi21  g56(.a(new_n100_), .b(new_n95_), .c(x10), .O(z13));
  ...
  aoi21  g63(.a(new_n107_), .b(new_n106_), .c(x10), .O(z14));
  ...
  oai21  g72(.a(new_n116_), .b(new_n49_), .c(new_n68_), .O(z15));
  oai21  g73(.a(x10), .b(x07), .c(x08), .O(new_n118_));
  inv1   g74(.a(new_n111_), .O(new_n119_));
  inv1   g75(.a(x18), .O(new_n120_));
  aoi21  g76(.a(new_n53_), .b(new_n120_), .c(new_n49_), .O(new_n121_));
  oai21  g77(.a(new_n119_), .b(x26), .c(new_n121_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n118_), .O(z16));
endmodule
