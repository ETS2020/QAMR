...
module FAU ( 
  ...
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n75_), .O(z09));
  ...
  oai21  g48(.a(new_n90_), .b(x22), .c(new_n71_), .O(new_n93_));
  nand3  g49(.a(new_n54_), .b(x08), .c(x03), .O(new_n94_));
  ...
  nand3  g57(.a(new_n101_), .b(new_n63_), .c(new_n54_), .O(z13));
  ...
  nand4  g70(.a(new_n107_), .b(new_n114_), .c(new_n77_), .d(x25), .O(new_n115_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n50_), .c(new_n111_), .O(z15));
  ...
  aoi22  g83(.a(x10), .b(new_n53_), .c(x08), .d(x07), .O(new_n128_));
