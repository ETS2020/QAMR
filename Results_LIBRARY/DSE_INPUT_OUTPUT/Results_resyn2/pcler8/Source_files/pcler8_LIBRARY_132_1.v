...
module FAU ( 
  ...
  aoi21  g48(.a(x08), .b(x03), .c(new_n87_), .O(new_n93_));
  ...
  oai21  g55(.a(new_n56_), .b(new_n62_), .c(new_n99_), .O(z13));
  ...
  nand4  g60(.a(new_n104_), .b(new_n75_), .c(x24), .d(x23), .O(new_n105_));
  ...
  aoi21  g78(.a(x08), .b(x07), .c(new_n87_), .O(new_n123_));
