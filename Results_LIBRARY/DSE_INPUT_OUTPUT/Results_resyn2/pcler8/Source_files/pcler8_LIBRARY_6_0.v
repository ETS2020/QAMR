...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n46_, new_n48_, new_n50_, new_n53_, new_n56_;
  ...
  inv1   g11(.a(new_n56_), .O(z07));
  and2   g12(.a(x08), .b(x07), .O(z08));
  oai21  g13(.a(x10), .b(x08), .c(new_n46_), .O(z09));
  inv1   g14(.a(new_n50_), .O(z11));
  inv1   g15(.a(new_n53_), .O(z13));
  oai21  g16(.a(x10), .b(x08), .c(new_n56_), .O(z15));
  zero   g17(.O(z00));
