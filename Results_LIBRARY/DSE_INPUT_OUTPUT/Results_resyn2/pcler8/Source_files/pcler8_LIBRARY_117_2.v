...
module FAU ( 
  ...
  oai21  g53(.a(new_n67_), .b(x04), .c(x08), .O(new_n98_));
  ...
  oai21  g60(.a(new_n67_), .b(x05), .c(x08), .O(new_n105_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n71_), .c(new_n105_), .O(z14));
  ...
  nand3  g74(.a(x10), .b(x08), .c(x06), .O(new_n119_));
  ...
  nand3  g81(.a(new_n125_), .b(new_n123_), .c(new_n72_), .O(new_n126_));
