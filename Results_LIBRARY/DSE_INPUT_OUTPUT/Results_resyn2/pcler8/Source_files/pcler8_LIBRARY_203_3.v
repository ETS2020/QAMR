...
module FAU ( 
  ...
  nand2  g16(.a(new_n60_), .b(new_n45_), .O(z02));
  ...
  oai21  g24(.a(x17), .b(x08), .c(x05), .O(new_n69_));
  ...
  nand3  g34(.a(new_n78_), .b(new_n58_), .c(new_n45_), .O(z09));
  ...
  aoi21  g41(.a(new_n85_), .b(new_n60_), .c(new_n57_), .O(z10));
  ...
  aoi21  g47(.a(new_n80_), .b(new_n91_), .c(new_n53_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n62_), .c(new_n57_), .O(z11));
  inv1   g50(.a(new_n75_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(x14), .c(new_n47_), .O(new_n96_));
  oai21  g52(.a(new_n88_), .b(x22), .c(new_n54_), .O(new_n97_));
  ...
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n54_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n67_), .c(new_n45_), .O(z13));
  inv1   g59(.a(x24), .O(new_n104_));
  oai21  g60(.a(new_n47_), .b(new_n46_), .c(new_n104_), .O(new_n105_));
  inv1   g61(.a(new_n47_), .O(new_n106_));
  nor2   g62(.a(new_n104_), .b(new_n46_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  aoi22  g64(.a(new_n108_), .b(new_n105_), .c(new_n50_), .d(x16), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n53_), .c(new_n69_), .O(z14));
  inv1   g66(.a(x25), .O(new_n111_));
  nand2  g67(.a(new_n108_), .b(new_n111_), .O(new_n112_));
  aoi21  g68(.a(x26), .b(x17), .c(new_n111_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n107_), .c(new_n106_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n112_), .c(new_n54_), .d(new_n45_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n71_), .O(z15));
  inv1   g72(.a(x26), .O(new_n117_));
  nand3  g73(.a(new_n107_), .b(new_n106_), .c(x25), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nor2   g75(.a(new_n49_), .b(x18), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n48_), .c(new_n53_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n73_), .c(new_n57_), .O(z16));
endmodule
