...
module FAU ( 
  ...
  nor2   g21(.a(new_n46_), .b(new_n52_), .O(z07));
  inv1   g22(.a(x07), .O(new_n67_));
  oai21  g23(.a(new_n46_), .b(new_n67_), .c(new_n53_), .O(z08));
  ...
  oai21  g28(.a(new_n58_), .b(new_n51_), .c(new_n72_), .O(z09));
  ...
  nand3  g35(.a(new_n79_), .b(new_n55_), .c(new_n53_), .O(z10));
  ...
  oai22  g41(.a(new_n85_), .b(new_n84_), .c(new_n58_), .d(new_n57_), .O(z11));
  inv1   g42(.a(z04), .O(new_n87_));
  aoi21  g43(.a(new_n81_), .b(x14), .c(new_n49_), .O(new_n88_));
  inv1   g44(.a(new_n82_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(x22), .c(new_n69_), .O(new_n90_));
  ...
  aoi21  g69(.a(x10), .b(new_n52_), .c(z07), .O(new_n114_));
  ...
  nand3  g74(.a(new_n118_), .b(new_n81_), .c(new_n117_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n69_), .O(new_n120_));
  oai22  g76(.a(new_n120_), .b(new_n116_), .c(new_n58_), .d(new_n67_), .O(z16));
endmodule
