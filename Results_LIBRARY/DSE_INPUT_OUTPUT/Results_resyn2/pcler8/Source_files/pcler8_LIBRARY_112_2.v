...
module FAU ( 
  ...
  oai21  g28(.a(new_n51_), .b(x08), .c(x07), .O(new_n73_));
  ...
  oai22  g36(.a(new_n80_), .b(new_n54_), .c(new_n58_), .d(new_n56_), .O(z09));
  ...
  aoi21  g45(.a(new_n89_), .b(new_n85_), .c(x07), .O(new_n90_));
  ...
  oai21  g51(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  inv1   g52(.a(x21), .O(new_n97_));
  aoi21  g53(.a(new_n82_), .b(new_n97_), .c(new_n87_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n96_), .c(x07), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(x10), .c(new_n62_), .O(z11));
  inv1   g56(.a(x14), .O(new_n101_));
  inv1   g57(.a(new_n47_), .O(new_n102_));
  oai21  g58(.a(new_n76_), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  inv1   g59(.a(x22), .O(new_n104_));
  aoi21  g60(.a(new_n92_), .b(new_n104_), .c(new_n87_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(x07), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(x10), .c(new_n64_), .O(z12));
  inv1   g63(.a(new_n54_), .O(new_n108_));
  inv1   g64(.a(new_n94_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x15), .O(new_n110_));
  ...
  nand3  g69(.a(new_n113_), .b(new_n111_), .c(new_n108_), .O(new_n114_));
  oai21  g70(.a(new_n58_), .b(new_n66_), .c(new_n114_), .O(z13));
  ...
  aoi22  g74(.a(new_n118_), .b(new_n116_), .c(new_n109_), .d(x16), .O(new_n119_));
  nand2  g75(.a(new_n70_), .b(x05), .O(new_n120_));
  oai21  g76(.a(new_n119_), .b(new_n54_), .c(new_n120_), .O(z14));
  ...
  oai21  g82(.a(new_n126_), .b(new_n54_), .c(new_n71_), .O(z15));
  aoi21  g83(.a(new_n48_), .b(x25), .c(x26), .O(new_n128_));
  inv1   g84(.a(x18), .O(new_n129_));
  nand3  g85(.a(new_n77_), .b(new_n102_), .c(new_n129_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n53_), .c(new_n51_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n128_), .c(new_n73_), .O(z16));
endmodule
