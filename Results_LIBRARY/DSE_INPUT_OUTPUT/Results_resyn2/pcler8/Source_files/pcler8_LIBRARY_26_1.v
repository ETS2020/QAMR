...
module FAU ( 
  ...
  oai21  g11(.a(new_n46_), .b(new_n55_), .c(new_n52_), .O(z02));
  ...
  nor2   g18(.a(new_n58_), .b(new_n62_), .O(z05));
  ...
  oai21  g53(.a(new_n58_), .b(new_n62_), .c(new_n97_), .O(z13));
  ...
  aoi21  g70(.a(x08), .b(x06), .c(new_n114_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n113_), .O(z15));
  aoi21  g72(.a(new_n109_), .b(new_n108_), .c(x26), .O(new_n117_));
  ...
  aoi21  g76(.a(x08), .b(x07), .c(new_n114_), .O(new_n121_));
