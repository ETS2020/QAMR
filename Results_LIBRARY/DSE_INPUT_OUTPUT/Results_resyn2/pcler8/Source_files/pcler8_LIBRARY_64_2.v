...
module FAU ( 
  ...
  aoi21  g16(.a(x08), .b(x02), .c(new_n46_), .O(new_n61_));
  inv1   g17(.a(new_n61_), .O(z03));
  nand2  g18(.a(x08), .b(x03), .O(new_n63_));
  nor2   g19(.a(new_n63_), .b(new_n46_), .O(z04));
  ...
  nand3  g31(.a(new_n75_), .b(new_n57_), .c(new_n47_), .O(z09));
  ...
  nor2   g38(.a(new_n50_), .b(new_n46_), .O(new_n83_));
  oai21  g39(.a(x20), .b(x19), .c(new_n83_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n82_), .c(new_n59_), .O(z10));
  ...
  oai21  g44(.a(new_n78_), .b(x21), .c(new_n51_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n88_), .c(new_n61_), .O(z11));
  aoi21  g46(.a(new_n77_), .b(x14), .c(new_n53_), .O(new_n91_));
  ...
  nand2  g57(.a(new_n101_), .b(new_n96_), .O(z13));
  inv1   g58(.a(new_n83_), .O(new_n103_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n103_), .c(new_n66_), .O(z14));
  nand3  g66(.a(x26), .b(x25), .c(x17), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  inv1   g68(.a(new_n53_), .O(new_n113_));
  ...
  aoi21  g80(.a(new_n124_), .b(new_n70_), .c(new_n46_), .O(z16));
endmodule
