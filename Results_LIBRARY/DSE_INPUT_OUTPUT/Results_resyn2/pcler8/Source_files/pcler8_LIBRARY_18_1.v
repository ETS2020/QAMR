...
module FAU ( 
  ...
  nand2  g23(.a(new_n67_), .b(new_n53_), .O(z08));
  nand2  g24(.a(x09), .b(new_n52_), .O(new_n69_));
  ...
  aoi21  g54(.a(new_n47_), .b(new_n46_), .c(new_n69_), .O(new_n99_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n88_), .c(new_n64_), .O(z14));
  nand3  g66(.a(x26), .b(x25), .c(x17), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  nand4  g68(.a(new_n107_), .b(new_n106_), .c(new_n77_), .d(x25), .O(new_n113_));
  ...
  aoi21  g73(.a(x10), .b(new_n52_), .c(z07), .O(new_n118_));
  oai21  g74(.a(new_n117_), .b(new_n69_), .c(new_n118_), .O(z15));
  ...
  oai21  g79(.a(new_n123_), .b(new_n108_), .c(new_n89_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n121_), .c(new_n67_), .O(z16));
endmodule
