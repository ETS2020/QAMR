...
module FAU ( 
  ...
  oai21  g41(.a(x20), .b(x08), .c(x19), .O(new_n86_));
  nand3  g42(.a(x23), .b(x22), .c(x13), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n46_), .c(x21), .O(new_n88_));
  aoi22  g44(.a(new_n88_), .b(new_n85_), .c(new_n86_), .d(x21), .O(new_n89_));
  nand2  g45(.a(new_n57_), .b(x09), .O(new_n90_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n71_), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n92_), .c(new_n76_), .d(new_n60_), .O(z12));
  ...
  oai21  g57(.a(new_n76_), .b(new_n62_), .c(new_n101_), .O(z13));
  ...
  nand2  g69(.a(new_n106_), .b(new_n113_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n112_), .c(new_n71_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n66_), .O(z15));
  nand3  g72(.a(x10), .b(x08), .c(x07), .O(new_n117_));
