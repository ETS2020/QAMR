...
module FAU ( 
  ...
  nor2   g23(.a(new_n67_), .b(new_n58_), .O(z06));
  nand2  g24(.a(x08), .b(x06), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n46_), .O(z07));
  nand2  g26(.a(x08), .b(x07), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n58_), .O(z08));
  oai21  g28(.a(new_n50_), .b(x19), .c(new_n56_), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n46_), .O(new_n74_));
  nand3  g30(.a(new_n53_), .b(new_n51_), .c(x11), .O(new_n75_));
  ...
  oai21  g36(.a(new_n80_), .b(new_n47_), .c(new_n79_), .O(new_n81_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n50_), .O(new_n82_));
  ...
  nor3   g43(.a(new_n87_), .b(new_n47_), .c(new_n86_), .O(new_n88_));
  aoi21  g44(.a(x20), .b(x19), .c(x21), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  oai21  g46(.a(new_n88_), .b(new_n85_), .c(new_n90_), .O(new_n91_));
  aoi21  g47(.a(new_n91_), .b(new_n61_), .c(new_n58_), .O(z11));
  nand4  g48(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  nand2  g50(.a(x23), .b(x14), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n47_), .c(new_n94_), .O(new_n96_));
  inv1   g52(.a(x22), .O(new_n97_));
  aoi21  g53(.a(new_n85_), .b(new_n97_), .c(new_n50_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n63_), .c(new_n58_), .O(z12));
  inv1   g56(.a(new_n50_), .O(new_n101_));
  nand4  g57(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n94_), .c(x23), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nand2  g60(.a(new_n93_), .b(new_n104_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n103_), .c(new_n101_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n65_), .c(new_n58_), .O(z13));
  inv1   g63(.a(x24), .O(new_n108_));
  aoi21  g64(.a(new_n53_), .b(x19), .c(new_n108_), .O(new_n109_));
  nor3   g65(.a(new_n85_), .b(new_n87_), .c(x24), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n109_), .c(new_n101_), .O(new_n111_));
  oai21  g67(.a(new_n51_), .b(new_n45_), .c(x16), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n111_), .c(new_n67_), .O(z14));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand3  g70(.a(x24), .b(x23), .c(x22), .O(new_n115_));
  nor2   g71(.a(new_n115_), .b(new_n85_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(x25), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  oai21  g74(.a(new_n115_), .b(new_n85_), .c(new_n118_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n117_), .c(new_n101_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n69_), .c(new_n58_), .O(z15));
  aoi21  g77(.a(new_n116_), .b(x25), .c(x26), .O(new_n122_));
  nor2   g78(.a(new_n87_), .b(new_n47_), .O(new_n123_));
  nor2   g79(.a(new_n85_), .b(x18), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n101_), .O(new_n126_));
  and2   g82(.a(new_n71_), .b(new_n46_), .O(new_n127_));
  oai21  g83(.a(new_n126_), .b(new_n122_), .c(new_n127_), .O(z16));
endmodule
