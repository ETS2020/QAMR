...
module FAU ( 
  ...
  oai21  g07(.a(x10), .b(x08), .c(x00), .O(new_n52_));
  inv1   g08(.a(new_n52_), .O(z01));
  nand2  g09(.a(x10), .b(x00), .O(new_n54_));
  ...
  nand2  g15(.a(new_n59_), .b(new_n54_), .O(z03));
  nand2  g16(.a(new_n56_), .b(x03), .O(new_n61_));
  ...
  aoi21  g40(.a(x08), .b(x01), .c(new_n55_), .O(new_n85_));
  ...
  aoi21  g52(.a(x08), .b(x03), .c(new_n55_), .O(new_n97_));
  ...
  nand2  g69(.a(new_n56_), .b(x05), .O(new_n114_));
  ...
  nand4  g73(.a(new_n111_), .b(new_n78_), .c(new_n77_), .d(x25), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand2  g75(.a(x24), .b(x23), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n46_), .c(new_n119_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  nand2  g78(.a(new_n56_), .b(x06), .O(new_n123_));
  oai21  g79(.a(new_n122_), .b(new_n50_), .c(new_n123_), .O(z15));
  nor2   g80(.a(new_n120_), .b(new_n46_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(x25), .c(x26), .O(new_n126_));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x22), .b(x21), .c(x20), .O(new_n128_));
  inv1   g84(.a(new_n128_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n79_), .c(x19), .d(new_n127_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n71_), .O(new_n131_));
  nand2  g87(.a(new_n56_), .b(x07), .O(new_n132_));
  oai21  g88(.a(new_n131_), .b(new_n126_), .c(new_n132_), .O(z16));
endmodule
