...
module FAU ( 
  ...
  nand2  g14(.a(new_n58_), .b(new_n53_), .O(z03));
  ...
  nand2  g25(.a(x09), .b(new_n52_), .O(new_n70_));
  ...
  nand3  g37(.a(new_n45_), .b(x09), .c(new_n52_), .O(new_n82_));
  ...
  oai21  g52(.a(new_n93_), .b(x22), .c(new_n96_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(new_n60_), .O(z12));
  nand3  g54(.a(new_n49_), .b(x24), .c(x15), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n48_), .O(new_n100_));
  aoi21  g56(.a(new_n47_), .b(new_n46_), .c(new_n70_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n62_), .c(new_n53_), .O(z13));
  ...
  nand3  g65(.a(new_n109_), .b(new_n78_), .c(new_n77_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n70_), .c(new_n104_), .O(z14));
  nand3  g68(.a(x26), .b(x25), .c(x17), .O(new_n113_));
  inv1   g69(.a(new_n113_), .O(new_n114_));
  nand4  g70(.a(new_n109_), .b(new_n78_), .c(new_n77_), .d(x25), .O(new_n115_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n82_), .c(new_n66_), .O(z15));
  ...
  oai21  g80(.a(new_n124_), .b(new_n110_), .c(new_n96_), .O(new_n125_));
