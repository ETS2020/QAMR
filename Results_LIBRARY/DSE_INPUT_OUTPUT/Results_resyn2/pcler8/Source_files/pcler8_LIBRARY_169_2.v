...
module FAU ( 
  ...
  aoi21  g13(.a(x10), .b(new_n57_), .c(new_n45_), .O(z03));
  ...
  nand3  g25(.a(new_n61_), .b(x09), .c(new_n45_), .O(new_n70_));
  ...
  nor2   g37(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n55_), .O(z10));
  ...
  oai22  g45(.a(new_n89_), .b(new_n88_), .c(new_n76_), .d(new_n57_), .O(z11));
  oai21  g46(.a(new_n61_), .b(x03), .c(x08), .O(new_n91_));
  aoi21  g47(.a(new_n85_), .b(x14), .c(new_n49_), .O(new_n92_));
  nand2  g48(.a(new_n61_), .b(x09), .O(new_n93_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n92_), .c(new_n91_), .O(z12));
  inv1   g54(.a(x15), .O(new_n99_));
  nor2   g55(.a(new_n72_), .b(new_n99_), .O(new_n100_));
  xor2a  g56(.a(new_n49_), .b(new_n48_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n94_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n62_), .O(z13));
  oai21  g59(.a(new_n61_), .b(x05), .c(x08), .O(new_n104_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n93_), .c(new_n104_), .O(z14));
