...
module FAU ( 
  ...
  nand3  g33(.a(new_n77_), .b(new_n76_), .c(new_n46_), .O(z09));
  and2   g34(.a(x20), .b(x19), .O(new_n79_));
  nand3  g35(.a(x22), .b(x21), .c(x12), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n50_), .c(new_n79_), .O(new_n81_));
  ...
  oai21  g44(.a(new_n79_), .b(x21), .c(new_n73_), .O(new_n89_));
  inv1   g45(.a(new_n46_), .O(new_n90_));
  aoi21  g46(.a(x08), .b(x02), .c(new_n90_), .O(new_n91_));
  oai21  g47(.a(new_n89_), .b(new_n88_), .c(new_n91_), .O(z11));
  ...
  oai21  g57(.a(new_n101_), .b(new_n99_), .c(new_n73_), .O(new_n102_));
  ...
  nand4  g63(.a(new_n107_), .b(new_n79_), .c(x24), .d(x23), .O(new_n108_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n49_), .c(new_n104_), .O(z14));
  inv1   g68(.a(x25), .O(new_n113_));
  nor2   g69(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nor2   g70(.a(new_n52_), .b(new_n100_), .O(new_n115_));
  ...
  nand3  g75(.a(new_n46_), .b(x08), .c(x06), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n119_), .O(z15));
  aoi21  g77(.a(new_n115_), .b(new_n114_), .c(x26), .O(new_n122_));
  oai21  g78(.a(new_n54_), .b(x18), .c(new_n73_), .O(new_n123_));
  aoi21  g79(.a(x08), .b(x07), .c(new_n90_), .O(new_n124_));
  oai21  g80(.a(new_n123_), .b(new_n122_), .c(new_n124_), .O(z16));
endmodule
