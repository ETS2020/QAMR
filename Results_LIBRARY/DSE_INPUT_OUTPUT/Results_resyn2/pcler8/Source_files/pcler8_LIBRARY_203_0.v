...
module FAU ( 
  ...
  aoi21  g23(.a(x08), .b(x05), .c(new_n45_), .O(new_n68_));
  ...
  nor3   g39(.a(new_n76_), .b(new_n75_), .c(new_n83_), .O(new_n84_));
  nor2   g40(.a(x20), .b(x19), .O(new_n85_));
  nor2   g41(.a(new_n85_), .b(new_n49_), .O(new_n86_));
  ...
  aoi21  g49(.a(new_n82_), .b(new_n93_), .c(new_n49_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n62_), .c(new_n45_), .O(z11));
  inv1   g52(.a(new_n76_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(x14), .c(new_n54_), .O(new_n98_));
  oai21  g54(.a(new_n90_), .b(x22), .c(new_n50_), .O(new_n99_));
  ...
  nand2  g61(.a(new_n52_), .b(x16), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand2  g63(.a(new_n55_), .b(x24), .O(new_n108_));
  inv1   g64(.a(x24), .O(new_n109_));
  oai21  g65(.a(new_n54_), .b(new_n53_), .c(new_n109_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n49_), .c(new_n68_), .O(z14));
  aoi21  g68(.a(new_n55_), .b(x24), .c(x25), .O(new_n113_));
  inv1   g69(.a(new_n54_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(x25), .c(x24), .d(x23), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n50_), .c(new_n46_), .O(new_n116_));
  nand3  g72(.a(x26), .b(x25), .c(x17), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n50_), .c(z07), .O(new_n119_));
  oai21  g75(.a(new_n116_), .b(new_n113_), .c(new_n119_), .O(z15));
  ...
  aoi21  g81(.a(new_n125_), .b(new_n72_), .c(new_n45_), .O(z16));
endmodule
