...
module FAU ( 
  ...
  nor2   g23(.a(new_n67_), .b(new_n62_), .O(z06));
  ...
  nand3  g38(.a(new_n82_), .b(new_n58_), .c(new_n46_), .O(z10));
  ...
  oai22  g49(.a(new_n93_), .b(new_n91_), .c(new_n63_), .d(new_n62_), .O(z12));
  ...
  nand4  g59(.a(new_n103_), .b(new_n77_), .c(x24), .d(x23), .O(new_n104_));
  ...
  and2   g63(.a(new_n67_), .b(new_n46_), .O(new_n108_));
  ...
  nand4  g70(.a(new_n103_), .b(new_n77_), .c(new_n114_), .d(x23), .O(new_n115_));
  ...
  nand3  g78(.a(new_n122_), .b(new_n71_), .c(new_n46_), .O(z16));
endmodule
