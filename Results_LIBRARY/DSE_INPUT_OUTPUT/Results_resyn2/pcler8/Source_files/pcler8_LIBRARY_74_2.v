...
module FAU ( 
  ...
  aoi21  g16(.a(x10), .b(new_n60_), .c(new_n45_), .O(z04));
  oai21  g17(.a(new_n57_), .b(x04), .c(x08), .O(new_n62_));
  inv1   g18(.a(new_n62_), .O(z05));
  oai21  g19(.a(new_n57_), .b(x05), .c(x08), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z06));
  oai21  g21(.a(new_n57_), .b(x06), .c(x08), .O(new_n66_));
  ...
  oai21  g32(.a(new_n57_), .b(x01), .c(x08), .O(new_n77_));
  ...
  nand2  g38(.a(new_n57_), .b(x09), .O(new_n83_));
  ...
  nand2  g46(.a(new_n78_), .b(new_n90_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n84_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n89_), .c(new_n58_), .O(z11));
  aoi21  g49(.a(new_n79_), .b(x14), .c(new_n49_), .O(new_n94_));
  inv1   g50(.a(new_n87_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(x22), .c(new_n71_), .O(new_n96_));
  nand3  g52(.a(x10), .b(x08), .c(x03), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n94_), .c(new_n97_), .O(z12));
  nand4  g54(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(x23), .c(new_n49_), .O(new_n100_));
  nand2  g56(.a(new_n87_), .b(new_n45_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(x22), .c(new_n48_), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n100_), .c(new_n84_), .O(new_n103_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n83_), .c(new_n64_), .O(z14));
  ...
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(new_n84_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n66_), .O(z15));
  inv1   g74(.a(x26), .O(new_n119_));
  nand4  g75(.a(new_n107_), .b(x25), .c(x24), .d(x23), .O(new_n120_));
  ...
  nand3  g79(.a(new_n123_), .b(new_n121_), .c(new_n84_), .O(new_n124_));
