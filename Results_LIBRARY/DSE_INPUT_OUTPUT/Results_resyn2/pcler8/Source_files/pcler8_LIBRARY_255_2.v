...
module FAU ( 
  ...
  inv1   g40(.a(new_n78_), .O(new_n85_));
  ...
  nand3  g44(.a(new_n53_), .b(x09), .c(new_n45_), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  oai21  g46(.a(new_n85_), .b(x21), .c(new_n90_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n88_), .c(new_n58_), .O(z11));
  oai21  g48(.a(new_n53_), .b(x03), .c(x08), .O(new_n93_));
  ...
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n90_), .O(new_n102_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n89_), .c(new_n64_), .O(z14));
