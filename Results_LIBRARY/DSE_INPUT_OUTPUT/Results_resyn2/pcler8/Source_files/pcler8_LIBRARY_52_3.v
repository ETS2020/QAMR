...
module FAU ( 
  ...
  aoi21  g43(.a(new_n76_), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n88_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n57_), .c(x10), .O(z11));
  nand2  g46(.a(x08), .b(x03), .O(new_n91_));
  ...
  aoi21  g51(.a(new_n83_), .b(new_n95_), .c(new_n87_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n91_), .c(x10), .O(z12));
  oai21  g54(.a(x10), .b(x04), .c(x08), .O(new_n99_));
  inv1   g55(.a(x15), .O(new_n100_));
  nor2   g56(.a(new_n45_), .b(new_n100_), .O(new_n101_));
  inv1   g57(.a(x23), .O(new_n102_));
  nor2   g58(.a(new_n50_), .b(new_n102_), .O(new_n103_));
  nor2   g59(.a(new_n93_), .b(x23), .O(new_n104_));
  nor2   g60(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n101_), .c(new_n80_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n99_), .O(z13));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  xor2a  g65(.a(new_n103_), .b(x24), .O(new_n110_));
