...
module FAU ( 
  ...
  nor2   g34(.a(new_n53_), .b(x09), .O(new_n79_));
  ...
  nor2   g43(.a(new_n87_), .b(new_n54_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  aoi21  g45(.a(x08), .b(x01), .c(new_n79_), .O(new_n90_));
  ...
  aoi21  g51(.a(x08), .b(x02), .c(new_n79_), .O(new_n96_));
  ...
  aoi21  g64(.a(x08), .b(x04), .c(new_n79_), .O(new_n109_));
  ...
  oai21  g69(.a(new_n48_), .b(new_n47_), .c(new_n113_), .O(new_n114_));
  inv1   g70(.a(new_n48_), .O(new_n115_));
  ...
  nand2  g74(.a(new_n102_), .b(x05), .O(new_n119_));
  oai21  g75(.a(new_n118_), .b(new_n54_), .c(new_n119_), .O(z14));
  inv1   g76(.a(z07), .O(new_n121_));
  nand3  g77(.a(x26), .b(x25), .c(x17), .O(new_n122_));
  inv1   g78(.a(new_n122_), .O(new_n123_));
  nand4  g79(.a(new_n116_), .b(new_n83_), .c(new_n82_), .d(x25), .O(new_n124_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n54_), .c(new_n121_), .O(z15));
  nor2   g85(.a(new_n126_), .b(new_n48_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(x25), .c(x26), .O(new_n131_));
  inv1   g87(.a(x18), .O(new_n132_));
  nand3  g88(.a(new_n84_), .b(new_n115_), .c(new_n132_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n55_), .O(new_n134_));
  oai22  g90(.a(new_n134_), .b(new_n131_), .c(new_n59_), .d(new_n73_), .O(z16));
endmodule
