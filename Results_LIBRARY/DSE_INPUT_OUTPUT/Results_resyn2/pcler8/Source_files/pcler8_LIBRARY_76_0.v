...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n55_, new_n58_, new_n60_, new_n62_, new_n64_,
  ...
  nor2   g03(.a(x17), .b(x01), .O(new_n48_));
  ...
  nor3   g08(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(z00));
  inv1   g09(.a(new_n48_), .O(new_n54_));
  nand2  g10(.a(x08), .b(x00), .O(new_n55_));
  nand2  g11(.a(new_n55_), .b(new_n54_), .O(z01));
  and2   g12(.a(x08), .b(x01), .O(z02));
  nand3  g13(.a(new_n54_), .b(x08), .c(x02), .O(new_n58_));
  inv1   g14(.a(new_n58_), .O(z03));
  aoi21  g15(.a(x08), .b(x03), .c(new_n48_), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(z04));
  nand2  g17(.a(x08), .b(x04), .O(new_n62_));
  nand2  g18(.a(new_n62_), .b(new_n54_), .O(z05));
  nand3  g19(.a(new_n54_), .b(x08), .c(x05), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z06));
  nand2  g21(.a(x08), .b(x06), .O(new_n66_));
  nor2   g22(.a(new_n66_), .b(new_n48_), .O(z07));
  nand2  g23(.a(x08), .b(x07), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n48_), .O(z08));
  ...
  nand3  g30(.a(new_n74_), .b(new_n55_), .c(new_n54_), .O(z09));
  ...
  oai21  g35(.a(x20), .b(x19), .c(new_n70_), .O(new_n80_));
  nor2   g36(.a(z02), .b(new_n48_), .O(new_n81_));
  ...
  oai21  g41(.a(new_n76_), .b(x21), .c(new_n49_), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n85_), .c(new_n58_), .O(z11));
  aoi21  g43(.a(new_n77_), .b(x14), .c(new_n52_), .O(new_n88_));
  inv1   g44(.a(new_n83_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(x22), .c(new_n70_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n88_), .c(new_n60_), .O(z12));
  inv1   g47(.a(x15), .O(new_n92_));
  nor2   g48(.a(new_n51_), .b(new_n92_), .O(new_n93_));
  inv1   g49(.a(x23), .O(new_n94_));
  xor2a  g50(.a(new_n52_), .b(new_n94_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n93_), .c(new_n70_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n62_), .c(new_n54_), .O(z13));
  nand4  g53(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n98_));
  inv1   g54(.a(new_n98_), .O(new_n99_));
  nand4  g55(.a(new_n71_), .b(new_n76_), .c(x24), .d(x23), .O(new_n100_));
  inv1   g56(.a(x24), .O(new_n101_));
  oai21  g57(.a(new_n52_), .b(new_n94_), .c(new_n101_), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n50_), .c(new_n64_), .O(z14));
  nand3  g60(.a(x26), .b(x25), .c(x17), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nor2   g62(.a(new_n52_), .b(new_n94_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(x25), .c(x24), .O(new_n108_));
  ...
  aoi21  g67(.a(x08), .b(x06), .c(new_n48_), .O(new_n112_));
  oai21  g68(.a(new_n111_), .b(new_n47_), .c(new_n112_), .O(z15));
  inv1   g69(.a(new_n108_), .O(new_n114_));
  nor2   g70(.a(new_n52_), .b(x18), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n77_), .c(new_n47_), .O(new_n116_));
  oai21  g72(.a(new_n114_), .b(x26), .c(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n68_), .c(new_n54_), .O(z16));
endmodule
