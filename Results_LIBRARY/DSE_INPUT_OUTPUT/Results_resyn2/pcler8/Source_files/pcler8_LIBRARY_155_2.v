...
module FAU ( 
  ...
  oai21  g25(.a(new_n55_), .b(x00), .c(x08), .O(new_n70_));
  nand2  g26(.a(new_n55_), .b(x09), .O(new_n71_));
  ...
  oai21  g40(.a(new_n55_), .b(x02), .c(x08), .O(new_n85_));
  ...
  oai21  g45(.a(new_n86_), .b(x21), .c(new_n72_), .O(new_n90_));
  ...
  nand2  g50(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n92_), .c(new_n60_), .O(z12));
  nand3  g52(.a(new_n55_), .b(x09), .c(new_n45_), .O(new_n97_));
  ...
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n98_), .O(new_n102_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n71_), .c(new_n64_), .O(z14));
  ...
  nand3  g71(.a(new_n115_), .b(new_n113_), .c(new_n98_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n66_), .O(z15));
  inv1   g73(.a(x26), .O(new_n118_));
  nand4  g74(.a(new_n106_), .b(x25), .c(x24), .d(x23), .O(new_n119_));
  ...
  nand3  g78(.a(new_n122_), .b(new_n120_), .c(new_n98_), .O(new_n123_));
