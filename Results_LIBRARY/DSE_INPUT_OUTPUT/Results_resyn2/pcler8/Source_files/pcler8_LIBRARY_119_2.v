...
module FAU ( 
  ...
  aoi21  g14(.a(x10), .b(new_n58_), .c(new_n45_), .O(z03));
  ...
  oai21  g19(.a(new_n53_), .b(x05), .c(x08), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z06));
  oai21  g21(.a(new_n53_), .b(x06), .c(x08), .O(new_n66_));
  ...
  aoi21  g38(.a(new_n78_), .b(new_n77_), .c(new_n82_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n56_), .O(z10));
  nand2  g41(.a(x10), .b(x08), .O(new_n86_));
  inv1   g42(.a(new_n72_), .O(new_n87_));
  ...
  oai22  g48(.a(new_n92_), .b(new_n90_), .c(new_n86_), .d(new_n58_), .O(z11));
  aoi21  g49(.a(new_n87_), .b(x14), .c(new_n49_), .O(new_n94_));
  inv1   g50(.a(new_n88_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(x22), .c(new_n91_), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n94_), .c(new_n86_), .d(new_n60_), .O(z12));
  oai21  g53(.a(new_n53_), .b(x04), .c(x08), .O(new_n98_));
  nand4  g54(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(x23), .c(new_n49_), .O(new_n100_));
  nand2  g56(.a(new_n88_), .b(new_n45_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(x22), .c(new_n48_), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n100_), .c(new_n71_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n98_), .O(z13));
  ...
  oai21  g67(.a(new_n111_), .b(new_n70_), .c(new_n64_), .O(z14));
  ...
  nand3  g74(.a(x10), .b(x08), .c(x07), .O(new_n119_));
  ...
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n91_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n119_), .O(z16));
endmodule
