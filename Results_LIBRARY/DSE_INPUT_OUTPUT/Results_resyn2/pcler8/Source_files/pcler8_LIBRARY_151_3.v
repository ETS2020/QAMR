...
module FAU ( 
  ...
  oai21  g13(.a(new_n51_), .b(new_n57_), .c(new_n45_), .O(z01));
  nand2  g14(.a(x08), .b(x01), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(new_n45_), .O(z02));
  inv1   g16(.a(x02), .O(new_n61_));
  oai21  g17(.a(new_n51_), .b(new_n61_), .c(new_n45_), .O(z03));
  nand2  g18(.a(new_n45_), .b(x08), .O(new_n63_));
  ...
  oai21  g29(.a(new_n51_), .b(new_n73_), .c(new_n45_), .O(z08));
  ...
  oai21  g34(.a(new_n63_), .b(new_n57_), .c(new_n78_), .O(z09));
  ...
  oai22  g47(.a(new_n91_), .b(new_n90_), .c(new_n63_), .d(new_n61_), .O(z11));
  ...
  nand3  g57(.a(new_n101_), .b(new_n67_), .c(new_n45_), .O(z13));
  ...
  nand2  g66(.a(new_n64_), .b(x05), .O(new_n111_));
  oai21  g67(.a(new_n110_), .b(new_n53_), .c(new_n111_), .O(z14));
  nand3  g68(.a(x26), .b(x25), .c(x17), .O(new_n113_));
  inv1   g69(.a(new_n113_), .O(new_n114_));
  and2   g70(.a(x22), .b(x21), .O(new_n115_));
  nand4  g71(.a(new_n108_), .b(new_n115_), .c(new_n80_), .d(x25), .O(new_n116_));
  inv1   g72(.a(x25), .O(new_n117_));
  nand2  g73(.a(x24), .b(x23), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n47_), .c(new_n117_), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(new_n116_), .c(new_n114_), .O(new_n120_));
  nand2  g76(.a(new_n64_), .b(x06), .O(new_n121_));
  oai21  g77(.a(new_n120_), .b(new_n53_), .c(new_n121_), .O(z15));
  nor2   g78(.a(new_n118_), .b(new_n47_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(x25), .c(x26), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n87_), .b(new_n107_), .c(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  oai22  g83(.a(new_n127_), .b(new_n124_), .c(new_n63_), .d(new_n73_), .O(z16));
endmodule
