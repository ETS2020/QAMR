...
module FAU ( 
  ...
  oai21  g21(.a(new_n63_), .b(x06), .c(x08), .O(new_n66_));
  ...
  oai22  g48(.a(new_n92_), .b(new_n91_), .c(new_n76_), .d(new_n57_), .O(z11));
  oai21  g49(.a(new_n63_), .b(x03), .c(x08), .O(new_n94_));
  aoi21  g50(.a(new_n80_), .b(x14), .c(new_n49_), .O(new_n95_));
  ...
  oai21  g55(.a(new_n63_), .b(x04), .c(x08), .O(new_n100_));
  ...
  nand3  g73(.a(new_n117_), .b(new_n115_), .c(new_n85_), .O(new_n118_));
