...
module FAU ( 
  ...
  nand3  g09(.a(new_n53_), .b(new_n48_), .c(new_n47_), .O(new_n54_));
  ...
  oai21  g16(.a(x17), .b(x08), .c(x02), .O(new_n61_));
  ...
  oai21  g50(.a(new_n92_), .b(x22), .c(new_n73_), .O(new_n95_));
  and2   g51(.a(new_n63_), .b(new_n45_), .O(new_n96_));
  oai21  g52(.a(new_n95_), .b(new_n94_), .c(new_n96_), .O(z12));
  nand4  g53(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n47_), .c(x23), .O(new_n99_));
  inv1   g55(.a(x23), .O(new_n100_));
  nand2  g56(.a(new_n46_), .b(new_n100_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n99_), .c(new_n73_), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n65_), .c(new_n56_), .O(z13));
  and2   g59(.a(x22), .b(x21), .O(new_n104_));
  nand3  g60(.a(new_n48_), .b(new_n104_), .c(new_n79_), .O(new_n105_));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  inv1   g63(.a(x24), .O(new_n108_));
  oai21  g64(.a(new_n46_), .b(new_n100_), .c(new_n108_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n105_), .c(new_n107_), .O(new_n110_));
  nand4  g66(.a(new_n45_), .b(new_n51_), .c(x09), .d(new_n50_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n110_), .c(new_n67_), .O(z14));
  inv1   g68(.a(new_n111_), .O(new_n113_));
  nand4  g69(.a(new_n48_), .b(new_n104_), .c(new_n79_), .d(x25), .O(new_n114_));
  ...
  nand3  g74(.a(new_n53_), .b(x17), .c(new_n118_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n117_), .c(new_n69_), .O(z15));
  inv1   g76(.a(z08), .O(new_n121_));
  inv1   g77(.a(x26), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(x18), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n48_), .c(new_n47_), .d(x25), .O(new_n124_));
  nand2  g80(.a(new_n114_), .b(new_n122_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n124_), .c(new_n73_), .O(new_n126_));
