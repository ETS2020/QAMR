...
module FAU ( 
  ...
  nor2   g29(.a(x16), .b(new_n73_), .O(new_n74_));
  nand3  g30(.a(new_n74_), .b(new_n53_), .c(x20), .O(new_n75_));
  inv1   g31(.a(x19), .O(new_n76_));
  inv1   g32(.a(new_n52_), .O(new_n77_));
  nand3  g33(.a(new_n77_), .b(new_n45_), .c(new_n76_), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(new_n75_), .c(new_n56_), .O(z09));
  nor2   g35(.a(new_n49_), .b(new_n48_), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(x12), .c(new_n46_), .O(new_n81_));
  ...
  nand2  g40(.a(new_n47_), .b(x21), .O(new_n85_));
  nand3  g41(.a(x23), .b(x22), .c(x13), .O(new_n86_));
  nor2   g42(.a(new_n86_), .b(new_n49_), .O(new_n87_));
  nor2   g43(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  oai21  g44(.a(new_n47_), .b(x21), .c(new_n77_), .O(new_n89_));
  and2   g45(.a(new_n61_), .b(new_n45_), .O(new_n90_));
  ...
  and2   g54(.a(new_n63_), .b(new_n45_), .O(new_n99_));
  ...
  aoi21  g60(.a(new_n93_), .b(new_n102_), .c(new_n52_), .O(new_n105_));
  ...
  nor2   g64(.a(new_n48_), .b(new_n46_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n108_), .c(x24), .O(new_n110_));
  inv1   g66(.a(x24), .O(new_n111_));
  oai21  g67(.a(new_n48_), .b(new_n46_), .c(new_n111_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n110_), .c(new_n51_), .d(x09), .O(new_n113_));
  oai21  g69(.a(new_n50_), .b(x05), .c(new_n45_), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(new_n50_), .c(new_n114_), .O(z14));
  inv1   g71(.a(x25), .O(new_n116_));
  aoi21  g72(.a(x26), .b(x17), .c(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n109_), .c(x24), .O(new_n118_));
  nand2  g74(.a(new_n109_), .b(x24), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n77_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n69_), .c(new_n45_), .O(z15));
  and2   g78(.a(x25), .b(x24), .O(new_n123_));
  inv1   g79(.a(x26), .O(new_n124_));
  nor2   g80(.a(new_n124_), .b(x18), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n123_), .c(new_n109_), .O(new_n126_));
  inv1   g82(.a(new_n48_), .O(new_n127_));
  nand3  g83(.a(new_n123_), .b(new_n127_), .c(new_n47_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n126_), .c(new_n77_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n71_), .c(new_n58_), .O(z16));
endmodule
