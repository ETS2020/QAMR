...
module FAU ( 
  ...
  nor2   g21(.a(new_n61_), .b(new_n65_), .O(z05));
  ...
  nand3  g27(.a(new_n45_), .b(x09), .c(new_n61_), .O(new_n72_));
  ...
  nand3  g37(.a(new_n81_), .b(new_n75_), .c(x12), .O(new_n82_));
  and2   g38(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  oai21  g39(.a(x20), .b(x19), .c(new_n73_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n83_), .c(new_n58_), .O(z10));
  ...
  oai22  g45(.a(new_n89_), .b(new_n88_), .c(new_n61_), .d(new_n60_), .O(z11));
  aoi21  g46(.a(new_n81_), .b(x14), .c(new_n47_), .O(new_n91_));
  inv1   g47(.a(new_n86_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x22), .c(new_n73_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n91_), .c(new_n63_), .O(z12));
  inv1   g50(.a(x15), .O(new_n95_));
  nor2   g51(.a(new_n74_), .b(new_n95_), .O(new_n96_));
  xor2a  g52(.a(new_n47_), .b(new_n46_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n96_), .c(new_n73_), .O(new_n98_));
  oai21  g54(.a(new_n61_), .b(new_n65_), .c(new_n98_), .O(z13));
  nand4  g55(.a(new_n75_), .b(new_n80_), .c(x24), .d(x23), .O(new_n100_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n72_), .c(new_n67_), .O(z14));
  ...
  oai21  g67(.a(new_n111_), .b(new_n72_), .c(new_n69_), .O(z15));
  ...
  nand4  g71(.a(new_n115_), .b(new_n113_), .c(x09), .d(new_n61_), .O(new_n116_));
  nor2   g72(.a(z08), .b(new_n54_), .O(new_n117_));
