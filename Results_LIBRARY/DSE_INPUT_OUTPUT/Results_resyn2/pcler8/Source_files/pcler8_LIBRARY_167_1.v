...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n53_, new_n54_, new_n55_, new_n59_, new_n61_, new_n63_, new_n65_,
  ...
  inv1   g37(.a(new_n54_), .O(new_n82_));
  nor2   g38(.a(z02), .b(new_n82_), .O(new_n83_));
  oai21  g39(.a(new_n81_), .b(new_n80_), .c(new_n83_), .O(z10));
  ...
  oai21  g44(.a(new_n85_), .b(x21), .c(new_n70_), .O(new_n89_));
  nor2   g45(.a(z03), .b(new_n82_), .O(new_n90_));
  ...
  nand2  g55(.a(x09), .b(new_n53_), .O(new_n100_));
  aoi21  g56(.a(new_n47_), .b(new_n46_), .c(new_n100_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n61_), .c(new_n54_), .O(z13));
  nand2  g59(.a(new_n70_), .b(new_n45_), .O(new_n104_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n104_), .c(new_n63_), .O(z14));
  inv1   g68(.a(new_n104_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n117_), .b(new_n116_), .c(new_n113_), .O(new_n118_));
  ...
  aoi21  g80(.a(new_n124_), .b(new_n77_), .c(new_n100_), .O(new_n125_));
