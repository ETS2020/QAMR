...
module FAU ( 
  ...
  aoi21  g14(.a(x08), .b(x00), .c(new_n45_), .O(new_n59_));
  ...
  nor2   g19(.a(new_n63_), .b(new_n45_), .O(z03));
  ...
  nor2   g59(.a(z05), .b(new_n45_), .O(new_n104_));
  ...
  oai21  g70(.a(new_n114_), .b(new_n113_), .c(new_n68_), .O(z14));
  nand2  g71(.a(x24), .b(x23), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n48_), .c(new_n50_), .O(new_n117_));
  nand4  g73(.a(new_n111_), .b(new_n75_), .c(new_n82_), .d(x25), .O(new_n118_));
  ...
  nand3  g83(.a(new_n127_), .b(new_n72_), .c(new_n46_), .O(z16));
endmodule
