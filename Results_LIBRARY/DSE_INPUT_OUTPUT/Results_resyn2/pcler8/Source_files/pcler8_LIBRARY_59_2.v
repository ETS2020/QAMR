...
module FAU ( 
  ...
  oai21  g46(.a(new_n87_), .b(x21), .c(new_n84_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n90_), .c(new_n58_), .O(z11));
  oai21  g48(.a(new_n57_), .b(x03), .c(x08), .O(new_n93_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n70_), .c(new_n64_), .O(z14));
  oai21  g67(.a(new_n57_), .b(x06), .c(x08), .O(new_n112_));
