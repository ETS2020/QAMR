...
module FAU ( 
  ...
  aoi21  g39(.a(new_n83_), .b(new_n59_), .c(new_n63_), .O(z10));
  nand3  g40(.a(x21), .b(x20), .c(x19), .O(new_n85_));
  inv1   g41(.a(new_n85_), .O(new_n86_));
  nand2  g42(.a(x22), .b(x13), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n47_), .c(new_n86_), .O(new_n88_));
  inv1   g44(.a(x21), .O(new_n89_));
  nand2  g45(.a(x20), .b(x19), .O(new_n90_));
  aoi21  g46(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n61_), .c(new_n63_), .O(z11));
  aoi21  g49(.a(new_n48_), .b(x14), .c(new_n53_), .O(new_n94_));
  oai21  g50(.a(new_n86_), .b(x22), .c(new_n52_), .O(new_n95_));
  and2   g51(.a(new_n64_), .b(new_n46_), .O(new_n96_));
  oai21  g52(.a(new_n95_), .b(new_n94_), .c(new_n96_), .O(z12));
  inv1   g53(.a(x15), .O(new_n98_));
  nor2   g54(.a(new_n47_), .b(new_n98_), .O(new_n99_));
  inv1   g55(.a(x23), .O(new_n100_));
  xor2a  g56(.a(new_n53_), .b(new_n100_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n99_), .c(new_n52_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n66_), .c(new_n46_), .O(z13));
  oai21  g59(.a(x08), .b(new_n45_), .c(x05), .O(new_n104_));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  and2   g62(.a(x22), .b(x21), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n78_), .c(x24), .d(x23), .O(new_n108_));
  inv1   g64(.a(x24), .O(new_n109_));
  oai21  g65(.a(new_n53_), .b(new_n100_), .c(new_n109_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n51_), .c(new_n104_), .O(z14));
  inv1   g68(.a(x25), .O(new_n113_));
  nor2   g69(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nor2   g70(.a(new_n53_), .b(new_n100_), .O(new_n115_));
  ...
  nand3  g75(.a(new_n119_), .b(new_n70_), .c(new_n46_), .O(z15));
  ...
  nand2  g79(.a(new_n123_), .b(new_n115_), .O(new_n124_));
  inv1   g80(.a(x05), .O(new_n125_));
  nand2  g81(.a(new_n49_), .b(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n50_), .b(x09), .O(new_n127_));
  aoi21  g83(.a(new_n126_), .b(new_n45_), .c(new_n127_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n121_), .c(new_n72_), .O(z16));
endmodule
