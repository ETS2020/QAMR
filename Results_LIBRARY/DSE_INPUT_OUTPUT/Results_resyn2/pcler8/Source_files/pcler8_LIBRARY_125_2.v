...
module FAU ( 
  ...
  nand2  g05(.a(new_n49_), .b(x15), .O(new_n50_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n100_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n99_), .c(new_n50_), .d(new_n48_), .O(new_n102_));
  nand4  g58(.a(new_n84_), .b(new_n48_), .c(x17), .d(x15), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n102_), .c(new_n66_), .O(z13));
  inv1   g60(.a(x24), .O(new_n105_));
  oai21  g61(.a(new_n97_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  ...
  nand4  g72(.a(new_n77_), .b(new_n116_), .c(new_n107_), .d(x25), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand2  g74(.a(x24), .b(x23), .O(new_n119_));
  oai21  g75(.a(new_n97_), .b(new_n119_), .c(new_n118_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(new_n121_));
  and2   g77(.a(new_n70_), .b(new_n50_), .O(new_n122_));
  oai21  g78(.a(new_n121_), .b(new_n47_), .c(new_n122_), .O(z15));
  inv1   g79(.a(x18), .O(new_n124_));
  nand3  g80(.a(new_n54_), .b(x19), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g84(.a(new_n128_), .b(new_n72_), .c(new_n50_), .O(z16));
endmodule
