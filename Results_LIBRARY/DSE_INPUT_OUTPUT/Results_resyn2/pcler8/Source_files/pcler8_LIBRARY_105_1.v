...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n62_, new_n63_, new_n67_, new_n69_, new_n71_, new_n73_,
  ...
  nor2   g16(.a(new_n53_), .b(x03), .O(new_n61_));
  nor2   g17(.a(new_n61_), .b(new_n52_), .O(new_n62_));
  inv1   g18(.a(new_n62_), .O(new_n63_));
  nor2   g19(.a(new_n63_), .b(new_n60_), .O(z02));
  and2   g20(.a(new_n62_), .b(x02), .O(z03));
  nor2   g21(.a(new_n52_), .b(new_n45_), .O(z04));
  ...
  aoi21  g47(.a(x08), .b(x02), .c(new_n61_), .O(new_n92_));
  ...
  nor2   g53(.a(z04), .b(new_n61_), .O(new_n98_));
