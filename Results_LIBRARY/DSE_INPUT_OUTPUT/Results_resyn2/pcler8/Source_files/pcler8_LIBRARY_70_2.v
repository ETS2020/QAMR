...
module FAU ( 
  ...
  nand3  g10(.a(x10), .b(x08), .c(x02), .O(new_n55_));
  inv1   g11(.a(new_n55_), .O(z03));
  nand3  g12(.a(x10), .b(x08), .c(x03), .O(new_n57_));
  ...
  oai21  g22(.a(new_n47_), .b(x00), .c(x08), .O(new_n67_));
  nand2  g23(.a(new_n47_), .b(x09), .O(new_n68_));
  ...
  oai21  g29(.a(new_n47_), .b(x01), .c(x08), .O(new_n74_));
  and2   g30(.a(x20), .b(x19), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(new_n76_));
  nand3  g32(.a(x22), .b(x21), .c(x12), .O(new_n77_));
  nor2   g33(.a(new_n77_), .b(new_n45_), .O(new_n78_));
  nor2   g34(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  oai21  g35(.a(x20), .b(x19), .c(new_n69_), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(z10));
  ...
  oai21  g42(.a(new_n75_), .b(x21), .c(new_n86_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n85_), .c(new_n55_), .O(z11));
  aoi21  g44(.a(new_n82_), .b(x14), .c(new_n49_), .O(new_n89_));
  inv1   g45(.a(new_n83_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(x22), .c(new_n86_), .O(new_n91_));
  ...
  oai21  g52(.a(new_n96_), .b(new_n94_), .c(new_n86_), .O(new_n97_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n68_), .c(new_n61_), .O(z14));
