...
module FAU ( 
  ...
  nor2   g01(.a(new_n45_), .b(x06), .O(new_n46_));
  ...
  oai21  g15(.a(new_n48_), .b(new_n59_), .c(new_n47_), .O(z02));
  ...
  aoi21  g31(.a(x08), .b(x00), .c(new_n46_), .O(new_n76_));
  ...
  oai22  g45(.a(new_n89_), .b(new_n88_), .c(new_n57_), .d(new_n61_), .O(z11));
  aoi21  g46(.a(new_n85_), .b(x14), .c(new_n52_), .O(new_n91_));
  inv1   g47(.a(new_n86_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x22), .c(new_n50_), .O(new_n93_));
  oai22  g49(.a(new_n93_), .b(new_n91_), .c(new_n57_), .d(new_n63_), .O(z12));
  inv1   g50(.a(x15), .O(new_n95_));
  nor2   g51(.a(new_n51_), .b(new_n95_), .O(new_n96_));
  inv1   g52(.a(x23), .O(new_n97_));
  xor2a  g53(.a(new_n52_), .b(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n50_), .O(new_n99_));
  oai21  g55(.a(new_n57_), .b(new_n65_), .c(new_n99_), .O(z13));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  and2   g58(.a(x22), .b(x21), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n78_), .c(x24), .d(x23), .O(new_n104_));
  inv1   g60(.a(x24), .O(new_n105_));
  oai21  g61(.a(new_n52_), .b(new_n97_), .c(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  nand3  g63(.a(new_n47_), .b(x08), .c(x05), .O(new_n108_));
  oai21  g64(.a(new_n107_), .b(new_n49_), .c(new_n108_), .O(z14));
  nor2   g65(.a(new_n52_), .b(new_n97_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(x24), .c(x25), .O(new_n111_));
  and2   g67(.a(x26), .b(x17), .O(new_n112_));
  and2   g68(.a(x25), .b(x24), .O(new_n113_));
  nand4  g69(.a(new_n103_), .b(new_n78_), .c(new_n113_), .d(x23), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n112_), .c(new_n50_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n111_), .c(new_n69_), .O(z15));
  ...
  nand3  g77(.a(new_n121_), .b(new_n71_), .c(new_n47_), .O(z16));
endmodule
