...
module FAU ( 
  ...
  oai21  g36(.a(new_n80_), .b(new_n77_), .c(new_n72_), .O(z10));
  ...
  nand2  g51(.a(new_n83_), .b(new_n46_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(x22), .c(new_n95_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n94_), .c(new_n79_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n59_), .O(z13));
  oai21  g55(.a(new_n47_), .b(x05), .c(x08), .O(new_n100_));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  and2   g58(.a(x22), .b(x21), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n73_), .c(x24), .d(x23), .O(new_n104_));
  inv1   g60(.a(x24), .O(new_n105_));
  oai21  g61(.a(new_n49_), .b(new_n95_), .c(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n78_), .c(new_n100_), .O(z14));
  oai21  g64(.a(new_n47_), .b(x06), .c(x08), .O(new_n109_));
  inv1   g65(.a(x25), .O(new_n110_));
  nor2   g66(.a(new_n110_), .b(new_n105_), .O(new_n111_));
  nor2   g67(.a(new_n49_), .b(new_n95_), .O(new_n112_));
  nand2  g68(.a(x26), .b(x17), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  nand2  g70(.a(new_n104_), .b(new_n110_), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n109_), .O(z15));
  aoi21  g73(.a(new_n112_), .b(new_n111_), .c(x26), .O(new_n118_));
  nor2   g74(.a(new_n49_), .b(x18), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n82_), .O(new_n120_));
