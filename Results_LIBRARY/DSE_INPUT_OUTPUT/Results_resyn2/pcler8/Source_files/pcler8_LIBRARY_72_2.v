...
module FAU ( 
  ...
  nand2  g01(.a(new_n45_), .b(x04), .O(new_n46_));
  ...
  nand3  g23(.a(x17), .b(x08), .c(x04), .O(new_n68_));
  ...
  oai21  g39(.a(new_n83_), .b(new_n55_), .c(new_n76_), .O(z09));
  ...
  and2   g44(.a(new_n62_), .b(new_n46_), .O(new_n89_));
  ...
  and2   g50(.a(new_n64_), .b(new_n46_), .O(new_n95_));
  oai21  g51(.a(new_n94_), .b(new_n93_), .c(new_n95_), .O(z11));
  nand3  g52(.a(new_n85_), .b(x22), .c(x21), .O(new_n97_));
  aoi21  g53(.a(new_n80_), .b(x14), .c(new_n97_), .O(new_n98_));
  inv1   g54(.a(new_n91_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(x22), .c(new_n56_), .O(new_n100_));
  and2   g56(.a(new_n66_), .b(new_n46_), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(z12));
  oai21  g58(.a(new_n45_), .b(x08), .c(x04), .O(new_n103_));
  nand3  g59(.a(new_n52_), .b(x24), .c(x15), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n49_), .O(new_n105_));
  aoi21  g61(.a(new_n48_), .b(new_n47_), .c(new_n55_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n103_), .O(z13));
  ...
  nand2  g72(.a(new_n56_), .b(new_n46_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n116_), .c(new_n70_), .O(z14));
  nand2  g74(.a(x24), .b(x23), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n48_), .c(new_n50_), .O(new_n120_));
  nand4  g76(.a(new_n114_), .b(new_n78_), .c(new_n85_), .d(x25), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n120_), .c(new_n56_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n72_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n46_), .O(new_n124_));
  nand3  g80(.a(new_n56_), .b(new_n52_), .c(x17), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n124_), .O(z15));
  nor2   g82(.a(new_n51_), .b(x18), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n114_), .c(new_n113_), .d(x25), .O(new_n128_));
  nand2  g84(.a(new_n121_), .b(new_n51_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n128_), .c(new_n56_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n74_), .c(new_n46_), .O(z16));
endmodule
