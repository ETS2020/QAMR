...
module FAU ( 
  ...
  aoi21  g28(.a(new_n72_), .b(new_n52_), .c(x10), .O(z09));
  oai21  g29(.a(x10), .b(x01), .c(x08), .O(new_n74_));
  and2   g30(.a(x20), .b(x19), .O(new_n75_));
  inv1   g31(.a(new_n45_), .O(new_n76_));
  nand3  g32(.a(new_n69_), .b(new_n76_), .c(x12), .O(new_n77_));
  and2   g33(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  inv1   g34(.a(new_n49_), .O(new_n79_));
  oai21  g35(.a(x20), .b(x19), .c(new_n79_), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n78_), .c(new_n74_), .O(z10));
  nand2  g37(.a(new_n75_), .b(x21), .O(new_n82_));
  and2   g38(.a(x22), .b(x13), .O(new_n83_));
  aoi21  g39(.a(new_n83_), .b(new_n76_), .c(new_n82_), .O(new_n84_));
  oai21  g40(.a(new_n75_), .b(x21), .c(new_n79_), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n84_), .c(new_n56_), .O(z11));
  nand2  g42(.a(x08), .b(x03), .O(new_n87_));
  inv1   g43(.a(x14), .O(new_n88_));
  inv1   g44(.a(new_n50_), .O(new_n89_));
  oai21  g45(.a(new_n45_), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  inv1   g46(.a(x22), .O(new_n91_));
  nand2  g47(.a(new_n82_), .b(new_n91_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n90_), .c(new_n48_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n87_), .c(x10), .O(z12));
  inv1   g50(.a(x23), .O(new_n95_));
  xor2a  g51(.a(new_n50_), .b(new_n95_), .O(new_n96_));
  aoi21  g52(.a(new_n76_), .b(x15), .c(new_n96_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n49_), .c(new_n61_), .O(z13));
  oai21  g54(.a(x10), .b(x05), .c(x08), .O(new_n99_));
  nand4  g55(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n100_));
  inv1   g56(.a(new_n100_), .O(new_n101_));
  nand4  g57(.a(new_n69_), .b(new_n75_), .c(x24), .d(x23), .O(new_n102_));
  inv1   g58(.a(x24), .O(new_n103_));
  oai21  g59(.a(new_n50_), .b(new_n95_), .c(new_n103_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n49_), .c(new_n99_), .O(z14));
  oai21  g62(.a(x10), .b(x06), .c(x08), .O(new_n107_));
  nand3  g63(.a(x26), .b(x25), .c(x17), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand4  g65(.a(new_n89_), .b(x25), .c(x24), .d(x23), .O(new_n110_));
  inv1   g66(.a(x25), .O(new_n111_));
  nand2  g67(.a(new_n102_), .b(new_n111_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n49_), .c(new_n107_), .O(z15));
  inv1   g70(.a(x26), .O(new_n115_));
  nand2  g71(.a(new_n110_), .b(new_n115_), .O(new_n116_));
  inv1   g72(.a(x18), .O(new_n117_));
  nand3  g73(.a(new_n89_), .b(new_n76_), .c(new_n117_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n48_), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(new_n67_), .c(x10), .O(z16));
endmodule
