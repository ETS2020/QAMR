...
module FAU ( 
  ...
  aoi21  g45(.a(new_n89_), .b(new_n78_), .c(new_n88_), .O(new_n90_));
  oai21  g46(.a(new_n77_), .b(x21), .c(new_n50_), .O(new_n91_));
  oai22  g47(.a(new_n91_), .b(new_n90_), .c(new_n59_), .d(new_n61_), .O(z11));
  ...
  aoi21  g51(.a(x08), .b(x03), .c(new_n85_), .O(new_n96_));
  ...
  nand3  g65(.a(new_n46_), .b(x08), .c(x05), .O(new_n110_));
  ...
  nand3  g80(.a(new_n124_), .b(new_n71_), .c(new_n46_), .O(z16));
endmodule
