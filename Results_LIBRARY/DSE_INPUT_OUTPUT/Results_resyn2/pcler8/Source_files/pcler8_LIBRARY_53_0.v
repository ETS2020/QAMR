...
module FAU ( 
  ...
  nand2  g30(.a(new_n56_), .b(new_n46_), .O(new_n75_));
  ...
  oai22  g37(.a(new_n81_), .b(new_n75_), .c(new_n59_), .d(new_n45_), .O(z09));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n61_), .c(new_n45_), .O(z10));
  ...
  or2    g49(.a(new_n83_), .b(x21), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n93_), .c(new_n56_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n63_), .c(new_n45_), .O(z11));
  inv1   g52(.a(new_n78_), .O(new_n97_));
  nand2  g53(.a(new_n91_), .b(x22), .O(new_n98_));
  aoi21  g54(.a(new_n97_), .b(x14), .c(new_n98_), .O(new_n99_));
  oai21  g55(.a(new_n91_), .b(x22), .c(new_n56_), .O(new_n100_));
  aoi21  g56(.a(x08), .b(x03), .c(new_n45_), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n99_), .c(new_n101_), .O(z12));
  inv1   g58(.a(x23), .O(new_n103_));
  nand2  g59(.a(new_n47_), .b(new_n103_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n56_), .c(new_n49_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n67_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n46_), .O(new_n107_));
  nand3  g63(.a(new_n97_), .b(new_n56_), .c(x15), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(z13));
  nand3  g65(.a(new_n52_), .b(x24), .c(x16), .O(new_n110_));
  inv1   g66(.a(x24), .O(new_n111_));
  oai21  g67(.a(new_n47_), .b(new_n103_), .c(new_n111_), .O(new_n112_));
  and2   g68(.a(x22), .b(x21), .O(new_n113_));
  and2   g69(.a(x24), .b(x23), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n83_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n110_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n56_), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n69_), .c(new_n45_), .O(z14));
  nand3  g75(.a(new_n114_), .b(new_n48_), .c(x25), .O(new_n120_));
  aoi21  g76(.a(new_n115_), .b(new_n50_), .c(new_n75_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g78(.a(new_n52_), .b(x17), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n56_), .c(z07), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n122_), .O(z15));
  nor2   g82(.a(new_n51_), .b(x18), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n114_), .c(new_n48_), .d(x25), .O(new_n128_));
  nand2  g84(.a(new_n120_), .b(new_n51_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n128_), .c(new_n56_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n73_), .c(new_n45_), .O(z16));
endmodule
