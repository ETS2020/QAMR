...
module FAU ( 
  ...
  nand2  g08(.a(new_n52_), .b(x04), .O(new_n53_));
  nand4  g09(.a(new_n53_), .b(new_n51_), .c(new_n48_), .d(x19), .O(new_n54_));
  ...
  nand2  g16(.a(new_n60_), .b(new_n53_), .O(z03));
  inv1   g17(.a(new_n53_), .O(new_n62_));
  nand2  g18(.a(x08), .b(x03), .O(new_n63_));
  nor2   g19(.a(new_n63_), .b(new_n62_), .O(z04));
  oai21  g20(.a(new_n52_), .b(x08), .c(x04), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z05));
  nand2  g22(.a(x08), .b(x05), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n53_), .O(z06));
  nand2  g24(.a(x08), .b(x06), .O(new_n69_));
  nor2   g25(.a(new_n69_), .b(new_n62_), .O(z07));
  nand2  g26(.a(x08), .b(x07), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n62_), .O(z08));
  nand3  g28(.a(new_n51_), .b(new_n48_), .c(x11), .O(new_n73_));
  inv1   g29(.a(x19), .O(new_n74_));
  nand3  g30(.a(new_n53_), .b(new_n48_), .c(new_n74_), .O(new_n75_));
  nand3  g31(.a(new_n75_), .b(new_n73_), .c(new_n56_), .O(z09));
  ...
  aoi21  g38(.a(new_n82_), .b(new_n58_), .c(new_n62_), .O(z10));
  ...
  nand3  g53(.a(new_n97_), .b(new_n53_), .c(new_n48_), .O(new_n98_));
  oai22  g54(.a(new_n98_), .b(new_n94_), .c(new_n63_), .d(new_n62_), .O(z12));
  ...
  and2   g79(.a(new_n69_), .b(new_n53_), .O(new_n124_));
  ...
  and2   g86(.a(new_n71_), .b(new_n53_), .O(new_n131_));
