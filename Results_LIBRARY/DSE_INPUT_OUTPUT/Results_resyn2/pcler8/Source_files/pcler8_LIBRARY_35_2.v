...
module FAU ( 
  ...
  aoi21  g23(.a(x10), .b(new_n67_), .c(new_n45_), .O(z08));
  ...
  oai22  g46(.a(new_n90_), .b(new_n89_), .c(new_n77_), .d(new_n57_), .O(z11));
  aoi21  g47(.a(new_n86_), .b(x14), .c(new_n49_), .O(new_n92_));
  inv1   g48(.a(x22), .O(new_n93_));
  nand2  g49(.a(new_n87_), .b(new_n93_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n71_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n92_), .c(new_n59_), .O(z12));
  ...
  nand2  g64(.a(new_n76_), .b(x05), .O(new_n109_));
  oai21  g65(.a(new_n108_), .b(new_n70_), .c(new_n109_), .O(z14));
  nand2  g66(.a(x26), .b(x17), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n50_), .c(x25), .d(x24), .O(new_n112_));
  inv1   g68(.a(x25), .O(new_n113_));
  nand2  g69(.a(new_n105_), .b(new_n113_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n112_), .c(new_n71_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n65_), .O(z15));
  nand2  g72(.a(new_n76_), .b(x07), .O(new_n117_));
  inv1   g73(.a(x26), .O(new_n118_));
  nand4  g74(.a(new_n104_), .b(x25), .c(x24), .d(x23), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  inv1   g76(.a(x18), .O(new_n121_));
  nand3  g77(.a(new_n50_), .b(new_n47_), .c(new_n121_), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n120_), .c(new_n71_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n117_), .O(z16));
endmodule
