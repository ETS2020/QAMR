...
module FAU ( 
  ...
  oai21  g23(.a(x17), .b(x08), .c(x05), .O(new_n68_));
  ...
  and2   g43(.a(new_n59_), .b(new_n45_), .O(new_n88_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n94_), .c(new_n52_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n61_), .c(new_n56_), .O(z11));
  inv1   g53(.a(new_n78_), .O(new_n98_));
  nand2  g54(.a(new_n91_), .b(x22), .O(new_n99_));
  aoi21  g55(.a(new_n98_), .b(x14), .c(new_n99_), .O(new_n100_));
  oai21  g56(.a(new_n91_), .b(x22), .c(new_n86_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n64_), .O(z12));
  inv1   g58(.a(x15), .O(new_n103_));
  nor2   g59(.a(new_n78_), .b(new_n103_), .O(new_n104_));
  inv1   g60(.a(x23), .O(new_n105_));
  xor2a  g61(.a(new_n46_), .b(new_n105_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n104_), .c(new_n86_), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n66_), .c(new_n56_), .O(z13));
  inv1   g64(.a(x24), .O(new_n109_));
  inv1   g65(.a(new_n46_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n109_), .c(x23), .O(new_n111_));
  inv1   g67(.a(new_n49_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(x24), .c(x16), .O(new_n113_));
  oai21  g69(.a(new_n46_), .b(new_n105_), .c(x24), .O(new_n114_));
  ...
  aoi21  g77(.a(new_n53_), .b(x17), .c(new_n70_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n121_), .c(new_n56_), .O(z15));
  aoi21  g79(.a(new_n48_), .b(x25), .c(x26), .O(new_n124_));
  nand2  g80(.a(new_n110_), .b(x23), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(new_n112_), .b(x24), .c(new_n126_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n125_), .c(new_n86_), .O(new_n128_));
