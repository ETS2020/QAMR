...
module FAU ( 
  ...
  oai21  g37(.a(new_n54_), .b(new_n56_), .c(new_n81_), .O(z10));
  ...
  aoi21  g49(.a(x08), .b(x03), .c(new_n88_), .O(new_n94_));
  ...
  nand3  g55(.a(new_n99_), .b(new_n62_), .c(new_n53_), .O(z13));
  ...
  aoi21  g75(.a(new_n112_), .b(new_n111_), .c(x26), .O(new_n120_));
  nor2   g76(.a(new_n49_), .b(x18), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n83_), .O(new_n122_));
