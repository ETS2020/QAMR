// Benchmark "FAU" written by ABC on Tue Aug 11 20:10:12 2020
...
module FAU ( 
  ...
  nand2  g08(.a(x10), .b(x00), .O(new_n53_));
  nand2  g09(.a(x08), .b(x01), .O(new_n54_));
  nand2  g10(.a(new_n54_), .b(new_n53_), .O(z02));
  nand2  g11(.a(x08), .b(x02), .O(new_n56_));
  nand2  g12(.a(new_n56_), .b(new_n53_), .O(z03));
  nand2  g13(.a(x08), .b(x03), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(new_n53_), .O(z04));
  nand2  g15(.a(x08), .b(x04), .O(new_n60_));
  nand2  g16(.a(new_n60_), .b(new_n53_), .O(z05));
  nand2  g17(.a(x08), .b(x05), .O(new_n62_));
  nand2  g18(.a(new_n62_), .b(new_n53_), .O(z06));
  nand2  g19(.a(x08), .b(x06), .O(new_n64_));
  nand2  g20(.a(new_n64_), .b(new_n53_), .O(z07));
  nand2  g21(.a(x08), .b(x07), .O(new_n66_));
  aoi21  g22(.a(x10), .b(x00), .c(new_n66_), .O(z08));
  nand4  g23(.a(x22), .b(x21), .c(x20), .d(x11), .O(new_n68_));
  oai21  g24(.a(new_n68_), .b(new_n45_), .c(x19), .O(new_n69_));
  nand3  g25(.a(new_n69_), .b(x09), .c(new_n46_), .O(new_n70_));
  aoi21  g26(.a(new_n70_), .b(new_n51_), .c(x10), .O(z09));
  ...
  nand3  g35(.a(new_n53_), .b(x08), .c(x01), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n79_), .O(z10));
  inv1   g37(.a(z03), .O(new_n82_));
  nand3  g38(.a(x21), .b(x20), .c(x19), .O(new_n83_));
  and2   g39(.a(x22), .b(x13), .O(new_n84_));
  aoi21  g40(.a(new_n84_), .b(new_n73_), .c(new_n83_), .O(new_n85_));
  inv1   g41(.a(new_n48_), .O(new_n86_));
  oai21  g42(.a(new_n72_), .b(x21), .c(new_n86_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(z11));
  inv1   g44(.a(z04), .O(new_n89_));
  aoi21  g45(.a(new_n73_), .b(x14), .c(new_n49_), .O(new_n90_));
  inv1   g46(.a(new_n83_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x22), .c(new_n86_), .O(new_n92_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(new_n86_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n60_), .c(new_n53_), .O(z13));
  inv1   g55(.a(z06), .O(new_n100_));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand4  g58(.a(new_n74_), .b(new_n72_), .c(x24), .d(x23), .O(new_n103_));
  ...
  oai21  g62(.a(new_n106_), .b(new_n48_), .c(new_n100_), .O(z14));
  inv1   g63(.a(x25), .O(new_n108_));
  nor2   g64(.a(new_n108_), .b(new_n104_), .O(new_n109_));
  nor2   g65(.a(new_n49_), .b(new_n96_), .O(new_n110_));
  ...
  nand3  g70(.a(new_n53_), .b(x08), .c(x06), .O(new_n115_));
  ...
  nand2  g74(.a(new_n118_), .b(new_n73_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n86_), .O(new_n120_));
  and2   g76(.a(new_n66_), .b(new_n53_), .O(new_n121_));
  oai21  g77(.a(new_n120_), .b(new_n117_), .c(new_n121_), .O(z16));
endmodule
