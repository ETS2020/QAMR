...
module FAU ( 
  ...
  nor2   g03(.a(x17), .b(x06), .O(new_n48_));
  ...
  nor2   g13(.a(new_n57_), .b(new_n48_), .O(z02));
  nand3  g14(.a(new_n54_), .b(x08), .c(x02), .O(new_n59_));
  inv1   g15(.a(new_n59_), .O(z03));
  nand2  g16(.a(x08), .b(x03), .O(new_n61_));
  nand2  g17(.a(new_n61_), .b(new_n54_), .O(z04));
  nand3  g18(.a(new_n54_), .b(x08), .c(x04), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z05));
  nand3  g20(.a(new_n54_), .b(x08), .c(x05), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z06));
  and2   g22(.a(x08), .b(x06), .O(z07));
  nand3  g23(.a(new_n54_), .b(x08), .c(x07), .O(new_n68_));
  ...
  nand3  g38(.a(new_n82_), .b(new_n57_), .c(new_n54_), .O(z10));
  ...
  nand3  g49(.a(new_n93_), .b(new_n91_), .c(new_n70_), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n61_), .c(new_n48_), .O(z12));
  ...
  oai21  g55(.a(new_n99_), .b(new_n97_), .c(new_n49_), .O(new_n100_));
  ...
  nand4  g66(.a(new_n90_), .b(x25), .c(x24), .d(x23), .O(new_n111_));
  ...
  nor2   g70(.a(z07), .b(new_n48_), .O(new_n115_));
  oai21  g71(.a(new_n114_), .b(new_n47_), .c(new_n115_), .O(z15));
  inv1   g72(.a(x26), .O(new_n117_));
  nand2  g73(.a(new_n111_), .b(new_n117_), .O(new_n118_));
  inv1   g74(.a(x18), .O(new_n119_));
  nand3  g75(.a(new_n90_), .b(new_n77_), .c(new_n119_), .O(new_n120_));
