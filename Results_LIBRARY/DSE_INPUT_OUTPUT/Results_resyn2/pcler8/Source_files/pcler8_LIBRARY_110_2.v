...
module FAU ( 
  ...
  nor2   g47(.a(new_n55_), .b(new_n45_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x03), .O(new_n93_));
  aoi21  g49(.a(new_n78_), .b(x14), .c(new_n49_), .O(new_n94_));
  ...
  nand2  g54(.a(new_n92_), .b(x04), .O(new_n99_));
  ...
  nand2  g59(.a(new_n103_), .b(new_n99_), .O(z13));
  ...
  nand2  g67(.a(new_n92_), .b(x05), .O(new_n112_));
  oai21  g68(.a(new_n111_), .b(new_n70_), .c(new_n112_), .O(z14));
  nand2  g69(.a(new_n92_), .b(x06), .O(new_n114_));
  ...
  nand2  g76(.a(new_n92_), .b(x07), .O(new_n121_));
