...
module FAU ( 
  ...
  nor2   g10(.a(x10), .b(new_n51_), .O(new_n56_));
  nand2  g11(.a(x08), .b(x03), .O(new_n57_));
  nor2   g12(.a(new_n57_), .b(new_n56_), .O(z04));
  nand2  g13(.a(x08), .b(x04), .O(new_n59_));
  nand2  g14(.a(new_n59_), .b(new_n47_), .O(z05));
  nand2  g15(.a(x08), .b(x05), .O(new_n61_));
  nor2   g16(.a(new_n61_), .b(new_n56_), .O(z06));
  inv1   g17(.a(x06), .O(new_n63_));
  nor2   g18(.a(new_n52_), .b(new_n63_), .O(z07));
  nand2  g19(.a(x08), .b(x07), .O(new_n65_));
  nand2  g20(.a(new_n65_), .b(new_n47_), .O(z08));
  nor2   g21(.a(new_n48_), .b(new_n56_), .O(z09));
  nand2  g22(.a(new_n57_), .b(new_n47_), .O(z12));
  nand2  g23(.a(new_n61_), .b(new_n47_), .O(z14));
  zero   g24(.O(z00));
  nor2   g25(.a(new_n52_), .b(new_n50_), .O(z10));
  nor2   g26(.a(new_n52_), .b(new_n54_), .O(z11));
  nand2  g27(.a(new_n59_), .b(new_n47_), .O(z13));
  nor2   g28(.a(new_n52_), .b(new_n63_), .O(z15));
  nand2  g29(.a(new_n65_), .b(new_n47_), .O(z16));
endmodule
