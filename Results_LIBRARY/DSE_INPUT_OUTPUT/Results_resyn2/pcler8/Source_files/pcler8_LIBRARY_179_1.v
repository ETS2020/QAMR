...
module FAU ( 
  ...
  nor2   g23(.a(new_n51_), .b(new_n45_), .O(z06));
  inv1   g24(.a(x06), .O(new_n69_));
  oai21  g25(.a(new_n51_), .b(new_n69_), .c(new_n46_), .O(z07));
  ...
  and2   g34(.a(new_n58_), .b(new_n46_), .O(new_n79_));
  ...
  and2   g39(.a(x24), .b(x23), .O(new_n84_));
  and2   g40(.a(x26), .b(x25), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(x12), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n82_), .O(new_n87_));
  aoi21  g43(.a(new_n81_), .b(new_n73_), .c(new_n53_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n60_), .c(new_n57_), .O(z10));
  ...
  inv1   g51(.a(new_n53_), .O(new_n96_));
  oai21  g52(.a(new_n82_), .b(x21), .c(new_n96_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(new_n91_), .O(z11));
  inv1   g54(.a(z04), .O(new_n99_));
  inv1   g55(.a(new_n93_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(x22), .O(new_n101_));
  aoi21  g57(.a(new_n92_), .b(x14), .c(new_n101_), .O(new_n102_));
  oai21  g58(.a(new_n100_), .b(x22), .c(new_n96_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n102_), .c(new_n99_), .O(z12));
  inv1   g60(.a(new_n47_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(x23), .O(new_n106_));
  inv1   g62(.a(x23), .O(new_n107_));
  nand2  g63(.a(new_n47_), .b(new_n107_), .O(new_n108_));
  aoi22  g64(.a(new_n108_), .b(new_n106_), .c(new_n92_), .d(x15), .O(new_n109_));
  nand2  g65(.a(new_n96_), .b(new_n46_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n109_), .c(new_n66_), .O(z13));
  nor2   g67(.a(new_n47_), .b(new_n107_), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(x24), .O(new_n113_));
  nand2  g69(.a(new_n85_), .b(x16), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n112_), .c(x24), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n96_), .O(new_n116_));
  nor2   g72(.a(z06), .b(new_n57_), .O(new_n117_));
  oai21  g73(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(z14));
  nand2  g74(.a(new_n49_), .b(x25), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  oai21  g76(.a(new_n48_), .b(new_n47_), .c(new_n120_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n119_), .c(new_n96_), .O(new_n122_));
  nor2   g78(.a(new_n51_), .b(new_n69_), .O(new_n123_));
  aoi21  g79(.a(new_n54_), .b(x17), .c(new_n123_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n122_), .c(new_n57_), .O(z15));
  aoi21  g81(.a(new_n49_), .b(x25), .c(x26), .O(new_n126_));
  inv1   g82(.a(x18), .O(new_n127_));
  nand4  g83(.a(new_n112_), .b(new_n85_), .c(x24), .d(new_n127_), .O(new_n128_));
  nand3  g84(.a(new_n128_), .b(new_n96_), .c(new_n46_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n126_), .c(new_n71_), .O(z16));
endmodule
