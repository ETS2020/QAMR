...
module FAU ( 
  ...
  oai21  g13(.a(new_n48_), .b(new_n57_), .c(new_n54_), .O(z02));
  ...
  nand2  g25(.a(new_n63_), .b(x07), .O(new_n70_));
  ...
  nand3  g33(.a(new_n77_), .b(new_n76_), .c(new_n54_), .O(z09));
  ...
  aoi21  g50(.a(new_n86_), .b(x14), .c(new_n94_), .O(new_n95_));
  oai21  g51(.a(new_n93_), .b(x22), .c(new_n72_), .O(new_n96_));
  ...
  nand4  g83(.a(new_n127_), .b(new_n86_), .c(x19), .d(new_n125_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n124_), .c(new_n70_), .O(z16));
endmodule
