...
module FAU ( 
  ...
  oai22  g39(.a(new_n83_), .b(new_n82_), .c(new_n77_), .d(new_n55_), .O(z10));
  oai21  g40(.a(new_n63_), .b(x02), .c(x08), .O(new_n85_));
  nand2  g41(.a(new_n63_), .b(x09), .O(new_n86_));
  ...
  oai21  g47(.a(new_n91_), .b(new_n86_), .c(new_n85_), .O(z11));
  ...
  oai21  g53(.a(new_n97_), .b(new_n93_), .c(new_n59_), .O(z12));
  ...
  oai21  g58(.a(new_n77_), .b(new_n61_), .c(new_n102_), .O(z13));
  ...
  oai21  g66(.a(new_n110_), .b(new_n86_), .c(new_n64_), .O(z14));
  oai21  g67(.a(new_n63_), .b(x06), .c(x08), .O(new_n112_));
  inv1   g68(.a(new_n86_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n112_), .O(z15));
  oai21  g75(.a(new_n63_), .b(x07), .c(x08), .O(new_n120_));
  ...
  nand3  g81(.a(new_n125_), .b(new_n123_), .c(new_n113_), .O(new_n126_));
