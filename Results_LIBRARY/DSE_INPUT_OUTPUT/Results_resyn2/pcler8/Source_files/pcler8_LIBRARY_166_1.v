...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_,
    new_n53_, new_n56_, new_n57_, new_n60_, new_n62_, new_n64_, new_n66_,
  ...
  oai21  g46(.a(new_n90_), .b(new_n87_), .c(new_n57_), .O(z11));
  ...
  nand3  g55(.a(new_n99_), .b(new_n98_), .c(new_n69_), .O(new_n100_));
  ...
  oai21  g63(.a(new_n107_), .b(new_n88_), .c(new_n62_), .O(z14));
  ...
  oai21  g70(.a(new_n114_), .b(new_n88_), .c(new_n64_), .O(z15));
