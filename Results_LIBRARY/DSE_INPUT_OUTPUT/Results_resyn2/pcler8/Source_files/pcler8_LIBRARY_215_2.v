...
module FAU ( 
  ...
  oai21  g25(.a(new_n57_), .b(x00), .c(x08), .O(new_n70_));
  ...
  oai21  g33(.a(new_n57_), .b(x01), .c(x08), .O(new_n78_));
  ...
  aoi21  g48(.a(new_n80_), .b(x14), .c(new_n49_), .O(new_n93_));
  inv1   g49(.a(x22), .O(new_n94_));
  nand2  g50(.a(new_n87_), .b(new_n94_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n72_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n93_), .c(new_n92_), .O(z12));
  oai21  g53(.a(new_n57_), .b(x04), .c(x08), .O(new_n98_));
  inv1   g54(.a(x15), .O(new_n99_));
  nor2   g55(.a(new_n73_), .b(new_n99_), .O(new_n100_));
  xor2a  g56(.a(new_n49_), .b(new_n48_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n72_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n98_), .O(z13));
  inv1   g59(.a(new_n72_), .O(new_n104_));
  oai21  g60(.a(new_n57_), .b(x05), .c(x08), .O(new_n105_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n104_), .c(new_n105_), .O(z14));
  oai21  g69(.a(new_n57_), .b(x06), .c(x08), .O(new_n114_));
  ...
  nand2  g81(.a(new_n72_), .b(new_n45_), .O(new_n126_));
  inv1   g82(.a(new_n126_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n125_), .c(new_n123_), .O(new_n128_));
  nand3  g84(.a(x10), .b(x08), .c(x07), .O(new_n129_));
