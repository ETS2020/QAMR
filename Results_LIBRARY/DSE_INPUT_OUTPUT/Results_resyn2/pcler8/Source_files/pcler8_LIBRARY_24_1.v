...
module FAU ( 
  ...
  nand3  g35(.a(new_n79_), .b(new_n58_), .c(new_n47_), .O(z09));
  ...
  oai21  g42(.a(new_n68_), .b(new_n60_), .c(new_n86_), .O(z10));
  ...
  oai22  g48(.a(new_n92_), .b(new_n91_), .c(new_n68_), .d(new_n62_), .O(z11));
  ...
  nand2  g54(.a(new_n52_), .b(x15), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n50_), .O(new_n100_));
  aoi21  g56(.a(new_n49_), .b(new_n48_), .c(new_n54_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  aoi21  g58(.a(x08), .b(x04), .c(new_n46_), .O(new_n103_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n54_), .c(new_n70_), .O(z14));
  nand3  g69(.a(x26), .b(x25), .c(x17), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  and2   g71(.a(x22), .b(x21), .O(new_n116_));
  nand4  g72(.a(new_n110_), .b(new_n116_), .c(new_n81_), .d(x25), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand2  g74(.a(x24), .b(x23), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n49_), .c(new_n118_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n54_), .c(new_n72_), .O(z15));
  nor2   g78(.a(new_n119_), .b(new_n49_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(x25), .c(x26), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n88_), .b(new_n109_), .c(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n55_), .O(new_n127_));
  aoi21  g83(.a(x08), .b(x07), .c(new_n46_), .O(new_n128_));
