...
module FAU ( 
  ...
  nand2  g12(.a(new_n56_), .b(new_n51_), .O(z02));
  nand2  g13(.a(x08), .b(x02), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(new_n51_), .O(z03));
  nand2  g15(.a(new_n53_), .b(x03), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(z04));
  nand2  g17(.a(new_n53_), .b(x04), .O(new_n62_));
  inv1   g18(.a(new_n62_), .O(z05));
  nand2  g19(.a(new_n53_), .b(x05), .O(new_n64_));
  ...
  nand3  g29(.a(new_n73_), .b(new_n54_), .c(new_n51_), .O(z09));
  ...
  nand3  g36(.a(new_n80_), .b(new_n56_), .c(new_n51_), .O(z10));
  ...
  nand2  g42(.a(new_n53_), .b(x02), .O(new_n87_));
  oai21  g43(.a(new_n86_), .b(new_n85_), .c(new_n87_), .O(z11));
  aoi21  g44(.a(new_n82_), .b(x14), .c(new_n49_), .O(new_n89_));
  inv1   g45(.a(new_n83_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(x22), .c(new_n70_), .O(new_n91_));
  aoi21  g47(.a(x08), .b(x03), .c(new_n52_), .O(new_n92_));
  oai21  g48(.a(new_n91_), .b(new_n89_), .c(new_n92_), .O(z12));
  ...
  aoi21  g54(.a(x08), .b(x04), .c(new_n52_), .O(new_n99_));
  ...
  nand4  g59(.a(new_n103_), .b(new_n75_), .c(x24), .d(x23), .O(new_n104_));
  ...
  aoi21  g63(.a(x08), .b(x05), .c(new_n52_), .O(new_n108_));
  oai21  g64(.a(new_n107_), .b(new_n48_), .c(new_n108_), .O(z14));
  inv1   g65(.a(z07), .O(new_n110_));
  nor2   g66(.a(new_n49_), .b(new_n96_), .O(new_n111_));
  ...
  nand2  g71(.a(new_n115_), .b(new_n70_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n112_), .c(new_n110_), .O(z15));
  oai21  g73(.a(x10), .b(x08), .c(x07), .O(new_n118_));
  aoi21  g74(.a(new_n111_), .b(new_n113_), .c(x26), .O(new_n119_));
  nor2   g75(.a(new_n49_), .b(x18), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n82_), .O(new_n121_));
