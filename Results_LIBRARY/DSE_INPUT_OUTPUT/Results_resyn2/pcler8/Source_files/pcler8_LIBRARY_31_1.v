...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n55_, new_n57_, new_n59_, new_n61_, new_n64_,
  ...
  nand2  g19(.a(x10), .b(new_n55_), .O(new_n64_));
  nand2  g20(.a(x08), .b(x05), .O(new_n65_));
  nand2  g21(.a(new_n65_), .b(new_n64_), .O(z06));
  and2   g22(.a(x08), .b(x06), .O(z07));
  nand2  g23(.a(x08), .b(x07), .O(new_n68_));
  nand2  g24(.a(new_n68_), .b(new_n64_), .O(z08));
  nand3  g25(.a(new_n45_), .b(x09), .c(new_n55_), .O(new_n70_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n54_), .c(new_n75_), .O(z09));
  ...
  nor2   g36(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  oai21  g38(.a(new_n55_), .b(new_n57_), .c(new_n82_), .O(z10));
  inv1   g39(.a(new_n72_), .O(new_n84_));
  ...
  oai21  g43(.a(new_n77_), .b(x21), .c(new_n71_), .O(new_n88_));
  oai22  g44(.a(new_n88_), .b(new_n87_), .c(new_n55_), .d(new_n59_), .O(z11));
  aoi21  g45(.a(new_n84_), .b(x14), .c(new_n47_), .O(new_n90_));
  inv1   g46(.a(x22), .O(new_n91_));
  nand2  g47(.a(new_n85_), .b(new_n91_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n71_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n90_), .c(new_n61_), .O(z12));
  ...
  oai21  g55(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(new_n100_));
  inv1   g56(.a(new_n64_), .O(new_n101_));
  nor2   g57(.a(new_n101_), .b(z05), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n100_), .O(z13));
  ...
  oai21  g66(.a(new_n110_), .b(new_n95_), .c(new_n104_), .O(z14));
  ...
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n96_), .O(new_n115_));
  nor2   g71(.a(z07), .b(new_n101_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n115_), .O(z15));
  inv1   g73(.a(x26), .O(new_n118_));
  nand4  g74(.a(new_n107_), .b(x25), .c(x24), .d(x23), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nor2   g76(.a(new_n47_), .b(x18), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n84_), .c(new_n70_), .O(new_n122_));
