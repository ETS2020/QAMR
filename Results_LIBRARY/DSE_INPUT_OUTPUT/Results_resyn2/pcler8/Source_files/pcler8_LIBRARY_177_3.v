...
module FAU ( 
  ...
  nand2  g08(.a(x11), .b(x10), .O(new_n53_));
  oai21  g09(.a(new_n48_), .b(new_n52_), .c(new_n53_), .O(z01));
  nand2  g10(.a(x08), .b(x01), .O(new_n55_));
  nand2  g11(.a(new_n55_), .b(new_n53_), .O(z02));
  inv1   g12(.a(x02), .O(new_n57_));
  oai21  g13(.a(new_n48_), .b(new_n57_), .c(new_n53_), .O(z03));
  nand2  g14(.a(x08), .b(x03), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(new_n53_), .O(z04));
  nand2  g16(.a(new_n53_), .b(x08), .O(new_n61_));
  inv1   g17(.a(new_n61_), .O(new_n62_));
  nand2  g18(.a(new_n62_), .b(x04), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z05));
  nand2  g20(.a(new_n62_), .b(x05), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z06));
  nand2  g22(.a(new_n62_), .b(x06), .O(new_n67_));
  ...
  oai21  g31(.a(new_n61_), .b(new_n52_), .c(new_n75_), .O(z09));
  ...
  nand3  g38(.a(new_n82_), .b(new_n55_), .c(new_n53_), .O(z10));
  ...
  oai22  g44(.a(new_n88_), .b(new_n87_), .c(new_n61_), .d(new_n57_), .O(z11));
  ...
  oai21  g49(.a(new_n91_), .b(x22), .c(new_n71_), .O(new_n94_));
  ...
  nand2  g57(.a(new_n101_), .b(new_n63_), .O(z13));
  ...
  oai21  g65(.a(new_n109_), .b(new_n50_), .c(new_n65_), .O(z14));
  nand3  g66(.a(x26), .b(x25), .c(x17), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  and2   g68(.a(x22), .b(x21), .O(new_n113_));
  nand4  g69(.a(new_n107_), .b(new_n113_), .c(new_n77_), .d(x25), .O(new_n114_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n50_), .c(new_n67_), .O(z15));
  ...
  nand2  g81(.a(new_n125_), .b(new_n71_), .O(new_n126_));
  nand2  g82(.a(new_n62_), .b(x07), .O(new_n127_));
  oai21  g83(.a(new_n126_), .b(new_n121_), .c(new_n127_), .O(z16));
endmodule
