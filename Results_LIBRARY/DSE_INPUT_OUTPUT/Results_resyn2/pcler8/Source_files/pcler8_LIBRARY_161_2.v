...
module FAU ( 
  ...
  oai21  g12(.a(new_n47_), .b(new_n56_), .c(new_n46_), .O(z01));
  ...
  oai21  g32(.a(new_n59_), .b(new_n56_), .c(new_n76_), .O(z09));
  and2   g33(.a(x20), .b(x19), .O(new_n78_));
  and2   g34(.a(x22), .b(x21), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(new_n51_), .c(x12), .O(new_n80_));
  ...
  aoi21  g41(.a(x08), .b(x01), .c(new_n85_), .O(new_n86_));
  ...
  aoi21  g46(.a(new_n90_), .b(new_n51_), .c(new_n89_), .O(new_n91_));
  oai21  g47(.a(new_n78_), .b(x21), .c(new_n73_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(new_n88_), .O(z11));
  aoi21  g49(.a(new_n51_), .b(x14), .c(new_n52_), .O(new_n94_));
  inv1   g50(.a(new_n89_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(x22), .c(new_n73_), .O(new_n96_));
  aoi21  g52(.a(x08), .b(x03), .c(new_n85_), .O(new_n97_));
  ...
  aoi21  g59(.a(x08), .b(x04), .c(new_n85_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n79_), .b(new_n78_), .c(x24), .d(x23), .O(new_n109_));
  ...
  nor2   g71(.a(new_n52_), .b(new_n101_), .O(new_n116_));
  ...
  nand3  g76(.a(new_n46_), .b(x08), .c(x06), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n120_), .O(z15));
  aoi21  g78(.a(new_n116_), .b(new_n115_), .c(x26), .O(new_n123_));
  oai21  g79(.a(new_n54_), .b(x18), .c(new_n73_), .O(new_n124_));
  aoi21  g80(.a(x08), .b(x07), .c(new_n85_), .O(new_n125_));
