...
module FAU ( 
  ...
  oai21  g12(.a(new_n46_), .b(new_n56_), .c(new_n53_), .O(z02));
  ...
  oai21  g36(.a(new_n54_), .b(new_n56_), .c(new_n80_), .O(z10));
  ...
  oai22  g42(.a(new_n86_), .b(new_n85_), .c(new_n54_), .d(new_n58_), .O(z11));
  ...
  oai21  g54(.a(new_n54_), .b(new_n62_), .c(new_n98_), .O(z13));
  ...
  oai21  g63(.a(new_n107_), .b(new_n48_), .c(new_n100_), .O(z14));
  ...
  aoi21  g76(.a(x08), .b(x07), .c(new_n91_), .O(new_n121_));
