...
module FAU ( 
  ...
  nand2  g06(.a(x24), .b(x23), .O(new_n51_));
  ...
  nand2  g14(.a(new_n58_), .b(new_n45_), .O(z02));
  nand3  g15(.a(new_n45_), .b(x08), .c(x02), .O(new_n60_));
  ...
  inv1   g22(.a(x17), .O(new_n67_));
  aoi21  g23(.a(new_n67_), .b(new_n47_), .c(new_n66_), .O(z06));
  inv1   g24(.a(new_n45_), .O(new_n69_));
  nand2  g25(.a(x08), .b(x06), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n69_), .O(z07));
  nand3  g27(.a(new_n45_), .b(x08), .c(x07), .O(new_n72_));
  inv1   g28(.a(new_n72_), .O(z08));
  nand4  g29(.a(new_n45_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n74_));
  ...
  nand3  g43(.a(new_n87_), .b(new_n58_), .c(new_n45_), .O(z10));
  ...
  oai21  g48(.a(new_n83_), .b(x21), .c(new_n75_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n92_), .c(new_n60_), .O(z11));
  inv1   g50(.a(x14), .O(new_n95_));
  inv1   g51(.a(new_n52_), .O(new_n96_));
  oai21  g52(.a(new_n76_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g56(.a(new_n100_), .b(new_n62_), .c(new_n69_), .O(z12));
  inv1   g57(.a(new_n49_), .O(new_n102_));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n96_), .c(x23), .O(new_n104_));
  inv1   g60(.a(x23), .O(new_n105_));
  nand2  g61(.a(new_n52_), .b(new_n105_), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n64_), .c(new_n45_), .O(z13));
  inv1   g64(.a(new_n51_), .O(new_n109_));
  nand2  g65(.a(new_n96_), .b(new_n109_), .O(new_n110_));
  nand4  g66(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  inv1   g68(.a(x24), .O(new_n113_));
  oai21  g69(.a(new_n52_), .b(new_n105_), .c(new_n113_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n110_), .c(new_n112_), .O(new_n115_));
  nand3  g71(.a(new_n67_), .b(x08), .c(x05), .O(new_n116_));
  oai21  g72(.a(new_n115_), .b(new_n74_), .c(new_n116_), .O(z14));
  nand2  g73(.a(new_n53_), .b(x25), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand2  g75(.a(new_n110_), .b(new_n119_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n102_), .O(new_n121_));
  oai21  g77(.a(new_n50_), .b(x05), .c(x17), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n121_), .c(new_n70_), .O(z15));
  aoi21  g79(.a(new_n53_), .b(x25), .c(x26), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n89_), .b(new_n96_), .c(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n75_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n124_), .c(new_n72_), .O(z16));
endmodule
