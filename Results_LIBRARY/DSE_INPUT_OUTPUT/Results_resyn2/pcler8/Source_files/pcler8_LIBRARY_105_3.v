...
module FAU ( 
  ...
  oai21  g47(.a(new_n80_), .b(x21), .c(new_n54_), .O(new_n92_));
  aoi21  g48(.a(x08), .b(x02), .c(new_n59_), .O(new_n93_));
  oai21  g49(.a(new_n92_), .b(new_n91_), .c(new_n93_), .O(z11));
  oai21  g50(.a(x10), .b(x08), .c(x03), .O(new_n95_));
  inv1   g51(.a(new_n89_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(x22), .O(new_n97_));
  aoi21  g53(.a(new_n82_), .b(x14), .c(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n96_), .b(x22), .c(new_n54_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n98_), .c(new_n95_), .O(z12));
  nand2  g56(.a(new_n50_), .b(x15), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  aoi21  g58(.a(new_n47_), .b(new_n46_), .c(new_n53_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n67_), .O(z13));
  ...
  oai21  g70(.a(new_n113_), .b(new_n53_), .c(new_n114_), .O(z14));
  nand3  g71(.a(x26), .b(x25), .c(x17), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(new_n117_));
  nand4  g73(.a(new_n111_), .b(new_n81_), .c(new_n80_), .d(x25), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand2  g75(.a(x24), .b(x23), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n47_), .c(new_n119_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  nand2  g78(.a(new_n60_), .b(x06), .O(new_n123_));
  oai21  g79(.a(new_n122_), .b(new_n53_), .c(new_n123_), .O(z15));
  inv1   g80(.a(z08), .O(new_n125_));
  nor2   g81(.a(new_n120_), .b(new_n47_), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(x25), .c(x26), .O(new_n127_));
  inv1   g83(.a(x18), .O(new_n128_));
  nand3  g84(.a(new_n82_), .b(new_n110_), .c(new_n128_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n54_), .O(new_n130_));
