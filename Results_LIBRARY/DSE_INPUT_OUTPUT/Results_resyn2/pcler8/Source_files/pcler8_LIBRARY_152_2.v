...
module FAU ( 
  ...
  aoi21  g12(.a(x10), .b(new_n56_), .c(new_n45_), .O(z02));
  oai21  g13(.a(new_n53_), .b(x02), .c(x08), .O(new_n58_));
  ...
  nand2  g32(.a(x10), .b(x08), .O(new_n77_));
  ...
  nand3  g38(.a(new_n53_), .b(x09), .c(new_n45_), .O(new_n83_));
  inv1   g39(.a(new_n83_), .O(new_n84_));
  oai21  g40(.a(x20), .b(x19), .c(new_n84_), .O(new_n85_));
  oai22  g41(.a(new_n85_), .b(new_n82_), .c(new_n77_), .d(new_n56_), .O(z10));
  ...
  oai21  g47(.a(new_n91_), .b(new_n70_), .c(new_n58_), .O(z11));
  aoi21  g48(.a(new_n79_), .b(x14), .c(new_n49_), .O(new_n93_));
  inv1   g49(.a(x21), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  oai21  g51(.a(new_n78_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n84_), .O(new_n97_));
  ...
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(new_n84_), .O(new_n102_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n83_), .c(new_n64_), .O(z14));
  ...
  nand3  g71(.a(new_n115_), .b(new_n113_), .c(new_n71_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n66_), .O(z15));
  oai21  g73(.a(new_n53_), .b(x07), .c(x08), .O(new_n118_));
