...
module FAU ( 
  ...
  oai21  g34(.a(x20), .b(x19), .c(new_n69_), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z10));
  nand2  g36(.a(x10), .b(x08), .O(new_n81_));
  ...
  oai21  g42(.a(new_n74_), .b(x21), .c(new_n86_), .O(new_n87_));
  oai22  g43(.a(new_n87_), .b(new_n85_), .c(new_n81_), .d(new_n55_), .O(z11));
  ...
  aoi21  g71(.a(new_n110_), .b(new_n109_), .c(x26), .O(new_n116_));
  nor2   g72(.a(new_n49_), .b(x18), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n82_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n86_), .O(new_n119_));
