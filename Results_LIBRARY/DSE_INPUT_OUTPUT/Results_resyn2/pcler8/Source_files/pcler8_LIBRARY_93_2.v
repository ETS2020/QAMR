...
module FAU ( 
  ...
  inv1   g12(.a(x05), .O(new_n57_));
  nor2   g13(.a(x09), .b(new_n57_), .O(new_n58_));
  ...
  oai21  g23(.a(new_n47_), .b(new_n67_), .c(new_n46_), .O(z05));
  nand3  g24(.a(x09), .b(x08), .c(x05), .O(new_n69_));
  ...
  oai21  g45(.a(new_n80_), .b(x21), .c(new_n75_), .O(new_n90_));
  aoi21  g46(.a(x08), .b(x02), .c(new_n58_), .O(new_n91_));
  ...
  oai21  g51(.a(new_n95_), .b(x22), .c(new_n75_), .O(new_n96_));
  ...
  oai21  g58(.a(new_n60_), .b(new_n67_), .c(new_n102_), .O(z13));
  oai21  g59(.a(new_n45_), .b(x08), .c(x05), .O(new_n104_));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  and2   g62(.a(x22), .b(x21), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n80_), .c(x24), .d(x23), .O(new_n108_));
  ...
  nand3  g74(.a(new_n118_), .b(new_n117_), .c(new_n75_), .O(new_n119_));
  nand2  g75(.a(new_n59_), .b(x06), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n119_), .O(z15));
  aoi21  g77(.a(new_n115_), .b(new_n114_), .c(x26), .O(new_n122_));
  oai21  g78(.a(new_n54_), .b(x18), .c(new_n75_), .O(new_n123_));
  nand2  g79(.a(new_n59_), .b(x07), .O(new_n124_));
