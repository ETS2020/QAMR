...
module FAU ( 
  ...
  oai21  g29(.a(new_n54_), .b(new_n51_), .c(new_n73_), .O(z09));
  ...
  inv1   g38(.a(new_n53_), .O(new_n83_));
  aoi21  g39(.a(x08), .b(x01), .c(new_n83_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n82_), .O(z10));
  ...
  oai21  g44(.a(new_n75_), .b(x21), .c(new_n70_), .O(new_n89_));
  oai22  g45(.a(new_n89_), .b(new_n88_), .c(new_n54_), .d(new_n58_), .O(z11));
  inv1   g46(.a(z04), .O(new_n91_));
  aoi21  g47(.a(new_n76_), .b(x14), .c(new_n49_), .O(new_n92_));
  ...
  nor2   g52(.a(new_n45_), .b(new_n96_), .O(new_n97_));
  inv1   g53(.a(x23), .O(new_n98_));
  xor2a  g54(.a(new_n49_), .b(new_n98_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n97_), .c(new_n70_), .O(new_n100_));
  oai21  g56(.a(new_n54_), .b(new_n62_), .c(new_n100_), .O(z13));
  inv1   g57(.a(z06), .O(new_n102_));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand4  g60(.a(new_n77_), .b(new_n75_), .c(x24), .d(x23), .O(new_n105_));
  inv1   g61(.a(x24), .O(new_n106_));
  oai21  g62(.a(new_n49_), .b(new_n98_), .c(new_n106_), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n48_), .c(new_n102_), .O(z14));
  inv1   g65(.a(x25), .O(new_n110_));
  nor2   g66(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  nor2   g67(.a(new_n49_), .b(new_n98_), .O(new_n112_));
  ...
  nand3  g71(.a(new_n115_), .b(new_n114_), .c(new_n70_), .O(new_n116_));
  nand3  g72(.a(new_n53_), .b(x08), .c(x06), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n116_), .O(z15));
  aoi21  g74(.a(new_n112_), .b(new_n111_), .c(x26), .O(new_n119_));
  nor2   g75(.a(new_n49_), .b(x18), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n76_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n70_), .O(new_n122_));
  aoi21  g78(.a(x08), .b(x07), .c(new_n83_), .O(new_n123_));
  oai21  g79(.a(new_n122_), .b(new_n119_), .c(new_n123_), .O(z16));
endmodule
