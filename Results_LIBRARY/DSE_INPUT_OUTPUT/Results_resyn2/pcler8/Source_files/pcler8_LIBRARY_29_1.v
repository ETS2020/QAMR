...
module FAU ( 
  ...
  aoi21  g29(.a(x08), .b(x07), .c(new_n46_), .O(new_n74_));
  ...
  aoi21  g48(.a(new_n92_), .b(new_n83_), .c(new_n91_), .O(new_n93_));
  oai21  g49(.a(new_n81_), .b(x21), .c(new_n55_), .O(new_n94_));
  oai22  g50(.a(new_n94_), .b(new_n93_), .c(new_n61_), .d(new_n63_), .O(z11));
  inv1   g51(.a(new_n91_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(x22), .O(new_n97_));
  aoi21  g53(.a(new_n83_), .b(x14), .c(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n96_), .b(x22), .c(new_n55_), .O(new_n99_));
  aoi21  g55(.a(x08), .b(x03), .c(new_n46_), .O(new_n100_));
  oai21  g56(.a(new_n99_), .b(new_n98_), .c(new_n100_), .O(z12));
  nand2  g57(.a(new_n52_), .b(x15), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n50_), .O(new_n103_));
  aoi21  g59(.a(new_n49_), .b(new_n48_), .c(new_n54_), .O(new_n104_));
  ...
  nand2  g70(.a(new_n71_), .b(x05), .O(new_n115_));
  oai21  g71(.a(new_n114_), .b(new_n54_), .c(new_n115_), .O(z14));
  nand3  g72(.a(x26), .b(x25), .c(x17), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  nand4  g74(.a(new_n112_), .b(new_n82_), .c(new_n81_), .d(x25), .O(new_n119_));
  ...
  nand3  g83(.a(new_n83_), .b(new_n111_), .c(new_n127_), .O(new_n128_));
