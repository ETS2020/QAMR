...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n55_, new_n57_, new_n58_, new_n61_, new_n63_,
  ...
  nand2  g12(.a(x10), .b(new_n55_), .O(new_n57_));
  ...
  nand2  g19(.a(new_n63_), .b(new_n57_), .O(z05));
  nand2  g20(.a(x08), .b(x05), .O(new_n65_));
  nand2  g21(.a(new_n65_), .b(new_n57_), .O(z06));
  ...
  nand2  g37(.a(new_n81_), .b(new_n58_), .O(z10));
  ...
  nand2  g51(.a(new_n95_), .b(new_n70_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n93_), .c(new_n61_), .O(z12));
  inv1   g53(.a(x15), .O(new_n98_));
  nor2   g54(.a(new_n71_), .b(new_n98_), .O(new_n99_));
  xor2a  g55(.a(new_n47_), .b(new_n46_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n99_), .c(new_n70_), .O(new_n101_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n87_), .c(new_n103_), .O(z14));
  ...
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n88_), .O(new_n114_));
  nor2   g70(.a(z07), .b(new_n90_), .O(new_n115_));
  ...
  aoi21  g76(.a(new_n120_), .b(new_n83_), .c(new_n87_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nor2   g78(.a(z08), .b(new_n90_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(z16));
endmodule
