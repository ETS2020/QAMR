...
module FAU ( 
  ...
  nor2   g09(.a(new_n53_), .b(new_n48_), .O(new_n54_));
  inv1   g10(.a(new_n54_), .O(new_n55_));
  nor2   g11(.a(new_n55_), .b(new_n52_), .O(z01));
  inv1   g12(.a(x07), .O(new_n57_));
  nand2  g13(.a(x10), .b(new_n57_), .O(new_n58_));
  ...
  oai21  g33(.a(new_n55_), .b(new_n52_), .c(new_n77_), .O(z09));
  ...
  nand3  g40(.a(new_n84_), .b(new_n59_), .c(new_n58_), .O(z10));
  ...
  nand2  g66(.a(new_n110_), .b(new_n99_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n109_), .c(new_n107_), .O(new_n112_));
  nand2  g68(.a(new_n54_), .b(x05), .O(new_n113_));
  ...
  nand4  g73(.a(new_n110_), .b(new_n117_), .c(new_n79_), .d(x25), .O(new_n118_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n50_), .c(new_n69_), .O(z15));
  nor2   g79(.a(new_n120_), .b(new_n46_), .O(new_n124_));
  ...
  nand4  g84(.a(new_n128_), .b(new_n87_), .c(x19), .d(new_n126_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n73_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n125_), .c(new_n71_), .O(z16));
endmodule
