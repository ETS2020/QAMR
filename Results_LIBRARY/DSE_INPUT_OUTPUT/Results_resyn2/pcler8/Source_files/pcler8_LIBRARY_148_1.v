...
module FAU ( 
  ...
  nand3  g09(.a(new_n53_), .b(x24), .c(x23), .O(new_n54_));
  ...
  oai21  g25(.a(new_n47_), .b(new_n69_), .c(new_n46_), .O(z07));
  nand2  g26(.a(x08), .b(x07), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n56_), .O(z08));
  ...
  oai21  g38(.a(x17), .b(x08), .c(new_n45_), .O(new_n83_));
  or2    g39(.a(x20), .b(x19), .O(new_n84_));
  nand4  g40(.a(new_n84_), .b(new_n83_), .c(new_n48_), .d(x09), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n82_), .c(new_n59_), .O(z10));
  nand3  g42(.a(x21), .b(x20), .c(x19), .O(new_n87_));
  inv1   g43(.a(new_n87_), .O(new_n88_));
  nand2  g44(.a(x22), .b(x13), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n73_), .c(new_n88_), .O(new_n90_));
  inv1   g46(.a(x21), .O(new_n91_));
  aoi21  g47(.a(new_n78_), .b(new_n91_), .c(new_n49_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n61_), .c(new_n56_), .O(z11));
  aoi21  g50(.a(new_n79_), .b(x14), .c(new_n52_), .O(new_n95_));
  oai21  g51(.a(new_n88_), .b(x22), .c(new_n50_), .O(new_n96_));
  and2   g52(.a(new_n63_), .b(new_n46_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n53_), .c(x24), .d(x23), .O(new_n106_));
  inv1   g62(.a(x24), .O(new_n107_));
  oai21  g63(.a(new_n52_), .b(new_n101_), .c(new_n107_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n106_), .c(new_n50_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n67_), .c(new_n56_), .O(z14));
  inv1   g66(.a(x25), .O(new_n111_));
  nand2  g67(.a(new_n54_), .b(new_n111_), .O(new_n112_));
  nor2   g68(.a(new_n52_), .b(new_n101_), .O(new_n113_));
  nor2   g69(.a(new_n111_), .b(new_n107_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(new_n49_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nor2   g72(.a(new_n47_), .b(new_n69_), .O(new_n117_));
  nand2  g73(.a(x26), .b(x25), .O(new_n118_));
  oai21  g74(.a(new_n49_), .b(new_n118_), .c(x01), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(x17), .c(new_n117_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n116_), .O(z15));
  aoi21  g77(.a(new_n114_), .b(new_n113_), .c(x26), .O(new_n122_));
  inv1   g78(.a(new_n78_), .O(new_n123_));
  and2   g79(.a(x22), .b(x21), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n123_), .c(x23), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand4  g82(.a(x26), .b(x25), .c(x24), .d(new_n126_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n125_), .c(new_n50_), .O(new_n128_));
  and2   g84(.a(new_n71_), .b(new_n46_), .O(new_n129_));
  oai21  g85(.a(new_n128_), .b(new_n122_), .c(new_n129_), .O(z16));
endmodule
