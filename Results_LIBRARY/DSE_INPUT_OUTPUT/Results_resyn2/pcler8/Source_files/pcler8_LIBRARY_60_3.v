...
module FAU ( 
  ...
  nor2   g17(.a(new_n61_), .b(new_n51_), .O(new_n62_));
  nand2  g18(.a(new_n62_), .b(x02), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z03));
  nand2  g20(.a(new_n62_), .b(x03), .O(new_n65_));
  ...
  nand2  g26(.a(new_n62_), .b(x06), .O(new_n71_));
  ...
  nand3  g33(.a(new_n77_), .b(x09), .c(new_n51_), .O(new_n78_));
  ...
  nand3  g41(.a(new_n85_), .b(new_n59_), .c(new_n45_), .O(z10));
  ...
  oai21  g46(.a(new_n80_), .b(x21), .c(new_n54_), .O(new_n91_));
  ...
  oai21  g51(.a(new_n93_), .b(x22), .c(new_n54_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n95_), .c(new_n65_), .O(z12));
  nand2  g53(.a(new_n50_), .b(x15), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  aoi21  g55(.a(new_n47_), .b(new_n46_), .c(new_n53_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  aoi21  g57(.a(x08), .b(x04), .c(new_n61_), .O(new_n102_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n53_), .c(new_n104_), .O(z14));
  nand3  g69(.a(x26), .b(x25), .c(x17), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  and2   g71(.a(x22), .b(x21), .O(new_n116_));
  nand4  g72(.a(new_n110_), .b(new_n116_), .c(new_n80_), .d(x25), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand2  g74(.a(x24), .b(x23), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n47_), .c(new_n118_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n53_), .c(new_n71_), .O(z15));
  nor2   g78(.a(new_n119_), .b(new_n47_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(x25), .c(x26), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(new_n87_), .b(new_n109_), .c(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  nand2  g83(.a(new_n62_), .b(x07), .O(new_n128_));
