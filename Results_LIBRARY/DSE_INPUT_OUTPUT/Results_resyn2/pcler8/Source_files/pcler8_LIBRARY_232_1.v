...
module FAU ( 
  ...
  nand3  g10(.a(new_n54_), .b(new_n49_), .c(new_n48_), .O(new_n55_));
  ...
  aoi21  g17(.a(x08), .b(x02), .c(new_n57_), .O(new_n62_));
  inv1   g18(.a(new_n62_), .O(z03));
  nand2  g19(.a(x08), .b(x03), .O(new_n64_));
  nor2   g20(.a(new_n64_), .b(new_n57_), .O(z04));
  ...
  nand3  g25(.a(new_n46_), .b(x08), .c(x06), .O(new_n70_));
  ...
  nand3  g34(.a(new_n78_), .b(new_n58_), .c(new_n46_), .O(z09));
  ...
  nor2   g39(.a(new_n83_), .b(new_n53_), .O(new_n84_));
  ...
  oai21  g46(.a(new_n80_), .b(x21), .c(new_n74_), .O(new_n91_));
  ...
  oai21  g51(.a(new_n93_), .b(x22), .c(new_n74_), .O(new_n96_));
  and2   g52(.a(new_n64_), .b(new_n46_), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n95_), .c(new_n97_), .O(z12));
  nand4  g54(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n48_), .c(x23), .O(new_n100_));
  inv1   g56(.a(x23), .O(new_n101_));
  nand2  g57(.a(new_n47_), .b(new_n101_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n100_), .c(new_n74_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n66_), .c(new_n57_), .O(z13));
  and2   g60(.a(x22), .b(x21), .O(new_n105_));
  nand3  g61(.a(new_n49_), .b(new_n105_), .c(new_n80_), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  inv1   g64(.a(x24), .O(new_n109_));
  oai21  g65(.a(new_n47_), .b(new_n101_), .c(new_n109_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n106_), .c(new_n108_), .O(new_n111_));
  nand2  g67(.a(new_n74_), .b(new_n46_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n111_), .c(new_n68_), .O(z14));
  nand4  g69(.a(new_n49_), .b(new_n105_), .c(new_n80_), .d(x25), .O(new_n114_));
  inv1   g70(.a(x25), .O(new_n115_));
  nand2  g71(.a(x24), .b(x23), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n47_), .c(new_n115_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n114_), .c(new_n74_), .d(new_n46_), .O(new_n118_));
  nand3  g74(.a(new_n54_), .b(x17), .c(x02), .O(new_n119_));
  ...
  nand4  g79(.a(new_n123_), .b(new_n49_), .c(new_n48_), .d(x25), .O(new_n124_));
  nand2  g80(.a(new_n114_), .b(new_n122_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n124_), .c(new_n74_), .O(new_n126_));
