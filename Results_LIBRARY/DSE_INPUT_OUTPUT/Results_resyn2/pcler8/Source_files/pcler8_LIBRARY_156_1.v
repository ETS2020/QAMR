...
module FAU ( 
  ...
  oai21  g13(.a(new_n50_), .b(new_n55_), .c(new_n57_), .O(z01));
  nand2  g14(.a(x08), .b(x01), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(new_n57_), .O(z02));
  inv1   g16(.a(x02), .O(new_n61_));
  nand2  g17(.a(new_n57_), .b(x08), .O(new_n62_));
  ...
  nand2  g28(.a(new_n70_), .b(x07), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(z08));
  nand4  g30(.a(new_n45_), .b(new_n56_), .c(x09), .d(new_n50_), .O(new_n75_));
  oai22  g31(.a(new_n75_), .b(x19), .c(new_n62_), .d(new_n55_), .O(z09));
  nand2  g32(.a(x20), .b(x19), .O(new_n77_));
  nand3  g33(.a(x26), .b(x25), .c(x22), .O(new_n78_));
  inv1   g34(.a(new_n78_), .O(new_n79_));
  nand4  g35(.a(x24), .b(x23), .c(x21), .d(x12), .O(new_n80_));
  inv1   g36(.a(new_n80_), .O(new_n81_));
  aoi21  g37(.a(new_n81_), .b(new_n79_), .c(new_n77_), .O(new_n82_));
  inv1   g38(.a(new_n75_), .O(new_n83_));
  oai21  g39(.a(x20), .b(x19), .c(new_n83_), .O(new_n84_));
  nand2  g40(.a(new_n70_), .b(x01), .O(new_n85_));
  oai21  g41(.a(new_n84_), .b(new_n82_), .c(new_n85_), .O(z10));
  nand3  g42(.a(x21), .b(x20), .c(x19), .O(new_n87_));
  nand3  g43(.a(x24), .b(x23), .c(x13), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n79_), .c(new_n87_), .O(new_n90_));
  inv1   g46(.a(x21), .O(new_n91_));
  nand2  g47(.a(new_n77_), .b(new_n91_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n83_), .O(new_n93_));
  oai22  g49(.a(new_n93_), .b(new_n90_), .c(new_n62_), .d(new_n61_), .O(z11));
  nand2  g50(.a(x24), .b(x23), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nand3  g52(.a(x26), .b(x25), .c(x14), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n96_), .c(new_n47_), .O(new_n99_));
  inv1   g55(.a(new_n87_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(x22), .c(new_n83_), .O(new_n101_));
  nand2  g57(.a(new_n70_), .b(x03), .O(new_n102_));
  oai21  g58(.a(new_n101_), .b(new_n99_), .c(new_n102_), .O(z12));
  nand2  g59(.a(x08), .b(x04), .O(new_n104_));
  inv1   g60(.a(new_n47_), .O(new_n105_));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n105_), .c(x23), .O(new_n107_));
  aoi21  g63(.a(new_n47_), .b(new_n46_), .c(new_n51_), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n107_), .c(x11), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(x10), .c(new_n104_), .O(z13));
  ...
  nand2  g70(.a(new_n96_), .b(new_n105_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n114_), .c(new_n112_), .O(new_n116_));
  nand2  g72(.a(new_n70_), .b(x05), .O(new_n117_));
  oai21  g73(.a(new_n116_), .b(new_n75_), .c(new_n117_), .O(z14));
  nand3  g74(.a(x26), .b(x25), .c(x17), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(new_n120_));
  nand3  g76(.a(new_n96_), .b(new_n105_), .c(x25), .O(new_n121_));
  inv1   g77(.a(x25), .O(new_n122_));
  oai21  g78(.a(new_n95_), .b(new_n47_), .c(new_n122_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n121_), .c(new_n120_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n75_), .c(new_n71_), .O(z15));
  nor2   g81(.a(new_n95_), .b(new_n47_), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(x25), .c(x26), .O(new_n127_));
  inv1   g83(.a(x18), .O(new_n128_));
  nand3  g84(.a(new_n126_), .b(new_n49_), .c(new_n128_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n83_), .O(new_n130_));
