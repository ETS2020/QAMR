...
module FAU ( 
  ...
  nor2   g20(.a(new_n54_), .b(new_n64_), .O(z05));
  ...
  oai21  g45(.a(new_n79_), .b(x21), .c(new_n73_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n89_), .c(new_n60_), .O(z11));
  aoi21  g47(.a(new_n86_), .b(x14), .c(new_n47_), .O(new_n92_));
  ...
  nor2   g53(.a(new_n74_), .b(new_n97_), .O(new_n98_));
  xor2a  g54(.a(new_n47_), .b(new_n46_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n98_), .c(new_n73_), .O(new_n100_));
  oai21  g56(.a(new_n54_), .b(new_n64_), .c(new_n100_), .O(z13));
  nand4  g57(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  inv1   g59(.a(new_n47_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x24), .c(x23), .O(new_n105_));
  oai21  g61(.a(new_n47_), .b(new_n46_), .c(new_n49_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n105_), .c(new_n103_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n72_), .c(new_n66_), .O(z14));
  nand2  g64(.a(x26), .b(x17), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n48_), .c(x25), .d(x24), .O(new_n110_));
  nand2  g66(.a(new_n105_), .b(new_n50_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n110_), .c(new_n73_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n68_), .O(z15));
  inv1   g69(.a(x26), .O(new_n114_));
  nand4  g70(.a(new_n104_), .b(x25), .c(x24), .d(x23), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nor2   g72(.a(new_n47_), .b(x18), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n86_), .c(new_n72_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n70_), .O(z16));
endmodule
