...
module FAU ( 
  ...
  oai21  g44(.a(new_n88_), .b(new_n51_), .c(new_n87_), .O(new_n89_));
  or2    g45(.a(new_n77_), .b(x21), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n89_), .c(new_n48_), .O(new_n91_));
  aoi21  g47(.a(new_n91_), .b(new_n85_), .c(x10), .O(z11));
  ...
  nand2  g54(.a(x08), .b(x04), .O(new_n99_));
  inv1   g55(.a(x15), .O(new_n100_));
  nor2   g56(.a(new_n51_), .b(new_n100_), .O(new_n101_));
  inv1   g57(.a(x23), .O(new_n102_));
  xor2a  g58(.a(new_n52_), .b(new_n102_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n101_), .c(new_n48_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n99_), .c(x10), .O(z13));
  oai21  g61(.a(x10), .b(x05), .c(x08), .O(new_n106_));
  nand3  g62(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nand4  g64(.a(new_n79_), .b(new_n77_), .c(x24), .d(x23), .O(new_n109_));
  ...
  nand2  g82(.a(new_n126_), .b(new_n50_), .O(new_n127_));
