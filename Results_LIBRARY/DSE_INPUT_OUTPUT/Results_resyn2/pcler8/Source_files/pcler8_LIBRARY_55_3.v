...
module FAU ( 
  ...
  nand3  g37(.a(new_n81_), .b(new_n80_), .c(new_n50_), .O(new_n82_));
  ...
  or2    g42(.a(new_n76_), .b(x21), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n50_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n86_), .c(new_n60_), .O(z11));
  aoi21  g45(.a(new_n77_), .b(x14), .c(new_n52_), .O(new_n90_));
  inv1   g46(.a(x22), .O(new_n91_));
  nand2  g47(.a(new_n84_), .b(new_n91_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n50_), .O(new_n93_));
  ...
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n48_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n64_), .c(x10), .O(z13));
  nand3  g56(.a(x26), .b(x25), .c(x24), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand4  g58(.a(new_n78_), .b(new_n76_), .c(x24), .d(x23), .O(new_n103_));
  ...
  oai21  g62(.a(new_n106_), .b(new_n49_), .c(new_n66_), .O(z14));
  ...
  aoi21  g70(.a(new_n114_), .b(new_n68_), .c(x10), .O(z15));
  inv1   g71(.a(x18), .O(new_n116_));
  nand2  g72(.a(new_n53_), .b(new_n116_), .O(new_n117_));
  inv1   g73(.a(x26), .O(new_n118_));
  nand2  g74(.a(new_n111_), .b(new_n110_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n117_), .c(new_n50_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n70_), .O(z16));
endmodule
