...
module FAU ( 
  ...
  nand2  g04(.a(new_n48_), .b(x24), .O(new_n49_));
  ...
  nor2   g09(.a(x15), .b(x14), .O(new_n54_));
  nor4   g10(.a(new_n54_), .b(new_n53_), .c(new_n49_), .d(new_n47_), .O(z00));
  inv1   g11(.a(new_n54_), .O(new_n56_));
  ...
  aoi21  g16(.a(x08), .b(x02), .c(new_n54_), .O(new_n61_));
  ...
  aoi21  g33(.a(new_n77_), .b(new_n57_), .c(new_n54_), .O(z09));
  ...
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n47_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  aoi21  g41(.a(new_n85_), .b(new_n59_), .c(new_n54_), .O(z10));
  inv1   g42(.a(new_n49_), .O(new_n87_));
  nand2  g43(.a(new_n50_), .b(x13), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n87_), .c(new_n51_), .O(new_n90_));
  oai21  g46(.a(new_n81_), .b(x21), .c(new_n73_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n90_), .c(new_n61_), .O(z11));
  nor2   g48(.a(new_n52_), .b(x22), .O(new_n93_));
  nand4  g49(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n73_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n93_), .c(new_n63_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n56_), .O(new_n97_));
  nand4  g53(.a(new_n50_), .b(new_n87_), .c(new_n73_), .d(x14), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(z12));
  inv1   g55(.a(x23), .O(new_n100_));
  nand2  g56(.a(new_n94_), .b(new_n100_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n56_), .c(new_n53_), .d(new_n73_), .O(new_n102_));
  inv1   g58(.a(new_n74_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n73_), .c(x15), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n102_), .c(new_n65_), .O(z13));
  inv1   g61(.a(x24), .O(new_n106_));
  nand2  g62(.a(new_n53_), .b(new_n106_), .O(new_n107_));
  nand2  g63(.a(new_n48_), .b(x16), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n52_), .c(new_n50_), .d(x24), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n107_), .c(new_n73_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n67_), .c(new_n56_), .O(z14));
  nand2  g67(.a(new_n48_), .b(x17), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(new_n113_));
  nand3  g69(.a(x24), .b(x23), .c(x22), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(new_n51_), .O(new_n115_));
  xor2a  g71(.a(new_n115_), .b(x25), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n113_), .c(new_n73_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n69_), .c(new_n54_), .O(z15));
  inv1   g74(.a(x18), .O(new_n119_));
  inv1   g75(.a(new_n94_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n103_), .c(new_n119_), .O(new_n121_));
  inv1   g77(.a(x26), .O(new_n122_));
  nand2  g78(.a(new_n115_), .b(x25), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n121_), .c(new_n73_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n71_), .c(new_n54_), .O(z16));
endmodule
