...
module FAU ( 
  ...
  aoi21  g15(.a(x10), .b(new_n59_), .c(new_n46_), .O(z05));
  ...
  oai21  g37(.a(new_n47_), .b(x02), .c(x08), .O(new_n82_));
  ...
  oai21  g42(.a(new_n73_), .b(x21), .c(new_n79_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(z11));
  aoi21  g44(.a(new_n83_), .b(x14), .c(new_n49_), .O(new_n89_));
  ...
  nand3  g53(.a(x10), .b(x08), .c(x04), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(z13));
  nand4  g55(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n100_));
  inv1   g56(.a(new_n100_), .O(new_n101_));
  and2   g57(.a(x22), .b(x21), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n73_), .c(x24), .d(x23), .O(new_n103_));
  ...
  oai21  g62(.a(new_n106_), .b(new_n78_), .c(new_n61_), .O(z14));
  oai21  g63(.a(new_n47_), .b(x06), .c(x08), .O(new_n108_));
  inv1   g64(.a(x25), .O(new_n109_));
  nor2   g65(.a(new_n109_), .b(new_n104_), .O(new_n110_));
  nor2   g66(.a(new_n49_), .b(new_n95_), .O(new_n111_));
  ...
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n79_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n108_), .O(z15));
  oai21  g72(.a(new_n47_), .b(x07), .c(x08), .O(new_n117_));
  ...
  nand2  g76(.a(new_n120_), .b(new_n79_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(z16));
endmodule
