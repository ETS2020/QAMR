...
module FAU ( 
  ...
  nand2  g14(.a(new_n47_), .b(x08), .O(new_n59_));
  nor2   g15(.a(new_n59_), .b(new_n58_), .O(z01));
  inv1   g16(.a(x01), .O(new_n61_));
  oai21  g17(.a(new_n53_), .b(new_n61_), .c(new_n47_), .O(z02));
  ...
  aoi21  g34(.a(x08), .b(x00), .c(new_n46_), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n78_), .O(z09));
  ...
  oai21  g42(.a(new_n59_), .b(new_n61_), .c(new_n86_), .O(z10));
  ...
  oai22  g48(.a(new_n92_), .b(new_n91_), .c(new_n59_), .d(new_n63_), .O(z11));
  ...
  nand3  g59(.a(new_n103_), .b(new_n67_), .c(new_n47_), .O(z13));
  ...
  nor2   g68(.a(new_n46_), .b(new_n53_), .O(new_n113_));
  ...
  nand4  g74(.a(new_n110_), .b(new_n118_), .c(new_n81_), .d(x25), .O(new_n119_));
  ...
  nand2  g79(.a(new_n113_), .b(x06), .O(new_n124_));
  oai21  g80(.a(new_n123_), .b(new_n54_), .c(new_n124_), .O(z15));
  nor2   g81(.a(new_n121_), .b(new_n49_), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(x25), .c(x26), .O(new_n127_));
  inv1   g83(.a(x18), .O(new_n128_));
  nand3  g84(.a(new_n88_), .b(new_n109_), .c(new_n128_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n55_), .O(new_n130_));
  oai22  g86(.a(new_n130_), .b(new_n127_), .c(new_n59_), .d(new_n73_), .O(z16));
endmodule
