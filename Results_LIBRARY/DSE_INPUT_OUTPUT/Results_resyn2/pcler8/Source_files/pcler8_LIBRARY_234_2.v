...
module FAU ( 
  ...
  nand3  g66(.a(x10), .b(x08), .c(x05), .O(new_n111_));
  ...
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(new_n83_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n66_), .O(z15));
  oai21  g74(.a(new_n55_), .b(x07), .c(x08), .O(new_n119_));
  inv1   g75(.a(x26), .O(new_n120_));
  nand4  g76(.a(new_n106_), .b(x25), .c(x24), .d(x23), .O(new_n121_));
  ...
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n83_), .O(new_n125_));
