...
module FAU ( 
  ...
  nand4  g40(.a(new_n84_), .b(new_n82_), .c(new_n78_), .d(new_n46_), .O(new_n85_));
  nand3  g41(.a(new_n85_), .b(new_n81_), .c(new_n59_), .O(z10));
  inv1   g42(.a(new_n82_), .O(new_n87_));
  nor2   g43(.a(new_n87_), .b(x21), .O(new_n88_));
  nand4  g44(.a(new_n53_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n88_), .c(new_n61_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n46_), .O(new_n91_));
  nand4  g47(.a(new_n87_), .b(new_n73_), .c(new_n51_), .d(x13), .O(new_n92_));
  ...
  nor2   g59(.a(new_n96_), .b(new_n103_), .O(new_n104_));
  oai21  g60(.a(new_n47_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  aoi21  g61(.a(new_n96_), .b(new_n103_), .c(new_n50_), .O(new_n106_));
  ...
  nand3  g73(.a(new_n54_), .b(new_n45_), .c(x24), .O(new_n118_));
  inv1   g74(.a(x26), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(x25), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(x17), .O(new_n121_));
  nand2  g77(.a(new_n109_), .b(x25), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n121_), .c(new_n118_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n78_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n117_), .O(z15));
  nor2   g81(.a(new_n120_), .b(new_n109_), .O(new_n126_));
  nand2  g82(.a(x25), .b(x24), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(x18), .O(new_n128_));
  nand2  g84(.a(new_n46_), .b(x26), .O(new_n129_));
  aoi21  g85(.a(new_n128_), .b(new_n54_), .c(new_n129_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n126_), .c(new_n78_), .O(new_n131_));
