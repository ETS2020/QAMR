...
module FAU ( 
  ...
  aoi21  g38(.a(x08), .b(x00), .c(new_n46_), .O(new_n83_));
  oai21  g39(.a(new_n82_), .b(new_n56_), .c(new_n83_), .O(z09));
  and2   g40(.a(x20), .b(x19), .O(new_n85_));
  inv1   g41(.a(new_n85_), .O(new_n86_));
  aoi21  g42(.a(new_n80_), .b(x12), .c(new_n86_), .O(new_n87_));
  oai21  g43(.a(x20), .b(x19), .c(new_n57_), .O(new_n88_));
  ...
  aoi21  g49(.a(new_n93_), .b(new_n79_), .c(new_n92_), .O(new_n94_));
  oai21  g50(.a(new_n85_), .b(x21), .c(new_n57_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z11));
  ...
  oai21  g55(.a(new_n99_), .b(x22), .c(new_n57_), .O(new_n100_));
  aoi21  g56(.a(x08), .b(x03), .c(new_n46_), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(z12));
  nand3  g58(.a(new_n53_), .b(x24), .c(x15), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n50_), .O(new_n104_));
  aoi21  g60(.a(new_n49_), .b(new_n48_), .c(new_n56_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n68_), .c(new_n47_), .O(z13));
  ...
  nand2  g71(.a(new_n57_), .b(new_n47_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n115_), .c(new_n70_), .O(z14));
  nand2  g73(.a(x24), .b(x23), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n49_), .c(new_n51_), .O(new_n119_));
  nand4  g75(.a(new_n113_), .b(new_n77_), .c(new_n85_), .d(x25), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n119_), .c(new_n57_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n72_), .O(new_n122_));
  ...
  nand4  g82(.a(new_n126_), .b(new_n113_), .c(new_n112_), .d(x25), .O(new_n127_));
  nand2  g83(.a(new_n120_), .b(new_n52_), .O(new_n128_));
  nand3  g84(.a(new_n128_), .b(new_n127_), .c(new_n57_), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n74_), .c(new_n46_), .O(z16));
endmodule
