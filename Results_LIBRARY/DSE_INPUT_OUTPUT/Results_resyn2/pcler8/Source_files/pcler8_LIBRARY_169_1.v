...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_,
    new_n53_, new_n54_, new_n56_, new_n57_, new_n59_, new_n62_, new_n65_,
  ...
  aoi21  g17(.a(x08), .b(x04), .c(new_n52_), .O(new_n62_));
  ...
  nand3  g39(.a(new_n83_), .b(new_n82_), .c(new_n72_), .O(new_n84_));
  oai21  g40(.a(new_n57_), .b(new_n56_), .c(new_n84_), .O(z10));
  ...
  oai21  g44(.a(new_n79_), .b(x21), .c(new_n72_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n88_), .c(new_n59_), .O(z11));
  aoi21  g46(.a(new_n80_), .b(x14), .c(new_n47_), .O(new_n91_));
  inv1   g47(.a(new_n86_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x22), .c(new_n70_), .O(new_n93_));
  nor2   g49(.a(z04), .b(new_n52_), .O(new_n94_));
  oai21  g50(.a(new_n93_), .b(new_n91_), .c(new_n94_), .O(z12));
  inv1   g51(.a(x15), .O(new_n96_));
  nor2   g52(.a(new_n73_), .b(new_n96_), .O(new_n97_));
  xor2a  g53(.a(new_n47_), .b(new_n46_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n97_), .c(new_n70_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n62_), .O(z13));
  inv1   g56(.a(new_n70_), .O(new_n101_));
  nand4  g57(.a(new_n74_), .b(new_n79_), .c(x24), .d(x23), .O(new_n102_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n71_), .c(new_n65_), .O(z15));
  inv1   g72(.a(new_n112_), .O(new_n117_));
  nor2   g73(.a(new_n47_), .b(x18), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n80_), .c(new_n71_), .O(new_n119_));
