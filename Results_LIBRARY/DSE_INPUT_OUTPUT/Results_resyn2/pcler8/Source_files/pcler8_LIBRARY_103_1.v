...
module FAU ( 
  ...
  nor2   g06(.a(new_n47_), .b(x01), .O(new_n51_));
  ...
  oai21  g36(.a(new_n46_), .b(new_n55_), .c(new_n80_), .O(z10));
  ...
  aoi21  g42(.a(x08), .b(x02), .c(new_n51_), .O(new_n87_));
  ...
  oai22  g47(.a(new_n91_), .b(new_n89_), .c(new_n58_), .d(new_n60_), .O(z12));
  ...
  nand3  g53(.a(new_n97_), .b(new_n62_), .c(new_n52_), .O(z13));
  ...
  aoi21  g61(.a(x08), .b(x05), .c(new_n51_), .O(new_n106_));
  ...
  aoi21  g70(.a(x08), .b(x06), .c(new_n51_), .O(new_n115_));
  ...
  oai22  g77(.a(new_n121_), .b(new_n117_), .c(new_n58_), .d(new_n68_), .O(z16));
endmodule
