...
module FAU ( 
  ...
  and2   g75(.a(new_n107_), .b(new_n104_), .O(new_n120_));
  inv1   g76(.a(x18), .O(new_n121_));
  aoi21  g77(.a(new_n53_), .b(new_n121_), .c(new_n91_), .O(new_n122_));
