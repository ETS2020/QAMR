...
module FAU ( 
  ...
  nor3   g07(.a(new_n51_), .b(new_n48_), .c(new_n47_), .O(new_n52_));
  nand4  g08(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n53_));
  inv1   g09(.a(new_n53_), .O(new_n54_));
  and2   g10(.a(x24), .b(x23), .O(new_n55_));
  nand3  g11(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(new_n56_));
  nand2  g12(.a(new_n56_), .b(new_n46_), .O(z00));
  nand2  g13(.a(x08), .b(x00), .O(new_n58_));
  and2   g14(.a(new_n58_), .b(new_n46_), .O(new_n59_));
  ...
  nor2   g23(.a(new_n67_), .b(new_n61_), .O(z04));
  ...
  nand3  g30(.a(new_n46_), .b(x08), .c(x07), .O(new_n75_));
  ...
  oai21  g39(.a(new_n83_), .b(new_n51_), .c(new_n59_), .O(z09));
  ...
  oai21  g55(.a(new_n99_), .b(x22), .c(new_n88_), .O(new_n100_));
  and2   g56(.a(new_n67_), .b(new_n46_), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(z12));
  nand2  g58(.a(new_n54_), .b(x23), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  aoi21  g60(.a(new_n53_), .b(new_n104_), .c(new_n51_), .O(new_n105_));
  aoi22  g61(.a(new_n105_), .b(new_n103_), .c(x08), .d(x04), .O(new_n106_));
  nand3  g62(.a(new_n80_), .b(new_n88_), .c(x15), .O(new_n107_));
  oai21  g63(.a(new_n106_), .b(new_n61_), .c(new_n107_), .O(z13));
  nand4  g64(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n109_));
  nand3  g65(.a(new_n55_), .b(new_n78_), .c(new_n85_), .O(new_n110_));
  ...
  nand2  g70(.a(new_n114_), .b(new_n88_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n71_), .c(new_n61_), .O(z14));
  nand2  g72(.a(new_n110_), .b(new_n47_), .O(new_n117_));
  nand3  g73(.a(new_n55_), .b(new_n54_), .c(x25), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n117_), .c(new_n88_), .O(new_n119_));
  oai21  g75(.a(new_n52_), .b(new_n45_), .c(x17), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n119_), .c(new_n73_), .O(z15));
  nor2   g77(.a(new_n48_), .b(x18), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n55_), .c(new_n54_), .d(x25), .O(new_n123_));
  nand2  g79(.a(new_n118_), .b(new_n48_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n123_), .c(new_n88_), .d(new_n46_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n75_), .O(z16));
endmodule
