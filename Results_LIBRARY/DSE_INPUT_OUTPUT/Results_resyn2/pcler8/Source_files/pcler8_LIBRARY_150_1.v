...
module FAU ( 
  ...
  nand2  g22(.a(new_n66_), .b(new_n56_), .O(z06));
  nand2  g23(.a(x08), .b(x06), .O(new_n68_));
  nand2  g24(.a(new_n68_), .b(new_n56_), .O(z07));
  and2   g25(.a(x08), .b(x07), .O(z08));
  ...
  aoi21  g31(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(new_n76_));
  oai21  g32(.a(new_n76_), .b(new_n53_), .c(new_n57_), .O(z09));
  inv1   g33(.a(z02), .O(new_n78_));
  ...
  oai21  g39(.a(x20), .b(x19), .c(new_n52_), .O(new_n84_));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n73_), .c(new_n87_), .O(new_n89_));
  oai21  g45(.a(new_n79_), .b(x21), .c(new_n52_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n89_), .c(new_n86_), .O(z11));
  inv1   g47(.a(new_n87_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x22), .O(new_n93_));
  aoi21  g49(.a(new_n73_), .b(x14), .c(new_n93_), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nand2  g51(.a(new_n87_), .b(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n52_), .c(new_n50_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n94_), .c(new_n63_), .O(z12));
  inv1   g54(.a(new_n49_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g57(.a(new_n46_), .b(new_n45_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n101_), .c(new_n52_), .O(new_n103_));
  inv1   g59(.a(new_n56_), .O(new_n104_));
  nor2   g60(.a(z05), .b(new_n104_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n103_), .O(z13));
  ...
  nand3  g68(.a(new_n112_), .b(new_n111_), .c(new_n79_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n108_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n53_), .c(new_n66_), .O(z14));
  nand2  g71(.a(x24), .b(x23), .O(new_n116_));
  nor2   g72(.a(new_n116_), .b(new_n46_), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  aoi21  g74(.a(x26), .b(x17), .c(new_n118_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g76(.a(new_n113_), .b(new_n118_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n120_), .c(new_n52_), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n56_), .O(z15));
  aoi21  g79(.a(new_n117_), .b(x25), .c(x26), .O(new_n124_));
  nand3  g80(.a(x22), .b(x21), .c(x20), .O(new_n125_));
  inv1   g81(.a(new_n125_), .O(new_n126_));
  nor2   g82(.a(new_n71_), .b(x18), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n126_), .c(new_n73_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n52_), .O(new_n129_));
  nor2   g85(.a(z08), .b(new_n104_), .O(new_n130_));
