...
module FAU ( 
  ...
  inv1   g63(.a(new_n57_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x05), .O(new_n109_));
  oai21  g65(.a(new_n107_), .b(new_n49_), .c(new_n109_), .O(z14));
  ...
  nand2  g73(.a(new_n108_), .b(x06), .O(new_n118_));
  ...
  nand2  g81(.a(new_n125_), .b(new_n71_), .O(z16));
endmodule
