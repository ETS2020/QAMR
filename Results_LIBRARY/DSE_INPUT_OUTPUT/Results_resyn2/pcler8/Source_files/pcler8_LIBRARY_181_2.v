...
module FAU ( 
  ...
  nand3  g32(.a(new_n76_), .b(new_n75_), .c(new_n46_), .O(z09));
  ...
  aoi21  g50(.a(x08), .b(x03), .c(new_n94_), .O(new_n95_));
  oai21  g51(.a(new_n93_), .b(new_n91_), .c(new_n95_), .O(z12));
  ...
  nand2  g76(.a(new_n53_), .b(new_n45_), .O(new_n121_));
