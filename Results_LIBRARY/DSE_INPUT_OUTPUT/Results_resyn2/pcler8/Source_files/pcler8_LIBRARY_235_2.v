...
module FAU ( 
  ...
  oai21  g11(.a(new_n55_), .b(x01), .c(x08), .O(new_n56_));
  ...
  nand2  g70(.a(new_n106_), .b(new_n114_), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n113_), .c(new_n83_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n66_), .O(z15));
  nand3  g73(.a(x10), .b(x08), .c(x07), .O(new_n118_));
