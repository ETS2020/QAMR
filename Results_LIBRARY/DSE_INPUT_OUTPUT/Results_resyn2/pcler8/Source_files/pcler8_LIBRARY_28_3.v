...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x02), .O(new_n45_));
  ...
  oai21  g16(.a(x10), .b(x08), .c(x02), .O(new_n61_));
  ...
  inv1   g68(.a(new_n51_), .O(new_n113_));
  ...
  nand3  g72(.a(new_n116_), .b(new_n115_), .c(new_n49_), .O(new_n117_));
  aoi21  g73(.a(x08), .b(x06), .c(new_n55_), .O(new_n118_));
  ...
  nand3  g80(.a(new_n124_), .b(new_n121_), .c(new_n49_), .O(new_n125_));
