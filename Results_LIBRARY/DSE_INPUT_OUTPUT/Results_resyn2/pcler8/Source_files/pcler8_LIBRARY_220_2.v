...
module FAU ( 
  ...
  nor2   g31(.a(new_n69_), .b(new_n45_), .O(new_n76_));
  ...
  nand2  g47(.a(new_n76_), .b(x03), .O(new_n92_));
  aoi21  g48(.a(new_n86_), .b(x14), .c(new_n47_), .O(new_n93_));
  inv1   g49(.a(new_n87_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(x22), .c(new_n71_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n93_), .c(new_n92_), .O(z12));
  ...
  nand2  g63(.a(new_n76_), .b(x05), .O(new_n108_));
  oai21  g64(.a(new_n107_), .b(new_n70_), .c(new_n108_), .O(z14));
  nand2  g65(.a(new_n76_), .b(x06), .O(new_n110_));
  ...
  nand2  g69(.a(new_n104_), .b(new_n111_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n71_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n110_), .O(z15));
  aoi21  g72(.a(x08), .b(x07), .c(new_n69_), .O(new_n117_));
  inv1   g73(.a(x26), .O(new_n118_));
  inv1   g74(.a(new_n47_), .O(new_n119_));
  nor2   g75(.a(new_n111_), .b(new_n105_), .O(new_n120_));
  ...
  aoi21  g80(.a(new_n124_), .b(new_n48_), .c(new_n123_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(new_n45_), .c(new_n117_), .O(z16));
endmodule
