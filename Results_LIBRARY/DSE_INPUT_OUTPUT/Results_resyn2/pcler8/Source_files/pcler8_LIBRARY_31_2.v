...
module FAU ( 
  ...
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n70_), .O(new_n82_));
  ...
  oai21  g44(.a(new_n79_), .b(x21), .c(new_n71_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n88_), .c(new_n57_), .O(z11));
  aoi21  g46(.a(new_n85_), .b(x14), .c(new_n49_), .O(new_n91_));
  ...
  oai21  g50(.a(new_n63_), .b(x04), .c(x08), .O(new_n95_));
  nand2  g51(.a(new_n63_), .b(x09), .O(new_n96_));
  ...
  nand2  g55(.a(new_n86_), .b(new_n45_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(x22), .c(new_n48_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n99_), .c(new_n97_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n95_), .O(z13));
  ...
  oai21  g66(.a(new_n110_), .b(new_n96_), .c(new_n64_), .O(z14));
  ...
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(new_n97_), .O(new_n117_));
  ...
  nand3  g80(.a(x10), .b(x08), .c(x07), .O(new_n125_));
