...
module FAU ( 
  ...
  nand2  g01(.a(new_n45_), .b(x02), .O(new_n46_));
  ...
  nand3  g15(.a(x17), .b(x08), .c(x02), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(z03));
  nand3  g17(.a(new_n46_), .b(x08), .c(x03), .O(new_n62_));
  ...
  oai21  g40(.a(x20), .b(x19), .c(new_n73_), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(z10));
  ...
  oai21  g45(.a(new_n80_), .b(x21), .c(new_n73_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n89_), .c(new_n60_), .O(z11));
  ...
  inv1   g51(.a(new_n73_), .O(new_n96_));
  inv1   g52(.a(new_n52_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(x23), .O(new_n98_));
  inv1   g54(.a(x23), .O(new_n99_));
  nand2  g55(.a(new_n52_), .b(new_n99_), .O(new_n100_));
  aoi22  g56(.a(new_n100_), .b(new_n98_), .c(new_n79_), .d(x15), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n96_), .c(new_n64_), .O(z13));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand4  g60(.a(new_n74_), .b(new_n80_), .c(x24), .d(x23), .O(new_n105_));
  inv1   g61(.a(x24), .O(new_n106_));
  nand2  g62(.a(new_n98_), .b(new_n106_), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n96_), .c(new_n66_), .O(z14));
  nand3  g65(.a(x26), .b(x25), .c(x17), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand4  g67(.a(new_n97_), .b(x25), .c(x24), .d(x23), .O(new_n112_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n49_), .c(new_n69_), .O(z15));
  ...
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n73_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n71_), .O(z16));
endmodule
