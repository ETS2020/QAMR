...
module FAU ( 
  ...
  nand2  g41(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  nand3  g42(.a(new_n86_), .b(new_n84_), .c(new_n46_), .O(new_n87_));
  ...
  aoi21  g49(.a(new_n82_), .b(new_n93_), .c(new_n50_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n62_), .c(new_n57_), .O(z11));
  inv1   g52(.a(new_n76_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(x14), .c(new_n53_), .O(new_n98_));
  oai21  g54(.a(new_n90_), .b(x22), .c(new_n84_), .O(new_n99_));
  and2   g55(.a(new_n64_), .b(new_n46_), .O(new_n100_));
  ...
  aoi21  g62(.a(new_n54_), .b(x24), .c(new_n50_), .O(new_n107_));
  oai21  g63(.a(new_n54_), .b(x24), .c(new_n107_), .O(new_n108_));
  oai21  g64(.a(new_n51_), .b(new_n45_), .c(x16), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n108_), .c(new_n68_), .O(z14));
  aoi21  g66(.a(new_n54_), .b(x24), .c(x25), .O(new_n111_));
  ...
  nor2   g71(.a(new_n115_), .b(new_n50_), .O(new_n116_));
  nor2   g72(.a(new_n116_), .b(z07), .O(new_n117_));
  oai21  g73(.a(new_n114_), .b(new_n111_), .c(new_n117_), .O(z15));
  inv1   g74(.a(x26), .O(new_n119_));
  nand2  g75(.a(new_n113_), .b(new_n119_), .O(new_n120_));
  nor2   g76(.a(new_n53_), .b(x18), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n97_), .c(new_n50_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n72_), .c(new_n57_), .O(z16));
endmodule
