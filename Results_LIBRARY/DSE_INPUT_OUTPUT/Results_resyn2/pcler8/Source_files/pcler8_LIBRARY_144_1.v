...
module FAU ( 
  ...
  nor2   g08(.a(new_n49_), .b(x07), .O(new_n53_));
  inv1   g09(.a(new_n53_), .O(new_n54_));
  nand2  g10(.a(new_n54_), .b(x08), .O(new_n55_));
  nor2   g11(.a(new_n55_), .b(new_n52_), .O(z01));
  inv1   g12(.a(x01), .O(new_n57_));
  nor2   g13(.a(new_n55_), .b(new_n57_), .O(z02));
  inv1   g14(.a(x02), .O(new_n59_));
  oai21  g15(.a(new_n48_), .b(new_n59_), .c(new_n54_), .O(z03));
  inv1   g16(.a(x03), .O(new_n61_));
  nor2   g17(.a(new_n55_), .b(new_n61_), .O(z04));
  nand2  g18(.a(x08), .b(x04), .O(new_n63_));
  nand2  g19(.a(new_n63_), .b(new_n54_), .O(z05));
  nor2   g20(.a(new_n53_), .b(new_n48_), .O(new_n65_));
  nand2  g21(.a(new_n65_), .b(x05), .O(new_n66_));
  inv1   g22(.a(new_n66_), .O(z06));
  nand2  g23(.a(new_n65_), .b(x06), .O(new_n68_));
  ...
  aoi21  g32(.a(x08), .b(x00), .c(new_n53_), .O(new_n77_));
  ...
  oai21  g40(.a(new_n55_), .b(new_n57_), .c(new_n84_), .O(z10));
  ...
  oai21  g45(.a(new_n79_), .b(x21), .c(new_n72_), .O(new_n90_));
  oai22  g46(.a(new_n90_), .b(new_n89_), .c(new_n55_), .d(new_n59_), .O(z11));
  inv1   g47(.a(new_n87_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x22), .O(new_n93_));
  aoi21  g49(.a(new_n86_), .b(x14), .c(new_n93_), .O(new_n94_));
  oai21  g50(.a(new_n92_), .b(x22), .c(new_n72_), .O(new_n95_));
  aoi21  g51(.a(x08), .b(x03), .c(new_n53_), .O(new_n96_));
  ...
  nand3  g59(.a(new_n103_), .b(new_n63_), .c(new_n54_), .O(z13));
  ...
  nand4  g82(.a(new_n126_), .b(new_n86_), .c(x19), .d(new_n124_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n72_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n123_), .c(new_n70_), .O(z16));
endmodule
