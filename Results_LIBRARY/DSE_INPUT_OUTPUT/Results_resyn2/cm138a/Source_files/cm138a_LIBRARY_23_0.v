...
module FAU ( 
  ...
  oai21  g14(.a(new_n28_), .b(new_n18_), .c(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n27_), .O(z2));
  oai21  g16(.a(new_n28_), .b(new_n24_), .c(x1), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n27_), .O(z3));
  nand2  g18(.a(x2), .b(new_n16_), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n21_), .c(x3), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(z4));
  nand2  g21(.a(x2), .b(x0), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n21_), .c(x3), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(z5));
  inv1   g24(.a(new_n28_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(x2), .c(x1), .d(new_n16_), .O(z6));
  oai21  g26(.a(new_n36_), .b(new_n28_), .c(x1), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n27_), .O(z7));
endmodule
