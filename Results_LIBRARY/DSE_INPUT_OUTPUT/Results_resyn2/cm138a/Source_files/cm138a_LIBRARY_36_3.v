...
module FAU ( 
  ...
  nand2  g08(.a(new_n18_), .b(x2), .O(new_n23_));
  ...
  oai21  g20(.a(new_n24_), .b(new_n34_), .c(new_n18_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z5));
  oai21  g22(.a(new_n27_), .b(new_n34_), .c(new_n18_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z6));
  oai21  g24(.a(new_n30_), .b(new_n34_), .c(new_n18_), .O(new_n39_));
