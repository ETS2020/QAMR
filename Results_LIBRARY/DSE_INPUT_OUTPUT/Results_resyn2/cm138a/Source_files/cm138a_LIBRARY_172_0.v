...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_;
  ...
  nand2  g10(.a(new_n16_), .b(new_n23_), .O(z4));
  nand2  g11(.a(x1), .b(x0), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(z4), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n21_), .O(z3));
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n16_), .O(z5));
  nand2  g17(.a(new_n30_), .b(x1), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n23_), .O(z6));
  nand2  g19(.a(new_n31_), .b(new_n28_), .O(z7));
  one    g20(.O(z0));
endmodule
