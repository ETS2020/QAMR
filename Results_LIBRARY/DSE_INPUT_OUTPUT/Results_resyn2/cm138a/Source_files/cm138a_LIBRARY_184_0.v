...
module FAU ( 
  ...
  nand4  g10(.a(new_n24_), .b(new_n20_), .c(new_n16_), .d(new_n18_), .O(z3));
  inv1   g11(.a(x4), .O(new_n26_));
  nand4  g12(.a(new_n26_), .b(x3), .c(x2), .d(new_n23_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(z6));
  nand4  g15(.a(new_n24_), .b(new_n20_), .c(new_n16_), .d(x2), .O(z7));
  buf    g16(.a(x0), .O(z1));
