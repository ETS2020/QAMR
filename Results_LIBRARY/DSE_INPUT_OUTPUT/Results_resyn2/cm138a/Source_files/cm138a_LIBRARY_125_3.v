...
module FAU ( 
  ...
  oai21  g10(.a(new_n24_), .b(new_n20_), .c(new_n16_), .O(new_n25_));
  ...
  oai21  g14(.a(new_n24_), .b(new_n28_), .c(new_n18_), .O(new_n29_));
  ...
  nand2  g18(.a(new_n16_), .b(x0), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n23_), .O(z4));
  inv1   g20(.a(new_n31_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n16_), .c(x0), .O(z5));
