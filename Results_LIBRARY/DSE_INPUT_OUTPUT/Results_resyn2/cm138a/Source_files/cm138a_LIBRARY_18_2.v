...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n36_, new_n38_;
  ...
  nand4  g10(.a(new_n15_), .b(new_n16_), .c(new_n18_), .d(x0), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n24_), .O(z1));
  nand4  g13(.a(x3), .b(new_n19_), .c(x1), .d(new_n17_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z2));
  nor2   g16(.a(x4), .b(new_n17_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n24_), .c(new_n15_), .d(x1), .O(z3));
  ...
  nor2   g21(.a(new_n23_), .b(new_n19_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n26_), .O(z5));
  nor2   g23(.a(x5), .b(x4), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n36_), .c(x1), .d(new_n17_), .O(z6));
  nand4  g25(.a(new_n38_), .b(new_n36_), .c(x1), .d(x0), .O(z7));
endmodule
