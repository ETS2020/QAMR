...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_, new_n34_;
  ...
  nand2  g09(.a(new_n20_), .b(x1), .O(new_n24_));
  nand2  g10(.a(x1), .b(new_n15_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(z1), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n24_), .O(z2));
  nand2  g13(.a(new_n24_), .b(x0), .O(z3));
  ...
  nand3  g18(.a(new_n32_), .b(x1), .c(new_n15_), .O(z6));
