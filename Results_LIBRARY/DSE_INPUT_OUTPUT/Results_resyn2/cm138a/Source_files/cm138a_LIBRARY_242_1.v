...
module FAU ( 
  ...
  nand4  g15(.a(new_n28_), .b(new_n27_), .c(x1), .d(x0), .O(z3));
  ...
  nand4  g24(.a(new_n38_), .b(new_n28_), .c(x1), .d(new_n17_), .O(z6));
  nand2  g25(.a(x1), .b(x0), .O(new_n40_));
  oai21  g26(.a(new_n37_), .b(new_n40_), .c(new_n16_), .O(new_n41_));
