...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n17_), .c(new_n23_), .d(x0), .O(z1));
  inv1   g12(.a(new_n20_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n17_), .c(x1), .O(z2));
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x3), .d(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n17_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x0), .O(z3));
  nand3  g17(.a(new_n27_), .b(x2), .c(new_n23_), .O(z4));
  nand3  g18(.a(new_n27_), .b(x2), .c(x1), .O(z6));
  one    g19(.O(z5));
  one    g20(.O(z7));
endmodule
