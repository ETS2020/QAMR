...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n27_, new_n30_, new_n32_;
  ...
  nand3  g11(.a(new_n21_), .b(new_n16_), .c(x1), .O(z2));
  xor2a  g12(.a(x2), .b(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n24_), .O(z3));
  nand2  g14(.a(x2), .b(new_n15_), .O(z4));
  nand2  g15(.a(new_n20_), .b(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x2), .O(z6));
  inv1   g17(.a(new_n23_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(x2), .c(x1), .O(z7));
  nand2  g19(.a(x2), .b(new_n15_), .O(z5));
endmodule
