...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n35_, new_n39_;
  ...
  nand4  g21(.a(new_n35_), .b(new_n15_), .c(new_n17_), .d(new_n16_), .O(z4));
  nand3  g22(.a(new_n35_), .b(new_n26_), .c(new_n15_), .O(z5));
  nand4  g23(.a(new_n35_), .b(new_n15_), .c(x1), .d(new_n16_), .O(z6));
  oai21  g24(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(new_n39_));
