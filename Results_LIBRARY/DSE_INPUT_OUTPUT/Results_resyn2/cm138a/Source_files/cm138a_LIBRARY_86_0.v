...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n36_, new_n37_, new_n38_, new_n40_;
  ...
  nand3  g09(.a(new_n23_), .b(new_n19_), .c(x0), .O(new_n24_));
  ...
  nand4  g16(.a(new_n23_), .b(new_n19_), .c(x3), .d(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n27_), .O(z3));
  nor2   g19(.a(new_n17_), .b(x1), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n21_), .c(new_n15_), .O(z4));
  inv1   g21(.a(x3), .O(new_n36_));
  nor2   g22(.a(x4), .b(new_n36_), .O(new_n37_));
  nor2   g23(.a(x5), .b(new_n15_), .O(new_n38_));
  nand3  g24(.a(new_n34_), .b(new_n38_), .c(new_n37_), .O(z5));
  nor2   g25(.a(new_n17_), .b(new_n16_), .O(new_n40_));
  nand3  g26(.a(new_n40_), .b(new_n21_), .c(new_n15_), .O(z6));
  nand3  g27(.a(new_n40_), .b(new_n38_), .c(new_n37_), .O(z7));
endmodule
