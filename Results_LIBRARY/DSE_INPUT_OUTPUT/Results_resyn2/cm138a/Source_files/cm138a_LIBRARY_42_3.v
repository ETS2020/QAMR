...
module FAU ( 
  ...
  nor2   g15(.a(new_n16_), .b(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n21_), .O(z4));
  nor2   g17(.a(new_n16_), .b(new_n15_), .O(new_n32_));
  nor2   g18(.a(new_n18_), .b(new_n17_), .O(new_n33_));
  aoi21  g19(.a(new_n32_), .b(new_n21_), .c(new_n33_), .O(z5));
  nand4  g20(.a(new_n19_), .b(new_n18_), .c(x3), .d(x1), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n30_), .O(z6));
  nand2  g23(.a(new_n36_), .b(new_n32_), .O(z7));
endmodule
