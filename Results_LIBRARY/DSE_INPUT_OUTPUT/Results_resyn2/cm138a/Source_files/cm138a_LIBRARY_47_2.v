...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n30_, new_n33_;
  ...
  xor2a  g13(.a(x2), .b(x1), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n24_), .O(z5));
  nand3  g15(.a(new_n28_), .b(x2), .c(x1), .O(z6));
  inv1   g16(.a(new_n23_), .O(new_n33_));
  nand3  g17(.a(new_n33_), .b(x2), .c(x1), .O(z7));
  one    g18(.O(z2));
  one    g19(.O(z3));
endmodule
