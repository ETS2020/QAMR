...
module FAU ( 
  ...
  nor2   g13(.a(new_n19_), .b(new_n15_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n25_), .c(new_n16_), .d(new_n18_), .O(z6));
  nand4  g15(.a(new_n28_), .b(new_n25_), .c(new_n16_), .d(x0), .O(z7));
