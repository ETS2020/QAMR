...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n35_, new_n37_, new_n39_, new_n40_;
  ...
  nand4  g16(.a(new_n28_), .b(new_n15_), .c(x1), .d(x0), .O(z3));
  ...
  oai21  g20(.a(new_n32_), .b(new_n25_), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n23_), .O(z5));
  inv1   g22(.a(new_n32_), .O(new_n37_));
  nand3  g23(.a(new_n37_), .b(new_n29_), .c(new_n15_), .O(z6));
  nand2  g24(.a(x1), .b(x0), .O(new_n39_));
  oai21  g25(.a(new_n32_), .b(new_n39_), .c(new_n15_), .O(new_n40_));
