...
module FAU ( 
  ...
  nand3  g11(.a(new_n25_), .b(new_n21_), .c(new_n17_), .O(z2));
  nor2   g12(.a(x5), .b(new_n17_), .O(new_n27_));
  ...
  nand2  g18(.a(new_n18_), .b(x3), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n32_), .c(new_n19_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x2), .O(z4));
  inv1   g21(.a(new_n33_), .O(new_n36_));
  nand3  g22(.a(new_n27_), .b(new_n23_), .c(new_n36_), .O(z5));
  nand3  g23(.a(new_n27_), .b(new_n25_), .c(new_n36_), .O(z6));
  oai21  g24(.a(new_n29_), .b(new_n33_), .c(new_n19_), .O(new_n39_));
