...
module FAU ( 
  ...
  nand2  g13(.a(x2), .b(new_n27_), .O(z5));
  nand2  g14(.a(new_n25_), .b(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(z5), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n26_), .O(z2));
  nand2  g17(.a(new_n22_), .b(new_n25_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n30_), .O(z3));
  nor2   g19(.a(new_n25_), .b(new_n27_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n20_), .O(z6));
  nand2  g21(.a(new_n35_), .b(new_n23_), .O(z7));
  one    g22(.O(z4));
endmodule
