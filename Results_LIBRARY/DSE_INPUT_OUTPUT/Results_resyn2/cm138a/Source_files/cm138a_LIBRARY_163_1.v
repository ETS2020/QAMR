...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n28_, new_n29_, new_n30_, new_n31_, new_n33_, new_n34_;
  ...
  nand4  g13(.a(new_n29_), .b(new_n28_), .c(x3), .d(new_n21_), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(x1), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(x2), .O(z6));
  nand4  g16(.a(new_n29_), .b(new_n28_), .c(x3), .d(x0), .O(new_n33_));
