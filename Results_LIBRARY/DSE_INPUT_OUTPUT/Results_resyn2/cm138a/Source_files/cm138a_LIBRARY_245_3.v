...
module FAU ( 
  ...
  oai21  g16(.a(new_n25_), .b(new_n28_), .c(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z3));
  inv1   g18(.a(new_n22_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(x2), .c(new_n17_), .d(new_n18_), .O(z4));
  nand2  g20(.a(x2), .b(x0), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n22_), .c(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(z5));
  nand4  g23(.a(new_n33_), .b(x2), .c(x1), .d(new_n18_), .O(z6));
  oai21  g24(.a(new_n35_), .b(new_n28_), .c(new_n15_), .O(new_n39_));
