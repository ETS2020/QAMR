...
module FAU ( 
  ...
  nand4  g16(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n31_));
  inv1   g17(.a(new_n31_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n15_), .O(z4));
  nand4  g19(.a(x3), .b(x2), .c(new_n22_), .d(x0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n18_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n17_), .O(z5));
  nand4  g22(.a(x3), .b(x2), .c(x1), .d(new_n24_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n18_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n17_), .O(z6));
  nand3  g25(.a(new_n32_), .b(x1), .c(x0), .O(z7));
endmodule
