...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n28_, new_n32_, new_n34_;
  ...
  nand2  g15(.a(new_n20_), .b(x1), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(x2), .O(z6));
  inv1   g17(.a(new_n23_), .O(new_n34_));
  nand3  g18(.a(new_n34_), .b(x2), .c(x1), .O(z7));
  one    g19(.O(z4));
  one    g20(.O(z5));
endmodule
