...
module FAU ( 
  ...
  nand3  g16(.a(new_n30_), .b(new_n20_), .c(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x3), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x1), .O(z3));
  nand3  g19(.a(new_n30_), .b(x2), .c(new_n19_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x3), .O(new_n35_));
  xor2a  g21(.a(x3), .b(x1), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(z4));
  nand4  g23(.a(new_n28_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand2  g24(.a(new_n35_), .b(x1), .O(z6));
  inv1   g25(.a(new_n23_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n30_), .c(x2), .d(x0), .O(z7));
endmodule
