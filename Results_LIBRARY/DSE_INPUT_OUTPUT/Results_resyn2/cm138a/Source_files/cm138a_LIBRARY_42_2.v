...
module FAU ( 
  ...
  nand4  g09(.a(new_n18_), .b(new_n17_), .c(new_n22_), .d(x2), .O(z4));
  inv1   g10(.a(x5), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(x3), .c(x2), .d(x0), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n20_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n22_), .O(z5));
  nand2  g14(.a(new_n22_), .b(x1), .O(z3));
  buf    g15(.a(x0), .O(z6));
  buf    g16(.a(x0), .O(z7));
endmodule
