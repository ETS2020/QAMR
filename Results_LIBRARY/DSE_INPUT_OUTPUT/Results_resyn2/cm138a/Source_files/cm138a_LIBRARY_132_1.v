...
module FAU ( 
  ...
  nand4  g23(.a(new_n37_), .b(new_n25_), .c(new_n18_), .d(x0), .O(z5));
  nand4  g24(.a(new_n37_), .b(new_n25_), .c(x1), .d(new_n17_), .O(z6));
  nand2  g25(.a(x1), .b(x0), .O(new_n40_));
  oai21  g26(.a(new_n36_), .b(new_n40_), .c(new_n16_), .O(new_n41_));
