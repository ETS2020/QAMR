...
module FAU ( 
  ...
  nand4  g06(.a(new_n20_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(z2));
  and2   g07(.a(x1), .b(x0), .O(new_n22_));
  nand4  g08(.a(new_n22_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(z3));
  nand2  g09(.a(x3), .b(new_n19_), .O(z5));
  nand4  g10(.a(new_n20_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g11(.a(new_n22_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z7));
  buf    g12(.a(x0), .O(z0));
  buf    g13(.a(x0), .O(z1));
  buf    g14(.a(x0), .O(z4));
endmodule
