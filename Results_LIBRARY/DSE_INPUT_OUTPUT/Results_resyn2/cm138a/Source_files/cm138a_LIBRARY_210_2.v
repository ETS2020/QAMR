...
module FAU ( 
  ...
  nand3  g10(.a(new_n20_), .b(x1), .c(x0), .O(z3));
  nand4  g11(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n27_));
  inv1   g12(.a(new_n27_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n15_), .O(z4));
  nand2  g14(.a(new_n23_), .b(x0), .O(z5));
  nand2  g15(.a(new_n27_), .b(x1), .O(new_n31_));
  xor2a  g16(.a(x1), .b(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n31_), .O(z6));
  nand2  g18(.a(new_n31_), .b(x0), .O(z7));
  one    g19(.O(z1));
endmodule
