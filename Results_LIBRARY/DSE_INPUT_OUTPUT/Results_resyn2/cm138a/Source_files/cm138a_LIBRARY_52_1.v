...
module FAU ( 
  ...
  nand3  g15(.a(new_n29_), .b(new_n18_), .c(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(x3), .b(x0), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n24_), .O(z2));
  inv1   g19(.a(new_n30_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(x3), .c(x0), .O(z3));
  ...
  nand4  g25(.a(new_n39_), .b(x3), .c(new_n16_), .d(x0), .O(z5));
  nand4  g26(.a(new_n39_), .b(x3), .c(x1), .d(new_n15_), .O(z6));
  nand2  g27(.a(x1), .b(x0), .O(new_n42_));
  oai21  g28(.a(new_n42_), .b(new_n36_), .c(x3), .O(new_n43_));
  nand2  g29(.a(new_n43_), .b(new_n24_), .O(z7));
endmodule
