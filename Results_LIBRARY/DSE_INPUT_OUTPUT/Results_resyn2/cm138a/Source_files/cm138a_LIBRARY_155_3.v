...
module FAU ( 
  ...
  nand2  g04(.a(new_n18_), .b(z6), .O(new_n19_));
  ...
  nand4  g11(.a(new_n22_), .b(new_n21_), .c(x3), .d(x0), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n17_), .c(new_n16_), .O(z1));
  nand2  g14(.a(new_n23_), .b(new_n17_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x1), .O(z2));
  nand2  g16(.a(new_n26_), .b(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z3));
  nand2  g18(.a(new_n24_), .b(x2), .O(z4));
  nand3  g19(.a(new_n27_), .b(x2), .c(new_n16_), .O(z5));
  one    g20(.O(z7));
endmodule
