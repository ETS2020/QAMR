...
module FAU ( 
  ...
  nand3  g08(.a(new_n19_), .b(new_n16_), .c(x3), .O(new_n23_));
  ...
  oai21  g18(.a(new_n32_), .b(new_n23_), .c(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n26_), .O(z4));
  xnor2a g20(.a(x4), .b(x1), .O(new_n35_));
  ...
  nand4  g24(.a(new_n30_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand2  g25(.a(new_n37_), .b(x1), .O(z7));
endmodule
