...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n25_, new_n27_, new_n29_, new_n32_, new_n33_;
  ...
  xnor2a g12(.a(x3), .b(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n21_), .O(z2));
  nor2   g14(.a(new_n24_), .b(new_n15_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n23_), .c(new_n17_), .d(x0), .O(z3));
  nand4  g16(.a(new_n25_), .b(new_n23_), .c(x2), .d(new_n16_), .O(z4));
  nand4  g17(.a(new_n19_), .b(new_n18_), .c(x2), .d(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x3), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(z5));
  nand4  g20(.a(new_n29_), .b(new_n23_), .c(x2), .d(new_n16_), .O(z6));
  nand2  g21(.a(new_n33_), .b(new_n27_), .O(z7));
endmodule
