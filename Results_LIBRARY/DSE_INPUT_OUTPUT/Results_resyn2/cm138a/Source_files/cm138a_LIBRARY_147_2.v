...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n37_, new_n39_;
  ...
  nor2   g11(.a(x2), .b(new_n19_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(new_n20_), .O(z1));
  inv1   g13(.a(new_n26_), .O(new_n28_));
  nand4  g14(.a(new_n17_), .b(new_n16_), .c(x3), .d(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n28_), .c(new_n23_), .O(z2));
  nand3  g17(.a(new_n17_), .b(new_n16_), .c(x1), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n26_), .c(x3), .O(z3));
  nand4  g20(.a(new_n25_), .b(x2), .c(new_n20_), .d(new_n19_), .O(z4));
  nand4  g21(.a(new_n25_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  nor2   g22(.a(new_n23_), .b(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n33_), .O(z6));
  oai21  g24(.a(new_n32_), .b(new_n19_), .c(x3), .O(new_n39_));
