...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n25_, new_n28_, new_n29_, new_n31_;
  ...
  nor2   g10(.a(new_n22_), .b(x0), .O(new_n25_));
  ...
  nand2  g15(.a(new_n28_), .b(new_n22_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x0), .O(z5));
  nand2  g17(.a(new_n29_), .b(new_n25_), .O(z6));
  one    g18(.O(z3));
  one    g19(.O(z7));
endmodule
