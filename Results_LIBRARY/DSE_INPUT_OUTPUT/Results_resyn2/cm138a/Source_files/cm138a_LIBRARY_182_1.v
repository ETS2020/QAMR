...
module FAU ( 
  ...
  nor2   g14(.a(x5), .b(new_n16_), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n29_), .c(new_n15_), .O(z4));
  nand3  g16(.a(new_n30_), .b(new_n23_), .c(new_n29_), .O(z5));
  nand4  g17(.a(new_n30_), .b(new_n29_), .c(x1), .d(x0), .O(z7));
  one    g18(.O(z2));
  one    g19(.O(z6));
endmodule
