...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n25_, new_n28_, new_n30_, new_n31_;
  ...
  aoi21  g11(.a(new_n23_), .b(new_n20_), .c(new_n25_), .O(z1));
  nor2   g12(.a(new_n24_), .b(new_n22_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n20_), .O(z3));
  nand4  g14(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n30_));
  inv1   g15(.a(new_n30_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n15_), .O(z4));
  aoi21  g17(.a(new_n31_), .b(new_n23_), .c(new_n25_), .O(z5));
  nand2  g18(.a(new_n31_), .b(new_n28_), .O(z7));
  one    g19(.O(z2));
  one    g20(.O(z6));
endmodule
