...
module FAU ( 
  ...
  nand2  g16(.a(new_n28_), .b(x1), .O(new_n32_));
  nand2  g17(.a(x1), .b(new_n16_), .O(new_n33_));
  nand2  g18(.a(z5), .b(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n32_), .O(z6));
  nand2  g20(.a(new_n32_), .b(x0), .O(z7));
  one    g21(.O(z1));
endmodule
