...
module FAU ( 
  ...
  nand4  g14(.a(new_n22_), .b(new_n21_), .c(x3), .d(x2), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n17_), .c(new_n16_), .O(z4));
  nand3  g17(.a(new_n30_), .b(new_n17_), .c(x0), .O(z5));
  nand2  g18(.a(new_n29_), .b(new_n16_), .O(new_n33_));
