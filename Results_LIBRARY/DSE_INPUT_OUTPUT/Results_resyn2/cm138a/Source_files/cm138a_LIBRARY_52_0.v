...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n36_, new_n39_, new_n40_;
  ...
  nand4  g17(.a(new_n31_), .b(new_n29_), .c(x1), .d(x0), .O(z3));
  ...
  nand4  g22(.a(new_n36_), .b(new_n31_), .c(new_n17_), .d(x0), .O(z5));
  nand4  g23(.a(new_n36_), .b(new_n31_), .c(x1), .d(new_n16_), .O(z6));
