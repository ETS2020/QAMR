...
module FAU ( 
  ...
  nand2  g10(.a(new_n25_), .b(x0), .O(z5));
  nand2  g11(.a(x1), .b(new_n23_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(z5), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n24_), .O(z2));
  nor2   g14(.a(new_n25_), .b(new_n23_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n20_), .O(z3));
  inv1   g16(.a(x3), .O(new_n32_));
  nor2   g17(.a(x4), .b(new_n32_), .O(new_n33_));
  nand4  g18(.a(new_n33_), .b(new_n15_), .c(new_n18_), .d(x2), .O(z4));
  inv1   g19(.a(new_n27_), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n33_), .c(new_n18_), .d(x2), .O(z6));
  nand4  g21(.a(new_n30_), .b(new_n33_), .c(new_n18_), .d(x2), .O(z7));
  one    g22(.O(z1));
endmodule
