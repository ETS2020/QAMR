...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(new_n17_), .d(x1), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  inv1   g13(.a(x3), .O(new_n28_));
  nor2   g14(.a(new_n28_), .b(x0), .O(new_n29_));
  aoi21  g15(.a(new_n29_), .b(new_n27_), .c(new_n23_), .O(z2));
  nor2   g16(.a(new_n28_), .b(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n27_), .O(z3));
  nand4  g18(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n16_), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  aoi21  g20(.a(new_n34_), .b(new_n29_), .c(new_n23_), .O(z4));
  nand2  g21(.a(new_n34_), .b(new_n31_), .O(z5));
  nand3  g22(.a(new_n18_), .b(x2), .c(x1), .O(new_n37_));
  inv1   g23(.a(new_n37_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n29_), .O(z6));
