...
module FAU ( 
  ...
  nand2  g08(.a(new_n16_), .b(x1), .O(new_n23_));
  ...
  nand4  g18(.a(new_n28_), .b(x2), .c(new_n15_), .d(new_n19_), .O(z4));
  nand4  g19(.a(new_n28_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand2  g20(.a(x2), .b(new_n19_), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n30_), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x1), .O(z6));
  nand4  g23(.a(new_n28_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
