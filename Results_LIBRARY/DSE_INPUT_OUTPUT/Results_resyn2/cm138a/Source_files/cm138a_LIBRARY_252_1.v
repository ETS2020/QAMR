...
module FAU ( 
  ...
  nand4  g14(.a(new_n28_), .b(new_n27_), .c(new_n19_), .d(new_n16_), .O(z2));
  nor2   g15(.a(new_n15_), .b(new_n17_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n27_), .c(new_n19_), .d(new_n16_), .O(z3));
  nand2  g17(.a(x2), .b(new_n15_), .O(z4));
  nand4  g18(.a(new_n28_), .b(new_n27_), .c(new_n19_), .d(x2), .O(z6));
  nand4  g19(.a(new_n30_), .b(new_n27_), .c(new_n19_), .d(x2), .O(z7));
