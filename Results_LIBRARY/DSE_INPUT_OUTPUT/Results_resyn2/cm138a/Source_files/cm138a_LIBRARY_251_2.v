...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n25_, new_n26_, new_n29_, new_n30_, new_n32_, new_n34_;
  ...
  nand2  g16(.a(new_n29_), .b(z5), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n26_), .O(z6));
  nand2  g18(.a(new_n29_), .b(x1), .O(new_n34_));
