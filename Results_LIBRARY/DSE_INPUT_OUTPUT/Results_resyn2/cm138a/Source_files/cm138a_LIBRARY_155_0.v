...
module FAU ( 
  ...
  nand3  g14(.a(new_n21_), .b(new_n20_), .c(x3), .O(new_n30_));
  inv1   g15(.a(new_n30_), .O(new_n31_));
  nand4  g16(.a(new_n31_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand2  g17(.a(x2), .b(x1), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(z0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n23_), .O(z6));
  inv1   g20(.a(new_n25_), .O(new_n36_));
