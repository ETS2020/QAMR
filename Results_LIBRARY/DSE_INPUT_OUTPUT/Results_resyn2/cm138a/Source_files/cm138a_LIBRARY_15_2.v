...
module FAU ( 
  ...
  nor2   g08(.a(new_n21_), .b(x0), .O(new_n23_));
  nand4  g09(.a(new_n23_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(z2));
  and2   g10(.a(x1), .b(x0), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(z3));
  nand4  g12(.a(new_n19_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z4));
  nand4  g13(.a(new_n23_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g14(.a(new_n25_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z7));
  nand2  g15(.a(new_n21_), .b(x0), .O(z5));
endmodule
