...
module FAU ( 
  ...
  nand3  g15(.a(new_n29_), .b(new_n17_), .c(x0), .O(z3));
  nand4  g16(.a(new_n19_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x3), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z4));
  nand4  g19(.a(new_n19_), .b(new_n18_), .c(new_n16_), .d(x0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z5));
  nand4  g22(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
