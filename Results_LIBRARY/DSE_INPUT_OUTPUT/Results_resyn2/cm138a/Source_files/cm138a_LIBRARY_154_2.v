...
module FAU ( 
  ...
  nand3  g14(.a(new_n28_), .b(new_n15_), .c(x2), .O(z4));
  nand2  g15(.a(x2), .b(x0), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n27_), .c(new_n22_), .O(new_n31_));
  nand2  g17(.a(x3), .b(x1), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z5));
  nand3  g19(.a(new_n24_), .b(new_n28_), .c(x2), .O(z6));
  nand4  g20(.a(new_n28_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
