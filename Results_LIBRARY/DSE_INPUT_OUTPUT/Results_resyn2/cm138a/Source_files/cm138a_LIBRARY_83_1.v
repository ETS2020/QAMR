...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n27_, new_n32_, new_n33_, new_n35_;
  ...
  oai21  g11(.a(new_n16_), .b(x0), .c(new_n17_), .O(new_n26_));
  nand2  g12(.a(new_n20_), .b(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n26_), .O(z2));
  nand3  g14(.a(new_n24_), .b(new_n17_), .c(x1), .O(z3));
  nand2  g15(.a(x2), .b(new_n16_), .O(z5));
  nand3  g16(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n32_));
  inv1   g17(.a(new_n32_), .O(new_n33_));
  nand4  g18(.a(new_n33_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
