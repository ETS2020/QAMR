...
module FAU ( 
  ...
  nand4  g13(.a(new_n19_), .b(new_n17_), .c(new_n16_), .d(x2), .O(z4));
  nand4  g14(.a(new_n22_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z5));
  nand4  g15(.a(new_n25_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z6));
  one    g16(.O(z7));
endmodule
