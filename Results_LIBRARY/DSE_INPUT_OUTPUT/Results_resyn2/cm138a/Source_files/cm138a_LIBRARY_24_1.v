...
module FAU ( 
  ...
  and2   g10(.a(x3), .b(x0), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(new_n18_), .d(x1), .O(z3));
  ...
  nand4  g15(.a(new_n25_), .b(new_n24_), .c(x2), .d(x1), .O(z7));
  nand2  g16(.a(x3), .b(new_n15_), .O(z2));
