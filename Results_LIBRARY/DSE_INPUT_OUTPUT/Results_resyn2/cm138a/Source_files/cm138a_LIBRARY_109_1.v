...
module FAU ( 
  ...
  nand4  g12(.a(new_n26_), .b(new_n25_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g13(.a(new_n18_), .b(x3), .c(x1), .d(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n19_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n17_), .O(z3));
  inv1   g16(.a(new_n26_), .O(new_n31_));
  nand2  g17(.a(new_n16_), .b(new_n15_), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n20_), .c(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n31_), .O(z4));
  nand2  g20(.a(new_n16_), .b(x0), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n20_), .c(x2), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n31_), .O(z5));
  nor2   g23(.a(x5), .b(new_n17_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n25_), .c(x1), .d(new_n15_), .O(z6));
  xor2a  g25(.a(x5), .b(x2), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n29_), .O(z7));
endmodule
