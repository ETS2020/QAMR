...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n34_;
  ...
  nor2   g15(.a(new_n17_), .b(new_n16_), .O(new_n31_));
  inv1   g16(.a(new_n31_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n30_), .c(new_n29_), .O(z4));
  inv1   g18(.a(new_n28_), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n16_), .c(x0), .O(z5));
  nand3  g20(.a(new_n31_), .b(new_n21_), .c(new_n15_), .O(z6));
  nand3  g21(.a(new_n31_), .b(new_n21_), .c(x0), .O(z7));
  one    g22(.O(z3));
endmodule
