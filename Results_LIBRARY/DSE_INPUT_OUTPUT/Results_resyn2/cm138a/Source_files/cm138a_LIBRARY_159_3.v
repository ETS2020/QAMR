...
module FAU ( 
  ...
  nand4  g09(.a(new_n19_), .b(x3), .c(new_n16_), .d(new_n15_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n18_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x1), .O(z2));
  nand4  g12(.a(new_n19_), .b(x3), .c(new_n16_), .d(x0), .O(new_n27_));
  ...
  nand2  g17(.a(new_n18_), .b(x1), .O(new_n32_));
  nand2  g18(.a(new_n17_), .b(x0), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(z4));
  inv1   g20(.a(new_n30_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n17_), .c(x0), .O(z5));
  nand3  g22(.a(new_n35_), .b(x1), .c(new_n15_), .O(z6));
  nand3  g23(.a(new_n35_), .b(x1), .c(x0), .O(z7));
endmodule
