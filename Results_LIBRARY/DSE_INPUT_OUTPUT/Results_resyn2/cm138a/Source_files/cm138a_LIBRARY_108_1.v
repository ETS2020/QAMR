...
module FAU ( 
  ...
  nand4  g15(.a(new_n19_), .b(x3), .c(x1), .d(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n15_), .O(z3));
  xor2a  g18(.a(x5), .b(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n21_), .O(z4));
  nand2  g20(.a(new_n33_), .b(new_n24_), .O(z5));
  nand4  g21(.a(new_n28_), .b(new_n27_), .c(new_n16_), .d(x2), .O(z6));
  nand2  g22(.a(new_n33_), .b(new_n31_), .O(z7));
endmodule
