...
module FAU ( 
  ...
  nand3  g10(.a(x3), .b(x1), .c(x0), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n24_), .c(new_n18_), .O(z3));
  nand4  g13(.a(new_n20_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x3), .O(z6));
  nand3  g16(.a(new_n26_), .b(new_n24_), .c(x2), .O(z7));
  buf    g17(.a(x0), .O(z0));
  buf    g18(.a(x0), .O(z4));
