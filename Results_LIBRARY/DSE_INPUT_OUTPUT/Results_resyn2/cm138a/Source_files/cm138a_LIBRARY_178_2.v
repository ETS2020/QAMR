...
module FAU ( 
  ...
  nand2  g12(.a(x2), .b(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(z1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n21_), .O(z4));
  inv1   g15(.a(new_n20_), .O(new_n30_));
  nor2   g16(.a(new_n15_), .b(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z5));
  nand2  g18(.a(new_n28_), .b(new_n25_), .O(z6));
  inv1   g19(.a(new_n24_), .O(new_n34_));
  nand2  g20(.a(new_n31_), .b(new_n34_), .O(z7));
