...
module FAU ( 
  ...
  nand4  g10(.a(new_n24_), .b(new_n23_), .c(x3), .d(new_n19_), .O(z1));
  ...
  nand4  g18(.a(new_n23_), .b(new_n32_), .c(x3), .d(x2), .O(z4));
  ...
  nand2  g26(.a(x3), .b(x2), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n40_), .c(new_n16_), .O(new_n42_));
