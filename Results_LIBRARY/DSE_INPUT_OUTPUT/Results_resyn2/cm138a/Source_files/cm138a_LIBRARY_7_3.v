...
module FAU ( 
  ...
  nand2  g12(.a(new_n24_), .b(new_n20_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x0), .O(z3));
  xnor2a g14(.a(x5), .b(x0), .O(new_n29_));
  inv1   g15(.a(x1), .O(new_n30_));
  nand4  g16(.a(new_n23_), .b(x3), .c(x2), .d(new_n30_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n20_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n29_), .O(z4));
  nand2  g19(.a(new_n32_), .b(x0), .O(z5));
  nand4  g20(.a(new_n23_), .b(x3), .c(x2), .d(x1), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n20_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n29_), .O(z6));
  nand2  g23(.a(new_n36_), .b(x0), .O(z7));
endmodule
