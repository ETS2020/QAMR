...
module FAU ( 
  ...
  oai21  g18(.a(new_n24_), .b(new_n32_), .c(new_n18_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x2), .O(z5));
  nand2  g20(.a(x1), .b(new_n15_), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n32_), .c(new_n18_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z6));
  oai21  g23(.a(new_n28_), .b(new_n32_), .c(new_n18_), .O(new_n38_));
