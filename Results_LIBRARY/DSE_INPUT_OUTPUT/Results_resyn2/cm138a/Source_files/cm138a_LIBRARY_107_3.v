...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n36_, new_n37_, new_n40_, new_n41_;
  ...
  nor3   g13(.a(x5), .b(x2), .c(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(x1), .O(z2));
  nand4  g15(.a(new_n15_), .b(new_n19_), .c(x3), .d(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n24_), .O(z3));
  nand3  g18(.a(new_n15_), .b(x2), .c(new_n23_), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n27_), .c(new_n18_), .O(z4));
  nand4  g21(.a(new_n19_), .b(x3), .c(new_n18_), .d(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z5));
  nand3  g24(.a(new_n34_), .b(new_n27_), .c(x1), .O(z6));
  nand4  g25(.a(new_n19_), .b(x3), .c(x1), .d(x0), .O(new_n40_));
