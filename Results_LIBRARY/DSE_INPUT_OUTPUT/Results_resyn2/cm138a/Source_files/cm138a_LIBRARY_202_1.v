...
module FAU ( 
  ...
  oai21  g09(.a(new_n23_), .b(new_n20_), .c(x3), .O(new_n24_));
  ...
  nand3  g14(.a(new_n28_), .b(new_n21_), .c(x3), .O(z2));
  nor2   g15(.a(new_n16_), .b(new_n15_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n21_), .c(x3), .O(z3));
  nand2  g17(.a(new_n16_), .b(new_n15_), .O(new_n32_));
  nand3  g18(.a(new_n19_), .b(new_n18_), .c(x2), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n32_), .c(x3), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n26_), .O(z4));
  oai21  g21(.a(new_n33_), .b(new_n23_), .c(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n26_), .O(z5));
  inv1   g23(.a(new_n33_), .O(new_n38_));
  nand3  g24(.a(new_n38_), .b(new_n28_), .c(x3), .O(z6));
  nand3  g25(.a(new_n38_), .b(new_n30_), .c(x3), .O(z7));
endmodule
