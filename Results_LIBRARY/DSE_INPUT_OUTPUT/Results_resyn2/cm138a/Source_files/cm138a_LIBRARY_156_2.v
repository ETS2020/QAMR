...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n24_, new_n27_, new_n28_, new_n31_, new_n33_;
  ...
  nand2  g09(.a(new_n24_), .b(new_n21_), .O(z2));
  nand3  g10(.a(new_n21_), .b(x1), .c(x0), .O(z3));
  nand4  g11(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n15_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n16_), .O(z4));
  inv1   g14(.a(new_n27_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n24_), .O(z6));
  nand2  g16(.a(new_n27_), .b(x1), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(x0), .O(z7));
  one    g18(.O(z1));
  one    g19(.O(z5));
endmodule
