...
module FAU ( 
  ...
  nand4  g12(.a(new_n19_), .b(new_n17_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g13(.a(new_n23_), .b(new_n22_), .c(x1), .d(x0), .O(new_n28_));
  ...
  nand4  g22(.a(new_n23_), .b(x2), .c(x1), .d(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n21_), .O(z6));
  nor2   g25(.a(x4), .b(new_n22_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n19_), .c(x1), .d(x0), .O(z7));
endmodule
