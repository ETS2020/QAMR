...
module FAU ( 
  ...
  nand2  g16(.a(new_n28_), .b(x0), .O(new_n31_));
  nand2  g17(.a(new_n22_), .b(x0), .O(new_n32_));
  nand2  g18(.a(z2), .b(new_n32_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n31_), .O(z5));
  nand2  g20(.a(new_n31_), .b(x1), .O(z7));
  nand2  g21(.a(x1), .b(new_n24_), .O(z6));
endmodule
