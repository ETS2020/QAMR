...
module FAU ( 
  ...
  nand4  g11(.a(new_n21_), .b(new_n17_), .c(x1), .d(new_n15_), .O(z2));
  nand2  g12(.a(x2), .b(new_n16_), .O(z5));
  nand2  g13(.a(new_n17_), .b(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(z5), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n24_), .O(z3));
  nand4  g16(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g17(.a(new_n23_), .b(x1), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(x2), .O(z7));
  one    g19(.O(z4));
endmodule
