...
module FAU ( 
  ...
  nand2  g15(.a(new_n16_), .b(x3), .O(new_n30_));
  oai21  g16(.a(new_n25_), .b(new_n30_), .c(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z3));
  nand4  g18(.a(new_n28_), .b(x2), .c(new_n15_), .d(new_n19_), .O(z4));
  nor2   g19(.a(new_n20_), .b(new_n19_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n28_), .c(new_n15_), .O(z5));
  nand2  g21(.a(x2), .b(new_n19_), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n30_), .c(new_n17_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x1), .O(z6));
  nand3  g24(.a(new_n34_), .b(new_n28_), .c(x1), .O(z7));
endmodule
