...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n23_, new_n24_, new_n29_, new_n30_, new_n32_, new_n34_;
  ...
  nand3  g10(.a(new_n24_), .b(new_n15_), .c(new_n21_), .O(z1));
  ...
  nand4  g17(.a(new_n32_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
