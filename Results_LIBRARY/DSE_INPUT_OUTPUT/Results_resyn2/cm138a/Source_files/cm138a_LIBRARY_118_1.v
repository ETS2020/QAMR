...
module FAU ( 
  ...
  nand4  g20(.a(new_n34_), .b(new_n32_), .c(new_n16_), .d(x2), .O(z4));
  nor2   g21(.a(x1), .b(new_n17_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n34_), .c(new_n16_), .d(x2), .O(z5));
  nand4  g23(.a(new_n16_), .b(new_n19_), .c(x3), .d(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(new_n39_));
  nor2   g25(.a(x5), .b(x2), .O(new_n40_));
  aoi21  g26(.a(x2), .b(x0), .c(new_n40_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n39_), .O(z6));
  nor2   g28(.a(new_n18_), .b(new_n17_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n34_), .c(new_n16_), .d(x2), .O(z7));
endmodule
