...
module FAU ( 
  ...
  nand2  g09(.a(x3), .b(new_n16_), .O(new_n24_));
  ...
  nand3  g16(.a(new_n23_), .b(x2), .c(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x3), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(z4));
  nand4  g19(.a(new_n25_), .b(new_n23_), .c(x2), .d(x0), .O(z5));
  nand2  g20(.a(x2), .b(new_n15_), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n20_), .c(x1), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n24_), .O(z6));
