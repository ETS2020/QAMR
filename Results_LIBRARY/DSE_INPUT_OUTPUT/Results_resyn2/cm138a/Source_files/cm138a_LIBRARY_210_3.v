...
module FAU ( 
  ...
  nand4  g08(.a(new_n18_), .b(new_n17_), .c(x1), .d(new_n22_), .O(z2));
  ...
  nand2  g14(.a(new_n27_), .b(new_n20_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x0), .O(z5));
  nand2  g16(.a(new_n27_), .b(new_n22_), .O(new_n32_));
