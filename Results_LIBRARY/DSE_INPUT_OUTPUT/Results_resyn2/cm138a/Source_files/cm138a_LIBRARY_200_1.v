...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(new_n16_), .d(x0), .O(z1));
  ...
  nand4  g16(.a(new_n30_), .b(new_n24_), .c(new_n16_), .d(x0), .O(z3));
  nor2   g17(.a(new_n18_), .b(x1), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g19(.a(new_n32_), .b(new_n24_), .c(new_n16_), .d(x0), .O(z5));
  ...
  nand4  g24(.a(new_n38_), .b(new_n24_), .c(new_n16_), .d(x0), .O(z7));
endmodule
