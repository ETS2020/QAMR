...
module FAU ( 
  ...
  oai21  g16(.a(new_n25_), .b(new_n30_), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z3));
  nand2  g18(.a(x2), .b(new_n19_), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n18_), .c(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n23_), .O(z4));
  nand4  g21(.a(new_n28_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand4  g22(.a(new_n28_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
