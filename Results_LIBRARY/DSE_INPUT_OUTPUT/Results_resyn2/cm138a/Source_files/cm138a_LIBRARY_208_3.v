...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n27_, new_n29_, new_n30_, new_n31_, new_n34_;
  ...
  nand3  g10(.a(new_n21_), .b(x1), .c(new_n15_), .O(z2));
  nand2  g11(.a(new_n16_), .b(new_n15_), .O(new_n27_));
  nand2  g12(.a(x1), .b(x0), .O(z7));
  nand2  g13(.a(z7), .b(new_n27_), .O(new_n29_));
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n29_), .O(z4));
  nand2  g17(.a(new_n31_), .b(x0), .O(z5));
  inv1   g18(.a(new_n30_), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(x1), .c(new_n15_), .O(z6));
  one    g20(.O(z3));
endmodule
