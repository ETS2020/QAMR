...
module FAU ( 
  ...
  nand2  g12(.a(new_n22_), .b(x1), .O(z3));
  ...
  nor2   g17(.a(x1), .b(new_n25_), .O(new_n32_));
  nand3  g18(.a(new_n30_), .b(new_n32_), .c(new_n29_), .O(z5));
  nand4  g19(.a(new_n30_), .b(new_n29_), .c(x1), .d(x0), .O(z7));
  one    g20(.O(z6));
endmodule
