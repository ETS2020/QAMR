...
module FAU ( 
  ...
  nor2   g12(.a(x5), .b(new_n21_), .O(new_n27_));
  ...
  nand4  g19(.a(new_n22_), .b(new_n23_), .c(x3), .d(x2), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n21_), .c(x0), .O(z5));
  nand2  g22(.a(new_n34_), .b(x1), .O(new_n37_));
  aoi21  g23(.a(x1), .b(x0), .c(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z6));
  nand3  g25(.a(new_n35_), .b(x1), .c(x0), .O(z7));
endmodule
