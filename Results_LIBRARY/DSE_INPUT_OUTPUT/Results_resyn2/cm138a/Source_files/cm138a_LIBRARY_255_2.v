...
module FAU ( 
  ...
  aoi21  g10(.a(new_n23_), .b(new_n21_), .c(new_n24_), .O(z1));
  nor2   g11(.a(new_n16_), .b(x0), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n21_), .O(z2));
  nor2   g13(.a(new_n16_), .b(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n21_), .O(z3));
  nand4  g15(.a(new_n19_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(z4));
  inv1   g18(.a(x3), .O(new_n33_));
  nor2   g19(.a(x4), .b(new_n33_), .O(new_n34_));
  nand4  g20(.a(new_n23_), .b(new_n34_), .c(new_n19_), .d(x2), .O(z5));
  nand4  g21(.a(new_n26_), .b(new_n34_), .c(new_n19_), .d(x2), .O(z6));
  nand4  g22(.a(new_n28_), .b(new_n34_), .c(new_n19_), .d(x2), .O(z7));
endmodule
