...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(new_n21_), .c(new_n16_), .O(z1));
  ...
  nand4  g15(.a(new_n29_), .b(new_n23_), .c(new_n19_), .d(x3), .O(z3));
  inv1   g16(.a(new_n29_), .O(new_n31_));
  ...
  oai21  g21(.a(new_n35_), .b(new_n20_), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n31_), .O(z5));
  nand4  g23(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g24(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
