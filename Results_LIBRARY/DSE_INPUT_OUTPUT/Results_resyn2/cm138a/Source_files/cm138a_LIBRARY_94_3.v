...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_;
  ...
  nand4  g07(.a(new_n21_), .b(new_n20_), .c(new_n15_), .d(x0), .O(new_n22_));
  ...
  nand4  g15(.a(new_n21_), .b(new_n20_), .c(x2), .d(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n19_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x3), .O(z5));
  buf    g18(.a(x0), .O(z3));
  nand2  g19(.a(x3), .b(x1), .O(z6));
  nand2  g20(.a(x3), .b(x1), .O(z7));
endmodule
