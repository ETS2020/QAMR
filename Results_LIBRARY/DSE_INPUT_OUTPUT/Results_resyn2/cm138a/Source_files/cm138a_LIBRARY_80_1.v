...
module FAU ( 
  ...
  oai21  g10(.a(new_n24_), .b(new_n23_), .c(new_n16_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n15_), .O(z1));
  inv1   g12(.a(new_n20_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n16_), .c(x1), .O(z2));
  xor2a  g14(.a(x4), .b(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n25_), .O(z3));
  nand3  g16(.a(new_n16_), .b(x2), .c(new_n17_), .O(new_n31_));
  nor2   g17(.a(new_n31_), .b(new_n23_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n15_), .O(z4));
  nand2  g19(.a(x2), .b(x0), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n23_), .c(new_n16_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n15_), .O(z5));
  nand2  g22(.a(new_n16_), .b(new_n15_), .O(new_n37_));
  oai21  g23(.a(new_n31_), .b(new_n23_), .c(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z6));
  nand2  g25(.a(new_n35_), .b(new_n29_), .O(z7));
endmodule
