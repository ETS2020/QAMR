...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_,
  ...
  nor2   g17(.a(x5), .b(new_n18_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n26_), .c(new_n17_), .d(new_n16_), .O(z4));
  nand3  g19(.a(new_n32_), .b(new_n26_), .c(new_n24_), .O(z5));
  nand4  g20(.a(new_n19_), .b(x2), .c(x1), .d(new_n16_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n15_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x3), .O(z6));
