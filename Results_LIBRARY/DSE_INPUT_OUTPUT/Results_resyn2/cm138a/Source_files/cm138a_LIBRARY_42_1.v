...
module FAU ( 
  ...
  oai21  g15(.a(new_n29_), .b(new_n20_), .c(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n27_), .O(z3));
  nor2   g17(.a(new_n17_), .b(x0), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n26_), .c(new_n19_), .d(x3), .O(z4));
  nand2  g19(.a(new_n19_), .b(x3), .O(new_n34_));
  nand2  g20(.a(x2), .b(x0), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n34_), .c(new_n18_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(z5));
  nand3  g23(.a(new_n32_), .b(new_n21_), .c(x1), .O(z6));
