...
module FAU ( 
  ...
  inv1   g13(.a(new_n25_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(x3), .c(x0), .O(z3));
  nand4  g15(.a(new_n19_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n15_), .O(z4));
  nand2  g18(.a(new_n31_), .b(new_n23_), .O(z5));
  nand3  g19(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g22(.a(new_n35_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
