...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n31_, new_n32_, new_n34_;
  ...
  nand2  g13(.a(new_n28_), .b(new_n24_), .O(z5));
  inv1   g14(.a(new_n20_), .O(new_n31_));
  nor2   g15(.a(new_n15_), .b(new_n16_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n31_), .O(z6));
  inv1   g17(.a(new_n23_), .O(new_n34_));
  nand2  g18(.a(new_n32_), .b(new_n34_), .O(z7));
  one    g19(.O(z2));
  one    g20(.O(z3));
endmodule
