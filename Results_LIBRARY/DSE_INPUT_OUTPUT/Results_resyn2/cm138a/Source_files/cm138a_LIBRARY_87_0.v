...
module FAU ( 
  ...
  nand2  g15(.a(new_n29_), .b(new_n18_), .O(z2));
  nand2  g16(.a(x1), .b(x0), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n27_), .c(x3), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n18_), .O(z3));
  nand3  g19(.a(new_n17_), .b(x3), .c(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x2), .O(new_n35_));
  nand2  g21(.a(x2), .b(x0), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n35_), .c(new_n19_), .O(z4));
  inv1   g23(.a(new_n34_), .O(new_n38_));
  nand3  g24(.a(new_n38_), .b(x2), .c(x0), .O(z5));
  nand3  g25(.a(new_n26_), .b(new_n25_), .c(x3), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n28_), .c(x2), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n19_), .O(z6));
  oai21  g28(.a(new_n40_), .b(new_n31_), .c(x2), .O(new_n43_));
