...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n33_;
  ...
  nand2  g13(.a(new_n25_), .b(new_n22_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x0), .O(z3));
  inv1   g15(.a(x0), .O(new_n30_));
  nand3  g16(.a(new_n19_), .b(x2), .c(new_n30_), .O(z4));
  nand2  g17(.a(new_n25_), .b(new_n30_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(x2), .O(z6));
  one    g19(.O(z5));
  one    g20(.O(z7));
endmodule
