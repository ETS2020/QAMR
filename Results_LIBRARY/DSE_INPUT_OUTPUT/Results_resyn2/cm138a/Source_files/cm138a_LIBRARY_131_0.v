...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(new_n20_), .c(new_n16_), .d(new_n18_), .O(z3));
  nand4  g10(.a(new_n21_), .b(new_n20_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g11(.a(new_n23_), .b(new_n20_), .c(new_n16_), .d(x2), .O(z7));
