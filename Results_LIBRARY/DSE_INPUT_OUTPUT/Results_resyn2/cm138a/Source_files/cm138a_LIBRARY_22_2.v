...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n24_, new_n25_, new_n28_, new_n29_, new_n32_, new_n34_;
  ...
  nand3  g16(.a(new_n32_), .b(x1), .c(new_n15_), .O(z6));
  nand2  g17(.a(new_n28_), .b(x1), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(x0), .O(z7));
  one    g19(.O(z1));
  one    g20(.O(z5));
endmodule
