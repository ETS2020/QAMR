...
module FAU ( 
  ...
  oai21  g06(.a(x1), .b(x0), .c(new_n16_), .O(new_n21_));
  nand2  g07(.a(new_n21_), .b(new_n20_), .O(z0));
  nand4  g08(.a(new_n18_), .b(new_n17_), .c(x3), .d(x0), .O(new_n23_));
  inv1   g09(.a(new_n23_), .O(new_n24_));
  nand3  g10(.a(new_n24_), .b(new_n16_), .c(new_n15_), .O(z1));
  inv1   g11(.a(x0), .O(new_n26_));
  inv1   g12(.a(new_n19_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(x1), .c(new_n26_), .O(z2));
  nand2  g14(.a(new_n23_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x1), .O(z3));
  nand3  g16(.a(new_n18_), .b(new_n17_), .c(x3), .O(new_n31_));
  inv1   g17(.a(new_n31_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(x2), .c(new_n15_), .d(new_n26_), .O(z4));
  nand2  g19(.a(new_n23_), .b(new_n15_), .O(new_n34_));
