...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_, new_n35_;
  ...
  nor2   g11(.a(new_n16_), .b(new_n15_), .O(new_n26_));
  ...
  nand2  g17(.a(z2), .b(new_n31_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n29_), .O(z5));
  inv1   g19(.a(new_n28_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n26_), .O(z7));
  one    g21(.O(z6));
endmodule
