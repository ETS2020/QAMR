...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n33_;
  ...
  oai21  g15(.a(new_n18_), .b(new_n19_), .c(new_n20_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x1), .O(z3));
  nand4  g17(.a(new_n28_), .b(x2), .c(new_n15_), .d(new_n19_), .O(z4));
  oai21  g18(.a(new_n18_), .b(new_n19_), .c(new_n15_), .O(new_n33_));
