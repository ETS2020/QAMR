...
module FAU ( 
  ...
  nand4  g14(.a(new_n25_), .b(x2), .c(new_n16_), .d(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x3), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n23_), .O(z4));
  nor2   g17(.a(x4), .b(new_n24_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n19_), .c(new_n16_), .d(x0), .O(z5));
  nand4  g19(.a(new_n25_), .b(x2), .c(x1), .d(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n23_), .O(z6));
  nand4  g22(.a(new_n25_), .b(x2), .c(x1), .d(x0), .O(new_n37_));
