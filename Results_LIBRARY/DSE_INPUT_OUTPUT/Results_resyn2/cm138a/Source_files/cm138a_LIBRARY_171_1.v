...
module FAU ( 
  ...
  nand4  g04(.a(new_n18_), .b(new_n16_), .c(x3), .d(new_n15_), .O(z2));
  inv1   g05(.a(x0), .O(new_n20_));
  nor2   g06(.a(new_n17_), .b(new_n20_), .O(new_n21_));
  nand4  g07(.a(new_n21_), .b(new_n16_), .c(x3), .d(new_n15_), .O(z3));
  nand2  g08(.a(x3), .b(new_n17_), .O(z5));
  inv1   g09(.a(x4), .O(new_n24_));
  inv1   g10(.a(x5), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n20_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x3), .O(z6));
  nand4  g14(.a(new_n25_), .b(new_n24_), .c(x2), .d(x0), .O(new_n29_));
