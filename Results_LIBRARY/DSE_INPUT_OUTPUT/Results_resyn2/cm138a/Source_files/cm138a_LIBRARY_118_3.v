...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n37_, new_n38_;
  ...
  nand2  g08(.a(new_n17_), .b(x2), .O(new_n23_));
  ...
  oai21  g14(.a(new_n28_), .b(new_n18_), .c(new_n15_), .O(new_n29_));
  ...
  inv1   g19(.a(new_n18_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(x2), .c(new_n20_), .d(new_n19_), .O(z4));
  nand4  g21(.a(new_n34_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  nand2  g22(.a(new_n16_), .b(x3), .O(new_n37_));
  oai21  g23(.a(new_n28_), .b(new_n37_), .c(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z6));
  nand4  g25(.a(new_n34_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
