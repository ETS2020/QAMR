...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n25_, new_n28_, new_n29_, new_n30_, new_n32_, new_n34_;
  ...
  nand2  g13(.a(new_n19_), .b(new_n28_), .O(new_n29_));
  xor2a  g14(.a(x2), .b(x1), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z4));
  nand2  g16(.a(new_n22_), .b(new_n28_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n30_), .O(z5));
  nor2   g18(.a(new_n25_), .b(new_n28_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n20_), .O(z6));
