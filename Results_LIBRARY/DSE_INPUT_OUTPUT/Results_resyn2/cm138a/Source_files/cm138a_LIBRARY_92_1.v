...
module FAU ( 
  ...
  nor2   g05(.a(new_n15_), .b(x0), .O(new_n20_));
  inv1   g06(.a(x0), .O(new_n21_));
  nor2   g07(.a(x5), .b(new_n21_), .O(new_n22_));
  inv1   g08(.a(x1), .O(new_n23_));
  inv1   g09(.a(x2), .O(new_n24_));
  inv1   g10(.a(x4), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(x3), .c(new_n24_), .d(new_n23_), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  aoi21  g13(.a(new_n27_), .b(new_n22_), .c(new_n20_), .O(z1));
  nand4  g14(.a(new_n25_), .b(x3), .c(new_n24_), .d(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n21_), .O(z2));
  xor2a  g17(.a(x5), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n30_), .O(z3));
  nor2   g19(.a(new_n24_), .b(x1), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n17_), .c(new_n15_), .d(new_n21_), .O(z4));
  nand4  g21(.a(new_n34_), .b(new_n17_), .c(new_n15_), .d(x0), .O(z5));
  nand4  g22(.a(new_n25_), .b(x3), .c(x2), .d(x1), .O(new_n37_));
