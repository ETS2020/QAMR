...
module FAU ( 
  ...
  nor2   g17(.a(x5), .b(new_n19_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n18_), .O(z5));
  nand4  g19(.a(new_n32_), .b(new_n31_), .c(x1), .d(new_n15_), .O(z6));
  nand4  g20(.a(new_n32_), .b(new_n31_), .c(x1), .d(x0), .O(z7));
