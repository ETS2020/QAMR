...
module FAU ( 
  ...
  nand4  g15(.a(new_n25_), .b(new_n24_), .c(x1), .d(x0), .O(z3));
  nor2   g16(.a(new_n23_), .b(new_n19_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n25_), .c(new_n18_), .d(new_n17_), .O(z4));
  nand4  g18(.a(x3), .b(x2), .c(new_n18_), .d(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(z5));
  nand4  g21(.a(new_n31_), .b(new_n25_), .c(x1), .d(new_n17_), .O(z6));
  nand4  g22(.a(new_n31_), .b(new_n25_), .c(x1), .d(x0), .O(z7));
endmodule
