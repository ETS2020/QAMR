...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n25_, new_n26_, new_n30_, new_n34_, new_n35_;
  ...
  nand4  g14(.a(new_n26_), .b(new_n23_), .c(x1), .d(x0), .O(z3));
  nor2   g15(.a(x5), .b(new_n18_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n26_), .c(new_n17_), .d(new_n16_), .O(z4));
  nand3  g17(.a(new_n30_), .b(new_n26_), .c(new_n24_), .O(z5));
  nand4  g18(.a(new_n30_), .b(new_n26_), .c(x1), .d(new_n16_), .O(z6));
  nand4  g19(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(new_n34_));
