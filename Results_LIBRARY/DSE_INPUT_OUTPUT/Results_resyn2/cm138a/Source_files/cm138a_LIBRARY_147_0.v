...
module FAU ( 
  ...
  nand3  g11(.a(new_n25_), .b(new_n24_), .c(x1), .O(new_n26_));
  oai21  g12(.a(new_n26_), .b(x0), .c(x3), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n15_), .O(z2));
  nand2  g14(.a(x3), .b(x0), .O(new_n29_));
  nor2   g15(.a(new_n29_), .b(new_n26_), .O(new_n30_));
  ...
  nand2  g20(.a(new_n33_), .b(new_n22_), .O(z5));
  nand3  g21(.a(new_n33_), .b(x1), .c(new_n16_), .O(z6));
  nand2  g22(.a(x3), .b(new_n15_), .O(new_n37_));
  oai21  g23(.a(new_n29_), .b(new_n26_), .c(x2), .O(new_n38_));
