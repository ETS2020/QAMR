...
module FAU ( 
  ...
  nand2  g08(.a(new_n15_), .b(x0), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n20_), .O(new_n25_));
  xor2a  g10(.a(x1), .b(x0), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n25_), .O(z2));
  inv1   g12(.a(new_n20_), .O(new_n28_));
  nor2   g13(.a(new_n15_), .b(new_n16_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n28_), .O(z3));
  nand4  g15(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n31_));
  inv1   g16(.a(new_n31_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n15_), .c(new_n16_), .O(z4));
  nand2  g18(.a(new_n31_), .b(new_n24_), .O(new_n35_));
  nand2  g19(.a(new_n35_), .b(new_n26_), .O(z6));
  nand2  g20(.a(new_n32_), .b(new_n29_), .O(z7));
  one    g21(.O(z1));
  one    g22(.O(z5));
endmodule
