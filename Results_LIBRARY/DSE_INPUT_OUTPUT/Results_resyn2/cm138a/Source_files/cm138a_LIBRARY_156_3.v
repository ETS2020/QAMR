...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n24_, new_n26_, new_n29_, new_n30_, new_n31_, new_n33_,
    new_n35_;
  ...
  nand4  g14(.a(new_n16_), .b(new_n29_), .c(x3), .d(x2), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n17_), .O(new_n31_));
  nand2  g16(.a(x1), .b(x0), .O(z7));
  nand2  g17(.a(z7), .b(new_n19_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z4));
  inv1   g19(.a(new_n30_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n24_), .O(z5));
  nand2  g21(.a(new_n35_), .b(new_n26_), .O(z6));
  one    g22(.O(z3));
endmodule
