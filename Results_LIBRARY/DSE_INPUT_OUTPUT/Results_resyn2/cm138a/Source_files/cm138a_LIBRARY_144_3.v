...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n26_, new_n29_, new_n30_, new_n32_;
  ...
  nand3  g12(.a(new_n26_), .b(new_n22_), .c(x0), .O(z1));
  ...
  nand3  g18(.a(new_n32_), .b(new_n22_), .c(x0), .O(z5));
  nand2  g19(.a(new_n30_), .b(x1), .O(z6));
