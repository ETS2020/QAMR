...
module FAU ( 
  ...
  xor2a  g11(.a(x5), .b(x1), .O(new_n26_));
  ...
  nor2   g16(.a(new_n18_), .b(x0), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g18(.a(new_n19_), .b(x3), .c(x2), .d(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(z5));
  nand4  g21(.a(new_n31_), .b(new_n30_), .c(new_n16_), .d(x1), .O(z6));
  nand2  g22(.a(new_n34_), .b(new_n26_), .O(z7));
endmodule
