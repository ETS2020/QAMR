...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n25_, new_n29_, new_n30_;
  ...
  nand2  g12(.a(new_n15_), .b(x1), .O(z3));
  nand4  g13(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n17_), .O(z4));
  nand4  g14(.a(new_n19_), .b(x3), .c(x2), .d(x0), .O(new_n29_));
