...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n27_, new_n30_, new_n31_, new_n32_;
  ...
  nand4  g14(.a(new_n19_), .b(new_n17_), .c(new_n16_), .d(x2), .O(z4));
  inv1   g15(.a(x4), .O(new_n30_));
  nand4  g16(.a(new_n16_), .b(new_n30_), .c(x2), .d(x0), .O(new_n31_));
  ...
  nand4  g20(.a(new_n27_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z7));
endmodule
