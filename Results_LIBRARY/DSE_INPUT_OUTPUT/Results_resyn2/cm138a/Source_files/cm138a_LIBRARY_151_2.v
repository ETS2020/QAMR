...
module FAU ( 
  ...
  nor2   g11(.a(x5), .b(x0), .O(new_n26_));
  nand4  g12(.a(new_n26_), .b(new_n25_), .c(new_n18_), .d(x1), .O(z2));
  ...
  nand4  g16(.a(new_n26_), .b(new_n25_), .c(x2), .d(x1), .O(z6));
  nand2  g17(.a(new_n15_), .b(x0), .O(z3));
