...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n25_, new_n26_, new_n28_, new_n31_;
  ...
  nand4  g10(.a(new_n19_), .b(new_n18_), .c(x3), .d(x1), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n16_), .c(new_n15_), .O(z2));
  nand2  g13(.a(new_n25_), .b(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n23_), .O(z3));
  nand2  g15(.a(new_n20_), .b(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x2), .O(z5));
  nand2  g17(.a(x2), .b(new_n15_), .O(z6));
  nand3  g18(.a(new_n26_), .b(x2), .c(x0), .O(z7));
  one    g19(.O(z4));
endmodule
