...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n35_, new_n36_, new_n39_;
  ...
  nand4  g13(.a(new_n19_), .b(new_n16_), .c(x3), .d(new_n18_), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n27_), .O(z2));
  oai21  g16(.a(new_n15_), .b(new_n17_), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n28_), .b(x1), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z3));
  nand4  g19(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n17_), .O(z4));
  nand4  g20(.a(new_n19_), .b(x3), .c(x2), .d(x0), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(z5));
  nand4  g23(.a(new_n27_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g24(.a(new_n15_), .b(new_n17_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z7));
endmodule
