...
module FAU ( 
  ...
  nand2  g20(.a(new_n20_), .b(x1), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(x2), .O(z6));
  inv1   g22(.a(new_n23_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x2), .c(x1), .O(z7));
  one    g24(.O(z5));
endmodule
