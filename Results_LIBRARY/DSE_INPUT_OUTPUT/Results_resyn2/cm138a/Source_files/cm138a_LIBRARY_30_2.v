...
module FAU ( 
  ...
  nand4  g10(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n25_));
  ...
  oai21  g15(.a(x1), .b(new_n29_), .c(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n28_), .O(z5));
  nand3  g17(.a(new_n26_), .b(x1), .c(new_n29_), .O(z6));
  nand3  g18(.a(new_n26_), .b(x1), .c(x0), .O(z7));
  nand2  g19(.a(new_n16_), .b(x1), .O(z3));
endmodule
