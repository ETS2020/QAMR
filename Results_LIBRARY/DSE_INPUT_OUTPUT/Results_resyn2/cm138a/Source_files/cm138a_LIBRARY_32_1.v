...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n29_, new_n30_, new_n32_, new_n34_;
  ...
  nor2   g08(.a(new_n16_), .b(x0), .O(new_n23_));
  nor2   g09(.a(x1), .b(new_n15_), .O(new_n24_));
  aoi21  g10(.a(new_n24_), .b(new_n21_), .c(new_n23_), .O(z1));
  inv1   g11(.a(new_n23_), .O(z2));
  nand3  g12(.a(new_n21_), .b(x1), .c(x0), .O(z3));
  nor2   g13(.a(x5), .b(x4), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(x3), .c(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z4));
  inv1   g17(.a(new_n29_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n24_), .O(z5));
  nand2  g19(.a(new_n29_), .b(x0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x1), .O(z7));
  inv1   g21(.a(new_n23_), .O(z6));
endmodule
