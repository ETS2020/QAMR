...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n15_), .c(new_n20_), .d(x0), .O(z1));
  nand4  g12(.a(new_n25_), .b(new_n15_), .c(x1), .d(new_n19_), .O(z2));
  ...
  nand4  g18(.a(new_n32_), .b(new_n31_), .c(new_n20_), .d(new_n19_), .O(z4));
  nand4  g19(.a(new_n32_), .b(new_n31_), .c(new_n20_), .d(x0), .O(z5));
  nand3  g20(.a(new_n32_), .b(x1), .c(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z6));
  nand4  g23(.a(new_n32_), .b(new_n31_), .c(x1), .d(x0), .O(z7));
endmodule
