...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n27_, new_n30_, new_n31_, new_n33_, new_n35_;
  ...
  nand3  g13(.a(new_n27_), .b(x1), .c(new_n22_), .O(z2));
  nand4  g14(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n30_));
  inv1   g15(.a(new_n30_), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(new_n15_), .c(new_n22_), .O(z4));
  nand2  g17(.a(new_n30_), .b(new_n15_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(x0), .O(z5));
  nand2  g19(.a(new_n30_), .b(new_n22_), .O(new_n35_));
