...
module FAU ( 
  ...
  nor2   g08(.a(x1), .b(new_n15_), .O(new_n24_));
  nor2   g09(.a(new_n16_), .b(x0), .O(new_n25_));
  aoi21  g10(.a(new_n25_), .b(new_n21_), .c(new_n24_), .O(z2));
  nand3  g11(.a(new_n21_), .b(x1), .c(x0), .O(z3));
  nor2   g12(.a(x5), .b(x4), .O(new_n28_));
  nand3  g13(.a(new_n28_), .b(x3), .c(x2), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n15_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(z4));
  inv1   g16(.a(new_n29_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n25_), .O(z6));
  nand2  g18(.a(new_n29_), .b(x1), .O(new_n35_));
