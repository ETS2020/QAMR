...
module FAU ( 
  ...
  nand4  g16(.a(new_n17_), .b(new_n16_), .c(x3), .d(x2), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n15_), .b(x0), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n23_), .O(z4));
  inv1   g20(.a(new_n31_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n15_), .c(x0), .O(z5));
  nand3  g22(.a(new_n35_), .b(x1), .c(new_n19_), .O(z6));
  nand4  g23(.a(new_n16_), .b(x3), .c(x2), .d(x0), .O(new_n38_));
