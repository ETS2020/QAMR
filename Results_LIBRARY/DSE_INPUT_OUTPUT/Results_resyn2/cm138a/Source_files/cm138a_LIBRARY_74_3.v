...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n25_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    new_n36_, new_n37_;
  ...
  nand3  g14(.a(new_n19_), .b(x3), .c(x2), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(new_n28_), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n19_), .b(x4), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z4));
  inv1   g18(.a(new_n29_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n23_), .c(new_n18_), .O(z5));
  nand3  g20(.a(new_n33_), .b(new_n25_), .c(new_n18_), .O(z6));
  nand2  g21(.a(x1), .b(x0), .O(new_n36_));
  oai21  g22(.a(new_n29_), .b(new_n36_), .c(new_n18_), .O(new_n37_));
