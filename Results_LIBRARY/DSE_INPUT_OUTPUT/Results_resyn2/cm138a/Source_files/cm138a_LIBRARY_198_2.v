...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n29_, new_n31_, new_n33_;
  ...
  nand2  g13(.a(new_n28_), .b(z2), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n21_), .O(z4));
  inv1   g15(.a(new_n23_), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(x2), .c(new_n16_), .O(z5));
  nand2  g17(.a(new_n20_), .b(x2), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(x1), .O(z6));
  nand3  g19(.a(new_n31_), .b(x2), .c(x1), .O(z7));
  one    g20(.O(z3));
endmodule
