...
module FAU ( 
  ...
  nand3  g12(.a(new_n21_), .b(x2), .c(new_n15_), .O(z4));
  nand2  g13(.a(x2), .b(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(z2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n24_), .O(z5));
  nand2  g16(.a(new_n20_), .b(x2), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z6));
  nand2  g18(.a(new_n23_), .b(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x1), .O(z7));
  nand2  g20(.a(new_n16_), .b(x1), .O(z3));
endmodule
