...
module FAU ( 
  ...
  nand4  g10(.a(new_n19_), .b(x3), .c(new_n16_), .d(new_n15_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n18_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x1), .O(z2));
  nor2   g13(.a(x4), .b(new_n17_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n23_), .c(new_n19_), .d(x3), .O(z3));
  inv1   g15(.a(new_n28_), .O(new_n30_));
  ...
  nand3  g20(.a(new_n21_), .b(x2), .c(x0), .O(z5));
  nand4  g21(.a(new_n19_), .b(x3), .c(x2), .d(new_n15_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n18_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x1), .O(z6));
  nand4  g24(.a(new_n19_), .b(x3), .c(x2), .d(x0), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n18_), .O(new_n40_));
