...
module FAU ( 
  ...
  nand3  g08(.a(new_n22_), .b(x1), .c(new_n17_), .O(z2));
  nand3  g09(.a(new_n22_), .b(x1), .c(x0), .O(z3));
  nand4  g10(.a(new_n20_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x1), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x3), .O(z6));
  nand3  g13(.a(x2), .b(x1), .c(x0), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n20_), .c(new_n19_), .d(x3), .O(z7));
  nand2  g16(.a(x3), .b(new_n15_), .O(z1));
  nand2  g17(.a(x3), .b(new_n15_), .O(z4));
