...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n24_, new_n25_, new_n26_, new_n28_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n37_;
  xnor2a g00(.a(x5), .b(x0), .O(new_n15_));
  ...
  nand2  g08(.a(new_n21_), .b(x0), .O(z1));
  nor2   g09(.a(x5), .b(x0), .O(new_n24_));
  ...
  nand2  g14(.a(new_n28_), .b(x0), .O(z3));
  ...
  nand2  g18(.a(new_n31_), .b(x0), .O(z5));
  nand4  g19(.a(new_n19_), .b(x3), .c(x2), .d(x1), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n24_), .O(z6));
  nand2  g22(.a(new_n34_), .b(new_n16_), .O(new_n37_));
