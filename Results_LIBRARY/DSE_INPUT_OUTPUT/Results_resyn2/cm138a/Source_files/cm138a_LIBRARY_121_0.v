...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n29_, new_n30_, new_n32_, new_n34_;
  ...
  nand3  g11(.a(new_n26_), .b(x1), .c(x0), .O(z3));
  nand4  g12(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n29_));
  inv1   g13(.a(new_n29_), .O(new_n30_));
  nand3  g14(.a(new_n30_), .b(new_n16_), .c(x0), .O(z5));
  nand2  g15(.a(new_n29_), .b(x1), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n23_), .O(z6));
  xnor2a g17(.a(x1), .b(x0), .O(new_n34_));
