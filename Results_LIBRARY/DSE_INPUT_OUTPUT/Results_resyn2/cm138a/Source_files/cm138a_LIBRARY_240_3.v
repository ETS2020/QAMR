...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n29_, new_n31_, new_n32_, new_n34_;
  ...
  nand3  g08(.a(new_n18_), .b(x3), .c(new_n17_), .O(new_n23_));
  inv1   g09(.a(new_n23_), .O(new_n24_));
  nand3  g10(.a(new_n24_), .b(new_n16_), .c(x0), .O(z1));
  nand3  g11(.a(new_n24_), .b(x1), .c(new_n15_), .O(z2));
  nand4  g12(.a(new_n18_), .b(x3), .c(x2), .d(new_n16_), .O(new_n28_));
  ...
  nand2  g17(.a(new_n32_), .b(x0), .O(z5));
  nand2  g18(.a(new_n31_), .b(new_n15_), .O(new_n34_));
