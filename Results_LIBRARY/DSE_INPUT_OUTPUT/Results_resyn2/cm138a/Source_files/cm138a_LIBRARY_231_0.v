...
module FAU ( 
  ...
  nand4  g08(.a(new_n22_), .b(new_n20_), .c(new_n19_), .d(new_n18_), .O(z2));
  ...
  nand4  g13(.a(new_n24_), .b(x3), .c(x2), .d(new_n18_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n16_), .O(z6));
  nand4  g16(.a(new_n22_), .b(new_n20_), .c(x2), .d(x0), .O(z7));
