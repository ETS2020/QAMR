...
module FAU ( 
  ...
  nand3  g13(.a(new_n21_), .b(new_n20_), .c(x3), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n16_), .c(x1), .d(x0), .O(z3));
  ...
  nor2   g19(.a(new_n16_), .b(new_n15_), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n33_), .c(new_n31_), .O(z4));
  nand3  g22(.a(new_n34_), .b(new_n17_), .c(x3), .O(z5));
  nand4  g23(.a(new_n29_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand3  g24(.a(new_n34_), .b(new_n29_), .c(x1), .O(z7));
endmodule
