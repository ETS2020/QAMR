...
module FAU ( 
  ...
  nor3   g03(.a(x4), .b(x2), .c(x1), .O(new_n18_));
  nand3  g04(.a(new_n18_), .b(new_n17_), .c(new_n15_), .O(z0));
  nand3  g05(.a(new_n18_), .b(new_n17_), .c(x0), .O(z1));
  inv1   g06(.a(x4), .O(new_n21_));
  inv1   g07(.a(x1), .O(new_n22_));
  inv1   g08(.a(x5), .O(new_n23_));
  nand4  g09(.a(new_n23_), .b(x3), .c(x2), .d(new_n15_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n22_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n21_), .O(z4));
  nand4  g12(.a(new_n23_), .b(x3), .c(x2), .d(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n22_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n21_), .O(z5));
  nand2  g15(.a(new_n21_), .b(x1), .O(z6));
  buf    g16(.a(x0), .O(z2));
  buf    g17(.a(x0), .O(z3));
  nand2  g18(.a(new_n21_), .b(x1), .O(z7));
endmodule
