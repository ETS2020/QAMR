...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n23_,
    new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_, new_n35_;
  ...
  nand3  g12(.a(new_n20_), .b(x1), .c(x0), .O(z3));
  nand4  g13(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n29_));
  inv1   g14(.a(new_n29_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n15_), .O(z4));
  nand2  g16(.a(new_n29_), .b(new_n24_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n26_), .O(z6));
