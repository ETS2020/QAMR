...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n24_, new_n26_, new_n27_, new_n30_, new_n31_,
  ...
  nand3  g13(.a(new_n27_), .b(new_n26_), .c(x3), .O(z1));
  nand4  g14(.a(new_n26_), .b(x3), .c(x1), .d(new_n15_), .O(z2));
  ...
  nand3  g21(.a(new_n34_), .b(new_n27_), .c(x3), .O(z5));
  nand2  g22(.a(x1), .b(new_n15_), .O(new_n37_));
  oai21  g23(.a(new_n33_), .b(new_n37_), .c(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n24_), .O(z6));
  oai21  g25(.a(new_n33_), .b(new_n30_), .c(x3), .O(new_n40_));
