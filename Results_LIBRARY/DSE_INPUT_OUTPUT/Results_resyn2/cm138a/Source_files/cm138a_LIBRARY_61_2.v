...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
  ...
  nand3  g12(.a(new_n26_), .b(new_n24_), .c(new_n18_), .O(z1));
  ...
  nand3  g16(.a(new_n26_), .b(new_n24_), .c(x1), .O(z3));
