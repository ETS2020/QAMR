...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n25_, new_n29_, new_n30_, new_n31_, new_n33_,
    new_n35_, new_n36_;
  ...
  nand3  g12(.a(new_n20_), .b(new_n19_), .c(x1), .O(z2));
  nand4  g13(.a(new_n19_), .b(new_n23_), .c(x1), .d(x0), .O(z3));
  inv1   g14(.a(x0), .O(new_n29_));
  nand2  g15(.a(x2), .b(new_n29_), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n18_), .c(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n22_), .O(z4));
  nor2   g18(.a(new_n23_), .b(new_n29_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n19_), .c(new_n15_), .O(z5));
  nand2  g20(.a(new_n17_), .b(x3), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n30_), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x1), .O(z6));
  nand3  g23(.a(new_n33_), .b(new_n19_), .c(x1), .O(z7));
endmodule
