...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_;
  ...
  nand2  g08(.a(new_n20_), .b(x0), .O(new_n23_));
  nand2  g09(.a(x1), .b(new_n15_), .O(z2));
  nand2  g10(.a(new_n16_), .b(x0), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(z2), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n23_), .O(z1));
  nand2  g13(.a(new_n23_), .b(x1), .O(z3));
  ...
  nand2  g17(.a(new_n29_), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n26_), .O(z5));
  nand2  g19(.a(new_n32_), .b(x1), .O(z7));
  one    g20(.O(z6));
endmodule
