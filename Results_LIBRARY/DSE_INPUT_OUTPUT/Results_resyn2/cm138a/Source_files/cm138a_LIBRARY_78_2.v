...
module FAU ( 
  ...
  nor2   g12(.a(new_n15_), .b(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n24_), .O(z3));
  nor2   g14(.a(x5), .b(x4), .O(new_n29_));
  nor2   g15(.a(x1), .b(x0), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(x3), .d(x2), .O(z4));
  nand4  g17(.a(new_n25_), .b(new_n29_), .c(x3), .d(x2), .O(z6));
  nand4  g18(.a(new_n27_), .b(new_n29_), .c(x3), .d(x2), .O(z7));
  nand2  g19(.a(new_n15_), .b(x0), .O(z5));
endmodule
