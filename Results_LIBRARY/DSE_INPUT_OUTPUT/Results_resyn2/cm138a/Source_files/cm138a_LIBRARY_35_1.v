...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n26_, new_n28_, new_n29_, new_n33_;
  ...
  nand2  g10(.a(new_n20_), .b(x0), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(x1), .O(z3));
  nand4  g12(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n28_));
  inv1   g13(.a(new_n28_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n16_), .c(new_n15_), .O(z4));
  nand3  g15(.a(new_n29_), .b(new_n16_), .c(x0), .O(z5));
  nand2  g16(.a(new_n28_), .b(x0), .O(new_n33_));
