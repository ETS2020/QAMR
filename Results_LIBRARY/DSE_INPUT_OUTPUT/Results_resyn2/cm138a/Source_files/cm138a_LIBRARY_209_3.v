...
module FAU ( 
  ...
  nand4  g13(.a(new_n16_), .b(new_n27_), .c(x3), .d(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x0), .O(z3));
  nand4  g16(.a(new_n16_), .b(new_n27_), .c(x3), .d(new_n24_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n21_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z4));
  nand4  g19(.a(new_n25_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
  one    g20(.O(z5));
  one    g21(.O(z7));
endmodule
