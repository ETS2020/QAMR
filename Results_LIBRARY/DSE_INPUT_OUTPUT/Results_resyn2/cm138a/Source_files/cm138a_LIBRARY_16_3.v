...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n27_, new_n29_;
  ...
  nand3  g15(.a(new_n29_), .b(new_n26_), .c(x1), .O(z3));
  nand2  g16(.a(new_n20_), .b(x2), .O(z4));
  nand3  g17(.a(new_n29_), .b(x2), .c(new_n15_), .O(z5));
  nand2  g18(.a(x2), .b(x1), .O(z6));
