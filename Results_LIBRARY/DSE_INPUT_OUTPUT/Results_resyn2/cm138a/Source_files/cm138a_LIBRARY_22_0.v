...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_, new_n35_;
  ...
  nand2  g12(.a(z4), .b(new_n21_), .O(new_n28_));
  xnor2a g13(.a(x1), .b(x0), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n28_), .O(z3));
  nand4  g15(.a(new_n20_), .b(new_n19_), .c(x3), .d(x2), .O(new_n31_));
  inv1   g16(.a(new_n31_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n17_), .O(z5));
  nand3  g18(.a(new_n32_), .b(x1), .c(new_n16_), .O(z6));
  nand2  g19(.a(new_n31_), .b(z4), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n29_), .O(z7));
  one    g21(.O(z0));
endmodule
