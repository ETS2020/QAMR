...
module FAU ( 
  ...
  and2   g12(.a(x2), .b(x1), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n18_), .c(new_n16_), .d(new_n21_), .O(z6));
  nand4  g14(.a(new_n27_), .b(new_n18_), .c(new_n16_), .d(x0), .O(z7));
  nand2  g15(.a(new_n15_), .b(x1), .O(z3));
endmodule
