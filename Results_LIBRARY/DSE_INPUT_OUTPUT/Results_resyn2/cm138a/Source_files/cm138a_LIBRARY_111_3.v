...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_;
  ...
  nand4  g17(.a(new_n25_), .b(x2), .c(new_n20_), .d(new_n19_), .O(z4));
  nor2   g18(.a(new_n15_), .b(new_n19_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n25_), .c(new_n20_), .O(z5));
  nand4  g20(.a(new_n25_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand3  g21(.a(new_n33_), .b(new_n25_), .c(x1), .O(z7));
endmodule
