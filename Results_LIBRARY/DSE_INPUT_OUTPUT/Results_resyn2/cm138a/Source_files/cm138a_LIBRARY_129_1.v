...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n27_, new_n29_, new_n30_, new_n31_;
  ...
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand3  g18(.a(new_n31_), .b(new_n24_), .c(new_n30_), .O(z5));
  nand3  g19(.a(new_n31_), .b(new_n27_), .c(new_n30_), .O(z7));
