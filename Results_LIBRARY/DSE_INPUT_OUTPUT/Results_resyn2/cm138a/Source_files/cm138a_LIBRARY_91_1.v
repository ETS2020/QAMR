...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n27_, new_n33_, new_n34_;
  ...
  nand3  g14(.a(new_n27_), .b(new_n24_), .c(x0), .O(z3));
  nand2  g15(.a(x2), .b(new_n15_), .O(z5));
  nand3  g16(.a(new_n26_), .b(x2), .c(x1), .O(z6));
  nand4  g17(.a(new_n19_), .b(new_n18_), .c(x3), .d(x0), .O(new_n33_));
