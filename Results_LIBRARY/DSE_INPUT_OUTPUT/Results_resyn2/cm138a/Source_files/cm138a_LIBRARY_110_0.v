...
module FAU ( 
  ...
  nor2   g08(.a(new_n22_), .b(new_n16_), .O(new_n23_));
  nor2   g09(.a(x4), .b(x2), .O(new_n24_));
  nand4  g10(.a(new_n24_), .b(new_n23_), .c(new_n18_), .d(x3), .O(z3));
  nand2  g11(.a(new_n15_), .b(new_n22_), .O(z4));
  ...
  nand4  g15(.a(new_n18_), .b(x3), .c(x2), .d(x0), .O(new_n30_));
