...
module FAU ( 
  ...
  nand3  g16(.a(new_n29_), .b(new_n22_), .c(new_n28_), .O(z3));
  nor2   g17(.a(new_n16_), .b(x1), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n28_), .c(x3), .d(new_n27_), .O(z4));
  nand3  g19(.a(new_n32_), .b(new_n22_), .c(new_n28_), .O(z5));
  nand4  g20(.a(new_n18_), .b(new_n17_), .c(x2), .d(x1), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n23_), .O(z6));
  nand4  g23(.a(new_n22_), .b(new_n28_), .c(x2), .d(x1), .O(z7));
endmodule
