...
module FAU ( 
  ...
  nor2   g19(.a(x4), .b(new_n22_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n18_), .c(new_n16_), .d(x0), .O(z5));
  nand3  g21(.a(new_n34_), .b(new_n27_), .c(new_n18_), .O(z6));
  nand3  g22(.a(new_n34_), .b(new_n29_), .c(new_n18_), .O(z7));
endmodule
