...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n27_, new_n29_, new_n31_;
  ...
  nand2  g14(.a(z4), .b(new_n27_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n26_), .O(z2));
  inv1   g16(.a(new_n23_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n16_), .c(x1), .O(z3));
  nand2  g18(.a(new_n26_), .b(x2), .O(z6));
  nand3  g19(.a(new_n31_), .b(x2), .c(x1), .O(z7));
  nand2  g20(.a(x2), .b(new_n15_), .O(z5));
endmodule
