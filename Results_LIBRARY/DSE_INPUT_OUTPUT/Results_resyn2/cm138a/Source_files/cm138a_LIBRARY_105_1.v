...
module FAU ( 
  ...
  nand2  g09(.a(new_n18_), .b(x3), .O(new_n24_));
  nand2  g10(.a(x1), .b(new_n15_), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(new_n24_), .c(new_n19_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n17_), .O(z2));
  nand2  g13(.a(x1), .b(x0), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(new_n24_), .c(new_n19_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n17_), .O(z3));
  nand2  g16(.a(new_n16_), .b(new_n15_), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n20_), .c(x2), .O(new_n32_));
  nand2  g18(.a(new_n19_), .b(new_n17_), .O(new_n33_));
  ...
  oai21  g23(.a(new_n25_), .b(new_n20_), .c(x2), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n33_), .O(z6));
  oai21  g25(.a(new_n28_), .b(new_n20_), .c(x2), .O(new_n40_));
