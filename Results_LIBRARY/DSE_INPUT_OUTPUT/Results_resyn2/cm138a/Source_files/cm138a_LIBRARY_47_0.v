...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n25_, new_n26_, new_n29_, new_n31_;
  inv1   g00(.a(x1), .O(new_n15_));
  inv1   g01(.a(x2), .O(new_n16_));
  nand2  g02(.a(new_n16_), .b(new_n15_), .O(z0));
  inv1   g03(.a(x3), .O(new_n18_));
  nor2   g04(.a(x4), .b(new_n18_), .O(new_n19_));
  nor2   g05(.a(x5), .b(x0), .O(new_n20_));
  nor2   g06(.a(x2), .b(new_n15_), .O(new_n21_));
  nand3  g07(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(z2));
  inv1   g08(.a(x4), .O(new_n23_));
  inv1   g09(.a(x5), .O(new_n24_));
  nand4  g10(.a(new_n24_), .b(new_n23_), .c(x3), .d(x0), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n21_), .O(z3));
  nand4  g13(.a(new_n20_), .b(new_n19_), .c(x2), .d(new_n15_), .O(z4));
  nand2  g14(.a(new_n25_), .b(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z5));
  nor2   g16(.a(new_n16_), .b(new_n15_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n20_), .c(new_n19_), .O(z6));
