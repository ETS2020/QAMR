...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n34_,
  ...
  nand2  g08(.a(x3), .b(x2), .O(new_n23_));
  ...
  nand4  g14(.a(new_n28_), .b(new_n15_), .c(x1), .d(new_n19_), .O(z2));
  nor2   g15(.a(new_n20_), .b(new_n19_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n28_), .c(new_n15_), .O(z3));
  nand4  g17(.a(new_n28_), .b(x2), .c(new_n20_), .d(new_n19_), .O(z4));
  nand4  g18(.a(new_n28_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  nand2  g19(.a(x1), .b(new_n19_), .O(new_n34_));
  nand2  g20(.a(new_n17_), .b(new_n16_), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n34_), .c(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z6));
  inv1   g23(.a(new_n35_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n30_), .c(x3), .d(x2), .O(z7));
endmodule
