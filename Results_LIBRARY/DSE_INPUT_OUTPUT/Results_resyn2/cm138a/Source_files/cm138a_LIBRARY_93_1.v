...
module FAU ( 
  ...
  nand3  g12(.a(new_n16_), .b(new_n17_), .c(x3), .O(new_n27_));
  ...
  oai21  g16(.a(new_n27_), .b(new_n24_), .c(x1), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z3));
  nor2   g18(.a(new_n20_), .b(x0), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n28_), .c(new_n15_), .O(z4));
  nand4  g20(.a(new_n28_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand3  g21(.a(new_n33_), .b(new_n28_), .c(x1), .O(z6));
  nand2  g22(.a(x2), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n27_), .c(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n30_), .O(z7));
endmodule
