...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n23_, new_n24_, new_n25_, new_n29_, new_n30_, new_n32_, new_n34_,
    new_n35_;
  ...
  nand4  g12(.a(new_n19_), .b(new_n18_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g13(.a(new_n19_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  nand4  g14(.a(new_n23_), .b(x2), .c(new_n16_), .d(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n21_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(z4));
  nor2   g17(.a(x5), .b(new_n22_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n18_), .c(new_n16_), .d(x0), .O(z5));
  nand4  g19(.a(new_n23_), .b(x2), .c(x1), .d(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n21_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(z6));
  nand4  g22(.a(new_n32_), .b(new_n18_), .c(x1), .d(x0), .O(z7));
endmodule
