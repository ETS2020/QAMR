...
module FAU ( 
  ...
  nand4  g19(.a(new_n33_), .b(new_n25_), .c(new_n18_), .d(new_n17_), .O(z4));
  nand4  g20(.a(new_n33_), .b(new_n25_), .c(new_n18_), .d(x0), .O(z5));
  nand4  g21(.a(new_n33_), .b(new_n25_), .c(x1), .d(new_n17_), .O(z6));
  nand4  g22(.a(x3), .b(x2), .c(x1), .d(x0), .O(new_n37_));
