...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n25_, new_n28_, new_n29_;
  ...
  and2   g14(.a(x3), .b(x2), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n15_), .O(z4));
  nand3  g16(.a(new_n29_), .b(new_n23_), .c(new_n28_), .O(z5));
  nand4  g17(.a(new_n29_), .b(new_n28_), .c(x1), .d(new_n22_), .O(z6));
