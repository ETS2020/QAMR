...
module FAU ( 
  ...
  nor2   g09(.a(new_n24_), .b(new_n15_), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n23_), .O(z2));
  nand2  g11(.a(new_n23_), .b(x0), .O(z3));
  ...
  nand4  g17(.a(new_n30_), .b(new_n29_), .c(x1), .d(new_n33_), .O(z6));
  nand3  g18(.a(new_n30_), .b(new_n24_), .c(new_n29_), .O(z7));
  one    g19(.O(z1));
  one    g20(.O(z5));
endmodule
