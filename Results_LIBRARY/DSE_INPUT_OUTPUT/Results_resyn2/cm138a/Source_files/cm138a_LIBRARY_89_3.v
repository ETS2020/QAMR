...
module FAU ( 
  ...
  nand3  g11(.a(new_n25_), .b(new_n24_), .c(new_n17_), .O(z1));
  nand2  g12(.a(x3), .b(x1), .O(z3));
  nand4  g13(.a(new_n24_), .b(x2), .c(new_n15_), .d(new_n16_), .O(z4));
  nand3  g14(.a(new_n25_), .b(new_n24_), .c(x2), .O(z5));
  buf    g15(.a(x0), .O(z2));
  nand2  g16(.a(x3), .b(x1), .O(z6));
  nand2  g17(.a(x3), .b(x1), .O(z7));
endmodule
