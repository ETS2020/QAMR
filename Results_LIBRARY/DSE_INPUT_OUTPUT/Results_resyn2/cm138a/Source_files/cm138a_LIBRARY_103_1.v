...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g14(.a(new_n27_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand2  g15(.a(x2), .b(new_n15_), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n26_), .c(x1), .O(new_n31_));
  nand2  g17(.a(new_n19_), .b(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z6));
  nand2  g19(.a(x2), .b(x0), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n26_), .c(x1), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n32_), .O(z7));
endmodule
