...
module FAU ( 
  ...
  nand3  g12(.a(new_n21_), .b(new_n16_), .c(x1), .O(z2));
  nand2  g13(.a(new_n23_), .b(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x1), .O(z3));
  nand3  g15(.a(new_n21_), .b(x2), .c(new_n15_), .O(z4));
  nand2  g16(.a(new_n24_), .b(x2), .O(z5));
