...
module FAU ( 
  ...
  xor2a  g18(.a(x4), .b(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n21_), .O(z4));
  nor2   g20(.a(x4), .b(new_n15_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n24_), .c(new_n18_), .d(x0), .O(z5));
  nand2  g22(.a(new_n27_), .b(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n33_), .O(z6));
  inv1   g24(.a(new_n30_), .O(new_n39_));
  nand2  g25(.a(new_n35_), .b(new_n39_), .O(z7));
endmodule
