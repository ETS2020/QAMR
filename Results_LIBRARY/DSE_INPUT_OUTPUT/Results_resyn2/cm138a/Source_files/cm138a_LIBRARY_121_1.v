...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n26_, new_n27_, new_n30_, new_n31_, new_n34_;
  ...
  nand2  g11(.a(new_n22_), .b(x0), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(z2), .O(new_n27_));
  ...
  nand3  g18(.a(new_n31_), .b(new_n22_), .c(x0), .O(z5));
