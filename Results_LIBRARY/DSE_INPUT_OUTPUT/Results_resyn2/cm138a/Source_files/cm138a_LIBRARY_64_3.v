...
module FAU ( 
  ...
  nand2  g10(.a(new_n19_), .b(x4), .O(new_n25_));
  ...
  nand2  g17(.a(new_n31_), .b(new_n25_), .O(z3));
  nand3  g18(.a(new_n19_), .b(x3), .c(x2), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g21(.a(new_n34_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z5));
  nand4  g22(.a(new_n34_), .b(new_n17_), .c(x1), .d(new_n15_), .O(z6));
  oai21  g23(.a(new_n33_), .b(new_n30_), .c(new_n17_), .O(new_n38_));
