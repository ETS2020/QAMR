...
module FAU ( 
  ...
  nor2   g26(.a(new_n67_), .b(x10), .O(new_n68_));
  oai21  g27(.a(new_n66_), .b(new_n50_), .c(new_n68_), .O(z05));
  ...
  nor2   g34(.a(new_n67_), .b(new_n75_), .O(z08));
  nor3   g35(.a(new_n67_), .b(new_n73_), .c(new_n75_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n44_), .b(new_n73_), .O(new_n79_));
  ...
  nand2  g42(.a(new_n73_), .b(x17), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(z11));
  nand2  g44(.a(new_n80_), .b(x23), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  nand2  g46(.a(new_n44_), .b(x23), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(new_n84_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  nor2   g49(.a(new_n79_), .b(new_n90_), .O(z14));
  nor2   g50(.a(x13), .b(x12), .O(new_n92_));
  nor2   g51(.a(x15), .b(x14), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n44_), .O(z15));
endmodule
