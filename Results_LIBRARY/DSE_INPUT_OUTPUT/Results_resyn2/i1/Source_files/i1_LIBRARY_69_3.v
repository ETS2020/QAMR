...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n62_, new_n63_, new_n64_, new_n67_, new_n68_, new_n71_,
  ...
  nand2  g21(.a(new_n56_), .b(new_n53_), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(x19), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n62_), .O(z05));
  nor2   g24(.a(new_n45_), .b(x08), .O(z06));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n67_), .O(z15));
endmodule
