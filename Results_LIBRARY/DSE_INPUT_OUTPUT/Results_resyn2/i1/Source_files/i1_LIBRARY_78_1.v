...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n67_, new_n69_, new_n71_, new_n73_, new_n76_, new_n77_, new_n79_,
    new_n81_, new_n84_, new_n86_, new_n87_;
  inv1   g00(.a(x00), .O(new_n42_));
  oai21  g01(.a(x24), .b(x19), .c(new_n42_), .O(new_n43_));
  ...
  oai21  g08(.a(new_n44_), .b(x08), .c(x19), .O(new_n50_));
  oai21  g09(.a(new_n50_), .b(new_n49_), .c(new_n43_), .O(z01));
  inv1   g10(.a(x24), .O(new_n52_));
  nor2   g11(.a(new_n52_), .b(x00), .O(new_n53_));
  ...
  nand3  g17(.a(new_n58_), .b(new_n49_), .c(x19), .O(new_n59_));
  ...
  aoi21  g30(.a(new_n71_), .b(x00), .c(new_n52_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n54_), .b(new_n73_), .O(z08));
  aoi21  g33(.a(new_n73_), .b(x00), .c(new_n52_), .O(z09));
  ...
  nand2  g42(.a(new_n52_), .b(x16), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n54_), .O(z14));
