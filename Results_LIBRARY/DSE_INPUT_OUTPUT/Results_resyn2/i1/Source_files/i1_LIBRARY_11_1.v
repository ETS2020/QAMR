...
module FAU ( 
  ...
  oai21  g21(.a(new_n59_), .b(new_n61_), .c(new_n53_), .O(z09));
  oai21  g22(.a(new_n43_), .b(x07), .c(new_n59_), .O(new_n64_));
  nand2  g23(.a(x22), .b(x14), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n64_), .O(z10));
  inv1   g25(.a(x22), .O(new_n67_));
  nand2  g26(.a(new_n59_), .b(x17), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n67_), .c(new_n53_), .O(z11));
  nand3  g28(.a(new_n59_), .b(x23), .c(x14), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n53_), .O(z12));
  inv1   g30(.a(x23), .O(new_n72_));
  oai21  g31(.a(new_n68_), .b(new_n72_), .c(new_n53_), .O(z13));
  nand2  g32(.a(new_n59_), .b(x16), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n53_), .O(z14));
  nor2   g34(.a(x13), .b(x12), .O(new_n76_));
  nor2   g35(.a(x15), .b(x14), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n76_), .c(new_n53_), .O(z15));
  buf    g37(.a(x19), .O(z06));
endmodule
