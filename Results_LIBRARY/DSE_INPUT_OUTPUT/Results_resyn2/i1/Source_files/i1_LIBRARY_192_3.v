...
module FAU ( 
  ...
  nand2  g00(.a(x21), .b(x08), .O(new_n42_));
  ...
  oai21  g14(.a(new_n55_), .b(new_n48_), .c(new_n53_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(x08), .O(new_n57_));
  nand3  g16(.a(new_n48_), .b(x19), .c(x00), .O(new_n58_));
  ...
  aoi21  g21(.a(new_n53_), .b(new_n60_), .c(new_n62_), .O(z04));
  inv1   g22(.a(x08), .O(new_n64_));
  nand2  g23(.a(x19), .b(new_n64_), .O(new_n65_));
  nor2   g24(.a(new_n62_), .b(x10), .O(new_n66_));
  oai21  g25(.a(new_n65_), .b(new_n48_), .c(new_n66_), .O(z05));
  and2   g26(.a(new_n42_), .b(x19), .O(z06));
  ...
  oai21  g35(.a(new_n76_), .b(new_n74_), .c(new_n42_), .O(z10));
  nand4  g36(.a(new_n42_), .b(new_n75_), .c(x22), .d(x17), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z11));
  inv1   g38(.a(x23), .O(new_n80_));
  oai21  g39(.a(new_n76_), .b(new_n80_), .c(new_n42_), .O(z12));
  nand2  g40(.a(x23), .b(x17), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(x24), .c(new_n42_), .O(z13));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n62_), .O(z15));
endmodule
