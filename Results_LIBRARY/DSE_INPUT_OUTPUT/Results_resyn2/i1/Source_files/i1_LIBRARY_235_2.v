...
module FAU ( 
  ...
  nand2  g25(.a(new_n51_), .b(new_n43_), .O(new_n67_));
  nand2  g26(.a(new_n63_), .b(x10), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n56_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n67_), .c(new_n68_), .O(z05));
