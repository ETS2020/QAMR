...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n71_, new_n73_, new_n76_, new_n78_, new_n79_,
  ...
  nand4  g34(.a(new_n46_), .b(new_n71_), .c(x22), .d(x14), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z10));
  inv1   g36(.a(x22), .O(new_n78_));
  nand2  g37(.a(new_n71_), .b(x17), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n46_), .O(z11));
  nand4  g39(.a(new_n46_), .b(new_n71_), .c(x23), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  inv1   g41(.a(x23), .O(new_n83_));
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n46_), .O(z13));
