...
module FAU ( 
  ...
  nand3  g28(.a(new_n52_), .b(x19), .c(new_n59_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(z05));
  inv1   g30(.a(x18), .O(new_n72_));
  inv1   g31(.a(x24), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n65_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n65_), .b(new_n75_), .O(z08));
  nor3   g35(.a(new_n45_), .b(new_n73_), .c(new_n75_), .O(z09));
  inv1   g36(.a(x22), .O(new_n78_));
  nand2  g37(.a(new_n73_), .b(x14), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n65_), .O(z10));
  nand4  g39(.a(new_n65_), .b(new_n73_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n65_), .O(z12));
  nand3  g43(.a(new_n73_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n65_), .O(z13));
  nand2  g45(.a(new_n73_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n65_), .O(z14));
