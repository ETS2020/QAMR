...
module FAU ( 
  ...
  nand2  g16(.a(new_n57_), .b(new_n51_), .O(z07));
  oai21  g17(.a(new_n43_), .b(x03), .c(x11), .O(new_n59_));
  ...
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(new_n51_), .O(z10));
  inv1   g24(.a(x17), .O(new_n66_));
  oai21  g25(.a(new_n64_), .b(new_n66_), .c(new_n51_), .O(z11));
  nand2  g26(.a(new_n61_), .b(x23), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n63_), .c(new_n51_), .O(z12));
  oai21  g28(.a(new_n68_), .b(new_n66_), .c(new_n51_), .O(z13));
