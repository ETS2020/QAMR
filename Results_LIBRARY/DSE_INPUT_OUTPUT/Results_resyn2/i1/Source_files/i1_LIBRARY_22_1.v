...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n61_, new_n64_, new_n66_, new_n67_, new_n69_,
  ...
  nand3  g12(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n54_));
  ...
  aoi21  g18(.a(new_n59_), .b(new_n55_), .c(new_n47_), .O(z02));
  ...
  nor3   g29(.a(new_n45_), .b(new_n67_), .c(new_n69_), .O(z09));
  inv1   g30(.a(x22), .O(new_n72_));
  nand2  g31(.a(new_n44_), .b(new_n67_), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x14), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand2  g35(.a(new_n74_), .b(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  inv1   g37(.a(x14), .O(new_n79_));
  nand2  g38(.a(new_n67_), .b(x23), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .O(z12));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n44_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  nor2   g43(.a(new_n73_), .b(new_n84_), .O(z14));
