...
module FAU ( 
  ...
  oai21  g24(.a(new_n51_), .b(x08), .c(x11), .O(new_n66_));
  ...
  nand3  g39(.a(new_n72_), .b(x23), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z12));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n75_), .O(z13));
