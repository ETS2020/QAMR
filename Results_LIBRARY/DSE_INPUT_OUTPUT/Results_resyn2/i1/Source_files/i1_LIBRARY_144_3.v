...
module FAU ( 
  ...
  nor2   g15(.a(x04), .b(x03), .O(new_n57_));
  ...
  aoi21  g23(.a(new_n64_), .b(new_n52_), .c(x07), .O(new_n65_));
  ...
  nor2   g32(.a(new_n45_), .b(x07), .O(z06));
  nand2  g33(.a(z06), .b(new_n73_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n58_), .c(new_n72_), .O(z05));
  ...
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z15));
endmodule
