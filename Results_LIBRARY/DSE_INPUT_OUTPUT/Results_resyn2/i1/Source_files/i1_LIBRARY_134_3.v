...
module FAU ( 
  ...
  nand2  g24(.a(new_n54_), .b(new_n64_), .O(z04));
  ...
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n43_), .O(z10));
  nand3  g37(.a(new_n43_), .b(new_n74_), .c(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x22), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  oai21  g42(.a(new_n77_), .b(new_n83_), .c(new_n43_), .O(z12));
