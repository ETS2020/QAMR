...
module FAU ( 
  ...
  nor2   g24(.a(x19), .b(new_n64_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(x10), .O(new_n67_));
  oai21  g26(.a(new_n65_), .b(new_n57_), .c(new_n67_), .O(z05));
  nand2  g27(.a(x24), .b(x18), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n66_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nor2   g30(.a(new_n66_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x24), .O(new_n73_));
  nor3   g32(.a(new_n66_), .b(new_n73_), .c(new_n71_), .O(z09));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n66_), .O(z15));
  buf    g47(.a(x19), .O(z06));
endmodule
