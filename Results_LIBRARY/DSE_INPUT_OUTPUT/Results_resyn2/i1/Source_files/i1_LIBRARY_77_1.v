...
module FAU ( 
  ...
  nand4  g29(.a(new_n70_), .b(new_n55_), .c(new_n47_), .d(new_n46_), .O(new_n71_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n66_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n66_), .O(z11));
  nand2  g44(.a(new_n79_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n81_), .c(new_n66_), .O(z12));
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n66_), .O(z13));
  nand2  g47(.a(new_n79_), .b(x16), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(new_n44_), .O(z14));
  nor3   g49(.a(x15), .b(x14), .c(x12), .O(new_n91_));
