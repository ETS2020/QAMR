...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n72_, new_n75_, new_n77_, new_n79_, new_n81_,
  ...
  nand2  g29(.a(new_n70_), .b(new_n43_), .O(z06));
  nand3  g30(.a(x24), .b(x19), .c(x18), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z07));
  and2   g32(.a(new_n44_), .b(x11), .O(z08));
  nand3  g33(.a(x24), .b(x19), .c(x11), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z09));
  nand3  g35(.a(new_n70_), .b(x22), .c(x14), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n44_), .O(z10));
  nand2  g37(.a(x22), .b(x17), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x24), .O(z11));
  ...
  nand2  g43(.a(new_n70_), .b(x16), .O(new_n85_));
