...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(new_n50_), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  nand2  g21(.a(new_n50_), .b(new_n62_), .O(z03));
  ...
  nand2  g29(.a(new_n50_), .b(new_n70_), .O(z06));
  and2   g30(.a(x24), .b(x18), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n50_), .b(new_n73_), .O(z08));
  nor2   g33(.a(new_n67_), .b(new_n73_), .O(z09));
  nand2  g34(.a(x22), .b(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x10), .c(x24), .O(z10));
  nand2  g36(.a(x22), .b(x17), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x10), .c(x24), .O(z11));
  nand2  g38(.a(x23), .b(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x10), .c(x24), .O(z12));
  nand4  g40(.a(new_n67_), .b(x23), .c(x17), .d(x10), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  nand2  g42(.a(x16), .b(x10), .O(new_n84_));
