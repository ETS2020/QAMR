...
module FAU ( 
  ...
  oai22  g34(.a(new_n75_), .b(new_n59_), .c(new_n45_), .d(new_n73_), .O(z05));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n45_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n70_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n70_), .O(z09));
  ...
  oai21  g48(.a(new_n84_), .b(new_n89_), .c(new_n70_), .O(z12));
