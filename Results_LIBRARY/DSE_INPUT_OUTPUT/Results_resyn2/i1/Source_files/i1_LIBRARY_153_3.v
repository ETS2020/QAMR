...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n72_, new_n75_, new_n77_, new_n79_, new_n81_,
  ...
  oai22  g26(.a(new_n67_), .b(new_n51_), .c(x19), .d(new_n45_), .O(z05));
  ...
  nand3  g33(.a(new_n70_), .b(x22), .c(x14), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(z10));
  nand4  g35(.a(new_n43_), .b(new_n70_), .c(x22), .d(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  nand4  g37(.a(new_n43_), .b(new_n70_), .c(x23), .d(x14), .O(new_n79_));
