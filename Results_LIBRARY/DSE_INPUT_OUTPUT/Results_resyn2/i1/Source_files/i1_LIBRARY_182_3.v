...
module FAU ( 
  ...
  aoi21  g23(.a(new_n45_), .b(new_n62_), .c(new_n64_), .O(z04));
  ...
  nor2   g30(.a(new_n71_), .b(new_n64_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n43_), .b(new_n73_), .O(z08));
  nor2   g33(.a(new_n64_), .b(x24), .O(new_n75_));
  aoi21  g34(.a(new_n43_), .b(new_n73_), .c(new_n75_), .O(z09));
  ...
  nand3  g39(.a(new_n75_), .b(x23), .c(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  nand3  g41(.a(new_n75_), .b(x23), .c(x17), .O(new_n83_));
