...
module FAU ( 
  ...
  nor2   g20(.a(new_n44_), .b(x17), .O(new_n62_));
  ...
  nand4  g29(.a(new_n70_), .b(new_n59_), .c(new_n49_), .d(new_n48_), .O(new_n71_));
  ...
  nand2  g34(.a(new_n75_), .b(new_n46_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nand2  g36(.a(new_n46_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n46_), .O(z09));
  nand4  g39(.a(new_n46_), .b(new_n79_), .c(x22), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  nand2  g41(.a(new_n79_), .b(x22), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n44_), .c(new_n43_), .O(z11));
  nand4  g43(.a(new_n46_), .b(new_n79_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand4  g45(.a(new_n79_), .b(x23), .c(new_n44_), .d(x17), .O(new_n87_));
