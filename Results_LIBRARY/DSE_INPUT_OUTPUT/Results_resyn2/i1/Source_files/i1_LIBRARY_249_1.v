...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n64_, new_n65_, new_n67_, new_n70_, new_n72_,
  ...
  oai21  g24(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z07));
  inv1   g25(.a(x11), .O(new_n67_));
  nand2  g26(.a(new_n44_), .b(new_n67_), .O(z08));
  oai21  g27(.a(new_n65_), .b(new_n67_), .c(new_n44_), .O(z09));
  nand2  g28(.a(x22), .b(x14), .O(new_n70_));
  nor3   g29(.a(new_n70_), .b(new_n45_), .c(x24), .O(z10));
  inv1   g30(.a(x22), .O(new_n72_));
  nand2  g31(.a(new_n65_), .b(x17), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z11));
  nand3  g33(.a(new_n65_), .b(x23), .c(x14), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n44_), .O(z12));
  inv1   g35(.a(x23), .O(new_n77_));
  oai21  g36(.a(new_n73_), .b(new_n77_), .c(new_n44_), .O(z13));
  nand2  g37(.a(new_n65_), .b(x16), .O(new_n79_));
