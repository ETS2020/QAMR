...
module FAU ( 
  ...
  nor2   g10(.a(x07), .b(new_n42_), .O(new_n52_));
  ...
  nor2   g14(.a(new_n46_), .b(x07), .O(z06));
  ...
  nand3  g39(.a(new_n43_), .b(new_n77_), .c(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x22), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand4  g43(.a(new_n43_), .b(new_n77_), .c(x23), .d(x14), .O(new_n85_));
