...
module FAU ( 
  ...
  nand4  g18(.a(new_n59_), .b(x08), .c(new_n58_), .d(new_n57_), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n50_), .c(x19), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  nor2   g21(.a(x04), .b(x03), .O(new_n63_));
  nand4  g22(.a(new_n52_), .b(new_n63_), .c(new_n47_), .d(new_n46_), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(x19), .c(x00), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n62_), .O(z02));
  ...
  oai21  g33(.a(new_n74_), .b(new_n64_), .c(new_n72_), .O(z05));
  nand2  g34(.a(x24), .b(x18), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n71_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nand2  g37(.a(new_n71_), .b(new_n78_), .O(z08));
  ...
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n71_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n71_), .O(z11));
  nand2  g45(.a(new_n80_), .b(x23), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n82_), .c(new_n71_), .O(z12));
  oai21  g47(.a(new_n87_), .b(new_n85_), .c(new_n71_), .O(z13));
  nand2  g48(.a(new_n80_), .b(x16), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n71_), .O(z14));
