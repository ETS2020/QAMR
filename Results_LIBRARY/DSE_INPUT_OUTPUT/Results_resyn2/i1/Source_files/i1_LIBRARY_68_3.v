...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n53_), .c(x05), .O(new_n66_));
  ...
  or2    g30(.a(new_n46_), .b(x08), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n59_), .c(new_n71_), .O(z05));
  ...
  nand4  g44(.a(new_n43_), .b(new_n81_), .c(x23), .d(x14), .O(new_n86_));
