...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
    ...
    new_n65_, new_n67_, new_n69_, new_n70_, new_n73_, new_n75_, new_n76_;
  ...
  nor2   g09(.a(new_n48_), .b(x07), .O(new_n51_));
  ...
  oai21  g23(.a(new_n48_), .b(x07), .c(x14), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n64_), .O(z10));
  inv1   g25(.a(x17), .O(new_n67_));
  oai21  g26(.a(new_n64_), .b(new_n67_), .c(new_n44_), .O(z11));
  inv1   g27(.a(x14), .O(new_n69_));
  nand2  g28(.a(new_n63_), .b(x23), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z12));
  oai21  g30(.a(new_n70_), .b(new_n67_), .c(new_n44_), .O(z13));
