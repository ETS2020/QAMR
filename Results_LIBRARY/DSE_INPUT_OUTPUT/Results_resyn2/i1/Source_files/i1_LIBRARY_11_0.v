...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n72_, new_n74_, new_n77_, new_n79_, new_n80_,
  ...
  nand2  g28(.a(new_n45_), .b(x07), .O(z06));
  ...
  oai21  g34(.a(new_n72_), .b(new_n74_), .c(new_n63_), .O(z09));
  nand2  g35(.a(x22), .b(x14), .O(new_n77_));
  nor3   g36(.a(new_n77_), .b(new_n43_), .c(x24), .O(z10));
  inv1   g37(.a(x22), .O(new_n79_));
  nand2  g38(.a(new_n72_), .b(x17), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(z11));
  nand3  g40(.a(new_n72_), .b(x23), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n63_), .O(z12));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n80_), .b(new_n84_), .c(new_n63_), .O(z13));
