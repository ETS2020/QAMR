...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n83_, new_n84_, new_n86_, new_n88_, new_n90_, new_n91_;
  ...
  nor2   g28(.a(new_n47_), .b(x08), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n71_));
  ...
  nand4  g38(.a(new_n78_), .b(x22), .c(x17), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z10));
  aoi21  g40(.a(x24), .b(x17), .c(new_n43_), .O(z11));
