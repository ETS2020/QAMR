...
module FAU ( 
  ...
  nand2  g13(.a(new_n54_), .b(new_n44_), .O(z04));
  inv1   g14(.a(x10), .O(new_n56_));
  nand2  g15(.a(new_n44_), .b(new_n56_), .O(z05));
  inv1   g16(.a(x18), .O(new_n58_));
  inv1   g17(.a(x24), .O(new_n59_));
  oai21  g18(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(z07));
  inv1   g19(.a(x11), .O(new_n61_));
  nand2  g20(.a(new_n44_), .b(new_n61_), .O(z08));
  oai21  g21(.a(new_n59_), .b(new_n61_), .c(new_n44_), .O(z09));
  inv1   g22(.a(x22), .O(new_n64_));
  nand2  g23(.a(new_n59_), .b(x14), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z10));
  nand4  g25(.a(new_n44_), .b(new_n59_), .c(x22), .d(x17), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z11));
  oai21  g27(.a(new_n51_), .b(x07), .c(x23), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n65_), .O(z12));
  nand4  g29(.a(new_n44_), .b(new_n59_), .c(x23), .d(x17), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z13));
  nand2  g31(.a(new_n59_), .b(x16), .O(new_n73_));
