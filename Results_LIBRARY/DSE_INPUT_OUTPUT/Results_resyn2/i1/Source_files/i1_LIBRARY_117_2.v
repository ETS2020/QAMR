...
module FAU ( 
  ...
  aoi21  g31(.a(new_n72_), .b(x19), .c(new_n71_), .O(z09));
  inv1   g32(.a(x22), .O(new_n74_));
  nand2  g33(.a(new_n72_), .b(x14), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z10));
  nand4  g35(.a(new_n44_), .b(new_n72_), .c(x22), .d(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  nand2  g37(.a(new_n44_), .b(x23), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n75_), .O(z12));
  nand4  g39(.a(new_n44_), .b(new_n72_), .c(x23), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  inv1   g41(.a(x16), .O(new_n83_));
  nor3   g42(.a(new_n68_), .b(x24), .c(new_n83_), .O(z14));
