...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n82_, new_n84_, new_n86_, new_n88_, new_n89_;
  ...
  nand3  g26(.a(x19), .b(new_n45_), .c(new_n57_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n51_), .c(new_n67_), .O(z05));
  inv1   g28(.a(x19), .O(new_n70_));
  nand3  g29(.a(x24), .b(new_n70_), .c(x18), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n64_), .b(new_n73_), .O(z08));
