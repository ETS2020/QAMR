...
module FAU ( 
  ...
  nor2   g12(.a(new_n46_), .b(x03), .O(new_n54_));
  nor2   g13(.a(new_n54_), .b(new_n53_), .O(z05));
  ...
  nand2  g22(.a(new_n58_), .b(x22), .O(new_n64_));
  ...
  oai21  g26(.a(new_n46_), .b(x03), .c(new_n58_), .O(new_n68_));
  ...
  nor2   g32(.a(new_n68_), .b(new_n73_), .O(z14));
