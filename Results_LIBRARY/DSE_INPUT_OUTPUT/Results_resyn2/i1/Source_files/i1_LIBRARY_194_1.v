...
module FAU ( 
  ...
  nand2  g08(.a(x19), .b(x18), .O(new_n50_));
  ...
  nor2   g18(.a(new_n59_), .b(x07), .O(new_n60_));
  nand4  g19(.a(new_n60_), .b(new_n47_), .c(new_n46_), .d(new_n58_), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n57_), .c(new_n50_), .O(z02));
  ...
  inv1   g27(.a(new_n50_), .O(z06));
  nand2  g28(.a(z06), .b(new_n59_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n56_), .c(new_n68_), .O(z05));
  inv1   g30(.a(x24), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n42_), .c(new_n43_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nor2   g33(.a(new_n65_), .b(new_n74_), .O(z08));
  nor3   g34(.a(new_n65_), .b(new_n72_), .c(new_n74_), .O(z09));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n72_), .b(x22), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n43_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n43_), .O(z11));
  nand2  g40(.a(new_n72_), .b(x23), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n77_), .c(new_n43_), .O(z12));
  oai21  g42(.a(new_n82_), .b(new_n80_), .c(new_n43_), .O(z13));
  nand2  g43(.a(new_n72_), .b(x16), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n65_), .O(z14));
  nor2   g45(.a(x13), .b(x12), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n65_), .O(z15));
endmodule
