...
module FAU ( 
  ...
  nor2   g11(.a(x24), .b(new_n42_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(z01));
  inv1   g13(.a(x07), .O(new_n55_));
  nor2   g14(.a(x06), .b(x05), .O(new_n56_));
  nand4  g15(.a(new_n56_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  nor2   g17(.a(x24), .b(new_n43_), .O(z06));
  ...
  nand2  g24(.a(new_n46_), .b(new_n65_), .O(z03));
  ...
  nand2  g39(.a(new_n44_), .b(x14), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n46_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  nor3   g42(.a(x24), .b(new_n80_), .c(new_n83_), .O(z11));
  inv1   g43(.a(x23), .O(new_n85_));
  oai21  g44(.a(new_n81_), .b(new_n85_), .c(new_n46_), .O(z12));
