...
module FAU ( 
  ...
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(new_n51_), .O(z09));
  oai21  g21(.a(new_n43_), .b(x07), .c(new_n61_), .O(new_n63_));
  ...
  nand3  g27(.a(new_n61_), .b(x23), .c(x14), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n51_), .O(z12));
  oai21  g29(.a(new_n43_), .b(x07), .c(x23), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n67_), .O(z13));
  nand2  g31(.a(new_n61_), .b(x16), .O(new_n73_));
