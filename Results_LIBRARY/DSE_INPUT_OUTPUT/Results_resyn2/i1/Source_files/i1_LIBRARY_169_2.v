...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n70_, new_n72_, new_n74_, new_n75_, new_n77_, new_n79_, new_n81_,
  ...
  oai21  g21(.a(new_n62_), .b(x19), .c(new_n42_), .O(z04));
  nand2  g22(.a(new_n43_), .b(x10), .O(new_n64_));
  nand3  g23(.a(x20), .b(x19), .c(new_n56_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n54_), .c(new_n64_), .O(z05));
  ...
  nand3  g37(.a(new_n72_), .b(x23), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n43_), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n67_), .c(x24), .O(z13));
  nand2  g41(.a(new_n72_), .b(x16), .O(new_n83_));
