...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(x08), .c(new_n43_), .O(new_n53_));
  oai21  g12(.a(new_n43_), .b(x08), .c(new_n53_), .O(new_n54_));
  aoi21  g13(.a(x19), .b(new_n42_), .c(new_n44_), .O(new_n55_));
  oai21  g14(.a(new_n54_), .b(new_n51_), .c(new_n55_), .O(z01));
  nand2  g15(.a(new_n51_), .b(new_n42_), .O(new_n57_));
  nor3   g16(.a(x07), .b(x06), .c(x05), .O(new_n58_));
  nand2  g17(.a(new_n43_), .b(x08), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(new_n50_), .c(new_n49_), .d(new_n58_), .O(new_n60_));
  ...
  nand2  g29(.a(new_n52_), .b(new_n43_), .O(z06));
