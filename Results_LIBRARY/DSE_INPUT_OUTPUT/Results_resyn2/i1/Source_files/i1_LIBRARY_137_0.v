...
module FAU ( 
  ...
  nand4  g18(.a(new_n48_), .b(new_n47_), .c(new_n59_), .d(new_n58_), .O(new_n60_));
  ...
  nor2   g28(.a(new_n43_), .b(x10), .O(new_n70_));
  oai21  g29(.a(new_n69_), .b(new_n60_), .c(new_n70_), .O(z05));
  inv1   g30(.a(x15), .O(new_n72_));
  nor2   g31(.a(x24), .b(new_n72_), .O(new_n73_));
  inv1   g32(.a(x24), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(x18), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n73_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nand2  g36(.a(new_n44_), .b(new_n77_), .O(z08));
  nor2   g37(.a(new_n74_), .b(new_n77_), .O(z09));
  nand2  g38(.a(x22), .b(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x15), .c(x24), .O(z10));
  nand3  g40(.a(new_n73_), .b(x22), .c(x17), .O(new_n82_));
  ...
  aoi21  g45(.a(new_n86_), .b(x15), .c(x24), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(x15), .c(x24), .O(z14));
  nor2   g48(.a(x13), .b(x12), .O(new_n90_));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(x24), .O(z15));
endmodule
