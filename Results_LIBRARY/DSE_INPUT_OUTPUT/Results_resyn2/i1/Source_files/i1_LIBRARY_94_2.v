...
module FAU ( 
  ...
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(z07));
  ...
  nand4  g39(.a(new_n53_), .b(new_n73_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n53_), .O(z12));
  nand4  g43(.a(new_n53_), .b(new_n73_), .c(x23), .d(x17), .O(new_n85_));
