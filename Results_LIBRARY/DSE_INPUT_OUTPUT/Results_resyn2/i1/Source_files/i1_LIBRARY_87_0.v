...
module FAU ( 
  ...
  nor2   g01(.a(x19), .b(x02), .O(new_n43_));
  nor2   g02(.a(new_n43_), .b(new_n42_), .O(z00));
  inv1   g03(.a(x19), .O(new_n45_));
  nor2   g04(.a(x05), .b(x04), .O(new_n46_));
  nor2   g05(.a(x07), .b(x06), .O(new_n47_));
  ...
  inv1   g17(.a(x03), .O(new_n59_));
  inv1   g18(.a(x09), .O(new_n60_));
  nand4  g19(.a(new_n60_), .b(x08), .c(new_n59_), .d(new_n58_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n57_), .c(x19), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n52_), .O(new_n63_));
  nand3  g22(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(x19), .c(x00), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n63_), .O(z02));
  inv1   g25(.a(x20), .O(new_n67_));
  nor2   g26(.a(new_n43_), .b(new_n67_), .O(z03));
  inv1   g27(.a(x21), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n43_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  inv1   g30(.a(x08), .O(new_n72_));
  nor2   g31(.a(x03), .b(x01), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n47_), .c(new_n46_), .d(new_n72_), .O(new_n74_));
  ...
  oai21  g39(.a(new_n79_), .b(new_n78_), .c(new_n80_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n80_), .b(new_n82_), .O(z08));
  oai21  g42(.a(new_n79_), .b(new_n82_), .c(new_n80_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  nand2  g44(.a(new_n79_), .b(x22), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n80_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n80_), .O(z11));
  nand3  g48(.a(new_n79_), .b(x23), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n80_), .O(z12));
  nand2  g50(.a(new_n80_), .b(new_n79_), .O(new_n92_));
  nand2  g51(.a(x23), .b(x17), .O(new_n93_));
  nor2   g52(.a(new_n93_), .b(new_n92_), .O(z13));
  inv1   g53(.a(x16), .O(new_n95_));
  nor2   g54(.a(new_n92_), .b(new_n95_), .O(z14));
