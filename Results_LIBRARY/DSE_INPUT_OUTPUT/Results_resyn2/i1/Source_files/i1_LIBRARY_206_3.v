...
module FAU ( 
  ...
  inv1   g16(.a(new_n48_), .O(new_n58_));
  oai21  g17(.a(new_n53_), .b(new_n58_), .c(x00), .O(new_n59_));
  ...
  aoi21  g23(.a(new_n64_), .b(new_n54_), .c(x03), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n59_), .c(new_n44_), .O(z02));
  ...
  nand2  g29(.a(new_n70_), .b(new_n69_), .O(z04));
  ...
  inv1   g36(.a(new_n47_), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n45_), .O(z07));
  ...
  oai21  g49(.a(new_n90_), .b(new_n85_), .c(new_n69_), .O(z12));
  oai21  g50(.a(new_n90_), .b(new_n88_), .c(new_n69_), .O(z13));
