...
module FAU ( 
  ...
  nand2  g13(.a(new_n54_), .b(new_n44_), .O(z01));
  ...
  nor2   g26(.a(new_n45_), .b(x10), .O(new_n68_));
  ...
  nand4  g34(.a(new_n74_), .b(x22), .c(x19), .d(x14), .O(new_n76_));
  ...
  aoi21  g41(.a(new_n82_), .b(x19), .c(new_n81_), .O(z12));
  nor2   g42(.a(new_n82_), .b(new_n79_), .O(z13));
