...
module FAU ( 
  ...
  nor2   g40(.a(new_n44_), .b(x24), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x23), .c(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand3  g43(.a(new_n82_), .b(x23), .c(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  and2   g45(.a(new_n82_), .b(x16), .O(z14));
