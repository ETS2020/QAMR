...
module FAU ( 
  ...
  nand2  g06(.a(new_n47_), .b(x19), .O(new_n48_));
  ...
  aoi21  g12(.a(new_n53_), .b(x00), .c(new_n48_), .O(z01));
  ...
  oai21  g29(.a(new_n69_), .b(new_n57_), .c(new_n70_), .O(z05));
  inv1   g30(.a(new_n48_), .O(z06));
  inv1   g31(.a(x18), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n43_), .c(new_n44_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n45_), .b(new_n75_), .O(z08));
  aoi21  g35(.a(new_n43_), .b(new_n75_), .c(new_n44_), .O(z09));
  ...
  nand2  g44(.a(new_n44_), .b(x16), .O(new_n86_));
