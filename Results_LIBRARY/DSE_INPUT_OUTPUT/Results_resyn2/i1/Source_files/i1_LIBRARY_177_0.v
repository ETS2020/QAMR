...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n70_, new_n71_, new_n73_, new_n76_, new_n77_, new_n78_, new_n80_,
  ...
  oai21  g26(.a(new_n50_), .b(x08), .c(new_n67_), .O(z05));
  nand2  g27(.a(new_n66_), .b(x10), .O(z06));
  inv1   g28(.a(x18), .O(new_n70_));
  nand2  g29(.a(new_n44_), .b(x24), .O(new_n71_));
  ...
  oai21  g41(.a(new_n82_), .b(x24), .c(new_n44_), .O(z12));
  nand2  g42(.a(x23), .b(x17), .O(new_n84_));
  nor3   g43(.a(new_n84_), .b(new_n43_), .c(x24), .O(z13));
  inv1   g44(.a(x16), .O(new_n86_));
  oai21  g45(.a(x24), .b(new_n86_), .c(new_n44_), .O(z14));
