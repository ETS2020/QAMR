...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x11), .O(new_n43_));
  ...
  nand3  g20(.a(new_n61_), .b(z06), .c(new_n55_), .O(new_n62_));
  ...
  nor2   g27(.a(new_n56_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n70_));
  ...
  nand2  g35(.a(new_n73_), .b(x14), .O(new_n77_));
