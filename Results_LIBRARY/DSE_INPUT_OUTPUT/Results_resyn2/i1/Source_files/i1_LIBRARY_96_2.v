...
module FAU ( 
  ...
  nor2   g02(.a(x24), .b(new_n43_), .O(z11));
  nor2   g03(.a(z11), .b(new_n42_), .O(z00));
  ...
  nor2   g22(.a(z11), .b(new_n63_), .O(z03));
  ...
  nor2   g27(.a(z11), .b(x10), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(new_n51_), .c(new_n69_), .O(z05));
  inv1   g29(.a(x19), .O(new_n71_));
  nor2   g30(.a(z11), .b(new_n71_), .O(z06));
  nand2  g31(.a(x24), .b(x18), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n46_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(z11), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n75_), .O(z09));
  nand4  g37(.a(new_n77_), .b(x23), .c(new_n43_), .d(x14), .O(new_n80_));
  inv1   g38(.a(new_n80_), .O(z12));
  nand4  g39(.a(new_n77_), .b(x23), .c(new_n43_), .d(x17), .O(new_n82_));
  inv1   g40(.a(new_n82_), .O(z13));
  inv1   g41(.a(x16), .O(new_n84_));
  aoi21  g42(.a(new_n43_), .b(new_n84_), .c(x24), .O(z14));
  nor2   g43(.a(x13), .b(x12), .O(new_n86_));
  nor2   g44(.a(x15), .b(x14), .O(new_n87_));
  aoi21  g45(.a(new_n87_), .b(new_n86_), .c(z11), .O(z15));
  zero   g46(.O(z10));
endmodule
