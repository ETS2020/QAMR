...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n72_, new_n74_, new_n75_, new_n77_, new_n78_,
  ...
  oai21  g11(.a(new_n52_), .b(x08), .c(new_n51_), .O(new_n53_));
  oai21  g12(.a(new_n51_), .b(x08), .c(new_n53_), .O(new_n54_));
  aoi21  g13(.a(x19), .b(new_n42_), .c(new_n44_), .O(new_n55_));
  oai21  g14(.a(new_n54_), .b(new_n50_), .c(new_n55_), .O(z01));
  nor3   g15(.a(x07), .b(x06), .c(x05), .O(new_n57_));
  nand2  g16(.a(new_n51_), .b(x08), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(new_n49_), .c(new_n48_), .d(new_n57_), .O(new_n59_));
  nand2  g18(.a(new_n50_), .b(new_n42_), .O(new_n60_));
  ...
  oai21  g27(.a(new_n67_), .b(new_n50_), .c(new_n68_), .O(z05));
  ...
  oai21  g34(.a(new_n74_), .b(new_n72_), .c(new_n75_), .O(z09));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n74_), .b(x22), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n75_), .O(z11));
  nand3  g40(.a(new_n74_), .b(x23), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n75_), .O(z12));
  nand2  g42(.a(x23), .b(x17), .O(new_n84_));
  nor3   g43(.a(new_n84_), .b(new_n44_), .c(x24), .O(z13));
  nand2  g44(.a(new_n74_), .b(x16), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n75_), .O(z14));
  nor2   g46(.a(x13), .b(x12), .O(new_n88_));
  nor2   g47(.a(x15), .b(x14), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n75_), .O(z15));
  buf    g49(.a(x19), .O(z06));
endmodule
