...
module FAU ( 
  ...
  aoi21  g22(.a(new_n63_), .b(new_n61_), .c(new_n62_), .O(z05));
  ...
  nand4  g29(.a(new_n42_), .b(new_n66_), .c(x22), .d(x14), .O(new_n71_));
  ...
  nand4  g35(.a(new_n42_), .b(new_n66_), .c(x23), .d(x17), .O(new_n77_));
