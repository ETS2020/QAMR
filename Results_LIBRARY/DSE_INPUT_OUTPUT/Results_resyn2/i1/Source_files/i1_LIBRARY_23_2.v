...
module FAU ( 
  ...
  nand2  g03(.a(x23), .b(x19), .O(new_n45_));
  ...
  nand3  g17(.a(new_n58_), .b(new_n54_), .c(x23), .O(new_n59_));
  ...
  oai21  g25(.a(new_n50_), .b(x08), .c(x23), .O(new_n67_));
  ...
  nor3   g34(.a(new_n62_), .b(new_n75_), .c(new_n73_), .O(z09));
  ...
  nor3   g42(.a(x24), .b(new_n42_), .c(new_n80_), .O(z13));
  nand2  g43(.a(new_n75_), .b(x16), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n62_), .O(z14));
