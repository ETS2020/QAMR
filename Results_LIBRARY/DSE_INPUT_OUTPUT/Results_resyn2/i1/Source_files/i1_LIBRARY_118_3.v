...
module FAU ( 
  ...
  nor2   g04(.a(x08), .b(new_n42_), .O(new_n46_));
  ...
  aoi21  g10(.a(new_n51_), .b(new_n46_), .c(new_n45_), .O(z01));
  nand2  g11(.a(new_n50_), .b(new_n49_), .O(new_n53_));
  inv1   g12(.a(new_n53_), .O(new_n54_));
  nand2  g13(.a(new_n46_), .b(x19), .O(new_n55_));
  ...
  nand4  g24(.a(new_n50_), .b(new_n49_), .c(new_n65_), .d(new_n64_), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x19), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n62_), .O(z05));
  nor2   g28(.a(new_n58_), .b(x24), .O(new_n70_));
  nor2   g29(.a(new_n58_), .b(x18), .O(new_n71_));
  ...
  nand3  g34(.a(new_n70_), .b(x22), .c(x14), .O(new_n76_));
