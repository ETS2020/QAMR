...
module FAU ( 
  ...
  nor2   g01(.a(x22), .b(x17), .O(new_n43_));
  ...
  nor2   g27(.a(new_n46_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n68_), .c(new_n43_), .O(z05));
  ...
  nor2   g38(.a(new_n79_), .b(x24), .O(z10));
  nand3  g39(.a(new_n77_), .b(x22), .c(x17), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z11));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n77_), .b(x23), .O(new_n84_));
  nor3   g43(.a(new_n84_), .b(new_n43_), .c(new_n83_), .O(z12));
