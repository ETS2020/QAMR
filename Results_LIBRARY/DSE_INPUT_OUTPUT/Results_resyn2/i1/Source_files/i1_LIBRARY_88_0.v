...
module FAU ( 
  ...
  nor3   g36(.a(new_n77_), .b(new_n43_), .c(new_n75_), .O(z10));
  inv1   g37(.a(x17), .O(new_n79_));
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n44_), .O(z11));
  nand2  g39(.a(new_n76_), .b(x23), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n75_), .c(new_n44_), .O(z12));
  oai21  g41(.a(new_n81_), .b(new_n79_), .c(new_n44_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  oai21  g43(.a(x24), .b(new_n84_), .c(new_n44_), .O(z14));
  inv1   g44(.a(x15), .O(new_n86_));
  nor3   g45(.a(x14), .b(x13), .c(x12), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n46_), .c(new_n86_), .O(z15));
  buf    g47(.a(x19), .O(z06));
endmodule
