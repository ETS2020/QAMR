...
module FAU ( 
  ...
  nor2   g09(.a(new_n50_), .b(x14), .O(z06));
  ...
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n43_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n43_), .b(new_n76_), .O(z08));
  oai21  g36(.a(new_n74_), .b(new_n76_), .c(new_n43_), .O(z09));
  nand4  g37(.a(new_n74_), .b(x22), .c(new_n50_), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand4  g39(.a(new_n43_), .b(new_n74_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand4  g41(.a(new_n74_), .b(x23), .c(new_n50_), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand4  g43(.a(new_n43_), .b(new_n74_), .c(x23), .d(x17), .O(new_n85_));
