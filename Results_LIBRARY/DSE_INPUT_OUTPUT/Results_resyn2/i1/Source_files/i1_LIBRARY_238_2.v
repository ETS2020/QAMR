...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n71_, new_n73_, new_n76_, new_n77_, new_n79_,
  ...
  aoi21  g30(.a(new_n71_), .b(x19), .c(new_n43_), .O(z07));
  ...
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n63_), .O(z11));
  nand2  g39(.a(new_n71_), .b(x23), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n76_), .c(new_n63_), .O(z12));
  oai21  g41(.a(new_n81_), .b(new_n79_), .c(new_n63_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  nor3   g43(.a(new_n44_), .b(x24), .c(new_n84_), .O(z14));
