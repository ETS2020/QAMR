...
module FAU ( 
  ...
  aoi21  g38(.a(new_n78_), .b(x19), .c(new_n43_), .O(z11));
  nand2  g39(.a(new_n72_), .b(x23), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n44_), .c(new_n77_), .O(z12));
  aoi21  g41(.a(new_n81_), .b(x19), .c(new_n43_), .O(z13));
