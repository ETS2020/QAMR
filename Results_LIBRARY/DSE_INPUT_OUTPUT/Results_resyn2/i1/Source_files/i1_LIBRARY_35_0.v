...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n78_, new_n81_, new_n83_, new_n84_, new_n86_, new_n88_, new_n90_,
    new_n92_, new_n93_;
  ...
  nor3   g38(.a(new_n43_), .b(new_n76_), .c(new_n78_), .O(z09));
  nand2  g39(.a(x22), .b(x14), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n43_), .c(x24), .O(z10));
  inv1   g41(.a(x22), .O(new_n83_));
  nand2  g42(.a(new_n76_), .b(x17), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n68_), .O(z11));
  nand3  g44(.a(new_n76_), .b(x23), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n68_), .O(z12));
  inv1   g46(.a(x23), .O(new_n88_));
  nor3   g47(.a(new_n84_), .b(new_n43_), .c(new_n88_), .O(z13));
  ...
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n68_), .O(z15));
endmodule
