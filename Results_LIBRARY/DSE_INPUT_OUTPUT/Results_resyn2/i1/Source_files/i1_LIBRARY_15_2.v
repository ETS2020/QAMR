...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n67_, new_n70_, new_n71_, new_n72_, new_n75_, new_n76_,
  ...
  oai21  g13(.a(new_n54_), .b(x07), .c(x09), .O(new_n55_));
  nand3  g14(.a(new_n55_), .b(new_n53_), .c(new_n51_), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(z00), .c(new_n46_), .O(z01));
  inv1   g16(.a(x19), .O(new_n58_));
  oai21  g17(.a(new_n58_), .b(new_n42_), .c(x08), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(x07), .O(new_n60_));
  nor2   g19(.a(new_n54_), .b(x07), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n52_), .c(new_n50_), .O(new_n62_));
  nand2  g21(.a(new_n50_), .b(new_n42_), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(x19), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n62_), .c(new_n60_), .O(z02));
  inv1   g24(.a(x20), .O(new_n66_));
  nand2  g25(.a(new_n54_), .b(x07), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n66_), .O(z03));
  or2    g27(.a(z03), .b(x21), .O(z04));
  inv1   g28(.a(x10), .O(new_n70_));
  oai21  g29(.a(new_n50_), .b(new_n58_), .c(new_n43_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n54_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n70_), .O(z05));
  inv1   g32(.a(new_n46_), .O(z06));
  inv1   g33(.a(x18), .O(new_n75_));
  inv1   g34(.a(x24), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n67_), .O(z07));
  ...
  nand3  g47(.a(new_n76_), .b(x23), .c(x17), .O(new_n89_));
