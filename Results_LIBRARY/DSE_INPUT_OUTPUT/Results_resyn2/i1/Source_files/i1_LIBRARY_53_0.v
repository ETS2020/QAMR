...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n83_, new_n85_, new_n87_, new_n88_;
  ...
  nand3  g17(.a(new_n58_), .b(new_n51_), .c(x19), .O(new_n59_));
  ...
  nand2  g30(.a(new_n54_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x24), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n71_), .c(new_n54_), .O(z09));
  inv1   g33(.a(x14), .O(new_n75_));
  nand2  g34(.a(new_n73_), .b(x22), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n54_), .O(z10));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n76_), .b(new_n78_), .c(new_n54_), .O(z11));
  nand3  g38(.a(new_n73_), .b(x23), .c(x14), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n54_), .O(z12));
  nand2  g40(.a(new_n54_), .b(new_n73_), .O(new_n82_));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z13));
  ...
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n54_), .O(z15));
  buf    g48(.a(x19), .O(z06));
endmodule
