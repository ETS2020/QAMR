...
module FAU ( 
  ...
  nand2  g01(.a(x22), .b(x21), .O(new_n43_));
  ...
  nand4  g17(.a(new_n48_), .b(new_n47_), .c(new_n58_), .d(new_n57_), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n42_), .O(new_n60_));
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(new_n53_), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(z02));
  inv1   g21(.a(x20), .O(new_n63_));
  nor2   g22(.a(new_n44_), .b(new_n63_), .O(z03));
  inv1   g23(.a(x21), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n63_), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  inv1   g26(.a(x19), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(new_n44_), .O(z05));
  nand2  g30(.a(new_n43_), .b(new_n68_), .O(z06));
  ...
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n43_), .O(z09));
  inv1   g37(.a(x22), .O(new_n79_));
  nand2  g38(.a(new_n77_), .b(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n65_), .c(new_n79_), .O(z10));
  nand2  g40(.a(new_n77_), .b(x17), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n65_), .c(new_n79_), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n80_), .b(new_n84_), .c(new_n43_), .O(z12));
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n43_), .O(z13));
