// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:20 2020
...
module FAU ( 
  ...
  nand4  g14(.a(new_n55_), .b(new_n54_), .c(new_n49_), .d(new_n48_), .O(new_n56_));
  ...
  oai21  g26(.a(new_n66_), .b(new_n59_), .c(new_n67_), .O(z05));
  nand2  g27(.a(new_n47_), .b(new_n43_), .O(z06));
  ...
  oai21  g33(.a(new_n74_), .b(new_n72_), .c(new_n45_), .O(z09));
  ...
  nand4  g39(.a(new_n45_), .b(new_n74_), .c(x23), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  nand4  g41(.a(new_n45_), .b(new_n74_), .c(x23), .d(x17), .O(new_n83_));
