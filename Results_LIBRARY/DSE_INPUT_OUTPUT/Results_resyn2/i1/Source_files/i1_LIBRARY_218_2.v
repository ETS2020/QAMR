...
module FAU ( 
  ...
  aoi21  g32(.a(new_n73_), .b(x19), .c(new_n43_), .O(z09));
  inv1   g33(.a(x14), .O(new_n75_));
  nand2  g34(.a(new_n73_), .b(x22), .O(new_n76_));
  nor3   g35(.a(new_n76_), .b(new_n44_), .c(new_n75_), .O(z10));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n76_), .b(new_n78_), .c(new_n63_), .O(z11));
  nand2  g38(.a(new_n73_), .b(x23), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n75_), .c(new_n63_), .O(z12));
  oai21  g40(.a(new_n80_), .b(new_n78_), .c(new_n63_), .O(z13));
  nand2  g41(.a(new_n73_), .b(x16), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n63_), .O(z14));
