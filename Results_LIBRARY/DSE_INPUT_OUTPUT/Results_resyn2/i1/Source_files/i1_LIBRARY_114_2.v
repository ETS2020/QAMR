...
module FAU ( 
  ...
  nand2  g21(.a(new_n46_), .b(x12), .O(new_n63_));
  ...
  nor3   g35(.a(new_n76_), .b(new_n44_), .c(x24), .O(z10));
  inv1   g36(.a(x22), .O(new_n78_));
  nand2  g37(.a(new_n71_), .b(x17), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(z11));
  nand3  g39(.a(new_n71_), .b(x23), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n63_), .O(z12));
  nand2  g41(.a(new_n63_), .b(x23), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n79_), .O(z13));
  nand2  g43(.a(new_n71_), .b(x16), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n63_), .O(z14));
