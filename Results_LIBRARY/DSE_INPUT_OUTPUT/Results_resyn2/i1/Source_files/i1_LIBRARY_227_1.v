...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n82_, new_n84_, new_n86_, new_n89_, new_n90_;
  ...
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(x16), .O(new_n61_));
  ...
  oai21  g27(.a(new_n50_), .b(x08), .c(x16), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x19), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n68_), .O(z05));
  nor2   g30(.a(new_n43_), .b(new_n53_), .O(z06));
  ...
  nor2   g46(.a(x24), .b(new_n53_), .O(z14));
