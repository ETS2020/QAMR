...
module FAU ( 
  ...
  nand2  g29(.a(new_n43_), .b(new_n47_), .O(z06));
  ...
  nand3  g34(.a(x24), .b(x19), .c(x11), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n43_), .b(x22), .O(new_n79_));
  ...
  nand3  g41(.a(new_n43_), .b(x23), .c(x14), .O(new_n83_));
