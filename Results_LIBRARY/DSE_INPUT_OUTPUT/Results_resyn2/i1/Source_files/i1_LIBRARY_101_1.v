...
module FAU ( 
  ...
  nand4  g37(.a(new_n77_), .b(x22), .c(x19), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand4  g39(.a(new_n77_), .b(x22), .c(x19), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n77_), .b(x23), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n46_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n46_), .O(z13));
  nand2  g46(.a(new_n77_), .b(x16), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(new_n44_), .O(z14));
