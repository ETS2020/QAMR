...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n83_, new_n85_, new_n87_, new_n88_;
  ...
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n53_), .O(z10));
  nand3  g38(.a(new_n75_), .b(x22), .c(x17), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n53_), .O(z11));
  aoi21  g40(.a(new_n78_), .b(x19), .c(new_n43_), .O(z12));
