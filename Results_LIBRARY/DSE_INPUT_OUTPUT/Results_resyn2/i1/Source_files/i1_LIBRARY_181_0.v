...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n83_, new_n86_, new_n87_;
  ...
  nor3   g32(.a(new_n43_), .b(new_n73_), .c(new_n71_), .O(z09));
  ...
  oai22  g39(.a(new_n80_), .b(x24), .c(x19), .d(x08), .O(z12));
  inv1   g40(.a(new_n75_), .O(new_n82_));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z13));
  and2   g43(.a(new_n75_), .b(x16), .O(z14));
