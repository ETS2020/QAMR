...
module FAU ( 
  ...
  aoi21  g23(.a(new_n64_), .b(new_n62_), .c(new_n43_), .O(z04));
  inv1   g24(.a(x10), .O(new_n66_));
  inv1   g25(.a(x08), .O(new_n67_));
  nand4  g26(.a(new_n49_), .b(new_n48_), .c(new_n56_), .d(new_n67_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n43_), .O(z05));
  inv1   g28(.a(x19), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x08), .O(z06));
  inv1   g30(.a(x18), .O(new_n72_));
  nand2  g31(.a(new_n44_), .b(x24), .O(new_n73_));
  ...
  nand2  g44(.a(new_n78_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n44_), .O(z12));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n44_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  oai21  g49(.a(x24), .b(new_n90_), .c(new_n44_), .O(z14));
