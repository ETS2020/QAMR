...
module FAU ( 
  ...
  nor2   g31(.a(x05), .b(x04), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n48_), .c(new_n47_), .d(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n53_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n71_), .O(z05));
  nand2  g36(.a(new_n46_), .b(x01), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(x24), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n44_), .b(new_n82_), .O(z08));
  nor3   g42(.a(new_n43_), .b(new_n80_), .c(new_n82_), .O(z09));
  ...
  nor3   g51(.a(new_n92_), .b(new_n43_), .c(x24), .O(z13));
