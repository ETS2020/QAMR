...
module FAU ( 
  ...
  and2   g25(.a(new_n50_), .b(x19), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(x08), .c(new_n66_), .O(z05));
  inv1   g27(.a(x19), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x08), .O(z06));
  ...
  oai21  g45(.a(new_n82_), .b(new_n86_), .c(new_n44_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor3   g47(.a(new_n43_), .b(x24), .c(new_n88_), .O(z14));
