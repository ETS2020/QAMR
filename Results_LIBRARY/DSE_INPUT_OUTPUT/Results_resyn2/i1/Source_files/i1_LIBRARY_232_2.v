...
module FAU ( 
  ...
  nor2   g27(.a(new_n63_), .b(x10), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(new_n57_), .c(new_n69_), .O(z05));
  ...
  nand2  g37(.a(new_n44_), .b(new_n72_), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(z10));
  nand2  g39(.a(new_n72_), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n78_), .c(new_n44_), .O(z11));
  ...
  nor2   g46(.a(new_n79_), .b(new_n87_), .O(z14));
  inv1   g47(.a(x13), .O(new_n89_));
  inv1   g48(.a(x15), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(new_n77_), .c(new_n89_), .d(new_n62_), .O(z15));
  buf    g50(.a(x19), .O(z06));
endmodule
