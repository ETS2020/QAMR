...
module FAU ( 
  ...
  aoi21  g19(.a(new_n60_), .b(new_n57_), .c(new_n53_), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  nand2  g21(.a(x19), .b(x18), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n62_), .O(z03));
  or2    g23(.a(z03), .b(x21), .O(z04));
  nand2  g24(.a(new_n63_), .b(x10), .O(new_n66_));
  nand3  g25(.a(x19), .b(new_n52_), .c(new_n58_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n56_), .c(new_n66_), .O(z05));
  nand3  g27(.a(x24), .b(new_n44_), .c(x18), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nand2  g30(.a(new_n63_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x24), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n71_), .c(new_n63_), .O(z09));
  inv1   g33(.a(x14), .O(new_n75_));
  nand2  g34(.a(new_n73_), .b(x22), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n63_), .O(z10));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n76_), .b(new_n78_), .c(new_n63_), .O(z11));
  nand4  g38(.a(new_n63_), .b(new_n73_), .c(x23), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z12));
  nand4  g40(.a(new_n63_), .b(new_n73_), .c(x23), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  nand3  g42(.a(new_n63_), .b(new_n73_), .c(x16), .O(new_n84_));
