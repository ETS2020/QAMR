...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n83_, new_n85_, new_n87_, new_n89_, new_n90_;
  ...
  oai21  g28(.a(new_n68_), .b(new_n51_), .c(new_n69_), .O(z05));
  ...
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n45_), .O(z09));
  nand2  g37(.a(new_n77_), .b(x22), .O(new_n79_));
  nand2  g38(.a(new_n45_), .b(x14), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n79_), .O(z10));
  aoi21  g40(.a(new_n79_), .b(x19), .c(new_n43_), .O(z11));
  nand2  g41(.a(new_n77_), .b(x23), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n80_), .O(z12));
  nand4  g43(.a(new_n77_), .b(x23), .c(x19), .d(x17), .O(new_n85_));
