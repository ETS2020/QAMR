...
module FAU ( 
  ...
  aoi21  g06(.a(x06), .b(new_n42_), .c(new_n43_), .O(z02));
  ...
  nand2  g22(.a(new_n61_), .b(x14), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(new_n52_), .O(z10));
  nand3  g24(.a(new_n61_), .b(x22), .c(x17), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n44_), .O(z11));
  oai21  g26(.a(new_n43_), .b(x06), .c(x23), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n64_), .O(z12));
  nand3  g28(.a(new_n61_), .b(x23), .c(x17), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n52_), .O(z13));
  nand2  g30(.a(new_n61_), .b(x16), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n52_), .O(z14));
