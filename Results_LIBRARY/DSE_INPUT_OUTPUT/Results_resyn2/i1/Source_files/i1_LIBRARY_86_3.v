...
module FAU ( 
  ...
  nor2   g23(.a(new_n44_), .b(x07), .O(z06));
  ...
  nand2  g30(.a(new_n71_), .b(new_n70_), .O(z04));
  ...
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n70_), .O(z07));
  ...
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n70_), .O(z12));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n70_), .O(z13));
  ...
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n70_), .O(z15));
endmodule
