// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:10 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n78_, new_n80_, new_n83_, new_n85_, new_n86_,
  ...
  nand2  g05(.a(x19), .b(new_n46_), .O(new_n47_));
  ...
  nand4  g20(.a(new_n61_), .b(new_n59_), .c(new_n58_), .d(new_n48_), .O(new_n62_));
  nand3  g21(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n42_), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(new_n62_), .c(x19), .d(new_n46_), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z02));
  inv1   g25(.a(x20), .O(new_n67_));
  nor2   g26(.a(new_n44_), .b(new_n67_), .O(z03));
  inv1   g27(.a(x21), .O(new_n69_));
  nand3  g28(.a(new_n43_), .b(new_n69_), .c(new_n67_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  inv1   g30(.a(x08), .O(new_n72_));
  nand3  g31(.a(x19), .b(new_n72_), .c(new_n46_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n54_), .c(new_n48_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n71_), .c(new_n44_), .O(z05));
  ...
  oai21  g40(.a(new_n78_), .b(new_n80_), .c(new_n43_), .O(z09));
  nand4  g41(.a(new_n43_), .b(new_n78_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  inv1   g43(.a(x22), .O(new_n85_));
  nand2  g44(.a(new_n78_), .b(x17), .O(new_n86_));
