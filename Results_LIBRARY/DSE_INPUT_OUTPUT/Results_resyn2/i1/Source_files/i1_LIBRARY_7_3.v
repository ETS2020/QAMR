...
module FAU ( 
  ...
  nor2   g08(.a(new_n49_), .b(x11), .O(z06));
  ...
  nor2   g31(.a(new_n72_), .b(new_n66_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nor2   g33(.a(x19), .b(new_n74_), .O(z08));
  inv1   g34(.a(x24), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n49_), .c(new_n74_), .O(z09));
  nand4  g36(.a(new_n42_), .b(new_n76_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand4  g38(.a(new_n42_), .b(new_n76_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  nand4  g40(.a(new_n42_), .b(new_n76_), .c(x23), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand4  g42(.a(new_n42_), .b(new_n76_), .c(x23), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z13));
  nand3  g44(.a(new_n42_), .b(new_n76_), .c(x16), .O(new_n86_));
