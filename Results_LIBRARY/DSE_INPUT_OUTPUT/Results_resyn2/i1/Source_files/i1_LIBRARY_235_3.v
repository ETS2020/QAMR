...
module FAU ( 
  ...
  nand2  g05(.a(x19), .b(new_n43_), .O(new_n47_));
  ...
  nand4  g17(.a(new_n58_), .b(new_n48_), .c(new_n50_), .d(new_n49_), .O(new_n59_));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n54_), .c(x07), .O(new_n66_));
  ...
  nand2  g31(.a(new_n69_), .b(x10), .O(new_n73_));
  or2    g32(.a(new_n47_), .b(x08), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n59_), .c(new_n73_), .O(z05));
  nand2  g34(.a(x24), .b(x18), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n45_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n45_), .b(new_n78_), .O(z08));
  inv1   g38(.a(x24), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n69_), .O(z09));
  nand4  g40(.a(new_n69_), .b(new_n80_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n80_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n69_), .O(z11));
  nand3  g44(.a(new_n80_), .b(x23), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n69_), .O(z12));
  nand4  g46(.a(new_n69_), .b(new_n80_), .c(x23), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z13));
  nand2  g48(.a(new_n80_), .b(x16), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n69_), .O(z14));
  nor2   g50(.a(x13), .b(x12), .O(new_n92_));
  nor2   g51(.a(x15), .b(x14), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n69_), .O(z15));
  buf    g53(.a(x19), .O(z06));
endmodule
