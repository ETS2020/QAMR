...
module FAU ( 
  ...
  oai21  g12(.a(new_n53_), .b(new_n52_), .c(x00), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(x19), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n45_), .O(z01));
  nand2  g15(.a(new_n52_), .b(new_n42_), .O(new_n57_));
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(x19), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n45_), .O(z02));
  ...
  nor2   g27(.a(new_n46_), .b(x10), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(new_n52_), .c(new_n69_), .O(z05));
  inv1   g29(.a(x24), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n43_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n46_), .b(new_n73_), .O(z08));
  nor3   g33(.a(new_n46_), .b(new_n71_), .c(new_n73_), .O(z09));
  inv1   g34(.a(x22), .O(new_n76_));
  nand2  g35(.a(new_n45_), .b(new_n71_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  ...
  nor2   g42(.a(new_n83_), .b(new_n77_), .O(z12));
  nand3  g43(.a(new_n71_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n45_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  nor2   g46(.a(new_n77_), .b(new_n87_), .O(z14));
