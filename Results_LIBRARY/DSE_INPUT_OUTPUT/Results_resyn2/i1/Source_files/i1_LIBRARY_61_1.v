...
module FAU ( 
  ...
  nand2  g38(.a(new_n43_), .b(x22), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n45_), .O(z10));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n45_), .O(z11));
  nand2  g42(.a(new_n43_), .b(x23), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n79_), .c(new_n45_), .O(z12));
  oai21  g44(.a(new_n84_), .b(new_n82_), .c(new_n45_), .O(z13));
