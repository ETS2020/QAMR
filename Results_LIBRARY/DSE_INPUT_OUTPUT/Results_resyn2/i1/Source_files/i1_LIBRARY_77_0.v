...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n84_, new_n86_, new_n87_, new_n88_;
  ...
  nor2   g43(.a(new_n84_), .b(new_n43_), .O(z14));
  inv1   g44(.a(x13), .O(new_n86_));
  inv1   g45(.a(x19), .O(new_n87_));
  nor3   g46(.a(x15), .b(x14), .c(x12), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(z15));
  buf    g48(.a(x19), .O(z06));
endmodule
