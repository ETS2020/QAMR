...
module FAU ( 
  ...
  nand4  g38(.a(new_n45_), .b(new_n72_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  inv1   g40(.a(x23), .O(new_n82_));
  oai21  g41(.a(new_n78_), .b(new_n82_), .c(new_n45_), .O(z12));
  nand4  g42(.a(new_n45_), .b(new_n72_), .c(x23), .d(x17), .O(new_n84_));
