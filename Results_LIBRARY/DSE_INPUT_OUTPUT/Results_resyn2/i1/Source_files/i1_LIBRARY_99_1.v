...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n71_, new_n74_, new_n75_, new_n76_, new_n78_, new_n80_,
    new_n83_, new_n85_, new_n86_;
  inv1   g00(.a(x00), .O(new_n42_));
  inv1   g01(.a(x15), .O(new_n43_));
  nand2  g02(.a(x19), .b(new_n43_), .O(new_n44_));
  nand2  g03(.a(new_n44_), .b(new_n42_), .O(z00));
  nand2  g04(.a(x19), .b(x15), .O(new_n46_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x15), .O(new_n60_));
  ...
  nand3  g24(.a(x19), .b(x15), .c(new_n57_), .O(new_n66_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n74_), .c(new_n44_), .O(z10));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n76_), .b(new_n78_), .c(new_n44_), .O(z11));
  nand2  g38(.a(new_n75_), .b(x23), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n74_), .c(new_n44_), .O(z12));
  oai21  g40(.a(new_n80_), .b(new_n78_), .c(new_n44_), .O(z13));
  nand2  g41(.a(new_n75_), .b(x16), .O(new_n83_));
  aoi21  g42(.a(x19), .b(new_n43_), .c(new_n83_), .O(z14));
  inv1   g43(.a(x19), .O(new_n85_));
  nor2   g44(.a(x13), .b(x12), .O(new_n86_));
  nand4  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .d(new_n74_), .O(z15));
  buf    g46(.a(x19), .O(z06));
endmodule
