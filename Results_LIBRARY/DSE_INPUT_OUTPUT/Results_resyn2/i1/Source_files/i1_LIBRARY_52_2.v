...
module FAU ( 
  ...
  nor3   g35(.a(new_n76_), .b(new_n75_), .c(new_n73_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n75_), .b(x22), .O(new_n79_));
  ...
  nand2  g41(.a(new_n75_), .b(x23), .O(new_n83_));
  nor3   g42(.a(new_n83_), .b(new_n76_), .c(new_n78_), .O(z12));
  ...
  nand4  g48(.a(new_n89_), .b(new_n78_), .c(new_n69_), .d(new_n88_), .O(z15));
endmodule
