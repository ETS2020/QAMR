...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n62_, new_n64_, new_n65_, new_n68_, new_n71_,
  ...
  nand4  g32(.a(new_n43_), .b(new_n73_), .c(x22), .d(x14), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z10));
  inv1   g34(.a(x22), .O(new_n76_));
  nand2  g35(.a(new_n73_), .b(x17), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n43_), .O(z11));
  nand2  g37(.a(x23), .b(x14), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(x24), .c(new_n43_), .O(z12));
  inv1   g39(.a(x23), .O(new_n81_));
  oai21  g40(.a(new_n77_), .b(new_n81_), .c(new_n43_), .O(z13));
  nand3  g41(.a(new_n43_), .b(new_n73_), .c(x16), .O(new_n83_));
