...
module FAU ( 
  ...
  nand2  g24(.a(new_n65_), .b(new_n53_), .O(z04));
  ...
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n53_), .O(z11));
  nand3  g41(.a(new_n76_), .b(x23), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n53_), .O(z12));
