...
module FAU ( 
  ...
  nand2  g04(.a(x19), .b(x17), .O(new_n46_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x17), .O(new_n60_));
  and2   g19(.a(new_n60_), .b(x19), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  nand2  g21(.a(new_n44_), .b(new_n62_), .O(z03));
  inv1   g22(.a(x21), .O(new_n64_));
  aoi22  g23(.a(new_n64_), .b(new_n62_), .c(x19), .d(new_n43_), .O(z04));
  inv1   g24(.a(x10), .O(new_n66_));
  oai21  g25(.a(new_n51_), .b(x08), .c(x17), .O(new_n67_));
