...
module FAU ( 
  ...
  nand2  g25(.a(new_n66_), .b(new_n60_), .O(z07));
  inv1   g26(.a(x11), .O(new_n68_));
  nand2  g27(.a(new_n60_), .b(new_n68_), .O(z08));
  ...
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n60_), .O(z10));
  inv1   g33(.a(x17), .O(new_n75_));
  oai21  g34(.a(new_n73_), .b(new_n75_), .c(new_n60_), .O(z11));
  nand2  g35(.a(new_n70_), .b(x23), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n72_), .c(new_n60_), .O(z12));
  oai21  g37(.a(new_n77_), .b(new_n75_), .c(new_n60_), .O(z13));
  nand2  g38(.a(new_n70_), .b(x16), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n60_), .O(z14));
  nor2   g40(.a(x13), .b(x12), .O(new_n82_));
  nor2   g41(.a(x15), .b(x14), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n82_), .c(new_n60_), .O(z15));
  buf    g43(.a(x19), .O(z06));
endmodule
