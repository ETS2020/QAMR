...
module FAU ( 
  ...
  aoi21  g37(.a(new_n78_), .b(new_n46_), .c(new_n57_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n43_), .O(z11));
  nand4  g40(.a(new_n76_), .b(x23), .c(new_n46_), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand4  g42(.a(new_n43_), .b(new_n76_), .c(x23), .d(x17), .O(new_n84_));
