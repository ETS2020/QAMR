...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n72_, new_n75_, new_n77_, new_n79_, new_n81_, new_n83_,
    new_n85_, new_n86_;
  ...
  aoi22  g12(.a(new_n53_), .b(z00), .c(new_n48_), .d(new_n46_), .O(z01));
  ...
  nand4  g19(.a(new_n60_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n61_));
  nand3  g20(.a(new_n61_), .b(new_n58_), .c(x19), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n48_), .O(z02));
  inv1   g22(.a(x20), .O(new_n64_));
  nand2  g23(.a(new_n48_), .b(new_n64_), .O(z03));
  or2    g24(.a(z03), .b(x21), .O(z04));
  inv1   g25(.a(x08), .O(new_n67_));
  nand2  g26(.a(x19), .b(new_n67_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n57_), .c(new_n43_), .O(z05));
  nand2  g28(.a(new_n48_), .b(new_n46_), .O(z06));
  and2   g29(.a(x24), .b(x18), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nor2   g31(.a(new_n44_), .b(new_n72_), .O(z08));
  oai21  g32(.a(new_n47_), .b(new_n72_), .c(new_n48_), .O(z09));
  nand4  g33(.a(new_n47_), .b(x22), .c(x14), .d(new_n43_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand2  g35(.a(x22), .b(x17), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n43_), .c(x24), .O(z11));
  nand4  g37(.a(new_n47_), .b(x23), .c(x14), .d(new_n43_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z12));
  nand4  g39(.a(new_n47_), .b(x23), .c(x17), .d(new_n43_), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  nand3  g41(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z14));
  nor2   g43(.a(x13), .b(x12), .O(new_n85_));
  nor2   g44(.a(x15), .b(x14), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(new_n85_), .c(new_n48_), .O(z15));
endmodule
