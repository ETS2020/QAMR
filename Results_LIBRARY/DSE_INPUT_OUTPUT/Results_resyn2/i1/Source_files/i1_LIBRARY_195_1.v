...
module FAU ( 
  ...
  nand2  g05(.a(x19), .b(x15), .O(new_n47_));
  ...
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(x15), .O(new_n61_));
  ...
  nand3  g26(.a(x19), .b(x15), .c(new_n58_), .O(new_n68_));
  ...
  nand2  g36(.a(new_n45_), .b(new_n74_), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(z10));
  nand2  g38(.a(new_n74_), .b(x17), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n77_), .c(new_n45_), .O(z11));
  nand3  g40(.a(new_n74_), .b(x23), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n45_), .O(z12));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n80_), .b(new_n84_), .c(new_n45_), .O(z13));
  inv1   g44(.a(x16), .O(new_n86_));
  nor2   g45(.a(new_n78_), .b(new_n86_), .O(z14));
