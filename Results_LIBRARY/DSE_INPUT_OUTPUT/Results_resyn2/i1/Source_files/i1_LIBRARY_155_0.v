...
module FAU ( 
  ...
  oai22  g28(.a(new_n69_), .b(new_n59_), .c(new_n43_), .d(new_n67_), .O(z05));
  inv1   g29(.a(x19), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x06), .O(z06));
