...
module FAU ( 
  ...
  oai21  g27(.a(new_n68_), .b(new_n50_), .c(new_n55_), .O(z05));
  nand2  g28(.a(x24), .b(x18), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n65_), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nor2   g31(.a(new_n65_), .b(new_n72_), .O(z08));
  ...
  nand3  g39(.a(new_n43_), .b(new_n74_), .c(x23), .O(new_n81_));
