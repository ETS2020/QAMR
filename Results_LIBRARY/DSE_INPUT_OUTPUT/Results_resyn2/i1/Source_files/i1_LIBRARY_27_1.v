...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_, new_n76_,
  ...
  nor2   g06(.a(x07), .b(x05), .O(new_n48_));
  ...
  nor2   g11(.a(new_n52_), .b(new_n46_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n51_), .c(x06), .O(new_n54_));
  oai22  g13(.a(new_n54_), .b(x03), .c(new_n46_), .d(x00), .O(z01));
  inv1   g14(.a(x03), .O(new_n56_));
  nand2  g15(.a(new_n50_), .b(new_n43_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(x00), .O(new_n59_));
  inv1   g18(.a(x09), .O(new_n60_));
  nand3  g19(.a(new_n49_), .b(new_n47_), .c(new_n56_), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(new_n62_));
  inv1   g21(.a(x08), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(x06), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(new_n62_), .c(new_n48_), .d(new_n60_), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n59_), .c(new_n46_), .O(z02));
  ...
  nand4  g31(.a(new_n48_), .b(x19), .c(new_n63_), .d(new_n43_), .O(new_n73_));
  oai22  g32(.a(new_n73_), .b(new_n61_), .c(new_n44_), .d(new_n72_), .O(z05));
  nand2  g33(.a(new_n68_), .b(new_n46_), .O(z06));
  inv1   g34(.a(x18), .O(new_n76_));
  nand2  g35(.a(new_n68_), .b(x24), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n76_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n68_), .b(new_n79_), .O(z08));
  ...
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n68_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n68_), .O(z11));
  nand2  g46(.a(new_n83_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n82_), .c(new_n68_), .O(z12));
  oai21  g48(.a(new_n88_), .b(new_n86_), .c(new_n68_), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  oai21  g50(.a(x24), .b(new_n91_), .c(new_n68_), .O(z14));
  nor2   g51(.a(x13), .b(x12), .O(new_n93_));
  nor2   g52(.a(x15), .b(x14), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(new_n68_), .O(z15));
endmodule
