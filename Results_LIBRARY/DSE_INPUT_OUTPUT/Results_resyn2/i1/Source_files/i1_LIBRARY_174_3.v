...
module FAU ( 
  ...
  aoi21  g01(.a(x24), .b(x19), .c(new_n42_), .O(z00));
  ...
  nor2   g08(.a(x24), .b(new_n42_), .O(new_n50_));
  aoi21  g09(.a(new_n50_), .b(new_n49_), .c(new_n44_), .O(z01));
  inv1   g10(.a(x07), .O(new_n52_));
  nor2   g11(.a(x06), .b(x05), .O(new_n53_));
  nand4  g12(.a(new_n53_), .b(new_n46_), .c(new_n45_), .d(new_n52_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n42_), .O(new_n55_));
  nor2   g14(.a(x24), .b(new_n44_), .O(z06));
  ...
  nand2  g21(.a(x24), .b(x19), .O(new_n63_));
  ...
  nand4  g27(.a(new_n68_), .b(new_n53_), .c(new_n46_), .d(new_n45_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x19), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n66_), .O(z05));
  nand3  g31(.a(x24), .b(new_n44_), .c(x18), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n63_), .b(new_n75_), .O(z08));
  nand3  g35(.a(x24), .b(new_n44_), .c(x11), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z09));
  inv1   g37(.a(x22), .O(new_n79_));
  nand2  g38(.a(new_n67_), .b(x14), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(z10));
  nand2  g40(.a(x22), .b(x17), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(x24), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n80_), .b(new_n84_), .c(new_n63_), .O(z12));
  nand2  g44(.a(x23), .b(x17), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(x24), .c(new_n63_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  oai21  g47(.a(x24), .b(new_n88_), .c(new_n63_), .O(z14));
  nor2   g48(.a(x13), .b(x12), .O(new_n90_));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n63_), .O(z15));
endmodule
