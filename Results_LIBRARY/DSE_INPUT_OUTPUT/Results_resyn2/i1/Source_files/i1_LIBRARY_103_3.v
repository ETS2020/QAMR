...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n61_, new_n64_, new_n66_, new_n69_, new_n71_,
    new_n72_, new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n83_;
  inv1   g00(.a(x00), .O(new_n42_));
  nand2  g01(.a(x19), .b(x10), .O(new_n43_));
  ...
  nand3  g22(.a(x19), .b(new_n45_), .c(new_n57_), .O(new_n64_));
  oai22  g23(.a(new_n64_), .b(new_n55_), .c(x19), .d(new_n45_), .O(z05));
  nand2  g24(.a(x24), .b(x18), .O(new_n66_));
  aoi21  g25(.a(x19), .b(x10), .c(new_n66_), .O(z07));
  and2   g26(.a(new_n43_), .b(x11), .O(z08));
  nand2  g27(.a(z08), .b(x24), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z09));
  inv1   g29(.a(x24), .O(new_n71_));
  nand4  g30(.a(new_n43_), .b(new_n71_), .c(x22), .d(x14), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z10));
  nand4  g32(.a(new_n43_), .b(new_n71_), .c(x22), .d(x17), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z11));
  nand2  g34(.a(x23), .b(x14), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(x24), .c(new_n43_), .O(z12));
  nand4  g36(.a(new_n43_), .b(new_n71_), .c(x23), .d(x17), .O(new_n78_));
