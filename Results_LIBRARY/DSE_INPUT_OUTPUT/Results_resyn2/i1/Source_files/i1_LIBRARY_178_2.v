...
module FAU ( 
  ...
  nor2   g12(.a(new_n43_), .b(new_n42_), .O(new_n54_));
  ...
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(x21), .O(new_n61_));
  ...
  oai21  g24(.a(new_n63_), .b(x19), .c(new_n43_), .O(z04));
  nand2  g25(.a(new_n44_), .b(x10), .O(new_n67_));
  nor2   g26(.a(new_n43_), .b(new_n46_), .O(z06));
