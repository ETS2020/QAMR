...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n71_, new_n72_, new_n73_, new_n76_, new_n79_,
  ...
  nor2   g17(.a(new_n52_), .b(new_n43_), .O(z06));
  ...
  nand3  g21(.a(new_n62_), .b(z06), .c(new_n58_), .O(new_n63_));
  ...
  nand4  g29(.a(new_n70_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n71_));
  ...
  oai21  g36(.a(new_n52_), .b(new_n76_), .c(new_n45_), .O(z09));
  nand2  g37(.a(x22), .b(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n43_), .c(x24), .O(z10));
  nand4  g39(.a(new_n52_), .b(x22), .c(new_n43_), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand2  g41(.a(x23), .b(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n43_), .c(x24), .O(z12));
  nand4  g43(.a(new_n52_), .b(x23), .c(new_n43_), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  aoi21  g46(.a(new_n43_), .b(new_n87_), .c(x24), .O(z14));
