...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n72_, new_n74_, new_n77_, new_n79_, new_n81_,
    new_n83_, new_n85_, new_n87_, new_n88_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x24), .b(x22), .O(new_n43_));
  ...
  nor2   g36(.a(new_n77_), .b(x24), .O(z10));
  inv1   g37(.a(x17), .O(new_n79_));
  aoi21  g38(.a(x22), .b(new_n79_), .c(x24), .O(z11));
  nand2  g39(.a(z10), .b(x23), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x22), .c(x24), .O(z13));
  inv1   g43(.a(x16), .O(new_n85_));
  aoi21  g44(.a(x22), .b(new_n85_), .c(x24), .O(z14));
