...
module FAU ( 
  ...
  nor2   g01(.a(x22), .b(x06), .O(new_n43_));
  ...
  oai21  g11(.a(new_n52_), .b(new_n51_), .c(x22), .O(new_n53_));
  ...
  nand2  g15(.a(new_n56_), .b(x22), .O(new_n57_));
  ...
  nand4  g21(.a(new_n62_), .b(new_n60_), .c(x22), .d(new_n47_), .O(new_n63_));
  ...
  oai21  g28(.a(new_n51_), .b(x08), .c(x22), .O(new_n70_));
