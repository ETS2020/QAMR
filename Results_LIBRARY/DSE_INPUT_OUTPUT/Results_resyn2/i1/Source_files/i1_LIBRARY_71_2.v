...
module FAU ( 
  ...
  oai21  g10(.a(new_n43_), .b(x09), .c(new_n51_), .O(new_n52_));
  oai21  g11(.a(x09), .b(new_n51_), .c(new_n52_), .O(new_n53_));
  nand2  g12(.a(new_n43_), .b(new_n51_), .O(z06));
  oai21  g13(.a(new_n43_), .b(new_n42_), .c(z06), .O(new_n55_));
  ...
  nand3  g19(.a(new_n50_), .b(x19), .c(x00), .O(new_n61_));
  ...
  nand2  g25(.a(x19), .b(new_n51_), .O(new_n67_));
  ...
  aoi22  g47(.a(new_n88_), .b(new_n87_), .c(new_n43_), .d(x08), .O(z15));
endmodule
