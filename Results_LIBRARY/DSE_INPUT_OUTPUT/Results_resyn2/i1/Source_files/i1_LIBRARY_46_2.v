...
module FAU ( 
  ...
  nand2  g36(.a(new_n45_), .b(x14), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n77_), .O(z10));
  aoi21  g38(.a(new_n77_), .b(x19), .c(new_n43_), .O(z11));
  nand2  g39(.a(new_n75_), .b(x23), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n78_), .O(z12));
  nand4  g41(.a(new_n75_), .b(x23), .c(x19), .d(x17), .O(new_n83_));
