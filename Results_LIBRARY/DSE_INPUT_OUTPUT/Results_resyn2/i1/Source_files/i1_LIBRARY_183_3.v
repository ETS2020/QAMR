...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x11), .O(new_n43_));
  ...
  nor2   g15(.a(new_n56_), .b(new_n55_), .O(z06));
  ...
  nand3  g20(.a(new_n61_), .b(z06), .c(new_n54_), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(z02));
  inv1   g22(.a(x20), .O(new_n64_));
  nor2   g23(.a(new_n56_), .b(new_n64_), .O(z03));
  inv1   g24(.a(x21), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n64_), .c(new_n56_), .O(z04));
  inv1   g26(.a(x10), .O(new_n68_));
  nor2   g27(.a(new_n55_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n48_), .c(new_n47_), .d(new_n58_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n68_), .c(new_n56_), .O(z05));
  ...
  nor2   g34(.a(x16), .b(new_n75_), .O(z08));
