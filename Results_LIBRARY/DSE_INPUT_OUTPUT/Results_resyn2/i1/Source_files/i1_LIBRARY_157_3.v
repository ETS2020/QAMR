...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n79_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_, new_n89_,
    new_n91_, new_n92_;
  ...
  nor2   g10(.a(x20), .b(new_n42_), .O(new_n52_));
  aoi21  g11(.a(new_n52_), .b(new_n51_), .c(new_n43_), .O(z01));
  ...
  nor2   g16(.a(x20), .b(new_n43_), .O(z06));
  ...
  nor2   g25(.a(x08), .b(x07), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n68_));
  ...
  nand2  g35(.a(new_n74_), .b(new_n76_), .O(z08));
  nor3   g36(.a(new_n45_), .b(new_n73_), .c(new_n76_), .O(z09));
  nor2   g37(.a(new_n45_), .b(x24), .O(new_n79_));
  ...
  nand2  g43(.a(new_n73_), .b(x23), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n74_), .O(z12));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n74_), .O(z13));
  ...
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n74_), .O(z15));
  buf    g52(.a(x20), .O(z03));
endmodule
