...
module FAU ( 
  ...
  nand2  g36(.a(new_n44_), .b(new_n71_), .O(new_n78_));
  ...
  nand3  g42(.a(new_n71_), .b(x23), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z12));
  nand2  g44(.a(x23), .b(x17), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n78_), .O(z13));
  nand2  g46(.a(new_n71_), .b(x16), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z14));
  nor2   g48(.a(x13), .b(x12), .O(new_n90_));
  nor3   g49(.a(x19), .b(x15), .c(x14), .O(new_n91_));
