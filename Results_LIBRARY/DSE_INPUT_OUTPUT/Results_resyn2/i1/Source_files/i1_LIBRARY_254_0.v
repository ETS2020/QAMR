...
module FAU ( 
  ...
  nand3  g27(.a(x24), .b(x19), .c(new_n68_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n58_), .c(new_n67_), .O(z05));
  ...
  oai21  g34(.a(new_n75_), .b(new_n73_), .c(new_n46_), .O(z09));
  nand4  g35(.a(new_n75_), .b(x22), .c(x14), .d(x10), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand4  g37(.a(new_n75_), .b(x22), .c(x17), .d(x10), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand2  g39(.a(x23), .b(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x10), .c(x24), .O(z12));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x10), .c(x24), .O(z13));
  nand2  g43(.a(x16), .b(x10), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(x24), .O(z14));
