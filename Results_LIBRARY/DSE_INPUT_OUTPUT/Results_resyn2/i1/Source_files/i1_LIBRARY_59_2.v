...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n43_), .c(new_n46_), .O(z05));
  inv1   g28(.a(x18), .O(new_n70_));
  inv1   g29(.a(x24), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n70_), .c(new_n53_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n53_), .b(new_n73_), .O(z08));
  ...
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z11));
  nand3  g39(.a(new_n71_), .b(x23), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n53_), .O(z12));
  inv1   g41(.a(x23), .O(new_n83_));
  nor3   g42(.a(new_n79_), .b(new_n44_), .c(new_n83_), .O(z13));
  ...
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n53_), .O(z15));
  buf    g48(.a(x19), .O(z06));
endmodule
