...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n70_, new_n73_, new_n74_, new_n76_, new_n77_, new_n78_, new_n80_,
  ...
  aoi21  g29(.a(x19), .b(x11), .c(new_n70_), .O(z07));
  nor2   g30(.a(x19), .b(new_n45_), .O(z08));
  inv1   g31(.a(x19), .O(new_n73_));
  inv1   g32(.a(x24), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n45_), .O(z09));
  nand3  g34(.a(new_n43_), .b(new_n74_), .c(x22), .O(new_n76_));
  ...
  nand4  g42(.a(new_n43_), .b(new_n74_), .c(x23), .d(x17), .O(new_n84_));
