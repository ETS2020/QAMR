...
module FAU ( 
  ...
  oai21  g26(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(z07));
  inv1   g27(.a(x11), .O(new_n69_));
  nand2  g28(.a(new_n45_), .b(new_n69_), .O(z08));
  oai21  g29(.a(new_n67_), .b(new_n69_), .c(new_n45_), .O(z09));
  nand2  g30(.a(new_n45_), .b(new_n67_), .O(new_n72_));
  nand2  g31(.a(x22), .b(x14), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z10));
  inv1   g33(.a(x22), .O(new_n75_));
  nand2  g34(.a(new_n67_), .b(x17), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(z11));
  nand3  g36(.a(new_n67_), .b(x23), .c(x14), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n45_), .O(z12));
  inv1   g38(.a(x23), .O(new_n80_));
  oai21  g39(.a(new_n76_), .b(new_n80_), .c(new_n45_), .O(z13));
  inv1   g40(.a(x16), .O(new_n82_));
  nor2   g41(.a(new_n72_), .b(new_n82_), .O(z14));
