...
module FAU ( 
  ...
  oai22  g26(.a(new_n67_), .b(new_n50_), .c(new_n43_), .d(new_n65_), .O(z05));
  inv1   g27(.a(x19), .O(new_n69_));
  nand2  g28(.a(x24), .b(new_n69_), .O(z06));
  and2   g29(.a(x24), .b(x18), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nor2   g31(.a(new_n43_), .b(new_n72_), .O(z08));
  inv1   g32(.a(x24), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n72_), .O(z09));
  nand2  g34(.a(x22), .b(x14), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(x24), .O(z10));
  nand4  g36(.a(new_n74_), .b(x22), .c(x19), .d(x17), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z11));
  nand4  g38(.a(new_n74_), .b(x23), .c(x19), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z12));
  nand2  g40(.a(x23), .b(x17), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x19), .c(x24), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  aoi21  g43(.a(x19), .b(new_n84_), .c(x24), .O(z14));
