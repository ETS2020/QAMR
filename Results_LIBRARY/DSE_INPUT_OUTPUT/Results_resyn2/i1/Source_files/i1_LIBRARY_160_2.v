...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n72_, new_n74_, new_n77_, new_n78_, new_n79_,
  ...
  nand2  g28(.a(new_n43_), .b(new_n53_), .O(z06));
  inv1   g29(.a(x18), .O(new_n71_));
  nand2  g30(.a(new_n44_), .b(x24), .O(new_n72_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n44_), .O(z10));
  nand2  g39(.a(new_n44_), .b(new_n78_), .O(new_n81_));
  nand2  g40(.a(x22), .b(x17), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n81_), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n79_), .b(new_n84_), .c(new_n44_), .O(z12));
  nand3  g44(.a(new_n78_), .b(x23), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor2   g47(.a(new_n81_), .b(new_n88_), .O(z14));
