...
module FAU ( 
  ...
  nor2   g01(.a(x24), .b(x13), .O(new_n43_));
  ...
  nand2  g19(.a(new_n60_), .b(new_n45_), .O(z02));
  ...
  nor2   g26(.a(new_n43_), .b(x10), .O(new_n68_));
  oai21  g27(.a(new_n67_), .b(new_n55_), .c(new_n68_), .O(z05));
  inv1   g28(.a(new_n46_), .O(z06));
  nand2  g29(.a(x24), .b(x18), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n45_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n43_), .b(new_n73_), .O(z08));
  inv1   g33(.a(x24), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n73_), .c(new_n45_), .O(z09));
  nand4  g35(.a(new_n75_), .b(x22), .c(x14), .d(x13), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand4  g37(.a(new_n75_), .b(x22), .c(x17), .d(x13), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand2  g39(.a(x23), .b(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x13), .c(x24), .O(z12));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x13), .c(x24), .O(z13));
  inv1   g43(.a(x16), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x13), .c(x24), .O(z14));
  inv1   g45(.a(x13), .O(new_n87_));
  nor3   g46(.a(x15), .b(x14), .c(x12), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n75_), .c(new_n87_), .O(z15));
endmodule
