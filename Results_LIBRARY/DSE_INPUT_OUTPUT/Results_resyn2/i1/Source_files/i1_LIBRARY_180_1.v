...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n83_, new_n85_, new_n87_, new_n89_;
  ...
  nand4  g39(.a(new_n44_), .b(new_n74_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand2  g41(.a(x23), .b(x14), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x24), .O(z12));
  nand4  g43(.a(new_n44_), .b(new_n74_), .c(x23), .d(x17), .O(new_n85_));
  ...
  oai21  g48(.a(new_n89_), .b(x19), .c(new_n43_), .O(z15));
endmodule
