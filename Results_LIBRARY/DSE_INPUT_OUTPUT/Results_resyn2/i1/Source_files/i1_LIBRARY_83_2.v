...
module FAU ( 
  ...
  nand2  g25(.a(new_n64_), .b(x10), .O(new_n67_));
  ...
  oai21  g30(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z07));
  ...
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n64_), .O(z10));
  inv1   g37(.a(x17), .O(new_n79_));
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n64_), .O(z11));
  nand3  g39(.a(new_n71_), .b(x23), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n64_), .O(z12));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  nor3   g42(.a(new_n83_), .b(new_n44_), .c(x24), .O(z13));
  nand2  g43(.a(new_n71_), .b(x16), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n64_), .O(z14));
