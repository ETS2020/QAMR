...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n71_, new_n74_, new_n77_, new_n79_, new_n81_,
  ...
  nand4  g13(.a(new_n54_), .b(new_n47_), .c(new_n46_), .d(new_n53_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n42_), .O(new_n56_));
  nor2   g15(.a(new_n43_), .b(new_n45_), .O(z06));
  ...
  nand3  g19(.a(new_n60_), .b(z06), .c(new_n56_), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(z02));
  inv1   g21(.a(x20), .O(new_n63_));
  nand2  g22(.a(new_n43_), .b(x19), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n63_), .O(z03));
  or2    g24(.a(z03), .b(x21), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  nor2   g26(.a(x08), .b(x07), .O(new_n68_));
  nand4  g27(.a(new_n68_), .b(new_n54_), .c(new_n47_), .d(new_n46_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x24), .O(new_n70_));
  ...
  nor2   g34(.a(new_n43_), .b(new_n74_), .O(z09));
  nand2  g35(.a(x22), .b(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n45_), .c(x24), .O(z10));
  nand4  g37(.a(new_n43_), .b(x22), .c(new_n45_), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand2  g39(.a(x23), .b(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n45_), .c(x24), .O(z12));
  nand2  g41(.a(x23), .b(x17), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n45_), .c(x24), .O(z13));
  inv1   g43(.a(x16), .O(new_n85_));
  aoi21  g44(.a(new_n45_), .b(new_n85_), .c(x24), .O(z14));
  nor2   g45(.a(x13), .b(x12), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n64_), .O(z15));
endmodule
