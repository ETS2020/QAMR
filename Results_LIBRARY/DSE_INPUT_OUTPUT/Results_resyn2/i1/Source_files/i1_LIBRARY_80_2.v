...
module FAU ( 
  ...
  nand4  g38(.a(new_n44_), .b(new_n75_), .c(x23), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z12));
  nand4  g40(.a(new_n44_), .b(new_n75_), .c(x23), .d(x17), .O(new_n82_));
  ...
  aoi22  g46(.a(new_n87_), .b(new_n86_), .c(new_n43_), .d(x16), .O(z15));
  buf    g47(.a(x19), .O(z06));
endmodule
