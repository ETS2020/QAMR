...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n71_, new_n72_, new_n75_, new_n76_, new_n78_, new_n80_,
  ...
  nor3   g32(.a(new_n72_), .b(new_n69_), .c(new_n71_), .O(z09));
  ...
  nor3   g37(.a(new_n78_), .b(new_n72_), .c(x24), .O(z11));
  nand2  g38(.a(new_n44_), .b(x23), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n76_), .O(z12));
  nand3  g40(.a(new_n69_), .b(x23), .c(x17), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n44_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  aoi21  g43(.a(x24), .b(x19), .c(new_n84_), .O(z14));
