...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n82_, new_n86_, new_n87_;
  ...
  nor3   g37(.a(new_n78_), .b(new_n44_), .c(new_n77_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n46_), .O(z11));
  ...
  aoi21  g43(.a(x24), .b(x19), .c(new_n43_), .O(z14));
  nor2   g44(.a(x13), .b(x12), .O(new_n86_));
  nor2   g45(.a(x15), .b(x14), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n86_), .c(new_n46_), .O(z15));
  buf    g47(.a(x19), .O(z06));
endmodule
