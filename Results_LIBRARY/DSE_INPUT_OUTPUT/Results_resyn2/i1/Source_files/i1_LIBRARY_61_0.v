...
module FAU ( 
  ...
  nand3  g28(.a(x24), .b(x19), .c(new_n69_), .O(new_n70_));
  ...
  nand2  g35(.a(x24), .b(x11), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n44_), .O(z09));
  nand2  g37(.a(x22), .b(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x10), .c(x24), .O(z10));
  nand2  g39(.a(x22), .b(x17), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x10), .c(x24), .O(z11));
  nand2  g41(.a(x23), .b(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x10), .c(x24), .O(z12));
  nand2  g43(.a(x23), .b(x17), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x10), .c(x24), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(x10), .c(x24), .O(z14));
