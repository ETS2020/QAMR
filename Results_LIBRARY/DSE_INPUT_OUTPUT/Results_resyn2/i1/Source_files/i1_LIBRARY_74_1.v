...
module FAU ( 
  ...
  nor2   g22(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  nand2  g33(.a(new_n44_), .b(new_n70_), .O(new_n75_));
  nand2  g34(.a(x22), .b(x17), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n75_), .O(z11));
  inv1   g36(.a(x23), .O(new_n78_));
  oai21  g37(.a(new_n73_), .b(new_n78_), .c(new_n44_), .O(z12));
  nand3  g38(.a(new_n70_), .b(x23), .c(x17), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n44_), .O(z13));
  inv1   g40(.a(x16), .O(new_n82_));
  nor2   g41(.a(new_n75_), .b(new_n82_), .O(z14));
  nor2   g42(.a(x13), .b(x12), .O(new_n84_));
  nor2   g43(.a(x15), .b(x14), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(z15));
endmodule
