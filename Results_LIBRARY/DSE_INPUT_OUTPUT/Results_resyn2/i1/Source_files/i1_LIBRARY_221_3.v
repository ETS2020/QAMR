...
module FAU ( 
  ...
  aoi21  g23(.a(new_n64_), .b(new_n52_), .c(x03), .O(new_n65_));
  ...
  nor2   g30(.a(new_n45_), .b(x03), .O(z06));
  nand2  g31(.a(z06), .b(new_n71_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n58_), .c(new_n70_), .O(z05));
  inv1   g33(.a(x18), .O(new_n75_));
  inv1   g34(.a(x24), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z07));
  ...
  nor2   g45(.a(new_n86_), .b(x24), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x23), .c(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand2  g48(.a(x23), .b(x17), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(x24), .c(new_n43_), .O(z13));
  nand2  g50(.a(new_n87_), .b(x16), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z14));
  nor2   g52(.a(x13), .b(x12), .O(new_n94_));
  nor2   g53(.a(x15), .b(x14), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n86_), .O(z15));
endmodule
