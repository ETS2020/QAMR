...
module FAU ( 
  ...
  and2   g12(.a(x13), .b(x00), .O(new_n54_));
  ...
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(x13), .O(new_n61_));
  ...
  nand3  g26(.a(new_n51_), .b(x19), .c(new_n58_), .O(new_n68_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n70_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n70_), .O(z11));
  nand2  g40(.a(new_n75_), .b(x23), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n77_), .c(new_n70_), .O(z12));
  oai21  g42(.a(new_n82_), .b(new_n80_), .c(new_n70_), .O(z13));
  nand2  g43(.a(new_n75_), .b(x16), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n44_), .O(z14));
