...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n60_, new_n62_, new_n64_, new_n66_, new_n69_,
    new_n70_, new_n72_, new_n75_, new_n76_, new_n77_, new_n79_, new_n80_,
  ...
  nor2   g24(.a(new_n46_), .b(x10), .O(new_n66_));
  oai21  g25(.a(new_n58_), .b(x08), .c(new_n66_), .O(z05));
  nand2  g26(.a(new_n46_), .b(x10), .O(z06));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n44_), .O(z11));
  nand2  g41(.a(new_n76_), .b(x23), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  inv1   g43(.a(x23), .O(new_n85_));
  nor3   g44(.a(new_n81_), .b(new_n43_), .c(new_n85_), .O(z13));
