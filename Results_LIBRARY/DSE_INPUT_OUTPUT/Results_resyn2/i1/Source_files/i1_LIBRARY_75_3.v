...
module FAU ( 
  ...
  nand2  g30(.a(new_n43_), .b(new_n45_), .O(z06));
  nand3  g31(.a(x24), .b(x18), .c(new_n68_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n43_), .b(new_n75_), .O(z08));
  nand3  g35(.a(x24), .b(x11), .c(new_n68_), .O(new_n77_));
