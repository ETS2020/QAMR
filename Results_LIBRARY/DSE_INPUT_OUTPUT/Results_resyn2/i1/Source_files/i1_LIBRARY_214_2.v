...
module FAU ( 
  ...
  nand2  g38(.a(new_n44_), .b(new_n79_), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  ...
  nor2   g47(.a(new_n88_), .b(new_n80_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  nor2   g49(.a(new_n80_), .b(new_n90_), .O(z14));
