...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n73_, new_n75_, new_n76_, new_n78_, new_n80_,
    new_n82_, new_n84_, new_n86_, new_n87_;
  inv1   g00(.a(x00), .O(new_n42_));
  nand2  g01(.a(x24), .b(x19), .O(new_n43_));
  nand2  g02(.a(new_n43_), .b(new_n42_), .O(z00));
  inv1   g03(.a(x24), .O(new_n45_));
  ...
  aoi22  g23(.a(x24), .b(x19), .c(new_n64_), .d(new_n62_), .O(z04));
  nand2  g24(.a(new_n43_), .b(x10), .O(new_n66_));
  nand3  g25(.a(new_n45_), .b(x19), .c(new_n57_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n51_), .c(new_n66_), .O(z05));
  ...
  nand3  g31(.a(x24), .b(new_n69_), .c(x11), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z09));
  inv1   g33(.a(x14), .O(new_n75_));
  nand2  g34(.a(new_n45_), .b(x22), .O(new_n76_));
