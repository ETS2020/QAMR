...
module FAU ( 
  ...
  nand2  g29(.a(new_n70_), .b(new_n44_), .O(z04));
  ...
  nor3   g40(.a(new_n43_), .b(new_n78_), .c(new_n80_), .O(z09));
  ...
  nand2  g48(.a(new_n44_), .b(new_n78_), .O(new_n90_));
  nand2  g49(.a(x23), .b(x17), .O(new_n91_));
  nor2   g50(.a(new_n91_), .b(new_n90_), .O(z13));
  inv1   g51(.a(x16), .O(new_n93_));
  nor2   g52(.a(new_n90_), .b(new_n93_), .O(z14));
  nor2   g53(.a(x13), .b(x12), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n44_), .O(z15));
endmodule
