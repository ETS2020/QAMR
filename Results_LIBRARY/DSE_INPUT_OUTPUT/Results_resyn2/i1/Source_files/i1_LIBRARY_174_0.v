...
module FAU ( 
  ...
  oai21  g26(.a(new_n66_), .b(new_n50_), .c(new_n67_), .O(z05));
  and2   g27(.a(x24), .b(x18), .O(z07));
  inv1   g28(.a(x11), .O(new_n70_));
  nand2  g29(.a(new_n45_), .b(new_n70_), .O(z08));
  inv1   g30(.a(x24), .O(new_n72_));
  nor2   g31(.a(new_n72_), .b(new_n70_), .O(z09));
  nand2  g32(.a(x22), .b(x14), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(x24), .O(z10));
  nand4  g34(.a(new_n72_), .b(x22), .c(x19), .d(x17), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z11));
  nand2  g36(.a(x23), .b(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x19), .c(x24), .O(z12));
  nand2  g38(.a(x23), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x19), .c(x24), .O(z13));
  inv1   g40(.a(x16), .O(new_n82_));
  aoi21  g41(.a(x19), .b(new_n82_), .c(x24), .O(z14));
