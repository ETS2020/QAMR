...
module FAU ( 
  ...
  nand2  g06(.a(new_n47_), .b(new_n43_), .O(z06));
  oai21  g07(.a(new_n47_), .b(new_n42_), .c(z06), .O(new_n49_));
  inv1   g08(.a(x07), .O(new_n50_));
  nor2   g09(.a(x02), .b(x01), .O(new_n51_));
  nor2   g10(.a(x04), .b(x03), .O(new_n52_));
  nor2   g11(.a(x06), .b(x05), .O(new_n53_));
  nand4  g12(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n54_));
  nor2   g13(.a(new_n47_), .b(x08), .O(new_n55_));
  nand2  g14(.a(x09), .b(new_n43_), .O(new_n56_));
  oai21  g15(.a(new_n55_), .b(x09), .c(new_n56_), .O(new_n57_));
  oai21  g16(.a(new_n57_), .b(new_n54_), .c(new_n49_), .O(z01));
  nor2   g17(.a(x09), .b(x07), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x19), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(x08), .O(new_n62_));
  nand3  g21(.a(new_n54_), .b(x19), .c(x00), .O(new_n63_));
  ...
  inv1   g27(.a(new_n55_), .O(new_n69_));
  nor2   g28(.a(new_n44_), .b(x10), .O(new_n70_));
  oai21  g29(.a(new_n69_), .b(new_n54_), .c(new_n70_), .O(z05));
  ...
  nand4  g36(.a(new_n45_), .b(new_n76_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  inv1   g38(.a(x22), .O(new_n80_));
  nand2  g39(.a(new_n76_), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(z11));
  nand4  g41(.a(new_n45_), .b(new_n76_), .c(x23), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  inv1   g43(.a(x23), .O(new_n85_));
  oai21  g44(.a(new_n81_), .b(new_n85_), .c(new_n45_), .O(z13));
