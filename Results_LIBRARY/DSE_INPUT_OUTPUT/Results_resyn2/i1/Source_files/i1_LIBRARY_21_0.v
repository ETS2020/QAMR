...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n67_, new_n69_, new_n71_, new_n72_, new_n76_, new_n79_,
    new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n90_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x24), .b(x07), .O(new_n43_));
  ...
  nand3  g20(.a(x19), .b(new_n56_), .c(x08), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n61_), .c(x24), .O(new_n63_));
  ...
  nand2  g28(.a(new_n69_), .b(new_n46_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nand3  g30(.a(x24), .b(x19), .c(new_n54_), .O(new_n72_));
  ...
  nor2   g36(.a(new_n57_), .b(new_n76_), .O(z09));
  nand4  g37(.a(new_n57_), .b(x22), .c(x14), .d(x07), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand2  g39(.a(x22), .b(x17), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x07), .c(x24), .O(z11));
  nand4  g41(.a(new_n57_), .b(x23), .c(x14), .d(x07), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand4  g43(.a(new_n57_), .b(x23), .c(x17), .d(x07), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(x07), .c(x24), .O(z14));
