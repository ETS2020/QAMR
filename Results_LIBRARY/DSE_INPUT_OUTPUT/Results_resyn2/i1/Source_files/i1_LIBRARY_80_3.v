...
module FAU ( 
  ...
  nor2   g09(.a(new_n50_), .b(x16), .O(z06));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n43_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  oai21  g42(.a(new_n81_), .b(new_n83_), .c(new_n43_), .O(z11));
  nand3  g43(.a(new_n43_), .b(new_n80_), .c(x23), .O(new_n85_));
  ...
  aoi21  g50(.a(x24), .b(new_n50_), .c(new_n91_), .O(z14));
  nor2   g51(.a(x13), .b(x12), .O(new_n93_));
  nor2   g52(.a(x15), .b(x14), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n66_), .O(z15));
endmodule
