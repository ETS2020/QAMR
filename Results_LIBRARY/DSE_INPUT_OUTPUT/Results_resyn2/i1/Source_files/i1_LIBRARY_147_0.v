...
module FAU ( 
  ...
  nand2  g34(.a(new_n45_), .b(x06), .O(z06));
  ...
  nand2  g42(.a(new_n81_), .b(x14), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n69_), .O(z10));
  nand3  g44(.a(new_n81_), .b(x22), .c(x17), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n43_), .O(z11));
  inv1   g46(.a(x23), .O(new_n88_));
  nor3   g47(.a(new_n84_), .b(new_n43_), .c(new_n88_), .O(z12));
