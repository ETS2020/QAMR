...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n60_, new_n61_, new_n62_, new_n65_, new_n67_,
  ...
  aoi21  g10(.a(new_n51_), .b(x00), .c(new_n43_), .O(z01));
  oai21  g11(.a(new_n43_), .b(x00), .c(x03), .O(new_n53_));
  nor3   g12(.a(x04), .b(x02), .c(x01), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(new_n47_), .c(new_n42_), .O(new_n55_));
  ...
  nor2   g19(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n55_), .c(x19), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n53_), .O(z02));
  and2   g22(.a(new_n44_), .b(x20), .O(z03));
  ...
  nor2   g27(.a(new_n45_), .b(x10), .O(new_n69_));
