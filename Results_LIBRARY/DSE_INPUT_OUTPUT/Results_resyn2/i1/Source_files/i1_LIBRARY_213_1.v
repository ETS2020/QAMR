...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n82_, new_n86_, new_n88_, new_n89_;
  ...
  nand2  g25(.a(new_n52_), .b(new_n66_), .O(z03));
  ...
  nand2  g32(.a(new_n73_), .b(new_n52_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n44_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  nor3   g36(.a(new_n44_), .b(new_n77_), .c(new_n75_), .O(z09));
  nand2  g37(.a(new_n77_), .b(x14), .O(new_n79_));
  nand2  g38(.a(new_n52_), .b(x22), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n79_), .O(z10));
  nand2  g40(.a(new_n77_), .b(x17), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n80_), .O(z11));
  aoi21  g42(.a(new_n79_), .b(x16), .c(new_n43_), .O(z12));
  nor2   g43(.a(x24), .b(new_n51_), .O(z14));
  nand3  g44(.a(z14), .b(x23), .c(x17), .O(new_n86_));
