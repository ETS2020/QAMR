...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n68_, new_n70_, new_n73_, new_n75_, new_n76_, new_n77_, new_n78_,
  ...
  inv1   g22(.a(new_n60_), .O(new_n64_));
  inv1   g23(.a(x08), .O(new_n65_));
  nand4  g24(.a(x19), .b(new_n65_), .c(new_n53_), .d(new_n42_), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(new_n52_), .c(new_n51_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n63_), .c(new_n64_), .O(z05));
  nand2  g28(.a(x24), .b(x18), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n64_), .O(z07));
  and2   g30(.a(new_n60_), .b(x11), .O(z08));
  nand2  g31(.a(z08), .b(x24), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z09));
  inv1   g33(.a(x24), .O(new_n75_));
  nand3  g34(.a(new_n60_), .b(new_n75_), .c(x14), .O(new_n76_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n60_), .O(z11));
  nand2  g40(.a(new_n77_), .b(x23), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand4  g42(.a(new_n60_), .b(new_n75_), .c(x23), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z13));
  nand3  g44(.a(new_n60_), .b(new_n75_), .c(x16), .O(new_n86_));
