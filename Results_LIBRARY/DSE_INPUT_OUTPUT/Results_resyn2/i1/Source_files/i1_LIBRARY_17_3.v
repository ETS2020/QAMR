...
module FAU ( 
  ...
  nand2  g01(.a(x19), .b(x05), .O(new_n43_));
  ...
  nor2   g10(.a(x05), .b(new_n42_), .O(new_n52_));
  ...
  nand4  g18(.a(new_n59_), .b(new_n57_), .c(x19), .d(new_n54_), .O(new_n60_));
  ...
  nand4  g37(.a(new_n43_), .b(new_n71_), .c(x22), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand3  g39(.a(new_n71_), .b(x22), .c(x17), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n43_), .O(z11));
  nand4  g41(.a(new_n43_), .b(new_n71_), .c(x23), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand4  g43(.a(new_n43_), .b(new_n71_), .c(x23), .d(x17), .O(new_n85_));
