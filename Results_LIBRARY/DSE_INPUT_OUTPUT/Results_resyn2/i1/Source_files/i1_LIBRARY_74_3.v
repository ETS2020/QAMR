...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n62_, new_n63_, new_n64_, new_n67_, new_n69_, new_n71_,
  ...
  nand4  g22(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(x19), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n62_), .c(new_n63_), .O(z05));
  nor2   g24(.a(new_n45_), .b(x08), .O(z06));
  nand2  g25(.a(x24), .b(x18), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n63_), .O(z07));
  inv1   g27(.a(x11), .O(new_n69_));
  nor2   g28(.a(new_n63_), .b(new_n69_), .O(z08));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n63_), .O(z15));
endmodule
