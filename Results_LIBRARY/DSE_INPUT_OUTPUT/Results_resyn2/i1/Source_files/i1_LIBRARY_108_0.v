...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n67_, new_n69_, new_n70_, new_n72_, new_n75_, new_n76_, new_n78_,
  ...
  nor2   g07(.a(x19), .b(x00), .O(new_n49_));
  inv1   g08(.a(new_n49_), .O(new_n50_));
  inv1   g09(.a(x00), .O(new_n51_));
  inv1   g10(.a(x07), .O(new_n52_));
  nor2   g11(.a(x06), .b(x05), .O(new_n53_));
  nand4  g12(.a(new_n45_), .b(new_n44_), .c(new_n53_), .d(new_n52_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  inv1   g14(.a(x09), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(x08), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n58_));
  nand3  g17(.a(new_n58_), .b(new_n55_), .c(x19), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n50_), .O(z02));
  inv1   g19(.a(x20), .O(new_n61_));
  nand2  g20(.a(new_n50_), .b(new_n61_), .O(z03));
  nor2   g21(.a(x21), .b(x20), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n49_), .O(z04));
  inv1   g23(.a(x10), .O(new_n65_));
  inv1   g24(.a(x08), .O(new_n66_));
  nand2  g25(.a(x19), .b(new_n66_), .O(new_n67_));
  oai22  g26(.a(new_n67_), .b(new_n54_), .c(new_n49_), .d(new_n65_), .O(z05));
  inv1   g27(.a(x18), .O(new_n69_));
  inv1   g28(.a(x24), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(new_n50_), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nor2   g31(.a(new_n49_), .b(new_n72_), .O(z08));
  nor3   g32(.a(new_n49_), .b(new_n70_), .c(new_n72_), .O(z09));
  inv1   g33(.a(x22), .O(new_n75_));
  nand2  g34(.a(new_n70_), .b(x14), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n50_), .O(z10));
  nand2  g36(.a(x22), .b(x17), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n49_), .c(x24), .O(z11));
  inv1   g38(.a(x23), .O(new_n80_));
  oai21  g39(.a(new_n76_), .b(new_n80_), .c(new_n50_), .O(z12));
  nand3  g40(.a(new_n70_), .b(x23), .c(x17), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n50_), .O(z13));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n49_), .O(z15));
  buf    g47(.a(x00), .O(z00));
  buf    g48(.a(x19), .O(z06));
endmodule
