...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(x15), .O(new_n62_));
  ...
  nor2   g27(.a(new_n43_), .b(new_n54_), .O(z06));
  nand2  g28(.a(z06), .b(new_n59_), .O(new_n70_));
  oai22  g29(.a(new_n70_), .b(new_n51_), .c(new_n44_), .d(new_n68_), .O(z05));
  ...
  nor3   g49(.a(x14), .b(x13), .c(x12), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(x19), .c(new_n54_), .O(z15));
endmodule
