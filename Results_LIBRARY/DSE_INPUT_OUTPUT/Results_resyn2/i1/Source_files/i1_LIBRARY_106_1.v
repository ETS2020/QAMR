...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n65_, new_n66_, new_n68_, new_n70_, new_n72_,
  ...
  aoi21  g17(.a(new_n58_), .b(new_n54_), .c(new_n52_), .O(z02));
  inv1   g18(.a(x20), .O(new_n60_));
  nand2  g19(.a(new_n44_), .b(new_n60_), .O(z03));
  or2    g20(.a(z03), .b(x21), .O(z04));
  and2   g21(.a(new_n44_), .b(x10), .O(z05));
  inv1   g22(.a(new_n50_), .O(z06));
  inv1   g23(.a(new_n44_), .O(new_n65_));
  nand2  g24(.a(x24), .b(x18), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n65_), .O(z07));
  inv1   g26(.a(x11), .O(new_n68_));
  nor2   g27(.a(new_n65_), .b(new_n68_), .O(z08));
  inv1   g28(.a(x24), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n68_), .c(new_n44_), .O(z09));
  inv1   g30(.a(x14), .O(new_n72_));
  nand2  g31(.a(new_n70_), .b(x22), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z10));
  inv1   g33(.a(x17), .O(new_n75_));
  oai21  g34(.a(new_n73_), .b(new_n75_), .c(new_n44_), .O(z11));
  inv1   g35(.a(x23), .O(new_n77_));
  nand2  g36(.a(new_n44_), .b(new_n70_), .O(new_n78_));
  ...
  nor2   g43(.a(new_n78_), .b(new_n84_), .O(z14));
