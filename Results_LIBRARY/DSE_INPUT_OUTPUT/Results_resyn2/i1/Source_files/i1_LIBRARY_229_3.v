...
module FAU ( 
  ...
  nand2  g05(.a(new_n44_), .b(x19), .O(new_n47_));
  ...
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(new_n44_), .O(new_n61_));
  ...
  oai21  g26(.a(new_n52_), .b(x08), .c(new_n44_), .O(new_n68_));
  ...
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n64_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n64_), .b(new_n75_), .O(z08));
  oai21  g35(.a(new_n73_), .b(new_n75_), .c(new_n64_), .O(z09));
  nor2   g36(.a(new_n45_), .b(x24), .O(new_n78_));
  ...
  nand2  g41(.a(new_n73_), .b(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n43_), .c(new_n44_), .O(z12));
  nand4  g43(.a(new_n73_), .b(x23), .c(new_n43_), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  nand2  g45(.a(new_n73_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n64_), .O(z14));
