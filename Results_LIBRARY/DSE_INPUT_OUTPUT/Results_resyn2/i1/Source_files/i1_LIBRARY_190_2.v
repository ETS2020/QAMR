...
module FAU ( 
  ...
  nand2  g39(.a(new_n44_), .b(new_n80_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  ...
  nor2   g46(.a(new_n81_), .b(new_n87_), .O(new_n88_));
  ...
  nor2   g52(.a(new_n81_), .b(new_n93_), .O(z14));
