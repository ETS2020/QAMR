...
module FAU ( 
  ...
  nor2   g10(.a(new_n48_), .b(x03), .O(new_n52_));
  ...
  oai21  g17(.a(new_n48_), .b(x03), .c(x24), .O(new_n59_));
  ...
  oai21  g28(.a(new_n48_), .b(x03), .c(x23), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n66_), .O(z12));
  nand4  g30(.a(new_n44_), .b(new_n65_), .c(x23), .d(x17), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z13));
  inv1   g32(.a(x16), .O(new_n74_));
  oai21  g33(.a(new_n48_), .b(x03), .c(new_n65_), .O(new_n75_));
