...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n67_, new_n68_, new_n71_, new_n73_, new_n75_, new_n77_, new_n79_,
  ...
  nand2  g10(.a(new_n45_), .b(x19), .O(new_n52_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(new_n44_), .O(z05));
  nand2  g28(.a(new_n45_), .b(new_n66_), .O(z06));
  ...
  nand4  g35(.a(new_n75_), .b(x22), .c(new_n43_), .d(x14), .O(new_n77_));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n43_), .c(x24), .O(z12));
  nand4  g41(.a(new_n75_), .b(x23), .c(new_n43_), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z13));
  nand3  g43(.a(new_n75_), .b(new_n43_), .c(x16), .O(new_n85_));
