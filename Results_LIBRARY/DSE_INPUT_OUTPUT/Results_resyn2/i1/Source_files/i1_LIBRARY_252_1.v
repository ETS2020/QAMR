...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n73_, new_n74_, new_n76_, new_n78_, new_n79_,
  ...
  nand2  g39(.a(new_n43_), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n74_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  nor3   g42(.a(x24), .b(new_n83_), .c(new_n78_), .O(z12));
  oai21  g43(.a(new_n81_), .b(new_n83_), .c(new_n74_), .O(z13));
