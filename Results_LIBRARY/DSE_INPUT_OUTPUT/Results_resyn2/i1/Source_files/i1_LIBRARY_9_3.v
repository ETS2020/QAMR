...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n72_, new_n74_, new_n75_, new_n76_, new_n78_, new_n80_,
    new_n82_, new_n84_, new_n86_, new_n87_;
  inv1   g00(.a(x00), .O(new_n42_));
  nand2  g01(.a(x22), .b(x19), .O(new_n43_));
  nand2  g02(.a(new_n43_), .b(new_n42_), .O(z00));
  inv1   g03(.a(x22), .O(new_n45_));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n45_), .O(z10));
  nand2  g36(.a(new_n75_), .b(x17), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n74_), .c(new_n45_), .O(z11));
  nand4  g38(.a(new_n43_), .b(new_n75_), .c(x23), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z12));
  inv1   g40(.a(x23), .O(new_n82_));
  oai21  g41(.a(new_n78_), .b(new_n82_), .c(new_n43_), .O(z13));
