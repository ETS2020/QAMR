...
module FAU ( 
  ...
  aoi21  g22(.a(new_n63_), .b(new_n52_), .c(x06), .O(new_n64_));
  ...
  nand2  g41(.a(new_n78_), .b(x11), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  nand2  g44(.a(new_n76_), .b(x22), .O(new_n86_));
  ...
  nand3  g48(.a(new_n43_), .b(new_n76_), .c(x23), .O(new_n90_));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n77_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
