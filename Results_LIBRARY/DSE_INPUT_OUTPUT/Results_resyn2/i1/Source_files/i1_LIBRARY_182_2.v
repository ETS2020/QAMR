...
module FAU ( 
  ...
  nand2  g04(.a(x21), .b(x19), .O(new_n46_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x21), .O(new_n60_));
  and2   g19(.a(new_n60_), .b(x19), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  nand2  g21(.a(new_n44_), .b(new_n62_), .O(z03));
  oai21  g22(.a(new_n62_), .b(x19), .c(new_n43_), .O(z04));
  inv1   g23(.a(x10), .O(new_n65_));
  oai21  g24(.a(new_n51_), .b(x08), .c(x21), .O(new_n66_));
  ...
  nand2  g36(.a(new_n44_), .b(new_n75_), .O(new_n78_));
