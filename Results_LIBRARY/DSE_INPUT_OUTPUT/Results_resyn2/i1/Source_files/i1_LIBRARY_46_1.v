...
module FAU ( 
  ...
  nand2  g22(.a(x19), .b(x17), .O(new_n64_));
  aoi21  g23(.a(new_n63_), .b(new_n59_), .c(new_n64_), .O(z02));
  ...
  inv1   g28(.a(new_n64_), .O(z06));
  nand2  g29(.a(z06), .b(new_n61_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n58_), .c(new_n69_), .O(z05));
  ...
  nand2  g41(.a(new_n82_), .b(new_n44_), .O(z11));
  nand4  g42(.a(new_n44_), .b(new_n78_), .c(x23), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z12));
  nand2  g44(.a(x23), .b(x17), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(x24), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor3   g47(.a(new_n73_), .b(x24), .c(new_n88_), .O(z14));
