...
module FAU ( 
  ...
  oai21  g12(.a(new_n53_), .b(x08), .c(new_n52_), .O(new_n54_));
  oai21  g13(.a(new_n52_), .b(x08), .c(new_n54_), .O(new_n55_));
  nand2  g14(.a(new_n53_), .b(new_n43_), .O(z06));
  oai21  g15(.a(new_n53_), .b(new_n42_), .c(z06), .O(new_n57_));
  oai21  g16(.a(new_n55_), .b(new_n51_), .c(new_n57_), .O(z01));
  nor3   g17(.a(x07), .b(x06), .c(x05), .O(new_n59_));
  nand2  g18(.a(new_n52_), .b(x08), .O(new_n60_));
  nand4  g19(.a(new_n60_), .b(new_n50_), .c(new_n49_), .d(new_n59_), .O(new_n61_));
  nand2  g20(.a(new_n51_), .b(new_n42_), .O(new_n62_));
  ...
  nand2  g42(.a(new_n83_), .b(new_n45_), .O(z12));
  nand2  g43(.a(new_n45_), .b(new_n73_), .O(new_n85_));
  nand2  g44(.a(x23), .b(x17), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n85_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor2   g47(.a(new_n85_), .b(new_n88_), .O(z14));
