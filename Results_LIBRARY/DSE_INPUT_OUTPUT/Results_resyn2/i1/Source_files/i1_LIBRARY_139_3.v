...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n71_, new_n73_, new_n76_, new_n78_, new_n79_,
  ...
  nor2   g09(.a(new_n50_), .b(x17), .O(z06));
  ...
  nand4  g21(.a(new_n62_), .b(new_n47_), .c(new_n46_), .d(new_n60_), .O(new_n63_));
  ...
  nand2  g29(.a(z06), .b(new_n61_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n58_), .c(new_n70_), .O(z05));
  ...
  nand2  g38(.a(new_n79_), .b(new_n43_), .O(z10));
  nand4  g39(.a(new_n78_), .b(x22), .c(new_n50_), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand3  g41(.a(new_n78_), .b(x23), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n43_), .O(z12));
  nand4  g43(.a(new_n78_), .b(x23), .c(new_n50_), .d(x17), .O(new_n85_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n66_), .O(z15));
endmodule
