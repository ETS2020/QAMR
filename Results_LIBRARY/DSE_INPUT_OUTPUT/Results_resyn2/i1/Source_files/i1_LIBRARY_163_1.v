...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n69_, new_n70_, new_n71_, new_n74_, new_n76_, new_n79_,
  ...
  nand4  g21(.a(new_n62_), .b(new_n60_), .c(new_n43_), .d(new_n47_), .O(new_n63_));
  ...
  oai21  g28(.a(new_n51_), .b(x08), .c(new_n43_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n47_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n69_), .O(z05));
  nand2  g31(.a(new_n66_), .b(new_n46_), .O(z06));
  nand3  g32(.a(x24), .b(x18), .c(x06), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nor2   g35(.a(new_n44_), .b(new_n76_), .O(z08));
  aoi21  g36(.a(new_n76_), .b(x06), .c(new_n43_), .O(z09));
  inv1   g37(.a(x14), .O(new_n79_));
  inv1   g38(.a(x22), .O(new_n80_));
  nor3   g39(.a(x24), .b(new_n80_), .c(new_n79_), .O(z10));
  nand2  g40(.a(new_n43_), .b(x17), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n66_), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  nor3   g43(.a(x24), .b(new_n84_), .c(new_n79_), .O(z12));
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n66_), .O(z13));
