...
module FAU ( 
  ...
  nand2  g31(.a(x19), .b(new_n72_), .O(z08));
  inv1   g32(.a(x24), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x11), .O(new_n75_));
  and2   g34(.a(new_n75_), .b(z08), .O(z09));
  ...
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n62_), .O(z11));
  nand2  g40(.a(new_n74_), .b(x23), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n77_), .c(new_n62_), .O(z12));
  oai21  g42(.a(new_n82_), .b(new_n80_), .c(new_n62_), .O(z13));
