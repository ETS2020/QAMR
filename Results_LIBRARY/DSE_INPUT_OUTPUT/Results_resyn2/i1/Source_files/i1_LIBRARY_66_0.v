...
module FAU ( 
  ...
  nand4  g27(.a(new_n68_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n43_), .O(z05));
  nand2  g29(.a(new_n44_), .b(new_n67_), .O(z06));
  ...
  nand4  g36(.a(new_n76_), .b(x22), .c(x20), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand2  g38(.a(x22), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x20), .c(x24), .O(z11));
  nand2  g40(.a(x23), .b(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x20), .c(x24), .O(z12));
  nand4  g42(.a(new_n76_), .b(x23), .c(x20), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z13));
  nand2  g44(.a(x20), .b(x16), .O(new_n86_));
