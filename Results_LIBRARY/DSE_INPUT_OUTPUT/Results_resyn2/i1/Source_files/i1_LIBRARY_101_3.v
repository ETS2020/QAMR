...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n71_, new_n74_, new_n76_, new_n77_, new_n79_,
  ...
  nor2   g10(.a(x22), .b(new_n42_), .O(new_n52_));
  aoi21  g11(.a(new_n52_), .b(new_n51_), .c(new_n46_), .O(z01));
  inv1   g12(.a(x22), .O(new_n54_));
  ...
  nand3  g27(.a(new_n54_), .b(x19), .c(new_n60_), .O(new_n69_));
  ...
  nand4  g35(.a(new_n76_), .b(x22), .c(new_n46_), .d(x14), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand4  g37(.a(new_n76_), .b(x22), .c(new_n46_), .d(x17), .O(new_n79_));
  ...
  nand3  g44(.a(new_n43_), .b(new_n76_), .c(x16), .O(new_n86_));
