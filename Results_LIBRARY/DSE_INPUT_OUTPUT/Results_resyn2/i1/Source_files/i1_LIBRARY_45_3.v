...
module FAU ( 
  ...
  nor2   g09(.a(new_n50_), .b(x13), .O(z06));
  ...
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(z11));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n77_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n43_), .O(z12));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n43_), .O(z13));
