...
module FAU ( 
  ...
  nand2  g34(.a(new_n44_), .b(x14), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n75_), .O(z10));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n75_), .b(new_n78_), .c(new_n44_), .O(z11));
  inv1   g38(.a(x14), .O(new_n80_));
  nand2  g39(.a(new_n74_), .b(x23), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n44_), .O(z12));
  oai21  g41(.a(new_n81_), .b(new_n78_), .c(new_n44_), .O(z13));
