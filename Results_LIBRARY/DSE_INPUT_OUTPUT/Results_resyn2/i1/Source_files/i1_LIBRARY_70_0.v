...
module FAU ( 
  ...
  aoi21  g21(.a(new_n62_), .b(new_n60_), .c(new_n43_), .O(z04));
  inv1   g22(.a(x10), .O(new_n64_));
  inv1   g23(.a(x08), .O(new_n65_));
  nand4  g24(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n65_), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n64_), .c(new_n43_), .O(z05));
  nand2  g26(.a(x24), .b(x18), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n43_), .O(z07));
  inv1   g28(.a(x11), .O(new_n70_));
  nor2   g29(.a(new_n43_), .b(new_n70_), .O(z08));
  inv1   g30(.a(x24), .O(new_n72_));
  nor3   g31(.a(new_n43_), .b(new_n72_), .c(new_n70_), .O(z09));
  nand2  g32(.a(new_n72_), .b(x22), .O(new_n74_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n81_), .O(z12));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n81_), .O(z13));
  nand2  g44(.a(new_n72_), .b(x16), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n81_), .O(z14));
