...
module FAU ( 
  ...
  nor2   g16(.a(new_n57_), .b(new_n51_), .O(z07));
  ...
  oai21  g21(.a(new_n48_), .b(x03), .c(new_n61_), .O(new_n63_));
  nand2  g22(.a(x22), .b(x14), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n63_), .O(z10));
  inv1   g24(.a(x22), .O(new_n66_));
  nand2  g25(.a(new_n61_), .b(x17), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(z11));
  nand2  g27(.a(x23), .b(x14), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n63_), .O(z12));
  inv1   g29(.a(x23), .O(new_n71_));
  oai21  g30(.a(new_n67_), .b(new_n71_), .c(new_n44_), .O(z13));
  inv1   g31(.a(x16), .O(new_n73_));
  nor2   g32(.a(new_n63_), .b(new_n73_), .O(z14));
