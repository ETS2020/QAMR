// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:28 2020
...
module FAU ( 
  ...
  nor3   g04(.a(x03), .b(x02), .c(x01), .O(new_n46_));
  ...
  oai21  g19(.a(new_n60_), .b(new_n51_), .c(x19), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  nor2   g21(.a(x07), .b(x04), .O(new_n63_));
  nand4  g22(.a(new_n63_), .b(new_n46_), .c(new_n49_), .d(new_n48_), .O(new_n64_));
  ...
  nand2  g40(.a(new_n80_), .b(x22), .O(new_n82_));
