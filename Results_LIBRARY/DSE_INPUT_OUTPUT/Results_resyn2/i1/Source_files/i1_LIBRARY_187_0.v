...
module FAU ( 
  ...
  aoi21  g05(.a(x19), .b(x08), .c(new_n46_), .O(new_n47_));
  ...
  aoi21  g11(.a(x19), .b(new_n42_), .c(new_n43_), .O(new_n53_));
  ...
  nand4  g25(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n66_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n43_), .O(z05));
  inv1   g27(.a(x18), .O(new_n69_));
  inv1   g28(.a(x24), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z07));
