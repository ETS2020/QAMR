...
module FAU ( 
  ...
  nand2  g19(.a(new_n45_), .b(new_n60_), .O(z03));
  ...
  nand4  g30(.a(new_n45_), .b(new_n70_), .c(x22), .d(x14), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z10));
  inv1   g32(.a(x22), .O(new_n74_));
  nand2  g33(.a(new_n70_), .b(x17), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(z11));
  nand4  g35(.a(new_n45_), .b(new_n70_), .c(x23), .d(x14), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z12));
  inv1   g37(.a(x23), .O(new_n79_));
  oai21  g38(.a(new_n75_), .b(new_n79_), .c(new_n45_), .O(z13));
  inv1   g39(.a(x16), .O(new_n81_));
  nor3   g40(.a(new_n44_), .b(x24), .c(new_n81_), .O(z14));
