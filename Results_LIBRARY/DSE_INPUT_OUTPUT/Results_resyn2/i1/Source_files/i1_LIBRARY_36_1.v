...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n67_, new_n69_, new_n71_, new_n72_, new_n75_, new_n76_,
  ...
  nand2  g14(.a(x09), .b(new_n55_), .O(new_n56_));
  inv1   g15(.a(x09), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x08), .c(x13), .O(new_n58_));
  ...
  nand3  g20(.a(x19), .b(new_n57_), .c(x08), .O(new_n62_));
  ...
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n44_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nand3  g30(.a(x19), .b(new_n43_), .c(new_n55_), .O(new_n72_));
  ...
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z10));
  inv1   g43(.a(x22), .O(new_n85_));
  nand2  g44(.a(new_n81_), .b(x17), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n47_), .O(z11));
  nand3  g46(.a(new_n81_), .b(x23), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n47_), .O(z12));
  inv1   g48(.a(x23), .O(new_n90_));
  nor3   g49(.a(new_n86_), .b(new_n44_), .c(new_n90_), .O(z13));
  inv1   g50(.a(x16), .O(new_n92_));
  nor2   g51(.a(new_n82_), .b(new_n92_), .O(z14));
