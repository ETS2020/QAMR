...
module FAU ( 
  ...
  nand2  g26(.a(new_n56_), .b(new_n67_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n54_), .c(new_n66_), .O(z05));
  nand3  g28(.a(new_n43_), .b(x24), .c(x18), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nand2  g31(.a(new_n43_), .b(new_n72_), .O(z08));
  nand3  g32(.a(new_n43_), .b(x24), .c(x11), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z09));
  inv1   g34(.a(x24), .O(new_n76_));
  nand4  g35(.a(new_n43_), .b(new_n76_), .c(x22), .d(x14), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand4  g37(.a(new_n43_), .b(new_n76_), .c(x22), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand4  g39(.a(new_n43_), .b(new_n76_), .c(x23), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  nand4  g41(.a(new_n43_), .b(new_n76_), .c(x23), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z13));
  nand3  g43(.a(new_n43_), .b(new_n76_), .c(x16), .O(new_n85_));
