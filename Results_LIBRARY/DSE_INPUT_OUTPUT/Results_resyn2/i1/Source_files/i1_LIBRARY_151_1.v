...
module FAU ( 
  ...
  nor3   g29(.a(new_n44_), .b(new_n67_), .c(new_n69_), .O(z09));
  inv1   g30(.a(x22), .O(new_n72_));
  nand2  g31(.a(new_n67_), .b(x14), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(z10));
  nand2  g33(.a(x22), .b(x17), .O(new_n75_));
  nor3   g34(.a(new_n75_), .b(new_n44_), .c(x24), .O(z11));
  inv1   g35(.a(x23), .O(new_n77_));
  oai21  g36(.a(new_n73_), .b(new_n77_), .c(new_n45_), .O(z12));
  nand3  g37(.a(new_n67_), .b(x23), .c(x17), .O(new_n79_));
