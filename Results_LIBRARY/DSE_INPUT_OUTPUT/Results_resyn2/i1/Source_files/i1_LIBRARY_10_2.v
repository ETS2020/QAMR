...
module FAU ( 
  ...
  nand2  g15(.a(new_n50_), .b(new_n42_), .O(new_n57_));
  nor3   g16(.a(x07), .b(x06), .c(x05), .O(new_n58_));
  nand2  g17(.a(new_n43_), .b(x08), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n60_));
  nand3  g19(.a(new_n60_), .b(new_n57_), .c(x19), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n56_), .O(z02));
  ...
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(new_n56_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nand2  g33(.a(new_n56_), .b(new_n74_), .O(z08));
  nor3   g34(.a(new_n44_), .b(new_n72_), .c(new_n74_), .O(z09));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n72_), .b(x22), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n56_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n56_), .O(z11));
  nand2  g40(.a(new_n56_), .b(new_n72_), .O(new_n82_));
  nand2  g41(.a(x23), .b(x14), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z12));
  nand3  g43(.a(new_n72_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n56_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  nor2   g46(.a(new_n82_), .b(new_n87_), .O(z14));
