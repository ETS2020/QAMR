...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n79_, new_n81_, new_n82_, new_n84_, new_n87_, new_n89_,
    new_n91_, new_n92_;
  ...
  inv1   g10(.a(x23), .O(new_n52_));
  nor2   g11(.a(new_n52_), .b(new_n43_), .O(new_n53_));
  ...
  nand3  g21(.a(new_n62_), .b(new_n58_), .c(new_n53_), .O(new_n63_));
  ...
  nand4  g29(.a(new_n70_), .b(new_n60_), .c(new_n48_), .d(new_n47_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x23), .O(new_n72_));
  ...
  nor3   g44(.a(x24), .b(new_n52_), .c(new_n81_), .O(z12));
