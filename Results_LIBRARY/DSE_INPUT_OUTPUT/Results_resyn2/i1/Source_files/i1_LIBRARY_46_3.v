...
module FAU ( 
  ...
  nor2   g09(.a(x17), .b(new_n42_), .O(new_n51_));
  ...
  nor2   g14(.a(x07), .b(x04), .O(new_n56_));
  ...
  nor2   g21(.a(new_n45_), .b(x17), .O(z06));
  inv1   g22(.a(z06), .O(new_n64_));
  aoi21  g23(.a(new_n62_), .b(new_n58_), .c(new_n64_), .O(z02));
  inv1   g24(.a(x20), .O(new_n66_));
  inv1   g25(.a(new_n43_), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n66_), .O(z03));
  inv1   g27(.a(x21), .O(new_n69_));
  nand3  g28(.a(new_n43_), .b(new_n69_), .c(new_n66_), .O(z04));
  nand2  g29(.a(new_n43_), .b(x10), .O(new_n71_));
  nand2  g30(.a(z06), .b(new_n60_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n57_), .c(new_n71_), .O(z05));
  nand2  g32(.a(x24), .b(x18), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n67_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nor2   g35(.a(new_n67_), .b(new_n76_), .O(z08));
  ...
  nand2  g41(.a(new_n78_), .b(x22), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n45_), .c(new_n82_), .O(z11));
  nand4  g43(.a(new_n43_), .b(new_n78_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand4  g45(.a(new_n78_), .b(x23), .c(new_n45_), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z13));
  nand3  g47(.a(new_n43_), .b(new_n78_), .c(x16), .O(new_n89_));
