...
module FAU ( 
  ...
  nor2   g01(.a(x24), .b(new_n42_), .O(z00));
  inv1   g02(.a(x24), .O(new_n44_));
  nor2   g03(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  ...
  aoi21  g16(.a(new_n57_), .b(x19), .c(x24), .O(new_n58_));
  ...
  aoi21  g33(.a(new_n74_), .b(new_n42_), .c(new_n44_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n65_), .b(new_n76_), .O(z08));
  aoi21  g36(.a(new_n76_), .b(new_n42_), .c(new_n44_), .O(z09));
