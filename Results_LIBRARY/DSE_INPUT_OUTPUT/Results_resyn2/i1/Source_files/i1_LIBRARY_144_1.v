...
module FAU ( 
  ...
  nor2   g21(.a(new_n62_), .b(new_n51_), .O(z09));
  nand4  g22(.a(new_n44_), .b(new_n58_), .c(x22), .d(x14), .O(new_n64_));
  ...
  nand4  g27(.a(new_n44_), .b(new_n58_), .c(x23), .d(x14), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z12));
  oai21  g29(.a(new_n46_), .b(x07), .c(x23), .O(new_n71_));
