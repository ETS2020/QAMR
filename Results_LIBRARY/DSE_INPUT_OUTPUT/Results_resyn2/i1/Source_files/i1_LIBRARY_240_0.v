...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n79_, new_n81_, new_n83_, new_n84_, new_n86_, new_n88_, new_n90_,
    new_n91_;
  ...
  and2   g18(.a(x19), .b(x00), .O(new_n60_));
  oai21  g19(.a(new_n50_), .b(x02), .c(new_n60_), .O(new_n61_));
  ...
  nand2  g24(.a(new_n65_), .b(new_n44_), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  oai21  g26(.a(new_n50_), .b(x08), .c(x19), .O(new_n68_));
  ...
  nand2  g35(.a(new_n75_), .b(x22), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  ...
  nand2  g42(.a(new_n75_), .b(x23), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n44_), .O(z13));
  nand2  g46(.a(new_n75_), .b(x16), .O(new_n88_));
