...
module FAU ( 
  ...
  nor2   g20(.a(x19), .b(new_n61_), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n60_), .O(z03));
  inv1   g22(.a(x21), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n60_), .c(new_n62_), .O(z04));
  nand2  g24(.a(new_n44_), .b(x10), .O(new_n66_));
  nand2  g25(.a(x19), .b(new_n61_), .O(new_n67_));
  ...
  nor2   g33(.a(new_n62_), .b(x24), .O(new_n75_));
  ...
  nor3   g41(.a(new_n82_), .b(new_n62_), .c(x24), .O(z13));
