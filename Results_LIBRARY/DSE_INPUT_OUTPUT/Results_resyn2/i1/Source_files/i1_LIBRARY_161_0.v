...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n82_, new_n84_, new_n87_, new_n88_, new_n89_;
  ...
  nand3  g42(.a(new_n81_), .b(x23), .c(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z13));
  and2   g44(.a(new_n81_), .b(x16), .O(z14));
  inv1   g45(.a(x13), .O(new_n87_));
  inv1   g46(.a(x19), .O(new_n88_));
  nor3   g47(.a(x15), .b(x14), .c(x12), .O(new_n89_));
