...
module FAU ( 
  ...
  nor2   g29(.a(x24), .b(x10), .O(new_n71_));
  oai21  g30(.a(new_n70_), .b(new_n60_), .c(new_n71_), .O(z05));
  nand2  g31(.a(new_n45_), .b(new_n47_), .O(z06));
  nand3  g32(.a(x24), .b(x18), .c(x10), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n45_), .b(new_n76_), .O(z08));
  nand3  g36(.a(x24), .b(x11), .c(x10), .O(new_n78_));
