...
module FAU ( 
  ...
  nand3  g11(.a(new_n52_), .b(new_n51_), .c(new_n43_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(x00), .c(new_n46_), .O(z01));
  oai21  g13(.a(new_n46_), .b(x00), .c(x07), .O(new_n55_));
  inv1   g14(.a(x08), .O(new_n56_));
  nor2   g15(.a(x09), .b(new_n56_), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n43_), .c(new_n50_), .O(new_n58_));
  nand2  g17(.a(new_n50_), .b(new_n42_), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(x19), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n58_), .c(new_n55_), .O(z02));
  ...
  nand2  g24(.a(new_n51_), .b(new_n43_), .O(new_n66_));
  inv1   g25(.a(new_n44_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x10), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n56_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n66_), .c(new_n68_), .O(z05));
  nand2  g29(.a(new_n46_), .b(new_n43_), .O(z06));
  inv1   g30(.a(x18), .O(new_n72_));
  nand2  g31(.a(new_n67_), .b(x24), .O(new_n73_));
