...
module FAU ( 
  ...
  nor2   g13(.a(new_n54_), .b(new_n44_), .O(z04));
  inv1   g14(.a(x10), .O(new_n56_));
  nor2   g15(.a(new_n44_), .b(new_n56_), .O(z05));
  nor2   g16(.a(new_n43_), .b(new_n51_), .O(z06));
  inv1   g17(.a(x18), .O(new_n59_));
  inv1   g18(.a(x24), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(z07));
  inv1   g20(.a(x11), .O(new_n62_));
  nand2  g21(.a(new_n52_), .b(new_n62_), .O(z08));
  oai21  g22(.a(new_n60_), .b(new_n62_), .c(new_n52_), .O(z09));
  inv1   g23(.a(x14), .O(new_n65_));
  nand2  g24(.a(new_n60_), .b(x22), .O(new_n66_));
  ...
  nand3  g28(.a(new_n60_), .b(x23), .c(x14), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n52_), .O(z12));
  oai21  g30(.a(new_n43_), .b(x07), .c(new_n60_), .O(new_n72_));
  nand2  g31(.a(x23), .b(x17), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z13));
  inv1   g33(.a(x16), .O(new_n75_));
  nor2   g34(.a(new_n72_), .b(new_n75_), .O(z14));
