...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n60_, new_n62_, new_n64_, new_n65_, new_n66_, new_n69_,
  ...
  aoi21  g21(.a(new_n62_), .b(new_n59_), .c(new_n60_), .O(z04));
  ...
  nor2   g28(.a(new_n69_), .b(new_n60_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nor2   g30(.a(new_n60_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x24), .O(new_n73_));
  nor3   g32(.a(new_n60_), .b(new_n73_), .c(new_n71_), .O(z09));
  nand4  g33(.a(new_n43_), .b(new_n73_), .c(x22), .d(x14), .O(new_n75_));
  ...
  nand2  g38(.a(new_n79_), .b(new_n43_), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n60_), .c(x24), .O(z13));
