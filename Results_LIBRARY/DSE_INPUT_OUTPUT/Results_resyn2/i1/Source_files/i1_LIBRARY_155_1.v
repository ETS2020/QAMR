...
module FAU ( 
  ...
  oai21  g16(.a(new_n43_), .b(x06), .c(x11), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z08));
  inv1   g18(.a(x24), .O(new_n60_));
  nor2   g19(.a(new_n58_), .b(new_n60_), .O(z09));
  inv1   g20(.a(x22), .O(new_n62_));
  nand2  g21(.a(new_n60_), .b(x14), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n62_), .c(new_n51_), .O(z10));
  nand4  g23(.a(new_n51_), .b(new_n60_), .c(x22), .d(x17), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z11));
  oai21  g25(.a(new_n43_), .b(x06), .c(x23), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n63_), .O(z12));
  nand4  g27(.a(new_n51_), .b(new_n60_), .c(x23), .d(x17), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z13));
  nand2  g29(.a(new_n60_), .b(x16), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n51_), .O(z14));
