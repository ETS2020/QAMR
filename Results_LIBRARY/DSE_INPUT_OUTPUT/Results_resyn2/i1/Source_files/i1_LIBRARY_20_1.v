...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(x17), .O(new_n62_));
  ...
  oai21  g27(.a(new_n51_), .b(x08), .c(x17), .O(new_n69_));
  ...
  oai21  g40(.a(new_n80_), .b(new_n54_), .c(new_n45_), .O(z11));
  nand2  g41(.a(new_n45_), .b(new_n74_), .O(new_n83_));
