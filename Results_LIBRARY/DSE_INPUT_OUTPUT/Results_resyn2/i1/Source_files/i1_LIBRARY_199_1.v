...
module FAU ( 
  ...
  nand3  g19(.a(new_n60_), .b(new_n56_), .c(x14), .O(new_n61_));
  ...
  nor2   g27(.a(new_n43_), .b(new_n53_), .O(z06));
  nand2  g28(.a(z06), .b(new_n58_), .O(new_n70_));
  oai22  g29(.a(new_n70_), .b(new_n50_), .c(new_n44_), .d(new_n68_), .O(z05));
  ...
  nand2  g38(.a(new_n64_), .b(new_n73_), .O(new_n80_));
  ...
  oai21  g48(.a(new_n89_), .b(x19), .c(new_n53_), .O(z15));
endmodule
