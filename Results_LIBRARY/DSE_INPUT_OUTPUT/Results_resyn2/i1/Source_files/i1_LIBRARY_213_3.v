...
module FAU ( 
  ...
  nand2  g01(.a(x23), .b(x16), .O(new_n43_));
  ...
  nand2  g41(.a(new_n76_), .b(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n82_), .O(z12));
  nand4  g43(.a(new_n76_), .b(x23), .c(x17), .d(new_n81_), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  nand3  g45(.a(new_n76_), .b(new_n82_), .c(x16), .O(new_n87_));
