...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n63_, new_n64_, new_n66_, new_n68_, new_n70_,
    new_n72_, new_n74_, new_n75_, new_n77_, new_n78_, new_n81_, new_n83_,
    new_n84_;
  ...
  nand4  g30(.a(new_n42_), .b(new_n70_), .c(x22), .d(x14), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z10));
  inv1   g32(.a(x19), .O(new_n74_));
  nand4  g33(.a(new_n70_), .b(x22), .c(new_n74_), .d(x17), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z11));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n70_), .b(x23), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n42_), .O(z12));
  aoi21  g38(.a(new_n78_), .b(new_n74_), .c(new_n44_), .O(z13));
