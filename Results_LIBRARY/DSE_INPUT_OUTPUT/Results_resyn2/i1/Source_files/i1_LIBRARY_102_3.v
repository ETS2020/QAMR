...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n68_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n68_), .b(new_n81_), .O(z08));
  nor3   g41(.a(new_n45_), .b(new_n79_), .c(new_n81_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  nand2  g43(.a(new_n79_), .b(x22), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n68_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n68_), .O(z11));
  nand3  g47(.a(new_n79_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n68_), .O(z12));
  nand4  g49(.a(new_n68_), .b(new_n79_), .c(x23), .d(x17), .O(new_n91_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n95_), .c(new_n68_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
