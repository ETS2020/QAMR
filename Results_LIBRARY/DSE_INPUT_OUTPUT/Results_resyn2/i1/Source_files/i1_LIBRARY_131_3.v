...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n72_, new_n73_, new_n75_, new_n77_, new_n79_,
    new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_;
  inv1   g00(.a(x00), .O(new_n42_));
  nand2  g01(.a(x24), .b(x01), .O(new_n43_));
  ...
  nand2  g29(.a(new_n43_), .b(new_n45_), .O(z06));
  inv1   g30(.a(x01), .O(new_n72_));
  nand3  g31(.a(x24), .b(x18), .c(new_n72_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n68_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  aoi21  g36(.a(new_n75_), .b(new_n72_), .c(new_n77_), .O(z09));
  inv1   g37(.a(x14), .O(new_n79_));
  nand2  g38(.a(new_n77_), .b(x22), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(z10));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n43_), .O(z11));
  nand2  g42(.a(new_n77_), .b(x23), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n79_), .c(new_n43_), .O(z12));
  oai21  g44(.a(new_n84_), .b(new_n82_), .c(new_n43_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  nor2   g46(.a(x24), .b(new_n87_), .O(z14));
  nor2   g47(.a(x13), .b(x12), .O(new_n89_));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z15));
endmodule
