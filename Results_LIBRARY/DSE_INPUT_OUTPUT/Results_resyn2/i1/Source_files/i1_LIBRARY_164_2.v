...
module FAU ( 
  ...
  nor2   g11(.a(new_n44_), .b(new_n42_), .O(new_n53_));
  aoi22  g12(.a(new_n53_), .b(new_n52_), .c(new_n45_), .d(new_n47_), .O(z01));
  ...
  nand4  g18(.a(new_n50_), .b(new_n49_), .c(new_n59_), .d(new_n58_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(new_n42_), .O(new_n61_));
  nor2   g20(.a(new_n44_), .b(new_n47_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(new_n61_), .c(new_n57_), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z02));
  inv1   g23(.a(x20), .O(new_n65_));
  nor2   g24(.a(new_n44_), .b(new_n65_), .O(z03));
  nor2   g25(.a(x21), .b(x20), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n45_), .O(z04));
  nor2   g27(.a(new_n47_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n43_), .c(new_n44_), .O(z05));
  nand2  g30(.a(new_n45_), .b(new_n47_), .O(z06));
  nand2  g31(.a(x24), .b(x18), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n45_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n44_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n75_), .O(z09));
  nand4  g37(.a(new_n77_), .b(x22), .c(x14), .d(new_n43_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand2  g39(.a(x22), .b(x17), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n43_), .c(x24), .O(z11));
  nand4  g41(.a(new_n77_), .b(x23), .c(x14), .d(new_n43_), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand2  g43(.a(x23), .b(x17), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n43_), .c(x24), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n43_), .c(x24), .O(z14));
