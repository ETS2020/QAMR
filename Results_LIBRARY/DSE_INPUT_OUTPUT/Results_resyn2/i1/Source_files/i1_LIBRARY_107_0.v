...
module FAU ( 
  ...
  nand2  g29(.a(new_n52_), .b(x24), .O(new_n71_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n76_), .c(new_n52_), .O(z10));
  ...
  oai21  g43(.a(new_n78_), .b(new_n84_), .c(new_n52_), .O(z12));
  nand2  g44(.a(new_n81_), .b(x23), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  oai21  g47(.a(x24), .b(new_n88_), .c(new_n52_), .O(z14));
