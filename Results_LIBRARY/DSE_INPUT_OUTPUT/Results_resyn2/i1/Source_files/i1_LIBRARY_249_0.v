...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n70_, new_n71_, new_n73_, new_n76_, new_n78_, new_n79_, new_n81_,
  ...
  nand4  g25(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(new_n66_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n43_), .O(z05));
  nand2  g27(.a(new_n45_), .b(x08), .O(z06));
  inv1   g28(.a(x18), .O(new_n70_));
  inv1   g29(.a(x24), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n70_), .c(new_n62_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n62_), .b(new_n73_), .O(z08));
  oai21  g33(.a(new_n71_), .b(new_n73_), .c(new_n62_), .O(z09));
  nand2  g34(.a(x22), .b(x14), .O(new_n76_));
  nor3   g35(.a(new_n76_), .b(new_n43_), .c(x24), .O(z10));
  inv1   g36(.a(x22), .O(new_n78_));
  nand2  g37(.a(new_n71_), .b(x17), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n62_), .O(z11));
  nand3  g39(.a(new_n71_), .b(x23), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n62_), .O(z12));
  inv1   g41(.a(x23), .O(new_n83_));
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n62_), .O(z13));
  nand2  g43(.a(new_n71_), .b(x16), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n62_), .O(z14));
  nor2   g45(.a(x13), .b(x12), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n62_), .O(z15));
endmodule
