...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n79_, new_n81_, new_n82_, new_n84_, new_n85_, new_n86_,
  ...
  oai21  g33(.a(new_n74_), .b(new_n59_), .c(new_n72_), .O(z05));
  nand2  g34(.a(x24), .b(x18), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n44_), .O(z07));
  ...
  nand3  g42(.a(new_n43_), .b(new_n81_), .c(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x22), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  nand4  g46(.a(new_n43_), .b(new_n81_), .c(x23), .d(x14), .O(new_n88_));
