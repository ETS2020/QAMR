...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n63_, new_n66_, new_n67_, new_n69_, new_n71_,
    new_n73_, new_n74_, new_n76_, new_n77_, new_n79_, new_n81_, new_n83_,
    new_n85_, new_n86_;
  ...
  nor2   g28(.a(new_n66_), .b(new_n69_), .O(z08));
  ...
  nand2  g34(.a(new_n44_), .b(new_n71_), .O(new_n76_));
  nand2  g35(.a(x22), .b(x17), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n76_), .O(z11));
  nand2  g37(.a(new_n44_), .b(x23), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n74_), .O(z12));
  nand3  g39(.a(new_n71_), .b(x23), .c(x17), .O(new_n81_));
