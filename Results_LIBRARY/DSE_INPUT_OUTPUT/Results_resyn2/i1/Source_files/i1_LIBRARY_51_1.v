// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:30 2020
...
module FAU ( 
  ...
  nor2   g12(.a(new_n44_), .b(new_n53_), .O(z05));
  inv1   g13(.a(x18), .O(new_n55_));
  oai21  g14(.a(new_n43_), .b(x07), .c(x24), .O(new_n56_));
  ...
  nand2  g19(.a(new_n60_), .b(new_n58_), .O(z08));
  nor2   g20(.a(new_n56_), .b(new_n58_), .O(z09));
  inv1   g21(.a(x22), .O(new_n63_));
  inv1   g22(.a(x24), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(x14), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n63_), .c(new_n60_), .O(z10));
  nand3  g25(.a(new_n64_), .b(x22), .c(x17), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n44_), .O(z11));
  inv1   g27(.a(x23), .O(new_n69_));
  oai21  g28(.a(new_n65_), .b(new_n69_), .c(new_n60_), .O(z12));
  nand3  g29(.a(new_n64_), .b(x23), .c(x17), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n60_), .O(z13));
  inv1   g31(.a(x16), .O(new_n73_));
  oai21  g32(.a(x24), .b(new_n73_), .c(new_n60_), .O(z14));
  nor2   g33(.a(x13), .b(x12), .O(new_n75_));
  nor2   g34(.a(x15), .b(x14), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n75_), .c(new_n60_), .O(z15));
  buf    g36(.a(x19), .O(z06));
endmodule
