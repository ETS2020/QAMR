...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    ...
    new_n67_, new_n69_, new_n70_, new_n72_, new_n74_, new_n75_;
  ...
  aoi21  g20(.a(x19), .b(new_n43_), .c(new_n61_), .O(z09));
  nand4  g21(.a(new_n44_), .b(new_n57_), .c(x22), .d(x14), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z10));
  nand4  g23(.a(new_n44_), .b(new_n57_), .c(x22), .d(x17), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z11));
  nand3  g25(.a(new_n57_), .b(x23), .c(x14), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n44_), .O(z12));
  oai21  g27(.a(new_n48_), .b(x01), .c(new_n57_), .O(new_n69_));
  nand2  g28(.a(x23), .b(x17), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n69_), .O(z13));
  nand2  g30(.a(new_n57_), .b(x16), .O(new_n72_));
