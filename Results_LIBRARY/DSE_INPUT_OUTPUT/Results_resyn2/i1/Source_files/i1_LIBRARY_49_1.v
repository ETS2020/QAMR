...
module FAU ( 
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x11), .O(new_n60_));
  ...
  nand3  g26(.a(x19), .b(x11), .c(new_n57_), .O(new_n68_));
  ...
  oai21  g31(.a(new_n72_), .b(new_n43_), .c(new_n44_), .O(z09));
  nand2  g32(.a(new_n72_), .b(x22), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n64_), .O(new_n75_));
