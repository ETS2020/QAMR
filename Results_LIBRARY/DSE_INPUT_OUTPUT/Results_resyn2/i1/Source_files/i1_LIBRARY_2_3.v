...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n54_), .c(x06), .O(new_n66_));
  ...
  nand2  g29(.a(new_n70_), .b(new_n46_), .O(z04));
  ...
  aoi21  g41(.a(new_n46_), .b(new_n80_), .c(new_n82_), .O(z09));
  ...
  oai21  g49(.a(new_n90_), .b(x24), .c(new_n46_), .O(z13));
