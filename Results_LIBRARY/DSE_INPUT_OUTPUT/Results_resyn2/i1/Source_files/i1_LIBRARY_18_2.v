...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n71_, new_n74_, new_n77_, new_n80_, new_n83_,
    new_n85_, new_n86_;
  ...
  inv1   g09(.a(x24), .O(new_n51_));
  nand2  g10(.a(new_n51_), .b(x17), .O(new_n52_));
  ...
  oai21  g34(.a(new_n51_), .b(new_n74_), .c(new_n52_), .O(z09));
  nand4  g35(.a(new_n51_), .b(x22), .c(new_n43_), .d(x14), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand2  g37(.a(x23), .b(x14), .O(new_n80_));
  aoi21  g38(.a(new_n80_), .b(new_n43_), .c(x24), .O(z12));
  inv1   g39(.a(x16), .O(new_n83_));
  aoi21  g40(.a(new_n43_), .b(new_n83_), .c(x24), .O(z14));
  nor2   g41(.a(x13), .b(x12), .O(new_n85_));
  nor2   g42(.a(x15), .b(x14), .O(new_n86_));
  aoi21  g43(.a(new_n86_), .b(new_n85_), .c(new_n44_), .O(z15));
  zero   g44(.O(z11));
  zero   g45(.O(z13));
endmodule
