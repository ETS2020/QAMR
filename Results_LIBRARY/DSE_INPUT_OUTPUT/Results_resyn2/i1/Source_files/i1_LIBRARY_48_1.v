...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(new_n58_), .c(new_n51_), .O(z07));
  ...
  nand2  g24(.a(new_n59_), .b(x22), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n65_), .c(new_n51_), .O(z10));
  inv1   g26(.a(x17), .O(new_n68_));
  oai21  g27(.a(new_n66_), .b(new_n68_), .c(new_n51_), .O(z11));
  nand3  g28(.a(new_n59_), .b(x23), .c(x14), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n51_), .O(z12));
  oai21  g30(.a(new_n43_), .b(x06), .c(new_n59_), .O(new_n72_));
  nand2  g31(.a(x23), .b(x17), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z13));
  nand2  g33(.a(new_n59_), .b(x16), .O(new_n75_));
