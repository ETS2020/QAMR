...
module FAU ( 
  ...
  nand2  g10(.a(x19), .b(x16), .O(new_n52_));
  ...
  nand4  g27(.a(new_n68_), .b(new_n59_), .c(new_n48_), .d(new_n47_), .O(new_n69_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .O(z10));
  nand2  g40(.a(x22), .b(x17), .O(new_n82_));
  nor3   g41(.a(new_n82_), .b(new_n45_), .c(x24), .O(z11));
  nand2  g42(.a(new_n44_), .b(x23), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n80_), .O(z12));
  nand3  g44(.a(new_n77_), .b(x23), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z13));
  nor2   g46(.a(x24), .b(new_n43_), .O(z14));
