...
module FAU ( 
  ...
  nor3   g09(.a(x09), .b(x08), .c(x07), .O(new_n51_));
  ...
  nand4  g14(.a(new_n50_), .b(new_n55_), .c(new_n48_), .d(new_n54_), .O(new_n56_));
  nor2   g15(.a(new_n47_), .b(new_n42_), .O(new_n57_));
  oai21  g16(.a(new_n56_), .b(x07), .c(new_n57_), .O(new_n58_));
  ...
  nand3  g25(.a(new_n54_), .b(new_n66_), .c(new_n65_), .O(new_n67_));
  ...
  oai21  g30(.a(new_n71_), .b(new_n67_), .c(new_n43_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n48_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n64_), .O(z05));
  nand2  g33(.a(new_n45_), .b(new_n47_), .O(z06));
