...
module FAU ( 
  ...
  oai21  g33(.a(new_n74_), .b(new_n72_), .c(new_n60_), .O(z09));
  ...
  nor3   g40(.a(new_n81_), .b(new_n69_), .c(x24), .O(z12));
  nand3  g41(.a(new_n74_), .b(x23), .c(x17), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n60_), .O(z13));
