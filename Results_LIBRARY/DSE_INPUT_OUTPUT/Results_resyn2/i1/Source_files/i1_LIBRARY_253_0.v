...
module FAU ( 
  ...
  nor2   g01(.a(x24), .b(x23), .O(new_n43_));
  ...
  nor2   g33(.a(x24), .b(new_n74_), .O(new_n75_));
  aoi21  g34(.a(x24), .b(new_n73_), .c(new_n75_), .O(z07));
  ...
  aoi21  g41(.a(new_n82_), .b(x23), .c(x24), .O(z11));
  inv1   g42(.a(x14), .O(new_n84_));
  aoi21  g43(.a(x23), .b(new_n84_), .c(x24), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  aoi21  g45(.a(x23), .b(new_n86_), .c(x24), .O(z13));
  nand2  g46(.a(x23), .b(x16), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(x24), .O(z14));
