...
module FAU ( 
  ...
  nand2  g28(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  nor3   g34(.a(new_n67_), .b(new_n75_), .c(new_n73_), .O(z09));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n75_), .b(x22), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n67_), .c(new_n77_), .O(z10));
  ...
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n67_), .O(z15));
endmodule
