...
module FAU ( 
  ...
  nand2  g11(.a(x23), .b(new_n46_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n71_), .b(new_n73_), .c(new_n53_), .O(z09));
  ...
  nand2  g39(.a(new_n71_), .b(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x19), .c(new_n43_), .O(z12));
  nand4  g41(.a(new_n71_), .b(x23), .c(x19), .d(x17), .O(new_n83_));
