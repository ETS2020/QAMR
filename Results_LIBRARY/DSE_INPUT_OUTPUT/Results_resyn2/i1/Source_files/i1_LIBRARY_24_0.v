...
module FAU ( 
  ...
  nor2   g35(.a(new_n76_), .b(new_n43_), .O(z07));
  ...
  nand3  g45(.a(new_n80_), .b(x23), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z12));
  nand2  g47(.a(new_n44_), .b(new_n80_), .O(new_n89_));
  nand2  g48(.a(x23), .b(x17), .O(new_n90_));
  nor2   g49(.a(new_n90_), .b(new_n89_), .O(z13));
  inv1   g50(.a(x16), .O(new_n92_));
  nor2   g51(.a(new_n89_), .b(new_n92_), .O(z14));
