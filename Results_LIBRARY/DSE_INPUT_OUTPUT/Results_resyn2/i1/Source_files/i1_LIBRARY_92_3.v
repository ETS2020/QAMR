...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n70_, new_n72_, new_n74_, new_n75_, new_n77_, new_n79_, new_n82_,
    new_n84_, new_n85_;
  ...
  nor2   g27(.a(new_n68_), .b(new_n45_), .O(z07));
  inv1   g28(.a(x11), .O(new_n70_));
  nand2  g29(.a(new_n46_), .b(new_n70_), .O(z08));
  inv1   g30(.a(x24), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n70_), .c(new_n46_), .O(z09));
  inv1   g32(.a(x14), .O(new_n74_));
  nand2  g33(.a(new_n72_), .b(x22), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n46_), .O(z10));
  inv1   g35(.a(x17), .O(new_n77_));
  oai21  g36(.a(new_n75_), .b(new_n77_), .c(new_n46_), .O(z11));
  nand2  g37(.a(new_n72_), .b(x23), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n74_), .c(new_n46_), .O(z12));
  oai21  g39(.a(new_n79_), .b(new_n77_), .c(new_n46_), .O(z13));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n45_), .O(z15));
  buf    g45(.a(x19), .O(z06));
endmodule
