...
module FAU ( 
  ...
  nor3   g30(.a(new_n66_), .b(new_n71_), .c(new_n69_), .O(z09));
  ...
  nand2  g37(.a(new_n78_), .b(new_n44_), .O(z12));
  nand3  g38(.a(new_n71_), .b(x23), .c(x17), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n66_), .O(z13));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n66_), .O(z15));
endmodule
