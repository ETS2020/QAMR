...
module FAU ( 
  ...
  nand2  g16(.a(new_n52_), .b(x00), .O(new_n58_));
  nor3   g17(.a(x07), .b(x06), .c(x05), .O(new_n59_));
  inv1   g18(.a(x08), .O(new_n60_));
  nor2   g19(.a(x09), .b(new_n60_), .O(new_n61_));
  nand4  g20(.a(new_n61_), .b(new_n51_), .c(new_n50_), .d(new_n59_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(new_n58_), .c(new_n43_), .O(new_n63_));
  ...
  nand3  g27(.a(new_n53_), .b(x19), .c(new_n60_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n45_), .O(z05));
  nand2  g29(.a(x24), .b(x18), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n46_), .O(z07));
  ...
  nand4  g40(.a(new_n46_), .b(new_n75_), .c(x23), .d(x14), .O(new_n82_));
  ...
  nand4  g48(.a(new_n89_), .b(new_n77_), .c(new_n43_), .d(new_n88_), .O(z15));
  buf    g49(.a(x19), .O(z06));
endmodule
