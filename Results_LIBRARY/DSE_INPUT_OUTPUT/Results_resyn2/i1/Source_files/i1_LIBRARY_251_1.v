...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(new_n51_), .O(z06));
  ...
  nand4  g15(.a(new_n56_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n57_));
  inv1   g16(.a(x07), .O(new_n58_));
  nor2   g17(.a(x06), .b(x05), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(new_n47_), .c(new_n46_), .d(new_n58_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(new_n42_), .O(new_n61_));
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(z06), .O(new_n62_));
  ...
  nand4  g28(.a(new_n69_), .b(new_n59_), .c(new_n47_), .d(new_n46_), .O(new_n70_));
  ...
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(z07));
  ...
  nor3   g41(.a(new_n82_), .b(new_n44_), .c(new_n81_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n74_), .O(z11));
  nand2  g44(.a(new_n79_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n81_), .c(new_n74_), .O(z12));
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n74_), .O(z13));
  nand2  g47(.a(new_n79_), .b(x16), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n74_), .O(z14));
  nor3   g49(.a(x15), .b(x14), .c(x13), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(x19), .c(new_n51_), .O(z15));
endmodule
