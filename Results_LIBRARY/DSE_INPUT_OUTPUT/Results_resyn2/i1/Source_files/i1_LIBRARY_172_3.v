...
module FAU ( 
  ...
  aoi21  g36(.a(new_n43_), .b(new_n76_), .c(new_n44_), .O(z09));
  nand3  g37(.a(new_n44_), .b(x22), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n48_), .O(z10));
  ...
  nor2   g45(.a(x24), .b(new_n43_), .O(z14));
  nor2   g46(.a(x13), .b(x12), .O(new_n88_));
  nor2   g47(.a(x15), .b(x14), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(z15));
endmodule
