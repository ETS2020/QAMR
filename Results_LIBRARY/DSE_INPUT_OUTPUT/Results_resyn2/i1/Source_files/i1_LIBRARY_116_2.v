...
module FAU ( 
  ...
  nand2  g20(.a(new_n61_), .b(new_n53_), .O(z02));
  inv1   g21(.a(x20), .O(new_n63_));
  nand2  g22(.a(new_n53_), .b(new_n63_), .O(z03));
  ...
  nand2  g29(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z10));
  nand3  g39(.a(new_n76_), .b(x22), .c(x17), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n44_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  nor3   g42(.a(new_n79_), .b(new_n44_), .c(new_n83_), .O(z12));
  nand3  g43(.a(new_n76_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n53_), .O(z13));
  nand2  g45(.a(new_n76_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n53_), .O(z14));
