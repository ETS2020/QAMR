// Benchmark "FAU" written by ABC on Tue Aug 11 19:28:18 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_,
    new_n91_, new_n92_;
  ...
  nor2   g19(.a(new_n43_), .b(new_n51_), .O(new_n61_));
  ...
  nand4  g29(.a(new_n70_), .b(new_n58_), .c(new_n47_), .d(new_n46_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x17), .O(new_n72_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n65_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n44_), .b(new_n78_), .O(z08));
  nor3   g38(.a(new_n44_), .b(new_n76_), .c(new_n78_), .O(z09));
  nand4  g39(.a(new_n65_), .b(new_n76_), .c(x22), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  nand2  g41(.a(x22), .b(x17), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x24), .O(z11));
  nand4  g43(.a(new_n65_), .b(new_n76_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand3  g45(.a(new_n76_), .b(x23), .c(x17), .O(new_n87_));
  ...
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n65_), .O(z15));
  buf    g52(.a(x19), .O(z06));
endmodule
