...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n52_), .O(z11));
  nand2  g40(.a(new_n75_), .b(x23), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n77_), .c(new_n52_), .O(z12));
  oai21  g42(.a(new_n82_), .b(new_n80_), .c(new_n52_), .O(z13));
  ...
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n52_), .O(z15));
endmodule
