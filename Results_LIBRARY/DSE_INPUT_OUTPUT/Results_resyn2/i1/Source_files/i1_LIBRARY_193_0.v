...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n85_, new_n88_, new_n89_;
  ...
  nand2  g28(.a(new_n69_), .b(x12), .O(z06));
  ...
  nor2   g35(.a(new_n43_), .b(x24), .O(new_n77_));
  ...
  inv1   g42(.a(new_n77_), .O(new_n84_));
  ...
  oai21  g48(.a(new_n89_), .b(new_n69_), .c(new_n88_), .O(z15));
endmodule
