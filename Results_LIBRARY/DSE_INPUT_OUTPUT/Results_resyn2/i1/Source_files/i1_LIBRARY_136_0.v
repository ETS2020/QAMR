...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n54_), .O(z04));
  ...
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(new_n54_), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nand2  g31(.a(new_n54_), .b(new_n72_), .O(z08));
  oai21  g32(.a(new_n70_), .b(new_n72_), .c(new_n54_), .O(z09));
