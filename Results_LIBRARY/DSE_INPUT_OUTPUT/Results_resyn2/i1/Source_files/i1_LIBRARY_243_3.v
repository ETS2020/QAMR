...
module FAU ( 
  ...
  nor2   g10(.a(x03), .b(new_n42_), .O(new_n52_));
  ...
  nor2   g14(.a(new_n46_), .b(x03), .O(z06));
  ...
  nand4  g37(.a(new_n43_), .b(new_n78_), .c(x22), .d(x14), .O(new_n79_));
  ...
  nand4  g43(.a(new_n43_), .b(new_n78_), .c(x23), .d(x17), .O(new_n85_));
