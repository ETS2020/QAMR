...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(new_n46_), .O(z02));
  ...
  oai21  g27(.a(new_n66_), .b(new_n55_), .c(new_n68_), .O(z05));
  nand2  g28(.a(new_n46_), .b(new_n45_), .O(z06));
  and2   g29(.a(x24), .b(x18), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  nor2   g31(.a(new_n43_), .b(new_n72_), .O(z08));
  oai21  g32(.a(new_n67_), .b(new_n72_), .c(new_n46_), .O(z09));
  nand4  g33(.a(new_n67_), .b(x22), .c(x14), .d(x10), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand2  g35(.a(x22), .b(x17), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x10), .c(x24), .O(z11));
  nand4  g37(.a(new_n67_), .b(x23), .c(x14), .d(x10), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z12));
  nand4  g39(.a(new_n67_), .b(x23), .c(x17), .d(x10), .O(new_n81_));
  ...
  nand3  g45(.a(new_n86_), .b(new_n85_), .c(new_n46_), .O(z15));
endmodule
