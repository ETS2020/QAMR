...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n78_, new_n80_, new_n82_, new_n84_, new_n86_, new_n89_, new_n90_;
  ...
  nand3  g25(.a(new_n51_), .b(new_n64_), .c(new_n43_), .O(z04));
  inv1   g26(.a(x10), .O(new_n68_));
  nor2   g27(.a(x08), .b(x07), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n58_), .c(new_n47_), .d(new_n46_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x21), .O(new_n71_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n76_), .c(new_n78_), .O(z09));
