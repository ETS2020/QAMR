...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n73_, new_n76_, new_n77_, new_n79_, new_n81_,
  ...
  nand2  g04(.a(new_n44_), .b(new_n43_), .O(new_n46_));
  ...
  nand2  g24(.a(new_n46_), .b(x10), .O(new_n66_));
  inv1   g25(.a(x08), .O(new_n67_));
  nand2  g26(.a(x19), .b(new_n67_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n51_), .c(new_n66_), .O(z05));
  nand2  g28(.a(new_n44_), .b(x18), .O(z06));
  inv1   g29(.a(x24), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n43_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n46_), .b(new_n73_), .O(z08));
  oai21  g33(.a(new_n71_), .b(new_n73_), .c(new_n46_), .O(z09));
  inv1   g34(.a(x14), .O(new_n76_));
  nand2  g35(.a(new_n71_), .b(x22), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n46_), .O(z10));
  inv1   g37(.a(x17), .O(new_n79_));
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n46_), .O(z11));
  inv1   g39(.a(x23), .O(new_n81_));
  nand2  g40(.a(new_n46_), .b(new_n71_), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  ...
  nor2   g47(.a(new_n82_), .b(new_n88_), .O(z14));
