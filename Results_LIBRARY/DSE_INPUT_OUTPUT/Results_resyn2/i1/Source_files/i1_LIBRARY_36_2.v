...
module FAU ( 
  ...
  nor2   g02(.a(x13), .b(new_n43_), .O(new_n44_));
  ...
  nand3  g13(.a(new_n54_), .b(new_n53_), .c(new_n43_), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n48_), .c(new_n46_), .O(z01));
  oai21  g15(.a(new_n46_), .b(new_n42_), .c(x13), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x05), .O(new_n58_));
  inv1   g17(.a(x08), .O(new_n59_));
  nor2   g18(.a(x09), .b(new_n59_), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(new_n43_), .c(new_n52_), .O(new_n61_));
  ...
  nand2  g27(.a(new_n53_), .b(new_n43_), .O(new_n69_));
  nand2  g28(.a(new_n47_), .b(x10), .O(new_n70_));
  nand2  g29(.a(x19), .b(new_n59_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n69_), .c(new_n70_), .O(z05));
  nand2  g31(.a(new_n47_), .b(new_n46_), .O(z06));
  inv1   g32(.a(x18), .O(new_n74_));
  nand2  g33(.a(new_n47_), .b(x24), .O(new_n75_));
  ...
  nand2  g39(.a(new_n47_), .b(new_n80_), .O(new_n81_));
  nand2  g40(.a(x22), .b(x14), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n81_), .O(z10));
  inv1   g42(.a(x22), .O(new_n84_));
  nand2  g43(.a(new_n80_), .b(x17), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n47_), .O(z11));
  nand3  g45(.a(new_n80_), .b(x23), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n47_), .O(z12));
  inv1   g47(.a(x23), .O(new_n89_));
  nor3   g48(.a(new_n85_), .b(new_n44_), .c(new_n89_), .O(z13));
  ...
  oai21  g53(.a(new_n94_), .b(x05), .c(new_n93_), .O(z15));
endmodule
