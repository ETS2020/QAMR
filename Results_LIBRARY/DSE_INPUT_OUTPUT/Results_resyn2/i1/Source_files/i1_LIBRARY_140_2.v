...
module FAU ( 
  ...
  nand3  g12(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(x00), .c(new_n47_), .O(z01));
  oai21  g14(.a(new_n47_), .b(x00), .c(x07), .O(new_n56_));
  inv1   g15(.a(x08), .O(new_n57_));
  nor2   g16(.a(x09), .b(new_n57_), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n43_), .c(new_n51_), .O(new_n59_));
  nand2  g18(.a(new_n51_), .b(new_n42_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x19), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(new_n56_), .O(z02));
  ...
  nand2  g25(.a(new_n52_), .b(new_n43_), .O(new_n67_));
  nand2  g26(.a(x19), .b(new_n57_), .O(new_n68_));
  nor2   g27(.a(new_n44_), .b(x10), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(z05));
  ...
  nor3   g38(.a(new_n79_), .b(new_n44_), .c(new_n78_), .O(z10));
