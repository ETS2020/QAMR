...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n60_, new_n62_, new_n65_, new_n66_, new_n68_,
  ...
  nand3  g24(.a(x19), .b(new_n45_), .c(new_n57_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n51_), .c(new_n65_), .O(z05));
