...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n62_, new_n64_, new_n65_, new_n68_, new_n70_,
    new_n72_, new_n74_, new_n75_, new_n77_, new_n79_, new_n81_, new_n83_,
    new_n85_, new_n86_;
  ...
  nand4  g23(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(x19), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z05));
  nor2   g25(.a(new_n46_), .b(x08), .O(z06));
  ...
  oai21  g31(.a(new_n72_), .b(new_n70_), .c(new_n43_), .O(z09));
  ...
  nand4  g39(.a(new_n43_), .b(new_n72_), .c(x23), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  nand3  g41(.a(new_n43_), .b(new_n72_), .c(x16), .O(new_n83_));
