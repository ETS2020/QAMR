...
module FAU ( 
  ...
  nand4  g27(.a(new_n50_), .b(new_n49_), .c(new_n57_), .d(new_n68_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n43_), .c(new_n67_), .O(z05));
  ...
  oai21  g34(.a(new_n72_), .b(new_n74_), .c(new_n45_), .O(z09));
