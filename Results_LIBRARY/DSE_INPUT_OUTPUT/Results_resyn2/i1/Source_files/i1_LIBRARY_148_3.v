...
module FAU ( 
  ...
  nor2   g10(.a(new_n51_), .b(x16), .O(z06));
  ...
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(z10));
  nand4  g40(.a(new_n43_), .b(new_n78_), .c(x22), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z11));
  nand4  g42(.a(new_n43_), .b(new_n78_), .c(x23), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z12));
  nand2  g44(.a(x23), .b(x17), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(x24), .c(new_n43_), .O(z13));
  nand3  g46(.a(new_n78_), .b(new_n51_), .c(x16), .O(new_n88_));
