...
module FAU ( 
  ...
  oai21  g17(.a(new_n58_), .b(new_n57_), .c(new_n52_), .O(z07));
  oai21  g18(.a(new_n43_), .b(x06), .c(x11), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z08));
  nor2   g20(.a(new_n60_), .b(new_n58_), .O(z09));
  oai21  g21(.a(new_n43_), .b(x06), .c(new_n58_), .O(new_n63_));
  nand2  g22(.a(x22), .b(x14), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n63_), .O(z10));
  inv1   g24(.a(x22), .O(new_n66_));
  nand2  g25(.a(new_n58_), .b(x17), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n66_), .c(new_n52_), .O(z11));
  nand3  g27(.a(new_n58_), .b(x23), .c(x14), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n52_), .O(z12));
  oai21  g29(.a(new_n43_), .b(x06), .c(x23), .O(new_n71_));
  ...
  nand3  g35(.a(new_n76_), .b(new_n75_), .c(new_n52_), .O(z15));
  buf    g36(.a(x19), .O(z06));
endmodule
