...
module FAU ( 
  ...
  nand2  g23(.a(new_n57_), .b(x07), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n64_), .O(z03));
  or2    g25(.a(z03), .b(x21), .O(z04));
  nand2  g26(.a(new_n65_), .b(x10), .O(new_n68_));
  nand3  g27(.a(x19), .b(new_n52_), .c(new_n43_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n49_), .c(new_n68_), .O(z05));
  ...
  oai21  g34(.a(new_n72_), .b(new_n74_), .c(new_n65_), .O(z09));
  ...
  nand2  g40(.a(new_n65_), .b(x23), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n78_), .O(z12));
