...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n71_, new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n84_,
    new_n85_;
  ...
  nor2   g25(.a(new_n45_), .b(x08), .O(z06));
  inv1   g26(.a(x18), .O(new_n68_));
  inv1   g27(.a(x24), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(new_n43_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nand2  g30(.a(new_n43_), .b(new_n71_), .O(z08));
  nor3   g31(.a(new_n60_), .b(new_n69_), .c(new_n71_), .O(z09));
  nand4  g32(.a(new_n43_), .b(new_n69_), .c(x22), .d(x14), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z10));
  nand4  g34(.a(new_n43_), .b(new_n69_), .c(x22), .d(x17), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z11));
  nand2  g36(.a(x23), .b(x14), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(x24), .c(new_n43_), .O(z12));
  nand4  g38(.a(new_n43_), .b(new_n69_), .c(x23), .d(x17), .O(new_n80_));
