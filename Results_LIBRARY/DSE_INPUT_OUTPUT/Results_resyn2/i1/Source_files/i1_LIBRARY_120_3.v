...
module FAU ( 
  ...
  nand3  g23(.a(new_n43_), .b(new_n64_), .c(new_n61_), .O(z04));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(z10));
  nand4  g36(.a(new_n43_), .b(new_n70_), .c(x22), .d(x17), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z11));
  nand2  g38(.a(new_n70_), .b(x23), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n75_), .c(new_n45_), .O(z12));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n43_), .O(z13));
  nand3  g42(.a(new_n43_), .b(new_n70_), .c(x16), .O(new_n84_));
