...
module FAU ( 
  ...
  nor3   g13(.a(x04), .b(x02), .c(x01), .O(new_n55_));
  ...
  nand2  g32(.a(new_n45_), .b(x24), .O(new_n74_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n45_), .O(z10));
  ...
  nor3   g46(.a(new_n81_), .b(new_n44_), .c(new_n87_), .O(z12));
