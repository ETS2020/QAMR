...
module FAU ( 
  ...
  nor2   g18(.a(new_n43_), .b(x00), .O(new_n60_));
  ...
  nand3  g25(.a(x19), .b(new_n50_), .c(new_n66_), .O(new_n67_));
  oai22  g26(.a(new_n67_), .b(new_n56_), .c(new_n60_), .d(new_n65_), .O(z05));
  ...
  nor3   g32(.a(new_n60_), .b(new_n70_), .c(new_n72_), .O(z09));
  nand2  g33(.a(new_n62_), .b(new_n70_), .O(new_n75_));
