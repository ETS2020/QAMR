...
module FAU ( 
  ...
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n46_), .O(z09));
  nor2   g40(.a(new_n45_), .b(x24), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x22), .c(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  inv1   g43(.a(x22), .O(new_n85_));
  nand2  g44(.a(new_n80_), .b(x17), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n46_), .O(z11));
  nand3  g46(.a(new_n82_), .b(x23), .c(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  inv1   g48(.a(x23), .O(new_n90_));
  oai21  g49(.a(new_n86_), .b(new_n90_), .c(new_n46_), .O(z13));
