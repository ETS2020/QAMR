...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n72_, new_n73_, new_n76_, new_n78_, new_n80_,
  ...
  nor2   g12(.a(x14), .b(new_n42_), .O(new_n54_));
  ...
  nor2   g27(.a(new_n46_), .b(x14), .O(z06));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n46_), .c(new_n56_), .O(z10));
  nand4  g38(.a(new_n43_), .b(new_n73_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  nand4  g40(.a(new_n73_), .b(x23), .c(new_n46_), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand3  g42(.a(new_n73_), .b(x23), .c(x17), .O(new_n84_));
