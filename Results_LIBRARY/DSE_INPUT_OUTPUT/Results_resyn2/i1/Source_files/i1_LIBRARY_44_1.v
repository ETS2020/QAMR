...
module FAU ( 
  ...
  nor2   g16(.a(new_n55_), .b(new_n43_), .O(z06));
  nand2  g17(.a(x24), .b(x18), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n56_), .O(z07));
  ...
  nand4  g23(.a(new_n44_), .b(new_n63_), .c(x22), .d(x14), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z10));
  nand4  g25(.a(new_n44_), .b(new_n63_), .c(x22), .d(x17), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z11));
  oai21  g27(.a(new_n55_), .b(x04), .c(new_n63_), .O(new_n69_));
  nand2  g28(.a(x23), .b(x14), .O(new_n70_));
  ...
  nor2   g33(.a(new_n69_), .b(new_n74_), .O(z14));
  nor2   g34(.a(x13), .b(x12), .O(new_n76_));
  nor2   g35(.a(x15), .b(x14), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n56_), .O(z15));
endmodule
