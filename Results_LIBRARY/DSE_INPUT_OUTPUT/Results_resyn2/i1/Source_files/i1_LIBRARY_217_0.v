...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n80_, new_n81_, new_n83_, new_n86_,
  ...
  nand2  g36(.a(new_n45_), .b(x02), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(x24), .O(new_n80_));
  inv1   g39(.a(new_n43_), .O(new_n81_));
  oai21  g40(.a(new_n80_), .b(new_n79_), .c(new_n81_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n81_), .b(new_n83_), .O(z08));
  oai21  g43(.a(new_n80_), .b(new_n83_), .c(new_n81_), .O(z09));
  inv1   g44(.a(x22), .O(new_n86_));
  nand2  g45(.a(new_n80_), .b(x14), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n81_), .O(z10));
  ...
  nor3   g51(.a(new_n87_), .b(new_n43_), .c(new_n92_), .O(z12));
