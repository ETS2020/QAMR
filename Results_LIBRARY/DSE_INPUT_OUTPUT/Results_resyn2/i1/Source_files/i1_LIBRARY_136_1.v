...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n62_, new_n63_, new_n65_, new_n68_, new_n69_,
  ...
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(new_n62_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nand2  g30(.a(new_n62_), .b(new_n71_), .O(z08));
  oai21  g31(.a(new_n69_), .b(new_n71_), .c(new_n62_), .O(z09));
  inv1   g32(.a(x14), .O(new_n74_));
  nand2  g33(.a(new_n69_), .b(x22), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n62_), .O(z10));
  inv1   g35(.a(x17), .O(new_n77_));
  oai21  g36(.a(new_n75_), .b(new_n77_), .c(new_n62_), .O(z11));
  nand3  g37(.a(new_n69_), .b(x23), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n62_), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n44_), .c(x24), .O(z13));
  nand2  g41(.a(new_n69_), .b(x16), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n62_), .O(z14));
