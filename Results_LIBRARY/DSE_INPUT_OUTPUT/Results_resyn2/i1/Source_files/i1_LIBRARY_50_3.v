...
module FAU ( 
  ...
  nor2   g11(.a(x20), .b(new_n43_), .O(z06));
  ...
  nand4  g19(.a(new_n60_), .b(new_n49_), .c(new_n48_), .d(new_n59_), .O(new_n61_));
  ...
  nand4  g27(.a(new_n68_), .b(new_n60_), .c(new_n49_), .d(new_n48_), .O(new_n69_));
  ...
  nand4  g42(.a(new_n46_), .b(new_n77_), .c(x23), .d(x14), .O(new_n84_));
