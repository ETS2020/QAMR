...
module FAU ( 
  ...
  oai21  g19(.a(new_n46_), .b(x04), .c(x11), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(z08));
  nor2   g21(.a(new_n61_), .b(new_n59_), .O(z09));
  inv1   g22(.a(x22), .O(new_n64_));
  nand2  g23(.a(new_n59_), .b(x14), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z10));
  oai21  g25(.a(new_n46_), .b(x04), .c(new_n59_), .O(new_n67_));
  nand2  g26(.a(x22), .b(x17), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n67_), .O(z11));
  oai21  g28(.a(new_n46_), .b(x04), .c(x23), .O(new_n70_));
