...
module FAU ( 
  ...
  nand2  g25(.a(x19), .b(new_n57_), .O(new_n67_));
  nor2   g26(.a(new_n64_), .b(x10), .O(new_n68_));
  oai21  g27(.a(new_n67_), .b(new_n50_), .c(new_n68_), .O(z05));
  nor2   g28(.a(new_n64_), .b(new_n55_), .O(z06));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n64_), .O(z15));
endmodule
