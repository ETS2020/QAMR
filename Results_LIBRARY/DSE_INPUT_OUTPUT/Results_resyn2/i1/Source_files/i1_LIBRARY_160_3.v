...
module FAU ( 
  ...
  nor2   g10(.a(new_n51_), .b(x09), .O(new_n52_));
  ...
  nand3  g17(.a(new_n58_), .b(new_n52_), .c(new_n50_), .O(new_n59_));
  ...
  nand4  g35(.a(new_n43_), .b(new_n74_), .c(x22), .d(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  inv1   g37(.a(x23), .O(new_n79_));
  oai21  g38(.a(new_n75_), .b(new_n79_), .c(new_n43_), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(x24), .c(new_n43_), .O(z13));
  nand3  g41(.a(new_n43_), .b(new_n74_), .c(x16), .O(new_n83_));
