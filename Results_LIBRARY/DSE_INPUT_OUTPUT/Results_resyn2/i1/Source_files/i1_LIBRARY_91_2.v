...
module FAU ( 
  ...
  nand2  g24(.a(new_n57_), .b(x07), .O(new_n66_));
  nor2   g25(.a(x21), .b(x20), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n66_), .O(z04));
  nand2  g27(.a(new_n66_), .b(x10), .O(new_n69_));
  nand3  g28(.a(x19), .b(new_n52_), .c(new_n43_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n49_), .c(new_n69_), .O(z05));
  ...
  nand2  g34(.a(new_n66_), .b(new_n75_), .O(z08));
  nor3   g35(.a(new_n44_), .b(new_n73_), .c(new_n75_), .O(z09));
  nand2  g36(.a(x22), .b(x14), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n44_), .c(x24), .O(z10));
  inv1   g38(.a(x22), .O(new_n80_));
  nand2  g39(.a(new_n73_), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n66_), .O(z11));
  nand3  g41(.a(new_n73_), .b(x23), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n66_), .O(z12));
  nand2  g43(.a(new_n66_), .b(x23), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n81_), .O(z13));
