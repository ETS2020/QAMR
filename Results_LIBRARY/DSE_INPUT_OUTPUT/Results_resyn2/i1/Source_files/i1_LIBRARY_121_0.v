...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x10), .O(new_n43_));
  ...
  nor2   g07(.a(x06), .b(x03), .O(new_n49_));
  ...
  nand2  g13(.a(new_n50_), .b(x00), .O(new_n55_));
  nor3   g14(.a(x07), .b(x06), .c(x03), .O(new_n56_));
  inv1   g15(.a(x08), .O(new_n57_));
  nor2   g16(.a(x09), .b(new_n57_), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n55_), .O(new_n60_));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n63_), .c(new_n43_), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  nand3  g26(.a(x19), .b(x12), .c(new_n57_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n50_), .c(new_n67_), .O(z05));
  inv1   g28(.a(x19), .O(new_n70_));
  nor2   g29(.a(new_n43_), .b(new_n70_), .O(z06));
  ...
  nand2  g34(.a(new_n45_), .b(new_n75_), .O(z08));
  oai21  g35(.a(new_n73_), .b(new_n75_), .c(new_n45_), .O(z09));
  ...
  nor2   g48(.a(x12), .b(new_n67_), .O(new_n90_));
