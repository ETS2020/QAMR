...
module FAU ( 
  ...
  inv1   g09(.a(x23), .O(new_n51_));
  nand2  g10(.a(new_n51_), .b(x16), .O(new_n52_));
  ...
  nand4  g37(.a(new_n52_), .b(new_n77_), .c(x22), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand4  g39(.a(new_n52_), .b(new_n77_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand3  g41(.a(new_n77_), .b(x23), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n52_), .O(z12));
  nand2  g43(.a(x23), .b(x17), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(x24), .O(z13));
  nor3   g45(.a(x24), .b(new_n51_), .c(new_n43_), .O(z14));
