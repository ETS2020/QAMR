...
module FAU ( 
  ...
  aoi21  g33(.a(x19), .b(new_n73_), .c(new_n43_), .O(z09));
  inv1   g34(.a(x22), .O(new_n76_));
  nand2  g35(.a(new_n43_), .b(x14), .O(new_n77_));
  ...
  oai21  g40(.a(new_n77_), .b(new_n81_), .c(new_n45_), .O(z12));
  nor3   g41(.a(x24), .b(new_n81_), .c(new_n79_), .O(z13));
  nand2  g42(.a(new_n43_), .b(x16), .O(new_n84_));
