...
module FAU ( 
  ...
  nor2   g09(.a(new_n50_), .b(x11), .O(z06));
  ...
  aoi21  g30(.a(x19), .b(x11), .c(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  inv1   g32(.a(x24), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n50_), .c(new_n73_), .O(z09));
  nand3  g34(.a(new_n74_), .b(x22), .c(x14), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n43_), .O(z10));
  nand3  g36(.a(new_n43_), .b(new_n74_), .c(x17), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x22), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  nand4  g40(.a(new_n43_), .b(new_n74_), .c(x23), .d(x14), .O(new_n82_));
