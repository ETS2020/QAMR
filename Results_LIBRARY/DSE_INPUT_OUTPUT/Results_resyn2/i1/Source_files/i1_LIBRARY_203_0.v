...
module FAU ( 
  ...
  oai21  g12(.a(new_n52_), .b(new_n42_), .c(z06), .O(new_n54_));
  oai21  g13(.a(new_n51_), .b(new_n46_), .c(new_n54_), .O(z01));
  ...
  nand3  g18(.a(new_n59_), .b(new_n51_), .c(x19), .O(new_n60_));
  ...
  nand4  g27(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n68_), .O(new_n69_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n63_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n63_), .O(z13));
  nand2  g46(.a(new_n75_), .b(x16), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n63_), .O(z14));
