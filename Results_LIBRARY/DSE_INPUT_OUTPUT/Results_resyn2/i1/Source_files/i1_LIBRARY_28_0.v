...
module FAU ( 
  ...
  oai21  g35(.a(new_n73_), .b(new_n75_), .c(new_n44_), .O(z09));
  ...
  nand2  g42(.a(new_n44_), .b(new_n73_), .O(new_n84_));
  nor3   g43(.a(new_n84_), .b(new_n83_), .c(new_n78_), .O(z12));
  oai21  g44(.a(new_n81_), .b(new_n83_), .c(new_n44_), .O(z13));
