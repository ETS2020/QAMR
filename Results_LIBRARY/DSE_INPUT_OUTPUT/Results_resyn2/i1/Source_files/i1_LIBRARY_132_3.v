...
module FAU ( 
  ...
  nor2   g11(.a(x10), .b(new_n42_), .O(new_n53_));
  ...
  nor2   g20(.a(new_n44_), .b(x10), .O(new_n62_));
  ...
  nand2  g26(.a(new_n67_), .b(new_n46_), .O(z04));
  inv1   g27(.a(x08), .O(new_n69_));
  nand2  g28(.a(x19), .b(new_n69_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n60_), .c(new_n43_), .O(z05));
  ...
  oai21  g42(.a(new_n83_), .b(new_n78_), .c(new_n46_), .O(z12));
  oai21  g43(.a(new_n83_), .b(new_n81_), .c(new_n46_), .O(z13));
  nand3  g44(.a(new_n46_), .b(new_n76_), .c(x16), .O(new_n86_));
