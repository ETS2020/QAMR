...
module FAU ( 
  ...
  aoi21  g32(.a(x22), .b(new_n73_), .c(new_n43_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n44_), .b(new_n75_), .O(z08));
  nand3  g35(.a(x24), .b(x22), .c(x11), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z09));
  nand2  g37(.a(x22), .b(x14), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x24), .O(z10));
  nand3  g39(.a(new_n43_), .b(x22), .c(x17), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n47_), .O(z11));
  nand2  g41(.a(x23), .b(x14), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x24), .O(z12));
  nand3  g43(.a(new_n43_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n47_), .O(z13));
  ...
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n47_), .O(z15));
endmodule
