...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n71_, new_n73_, new_n74_, new_n76_, new_n79_,
  ...
  nor2   g11(.a(x07), .b(new_n42_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n52_), .c(new_n44_), .O(z01));
  nand3  g13(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n42_), .O(new_n56_));
  nor2   g15(.a(new_n44_), .b(x07), .O(z06));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n63_), .c(new_n45_), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  inv1   g26(.a(x08), .O(new_n68_));
  nand4  g27(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n68_), .O(new_n69_));
  ...
  nand3  g43(.a(new_n84_), .b(x23), .c(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand3  g45(.a(new_n84_), .b(x23), .c(x17), .O(new_n87_));
  ...
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(new_n46_), .O(z15));
endmodule
