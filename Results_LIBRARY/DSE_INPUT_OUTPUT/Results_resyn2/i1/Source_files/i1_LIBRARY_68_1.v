...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    ...
    new_n66_, new_n68_, new_n69_, new_n72_, new_n74_, new_n75_;
  ...
  oai21  g27(.a(new_n48_), .b(x05), .c(x14), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n68_), .O(z12));
  oai21  g29(.a(new_n68_), .b(new_n66_), .c(new_n44_), .O(z13));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(z15));
  buf    g35(.a(x19), .O(z06));
endmodule
