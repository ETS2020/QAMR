...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n63_, new_n65_, new_n66_, new_n68_, new_n71_,
  ...
  oai21  g28(.a(new_n66_), .b(new_n68_), .c(new_n44_), .O(z09));
  inv1   g29(.a(x22), .O(new_n71_));
  nand2  g30(.a(new_n66_), .b(x14), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(new_n44_), .O(z10));
  nand2  g32(.a(x22), .b(x17), .O(new_n74_));
  nor3   g33(.a(new_n74_), .b(new_n45_), .c(x24), .O(z11));
  nand2  g34(.a(new_n44_), .b(x23), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n72_), .O(z12));
  nand3  g36(.a(new_n66_), .b(x23), .c(x17), .O(new_n78_));
  ...
  nand3  g42(.a(new_n83_), .b(new_n82_), .c(new_n44_), .O(z15));
  buf    g43(.a(x19), .O(z06));
endmodule
