...
module FAU ( 
  ...
  nand2  g31(.a(new_n72_), .b(new_n46_), .O(z07));
  ...
  nand4  g36(.a(new_n76_), .b(x22), .c(x14), .d(new_n43_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand4  g38(.a(new_n76_), .b(x22), .c(x17), .d(new_n43_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  nand2  g40(.a(x23), .b(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n43_), .c(x24), .O(z12));
  nand2  g42(.a(x23), .b(x17), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n43_), .c(x24), .O(z13));
  inv1   g44(.a(x16), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n43_), .c(x24), .O(z14));
