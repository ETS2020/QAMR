...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    new_n54_, new_n56_, new_n57_, new_n59_, new_n60_, new_n63_, new_n65_,
  ...
  oai21  g18(.a(new_n59_), .b(x01), .c(x11), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z08));
  nor2   g20(.a(new_n60_), .b(new_n57_), .O(z09));
  nand4  g21(.a(new_n44_), .b(new_n57_), .c(x22), .d(x14), .O(new_n63_));
  ...
  nand4  g26(.a(new_n44_), .b(new_n57_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  oai21  g28(.a(new_n59_), .b(x01), .c(x23), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n66_), .O(z13));
  inv1   g30(.a(x16), .O(new_n72_));
  oai21  g31(.a(new_n59_), .b(x01), .c(new_n57_), .O(new_n73_));
