...
module FAU ( 
  ...
  nand2  g29(.a(new_n70_), .b(new_n69_), .O(z07));
  ...
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n69_), .O(z11));
  nand2  g39(.a(new_n74_), .b(x23), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n76_), .c(new_n69_), .O(z12));
  oai21  g41(.a(new_n81_), .b(new_n79_), .c(new_n69_), .O(z13));
  nand2  g42(.a(new_n74_), .b(x16), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n69_), .O(z14));
  inv1   g44(.a(x12), .O(new_n86_));
  nor3   g45(.a(x15), .b(x14), .c(x13), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n45_), .c(new_n86_), .O(z15));
  buf    g47(.a(x19), .O(z06));
endmodule
