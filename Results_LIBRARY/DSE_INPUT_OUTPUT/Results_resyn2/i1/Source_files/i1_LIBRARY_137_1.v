...
module FAU ( 
  ...
  aoi21  g33(.a(new_n74_), .b(x15), .c(new_n54_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n44_), .b(new_n76_), .O(z08));
  nand3  g36(.a(x24), .b(x15), .c(x11), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z09));
  nand3  g38(.a(new_n54_), .b(x22), .c(x14), .O(new_n80_));
