...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(new_n51_), .c(x19), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(new_n43_), .O(new_n54_));
  nand2  g13(.a(x19), .b(new_n42_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n54_), .O(z01));
  inv1   g15(.a(x08), .O(new_n57_));
  nor2   g16(.a(x09), .b(new_n57_), .O(new_n58_));
  nand4  g17(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n43_), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g19(.a(new_n59_), .b(new_n42_), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(x19), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n60_), .O(z02));
  and2   g22(.a(new_n45_), .b(x20), .O(z03));
  nor2   g23(.a(x21), .b(x20), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n45_), .O(z04));
  nand2  g25(.a(new_n45_), .b(x10), .O(new_n67_));
  nand2  g26(.a(x19), .b(new_n57_), .O(new_n68_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n45_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n45_), .O(z13));
