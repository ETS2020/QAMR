...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n81_, new_n83_, new_n85_, new_n87_, new_n90_, new_n91_;
  ...
  nor2   g35(.a(new_n76_), .b(new_n43_), .O(z08));
  ...
  nand4  g41(.a(new_n45_), .b(new_n74_), .c(x22), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  inv1   g43(.a(x23), .O(new_n85_));
  nor3   g44(.a(new_n81_), .b(new_n44_), .c(new_n85_), .O(z12));
  nand4  g45(.a(new_n45_), .b(new_n74_), .c(x23), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z13));
  oai21  g47(.a(x24), .b(new_n76_), .c(new_n45_), .O(z14));
