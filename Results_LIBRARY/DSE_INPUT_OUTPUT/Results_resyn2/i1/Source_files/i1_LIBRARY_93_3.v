...
module FAU ( 
  ...
  nor2   g11(.a(x09), .b(new_n42_), .O(new_n53_));
  ...
  nand2  g17(.a(new_n58_), .b(new_n52_), .O(new_n59_));
  ...
  aoi21  g22(.a(new_n63_), .b(new_n61_), .c(new_n45_), .O(z04));
  inv1   g23(.a(x10), .O(new_n65_));
  nand2  g24(.a(new_n51_), .b(new_n50_), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n49_), .c(x19), .d(new_n48_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(new_n45_), .O(z05));
  ...
  nor2   g34(.a(new_n45_), .b(x24), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x22), .c(x14), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand3  g37(.a(new_n71_), .b(x22), .c(x17), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n46_), .O(z11));
  nand3  g39(.a(new_n71_), .b(x23), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n46_), .O(z12));
  nand4  g41(.a(new_n46_), .b(new_n71_), .c(x23), .d(x17), .O(new_n83_));
