...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n71_, new_n73_, new_n75_, new_n77_, new_n78_, new_n80_, new_n82_,
    new_n84_, new_n85_;
  ...
  nand2  g26(.a(new_n67_), .b(new_n61_), .O(z07));
  ...
  nand4  g31(.a(new_n61_), .b(new_n71_), .c(x22), .d(x14), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z10));
  nand4  g33(.a(new_n61_), .b(new_n71_), .c(x22), .d(x17), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z11));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n71_), .b(x23), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n61_), .O(z12));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n61_), .O(z13));
  nand2  g40(.a(new_n71_), .b(x16), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n61_), .O(z14));
  nor2   g42(.a(x13), .b(x12), .O(new_n84_));
  nor2   g43(.a(x15), .b(x14), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(new_n61_), .O(z15));
  buf    g45(.a(x19), .O(z06));
endmodule
