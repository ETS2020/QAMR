...
module FAU ( 
  ...
  nand3  g31(.a(new_n43_), .b(new_n71_), .c(x22), .O(new_n73_));
  ...
  nand2  g38(.a(new_n71_), .b(x23), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(z12));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n43_), .O(z13));
