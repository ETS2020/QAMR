...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(new_n44_), .O(new_n62_));
  ...
  oai21  g25(.a(new_n52_), .b(x08), .c(new_n44_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x19), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n66_), .O(z05));
  nor2   g28(.a(x20), .b(new_n43_), .O(z06));
  ...
  nand2  g36(.a(new_n77_), .b(new_n46_), .O(z10));
  nand4  g37(.a(new_n46_), .b(new_n75_), .c(x22), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand4  g39(.a(new_n46_), .b(new_n75_), .c(x23), .d(x14), .O(new_n81_));
