...
module FAU ( 
  ...
  nor2   g31(.a(new_n46_), .b(new_n43_), .O(z08));
  inv1   g32(.a(x24), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(new_n43_), .O(z09));
  ...
  and2   g43(.a(new_n76_), .b(x16), .O(z14));
