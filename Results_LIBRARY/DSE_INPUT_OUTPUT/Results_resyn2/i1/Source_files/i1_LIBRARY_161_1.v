...
module FAU ( 
  ...
  nand2  g23(.a(x19), .b(x13), .O(new_n65_));
  ...
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n45_), .O(z04));
  nand2  g29(.a(new_n44_), .b(x10), .O(new_n71_));
  inv1   g30(.a(new_n65_), .O(z06));
  nand2  g31(.a(z06), .b(new_n62_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n59_), .c(new_n71_), .O(z05));
  inv1   g33(.a(x18), .O(new_n75_));
  inv1   g34(.a(x24), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n44_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n45_), .b(new_n78_), .O(z08));
  oai21  g38(.a(new_n76_), .b(new_n78_), .c(new_n44_), .O(z09));
  ...
  nand4  g44(.a(new_n44_), .b(new_n76_), .c(x23), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  nand4  g46(.a(new_n44_), .b(new_n76_), .c(x23), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  nor3   g49(.a(new_n45_), .b(x24), .c(new_n90_), .O(z14));
