...
module FAU ( 
  ...
  oai21  g35(.a(new_n76_), .b(new_n59_), .c(new_n73_), .O(z05));
  ...
  nor3   g41(.a(new_n45_), .b(new_n82_), .c(new_n80_), .O(z09));
  ...
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n72_), .O(z11));
  nand2  g47(.a(new_n82_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n84_), .c(new_n72_), .O(z12));
  oai21  g49(.a(new_n89_), .b(new_n87_), .c(new_n72_), .O(z13));
  nand2  g50(.a(new_n82_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n72_), .O(z14));
  nor2   g52(.a(x13), .b(x12), .O(new_n94_));
  nor2   g53(.a(x15), .b(x14), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n45_), .O(z15));
endmodule
