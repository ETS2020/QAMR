...
module FAU ( 
  ...
  nand2  g06(.a(x24), .b(new_n47_), .O(new_n48_));
  ...
  nor2   g27(.a(x24), .b(x10), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(new_n57_), .c(new_n69_), .O(z05));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(z06));
  ...
  aoi21  g34(.a(new_n74_), .b(x10), .c(new_n43_), .O(z09));
  nand2  g35(.a(x22), .b(x14), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(x24), .O(z10));
  nand3  g37(.a(new_n43_), .b(x22), .c(x17), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n48_), .O(z11));
  ...
  nand3  g47(.a(new_n88_), .b(new_n87_), .c(new_n48_), .O(z15));
endmodule
