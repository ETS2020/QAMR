...
module FAU ( 
  ...
  nor2   g10(.a(x16), .b(new_n42_), .O(new_n52_));
  ...
  nor2   g22(.a(new_n46_), .b(x16), .O(z06));
  ...
  nand4  g38(.a(new_n43_), .b(new_n79_), .c(x22), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z10));
  nand3  g40(.a(new_n79_), .b(x22), .c(x17), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n43_), .O(z11));
  inv1   g42(.a(x14), .O(new_n84_));
  nand2  g43(.a(new_n79_), .b(x23), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n43_), .O(z12));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n43_), .O(z13));
  inv1   g47(.a(x16), .O(new_n89_));
  aoi21  g48(.a(x24), .b(new_n46_), .c(new_n89_), .O(z14));
