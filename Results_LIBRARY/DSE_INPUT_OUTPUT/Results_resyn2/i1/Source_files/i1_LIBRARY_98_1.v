...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n70_, new_n72_, new_n74_, new_n76_, new_n78_,
    new_n80_, new_n81_, new_n83_, new_n85_, new_n89_, new_n90_;
  ...
  nand2  g23(.a(x19), .b(x16), .O(new_n65_));
  aoi21  g24(.a(new_n64_), .b(new_n60_), .c(new_n65_), .O(z02));
  and2   g25(.a(new_n44_), .b(x20), .O(z03));
  ...
  nor3   g40(.a(new_n81_), .b(new_n45_), .c(new_n80_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  oai21  g42(.a(new_n81_), .b(new_n83_), .c(new_n44_), .O(z11));
  nand2  g43(.a(new_n78_), .b(x23), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n80_), .c(new_n44_), .O(z12));
  oai21  g45(.a(new_n85_), .b(new_n83_), .c(new_n44_), .O(z13));
  oai21  g46(.a(x24), .b(new_n43_), .c(new_n44_), .O(z14));
