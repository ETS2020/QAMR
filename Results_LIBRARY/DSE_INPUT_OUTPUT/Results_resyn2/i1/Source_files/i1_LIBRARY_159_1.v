...
module FAU ( 
  ...
  nand4  g32(.a(new_n45_), .b(new_n70_), .c(x22), .d(x17), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z11));
  inv1   g34(.a(x14), .O(new_n76_));
  nand2  g35(.a(new_n70_), .b(x23), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n45_), .O(z12));
  inv1   g37(.a(x17), .O(new_n79_));
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n45_), .O(z13));
  nand2  g39(.a(new_n70_), .b(x16), .O(new_n81_));
