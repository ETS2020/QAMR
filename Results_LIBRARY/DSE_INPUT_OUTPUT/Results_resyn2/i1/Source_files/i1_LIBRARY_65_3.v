...
module FAU ( 
  ...
  nand2  g24(.a(new_n48_), .b(new_n65_), .O(z03));
  ...
  oai21  g30(.a(new_n70_), .b(new_n60_), .c(new_n71_), .O(z05));
  nand2  g31(.a(new_n48_), .b(new_n47_), .O(z06));
  ...
  nand3  g44(.a(new_n44_), .b(x23), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n48_), .O(z13));
  nand2  g46(.a(new_n44_), .b(x16), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n48_), .O(z14));
  nor2   g48(.a(x13), .b(x12), .O(new_n90_));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n48_), .O(z15));
endmodule
