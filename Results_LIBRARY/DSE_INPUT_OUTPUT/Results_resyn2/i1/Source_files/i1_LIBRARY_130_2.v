...
module FAU ( 
  ...
  oai21  g27(.a(new_n68_), .b(new_n59_), .c(new_n43_), .O(z05));
  ...
  nand4  g36(.a(new_n45_), .b(new_n77_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  inv1   g38(.a(x22), .O(new_n80_));
  nand2  g39(.a(new_n77_), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(z11));
  nand4  g41(.a(new_n45_), .b(new_n77_), .c(x23), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  inv1   g43(.a(x23), .O(new_n85_));
  nor3   g44(.a(new_n81_), .b(new_n44_), .c(new_n85_), .O(z13));
