...
module FAU ( 
  ...
  and2   g17(.a(x19), .b(x00), .O(new_n59_));
  oai21  g18(.a(new_n49_), .b(x03), .c(new_n59_), .O(new_n60_));
  ...
  oai21  g26(.a(new_n49_), .b(x08), .c(x19), .O(new_n68_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n77_), .c(new_n64_), .O(z12));
  oai21  g42(.a(new_n82_), .b(new_n80_), .c(new_n64_), .O(z13));
