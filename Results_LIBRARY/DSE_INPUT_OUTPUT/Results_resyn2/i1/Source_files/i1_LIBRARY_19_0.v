...
module FAU ( 
  ...
  nand2  g30(.a(new_n52_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x24), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n71_), .O(z09));
  nand4  g33(.a(new_n73_), .b(x22), .c(x19), .d(x14), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand4  g35(.a(new_n73_), .b(x22), .c(x19), .d(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  nand4  g37(.a(new_n73_), .b(x23), .c(x19), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z12));
  nand4  g39(.a(new_n73_), .b(x23), .c(x19), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z13));
  inv1   g41(.a(x16), .O(new_n83_));
  aoi21  g42(.a(x19), .b(new_n83_), .c(x24), .O(z14));
  nor2   g43(.a(x13), .b(x12), .O(new_n85_));
  nor2   g44(.a(x15), .b(x14), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(z15));
  buf    g46(.a(x19), .O(z06));
endmodule
