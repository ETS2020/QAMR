...
module FAU ( 
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x13), .O(new_n60_));
  ...
  oai22  g26(.a(new_n67_), .b(new_n51_), .c(new_n44_), .d(new_n66_), .O(z05));
  inv1   g27(.a(x18), .O(new_n69_));
  inv1   g28(.a(x24), .O(new_n70_));
  inv1   g29(.a(new_n44_), .O(new_n71_));
  oai21  g30(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n44_), .b(new_n73_), .O(z08));
  nor3   g33(.a(new_n44_), .b(new_n70_), .c(new_n73_), .O(z09));
  inv1   g34(.a(x22), .O(new_n76_));
  nand2  g35(.a(new_n70_), .b(x14), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n71_), .O(z10));
  ...
  oai21  g42(.a(new_n77_), .b(new_n83_), .c(new_n71_), .O(z12));
  nand2  g43(.a(new_n80_), .b(x23), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  nand2  g45(.a(new_n70_), .b(x16), .O(new_n87_));
