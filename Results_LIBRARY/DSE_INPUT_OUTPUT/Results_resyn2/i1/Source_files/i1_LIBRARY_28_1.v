...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n83_, new_n84_, new_n87_, new_n89_, new_n90_;
  ...
  nand2  g30(.a(new_n43_), .b(new_n71_), .O(z06));
  ...
  nand2  g35(.a(new_n45_), .b(new_n76_), .O(z08));
  oai21  g36(.a(new_n74_), .b(new_n76_), .c(new_n45_), .O(z09));
  nand4  g37(.a(new_n74_), .b(x22), .c(x19), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand2  g39(.a(new_n74_), .b(x17), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x19), .c(new_n43_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  nand2  g42(.a(new_n74_), .b(x14), .O(new_n84_));
  nor3   g43(.a(new_n84_), .b(new_n44_), .c(new_n83_), .O(z12));
  oai21  g44(.a(new_n81_), .b(new_n83_), .c(new_n45_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  nor3   g46(.a(new_n44_), .b(x24), .c(new_n87_), .O(z14));
