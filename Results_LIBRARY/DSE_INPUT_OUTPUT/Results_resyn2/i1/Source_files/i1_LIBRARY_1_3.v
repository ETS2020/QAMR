...
module FAU ( 
  ...
  nor2   g09(.a(x23), .b(new_n50_), .O(z06));
  ...
  nand2  g27(.a(z06), .b(new_n61_), .O(new_n69_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n74_), .c(new_n43_), .O(z09));
  inv1   g36(.a(x22), .O(new_n78_));
  nand2  g37(.a(new_n76_), .b(x14), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n43_), .O(z10));
  nand4  g39(.a(new_n43_), .b(new_n76_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x23), .O(new_n83_));
  aoi21  g42(.a(new_n79_), .b(new_n50_), .c(new_n83_), .O(z12));
  nand4  g43(.a(new_n76_), .b(x23), .c(new_n50_), .d(x17), .O(new_n85_));
