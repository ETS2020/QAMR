...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n72_, new_n74_, new_n77_, new_n78_, new_n79_,
  ...
  nor2   g13(.a(new_n43_), .b(new_n42_), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n54_), .c(new_n47_), .O(z01));
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(x18), .O(new_n62_));
  ...
  oai21  g26(.a(new_n52_), .b(x08), .c(x18), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x19), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n67_), .O(z05));
  nor2   g29(.a(new_n47_), .b(new_n43_), .O(z06));
  ...
  nor3   g34(.a(new_n45_), .b(new_n72_), .c(new_n74_), .O(z09));
  ...
  nor2   g43(.a(new_n84_), .b(new_n78_), .O(z12));
  nand3  g44(.a(new_n72_), .b(x23), .c(x17), .O(new_n86_));
