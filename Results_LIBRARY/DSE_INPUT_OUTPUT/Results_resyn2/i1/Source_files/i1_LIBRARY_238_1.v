...
module FAU ( 
  ...
  nand4  g29(.a(new_n70_), .b(new_n59_), .c(new_n47_), .d(new_n46_), .O(new_n71_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n51_), .c(new_n65_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nand2  g36(.a(new_n65_), .b(new_n77_), .O(z08));
  oai21  g37(.a(new_n75_), .b(new_n77_), .c(new_n65_), .O(z09));
  inv1   g38(.a(x14), .O(new_n80_));
  nand2  g39(.a(new_n75_), .b(x22), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n65_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  oai21  g42(.a(new_n81_), .b(new_n83_), .c(new_n65_), .O(z11));
  nand2  g43(.a(new_n75_), .b(x23), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n80_), .c(new_n65_), .O(z12));
  oai21  g45(.a(new_n85_), .b(new_n83_), .c(new_n65_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor3   g47(.a(new_n44_), .b(x24), .c(new_n88_), .O(z14));
