...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n48_, new_n49_, new_n50_,
    ...
    new_n88_, new_n90_, new_n92_, new_n93_, new_n95_, new_n97_, new_n98_;
  inv1   g00(.a(x00), .O(new_n42_));
  inv1   g01(.a(x07), .O(new_n43_));
  inv1   g02(.a(x19), .O(new_n44_));
  nor2   g03(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nor2   g04(.a(new_n45_), .b(new_n42_), .O(z00));
  nor2   g05(.a(new_n44_), .b(x07), .O(z06));
  inv1   g06(.a(z06), .O(new_n48_));
  ...
  nand4  g21(.a(new_n62_), .b(new_n60_), .c(new_n59_), .d(new_n49_), .O(new_n63_));
  nand3  g22(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n42_), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(new_n63_), .c(z06), .O(new_n66_));
  ...
  nand3  g35(.a(new_n76_), .b(new_n55_), .c(new_n49_), .O(new_n77_));
  ...
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n69_), .O(z09));
  ...
  nor2   g50(.a(new_n45_), .b(x24), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x23), .c(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n92_), .b(x16), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z14));
  nor2   g55(.a(x13), .b(x12), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(z15));
endmodule
