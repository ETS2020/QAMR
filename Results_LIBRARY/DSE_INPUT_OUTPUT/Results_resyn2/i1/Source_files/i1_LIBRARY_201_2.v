...
module FAU ( 
  ...
  nor2   g22(.a(x19), .b(new_n63_), .O(new_n64_));
  nor2   g23(.a(x21), .b(x20), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n64_), .O(z04));
  nand2  g25(.a(new_n44_), .b(x10), .O(new_n67_));
  nand2  g26(.a(x19), .b(new_n63_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n57_), .c(new_n67_), .O(z05));
  nand2  g28(.a(new_n43_), .b(new_n63_), .O(z06));
