...
module FAU ( 
  ...
  oai21  g28(.a(new_n69_), .b(new_n52_), .c(new_n67_), .O(z05));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n64_), .O(z15));
  buf    g50(.a(x19), .O(z06));
endmodule
