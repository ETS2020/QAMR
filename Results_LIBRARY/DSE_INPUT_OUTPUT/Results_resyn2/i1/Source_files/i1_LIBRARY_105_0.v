...
module FAU ( 
  ...
  nor2   g01(.a(x20), .b(x13), .O(new_n43_));
  ...
  nand2  g22(.a(new_n63_), .b(x13), .O(z03));
  nand2  g23(.a(x21), .b(x13), .O(new_n65_));
  ...
  nor3   g51(.a(x15), .b(x14), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n63_), .c(new_n92_), .O(z15));
endmodule
