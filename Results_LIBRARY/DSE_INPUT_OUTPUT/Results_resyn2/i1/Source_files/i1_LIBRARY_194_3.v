...
module FAU ( 
  ...
  nor2   g08(.a(new_n49_), .b(x18), .O(z06));
  ...
  inv1   g24(.a(new_n42_), .O(new_n66_));
  ...
  aoi21  g32(.a(new_n73_), .b(new_n49_), .c(new_n72_), .O(z07));
  and2   g33(.a(new_n42_), .b(x11), .O(z08));
  nand2  g34(.a(z08), .b(x24), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n73_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n42_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n42_), .O(z11));
  nand2  g41(.a(new_n73_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n78_), .c(new_n42_), .O(z12));
  oai21  g43(.a(new_n83_), .b(new_n81_), .c(new_n42_), .O(z13));
  nand3  g44(.a(new_n42_), .b(new_n73_), .c(x16), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z14));
  nor2   g46(.a(x13), .b(x12), .O(new_n88_));
  nor2   g47(.a(x15), .b(x14), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n66_), .O(z15));
endmodule
