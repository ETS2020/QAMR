...
module FAU ( 
  ...
  oai22  g27(.a(new_n68_), .b(new_n57_), .c(new_n43_), .d(new_n66_), .O(z05));
  ...
  oai21  g40(.a(new_n81_), .b(new_n76_), .c(new_n62_), .O(z12));
  oai21  g41(.a(new_n81_), .b(new_n79_), .c(new_n62_), .O(z13));
