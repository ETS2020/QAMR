...
module FAU ( 
  ...
  nor2   g10(.a(x17), .b(new_n42_), .O(new_n52_));
  ...
  nor2   g19(.a(new_n46_), .b(x17), .O(new_n61_));
  ...
  nand4  g29(.a(new_n70_), .b(new_n58_), .c(new_n48_), .d(new_n47_), .O(new_n71_));
  ...
  nand4  g41(.a(new_n80_), .b(x22), .c(new_n46_), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand4  g43(.a(new_n43_), .b(new_n80_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand2  g45(.a(new_n80_), .b(x23), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n46_), .c(new_n69_), .O(z13));
