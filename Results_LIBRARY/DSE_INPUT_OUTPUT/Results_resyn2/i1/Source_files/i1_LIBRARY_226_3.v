...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n82_, new_n84_, new_n85_, new_n86_,
  ...
  aoi21  g23(.a(new_n64_), .b(new_n53_), .c(x03), .O(new_n65_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n52_), .c(new_n72_), .O(new_n75_));
  ...
  nand2  g40(.a(z08), .b(x24), .O(new_n82_));
  ...
  oai21  g49(.a(new_n90_), .b(new_n84_), .c(new_n43_), .O(z12));
  oai21  g50(.a(new_n90_), .b(new_n88_), .c(new_n43_), .O(z13));
