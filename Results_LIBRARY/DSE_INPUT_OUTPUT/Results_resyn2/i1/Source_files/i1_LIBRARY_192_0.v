...
module FAU ( 
  ...
  nor2   g01(.a(x21), .b(x08), .O(new_n43_));
  ...
  oai21  g24(.a(new_n62_), .b(new_n64_), .c(new_n65_), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  inv1   g26(.a(x19), .O(new_n68_));
  oai21  g27(.a(new_n50_), .b(new_n68_), .c(x21), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n64_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n67_), .O(z05));
  nor2   g30(.a(new_n43_), .b(new_n68_), .O(z06));
  nand2  g31(.a(x24), .b(x18), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n43_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n43_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  nor3   g36(.a(new_n43_), .b(new_n77_), .c(new_n75_), .O(z09));
  inv1   g37(.a(x22), .O(new_n79_));
  nand2  g38(.a(new_n77_), .b(x14), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n45_), .O(z10));
  nand3  g40(.a(new_n77_), .b(x22), .c(x17), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n43_), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n80_), .b(new_n84_), .c(new_n45_), .O(z12));
