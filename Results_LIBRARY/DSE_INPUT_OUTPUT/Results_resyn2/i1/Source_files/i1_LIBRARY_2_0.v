// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:05 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n82_, new_n84_, new_n85_, new_n87_, new_n90_, new_n91_;
  ...
  nor2   g19(.a(new_n60_), .b(new_n42_), .O(new_n61_));
  oai21  g20(.a(new_n50_), .b(x06), .c(new_n61_), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n59_), .O(z02));
  ...
  inv1   g42(.a(new_n79_), .O(new_n84_));
