...
module FAU ( 
  ...
  nand2  g26(.a(x19), .b(new_n62_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n57_), .c(new_n67_), .O(z05));
  nand2  g28(.a(new_n43_), .b(new_n62_), .O(z06));
  nand2  g29(.a(x24), .b(x18), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n63_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n63_), .b(new_n73_), .O(z08));
  ...
  nor2   g38(.a(new_n63_), .b(x24), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x22), .c(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand2  g41(.a(new_n44_), .b(x23), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n78_), .O(z12));
  nand3  g43(.a(new_n80_), .b(x23), .c(x17), .O(new_n85_));
