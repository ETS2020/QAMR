...
module FAU ( 
  ...
  oai21  g10(.a(new_n51_), .b(x08), .c(new_n43_), .O(new_n52_));
  oai21  g11(.a(new_n43_), .b(x08), .c(new_n52_), .O(new_n53_));
  ...
  nand2  g21(.a(new_n51_), .b(x09), .O(new_n63_));
  ...
  nand4  g41(.a(new_n63_), .b(new_n77_), .c(x23), .d(x14), .O(new_n83_));
