...
module FAU ( 
  ...
  oai21  g12(.a(new_n53_), .b(x09), .c(new_n43_), .O(new_n54_));
  ...
  nand4  g17(.a(new_n52_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n59_));
  ...
  nand2  g22(.a(new_n53_), .b(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n63_), .O(z03));
  nor2   g24(.a(x21), .b(x20), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n44_), .O(z04));
  nand2  g26(.a(new_n64_), .b(x10), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n43_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n50_), .c(new_n68_), .O(z05));
  nand2  g29(.a(new_n53_), .b(new_n43_), .O(z06));
  ...
  nand2  g41(.a(new_n64_), .b(new_n76_), .O(new_n83_));
  nand2  g42(.a(x23), .b(x14), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z12));
  nand3  g44(.a(new_n76_), .b(x23), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n64_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor2   g47(.a(new_n83_), .b(new_n88_), .O(z14));
