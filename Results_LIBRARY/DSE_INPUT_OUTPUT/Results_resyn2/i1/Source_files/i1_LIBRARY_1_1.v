...
module FAU ( 
  ...
  nand2  g02(.a(x23), .b(new_n43_), .O(new_n44_));
  ...
  nor3   g37(.a(new_n78_), .b(new_n68_), .c(x24), .O(z11));
  inv1   g38(.a(x23), .O(new_n80_));
  aoi21  g39(.a(new_n76_), .b(x19), .c(new_n80_), .O(z12));
  nand4  g40(.a(new_n73_), .b(x23), .c(x19), .d(x17), .O(new_n82_));
