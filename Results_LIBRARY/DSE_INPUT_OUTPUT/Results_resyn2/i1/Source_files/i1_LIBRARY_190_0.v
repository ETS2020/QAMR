...
module FAU ( 
  ...
  nand4  g20(.a(new_n55_), .b(new_n54_), .c(new_n61_), .d(new_n43_), .O(new_n62_));
  nand4  g21(.a(new_n55_), .b(new_n49_), .c(new_n48_), .d(new_n43_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n42_), .c(new_n44_), .O(new_n64_));
  ...
  nor2   g28(.a(new_n69_), .b(new_n46_), .O(z04));
  nand2  g29(.a(new_n45_), .b(x10), .O(new_n71_));
  nand2  g30(.a(x19), .b(new_n51_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n63_), .c(new_n71_), .O(z05));
  nand2  g32(.a(new_n44_), .b(x06), .O(z06));
  inv1   g33(.a(x18), .O(new_n75_));
  nand2  g34(.a(new_n45_), .b(x24), .O(new_n76_));
  ...
  nand2  g41(.a(new_n45_), .b(new_n82_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n46_), .O(z15));
endmodule
