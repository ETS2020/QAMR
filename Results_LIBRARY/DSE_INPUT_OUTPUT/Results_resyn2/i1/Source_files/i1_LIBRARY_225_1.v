...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n83_, new_n86_, new_n88_;
  ...
  nor3   g06(.a(x06), .b(x05), .c(x04), .O(new_n48_));
  xnor2a g07(.a(x09), .b(x08), .O(new_n49_));
  nand4  g08(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n50_));
  nand2  g09(.a(x19), .b(x14), .O(new_n51_));
  ...
  nand4  g20(.a(new_n61_), .b(new_n48_), .c(new_n47_), .d(new_n59_), .O(new_n62_));
  ...
  inv1   g28(.a(new_n51_), .O(z06));
  nand2  g29(.a(z06), .b(new_n60_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n57_), .c(new_n69_), .O(z05));
  nand2  g31(.a(x24), .b(x18), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n44_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n66_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n44_), .O(z09));
  nand2  g37(.a(new_n77_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n43_), .c(new_n44_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n44_), .O(z11));
  nand2  g41(.a(new_n77_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n43_), .c(new_n44_), .O(z12));
  ...
  nor3   g46(.a(x15), .b(x13), .c(x12), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(x19), .c(new_n43_), .O(z15));
endmodule
