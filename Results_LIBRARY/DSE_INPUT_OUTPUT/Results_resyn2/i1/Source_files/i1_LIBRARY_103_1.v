...
module FAU ( 
  ...
  nor2   g05(.a(new_n46_), .b(new_n43_), .O(new_n47_));
  ...
  nor3   g31(.a(new_n67_), .b(new_n72_), .c(new_n70_), .O(z09));
  ...
  nand2  g39(.a(new_n44_), .b(new_n72_), .O(new_n81_));
  nand2  g40(.a(x23), .b(x17), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n81_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  nor2   g43(.a(new_n81_), .b(new_n84_), .O(z14));
