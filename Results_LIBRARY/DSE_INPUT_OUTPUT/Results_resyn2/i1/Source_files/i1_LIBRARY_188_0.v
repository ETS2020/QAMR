...
module FAU ( 
  ...
  oai22  g26(.a(new_n67_), .b(new_n55_), .c(new_n43_), .d(new_n65_), .O(z05));
  nand2  g27(.a(new_n45_), .b(x16), .O(z06));
  nand2  g28(.a(x24), .b(x18), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n52_), .O(z07));
  ...
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n52_), .O(z15));
endmodule
