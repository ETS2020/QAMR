...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n44_), .O(z04));
  ...
  nand2  g46(.a(new_n45_), .b(new_n79_), .O(new_n88_));
  nand2  g47(.a(x23), .b(x17), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(new_n88_), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  nor2   g50(.a(new_n88_), .b(new_n91_), .O(z14));
