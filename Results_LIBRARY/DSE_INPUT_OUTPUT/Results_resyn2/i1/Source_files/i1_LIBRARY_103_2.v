...
module FAU ( 
  ...
  aoi21  g25(.a(new_n66_), .b(new_n64_), .c(new_n43_), .O(z05));
  nand2  g26(.a(new_n43_), .b(new_n64_), .O(z06));
  nor2   g27(.a(x19), .b(new_n64_), .O(new_n69_));
  ...
  nor2   g34(.a(new_n69_), .b(x24), .O(new_n76_));
