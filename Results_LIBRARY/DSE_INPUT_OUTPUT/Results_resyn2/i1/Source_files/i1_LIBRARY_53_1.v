...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n61_, new_n63_, new_n65_, new_n68_, new_n70_,
  ...
  oai21  g31(.a(new_n72_), .b(new_n70_), .c(new_n61_), .O(z09));
  ...
  oai21  g36(.a(new_n75_), .b(new_n77_), .c(new_n61_), .O(z11));
  nand3  g37(.a(new_n72_), .b(x23), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n61_), .O(z12));
  nand2  g39(.a(new_n61_), .b(new_n72_), .O(new_n81_));
  ...
  nand3  g46(.a(new_n87_), .b(new_n86_), .c(new_n61_), .O(z15));
endmodule
