...
module FAU ( 
  ...
  nor2   g24(.a(new_n45_), .b(x10), .O(new_n66_));
  ...
  nor3   g31(.a(new_n45_), .b(new_n69_), .c(new_n71_), .O(z09));
  inv1   g32(.a(x22), .O(new_n74_));
  nand2  g33(.a(new_n44_), .b(new_n69_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  ...
  nand2  g40(.a(new_n69_), .b(x23), .O(new_n82_));
  ...
  nor2   g45(.a(new_n75_), .b(new_n86_), .O(z14));
