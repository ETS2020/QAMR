...
module FAU ( 
  ...
  nand2  g23(.a(new_n47_), .b(new_n64_), .O(z03));
  nor2   g24(.a(x21), .b(x20), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n44_), .O(z04));
  inv1   g26(.a(x08), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n68_), .O(new_n69_));
  nor2   g28(.a(new_n44_), .b(x10), .O(new_n70_));
  oai21  g29(.a(new_n69_), .b(new_n59_), .c(new_n70_), .O(z05));
  nand2  g30(.a(new_n47_), .b(new_n46_), .O(z06));
  nand2  g31(.a(x24), .b(x18), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n47_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n47_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(z09));
  nand2  g37(.a(x22), .b(x14), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n43_), .c(x24), .O(z10));
  nand4  g39(.a(new_n77_), .b(x22), .c(x17), .d(new_n43_), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand4  g41(.a(new_n77_), .b(x23), .c(new_n43_), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand4  g43(.a(new_n77_), .b(x23), .c(x17), .d(new_n43_), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  nor2   g45(.a(x13), .b(x12), .O(new_n88_));
  nor2   g46(.a(x15), .b(x14), .O(new_n89_));
  nand3  g47(.a(new_n89_), .b(new_n88_), .c(new_n47_), .O(z15));
  zero   g48(.O(z14));
endmodule
