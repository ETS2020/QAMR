...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n69_, new_n70_, new_n72_, new_n73_, new_n74_, new_n77_, new_n79_,
    new_n81_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_;
  inv1   g00(.a(x00), .O(new_n42_));
  nand2  g01(.a(x23), .b(x18), .O(new_n43_));
  ...
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z07));
  ...
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(z11));
  nand4  g42(.a(new_n74_), .b(x23), .c(new_n72_), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z12));
  aoi21  g44(.a(new_n82_), .b(new_n72_), .c(new_n73_), .O(z13));
  nand3  g45(.a(new_n43_), .b(new_n74_), .c(x16), .O(new_n87_));
