...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n66_, new_n68_, new_n70_, new_n71_, new_n74_, new_n76_, new_n79_,
  ...
  aoi21  g36(.a(new_n76_), .b(new_n43_), .c(new_n44_), .O(z09));
  nand3  g37(.a(new_n44_), .b(x22), .c(x14), .O(new_n79_));
