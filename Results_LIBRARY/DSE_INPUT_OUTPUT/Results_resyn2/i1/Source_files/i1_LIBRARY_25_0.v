...
module FAU ( 
  ...
  nand4  g19(.a(new_n52_), .b(new_n49_), .c(new_n48_), .d(new_n60_), .O(new_n61_));
  nand3  g20(.a(new_n61_), .b(new_n59_), .c(x19), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n44_), .O(z02));
  ...
  oai21  g36(.a(new_n74_), .b(new_n76_), .c(new_n44_), .O(z09));
