...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n71_, new_n73_, new_n74_, new_n76_, new_n78_, new_n79_, new_n81_,
  ...
  nor2   g15(.a(new_n43_), .b(new_n50_), .O(new_n57_));
  nand3  g16(.a(new_n57_), .b(new_n56_), .c(new_n49_), .O(new_n58_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n61_), .O(z10));
  inv1   g34(.a(x17), .O(new_n76_));
  oai21  g35(.a(new_n74_), .b(new_n76_), .c(new_n61_), .O(z11));
  nand2  g36(.a(new_n61_), .b(new_n71_), .O(new_n78_));
  nand2  g37(.a(x23), .b(x14), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n78_), .O(z12));
  nand3  g39(.a(new_n71_), .b(x23), .c(x17), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n61_), .O(z13));
  inv1   g41(.a(x16), .O(new_n83_));
  nor2   g42(.a(new_n78_), .b(new_n83_), .O(z14));
