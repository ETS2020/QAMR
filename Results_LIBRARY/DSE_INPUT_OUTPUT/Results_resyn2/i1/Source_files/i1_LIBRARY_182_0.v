...
module FAU ( 
  ...
  oai21  g23(.a(new_n62_), .b(new_n46_), .c(new_n64_), .O(z04));
  ...
  nor2   g32(.a(new_n43_), .b(x24), .O(new_n74_));
  aoi21  g33(.a(new_n44_), .b(new_n72_), .c(new_n74_), .O(z09));
  nand3  g34(.a(new_n74_), .b(x22), .c(x14), .O(new_n76_));
  ...
  nand3  g40(.a(new_n74_), .b(x23), .c(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  oai21  g43(.a(x24), .b(new_n84_), .c(new_n44_), .O(z14));
