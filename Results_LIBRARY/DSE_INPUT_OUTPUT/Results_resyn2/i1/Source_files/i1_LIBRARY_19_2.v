// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:14 2020
...
module FAU ( 
  ...
  nand2  g04(.a(x24), .b(x19), .O(new_n46_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x24), .O(new_n60_));
  ...
  inv1   g26(.a(new_n46_), .O(z06));
  nand2  g27(.a(z06), .b(new_n57_), .O(new_n69_));
  ...
  nand4  g34(.a(new_n74_), .b(x22), .c(new_n43_), .d(x14), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z10));
  nand4  g36(.a(new_n74_), .b(x22), .c(new_n43_), .d(x17), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z11));
  nand4  g38(.a(new_n74_), .b(x23), .c(new_n43_), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z12));
  nand4  g40(.a(new_n74_), .b(x23), .c(new_n43_), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  aoi21  g43(.a(new_n43_), .b(new_n84_), .c(x24), .O(z14));
