...
module FAU ( 
  ...
  nand2  g08(.a(x19), .b(x11), .O(new_n50_));
  ...
  nor2   g31(.a(new_n72_), .b(new_n65_), .O(z07));
  inv1   g32(.a(x24), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n42_), .c(new_n43_), .O(z09));
  nand4  g34(.a(new_n43_), .b(new_n74_), .c(x22), .d(x14), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z10));
  nand4  g36(.a(new_n43_), .b(new_n74_), .c(x22), .d(x17), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z11));
  nand4  g38(.a(new_n43_), .b(new_n74_), .c(x23), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z12));
  nand4  g40(.a(new_n43_), .b(new_n74_), .c(x23), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  nor3   g43(.a(new_n65_), .b(x24), .c(new_n84_), .O(z14));
