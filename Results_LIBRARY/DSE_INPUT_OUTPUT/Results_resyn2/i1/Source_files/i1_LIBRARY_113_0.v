...
module FAU ( 
  ...
  nand2  g29(.a(new_n70_), .b(x12), .O(z06));
  ...
  oai21  g42(.a(new_n79_), .b(new_n83_), .c(new_n45_), .O(z12));
  ...
  nor3   g48(.a(x15), .b(x14), .c(x13), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n70_), .c(new_n89_), .O(z15));
endmodule
