...
module FAU ( 
  ...
  oai22  g27(.a(new_n68_), .b(new_n51_), .c(new_n44_), .d(new_n67_), .O(z05));
  nand2  g28(.a(x24), .b(x18), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n63_), .O(z07));
  ...
  nor3   g35(.a(new_n44_), .b(x24), .c(new_n76_), .O(new_n77_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n63_), .O(z11));
  nand2  g41(.a(new_n77_), .b(x23), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  inv1   g43(.a(x23), .O(new_n85_));
  oai21  g44(.a(new_n81_), .b(new_n85_), .c(new_n63_), .O(z13));
