...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n70_, new_n73_, new_n74_, new_n76_, new_n77_, new_n79_, new_n81_,
  ...
  nand4  g08(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(x08), .O(new_n50_));
  ...
  aoi21  g15(.a(new_n56_), .b(x09), .c(new_n46_), .O(z02));
  ...
  nand3  g23(.a(x19), .b(x09), .c(new_n64_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n55_), .c(new_n63_), .O(z05));
  ...
  nor3   g30(.a(new_n59_), .b(new_n68_), .c(new_n70_), .O(z09));
  nand2  g31(.a(new_n44_), .b(new_n68_), .O(new_n73_));
  nand2  g32(.a(x22), .b(x14), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n73_), .O(z10));
  inv1   g34(.a(x22), .O(new_n76_));
  nand2  g35(.a(new_n68_), .b(x17), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n44_), .O(z11));
  nand3  g37(.a(new_n68_), .b(x23), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z12));
  nand2  g39(.a(new_n44_), .b(x23), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n77_), .O(z13));
  inv1   g41(.a(x16), .O(new_n83_));
  nor2   g42(.a(new_n73_), .b(new_n83_), .O(z14));
