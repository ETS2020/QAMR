...
module FAU ( 
  ...
  nand2  g11(.a(x20), .b(x19), .O(new_n53_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x20), .O(new_n60_));
  and2   g19(.a(new_n60_), .b(x19), .O(z02));
  inv1   g20(.a(x21), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(x19), .c(new_n43_), .O(z04));
  inv1   g22(.a(x10), .O(new_n64_));
  oai21  g23(.a(new_n50_), .b(x08), .c(x20), .O(new_n65_));
  ...
  nand2  g34(.a(new_n44_), .b(new_n69_), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x22), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  inv1   g38(.a(x22), .O(new_n80_));
  nand2  g39(.a(new_n69_), .b(x17), .O(new_n81_));
  ...
  nor2   g46(.a(new_n76_), .b(new_n87_), .O(z14));
