...
module FAU ( 
  ...
  oai21  g24(.a(new_n63_), .b(new_n43_), .c(new_n44_), .O(z04));
  nand2  g25(.a(new_n45_), .b(x10), .O(new_n67_));
  inv1   g26(.a(x08), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n68_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n51_), .c(new_n67_), .O(z05));
  ...
  nor2   g33(.a(new_n64_), .b(new_n74_), .O(z08));
  nor3   g34(.a(new_n64_), .b(new_n72_), .c(new_n74_), .O(z09));
  inv1   g35(.a(x22), .O(new_n77_));
  nand2  g36(.a(new_n45_), .b(new_n72_), .O(new_n78_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n64_), .O(z15));
  buf    g53(.a(x19), .O(z06));
endmodule
