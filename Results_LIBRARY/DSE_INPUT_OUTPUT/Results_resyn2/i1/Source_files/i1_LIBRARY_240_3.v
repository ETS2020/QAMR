...
module FAU ( 
  ...
  aoi21  g22(.a(new_n63_), .b(new_n52_), .c(x02), .O(new_n64_));
  ...
  nand2  g32(.a(new_n46_), .b(new_n73_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n51_), .c(new_n72_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n71_), .O(z05));
  nor2   g36(.a(new_n45_), .b(x02), .O(z06));
  ...
  nor3   g42(.a(new_n67_), .b(new_n83_), .c(new_n81_), .O(z09));
  nand3  g43(.a(new_n43_), .b(new_n83_), .c(x22), .O(new_n85_));
