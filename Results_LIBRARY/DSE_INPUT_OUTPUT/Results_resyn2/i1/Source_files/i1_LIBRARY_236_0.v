...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n72_, new_n73_, new_n75_, new_n78_, new_n79_,
  ...
  nor2   g15(.a(x07), .b(x02), .O(new_n57_));
  ...
  nand4  g25(.a(new_n57_), .b(new_n48_), .c(new_n47_), .d(new_n66_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x19), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n56_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n65_), .O(z05));
  nand2  g29(.a(new_n46_), .b(x01), .O(z06));
  ...
  nor3   g35(.a(new_n43_), .b(new_n73_), .c(new_n75_), .O(z09));
  nor2   g36(.a(new_n43_), .b(x24), .O(new_n78_));
