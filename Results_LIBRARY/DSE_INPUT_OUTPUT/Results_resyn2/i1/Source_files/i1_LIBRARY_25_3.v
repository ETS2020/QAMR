...
module FAU ( 
  ...
  nand2  g19(.a(new_n46_), .b(new_n60_), .O(z03));
  nor2   g20(.a(x21), .b(x20), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n45_), .O(z04));
  ...
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(new_n46_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nand2  g30(.a(new_n46_), .b(new_n71_), .O(z08));
  oai21  g31(.a(new_n69_), .b(new_n71_), .c(new_n46_), .O(z09));
  nor2   g32(.a(new_n45_), .b(x24), .O(new_n74_));
