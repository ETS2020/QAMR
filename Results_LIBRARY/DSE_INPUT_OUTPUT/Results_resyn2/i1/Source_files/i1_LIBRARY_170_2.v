...
module FAU ( 
  ...
  nand2  g03(.a(new_n43_), .b(x18), .O(new_n45_));
  ...
  nand2  g23(.a(new_n45_), .b(x10), .O(new_n65_));
  inv1   g24(.a(x08), .O(new_n66_));
  nand2  g25(.a(x19), .b(new_n66_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n50_), .c(new_n65_), .O(z05));
  inv1   g27(.a(x18), .O(new_n69_));
  nand2  g28(.a(new_n43_), .b(new_n69_), .O(z06));
  nand3  g29(.a(x24), .b(x19), .c(x18), .O(new_n71_));
  ...
  nand2  g41(.a(new_n45_), .b(new_n75_), .O(new_n83_));
