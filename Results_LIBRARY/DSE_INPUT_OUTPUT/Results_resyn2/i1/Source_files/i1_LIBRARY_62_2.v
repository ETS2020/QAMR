...
module FAU ( 
  ...
  nand4  g36(.a(new_n44_), .b(new_n77_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand4  g38(.a(new_n44_), .b(new_n77_), .c(x22), .d(x17), .O(new_n80_));
  ...
  oai21  g46(.a(x24), .b(new_n87_), .c(new_n44_), .O(z14));
