...
module FAU ( 
  ...
  oai21  g12(.a(new_n47_), .b(x00), .c(x01), .O(new_n54_));
  nor3   g13(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n48_), .c(new_n42_), .O(new_n56_));
  ...
  oai21  g21(.a(new_n62_), .b(new_n56_), .c(x19), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n54_), .O(z02));
  ...
  oai21  g30(.a(new_n70_), .b(new_n59_), .c(new_n71_), .O(z05));
  nand2  g31(.a(x24), .b(x18), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n44_), .O(z07));
  ...
  nor3   g38(.a(new_n44_), .b(x24), .c(new_n79_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x22), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  inv1   g41(.a(x22), .O(new_n83_));
  nand2  g42(.a(new_n77_), .b(x17), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n45_), .O(z11));
  nand2  g44(.a(new_n80_), .b(x23), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z12));
  inv1   g46(.a(x23), .O(new_n88_));
  oai21  g47(.a(new_n84_), .b(new_n88_), .c(new_n45_), .O(z13));
  nand2  g48(.a(new_n77_), .b(x16), .O(new_n90_));
