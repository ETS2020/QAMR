...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n79_, new_n80_, new_n83_, new_n85_, new_n87_,
  ...
  nor2   g13(.a(x04), .b(new_n42_), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n54_), .c(new_n45_), .O(z01));
  nor2   g15(.a(x05), .b(x03), .O(new_n57_));
  nor2   g16(.a(x07), .b(x06), .O(new_n58_));
  inv1   g17(.a(x09), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(x08), .O(new_n60_));
  nand4  g19(.a(new_n60_), .b(new_n58_), .c(new_n57_), .d(new_n46_), .O(new_n61_));
  nand3  g20(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n42_), .O(new_n63_));
  nor2   g22(.a(new_n45_), .b(x04), .O(z06));
  nand3  g23(.a(z06), .b(new_n63_), .c(new_n61_), .O(new_n65_));
  ...
  nand3  g33(.a(x19), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n52_), .c(new_n46_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n72_), .c(new_n69_), .O(z05));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(x24), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(z07));
  and2   g40(.a(new_n43_), .b(x11), .O(z08));
  nand2  g41(.a(z08), .b(x24), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  nand3  g43(.a(new_n80_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n43_), .O(z10));
  nand4  g45(.a(new_n43_), .b(new_n80_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand4  g47(.a(new_n43_), .b(new_n80_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand2  g49(.a(x23), .b(x17), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(x24), .c(new_n43_), .O(z13));
  inv1   g51(.a(x16), .O(new_n93_));
  oai21  g52(.a(x24), .b(new_n93_), .c(new_n43_), .O(z14));
