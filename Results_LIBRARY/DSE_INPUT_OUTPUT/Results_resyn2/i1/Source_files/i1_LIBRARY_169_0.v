...
module FAU ( 
  ...
  nand2  g20(.a(new_n61_), .b(x19), .O(z03));
  nand2  g21(.a(x21), .b(x19), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n61_), .O(z04));
  ...
  nand2  g27(.a(x20), .b(new_n45_), .O(z06));
