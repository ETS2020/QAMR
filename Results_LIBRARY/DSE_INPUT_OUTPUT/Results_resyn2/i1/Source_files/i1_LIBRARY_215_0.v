...
module FAU ( 
  ...
  nand2  g26(.a(new_n55_), .b(x19), .O(new_n68_));
  ...
  nand2  g32(.a(new_n52_), .b(new_n73_), .O(z08));
  inv1   g33(.a(x24), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n73_), .c(new_n52_), .O(z09));
  ...
  nand2  g40(.a(new_n75_), .b(x17), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n52_), .O(z11));
  ...
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n52_), .O(z15));
  buf    g51(.a(x19), .O(z06));
endmodule
