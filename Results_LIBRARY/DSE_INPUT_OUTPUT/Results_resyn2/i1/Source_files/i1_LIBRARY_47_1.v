...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n49_, new_n51_, new_n53_,
    new_n55_, new_n57_, new_n58_, new_n60_, new_n62_, new_n64_, new_n65_,
    new_n67_, new_n69_, new_n70_, new_n72_, new_n74_, new_n76_, new_n77_;
  inv1   g00(.a(x00), .O(new_n42_));
  inv1   g01(.a(x19), .O(new_n43_));
  nor2   g02(.a(new_n43_), .b(x02), .O(new_n44_));
  nor2   g03(.a(new_n44_), .b(new_n42_), .O(z00));
  nand3  g04(.a(x19), .b(x02), .c(new_n42_), .O(new_n46_));
  inv1   g05(.a(new_n46_), .O(z01));
  aoi21  g06(.a(x02), .b(new_n42_), .c(new_n43_), .O(z02));
  ...
  inv1   g13(.a(x02), .O(new_n55_));
  nor2   g14(.a(new_n43_), .b(new_n55_), .O(z06));
  nand2  g15(.a(x19), .b(new_n55_), .O(new_n57_));
  ...
  nand4  g23(.a(new_n57_), .b(new_n64_), .c(x22), .d(x14), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z10));
  nand4  g25(.a(new_n57_), .b(new_n64_), .c(x22), .d(x17), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z11));
  inv1   g27(.a(x14), .O(new_n69_));
  nand2  g28(.a(new_n64_), .b(x23), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n69_), .c(new_n57_), .O(z12));
  inv1   g30(.a(x17), .O(new_n72_));
  oai21  g31(.a(new_n70_), .b(new_n72_), .c(new_n57_), .O(z13));
  nand2  g32(.a(new_n64_), .b(x16), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n57_), .O(z14));
