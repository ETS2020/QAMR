...
module FAU ( 
  ...
  nand4  g30(.a(new_n71_), .b(new_n69_), .c(x22), .d(x14), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z10));
  nand4  g32(.a(new_n71_), .b(new_n69_), .c(x22), .d(x17), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z11));
  nand3  g34(.a(new_n69_), .b(x23), .c(x14), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n71_), .O(z12));
  nand2  g36(.a(x23), .b(x17), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n44_), .c(x24), .O(z13));
  nand2  g38(.a(new_n69_), .b(x16), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n71_), .O(z14));
  nor2   g40(.a(x13), .b(x12), .O(new_n82_));
  nor2   g41(.a(x15), .b(x14), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n82_), .c(new_n71_), .O(z15));
  buf    g43(.a(x19), .O(z06));
endmodule
