...
module FAU ( 
  ...
  nand2  g23(.a(new_n59_), .b(x22), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n64_), .c(new_n55_), .O(z10));
  inv1   g25(.a(x17), .O(new_n67_));
  oai21  g26(.a(new_n65_), .b(new_n67_), .c(new_n55_), .O(z11));
  nand3  g27(.a(new_n59_), .b(x23), .c(x14), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n55_), .O(z12));
  oai21  g29(.a(new_n43_), .b(x02), .c(new_n59_), .O(new_n71_));
