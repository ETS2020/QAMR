...
module FAU ( 
  ...
  nand2  g31(.a(new_n46_), .b(new_n72_), .O(z08));
  ...
  nand4  g37(.a(new_n46_), .b(new_n74_), .c(x22), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  inv1   g39(.a(x23), .O(new_n81_));
  nor3   g40(.a(new_n77_), .b(new_n44_), .c(new_n81_), .O(z12));
  nand4  g41(.a(new_n46_), .b(new_n74_), .c(x23), .d(x17), .O(new_n83_));
