...
module FAU ( 
  ...
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n43_), .O(z10));
  inv1   g37(.a(x17), .O(new_n79_));
  oai21  g38(.a(new_n77_), .b(new_n79_), .c(new_n43_), .O(z11));
