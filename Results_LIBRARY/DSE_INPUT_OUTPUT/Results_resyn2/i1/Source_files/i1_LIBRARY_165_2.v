...
module FAU ( 
  ...
  nand2  g02(.a(new_n43_), .b(x11), .O(new_n44_));
  ...
  nand4  g12(.a(new_n48_), .b(new_n47_), .c(new_n53_), .d(new_n52_), .O(new_n54_));
  ...
  nand2  g18(.a(new_n59_), .b(new_n44_), .O(z02));
  ...
  oai21  g26(.a(new_n65_), .b(new_n54_), .c(new_n67_), .O(z05));
  nand2  g27(.a(x24), .b(x18), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n66_), .O(z07));
  inv1   g29(.a(x11), .O(new_n71_));
  nor2   g30(.a(new_n43_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x24), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x19), .c(new_n71_), .O(z09));
  nand4  g33(.a(new_n44_), .b(new_n73_), .c(x22), .d(x14), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand4  g35(.a(new_n44_), .b(new_n73_), .c(x22), .d(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  nand3  g37(.a(new_n73_), .b(x23), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n66_), .c(x24), .O(z13));
  ...
  nand3  g45(.a(new_n86_), .b(new_n85_), .c(new_n44_), .O(z15));
  buf    g46(.a(x19), .O(z06));
endmodule
