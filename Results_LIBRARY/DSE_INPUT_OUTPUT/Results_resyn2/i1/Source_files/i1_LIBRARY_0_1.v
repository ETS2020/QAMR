// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:04 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    new_n54_, new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_,
  ...
  nor2   g13(.a(new_n48_), .b(x01), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(new_n54_), .O(z05));
  nand2  g15(.a(x24), .b(x18), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n55_), .O(z07));
  ...
  oai21  g21(.a(new_n48_), .b(x01), .c(new_n61_), .O(new_n63_));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n55_), .O(z15));
  buf    g36(.a(x19), .O(z06));
endmodule
