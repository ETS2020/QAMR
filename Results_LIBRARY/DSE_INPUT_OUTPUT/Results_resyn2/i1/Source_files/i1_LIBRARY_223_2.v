...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n74_, new_n76_, new_n78_, new_n80_, new_n82_,
    new_n84_, new_n85_;
  ...
  nand2  g13(.a(x24), .b(x19), .O(new_n55_));
  ...
  nand3  g26(.a(x24), .b(x19), .c(new_n60_), .O(new_n68_));
  ...
  nor2   g31(.a(new_n43_), .b(new_n71_), .O(z09));
  nand2  g32(.a(x22), .b(x14), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n47_), .c(x24), .O(z10));
  nand4  g34(.a(new_n43_), .b(x22), .c(new_n47_), .d(x17), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z11));
  nand4  g36(.a(new_n43_), .b(x23), .c(new_n47_), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z12));
  nand2  g38(.a(x23), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n47_), .c(x24), .O(z13));
  inv1   g40(.a(x16), .O(new_n82_));
  aoi21  g41(.a(new_n47_), .b(new_n82_), .c(x24), .O(z14));
