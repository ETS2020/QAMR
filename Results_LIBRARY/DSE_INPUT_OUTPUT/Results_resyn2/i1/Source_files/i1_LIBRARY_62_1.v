...
module FAU ( 
  ...
  nand4  g31(.a(new_n45_), .b(new_n72_), .c(x22), .d(x14), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z10));
  nand4  g33(.a(new_n45_), .b(new_n72_), .c(x22), .d(x17), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z11));
  inv1   g35(.a(x14), .O(new_n77_));
  nand2  g36(.a(new_n72_), .b(x23), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n45_), .O(z12));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n45_), .O(z13));
