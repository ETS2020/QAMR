...
module FAU ( 
  ...
  nor2   g28(.a(x15), .b(x10), .O(new_n70_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n47_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n47_), .b(new_n76_), .O(z08));
  oai21  g36(.a(new_n74_), .b(new_n76_), .c(new_n47_), .O(z09));
  inv1   g37(.a(x14), .O(new_n79_));
  nand2  g38(.a(new_n74_), .b(x22), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n47_), .O(z10));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n47_), .O(z11));
  nand2  g42(.a(new_n47_), .b(new_n74_), .O(new_n84_));
  nand2  g43(.a(x23), .b(x14), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z12));
  nand3  g45(.a(new_n74_), .b(x23), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n47_), .O(z13));
  inv1   g47(.a(x16), .O(new_n89_));
  nor2   g48(.a(new_n84_), .b(new_n89_), .O(z14));
  nor2   g49(.a(x13), .b(x12), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n43_), .c(new_n79_), .O(z15));
endmodule
