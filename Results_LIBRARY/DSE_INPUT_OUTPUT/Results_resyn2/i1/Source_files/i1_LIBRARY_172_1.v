...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n70_, new_n73_, new_n75_, new_n78_, new_n80_,
  ...
  aoi21  g32(.a(new_n73_), .b(x16), .c(new_n43_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n47_), .b(new_n75_), .O(z08));
  aoi21  g35(.a(x16), .b(new_n75_), .c(new_n43_), .O(z09));
  nand3  g36(.a(new_n43_), .b(x22), .c(x14), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n47_), .O(z10));
  ...
  nand3  g48(.a(new_n89_), .b(new_n88_), .c(new_n47_), .O(z15));
endmodule
