...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n74_, new_n76_, new_n78_, new_n81_, new_n83_, new_n84_;
  ...
  nand2  g24(.a(new_n62_), .b(new_n65_), .O(z05));
  ...
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n62_), .O(z10));
  inv1   g34(.a(x17), .O(new_n76_));
  oai21  g35(.a(new_n74_), .b(new_n76_), .c(new_n62_), .O(z11));
  nand2  g36(.a(new_n71_), .b(x23), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n44_), .c(new_n73_), .O(z12));
  oai21  g38(.a(new_n78_), .b(new_n76_), .c(new_n62_), .O(z13));
  nand2  g39(.a(new_n71_), .b(x16), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n62_), .O(z14));
