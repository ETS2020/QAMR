...
module FAU ( 
  ...
  inv1   g09(.a(x22), .O(new_n51_));
  nand2  g10(.a(new_n51_), .b(x21), .O(new_n52_));
  ...
  nand2  g26(.a(new_n43_), .b(new_n66_), .O(z04));
  ...
  oai21  g44(.a(new_n85_), .b(new_n80_), .c(new_n52_), .O(z12));
  oai21  g45(.a(new_n85_), .b(new_n83_), .c(new_n52_), .O(z13));
