// Benchmark "FAU" written by ABC on Tue Aug 11 19:28:27 2020
...
module FAU ( 
  ...
  nand2  g11(.a(x19), .b(x08), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(x09), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  aoi21  g14(.a(x19), .b(new_n42_), .c(new_n43_), .O(new_n56_));
  oai21  g15(.a(new_n55_), .b(new_n50_), .c(new_n56_), .O(z01));
  nand2  g16(.a(new_n50_), .b(new_n42_), .O(new_n58_));
  nor3   g17(.a(x07), .b(x06), .c(x05), .O(new_n59_));
  nand4  g18(.a(new_n52_), .b(new_n49_), .c(new_n48_), .d(new_n59_), .O(new_n60_));
  nand3  g19(.a(new_n60_), .b(new_n58_), .c(x19), .O(new_n61_));
  ...
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n44_), .O(z15));
  buf    g50(.a(x19), .O(z06));
endmodule
