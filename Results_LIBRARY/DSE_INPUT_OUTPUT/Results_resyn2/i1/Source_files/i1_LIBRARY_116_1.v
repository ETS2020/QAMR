...
module FAU ( 
  ...
  nand3  g26(.a(x19), .b(x13), .c(new_n57_), .O(new_n68_));
  ...
  nand2  g35(.a(new_n76_), .b(new_n63_), .O(z10));
  nand3  g36(.a(new_n74_), .b(x22), .c(x17), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n44_), .O(z11));
  inv1   g38(.a(x23), .O(new_n80_));
  nand2  g39(.a(new_n74_), .b(x14), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n44_), .c(new_n80_), .O(z12));
