...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n72_, new_n75_, new_n77_, new_n78_, new_n80_,
  ...
  nor2   g12(.a(x17), .b(new_n42_), .O(new_n54_));
  ...
  nor2   g27(.a(new_n46_), .b(x17), .O(z06));
  nand2  g28(.a(z06), .b(new_n59_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n51_), .c(new_n68_), .O(z05));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n46_), .c(new_n56_), .O(z13));
