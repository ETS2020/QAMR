...
module FAU ( 
  ...
  inv1   g20(.a(new_n60_), .O(new_n62_));
  nor2   g21(.a(x21), .b(x20), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n62_), .O(z04));
  inv1   g23(.a(x10), .O(new_n65_));
  inv1   g24(.a(x08), .O(new_n66_));
  nand4  g25(.a(x19), .b(new_n66_), .c(new_n53_), .d(new_n42_), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(new_n52_), .c(new_n51_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n65_), .c(new_n62_), .O(z05));
  inv1   g29(.a(x18), .O(new_n71_));
  inv1   g30(.a(x24), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(new_n60_), .O(z07));
  and2   g32(.a(new_n60_), .b(x11), .O(z08));
  nand2  g33(.a(z08), .b(x24), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z09));
  inv1   g35(.a(x22), .O(new_n77_));
  nand2  g36(.a(new_n72_), .b(x14), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n60_), .O(z10));
  nand4  g38(.a(new_n60_), .b(new_n72_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  inv1   g40(.a(x23), .O(new_n82_));
  oai21  g41(.a(new_n78_), .b(new_n82_), .c(new_n60_), .O(z12));
  nand2  g42(.a(x23), .b(x17), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(x24), .c(new_n60_), .O(z13));
  inv1   g44(.a(x16), .O(new_n86_));
  oai21  g45(.a(x24), .b(new_n86_), .c(new_n60_), .O(z14));
  nor2   g46(.a(x13), .b(x12), .O(new_n88_));
  nor2   g47(.a(x15), .b(x14), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n62_), .O(z15));
  nor2   g49(.a(new_n44_), .b(x00), .O(z06));
endmodule
