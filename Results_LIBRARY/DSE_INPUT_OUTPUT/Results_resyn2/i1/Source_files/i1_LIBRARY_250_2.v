...
module FAU ( 
  ...
  oai21  g16(.a(new_n52_), .b(x00), .c(x05), .O(new_n58_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n68_), .O(z09));
  inv1   g39(.a(x22), .O(new_n81_));
  nand2  g40(.a(new_n79_), .b(x14), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n68_), .O(z10));
  nand2  g42(.a(new_n68_), .b(new_n79_), .O(new_n84_));
  nand2  g43(.a(x22), .b(x17), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(z11));
  inv1   g45(.a(x23), .O(new_n87_));
  oai21  g46(.a(new_n82_), .b(new_n87_), .c(new_n68_), .O(z12));
  nand3  g47(.a(new_n79_), .b(x23), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n68_), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  nor2   g50(.a(new_n84_), .b(new_n91_), .O(z14));
