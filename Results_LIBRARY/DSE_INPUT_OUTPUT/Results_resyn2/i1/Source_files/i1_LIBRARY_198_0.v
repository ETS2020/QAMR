...
module FAU ( 
  ...
  nand2  g21(.a(new_n62_), .b(x19), .O(z03));
  nand2  g22(.a(x21), .b(x19), .O(new_n64_));
  ...
  nor3   g38(.a(new_n79_), .b(new_n43_), .c(x24), .O(z11));
  inv1   g39(.a(x23), .O(new_n81_));
  nor3   g40(.a(new_n77_), .b(new_n43_), .c(new_n81_), .O(z12));
