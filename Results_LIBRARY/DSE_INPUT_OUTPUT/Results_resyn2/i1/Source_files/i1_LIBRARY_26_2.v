...
module FAU ( 
  ...
  aoi21  g38(.a(new_n79_), .b(x19), .c(new_n43_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n46_), .O(z11));
  nand4  g41(.a(new_n77_), .b(x23), .c(x19), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand2  g43(.a(new_n77_), .b(x23), .O(new_n85_));
  nor3   g44(.a(new_n85_), .b(new_n44_), .c(new_n81_), .O(z13));
