...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n71_, new_n74_, new_n76_, new_n78_, new_n80_,
  ...
  nand3  g23(.a(new_n43_), .b(new_n64_), .c(new_n62_), .O(z04));
  ...
  nand4  g34(.a(new_n43_), .b(new_n71_), .c(x22), .d(x14), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z10));
  nand3  g36(.a(new_n71_), .b(x22), .c(x17), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n43_), .O(z11));
  nand2  g38(.a(x23), .b(x14), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(x24), .c(new_n43_), .O(z12));
  nand4  g40(.a(new_n43_), .b(new_n71_), .c(x23), .d(x17), .O(new_n82_));
