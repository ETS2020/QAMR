...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n79_, new_n82_, new_n84_, new_n85_, new_n87_, new_n89_,
  ...
  aoi21  g15(.a(new_n56_), .b(new_n55_), .c(new_n46_), .O(z01));
  ...
  aoi21  g24(.a(new_n65_), .b(new_n53_), .c(x07), .O(new_n66_));
  ...
  nor2   g31(.a(new_n46_), .b(x07), .O(z06));
  nand2  g32(.a(z06), .b(new_n72_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n59_), .c(new_n71_), .O(z05));
  ...
  oai21  g39(.a(new_n77_), .b(new_n79_), .c(new_n43_), .O(z09));
  nand3  g40(.a(new_n77_), .b(x22), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n43_), .O(z10));
  nor2   g42(.a(new_n44_), .b(x24), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x22), .c(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  nand4  g45(.a(new_n43_), .b(new_n77_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n84_), .b(x23), .c(x17), .O(new_n89_));
