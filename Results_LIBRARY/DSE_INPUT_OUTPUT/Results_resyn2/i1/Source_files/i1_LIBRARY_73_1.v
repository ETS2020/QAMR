...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n73_, new_n75_, new_n76_, new_n78_, new_n80_, new_n83_,
    new_n84_;
  ...
  inv1   g11(.a(new_n51_), .O(new_n53_));
  ...
  nand3  g16(.a(new_n57_), .b(new_n53_), .c(new_n50_), .O(new_n58_));
  ...
  nand2  g31(.a(new_n70_), .b(x14), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(z10));
  nor2   g33(.a(new_n44_), .b(x24), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(x22), .c(x17), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z11));
  inv1   g36(.a(x23), .O(new_n78_));
  nor3   g37(.a(new_n73_), .b(new_n44_), .c(new_n78_), .O(z12));
  nand3  g38(.a(new_n75_), .b(x23), .c(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z13));
  and2   g40(.a(new_n75_), .b(x16), .O(z14));
  nor2   g41(.a(x13), .b(x12), .O(new_n83_));
  nor2   g42(.a(x15), .b(x14), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(new_n45_), .O(z15));
  buf    g44(.a(x19), .O(z06));
endmodule
