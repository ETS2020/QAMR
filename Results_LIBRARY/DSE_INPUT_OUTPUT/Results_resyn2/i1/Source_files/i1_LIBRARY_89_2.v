...
module FAU ( 
  ...
  nor2   g25(.a(new_n66_), .b(new_n65_), .O(z04));
  nand2  g26(.a(new_n44_), .b(x10), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n46_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n53_), .c(new_n68_), .O(z05));
  nand2  g29(.a(x24), .b(x18), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n65_), .O(z07));
  ...
  nand4  g40(.a(new_n44_), .b(new_n75_), .c(x23), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand4  g42(.a(new_n44_), .b(new_n75_), .c(x23), .d(x17), .O(new_n84_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n65_), .O(z15));
endmodule
