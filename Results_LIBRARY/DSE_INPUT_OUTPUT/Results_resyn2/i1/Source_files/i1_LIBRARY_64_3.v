...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n78_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_,
  ...
  aoi21  g24(.a(new_n65_), .b(new_n53_), .c(x06), .O(new_n66_));
  ...
  nor2   g32(.a(new_n46_), .b(x06), .O(z06));
  nand2  g33(.a(z06), .b(new_n73_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n59_), .c(new_n72_), .O(z05));
  nor2   g35(.a(new_n44_), .b(x24), .O(new_n77_));
  nor2   g36(.a(new_n44_), .b(x18), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n77_), .O(z07));
  and2   g38(.a(new_n43_), .b(x11), .O(z08));
  nand2  g39(.a(z08), .b(x24), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z09));
  nand3  g41(.a(new_n77_), .b(x22), .c(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n77_), .b(x22), .c(x17), .O(new_n85_));
  ...
  oai21  g48(.a(new_n89_), .b(x24), .c(new_n43_), .O(z13));
