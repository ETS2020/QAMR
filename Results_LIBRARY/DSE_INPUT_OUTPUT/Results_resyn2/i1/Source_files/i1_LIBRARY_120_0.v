...
module FAU ( 
  ...
  oai22  g27(.a(new_n68_), .b(new_n58_), .c(new_n43_), .d(new_n66_), .O(z05));
  nand2  g28(.a(new_n46_), .b(x14), .O(z06));
  ...
  nor3   g48(.a(x15), .b(x13), .c(x12), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n46_), .c(new_n89_), .O(z15));
endmodule
