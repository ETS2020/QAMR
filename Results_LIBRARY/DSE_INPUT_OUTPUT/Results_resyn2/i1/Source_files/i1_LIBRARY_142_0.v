...
module FAU ( 
  ...
  nand2  g23(.a(new_n64_), .b(new_n63_), .O(z04));
  ...
  nand2  g28(.a(new_n45_), .b(x04), .O(z06));
  inv1   g29(.a(x18), .O(new_n71_));
  inv1   g30(.a(x24), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(new_n63_), .O(z07));
  ...
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n63_), .O(z10));
  nand2  g38(.a(new_n63_), .b(new_n72_), .O(new_n80_));
  ...
  nand2  g44(.a(new_n85_), .b(new_n63_), .O(z13));
