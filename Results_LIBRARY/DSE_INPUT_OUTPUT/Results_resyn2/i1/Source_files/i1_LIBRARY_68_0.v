...
module FAU ( 
  ...
  oai21  g20(.a(new_n61_), .b(new_n51_), .c(x19), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  nor2   g22(.a(x04), .b(x03), .O(new_n64_));
  nand4  g23(.a(new_n53_), .b(new_n64_), .c(new_n48_), .d(new_n47_), .O(new_n65_));
  ...
  nand2  g31(.a(x19), .b(new_n72_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n65_), .c(new_n71_), .O(z05));
  nand2  g33(.a(new_n46_), .b(x05), .O(z06));
  ...
  nor3   g46(.a(new_n87_), .b(new_n43_), .c(new_n82_), .O(z12));
  oai21  g47(.a(new_n87_), .b(new_n85_), .c(new_n44_), .O(z13));
