...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n81_, new_n83_, new_n84_, new_n86_, new_n89_, new_n90_;
  ...
  oai21  g12(.a(new_n53_), .b(new_n52_), .c(x09), .O(new_n54_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n58_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n58_), .O(z13));
  and2   g46(.a(new_n78_), .b(x16), .O(z14));
  nor2   g47(.a(x13), .b(x12), .O(new_n89_));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(new_n58_), .O(z15));
endmodule
