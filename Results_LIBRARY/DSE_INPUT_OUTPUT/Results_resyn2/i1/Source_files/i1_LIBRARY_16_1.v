...
module FAU ( 
  ...
  oai21  g24(.a(x24), .b(new_n65_), .c(new_n63_), .O(z04));
  ...
  nand3  g31(.a(x24), .b(x20), .c(x18), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n45_), .b(new_n75_), .O(z08));
  nand3  g35(.a(x24), .b(x20), .c(x11), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z09));
  nand3  g37(.a(new_n43_), .b(x22), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n45_), .O(z10));
  nand2  g39(.a(x22), .b(x17), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(x24), .O(z11));
  nand2  g41(.a(x23), .b(x14), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x24), .O(z12));
  nand2  g43(.a(x23), .b(x17), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(x24), .O(z13));
  nand2  g45(.a(new_n43_), .b(x16), .O(new_n87_));
