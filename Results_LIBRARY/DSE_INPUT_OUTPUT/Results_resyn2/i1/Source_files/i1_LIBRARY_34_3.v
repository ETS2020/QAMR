...
module FAU ( 
  ...
  nor2   g10(.a(x14), .b(new_n42_), .O(new_n52_));
  ...
  nand2  g31(.a(new_n72_), .b(new_n67_), .O(z05));
  ...
  nand4  g38(.a(new_n78_), .b(x22), .c(new_n46_), .d(x14), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z10));
  nand4  g40(.a(new_n43_), .b(new_n78_), .c(x22), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z11));
  nand2  g42(.a(new_n78_), .b(x23), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n46_), .c(new_n68_), .O(z12));
  nand4  g44(.a(new_n43_), .b(new_n78_), .c(x23), .d(x17), .O(new_n86_));
