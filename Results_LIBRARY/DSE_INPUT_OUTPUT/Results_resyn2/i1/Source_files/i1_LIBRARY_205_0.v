...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n58_, new_n59_, new_n61_, new_n64_, new_n65_, new_n66_,
  ...
  oai22  g25(.a(new_n66_), .b(new_n54_), .c(new_n49_), .d(new_n64_), .O(z05));
  nand2  g26(.a(x24), .b(x18), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n49_), .O(z07));
  inv1   g28(.a(x11), .O(new_n70_));
  nor2   g29(.a(new_n49_), .b(new_n70_), .O(z08));
  inv1   g30(.a(x24), .O(new_n72_));
  nor3   g31(.a(new_n49_), .b(new_n72_), .c(new_n70_), .O(z09));
  inv1   g32(.a(x14), .O(new_n74_));
  nor3   g33(.a(new_n49_), .b(x24), .c(new_n74_), .O(new_n75_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n50_), .O(z11));
  nand2  g39(.a(new_n75_), .b(x23), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  inv1   g41(.a(x23), .O(new_n83_));
  nor3   g42(.a(new_n79_), .b(new_n49_), .c(new_n83_), .O(z13));
  inv1   g43(.a(x16), .O(new_n85_));
  nor3   g44(.a(new_n49_), .b(x24), .c(new_n85_), .O(z14));
  nor2   g45(.a(x13), .b(x12), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n49_), .O(z15));
  buf    g48(.a(x00), .O(z00));
  buf    g49(.a(x19), .O(z06));
endmodule
