...
module FAU ( 
  ...
  nor2   g11(.a(x15), .b(new_n42_), .O(new_n53_));
  ...
  nor2   g27(.a(new_n45_), .b(x15), .O(z06));
  nand2  g28(.a(z06), .b(new_n58_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n50_), .c(new_n68_), .O(z05));
