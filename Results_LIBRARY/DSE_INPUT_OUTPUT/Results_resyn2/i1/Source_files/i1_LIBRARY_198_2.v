...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(x20), .O(new_n62_));
  and2   g21(.a(new_n62_), .b(x19), .O(z02));
  nand2  g22(.a(new_n54_), .b(new_n43_), .O(z03));
  inv1   g23(.a(x21), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(x19), .c(new_n54_), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  oai21  g26(.a(new_n51_), .b(x08), .c(x20), .O(new_n68_));
