...
module FAU ( 
  ...
  nand2  g30(.a(new_n71_), .b(new_n67_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n67_), .b(new_n73_), .O(z08));
  ...
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n67_), .O(z10));
  inv1   g38(.a(x17), .O(new_n80_));
  oai21  g39(.a(new_n78_), .b(new_n80_), .c(new_n67_), .O(z11));
  nand2  g40(.a(new_n75_), .b(x23), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n77_), .c(new_n67_), .O(z12));
  oai21  g42(.a(new_n82_), .b(new_n80_), .c(new_n67_), .O(z13));
