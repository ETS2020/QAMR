...
module FAU ( 
  ...
  nor2   g25(.a(x19), .b(new_n66_), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(x10), .O(new_n68_));
  oai21  g27(.a(new_n65_), .b(new_n57_), .c(new_n68_), .O(z05));
  nand2  g28(.a(new_n43_), .b(new_n66_), .O(z06));
  ...
  nor2   g33(.a(new_n67_), .b(new_n74_), .O(z08));
  nor3   g34(.a(new_n67_), .b(new_n72_), .c(new_n74_), .O(z09));
