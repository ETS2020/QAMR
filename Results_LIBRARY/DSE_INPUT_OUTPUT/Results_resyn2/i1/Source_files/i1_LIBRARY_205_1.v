...
module FAU ( 
  ...
  nand3  g30(.a(new_n46_), .b(x19), .c(new_n71_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n45_), .c(new_n70_), .O(z05));
  nor2   g32(.a(new_n52_), .b(new_n66_), .O(z06));
  ...
  nor2   g37(.a(new_n75_), .b(new_n78_), .O(z08));
  inv1   g38(.a(x24), .O(new_n80_));
  nor3   g39(.a(new_n75_), .b(new_n80_), .c(new_n78_), .O(z09));
  nand4  g40(.a(new_n67_), .b(new_n80_), .c(x22), .d(x14), .O(new_n82_));
  ...
  nand4  g45(.a(new_n67_), .b(new_n80_), .c(x23), .d(x14), .O(new_n87_));
  ...
  nor3   g50(.a(new_n75_), .b(x24), .c(new_n91_), .O(z14));
