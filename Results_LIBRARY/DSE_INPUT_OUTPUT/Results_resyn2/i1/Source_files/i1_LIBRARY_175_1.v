...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n61_, new_n63_, new_n65_, new_n68_, new_n69_,
  ...
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(new_n61_), .O(z07));
  ...
  nand2  g33(.a(new_n69_), .b(x14), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n61_), .O(z10));
  nand2  g35(.a(new_n61_), .b(new_n69_), .O(new_n77_));
  nand2  g36(.a(x22), .b(x17), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n77_), .O(z11));
  inv1   g38(.a(x23), .O(new_n80_));
  oai21  g39(.a(new_n75_), .b(new_n80_), .c(new_n61_), .O(z12));
  nand3  g40(.a(new_n69_), .b(x23), .c(x17), .O(new_n82_));
