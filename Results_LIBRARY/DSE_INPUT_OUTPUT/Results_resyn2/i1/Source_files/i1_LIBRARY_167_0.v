...
module FAU ( 
  ...
  nor2   g01(.a(x23), .b(x18), .O(new_n43_));
  ...
  nor2   g27(.a(new_n50_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n68_), .c(new_n43_), .O(z05));
  nand2  g30(.a(x24), .b(x18), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n64_), .O(z07));
  ...
  nor2   g46(.a(new_n87_), .b(new_n43_), .O(z14));
