...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n67_, new_n69_, new_n70_, new_n73_, new_n75_, new_n78_, new_n79_,
  ...
  aoi22  g12(.a(new_n53_), .b(z00), .c(new_n48_), .d(new_n47_), .O(z01));
  ...
  nor2   g20(.a(new_n45_), .b(new_n47_), .O(new_n62_));
  ...
  nand4  g28(.a(new_n69_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n43_), .c(new_n45_), .O(z05));
  nand2  g30(.a(new_n48_), .b(new_n47_), .O(z06));
  nand3  g31(.a(x24), .b(x18), .c(new_n43_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n48_), .b(new_n75_), .O(z08));
  aoi21  g35(.a(new_n75_), .b(new_n43_), .c(new_n44_), .O(z09));
  ...
  nand2  g41(.a(new_n44_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n78_), .c(new_n48_), .O(z12));
  oai21  g43(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(z13));
