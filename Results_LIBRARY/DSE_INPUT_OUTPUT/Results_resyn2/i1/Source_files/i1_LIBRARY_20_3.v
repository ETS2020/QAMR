...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n72_, new_n73_, new_n76_, new_n78_, new_n79_,
  ...
  nor2   g11(.a(x17), .b(new_n42_), .O(new_n53_));
  ...
  aoi22  g24(.a(new_n65_), .b(new_n63_), .c(x19), .d(x17), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  oai21  g26(.a(new_n50_), .b(x08), .c(new_n55_), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x19), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n67_), .O(z05));
  nor2   g29(.a(new_n45_), .b(x17), .O(z06));
  inv1   g30(.a(x18), .O(new_n72_));
  inv1   g31(.a(x24), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n72_), .c(new_n43_), .O(z07));
  and2   g33(.a(new_n43_), .b(x11), .O(z08));
  nand2  g34(.a(z08), .b(x24), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n73_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n43_), .O(z10));
  aoi21  g39(.a(new_n79_), .b(new_n45_), .c(new_n55_), .O(z11));
  nand4  g40(.a(new_n43_), .b(new_n73_), .c(x23), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand2  g42(.a(new_n73_), .b(x23), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n45_), .c(new_n55_), .O(z13));
  nand3  g44(.a(new_n43_), .b(new_n73_), .c(x16), .O(new_n86_));
