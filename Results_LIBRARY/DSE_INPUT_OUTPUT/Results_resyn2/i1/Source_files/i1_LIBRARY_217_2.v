...
module FAU ( 
  ...
  nor3   g12(.a(x04), .b(x03), .c(x01), .O(new_n54_));
  ...
  oai21  g29(.a(new_n69_), .b(new_n58_), .c(new_n70_), .O(z05));
  nand2  g30(.a(new_n46_), .b(new_n43_), .O(z06));
  ...
  oai21  g37(.a(new_n74_), .b(new_n77_), .c(new_n75_), .O(z09));
