...
module FAU ( 
  ...
  nor2   g01(.a(x24), .b(x06), .O(new_n43_));
  ...
  oai21  g12(.a(new_n45_), .b(x00), .c(new_n53_), .O(z01));
  nand3  g13(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(x24), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n46_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x00), .O(new_n58_));
  inv1   g17(.a(new_n55_), .O(new_n59_));
  inv1   g18(.a(x08), .O(new_n60_));
  nor2   g19(.a(x09), .b(new_n60_), .O(new_n61_));
  nand4  g20(.a(new_n61_), .b(new_n59_), .c(x24), .d(new_n46_), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(new_n58_), .c(new_n45_), .O(z02));
  ...
  oai21  g27(.a(new_n50_), .b(x08), .c(x24), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n68_), .O(z05));
  nand2  g30(.a(new_n65_), .b(new_n45_), .O(z06));
  ...
  nand4  g36(.a(new_n76_), .b(x22), .c(x14), .d(x06), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand2  g38(.a(x22), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x06), .c(x24), .O(z11));
  nand4  g40(.a(new_n76_), .b(x23), .c(x14), .d(x06), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand2  g42(.a(x23), .b(x17), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(x06), .c(x24), .O(z13));
  inv1   g44(.a(x16), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(x06), .c(x24), .O(z14));
