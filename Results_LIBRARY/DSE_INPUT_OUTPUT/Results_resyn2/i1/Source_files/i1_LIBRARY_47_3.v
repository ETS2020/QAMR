...
module FAU ( 
  ...
  nand2  g00(.a(x19), .b(x02), .O(new_n42_));
  ...
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n42_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n42_), .O(z13));
  inv1   g52(.a(x16), .O(new_n94_));
  oai21  g53(.a(x24), .b(new_n94_), .c(new_n42_), .O(z14));
