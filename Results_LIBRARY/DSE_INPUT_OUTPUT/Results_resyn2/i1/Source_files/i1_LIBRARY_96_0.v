...
module FAU ( 
  ...
  aoi21  g39(.a(x22), .b(new_n80_), .c(x24), .O(z11));
  nand2  g40(.a(z10), .b(x23), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand4  g42(.a(new_n76_), .b(x23), .c(x22), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z13));
  inv1   g44(.a(x16), .O(new_n86_));
  aoi21  g45(.a(x22), .b(new_n86_), .c(x24), .O(z14));
