...
module FAU ( 
  ...
  nor2   g10(.a(x02), .b(x01), .O(new_n52_));
  xnor2a g11(.a(x09), .b(x08), .O(new_n53_));
  nand4  g12(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(new_n49_), .c(new_n47_), .O(z01));
  oai21  g14(.a(new_n47_), .b(new_n42_), .c(new_n44_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(x01), .O(new_n57_));
  nor3   g16(.a(x04), .b(x03), .c(x02), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n50_), .c(new_n42_), .O(new_n59_));
  inv1   g18(.a(x07), .O(new_n60_));
  nor2   g19(.a(x06), .b(x05), .O(new_n61_));
  nand4  g20(.a(new_n52_), .b(new_n51_), .c(new_n61_), .d(new_n60_), .O(new_n62_));
  ...
  nand2  g25(.a(new_n66_), .b(new_n57_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nand2  g27(.a(new_n48_), .b(new_n68_), .O(z03));
  or2    g28(.a(z03), .b(x21), .O(z04));
  inv1   g29(.a(x08), .O(new_n71_));
  nand2  g30(.a(x19), .b(new_n71_), .O(new_n72_));
  nor2   g31(.a(new_n45_), .b(x10), .O(new_n73_));
  oai21  g32(.a(new_n72_), .b(new_n62_), .c(new_n73_), .O(z05));
  nor2   g33(.a(new_n45_), .b(new_n47_), .O(z06));
  nand3  g34(.a(x24), .b(x18), .c(new_n43_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nand2  g37(.a(new_n48_), .b(new_n78_), .O(z08));
  nand3  g38(.a(x24), .b(x11), .c(new_n43_), .O(new_n80_));
  ...
  nand3  g46(.a(new_n44_), .b(x23), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n48_), .O(z13));
  nand2  g48(.a(new_n44_), .b(x16), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n48_), .O(z14));
  nor2   g50(.a(x13), .b(x12), .O(new_n92_));
  nor2   g51(.a(x15), .b(x14), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n48_), .O(z15));
endmodule
