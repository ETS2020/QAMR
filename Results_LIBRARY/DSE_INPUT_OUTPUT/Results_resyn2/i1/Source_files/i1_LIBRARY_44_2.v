// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:27 2020
...
module FAU ( 
  ...
  nand4  g19(.a(new_n60_), .b(new_n48_), .c(new_n47_), .d(new_n58_), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n57_), .c(new_n43_), .O(z02));
  ...
  nand2  g25(.a(x19), .b(new_n59_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n56_), .c(new_n66_), .O(z05));
