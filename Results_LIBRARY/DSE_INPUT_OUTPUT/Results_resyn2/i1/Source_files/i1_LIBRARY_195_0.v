...
module FAU ( 
  ...
  nand2  g28(.a(new_n46_), .b(x15), .O(z06));
  ...
  nand2  g37(.a(new_n44_), .b(new_n75_), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(z10));
  nand2  g39(.a(new_n75_), .b(x17), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n78_), .c(new_n44_), .O(z11));
  nand3  g41(.a(new_n75_), .b(x23), .c(x14), .O(new_n83_));
