...
module FAU ( 
  ...
  nand2  g10(.a(x23), .b(x19), .O(new_n52_));
  aoi21  g11(.a(new_n51_), .b(x00), .c(new_n52_), .O(z01));
  inv1   g12(.a(new_n52_), .O(z06));
  ...
  nand4  g28(.a(new_n69_), .b(new_n59_), .c(new_n48_), .d(new_n47_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x23), .O(new_n71_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nor2   g36(.a(new_n44_), .b(new_n77_), .O(z08));
  nor3   g37(.a(new_n44_), .b(new_n75_), .c(new_n77_), .O(z09));
  nand3  g38(.a(new_n75_), .b(x22), .c(x14), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n45_), .O(z10));
  nand2  g40(.a(x22), .b(x17), .O(new_n82_));
  nor3   g41(.a(new_n82_), .b(new_n44_), .c(x24), .O(z11));
  ...
  nand3  g50(.a(new_n91_), .b(new_n90_), .c(new_n45_), .O(z15));
endmodule
