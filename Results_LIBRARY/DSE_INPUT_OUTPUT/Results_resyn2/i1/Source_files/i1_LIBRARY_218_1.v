...
module FAU ( 
  ...
  nand2  g09(.a(x19), .b(x11), .O(new_n51_));
  ...
  nand2  g33(.a(new_n74_), .b(new_n64_), .O(z07));
  nor2   g34(.a(x19), .b(x11), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z08));
  inv1   g36(.a(x24), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x11), .c(new_n76_), .O(z09));
  inv1   g38(.a(x14), .O(new_n80_));
  nand2  g39(.a(new_n78_), .b(x22), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(new_n44_), .c(new_n80_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  oai21  g42(.a(new_n81_), .b(new_n83_), .c(new_n64_), .O(z11));
  nand2  g43(.a(new_n78_), .b(x23), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n80_), .c(new_n64_), .O(z12));
  oai21  g45(.a(new_n85_), .b(new_n83_), .c(new_n64_), .O(z13));
