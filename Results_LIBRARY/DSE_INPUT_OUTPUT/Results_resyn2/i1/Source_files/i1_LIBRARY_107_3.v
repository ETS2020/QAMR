...
module FAU ( 
  ...
  nand4  g14(.a(new_n47_), .b(new_n46_), .c(new_n55_), .d(new_n54_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(x00), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n53_), .c(new_n49_), .O(z02));
  inv1   g17(.a(x20), .O(new_n59_));
  inv1   g18(.a(new_n42_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n59_), .O(z03));
  inv1   g20(.a(x21), .O(new_n62_));
  nand3  g21(.a(new_n42_), .b(new_n62_), .c(new_n59_), .O(z04));
  inv1   g22(.a(x10), .O(new_n64_));
  nand4  g23(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(x19), .O(new_n65_));
