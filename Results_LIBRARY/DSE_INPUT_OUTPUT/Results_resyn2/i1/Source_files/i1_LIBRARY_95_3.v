...
module FAU ( 
  ...
  aoi22  g24(.a(x23), .b(x19), .c(new_n65_), .d(new_n63_), .O(z04));
  ...
  nand4  g40(.a(new_n43_), .b(new_n75_), .c(x22), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z11));
  nand4  g42(.a(new_n75_), .b(x23), .c(new_n50_), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z12));
  nand4  g44(.a(new_n75_), .b(x23), .c(new_n50_), .d(x17), .O(new_n86_));
