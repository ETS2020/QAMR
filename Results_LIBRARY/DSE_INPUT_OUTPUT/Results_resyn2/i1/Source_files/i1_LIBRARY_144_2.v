...
module FAU ( 
  ...
  nor2   g26(.a(new_n67_), .b(new_n56_), .O(z04));
  nand2  g27(.a(new_n44_), .b(x10), .O(new_n69_));
  nand3  g28(.a(x19), .b(new_n53_), .c(new_n50_), .O(new_n70_));
  ...
  nor3   g35(.a(new_n56_), .b(new_n73_), .c(new_n75_), .O(z09));
  nand4  g36(.a(new_n44_), .b(new_n73_), .c(x22), .d(x14), .O(new_n78_));
  ...
  nand4  g41(.a(new_n44_), .b(new_n73_), .c(x23), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand2  g43(.a(new_n44_), .b(x23), .O(new_n85_));
