...
module FAU ( 
  ...
  nor3   g11(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n46_), .c(new_n42_), .O(new_n54_));
  ...
  nor2   g18(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n54_), .c(x19), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n52_), .O(z02));
  ...
  oai21  g28(.a(new_n67_), .b(new_n57_), .c(new_n69_), .O(z05));
  ...
  nor3   g36(.a(new_n68_), .b(new_n74_), .c(new_n76_), .O(z09));
  ...
  nand3  g44(.a(new_n74_), .b(x23), .c(x14), .O(new_n86_));
