...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n60_, new_n61_, new_n63_, new_n67_, new_n68_, new_n70_,
    new_n73_, new_n74_, new_n75_, new_n76_, new_n78_, new_n80_, new_n82_,
  ...
  aoi21  g22(.a(new_n63_), .b(new_n60_), .c(new_n61_), .O(z04));
  and2   g23(.a(new_n44_), .b(x10), .O(z05));
  nor2   g24(.a(new_n46_), .b(new_n43_), .O(z06));
  inv1   g25(.a(x18), .O(new_n67_));
  inv1   g26(.a(x24), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n67_), .c(new_n44_), .O(z07));
  inv1   g28(.a(x11), .O(new_n70_));
  nand2  g29(.a(new_n44_), .b(new_n70_), .O(z08));
  nor3   g30(.a(new_n61_), .b(new_n68_), .c(new_n70_), .O(z09));
  inv1   g31(.a(x22), .O(new_n73_));
  nand2  g32(.a(new_n44_), .b(new_n68_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  ...
  nand3  g38(.a(new_n68_), .b(x23), .c(x14), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n44_), .O(z12));
  nand2  g40(.a(x23), .b(x17), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n74_), .O(z13));
  nand2  g42(.a(new_n68_), .b(x16), .O(new_n84_));
