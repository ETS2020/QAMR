...
module FAU ( 
  ...
  nor2   g26(.a(new_n63_), .b(x10), .O(new_n68_));
  oai21  g27(.a(new_n67_), .b(new_n54_), .c(new_n68_), .O(z05));
  ...
  nand2  g35(.a(new_n44_), .b(x14), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n76_), .O(z10));
  nand4  g37(.a(new_n74_), .b(x22), .c(x19), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand2  g39(.a(new_n74_), .b(x23), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n77_), .O(z12));
  nand4  g41(.a(new_n74_), .b(x23), .c(x19), .d(x17), .O(new_n83_));
