...
module FAU ( 
  ...
  nand2  g10(.a(x19), .b(x08), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(x09), .O(new_n53_));
  nand2  g12(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  aoi21  g13(.a(x19), .b(new_n42_), .c(new_n43_), .O(new_n55_));
  oai21  g14(.a(new_n54_), .b(new_n49_), .c(new_n55_), .O(z01));
  nor3   g15(.a(x07), .b(x06), .c(x05), .O(new_n57_));
  nand4  g16(.a(new_n51_), .b(new_n48_), .c(new_n47_), .d(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n49_), .b(new_n42_), .O(new_n59_));
  ...
  nand2  g29(.a(new_n70_), .b(new_n67_), .O(z05));
  ...
  nor3   g35(.a(new_n43_), .b(new_n76_), .c(new_n74_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n76_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n64_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n64_), .O(z11));
  nand2  g41(.a(new_n76_), .b(x23), .O(new_n83_));
  nor3   g42(.a(new_n83_), .b(new_n43_), .c(new_n78_), .O(z12));
  oai21  g43(.a(new_n83_), .b(new_n81_), .c(new_n64_), .O(z13));
  nand2  g44(.a(new_n76_), .b(x16), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n64_), .O(z14));
