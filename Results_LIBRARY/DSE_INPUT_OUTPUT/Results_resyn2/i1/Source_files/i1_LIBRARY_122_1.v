...
module FAU ( 
  ...
  nand2  g15(.a(new_n51_), .b(z00), .O(new_n57_));
  nor3   g16(.a(x07), .b(x06), .c(x05), .O(new_n58_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(new_n60_));
  inv1   g19(.a(x08), .O(new_n61_));
  nor2   g20(.a(x09), .b(new_n61_), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(new_n60_), .c(new_n58_), .d(new_n43_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n57_), .c(new_n56_), .O(z02));
  ...
  nand4  g37(.a(new_n46_), .b(new_n77_), .c(x22), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand4  g39(.a(new_n46_), .b(new_n77_), .c(x22), .d(x17), .O(new_n81_));
