...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n62_, new_n64_, new_n65_, new_n67_, new_n68_,
    new_n70_, new_n71_, new_n74_, new_n75_, new_n77_, new_n78_, new_n80_,
    new_n82_, new_n84_, new_n86_;
  inv1   g00(.a(x00), .O(new_n42_));
  inv1   g01(.a(x14), .O(new_n43_));
  nand2  g02(.a(x19), .b(new_n43_), .O(new_n44_));
  nand2  g03(.a(new_n44_), .b(new_n42_), .O(z00));
  nand2  g04(.a(x19), .b(x14), .O(new_n46_));
  ...
  nand3  g23(.a(x19), .b(x14), .c(new_n57_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n55_), .c(new_n64_), .O(z05));
  ...
  nor2   g30(.a(new_n71_), .b(new_n70_), .O(z08));
  nor3   g31(.a(new_n71_), .b(new_n68_), .c(new_n70_), .O(z09));
  inv1   g32(.a(x22), .O(new_n74_));
  nand2  g33(.a(new_n68_), .b(x14), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z10));
  nand2  g35(.a(new_n44_), .b(new_n68_), .O(new_n77_));
  ...
  nand3  g40(.a(new_n68_), .b(x23), .c(x17), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n44_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  nor2   g43(.a(new_n77_), .b(new_n84_), .O(z14));
  nor3   g44(.a(x15), .b(x13), .c(x12), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(x19), .c(new_n43_), .O(z15));
  buf    g46(.a(x19), .O(z06));
endmodule
