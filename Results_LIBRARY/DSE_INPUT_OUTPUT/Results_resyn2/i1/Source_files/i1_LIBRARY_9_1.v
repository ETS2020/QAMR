...
module FAU ( 
  ...
  nor2   g31(.a(new_n72_), .b(new_n62_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nor2   g33(.a(new_n62_), .b(new_n74_), .O(z08));
  inv1   g34(.a(x24), .O(new_n76_));
  nor3   g35(.a(new_n62_), .b(new_n76_), .c(new_n74_), .O(z09));
  nand2  g36(.a(new_n76_), .b(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x19), .c(new_n70_), .O(z10));
  nand2  g38(.a(new_n76_), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x19), .c(new_n70_), .O(z11));
  inv1   g40(.a(x23), .O(new_n82_));
  nor3   g41(.a(new_n78_), .b(new_n62_), .c(new_n82_), .O(z12));
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n44_), .O(z13));
