...
module FAU ( 
  ...
  nand2  g10(.a(x22), .b(new_n51_), .O(new_n52_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n51_), .c(new_n66_), .O(z04));
  inv1   g27(.a(x10), .O(new_n69_));
  nor2   g28(.a(new_n55_), .b(x08), .O(new_n70_));
  ...
  nand2  g35(.a(new_n52_), .b(new_n76_), .O(z08));
  inv1   g36(.a(x24), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n76_), .c(new_n52_), .O(z09));
  nand2  g38(.a(new_n78_), .b(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x21), .c(new_n43_), .O(z10));
  nand2  g40(.a(new_n78_), .b(x17), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x21), .c(new_n43_), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  oai21  g43(.a(new_n80_), .b(new_n84_), .c(new_n52_), .O(z12));
  oai21  g44(.a(new_n82_), .b(new_n84_), .c(new_n52_), .O(z13));
