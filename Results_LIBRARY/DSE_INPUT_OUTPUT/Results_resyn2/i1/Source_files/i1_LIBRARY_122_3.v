...
module FAU ( 
  ...
  nand2  g12(.a(new_n53_), .b(new_n43_), .O(z01));
  ...
  oai21  g17(.a(new_n44_), .b(new_n42_), .c(new_n50_), .O(new_n59_));
  ...
  and2   g28(.a(new_n43_), .b(x19), .O(z06));
  ...
  nand3  g35(.a(new_n43_), .b(new_n75_), .c(x22), .O(new_n77_));
