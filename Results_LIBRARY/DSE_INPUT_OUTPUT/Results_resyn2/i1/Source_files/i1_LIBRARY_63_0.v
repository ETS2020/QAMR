// Benchmark "FAU" written by ABC on Tue Aug 11 19:27:36 2020
...
module FAU ( 
  ...
  nor2   g05(.a(x03), .b(x02), .O(new_n47_));
  nor2   g06(.a(x07), .b(x06), .O(new_n48_));
  nor3   g07(.a(x05), .b(x04), .c(x01), .O(new_n49_));
  ...
  nand4  g20(.a(new_n61_), .b(x08), .c(new_n60_), .d(new_n59_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n58_), .c(x19), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n53_), .O(new_n64_));
  nand3  g23(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(x19), .c(x00), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n64_), .O(z02));
  ...
  nor2   g32(.a(x05), .b(x04), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n48_), .c(new_n47_), .d(new_n73_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n53_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n72_), .O(z05));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n43_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n44_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n44_), .O(z09));
  ...
  nand2  g48(.a(new_n83_), .b(x17), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n44_), .O(z11));
  nand2  g50(.a(new_n86_), .b(x23), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  inv1   g52(.a(x23), .O(new_n94_));
  oai21  g53(.a(new_n90_), .b(new_n94_), .c(new_n44_), .O(z13));
  nand2  g54(.a(new_n83_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(z14));
  nor2   g56(.a(x13), .b(x12), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(new_n44_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
