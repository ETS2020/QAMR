...
module FAU ( 
  ...
  nor2   g09(.a(x07), .b(new_n42_), .O(new_n51_));
  ...
  nor3   g34(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(z09));
  nand4  g35(.a(new_n43_), .b(new_n74_), .c(x22), .d(x14), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z10));
  nand3  g37(.a(new_n74_), .b(x22), .c(x17), .O(new_n79_));
