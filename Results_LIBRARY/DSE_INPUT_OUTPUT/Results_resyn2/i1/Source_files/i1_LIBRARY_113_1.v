...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_;
  ...
  nand3  g20(.a(new_n61_), .b(new_n57_), .c(x12), .O(new_n62_));
  ...
  nor3   g40(.a(new_n81_), .b(new_n44_), .c(x24), .O(z11));
  ...
  nor3   g47(.a(x15), .b(x14), .c(x13), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(x19), .c(new_n54_), .O(z15));
  buf    g49(.a(x19), .O(z06));
endmodule
