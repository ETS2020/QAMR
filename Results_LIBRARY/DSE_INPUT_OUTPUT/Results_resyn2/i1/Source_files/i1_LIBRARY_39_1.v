...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n84_, new_n86_, new_n87_;
  ...
  nand2  g35(.a(new_n75_), .b(x14), .O(new_n77_));
  nand2  g36(.a(new_n45_), .b(x22), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n77_), .O(z10));
  nand2  g38(.a(new_n75_), .b(x17), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n78_), .O(z11));
  aoi21  g40(.a(new_n77_), .b(x19), .c(new_n43_), .O(z12));
  aoi21  g41(.a(new_n80_), .b(x19), .c(new_n43_), .O(z13));
