...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
    new_n70_, new_n71_, new_n73_, new_n74_, new_n77_, new_n79_, new_n81_,
  ...
  aoi21  g36(.a(new_n77_), .b(x19), .c(new_n68_), .O(z10));
  inv1   g37(.a(x17), .O(new_n79_));
  nor3   g38(.a(new_n77_), .b(new_n74_), .c(new_n79_), .O(z11));
  nand2  g39(.a(new_n71_), .b(x23), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x19), .c(new_n68_), .O(z12));
  oai21  g41(.a(new_n81_), .b(new_n79_), .c(new_n44_), .O(z13));
  inv1   g42(.a(x16), .O(new_n84_));
  nor3   g43(.a(new_n74_), .b(x24), .c(new_n84_), .O(z14));
  nor2   g44(.a(x13), .b(x12), .O(new_n86_));
  nor2   g45(.a(x15), .b(x14), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n74_), .O(z15));
endmodule
