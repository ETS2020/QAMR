...
module FAU ( 
  ...
  oai21  g17(.a(new_n43_), .b(x00), .c(x02), .O(new_n59_));
  nor3   g18(.a(x07), .b(x06), .c(x05), .O(new_n60_));
  nor3   g19(.a(x04), .b(x03), .c(x01), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n60_), .c(new_n42_), .O(new_n62_));
  nor2   g21(.a(new_n54_), .b(new_n50_), .O(new_n63_));
  ...
  nand2  g27(.a(x19), .b(new_n51_), .O(new_n69_));
  nor2   g28(.a(new_n56_), .b(x10), .O(new_n70_));
  ...
  nor2   g37(.a(new_n78_), .b(new_n56_), .O(new_n79_));
