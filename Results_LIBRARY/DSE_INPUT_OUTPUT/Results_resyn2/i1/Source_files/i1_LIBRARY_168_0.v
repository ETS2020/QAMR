...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n73_, new_n74_, new_n75_, new_n77_, new_n79_,
  ...
  nand2  g29(.a(new_n70_), .b(new_n44_), .O(z07));
  and2   g30(.a(x24), .b(x11), .O(z09));
  inv1   g31(.a(x14), .O(new_n73_));
  inv1   g32(.a(x24), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x22), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n73_), .c(new_n44_), .O(z10));
  inv1   g35(.a(x17), .O(new_n77_));
  oai21  g36(.a(new_n75_), .b(new_n77_), .c(new_n44_), .O(z11));
  nand2  g37(.a(new_n74_), .b(x23), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(new_n43_), .c(new_n73_), .O(z12));
  oai21  g39(.a(new_n79_), .b(new_n77_), .c(new_n44_), .O(z13));
  nand2  g40(.a(new_n74_), .b(x16), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n44_), .O(z14));
  nor2   g42(.a(x13), .b(x12), .O(new_n84_));
  nor2   g43(.a(x15), .b(x14), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(new_n44_), .O(z15));
  buf    g45(.a(x19), .O(z06));
  buf    g46(.a(x11), .O(z08));
endmodule
