...
module FAU ( 
  ...
  nand4  g39(.a(new_n77_), .b(x22), .c(x17), .d(x10), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand4  g41(.a(new_n77_), .b(x23), .c(x14), .d(x10), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand4  g43(.a(new_n77_), .b(x23), .c(x17), .d(x10), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z13));
  nand2  g45(.a(x16), .b(x10), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(x24), .O(z14));
