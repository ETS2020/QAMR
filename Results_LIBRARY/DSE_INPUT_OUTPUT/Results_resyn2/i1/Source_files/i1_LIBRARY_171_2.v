...
module FAU ( 
  ...
  oai21  g12(.a(new_n43_), .b(x09), .c(new_n53_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nor2   g14(.a(x19), .b(new_n53_), .O(new_n56_));
  aoi21  g15(.a(x19), .b(new_n42_), .c(new_n56_), .O(new_n57_));
  oai21  g16(.a(new_n55_), .b(new_n50_), .c(new_n57_), .O(z01));
