...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n80_, new_n82_, new_n83_, new_n85_, new_n88_, new_n89_;
  ...
  nor2   g09(.a(new_n43_), .b(x08), .O(new_n51_));
  inv1   g10(.a(x08), .O(new_n52_));
  nand2  g11(.a(x09), .b(new_n52_), .O(new_n53_));
  oai21  g12(.a(new_n51_), .b(x09), .c(new_n53_), .O(new_n54_));
  nand2  g13(.a(x19), .b(x00), .O(new_n55_));
  oai21  g14(.a(x19), .b(x08), .c(new_n55_), .O(new_n56_));
  ...
  inv1   g25(.a(new_n51_), .O(new_n67_));
  nor2   g26(.a(x19), .b(new_n52_), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(x10), .O(new_n69_));
  oai21  g28(.a(new_n67_), .b(new_n50_), .c(new_n69_), .O(z05));
  ...
  nor2   g35(.a(new_n68_), .b(x24), .O(new_n77_));
