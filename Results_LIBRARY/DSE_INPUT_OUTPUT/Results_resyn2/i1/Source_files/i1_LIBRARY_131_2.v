...
module FAU ( 
  ...
  nand3  g21(.a(new_n62_), .b(new_n59_), .c(x19), .O(new_n63_));
  ...
  nor2   g28(.a(x24), .b(new_n52_), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(x10), .O(new_n71_));
  oai21  g30(.a(new_n69_), .b(new_n58_), .c(new_n71_), .O(z05));
  nand2  g31(.a(new_n44_), .b(new_n46_), .O(z06));
  and2   g32(.a(x24), .b(x18), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n70_), .b(new_n75_), .O(z08));
  oai21  g35(.a(new_n43_), .b(new_n75_), .c(new_n44_), .O(z09));
  nand2  g36(.a(x22), .b(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n52_), .c(x24), .O(z10));
  nand2  g38(.a(x22), .b(x17), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n52_), .c(x24), .O(z11));
  nand2  g40(.a(x23), .b(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n52_), .c(x24), .O(z12));
  nand2  g42(.a(x23), .b(x17), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n52_), .c(x24), .O(z13));
  nand3  g44(.a(new_n43_), .b(x16), .c(new_n52_), .O(new_n86_));
