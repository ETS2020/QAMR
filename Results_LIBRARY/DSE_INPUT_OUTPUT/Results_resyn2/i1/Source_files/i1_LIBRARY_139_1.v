...
module FAU ( 
  ...
  nand2  g09(.a(x19), .b(x17), .O(new_n51_));
  ...
  nor3   g35(.a(new_n74_), .b(new_n76_), .c(new_n73_), .O(z09));
  inv1   g36(.a(x22), .O(new_n78_));
  nand2  g37(.a(new_n76_), .b(x14), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n44_), .O(z10));
  nor3   g39(.a(x24), .b(new_n78_), .c(new_n43_), .O(z11));
  inv1   g40(.a(x23), .O(new_n82_));
  oai21  g41(.a(new_n79_), .b(new_n82_), .c(new_n44_), .O(z12));
  nor3   g42(.a(x24), .b(new_n82_), .c(new_n43_), .O(z13));
