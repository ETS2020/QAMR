...
module FAU ( 
  ...
  nand2  g29(.a(new_n70_), .b(x14), .O(z06));
  ...
  nor3   g44(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  nor2   g46(.a(new_n85_), .b(new_n87_), .O(z14));
  nor2   g47(.a(x13), .b(x12), .O(new_n89_));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x19), .O(z15));
endmodule
