...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n70_, new_n71_, new_n73_, new_n76_, new_n78_, new_n80_,
  ...
  nand3  g34(.a(new_n71_), .b(x22), .c(x14), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n44_), .O(z10));
  nand2  g36(.a(x22), .b(x17), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(new_n43_), .c(x24), .O(z11));
  ...
  nand2  g42(.a(new_n71_), .b(x16), .O(new_n84_));
