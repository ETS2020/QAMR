...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n73_, new_n75_, new_n77_, new_n78_, new_n81_,
  ...
  nand3  g18(.a(new_n50_), .b(new_n44_), .c(x00), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(new_n59_), .c(new_n55_), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  inv1   g21(.a(new_n44_), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n62_), .O(z03));
  inv1   g23(.a(x21), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(new_n63_), .O(z04));
  ...
  nor2   g28(.a(new_n63_), .b(new_n55_), .O(z06));
  ...
  nor3   g38(.a(x24), .b(new_n77_), .c(new_n43_), .O(z11));
  inv1   g39(.a(x23), .O(new_n81_));
  oai21  g40(.a(new_n78_), .b(new_n81_), .c(new_n44_), .O(z12));
  nor3   g41(.a(x24), .b(new_n81_), .c(new_n43_), .O(z13));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n63_), .O(z15));
endmodule
