...
module FAU ( 
  ...
  nand2  g01(.a(x24), .b(x20), .O(new_n43_));
  ...
  nand2  g12(.a(new_n49_), .b(new_n42_), .O(new_n54_));
  ...
  nand2  g18(.a(new_n59_), .b(new_n43_), .O(z02));
  ...
  nor2   g24(.a(new_n61_), .b(x10), .O(new_n66_));
  oai21  g25(.a(new_n65_), .b(new_n49_), .c(new_n66_), .O(z05));
  and2   g26(.a(new_n43_), .b(x19), .O(z06));
  ...
  oai21  g35(.a(new_n76_), .b(x24), .c(new_n43_), .O(z10));
  nand2  g36(.a(x22), .b(x17), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(x24), .O(z11));
