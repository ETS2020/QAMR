...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n78_, new_n80_, new_n81_, new_n82_, new_n84_, new_n86_, new_n88_,
  ...
  nor2   g09(.a(x10), .b(new_n42_), .O(new_n51_));
  ...
  nand4  g16(.a(new_n48_), .b(new_n47_), .c(new_n57_), .d(new_n56_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n42_), .O(new_n59_));
  nor2   g18(.a(new_n45_), .b(x10), .O(new_n60_));
  ...
  oai21  g29(.a(new_n70_), .b(new_n58_), .c(new_n68_), .O(z05));
  inv1   g30(.a(x24), .O(new_n72_));
  nor2   g31(.a(new_n65_), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g36(.a(new_n73_), .b(x11), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z09));
  nand3  g38(.a(new_n43_), .b(new_n72_), .c(x22), .O(new_n80_));
  ...
  oai21  g45(.a(new_n86_), .b(x24), .c(new_n43_), .O(z12));
  nand4  g46(.a(new_n43_), .b(new_n72_), .c(x23), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  oai21  g49(.a(x24), .b(new_n90_), .c(new_n43_), .O(z14));
