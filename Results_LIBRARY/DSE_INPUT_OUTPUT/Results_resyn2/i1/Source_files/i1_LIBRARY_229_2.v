...
module FAU ( 
  ...
  nand2  g04(.a(x23), .b(x19), .O(new_n46_));
  ...
  nand3  g18(.a(new_n59_), .b(new_n55_), .c(x23), .O(new_n60_));
  ...
  oai21  g25(.a(new_n51_), .b(x08), .c(x23), .O(new_n67_));
  ...
  nor3   g36(.a(new_n44_), .b(x24), .c(new_n77_), .O(new_n78_));
