...
module FAU ( 
  ...
  oai21  g27(.a(new_n67_), .b(new_n59_), .c(new_n68_), .O(z05));
  ...
  aoi21  g34(.a(new_n70_), .b(new_n73_), .c(new_n75_), .O(z09));
  ...
  oai21  g40(.a(new_n81_), .b(x24), .c(new_n43_), .O(z12));
