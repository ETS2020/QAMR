...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n66_, new_n68_, new_n70_, new_n71_, new_n74_, new_n76_, new_n78_,
  ...
  aoi22  g13(.a(new_n54_), .b(new_n53_), .c(new_n46_), .d(new_n48_), .O(z01));
  ...
  inv1   g17(.a(x07), .O(new_n59_));
  nor2   g18(.a(x06), .b(x05), .O(new_n60_));
  nand4  g19(.a(new_n51_), .b(new_n50_), .c(new_n60_), .d(new_n59_), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n42_), .O(new_n62_));
  nor2   g21(.a(new_n45_), .b(new_n48_), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(z02));
  inv1   g24(.a(x20), .O(new_n66_));
  nor2   g25(.a(new_n45_), .b(new_n66_), .O(z03));
  nor2   g26(.a(x21), .b(x20), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n46_), .O(z04));
  nor2   g28(.a(new_n48_), .b(x08), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n43_), .c(new_n45_), .O(z05));
  nand2  g31(.a(new_n46_), .b(new_n48_), .O(z06));
  inv1   g32(.a(x18), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n43_), .c(new_n44_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nor2   g35(.a(new_n45_), .b(new_n76_), .O(z08));
  nand3  g36(.a(x24), .b(x11), .c(new_n43_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z09));
  inv1   g38(.a(x14), .O(new_n80_));
  inv1   g39(.a(x22), .O(new_n81_));
  nor3   g40(.a(x24), .b(new_n81_), .c(new_n80_), .O(z10));
  nand2  g41(.a(new_n44_), .b(x17), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n46_), .O(z11));
  inv1   g43(.a(x23), .O(new_n85_));
  nor3   g44(.a(x24), .b(new_n85_), .c(new_n80_), .O(z12));
  oai21  g45(.a(new_n83_), .b(new_n85_), .c(new_n46_), .O(z13));
  nand2  g46(.a(new_n44_), .b(x16), .O(new_n88_));
