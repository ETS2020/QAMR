...
module FAU ( 
  ...
  nand2  g29(.a(new_n72_), .b(new_n51_), .O(new_n73_));
  oai21  g30(.a(new_n73_), .b(new_n64_), .c(new_n47_), .O(z04));
  inv1   g31(.a(x09), .O(new_n75_));
  nand2  g32(.a(new_n63_), .b(new_n47_), .O(new_n76_));
  nor4   g33(.a(new_n76_), .b(new_n50_), .c(new_n75_), .d(new_n49_), .O(z05));
  nor3   g34(.a(new_n76_), .b(new_n66_), .c(new_n49_), .O(z06));
  ...
  nand4  g42(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n47_), .O(new_n86_));
  ...
  nor2   g64(.a(new_n91_), .b(new_n104_), .O(new_n108_));
  nand2  g65(.a(new_n104_), .b(x20), .O(new_n109_));
  nand3  g66(.a(new_n105_), .b(x16), .c(x15), .O(new_n110_));
  ...
  nand3  g71(.a(new_n100_), .b(x15), .c(new_n98_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(new_n109_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n97_), .c(new_n108_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n114_), .c(new_n47_), .O(z11));
  oai21  g75(.a(new_n50_), .b(new_n49_), .c(new_n63_), .O(new_n119_));
  ...
  nand3  g82(.a(new_n47_), .b(new_n125_), .c(x09), .O(new_n126_));
  aoi21  g83(.a(new_n124_), .b(new_n119_), .c(new_n126_), .O(z12));
  nand3  g84(.a(new_n121_), .b(new_n52_), .c(x17), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n47_), .O(z13));
  nand3  g86(.a(new_n69_), .b(new_n50_), .c(new_n75_), .O(new_n130_));
  oai21  g87(.a(new_n130_), .b(new_n55_), .c(new_n47_), .O(z14));
  oai21  g88(.a(x10), .b(new_n62_), .c(x02), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(x00), .O(new_n133_));
  nand3  g90(.a(x19), .b(new_n49_), .c(new_n62_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n133_), .c(new_n60_), .O(z15));
  oai21  g92(.a(new_n62_), .b(x00), .c(new_n47_), .O(z16));
  nand2  g93(.a(new_n87_), .b(new_n47_), .O(z17));
endmodule
