...
module FAU ( 
  ...
  nor2   g31(.a(new_n66_), .b(x01), .O(new_n76_));
  ...
  nor2   g38(.a(new_n82_), .b(x16), .O(new_n83_));
  nand4  g39(.a(new_n83_), .b(new_n81_), .c(new_n80_), .d(new_n76_), .O(new_n84_));
  nand3  g40(.a(new_n61_), .b(new_n82_), .c(x01), .O(new_n85_));
  inv1   g41(.a(x21), .O(new_n86_));
  inv1   g42(.a(x22), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n86_), .c(new_n45_), .O(new_n88_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n88_), .O(z09));
  nand4  g45(.a(x21), .b(new_n82_), .c(new_n52_), .d(x18), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n87_), .c(new_n45_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(x01), .O(new_n92_));
  inv1   g48(.a(x14), .O(new_n93_));
  nand2  g49(.a(x15), .b(new_n93_), .O(new_n94_));
  nand3  g50(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n95_));
  nor2   g51(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nor2   g52(.a(new_n79_), .b(new_n72_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n92_), .O(z10));
  oai21  g55(.a(new_n90_), .b(x22), .c(new_n45_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(x01), .O(new_n101_));
  inv1   g57(.a(x16), .O(new_n102_));
  nand3  g58(.a(new_n97_), .b(new_n96_), .c(new_n102_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n101_), .O(z11));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n105_));
  nand3  g61(.a(new_n52_), .b(x17), .c(new_n66_), .O(new_n106_));
  inv1   g62(.a(x24), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(x09), .c(new_n46_), .d(new_n45_), .O(new_n108_));
  aoi21  g64(.a(new_n106_), .b(new_n105_), .c(new_n108_), .O(z12));
  oai21  g65(.a(new_n106_), .b(new_n47_), .c(new_n55_), .O(z13));
  nor2   g66(.a(new_n59_), .b(new_n49_), .O(z14));
  aoi21  g67(.a(x19), .b(new_n46_), .c(x00), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(new_n76_), .O(z15));
  nand2  g69(.a(new_n72_), .b(new_n55_), .O(z17));
  zero   g70(.O(z06));
  inv1   g71(.a(new_n55_), .O(z05));
  buf    g72(.a(x01), .O(z16));
endmodule
