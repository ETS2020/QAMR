...
module FAU ( 
  ...
  nand2  g14(.a(new_n57_), .b(x00), .O(new_n58_));
  ...
  nor3   g19(.a(x09), .b(new_n62_), .c(new_n46_), .O(new_n63_));
  nand3  g20(.a(x12), .b(x11), .c(x10), .O(new_n64_));
  inv1   g21(.a(new_n64_), .O(new_n65_));
  aoi21  g22(.a(new_n65_), .b(new_n63_), .c(new_n57_), .O(new_n66_));
  nand4  g23(.a(new_n48_), .b(new_n52_), .c(x18), .d(new_n50_), .O(new_n67_));
  oai21  g24(.a(new_n66_), .b(new_n45_), .c(new_n67_), .O(z03));
  inv1   g25(.a(x11), .O(new_n69_));
  inv1   g26(.a(x12), .O(new_n70_));
  nand4  g27(.a(new_n63_), .b(new_n70_), .c(new_n69_), .d(x10), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x23), .c(new_n45_), .O(z04));
  nand3  g29(.a(x02), .b(x01), .c(x00), .O(new_n73_));
  nand2  g30(.a(x23), .b(x10), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n73_), .c(new_n44_), .O(z05));
  nor4   g32(.a(new_n74_), .b(new_n73_), .c(new_n69_), .d(x09), .O(z06));
  nand4  g33(.a(new_n70_), .b(x11), .c(x10), .d(new_n44_), .O(new_n77_));
  nand3  g34(.a(x23), .b(x02), .c(x00), .O(new_n78_));
  ...
  nor3   g43(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(z08));
  ...
  oai21  g60(.a(new_n103_), .b(new_n100_), .c(new_n58_), .O(z09));
  nand3  g61(.a(new_n99_), .b(x22), .c(x21), .O(new_n105_));
  nor2   g62(.a(new_n93_), .b(x14), .O(new_n106_));
  nand4  g63(.a(new_n102_), .b(new_n101_), .c(x20), .d(x16), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n106_), .c(new_n91_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(x00), .O(z10));
  nand2  g67(.a(new_n102_), .b(new_n45_), .O(new_n111_));
  nand2  g68(.a(new_n99_), .b(x21), .O(new_n112_));
  nor2   g69(.a(new_n97_), .b(x16), .O(new_n113_));
  nand4  g70(.a(new_n106_), .b(new_n113_), .c(new_n91_), .d(new_n101_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n52_), .b(x17), .c(new_n62_), .O(new_n119_));
  ...
  nor2   g80(.a(new_n119_), .b(new_n47_), .O(z13));
  oai21  g81(.a(new_n60_), .b(new_n49_), .c(new_n58_), .O(z14));
  aoi21  g82(.a(x19), .b(new_n46_), .c(x00), .O(new_n126_));
  oai21  g83(.a(x10), .b(new_n46_), .c(x23), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(x00), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(x02), .c(new_n126_), .O(z15));
  aoi21  g86(.a(x23), .b(x00), .c(new_n84_), .O(z16));
  inv1   g87(.a(new_n85_), .O(z17));
endmodule
