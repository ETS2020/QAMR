...
module FAU ( 
  ...
  nor2   g21(.a(new_n44_), .b(new_n64_), .O(new_n65_));
  nand3  g22(.a(new_n65_), .b(x12), .c(x10), .O(new_n66_));
  inv1   g23(.a(x02), .O(new_n67_));
  nor2   g24(.a(x09), .b(new_n67_), .O(new_n68_));
  nand3  g25(.a(new_n68_), .b(new_n45_), .c(x11), .O(new_n69_));
  nand3  g26(.a(new_n50_), .b(x18), .c(new_n48_), .O(new_n70_));
  oai22  g27(.a(new_n70_), .b(new_n63_), .c(new_n69_), .d(new_n66_), .O(z03));
  nor2   g28(.a(x12), .b(x11), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n68_), .c(x10), .d(x00), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(new_n45_), .c(new_n44_), .O(z04));
  nand2  g31(.a(new_n65_), .b(x02), .O(new_n75_));
  nand3  g32(.a(new_n45_), .b(x10), .c(x09), .O(new_n76_));
  nor2   g33(.a(new_n76_), .b(new_n75_), .O(z05));
  nand2  g34(.a(new_n45_), .b(x11), .O(new_n78_));
  nand2  g35(.a(x10), .b(new_n52_), .O(new_n79_));
  nor3   g36(.a(new_n79_), .b(new_n75_), .c(new_n78_), .O(z06));
  inv1   g37(.a(x12), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(x11), .O(new_n82_));
  oai21  g39(.a(new_n82_), .b(new_n79_), .c(x01), .O(new_n83_));
  nand3  g40(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  nand2  g41(.a(new_n84_), .b(new_n47_), .O(z07));
  ...
  nand3  g46(.a(x02), .b(new_n44_), .c(new_n64_), .O(new_n90_));
  ...
  nand4  g54(.a(x12), .b(new_n97_), .c(x02), .d(new_n44_), .O(new_n98_));
  ...
  oai21  g59(.a(new_n102_), .b(new_n98_), .c(new_n96_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n94_), .c(new_n93_), .d(new_n64_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n47_), .O(z09));
  nor2   g62(.a(new_n46_), .b(new_n64_), .O(new_n106_));
  inv1   g63(.a(new_n98_), .O(new_n107_));
  nand4  g64(.a(new_n93_), .b(x20), .c(x15), .d(new_n99_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nor2   g66(.a(new_n100_), .b(x14), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n109_), .c(new_n107_), .d(new_n94_), .O(new_n111_));
  nor2   g68(.a(new_n96_), .b(new_n93_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(x22), .c(new_n46_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n111_), .c(new_n106_), .O(z10));
  inv1   g71(.a(new_n112_), .O(new_n115_));
  nand3  g72(.a(new_n109_), .b(new_n107_), .c(new_n100_), .O(new_n116_));
  nand3  g73(.a(new_n94_), .b(new_n45_), .c(new_n64_), .O(new_n117_));
  aoi21  g74(.a(new_n116_), .b(new_n115_), .c(new_n117_), .O(z11));
  nand2  g75(.a(x10), .b(x02), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n65_), .c(new_n45_), .O(new_n120_));
  ...
  nand2  g81(.a(new_n124_), .b(new_n53_), .O(new_n125_));
  inv1   g82(.a(x24), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(x09), .O(new_n127_));
  aoi21  g84(.a(new_n125_), .b(new_n120_), .c(new_n127_), .O(z12));
  nor2   g85(.a(new_n123_), .b(new_n54_), .O(z13));
  nor2   g86(.a(new_n61_), .b(new_n56_), .O(z14));
  aoi21  g87(.a(x19), .b(new_n44_), .c(new_n106_), .O(new_n131_));
  nand3  g88(.a(new_n65_), .b(new_n45_), .c(new_n60_), .O(new_n132_));
  oai21  g89(.a(new_n131_), .b(x02), .c(new_n132_), .O(z15));
  nand3  g90(.a(new_n45_), .b(x01), .c(new_n64_), .O(new_n134_));
  inv1   g91(.a(new_n134_), .O(z16));
  nand2  g92(.a(new_n90_), .b(new_n47_), .O(z17));
endmodule
