...
module FAU ( 
  ...
  nand3  g28(.a(x19), .b(new_n51_), .c(x17), .O(new_n75_));
  ...
  nor2   g34(.a(new_n67_), .b(x01), .O(new_n81_));
  ...
  nand4  g44(.a(x21), .b(new_n83_), .c(new_n52_), .d(x18), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n88_), .c(new_n45_), .O(new_n92_));
  ...
  oai21  g54(.a(new_n91_), .b(x22), .c(new_n45_), .O(new_n101_));
  ...
  nand3  g60(.a(new_n52_), .b(x17), .c(new_n67_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nor2   g62(.a(x24), .b(new_n44_), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n108_), .c(new_n73_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n55_), .O(z12));
  nor2   g65(.a(new_n107_), .b(new_n47_), .O(z13));
  nor2   g66(.a(new_n59_), .b(new_n49_), .O(z14));
  aoi21  g67(.a(x19), .b(new_n46_), .c(x00), .O(new_n114_));
  nor2   g68(.a(new_n114_), .b(new_n81_), .O(z15));
