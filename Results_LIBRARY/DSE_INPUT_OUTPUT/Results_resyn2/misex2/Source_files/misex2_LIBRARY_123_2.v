...
module FAU ( 
  ...
  nand3  g40(.a(new_n51_), .b(x19), .c(x17), .O(new_n84_));
  nor3   g41(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(z08));
  nand2  g42(.a(x02), .b(new_n58_), .O(new_n86_));
  ...
  nand4  g48(.a(x20), .b(new_n44_), .c(new_n91_), .d(new_n90_), .O(new_n92_));
  ...
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(new_n57_), .O(new_n101_));
  ...
  nor2   g68(.a(x22), .b(new_n44_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n106_), .c(new_n109_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n57_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n64_), .O(z10));
  nand2  g73(.a(new_n100_), .b(new_n57_), .O(new_n117_));
  ...
  oai21  g78(.a(new_n121_), .b(new_n117_), .c(new_n64_), .O(z11));
  oai21  g79(.a(new_n50_), .b(new_n103_), .c(new_n59_), .O(new_n123_));
  ...
  nand2  g84(.a(new_n127_), .b(new_n46_), .O(new_n128_));
  nor2   g85(.a(x24), .b(new_n45_), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(new_n64_), .O(new_n130_));
  aoi21  g87(.a(new_n128_), .b(new_n123_), .c(new_n130_), .O(z12));
  inv1   g88(.a(new_n46_), .O(new_n132_));
  oai21  g89(.a(new_n126_), .b(new_n132_), .c(new_n64_), .O(z13));
  nor3   g90(.a(new_n52_), .b(x10), .c(x09), .O(z14));
  oai21  g91(.a(x10), .b(new_n58_), .c(x02), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(x00), .O(new_n136_));
  nand3  g93(.a(x19), .b(new_n103_), .c(new_n58_), .O(new_n137_));
  nand3  g94(.a(new_n137_), .b(new_n136_), .c(new_n64_), .O(z15));
  nor3   g95(.a(new_n63_), .b(new_n58_), .c(x00), .O(z16));
  nand2  g96(.a(new_n83_), .b(new_n64_), .O(z17));
endmodule
