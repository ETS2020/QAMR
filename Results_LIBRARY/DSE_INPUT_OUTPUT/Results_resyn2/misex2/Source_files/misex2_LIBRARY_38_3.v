...
module FAU ( 
  ...
  nand3  g30(.a(new_n61_), .b(x10), .c(x09), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(new_n71_), .c(new_n58_), .O(z05));
  nor3   g32(.a(new_n68_), .b(x23), .c(new_n69_), .O(z06));
  inv1   g33(.a(new_n61_), .O(new_n77_));
  nand4  g34(.a(new_n67_), .b(new_n71_), .c(new_n70_), .d(x11), .O(new_n78_));
