...
module FAU ( 
  ...
  nand4  g29(.a(new_n74_), .b(x19), .c(new_n51_), .d(x17), .O(new_n75_));
  oai21  g30(.a(new_n75_), .b(new_n72_), .c(new_n55_), .O(z08));
  nor2   g31(.a(new_n67_), .b(x01), .O(new_n77_));
  ...
  nor2   g37(.a(new_n82_), .b(x16), .O(new_n83_));
  nor2   g38(.a(x15), .b(x14), .O(new_n84_));
  nand4  g39(.a(new_n84_), .b(new_n83_), .c(new_n81_), .d(new_n77_), .O(new_n85_));
  nand3  g40(.a(new_n61_), .b(new_n82_), .c(x01), .O(new_n86_));
  ...
  nand4  g45(.a(x21), .b(new_n82_), .c(new_n52_), .d(x18), .O(new_n91_));
  ...
  nand4  g50(.a(new_n88_), .b(new_n87_), .c(x20), .d(x16), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n95_), .c(new_n81_), .d(new_n74_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n93_), .O(z10));
  nand2  g54(.a(new_n88_), .b(new_n45_), .O(new_n100_));
  nand3  g55(.a(new_n87_), .b(x02), .c(new_n46_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n95_), .c(new_n83_), .d(new_n81_), .O(new_n103_));
  inv1   g58(.a(new_n91_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n109_), .b(x09), .c(new_n46_), .d(new_n45_), .O(new_n110_));
  aoi21  g65(.a(new_n108_), .b(new_n107_), .c(new_n110_), .O(z12));
  nor2   g66(.a(new_n108_), .b(new_n47_), .O(z13));
  nor2   g67(.a(new_n59_), .b(new_n49_), .O(z14));
  nand2  g68(.a(new_n67_), .b(new_n46_), .O(new_n114_));
  aoi21  g69(.a(new_n52_), .b(new_n45_), .c(new_n114_), .O(z15));
  nand2  g70(.a(new_n73_), .b(new_n55_), .O(z17));
  zero   g71(.O(z04));
  zero   g72(.O(z06));
  buf    g73(.a(x01), .O(z16));
endmodule
