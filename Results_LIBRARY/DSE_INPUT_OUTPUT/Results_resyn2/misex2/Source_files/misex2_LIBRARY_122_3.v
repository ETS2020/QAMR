...
module FAU ( 
  ...
  oai21  g30(.a(new_n74_), .b(new_n71_), .c(new_n60_), .O(z08));
  nand2  g31(.a(x02), .b(new_n46_), .O(new_n76_));
  ...
  nand3  g44(.a(new_n88_), .b(new_n87_), .c(new_n45_), .O(new_n89_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n89_), .O(z09));
  nand4  g46(.a(x21), .b(new_n83_), .c(new_n52_), .d(x18), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n88_), .c(new_n45_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x01), .O(new_n93_));
  nor2   g49(.a(new_n80_), .b(new_n76_), .O(new_n94_));
  nand3  g50(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n95_));
  inv1   g51(.a(x14), .O(new_n96_));
  nand3  g52(.a(x16), .b(x15), .c(new_n96_), .O(new_n97_));
  nor2   g53(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n94_), .c(new_n45_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n93_), .O(z10));
  oai21  g56(.a(new_n91_), .b(x22), .c(new_n45_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(x01), .O(new_n102_));
  inv1   g58(.a(x16), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x15), .c(new_n96_), .O(new_n104_));
  nor2   g60(.a(new_n104_), .b(new_n95_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n94_), .c(new_n45_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n102_), .O(z11));
  ...
  nand4  g68(.a(new_n112_), .b(new_n111_), .c(new_n46_), .d(new_n45_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n60_), .O(z12));
  oai21  g70(.a(new_n110_), .b(new_n47_), .c(new_n60_), .O(z13));
  nor2   g71(.a(new_n58_), .b(new_n49_), .O(z14));
  nand2  g72(.a(new_n109_), .b(new_n46_), .O(new_n117_));
  aoi21  g73(.a(new_n52_), .b(new_n45_), .c(new_n117_), .O(z15));
  nand2  g74(.a(new_n72_), .b(new_n60_), .O(z17));
  zero   g75(.O(z04));
