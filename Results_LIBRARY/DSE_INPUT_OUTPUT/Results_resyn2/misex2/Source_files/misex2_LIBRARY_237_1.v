...
module FAU ( 
  ...
  aoi21  g27(.a(new_n70_), .b(x00), .c(new_n59_), .O(z04));
  nand2  g28(.a(new_n64_), .b(x09), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x00), .c(new_n59_), .O(z05));
  nand2  g30(.a(new_n66_), .b(new_n64_), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n59_), .c(new_n58_), .O(z06));
  nor2   g32(.a(new_n59_), .b(new_n58_), .O(new_n76_));
  ...
  nand4  g38(.a(x19), .b(new_n49_), .c(x17), .d(new_n81_), .O(new_n82_));
  ...
  nand3  g46(.a(new_n89_), .b(new_n84_), .c(new_n83_), .O(new_n90_));
  aoi21  g47(.a(new_n90_), .b(new_n59_), .c(x00), .O(z08));
  nand2  g48(.a(new_n46_), .b(x02), .O(new_n92_));
  inv1   g49(.a(new_n92_), .O(z17));
  nor2   g50(.a(x14), .b(x13), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(x12), .c(new_n65_), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(z17), .O(new_n97_));
  ...
  nand4  g64(.a(new_n107_), .b(new_n96_), .c(z17), .d(x15), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(z10));
  nand4  g66(.a(new_n103_), .b(new_n96_), .c(z17), .d(x15), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(z11));
  oai21  g68(.a(new_n55_), .b(new_n44_), .c(new_n76_), .O(new_n112_));
  nand2  g69(.a(new_n60_), .b(new_n48_), .O(new_n113_));
  inv1   g70(.a(x23), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(new_n114_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n113_), .c(new_n46_), .O(new_n116_));
  inv1   g73(.a(x24), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(x09), .O(new_n118_));
  aoi21  g75(.a(new_n116_), .b(new_n112_), .c(new_n118_), .O(z12));
  nand2  g76(.a(new_n60_), .b(x17), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n59_), .c(x00), .O(z13));
  nor2   g78(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g79(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n44_), .c(new_n59_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n58_), .c(new_n124_), .O(z15));
  zero   g82(.O(z16));
endmodule
