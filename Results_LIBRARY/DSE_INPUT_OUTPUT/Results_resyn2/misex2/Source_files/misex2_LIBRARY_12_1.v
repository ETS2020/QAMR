...
module FAU ( 
  ...
  nor2   g39(.a(new_n55_), .b(x07), .O(new_n83_));
  nor2   g40(.a(new_n66_), .b(x18), .O(new_n84_));
  ...
  nand4  g57(.a(x20), .b(new_n78_), .c(new_n100_), .d(new_n99_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n98_), .c(new_n93_), .O(new_n103_));
  inv1   g60(.a(x21), .O(new_n104_));
  inv1   g61(.a(x22), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n104_), .c(new_n79_), .O(new_n106_));
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n45_), .O(z09));
  nor2   g64(.a(new_n92_), .b(new_n104_), .O(new_n108_));
  nand4  g65(.a(new_n104_), .b(x20), .c(x15), .d(new_n99_), .O(new_n109_));
  nand2  g66(.a(new_n105_), .b(x16), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  aoi22  g68(.a(new_n111_), .b(new_n98_), .c(new_n108_), .d(x22), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(x00), .c(new_n45_), .O(z10));
  nand2  g70(.a(new_n105_), .b(new_n79_), .O(new_n114_));
  nor2   g71(.a(new_n109_), .b(x16), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n98_), .c(new_n108_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n45_), .O(z11));
  nand2  g74(.a(x01), .b(x00), .O(new_n118_));
  aoi21  g75(.a(x10), .b(x02), .c(new_n118_), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  inv1   g77(.a(x02), .O(new_n121_));
  nand3  g78(.a(new_n66_), .b(x17), .c(new_n121_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n120_), .c(new_n54_), .O(new_n123_));
  inv1   g80(.a(x09), .O(new_n124_));
  nor2   g81(.a(x24), .b(new_n124_), .O(new_n125_));
  oai21  g82(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n45_), .O(z12));
  oai21  g84(.a(new_n122_), .b(new_n54_), .c(new_n45_), .O(z13));
  nand4  g85(.a(new_n46_), .b(new_n50_), .c(new_n124_), .d(new_n121_), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(new_n56_), .O(z14));
  oai21  g87(.a(x10), .b(new_n80_), .c(x02), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(x00), .O(new_n132_));
  nand3  g89(.a(x19), .b(new_n121_), .c(new_n80_), .O(new_n133_));
  nand3  g90(.a(new_n133_), .b(new_n132_), .c(new_n45_), .O(z15));
  nand2  g91(.a(x01), .b(new_n79_), .O(new_n135_));
  aoi21  g92(.a(x16), .b(new_n44_), .c(new_n135_), .O(z16));
  nand2  g93(.a(new_n81_), .b(new_n45_), .O(z17));
endmodule
