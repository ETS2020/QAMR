...
module FAU ( 
  ...
  nand4  g17(.a(new_n47_), .b(new_n51_), .c(x18), .d(new_n49_), .O(new_n61_));
  inv1   g18(.a(x00), .O(new_n62_));
  inv1   g19(.a(x02), .O(new_n63_));
  nor2   g20(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nor2   g21(.a(new_n58_), .b(x09), .O(new_n65_));
  nand3  g22(.a(new_n65_), .b(new_n64_), .c(x11), .O(new_n66_));
  inv1   g23(.a(x01), .O(new_n67_));
  nor2   g24(.a(new_n54_), .b(new_n67_), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(x12), .O(new_n69_));
  oai21  g26(.a(new_n69_), .b(new_n66_), .c(new_n61_), .O(z03));
  inv1   g27(.a(x11), .O(new_n71_));
  inv1   g28(.a(x12), .O(new_n72_));
  nand3  g29(.a(new_n65_), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  nand2  g30(.a(new_n68_), .b(new_n64_), .O(new_n74_));
  nor2   g31(.a(new_n74_), .b(new_n73_), .O(z04));
  nand3  g32(.a(new_n64_), .b(x10), .c(x09), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x04), .c(new_n67_), .O(z05));
  aoi21  g34(.a(new_n66_), .b(x04), .c(new_n67_), .O(z06));
  inv1   g35(.a(new_n64_), .O(new_n79_));
  nand4  g36(.a(new_n65_), .b(new_n72_), .c(x11), .d(x04), .O(new_n80_));
  ...
  nand4  g55(.a(new_n98_), .b(new_n97_), .c(x20), .d(new_n93_), .O(new_n99_));
  inv1   g56(.a(x21), .O(new_n100_));
  inv1   g57(.a(x22), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n62_), .O(new_n102_));
  aoi21  g59(.a(new_n99_), .b(new_n92_), .c(new_n102_), .O(z09));
  inv1   g60(.a(x14), .O(new_n104_));
  nand4  g61(.a(new_n100_), .b(x20), .c(x15), .d(new_n104_), .O(new_n105_));
  nand2  g62(.a(new_n101_), .b(x16), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g64(.a(x22), .b(x21), .c(x01), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n90_), .O(new_n109_));
  aoi21  g66(.a(new_n107_), .b(new_n97_), .c(new_n109_), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(x00), .c(new_n55_), .O(z10));
  nand2  g68(.a(new_n101_), .b(new_n62_), .O(new_n112_));
  nand3  g69(.a(new_n91_), .b(new_n68_), .c(x21), .O(new_n113_));
  inv1   g70(.a(new_n105_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n97_), .c(new_n93_), .O(new_n115_));
  ...
  nand3  g79(.a(new_n122_), .b(new_n68_), .c(x00), .O(new_n123_));
  inv1   g80(.a(x24), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x09), .O(new_n125_));
  aoi21  g82(.a(new_n123_), .b(new_n121_), .c(new_n125_), .O(z12));
  oai21  g83(.a(new_n119_), .b(new_n46_), .c(new_n55_), .O(z13));
  nor2   g84(.a(new_n59_), .b(new_n48_), .O(z14));
  oai21  g85(.a(x10), .b(new_n67_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n63_), .c(new_n67_), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(new_n130_), .c(new_n55_), .O(z15));
  nand3  g89(.a(x04), .b(x01), .c(new_n62_), .O(new_n133_));
  inv1   g90(.a(new_n133_), .O(z16));
  inv1   g91(.a(new_n86_), .O(z17));
endmodule
