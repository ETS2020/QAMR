...
module FAU ( 
  ...
  nor2   g02(.a(x16), .b(x04), .O(new_n46_));
  ...
  nand4  g13(.a(new_n47_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n57_));
  ...
  or2    g21(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  inv1   g22(.a(new_n46_), .O(new_n66_));
  inv1   g23(.a(x19), .O(new_n67_));
  nor2   g24(.a(x17), .b(x02), .O(new_n68_));
  nand4  g25(.a(new_n68_), .b(new_n51_), .c(new_n67_), .d(x18), .O(new_n69_));
  and2   g26(.a(new_n69_), .b(new_n66_), .O(new_n70_));
  oai21  g27(.a(new_n65_), .b(new_n59_), .c(new_n70_), .O(z03));
  inv1   g28(.a(x11), .O(new_n72_));
  nand4  g29(.a(new_n59_), .b(new_n72_), .c(x10), .d(new_n50_), .O(new_n73_));
  oai21  g30(.a(new_n73_), .b(new_n63_), .c(new_n66_), .O(z04));
  nor2   g31(.a(new_n56_), .b(new_n49_), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(new_n62_), .c(x09), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n66_), .O(z05));
  nand2  g34(.a(new_n65_), .b(new_n66_), .O(z06));
  oai21  g35(.a(new_n64_), .b(x12), .c(x01), .O(new_n79_));
  nand3  g36(.a(new_n79_), .b(x02), .c(x00), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(new_n66_), .O(z07));
  ...
  nand2  g42(.a(new_n51_), .b(x02), .O(new_n86_));
  inv1   g43(.a(new_n86_), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(x19), .c(new_n45_), .d(x17), .O(new_n88_));
  oai21  g45(.a(new_n88_), .b(new_n85_), .c(new_n66_), .O(z08));
  inv1   g46(.a(x20), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(new_n67_), .c(x18), .d(x01), .O(new_n91_));
  ...
  oai21  g62(.a(new_n105_), .b(new_n102_), .c(new_n66_), .O(z09));
  ...
  oai21  g68(.a(new_n111_), .b(x00), .c(new_n66_), .O(z10));
  nand2  g69(.a(new_n104_), .b(new_n60_), .O(new_n113_));
  nor2   g70(.a(new_n108_), .b(x16), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n96_), .c(new_n107_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n113_), .c(new_n66_), .O(z11));
  inv1   g73(.a(new_n62_), .O(new_n117_));
  nor3   g74(.a(x19), .b(x17), .c(x02), .O(new_n118_));
  nor2   g75(.a(x19), .b(x02), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(x23), .c(new_n51_), .O(new_n120_));
  oai22  g77(.a(new_n120_), .b(new_n118_), .c(new_n75_), .d(new_n117_), .O(new_n121_));
  nor2   g78(.a(x24), .b(new_n50_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n66_), .O(z12));
  nor2   g81(.a(x02), .b(x01), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(x17), .c(new_n60_), .O(new_n126_));
  ...
  aoi21  g86(.a(new_n125_), .b(x19), .c(new_n46_), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n60_), .c(new_n130_), .O(z15));
  nor3   g88(.a(new_n46_), .b(new_n61_), .c(x00), .O(z16));
  nor2   g89(.a(new_n86_), .b(new_n46_), .O(z17));
endmodule
