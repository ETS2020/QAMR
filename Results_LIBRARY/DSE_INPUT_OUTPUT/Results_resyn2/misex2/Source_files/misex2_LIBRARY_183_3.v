...
module FAU ( 
  ...
  nand4  g24(.a(new_n53_), .b(new_n47_), .c(x18), .d(new_n45_), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(new_n67_), .O(z03));
  inv1   g26(.a(x11), .O(new_n70_));
  inv1   g27(.a(x02), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n50_), .O(new_n72_));
  nor2   g29(.a(x12), .b(new_n58_), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(new_n72_), .c(new_n70_), .d(new_n49_), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(new_n62_), .c(new_n51_), .O(z04));
  nor4   g32(.a(new_n63_), .b(x16), .c(new_n49_), .d(new_n51_), .O(z05));
  aoi21  g33(.a(new_n65_), .b(new_n62_), .c(new_n51_), .O(z06));
  nand3  g34(.a(new_n73_), .b(x11), .c(new_n49_), .O(new_n78_));
  nand2  g35(.a(new_n78_), .b(x01), .O(new_n79_));
  nand2  g36(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  ...
  nand3  g42(.a(x02), .b(new_n51_), .c(new_n50_), .O(new_n86_));
  ...
  nand4  g49(.a(x12), .b(new_n70_), .c(x02), .d(new_n51_), .O(new_n93_));
  inv1   g50(.a(x15), .O(new_n94_));
  nor2   g51(.a(x14), .b(x13), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(x20), .c(new_n62_), .d(new_n94_), .O(new_n96_));
  oai21  g53(.a(new_n96_), .b(new_n93_), .c(new_n92_), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n90_), .c(new_n89_), .d(new_n50_), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n44_), .O(z09));
  nor2   g56(.a(new_n92_), .b(new_n89_), .O(new_n100_));
  nand4  g57(.a(new_n90_), .b(new_n89_), .c(x16), .d(x02), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand2  g59(.a(x20), .b(x15), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  inv1   g61(.a(x14), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n104_), .c(x12), .d(new_n70_), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  aoi22  g64(.a(new_n107_), .b(new_n102_), .c(new_n100_), .d(x22), .O(new_n108_));
  oai21  g65(.a(new_n108_), .b(x00), .c(new_n44_), .O(z10));
  inv1   g66(.a(new_n100_), .O(new_n110_));
  inv1   g67(.a(new_n93_), .O(new_n111_));
  inv1   g68(.a(new_n103_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n95_), .c(new_n111_), .d(new_n89_), .O(new_n113_));
  nand3  g70(.a(new_n90_), .b(new_n62_), .c(new_n50_), .O(new_n114_));
  ...
  nand4  g78(.a(new_n121_), .b(new_n62_), .c(x01), .d(x00), .O(new_n122_));
  ...
  nand3  g86(.a(x19), .b(new_n71_), .c(new_n51_), .O(new_n130_));
  nand3  g87(.a(new_n130_), .b(new_n129_), .c(new_n44_), .O(z15));
  nand3  g88(.a(new_n62_), .b(x01), .c(new_n50_), .O(new_n132_));
  inv1   g89(.a(new_n132_), .O(z16));
  nand2  g90(.a(new_n86_), .b(new_n44_), .O(z17));
endmodule
