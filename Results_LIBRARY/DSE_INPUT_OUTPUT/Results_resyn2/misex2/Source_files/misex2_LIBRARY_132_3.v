...
module FAU ( 
  ...
  nand2  g00(.a(x18), .b(x00), .O(new_n44_));
  ...
  nand2  g16(.a(x02), .b(x01), .O(new_n60_));
  nor2   g17(.a(new_n60_), .b(x09), .O(new_n61_));
  nand3  g18(.a(x12), .b(x11), .c(x10), .O(new_n62_));
  inv1   g19(.a(new_n62_), .O(new_n63_));
  aoi21  g20(.a(new_n63_), .b(new_n61_), .c(x18), .O(new_n64_));
  nor2   g21(.a(x02), .b(x01), .O(new_n65_));
  nand4  g22(.a(new_n65_), .b(new_n51_), .c(x18), .d(new_n49_), .O(new_n66_));
  ...
  aoi21  g27(.a(new_n70_), .b(new_n50_), .c(new_n59_), .O(z04));
  nand3  g28(.a(new_n50_), .b(x01), .c(x00), .O(new_n72_));
  nand2  g29(.a(x10), .b(x02), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z05));
  nand3  g31(.a(new_n61_), .b(x11), .c(x10), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n50_), .c(new_n59_), .O(z06));
  nand4  g33(.a(new_n69_), .b(x11), .c(x10), .d(new_n46_), .O(new_n77_));
  nand2  g34(.a(new_n77_), .b(x01), .O(new_n78_));
  nand2  g35(.a(new_n78_), .b(x02), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(new_n50_), .c(new_n59_), .O(z07));
  ...
  nand4  g63(.a(new_n100_), .b(x20), .c(x15), .d(new_n106_), .O(new_n107_));
  ...
  nand2  g69(.a(new_n101_), .b(new_n59_), .O(new_n113_));
  nand2  g70(.a(new_n104_), .b(x21), .O(new_n114_));
  nand3  g71(.a(new_n108_), .b(new_n96_), .c(new_n109_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(z11));
  nand4  g73(.a(new_n73_), .b(new_n50_), .c(x01), .d(x00), .O(new_n117_));
  ...
  nand3  g84(.a(new_n47_), .b(x19), .c(new_n45_), .O(new_n128_));
  aoi21  g85(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n129_));
  nand2  g86(.a(new_n50_), .b(x00), .O(new_n130_));
  oai21  g87(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(z15));
  nor2   g88(.a(new_n92_), .b(x00), .O(z16));
endmodule
