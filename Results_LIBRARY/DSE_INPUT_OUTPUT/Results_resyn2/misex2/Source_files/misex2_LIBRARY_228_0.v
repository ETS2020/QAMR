...
module FAU ( 
  ...
  nor2   g14(.a(new_n50_), .b(new_n48_), .O(z06));
  ...
  nor2   g25(.a(new_n61_), .b(x00), .O(z16));
  nor2   g26(.a(x21), .b(x20), .O(new_n72_));
  nand2  g27(.a(new_n72_), .b(z16), .O(new_n73_));
  nor2   g28(.a(new_n73_), .b(new_n70_), .O(z09));
  inv1   g29(.a(x21), .O(new_n75_));
  nor2   g30(.a(new_n75_), .b(x20), .O(new_n76_));
  nand3  g31(.a(new_n76_), .b(new_n69_), .c(x22), .O(new_n77_));
  aoi21  g32(.a(new_n77_), .b(x01), .c(x00), .O(z10));
  nand3  g33(.a(new_n76_), .b(new_n69_), .c(new_n67_), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(x01), .c(x00), .O(z11));
  inv1   g35(.a(x24), .O(new_n81_));
  nand2  g36(.a(new_n56_), .b(new_n81_), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(new_n58_), .O(z12));
  inv1   g38(.a(x10), .O(new_n85_));
  nand2  g39(.a(new_n57_), .b(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n86_), .b(new_n63_), .c(new_n52_), .O(z15));
  zero   g41(.O(z00));
  zero   g42(.O(z02));
  zero   g43(.O(z14));
