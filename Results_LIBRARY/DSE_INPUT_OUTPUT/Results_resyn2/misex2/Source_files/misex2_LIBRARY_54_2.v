...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_, new_n52_,
    ...
    new_n69_, new_n71_, new_n75_, new_n76_, new_n77_, new_n78_, new_n79_,
  ...
  nand4  g06(.a(new_n46_), .b(x10), .c(x09), .d(new_n49_), .O(new_n50_));
  ...
  nand3  g11(.a(new_n54_), .b(x09), .c(new_n49_), .O(new_n55_));
  ...
  nand3  g22(.a(x10), .b(new_n58_), .c(x02), .O(new_n66_));
  inv1   g23(.a(x01), .O(new_n67_));
  nor2   g24(.a(new_n67_), .b(new_n44_), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(new_n57_), .O(new_n69_));
  nor3   g26(.a(new_n69_), .b(new_n66_), .c(x11), .O(z04));
  nand3  g27(.a(x10), .b(x09), .c(x02), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x01), .c(new_n44_), .O(z05));
  aoi21  g29(.a(new_n59_), .b(x01), .c(new_n44_), .O(z06));
  nor2   g30(.a(new_n69_), .b(new_n59_), .O(z07));
  inv1   g31(.a(x08), .O(new_n75_));
  inv1   g32(.a(x18), .O(new_n76_));
  nand4  g33(.a(x19), .b(new_n76_), .c(x17), .d(new_n75_), .O(new_n77_));
  ...
  nand4  g48(.a(new_n91_), .b(new_n90_), .c(x20), .d(new_n67_), .O(new_n92_));
  ...
  aoi21  g59(.a(new_n102_), .b(new_n90_), .c(x00), .O(new_n103_));
  ...
  nand3  g67(.a(new_n110_), .b(new_n90_), .c(new_n67_), .O(new_n111_));
  nand2  g68(.a(new_n97_), .b(new_n44_), .O(new_n112_));
  aoi21  g69(.a(new_n111_), .b(new_n107_), .c(new_n112_), .O(z11));
  inv1   g70(.a(x23), .O(new_n114_));
  nand2  g71(.a(new_n62_), .b(x17), .O(new_n115_));
  oai21  g72(.a(new_n62_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  ...
  nand3  g80(.a(new_n46_), .b(new_n45_), .c(new_n52_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g82(.a(x19), .b(new_n49_), .c(x00), .O(new_n126_));
  aoi21  g83(.a(new_n118_), .b(x00), .c(new_n67_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(new_n126_), .O(z15));
  nor2   g85(.a(new_n68_), .b(new_n54_), .O(z16));
  aoi21  g86(.a(new_n49_), .b(new_n44_), .c(x01), .O(z17));
endmodule
