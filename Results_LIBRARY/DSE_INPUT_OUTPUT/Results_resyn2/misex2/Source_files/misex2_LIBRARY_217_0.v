...
module FAU ( 
  ...
  nor2   g15(.a(new_n60_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x00), .O(z16));
  inv1   g17(.a(x01), .O(new_n63_));
  oai21  g18(.a(x02), .b(z16), .c(new_n63_), .O(new_n64_));
  ...
  and2   g30(.a(x22), .b(x21), .O(new_n77_));
  nand4  g31(.a(new_n77_), .b(new_n70_), .c(new_n69_), .d(x18), .O(new_n78_));
  aoi21  g32(.a(new_n78_), .b(x01), .c(x00), .O(z10));
  nand2  g33(.a(new_n74_), .b(x21), .O(new_n80_));
  nor3   g34(.a(new_n80_), .b(new_n72_), .c(new_n71_), .O(z11));
  inv1   g35(.a(x24), .O(new_n82_));
  nand2  g36(.a(new_n57_), .b(new_n82_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n58_), .c(new_n47_), .O(z12));
