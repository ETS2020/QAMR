...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n117_, new_n120_, new_n121_, new_n122_;
  nor2   g00(.a(x07), .b(x06), .O(new_n44_));
  ...
  oai21  g26(.a(new_n69_), .b(new_n60_), .c(new_n45_), .O(z04));
  nor4   g27(.a(new_n60_), .b(new_n44_), .c(new_n57_), .d(new_n47_), .O(z05));
  oai21  g28(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(z06));
  ...
  nand2  g35(.a(x02), .b(new_n79_), .O(new_n80_));
  inv1   g36(.a(x13), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(x12), .c(new_n67_), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nor2   g39(.a(new_n77_), .b(x16), .O(new_n84_));
  ...
  nor2   g44(.a(new_n44_), .b(x00), .O(new_n89_));
  ...
  nand4  g50(.a(new_n88_), .b(new_n87_), .c(x20), .d(x16), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n94_), .c(new_n83_), .O(new_n97_));
  inv1   g53(.a(new_n78_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(x22), .c(x21), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n97_), .c(new_n92_), .O(z10));
  nand2  g56(.a(new_n98_), .b(x21), .O(new_n101_));
  inv1   g57(.a(x16), .O(new_n102_));
  nand3  g58(.a(new_n87_), .b(x20), .c(new_n102_), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n94_), .c(new_n83_), .O(new_n105_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(new_n106_));
  aoi21  g62(.a(new_n105_), .b(new_n101_), .c(new_n106_), .O(z11));
  nand2  g63(.a(x10), .b(x02), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(x01), .c(x00), .O(new_n109_));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g66(.a(new_n52_), .b(x17), .c(new_n46_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n48_), .O(new_n113_));
  inv1   g69(.a(x24), .O(new_n114_));
  nand3  g70(.a(new_n45_), .b(new_n114_), .c(x09), .O(new_n115_));
  aoi21  g71(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  inv1   g72(.a(new_n48_), .O(new_n117_));
  oai21  g73(.a(new_n111_), .b(new_n117_), .c(new_n45_), .O(z13));
  oai21  g74(.a(new_n58_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g75(.a(x10), .b(new_n79_), .c(x02), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(x00), .O(new_n121_));
  nand3  g77(.a(x19), .b(new_n46_), .c(new_n79_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n121_), .c(new_n44_), .O(z15));
  oai21  g79(.a(new_n79_), .b(x00), .c(new_n45_), .O(z16));
  nor2   g80(.a(new_n92_), .b(new_n80_), .O(z17));
  zero   g81(.O(z08));
endmodule
