...
module FAU ( 
  ...
  nand2  g11(.a(x24), .b(x01), .O(new_n55_));
  ...
  nor2   g23(.a(x24), .b(new_n46_), .O(new_n67_));
  nand2  g24(.a(new_n67_), .b(x12), .O(new_n68_));
  nand4  g25(.a(new_n48_), .b(new_n52_), .c(x18), .d(new_n50_), .O(new_n69_));
  oai21  g26(.a(new_n68_), .b(new_n66_), .c(new_n69_), .O(z03));
  inv1   g27(.a(x24), .O(new_n71_));
  inv1   g28(.a(x11), .O(new_n72_));
  inv1   g29(.a(x12), .O(new_n73_));
  nand4  g30(.a(new_n63_), .b(new_n62_), .c(new_n73_), .d(new_n72_), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(new_n71_), .c(new_n46_), .O(z04));
  nand2  g32(.a(x10), .b(x02), .O(new_n76_));
  nand2  g33(.a(x01), .b(x00), .O(new_n77_));
  nor4   g34(.a(new_n77_), .b(new_n76_), .c(x24), .d(new_n44_), .O(z05));
  aoi21  g35(.a(new_n66_), .b(new_n71_), .c(new_n46_), .O(z06));
  inv1   g36(.a(new_n62_), .O(new_n80_));
  nand3  g37(.a(new_n65_), .b(new_n71_), .c(new_n73_), .O(new_n81_));
  ...
  nand3  g49(.a(new_n92_), .b(x12), .c(new_n72_), .O(new_n93_));
  ...
  nand4  g54(.a(new_n67_), .b(new_n97_), .c(new_n52_), .d(x18), .O(new_n98_));
  ...
  nand4  g61(.a(new_n100_), .b(new_n99_), .c(x20), .d(x16), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n94_), .O(new_n107_));
  nand4  g64(.a(x21), .b(new_n97_), .c(new_n52_), .d(x18), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n67_), .c(x22), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n107_), .c(x00), .O(z10));
  nand2  g68(.a(new_n100_), .b(new_n45_), .O(new_n112_));
  nor2   g69(.a(new_n108_), .b(new_n46_), .O(new_n113_));
  nand3  g70(.a(new_n99_), .b(x20), .c(new_n90_), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(new_n104_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n94_), .c(new_n113_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n112_), .c(new_n55_), .O(z11));
  aoi21  g74(.a(x10), .b(x02), .c(new_n77_), .O(new_n118_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g76(.a(new_n52_), .b(x17), .c(new_n61_), .O(new_n120_));
  nand3  g77(.a(new_n71_), .b(new_n46_), .c(new_n45_), .O(new_n121_));
  aoi21  g78(.a(new_n120_), .b(new_n119_), .c(new_n121_), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n118_), .c(x09), .O(new_n123_));
  ...
  nand3  g85(.a(x19), .b(new_n61_), .c(new_n46_), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(new_n128_), .c(new_n55_), .O(z15));
  nand3  g87(.a(new_n71_), .b(x01), .c(new_n45_), .O(new_n131_));
  inv1   g88(.a(new_n131_), .O(z16));
  nand2  g89(.a(new_n87_), .b(new_n55_), .O(z17));
endmodule
