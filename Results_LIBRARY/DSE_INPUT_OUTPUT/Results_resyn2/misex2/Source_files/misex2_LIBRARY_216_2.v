...
module FAU ( 
  ...
  nor2   g13(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  inv1   g14(.a(x02), .O(new_n58_));
  nor2   g15(.a(new_n53_), .b(new_n58_), .O(new_n59_));
  nand3  g16(.a(new_n59_), .b(x11), .c(new_n49_), .O(new_n60_));
  ...
  nand4  g22(.a(new_n65_), .b(new_n64_), .c(x18), .d(new_n63_), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(new_n62_), .O(z03));
  inv1   g24(.a(x11), .O(new_n68_));
  inv1   g25(.a(x12), .O(new_n69_));
  nand4  g26(.a(new_n59_), .b(new_n69_), .c(new_n68_), .d(new_n49_), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(x01), .c(new_n44_), .O(z04));
  nand2  g28(.a(new_n59_), .b(x09), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n44_), .O(z05));
  nor3   g30(.a(new_n60_), .b(new_n56_), .c(new_n44_), .O(z06));
  nand4  g31(.a(new_n59_), .b(new_n69_), .c(x11), .d(new_n49_), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x01), .c(new_n44_), .O(z07));
  nor2   g33(.a(new_n63_), .b(x08), .O(new_n77_));
  inv1   g34(.a(x19), .O(new_n78_));
  nor2   g35(.a(new_n78_), .b(x18), .O(new_n79_));
  nor2   g36(.a(x03), .b(new_n58_), .O(new_n80_));
  ...
  nand4  g41(.a(new_n84_), .b(new_n80_), .c(new_n79_), .d(new_n77_), .O(new_n85_));
  ...
  nand2  g46(.a(new_n68_), .b(x02), .O(new_n90_));
  ...
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n44_), .O(new_n99_));
  ...
  nand4  g61(.a(x21), .b(x18), .c(x01), .d(new_n44_), .O(new_n105_));
  ...
  aoi21  g73(.a(new_n64_), .b(new_n63_), .c(x01), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n116_), .c(new_n114_), .O(new_n118_));
  inv1   g75(.a(x24), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(x09), .O(new_n120_));
  oai22  g77(.a(new_n120_), .b(new_n118_), .c(x01), .d(new_n44_), .O(z12));
  nand2  g78(.a(new_n64_), .b(x17), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n44_), .c(x01), .O(z13));
  nand3  g80(.a(new_n46_), .b(new_n45_), .c(new_n53_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g82(.a(x19), .b(new_n58_), .c(x00), .O(new_n126_));
  nor2   g83(.a(new_n114_), .b(new_n56_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(new_n126_), .O(z15));
  nor2   g85(.a(new_n65_), .b(new_n57_), .O(z16));
  aoi21  g86(.a(new_n58_), .b(new_n44_), .c(x01), .O(z17));
endmodule
