...
module FAU ( 
  ...
  nand4  g11(.a(new_n48_), .b(new_n47_), .c(new_n45_), .d(x09), .O(new_n55_));
  ...
  nand3  g16(.a(new_n48_), .b(x18), .c(new_n59_), .O(new_n60_));
  nand3  g17(.a(new_n46_), .b(x11), .c(x02), .O(new_n61_));
  inv1   g18(.a(x01), .O(new_n62_));
  nor2   g19(.a(new_n62_), .b(new_n44_), .O(new_n63_));
  nand2  g20(.a(new_n63_), .b(x12), .O(new_n64_));
  oai22  g21(.a(new_n64_), .b(new_n61_), .c(new_n60_), .d(new_n58_), .O(z03));
  nand2  g22(.a(new_n63_), .b(x02), .O(new_n66_));
  inv1   g23(.a(x11), .O(new_n67_));
  inv1   g24(.a(x12), .O(new_n68_));
  nand3  g25(.a(new_n46_), .b(new_n68_), .c(new_n67_), .O(new_n69_));
  nor2   g26(.a(new_n69_), .b(new_n66_), .O(z04));
  inv1   g27(.a(x09), .O(new_n71_));
  nor3   g28(.a(new_n66_), .b(new_n45_), .c(new_n71_), .O(z05));
  aoi21  g29(.a(new_n61_), .b(x01), .c(new_n44_), .O(z06));
  nand4  g30(.a(new_n46_), .b(new_n68_), .c(x11), .d(x02), .O(new_n74_));
  ...
  nand2  g36(.a(new_n57_), .b(x02), .O(new_n80_));
  ...
  nand2  g43(.a(new_n67_), .b(x02), .O(new_n87_));
  ...
  nand3  g52(.a(new_n95_), .b(new_n94_), .c(new_n44_), .O(new_n96_));
  ...
  nand4  g58(.a(x21), .b(x18), .c(x01), .d(new_n44_), .O(new_n102_));
  ...
  nor2   g68(.a(new_n45_), .b(new_n111_), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(new_n44_), .O(new_n113_));
  ...
  nor2   g73(.a(x24), .b(new_n71_), .O(new_n117_));
  oai21  g74(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(new_n118_));
  nand2  g75(.a(new_n62_), .b(x00), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(z12));
  nor2   g77(.a(new_n115_), .b(new_n58_), .O(z13));
  nand4  g78(.a(new_n48_), .b(new_n47_), .c(new_n45_), .d(new_n71_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g80(.a(new_n63_), .O(new_n124_));
  nand3  g81(.a(new_n57_), .b(x19), .c(new_n111_), .O(new_n125_));
  oai21  g82(.a(new_n112_), .b(new_n124_), .c(new_n125_), .O(z15));
