...
module FAU ( 
  ...
  nand3  g14(.a(new_n51_), .b(new_n49_), .c(x11), .O(new_n60_));
  nand2  g15(.a(new_n60_), .b(new_n47_), .O(z06));
  inv1   g16(.a(x09), .O(new_n62_));
  inv1   g17(.a(x12), .O(new_n63_));
  nand4  g18(.a(new_n63_), .b(x11), .c(x10), .d(new_n62_), .O(new_n64_));
  nand2  g19(.a(x02), .b(x00), .O(new_n65_));
  aoi21  g20(.a(new_n64_), .b(x01), .c(new_n65_), .O(z07));
  inv1   g21(.a(x19), .O(new_n68_));
  inv1   g22(.a(x20), .O(new_n69_));
  nand3  g23(.a(new_n69_), .b(new_n68_), .c(x18), .O(new_n70_));
  ...
  nor3   g29(.a(new_n75_), .b(new_n72_), .c(new_n70_), .O(z09));
  and2   g30(.a(x22), .b(x21), .O(new_n77_));
  nand4  g31(.a(new_n77_), .b(new_n69_), .c(new_n68_), .d(x18), .O(new_n78_));
  aoi21  g32(.a(new_n78_), .b(x01), .c(x00), .O(z10));
  nand2  g33(.a(new_n74_), .b(x21), .O(new_n80_));
  nor3   g34(.a(new_n80_), .b(new_n72_), .c(new_n70_), .O(z11));
  inv1   g35(.a(x24), .O(new_n82_));
  nand2  g36(.a(new_n57_), .b(new_n82_), .O(new_n83_));
  nor2   g37(.a(new_n83_), .b(new_n58_), .O(z12));
