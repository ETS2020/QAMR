...
module FAU ( 
  ...
  inv1   g20(.a(new_n44_), .O(z06));
  inv1   g21(.a(x02), .O(new_n67_));
  aoi21  g22(.a(new_n67_), .b(new_n47_), .c(new_n46_), .O(z07));
  ...
  nand3  g29(.a(x19), .b(new_n52_), .c(x17), .O(new_n75_));
  ...
  nor2   g35(.a(new_n67_), .b(x01), .O(new_n81_));
  nor2   g36(.a(x15), .b(x14), .O(new_n82_));
  inv1   g37(.a(x20), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(x16), .O(new_n84_));
  nand4  g39(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n85_));
  nand3  g40(.a(new_n61_), .b(new_n83_), .c(x01), .O(new_n86_));
  inv1   g41(.a(x21), .O(new_n87_));
  inv1   g42(.a(x22), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(new_n89_));
  aoi21  g44(.a(new_n86_), .b(new_n85_), .c(new_n89_), .O(z09));
  nand4  g45(.a(x21), .b(new_n83_), .c(new_n53_), .d(x18), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(new_n88_), .c(new_n46_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(x01), .O(new_n93_));
  nor2   g48(.a(new_n79_), .b(new_n74_), .O(new_n94_));
  inv1   g49(.a(x14), .O(new_n95_));
  nand2  g50(.a(x15), .b(new_n95_), .O(new_n96_));
  nand3  g51(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n94_), .c(x16), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n93_), .O(z10));
  oai21  g55(.a(new_n91_), .b(x22), .c(new_n46_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x01), .O(new_n102_));
  inv1   g57(.a(x16), .O(new_n103_));
  nand3  g58(.a(new_n98_), .b(new_n94_), .c(new_n103_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n102_), .O(z11));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n106_));
  nand3  g61(.a(new_n53_), .b(x17), .c(new_n67_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nor2   g63(.a(x24), .b(new_n45_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n73_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n44_), .O(z12));
  nor2   g66(.a(new_n107_), .b(new_n48_), .O(z13));
  oai21  g67(.a(new_n59_), .b(new_n50_), .c(new_n44_), .O(z14));
  nand2  g68(.a(new_n67_), .b(new_n47_), .O(new_n114_));
  aoi21  g69(.a(new_n53_), .b(new_n46_), .c(new_n114_), .O(z15));
  nor2   g70(.a(new_n47_), .b(x00), .O(z16));
