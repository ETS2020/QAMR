...
module FAU ( 
  ...
  nor2   g13(.a(x02), .b(x00), .O(new_n57_));
  nand3  g14(.a(new_n57_), .b(new_n56_), .c(new_n48_), .O(new_n58_));
  inv1   g15(.a(new_n58_), .O(new_n59_));
  nand3  g16(.a(new_n59_), .b(x10), .c(x09), .O(new_n60_));
  aoi21  g17(.a(new_n60_), .b(new_n55_), .c(x17), .O(z01));
  nand2  g18(.a(new_n44_), .b(x09), .O(new_n62_));
  nor2   g19(.a(new_n62_), .b(new_n53_), .O(z02));
  nand2  g20(.a(x02), .b(x00), .O(new_n64_));
  inv1   g21(.a(new_n64_), .O(new_n65_));
  nand4  g22(.a(new_n65_), .b(new_n45_), .c(x12), .d(x11), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(x17), .O(new_n67_));
  nand2  g24(.a(new_n67_), .b(x01), .O(new_n68_));
  nand4  g25(.a(new_n57_), .b(new_n56_), .c(x18), .d(new_n47_), .O(new_n69_));
  nand2  g26(.a(new_n69_), .b(new_n68_), .O(z03));
  inv1   g27(.a(x11), .O(new_n71_));
  inv1   g28(.a(x12), .O(new_n72_));
  nand4  g29(.a(new_n65_), .b(new_n45_), .c(new_n72_), .d(new_n71_), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x17), .c(new_n55_), .O(z04));
  nand3  g31(.a(new_n65_), .b(x10), .c(x09), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x17), .c(new_n55_), .O(z05));
  nand3  g33(.a(new_n65_), .b(new_n45_), .c(x11), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x17), .c(new_n55_), .O(z06));
  nand4  g35(.a(new_n45_), .b(x17), .c(new_n72_), .d(x11), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(x01), .c(new_n64_), .O(z07));
  ...
  nand3  g42(.a(x02), .b(new_n55_), .c(new_n85_), .O(new_n86_));
  nand3  g43(.a(x19), .b(new_n48_), .c(x17), .O(new_n87_));
  nor3   g44(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z08));
  nor2   g45(.a(x17), .b(new_n55_), .O(new_n89_));
  inv1   g46(.a(new_n89_), .O(new_n90_));
  inv1   g47(.a(x20), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(new_n56_), .c(x18), .d(x01), .O(new_n92_));
  inv1   g49(.a(new_n92_), .O(new_n93_));
  nand2  g50(.a(x02), .b(new_n55_), .O(new_n94_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n90_), .O(z09));
  nor2   g64(.a(new_n89_), .b(new_n85_), .O(new_n108_));
  nor2   g65(.a(new_n99_), .b(x14), .O(new_n109_));
  ...
  aoi21  g70(.a(new_n113_), .b(new_n93_), .c(new_n89_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n112_), .c(new_n108_), .O(z10));
  nand2  g72(.a(new_n105_), .b(new_n85_), .O(new_n116_));
  nand3  g73(.a(new_n93_), .b(x21), .c(x17), .O(new_n117_));
  nor2   g74(.a(new_n91_), .b(x16), .O(new_n118_));
  nand4  g75(.a(new_n109_), .b(new_n118_), .c(new_n97_), .d(new_n104_), .O(new_n119_));
  ...
  oai21  g79(.a(new_n122_), .b(new_n52_), .c(x17), .O(new_n123_));
  inv1   g80(.a(new_n50_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n49_), .c(x23), .O(new_n125_));
  ...
  nand2  g88(.a(new_n131_), .b(new_n59_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n55_), .c(x17), .O(z14));
  nor2   g90(.a(new_n56_), .b(x01), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(new_n108_), .O(new_n135_));
  nand4  g92(.a(x17), .b(new_n44_), .c(x01), .d(x00), .O(new_n136_));
  oai21  g93(.a(new_n135_), .b(x02), .c(new_n136_), .O(z15));
  aoi21  g94(.a(x17), .b(x00), .c(new_n55_), .O(z16));
  nand2  g95(.a(new_n90_), .b(new_n86_), .O(z17));
endmodule
