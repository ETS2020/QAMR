...
module FAU ( 
  ...
  aoi21  g17(.a(new_n60_), .b(new_n59_), .c(x05), .O(new_n61_));
  ...
  nor2   g39(.a(x18), .b(new_n82_), .O(new_n83_));
  nand4  g40(.a(new_n83_), .b(new_n81_), .c(x19), .d(x02), .O(new_n84_));
  nor2   g41(.a(new_n84_), .b(new_n80_), .O(z08));
  inv1   g42(.a(x13), .O(new_n86_));
  nand3  g43(.a(new_n86_), .b(x12), .c(new_n68_), .O(new_n87_));
  inv1   g44(.a(x16), .O(new_n88_));
  nand2  g45(.a(x20), .b(new_n88_), .O(new_n89_));
  nor2   g46(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  inv1   g47(.a(x14), .O(new_n91_));
  inv1   g48(.a(x15), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x02), .d(new_n66_), .O(new_n93_));
  ...
  aoi21  g55(.a(new_n94_), .b(new_n90_), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g60(.a(new_n103_), .b(new_n99_), .c(new_n67_), .O(z09));
  nor2   g61(.a(new_n97_), .b(new_n101_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(x22), .O(new_n106_));
  nand3  g63(.a(new_n102_), .b(new_n101_), .c(x20), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand4  g65(.a(x15), .b(new_n91_), .c(x02), .d(new_n66_), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(new_n87_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n108_), .c(x16), .d(new_n53_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n106_), .c(x00), .O(z10));
  nand2  g69(.a(new_n102_), .b(new_n100_), .O(new_n113_));
  nor2   g70(.a(new_n109_), .b(x21), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n90_), .c(new_n105_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n113_), .c(new_n67_), .O(z11));
  nor2   g73(.a(new_n66_), .b(new_n100_), .O(new_n117_));
  ...
  oai21  g78(.a(new_n121_), .b(x23), .c(new_n81_), .O(new_n122_));
  ...
  nand2  g83(.a(new_n48_), .b(new_n47_), .O(new_n127_));
  nor3   g84(.a(new_n127_), .b(x19), .c(new_n82_), .O(z13));
  nand4  g85(.a(new_n47_), .b(new_n46_), .c(new_n54_), .d(new_n44_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n53_), .c(x01), .O(z14));
  inv1   g87(.a(x02), .O(new_n131_));
  aoi21  g88(.a(new_n54_), .b(x01), .c(new_n131_), .O(new_n132_));
  aoi21  g89(.a(x19), .b(new_n131_), .c(x05), .O(new_n133_));
  oai22  g90(.a(new_n133_), .b(x01), .c(new_n132_), .d(new_n100_), .O(z15));
  nor2   g91(.a(new_n117_), .b(new_n48_), .O(z16));
  nand3  g92(.a(new_n81_), .b(new_n53_), .c(x02), .O(new_n136_));
