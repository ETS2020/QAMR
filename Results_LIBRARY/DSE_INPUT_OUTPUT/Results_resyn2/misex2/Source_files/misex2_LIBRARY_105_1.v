...
module FAU ( 
  ...
  nand3  g09(.a(new_n46_), .b(x10), .c(x09), .O(new_n53_));
  nor2   g10(.a(new_n53_), .b(new_n52_), .O(z01));
  nand4  g11(.a(new_n46_), .b(new_n47_), .c(x09), .d(new_n45_), .O(new_n55_));
  ...
  nand4  g22(.a(new_n65_), .b(new_n48_), .c(x02), .d(x01), .O(new_n66_));
  ...
  nand3  g27(.a(new_n70_), .b(new_n64_), .c(new_n63_), .O(new_n71_));
  ...
  inv1   g33(.a(new_n68_), .O(new_n77_));
  nand3  g34(.a(new_n48_), .b(new_n64_), .c(x11), .O(new_n78_));
  inv1   g35(.a(new_n51_), .O(new_n79_));
  oai21  g36(.a(x02), .b(new_n57_), .c(new_n79_), .O(new_n80_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n80_), .O(z07));
  ...
  nor2   g42(.a(x03), .b(new_n45_), .O(new_n86_));
  inv1   g43(.a(x05), .O(new_n87_));
  inv1   g44(.a(x06), .O(new_n88_));
  inv1   g45(.a(x07), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x04), .O(new_n90_));
  inv1   g47(.a(new_n90_), .O(new_n91_));
  nand3  g48(.a(new_n91_), .b(new_n86_), .c(new_n85_), .O(new_n92_));
  aoi21  g49(.a(new_n92_), .b(new_n44_), .c(x00), .O(z08));
  nor2   g50(.a(x11), .b(new_n45_), .O(new_n94_));
  ...
  nor2   g59(.a(x16), .b(x15), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n102_), .c(new_n98_), .d(new_n94_), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n44_), .c(x00), .O(z09));
  nand2  g62(.a(new_n98_), .b(new_n94_), .O(new_n106_));
  nand4  g63(.a(new_n102_), .b(new_n51_), .c(x16), .d(x15), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n106_), .O(z10));
  inv1   g65(.a(x15), .O(new_n109_));
  nor2   g66(.a(x16), .b(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n102_), .c(new_n98_), .d(new_n94_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n44_), .c(x00), .O(z11));
  nand2  g69(.a(new_n69_), .b(new_n77_), .O(new_n113_));
  nand2  g70(.a(new_n59_), .b(new_n58_), .O(new_n114_));
  inv1   g71(.a(x23), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(new_n115_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n114_), .c(new_n51_), .O(new_n117_));
  ...
  aoi21  g78(.a(new_n121_), .b(new_n44_), .c(x00), .O(z13));
  nand2  g79(.a(new_n46_), .b(new_n47_), .O(new_n123_));
  nor3   g80(.a(new_n123_), .b(new_n52_), .c(x09), .O(z14));
  oai21  g81(.a(new_n47_), .b(new_n57_), .c(x01), .O(new_n125_));
  oai21  g82(.a(x19), .b(x00), .c(new_n45_), .O(new_n126_));
