...
module FAU ( 
  ...
  nand3  g28(.a(x19), .b(new_n51_), .c(x17), .O(new_n73_));
  nor3   g29(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z08));
  inv1   g30(.a(x21), .O(new_n75_));
  inv1   g31(.a(x22), .O(new_n76_));
  nand2  g32(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  inv1   g33(.a(x20), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(new_n52_), .c(x18), .O(new_n79_));
  ...
  nand3  g41(.a(new_n76_), .b(new_n75_), .c(x20), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  nor3   g43(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n81_), .O(z09));
  nand2  g46(.a(x22), .b(x21), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n79_), .c(new_n45_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x01), .O(new_n93_));
  inv1   g49(.a(x15), .O(new_n94_));
  nor2   g50(.a(new_n94_), .b(x14), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n87_), .c(new_n85_), .d(x16), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n93_), .O(z10));
  inv1   g53(.a(x02), .O(new_n98_));
  nor2   g54(.a(new_n98_), .b(x01), .O(new_n99_));
  inv1   g55(.a(new_n84_), .O(new_n100_));
  inv1   g56(.a(x16), .O(new_n101_));
  nand3  g57(.a(new_n75_), .b(x20), .c(new_n101_), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n95_), .c(new_n100_), .d(new_n99_), .O(new_n104_));
  inv1   g60(.a(new_n79_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x21), .c(x01), .O(new_n106_));
  nand2  g62(.a(new_n76_), .b(new_n45_), .O(new_n107_));
  aoi21  g63(.a(new_n106_), .b(new_n104_), .c(new_n107_), .O(z11));
  inv1   g64(.a(new_n47_), .O(new_n109_));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g66(.a(new_n52_), .b(x17), .c(new_n98_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nor2   g68(.a(x24), .b(new_n44_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n109_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n57_), .O(z12));
  oai21  g71(.a(new_n111_), .b(new_n47_), .c(new_n57_), .O(z13));
  nor2   g72(.a(new_n59_), .b(new_n49_), .O(z14));
  aoi21  g73(.a(x19), .b(new_n46_), .c(x00), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(new_n99_), .O(z15));
  nor2   g75(.a(new_n46_), .b(x00), .O(z16));
  nand2  g76(.a(new_n72_), .b(new_n57_), .O(z17));
  zero   g77(.O(z05));
  inv1   g78(.a(new_n57_), .O(z06));
endmodule
