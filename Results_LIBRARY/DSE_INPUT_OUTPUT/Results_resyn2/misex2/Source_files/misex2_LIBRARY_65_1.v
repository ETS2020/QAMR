...
module FAU ( 
  ...
  nand2  g02(.a(x23), .b(new_n45_), .O(new_n46_));
  ...
  nand4  g21(.a(new_n64_), .b(new_n51_), .c(x18), .d(new_n63_), .O(new_n65_));
  and2   g22(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  oai21  g23(.a(new_n62_), .b(new_n59_), .c(new_n66_), .O(z03));
  inv1   g24(.a(x11), .O(new_n68_));
  nand4  g25(.a(new_n59_), .b(new_n68_), .c(x10), .d(new_n50_), .O(new_n69_));
  oai21  g26(.a(new_n69_), .b(new_n60_), .c(new_n46_), .O(z04));
  inv1   g27(.a(x00), .O(new_n71_));
  inv1   g28(.a(x01), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nor2   g30(.a(new_n56_), .b(new_n49_), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(new_n73_), .c(new_n46_), .d(x09), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(z05));
  nand2  g33(.a(new_n62_), .b(new_n46_), .O(z06));
  ...
  nand3  g37(.a(new_n51_), .b(new_n46_), .c(x02), .O(new_n81_));
  ...
  nand2  g48(.a(x02), .b(new_n72_), .O(new_n92_));
  ...
  nand4  g54(.a(x20), .b(new_n45_), .c(new_n97_), .d(new_n96_), .O(new_n98_));
  ...
  nand3  g59(.a(new_n102_), .b(new_n101_), .c(new_n71_), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n100_), .c(new_n46_), .O(z09));
  nand4  g61(.a(new_n91_), .b(new_n46_), .c(x22), .d(x21), .O(new_n105_));
  nand4  g62(.a(new_n102_), .b(new_n101_), .c(x20), .d(x16), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n95_), .c(x15), .d(new_n96_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n105_), .c(x00), .O(z10));
  nand2  g66(.a(new_n102_), .b(new_n71_), .O(new_n110_));
  nand3  g67(.a(new_n91_), .b(new_n46_), .c(x21), .O(new_n111_));
  inv1   g68(.a(x23), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n101_), .c(x20), .d(new_n45_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n95_), .c(x15), .d(new_n96_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n111_), .c(new_n110_), .O(z11));
  inv1   g73(.a(new_n74_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n73_), .c(new_n46_), .O(new_n118_));
  nand2  g75(.a(new_n64_), .b(x17), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n51_), .c(new_n46_), .O(new_n122_));
  inv1   g79(.a(x24), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(x09), .O(new_n124_));
  aoi21  g81(.a(new_n122_), .b(new_n118_), .c(new_n124_), .O(z12));
  nand3  g82(.a(new_n64_), .b(new_n51_), .c(x17), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n46_), .O(z13));
  nand3  g84(.a(new_n47_), .b(new_n46_), .c(new_n44_), .O(new_n128_));
  nor3   g85(.a(new_n52_), .b(new_n128_), .c(x10), .O(z14));
  inv1   g86(.a(new_n46_), .O(new_n130_));
  oai21  g87(.a(x10), .b(new_n72_), .c(x02), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(x00), .O(new_n132_));
  nand3  g89(.a(x19), .b(new_n49_), .c(new_n72_), .O(new_n133_));
  aoi21  g90(.a(new_n133_), .b(new_n132_), .c(new_n130_), .O(z15));
  nor3   g91(.a(new_n130_), .b(new_n72_), .c(x00), .O(z16));
  inv1   g92(.a(new_n81_), .O(z17));
endmodule
