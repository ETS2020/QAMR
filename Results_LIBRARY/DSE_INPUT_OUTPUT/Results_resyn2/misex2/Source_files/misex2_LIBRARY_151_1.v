...
module FAU ( 
  ...
  and2   g28(.a(new_n69_), .b(new_n45_), .O(new_n72_));
  nand2  g29(.a(new_n72_), .b(new_n66_), .O(new_n73_));
  inv1   g30(.a(x12), .O(new_n74_));
  nand3  g31(.a(new_n74_), .b(new_n64_), .c(x10), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(new_n73_), .O(z04));
  nand4  g33(.a(new_n72_), .b(x10), .c(x09), .d(x02), .O(new_n77_));
  inv1   g34(.a(new_n77_), .O(z05));
  nand3  g35(.a(new_n72_), .b(new_n66_), .c(new_n65_), .O(new_n79_));
  inv1   g36(.a(new_n79_), .O(z06));
  nand3  g37(.a(new_n65_), .b(new_n74_), .c(new_n54_), .O(new_n81_));
  ...
  nand3  g44(.a(x02), .b(new_n68_), .c(new_n67_), .O(new_n88_));
  inv1   g45(.a(new_n88_), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(x19), .c(new_n48_), .d(x17), .O(new_n90_));
  ...
  nand2  g52(.a(x20), .b(new_n44_), .O(new_n96_));
  ...
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n67_), .O(new_n102_));
  aoi21  g59(.a(new_n99_), .b(new_n93_), .c(new_n102_), .O(z09));
  nor2   g60(.a(new_n93_), .b(new_n100_), .O(new_n104_));
  nand2  g61(.a(new_n98_), .b(x15), .O(new_n105_));
  ...
  nand2  g67(.a(new_n101_), .b(new_n67_), .O(new_n111_));
  aoi21  g68(.a(new_n106_), .b(new_n97_), .c(new_n104_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n111_), .c(new_n45_), .O(z11));
  oai21  g70(.a(new_n63_), .b(new_n53_), .c(new_n69_), .O(new_n114_));
  ...
  nand2  g75(.a(new_n118_), .b(new_n55_), .O(new_n119_));
  inv1   g76(.a(x24), .O(new_n120_));
  nand3  g77(.a(new_n45_), .b(new_n120_), .c(x09), .O(new_n121_));
  aoi21  g78(.a(new_n119_), .b(new_n114_), .c(new_n121_), .O(z12));
  inv1   g79(.a(new_n55_), .O(new_n123_));
  oai21  g80(.a(new_n117_), .b(new_n123_), .c(new_n45_), .O(z13));
  ...
  nand2  g88(.a(new_n88_), .b(new_n45_), .O(z17));
endmodule
