...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n104_, new_n105_, new_n106_, new_n107_, new_n111_;
  ...
  nand4  g32(.a(new_n77_), .b(new_n52_), .c(x18), .d(x01), .O(new_n78_));
  nand2  g33(.a(x02), .b(new_n46_), .O(new_n79_));
  inv1   g34(.a(x11), .O(new_n80_));
  inv1   g35(.a(x13), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(x12), .c(new_n80_), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nor2   g38(.a(x15), .b(x14), .O(new_n84_));
  nor2   g39(.a(new_n77_), .b(x16), .O(new_n85_));
  ...
  aoi21  g44(.a(new_n86_), .b(new_n78_), .c(new_n89_), .O(z09));
  inv1   g45(.a(new_n78_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(x22), .c(x21), .O(new_n92_));
  inv1   g47(.a(x14), .O(new_n93_));
  nand4  g48(.a(new_n87_), .b(x20), .c(x15), .d(new_n93_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(new_n95_));
  inv1   g50(.a(x16), .O(new_n96_));
  nor2   g51(.a(x22), .b(new_n96_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n95_), .c(new_n83_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n92_), .c(x00), .O(z10));
  nand2  g54(.a(new_n88_), .b(new_n45_), .O(new_n100_));
  nand2  g55(.a(new_n91_), .b(x21), .O(new_n101_));
  nand3  g56(.a(new_n95_), .b(new_n83_), .c(new_n96_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(z11));
  oai21  g58(.a(x19), .b(x02), .c(x23), .O(new_n104_));
  nand3  g59(.a(new_n52_), .b(x17), .c(new_n67_), .O(new_n105_));
  inv1   g60(.a(x24), .O(new_n106_));
  nand3  g61(.a(new_n73_), .b(new_n106_), .c(x09), .O(new_n107_));
  aoi21  g62(.a(new_n105_), .b(new_n104_), .c(new_n107_), .O(z12));
  oai21  g63(.a(new_n105_), .b(new_n47_), .c(new_n57_), .O(z13));
  nor2   g64(.a(new_n59_), .b(new_n49_), .O(z14));
  nand2  g65(.a(x19), .b(new_n46_), .O(new_n111_));
  aoi22  g66(.a(new_n111_), .b(new_n45_), .c(x02), .d(new_n46_), .O(z15));
  inv1   g67(.a(new_n74_), .O(z17));
  zero   g68(.O(z05));
  zero   g69(.O(z06));
  buf    g70(.a(x01), .O(z16));
endmodule
