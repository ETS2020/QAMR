...
module FAU ( 
  ...
  inv1   g19(.a(new_n55_), .O(z05));
  inv1   g20(.a(x02), .O(new_n65_));
  aoi21  g21(.a(new_n65_), .b(new_n46_), .c(new_n45_), .O(z07));
  ...
  oai21  g48(.a(new_n92_), .b(new_n79_), .c(new_n45_), .O(new_n93_));
  ...
  nand4  g58(.a(x15), .b(new_n95_), .c(x02), .d(new_n46_), .O(new_n103_));
  ...
  nand3  g66(.a(new_n52_), .b(x17), .c(new_n65_), .O(new_n111_));
  ...
  oai21  g71(.a(new_n59_), .b(new_n49_), .c(new_n55_), .O(z14));
  nand2  g72(.a(new_n65_), .b(new_n46_), .O(new_n117_));
  aoi21  g73(.a(new_n52_), .b(new_n45_), .c(new_n117_), .O(z15));
  nor2   g74(.a(new_n46_), .b(x00), .O(z16));
  zero   g75(.O(z04));
  inv1   g76(.a(new_n55_), .O(z06));
endmodule
