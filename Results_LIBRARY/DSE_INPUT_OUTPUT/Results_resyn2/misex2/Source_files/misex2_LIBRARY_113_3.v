...
module FAU ( 
  ...
  aoi21  g20(.a(new_n63_), .b(new_n61_), .c(x06), .O(new_n64_));
  ...
  aoi21  g30(.a(new_n73_), .b(new_n68_), .c(new_n59_), .O(z05));
  nor2   g31(.a(new_n69_), .b(new_n56_), .O(new_n75_));
  nor2   g32(.a(x06), .b(new_n59_), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nor3   g34(.a(new_n77_), .b(new_n60_), .c(x09), .O(z06));
  nand4  g35(.a(new_n75_), .b(new_n70_), .c(new_n46_), .d(new_n68_), .O(new_n79_));
  ...
  nand3  g42(.a(x02), .b(new_n59_), .c(new_n85_), .O(new_n86_));
  inv1   g43(.a(new_n86_), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(x19), .c(new_n50_), .d(x17), .O(new_n88_));
  oai21  g45(.a(new_n88_), .b(new_n84_), .c(new_n44_), .O(z08));
  nor2   g46(.a(x20), .b(x19), .O(new_n90_));
  nand3  g47(.a(x18), .b(new_n68_), .c(x01), .O(new_n91_));
  inv1   g48(.a(new_n91_), .O(new_n92_));
  nand2  g49(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand2  g50(.a(x02), .b(new_n59_), .O(new_n94_));
  ...
  nand2  g59(.a(new_n102_), .b(new_n97_), .O(new_n103_));
  inv1   g60(.a(x21), .O(new_n104_));
  inv1   g61(.a(x22), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n104_), .c(new_n85_), .O(new_n106_));
  aoi21  g63(.a(new_n103_), .b(new_n93_), .c(new_n106_), .O(z09));
  nand4  g64(.a(new_n92_), .b(new_n90_), .c(x22), .d(x21), .O(new_n108_));
  nand4  g65(.a(new_n104_), .b(x20), .c(x15), .d(new_n98_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nor2   g67(.a(x22), .b(new_n100_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n110_), .c(new_n97_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n108_), .c(x00), .O(z10));
  nand2  g70(.a(new_n105_), .b(new_n85_), .O(new_n114_));
  nand3  g71(.a(new_n92_), .b(new_n90_), .c(x21), .O(new_n115_));
  nand3  g72(.a(new_n110_), .b(new_n97_), .c(new_n100_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(z11));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand2  g75(.a(new_n65_), .b(x17), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g78(.a(x10), .b(x02), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n76_), .c(x00), .O(new_n123_));
  inv1   g80(.a(x24), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x09), .O(new_n125_));
  aoi21  g82(.a(new_n123_), .b(new_n121_), .c(new_n125_), .O(z12));
  nor3   g83(.a(new_n119_), .b(x01), .c(x00), .O(z13));
  oai21  g84(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g85(.a(x10), .b(new_n59_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n45_), .c(new_n59_), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(new_n130_), .c(new_n44_), .O(z15));
  nand3  g89(.a(new_n68_), .b(x01), .c(new_n85_), .O(new_n133_));
  inv1   g90(.a(new_n133_), .O(z16));
  nand2  g91(.a(new_n86_), .b(new_n44_), .O(z17));
endmodule
