...
module FAU ( 
  ...
  nand4  g61(.a(new_n44_), .b(new_n104_), .c(new_n103_), .d(new_n64_), .O(new_n105_));
  ...
  nand4  g66(.a(new_n109_), .b(new_n99_), .c(new_n104_), .d(x16), .O(new_n110_));
  nor2   g67(.a(new_n95_), .b(new_n103_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(x22), .c(new_n45_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n110_), .c(new_n78_), .O(z10));
  nand2  g70(.a(new_n104_), .b(new_n64_), .O(new_n114_));
  nor2   g71(.a(new_n108_), .b(x16), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n99_), .c(new_n111_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n46_), .O(z11));
  nand2  g74(.a(x10), .b(x02), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  nand3  g76(.a(new_n53_), .b(new_n51_), .c(new_n47_), .O(new_n120_));
  inv1   g77(.a(x23), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(new_n121_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n120_), .c(new_n49_), .O(new_n123_));
  nand2  g80(.a(new_n44_), .b(x09), .O(new_n124_));
  aoi21  g81(.a(new_n123_), .b(new_n119_), .c(new_n124_), .O(z12));
