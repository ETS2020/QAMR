// Benchmark "FAU" written by ABC on Tue Aug 11 19:55:01 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n69_, new_n70_, new_n71_, new_n73_, new_n76_, new_n78_, new_n79_,
  ...
  nand3  g07(.a(new_n50_), .b(x09), .c(new_n45_), .O(new_n51_));
  nand2  g08(.a(new_n47_), .b(x10), .O(new_n52_));
  nor2   g09(.a(new_n52_), .b(new_n51_), .O(z01));
  inv1   g10(.a(x10), .O(new_n54_));
  nand2  g11(.a(new_n47_), .b(new_n54_), .O(new_n55_));
  nor2   g12(.a(new_n55_), .b(new_n51_), .O(z02));
  nand2  g13(.a(new_n50_), .b(new_n45_), .O(new_n57_));
  nor2   g14(.a(new_n54_), .b(new_n45_), .O(new_n58_));
  nand3  g15(.a(new_n58_), .b(x11), .c(new_n46_), .O(new_n59_));
  ...
  oai22  g23(.a(new_n66_), .b(new_n57_), .c(new_n62_), .d(new_n59_), .O(z03));
  inv1   g24(.a(x11), .O(new_n68_));
  inv1   g25(.a(x12), .O(new_n69_));
  nand3  g26(.a(new_n69_), .b(new_n68_), .c(new_n46_), .O(new_n70_));
  nand2  g27(.a(new_n61_), .b(new_n58_), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n70_), .O(z04));
  ...
  nand4  g32(.a(new_n58_), .b(new_n69_), .c(x11), .d(new_n46_), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n44_), .O(z07));
  inv1   g34(.a(x08), .O(new_n78_));
  nand4  g35(.a(x19), .b(new_n64_), .c(x17), .d(new_n78_), .O(new_n79_));
  ...
  nand2  g43(.a(new_n68_), .b(x02), .O(new_n87_));
  ...
  nor2   g61(.a(x20), .b(new_n60_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n65_), .c(x22), .d(x21), .O(new_n106_));
  nand3  g63(.a(x16), .b(x15), .c(new_n60_), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n94_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n91_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n106_), .c(x00), .O(z10));
  nand2  g67(.a(new_n96_), .b(x15), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(new_n94_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n91_), .c(x00), .O(new_n113_));
  nand4  g70(.a(new_n102_), .b(new_n101_), .c(new_n93_), .d(x21), .O(new_n114_));
  oai21  g71(.a(new_n113_), .b(x01), .c(new_n114_), .O(z11));
  nor2   g72(.a(new_n58_), .b(new_n44_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  inv1   g74(.a(x19), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(x17), .c(new_n45_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n117_), .c(x01), .O(new_n120_));
  nor2   g77(.a(x24), .b(new_n46_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n116_), .c(new_n121_), .O(new_n122_));
  nand2  g79(.a(new_n60_), .b(x00), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(z12));
  aoi21  g81(.a(new_n119_), .b(new_n44_), .c(x01), .O(z13));
  nor3   g82(.a(new_n55_), .b(new_n57_), .c(x09), .O(z14));
  inv1   g83(.a(new_n61_), .O(new_n127_));
  oai22  g84(.a(new_n127_), .b(new_n58_), .c(new_n57_), .d(new_n118_), .O(z15));
  nor2   g85(.a(new_n61_), .b(new_n50_), .O(z16));
