...
module FAU ( 
  ...
  nand2  g34(.a(new_n77_), .b(new_n64_), .O(new_n78_));
  inv1   g35(.a(new_n78_), .O(z06));
  nor2   g36(.a(x12), .b(x09), .O(new_n80_));
  aoi21  g37(.a(new_n80_), .b(new_n64_), .c(new_n67_), .O(new_n81_));
  ...
  nand3  g44(.a(x02), .b(new_n67_), .c(new_n66_), .O(new_n88_));
  ...
  nand3  g63(.a(new_n106_), .b(new_n105_), .c(new_n66_), .O(new_n107_));
  ...
  nand3  g83(.a(new_n44_), .b(new_n105_), .c(x09), .O(new_n127_));
  aoi21  g84(.a(new_n126_), .b(new_n121_), .c(new_n127_), .O(z12));
  inv1   g85(.a(new_n46_), .O(new_n129_));
  oai21  g86(.a(new_n124_), .b(new_n129_), .c(new_n45_), .O(z13));
  oai21  g87(.a(new_n59_), .b(new_n48_), .c(new_n45_), .O(z14));
  oai21  g88(.a(x10), .b(new_n67_), .c(x02), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(x00), .O(new_n133_));
  nand3  g90(.a(x19), .b(new_n55_), .c(new_n67_), .O(new_n134_));
  nand3  g91(.a(new_n134_), .b(new_n133_), .c(new_n45_), .O(z15));
  oai21  g92(.a(new_n67_), .b(x00), .c(new_n45_), .O(z16));
  nand2  g93(.a(new_n88_), .b(new_n45_), .O(z17));
endmodule
