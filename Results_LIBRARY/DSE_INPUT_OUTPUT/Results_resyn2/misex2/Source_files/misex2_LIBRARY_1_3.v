...
module FAU ( 
  ...
  nor2   g27(.a(new_n70_), .b(new_n45_), .O(new_n71_));
  nor2   g28(.a(x12), .b(new_n57_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n71_), .c(new_n69_), .d(new_n44_), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(new_n60_), .c(new_n46_), .O(z04));
  nand2  g31(.a(new_n63_), .b(x09), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n60_), .c(new_n46_), .O(z05));
  aoi21  g33(.a(new_n64_), .b(new_n60_), .c(new_n46_), .O(z06));
  ...
  nor2   g37(.a(new_n60_), .b(new_n46_), .O(new_n81_));
  ...
  nor2   g43(.a(new_n70_), .b(x00), .O(new_n87_));
  ...
  aoi21  g47(.a(new_n90_), .b(new_n46_), .c(new_n60_), .O(z08));
  ...
  nor2   g65(.a(new_n81_), .b(new_n45_), .O(new_n109_));
  ...
  nand2  g73(.a(new_n106_), .b(new_n45_), .O(new_n117_));
  ...
  nand3  g81(.a(new_n52_), .b(x17), .c(new_n70_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n124_), .c(new_n47_), .O(new_n126_));
  ...
  nor2   g86(.a(new_n125_), .b(new_n47_), .O(z13));
  nor2   g87(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g88(.a(x19), .b(new_n46_), .c(new_n109_), .O(new_n132_));
  nand4  g89(.a(new_n57_), .b(new_n60_), .c(x01), .d(x00), .O(new_n133_));
  oai21  g90(.a(new_n132_), .b(x02), .c(new_n133_), .O(z15));
  nand3  g91(.a(new_n60_), .b(x01), .c(new_n45_), .O(new_n135_));
  inv1   g92(.a(new_n135_), .O(z16));
  nand3  g93(.a(x02), .b(new_n46_), .c(new_n45_), .O(new_n137_));
