...
module FAU ( 
  ...
  nor2   g04(.a(x17), .b(x09), .O(new_n48_));
  nand4  g05(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n49_));
  aoi21  g06(.a(new_n49_), .b(x16), .c(new_n44_), .O(z00));
  inv1   g07(.a(x09), .O(new_n51_));
  nor2   g08(.a(x17), .b(new_n51_), .O(new_n52_));
  nand4  g09(.a(new_n52_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n53_));
  aoi21  g10(.a(new_n53_), .b(x16), .c(new_n44_), .O(z01));
  nor2   g11(.a(new_n53_), .b(x10), .O(z02));
  nand3  g12(.a(x02), .b(x01), .c(x00), .O(new_n56_));
  inv1   g13(.a(new_n56_), .O(new_n57_));
  nand3  g14(.a(new_n57_), .b(x10), .c(new_n51_), .O(new_n58_));
  nand3  g15(.a(x16), .b(x12), .c(x11), .O(new_n59_));
  inv1   g16(.a(x16), .O(new_n60_));
  nand2  g17(.a(new_n60_), .b(x10), .O(new_n61_));
  nand2  g18(.a(new_n61_), .b(new_n46_), .O(new_n62_));
  inv1   g19(.a(x17), .O(new_n63_));
  inv1   g20(.a(x19), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(x18), .c(new_n63_), .d(new_n45_), .O(new_n65_));
  oai22  g22(.a(new_n65_), .b(new_n62_), .c(new_n59_), .d(new_n58_), .O(z03));
  inv1   g23(.a(x11), .O(new_n67_));
  inv1   g24(.a(x12), .O(new_n68_));
  nand4  g25(.a(new_n57_), .b(new_n68_), .c(new_n67_), .d(new_n51_), .O(new_n69_));
  aoi21  g26(.a(new_n69_), .b(x16), .c(new_n44_), .O(z04));
  nor4   g27(.a(new_n56_), .b(new_n60_), .c(new_n44_), .d(new_n51_), .O(z05));
  nor3   g28(.a(new_n58_), .b(new_n60_), .c(new_n67_), .O(z06));
  ...
  aoi21  g59(.a(new_n98_), .b(new_n90_), .c(new_n102_), .O(z09));
  nand4  g60(.a(new_n89_), .b(new_n87_), .c(x22), .d(x21), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  inv1   g62(.a(x14), .O(new_n106_));
  nand4  g63(.a(new_n100_), .b(x20), .c(new_n106_), .d(new_n105_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nor3   g65(.a(x22), .b(new_n60_), .c(new_n95_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n108_), .c(new_n93_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n104_), .c(x00), .O(z10));
  nand2  g68(.a(new_n101_), .b(new_n99_), .O(new_n112_));
  nand3  g69(.a(new_n89_), .b(new_n87_), .c(x21), .O(new_n113_));
  nor2   g70(.a(x16), .b(new_n95_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n108_), .c(new_n93_), .d(new_n44_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(z11));
  oai21  g73(.a(new_n60_), .b(x02), .c(x10), .O(new_n117_));
  ...
  nand2  g78(.a(new_n121_), .b(new_n63_), .O(new_n122_));
  nand4  g79(.a(new_n122_), .b(new_n120_), .c(new_n61_), .d(new_n46_), .O(new_n123_));
  inv1   g80(.a(x24), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x09), .O(new_n125_));
  aoi21  g82(.a(new_n123_), .b(new_n118_), .c(new_n125_), .O(z12));
  inv1   g83(.a(new_n62_), .O(new_n127_));
  nand3  g84(.a(new_n121_), .b(new_n127_), .c(x17), .O(new_n128_));
  inv1   g85(.a(new_n128_), .O(z13));
  nand4  g86(.a(new_n46_), .b(new_n78_), .c(new_n44_), .d(new_n51_), .O(new_n130_));
  oai21  g87(.a(new_n130_), .b(new_n122_), .c(new_n61_), .O(z14));
  nand2  g88(.a(x02), .b(new_n91_), .O(new_n132_));
  oai21  g89(.a(new_n64_), .b(x01), .c(new_n99_), .O(new_n133_));
  nand3  g90(.a(new_n133_), .b(new_n117_), .c(new_n132_), .O(new_n134_));
  inv1   g91(.a(new_n134_), .O(z15));
  nand2  g92(.a(x01), .b(new_n99_), .O(new_n136_));
  aoi21  g93(.a(new_n60_), .b(x10), .c(new_n136_), .O(z16));
  nand2  g94(.a(new_n127_), .b(x02), .O(new_n138_));
