...
module FAU ( 
  ...
  nor2   g27(.a(x01), .b(x00), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(x02), .O(new_n73_));
  nand3  g29(.a(x19), .b(new_n51_), .c(x17), .O(new_n74_));
  nor3   g30(.a(new_n74_), .b(new_n73_), .c(new_n71_), .O(z08));
  ...
  nor2   g38(.a(new_n66_), .b(x01), .O(new_n83_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n45_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n89_), .c(new_n87_), .d(new_n83_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n82_), .O(z09));
  nand3  g52(.a(x16), .b(x15), .c(new_n90_), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n89_), .c(new_n87_), .d(new_n83_), .O(new_n99_));
  inv1   g55(.a(new_n80_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(x22), .c(x21), .d(x01), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n99_), .c(x00), .O(z10));
  nand3  g58(.a(new_n100_), .b(x21), .c(x01), .O(new_n103_));
  nor2   g59(.a(new_n91_), .b(x14), .O(new_n104_));
  nand3  g60(.a(new_n76_), .b(x20), .c(new_n92_), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n104_), .c(new_n87_), .d(new_n83_), .O(new_n107_));
  nand2  g63(.a(new_n77_), .b(new_n45_), .O(new_n108_));
  aoi21  g64(.a(new_n107_), .b(new_n103_), .c(new_n108_), .O(z11));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g66(.a(new_n52_), .b(x17), .c(new_n66_), .O(new_n111_));
  ...
  nand2  g70(.a(new_n114_), .b(new_n55_), .O(z12));
  nor2   g71(.a(new_n111_), .b(new_n47_), .O(z13));
  oai21  g72(.a(new_n59_), .b(new_n49_), .c(new_n55_), .O(z14));
  nand2  g73(.a(new_n66_), .b(new_n46_), .O(new_n118_));
  aoi21  g74(.a(new_n52_), .b(new_n45_), .c(new_n118_), .O(z15));
  inv1   g75(.a(new_n73_), .O(z17));
  zero   g76(.O(z05));
  inv1   g77(.a(new_n55_), .O(z06));
  buf    g78(.a(x01), .O(z16));
endmodule
