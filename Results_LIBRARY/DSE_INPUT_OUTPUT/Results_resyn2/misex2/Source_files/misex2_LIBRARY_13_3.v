...
module FAU ( 
  ...
  inv1   g17(.a(new_n49_), .O(new_n61_));
  nand3  g18(.a(new_n53_), .b(x18), .c(new_n51_), .O(new_n62_));
  oai21  g19(.a(new_n62_), .b(new_n61_), .c(new_n44_), .O(z03));
  inv1   g20(.a(new_n44_), .O(z04));
  nand3  g21(.a(x02), .b(new_n47_), .c(x00), .O(new_n67_));
  ...
  nand3  g30(.a(x19), .b(new_n52_), .c(x17), .O(new_n76_));
  nor3   g31(.a(new_n76_), .b(new_n75_), .c(new_n72_), .O(z08));
  inv1   g32(.a(x20), .O(new_n78_));
  nand4  g33(.a(new_n78_), .b(new_n53_), .c(x18), .d(x01), .O(new_n79_));
  nand2  g34(.a(x02), .b(new_n47_), .O(new_n80_));
  ...
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n46_), .O(new_n90_));
  aoi21  g45(.a(new_n87_), .b(new_n79_), .c(new_n90_), .O(z09));
  inv1   g46(.a(new_n79_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(x22), .c(x21), .O(new_n93_));
  inv1   g48(.a(x14), .O(new_n94_));
  nand4  g49(.a(new_n88_), .b(x20), .c(x15), .d(new_n94_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(new_n96_));
  inv1   g51(.a(x16), .O(new_n97_));
  nor2   g52(.a(x22), .b(new_n97_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n96_), .c(new_n84_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n93_), .c(x00), .O(z10));
  nand2  g55(.a(new_n89_), .b(new_n46_), .O(new_n101_));
  nand2  g56(.a(new_n92_), .b(x21), .O(new_n102_));
  nand3  g57(.a(new_n96_), .b(new_n84_), .c(new_n97_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(z11));
  oai21  g59(.a(x19), .b(x02), .c(x23), .O(new_n105_));
  nand3  g60(.a(new_n53_), .b(x17), .c(new_n73_), .O(new_n106_));
  inv1   g61(.a(x24), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(x09), .c(new_n47_), .d(new_n46_), .O(new_n108_));
  aoi21  g63(.a(new_n106_), .b(new_n105_), .c(new_n108_), .O(z12));
  nor2   g64(.a(new_n106_), .b(new_n48_), .O(z13));
  oai21  g65(.a(new_n59_), .b(new_n50_), .c(new_n44_), .O(z14));
  aoi21  g66(.a(x19), .b(new_n47_), .c(x00), .O(new_n112_));
  nor2   g67(.a(new_n112_), .b(new_n74_), .O(z15));
  nand2  g68(.a(new_n75_), .b(new_n44_), .O(z17));
  zero   g69(.O(z05));
  zero   g70(.O(z06));
  buf    g71(.a(x01), .O(z16));
endmodule
