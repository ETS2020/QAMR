...
module FAU ( 
  ...
  oai21  g09(.a(new_n52_), .b(new_n49_), .c(new_n46_), .O(z00));
  nand2  g10(.a(new_n51_), .b(x09), .O(new_n54_));
  oai21  g11(.a(new_n54_), .b(new_n49_), .c(new_n46_), .O(z01));
  inv1   g12(.a(x10), .O(new_n56_));
  nand4  g13(.a(new_n48_), .b(new_n44_), .c(new_n47_), .d(new_n56_), .O(new_n57_));
  nor2   g14(.a(new_n57_), .b(new_n54_), .O(z02));
  nor2   g15(.a(x19), .b(new_n44_), .O(new_n59_));
  nand4  g16(.a(new_n59_), .b(new_n51_), .c(x23), .d(new_n47_), .O(new_n60_));
  ...
  nand4  g22(.a(new_n65_), .b(x11), .c(x10), .d(new_n50_), .O(new_n66_));
  nand2  g23(.a(new_n46_), .b(x12), .O(new_n67_));
  oai21  g24(.a(new_n67_), .b(new_n66_), .c(new_n60_), .O(z03));
  inv1   g25(.a(x12), .O(new_n69_));
  nand3  g26(.a(new_n69_), .b(x10), .c(new_n50_), .O(new_n70_));
  inv1   g27(.a(x11), .O(new_n71_));
  nand2  g28(.a(new_n65_), .b(new_n71_), .O(new_n72_));
  oai21  g29(.a(new_n72_), .b(new_n70_), .c(new_n46_), .O(z04));
  nand2  g30(.a(x10), .b(x02), .O(new_n74_));
  nand2  g31(.a(new_n63_), .b(x09), .O(new_n75_));
  oai21  g32(.a(new_n75_), .b(new_n74_), .c(new_n46_), .O(z05));
  nand2  g33(.a(new_n66_), .b(new_n46_), .O(z06));
  oai21  g34(.a(new_n70_), .b(new_n71_), .c(x01), .O(new_n78_));
  ...
  nand3  g42(.a(x19), .b(new_n44_), .c(x17), .O(new_n86_));
  nor3   g43(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(z08));
  inv1   g44(.a(x20), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(new_n48_), .c(x18), .d(x01), .O(new_n89_));
  ...
  nand2  g67(.a(new_n102_), .b(new_n61_), .O(new_n111_));
  nor2   g68(.a(new_n106_), .b(x16), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n94_), .c(new_n105_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n111_), .c(new_n46_), .O(z11));
  ...
  nand2  g76(.a(new_n117_), .b(new_n47_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n119_), .c(new_n115_), .O(new_n121_));
  nand3  g78(.a(new_n74_), .b(new_n63_), .c(new_n46_), .O(new_n122_));
  inv1   g79(.a(x24), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(x09), .O(new_n124_));
  aoi21  g81(.a(new_n122_), .b(new_n121_), .c(new_n124_), .O(z12));
  nand3  g82(.a(new_n117_), .b(new_n115_), .c(x17), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n46_), .O(z13));
  nor2   g84(.a(new_n57_), .b(new_n52_), .O(z14));
  oai21  g85(.a(x10), .b(new_n62_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  inv1   g87(.a(x02), .O(new_n131_));
  nand3  g88(.a(x19), .b(new_n131_), .c(new_n62_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n130_), .c(new_n45_), .O(z15));
  nor3   g90(.a(new_n45_), .b(new_n62_), .c(x00), .O(z16));
  nand2  g91(.a(new_n85_), .b(new_n46_), .O(z17));
endmodule
