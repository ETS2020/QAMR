...
module FAU ( 
  ...
  nor2   g44(.a(new_n49_), .b(x01), .O(new_n88_));
  ...
  nand4  g53(.a(new_n94_), .b(new_n44_), .c(x18), .d(x01), .O(new_n97_));
  inv1   g54(.a(x16), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n45_), .c(new_n98_), .d(new_n70_), .O(new_n100_));
  aoi21  g57(.a(new_n97_), .b(new_n96_), .c(new_n100_), .O(z09));
  inv1   g58(.a(new_n97_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(x22), .c(x21), .d(new_n70_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z10));
  nand2  g61(.a(new_n99_), .b(new_n70_), .O(new_n105_));
  nand2  g62(.a(new_n102_), .b(x21), .O(new_n106_));
  nand4  g63(.a(new_n45_), .b(x20), .c(new_n98_), .d(x15), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n93_), .c(new_n88_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(z11));
  nand2  g67(.a(new_n69_), .b(new_n72_), .O(new_n111_));
  nand3  g68(.a(new_n44_), .b(new_n84_), .c(new_n49_), .O(new_n112_));
  ...
  nand4  g76(.a(x17), .b(new_n49_), .c(new_n71_), .d(new_n70_), .O(new_n120_));
  nor3   g77(.a(new_n120_), .b(new_n119_), .c(x19), .O(z13));
  nand3  g78(.a(new_n47_), .b(new_n44_), .c(new_n60_), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n52_), .c(new_n46_), .O(z14));
  oai21  g80(.a(x10), .b(new_n71_), .c(x02), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x00), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n49_), .c(new_n71_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n125_), .c(new_n119_), .O(z15));
  oai21  g84(.a(new_n71_), .b(x00), .c(new_n46_), .O(z16));
  nand2  g85(.a(new_n51_), .b(x02), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(new_n119_), .O(z17));
endmodule
