...
module FAU ( 
  ...
  aoi21  g29(.a(new_n72_), .b(new_n59_), .c(new_n71_), .O(z04));
  nand4  g30(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(new_n59_), .c(new_n71_), .O(z05));
  aoi21  g32(.a(new_n65_), .b(new_n59_), .c(new_n71_), .O(z06));
  nand4  g33(.a(new_n64_), .b(new_n60_), .c(new_n46_), .d(new_n59_), .O(new_n77_));
  ...
  nand3  g40(.a(x02), .b(new_n71_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g59(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n100_), .c(new_n44_), .O(z09));
  nor2   g61(.a(new_n89_), .b(new_n101_), .O(new_n105_));
  nand4  g62(.a(new_n101_), .b(x20), .c(x15), .d(new_n95_), .O(new_n106_));
  nand2  g63(.a(new_n102_), .b(x16), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  aoi22  g65(.a(new_n108_), .b(new_n94_), .c(new_n105_), .d(x22), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(x00), .c(new_n44_), .O(z10));
  nand2  g67(.a(new_n102_), .b(new_n83_), .O(new_n111_));
  nor2   g68(.a(new_n106_), .b(x16), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n94_), .c(new_n105_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n111_), .c(new_n44_), .O(z11));
  ...
  nand4  g77(.a(new_n120_), .b(new_n59_), .c(x01), .d(x00), .O(new_n121_));
  ...
  oai21  g82(.a(new_n117_), .b(new_n125_), .c(new_n44_), .O(z13));
  oai21  g83(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g84(.a(x10), .b(new_n71_), .c(x02), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(x00), .O(new_n129_));
  nand3  g86(.a(x19), .b(new_n45_), .c(new_n71_), .O(new_n130_));
  nand3  g87(.a(new_n130_), .b(new_n129_), .c(new_n44_), .O(z15));
  aoi21  g88(.a(new_n59_), .b(x00), .c(new_n71_), .O(z16));
