...
module FAU ( 
  ...
  nand4  g23(.a(new_n66_), .b(new_n53_), .c(new_n49_), .d(x18), .O(new_n67_));
  aoi21  g24(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(z03));
  ...
  aoi21  g34(.a(new_n64_), .b(new_n70_), .c(new_n77_), .O(new_n78_));
  nand3  g35(.a(new_n46_), .b(x02), .c(x00), .O(new_n79_));
  nor2   g36(.a(new_n79_), .b(new_n78_), .O(z07));
  ...
  nand4  g44(.a(new_n87_), .b(new_n81_), .c(x19), .d(new_n48_), .O(new_n88_));
  nand2  g45(.a(new_n88_), .b(new_n46_), .O(z08));
  inv1   g46(.a(x20), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(new_n49_), .c(x18), .d(x01), .O(new_n91_));
  inv1   g48(.a(new_n91_), .O(new_n92_));
  nand2  g49(.a(new_n92_), .b(new_n46_), .O(new_n93_));
  inv1   g50(.a(x16), .O(new_n94_));
  nand2  g51(.a(x02), .b(new_n77_), .O(new_n95_));
  nand3  g52(.a(new_n44_), .b(x12), .c(new_n69_), .O(new_n96_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n97_), .c(new_n94_), .O(new_n116_));
  ...
  nand3  g78(.a(new_n49_), .b(x17), .c(new_n51_), .O(new_n122_));
  ...
  oai21  g83(.a(new_n122_), .b(new_n120_), .c(new_n46_), .O(z13));
  nor3   g84(.a(new_n59_), .b(new_n54_), .c(new_n45_), .O(z14));
  oai21  g85(.a(x10), .b(new_n77_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n51_), .c(new_n77_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(new_n130_), .c(new_n45_), .O(z15));
  oai21  g89(.a(new_n77_), .b(x00), .c(new_n46_), .O(z16));
  nor3   g90(.a(new_n120_), .b(new_n45_), .c(new_n51_), .O(z17));
endmodule
