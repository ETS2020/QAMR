...
module FAU ( 
  ...
  nand2  g26(.a(new_n65_), .b(new_n63_), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(x12), .c(x11), .O(z04));
  nand4  g28(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x06), .c(new_n56_), .O(z05));
  inv1   g30(.a(x11), .O(new_n74_));
  nor2   g31(.a(new_n70_), .b(new_n74_), .O(z06));
  nand2  g32(.a(x02), .b(x00), .O(new_n76_));
  inv1   g33(.a(x12), .O(new_n77_));
  nand4  g34(.a(new_n63_), .b(new_n77_), .c(x11), .d(x10), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(x01), .c(new_n76_), .O(z07));
  inv1   g36(.a(x08), .O(new_n80_));
  nand4  g37(.a(x19), .b(new_n50_), .c(x17), .d(new_n80_), .O(new_n81_));
  inv1   g38(.a(new_n81_), .O(new_n82_));
  inv1   g39(.a(x02), .O(new_n83_));
  nor2   g40(.a(new_n83_), .b(x00), .O(new_n84_));
  inv1   g41(.a(x04), .O(new_n85_));
  nor2   g42(.a(new_n85_), .b(x03), .O(new_n86_));
  nor2   g43(.a(x07), .b(x05), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n88_));
  aoi21  g45(.a(new_n88_), .b(new_n56_), .c(x06), .O(z08));
  inv1   g46(.a(x16), .O(new_n90_));
  nand2  g47(.a(x02), .b(new_n56_), .O(new_n91_));
  ...
  nand4  g54(.a(new_n67_), .b(new_n97_), .c(x06), .d(x01), .O(new_n98_));
  ...
  aoi21  g59(.a(new_n98_), .b(new_n96_), .c(new_n102_), .O(z09));
  nor2   g60(.a(new_n57_), .b(new_n99_), .O(new_n104_));
  ...
  nand2  g66(.a(new_n97_), .b(x01), .O(new_n110_));
  nand3  g67(.a(x21), .b(new_n51_), .c(x18), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(x22), .c(new_n57_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(new_n104_), .O(z10));
  nand2  g71(.a(new_n101_), .b(new_n99_), .O(new_n115_));
  nand3  g72(.a(new_n100_), .b(x20), .c(new_n90_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(new_n106_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n94_), .c(new_n112_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n115_), .c(new_n58_), .O(z11));
  nand2  g76(.a(x10), .b(x02), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(x06), .c(x01), .d(x00), .O(new_n121_));
  ...
  oai21  g89(.a(new_n132_), .b(new_n104_), .c(new_n83_), .O(new_n133_));
  nand4  g90(.a(new_n59_), .b(x06), .c(x01), .d(x00), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(new_n133_), .O(z15));
  nand3  g92(.a(x06), .b(x01), .c(new_n99_), .O(new_n136_));
  inv1   g93(.a(new_n136_), .O(z16));
  oai21  g94(.a(new_n46_), .b(new_n83_), .c(new_n58_), .O(z17));
endmodule
