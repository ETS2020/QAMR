...
module FAU ( 
  ...
  nand2  g05(.a(new_n48_), .b(new_n45_), .O(new_n49_));
  ...
  inv1   g16(.a(x05), .O(new_n60_));
  nand3  g17(.a(new_n60_), .b(x01), .c(x00), .O(new_n61_));
  inv1   g18(.a(new_n61_), .O(new_n62_));
  nand3  g19(.a(x10), .b(new_n45_), .c(x02), .O(new_n63_));
  inv1   g20(.a(new_n63_), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(new_n62_), .c(x12), .d(x11), .O(new_n65_));
  nand4  g22(.a(new_n48_), .b(new_n52_), .c(x18), .d(new_n50_), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(new_n65_), .O(z03));
  nand2  g24(.a(new_n64_), .b(new_n62_), .O(new_n68_));
  nor3   g25(.a(new_n68_), .b(x12), .c(x11), .O(z04));
  inv1   g26(.a(x02), .O(new_n70_));
  nor4   g27(.a(new_n61_), .b(new_n57_), .c(new_n45_), .d(new_n70_), .O(z05));
  inv1   g28(.a(x11), .O(new_n72_));
  nor2   g29(.a(new_n68_), .b(new_n72_), .O(z06));
  inv1   g30(.a(x12), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(x11), .c(x10), .d(new_n45_), .O(new_n75_));
  ...
  inv1   g40(.a(new_n83_), .O(z17));
  nand4  g41(.a(z17), .b(x19), .c(new_n51_), .d(x17), .O(new_n85_));
  oai21  g42(.a(new_n85_), .b(new_n82_), .c(new_n44_), .O(z08));
  nand2  g43(.a(new_n60_), .b(x01), .O(new_n87_));
  inv1   g44(.a(x20), .O(new_n88_));
  nand3  g45(.a(new_n88_), .b(new_n52_), .c(x18), .O(new_n89_));
  ...
  nor2   g66(.a(new_n109_), .b(new_n89_), .O(new_n110_));
  ...
  nand2  g70(.a(new_n90_), .b(x21), .O(new_n114_));
  ...
  oai21  g79(.a(new_n57_), .b(new_n70_), .c(new_n62_), .O(new_n123_));
  ...
  oai21  g84(.a(new_n58_), .b(new_n49_), .c(new_n44_), .O(z14));
  oai21  g85(.a(x10), .b(new_n93_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n70_), .c(new_n93_), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(new_n130_), .c(new_n44_), .O(z15));
  aoi21  g89(.a(new_n60_), .b(x00), .c(new_n93_), .O(z16));
endmodule
