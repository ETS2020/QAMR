...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n132_, new_n134_;
  nand2  g00(.a(x21), .b(x13), .O(new_n44_));
  ...
  nand4  g13(.a(new_n44_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n57_));
  nand3  g14(.a(new_n51_), .b(x09), .c(new_n49_), .O(new_n58_));
  nor3   g15(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z01));
  inv1   g16(.a(new_n57_), .O(new_n60_));
  nand2  g17(.a(new_n60_), .b(new_n56_), .O(new_n61_));
  nor2   g18(.a(new_n61_), .b(new_n58_), .O(z02));
  inv1   g19(.a(new_n44_), .O(new_n63_));
  ...
  nand3  g24(.a(x11), .b(x10), .c(new_n50_), .O(new_n68_));
  nor2   g25(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g26(.a(new_n69_), .b(x12), .O(new_n70_));
  nor2   g27(.a(x17), .b(x02), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(new_n51_), .c(new_n47_), .d(x18), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(new_n70_), .c(new_n63_), .O(z03));
  inv1   g30(.a(x11), .O(new_n74_));
  inv1   g31(.a(x12), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(new_n74_), .c(x10), .d(new_n50_), .O(new_n76_));
  oai21  g33(.a(new_n76_), .b(new_n67_), .c(new_n44_), .O(z04));
  nor4   g34(.a(new_n67_), .b(new_n63_), .c(new_n56_), .d(new_n50_), .O(z05));
  oai21  g35(.a(new_n68_), .b(new_n67_), .c(new_n44_), .O(z06));
  oai21  g36(.a(new_n68_), .b(x12), .c(x01), .O(new_n80_));
  ...
  nand3  g43(.a(x02), .b(new_n65_), .c(new_n64_), .O(new_n87_));
  inv1   g44(.a(new_n87_), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(x19), .c(new_n46_), .d(x17), .O(new_n89_));
  oai21  g46(.a(new_n89_), .b(new_n86_), .c(new_n44_), .O(z08));
  inv1   g47(.a(x20), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(new_n47_), .c(x18), .d(x01), .O(new_n92_));
  inv1   g49(.a(new_n92_), .O(new_n93_));
  nand2  g50(.a(x02), .b(new_n65_), .O(new_n94_));
  inv1   g51(.a(x13), .O(new_n95_));
  nand3  g52(.a(new_n95_), .b(x12), .c(new_n74_), .O(new_n96_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n44_), .O(z09));
  ...
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n44_), .O(z11));
  oai21  g74(.a(new_n56_), .b(new_n49_), .c(new_n66_), .O(new_n118_));
  ...
  nand3  g81(.a(new_n44_), .b(new_n124_), .c(x09), .O(new_n125_));
  aoi21  g82(.a(new_n123_), .b(new_n118_), .c(new_n125_), .O(z12));
  inv1   g83(.a(new_n51_), .O(new_n127_));
  oai21  g84(.a(new_n121_), .b(new_n127_), .c(new_n44_), .O(z13));
  nor2   g85(.a(new_n61_), .b(new_n52_), .O(z14));
  oai21  g86(.a(x10), .b(new_n65_), .c(x02), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(x00), .O(new_n131_));
  nand3  g88(.a(x19), .b(new_n49_), .c(new_n65_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n131_), .c(new_n63_), .O(z15));
  nand3  g90(.a(new_n44_), .b(x01), .c(new_n64_), .O(new_n134_));
