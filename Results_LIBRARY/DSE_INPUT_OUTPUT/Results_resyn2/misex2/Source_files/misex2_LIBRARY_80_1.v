...
module FAU ( 
  ...
  nand3  g27(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x00), .c(new_n44_), .O(z04));
  nand3  g29(.a(x09), .b(x01), .c(x00), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n55_), .c(new_n68_), .O(z05));
  aoi21  g31(.a(new_n64_), .b(x00), .c(new_n44_), .O(z06));
  nand2  g32(.a(x01), .b(new_n52_), .O(new_n76_));
  aoi21  g33(.a(new_n70_), .b(new_n63_), .c(new_n44_), .O(new_n77_));
  ...
  nand3  g40(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n84_));
  ...
  aoi21  g53(.a(new_n96_), .b(new_n44_), .c(x00), .O(z09));
  inv1   g54(.a(new_n84_), .O(new_n98_));
  nor2   g55(.a(new_n94_), .b(x11), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n93_), .c(new_n98_), .d(x15), .O(new_n100_));
  nand4  g57(.a(new_n90_), .b(new_n89_), .c(x20), .d(x16), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(new_n100_), .O(z10));
  nor2   g59(.a(new_n100_), .b(new_n91_), .O(z11));
  aoi21  g60(.a(x10), .b(x02), .c(new_n44_), .O(new_n104_));
  inv1   g61(.a(x23), .O(new_n105_));
  oai21  g62(.a(x19), .b(x02), .c(new_n105_), .O(new_n106_));
  aoi21  g63(.a(new_n50_), .b(new_n58_), .c(x00), .O(new_n107_));
  ...
  aoi21  g69(.a(new_n112_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g70(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n55_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g72(.a(new_n55_), .b(new_n52_), .c(x01), .O(new_n116_));
  oai21  g73(.a(x19), .b(x00), .c(new_n68_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n116_), .O(z15));
  aoi21  g75(.a(new_n68_), .b(new_n44_), .c(x00), .O(z17));
  zero   g76(.O(z16));
endmodule
