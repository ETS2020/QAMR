...
module FAU ( 
  ...
  nor2   g13(.a(x16), .b(new_n46_), .O(new_n57_));
  ...
  nand4  g22(.a(new_n65_), .b(new_n63_), .c(x16), .d(x12), .O(new_n66_));
  ...
  nor4   g29(.a(new_n72_), .b(new_n64_), .c(new_n70_), .d(x12), .O(z04));
  nor4   g30(.a(new_n64_), .b(new_n70_), .c(new_n59_), .d(new_n44_), .O(z05));
  nand3  g31(.a(new_n63_), .b(x02), .c(x00), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x16), .c(new_n46_), .O(z06));
  nand2  g33(.a(x02), .b(x00), .O(new_n77_));
  nor2   g34(.a(new_n70_), .b(x12), .O(new_n78_));
  ...
  nand4  g43(.a(z17), .b(x19), .c(new_n51_), .d(x17), .O(new_n87_));
  ...
  nand4  g48(.a(new_n91_), .b(x12), .c(new_n71_), .d(x02), .O(new_n92_));
  inv1   g49(.a(x14), .O(new_n93_));
  inv1   g50(.a(x15), .O(new_n94_));
  nand4  g51(.a(x20), .b(new_n70_), .c(new_n94_), .d(new_n93_), .O(new_n95_));
  ...
  nor2   g58(.a(new_n57_), .b(new_n45_), .O(new_n102_));
  nor2   g59(.a(new_n92_), .b(x01), .O(new_n103_));
  inv1   g60(.a(x21), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(x20), .c(x15), .d(new_n93_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nor2   g63(.a(x22), .b(new_n70_), .O(new_n107_));
  ...
  aoi21  g67(.a(new_n110_), .b(new_n109_), .c(new_n57_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n108_), .c(new_n102_), .O(z10));
  nand3  g69(.a(new_n106_), .b(new_n103_), .c(new_n70_), .O(new_n113_));
  ...
  nand3  g76(.a(new_n52_), .b(x17), .c(new_n119_), .O(new_n120_));
  ...
  nand2  g80(.a(new_n123_), .b(new_n58_), .O(z12));
  oai21  g81(.a(new_n67_), .b(new_n50_), .c(new_n58_), .O(z13));
  oai21  g82(.a(new_n60_), .b(new_n49_), .c(new_n58_), .O(z14));
  nor2   g83(.a(new_n52_), .b(x01), .O(new_n127_));
  oai21  g84(.a(new_n127_), .b(new_n102_), .c(new_n119_), .O(new_n128_));
  nand4  g85(.a(x16), .b(new_n59_), .c(x01), .d(x00), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(new_n128_), .O(z15));
  aoi21  g87(.a(x16), .b(x00), .c(new_n46_), .O(z16));
endmodule
