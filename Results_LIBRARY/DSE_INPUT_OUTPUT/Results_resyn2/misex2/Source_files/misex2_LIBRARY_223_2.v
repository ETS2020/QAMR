...
module FAU ( 
  ...
  nor3   g10(.a(new_n53_), .b(new_n50_), .c(new_n49_), .O(z01));
  inv1   g11(.a(x10), .O(new_n55_));
  nand4  g12(.a(new_n46_), .b(new_n55_), .c(x09), .d(new_n51_), .O(new_n56_));
  ...
  nor2   g18(.a(new_n55_), .b(new_n51_), .O(new_n62_));
  nand3  g19(.a(new_n62_), .b(x11), .c(new_n49_), .O(new_n63_));
  inv1   g20(.a(x01), .O(new_n64_));
  nor2   g21(.a(new_n64_), .b(new_n44_), .O(new_n65_));
  nand2  g22(.a(new_n65_), .b(x12), .O(new_n66_));
  oai22  g23(.a(new_n66_), .b(new_n63_), .c(new_n61_), .d(new_n53_), .O(z03));
  inv1   g24(.a(x11), .O(new_n68_));
  inv1   g25(.a(x12), .O(new_n69_));
  nand4  g26(.a(new_n62_), .b(new_n69_), .c(new_n68_), .d(new_n49_), .O(new_n70_));
  ...
  aoi21  g31(.a(new_n63_), .b(x01), .c(new_n44_), .O(z06));
  nand4  g32(.a(new_n62_), .b(new_n69_), .c(x11), .d(new_n49_), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n44_), .O(z07));
  inv1   g34(.a(x08), .O(new_n78_));
  nand4  g35(.a(x19), .b(new_n59_), .c(x17), .d(new_n78_), .O(new_n79_));
  inv1   g36(.a(new_n79_), .O(new_n80_));
  nor2   g37(.a(x03), .b(new_n51_), .O(new_n81_));
  ...
  nor2   g61(.a(x20), .b(new_n64_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n60_), .c(x22), .d(x21), .O(new_n106_));
  nand3  g63(.a(x16), .b(x15), .c(new_n64_), .O(new_n107_));
  ...
  nor2   g72(.a(new_n62_), .b(new_n44_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  inv1   g74(.a(x19), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(x17), .c(new_n51_), .O(new_n119_));
  ...
  nand2  g79(.a(new_n64_), .b(x00), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(z12));
  inv1   g81(.a(new_n52_), .O(new_n125_));
  nor2   g82(.a(new_n119_), .b(new_n125_), .O(z13));
  nand3  g83(.a(new_n46_), .b(new_n45_), .c(new_n55_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g85(.a(x19), .b(new_n51_), .c(x00), .O(new_n129_));
  nor2   g86(.a(new_n116_), .b(new_n64_), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(new_n129_), .O(z15));
  nor2   g88(.a(new_n65_), .b(new_n52_), .O(z16));
  aoi21  g89(.a(new_n51_), .b(new_n44_), .c(x01), .O(z17));
endmodule
