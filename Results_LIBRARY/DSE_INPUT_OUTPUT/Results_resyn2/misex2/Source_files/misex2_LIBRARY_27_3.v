...
module FAU ( 
  ...
  nand4  g46(.a(new_n90_), .b(new_n89_), .c(new_n87_), .d(new_n83_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n82_), .O(z09));
  nand4  g48(.a(x21), .b(new_n79_), .c(new_n52_), .d(x18), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n77_), .c(new_n45_), .O(new_n94_));
  ...
  oai21  g55(.a(new_n93_), .b(x22), .c(new_n45_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(x01), .O(new_n101_));
  nand4  g57(.a(new_n97_), .b(new_n89_), .c(new_n87_), .d(new_n83_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(z11));
  inv1   g59(.a(new_n47_), .O(new_n104_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n105_));
  nand3  g61(.a(new_n52_), .b(x17), .c(new_n66_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nor2   g63(.a(x24), .b(new_n44_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n107_), .c(new_n104_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n55_), .O(z12));
  oai21  g66(.a(new_n106_), .b(new_n47_), .c(new_n55_), .O(z13));
  nor2   g67(.a(new_n59_), .b(new_n49_), .O(z14));
  nand2  g68(.a(x19), .b(new_n46_), .O(new_n113_));
  aoi22  g69(.a(new_n113_), .b(new_n45_), .c(x02), .d(new_n46_), .O(z15));
  nand2  g70(.a(new_n72_), .b(new_n55_), .O(z17));
  zero   g71(.O(z04));
  inv1   g72(.a(new_n55_), .O(z06));
  buf    g73(.a(x01), .O(z16));
endmodule
