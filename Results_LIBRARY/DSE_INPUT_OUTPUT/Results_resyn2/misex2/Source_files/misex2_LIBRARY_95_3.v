...
module FAU ( 
  ...
  nand3  g33(.a(new_n78_), .b(new_n52_), .c(x18), .O(new_n79_));
  oai21  g34(.a(new_n79_), .b(new_n77_), .c(new_n45_), .O(new_n80_));
  ...
  nor2   g39(.a(new_n84_), .b(new_n72_), .O(new_n85_));
  nand3  g40(.a(new_n76_), .b(new_n75_), .c(x20), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor3   g42(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n81_), .O(z09));
  nand2  g45(.a(x22), .b(x21), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(new_n79_), .c(new_n45_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(x01), .O(new_n93_));
  inv1   g48(.a(x15), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x14), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n87_), .c(new_n85_), .d(x16), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n93_), .O(z10));
  nor2   g52(.a(new_n66_), .b(x01), .O(new_n98_));
  inv1   g53(.a(new_n84_), .O(new_n99_));
  inv1   g54(.a(x16), .O(new_n100_));
  nand3  g55(.a(new_n75_), .b(x20), .c(new_n100_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n95_), .c(new_n99_), .d(new_n98_), .O(new_n103_));
  inv1   g58(.a(new_n79_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(x21), .c(x01), .O(new_n105_));
  nand2  g60(.a(new_n76_), .b(new_n45_), .O(new_n106_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(new_n106_), .O(z11));
  ...
  nand2  g69(.a(new_n66_), .b(new_n46_), .O(new_n115_));
  aoi21  g70(.a(new_n52_), .b(new_n45_), .c(new_n115_), .O(z15));
  nor2   g71(.a(new_n46_), .b(x00), .O(z16));
  nand2  g72(.a(new_n72_), .b(new_n55_), .O(z17));
  zero   g73(.O(z05));
  zero   g74(.O(z06));
endmodule
