...
module FAU ( 
  ...
  nand2  g01(.a(new_n44_), .b(x07), .O(new_n45_));
  ...
  oai21  g45(.a(new_n88_), .b(new_n82_), .c(new_n45_), .O(z08));
  ...
  nand4  g52(.a(x20), .b(new_n44_), .c(new_n95_), .d(new_n94_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  inv1   g54(.a(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n66_), .c(x18), .d(x01), .O(new_n99_));
  ...
  nand3  g60(.a(new_n103_), .b(new_n102_), .c(new_n83_), .O(new_n104_));
  oai21  g61(.a(new_n104_), .b(new_n101_), .c(new_n45_), .O(z09));
  nor2   g62(.a(new_n99_), .b(new_n102_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n45_), .c(x22), .O(new_n107_));
  nand2  g64(.a(x15), .b(new_n94_), .O(new_n108_));
  ...
  nand2  g69(.a(new_n103_), .b(new_n83_), .O(new_n113_));
  nand3  g70(.a(new_n102_), .b(x20), .c(new_n44_), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(new_n108_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n93_), .c(new_n106_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n113_), .c(new_n45_), .O(z11));
  ...
  nand3  g89(.a(x19), .b(new_n121_), .c(new_n84_), .O(new_n133_));
  aoi22  g90(.a(new_n133_), .b(new_n132_), .c(new_n44_), .d(x07), .O(z15));
