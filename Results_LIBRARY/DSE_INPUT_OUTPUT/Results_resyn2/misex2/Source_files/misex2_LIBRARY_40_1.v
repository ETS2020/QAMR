...
module FAU ( 
  ...
  aoi21  g16(.a(new_n59_), .b(new_n45_), .c(x24), .O(new_n60_));
  ...
  nand3  g33(.a(new_n48_), .b(new_n71_), .c(x11), .O(new_n77_));
  ...
  aoi21  g43(.a(new_n86_), .b(new_n44_), .c(x01), .O(z08));
  ...
  nand3  g52(.a(new_n44_), .b(x20), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g74(.a(new_n74_), .b(new_n63_), .c(new_n44_), .O(new_n118_));
  oai21  g75(.a(new_n117_), .b(new_n114_), .c(new_n118_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(x09), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n69_), .O(z12));
  inv1   g78(.a(x02), .O(new_n122_));
  nand2  g79(.a(new_n116_), .b(new_n122_), .O(new_n123_));
  nor2   g80(.a(x24), .b(x19), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x17), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(new_n123_), .O(z13));
  nor2   g83(.a(x18), .b(x09), .O(new_n127_));
  nand3  g84(.a(new_n127_), .b(new_n124_), .c(new_n55_), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(new_n123_), .O(z14));
  aoi21  g86(.a(new_n47_), .b(x01), .c(new_n122_), .O(new_n130_));
  aoi21  g87(.a(x19), .b(new_n122_), .c(x24), .O(new_n131_));
  oai22  g88(.a(new_n131_), .b(x01), .c(new_n130_), .d(new_n61_), .O(z15));
  aoi21  g89(.a(new_n44_), .b(new_n62_), .c(new_n63_), .O(z16));
  nand3  g90(.a(new_n116_), .b(new_n44_), .c(x02), .O(new_n134_));
