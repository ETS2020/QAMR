...
module FAU ( 
  ...
  nand2  g20(.a(new_n64_), .b(x00), .O(new_n65_));
  nand2  g21(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand3  g22(.a(new_n55_), .b(x02), .c(x00), .O(new_n67_));
  oai21  g23(.a(new_n67_), .b(new_n61_), .c(new_n66_), .O(z07));
  inv1   g24(.a(x19), .O(new_n70_));
  inv1   g25(.a(x22), .O(new_n71_));
  nor2   g26(.a(x21), .b(x20), .O(new_n72_));
  nand4  g27(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(x18), .O(new_n73_));
  aoi21  g28(.a(new_n73_), .b(x01), .c(x00), .O(z09));
  inv1   g29(.a(x18), .O(new_n75_));
  nor2   g30(.a(x19), .b(new_n75_), .O(new_n76_));
  nor2   g31(.a(new_n63_), .b(x00), .O(z16));
  inv1   g32(.a(x21), .O(new_n78_));
  nor2   g33(.a(new_n78_), .b(x20), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(z16), .c(new_n76_), .d(x22), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z10));
  nand4  g36(.a(new_n79_), .b(z16), .c(new_n76_), .d(new_n71_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z11));
  inv1   g38(.a(x24), .O(new_n84_));
  nand2  g39(.a(new_n58_), .b(new_n84_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n59_), .c(new_n46_), .O(z12));
  nand3  g41(.a(new_n49_), .b(x01), .c(x00), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n65_), .c(new_n46_), .O(z15));
  zero   g43(.O(z01));
  zero   g44(.O(z08));
