...
module FAU ( 
  ...
  nand2  g70(.a(new_n105_), .b(new_n63_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n74_), .b(new_n65_), .c(new_n46_), .O(new_n118_));
  nor2   g75(.a(new_n45_), .b(x01), .O(new_n119_));
  nand3  g76(.a(new_n49_), .b(new_n47_), .c(new_n77_), .O(new_n120_));
  oai21  g77(.a(x19), .b(x02), .c(new_n44_), .O(new_n121_));
  nand4  g78(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n63_), .O(new_n122_));
