...
module FAU ( 
  ...
  oai21  g12(.a(new_n55_), .b(new_n50_), .c(new_n46_), .O(z01));
  inv1   g13(.a(x10), .O(new_n57_));
  nand3  g14(.a(new_n48_), .b(new_n47_), .c(new_n57_), .O(new_n58_));
  or2    g15(.a(new_n58_), .b(x19), .O(new_n59_));
  oai21  g16(.a(new_n59_), .b(new_n55_), .c(new_n46_), .O(z02));
  ...
  nand4  g22(.a(new_n65_), .b(new_n62_), .c(x12), .d(x02), .O(new_n66_));
  nand4  g23(.a(new_n52_), .b(new_n49_), .c(x18), .d(new_n47_), .O(new_n67_));
  nand3  g24(.a(new_n67_), .b(new_n66_), .c(new_n46_), .O(z03));
  ...
  oai21  g29(.a(new_n72_), .b(new_n69_), .c(new_n46_), .O(z04));
  nand2  g30(.a(x10), .b(x02), .O(new_n74_));
  nand2  g31(.a(new_n65_), .b(x09), .O(new_n75_));
  oai21  g32(.a(new_n75_), .b(new_n74_), .c(new_n46_), .O(z05));
  inv1   g33(.a(x02), .O(new_n77_));
  nand2  g34(.a(new_n65_), .b(new_n46_), .O(new_n78_));
  nor3   g35(.a(new_n78_), .b(new_n61_), .c(new_n77_), .O(z06));
  ...
  nand3  g43(.a(x02), .b(new_n64_), .c(new_n63_), .O(new_n87_));
  inv1   g44(.a(new_n87_), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(x19), .c(new_n48_), .d(x17), .O(new_n89_));
  ...
  nand2  g50(.a(x02), .b(new_n64_), .O(new_n94_));
  nand3  g51(.a(new_n44_), .b(x12), .c(new_n70_), .O(new_n95_));
  nor2   g52(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  ...
  aoi21  g58(.a(new_n101_), .b(new_n96_), .c(new_n93_), .O(new_n102_));
  ...
  nor2   g63(.a(new_n92_), .b(new_n103_), .O(new_n107_));
  ...
  oai21  g68(.a(new_n111_), .b(x00), .c(new_n46_), .O(z10));
  nand2  g69(.a(new_n104_), .b(new_n63_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n74_), .b(new_n65_), .c(new_n46_), .O(new_n117_));
  inv1   g74(.a(x23), .O(new_n118_));
  nand3  g75(.a(new_n49_), .b(new_n44_), .c(new_n77_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g77(.a(new_n49_), .b(new_n47_), .c(new_n77_), .O(new_n121_));
  nand4  g78(.a(new_n121_), .b(new_n120_), .c(new_n64_), .d(new_n63_), .O(new_n122_));
  ...
  nor4   g84(.a(new_n58_), .b(new_n53_), .c(new_n45_), .d(x19), .O(z14));
  oai21  g85(.a(x10), .b(new_n64_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n77_), .c(new_n64_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(new_n130_), .c(new_n45_), .O(z15));
  oai21  g89(.a(new_n64_), .b(x00), .c(new_n46_), .O(z16));
  nand2  g90(.a(new_n87_), .b(new_n46_), .O(z17));
endmodule
