...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n132_;
  nand2  g00(.a(x21), .b(x11), .O(new_n44_));
  ...
  nor3   g19(.a(new_n62_), .b(new_n61_), .c(x09), .O(new_n63_));
  aoi21  g20(.a(new_n63_), .b(x12), .c(x21), .O(new_n64_));
  nor2   g21(.a(x17), .b(x02), .O(new_n65_));
  nand4  g22(.a(new_n65_), .b(new_n47_), .c(new_n51_), .d(x18), .O(new_n66_));
  oai21  g23(.a(new_n64_), .b(new_n60_), .c(new_n66_), .O(z03));
  inv1   g24(.a(x12), .O(new_n68_));
  nand3  g25(.a(new_n63_), .b(new_n68_), .c(new_n60_), .O(new_n69_));
  inv1   g26(.a(new_n69_), .O(z04));
  inv1   g27(.a(new_n61_), .O(new_n71_));
  inv1   g28(.a(new_n62_), .O(new_n72_));
  nand3  g29(.a(new_n72_), .b(new_n71_), .c(x09), .O(new_n73_));
  nand2  g30(.a(new_n73_), .b(new_n44_), .O(z05));
  nor2   g31(.a(x21), .b(new_n60_), .O(new_n75_));
  and2   g32(.a(new_n75_), .b(new_n63_), .O(z06));
  nand4  g33(.a(new_n68_), .b(x11), .c(x10), .d(new_n46_), .O(new_n77_));
  ...
  nand4  g41(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n44_), .O(new_n85_));
  inv1   g42(.a(x00), .O(new_n86_));
  inv1   g43(.a(x01), .O(new_n87_));
  nand3  g44(.a(x02), .b(new_n87_), .c(new_n86_), .O(new_n88_));
  ...
  nand2  g50(.a(x02), .b(new_n87_), .O(new_n94_));
  ...
  nand3  g62(.a(new_n105_), .b(new_n104_), .c(new_n86_), .O(new_n106_));
  ...
  nand2  g70(.a(new_n105_), .b(new_n86_), .O(new_n114_));
  ...
  nand2  g74(.a(new_n62_), .b(new_n71_), .O(new_n118_));
  ...
  nand2  g79(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  ...
  inv1   g83(.a(new_n47_), .O(new_n127_));
  oai21  g84(.a(new_n121_), .b(new_n127_), .c(new_n44_), .O(z13));
  oai21  g85(.a(new_n58_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g86(.a(x10), .b(new_n87_), .c(x02), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(x00), .O(new_n131_));
  nand3  g88(.a(x19), .b(new_n45_), .c(new_n87_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n131_), .c(new_n54_), .O(z15));
  oai21  g90(.a(new_n87_), .b(x00), .c(new_n44_), .O(z16));
  nand2  g91(.a(new_n88_), .b(new_n44_), .O(z17));
endmodule
