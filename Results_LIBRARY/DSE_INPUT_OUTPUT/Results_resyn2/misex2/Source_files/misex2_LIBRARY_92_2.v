...
module FAU ( 
  ...
  nor2   g18(.a(new_n57_), .b(x09), .O(new_n62_));
  nand4  g19(.a(new_n62_), .b(new_n61_), .c(x12), .d(x11), .O(new_n63_));
  nand2  g20(.a(new_n63_), .b(x16), .O(new_n64_));
  ...
  nand2  g28(.a(new_n62_), .b(new_n61_), .O(new_n72_));
  inv1   g29(.a(new_n72_), .O(new_n73_));
  nand3  g30(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x16), .c(new_n69_), .O(z04));
  nand2  g32(.a(x16), .b(x01), .O(new_n76_));
  nor4   g33(.a(new_n76_), .b(new_n60_), .c(new_n57_), .d(new_n47_), .O(z05));
  nand2  g34(.a(new_n73_), .b(x11), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(x16), .c(new_n69_), .O(z06));
  nand4  g36(.a(new_n62_), .b(x16), .c(new_n71_), .d(x11), .O(new_n80_));
  aoi21  g37(.a(new_n80_), .b(x01), .c(new_n60_), .O(z07));
  ...
  nand4  g44(.a(z17), .b(x19), .c(new_n51_), .d(x17), .O(new_n88_));
  oai21  g45(.a(new_n88_), .b(new_n85_), .c(new_n45_), .O(z08));
  inv1   g46(.a(x20), .O(new_n90_));
  nand3  g47(.a(new_n90_), .b(new_n52_), .c(x18), .O(new_n91_));
  nor2   g48(.a(new_n91_), .b(new_n76_), .O(new_n92_));
  ...
  nand2  g70(.a(new_n92_), .b(x21), .O(new_n114_));
  ...
  oai21  g83(.a(new_n120_), .b(new_n118_), .c(new_n45_), .O(z13));
  oai21  g84(.a(new_n58_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g85(.a(x10), .b(new_n69_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n46_), .c(new_n69_), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(new_n130_), .c(new_n45_), .O(z15));
  nand3  g89(.a(x16), .b(x01), .c(new_n100_), .O(new_n133_));
