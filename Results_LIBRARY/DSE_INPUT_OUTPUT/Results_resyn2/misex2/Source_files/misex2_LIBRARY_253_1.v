...
module FAU ( 
  ...
  nor2   g19(.a(x09), .b(new_n45_), .O(new_n63_));
  ...
  nor3   g28(.a(new_n71_), .b(new_n54_), .c(new_n46_), .O(z05));
  nand3  g29(.a(x11), .b(x10), .c(new_n46_), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n71_), .O(z06));
  nand2  g31(.a(x01), .b(new_n57_), .O(new_n75_));
  oai21  g32(.a(new_n73_), .b(x12), .c(x01), .O(new_n76_));
  ...
  nand2  g50(.a(new_n64_), .b(x02), .O(new_n94_));
  ...
  nand3  g55(.a(new_n98_), .b(new_n50_), .c(new_n93_), .O(new_n99_));
  ...
  nand3  g59(.a(new_n102_), .b(new_n98_), .c(x15), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g61(.a(new_n92_), .O(new_n105_));
  nand3  g62(.a(new_n98_), .b(new_n105_), .c(x15), .O(new_n106_));
  ...
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n75_), .O(z12));
  nand2  g74(.a(new_n50_), .b(x17), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(new_n111_), .O(z13));
  nand3  g76(.a(new_n50_), .b(new_n46_), .c(new_n45_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(new_n55_), .O(z14));
  ...
  inv1   g81(.a(new_n75_), .O(z16));
  aoi21  g82(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
endmodule
