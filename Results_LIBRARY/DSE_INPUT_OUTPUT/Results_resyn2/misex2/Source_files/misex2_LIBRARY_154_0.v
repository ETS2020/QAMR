...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n75_, new_n78_, new_n80_, new_n81_;
  ...
  nand2  g30(.a(new_n55_), .b(new_n74_), .O(new_n75_));
  oai21  g31(.a(new_n75_), .b(new_n56_), .c(new_n51_), .O(z12));
  inv1   g32(.a(x01), .O(new_n78_));
  nor2   g33(.a(new_n78_), .b(x00), .O(z16));
  inv1   g34(.a(x10), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(x01), .c(new_n60_), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(z16), .O(z15));
  zero   g37(.O(z01));
  zero   g38(.O(z14));
