...
module FAU ( 
  ...
  nand3  g26(.a(new_n69_), .b(new_n62_), .c(new_n51_), .O(new_n70_));
  nand2  g27(.a(new_n70_), .b(new_n45_), .O(z04));
  oai21  g28(.a(new_n61_), .b(new_n57_), .c(new_n45_), .O(z05));
  nand3  g29(.a(new_n64_), .b(new_n62_), .c(new_n45_), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(z06));
  oai21  g31(.a(new_n63_), .b(x12), .c(x01), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(x02), .c(x00), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n45_), .O(z07));
  ...
  inv1   g38(.a(x00), .O(new_n82_));
  inv1   g39(.a(x01), .O(new_n83_));
  nand3  g40(.a(x02), .b(new_n83_), .c(new_n82_), .O(new_n84_));
  inv1   g41(.a(new_n84_), .O(new_n85_));
  nor2   g42(.a(x18), .b(new_n55_), .O(new_n86_));
  nand3  g43(.a(new_n86_), .b(new_n85_), .c(x19), .O(new_n87_));
  oai21  g44(.a(new_n87_), .b(new_n81_), .c(new_n45_), .O(z08));
  inv1   g45(.a(x20), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(new_n66_), .c(x18), .d(x01), .O(new_n90_));
  inv1   g47(.a(new_n90_), .O(new_n91_));
  nand2  g48(.a(x02), .b(new_n83_), .O(new_n92_));
  ...
  nand4  g55(.a(x20), .b(new_n44_), .c(new_n98_), .d(new_n97_), .O(new_n99_));
  ...
  nand3  g60(.a(new_n103_), .b(new_n102_), .c(new_n82_), .O(new_n104_));
  oai21  g61(.a(new_n104_), .b(new_n101_), .c(new_n45_), .O(z09));
  nor2   g62(.a(new_n90_), .b(new_n102_), .O(new_n106_));
  nand4  g63(.a(new_n102_), .b(x20), .c(x15), .d(new_n97_), .O(new_n107_));
  nand2  g64(.a(new_n103_), .b(x16), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  aoi22  g66(.a(new_n109_), .b(new_n96_), .c(new_n106_), .d(x22), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(x00), .c(new_n45_), .O(z10));
  nand2  g68(.a(new_n103_), .b(new_n82_), .O(new_n112_));
  nor2   g69(.a(new_n107_), .b(x16), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n96_), .c(new_n106_), .O(new_n114_));
  ...
  nand3  g76(.a(new_n66_), .b(x17), .c(new_n119_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n118_), .c(new_n54_), .O(new_n121_));
  inv1   g78(.a(x09), .O(new_n122_));
  nor2   g79(.a(x24), .b(new_n122_), .O(new_n123_));
  oai21  g80(.a(new_n121_), .b(new_n117_), .c(new_n123_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n45_), .O(z12));
  oai21  g82(.a(new_n120_), .b(new_n54_), .c(new_n45_), .O(z13));
  nand4  g83(.a(new_n46_), .b(new_n50_), .c(new_n122_), .d(new_n119_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(new_n56_), .O(z14));
  oai21  g85(.a(x10), .b(new_n83_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n119_), .c(new_n83_), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(new_n130_), .c(new_n45_), .O(z15));
  nand2  g89(.a(x01), .b(new_n82_), .O(new_n133_));
  aoi21  g90(.a(new_n44_), .b(x08), .c(new_n133_), .O(z16));
