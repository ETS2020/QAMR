...
module FAU ( 
  ...
  nor2   g16(.a(x17), .b(x00), .O(new_n60_));
  nand4  g17(.a(new_n60_), .b(new_n59_), .c(new_n47_), .d(x18), .O(new_n61_));
  ...
  nand3  g24(.a(new_n67_), .b(new_n61_), .c(new_n44_), .O(z03));
  nand3  g25(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n69_));
  nand2  g26(.a(new_n62_), .b(x10), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(new_n69_), .c(x12), .O(z04));
  nand2  g28(.a(new_n66_), .b(new_n44_), .O(new_n72_));
  nor4   g29(.a(new_n72_), .b(new_n56_), .c(new_n50_), .d(new_n49_), .O(z05));
  nor3   g30(.a(new_n69_), .b(new_n62_), .c(new_n56_), .O(z06));
  inv1   g31(.a(x01), .O(new_n75_));
  nor2   g32(.a(x12), .b(x09), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(new_n63_), .c(new_n75_), .O(new_n77_));
  nand2  g34(.a(x02), .b(x00), .O(new_n78_));
  oai21  g35(.a(new_n78_), .b(new_n77_), .c(new_n44_), .O(z07));
  ...
  nand4  g42(.a(new_n85_), .b(x19), .c(new_n46_), .d(x17), .O(new_n86_));
  ...
  nand3  g49(.a(new_n92_), .b(x12), .c(new_n62_), .O(new_n93_));
  ...
  aoi21  g82(.a(new_n56_), .b(x01), .c(new_n49_), .O(new_n126_));
  oai21  g83(.a(new_n59_), .b(x21), .c(x19), .O(new_n127_));
  oai21  g84(.a(new_n126_), .b(new_n97_), .c(new_n127_), .O(z15));
  nand3  g85(.a(new_n44_), .b(x01), .c(new_n97_), .O(new_n129_));
