...
module FAU ( 
  ...
  nand3  g23(.a(new_n67_), .b(new_n66_), .c(x18), .O(new_n68_));
  inv1   g24(.a(x00), .O(z16));
  nand2  g25(.a(x01), .b(z16), .O(new_n70_));
  inv1   g26(.a(x21), .O(new_n71_));
  inv1   g27(.a(x22), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nor3   g29(.a(new_n73_), .b(new_n70_), .c(new_n68_), .O(z09));
  and2   g30(.a(x22), .b(x21), .O(new_n75_));
  nand4  g31(.a(new_n75_), .b(new_n67_), .c(new_n66_), .d(x18), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(x01), .c(x00), .O(z10));
  nand2  g33(.a(new_n72_), .b(x21), .O(new_n78_));
  nor3   g34(.a(new_n78_), .b(new_n70_), .c(new_n68_), .O(z11));
  inv1   g35(.a(new_n56_), .O(new_n80_));
  nor3   g36(.a(new_n57_), .b(new_n80_), .c(x24), .O(z12));
  nand3  g37(.a(new_n56_), .b(x01), .c(x00), .O(new_n82_));
  inv1   g38(.a(x01), .O(new_n83_));
  nand2  g39(.a(new_n64_), .b(new_n83_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n82_), .O(z15));
  zero   g41(.O(z02));
