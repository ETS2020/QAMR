...
module FAU ( 
  ...
  nor2   g18(.a(new_n63_), .b(new_n59_), .O(z05));
  nor2   g19(.a(new_n51_), .b(new_n48_), .O(z06));
  ...
  nor2   g26(.a(new_n61_), .b(x00), .O(new_n73_));
  inv1   g27(.a(x18), .O(new_n74_));
  nor2   g28(.a(x19), .b(new_n74_), .O(new_n75_));
  nand3  g29(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(new_n76_));
  inv1   g30(.a(x21), .O(new_n77_));
  inv1   g31(.a(x22), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nor2   g33(.a(new_n79_), .b(new_n76_), .O(z09));
  nand4  g34(.a(new_n75_), .b(new_n73_), .c(x21), .d(new_n72_), .O(new_n81_));
  nor2   g35(.a(new_n81_), .b(new_n78_), .O(z10));
  nor2   g36(.a(new_n81_), .b(x22), .O(z11));
  inv1   g37(.a(x24), .O(new_n84_));
  nand2  g38(.a(new_n59_), .b(new_n84_), .O(new_n85_));
  nor2   g39(.a(new_n85_), .b(new_n63_), .O(z12));
  inv1   g40(.a(x10), .O(new_n88_));
  nand2  g41(.a(new_n62_), .b(new_n88_), .O(new_n89_));
  nand3  g42(.a(new_n89_), .b(new_n67_), .c(new_n47_), .O(z15));
  zero   g43(.O(z00));
  zero   g44(.O(z01));
  zero   g45(.O(z08));
  zero   g46(.O(z14));
