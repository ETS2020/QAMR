...
module FAU ( 
  ...
  nand3  g18(.a(new_n61_), .b(x10), .c(new_n46_), .O(new_n62_));
  inv1   g19(.a(new_n62_), .O(new_n63_));
  nand4  g20(.a(new_n63_), .b(new_n59_), .c(x12), .d(x11), .O(new_n64_));
  ...
  nor4   g24(.a(new_n62_), .b(x22), .c(x12), .d(x11), .O(z04));
  nor4   g25(.a(new_n60_), .b(x22), .c(new_n56_), .d(new_n46_), .O(z05));
  inv1   g26(.a(x11), .O(new_n70_));
  nor3   g27(.a(new_n62_), .b(x22), .c(new_n70_), .O(z06));
  ...
  nor2   g38(.a(new_n45_), .b(x01), .O(new_n82_));
  nor2   g39(.a(x18), .b(new_n49_), .O(new_n83_));
  nand4  g40(.a(new_n83_), .b(new_n82_), .c(x19), .d(new_n81_), .O(new_n84_));
  oai21  g41(.a(new_n84_), .b(new_n80_), .c(new_n44_), .O(z08));
  ...
  nand3  g49(.a(new_n92_), .b(x02), .c(new_n91_), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nor2   g51(.a(x15), .b(x14), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n94_), .c(new_n90_), .d(x20), .O(new_n96_));
  inv1   g53(.a(x21), .O(new_n97_));
  nand3  g54(.a(new_n59_), .b(new_n97_), .c(new_n81_), .O(new_n98_));
  aoi21  g55(.a(new_n96_), .b(new_n87_), .c(new_n98_), .O(z09));
  nand3  g56(.a(new_n59_), .b(new_n97_), .c(x20), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(new_n89_), .O(new_n101_));
  ...
  nand4  g62(.a(new_n105_), .b(new_n82_), .c(x16), .d(new_n81_), .O(new_n106_));
  oai21  g63(.a(new_n106_), .b(new_n102_), .c(new_n44_), .O(z10));
  nor2   g64(.a(new_n104_), .b(new_n93_), .O(new_n108_));
  nor2   g65(.a(new_n87_), .b(new_n97_), .O(new_n109_));
  aoi21  g66(.a(new_n108_), .b(new_n101_), .c(new_n109_), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(x00), .c(new_n44_), .O(z11));
  ...
  oai21  g77(.a(new_n116_), .b(new_n114_), .c(new_n44_), .O(z13));
  oai21  g78(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g79(.a(x10), .b(new_n91_), .c(x02), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(x00), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n45_), .c(new_n91_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n124_), .c(new_n44_), .O(z15));
  aoi21  g83(.a(new_n59_), .b(x00), .c(new_n91_), .O(z16));
  nand2  g84(.a(new_n47_), .b(x02), .O(new_n128_));
