...
module FAU ( 
  ...
  nor3   g19(.a(new_n62_), .b(new_n47_), .c(x02), .O(z03));
  ...
  nand2  g30(.a(x02), .b(new_n46_), .O(new_n76_));
  ...
  nor2   g48(.a(new_n80_), .b(new_n76_), .O(new_n94_));
  nand3  g49(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n95_));
  inv1   g50(.a(x14), .O(new_n96_));
  nand3  g51(.a(x16), .b(x15), .c(new_n96_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n94_), .c(new_n45_), .O(new_n99_));
  ...
  nand3  g58(.a(new_n103_), .b(x15), .c(new_n96_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n95_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n94_), .c(new_n45_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n102_), .O(z11));
  oai21  g62(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  inv1   g63(.a(x02), .O(new_n109_));
  nand3  g64(.a(new_n52_), .b(x17), .c(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nor2   g66(.a(x24), .b(new_n44_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n111_), .c(new_n46_), .d(new_n45_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n55_), .O(z12));
  nor2   g69(.a(new_n110_), .b(new_n47_), .O(z13));
  nor2   g70(.a(new_n59_), .b(new_n49_), .O(z14));
  nand2  g71(.a(new_n109_), .b(new_n46_), .O(new_n117_));
  aoi21  g72(.a(new_n52_), .b(new_n45_), .c(new_n117_), .O(z15));
  nor2   g73(.a(new_n46_), .b(x00), .O(z16));
  nand2  g74(.a(new_n73_), .b(new_n55_), .O(z17));
  zero   g75(.O(z04));
  zero   g76(.O(z06));
endmodule
