...
module FAU ( 
  ...
  nand2  g12(.a(x05), .b(x01), .O(new_n56_));
  ...
  nand3  g20(.a(new_n63_), .b(x11), .c(new_n44_), .O(new_n64_));
  oai21  g21(.a(new_n64_), .b(new_n61_), .c(new_n60_), .O(new_n65_));
  ...
  nand4  g31(.a(new_n74_), .b(new_n73_), .c(new_n70_), .d(new_n44_), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n60_), .c(new_n69_), .O(z04));
  nand2  g33(.a(new_n63_), .b(x09), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(new_n60_), .c(new_n69_), .O(z05));
  aoi21  g35(.a(new_n64_), .b(new_n60_), .c(new_n69_), .O(z06));
  nand3  g36(.a(new_n74_), .b(x11), .c(new_n44_), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(x01), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  nand2  g39(.a(new_n82_), .b(new_n56_), .O(z07));
  ...
  nand3  g45(.a(x19), .b(new_n50_), .c(x17), .O(new_n89_));
  ...
  nand2  g50(.a(x02), .b(new_n69_), .O(new_n94_));
  ...
  nand3  g62(.a(new_n105_), .b(new_n104_), .c(new_n71_), .O(new_n106_));
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n56_), .O(z09));
  nor2   g64(.a(new_n92_), .b(new_n104_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(x22), .c(new_n60_), .O(new_n109_));
  nand2  g66(.a(x15), .b(new_n98_), .O(new_n110_));
  nand4  g67(.a(new_n105_), .b(new_n104_), .c(x20), .d(x16), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n97_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(x00), .O(z10));
  nand2  g71(.a(new_n105_), .b(new_n71_), .O(new_n115_));
  nand3  g72(.a(new_n104_), .b(x20), .c(new_n100_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(new_n110_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n97_), .c(new_n108_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n115_), .c(new_n56_), .O(z11));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g77(.a(new_n51_), .b(x17), .c(new_n72_), .O(new_n121_));
  ...
  nand2  g83(.a(new_n126_), .b(new_n56_), .O(z12));
  nand2  g84(.a(new_n47_), .b(new_n51_), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(new_n49_), .O(z13));
  oai21  g86(.a(new_n58_), .b(new_n48_), .c(new_n56_), .O(z14));
  oai21  g87(.a(x10), .b(new_n69_), .c(x02), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(x00), .O(new_n132_));
  nand3  g89(.a(x19), .b(new_n72_), .c(new_n69_), .O(new_n133_));
  nand3  g90(.a(new_n133_), .b(new_n132_), .c(new_n56_), .O(z15));
  aoi21  g91(.a(new_n60_), .b(x00), .c(new_n69_), .O(z16));
  inv1   g92(.a(new_n88_), .O(z17));
endmodule
