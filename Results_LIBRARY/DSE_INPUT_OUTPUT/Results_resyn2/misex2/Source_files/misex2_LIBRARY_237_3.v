...
module FAU ( 
  ...
  inv1   g29(.a(new_n73_), .O(z17));
  nor2   g30(.a(x18), .b(new_n50_), .O(new_n75_));
  nand3  g31(.a(new_n75_), .b(z17), .c(x19), .O(new_n76_));
  oai21  g32(.a(new_n76_), .b(new_n71_), .c(new_n61_), .O(z08));
  inv1   g33(.a(x20), .O(new_n78_));
  nand4  g34(.a(new_n78_), .b(new_n52_), .c(x18), .d(x01), .O(new_n79_));
  ...
  nor2   g41(.a(new_n78_), .b(x16), .O(new_n86_));
  ...
  nand3  g54(.a(new_n98_), .b(new_n96_), .c(new_n84_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n93_), .c(x00), .O(z10));
  nand2  g56(.a(new_n89_), .b(new_n45_), .O(new_n101_));
  nand2  g57(.a(new_n92_), .b(x21), .O(new_n102_));
  nand3  g58(.a(new_n96_), .b(new_n84_), .c(new_n97_), .O(new_n103_));
  ...
  nand3  g63(.a(new_n72_), .b(new_n107_), .c(x09), .O(new_n108_));
  aoi21  g64(.a(new_n106_), .b(new_n105_), .c(new_n108_), .O(z12));
  oai21  g65(.a(new_n106_), .b(new_n47_), .c(new_n61_), .O(z13));
  nor2   g66(.a(new_n58_), .b(new_n49_), .O(z14));
  nand2  g67(.a(new_n66_), .b(new_n46_), .O(new_n112_));
  aoi21  g68(.a(new_n52_), .b(new_n45_), .c(new_n112_), .O(z15));
  nor2   g69(.a(new_n46_), .b(x00), .O(z16));
  zero   g70(.O(z06));
  inv1   g71(.a(new_n61_), .O(z05));
endmodule
