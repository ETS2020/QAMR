...
module FAU ( 
  ...
  nand3  g13(.a(new_n56_), .b(new_n44_), .c(new_n47_), .O(new_n57_));
  ...
  oai21  g27(.a(new_n70_), .b(new_n60_), .c(new_n44_), .O(z04));
  ...
  oai21  g33(.a(new_n76_), .b(new_n72_), .c(new_n44_), .O(z05));
  nor3   g34(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z06));
  nand2  g35(.a(new_n63_), .b(new_n69_), .O(new_n79_));
  nand3  g36(.a(new_n44_), .b(x02), .c(x00), .O(new_n80_));
  ...
  nand3  g43(.a(x02), .b(new_n74_), .c(new_n73_), .O(new_n87_));
  ...
  nand3  g61(.a(new_n104_), .b(new_n103_), .c(new_n73_), .O(new_n105_));
  oai21  g62(.a(new_n105_), .b(new_n102_), .c(new_n44_), .O(z09));
  nand4  g63(.a(new_n92_), .b(new_n44_), .c(x22), .d(x21), .O(new_n107_));
  ...
  nand2  g69(.a(new_n104_), .b(new_n73_), .O(new_n113_));
  nand3  g70(.a(new_n92_), .b(new_n44_), .c(x21), .O(new_n114_));
  nor2   g71(.a(new_n90_), .b(x16), .O(new_n115_));
  nand4  g72(.a(new_n108_), .b(new_n115_), .c(new_n96_), .d(new_n103_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z11));
  nand2  g74(.a(new_n72_), .b(new_n75_), .O(new_n118_));
  nand2  g75(.a(new_n65_), .b(new_n45_), .O(new_n119_));
  ...
  nand4  g83(.a(x17), .b(new_n49_), .c(new_n74_), .d(new_n73_), .O(new_n127_));
  nor3   g84(.a(new_n127_), .b(new_n59_), .c(x19), .O(z13));
  nor2   g85(.a(new_n57_), .b(new_n52_), .O(z14));
  oai21  g86(.a(x10), .b(new_n74_), .c(x02), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(x00), .O(new_n131_));
  nand3  g88(.a(x19), .b(new_n49_), .c(new_n74_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n131_), .c(new_n59_), .O(z15));
  nand3  g90(.a(new_n44_), .b(x01), .c(new_n73_), .O(new_n134_));
  inv1   g91(.a(new_n134_), .O(z16));
  nand2  g92(.a(new_n87_), .b(new_n44_), .O(z17));
endmodule
