...
module FAU ( 
  ...
  nand2  g01(.a(x07), .b(new_n44_), .O(new_n45_));
  ...
  inv1   g11(.a(x07), .O(new_n55_));
  nor2   g12(.a(new_n55_), .b(x06), .O(new_n56_));
  ...
  nand4  g37(.a(new_n55_), .b(new_n44_), .c(new_n80_), .d(x04), .O(new_n81_));
