...
module FAU ( 
  ...
  nand3  g63(.a(new_n73_), .b(new_n108_), .c(x09), .O(new_n109_));
  ...
  nand2  g67(.a(new_n67_), .b(new_n46_), .O(new_n113_));
  aoi21  g68(.a(new_n52_), .b(new_n45_), .c(new_n113_), .O(z15));
  inv1   g69(.a(new_n74_), .O(z17));
  zero   g70(.O(z05));
  zero   g71(.O(z06));
  buf    g72(.a(x01), .O(z16));
endmodule
