...
module FAU ( 
  ...
  nand2  g10(.a(x16), .b(x01), .O(new_n54_));
  ...
  aoi21  g20(.a(new_n63_), .b(x12), .c(x16), .O(new_n64_));
  ...
  nor2   g25(.a(x16), .b(x12), .O(new_n69_));
  nand4  g26(.a(new_n69_), .b(new_n68_), .c(x10), .d(new_n44_), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(new_n67_), .O(z04));
  nor4   g28(.a(new_n67_), .b(x16), .c(new_n57_), .d(new_n44_), .O(z05));
  nor2   g29(.a(new_n63_), .b(x16), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n60_), .O(z06));
  inv1   g31(.a(new_n62_), .O(new_n75_));
  nand2  g32(.a(new_n69_), .b(new_n75_), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n61_), .O(z07));
  ...
  nand2  g38(.a(new_n45_), .b(x02), .O(new_n82_));
  inv1   g39(.a(new_n82_), .O(z17));
  nand4  g40(.a(z17), .b(x19), .c(new_n50_), .d(x17), .O(new_n84_));
  oai21  g41(.a(new_n84_), .b(new_n81_), .c(new_n54_), .O(z08));
  inv1   g42(.a(x20), .O(new_n86_));
  nand4  g43(.a(new_n86_), .b(new_n51_), .c(x18), .d(x01), .O(new_n87_));
  inv1   g44(.a(x13), .O(new_n88_));
  inv1   g45(.a(x14), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n68_), .O(new_n90_));
  nand2  g47(.a(x02), .b(new_n60_), .O(new_n91_));
  nor2   g48(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nor2   g49(.a(new_n86_), .b(x15), .O(new_n93_));
  ...
  inv1   g56(.a(new_n54_), .O(new_n100_));
  ...
  nor2   g63(.a(new_n87_), .b(new_n106_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(x22), .c(new_n100_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n105_), .c(new_n101_), .O(z10));
  nand4  g66(.a(new_n106_), .b(x20), .c(new_n96_), .d(x15), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n92_), .c(new_n107_), .O(new_n112_));
  inv1   g69(.a(x22), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n95_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n112_), .c(new_n54_), .O(z11));
  nand2  g72(.a(x10), .b(x02), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n96_), .c(x01), .d(x00), .O(new_n117_));
  ...
  nor2   g82(.a(new_n120_), .b(new_n46_), .O(z13));
  nor2   g83(.a(new_n58_), .b(new_n48_), .O(z14));
  nand3  g84(.a(new_n96_), .b(x01), .c(x00), .O(new_n128_));
  aoi21  g85(.a(x19), .b(new_n60_), .c(new_n101_), .O(new_n129_));
  oai22  g86(.a(new_n129_), .b(x02), .c(new_n128_), .d(x10), .O(z15));
  nand3  g87(.a(new_n96_), .b(x01), .c(new_n95_), .O(new_n131_));
