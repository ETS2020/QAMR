...
module FAU ( 
  ...
  inv1   g17(.a(x04), .O(new_n61_));
  nor2   g18(.a(x19), .b(new_n51_), .O(new_n62_));
  nor3   g19(.a(x17), .b(x02), .c(x00), .O(new_n63_));
  aoi21  g20(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  inv1   g21(.a(x00), .O(new_n65_));
  inv1   g22(.a(x01), .O(new_n66_));
  nor2   g23(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g24(.a(x11), .b(x10), .c(new_n44_), .O(new_n68_));
  inv1   g25(.a(new_n68_), .O(new_n69_));
  nand3  g26(.a(new_n69_), .b(new_n67_), .c(x02), .O(new_n70_));
  oai22  g27(.a(new_n70_), .b(new_n60_), .c(new_n64_), .d(x01), .O(z03));
  nand2  g28(.a(new_n67_), .b(x02), .O(new_n72_));
  nand2  g29(.a(new_n61_), .b(new_n66_), .O(new_n73_));
  inv1   g30(.a(x11), .O(new_n74_));
  nand4  g31(.a(new_n60_), .b(new_n74_), .c(x10), .d(new_n44_), .O(new_n75_));
  ...
  nand2  g36(.a(new_n73_), .b(new_n70_), .O(z06));
  oai21  g37(.a(new_n68_), .b(x12), .c(x01), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  nand2  g39(.a(new_n82_), .b(new_n73_), .O(z07));
  inv1   g40(.a(x08), .O(new_n84_));
  nand4  g41(.a(x19), .b(new_n51_), .c(x17), .d(new_n84_), .O(new_n85_));
  inv1   g42(.a(new_n85_), .O(new_n86_));
  nor2   g43(.a(new_n45_), .b(x00), .O(new_n87_));
  ...
  aoi21  g47(.a(new_n90_), .b(x04), .c(x01), .O(z08));
  inv1   g48(.a(x20), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n52_), .c(x18), .d(x01), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nand2  g51(.a(x02), .b(new_n66_), .O(new_n95_));
  inv1   g52(.a(x13), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(x12), .c(new_n74_), .O(new_n97_));
  ...
  oai21  g64(.a(new_n107_), .b(new_n104_), .c(new_n73_), .O(z09));
  ...
  nand2  g71(.a(new_n106_), .b(new_n65_), .O(new_n115_));
  nor2   g72(.a(new_n110_), .b(x16), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n98_), .c(new_n109_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n115_), .c(new_n73_), .O(z11));
  nand2  g75(.a(new_n77_), .b(new_n67_), .O(new_n119_));
  nor3   g76(.a(x19), .b(x17), .c(x02), .O(new_n120_));
  nor2   g77(.a(x19), .b(x02), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(x23), .c(new_n46_), .O(new_n122_));
  ...
  nand2  g85(.a(x04), .b(new_n45_), .O(new_n129_));
  aoi21  g86(.a(x19), .b(new_n66_), .c(x00), .O(new_n130_));
  oai21  g87(.a(new_n130_), .b(new_n129_), .c(new_n119_), .O(z15));
  nor2   g88(.a(new_n66_), .b(x00), .O(z16));
  nand3  g89(.a(new_n46_), .b(x04), .c(x02), .O(new_n133_));
