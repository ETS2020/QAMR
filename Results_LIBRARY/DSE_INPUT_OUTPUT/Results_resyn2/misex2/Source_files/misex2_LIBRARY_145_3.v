...
module FAU ( 
  ...
  nand4  g22(.a(new_n65_), .b(new_n45_), .c(new_n48_), .d(new_n53_), .O(new_n66_));
  oai21  g23(.a(new_n64_), .b(new_n59_), .c(new_n66_), .O(z03));
  inv1   g24(.a(x23), .O(new_n68_));
  ...
  nor2   g31(.a(x23), .b(new_n59_), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(x11), .c(x10), .O(new_n76_));
  nor3   g33(.a(new_n76_), .b(new_n60_), .c(x09), .O(z06));
  ...
  nand4  g43(.a(z17), .b(x19), .c(new_n49_), .d(x17), .O(new_n87_));
  ...
  oai21  g62(.a(new_n105_), .b(new_n101_), .c(new_n44_), .O(z09));
  nand2  g63(.a(x21), .b(new_n89_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n75_), .c(new_n65_), .d(x22), .O(new_n109_));
  nand2  g66(.a(x15), .b(new_n96_), .O(new_n110_));
  nand4  g67(.a(new_n104_), .b(new_n103_), .c(x20), .d(x16), .O(new_n111_));
  ...
  nand2  g71(.a(new_n104_), .b(new_n102_), .O(new_n115_));
  nand3  g72(.a(new_n103_), .b(x20), .c(new_n98_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(new_n110_), .O(new_n117_));
  nand3  g74(.a(new_n50_), .b(x18), .c(x01), .O(new_n118_));
