...
module FAU ( 
  ...
  nand3  g24(.a(new_n67_), .b(new_n52_), .c(x02), .O(new_n68_));
  nand4  g25(.a(x23), .b(x12), .c(x11), .d(x10), .O(new_n69_));
  oai22  g26(.a(new_n69_), .b(new_n68_), .c(new_n64_), .d(new_n63_), .O(z03));
  nand2  g27(.a(new_n44_), .b(x10), .O(new_n71_));
  nor3   g28(.a(new_n71_), .b(new_n68_), .c(x11), .O(z04));
  nand2  g29(.a(x10), .b(x02), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(new_n67_), .c(new_n46_), .d(x09), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(z05));
  nand2  g33(.a(new_n67_), .b(new_n46_), .O(new_n77_));
  nand2  g34(.a(x11), .b(new_n52_), .O(new_n78_));
  nor3   g35(.a(new_n78_), .b(new_n73_), .c(new_n77_), .O(z06));
  oai21  g36(.a(new_n78_), .b(new_n71_), .c(x01), .O(new_n80_));
  ...
  nand3  g43(.a(x02), .b(new_n66_), .c(new_n65_), .O(new_n87_));
  ...
  oai21  g64(.a(new_n107_), .b(new_n104_), .c(new_n46_), .O(z09));
  nand2  g65(.a(x22), .b(x21), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(new_n92_), .O(new_n110_));
  nand2  g67(.a(x15), .b(new_n99_), .O(new_n111_));
  ...
  oai21  g71(.a(new_n114_), .b(x00), .c(new_n46_), .O(z10));
  nand2  g72(.a(new_n106_), .b(new_n65_), .O(new_n116_));
  nor3   g73(.a(x20), .b(new_n48_), .c(new_n66_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n62_), .c(x21), .O(new_n118_));
  nand4  g75(.a(x23), .b(new_n105_), .c(x20), .d(new_n101_), .O(new_n119_));
  nor2   g76(.a(new_n119_), .b(new_n111_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n98_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n118_), .c(new_n116_), .O(z11));
  nand2  g79(.a(new_n73_), .b(new_n67_), .O(new_n123_));
  aoi21  g80(.a(new_n49_), .b(new_n51_), .c(x23), .O(new_n124_));
  nand3  g81(.a(new_n49_), .b(new_n47_), .c(new_n51_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n53_), .O(new_n126_));
  oai21  g83(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(new_n127_));
  nor2   g84(.a(x24), .b(new_n52_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(new_n46_), .O(z12));
  nand2  g87(.a(x17), .b(new_n51_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(new_n63_), .O(z13));
  nand3  g89(.a(new_n59_), .b(new_n52_), .c(new_n51_), .O(new_n133_));
  nor2   g90(.a(new_n133_), .b(new_n63_), .O(z14));
  oai21  g91(.a(x10), .b(new_n66_), .c(x02), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(x00), .O(new_n136_));
  nand3  g93(.a(x19), .b(new_n51_), .c(new_n66_), .O(new_n137_));
  aoi21  g94(.a(new_n137_), .b(new_n136_), .c(new_n45_), .O(z15));
  nor3   g95(.a(new_n45_), .b(new_n66_), .c(x00), .O(z16));
  nand2  g96(.a(new_n87_), .b(new_n46_), .O(z17));
endmodule
