...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n68_, new_n69_, new_n70_, new_n71_, new_n73_, new_n76_, new_n78_,
    new_n79_, new_n80_, new_n82_, new_n83_, new_n84_, new_n85_, new_n86_,
    new_n87_, new_n88_, new_n89_, new_n90_, new_n92_, new_n93_, new_n94_,
    new_n95_, new_n96_, new_n97_, new_n98_, new_n99_, new_n100_, new_n101_,
    new_n103_, new_n104_, new_n106_, new_n107_, new_n108_, new_n110_,
    new_n111_, new_n112_, new_n113_, new_n114_, new_n115_, new_n116_,
    new_n117_, new_n118_, new_n122_, new_n123_, new_n124_, new_n127_;
  ...
  nand4  g12(.a(new_n55_), .b(new_n50_), .c(new_n46_), .d(new_n44_), .O(new_n56_));
  aoi21  g13(.a(new_n56_), .b(new_n49_), .c(x01), .O(z01));
  nand3  g14(.a(new_n50_), .b(new_n49_), .c(new_n54_), .O(new_n58_));
  nor3   g15(.a(new_n58_), .b(new_n47_), .c(new_n53_), .O(z02));
  inv1   g16(.a(x12), .O(new_n60_));
  nand2  g17(.a(new_n46_), .b(new_n44_), .O(new_n61_));
  inv1   g18(.a(x17), .O(new_n62_));
  inv1   g19(.a(x19), .O(new_n63_));
  nand3  g20(.a(new_n63_), .b(x18), .c(new_n62_), .O(new_n64_));
  oai21  g21(.a(new_n64_), .b(new_n61_), .c(new_n49_), .O(new_n65_));
  nand2  g22(.a(new_n65_), .b(new_n45_), .O(new_n66_));
  nand3  g23(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  inv1   g24(.a(new_n67_), .O(new_n68_));
  inv1   g25(.a(x11), .O(new_n69_));
  nor2   g26(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  nand3  g27(.a(new_n70_), .b(new_n68_), .c(new_n53_), .O(new_n71_));
  oai21  g28(.a(new_n71_), .b(new_n60_), .c(new_n66_), .O(z03));
  nand3  g29(.a(new_n60_), .b(new_n69_), .c(x10), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n67_), .c(x09), .O(z04));
  nor3   g31(.a(new_n67_), .b(new_n54_), .c(new_n53_), .O(z05));
  nand2  g32(.a(x16), .b(new_n45_), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n71_), .O(z06));
  nand2  g34(.a(new_n49_), .b(new_n45_), .O(new_n78_));
  nand4  g35(.a(new_n70_), .b(new_n60_), .c(new_n53_), .d(x01), .O(new_n79_));
  ...
  nand2  g60(.a(x22), .b(new_n44_), .O(new_n104_));
  oai21  g61(.a(new_n104_), .b(new_n103_), .c(new_n76_), .O(z10));
