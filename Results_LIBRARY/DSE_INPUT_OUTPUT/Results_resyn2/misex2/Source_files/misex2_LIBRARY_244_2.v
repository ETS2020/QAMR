...
module FAU ( 
  ...
  aoi21  g30(.a(new_n63_), .b(x01), .c(new_n44_), .O(z06));
  nand2  g31(.a(new_n65_), .b(new_n69_), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(new_n63_), .O(z07));
  ...
  nand3  g40(.a(new_n59_), .b(new_n83_), .c(x02), .O(new_n84_));
  nor3   g41(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z08));
  nand2  g42(.a(x02), .b(new_n64_), .O(new_n86_));
  ...
  inv1   g56(.a(new_n95_), .O(new_n100_));
  ...
  nand2  g65(.a(new_n97_), .b(new_n44_), .O(new_n109_));
  nand2  g66(.a(new_n100_), .b(x21), .O(new_n110_));
  nand3  g67(.a(new_n104_), .b(new_n89_), .c(new_n105_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(z11));
  nand2  g69(.a(new_n65_), .b(new_n61_), .O(new_n113_));
  inv1   g70(.a(x23), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(new_n114_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n59_), .c(new_n58_), .O(new_n116_));
  inv1   g73(.a(x24), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(x09), .O(new_n118_));
  aoi21  g75(.a(new_n116_), .b(new_n113_), .c(new_n118_), .O(z12));
  nand2  g76(.a(new_n57_), .b(x17), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n44_), .c(x01), .O(z13));
  nand3  g78(.a(new_n46_), .b(new_n45_), .c(new_n53_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g80(.a(x02), .O(new_n124_));
  aoi21  g81(.a(x19), .b(new_n124_), .c(x00), .O(new_n125_));
  aoi21  g82(.a(new_n61_), .b(x00), .c(new_n64_), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(new_n125_), .O(z15));
  nor2   g84(.a(new_n65_), .b(new_n59_), .O(z16));
  aoi21  g85(.a(new_n124_), .b(new_n44_), .c(x01), .O(z17));
endmodule
