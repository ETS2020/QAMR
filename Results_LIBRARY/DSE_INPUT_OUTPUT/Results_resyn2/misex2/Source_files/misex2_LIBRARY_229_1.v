...
module FAU ( 
  ...
  nor2   g25(.a(x02), .b(x01), .O(new_n69_));
  nand4  g26(.a(new_n69_), .b(new_n68_), .c(new_n66_), .d(new_n65_), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(new_n64_), .c(new_n59_), .O(z03));
  inv1   g28(.a(x11), .O(new_n72_));
  inv1   g29(.a(x12), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(new_n72_), .c(x10), .d(new_n50_), .O(new_n74_));
  oai21  g31(.a(new_n74_), .b(new_n60_), .c(new_n45_), .O(z04));
  ...
  nand3  g47(.a(x19), .b(new_n67_), .c(x17), .O(new_n91_));
  nor3   g48(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(z08));
  nor2   g49(.a(new_n73_), .b(x11), .O(new_n93_));
  ...
  nand3  g54(.a(new_n68_), .b(new_n95_), .c(x01), .O(new_n98_));
  ...
  nand3  g61(.a(new_n45_), .b(x01), .c(new_n65_), .O(new_n105_));
  inv1   g62(.a(x21), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(x20), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n68_), .c(x22), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n105_), .O(z10));
  inv1   g66(.a(x16), .O(new_n110_));
  nand4  g67(.a(new_n106_), .b(x20), .c(new_n110_), .d(x15), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n94_), .c(new_n93_), .d(new_n89_), .O(new_n113_));
  nand4  g70(.a(new_n107_), .b(new_n68_), .c(new_n45_), .d(x01), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(new_n101_), .O(z11));
  nand3  g72(.a(new_n76_), .b(x01), .c(x00), .O(new_n116_));
  nor3   g73(.a(x19), .b(x17), .c(x02), .O(new_n117_));
  nor2   g74(.a(x19), .b(x02), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(x23), .c(new_n51_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n69_), .b(x17), .c(new_n65_), .O(new_n124_));
  nor3   g81(.a(new_n124_), .b(new_n59_), .c(x19), .O(z13));
  nor2   g82(.a(new_n57_), .b(new_n52_), .O(z14));
  inv1   g83(.a(x01), .O(new_n127_));
  oai21  g84(.a(x10), .b(new_n127_), .c(x02), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(x00), .O(new_n129_));
  nand2  g86(.a(new_n69_), .b(x19), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n129_), .c(new_n59_), .O(z15));
  inv1   g88(.a(new_n105_), .O(z16));
  nand2  g89(.a(new_n90_), .b(new_n45_), .O(z17));
endmodule
