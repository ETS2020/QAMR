...
module FAU ( 
  ...
  nand2  g01(.a(new_n44_), .b(x06), .O(new_n45_));
  ...
  inv1   g11(.a(x06), .O(new_n55_));
  nor2   g12(.a(x07), .b(new_n55_), .O(new_n56_));
  nand3  g13(.a(new_n48_), .b(x09), .c(new_n46_), .O(new_n57_));
  nor3   g14(.a(new_n57_), .b(new_n53_), .c(new_n56_), .O(z01));
  ...
  oai21  g28(.a(new_n71_), .b(new_n62_), .c(new_n45_), .O(z04));
  nor4   g29(.a(new_n62_), .b(new_n56_), .c(new_n59_), .d(new_n47_), .O(z05));
  oai21  g30(.a(new_n63_), .b(new_n62_), .c(new_n45_), .O(z06));
  ...
  nand4  g37(.a(new_n44_), .b(new_n55_), .c(new_n80_), .d(x04), .O(new_n81_));
  inv1   g38(.a(x03), .O(new_n82_));
  nand3  g39(.a(new_n48_), .b(new_n82_), .c(x02), .O(new_n83_));
  nor3   g40(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(z08));
  ...
  nand4  g54(.a(new_n45_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n98_));
  aoi21  g55(.a(new_n94_), .b(new_n86_), .c(new_n98_), .O(z09));
  nand2  g56(.a(new_n45_), .b(new_n95_), .O(new_n100_));
  ...
  inv1   g62(.a(new_n86_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(x22), .c(x21), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(z10));
  ...
  nand3  g70(.a(new_n45_), .b(new_n97_), .c(new_n95_), .O(new_n114_));
  ...
  oai21  g83(.a(new_n60_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g84(.a(x10), .b(new_n87_), .c(x02), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(x00), .O(new_n129_));
  nand3  g86(.a(x19), .b(new_n46_), .c(new_n87_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n129_), .c(new_n56_), .O(z15));
  oai21  g88(.a(new_n87_), .b(x00), .c(new_n45_), .O(z16));
  nor2   g89(.a(new_n100_), .b(new_n88_), .O(z17));
endmodule
