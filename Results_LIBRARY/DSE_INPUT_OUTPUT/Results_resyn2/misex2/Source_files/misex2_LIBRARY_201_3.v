...
module FAU ( 
  ...
  inv1   g16(.a(new_n48_), .O(new_n60_));
  nand2  g17(.a(x01), .b(x00), .O(new_n61_));
  nand3  g18(.a(new_n52_), .b(x18), .c(new_n50_), .O(new_n62_));
  oai21  g19(.a(new_n62_), .b(new_n60_), .c(new_n61_), .O(z03));
  inv1   g20(.a(new_n61_), .O(z04));
  ...
  nor2   g29(.a(x18), .b(new_n50_), .O(new_n74_));
  nand3  g30(.a(new_n74_), .b(new_n73_), .c(x19), .O(new_n75_));
  oai21  g31(.a(new_n75_), .b(new_n71_), .c(new_n61_), .O(z08));
  inv1   g32(.a(x21), .O(new_n77_));
  inv1   g33(.a(x22), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  inv1   g35(.a(x20), .O(new_n80_));
  nand3  g36(.a(new_n80_), .b(new_n52_), .c(x18), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(new_n79_), .c(new_n45_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(x01), .O(new_n83_));
  ...
  nand3  g57(.a(new_n77_), .b(x20), .c(new_n101_), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  inv1   g59(.a(x14), .O(new_n104_));
  nand4  g60(.a(x15), .b(new_n104_), .c(x02), .d(new_n46_), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n103_), .c(new_n100_), .O(new_n107_));
  inv1   g63(.a(new_n81_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(x21), .c(x01), .O(new_n109_));
  nand2  g65(.a(new_n78_), .b(new_n45_), .O(new_n110_));
  aoi21  g66(.a(new_n109_), .b(new_n107_), .c(new_n110_), .O(z11));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g68(.a(new_n52_), .b(x17), .c(new_n66_), .O(new_n113_));
  inv1   g69(.a(x24), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(x09), .c(new_n46_), .d(new_n45_), .O(new_n115_));
  aoi21  g71(.a(new_n113_), .b(new_n112_), .c(new_n115_), .O(z12));
  oai21  g72(.a(new_n113_), .b(new_n47_), .c(new_n61_), .O(z13));
  nor2   g73(.a(new_n58_), .b(new_n49_), .O(z14));
  nand2  g74(.a(new_n66_), .b(new_n46_), .O(new_n119_));
  aoi21  g75(.a(new_n52_), .b(new_n45_), .c(new_n119_), .O(z15));
  nand2  g76(.a(new_n72_), .b(new_n61_), .O(z17));
  zero   g77(.O(z06));
  inv1   g78(.a(new_n61_), .O(z05));
  buf    g79(.a(x01), .O(z16));
endmodule
