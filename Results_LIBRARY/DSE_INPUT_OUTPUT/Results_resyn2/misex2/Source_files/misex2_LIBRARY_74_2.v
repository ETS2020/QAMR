...
module FAU ( 
  ...
  oai22  g20(.a(new_n63_), .b(new_n56_), .c(new_n61_), .d(new_n59_), .O(z03));
  ...
  aoi21  g27(.a(new_n70_), .b(x05), .c(new_n69_), .O(z05));
  nand3  g28(.a(new_n58_), .b(new_n60_), .c(x11), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x05), .c(new_n69_), .O(z06));
  nand4  g30(.a(new_n60_), .b(new_n66_), .c(x11), .d(x05), .O(new_n74_));
  ...
  nand3  g41(.a(x18), .b(x05), .c(x01), .O(new_n85_));
  ...
  nand3  g70(.a(x05), .b(x01), .c(x00), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  oai21  g72(.a(new_n44_), .b(new_n113_), .c(new_n115_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n62_), .b(x17), .c(new_n113_), .O(new_n118_));
  ...
  oai21  g80(.a(new_n118_), .b(new_n56_), .c(new_n51_), .O(z13));
  nand2  g81(.a(new_n44_), .b(new_n54_), .O(new_n125_));
  oai21  g82(.a(new_n125_), .b(new_n48_), .c(new_n51_), .O(z14));
  aoi22  g83(.a(new_n51_), .b(x00), .c(x19), .d(new_n69_), .O(new_n127_));
  oai22  g84(.a(new_n127_), .b(x02), .c(new_n114_), .d(x10), .O(z15));
  nand3  g85(.a(x05), .b(x01), .c(new_n98_), .O(new_n129_));
  inv1   g86(.a(new_n129_), .O(z16));
  inv1   g87(.a(new_n80_), .O(z17));
endmodule
