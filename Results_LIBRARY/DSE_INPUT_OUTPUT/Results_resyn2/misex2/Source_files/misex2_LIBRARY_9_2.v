...
module FAU ( 
  ...
  nor3   g19(.a(x09), .b(new_n62_), .c(new_n61_), .O(new_n63_));
  nand3  g20(.a(x12), .b(x11), .c(x10), .O(new_n64_));
  inv1   g21(.a(new_n64_), .O(new_n65_));
  aoi21  g22(.a(new_n65_), .b(new_n63_), .c(new_n60_), .O(new_n66_));
  nand2  g23(.a(new_n47_), .b(new_n51_), .O(new_n67_));
  nand2  g24(.a(x18), .b(new_n49_), .O(new_n68_));
  oai22  g25(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n59_), .O(z03));
  inv1   g26(.a(x11), .O(new_n70_));
  inv1   g27(.a(x12), .O(new_n71_));
  nand4  g28(.a(new_n63_), .b(new_n71_), .c(new_n70_), .d(x10), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x08), .c(new_n59_), .O(z04));
  nor2   g30(.a(new_n62_), .b(new_n61_), .O(new_n74_));
  nand3  g31(.a(new_n74_), .b(x08), .c(x01), .O(new_n75_));
  ...
  nand2  g37(.a(new_n60_), .b(x01), .O(new_n81_));
  ...
  nand4  g47(.a(new_n90_), .b(x18), .c(x08), .d(x01), .O(new_n91_));
  inv1   g48(.a(x16), .O(new_n92_));
  nand2  g49(.a(x02), .b(new_n59_), .O(new_n93_));
  ...
  nand4  g61(.a(new_n104_), .b(new_n90_), .c(x22), .d(x08), .O(new_n105_));
  inv1   g62(.a(x14), .O(new_n106_));
  nand4  g63(.a(new_n99_), .b(x20), .c(x15), .d(new_n106_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n96_), .c(new_n100_), .d(x16), .O(new_n109_));
  ...
  aoi21  g70(.a(new_n113_), .b(new_n96_), .c(new_n112_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n111_), .c(new_n81_), .O(z11));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n51_), .b(x17), .c(new_n62_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n116_), .c(new_n46_), .O(new_n118_));
  ...
  nand2  g79(.a(new_n122_), .b(new_n81_), .O(z12));
  nor2   g80(.a(new_n67_), .b(new_n49_), .O(z13));
  nor2   g81(.a(new_n57_), .b(new_n48_), .O(z14));
  aoi22  g82(.a(new_n81_), .b(x00), .c(x19), .d(new_n59_), .O(new_n126_));
  nand4  g83(.a(new_n56_), .b(x08), .c(x01), .d(x00), .O(new_n127_));
  oai21  g84(.a(new_n126_), .b(x02), .c(new_n127_), .O(z15));
  nand3  g85(.a(x08), .b(x01), .c(new_n61_), .O(new_n129_));
  inv1   g86(.a(new_n129_), .O(z16));
  inv1   g87(.a(new_n87_), .O(z17));
endmodule
