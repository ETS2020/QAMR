...
module FAU ( 
  ...
  nand4  g28(.a(new_n73_), .b(x19), .c(new_n51_), .d(x17), .O(new_n74_));
  oai21  g29(.a(new_n74_), .b(new_n71_), .c(new_n55_), .O(z08));
  inv1   g30(.a(x20), .O(new_n76_));
  inv1   g31(.a(new_n61_), .O(new_n77_));
  ...
  nor2   g40(.a(new_n76_), .b(x16), .O(new_n86_));
  ...
  aoi21  g45(.a(new_n87_), .b(new_n78_), .c(new_n90_), .O(z09));
  ...
  nand3  g56(.a(new_n89_), .b(x21), .c(new_n76_), .O(new_n102_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n106_), .c(new_n73_), .d(new_n105_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n104_), .O(z11));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g64(.a(new_n52_), .b(x17), .c(new_n79_), .O(new_n110_));
  ...
  nand2  g71(.a(new_n79_), .b(new_n46_), .O(new_n117_));
  aoi21  g72(.a(new_n52_), .b(new_n45_), .c(new_n117_), .O(z15));
  nor2   g73(.a(new_n46_), .b(x00), .O(z16));
  nand2  g74(.a(new_n72_), .b(new_n55_), .O(z17));
  zero   g75(.O(z04));
  zero   g76(.O(z05));
endmodule
