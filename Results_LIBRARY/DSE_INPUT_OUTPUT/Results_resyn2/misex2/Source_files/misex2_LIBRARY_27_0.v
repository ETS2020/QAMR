...
module FAU ( 
  ...
  nor2   g12(.a(new_n57_), .b(new_n48_), .O(z04));
  nand2  g13(.a(x10), .b(x02), .O(new_n59_));
  inv1   g14(.a(x00), .O(z16));
  inv1   g15(.a(x01), .O(new_n61_));
  nor2   g16(.a(new_n61_), .b(z16), .O(new_n62_));
  nand2  g17(.a(new_n62_), .b(x09), .O(new_n63_));
  oai21  g18(.a(new_n63_), .b(new_n59_), .c(new_n47_), .O(z05));
  oai21  g19(.a(new_n51_), .b(new_n48_), .c(new_n47_), .O(z06));
  inv1   g20(.a(x02), .O(new_n66_));
  nand2  g21(.a(new_n66_), .b(x00), .O(new_n67_));
  nand2  g22(.a(new_n67_), .b(new_n61_), .O(new_n68_));
  nand3  g23(.a(new_n56_), .b(x02), .c(x00), .O(new_n69_));
  oai21  g24(.a(new_n69_), .b(new_n51_), .c(new_n68_), .O(z07));
  inv1   g25(.a(x22), .O(new_n71_));
  inv1   g26(.a(x18), .O(new_n72_));
  nor2   g27(.a(x19), .b(new_n72_), .O(new_n73_));
  nor2   g28(.a(x21), .b(x20), .O(new_n74_));
  nand3  g29(.a(new_n74_), .b(new_n73_), .c(new_n71_), .O(new_n75_));
  ...
  nand3  g35(.a(new_n78_), .b(new_n73_), .c(new_n71_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(x01), .c(x00), .O(z11));
  inv1   g37(.a(x24), .O(new_n83_));
  nand2  g38(.a(new_n59_), .b(new_n83_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n63_), .c(new_n47_), .O(z12));
  inv1   g40(.a(x10), .O(new_n87_));
  nand2  g41(.a(new_n62_), .b(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n67_), .c(new_n47_), .O(z15));
  zero   g43(.O(z00));
  zero   g44(.O(z02));
  zero   g45(.O(z14));
