...
module FAU ( 
  ...
  nand3  g32(.a(new_n75_), .b(new_n70_), .c(new_n68_), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(x01), .c(x00), .O(z11));
  inv1   g34(.a(x24), .O(new_n80_));
  nand2  g35(.a(new_n58_), .b(new_n80_), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(new_n59_), .c(new_n46_), .O(z12));
  inv1   g37(.a(x10), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(x01), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x02), .c(new_n62_), .O(z15));
  nor2   g40(.a(new_n63_), .b(x00), .O(z16));
  zero   g41(.O(z01));
  zero   g42(.O(z08));
