...
module FAU ( 
  ...
  nor2   g10(.a(new_n49_), .b(x04), .O(new_n54_));
  ...
  nor2   g21(.a(new_n54_), .b(new_n64_), .O(new_n65_));
  inv1   g22(.a(x00), .O(new_n66_));
  inv1   g23(.a(x01), .O(new_n67_));
  nor2   g24(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g25(.a(new_n68_), .b(new_n65_), .c(new_n63_), .d(new_n44_), .O(new_n69_));
  nand4  g26(.a(new_n47_), .b(new_n51_), .c(x18), .d(new_n49_), .O(new_n70_));
  oai21  g27(.a(new_n69_), .b(new_n61_), .c(new_n70_), .O(z03));
  nand3  g28(.a(new_n68_), .b(new_n65_), .c(new_n44_), .O(new_n72_));
  nand3  g29(.a(new_n61_), .b(new_n62_), .c(x10), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n72_), .O(z04));
  nor2   g31(.a(new_n58_), .b(new_n64_), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(new_n68_), .c(x09), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n55_), .O(z05));
  inv1   g34(.a(new_n69_), .O(z06));
  nor2   g35(.a(x12), .b(x09), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(new_n63_), .c(new_n67_), .O(new_n80_));
  nand2  g37(.a(x02), .b(x00), .O(new_n81_));
  oai21  g38(.a(new_n81_), .b(new_n80_), .c(new_n55_), .O(z07));
  inv1   g39(.a(x08), .O(new_n83_));
  nand4  g40(.a(x19), .b(new_n50_), .c(x17), .d(new_n83_), .O(new_n84_));
  ...
  nand3  g45(.a(new_n45_), .b(new_n88_), .c(x02), .O(new_n89_));
  nor3   g46(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(z08));
  ...
  nand3  g62(.a(new_n105_), .b(new_n104_), .c(new_n66_), .O(new_n106_));
  ...
  nand2  g70(.a(new_n105_), .b(new_n66_), .O(new_n114_));
  nor2   g71(.a(new_n109_), .b(x16), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n97_), .c(new_n108_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n55_), .O(z11));
  inv1   g74(.a(new_n68_), .O(new_n118_));
  nor3   g75(.a(x19), .b(x17), .c(x02), .O(new_n119_));
  nor2   g76(.a(x19), .b(x02), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(x23), .c(new_n45_), .O(new_n121_));
  oai22  g78(.a(new_n121_), .b(new_n119_), .c(new_n75_), .d(new_n118_), .O(new_n122_));
  nor2   g79(.a(x24), .b(new_n44_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n55_), .O(z12));
  nand3  g82(.a(new_n51_), .b(x17), .c(x04), .O(new_n126_));
  nor3   g83(.a(new_n126_), .b(new_n46_), .c(x02), .O(z13));
  nor2   g84(.a(new_n59_), .b(new_n48_), .O(z14));
  oai21  g85(.a(x10), .b(new_n67_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n64_), .c(new_n67_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(new_n130_), .c(new_n54_), .O(z15));
  oai21  g89(.a(new_n67_), .b(x00), .c(new_n55_), .O(z16));
  nor3   g90(.a(new_n54_), .b(new_n46_), .c(new_n64_), .O(z17));
endmodule
