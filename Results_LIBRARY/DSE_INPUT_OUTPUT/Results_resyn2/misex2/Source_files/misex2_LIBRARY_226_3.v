...
module FAU ( 
  ...
  nand4  g25(.a(new_n68_), .b(new_n53_), .c(new_n46_), .d(x18), .O(new_n69_));
  ...
  nand2  g50(.a(x02), .b(new_n63_), .O(new_n94_));
  inv1   g51(.a(x13), .O(new_n95_));
  inv1   g52(.a(x14), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n95_), .c(x12), .d(new_n73_), .O(new_n97_));
  ...
  nand4  g65(.a(new_n105_), .b(x20), .c(x16), .d(x15), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  aoi22  g67(.a(new_n110_), .b(new_n98_), .c(new_n108_), .d(x22), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(x00), .c(new_n47_), .O(z10));
  inv1   g69(.a(new_n108_), .O(new_n113_));
  nand4  g70(.a(new_n98_), .b(new_n104_), .c(x20), .d(x15), .O(new_n114_));
  nand3  g71(.a(new_n105_), .b(new_n100_), .c(new_n62_), .O(new_n115_));
  aoi21  g72(.a(new_n114_), .b(new_n113_), .c(new_n115_), .O(z11));
  nand2  g73(.a(new_n76_), .b(new_n64_), .O(new_n117_));
  nand3  g74(.a(new_n46_), .b(new_n44_), .c(new_n51_), .O(new_n118_));
  ...
  nand4  g82(.a(x17), .b(new_n51_), .c(new_n63_), .d(new_n62_), .O(new_n126_));
  nor3   g83(.a(new_n126_), .b(new_n125_), .c(x19), .O(z13));
  nor3   g84(.a(new_n54_), .b(new_n48_), .c(x10), .O(z14));
  oai21  g85(.a(x10), .b(new_n63_), .c(x02), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n51_), .c(new_n63_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(new_n130_), .c(new_n125_), .O(z15));
  nand3  g89(.a(new_n47_), .b(x01), .c(new_n62_), .O(new_n133_));
