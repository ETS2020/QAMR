...
module FAU ( 
  ...
  nand4  g46(.a(x21), .b(new_n82_), .c(new_n52_), .d(x18), .O(new_n91_));
  ...
  nand3  g56(.a(new_n87_), .b(x02), .c(new_n46_), .O(new_n101_));
  ...
  nand3  g63(.a(new_n52_), .b(x17), .c(new_n76_), .O(new_n108_));
  inv1   g64(.a(x24), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(x09), .c(new_n46_), .d(new_n45_), .O(new_n110_));
  ...
  nand2  g69(.a(new_n76_), .b(new_n46_), .O(new_n114_));
  aoi21  g70(.a(new_n52_), .b(new_n45_), .c(new_n114_), .O(z15));
  nand2  g71(.a(new_n72_), .b(new_n55_), .O(z17));
  zero   g72(.O(z04));
  inv1   g73(.a(new_n55_), .O(z06));
  buf    g74(.a(x01), .O(z16));
endmodule
