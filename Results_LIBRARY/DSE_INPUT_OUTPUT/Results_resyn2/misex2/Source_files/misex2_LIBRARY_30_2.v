...
module FAU ( 
  ...
  nand3  g25(.a(new_n62_), .b(new_n68_), .c(new_n67_), .O(new_n69_));
  nand2  g26(.a(new_n69_), .b(new_n45_), .O(z04));
  inv1   g27(.a(new_n61_), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(new_n45_), .c(x10), .d(x09), .O(new_n72_));
  inv1   g29(.a(new_n72_), .O(z05));
  nand2  g30(.a(new_n62_), .b(x11), .O(new_n74_));
  nand2  g31(.a(new_n74_), .b(new_n45_), .O(z06));
  nand3  g32(.a(new_n51_), .b(new_n68_), .c(x11), .O(new_n76_));
  ...
  nor2   g62(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  ...
  aoi21  g67(.a(new_n110_), .b(new_n93_), .c(new_n106_), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(x00), .c(new_n45_), .O(z10));
  nand2  g69(.a(new_n102_), .b(new_n83_), .O(new_n113_));
  inv1   g70(.a(new_n108_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n93_), .c(new_n44_), .O(new_n115_));
  nand3  g72(.a(new_n99_), .b(new_n45_), .c(x21), .O(new_n116_));
  ...
  nand3  g78(.a(new_n64_), .b(x17), .c(new_n56_), .O(new_n122_));
  ...
  oai21  g84(.a(new_n122_), .b(new_n120_), .c(new_n45_), .O(z13));
  nand4  g85(.a(new_n46_), .b(new_n50_), .c(new_n124_), .d(new_n56_), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(new_n55_), .O(z14));
  oai21  g87(.a(x10), .b(new_n84_), .c(x02), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(x00), .O(new_n132_));
  nand3  g89(.a(x19), .b(new_n56_), .c(new_n84_), .O(new_n133_));
