...
module FAU ( 
  ...
  nand3  g20(.a(new_n63_), .b(x10), .c(new_n44_), .O(new_n64_));
  oai22  g21(.a(new_n64_), .b(new_n61_), .c(new_n60_), .d(new_n47_), .O(z03));
  inv1   g22(.a(x11), .O(new_n66_));
  inv1   g23(.a(x12), .O(new_n67_));
  nand2  g24(.a(x10), .b(x02), .O(new_n68_));
  nor3   g25(.a(new_n68_), .b(new_n62_), .c(x09), .O(new_n69_));
  nand3  g26(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(new_n70_));
  inv1   g27(.a(new_n70_), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n62_), .c(new_n44_), .O(z05));
  nand2  g29(.a(new_n69_), .b(x11), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(z06));
  nand4  g31(.a(new_n67_), .b(x11), .c(x10), .d(new_n44_), .O(new_n75_));
  ...
  nand2  g65(.a(new_n97_), .b(new_n95_), .O(new_n109_));
  nand2  g66(.a(new_n100_), .b(x21), .O(new_n110_));
  nand3  g67(.a(new_n104_), .b(new_n91_), .c(new_n105_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(z11));
  nand2  g69(.a(new_n68_), .b(new_n63_), .O(new_n113_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g71(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n115_));
  ...
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n45_), .c(new_n87_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n95_), .c(new_n124_), .O(z15));
  nor2   g82(.a(new_n87_), .b(x00), .O(z16));
