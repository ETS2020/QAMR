...
module FAU ( 
  ...
  aoi21  g040(.a(new_n62_), .b(new_n60_), .c(new_n33_), .O(new_n63_));
  oai21  g041(.a(new_n62_), .b(new_n60_), .c(new_n63_), .O(new_n64_));
  ...
  oai21  g194(.a(new_n216_), .b(new_n214_), .c(new_n61_), .O(new_n217_));
  ...
  aoi21  g231(.a(new_n253_), .b(new_n252_), .c(new_n61_), .O(new_n254_));
  oai21  g232(.a(new_n254_), .b(new_n251_), .c(new_n155_), .O(new_n255_));
  inv1   g233(.a(new_n218_), .O(new_n256_));
  nor2   g234(.a(new_n94_), .b(new_n61_), .O(new_n257_));
  ...
  nor2   g246(.a(new_n218_), .b(new_n61_), .O(new_n269_));
  ...
  oai21  g275(.a(x08), .b(new_n61_), .c(x03), .O(new_n298_));
  nand2  g276(.a(x08), .b(new_n61_), .O(new_n299_));
  ...
  aoi21  g351(.a(new_n373_), .b(x10), .c(new_n61_), .O(new_n374_));
  ...
  nor2   g434(.a(new_n70_), .b(new_n61_), .O(new_n457_));
  ...
  nor2   g520(.a(x09), .b(new_n61_), .O(new_n543_));
  ...
  aoi21  g545(.a(new_n564_), .b(new_n61_), .c(new_n567_), .O(new_n568_));
  ...
  oai21  g569(.a(new_n588_), .b(new_n61_), .c(new_n591_), .O(new_n592_));
  ...
  nand3  g599(.a(new_n621_), .b(new_n619_), .c(new_n61_), .O(new_n622_));
  nor2   g600(.a(new_n181_), .b(new_n61_), .O(new_n623_));
  ...
  oai21  g617(.a(new_n636_), .b(new_n61_), .c(new_n639_), .O(new_n640_));
  aoi21  g618(.a(new_n629_), .b(x09), .c(new_n640_), .O(new_n641_));
  nand2  g619(.a(new_n49_), .b(x00), .O(new_n642_));
  nor2   g620(.a(new_n66_), .b(new_n61_), .O(new_n643_));
  ...
  oai21  g632(.a(new_n654_), .b(new_n651_), .c(new_n61_), .O(new_n655_));
  ...
  aoi21  g878(.a(new_n900_), .b(new_n899_), .c(new_n61_), .O(new_n901_));
  ...
  nor2   g882(.a(new_n904_), .b(new_n62_), .O(new_n905_));
