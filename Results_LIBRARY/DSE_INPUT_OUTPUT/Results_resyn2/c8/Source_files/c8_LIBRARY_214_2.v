...
module FAU ( 
  ...
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n67_), .O(new_n99_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n98_), .c(new_n80_), .d(new_n67_), .O(new_n115_));
  ...
  inv1   g77(.a(new_n115_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n58_), .O(new_n125_));
  aoi21  g79(.a(new_n115_), .b(x26), .c(new_n61_), .O(new_n126_));
  ...
  nand2  g83(.a(new_n129_), .b(new_n60_), .O(new_n130_));
  aoi21  g84(.a(new_n126_), .b(new_n125_), .c(new_n130_), .O(z16));
  nand2  g85(.a(x27), .b(x17), .O(new_n132_));
  inv1   g86(.a(x17), .O(new_n133_));
  nand3  g87(.a(new_n58_), .b(x19), .c(new_n133_), .O(new_n134_));
  inv1   g88(.a(new_n134_), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n114_), .c(new_n98_), .d(new_n80_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n132_), .c(new_n61_), .O(z17));
  buf    g91(.a(x27), .O(z08));
endmodule
