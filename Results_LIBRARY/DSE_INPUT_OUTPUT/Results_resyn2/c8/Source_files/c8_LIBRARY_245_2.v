...
module FAU ( 
  ...
  oai22  g15(.a(z08), .b(x26), .c(new_n47_), .d(x15), .O(z07));
  ...
  xor2a  g45(.a(new_n85_), .b(x22), .O(new_n92_));
  inv1   g46(.a(x03), .O(new_n93_));
  nand2  g47(.a(x18), .b(new_n93_), .O(new_n94_));
  inv1   g48(.a(x11), .O(new_n95_));
  aoi21  g49(.a(new_n65_), .b(new_n95_), .c(x16), .O(new_n96_));
  aoi21  g50(.a(new_n96_), .b(new_n94_), .c(new_n57_), .O(new_n97_));
  oai21  g51(.a(new_n92_), .b(new_n63_), .c(new_n97_), .O(z12));
  inv1   g52(.a(x22), .O(new_n99_));
  nand3  g53(.a(new_n84_), .b(new_n69_), .c(new_n99_), .O(new_n100_));
  ...
  oai21  g61(.a(new_n65_), .b(x04), .c(new_n107_), .O(new_n108_));
  aoi21  g62(.a(new_n108_), .b(new_n105_), .c(new_n57_), .O(z13));
  xor2a  g63(.a(new_n103_), .b(x24), .O(new_n110_));
  ...
  aoi21  g68(.a(new_n114_), .b(new_n112_), .c(new_n57_), .O(new_n115_));
  oai21  g69(.a(new_n110_), .b(new_n63_), .c(new_n115_), .O(z14));
  oai21  g70(.a(new_n103_), .b(x24), .c(x25), .O(new_n117_));
  nor2   g71(.a(x25), .b(x24), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n102_), .c(new_n84_), .d(new_n69_), .O(new_n119_));
  and2   g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n65_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n63_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n58_), .O(new_n124_));
  aoi21  g78(.a(new_n120_), .b(new_n117_), .c(new_n124_), .O(z15));
  nor2   g79(.a(new_n119_), .b(x26), .O(new_n126_));
  nand2  g80(.a(new_n119_), .b(x26), .O(new_n127_));
  ...
  oai21  g85(.a(new_n128_), .b(new_n126_), .c(new_n131_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n58_), .O(z16));
  inv1   g87(.a(x17), .O(new_n134_));
  nand2  g88(.a(new_n118_), .b(new_n102_), .O(new_n135_));
  inv1   g89(.a(x26), .O(new_n136_));
  nand4  g90(.a(new_n84_), .b(new_n136_), .c(x19), .d(new_n134_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n135_), .c(new_n47_), .d(new_n134_), .O(new_n138_));
