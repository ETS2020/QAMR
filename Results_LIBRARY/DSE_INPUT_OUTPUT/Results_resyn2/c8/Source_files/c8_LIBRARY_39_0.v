...
module FAU ( 
  ...
  nor2   g20(.a(x27), .b(x14), .O(new_n67_));
  ...
  oai21  g34(.a(new_n72_), .b(new_n78_), .c(new_n80_), .O(new_n81_));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n67_), .O(z11));
  inv1   g40(.a(x16), .O(new_n87_));
  nand2  g41(.a(x18), .b(x03), .O(new_n88_));
  nand2  g42(.a(new_n60_), .b(x11), .O(new_n89_));
  ...
  nand2  g49(.a(new_n95_), .b(new_n68_), .O(z12));
  inv1   g50(.a(x23), .O(new_n97_));
  xor2a  g51(.a(new_n92_), .b(new_n97_), .O(new_n98_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n99_), .c(new_n67_), .O(z13));
  nand3  g57(.a(new_n91_), .b(new_n72_), .c(new_n97_), .O(new_n104_));
  nand2  g58(.a(new_n65_), .b(new_n70_), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n91_), .O(new_n107_));
  nor2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  aoi21  g62(.a(new_n104_), .b(x24), .c(new_n108_), .O(new_n109_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n87_), .c(new_n114_), .O(z14));
  oai21  g69(.a(new_n107_), .b(new_n105_), .c(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x22), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n79_), .d(new_n65_), .O(new_n118_));
  ...
  aoi21  g76(.a(new_n60_), .b(new_n48_), .c(x16), .O(new_n123_));
  aoi21  g77(.a(new_n123_), .b(new_n122_), .c(new_n67_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n120_), .O(z15));
  inv1   g79(.a(new_n80_), .O(new_n126_));
  nand2  g80(.a(new_n117_), .b(new_n106_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n126_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  aoi21  g84(.a(new_n118_), .b(new_n130_), .c(new_n87_), .O(new_n131_));
  ...
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n67_), .O(z16));
  inv1   g90(.a(x17), .O(new_n137_));
  inv1   g91(.a(new_n107_), .O(new_n138_));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n138_), .c(new_n70_), .d(x19), .O(new_n140_));
  oai21  g94(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(new_n142_), .O(z17));
endmodule
