...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n49_, new_n57_, new_n58_, new_n59_, new_n61_,
  ...
  inv1   g65(.a(new_n58_), .O(new_n112_));
  nand2  g66(.a(x18), .b(x05), .O(new_n113_));
  nand2  g67(.a(new_n61_), .b(x13), .O(new_n114_));
  nand3  g68(.a(new_n114_), .b(new_n113_), .c(new_n67_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  aoi21  g70(.a(new_n111_), .b(new_n108_), .c(new_n116_), .O(z14));
  nand2  g71(.a(new_n82_), .b(new_n73_), .O(new_n118_));
  nor2   g72(.a(x25), .b(x24), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n100_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  aoi21  g75(.a(new_n110_), .b(x25), .c(new_n121_), .O(new_n122_));
  inv1   g76(.a(x06), .O(new_n123_));
  nand2  g77(.a(x18), .b(new_n123_), .O(new_n124_));
  inv1   g78(.a(x14), .O(new_n125_));
  aoi21  g79(.a(new_n61_), .b(new_n125_), .c(x16), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n124_), .c(new_n58_), .O(new_n127_));
  oai21  g81(.a(new_n122_), .b(new_n67_), .c(new_n127_), .O(z15));
  nor3   g82(.a(new_n120_), .b(new_n118_), .c(new_n57_), .O(new_n129_));
  ...
  inv1   g91(.a(new_n120_), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n82_), .c(new_n68_), .d(new_n57_), .O(new_n139_));
  nand2  g93(.a(new_n112_), .b(x16), .O(new_n140_));
