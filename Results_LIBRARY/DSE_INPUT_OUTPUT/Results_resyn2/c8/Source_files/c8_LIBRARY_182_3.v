...
module FAU ( 
  ...
  nand3  g20(.a(new_n66_), .b(new_n63_), .c(new_n56_), .O(z09));
  ...
  aoi21  g26(.a(new_n72_), .b(new_n69_), .c(new_n57_), .O(z10));
  inv1   g27(.a(x20), .O(new_n74_));
  inv1   g28(.a(x21), .O(new_n75_));
  aoi21  g29(.a(new_n65_), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n81_), .c(x16), .O(new_n82_));
  oai21  g36(.a(new_n60_), .b(x02), .c(new_n82_), .O(new_n83_));
  aoi21  g37(.a(new_n83_), .b(new_n80_), .c(new_n57_), .O(z11));
  inv1   g38(.a(x22), .O(new_n85_));
  aoi21  g39(.a(new_n77_), .b(new_n65_), .c(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n77_), .b(new_n65_), .c(new_n85_), .O(new_n87_));
  ...
  oai21  g45(.a(new_n60_), .b(x03), .c(new_n91_), .O(new_n92_));
  aoi21  g46(.a(new_n92_), .b(new_n89_), .c(new_n57_), .O(z12));
  inv1   g47(.a(x16), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n77_), .c(new_n65_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n87_), .b(x23), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n100_), .c(new_n57_), .O(new_n103_));
  oai21  g57(.a(new_n98_), .b(new_n94_), .c(new_n103_), .O(z13));
  inv1   g58(.a(x24), .O(new_n105_));
  xor2a  g59(.a(new_n96_), .b(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x16), .O(new_n107_));
  inv1   g61(.a(x13), .O(new_n108_));
  aoi21  g62(.a(new_n60_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n60_), .b(x05), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n110_), .b(new_n107_), .c(new_n57_), .O(z14));
  oai21  g65(.a(new_n96_), .b(x24), .c(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n95_), .c(new_n77_), .d(new_n65_), .O(new_n114_));
  and2   g68(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g69(.a(x18), .b(x06), .O(new_n116_));
  nand2  g70(.a(new_n60_), .b(x14), .O(new_n117_));
  nand3  g71(.a(new_n117_), .b(new_n116_), .c(new_n94_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n56_), .O(new_n119_));
  aoi21  g73(.a(new_n115_), .b(new_n112_), .c(new_n119_), .O(z15));
  nand2  g74(.a(new_n113_), .b(new_n95_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n79_), .c(x26), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  aoi21  g78(.a(new_n114_), .b(new_n124_), .c(new_n94_), .O(new_n125_));
  ...
  oai21  g82(.a(new_n60_), .b(x07), .c(new_n128_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n126_), .c(new_n57_), .O(z16));
  inv1   g84(.a(x17), .O(new_n131_));
  nand4  g85(.a(new_n77_), .b(new_n124_), .c(x19), .d(new_n131_), .O(new_n132_));
  oai22  g86(.a(new_n132_), .b(new_n121_), .c(new_n47_), .d(new_n131_), .O(new_n133_));
