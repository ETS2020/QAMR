...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n51_, new_n58_, new_n60_, new_n61_, new_n62_,
  ...
  nand2  g11(.a(x27), .b(new_n47_), .O(new_n58_));
  oai21  g12(.a(z08), .b(x26), .c(new_n58_), .O(z07));
  nor2   g13(.a(x27), .b(x15), .O(new_n60_));
  ...
  aoi21  g33(.a(new_n71_), .b(new_n70_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g39(.a(new_n61_), .b(new_n85_), .c(x16), .O(new_n86_));
  oai21  g40(.a(new_n61_), .b(x02), .c(new_n86_), .O(new_n87_));
  aoi21  g41(.a(new_n87_), .b(new_n84_), .c(new_n60_), .O(z11));
  ...
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n60_), .O(new_n94_));
  oai21  g48(.a(new_n89_), .b(new_n66_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x23), .O(new_n96_));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n81_), .b(new_n71_), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n81_), .b(new_n71_), .c(new_n96_), .d(new_n97_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n81_), .c(new_n71_), .d(new_n97_), .O(new_n108_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n81_), .d(new_n71_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi21  g73(.a(new_n108_), .b(x25), .c(new_n119_), .O(new_n120_));
  inv1   g74(.a(x06), .O(new_n121_));
  nand2  g75(.a(x18), .b(new_n121_), .O(new_n122_));
  inv1   g76(.a(x14), .O(new_n123_));
  aoi21  g77(.a(new_n61_), .b(new_n123_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n122_), .c(new_n60_), .O(new_n125_));
  oai21  g79(.a(new_n120_), .b(new_n66_), .c(new_n125_), .O(z15));
  inv1   g80(.a(x26), .O(new_n127_));
  nand2  g81(.a(new_n119_), .b(new_n127_), .O(new_n128_));
  aoi21  g82(.a(new_n118_), .b(x26), .c(new_n66_), .O(new_n129_));
  inv1   g83(.a(new_n60_), .O(new_n130_));
  nand2  g84(.a(x18), .b(x07), .O(new_n131_));
  nand2  g85(.a(new_n61_), .b(x15), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n131_), .c(new_n66_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  aoi21  g88(.a(new_n129_), .b(new_n128_), .c(new_n134_), .O(z16));
  nand2  g89(.a(new_n117_), .b(new_n107_), .O(new_n136_));
  nand4  g90(.a(new_n81_), .b(new_n127_), .c(x19), .d(new_n65_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n51_), .d(new_n65_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n130_), .O(z17));
endmodule
