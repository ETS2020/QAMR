...
module FAU ( 
  ...
  nand4  g61(.a(new_n98_), .b(new_n78_), .c(new_n65_), .d(new_n107_), .O(new_n108_));
  ...
  nor3   g78(.a(new_n116_), .b(new_n87_), .c(new_n124_), .O(new_n125_));
