...
module FAU ( 
  ...
  aoi21  g28(.a(new_n74_), .b(new_n71_), .c(new_n57_), .O(z10));
  ...
  nor2   g72(.a(x18), .b(x16), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(x27), .c(x14), .O(new_n120_));
  nand3  g74(.a(x18), .b(new_n65_), .c(x06), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(z15));
  nand2  g76(.a(new_n116_), .b(x26), .O(new_n123_));
  nor3   g77(.a(x26), .b(x23), .c(x22), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n115_), .c(new_n78_), .d(new_n69_), .O(new_n125_));
  ...
  inv1   g87(.a(new_n57_), .O(new_n134_));
  inv1   g88(.a(x26), .O(new_n135_));
  nand3  g89(.a(new_n115_), .b(new_n96_), .c(new_n135_), .O(new_n136_));
  nand3  g90(.a(new_n78_), .b(x19), .c(new_n64_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n47_), .d(new_n64_), .O(new_n138_));
