...
module FAU ( 
  ...
  nor2   g18(.a(new_n49_), .b(x12), .O(new_n65_));
  ...
  nand2  g29(.a(new_n63_), .b(new_n75_), .O(new_n76_));
  ...
  aoi21  g38(.a(new_n84_), .b(new_n82_), .c(new_n65_), .O(new_n85_));
  oai21  g39(.a(new_n80_), .b(new_n74_), .c(new_n85_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n77_), .b(new_n63_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n77_), .b(new_n63_), .c(new_n87_), .O(new_n89_));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n91_), .c(new_n65_), .O(z12));
  ...
  aoi21  g57(.a(new_n103_), .b(new_n101_), .c(new_n65_), .O(new_n104_));
  ...
  aoi21  g65(.a(new_n111_), .b(new_n108_), .c(new_n65_), .O(z14));
  nand4  g66(.a(new_n96_), .b(new_n77_), .c(new_n63_), .d(new_n106_), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n96_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n79_), .c(new_n113_), .d(x25), .O(new_n117_));
  ...
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n65_), .O(new_n122_));
  oai21  g76(.a(new_n117_), .b(new_n74_), .c(new_n122_), .O(z15));
  nand3  g77(.a(new_n116_), .b(new_n79_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  nand4  g79(.a(new_n114_), .b(new_n96_), .c(new_n77_), .d(new_n63_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n125_), .c(new_n74_), .O(new_n127_));
  ...
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n65_), .O(z16));
  inv1   g86(.a(x17), .O(new_n133_));
  nand4  g87(.a(new_n77_), .b(new_n125_), .c(x19), .d(new_n133_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n115_), .c(new_n49_), .d(new_n133_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n66_), .O(z17));
endmodule
