...
module FAU ( 
  ...
  inv1   g023(.a(new_n65_), .O(new_n70_));
  ...
  nand3  g030(.a(new_n76_), .b(new_n73_), .c(new_n70_), .O(z10));
  ...
  aoi21  g037(.a(new_n71_), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  inv1   g038(.a(x17), .O(new_n85_));
  inv1   g039(.a(x19), .O(new_n86_));
  nand4  g040(.a(new_n83_), .b(new_n82_), .c(new_n86_), .d(new_n85_), .O(new_n87_));
  inv1   g041(.a(new_n87_), .O(new_n88_));
  nor2   g042(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  oai21  g043(.a(new_n89_), .b(new_n67_), .c(new_n81_), .O(z11));
  inv1   g044(.a(x03), .O(new_n91_));
  nand2  g045(.a(new_n60_), .b(x11), .O(new_n92_));
  oai21  g046(.a(new_n62_), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n58_), .O(new_n94_));
  xor2a  g048(.a(new_n87_), .b(x22), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n67_), .c(new_n94_), .O(z12));
  inv1   g050(.a(x04), .O(new_n97_));
  nand2  g051(.a(new_n60_), .b(x12), .O(new_n98_));
  oai21  g052(.a(new_n62_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n58_), .O(new_n100_));
  inv1   g054(.a(x22), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n71_), .c(new_n101_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x23), .O(new_n104_));
  nor2   g058(.a(x23), .b(x22), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n102_), .c(new_n71_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n66_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n100_), .O(z13));
  nand2  g063(.a(new_n106_), .b(x24), .O(new_n110_));
  nor2   g064(.a(x24), .b(x21), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n105_), .c(new_n71_), .d(new_n82_), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n60_), .b(new_n117_), .c(x16), .O(new_n118_));
  aoi21  g072(.a(new_n118_), .b(new_n116_), .c(new_n65_), .O(new_n119_));
  ...
  nand4  g081(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n101_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n88_), .c(new_n112_), .d(x25), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n67_), .c(new_n124_), .O(z15));
  inv1   g085(.a(x07), .O(new_n132_));
  nand2  g086(.a(new_n60_), .b(x15), .O(new_n133_));
  oai21  g087(.a(new_n62_), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n58_), .O(new_n135_));
  inv1   g089(.a(x26), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n105_), .c(new_n102_), .d(new_n71_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g093(.a(new_n138_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n66_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(new_n135_), .O(z16));
  nand2  g096(.a(x27), .b(x17), .O(new_n143_));
  nand4  g097(.a(new_n102_), .b(new_n136_), .c(x19), .d(new_n85_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n128_), .c(new_n143_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n70_), .O(z17));
endmodule
