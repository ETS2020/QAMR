...
module FAU ( 
  ...
  xor2a  g42(.a(new_n85_), .b(x22), .O(new_n89_));
  ...
  nand3  g50(.a(new_n84_), .b(new_n65_), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n84_), .c(new_n65_), .O(new_n100_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n99_), .c(new_n84_), .d(new_n65_), .O(new_n122_));
  and2   g76(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g77(.a(x18), .b(x06), .O(new_n124_));
  nand2  g78(.a(new_n58_), .b(x14), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n124_), .c(new_n69_), .O(new_n126_));
  ...
  nor2   g83(.a(new_n122_), .b(new_n129_), .O(new_n130_));
  nand2  g84(.a(new_n122_), .b(new_n129_), .O(new_n131_));
  ...
  aoi21  g90(.a(new_n136_), .b(new_n134_), .c(new_n72_), .O(new_n137_));
  oai21  g91(.a(new_n132_), .b(new_n130_), .c(new_n137_), .O(z16));
  nor2   g92(.a(x20), .b(new_n63_), .O(new_n139_));
  nor2   g93(.a(x26), .b(x25), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n139_), .c(new_n110_), .d(new_n99_), .O(new_n141_));
