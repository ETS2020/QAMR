...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n50_, new_n53_, new_n54_, new_n60_, new_n61_, new_n62_,
  ...
  nand2  g06(.a(x27), .b(x11), .O(new_n53_));
  inv1   g07(.a(new_n53_), .O(new_n54_));
  aoi21  g08(.a(new_n47_), .b(x22), .c(new_n54_), .O(z03));
  ...
  aoi21  g21(.a(new_n67_), .b(new_n63_), .c(new_n54_), .O(z09));
  ...
  aoi21  g28(.a(new_n74_), .b(new_n71_), .c(new_n54_), .O(z10));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n102_), .c(new_n54_), .O(new_n105_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n97_), .c(new_n82_), .d(new_n69_), .O(new_n118_));
  ...
  nand2  g76(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n54_), .O(z16));
  nand4  g89(.a(new_n82_), .b(new_n129_), .c(x19), .d(new_n64_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n126_), .c(new_n47_), .d(new_n64_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n53_), .O(z17));
endmodule
