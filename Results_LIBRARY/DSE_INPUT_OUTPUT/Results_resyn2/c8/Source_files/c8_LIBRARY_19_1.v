...
module FAU ( 
  ...
  nand2  g40(.a(new_n79_), .b(new_n70_), .O(new_n87_));
  ...
  nand3  g49(.a(new_n79_), .b(new_n70_), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x23), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n79_), .c(new_n70_), .O(new_n99_));
  ...
  nand4  g67(.a(new_n98_), .b(new_n79_), .c(new_n70_), .d(new_n113_), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n98_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n87_), .O(new_n117_));
  ...
  nor3   g79(.a(new_n116_), .b(new_n87_), .c(new_n125_), .O(new_n126_));
  ...
  aoi21  g84(.a(new_n59_), .b(new_n130_), .c(x16), .O(new_n131_));
  ...
  inv1   g88(.a(new_n116_), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n79_), .c(new_n66_), .d(new_n125_), .O(new_n136_));
  oai21  g90(.a(new_n49_), .b(x14), .c(x16), .O(new_n137_));
