...
module FAU ( 
  ...
  nor2   g11(.a(new_n49_), .b(x01), .O(new_n58_));
  ...
  nand3  g26(.a(new_n72_), .b(new_n69_), .c(x16), .O(new_n73_));
  nand2  g27(.a(x18), .b(x01), .O(new_n74_));
  nand2  g28(.a(new_n59_), .b(x09), .O(new_n75_));
  nand3  g29(.a(new_n75_), .b(new_n74_), .c(new_n64_), .O(new_n76_));
  nand3  g30(.a(new_n76_), .b(new_n73_), .c(new_n68_), .O(new_n77_));
  ...
  nand3  g45(.a(new_n91_), .b(new_n71_), .c(new_n70_), .O(new_n92_));
  ...
  nand4  g60(.a(new_n91_), .b(new_n71_), .c(new_n106_), .d(new_n70_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n91_), .c(new_n71_), .d(new_n70_), .O(new_n110_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n81_), .d(new_n71_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n59_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n64_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n68_), .O(new_n126_));
  ...
  aoi21  g85(.a(new_n121_), .b(new_n131_), .c(new_n64_), .O(new_n132_));
  ...
  nand4  g91(.a(new_n81_), .b(new_n131_), .c(x19), .d(new_n63_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n128_), .c(new_n49_), .d(new_n63_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n68_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
