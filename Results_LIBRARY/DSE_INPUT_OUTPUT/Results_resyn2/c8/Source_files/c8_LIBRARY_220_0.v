...
module FAU ( 
  ...
  oai21  g39(.a(new_n80_), .b(new_n66_), .c(new_n85_), .O(z11));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n91_), .c(new_n60_), .O(z12));
  nand2  g49(.a(new_n89_), .b(x23), .O(new_n96_));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n79_), .c(new_n70_), .O(new_n98_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n102_), .c(new_n60_), .O(new_n105_));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n109_), .c(new_n60_), .O(z14));
  nand4  g67(.a(new_n97_), .b(new_n79_), .c(new_n70_), .d(new_n107_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n97_), .c(new_n79_), .d(new_n70_), .O(new_n117_));
  ...
  aoi21  g75(.a(new_n61_), .b(new_n48_), .c(x16), .O(new_n122_));
  ...
  nand4  g80(.a(new_n126_), .b(new_n116_), .c(new_n79_), .d(new_n70_), .O(new_n127_));
  ...
  nand3  g91(.a(new_n116_), .b(new_n97_), .c(new_n137_), .O(new_n138_));
  nand3  g92(.a(new_n79_), .b(x19), .c(new_n65_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n47_), .d(new_n65_), .O(new_n140_));
