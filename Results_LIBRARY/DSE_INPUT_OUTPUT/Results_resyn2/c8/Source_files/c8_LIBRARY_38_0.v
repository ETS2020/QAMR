...
module FAU ( 
  ...
  nand2  g08(.a(x27), .b(new_n48_), .O(new_n55_));
  oai21  g09(.a(new_n50_), .b(x23), .c(new_n55_), .O(z04));
  aoi22  g10(.a(new_n49_), .b(x24), .c(x27), .d(x13), .O(z05));
  oai22  g11(.a(new_n50_), .b(x25), .c(new_n47_), .d(x14), .O(z06));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n67_), .O(new_n87_));
  oai21  g41(.a(new_n82_), .b(new_n76_), .c(new_n87_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n79_), .b(new_n65_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n79_), .b(new_n65_), .c(new_n89_), .O(new_n91_));
  ...
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n67_), .O(z12));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n79_), .c(new_n65_), .O(new_n99_));
  ...
  aoi21  g57(.a(new_n60_), .b(new_n48_), .c(x16), .O(new_n104_));
  aoi21  g58(.a(new_n104_), .b(new_n103_), .c(new_n67_), .O(new_n105_));
  oai21  g59(.a(new_n101_), .b(new_n76_), .c(new_n105_), .O(z13));
  inv1   g60(.a(x24), .O(new_n107_));
  xor2a  g61(.a(new_n99_), .b(new_n107_), .O(new_n108_));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n109_), .c(new_n67_), .O(z14));
  nand4  g67(.a(new_n98_), .b(new_n79_), .c(new_n65_), .d(new_n107_), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n98_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  aoi22  g71(.a(new_n117_), .b(new_n81_), .c(new_n114_), .d(x25), .O(new_n118_));
  ...
  aoi21  g76(.a(new_n122_), .b(new_n120_), .c(new_n67_), .O(new_n123_));
  oai21  g77(.a(new_n118_), .b(new_n76_), .c(new_n123_), .O(z15));
  nand3  g78(.a(new_n117_), .b(new_n81_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  nand4  g80(.a(new_n115_), .b(new_n98_), .c(new_n79_), .d(new_n65_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n76_), .O(new_n128_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n129_), .c(new_n67_), .O(z16));
  inv1   g87(.a(x17), .O(new_n134_));
  nand4  g88(.a(new_n79_), .b(new_n126_), .c(x19), .d(new_n134_), .O(new_n135_));
