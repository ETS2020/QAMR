...
module FAU ( 
  ...
  oai21  g09(.a(x27), .b(x24), .c(x13), .O(z05));
  ...
  aoi21  g44(.a(x18), .b(x03), .c(new_n90_), .O(new_n91_));
  nor2   g45(.a(x22), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n66_), .c(new_n71_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(x16), .O(new_n94_));
  aoi21  g48(.a(new_n81_), .b(x22), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n91_), .c(new_n69_), .O(z12));
  xor2a  g50(.a(new_n93_), .b(x23), .O(new_n97_));
  ...
  aoi21  g55(.a(new_n101_), .b(new_n99_), .c(new_n68_), .O(new_n102_));
  oai21  g56(.a(new_n97_), .b(new_n89_), .c(new_n102_), .O(z13));
  inv1   g57(.a(x23), .O(new_n104_));
  nand4  g58(.a(new_n92_), .b(new_n66_), .c(new_n104_), .d(new_n71_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n92_), .c(new_n73_), .O(new_n108_));
  ...
  aoi21  g66(.a(new_n59_), .b(new_n48_), .c(x16), .O(new_n113_));
  aoi21  g67(.a(new_n113_), .b(new_n112_), .c(new_n68_), .O(new_n114_));
  ...
  nand3  g72(.a(new_n107_), .b(new_n118_), .c(new_n117_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n82_), .c(new_n89_), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n59_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n89_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n69_), .O(new_n125_));
  aoi21  g79(.a(new_n121_), .b(new_n116_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n120_), .b(new_n82_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  oai21  g82(.a(new_n119_), .b(new_n81_), .c(new_n128_), .O(new_n129_));
  ...
  nor2   g90(.a(x20), .b(new_n64_), .O(new_n137_));
  nor2   g91(.a(x26), .b(x25), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n92_), .O(new_n139_));
  oai21  g93(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  aoi21  g95(.a(new_n139_), .b(new_n63_), .c(new_n141_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
