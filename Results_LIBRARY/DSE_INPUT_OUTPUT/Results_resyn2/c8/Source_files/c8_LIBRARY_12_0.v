...
module FAU ( 
  ...
  xor2a  g51(.a(new_n97_), .b(x23), .O(new_n98_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n100_), .c(new_n60_), .O(new_n103_));
  oai21  g57(.a(new_n98_), .b(new_n66_), .c(new_n103_), .O(z13));
  inv1   g58(.a(x23), .O(new_n105_));
  nand4  g59(.a(new_n81_), .b(new_n71_), .c(new_n105_), .d(new_n96_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n81_), .c(new_n71_), .d(new_n96_), .O(new_n109_));
  ...
  aoi21  g68(.a(new_n61_), .b(new_n114_), .c(x16), .O(new_n115_));
  ...
  nand2  g72(.a(new_n118_), .b(new_n108_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n83_), .c(new_n109_), .d(x25), .O(new_n121_));
  inv1   g75(.a(x06), .O(new_n122_));
  nand2  g76(.a(x18), .b(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n61_), .b(new_n48_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n123_), .c(new_n60_), .O(new_n125_));
  oai21  g79(.a(new_n121_), .b(new_n66_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n120_), .b(new_n83_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand4  g82(.a(new_n118_), .b(new_n108_), .c(new_n81_), .d(new_n71_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n128_), .c(new_n66_), .O(new_n130_));
  ...
  inv1   g89(.a(new_n60_), .O(new_n136_));
  nand4  g90(.a(new_n81_), .b(new_n128_), .c(x19), .d(new_n65_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n119_), .c(new_n47_), .d(new_n65_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n136_), .O(z17));
endmodule
