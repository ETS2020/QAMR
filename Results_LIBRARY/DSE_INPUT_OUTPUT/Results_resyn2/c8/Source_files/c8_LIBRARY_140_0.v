...
module FAU ( 
  ...
  oai21  g07(.a(x27), .b(x22), .c(x11), .O(z03));
  ...
  nor2   g12(.a(x27), .b(x11), .O(new_n59_));
  ...
  nand2  g30(.a(new_n60_), .b(new_n69_), .O(new_n77_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n68_), .c(new_n84_), .O(z11));
  inv1   g39(.a(x22), .O(new_n86_));
  nand3  g40(.a(new_n78_), .b(new_n60_), .c(new_n86_), .O(new_n87_));
  nand2  g41(.a(new_n78_), .b(new_n60_), .O(new_n88_));
  aoi21  g42(.a(new_n88_), .b(x22), .c(new_n68_), .O(new_n89_));
  inv1   g43(.a(new_n59_), .O(new_n90_));
  nand2  g44(.a(x18), .b(x03), .O(new_n91_));
  nand2  g45(.a(new_n63_), .b(x11), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n91_), .c(new_n68_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n94_), .O(z12));
  xor2a  g49(.a(new_n87_), .b(x23), .O(new_n96_));
  inv1   g50(.a(x04), .O(new_n97_));
  nand2  g51(.a(x18), .b(new_n97_), .O(new_n98_));
  inv1   g52(.a(x12), .O(new_n99_));
  aoi21  g53(.a(new_n63_), .b(new_n99_), .c(x16), .O(new_n100_));
  ...
  nand4  g57(.a(new_n78_), .b(new_n60_), .c(new_n103_), .d(new_n86_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n106_), .c(new_n60_), .d(new_n69_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n106_), .c(new_n78_), .d(new_n60_), .O(new_n119_));
  and2   g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n63_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n68_), .O(new_n123_));
  ...
  nor2   g80(.a(new_n119_), .b(new_n126_), .O(new_n127_));
  nand2  g81(.a(new_n119_), .b(new_n126_), .O(new_n128_));
  ...
  nand2  g90(.a(new_n118_), .b(new_n106_), .O(new_n137_));
  nand4  g91(.a(new_n78_), .b(new_n126_), .c(x19), .d(new_n136_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n47_), .d(new_n136_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n90_), .O(z17));
endmodule
