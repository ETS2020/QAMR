...
module FAU ( 
  ...
  aoi21  g51(.a(new_n60_), .b(new_n97_), .c(new_n61_), .O(new_n98_));
  oai21  g52(.a(new_n60_), .b(x04), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g62(.a(new_n108_), .b(new_n50_), .c(new_n47_), .O(new_n109_));
  ...
  nand2  g84(.a(new_n50_), .b(new_n47_), .O(new_n131_));
