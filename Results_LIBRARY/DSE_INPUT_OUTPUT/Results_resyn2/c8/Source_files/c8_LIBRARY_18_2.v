...
module FAU ( 
  ...
  nand4  g68(.a(new_n98_), .b(new_n82_), .c(new_n67_), .d(new_n108_), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n82_), .d(new_n67_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  aoi21  g72(.a(new_n115_), .b(x25), .c(new_n118_), .O(new_n119_));
  ...
  oai21  g78(.a(new_n119_), .b(new_n61_), .c(new_n124_), .O(z15));
  nand2  g79(.a(new_n118_), .b(new_n58_), .O(new_n126_));
  aoi21  g80(.a(new_n117_), .b(x26), .c(new_n61_), .O(new_n127_));
  nand2  g81(.a(x18), .b(x07), .O(new_n128_));
  nand2  g82(.a(new_n63_), .b(x15), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n128_), .c(new_n61_), .O(new_n130_));
  ...
  nand3  g88(.a(new_n58_), .b(x19), .c(new_n134_), .O(new_n135_));
  inv1   g89(.a(new_n135_), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n116_), .c(new_n98_), .d(new_n82_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n133_), .c(new_n61_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
