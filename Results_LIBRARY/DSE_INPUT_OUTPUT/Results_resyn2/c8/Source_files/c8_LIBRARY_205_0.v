...
module FAU ( 
  ...
  nand3  g45(.a(new_n91_), .b(new_n64_), .c(new_n71_), .O(new_n92_));
  ...
  nand3  g64(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n82_), .c(x24), .O(new_n112_));
  inv1   g66(.a(x24), .O(new_n113_));
  nand3  g67(.a(new_n100_), .b(new_n73_), .c(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(x16), .O(new_n116_));
  inv1   g70(.a(x13), .O(new_n117_));
  aoi21  g71(.a(new_n66_), .b(new_n117_), .c(x16), .O(new_n118_));
  oai21  g72(.a(new_n66_), .b(x05), .c(new_n118_), .O(new_n119_));
  aoi21  g73(.a(new_n119_), .b(new_n116_), .c(new_n60_), .O(z14));
  nor2   g74(.a(new_n111_), .b(new_n82_), .O(new_n121_));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n121_), .c(new_n114_), .d(x25), .O(new_n123_));
  inv1   g77(.a(x06), .O(new_n124_));
  nand2  g78(.a(x18), .b(new_n124_), .O(new_n125_));
  aoi21  g79(.a(new_n66_), .b(new_n48_), .c(x16), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n125_), .c(new_n60_), .O(new_n127_));
  oai21  g81(.a(new_n123_), .b(new_n81_), .c(new_n127_), .O(z15));
  nand3  g82(.a(new_n122_), .b(new_n121_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  inv1   g84(.a(new_n122_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n101_), .c(new_n130_), .O(new_n132_));
  ...
  aoi21  g91(.a(new_n137_), .b(new_n135_), .c(new_n60_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n133_), .O(z16));
  nor2   g93(.a(x20), .b(new_n62_), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n122_), .c(new_n100_), .d(new_n130_), .O(new_n141_));
  oai21  g95(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  aoi21  g97(.a(new_n141_), .b(new_n61_), .c(new_n143_), .O(z17));
endmodule
