...
module FAU ( 
  ...
  nor2   g70(.a(new_n116_), .b(new_n65_), .O(new_n117_));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n113_), .c(new_n122_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nor3   g78(.a(new_n115_), .b(new_n81_), .c(new_n124_), .O(new_n125_));
  oai21  g79(.a(new_n116_), .b(x26), .c(x16), .O(new_n126_));
  ...
  inv1   g87(.a(new_n115_), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n80_), .c(new_n66_), .d(new_n124_), .O(new_n135_));
  nand2  g89(.a(new_n118_), .b(x16), .O(new_n136_));
