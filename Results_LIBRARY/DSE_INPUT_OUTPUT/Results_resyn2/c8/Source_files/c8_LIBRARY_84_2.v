...
module FAU ( 
  ...
  aoi21  g50(.a(new_n96_), .b(new_n94_), .c(new_n59_), .O(new_n97_));
  ...
  aoi21  g67(.a(new_n113_), .b(new_n110_), .c(new_n59_), .O(z14));
  ...
  oai21  g73(.a(x18), .b(x16), .c(x27), .O(new_n120_));
  inv1   g74(.a(x06), .O(new_n121_));
  nor2   g75(.a(x16), .b(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(x18), .c(new_n120_), .d(x14), .O(new_n123_));
  ...
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n49_), .d(new_n136_), .O(new_n140_));
