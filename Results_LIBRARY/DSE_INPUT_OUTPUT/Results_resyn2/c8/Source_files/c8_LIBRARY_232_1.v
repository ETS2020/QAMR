...
module FAU ( 
  ...
  oai21  g75(.a(new_n116_), .b(new_n94_), .c(new_n121_), .O(z15));
  nand3  g76(.a(new_n115_), .b(new_n79_), .c(x26), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  nand4  g78(.a(new_n113_), .b(new_n95_), .c(new_n77_), .d(new_n63_), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n124_), .c(new_n94_), .O(new_n126_));
  ...
  nand4  g86(.a(new_n77_), .b(new_n124_), .c(x19), .d(new_n132_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n114_), .c(new_n49_), .d(new_n132_), .O(new_n134_));
