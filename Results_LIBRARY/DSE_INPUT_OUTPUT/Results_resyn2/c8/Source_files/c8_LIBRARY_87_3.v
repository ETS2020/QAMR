...
module FAU ( 
  ...
  nand2  g36(.a(new_n82_), .b(new_n73_), .O(new_n83_));
  oai21  g37(.a(new_n75_), .b(new_n81_), .c(new_n83_), .O(new_n84_));
  ...
  aoi21  g42(.a(new_n88_), .b(new_n85_), .c(new_n59_), .O(z11));
  ...
  nand4  g53(.a(new_n82_), .b(new_n73_), .c(new_n99_), .d(new_n90_), .O(new_n100_));
  aoi21  g54(.a(new_n92_), .b(x23), .c(new_n66_), .O(new_n101_));
  nand2  g55(.a(x18), .b(x04), .O(new_n102_));
  nand2  g56(.a(new_n60_), .b(x12), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n102_), .c(new_n66_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n71_), .O(new_n105_));
  aoi21  g59(.a(new_n101_), .b(new_n100_), .c(new_n105_), .O(z13));
  ...
  inv1   g70(.a(new_n100_), .O(new_n117_));
  nor2   g71(.a(x27), .b(new_n58_), .O(new_n118_));
  nor2   g72(.a(x25), .b(x24), .O(new_n119_));
  aoi22  g73(.a(new_n119_), .b(new_n117_), .c(new_n118_), .d(new_n110_), .O(new_n120_));
  nor2   g74(.a(new_n59_), .b(x16), .O(new_n121_));
  inv1   g75(.a(x14), .O(new_n122_));
  nand2  g76(.a(new_n60_), .b(new_n122_), .O(new_n123_));
  ...
  oai21  g80(.a(new_n120_), .b(new_n66_), .c(new_n126_), .O(z15));
  nand2  g81(.a(new_n110_), .b(x26), .O(new_n128_));
  nor2   g82(.a(x26), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n108_), .c(new_n82_), .d(new_n73_), .O(new_n130_));
  ...
  nand2  g89(.a(new_n60_), .b(new_n135_), .O(new_n136_));
  ...
  nand4  g95(.a(new_n129_), .b(new_n108_), .c(new_n82_), .d(new_n67_), .O(new_n142_));
  nand2  g96(.a(new_n58_), .b(x16), .O(new_n143_));
  aoi21  g97(.a(new_n142_), .b(new_n141_), .c(new_n143_), .O(z17));
  buf    g98(.a(x27), .O(z08));
endmodule
