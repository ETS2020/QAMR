...
module FAU ( 
  ...
  aoi21  g09(.a(new_n49_), .b(x25), .c(z08), .O(z06));
  ...
  xor2a  g25(.a(new_n66_), .b(new_n71_), .O(new_n72_));
  inv1   g26(.a(x01), .O(new_n73_));
  nand2  g27(.a(x18), .b(new_n73_), .O(new_n74_));
  inv1   g28(.a(x09), .O(new_n75_));
  aoi21  g29(.a(new_n62_), .b(new_n75_), .c(x16), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n58_), .O(new_n77_));
  oai21  g31(.a(new_n72_), .b(new_n60_), .c(new_n77_), .O(z10));
  inv1   g32(.a(x21), .O(new_n79_));
  aoi21  g33(.a(new_n66_), .b(new_n71_), .c(new_n79_), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  nand2  g35(.a(new_n81_), .b(new_n66_), .O(new_n82_));
  inv1   g36(.a(new_n82_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n80_), .c(x16), .O(new_n84_));
  inv1   g38(.a(x10), .O(new_n85_));
  aoi21  g39(.a(new_n62_), .b(new_n85_), .c(x16), .O(new_n86_));
  oai21  g40(.a(new_n62_), .b(x02), .c(new_n86_), .O(new_n87_));
  aoi21  g41(.a(new_n87_), .b(new_n84_), .c(new_n58_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n81_), .b(new_n66_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n81_), .b(new_n66_), .c(new_n89_), .O(new_n91_));
  inv1   g45(.a(new_n91_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  inv1   g47(.a(x11), .O(new_n94_));
  aoi21  g48(.a(new_n62_), .b(new_n94_), .c(x16), .O(new_n95_));
  oai21  g49(.a(new_n62_), .b(x03), .c(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n58_), .O(z12));
  ...
  aoi21  g55(.a(new_n62_), .b(new_n101_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n62_), .b(x04), .c(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n58_), .O(z13));
  nand4  g58(.a(new_n81_), .b(new_n66_), .c(new_n98_), .d(new_n89_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n81_), .c(new_n66_), .d(new_n89_), .O(new_n108_));
  ...
  aoi21  g67(.a(new_n62_), .b(new_n113_), .c(x16), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(new_n112_), .c(new_n58_), .O(new_n115_));
  ...
  aoi22  g73(.a(new_n119_), .b(new_n83_), .c(new_n108_), .d(x25), .O(new_n120_));
  inv1   g74(.a(x06), .O(new_n121_));
  nand2  g75(.a(x18), .b(new_n121_), .O(new_n122_));
  inv1   g76(.a(x14), .O(new_n123_));
  aoi21  g77(.a(new_n62_), .b(new_n123_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n122_), .c(new_n58_), .O(new_n125_));
  oai21  g79(.a(new_n120_), .b(new_n60_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n119_), .b(new_n83_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n81_), .d(new_n66_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n128_), .c(new_n60_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  inv1   g85(.a(x15), .O(new_n132_));
  aoi21  g86(.a(new_n62_), .b(new_n132_), .c(x16), .O(new_n133_));
  oai21  g87(.a(new_n62_), .b(x07), .c(new_n133_), .O(new_n134_));
  ...
  nand4  g92(.a(new_n138_), .b(new_n119_), .c(new_n81_), .d(new_n128_), .O(new_n139_));
