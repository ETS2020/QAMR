...
module FAU ( 
  ...
  nand4  g60(.a(new_n85_), .b(new_n71_), .c(new_n106_), .d(new_n90_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n109_), .c(new_n71_), .d(new_n82_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x16), .O(new_n113_));
  oai21  g67(.a(new_n60_), .b(x16), .c(new_n47_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x05), .O(new_n115_));
  nand3  g69(.a(new_n60_), .b(new_n65_), .c(x13), .O(new_n116_));
  nand3  g70(.a(new_n116_), .b(new_n115_), .c(new_n113_), .O(z14));
  nand2  g71(.a(new_n111_), .b(x25), .O(new_n118_));
  nor2   g72(.a(x25), .b(x22), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n85_), .d(new_n71_), .O(new_n120_));
  and2   g74(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n60_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n65_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n78_), .O(new_n125_));
  ...
  aoi21  g85(.a(new_n120_), .b(new_n131_), .c(new_n65_), .O(new_n132_));
  ...
  nand4  g92(.a(new_n85_), .b(new_n131_), .c(x19), .d(new_n64_), .O(new_n139_));
  ...
  nand4  g96(.a(new_n47_), .b(new_n131_), .c(new_n142_), .d(new_n82_), .O(new_n143_));
  inv1   g97(.a(new_n143_), .O(new_n144_));
  nand4  g98(.a(new_n144_), .b(new_n110_), .c(new_n109_), .d(new_n67_), .O(new_n145_));
  aoi21  g99(.a(new_n145_), .b(new_n141_), .c(new_n65_), .O(z17));
endmodule
