...
module FAU ( 
  ...
  nor2   g11(.a(new_n49_), .b(x15), .O(new_n58_));
  ...
  nand2  g40(.a(new_n86_), .b(new_n77_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n83_), .b(new_n69_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n83_), .b(new_n69_), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n98_), .b(new_n83_), .c(new_n69_), .O(new_n99_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n98_), .c(new_n69_), .d(new_n68_), .O(new_n110_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n98_), .c(new_n83_), .d(new_n69_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n118_), .b(new_n98_), .c(new_n126_), .O(new_n127_));
  nor2   g81(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  aoi21  g82(.a(new_n119_), .b(x26), .c(new_n128_), .O(new_n129_));
  nand2  g83(.a(new_n77_), .b(x16), .O(new_n130_));
  nor2   g84(.a(x27), .b(new_n59_), .O(new_n131_));
  inv1   g85(.a(x07), .O(new_n132_));
  aoi21  g86(.a(x18), .b(new_n132_), .c(x16), .O(new_n133_));
  oai21  g87(.a(new_n131_), .b(x15), .c(new_n133_), .O(new_n134_));
  oai21  g88(.a(new_n130_), .b(new_n129_), .c(new_n134_), .O(z16));
  nand3  g89(.a(new_n83_), .b(x19), .c(new_n63_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n127_), .c(new_n49_), .d(new_n63_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n77_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
