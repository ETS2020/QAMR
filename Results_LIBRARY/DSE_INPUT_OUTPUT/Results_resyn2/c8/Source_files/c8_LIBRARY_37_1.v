...
module FAU ( 
  ...
  oai21  g67(.a(new_n59_), .b(x05), .c(new_n113_), .O(new_n114_));
  ...
  nor3   g80(.a(new_n117_), .b(new_n82_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n81_), .c(new_n66_), .d(new_n126_), .O(new_n137_));
