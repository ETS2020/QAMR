...
module FAU ( 
  ...
  nand4  g67(.a(new_n97_), .b(new_n79_), .c(new_n65_), .d(new_n107_), .O(new_n114_));
  ...
  aoi21  g74(.a(new_n60_), .b(new_n48_), .c(x16), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n120_), .c(new_n67_), .O(new_n122_));
  oai21  g76(.a(new_n118_), .b(new_n96_), .c(new_n122_), .O(z15));
  nand3  g77(.a(new_n117_), .b(new_n81_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  nand4  g79(.a(new_n115_), .b(new_n97_), .c(new_n79_), .d(new_n65_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n125_), .c(new_n96_), .O(new_n127_));
  ...
  nand4  g87(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n133_), .O(new_n134_));
