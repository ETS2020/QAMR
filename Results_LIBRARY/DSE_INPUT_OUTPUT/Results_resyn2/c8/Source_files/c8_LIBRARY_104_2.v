...
module FAU ( 
  ...
  oai22  g44(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n80_), .O(z12));
  ...
  oai21  g49(.a(new_n86_), .b(x23), .c(x24), .O(new_n96_));
  nor2   g50(.a(x24), .b(x23), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n78_), .c(new_n61_), .d(new_n84_), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n96_), .c(x27), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x16), .O(new_n100_));
  inv1   g54(.a(x13), .O(new_n101_));
  aoi21  g55(.a(new_n65_), .b(new_n101_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n65_), .b(x05), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n100_), .O(z14));
  nand2  g58(.a(new_n98_), .b(x25), .O(new_n105_));
  nor3   g59(.a(x25), .b(x24), .c(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n78_), .c(new_n61_), .d(new_n84_), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n105_), .c(x27), .O(new_n108_));
  ...
  oai21  g70(.a(new_n116_), .b(new_n86_), .c(x27), .O(new_n117_));
  ...
  oai21  g75(.a(new_n118_), .b(new_n67_), .c(new_n121_), .O(z16));
  inv1   g76(.a(new_n116_), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n78_), .c(new_n84_), .d(x19), .O(new_n124_));
  nor2   g78(.a(new_n49_), .b(x17), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n124_), .c(new_n67_), .O(z17));
endmodule
