...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x12), .O(z08));
  ...
  inv1   g13(.a(new_n55_), .O(new_n60_));
  ...
  and2   g18(.a(x19), .b(x17), .O(new_n65_));
  nor2   g19(.a(x19), .b(x17), .O(new_n66_));
  oai21  g20(.a(new_n66_), .b(new_n65_), .c(x16), .O(new_n67_));
  nand3  g21(.a(new_n67_), .b(new_n64_), .c(new_n60_), .O(z09));
  xor2a  g22(.a(new_n66_), .b(x20), .O(new_n69_));
  nand2  g23(.a(new_n69_), .b(x16), .O(new_n70_));
  inv1   g24(.a(x09), .O(new_n71_));
  aoi21  g25(.a(new_n61_), .b(new_n71_), .c(x16), .O(new_n72_));
  oai21  g26(.a(new_n61_), .b(x01), .c(new_n72_), .O(new_n73_));
  aoi21  g27(.a(new_n73_), .b(new_n70_), .c(new_n55_), .O(z10));
  inv1   g28(.a(x16), .O(new_n75_));
  inv1   g29(.a(x20), .O(new_n76_));
  nand2  g30(.a(new_n66_), .b(new_n76_), .O(new_n77_));
  nor2   g31(.a(x21), .b(x20), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n66_), .O(new_n79_));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n83_), .c(new_n55_), .O(new_n86_));
  oai21  g40(.a(new_n81_), .b(new_n75_), .c(new_n86_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n78_), .b(new_n66_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n78_), .b(new_n66_), .c(new_n88_), .O(new_n90_));
  ...
  aoi21  g49(.a(new_n95_), .b(new_n92_), .c(new_n55_), .O(z12));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n78_), .c(new_n66_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n90_), .b(x23), .c(new_n99_), .O(new_n100_));
  inv1   g54(.a(x04), .O(new_n101_));
  nand2  g55(.a(x18), .b(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n61_), .b(new_n54_), .c(x16), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n102_), .c(new_n55_), .O(new_n104_));
  oai21  g58(.a(new_n100_), .b(new_n75_), .c(new_n104_), .O(z13));
  inv1   g59(.a(x24), .O(new_n106_));
  xor2a  g60(.a(new_n98_), .b(new_n106_), .O(new_n107_));
  ...
  aoi21  g65(.a(new_n111_), .b(new_n108_), .c(new_n55_), .O(z14));
  nand4  g66(.a(new_n97_), .b(new_n78_), .c(new_n66_), .d(new_n106_), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n97_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n80_), .c(new_n113_), .d(x25), .O(new_n117_));
  ...
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n55_), .O(new_n122_));
  oai21  g76(.a(new_n117_), .b(new_n75_), .c(new_n122_), .O(z15));
  nand3  g77(.a(new_n116_), .b(new_n80_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  nand4  g79(.a(new_n114_), .b(new_n97_), .c(new_n78_), .d(new_n66_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n125_), .c(new_n75_), .O(new_n127_));
  ...
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n55_), .O(z16));
  inv1   g86(.a(x17), .O(new_n133_));
  nand4  g87(.a(new_n78_), .b(new_n125_), .c(x19), .d(new_n133_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n115_), .c(new_n47_), .d(new_n133_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n60_), .O(z17));
endmodule
