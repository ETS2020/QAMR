...
module FAU ( 
  ...
  nor2   g19(.a(x27), .b(x02), .O(new_n66_));
  ...
  nand2  g31(.a(new_n64_), .b(new_n70_), .O(new_n78_));
  ...
  nand2  g36(.a(x18), .b(new_n47_), .O(new_n83_));
  ...
  oai21  g40(.a(new_n82_), .b(new_n69_), .c(new_n86_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n79_), .b(new_n64_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n79_), .b(new_n64_), .c(new_n88_), .O(new_n90_));
  ...
  nand4  g58(.a(new_n79_), .b(new_n64_), .c(new_n104_), .d(new_n88_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n79_), .c(new_n64_), .d(new_n88_), .O(new_n108_));
  ...
  aoi21  g78(.a(new_n124_), .b(new_n122_), .c(new_n66_), .O(new_n125_));
  ...
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n79_), .d(new_n64_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n128_), .c(new_n69_), .O(new_n130_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n66_), .O(z16));
  inv1   g89(.a(x17), .O(new_n136_));
  nand4  g90(.a(new_n79_), .b(new_n128_), .c(x19), .d(new_n136_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n118_), .c(new_n51_), .d(new_n136_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n67_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
