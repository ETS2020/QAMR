...
module FAU ( 
  ...
  oai22  g15(.a(new_n49_), .b(x26), .c(new_n47_), .d(x15), .O(z07));
  ...
  oai21  g58(.a(new_n99_), .b(new_n71_), .c(new_n104_), .O(z13));
  inv1   g59(.a(x23), .O(new_n106_));
  nand4  g60(.a(new_n82_), .b(new_n68_), .c(new_n106_), .d(new_n97_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n82_), .c(new_n68_), .d(new_n97_), .O(new_n110_));
  ...
  oai21  g80(.a(new_n122_), .b(new_n71_), .c(new_n126_), .O(z15));
  nand3  g81(.a(new_n121_), .b(new_n84_), .c(x26), .O(new_n128_));
  inv1   g82(.a(x26), .O(new_n129_));
  nand4  g83(.a(new_n119_), .b(new_n109_), .c(new_n82_), .d(new_n68_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n129_), .c(new_n71_), .O(new_n131_));
  ...
  oai21  g88(.a(new_n63_), .b(x07), .c(new_n134_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n57_), .O(z16));
  inv1   g90(.a(x17), .O(new_n137_));
  nand4  g91(.a(new_n82_), .b(new_n129_), .c(x19), .d(new_n137_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n120_), .c(new_n47_), .d(new_n137_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n58_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
