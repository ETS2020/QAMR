...
module FAU ( 
  ...
  aoi21  g17(.a(x19), .b(new_n63_), .c(new_n48_), .O(new_n64_));
  ...
  oai22  g25(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n48_), .O(z10));
  ...
  oai22  g31(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n48_), .O(z11));
  inv1   g32(.a(x22), .O(new_n79_));
  aoi21  g33(.a(new_n74_), .b(new_n68_), .c(new_n79_), .O(new_n80_));
  nand3  g34(.a(new_n74_), .b(new_n68_), .c(new_n79_), .O(new_n81_));
  ...
  oai21  g39(.a(x18), .b(new_n84_), .c(new_n85_), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n47_), .c(new_n48_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n83_), .O(z12));
  nand2  g42(.a(new_n81_), .b(x23), .O(new_n89_));
  nor2   g43(.a(x23), .b(x22), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n74_), .c(new_n68_), .O(new_n91_));
  ...
  oai21  g50(.a(new_n96_), .b(new_n47_), .c(new_n48_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n93_), .O(z13));
  nand2  g52(.a(new_n91_), .b(x24), .O(new_n99_));
  nor2   g53(.a(x24), .b(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n90_), .c(new_n68_), .d(new_n67_), .O(new_n101_));
  ...
  oai21  g60(.a(new_n106_), .b(new_n47_), .c(new_n48_), .O(new_n107_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n90_), .c(new_n74_), .d(new_n68_), .O(new_n115_));
  ...
  nand3  g75(.a(new_n121_), .b(new_n119_), .c(new_n61_), .O(new_n122_));
  ...
  nand2  g81(.a(new_n47_), .b(new_n48_), .O(new_n128_));
  nand2  g82(.a(new_n114_), .b(new_n90_), .O(new_n129_));
  nand2  g83(.a(x27), .b(x17), .O(new_n130_));
  nand4  g84(.a(new_n74_), .b(new_n123_), .c(x19), .d(new_n63_), .O(new_n131_));
