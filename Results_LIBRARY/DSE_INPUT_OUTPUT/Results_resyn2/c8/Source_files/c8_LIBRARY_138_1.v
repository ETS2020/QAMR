...
module FAU ( 
  ...
  aoi21  g41(.a(new_n58_), .b(new_n87_), .c(new_n61_), .O(new_n88_));
  oai21  g42(.a(new_n58_), .b(x03), .c(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n86_), .b(new_n60_), .c(new_n89_), .O(z12));
  inv1   g44(.a(x22), .O(new_n91_));
  nor2   g45(.a(x21), .b(x20), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n74_), .c(new_n91_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n92_), .c(new_n74_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x16), .O(new_n98_));
  inv1   g52(.a(x12), .O(new_n99_));
  aoi21  g53(.a(new_n58_), .b(new_n99_), .c(new_n61_), .O(new_n100_));
  ...
  nand4  g58(.a(new_n104_), .b(new_n95_), .c(new_n74_), .d(new_n73_), .O(new_n105_));
  ...
  nand3  g63(.a(new_n109_), .b(new_n108_), .c(new_n47_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  ...
  aoi22  g71(.a(new_n117_), .b(new_n83_), .c(new_n105_), .d(x25), .O(new_n118_));
  ...
  nand4  g81(.a(new_n127_), .b(new_n95_), .c(new_n92_), .d(new_n74_), .O(new_n128_));
  ...
  nand4  g87(.a(new_n117_), .b(new_n92_), .c(new_n66_), .d(new_n126_), .O(new_n134_));
