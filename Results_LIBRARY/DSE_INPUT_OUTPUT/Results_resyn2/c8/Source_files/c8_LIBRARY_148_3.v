...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n55_, new_n56_, new_n59_, new_n60_, new_n61_,
  ...
  nor2   g01(.a(new_n47_), .b(x02), .O(new_n48_));
  ...
  aoi22  g05(.a(new_n48_), .b(x11), .c(new_n47_), .d(x22), .O(z03));
  aoi22  g06(.a(new_n48_), .b(x12), .c(new_n47_), .d(x23), .O(z04));
  aoi22  g07(.a(new_n48_), .b(x13), .c(new_n47_), .d(x24), .O(z05));
  inv1   g08(.a(x14), .O(new_n55_));
  nand2  g09(.a(new_n48_), .b(new_n55_), .O(new_n56_));
  oai21  g10(.a(x27), .b(x25), .c(new_n56_), .O(z06));
  aoi22  g11(.a(new_n48_), .b(x15), .c(new_n47_), .d(x26), .O(z07));
  nand2  g12(.a(x27), .b(x02), .O(new_n59_));
  ...
  nor2   g36(.a(new_n82_), .b(new_n66_), .O(new_n83_));
  nand2  g37(.a(x18), .b(x02), .O(new_n84_));
  nand2  g38(.a(new_n61_), .b(x10), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(new_n84_), .c(new_n66_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n59_), .O(new_n87_));
  aoi21  g41(.a(new_n83_), .b(new_n79_), .c(new_n87_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n80_), .b(new_n70_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n80_), .b(new_n70_), .c(new_n89_), .O(new_n91_));
  ...
  nand4  g59(.a(new_n80_), .b(new_n70_), .c(new_n105_), .d(new_n89_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n80_), .c(new_n70_), .d(new_n89_), .O(new_n109_));
  ...
  aoi22  g74(.a(new_n120_), .b(new_n82_), .c(new_n109_), .d(x25), .O(new_n121_));
  inv1   g75(.a(x06), .O(new_n122_));
  nand2  g76(.a(x18), .b(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n61_), .b(new_n55_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n123_), .c(new_n60_), .O(new_n125_));
  oai21  g79(.a(new_n121_), .b(new_n66_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n120_), .b(new_n82_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand4  g82(.a(new_n118_), .b(new_n108_), .c(new_n80_), .d(new_n70_), .O(new_n129_));
  ...
  nand4  g89(.a(new_n80_), .b(new_n128_), .c(x19), .d(new_n65_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n119_), .c(new_n47_), .d(new_n65_), .O(new_n137_));
