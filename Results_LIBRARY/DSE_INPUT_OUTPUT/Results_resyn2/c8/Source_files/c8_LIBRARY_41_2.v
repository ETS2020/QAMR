...
module FAU ( 
  ...
  inv1   g71(.a(new_n111_), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n74_), .c(new_n79_), .d(x19), .O(new_n119_));
  nor2   g73(.a(new_n49_), .b(x17), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n119_), .c(new_n65_), .O(z17));
endmodule
