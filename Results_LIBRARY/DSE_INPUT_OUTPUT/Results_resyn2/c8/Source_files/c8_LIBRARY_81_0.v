...
module FAU ( 
  ...
  oai22  g07(.a(new_n53_), .b(x22), .c(new_n52_), .d(x11), .O(z03));
  oai22  g08(.a(new_n53_), .b(x23), .c(new_n52_), .d(x12), .O(z04));
  oai22  g09(.a(new_n53_), .b(x24), .c(new_n52_), .d(x13), .O(z05));
  ...
  aoi21  g42(.a(new_n78_), .b(new_n64_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n78_), .b(new_n64_), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n98_), .b(new_n78_), .c(new_n64_), .O(new_n99_));
  ...
  nand4  g88(.a(new_n126_), .b(new_n134_), .c(new_n106_), .d(new_n76_), .O(new_n135_));
  inv1   g89(.a(new_n135_), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n98_), .c(new_n75_), .d(x19), .O(new_n137_));
  oai21  g91(.a(x17), .b(new_n47_), .c(new_n52_), .O(new_n138_));
