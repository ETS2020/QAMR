...
module FAU ( 
  ...
  aoi21  g35(.a(new_n73_), .b(new_n80_), .c(new_n81_), .O(new_n82_));
  ...
  aoi21  g41(.a(new_n62_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g42(.a(new_n62_), .b(x02), .c(new_n88_), .O(new_n89_));
  ...
  aoi21  g50(.a(new_n62_), .b(new_n96_), .c(x16), .O(new_n97_));
  oai21  g51(.a(new_n62_), .b(x03), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g60(.a(new_n62_), .b(x04), .c(new_n106_), .O(new_n107_));
  ...
  nand4  g64(.a(new_n110_), .b(new_n83_), .c(new_n73_), .d(new_n91_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x16), .O(new_n113_));
  inv1   g67(.a(x13), .O(new_n114_));
  aoi21  g68(.a(new_n62_), .b(new_n114_), .c(x16), .O(new_n115_));
  oai21  g69(.a(new_n62_), .b(x05), .c(new_n115_), .O(new_n116_));
  aoi21  g70(.a(new_n116_), .b(new_n113_), .c(new_n57_), .O(z14));
  nand2  g71(.a(new_n111_), .b(x25), .O(new_n118_));
  nor2   g72(.a(x25), .b(x24), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n101_), .c(new_n83_), .d(new_n73_), .O(new_n120_));
  and2   g74(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n62_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n68_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n56_), .O(new_n125_));
  ...
  nand3  g82(.a(new_n128_), .b(new_n85_), .c(x26), .O(new_n129_));
  aoi21  g83(.a(new_n120_), .b(new_n59_), .c(new_n68_), .O(new_n130_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n57_), .O(z16));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n128_), .b(new_n83_), .c(new_n69_), .d(new_n59_), .O(new_n137_));
