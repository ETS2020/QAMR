...
module FAU ( 
  ...
  aoi21  g013(.a(new_n48_), .b(new_n59_), .c(x16), .O(new_n60_));
  oai21  g014(.a(new_n48_), .b(x00), .c(new_n60_), .O(new_n61_));
  nor2   g015(.a(x27), .b(x18), .O(new_n62_));
  ...
  aoi21  g040(.a(new_n48_), .b(new_n86_), .c(x16), .O(new_n87_));
  ...
  nor2   g044(.a(new_n62_), .b(new_n70_), .O(new_n91_));
  inv1   g045(.a(new_n91_), .O(new_n92_));
  aoi21  g046(.a(x27), .b(x11), .c(x18), .O(new_n93_));
  oai21  g047(.a(new_n48_), .b(x03), .c(new_n70_), .O(new_n94_));
  oai22  g048(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n90_), .O(z12));
  inv1   g049(.a(x12), .O(new_n96_));
  nand2  g050(.a(x18), .b(x04), .O(new_n97_));
  nand2  g051(.a(x27), .b(new_n48_), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n96_), .c(new_n97_), .O(new_n99_));
  ...
  nand2  g080(.a(x27), .b(x14), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  inv1   g082(.a(x06), .O(new_n129_));
  nand2  g083(.a(x18), .b(new_n129_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n128_), .c(new_n70_), .O(new_n131_));
  oai21  g085(.a(new_n126_), .b(new_n92_), .c(new_n131_), .O(z15));
  inv1   g086(.a(x15), .O(new_n133_));
  nand2  g087(.a(x18), .b(x07), .O(new_n134_));
  oai21  g088(.a(new_n98_), .b(new_n133_), .c(new_n134_), .O(new_n135_));
