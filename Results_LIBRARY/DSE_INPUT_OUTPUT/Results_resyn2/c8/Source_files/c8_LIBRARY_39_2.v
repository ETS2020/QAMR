...
module FAU ( 
  ...
  nand2  g40(.a(new_n58_), .b(x11), .O(new_n87_));
  nand3  g41(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nor2   g42(.a(x22), .b(x21), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n63_), .c(new_n68_), .O(new_n90_));
  nand2  g44(.a(new_n78_), .b(x22), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n90_), .c(x16), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n65_), .O(z12));
  inv1   g48(.a(x23), .O(new_n95_));
  xor2a  g49(.a(new_n90_), .b(new_n95_), .O(new_n96_));
  ...
  aoi21  g54(.a(new_n100_), .b(new_n97_), .c(new_n67_), .O(z13));
  nand3  g55(.a(new_n89_), .b(new_n70_), .c(new_n95_), .O(new_n102_));
  nand2  g56(.a(new_n63_), .b(new_n68_), .O(new_n103_));
  nor2   g57(.a(x24), .b(x23), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  ...
  oai21  g66(.a(new_n107_), .b(new_n85_), .c(new_n112_), .O(z14));
  oai21  g67(.a(new_n105_), .b(new_n103_), .c(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x22), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n104_), .c(new_n77_), .d(new_n63_), .O(new_n116_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n67_), .O(z16));
  inv1   g88(.a(x17), .O(new_n135_));
  inv1   g89(.a(new_n105_), .O(new_n136_));
