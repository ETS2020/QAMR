...
module FAU ( 
  ...
  nand2  g31(.a(new_n77_), .b(new_n74_), .O(z10));
  nand2  g32(.a(x18), .b(x02), .O(new_n79_));
  aoi21  g33(.a(new_n58_), .b(x10), .c(x16), .O(new_n80_));
  nand2  g34(.a(new_n72_), .b(x21), .O(new_n81_));
  nor2   g35(.a(x21), .b(x20), .O(new_n82_));
  aoi21  g36(.a(new_n82_), .b(new_n70_), .c(new_n64_), .O(new_n83_));
  aoi22  g37(.a(new_n83_), .b(new_n81_), .c(new_n80_), .d(new_n79_), .O(z11));
  inv1   g38(.a(x22), .O(new_n85_));
  aoi21  g39(.a(new_n82_), .b(new_n70_), .c(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n82_), .b(new_n70_), .c(new_n85_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n86_), .c(new_n65_), .O(new_n89_));
  ...
  nand2  g46(.a(new_n92_), .b(new_n89_), .O(z12));
  nand2  g47(.a(new_n87_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n82_), .c(new_n70_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n65_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n104_), .b(new_n95_), .c(new_n70_), .d(new_n69_), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n103_), .c(new_n47_), .O(new_n106_));
  ...
  nand2  g65(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n95_), .c(new_n82_), .d(new_n70_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n65_), .O(new_n116_));
  ...
  nand2  g73(.a(new_n119_), .b(new_n116_), .O(z15));
  ...
  nor2   g78(.a(new_n114_), .b(new_n124_), .O(new_n125_));
  nand2  g79(.a(new_n114_), .b(new_n124_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n65_), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n125_), .c(new_n123_), .O(z16));
  nand2  g82(.a(new_n104_), .b(new_n95_), .O(new_n129_));
  inv1   g83(.a(x25), .O(new_n130_));
  nand3  g84(.a(new_n124_), .b(new_n130_), .c(new_n69_), .O(new_n131_));
  nor4   g85(.a(new_n131_), .b(new_n129_), .c(new_n66_), .d(new_n64_), .O(z17));
endmodule
