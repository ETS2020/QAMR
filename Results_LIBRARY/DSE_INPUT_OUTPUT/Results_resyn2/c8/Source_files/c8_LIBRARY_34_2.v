...
module FAU ( 
  ...
  nand2  g11(.a(new_n50_), .b(x14), .O(new_n58_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n78_), .c(new_n69_), .O(new_n98_));
  ...
  oai21  g67(.a(new_n98_), .b(x24), .c(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n97_), .c(new_n78_), .d(new_n69_), .O(new_n116_));
  and2   g70(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g71(.a(x18), .b(x06), .O(new_n118_));
  nand2  g72(.a(new_n60_), .b(x14), .O(new_n119_));
  nand3  g73(.a(new_n119_), .b(new_n118_), .c(new_n65_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n58_), .O(new_n121_));
  aoi21  g75(.a(new_n117_), .b(new_n114_), .c(new_n121_), .O(z15));
  nand2  g76(.a(new_n115_), .b(new_n97_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n80_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  aoi21  g80(.a(new_n116_), .b(new_n126_), .c(new_n65_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  inv1   g82(.a(x15), .O(new_n129_));
  aoi21  g83(.a(new_n60_), .b(new_n129_), .c(x16), .O(new_n130_));
  oai21  g84(.a(new_n60_), .b(x07), .c(new_n130_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n59_), .O(z16));
  nand4  g86(.a(new_n78_), .b(new_n126_), .c(x19), .d(new_n64_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n123_), .c(new_n50_), .d(new_n64_), .O(new_n134_));
