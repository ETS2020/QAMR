...
module FAU ( 
  ...
  nand3  g51(.a(new_n81_), .b(new_n66_), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n81_), .b(new_n66_), .c(new_n96_), .d(new_n97_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n81_), .c(new_n66_), .d(new_n97_), .O(new_n108_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n81_), .d(new_n66_), .O(new_n119_));
  and2   g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n62_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n60_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n59_), .O(new_n124_));
  ...
  aoi21  g83(.a(new_n119_), .b(new_n129_), .c(new_n60_), .O(new_n130_));
  ...
  nand4  g92(.a(new_n138_), .b(new_n127_), .c(new_n81_), .d(new_n129_), .O(new_n139_));
