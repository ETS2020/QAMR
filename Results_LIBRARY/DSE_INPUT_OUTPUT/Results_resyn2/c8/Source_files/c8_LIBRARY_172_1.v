...
module FAU ( 
  ...
  nand3  g48(.a(new_n78_), .b(new_n68_), .c(new_n94_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n78_), .b(new_n68_), .c(new_n93_), .d(new_n94_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x24), .O(new_n103_));
  nor2   g57(.a(x24), .b(x23), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n78_), .c(new_n68_), .d(new_n94_), .O(new_n105_));
  ...
  nand2  g68(.a(new_n114_), .b(new_n104_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n80_), .c(new_n105_), .d(x25), .O(new_n117_));
  ...
  nand4  g79(.a(new_n114_), .b(new_n104_), .c(new_n78_), .d(new_n68_), .O(new_n126_));
  ...
  nand4  g87(.a(new_n78_), .b(new_n125_), .c(x19), .d(new_n63_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n115_), .c(new_n50_), .d(new_n63_), .O(new_n135_));
