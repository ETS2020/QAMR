...
module FAU ( 
  ...
  xor2a  g43(.a(new_n81_), .b(x22), .O(new_n90_));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n92_), .c(new_n60_), .O(new_n95_));
  oai21  g49(.a(new_n90_), .b(new_n69_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n80_), .b(new_n62_), .c(new_n97_), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n80_), .c(new_n62_), .O(new_n100_));
  ...
  aoi21  g60(.a(new_n106_), .b(new_n104_), .c(new_n60_), .O(new_n107_));
  oai21  g61(.a(new_n102_), .b(new_n69_), .c(new_n107_), .O(z13));
  ...
  nand4  g71(.a(new_n117_), .b(new_n99_), .c(new_n80_), .d(new_n62_), .O(new_n118_));
  and2   g72(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n64_), .b(x14), .O(new_n121_));
  ...
  oai21  g86(.a(new_n64_), .b(x07), .c(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n60_), .O(z16));
  inv1   g88(.a(x17), .O(new_n135_));
  inv1   g89(.a(x25), .O(new_n136_));
  nand4  g90(.a(new_n128_), .b(new_n136_), .c(new_n109_), .d(new_n78_), .O(new_n137_));
  inv1   g91(.a(new_n137_), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n99_), .c(new_n70_), .d(x19), .O(new_n139_));
  oai21  g93(.a(x17), .b(new_n47_), .c(new_n50_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  aoi21  g95(.a(new_n139_), .b(new_n135_), .c(new_n141_), .O(z17));
endmodule
