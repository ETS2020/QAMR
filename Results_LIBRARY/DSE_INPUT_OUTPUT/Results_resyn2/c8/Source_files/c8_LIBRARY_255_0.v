...
module FAU ( 
  ...
  oai21  g25(.a(new_n68_), .b(new_n48_), .c(new_n71_), .O(z10));
  inv1   g26(.a(x21), .O(new_n73_));
  aoi21  g27(.a(new_n64_), .b(new_n67_), .c(new_n73_), .O(new_n74_));
  inv1   g28(.a(x17), .O(new_n75_));
  inv1   g29(.a(x19), .O(new_n76_));
  nand4  g30(.a(new_n73_), .b(new_n67_), .c(new_n76_), .d(new_n75_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(new_n78_));
  oai21  g32(.a(new_n78_), .b(new_n74_), .c(x16), .O(new_n79_));
  inv1   g33(.a(x10), .O(new_n80_));
  aoi21  g34(.a(new_n60_), .b(new_n80_), .c(new_n61_), .O(new_n81_));
  oai21  g35(.a(new_n60_), .b(x02), .c(new_n81_), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n79_), .O(z11));
  xor2a  g37(.a(new_n77_), .b(x22), .O(new_n84_));
  inv1   g38(.a(x11), .O(new_n85_));
  nand2  g39(.a(x18), .b(x03), .O(new_n86_));
  oai21  g40(.a(x18), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  oai21  g41(.a(new_n87_), .b(new_n47_), .c(new_n48_), .O(new_n88_));
  oai21  g42(.a(new_n84_), .b(new_n48_), .c(new_n88_), .O(z12));
  inv1   g43(.a(x22), .O(new_n90_));
  nor2   g44(.a(x21), .b(x20), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n64_), .c(new_n90_), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(x23), .O(new_n93_));
  nor2   g47(.a(x23), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n91_), .c(new_n64_), .O(new_n95_));
  ...
  oai21  g54(.a(new_n100_), .b(new_n47_), .c(new_n48_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n97_), .O(z13));
  nand2  g56(.a(new_n95_), .b(x24), .O(new_n103_));
  nor2   g57(.a(x24), .b(x21), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n94_), .c(new_n64_), .d(new_n67_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x16), .O(new_n107_));
  inv1   g61(.a(x13), .O(new_n108_));
  aoi21  g62(.a(new_n60_), .b(new_n108_), .c(new_n61_), .O(new_n109_));
  oai21  g63(.a(new_n60_), .b(x05), .c(new_n109_), .O(new_n110_));
  ...
  aoi22  g70(.a(new_n116_), .b(new_n78_), .c(new_n105_), .d(x25), .O(new_n117_));
  ...
  oai21  g74(.a(new_n117_), .b(new_n48_), .c(new_n120_), .O(z15));
  inv1   g75(.a(x26), .O(new_n122_));
  nand3  g76(.a(new_n116_), .b(new_n78_), .c(new_n122_), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n94_), .c(new_n91_), .d(new_n64_), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(x26), .c(new_n48_), .O(new_n126_));
  nand2  g80(.a(x18), .b(x07), .O(new_n127_));
  aoi21  g81(.a(new_n60_), .b(x15), .c(new_n61_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n123_), .O(z16));
  nand2  g83(.a(new_n47_), .b(new_n48_), .O(new_n130_));
  nand2  g84(.a(x27), .b(x17), .O(new_n131_));
  nand4  g85(.a(new_n91_), .b(new_n122_), .c(x19), .d(new_n75_), .O(new_n132_));
  oai21  g86(.a(new_n132_), .b(new_n115_), .c(new_n131_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n130_), .O(z17));
endmodule
