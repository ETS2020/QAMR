...
module FAU ( 
  ...
  oai21  g25(.a(new_n71_), .b(new_n47_), .c(new_n48_), .O(new_n72_));
  oai21  g26(.a(new_n68_), .b(new_n48_), .c(new_n72_), .O(z10));
  inv1   g27(.a(x21), .O(new_n74_));
  aoi21  g28(.a(new_n64_), .b(new_n67_), .c(new_n74_), .O(new_n75_));
  inv1   g29(.a(x17), .O(new_n76_));
  inv1   g30(.a(x19), .O(new_n77_));
  nand4  g31(.a(new_n74_), .b(new_n67_), .c(new_n77_), .d(new_n76_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(new_n79_));
  oai21  g33(.a(new_n79_), .b(new_n75_), .c(x16), .O(new_n80_));
  inv1   g34(.a(x10), .O(new_n81_));
  aoi21  g35(.a(new_n60_), .b(new_n81_), .c(new_n61_), .O(new_n82_));
  oai21  g36(.a(new_n60_), .b(x02), .c(new_n82_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n80_), .O(z11));
  ...
  oai21  g42(.a(new_n88_), .b(new_n47_), .c(new_n48_), .O(new_n89_));
  oai21  g43(.a(new_n85_), .b(new_n48_), .c(new_n89_), .O(z12));
  inv1   g44(.a(x22), .O(new_n91_));
  nor2   g45(.a(x21), .b(x20), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n64_), .c(new_n91_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n92_), .c(new_n64_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x16), .O(new_n98_));
  inv1   g52(.a(x12), .O(new_n99_));
  aoi21  g53(.a(new_n60_), .b(new_n99_), .c(new_n61_), .O(new_n100_));
  ...
  nand4  g58(.a(new_n104_), .b(new_n95_), .c(new_n64_), .d(new_n67_), .O(new_n105_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n91_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n79_), .c(new_n105_), .d(x25), .O(new_n117_));
  ...
  nand3  g76(.a(new_n116_), .b(new_n79_), .c(new_n122_), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n95_), .c(new_n92_), .d(new_n64_), .O(new_n125_));
  ...
  nand4  g85(.a(new_n92_), .b(new_n122_), .c(x19), .d(new_n76_), .O(new_n132_));
