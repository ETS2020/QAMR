...
module FAU ( 
  ...
  nand4  g69(.a(new_n115_), .b(new_n105_), .c(new_n79_), .d(new_n69_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  aoi21  g71(.a(new_n106_), .b(x25), .c(new_n117_), .O(new_n118_));
  ...
  oai21  g77(.a(new_n118_), .b(new_n64_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand2  g79(.a(new_n117_), .b(new_n125_), .O(new_n126_));
  aoi21  g80(.a(new_n116_), .b(x26), .c(new_n64_), .O(new_n127_));
  inv1   g81(.a(new_n58_), .O(new_n128_));
  nand2  g82(.a(x18), .b(x07), .O(new_n129_));
  nand2  g83(.a(new_n59_), .b(x15), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n129_), .c(new_n64_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  aoi21  g86(.a(new_n127_), .b(new_n126_), .c(new_n132_), .O(z16));
  nand2  g87(.a(new_n115_), .b(new_n105_), .O(new_n134_));
  nand4  g88(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n63_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n134_), .c(new_n47_), .d(new_n63_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n128_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
