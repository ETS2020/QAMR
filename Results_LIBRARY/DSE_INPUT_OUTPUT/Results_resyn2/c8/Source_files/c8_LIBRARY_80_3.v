...
module FAU ( 
  ...
  nand2  g31(.a(new_n70_), .b(new_n77_), .O(new_n78_));
  nor2   g32(.a(x21), .b(x20), .O(new_n79_));
  aoi22  g33(.a(new_n79_), .b(new_n70_), .c(new_n78_), .d(x21), .O(new_n80_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n65_), .c(new_n85_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n79_), .b(new_n70_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n79_), .b(new_n70_), .c(new_n87_), .O(new_n89_));
  ...
  aoi21  g55(.a(new_n101_), .b(new_n98_), .c(new_n59_), .O(z13));
  nand4  g56(.a(new_n79_), .b(new_n70_), .c(new_n96_), .d(new_n87_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n79_), .c(new_n70_), .d(new_n87_), .O(new_n106_));
  ...
  nand2  g68(.a(new_n79_), .b(new_n70_), .O(new_n115_));
  nor2   g69(.a(x25), .b(x22), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n105_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  aoi21  g72(.a(new_n106_), .b(x25), .c(new_n118_), .O(new_n119_));
  ...
  nor3   g79(.a(new_n117_), .b(new_n115_), .c(new_n58_), .O(new_n126_));
  ...
  nand4  g87(.a(new_n79_), .b(new_n58_), .c(x19), .d(new_n64_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n117_), .c(new_n47_), .d(new_n64_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n69_), .O(z17));
endmodule
