...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n50_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n147_;
  nand2  g000(.a(x27), .b(x07), .O(new_n47_));
  ...
  aoi22  g008(.a(new_n50_), .b(x13), .c(new_n49_), .d(x24), .O(z05));
  aoi22  g009(.a(new_n50_), .b(x14), .c(new_n49_), .d(x25), .O(z06));
  aoi22  g010(.a(new_n50_), .b(x15), .c(new_n49_), .d(x26), .O(z07));
  nor2   g011(.a(new_n49_), .b(x07), .O(new_n58_));
  ...
  nor2   g026(.a(new_n66_), .b(x20), .O(new_n73_));
  ...
  aoi21  g033(.a(new_n79_), .b(new_n76_), .c(new_n58_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n74_), .O(z10));
  nand2  g035(.a(x18), .b(x02), .O(new_n82_));
  nand2  g036(.a(new_n78_), .b(x10), .O(new_n83_));
  nand3  g037(.a(new_n83_), .b(new_n82_), .c(new_n61_), .O(new_n84_));
  ...
  nand2  g044(.a(new_n90_), .b(new_n59_), .O(z11));
  inv1   g045(.a(x22), .O(new_n92_));
  aoi21  g046(.a(new_n87_), .b(new_n71_), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(new_n87_), .b(new_n71_), .c(new_n92_), .O(new_n94_));
  inv1   g048(.a(new_n94_), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n93_), .c(x16), .O(new_n96_));
  inv1   g050(.a(x11), .O(new_n97_));
  aoi21  g051(.a(new_n78_), .b(new_n97_), .c(x16), .O(new_n98_));
  oai21  g052(.a(new_n78_), .b(x03), .c(new_n98_), .O(new_n99_));
  aoi21  g053(.a(new_n99_), .b(new_n96_), .c(new_n58_), .O(z12));
  inv1   g054(.a(x12), .O(new_n101_));
  oai21  g055(.a(x18), .b(new_n101_), .c(new_n61_), .O(new_n102_));
  aoi21  g056(.a(x18), .b(x04), .c(new_n102_), .O(new_n103_));
  nor2   g057(.a(x23), .b(x22), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n87_), .c(new_n71_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x16), .O(new_n106_));
  aoi21  g060(.a(new_n94_), .b(x23), .c(new_n106_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n103_), .c(new_n59_), .O(z13));
  nand2  g062(.a(new_n105_), .b(x24), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nor2   g064(.a(x24), .b(x23), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n110_), .c(new_n71_), .d(new_n70_), .O(new_n112_));
  ...
  nand4  g076(.a(new_n122_), .b(new_n104_), .c(new_n87_), .d(new_n71_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  inv1   g079(.a(x14), .O(new_n126_));
  aoi21  g080(.a(new_n78_), .b(new_n126_), .c(x16), .O(new_n127_));
  oai21  g081(.a(new_n78_), .b(x06), .c(new_n127_), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(new_n125_), .c(new_n58_), .O(z15));
  inv1   g083(.a(x26), .O(new_n130_));
  nand3  g084(.a(new_n122_), .b(new_n104_), .c(new_n130_), .O(new_n131_));
  nor2   g085(.a(new_n131_), .b(new_n88_), .O(new_n132_));
  aoi21  g086(.a(new_n123_), .b(x26), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n59_), .b(x16), .O(new_n134_));
  nor2   g088(.a(x27), .b(x18), .O(new_n135_));
  inv1   g089(.a(x15), .O(new_n136_));
  aoi21  g090(.a(new_n78_), .b(new_n136_), .c(x16), .O(new_n137_));
  oai21  g091(.a(new_n135_), .b(x07), .c(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n134_), .b(new_n133_), .c(new_n138_), .O(z16));
  nand3  g093(.a(new_n87_), .b(x19), .c(new_n64_), .O(new_n140_));
  oai22  g094(.a(new_n140_), .b(new_n131_), .c(new_n49_), .d(new_n64_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x07), .O(new_n142_));
  nor2   g096(.a(new_n65_), .b(x17), .O(new_n143_));
  inv1   g097(.a(x25), .O(new_n144_));
  nand4  g098(.a(new_n49_), .b(new_n130_), .c(new_n144_), .d(new_n70_), .O(new_n145_));
  inv1   g099(.a(new_n145_), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n143_), .c(new_n111_), .d(new_n110_), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(new_n142_), .c(new_n61_), .O(z17));
