...
module FAU ( 
  ...
  oai22  g11(.a(new_n52_), .b(x26), .c(new_n51_), .d(x15), .O(z07));
  ...
  nand3  g49(.a(new_n80_), .b(new_n70_), .c(new_n95_), .O(new_n96_));
  xnor2a g50(.a(new_n96_), .b(x23), .O(new_n97_));
  ...
  oai21  g56(.a(new_n96_), .b(x23), .c(x24), .O(new_n103_));
  inv1   g57(.a(new_n96_), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n80_), .d(new_n70_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  inv1   g72(.a(new_n59_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n60_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n65_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  aoi21  g77(.a(new_n118_), .b(new_n115_), .c(new_n123_), .O(z15));
  nor2   g78(.a(new_n117_), .b(x26), .O(new_n125_));
  nand2  g79(.a(new_n117_), .b(x26), .O(new_n126_));
  ...
  nand2  g85(.a(new_n131_), .b(new_n119_), .O(z16));
  nand2  g86(.a(new_n116_), .b(new_n105_), .O(new_n133_));
  inv1   g87(.a(x26), .O(new_n134_));
  nand4  g88(.a(new_n80_), .b(new_n134_), .c(x19), .d(new_n64_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n133_), .c(new_n51_), .d(new_n64_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n119_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
