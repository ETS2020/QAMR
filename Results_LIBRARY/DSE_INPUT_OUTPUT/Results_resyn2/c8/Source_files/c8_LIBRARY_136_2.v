...
module FAU ( 
  ...
  nand2  g33(.a(new_n79_), .b(new_n59_), .O(new_n80_));
  and2   g34(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  aoi22  g35(.a(new_n81_), .b(new_n78_), .c(new_n77_), .d(new_n76_), .O(z11));
  nand2  g36(.a(x18), .b(x03), .O(new_n83_));
  aoi21  g37(.a(new_n64_), .b(x11), .c(x16), .O(new_n84_));
  inv1   g38(.a(x22), .O(new_n85_));
  nand3  g39(.a(new_n79_), .b(new_n59_), .c(new_n85_), .O(new_n86_));
  aoi21  g40(.a(new_n80_), .b(x22), .c(new_n63_), .O(new_n87_));
  aoi22  g41(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n83_), .O(z12));
  nor2   g42(.a(x23), .b(x22), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n79_), .c(new_n59_), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(x27), .O(new_n91_));
  aoi21  g45(.a(new_n86_), .b(x23), .c(new_n91_), .O(new_n92_));
  inv1   g46(.a(x12), .O(new_n93_));
  aoi21  g47(.a(new_n64_), .b(new_n93_), .c(x16), .O(new_n94_));
  oai21  g48(.a(new_n64_), .b(x04), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n92_), .b(new_n61_), .c(new_n95_), .O(z13));
  nand2  g50(.a(new_n90_), .b(x24), .O(new_n97_));
  nor2   g51(.a(x24), .b(x21), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n89_), .c(new_n59_), .d(new_n68_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n62_), .O(new_n101_));
  inv1   g55(.a(x13), .O(new_n102_));
  aoi21  g56(.a(new_n64_), .b(new_n102_), .c(x16), .O(new_n103_));
  oai21  g57(.a(new_n64_), .b(x05), .c(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n101_), .O(z14));
  nand2  g59(.a(new_n99_), .b(x25), .O(new_n106_));
  nor2   g60(.a(x25), .b(x24), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n89_), .c(new_n79_), .d(new_n59_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n62_), .O(new_n110_));
  inv1   g64(.a(x14), .O(new_n111_));
  aoi21  g65(.a(new_n64_), .b(new_n111_), .c(x16), .O(new_n112_));
  oai21  g66(.a(new_n64_), .b(x06), .c(new_n112_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n110_), .O(z15));
  inv1   g68(.a(new_n86_), .O(new_n115_));
  nor2   g69(.a(x26), .b(x23), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n107_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  aoi22  g72(.a(new_n118_), .b(new_n115_), .c(new_n108_), .d(x26), .O(new_n119_));
  inv1   g73(.a(x15), .O(new_n120_));
  aoi21  g74(.a(new_n64_), .b(new_n120_), .c(x16), .O(new_n121_));
  oai21  g75(.a(new_n64_), .b(x07), .c(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n119_), .b(new_n63_), .c(new_n122_), .O(z16));
  inv1   g77(.a(x17), .O(new_n124_));
  nand4  g78(.a(new_n118_), .b(new_n79_), .c(new_n85_), .d(x19), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n124_), .c(new_n63_), .O(z17));
  buf    g80(.a(x27), .O(z08));
endmodule
