...
module FAU ( 
  ...
  oai21  g48(.a(new_n89_), .b(new_n61_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x22), .O(new_n96_));
  nand3  g50(.a(new_n81_), .b(new_n67_), .c(new_n96_), .O(new_n97_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n117_), .c(new_n99_), .d(new_n81_), .O(new_n138_));
  nand2  g92(.a(x27), .b(x17), .O(new_n139_));
  nand2  g93(.a(new_n60_), .b(x16), .O(new_n140_));
