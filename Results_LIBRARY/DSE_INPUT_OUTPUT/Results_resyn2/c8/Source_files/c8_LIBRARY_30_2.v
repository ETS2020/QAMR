...
module FAU ( 
  ...
  nor2   g01(.a(x27), .b(x03), .O(new_n48_));
  ...
  nand2  g31(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  oai21  g32(.a(new_n70_), .b(new_n76_), .c(new_n78_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(x16), .O(new_n80_));
  ...
  aoi22  g40(.a(new_n86_), .b(new_n70_), .c(new_n78_), .d(x22), .O(new_n87_));
  nand2  g41(.a(x18), .b(new_n58_), .O(new_n88_));
  ...
  oai21  g45(.a(new_n87_), .b(new_n85_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x23), .O(new_n93_));
  nand3  g47(.a(new_n86_), .b(new_n61_), .c(new_n68_), .O(new_n94_));
  xor2a  g48(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(x16), .O(new_n96_));
  inv1   g50(.a(x12), .O(new_n97_));
  aoi21  g51(.a(new_n63_), .b(new_n97_), .c(x16), .O(new_n98_));
  oai21  g52(.a(new_n63_), .b(x04), .c(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n99_), .b(new_n96_), .c(new_n59_), .O(z13));
  nand3  g54(.a(new_n86_), .b(new_n70_), .c(new_n93_), .O(new_n101_));
  nand2  g55(.a(new_n61_), .b(new_n68_), .O(new_n102_));
  nor2   g56(.a(x24), .b(x23), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n86_), .O(new_n104_));
  nor2   g58(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  aoi21  g59(.a(new_n101_), .b(x24), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g64(.a(new_n110_), .b(new_n108_), .c(new_n59_), .O(new_n111_));
  oai21  g65(.a(new_n106_), .b(new_n85_), .c(new_n111_), .O(z14));
  oai21  g66(.a(new_n104_), .b(new_n102_), .c(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x22), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n103_), .c(new_n77_), .d(new_n61_), .O(new_n115_));
  ...
  aoi21  g74(.a(new_n63_), .b(new_n120_), .c(x16), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n59_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n117_), .O(z15));
  inv1   g77(.a(new_n78_), .O(new_n124_));
  nand2  g78(.a(new_n114_), .b(new_n103_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n124_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  aoi21  g82(.a(new_n115_), .b(new_n128_), .c(new_n85_), .O(new_n129_));
  ...
  inv1   g89(.a(new_n104_), .O(new_n136_));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n68_), .d(x19), .O(new_n138_));
  nor2   g92(.a(x17), .b(x03), .O(new_n139_));
