...
module FAU ( 
  ...
  nand2  g01(.a(x27), .b(x13), .O(new_n48_));
  ...
  aoi22  g07(.a(new_n49_), .b(x12), .c(new_n47_), .d(x23), .O(z04));
  nor2   g08(.a(x27), .b(x24), .O(z05));
  ...
  nor2   g18(.a(new_n47_), .b(x13), .O(new_n65_));
  ...
  aoi21  g31(.a(new_n63_), .b(new_n69_), .c(new_n77_), .O(new_n78_));
  ...
  oai21  g38(.a(new_n58_), .b(x02), .c(new_n84_), .O(new_n85_));
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n65_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n79_), .b(new_n63_), .c(new_n87_), .O(new_n88_));
  nor2   g42(.a(x22), .b(x21), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n63_), .c(new_n69_), .O(new_n90_));
  ...
  aoi21  g54(.a(new_n58_), .b(new_n100_), .c(x16), .O(new_n101_));
  oai21  g55(.a(new_n58_), .b(x04), .c(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n102_), .b(new_n99_), .c(new_n65_), .O(z13));
  oai21  g57(.a(new_n90_), .b(x23), .c(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n89_), .c(new_n63_), .d(new_n69_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(x16), .O(new_n107_));
  nand2  g61(.a(x18), .b(x05), .O(new_n108_));
  nand2  g62(.a(new_n58_), .b(x13), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n108_), .c(new_n68_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n66_), .O(new_n111_));
  aoi21  g65(.a(new_n107_), .b(new_n104_), .c(new_n111_), .O(z14));
  nand2  g66(.a(new_n106_), .b(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x22), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n105_), .c(new_n79_), .d(new_n63_), .O(new_n115_));
  and2   g69(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g70(.a(x18), .b(x06), .O(new_n117_));
  nand2  g71(.a(new_n58_), .b(x14), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n117_), .c(new_n68_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n66_), .O(new_n120_));
  aoi21  g74(.a(new_n116_), .b(new_n113_), .c(new_n120_), .O(z15));
  nand2  g75(.a(new_n114_), .b(new_n105_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n81_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  aoi21  g79(.a(new_n115_), .b(new_n125_), .c(new_n68_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  inv1   g81(.a(x15), .O(new_n128_));
  aoi21  g82(.a(new_n58_), .b(new_n128_), .c(x16), .O(new_n129_));
  oai21  g83(.a(new_n58_), .b(x07), .c(new_n129_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n127_), .c(new_n65_), .O(z16));
  inv1   g85(.a(x17), .O(new_n132_));
  nand4  g86(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n132_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n122_), .c(new_n47_), .d(new_n132_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n66_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
