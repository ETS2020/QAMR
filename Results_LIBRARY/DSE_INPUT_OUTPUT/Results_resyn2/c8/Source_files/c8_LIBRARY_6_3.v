...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x06), .O(z08));
  ...
  nand2  g11(.a(x27), .b(x06), .O(new_n58_));
  ...
  nand3  g30(.a(new_n76_), .b(new_n73_), .c(new_n58_), .O(z10));
  ...
  oai21  g74(.a(new_n60_), .b(x16), .c(new_n47_), .O(new_n121_));
  nand3  g75(.a(new_n60_), .b(new_n66_), .c(x14), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n121_), .b(x06), .c(new_n123_), .O(new_n124_));
  oai21  g78(.a(new_n120_), .b(new_n66_), .c(new_n124_), .O(z15));
  nand3  g79(.a(new_n119_), .b(new_n83_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n117_), .b(new_n107_), .c(new_n81_), .d(new_n71_), .O(new_n128_));
  ...
  nand4  g89(.a(new_n119_), .b(new_n81_), .c(new_n67_), .d(new_n127_), .O(new_n136_));
  nand2  g90(.a(new_n58_), .b(x16), .O(new_n137_));
