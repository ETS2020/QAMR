...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x00), .O(new_n48_));
  ...
  nor2   g15(.a(new_n47_), .b(new_n58_), .O(new_n62_));
  ...
  oai21  g29(.a(new_n59_), .b(x01), .c(new_n75_), .O(new_n76_));
  nand3  g30(.a(new_n76_), .b(new_n73_), .c(new_n63_), .O(z10));
  inv1   g31(.a(x16), .O(new_n78_));
  inv1   g32(.a(x20), .O(new_n79_));
  nand2  g33(.a(new_n71_), .b(new_n79_), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  aoi22  g35(.a(new_n81_), .b(new_n71_), .c(new_n80_), .d(x21), .O(new_n82_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n78_), .c(new_n87_), .O(z11));
  ...
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n62_), .O(z12));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n62_), .O(z13));
  ...
  aoi21  g65(.a(new_n111_), .b(new_n109_), .c(new_n62_), .O(new_n112_));
  oai21  g66(.a(new_n107_), .b(new_n78_), .c(new_n112_), .O(z14));
  inv1   g67(.a(x24), .O(new_n114_));
  nand4  g68(.a(new_n99_), .b(new_n81_), .c(new_n71_), .d(new_n114_), .O(new_n115_));
  nand2  g69(.a(new_n81_), .b(new_n71_), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n99_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  aoi21  g73(.a(new_n115_), .b(x25), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g79(.a(new_n120_), .b(new_n78_), .c(new_n125_), .O(z15));
  inv1   g80(.a(x26), .O(new_n127_));
  nor3   g81(.a(new_n118_), .b(new_n116_), .c(new_n127_), .O(new_n128_));
  oai21  g82(.a(new_n119_), .b(x26), .c(x16), .O(new_n129_));
  ...
  inv1   g90(.a(new_n118_), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n81_), .c(new_n65_), .d(new_n127_), .O(new_n138_));
  nand2  g92(.a(new_n63_), .b(x16), .O(new_n139_));
