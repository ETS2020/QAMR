...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n48_, new_n51_, new_n58_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  aoi22  g07(.a(z08), .b(x12), .c(new_n51_), .d(x23), .O(z04));
  ...
  nor2   g15(.a(new_n51_), .b(x08), .O(new_n62_));
  ...
  oai21  g68(.a(new_n58_), .b(x05), .c(new_n114_), .O(new_n115_));
  aoi21  g69(.a(new_n115_), .b(new_n112_), .c(new_n62_), .O(z14));
  ...
  oai21  g88(.a(new_n58_), .b(x07), .c(new_n134_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n62_), .O(z16));
  ...
  nand2  g93(.a(new_n139_), .b(x08), .O(new_n140_));
  nor2   g94(.a(new_n66_), .b(x17), .O(new_n141_));
  inv1   g95(.a(x25), .O(new_n142_));
  nand4  g96(.a(new_n51_), .b(new_n130_), .c(new_n142_), .d(new_n70_), .O(new_n143_));
