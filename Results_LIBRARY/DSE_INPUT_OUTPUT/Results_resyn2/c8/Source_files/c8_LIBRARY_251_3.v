...
module FAU ( 
  ...
  nand3  g52(.a(new_n98_), .b(new_n78_), .c(new_n69_), .O(new_n99_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n98_), .c(new_n78_), .d(new_n69_), .O(new_n115_));
  ...
  nand3  g77(.a(new_n123_), .b(new_n80_), .c(x26), .O(new_n124_));
