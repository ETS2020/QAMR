...
module FAU ( 
  ...
  nor2   g12(.a(x27), .b(x13), .O(new_n59_));
  ...
  nand2  g25(.a(new_n63_), .b(new_n70_), .O(new_n72_));
  ...
  oai21  g30(.a(new_n65_), .b(x01), .c(new_n76_), .O(new_n77_));
  ...
  aoi22  g44(.a(new_n90_), .b(new_n73_), .c(new_n81_), .d(x22), .O(new_n91_));
  ...
  nand3  g52(.a(new_n90_), .b(new_n63_), .c(new_n70_), .O(new_n99_));
  xor2a  g53(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n107_), .b(new_n90_), .c(new_n63_), .d(new_n70_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g63(.a(x18), .b(x05), .O(new_n110_));
  nand2  g64(.a(new_n65_), .b(x13), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(new_n112_));
  oai21  g66(.a(x27), .b(x13), .c(new_n112_), .O(new_n113_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n107_), .c(new_n80_), .d(new_n63_), .O(new_n117_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n107_), .d(new_n90_), .O(new_n138_));
