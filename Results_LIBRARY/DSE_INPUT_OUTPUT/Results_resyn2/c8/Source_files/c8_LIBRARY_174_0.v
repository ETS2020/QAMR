...
module FAU ( 
  ...
  nor2   g21(.a(x27), .b(x02), .O(new_n68_));
  ...
  nand2  g37(.a(x18), .b(new_n48_), .O(new_n84_));
  ...
  nand3  g44(.a(new_n90_), .b(new_n66_), .c(new_n71_), .O(new_n91_));
  ...
  nand3  g77(.a(new_n66_), .b(new_n123_), .c(new_n71_), .O(new_n124_));
  ...
  nand2  g81(.a(new_n59_), .b(x14), .O(new_n128_));
  ...
  oai21  g97(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(x16), .O(new_n145_));
  aoi21  g99(.a(new_n143_), .b(new_n63_), .c(new_n145_), .O(z17));
endmodule
