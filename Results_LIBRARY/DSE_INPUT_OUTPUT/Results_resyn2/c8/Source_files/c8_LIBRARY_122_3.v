...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x13), .O(new_n48_));
  ...
  nand2  g08(.a(x27), .b(x13), .O(new_n55_));
  inv1   g09(.a(new_n55_), .O(new_n56_));
  aoi21  g10(.a(new_n47_), .b(x24), .c(new_n56_), .O(z05));
  ...
  aoi21  g21(.a(new_n67_), .b(new_n63_), .c(new_n56_), .O(z09));
  ...
  nand3  g28(.a(new_n74_), .b(new_n71_), .c(new_n55_), .O(z10));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n83_), .c(new_n56_), .O(new_n86_));
  ...
  aoi21  g46(.a(new_n92_), .b(new_n90_), .c(new_n56_), .O(new_n93_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n99_), .c(new_n56_), .O(z13));
  ...
  nand2  g62(.a(new_n60_), .b(x13), .O(new_n109_));
  ...
  nor2   g66(.a(x25), .b(x22), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n105_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n80_), .c(new_n106_), .d(x25), .O(new_n116_));
  ...
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n56_), .O(new_n121_));
  oai21  g75(.a(new_n116_), .b(new_n65_), .c(new_n121_), .O(z15));
  nand3  g76(.a(new_n115_), .b(new_n80_), .c(x26), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  nand4  g78(.a(new_n113_), .b(new_n105_), .c(new_n78_), .d(new_n69_), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n124_), .c(new_n65_), .O(new_n126_));
  ...
  aoi21  g84(.a(new_n130_), .b(new_n127_), .c(new_n56_), .O(z16));
  nand4  g85(.a(new_n78_), .b(new_n124_), .c(x19), .d(new_n64_), .O(new_n132_));
  oai22  g86(.a(new_n132_), .b(new_n114_), .c(new_n47_), .d(new_n64_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n55_), .O(z17));
  buf    g89(.a(x27), .O(z08));
endmodule
