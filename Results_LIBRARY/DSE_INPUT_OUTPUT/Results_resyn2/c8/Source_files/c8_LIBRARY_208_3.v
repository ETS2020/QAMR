...
module FAU ( 
  ...
  aoi21  g008(.a(new_n53_), .b(new_n54_), .c(new_n50_), .O(new_n55_));
  oai21  g009(.a(new_n53_), .b(x09), .c(new_n55_), .O(z01));
  inv1   g010(.a(x10), .O(new_n57_));
  aoi21  g011(.a(new_n53_), .b(x21), .c(new_n50_), .O(new_n58_));
  oai21  g012(.a(new_n53_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  inv1   g013(.a(new_n59_), .O(z02));
  inv1   g014(.a(x11), .O(new_n61_));
  aoi21  g015(.a(new_n53_), .b(x22), .c(new_n50_), .O(new_n62_));
  oai21  g016(.a(new_n53_), .b(new_n61_), .c(new_n62_), .O(new_n63_));
  inv1   g017(.a(new_n63_), .O(z03));
  inv1   g018(.a(x12), .O(new_n65_));
  aoi21  g019(.a(new_n53_), .b(x23), .c(new_n50_), .O(new_n66_));
  oai21  g020(.a(new_n53_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  inv1   g021(.a(new_n67_), .O(z04));
  inv1   g022(.a(x24), .O(new_n69_));
  aoi21  g023(.a(new_n53_), .b(new_n69_), .c(new_n50_), .O(new_n70_));
  oai21  g024(.a(new_n53_), .b(x13), .c(new_n70_), .O(z05));
  inv1   g025(.a(x25), .O(new_n72_));
  aoi21  g026(.a(new_n53_), .b(new_n72_), .c(new_n50_), .O(new_n73_));
  oai21  g027(.a(new_n53_), .b(x14), .c(new_n73_), .O(z06));
  inv1   g028(.a(x26), .O(new_n75_));
  aoi21  g029(.a(new_n53_), .b(new_n75_), .c(new_n50_), .O(new_n76_));
  oai21  g030(.a(new_n53_), .b(x15), .c(new_n76_), .O(z07));
  nor2   g031(.a(new_n50_), .b(new_n53_), .O(z08));
  inv1   g032(.a(new_n50_), .O(new_n79_));
  inv1   g033(.a(x17), .O(new_n80_));
  inv1   g034(.a(x16), .O(new_n81_));
  nor2   g035(.a(new_n49_), .b(x17), .O(new_n82_));
  nor2   g036(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  oai21  g037(.a(x19), .b(new_n80_), .c(new_n83_), .O(new_n84_));
  inv1   g038(.a(x18), .O(new_n85_));
  aoi21  g039(.a(new_n85_), .b(new_n47_), .c(x16), .O(new_n86_));
  oai21  g040(.a(new_n85_), .b(x00), .c(new_n86_), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n84_), .c(new_n79_), .O(z09));
  nor2   g042(.a(new_n54_), .b(new_n80_), .O(new_n89_));
  nor3   g043(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  oai21  g044(.a(new_n90_), .b(new_n89_), .c(x16), .O(new_n91_));
  oai21  g045(.a(new_n54_), .b(new_n81_), .c(new_n48_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(x19), .O(new_n93_));
  inv1   g047(.a(x09), .O(new_n94_));
  aoi21  g048(.a(new_n85_), .b(new_n94_), .c(x16), .O(new_n95_));
  oai21  g049(.a(new_n85_), .b(x01), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n93_), .c(new_n91_), .O(z10));
  oai21  g051(.a(x20), .b(x17), .c(x21), .O(new_n98_));
  inv1   g052(.a(x21), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n54_), .c(new_n80_), .O(new_n100_));
  aoi21  g054(.a(new_n100_), .b(new_n98_), .c(x19), .O(new_n101_));
  nor2   g055(.a(new_n49_), .b(x14), .O(new_n102_));
  ...
  nand2  g060(.a(new_n85_), .b(new_n57_), .O(new_n107_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n112_), .c(new_n80_), .O(new_n114_));
  nor2   g068(.a(new_n114_), .b(x19), .O(new_n115_));
  aoi21  g069(.a(new_n100_), .b(x22), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(x22), .b(x16), .O(new_n117_));
  aoi21  g071(.a(new_n117_), .b(new_n48_), .c(new_n49_), .O(new_n118_));
  inv1   g072(.a(x03), .O(new_n119_));
  nand2  g073(.a(x18), .b(new_n119_), .O(new_n120_));
  aoi21  g074(.a(new_n85_), .b(new_n61_), .c(x16), .O(new_n121_));
  aoi21  g075(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(new_n122_));
  oai21  g076(.a(new_n116_), .b(new_n81_), .c(new_n122_), .O(z12));
  nand2  g077(.a(new_n114_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n113_), .c(new_n80_), .O(new_n126_));
  ...
  nand2  g084(.a(new_n85_), .b(new_n65_), .O(new_n131_));
  ...
  nand2  g098(.a(new_n85_), .b(new_n144_), .O(new_n145_));
  ...
  nand3  g104(.a(new_n69_), .b(new_n150_), .c(new_n112_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n100_), .c(x25), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n125_), .c(new_n113_), .d(new_n80_), .O(new_n154_));
  ...
  nand2  g112(.a(new_n85_), .b(new_n48_), .O(new_n159_));
  inv1   g113(.a(x06), .O(new_n160_));
  nand2  g114(.a(x18), .b(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n159_), .c(new_n106_), .O(new_n162_));
  ...
  nand2  g125(.a(new_n85_), .b(new_n171_), .O(new_n172_));
  ...
  nand4  g131(.a(new_n177_), .b(new_n138_), .c(new_n113_), .d(new_n82_), .O(new_n178_));
