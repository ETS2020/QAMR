...
module FAU ( 
  ...
  aoi22  g10(.a(new_n48_), .b(x25), .c(x27), .d(x14), .O(z06));
  ...
  nor2   g21(.a(x27), .b(x05), .O(new_n68_));
  ...
  xor2a  g26(.a(new_n66_), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g33(.a(x18), .b(x02), .O(new_n80_));
  nand2  g34(.a(new_n59_), .b(x10), .O(new_n81_));
  nand3  g35(.a(new_n81_), .b(new_n80_), .c(new_n71_), .O(new_n82_));
  inv1   g36(.a(x21), .O(new_n83_));
  aoi21  g37(.a(new_n66_), .b(new_n72_), .c(new_n83_), .O(new_n84_));
  nor2   g38(.a(x21), .b(x20), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n66_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(x16), .O(new_n87_));
  oai21  g41(.a(new_n87_), .b(new_n84_), .c(new_n82_), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n69_), .O(z11));
  inv1   g43(.a(x22), .O(new_n90_));
  aoi21  g44(.a(new_n85_), .b(new_n66_), .c(new_n90_), .O(new_n91_));
  nor2   g45(.a(x22), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n66_), .c(new_n72_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n91_), .c(x16), .O(new_n95_));
  ...
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n68_), .O(z16));
  nor2   g91(.a(x20), .b(new_n64_), .O(new_n138_));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n138_), .c(new_n109_), .d(new_n92_), .O(new_n140_));
  oai21  g94(.a(x17), .b(new_n47_), .c(new_n50_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  aoi21  g96(.a(new_n140_), .b(new_n63_), .c(new_n142_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
