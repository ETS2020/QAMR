...
module FAU ( 
  ...
  aoi22  g05(.a(new_n49_), .b(x09), .c(new_n48_), .d(x20), .O(z01));
  oai22  g06(.a(new_n50_), .b(x10), .c(x27), .d(x21), .O(z02));
  aoi22  g07(.a(new_n49_), .b(x11), .c(new_n48_), .d(x22), .O(z03));
  ...
  aoi22  g11(.a(new_n49_), .b(x15), .c(new_n48_), .d(x26), .O(z07));
  inv1   g12(.a(x08), .O(new_n59_));
  aoi21  g13(.a(new_n47_), .b(new_n59_), .c(x16), .O(new_n60_));
  oai21  g14(.a(new_n47_), .b(x00), .c(new_n60_), .O(new_n61_));
  nor2   g15(.a(new_n48_), .b(x18), .O(new_n62_));
  ...
  nor2   g28(.a(new_n62_), .b(new_n74_), .O(new_n75_));
  inv1   g29(.a(new_n75_), .O(new_n76_));
  oai22  g30(.a(new_n76_), .b(new_n73_), .c(new_n71_), .d(x16), .O(z10));
  nand2  g31(.a(x18), .b(x02), .O(new_n78_));
  nand2  g32(.a(new_n70_), .b(x10), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g34(.a(new_n80_), .b(new_n74_), .O(new_n81_));
  inv1   g35(.a(x21), .O(new_n82_));
  aoi21  g36(.a(new_n67_), .b(new_n72_), .c(new_n82_), .O(new_n83_));
  nand4  g37(.a(new_n82_), .b(new_n72_), .c(new_n65_), .d(new_n64_), .O(new_n84_));
  inv1   g38(.a(new_n84_), .O(new_n85_));
  nor2   g39(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n76_), .c(new_n81_), .O(z11));
  nand2  g41(.a(x18), .b(x03), .O(new_n88_));
  nand2  g42(.a(new_n70_), .b(x11), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n74_), .O(new_n91_));
  xor2a  g45(.a(new_n84_), .b(x22), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n76_), .c(new_n91_), .O(z12));
  nand2  g47(.a(x18), .b(x04), .O(new_n94_));
  nand2  g48(.a(new_n70_), .b(x12), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n74_), .O(new_n97_));
  ...
  nand2  g61(.a(new_n70_), .b(x13), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n74_), .O(new_n110_));
  nand2  g64(.a(new_n103_), .b(x24), .O(new_n111_));
  nor2   g65(.a(x24), .b(x21), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n102_), .c(new_n67_), .d(new_n72_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n75_), .O(new_n115_));
  ...
  aoi22  g75(.a(new_n121_), .b(new_n85_), .c(new_n113_), .d(x25), .O(new_n122_));
  inv1   g76(.a(x06), .O(new_n123_));
  nand2  g77(.a(x18), .b(new_n123_), .O(new_n124_));
  inv1   g78(.a(x14), .O(new_n125_));
  aoi21  g79(.a(new_n47_), .b(new_n125_), .c(x16), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n124_), .c(new_n62_), .O(new_n127_));
  oai21  g81(.a(new_n122_), .b(new_n74_), .c(new_n127_), .O(z15));
  nand2  g82(.a(x18), .b(x07), .O(new_n129_));
  nand2  g83(.a(new_n70_), .b(x15), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n74_), .O(new_n132_));
  ...
  nand2  g91(.a(new_n137_), .b(new_n75_), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(new_n136_), .c(new_n132_), .O(z16));
  nand2  g93(.a(new_n49_), .b(x17), .O(new_n140_));
  nand3  g94(.a(new_n133_), .b(x19), .c(new_n64_), .O(new_n141_));
  inv1   g95(.a(new_n141_), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n121_), .c(new_n99_), .d(new_n63_), .O(new_n143_));
  aoi21  g97(.a(new_n143_), .b(new_n140_), .c(new_n74_), .O(z17));
  buf    g98(.a(x27), .O(z08));
endmodule
