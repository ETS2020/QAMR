...
module FAU ( 
  ...
  aoi22  g09(.a(z08), .b(x14), .c(new_n51_), .d(x25), .O(z06));
  aoi22  g10(.a(z08), .b(x15), .c(new_n51_), .d(x26), .O(z07));
  ...
  nand3  g80(.a(new_n118_), .b(new_n77_), .c(new_n126_), .O(new_n127_));
  nor2   g81(.a(x25), .b(x24), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n93_), .c(new_n88_), .d(new_n61_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(x26), .c(new_n68_), .O(new_n130_));
  nand2  g84(.a(x18), .b(x07), .O(new_n131_));
  nand2  g85(.a(new_n63_), .b(x15), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n131_), .c(new_n65_), .O(new_n133_));
  inv1   g87(.a(new_n133_), .O(new_n134_));
  aoi21  g88(.a(new_n130_), .b(new_n127_), .c(new_n134_), .O(z16));
  nor2   g89(.a(x17), .b(new_n68_), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n88_), .c(new_n126_), .d(x19), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n117_), .c(new_n136_), .d(new_n51_), .O(z17));
endmodule
