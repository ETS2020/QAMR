...
module FAU ( 
  ...
  nand2  g29(.a(new_n68_), .b(new_n75_), .O(new_n76_));
  nor2   g30(.a(x21), .b(x20), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(new_n68_), .O(new_n78_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n64_), .c(new_n85_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n77_), .b(new_n68_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n77_), .b(new_n68_), .c(new_n87_), .O(new_n89_));
  ...
  oai21  g47(.a(new_n59_), .b(x03), .c(new_n93_), .O(new_n94_));
  ...
  nand4  g56(.a(new_n77_), .b(new_n68_), .c(new_n96_), .d(new_n87_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n77_), .c(new_n68_), .d(new_n87_), .O(new_n106_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n77_), .d(new_n68_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  inv1   g72(.a(new_n58_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n59_), .b(x14), .O(new_n121_));
  ...
  oai21  g86(.a(new_n59_), .b(x07), .c(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n58_), .O(z16));
  nand4  g88(.a(new_n77_), .b(new_n128_), .c(x19), .d(new_n63_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n125_), .c(new_n47_), .d(new_n63_), .O(new_n136_));
