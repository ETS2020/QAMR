...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n49_, new_n52_, new_n59_, new_n60_, new_n61_,
  ...
  aoi22  g04(.a(new_n49_), .b(x09), .c(new_n47_), .d(x20), .O(z01));
  inv1   g05(.a(new_n49_), .O(new_n52_));
  oai22  g06(.a(new_n52_), .b(x10), .c(x27), .d(x21), .O(z02));
  aoi22  g07(.a(new_n49_), .b(x11), .c(new_n47_), .d(x22), .O(z03));
  oai22  g08(.a(new_n52_), .b(x12), .c(x27), .d(x23), .O(z04));
  aoi22  g09(.a(new_n49_), .b(x13), .c(new_n47_), .d(x24), .O(z05));
  aoi22  g10(.a(new_n49_), .b(x14), .c(new_n47_), .d(x25), .O(z06));
  oai22  g11(.a(new_n52_), .b(x15), .c(x27), .d(x26), .O(z07));
  ...
  aoi21  g50(.a(new_n59_), .b(new_n96_), .c(new_n61_), .O(new_n97_));
  ...
  nand4  g55(.a(new_n101_), .b(new_n92_), .c(new_n71_), .d(new_n70_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x16), .O(new_n104_));
  inv1   g58(.a(x13), .O(new_n105_));
  aoi21  g59(.a(new_n59_), .b(new_n105_), .c(new_n61_), .O(new_n106_));
  ...
  nand3  g64(.a(new_n110_), .b(new_n109_), .c(new_n62_), .O(new_n111_));
  inv1   g65(.a(new_n111_), .O(new_n112_));
  nand2  g66(.a(new_n102_), .b(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n92_), .c(new_n80_), .d(new_n71_), .O(new_n115_));
  and2   g69(.a(new_n115_), .b(x16), .O(new_n116_));
  aoi21  g70(.a(new_n116_), .b(new_n113_), .c(new_n112_), .O(z15));
  inv1   g71(.a(x07), .O(new_n118_));
  nand2  g72(.a(x18), .b(new_n118_), .O(new_n119_));
  inv1   g73(.a(x15), .O(new_n120_));
  nand2  g74(.a(new_n59_), .b(new_n120_), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n119_), .c(new_n62_), .O(new_n122_));
  inv1   g76(.a(x26), .O(new_n123_));
  nor2   g77(.a(new_n115_), .b(new_n123_), .O(new_n124_));
  nand2  g78(.a(new_n115_), .b(new_n123_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(x16), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n124_), .c(new_n122_), .O(z16));
  nand2  g81(.a(x27), .b(x17), .O(new_n128_));
  nand2  g82(.a(new_n114_), .b(new_n92_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n80_), .c(new_n66_), .d(new_n123_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n48_), .O(z17));
  buf    g86(.a(x27), .O(z08));
endmodule
