...
module FAU ( 
  ...
  wire new_n47_, new_n50_, new_n51_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n141_, new_n142_;
  nor2   g00(.a(x27), .b(x25), .O(new_n47_));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  nand2  g35(.a(new_n81_), .b(new_n67_), .O(new_n82_));
  ...
  oai21  g40(.a(new_n63_), .b(x02), .c(new_n86_), .O(new_n87_));
  aoi21  g41(.a(new_n87_), .b(new_n84_), .c(new_n59_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n81_), .b(new_n67_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n81_), .b(new_n67_), .c(new_n89_), .O(new_n91_));
  ...
  nand3  g53(.a(new_n99_), .b(new_n81_), .c(new_n67_), .O(new_n100_));
  ...
  aoi21  g60(.a(new_n106_), .b(new_n104_), .c(new_n59_), .O(new_n107_));
  ...
  oai21  g67(.a(new_n63_), .b(x05), .c(new_n113_), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(new_n111_), .c(new_n59_), .O(z14));
  nand4  g69(.a(new_n99_), .b(new_n81_), .c(new_n67_), .d(new_n109_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n58_), .O(new_n117_));
  nand2  g71(.a(new_n116_), .b(new_n58_), .O(new_n118_));
  ...
  oai21  g78(.a(new_n119_), .b(new_n117_), .c(new_n124_), .O(z15));
  nand2  g79(.a(new_n116_), .b(x26), .O(new_n126_));
  nor3   g80(.a(x26), .b(x25), .c(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n99_), .c(new_n81_), .d(new_n67_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x16), .O(new_n130_));
  nand2  g84(.a(x26), .b(x16), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(x27), .c(new_n58_), .O(new_n132_));
  inv1   g86(.a(x07), .O(new_n133_));
  nand2  g87(.a(x18), .b(new_n133_), .O(new_n134_));
  inv1   g88(.a(x15), .O(new_n135_));
  aoi21  g89(.a(new_n63_), .b(new_n135_), .c(x16), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n134_), .c(new_n132_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n130_), .O(z16));
  nand2  g92(.a(x27), .b(x17), .O(new_n139_));
  inv1   g93(.a(x19), .O(new_n140_));
  nor2   g94(.a(new_n140_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n127_), .c(new_n99_), .d(new_n81_), .O(new_n142_));
  aoi21  g96(.a(new_n142_), .b(new_n139_), .c(new_n61_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
