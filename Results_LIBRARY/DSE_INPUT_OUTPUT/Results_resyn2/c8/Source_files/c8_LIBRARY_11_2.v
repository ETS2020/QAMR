...
module FAU ( 
  ...
  oai22  g05(.a(new_n50_), .b(x21), .c(new_n47_), .d(x10), .O(z02));
  aoi22  g06(.a(new_n49_), .b(x22), .c(x27), .d(x11), .O(z03));
  aoi22  g07(.a(new_n49_), .b(x23), .c(x27), .d(x12), .O(z04));
  aoi22  g08(.a(new_n49_), .b(x24), .c(x27), .d(x13), .O(z05));
  ...
  aoi21  g30(.a(new_n76_), .b(new_n73_), .c(new_n62_), .O(z10));
  ...
  nand2  g38(.a(new_n84_), .b(new_n67_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(x16), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n83_), .c(new_n81_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n63_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n84_), .b(new_n67_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n84_), .b(new_n67_), .c(new_n89_), .O(new_n91_));
  ...
  nand3  g53(.a(new_n99_), .b(new_n84_), .c(new_n67_), .O(new_n100_));
  ...
  nand3  g62(.a(new_n108_), .b(new_n99_), .c(new_n72_), .O(new_n109_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n99_), .c(new_n84_), .d(new_n67_), .O(new_n118_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n62_), .O(z16));
  nor2   g89(.a(x20), .b(new_n65_), .O(new_n136_));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n108_), .d(new_n99_), .O(new_n138_));
  nor2   g92(.a(x17), .b(x08), .O(new_n139_));
  oai21  g93(.a(new_n139_), .b(x27), .c(x16), .O(new_n140_));
  aoi21  g94(.a(new_n138_), .b(new_n64_), .c(new_n140_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
