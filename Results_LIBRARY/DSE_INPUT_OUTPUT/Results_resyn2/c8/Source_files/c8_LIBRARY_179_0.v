...
module FAU ( 
  ...
  aoi21  g43(.a(new_n84_), .b(new_n63_), .c(new_n89_), .O(new_n90_));
  nor2   g44(.a(x22), .b(x21), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n63_), .c(new_n81_), .O(new_n92_));
  ...
  oai21  g58(.a(new_n99_), .b(new_n77_), .c(new_n104_), .O(z13));
  inv1   g59(.a(x23), .O(new_n106_));
  nand4  g60(.a(new_n91_), .b(new_n63_), .c(new_n106_), .d(new_n81_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n91_), .c(new_n63_), .d(new_n81_), .O(new_n110_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n84_), .d(new_n63_), .O(new_n120_));
  and2   g74(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n65_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n77_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n76_), .O(new_n125_));
  ...
  aoi21  g85(.a(new_n120_), .b(new_n131_), .c(new_n77_), .O(new_n132_));
  ...
  nand4  g93(.a(new_n139_), .b(new_n138_), .c(new_n109_), .d(new_n91_), .O(new_n140_));
