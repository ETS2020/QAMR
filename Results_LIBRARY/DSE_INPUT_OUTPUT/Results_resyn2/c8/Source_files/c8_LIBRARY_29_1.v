...
module FAU ( 
  ...
  aoi21  g35(.a(new_n68_), .b(new_n73_), .c(new_n81_), .O(new_n82_));
  nor2   g36(.a(x21), .b(x20), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  ...
  oai21  g42(.a(new_n64_), .b(x02), .c(new_n88_), .O(new_n89_));
  aoi21  g43(.a(new_n89_), .b(new_n86_), .c(new_n58_), .O(z11));
  inv1   g44(.a(x22), .O(new_n91_));
  aoi21  g45(.a(new_n83_), .b(new_n68_), .c(new_n91_), .O(new_n92_));
  nand3  g46(.a(new_n83_), .b(new_n68_), .c(new_n91_), .O(new_n93_));
  ...
  nand3  g55(.a(new_n101_), .b(new_n83_), .c(new_n68_), .O(new_n102_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n62_), .c(new_n114_), .O(z14));
  ...
  nor2   g72(.a(new_n118_), .b(new_n84_), .O(new_n119_));
  ...
  nor3   g79(.a(new_n118_), .b(new_n84_), .c(new_n57_), .O(new_n126_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n134_), .c(new_n83_), .d(new_n57_), .O(new_n137_));
