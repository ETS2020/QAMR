...
module FAU ( 
  ...
  oai22  g11(.a(z08), .b(x26), .c(new_n55_), .d(x15), .O(z07));
  inv1   g12(.a(x18), .O(new_n59_));
  nor2   g13(.a(new_n59_), .b(x00), .O(new_n60_));
  nor2   g14(.a(new_n55_), .b(x16), .O(new_n61_));
  ...
  oai21  g40(.a(new_n86_), .b(new_n55_), .c(new_n47_), .O(new_n87_));
  ...
  oai21  g50(.a(new_n96_), .b(new_n55_), .c(new_n47_), .O(new_n97_));
  ...
  oai21  g60(.a(new_n106_), .b(new_n55_), .c(new_n47_), .O(new_n107_));
  ...
  nand2  g81(.a(new_n55_), .b(new_n47_), .O(new_n128_));
