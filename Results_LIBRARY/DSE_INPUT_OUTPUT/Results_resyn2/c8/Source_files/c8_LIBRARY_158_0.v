...
module FAU ( 
  ...
  xnor2a g53(.a(new_n91_), .b(x23), .O(new_n100_));
  ...
  oai21  g59(.a(new_n91_), .b(x23), .c(x24), .O(new_n106_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n81_), .d(new_n67_), .O(new_n119_));
  and2   g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n63_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n61_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n60_), .O(new_n124_));
  ...
  nand2  g83(.a(new_n63_), .b(x15), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n129_), .c(new_n61_), .O(new_n131_));
  oai21  g85(.a(new_n128_), .b(new_n126_), .c(new_n131_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n60_), .O(z16));
  inv1   g87(.a(x17), .O(new_n134_));
  nand2  g88(.a(new_n118_), .b(new_n107_), .O(new_n135_));
  inv1   g89(.a(x26), .O(new_n136_));
  nand4  g90(.a(new_n81_), .b(new_n136_), .c(x19), .d(new_n134_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n135_), .c(new_n50_), .d(new_n134_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n60_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
