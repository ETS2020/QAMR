...
module FAU ( 
  ...
  nand2  g31(.a(x18), .b(x02), .O(new_n78_));
  aoi21  g32(.a(new_n65_), .b(x10), .c(x16), .O(new_n79_));
  nand2  g33(.a(new_n72_), .b(x21), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  nand2  g35(.a(x27), .b(x16), .O(new_n82_));
  aoi21  g36(.a(new_n81_), .b(new_n61_), .c(new_n82_), .O(new_n83_));
  aoi22  g37(.a(new_n83_), .b(new_n80_), .c(new_n79_), .d(new_n78_), .O(z11));
  inv1   g38(.a(new_n82_), .O(new_n85_));
  inv1   g39(.a(x22), .O(new_n86_));
  aoi21  g40(.a(new_n81_), .b(new_n61_), .c(new_n86_), .O(new_n87_));
  nand3  g41(.a(new_n81_), .b(new_n61_), .c(new_n86_), .O(new_n88_));
  inv1   g42(.a(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n90_));
  nor2   g44(.a(new_n65_), .b(x03), .O(new_n91_));
  oai21  g45(.a(x18), .b(x11), .c(new_n67_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(z12));
  nor2   g47(.a(x23), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n81_), .c(new_n61_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n88_), .b(x23), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(new_n65_), .b(x04), .O(new_n98_));
  oai21  g52(.a(x18), .b(x12), .c(new_n67_), .O(new_n99_));
  oai22  g53(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n82_), .O(z13));
  nand2  g54(.a(new_n95_), .b(x24), .O(new_n101_));
  nor2   g55(.a(x24), .b(x21), .O(new_n102_));
  nand4  g56(.a(new_n102_), .b(new_n94_), .c(new_n61_), .d(new_n70_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n85_), .O(new_n105_));
  inv1   g59(.a(x13), .O(new_n106_));
  aoi21  g60(.a(new_n65_), .b(new_n106_), .c(x16), .O(new_n107_));
  oai21  g61(.a(new_n65_), .b(x05), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n105_), .O(z14));
  nor2   g63(.a(x25), .b(x24), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n94_), .c(new_n81_), .d(new_n61_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x27), .O(new_n112_));
  aoi21  g66(.a(new_n103_), .b(x25), .c(new_n112_), .O(new_n113_));
  inv1   g67(.a(x14), .O(new_n114_));
  aoi21  g68(.a(new_n65_), .b(new_n114_), .c(x16), .O(new_n115_));
  oai21  g69(.a(new_n65_), .b(x06), .c(new_n115_), .O(new_n116_));
  oai21  g70(.a(new_n113_), .b(new_n67_), .c(new_n116_), .O(z15));
  nor2   g71(.a(x26), .b(x23), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n110_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n89_), .c(new_n111_), .d(x26), .O(new_n121_));
  inv1   g75(.a(x15), .O(new_n122_));
  aoi21  g76(.a(new_n65_), .b(new_n122_), .c(x16), .O(new_n123_));
  oai21  g77(.a(new_n65_), .b(x07), .c(new_n123_), .O(new_n124_));
  oai21  g78(.a(new_n121_), .b(new_n82_), .c(new_n124_), .O(z16));
  nand4  g79(.a(new_n120_), .b(new_n81_), .c(new_n86_), .d(x19), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n58_), .c(new_n82_), .O(z17));
  buf    g81(.a(x27), .O(z08));
endmodule
