...
module FAU ( 
  ...
  nand3  g30(.a(new_n76_), .b(new_n73_), .c(new_n60_), .O(z10));
  ...
  aoi21  g44(.a(new_n80_), .b(new_n67_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n80_), .b(new_n67_), .c(new_n90_), .O(new_n92_));
  ...
  nand4  g59(.a(new_n80_), .b(new_n67_), .c(new_n99_), .d(new_n90_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n80_), .c(new_n67_), .d(new_n90_), .O(new_n109_));
  ...
  aoi21  g78(.a(new_n63_), .b(new_n124_), .c(x16), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n123_), .c(new_n59_), .O(new_n126_));
  oai21  g80(.a(new_n121_), .b(new_n61_), .c(new_n126_), .O(z15));
  nand4  g81(.a(new_n118_), .b(new_n108_), .c(new_n80_), .d(new_n67_), .O(new_n128_));
  nor2   g82(.a(new_n128_), .b(new_n58_), .O(new_n129_));
  nand2  g83(.a(new_n128_), .b(new_n58_), .O(new_n130_));
  ...
  nand4  g93(.a(new_n120_), .b(new_n80_), .c(x19), .d(new_n139_), .O(new_n140_));
  nand2  g94(.a(new_n58_), .b(x16), .O(new_n141_));
