...
module FAU ( 
  ...
  nand3  g51(.a(new_n97_), .b(new_n78_), .c(new_n63_), .O(new_n98_));
  ...
  aoi21  g56(.a(new_n58_), .b(new_n65_), .c(x16), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n102_), .c(new_n66_), .O(new_n104_));
  ...
  nand4  g66(.a(new_n97_), .b(new_n78_), .c(new_n63_), .d(new_n106_), .O(new_n113_));
  ...
  nand4  g79(.a(new_n114_), .b(new_n97_), .c(new_n78_), .d(new_n63_), .O(new_n126_));
