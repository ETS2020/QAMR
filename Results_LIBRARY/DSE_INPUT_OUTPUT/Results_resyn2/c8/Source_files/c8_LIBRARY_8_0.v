...
module FAU ( 
  ...
  oai22  g09(.a(z08), .b(x24), .c(new_n50_), .d(x13), .O(z05));
  ...
  aoi21  g30(.a(new_n60_), .b(new_n76_), .c(x16), .O(new_n77_));
  oai21  g31(.a(new_n60_), .b(x01), .c(new_n77_), .O(new_n78_));
  aoi21  g32(.a(new_n78_), .b(new_n75_), .c(new_n69_), .O(z10));
  inv1   g33(.a(x21), .O(new_n80_));
  nor2   g34(.a(new_n74_), .b(new_n80_), .O(new_n81_));
  nand3  g35(.a(new_n67_), .b(new_n80_), .c(new_n72_), .O(new_n82_));
  ...
  aoi21  g42(.a(new_n88_), .b(new_n86_), .c(new_n69_), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n84_), .O(z11));
  nand2  g44(.a(new_n82_), .b(x22), .O(new_n91_));
  ...
  nand3  g55(.a(new_n101_), .b(new_n74_), .c(new_n80_), .O(new_n102_));
  ...
  aoi22  g64(.a(new_n110_), .b(new_n83_), .c(new_n102_), .d(x24), .O(new_n111_));
  ...
  oai21  g72(.a(new_n118_), .b(new_n82_), .c(x25), .O(new_n119_));
