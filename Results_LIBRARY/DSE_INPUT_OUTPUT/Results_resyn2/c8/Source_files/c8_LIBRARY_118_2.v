...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n57_, new_n58_, new_n60_, new_n61_, new_n62_,
  ...
  nor2   g01(.a(x27), .b(x26), .O(new_n48_));
  ...
  aoi21  g12(.a(x27), .b(x15), .c(new_n58_), .O(z07));
  ...
  xor2a  g24(.a(new_n66_), .b(new_n70_), .O(new_n71_));
  inv1   g25(.a(x01), .O(new_n72_));
  nand2  g26(.a(x18), .b(new_n72_), .O(new_n73_));
  inv1   g27(.a(x09), .O(new_n74_));
  aoi21  g28(.a(new_n61_), .b(new_n74_), .c(x16), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n58_), .O(new_n76_));
  oai21  g30(.a(new_n71_), .b(new_n69_), .c(new_n76_), .O(z10));
  nand2  g31(.a(new_n66_), .b(new_n70_), .O(new_n78_));
  nor2   g32(.a(x21), .b(x20), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n66_), .O(new_n80_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n69_), .c(new_n87_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n79_), .b(new_n66_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n79_), .b(new_n66_), .c(new_n89_), .O(new_n91_));
  ...
  nand4  g58(.a(new_n79_), .b(new_n66_), .c(new_n98_), .d(new_n89_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n79_), .c(new_n66_), .d(new_n89_), .O(new_n108_));
  ...
  oai21  g79(.a(new_n120_), .b(new_n69_), .c(new_n125_), .O(z15));
  nand4  g80(.a(new_n117_), .b(new_n107_), .c(new_n79_), .d(new_n66_), .O(new_n127_));
  nor2   g81(.a(new_n127_), .b(new_n57_), .O(new_n128_));
  nand2  g82(.a(new_n127_), .b(new_n57_), .O(new_n129_));
  ...
  aoi21  g87(.a(new_n61_), .b(new_n133_), .c(x16), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n58_), .O(new_n135_));
  oai21  g89(.a(new_n130_), .b(new_n128_), .c(new_n135_), .O(z16));
  inv1   g90(.a(x17), .O(new_n137_));
  nand4  g91(.a(new_n119_), .b(new_n79_), .c(new_n57_), .d(x19), .O(new_n138_));
  oai21  g92(.a(x27), .b(new_n137_), .c(x16), .O(new_n139_));
