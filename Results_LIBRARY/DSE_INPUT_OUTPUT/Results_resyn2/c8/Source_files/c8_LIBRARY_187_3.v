...
module FAU ( 
  ...
  nand3  g50(.a(new_n96_), .b(new_n77_), .c(new_n63_), .O(new_n97_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n99_), .c(new_n73_), .O(z13));
  inv1   g57(.a(x24), .O(new_n104_));
  xor2a  g58(.a(new_n97_), .b(new_n104_), .O(new_n105_));
  ...
  aoi21  g63(.a(new_n109_), .b(new_n106_), .c(new_n73_), .O(z14));
  oai21  g64(.a(new_n97_), .b(x24), .c(x25), .O(new_n111_));
  nor2   g65(.a(x25), .b(x24), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n96_), .c(new_n77_), .d(new_n63_), .O(new_n113_));
  and2   g67(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g68(.a(x18), .b(x06), .O(new_n115_));
  nand2  g69(.a(new_n58_), .b(x14), .O(new_n116_));
  nand3  g70(.a(new_n116_), .b(new_n115_), .c(new_n85_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n65_), .O(new_n118_));
  aoi21  g72(.a(new_n114_), .b(new_n111_), .c(new_n118_), .O(z15));
  nand2  g73(.a(new_n112_), .b(new_n96_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n79_), .c(x26), .O(new_n122_));
  inv1   g76(.a(x26), .O(new_n123_));
  aoi21  g77(.a(new_n113_), .b(new_n123_), .c(new_n85_), .O(new_n124_));
  ...
  aoi21  g82(.a(new_n128_), .b(new_n125_), .c(new_n73_), .O(z16));
  inv1   g83(.a(x17), .O(new_n130_));
  nand4  g84(.a(new_n77_), .b(new_n123_), .c(x19), .d(new_n130_), .O(new_n131_));
  oai22  g85(.a(new_n131_), .b(new_n120_), .c(new_n47_), .d(new_n130_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n65_), .O(z17));
endmodule
