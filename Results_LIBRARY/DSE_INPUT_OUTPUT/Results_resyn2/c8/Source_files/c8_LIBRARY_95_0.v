...
module FAU ( 
  ...
  oai21  g73(.a(new_n119_), .b(new_n83_), .c(x25), .O(new_n120_));
  nand2  g74(.a(new_n66_), .b(new_n71_), .O(new_n121_));
  nor2   g75(.a(x25), .b(x21), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n111_), .c(new_n110_), .O(new_n125_));
  nand2  g79(.a(x18), .b(x06), .O(new_n126_));
  nand2  g80(.a(new_n59_), .b(x14), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n126_), .c(new_n110_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n69_), .O(new_n129_));
  aoi21  g83(.a(new_n125_), .b(new_n120_), .c(new_n129_), .O(z15));
  nand3  g84(.a(new_n124_), .b(new_n111_), .c(x26), .O(new_n131_));
  inv1   g85(.a(x26), .O(new_n132_));
  nand2  g86(.a(new_n122_), .b(new_n73_), .O(new_n133_));
  oai21  g87(.a(new_n133_), .b(new_n119_), .c(new_n132_), .O(new_n134_));
  nand3  g88(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  ...
  nor2   g95(.a(x20), .b(new_n64_), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n122_), .c(new_n111_), .d(new_n132_), .O(new_n143_));
