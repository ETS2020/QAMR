...
module FAU ( 
  ...
  oai22  g15(.a(new_n50_), .b(x26), .c(new_n49_), .d(x15), .O(z07));
  ...
  aoi21  g25(.a(new_n71_), .b(new_n67_), .c(new_n57_), .O(z09));
  ...
  nand2  g52(.a(new_n98_), .b(new_n58_), .O(z12));
  ...
  aoi21  g59(.a(new_n68_), .b(new_n105_), .c(x16), .O(new_n106_));
  oai21  g60(.a(new_n68_), .b(x04), .c(new_n106_), .O(new_n107_));
  ...
  aoi21  g66(.a(new_n68_), .b(new_n112_), .c(x16), .O(new_n113_));
  oai21  g67(.a(new_n68_), .b(x05), .c(new_n113_), .O(new_n114_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n101_), .c(new_n82_), .d(new_n66_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n68_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n90_), .O(new_n123_));
