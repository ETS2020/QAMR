...
module FAU ( 
  ...
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n57_), .O(z11));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n91_), .c(new_n57_), .O(z12));
  ...
  oai21  g64(.a(new_n60_), .b(x05), .c(new_n110_), .O(new_n111_));
  aoi21  g65(.a(new_n111_), .b(new_n108_), .c(new_n57_), .O(z14));
  oai21  g66(.a(new_n97_), .b(x24), .c(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n96_), .c(new_n79_), .d(new_n69_), .O(new_n115_));
  ...
  oai21  g83(.a(new_n60_), .b(x07), .c(new_n129_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n127_), .c(new_n57_), .O(z16));
  nand4  g85(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n64_), .O(new_n132_));
  oai22  g86(.a(new_n132_), .b(new_n122_), .c(new_n47_), .d(new_n64_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n56_), .O(z17));
endmodule
