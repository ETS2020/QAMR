...
module FAU ( 
  ...
  oai22  g48(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(z13));
  nor2   g49(.a(x24), .b(x21), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n89_), .c(new_n67_), .d(new_n66_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x27), .O(new_n98_));
  aoi21  g52(.a(new_n90_), .b(x24), .c(new_n98_), .O(new_n99_));
  inv1   g53(.a(x13), .O(new_n100_));
  aoi21  g54(.a(new_n61_), .b(new_n100_), .c(x16), .O(new_n101_));
  oai21  g55(.a(new_n61_), .b(x05), .c(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n99_), .b(new_n63_), .c(new_n102_), .O(z14));
  nand2  g57(.a(new_n97_), .b(x25), .O(new_n104_));
  nor2   g58(.a(x25), .b(x24), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n89_), .c(new_n77_), .d(new_n67_), .O(new_n106_));
  ...
  oai21  g72(.a(new_n61_), .b(x07), .c(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n116_), .b(new_n69_), .c(new_n119_), .O(z16));
  nand4  g74(.a(new_n115_), .b(new_n77_), .c(new_n81_), .d(x19), .O(new_n121_));
  nor2   g75(.a(new_n49_), .b(x17), .O(new_n122_));
  aoi21  g76(.a(new_n122_), .b(new_n121_), .c(new_n63_), .O(z17));
endmodule
