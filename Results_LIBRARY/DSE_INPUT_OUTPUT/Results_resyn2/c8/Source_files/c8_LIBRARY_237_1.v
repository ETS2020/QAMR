...
module FAU ( 
  ...
  nand2  g01(.a(x27), .b(x11), .O(new_n48_));
  ...
  aoi21  g06(.a(new_n47_), .b(x22), .c(z08), .O(z03));
  ...
  nor2   g11(.a(new_n47_), .b(x11), .O(new_n58_));
  ...
  nand2  g32(.a(new_n78_), .b(new_n68_), .O(new_n79_));
  ...
  oai21  g46(.a(new_n79_), .b(x22), .c(x23), .O(new_n93_));
  nor2   g47(.a(x23), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n78_), .c(new_n68_), .O(new_n95_));
  ...
  aoi21  g54(.a(new_n59_), .b(new_n100_), .c(x16), .O(new_n101_));
  aoi21  g55(.a(new_n101_), .b(new_n99_), .c(new_n58_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n97_), .O(z13));
  nand2  g57(.a(new_n95_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x21), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n94_), .c(new_n68_), .d(new_n75_), .O(new_n106_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n94_), .c(new_n78_), .d(new_n68_), .O(new_n115_));
  ...
  oai21  g73(.a(new_n59_), .b(x06), .c(new_n119_), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n117_), .c(new_n58_), .O(z15));
  inv1   g75(.a(x26), .O(new_n122_));
  nand3  g76(.a(new_n114_), .b(new_n94_), .c(new_n122_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n79_), .O(new_n124_));
  ...
  aoi21  g82(.a(new_n59_), .b(new_n128_), .c(x16), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n127_), .c(new_n58_), .O(new_n130_));
  oai21  g84(.a(new_n125_), .b(new_n64_), .c(new_n130_), .O(z16));
  inv1   g85(.a(new_n58_), .O(new_n132_));
  nand3  g86(.a(new_n78_), .b(x19), .c(new_n63_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n123_), .c(new_n47_), .d(new_n63_), .O(new_n134_));
