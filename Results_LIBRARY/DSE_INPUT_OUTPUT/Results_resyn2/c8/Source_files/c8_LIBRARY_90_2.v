...
module FAU ( 
  ...
  aoi21  g40(.a(new_n58_), .b(new_n86_), .c(x16), .O(new_n87_));
  ...
  nand3  g46(.a(new_n73_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  ...
  oai21  g51(.a(new_n58_), .b(x03), .c(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n98_), .b(new_n95_), .c(new_n68_), .O(z12));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n73_), .c(new_n93_), .d(x23), .O(new_n101_));
  ...
  nand3  g62(.a(new_n108_), .b(new_n92_), .c(new_n91_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n82_), .c(x24), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  nand3  g65(.a(new_n100_), .b(new_n73_), .c(new_n111_), .O(new_n112_));
  ...
  oai21  g70(.a(new_n58_), .b(x05), .c(new_n116_), .O(new_n117_));
  aoi21  g71(.a(new_n117_), .b(new_n114_), .c(new_n68_), .O(z14));
  nand2  g72(.a(new_n112_), .b(x25), .O(new_n119_));
  nand4  g73(.a(new_n111_), .b(new_n108_), .c(new_n92_), .d(new_n91_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand3  g76(.a(new_n65_), .b(new_n122_), .c(new_n71_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n121_), .c(new_n81_), .O(new_n125_));
  nand2  g79(.a(x18), .b(x06), .O(new_n126_));
  nand2  g80(.a(new_n58_), .b(x14), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n126_), .c(new_n81_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n69_), .O(new_n129_));
  aoi21  g83(.a(new_n125_), .b(new_n119_), .c(new_n129_), .O(z15));
  nand3  g84(.a(new_n124_), .b(new_n121_), .c(x26), .O(new_n131_));
  inv1   g85(.a(x26), .O(new_n132_));
  oai21  g86(.a(new_n123_), .b(new_n120_), .c(new_n132_), .O(new_n133_));
  nand3  g87(.a(new_n133_), .b(new_n131_), .c(x16), .O(new_n134_));
  nand2  g88(.a(x18), .b(new_n67_), .O(new_n135_));
  ...
  nand2  g92(.a(new_n138_), .b(new_n134_), .O(z16));
  nor2   g93(.a(x26), .b(x25), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n121_), .c(new_n71_), .d(x19), .O(new_n141_));
  nor2   g95(.a(x17), .b(x07), .O(new_n142_));
