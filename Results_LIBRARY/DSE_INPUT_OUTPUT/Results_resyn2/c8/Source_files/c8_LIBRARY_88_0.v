...
module FAU ( 
  ...
  nand2  g12(.a(x19), .b(x17), .O(new_n59_));
  nor2   g13(.a(x19), .b(x17), .O(new_n60_));
  inv1   g14(.a(new_n60_), .O(new_n61_));
  nand3  g15(.a(new_n61_), .b(new_n59_), .c(x16), .O(new_n62_));
  nor2   g16(.a(x27), .b(x00), .O(new_n63_));
  inv1   g17(.a(new_n63_), .O(new_n64_));
  inv1   g18(.a(x18), .O(new_n65_));
  aoi21  g19(.a(new_n65_), .b(x08), .c(x16), .O(new_n66_));
  oai21  g20(.a(new_n65_), .b(new_n47_), .c(new_n66_), .O(new_n67_));
  nand3  g21(.a(new_n67_), .b(new_n64_), .c(new_n62_), .O(new_n68_));
  inv1   g22(.a(new_n68_), .O(z09));
  inv1   g23(.a(x20), .O(new_n70_));
  nor2   g24(.a(new_n60_), .b(new_n70_), .O(new_n71_));
  nor2   g25(.a(new_n61_), .b(x20), .O(new_n72_));
  ...
  nand2  g35(.a(new_n65_), .b(x10), .O(new_n82_));
  nand3  g36(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  inv1   g37(.a(x21), .O(new_n84_));
  aoi21  g38(.a(new_n60_), .b(new_n70_), .c(new_n84_), .O(new_n85_));
  nor2   g39(.a(x21), .b(x20), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n60_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(x16), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n85_), .c(new_n83_), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n64_), .O(z11));
  inv1   g44(.a(x22), .O(new_n91_));
  aoi21  g45(.a(new_n86_), .b(new_n60_), .c(new_n91_), .O(new_n92_));
  nand3  g46(.a(new_n86_), .b(new_n60_), .c(new_n91_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n92_), .c(x16), .O(new_n95_));
  inv1   g49(.a(x11), .O(new_n96_));
  aoi21  g50(.a(new_n65_), .b(new_n96_), .c(x16), .O(new_n97_));
  oai21  g51(.a(new_n65_), .b(x03), .c(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n98_), .b(new_n95_), .c(new_n63_), .O(z12));
  nand2  g53(.a(new_n93_), .b(x23), .O(new_n100_));
  nor2   g54(.a(x23), .b(x22), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n86_), .c(new_n60_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x16), .O(new_n104_));
  inv1   g58(.a(x12), .O(new_n105_));
  aoi21  g59(.a(new_n65_), .b(new_n105_), .c(x16), .O(new_n106_));
  oai21  g60(.a(new_n65_), .b(x04), .c(new_n106_), .O(new_n107_));
  aoi21  g61(.a(new_n107_), .b(new_n104_), .c(new_n63_), .O(z13));
  nand2  g62(.a(new_n102_), .b(x24), .O(new_n109_));
  nor2   g63(.a(x24), .b(x21), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n101_), .c(new_n60_), .d(new_n70_), .O(new_n111_));
  ...
  oai21  g69(.a(new_n65_), .b(x05), .c(new_n115_), .O(new_n116_));
  aoi21  g70(.a(new_n116_), .b(new_n113_), .c(new_n63_), .O(z14));
  nand2  g71(.a(new_n111_), .b(x25), .O(new_n118_));
  nor2   g72(.a(x25), .b(x24), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n101_), .c(new_n86_), .d(new_n60_), .O(new_n120_));
  and2   g74(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n65_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n80_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n64_), .O(new_n125_));
  ...
  oai21  g89(.a(new_n65_), .b(x07), .c(new_n135_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n63_), .O(z16));
  ...
  oai21  g96(.a(x17), .b(new_n47_), .c(new_n50_), .O(new_n143_));
