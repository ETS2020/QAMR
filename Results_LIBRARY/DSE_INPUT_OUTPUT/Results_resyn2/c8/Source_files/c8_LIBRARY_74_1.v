...
module FAU ( 
  ...
  aoi22  g09(.a(new_n49_), .b(x13), .c(new_n48_), .d(x24), .O(z05));
  ...
  oai21  g32(.a(new_n73_), .b(new_n61_), .c(new_n78_), .O(z10));
  nand2  g33(.a(new_n67_), .b(new_n72_), .O(new_n80_));
  ...
  nand3  g55(.a(new_n101_), .b(new_n81_), .c(new_n67_), .O(new_n102_));
  ...
  aoi21  g69(.a(new_n115_), .b(new_n113_), .c(new_n59_), .O(new_n116_));
  oai21  g70(.a(new_n111_), .b(new_n61_), .c(new_n116_), .O(z14));
  oai21  g71(.a(new_n102_), .b(x24), .c(x25), .O(new_n118_));
  nor2   g72(.a(x25), .b(x24), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n101_), .c(new_n81_), .d(new_n67_), .O(new_n120_));
  and2   g74(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n63_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n61_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n60_), .O(new_n125_));
  aoi21  g79(.a(new_n121_), .b(new_n118_), .c(new_n125_), .O(z15));
  inv1   g80(.a(x26), .O(new_n127_));
  nor2   g81(.a(new_n120_), .b(new_n127_), .O(new_n128_));
  nand2  g82(.a(new_n120_), .b(new_n127_), .O(new_n129_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n59_), .O(new_n135_));
  oai21  g89(.a(new_n130_), .b(new_n128_), .c(new_n135_), .O(z16));
  inv1   g90(.a(x17), .O(new_n137_));
  nand3  g91(.a(new_n127_), .b(x19), .c(new_n137_), .O(new_n138_));
  inv1   g92(.a(new_n138_), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n119_), .c(new_n101_), .d(new_n81_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  nand2  g95(.a(new_n60_), .b(x16), .O(new_n142_));
  aoi21  g96(.a(new_n141_), .b(new_n140_), .c(new_n142_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
