...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n50_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n141_;
  nand2  g00(.a(x27), .b(x00), .O(new_n47_));
  ...
  nand3  g18(.a(new_n64_), .b(new_n63_), .c(x16), .O(new_n65_));
  nor2   g19(.a(new_n49_), .b(x00), .O(new_n66_));
  inv1   g20(.a(new_n66_), .O(new_n67_));
  nand3  g21(.a(new_n67_), .b(new_n65_), .c(new_n61_), .O(new_n68_));
  inv1   g22(.a(new_n68_), .O(z09));
  inv1   g23(.a(x20), .O(new_n70_));
  nor2   g24(.a(new_n62_), .b(new_n70_), .O(new_n71_));
  nor2   g25(.a(new_n63_), .b(x20), .O(new_n72_));
  ...
  aoi21  g31(.a(new_n77_), .b(new_n75_), .c(new_n66_), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n73_), .O(z10));
  inv1   g33(.a(x21), .O(new_n80_));
  aoi21  g34(.a(new_n62_), .b(new_n70_), .c(new_n80_), .O(new_n81_));
  nor2   g35(.a(x21), .b(x20), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n62_), .O(new_n83_));
  ...
  nand2  g52(.a(new_n98_), .b(new_n67_), .O(z12));
  inv1   g53(.a(x23), .O(new_n100_));
  xor2a  g54(.a(new_n95_), .b(new_n100_), .O(new_n101_));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n66_), .O(z13));
  nand4  g60(.a(new_n94_), .b(new_n62_), .c(new_n100_), .d(new_n70_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n94_), .c(new_n62_), .d(new_n70_), .O(new_n110_));
  ...
  aoi21  g70(.a(new_n116_), .b(new_n114_), .c(new_n66_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n112_), .O(z14));
  nand2  g72(.a(new_n110_), .b(x25), .O(new_n119_));
  nor2   g73(.a(x25), .b(x22), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n82_), .d(new_n62_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n59_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n90_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n67_), .O(new_n126_));
  ...
  nand3  g83(.a(new_n129_), .b(new_n84_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  aoi21  g85(.a(new_n121_), .b(new_n131_), .c(new_n90_), .O(new_n132_));
  ...
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n66_), .O(z16));
  inv1   g91(.a(x17), .O(new_n138_));
  nand4  g92(.a(new_n82_), .b(new_n131_), .c(x19), .d(new_n138_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n128_), .c(new_n49_), .d(new_n138_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n67_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
