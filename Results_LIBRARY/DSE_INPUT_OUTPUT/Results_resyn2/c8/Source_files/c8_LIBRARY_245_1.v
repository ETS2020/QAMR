...
module FAU ( 
  ...
  aoi21  g09(.a(new_n53_), .b(x25), .c(new_n54_), .O(z06));
  ...
  nand3  g50(.a(new_n81_), .b(new_n66_), .c(new_n96_), .O(new_n97_));
  xnor2a g51(.a(new_n97_), .b(x23), .O(new_n98_));
  ...
  inv1   g58(.a(new_n97_), .O(new_n105_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n81_), .d(new_n66_), .O(new_n118_));
  ...
  nand2  g76(.a(new_n122_), .b(new_n59_), .O(new_n123_));
  ...
  nand2  g82(.a(new_n62_), .b(x15), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n128_), .c(new_n60_), .O(new_n130_));
  oai21  g84(.a(new_n127_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n59_), .O(z16));
  inv1   g86(.a(x17), .O(new_n133_));
  nand2  g87(.a(new_n117_), .b(new_n106_), .O(new_n134_));
  inv1   g88(.a(x26), .O(new_n135_));
  nand4  g89(.a(new_n81_), .b(new_n135_), .c(x19), .d(new_n133_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n134_), .c(new_n53_), .d(new_n133_), .O(new_n137_));
