...
module FAU ( 
  ...
  aoi21  g78(.a(new_n124_), .b(x26), .c(new_n60_), .O(new_n125_));
  ...
  nor2   g82(.a(x17), .b(new_n60_), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n90_), .c(new_n121_), .d(x19), .O(new_n130_));
  oai22  g84(.a(new_n130_), .b(new_n114_), .c(new_n129_), .d(new_n47_), .O(z17));
endmodule
