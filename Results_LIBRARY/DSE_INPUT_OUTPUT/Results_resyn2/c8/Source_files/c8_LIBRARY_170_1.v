...
module FAU ( 
  ...
  nor2   g11(.a(new_n47_), .b(x09), .O(new_n58_));
  ...
  aoi21  g26(.a(new_n72_), .b(new_n71_), .c(new_n65_), .O(new_n73_));
  oai21  g27(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand2  g28(.a(x18), .b(x01), .O(new_n75_));
  nand2  g29(.a(new_n59_), .b(x09), .O(new_n76_));
  nand3  g30(.a(new_n76_), .b(new_n75_), .c(new_n65_), .O(new_n77_));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n92_), .c(new_n58_), .O(new_n95_));
  oai21  g49(.a(new_n90_), .b(new_n65_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n82_), .b(new_n72_), .c(new_n97_), .O(new_n98_));
  xor2a  g52(.a(new_n98_), .b(x23), .O(new_n99_));
  ...
  nand4  g60(.a(new_n82_), .b(new_n72_), .c(new_n106_), .d(new_n97_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n82_), .c(new_n72_), .d(new_n97_), .O(new_n110_));
  ...
  aoi22  g75(.a(new_n121_), .b(new_n84_), .c(new_n110_), .d(x25), .O(new_n122_));
  ...
  oai21  g81(.a(new_n122_), .b(new_n65_), .c(new_n127_), .O(z15));
  nand3  g82(.a(new_n121_), .b(new_n84_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  nand4  g84(.a(new_n119_), .b(new_n109_), .c(new_n82_), .d(new_n72_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n130_), .c(new_n65_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  ...
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n58_), .O(z16));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n121_), .b(new_n82_), .c(new_n66_), .d(new_n130_), .O(new_n139_));
  nand2  g93(.a(new_n70_), .b(x16), .O(new_n140_));
