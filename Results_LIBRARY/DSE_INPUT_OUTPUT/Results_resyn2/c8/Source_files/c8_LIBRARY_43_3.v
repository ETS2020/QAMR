...
module FAU ( 
  ...
  nor2   g001(.a(new_n47_), .b(x12), .O(new_n48_));
  ...
  nand2  g007(.a(new_n47_), .b(x23), .O(z04));
  ...
  nand2  g011(.a(x27), .b(x12), .O(new_n58_));
  ...
  nand2  g037(.a(new_n83_), .b(new_n66_), .O(new_n84_));
  nand2  g038(.a(new_n84_), .b(x16), .O(new_n85_));
  oai21  g039(.a(new_n85_), .b(new_n82_), .c(new_n80_), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n58_), .O(z11));
  inv1   g041(.a(new_n58_), .O(new_n88_));
  inv1   g042(.a(x22), .O(new_n89_));
  aoi21  g043(.a(new_n83_), .b(new_n66_), .c(new_n89_), .O(new_n90_));
  nand3  g044(.a(new_n83_), .b(new_n66_), .c(new_n89_), .O(new_n91_));
  ...
  aoi21  g050(.a(new_n96_), .b(new_n93_), .c(new_n88_), .O(z12));
  nand2  g051(.a(new_n91_), .b(x23), .O(new_n98_));
  nor2   g052(.a(x23), .b(x22), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n83_), .c(new_n66_), .O(new_n100_));
  and2   g054(.a(new_n100_), .b(x16), .O(new_n101_));
  nand2  g055(.a(x18), .b(x04), .O(new_n102_));
  nand2  g056(.a(new_n73_), .b(x12), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n102_), .c(new_n60_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n58_), .O(new_n105_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n108_), .c(new_n71_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(x16), .O(new_n112_));
  inv1   g066(.a(x13), .O(new_n113_));
  aoi21  g067(.a(new_n73_), .b(new_n113_), .c(x16), .O(new_n114_));
  oai21  g068(.a(new_n73_), .b(x05), .c(new_n114_), .O(new_n115_));
  aoi21  g069(.a(new_n115_), .b(new_n112_), .c(new_n88_), .O(z14));
  nand2  g070(.a(new_n110_), .b(x25), .O(new_n117_));
  nor2   g071(.a(x25), .b(x24), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n99_), .c(new_n83_), .d(new_n66_), .O(new_n119_));
  and2   g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g074(.a(x18), .b(x06), .O(new_n121_));
  nand2  g075(.a(new_n73_), .b(x14), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n121_), .c(new_n60_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n58_), .O(new_n124_));
  aoi21  g078(.a(new_n120_), .b(new_n117_), .c(new_n124_), .O(z15));
  inv1   g079(.a(new_n84_), .O(new_n126_));
  nand2  g080(.a(new_n118_), .b(new_n99_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n126_), .c(x26), .O(new_n129_));
  inv1   g083(.a(x26), .O(new_n130_));
  aoi21  g084(.a(new_n119_), .b(new_n130_), .c(new_n60_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  inv1   g086(.a(x15), .O(new_n133_));
  aoi21  g087(.a(new_n73_), .b(new_n133_), .c(x16), .O(new_n134_));
  oai21  g088(.a(new_n73_), .b(x07), .c(new_n134_), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n132_), .c(new_n88_), .O(z16));
  inv1   g090(.a(x12), .O(new_n137_));
  nand2  g091(.a(x27), .b(x17), .O(new_n138_));
  nand4  g092(.a(new_n83_), .b(new_n130_), .c(x19), .d(new_n63_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n127_), .c(new_n138_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nor2   g095(.a(new_n64_), .b(x17), .O(new_n142_));
  inv1   g096(.a(x25), .O(new_n143_));
  nand4  g097(.a(new_n47_), .b(new_n130_), .c(new_n143_), .d(new_n69_), .O(new_n144_));
  inv1   g098(.a(new_n144_), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n142_), .c(new_n109_), .d(new_n108_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n141_), .c(new_n60_), .O(z17));
