...
module FAU ( 
  ...
  nand2  g69(.a(new_n115_), .b(new_n99_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n82_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n66_), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n60_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n66_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n58_), .O(new_n122_));
  aoi21  g76(.a(new_n118_), .b(new_n114_), .c(new_n122_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nor3   g78(.a(new_n116_), .b(new_n82_), .c(new_n124_), .O(new_n125_));
  oai21  g79(.a(new_n117_), .b(x26), .c(x16), .O(new_n126_));
  ...
  aoi21  g84(.a(new_n130_), .b(new_n128_), .c(new_n59_), .O(new_n131_));
  oai21  g85(.a(new_n126_), .b(new_n125_), .c(new_n131_), .O(z16));
  nand2  g86(.a(x27), .b(x17), .O(new_n133_));
  inv1   g87(.a(new_n116_), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n81_), .c(new_n67_), .d(new_n124_), .O(new_n135_));
  nand2  g89(.a(new_n58_), .b(x16), .O(new_n136_));
  aoi21  g90(.a(new_n135_), .b(new_n133_), .c(new_n136_), .O(z17));
endmodule
