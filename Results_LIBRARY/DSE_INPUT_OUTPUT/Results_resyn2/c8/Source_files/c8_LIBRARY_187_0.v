...
module FAU ( 
  ...
  xor2a  g24(.a(new_n64_), .b(new_n70_), .O(new_n71_));
  inv1   g25(.a(x01), .O(new_n72_));
  nand2  g26(.a(x18), .b(new_n72_), .O(new_n73_));
  inv1   g27(.a(x09), .O(new_n74_));
  aoi21  g28(.a(new_n59_), .b(new_n74_), .c(x16), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n66_), .O(new_n76_));
  oai21  g30(.a(new_n71_), .b(new_n69_), .c(new_n76_), .O(z10));
  inv1   g31(.a(x21), .O(new_n78_));
  aoi21  g32(.a(new_n64_), .b(new_n70_), .c(new_n78_), .O(new_n79_));
  ...
  oai21  g47(.a(new_n88_), .b(new_n69_), .c(new_n93_), .O(z12));
  inv1   g48(.a(x22), .O(new_n95_));
  nand3  g49(.a(new_n80_), .b(new_n64_), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x23), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n64_), .O(new_n99_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n66_), .O(z13));
  inv1   g59(.a(x24), .O(new_n106_));
  xor2a  g60(.a(new_n99_), .b(new_n106_), .O(new_n107_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n98_), .c(new_n80_), .d(new_n64_), .O(new_n115_));
  and2   g69(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g70(.a(x18), .b(x06), .O(new_n117_));
  nand2  g71(.a(new_n59_), .b(x14), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n117_), .c(new_n69_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n67_), .O(new_n120_));
  aoi21  g74(.a(new_n116_), .b(new_n113_), .c(new_n120_), .O(z15));
  nand2  g75(.a(new_n114_), .b(new_n98_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n82_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  aoi21  g79(.a(new_n115_), .b(new_n125_), .c(new_n69_), .O(new_n126_));
  ...
  oai21  g83(.a(new_n59_), .b(x07), .c(new_n129_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n127_), .c(new_n66_), .O(z16));
  inv1   g85(.a(x17), .O(new_n132_));
  nand4  g86(.a(new_n80_), .b(new_n125_), .c(x19), .d(new_n132_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n122_), .c(new_n47_), .d(new_n132_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n67_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
