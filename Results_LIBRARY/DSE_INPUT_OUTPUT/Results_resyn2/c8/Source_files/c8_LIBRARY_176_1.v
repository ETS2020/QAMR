...
module FAU ( 
  ...
  oai22  g009(.a(new_n50_), .b(x13), .c(x27), .d(x24), .O(z05));
  aoi21  g010(.a(new_n48_), .b(x25), .c(z08), .O(z06));
  aoi22  g011(.a(z08), .b(x15), .c(new_n48_), .d(x26), .O(z07));
  nor2   g012(.a(new_n48_), .b(x14), .O(new_n59_));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n75_), .c(new_n59_), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n73_), .O(z10));
  inv1   g034(.a(x21), .O(new_n81_));
  aoi21  g035(.a(new_n65_), .b(new_n70_), .c(new_n81_), .O(new_n82_));
  nor2   g036(.a(x21), .b(x20), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n65_), .O(new_n84_));
  inv1   g038(.a(new_n84_), .O(new_n85_));
  oai21  g039(.a(new_n85_), .b(new_n82_), .c(x16), .O(new_n86_));
  inv1   g040(.a(x10), .O(new_n87_));
  aoi21  g041(.a(new_n77_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g042(.a(new_n77_), .b(x02), .c(new_n88_), .O(new_n89_));
  aoi21  g043(.a(new_n89_), .b(new_n86_), .c(new_n59_), .O(z11));
  inv1   g044(.a(x22), .O(new_n91_));
  aoi21  g045(.a(new_n83_), .b(new_n65_), .c(new_n91_), .O(new_n92_));
  nand3  g046(.a(new_n83_), .b(new_n65_), .c(new_n91_), .O(new_n93_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n83_), .c(new_n65_), .O(new_n102_));
  ...
  nand4  g066(.a(new_n112_), .b(new_n101_), .c(new_n65_), .d(new_n70_), .O(new_n113_));
  ...
  nand4  g077(.a(new_n123_), .b(new_n101_), .c(new_n83_), .d(new_n65_), .O(new_n124_));
  and2   g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g079(.a(x18), .b(x06), .O(new_n126_));
  nand2  g080(.a(new_n77_), .b(x14), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n62_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n60_), .O(new_n129_));
  aoi21  g083(.a(new_n125_), .b(new_n122_), .c(new_n129_), .O(z15));
  inv1   g084(.a(x26), .O(new_n131_));
  nor2   g085(.a(new_n124_), .b(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n124_), .b(new_n131_), .O(new_n133_));
  ...
  aoi21  g091(.a(new_n77_), .b(new_n137_), .c(x16), .O(new_n138_));
  aoi21  g092(.a(new_n138_), .b(new_n136_), .c(new_n59_), .O(new_n139_));
  oai21  g093(.a(new_n134_), .b(new_n132_), .c(new_n139_), .O(z16));
  nand2  g094(.a(new_n123_), .b(new_n101_), .O(new_n141_));
  nand2  g095(.a(x27), .b(x17), .O(new_n142_));
  inv1   g096(.a(x17), .O(new_n143_));
  nand4  g097(.a(new_n83_), .b(new_n131_), .c(x19), .d(new_n143_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n141_), .c(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n60_), .O(z17));
endmodule
