...
module FAU ( 
  ...
  nand4  g35(.a(new_n79_), .b(new_n78_), .c(new_n64_), .d(new_n81_), .O(new_n82_));
  ...
  aoi21  g60(.a(new_n60_), .b(new_n106_), .c(x16), .O(new_n107_));
  ...
  oai21  g69(.a(new_n110_), .b(new_n66_), .c(new_n115_), .O(z14));
  ...
  oai21  g77(.a(x18), .b(x16), .c(new_n47_), .O(new_n124_));
  nand3  g78(.a(x18), .b(new_n66_), .c(x06), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi21  g80(.a(new_n124_), .b(x14), .c(new_n126_), .O(new_n127_));
  oai21  g81(.a(new_n123_), .b(new_n66_), .c(new_n127_), .O(z15));
  inv1   g82(.a(x26), .O(new_n129_));
  nor2   g83(.a(x25), .b(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n100_), .c(new_n97_), .d(new_n71_), .O(new_n131_));
  ...
  aoi21  g92(.a(new_n138_), .b(new_n136_), .c(new_n57_), .O(new_n139_));
  oai21  g93(.a(new_n134_), .b(new_n132_), .c(new_n139_), .O(z16));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n122_), .b(new_n97_), .c(new_n67_), .d(new_n129_), .O(new_n142_));
  nand2  g96(.a(new_n56_), .b(x16), .O(new_n143_));
