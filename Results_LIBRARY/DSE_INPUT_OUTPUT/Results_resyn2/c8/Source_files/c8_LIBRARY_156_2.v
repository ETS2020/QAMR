...
module FAU ( 
  ...
  nand3  g36(.a(new_n65_), .b(new_n81_), .c(new_n71_), .O(new_n83_));
  ...
  nand3  g47(.a(new_n93_), .b(new_n65_), .c(new_n71_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(x16), .O(new_n96_));
  inv1   g50(.a(x11), .O(new_n97_));
  aoi21  g51(.a(new_n58_), .b(new_n97_), .c(x16), .O(new_n98_));
  oai21  g52(.a(new_n58_), .b(x03), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g61(.a(new_n58_), .b(x04), .c(new_n107_), .O(new_n108_));
  ...
  aoi21  g82(.a(new_n128_), .b(new_n126_), .c(new_n68_), .O(new_n129_));
  oai21  g83(.a(new_n124_), .b(new_n110_), .c(new_n129_), .O(z15));
  oai21  g84(.a(new_n122_), .b(new_n83_), .c(x26), .O(new_n131_));
  nor2   g85(.a(x26), .b(x25), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n111_), .c(new_n73_), .d(new_n81_), .O(new_n133_));
  ...
  aoi21  g91(.a(new_n58_), .b(new_n67_), .c(x16), .O(new_n138_));
  aoi21  g92(.a(new_n138_), .b(new_n137_), .c(new_n68_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n135_), .O(z16));
  nor2   g94(.a(x20), .b(new_n63_), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n132_), .c(new_n111_), .d(new_n81_), .O(new_n142_));
  nor2   g96(.a(x17), .b(x15), .O(new_n143_));
