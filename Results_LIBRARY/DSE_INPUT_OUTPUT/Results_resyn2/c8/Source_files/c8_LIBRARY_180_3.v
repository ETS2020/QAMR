...
module FAU ( 
  ...
  nand3  g73(.a(x18), .b(new_n59_), .c(x06), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi21  g75(.a(new_n119_), .b(x14), .c(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n118_), .b(new_n59_), .c(new_n122_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nor3   g78(.a(new_n116_), .b(new_n114_), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g84(.a(new_n130_), .b(new_n128_), .c(new_n80_), .O(new_n131_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n133_), .c(new_n78_), .d(new_n124_), .O(new_n136_));
