...
module FAU ( 
  ...
  aoi21  g44(.a(new_n80_), .b(new_n65_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n80_), .b(new_n65_), .c(new_n90_), .O(new_n92_));
  inv1   g46(.a(new_n92_), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n91_), .c(x16), .O(new_n94_));
  inv1   g48(.a(x11), .O(new_n95_));
  aoi21  g49(.a(new_n75_), .b(new_n95_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n75_), .b(x03), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g59(.a(new_n92_), .b(x23), .c(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n107_), .c(new_n65_), .d(new_n70_), .O(new_n109_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n107_), .c(new_n80_), .d(new_n65_), .O(new_n120_));
  ...
  nor2   g80(.a(new_n47_), .b(new_n57_), .O(new_n127_));
  nand3  g81(.a(new_n119_), .b(new_n107_), .c(new_n57_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  aoi22  g83(.a(new_n129_), .b(new_n82_), .c(new_n127_), .d(new_n120_), .O(new_n130_));
  ...
  nand4  g88(.a(new_n134_), .b(new_n132_), .c(new_n60_), .d(new_n62_), .O(new_n135_));
  oai21  g89(.a(new_n130_), .b(new_n62_), .c(new_n135_), .O(z16));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  inv1   g91(.a(x17), .O(new_n138_));
  nand4  g92(.a(new_n129_), .b(new_n80_), .c(x19), .d(new_n138_), .O(new_n139_));
  aoi21  g93(.a(new_n139_), .b(new_n137_), .c(new_n62_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
