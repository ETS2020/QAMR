...
module FAU ( 
  ...
  nor2   g01(.a(x27), .b(x23), .O(new_n48_));
  ...
  aoi21  g44(.a(new_n60_), .b(new_n90_), .c(x16), .O(new_n91_));
  aoi21  g45(.a(new_n91_), .b(new_n89_), .c(new_n59_), .O(new_n92_));
  oai21  g46(.a(new_n87_), .b(new_n65_), .c(new_n92_), .O(z12));
  inv1   g47(.a(x22), .O(new_n94_));
  nand3  g48(.a(new_n79_), .b(new_n69_), .c(new_n94_), .O(new_n95_));
  nor2   g49(.a(x23), .b(x22), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n79_), .c(new_n69_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x23), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g58(.a(new_n99_), .b(new_n65_), .c(new_n104_), .O(z13));
  nand4  g59(.a(new_n96_), .b(new_n79_), .c(new_n69_), .d(x24), .O(new_n106_));
  inv1   g60(.a(x24), .O(new_n107_));
  nand2  g61(.a(new_n97_), .b(new_n107_), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n106_), .c(x16), .O(new_n109_));
  inv1   g63(.a(x13), .O(new_n110_));
  aoi21  g64(.a(new_n60_), .b(new_n110_), .c(x16), .O(new_n111_));
  oai21  g65(.a(new_n60_), .b(x05), .c(new_n111_), .O(new_n112_));
  aoi21  g66(.a(new_n112_), .b(new_n109_), .c(new_n59_), .O(z14));
  nand4  g67(.a(new_n79_), .b(new_n69_), .c(new_n107_), .d(new_n94_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n96_), .c(new_n79_), .d(new_n69_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g73(.a(x25), .b(x16), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(x27), .c(new_n58_), .O(new_n121_));
  inv1   g75(.a(x06), .O(new_n122_));
  nand2  g76(.a(x18), .b(new_n122_), .O(new_n123_));
  inv1   g77(.a(x14), .O(new_n124_));
  aoi21  g78(.a(new_n60_), .b(new_n124_), .c(x16), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n123_), .c(new_n121_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n119_), .O(z15));
  inv1   g81(.a(x26), .O(new_n128_));
  and2   g82(.a(new_n117_), .b(new_n128_), .O(new_n129_));
  nand2  g83(.a(new_n116_), .b(x26), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n95_), .c(x16), .O(new_n131_));
  nand2  g85(.a(x26), .b(x16), .O(new_n132_));
  aoi21  g86(.a(new_n132_), .b(x27), .c(new_n58_), .O(new_n133_));
  ...
  oai21  g92(.a(new_n131_), .b(new_n129_), .c(new_n138_), .O(z16));
  inv1   g93(.a(new_n59_), .O(new_n140_));
  nand3  g94(.a(new_n128_), .b(x19), .c(new_n64_), .O(new_n141_));
  nand3  g95(.a(new_n116_), .b(new_n96_), .c(new_n79_), .O(new_n142_));
