...
module FAU ( 
  ...
  nor2   g19(.a(x27), .b(x26), .O(new_n66_));
  ...
  oai21  g28(.a(new_n59_), .b(x01), .c(new_n74_), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n72_), .c(new_n66_), .O(z10));
  inv1   g30(.a(x21), .O(new_n77_));
  nor2   g31(.a(new_n71_), .b(new_n77_), .O(new_n78_));
  nand3  g32(.a(new_n64_), .b(new_n77_), .c(new_n69_), .O(new_n79_));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n83_), .c(new_n66_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n81_), .O(z11));
  nand2  g41(.a(new_n79_), .b(x22), .O(new_n88_));
  inv1   g42(.a(x22), .O(new_n89_));
  nand3  g43(.a(new_n71_), .b(new_n89_), .c(new_n77_), .O(new_n90_));
  ...
  aoi21  g49(.a(new_n95_), .b(new_n92_), .c(new_n66_), .O(z12));
  inv1   g50(.a(x16), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  aoi22  g52(.a(new_n98_), .b(new_n80_), .c(new_n90_), .d(x23), .O(new_n99_));
  ...
  oai21  g58(.a(new_n99_), .b(new_n97_), .c(new_n104_), .O(z13));
  nand3  g59(.a(new_n98_), .b(new_n71_), .c(new_n77_), .O(new_n106_));
  nor2   g60(.a(x24), .b(x21), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n98_), .c(new_n64_), .d(new_n69_), .O(new_n108_));
  inv1   g62(.a(new_n108_), .O(new_n109_));
  aoi21  g63(.a(new_n106_), .b(x24), .c(new_n109_), .O(new_n110_));
  ...
  aoi21  g68(.a(new_n114_), .b(new_n112_), .c(new_n66_), .O(new_n115_));
  oai21  g69(.a(new_n110_), .b(new_n97_), .c(new_n115_), .O(z14));
  nand2  g70(.a(new_n108_), .b(x25), .O(new_n117_));
  nor2   g71(.a(x25), .b(x24), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n98_), .c(new_n71_), .d(new_n77_), .O(new_n119_));
  ...
  oai21  g77(.a(new_n59_), .b(x06), .c(new_n123_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n121_), .c(new_n66_), .O(z15));
  nor2   g79(.a(x26), .b(x25), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(x27), .O(new_n127_));
  nor2   g81(.a(new_n127_), .b(new_n108_), .O(new_n128_));
  ...
  nand2  g86(.a(new_n59_), .b(new_n132_), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n131_), .c(new_n67_), .d(new_n97_), .O(new_n134_));
  oai21  g88(.a(new_n129_), .b(new_n97_), .c(new_n134_), .O(z16));
  inv1   g89(.a(x17), .O(new_n136_));
  inv1   g90(.a(x19), .O(new_n137_));
  nor2   g91(.a(x20), .b(new_n137_), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n126_), .c(new_n107_), .d(new_n98_), .O(new_n139_));
  nand2  g93(.a(x27), .b(x16), .O(new_n140_));
