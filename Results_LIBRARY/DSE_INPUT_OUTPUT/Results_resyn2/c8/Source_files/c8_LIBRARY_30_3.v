...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x03), .O(z08));
  ...
  nand2  g43(.a(x18), .b(new_n58_), .O(new_n90_));
  ...
  oai21  g47(.a(new_n89_), .b(new_n66_), .c(new_n93_), .O(z12));
  inv1   g48(.a(x23), .O(new_n95_));
  inv1   g49(.a(x22), .O(new_n96_));
  nand3  g50(.a(new_n81_), .b(new_n71_), .c(new_n96_), .O(new_n97_));
  xor2a  g51(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n81_), .b(new_n71_), .c(new_n95_), .d(new_n96_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n81_), .c(new_n71_), .d(new_n96_), .O(new_n107_));
  ...
  aoi22  g72(.a(new_n118_), .b(new_n83_), .c(new_n107_), .d(x25), .O(new_n119_));
  ...
  aoi21  g77(.a(new_n123_), .b(new_n121_), .c(new_n59_), .O(new_n124_));
  oai21  g78(.a(new_n119_), .b(new_n66_), .c(new_n124_), .O(z15));
  nand3  g79(.a(new_n118_), .b(new_n83_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n116_), .b(new_n106_), .c(new_n81_), .d(new_n71_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n66_), .O(new_n129_));
  ...
  oai21  g86(.a(new_n60_), .b(x07), .c(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n59_), .O(z16));
  nand2  g88(.a(x27), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n118_), .b(new_n81_), .c(new_n67_), .d(new_n127_), .O(new_n136_));
  oai21  g90(.a(new_n47_), .b(new_n58_), .c(x16), .O(new_n137_));
