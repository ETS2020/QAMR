...
module FAU ( 
  ...
  oai21  g33(.a(new_n74_), .b(new_n72_), .c(new_n79_), .O(z10));
  nand2  g34(.a(x18), .b(x02), .O(new_n81_));
  nand2  g35(.a(new_n60_), .b(x10), .O(new_n82_));
  nand3  g36(.a(new_n82_), .b(new_n81_), .c(new_n72_), .O(new_n83_));
  inv1   g37(.a(x21), .O(new_n84_));
  aoi21  g38(.a(new_n67_), .b(new_n73_), .c(new_n84_), .O(new_n85_));
  nor2   g39(.a(x21), .b(x20), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(x16), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n85_), .c(new_n83_), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n70_), .O(z11));
  ...
  aoi21  g49(.a(new_n95_), .b(new_n93_), .c(new_n69_), .O(new_n96_));
  oai21  g50(.a(new_n91_), .b(new_n72_), .c(new_n96_), .O(z12));
  inv1   g51(.a(x22), .O(new_n98_));
  nand3  g52(.a(new_n86_), .b(new_n67_), .c(new_n98_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x23), .O(new_n100_));
  nor2   g54(.a(x23), .b(x22), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n86_), .c(new_n67_), .O(new_n102_));
  ...
  aoi21  g62(.a(new_n108_), .b(new_n106_), .c(new_n69_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n104_), .O(z13));
  nand2  g64(.a(new_n102_), .b(x24), .O(new_n111_));
  nor2   g65(.a(x24), .b(x21), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n101_), .c(new_n67_), .d(new_n73_), .O(new_n113_));
  ...
  aoi21  g73(.a(new_n119_), .b(new_n117_), .c(new_n69_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n115_), .O(z14));
  nand2  g75(.a(new_n113_), .b(x25), .O(new_n122_));
  nor2   g76(.a(x25), .b(x24), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n101_), .c(new_n86_), .d(new_n67_), .O(new_n124_));
  and2   g78(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g79(.a(x18), .b(x06), .O(new_n126_));
  nand2  g80(.a(new_n60_), .b(x14), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n126_), .c(new_n72_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n70_), .O(new_n129_));
  ...
  nand4  g96(.a(new_n142_), .b(new_n141_), .c(new_n112_), .d(new_n101_), .O(new_n143_));
