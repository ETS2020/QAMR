...
module FAU ( 
  ...
  nor2   g18(.a(x18), .b(x16), .O(new_n65_));
  inv1   g19(.a(x18), .O(new_n66_));
  nor2   g20(.a(new_n66_), .b(x16), .O(new_n67_));
  aoi22  g21(.a(new_n67_), .b(x00), .c(new_n65_), .d(x08), .O(new_n68_));
  ...
  aoi22  g25(.a(new_n67_), .b(x01), .c(new_n65_), .d(x09), .O(new_n72_));
  ...
  aoi21  g35(.a(new_n66_), .b(new_n81_), .c(x16), .O(new_n82_));
  oai21  g36(.a(new_n66_), .b(x02), .c(new_n82_), .O(new_n83_));
  ...
  nand3  g41(.a(new_n87_), .b(new_n63_), .c(new_n74_), .O(new_n88_));
  inv1   g42(.a(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n86_), .c(x16), .O(new_n90_));
  inv1   g44(.a(x11), .O(new_n91_));
  aoi21  g45(.a(new_n66_), .b(new_n91_), .c(x16), .O(new_n92_));
  oai21  g46(.a(new_n66_), .b(x03), .c(new_n92_), .O(new_n93_));
  aoi21  g47(.a(new_n93_), .b(new_n90_), .c(new_n59_), .O(z12));
  inv1   g48(.a(x16), .O(new_n95_));
  xor2a  g49(.a(new_n88_), .b(x23), .O(new_n96_));
  ...
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(new_n101_), .O(z13));
  inv1   g56(.a(x23), .O(new_n103_));
  nand4  g57(.a(new_n87_), .b(new_n63_), .c(new_n103_), .d(new_n74_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n87_), .c(new_n63_), .d(new_n74_), .O(new_n107_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n77_), .d(new_n63_), .O(new_n118_));
  and2   g72(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n66_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n95_), .O(new_n122_));
  oai21  g76(.a(x27), .b(new_n58_), .c(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n119_), .b(new_n116_), .c(new_n123_), .O(z15));
  nand2  g78(.a(new_n117_), .b(new_n106_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n79_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  aoi21  g82(.a(new_n118_), .b(new_n128_), .c(new_n95_), .O(new_n129_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n59_), .O(z16));
  nor2   g88(.a(x20), .b(new_n61_), .O(new_n135_));
  nor2   g89(.a(x26), .b(x25), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n106_), .d(new_n87_), .O(new_n137_));
  nor2   g91(.a(x17), .b(x09), .O(new_n138_));
