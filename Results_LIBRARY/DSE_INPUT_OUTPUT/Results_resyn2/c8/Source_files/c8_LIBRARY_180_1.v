...
module FAU ( 
  ...
  aoi21  g09(.a(new_n51_), .b(x25), .c(z08), .O(z06));
  oai22  g10(.a(new_n47_), .b(x15), .c(x27), .d(x26), .O(z07));
  nor2   g11(.a(new_n51_), .b(x14), .O(new_n58_));
  ...
  nand4  g67(.a(new_n98_), .b(new_n80_), .c(new_n66_), .d(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n80_), .b(new_n66_), .O(new_n115_));
  ...
  oai21  g78(.a(new_n119_), .b(new_n60_), .c(new_n124_), .O(z15));
  ...
  nor2   g90(.a(new_n136_), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n135_), .c(new_n80_), .d(new_n126_), .O(new_n138_));
