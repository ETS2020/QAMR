...
module FAU ( 
  ...
  inv1   g32(.a(new_n69_), .O(new_n79_));
  inv1   g33(.a(x22), .O(new_n80_));
  aoi21  g34(.a(new_n74_), .b(new_n67_), .c(new_n80_), .O(new_n81_));
  nand3  g35(.a(new_n74_), .b(new_n67_), .c(new_n80_), .O(new_n82_));
  inv1   g36(.a(new_n82_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(new_n84_));
  nor2   g38(.a(new_n61_), .b(x03), .O(new_n85_));
  oai21  g39(.a(x18), .b(x11), .c(new_n63_), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(z12));
  inv1   g41(.a(x23), .O(new_n88_));
  nand4  g42(.a(new_n74_), .b(new_n67_), .c(new_n88_), .d(new_n80_), .O(new_n89_));
  nand2  g43(.a(new_n82_), .b(x23), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n89_), .c(x27), .O(new_n91_));
  ...
  nand2  g49(.a(new_n89_), .b(x24), .O(new_n96_));
  nor2   g50(.a(x24), .b(x23), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n74_), .c(new_n67_), .d(new_n80_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n79_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n106_), .b(new_n74_), .c(new_n67_), .d(new_n80_), .O(new_n107_));
  ...
  oai21  g70(.a(new_n116_), .b(new_n82_), .c(x27), .O(new_n117_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n74_), .c(new_n80_), .d(x19), .O(new_n125_));
