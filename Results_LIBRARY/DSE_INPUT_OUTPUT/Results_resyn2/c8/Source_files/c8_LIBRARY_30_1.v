...
module FAU ( 
  ...
  nand3  g79(.a(new_n118_), .b(new_n82_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n116_), .b(new_n106_), .c(new_n80_), .d(new_n70_), .O(new_n128_));
  ...
  nand4  g89(.a(new_n118_), .b(new_n80_), .c(new_n66_), .d(new_n127_), .O(new_n136_));
  oai21  g90(.a(new_n49_), .b(x03), .c(x16), .O(new_n137_));
