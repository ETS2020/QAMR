...
module FAU ( 
  ...
  aoi21  g27(.a(new_n65_), .b(new_n68_), .c(new_n73_), .O(new_n74_));
  nor2   g28(.a(x21), .b(x20), .O(new_n75_));
  nand2  g29(.a(new_n75_), .b(new_n65_), .O(new_n76_));
  inv1   g30(.a(new_n76_), .O(new_n77_));
  oai21  g31(.a(new_n77_), .b(new_n74_), .c(new_n63_), .O(new_n78_));
  ...
  nor2   g35(.a(x22), .b(x21), .O(new_n82_));
  nand3  g36(.a(new_n82_), .b(new_n65_), .c(new_n68_), .O(new_n83_));
  nand2  g37(.a(new_n76_), .b(x22), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(new_n83_), .c(new_n47_), .O(new_n85_));
  ...
  nand4  g45(.a(new_n82_), .b(new_n65_), .c(new_n91_), .d(new_n68_), .O(new_n92_));
  nand2  g46(.a(new_n83_), .b(x23), .O(new_n93_));
  ...
  nand4  g55(.a(new_n101_), .b(new_n82_), .c(new_n65_), .d(new_n68_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n63_), .O(new_n104_));
  ...
  nor2   g63(.a(x25), .b(x22), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n101_), .c(new_n75_), .d(new_n65_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n63_), .O(new_n113_));
  ...
  or2    g71(.a(new_n111_), .b(x26), .O(new_n118_));
  aoi21  g72(.a(new_n111_), .b(x26), .c(new_n64_), .O(new_n119_));
  inv1   g73(.a(x15), .O(new_n120_));
  oai21  g74(.a(x18), .b(new_n120_), .c(new_n62_), .O(new_n121_));
  aoi21  g75(.a(x18), .b(x07), .c(new_n121_), .O(new_n122_));
  aoi21  g76(.a(new_n119_), .b(new_n118_), .c(new_n122_), .O(z16));
  inv1   g77(.a(x25), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n124_), .c(new_n68_), .O(new_n126_));
  inv1   g80(.a(x17), .O(new_n127_));
  nand3  g81(.a(new_n63_), .b(x19), .c(new_n127_), .O(new_n128_));
  nand2  g82(.a(new_n101_), .b(new_n82_), .O(new_n129_));
  nor3   g83(.a(new_n129_), .b(new_n128_), .c(new_n126_), .O(z17));
endmodule
