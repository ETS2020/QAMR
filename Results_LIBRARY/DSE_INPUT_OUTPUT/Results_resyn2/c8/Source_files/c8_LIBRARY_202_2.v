...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n49_, new_n51_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  aoi21  g03(.a(new_n49_), .b(x20), .c(x09), .O(z01));
  inv1   g04(.a(new_n47_), .O(new_n51_));
  oai22  g05(.a(new_n51_), .b(x21), .c(new_n49_), .d(x10), .O(z02));
  oai22  g06(.a(new_n51_), .b(x22), .c(new_n49_), .d(x11), .O(z03));
  aoi22  g07(.a(new_n47_), .b(x23), .c(x27), .d(x12), .O(z04));
  aoi22  g08(.a(new_n47_), .b(x24), .c(x27), .d(x13), .O(z05));
  oai22  g09(.a(new_n51_), .b(x25), .c(new_n49_), .d(x14), .O(z06));
  oai22  g10(.a(new_n51_), .b(x26), .c(new_n49_), .d(x15), .O(z07));
  ...
  xor2a  g26(.a(new_n65_), .b(new_n72_), .O(new_n73_));
  inv1   g27(.a(x01), .O(new_n74_));
  nand2  g28(.a(x18), .b(new_n74_), .O(new_n75_));
  aoi21  g29(.a(new_n58_), .b(new_n67_), .c(x16), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n75_), .c(new_n68_), .O(new_n77_));
  oai21  g31(.a(new_n73_), .b(new_n71_), .c(new_n77_), .O(z10));
  inv1   g32(.a(x21), .O(new_n79_));
  aoi21  g33(.a(new_n65_), .b(new_n72_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g41(.a(new_n87_), .b(new_n84_), .c(new_n68_), .O(z11));
  ...
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n68_), .O(new_n94_));
  oai21  g48(.a(new_n89_), .b(new_n71_), .c(new_n94_), .O(z12));
  oai21  g49(.a(new_n82_), .b(x22), .c(x23), .O(new_n96_));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n81_), .c(new_n65_), .O(new_n98_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n102_), .c(new_n68_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n100_), .O(z13));
  nand2  g60(.a(new_n98_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x21), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n97_), .c(new_n65_), .d(new_n72_), .O(new_n109_));
  ...
  oai21  g67(.a(new_n58_), .b(x05), .c(new_n113_), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(new_n111_), .c(new_n68_), .O(z14));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n97_), .c(new_n81_), .d(new_n65_), .O(new_n117_));
  aoi21  g71(.a(new_n109_), .b(x25), .c(new_n71_), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n58_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n71_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n69_), .O(new_n122_));
  ...
  aoi21  g85(.a(new_n131_), .b(new_n129_), .c(new_n68_), .O(new_n132_));
  oai21  g86(.a(new_n127_), .b(new_n125_), .c(new_n132_), .O(z16));
  nor2   g87(.a(x20), .b(new_n63_), .O(new_n134_));
  nor2   g88(.a(x26), .b(x25), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n134_), .c(new_n108_), .d(new_n97_), .O(new_n136_));
  nor2   g90(.a(x17), .b(x09), .O(new_n137_));
  oai21  g91(.a(new_n137_), .b(x27), .c(x16), .O(new_n138_));
  aoi21  g92(.a(new_n136_), .b(new_n62_), .c(new_n138_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
