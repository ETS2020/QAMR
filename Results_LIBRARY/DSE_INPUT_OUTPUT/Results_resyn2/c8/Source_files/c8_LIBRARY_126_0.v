...
module FAU ( 
  ...
  oai21  g67(.a(new_n61_), .b(x05), .c(new_n113_), .O(new_n114_));
  ...
  aoi22  g72(.a(new_n118_), .b(new_n83_), .c(new_n109_), .d(x25), .O(new_n119_));
  ...
  nand3  g78(.a(new_n118_), .b(new_n83_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  nand4  g80(.a(new_n116_), .b(new_n99_), .c(new_n81_), .d(new_n71_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n66_), .O(new_n128_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n129_), .c(new_n60_), .O(z16));
  inv1   g87(.a(new_n60_), .O(new_n134_));
  nand4  g88(.a(new_n81_), .b(new_n126_), .c(x19), .d(new_n65_), .O(new_n135_));
