...
module FAU ( 
  ...
  nand3  g34(.a(new_n66_), .b(new_n79_), .c(new_n71_), .O(new_n81_));
  ...
  nand3  g43(.a(new_n73_), .b(new_n89_), .c(new_n79_), .O(new_n90_));
  ...
  nand3  g51(.a(new_n71_), .b(new_n64_), .c(new_n63_), .O(new_n98_));
  inv1   g52(.a(x23), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n89_), .c(new_n79_), .O(new_n100_));
  nor2   g54(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  aoi21  g55(.a(new_n90_), .b(x23), .c(new_n101_), .O(new_n102_));
  ...
  aoi21  g60(.a(new_n106_), .b(new_n104_), .c(new_n68_), .O(new_n107_));
  oai21  g61(.a(new_n102_), .b(new_n97_), .c(new_n107_), .O(z13));
  oai21  g62(.a(new_n100_), .b(new_n98_), .c(x24), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n73_), .c(new_n110_), .O(new_n112_));
  ...
  oai21  g70(.a(new_n59_), .b(x05), .c(new_n116_), .O(new_n117_));
  aoi21  g71(.a(new_n117_), .b(new_n114_), .c(new_n68_), .O(z14));
  nand3  g72(.a(new_n101_), .b(x25), .c(new_n110_), .O(new_n119_));
  nand2  g73(.a(new_n112_), .b(new_n47_), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(x16), .O(new_n121_));
  ...
  oai21  g83(.a(new_n129_), .b(new_n112_), .c(x27), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nor2   g85(.a(new_n59_), .b(x07), .O(new_n132_));
  oai21  g86(.a(x18), .b(x15), .c(new_n97_), .O(new_n133_));
  nor2   g87(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nor2   g88(.a(x25), .b(x24), .O(new_n135_));
  nand3  g89(.a(new_n135_), .b(new_n101_), .c(x27), .O(new_n136_));
  nor2   g90(.a(new_n128_), .b(new_n97_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n136_), .c(new_n134_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n131_), .O(z16));
  nor2   g93(.a(x20), .b(new_n64_), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n135_), .c(new_n111_), .d(new_n128_), .O(new_n141_));
