...
module FAU ( 
  ...
  oai21  g14(.a(x19), .b(x17), .c(x27), .O(new_n61_));
  ...
  aoi21  g23(.a(new_n69_), .b(new_n68_), .c(new_n47_), .O(new_n70_));
  oai21  g24(.a(new_n69_), .b(new_n68_), .c(new_n70_), .O(new_n71_));
  nand2  g25(.a(new_n71_), .b(x16), .O(new_n72_));
  nor2   g26(.a(new_n63_), .b(x01), .O(new_n73_));
  oai21  g27(.a(x18), .b(x09), .c(new_n65_), .O(new_n74_));
  oai21  g28(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z10));
  inv1   g29(.a(x21), .O(new_n76_));
  aoi21  g30(.a(new_n69_), .b(new_n68_), .c(new_n76_), .O(new_n77_));
  ...
  nor2   g35(.a(new_n63_), .b(x02), .O(new_n82_));
  oai21  g36(.a(x18), .b(x10), .c(new_n65_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z11));
  xor2a  g38(.a(new_n79_), .b(x22), .O(new_n85_));
  nand2  g39(.a(x27), .b(x16), .O(new_n86_));
  nor2   g40(.a(new_n63_), .b(x03), .O(new_n87_));
  oai21  g41(.a(x18), .b(x11), .c(new_n65_), .O(new_n88_));
  oai22  g42(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(z12));
  inv1   g43(.a(x22), .O(new_n90_));
  inv1   g44(.a(x23), .O(new_n91_));
  nand4  g45(.a(new_n78_), .b(new_n69_), .c(new_n91_), .d(new_n90_), .O(new_n92_));
  nand3  g46(.a(new_n78_), .b(new_n69_), .c(new_n90_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(x23), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n92_), .c(x27), .O(new_n95_));
  ...
  nand4  g54(.a(new_n100_), .b(new_n78_), .c(new_n69_), .d(new_n90_), .O(new_n101_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n78_), .c(new_n69_), .d(new_n90_), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n108_), .c(x27), .O(new_n111_));
  ...
  oai21  g73(.a(new_n119_), .b(new_n93_), .c(x27), .O(new_n120_));
  ...
  inv1   g79(.a(new_n119_), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n78_), .c(new_n90_), .d(x19), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n58_), .c(new_n86_), .O(z17));
endmodule
