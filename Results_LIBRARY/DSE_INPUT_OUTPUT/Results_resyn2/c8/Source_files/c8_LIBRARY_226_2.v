...
module FAU ( 
  ...
  inv1   g23(.a(x16), .O(new_n70_));
  inv1   g24(.a(x20), .O(new_n71_));
  xor2a  g25(.a(new_n63_), .b(new_n71_), .O(new_n72_));
  inv1   g26(.a(x01), .O(new_n73_));
  nand2  g27(.a(x18), .b(new_n73_), .O(new_n74_));
  inv1   g28(.a(x09), .O(new_n75_));
  aoi21  g29(.a(new_n65_), .b(new_n75_), .c(x16), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n59_), .O(new_n77_));
  oai21  g31(.a(new_n72_), .b(new_n70_), .c(new_n77_), .O(z10));
  inv1   g32(.a(x21), .O(new_n79_));
  aoi21  g33(.a(new_n63_), .b(new_n71_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g46(.a(new_n65_), .b(new_n92_), .c(x16), .O(new_n93_));
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n59_), .O(new_n94_));
  oai21  g48(.a(new_n89_), .b(new_n70_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x22), .O(new_n96_));
  nand3  g50(.a(new_n81_), .b(new_n63_), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n81_), .c(new_n63_), .O(new_n100_));
  ...
  nand4  g64(.a(new_n110_), .b(new_n99_), .c(new_n63_), .d(new_n71_), .O(new_n111_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n99_), .c(new_n81_), .d(new_n63_), .O(new_n122_));
  ...
  aoi21  g98(.a(new_n142_), .b(new_n60_), .c(new_n144_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
