...
module FAU ( 
  ...
  nand3  g43(.a(new_n85_), .b(new_n70_), .c(new_n69_), .O(new_n90_));
  xor2a  g44(.a(new_n90_), .b(x23), .O(new_n91_));
  nor2   g45(.a(new_n58_), .b(x04), .O(new_n92_));
  oai21  g46(.a(x18), .b(x12), .c(new_n60_), .O(new_n93_));
  oai22  g47(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n64_), .O(z13));
  inv1   g48(.a(x23), .O(new_n95_));
  nand4  g49(.a(new_n85_), .b(new_n70_), .c(new_n95_), .d(new_n69_), .O(new_n96_));
  inv1   g50(.a(x22), .O(new_n97_));
  inv1   g51(.a(x24), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n95_), .c(new_n97_), .d(new_n77_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n72_), .c(new_n96_), .d(x24), .O(new_n101_));
  ...
  oai21  g58(.a(new_n101_), .b(new_n64_), .c(new_n104_), .O(z14));
  inv1   g59(.a(x14), .O(new_n106_));
  oai21  g60(.a(x18), .b(new_n106_), .c(new_n60_), .O(new_n107_));
  aoi21  g61(.a(x18), .b(x06), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n100_), .b(new_n72_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x25), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nor2   g65(.a(x25), .b(x22), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n111_), .c(new_n78_), .d(new_n70_), .O(new_n113_));
  and2   g67(.a(new_n113_), .b(new_n65_), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(z15));
  ...
  nor4   g78(.a(new_n124_), .b(new_n99_), .c(new_n66_), .d(new_n64_), .O(z17));
endmodule
