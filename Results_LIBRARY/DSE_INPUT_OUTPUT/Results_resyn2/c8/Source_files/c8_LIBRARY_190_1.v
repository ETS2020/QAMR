...
module FAU ( 
  ...
  nor2   g11(.a(new_n47_), .b(x02), .O(new_n58_));
  ...
  aoi21  g34(.a(new_n80_), .b(new_n66_), .c(new_n60_), .O(new_n81_));
  nand2  g35(.a(x18), .b(x02), .O(new_n82_));
  nand2  g36(.a(new_n62_), .b(x10), .O(new_n83_));
  nand3  g37(.a(new_n83_), .b(new_n82_), .c(new_n60_), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n59_), .O(new_n85_));
  aoi21  g39(.a(new_n81_), .b(new_n79_), .c(new_n85_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n80_), .b(new_n66_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n80_), .b(new_n66_), .c(new_n87_), .O(new_n89_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n80_), .c(new_n66_), .O(new_n98_));
  ...
  aoi21  g62(.a(new_n62_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n62_), .b(x05), .c(new_n109_), .O(new_n110_));
  ...
  nand4  g67(.a(new_n113_), .b(new_n97_), .c(new_n80_), .d(new_n66_), .O(new_n114_));
  ...
  aoi21  g73(.a(new_n62_), .b(new_n119_), .c(x16), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n58_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n116_), .O(z15));
  nand2  g76(.a(new_n114_), .b(x26), .O(new_n123_));
  nor3   g77(.a(x26), .b(x23), .c(x22), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n113_), .c(new_n80_), .d(new_n66_), .O(new_n125_));
  ...
  nand3  g89(.a(new_n113_), .b(new_n97_), .c(new_n135_), .O(new_n136_));
  nand3  g90(.a(new_n80_), .b(x19), .c(new_n134_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n47_), .d(new_n134_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n59_), .O(z17));
endmodule
