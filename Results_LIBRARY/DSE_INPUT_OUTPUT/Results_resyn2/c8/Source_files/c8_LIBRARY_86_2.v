...
module FAU ( 
  ...
  nor2   g00(.a(x27), .b(x15), .O(new_n47_));
  ...
  aoi21  g10(.a(new_n50_), .b(x26), .c(x15), .O(z07));
  nand2  g11(.a(new_n50_), .b(x15), .O(new_n58_));
  ...
  nand3  g50(.a(new_n80_), .b(new_n70_), .c(new_n96_), .O(new_n97_));
  ...
  nand4  g57(.a(new_n80_), .b(new_n70_), .c(new_n95_), .d(new_n96_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n80_), .c(new_n70_), .d(new_n96_), .O(new_n107_));
  ...
  aoi22  g72(.a(new_n118_), .b(new_n82_), .c(new_n107_), .d(x25), .O(new_n119_));
  ...
  nand3  g80(.a(new_n116_), .b(new_n106_), .c(new_n126_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n82_), .O(new_n129_));
  nand4  g83(.a(new_n116_), .b(new_n106_), .c(new_n80_), .d(new_n70_), .O(new_n130_));
  ...
  nand3  g87(.a(new_n133_), .b(new_n132_), .c(new_n65_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n58_), .O(new_n135_));
  aoi21  g89(.a(new_n131_), .b(new_n129_), .c(new_n135_), .O(z16));
  nand3  g90(.a(new_n80_), .b(x19), .c(new_n64_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n127_), .c(new_n50_), .d(new_n64_), .O(new_n138_));
