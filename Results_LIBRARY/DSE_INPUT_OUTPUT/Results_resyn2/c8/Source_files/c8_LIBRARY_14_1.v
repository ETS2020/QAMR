...
module FAU ( 
  ...
  nor2   g91(.a(new_n77_), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n119_), .c(new_n90_), .d(new_n127_), .O(new_n139_));
  aoi21  g93(.a(new_n139_), .b(new_n137_), .c(new_n65_), .O(z17));
endmodule
