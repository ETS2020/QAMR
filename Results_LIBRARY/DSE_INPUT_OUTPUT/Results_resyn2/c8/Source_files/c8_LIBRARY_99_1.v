...
module FAU ( 
  ...
  aoi21  g16(.a(x19), .b(x17), .c(new_n58_), .O(new_n63_));
  oai21  g17(.a(x19), .b(x17), .c(new_n63_), .O(new_n64_));
  nor2   g18(.a(new_n47_), .b(x08), .O(new_n65_));
  ...
  aoi21  g28(.a(new_n74_), .b(new_n71_), .c(new_n65_), .O(z10));
  ...
  oai21  g46(.a(new_n87_), .b(new_n58_), .c(new_n92_), .O(z12));
  oai21  g47(.a(new_n80_), .b(x22), .c(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n79_), .c(new_n69_), .O(new_n96_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n100_), .c(new_n65_), .O(new_n103_));
  ...
  nand4  g65(.a(new_n95_), .b(new_n79_), .c(new_n69_), .d(new_n105_), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n95_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n81_), .c(new_n112_), .d(x25), .O(new_n116_));
  ...
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n65_), .O(new_n121_));
  oai21  g75(.a(new_n116_), .b(new_n58_), .c(new_n121_), .O(z15));
  nand3  g76(.a(new_n115_), .b(new_n81_), .c(x26), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  nand4  g78(.a(new_n113_), .b(new_n95_), .c(new_n79_), .d(new_n69_), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n124_), .c(new_n58_), .O(new_n126_));
  ...
  nand4  g86(.a(new_n79_), .b(new_n124_), .c(x19), .d(new_n132_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n114_), .c(new_n47_), .d(new_n132_), .O(new_n134_));
