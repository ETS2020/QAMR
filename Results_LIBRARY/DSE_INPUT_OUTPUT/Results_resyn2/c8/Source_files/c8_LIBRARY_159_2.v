...
module FAU ( 
  ...
  nand2  g52(.a(new_n91_), .b(new_n72_), .O(new_n99_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n72_), .c(new_n99_), .d(x23), .O(new_n101_));
  oai21  g55(.a(x18), .b(x16), .c(x27), .O(new_n102_));
  inv1   g56(.a(x04), .O(new_n103_));
  nor2   g57(.a(x16), .b(new_n103_), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(x18), .c(new_n102_), .d(x12), .O(new_n105_));
  oai21  g59(.a(new_n101_), .b(new_n80_), .c(new_n105_), .O(z13));
  inv1   g60(.a(x22), .O(new_n107_));
  inv1   g61(.a(x23), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n107_), .c(new_n89_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n81_), .c(x24), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  nand3  g65(.a(new_n100_), .b(new_n72_), .c(new_n111_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n91_), .b(new_n111_), .c(new_n108_), .O(new_n120_));
  ...
  nand2  g80(.a(new_n65_), .b(x14), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n126_), .c(new_n80_), .O(new_n128_));
  oai21  g82(.a(x27), .b(new_n58_), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g95(.a(new_n141_), .b(new_n121_), .c(new_n70_), .d(x19), .O(new_n142_));
  nor2   g96(.a(x17), .b(x12), .O(new_n143_));
