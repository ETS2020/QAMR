...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n52_, new_n53_, new_n57_, new_n58_, new_n59_, new_n61_,
  ...
  aoi21  g09(.a(new_n52_), .b(x25), .c(new_n53_), .O(z06));
  inv1   g10(.a(x26), .O(new_n57_));
  nor2   g11(.a(new_n52_), .b(x14), .O(new_n58_));
  aoi21  g12(.a(new_n52_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  oai21  g13(.a(new_n52_), .b(x15), .c(new_n59_), .O(z07));
  ...
  aoi21  g58(.a(new_n64_), .b(new_n104_), .c(x16), .O(new_n105_));
  oai21  g59(.a(new_n64_), .b(x04), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g67(.a(new_n108_), .b(new_n62_), .c(new_n113_), .O(z14));
  oai21  g68(.a(new_n101_), .b(x24), .c(x25), .O(new_n115_));
  nand2  g69(.a(new_n82_), .b(new_n68_), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n100_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n62_), .O(new_n120_));
  ...
  aoi21  g78(.a(new_n120_), .b(new_n115_), .c(new_n124_), .O(z15));
  nor3   g79(.a(new_n118_), .b(new_n116_), .c(new_n57_), .O(new_n126_));
  oai21  g80(.a(new_n119_), .b(x26), .c(x16), .O(new_n127_));
  inv1   g81(.a(x07), .O(new_n128_));
  nand2  g82(.a(x18), .b(new_n128_), .O(new_n129_));
  inv1   g83(.a(x15), .O(new_n130_));
  aoi21  g84(.a(new_n64_), .b(new_n130_), .c(x16), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n129_), .c(new_n58_), .O(new_n132_));
  oai21  g86(.a(new_n127_), .b(new_n126_), .c(new_n132_), .O(z16));
  inv1   g87(.a(new_n118_), .O(new_n134_));
  inv1   g88(.a(x19), .O(new_n135_));
  nor2   g89(.a(new_n135_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n134_), .c(new_n82_), .d(new_n57_), .O(new_n137_));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  nand2  g92(.a(new_n61_), .b(x16), .O(new_n139_));
  aoi21  g93(.a(new_n138_), .b(new_n137_), .c(new_n139_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
