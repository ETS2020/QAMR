...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n54_, new_n60_, new_n61_,
  ...
  nand2  g07(.a(x27), .b(new_n47_), .O(new_n54_));
  oai21  g08(.a(new_n51_), .b(x22), .c(new_n54_), .O(z03));
  ...
  inv1   g30(.a(new_n60_), .O(new_n77_));
  nand2  g31(.a(x18), .b(x02), .O(new_n78_));
  nand2  g32(.a(new_n61_), .b(x10), .O(new_n79_));
  nand3  g33(.a(new_n79_), .b(new_n78_), .c(new_n66_), .O(new_n80_));
  ...
  nand3  g44(.a(new_n84_), .b(new_n70_), .c(new_n90_), .O(new_n91_));
  ...
  nand2  g49(.a(new_n95_), .b(new_n77_), .O(new_n96_));
  aoi21  g50(.a(new_n92_), .b(new_n89_), .c(new_n96_), .O(z12));
  ...
  nand4  g64(.a(new_n110_), .b(new_n99_), .c(new_n70_), .d(new_n81_), .O(new_n111_));
  ...
  oai21  g69(.a(new_n61_), .b(x05), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n99_), .c(new_n84_), .d(new_n70_), .O(new_n120_));
  and2   g74(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n61_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n66_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n77_), .O(new_n125_));
  aoi21  g79(.a(new_n121_), .b(new_n118_), .c(new_n125_), .O(z15));
  inv1   g80(.a(new_n85_), .O(new_n127_));
  nand2  g81(.a(new_n119_), .b(new_n99_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n127_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  aoi21  g85(.a(new_n120_), .b(new_n131_), .c(new_n66_), .O(new_n132_));
  ...
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n60_), .O(z16));
  nand4  g91(.a(new_n84_), .b(new_n131_), .c(x19), .d(new_n65_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n128_), .c(new_n50_), .d(new_n65_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n77_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
