...
module FAU ( 
  ...
  aoi21  g31(.a(new_n69_), .b(new_n68_), .c(new_n77_), .O(new_n78_));
  ...
  aoi21  g37(.a(new_n59_), .b(new_n83_), .c(x16), .O(new_n84_));
  oai21  g38(.a(new_n59_), .b(x02), .c(new_n84_), .O(new_n85_));
  ...
  aoi21  g44(.a(new_n59_), .b(new_n90_), .c(x16), .O(new_n91_));
  aoi21  g45(.a(new_n91_), .b(new_n89_), .c(new_n58_), .O(new_n92_));
  oai21  g46(.a(new_n87_), .b(new_n64_), .c(new_n92_), .O(z12));
  ...
  nand3  g51(.a(new_n97_), .b(new_n79_), .c(new_n69_), .O(new_n98_));
  ...
  nand4  g60(.a(new_n97_), .b(new_n79_), .c(new_n69_), .d(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(x16), .O(new_n109_));
  inv1   g63(.a(x13), .O(new_n110_));
  aoi21  g64(.a(new_n59_), .b(new_n110_), .c(x16), .O(new_n111_));
  oai21  g65(.a(new_n59_), .b(x05), .c(new_n111_), .O(new_n112_));
  aoi21  g66(.a(new_n112_), .b(new_n109_), .c(new_n58_), .O(z14));
  ...
  nand4  g79(.a(new_n114_), .b(new_n97_), .c(new_n79_), .d(new_n69_), .O(new_n126_));
  ...
  inv1   g86(.a(new_n58_), .O(new_n133_));
  nand4  g87(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n63_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n115_), .c(new_n49_), .d(new_n63_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n133_), .O(z17));
endmodule
