...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n55_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  aoi21  g004(.a(x27), .b(x10), .c(x21), .O(z02));
  aoi22  g005(.a(new_n48_), .b(x11), .c(new_n47_), .d(x22), .O(z03));
  aoi22  g006(.a(new_n48_), .b(x12), .c(new_n47_), .d(x23), .O(z04));
  aoi22  g007(.a(new_n48_), .b(x13), .c(new_n47_), .d(x24), .O(z05));
  inv1   g008(.a(new_n48_), .O(new_n55_));
  oai22  g009(.a(new_n55_), .b(x14), .c(x27), .d(x25), .O(z06));
  oai22  g010(.a(new_n55_), .b(x15), .c(x27), .d(x26), .O(z07));
  ...
  nor2   g029(.a(new_n70_), .b(new_n58_), .O(new_n76_));
  nand3  g030(.a(new_n60_), .b(new_n58_), .c(new_n68_), .O(new_n77_));
  ...
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n59_), .O(new_n84_));
  nand2  g038(.a(new_n84_), .b(new_n79_), .O(z11));
  inv1   g039(.a(x22), .O(new_n86_));
  nand2  g040(.a(new_n77_), .b(new_n86_), .O(new_n87_));
  nand2  g041(.a(new_n78_), .b(x22), .O(new_n88_));
  ...
  aoi21  g046(.a(new_n63_), .b(new_n92_), .c(x16), .O(new_n93_));
  aoi21  g047(.a(new_n93_), .b(new_n91_), .c(new_n59_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n89_), .O(z12));
  inv1   g049(.a(x23), .O(new_n96_));
  aoi21  g050(.a(new_n70_), .b(new_n86_), .c(new_n96_), .O(new_n97_));
  nand4  g051(.a(new_n60_), .b(new_n96_), .c(new_n86_), .d(new_n68_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n58_), .O(new_n99_));
  inv1   g053(.a(x16), .O(new_n100_));
  nand2  g054(.a(new_n47_), .b(x23), .O(new_n101_));
  aoi21  g055(.a(new_n101_), .b(x21), .c(new_n100_), .O(new_n102_));
  oai21  g056(.a(new_n99_), .b(new_n97_), .c(new_n102_), .O(new_n103_));
  nor2   g057(.a(new_n59_), .b(x16), .O(new_n104_));
  inv1   g058(.a(x12), .O(new_n105_));
  nand2  g059(.a(new_n63_), .b(new_n105_), .O(new_n106_));
  inv1   g060(.a(x04), .O(new_n107_));
  nand2  g061(.a(x18), .b(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n103_), .O(z13));
  nand2  g064(.a(new_n98_), .b(x24), .O(new_n111_));
  nor3   g065(.a(x24), .b(x23), .c(x22), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n70_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n111_), .c(new_n58_), .O(new_n114_));
  nand2  g068(.a(new_n47_), .b(x24), .O(new_n115_));
  aoi21  g069(.a(new_n115_), .b(x21), .c(new_n100_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n119_), .c(new_n104_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n117_), .O(z14));
  inv1   g077(.a(x25), .O(new_n124_));
  oai21  g078(.a(new_n113_), .b(x21), .c(new_n124_), .O(new_n125_));
  nand4  g079(.a(new_n112_), .b(new_n70_), .c(x25), .d(new_n58_), .O(new_n126_));
  nor2   g080(.a(new_n59_), .b(new_n100_), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n130_), .c(new_n104_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n128_), .O(z15));
  nand3  g088(.a(new_n112_), .b(new_n70_), .c(new_n124_), .O(new_n135_));
  inv1   g089(.a(x24), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n96_), .c(new_n86_), .O(new_n137_));
  inv1   g091(.a(x26), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n124_), .O(new_n139_));
  ...
  aoi21  g096(.a(new_n142_), .b(new_n47_), .c(new_n58_), .O(new_n143_));
  ...
  oai21  g102(.a(new_n141_), .b(new_n100_), .c(new_n148_), .O(z16));
  oai21  g103(.a(x21), .b(x17), .c(x27), .O(new_n150_));
  nor2   g104(.a(x21), .b(x17), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n68_), .d(x19), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n150_), .c(new_n104_), .O(z17));
