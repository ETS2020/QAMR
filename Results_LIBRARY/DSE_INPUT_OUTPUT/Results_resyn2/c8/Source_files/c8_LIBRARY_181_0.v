...
module FAU ( 
  ...
  xor2a  g43(.a(new_n82_), .b(x22), .O(new_n90_));
  ...
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n81_), .b(new_n67_), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x23), .O(new_n99_));
  nor2   g53(.a(x23), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n81_), .c(new_n67_), .O(new_n101_));
  ...
  nand4  g65(.a(new_n111_), .b(new_n100_), .c(new_n67_), .d(new_n78_), .O(new_n112_));
  ...
  nand4  g95(.a(new_n141_), .b(new_n140_), .c(new_n111_), .d(new_n100_), .O(new_n142_));
