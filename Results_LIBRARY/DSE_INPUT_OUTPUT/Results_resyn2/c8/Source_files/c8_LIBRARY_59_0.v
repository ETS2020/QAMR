...
module FAU ( 
  ...
  nand2  g25(.a(x18), .b(new_n48_), .O(new_n72_));
  ...
  oai21  g29(.a(new_n71_), .b(new_n65_), .c(new_n75_), .O(z10));
  nand2  g30(.a(new_n70_), .b(new_n69_), .O(new_n77_));
  nor2   g31(.a(x21), .b(x20), .O(new_n78_));
  aoi22  g32(.a(new_n78_), .b(new_n70_), .c(new_n77_), .d(x21), .O(new_n79_));
  ...
  aoi21  g40(.a(new_n78_), .b(new_n70_), .c(new_n86_), .O(new_n87_));
  nand3  g41(.a(new_n78_), .b(new_n70_), .c(new_n86_), .O(new_n88_));
  ...
  nand3  g50(.a(new_n96_), .b(new_n78_), .c(new_n70_), .O(new_n97_));
  ...
  nand4  g66(.a(new_n96_), .b(new_n78_), .c(new_n70_), .d(new_n106_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n96_), .c(new_n78_), .d(new_n70_), .O(new_n116_));
  ...
  nand2  g78(.a(new_n116_), .b(x26), .O(new_n125_));
  nor3   g79(.a(x26), .b(x23), .c(x22), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n115_), .c(new_n78_), .d(new_n70_), .O(new_n127_));
  ...
  inv1   g89(.a(new_n59_), .O(new_n136_));
  inv1   g90(.a(x26), .O(new_n137_));
  nand3  g91(.a(new_n115_), .b(new_n96_), .c(new_n137_), .O(new_n138_));
  nand3  g92(.a(new_n78_), .b(x19), .c(new_n64_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n47_), .d(new_n64_), .O(new_n140_));
