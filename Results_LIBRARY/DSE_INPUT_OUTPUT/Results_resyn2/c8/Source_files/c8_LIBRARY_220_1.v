...
module FAU ( 
  ...
  aoi22  g31(.a(new_n77_), .b(new_n68_), .c(new_n76_), .d(x21), .O(new_n78_));
  inv1   g32(.a(x02), .O(new_n79_));
  nand2  g33(.a(x18), .b(new_n79_), .O(new_n80_));
  inv1   g34(.a(x10), .O(new_n81_));
  aoi21  g35(.a(new_n59_), .b(new_n81_), .c(x16), .O(new_n82_));
  aoi21  g36(.a(new_n82_), .b(new_n80_), .c(new_n58_), .O(new_n83_));
  oai21  g37(.a(new_n78_), .b(new_n64_), .c(new_n83_), .O(z11));
  inv1   g38(.a(x22), .O(new_n85_));
  aoi21  g39(.a(new_n77_), .b(new_n68_), .c(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n77_), .b(new_n68_), .c(new_n85_), .O(new_n87_));
  ...
  aoi21  g56(.a(new_n102_), .b(new_n100_), .c(new_n58_), .O(new_n103_));
  ...
  aoi21  g62(.a(new_n59_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n59_), .b(x05), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n110_), .b(new_n107_), .c(new_n58_), .O(z14));
  nand4  g65(.a(new_n95_), .b(new_n77_), .c(new_n68_), .d(new_n105_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n95_), .c(new_n77_), .d(new_n68_), .O(new_n115_));
  ...
  nand2  g77(.a(new_n115_), .b(x26), .O(new_n124_));
  nor3   g78(.a(x26), .b(x23), .c(x22), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n114_), .c(new_n77_), .d(new_n68_), .O(new_n126_));
  ...
  nand3  g90(.a(new_n114_), .b(new_n95_), .c(new_n136_), .O(new_n137_));
  nand3  g91(.a(new_n77_), .b(x19), .c(new_n63_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n50_), .d(new_n63_), .O(new_n139_));
