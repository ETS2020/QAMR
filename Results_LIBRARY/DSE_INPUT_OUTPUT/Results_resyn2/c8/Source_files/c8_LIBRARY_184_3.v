...
module FAU ( 
  ...
  aoi21  g46(.a(new_n92_), .b(new_n90_), .c(new_n57_), .O(new_n93_));
  ...
  oai21  g67(.a(new_n108_), .b(new_n60_), .c(new_n113_), .O(z14));
  oai21  g68(.a(new_n99_), .b(x24), .c(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n80_), .d(new_n66_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n62_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n60_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n56_), .O(new_n122_));
  ...
  aoi21  g84(.a(new_n62_), .b(new_n130_), .c(x16), .O(new_n131_));
  ...
  nand2  g93(.a(new_n139_), .b(new_n56_), .O(z17));
endmodule
