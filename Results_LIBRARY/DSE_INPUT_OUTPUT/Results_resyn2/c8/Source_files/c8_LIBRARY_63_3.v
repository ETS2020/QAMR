...
module FAU ( 
  ...
  nand2  g04(.a(new_n47_), .b(x20), .O(z01));
  ...
  aoi21  g44(.a(new_n90_), .b(new_n88_), .c(new_n66_), .O(new_n91_));
  oai21  g45(.a(new_n86_), .b(new_n74_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x22), .O(new_n93_));
  nand3  g47(.a(new_n81_), .b(new_n63_), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(x23), .O(new_n95_));
  nor2   g49(.a(x23), .b(x22), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n81_), .c(new_n63_), .O(new_n97_));
  ...
  nand4  g59(.a(new_n105_), .b(new_n96_), .c(new_n63_), .d(new_n78_), .O(new_n106_));
  ...
  nand3  g86(.a(new_n81_), .b(new_n126_), .c(x19), .O(new_n133_));
  nor2   g87(.a(new_n133_), .b(new_n123_), .O(new_n134_));
  aoi21  g88(.a(new_n47_), .b(x17), .c(new_n74_), .O(new_n135_));
  oai21  g89(.a(new_n134_), .b(x17), .c(new_n135_), .O(new_n136_));
