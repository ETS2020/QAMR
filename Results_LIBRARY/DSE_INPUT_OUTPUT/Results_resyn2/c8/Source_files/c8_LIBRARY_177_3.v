...
module FAU ( 
  ...
  aoi21  g007(.a(x27), .b(x13), .c(x24), .O(z05));
  inv1   g008(.a(x14), .O(new_n55_));
  nand2  g009(.a(new_n48_), .b(new_n55_), .O(new_n56_));
  oai21  g010(.a(x27), .b(x25), .c(new_n56_), .O(z06));
  aoi22  g011(.a(new_n48_), .b(x15), .c(new_n47_), .d(x26), .O(z07));
  ...
  nand3  g032(.a(new_n78_), .b(new_n74_), .c(new_n61_), .O(z10));
  inv1   g033(.a(x21), .O(new_n80_));
  aoi21  g034(.a(new_n66_), .b(new_n71_), .c(new_n80_), .O(new_n81_));
  ...
  aoi21  g047(.a(new_n75_), .b(new_n93_), .c(x16), .O(new_n94_));
  aoi21  g048(.a(new_n94_), .b(new_n92_), .c(new_n60_), .O(new_n95_));
  oai21  g049(.a(new_n90_), .b(new_n63_), .c(new_n95_), .O(z12));
  nand2  g050(.a(x18), .b(x04), .O(new_n97_));
  nand2  g051(.a(new_n75_), .b(x12), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n97_), .c(new_n63_), .O(new_n99_));
  inv1   g053(.a(x22), .O(new_n100_));
  inv1   g054(.a(x23), .O(new_n101_));
  nand4  g055(.a(new_n82_), .b(new_n66_), .c(new_n101_), .d(new_n100_), .O(new_n102_));
  nand3  g056(.a(new_n82_), .b(new_n66_), .c(new_n100_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x23), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n102_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n99_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n61_), .O(z13));
  nor2   g061(.a(new_n60_), .b(x16), .O(new_n108_));
  inv1   g062(.a(x13), .O(new_n109_));
  nand2  g063(.a(new_n75_), .b(new_n109_), .O(new_n110_));
  inv1   g064(.a(x05), .O(new_n111_));
  nand2  g065(.a(x18), .b(new_n111_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n110_), .c(new_n108_), .O(new_n113_));
  nor2   g067(.a(new_n102_), .b(new_n59_), .O(new_n114_));
  inv1   g068(.a(new_n102_), .O(new_n115_));
  nor2   g069(.a(x27), .b(new_n59_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n115_), .c(x16), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(new_n113_), .O(z14));
  nand2  g072(.a(new_n102_), .b(x25), .O(new_n119_));
  nor3   g073(.a(x25), .b(x24), .c(x23), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n82_), .c(new_n66_), .d(new_n100_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(x25), .b(x16), .O(new_n124_));
  aoi21  g078(.a(new_n124_), .b(new_n47_), .c(new_n59_), .O(new_n125_));
  inv1   g079(.a(x06), .O(new_n126_));
  nand2  g080(.a(x18), .b(new_n126_), .O(new_n127_));
  aoi21  g081(.a(new_n75_), .b(new_n55_), .c(x16), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(new_n127_), .c(new_n125_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n123_), .O(z15));
  nor2   g084(.a(x25), .b(x23), .O(new_n131_));
  nor2   g085(.a(x22), .b(x21), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n131_), .c(new_n66_), .d(new_n71_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x26), .O(new_n134_));
  nor2   g088(.a(x26), .b(x22), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n131_), .c(new_n82_), .d(new_n66_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n134_), .c(new_n59_), .O(new_n137_));
  nand2  g091(.a(new_n47_), .b(x26), .O(new_n138_));
  aoi21  g092(.a(new_n138_), .b(x24), .c(new_n63_), .O(new_n139_));
  ...
  nand3  g098(.a(new_n144_), .b(new_n142_), .c(new_n108_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n135_), .c(new_n131_), .d(new_n82_), .O(new_n150_));
