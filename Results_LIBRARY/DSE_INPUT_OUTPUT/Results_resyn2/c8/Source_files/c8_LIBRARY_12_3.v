...
module FAU ( 
  ...
  aoi21  g45(.a(new_n91_), .b(new_n89_), .c(new_n57_), .O(new_n92_));
  ...
  aoi21  g54(.a(new_n100_), .b(new_n98_), .c(new_n57_), .O(new_n101_));
  oai21  g55(.a(new_n96_), .b(new_n65_), .c(new_n101_), .O(z13));
  ...
  oai21  g77(.a(new_n119_), .b(new_n65_), .c(new_n123_), .O(z15));
  nand3  g78(.a(new_n118_), .b(new_n81_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  nand4  g80(.a(new_n116_), .b(new_n106_), .c(new_n79_), .d(new_n69_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n65_), .O(new_n128_));
  ...
  nand4  g87(.a(new_n79_), .b(new_n126_), .c(x19), .d(new_n64_), .O(new_n134_));
