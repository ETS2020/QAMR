...
module FAU ( 
  ...
  aoi21  g29(.a(new_n59_), .b(x10), .c(new_n61_), .O(new_n76_));
  ...
  nand4  g34(.a(new_n80_), .b(new_n68_), .c(new_n79_), .d(new_n64_), .O(new_n81_));
  inv1   g35(.a(new_n81_), .O(new_n82_));
  nor2   g36(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  aoi22  g37(.a(new_n83_), .b(new_n78_), .c(new_n76_), .d(new_n75_), .O(z11));
  ...
  nand4  g79(.a(new_n125_), .b(new_n94_), .c(new_n91_), .d(new_n69_), .O(new_n126_));
  ...
  nand4  g84(.a(new_n91_), .b(new_n124_), .c(x19), .d(new_n64_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n114_), .c(x16), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n61_), .O(new_n133_));
