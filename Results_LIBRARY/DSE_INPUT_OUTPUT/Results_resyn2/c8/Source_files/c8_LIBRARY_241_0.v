...
module FAU ( 
  ...
  oai21  g37(.a(new_n83_), .b(new_n50_), .c(new_n47_), .O(new_n84_));
  ...
  inv1   g46(.a(x04), .O(new_n93_));
  nand2  g47(.a(x18), .b(new_n93_), .O(new_n94_));
  inv1   g48(.a(x12), .O(new_n95_));
  nand2  g49(.a(new_n59_), .b(new_n95_), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n94_), .c(new_n61_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n92_), .O(z13));
  nand2  g52(.a(new_n90_), .b(x24), .O(new_n99_));
  nor2   g53(.a(x24), .b(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n89_), .c(new_n68_), .d(new_n67_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x16), .O(new_n103_));
  inv1   g57(.a(x13), .O(new_n104_));
  nand2  g58(.a(x18), .b(x05), .O(new_n105_));
  oai21  g59(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n50_), .c(new_n47_), .O(new_n107_));
  ...
  nand2  g66(.a(new_n101_), .b(x25), .O(new_n113_));
  ...
  nand2  g80(.a(new_n50_), .b(new_n47_), .O(new_n127_));
