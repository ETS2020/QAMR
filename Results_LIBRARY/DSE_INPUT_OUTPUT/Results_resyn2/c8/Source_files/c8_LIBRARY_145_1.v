...
module FAU ( 
  ...
  aoi21  g46(.a(new_n92_), .b(new_n90_), .c(new_n58_), .O(new_n93_));
  oai21  g47(.a(new_n88_), .b(new_n60_), .c(new_n93_), .O(z12));
  inv1   g48(.a(x22), .O(new_n95_));
  nand3  g49(.a(new_n80_), .b(new_n66_), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x23), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n66_), .O(new_n99_));
  ...
  oai21  g57(.a(new_n62_), .b(x04), .c(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n58_), .O(z13));
  ...
  aoi21  g64(.a(new_n110_), .b(new_n108_), .c(new_n58_), .O(new_n111_));
  oai21  g65(.a(new_n106_), .b(new_n60_), .c(new_n111_), .O(z14));
  oai21  g66(.a(new_n99_), .b(x24), .c(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n98_), .O(new_n115_));
  nor2   g69(.a(new_n115_), .b(new_n81_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  ...
  aoi21  g75(.a(new_n117_), .b(new_n113_), .c(new_n121_), .O(z15));
  inv1   g76(.a(x26), .O(new_n123_));
  nor3   g77(.a(new_n115_), .b(new_n81_), .c(new_n123_), .O(new_n124_));
  oai21  g78(.a(new_n116_), .b(x26), .c(x16), .O(new_n125_));
  inv1   g79(.a(x07), .O(new_n126_));
  nand2  g80(.a(x18), .b(new_n126_), .O(new_n127_));
  inv1   g81(.a(x15), .O(new_n128_));
  aoi21  g82(.a(new_n62_), .b(new_n128_), .c(x16), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n127_), .c(new_n58_), .O(new_n130_));
  oai21  g84(.a(new_n125_), .b(new_n124_), .c(new_n130_), .O(z16));
  inv1   g85(.a(new_n115_), .O(new_n132_));
  inv1   g86(.a(x19), .O(new_n133_));
  nor2   g87(.a(new_n133_), .b(x17), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n132_), .c(new_n80_), .d(new_n123_), .O(new_n135_));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nand2  g90(.a(new_n59_), .b(x16), .O(new_n137_));
