...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n63_), .c(new_n87_), .d(new_n86_), .O(new_n88_));
  ...
  oai21  g47(.a(new_n59_), .b(x04), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n91_), .O(z13));
  nor2   g49(.a(x24), .b(x23), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n75_), .c(new_n63_), .d(new_n86_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  aoi21  g52(.a(new_n88_), .b(x24), .c(new_n98_), .O(new_n99_));
  nor2   g53(.a(new_n59_), .b(x05), .O(new_n100_));
  oai21  g54(.a(x18), .b(x13), .c(new_n72_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n72_), .O(z14));
  nor2   g56(.a(x25), .b(x22), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n77_), .c(new_n97_), .d(x25), .O(new_n106_));
  nor2   g60(.a(new_n59_), .b(x06), .O(new_n107_));
  oai21  g61(.a(x18), .b(x14), .c(new_n72_), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n62_), .O(z15));
  inv1   g63(.a(x26), .O(new_n110_));
  nand3  g64(.a(new_n105_), .b(new_n77_), .c(new_n110_), .O(new_n111_));
  nand4  g65(.a(new_n103_), .b(new_n96_), .c(new_n75_), .d(new_n63_), .O(new_n112_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n105_), .c(new_n75_), .d(new_n110_), .O(new_n122_));
  aoi21  g76(.a(new_n122_), .b(new_n47_), .c(new_n72_), .O(z17));
endmodule
