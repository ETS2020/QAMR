...
module FAU ( 
  ...
  oai22  g07(.a(new_n52_), .b(x11), .c(x27), .d(x22), .O(z03));
  ...
  nor2   g16(.a(new_n62_), .b(x00), .O(new_n63_));
  nand2  g17(.a(new_n47_), .b(new_n48_), .O(new_n64_));
  inv1   g18(.a(new_n64_), .O(new_n65_));
  oai21  g19(.a(x18), .b(x08), .c(new_n65_), .O(new_n66_));
  oai21  g20(.a(new_n66_), .b(new_n63_), .c(new_n61_), .O(z09));
  nand2  g21(.a(x18), .b(x01), .O(new_n68_));
  aoi21  g22(.a(new_n62_), .b(x09), .c(new_n64_), .O(new_n69_));
  oai21  g23(.a(x19), .b(x17), .c(x20), .O(new_n70_));
  inv1   g24(.a(x20), .O(new_n71_));
  aoi21  g25(.a(new_n60_), .b(new_n71_), .c(new_n48_), .O(new_n72_));
  aoi22  g26(.a(new_n72_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(z10));
  nand2  g27(.a(x18), .b(x02), .O(new_n74_));
  aoi21  g28(.a(new_n62_), .b(x10), .c(new_n64_), .O(new_n75_));
  nand2  g29(.a(new_n60_), .b(new_n71_), .O(new_n76_));
  nand2  g30(.a(new_n76_), .b(x21), .O(new_n77_));
  nor2   g31(.a(x21), .b(x20), .O(new_n78_));
  aoi21  g32(.a(new_n78_), .b(new_n60_), .c(new_n48_), .O(new_n79_));
  aoi22  g33(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n74_), .O(z11));
  nand2  g34(.a(new_n78_), .b(new_n60_), .O(new_n81_));
  xor2a  g35(.a(new_n81_), .b(x22), .O(new_n82_));
  nor2   g36(.a(new_n62_), .b(x03), .O(new_n83_));
  ...
  nand2  g47(.a(new_n62_), .b(x12), .O(new_n94_));
  ...
  nand2  g75(.a(new_n62_), .b(x15), .O(new_n122_));
  ...
  nand4  g81(.a(new_n127_), .b(new_n78_), .c(new_n117_), .d(x19), .O(new_n128_));
