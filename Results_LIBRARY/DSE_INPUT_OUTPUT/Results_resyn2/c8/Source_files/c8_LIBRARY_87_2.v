...
module FAU ( 
  ...
  aoi21  g20(.a(new_n66_), .b(new_n62_), .c(new_n57_), .O(z09));
  ...
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n57_), .O(new_n76_));
  ...
  aoi21  g41(.a(new_n79_), .b(new_n60_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n79_), .b(new_n60_), .c(new_n87_), .O(new_n89_));
  ...
  nor2   g50(.a(new_n90_), .b(new_n96_), .O(new_n97_));
  nand4  g51(.a(new_n79_), .b(new_n60_), .c(new_n96_), .d(new_n87_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n97_), .c(x16), .O(new_n100_));
  ...
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n57_), .O(z13));
  nand2  g58(.a(new_n98_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x23), .b(x22), .O(new_n106_));
  nor2   g60(.a(x24), .b(x21), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n106_), .c(new_n60_), .d(new_n68_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(x16), .O(new_n109_));
  inv1   g63(.a(new_n57_), .O(new_n110_));
  inv1   g64(.a(x16), .O(new_n111_));
  nand2  g65(.a(x18), .b(x05), .O(new_n112_));
  nand2  g66(.a(new_n63_), .b(x13), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  aoi21  g69(.a(new_n109_), .b(new_n105_), .c(new_n115_), .O(z14));
  nor2   g70(.a(new_n47_), .b(new_n56_), .O(new_n117_));
  nor2   g71(.a(x25), .b(x24), .O(new_n118_));
  aoi22  g72(.a(new_n118_), .b(new_n99_), .c(new_n117_), .d(new_n108_), .O(new_n119_));
  inv1   g73(.a(x14), .O(new_n120_));
  nand2  g74(.a(new_n63_), .b(new_n120_), .O(new_n121_));
  inv1   g75(.a(x06), .O(new_n122_));
  nand2  g76(.a(x18), .b(new_n122_), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n121_), .c(new_n110_), .d(new_n111_), .O(new_n124_));
  oai21  g78(.a(new_n119_), .b(new_n111_), .c(new_n124_), .O(z15));
  nand2  g79(.a(new_n108_), .b(x26), .O(new_n126_));
  inv1   g80(.a(x24), .O(new_n127_));
  nor3   g81(.a(x26), .b(x23), .c(x22), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n79_), .c(new_n60_), .d(new_n127_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n126_), .c(x25), .O(new_n130_));
  nand2  g84(.a(new_n117_), .b(x26), .O(new_n131_));
  inv1   g85(.a(new_n131_), .O(new_n132_));
  oai21  g86(.a(new_n132_), .b(new_n130_), .c(x16), .O(new_n133_));
  inv1   g87(.a(x15), .O(new_n134_));
  nand2  g88(.a(new_n63_), .b(new_n134_), .O(new_n135_));
  inv1   g89(.a(x07), .O(new_n136_));
  nand2  g90(.a(x18), .b(new_n136_), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n135_), .c(new_n110_), .d(new_n111_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n133_), .O(z16));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  inv1   g94(.a(x19), .O(new_n141_));
  nor2   g95(.a(new_n141_), .b(x17), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n128_), .c(new_n118_), .d(new_n79_), .O(new_n143_));
  aoi21  g97(.a(new_n143_), .b(new_n140_), .c(new_n111_), .O(z17));
endmodule
