...
module FAU ( 
  ...
  nand4  g61(.a(new_n98_), .b(new_n80_), .c(new_n70_), .d(new_n107_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n60_), .b(x05), .c(new_n112_), .O(new_n113_));
  ...
  aoi22  g71(.a(new_n117_), .b(new_n82_), .c(new_n108_), .d(x25), .O(new_n118_));
  ...
  oai21  g76(.a(new_n118_), .b(new_n65_), .c(new_n122_), .O(z15));
  nand3  g77(.a(new_n117_), .b(new_n82_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  nand4  g79(.a(new_n115_), .b(new_n98_), .c(new_n80_), .d(new_n70_), .O(new_n126_));
  ...
  inv1   g86(.a(new_n59_), .O(new_n133_));
  nand4  g87(.a(new_n80_), .b(new_n125_), .c(x19), .d(new_n64_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n116_), .c(new_n47_), .d(new_n64_), .O(new_n135_));
