...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n54_, new_n58_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  nor2   g00(.a(x27), .b(x02), .O(new_n47_));
  ...
  aoi22  g06(.a(new_n47_), .b(x24), .c(x27), .d(x13), .O(z05));
  inv1   g07(.a(x27), .O(new_n54_));
  inv1   g08(.a(new_n47_), .O(z08));
  oai22  g09(.a(z08), .b(x25), .c(new_n54_), .d(x14), .O(z06));
  aoi22  g10(.a(new_n47_), .b(x26), .c(x27), .d(x15), .O(z07));
  inv1   g11(.a(x02), .O(new_n58_));
  ...
  oai21  g38(.a(new_n60_), .b(new_n58_), .c(new_n84_), .O(new_n85_));
  ...
  oai22  g90(.a(new_n136_), .b(new_n118_), .c(new_n54_), .d(new_n64_), .O(new_n137_));
