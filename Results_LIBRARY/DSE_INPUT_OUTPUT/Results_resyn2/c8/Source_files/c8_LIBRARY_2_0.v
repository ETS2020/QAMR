...
module FAU ( 
  ...
  nand3  g40(.a(new_n61_), .b(new_n79_), .c(new_n68_), .O(new_n87_));
  ...
  nand3  g49(.a(new_n88_), .b(new_n61_), .c(new_n68_), .O(new_n96_));
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g51(.a(new_n97_), .b(new_n70_), .c(new_n96_), .d(x23), .O(new_n98_));
  ...
  oai21  g57(.a(new_n98_), .b(new_n78_), .c(new_n103_), .O(z13));
  aoi21  g58(.a(new_n97_), .b(new_n70_), .c(new_n47_), .O(new_n105_));
  inv1   g59(.a(x22), .O(new_n106_));
  inv1   g60(.a(x23), .O(new_n107_));
  nand4  g61(.a(x27), .b(new_n47_), .c(new_n107_), .d(new_n106_), .O(new_n108_));
  nor2   g62(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n105_), .c(x16), .O(new_n110_));
  nor2   g64(.a(new_n59_), .b(x16), .O(new_n111_));
  inv1   g65(.a(x13), .O(new_n112_));
  nand2  g66(.a(new_n63_), .b(new_n112_), .O(new_n113_));
  inv1   g67(.a(x05), .O(new_n114_));
  nand2  g68(.a(x18), .b(new_n114_), .O(new_n115_));
  nand3  g69(.a(new_n115_), .b(new_n113_), .c(new_n111_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n110_), .O(z14));
  nand4  g71(.a(new_n88_), .b(new_n61_), .c(new_n107_), .d(new_n68_), .O(new_n118_));
  inv1   g72(.a(x25), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(x16), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n118_), .c(x27), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  nor2   g76(.a(new_n119_), .b(new_n78_), .O(new_n123_));
  oai21  g77(.a(new_n108_), .b(new_n87_), .c(new_n123_), .O(new_n124_));
  inv1   g78(.a(x14), .O(new_n125_));
  aoi21  g79(.a(new_n63_), .b(new_n125_), .c(x16), .O(new_n126_));
  oai21  g80(.a(new_n63_), .b(x06), .c(new_n126_), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n124_), .c(new_n122_), .O(z15));
  inv1   g82(.a(x26), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n119_), .c(x16), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n118_), .c(x27), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  inv1   g86(.a(new_n87_), .O(new_n133_));
  inv1   g87(.a(new_n108_), .O(new_n134_));
  nand3  g88(.a(new_n134_), .b(new_n133_), .c(new_n119_), .O(new_n135_));
  nor2   g89(.a(new_n129_), .b(new_n78_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  inv1   g91(.a(x15), .O(new_n138_));
  aoi21  g92(.a(new_n63_), .b(new_n138_), .c(x16), .O(new_n139_));
  oai21  g93(.a(new_n63_), .b(x07), .c(new_n139_), .O(new_n140_));
  nand3  g94(.a(new_n140_), .b(new_n137_), .c(new_n132_), .O(z16));
  nor3   g95(.a(x26), .b(x25), .c(x24), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n97_), .c(new_n68_), .d(x19), .O(new_n143_));
  aoi21  g97(.a(x27), .b(x17), .c(new_n59_), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n111_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
