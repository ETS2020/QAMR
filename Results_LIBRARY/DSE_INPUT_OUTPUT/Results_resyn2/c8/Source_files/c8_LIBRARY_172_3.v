...
module FAU ( 
  ...
  nor2   g62(.a(x18), .b(x16), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(x27), .c(x13), .O(new_n110_));
  nand3  g64(.a(x18), .b(new_n65_), .c(x05), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n110_), .c(new_n108_), .O(z14));
  nor2   g66(.a(x25), .b(x22), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n105_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n81_), .c(new_n106_), .d(x25), .O(new_n116_));
  ...
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n59_), .O(new_n121_));
  oai21  g75(.a(new_n116_), .b(new_n65_), .c(new_n121_), .O(z15));
  nand3  g76(.a(new_n115_), .b(new_n81_), .c(x26), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  nand4  g78(.a(new_n113_), .b(new_n105_), .c(new_n79_), .d(new_n69_), .O(new_n125_));
  ...
  aoi21  g84(.a(new_n130_), .b(new_n127_), .c(new_n59_), .O(z16));
  inv1   g85(.a(new_n59_), .O(new_n132_));
  nand4  g86(.a(new_n79_), .b(new_n124_), .c(x19), .d(new_n64_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n114_), .c(new_n47_), .d(new_n64_), .O(new_n134_));
