...
module FAU ( 
  ...
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n58_), .O(z13));
  ...
  inv1   g76(.a(new_n58_), .O(new_n123_));
  nand2  g77(.a(x18), .b(x06), .O(new_n124_));
  nand2  g78(.a(new_n61_), .b(x14), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n124_), .c(new_n67_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  aoi21  g81(.a(new_n122_), .b(new_n119_), .c(new_n127_), .O(z15));
  nand2  g82(.a(new_n120_), .b(new_n109_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n85_), .c(x26), .O(new_n131_));
  aoi21  g85(.a(new_n121_), .b(new_n57_), .c(new_n67_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  inv1   g87(.a(x15), .O(new_n134_));
  aoi21  g88(.a(new_n61_), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g89(.a(new_n61_), .b(x07), .c(new_n135_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n58_), .O(z16));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n130_), .b(new_n83_), .c(new_n68_), .d(new_n57_), .O(new_n139_));
  nand2  g93(.a(new_n123_), .b(x16), .O(new_n140_));
