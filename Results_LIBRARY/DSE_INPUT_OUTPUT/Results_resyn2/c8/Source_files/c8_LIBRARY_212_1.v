...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n58_, new_n59_, new_n60_, new_n61_, new_n62_,
    ...
    new_n136_, new_n137_;
  nand2  g00(.a(x27), .b(x10), .O(new_n47_));
  ...
  aoi21  g05(.a(new_n49_), .b(x21), .c(z08), .O(z02));
  ...
  nor2   g18(.a(new_n49_), .b(x10), .O(new_n65_));
  ...
  xor2a  g40(.a(new_n78_), .b(x22), .O(new_n87_));
  ...
  oai21  g46(.a(new_n87_), .b(new_n74_), .c(new_n92_), .O(z12));
  inv1   g47(.a(x23), .O(new_n94_));
  inv1   g48(.a(x22), .O(new_n95_));
  nand3  g49(.a(new_n77_), .b(new_n63_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g56(.a(new_n77_), .b(new_n63_), .c(new_n94_), .d(new_n95_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n77_), .c(new_n63_), .d(new_n95_), .O(new_n106_));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n110_), .c(new_n65_), .O(new_n113_));
  ...
  aoi21  g76(.a(new_n122_), .b(new_n120_), .c(new_n65_), .O(new_n123_));
  ...
  nand4  g80(.a(new_n115_), .b(new_n105_), .c(new_n77_), .d(new_n63_), .O(new_n127_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n129_), .c(new_n65_), .O(z16));
  inv1   g87(.a(x17), .O(new_n134_));
  nand4  g88(.a(new_n77_), .b(new_n126_), .c(x19), .d(new_n134_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n116_), .c(new_n49_), .d(new_n134_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n66_), .O(z17));
endmodule
