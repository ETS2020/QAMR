...
module FAU ( 
  ...
  oai21  g41(.a(new_n82_), .b(new_n65_), .c(new_n87_), .O(z11));
  ...
  nand3  g51(.a(new_n79_), .b(new_n70_), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g58(.a(new_n98_), .b(x23), .c(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n79_), .c(new_n70_), .d(new_n97_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(x16), .O(new_n108_));
  ...
  nand2  g65(.a(new_n111_), .b(new_n58_), .O(new_n112_));
  aoi21  g66(.a(new_n108_), .b(new_n105_), .c(new_n112_), .O(z14));
  ...
  nand4  g79(.a(new_n114_), .b(new_n106_), .c(new_n79_), .d(new_n70_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n125_), .c(new_n65_), .O(new_n127_));
  ...
  nand4  g86(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n64_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n115_), .c(new_n47_), .d(new_n64_), .O(new_n134_));
