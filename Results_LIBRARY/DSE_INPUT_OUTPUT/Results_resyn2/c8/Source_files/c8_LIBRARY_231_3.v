...
module FAU ( 
  ...
  inv1   g34(.a(new_n62_), .O(new_n81_));
  inv1   g35(.a(x22), .O(new_n82_));
  aoi21  g36(.a(new_n78_), .b(new_n63_), .c(new_n82_), .O(new_n83_));
  nand3  g37(.a(new_n78_), .b(new_n63_), .c(new_n82_), .O(new_n84_));
  inv1   g38(.a(new_n84_), .O(new_n85_));
  oai21  g39(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(new_n86_));
  ...
  nand2  g44(.a(new_n84_), .b(x23), .O(new_n91_));
  ...
  nand2  g57(.a(new_n103_), .b(new_n81_), .O(new_n104_));
  ...
  nand2  g77(.a(new_n123_), .b(new_n81_), .O(new_n124_));
