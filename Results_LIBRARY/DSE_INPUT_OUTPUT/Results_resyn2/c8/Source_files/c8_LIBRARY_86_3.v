...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n51_, new_n57_, new_n58_, new_n60_, new_n61_,
  ...
  nand2  g10(.a(x27), .b(x15), .O(new_n57_));
  inv1   g11(.a(new_n57_), .O(new_n58_));
  aoi21  g12(.a(new_n47_), .b(x26), .c(new_n58_), .O(z07));
  ...
  aoi21  g21(.a(new_n67_), .b(new_n63_), .c(new_n58_), .O(z09));
  ...
  nand3  g28(.a(new_n74_), .b(new_n71_), .c(new_n57_), .O(z10));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n58_), .O(z11));
  ...
  nand3  g49(.a(new_n79_), .b(new_n69_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g56(.a(new_n79_), .b(new_n69_), .c(new_n94_), .d(new_n95_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n79_), .c(new_n69_), .d(new_n95_), .O(new_n106_));
  ...
  aoi22  g71(.a(new_n117_), .b(new_n81_), .c(new_n106_), .d(x25), .O(new_n118_));
  ...
  aoi21  g76(.a(new_n122_), .b(new_n120_), .c(new_n58_), .O(new_n123_));
  oai21  g77(.a(new_n118_), .b(new_n65_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand3  g79(.a(new_n115_), .b(new_n105_), .c(new_n125_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n81_), .O(new_n128_));
  nand4  g82(.a(new_n115_), .b(new_n105_), .c(new_n79_), .d(new_n69_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(x26), .c(new_n65_), .O(new_n130_));
  nand2  g84(.a(x18), .b(x07), .O(new_n131_));
  nand2  g85(.a(new_n60_), .b(x15), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n131_), .c(new_n65_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n57_), .O(new_n134_));
  aoi21  g88(.a(new_n130_), .b(new_n128_), .c(new_n134_), .O(z16));
  nand3  g89(.a(new_n79_), .b(x19), .c(new_n64_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n126_), .c(new_n47_), .d(new_n64_), .O(new_n137_));
