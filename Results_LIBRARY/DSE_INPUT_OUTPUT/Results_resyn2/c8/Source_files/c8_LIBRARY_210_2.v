...
module FAU ( 
  ...
  aoi21  g01(.a(new_n47_), .b(x19), .c(x08), .O(z00));
  nor2   g02(.a(x27), .b(x08), .O(new_n49_));
  inv1   g03(.a(new_n49_), .O(new_n50_));
  oai22  g04(.a(new_n50_), .b(x20), .c(new_n47_), .d(x09), .O(z01));
  aoi22  g05(.a(new_n49_), .b(x21), .c(x27), .d(x10), .O(z02));
  aoi22  g06(.a(new_n49_), .b(x22), .c(x27), .d(x11), .O(z03));
  aoi22  g07(.a(new_n49_), .b(x23), .c(x27), .d(x12), .O(z04));
  oai22  g08(.a(new_n50_), .b(x24), .c(new_n47_), .d(x13), .O(z05));
  oai22  g09(.a(new_n50_), .b(x25), .c(new_n47_), .d(x14), .O(z06));
  oai22  g10(.a(new_n50_), .b(x26), .c(new_n47_), .d(x15), .O(z07));
  ...
  nor2   g15(.a(x27), .b(new_n59_), .O(new_n62_));
  ...
  nand3  g20(.a(new_n66_), .b(new_n63_), .c(new_n61_), .O(z09));
  inv1   g21(.a(x16), .O(new_n68_));
  inv1   g22(.a(x20), .O(new_n69_));
  xor2a  g23(.a(new_n65_), .b(new_n69_), .O(new_n70_));
  ...
  aoi21  g28(.a(new_n74_), .b(new_n72_), .c(new_n62_), .O(new_n75_));
  oai21  g29(.a(new_n70_), .b(new_n68_), .c(new_n75_), .O(z10));
  inv1   g30(.a(x21), .O(new_n77_));
  aoi21  g31(.a(new_n65_), .b(new_n69_), .c(new_n77_), .O(new_n78_));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n62_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n79_), .b(new_n65_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n79_), .b(new_n65_), .c(new_n87_), .O(new_n89_));
  ...
  oai21  g47(.a(new_n58_), .b(x03), .c(new_n93_), .O(new_n94_));
  aoi21  g48(.a(new_n94_), .b(new_n91_), .c(new_n62_), .O(z12));
  nand2  g49(.a(new_n89_), .b(x23), .O(new_n96_));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n79_), .c(new_n65_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x16), .O(new_n100_));
  inv1   g54(.a(x12), .O(new_n101_));
  aoi21  g55(.a(new_n58_), .b(new_n101_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n58_), .b(x04), .c(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n62_), .O(z13));
  inv1   g58(.a(x24), .O(new_n105_));
  xor2a  g59(.a(new_n98_), .b(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x16), .O(new_n107_));
  inv1   g61(.a(x13), .O(new_n108_));
  aoi21  g62(.a(new_n58_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n58_), .b(x05), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n110_), .b(new_n107_), .c(new_n62_), .O(z14));
  oai21  g65(.a(new_n98_), .b(x24), .c(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n97_), .c(new_n79_), .d(new_n65_), .O(new_n114_));
  ...
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n62_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n116_), .O(z15));
  nand2  g76(.a(new_n113_), .b(new_n97_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n81_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  aoi21  g80(.a(new_n114_), .b(new_n126_), .c(new_n68_), .O(new_n127_));
  ...
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n62_), .O(z16));
  inv1   g86(.a(x17), .O(new_n133_));
  inv1   g87(.a(x25), .O(new_n134_));
  nand4  g88(.a(new_n126_), .b(new_n134_), .c(new_n105_), .d(new_n77_), .O(new_n135_));
  inv1   g89(.a(new_n135_), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n97_), .c(new_n69_), .d(x19), .O(new_n137_));
  nor2   g91(.a(x17), .b(x08), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(x27), .c(x16), .O(new_n139_));
  aoi21  g93(.a(new_n137_), .b(new_n133_), .c(new_n139_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
