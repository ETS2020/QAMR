...
module FAU ( 
  ...
  xor2a  g21(.a(new_n61_), .b(x20), .O(new_n68_));
  ...
  aoi21  g29(.a(new_n61_), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  ...
  aoi21  g39(.a(new_n77_), .b(new_n61_), .c(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n77_), .b(new_n61_), .c(new_n85_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n86_), .c(x16), .O(new_n89_));
  inv1   g43(.a(x11), .O(new_n90_));
  aoi21  g44(.a(new_n63_), .b(new_n90_), .c(x16), .O(new_n91_));
  oai21  g45(.a(new_n63_), .b(x03), .c(new_n91_), .O(new_n92_));
  aoi21  g46(.a(new_n92_), .b(new_n89_), .c(new_n59_), .O(z12));
  nand2  g47(.a(new_n87_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n77_), .c(new_n61_), .O(new_n96_));
  ...
  oai21  g54(.a(new_n63_), .b(x04), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g61(.a(new_n63_), .b(x05), .c(new_n107_), .O(new_n108_));
  ...
  nand4  g65(.a(new_n111_), .b(new_n95_), .c(new_n77_), .d(new_n61_), .O(new_n112_));
  and2   g66(.a(new_n112_), .b(x16), .O(new_n113_));
  inv1   g67(.a(x16), .O(new_n114_));
  nand2  g68(.a(x18), .b(x06), .O(new_n115_));
  nand2  g69(.a(new_n63_), .b(x14), .O(new_n116_));
  nand3  g70(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  oai21  g71(.a(x27), .b(new_n58_), .c(new_n117_), .O(new_n118_));
  ...
  aoi21  g80(.a(new_n63_), .b(new_n126_), .c(x16), .O(new_n127_));
  oai21  g81(.a(new_n63_), .b(x07), .c(new_n127_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n125_), .c(new_n59_), .O(z16));
  inv1   g83(.a(x17), .O(new_n130_));
  inv1   g84(.a(x25), .O(new_n131_));
  nand4  g85(.a(new_n123_), .b(new_n131_), .c(new_n103_), .d(new_n75_), .O(new_n132_));
  inv1   g86(.a(new_n132_), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n95_), .c(new_n74_), .d(x19), .O(new_n134_));
  nor2   g88(.a(x17), .b(x14), .O(new_n135_));
  oai21  g89(.a(new_n135_), .b(x27), .c(x16), .O(new_n136_));
  aoi21  g90(.a(new_n134_), .b(new_n130_), .c(new_n136_), .O(z17));
endmodule
