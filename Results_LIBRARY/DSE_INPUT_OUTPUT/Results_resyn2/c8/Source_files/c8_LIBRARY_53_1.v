...
module FAU ( 
  ...
  nand2  g01(.a(x27), .b(x05), .O(new_n48_));
  ...
  nor2   g11(.a(new_n47_), .b(x05), .O(new_n58_));
  ...
  nand3  g43(.a(new_n89_), .b(new_n69_), .c(new_n68_), .O(new_n90_));
  ...
  nand4  g57(.a(new_n89_), .b(new_n69_), .c(new_n97_), .d(new_n68_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n89_), .c(new_n69_), .d(new_n68_), .O(new_n107_));
  ...
  aoi21  g66(.a(new_n59_), .b(new_n112_), .c(x16), .O(new_n113_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n79_), .d(new_n69_), .O(new_n118_));
  and2   g72(.a(new_n118_), .b(x16), .O(new_n119_));
  inv1   g73(.a(new_n58_), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n59_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n64_), .O(new_n123_));
  ...
  nand3  g81(.a(new_n127_), .b(new_n81_), .c(x26), .O(new_n128_));
  inv1   g82(.a(x26), .O(new_n129_));
  aoi21  g83(.a(new_n118_), .b(new_n129_), .c(new_n64_), .O(new_n130_));
  ...
  nand4  g89(.a(new_n79_), .b(new_n129_), .c(x19), .d(new_n63_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n126_), .c(new_n47_), .d(new_n63_), .O(new_n137_));
