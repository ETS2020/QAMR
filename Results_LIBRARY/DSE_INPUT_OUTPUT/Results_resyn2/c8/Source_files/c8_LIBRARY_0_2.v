// Benchmark "FAU" written by ABC on Sat Aug  8 23:28:53 2020
...
module FAU ( 
  ...
  oai21  g42(.a(new_n83_), .b(new_n77_), .c(new_n88_), .O(z11));
  ...
  oai21  g49(.a(new_n90_), .b(new_n77_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n80_), .b(new_n68_), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g63(.a(new_n100_), .b(new_n80_), .c(new_n68_), .d(new_n109_), .O(new_n110_));
  ...
  oai21  g68(.a(new_n63_), .b(x05), .c(new_n114_), .O(new_n115_));
  ...
  oai21  g78(.a(new_n120_), .b(new_n77_), .c(new_n124_), .O(z15));
  nand3  g79(.a(new_n119_), .b(new_n82_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n117_), .b(new_n100_), .c(new_n80_), .d(new_n68_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n77_), .O(new_n129_));
  ...
  oai22  g90(.a(new_n136_), .b(new_n118_), .c(new_n49_), .d(new_n135_), .O(new_n137_));
