...
module FAU ( 
  ...
  aoi21  g38(.a(new_n59_), .b(x11), .c(new_n61_), .O(new_n85_));
  ...
  nand2  g51(.a(new_n59_), .b(x12), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n97_), .c(new_n47_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n60_), .O(new_n100_));
  ...
  nand2  g61(.a(new_n59_), .b(x13), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n107_), .c(new_n47_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n60_), .O(new_n110_));
  ...
  aoi21  g72(.a(new_n59_), .b(new_n118_), .c(new_n61_), .O(new_n119_));
  oai21  g73(.a(new_n59_), .b(x06), .c(new_n119_), .O(new_n120_));
  oai21  g74(.a(new_n117_), .b(new_n60_), .c(new_n120_), .O(z15));
  inv1   g75(.a(x15), .O(new_n122_));
  aoi21  g76(.a(new_n59_), .b(new_n122_), .c(new_n61_), .O(new_n123_));
  oai21  g77(.a(new_n59_), .b(x07), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n60_), .O(z17));
  buf    g89(.a(x27), .O(z08));
endmodule
