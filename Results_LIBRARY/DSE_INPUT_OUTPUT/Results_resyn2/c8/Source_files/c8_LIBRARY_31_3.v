...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x01), .O(new_n48_));
  ...
  nand4  g59(.a(new_n85_), .b(new_n71_), .c(new_n99_), .d(new_n90_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n108_), .c(new_n71_), .d(new_n82_), .O(new_n110_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n108_), .c(new_n85_), .d(new_n71_), .O(new_n121_));
  ...
  nand2  g79(.a(new_n125_), .b(new_n78_), .O(new_n126_));
  aoi21  g80(.a(new_n122_), .b(new_n119_), .c(new_n126_), .O(z15));
  inv1   g81(.a(new_n86_), .O(new_n128_));
  nand2  g82(.a(new_n120_), .b(new_n108_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n128_), .c(x26), .O(new_n131_));
  inv1   g85(.a(x26), .O(new_n132_));
  aoi21  g86(.a(new_n121_), .b(new_n132_), .c(new_n65_), .O(new_n133_));
  ...
  oai21  g90(.a(new_n60_), .b(x07), .c(new_n136_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n134_), .c(new_n59_), .O(z16));
  nand2  g92(.a(x27), .b(x17), .O(new_n139_));
  nand4  g93(.a(new_n85_), .b(new_n132_), .c(x19), .d(new_n64_), .O(new_n140_));
  oai21  g94(.a(new_n140_), .b(new_n129_), .c(new_n139_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n58_), .O(new_n142_));
  nor2   g96(.a(x27), .b(x26), .O(new_n143_));
  nand4  g97(.a(new_n130_), .b(new_n85_), .c(new_n67_), .d(new_n143_), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n142_), .c(new_n65_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
