...
module FAU ( 
  ...
  oai21  g011(.a(z08), .b(x25), .c(new_n57_), .O(z06));
  oai22  g012(.a(z08), .b(x26), .c(new_n50_), .d(x15), .O(z07));
  ...
  nand2  g035(.a(new_n60_), .b(x10), .O(new_n82_));
  nand3  g036(.a(new_n82_), .b(new_n81_), .c(new_n72_), .O(new_n83_));
  inv1   g037(.a(x21), .O(new_n84_));
  aoi21  g038(.a(new_n67_), .b(new_n73_), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g043(.a(new_n89_), .b(new_n70_), .O(z11));
  xor2a  g044(.a(new_n87_), .b(x22), .O(new_n91_));
  ...
  nand3  g052(.a(new_n86_), .b(new_n67_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x23), .O(new_n100_));
  nor2   g054(.a(x23), .b(x22), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n86_), .c(new_n67_), .O(new_n102_));
  ...
  nand4  g077(.a(new_n123_), .b(new_n101_), .c(new_n86_), .d(new_n67_), .O(new_n124_));
