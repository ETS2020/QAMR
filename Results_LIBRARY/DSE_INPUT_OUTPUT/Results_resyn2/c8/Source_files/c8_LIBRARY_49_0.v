...
module FAU ( 
  ...
  aoi21  g54(.a(new_n92_), .b(new_n73_), .c(new_n100_), .O(new_n101_));
  inv1   g55(.a(x22), .O(new_n102_));
  nand3  g56(.a(new_n100_), .b(new_n102_), .c(new_n90_), .O(new_n103_));
  ...
  aoi22  g74(.a(new_n120_), .b(new_n104_), .c(new_n113_), .d(x25), .O(new_n121_));
  inv1   g75(.a(x06), .O(new_n122_));
  nand2  g76(.a(x18), .b(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n59_), .b(new_n48_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n123_), .c(new_n68_), .O(new_n125_));
  oai21  g79(.a(new_n121_), .b(new_n81_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n120_), .b(new_n104_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand2  g82(.a(new_n112_), .b(new_n73_), .O(new_n129_));
  inv1   g83(.a(new_n120_), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand3  g85(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  ...
  aoi21  g90(.a(new_n136_), .b(new_n134_), .c(new_n68_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n132_), .O(z16));
  nor2   g92(.a(x20), .b(new_n64_), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n120_), .c(new_n112_), .d(new_n128_), .O(new_n140_));
