...
module FAU ( 
  ...
  nor2   g19(.a(x27), .b(x14), .O(new_n66_));
  inv1   g20(.a(new_n66_), .O(new_n67_));
  nand3  g21(.a(new_n67_), .b(new_n65_), .c(new_n62_), .O(z09));
  inv1   g22(.a(x20), .O(new_n69_));
  nor2   g23(.a(new_n64_), .b(new_n69_), .O(new_n70_));
  ...
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n66_), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(new_n72_), .O(z10));
  inv1   g32(.a(x21), .O(new_n79_));
  nor2   g33(.a(x21), .b(x20), .O(new_n80_));
  nand2  g34(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  oai21  g35(.a(new_n71_), .b(new_n79_), .c(new_n81_), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(x16), .O(new_n83_));
  inv1   g37(.a(x10), .O(new_n84_));
  aoi21  g38(.a(new_n59_), .b(new_n84_), .c(x16), .O(new_n85_));
  oai21  g39(.a(new_n59_), .b(x02), .c(new_n85_), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(new_n83_), .c(new_n66_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n80_), .b(new_n64_), .c(new_n88_), .O(new_n89_));
  nor2   g43(.a(x22), .b(x21), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n64_), .c(new_n69_), .O(new_n91_));
  inv1   g45(.a(new_n91_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n89_), .c(x16), .O(new_n93_));
  inv1   g47(.a(x11), .O(new_n94_));
  aoi21  g48(.a(new_n59_), .b(new_n94_), .c(x16), .O(new_n95_));
  oai21  g49(.a(new_n59_), .b(x03), .c(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n66_), .O(z12));
  ...
  aoi21  g55(.a(new_n59_), .b(new_n101_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n59_), .b(x04), .c(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n66_), .O(z13));
  inv1   g58(.a(x16), .O(new_n105_));
  nand3  g59(.a(new_n90_), .b(new_n71_), .c(new_n98_), .O(new_n106_));
  nand2  g60(.a(new_n64_), .b(new_n69_), .O(new_n107_));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n90_), .O(new_n109_));
  nor2   g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  aoi21  g64(.a(new_n106_), .b(x24), .c(new_n110_), .O(new_n111_));
  ...
  aoi21  g69(.a(new_n115_), .b(new_n113_), .c(new_n66_), .O(new_n116_));
  oai21  g70(.a(new_n111_), .b(new_n105_), .c(new_n116_), .O(z14));
  oai21  g71(.a(new_n109_), .b(new_n107_), .c(x25), .O(new_n118_));
  nor2   g72(.a(x25), .b(x22), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n108_), .c(new_n80_), .d(new_n64_), .O(new_n120_));
  ...
  aoi21  g78(.a(new_n59_), .b(new_n48_), .c(x16), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n124_), .c(new_n66_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n122_), .O(z15));
  inv1   g81(.a(new_n81_), .O(new_n128_));
  nand2  g82(.a(new_n119_), .b(new_n108_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n128_), .c(x26), .O(new_n131_));
  inv1   g85(.a(x26), .O(new_n132_));
  aoi21  g86(.a(new_n120_), .b(new_n132_), .c(new_n105_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  inv1   g88(.a(x15), .O(new_n135_));
  aoi21  g89(.a(new_n59_), .b(new_n135_), .c(x16), .O(new_n136_));
  oai21  g90(.a(new_n59_), .b(x07), .c(new_n136_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n134_), .c(new_n66_), .O(z16));
  inv1   g92(.a(x17), .O(new_n139_));
  inv1   g93(.a(new_n109_), .O(new_n140_));
