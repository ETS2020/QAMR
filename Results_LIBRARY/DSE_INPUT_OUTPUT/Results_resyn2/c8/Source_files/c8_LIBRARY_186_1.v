...
module FAU ( 
  ...
  nand2  g23(.a(new_n60_), .b(x09), .O(new_n70_));
  ...
  nand4  g33(.a(new_n79_), .b(new_n73_), .c(new_n78_), .d(new_n77_), .O(new_n80_));
  inv1   g34(.a(new_n80_), .O(new_n81_));
  aoi21  g35(.a(new_n74_), .b(x21), .c(new_n81_), .O(new_n82_));
  nor2   g36(.a(new_n60_), .b(x02), .O(new_n83_));
  oai21  g37(.a(x18), .b(x10), .c(new_n59_), .O(new_n84_));
  oai22  g38(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n65_), .O(z11));
  xor2a  g39(.a(new_n80_), .b(x22), .O(new_n86_));
  nor2   g40(.a(new_n60_), .b(x03), .O(new_n87_));
  oai21  g41(.a(x18), .b(x11), .c(new_n59_), .O(new_n88_));
  oai22  g42(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n65_), .O(z12));
  inv1   g43(.a(x22), .O(new_n90_));
  nor2   g44(.a(x21), .b(x20), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n66_), .c(new_n90_), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(x23), .O(new_n93_));
  nor2   g47(.a(x23), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n91_), .c(new_n66_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x16), .O(new_n97_));
  nand2  g51(.a(x18), .b(x04), .O(new_n98_));
  nand2  g52(.a(new_n60_), .b(x12), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n98_), .c(new_n47_), .O(new_n100_));
  ...
  nand4  g58(.a(new_n104_), .b(new_n94_), .c(new_n66_), .d(new_n73_), .O(new_n105_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n90_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  aoi22  g71(.a(new_n117_), .b(new_n81_), .c(new_n105_), .d(x25), .O(new_n118_));
  inv1   g72(.a(x06), .O(new_n119_));
  nand2  g73(.a(x18), .b(new_n119_), .O(new_n120_));
  inv1   g74(.a(x14), .O(new_n121_));
  nand2  g75(.a(new_n60_), .b(new_n121_), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n120_), .c(new_n59_), .O(new_n123_));
  oai21  g77(.a(new_n118_), .b(new_n65_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand3  g79(.a(new_n117_), .b(new_n81_), .c(new_n125_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n94_), .c(new_n91_), .d(new_n66_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(x26), .c(new_n65_), .O(new_n129_));
  nand2  g83(.a(x18), .b(x07), .O(new_n130_));
  nand2  g84(.a(new_n60_), .b(x15), .O(new_n131_));
  nand3  g85(.a(new_n131_), .b(new_n130_), .c(new_n59_), .O(new_n132_));
  inv1   g86(.a(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n129_), .b(new_n126_), .c(new_n133_), .O(z16));
  nor2   g88(.a(x17), .b(new_n65_), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n91_), .c(new_n125_), .d(x19), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n116_), .c(new_n135_), .d(new_n47_), .O(z17));
endmodule
