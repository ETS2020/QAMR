...
module FAU ( 
  ...
  aoi22  g08(.a(z08), .b(x13), .c(new_n49_), .d(x24), .O(z05));
  ...
  aoi21  g45(.a(new_n91_), .b(new_n89_), .c(new_n65_), .O(new_n92_));
  oai21  g46(.a(new_n87_), .b(new_n68_), .c(new_n92_), .O(z12));
  inv1   g47(.a(x22), .O(new_n94_));
  nand3  g48(.a(new_n79_), .b(new_n63_), .c(new_n94_), .O(new_n95_));
  ...
  aoi21  g54(.a(new_n100_), .b(new_n98_), .c(new_n65_), .O(new_n101_));
  oai21  g55(.a(new_n96_), .b(new_n68_), .c(new_n101_), .O(z13));
  inv1   g56(.a(x23), .O(new_n103_));
  nand4  g57(.a(new_n79_), .b(new_n63_), .c(new_n103_), .d(new_n94_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n79_), .c(new_n63_), .d(new_n94_), .O(new_n107_));
  ...
  aoi21  g67(.a(new_n113_), .b(new_n111_), .c(new_n65_), .O(new_n114_));
  ...
  aoi21  g77(.a(new_n123_), .b(new_n121_), .c(new_n65_), .O(new_n124_));
  oai21  g78(.a(new_n119_), .b(new_n68_), .c(new_n124_), .O(z15));
  nand3  g79(.a(new_n118_), .b(new_n81_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n116_), .b(new_n106_), .c(new_n79_), .d(new_n63_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n68_), .O(new_n129_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n65_), .O(z16));
  inv1   g88(.a(x17), .O(new_n135_));
  nand4  g89(.a(new_n79_), .b(new_n127_), .c(x19), .d(new_n135_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n117_), .c(new_n49_), .d(new_n135_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n66_), .O(z17));
endmodule
