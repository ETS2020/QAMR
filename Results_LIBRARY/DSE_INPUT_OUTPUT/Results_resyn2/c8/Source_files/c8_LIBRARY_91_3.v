...
module FAU ( 
  ...
  nand4  g59(.a(new_n80_), .b(new_n71_), .c(new_n97_), .d(new_n98_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n80_), .c(new_n71_), .d(new_n98_), .O(new_n109_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n108_), .c(new_n80_), .d(new_n71_), .O(new_n120_));
  ...
  nand2  g80(.a(new_n119_), .b(new_n108_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n82_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  aoi21  g84(.a(new_n120_), .b(new_n130_), .c(new_n66_), .O(new_n131_));
  ...
  nand4  g91(.a(new_n128_), .b(new_n80_), .c(new_n67_), .d(new_n130_), .O(new_n138_));
