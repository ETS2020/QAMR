...
module FAU ( 
  ...
  oai21  g30(.a(new_n58_), .b(x01), .c(new_n76_), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(new_n74_), .c(new_n68_), .O(z10));
  inv1   g32(.a(x21), .O(new_n79_));
  nor2   g33(.a(new_n73_), .b(new_n79_), .O(new_n80_));
  nand3  g34(.a(new_n65_), .b(new_n79_), .c(new_n71_), .O(new_n81_));
  ...
  oai21  g39(.a(new_n58_), .b(x02), .c(new_n85_), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(new_n83_), .c(new_n68_), .O(z11));
  nand2  g41(.a(new_n81_), .b(x22), .O(new_n88_));
  nor2   g42(.a(x22), .b(x21), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n65_), .c(new_n71_), .O(new_n90_));
  ...
  nand4  g52(.a(new_n98_), .b(new_n65_), .c(new_n79_), .d(new_n71_), .O(new_n99_));
  ...
  nand3  g61(.a(new_n107_), .b(new_n89_), .c(new_n73_), .O(new_n108_));
  ...
  aoi21  g68(.a(new_n114_), .b(new_n112_), .c(new_n68_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n110_), .O(z14));
  nand2  g70(.a(new_n108_), .b(x25), .O(new_n117_));
  inv1   g71(.a(x16), .O(new_n118_));
  nor2   g72(.a(x25), .b(x22), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n107_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(new_n81_), .O(new_n121_));
  nor2   g75(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n58_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n118_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n69_), .O(new_n126_));
  aoi21  g80(.a(new_n122_), .b(new_n117_), .c(new_n126_), .O(z15));
  nand2  g81(.a(new_n121_), .b(x26), .O(new_n128_));
  inv1   g82(.a(x26), .O(new_n129_));
  oai21  g83(.a(new_n120_), .b(new_n81_), .c(new_n129_), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n128_), .c(x16), .O(new_n131_));
  nand2  g85(.a(x18), .b(new_n67_), .O(new_n132_));
  inv1   g86(.a(x15), .O(new_n133_));
  aoi21  g87(.a(new_n58_), .b(new_n133_), .c(x16), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n68_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n131_), .O(z16));
  nor2   g90(.a(x20), .b(new_n63_), .O(new_n137_));
  nor2   g91(.a(x26), .b(x25), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n89_), .O(new_n139_));
  nor2   g93(.a(x17), .b(x07), .O(new_n140_));
