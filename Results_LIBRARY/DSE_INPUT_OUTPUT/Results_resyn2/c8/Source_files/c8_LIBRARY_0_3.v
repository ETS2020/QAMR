...
module FAU ( 
  ...
  nand3  g52(.a(new_n98_), .b(new_n78_), .c(new_n63_), .O(new_n99_));
  ...
  nand4  g61(.a(new_n98_), .b(new_n78_), .c(new_n63_), .d(new_n107_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n58_), .b(x05), .c(new_n112_), .O(new_n113_));
  ...
  nand3  g73(.a(x18), .b(new_n75_), .c(x06), .O(new_n120_));
  ...
  nand4  g79(.a(new_n115_), .b(new_n98_), .c(new_n78_), .d(new_n63_), .O(new_n126_));
