...
module FAU ( 
  ...
  oai21  g58(.a(new_n99_), .b(new_n64_), .c(new_n104_), .O(z13));
  ...
  inv1   g70(.a(new_n58_), .O(new_n117_));
  nand2  g71(.a(x18), .b(x06), .O(new_n118_));
  nand2  g72(.a(new_n59_), .b(x14), .O(new_n119_));
  nand3  g73(.a(new_n119_), .b(new_n118_), .c(new_n64_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  aoi21  g75(.a(new_n116_), .b(new_n113_), .c(new_n121_), .O(z15));
  nand2  g76(.a(new_n114_), .b(new_n96_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n81_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  aoi21  g80(.a(new_n115_), .b(new_n126_), .c(new_n64_), .O(new_n127_));
  ...
  nand4  g86(.a(new_n79_), .b(new_n126_), .c(x19), .d(new_n63_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n123_), .c(new_n50_), .d(new_n63_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n117_), .O(z17));
endmodule
