...
module FAU ( 
  ...
  nand2  g028(.a(new_n47_), .b(x26), .O(new_n75_));
  nand3  g029(.a(new_n75_), .b(new_n74_), .c(new_n53_), .O(new_n76_));
  ...
  oai21  g035(.a(new_n79_), .b(x00), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g040(.a(new_n86_), .b(new_n82_), .c(new_n53_), .O(z09));
  nor2   g041(.a(x18), .b(x06), .O(new_n88_));
  aoi22  g042(.a(new_n88_), .b(x09), .c(x18), .d(x01), .O(new_n89_));
  ...
  aoi21  g054(.a(new_n79_), .b(new_n58_), .c(x16), .O(new_n101_));
  aoi21  g055(.a(new_n101_), .b(new_n100_), .c(new_n50_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n98_), .O(z11));
  aoi22  g057(.a(new_n88_), .b(x11), .c(x18), .d(x03), .O(new_n104_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n83_), .c(new_n62_), .O(new_n108_));
  ...
  aoi21  g070(.a(new_n79_), .b(new_n116_), .c(x16), .O(new_n117_));
  ...
  aoi21  g081(.a(new_n79_), .b(new_n127_), .c(x16), .O(new_n128_));
  ...
  oai21  g088(.a(x18), .b(new_n134_), .c(new_n49_), .O(new_n135_));
  nor2   g089(.a(new_n50_), .b(x16), .O(new_n136_));
  ...
  nand2  g094(.a(new_n88_), .b(x15), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n110_), .c(new_n107_), .d(new_n83_), .O(new_n146_));
  nor2   g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n146_), .b(new_n144_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n53_), .c(x16), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n147_), .c(new_n143_), .O(z16));
  nor2   g104(.a(new_n48_), .b(x17), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n132_), .c(new_n107_), .d(new_n144_), .O(new_n152_));
  aoi21  g106(.a(x27), .b(x17), .c(new_n50_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n152_), .c(new_n136_), .O(z17));
endmodule
