...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n53_, new_n54_, new_n57_, new_n58_, new_n59_, new_n61_,
  ...
  inv1   g07(.a(new_n47_), .O(new_n54_));
  aoi22  g08(.a(new_n54_), .b(x13), .c(new_n53_), .d(x24), .O(z05));
  nor2   g09(.a(x27), .b(x25), .O(z06));
  inv1   g10(.a(x26), .O(new_n57_));
  nor2   g11(.a(new_n53_), .b(x14), .O(new_n58_));
  aoi21  g12(.a(new_n53_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  oai21  g13(.a(new_n53_), .b(x15), .c(new_n59_), .O(z07));
  ...
  oai21  g30(.a(new_n61_), .b(x01), .c(new_n76_), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(new_n74_), .c(new_n58_), .O(z10));
  inv1   g32(.a(x20), .O(new_n79_));
  inv1   g33(.a(x21), .O(new_n80_));
  aoi21  g34(.a(new_n72_), .b(new_n79_), .c(new_n80_), .O(new_n81_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n82_), .c(new_n72_), .d(new_n90_), .O(new_n110_));
  ...
  inv1   g74(.a(new_n58_), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n61_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n67_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  aoi21  g79(.a(new_n120_), .b(new_n117_), .c(new_n125_), .O(z15));
  nand2  g80(.a(new_n118_), .b(new_n100_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n84_), .c(x26), .O(new_n129_));
  aoi21  g83(.a(new_n119_), .b(new_n57_), .c(new_n67_), .O(new_n130_));
  ...
  oai21  g87(.a(new_n61_), .b(x07), .c(new_n133_), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n58_), .O(z16));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n128_), .b(new_n82_), .c(new_n68_), .d(new_n57_), .O(new_n137_));
  nand2  g91(.a(new_n121_), .b(x16), .O(new_n138_));
