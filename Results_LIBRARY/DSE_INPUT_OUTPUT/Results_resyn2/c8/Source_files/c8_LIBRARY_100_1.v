...
module FAU ( 
  ...
  aoi21  g04(.a(new_n47_), .b(x20), .c(new_n49_), .O(z01));
  ...
  aoi22  g75(.a(new_n121_), .b(new_n85_), .c(new_n110_), .d(x25), .O(new_n122_));
  ...
  nand3  g82(.a(new_n121_), .b(new_n85_), .c(x26), .O(new_n129_));
  nand4  g83(.a(new_n119_), .b(new_n109_), .c(new_n83_), .d(new_n73_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n57_), .c(new_n67_), .O(new_n131_));
  ...
  nand4  g91(.a(new_n121_), .b(new_n83_), .c(new_n68_), .d(new_n57_), .O(new_n138_));
  oai21  g92(.a(new_n47_), .b(x09), .c(x16), .O(new_n139_));
