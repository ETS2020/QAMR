...
module FAU ( 
  ...
  nand3  g72(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n68_), .O(new_n120_));
  aoi21  g74(.a(new_n115_), .b(new_n112_), .c(new_n120_), .O(z15));
  nand2  g75(.a(new_n113_), .b(new_n97_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n81_), .c(x26), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  aoi21  g79(.a(new_n114_), .b(new_n125_), .c(new_n116_), .O(new_n126_));
  ...
  aoi21  g84(.a(new_n130_), .b(new_n127_), .c(new_n67_), .O(z16));
  ...
  nand2  g89(.a(new_n135_), .b(new_n68_), .O(z17));
endmodule
