...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n50_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n147_, new_n148_;
  nor2   g000(.a(x27), .b(x12), .O(new_n47_));
  ...
  aoi21  g007(.a(new_n49_), .b(x23), .c(x12), .O(z04));
  oai22  g008(.a(new_n50_), .b(x24), .c(new_n49_), .d(x13), .O(z05));
  oai22  g009(.a(new_n50_), .b(x25), .c(new_n49_), .d(x14), .O(z06));
  aoi22  g010(.a(new_n47_), .b(x26), .c(x27), .d(x15), .O(z07));
  nand2  g011(.a(new_n49_), .b(x12), .O(new_n58_));
  ...
  inv1   g026(.a(new_n58_), .O(new_n73_));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n75_), .c(new_n73_), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n72_), .O(z10));
  nand2  g034(.a(x18), .b(x02), .O(new_n81_));
  nand2  g035(.a(new_n77_), .b(x10), .O(new_n82_));
  nand3  g036(.a(new_n82_), .b(new_n81_), .c(new_n60_), .O(new_n83_));
  inv1   g037(.a(x21), .O(new_n84_));
  nor2   g038(.a(new_n71_), .b(new_n84_), .O(new_n85_));
  nand4  g039(.a(new_n84_), .b(new_n69_), .c(new_n64_), .d(new_n63_), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(x16), .O(new_n87_));
  oai21  g041(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n58_), .O(z11));
  inv1   g043(.a(x22), .O(new_n90_));
  nor2   g044(.a(x21), .b(x20), .O(new_n91_));
  aoi21  g045(.a(new_n91_), .b(new_n66_), .c(new_n90_), .O(new_n92_));
  nand3  g046(.a(new_n91_), .b(new_n66_), .c(new_n90_), .O(new_n93_));
  ...
  nand4  g064(.a(new_n110_), .b(new_n101_), .c(new_n66_), .d(new_n69_), .O(new_n111_));
  ...
  aoi21  g071(.a(new_n117_), .b(new_n115_), .c(new_n73_), .O(new_n118_));
  ...
  aoi21  g084(.a(new_n130_), .b(new_n128_), .c(new_n73_), .O(new_n131_));
  oai21  g085(.a(new_n126_), .b(new_n60_), .c(new_n131_), .O(z15));
  inv1   g086(.a(x26), .O(new_n133_));
  nor2   g087(.a(x25), .b(x24), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n101_), .c(new_n91_), .d(new_n66_), .O(new_n135_));
