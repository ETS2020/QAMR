...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(x25), .c(new_n57_), .O(z06));
  ...
  aoi21  g43(.a(new_n79_), .b(new_n70_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n79_), .b(new_n70_), .c(new_n89_), .O(new_n91_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n79_), .d(new_n70_), .O(new_n117_));
  ...
  nand4  g88(.a(new_n79_), .b(new_n128_), .c(x19), .d(new_n65_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n125_), .c(new_n51_), .d(new_n65_), .O(new_n136_));
