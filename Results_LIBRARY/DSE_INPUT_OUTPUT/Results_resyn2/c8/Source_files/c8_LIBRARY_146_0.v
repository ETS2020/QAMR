...
module FAU ( 
  ...
  nor2   g12(.a(x27), .b(x07), .O(new_n59_));
  ...
  nand2  g43(.a(new_n72_), .b(new_n89_), .O(new_n90_));
  nor2   g44(.a(x22), .b(x21), .O(new_n91_));
  aoi22  g45(.a(new_n91_), .b(new_n72_), .c(new_n90_), .d(x22), .O(new_n92_));
  ...
  oai21  g51(.a(new_n92_), .b(new_n80_), .c(new_n97_), .O(z12));
  inv1   g52(.a(x23), .O(new_n99_));
  aoi21  g53(.a(new_n91_), .b(new_n72_), .c(new_n99_), .O(new_n100_));
  inv1   g54(.a(x22), .O(new_n101_));
  nand3  g55(.a(new_n99_), .b(new_n101_), .c(new_n89_), .O(new_n102_));
  nor2   g56(.a(new_n102_), .b(new_n81_), .O(new_n103_));
  ...
  oai21  g62(.a(new_n102_), .b(new_n81_), .c(x24), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n72_), .c(new_n110_), .O(new_n112_));
  ...
  oai21  g70(.a(new_n65_), .b(x05), .c(new_n116_), .O(new_n117_));
  aoi21  g71(.a(new_n117_), .b(new_n114_), .c(new_n59_), .O(z14));
  nand2  g72(.a(new_n112_), .b(x25), .O(new_n119_));
  nand3  g73(.a(new_n91_), .b(new_n110_), .c(new_n99_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand3  g76(.a(new_n63_), .b(new_n122_), .c(new_n70_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n121_), .c(new_n80_), .O(new_n125_));
  inv1   g79(.a(new_n59_), .O(new_n126_));
  nand2  g80(.a(x18), .b(x06), .O(new_n127_));
  nand2  g81(.a(new_n65_), .b(x14), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n127_), .c(new_n80_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  aoi21  g84(.a(new_n125_), .b(new_n119_), .c(new_n130_), .O(z15));
  inv1   g85(.a(x26), .O(new_n132_));
  nand3  g86(.a(new_n124_), .b(new_n121_), .c(new_n132_), .O(new_n133_));
  nand4  g87(.a(new_n111_), .b(new_n72_), .c(new_n122_), .d(new_n110_), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(x26), .c(new_n80_), .O(new_n135_));
  aoi21  g89(.a(new_n65_), .b(x15), .c(x16), .O(new_n136_));
  oai21  g90(.a(new_n65_), .b(new_n47_), .c(new_n136_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n126_), .O(new_n138_));
  aoi21  g92(.a(new_n135_), .b(new_n133_), .c(new_n138_), .O(z16));
  nor2   g93(.a(x26), .b(x25), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n121_), .c(new_n70_), .d(x19), .O(new_n141_));
