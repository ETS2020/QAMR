...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x23), .O(z08));
  ...
  aoi21  g07(.a(x27), .b(x12), .c(x23), .O(z04));
  ...
  nand4  g58(.a(new_n80_), .b(new_n70_), .c(new_n58_), .d(new_n95_), .O(new_n105_));
  inv1   g59(.a(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  aoi21  g61(.a(new_n105_), .b(x24), .c(new_n65_), .O(new_n108_));
  ...
  nand4  g67(.a(new_n80_), .b(new_n70_), .c(new_n104_), .d(new_n95_), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n106_), .c(new_n114_), .d(x25), .O(new_n116_));
  ...
  oai21  g77(.a(new_n116_), .b(new_n65_), .c(new_n123_), .O(z15));
  nand4  g78(.a(new_n115_), .b(new_n80_), .c(new_n70_), .d(new_n95_), .O(new_n125_));
  nor2   g79(.a(x26), .b(x22), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n115_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  nand3  g82(.a(new_n80_), .b(new_n70_), .c(new_n58_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  aoi22  g84(.a(new_n130_), .b(new_n128_), .c(new_n125_), .d(x26), .O(new_n131_));
  ...
  oai21  g92(.a(new_n131_), .b(new_n65_), .c(new_n138_), .O(z16));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  nand4  g94(.a(new_n128_), .b(new_n80_), .c(x19), .d(new_n64_), .O(new_n141_));
  nand2  g95(.a(new_n58_), .b(x16), .O(new_n142_));
