...
module FAU ( 
  ...
  nand2  g00(.a(x27), .b(x01), .O(new_n47_));
  ...
  aoi22  g07(.a(z08), .b(x12), .c(new_n52_), .d(x23), .O(z04));
  ...
  nor2   g11(.a(new_n52_), .b(x01), .O(new_n58_));
  ...
  inv1   g21(.a(new_n58_), .O(new_n68_));
  inv1   g22(.a(x20), .O(new_n69_));
  nor2   g23(.a(x19), .b(x17), .O(new_n70_));
  aoi21  g24(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(new_n71_));
  oai21  g25(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(new_n72_));
  nand2  g26(.a(x18), .b(x01), .O(new_n73_));
  nand2  g27(.a(new_n59_), .b(x09), .O(new_n74_));
  nand3  g28(.a(new_n74_), .b(new_n73_), .c(new_n64_), .O(new_n75_));
  nand3  g29(.a(new_n75_), .b(new_n72_), .c(new_n68_), .O(new_n76_));
  ...
  oai21  g56(.a(new_n97_), .b(new_n64_), .c(new_n102_), .O(z13));
  ...
  oai21  g79(.a(new_n120_), .b(new_n64_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n119_), .b(new_n82_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n80_), .d(new_n70_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n128_), .c(new_n64_), .O(new_n130_));
  ...
  nand4  g89(.a(new_n80_), .b(new_n128_), .c(x19), .d(new_n63_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n118_), .c(new_n52_), .d(new_n63_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n68_), .O(z17));
endmodule
