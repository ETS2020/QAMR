...
module FAU ( 
  ...
  nand3  g51(.a(new_n82_), .b(new_n67_), .c(new_n97_), .O(new_n98_));
  xnor2a g52(.a(new_n98_), .b(x23), .O(new_n99_));
  ...
  inv1   g59(.a(new_n98_), .O(new_n106_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n82_), .d(new_n67_), .O(new_n119_));
  ...
  nand4  g90(.a(new_n82_), .b(new_n136_), .c(x19), .d(new_n134_), .O(new_n137_));
