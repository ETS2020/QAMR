...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n57_, new_n60_, new_n61_,
  ...
  oai21  g11(.a(new_n50_), .b(x25), .c(new_n57_), .O(z06));
  ...
  aoi21  g48(.a(new_n61_), .b(new_n94_), .c(x16), .O(new_n95_));
  oai21  g49(.a(new_n61_), .b(x03), .c(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n60_), .O(z12));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n81_), .c(new_n71_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n91_), .b(x23), .c(new_n100_), .O(new_n101_));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n103_), .c(new_n60_), .O(new_n106_));
  oai21  g60(.a(new_n101_), .b(new_n66_), .c(new_n106_), .O(z13));
  inv1   g61(.a(x24), .O(new_n108_));
  xor2a  g62(.a(new_n99_), .b(new_n108_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x16), .O(new_n110_));
  inv1   g64(.a(x13), .O(new_n111_));
  aoi21  g65(.a(new_n61_), .b(new_n111_), .c(x16), .O(new_n112_));
  oai21  g66(.a(new_n61_), .b(x05), .c(new_n112_), .O(new_n113_));
  aoi21  g67(.a(new_n113_), .b(new_n110_), .c(new_n60_), .O(z14));
  oai21  g68(.a(new_n99_), .b(x24), .c(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n81_), .d(new_n71_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  inv1   g72(.a(new_n60_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n61_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n66_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  aoi21  g77(.a(new_n118_), .b(new_n115_), .c(new_n123_), .O(z15));
  nand2  g78(.a(new_n116_), .b(new_n98_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n83_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  aoi21  g82(.a(new_n117_), .b(new_n128_), .c(new_n66_), .O(new_n129_));
  ...
  oai21  g86(.a(new_n61_), .b(x07), .c(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n60_), .O(z16));
  nand4  g88(.a(new_n81_), .b(new_n128_), .c(x19), .d(new_n65_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n125_), .c(new_n47_), .d(new_n65_), .O(new_n136_));
