...
module FAU ( 
  ...
  oai22  g08(.a(z08), .b(x24), .c(new_n51_), .d(x13), .O(z05));
  oai22  g09(.a(z08), .b(x25), .c(new_n51_), .d(x14), .O(z06));
  ...
  nand3  g43(.a(new_n63_), .b(new_n89_), .c(new_n70_), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(x22), .O(new_n91_));
  nor2   g45(.a(x22), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n63_), .c(new_n70_), .O(new_n93_));
  ...
  nand3  g63(.a(new_n101_), .b(new_n72_), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n102_), .b(x24), .c(new_n80_), .O(new_n111_));
  nor2   g65(.a(new_n65_), .b(new_n58_), .O(new_n112_));
  inv1   g66(.a(x13), .O(new_n113_));
  oai21  g67(.a(x18), .b(new_n113_), .c(new_n80_), .O(new_n114_));
  oai22  g68(.a(new_n114_), .b(new_n112_), .c(x27), .d(new_n58_), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n110_), .c(new_n115_), .O(z14));
  inv1   g70(.a(x22), .O(new_n117_));
  inv1   g71(.a(x23), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n117_), .c(new_n89_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n81_), .O(new_n120_));
  nor2   g74(.a(x25), .b(x24), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n120_), .c(new_n110_), .d(x25), .O(new_n122_));
  ...
  aoi21  g80(.a(new_n126_), .b(new_n124_), .c(new_n59_), .O(new_n127_));
  oai21  g81(.a(new_n122_), .b(new_n80_), .c(new_n127_), .O(z15));
  nand3  g82(.a(new_n121_), .b(new_n120_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  inv1   g84(.a(new_n121_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n102_), .c(new_n130_), .O(new_n132_));
  ...
  nand4  g94(.a(new_n140_), .b(new_n121_), .c(new_n101_), .d(new_n130_), .O(new_n141_));
  nor2   g95(.a(x17), .b(x05), .O(new_n142_));
