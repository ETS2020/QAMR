...
module FAU ( 
  ...
  nor2   g11(.a(new_n49_), .b(x06), .O(new_n58_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n99_), .c(new_n79_), .d(new_n66_), .O(new_n116_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n115_), .c(new_n79_), .d(new_n66_), .O(new_n125_));
  ...
  nand3  g89(.a(new_n115_), .b(new_n99_), .c(new_n135_), .O(new_n136_));
  nand3  g90(.a(new_n79_), .b(x19), .c(new_n134_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n49_), .d(new_n134_), .O(new_n138_));
