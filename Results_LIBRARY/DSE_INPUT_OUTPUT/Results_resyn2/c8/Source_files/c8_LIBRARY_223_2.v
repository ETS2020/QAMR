...
module FAU ( 
  ...
  nand3  g55(.a(new_n101_), .b(new_n72_), .c(new_n80_), .O(new_n102_));
  ...
  nand3  g71(.a(new_n110_), .b(new_n72_), .c(new_n80_), .O(new_n118_));
  inv1   g72(.a(x24), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand3  g74(.a(new_n101_), .b(new_n120_), .c(new_n119_), .O(new_n121_));
  nor2   g75(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  aoi21  g76(.a(new_n118_), .b(x25), .c(new_n122_), .O(new_n123_));
  ...
  oai21  g81(.a(new_n123_), .b(new_n109_), .c(new_n127_), .O(z15));
  oai21  g82(.a(new_n121_), .b(new_n82_), .c(x26), .O(new_n129_));
  nor2   g83(.a(x26), .b(x25), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n110_), .c(new_n72_), .d(new_n80_), .O(new_n131_));
  ...
  nand4  g94(.a(new_n140_), .b(new_n130_), .c(new_n110_), .d(new_n80_), .O(new_n141_));
