...
module FAU ( 
  ...
  oai22  g08(.a(z08), .b(x23), .c(new_n51_), .d(x12), .O(z04));
  ...
  nor2   g12(.a(x27), .b(x03), .O(new_n59_));
  ...
  inv1   g29(.a(new_n59_), .O(new_n76_));
  inv1   g30(.a(x16), .O(new_n77_));
  nand2  g31(.a(x18), .b(x02), .O(new_n78_));
  nand2  g32(.a(new_n65_), .b(x10), .O(new_n79_));
  nand3  g33(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  inv1   g34(.a(x20), .O(new_n81_));
  inv1   g35(.a(x21), .O(new_n82_));
  aoi21  g36(.a(new_n63_), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nor2   g37(.a(x21), .b(x20), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n63_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(x16), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n83_), .c(new_n80_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n76_), .O(z11));
  nand2  g42(.a(new_n85_), .b(x22), .O(new_n89_));
  inv1   g43(.a(x22), .O(new_n90_));
  inv1   g44(.a(new_n85_), .O(new_n91_));
  aoi21  g45(.a(new_n91_), .b(new_n90_), .c(new_n77_), .O(new_n92_));
  aoi21  g46(.a(new_n65_), .b(x11), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n65_), .b(new_n47_), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  aoi21  g49(.a(new_n92_), .b(new_n89_), .c(new_n95_), .O(z12));
  oai21  g50(.a(new_n85_), .b(x22), .c(x23), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n84_), .c(new_n63_), .O(new_n99_));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n103_), .c(new_n59_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n101_), .O(z13));
  nand2  g61(.a(new_n99_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x21), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n98_), .c(new_n63_), .d(new_n81_), .O(new_n110_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n98_), .c(new_n84_), .d(new_n63_), .O(new_n119_));
  and2   g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n65_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n77_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n76_), .O(new_n124_));
  aoi21  g78(.a(new_n120_), .b(new_n117_), .c(new_n124_), .O(z15));
  nand2  g79(.a(new_n118_), .b(new_n98_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n91_), .c(x26), .O(new_n128_));
  inv1   g82(.a(x26), .O(new_n129_));
  aoi21  g83(.a(new_n119_), .b(new_n129_), .c(new_n77_), .O(new_n130_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n109_), .d(new_n98_), .O(new_n138_));
  oai21  g92(.a(x17), .b(new_n47_), .c(new_n51_), .O(new_n139_));
