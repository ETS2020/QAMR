...
module FAU ( 
  ...
  nand3  g27(.a(new_n73_), .b(new_n70_), .c(x16), .O(new_n74_));
  aoi21  g28(.a(new_n60_), .b(x09), .c(x16), .O(new_n75_));
  oai21  g29(.a(new_n60_), .b(new_n48_), .c(new_n75_), .O(new_n76_));
  nand3  g30(.a(new_n76_), .b(new_n74_), .c(new_n69_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(z10));
  inv1   g32(.a(x21), .O(new_n79_));
  aoi21  g33(.a(new_n72_), .b(new_n71_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g43(.a(new_n81_), .b(new_n72_), .c(new_n89_), .O(new_n90_));
  nor2   g44(.a(x22), .b(x21), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n72_), .c(new_n71_), .O(new_n92_));
  inv1   g46(.a(new_n92_), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n90_), .c(x16), .O(new_n94_));
  inv1   g48(.a(x11), .O(new_n95_));
  aoi21  g49(.a(new_n60_), .b(new_n95_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n60_), .b(x03), .c(new_n96_), .O(new_n97_));
  ...
  nand4  g60(.a(new_n91_), .b(new_n72_), .c(new_n106_), .d(new_n71_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n91_), .c(new_n72_), .d(new_n71_), .O(new_n110_));
  ...
  aoi21  g69(.a(new_n60_), .b(new_n115_), .c(x16), .O(new_n116_));
  aoi21  g70(.a(new_n116_), .b(new_n114_), .c(new_n59_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n112_), .O(z14));
  nand2  g72(.a(new_n110_), .b(x25), .O(new_n119_));
  nor2   g73(.a(x25), .b(x22), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n81_), .d(new_n72_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n60_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n65_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n69_), .O(new_n126_));
  aoi21  g80(.a(new_n122_), .b(new_n119_), .c(new_n126_), .O(z15));
  nand2  g81(.a(new_n120_), .b(new_n109_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n83_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  aoi21  g85(.a(new_n121_), .b(new_n131_), .c(new_n65_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  inv1   g87(.a(x15), .O(new_n134_));
  aoi21  g88(.a(new_n60_), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g89(.a(new_n60_), .b(x07), .c(new_n135_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n59_), .O(z16));
  nand4  g91(.a(new_n81_), .b(new_n131_), .c(x19), .d(new_n64_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n128_), .c(new_n47_), .d(new_n64_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n69_), .O(z17));
endmodule
