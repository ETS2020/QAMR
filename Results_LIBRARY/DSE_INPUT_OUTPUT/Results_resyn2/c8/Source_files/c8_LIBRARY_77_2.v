...
module FAU ( 
  ...
  nand2  g78(.a(new_n77_), .b(x14), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n124_), .c(new_n62_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n60_), .O(new_n127_));
  aoi21  g81(.a(new_n123_), .b(new_n120_), .c(new_n127_), .O(z15));
  nor2   g82(.a(new_n122_), .b(new_n58_), .O(new_n129_));
  nand2  g83(.a(new_n122_), .b(new_n58_), .O(new_n130_));
  ...
  nand2  g91(.a(new_n121_), .b(new_n109_), .O(new_n138_));
  nand4  g92(.a(new_n82_), .b(new_n58_), .c(x19), .d(new_n65_), .O(new_n139_));
