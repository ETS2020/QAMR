...
module FAU ( 
  ...
  aoi21  g25(.a(new_n59_), .b(new_n71_), .c(new_n61_), .O(new_n72_));
  oai21  g26(.a(new_n59_), .b(x01), .c(new_n72_), .O(new_n73_));
  oai21  g27(.a(new_n70_), .b(new_n47_), .c(new_n73_), .O(z10));
  inv1   g28(.a(x21), .O(new_n75_));
  aoi21  g29(.a(new_n69_), .b(new_n68_), .c(new_n75_), .O(new_n76_));
  inv1   g30(.a(x19), .O(new_n77_));
  nand4  g31(.a(new_n75_), .b(new_n68_), .c(new_n77_), .d(new_n64_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(new_n79_));
  oai21  g33(.a(new_n79_), .b(new_n76_), .c(x16), .O(new_n80_));
  inv1   g34(.a(x10), .O(new_n81_));
  aoi21  g35(.a(new_n59_), .b(new_n81_), .c(new_n61_), .O(new_n82_));
  oai21  g36(.a(new_n59_), .b(x02), .c(new_n82_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n80_), .O(z11));
  xor2a  g38(.a(new_n78_), .b(x22), .O(new_n85_));
  inv1   g39(.a(x11), .O(new_n86_));
  aoi21  g40(.a(new_n59_), .b(new_n86_), .c(new_n61_), .O(new_n87_));
  oai21  g41(.a(new_n59_), .b(x03), .c(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n85_), .b(new_n47_), .c(new_n88_), .O(z12));
  inv1   g43(.a(x22), .O(new_n90_));
  nor2   g44(.a(x21), .b(x20), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n69_), .c(new_n90_), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(x23), .O(new_n93_));
  nor2   g47(.a(x23), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n91_), .c(new_n69_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x16), .O(new_n97_));
  inv1   g51(.a(x12), .O(new_n98_));
  aoi21  g52(.a(new_n59_), .b(new_n98_), .c(new_n61_), .O(new_n99_));
  ...
  nand4  g57(.a(new_n103_), .b(new_n94_), .c(new_n69_), .d(new_n68_), .O(new_n104_));
  ...
  aoi22  g69(.a(new_n115_), .b(new_n79_), .c(new_n104_), .d(x25), .O(new_n116_));
  ...
  nand3  g75(.a(new_n115_), .b(new_n79_), .c(new_n121_), .O(new_n122_));
  nor2   g76(.a(x25), .b(x24), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n94_), .c(new_n91_), .d(new_n69_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(x26), .c(new_n47_), .O(new_n125_));
  nand2  g79(.a(x18), .b(x07), .O(new_n126_));
  aoi21  g80(.a(new_n59_), .b(x15), .c(new_n61_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n122_), .O(z16));
  nand4  g82(.a(new_n91_), .b(new_n121_), .c(x19), .d(new_n64_), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n114_), .c(x16), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n61_), .O(new_n131_));
  nand3  g85(.a(x27), .b(x17), .c(x16), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n131_), .O(z17));
endmodule
