...
module FAU ( 
  ...
  nand2  g11(.a(new_n50_), .b(x01), .O(new_n58_));
  ...
  xor2a  g23(.a(new_n60_), .b(x20), .O(new_n70_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n80_), .c(new_n81_), .O(new_n82_));
  nor2   g36(.a(x21), .b(x20), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n60_), .O(new_n84_));
  ...
  aoi21  g42(.a(new_n83_), .b(new_n60_), .c(new_n88_), .O(new_n89_));
  nor2   g43(.a(x22), .b(x21), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n60_), .c(new_n80_), .O(new_n91_));
  ...
  oai21  g56(.a(new_n65_), .b(x04), .c(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n59_), .O(z13));
  nand4  g58(.a(new_n90_), .b(new_n60_), .c(new_n98_), .d(new_n80_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n90_), .c(new_n60_), .d(new_n80_), .O(new_n108_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n83_), .d(new_n60_), .O(new_n119_));
  and2   g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  nand2  g75(.a(new_n65_), .b(x14), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n76_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n58_), .O(new_n124_));
  aoi21  g78(.a(new_n120_), .b(new_n117_), .c(new_n124_), .O(z15));
  inv1   g79(.a(new_n84_), .O(new_n126_));
  nand2  g80(.a(new_n118_), .b(new_n107_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n126_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  aoi21  g84(.a(new_n119_), .b(new_n130_), .c(new_n76_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  inv1   g86(.a(x15), .O(new_n133_));
  aoi21  g87(.a(new_n65_), .b(new_n133_), .c(x16), .O(new_n134_));
  oai21  g88(.a(new_n65_), .b(x07), .c(new_n134_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n59_), .O(z16));
  nor2   g90(.a(x20), .b(new_n62_), .O(new_n137_));
  nor2   g91(.a(x26), .b(x25), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n90_), .O(new_n139_));
  nor2   g93(.a(x17), .b(x01), .O(new_n140_));
  oai21  g94(.a(new_n140_), .b(x27), .c(x16), .O(new_n141_));
  aoi21  g95(.a(new_n139_), .b(new_n61_), .c(new_n141_), .O(z17));
endmodule
