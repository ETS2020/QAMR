...
module FAU ( 
  ...
  oai21  g21(.a(new_n67_), .b(new_n63_), .c(new_n61_), .O(z09));
  ...
  oai22  g28(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(new_n64_), .O(z10));
  ...
  aoi21  g34(.a(new_n80_), .b(new_n70_), .c(new_n64_), .O(new_n81_));
  aoi22  g35(.a(new_n81_), .b(new_n79_), .c(new_n77_), .d(new_n76_), .O(z11));
  inv1   g36(.a(x22), .O(new_n83_));
  aoi21  g37(.a(new_n80_), .b(new_n70_), .c(new_n83_), .O(new_n84_));
  nand3  g38(.a(new_n80_), .b(new_n70_), .c(new_n83_), .O(new_n85_));
  ...
  oai21  g42(.a(x18), .b(x11), .c(new_n73_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(z12));
  nand2  g44(.a(new_n85_), .b(x23), .O(new_n91_));
  nor2   g45(.a(x23), .b(x22), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n80_), .c(new_n70_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n65_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n101_), .b(new_n92_), .c(new_n70_), .d(new_n69_), .O(new_n102_));
  ...
  oai21  g60(.a(new_n58_), .b(x05), .c(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n104_), .O(z14));
  nand2  g62(.a(new_n102_), .b(x25), .O(new_n109_));
  nor2   g63(.a(x25), .b(x24), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n92_), .c(new_n80_), .d(new_n70_), .O(new_n111_));
  ...
  oai21  g69(.a(new_n58_), .b(x06), .c(new_n115_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n113_), .O(z15));
  nor2   g71(.a(new_n58_), .b(x07), .O(new_n118_));
  oai21  g72(.a(x18), .b(x15), .c(new_n73_), .O(new_n119_));
  inv1   g73(.a(x26), .O(new_n120_));
  nor2   g74(.a(new_n111_), .b(new_n120_), .O(new_n121_));
  nand2  g75(.a(new_n111_), .b(new_n120_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n65_), .O(new_n123_));
  oai22  g77(.a(new_n123_), .b(new_n121_), .c(new_n119_), .d(new_n118_), .O(z16));
  nand2  g78(.a(new_n101_), .b(new_n92_), .O(new_n125_));
  inv1   g79(.a(x25), .O(new_n126_));
  nand3  g80(.a(new_n120_), .b(new_n126_), .c(new_n69_), .O(new_n127_));
  nor4   g81(.a(new_n127_), .b(new_n125_), .c(new_n66_), .d(new_n64_), .O(z17));
  buf    g82(.a(x27), .O(z08));
endmodule
