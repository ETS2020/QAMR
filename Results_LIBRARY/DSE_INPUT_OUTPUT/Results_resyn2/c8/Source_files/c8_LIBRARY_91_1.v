...
module FAU ( 
  ...
  aoi21  g09(.a(new_n47_), .b(x25), .c(new_n49_), .O(z06));
  ...
  nand4  g58(.a(new_n79_), .b(new_n70_), .c(new_n96_), .d(new_n97_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n79_), .c(new_n70_), .d(new_n97_), .O(new_n108_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n79_), .d(new_n70_), .O(new_n119_));
  ...
  nand3  g82(.a(new_n128_), .b(new_n81_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  aoi21  g84(.a(new_n119_), .b(new_n130_), .c(new_n65_), .O(new_n131_));
  ...
  oai21  g88(.a(new_n59_), .b(x07), .c(new_n134_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n58_), .O(z16));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n128_), .b(new_n79_), .c(new_n66_), .d(new_n130_), .O(new_n138_));
  nand2  g92(.a(new_n121_), .b(x16), .O(new_n139_));
