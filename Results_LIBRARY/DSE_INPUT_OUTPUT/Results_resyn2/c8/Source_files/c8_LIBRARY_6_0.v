...
module FAU ( 
  ...
  oai22  g08(.a(new_n50_), .b(x23), .c(new_n47_), .d(x12), .O(z04));
  ...
  nor2   g12(.a(x27), .b(x06), .O(new_n59_));
  ...
  nor2   g22(.a(new_n61_), .b(new_n68_), .O(new_n69_));
  ...
  oai21  g34(.a(new_n70_), .b(new_n78_), .c(new_n80_), .O(new_n81_));
  nand2  g35(.a(new_n81_), .b(x16), .O(new_n82_));
  inv1   g36(.a(x10), .O(new_n83_));
  aoi21  g37(.a(new_n63_), .b(new_n83_), .c(x16), .O(new_n84_));
  oai21  g38(.a(new_n63_), .b(x02), .c(new_n84_), .O(new_n85_));
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n59_), .O(z11));
  inv1   g40(.a(new_n59_), .O(new_n87_));
  inv1   g41(.a(x16), .O(new_n88_));
  nand2  g42(.a(x18), .b(x03), .O(new_n89_));
  nand2  g43(.a(new_n63_), .b(x11), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  nor2   g45(.a(x22), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n61_), .c(new_n68_), .O(new_n93_));
  nand2  g47(.a(new_n80_), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n87_), .O(z12));
  inv1   g51(.a(x23), .O(new_n98_));
  xor2a  g52(.a(new_n93_), .b(new_n98_), .O(new_n99_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n70_), .c(new_n98_), .O(new_n105_));
  nand2  g59(.a(new_n61_), .b(new_n68_), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n92_), .O(new_n108_));
  ...
  nand2  g79(.a(new_n125_), .b(new_n121_), .O(z15));
  inv1   g80(.a(new_n80_), .O(new_n127_));
  nand2  g81(.a(new_n118_), .b(new_n107_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n127_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  aoi21  g85(.a(new_n119_), .b(new_n131_), .c(new_n88_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  inv1   g87(.a(x15), .O(new_n134_));
  aoi21  g88(.a(new_n63_), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g89(.a(new_n63_), .b(x07), .c(new_n135_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n59_), .O(z16));
  inv1   g91(.a(x17), .O(new_n138_));
  inv1   g92(.a(new_n108_), .O(new_n139_));
  nor2   g93(.a(x26), .b(x25), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n139_), .c(new_n68_), .d(x19), .O(new_n141_));
  oai21  g95(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(new_n143_), .O(z17));
  buf    g98(.a(x27), .O(z08));
endmodule
