...
module FAU ( 
  ...
  nand3  g34(.a(new_n72_), .b(new_n65_), .c(new_n64_), .O(new_n81_));
  ...
  nand2  g43(.a(new_n74_), .b(new_n89_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n74_), .b(new_n98_), .c(new_n89_), .O(new_n99_));
  ...
  aoi21  g61(.a(new_n107_), .b(new_n105_), .c(new_n69_), .O(new_n108_));
  ...
  nand3  g66(.a(new_n112_), .b(new_n74_), .c(new_n111_), .O(new_n113_));
  ...
  oai21  g71(.a(new_n60_), .b(x05), .c(new_n117_), .O(new_n118_));
  aoi21  g72(.a(new_n118_), .b(new_n115_), .c(new_n69_), .O(z14));
  nand2  g73(.a(new_n113_), .b(x25), .O(new_n120_));
  nor2   g74(.a(x25), .b(x24), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n102_), .c(new_n80_), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n60_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n80_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n70_), .O(new_n126_));
  aoi21  g80(.a(new_n122_), .b(new_n120_), .c(new_n126_), .O(z15));
  nand3  g81(.a(new_n121_), .b(new_n102_), .c(x26), .O(new_n128_));
  inv1   g82(.a(x26), .O(new_n129_));
  nand2  g83(.a(new_n112_), .b(new_n74_), .O(new_n130_));
  ...
  aoi21  g91(.a(new_n137_), .b(new_n135_), .c(new_n69_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n133_), .O(z16));
  nor2   g93(.a(x20), .b(new_n65_), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n121_), .c(new_n112_), .d(new_n129_), .O(new_n141_));
  oai21  g95(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  aoi21  g97(.a(new_n141_), .b(new_n64_), .c(new_n143_), .O(z17));
endmodule
