...
module FAU ( 
  ...
  oai22  g06(.a(z08), .b(x22), .c(new_n51_), .d(x11), .O(z03));
  aoi22  g07(.a(new_n47_), .b(x23), .c(x27), .d(x12), .O(z04));
  aoi22  g08(.a(new_n47_), .b(x24), .c(x27), .d(x13), .O(z05));
  aoi21  g09(.a(new_n51_), .b(x25), .c(x14), .O(z06));
  oai22  g10(.a(z08), .b(x26), .c(new_n51_), .d(x15), .O(z07));
  ...
  nand2  g18(.a(new_n51_), .b(x14), .O(new_n65_));
  ...
  aoi21  g31(.a(new_n63_), .b(new_n68_), .c(new_n77_), .O(new_n78_));
  ...
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(new_n70_), .O(z11));
  nand2  g40(.a(x18), .b(x03), .O(new_n87_));
  nand2  g41(.a(new_n58_), .b(x11), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n87_), .c(new_n67_), .O(new_n89_));
  nor2   g43(.a(x22), .b(x21), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n63_), .c(new_n68_), .O(new_n91_));
  nand2  g45(.a(new_n80_), .b(x22), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n65_), .O(z12));
  inv1   g49(.a(x23), .O(new_n96_));
  xor2a  g50(.a(new_n91_), .b(new_n96_), .O(new_n97_));
  ...
  aoi21  g55(.a(new_n101_), .b(new_n98_), .c(new_n70_), .O(z13));
  nand4  g56(.a(new_n90_), .b(new_n63_), .c(new_n96_), .d(new_n68_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n90_), .c(new_n63_), .d(new_n68_), .O(new_n106_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n129_), .c(new_n70_), .O(z16));
  inv1   g87(.a(x17), .O(new_n134_));
  nor2   g88(.a(x26), .b(x21), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n125_), .c(new_n68_), .d(x19), .O(new_n136_));
  nor2   g90(.a(x17), .b(x14), .O(new_n137_));
