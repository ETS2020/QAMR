...
module FAU ( 
  ...
  nand2  g11(.a(x27), .b(new_n48_), .O(new_n58_));
  ...
  inv1   g32(.a(new_n60_), .O(new_n79_));
  nand2  g33(.a(x18), .b(x02), .O(new_n80_));
  nand2  g34(.a(new_n61_), .b(x10), .O(new_n81_));
  nand3  g35(.a(new_n81_), .b(new_n80_), .c(new_n66_), .O(new_n82_));
  inv1   g36(.a(x21), .O(new_n83_));
  nor2   g37(.a(new_n73_), .b(new_n83_), .O(new_n84_));
  nor2   g38(.a(x21), .b(x20), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n71_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(x16), .O(new_n87_));
  oai21  g41(.a(new_n87_), .b(new_n84_), .c(new_n82_), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n79_), .O(z11));
  inv1   g43(.a(x22), .O(new_n90_));
  aoi21  g44(.a(new_n85_), .b(new_n71_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n85_), .b(new_n71_), .c(new_n90_), .O(new_n92_));
  ...
  nand3  g54(.a(new_n100_), .b(new_n85_), .c(new_n71_), .O(new_n101_));
  ...
  aoi21  g60(.a(new_n61_), .b(new_n106_), .c(x16), .O(new_n107_));
  ...
  nand4  g65(.a(new_n111_), .b(new_n100_), .c(new_n71_), .d(new_n70_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x16), .O(new_n114_));
  inv1   g68(.a(x13), .O(new_n115_));
  aoi21  g69(.a(new_n61_), .b(new_n115_), .c(x16), .O(new_n116_));
  oai21  g70(.a(new_n61_), .b(x05), .c(new_n116_), .O(new_n117_));
  aoi21  g71(.a(new_n117_), .b(new_n114_), .c(new_n60_), .O(z14));
  nand2  g72(.a(new_n112_), .b(x25), .O(new_n119_));
  nor2   g73(.a(x25), .b(x24), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n100_), .c(new_n85_), .d(new_n71_), .O(new_n121_));
  ...
  oai21  g79(.a(new_n61_), .b(x06), .c(new_n125_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n123_), .c(new_n60_), .O(z15));
  inv1   g81(.a(x26), .O(new_n128_));
  nand3  g82(.a(new_n120_), .b(new_n100_), .c(new_n128_), .O(new_n129_));
  nor2   g83(.a(new_n129_), .b(new_n86_), .O(new_n130_));
  aoi21  g84(.a(new_n121_), .b(x26), .c(new_n130_), .O(new_n131_));
  nand2  g85(.a(new_n79_), .b(x16), .O(new_n132_));
  oai21  g86(.a(new_n47_), .b(new_n61_), .c(new_n48_), .O(new_n133_));
  inv1   g87(.a(x07), .O(new_n134_));
  aoi21  g88(.a(x18), .b(new_n134_), .c(x16), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  oai21  g90(.a(new_n132_), .b(new_n131_), .c(new_n136_), .O(z16));
  nand3  g91(.a(new_n85_), .b(x19), .c(new_n65_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n129_), .c(new_n47_), .d(new_n65_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n79_), .O(z17));
endmodule
