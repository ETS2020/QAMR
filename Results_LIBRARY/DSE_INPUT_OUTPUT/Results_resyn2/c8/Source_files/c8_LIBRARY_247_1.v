...
module FAU ( 
  ...
  nand2  g40(.a(new_n60_), .b(x11), .O(new_n87_));
  nand3  g41(.a(new_n87_), .b(new_n86_), .c(new_n59_), .O(new_n88_));
  inv1   g42(.a(new_n88_), .O(new_n89_));
  nand2  g43(.a(new_n80_), .b(x22), .O(new_n90_));
  inv1   g44(.a(x22), .O(new_n91_));
  nor2   g45(.a(x21), .b(x20), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n66_), .c(new_n91_), .O(new_n93_));
  and2   g47(.a(new_n93_), .b(x16), .O(new_n94_));
  aoi21  g48(.a(new_n94_), .b(new_n90_), .c(new_n89_), .O(z12));
  nand2  g49(.a(new_n93_), .b(x23), .O(new_n96_));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n92_), .c(new_n66_), .O(new_n98_));
  ...
  nand2  g57(.a(new_n60_), .b(new_n103_), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n102_), .c(new_n59_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n100_), .O(z13));
  nand2  g60(.a(new_n98_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x21), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n97_), .c(new_n66_), .d(new_n73_), .O(new_n109_));
  ...
  nand2  g68(.a(new_n60_), .b(new_n114_), .O(new_n115_));
  nand3  g69(.a(new_n115_), .b(new_n113_), .c(new_n59_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n111_), .O(z14));
  inv1   g71(.a(x23), .O(new_n118_));
  inv1   g72(.a(x24), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n91_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n81_), .c(new_n109_), .d(x25), .O(new_n123_));
  inv1   g77(.a(x06), .O(new_n124_));
  nand2  g78(.a(x18), .b(new_n124_), .O(new_n125_));
  inv1   g79(.a(x14), .O(new_n126_));
  nand2  g80(.a(new_n60_), .b(new_n126_), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n125_), .c(new_n59_), .O(new_n128_));
  oai21  g82(.a(new_n123_), .b(new_n65_), .c(new_n128_), .O(z15));
  inv1   g83(.a(x26), .O(new_n130_));
  nand3  g84(.a(new_n122_), .b(new_n81_), .c(new_n130_), .O(new_n131_));
  nor2   g85(.a(x25), .b(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n97_), .c(new_n92_), .d(new_n66_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(x26), .c(new_n65_), .O(new_n134_));
  nand2  g88(.a(x18), .b(x07), .O(new_n135_));
  nand2  g89(.a(new_n60_), .b(x15), .O(new_n136_));
  nand3  g90(.a(new_n136_), .b(new_n135_), .c(new_n59_), .O(new_n137_));
  inv1   g91(.a(new_n137_), .O(new_n138_));
  aoi21  g92(.a(new_n134_), .b(new_n131_), .c(new_n138_), .O(z16));
  nor2   g93(.a(x17), .b(new_n65_), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n92_), .c(new_n130_), .d(x19), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n121_), .c(new_n140_), .d(new_n49_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
