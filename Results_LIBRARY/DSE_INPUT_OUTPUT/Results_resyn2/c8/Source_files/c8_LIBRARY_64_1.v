...
module FAU ( 
  ...
  nor2   g18(.a(new_n49_), .b(x14), .O(new_n65_));
  inv1   g19(.a(new_n65_), .O(new_n66_));
  nand3  g20(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(z09));
  xor2a  g21(.a(new_n63_), .b(x20), .O(new_n68_));
  nand2  g22(.a(new_n68_), .b(x16), .O(new_n69_));
  inv1   g23(.a(x09), .O(new_n70_));
  aoi21  g24(.a(new_n58_), .b(new_n70_), .c(x16), .O(new_n71_));
  oai21  g25(.a(new_n58_), .b(x01), .c(new_n71_), .O(new_n72_));
  aoi21  g26(.a(new_n72_), .b(new_n69_), .c(new_n65_), .O(z10));
  inv1   g27(.a(x20), .O(new_n74_));
  inv1   g28(.a(x21), .O(new_n75_));
  aoi21  g29(.a(new_n63_), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  nor2   g30(.a(x21), .b(x20), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(new_n63_), .O(new_n78_));
  ...
  oai21  g36(.a(new_n58_), .b(x02), .c(new_n82_), .O(new_n83_));
  aoi21  g37(.a(new_n83_), .b(new_n80_), .c(new_n65_), .O(z11));
  inv1   g38(.a(x22), .O(new_n85_));
  aoi21  g39(.a(new_n77_), .b(new_n63_), .c(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n77_), .b(new_n63_), .c(new_n85_), .O(new_n87_));
  ...
  oai21  g45(.a(new_n58_), .b(x03), .c(new_n91_), .O(new_n92_));
  aoi21  g46(.a(new_n92_), .b(new_n89_), .c(new_n65_), .O(z12));
  nand2  g47(.a(new_n87_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n77_), .c(new_n63_), .O(new_n96_));
  ...
  aoi21  g55(.a(new_n101_), .b(new_n98_), .c(new_n65_), .O(z13));
  inv1   g56(.a(x24), .O(new_n103_));
  xor2a  g57(.a(new_n96_), .b(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x16), .O(new_n105_));
  inv1   g59(.a(x13), .O(new_n106_));
  aoi21  g60(.a(new_n58_), .b(new_n106_), .c(x16), .O(new_n107_));
  oai21  g61(.a(new_n58_), .b(x05), .c(new_n107_), .O(new_n108_));
  aoi21  g62(.a(new_n108_), .b(new_n105_), .c(new_n65_), .O(z14));
  oai21  g63(.a(new_n96_), .b(x24), .c(x25), .O(new_n110_));
  nor2   g64(.a(x25), .b(x24), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n95_), .c(new_n77_), .d(new_n63_), .O(new_n112_));
  and2   g66(.a(new_n112_), .b(x16), .O(new_n113_));
  inv1   g67(.a(x16), .O(new_n114_));
  nand2  g68(.a(x18), .b(x06), .O(new_n115_));
  nand2  g69(.a(new_n58_), .b(x14), .O(new_n116_));
  nand3  g70(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n66_), .O(new_n118_));
  aoi21  g72(.a(new_n113_), .b(new_n110_), .c(new_n118_), .O(z15));
  nand2  g73(.a(new_n111_), .b(new_n95_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n79_), .c(x26), .O(new_n122_));
  inv1   g76(.a(x26), .O(new_n123_));
  aoi21  g77(.a(new_n112_), .b(new_n123_), .c(new_n114_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  inv1   g79(.a(x15), .O(new_n126_));
  aoi21  g80(.a(new_n58_), .b(new_n126_), .c(x16), .O(new_n127_));
  oai21  g81(.a(new_n58_), .b(x07), .c(new_n127_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n125_), .c(new_n65_), .O(z16));
  inv1   g83(.a(x17), .O(new_n130_));
  nand4  g84(.a(new_n77_), .b(new_n123_), .c(x19), .d(new_n130_), .O(new_n131_));
  oai22  g85(.a(new_n131_), .b(new_n120_), .c(new_n49_), .d(new_n130_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n66_), .O(z17));
  buf    g88(.a(x27), .O(z08));
endmodule
