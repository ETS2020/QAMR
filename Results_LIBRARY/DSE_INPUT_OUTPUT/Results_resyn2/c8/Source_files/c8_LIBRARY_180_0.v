...
module FAU ( 
  ...
  nor2   g21(.a(x27), .b(x14), .O(new_n68_));
  ...
  nand3  g36(.a(new_n66_), .b(new_n81_), .c(new_n71_), .O(new_n83_));
  ...
  aoi21  g43(.a(new_n89_), .b(new_n87_), .c(new_n68_), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n85_), .O(z11));
  nand2  g45(.a(new_n83_), .b(x22), .O(new_n92_));
  nor2   g46(.a(x22), .b(x21), .O(new_n93_));
  nand3  g47(.a(new_n93_), .b(new_n66_), .c(new_n71_), .O(new_n94_));
  ...
  aoi21  g70(.a(new_n116_), .b(new_n114_), .c(new_n68_), .O(new_n117_));
  ...
  aoi21  g80(.a(new_n59_), .b(new_n48_), .c(x16), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n68_), .O(new_n128_));
  ...
  aoi21  g92(.a(new_n138_), .b(new_n136_), .c(new_n68_), .O(new_n139_));
  ...
  aoi21  g98(.a(new_n142_), .b(new_n63_), .c(new_n144_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
