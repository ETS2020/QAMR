...
module FAU ( 
  ...
  nand3  g36(.a(new_n64_), .b(new_n81_), .c(new_n71_), .O(new_n83_));
  ...
  aoi21  g43(.a(new_n89_), .b(new_n87_), .c(new_n60_), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n85_), .O(z11));
  nand2  g45(.a(new_n83_), .b(x22), .O(new_n92_));
  nor2   g46(.a(x22), .b(x21), .O(new_n93_));
  nand3  g47(.a(new_n93_), .b(new_n64_), .c(new_n71_), .O(new_n94_));
  ...
  aoi21  g53(.a(new_n99_), .b(new_n96_), .c(new_n60_), .O(z12));
  nand2  g54(.a(new_n94_), .b(x23), .O(new_n101_));
  nor2   g55(.a(x23), .b(x22), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n73_), .c(new_n81_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x16), .O(new_n105_));
  inv1   g59(.a(x12), .O(new_n106_));
  aoi21  g60(.a(new_n66_), .b(new_n106_), .c(x16), .O(new_n107_));
  oai21  g61(.a(new_n66_), .b(x04), .c(new_n107_), .O(new_n108_));
  aoi21  g62(.a(new_n108_), .b(new_n105_), .c(new_n60_), .O(z13));
  inv1   g63(.a(x16), .O(new_n110_));
  nor3   g64(.a(x24), .b(x23), .c(x22), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n84_), .c(new_n103_), .d(x24), .O(new_n112_));
  ...
  aoi21  g70(.a(new_n116_), .b(new_n114_), .c(new_n60_), .O(new_n117_));
  oai21  g71(.a(new_n112_), .b(new_n110_), .c(new_n117_), .O(z14));
  nand3  g72(.a(new_n111_), .b(new_n73_), .c(new_n81_), .O(new_n119_));
  inv1   g73(.a(x24), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand3  g75(.a(new_n102_), .b(new_n121_), .c(new_n120_), .O(new_n122_));
  nor2   g76(.a(new_n122_), .b(new_n83_), .O(new_n123_));
  aoi21  g77(.a(new_n119_), .b(x25), .c(new_n123_), .O(new_n124_));
  inv1   g78(.a(x06), .O(new_n125_));
  nand2  g79(.a(x18), .b(new_n125_), .O(new_n126_));
  aoi21  g80(.a(new_n66_), .b(new_n48_), .c(x16), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n60_), .O(new_n128_));
  oai21  g82(.a(new_n124_), .b(new_n110_), .c(new_n128_), .O(z15));
  oai21  g83(.a(new_n122_), .b(new_n83_), .c(x26), .O(new_n130_));
  nor2   g84(.a(x26), .b(x25), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n111_), .c(new_n73_), .d(new_n81_), .O(new_n132_));
  ...
  aoi21  g91(.a(new_n66_), .b(new_n137_), .c(x16), .O(new_n138_));
  aoi21  g92(.a(new_n138_), .b(new_n136_), .c(new_n60_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n134_), .O(z16));
  nor2   g94(.a(x20), .b(new_n62_), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n131_), .c(new_n111_), .d(new_n81_), .O(new_n142_));
  oai21  g96(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(x16), .O(new_n144_));
  aoi21  g98(.a(new_n142_), .b(new_n61_), .c(new_n144_), .O(z17));
endmodule
