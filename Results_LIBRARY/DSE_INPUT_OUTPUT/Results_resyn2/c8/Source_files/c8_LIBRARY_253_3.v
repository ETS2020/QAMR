...
module FAU ( 
  ...
  inv1   g21(.a(new_n59_), .O(new_n68_));
  xor2a  g22(.a(new_n60_), .b(x20), .O(new_n69_));
  nand2  g23(.a(new_n69_), .b(x16), .O(new_n70_));
  inv1   g24(.a(x09), .O(new_n71_));
  aoi21  g25(.a(new_n63_), .b(new_n71_), .c(x16), .O(new_n72_));
  oai21  g26(.a(new_n63_), .b(x01), .c(new_n72_), .O(new_n73_));
  nand3  g27(.a(new_n73_), .b(new_n70_), .c(new_n68_), .O(z10));
  inv1   g28(.a(x20), .O(new_n75_));
  inv1   g29(.a(x21), .O(new_n76_));
  aoi21  g30(.a(new_n60_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  ...
  oai21  g37(.a(new_n63_), .b(x02), .c(new_n83_), .O(new_n84_));
  aoi21  g38(.a(new_n84_), .b(new_n81_), .c(new_n59_), .O(z11));
  ...
  oai21  g45(.a(new_n87_), .b(new_n86_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x23), .O(new_n93_));
  inv1   g47(.a(x22), .O(new_n94_));
  nand3  g48(.a(new_n78_), .b(new_n60_), .c(new_n94_), .O(new_n95_));
  xor2a  g49(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n78_), .b(new_n60_), .c(new_n93_), .d(new_n94_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x24), .O(new_n103_));
  nor2   g57(.a(x24), .b(x23), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n104_), .c(new_n60_), .d(new_n75_), .O(new_n106_));
  ...
  nand2  g70(.a(new_n116_), .b(new_n104_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n79_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n86_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n63_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n86_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n68_), .O(new_n123_));
  aoi21  g77(.a(new_n119_), .b(new_n115_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nor3   g79(.a(new_n117_), .b(new_n79_), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g88(.a(new_n78_), .b(new_n125_), .c(x19), .d(new_n134_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n117_), .c(new_n47_), .d(new_n134_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n68_), .O(z17));
endmodule
