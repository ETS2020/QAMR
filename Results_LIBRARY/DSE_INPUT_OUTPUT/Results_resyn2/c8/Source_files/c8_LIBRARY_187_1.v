...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(x25), .c(z08), .O(z06));
  aoi22  g10(.a(z08), .b(x15), .c(new_n50_), .d(x26), .O(z07));
  ...
  nor2   g18(.a(new_n50_), .b(x14), .O(new_n65_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n79_), .c(new_n63_), .O(new_n98_));
  ...
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n65_), .O(z13));
  ...
  aoi21  g64(.a(new_n110_), .b(new_n107_), .c(new_n65_), .O(z14));
  oai21  g65(.a(new_n98_), .b(x24), .c(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n97_), .c(new_n79_), .d(new_n63_), .O(new_n114_));
  and2   g68(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g69(.a(x18), .b(x06), .O(new_n116_));
  nand2  g70(.a(new_n58_), .b(x14), .O(new_n117_));
  nand3  g71(.a(new_n117_), .b(new_n116_), .c(new_n68_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  aoi21  g73(.a(new_n115_), .b(new_n112_), .c(new_n119_), .O(z15));
  nand2  g74(.a(new_n113_), .b(new_n97_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n81_), .c(x26), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  aoi21  g78(.a(new_n114_), .b(new_n124_), .c(new_n68_), .O(new_n125_));
  ...
  aoi21  g83(.a(new_n129_), .b(new_n126_), .c(new_n65_), .O(z16));
  inv1   g84(.a(x17), .O(new_n131_));
  nand4  g85(.a(new_n79_), .b(new_n124_), .c(x19), .d(new_n131_), .O(new_n132_));
  oai22  g86(.a(new_n132_), .b(new_n121_), .c(new_n50_), .d(new_n131_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n66_), .O(z17));
endmodule
