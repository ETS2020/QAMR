...
module FAU ( 
  ...
  aoi21  g72(.a(new_n63_), .b(x14), .c(x16), .O(new_n119_));
  oai21  g73(.a(new_n63_), .b(new_n48_), .c(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n60_), .O(new_n121_));
  aoi21  g75(.a(new_n118_), .b(new_n115_), .c(new_n121_), .O(z15));
  nand2  g76(.a(new_n117_), .b(x26), .O(new_n123_));
  nor3   g77(.a(x26), .b(x23), .c(x22), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n116_), .c(new_n80_), .d(new_n67_), .O(new_n125_));
  ...
  nand3  g89(.a(new_n116_), .b(new_n100_), .c(new_n135_), .O(new_n136_));
