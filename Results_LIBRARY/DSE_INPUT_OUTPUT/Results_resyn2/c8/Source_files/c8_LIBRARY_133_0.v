...
module FAU ( 
  ...
  aoi21  g44(.a(new_n80_), .b(new_n62_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n80_), .b(new_n62_), .c(new_n90_), .O(new_n92_));
  ...
  nand3  g54(.a(new_n100_), .b(new_n80_), .c(new_n62_), .O(new_n101_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n100_), .c(new_n80_), .d(new_n62_), .O(new_n117_));
  ...
  aoi21  g75(.a(new_n64_), .b(new_n47_), .c(x16), .O(new_n122_));
  ...
  aoi21  g82(.a(new_n117_), .b(new_n128_), .c(new_n69_), .O(new_n129_));
  ...
  nand4  g90(.a(new_n128_), .b(new_n136_), .c(new_n108_), .d(new_n78_), .O(new_n137_));
  inv1   g91(.a(new_n137_), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n100_), .c(new_n70_), .d(x19), .O(new_n139_));
