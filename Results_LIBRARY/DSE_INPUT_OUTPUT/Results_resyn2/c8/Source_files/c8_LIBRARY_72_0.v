...
module FAU ( 
  ...
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n81_), .d(new_n67_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n63_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n61_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n60_), .O(new_n122_));
  aoi21  g76(.a(new_n118_), .b(new_n115_), .c(new_n122_), .O(z15));
  nor2   g77(.a(new_n117_), .b(x26), .O(new_n124_));
  nand2  g78(.a(new_n117_), .b(x26), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(x16), .O(new_n126_));
  nand2  g80(.a(x18), .b(x07), .O(new_n127_));
  nand2  g81(.a(new_n63_), .b(x15), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n127_), .c(new_n61_), .O(new_n129_));
  oai21  g83(.a(new_n126_), .b(new_n124_), .c(new_n129_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n60_), .O(z16));
  inv1   g85(.a(x17), .O(new_n132_));
  nand2  g86(.a(new_n116_), .b(new_n105_), .O(new_n133_));
  inv1   g87(.a(x26), .O(new_n134_));
  nand4  g88(.a(new_n81_), .b(new_n134_), .c(x19), .d(new_n132_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n133_), .c(new_n47_), .d(new_n132_), .O(new_n136_));
