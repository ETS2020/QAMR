...
module FAU ( 
  ...
  nand2  g10(.a(x27), .b(x15), .O(z07));
  nor2   g11(.a(x27), .b(new_n48_), .O(new_n58_));
  ...
  nand4  g61(.a(new_n107_), .b(new_n106_), .c(new_n69_), .d(new_n68_), .O(new_n108_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n106_), .c(new_n79_), .d(new_n69_), .O(new_n119_));
  ...
  aoi21  g78(.a(new_n124_), .b(new_n121_), .c(new_n58_), .O(z15));
  nor2   g79(.a(new_n47_), .b(new_n48_), .O(new_n126_));
  nand3  g80(.a(new_n118_), .b(new_n106_), .c(new_n48_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n81_), .c(new_n126_), .d(new_n119_), .O(new_n129_));
  nor2   g83(.a(new_n58_), .b(x16), .O(new_n130_));
  inv1   g84(.a(x07), .O(new_n131_));
  nand2  g85(.a(x18), .b(new_n131_), .O(new_n132_));
  inv1   g86(.a(x15), .O(new_n133_));
  nand2  g87(.a(new_n59_), .b(new_n133_), .O(new_n134_));
  nand3  g88(.a(new_n134_), .b(new_n132_), .c(new_n130_), .O(new_n135_));
  oai21  g89(.a(new_n129_), .b(new_n64_), .c(new_n135_), .O(z16));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n128_), .b(new_n79_), .c(x19), .d(new_n63_), .O(new_n138_));
  aoi21  g92(.a(new_n138_), .b(new_n137_), .c(new_n64_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
