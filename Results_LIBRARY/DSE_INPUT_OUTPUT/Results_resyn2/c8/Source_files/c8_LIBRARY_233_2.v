...
module FAU ( 
  ...
  nand4  g58(.a(new_n81_), .b(new_n67_), .c(new_n98_), .d(new_n89_), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n81_), .c(new_n67_), .d(new_n89_), .O(new_n107_));
  inv1   g61(.a(new_n107_), .O(new_n108_));
  aoi21  g62(.a(new_n105_), .b(x24), .c(new_n108_), .O(new_n109_));
  ...
  nor2   g69(.a(new_n107_), .b(new_n56_), .O(new_n116_));
  oai21  g70(.a(new_n108_), .b(x25), .c(x16), .O(new_n117_));
  ...
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n57_), .O(new_n122_));
  oai21  g76(.a(new_n117_), .b(new_n116_), .c(new_n122_), .O(z15));
  nand2  g77(.a(new_n107_), .b(x26), .O(new_n124_));
  nor3   g78(.a(x26), .b(x25), .c(x22), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n106_), .c(new_n81_), .d(new_n67_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x16), .O(new_n128_));
  nand2  g82(.a(x26), .b(x16), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(x27), .c(new_n56_), .O(new_n130_));
  ...
  nand4  g92(.a(new_n106_), .b(new_n138_), .c(new_n56_), .d(new_n89_), .O(new_n139_));
  ...
  nand2  g96(.a(new_n142_), .b(new_n60_), .O(z17));
endmodule
