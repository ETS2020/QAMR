...
module FAU ( 
  ...
  oai22  g10(.a(new_n54_), .b(x23), .c(new_n47_), .d(x12), .O(z04));
  oai22  g11(.a(new_n54_), .b(x24), .c(new_n47_), .d(x13), .O(z05));
  oai22  g12(.a(new_n54_), .b(x25), .c(new_n47_), .d(x14), .O(z06));
  oai22  g13(.a(new_n54_), .b(x26), .c(new_n47_), .d(x15), .O(z07));
  ...
  nand2  g19(.a(new_n48_), .b(x17), .O(new_n66_));
  nor2   g20(.a(new_n48_), .b(x17), .O(new_n67_));
  nor2   g21(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  nand2  g22(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  oai21  g23(.a(new_n65_), .b(new_n62_), .c(new_n69_), .O(z09));
  inv1   g24(.a(x20), .O(new_n71_));
  nor2   g25(.a(x19), .b(x17), .O(new_n72_));
  xor2a  g26(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nor2   g27(.a(new_n61_), .b(x01), .O(new_n74_));
  oai21  g28(.a(x18), .b(x09), .c(new_n64_), .O(new_n75_));
  oai22  g29(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n51_), .O(z10));
  nand2  g30(.a(x18), .b(x02), .O(new_n77_));
  aoi21  g31(.a(new_n61_), .b(x10), .c(new_n63_), .O(new_n78_));
  nand2  g32(.a(new_n72_), .b(new_n71_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(x21), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  aoi21  g35(.a(new_n81_), .b(new_n72_), .c(new_n51_), .O(new_n82_));
  aoi22  g36(.a(new_n82_), .b(new_n80_), .c(new_n78_), .d(new_n77_), .O(z11));
  inv1   g37(.a(x22), .O(new_n84_));
  aoi21  g38(.a(new_n81_), .b(new_n72_), .c(new_n84_), .O(new_n85_));
  nand3  g39(.a(new_n81_), .b(new_n72_), .c(new_n84_), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  oai21  g41(.a(new_n87_), .b(new_n85_), .c(x16), .O(new_n88_));
  inv1   g42(.a(x11), .O(new_n89_));
  aoi21  g43(.a(new_n61_), .b(new_n89_), .c(new_n63_), .O(new_n90_));
  oai21  g44(.a(new_n61_), .b(x03), .c(new_n90_), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n88_), .O(z12));
  nand2  g46(.a(new_n86_), .b(x23), .O(new_n93_));
  nor2   g47(.a(x23), .b(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n81_), .c(new_n72_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x16), .O(new_n97_));
  inv1   g51(.a(x12), .O(new_n98_));
  aoi21  g52(.a(new_n61_), .b(new_n98_), .c(new_n63_), .O(new_n99_));
  oai21  g53(.a(new_n61_), .b(x04), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n97_), .O(z13));
  nand2  g55(.a(new_n95_), .b(x24), .O(new_n102_));
  nor2   g56(.a(x24), .b(x21), .O(new_n103_));
  nand4  g57(.a(new_n103_), .b(new_n94_), .c(new_n72_), .d(new_n71_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x16), .O(new_n106_));
  inv1   g60(.a(x13), .O(new_n107_));
  aoi21  g61(.a(new_n61_), .b(new_n107_), .c(new_n63_), .O(new_n108_));
  oai21  g62(.a(new_n61_), .b(x05), .c(new_n108_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n106_), .O(z14));
  nand2  g64(.a(x18), .b(x06), .O(new_n111_));
  nand2  g65(.a(new_n61_), .b(x14), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n111_), .c(new_n64_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n104_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n94_), .c(new_n81_), .d(new_n72_), .O(new_n117_));
  ...
  nand2  g76(.a(new_n61_), .b(new_n122_), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n121_), .c(new_n64_), .O(new_n124_));
  ...
  nand2  g84(.a(new_n116_), .b(new_n94_), .O(new_n131_));
  inv1   g85(.a(new_n131_), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n81_), .c(new_n67_), .d(new_n125_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n51_), .O(z17));
  buf    g88(.a(x27), .O(z08));
endmodule
