...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x15), .O(z08));
  ...
  nand4  g33(.a(new_n77_), .b(new_n76_), .c(new_n79_), .d(new_n64_), .O(new_n80_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n98_), .c(new_n69_), .d(new_n76_), .O(new_n110_));
  ...
  aoi22  g77(.a(new_n123_), .b(new_n81_), .c(new_n110_), .d(x25), .O(new_n124_));
  ...
  aoi21  g82(.a(new_n128_), .b(new_n126_), .c(new_n59_), .O(new_n129_));
  oai21  g83(.a(new_n124_), .b(new_n65_), .c(new_n129_), .O(z15));
  inv1   g84(.a(x26), .O(new_n131_));
  nand3  g85(.a(new_n123_), .b(new_n81_), .c(new_n131_), .O(new_n132_));
  nor2   g86(.a(x25), .b(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n98_), .c(new_n95_), .d(new_n69_), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(x26), .c(new_n65_), .O(new_n135_));
  nand2  g89(.a(x18), .b(x07), .O(new_n136_));
  nand2  g90(.a(new_n60_), .b(x15), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n136_), .c(new_n65_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n58_), .O(new_n139_));
  aoi21  g93(.a(new_n135_), .b(new_n132_), .c(new_n139_), .O(z16));
  nand3  g94(.a(new_n133_), .b(new_n98_), .c(new_n131_), .O(new_n141_));
  nand3  g95(.a(new_n95_), .b(x19), .c(new_n64_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n47_), .d(new_n64_), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(new_n58_), .O(z17));
endmodule
