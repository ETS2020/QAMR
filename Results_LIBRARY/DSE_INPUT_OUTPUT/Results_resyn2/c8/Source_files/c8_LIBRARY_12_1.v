...
module FAU ( 
  ...
  aoi21  g54(.a(new_n100_), .b(new_n98_), .c(new_n58_), .O(new_n101_));
  oai21  g55(.a(new_n96_), .b(new_n64_), .c(new_n101_), .O(z13));
  inv1   g56(.a(x23), .O(new_n103_));
  nand4  g57(.a(new_n79_), .b(new_n69_), .c(new_n103_), .d(new_n94_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n79_), .c(new_n69_), .d(new_n94_), .O(new_n107_));
  ...
  oai21  g78(.a(new_n119_), .b(new_n64_), .c(new_n124_), .O(z15));
  nand3  g79(.a(new_n118_), .b(new_n81_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n116_), .b(new_n106_), .c(new_n79_), .d(new_n69_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n64_), .O(new_n129_));
  ...
  nand4  g89(.a(new_n79_), .b(new_n127_), .c(x19), .d(new_n63_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n117_), .c(new_n49_), .d(new_n63_), .O(new_n137_));
