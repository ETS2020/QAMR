...
module FAU ( 
  ...
  aoi21  g57(.a(new_n62_), .b(new_n103_), .c(x16), .O(new_n104_));
  oai21  g58(.a(new_n62_), .b(x04), .c(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n59_), .O(z13));
  nand4  g60(.a(new_n83_), .b(new_n73_), .c(new_n100_), .d(new_n91_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n83_), .c(new_n73_), .d(new_n91_), .O(new_n110_));
  ...
  aoi21  g69(.a(new_n62_), .b(new_n115_), .c(x16), .O(new_n116_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n83_), .d(new_n73_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n62_), .b(x14), .O(new_n124_));
  ...
  nand3  g83(.a(new_n129_), .b(new_n85_), .c(x26), .O(new_n130_));
  aoi21  g84(.a(new_n121_), .b(new_n57_), .c(new_n68_), .O(new_n131_));
  ...
  oai21  g88(.a(new_n62_), .b(x07), .c(new_n134_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n59_), .O(z16));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n129_), .b(new_n83_), .c(new_n69_), .d(new_n57_), .O(new_n138_));
