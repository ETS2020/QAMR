...
module FAU ( 
  ...
  aoi21  g31(.a(new_n60_), .b(new_n69_), .c(new_n77_), .O(new_n78_));
  ...
  oai21  g45(.a(new_n87_), .b(new_n68_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x23), .O(new_n93_));
  inv1   g47(.a(x22), .O(new_n94_));
  nand3  g48(.a(new_n79_), .b(new_n60_), .c(new_n94_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n79_), .b(new_n60_), .c(new_n93_), .d(new_n94_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x24), .O(new_n103_));
  nor2   g57(.a(x24), .b(x23), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n104_), .c(new_n60_), .d(new_n69_), .O(new_n106_));
  ...
  nor2   g71(.a(new_n117_), .b(new_n80_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n68_), .O(new_n119_));
  ...
  nor3   g80(.a(new_n117_), .b(new_n80_), .c(new_n126_), .O(new_n127_));
