...
module FAU ( 
  ...
  nor2   g01(.a(x27), .b(x24), .O(new_n48_));
  ...
  oai21  g32(.a(new_n73_), .b(new_n66_), .c(new_n78_), .O(z10));
  nand2  g33(.a(new_n72_), .b(new_n71_), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  aoi22  g35(.a(new_n81_), .b(new_n72_), .c(new_n80_), .d(x21), .O(new_n82_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n66_), .c(new_n87_), .O(z11));
  ...
  nor2   g61(.a(new_n59_), .b(new_n66_), .O(new_n108_));
  inv1   g62(.a(new_n108_), .O(new_n109_));
  nor2   g63(.a(new_n59_), .b(x16), .O(new_n110_));
  ...
  nand3  g68(.a(new_n114_), .b(new_n112_), .c(new_n110_), .O(new_n115_));
  oai21  g69(.a(new_n109_), .b(new_n107_), .c(new_n115_), .O(z14));
  inv1   g70(.a(x14), .O(new_n117_));
  nand2  g71(.a(new_n60_), .b(new_n117_), .O(new_n118_));
  inv1   g72(.a(x06), .O(new_n119_));
  nand2  g73(.a(x18), .b(new_n119_), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n118_), .c(new_n110_), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n99_), .b(new_n81_), .c(new_n72_), .d(new_n58_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g78(.a(new_n123_), .b(new_n122_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n108_), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n124_), .c(new_n121_), .O(z15));
  oai21  g81(.a(new_n100_), .b(x25), .c(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n99_), .c(new_n81_), .d(new_n72_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g86(.a(x26), .b(x16), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(x27), .c(new_n58_), .O(new_n134_));
  ...
  aoi21  g92(.a(new_n138_), .b(new_n136_), .c(new_n134_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n132_), .O(z16));
  oai21  g94(.a(new_n47_), .b(x17), .c(z08), .O(new_n141_));
  nand4  g95(.a(new_n129_), .b(new_n99_), .c(new_n81_), .d(new_n67_), .O(new_n142_));
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n110_), .O(z17));
endmodule
