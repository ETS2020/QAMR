...
module FAU ( 
  ...
  nand2  g41(.a(new_n80_), .b(new_n66_), .O(new_n88_));
  ...
  nand3  g53(.a(new_n99_), .b(new_n80_), .c(new_n66_), .O(new_n100_));
  ...
  nand4  g62(.a(new_n99_), .b(new_n80_), .c(new_n66_), .d(new_n108_), .O(new_n109_));
  ...
  oai21  g67(.a(new_n62_), .b(x05), .c(new_n113_), .O(new_n114_));
  ...
  nor3   g80(.a(new_n117_), .b(new_n88_), .c(new_n126_), .O(new_n127_));
