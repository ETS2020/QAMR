...
module FAU ( 
  ...
  aoi21  g37(.a(new_n71_), .b(new_n70_), .c(new_n83_), .O(new_n84_));
  ...
  aoi21  g71(.a(new_n61_), .b(new_n117_), .c(x16), .O(new_n118_));
  aoi21  g72(.a(new_n118_), .b(new_n116_), .c(new_n60_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n114_), .O(z14));
  nand2  g74(.a(new_n112_), .b(x25), .O(new_n121_));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n100_), .c(new_n85_), .d(new_n71_), .O(new_n123_));
  and2   g77(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g78(.a(x18), .b(x06), .O(new_n125_));
  nand2  g79(.a(new_n61_), .b(x14), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n125_), .c(new_n66_), .O(new_n127_));
  ...
  nor2   g84(.a(new_n123_), .b(new_n130_), .O(new_n131_));
  nand2  g85(.a(new_n123_), .b(new_n130_), .O(new_n132_));
  ...
  aoi21  g90(.a(new_n61_), .b(new_n136_), .c(x16), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n135_), .c(new_n60_), .O(new_n138_));
  oai21  g92(.a(new_n133_), .b(new_n131_), .c(new_n138_), .O(z16));
  nand2  g93(.a(new_n122_), .b(new_n100_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n85_), .b(new_n130_), .c(x19), .d(new_n65_), .O(new_n142_));
  oai21  g96(.a(new_n142_), .b(new_n140_), .c(new_n141_), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(new_n79_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
