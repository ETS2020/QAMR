...
module FAU ( 
  ...
  nand2  g001(.a(x27), .b(x00), .O(new_n48_));
  ...
  nor2   g011(.a(new_n47_), .b(x00), .O(new_n58_));
  ...
  nand3  g025(.a(new_n71_), .b(new_n66_), .c(new_n61_), .O(new_n72_));
  inv1   g026(.a(new_n72_), .O(z09));
  ...
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n58_), .O(new_n81_));
  oai21  g035(.a(new_n76_), .b(new_n62_), .c(new_n81_), .O(z10));
  nand2  g036(.a(x18), .b(x02), .O(new_n83_));
  nand2  g037(.a(new_n64_), .b(x10), .O(new_n84_));
  nand3  g038(.a(new_n84_), .b(new_n83_), .c(new_n62_), .O(new_n85_));
  inv1   g039(.a(x21), .O(new_n86_));
  aoi21  g040(.a(new_n75_), .b(new_n74_), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g047(.a(new_n88_), .b(new_n75_), .c(new_n93_), .O(new_n94_));
  nand3  g048(.a(new_n88_), .b(new_n75_), .c(new_n93_), .O(new_n95_));
  inv1   g049(.a(new_n95_), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n94_), .c(x16), .O(new_n97_));
  inv1   g051(.a(x11), .O(new_n98_));
  aoi21  g052(.a(new_n64_), .b(new_n98_), .c(x16), .O(new_n99_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n88_), .c(new_n75_), .O(new_n104_));
  ...
  oai21  g062(.a(new_n64_), .b(x04), .c(new_n108_), .O(new_n109_));
  aoi21  g063(.a(new_n109_), .b(new_n106_), .c(new_n58_), .O(z13));
  nand2  g064(.a(new_n104_), .b(x24), .O(new_n111_));
  nor2   g065(.a(x24), .b(x23), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand4  g067(.a(new_n113_), .b(new_n112_), .c(new_n75_), .d(new_n74_), .O(new_n114_));
  ...
  oai21  g072(.a(new_n64_), .b(x05), .c(new_n118_), .O(new_n119_));
  aoi21  g073(.a(new_n119_), .b(new_n116_), .c(new_n58_), .O(z14));
  nand2  g074(.a(new_n114_), .b(x25), .O(new_n121_));
  nor2   g075(.a(x25), .b(x24), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n103_), .c(new_n88_), .d(new_n75_), .O(new_n123_));
  and2   g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g078(.a(x18), .b(x06), .O(new_n125_));
  nand2  g079(.a(new_n64_), .b(x14), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n62_), .O(new_n127_));
  ...
  nand2  g084(.a(new_n122_), .b(new_n103_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n130_), .c(x26), .O(new_n133_));
  aoi21  g087(.a(new_n123_), .b(new_n57_), .c(new_n62_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  inv1   g089(.a(x15), .O(new_n136_));
  aoi21  g090(.a(new_n64_), .b(new_n136_), .c(x16), .O(new_n137_));
  oai21  g091(.a(new_n64_), .b(x07), .c(new_n137_), .O(new_n138_));
  aoi21  g092(.a(new_n138_), .b(new_n135_), .c(new_n58_), .O(z16));
  nand2  g093(.a(x27), .b(x17), .O(new_n140_));
  nand4  g094(.a(new_n88_), .b(new_n57_), .c(x19), .d(new_n69_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n131_), .c(new_n140_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x00), .O(new_n143_));
  inv1   g097(.a(x25), .O(new_n144_));
  nand4  g098(.a(new_n47_), .b(new_n57_), .c(new_n144_), .d(new_n74_), .O(new_n145_));
  inv1   g099(.a(new_n145_), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n113_), .c(new_n112_), .d(new_n68_), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(new_n143_), .c(new_n62_), .O(z17));
endmodule
