...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n49_, new_n54_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  aoi22  g04(.a(new_n47_), .b(x21), .c(x27), .d(x10), .O(z02));
  aoi22  g05(.a(new_n47_), .b(x22), .c(x27), .d(x11), .O(z03));
  aoi22  g06(.a(new_n47_), .b(x23), .c(x27), .d(x12), .O(z04));
  inv1   g07(.a(new_n47_), .O(new_n54_));
  oai22  g08(.a(new_n54_), .b(x24), .c(new_n49_), .d(x13), .O(z05));
  oai22  g09(.a(new_n54_), .b(x25), .c(new_n49_), .d(x14), .O(z06));
  ...
  aoi21  g73(.a(new_n119_), .b(new_n116_), .c(new_n59_), .O(z15));
  ...
  inv1   g84(.a(new_n59_), .O(new_n131_));
  nand3  g85(.a(new_n77_), .b(x19), .c(new_n60_), .O(new_n132_));
  oai22  g86(.a(new_n132_), .b(new_n122_), .c(new_n49_), .d(new_n60_), .O(new_n133_));
