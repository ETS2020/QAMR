...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n50_, new_n56_, new_n60_, new_n61_, new_n62_,
  ...
  nand2  g09(.a(x27), .b(new_n47_), .O(new_n56_));
  ...
  nor2   g20(.a(x27), .b(x13), .O(new_n67_));
  ...
  nand3  g45(.a(new_n91_), .b(new_n65_), .c(new_n71_), .O(new_n92_));
  ...
  aoi21  g51(.a(new_n97_), .b(new_n94_), .c(new_n67_), .O(z12));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n67_), .O(z13));
  oai21  g59(.a(new_n92_), .b(x23), .c(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n91_), .c(new_n65_), .d(new_n71_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g63(.a(x18), .b(x05), .O(new_n110_));
  nand2  g64(.a(new_n60_), .b(x13), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n110_), .c(new_n70_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n68_), .O(new_n113_));
  aoi21  g67(.a(new_n109_), .b(new_n106_), .c(new_n113_), .O(z14));
  nand2  g68(.a(new_n108_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x22), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n107_), .c(new_n81_), .d(new_n65_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n60_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n70_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n68_), .O(new_n122_));
  ...
  nand3  g79(.a(new_n125_), .b(new_n83_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  aoi21  g81(.a(new_n117_), .b(new_n127_), .c(new_n70_), .O(new_n128_));
  ...
  nand4  g88(.a(new_n81_), .b(new_n127_), .c(x19), .d(new_n134_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n124_), .c(new_n50_), .d(new_n134_), .O(new_n136_));
