...
module FAU ( 
  ...
  nand4  g65(.a(new_n95_), .b(new_n77_), .c(new_n65_), .d(new_n105_), .O(new_n112_));
  ...
  oai21  g70(.a(x18), .b(x16), .c(new_n47_), .O(new_n117_));
  nand3  g71(.a(x18), .b(new_n94_), .c(x06), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi21  g73(.a(new_n117_), .b(x14), .c(new_n119_), .O(new_n120_));
  ...
  nand4  g77(.a(new_n113_), .b(new_n95_), .c(new_n77_), .d(new_n65_), .O(new_n124_));
