...
module FAU ( 
  ...
  oai21  g06(.a(x27), .b(x21), .c(x10), .O(z02));
  ...
  nor2   g19(.a(x27), .b(x10), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n59_), .b(new_n48_), .c(x16), .O(new_n84_));
  ...
  nand4  g56(.a(new_n78_), .b(new_n64_), .c(new_n94_), .d(new_n95_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n78_), .c(new_n64_), .d(new_n95_), .O(new_n106_));
  ...
  nand4  g80(.a(new_n115_), .b(new_n105_), .c(new_n78_), .d(new_n64_), .O(new_n127_));
