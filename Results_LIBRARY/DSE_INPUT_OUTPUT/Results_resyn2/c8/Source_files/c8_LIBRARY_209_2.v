...
module FAU ( 
  ...
  oai21  g48(.a(new_n89_), .b(new_n68_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x22), .O(new_n96_));
  nand3  g50(.a(new_n79_), .b(new_n61_), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n79_), .c(new_n61_), .O(new_n99_));
  ...
  oai21  g60(.a(new_n101_), .b(new_n68_), .c(new_n106_), .O(z13));
  ...
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n79_), .d(new_n61_), .O(new_n117_));
  ...
  oai21  g75(.a(x27), .b(new_n58_), .c(new_n121_), .O(new_n122_));
  ...
  aoi21  g81(.a(new_n117_), .b(new_n127_), .c(new_n68_), .O(new_n128_));
  ...
  nand4  g89(.a(new_n127_), .b(new_n135_), .c(new_n108_), .d(new_n77_), .O(new_n136_));
  inv1   g90(.a(new_n136_), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n98_), .c(new_n69_), .d(x19), .O(new_n138_));
