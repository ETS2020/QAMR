...
module FAU ( 
  ...
  aoi21  g10(.a(x27), .b(x14), .c(new_n49_), .O(z06));
  ...
  nand3  g42(.a(new_n79_), .b(new_n63_), .c(new_n87_), .O(new_n89_));
  ...
  oai21  g47(.a(new_n65_), .b(x03), .c(new_n93_), .O(new_n94_));
  ...
  nand4  g62(.a(new_n108_), .b(new_n97_), .c(new_n63_), .d(new_n70_), .O(new_n109_));
  ...
  nor2   g71(.a(new_n109_), .b(new_n48_), .O(new_n118_));
  nand2  g72(.a(new_n109_), .b(new_n48_), .O(new_n119_));
  ...
  oai21  g79(.a(new_n120_), .b(new_n118_), .c(new_n125_), .O(z15));
  inv1   g80(.a(x26), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x16), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n109_), .c(x27), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n48_), .O(new_n130_));
  inv1   g84(.a(x24), .O(new_n131_));
  nand3  g85(.a(x27), .b(new_n48_), .c(new_n131_), .O(new_n132_));
  and2   g86(.a(x26), .b(x16), .O(new_n133_));
  oai21  g87(.a(new_n132_), .b(new_n98_), .c(new_n133_), .O(new_n134_));
  inv1   g88(.a(x15), .O(new_n135_));
  aoi21  g89(.a(new_n65_), .b(new_n135_), .c(x16), .O(new_n136_));
  oai21  g90(.a(new_n65_), .b(x07), .c(new_n136_), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n134_), .c(new_n130_), .O(z16));
  nor2   g92(.a(x20), .b(new_n61_), .O(new_n139_));
  nor2   g93(.a(x26), .b(x25), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n139_), .c(new_n108_), .d(new_n97_), .O(new_n141_));
  nand2  g95(.a(x27), .b(x16), .O(new_n142_));
  aoi21  g96(.a(new_n141_), .b(new_n60_), .c(new_n142_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
