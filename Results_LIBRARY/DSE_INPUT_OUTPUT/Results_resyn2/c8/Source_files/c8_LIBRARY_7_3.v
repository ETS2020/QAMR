...
module FAU ( 
  ...
  nand2  g39(.a(new_n81_), .b(new_n70_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(x22), .O(new_n87_));
  nand3  g41(.a(new_n87_), .b(new_n85_), .c(new_n47_), .O(new_n88_));
  ...
  nand4  g48(.a(new_n84_), .b(new_n70_), .c(new_n94_), .d(new_n69_), .O(new_n95_));
  nand2  g49(.a(new_n85_), .b(x23), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n95_), .c(new_n47_), .O(new_n97_));
  ...
  nand4  g58(.a(new_n104_), .b(new_n84_), .c(new_n70_), .d(new_n69_), .O(new_n105_));
  ...
  nand4  g67(.a(new_n113_), .b(new_n104_), .c(new_n81_), .d(new_n70_), .O(new_n114_));
  ...
  or2    g74(.a(new_n114_), .b(x26), .O(new_n121_));
  aoi21  g75(.a(new_n114_), .b(x26), .c(new_n64_), .O(new_n122_));
  inv1   g76(.a(x15), .O(new_n123_));
  oai21  g77(.a(x18), .b(new_n123_), .c(new_n60_), .O(new_n124_));
  aoi21  g78(.a(x18), .b(x07), .c(new_n124_), .O(new_n125_));
  aoi21  g79(.a(new_n122_), .b(new_n121_), .c(new_n125_), .O(z16));
  inv1   g80(.a(x25), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n127_), .c(new_n69_), .O(new_n129_));
  nand2  g83(.a(new_n104_), .b(new_n84_), .O(new_n130_));
  nor4   g84(.a(new_n130_), .b(new_n129_), .c(new_n66_), .d(new_n64_), .O(z17));
  buf    g85(.a(x27), .O(z08));
endmodule
