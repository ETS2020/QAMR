...
module FAU ( 
  ...
  aoi22  g29(.a(new_n75_), .b(new_n63_), .c(new_n68_), .d(x21), .O(new_n76_));
  inv1   g30(.a(x10), .O(new_n77_));
  aoi21  g31(.a(new_n59_), .b(new_n77_), .c(x16), .O(new_n78_));
  oai21  g32(.a(new_n59_), .b(x02), .c(new_n78_), .O(new_n79_));
  oai21  g33(.a(new_n76_), .b(new_n62_), .c(new_n79_), .O(z11));
  inv1   g34(.a(x22), .O(new_n81_));
  aoi21  g35(.a(new_n75_), .b(new_n63_), .c(new_n81_), .O(new_n82_));
  nand3  g36(.a(new_n75_), .b(new_n63_), .c(new_n81_), .O(new_n83_));
  ...
  nand3  g46(.a(new_n92_), .b(new_n75_), .c(new_n63_), .O(new_n93_));
  ...
  nand4  g64(.a(new_n110_), .b(new_n92_), .c(new_n75_), .d(new_n63_), .O(new_n111_));
