...
module FAU ( 
  ...
  oai22  g12(.a(new_n49_), .b(x15), .c(x27), .d(x26), .O(z07));
  ...
  aoi21  g21(.a(new_n67_), .b(new_n63_), .c(new_n57_), .O(z09));
  ...
  nand3  g28(.a(new_n74_), .b(new_n71_), .c(new_n56_), .O(z10));
  inv1   g29(.a(x20), .O(new_n76_));
  nand2  g30(.a(new_n69_), .b(new_n76_), .O(new_n77_));
  nor2   g31(.a(x21), .b(x20), .O(new_n78_));
  aoi22  g32(.a(new_n78_), .b(new_n69_), .c(new_n77_), .d(x21), .O(new_n79_));
  inv1   g33(.a(x02), .O(new_n80_));
  nand2  g34(.a(x18), .b(new_n80_), .O(new_n81_));
  inv1   g35(.a(x10), .O(new_n82_));
  aoi21  g36(.a(new_n60_), .b(new_n82_), .c(x16), .O(new_n83_));
  aoi21  g37(.a(new_n83_), .b(new_n81_), .c(new_n57_), .O(new_n84_));
  oai21  g38(.a(new_n79_), .b(new_n65_), .c(new_n84_), .O(z11));
  inv1   g39(.a(x22), .O(new_n86_));
  aoi21  g40(.a(new_n78_), .b(new_n69_), .c(new_n86_), .O(new_n87_));
  nand3  g41(.a(new_n78_), .b(new_n69_), .c(new_n86_), .O(new_n88_));
  ...
  oai21  g46(.a(new_n60_), .b(x03), .c(new_n92_), .O(new_n93_));
  aoi21  g47(.a(new_n93_), .b(new_n90_), .c(new_n57_), .O(z12));
  nand2  g48(.a(new_n88_), .b(x23), .O(new_n95_));
  nor2   g49(.a(x23), .b(x22), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n78_), .c(new_n69_), .O(new_n97_));
  ...
  aoi21  g56(.a(new_n60_), .b(new_n102_), .c(x16), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n101_), .c(new_n57_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n99_), .O(z13));
  xor2a  g59(.a(new_n97_), .b(x24), .O(new_n106_));
  ...
  aoi21  g64(.a(new_n110_), .b(new_n108_), .c(new_n57_), .O(new_n111_));
  oai21  g65(.a(new_n106_), .b(new_n65_), .c(new_n111_), .O(z14));
  oai21  g66(.a(new_n97_), .b(x24), .c(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n96_), .c(new_n78_), .d(new_n69_), .O(new_n115_));
  and2   g69(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g70(.a(x18), .b(x06), .O(new_n117_));
  nand2  g71(.a(new_n60_), .b(x14), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n117_), .c(new_n65_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n56_), .O(new_n120_));
  aoi21  g74(.a(new_n116_), .b(new_n113_), .c(new_n120_), .O(z15));
  inv1   g75(.a(x26), .O(new_n122_));
  nor2   g76(.a(new_n115_), .b(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n115_), .b(new_n122_), .O(new_n124_));
  ...
  aoi21  g82(.a(new_n60_), .b(new_n128_), .c(x16), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n127_), .c(new_n57_), .O(new_n130_));
  oai21  g84(.a(new_n125_), .b(new_n123_), .c(new_n130_), .O(z16));
  nand2  g85(.a(new_n114_), .b(new_n96_), .O(new_n132_));
  nand2  g86(.a(x27), .b(x17), .O(new_n133_));
  nand4  g87(.a(new_n78_), .b(new_n122_), .c(x19), .d(new_n64_), .O(new_n134_));
  oai21  g88(.a(new_n134_), .b(new_n132_), .c(new_n133_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n56_), .O(z17));
endmodule
