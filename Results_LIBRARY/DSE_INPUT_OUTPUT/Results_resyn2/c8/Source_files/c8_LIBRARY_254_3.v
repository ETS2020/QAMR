...
module FAU ( 
  ...
  aoi21  g63(.a(new_n109_), .b(new_n107_), .c(new_n59_), .O(new_n110_));
  oai21  g64(.a(new_n105_), .b(new_n65_), .c(new_n110_), .O(z14));
  oai21  g65(.a(new_n98_), .b(x24), .c(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n97_), .c(new_n79_), .d(new_n69_), .O(new_n114_));
  and2   g68(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g69(.a(x18), .b(x06), .O(new_n116_));
  nand2  g70(.a(new_n60_), .b(x14), .O(new_n117_));
  nand3  g71(.a(new_n117_), .b(new_n116_), .c(new_n65_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n58_), .O(new_n119_));
  aoi21  g73(.a(new_n115_), .b(new_n112_), .c(new_n119_), .O(z15));
  nor2   g74(.a(new_n114_), .b(x26), .O(new_n121_));
  nand2  g75(.a(new_n114_), .b(x26), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g77(.a(x18), .b(x07), .O(new_n124_));
  nand2  g78(.a(new_n60_), .b(x15), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n124_), .c(new_n65_), .O(new_n126_));
  oai21  g80(.a(new_n123_), .b(new_n121_), .c(new_n126_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n58_), .O(z16));
  nand2  g82(.a(new_n113_), .b(new_n97_), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  nand4  g84(.a(new_n79_), .b(new_n130_), .c(x19), .d(new_n64_), .O(new_n131_));
  oai22  g85(.a(new_n131_), .b(new_n129_), .c(new_n47_), .d(new_n64_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n58_), .O(z17));
endmodule
