...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n56_, new_n60_, new_n61_,
  ...
  inv1   g09(.a(x27), .O(new_n56_));
  oai22  g10(.a(new_n50_), .b(x24), .c(new_n56_), .d(x13), .O(z05));
  oai22  g11(.a(new_n50_), .b(x25), .c(new_n56_), .d(x14), .O(z06));
  aoi22  g12(.a(new_n48_), .b(x26), .c(x27), .d(x15), .O(z07));
  nor2   g13(.a(x27), .b(x09), .O(new_n60_));
  ...
  inv1   g23(.a(new_n60_), .O(new_n70_));
  inv1   g24(.a(x20), .O(new_n71_));
  nor2   g25(.a(x19), .b(x17), .O(new_n72_));
  aoi21  g26(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(new_n73_));
  oai21  g27(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand2  g28(.a(x18), .b(x01), .O(new_n75_));
  nand2  g29(.a(new_n61_), .b(x09), .O(new_n76_));
  nand3  g30(.a(new_n76_), .b(new_n75_), .c(new_n66_), .O(new_n77_));
  nand3  g31(.a(new_n77_), .b(new_n74_), .c(new_n70_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(z10));
  inv1   g33(.a(x21), .O(new_n80_));
  aoi21  g34(.a(new_n72_), .b(new_n71_), .c(new_n80_), .O(new_n81_));
  nor2   g35(.a(x21), .b(x20), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n72_), .O(new_n83_));
  ...
  oai21  g41(.a(new_n61_), .b(x02), .c(new_n87_), .O(new_n88_));
  aoi21  g42(.a(new_n88_), .b(new_n85_), .c(new_n60_), .O(z11));
  ...
  nand3  g54(.a(new_n100_), .b(new_n82_), .c(new_n72_), .O(new_n101_));
  ...
  aoi21  g60(.a(new_n106_), .b(new_n103_), .c(new_n60_), .O(z13));
  nand2  g61(.a(new_n101_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x21), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n100_), .c(new_n72_), .d(new_n71_), .O(new_n110_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n100_), .c(new_n82_), .d(new_n72_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(x16), .O(new_n121_));
  inv1   g75(.a(x14), .O(new_n122_));
  aoi21  g76(.a(new_n61_), .b(new_n122_), .c(x16), .O(new_n123_));
  oai21  g77(.a(new_n61_), .b(x06), .c(new_n123_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n121_), .c(new_n60_), .O(z15));
  inv1   g79(.a(x26), .O(new_n126_));
  nand3  g80(.a(new_n118_), .b(new_n100_), .c(new_n126_), .O(new_n127_));
  nor2   g81(.a(new_n127_), .b(new_n83_), .O(new_n128_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n131_), .c(new_n60_), .O(new_n134_));
  oai21  g88(.a(new_n129_), .b(new_n66_), .c(new_n134_), .O(z16));
  nand3  g89(.a(new_n82_), .b(x19), .c(new_n65_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n127_), .c(new_n56_), .d(new_n65_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n70_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
