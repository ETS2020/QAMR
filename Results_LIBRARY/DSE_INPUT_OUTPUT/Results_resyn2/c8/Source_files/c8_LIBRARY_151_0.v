...
module FAU ( 
  ...
  oai22  g08(.a(z08), .b(x23), .c(new_n50_), .d(x12), .O(z04));
  ...
  nor2   g14(.a(new_n50_), .b(x16), .O(new_n61_));
  ...
  nor2   g19(.a(x19), .b(new_n65_), .O(new_n66_));
  inv1   g20(.a(x19), .O(new_n67_));
  oai21  g21(.a(new_n67_), .b(x17), .c(x16), .O(new_n68_));
  oai22  g22(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n60_), .O(z09));
  ...
  nand4  g31(.a(new_n76_), .b(new_n70_), .c(new_n67_), .d(new_n65_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(new_n79_));
  oai21  g33(.a(new_n79_), .b(new_n77_), .c(x16), .O(new_n80_));
  nor2   g34(.a(new_n59_), .b(x02), .O(new_n81_));
  oai21  g35(.a(x18), .b(x10), .c(new_n61_), .O(new_n82_));
  oai21  g36(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(z11));
  nand2  g37(.a(x18), .b(x03), .O(new_n84_));
  nand2  g38(.a(new_n59_), .b(x11), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(new_n84_), .c(new_n61_), .O(new_n86_));
  ...
  nand2  g55(.a(new_n59_), .b(new_n101_), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n100_), .c(new_n61_), .O(new_n103_));
  ...
  nand2  g66(.a(new_n59_), .b(new_n112_), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(new_n111_), .c(new_n61_), .O(new_n114_));
  ...
  nand2  g78(.a(new_n59_), .b(new_n124_), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n123_), .c(new_n61_), .O(new_n126_));
  oai21  g80(.a(new_n121_), .b(new_n47_), .c(new_n126_), .O(z15));
  ...
  aoi21  g85(.a(new_n131_), .b(x26), .c(new_n47_), .O(new_n132_));
  nand2  g86(.a(x18), .b(x07), .O(new_n133_));
  nand2  g87(.a(new_n59_), .b(x15), .O(new_n134_));
  nand3  g88(.a(new_n134_), .b(new_n133_), .c(new_n61_), .O(new_n135_));
  inv1   g89(.a(new_n135_), .O(new_n136_));
  aoi21  g90(.a(new_n132_), .b(new_n129_), .c(new_n136_), .O(z16));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  nor2   g92(.a(new_n67_), .b(x17), .O(new_n139_));
  nand4  g93(.a(new_n120_), .b(new_n90_), .c(new_n139_), .d(new_n128_), .O(new_n140_));
  aoi21  g94(.a(new_n140_), .b(new_n138_), .c(new_n47_), .O(z17));
endmodule
