...
module FAU ( 
  ...
  nand2  g11(.a(new_n47_), .b(x04), .O(new_n58_));
  ...
  nand4  g36(.a(new_n80_), .b(new_n79_), .c(new_n82_), .d(new_n64_), .O(new_n83_));
  ...
  nand3  g49(.a(new_n95_), .b(new_n69_), .c(new_n94_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x23), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n95_), .c(new_n69_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(x16), .O(new_n101_));
  oai21  g55(.a(new_n60_), .b(x16), .c(x27), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x04), .O(new_n103_));
  nand3  g57(.a(new_n60_), .b(new_n65_), .c(x12), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(z13));
  nand2  g59(.a(new_n99_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x21), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n98_), .c(new_n69_), .d(new_n79_), .O(new_n108_));
  ...
  inv1   g70(.a(new_n83_), .O(new_n117_));
  inv1   g71(.a(x23), .O(new_n118_));
  inv1   g72(.a(x24), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n94_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n117_), .c(new_n108_), .d(x25), .O(new_n123_));
  inv1   g77(.a(x06), .O(new_n124_));
  nand2  g78(.a(x18), .b(new_n124_), .O(new_n125_));
  inv1   g79(.a(x14), .O(new_n126_));
  aoi21  g80(.a(new_n60_), .b(new_n126_), .c(x16), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n125_), .c(new_n59_), .O(new_n128_));
  oai21  g82(.a(new_n123_), .b(new_n65_), .c(new_n128_), .O(z15));
  inv1   g83(.a(x26), .O(new_n130_));
  nor2   g84(.a(x25), .b(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n98_), .c(new_n95_), .d(new_n69_), .O(new_n132_));
  ...
  aoi21  g92(.a(new_n60_), .b(new_n138_), .c(x16), .O(new_n139_));
  aoi21  g93(.a(new_n139_), .b(new_n137_), .c(new_n59_), .O(new_n140_));
  oai21  g94(.a(new_n135_), .b(new_n133_), .c(new_n140_), .O(z16));
  nand2  g95(.a(x27), .b(x17), .O(new_n142_));
  nand4  g96(.a(new_n95_), .b(new_n130_), .c(x19), .d(new_n64_), .O(new_n143_));
  oai21  g97(.a(new_n143_), .b(new_n121_), .c(new_n142_), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g99(.a(new_n145_), .b(new_n58_), .O(z17));
endmodule
