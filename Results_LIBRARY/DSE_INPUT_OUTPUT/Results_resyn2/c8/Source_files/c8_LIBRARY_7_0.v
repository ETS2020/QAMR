...
module FAU ( 
  ...
  aoi21  g28(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(new_n75_));
  ...
  nand3  g64(.a(new_n110_), .b(new_n109_), .c(x27), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n48_), .O(new_n112_));
  ...
  aoi21  g74(.a(new_n59_), .b(new_n120_), .c(new_n61_), .O(new_n121_));
  oai21  g75(.a(new_n59_), .b(x06), .c(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n119_), .b(new_n48_), .c(new_n122_), .O(z15));
  ...
  aoi21  g81(.a(new_n127_), .b(x26), .c(new_n48_), .O(new_n128_));
  nand2  g82(.a(x18), .b(x07), .O(new_n129_));
  aoi21  g83(.a(new_n59_), .b(x15), .c(new_n61_), .O(new_n130_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n132_), .c(new_n48_), .O(z17));
endmodule
