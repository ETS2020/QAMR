...
module FAU ( 
  ...
  aoi21  g35(.a(new_n81_), .b(new_n67_), .c(new_n61_), .O(new_n82_));
  aoi21  g36(.a(new_n63_), .b(x10), .c(x16), .O(new_n83_));
  oai21  g37(.a(new_n63_), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  aoi21  g39(.a(new_n82_), .b(new_n80_), .c(new_n85_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n81_), .b(new_n67_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n81_), .b(new_n67_), .c(new_n87_), .O(new_n89_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n81_), .c(new_n67_), .O(new_n98_));
  ...
  aoi21  g62(.a(new_n63_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n63_), .b(x05), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n110_), .b(new_n107_), .c(new_n59_), .O(z14));
  oai21  g65(.a(new_n98_), .b(x24), .c(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n97_), .c(new_n81_), .d(new_n67_), .O(new_n114_));
  ...
  aoi21  g73(.a(new_n63_), .b(new_n119_), .c(x16), .O(new_n120_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n113_), .c(new_n81_), .d(new_n67_), .O(new_n125_));
  ...
  nand3  g90(.a(new_n81_), .b(x19), .c(new_n134_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n51_), .d(new_n134_), .O(new_n138_));
