...
module FAU ( 
  ...
  aoi21  g47(.a(new_n80_), .b(x22), .c(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n90_), .c(new_n67_), .O(z12));
  inv1   g49(.a(x23), .O(new_n96_));
  xor2a  g50(.a(new_n92_), .b(new_n96_), .O(new_n97_));
  ...
  aoi21  g55(.a(new_n101_), .b(new_n98_), .c(new_n69_), .O(z13));
  nand4  g56(.a(new_n91_), .b(new_n65_), .c(new_n96_), .d(new_n70_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n91_), .c(new_n72_), .O(new_n106_));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n110_), .c(new_n69_), .O(new_n113_));
  ...
  nor2   g72(.a(new_n118_), .b(new_n88_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n58_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n88_), .O(new_n122_));
  ...
  oai21  g80(.a(new_n117_), .b(new_n80_), .c(new_n126_), .O(new_n127_));
  ...
  nor2   g88(.a(x20), .b(new_n63_), .O(new_n135_));
  nor2   g89(.a(x26), .b(x25), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n105_), .d(new_n91_), .O(new_n137_));
  nor2   g91(.a(x17), .b(x14), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(x27), .c(x16), .O(new_n139_));
  aoi21  g93(.a(new_n137_), .b(new_n62_), .c(new_n139_), .O(z17));
endmodule
