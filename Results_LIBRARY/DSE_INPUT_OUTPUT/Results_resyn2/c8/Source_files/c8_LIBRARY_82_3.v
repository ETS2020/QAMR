...
module FAU ( 
  ...
  xor2a  g030(.a(new_n67_), .b(new_n76_), .O(new_n77_));
  nor2   g031(.a(new_n62_), .b(new_n70_), .O(new_n78_));
  inv1   g032(.a(new_n78_), .O(new_n79_));
  oai21  g033(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(z10));
  inv1   g034(.a(x02), .O(new_n81_));
  nand2  g035(.a(new_n58_), .b(x10), .O(new_n82_));
  oai21  g036(.a(new_n73_), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(new_n70_), .O(new_n84_));
  inv1   g038(.a(x21), .O(new_n85_));
  aoi21  g039(.a(new_n67_), .b(new_n76_), .c(new_n85_), .O(new_n86_));
  nand4  g040(.a(new_n85_), .b(new_n76_), .c(new_n65_), .d(new_n64_), .O(new_n87_));
  inv1   g041(.a(new_n87_), .O(new_n88_));
  nor2   g042(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  oai21  g043(.a(new_n89_), .b(new_n79_), .c(new_n84_), .O(z11));
  inv1   g044(.a(x03), .O(new_n91_));
  nand2  g045(.a(new_n58_), .b(x11), .O(new_n92_));
  oai21  g046(.a(new_n73_), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n70_), .O(new_n94_));
  xor2a  g048(.a(new_n87_), .b(x22), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n79_), .c(new_n94_), .O(z12));
  inv1   g050(.a(x04), .O(new_n97_));
  nand2  g051(.a(new_n58_), .b(x12), .O(new_n98_));
  oai21  g052(.a(new_n73_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n70_), .O(new_n100_));
  inv1   g054(.a(x22), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n67_), .c(new_n101_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x23), .O(new_n104_));
  nor2   g058(.a(x23), .b(x22), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n102_), .c(new_n67_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n100_), .O(z13));
  inv1   g063(.a(x05), .O(new_n110_));
  nand2  g064(.a(new_n58_), .b(x13), .O(new_n111_));
  oai21  g065(.a(new_n73_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n70_), .O(new_n113_));
  nand2  g067(.a(new_n106_), .b(x24), .O(new_n114_));
  nor2   g068(.a(x24), .b(x21), .O(new_n115_));
  nand4  g069(.a(new_n115_), .b(new_n105_), .c(new_n67_), .d(new_n76_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n78_), .O(new_n118_));
  ...
  nand4  g076(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n101_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  aoi22  g078(.a(new_n124_), .b(new_n88_), .c(new_n116_), .d(x25), .O(new_n125_));
  ...
  inv1   g085(.a(x07), .O(new_n132_));
  nand2  g086(.a(new_n58_), .b(x15), .O(new_n133_));
  oai21  g087(.a(new_n73_), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n70_), .O(new_n135_));
  inv1   g089(.a(x26), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n105_), .c(new_n102_), .d(new_n67_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g093(.a(new_n138_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n78_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(new_n135_), .O(z16));
  nand2  g096(.a(new_n48_), .b(x17), .O(new_n143_));
  nand3  g097(.a(new_n136_), .b(x19), .c(new_n64_), .O(new_n144_));
  inv1   g098(.a(new_n144_), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n102_), .d(new_n63_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n143_), .c(new_n70_), .O(z17));
