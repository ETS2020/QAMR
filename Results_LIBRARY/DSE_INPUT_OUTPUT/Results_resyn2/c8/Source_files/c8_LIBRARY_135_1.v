...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n48_, new_n52_, new_n53_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  oai22  g03(.a(new_n48_), .b(x10), .c(x27), .d(x21), .O(z02));
  oai22  g04(.a(new_n48_), .b(x11), .c(x27), .d(x22), .O(z03));
  ...
  aoi22  g10(.a(new_n53_), .b(x15), .c(new_n52_), .d(x26), .O(z07));
  ...
  nor2   g16(.a(new_n52_), .b(x08), .O(new_n63_));
  ...
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n70_), .O(new_n99_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n63_), .O(z13));
  ...
  aoi21  g65(.a(new_n111_), .b(new_n108_), .c(new_n63_), .O(z14));
  oai21  g66(.a(new_n99_), .b(x24), .c(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n98_), .c(new_n80_), .d(new_n70_), .O(new_n115_));
  ...
  aoi21  g74(.a(new_n60_), .b(new_n120_), .c(x16), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n63_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n117_), .O(z15));
  nand2  g77(.a(new_n115_), .b(x26), .O(new_n124_));
  nor3   g78(.a(x26), .b(x23), .c(x22), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n114_), .c(new_n80_), .d(new_n70_), .O(new_n126_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n130_), .c(new_n63_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n128_), .O(z16));
  inv1   g88(.a(x17), .O(new_n135_));
  inv1   g89(.a(x26), .O(new_n136_));
  nand3  g90(.a(new_n114_), .b(new_n98_), .c(new_n136_), .O(new_n137_));
  nand3  g91(.a(new_n80_), .b(x19), .c(new_n135_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n52_), .d(new_n135_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n64_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
