...
module FAU ( 
  ...
  aoi21  g75(.a(new_n62_), .b(new_n121_), .c(x16), .O(new_n122_));
  ...
  nand4  g80(.a(new_n126_), .b(new_n115_), .c(new_n79_), .d(new_n66_), .O(new_n127_));
  ...
  nand3  g91(.a(new_n115_), .b(new_n99_), .c(new_n137_), .O(new_n138_));
  nand3  g92(.a(new_n79_), .b(x19), .c(new_n136_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n47_), .d(new_n136_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n59_), .O(z17));
endmodule
