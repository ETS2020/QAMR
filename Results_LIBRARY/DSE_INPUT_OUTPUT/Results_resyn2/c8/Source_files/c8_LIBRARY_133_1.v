...
module FAU ( 
  ...
  oai21  g42(.a(new_n83_), .b(new_n65_), .c(new_n88_), .O(z11));
  inv1   g43(.a(x22), .O(new_n90_));
  aoi21  g44(.a(new_n80_), .b(new_n71_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n80_), .b(new_n71_), .c(new_n90_), .O(new_n92_));
  ...
  nand3  g54(.a(new_n100_), .b(new_n80_), .c(new_n71_), .O(new_n101_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n80_), .c(new_n71_), .d(new_n90_), .O(new_n110_));
  ...
  oai21  g68(.a(new_n59_), .b(x05), .c(new_n114_), .O(new_n115_));
  ...
  aoi22  g73(.a(new_n119_), .b(new_n82_), .c(new_n110_), .d(x25), .O(new_n120_));
  ...
  nand4  g82(.a(new_n117_), .b(new_n100_), .c(new_n80_), .d(new_n71_), .O(new_n129_));
  ...
  nand4  g90(.a(new_n119_), .b(new_n80_), .c(new_n66_), .d(new_n128_), .O(new_n137_));
  oai21  g91(.a(new_n47_), .b(x14), .c(x16), .O(new_n138_));
