...
module FAU ( 
  ...
  aoi21  g13(.a(new_n47_), .b(new_n59_), .c(new_n57_), .O(new_n60_));
  oai21  g14(.a(new_n47_), .b(x15), .c(new_n60_), .O(z07));
  ...
  nand2  g20(.a(new_n66_), .b(x17), .O(new_n67_));
  inv1   g21(.a(x16), .O(new_n68_));
  nor2   g22(.a(new_n66_), .b(x17), .O(new_n69_));
  nor2   g23(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g24(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  aoi21  g25(.a(new_n71_), .b(new_n65_), .c(new_n57_), .O(z09));
  ...
  aoi21  g30(.a(new_n62_), .b(new_n76_), .c(x16), .O(new_n77_));
  oai21  g31(.a(new_n62_), .b(x01), .c(new_n77_), .O(new_n78_));
  nand3  g32(.a(new_n78_), .b(new_n75_), .c(new_n56_), .O(z10));
  ...
  aoi21  g40(.a(new_n62_), .b(new_n86_), .c(x16), .O(new_n87_));
  ...
  aoi21  g49(.a(new_n62_), .b(new_n95_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n62_), .b(x03), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g58(.a(new_n62_), .b(new_n104_), .c(x16), .O(new_n105_));
  oai21  g59(.a(new_n62_), .b(x04), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n62_), .b(x05), .c(new_n114_), .O(new_n115_));
  aoi21  g69(.a(new_n115_), .b(new_n112_), .c(new_n57_), .O(z14));
  ...
  oai21  g75(.a(x18), .b(x16), .c(new_n47_), .O(new_n122_));
  nand3  g76(.a(x18), .b(new_n68_), .c(x06), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi21  g78(.a(new_n122_), .b(x14), .c(new_n124_), .O(new_n125_));
  oai21  g79(.a(new_n121_), .b(new_n68_), .c(new_n125_), .O(z15));
  nor3   g80(.a(new_n119_), .b(new_n117_), .c(new_n59_), .O(new_n127_));
  oai21  g81(.a(new_n120_), .b(x26), .c(x16), .O(new_n128_));
  ...
  inv1   g89(.a(new_n119_), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n82_), .c(new_n69_), .d(new_n59_), .O(new_n137_));
  nand2  g91(.a(new_n56_), .b(x16), .O(new_n138_));
