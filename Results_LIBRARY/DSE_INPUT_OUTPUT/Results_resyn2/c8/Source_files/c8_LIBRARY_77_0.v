...
module FAU ( 
  ...
  nand3  g45(.a(new_n85_), .b(new_n66_), .c(new_n90_), .O(new_n92_));
  ...
  nand3  g53(.a(new_n99_), .b(new_n85_), .c(new_n66_), .O(new_n100_));
  ...
  oai21  g61(.a(new_n102_), .b(new_n79_), .c(new_n107_), .O(z13));
  nand2  g62(.a(new_n100_), .b(x24), .O(new_n109_));
  nor2   g63(.a(x24), .b(x21), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n99_), .c(new_n66_), .d(new_n71_), .O(new_n111_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n99_), .c(new_n85_), .d(new_n66_), .O(new_n122_));
  ...
  aoi21  g81(.a(new_n127_), .b(new_n124_), .c(new_n68_), .O(z15));
  inv1   g82(.a(x23), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n90_), .c(new_n64_), .O(new_n130_));
  nand4  g84(.a(new_n121_), .b(new_n85_), .c(new_n63_), .d(x16), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n130_), .c(x27), .O(new_n132_));
  ...
  nor2   g91(.a(new_n48_), .b(new_n79_), .O(new_n138_));
  aoi22  g92(.a(new_n138_), .b(new_n122_), .c(new_n137_), .d(new_n135_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n133_), .O(z16));
  nand2  g94(.a(new_n110_), .b(new_n99_), .O(new_n141_));
  inv1   g95(.a(x25), .O(new_n142_));
  nand4  g96(.a(new_n48_), .b(new_n142_), .c(new_n71_), .d(x19), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n141_), .c(new_n47_), .d(new_n63_), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g99(.a(new_n145_), .b(new_n69_), .O(z17));
endmodule
