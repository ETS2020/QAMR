...
module FAU ( 
  ...
  oai22  g12(.a(new_n51_), .b(x26), .c(new_n50_), .d(x15), .O(z07));
  ...
  aoi21  g31(.a(new_n77_), .b(new_n74_), .c(new_n60_), .O(z10));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n60_), .O(new_n87_));
  ...
  aoi21  g51(.a(new_n97_), .b(new_n95_), .c(new_n60_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n93_), .O(z12));
  nand2  g53(.a(new_n91_), .b(x23), .O(new_n100_));
  ...
  aoi21  g61(.a(new_n107_), .b(new_n104_), .c(new_n60_), .O(z13));
  inv1   g62(.a(x24), .O(new_n109_));
  xor2a  g63(.a(new_n102_), .b(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x16), .O(new_n111_));
  inv1   g65(.a(x13), .O(new_n112_));
  aoi21  g66(.a(new_n64_), .b(new_n112_), .c(x16), .O(new_n113_));
  oai21  g67(.a(new_n64_), .b(x05), .c(new_n113_), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(new_n111_), .c(new_n60_), .O(z14));
  oai21  g69(.a(new_n102_), .b(x24), .c(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n101_), .c(new_n81_), .d(new_n68_), .O(new_n118_));
  ...
  aoi21  g76(.a(new_n64_), .b(new_n47_), .c(x16), .O(new_n123_));
  aoi21  g77(.a(new_n123_), .b(new_n122_), .c(new_n60_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n120_), .O(z15));
  nand2  g79(.a(new_n118_), .b(x26), .O(new_n126_));
  nor3   g80(.a(x26), .b(x23), .c(x22), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n117_), .c(new_n81_), .d(new_n68_), .O(new_n128_));
  ...
  inv1   g91(.a(x26), .O(new_n138_));
  nand3  g92(.a(new_n117_), .b(new_n101_), .c(new_n138_), .O(new_n139_));
  nand3  g93(.a(new_n81_), .b(x19), .c(new_n137_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n50_), .d(new_n137_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(new_n61_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
