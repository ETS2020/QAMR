...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n49_, new_n55_, new_n56_, new_n60_, new_n61_,
  ...
  nor2   g001(.a(x27), .b(x25), .O(new_n48_));
  ...
  oai22  g006(.a(new_n49_), .b(x22), .c(new_n47_), .d(x11), .O(z03));
  oai22  g007(.a(new_n49_), .b(x23), .c(new_n47_), .d(x12), .O(z04));
  nor2   g008(.a(x25), .b(x24), .O(new_n55_));
  nor2   g009(.a(new_n55_), .b(x27), .O(new_n56_));
  aoi21  g010(.a(x27), .b(x13), .c(new_n56_), .O(z05));
  nand2  g011(.a(x27), .b(x14), .O(z06));
  ...
  nand4  g076(.a(new_n101_), .b(new_n83_), .c(new_n73_), .d(new_n55_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  ...
  aoi21  g083(.a(new_n129_), .b(new_n127_), .c(new_n61_), .O(new_n130_));
  ...
  aoi21  g091(.a(new_n137_), .b(x27), .c(new_n60_), .O(new_n138_));
  ...
  nand4  g099(.a(new_n133_), .b(new_n101_), .c(new_n83_), .d(new_n69_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n145_), .c(new_n68_), .O(z17));
