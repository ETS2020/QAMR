...
module FAU ( 
  ...
  nor2   g34(.a(new_n71_), .b(new_n80_), .O(new_n81_));
  nand3  g35(.a(new_n65_), .b(new_n80_), .c(new_n69_), .O(new_n82_));
  ...
  nand3  g44(.a(new_n90_), .b(new_n65_), .c(new_n69_), .O(new_n91_));
  ...
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n73_), .O(z12));
  nand2  g51(.a(new_n91_), .b(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n71_), .c(new_n80_), .O(new_n100_));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n73_), .O(z13));
  ...
  aoi21  g67(.a(new_n113_), .b(new_n111_), .c(new_n73_), .O(new_n114_));
  oai21  g68(.a(new_n109_), .b(new_n107_), .c(new_n114_), .O(z14));
  inv1   g69(.a(new_n108_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n82_), .c(x25), .O(new_n117_));
  nand2  g71(.a(new_n65_), .b(new_n69_), .O(new_n118_));
  ...
  nand2  g83(.a(new_n119_), .b(new_n71_), .O(new_n130_));
