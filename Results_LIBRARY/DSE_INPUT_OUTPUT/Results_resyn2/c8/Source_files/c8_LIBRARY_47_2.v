...
module FAU ( 
  ...
  oai22  g37(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n59_), .O(z12));
  inv1   g38(.a(x23), .O(new_n85_));
  nand4  g39(.a(new_n72_), .b(new_n66_), .c(new_n85_), .d(new_n77_), .O(new_n86_));
  nand2  g40(.a(new_n79_), .b(x23), .O(new_n87_));
  nand3  g41(.a(new_n87_), .b(new_n86_), .c(x27), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(x16), .O(new_n89_));
  nor2   g43(.a(new_n60_), .b(x04), .O(new_n90_));
  oai21  g44(.a(x18), .b(x12), .c(new_n62_), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(z13));
  nor2   g46(.a(x24), .b(x23), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n72_), .c(new_n66_), .d(new_n77_), .O(new_n94_));
  ...
  nand2  g54(.a(new_n94_), .b(x25), .O(new_n101_));
  nor3   g55(.a(x25), .b(x24), .c(x23), .O(new_n102_));
  nand4  g56(.a(new_n102_), .b(new_n72_), .c(new_n66_), .d(new_n77_), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n101_), .c(x27), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x16), .O(new_n105_));
  inv1   g59(.a(x14), .O(new_n106_));
  aoi21  g60(.a(new_n60_), .b(new_n106_), .c(x16), .O(new_n107_));
  oai21  g61(.a(new_n60_), .b(x06), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n105_), .O(z15));
  inv1   g63(.a(x25), .O(new_n110_));
  inv1   g64(.a(x26), .O(new_n111_));
  nand3  g65(.a(new_n93_), .b(new_n111_), .c(new_n110_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n79_), .c(x27), .O(new_n113_));
  aoi21  g67(.a(new_n103_), .b(x26), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g71(.a(new_n114_), .b(new_n62_), .c(new_n117_), .O(z16));
  inv1   g72(.a(x17), .O(new_n119_));
  inv1   g73(.a(new_n112_), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n72_), .c(new_n77_), .d(x19), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n59_), .O(z17));
endmodule
