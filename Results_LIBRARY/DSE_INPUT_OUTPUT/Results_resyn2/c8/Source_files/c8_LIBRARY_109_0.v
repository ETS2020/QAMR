...
module FAU ( 
  ...
  oai21  g39(.a(new_n85_), .b(new_n47_), .c(new_n48_), .O(new_n86_));
  oai21  g40(.a(new_n82_), .b(new_n48_), .c(new_n86_), .O(z12));
  ...
  oai21  g77(.a(new_n118_), .b(new_n48_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand3  g79(.a(new_n117_), .b(new_n77_), .c(new_n125_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n92_), .c(new_n89_), .d(new_n68_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(x26), .c(new_n48_), .O(new_n129_));
  nand2  g83(.a(x18), .b(x07), .O(new_n130_));
  nand2  g84(.a(new_n59_), .b(x15), .O(new_n131_));
  nand3  g85(.a(new_n131_), .b(new_n130_), .c(new_n61_), .O(new_n132_));
  inv1   g86(.a(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n129_), .b(new_n126_), .c(new_n133_), .O(z16));
  nand2  g88(.a(new_n47_), .b(new_n48_), .O(new_n135_));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n89_), .b(new_n125_), .c(x19), .d(new_n63_), .O(new_n137_));
