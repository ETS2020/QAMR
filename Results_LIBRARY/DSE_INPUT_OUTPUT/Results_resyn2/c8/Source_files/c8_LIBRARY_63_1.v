...
module FAU ( 
  ...
  nor2   g18(.a(new_n49_), .b(x09), .O(new_n65_));
  ...
  nand2  g31(.a(new_n58_), .b(x10), .O(new_n78_));
  nand3  g32(.a(new_n78_), .b(new_n77_), .c(new_n68_), .O(new_n79_));
  inv1   g33(.a(x21), .O(new_n80_));
  aoi21  g34(.a(new_n63_), .b(new_n69_), .c(new_n80_), .O(new_n81_));
  nor2   g35(.a(x21), .b(x20), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(x16), .O(new_n84_));
  oai21  g38(.a(new_n84_), .b(new_n81_), .c(new_n79_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n66_), .O(z11));
  ...
  nand3  g48(.a(new_n82_), .b(new_n63_), .c(new_n94_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(x23), .O(new_n96_));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n82_), .c(new_n63_), .O(new_n98_));
  ...
  nand4  g60(.a(new_n106_), .b(new_n97_), .c(new_n63_), .d(new_n69_), .O(new_n107_));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n109_), .c(new_n65_), .O(z14));
  nand2  g67(.a(new_n107_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n97_), .c(new_n82_), .d(new_n63_), .O(new_n116_));
  and2   g70(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g71(.a(x18), .b(x06), .O(new_n118_));
  nand2  g72(.a(new_n58_), .b(x14), .O(new_n119_));
  nand3  g73(.a(new_n119_), .b(new_n118_), .c(new_n68_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n66_), .O(new_n121_));
  ...
  aoi21  g89(.a(new_n49_), .b(x17), .c(new_n68_), .O(new_n136_));
