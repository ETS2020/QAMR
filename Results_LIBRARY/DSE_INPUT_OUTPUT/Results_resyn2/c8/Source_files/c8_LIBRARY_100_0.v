...
module FAU ( 
  ...
  oai21  g03(.a(x27), .b(x20), .c(x09), .O(z01));
  ...
  nor2   g12(.a(x27), .b(x09), .O(new_n59_));
  ...
  aoi21  g27(.a(new_n63_), .b(new_n47_), .c(x16), .O(new_n74_));
  aoi21  g28(.a(new_n74_), .b(new_n73_), .c(new_n59_), .O(new_n75_));
  nand2  g29(.a(new_n75_), .b(new_n71_), .O(z10));
  inv1   g30(.a(x21), .O(new_n77_));
  nor2   g31(.a(x21), .b(x20), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n61_), .O(new_n79_));
  oai21  g33(.a(new_n70_), .b(new_n77_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g40(.a(new_n78_), .b(new_n61_), .c(new_n86_), .O(new_n87_));
  nor2   g41(.a(x22), .b(x21), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n61_), .c(new_n68_), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(new_n90_));
  oai21  g44(.a(new_n90_), .b(new_n87_), .c(x16), .O(new_n91_));
  ...
  nand3  g57(.a(new_n88_), .b(new_n70_), .c(new_n96_), .O(new_n104_));
  nand2  g58(.a(new_n61_), .b(new_n68_), .O(new_n105_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n103_), .c(new_n114_), .O(z14));
  oai21  g69(.a(new_n107_), .b(new_n105_), .c(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x22), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n78_), .d(new_n61_), .O(new_n118_));
  ...
  inv1   g80(.a(new_n79_), .O(new_n127_));
  nand2  g81(.a(new_n117_), .b(new_n106_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n127_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  aoi21  g85(.a(new_n118_), .b(new_n131_), .c(new_n103_), .O(new_n132_));
