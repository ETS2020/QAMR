...
module FAU ( 
  ...
  aoi21  g56(.a(new_n102_), .b(new_n99_), .c(new_n76_), .O(z13));
  nand4  g57(.a(new_n80_), .b(new_n65_), .c(new_n97_), .d(new_n88_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n80_), .c(new_n65_), .d(new_n88_), .O(new_n107_));
  ...
  aoi21  g67(.a(new_n113_), .b(new_n111_), .c(new_n76_), .O(new_n114_));
  ...
  nand3  g74(.a(x18), .b(new_n59_), .c(x06), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi21  g76(.a(new_n120_), .b(x14), .c(new_n122_), .O(new_n123_));
  oai21  g77(.a(new_n119_), .b(new_n59_), .c(new_n123_), .O(z15));
  nand3  g78(.a(new_n118_), .b(new_n82_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  nand4  g80(.a(new_n116_), .b(new_n106_), .c(new_n80_), .d(new_n65_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n59_), .O(new_n128_));
  ...
  oai21  g85(.a(new_n61_), .b(x07), .c(new_n131_), .O(new_n132_));
  aoi21  g86(.a(new_n132_), .b(new_n129_), .c(new_n76_), .O(z16));
