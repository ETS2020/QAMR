...
module FAU ( 
  ...
  oai21  g75(.a(new_n63_), .b(x16), .c(x27), .O(new_n122_));
  nand3  g76(.a(new_n63_), .b(new_n88_), .c(x14), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi21  g78(.a(new_n122_), .b(x06), .c(new_n124_), .O(new_n125_));
  ...
  nor2   g95(.a(x17), .b(x06), .O(new_n142_));
