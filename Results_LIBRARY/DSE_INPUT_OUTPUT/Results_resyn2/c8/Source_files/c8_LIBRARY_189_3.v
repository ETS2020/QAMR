...
module FAU ( 
  ...
  nand2  g79(.a(new_n125_), .b(new_n56_), .O(new_n126_));
  ...
  aoi21  g84(.a(new_n121_), .b(new_n59_), .c(new_n68_), .O(new_n131_));
  ...
  nand4  g91(.a(new_n129_), .b(new_n83_), .c(new_n69_), .d(new_n59_), .O(new_n138_));
