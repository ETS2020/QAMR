...
module FAU ( 
  ...
  aoi21  g06(.a(new_n49_), .b(x22), .c(x11), .O(z03));
  ...
  nand2  g11(.a(new_n49_), .b(x11), .O(new_n58_));
  ...
  nand2  g47(.a(new_n93_), .b(new_n58_), .O(new_n94_));
  ...
  oai22  g90(.a(new_n136_), .b(new_n126_), .c(new_n49_), .d(new_n64_), .O(new_n137_));
