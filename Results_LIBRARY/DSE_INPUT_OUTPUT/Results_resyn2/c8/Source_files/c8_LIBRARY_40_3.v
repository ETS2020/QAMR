...
module FAU ( 
  ...
  inv1   g09(.a(z08), .O(new_n56_));
  oai22  g10(.a(new_n56_), .b(x13), .c(x27), .d(x24), .O(z05));
  oai22  g11(.a(new_n56_), .b(x14), .c(x27), .d(x25), .O(z06));
  ...
  aoi21  g21(.a(new_n67_), .b(new_n63_), .c(new_n51_), .O(z09));
  ...
  aoi21  g26(.a(new_n72_), .b(new_n71_), .c(new_n51_), .O(z10));
  ...
  aoi21  g37(.a(new_n83_), .b(new_n80_), .c(new_n51_), .O(z11));
  inv1   g38(.a(x22), .O(new_n85_));
  aoi21  g39(.a(new_n77_), .b(new_n69_), .c(new_n85_), .O(new_n86_));
  nand3  g40(.a(new_n77_), .b(new_n69_), .c(new_n85_), .O(new_n87_));
  ...
  aoi21  g46(.a(new_n92_), .b(new_n89_), .c(new_n51_), .O(z12));
  nand2  g47(.a(new_n87_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n77_), .c(new_n69_), .O(new_n96_));
  ...
  oai21  g54(.a(new_n64_), .b(x04), .c(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n101_), .b(new_n98_), .c(new_n51_), .O(z13));
  nand2  g56(.a(new_n96_), .b(x24), .O(new_n103_));
  nor2   g57(.a(x24), .b(x21), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n95_), .c(new_n69_), .d(new_n74_), .O(new_n105_));
  ...
  oai21  g63(.a(new_n64_), .b(x05), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n110_), .b(new_n107_), .c(new_n51_), .O(z14));
  nand2  g65(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x24), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n95_), .c(new_n77_), .d(new_n69_), .O(new_n114_));
  ...
  oai21  g72(.a(new_n64_), .b(x06), .c(new_n118_), .O(new_n119_));
  aoi21  g73(.a(new_n119_), .b(new_n116_), .c(new_n51_), .O(z15));
  inv1   g74(.a(x26), .O(new_n121_));
  nand3  g75(.a(new_n113_), .b(new_n95_), .c(new_n121_), .O(new_n122_));
  nor2   g76(.a(new_n122_), .b(new_n78_), .O(new_n123_));
  aoi21  g77(.a(new_n114_), .b(x26), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g82(.a(new_n128_), .b(new_n126_), .c(new_n51_), .O(new_n129_));
  oai21  g83(.a(new_n124_), .b(new_n61_), .c(new_n129_), .O(z16));
  inv1   g84(.a(new_n51_), .O(new_n131_));
  nand3  g85(.a(new_n77_), .b(x19), .c(new_n60_), .O(new_n132_));
  oai22  g86(.a(new_n132_), .b(new_n122_), .c(new_n47_), .d(new_n60_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n131_), .O(z17));
endmodule
