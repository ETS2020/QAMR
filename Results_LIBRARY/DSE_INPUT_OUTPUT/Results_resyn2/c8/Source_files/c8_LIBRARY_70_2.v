...
module FAU ( 
  ...
  aoi21  g21(.a(new_n67_), .b(new_n63_), .c(new_n55_), .O(z09));
  ...
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n55_), .O(new_n76_));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n83_), .c(new_n55_), .O(z11));
  ...
  aoi21  g46(.a(new_n92_), .b(new_n90_), .c(new_n55_), .O(new_n93_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n80_), .c(new_n70_), .O(new_n98_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n102_), .c(new_n55_), .O(new_n105_));
  oai21  g59(.a(new_n100_), .b(new_n65_), .c(new_n105_), .O(z13));
  nand4  g60(.a(new_n97_), .b(new_n80_), .c(new_n70_), .d(x24), .O(new_n107_));
  inv1   g61(.a(x24), .O(new_n108_));
  nand2  g62(.a(new_n98_), .b(new_n108_), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n107_), .c(x16), .O(new_n110_));
  ...
  aoi21  g67(.a(new_n113_), .b(new_n110_), .c(new_n55_), .O(z14));
  nand4  g68(.a(new_n80_), .b(new_n70_), .c(new_n108_), .d(new_n95_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n97_), .c(new_n80_), .d(new_n70_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g74(.a(x25), .b(x16), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(x27), .c(new_n54_), .O(new_n122_));
  inv1   g76(.a(x06), .O(new_n123_));
  nand2  g77(.a(x18), .b(new_n123_), .O(new_n124_));
  inv1   g78(.a(x14), .O(new_n125_));
  aoi21  g79(.a(new_n60_), .b(new_n125_), .c(x16), .O(new_n126_));
  ...
  and2   g83(.a(new_n118_), .b(new_n129_), .O(new_n130_));
  nand2  g84(.a(new_n117_), .b(x26), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n96_), .c(x16), .O(new_n132_));
  nand2  g86(.a(x26), .b(x16), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(x27), .c(new_n54_), .O(new_n134_));
  ...
  oai21  g93(.a(new_n132_), .b(new_n130_), .c(new_n139_), .O(z16));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  nand3  g95(.a(new_n129_), .b(x19), .c(new_n64_), .O(new_n142_));
  inv1   g96(.a(new_n142_), .O(new_n143_));
  nand4  g97(.a(new_n143_), .b(new_n117_), .c(new_n97_), .d(new_n80_), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n141_), .c(new_n65_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
