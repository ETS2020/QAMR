...
module FAU ( 
  ...
  aoi21  g33(.a(new_n61_), .b(x11), .c(x16), .O(new_n80_));
  inv1   g34(.a(x22), .O(new_n81_));
  nand3  g35(.a(new_n74_), .b(new_n67_), .c(new_n81_), .O(new_n82_));
  nand2  g36(.a(new_n74_), .b(new_n67_), .O(new_n83_));
  aoi21  g37(.a(new_n83_), .b(x22), .c(new_n69_), .O(new_n84_));
  aoi22  g38(.a(new_n84_), .b(new_n82_), .c(new_n80_), .d(new_n79_), .O(z12));
  nor2   g39(.a(x23), .b(x22), .O(new_n86_));
  nand3  g40(.a(new_n86_), .b(new_n74_), .c(new_n67_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(x27), .O(new_n88_));
  ...
  oai21  g45(.a(new_n61_), .b(x04), .c(new_n91_), .O(new_n92_));
  oai21  g46(.a(new_n89_), .b(new_n63_), .c(new_n92_), .O(z13));
  nor2   g47(.a(x24), .b(x21), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n86_), .c(new_n67_), .d(new_n66_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(x27), .O(new_n96_));
  aoi21  g50(.a(new_n87_), .b(x24), .c(new_n96_), .O(new_n97_));
  inv1   g51(.a(x13), .O(new_n98_));
  aoi21  g52(.a(new_n61_), .b(new_n98_), .c(x16), .O(new_n99_));
  oai21  g53(.a(new_n61_), .b(x05), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n97_), .b(new_n63_), .c(new_n100_), .O(z14));
  nor2   g55(.a(x25), .b(x24), .O(new_n102_));
  nand4  g56(.a(new_n102_), .b(new_n86_), .c(new_n74_), .d(new_n67_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x27), .O(new_n104_));
  aoi21  g58(.a(new_n95_), .b(x25), .c(new_n104_), .O(new_n105_));
  inv1   g59(.a(x14), .O(new_n106_));
  aoi21  g60(.a(new_n61_), .b(new_n106_), .c(x16), .O(new_n107_));
  oai21  g61(.a(new_n61_), .b(x06), .c(new_n107_), .O(new_n108_));
  oai21  g62(.a(new_n105_), .b(new_n63_), .c(new_n108_), .O(z15));
  inv1   g63(.a(new_n82_), .O(new_n110_));
  nor2   g64(.a(x26), .b(x23), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n102_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n110_), .c(new_n103_), .d(x26), .O(new_n114_));
  inv1   g68(.a(x15), .O(new_n115_));
  aoi21  g69(.a(new_n61_), .b(new_n115_), .c(x16), .O(new_n116_));
  oai21  g70(.a(new_n61_), .b(x07), .c(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n114_), .b(new_n69_), .c(new_n117_), .O(z16));
  inv1   g72(.a(x17), .O(new_n119_));
  nand4  g73(.a(new_n113_), .b(new_n74_), .c(new_n81_), .d(x19), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n119_), .c(new_n69_), .O(z17));
  buf    g75(.a(x27), .O(z08));
endmodule
