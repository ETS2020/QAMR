...
module FAU ( 
  ...
  nor2   g01(.a(x27), .b(x01), .O(new_n48_));
  ...
  xor2a  g21(.a(new_n60_), .b(x20), .O(new_n68_));
  nand2  g22(.a(new_n68_), .b(x16), .O(new_n69_));
  inv1   g23(.a(x09), .O(new_n70_));
  aoi21  g24(.a(new_n63_), .b(new_n70_), .c(x16), .O(new_n71_));
  oai21  g25(.a(new_n63_), .b(x01), .c(new_n71_), .O(new_n72_));
  aoi21  g26(.a(new_n72_), .b(new_n69_), .c(new_n59_), .O(z10));
  inv1   g27(.a(x20), .O(new_n74_));
  inv1   g28(.a(x21), .O(new_n75_));
  aoi21  g29(.a(new_n60_), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  nor2   g30(.a(x21), .b(x20), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(new_n60_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(new_n79_));
  oai21  g33(.a(new_n79_), .b(new_n76_), .c(x16), .O(new_n80_));
  inv1   g34(.a(x10), .O(new_n81_));
  aoi21  g35(.a(new_n63_), .b(new_n81_), .c(x16), .O(new_n82_));
  oai21  g36(.a(new_n63_), .b(x02), .c(new_n82_), .O(new_n83_));
  ...
  aoi21  g43(.a(new_n63_), .b(new_n89_), .c(x16), .O(new_n90_));
  aoi21  g44(.a(new_n90_), .b(new_n88_), .c(new_n59_), .O(new_n91_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x22), .O(new_n93_));
  nand3  g47(.a(new_n77_), .b(new_n60_), .c(new_n93_), .O(new_n94_));
  ...
  aoi21  g52(.a(new_n63_), .b(new_n98_), .c(x16), .O(new_n99_));
  aoi21  g53(.a(new_n99_), .b(new_n97_), .c(new_n59_), .O(new_n100_));
  oai21  g54(.a(new_n95_), .b(new_n85_), .c(new_n100_), .O(z13));
  inv1   g55(.a(x23), .O(new_n102_));
  nand4  g56(.a(new_n77_), .b(new_n60_), .c(new_n102_), .d(new_n93_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n77_), .c(new_n60_), .d(new_n93_), .O(new_n106_));
  ...
  oai21  g77(.a(new_n118_), .b(new_n85_), .c(new_n123_), .O(z15));
  nand3  g78(.a(new_n117_), .b(new_n79_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  nand4  g80(.a(new_n115_), .b(new_n105_), .c(new_n77_), .d(new_n60_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n126_), .c(new_n85_), .O(new_n128_));
  ...
  inv1   g87(.a(new_n59_), .O(new_n134_));
  inv1   g88(.a(x17), .O(new_n135_));
  nand4  g89(.a(new_n77_), .b(new_n126_), .c(x19), .d(new_n135_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n116_), .c(new_n47_), .d(new_n135_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n134_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
