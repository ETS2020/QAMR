...
module FAU ( 
  ...
  aoi21  g41(.a(new_n87_), .b(new_n84_), .c(new_n69_), .O(z11));
  ...
  nand3  g47(.a(new_n93_), .b(new_n67_), .c(new_n72_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(x16), .O(new_n95_));
  aoi21  g49(.a(new_n82_), .b(x22), .c(new_n95_), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(new_n92_), .c(new_n70_), .O(z12));
  inv1   g51(.a(x23), .O(new_n98_));
  xor2a  g52(.a(new_n94_), .b(new_n98_), .O(new_n99_));
  ...
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n69_), .O(z13));
  nand4  g58(.a(new_n93_), .b(new_n67_), .c(new_n98_), .d(new_n72_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n93_), .c(new_n74_), .O(new_n108_));
  ...
  aoi21  g68(.a(new_n114_), .b(new_n112_), .c(new_n69_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n110_), .O(z14));
  nand2  g70(.a(new_n108_), .b(x25), .O(new_n117_));
  nor2   g71(.a(x25), .b(x22), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n107_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n82_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(new_n90_), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  nand2  g76(.a(new_n60_), .b(x14), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n122_), .c(new_n90_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n70_), .O(new_n125_));
  aoi21  g79(.a(new_n121_), .b(new_n117_), .c(new_n125_), .O(z15));
  nand2  g80(.a(new_n120_), .b(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  oai21  g82(.a(new_n119_), .b(new_n82_), .c(new_n128_), .O(new_n129_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n69_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n130_), .O(z16));
  nor2   g90(.a(x20), .b(new_n65_), .O(new_n137_));
  nor2   g91(.a(x26), .b(x25), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n93_), .O(new_n139_));
