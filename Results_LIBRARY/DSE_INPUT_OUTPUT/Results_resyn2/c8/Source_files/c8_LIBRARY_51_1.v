...
module FAU ( 
  ...
  nand2  g01(.a(x27), .b(x00), .O(new_n48_));
  ...
  nor2   g15(.a(new_n47_), .b(x00), .O(new_n62_));
  inv1   g16(.a(new_n62_), .O(new_n63_));
  inv1   g17(.a(x19), .O(new_n64_));
  nor2   g18(.a(new_n64_), .b(x17), .O(new_n65_));
  inv1   g19(.a(x17), .O(new_n66_));
  nor2   g20(.a(x19), .b(new_n66_), .O(new_n67_));
  oai21  g21(.a(new_n67_), .b(new_n65_), .c(x16), .O(new_n68_));
  nand3  g22(.a(new_n68_), .b(new_n63_), .c(new_n61_), .O(new_n69_));
  ...
  aoi21  g32(.a(new_n78_), .b(new_n76_), .c(new_n62_), .O(new_n79_));
  oai21  g33(.a(new_n74_), .b(new_n71_), .c(new_n79_), .O(z10));
  ...
  oai21  g42(.a(new_n83_), .b(new_n71_), .c(new_n88_), .O(z11));
  ...
  oai21  g59(.a(new_n59_), .b(x04), .c(new_n105_), .O(new_n106_));
  aoi21  g60(.a(new_n106_), .b(new_n103_), .c(new_n62_), .O(z13));
  xor2a  g61(.a(new_n101_), .b(x24), .O(new_n108_));
  inv1   g62(.a(x05), .O(new_n109_));
  nand2  g63(.a(x18), .b(new_n109_), .O(new_n110_));
  inv1   g64(.a(x13), .O(new_n111_));
  aoi21  g65(.a(new_n59_), .b(new_n111_), .c(x16), .O(new_n112_));
  aoi21  g66(.a(new_n112_), .b(new_n110_), .c(new_n62_), .O(new_n113_));
  oai21  g67(.a(new_n108_), .b(new_n71_), .c(new_n113_), .O(z14));
  inv1   g68(.a(x24), .O(new_n115_));
  nand4  g69(.a(new_n100_), .b(new_n82_), .c(new_n73_), .d(new_n115_), .O(new_n116_));
  ...
  aoi21  g74(.a(new_n116_), .b(x25), .c(new_n120_), .O(new_n121_));
  inv1   g75(.a(x06), .O(new_n122_));
  nand2  g76(.a(x18), .b(new_n122_), .O(new_n123_));
  inv1   g77(.a(x14), .O(new_n124_));
  aoi21  g78(.a(new_n59_), .b(new_n124_), .c(x16), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n123_), .c(new_n62_), .O(new_n126_));
  oai21  g80(.a(new_n121_), .b(new_n71_), .c(new_n126_), .O(z15));
  inv1   g81(.a(x26), .O(new_n128_));
  nor3   g82(.a(new_n119_), .b(new_n117_), .c(new_n128_), .O(new_n129_));
  oai21  g83(.a(new_n120_), .b(x26), .c(x16), .O(new_n130_));
  inv1   g84(.a(x07), .O(new_n131_));
  nand2  g85(.a(x18), .b(new_n131_), .O(new_n132_));
  inv1   g86(.a(x15), .O(new_n133_));
  aoi21  g87(.a(new_n59_), .b(new_n133_), .c(x16), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n62_), .O(new_n135_));
  oai21  g89(.a(new_n130_), .b(new_n129_), .c(new_n135_), .O(z16));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  inv1   g91(.a(new_n119_), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n82_), .c(new_n65_), .d(new_n128_), .O(new_n139_));
  nand2  g93(.a(new_n63_), .b(x16), .O(new_n140_));
