...
module FAU ( 
  ...
  oai21  g53(.a(x18), .b(new_n99_), .c(new_n61_), .O(new_n100_));
  aoi21  g54(.a(x18), .b(x04), .c(new_n100_), .O(new_n101_));
  nor2   g55(.a(x23), .b(x22), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n82_), .c(new_n67_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x16), .O(new_n104_));
  aoi21  g58(.a(new_n92_), .b(x23), .c(new_n104_), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n101_), .c(new_n59_), .O(z13));
  nand2  g60(.a(new_n103_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n108_), .c(new_n67_), .d(new_n70_), .O(new_n110_));
  ...
  aoi21  g69(.a(new_n77_), .b(new_n115_), .c(x16), .O(new_n116_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n102_), .c(new_n82_), .d(new_n67_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(x16), .O(new_n123_));
  inv1   g77(.a(x14), .O(new_n124_));
  aoi21  g78(.a(new_n77_), .b(new_n124_), .c(x16), .O(new_n125_));
  oai21  g79(.a(new_n77_), .b(x06), .c(new_n125_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n123_), .c(new_n58_), .O(z15));
  inv1   g81(.a(x26), .O(new_n128_));
  nand3  g82(.a(new_n120_), .b(new_n102_), .c(new_n128_), .O(new_n129_));
  nor2   g83(.a(new_n129_), .b(new_n83_), .O(new_n130_));
  ...
  nand2  g93(.a(new_n139_), .b(x05), .O(new_n140_));
