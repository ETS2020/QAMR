...
module FAU ( 
  ...
  inv1   g023(.a(x01), .O(new_n70_));
  nand2  g024(.a(new_n60_), .b(x09), .O(new_n71_));
  oai21  g025(.a(new_n62_), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  nand2  g026(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  inv1   g027(.a(x20), .O(new_n74_));
  nor2   g028(.a(x19), .b(x17), .O(new_n75_));
  xor2a  g029(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  oai21  g030(.a(new_n76_), .b(new_n67_), .c(new_n73_), .O(z10));
  inv1   g031(.a(x02), .O(new_n78_));
  nand2  g032(.a(new_n60_), .b(x10), .O(new_n79_));
  oai21  g033(.a(new_n62_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n58_), .O(new_n81_));
  inv1   g035(.a(x21), .O(new_n82_));
  aoi21  g036(.a(new_n75_), .b(new_n74_), .c(new_n82_), .O(new_n83_));
  inv1   g037(.a(x17), .O(new_n84_));
  inv1   g038(.a(x19), .O(new_n85_));
  nand4  g039(.a(new_n82_), .b(new_n74_), .c(new_n85_), .d(new_n84_), .O(new_n86_));
  inv1   g040(.a(new_n86_), .O(new_n87_));
  nor2   g041(.a(new_n87_), .b(new_n83_), .O(new_n88_));
  oai21  g042(.a(new_n88_), .b(new_n67_), .c(new_n81_), .O(z11));
  ...
  aoi21  g062(.a(new_n108_), .b(new_n106_), .c(new_n65_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n104_), .O(z13));
  inv1   g064(.a(x05), .O(new_n111_));
  nand2  g065(.a(new_n60_), .b(x13), .O(new_n112_));
  oai21  g066(.a(new_n62_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n58_), .O(new_n114_));
  nand2  g068(.a(new_n102_), .b(x24), .O(new_n115_));
  nor2   g069(.a(x24), .b(x21), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n101_), .c(new_n75_), .d(new_n74_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n66_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z14));
  inv1   g074(.a(x06), .O(new_n121_));
  nand2  g075(.a(new_n60_), .b(x14), .O(new_n122_));
  oai21  g076(.a(new_n62_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  ...
  nand4  g081(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n97_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n87_), .c(new_n117_), .d(x25), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n67_), .c(new_n124_), .O(z15));
  inv1   g085(.a(x26), .O(new_n132_));
  nor2   g086(.a(x25), .b(x24), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n101_), .c(new_n98_), .d(new_n75_), .O(new_n134_));
  ...
  aoi21  g095(.a(new_n141_), .b(new_n139_), .c(new_n65_), .O(new_n142_));
  oai21  g096(.a(new_n137_), .b(new_n135_), .c(new_n142_), .O(z16));
  nand2  g097(.a(x27), .b(x17), .O(new_n144_));
  nand4  g098(.a(new_n98_), .b(new_n132_), .c(x19), .d(new_n84_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n128_), .c(new_n144_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n66_), .O(z17));
