...
module FAU ( 
  ...
  nand3  g32(.a(new_n78_), .b(new_n74_), .c(new_n60_), .O(z10));
  inv1   g33(.a(x21), .O(new_n80_));
  nor2   g34(.a(x21), .b(x20), .O(new_n81_));
  nand2  g35(.a(new_n81_), .b(new_n68_), .O(new_n82_));
  oai21  g36(.a(new_n73_), .b(new_n80_), .c(new_n82_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(x16), .O(new_n84_));
  inv1   g38(.a(x10), .O(new_n85_));
  aoi21  g39(.a(new_n75_), .b(new_n85_), .c(x16), .O(new_n86_));
  oai21  g40(.a(new_n75_), .b(x02), .c(new_n86_), .O(new_n87_));
  ...
  oai21  g52(.a(x18), .b(new_n98_), .c(new_n62_), .O(new_n99_));
  aoi21  g53(.a(x18), .b(x04), .c(new_n99_), .O(new_n100_));
  ...
  aoi21  g57(.a(new_n91_), .b(x23), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n100_), .c(new_n60_), .O(z13));
  ...
  oai21  g65(.a(new_n75_), .b(x16), .c(new_n47_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x05), .O(new_n113_));
  nand3  g67(.a(new_n75_), .b(new_n62_), .c(x13), .O(new_n114_));
  ...
  aoi21  g75(.a(new_n75_), .b(new_n121_), .c(x16), .O(new_n122_));
  ...
  nand3  g79(.a(new_n117_), .b(new_n101_), .c(new_n125_), .O(new_n126_));
  nor2   g80(.a(new_n126_), .b(new_n82_), .O(new_n127_));
  aoi21  g81(.a(new_n118_), .b(x26), .c(new_n127_), .O(new_n128_));
  inv1   g82(.a(x07), .O(new_n129_));
  nand2  g83(.a(x18), .b(new_n129_), .O(new_n130_));
  inv1   g84(.a(x15), .O(new_n131_));
  aoi21  g85(.a(new_n75_), .b(new_n131_), .c(x16), .O(new_n132_));
  aoi21  g86(.a(new_n132_), .b(new_n130_), .c(new_n59_), .O(new_n133_));
  oai21  g87(.a(new_n128_), .b(new_n62_), .c(new_n133_), .O(z16));
  nand3  g88(.a(new_n81_), .b(x19), .c(new_n65_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n126_), .c(new_n47_), .d(new_n65_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n58_), .O(new_n137_));
  inv1   g91(.a(x25), .O(new_n138_));
  nand4  g92(.a(new_n47_), .b(new_n125_), .c(new_n138_), .d(new_n71_), .O(new_n139_));
  nor3   g93(.a(new_n139_), .b(new_n66_), .c(x17), .O(new_n140_));
  nand3  g94(.a(new_n140_), .b(new_n108_), .c(new_n107_), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n137_), .c(new_n62_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
