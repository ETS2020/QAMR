...
module FAU ( 
  ...
  aoi21  g28(.a(new_n74_), .b(new_n71_), .c(new_n69_), .O(z10));
  ...
  xor2a  g41(.a(new_n80_), .b(x22), .O(new_n88_));
  inv1   g42(.a(x03), .O(new_n89_));
  nand2  g43(.a(x18), .b(new_n89_), .O(new_n90_));
  inv1   g44(.a(x11), .O(new_n91_));
  aoi21  g45(.a(new_n58_), .b(new_n91_), .c(x16), .O(new_n92_));
  aoi21  g46(.a(new_n92_), .b(new_n90_), .c(new_n69_), .O(new_n93_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n93_), .O(z12));
  inv1   g48(.a(x22), .O(new_n95_));
  nand3  g49(.a(new_n79_), .b(new_n65_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n98_), .c(new_n65_), .d(new_n76_), .O(new_n110_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n98_), .c(new_n79_), .d(new_n65_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n58_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n87_), .O(new_n125_));
  ...
  nand4  g93(.a(new_n139_), .b(new_n138_), .c(new_n109_), .d(new_n98_), .O(new_n140_));
