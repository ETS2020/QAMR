...
module FAU ( 
  ...
  xor2a  g60(.a(new_n98_), .b(x24), .O(new_n107_));
  ...
  oai21  g66(.a(new_n107_), .b(new_n65_), .c(new_n112_), .O(z14));
  oai21  g67(.a(new_n98_), .b(x24), .c(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n97_), .c(new_n79_), .d(new_n70_), .O(new_n116_));
  ...
  nor2   g77(.a(new_n116_), .b(new_n123_), .O(new_n124_));
  nand2  g78(.a(new_n116_), .b(new_n123_), .O(new_n125_));
  ...
  oai21  g85(.a(new_n126_), .b(new_n124_), .c(new_n131_), .O(z16));
  nand2  g86(.a(new_n115_), .b(new_n97_), .O(new_n133_));
  nand2  g87(.a(x27), .b(x17), .O(new_n134_));
  nand4  g88(.a(new_n79_), .b(new_n123_), .c(x19), .d(new_n64_), .O(new_n135_));
