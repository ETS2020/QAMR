...
module FAU ( 
  ...
  nand4  g67(.a(new_n113_), .b(new_n97_), .c(new_n78_), .d(new_n65_), .O(new_n114_));
  ...
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n80_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n116_), .O(z15));
  nand2  g76(.a(new_n114_), .b(x26), .O(new_n123_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n97_), .c(new_n78_), .d(new_n65_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(x16), .O(new_n127_));
  nor2   g81(.a(x18), .b(x16), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(x27), .c(x15), .O(new_n129_));
  nand3  g83(.a(x18), .b(new_n59_), .c(x07), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n129_), .c(new_n127_), .O(z16));
  inv1   g85(.a(x19), .O(new_n132_));
  nor2   g86(.a(new_n132_), .b(x17), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n124_), .c(new_n97_), .d(new_n78_), .O(new_n134_));
  nand2  g88(.a(x27), .b(x17), .O(new_n135_));
  nand2  g89(.a(new_n58_), .b(x16), .O(new_n136_));
  aoi21  g90(.a(new_n135_), .b(new_n134_), .c(new_n136_), .O(z17));
endmodule
