...
module FAU ( 
  ...
  nand3  g50(.a(new_n96_), .b(new_n77_), .c(new_n68_), .O(new_n97_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n96_), .c(new_n77_), .d(new_n68_), .O(new_n115_));
  ...
  nand3  g78(.a(new_n124_), .b(new_n79_), .c(x26), .O(new_n125_));
  ...
  nand4  g86(.a(new_n77_), .b(new_n126_), .c(x19), .d(new_n63_), .O(new_n133_));
