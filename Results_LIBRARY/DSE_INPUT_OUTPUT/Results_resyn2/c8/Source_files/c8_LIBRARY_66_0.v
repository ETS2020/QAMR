...
module FAU ( 
  ...
  nand4  g69(.a(new_n115_), .b(new_n99_), .c(new_n79_), .d(new_n63_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n88_), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n65_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n88_), .O(new_n121_));
  ...
  aoi21  g83(.a(new_n65_), .b(new_n129_), .c(x16), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n128_), .c(new_n59_), .O(new_n131_));
  oai21  g85(.a(new_n126_), .b(new_n125_), .c(new_n131_), .O(z16));
  nor2   g86(.a(x24), .b(new_n61_), .O(new_n133_));
  nor2   g87(.a(x26), .b(x25), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n99_), .d(new_n79_), .O(new_n135_));
  oai21  g89(.a(x17), .b(new_n47_), .c(new_n50_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  aoi21  g91(.a(new_n135_), .b(new_n60_), .c(new_n137_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
