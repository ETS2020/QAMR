...
module FAU ( 
  ...
  nand2  g11(.a(x27), .b(x01), .O(new_n58_));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n82_), .O(new_n87_));
  oai21  g41(.a(new_n81_), .b(new_n59_), .c(new_n87_), .O(z11));
  xor2a  g42(.a(new_n79_), .b(x22), .O(new_n89_));
  ...
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n82_), .O(new_n94_));
  oai21  g48(.a(new_n89_), .b(new_n59_), .c(new_n94_), .O(z12));
  oai21  g49(.a(new_n79_), .b(x22), .c(x23), .O(new_n96_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n102_), .c(new_n82_), .O(new_n105_));
  ...
  oai21  g65(.a(new_n61_), .b(x05), .c(new_n111_), .O(new_n112_));
  aoi21  g66(.a(new_n112_), .b(new_n109_), .c(new_n82_), .O(z14));
  nand4  g67(.a(new_n97_), .b(new_n78_), .c(new_n65_), .d(new_n107_), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n97_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  aoi22  g71(.a(new_n117_), .b(new_n80_), .c(new_n114_), .d(x25), .O(new_n118_));
  ...
  aoi21  g76(.a(new_n122_), .b(new_n120_), .c(new_n82_), .O(new_n123_));
  oai21  g77(.a(new_n118_), .b(new_n59_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand4  g79(.a(new_n115_), .b(new_n97_), .c(new_n78_), .d(new_n65_), .O(new_n126_));
  nor2   g80(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g81(.a(new_n126_), .b(new_n125_), .O(new_n128_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n131_), .c(new_n82_), .O(new_n134_));
  oai21  g88(.a(new_n129_), .b(new_n127_), .c(new_n134_), .O(z16));
  inv1   g89(.a(x19), .O(new_n136_));
  nor2   g90(.a(new_n136_), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n117_), .c(new_n78_), .d(new_n125_), .O(new_n138_));
