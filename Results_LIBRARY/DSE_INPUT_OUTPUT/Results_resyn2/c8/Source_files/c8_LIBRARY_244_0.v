...
module FAU ( 
  ...
  aoi21  g41(.a(new_n79_), .b(new_n61_), .c(new_n87_), .O(new_n88_));
  nor2   g42(.a(x22), .b(x21), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n61_), .c(new_n69_), .O(new_n90_));
  ...
  nand4  g57(.a(new_n89_), .b(new_n61_), .c(new_n97_), .d(new_n69_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n89_), .c(new_n61_), .d(new_n69_), .O(new_n107_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n79_), .d(new_n61_), .O(new_n118_));
  ...
  oai21  g76(.a(x27), .b(x14), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g80(.a(new_n126_), .b(new_n81_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  aoi21  g82(.a(new_n118_), .b(new_n128_), .c(new_n68_), .O(new_n129_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n126_), .c(new_n69_), .d(x19), .O(new_n137_));
  oai21  g91(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  aoi21  g93(.a(new_n137_), .b(new_n135_), .c(new_n139_), .O(z17));
endmodule
