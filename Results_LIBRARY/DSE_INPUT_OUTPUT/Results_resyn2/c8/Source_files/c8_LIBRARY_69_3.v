...
module FAU ( 
  ...
  nand4  g67(.a(new_n97_), .b(new_n79_), .c(new_n66_), .d(new_n107_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n97_), .c(new_n79_), .d(new_n66_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(x16), .O(new_n119_));
  nor2   g73(.a(x18), .b(x16), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(x27), .c(x14), .O(new_n121_));
  nand3  g75(.a(x18), .b(new_n60_), .c(x06), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n121_), .c(new_n119_), .O(z15));
  nand2  g77(.a(new_n117_), .b(x26), .O(new_n124_));
  nor3   g78(.a(x26), .b(x23), .c(x22), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n116_), .c(new_n79_), .d(new_n66_), .O(new_n126_));
  ...
  nand3  g90(.a(new_n116_), .b(new_n97_), .c(new_n136_), .O(new_n137_));
  nand3  g91(.a(new_n79_), .b(x19), .c(new_n135_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n47_), .d(new_n135_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n56_), .O(z17));
endmodule
