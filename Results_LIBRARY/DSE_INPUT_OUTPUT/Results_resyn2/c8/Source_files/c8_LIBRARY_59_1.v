...
module FAU ( 
  ...
  aoi21  g37(.a(new_n83_), .b(new_n81_), .c(new_n58_), .O(new_n84_));
  oai21  g38(.a(new_n79_), .b(new_n64_), .c(new_n84_), .O(z11));
  ...
  inv1   g89(.a(new_n58_), .O(new_n136_));
  inv1   g90(.a(x26), .O(new_n137_));
  nand3  g91(.a(new_n115_), .b(new_n96_), .c(new_n137_), .O(new_n138_));
  nand3  g92(.a(new_n78_), .b(x19), .c(new_n63_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n49_), .d(new_n63_), .O(new_n140_));
