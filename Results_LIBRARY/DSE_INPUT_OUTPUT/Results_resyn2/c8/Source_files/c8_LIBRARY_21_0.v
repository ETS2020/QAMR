...
module FAU ( 
  ...
  aoi21  g55(.a(new_n101_), .b(new_n99_), .c(new_n66_), .O(new_n102_));
  oai21  g56(.a(new_n97_), .b(new_n69_), .c(new_n102_), .O(z13));
  inv1   g57(.a(x23), .O(new_n104_));
  nand4  g58(.a(new_n80_), .b(new_n64_), .c(new_n104_), .d(new_n95_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n80_), .c(new_n64_), .d(new_n95_), .O(new_n108_));
  ...
  aoi21  g76(.a(new_n59_), .b(new_n48_), .c(x16), .O(new_n123_));
  aoi21  g77(.a(new_n123_), .b(new_n122_), .c(new_n66_), .O(new_n124_));
  oai21  g78(.a(new_n120_), .b(new_n69_), .c(new_n124_), .O(z15));
  nand3  g79(.a(new_n119_), .b(new_n82_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  nand4  g81(.a(new_n117_), .b(new_n107_), .c(new_n80_), .d(new_n64_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n69_), .O(new_n129_));
  ...
  aoi21  g87(.a(new_n133_), .b(new_n130_), .c(new_n66_), .O(z16));
  inv1   g88(.a(x17), .O(new_n135_));
  nand4  g89(.a(new_n80_), .b(new_n127_), .c(x19), .d(new_n135_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n118_), .c(new_n47_), .d(new_n135_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n67_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
