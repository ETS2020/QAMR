...
module FAU ( 
  ...
  nand2  g53(.a(new_n59_), .b(x12), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n99_), .c(x27), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  ...
  oai21  g75(.a(new_n118_), .b(new_n47_), .c(new_n121_), .O(z15));
  inv1   g76(.a(x15), .O(new_n123_));
  aoi21  g77(.a(new_n59_), .b(new_n123_), .c(new_n61_), .O(new_n124_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n133_), .c(new_n47_), .O(z17));
  buf    g89(.a(x27), .O(z08));
endmodule
