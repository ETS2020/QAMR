...
module FAU ( 
  ...
  nand2  g23(.a(new_n69_), .b(new_n56_), .O(z09));
  ...
  nand3  g29(.a(new_n75_), .b(new_n72_), .c(new_n56_), .O(z10));
  inv1   g30(.a(x20), .O(new_n77_));
  nand2  g31(.a(new_n66_), .b(new_n77_), .O(new_n78_));
  ...
  aoi21  g38(.a(new_n84_), .b(new_n82_), .c(new_n57_), .O(new_n85_));
  ...
  nand3  g53(.a(new_n99_), .b(new_n79_), .c(new_n66_), .O(new_n100_));
  ...
  aoi21  g59(.a(new_n62_), .b(new_n105_), .c(x16), .O(new_n106_));
  aoi21  g60(.a(new_n106_), .b(new_n104_), .c(new_n57_), .O(new_n107_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n60_), .c(new_n114_), .O(z14));
  oai21  g69(.a(new_n100_), .b(x24), .c(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n99_), .c(new_n79_), .d(new_n66_), .O(new_n118_));
  and2   g72(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n62_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n60_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n56_), .O(new_n123_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n130_), .c(new_n57_), .O(new_n133_));
  oai21  g87(.a(new_n128_), .b(new_n126_), .c(new_n133_), .O(z16));
  inv1   g88(.a(x17), .O(new_n135_));
  nand3  g89(.a(new_n125_), .b(x19), .c(new_n135_), .O(new_n136_));
  inv1   g90(.a(new_n136_), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n117_), .c(new_n99_), .d(new_n79_), .O(new_n138_));
  nand2  g92(.a(x27), .b(x17), .O(new_n139_));
  nand2  g93(.a(new_n56_), .b(x16), .O(new_n140_));
