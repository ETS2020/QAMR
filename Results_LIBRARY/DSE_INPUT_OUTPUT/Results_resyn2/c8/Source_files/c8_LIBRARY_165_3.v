...
module FAU ( 
  ...
  inv1   g031(.a(new_n59_), .O(new_n78_));
  ...
  nand3  g049(.a(new_n84_), .b(new_n70_), .c(new_n58_), .O(new_n96_));
  ...
  aoi21  g064(.a(new_n110_), .b(new_n47_), .c(new_n58_), .O(new_n111_));
  ...
  nand3  g090(.a(new_n47_), .b(x26), .c(x22), .O(new_n137_));
  ...
  oai21  g099(.a(x22), .b(x17), .c(x27), .O(new_n146_));
  nand3  g100(.a(new_n58_), .b(x19), .c(new_n64_), .O(new_n147_));
  inv1   g101(.a(new_n147_), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n134_), .c(new_n106_), .d(new_n84_), .O(new_n149_));
  aoi21  g103(.a(new_n149_), .b(new_n146_), .c(new_n126_), .O(z17));
