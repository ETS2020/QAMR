...
module FAU ( 
  ...
  aoi21  g30(.a(new_n66_), .b(new_n76_), .c(x16), .O(new_n77_));
  ...
  aoi21  g34(.a(new_n64_), .b(new_n72_), .c(new_n80_), .O(new_n81_));
  ...
  oai21  g41(.a(new_n66_), .b(x02), .c(new_n87_), .O(new_n88_));
  aoi21  g42(.a(new_n88_), .b(new_n85_), .c(new_n57_), .O(z11));
  inv1   g43(.a(x22), .O(new_n90_));
  aoi21  g44(.a(new_n82_), .b(new_n64_), .c(new_n90_), .O(new_n91_));
  nor2   g45(.a(x22), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n64_), .c(new_n72_), .O(new_n93_));
  ...
  oai21  g51(.a(new_n66_), .b(x03), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g57(.a(new_n66_), .b(new_n103_), .c(x16), .O(new_n104_));
  oai21  g58(.a(new_n66_), .b(x04), .c(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n57_), .O(z13));
  nand4  g60(.a(new_n92_), .b(new_n64_), .c(new_n100_), .d(new_n72_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n92_), .c(new_n64_), .d(new_n72_), .O(new_n110_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n82_), .d(new_n64_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n66_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n71_), .O(new_n125_));
  ...
  aoi21  g85(.a(new_n121_), .b(new_n131_), .c(new_n71_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  inv1   g87(.a(x15), .O(new_n134_));
  aoi21  g88(.a(new_n66_), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g89(.a(new_n66_), .b(x07), .c(new_n135_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n57_), .O(z16));
  inv1   g91(.a(x17), .O(new_n138_));
  nor2   g92(.a(x26), .b(x21), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n129_), .c(new_n72_), .d(x19), .O(new_n140_));
  nor2   g94(.a(x17), .b(x14), .O(new_n141_));
  oai21  g95(.a(new_n141_), .b(x27), .c(x16), .O(new_n142_));
  aoi21  g96(.a(new_n140_), .b(new_n138_), .c(new_n142_), .O(z17));
endmodule
