...
module FAU ( 
  ...
  nand4  g35(.a(new_n79_), .b(new_n70_), .c(new_n63_), .d(new_n81_), .O(new_n82_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n71_), .c(new_n96_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x23), .O(new_n99_));
  nor2   g53(.a(x23), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n97_), .c(new_n71_), .O(new_n101_));
  ...
  xor2a  g63(.a(new_n101_), .b(x24), .O(new_n110_));
  ...
  oai21  g69(.a(new_n110_), .b(new_n65_), .c(new_n115_), .O(z14));
  inv1   g70(.a(x24), .O(new_n117_));
  nand4  g71(.a(new_n100_), .b(new_n97_), .c(new_n71_), .d(new_n117_), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n117_), .c(new_n119_), .d(new_n96_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n83_), .c(new_n118_), .d(x25), .O(new_n123_));
  ...
  nand4  g85(.a(new_n131_), .b(new_n100_), .c(new_n97_), .d(new_n71_), .O(new_n132_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n137_), .c(new_n58_), .O(new_n140_));
  oai21  g94(.a(new_n135_), .b(new_n133_), .c(new_n140_), .O(z16));
  nand2  g95(.a(x27), .b(x17), .O(new_n142_));
  nand4  g96(.a(new_n122_), .b(new_n97_), .c(new_n66_), .d(new_n130_), .O(new_n143_));
  oai21  g97(.a(new_n47_), .b(x14), .c(x16), .O(new_n144_));
