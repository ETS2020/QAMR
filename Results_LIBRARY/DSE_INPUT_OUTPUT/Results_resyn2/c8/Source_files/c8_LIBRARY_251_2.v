...
module FAU ( 
  ...
  nand2  g33(.a(new_n72_), .b(new_n79_), .O(new_n80_));
  ...
  aoi21  g45(.a(new_n81_), .b(new_n72_), .c(new_n91_), .O(new_n92_));
  nand3  g46(.a(new_n81_), .b(new_n72_), .c(new_n91_), .O(new_n93_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n101_), .c(new_n81_), .d(new_n72_), .O(new_n118_));
  ...
  nand2  g78(.a(new_n117_), .b(new_n101_), .O(new_n125_));
  ...
  nand4  g88(.a(new_n81_), .b(new_n128_), .c(x19), .d(new_n67_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n125_), .c(new_n49_), .d(new_n67_), .O(new_n136_));
