...
module FAU ( 
  ...
  nand2  g065(.a(new_n58_), .b(x13), .O(new_n112_));
  oai21  g066(.a(new_n91_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n88_), .O(new_n114_));
  nand2  g068(.a(new_n107_), .b(x24), .O(new_n115_));
  nor2   g069(.a(x24), .b(x21), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n106_), .c(new_n64_), .d(new_n76_), .O(new_n117_));
  ...
  nand2  g075(.a(new_n58_), .b(x14), .O(new_n122_));
  oai21  g076(.a(new_n91_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  ...
  nand4  g081(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n102_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n80_), .c(new_n117_), .d(x25), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n96_), .c(new_n124_), .O(z15));
  inv1   g085(.a(x07), .O(new_n132_));
  nand2  g086(.a(new_n58_), .b(x15), .O(new_n133_));
  oai21  g087(.a(new_n91_), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n88_), .O(new_n135_));
  inv1   g089(.a(x26), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n106_), .c(new_n103_), .d(new_n64_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g093(.a(new_n138_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n95_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(new_n135_), .O(z16));
  nand2  g096(.a(x27), .b(x17), .O(new_n143_));
  nand4  g097(.a(new_n103_), .b(new_n136_), .c(x19), .d(new_n65_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n128_), .c(new_n143_), .O(new_n145_));
