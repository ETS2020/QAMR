...
module FAU ( 
  ...
  aoi21  g35(.a(new_n66_), .b(new_n71_), .c(new_n81_), .O(new_n82_));
  nand4  g36(.a(new_n81_), .b(new_n71_), .c(new_n64_), .d(new_n63_), .O(new_n83_));
  ...
  aoi21  g42(.a(new_n88_), .b(new_n85_), .c(new_n68_), .O(z11));
  inv1   g43(.a(x22), .O(new_n90_));
  xor2a  g44(.a(new_n83_), .b(new_n90_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n66_), .b(new_n90_), .c(new_n81_), .d(new_n71_), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  aoi22  g53(.a(new_n99_), .b(new_n84_), .c(new_n98_), .d(x23), .O(new_n100_));
  ...
  nand4  g60(.a(new_n99_), .b(new_n66_), .c(new_n81_), .d(new_n71_), .O(new_n107_));
  inv1   g61(.a(x23), .O(new_n108_));
  inv1   g62(.a(x24), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n108_), .c(new_n90_), .d(new_n81_), .O(new_n110_));
  inv1   g64(.a(new_n110_), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n73_), .c(new_n107_), .d(x24), .O(new_n112_));
  ...
  oai21  g70(.a(new_n112_), .b(new_n97_), .c(new_n116_), .O(z14));
  inv1   g71(.a(x25), .O(new_n118_));
  nand3  g72(.a(new_n99_), .b(new_n118_), .c(new_n109_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n84_), .O(new_n121_));
  nor2   g75(.a(x24), .b(x21), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n99_), .c(new_n73_), .O(new_n123_));
  aoi21  g77(.a(new_n123_), .b(x25), .c(new_n97_), .O(new_n124_));
  nand2  g78(.a(x18), .b(x06), .O(new_n125_));
  nand2  g79(.a(new_n59_), .b(x14), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n125_), .c(new_n97_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n69_), .O(new_n128_));
  aoi21  g82(.a(new_n124_), .b(new_n121_), .c(new_n128_), .O(z15));
  nand3  g83(.a(new_n120_), .b(new_n84_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  oai21  g85(.a(new_n119_), .b(new_n83_), .c(new_n131_), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n130_), .c(x16), .O(new_n133_));
  ...
  nand4  g94(.a(new_n140_), .b(new_n111_), .c(new_n71_), .d(x19), .O(new_n141_));
