...
module FAU ( 
  ...
  aoi21  g09(.a(new_n49_), .b(x25), .c(new_n50_), .O(z06));
  ...
  aoi21  g41(.a(new_n61_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g42(.a(new_n61_), .b(x02), .c(new_n88_), .O(new_n89_));
  aoi21  g43(.a(new_n89_), .b(new_n86_), .c(new_n58_), .O(z11));
  inv1   g44(.a(x22), .O(new_n91_));
  aoi21  g45(.a(new_n83_), .b(new_n73_), .c(new_n91_), .O(new_n92_));
  nand3  g46(.a(new_n83_), .b(new_n73_), .c(new_n91_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n92_), .c(x16), .O(new_n95_));
  inv1   g49(.a(x11), .O(new_n96_));
  aoi21  g50(.a(new_n61_), .b(new_n96_), .c(x16), .O(new_n97_));
  oai21  g51(.a(new_n61_), .b(x03), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g59(.a(new_n61_), .b(new_n105_), .c(x16), .O(new_n106_));
  oai21  g60(.a(new_n61_), .b(x04), .c(new_n106_), .O(new_n107_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n67_), .c(new_n114_), .O(z14));
  inv1   g69(.a(x24), .O(new_n116_));
  nand4  g70(.a(new_n101_), .b(new_n83_), .c(new_n73_), .d(new_n116_), .O(new_n117_));
  nor2   g71(.a(x25), .b(x24), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n101_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n84_), .O(new_n120_));
  aoi21  g74(.a(new_n117_), .b(x25), .c(new_n120_), .O(new_n121_));
  ...
  nor3   g81(.a(new_n119_), .b(new_n84_), .c(new_n57_), .O(new_n128_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n83_), .c(new_n68_), .d(new_n57_), .O(new_n138_));
