...
module FAU ( 
  ...
  aoi21  g34(.a(new_n77_), .b(new_n64_), .c(new_n80_), .O(new_n81_));
  nand3  g35(.a(new_n77_), .b(new_n64_), .c(new_n80_), .O(new_n82_));
  ...
  nand2  g42(.a(new_n82_), .b(x23), .O(new_n89_));
  nor2   g43(.a(x23), .b(x22), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n77_), .c(new_n64_), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(x16), .O(new_n93_));
  inv1   g47(.a(x12), .O(new_n94_));
  aoi21  g48(.a(new_n60_), .b(new_n94_), .c(new_n61_), .O(new_n95_));
  oai21  g49(.a(new_n60_), .b(x04), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n93_), .O(z13));
  nand2  g51(.a(new_n91_), .b(x24), .O(new_n98_));
  nor2   g52(.a(x24), .b(x21), .O(new_n99_));
  nand4  g53(.a(new_n99_), .b(new_n90_), .c(new_n64_), .d(new_n70_), .O(new_n100_));
  ...
  nand4  g67(.a(new_n113_), .b(new_n90_), .c(new_n77_), .d(new_n64_), .O(new_n114_));
  ...
  nand4  g84(.a(new_n130_), .b(new_n113_), .c(new_n90_), .d(new_n77_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n127_), .c(new_n48_), .O(z17));
endmodule
