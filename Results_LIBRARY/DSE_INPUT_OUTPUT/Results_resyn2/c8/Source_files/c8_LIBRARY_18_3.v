...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n49_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  nand2  g13(.a(x27), .b(x15), .O(new_n60_));
  nand2  g14(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  ...
  nand2  g26(.a(new_n72_), .b(new_n59_), .O(z09));
  ...
  nand3  g32(.a(new_n78_), .b(new_n75_), .c(new_n59_), .O(z10));
  ...
  aoi21  g49(.a(new_n95_), .b(new_n93_), .c(new_n58_), .O(new_n96_));
  oai21  g50(.a(new_n91_), .b(new_n63_), .c(new_n96_), .O(z12));
  oai21  g51(.a(new_n84_), .b(x22), .c(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n83_), .c(new_n69_), .O(new_n100_));
  ...
  aoi21  g68(.a(new_n114_), .b(new_n111_), .c(new_n58_), .O(z14));
  nand4  g69(.a(new_n99_), .b(new_n83_), .c(new_n69_), .d(new_n109_), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n99_), .c(new_n83_), .d(new_n69_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi21  g73(.a(new_n116_), .b(x25), .c(new_n119_), .O(new_n120_));
  inv1   g74(.a(x06), .O(new_n121_));
  nand2  g75(.a(x18), .b(new_n121_), .O(new_n122_));
  inv1   g76(.a(x14), .O(new_n123_));
  aoi21  g77(.a(new_n65_), .b(new_n123_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n122_), .c(new_n58_), .O(new_n125_));
  oai21  g79(.a(new_n120_), .b(new_n63_), .c(new_n125_), .O(z15));
  nand2  g80(.a(new_n119_), .b(new_n57_), .O(new_n127_));
  aoi21  g81(.a(new_n118_), .b(x26), .c(new_n63_), .O(new_n128_));
  nand2  g82(.a(x18), .b(x07), .O(new_n129_));
  nand2  g83(.a(new_n65_), .b(x15), .O(new_n130_));
  nand3  g84(.a(new_n130_), .b(new_n129_), .c(new_n63_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n59_), .O(new_n132_));
  aoi21  g86(.a(new_n128_), .b(new_n127_), .c(new_n132_), .O(z16));
  nand2  g87(.a(x27), .b(x17), .O(new_n134_));
  inv1   g88(.a(x19), .O(new_n135_));
  nor2   g89(.a(new_n135_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n117_), .c(new_n99_), .d(new_n83_), .O(new_n137_));
  nand2  g91(.a(new_n57_), .b(x16), .O(new_n138_));
  aoi21  g92(.a(new_n137_), .b(new_n134_), .c(new_n138_), .O(z17));
endmodule
