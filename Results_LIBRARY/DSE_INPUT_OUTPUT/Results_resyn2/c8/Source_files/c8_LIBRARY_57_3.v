...
module FAU ( 
  ...
  nor2   g001(.a(new_n47_), .b(x04), .O(new_n48_));
  ...
  nand2  g011(.a(x27), .b(x04), .O(new_n58_));
  ...
  nand2  g030(.a(new_n60_), .b(x10), .O(new_n77_));
  nand3  g031(.a(new_n77_), .b(new_n76_), .c(new_n65_), .O(new_n78_));
  inv1   g032(.a(x20), .O(new_n79_));
  inv1   g033(.a(x21), .O(new_n80_));
  aoi21  g034(.a(new_n69_), .b(new_n79_), .c(new_n80_), .O(new_n81_));
  inv1   g035(.a(x19), .O(new_n82_));
  nand4  g036(.a(new_n80_), .b(new_n79_), .c(new_n82_), .d(new_n64_), .O(new_n83_));
  ...
  oai21  g055(.a(new_n60_), .b(x16), .c(new_n47_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(x04), .O(new_n103_));
  nand3  g057(.a(new_n60_), .b(new_n65_), .c(x12), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(z13));
  nand2  g059(.a(new_n99_), .b(x24), .O(new_n106_));
  nor2   g060(.a(x24), .b(x21), .O(new_n107_));
  nand4  g061(.a(new_n107_), .b(new_n98_), .c(new_n69_), .d(new_n79_), .O(new_n108_));
  ...
  nand2  g069(.a(new_n115_), .b(new_n110_), .O(z14));
  inv1   g070(.a(new_n83_), .O(new_n117_));
  inv1   g071(.a(x23), .O(new_n118_));
  inv1   g072(.a(x24), .O(new_n119_));
  inv1   g073(.a(x25), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n94_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  aoi22  g076(.a(new_n122_), .b(new_n117_), .c(new_n108_), .d(x25), .O(new_n123_));
  ...
  aoi21  g081(.a(new_n127_), .b(new_n125_), .c(new_n59_), .O(new_n128_));
  oai21  g082(.a(new_n123_), .b(new_n65_), .c(new_n128_), .O(z15));
  inv1   g083(.a(x26), .O(new_n130_));
  nor2   g084(.a(x25), .b(x24), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n98_), .c(new_n95_), .d(new_n69_), .O(new_n132_));
  nor2   g086(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g087(.a(new_n132_), .b(new_n130_), .O(new_n134_));
  ...
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(new_n59_), .O(new_n140_));
  oai21  g094(.a(new_n135_), .b(new_n133_), .c(new_n140_), .O(z16));
  nand2  g095(.a(x27), .b(x17), .O(new_n142_));
  nand4  g096(.a(new_n95_), .b(new_n130_), .c(x19), .d(new_n64_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n121_), .c(new_n142_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n58_), .O(z17));
