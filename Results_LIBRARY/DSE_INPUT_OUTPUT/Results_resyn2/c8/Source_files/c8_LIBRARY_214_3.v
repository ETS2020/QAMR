...
module FAU ( 
  ...
  aoi21  g32(.a(new_n78_), .b(new_n75_), .c(new_n58_), .O(z10));
  ...
  nand3  g54(.a(new_n100_), .b(new_n82_), .c(new_n69_), .O(new_n101_));
  ...
  nand4  g63(.a(new_n100_), .b(new_n82_), .c(new_n69_), .d(new_n109_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n100_), .c(new_n82_), .d(new_n69_), .O(new_n118_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n117_), .c(new_n100_), .d(new_n82_), .O(new_n137_));
