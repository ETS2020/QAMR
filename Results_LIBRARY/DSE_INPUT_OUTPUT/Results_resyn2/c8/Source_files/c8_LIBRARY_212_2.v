...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_, new_n55_,
    new_n56_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_,
  ...
  nor2   g01(.a(x27), .b(x10), .O(new_n48_));
  ...
  nor2   g06(.a(x27), .b(new_n52_), .O(new_n53_));
  inv1   g07(.a(new_n53_), .O(new_n54_));
  inv1   g08(.a(x21), .O(new_n55_));
  oai21  g09(.a(x27), .b(new_n55_), .c(new_n52_), .O(new_n56_));
  nand2  g10(.a(new_n56_), .b(new_n54_), .O(z02));
  oai22  g11(.a(new_n49_), .b(x22), .c(new_n47_), .d(x11), .O(z03));
  oai22  g12(.a(new_n49_), .b(x23), .c(new_n47_), .d(x12), .O(z04));
  oai22  g13(.a(new_n49_), .b(x24), .c(new_n47_), .d(x13), .O(z05));
  aoi22  g14(.a(new_n48_), .b(x25), .c(x27), .d(x14), .O(z06));
  ...
  nand3  g23(.a(new_n69_), .b(new_n66_), .c(new_n54_), .O(z09));
  ...
  aoi21  g29(.a(new_n75_), .b(new_n72_), .c(new_n53_), .O(z10));
  inv1   g30(.a(x20), .O(new_n77_));
  aoi21  g31(.a(new_n68_), .b(new_n77_), .c(new_n55_), .O(new_n78_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n52_), .c(x16), .O(new_n85_));
  aoi21  g39(.a(new_n85_), .b(new_n84_), .c(new_n53_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n82_), .O(z11));
  inv1   g41(.a(x16), .O(new_n88_));
  xor2a  g42(.a(new_n80_), .b(x22), .O(new_n89_));
  ...
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n53_), .O(new_n94_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x23), .O(new_n96_));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n79_), .b(new_n68_), .c(new_n97_), .O(new_n98_));
  xor2a  g52(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x16), .O(new_n100_));
  inv1   g54(.a(x12), .O(new_n101_));
  aoi21  g55(.a(new_n63_), .b(new_n101_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n63_), .b(x04), .c(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n53_), .O(z13));
  nand4  g58(.a(new_n79_), .b(new_n68_), .c(new_n96_), .d(new_n97_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n79_), .c(new_n68_), .d(new_n97_), .O(new_n108_));
  ...
  aoi21  g68(.a(new_n114_), .b(new_n112_), .c(new_n53_), .O(new_n115_));
  ...
  aoi22  g73(.a(new_n119_), .b(new_n81_), .c(new_n108_), .d(x25), .O(new_n120_));
  inv1   g74(.a(x06), .O(new_n121_));
  nand2  g75(.a(x18), .b(new_n121_), .O(new_n122_));
  inv1   g76(.a(x14), .O(new_n123_));
  aoi21  g77(.a(new_n63_), .b(new_n123_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n122_), .c(new_n53_), .O(new_n125_));
  oai21  g79(.a(new_n120_), .b(new_n88_), .c(new_n125_), .O(z15));
  nand3  g80(.a(new_n119_), .b(new_n81_), .c(x26), .O(new_n127_));
  inv1   g81(.a(x26), .O(new_n128_));
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n79_), .d(new_n68_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n128_), .c(new_n88_), .O(new_n130_));
  ...
  oai21  g87(.a(new_n63_), .b(x07), .c(new_n133_), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n53_), .O(z16));
  inv1   g89(.a(x17), .O(new_n136_));
  nand4  g90(.a(new_n79_), .b(new_n128_), .c(x19), .d(new_n136_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n118_), .c(new_n47_), .d(new_n136_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n54_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
