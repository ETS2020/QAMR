...
module FAU ( 
  ...
  xnor2a g49(.a(new_n95_), .b(x23), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(x16), .O(new_n97_));
  inv1   g51(.a(x12), .O(new_n98_));
  aoi21  g52(.a(new_n59_), .b(new_n98_), .c(x16), .O(new_n99_));
  oai21  g53(.a(new_n59_), .b(x04), .c(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n100_), .b(new_n97_), .c(new_n58_), .O(z13));
  oai21  g55(.a(new_n95_), .b(x23), .c(x24), .O(new_n102_));
  inv1   g56(.a(new_n95_), .O(new_n103_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n104_), .c(new_n79_), .d(new_n69_), .O(new_n116_));
  and2   g70(.a(new_n116_), .b(x16), .O(new_n117_));
  inv1   g71(.a(new_n58_), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n59_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n64_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  aoi21  g76(.a(new_n117_), .b(new_n114_), .c(new_n122_), .O(z15));
  nor2   g77(.a(new_n116_), .b(x26), .O(new_n124_));
  nand2  g78(.a(new_n116_), .b(x26), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(x16), .O(new_n126_));
  nand2  g80(.a(x18), .b(x07), .O(new_n127_));
  nand2  g81(.a(new_n59_), .b(x15), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n127_), .c(new_n64_), .O(new_n129_));
  oai21  g83(.a(new_n126_), .b(new_n124_), .c(new_n129_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n118_), .O(z16));
  nand2  g85(.a(new_n115_), .b(new_n104_), .O(new_n132_));
  inv1   g86(.a(x26), .O(new_n133_));
  nand4  g87(.a(new_n79_), .b(new_n133_), .c(x19), .d(new_n63_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n132_), .c(new_n47_), .d(new_n63_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n118_), .O(z17));
endmodule
