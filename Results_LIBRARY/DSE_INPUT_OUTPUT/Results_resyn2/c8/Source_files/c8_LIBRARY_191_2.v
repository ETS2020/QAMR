...
module FAU ( 
  ...
  oai22  g008(.a(z08), .b(x24), .c(new_n49_), .d(x13), .O(z05));
  ...
  nand2  g063(.a(new_n106_), .b(x24), .O(new_n110_));
  nor2   g064(.a(x24), .b(x21), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n105_), .c(new_n64_), .d(new_n71_), .O(new_n112_));
  ...
  aoi21  g072(.a(new_n118_), .b(new_n116_), .c(new_n62_), .O(new_n119_));
  ...
  nand4  g077(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n101_), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  aoi22  g079(.a(new_n125_), .b(new_n82_), .c(new_n112_), .d(x25), .O(new_n126_));
  ...
  aoi21  g084(.a(new_n130_), .b(new_n128_), .c(new_n62_), .O(new_n131_));
  oai21  g085(.a(new_n126_), .b(new_n70_), .c(new_n131_), .O(z15));
  inv1   g086(.a(x07), .O(new_n133_));
  inv1   g087(.a(x15), .O(new_n134_));
  oai22  g088(.a(new_n90_), .b(new_n133_), .c(x18), .d(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n70_), .O(new_n136_));
  inv1   g090(.a(x26), .O(new_n137_));
  nor2   g091(.a(x25), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n105_), .c(new_n102_), .d(new_n64_), .O(new_n139_));
  ...
  nand4  g098(.a(new_n102_), .b(new_n137_), .c(x19), .d(new_n65_), .O(new_n145_));
