...
module FAU ( 
  ...
  nor2   g10(.a(new_n50_), .b(x14), .O(z06));
  ...
  aoi21  g63(.a(new_n109_), .b(new_n107_), .c(new_n68_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n105_), .O(z13));
  oai21  g65(.a(new_n103_), .b(new_n82_), .c(x24), .O(new_n112_));
  inv1   g66(.a(x24), .O(new_n113_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  nand3  g68(.a(new_n114_), .b(new_n73_), .c(new_n113_), .O(new_n115_));
  ...
  oai21  g73(.a(new_n59_), .b(x05), .c(new_n119_), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n117_), .c(new_n68_), .O(z14));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(x27), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n104_), .c(new_n115_), .d(x25), .O(new_n125_));
  inv1   g79(.a(x06), .O(new_n126_));
  nand2  g80(.a(x18), .b(new_n126_), .O(new_n127_));
  inv1   g81(.a(x14), .O(new_n128_));
  nand2  g82(.a(new_n59_), .b(new_n128_), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n127_), .c(new_n69_), .d(new_n81_), .O(new_n130_));
  oai21  g84(.a(new_n125_), .b(new_n81_), .c(new_n130_), .O(z15));
  inv1   g85(.a(x26), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x16), .O(new_n133_));
  oai21  g87(.a(new_n133_), .b(new_n115_), .c(x27), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g89(.a(new_n124_), .b(new_n104_), .O(new_n136_));
  nor2   g90(.a(new_n132_), .b(new_n81_), .O(new_n137_));
  nor2   g91(.a(new_n59_), .b(x07), .O(new_n138_));
  oai21  g92(.a(x18), .b(x15), .c(new_n81_), .O(new_n139_));
  nor2   g93(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  aoi21  g94(.a(new_n137_), .b(new_n136_), .c(new_n140_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n135_), .O(z16));
  nor2   g96(.a(x20), .b(new_n64_), .O(new_n143_));
  nand4  g97(.a(new_n143_), .b(new_n122_), .c(new_n114_), .d(new_n132_), .O(new_n144_));
  nand2  g98(.a(x27), .b(x16), .O(new_n145_));
  aoi21  g99(.a(new_n144_), .b(new_n63_), .c(new_n145_), .O(z17));
endmodule
