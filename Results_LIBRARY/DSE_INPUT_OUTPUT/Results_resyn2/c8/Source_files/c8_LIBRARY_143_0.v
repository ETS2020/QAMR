...
module FAU ( 
  ...
  nand3  g53(.a(new_n99_), .b(new_n72_), .c(new_n80_), .O(new_n100_));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n83_), .c(new_n100_), .d(x24), .O(new_n109_));
  ...
  nand3  g69(.a(new_n108_), .b(new_n72_), .c(new_n80_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  inv1   g71(.a(x25), .O(new_n118_));
  nand3  g72(.a(new_n99_), .b(new_n118_), .c(new_n117_), .O(new_n119_));
  ...
  aoi21  g77(.a(new_n65_), .b(new_n48_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n123_), .c(new_n59_), .O(new_n125_));
  oai21  g79(.a(new_n121_), .b(new_n107_), .c(new_n125_), .O(z15));
  oai21  g80(.a(new_n119_), .b(new_n82_), .c(x26), .O(new_n127_));
  nor2   g81(.a(x26), .b(x25), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n108_), .c(new_n72_), .d(new_n80_), .O(new_n129_));
  ...
  nand4  g92(.a(new_n138_), .b(new_n128_), .c(new_n108_), .d(new_n80_), .O(new_n139_));
