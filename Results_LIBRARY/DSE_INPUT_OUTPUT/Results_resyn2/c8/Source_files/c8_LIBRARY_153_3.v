...
module FAU ( 
  ...
  inv1   g29(.a(new_n63_), .O(new_n76_));
  inv1   g30(.a(x21), .O(new_n77_));
  aoi21  g31(.a(new_n70_), .b(new_n69_), .c(new_n77_), .O(new_n78_));
  nand4  g32(.a(new_n77_), .b(new_n69_), .c(new_n64_), .d(new_n62_), .O(new_n79_));
  inv1   g33(.a(new_n79_), .O(new_n80_));
  oai21  g34(.a(new_n80_), .b(new_n78_), .c(new_n76_), .O(new_n81_));
  nor2   g35(.a(new_n58_), .b(x02), .O(new_n82_));
  oai21  g36(.a(x18), .b(x10), .c(new_n73_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z11));
  inv1   g38(.a(x22), .O(new_n85_));
  nor2   g39(.a(x21), .b(x20), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(new_n70_), .c(new_n85_), .O(new_n87_));
  nand3  g41(.a(new_n86_), .b(new_n70_), .c(new_n85_), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n87_), .c(x16), .O(new_n90_));
  nor2   g44(.a(new_n58_), .b(x03), .O(new_n91_));
  oai21  g45(.a(x18), .b(x11), .c(new_n73_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(z12));
  nand2  g47(.a(new_n88_), .b(x23), .O(new_n94_));
  nor2   g48(.a(x23), .b(x22), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n86_), .c(new_n70_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n76_), .O(new_n98_));
  ...
  nand2  g60(.a(new_n106_), .b(new_n76_), .O(new_n107_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n85_), .O(new_n115_));
  ...
  oai21  g73(.a(new_n58_), .b(x06), .c(new_n119_), .O(new_n120_));
  oai21  g74(.a(new_n117_), .b(new_n63_), .c(new_n120_), .O(z15));
  inv1   g75(.a(x15), .O(new_n122_));
  aoi21  g76(.a(new_n58_), .b(new_n122_), .c(x16), .O(new_n123_));
  oai21  g77(.a(new_n58_), .b(x07), .c(new_n123_), .O(new_n124_));
  inv1   g78(.a(x26), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n95_), .c(new_n86_), .d(new_n70_), .O(new_n127_));
  nor2   g81(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g82(.a(new_n127_), .b(new_n125_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n76_), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n128_), .c(new_n124_), .O(z16));
  nand4  g85(.a(new_n116_), .b(new_n86_), .c(new_n65_), .d(new_n125_), .O(new_n132_));
  aoi21  g86(.a(new_n132_), .b(new_n47_), .c(new_n73_), .O(z17));
  buf    g87(.a(x27), .O(z08));
endmodule
