...
module FAU ( 
  ...
  nor2   g32(.a(new_n72_), .b(new_n78_), .O(new_n79_));
  nand3  g33(.a(new_n65_), .b(new_n78_), .c(new_n70_), .O(new_n80_));
  inv1   g34(.a(new_n80_), .O(new_n81_));
  oai21  g35(.a(new_n81_), .b(new_n79_), .c(x16), .O(new_n82_));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n69_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n82_), .O(z11));
  nand2  g42(.a(new_n80_), .b(x22), .O(new_n89_));
  nor2   g43(.a(x22), .b(x21), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n65_), .c(new_n70_), .O(new_n91_));
  ...
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n69_), .O(z12));
  nand2  g51(.a(new_n91_), .b(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n72_), .c(new_n78_), .O(new_n100_));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n69_), .O(z13));
  inv1   g60(.a(x16), .O(new_n107_));
  nor3   g61(.a(x24), .b(x23), .c(x22), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n81_), .c(new_n100_), .d(x24), .O(new_n109_));
  ...
  aoi21  g67(.a(new_n113_), .b(new_n111_), .c(new_n69_), .O(new_n114_));
  oai21  g68(.a(new_n109_), .b(new_n107_), .c(new_n114_), .O(z14));
  inv1   g69(.a(new_n108_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n80_), .c(x25), .O(new_n117_));
  nand2  g71(.a(new_n65_), .b(new_n70_), .O(new_n118_));
  nor2   g72(.a(x25), .b(x21), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n108_), .c(new_n107_), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n58_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n107_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n67_), .O(new_n126_));
  aoi21  g80(.a(new_n122_), .b(new_n117_), .c(new_n126_), .O(z15));
  nand3  g81(.a(new_n121_), .b(new_n108_), .c(x26), .O(new_n128_));
  inv1   g82(.a(x26), .O(new_n129_));
  nand2  g83(.a(new_n119_), .b(new_n72_), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n116_), .c(new_n129_), .O(new_n131_));
  ...
  aoi21  g89(.a(new_n58_), .b(new_n135_), .c(x16), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n134_), .c(new_n69_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n132_), .O(z16));
  nor2   g92(.a(x20), .b(new_n63_), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n119_), .c(new_n108_), .d(new_n129_), .O(new_n140_));
  nor2   g94(.a(x17), .b(x14), .O(new_n141_));
  oai21  g95(.a(new_n141_), .b(x27), .c(x16), .O(new_n142_));
  aoi21  g96(.a(new_n140_), .b(new_n62_), .c(new_n142_), .O(z17));
endmodule
