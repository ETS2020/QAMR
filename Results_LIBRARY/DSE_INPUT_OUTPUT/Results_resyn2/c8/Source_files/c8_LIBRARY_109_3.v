...
module FAU ( 
  ...
  xor2a  g45(.a(new_n85_), .b(x23), .O(new_n92_));
  nor2   g46(.a(new_n58_), .b(x04), .O(new_n93_));
  oai21  g47(.a(x18), .b(x12), .c(new_n60_), .O(new_n94_));
  oai22  g48(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n64_), .O(z13));
  inv1   g49(.a(x23), .O(new_n96_));
  nand4  g50(.a(new_n76_), .b(new_n70_), .c(new_n96_), .d(new_n83_), .O(new_n97_));
  nor2   g51(.a(x24), .b(x23), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n76_), .c(new_n70_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x24), .c(new_n100_), .O(new_n101_));
  nor2   g55(.a(new_n58_), .b(x05), .O(new_n102_));
  oai21  g56(.a(x18), .b(x13), .c(new_n60_), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n64_), .O(z14));
  nor2   g58(.a(x25), .b(x22), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  inv1   g60(.a(new_n106_), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n78_), .c(new_n99_), .d(x25), .O(new_n108_));
  nor2   g62(.a(new_n58_), .b(x06), .O(new_n109_));
  oai21  g63(.a(x18), .b(x14), .c(new_n60_), .O(new_n110_));
  oai22  g64(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n64_), .O(z15));
  inv1   g65(.a(x26), .O(new_n112_));
  nand3  g66(.a(new_n107_), .b(new_n78_), .c(new_n112_), .O(new_n113_));
  nand4  g67(.a(new_n105_), .b(new_n98_), .c(new_n76_), .d(new_n70_), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(x26), .c(x27), .O(new_n115_));
  ...
  oai21  g73(.a(new_n58_), .b(x07), .c(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n117_), .O(z16));
  nand4  g75(.a(new_n107_), .b(new_n76_), .c(new_n65_), .d(new_n112_), .O(new_n122_));
  aoi21  g76(.a(new_n122_), .b(new_n47_), .c(new_n60_), .O(z17));
endmodule
