...
module FAU ( 
  ...
  oai21  g59(.a(new_n60_), .b(x04), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g74(.a(x18), .b(x16), .c(new_n47_), .O(new_n121_));
  nand3  g75(.a(x18), .b(new_n66_), .c(x06), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n121_), .b(x14), .c(new_n123_), .O(new_n124_));
  ...
  nand4  g81(.a(new_n117_), .b(new_n100_), .c(new_n80_), .d(new_n71_), .O(new_n128_));
  ...
  nand4  g89(.a(new_n119_), .b(new_n80_), .c(new_n67_), .d(new_n127_), .O(new_n136_));
