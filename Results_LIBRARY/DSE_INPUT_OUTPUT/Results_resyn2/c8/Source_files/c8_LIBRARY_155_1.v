...
module FAU ( 
  ...
  nor2   g18(.a(new_n47_), .b(x14), .O(new_n65_));
  ...
  xor2a  g48(.a(new_n87_), .b(x23), .O(new_n95_));
  ...
  aoi21  g53(.a(new_n99_), .b(new_n97_), .c(new_n65_), .O(new_n100_));
  oai21  g54(.a(new_n95_), .b(new_n94_), .c(new_n100_), .O(z13));
  inv1   g55(.a(x23), .O(new_n102_));
  nand4  g56(.a(new_n77_), .b(new_n63_), .c(new_n102_), .d(new_n85_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n77_), .c(new_n63_), .d(new_n85_), .O(new_n106_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n77_), .d(new_n63_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n58_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n94_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n66_), .O(new_n122_));
  ...
  nand3  g79(.a(new_n125_), .b(new_n79_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  aoi21  g81(.a(new_n117_), .b(new_n127_), .c(new_n94_), .O(new_n128_));
  ...
  nand4  g88(.a(new_n77_), .b(new_n127_), .c(x19), .d(new_n134_), .O(new_n135_));
