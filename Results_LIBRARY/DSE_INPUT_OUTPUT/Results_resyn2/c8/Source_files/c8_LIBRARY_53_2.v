...
module FAU ( 
  ...
  nand2  g11(.a(new_n50_), .b(x05), .O(new_n58_));
  ...
  oai21  g64(.a(new_n60_), .b(x16), .c(x27), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x05), .O(new_n112_));
  nand3  g66(.a(new_n60_), .b(new_n65_), .c(x13), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(new_n112_), .c(new_n110_), .O(z14));
  nand2  g68(.a(new_n108_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x22), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n107_), .c(new_n80_), .d(new_n70_), .O(new_n117_));
  ...
  nand4  g87(.a(new_n80_), .b(new_n127_), .c(x19), .d(new_n64_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n124_), .c(new_n50_), .d(new_n64_), .O(new_n135_));
