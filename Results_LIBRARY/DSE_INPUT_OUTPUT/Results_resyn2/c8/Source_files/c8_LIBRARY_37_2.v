...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(x25), .c(x14), .O(z06));
  ...
  nand3  g60(.a(new_n70_), .b(new_n61_), .c(new_n60_), .O(new_n107_));
  inv1   g61(.a(x22), .O(new_n108_));
  inv1   g62(.a(x23), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n108_), .c(new_n80_), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n107_), .c(x24), .O(new_n111_));
  ...
  nor2   g74(.a(new_n110_), .b(new_n107_), .O(new_n121_));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n121_), .c(new_n113_), .d(x25), .O(new_n123_));
  oai21  g77(.a(x18), .b(x16), .c(x27), .O(new_n124_));
  inv1   g78(.a(x06), .O(new_n125_));
  nor2   g79(.a(x16), .b(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(x18), .c(new_n124_), .d(x14), .O(new_n127_));
  oai21  g81(.a(new_n123_), .b(new_n120_), .c(new_n127_), .O(z15));
  nand3  g82(.a(new_n122_), .b(new_n121_), .c(x26), .O(new_n129_));
  inv1   g83(.a(x26), .O(new_n130_));
  inv1   g84(.a(new_n122_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n100_), .c(new_n130_), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  inv1   g87(.a(x07), .O(new_n134_));
  nand2  g88(.a(x18), .b(new_n134_), .O(new_n135_));
  inv1   g89(.a(x15), .O(new_n136_));
  aoi21  g90(.a(new_n65_), .b(new_n136_), .c(x16), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n135_), .c(new_n59_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n133_), .O(z16));
  nor2   g93(.a(x20), .b(new_n61_), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n122_), .c(new_n99_), .d(new_n130_), .O(new_n141_));
  nor2   g95(.a(x17), .b(x14), .O(new_n142_));
  oai21  g96(.a(new_n142_), .b(x27), .c(x16), .O(new_n143_));
  aoi21  g97(.a(new_n141_), .b(new_n60_), .c(new_n143_), .O(z17));
endmodule
