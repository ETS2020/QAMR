...
module FAU ( 
  ...
  oai22  g09(.a(z08), .b(x24), .c(new_n52_), .d(x13), .O(z05));
  oai22  g10(.a(z08), .b(x25), .c(new_n52_), .d(x14), .O(z06));
  ...
  aoi22  g63(.a(new_n109_), .b(new_n83_), .c(new_n102_), .d(x24), .O(new_n110_));
  oai21  g64(.a(x27), .b(x05), .c(x16), .O(new_n111_));
  oai21  g65(.a(new_n52_), .b(x18), .c(new_n47_), .O(new_n112_));
  ...
  oai21  g69(.a(new_n111_), .b(new_n110_), .c(new_n115_), .O(z14));
  inv1   g70(.a(x16), .O(new_n117_));
  nand3  g71(.a(new_n109_), .b(new_n72_), .c(new_n80_), .O(new_n118_));
  ...
  oai21  g82(.a(new_n123_), .b(new_n117_), .c(new_n128_), .O(z15));
  oai21  g83(.a(new_n121_), .b(new_n82_), .c(x26), .O(new_n130_));
  nor2   g84(.a(x26), .b(x25), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n109_), .c(new_n72_), .d(new_n80_), .O(new_n132_));
  ...
  nor2   g94(.a(x20), .b(new_n61_), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n131_), .c(new_n109_), .d(new_n80_), .O(new_n142_));
  oai21  g96(.a(x17), .b(new_n47_), .c(new_n52_), .O(new_n143_));
