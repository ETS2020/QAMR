...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n49_, new_n50_, new_n56_, new_n57_, new_n58_, new_n59_,
  ...
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n85_), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(new_n83_), .c(new_n57_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n80_), .b(new_n68_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n80_), .b(new_n68_), .c(new_n88_), .O(new_n90_));
  ...
  oai21  g48(.a(new_n63_), .b(x03), .c(new_n94_), .O(new_n95_));
  aoi21  g49(.a(new_n95_), .b(new_n92_), .c(new_n57_), .O(z12));
  inv1   g50(.a(x16), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n68_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n90_), .b(x23), .c(new_n100_), .O(new_n101_));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n103_), .c(new_n57_), .O(new_n106_));
  oai21  g60(.a(new_n101_), .b(new_n97_), .c(new_n106_), .O(z13));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n110_), .c(new_n57_), .O(new_n113_));
  oai21  g67(.a(new_n108_), .b(new_n97_), .c(new_n113_), .O(z14));
  oai21  g68(.a(new_n99_), .b(x24), .c(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n80_), .d(new_n68_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  nand2  g73(.a(new_n63_), .b(x14), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n97_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n58_), .O(new_n122_));
  aoi21  g76(.a(new_n118_), .b(new_n115_), .c(new_n122_), .O(z15));
  nand2  g77(.a(new_n116_), .b(new_n98_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n82_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  aoi21  g81(.a(new_n117_), .b(new_n127_), .c(new_n97_), .O(new_n128_));
  ...
  nand4  g88(.a(new_n80_), .b(new_n127_), .c(x19), .d(new_n134_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n124_), .c(new_n49_), .d(new_n134_), .O(new_n136_));
