...
module FAU ( 
  ...
  nand2  g25(.a(new_n71_), .b(new_n58_), .O(z09));
  ...
  nand3  g31(.a(new_n77_), .b(new_n74_), .c(new_n58_), .O(z10));
  ...
  nand3  g53(.a(new_n99_), .b(new_n81_), .c(new_n68_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(x16), .O(new_n102_));
  inv1   g56(.a(x12), .O(new_n103_));
  aoi21  g57(.a(new_n64_), .b(new_n103_), .c(x16), .O(new_n104_));
  oai21  g58(.a(new_n64_), .b(x04), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g66(.a(new_n107_), .b(new_n62_), .c(new_n112_), .O(z14));
  oai21  g67(.a(new_n100_), .b(x24), .c(x25), .O(new_n114_));
  nand2  g68(.a(new_n81_), .b(new_n68_), .O(new_n115_));
  ...
  aoi21  g77(.a(new_n119_), .b(new_n114_), .c(new_n123_), .O(z15));
  nor3   g78(.a(new_n117_), .b(new_n115_), .c(new_n57_), .O(new_n125_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n133_), .c(new_n81_), .d(new_n57_), .O(new_n136_));
