...
module FAU ( 
  ...
  nand2  g00(.a(x27), .b(x06), .O(new_n47_));
  ...
  aoi22  g09(.a(z08), .b(x14), .c(new_n50_), .d(x25), .O(z06));
  oai22  g10(.a(new_n47_), .b(x15), .c(x27), .d(x26), .O(z07));
  nor2   g11(.a(new_n50_), .b(x06), .O(new_n58_));
  ...
  oai21  g31(.a(new_n72_), .b(new_n65_), .c(new_n77_), .O(z10));
  ...
  oai21  g40(.a(new_n59_), .b(x02), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g46(.a(new_n59_), .b(new_n92_), .c(x16), .O(new_n93_));
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n58_), .O(new_n94_));
  oai21  g48(.a(new_n89_), .b(new_n65_), .c(new_n94_), .O(z12));
  ...
  aoi21  g67(.a(new_n59_), .b(new_n113_), .c(x16), .O(new_n114_));
  ...
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n81_), .d(new_n71_), .O(new_n129_));
  ...
  aoi21  g86(.a(new_n59_), .b(new_n132_), .c(x16), .O(new_n133_));
  oai21  g87(.a(new_n59_), .b(x07), .c(new_n133_), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n131_), .c(new_n58_), .O(z16));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n119_), .b(new_n81_), .c(new_n66_), .d(new_n128_), .O(new_n137_));
  oai21  g91(.a(new_n50_), .b(x06), .c(x16), .O(new_n138_));
