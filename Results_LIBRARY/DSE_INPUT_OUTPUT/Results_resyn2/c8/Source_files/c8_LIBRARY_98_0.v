...
module FAU ( 
  ...
  oai22  g009(.a(new_n52_), .b(x24), .c(new_n51_), .d(x13), .O(z05));
  aoi22  g010(.a(new_n48_), .b(x25), .c(x27), .d(x14), .O(z06));
  oai22  g011(.a(new_n52_), .b(x26), .c(new_n51_), .d(x15), .O(z07));
  ...
  xor2a  g024(.a(new_n64_), .b(new_n70_), .O(new_n71_));
  inv1   g025(.a(x16), .O(new_n72_));
  nor2   g026(.a(new_n62_), .b(new_n72_), .O(new_n73_));
  inv1   g027(.a(new_n73_), .O(new_n74_));
  aoi21  g028(.a(x27), .b(x09), .c(x18), .O(new_n75_));
  oai21  g029(.a(new_n47_), .b(x01), .c(new_n72_), .O(new_n76_));
  oai22  g030(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n71_), .O(z10));
  inv1   g031(.a(x10), .O(new_n78_));
  nand2  g032(.a(x18), .b(x02), .O(new_n79_));
  nand2  g033(.a(x27), .b(new_n47_), .O(new_n80_));
  oai21  g034(.a(new_n80_), .b(new_n78_), .c(new_n79_), .O(new_n81_));
  nand2  g035(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  inv1   g036(.a(x21), .O(new_n83_));
  aoi21  g037(.a(new_n64_), .b(new_n70_), .c(new_n83_), .O(new_n84_));
  nand4  g038(.a(new_n83_), .b(new_n70_), .c(new_n66_), .d(new_n65_), .O(new_n85_));
  inv1   g039(.a(new_n85_), .O(new_n86_));
  oai21  g040(.a(new_n86_), .b(new_n84_), .c(new_n73_), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(new_n82_), .O(z11));
  ...
  aoi21  g046(.a(new_n47_), .b(new_n92_), .c(x16), .O(new_n93_));
  aoi21  g047(.a(new_n93_), .b(new_n91_), .c(new_n62_), .O(new_n94_));
  oai21  g048(.a(new_n89_), .b(new_n72_), .c(new_n94_), .O(z12));
  inv1   g049(.a(x22), .O(new_n96_));
  nor2   g050(.a(x21), .b(x20), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n64_), .c(new_n96_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x23), .O(new_n99_));
  nor2   g053(.a(x23), .b(x22), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n97_), .c(new_n64_), .O(new_n101_));
  ...
  aoi21  g060(.a(new_n47_), .b(new_n106_), .c(x16), .O(new_n107_));
  ...
  nand4  g065(.a(new_n111_), .b(new_n100_), .c(new_n64_), .d(new_n70_), .O(new_n112_));
  ...
  nand4  g077(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n96_), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  aoi22  g079(.a(new_n125_), .b(new_n86_), .c(new_n112_), .d(x25), .O(new_n126_));
