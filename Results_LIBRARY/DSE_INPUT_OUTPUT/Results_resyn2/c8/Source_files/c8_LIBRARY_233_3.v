...
module FAU ( 
  ...
  nor2   g69(.a(new_n107_), .b(new_n58_), .O(new_n116_));
  ...
  aoi21  g83(.a(new_n129_), .b(new_n47_), .c(new_n58_), .O(new_n130_));
  ...
  nand4  g92(.a(new_n106_), .b(new_n138_), .c(new_n58_), .d(new_n89_), .O(new_n139_));
