...
module FAU ( 
  ...
  nand2  g33(.a(new_n77_), .b(new_n64_), .O(new_n80_));
  xor2a  g34(.a(new_n80_), .b(x22), .O(new_n81_));
  nor2   g35(.a(new_n60_), .b(x03), .O(new_n82_));
  inv1   g36(.a(new_n61_), .O(new_n83_));
  oai21  g37(.a(x18), .b(x11), .c(new_n83_), .O(new_n84_));
  oai22  g38(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n48_), .O(z12));
  inv1   g39(.a(x22), .O(new_n86_));
  nand3  g40(.a(new_n77_), .b(new_n64_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g63(.a(new_n109_), .b(new_n108_), .c(new_n83_), .O(new_n110_));
  ...
  inv1   g71(.a(new_n80_), .O(new_n118_));
  ...
  aoi21  g77(.a(new_n60_), .b(x15), .c(new_n61_), .O(new_n124_));
  ...
  nand4  g82(.a(new_n128_), .b(new_n120_), .c(new_n77_), .d(new_n117_), .O(new_n129_));
  aoi21  g83(.a(new_n129_), .b(new_n126_), .c(new_n48_), .O(z17));
endmodule
