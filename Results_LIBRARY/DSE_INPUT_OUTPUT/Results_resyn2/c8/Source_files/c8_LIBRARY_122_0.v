...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n49_, new_n56_, new_n60_, new_n61_, new_n62_,
  ...
  nand2  g09(.a(x27), .b(new_n48_), .O(new_n56_));
  oai21  g10(.a(z08), .b(x24), .c(new_n56_), .O(z05));
  aoi22  g11(.a(new_n49_), .b(x25), .c(x27), .d(x14), .O(z06));
  aoi22  g12(.a(new_n49_), .b(x26), .c(x27), .d(x15), .O(z07));
  nor2   g13(.a(x27), .b(x13), .O(new_n60_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n66_), .c(new_n88_), .O(z11));
  ...
  oai21  g49(.a(new_n90_), .b(new_n66_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x23), .O(new_n97_));
  inv1   g51(.a(x22), .O(new_n98_));
  nand3  g52(.a(new_n80_), .b(new_n71_), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g59(.a(new_n99_), .b(x23), .c(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n80_), .c(new_n71_), .d(new_n98_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(x16), .O(new_n109_));
  inv1   g63(.a(new_n60_), .O(new_n110_));
  nand2  g64(.a(x18), .b(x05), .O(new_n111_));
  nand2  g65(.a(new_n61_), .b(x13), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n111_), .c(new_n66_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  aoi21  g68(.a(new_n109_), .b(new_n106_), .c(new_n114_), .O(z14));
  nor2   g69(.a(x25), .b(x22), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n107_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  aoi22  g72(.a(new_n118_), .b(new_n82_), .c(new_n108_), .d(x25), .O(new_n119_));
  ...
  aoi21  g77(.a(new_n123_), .b(new_n121_), .c(new_n60_), .O(new_n124_));
  ...
  nand4  g81(.a(new_n116_), .b(new_n107_), .c(new_n80_), .d(new_n71_), .O(new_n128_));
  ...
  nand4  g88(.a(new_n80_), .b(new_n127_), .c(x19), .d(new_n65_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n117_), .c(new_n47_), .d(new_n65_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n110_), .O(z17));
endmodule
