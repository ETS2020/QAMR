...
module FAU ( 
  ...
  nor2   g22(.a(x27), .b(x15), .O(new_n69_));
  ...
  aoi21  g44(.a(new_n90_), .b(new_n88_), .c(new_n69_), .O(new_n91_));
  ...
  oai21  g53(.a(new_n60_), .b(x03), .c(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n100_), .b(new_n97_), .c(new_n69_), .O(z12));
  ...
  oai21  g62(.a(new_n60_), .b(x04), .c(new_n108_), .O(new_n109_));
  aoi21  g63(.a(new_n109_), .b(new_n106_), .c(new_n69_), .O(z13));
  inv1   g64(.a(x16), .O(new_n111_));
  nor3   g65(.a(x24), .b(x23), .c(x22), .O(new_n112_));
  aoi22  g66(.a(new_n112_), .b(new_n85_), .c(new_n104_), .d(x24), .O(new_n113_));
  ...
  aoi21  g71(.a(new_n117_), .b(new_n115_), .c(new_n69_), .O(new_n118_));
  oai21  g72(.a(new_n113_), .b(new_n111_), .c(new_n118_), .O(z14));
  nand3  g73(.a(new_n112_), .b(new_n74_), .c(new_n82_), .O(new_n120_));
  inv1   g74(.a(x24), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand3  g76(.a(new_n103_), .b(new_n122_), .c(new_n121_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  aoi21  g78(.a(new_n120_), .b(x25), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g83(.a(new_n129_), .b(new_n127_), .c(new_n69_), .O(new_n130_));
  oai21  g84(.a(new_n125_), .b(new_n111_), .c(new_n130_), .O(z15));
  oai21  g85(.a(new_n123_), .b(new_n84_), .c(x26), .O(new_n132_));
  nor2   g86(.a(x26), .b(x25), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n112_), .c(new_n74_), .d(new_n82_), .O(new_n134_));
  ...
  aoi21  g92(.a(new_n60_), .b(new_n47_), .c(x16), .O(new_n139_));
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n69_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n136_), .O(z16));
  nor2   g95(.a(x20), .b(new_n65_), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n133_), .c(new_n112_), .d(new_n82_), .O(new_n143_));
  oai21  g97(.a(x17), .b(new_n47_), .c(new_n51_), .O(new_n144_));
