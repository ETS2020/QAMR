...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x05), .O(z08));
  ...
  nand2  g11(.a(x27), .b(x05), .O(new_n58_));
  ...
  nand3  g43(.a(new_n89_), .b(new_n69_), .c(new_n76_), .O(new_n90_));
  ...
  nand4  g57(.a(new_n89_), .b(new_n69_), .c(new_n97_), .d(new_n76_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n89_), .c(new_n69_), .d(new_n76_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(x16), .O(new_n109_));
  oai21  g63(.a(new_n60_), .b(x16), .c(new_n47_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x05), .O(new_n111_));
  nand3  g65(.a(new_n60_), .b(new_n65_), .c(x13), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n111_), .c(new_n109_), .O(z14));
  nand2  g67(.a(new_n107_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x22), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n106_), .c(new_n79_), .d(new_n69_), .O(new_n116_));
  ...
  nand2  g76(.a(new_n115_), .b(new_n106_), .O(new_n123_));
  ...
  nand4  g86(.a(new_n79_), .b(new_n126_), .c(x19), .d(new_n64_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n123_), .c(new_n47_), .d(new_n64_), .O(new_n134_));
