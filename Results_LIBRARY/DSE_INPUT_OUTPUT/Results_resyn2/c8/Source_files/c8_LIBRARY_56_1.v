...
module FAU ( 
  ...
  nor2   g10(.a(new_n47_), .b(x15), .O(new_n57_));
  ...
  nand2  g23(.a(new_n69_), .b(new_n58_), .O(z09));
  ...
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n57_), .O(new_n77_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n57_), .O(z13));
  ...
  aoi21  g77(.a(new_n123_), .b(new_n121_), .c(new_n57_), .O(new_n124_));
