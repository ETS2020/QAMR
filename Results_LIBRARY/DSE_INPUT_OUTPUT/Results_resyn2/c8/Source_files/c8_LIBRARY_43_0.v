...
module FAU ( 
  ...
  oai21  g08(.a(x27), .b(x23), .c(x12), .O(z04));
  ...
  nor2   g21(.a(x27), .b(x12), .O(new_n68_));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n66_), .c(new_n92_), .O(new_n93_));
  nand3  g47(.a(new_n87_), .b(new_n66_), .c(new_n92_), .O(new_n94_));
  ...
  nand3  g56(.a(new_n102_), .b(new_n87_), .c(new_n66_), .O(new_n103_));
  ...
  nand3  g65(.a(new_n111_), .b(new_n102_), .c(new_n73_), .O(new_n112_));
  ...
  aoi21  g91(.a(new_n137_), .b(new_n134_), .c(new_n68_), .O(z16));
  nor2   g92(.a(x20), .b(new_n64_), .O(new_n139_));
  nor2   g93(.a(x26), .b(x25), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n139_), .c(new_n111_), .d(new_n102_), .O(new_n141_));
