...
module FAU ( 
  ...
  aoi21  g36(.a(new_n70_), .b(new_n69_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g41(.a(new_n87_), .b(new_n78_), .O(z11));
  inv1   g42(.a(x22), .O(new_n89_));
  aoi21  g43(.a(new_n84_), .b(new_n70_), .c(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n84_), .b(new_n70_), .c(new_n89_), .O(new_n91_));
  ...
  nand3  g53(.a(new_n99_), .b(new_n84_), .c(new_n70_), .O(new_n100_));
  ...
  nand4  g64(.a(new_n110_), .b(new_n99_), .c(new_n70_), .d(new_n69_), .O(new_n111_));
  ...
  aoi21  g70(.a(new_n60_), .b(new_n116_), .c(x16), .O(new_n117_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n99_), .c(new_n84_), .d(new_n70_), .O(new_n122_));
  ...
  nand2  g80(.a(new_n126_), .b(new_n78_), .O(new_n127_));
  ...
  nand2  g92(.a(new_n121_), .b(new_n99_), .O(new_n139_));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  nand4  g94(.a(new_n84_), .b(new_n129_), .c(x19), .d(new_n64_), .O(new_n141_));
  oai21  g95(.a(new_n141_), .b(new_n139_), .c(new_n140_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(new_n78_), .O(z17));
endmodule
