...
module FAU ( 
  ...
  nand4  g66(.a(new_n96_), .b(new_n78_), .c(new_n69_), .d(new_n106_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n96_), .c(new_n78_), .d(new_n69_), .O(new_n116_));
  ...
  nand4  g80(.a(new_n126_), .b(new_n115_), .c(new_n78_), .d(new_n69_), .O(new_n127_));
  ...
  nand3  g90(.a(new_n115_), .b(new_n96_), .c(new_n136_), .O(new_n137_));
  nand3  g91(.a(new_n78_), .b(x19), .c(new_n64_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n47_), .d(new_n64_), .O(new_n139_));
