...
module FAU ( 
  ...
  nand4  g61(.a(new_n107_), .b(new_n98_), .c(new_n70_), .d(new_n69_), .O(new_n108_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n98_), .c(new_n80_), .d(new_n70_), .O(new_n117_));
  ...
  oai21  g75(.a(new_n59_), .b(x06), .c(new_n121_), .O(new_n122_));
  aoi21  g76(.a(new_n122_), .b(new_n119_), .c(new_n58_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nand3  g78(.a(new_n116_), .b(new_n98_), .c(new_n124_), .O(new_n125_));
  nor2   g79(.a(new_n125_), .b(new_n81_), .O(new_n126_));
  ...
  oai21  g86(.a(new_n127_), .b(new_n64_), .c(new_n132_), .O(z16));
  nand3  g87(.a(new_n80_), .b(x19), .c(new_n63_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n125_), .c(new_n47_), .d(new_n63_), .O(new_n135_));
