...
module FAU ( 
  ...
  nor2   g57(.a(x25), .b(x24), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n88_), .c(new_n77_), .d(new_n59_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x27), .O(new_n106_));
  aoi21  g60(.a(new_n97_), .b(x25), .c(new_n106_), .O(new_n107_));
  inv1   g61(.a(x14), .O(new_n108_));
  aoi21  g62(.a(new_n64_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n64_), .b(x06), .c(new_n109_), .O(new_n110_));
  oai21  g64(.a(new_n107_), .b(new_n61_), .c(new_n110_), .O(z15));
  nor2   g65(.a(x26), .b(x23), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n104_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n83_), .c(new_n105_), .d(x26), .O(new_n115_));
  ...
  nand4  g74(.a(new_n114_), .b(new_n77_), .c(new_n80_), .d(x19), .O(new_n121_));
