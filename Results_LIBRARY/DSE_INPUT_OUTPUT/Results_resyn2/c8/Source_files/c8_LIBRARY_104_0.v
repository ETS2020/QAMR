...
module FAU ( 
  ...
  oai22  g11(.a(z08), .b(x26), .c(new_n50_), .d(x15), .O(z07));
  ...
  oai21  g25(.a(new_n71_), .b(new_n50_), .c(new_n47_), .O(new_n72_));
  oai21  g26(.a(new_n68_), .b(new_n47_), .c(new_n72_), .O(z10));
  nand2  g27(.a(new_n64_), .b(new_n67_), .O(new_n74_));
  nor2   g28(.a(x21), .b(x20), .O(new_n75_));
  aoi22  g29(.a(new_n75_), .b(new_n64_), .c(new_n74_), .d(x21), .O(new_n76_));
  nor2   g30(.a(new_n60_), .b(x02), .O(new_n77_));
  inv1   g31(.a(new_n61_), .O(new_n78_));
  oai21  g32(.a(x18), .b(x10), .c(new_n78_), .O(new_n79_));
  oai22  g33(.a(new_n79_), .b(new_n77_), .c(new_n76_), .d(new_n47_), .O(z11));
  nand2  g34(.a(new_n75_), .b(new_n64_), .O(new_n81_));
  xor2a  g35(.a(new_n81_), .b(x22), .O(new_n82_));
  nor2   g36(.a(new_n60_), .b(x03), .O(new_n83_));
  oai21  g37(.a(x18), .b(x11), .c(new_n78_), .O(new_n84_));
  oai22  g38(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n47_), .O(z12));
  inv1   g39(.a(x22), .O(new_n86_));
  nand3  g40(.a(new_n75_), .b(new_n64_), .c(new_n86_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(x23), .O(new_n88_));
  nor2   g42(.a(x23), .b(x22), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n75_), .c(new_n64_), .O(new_n90_));
  ...
  nand4  g52(.a(new_n98_), .b(new_n89_), .c(new_n64_), .d(new_n67_), .O(new_n99_));
  ...
  oai21  g58(.a(new_n104_), .b(new_n50_), .c(new_n47_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n101_), .O(z14));
  nand2  g60(.a(x18), .b(x06), .O(new_n107_));
  nand2  g61(.a(new_n60_), .b(x14), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n107_), .c(new_n78_), .O(new_n109_));
  inv1   g63(.a(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n99_), .b(x25), .O(new_n111_));
  nor2   g65(.a(x25), .b(x24), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n89_), .c(new_n75_), .d(new_n64_), .O(new_n113_));
  and2   g67(.a(new_n113_), .b(x16), .O(new_n114_));
  aoi21  g68(.a(new_n114_), .b(new_n111_), .c(new_n110_), .O(z15));
  inv1   g69(.a(x26), .O(new_n116_));
  inv1   g70(.a(new_n113_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  aoi21  g72(.a(new_n113_), .b(x26), .c(new_n47_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x07), .O(new_n120_));
  nand2  g74(.a(new_n60_), .b(x15), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n78_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi21  g77(.a(new_n119_), .b(new_n118_), .c(new_n123_), .O(z16));
  nand2  g78(.a(new_n50_), .b(new_n47_), .O(new_n125_));
  nand2  g79(.a(new_n112_), .b(new_n89_), .O(new_n126_));
  nand2  g80(.a(x27), .b(x17), .O(new_n127_));
  inv1   g81(.a(x17), .O(new_n128_));
  nand4  g82(.a(new_n75_), .b(new_n116_), .c(x19), .d(new_n128_), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n126_), .c(new_n127_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x16), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n125_), .O(z17));
endmodule
