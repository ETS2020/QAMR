...
module FAU ( 
  ...
  nand2  g10(.a(new_n47_), .b(x26), .O(z07));
  inv1   g11(.a(x15), .O(new_n58_));
  ...
  aoi21  g23(.a(new_n69_), .b(new_n63_), .c(new_n59_), .O(z09));
  ...
  aoi21  g47(.a(new_n93_), .b(new_n91_), .c(new_n59_), .O(new_n94_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n81_), .c(new_n71_), .O(new_n98_));
  ...
  xor2a  g61(.a(new_n98_), .b(new_n107_), .O(new_n108_));
  ...
  nand4  g67(.a(new_n97_), .b(new_n81_), .c(new_n71_), .d(new_n107_), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n97_), .c(new_n81_), .d(new_n71_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  aoi21  g71(.a(new_n114_), .b(x25), .c(new_n117_), .O(new_n118_));
  ...
  aoi21  g76(.a(new_n122_), .b(new_n120_), .c(new_n59_), .O(new_n123_));
  oai21  g77(.a(new_n118_), .b(new_n65_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand2  g79(.a(new_n117_), .b(new_n125_), .O(new_n126_));
  aoi21  g80(.a(new_n116_), .b(x26), .c(new_n65_), .O(new_n127_));
  ...
  oai21  g84(.a(new_n47_), .b(new_n58_), .c(new_n130_), .O(new_n131_));
  aoi21  g85(.a(new_n127_), .b(new_n126_), .c(new_n131_), .O(z16));
  nand2  g86(.a(new_n97_), .b(new_n81_), .O(new_n133_));
  nand2  g87(.a(x27), .b(x17), .O(new_n134_));
  nand4  g88(.a(new_n115_), .b(new_n125_), .c(x19), .d(new_n64_), .O(new_n135_));
  oai21  g89(.a(new_n135_), .b(new_n133_), .c(new_n134_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n58_), .O(new_n137_));
  nor2   g91(.a(x27), .b(x25), .O(new_n138_));
  inv1   g92(.a(new_n133_), .O(new_n139_));
  nor2   g93(.a(x26), .b(x24), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n139_), .c(new_n67_), .d(new_n138_), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n137_), .c(new_n65_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
