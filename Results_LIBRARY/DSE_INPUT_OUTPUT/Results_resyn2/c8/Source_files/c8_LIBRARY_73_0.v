...
module FAU ( 
  ...
  oai21  g41(.a(new_n84_), .b(new_n48_), .c(new_n87_), .O(z12));
  ...
  oai21  g53(.a(new_n99_), .b(new_n47_), .c(new_n48_), .O(new_n100_));
  ...
  oai21  g73(.a(new_n116_), .b(new_n48_), .c(new_n119_), .O(z15));
  inv1   g74(.a(x15), .O(new_n121_));
  aoi21  g75(.a(new_n60_), .b(new_n121_), .c(new_n61_), .O(new_n122_));
  oai21  g76(.a(new_n60_), .b(x07), .c(new_n122_), .O(new_n123_));
  ...
  nand4  g86(.a(new_n90_), .b(new_n124_), .c(x19), .d(new_n77_), .O(new_n133_));
  oai21  g87(.a(new_n133_), .b(new_n114_), .c(new_n132_), .O(new_n134_));
