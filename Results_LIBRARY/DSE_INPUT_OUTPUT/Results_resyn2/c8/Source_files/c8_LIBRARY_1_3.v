...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n52_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  nor2   g001(.a(new_n47_), .b(x25), .O(new_n48_));
  ...
  aoi21  g009(.a(x27), .b(x14), .c(x25), .O(z06));
  ...
  aoi21  g033(.a(new_n79_), .b(new_n75_), .c(new_n59_), .O(z10));
  ...
  aoi21  g062(.a(new_n108_), .b(new_n106_), .c(new_n59_), .O(new_n109_));
  ...
  aoi21  g073(.a(new_n119_), .b(new_n117_), .c(new_n59_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n115_), .O(z14));
  nor2   g075(.a(x27), .b(new_n58_), .O(new_n122_));
  ...
  nor3   g088(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n101_), .c(new_n86_), .d(new_n72_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g092(.a(x26), .b(x16), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n47_), .c(new_n58_), .O(new_n140_));
  ...
  nor2   g102(.a(x26), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n101_), .d(new_n86_), .O(new_n150_));
