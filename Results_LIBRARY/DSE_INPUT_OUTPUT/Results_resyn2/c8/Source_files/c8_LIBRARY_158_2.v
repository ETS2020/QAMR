...
module FAU ( 
  ...
  nand2  g44(.a(new_n83_), .b(new_n69_), .O(new_n91_));
  xor2a  g45(.a(new_n91_), .b(x22), .O(new_n92_));
  ...
  nand3  g53(.a(new_n83_), .b(new_n69_), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(x23), .O(new_n101_));
  nor2   g55(.a(x23), .b(x22), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n83_), .c(new_n69_), .O(new_n103_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n102_), .c(new_n83_), .d(new_n69_), .O(new_n119_));
  ...
  nand4  g90(.a(new_n83_), .b(new_n136_), .c(x19), .d(new_n134_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n135_), .c(new_n49_), .d(new_n134_), .O(new_n138_));
