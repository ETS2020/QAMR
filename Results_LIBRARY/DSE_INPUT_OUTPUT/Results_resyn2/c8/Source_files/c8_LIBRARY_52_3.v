...
module FAU ( 
  ...
  aoi21  g28(.a(new_n74_), .b(new_n71_), .c(new_n58_), .O(z10));
  ...
  nand2  g39(.a(new_n85_), .b(new_n57_), .O(z11));
  ...
  nand2  g75(.a(new_n121_), .b(new_n57_), .O(new_n122_));
  ...
  nand2  g84(.a(new_n130_), .b(new_n57_), .O(new_n131_));
  ...
  nand2  g90(.a(new_n136_), .b(new_n57_), .O(z17));
  buf    g91(.a(x27), .O(z08));
endmodule
