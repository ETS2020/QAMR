...
module FAU ( 
  ...
  nor2   g01(.a(new_n47_), .b(x02), .O(z08));
  ...
  nand3  g27(.a(new_n73_), .b(new_n70_), .c(new_n67_), .O(z10));
  ...
  nand2  g35(.a(x18), .b(new_n65_), .O(new_n82_));
  inv1   g36(.a(x10), .O(new_n83_));
  aoi21  g37(.a(new_n58_), .b(new_n83_), .c(x16), .O(new_n84_));
  aoi21  g38(.a(new_n84_), .b(new_n82_), .c(new_n66_), .O(new_n85_));
  oai21  g39(.a(new_n81_), .b(new_n75_), .c(new_n85_), .O(z11));
  inv1   g40(.a(x22), .O(new_n87_));
  aoi21  g41(.a(new_n78_), .b(new_n63_), .c(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n78_), .b(new_n63_), .c(new_n87_), .O(new_n89_));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n91_), .c(new_n66_), .O(z12));
  xor2a  g49(.a(new_n89_), .b(x23), .O(new_n96_));
  ...
  oai21  g55(.a(new_n96_), .b(new_n75_), .c(new_n101_), .O(z13));
  inv1   g56(.a(x23), .O(new_n103_));
  nand4  g57(.a(new_n78_), .b(new_n63_), .c(new_n103_), .d(new_n87_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n78_), .c(new_n63_), .d(new_n87_), .O(new_n107_));
  ...
  aoi21  g77(.a(new_n123_), .b(new_n121_), .c(new_n66_), .O(new_n124_));
  oai21  g78(.a(new_n119_), .b(new_n75_), .c(new_n124_), .O(z15));
  ...
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n75_), .O(new_n129_));
