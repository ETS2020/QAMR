...
module FAU ( 
  ...
  oai22  g12(.a(z08), .b(x26), .c(new_n47_), .d(x15), .O(z07));
  nor2   g13(.a(x27), .b(x14), .O(new_n60_));
  inv1   g14(.a(x17), .O(new_n61_));
  ...
  aoi21  g23(.a(new_n69_), .b(new_n65_), .c(new_n60_), .O(z09));
  inv1   g24(.a(x20), .O(new_n71_));
  nor2   g25(.a(new_n64_), .b(new_n71_), .O(new_n72_));
  ...
  nand3  g33(.a(new_n71_), .b(new_n62_), .c(new_n61_), .O(new_n80_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n84_), .c(x16), .O(new_n85_));
  ...
  nand2  g42(.a(new_n73_), .b(new_n88_), .O(new_n89_));
  nor2   g43(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g44(.a(new_n90_), .b(new_n73_), .c(new_n89_), .d(x22), .O(new_n91_));
  inv1   g45(.a(x03), .O(new_n92_));
  nand2  g46(.a(x18), .b(new_n92_), .O(new_n93_));
  inv1   g47(.a(x11), .O(new_n94_));
  aoi21  g48(.a(new_n66_), .b(new_n94_), .c(x16), .O(new_n95_));
  aoi21  g49(.a(new_n95_), .b(new_n93_), .c(new_n60_), .O(new_n96_));
  oai21  g50(.a(new_n91_), .b(new_n79_), .c(new_n96_), .O(z12));
  inv1   g51(.a(x23), .O(new_n98_));
  aoi21  g52(.a(new_n90_), .b(new_n73_), .c(new_n98_), .O(new_n99_));
  inv1   g53(.a(x22), .O(new_n100_));
  nand3  g54(.a(new_n98_), .b(new_n100_), .c(new_n88_), .O(new_n101_));
  nor2   g55(.a(new_n101_), .b(new_n80_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n99_), .c(x16), .O(new_n103_));
  ...
  oai21  g61(.a(new_n101_), .b(new_n80_), .c(x24), .O(new_n108_));
  inv1   g62(.a(x24), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n73_), .c(new_n109_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x16), .O(new_n113_));
  inv1   g67(.a(x13), .O(new_n114_));
  aoi21  g68(.a(new_n66_), .b(new_n114_), .c(x16), .O(new_n115_));
  oai21  g69(.a(new_n66_), .b(x05), .c(new_n115_), .O(new_n116_));
  aoi21  g70(.a(new_n116_), .b(new_n113_), .c(new_n60_), .O(z14));
  nor2   g71(.a(x25), .b(x24), .O(new_n118_));
  aoi22  g72(.a(new_n118_), .b(new_n102_), .c(new_n111_), .d(x25), .O(new_n119_));
  inv1   g73(.a(x06), .O(new_n120_));
  nand2  g74(.a(x18), .b(new_n120_), .O(new_n121_));
  aoi21  g75(.a(new_n66_), .b(new_n48_), .c(x16), .O(new_n122_));
  aoi21  g76(.a(new_n122_), .b(new_n121_), .c(new_n60_), .O(new_n123_));
  oai21  g77(.a(new_n119_), .b(new_n79_), .c(new_n123_), .O(z15));
  nand3  g78(.a(new_n118_), .b(new_n102_), .c(x26), .O(new_n125_));
  inv1   g79(.a(x26), .O(new_n126_));
  nand2  g80(.a(new_n110_), .b(new_n73_), .O(new_n127_));
  inv1   g81(.a(new_n118_), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n127_), .c(new_n126_), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n125_), .c(x16), .O(new_n130_));
  inv1   g84(.a(x07), .O(new_n131_));
  nand2  g85(.a(x18), .b(new_n131_), .O(new_n132_));
  inv1   g86(.a(x15), .O(new_n133_));
  aoi21  g87(.a(new_n66_), .b(new_n133_), .c(x16), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n60_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n130_), .O(z16));
  nor2   g90(.a(x20), .b(new_n62_), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n118_), .c(new_n110_), .d(new_n126_), .O(new_n138_));
  oai21  g92(.a(x17), .b(new_n48_), .c(new_n47_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  aoi21  g94(.a(new_n138_), .b(new_n61_), .c(new_n140_), .O(z17));
endmodule
