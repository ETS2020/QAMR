...
module FAU ( 
  ...
  aoi22  g08(.a(z08), .b(x13), .c(new_n52_), .d(x24), .O(z05));
  oai22  g09(.a(new_n47_), .b(x14), .c(x27), .d(x25), .O(z06));
  aoi22  g10(.a(z08), .b(x15), .c(new_n52_), .d(x26), .O(z07));
  ...
  nand3  g52(.a(new_n98_), .b(new_n97_), .c(new_n52_), .O(new_n99_));
  ...
  aoi21  g61(.a(new_n59_), .b(new_n107_), .c(new_n61_), .O(new_n108_));
  ...
  oai22  g86(.a(new_n132_), .b(new_n114_), .c(new_n131_), .d(new_n52_), .O(z17));
endmodule
