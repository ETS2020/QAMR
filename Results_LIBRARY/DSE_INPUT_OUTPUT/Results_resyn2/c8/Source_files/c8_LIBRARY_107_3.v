...
module FAU ( 
  ...
  nand3  g41(.a(new_n87_), .b(new_n60_), .c(new_n74_), .O(new_n88_));
  ...
  nand4  g57(.a(new_n87_), .b(new_n60_), .c(new_n103_), .d(new_n74_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n87_), .c(new_n60_), .d(new_n74_), .O(new_n107_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n77_), .d(new_n60_), .O(new_n118_));
  ...
  nand4  g89(.a(new_n77_), .b(new_n128_), .c(x19), .d(new_n135_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n125_), .c(new_n47_), .d(new_n135_), .O(new_n137_));
