...
module FAU ( 
  ...
  inv1   g23(.a(new_n59_), .O(new_n70_));
  oai21  g24(.a(x19), .b(x17), .c(x20), .O(new_n71_));
  inv1   g25(.a(x20), .O(new_n72_));
  nand2  g26(.a(new_n63_), .b(new_n72_), .O(new_n73_));
  nand3  g27(.a(new_n73_), .b(new_n71_), .c(x16), .O(new_n74_));
  aoi21  g28(.a(new_n65_), .b(x09), .c(x16), .O(new_n75_));
  oai21  g29(.a(new_n65_), .b(new_n47_), .c(new_n75_), .O(new_n76_));
  nand3  g30(.a(new_n76_), .b(new_n74_), .c(new_n70_), .O(new_n77_));
  ...
  aoi21  g36(.a(new_n73_), .b(x21), .c(new_n82_), .O(new_n83_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n79_), .c(new_n88_), .O(z11));
  inv1   g43(.a(x22), .O(new_n90_));
  aoi21  g44(.a(new_n80_), .b(new_n63_), .c(new_n90_), .O(new_n91_));
  nor2   g45(.a(x22), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n63_), .c(new_n72_), .O(new_n93_));
  ...
  nand4  g60(.a(new_n92_), .b(new_n63_), .c(new_n100_), .d(new_n72_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n92_), .c(new_n63_), .d(new_n72_), .O(new_n110_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n80_), .d(new_n63_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  nand2  g77(.a(new_n65_), .b(x14), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n79_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n70_), .O(new_n126_));
  ...
  nand3  g83(.a(new_n129_), .b(new_n82_), .c(x26), .O(new_n130_));
  inv1   g84(.a(x26), .O(new_n131_));
  aoi21  g85(.a(new_n121_), .b(new_n131_), .c(new_n79_), .O(new_n132_));
  ...
  oai21  g94(.a(x17), .b(new_n47_), .c(new_n51_), .O(new_n141_));
