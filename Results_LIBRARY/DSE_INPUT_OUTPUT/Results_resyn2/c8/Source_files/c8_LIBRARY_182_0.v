...
module FAU ( 
  ...
  aoi21  g31(.a(new_n65_), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  ...
  aoi21  g48(.a(new_n94_), .b(new_n91_), .c(new_n67_), .O(z12));
  ...
  aoi21  g53(.a(new_n89_), .b(x23), .c(new_n99_), .O(new_n100_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n102_), .c(new_n67_), .O(new_n105_));
  oai21  g59(.a(new_n100_), .b(new_n96_), .c(new_n105_), .O(z13));
  ...
  nand4  g69(.a(new_n115_), .b(new_n97_), .c(new_n79_), .d(new_n65_), .O(new_n116_));
  and2   g70(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g71(.a(x18), .b(x06), .O(new_n118_));
  nand2  g72(.a(new_n60_), .b(x14), .O(new_n119_));
  nand3  g73(.a(new_n119_), .b(new_n118_), .c(new_n96_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n68_), .O(new_n121_));
  ...
  aoi21  g80(.a(new_n116_), .b(new_n126_), .c(new_n96_), .O(new_n127_));
  ...
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n67_), .O(z16));
  inv1   g86(.a(x17), .O(new_n133_));
  nand4  g87(.a(new_n79_), .b(new_n126_), .c(x19), .d(new_n133_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n123_), .c(new_n47_), .d(new_n133_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n68_), .O(z17));
endmodule
