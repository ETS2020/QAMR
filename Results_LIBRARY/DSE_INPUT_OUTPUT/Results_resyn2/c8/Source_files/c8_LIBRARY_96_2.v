...
module FAU ( 
  ...
  nand2  g31(.a(new_n63_), .b(new_n70_), .O(new_n78_));
  ...
  nand2  g36(.a(x18), .b(new_n65_), .O(new_n83_));
  ...
  aoi21  g42(.a(new_n79_), .b(new_n63_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n79_), .b(new_n63_), .c(new_n88_), .O(new_n90_));
  ...
  nand4  g58(.a(new_n79_), .b(new_n63_), .c(new_n104_), .d(new_n88_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n79_), .c(new_n63_), .d(new_n88_), .O(new_n108_));
  ...
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n79_), .d(new_n63_), .O(new_n129_));
  ...
  oai22  g91(.a(new_n137_), .b(new_n118_), .c(new_n50_), .d(new_n136_), .O(new_n138_));
