...
module FAU ( 
  ...
  nor2   g19(.a(new_n47_), .b(new_n58_), .O(new_n66_));
  ...
  nand3  g30(.a(new_n76_), .b(new_n73_), .c(new_n67_), .O(z10));
  ...
  nand4  g58(.a(new_n92_), .b(new_n62_), .c(new_n98_), .d(new_n70_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n92_), .c(new_n62_), .d(new_n70_), .O(new_n108_));
  ...
  nand4  g90(.a(new_n80_), .b(new_n129_), .c(x19), .d(new_n136_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n126_), .c(new_n47_), .d(new_n136_), .O(new_n138_));
