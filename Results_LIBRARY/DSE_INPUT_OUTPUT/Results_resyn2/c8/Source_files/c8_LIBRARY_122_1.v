...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n54_, new_n55_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n135_;
  nand2  g00(.a(x27), .b(x13), .O(new_n47_));
  ...
  nor2   g06(.a(x27), .b(x24), .O(z05));
  inv1   g07(.a(x27), .O(new_n54_));
  inv1   g08(.a(new_n47_), .O(new_n55_));
  aoi22  g09(.a(new_n55_), .b(x14), .c(new_n54_), .d(x25), .O(z06));
  aoi22  g10(.a(new_n55_), .b(x15), .c(new_n54_), .d(x26), .O(z07));
  nor2   g11(.a(new_n54_), .b(x13), .O(new_n58_));
  ...
  aoi21  g27(.a(new_n59_), .b(new_n73_), .c(x16), .O(new_n74_));
  aoi21  g28(.a(new_n74_), .b(new_n72_), .c(new_n58_), .O(new_n75_));
  oai21  g29(.a(new_n70_), .b(new_n64_), .c(new_n75_), .O(z10));
  nand2  g30(.a(new_n69_), .b(new_n68_), .O(new_n77_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n64_), .c(new_n86_), .O(z11));
  xor2a  g41(.a(new_n79_), .b(x22), .O(new_n88_));
  ...
  nand3  g50(.a(new_n78_), .b(new_n69_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g55(.a(new_n59_), .b(x04), .c(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n102_), .b(new_n99_), .c(new_n58_), .O(z13));
  oai21  g57(.a(new_n97_), .b(x23), .c(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n78_), .c(new_n69_), .d(new_n96_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(x16), .O(new_n107_));
  inv1   g61(.a(new_n58_), .O(new_n108_));
  nand2  g62(.a(x18), .b(x05), .O(new_n109_));
  nand2  g63(.a(new_n59_), .b(x13), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n109_), .c(new_n64_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  aoi21  g66(.a(new_n107_), .b(new_n104_), .c(new_n112_), .O(z14));
  nor2   g67(.a(x25), .b(x22), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n105_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n80_), .c(new_n106_), .d(x25), .O(new_n117_));
  inv1   g71(.a(x06), .O(new_n118_));
  nand2  g72(.a(x18), .b(new_n118_), .O(new_n119_));
  inv1   g73(.a(x14), .O(new_n120_));
  aoi21  g74(.a(new_n59_), .b(new_n120_), .c(x16), .O(new_n121_));
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n58_), .O(new_n122_));
  ...
  nand4  g79(.a(new_n114_), .b(new_n105_), .c(new_n78_), .d(new_n69_), .O(new_n126_));
  ...
  aoi21  g83(.a(new_n59_), .b(new_n129_), .c(x16), .O(new_n130_));
  oai21  g84(.a(new_n59_), .b(x07), .c(new_n130_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n128_), .c(new_n58_), .O(z16));
  nand4  g86(.a(new_n78_), .b(new_n125_), .c(x19), .d(new_n63_), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n115_), .c(new_n54_), .d(new_n63_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n108_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
