...
module FAU ( 
  ...
  nand4  g81(.a(new_n116_), .b(new_n106_), .c(new_n80_), .d(new_n66_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n60_), .O(new_n129_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n118_), .c(new_n80_), .d(new_n127_), .O(new_n138_));
  nand2  g92(.a(new_n59_), .b(x16), .O(new_n139_));
