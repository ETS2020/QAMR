...
module FAU ( 
  ...
  nand2  g32(.a(new_n71_), .b(new_n78_), .O(new_n79_));
  ...
  nand2  g41(.a(new_n80_), .b(new_n71_), .O(new_n88_));
  ...
  nand3  g50(.a(new_n80_), .b(new_n71_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g65(.a(new_n111_), .b(new_n109_), .c(new_n57_), .O(new_n112_));
  oai21  g66(.a(new_n107_), .b(new_n66_), .c(new_n112_), .O(z14));
  inv1   g67(.a(x24), .O(new_n114_));
  nand4  g68(.a(new_n99_), .b(new_n80_), .c(new_n71_), .d(new_n114_), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n99_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n88_), .O(new_n118_));
  ...
  nor3   g79(.a(new_n117_), .b(new_n88_), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n80_), .c(new_n67_), .d(new_n125_), .O(new_n136_));
  oai21  g90(.a(new_n47_), .b(new_n56_), .c(x16), .O(new_n137_));
