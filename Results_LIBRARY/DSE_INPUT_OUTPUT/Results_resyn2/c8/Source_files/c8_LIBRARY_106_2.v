...
module FAU ( 
  ...
  nand4  g69(.a(new_n115_), .b(new_n97_), .c(new_n80_), .d(new_n70_), .O(new_n116_));
  ...
  nand3  g78(.a(new_n124_), .b(new_n82_), .c(x26), .O(new_n125_));
  ...
  nand4  g86(.a(new_n80_), .b(new_n126_), .c(x19), .d(new_n64_), .O(new_n133_));
