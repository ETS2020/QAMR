...
module FAU ( 
  ...
  nand3  g48(.a(new_n77_), .b(new_n63_), .c(new_n94_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(x23), .O(new_n96_));
  nor2   g50(.a(x23), .b(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n77_), .c(new_n63_), .O(new_n98_));
  ...
  nand4  g60(.a(new_n97_), .b(new_n77_), .c(new_n63_), .d(new_n106_), .O(new_n107_));
  ...
  aoi22  g70(.a(new_n116_), .b(new_n79_), .c(new_n107_), .d(x25), .O(new_n117_));
  ...
  nand4  g79(.a(new_n114_), .b(new_n97_), .c(new_n77_), .d(new_n63_), .O(new_n126_));
