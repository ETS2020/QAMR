...
module FAU ( 
  ...
  aoi21  g64(.a(new_n60_), .b(new_n48_), .c(x16), .O(new_n111_));
  aoi21  g65(.a(new_n111_), .b(new_n110_), .c(new_n59_), .O(new_n112_));
  ...
  aoi22  g70(.a(new_n116_), .b(new_n81_), .c(new_n106_), .d(x25), .O(new_n117_));
  ...
  nand4  g79(.a(new_n114_), .b(new_n105_), .c(new_n79_), .d(new_n69_), .O(new_n126_));
  ...
  nand4  g87(.a(new_n79_), .b(new_n125_), .c(x19), .d(new_n64_), .O(new_n134_));
  oai22  g88(.a(new_n134_), .b(new_n115_), .c(new_n47_), .d(new_n64_), .O(new_n135_));
