...
module FAU ( 
  ...
  nor2   g34(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  inv1   g35(.a(new_n58_), .O(new_n82_));
  nand2  g36(.a(x18), .b(x02), .O(new_n83_));
  nand2  g37(.a(new_n59_), .b(x10), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(new_n83_), .c(new_n64_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  aoi21  g40(.a(new_n81_), .b(new_n77_), .c(new_n86_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n78_), .b(new_n68_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n78_), .b(new_n68_), .c(new_n88_), .O(new_n90_));
  ...
  nand4  g58(.a(new_n78_), .b(new_n68_), .c(new_n104_), .d(new_n88_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n78_), .c(new_n68_), .d(new_n88_), .O(new_n108_));
  ...
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n78_), .d(new_n68_), .O(new_n129_));
  ...
  nand4  g89(.a(new_n78_), .b(new_n128_), .c(x19), .d(new_n63_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n118_), .c(new_n47_), .d(new_n63_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n82_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
