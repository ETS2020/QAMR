...
module FAU ( 
  ...
  aoi21  g013(.a(new_n47_), .b(new_n59_), .c(x16), .O(new_n60_));
  oai21  g014(.a(new_n47_), .b(x00), .c(new_n60_), .O(new_n61_));
  ...
  aoi21  g071(.a(new_n47_), .b(new_n117_), .c(x16), .O(new_n118_));
  ...
  aoi21  g083(.a(new_n47_), .b(new_n129_), .c(x16), .O(new_n130_));
