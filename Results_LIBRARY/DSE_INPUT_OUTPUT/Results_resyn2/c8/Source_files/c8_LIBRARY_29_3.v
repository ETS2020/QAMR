...
module FAU ( 
  ...
  nand3  g31(.a(new_n77_), .b(new_n74_), .c(new_n56_), .O(z10));
  ...
  nor2   g71(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n62_), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  nand2  g74(.a(new_n64_), .b(x14), .O(new_n121_));
  nand3  g75(.a(new_n121_), .b(new_n120_), .c(new_n62_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n56_), .O(new_n123_));
  aoi21  g77(.a(new_n119_), .b(new_n115_), .c(new_n123_), .O(z15));
  nor3   g78(.a(new_n117_), .b(new_n83_), .c(new_n59_), .O(new_n125_));
  oai21  g79(.a(new_n118_), .b(x26), .c(x16), .O(new_n126_));
  inv1   g80(.a(x07), .O(new_n127_));
  nand2  g81(.a(x18), .b(new_n127_), .O(new_n128_));
  inv1   g82(.a(x15), .O(new_n129_));
  aoi21  g83(.a(new_n64_), .b(new_n129_), .c(x16), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n128_), .c(new_n57_), .O(new_n131_));
  oai21  g85(.a(new_n126_), .b(new_n125_), .c(new_n131_), .O(z16));
  inv1   g86(.a(new_n117_), .O(new_n133_));
  inv1   g87(.a(x19), .O(new_n134_));
  nor2   g88(.a(new_n134_), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n133_), .c(new_n82_), .d(new_n59_), .O(new_n136_));
