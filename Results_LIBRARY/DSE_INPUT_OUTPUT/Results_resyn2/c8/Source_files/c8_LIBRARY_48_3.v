...
module FAU ( 
  ...
  nand2  g25(.a(new_n71_), .b(new_n56_), .O(z09));
  ...
  aoi21  g31(.a(new_n77_), .b(new_n74_), .c(new_n57_), .O(z10));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n84_), .c(new_n57_), .O(new_n87_));
  ...
  aoi21  g51(.a(new_n97_), .b(new_n95_), .c(new_n57_), .O(new_n98_));
  ...
  aoi21  g61(.a(new_n107_), .b(new_n105_), .c(new_n57_), .O(new_n108_));
  ...
  nand2  g77(.a(new_n123_), .b(new_n56_), .O(new_n124_));
  aoi21  g78(.a(new_n120_), .b(new_n117_), .c(new_n124_), .O(z15));
  nor2   g79(.a(new_n119_), .b(new_n59_), .O(new_n126_));
  nand2  g80(.a(new_n119_), .b(new_n59_), .O(new_n127_));
  ...
  nand3  g89(.a(new_n59_), .b(x19), .c(new_n135_), .O(new_n136_));
