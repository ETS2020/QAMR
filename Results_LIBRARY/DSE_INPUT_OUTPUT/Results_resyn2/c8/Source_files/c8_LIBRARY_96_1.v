...
module FAU ( 
  ...
  nand2  g01(.a(x27), .b(x02), .O(new_n48_));
  ...
  nor2   g18(.a(new_n47_), .b(x02), .O(new_n65_));
  ...
  xor2a  g50(.a(new_n90_), .b(x23), .O(new_n97_));
  ...
  aoi21  g55(.a(new_n101_), .b(new_n99_), .c(new_n65_), .O(new_n102_));
  oai21  g56(.a(new_n97_), .b(new_n68_), .c(new_n102_), .O(z13));
  inv1   g57(.a(x23), .O(new_n104_));
  nand4  g58(.a(new_n78_), .b(new_n63_), .c(new_n104_), .d(new_n88_), .O(new_n105_));
