...
module FAU ( 
  ...
  aoi21  g29(.a(new_n58_), .b(x10), .c(x16), .O(new_n76_));
  nand2  g30(.a(new_n70_), .b(new_n69_), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(x21), .O(new_n78_));
  nor2   g32(.a(x21), .b(x20), .O(new_n79_));
  aoi21  g33(.a(new_n79_), .b(new_n70_), .c(new_n64_), .O(new_n80_));
  aoi22  g34(.a(new_n80_), .b(new_n78_), .c(new_n76_), .d(new_n75_), .O(z11));
  inv1   g35(.a(x22), .O(new_n82_));
  aoi21  g36(.a(new_n79_), .b(new_n70_), .c(new_n82_), .O(new_n83_));
  nand3  g37(.a(new_n79_), .b(new_n70_), .c(new_n82_), .O(new_n84_));
  ...
  nand3  g44(.a(new_n90_), .b(new_n79_), .c(new_n70_), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n47_), .O(new_n92_));
  ...
  oai21  g49(.a(new_n58_), .b(x04), .c(new_n95_), .O(new_n96_));
  oai21  g50(.a(new_n93_), .b(new_n60_), .c(new_n96_), .O(z13));
  nand2  g51(.a(new_n91_), .b(x24), .O(new_n98_));
  nor2   g52(.a(x24), .b(x21), .O(new_n99_));
  nand4  g53(.a(new_n99_), .b(new_n90_), .c(new_n70_), .d(new_n69_), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n98_), .c(new_n47_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(x16), .O(new_n102_));
  inv1   g56(.a(x13), .O(new_n103_));
  aoi21  g57(.a(new_n58_), .b(new_n103_), .c(x16), .O(new_n104_));
  oai21  g58(.a(new_n58_), .b(x05), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n102_), .O(z14));
  nand2  g60(.a(new_n100_), .b(x25), .O(new_n107_));
  nor2   g61(.a(x25), .b(x24), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n90_), .c(new_n79_), .d(new_n70_), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n107_), .c(new_n47_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x16), .O(new_n111_));
  inv1   g65(.a(x14), .O(new_n112_));
  aoi21  g66(.a(new_n58_), .b(new_n112_), .c(x16), .O(new_n113_));
  oai21  g67(.a(new_n58_), .b(x06), .c(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n111_), .O(z15));
  nor2   g69(.a(new_n58_), .b(x07), .O(new_n116_));
  oai21  g70(.a(x18), .b(x15), .c(new_n60_), .O(new_n117_));
  inv1   g71(.a(x26), .O(new_n118_));
  nor2   g72(.a(new_n109_), .b(new_n118_), .O(new_n119_));
  nand2  g73(.a(new_n109_), .b(new_n118_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n65_), .O(new_n121_));
  oai22  g75(.a(new_n121_), .b(new_n119_), .c(new_n117_), .d(new_n116_), .O(z16));
  nand2  g76(.a(new_n99_), .b(new_n90_), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand3  g78(.a(new_n118_), .b(new_n124_), .c(new_n69_), .O(new_n125_));
  nor4   g79(.a(new_n125_), .b(new_n123_), .c(new_n66_), .d(new_n64_), .O(z17));
  buf    g80(.a(x27), .O(z08));
endmodule
