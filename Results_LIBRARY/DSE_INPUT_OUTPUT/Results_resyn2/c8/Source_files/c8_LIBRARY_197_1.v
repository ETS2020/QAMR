...
module FAU ( 
  ...
  oai22  g27(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n47_), .O(z10));
  ...
  oai22  g33(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n47_), .O(z11));
  ...
  nand4  g54(.a(new_n100_), .b(new_n89_), .c(new_n70_), .d(new_n69_), .O(new_n101_));
  ...
  nand2  g60(.a(new_n59_), .b(new_n106_), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n105_), .c(new_n61_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n103_), .O(z14));
  nand2  g63(.a(x18), .b(x06), .O(new_n110_));
  nand2  g64(.a(new_n59_), .b(x14), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n110_), .c(new_n61_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  nand2  g67(.a(new_n101_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n89_), .c(new_n76_), .d(new_n70_), .O(new_n116_));
  and2   g70(.a(new_n116_), .b(x16), .O(new_n117_));
  aoi21  g71(.a(new_n117_), .b(new_n114_), .c(new_n113_), .O(z15));
  inv1   g72(.a(x26), .O(new_n119_));
  inv1   g73(.a(new_n81_), .O(new_n120_));
  nand2  g74(.a(new_n115_), .b(new_n89_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n120_), .c(new_n119_), .O(new_n123_));
  aoi21  g77(.a(new_n116_), .b(x26), .c(new_n47_), .O(new_n124_));
  nand2  g78(.a(x18), .b(x07), .O(new_n125_));
  nand2  g79(.a(new_n59_), .b(x15), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n125_), .c(new_n61_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi21  g82(.a(new_n124_), .b(new_n123_), .c(new_n128_), .O(z16));
  nand2  g83(.a(x27), .b(x17), .O(new_n130_));
  nand4  g84(.a(new_n122_), .b(new_n76_), .c(new_n65_), .d(new_n119_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n130_), .c(new_n47_), .O(z17));
endmodule
