...
module FAU ( 
  ...
  nand2  g16(.a(new_n47_), .b(x08), .O(new_n63_));
  ...
  inv1   g24(.a(new_n63_), .O(new_n71_));
  ...
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(new_n76_));
  oai21  g30(.a(new_n70_), .b(new_n58_), .c(new_n76_), .O(z10));
  inv1   g31(.a(x21), .O(new_n78_));
  aoi21  g32(.a(new_n69_), .b(new_n68_), .c(new_n78_), .O(new_n79_));
  nor2   g33(.a(x21), .b(x20), .O(new_n80_));
  nand2  g34(.a(new_n80_), .b(new_n69_), .O(new_n81_));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n83_), .c(new_n71_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n80_), .b(new_n69_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n80_), .b(new_n69_), .c(new_n88_), .O(new_n90_));
  ...
  aoi21  g49(.a(new_n95_), .b(new_n92_), .c(new_n71_), .O(z12));
  nand2  g50(.a(new_n90_), .b(x23), .O(new_n97_));
  nor2   g51(.a(x23), .b(x22), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n69_), .O(new_n99_));
  ...
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n71_), .O(z13));
  ...
  nand4  g68(.a(new_n114_), .b(new_n98_), .c(new_n80_), .d(new_n69_), .O(new_n115_));
  ...
  aoi21  g75(.a(new_n121_), .b(new_n119_), .c(new_n71_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n117_), .O(z15));
  nand2  g77(.a(new_n115_), .b(x26), .O(new_n124_));
  nor3   g78(.a(x26), .b(x23), .c(x22), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n114_), .c(new_n80_), .d(new_n69_), .O(new_n126_));
  ...
  aoi21  g86(.a(new_n132_), .b(new_n130_), .c(new_n71_), .O(new_n133_));
  ...
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n47_), .d(new_n135_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n63_), .O(z17));
endmodule
