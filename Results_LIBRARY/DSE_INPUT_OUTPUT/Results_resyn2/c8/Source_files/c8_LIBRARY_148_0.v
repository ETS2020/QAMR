...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n55_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  aoi22  g04(.a(new_n48_), .b(x21), .c(x27), .d(x10), .O(z02));
  aoi22  g05(.a(new_n48_), .b(x22), .c(x27), .d(x11), .O(z03));
  aoi22  g06(.a(new_n48_), .b(x23), .c(x27), .d(x12), .O(z04));
  aoi22  g07(.a(new_n48_), .b(x24), .c(x27), .d(x13), .O(z05));
  inv1   g08(.a(x27), .O(new_n55_));
  inv1   g09(.a(new_n48_), .O(z08));
  oai22  g10(.a(z08), .b(x25), .c(new_n55_), .d(x14), .O(z06));
  aoi22  g11(.a(new_n48_), .b(x26), .c(x27), .d(x15), .O(z07));
  nor2   g12(.a(x27), .b(x02), .O(new_n59_));
  ...
  nor2   g35(.a(new_n81_), .b(new_n65_), .O(new_n82_));
  inv1   g36(.a(new_n59_), .O(new_n83_));
  aoi21  g37(.a(new_n60_), .b(x10), .c(x16), .O(new_n84_));
  oai21  g38(.a(new_n60_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  aoi21  g40(.a(new_n82_), .b(new_n78_), .c(new_n86_), .O(z11));
  inv1   g41(.a(x22), .O(new_n88_));
  aoi21  g42(.a(new_n79_), .b(new_n69_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n79_), .b(new_n69_), .c(new_n88_), .O(new_n90_));
  ...
  nand4  g58(.a(new_n79_), .b(new_n69_), .c(new_n104_), .d(new_n88_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x23), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n79_), .c(new_n69_), .d(new_n88_), .O(new_n108_));
  ...
  nand4  g82(.a(new_n117_), .b(new_n107_), .c(new_n79_), .d(new_n69_), .O(new_n129_));
  ...
  nand4  g89(.a(new_n79_), .b(new_n128_), .c(x19), .d(new_n64_), .O(new_n136_));
  oai22  g90(.a(new_n136_), .b(new_n118_), .c(new_n55_), .d(new_n64_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n83_), .O(z17));
endmodule
