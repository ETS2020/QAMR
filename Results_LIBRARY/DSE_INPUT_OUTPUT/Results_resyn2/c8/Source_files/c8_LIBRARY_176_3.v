...
module FAU ( 
  ...
  aoi21  g42(.a(new_n80_), .b(new_n65_), .c(new_n88_), .O(new_n89_));
  nand3  g43(.a(new_n80_), .b(new_n65_), .c(new_n88_), .O(new_n90_));
  ...
  aoi21  g49(.a(new_n95_), .b(new_n92_), .c(new_n76_), .O(z12));
  ...
  aoi21  g59(.a(new_n105_), .b(new_n103_), .c(new_n76_), .O(new_n106_));
  ...
  aoi21  g66(.a(new_n112_), .b(new_n110_), .c(new_n76_), .O(new_n113_));
  ...
  aoi21  g85(.a(new_n131_), .b(new_n129_), .c(new_n76_), .O(new_n132_));
