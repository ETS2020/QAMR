...
module FAU ( 
  ...
  aoi21  g024(.a(new_n52_), .b(new_n65_), .c(x18), .O(new_n76_));
  oai21  g025(.a(new_n75_), .b(new_n52_), .c(new_n76_), .O(z03));
  inv1   g026(.a(x22), .O(new_n78_));
  nand3  g027(.a(new_n69_), .b(new_n58_), .c(new_n78_), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(x23), .O(new_n80_));
  nor2   g029(.a(x23), .b(x22), .O(new_n81_));
  nand3  g030(.a(new_n81_), .b(new_n69_), .c(new_n58_), .O(new_n82_));
  ...
  nand4  g043(.a(new_n94_), .b(new_n81_), .c(new_n69_), .d(new_n58_), .O(new_n95_));
  ...
  nand2  g059(.a(new_n110_), .b(new_n66_), .O(z08));
  ...
  nand2  g077(.a(new_n128_), .b(new_n66_), .O(z10));
  ...
  nand4  g081(.a(new_n132_), .b(new_n81_), .c(new_n69_), .d(new_n58_), .O(new_n133_));
  ...
  nand2  g087(.a(new_n138_), .b(new_n66_), .O(z11));
  ...
  nand2  g096(.a(new_n147_), .b(new_n66_), .O(z12));
  ...
  oai21  g108(.a(new_n159_), .b(new_n157_), .c(new_n66_), .O(z13));
  ...
  nand2  g118(.a(new_n169_), .b(new_n66_), .O(z14));
