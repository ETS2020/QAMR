...
module FAU ( 
  ...
  nand4  g056(.a(new_n107_), .b(new_n95_), .c(new_n94_), .d(new_n79_), .O(new_n108_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n97_), .d(new_n65_), .O(new_n167_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n161_), .c(new_n124_), .d(new_n107_), .O(new_n174_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n173_), .c(new_n161_), .d(new_n124_), .O(new_n201_));
