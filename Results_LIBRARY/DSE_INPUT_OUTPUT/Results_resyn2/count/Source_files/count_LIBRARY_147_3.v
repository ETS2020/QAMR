...
module FAU ( 
  ...
  nand4  g054(.a(new_n105_), .b(new_n93_), .c(new_n92_), .d(new_n76_), .O(new_n106_));
  inv1   g055(.a(new_n106_), .O(new_n107_));
  aoi22  g056(.a(new_n107_), .b(new_n71_), .c(new_n104_), .d(x25), .O(new_n108_));
  nor2   g057(.a(x18), .b(new_n58_), .O(new_n109_));
  inv1   g058(.a(new_n109_), .O(new_n110_));
  oai21  g059(.a(new_n110_), .b(new_n108_), .c(new_n101_), .O(z06));
  inv1   g060(.a(x08), .O(new_n112_));
  oai21  g061(.a(x18), .b(new_n112_), .c(new_n58_), .O(new_n113_));
  nor2   g062(.a(x25), .b(x24), .O(new_n114_));
  nand4  g063(.a(new_n114_), .b(new_n85_), .c(new_n78_), .d(new_n55_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(x26), .O(new_n116_));
  nor3   g065(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n87_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n109_), .O(new_n120_));
  ...
  nor2   g074(.a(new_n125_), .b(new_n104_), .O(new_n126_));
  aoi21  g075(.a(new_n118_), .b(x27), .c(new_n126_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n110_), .c(new_n123_), .O(z08));
  inv1   g077(.a(x06), .O(new_n129_));
  oai21  g078(.a(x18), .b(new_n129_), .c(new_n58_), .O(new_n130_));
  nor3   g079(.a(x27), .b(x26), .c(x25), .O(new_n131_));
  nand3  g080(.a(new_n131_), .b(new_n95_), .c(new_n63_), .O(new_n132_));
  nor2   g081(.a(x26), .b(x25), .O(new_n133_));
  nor2   g082(.a(x28), .b(x27), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n102_), .O(new_n135_));
  nor2   g084(.a(new_n135_), .b(new_n79_), .O(new_n136_));
  aoi21  g085(.a(new_n132_), .b(x28), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n110_), .c(new_n130_), .O(z09));
  inv1   g087(.a(x05), .O(new_n139_));
  oai21  g088(.a(x18), .b(new_n139_), .c(new_n58_), .O(new_n140_));
  oai21  g089(.a(new_n135_), .b(new_n79_), .c(x29), .O(new_n141_));
  nor3   g090(.a(x29), .b(x28), .c(x27), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n117_), .c(new_n87_), .O(new_n143_));
  ...
  nand4  g098(.a(new_n134_), .b(new_n133_), .c(new_n149_), .d(new_n93_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n86_), .c(x30), .O(new_n151_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n117_), .c(new_n87_), .O(new_n157_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n134_), .c(new_n133_), .d(new_n93_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n86_), .c(x31), .O(new_n165_));
  inv1   g114(.a(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n154_), .c(new_n149_), .d(new_n153_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n95_), .d(new_n63_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n109_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n162_), .O(z12));
  nor2   g121(.a(x31), .b(x28), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n163_), .c(new_n124_), .d(new_n105_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n104_), .c(x32), .O(new_n175_));
  inv1   g124(.a(x26), .O(new_n176_));
  inv1   g125(.a(x32), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n166_), .c(new_n176_), .d(new_n105_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n156_), .c(new_n95_), .d(new_n63_), .O(new_n180_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n163_), .c(new_n134_), .d(new_n133_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n104_), .c(x33), .O(new_n190_));
  inv1   g139(.a(x33), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n177_), .c(new_n152_), .d(new_n176_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n168_), .c(new_n107_), .d(new_n71_), .O(new_n194_));
  ...
  oai21  g147(.a(x18), .b(new_n198_), .c(new_n58_), .O(new_n199_));
  inv1   g148(.a(x34), .O(new_n200_));
  nor2   g149(.a(new_n194_), .b(new_n200_), .O(new_n201_));
  nor2   g150(.a(x33), .b(x32), .O(new_n202_));
  nand4  g151(.a(new_n202_), .b(new_n173_), .c(new_n163_), .d(new_n124_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n115_), .c(new_n200_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n109_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n201_), .c(new_n199_), .O(z15));
endmodule
