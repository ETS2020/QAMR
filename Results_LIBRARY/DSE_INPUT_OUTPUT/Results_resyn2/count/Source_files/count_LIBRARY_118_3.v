...
module FAU ( 
  ...
  nand3  g028(.a(new_n79_), .b(new_n55_), .c(new_n77_), .O(new_n80_));
  ...
  nand3  g035(.a(new_n86_), .b(new_n79_), .c(new_n55_), .O(new_n87_));
  ...
  nand4  g043(.a(new_n94_), .b(new_n93_), .c(new_n77_), .d(new_n70_), .O(new_n95_));
  inv1   g044(.a(new_n95_), .O(new_n96_));
  aoi22  g045(.a(new_n96_), .b(new_n65_), .c(new_n87_), .d(x24), .O(new_n97_));
  ...
  inv1   g049(.a(new_n66_), .O(new_n101_));
  ...
  nand4  g056(.a(new_n107_), .b(new_n94_), .c(new_n93_), .d(new_n77_), .O(new_n108_));
  inv1   g057(.a(new_n108_), .O(new_n109_));
  aoi22  g058(.a(new_n109_), .b(new_n72_), .c(new_n106_), .d(x25), .O(new_n110_));
  oai21  g059(.a(new_n110_), .b(new_n101_), .c(new_n103_), .O(z06));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n86_), .c(new_n79_), .d(new_n55_), .O(new_n113_));
  ...
  nor2   g084(.a(new_n135_), .b(new_n80_), .O(new_n136_));
  aoi21  g085(.a(new_n132_), .b(x28), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n101_), .c(new_n130_), .O(z09));
  ...
  nand4  g096(.a(new_n134_), .b(new_n133_), .c(new_n147_), .d(new_n94_), .O(new_n148_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n134_), .c(new_n133_), .d(new_n94_), .O(new_n164_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n96_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n96_), .d(new_n65_), .O(new_n182_));
