...
module FAU ( 
  ...
  aoi21  g011(.a(new_n56_), .b(x14), .c(x09), .O(new_n63_));
  ...
  aoi21  g024(.a(new_n56_), .b(x12), .c(x09), .O(new_n76_));
  ...
  aoi21  g031(.a(new_n56_), .b(x11), .c(x09), .O(new_n83_));
  ...
  aoi21  g038(.a(new_n56_), .b(x10), .c(x09), .O(new_n90_));
  ...
  nand4  g047(.a(new_n98_), .b(new_n95_), .c(new_n94_), .d(x16), .O(z06));
  ...
  aoi21  g055(.a(new_n56_), .b(x08), .c(x09), .O(new_n107_));
  ...
  aoi21  g063(.a(new_n56_), .b(x07), .c(x09), .O(new_n115_));
  ...
  aoi21  g070(.a(new_n56_), .b(x06), .c(x09), .O(new_n122_));
  ...
  nor2   g087(.a(new_n138_), .b(new_n97_), .O(new_n139_));
  ...
  aoi21  g098(.a(new_n56_), .b(x03), .c(x09), .O(new_n150_));
  ...
  inv1   g108(.a(new_n94_), .O(new_n160_));
  ...
  oai21  g114(.a(new_n154_), .b(new_n88_), .c(x33), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n165_), .c(x16), .O(new_n167_));
  aoi21  g116(.a(new_n56_), .b(x01), .c(x09), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n52_), .O(z14));
  nand3  g119(.a(new_n164_), .b(new_n160_), .c(x34), .O(new_n171_));
