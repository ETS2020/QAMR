...
module FAU ( 
  ...
  aoi21  g022(.a(new_n69_), .b(x22), .c(new_n56_), .O(new_n74_));
  oai21  g023(.a(new_n69_), .b(x22), .c(new_n74_), .O(new_n75_));
  aoi21  g024(.a(new_n56_), .b(x12), .c(x18), .O(new_n76_));
  ...
  aoi21  g031(.a(new_n56_), .b(x11), .c(x18), .O(new_n83_));
  ...
  nand4  g036(.a(new_n87_), .b(new_n80_), .c(new_n53_), .d(new_n61_), .O(new_n88_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n80_), .c(new_n68_), .d(new_n53_), .O(new_n94_));
  ...
  oai21  g062(.a(new_n113_), .b(new_n88_), .c(x16), .O(new_n114_));
  ...
  oai21  g068(.a(new_n113_), .b(new_n88_), .c(x28), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n119_), .c(x16), .O(new_n121_));
  aoi21  g070(.a(new_n56_), .b(x06), .c(x18), .O(new_n122_));
  ...
  nor3   g075(.a(new_n126_), .b(new_n103_), .c(new_n81_), .O(new_n127_));
  ...
  oai21  g089(.a(new_n135_), .b(new_n81_), .c(x31), .O(new_n141_));
  nand2  g090(.a(new_n87_), .b(new_n80_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n112_), .c(new_n143_), .d(new_n60_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n141_), .c(x16), .O(new_n149_));
  aoi21  g098(.a(new_n56_), .b(x03), .c(x18), .O(new_n150_));
  ...
  oai21  g107(.a(new_n156_), .b(new_n56_), .c(new_n158_), .O(z13));
  ...
  oai21  g113(.a(new_n154_), .b(new_n88_), .c(x33), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n164_), .c(x16), .O(new_n166_));
  aoi21  g115(.a(new_n56_), .b(x01), .c(x18), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n52_), .O(z14));
  nand3  g118(.a(new_n163_), .b(new_n95_), .c(x34), .O(new_n170_));
