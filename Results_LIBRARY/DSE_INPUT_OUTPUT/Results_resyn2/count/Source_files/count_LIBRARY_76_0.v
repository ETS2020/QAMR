...
module FAU ( 
  ...
  nand2  g19(.a(new_n66_), .b(x16), .O(new_n71_));
  inv1   g20(.a(x13), .O(new_n72_));
  nand2  g21(.a(new_n58_), .b(new_n72_), .O(new_n73_));
  nand3  g22(.a(new_n73_), .b(new_n71_), .c(new_n61_), .O(z02));
  nand2  g23(.a(x22), .b(x16), .O(new_n75_));
  inv1   g24(.a(x12), .O(new_n76_));
  nand2  g25(.a(new_n58_), .b(new_n76_), .O(new_n77_));
  nand3  g26(.a(new_n77_), .b(new_n75_), .c(new_n61_), .O(z03));
  nand2  g27(.a(x23), .b(x16), .O(new_n79_));
  inv1   g28(.a(x11), .O(new_n80_));
  nand2  g29(.a(new_n58_), .b(new_n80_), .O(new_n81_));
  nand3  g30(.a(new_n81_), .b(new_n79_), .c(new_n61_), .O(z04));
  nand2  g31(.a(new_n58_), .b(x10), .O(new_n83_));
  inv1   g32(.a(x24), .O(new_n84_));
  nand2  g33(.a(new_n84_), .b(x16), .O(new_n85_));
  nand3  g34(.a(new_n85_), .b(new_n83_), .c(x21), .O(new_n86_));
  nand2  g35(.a(new_n86_), .b(new_n63_), .O(z05));
  nand2  g36(.a(x25), .b(x16), .O(new_n88_));
  inv1   g37(.a(x09), .O(new_n89_));
  nand2  g38(.a(new_n58_), .b(new_n89_), .O(new_n90_));
  nand3  g39(.a(new_n90_), .b(new_n88_), .c(new_n61_), .O(z06));
  nand2  g40(.a(x26), .b(x16), .O(new_n92_));
  inv1   g41(.a(x08), .O(new_n93_));
  nand2  g42(.a(new_n58_), .b(new_n93_), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n92_), .c(new_n61_), .O(z07));
  nand2  g44(.a(new_n58_), .b(x07), .O(new_n96_));
  inv1   g45(.a(x27), .O(new_n97_));
  nand2  g46(.a(new_n97_), .b(x16), .O(new_n98_));
  nand3  g47(.a(new_n98_), .b(new_n96_), .c(x21), .O(new_n99_));
