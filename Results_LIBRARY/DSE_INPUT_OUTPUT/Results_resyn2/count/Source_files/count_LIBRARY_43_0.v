...
module FAU ( 
  ...
  nand3  g10(.a(new_n61_), .b(new_n59_), .c(x17), .O(new_n62_));
  ...
  nand3  g25(.a(new_n76_), .b(new_n74_), .c(x17), .O(new_n77_));
  ...
  nand2  g41(.a(new_n53_), .b(new_n92_), .O(new_n93_));
  nand3  g42(.a(new_n93_), .b(new_n91_), .c(new_n66_), .O(z08));
  nand2  g43(.a(new_n53_), .b(x06), .O(new_n95_));
  inv1   g44(.a(x28), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(x16), .O(new_n97_));
  nand3  g46(.a(new_n97_), .b(new_n95_), .c(x17), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(new_n52_), .O(z09));
  nand2  g48(.a(x29), .b(x16), .O(new_n100_));
  inv1   g49(.a(x05), .O(new_n101_));
  nand2  g50(.a(new_n53_), .b(new_n101_), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n100_), .c(new_n66_), .O(z10));
  nand2  g52(.a(x30), .b(x16), .O(new_n104_));
  inv1   g53(.a(x04), .O(new_n105_));
  nand2  g54(.a(new_n53_), .b(new_n105_), .O(new_n106_));
  nand3  g55(.a(new_n106_), .b(new_n104_), .c(new_n66_), .O(z11));
  nand2  g56(.a(x31), .b(x16), .O(new_n108_));
  inv1   g57(.a(x03), .O(new_n109_));
  nand2  g58(.a(new_n53_), .b(new_n109_), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(new_n66_), .O(z12));
  nand2  g60(.a(new_n53_), .b(x02), .O(new_n112_));
  inv1   g61(.a(x32), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x16), .O(new_n114_));
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(x17), .O(new_n115_));
  nand2  g64(.a(new_n115_), .b(new_n52_), .O(z13));
  nand2  g65(.a(x33), .b(x16), .O(new_n117_));
  inv1   g66(.a(x01), .O(new_n118_));
  nand2  g67(.a(new_n53_), .b(new_n118_), .O(new_n119_));
  nand3  g68(.a(new_n119_), .b(new_n117_), .c(new_n66_), .O(z14));
  nand2  g69(.a(new_n53_), .b(x00), .O(new_n121_));
  inv1   g70(.a(x34), .O(new_n122_));
  nand2  g71(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g72(.a(new_n123_), .b(new_n121_), .c(x17), .O(new_n124_));
  nand2  g73(.a(new_n124_), .b(new_n52_), .O(z15));
endmodule
