...
module FAU ( 
  ...
  nand2  g022(.a(new_n68_), .b(new_n73_), .O(new_n74_));
  aoi21  g023(.a(new_n67_), .b(x22), .c(new_n52_), .O(new_n75_));
  ...
  nand4  g036(.a(new_n80_), .b(new_n66_), .c(new_n59_), .d(new_n87_), .O(new_n88_));
  nand2  g037(.a(new_n81_), .b(x24), .O(new_n89_));
  ...
  nand3  g049(.a(new_n82_), .b(new_n100_), .c(new_n87_), .O(new_n101_));
  inv1   g050(.a(x26), .O(new_n102_));
  nand3  g051(.a(new_n102_), .b(new_n100_), .c(new_n87_), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n81_), .O(new_n104_));
  aoi21  g053(.a(new_n101_), .b(x26), .c(new_n104_), .O(new_n105_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n80_), .c(new_n66_), .d(new_n59_), .O(new_n110_));
  xor2a  g059(.a(new_n110_), .b(x27), .O(new_n111_));
  ...
  nand2  g064(.a(new_n104_), .b(new_n115_), .O(new_n116_));
  nor2   g065(.a(x28), .b(x27), .O(new_n117_));
  aoi22  g066(.a(new_n117_), .b(new_n104_), .c(new_n116_), .d(x28), .O(new_n118_));
  ...
  nand3  g076(.a(new_n117_), .b(new_n104_), .c(new_n127_), .O(new_n128_));
  nor2   g077(.a(x30), .b(x29), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n117_), .O(new_n130_));
  oai21  g079(.a(new_n130_), .b(new_n110_), .c(x16), .O(new_n131_));
  aoi21  g080(.a(new_n128_), .b(x30), .c(new_n131_), .O(new_n132_));
  inv1   g081(.a(x04), .O(new_n133_));
  inv1   g082(.a(x18), .O(new_n134_));
  oai21  g083(.a(x16), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n132_), .c(new_n57_), .O(z11));
  nor2   g085(.a(x31), .b(x28), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n129_), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n104_), .c(new_n115_), .O(new_n140_));
  oai21  g089(.a(new_n130_), .b(new_n110_), .c(x31), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n140_), .c(x16), .O(new_n142_));
  aoi21  g091(.a(new_n52_), .b(x03), .c(x18), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n57_), .O(z12));
  nor3   g094(.a(new_n130_), .b(new_n103_), .c(new_n81_), .O(new_n146_));
  nor2   g095(.a(x32), .b(x31), .O(new_n147_));
  aoi22  g096(.a(new_n147_), .b(new_n146_), .c(new_n140_), .d(x32), .O(new_n148_));
  ...
  inv1   g100(.a(new_n130_), .O(new_n152_));
  nand3  g101(.a(new_n147_), .b(new_n152_), .c(new_n104_), .O(new_n153_));
  nor2   g102(.a(x27), .b(x26), .O(new_n154_));
  nor2   g103(.a(x33), .b(x32), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n137_), .d(new_n129_), .O(new_n156_));
  nor3   g105(.a(new_n156_), .b(new_n88_), .c(x25), .O(new_n157_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n101_), .c(new_n163_), .O(new_n164_));
