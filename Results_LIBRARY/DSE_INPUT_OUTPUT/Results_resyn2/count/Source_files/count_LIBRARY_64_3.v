...
module FAU ( 
  ...
  aoi22  g048(.a(new_n99_), .b(new_n65_), .c(new_n88_), .d(x24), .O(new_n100_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n87_), .c(new_n80_), .d(new_n55_), .O(new_n115_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n168_), .c(new_n109_), .d(new_n75_), .O(new_n194_));
