...
module FAU ( 
  ...
  oai21  g033(.a(new_n62_), .b(x11), .c(new_n84_), .O(z04));
  ...
  oai22  g039(.a(new_n90_), .b(new_n58_), .c(new_n62_), .d(x10), .O(z05));
  ...
  oai22  g044(.a(new_n95_), .b(new_n58_), .c(new_n62_), .d(x09), .O(z06));
  ...
  nand2  g052(.a(new_n100_), .b(new_n99_), .O(new_n104_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n113_), .c(new_n105_), .O(new_n114_));
  oai22  g063(.a(new_n114_), .b(new_n88_), .c(new_n108_), .d(new_n113_), .O(new_n115_));
  ...
  nand4  g071(.a(new_n105_), .b(new_n86_), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  nor3   g073(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n124_), .c(new_n80_), .d(new_n99_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n120_), .c(new_n70_), .O(new_n127_));
  ...
  aoi22  g085(.a(new_n136_), .b(new_n98_), .c(new_n126_), .d(x30), .O(new_n137_));
  ...
  nand3  g089(.a(new_n136_), .b(new_n100_), .c(new_n99_), .O(new_n141_));
  nor2   g090(.a(x31), .b(x30), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n134_), .c(new_n106_), .d(new_n105_), .O(new_n143_));
  ...
  oai21  g097(.a(new_n143_), .b(new_n88_), .c(x32), .O(new_n149_));
  inv1   g098(.a(new_n88_), .O(new_n150_));
  nor2   g099(.a(x32), .b(x31), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n99_), .c(new_n105_), .O(new_n152_));
  inv1   g101(.a(new_n152_), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n136_), .c(new_n150_), .O(new_n154_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n142_), .c(new_n134_), .d(new_n106_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n163_), .b(new_n58_), .c(new_n165_), .O(z14));
  inv1   g115(.a(x00), .O(new_n167_));
  nand2  g116(.a(new_n61_), .b(new_n167_), .O(new_n168_));
