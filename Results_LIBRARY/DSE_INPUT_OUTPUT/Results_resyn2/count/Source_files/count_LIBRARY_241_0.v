...
module FAU ( 
  ...
  nand2  g014(.a(new_n52_), .b(x10), .O(new_n66_));
  ...
  nand3  g057(.a(new_n108_), .b(new_n103_), .c(x16), .O(new_n109_));
  aoi21  g058(.a(new_n57_), .b(x08), .c(new_n56_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(new_n52_), .O(z07));
  inv1   g061(.a(x27), .O(new_n113_));
  nor2   g062(.a(new_n107_), .b(new_n113_), .O(new_n114_));
  nor3   g063(.a(x27), .b(x26), .c(x25), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n90_), .c(new_n83_), .d(new_n63_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(x16), .O(new_n117_));
  aoi21  g066(.a(new_n57_), .b(x07), .c(new_n56_), .O(new_n118_));
  ...
  nand2  g089(.a(new_n140_), .b(new_n121_), .O(new_n141_));
  inv1   g090(.a(new_n141_), .O(new_n142_));
  aoi22  g091(.a(new_n142_), .b(new_n107_), .c(new_n134_), .d(x30), .O(new_n143_));
  ...
  aoi21  g096(.a(new_n142_), .b(new_n107_), .c(new_n147_), .O(new_n148_));
  inv1   g097(.a(x28), .O(new_n149_));
  nand3  g098(.a(new_n140_), .b(new_n147_), .c(new_n149_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n116_), .c(x16), .O(new_n151_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n115_), .c(new_n92_), .d(new_n63_), .O(new_n156_));
  nor2   g105(.a(x32), .b(x31), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n140_), .c(new_n121_), .d(new_n105_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n97_), .c(x16), .O(new_n159_));
  aoi21  g108(.a(new_n156_), .b(x32), .c(new_n159_), .O(new_n160_));
  inv1   g109(.a(x02), .O(new_n161_));
  oai21  g110(.a(x16), .b(new_n161_), .c(x10), .O(new_n162_));
  ...
  oai21  g118(.a(new_n158_), .b(new_n97_), .c(x33), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n169_), .c(x16), .O(new_n171_));
  aoi21  g120(.a(new_n57_), .b(x01), .c(new_n56_), .O(new_n172_));
