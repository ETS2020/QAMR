...
module FAU ( 
  ...
  aoi21  g011(.a(new_n56_), .b(x14), .c(x13), .O(new_n63_));
  ...
  nand2  g019(.a(new_n52_), .b(new_n70_), .O(new_n71_));
  nor3   g020(.a(new_n71_), .b(new_n69_), .c(new_n56_), .O(new_n72_));
  oai21  g021(.a(new_n60_), .b(new_n66_), .c(new_n72_), .O(z02));
  ...
  nand4  g039(.a(new_n90_), .b(new_n82_), .c(new_n53_), .d(new_n61_), .O(new_n91_));
  nand3  g040(.a(new_n91_), .b(new_n89_), .c(x16), .O(new_n92_));
  aoi21  g041(.a(new_n56_), .b(x10), .c(x13), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(new_n52_), .O(z05));
  nor2   g044(.a(x25), .b(x24), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n82_), .c(new_n67_), .d(new_n53_), .O(new_n97_));
  ...
  nand3  g070(.a(new_n121_), .b(new_n120_), .c(new_n111_), .O(new_n122_));
  inv1   g071(.a(x28), .O(new_n123_));
  nand4  g072(.a(new_n82_), .b(new_n67_), .c(new_n53_), .d(new_n123_), .O(new_n124_));
  ...
  oai21  g078(.a(new_n124_), .b(new_n122_), .c(x29), .O(new_n130_));
  inv1   g079(.a(new_n122_), .O(new_n131_));
  nor2   g080(.a(x29), .b(x28), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n131_), .c(new_n84_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(x16), .O(new_n135_));
  nor2   g084(.a(x16), .b(x05), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n71_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n135_), .O(z10));
  nand4  g087(.a(new_n132_), .b(new_n82_), .c(new_n67_), .d(new_n53_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n122_), .c(x30), .O(new_n140_));
  ...
  nand3  g093(.a(new_n144_), .b(new_n141_), .c(new_n84_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n140_), .c(x16), .O(new_n146_));
  aoi21  g095(.a(new_n56_), .b(x04), .c(x13), .O(new_n147_));
  ...
  nand4  g101(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n123_), .O(new_n153_));
  inv1   g102(.a(new_n153_), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n114_), .c(new_n113_), .d(new_n60_), .O(new_n155_));
  nand4  g104(.a(new_n142_), .b(new_n132_), .c(new_n121_), .d(new_n111_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n83_), .c(x31), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n155_), .c(x16), .O(new_n158_));
  aoi21  g107(.a(new_n56_), .b(x03), .c(x13), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n52_), .O(z12));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n142_), .c(new_n132_), .d(new_n121_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n91_), .c(x16), .O(new_n164_));
  aoi21  g113(.a(new_n155_), .b(x32), .c(new_n164_), .O(new_n165_));
  inv1   g114(.a(x02), .O(new_n166_));
  oai21  g115(.a(x16), .b(new_n166_), .c(new_n70_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n165_), .c(new_n52_), .O(z13));
  oai21  g117(.a(new_n163_), .b(new_n91_), .c(x33), .O(new_n169_));
  inv1   g118(.a(x26), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  inv1   g120(.a(x33), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n171_), .c(new_n120_), .d(new_n170_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n153_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n98_), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n169_), .c(x16), .O(new_n176_));
  aoi21  g125(.a(new_n56_), .b(x01), .c(x13), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n52_), .O(z14));
  nand3  g128(.a(new_n174_), .b(new_n98_), .c(x34), .O(new_n180_));
