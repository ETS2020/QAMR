...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n175_;
  nand2  g000(.a(x18), .b(x13), .O(new_n52_));
  ...
  and2   g016(.a(new_n63_), .b(x21), .O(new_n68_));
  ...
  nand4  g038(.a(new_n89_), .b(new_n69_), .c(new_n53_), .d(new_n75_), .O(new_n90_));
  ...
  nand4  g062(.a(new_n69_), .b(new_n53_), .c(new_n113_), .d(new_n75_), .O(new_n114_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n83_), .c(new_n69_), .d(new_n53_), .O(new_n131_));
  ...
  aoi21  g122(.a(new_n56_), .b(x00), .c(x18), .O(new_n174_));
