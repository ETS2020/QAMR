...
module FAU ( 
  ...
  nand2  g19(.a(new_n56_), .b(new_n70_), .O(new_n71_));
  nand3  g20(.a(new_n71_), .b(new_n69_), .c(new_n54_), .O(z03));
  nand2  g21(.a(x23), .b(x16), .O(new_n73_));
  inv1   g22(.a(x11), .O(new_n74_));
  nand2  g23(.a(new_n56_), .b(new_n74_), .O(new_n75_));
  nand3  g24(.a(new_n75_), .b(new_n73_), .c(new_n54_), .O(z04));
  nand2  g25(.a(new_n56_), .b(x10), .O(new_n77_));
  inv1   g26(.a(x24), .O(new_n78_));
  nand2  g27(.a(new_n78_), .b(x16), .O(new_n79_));
  nand3  g28(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n80_));
  nand2  g29(.a(new_n80_), .b(new_n59_), .O(z05));
  nand2  g30(.a(x25), .b(x16), .O(new_n82_));
  inv1   g31(.a(x09), .O(new_n83_));
  nand2  g32(.a(new_n56_), .b(new_n83_), .O(new_n84_));
  nand3  g33(.a(new_n84_), .b(new_n82_), .c(new_n54_), .O(z06));
  nand2  g34(.a(x26), .b(x16), .O(new_n86_));
  inv1   g35(.a(x08), .O(new_n87_));
  nand2  g36(.a(new_n56_), .b(new_n87_), .O(new_n88_));
  nand3  g37(.a(new_n88_), .b(new_n86_), .c(new_n54_), .O(z07));
  nand2  g38(.a(new_n56_), .b(x07), .O(new_n90_));
  inv1   g39(.a(x27), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(x16), .O(new_n92_));
  nand3  g41(.a(new_n92_), .b(new_n90_), .c(x19), .O(new_n93_));
  nand2  g42(.a(new_n93_), .b(new_n59_), .O(z08));
  nand2  g43(.a(new_n56_), .b(x06), .O(new_n95_));
  inv1   g44(.a(x28), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(x16), .O(new_n97_));
  nand3  g46(.a(new_n97_), .b(new_n95_), .c(x19), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(new_n59_), .O(z09));
  ...
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(new_n54_), .O(z13));
  nand2  g64(.a(new_n56_), .b(x01), .O(new_n116_));
  inv1   g65(.a(x33), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(x16), .O(new_n118_));
  nand3  g67(.a(new_n118_), .b(new_n116_), .c(x19), .O(new_n119_));
  nand2  g68(.a(new_n119_), .b(new_n59_), .O(z14));
  ...
  nand2  g73(.a(new_n124_), .b(new_n59_), .O(z15));
endmodule
