...
module FAU ( 
  ...
  nor2   g006(.a(x18), .b(x07), .O(new_n58_));
  ...
  aoi21  g022(.a(new_n56_), .b(x13), .c(x07), .O(new_n74_));
  ...
  aoi22  g026(.a(new_n77_), .b(new_n62_), .c(new_n72_), .d(x22), .O(new_n78_));
  ...
  nand2  g049(.a(new_n100_), .b(new_n68_), .O(z06));
  ...
  nand4  g058(.a(new_n102_), .b(new_n89_), .c(new_n77_), .d(new_n62_), .O(new_n110_));
  ...
  nand3  g063(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(new_n109_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n68_), .O(z08));
  nor2   g066(.a(x28), .b(x27), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n102_), .c(new_n89_), .O(new_n119_));
  oai21  g068(.a(new_n119_), .b(new_n82_), .c(x16), .O(new_n120_));
  aoi21  g069(.a(new_n114_), .b(x28), .c(new_n120_), .O(new_n121_));
  inv1   g070(.a(x06), .O(new_n122_));
  oai21  g071(.a(x16), .b(new_n122_), .c(new_n109_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n121_), .c(new_n68_), .O(z09));
  oai21  g073(.a(new_n119_), .b(new_n82_), .c(x29), .O(new_n125_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n104_), .c(new_n133_), .O(new_n134_));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x29), .b(x28), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n133_), .c(new_n135_), .O(new_n137_));
  nor2   g086(.a(new_n137_), .b(new_n110_), .O(new_n138_));
  ...
  nand3  g094(.a(new_n145_), .b(new_n136_), .c(new_n113_), .O(new_n146_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n143_), .c(new_n102_), .d(new_n112_), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n152_), .c(x16), .O(new_n155_));
  aoi21  g104(.a(new_n56_), .b(x02), .c(x07), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n68_), .O(z13));
  nor2   g107(.a(x27), .b(x26), .O(new_n159_));
  nor2   g108(.a(x33), .b(x32), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n145_), .c(new_n136_), .d(new_n159_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n97_), .O(new_n162_));
  ...
  nor3   g115(.a(new_n161_), .b(new_n97_), .c(x34), .O(new_n167_));
  inv1   g116(.a(x34), .O(new_n168_));
  oai21  g117(.a(new_n162_), .b(new_n168_), .c(x16), .O(new_n169_));
  aoi21  g118(.a(new_n56_), .b(x00), .c(x07), .O(new_n170_));
  oai21  g119(.a(new_n169_), .b(new_n167_), .c(new_n170_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n68_), .O(z15));
endmodule
