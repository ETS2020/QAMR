...
module FAU ( 
  ...
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n100_), .O(new_n135_));
  nor2   g084(.a(new_n135_), .b(new_n79_), .O(new_n136_));
  aoi21  g085(.a(new_n132_), .b(x28), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n128_), .c(new_n130_), .O(z09));
  oai21  g087(.a(new_n135_), .b(new_n79_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n115_), .c(new_n87_), .O(new_n141_));
  ...
  nand2  g107(.a(new_n158_), .b(new_n118_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n148_), .O(z11));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n134_), .c(new_n133_), .d(new_n93_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n95_), .d(new_n63_), .O(new_n167_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n166_), .c(new_n105_), .d(new_n71_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n175_), .c(new_n161_), .d(new_n121_), .O(new_n201_));
