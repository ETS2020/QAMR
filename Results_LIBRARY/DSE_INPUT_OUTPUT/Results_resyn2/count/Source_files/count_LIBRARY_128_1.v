...
module FAU ( 
  ...
  oai21  g022(.a(new_n53_), .b(x13), .c(new_n73_), .O(z02));
  ...
  nand3  g028(.a(new_n70_), .b(new_n56_), .c(new_n77_), .O(new_n80_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n70_), .c(new_n56_), .O(new_n86_));
  nand2  g035(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  aoi21  g036(.a(new_n80_), .b(x23), .c(new_n87_), .O(new_n88_));
  oai22  g037(.a(new_n88_), .b(new_n84_), .c(new_n53_), .d(x11), .O(z04));
  inv1   g038(.a(x23), .O(new_n90_));
  inv1   g039(.a(x24), .O(new_n91_));
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n77_), .d(new_n67_), .O(new_n92_));
  inv1   g041(.a(new_n92_), .O(new_n93_));
  aoi22  g042(.a(new_n93_), .b(new_n68_), .c(new_n86_), .d(x24), .O(new_n94_));
  inv1   g043(.a(x10), .O(new_n95_));
  aoi21  g044(.a(new_n84_), .b(new_n95_), .c(x18), .O(new_n96_));
  oai21  g045(.a(new_n94_), .b(new_n84_), .c(new_n96_), .O(z05));
  nor2   g046(.a(x24), .b(x23), .O(new_n98_));
  nor2   g047(.a(x22), .b(x21), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n56_), .d(new_n61_), .O(new_n100_));
  nor2   g049(.a(x25), .b(x24), .O(new_n101_));
  nand4  g050(.a(new_n101_), .b(new_n85_), .c(new_n70_), .d(new_n56_), .O(new_n102_));
  ...
  oai21  g055(.a(new_n104_), .b(new_n84_), .c(new_n106_), .O(z06));
  nand2  g056(.a(new_n102_), .b(x26), .O(new_n108_));
  inv1   g057(.a(new_n86_), .O(new_n109_));
  ...
  aoi21  g063(.a(new_n84_), .b(new_n114_), .c(x18), .O(new_n115_));
  ...
  aoi21  g069(.a(new_n111_), .b(x27), .c(new_n120_), .O(new_n121_));
  inv1   g070(.a(x07), .O(new_n122_));
  aoi21  g071(.a(new_n84_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g072(.a(new_n121_), .b(new_n84_), .c(new_n123_), .O(z08));
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n93_), .c(new_n68_), .O(new_n126_));
  nor2   g075(.a(x26), .b(x25), .O(new_n127_));
  nor2   g076(.a(x28), .b(x27), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n127_), .c(new_n98_), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n80_), .c(new_n54_), .O(new_n130_));
  aoi21  g079(.a(new_n126_), .b(x28), .c(new_n130_), .O(new_n131_));
  inv1   g080(.a(x06), .O(new_n132_));
  nand2  g081(.a(new_n52_), .b(new_n132_), .O(new_n133_));
  oai21  g082(.a(new_n131_), .b(new_n84_), .c(new_n133_), .O(z09));
  oai21  g083(.a(new_n129_), .b(new_n80_), .c(x29), .O(new_n135_));
  inv1   g084(.a(x29), .O(new_n136_));
  nand4  g085(.a(new_n128_), .b(new_n127_), .c(new_n136_), .d(new_n91_), .O(new_n137_));
  ...
  aoi21  g089(.a(new_n84_), .b(new_n140_), .c(x18), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n139_), .O(z10));
  oai21  g091(.a(new_n137_), .b(new_n86_), .c(x30), .O(new_n143_));
  inv1   g092(.a(x27), .O(new_n144_));
  inv1   g093(.a(x28), .O(new_n145_));
  inv1   g094(.a(x30), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n136_), .c(new_n145_), .d(new_n144_), .O(new_n147_));
  inv1   g096(.a(new_n147_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n110_), .c(new_n109_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n143_), .c(new_n54_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g100(.a(x04), .O(new_n152_));
  nand2  g101(.a(new_n52_), .b(new_n152_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n151_), .O(z11));
  nor2   g103(.a(x30), .b(x29), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n128_), .c(new_n127_), .d(new_n91_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n86_), .c(x31), .O(new_n157_));
  nor2   g106(.a(x31), .b(x28), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  inv1   g108(.a(new_n159_), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n125_), .c(new_n93_), .d(new_n68_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g112(.a(x03), .O(new_n164_));
  aoi21  g113(.a(new_n84_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n163_), .O(z12));
  nand4  g115(.a(new_n158_), .b(new_n155_), .c(new_n118_), .d(new_n117_), .O(new_n167_));
  ...
  nand4  g120(.a(new_n171_), .b(new_n170_), .c(new_n169_), .d(new_n117_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n148_), .c(new_n93_), .d(new_n68_), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n168_), .c(new_n54_), .O(new_n175_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n155_), .c(new_n128_), .d(new_n127_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n100_), .c(x33), .O(new_n182_));
  nand2  g131(.a(new_n101_), .b(new_n85_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n118_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n160_), .c(new_n184_), .d(new_n78_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n182_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(x16), .O(new_n190_));
  inv1   g139(.a(x01), .O(new_n191_));
  aoi21  g140(.a(new_n84_), .b(new_n191_), .c(x18), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(new_n190_), .O(z14));
  inv1   g142(.a(x34), .O(new_n194_));
  nor2   g143(.a(new_n188_), .b(new_n194_), .O(new_n195_));
  nand4  g144(.a(new_n185_), .b(new_n158_), .c(new_n155_), .d(new_n118_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n102_), .c(new_n194_), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(x16), .O(new_n198_));
  inv1   g147(.a(x00), .O(new_n199_));
  aoi21  g148(.a(new_n84_), .b(new_n199_), .c(x18), .O(new_n200_));
