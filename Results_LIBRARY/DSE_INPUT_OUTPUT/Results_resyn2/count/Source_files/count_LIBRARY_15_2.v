...
module FAU ( 
  ...
  aoi21  g022(.a(new_n56_), .b(x13), .c(x12), .O(new_n74_));
  oai21  g023(.a(new_n73_), .b(new_n70_), .c(new_n74_), .O(new_n75_));
  nand2  g024(.a(new_n75_), .b(new_n58_), .O(z02));
  inv1   g025(.a(new_n59_), .O(new_n77_));
  nand2  g026(.a(new_n72_), .b(x22), .O(new_n78_));
  inv1   g027(.a(x22), .O(new_n79_));
  nand3  g028(.a(new_n71_), .b(new_n53_), .c(new_n79_), .O(new_n80_));
  nand4  g029(.a(new_n80_), .b(new_n78_), .c(new_n77_), .d(x16), .O(z03));
  nand2  g030(.a(new_n80_), .b(x23), .O(new_n82_));
  nor2   g031(.a(x23), .b(x22), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n71_), .c(new_n53_), .O(new_n84_));
  aoi21  g033(.a(new_n84_), .b(new_n82_), .c(new_n56_), .O(new_n85_));
  oai21  g034(.a(x16), .b(x11), .c(new_n77_), .O(new_n86_));
  or2    g035(.a(new_n86_), .b(new_n85_), .O(z04));
  nand2  g036(.a(new_n84_), .b(x24), .O(new_n88_));
  nor2   g037(.a(x24), .b(x21), .O(new_n89_));
  nand4  g038(.a(new_n89_), .b(new_n83_), .c(new_n53_), .d(new_n62_), .O(new_n90_));
  nand3  g039(.a(new_n90_), .b(new_n88_), .c(x16), .O(new_n91_));
  aoi21  g040(.a(new_n56_), .b(x10), .c(x12), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n58_), .O(z05));
  nor2   g043(.a(x25), .b(x24), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n83_), .c(new_n71_), .d(new_n53_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n96_), .b(x26), .c(x27), .O(new_n106_));
  nor3   g055(.a(x27), .b(x26), .c(x25), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n89_), .c(new_n83_), .d(new_n64_), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n106_), .c(x16), .O(new_n109_));
  aoi21  g058(.a(new_n56_), .b(x07), .c(x12), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(new_n58_), .O(z08));
  inv1   g061(.a(x23), .O(new_n113_));
  inv1   g062(.a(x26), .O(new_n114_));
  nor2   g063(.a(x28), .b(x27), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n95_), .c(new_n114_), .d(new_n113_), .O(new_n116_));
  ...
  nand2  g070(.a(new_n95_), .b(new_n114_), .O(new_n122_));
  ...
  oai21  g074(.a(new_n116_), .b(new_n80_), .c(x29), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n125_), .c(x16), .O(new_n127_));
  aoi21  g076(.a(new_n56_), .b(x05), .c(x12), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n58_), .O(z10));
  inv1   g079(.a(x30), .O(new_n131_));
  aoi21  g080(.a(new_n124_), .b(new_n123_), .c(new_n131_), .O(new_n132_));
  nor3   g081(.a(x26), .b(x25), .c(x24), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n83_), .c(new_n71_), .d(new_n53_), .O(new_n134_));
  ...
  aoi21  g086(.a(new_n56_), .b(x04), .c(x12), .O(new_n138_));
  oai21  g087(.a(new_n137_), .b(new_n132_), .c(new_n138_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n58_), .O(z11));
  inv1   g089(.a(x31), .O(new_n141_));
  inv1   g090(.a(new_n136_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n123_), .c(new_n141_), .O(new_n143_));
  inv1   g092(.a(x28), .O(new_n144_));
  nand3  g093(.a(new_n135_), .b(new_n141_), .c(new_n144_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n108_), .c(x16), .O(new_n146_));
  aoi21  g095(.a(new_n56_), .b(x03), .c(x12), .O(new_n147_));
  oai21  g096(.a(new_n146_), .b(new_n143_), .c(new_n147_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n58_), .O(z12));
  nand2  g098(.a(new_n89_), .b(new_n83_), .O(new_n150_));
  inv1   g099(.a(new_n150_), .O(new_n151_));
  inv1   g100(.a(new_n145_), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n107_), .c(new_n151_), .d(new_n64_), .O(new_n153_));
  nor2   g102(.a(x26), .b(x25), .O(new_n154_));
  nor2   g103(.a(x32), .b(x31), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n135_), .d(new_n115_), .O(new_n156_));
  ...
  oai21  g108(.a(x16), .b(new_n159_), .c(new_n57_), .O(new_n160_));
  ...
  aoi21  g117(.a(new_n56_), .b(x01), .c(x12), .O(new_n169_));
