...
module FAU ( 
  ...
  nand2  g007(.a(x18), .b(x05), .O(new_n59_));
  ...
  nand2  g037(.a(new_n88_), .b(new_n59_), .O(z04));
  nand2  g038(.a(new_n85_), .b(x24), .O(new_n90_));
  nor2   g039(.a(x24), .b(x21), .O(new_n91_));
  nand4  g040(.a(new_n91_), .b(new_n84_), .c(new_n53_), .d(new_n61_), .O(new_n92_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n84_), .c(new_n68_), .d(new_n53_), .O(new_n98_));
  ...
  nand3  g064(.a(new_n112_), .b(new_n115_), .c(new_n114_), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n92_), .c(x16), .O(new_n117_));
  ...
  oai21  g069(.a(new_n116_), .b(new_n92_), .c(x28), .O(new_n121_));
  inv1   g070(.a(x23), .O(new_n122_));
  nor2   g071(.a(x28), .b(x27), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n106_), .c(new_n78_), .d(new_n122_), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  aoi21  g074(.a(new_n56_), .b(x06), .c(x18), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n59_), .O(z09));
  inv1   g077(.a(x24), .O(new_n129_));
  nor2   g078(.a(x26), .b(x25), .O(new_n130_));
  nand4  g079(.a(new_n123_), .b(new_n130_), .c(new_n129_), .d(new_n122_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n77_), .c(x29), .O(new_n132_));
  inv1   g081(.a(x29), .O(new_n133_));
  nand4  g082(.a(new_n123_), .b(new_n106_), .c(new_n105_), .d(new_n133_), .O(new_n134_));
  ...
  nand2  g086(.a(new_n137_), .b(new_n59_), .O(z10));
  nand4  g087(.a(new_n123_), .b(new_n130_), .c(new_n133_), .d(new_n129_), .O(new_n139_));
  ...
  aoi21  g094(.a(new_n56_), .b(x04), .c(x18), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n59_), .O(z11));
  nor2   g097(.a(new_n116_), .b(new_n92_), .O(new_n149_));
  inv1   g098(.a(x28), .O(new_n150_));
  inv1   g099(.a(x31), .O(new_n151_));
  nand3  g100(.a(new_n141_), .b(new_n151_), .c(new_n150_), .O(new_n152_));
  inv1   g101(.a(new_n152_), .O(new_n153_));
  aoi22  g102(.a(new_n153_), .b(new_n149_), .c(new_n144_), .d(x31), .O(new_n154_));
  ...
  nand2  g106(.a(new_n91_), .b(new_n84_), .O(new_n158_));
  inv1   g107(.a(new_n158_), .O(new_n159_));
  inv1   g108(.a(new_n116_), .O(new_n160_));
  nand4  g109(.a(new_n153_), .b(new_n160_), .c(new_n159_), .d(new_n60_), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n141_), .c(new_n123_), .d(new_n130_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n92_), .c(x16), .O(new_n164_));
  aoi21  g113(.a(new_n161_), .b(x32), .c(new_n164_), .O(new_n165_));
  inv1   g114(.a(x02), .O(new_n166_));
  inv1   g115(.a(x18), .O(new_n167_));
  oai21  g116(.a(x16), .b(new_n166_), .c(new_n167_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n165_), .c(new_n59_), .O(z13));
  nor2   g118(.a(x33), .b(x32), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n112_), .c(new_n115_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n152_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n99_), .O(new_n173_));
  oai21  g122(.a(new_n163_), .b(new_n92_), .c(x33), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n173_), .c(x16), .O(new_n175_));
  aoi21  g124(.a(new_n56_), .b(x01), .c(x18), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n59_), .O(z14));
  nand3  g127(.a(new_n172_), .b(new_n99_), .c(x34), .O(new_n179_));
