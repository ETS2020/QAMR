...
module FAU ( 
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n99_), .d(new_n66_), .O(new_n167_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n99_), .d(new_n66_), .O(new_n182_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n175_), .c(new_n161_), .d(new_n124_), .O(new_n201_));
