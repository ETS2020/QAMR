...
module FAU ( 
  ...
  nand2  g031(.a(new_n72_), .b(x22), .O(new_n83_));
  ...
  nand3  g036(.a(new_n87_), .b(new_n81_), .c(new_n55_), .O(new_n88_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n87_), .c(new_n81_), .d(new_n55_), .O(new_n113_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n97_), .d(new_n63_), .O(new_n169_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n168_), .c(new_n109_), .d(new_n73_), .O(new_n192_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n175_), .c(new_n163_), .d(new_n122_), .O(new_n201_));
