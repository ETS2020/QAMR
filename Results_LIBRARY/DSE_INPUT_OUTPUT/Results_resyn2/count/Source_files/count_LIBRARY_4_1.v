...
module FAU ( 
  ...
  oai21  g030(.a(x16), .b(x11), .c(new_n62_), .O(new_n82_));
  ...
  nand4  g037(.a(new_n79_), .b(new_n67_), .c(new_n60_), .d(new_n88_), .O(new_n89_));
  nor2   g038(.a(x25), .b(x24), .O(new_n90_));
  nand4  g039(.a(new_n90_), .b(new_n79_), .c(new_n67_), .d(new_n60_), .O(new_n91_));
  ...
  nand2  g050(.a(new_n101_), .b(new_n62_), .O(z07));
  ...
  oai21  g057(.a(new_n58_), .b(x07), .c(new_n108_), .O(z08));
  ...
  nand3  g068(.a(new_n119_), .b(new_n117_), .c(new_n62_), .O(new_n120_));
  ...
  nand2  g083(.a(new_n57_), .b(new_n134_), .O(new_n135_));
  ...
  oai21  g087(.a(new_n138_), .b(new_n89_), .c(new_n62_), .O(new_n139_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n145_), .c(new_n130_), .d(new_n103_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n144_), .c(new_n62_), .O(new_n148_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n137_), .c(new_n128_), .d(new_n153_), .O(new_n155_));
  ...
  nand2  g110(.a(new_n57_), .b(new_n161_), .O(new_n162_));
  nor3   g111(.a(new_n155_), .b(new_n91_), .c(x34), .O(new_n163_));
  inv1   g112(.a(x34), .O(new_n164_));
  oai21  g113(.a(new_n156_), .b(new_n164_), .c(new_n62_), .O(new_n165_));
