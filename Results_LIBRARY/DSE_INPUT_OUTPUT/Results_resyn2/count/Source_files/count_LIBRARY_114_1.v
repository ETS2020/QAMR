...
module FAU ( 
  ...
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n75_), .d(new_n66_), .O(new_n92_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n83_), .c(new_n53_), .d(new_n61_), .O(new_n101_));
  ...
  aoi22  g059(.a(new_n110_), .b(new_n107_), .c(new_n99_), .d(x26), .O(new_n111_));
  ...
  oai21  g063(.a(new_n109_), .b(new_n84_), .c(x27), .O(new_n115_));
  nor3   g064(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n93_), .c(new_n60_), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(x16), .O(new_n118_));
  aoi21  g067(.a(new_n56_), .b(x07), .c(x18), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n52_), .O(z08));
  inv1   g070(.a(x27), .O(new_n122_));
  nand3  g071(.a(new_n108_), .b(new_n122_), .c(new_n91_), .O(new_n123_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n133_), .c(new_n108_), .d(new_n91_), .O(new_n151_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n116_), .c(new_n93_), .d(new_n60_), .O(new_n158_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n143_), .c(new_n133_), .d(new_n108_), .O(new_n164_));
  ...
  oai21  g117(.a(new_n166_), .b(new_n56_), .c(new_n168_), .O(z13));
  oai21  g118(.a(new_n164_), .b(new_n101_), .c(x33), .O(new_n170_));
  inv1   g119(.a(new_n99_), .O(new_n171_));
