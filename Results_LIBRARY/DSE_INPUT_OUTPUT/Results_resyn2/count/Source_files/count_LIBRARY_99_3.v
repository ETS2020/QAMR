...
module FAU ( 
  ...
  nand4  g063(.a(new_n114_), .b(new_n87_), .c(new_n82_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g091(.a(new_n142_), .b(new_n117_), .c(new_n89_), .O(new_n143_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n117_), .c(new_n89_), .O(new_n157_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n97_), .d(new_n63_), .O(new_n169_));
