...
module FAU ( 
  ...
  aoi22  g045(.a(new_n96_), .b(new_n66_), .c(new_n87_), .d(x24), .O(new_n97_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n101_), .c(new_n55_), .d(new_n64_), .O(new_n103_));
  ...
  nand3  g089(.a(new_n140_), .b(new_n114_), .c(new_n88_), .O(new_n141_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n134_), .c(new_n133_), .d(new_n94_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n96_), .d(new_n66_), .O(new_n167_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n161_), .c(new_n121_), .d(new_n104_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n103_), .c(x32), .O(new_n177_));
  inv1   g126(.a(x26), .O(new_n178_));
  inv1   g127(.a(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n164_), .c(new_n178_), .d(new_n104_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n96_), .d(new_n66_), .O(new_n182_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n106_), .d(new_n72_), .O(new_n192_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n175_), .c(new_n161_), .d(new_n121_), .O(new_n203_));
