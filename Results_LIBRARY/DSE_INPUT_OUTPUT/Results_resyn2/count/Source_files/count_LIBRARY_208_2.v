...
module FAU ( 
  ...
  nor2   g006(.a(x18), .b(x04), .O(new_n58_));
  ...
  aoi21  g012(.a(new_n56_), .b(x14), .c(x04), .O(new_n64_));
  ...
  nand3  g024(.a(new_n75_), .b(new_n53_), .c(new_n62_), .O(new_n76_));
  nand3  g025(.a(new_n76_), .b(new_n74_), .c(x16), .O(new_n77_));
  aoi21  g026(.a(new_n56_), .b(x12), .c(x04), .O(new_n78_));
  nand2  g027(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(new_n60_), .O(z03));
  or2    g029(.a(new_n76_), .b(x23), .O(new_n81_));
  aoi21  g030(.a(new_n76_), .b(x23), .c(new_n56_), .O(new_n82_));
  nand2  g031(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  aoi21  g032(.a(new_n56_), .b(x11), .c(x04), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(new_n60_), .O(z04));
  nor2   g035(.a(x24), .b(x23), .O(new_n87_));
  nand4  g036(.a(new_n87_), .b(new_n75_), .c(new_n53_), .d(new_n62_), .O(new_n88_));
  ...
  nand3  g050(.a(new_n101_), .b(new_n75_), .c(new_n61_), .O(new_n102_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n101_), .c(new_n75_), .d(new_n61_), .O(new_n112_));
  ...
  nand3  g067(.a(new_n111_), .b(new_n96_), .c(new_n118_), .O(new_n119_));
  nand2  g068(.a(new_n112_), .b(x28), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n119_), .c(x16), .O(new_n121_));
  aoi21  g070(.a(new_n56_), .b(x06), .c(x04), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n60_), .O(z09));
  oai21  g073(.a(new_n112_), .b(x28), .c(x29), .O(new_n125_));
  nor2   g074(.a(x29), .b(x28), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n105_), .c(new_n110_), .O(new_n127_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n134_), .c(new_n110_), .O(new_n135_));
  inv1   g084(.a(new_n135_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n105_), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n133_), .c(new_n58_), .d(x16), .O(z11));
  nor2   g087(.a(x31), .b(x30), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n126_), .c(new_n103_), .d(new_n110_), .O(new_n140_));
  nor2   g089(.a(new_n140_), .b(new_n88_), .O(new_n141_));
  aoi21  g090(.a(new_n137_), .b(x31), .c(new_n141_), .O(new_n142_));
  nor2   g091(.a(x16), .b(x03), .O(new_n143_));
  nor2   g092(.a(new_n143_), .b(new_n69_), .O(new_n144_));
  ...
  aoi21  g100(.a(new_n56_), .b(x02), .c(x04), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n60_), .O(z13));
  inv1   g103(.a(x33), .O(new_n155_));
  aoi21  g104(.a(new_n149_), .b(new_n89_), .c(new_n155_), .O(new_n156_));
  nor2   g105(.a(x33), .b(x32), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n139_), .c(new_n126_), .d(new_n111_), .O(new_n158_));
  ...
  nor2   g110(.a(new_n161_), .b(new_n69_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n160_), .O(z14));
  oai21  g112(.a(new_n158_), .b(new_n102_), .c(x34), .O(new_n164_));
  inv1   g113(.a(x34), .O(new_n165_));
  inv1   g114(.a(new_n158_), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n96_), .c(new_n165_), .O(new_n167_));
