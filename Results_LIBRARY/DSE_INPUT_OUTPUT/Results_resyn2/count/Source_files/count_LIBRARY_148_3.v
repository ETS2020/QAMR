...
module FAU ( 
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n55_), .d(new_n64_), .O(new_n98_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n86_), .c(new_n79_), .d(new_n55_), .O(new_n111_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n113_), .c(new_n88_), .O(new_n157_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n128_), .d(new_n66_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n128_), .d(new_n66_), .O(new_n182_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n175_), .c(new_n163_), .d(new_n120_), .O(new_n201_));
