...
module FAU ( 
  ...
  nand4  g068(.a(new_n119_), .b(new_n118_), .c(new_n75_), .d(new_n117_), .O(new_n120_));
  inv1   g069(.a(new_n120_), .O(new_n121_));
  nor3   g070(.a(x27), .b(x26), .c(x25), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(new_n63_), .O(new_n123_));
  nor2   g072(.a(x26), .b(x25), .O(new_n124_));
  nor2   g073(.a(x28), .b(x27), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n124_), .c(new_n90_), .O(new_n126_));
  oai21  g075(.a(new_n126_), .b(new_n77_), .c(new_n62_), .O(new_n127_));
  aoi21  g076(.a(new_n123_), .b(x28), .c(new_n127_), .O(new_n128_));
  inv1   g077(.a(x06), .O(new_n129_));
  nand2  g078(.a(new_n57_), .b(new_n129_), .O(new_n130_));
  oai21  g079(.a(new_n128_), .b(new_n52_), .c(new_n130_), .O(z09));
  oai21  g080(.a(new_n126_), .b(new_n77_), .c(x29), .O(new_n132_));
  nor3   g081(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n102_), .c(new_n85_), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n132_), .c(new_n62_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(x16), .O(new_n136_));
  inv1   g085(.a(x05), .O(new_n137_));
  nand2  g086(.a(new_n57_), .b(new_n137_), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n136_), .O(z10));
  inv1   g088(.a(x29), .O(new_n140_));
  nand4  g089(.a(new_n125_), .b(new_n124_), .c(new_n140_), .d(new_n119_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n84_), .c(x30), .O(new_n142_));
  inv1   g091(.a(x27), .O(new_n143_));
  inv1   g092(.a(x28), .O(new_n144_));
  inv1   g093(.a(x30), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n140_), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n102_), .c(new_n85_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n142_), .c(new_n62_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n125_), .c(new_n124_), .d(new_n119_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n84_), .c(x31), .O(new_n156_));
  nor2   g105(.a(x31), .b(x28), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  inv1   g107(.a(new_n158_), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n122_), .c(new_n121_), .d(new_n63_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n157_), .b(new_n154_), .c(new_n110_), .d(new_n109_), .O(new_n166_));
  ...
  nand4  g119(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n109_), .O(new_n171_));
  inv1   g120(.a(new_n171_), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n147_), .c(new_n121_), .d(new_n63_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n167_), .c(new_n62_), .O(new_n174_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n125_), .d(new_n124_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n92_), .c(x33), .O(new_n181_));
  nand2  g130(.a(new_n96_), .b(new_n83_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nor2   g132(.a(x33), .b(x32), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n110_), .O(new_n185_));
  inv1   g134(.a(new_n185_), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n159_), .c(new_n183_), .d(new_n70_), .O(new_n187_));
  ...
  nand4  g143(.a(new_n184_), .b(new_n157_), .c(new_n154_), .d(new_n110_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n97_), .c(new_n193_), .O(new_n196_));
