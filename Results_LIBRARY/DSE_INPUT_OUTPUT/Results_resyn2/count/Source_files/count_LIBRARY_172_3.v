...
module FAU ( 
  ...
  nand3  g089(.a(new_n140_), .b(new_n117_), .c(new_n87_), .O(new_n141_));
  ...
  nand4  g096(.a(new_n134_), .b(new_n133_), .c(new_n147_), .d(new_n93_), .O(new_n148_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n117_), .c(new_n87_), .O(new_n155_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n95_), .d(new_n63_), .O(new_n180_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n168_), .c(new_n107_), .d(new_n71_), .O(new_n192_));
