...
module FAU ( 
  ...
  nand3  g030(.a(new_n77_), .b(new_n53_), .c(new_n61_), .O(new_n82_));
  aoi21  g031(.a(new_n82_), .b(x23), .c(new_n56_), .O(new_n83_));
  oai21  g032(.a(new_n82_), .b(x23), .c(new_n83_), .O(new_n84_));
  aoi21  g033(.a(new_n56_), .b(x11), .c(new_n73_), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g035(.a(new_n86_), .b(new_n57_), .O(z04));
  oai21  g036(.a(new_n82_), .b(x23), .c(x24), .O(new_n88_));
  ...
  aoi21  g040(.a(new_n56_), .b(x10), .c(new_n73_), .O(new_n92_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n89_), .c(new_n70_), .d(new_n53_), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n95_), .c(x16), .O(new_n98_));
  aoi21  g047(.a(new_n56_), .b(x09), .c(new_n73_), .O(new_n99_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n89_), .c(new_n77_), .d(new_n63_), .O(new_n110_));
  nor3   g059(.a(x27), .b(x26), .c(x25), .O(new_n111_));
  aoi22  g060(.a(new_n111_), .b(new_n109_), .c(new_n110_), .d(x27), .O(new_n112_));
  nand2  g061(.a(x16), .b(x07), .O(new_n113_));
  oai21  g062(.a(new_n113_), .b(new_n112_), .c(new_n57_), .O(z08));
  nand2  g063(.a(new_n111_), .b(new_n109_), .O(new_n115_));
  nor2   g064(.a(x28), .b(x27), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n102_), .c(new_n89_), .O(new_n117_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n104_), .c(new_n131_), .O(new_n132_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n141_), .c(new_n102_), .d(new_n109_), .O(new_n152_));
  ...
  nor3   g113(.a(new_n159_), .b(new_n97_), .c(x34), .O(new_n165_));
