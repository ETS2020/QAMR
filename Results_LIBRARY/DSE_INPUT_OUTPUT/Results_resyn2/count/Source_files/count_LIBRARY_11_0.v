...
module FAU ( 
  ...
  oai21  g031(.a(x16), .b(new_n82_), .c(x04), .O(new_n83_));
  oai21  g032(.a(new_n83_), .b(new_n81_), .c(new_n59_), .O(z03));
  ...
  nand4  g041(.a(new_n78_), .b(new_n55_), .c(new_n86_), .d(new_n64_), .O(new_n93_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n78_), .c(new_n63_), .d(new_n86_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(x16), .O(new_n110_));
  aoi21  g059(.a(new_n58_), .b(x08), .c(new_n66_), .O(new_n111_));
  ...
  oai21  g074(.a(x16), .b(new_n125_), .c(x04), .O(new_n126_));
  oai21  g075(.a(new_n126_), .b(new_n124_), .c(new_n59_), .O(z09));
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n108_), .c(new_n88_), .O(new_n129_));
  oai21  g078(.a(new_n122_), .b(new_n79_), .c(x29), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n129_), .c(x16), .O(new_n131_));
  aoi21  g080(.a(new_n58_), .b(x05), .c(new_n66_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n59_), .O(z10));
  ...
  aoi21  g088(.a(new_n129_), .b(x30), .c(new_n139_), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n58_), .c(new_n135_), .O(z11));
  ...
  nand4  g099(.a(new_n150_), .b(new_n114_), .c(new_n144_), .d(new_n63_), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n142_), .c(x16), .O(new_n152_));
  aoi21  g101(.a(new_n58_), .b(x03), .c(new_n66_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n59_), .O(z12));
  nor2   g104(.a(x32), .b(x31), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n137_), .c(new_n121_), .d(new_n120_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n106_), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(new_n149_), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n101_), .c(new_n88_), .O(new_n168_));
  oai21  g117(.a(new_n157_), .b(new_n95_), .c(x33), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n168_), .c(x16), .O(new_n170_));
  aoi21  g119(.a(new_n58_), .b(x01), .c(new_n66_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n59_), .O(z14));
  nand4  g122(.a(new_n167_), .b(new_n101_), .c(new_n88_), .d(x34), .O(new_n174_));
