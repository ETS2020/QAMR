...
module FAU ( 
  ...
  aoi21  g006(.a(new_n57_), .b(x15), .c(x00), .O(new_n58_));
  ...
  nand2  g013(.a(new_n52_), .b(new_n64_), .O(new_n65_));
  nor2   g014(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  oai21  g015(.a(new_n62_), .b(new_n57_), .c(new_n66_), .O(z01));
  nand3  g016(.a(new_n61_), .b(new_n55_), .c(new_n54_), .O(new_n68_));
  ...
  aoi21  g034(.a(new_n57_), .b(x11), .c(x00), .O(new_n86_));
  ...
  nand4  g039(.a(new_n90_), .b(new_n83_), .c(new_n53_), .d(new_n61_), .O(new_n91_));
  nand3  g040(.a(new_n91_), .b(new_n89_), .c(x16), .O(new_n92_));
  aoi21  g041(.a(new_n57_), .b(x10), .c(x00), .O(new_n93_));
  ...
  aoi21  g048(.a(new_n57_), .b(x09), .c(x00), .O(new_n100_));
  ...
  aoi21  g069(.a(new_n57_), .b(x07), .c(x00), .O(new_n121_));
  ...
  oai21  g090(.a(new_n139_), .b(new_n57_), .c(new_n141_), .O(z11));
  ...
  aoi21  g112(.a(new_n57_), .b(x02), .c(x00), .O(new_n164_));
  ...
  oai21  g121(.a(new_n170_), .b(new_n57_), .c(new_n172_), .O(z14));
  inv1   g122(.a(x34), .O(new_n174_));
  nand3  g123(.a(new_n52_), .b(x16), .c(new_n64_), .O(new_n175_));
  aoi21  g124(.a(new_n169_), .b(new_n174_), .c(new_n175_), .O(new_n176_));
  oai21  g125(.a(new_n169_), .b(new_n174_), .c(new_n176_), .O(z15));
endmodule
