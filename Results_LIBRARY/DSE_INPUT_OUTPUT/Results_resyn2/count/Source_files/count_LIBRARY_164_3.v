...
module FAU ( 
  ...
  aoi22  g046(.a(new_n97_), .b(new_n65_), .c(new_n88_), .d(x24), .O(new_n98_));
  ...
  nand3  g078(.a(new_n129_), .b(new_n97_), .c(new_n65_), .O(new_n130_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n97_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n97_), .d(new_n65_), .O(new_n182_));
