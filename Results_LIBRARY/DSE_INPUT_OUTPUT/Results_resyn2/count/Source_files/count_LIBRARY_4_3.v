...
module FAU ( 
  ...
  nand3  g078(.a(new_n129_), .b(new_n96_), .c(new_n65_), .O(new_n130_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n114_), .c(new_n88_), .O(new_n157_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n96_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n168_), .c(new_n106_), .d(new_n72_), .O(new_n192_));
