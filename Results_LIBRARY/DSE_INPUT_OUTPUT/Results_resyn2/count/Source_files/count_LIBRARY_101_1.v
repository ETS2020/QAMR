...
module FAU ( 
  ...
  oai21  g031(.a(x16), .b(x11), .c(new_n63_), .O(new_n83_));
  or2    g032(.a(new_n83_), .b(new_n82_), .O(z04));
  ...
  nand2  g052(.a(new_n103_), .b(new_n63_), .O(z07));
  ...
  oai21  g061(.a(new_n107_), .b(new_n91_), .c(x28), .O(new_n113_));
  ...
  oai21  g071(.a(new_n122_), .b(new_n91_), .c(x29), .O(new_n123_));
  inv1   g072(.a(x22), .O(new_n124_));
  inv1   g073(.a(x23), .O(new_n125_));
  inv1   g074(.a(x25), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n89_), .c(new_n125_), .d(new_n124_), .O(new_n127_));
  inv1   g076(.a(new_n127_), .O(new_n128_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n70_), .d(new_n101_), .O(new_n130_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n153_), .c(new_n63_), .O(new_n158_));
