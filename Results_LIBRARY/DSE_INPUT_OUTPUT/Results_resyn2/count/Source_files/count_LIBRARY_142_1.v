...
module FAU ( 
  ...
  oai21  g051(.a(new_n102_), .b(new_n101_), .c(new_n77_), .O(new_n103_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n70_), .d(new_n101_), .O(new_n127_));
  ...
  aoi22  g086(.a(new_n137_), .b(new_n100_), .c(new_n127_), .d(x30), .O(new_n138_));
  ...
  nand3  g090(.a(new_n137_), .b(new_n102_), .c(new_n101_), .O(new_n142_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n101_), .c(new_n107_), .O(new_n153_));
  ...
  oai21  g111(.a(new_n162_), .b(new_n94_), .c(new_n77_), .O(new_n163_));
  aoi21  g112(.a(new_n155_), .b(x33), .c(new_n163_), .O(new_n164_));
  inv1   g113(.a(x01), .O(new_n165_));
  nand2  g114(.a(new_n52_), .b(new_n165_), .O(new_n166_));
