...
module FAU ( 
  ...
  aoi21  g037(.a(new_n88_), .b(x16), .c(new_n87_), .O(new_n89_));
  nand2  g038(.a(new_n81_), .b(x24), .O(new_n90_));
  inv1   g039(.a(x21), .O(new_n91_));
  inv1   g040(.a(x23), .O(new_n92_));
  inv1   g041(.a(x24), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n72_), .d(new_n91_), .O(new_n94_));
  nor2   g043(.a(new_n94_), .b(new_n66_), .O(new_n95_));
  nor3   g044(.a(new_n95_), .b(x18), .c(new_n58_), .O(new_n96_));
  aoi21  g045(.a(new_n96_), .b(new_n90_), .c(new_n89_), .O(z05));
  nand2  g046(.a(x18), .b(new_n87_), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nor2   g048(.a(x22), .b(x21), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n99_), .c(new_n55_), .d(new_n61_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(x25), .O(new_n102_));
  nor2   g051(.a(x25), .b(x24), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n80_), .c(new_n67_), .d(new_n55_), .O(new_n104_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n82_), .c(new_n93_), .O(new_n111_));
  ...
  nand2  g063(.a(new_n114_), .b(new_n98_), .O(z07));
  nand2  g064(.a(new_n110_), .b(new_n93_), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n81_), .c(x27), .O(new_n117_));
  ...
  nand3  g072(.a(new_n123_), .b(new_n117_), .c(x16), .O(new_n124_));
  aoi21  g073(.a(new_n58_), .b(x07), .c(x18), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n98_), .O(z08));
  inv1   g076(.a(x28), .O(new_n128_));
  nand4  g077(.a(new_n110_), .b(new_n99_), .c(new_n128_), .d(new_n120_), .O(new_n129_));
  ...
  oai21  g083(.a(new_n129_), .b(new_n74_), .c(x29), .O(new_n135_));
  inv1   g084(.a(x29), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n128_), .c(new_n93_), .O(new_n137_));
  ...
  aoi21  g089(.a(new_n58_), .b(x05), .c(x18), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n98_), .O(z10));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n110_), .c(new_n120_), .d(new_n93_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n81_), .c(x30), .O(new_n146_));
  inv1   g095(.a(x30), .O(new_n147_));
  nand3  g096(.a(new_n138_), .b(new_n82_), .c(new_n147_), .O(new_n148_));
  ...
  nand2  g100(.a(new_n151_), .b(new_n98_), .O(z11));
  nor2   g101(.a(x31), .b(x30), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n144_), .c(new_n110_), .d(new_n120_), .O(new_n154_));
  nor2   g103(.a(new_n154_), .b(new_n101_), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n147_), .c(new_n136_), .d(new_n128_), .O(new_n162_));
  nor2   g111(.a(new_n162_), .b(new_n121_), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n95_), .c(new_n160_), .O(new_n164_));
  oai21  g113(.a(new_n154_), .b(new_n101_), .c(x32), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n164_), .c(x16), .O(new_n166_));
  aoi21  g115(.a(new_n58_), .b(x02), .c(x18), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n98_), .O(z13));
