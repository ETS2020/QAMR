...
module FAU ( 
  ...
  aoi21  g038(.a(new_n56_), .b(x11), .c(x28), .O(new_n90_));
  ...
  aoi22  g044(.a(new_n95_), .b(new_n62_), .c(new_n88_), .d(x24), .O(new_n96_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n87_), .c(new_n53_), .d(new_n60_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(x25), .O(new_n103_));
  nand3  g052(.a(new_n103_), .b(new_n101_), .c(x16), .O(new_n104_));
  aoi21  g053(.a(new_n56_), .b(x09), .c(x28), .O(new_n105_));
  ...
  nand3  g063(.a(new_n114_), .b(new_n108_), .c(x16), .O(new_n115_));
  aoi21  g064(.a(new_n56_), .b(x08), .c(x28), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n52_), .O(z07));
  inv1   g067(.a(x27), .O(new_n119_));
  nor2   g068(.a(new_n112_), .b(new_n88_), .O(new_n120_));
  nor3   g069(.a(x27), .b(x26), .c(x25), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n93_), .c(new_n87_), .d(new_n62_), .O(new_n122_));
  ...
  nand3  g076(.a(new_n121_), .b(new_n110_), .c(x16), .O(new_n128_));
  nor2   g077(.a(x16), .b(x06), .O(new_n129_));
  nor2   g078(.a(new_n129_), .b(new_n66_), .O(new_n130_));
  oai21  g079(.a(new_n128_), .b(new_n88_), .c(new_n130_), .O(z09));
  inv1   g080(.a(x29), .O(new_n132_));
  nor2   g081(.a(x27), .b(x23), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nor2   g083(.a(new_n134_), .b(new_n112_), .O(new_n135_));
  aoi22  g084(.a(new_n135_), .b(new_n81_), .c(new_n122_), .d(x29), .O(new_n136_));
  ...
  nand2  g088(.a(new_n135_), .b(new_n81_), .O(new_n140_));
  inv1   g089(.a(x26), .O(new_n141_));
  nor2   g090(.a(x30), .b(x29), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n119_), .c(new_n141_), .O(new_n143_));
  ...
  oai21  g097(.a(new_n143_), .b(new_n101_), .c(x31), .O(new_n149_));
  nor2   g098(.a(x31), .b(x27), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n142_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n114_), .c(new_n149_), .O(new_n152_));
  ...
  aoi21  g107(.a(new_n158_), .b(new_n120_), .c(new_n157_), .O(new_n159_));
  nor2   g108(.a(x32), .b(x31), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n142_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n122_), .c(x16), .O(new_n162_));
  aoi21  g111(.a(new_n56_), .b(x02), .c(x28), .O(new_n163_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n121_), .c(new_n95_), .d(new_n62_), .O(new_n167_));
  nor2   g116(.a(x33), .b(x32), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n150_), .c(new_n142_), .d(new_n111_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n102_), .c(x16), .O(new_n170_));
  aoi21  g119(.a(new_n167_), .b(x33), .c(new_n170_), .O(new_n171_));
  inv1   g120(.a(x01), .O(new_n172_));
  oai21  g121(.a(x16), .b(new_n172_), .c(new_n65_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n171_), .c(new_n52_), .O(z14));
  oai21  g123(.a(new_n169_), .b(new_n102_), .c(x34), .O(new_n175_));
  inv1   g124(.a(new_n101_), .O(new_n176_));
  inv1   g125(.a(new_n143_), .O(new_n177_));
  nor2   g126(.a(x34), .b(x33), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n160_), .c(new_n177_), .d(new_n176_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(x16), .O(new_n181_));
  nor2   g130(.a(x16), .b(x00), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n66_), .O(new_n183_));
