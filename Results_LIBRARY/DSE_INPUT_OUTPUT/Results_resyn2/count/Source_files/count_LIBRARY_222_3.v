...
module FAU ( 
  ...
  aoi22  g048(.a(new_n99_), .b(new_n66_), .c(new_n90_), .d(x24), .O(new_n100_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n89_), .c(new_n79_), .d(new_n55_), .O(new_n113_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n99_), .d(new_n66_), .O(new_n180_));
