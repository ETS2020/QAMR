...
module FAU ( 
  ...
  aoi22  g34(.a(new_n85_), .b(new_n73_), .c(new_n81_), .d(x26), .O(new_n86_));
  oai21  g35(.a(new_n86_), .b(new_n54_), .c(new_n58_), .O(z07));
  inv1   g36(.a(new_n70_), .O(new_n88_));
  nand4  g37(.a(new_n85_), .b(new_n71_), .c(new_n63_), .d(new_n52_), .O(new_n89_));
  ...
  aoi22  g42(.a(new_n93_), .b(new_n88_), .c(new_n89_), .d(x27), .O(new_n94_));
  ...
  nand2  g48(.a(new_n99_), .b(new_n88_), .O(new_n100_));
  ...
  nand3  g54(.a(new_n105_), .b(new_n85_), .c(new_n73_), .O(new_n106_));
  ...
  nand3  g65(.a(new_n116_), .b(new_n85_), .c(new_n73_), .O(new_n117_));
  ...
  nand3  g74(.a(new_n125_), .b(new_n93_), .c(new_n88_), .O(new_n126_));
