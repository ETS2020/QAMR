...
module FAU ( 
  ...
  oai21  g025(.a(new_n76_), .b(new_n74_), .c(new_n69_), .O(z02));
  ...
  oai21  g041(.a(new_n92_), .b(new_n76_), .c(new_n88_), .O(z04));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n78_), .d(new_n71_), .O(new_n98_));
  inv1   g047(.a(new_n98_), .O(new_n99_));
  aoi22  g048(.a(new_n99_), .b(new_n63_), .c(new_n90_), .d(x24), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n76_), .c(new_n95_), .O(z05));
  ...
  nand4  g054(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n78_), .O(new_n106_));
  inv1   g055(.a(new_n106_), .O(new_n107_));
  aoi22  g056(.a(new_n107_), .b(new_n73_), .c(new_n104_), .d(x25), .O(new_n108_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n89_), .c(new_n80_), .d(new_n55_), .O(new_n113_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n99_), .c(new_n63_), .O(new_n132_));
  ...
  nor2   g084(.a(new_n135_), .b(new_n81_), .O(new_n136_));
  aoi21  g085(.a(new_n132_), .b(x28), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n76_), .c(new_n130_), .O(z09));
  oai21  g087(.a(new_n135_), .b(new_n81_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n115_), .c(new_n91_), .O(new_n141_));
  ...
  nand4  g096(.a(new_n134_), .b(new_n133_), .c(new_n147_), .d(new_n97_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n90_), .c(x30), .O(new_n149_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n115_), .c(new_n91_), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n134_), .c(new_n133_), .d(new_n97_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n99_), .d(new_n63_), .O(new_n167_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n161_), .c(new_n122_), .d(new_n105_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n104_), .c(x32), .O(new_n177_));
  inv1   g126(.a(x26), .O(new_n178_));
  inv1   g127(.a(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n164_), .c(new_n178_), .d(new_n105_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n99_), .d(new_n63_), .O(new_n182_));
  ...
  nand4  g135(.a(new_n186_), .b(new_n161_), .c(new_n134_), .d(new_n133_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n104_), .c(x33), .O(new_n188_));
  inv1   g137(.a(x33), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n179_), .c(new_n150_), .d(new_n178_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n107_), .d(new_n73_), .O(new_n192_));
  ...
  nor2   g149(.a(new_n192_), .b(new_n200_), .O(new_n201_));
  nor2   g150(.a(x33), .b(x32), .O(new_n202_));
  nand4  g151(.a(new_n202_), .b(new_n175_), .c(new_n161_), .d(new_n122_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n113_), .c(new_n200_), .O(new_n204_));
