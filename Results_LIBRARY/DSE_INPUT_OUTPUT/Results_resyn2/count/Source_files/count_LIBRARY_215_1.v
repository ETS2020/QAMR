...
module FAU ( 
  ...
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n68_), .d(new_n53_), .O(new_n98_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n111_), .c(new_n75_), .d(new_n66_), .O(new_n113_));
  ...
  nand4  g073(.a(new_n83_), .b(new_n68_), .c(new_n53_), .d(new_n124_), .O(new_n125_));
  ...
  nand4  g088(.a(new_n133_), .b(new_n83_), .c(new_n68_), .d(new_n53_), .O(new_n140_));
  ...
  aoi21  g096(.a(new_n56_), .b(x04), .c(x18), .O(new_n148_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n115_), .c(new_n114_), .d(new_n60_), .O(new_n156_));
  ...
  aoi21  g108(.a(new_n56_), .b(x03), .c(x18), .O(new_n160_));
  ...
  oai21  g118(.a(new_n169_), .b(new_n166_), .c(new_n52_), .O(z13));
  ...
  aoi21  g127(.a(new_n56_), .b(x01), .c(x18), .O(new_n179_));
