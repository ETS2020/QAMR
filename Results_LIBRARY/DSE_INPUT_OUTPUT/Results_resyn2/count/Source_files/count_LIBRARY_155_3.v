...
module FAU ( 
  ...
  aoi22  g045(.a(new_n96_), .b(new_n64_), .c(new_n87_), .d(x24), .O(new_n97_));
  ...
  inv1   g049(.a(new_n57_), .O(new_n101_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n104_), .c(new_n55_), .d(new_n65_), .O(new_n106_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n86_), .c(new_n79_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g078(.a(new_n129_), .b(new_n96_), .c(new_n64_), .O(new_n130_));
  ...
  nor2   g082(.a(new_n133_), .b(new_n80_), .O(new_n134_));
  ...
  oai21  g087(.a(new_n133_), .b(new_n80_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n117_), .c(new_n88_), .O(new_n141_));
  ...
  nand4  g096(.a(new_n132_), .b(new_n131_), .c(new_n147_), .d(new_n94_), .O(new_n148_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n117_), .c(new_n88_), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n132_), .c(new_n131_), .d(new_n94_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n129_), .c(new_n96_), .d(new_n64_), .O(new_n167_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n96_), .d(new_n64_), .O(new_n180_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n109_), .d(new_n72_), .O(new_n192_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n173_), .c(new_n161_), .d(new_n122_), .O(new_n203_));
