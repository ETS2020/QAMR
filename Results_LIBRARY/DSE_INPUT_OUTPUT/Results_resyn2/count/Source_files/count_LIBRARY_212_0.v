...
module FAU ( 
  ...
  inv1   g15(.a(x25), .O(new_n67_));
  aoi21  g16(.a(new_n58_), .b(x14), .c(new_n67_), .O(new_n68_));
  nand2  g17(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g18(.a(new_n69_), .b(new_n59_), .O(z01));
  inv1   g19(.a(x21), .O(new_n71_));
  nand3  g20(.a(new_n55_), .b(new_n71_), .c(new_n63_), .O(new_n72_));
  nand2  g21(.a(new_n64_), .b(x21), .O(new_n73_));
  nand3  g22(.a(new_n73_), .b(new_n72_), .c(x16), .O(new_n74_));
  aoi21  g23(.a(new_n58_), .b(x13), .c(new_n67_), .O(new_n75_));
  nand2  g24(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g25(.a(new_n76_), .b(new_n59_), .O(z02));
  xor2a  g26(.a(new_n72_), .b(x22), .O(new_n78_));
  ...
  nand3  g32(.a(new_n83_), .b(new_n82_), .c(new_n71_), .O(new_n84_));
  inv1   g33(.a(x23), .O(new_n85_));
  nand3  g34(.a(new_n85_), .b(new_n82_), .c(new_n71_), .O(new_n86_));
  oai21  g35(.a(new_n86_), .b(new_n64_), .c(x16), .O(new_n87_));
  aoi21  g36(.a(new_n84_), .b(x23), .c(new_n87_), .O(new_n88_));
  inv1   g37(.a(x11), .O(new_n89_));
  oai21  g38(.a(x16), .b(new_n89_), .c(x25), .O(new_n90_));
  oai21  g39(.a(new_n90_), .b(new_n88_), .c(new_n59_), .O(z04));
  oai21  g40(.a(new_n86_), .b(new_n64_), .c(x24), .O(new_n92_));
  inv1   g41(.a(x24), .O(new_n93_));
  nor3   g42(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n83_), .c(new_n93_), .O(new_n95_));
  nand3  g44(.a(new_n95_), .b(new_n92_), .c(x16), .O(new_n96_));
  aoi21  g45(.a(new_n58_), .b(x10), .c(new_n67_), .O(new_n97_));
  nand2  g46(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(new_n59_), .O(z05));
  nand2  g48(.a(new_n95_), .b(x16), .O(new_n100_));
  ...
  nand3  g70(.a(new_n121_), .b(new_n119_), .c(new_n109_), .O(z10));
  nand2  g71(.a(new_n58_), .b(x04), .O(new_n123_));
  inv1   g72(.a(x30), .O(new_n124_));
  nand2  g73(.a(new_n124_), .b(x16), .O(new_n125_));
  nand3  g74(.a(new_n125_), .b(new_n123_), .c(x25), .O(new_n126_));
  nand2  g75(.a(new_n126_), .b(new_n59_), .O(z11));
  nand2  g76(.a(new_n58_), .b(x03), .O(new_n128_));
  inv1   g77(.a(x31), .O(new_n129_));
  nand2  g78(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g79(.a(new_n130_), .b(new_n128_), .c(x25), .O(new_n131_));
  nand2  g80(.a(new_n131_), .b(new_n59_), .O(z12));
