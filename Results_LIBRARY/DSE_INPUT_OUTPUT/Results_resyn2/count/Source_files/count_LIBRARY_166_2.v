...
module FAU ( 
  ...
  aoi21  g013(.a(new_n56_), .b(x14), .c(x05), .O(new_n65_));
  ...
  aoi21  g033(.a(new_n56_), .b(x11), .c(x05), .O(new_n85_));
  ...
  nand4  g038(.a(new_n89_), .b(new_n82_), .c(new_n53_), .d(new_n63_), .O(new_n90_));
  nand3  g039(.a(new_n90_), .b(new_n88_), .c(x16), .O(new_n91_));
  aoi21  g040(.a(new_n56_), .b(x10), .c(x05), .O(new_n92_));
  ...
  aoi21  g057(.a(new_n56_), .b(x08), .c(x05), .O(new_n109_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n89_), .c(new_n82_), .d(new_n62_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(x16), .O(new_n116_));
  aoi21  g065(.a(new_n56_), .b(x07), .c(x05), .O(new_n117_));
  ...
  aoi21  g072(.a(new_n56_), .b(x06), .c(x05), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n58_), .O(z09));
  inv1   g075(.a(x29), .O(new_n127_));
  nand4  g076(.a(new_n120_), .b(new_n104_), .c(new_n127_), .d(new_n103_), .O(new_n128_));
  oai21  g077(.a(new_n128_), .b(new_n83_), .c(x16), .O(new_n129_));
  aoi21  g078(.a(new_n121_), .b(x29), .c(new_n129_), .O(new_n130_));
  oai21  g079(.a(new_n130_), .b(x05), .c(new_n58_), .O(z10));
  oai21  g080(.a(new_n128_), .b(new_n83_), .c(x30), .O(new_n132_));
  ...
  aoi21  g086(.a(new_n56_), .b(x04), .c(x05), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n58_), .O(z11));
  inv1   g089(.a(x31), .O(new_n141_));
  aoi21  g090(.a(new_n135_), .b(new_n106_), .c(new_n141_), .O(new_n142_));
  inv1   g091(.a(x28), .O(new_n143_));
  nand3  g092(.a(new_n133_), .b(new_n141_), .c(new_n143_), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n115_), .O(new_n145_));
  ...
  nand2  g098(.a(new_n89_), .b(new_n82_), .O(new_n150_));
  inv1   g099(.a(new_n150_), .O(new_n151_));
  inv1   g100(.a(new_n144_), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n114_), .c(new_n151_), .d(new_n62_), .O(new_n153_));
  nor2   g102(.a(x32), .b(x31), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n133_), .c(new_n120_), .d(new_n104_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n90_), .c(x16), .O(new_n156_));
  aoi21  g105(.a(new_n153_), .b(x32), .c(new_n156_), .O(new_n157_));
  inv1   g106(.a(x02), .O(new_n158_));
  oai21  g107(.a(x16), .b(new_n158_), .c(new_n57_), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n157_), .c(new_n58_), .O(z13));
  ...
  nand2  g113(.a(new_n164_), .b(new_n97_), .O(new_n165_));
  oai21  g114(.a(new_n155_), .b(new_n90_), .c(x33), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n165_), .c(x16), .O(new_n167_));
  aoi21  g116(.a(new_n56_), .b(x01), .c(x05), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n58_), .O(z14));
  nand3  g119(.a(new_n164_), .b(new_n97_), .c(x34), .O(new_n171_));
