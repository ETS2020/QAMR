...
module FAU ( 
  ...
  aoi21  g006(.a(new_n57_), .b(x15), .c(x01), .O(new_n58_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n68_), .c(new_n53_), .d(new_n75_), .O(new_n92_));
  nand2  g041(.a(new_n85_), .b(x24), .O(new_n93_));
  nand3  g042(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  aoi21  g043(.a(new_n57_), .b(x10), .c(x01), .O(new_n95_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n84_), .c(new_n68_), .d(new_n53_), .O(new_n112_));
  aoi21  g061(.a(new_n112_), .b(x26), .c(new_n57_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  aoi21  g063(.a(new_n57_), .b(x08), .c(x01), .O(new_n115_));
  ...
  oai21  g072(.a(x16), .b(new_n123_), .c(new_n71_), .O(new_n124_));
  ...
  aoi21  g080(.a(new_n57_), .b(x06), .c(x01), .O(new_n132_));
  ...
  oai21  g088(.a(x16), .b(new_n139_), .c(new_n71_), .O(new_n140_));
  ...
  aoi21  g096(.a(new_n57_), .b(x04), .c(x01), .O(new_n148_));
  ...
  aoi21  g108(.a(new_n57_), .b(x03), .c(x01), .O(new_n160_));
  ...
  oai21  g117(.a(new_n166_), .b(new_n57_), .c(new_n168_), .O(z13));
  ...
  nand3  g124(.a(new_n175_), .b(new_n170_), .c(x16), .O(new_n176_));
  ...
  aoi21  g135(.a(new_n57_), .b(x00), .c(x01), .O(new_n187_));
