...
module FAU ( 
  ...
  nand3  g091(.a(new_n142_), .b(new_n117_), .c(new_n91_), .O(new_n143_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n99_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n156_), .c(new_n99_), .d(new_n65_), .O(new_n180_));
