...
module FAU ( 
  ...
  xor2a  g005(.a(x19), .b(x17), .O(new_n57_));
  oai21  g006(.a(new_n57_), .b(new_n52_), .c(new_n56_), .O(z00));
  inv1   g007(.a(x20), .O(new_n59_));
  nor2   g008(.a(x19), .b(x17), .O(new_n60_));
  xor2a  g009(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g010(.a(x15), .b(x14), .O(new_n62_));
  aoi21  g011(.a(new_n62_), .b(new_n52_), .c(x18), .O(new_n63_));
  oai21  g012(.a(new_n61_), .b(new_n52_), .c(new_n63_), .O(z01));
  ...
  aoi21  g021(.a(new_n72_), .b(new_n70_), .c(new_n54_), .O(z02));
  ...
  nand2  g027(.a(x15), .b(x12), .O(new_n79_));
  aoi21  g028(.a(new_n79_), .b(new_n52_), .c(x18), .O(new_n80_));
  ...
  aoi21  g037(.a(new_n88_), .b(new_n86_), .c(new_n54_), .O(z04));
  xor2a  g038(.a(new_n84_), .b(x24), .O(new_n90_));
  inv1   g039(.a(x15), .O(new_n91_));
  nor2   g040(.a(new_n91_), .b(x10), .O(new_n92_));
  aoi21  g041(.a(new_n92_), .b(new_n52_), .c(new_n55_), .O(new_n93_));
  oai21  g042(.a(new_n90_), .b(new_n52_), .c(new_n93_), .O(z05));
  nor2   g043(.a(x16), .b(x09), .O(new_n95_));
  oai21  g044(.a(new_n95_), .b(x18), .c(x15), .O(new_n96_));
  inv1   g045(.a(x24), .O(new_n97_));
  nand4  g046(.a(new_n83_), .b(new_n67_), .c(new_n60_), .d(new_n97_), .O(new_n98_));
  nor2   g047(.a(x25), .b(x24), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n83_), .c(new_n67_), .d(new_n60_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n53_), .O(new_n101_));
  aoi21  g050(.a(new_n98_), .b(x25), .c(new_n101_), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n52_), .c(new_n96_), .O(z06));
  nor2   g052(.a(new_n100_), .b(x26), .O(new_n104_));
  nand2  g053(.a(new_n100_), .b(x26), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(x16), .O(new_n106_));
  oai21  g055(.a(new_n91_), .b(x08), .c(new_n52_), .O(new_n107_));
  oai21  g056(.a(new_n106_), .b(new_n104_), .c(new_n107_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n56_), .O(z07));
  ...
  nand2  g064(.a(x15), .b(x07), .O(new_n116_));
  aoi21  g065(.a(new_n116_), .b(new_n52_), .c(x18), .O(new_n117_));
  oai21  g066(.a(new_n115_), .b(new_n52_), .c(new_n117_), .O(z08));
  nor2   g067(.a(x16), .b(x06), .O(new_n119_));
  oai21  g068(.a(new_n119_), .b(x18), .c(x15), .O(new_n120_));
  ...
  oai21  g073(.a(new_n124_), .b(new_n98_), .c(new_n53_), .O(new_n125_));
  ...
  oai21  g077(.a(new_n128_), .b(x18), .c(x15), .O(new_n129_));
  ...
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n53_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n129_), .O(z10));
  nor2   g084(.a(x16), .b(x04), .O(new_n136_));
  oai21  g085(.a(new_n136_), .b(x18), .c(x15), .O(new_n137_));
  inv1   g086(.a(x30), .O(new_n138_));
  aoi21  g087(.a(new_n131_), .b(new_n104_), .c(new_n138_), .O(new_n139_));
  ...
  nand2  g102(.a(x15), .b(x03), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n52_), .c(x18), .O(new_n155_));
  oai21  g104(.a(new_n153_), .b(new_n52_), .c(new_n155_), .O(z12));
  oai21  g105(.a(new_n151_), .b(new_n98_), .c(x32), .O(new_n157_));
  ...
  nand2  g112(.a(x15), .b(x02), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n52_), .c(x18), .O(new_n165_));
  ...
  nand2  g119(.a(x15), .b(x01), .O(new_n171_));
  aoi21  g120(.a(new_n171_), .b(new_n52_), .c(x18), .O(new_n172_));
  oai21  g121(.a(new_n170_), .b(new_n52_), .c(new_n172_), .O(z14));
  nor2   g122(.a(x16), .b(x00), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(x18), .c(x15), .O(new_n175_));
  nor3   g124(.a(new_n168_), .b(new_n100_), .c(x34), .O(new_n176_));
  inv1   g125(.a(x34), .O(new_n177_));
  oai21  g126(.a(new_n169_), .b(new_n177_), .c(new_n53_), .O(new_n178_));
