...
module FAU ( 
  ...
  xor2a  g15(.a(new_n63_), .b(x21), .O(new_n67_));
  oai21  g16(.a(new_n67_), .b(new_n54_), .c(new_n58_), .O(z02));
  inv1   g17(.a(x21), .O(new_n69_));
  nand2  g18(.a(new_n64_), .b(new_n69_), .O(new_n70_));
  inv1   g19(.a(x22), .O(new_n71_));
  nand2  g20(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nor2   g21(.a(new_n72_), .b(new_n63_), .O(new_n73_));
  aoi21  g22(.a(new_n70_), .b(x22), .c(new_n73_), .O(new_n74_));
  oai21  g23(.a(new_n74_), .b(new_n54_), .c(new_n58_), .O(z03));
  oai21  g24(.a(new_n72_), .b(new_n63_), .c(x23), .O(new_n76_));
  inv1   g25(.a(x23), .O(new_n77_));
  nor2   g26(.a(x22), .b(x21), .O(new_n78_));
  nand4  g27(.a(new_n78_), .b(new_n52_), .c(new_n77_), .d(new_n59_), .O(new_n79_));
  nand3  g28(.a(new_n79_), .b(new_n76_), .c(new_n55_), .O(z04));
  nand2  g29(.a(new_n79_), .b(x24), .O(new_n81_));
  inv1   g30(.a(x24), .O(new_n82_));
  nand3  g31(.a(new_n77_), .b(new_n71_), .c(new_n69_), .O(new_n83_));
  nor2   g32(.a(new_n83_), .b(new_n63_), .O(new_n84_));
  nand2  g33(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g34(.a(new_n85_), .b(new_n81_), .c(new_n55_), .O(z05));
  nand2  g35(.a(new_n85_), .b(x25), .O(new_n87_));
  inv1   g36(.a(x25), .O(new_n88_));
  nand2  g37(.a(new_n88_), .b(new_n82_), .O(new_n89_));
  nor2   g38(.a(new_n89_), .b(new_n79_), .O(new_n90_));
  inv1   g39(.a(new_n90_), .O(new_n91_));
  nand3  g40(.a(new_n91_), .b(new_n87_), .c(new_n55_), .O(z06));
  ...
  nand3  g46(.a(new_n97_), .b(new_n84_), .c(new_n93_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n109_), .b(new_n108_), .c(new_n96_), .d(new_n82_), .O(new_n110_));
  nor2   g59(.a(new_n110_), .b(new_n79_), .O(new_n111_));
  ...
  nand3  g65(.a(new_n116_), .b(new_n115_), .c(new_n84_), .O(new_n117_));
  ...
  oai21  g71(.a(new_n119_), .b(new_n79_), .c(x31), .O(new_n123_));
  ...
  nand3  g78(.a(new_n129_), .b(new_n84_), .c(new_n82_), .O(new_n130_));
