...
module FAU ( 
  ...
  nand2  g013(.a(x34), .b(x18), .O(new_n65_));
  ...
  nand3  g023(.a(new_n74_), .b(new_n58_), .c(new_n57_), .O(new_n75_));
  nand2  g024(.a(new_n75_), .b(x16), .O(new_n76_));
  aoi21  g025(.a(new_n67_), .b(x22), .c(new_n76_), .O(new_n77_));
  inv1   g026(.a(x12), .O(new_n78_));
  inv1   g027(.a(x18), .O(new_n79_));
  oai21  g028(.a(x16), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  oai21  g029(.a(new_n80_), .b(new_n77_), .c(new_n65_), .O(z03));
  inv1   g030(.a(x23), .O(new_n82_));
  nand2  g031(.a(new_n74_), .b(new_n82_), .O(new_n83_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n74_), .c(new_n58_), .d(new_n57_), .O(new_n92_));
  ...
  nand3  g048(.a(new_n99_), .b(new_n89_), .c(new_n60_), .O(new_n100_));
  ...
  nand3  g055(.a(new_n99_), .b(new_n84_), .c(new_n106_), .O(new_n107_));
  nand2  g056(.a(new_n100_), .b(x26), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n107_), .c(x16), .O(new_n109_));
  aoi21  g058(.a(new_n52_), .b(x08), .c(x18), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(new_n65_), .O(z07));
  ...
  nand3  g068(.a(new_n113_), .b(new_n93_), .c(new_n98_), .O(new_n120_));
  nor2   g069(.a(x26), .b(x25), .O(new_n121_));
  nor2   g070(.a(x28), .b(x27), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(new_n91_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n75_), .c(x16), .O(new_n124_));
  aoi21  g073(.a(new_n120_), .b(x28), .c(new_n124_), .O(new_n125_));
  inv1   g074(.a(x06), .O(new_n126_));
  oai21  g075(.a(x16), .b(new_n126_), .c(new_n79_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n125_), .c(new_n65_), .O(z09));
  oai21  g077(.a(new_n123_), .b(new_n75_), .c(x29), .O(new_n129_));
  inv1   g078(.a(x24), .O(new_n130_));
  inv1   g079(.a(x27), .O(new_n131_));
  nor2   g080(.a(x29), .b(x28), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n121_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  oai21  g082(.a(new_n133_), .b(new_n90_), .c(new_n129_), .O(new_n134_));
  ...
  oai21  g087(.a(new_n133_), .b(new_n90_), .c(x30), .O(new_n139_));
  inv1   g088(.a(x30), .O(new_n140_));
  inv1   g089(.a(new_n133_), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n84_), .c(new_n140_), .O(new_n142_));
  ...
  nand2  g094(.a(new_n145_), .b(new_n65_), .O(z11));
  nor2   g095(.a(x31), .b(x30), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n132_), .c(new_n121_), .d(new_n131_), .O(new_n148_));
  nor2   g097(.a(new_n148_), .b(new_n92_), .O(new_n149_));
  aoi21  g098(.a(new_n142_), .b(x31), .c(new_n149_), .O(new_n150_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n93_), .c(new_n154_), .O(new_n156_));
  oai21  g105(.a(new_n148_), .b(new_n92_), .c(x32), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n156_), .c(x16), .O(new_n158_));
  aoi21  g107(.a(new_n52_), .b(x02), .c(x18), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n65_), .O(z13));
  nor2   g110(.a(x33), .b(x32), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n147_), .c(new_n132_), .d(new_n113_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n165_), .b(new_n52_), .c(new_n167_), .O(z14));
  nand2  g117(.a(new_n164_), .b(x34), .O(new_n169_));
  inv1   g118(.a(x34), .O(new_n170_));
  oai21  g119(.a(new_n163_), .b(new_n100_), .c(new_n170_), .O(new_n171_));
