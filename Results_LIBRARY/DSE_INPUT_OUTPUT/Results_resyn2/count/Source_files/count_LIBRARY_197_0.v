...
module FAU ( 
  ...
  oai21  g021(.a(new_n72_), .b(new_n57_), .c(new_n69_), .O(z02));
  inv1   g022(.a(x22), .O(new_n74_));
  nand3  g023(.a(new_n71_), .b(new_n53_), .c(new_n74_), .O(new_n75_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n82_), .c(new_n71_), .d(new_n53_), .O(new_n97_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n89_), .c(new_n82_), .d(new_n63_), .O(new_n114_));
  ...
  oai21  g081(.a(new_n130_), .b(new_n57_), .c(new_n132_), .O(z10));
  ...
  oai21  g102(.a(new_n151_), .b(new_n57_), .c(new_n153_), .O(z12));
  ...
  oai21  g111(.a(new_n160_), .b(new_n57_), .c(new_n162_), .O(z13));
  ...
  oai21  g122(.a(x16), .b(new_n173_), .c(x13), .O(new_n174_));
  ...
  aoi21  g127(.a(new_n57_), .b(x00), .c(new_n56_), .O(new_n179_));
