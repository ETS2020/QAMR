...
module FAU ( 
  ...
  nand3  g025(.a(new_n68_), .b(new_n56_), .c(new_n75_), .O(new_n77_));
  ...
  nand3  g032(.a(new_n83_), .b(new_n68_), .c(new_n56_), .O(new_n84_));
  inv1   g033(.a(new_n84_), .O(new_n85_));
  aoi21  g034(.a(new_n77_), .b(x23), .c(new_n85_), .O(new_n86_));
  inv1   g035(.a(x11), .O(new_n87_));
  aoi21  g036(.a(new_n67_), .b(new_n87_), .c(x18), .O(new_n88_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n91_), .c(new_n56_), .d(new_n90_), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  aoi21  g043(.a(new_n84_), .b(x24), .c(new_n94_), .O(new_n95_));
  oai22  g044(.a(new_n95_), .b(new_n67_), .c(new_n53_), .d(x10), .O(z05));
  nor2   g045(.a(x25), .b(x24), .O(new_n97_));
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n68_), .d(new_n56_), .O(new_n98_));
  ...
  oai21  g051(.a(new_n100_), .b(new_n67_), .c(new_n102_), .O(z06));
  ...
  oai21  g059(.a(new_n108_), .b(new_n67_), .c(new_n110_), .O(z07));
  inv1   g060(.a(x27), .O(new_n112_));
  nor3   g061(.a(x27), .b(x26), .c(x25), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n92_), .c(new_n91_), .d(new_n62_), .O(new_n114_));
  ...
  aoi21  g066(.a(new_n67_), .b(new_n117_), .c(x18), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n116_), .O(z08));
  nor2   g068(.a(x28), .b(x27), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n105_), .c(new_n91_), .O(new_n121_));
  ...
  oai21  g074(.a(new_n123_), .b(new_n67_), .c(new_n125_), .O(z09));
  oai21  g075(.a(new_n121_), .b(new_n77_), .c(x29), .O(new_n127_));
  inv1   g076(.a(new_n106_), .O(new_n128_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n128_), .c(new_n85_), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n127_), .c(new_n54_), .O(new_n131_));
  ...
  nand4  g085(.a(new_n120_), .b(new_n105_), .c(new_n136_), .d(new_n104_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n84_), .c(x30), .O(new_n138_));
  inv1   g087(.a(x28), .O(new_n139_));
  inv1   g088(.a(x30), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n136_), .c(new_n139_), .d(new_n112_), .O(new_n141_));
  inv1   g090(.a(new_n141_), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n128_), .c(new_n85_), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n138_), .c(new_n54_), .O(new_n144_));
  ...
  oai21  g102(.a(new_n153_), .b(new_n93_), .c(new_n54_), .O(new_n154_));
  aoi21  g103(.a(new_n143_), .b(x31), .c(new_n154_), .O(new_n155_));
  inv1   g104(.a(x03), .O(new_n156_));
  nand2  g105(.a(new_n52_), .b(new_n156_), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n67_), .c(new_n157_), .O(z12));
  oai21  g107(.a(new_n153_), .b(new_n93_), .c(x32), .O(new_n159_));
  inv1   g108(.a(x21), .O(new_n160_));
  inv1   g109(.a(x23), .O(new_n161_));
  nand4  g110(.a(new_n104_), .b(new_n161_), .c(new_n75_), .d(new_n160_), .O(new_n162_));
  inv1   g111(.a(new_n162_), .O(new_n163_));
  inv1   g112(.a(x26), .O(new_n164_));
  inv1   g113(.a(x31), .O(new_n165_));
  inv1   g114(.a(x32), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n149_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n142_), .c(new_n163_), .d(new_n62_), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n159_), .c(new_n54_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g120(.a(x02), .O(new_n172_));
  nand2  g121(.a(new_n52_), .b(new_n172_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n171_), .O(z13));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n151_), .c(new_n120_), .d(new_n105_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n93_), .c(x33), .O(new_n177_));
  nand2  g126(.a(new_n97_), .b(new_n83_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nand2  g128(.a(new_n152_), .b(new_n151_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nor2   g130(.a(x33), .b(x32), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n150_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n181_), .c(new_n179_), .d(new_n70_), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n177_), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(x16), .O(new_n187_));
  inv1   g136(.a(x01), .O(new_n188_));
  aoi21  g137(.a(new_n67_), .b(new_n188_), .c(x18), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n187_), .O(z14));
  inv1   g139(.a(x34), .O(new_n191_));
  nor2   g140(.a(new_n185_), .b(new_n191_), .O(new_n192_));
  nand4  g141(.a(new_n182_), .b(new_n152_), .c(new_n151_), .d(new_n150_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n98_), .c(new_n191_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(x16), .O(new_n195_));
  inv1   g144(.a(x00), .O(new_n196_));
  aoi21  g145(.a(new_n67_), .b(new_n196_), .c(x18), .O(new_n197_));
  oai21  g146(.a(new_n195_), .b(new_n192_), .c(new_n197_), .O(z15));
endmodule
