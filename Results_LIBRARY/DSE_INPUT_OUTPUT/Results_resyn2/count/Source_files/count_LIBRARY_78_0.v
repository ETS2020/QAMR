...
module FAU ( 
  ...
  nand2  g026(.a(new_n72_), .b(new_n77_), .O(new_n78_));
  aoi21  g027(.a(new_n71_), .b(x22), .c(new_n56_), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  aoi21  g029(.a(new_n56_), .b(x12), .c(new_n64_), .O(new_n81_));
  ...
  nand2  g036(.a(x16), .b(x11), .O(new_n88_));
  oai21  g037(.a(new_n88_), .b(new_n87_), .c(new_n57_), .O(z04));
  ...
  nand4  g062(.a(new_n104_), .b(new_n113_), .c(new_n77_), .d(new_n68_), .O(new_n114_));
  ...
  aoi21  g067(.a(new_n56_), .b(x07), .c(new_n64_), .O(new_n119_));
  ...
  nand4  g073(.a(new_n84_), .b(new_n70_), .c(new_n53_), .d(new_n124_), .O(new_n125_));
  ...
  nand3  g082(.a(new_n133_), .b(new_n132_), .c(new_n86_), .O(new_n134_));
  ...
  nand4  g088(.a(new_n133_), .b(new_n84_), .c(new_n70_), .d(new_n53_), .O(new_n140_));
  ...
  nand3  g093(.a(new_n144_), .b(new_n107_), .c(new_n86_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n141_), .c(x16), .O(new_n146_));
  aoi21  g095(.a(new_n56_), .b(x04), .c(new_n64_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n57_), .O(z11));
  nand4  g098(.a(new_n142_), .b(new_n133_), .c(new_n105_), .d(new_n104_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n85_), .c(x31), .O(new_n151_));
  ...
  aoi21  g107(.a(new_n56_), .b(x03), .c(new_n64_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n57_), .O(z12));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n142_), .c(new_n133_), .d(new_n105_), .O(new_n163_));
  ...
  inv1   g118(.a(new_n98_), .O(new_n170_));
  ...
  aoi21  g126(.a(new_n56_), .b(x01), .c(new_n64_), .O(new_n178_));
