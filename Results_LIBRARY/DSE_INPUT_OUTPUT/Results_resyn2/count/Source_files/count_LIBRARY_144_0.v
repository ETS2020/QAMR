...
module FAU ( 
  ...
  nand2  g006(.a(new_n57_), .b(x14), .O(new_n58_));
  ...
  xor2a  g016(.a(new_n64_), .b(new_n67_), .O(new_n68_));
  ...
  nand2  g020(.a(new_n64_), .b(new_n67_), .O(new_n72_));
  nor2   g021(.a(x22), .b(x21), .O(new_n73_));
  nand3  g022(.a(new_n73_), .b(new_n53_), .c(new_n62_), .O(new_n74_));
  ...
  aoi21  g028(.a(new_n74_), .b(x23), .c(new_n56_), .O(new_n80_));
  oai21  g029(.a(new_n74_), .b(x23), .c(new_n80_), .O(new_n81_));
  inv1   g030(.a(x14), .O(new_n82_));
  aoi21  g031(.a(new_n56_), .b(x11), .c(new_n82_), .O(new_n83_));
  nand2  g032(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(new_n57_), .O(z04));
  oai21  g034(.a(new_n74_), .b(x23), .c(x24), .O(new_n86_));
  nor2   g035(.a(x24), .b(x23), .O(new_n87_));
  nand4  g036(.a(new_n87_), .b(new_n73_), .c(new_n53_), .d(new_n62_), .O(new_n88_));
  nand3  g037(.a(new_n88_), .b(new_n86_), .c(x16), .O(new_n89_));
  aoi21  g038(.a(new_n56_), .b(x10), .c(new_n82_), .O(new_n90_));
  ...
  nand4  g043(.a(new_n94_), .b(new_n87_), .c(new_n64_), .d(new_n67_), .O(new_n95_));
  aoi21  g044(.a(new_n95_), .b(new_n93_), .c(new_n56_), .O(new_n96_));
  oai21  g045(.a(x16), .b(x09), .c(new_n61_), .O(new_n97_));
  or2    g046(.a(new_n97_), .b(new_n96_), .O(z06));
  nand2  g047(.a(new_n95_), .b(x26), .O(new_n99_));
  nor2   g048(.a(x26), .b(x25), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n87_), .c(new_n73_), .d(new_n64_), .O(new_n101_));
  nand3  g050(.a(new_n101_), .b(new_n99_), .c(x16), .O(new_n102_));
  aoi21  g051(.a(new_n56_), .b(x08), .c(new_n82_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n57_), .O(z07));
  inv1   g054(.a(x27), .O(new_n106_));
  nand3  g055(.a(new_n100_), .b(new_n87_), .c(new_n106_), .O(new_n107_));
  nor2   g056(.a(new_n107_), .b(new_n74_), .O(new_n108_));
  aoi21  g057(.a(new_n101_), .b(x27), .c(new_n108_), .O(new_n109_));
  nor2   g058(.a(x16), .b(x07), .O(new_n110_));
  nor2   g059(.a(new_n110_), .b(new_n58_), .O(new_n111_));
  oai21  g060(.a(new_n109_), .b(new_n56_), .c(new_n111_), .O(z08));
  inv1   g061(.a(x28), .O(new_n113_));
  nor2   g062(.a(new_n108_), .b(new_n113_), .O(new_n114_));
  nand3  g063(.a(new_n100_), .b(new_n113_), .c(new_n106_), .O(new_n115_));
  ...
  nand2  g068(.a(new_n119_), .b(new_n117_), .O(z09));
  oai21  g069(.a(new_n115_), .b(new_n88_), .c(x29), .O(new_n121_));
  nor2   g070(.a(x29), .b(x28), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n108_), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n121_), .c(x16), .O(new_n124_));
  aoi21  g073(.a(new_n56_), .b(x05), .c(new_n82_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n57_), .O(z10));
  inv1   g076(.a(x30), .O(new_n128_));
  aoi21  g077(.a(new_n122_), .b(new_n108_), .c(new_n128_), .O(new_n129_));
  nand3  g078(.a(new_n122_), .b(new_n128_), .c(new_n106_), .O(new_n130_));
  nor2   g079(.a(new_n130_), .b(new_n101_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n129_), .c(x16), .O(new_n132_));
  nor2   g081(.a(x16), .b(x04), .O(new_n133_));
  nor2   g082(.a(new_n133_), .b(new_n58_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n132_), .O(z11));
  inv1   g084(.a(new_n100_), .O(new_n136_));
  ...
  nand3  g089(.a(new_n122_), .b(new_n140_), .c(new_n128_), .O(new_n141_));
  nor3   g090(.a(new_n141_), .b(new_n107_), .c(new_n74_), .O(new_n142_));
  aoi21  g091(.a(new_n139_), .b(x31), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g099(.a(new_n150_), .b(new_n122_), .c(new_n128_), .d(new_n106_), .O(new_n151_));
  ...
  aoi21  g107(.a(new_n158_), .b(new_n137_), .c(new_n157_), .O(new_n159_));
  inv1   g108(.a(x26), .O(new_n160_));
  nand4  g109(.a(new_n157_), .b(new_n147_), .c(new_n106_), .d(new_n160_), .O(new_n161_));
  inv1   g110(.a(new_n161_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n148_), .O(new_n163_));
  nor2   g112(.a(new_n163_), .b(new_n95_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n159_), .c(x16), .O(new_n165_));
  nor2   g114(.a(x16), .b(x01), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(new_n58_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n165_), .O(z14));
  inv1   g117(.a(new_n95_), .O(new_n169_));
  nand4  g118(.a(new_n162_), .b(new_n148_), .c(new_n169_), .d(x34), .O(new_n170_));
  inv1   g119(.a(x34), .O(new_n171_));
  oai21  g120(.a(new_n163_), .b(new_n95_), .c(new_n171_), .O(new_n172_));
  nand3  g121(.a(new_n172_), .b(new_n170_), .c(x16), .O(new_n173_));
  nor2   g122(.a(x16), .b(x00), .O(new_n174_));
  nor2   g123(.a(new_n174_), .b(new_n58_), .O(new_n175_));
