...
module FAU ( 
  ...
  nand2  g26(.a(new_n58_), .b(x11), .O(new_n78_));
  inv1   g27(.a(x23), .O(new_n79_));
  nand2  g28(.a(new_n79_), .b(x16), .O(new_n80_));
  nand3  g29(.a(new_n80_), .b(new_n78_), .c(x22), .O(new_n81_));
  nand2  g30(.a(new_n81_), .b(new_n59_), .O(z04));
  ...
  nand3  g79(.a(new_n130_), .b(new_n128_), .c(new_n83_), .O(z15));
endmodule
