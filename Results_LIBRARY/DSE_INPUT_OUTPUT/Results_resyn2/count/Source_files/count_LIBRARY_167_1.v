...
module FAU ( 
  ...
  nand3  g014(.a(new_n61_), .b(new_n55_), .c(new_n54_), .O(new_n66_));
  ...
  nand4  g037(.a(new_n88_), .b(new_n81_), .c(new_n53_), .d(new_n61_), .O(new_n89_));
  ...
  oai21  g059(.a(new_n110_), .b(new_n82_), .c(x27), .O(new_n111_));
  inv1   g060(.a(x21), .O(new_n112_));
  inv1   g061(.a(x23), .O(new_n113_));
  nand4  g062(.a(new_n107_), .b(new_n113_), .c(new_n72_), .d(new_n112_), .O(new_n114_));
  ...
  nor3   g070(.a(x28), .b(x27), .c(x23), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n102_), .O(new_n123_));
  ...
  aoi21  g075(.a(new_n57_), .b(new_n126_), .c(x18), .O(new_n127_));
  oai21  g076(.a(new_n125_), .b(new_n57_), .c(new_n127_), .O(z09));
  oai21  g077(.a(new_n123_), .b(new_n74_), .c(x29), .O(new_n129_));
  nor3   g078(.a(x29), .b(x28), .c(x27), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n102_), .c(new_n101_), .O(new_n131_));
  ...
  xor2a  g085(.a(new_n131_), .b(x30), .O(new_n137_));
  ...
  nand4  g090(.a(new_n130_), .b(new_n102_), .c(new_n101_), .d(new_n141_), .O(new_n142_));
  nor2   g091(.a(x29), .b(x28), .O(new_n143_));
  nor2   g092(.a(x31), .b(x30), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n143_), .c(new_n116_), .d(new_n108_), .O(new_n145_));
  nor2   g094(.a(new_n145_), .b(new_n89_), .O(new_n146_));
  aoi21  g095(.a(new_n142_), .b(x31), .c(new_n146_), .O(new_n147_));
  inv1   g096(.a(x03), .O(new_n148_));
  aoi21  g097(.a(new_n57_), .b(new_n148_), .c(x18), .O(new_n149_));
  oai21  g098(.a(new_n147_), .b(new_n57_), .c(new_n149_), .O(z12));
  inv1   g099(.a(x31), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n141_), .O(new_n152_));
  inv1   g101(.a(x32), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n109_), .c(new_n108_), .O(new_n154_));
  nor2   g103(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n130_), .c(new_n115_), .O(new_n156_));
  oai21  g105(.a(new_n145_), .b(new_n89_), .c(x32), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n156_), .c(x16), .O(new_n158_));
  aoi21  g107(.a(new_n57_), .b(x02), .c(x18), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n52_), .O(z13));
  nor2   g110(.a(x33), .b(x32), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n144_), .c(new_n143_), .d(new_n116_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n165_), .b(new_n57_), .c(new_n167_), .O(z14));
  xnor2a g117(.a(new_n164_), .b(x34), .O(new_n169_));
  inv1   g118(.a(x00), .O(new_n170_));
  aoi21  g119(.a(new_n57_), .b(new_n170_), .c(x18), .O(new_n171_));
  oai21  g120(.a(new_n169_), .b(new_n57_), .c(new_n171_), .O(z15));
endmodule
