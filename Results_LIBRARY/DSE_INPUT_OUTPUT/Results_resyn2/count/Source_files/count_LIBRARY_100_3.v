...
module FAU ( 
  ...
  nand4  g091(.a(new_n133_), .b(new_n142_), .c(new_n140_), .d(new_n97_), .O(new_n143_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n133_), .c(new_n142_), .d(new_n97_), .O(new_n163_));
  ...
  nand4  g141(.a(new_n192_), .b(new_n167_), .c(new_n106_), .d(new_n74_), .O(new_n193_));
  ...
  oai21  g153(.a(new_n204_), .b(new_n114_), .c(new_n201_), .O(new_n205_));
