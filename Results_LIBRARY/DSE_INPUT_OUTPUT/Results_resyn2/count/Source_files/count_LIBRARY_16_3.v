...
module FAU ( 
  ...
  nand2  g017(.a(new_n55_), .b(new_n62_), .O(new_n69_));
  inv1   g018(.a(x21), .O(new_n70_));
  nand4  g019(.a(new_n70_), .b(new_n62_), .c(new_n53_), .d(new_n52_), .O(new_n71_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n77_), .d(new_n70_), .O(new_n98_));
  inv1   g047(.a(new_n98_), .O(new_n99_));
  aoi22  g048(.a(new_n99_), .b(new_n64_), .c(new_n87_), .d(x24), .O(new_n100_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n104_), .c(new_n55_), .d(new_n62_), .O(new_n106_));
  inv1   g055(.a(x25), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n77_), .O(new_n108_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n93_), .c(new_n123_), .O(z08));
  ...
  oai21  g089(.a(new_n133_), .b(new_n80_), .c(x29), .O(new_n141_));
