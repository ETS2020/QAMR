...
module FAU ( 
  ...
  nand3  g035(.a(new_n86_), .b(new_n80_), .c(new_n55_), .O(new_n87_));
  ...
  aoi22  g048(.a(new_n99_), .b(new_n63_), .c(new_n87_), .d(x24), .O(new_n100_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n86_), .c(new_n80_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g091(.a(new_n142_), .b(new_n117_), .c(new_n88_), .O(new_n143_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n99_), .d(new_n63_), .O(new_n169_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n99_), .d(new_n63_), .O(new_n180_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n168_), .c(new_n109_), .d(new_n71_), .O(new_n192_));
