...
module FAU ( 
  ...
  nand4  g054(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n80_), .O(new_n106_));
  ...
  oai21  g087(.a(new_n135_), .b(new_n83_), .c(x29), .O(new_n139_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n134_), .c(new_n133_), .d(new_n95_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n97_), .d(new_n66_), .O(new_n167_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n97_), .d(new_n66_), .O(new_n182_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n107_), .d(new_n75_), .O(new_n192_));
