...
module FAU ( 
  ...
  nor2   g011(.a(x18), .b(x16), .O(new_n63_));
  inv1   g012(.a(new_n63_), .O(new_n64_));
  inv1   g013(.a(x21), .O(new_n65_));
  aoi21  g014(.a(new_n58_), .b(new_n57_), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g019(.a(new_n70_), .b(new_n66_), .c(x16), .O(new_n71_));
  oai21  g020(.a(new_n64_), .b(x13), .c(new_n71_), .O(z02));
  xor2a  g021(.a(new_n69_), .b(x22), .O(new_n73_));
  ...
  oai21  g025(.a(new_n69_), .b(x22), .c(x23), .O(new_n77_));
  inv1   g026(.a(new_n69_), .O(new_n78_));
  nor2   g027(.a(x23), .b(x22), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  aoi21  g029(.a(new_n80_), .b(new_n77_), .c(new_n52_), .O(new_n81_));
  oai21  g030(.a(x16), .b(x11), .c(new_n67_), .O(new_n82_));
  or2    g031(.a(new_n82_), .b(new_n81_), .O(z04));
  xor2a  g032(.a(new_n80_), .b(x24), .O(new_n84_));
  ...
  nand4  g037(.a(new_n79_), .b(new_n68_), .c(new_n58_), .d(new_n88_), .O(new_n89_));
  nor2   g038(.a(x25), .b(x24), .O(new_n90_));
  nand4  g039(.a(new_n90_), .b(new_n79_), .c(new_n68_), .d(new_n58_), .O(new_n91_));
  inv1   g040(.a(new_n91_), .O(new_n92_));
  aoi21  g041(.a(new_n89_), .b(x25), .c(new_n92_), .O(new_n93_));
  ...
  nand2  g045(.a(new_n52_), .b(x08), .O(new_n97_));
  nor2   g046(.a(new_n91_), .b(x26), .O(new_n98_));
  inv1   g047(.a(x26), .O(new_n99_));
  oai21  g048(.a(new_n92_), .b(new_n99_), .c(x16), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n98_), .c(new_n97_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n67_), .O(z07));
  inv1   g051(.a(new_n89_), .O(new_n103_));
  nor3   g052(.a(x27), .b(x26), .c(x25), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  oai21  g054(.a(new_n91_), .b(x26), .c(x27), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n105_), .c(new_n67_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(x16), .O(new_n108_));
  oai21  g057(.a(new_n64_), .b(x07), .c(new_n108_), .O(z08));
  inv1   g058(.a(x28), .O(new_n110_));
  nand2  g059(.a(new_n104_), .b(new_n110_), .O(new_n111_));
  nor2   g060(.a(new_n111_), .b(new_n89_), .O(new_n112_));
  aoi21  g061(.a(new_n105_), .b(x28), .c(new_n112_), .O(new_n113_));
  ...
  oai21  g065(.a(new_n111_), .b(new_n89_), .c(x29), .O(new_n117_));
  nor3   g066(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n98_), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n117_), .c(new_n67_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(x16), .O(new_n121_));
  inv1   g070(.a(x05), .O(new_n122_));
  nand2  g071(.a(new_n63_), .b(new_n122_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n121_), .O(z10));
  inv1   g073(.a(x30), .O(new_n125_));
  aoi21  g074(.a(new_n118_), .b(new_n98_), .c(new_n125_), .O(new_n126_));
  inv1   g075(.a(x27), .O(new_n127_));
  nor2   g076(.a(x29), .b(x28), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n125_), .c(new_n127_), .O(new_n129_));
  inv1   g078(.a(new_n129_), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n92_), .c(new_n99_), .O(new_n131_));
  ...
  nand2  g083(.a(new_n63_), .b(new_n134_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n133_), .O(z11));
  nor2   g085(.a(x31), .b(x30), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n128_), .c(new_n104_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n89_), .O(new_n139_));
  aoi21  g088(.a(new_n131_), .b(x31), .c(new_n139_), .O(new_n140_));
  inv1   g089(.a(x03), .O(new_n141_));
  aoi21  g090(.a(new_n52_), .b(new_n141_), .c(x18), .O(new_n142_));
  oai21  g091(.a(new_n140_), .b(new_n52_), .c(new_n142_), .O(z12));
  oai21  g092(.a(new_n138_), .b(new_n89_), .c(x32), .O(new_n144_));
  nor2   g093(.a(x26), .b(x25), .O(new_n145_));
  nor2   g094(.a(x32), .b(x31), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  inv1   g096(.a(new_n147_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n130_), .c(new_n103_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n144_), .c(new_n67_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g100(.a(x02), .O(new_n152_));
  nand2  g101(.a(new_n63_), .b(new_n152_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n151_), .O(z13));
  nor2   g103(.a(x27), .b(x26), .O(new_n155_));
  nor2   g104(.a(x33), .b(x32), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n137_), .c(new_n128_), .d(new_n155_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n91_), .c(new_n67_), .O(new_n158_));
  aoi21  g107(.a(new_n149_), .b(x33), .c(new_n158_), .O(new_n159_));
  oai22  g108(.a(new_n159_), .b(new_n52_), .c(new_n64_), .d(x01), .O(z14));
  inv1   g109(.a(x00), .O(new_n161_));
  nand2  g110(.a(new_n63_), .b(new_n161_), .O(new_n162_));
  nor3   g111(.a(new_n157_), .b(new_n91_), .c(x34), .O(new_n163_));
  oai21  g112(.a(new_n157_), .b(new_n91_), .c(x34), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n67_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n163_), .c(x16), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n162_), .O(z15));
endmodule
