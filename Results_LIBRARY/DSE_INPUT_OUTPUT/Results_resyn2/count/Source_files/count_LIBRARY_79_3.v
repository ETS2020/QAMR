...
module FAU ( 
  ...
  nand2  g017(.a(new_n55_), .b(new_n63_), .O(new_n69_));
  ...
  inv1   g034(.a(new_n66_), .O(new_n86_));
  inv1   g035(.a(x11), .O(new_n87_));
  oai21  g036(.a(x18), .b(new_n87_), .c(new_n58_), .O(new_n88_));
  nor2   g037(.a(x23), .b(x22), .O(new_n89_));
  nand3  g038(.a(new_n89_), .b(new_n81_), .c(new_n55_), .O(new_n90_));
  inv1   g039(.a(new_n90_), .O(new_n91_));
  aoi21  g040(.a(new_n82_), .b(x23), .c(new_n91_), .O(new_n92_));
  ...
  aoi22  g048(.a(new_n99_), .b(new_n65_), .c(new_n90_), .d(x24), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n86_), .c(new_n95_), .O(z05));
  ...
  oai21  g059(.a(new_n110_), .b(new_n86_), .c(new_n103_), .O(z06));
  inv1   g060(.a(x08), .O(new_n112_));
  oai21  g061(.a(x18), .b(new_n112_), .c(new_n58_), .O(new_n113_));
  nor2   g062(.a(x25), .b(x24), .O(new_n114_));
  nand4  g063(.a(new_n114_), .b(new_n89_), .c(new_n81_), .d(new_n55_), .O(new_n115_));
  ...
  oai21  g086(.a(new_n137_), .b(new_n86_), .c(new_n130_), .O(z09));
  ...
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n99_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n99_), .d(new_n65_), .O(new_n182_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n175_), .c(new_n163_), .d(new_n124_), .O(new_n203_));
