...
module FAU ( 
  ...
  nand3  g027(.a(new_n69_), .b(new_n56_), .c(new_n76_), .O(new_n79_));
  ...
  oai22  g036(.a(new_n87_), .b(new_n83_), .c(new_n53_), .d(x11), .O(z04));
  inv1   g037(.a(x20), .O(new_n89_));
  nor2   g038(.a(x24), .b(x23), .O(new_n90_));
  nor2   g039(.a(x22), .b(x21), .O(new_n91_));
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n56_), .d(new_n89_), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n54_), .O(new_n93_));
  aoi21  g042(.a(new_n85_), .b(x24), .c(new_n93_), .O(new_n94_));
  oai22  g043(.a(new_n94_), .b(new_n83_), .c(new_n53_), .d(x10), .O(z05));
  nor2   g044(.a(x25), .b(x24), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n84_), .c(new_n69_), .d(new_n56_), .O(new_n97_));
  inv1   g046(.a(new_n97_), .O(new_n98_));
  aoi21  g047(.a(new_n92_), .b(x25), .c(new_n98_), .O(new_n99_));
  inv1   g048(.a(x09), .O(new_n100_));
  aoi21  g049(.a(new_n83_), .b(new_n100_), .c(x18), .O(new_n101_));
  oai21  g050(.a(new_n99_), .b(new_n83_), .c(new_n101_), .O(z06));
  ...
  aoi22  g056(.a(new_n107_), .b(new_n103_), .c(new_n97_), .d(x26), .O(new_n108_));
  inv1   g057(.a(x08), .O(new_n109_));
  aoi21  g058(.a(new_n83_), .b(new_n109_), .c(x18), .O(new_n110_));
  oai21  g059(.a(new_n108_), .b(new_n83_), .c(new_n110_), .O(z07));
  oai21  g060(.a(new_n106_), .b(new_n85_), .c(x27), .O(new_n112_));
  inv1   g061(.a(x23), .O(new_n113_));
  nand4  g062(.a(new_n104_), .b(new_n113_), .c(new_n76_), .d(new_n67_), .O(new_n114_));
  inv1   g063(.a(new_n114_), .O(new_n115_));
  nor3   g064(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n115_), .c(new_n62_), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n112_), .c(new_n54_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n123_), .b(new_n105_), .c(new_n90_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n79_), .c(new_n54_), .O(new_n125_));
  aoi21  g074(.a(new_n117_), .b(x28), .c(new_n125_), .O(new_n126_));
  inv1   g075(.a(x06), .O(new_n127_));
  nand2  g076(.a(new_n52_), .b(new_n127_), .O(new_n128_));
  oai21  g077(.a(new_n126_), .b(new_n83_), .c(new_n128_), .O(z09));
  oai21  g078(.a(new_n124_), .b(new_n79_), .c(x29), .O(new_n130_));
  inv1   g079(.a(x29), .O(new_n131_));
  nand4  g080(.a(new_n123_), .b(new_n105_), .c(new_n131_), .d(new_n104_), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n85_), .c(new_n130_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  inv1   g083(.a(x05), .O(new_n135_));
  aoi21  g084(.a(new_n83_), .b(new_n135_), .c(x18), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n134_), .O(z10));
  oai21  g086(.a(new_n132_), .b(new_n85_), .c(x30), .O(new_n138_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n162_), .O(new_n169_));
  inv1   g118(.a(new_n169_), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n143_), .c(new_n115_), .d(new_n62_), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n165_), .c(new_n54_), .O(new_n172_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n150_), .c(new_n123_), .d(new_n105_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n92_), .c(x33), .O(new_n179_));
  nand2  g128(.a(new_n96_), .b(new_n84_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nor2   g130(.a(x33), .b(x32), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n163_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n155_), .c(new_n181_), .d(new_n77_), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n179_), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(x16), .O(new_n187_));
  inv1   g136(.a(x01), .O(new_n188_));
  aoi21  g137(.a(new_n83_), .b(new_n188_), .c(x18), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n187_), .O(z14));
  inv1   g139(.a(x34), .O(new_n191_));
  nor2   g140(.a(new_n185_), .b(new_n191_), .O(new_n192_));
  nand4  g141(.a(new_n182_), .b(new_n153_), .c(new_n150_), .d(new_n163_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n97_), .c(new_n191_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(x16), .O(new_n195_));
  inv1   g144(.a(x00), .O(new_n196_));
  aoi21  g145(.a(new_n83_), .b(new_n196_), .c(x18), .O(new_n197_));
