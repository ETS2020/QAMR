...
module FAU ( 
  ...
  nand4  g066(.a(new_n117_), .b(new_n92_), .c(new_n85_), .d(new_n55_), .O(new_n118_));
  ...
  oai21  g071(.a(new_n122_), .b(new_n71_), .c(new_n116_), .O(z07));
  ...
  nand3  g081(.a(new_n132_), .b(new_n119_), .c(new_n105_), .O(new_n133_));
  nor2   g082(.a(new_n133_), .b(new_n86_), .O(new_n134_));
  aoi21  g083(.a(new_n126_), .b(x28), .c(new_n134_), .O(new_n135_));
  ...
  nand4  g098(.a(new_n132_), .b(new_n119_), .c(new_n149_), .d(new_n98_), .O(new_n150_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n132_), .c(new_n119_), .d(new_n98_), .O(new_n162_));
  ...
  nand4  g125(.a(new_n176_), .b(new_n161_), .c(new_n175_), .d(new_n108_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n107_), .c(x32), .O(new_n178_));
  inv1   g127(.a(x26), .O(new_n179_));
  inv1   g128(.a(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n164_), .c(new_n179_), .d(new_n108_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n156_), .c(new_n100_), .d(new_n74_), .O(new_n183_));
  ...
  nand4  g136(.a(new_n187_), .b(new_n161_), .c(new_n132_), .d(new_n119_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n107_), .c(x33), .O(new_n189_));
  inv1   g138(.a(x33), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n180_), .c(new_n152_), .d(new_n179_), .O(new_n191_));
  inv1   g140(.a(new_n191_), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n166_), .c(new_n110_), .d(new_n78_), .O(new_n193_));
  ...
  nand4  g150(.a(new_n201_), .b(new_n176_), .c(new_n161_), .d(new_n175_), .O(new_n202_));
