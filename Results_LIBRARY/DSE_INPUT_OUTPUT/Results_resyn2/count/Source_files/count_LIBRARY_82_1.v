...
module FAU ( 
  ...
  nand4  g049(.a(new_n100_), .b(new_n87_), .c(new_n82_), .d(new_n55_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n65_), .O(new_n102_));
  aoi21  g051(.a(new_n96_), .b(x25), .c(new_n102_), .O(new_n103_));
  oai22  g052(.a(new_n103_), .b(new_n58_), .c(new_n62_), .d(x09), .O(z06));
  ...
  nand4  g071(.a(new_n122_), .b(new_n121_), .c(new_n80_), .d(new_n71_), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n124_), .c(new_n66_), .O(new_n126_));
  nor2   g075(.a(x26), .b(x25), .O(new_n127_));
  nor2   g076(.a(x28), .b(x27), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n127_), .c(new_n94_), .O(new_n129_));
  ...
  nand3  g085(.a(new_n136_), .b(new_n106_), .c(new_n89_), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n135_), .c(new_n65_), .O(new_n138_));
  ...
  nand3  g099(.a(new_n150_), .b(new_n106_), .c(new_n89_), .O(new_n151_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n125_), .c(new_n124_), .d(new_n66_), .O(new_n163_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n150_), .c(new_n124_), .d(new_n66_), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n171_), .c(new_n65_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(x16), .O(new_n178_));
  inv1   g127(.a(x02), .O(new_n179_));
  nand2  g128(.a(new_n61_), .b(new_n179_), .O(new_n180_));
  ...
  nand4  g133(.a(new_n113_), .b(new_n122_), .c(new_n121_), .d(new_n80_), .O(new_n185_));
  inv1   g134(.a(new_n185_), .O(new_n186_));
  inv1   g135(.a(x33), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n173_), .c(new_n146_), .d(new_n172_), .O(new_n188_));
  inv1   g137(.a(new_n188_), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n162_), .c(new_n186_), .d(new_n73_), .O(new_n190_));
  nand3  g139(.a(new_n190_), .b(new_n184_), .c(new_n65_), .O(new_n191_));
  ...
  nand4  g145(.a(new_n189_), .b(new_n162_), .c(new_n196_), .d(x34), .O(new_n197_));
