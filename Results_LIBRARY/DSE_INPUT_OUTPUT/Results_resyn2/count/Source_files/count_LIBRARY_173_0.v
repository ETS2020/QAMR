...
module FAU ( 
  ...
  inv1   g25(.a(new_n60_), .O(new_n77_));
  ...
  nand2  g38(.a(new_n58_), .b(x08), .O(new_n90_));
  inv1   g39(.a(x26), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(x16), .O(new_n92_));
  nand3  g41(.a(new_n92_), .b(new_n90_), .c(x22), .O(new_n93_));
  nand2  g42(.a(new_n93_), .b(new_n59_), .O(z07));
  nand2  g43(.a(new_n58_), .b(x07), .O(new_n95_));
  inv1   g44(.a(x27), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(x16), .O(new_n97_));
  nand3  g46(.a(new_n97_), .b(new_n95_), .c(x22), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(new_n59_), .O(z08));
  nand2  g48(.a(x28), .b(x16), .O(new_n100_));
  inv1   g49(.a(x06), .O(new_n101_));
  nand2  g50(.a(new_n58_), .b(new_n101_), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n100_), .c(new_n77_), .O(z09));
  nand2  g52(.a(new_n58_), .b(x05), .O(new_n104_));
  inv1   g53(.a(x29), .O(new_n105_));
  nand2  g54(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g55(.a(new_n106_), .b(new_n104_), .c(x22), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n59_), .O(z10));
  ...
  nand2  g61(.a(new_n112_), .b(new_n59_), .O(z11));
  ...
  nand3  g75(.a(new_n126_), .b(new_n124_), .c(new_n77_), .O(z14));
