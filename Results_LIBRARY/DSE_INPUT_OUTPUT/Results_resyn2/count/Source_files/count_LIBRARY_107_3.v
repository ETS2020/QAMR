...
module FAU ( 
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n80_), .d(new_n73_), .O(new_n98_));
  ...
  nand4  g056(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n80_), .O(new_n108_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n99_), .d(new_n65_), .O(new_n180_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n109_), .d(new_n75_), .O(new_n192_));
