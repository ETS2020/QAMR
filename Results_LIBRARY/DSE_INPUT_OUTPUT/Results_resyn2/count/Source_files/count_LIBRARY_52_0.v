...
module FAU ( 
  ...
  aoi21  g032(.a(new_n56_), .b(x11), .c(new_n65_), .O(new_n84_));
  ...
  aoi21  g039(.a(new_n56_), .b(x10), .c(new_n65_), .O(new_n91_));
  ...
  aoi21  g056(.a(new_n56_), .b(x08), .c(new_n65_), .O(new_n108_));
  ...
  oai21  g094(.a(x16), .b(new_n145_), .c(x02), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n144_), .c(new_n57_), .O(z12));
  ...
  nand2  g102(.a(x16), .b(x02), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n153_), .c(new_n57_), .O(z13));
  oai21  g104(.a(new_n151_), .b(new_n88_), .c(x33), .O(new_n156_));
  nor2   g105(.a(x33), .b(x32), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n141_), .c(new_n132_), .d(new_n111_), .O(new_n158_));
  ...
  nor3   g112(.a(new_n158_), .b(new_n95_), .c(x34), .O(new_n164_));
  oai21  g113(.a(new_n158_), .b(new_n95_), .c(x34), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(x16), .O(new_n166_));
  aoi21  g115(.a(new_n56_), .b(x00), .c(new_n65_), .O(new_n167_));
  oai21  g116(.a(new_n166_), .b(new_n164_), .c(new_n167_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n57_), .O(z15));
endmodule
