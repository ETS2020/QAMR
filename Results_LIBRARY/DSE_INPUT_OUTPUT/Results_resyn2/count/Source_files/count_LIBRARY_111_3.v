...
module FAU ( 
  ...
  oai21  g021(.a(x18), .b(new_n72_), .c(new_n56_), .O(new_n73_));
  nor3   g022(.a(x20), .b(x19), .c(x17), .O(new_n74_));
  inv1   g023(.a(new_n74_), .O(new_n75_));
  inv1   g024(.a(x21), .O(new_n76_));
  nand4  g025(.a(new_n76_), .b(new_n62_), .c(new_n53_), .d(new_n52_), .O(new_n77_));
  inv1   g026(.a(new_n77_), .O(new_n78_));
  aoi21  g027(.a(new_n75_), .b(x21), .c(new_n78_), .O(new_n79_));
  oai21  g028(.a(new_n79_), .b(new_n71_), .c(new_n73_), .O(z02));
  ...
  nand3  g034(.a(new_n85_), .b(new_n55_), .c(new_n83_), .O(new_n86_));
  inv1   g035(.a(new_n86_), .O(new_n87_));
  oai21  g036(.a(new_n87_), .b(new_n84_), .c(new_n57_), .O(new_n88_));
  nand2  g037(.a(new_n88_), .b(new_n82_), .O(z03));
  inv1   g038(.a(x11), .O(new_n90_));
  oai21  g039(.a(x18), .b(new_n90_), .c(new_n56_), .O(new_n91_));
  nor2   g040(.a(x23), .b(x22), .O(new_n92_));
  nand3  g041(.a(new_n92_), .b(new_n85_), .c(new_n55_), .O(new_n93_));
  inv1   g042(.a(new_n93_), .O(new_n94_));
  aoi21  g043(.a(new_n86_), .b(x23), .c(new_n94_), .O(new_n95_));
  oai21  g044(.a(new_n95_), .b(new_n71_), .c(new_n91_), .O(z04));
  inv1   g045(.a(x23), .O(new_n97_));
  inv1   g046(.a(x24), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n97_), .c(new_n83_), .d(new_n76_), .O(new_n99_));
  ...
  nand4  g055(.a(new_n106_), .b(new_n105_), .c(new_n55_), .d(new_n62_), .O(new_n107_));
  inv1   g056(.a(x25), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n98_), .c(new_n97_), .d(new_n83_), .O(new_n109_));
  inv1   g058(.a(new_n109_), .O(new_n110_));
  aoi22  g059(.a(new_n110_), .b(new_n78_), .c(new_n107_), .d(x25), .O(new_n111_));
  inv1   g060(.a(x09), .O(new_n112_));
  aoi21  g061(.a(new_n56_), .b(new_n112_), .c(x18), .O(new_n113_));
  oai21  g062(.a(new_n111_), .b(new_n56_), .c(new_n113_), .O(z06));
  nor2   g063(.a(x25), .b(x24), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n92_), .c(new_n85_), .d(new_n55_), .O(new_n116_));
  nor2   g065(.a(x26), .b(x25), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n98_), .O(new_n118_));
  inv1   g067(.a(new_n118_), .O(new_n119_));
  aoi22  g068(.a(new_n119_), .b(new_n94_), .c(new_n116_), .d(x26), .O(new_n120_));
  inv1   g069(.a(x08), .O(new_n121_));
  aoi21  g070(.a(new_n56_), .b(new_n121_), .c(x18), .O(new_n122_));
  oai21  g071(.a(new_n120_), .b(new_n56_), .c(new_n122_), .O(z07));
  oai21  g072(.a(new_n118_), .b(new_n93_), .c(x27), .O(new_n124_));
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n100_), .c(new_n74_), .O(new_n126_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n117_), .c(new_n105_), .O(new_n135_));
  nor2   g084(.a(new_n135_), .b(new_n86_), .O(new_n136_));
  aoi21  g085(.a(new_n126_), .b(x28), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n71_), .c(new_n133_), .O(z09));
  oai21  g087(.a(new_n135_), .b(new_n86_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n119_), .c(new_n94_), .O(new_n141_));
  ...
  nand4  g096(.a(new_n134_), .b(new_n117_), .c(new_n147_), .d(new_n98_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n93_), .c(x30), .O(new_n149_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n119_), .c(new_n94_), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n134_), .c(new_n117_), .d(new_n98_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n125_), .c(new_n100_), .d(new_n74_), .O(new_n167_));
  ...
  nor2   g122(.a(x31), .b(x28), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n161_), .c(new_n173_), .d(new_n108_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n107_), .c(x32), .O(new_n176_));
  inv1   g125(.a(x26), .O(new_n177_));
  inv1   g126(.a(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n164_), .c(new_n177_), .d(new_n108_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n154_), .c(new_n100_), .d(new_n74_), .O(new_n181_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n161_), .c(new_n134_), .d(new_n117_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n107_), .c(x33), .O(new_n191_));
  inv1   g140(.a(x33), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n178_), .c(new_n150_), .d(new_n177_), .O(new_n193_));
  inv1   g142(.a(new_n193_), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n166_), .c(new_n110_), .d(new_n78_), .O(new_n195_));
  ...
  nor2   g148(.a(new_n195_), .b(new_n199_), .O(new_n200_));
  nor2   g149(.a(x33), .b(x32), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n174_), .c(new_n161_), .d(new_n173_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n116_), .c(new_n199_), .O(new_n203_));
