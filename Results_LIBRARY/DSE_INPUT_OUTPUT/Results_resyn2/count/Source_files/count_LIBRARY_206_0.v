...
module FAU ( 
  ...
  nand2  g56(.a(new_n56_), .b(x03), .O(new_n108_));
  inv1   g57(.a(x31), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(x16), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(x19), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n59_), .O(z12));
  nand2  g61(.a(x32), .b(x16), .O(new_n113_));
  inv1   g62(.a(x02), .O(new_n114_));
  nand2  g63(.a(new_n56_), .b(new_n114_), .O(new_n115_));
  nand3  g64(.a(new_n115_), .b(new_n113_), .c(new_n54_), .O(z13));
  nand2  g65(.a(new_n56_), .b(x01), .O(new_n117_));
  inv1   g66(.a(x33), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g68(.a(new_n119_), .b(new_n117_), .c(x19), .O(new_n120_));
  nand2  g69(.a(new_n120_), .b(new_n59_), .O(z14));
  nand2  g70(.a(x34), .b(x16), .O(new_n122_));
  inv1   g71(.a(x00), .O(new_n123_));
  nand2  g72(.a(new_n56_), .b(new_n123_), .O(new_n124_));
  nand3  g73(.a(new_n124_), .b(new_n122_), .c(new_n54_), .O(z15));
endmodule
