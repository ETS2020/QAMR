...
module FAU ( 
  ...
  oai21  g089(.a(new_n135_), .b(new_n82_), .c(x29), .O(new_n141_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n163_), .c(new_n122_), .d(new_n105_), .O(new_n174_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n168_), .c(new_n107_), .d(new_n72_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n173_), .c(new_n163_), .d(new_n122_), .O(new_n201_));
