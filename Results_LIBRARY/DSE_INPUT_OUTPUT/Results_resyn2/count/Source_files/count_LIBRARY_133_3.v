...
module FAU ( 
  ...
  nor2   g074(.a(new_n125_), .b(new_n103_), .O(new_n126_));
  aoi21  g075(.a(new_n115_), .b(x27), .c(new_n126_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n121_), .c(new_n123_), .O(z08));
  ...
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n101_), .O(new_n135_));
  nor2   g084(.a(new_n135_), .b(new_n80_), .O(new_n136_));
  aoi21  g085(.a(new_n132_), .b(x28), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n121_), .c(new_n130_), .O(z09));
  ...
  nand3  g091(.a(new_n142_), .b(new_n114_), .c(new_n88_), .O(new_n143_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n114_), .c(new_n88_), .O(new_n155_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n163_), .c(new_n124_), .d(new_n104_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n103_), .c(x32), .O(new_n177_));
  inv1   g126(.a(x26), .O(new_n178_));
  inv1   g127(.a(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n166_), .c(new_n178_), .d(new_n104_), .O(new_n180_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n168_), .c(new_n106_), .d(new_n72_), .O(new_n194_));
  ...
  oai21  g152(.a(new_n203_), .b(new_n112_), .c(new_n200_), .O(new_n204_));
