...
module FAU ( 
  ...
  nand4  g020(.a(new_n69_), .b(new_n61_), .c(new_n55_), .d(new_n54_), .O(new_n72_));
  nand2  g021(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  oai21  g022(.a(new_n73_), .b(new_n70_), .c(x16), .O(new_n74_));
  oai21  g023(.a(new_n53_), .b(x13), .c(new_n74_), .O(z02));
  xor2a  g024(.a(new_n72_), .b(x22), .O(new_n76_));
  inv1   g025(.a(x12), .O(new_n77_));
  aoi21  g026(.a(new_n66_), .b(new_n77_), .c(x18), .O(new_n78_));
  oai21  g027(.a(new_n76_), .b(new_n66_), .c(new_n78_), .O(z03));
  inv1   g028(.a(x22), .O(new_n80_));
  nor2   g029(.a(x21), .b(x20), .O(new_n81_));
  nand3  g030(.a(new_n81_), .b(new_n56_), .c(new_n80_), .O(new_n82_));
  nor2   g031(.a(x23), .b(x22), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n81_), .c(new_n56_), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  aoi21  g034(.a(new_n82_), .b(x23), .c(new_n85_), .O(new_n86_));
  oai22  g035(.a(new_n86_), .b(new_n66_), .c(new_n53_), .d(x11), .O(z04));
  nor2   g036(.a(x24), .b(x23), .O(new_n88_));
  nor2   g037(.a(x22), .b(x21), .O(new_n89_));
  nand4  g038(.a(new_n89_), .b(new_n88_), .c(new_n56_), .d(new_n61_), .O(new_n90_));
  nand2  g039(.a(new_n90_), .b(new_n71_), .O(new_n91_));
  aoi21  g040(.a(new_n84_), .b(x24), .c(new_n91_), .O(new_n92_));
  oai22  g041(.a(new_n92_), .b(new_n66_), .c(new_n53_), .d(x10), .O(z05));
  inv1   g042(.a(x23), .O(new_n94_));
  inv1   g043(.a(x24), .O(new_n95_));
  inv1   g044(.a(x25), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n80_), .O(new_n97_));
  nor2   g046(.a(new_n97_), .b(new_n72_), .O(new_n98_));
  aoi21  g047(.a(new_n90_), .b(x25), .c(new_n98_), .O(new_n99_));
  inv1   g048(.a(x09), .O(new_n100_));
  aoi21  g049(.a(new_n66_), .b(new_n100_), .c(x18), .O(new_n101_));
  oai21  g050(.a(new_n99_), .b(new_n66_), .c(new_n101_), .O(z06));
  inv1   g051(.a(x08), .O(new_n103_));
  nand2  g052(.a(new_n52_), .b(new_n103_), .O(new_n104_));
  oai21  g053(.a(new_n97_), .b(new_n72_), .c(x26), .O(new_n105_));
  inv1   g054(.a(new_n84_), .O(new_n106_));
  nor2   g055(.a(x26), .b(x25), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(new_n95_), .O(new_n108_));
  inv1   g057(.a(new_n108_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n105_), .c(new_n71_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n104_), .O(z07));
  inv1   g062(.a(x27), .O(new_n114_));
  nor2   g063(.a(new_n108_), .b(new_n84_), .O(new_n115_));
  nor3   g064(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n89_), .c(new_n88_), .d(new_n63_), .O(new_n117_));
  ...
  aoi21  g069(.a(new_n66_), .b(new_n120_), .c(x18), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n119_), .O(z08));
  nor2   g071(.a(x28), .b(x27), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n107_), .c(new_n88_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n82_), .c(new_n71_), .O(new_n125_));
  aoi21  g074(.a(new_n117_), .b(x28), .c(new_n125_), .O(new_n126_));
  oai22  g075(.a(new_n126_), .b(new_n66_), .c(new_n53_), .d(x06), .O(z09));
  oai21  g076(.a(new_n124_), .b(new_n82_), .c(x29), .O(new_n128_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n109_), .c(new_n106_), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n128_), .c(new_n71_), .O(new_n131_));
  ...
  nand4  g085(.a(new_n123_), .b(new_n107_), .c(new_n136_), .d(new_n95_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n84_), .c(x30), .O(new_n138_));
  nor2   g087(.a(x30), .b(x29), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n123_), .O(new_n140_));
  inv1   g089(.a(new_n140_), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n109_), .c(new_n106_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(x16), .O(new_n144_));
  inv1   g093(.a(x04), .O(new_n145_));
  aoi21  g094(.a(new_n66_), .b(new_n145_), .c(x18), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n144_), .O(z11));
  nor2   g096(.a(x27), .b(x26), .O(new_n148_));
  nor2   g097(.a(x31), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n139_), .c(new_n148_), .d(new_n96_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n90_), .c(new_n71_), .O(new_n151_));
  aoi21  g100(.a(new_n142_), .b(x31), .c(new_n151_), .O(new_n152_));
  inv1   g101(.a(x03), .O(new_n153_));
  nand2  g102(.a(new_n52_), .b(new_n153_), .O(new_n154_));
  oai21  g103(.a(new_n152_), .b(new_n66_), .c(new_n154_), .O(z12));
  oai21  g104(.a(new_n150_), .b(new_n90_), .c(x32), .O(new_n156_));
  nand2  g105(.a(new_n89_), .b(new_n88_), .O(new_n157_));
  inv1   g106(.a(new_n157_), .O(new_n158_));
  nor2   g107(.a(x32), .b(x31), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n107_), .O(new_n160_));
  inv1   g109(.a(new_n160_), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n141_), .c(new_n158_), .d(new_n63_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n159_), .b(new_n139_), .c(new_n123_), .d(new_n107_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n90_), .c(x33), .O(new_n169_));
  inv1   g118(.a(new_n72_), .O(new_n170_));
  inv1   g119(.a(new_n97_), .O(new_n171_));
  inv1   g120(.a(x28), .O(new_n172_));
  inv1   g121(.a(x30), .O(new_n173_));
  inv1   g122(.a(x31), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n173_), .c(new_n136_), .d(new_n172_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  inv1   g125(.a(x26), .O(new_n177_));
  inv1   g126(.a(x32), .O(new_n178_));
  inv1   g127(.a(x33), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n178_), .c(new_n114_), .d(new_n177_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n176_), .c(new_n171_), .d(new_n170_), .O(new_n182_));
  nand3  g131(.a(new_n182_), .b(new_n169_), .c(new_n71_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(x16), .O(new_n184_));
  inv1   g133(.a(x01), .O(new_n185_));
  nand2  g134(.a(new_n52_), .b(new_n185_), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n184_), .O(z14));
  nand4  g136(.a(new_n181_), .b(new_n176_), .c(new_n98_), .d(x34), .O(new_n188_));
  ...
  aoi21  g141(.a(new_n66_), .b(new_n192_), .c(x18), .O(new_n193_));
