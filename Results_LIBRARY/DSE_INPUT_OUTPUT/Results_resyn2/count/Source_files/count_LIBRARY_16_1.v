...
module FAU ( 
  ...
  nand4  g036(.a(new_n80_), .b(new_n87_), .c(new_n56_), .d(new_n86_), .O(new_n88_));
  nand2  g037(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  aoi21  g038(.a(new_n81_), .b(x24), .c(new_n89_), .O(new_n90_));
  oai22  g039(.a(new_n90_), .b(new_n61_), .c(new_n53_), .d(x10), .O(z05));
  nor2   g040(.a(x25), .b(x24), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n80_), .c(new_n87_), .d(new_n56_), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n83_), .O(new_n94_));
  aoi21  g043(.a(new_n88_), .b(x25), .c(new_n94_), .O(new_n95_));
  oai22  g044(.a(new_n95_), .b(new_n61_), .c(new_n53_), .d(x09), .O(z06));
  nand2  g045(.a(new_n61_), .b(x08), .O(new_n97_));
  ...
  nand2  g051(.a(new_n102_), .b(new_n83_), .O(z07));
  inv1   g052(.a(x07), .O(new_n104_));
  nand2  g053(.a(new_n52_), .b(new_n104_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n93_), .b(x26), .c(x27), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n109_), .c(new_n83_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n105_), .O(z08));
  inv1   g062(.a(x28), .O(new_n114_));
  nand3  g063(.a(new_n108_), .b(new_n114_), .c(new_n106_), .O(new_n115_));
  nor2   g064(.a(new_n115_), .b(new_n88_), .O(new_n116_));
  aoi21  g065(.a(new_n109_), .b(x28), .c(new_n116_), .O(new_n117_));
  inv1   g066(.a(x06), .O(new_n118_));
  aoi21  g067(.a(new_n61_), .b(new_n118_), .c(x18), .O(new_n119_));
  oai21  g068(.a(new_n117_), .b(new_n61_), .c(new_n119_), .O(z09));
  oai21  g069(.a(new_n115_), .b(new_n88_), .c(x29), .O(new_n121_));
  inv1   g070(.a(x22), .O(new_n122_));
  inv1   g071(.a(x23), .O(new_n123_));
  nand4  g072(.a(new_n106_), .b(new_n86_), .c(new_n123_), .d(new_n122_), .O(new_n124_));
  inv1   g073(.a(new_n124_), .O(new_n125_));
  nor3   g074(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n70_), .d(new_n99_), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n121_), .c(new_n83_), .O(new_n128_));
  ...
  nand4  g092(.a(new_n143_), .b(new_n135_), .c(new_n108_), .d(new_n106_), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n88_), .c(new_n83_), .O(new_n145_));
  ...
  nand3  g100(.a(new_n151_), .b(new_n99_), .c(new_n106_), .O(new_n152_));
  inv1   g101(.a(new_n152_), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n137_), .c(new_n107_), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n150_), .c(new_n83_), .O(new_n155_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n143_), .c(new_n135_), .d(new_n108_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n93_), .O(new_n162_));
  aoi21  g111(.a(new_n154_), .b(x33), .c(new_n162_), .O(new_n163_));
  inv1   g112(.a(x01), .O(new_n164_));
  aoi21  g113(.a(new_n61_), .b(new_n164_), .c(x18), .O(new_n165_));
  oai21  g114(.a(new_n163_), .b(new_n61_), .c(new_n165_), .O(z14));
  inv1   g115(.a(x00), .O(new_n167_));
  nand2  g116(.a(new_n52_), .b(new_n167_), .O(new_n168_));
  nor3   g117(.a(new_n161_), .b(new_n93_), .c(x34), .O(new_n169_));
  oai21  g118(.a(new_n161_), .b(new_n93_), .c(x34), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n83_), .O(new_n171_));
