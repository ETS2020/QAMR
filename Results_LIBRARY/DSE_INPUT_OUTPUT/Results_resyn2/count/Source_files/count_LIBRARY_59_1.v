...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n175_, new_n176_;
  nand2  g000(.a(x18), .b(x04), .O(new_n52_));
  ...
  nand2  g015(.a(new_n53_), .b(new_n63_), .O(new_n67_));
  ...
  nand2  g021(.a(new_n62_), .b(new_n72_), .O(new_n73_));
  nor2   g022(.a(x22), .b(x21), .O(new_n74_));
  nand3  g023(.a(new_n74_), .b(new_n53_), .c(new_n63_), .O(new_n75_));
  ...
  nand4  g031(.a(new_n74_), .b(new_n53_), .c(new_n81_), .d(new_n63_), .O(new_n83_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n89_), .c(new_n62_), .d(new_n72_), .O(new_n97_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n89_), .c(new_n74_), .d(new_n62_), .O(new_n105_));
  ...
  nand3  g059(.a(new_n104_), .b(new_n89_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g067(.a(new_n104_), .b(new_n117_), .c(new_n110_), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  ...
  oai21  g073(.a(new_n119_), .b(new_n90_), .c(x29), .O(new_n125_));
  inv1   g074(.a(x24), .O(new_n126_));
  nor2   g075(.a(x29), .b(x28), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n104_), .c(new_n110_), .d(new_n126_), .O(new_n128_));
  ...
  nor3   g091(.a(new_n142_), .b(new_n111_), .c(new_n75_), .O(new_n143_));
  ...
  aoi21  g098(.a(new_n149_), .b(new_n112_), .c(new_n148_), .O(new_n150_));
  nand4  g099(.a(new_n141_), .b(new_n127_), .c(new_n148_), .d(new_n110_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n105_), .O(new_n152_));
  ...
  inv1   g106(.a(new_n104_), .O(new_n158_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n148_), .c(new_n110_), .d(new_n162_), .O(new_n163_));
  ...
  nand4  g119(.a(new_n164_), .b(new_n149_), .c(new_n98_), .d(x34), .O(new_n171_));
  inv1   g120(.a(x34), .O(new_n172_));
  oai21  g121(.a(new_n165_), .b(new_n97_), .c(new_n172_), .O(new_n173_));
