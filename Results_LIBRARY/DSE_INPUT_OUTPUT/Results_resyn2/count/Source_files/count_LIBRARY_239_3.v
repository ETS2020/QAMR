...
module FAU ( 
  ...
  nand3  g038(.a(new_n89_), .b(new_n79_), .c(new_n55_), .O(new_n90_));
  inv1   g039(.a(new_n90_), .O(new_n91_));
  aoi21  g040(.a(new_n80_), .b(x23), .c(new_n91_), .O(new_n92_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n77_), .O(new_n106_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n89_), .c(new_n79_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n99_), .c(new_n64_), .O(new_n132_));
  ...
  oai21  g087(.a(new_n135_), .b(new_n80_), .c(x29), .O(new_n139_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n99_), .d(new_n64_), .O(new_n167_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n99_), .d(new_n64_), .O(new_n182_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n107_), .d(new_n72_), .O(new_n192_));
