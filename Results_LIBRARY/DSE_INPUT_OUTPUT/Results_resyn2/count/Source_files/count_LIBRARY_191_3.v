...
module FAU ( 
  ...
  nand2  g020(.a(new_n55_), .b(new_n62_), .O(new_n72_));
  ...
  aoi22  g046(.a(new_n97_), .b(new_n64_), .c(new_n88_), .d(x24), .O(new_n98_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n87_), .c(new_n82_), .d(new_n55_), .O(new_n113_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n97_), .c(new_n64_), .O(new_n132_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n97_), .d(new_n64_), .O(new_n167_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n97_), .d(new_n64_), .O(new_n180_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n161_), .c(new_n134_), .d(new_n133_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n106_), .c(x33), .O(new_n190_));
  inv1   g139(.a(x33), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n177_), .c(new_n150_), .d(new_n176_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n166_), .c(new_n109_), .d(new_n75_), .O(new_n194_));
