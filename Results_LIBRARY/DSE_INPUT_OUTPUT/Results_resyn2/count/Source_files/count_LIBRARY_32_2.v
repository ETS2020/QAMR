...
module FAU ( 
  ...
  aoi21  g005(.a(new_n56_), .b(x15), .c(x01), .O(new_n57_));
  ...
  aoi21  g012(.a(new_n56_), .b(x14), .c(x01), .O(new_n64_));
  ...
  nand2  g021(.a(new_n52_), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g038(.a(new_n82_), .b(new_n67_), .c(new_n53_), .d(new_n89_), .O(new_n90_));
  nand2  g039(.a(new_n83_), .b(x24), .O(new_n91_));
  nand3  g040(.a(new_n91_), .b(new_n90_), .c(x16), .O(new_n92_));
  aoi21  g041(.a(new_n56_), .b(x10), .c(x01), .O(new_n93_));
  ...
  aoi21  g083(.a(new_n56_), .b(x04), .c(x01), .O(new_n135_));
  ...
  oai21  g109(.a(new_n160_), .b(x01), .c(new_n52_), .O(z14));
  nor3   g110(.a(new_n158_), .b(new_n97_), .c(x34), .O(new_n162_));
  oai21  g111(.a(new_n158_), .b(new_n97_), .c(x34), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(x16), .O(new_n164_));
  aoi21  g113(.a(new_n56_), .b(x00), .c(x01), .O(new_n165_));
