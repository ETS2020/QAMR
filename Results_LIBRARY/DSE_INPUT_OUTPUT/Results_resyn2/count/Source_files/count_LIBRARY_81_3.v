...
module FAU ( 
  ...
  xor2a  g031(.a(new_n78_), .b(x23), .O(new_n83_));
  ...
  nand3  g036(.a(new_n77_), .b(new_n60_), .c(new_n87_), .O(new_n88_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n89_), .c(new_n69_), .d(new_n58_), .O(new_n98_));
  ...
  nand2  g050(.a(new_n101_), .b(new_n66_), .O(z06));
  ...
  nand2  g058(.a(new_n75_), .b(x16), .O(new_n110_));
  nand4  g059(.a(new_n103_), .b(new_n89_), .c(new_n77_), .d(new_n60_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x27), .O(new_n112_));
  nor3   g061(.a(x27), .b(x26), .c(x25), .O(new_n113_));
  aoi21  g062(.a(new_n113_), .b(new_n91_), .c(new_n110_), .O(new_n114_));
  aoi22  g063(.a(new_n114_), .b(new_n112_), .c(new_n110_), .d(x07), .O(z08));
  nand2  g064(.a(new_n113_), .b(new_n91_), .O(new_n116_));
  nor2   g065(.a(x28), .b(x27), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n103_), .c(new_n89_), .O(new_n118_));
  ...
  nand2  g074(.a(new_n125_), .b(new_n105_), .O(new_n126_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n105_), .c(new_n132_), .O(new_n133_));
  ...
  nand4  g101(.a(new_n152_), .b(new_n142_), .c(new_n103_), .d(new_n91_), .O(new_n153_));
  ...
  nor3   g114(.a(new_n160_), .b(new_n98_), .c(x34), .O(new_n166_));
