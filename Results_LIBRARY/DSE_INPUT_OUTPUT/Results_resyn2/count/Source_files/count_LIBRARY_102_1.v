...
module FAU ( 
  ...
  oai21  g026(.a(new_n69_), .b(x22), .c(new_n77_), .O(new_n78_));
  oai21  g027(.a(new_n78_), .b(new_n76_), .c(x16), .O(new_n79_));
  oai21  g028(.a(new_n53_), .b(x12), .c(new_n79_), .O(z03));
  oai21  g029(.a(new_n69_), .b(x22), .c(x23), .O(new_n81_));
  nor2   g030(.a(x23), .b(x22), .O(new_n82_));
  nand2  g031(.a(new_n82_), .b(new_n70_), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n81_), .c(new_n77_), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(x16), .O(new_n85_));
  oai21  g034(.a(new_n53_), .b(x11), .c(new_n85_), .O(z04));
  inv1   g035(.a(x24), .O(new_n87_));
  nor2   g036(.a(x21), .b(x20), .O(new_n88_));
  nand4  g037(.a(new_n82_), .b(new_n88_), .c(new_n56_), .d(new_n87_), .O(new_n89_));
  nand2  g038(.a(new_n89_), .b(new_n77_), .O(new_n90_));
  aoi21  g039(.a(new_n83_), .b(x24), .c(new_n90_), .O(new_n91_));
  oai22  g040(.a(new_n91_), .b(new_n61_), .c(new_n53_), .d(x10), .O(z05));
  nor2   g041(.a(x25), .b(x24), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n82_), .c(new_n88_), .d(new_n56_), .O(new_n94_));
  ...
  nand2  g053(.a(new_n104_), .b(new_n77_), .O(z07));
  nand2  g054(.a(new_n95_), .b(new_n102_), .O(new_n106_));
  ...
  oai21  g062(.a(new_n111_), .b(new_n61_), .c(new_n113_), .O(z08));
  inv1   g063(.a(x28), .O(new_n115_));
  nand3  g064(.a(new_n108_), .b(new_n115_), .c(new_n107_), .O(new_n116_));
  oai22  g065(.a(new_n116_), .b(new_n89_), .c(new_n110_), .d(new_n115_), .O(new_n117_));
  ...
  nand4  g072(.a(new_n107_), .b(new_n87_), .c(new_n123_), .d(new_n75_), .O(new_n124_));
  inv1   g073(.a(new_n124_), .O(new_n125_));
  nor3   g074(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n70_), .d(new_n102_), .O(new_n127_));
  ...
  aoi22  g086(.a(new_n137_), .b(new_n101_), .c(new_n127_), .d(x30), .O(new_n138_));
  inv1   g087(.a(x04), .O(new_n139_));
  aoi21  g088(.a(new_n61_), .b(new_n139_), .c(x18), .O(new_n140_));
  oai21  g089(.a(new_n138_), .b(new_n61_), .c(new_n140_), .O(z11));
  nand3  g090(.a(new_n137_), .b(new_n95_), .c(new_n102_), .O(new_n142_));
  nor2   g091(.a(x31), .b(x30), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n135_), .c(new_n108_), .d(new_n107_), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n89_), .c(new_n77_), .O(new_n145_));
  aoi21  g094(.a(new_n142_), .b(x31), .c(new_n145_), .O(new_n146_));
  inv1   g095(.a(x03), .O(new_n147_));
  nand2  g096(.a(new_n52_), .b(new_n147_), .O(new_n148_));
  oai21  g097(.a(new_n146_), .b(new_n61_), .c(new_n148_), .O(z12));
  oai21  g098(.a(new_n144_), .b(new_n89_), .c(x32), .O(new_n150_));
  inv1   g099(.a(new_n89_), .O(new_n151_));
  nor2   g100(.a(x32), .b(x31), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n102_), .c(new_n107_), .O(new_n153_));
  inv1   g102(.a(new_n153_), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n137_), .c(new_n151_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n150_), .c(new_n77_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g106(.a(x02), .O(new_n158_));
  nand2  g107(.a(new_n52_), .b(new_n158_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n157_), .O(z13));
  nor2   g109(.a(x33), .b(x32), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n143_), .c(new_n135_), .d(new_n108_), .O(new_n162_));
  ...
  aoi21  g114(.a(new_n61_), .b(new_n165_), .c(x18), .O(new_n166_));
  oai21  g115(.a(new_n164_), .b(new_n61_), .c(new_n166_), .O(z14));
  inv1   g116(.a(x00), .O(new_n168_));
  nand2  g117(.a(new_n52_), .b(new_n168_), .O(new_n169_));
  nor3   g118(.a(new_n162_), .b(new_n94_), .c(x34), .O(new_n170_));
