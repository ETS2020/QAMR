...
module FAU ( 
  ...
  nand3  g12(.a(new_n63_), .b(new_n53_), .c(new_n52_), .O(new_n64_));
  oai21  g13(.a(x19), .b(x17), .c(x20), .O(new_n65_));
  nand3  g14(.a(new_n65_), .b(new_n64_), .c(x16), .O(new_n66_));
  nand2  g15(.a(new_n58_), .b(x14), .O(new_n67_));
  nand3  g16(.a(new_n67_), .b(new_n66_), .c(x23), .O(new_n68_));
  nand2  g17(.a(new_n68_), .b(new_n59_), .O(z01));
  xor2a  g18(.a(new_n64_), .b(x21), .O(new_n70_));
  ...
  oai21  g28(.a(new_n75_), .b(x22), .c(x16), .O(new_n80_));
  nor2   g29(.a(x16), .b(x11), .O(new_n81_));
  ...
  nand2  g41(.a(new_n58_), .b(x08), .O(new_n93_));
  inv1   g42(.a(x26), .O(new_n94_));
  nand2  g43(.a(new_n94_), .b(x16), .O(new_n95_));
  nand3  g44(.a(new_n95_), .b(new_n93_), .c(x23), .O(new_n96_));
