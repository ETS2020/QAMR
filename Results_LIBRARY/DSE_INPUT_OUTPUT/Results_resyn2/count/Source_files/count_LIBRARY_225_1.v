...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x11), .O(new_n68_));
  ...
  xor2a  g033(.a(new_n80_), .b(x23), .O(new_n85_));
  ...
  nand3  g039(.a(new_n90_), .b(new_n79_), .c(new_n63_), .O(new_n91_));
  aoi21  g040(.a(new_n91_), .b(new_n89_), .c(new_n58_), .O(new_n92_));
  oai21  g041(.a(x16), .b(x10), .c(new_n77_), .O(new_n93_));
  or2    g042(.a(new_n93_), .b(new_n92_), .O(z05));
  nor2   g043(.a(x25), .b(x22), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n90_), .c(new_n71_), .d(new_n55_), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(x16), .O(new_n97_));
  aoi21  g046(.a(new_n91_), .b(x25), .c(new_n97_), .O(new_n98_));
  inv1   g047(.a(x09), .O(new_n99_));
  oai21  g048(.a(x16), .b(new_n99_), .c(new_n77_), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n98_), .c(new_n68_), .O(z06));
  ...
  nand2  g062(.a(new_n113_), .b(new_n77_), .O(z08));
  ...
  nand2  g111(.a(new_n162_), .b(new_n68_), .O(z14));
  ...
  nand2  g118(.a(new_n169_), .b(new_n68_), .O(z15));
endmodule
