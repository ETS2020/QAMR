...
module FAU ( 
  ...
  nand2  g008(.a(new_n59_), .b(x09), .O(new_n60_));
  ...
  aoi21  g036(.a(new_n58_), .b(x11), .c(new_n67_), .O(new_n88_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n85_), .c(new_n55_), .d(new_n63_), .O(new_n93_));
  ...
  inv1   g046(.a(new_n60_), .O(new_n98_));
  ...
  oai21  g051(.a(new_n102_), .b(new_n58_), .c(new_n98_), .O(z06));
  xor2a  g052(.a(new_n100_), .b(x26), .O(new_n104_));
  ...
  oai21  g056(.a(new_n100_), .b(x26), .c(x27), .O(new_n108_));
  inv1   g057(.a(x25), .O(new_n109_));
  inv1   g058(.a(x21), .O(new_n110_));
  inv1   g059(.a(x23), .O(new_n111_));
  inv1   g060(.a(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n111_), .c(new_n76_), .d(new_n110_), .O(new_n113_));
  ...
  nand3  g065(.a(new_n116_), .b(new_n108_), .c(x16), .O(new_n117_));
  aoi21  g066(.a(new_n58_), .b(x07), .c(new_n67_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n59_), .O(z08));
  inv1   g069(.a(x26), .O(new_n121_));
  inv1   g070(.a(x27), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(new_n109_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n93_), .c(x28), .O(new_n124_));
  inv1   g073(.a(x28), .O(new_n125_));
  inv1   g074(.a(new_n77_), .O(new_n126_));
  nand3  g075(.a(new_n121_), .b(new_n109_), .c(new_n112_), .O(new_n127_));
  inv1   g076(.a(new_n127_), .O(new_n128_));
  nor2   g077(.a(x27), .b(x23), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n126_), .d(new_n125_), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n124_), .c(x16), .O(new_n131_));
  aoi21  g080(.a(new_n58_), .b(x06), .c(new_n67_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n59_), .O(z09));
  nand4  g083(.a(new_n129_), .b(new_n99_), .c(new_n125_), .d(new_n121_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n77_), .c(x29), .O(new_n136_));
  inv1   g085(.a(new_n86_), .O(new_n137_));
  inv1   g086(.a(x29), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n125_), .c(new_n122_), .O(new_n139_));
  ...
  aoi21  g091(.a(new_n58_), .b(x05), .c(new_n67_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n59_), .O(z10));
  nor2   g094(.a(x29), .b(x28), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n99_), .c(new_n122_), .d(new_n121_), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n86_), .c(x30), .O(new_n148_));
  inv1   g097(.a(x30), .O(new_n149_));
  nand3  g098(.a(new_n140_), .b(new_n137_), .c(new_n149_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n148_), .c(x16), .O(new_n151_));
  aoi21  g100(.a(new_n58_), .b(x04), .c(new_n67_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n59_), .O(z11));
  nor2   g103(.a(x31), .b(x30), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n146_), .c(new_n115_), .d(new_n109_), .O(new_n156_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n149_), .c(new_n138_), .d(new_n125_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n123_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n114_), .c(new_n162_), .O(new_n166_));
  oai21  g115(.a(new_n156_), .b(new_n93_), .c(x32), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n166_), .c(x16), .O(new_n168_));
  aoi21  g117(.a(new_n58_), .b(x02), .c(new_n67_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n59_), .O(z13));
  nor2   g120(.a(x33), .b(x32), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n155_), .c(new_n146_), .d(new_n115_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n100_), .O(new_n174_));
  ...
  nand2  g127(.a(new_n174_), .b(x34), .O(new_n179_));
  inv1   g128(.a(x34), .O(new_n180_));
  oai21  g129(.a(new_n173_), .b(new_n100_), .c(new_n180_), .O(new_n181_));
