...
module FAU ( 
  ...
  nand3  g078(.a(new_n129_), .b(new_n97_), .c(new_n66_), .O(new_n130_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n129_), .c(new_n97_), .d(new_n66_), .O(new_n167_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n156_), .c(new_n97_), .d(new_n66_), .O(new_n180_));
