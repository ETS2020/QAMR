...
module FAU ( 
  ...
  nor3   g13(.a(new_n64_), .b(new_n58_), .c(x18), .O(new_n65_));
  oai21  g14(.a(new_n63_), .b(new_n57_), .c(new_n65_), .O(z01));
  inv1   g15(.a(x21), .O(new_n67_));
  aoi21  g16(.a(new_n53_), .b(new_n62_), .c(new_n67_), .O(new_n68_));
  nand4  g17(.a(new_n67_), .b(new_n62_), .c(new_n55_), .d(new_n54_), .O(new_n69_));
  nand2  g18(.a(new_n69_), .b(x16), .O(new_n70_));
  aoi21  g19(.a(new_n57_), .b(x13), .c(new_n58_), .O(new_n71_));
  oai21  g20(.a(new_n70_), .b(new_n68_), .c(new_n71_), .O(new_n72_));
  nand2  g21(.a(new_n72_), .b(new_n52_), .O(z02));
  aoi21  g22(.a(new_n57_), .b(x12), .c(new_n58_), .O(new_n74_));
  oai21  g23(.a(new_n69_), .b(new_n57_), .c(new_n74_), .O(new_n75_));
  nand2  g24(.a(new_n75_), .b(new_n52_), .O(z03));
  nor2   g25(.a(new_n58_), .b(x18), .O(new_n77_));
  nand2  g26(.a(x23), .b(x16), .O(new_n78_));
  inv1   g27(.a(x11), .O(new_n79_));
  nand2  g28(.a(new_n57_), .b(new_n79_), .O(new_n80_));
  nand3  g29(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(z04));
  nand2  g30(.a(x24), .b(x16), .O(new_n82_));
  inv1   g31(.a(x10), .O(new_n83_));
  nand2  g32(.a(new_n57_), .b(new_n83_), .O(new_n84_));
  nand3  g33(.a(new_n84_), .b(new_n82_), .c(new_n77_), .O(z05));
  nand2  g34(.a(new_n57_), .b(x09), .O(new_n86_));
  inv1   g35(.a(x25), .O(new_n87_));
  nand2  g36(.a(new_n87_), .b(x16), .O(new_n88_));
  nand3  g37(.a(new_n88_), .b(new_n86_), .c(x22), .O(new_n89_));
  nand2  g38(.a(new_n89_), .b(new_n52_), .O(z06));
  nand2  g39(.a(new_n57_), .b(x08), .O(new_n91_));
  inv1   g40(.a(x26), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(x16), .O(new_n93_));
  nand3  g42(.a(new_n93_), .b(new_n91_), .c(x22), .O(new_n94_));
  nand2  g43(.a(new_n94_), .b(new_n52_), .O(z07));
  nand2  g44(.a(x27), .b(x16), .O(new_n96_));
  inv1   g45(.a(x07), .O(new_n97_));
  nand2  g46(.a(new_n57_), .b(new_n97_), .O(new_n98_));
  nand3  g47(.a(new_n98_), .b(new_n96_), .c(new_n77_), .O(z08));
  nand2  g48(.a(new_n57_), .b(x06), .O(new_n100_));
  ...
  nand2  g55(.a(new_n57_), .b(new_n106_), .O(new_n107_));
  nand3  g56(.a(new_n107_), .b(new_n105_), .c(new_n77_), .O(z10));
  nand2  g57(.a(new_n57_), .b(x04), .O(new_n109_));
  inv1   g58(.a(x30), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g60(.a(new_n111_), .b(new_n109_), .c(x22), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(new_n52_), .O(z11));
  nand2  g62(.a(new_n57_), .b(x03), .O(new_n114_));
  inv1   g63(.a(x31), .O(new_n115_));
  nand2  g64(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g65(.a(new_n116_), .b(new_n114_), .c(x22), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(new_n52_), .O(z12));
  nand2  g67(.a(x32), .b(x16), .O(new_n119_));
  inv1   g68(.a(x02), .O(new_n120_));
  nand2  g69(.a(new_n57_), .b(new_n120_), .O(new_n121_));
  nand3  g70(.a(new_n121_), .b(new_n119_), .c(new_n77_), .O(z13));
  nand2  g71(.a(new_n57_), .b(x01), .O(new_n123_));
  inv1   g72(.a(x33), .O(new_n124_));
  nand2  g73(.a(new_n124_), .b(x16), .O(new_n125_));
  nand3  g74(.a(new_n125_), .b(new_n123_), .c(x22), .O(new_n126_));
  nand2  g75(.a(new_n126_), .b(new_n52_), .O(z14));
