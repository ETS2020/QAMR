...
module FAU ( 
  ...
  nand4  g058(.a(new_n103_), .b(new_n89_), .c(new_n77_), .d(new_n63_), .O(new_n110_));
  nor3   g059(.a(x27), .b(x26), .c(x25), .O(new_n111_));
  aoi22  g060(.a(new_n111_), .b(new_n91_), .c(new_n110_), .d(x27), .O(new_n112_));
  nand2  g061(.a(x16), .b(x07), .O(new_n113_));
  oai21  g062(.a(new_n113_), .b(new_n112_), .c(new_n57_), .O(z08));
  nand2  g063(.a(new_n111_), .b(new_n91_), .O(new_n115_));
  nor2   g064(.a(x28), .b(x27), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n103_), .c(new_n89_), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(new_n82_), .c(x16), .O(new_n118_));
  aoi21  g067(.a(new_n115_), .b(x28), .c(new_n118_), .O(new_n119_));
  inv1   g068(.a(x06), .O(new_n120_));
  oai21  g069(.a(x16), .b(new_n120_), .c(x07), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n119_), .c(new_n57_), .O(z09));
  oai21  g071(.a(new_n117_), .b(new_n82_), .c(x29), .O(new_n123_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n105_), .c(new_n131_), .O(new_n132_));
  inv1   g081(.a(x27), .O(new_n133_));
  nor2   g082(.a(x29), .b(x28), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n131_), .c(new_n133_), .O(new_n135_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n134_), .c(new_n111_), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n90_), .O(new_n145_));
  aoi21  g094(.a(new_n142_), .b(x31), .c(new_n145_), .O(new_n146_));
  nor2   g095(.a(x16), .b(x03), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n58_), .O(new_n148_));
  oai21  g097(.a(new_n146_), .b(new_n56_), .c(new_n148_), .O(z12));
  oai21  g098(.a(new_n144_), .b(new_n90_), .c(x32), .O(new_n150_));
  nor2   g099(.a(x32), .b(x31), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n141_), .c(new_n103_), .d(new_n91_), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n150_), .c(x16), .O(new_n153_));
  aoi21  g102(.a(new_n56_), .b(x02), .c(new_n73_), .O(new_n154_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n143_), .c(new_n134_), .d(new_n157_), .O(new_n159_));
  nor2   g108(.a(new_n159_), .b(new_n98_), .O(new_n160_));
  ...
  nor3   g113(.a(new_n159_), .b(new_n98_), .c(x34), .O(new_n165_));
  inv1   g114(.a(x34), .O(new_n166_));
  oai21  g115(.a(new_n160_), .b(new_n166_), .c(x16), .O(new_n167_));
  aoi21  g116(.a(new_n56_), .b(x00), .c(new_n73_), .O(new_n168_));
  oai21  g117(.a(new_n167_), .b(new_n165_), .c(new_n168_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n57_), .O(z15));
endmodule
