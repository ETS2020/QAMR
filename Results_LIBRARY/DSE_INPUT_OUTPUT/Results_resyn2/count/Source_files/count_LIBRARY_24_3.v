...
module FAU ( 
  ...
  nand4  g043(.a(new_n94_), .b(new_n93_), .c(new_n79_), .d(new_n70_), .O(new_n95_));
  ...
  nand4  g056(.a(new_n107_), .b(new_n94_), .c(new_n93_), .d(new_n79_), .O(new_n108_));
  ...
  nand4  g098(.a(new_n134_), .b(new_n133_), .c(new_n149_), .d(new_n94_), .O(new_n150_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n96_), .d(new_n65_), .O(new_n167_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n161_), .c(new_n124_), .d(new_n107_), .O(new_n176_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n96_), .d(new_n65_), .O(new_n182_));
