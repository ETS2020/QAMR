...
module FAU ( 
  ...
  nand3  g029(.a(new_n80_), .b(new_n77_), .c(new_n67_), .O(new_n81_));
  nand2  g030(.a(new_n81_), .b(x16), .O(new_n82_));
  oai21  g031(.a(new_n64_), .b(x11), .c(new_n82_), .O(z04));
  inv1   g032(.a(x24), .O(new_n84_));
  nand4  g033(.a(new_n79_), .b(new_n68_), .c(new_n58_), .d(new_n84_), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(new_n67_), .O(new_n86_));
  aoi21  g035(.a(new_n80_), .b(x24), .c(new_n86_), .O(new_n87_));
  oai22  g036(.a(new_n87_), .b(new_n52_), .c(new_n64_), .d(x10), .O(z05));
  nor2   g037(.a(x25), .b(x24), .O(new_n89_));
  nand4  g038(.a(new_n89_), .b(new_n79_), .c(new_n68_), .d(new_n58_), .O(new_n90_));
  nand2  g039(.a(new_n90_), .b(new_n67_), .O(new_n91_));
  aoi21  g040(.a(new_n85_), .b(x25), .c(new_n91_), .O(new_n92_));
  oai22  g041(.a(new_n92_), .b(new_n52_), .c(new_n64_), .d(x09), .O(z06));
  nand2  g042(.a(new_n52_), .b(x08), .O(new_n94_));
  nor2   g043(.a(new_n90_), .b(x26), .O(new_n95_));
  nand2  g044(.a(new_n90_), .b(x26), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(x16), .O(new_n97_));
  oai21  g046(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n67_), .O(z07));
  inv1   g048(.a(new_n95_), .O(new_n100_));
  inv1   g049(.a(x25), .O(new_n101_));
  nor2   g050(.a(x27), .b(x26), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n85_), .O(new_n104_));
  aoi21  g053(.a(new_n100_), .b(x27), .c(new_n104_), .O(new_n105_));
  ...
  oai22  g060(.a(new_n111_), .b(new_n85_), .c(new_n104_), .d(new_n109_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x16), .O(new_n113_));
  inv1   g062(.a(x06), .O(new_n114_));
  aoi21  g063(.a(new_n52_), .b(new_n114_), .c(x18), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(new_n113_), .O(z09));
  oai21  g065(.a(new_n111_), .b(new_n85_), .c(x29), .O(new_n117_));
  ...
  oai21  g093(.a(new_n142_), .b(new_n52_), .c(new_n144_), .O(z12));
  oai21  g094(.a(new_n140_), .b(new_n85_), .c(x32), .O(new_n146_));
  inv1   g095(.a(new_n85_), .O(new_n147_));
  nor2   g096(.a(x32), .b(x31), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n127_), .c(new_n101_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n132_), .c(new_n147_), .O(new_n151_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n139_), .c(new_n130_), .d(new_n102_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n90_), .c(new_n67_), .O(new_n159_));
  aoi21  g108(.a(new_n151_), .b(x33), .c(new_n159_), .O(new_n160_));
  oai22  g109(.a(new_n160_), .b(new_n52_), .c(new_n64_), .d(x01), .O(z14));
  inv1   g110(.a(x00), .O(new_n162_));
  nand2  g111(.a(new_n63_), .b(new_n162_), .O(new_n163_));
  nor3   g112(.a(new_n158_), .b(new_n90_), .c(x34), .O(new_n164_));
  oai21  g113(.a(new_n158_), .b(new_n90_), .c(x34), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n67_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n164_), .c(x16), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n163_), .O(z15));
endmodule
