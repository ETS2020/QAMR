...
module FAU ( 
  ...
  nand2  g19(.a(new_n70_), .b(new_n53_), .O(new_n71_));
  nand2  g20(.a(new_n71_), .b(x16), .O(new_n72_));
  inv1   g21(.a(x28), .O(new_n73_));
  aoi21  g22(.a(new_n56_), .b(x13), .c(new_n73_), .O(new_n74_));
  oai21  g23(.a(new_n72_), .b(new_n69_), .c(new_n74_), .O(new_n75_));
  nand2  g24(.a(new_n75_), .b(new_n57_), .O(z02));
  nor2   g25(.a(x22), .b(x21), .O(new_n77_));
  aoi22  g26(.a(new_n77_), .b(new_n63_), .c(new_n71_), .d(x22), .O(new_n78_));
  nor2   g27(.a(x16), .b(x12), .O(new_n79_));
  nor2   g28(.a(new_n79_), .b(new_n58_), .O(new_n80_));
  oai21  g29(.a(new_n78_), .b(new_n56_), .c(new_n80_), .O(z03));
  inv1   g30(.a(x23), .O(new_n82_));
  aoi21  g31(.a(new_n77_), .b(new_n63_), .c(new_n82_), .O(new_n83_));
  nand4  g32(.a(new_n77_), .b(new_n53_), .c(new_n82_), .d(new_n61_), .O(new_n84_));
  inv1   g33(.a(new_n84_), .O(new_n85_));
  oai21  g34(.a(new_n85_), .b(new_n83_), .c(x16), .O(new_n86_));
  nor2   g35(.a(x16), .b(x11), .O(new_n87_));
  nor2   g36(.a(new_n87_), .b(new_n58_), .O(new_n88_));
  nand2  g37(.a(new_n88_), .b(new_n86_), .O(z04));
  nand2  g38(.a(new_n84_), .b(x24), .O(new_n90_));
  nor2   g39(.a(x24), .b(x23), .O(new_n91_));
  nand4  g40(.a(new_n91_), .b(new_n77_), .c(new_n53_), .d(new_n61_), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand2  g42(.a(new_n93_), .b(x16), .O(new_n94_));
  nor2   g43(.a(x16), .b(x10), .O(new_n95_));
  nor2   g44(.a(new_n95_), .b(new_n58_), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(new_n94_), .O(z05));
  nand2  g46(.a(new_n92_), .b(x25), .O(new_n98_));
  nor2   g47(.a(x25), .b(x22), .O(new_n99_));
  nand4  g48(.a(new_n99_), .b(new_n91_), .c(new_n70_), .d(new_n53_), .O(new_n100_));
  nand3  g49(.a(new_n100_), .b(new_n98_), .c(x16), .O(new_n101_));
  aoi21  g50(.a(new_n56_), .b(x09), .c(new_n73_), .O(new_n102_));
  nand2  g51(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(new_n57_), .O(z06));
  and2   g53(.a(new_n100_), .b(x26), .O(new_n105_));
  oai21  g54(.a(new_n100_), .b(x26), .c(x16), .O(new_n106_));
  aoi21  g55(.a(new_n56_), .b(x08), .c(new_n73_), .O(new_n107_));
  oai21  g56(.a(new_n106_), .b(new_n105_), .c(new_n107_), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n57_), .O(z07));
  oai21  g58(.a(new_n100_), .b(x26), .c(x27), .O(new_n110_));
  nor3   g59(.a(x27), .b(x26), .c(x25), .O(new_n111_));
  nand4  g60(.a(new_n111_), .b(new_n91_), .c(new_n77_), .d(new_n63_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x16), .O(new_n114_));
  nor2   g63(.a(x16), .b(x07), .O(new_n115_));
  nor2   g64(.a(new_n115_), .b(new_n58_), .O(new_n116_));
  nand2  g65(.a(new_n116_), .b(new_n114_), .O(z08));
  aoi21  g66(.a(new_n56_), .b(x06), .c(new_n73_), .O(new_n118_));
  oai21  g67(.a(new_n112_), .b(new_n56_), .c(new_n118_), .O(new_n119_));
  nand2  g68(.a(new_n119_), .b(new_n57_), .O(z09));
  nand2  g69(.a(new_n56_), .b(x05), .O(new_n121_));
  inv1   g70(.a(x29), .O(new_n122_));
  nand2  g71(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g72(.a(new_n123_), .b(new_n121_), .c(x28), .O(new_n124_));
  ...
  nand3  g77(.a(new_n128_), .b(new_n126_), .c(x28), .O(new_n129_));
  ...
  nand3  g82(.a(new_n133_), .b(new_n131_), .c(x28), .O(new_n134_));
  ...
  nand3  g87(.a(new_n138_), .b(new_n136_), .c(x28), .O(new_n139_));
  ...
  nand3  g92(.a(new_n143_), .b(new_n141_), .c(x28), .O(new_n144_));
  ...
  nand3  g97(.a(new_n148_), .b(new_n146_), .c(x28), .O(new_n149_));
