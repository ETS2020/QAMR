...
module FAU ( 
  ...
  xor2a  g24(.a(new_n71_), .b(x22), .O(new_n76_));
  nand2  g25(.a(x23), .b(new_n52_), .O(new_n77_));
  nor2   g26(.a(x16), .b(x12), .O(new_n78_));
  nor2   g27(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  oai21  g28(.a(new_n76_), .b(new_n57_), .c(new_n79_), .O(z03));
  oai21  g29(.a(new_n71_), .b(x22), .c(x16), .O(new_n81_));
  nor2   g30(.a(x16), .b(x11), .O(new_n82_));
  nor2   g31(.a(new_n82_), .b(new_n77_), .O(new_n83_));
  ...
  inv1   g38(.a(new_n77_), .O(new_n90_));
