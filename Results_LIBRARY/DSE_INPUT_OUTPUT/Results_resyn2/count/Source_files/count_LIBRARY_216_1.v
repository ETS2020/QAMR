...
module FAU ( 
  ...
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n53_), .d(new_n61_), .O(new_n92_));
  nand3  g041(.a(new_n92_), .b(new_n89_), .c(x16), .O(new_n93_));
  aoi21  g042(.a(new_n56_), .b(x10), .c(x18), .O(new_n94_));
  ...
  nand4  g047(.a(new_n98_), .b(new_n82_), .c(new_n68_), .d(new_n53_), .O(new_n99_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n91_), .c(new_n90_), .d(new_n60_), .O(new_n115_));
  ...
  aoi21  g074(.a(new_n56_), .b(x06), .c(x18), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n52_), .O(z09));
  nand4  g077(.a(new_n82_), .b(new_n68_), .c(new_n53_), .d(new_n120_), .O(new_n129_));
  ...
  aoi21  g082(.a(new_n56_), .b(x05), .c(x18), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n52_), .O(z10));
  nand4  g085(.a(new_n131_), .b(new_n82_), .c(new_n68_), .d(new_n53_), .O(new_n137_));
  ...
  aoi21  g092(.a(new_n56_), .b(x04), .c(x18), .O(new_n144_));
  ...
  aoi21  g100(.a(new_n56_), .b(x03), .c(x18), .O(new_n152_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n114_), .c(new_n156_), .d(new_n60_), .O(new_n158_));
  ...
  oai21  g112(.a(x16), .b(new_n163_), .c(new_n74_), .O(new_n164_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n149_), .c(new_n131_), .d(new_n167_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n99_), .c(new_n166_), .O(new_n170_));
  ...
  nor3   g123(.a(new_n169_), .b(new_n99_), .c(x34), .O(new_n175_));
  oai21  g124(.a(new_n169_), .b(new_n99_), .c(x34), .O(new_n176_));
