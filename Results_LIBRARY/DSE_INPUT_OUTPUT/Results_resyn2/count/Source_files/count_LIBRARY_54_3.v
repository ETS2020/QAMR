...
module FAU ( 
  ...
  nor2   g027(.a(new_n75_), .b(new_n78_), .O(new_n79_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n78_), .d(new_n73_), .O(new_n98_));
  inv1   g047(.a(new_n98_), .O(new_n99_));
  aoi22  g048(.a(new_n99_), .b(new_n66_), .c(new_n88_), .d(x24), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n69_), .c(new_n95_), .O(z05));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nor2   g051(.a(x22), .b(x21), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n102_), .c(new_n55_), .d(new_n64_), .O(new_n104_));
  inv1   g053(.a(x25), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n78_), .O(new_n106_));
  inv1   g055(.a(new_n106_), .O(new_n107_));
  aoi22  g056(.a(new_n107_), .b(new_n75_), .c(new_n104_), .d(x25), .O(new_n108_));
  ...
  oai21  g113(.a(new_n164_), .b(new_n88_), .c(x31), .O(new_n165_));
  inv1   g114(.a(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n154_), .c(new_n149_), .d(new_n153_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n99_), .d(new_n66_), .O(new_n169_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n168_), .c(new_n107_), .d(new_n75_), .O(new_n192_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n173_), .c(new_n163_), .d(new_n124_), .O(new_n201_));
