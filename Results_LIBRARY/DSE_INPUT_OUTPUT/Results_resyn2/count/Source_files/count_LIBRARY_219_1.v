...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n193_;
  nand2  g000(.a(x18), .b(x02), .O(new_n52_));
  ...
  aoi21  g012(.a(new_n57_), .b(new_n63_), .c(x18), .O(new_n64_));
  oai21  g013(.a(new_n62_), .b(new_n57_), .c(new_n64_), .O(z01));
  inv1   g014(.a(x21), .O(new_n66_));
  aoi21  g015(.a(new_n53_), .b(new_n61_), .c(new_n66_), .O(new_n67_));
  nand4  g016(.a(new_n66_), .b(new_n61_), .c(new_n55_), .d(new_n54_), .O(new_n68_));
  nand2  g017(.a(new_n68_), .b(x16), .O(new_n69_));
  aoi21  g018(.a(new_n57_), .b(x13), .c(x18), .O(new_n70_));
  ...
  nand4  g037(.a(new_n88_), .b(new_n74_), .c(new_n53_), .d(new_n73_), .O(new_n89_));
  inv1   g038(.a(new_n89_), .O(new_n90_));
  aoi21  g039(.a(new_n82_), .b(x24), .c(new_n90_), .O(new_n91_));
  inv1   g040(.a(x10), .O(new_n92_));
  aoi21  g041(.a(new_n57_), .b(new_n92_), .c(x18), .O(new_n93_));
  oai21  g042(.a(new_n91_), .b(new_n57_), .c(new_n93_), .O(z05));
  nand2  g043(.a(new_n89_), .b(x25), .O(new_n95_));
  nor2   g044(.a(x25), .b(x24), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n81_), .c(new_n74_), .d(new_n53_), .O(new_n97_));
  ...
  aoi21  g056(.a(new_n57_), .b(new_n107_), .c(x18), .O(new_n108_));
  ...
  oai21  g066(.a(new_n117_), .b(new_n114_), .c(new_n52_), .O(z08));
  oai21  g067(.a(new_n112_), .b(new_n89_), .c(x28), .O(new_n119_));
  inv1   g068(.a(new_n75_), .O(new_n120_));
  nor2   g069(.a(x26), .b(x25), .O(new_n121_));
  nor2   g070(.a(x28), .b(x27), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(new_n88_), .O(new_n123_));
  ...
  oai21  g081(.a(new_n123_), .b(new_n75_), .c(x29), .O(new_n133_));
  ...
  nand2  g085(.a(new_n136_), .b(new_n52_), .O(z10));
  inv1   g086(.a(x24), .O(new_n138_));
  nor2   g087(.a(x30), .b(x29), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n122_), .c(new_n121_), .d(new_n138_), .O(new_n140_));
  nor2   g089(.a(new_n140_), .b(new_n82_), .O(new_n141_));
  aoi21  g090(.a(new_n132_), .b(x30), .c(new_n141_), .O(new_n142_));
  inv1   g091(.a(x04), .O(new_n143_));
  aoi21  g092(.a(new_n57_), .b(new_n143_), .c(x18), .O(new_n144_));
  oai21  g093(.a(new_n142_), .b(new_n57_), .c(new_n144_), .O(z11));
  nand2  g094(.a(new_n139_), .b(new_n122_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n103_), .c(new_n83_), .O(new_n148_));
  nor2   g097(.a(x31), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n139_), .c(new_n111_), .d(new_n110_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n89_), .c(x16), .O(new_n151_));
  aoi21  g100(.a(new_n148_), .b(x31), .c(new_n151_), .O(new_n152_));
  inv1   g101(.a(x03), .O(new_n153_));
  oai21  g102(.a(x16), .b(new_n153_), .c(new_n116_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n152_), .c(new_n52_), .O(z12));
  oai21  g104(.a(new_n150_), .b(new_n89_), .c(x32), .O(new_n156_));
  nor2   g105(.a(x32), .b(x31), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n139_), .c(new_n122_), .d(new_n121_), .O(new_n158_));
  inv1   g107(.a(new_n158_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n90_), .O(new_n160_));
  ...
  aoi21  g115(.a(new_n159_), .b(new_n90_), .c(new_n166_), .O(new_n167_));
  nor2   g116(.a(x33), .b(x32), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n149_), .c(new_n139_), .d(new_n111_), .O(new_n169_));
  nor2   g118(.a(new_n169_), .b(new_n97_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n167_), .c(x16), .O(new_n171_));
  inv1   g120(.a(x01), .O(new_n172_));
  aoi21  g121(.a(new_n57_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n171_), .O(z14));
  inv1   g123(.a(x34), .O(new_n175_));
  inv1   g124(.a(x23), .O(new_n176_));
  nand4  g125(.a(new_n110_), .b(new_n138_), .c(new_n176_), .d(new_n73_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n68_), .O(new_n178_));
  ...
  oai21  g138(.a(new_n169_), .b(new_n97_), .c(x34), .O(new_n190_));
  nand3  g139(.a(new_n190_), .b(new_n189_), .c(x16), .O(new_n191_));
  aoi21  g140(.a(new_n57_), .b(x00), .c(x18), .O(new_n192_));
