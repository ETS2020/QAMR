...
module FAU ( 
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n55_), .d(new_n63_), .O(new_n98_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n95_), .c(new_n102_), .d(new_n77_), .O(new_n104_));
  inv1   g053(.a(new_n104_), .O(new_n105_));
  aoi22  g054(.a(new_n105_), .b(new_n72_), .c(new_n98_), .d(x25), .O(new_n106_));
  ...
  nor2   g070(.a(new_n121_), .b(new_n98_), .O(new_n122_));
  ...
  nand4  g075(.a(new_n95_), .b(new_n102_), .c(new_n77_), .d(new_n70_), .O(new_n127_));
  inv1   g076(.a(new_n127_), .O(new_n128_));
  nor3   g077(.a(x27), .b(x26), .c(x25), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n128_), .c(new_n65_), .O(new_n130_));
  nor2   g079(.a(x26), .b(x25), .O(new_n131_));
  nor2   g080(.a(x28), .b(x27), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n131_), .c(new_n96_), .O(new_n133_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n132_), .c(new_n131_), .d(new_n95_), .O(new_n164_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n129_), .c(new_n128_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n163_), .c(new_n120_), .d(new_n103_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n98_), .c(x32), .O(new_n177_));
  inv1   g126(.a(x26), .O(new_n178_));
  inv1   g127(.a(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n166_), .c(new_n178_), .d(new_n103_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n128_), .d(new_n65_), .O(new_n182_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n168_), .c(new_n105_), .d(new_n72_), .O(new_n192_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n175_), .c(new_n163_), .d(new_n120_), .O(new_n203_));
