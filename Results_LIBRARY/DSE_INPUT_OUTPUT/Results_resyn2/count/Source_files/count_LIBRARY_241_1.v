...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n181_, new_n182_;
  nand2  g000(.a(x18), .b(x10), .O(new_n52_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n84_), .c(new_n72_), .d(new_n53_), .O(new_n98_));
  nand4  g047(.a(new_n90_), .b(new_n84_), .c(new_n53_), .d(new_n60_), .O(new_n99_));
  ...
  nand4  g066(.a(new_n117_), .b(new_n90_), .c(new_n84_), .d(new_n63_), .O(new_n118_));
  ...
  aoi21  g102(.a(new_n56_), .b(x03), .c(x18), .O(new_n154_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n117_), .c(new_n92_), .d(new_n63_), .O(new_n158_));
  ...
  oai21  g112(.a(x16), .b(new_n163_), .c(new_n62_), .O(new_n164_));
