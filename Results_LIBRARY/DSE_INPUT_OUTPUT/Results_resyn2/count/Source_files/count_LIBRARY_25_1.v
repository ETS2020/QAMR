...
module FAU ( 
  ...
  nand3  g028(.a(new_n67_), .b(new_n58_), .c(new_n77_), .O(new_n80_));
  ...
  nand3  g033(.a(new_n84_), .b(new_n67_), .c(new_n58_), .O(new_n85_));
  ...
  inv1   g039(.a(new_n75_), .O(new_n91_));
  ...
  oai22  g045(.a(new_n96_), .b(new_n52_), .c(new_n91_), .d(x10), .O(z05));
  nor2   g046(.a(x25), .b(x24), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n84_), .c(new_n67_), .d(new_n58_), .O(new_n99_));
  nand2  g048(.a(new_n99_), .b(new_n79_), .O(new_n100_));
  aoi21  g049(.a(new_n94_), .b(x25), .c(new_n100_), .O(new_n101_));
  oai22  g050(.a(new_n101_), .b(new_n52_), .c(new_n91_), .d(x09), .O(z06));
  inv1   g051(.a(x08), .O(new_n103_));
  nand2  g052(.a(new_n75_), .b(new_n103_), .O(new_n104_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n105_), .c(new_n79_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n104_), .O(z07));
  inv1   g062(.a(x27), .O(new_n114_));
  nor2   g063(.a(new_n108_), .b(new_n85_), .O(new_n115_));
  nor3   g064(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n93_), .c(new_n92_), .d(new_n60_), .O(new_n117_));
  ...
  nand3  g072(.a(new_n123_), .b(new_n107_), .c(new_n92_), .O(new_n124_));
  ...
  oai21  g078(.a(new_n124_), .b(new_n80_), .c(x29), .O(new_n130_));
  nor3   g079(.a(x29), .b(x28), .c(x27), .O(new_n131_));
  nand3  g080(.a(new_n131_), .b(new_n109_), .c(new_n86_), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n79_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  inv1   g083(.a(x05), .O(new_n135_));
  nand2  g084(.a(new_n75_), .b(new_n135_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n134_), .O(z10));
  inv1   g086(.a(x29), .O(new_n138_));
  nand4  g087(.a(new_n123_), .b(new_n107_), .c(new_n138_), .d(new_n106_), .O(new_n139_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n109_), .c(new_n86_), .O(new_n144_));
  ...
  nor2   g100(.a(x31), .b(x28), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n141_), .c(new_n151_), .d(new_n150_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n94_), .c(new_n79_), .O(new_n154_));
  aoi21  g103(.a(new_n144_), .b(x31), .c(new_n154_), .O(new_n155_));
  inv1   g104(.a(x03), .O(new_n156_));
  nand2  g105(.a(new_n75_), .b(new_n156_), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n52_), .c(new_n157_), .O(z12));
  oai21  g107(.a(new_n153_), .b(new_n94_), .c(x32), .O(new_n159_));
  nand2  g108(.a(new_n93_), .b(new_n92_), .O(new_n160_));
  inv1   g109(.a(new_n160_), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n107_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n143_), .c(new_n161_), .d(new_n60_), .O(new_n165_));
  ...
  nand4  g119(.a(new_n162_), .b(new_n141_), .c(new_n123_), .d(new_n107_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n94_), .c(x33), .O(new_n172_));
  nand2  g121(.a(new_n98_), .b(new_n84_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand2  g123(.a(new_n152_), .b(new_n141_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  nor2   g125(.a(x33), .b(x32), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n151_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n176_), .c(new_n174_), .d(new_n69_), .O(new_n180_));
  ...
  nor2   g135(.a(new_n180_), .b(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n177_), .b(new_n152_), .c(new_n141_), .d(new_n151_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n99_), .c(new_n186_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(x16), .O(new_n190_));
  inv1   g139(.a(x00), .O(new_n191_));
  aoi21  g140(.a(new_n52_), .b(new_n191_), .c(x18), .O(new_n192_));
  oai21  g141(.a(new_n190_), .b(new_n187_), .c(new_n192_), .O(z15));
endmodule
