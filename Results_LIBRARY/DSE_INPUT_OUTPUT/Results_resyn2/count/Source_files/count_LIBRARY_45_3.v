...
module FAU ( 
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n78_), .d(new_n73_), .O(new_n96_));
  ...
  oai21  g089(.a(new_n135_), .b(new_n81_), .c(x29), .O(new_n141_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n166_), .c(new_n107_), .d(new_n75_), .O(new_n194_));
