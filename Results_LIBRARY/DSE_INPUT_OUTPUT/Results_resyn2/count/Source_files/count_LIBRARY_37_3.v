...
module FAU ( 
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n78_), .d(new_n71_), .O(new_n96_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n78_), .O(new_n106_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n87_), .c(new_n80_), .d(new_n55_), .O(new_n113_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n76_), .c(new_n123_), .O(z08));
  nor3   g077(.a(x27), .b(x26), .c(x25), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n97_), .c(new_n63_), .O(new_n130_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n81_), .c(x29), .O(new_n141_));
  nor3   g090(.a(x29), .b(x28), .c(x27), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n115_), .c(new_n89_), .O(new_n143_));
  ...
  nand4  g098(.a(new_n132_), .b(new_n131_), .c(new_n149_), .d(new_n95_), .O(new_n150_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n115_), .c(new_n89_), .O(new_n157_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n132_), .c(new_n131_), .d(new_n95_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n88_), .c(x31), .O(new_n163_));
  inv1   g112(.a(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n154_), .c(new_n149_), .d(new_n153_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n129_), .c(new_n97_), .d(new_n63_), .O(new_n167_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n161_), .c(new_n124_), .d(new_n105_), .O(new_n176_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n97_), .d(new_n63_), .O(new_n182_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n179_), .c(new_n152_), .d(new_n178_), .O(new_n192_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n175_), .c(new_n161_), .d(new_n124_), .O(new_n203_));
