...
module FAU ( 
  ...
  nand3  g080(.a(new_n131_), .b(new_n96_), .c(new_n64_), .O(new_n132_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n96_), .d(new_n64_), .O(new_n169_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n96_), .d(new_n64_), .O(new_n182_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n168_), .c(new_n109_), .d(new_n72_), .O(new_n194_));
