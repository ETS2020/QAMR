...
module FAU ( 
  ...
  nand2  g15(.a(new_n53_), .b(new_n66_), .O(new_n67_));
  nand3  g16(.a(new_n67_), .b(new_n65_), .c(new_n61_), .O(z02));
  nand2  g17(.a(x22), .b(x16), .O(new_n69_));
  inv1   g18(.a(x12), .O(new_n70_));
  nand2  g19(.a(new_n53_), .b(new_n70_), .O(new_n71_));
  nand3  g20(.a(new_n71_), .b(new_n69_), .c(new_n61_), .O(z03));
  nand2  g21(.a(new_n53_), .b(x11), .O(new_n73_));
  inv1   g22(.a(x23), .O(new_n74_));
  nand2  g23(.a(new_n74_), .b(x16), .O(new_n75_));
  nand3  g24(.a(new_n75_), .b(new_n73_), .c(x19), .O(new_n76_));
  nand2  g25(.a(new_n76_), .b(new_n52_), .O(z04));
  nand2  g26(.a(new_n53_), .b(x10), .O(new_n78_));
  inv1   g27(.a(x24), .O(new_n79_));
  nand2  g28(.a(new_n79_), .b(x16), .O(new_n80_));
  nand3  g29(.a(new_n80_), .b(new_n78_), .c(x19), .O(new_n81_));
  nand2  g30(.a(new_n81_), .b(new_n52_), .O(z05));
  nand2  g31(.a(x25), .b(x16), .O(new_n83_));
  inv1   g32(.a(x09), .O(new_n84_));
  nand2  g33(.a(new_n53_), .b(new_n84_), .O(new_n85_));
  nand3  g34(.a(new_n85_), .b(new_n83_), .c(new_n61_), .O(z06));
  nand2  g35(.a(x26), .b(x16), .O(new_n87_));
  inv1   g36(.a(x08), .O(new_n88_));
  nand2  g37(.a(new_n53_), .b(new_n88_), .O(new_n89_));
  nand3  g38(.a(new_n89_), .b(new_n87_), .c(new_n61_), .O(z07));
  ...
  nand3  g47(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(z09));
  nand2  g48(.a(x29), .b(x16), .O(new_n100_));
  inv1   g49(.a(x05), .O(new_n101_));
  nand2  g50(.a(new_n53_), .b(new_n101_), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n100_), .c(new_n61_), .O(z10));
  nand2  g52(.a(new_n53_), .b(x04), .O(new_n104_));
  inv1   g53(.a(x30), .O(new_n105_));
  nand2  g54(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g55(.a(new_n106_), .b(new_n104_), .c(x19), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n52_), .O(z11));
  nand2  g57(.a(x31), .b(x16), .O(new_n109_));
  inv1   g58(.a(x03), .O(new_n110_));
  nand2  g59(.a(new_n53_), .b(new_n110_), .O(new_n111_));
  nand3  g60(.a(new_n111_), .b(new_n109_), .c(new_n61_), .O(z12));
  nand2  g61(.a(x32), .b(x16), .O(new_n113_));
  inv1   g62(.a(x02), .O(new_n114_));
  nand2  g63(.a(new_n53_), .b(new_n114_), .O(new_n115_));
  nand3  g64(.a(new_n115_), .b(new_n113_), .c(new_n61_), .O(z13));
  nand2  g65(.a(x33), .b(x16), .O(new_n117_));
  inv1   g66(.a(x01), .O(new_n118_));
  nand2  g67(.a(new_n53_), .b(new_n118_), .O(new_n119_));
  nand3  g68(.a(new_n119_), .b(new_n117_), .c(new_n61_), .O(z14));
  nand2  g69(.a(x34), .b(x16), .O(new_n121_));
  inv1   g70(.a(x00), .O(new_n122_));
  nand2  g71(.a(new_n53_), .b(new_n122_), .O(new_n123_));
  nand3  g72(.a(new_n123_), .b(new_n121_), .c(new_n61_), .O(z15));
endmodule
