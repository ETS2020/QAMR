...
module FAU ( 
  ...
  oai21  g019(.a(x18), .b(new_n70_), .c(new_n56_), .O(new_n71_));
  nand2  g020(.a(new_n55_), .b(new_n64_), .O(new_n72_));
  ...
  aoi22  g046(.a(new_n97_), .b(new_n66_), .c(new_n90_), .d(x24), .O(new_n98_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n97_), .c(new_n66_), .O(new_n132_));
  ...
  nand4  g096(.a(new_n134_), .b(new_n133_), .c(new_n147_), .d(new_n95_), .O(new_n148_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n152_), .c(new_n147_), .d(new_n151_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n97_), .d(new_n66_), .O(new_n169_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n163_), .c(new_n124_), .d(new_n107_), .O(new_n174_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n97_), .d(new_n66_), .O(new_n180_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n177_), .c(new_n150_), .d(new_n176_), .O(new_n190_));
