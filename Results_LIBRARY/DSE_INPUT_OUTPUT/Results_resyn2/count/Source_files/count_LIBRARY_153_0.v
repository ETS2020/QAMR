...
module FAU ( 
  ...
  nand2  g48(.a(x28), .b(x16), .O(new_n100_));
  inv1   g49(.a(x06), .O(new_n101_));
  nand2  g50(.a(new_n56_), .b(new_n101_), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n100_), .c(new_n85_), .O(z09));
  nand2  g52(.a(x29), .b(x16), .O(new_n104_));
  inv1   g53(.a(x05), .O(new_n105_));
  nand2  g54(.a(new_n56_), .b(new_n105_), .O(new_n106_));
  nand3  g55(.a(new_n106_), .b(new_n104_), .c(new_n85_), .O(z10));
  nand2  g56(.a(x30), .b(x16), .O(new_n108_));
  inv1   g57(.a(x04), .O(new_n109_));
  nand2  g58(.a(new_n56_), .b(new_n109_), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(new_n85_), .O(z11));
  nand2  g60(.a(new_n56_), .b(x03), .O(new_n112_));
  inv1   g61(.a(x31), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x16), .O(new_n114_));
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(x21), .O(new_n115_));
  nand2  g64(.a(new_n115_), .b(new_n57_), .O(z12));
  nand2  g65(.a(new_n56_), .b(x02), .O(new_n117_));
  inv1   g66(.a(x32), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g68(.a(new_n119_), .b(new_n117_), .c(x21), .O(new_n120_));
  nand2  g69(.a(new_n120_), .b(new_n57_), .O(z13));
  nand2  g70(.a(x33), .b(x16), .O(new_n122_));
  inv1   g71(.a(x01), .O(new_n123_));
  nand2  g72(.a(new_n56_), .b(new_n123_), .O(new_n124_));
  nand3  g73(.a(new_n124_), .b(new_n122_), .c(new_n85_), .O(z14));
  nand2  g74(.a(x34), .b(x16), .O(new_n126_));
  inv1   g75(.a(x00), .O(new_n127_));
  nand2  g76(.a(new_n56_), .b(new_n127_), .O(new_n128_));
  nand3  g77(.a(new_n128_), .b(new_n126_), .c(new_n85_), .O(z15));
endmodule
