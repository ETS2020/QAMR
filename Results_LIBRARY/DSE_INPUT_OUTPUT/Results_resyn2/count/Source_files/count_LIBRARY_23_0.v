...
module FAU ( 
  ...
  nand3  g15(.a(new_n66_), .b(new_n64_), .c(x16), .O(new_n67_));
  aoi21  g16(.a(new_n58_), .b(x14), .c(new_n60_), .O(new_n68_));
  nand2  g17(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g18(.a(new_n69_), .b(new_n63_), .O(z01));
  aoi21  g19(.a(new_n58_), .b(x13), .c(new_n60_), .O(new_n71_));
  oai21  g20(.a(new_n66_), .b(new_n58_), .c(new_n71_), .O(new_n72_));
  nand2  g21(.a(new_n72_), .b(new_n63_), .O(z02));
  nand2  g22(.a(new_n58_), .b(x12), .O(new_n74_));
  inv1   g23(.a(x22), .O(new_n75_));
  nand2  g24(.a(new_n75_), .b(x16), .O(new_n76_));
  nand3  g25(.a(new_n76_), .b(new_n74_), .c(x21), .O(new_n77_));
  nand2  g26(.a(new_n77_), .b(new_n63_), .O(z03));
  nand2  g27(.a(new_n58_), .b(x11), .O(new_n79_));
  inv1   g28(.a(x23), .O(new_n80_));
  nand2  g29(.a(new_n80_), .b(x16), .O(new_n81_));
  nand3  g30(.a(new_n81_), .b(new_n79_), .c(x21), .O(new_n82_));
  nand2  g31(.a(new_n82_), .b(new_n63_), .O(z04));
  nand2  g32(.a(x24), .b(x16), .O(new_n84_));
  inv1   g33(.a(x10), .O(new_n85_));
  nand2  g34(.a(new_n58_), .b(new_n85_), .O(new_n86_));
  nand3  g35(.a(new_n86_), .b(new_n84_), .c(new_n61_), .O(z05));
  nand2  g36(.a(new_n58_), .b(x09), .O(new_n88_));
  inv1   g37(.a(x25), .O(new_n89_));
  nand2  g38(.a(new_n89_), .b(x16), .O(new_n90_));
  nand3  g39(.a(new_n90_), .b(new_n88_), .c(x21), .O(new_n91_));
  ...
  nand3  g44(.a(new_n95_), .b(new_n93_), .c(x21), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(new_n63_), .O(z07));
  nand2  g46(.a(x27), .b(x16), .O(new_n98_));
  inv1   g47(.a(x07), .O(new_n99_));
  nand2  g48(.a(new_n58_), .b(new_n99_), .O(new_n100_));
  nand3  g49(.a(new_n100_), .b(new_n98_), .c(new_n61_), .O(z08));
  nand2  g50(.a(new_n58_), .b(x06), .O(new_n102_));
  inv1   g51(.a(x28), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(x16), .O(new_n104_));
  nand3  g53(.a(new_n104_), .b(new_n102_), .c(x21), .O(new_n105_));
  nand2  g54(.a(new_n105_), .b(new_n63_), .O(z09));
  ...
  nand2  g80(.a(new_n131_), .b(new_n63_), .O(z15));
endmodule
