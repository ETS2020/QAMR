...
module FAU ( 
  ...
  nor2   g016(.a(x18), .b(x16), .O(new_n68_));
  ...
  oai21  g024(.a(new_n69_), .b(x13), .c(new_n75_), .O(z02));
  inv1   g025(.a(x12), .O(new_n77_));
  nand2  g026(.a(new_n68_), .b(new_n77_), .O(new_n78_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n79_), .d(new_n70_), .O(new_n96_));
  inv1   g045(.a(new_n96_), .O(new_n97_));
  aoi22  g046(.a(new_n97_), .b(new_n63_), .c(new_n88_), .d(x24), .O(new_n98_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n102_), .c(new_n55_), .d(new_n61_), .O(new_n104_));
  ...
  oai22  g057(.a(new_n108_), .b(new_n58_), .c(new_n69_), .d(x09), .O(z06));
  inv1   g058(.a(x08), .O(new_n110_));
  nand2  g059(.a(new_n68_), .b(new_n110_), .O(new_n111_));
  ...
  nand3  g063(.a(new_n114_), .b(new_n112_), .c(new_n72_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n111_), .O(z07));
  inv1   g066(.a(x27), .O(new_n118_));
  aoi21  g067(.a(new_n113_), .b(new_n89_), .c(new_n118_), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n103_), .c(new_n102_), .d(new_n63_), .O(new_n121_));
  ...
  nand3  g077(.a(new_n128_), .b(new_n127_), .c(new_n102_), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n83_), .c(new_n72_), .O(new_n130_));
  aoi21  g079(.a(new_n121_), .b(x28), .c(new_n130_), .O(new_n131_));
  oai22  g080(.a(new_n131_), .b(new_n58_), .c(new_n69_), .d(x06), .O(z09));
  oai21  g081(.a(new_n129_), .b(new_n83_), .c(x29), .O(new_n133_));
  nor3   g082(.a(x29), .b(x28), .c(x27), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n113_), .c(new_n89_), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n72_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(x16), .O(new_n137_));
  inv1   g086(.a(x05), .O(new_n138_));
  nand2  g087(.a(new_n68_), .b(new_n138_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n137_), .O(z10));
  inv1   g089(.a(x29), .O(new_n141_));
  nand4  g090(.a(new_n128_), .b(new_n127_), .c(new_n141_), .d(new_n95_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n88_), .c(x30), .O(new_n143_));
  inv1   g092(.a(x28), .O(new_n144_));
  inv1   g093(.a(x30), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n141_), .c(new_n144_), .d(new_n118_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n113_), .c(new_n89_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n143_), .c(new_n72_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g099(.a(x04), .O(new_n151_));
  nand2  g100(.a(new_n68_), .b(new_n151_), .O(new_n152_));
  ...
  nor2   g105(.a(x31), .b(x28), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n154_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n104_), .c(new_n72_), .O(new_n159_));
  aoi21  g108(.a(new_n148_), .b(x31), .c(new_n159_), .O(new_n160_));
  inv1   g109(.a(x03), .O(new_n161_));
  nand2  g110(.a(new_n68_), .b(new_n161_), .O(new_n162_));
  oai21  g111(.a(new_n160_), .b(new_n58_), .c(new_n162_), .O(z12));
  oai21  g112(.a(new_n158_), .b(new_n104_), .c(x32), .O(new_n164_));
  ...
  nand4  g118(.a(new_n169_), .b(new_n147_), .c(new_n97_), .d(new_n63_), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n164_), .c(new_n72_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(x16), .O(new_n172_));
  inv1   g121(.a(x02), .O(new_n173_));
  nand2  g122(.a(new_n68_), .b(new_n173_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n172_), .O(z13));
  nor2   g124(.a(x32), .b(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n156_), .c(new_n128_), .d(new_n127_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n104_), .c(x33), .O(new_n178_));
  nand4  g127(.a(new_n154_), .b(new_n95_), .c(new_n94_), .d(new_n79_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n166_), .b(new_n145_), .c(new_n141_), .d(new_n144_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  inv1   g131(.a(x33), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n167_), .c(new_n118_), .d(new_n165_), .O(new_n184_));
  inv1   g133(.a(new_n184_), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n182_), .c(new_n180_), .d(new_n80_), .O(new_n186_));
  nand3  g135(.a(new_n186_), .b(new_n178_), .c(new_n72_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(x16), .O(new_n188_));
  inv1   g137(.a(x01), .O(new_n189_));
  nand2  g138(.a(new_n68_), .b(new_n189_), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(new_n188_), .O(z14));
  inv1   g140(.a(new_n106_), .O(new_n192_));
  nand4  g141(.a(new_n185_), .b(new_n182_), .c(new_n192_), .d(x34), .O(new_n193_));
  inv1   g142(.a(x34), .O(new_n194_));
  nand2  g143(.a(new_n186_), .b(new_n194_), .O(new_n195_));
