...
module FAU ( 
  ...
  oai21  g033(.a(new_n84_), .b(new_n81_), .c(new_n75_), .O(new_n85_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n80_), .d(new_n71_), .O(new_n98_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n80_), .O(new_n106_));
  ...
  nand3  g081(.a(new_n132_), .b(new_n131_), .c(new_n102_), .O(new_n133_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n166_), .c(new_n107_), .d(new_n73_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n190_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n75_), .O(new_n196_));
