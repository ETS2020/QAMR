...
module FAU ( 
  ...
  nand4  g040(.a(new_n81_), .b(new_n91_), .c(new_n56_), .d(new_n90_), .O(new_n92_));
  nor2   g041(.a(x25), .b(x24), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n81_), .c(new_n91_), .d(new_n56_), .O(new_n94_));
  ...
  nand3  g061(.a(new_n112_), .b(new_n111_), .c(new_n69_), .O(new_n113_));
  ...
  oai21  g070(.a(new_n119_), .b(new_n61_), .c(new_n121_), .O(z09));
  oai21  g071(.a(new_n117_), .b(new_n92_), .c(x29), .O(new_n123_));
  inv1   g072(.a(x23), .O(new_n124_));
  inv1   g073(.a(x25), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n90_), .c(new_n124_), .d(new_n74_), .O(new_n126_));
  inv1   g075(.a(new_n126_), .O(new_n127_));
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n75_), .d(new_n103_), .O(new_n129_));
  ...
  nand3  g094(.a(new_n145_), .b(new_n137_), .c(new_n110_), .O(new_n146_));
  ...
  nand3  g102(.a(new_n153_), .b(new_n103_), .c(new_n125_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n139_), .c(new_n109_), .O(new_n156_));
  ...
  oai21  g113(.a(new_n164_), .b(new_n94_), .c(new_n69_), .O(new_n165_));
