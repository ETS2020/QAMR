...
module FAU ( 
  ...
  aoi21  g025(.a(new_n71_), .b(new_n53_), .c(new_n76_), .O(new_n77_));
  nand3  g026(.a(new_n71_), .b(new_n53_), .c(new_n76_), .O(new_n78_));
  ...
  nand4  g046(.a(new_n91_), .b(new_n85_), .c(new_n53_), .d(new_n60_), .O(new_n98_));
  nor2   g047(.a(x25), .b(x24), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n85_), .c(new_n71_), .d(new_n53_), .O(new_n100_));
  ...
  nand4  g064(.a(new_n115_), .b(new_n91_), .c(new_n85_), .d(new_n63_), .O(new_n116_));
  ...
  nand4  g073(.a(new_n124_), .b(new_n99_), .c(new_n79_), .d(new_n106_), .O(new_n125_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n99_), .c(new_n106_), .d(new_n132_), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n78_), .c(x29), .O(new_n135_));
  ...
  nor3   g090(.a(new_n141_), .b(new_n107_), .c(new_n86_), .O(new_n142_));
  ...
  nand4  g105(.a(new_n156_), .b(new_n115_), .c(new_n93_), .d(new_n63_), .O(new_n157_));
  ...
  oai21  g118(.a(new_n160_), .b(new_n98_), .c(x33), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n169_), .c(x16), .O(new_n171_));
  aoi21  g120(.a(new_n56_), .b(x01), .c(x18), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n52_), .O(z14));
  nand3  g123(.a(new_n168_), .b(new_n101_), .c(x34), .O(new_n175_));
