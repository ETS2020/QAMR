...
module FAU ( 
  ...
  nand2  g008(.a(new_n59_), .b(x06), .O(new_n60_));
  ...
  nor2   g020(.a(new_n71_), .b(new_n60_), .O(new_n72_));
  ...
  nand3  g031(.a(new_n82_), .b(new_n69_), .c(new_n55_), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n81_), .c(x16), .O(new_n84_));
  inv1   g033(.a(x06), .O(new_n85_));
  aoi21  g034(.a(new_n58_), .b(x11), .c(new_n85_), .O(new_n86_));
  ...
  aoi21  g042(.a(new_n58_), .b(x10), .c(new_n85_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g044(.a(new_n95_), .b(new_n59_), .O(z05));
  nand2  g045(.a(new_n92_), .b(x25), .O(new_n97_));
  nor2   g046(.a(x25), .b(x24), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n82_), .c(new_n69_), .d(new_n55_), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n97_), .c(x16), .O(new_n100_));
  aoi21  g049(.a(new_n58_), .b(x09), .c(new_n85_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n59_), .O(z06));
  ...
  nand4  g063(.a(new_n104_), .b(new_n114_), .c(new_n79_), .d(new_n113_), .O(new_n115_));
  nor2   g064(.a(new_n115_), .b(new_n68_), .O(new_n116_));
  ...
  aoi21  g072(.a(new_n58_), .b(x07), .c(new_n85_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n59_), .O(z08));
  inv1   g075(.a(new_n60_), .O(new_n127_));
  inv1   g076(.a(x28), .O(new_n128_));
  nand4  g077(.a(new_n105_), .b(new_n90_), .c(new_n128_), .d(new_n119_), .O(new_n129_));
  nor2   g078(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  aoi21  g079(.a(new_n122_), .b(x28), .c(new_n130_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n58_), .c(new_n127_), .O(z09));
  oai21  g081(.a(new_n129_), .b(new_n80_), .c(x29), .O(new_n133_));
  inv1   g082(.a(new_n83_), .O(new_n134_));
  inv1   g083(.a(x29), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n128_), .c(new_n104_), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n120_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n133_), .c(x16), .O(new_n139_));
  aoi21  g088(.a(new_n58_), .b(x05), .c(new_n85_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n59_), .O(z10));
  nor2   g091(.a(x29), .b(x28), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n105_), .c(new_n119_), .d(new_n104_), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n83_), .c(x30), .O(new_n145_));
  inv1   g094(.a(x30), .O(new_n146_));
  nand3  g095(.a(new_n137_), .b(new_n134_), .c(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n145_), .c(x16), .O(new_n148_));
  aoi21  g097(.a(new_n58_), .b(x04), .c(new_n85_), .O(new_n149_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n146_), .c(new_n135_), .d(new_n128_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n120_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n116_), .c(new_n159_), .O(new_n163_));
  oai21  g112(.a(new_n153_), .b(new_n92_), .c(x32), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n163_), .c(x16), .O(new_n165_));
  aoi21  g114(.a(new_n58_), .b(x02), .c(new_n85_), .O(new_n166_));
  ...
  nor3   g125(.a(new_n171_), .b(new_n99_), .c(x34), .O(new_n177_));
  oai21  g126(.a(new_n171_), .b(new_n99_), .c(x34), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  aoi21  g128(.a(new_n58_), .b(x00), .c(new_n85_), .O(new_n180_));
  oai21  g129(.a(new_n179_), .b(new_n177_), .c(new_n180_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n59_), .O(z15));
endmodule
