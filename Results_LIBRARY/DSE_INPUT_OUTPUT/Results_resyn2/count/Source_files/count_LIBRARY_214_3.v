...
module FAU ( 
  ...
  nand3  g076(.a(new_n127_), .b(new_n100_), .c(new_n74_), .O(new_n128_));
  ...
  nand4  g096(.a(new_n132_), .b(new_n119_), .c(new_n147_), .d(new_n98_), .O(new_n148_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n121_), .c(new_n94_), .O(new_n155_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n127_), .c(new_n100_), .d(new_n74_), .O(new_n167_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n161_), .c(new_n132_), .d(new_n119_), .O(new_n190_));
  ...
  nand4  g152(.a(new_n203_), .b(new_n174_), .c(new_n161_), .d(new_n173_), .O(new_n204_));
