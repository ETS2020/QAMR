...
module FAU ( 
  ...
  nand3  g036(.a(new_n87_), .b(new_n78_), .c(new_n55_), .O(new_n88_));
  inv1   g037(.a(new_n88_), .O(new_n89_));
  aoi21  g038(.a(new_n79_), .b(x23), .c(new_n89_), .O(new_n90_));
  nor2   g039(.a(x18), .b(new_n58_), .O(new_n91_));
  inv1   g040(.a(new_n91_), .O(new_n92_));
  oai21  g041(.a(new_n92_), .b(new_n90_), .c(new_n86_), .O(z04));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n76_), .d(new_n69_), .O(new_n98_));
  inv1   g047(.a(new_n98_), .O(new_n99_));
  aoi22  g048(.a(new_n99_), .b(new_n63_), .c(new_n88_), .d(x24), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n92_), .c(new_n95_), .O(z05));
  ...
  nand4  g054(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n76_), .O(new_n106_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n87_), .c(new_n78_), .d(new_n55_), .O(new_n115_));
  ...
  nand2  g068(.a(new_n119_), .b(new_n91_), .O(new_n120_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n92_), .c(new_n123_), .O(z08));
  ...
  oai21  g087(.a(new_n133_), .b(new_n79_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n117_), .c(new_n89_), .O(new_n141_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n117_), .c(new_n89_), .O(new_n155_));
  ...
  nand2  g132(.a(new_n183_), .b(new_n91_), .O(new_n184_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n166_), .c(new_n107_), .d(new_n71_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n190_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n91_), .O(new_n196_));
