...
module FAU ( 
  ...
  nor2   g10(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nor2   g11(.a(new_n54_), .b(x20), .O(new_n63_));
  oai21  g12(.a(new_n63_), .b(new_n62_), .c(x16), .O(new_n64_));
  nand2  g13(.a(new_n64_), .b(new_n59_), .O(z01));
  nand2  g14(.a(new_n61_), .b(new_n60_), .O(new_n66_));
  nor2   g15(.a(x21), .b(x20), .O(new_n67_));
  nand2  g16(.a(new_n67_), .b(new_n61_), .O(new_n68_));
  inv1   g17(.a(new_n68_), .O(new_n69_));
  aoi21  g18(.a(new_n66_), .b(x21), .c(new_n69_), .O(new_n70_));
  oai21  g19(.a(new_n70_), .b(new_n55_), .c(new_n59_), .O(z02));
  xor2a  g20(.a(new_n68_), .b(x22), .O(new_n72_));
  oai21  g21(.a(new_n72_), .b(new_n55_), .c(new_n59_), .O(z03));
  oai21  g22(.a(new_n68_), .b(x22), .c(x23), .O(new_n74_));
  nor2   g23(.a(x23), .b(x22), .O(new_n75_));
  nand3  g24(.a(new_n75_), .b(new_n67_), .c(new_n61_), .O(new_n76_));
  nand3  g25(.a(new_n76_), .b(new_n74_), .c(new_n56_), .O(z04));
  nor2   g26(.a(x24), .b(x21), .O(new_n78_));
  nand4  g27(.a(new_n78_), .b(new_n75_), .c(new_n61_), .d(new_n60_), .O(new_n79_));
  inv1   g28(.a(new_n79_), .O(new_n80_));
  aoi21  g29(.a(new_n76_), .b(x24), .c(new_n80_), .O(new_n81_));
  oai21  g30(.a(new_n81_), .b(new_n55_), .c(new_n59_), .O(z05));
  nor2   g31(.a(x25), .b(x24), .O(new_n83_));
  nand4  g32(.a(new_n83_), .b(new_n75_), .c(new_n67_), .d(new_n61_), .O(new_n84_));
  nand2  g33(.a(new_n79_), .b(x25), .O(new_n85_));
  nand3  g34(.a(new_n85_), .b(new_n84_), .c(new_n56_), .O(z06));
  nand2  g35(.a(new_n84_), .b(x26), .O(new_n87_));
  inv1   g36(.a(new_n76_), .O(new_n88_));
  inv1   g37(.a(x26), .O(new_n89_));
  nand2  g38(.a(new_n83_), .b(new_n89_), .O(new_n90_));
  inv1   g39(.a(new_n90_), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand3  g41(.a(new_n92_), .b(new_n87_), .c(new_n56_), .O(z07));
  ...
  aoi21  g46(.a(new_n92_), .b(x27), .c(new_n97_), .O(new_n98_));
  oai21  g47(.a(new_n98_), .b(new_n55_), .c(new_n59_), .O(z08));
  oai21  g48(.a(new_n96_), .b(new_n79_), .c(x28), .O(new_n100_));
  inv1   g49(.a(x22), .O(new_n101_));
  nor3   g50(.a(x28), .b(x27), .c(x23), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n91_), .c(new_n69_), .d(new_n101_), .O(new_n103_));
  nand3  g52(.a(new_n103_), .b(new_n100_), .c(new_n56_), .O(z09));
  nor2   g53(.a(new_n90_), .b(new_n76_), .O(new_n105_));
  nor2   g54(.a(x29), .b(x28), .O(new_n106_));
  nand3  g55(.a(new_n106_), .b(new_n105_), .c(new_n94_), .O(new_n107_));
  nand2  g56(.a(new_n103_), .b(x29), .O(new_n108_));
  nand3  g57(.a(new_n108_), .b(new_n107_), .c(new_n56_), .O(z10));
  nand2  g58(.a(new_n107_), .b(x30), .O(new_n110_));
  inv1   g59(.a(x30), .O(new_n111_));
  nand4  g60(.a(new_n106_), .b(new_n105_), .c(new_n111_), .d(new_n94_), .O(new_n112_));
  nand3  g61(.a(new_n112_), .b(new_n110_), .c(new_n56_), .O(z11));
  nand2  g62(.a(new_n112_), .b(x31), .O(new_n114_));
  nor2   g63(.a(x31), .b(x30), .O(new_n115_));
  nand4  g64(.a(new_n115_), .b(new_n106_), .c(new_n95_), .d(new_n94_), .O(new_n116_));
  or2    g65(.a(new_n116_), .b(new_n79_), .O(new_n117_));
  nand3  g66(.a(new_n117_), .b(new_n114_), .c(new_n56_), .O(z12));
  oai21  g67(.a(new_n116_), .b(new_n79_), .c(x32), .O(new_n119_));
  nand2  g68(.a(new_n78_), .b(new_n75_), .O(new_n120_));
  inv1   g69(.a(new_n120_), .O(new_n121_));
  inv1   g70(.a(x28), .O(new_n122_));
  inv1   g71(.a(x29), .O(new_n123_));
  inv1   g72(.a(x31), .O(new_n124_));
  nand4  g73(.a(new_n124_), .b(new_n111_), .c(new_n123_), .d(new_n122_), .O(new_n125_));
  ...
  nand4  g78(.a(new_n129_), .b(new_n126_), .c(new_n121_), .d(new_n63_), .O(new_n130_));
  nand2  g79(.a(new_n130_), .b(new_n119_), .O(new_n131_));
  nand2  g80(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g81(.a(new_n132_), .b(new_n59_), .O(z13));
  nand4  g82(.a(new_n127_), .b(new_n115_), .c(new_n106_), .d(new_n95_), .O(new_n134_));
  ...
  nand4  g87(.a(new_n138_), .b(new_n137_), .c(new_n94_), .d(new_n89_), .O(new_n139_));
  ...
  nand2  g92(.a(new_n143_), .b(new_n59_), .O(z14));
