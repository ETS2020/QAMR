...
module FAU ( 
  ...
  and2   g029(.a(new_n80_), .b(new_n65_), .O(new_n81_));
  ...
  aoi21  g033(.a(new_n84_), .b(new_n82_), .c(new_n53_), .O(z03));
  inv1   g034(.a(x23), .O(new_n86_));
  nand4  g035(.a(new_n80_), .b(new_n57_), .c(new_n86_), .d(new_n63_), .O(new_n87_));
  oai21  g036(.a(new_n81_), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g043(.a(new_n86_), .b(new_n78_), .c(new_n70_), .O(new_n95_));
  nor2   g044(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nor2   g045(.a(x24), .b(x23), .O(new_n97_));
  nand4  g046(.a(new_n97_), .b(new_n80_), .c(new_n57_), .d(new_n63_), .O(new_n98_));
  ...
  oai21  g055(.a(new_n106_), .b(new_n87_), .c(new_n104_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(x16), .O(new_n108_));
  inv1   g057(.a(x09), .O(new_n109_));
  aoi21  g058(.a(new_n60_), .b(new_n109_), .c(x18), .O(new_n110_));
  aoi21  g059(.a(new_n110_), .b(new_n108_), .c(new_n53_), .O(z06));
  oai21  g060(.a(new_n106_), .b(new_n87_), .c(x26), .O(new_n112_));
  ...
  aoi21  g067(.a(new_n118_), .b(new_n116_), .c(new_n53_), .O(z07));
  ...
  inv1   g075(.a(new_n53_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nor2   g077(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  oai21  g078(.a(new_n124_), .b(new_n60_), .c(new_n129_), .O(z08));
  inv1   g079(.a(x28), .O(new_n131_));
  nor2   g080(.a(new_n123_), .b(new_n131_), .O(new_n132_));
  nand3  g081(.a(new_n121_), .b(new_n131_), .c(new_n120_), .O(new_n133_));
  ...
  aoi21  g086(.a(new_n137_), .b(new_n135_), .c(new_n53_), .O(z09));
  nor3   g087(.a(x23), .b(x22), .c(x21), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n113_), .c(new_n139_), .d(new_n65_), .O(new_n141_));
  oai21  g090(.a(new_n134_), .b(new_n52_), .c(new_n141_), .O(new_n142_));
  ...
  oai21  g095(.a(new_n133_), .b(new_n98_), .c(x30), .O(new_n147_));
  inv1   g096(.a(x27), .O(new_n148_));
  nor2   g097(.a(x30), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n113_), .c(new_n96_), .d(new_n148_), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n147_), .c(x29), .O(new_n151_));
  inv1   g100(.a(x30), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n52_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(x31), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n151_), .c(x16), .O(new_n156_));
  oai21  g105(.a(new_n153_), .b(new_n126_), .c(x16), .O(new_n157_));
  aoi21  g106(.a(new_n126_), .b(x04), .c(new_n53_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n156_), .O(z11));
  oai21  g109(.a(x16), .b(x03), .c(new_n126_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n127_), .O(new_n162_));
  nand2  g111(.a(new_n52_), .b(new_n131_), .O(new_n163_));
  oai21  g112(.a(new_n141_), .b(x30), .c(x31), .O(new_n164_));
  inv1   g113(.a(x31), .O(new_n165_));
  nand3  g114(.a(new_n123_), .b(new_n165_), .c(new_n152_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n163_), .c(new_n164_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(x16), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n162_), .O(z12));
  oai21  g118(.a(x16), .b(x02), .c(new_n126_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n127_), .O(new_n171_));
  inv1   g120(.a(x26), .O(new_n172_));
  nand4  g121(.a(new_n149_), .b(new_n105_), .c(new_n148_), .d(new_n172_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n87_), .c(x32), .O(new_n174_));
  nand2  g123(.a(new_n97_), .b(new_n80_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  nor3   g125(.a(x27), .b(x26), .c(x25), .O(new_n177_));
  inv1   g126(.a(x32), .O(new_n178_));
  nand3  g127(.a(new_n149_), .b(new_n178_), .c(new_n165_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n177_), .c(new_n176_), .d(new_n65_), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n174_), .c(x29), .O(new_n182_));
  nor2   g131(.a(new_n178_), .b(new_n165_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n182_), .c(x16), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n171_), .O(z13));
  nand4  g134(.a(new_n177_), .b(new_n97_), .c(new_n80_), .d(new_n65_), .O(new_n186_));
  oai21  g135(.a(new_n179_), .b(new_n186_), .c(x33), .O(new_n187_));
  nor2   g136(.a(x33), .b(x32), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n131_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n166_), .c(new_n187_), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(x16), .O(new_n191_));
  nand2  g140(.a(x33), .b(x16), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(x31), .c(new_n52_), .O(new_n193_));
  oai21  g142(.a(x16), .b(x01), .c(new_n126_), .O(new_n194_));
  nor2   g143(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n191_), .O(z14));
  oai21  g145(.a(x16), .b(x00), .c(new_n126_), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n127_), .O(new_n198_));
  nand4  g147(.a(new_n188_), .b(new_n149_), .c(new_n121_), .d(new_n120_), .O(new_n199_));
  ...
  nand4  g152(.a(new_n203_), .b(new_n180_), .c(new_n105_), .d(new_n96_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n200_), .c(x29), .O(new_n205_));
  and2   g154(.a(x34), .b(x31), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n205_), .c(x16), .O(new_n207_));
  nand2  g156(.a(new_n207_), .b(new_n198_), .O(z15));
endmodule
