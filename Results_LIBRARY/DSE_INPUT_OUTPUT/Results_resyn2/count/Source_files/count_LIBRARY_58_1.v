...
module FAU ( 
  ...
  nand2  g000(.a(x18), .b(x07), .O(new_n52_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n77_), .c(new_n53_), .d(new_n61_), .O(new_n94_));
  ...
  oai21  g052(.a(x16), .b(x09), .c(new_n74_), .O(new_n104_));
  or2    g053(.a(new_n104_), .b(new_n103_), .O(z06));
  nand2  g054(.a(new_n102_), .b(x26), .O(new_n106_));
  nor3   g055(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n100_), .c(new_n60_), .O(new_n108_));
  ...
  nand2  g060(.a(new_n111_), .b(new_n52_), .O(z07));
  inv1   g061(.a(new_n94_), .O(new_n113_));
  nor3   g062(.a(x27), .b(x26), .c(x25), .O(new_n114_));
  aoi22  g063(.a(new_n114_), .b(new_n113_), .c(new_n108_), .d(x27), .O(new_n115_));
  ...
  nand2  g067(.a(new_n114_), .b(new_n113_), .O(new_n119_));
  ...
  oai21  g075(.a(new_n121_), .b(new_n78_), .c(x29), .O(new_n127_));
  ...
  nor2   g089(.a(new_n140_), .b(new_n108_), .O(new_n141_));
  ...
  oai21  g110(.a(x16), .b(new_n161_), .c(new_n74_), .O(new_n162_));
