...
module FAU ( 
  ...
  nand2  g000(.a(x18), .b(x12), .O(new_n52_));
  ...
  aoi21  g021(.a(new_n57_), .b(x13), .c(x18), .O(new_n73_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n76_), .d(new_n68_), .O(new_n92_));
  nor2   g041(.a(new_n92_), .b(new_n62_), .O(new_n93_));
  aoi21  g042(.a(new_n84_), .b(x24), .c(new_n93_), .O(new_n94_));
  inv1   g043(.a(x10), .O(new_n95_));
  aoi21  g044(.a(new_n57_), .b(new_n95_), .c(x18), .O(new_n96_));
  oai21  g045(.a(new_n94_), .b(new_n57_), .c(new_n96_), .O(z05));
  nor2   g046(.a(x24), .b(x23), .O(new_n98_));
  nor2   g047(.a(x22), .b(x21), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n53_), .d(new_n61_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n83_), .c(new_n70_), .d(new_n53_), .O(new_n103_));
  nand3  g052(.a(new_n103_), .b(new_n101_), .c(x16), .O(new_n104_));
  aoi21  g053(.a(new_n57_), .b(x09), .c(x18), .O(new_n105_));
  ...
  nand3  g058(.a(new_n109_), .b(new_n108_), .c(new_n91_), .O(new_n110_));
  ...
  aoi21  g062(.a(new_n57_), .b(new_n113_), .c(x18), .O(new_n114_));
  oai21  g063(.a(new_n112_), .b(new_n57_), .c(new_n114_), .O(z07));
  inv1   g064(.a(x27), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n109_), .c(new_n108_), .O(new_n117_));
  oai22  g066(.a(new_n117_), .b(new_n100_), .c(new_n111_), .d(new_n116_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n123_), .b(new_n93_), .c(new_n108_), .O(new_n124_));
  inv1   g073(.a(x28), .O(new_n125_));
  nor2   g074(.a(x26), .b(x25), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n98_), .c(new_n125_), .d(new_n116_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n77_), .c(x16), .O(new_n128_));
  aoi21  g077(.a(new_n124_), .b(x28), .c(new_n128_), .O(new_n129_));
  inv1   g078(.a(x06), .O(new_n130_));
  inv1   g079(.a(x18), .O(new_n131_));
  oai21  g080(.a(x16), .b(new_n130_), .c(new_n131_), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n129_), .c(new_n52_), .O(z09));
  oai21  g082(.a(new_n127_), .b(new_n77_), .c(x29), .O(new_n134_));
  nor2   g083(.a(x29), .b(x28), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n126_), .c(new_n116_), .d(new_n91_), .O(new_n136_));
  ...
  aoi21  g088(.a(new_n57_), .b(new_n139_), .c(x18), .O(new_n140_));
  ...
  aoi21  g105(.a(new_n57_), .b(new_n156_), .c(x18), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n57_), .c(new_n157_), .O(z12));
  inv1   g107(.a(x32), .O(new_n159_));
  inv1   g108(.a(x31), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n143_), .c(new_n144_), .d(new_n125_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n117_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n93_), .c(new_n159_), .O(new_n163_));
  oai21  g112(.a(new_n153_), .b(new_n100_), .c(x32), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n163_), .c(x16), .O(new_n165_));
  aoi21  g114(.a(new_n57_), .b(x02), .c(x18), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n52_), .O(z13));
  nor2   g117(.a(x33), .b(x32), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n152_), .c(new_n135_), .d(new_n123_), .O(new_n170_));
  ...
  nor3   g124(.a(new_n170_), .b(new_n103_), .c(x34), .O(new_n176_));
  oai21  g125(.a(new_n170_), .b(new_n103_), .c(x34), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(x16), .O(new_n178_));
  aoi21  g127(.a(new_n57_), .b(x00), .c(x18), .O(new_n179_));
