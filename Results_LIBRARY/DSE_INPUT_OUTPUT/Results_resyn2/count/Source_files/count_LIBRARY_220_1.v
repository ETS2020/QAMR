...
module FAU ( 
  ...
  aoi21  g026(.a(new_n70_), .b(x22), .c(new_n56_), .O(new_n78_));
  ...
  aoi22  g041(.a(new_n92_), .b(new_n62_), .c(new_n84_), .d(x24), .O(new_n93_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n69_), .d(new_n53_), .O(new_n98_));
  nand4  g047(.a(new_n90_), .b(new_n83_), .c(new_n53_), .d(new_n63_), .O(new_n99_));
  ...
  nand4  g066(.a(new_n117_), .b(new_n90_), .c(new_n83_), .d(new_n62_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x16), .O(new_n119_));
  aoi21  g068(.a(new_n56_), .b(x07), .c(x18), .O(new_n120_));
  ...
  aoi21  g090(.a(new_n56_), .b(x04), .c(x18), .O(new_n142_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n117_), .c(new_n92_), .d(new_n62_), .O(new_n155_));
  ...
  aoi21  g119(.a(new_n56_), .b(x01), .c(x18), .O(new_n171_));
