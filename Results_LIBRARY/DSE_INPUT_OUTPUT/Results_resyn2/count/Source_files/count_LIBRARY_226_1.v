...
module FAU ( 
  ...
  nand2  g021(.a(new_n66_), .b(new_n72_), .O(new_n73_));
  aoi21  g022(.a(new_n65_), .b(x22), .c(new_n52_), .O(new_n74_));
  ...
  nand2  g026(.a(new_n77_), .b(new_n71_), .O(z03));
  ...
  nand4  g036(.a(new_n79_), .b(new_n64_), .c(new_n58_), .d(new_n86_), .O(new_n88_));
  ...
  nor2   g044(.a(new_n88_), .b(x25), .O(new_n96_));
  ...
  nand3  g060(.a(new_n103_), .b(new_n89_), .c(new_n110_), .O(new_n112_));
  ...
  nand2  g064(.a(new_n115_), .b(new_n71_), .O(z08));
  nor2   g065(.a(x28), .b(x27), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n103_), .c(new_n86_), .O(new_n118_));
  ...
  nand4  g080(.a(new_n131_), .b(new_n130_), .c(new_n103_), .d(new_n86_), .O(new_n132_));
  ...
  oai21  g086(.a(new_n137_), .b(new_n134_), .c(new_n71_), .O(z11));
  nor2   g087(.a(new_n104_), .b(x27), .O(new_n139_));
  nor2   g088(.a(x31), .b(x30), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n130_), .c(new_n139_), .d(new_n89_), .O(new_n141_));
  oai21  g090(.a(new_n132_), .b(new_n80_), .c(x31), .O(new_n142_));
  ...
  nand2  g094(.a(new_n145_), .b(new_n71_), .O(z12));
  nor2   g095(.a(x32), .b(x31), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n131_), .c(new_n130_), .O(new_n148_));
  nor3   g097(.a(new_n148_), .b(new_n104_), .c(new_n88_), .O(new_n149_));
  ...
  nand2  g103(.a(new_n154_), .b(new_n105_), .O(new_n155_));
  ...
  nor3   g107(.a(new_n158_), .b(new_n88_), .c(x25), .O(new_n159_));
  ...
  nand2  g114(.a(new_n89_), .b(new_n94_), .O(new_n166_));
