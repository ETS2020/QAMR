...
module FAU ( 
  ...
  oai22  g045(.a(new_n96_), .b(new_n61_), .c(new_n53_), .d(x09), .O(z06));
  inv1   g046(.a(x08), .O(new_n98_));
  nand2  g047(.a(new_n52_), .b(new_n98_), .O(new_n99_));
  nor2   g048(.a(new_n94_), .b(x26), .O(new_n100_));
  inv1   g049(.a(x26), .O(new_n101_));
  inv1   g050(.a(new_n94_), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(new_n103_));
  oai21  g052(.a(new_n103_), .b(new_n100_), .c(x16), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n99_), .O(z07));
  nand2  g054(.a(new_n102_), .b(new_n101_), .O(new_n106_));
  inv1   g055(.a(x25), .O(new_n107_));
  nor2   g056(.a(x27), .b(x26), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nor2   g058(.a(new_n109_), .b(new_n92_), .O(new_n110_));
  ...
  oai22  g066(.a(new_n117_), .b(new_n92_), .c(new_n110_), .d(new_n115_), .O(new_n118_));
  ...
  oai21  g071(.a(new_n117_), .b(new_n92_), .c(x29), .O(new_n123_));
  inv1   g072(.a(x22), .O(new_n124_));
  inv1   g073(.a(x23), .O(new_n125_));
  nand4  g074(.a(new_n107_), .b(new_n90_), .c(new_n125_), .d(new_n124_), .O(new_n126_));
  inv1   g075(.a(new_n126_), .O(new_n127_));
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n70_), .d(new_n101_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n123_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(x16), .O(new_n131_));
  inv1   g080(.a(x05), .O(new_n132_));
  aoi21  g081(.a(new_n61_), .b(new_n132_), .c(x18), .O(new_n133_));
  ...
  aoi22  g088(.a(new_n139_), .b(new_n100_), .c(new_n129_), .d(x30), .O(new_n140_));
  inv1   g089(.a(x04), .O(new_n141_));
  aoi21  g090(.a(new_n61_), .b(new_n141_), .c(x18), .O(new_n142_));
  oai21  g091(.a(new_n140_), .b(new_n61_), .c(new_n142_), .O(z11));
  nand3  g092(.a(new_n139_), .b(new_n102_), .c(new_n101_), .O(new_n144_));
  nor2   g093(.a(x31), .b(x30), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n137_), .c(new_n116_), .O(new_n146_));
  ...
  oai21  g099(.a(new_n148_), .b(new_n61_), .c(new_n150_), .O(z12));
  oai21  g100(.a(new_n146_), .b(new_n92_), .c(x32), .O(new_n152_));
  inv1   g101(.a(new_n92_), .O(new_n153_));
  nor2   g102(.a(x32), .b(x31), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n101_), .c(new_n107_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n145_), .c(new_n137_), .d(new_n108_), .O(new_n164_));
  ...
  oai21  g117(.a(new_n166_), .b(new_n61_), .c(new_n168_), .O(z14));
  ...
  nand2  g122(.a(new_n173_), .b(new_n83_), .O(new_n174_));
