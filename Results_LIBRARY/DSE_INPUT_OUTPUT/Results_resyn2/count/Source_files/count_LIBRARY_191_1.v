...
module FAU ( 
  ...
  nand3  g030(.a(new_n81_), .b(new_n56_), .c(new_n78_), .O(new_n82_));
  ...
  nand3  g035(.a(new_n86_), .b(new_n81_), .c(new_n56_), .O(new_n87_));
  ...
  aoi21  g047(.a(new_n66_), .b(new_n98_), .c(x18), .O(new_n99_));
  oai21  g048(.a(new_n97_), .b(new_n66_), .c(new_n99_), .O(z05));
  nand4  g049(.a(new_n94_), .b(new_n93_), .c(new_n56_), .d(new_n61_), .O(new_n101_));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n86_), .c(new_n81_), .d(new_n56_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n71_), .O(new_n104_));
  aoi21  g053(.a(new_n101_), .b(x25), .c(new_n104_), .O(new_n105_));
  oai22  g054(.a(new_n105_), .b(new_n66_), .c(new_n53_), .d(x09), .O(z06));
  nand2  g055(.a(new_n103_), .b(x26), .O(new_n107_));
  ...
  aoi21  g067(.a(new_n109_), .b(x27), .c(new_n118_), .O(new_n119_));
  inv1   g068(.a(x07), .O(new_n120_));
  aoi21  g069(.a(new_n66_), .b(new_n120_), .c(x18), .O(new_n121_));
  oai21  g070(.a(new_n119_), .b(new_n66_), .c(new_n121_), .O(z08));
  nor3   g071(.a(x27), .b(x26), .c(x25), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n96_), .c(new_n63_), .O(new_n124_));
  nor2   g073(.a(x26), .b(x25), .O(new_n125_));
  nor2   g074(.a(x28), .b(x27), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n125_), .c(new_n93_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n82_), .c(new_n71_), .O(new_n128_));
  aoi21  g077(.a(new_n124_), .b(x28), .c(new_n128_), .O(new_n129_));
  inv1   g078(.a(x06), .O(new_n130_));
  nand2  g079(.a(new_n52_), .b(new_n130_), .O(new_n131_));
  oai21  g080(.a(new_n129_), .b(new_n66_), .c(new_n131_), .O(z09));
  oai21  g081(.a(new_n127_), .b(new_n82_), .c(x29), .O(new_n133_));
  nor3   g082(.a(x29), .b(x28), .c(x27), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n108_), .c(new_n88_), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n71_), .O(new_n136_));
  ...
  nand4  g091(.a(new_n126_), .b(new_n125_), .c(new_n142_), .d(new_n141_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n87_), .c(x30), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n126_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n108_), .c(new_n88_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g099(.a(x04), .O(new_n151_));
  aoi21  g100(.a(new_n66_), .b(new_n151_), .c(x18), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n150_), .O(z11));
  nand4  g102(.a(new_n145_), .b(new_n126_), .c(new_n125_), .d(new_n141_), .O(new_n154_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n123_), .c(new_n96_), .d(new_n63_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n155_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g112(.a(x03), .O(new_n164_));
  aoi21  g113(.a(new_n66_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n163_), .O(z12));
  nor2   g115(.a(x31), .b(x28), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n145_), .c(new_n116_), .d(new_n115_), .O(new_n168_));
  ...
  nand4  g121(.a(new_n172_), .b(new_n147_), .c(new_n96_), .d(new_n63_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(x16), .O(new_n175_));
  inv1   g124(.a(x02), .O(new_n176_));
  aoi21  g125(.a(new_n66_), .b(new_n176_), .c(x18), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n175_), .O(z13));
  nand4  g127(.a(new_n170_), .b(new_n145_), .c(new_n126_), .d(new_n125_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n101_), .c(x33), .O(new_n180_));
  inv1   g129(.a(x23), .O(new_n181_));
  nand4  g130(.a(new_n115_), .b(new_n141_), .c(new_n181_), .d(new_n78_), .O(new_n182_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n160_), .c(new_n183_), .d(new_n79_), .O(new_n190_));
  nand3  g139(.a(new_n190_), .b(new_n180_), .c(new_n71_), .O(new_n191_));
  ...
  inv1   g144(.a(new_n103_), .O(new_n196_));
  nand4  g145(.a(new_n189_), .b(new_n160_), .c(new_n196_), .d(x34), .O(new_n197_));
  inv1   g146(.a(x34), .O(new_n198_));
  nand2  g147(.a(new_n190_), .b(new_n198_), .O(new_n199_));
  nand3  g148(.a(new_n199_), .b(new_n197_), .c(x16), .O(new_n200_));
  inv1   g149(.a(x00), .O(new_n201_));
  aoi21  g150(.a(new_n66_), .b(new_n201_), .c(x18), .O(new_n202_));
