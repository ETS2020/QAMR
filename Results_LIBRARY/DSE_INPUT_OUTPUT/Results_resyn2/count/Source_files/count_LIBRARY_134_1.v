...
module FAU ( 
  ...
  nand2  g071(.a(new_n109_), .b(new_n115_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n96_), .c(x29), .O(new_n124_));
  ...
  aoi21  g078(.a(new_n67_), .b(new_n129_), .c(x18), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g080(.a(x30), .O(new_n132_));
  aoi21  g081(.a(new_n125_), .b(new_n103_), .c(new_n132_), .O(new_n133_));
  inv1   g082(.a(x26), .O(new_n134_));
  inv1   g083(.a(new_n98_), .O(new_n135_));
  inv1   g084(.a(x27), .O(new_n136_));
  nor2   g085(.a(x29), .b(x28), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n132_), .c(new_n136_), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n135_), .c(new_n134_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n54_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n133_), .c(x16), .O(new_n142_));
  ...
  nand3  g095(.a(new_n146_), .b(new_n137_), .c(new_n109_), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  aoi21  g097(.a(new_n140_), .b(x31), .c(new_n148_), .O(new_n149_));
  inv1   g098(.a(x03), .O(new_n150_));
  aoi21  g099(.a(new_n67_), .b(new_n150_), .c(x18), .O(new_n151_));
  oai21  g100(.a(new_n149_), .b(new_n67_), .c(new_n151_), .O(z12));
  oai21  g101(.a(new_n147_), .b(new_n96_), .c(x32), .O(new_n153_));
  nor2   g102(.a(x26), .b(x25), .O(new_n154_));
  nor2   g103(.a(x32), .b(x31), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n139_), .d(new_n108_), .O(new_n156_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n146_), .c(new_n137_), .d(new_n162_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n98_), .O(new_n165_));
  aoi21  g114(.a(new_n156_), .b(x33), .c(new_n165_), .O(new_n166_));
  inv1   g115(.a(x01), .O(new_n167_));
  aoi21  g116(.a(new_n67_), .b(new_n167_), .c(x18), .O(new_n168_));
  oai21  g117(.a(new_n166_), .b(new_n67_), .c(new_n168_), .O(z14));
  inv1   g118(.a(x00), .O(new_n170_));
  nand2  g119(.a(new_n52_), .b(new_n170_), .O(new_n171_));
  nor3   g120(.a(new_n164_), .b(new_n98_), .c(x34), .O(new_n172_));
  inv1   g121(.a(x34), .O(new_n173_));
  oai21  g122(.a(new_n165_), .b(new_n173_), .c(new_n54_), .O(new_n174_));
