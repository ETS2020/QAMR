...
module FAU ( 
  ...
  nor2   g30(.a(x23), .b(x22), .O(new_n82_));
  nand4  g31(.a(new_n82_), .b(new_n53_), .c(new_n69_), .d(new_n61_), .O(new_n83_));
  nand2  g32(.a(new_n77_), .b(x23), .O(new_n84_));
  ...
  nand4  g39(.a(new_n90_), .b(new_n76_), .c(new_n53_), .d(new_n61_), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(x16), .O(new_n93_));
  nor2   g42(.a(x16), .b(x10), .O(new_n94_));
  nor2   g43(.a(new_n94_), .b(new_n66_), .O(new_n95_));
  nand2  g44(.a(new_n95_), .b(new_n93_), .O(z05));
  nor2   g45(.a(x25), .b(x22), .O(new_n97_));
  nand4  g46(.a(new_n97_), .b(new_n90_), .c(new_n63_), .d(new_n69_), .O(new_n98_));
  nand2  g47(.a(new_n91_), .b(x25), .O(new_n99_));
  nand3  g48(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  aoi21  g49(.a(new_n56_), .b(x09), .c(new_n57_), .O(new_n101_));
  nand2  g50(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g51(.a(new_n102_), .b(new_n52_), .O(z06));
  nand2  g52(.a(new_n98_), .b(x16), .O(new_n104_));
  nor2   g53(.a(x16), .b(x08), .O(new_n105_));
  nor2   g54(.a(new_n105_), .b(new_n66_), .O(new_n106_));
  nand2  g55(.a(new_n106_), .b(new_n104_), .O(z07));
  nand2  g56(.a(new_n56_), .b(x07), .O(new_n108_));
  inv1   g57(.a(x27), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(x16), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(x26), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n52_), .O(z08));
  inv1   g61(.a(new_n66_), .O(new_n113_));
  nand2  g62(.a(x28), .b(x16), .O(new_n114_));
  inv1   g63(.a(x06), .O(new_n115_));
  nand2  g64(.a(new_n56_), .b(new_n115_), .O(new_n116_));
  nand3  g65(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z09));
  nand2  g66(.a(new_n56_), .b(x05), .O(new_n118_));
  inv1   g67(.a(x29), .O(new_n119_));
  nand2  g68(.a(new_n119_), .b(x16), .O(new_n120_));
  nand3  g69(.a(new_n120_), .b(new_n118_), .c(x26), .O(new_n121_));
  nand2  g70(.a(new_n121_), .b(new_n52_), .O(z10));
  nand2  g71(.a(new_n56_), .b(x04), .O(new_n123_));
  inv1   g72(.a(x30), .O(new_n124_));
  nand2  g73(.a(new_n124_), .b(x16), .O(new_n125_));
  nand3  g74(.a(new_n125_), .b(new_n123_), .c(x26), .O(new_n126_));
  nand2  g75(.a(new_n126_), .b(new_n52_), .O(z11));
  nand2  g76(.a(x31), .b(x16), .O(new_n128_));
  inv1   g77(.a(x03), .O(new_n129_));
  nand2  g78(.a(new_n56_), .b(new_n129_), .O(new_n130_));
  nand3  g79(.a(new_n130_), .b(new_n128_), .c(new_n113_), .O(z12));
  nand2  g80(.a(new_n56_), .b(x02), .O(new_n132_));
  inv1   g81(.a(x32), .O(new_n133_));
  nand2  g82(.a(new_n133_), .b(x16), .O(new_n134_));
  nand3  g83(.a(new_n134_), .b(new_n132_), .c(x26), .O(new_n135_));
  nand2  g84(.a(new_n135_), .b(new_n52_), .O(z13));
  nand2  g85(.a(new_n56_), .b(x01), .O(new_n137_));
  inv1   g86(.a(x33), .O(new_n138_));
  nand2  g87(.a(new_n138_), .b(x16), .O(new_n139_));
  nand3  g88(.a(new_n139_), .b(new_n137_), .c(x26), .O(new_n140_));
  nand2  g89(.a(new_n140_), .b(new_n52_), .O(z14));
  nand2  g90(.a(new_n56_), .b(x00), .O(new_n142_));
  inv1   g91(.a(x34), .O(new_n143_));
  nand2  g92(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g93(.a(new_n144_), .b(new_n142_), .c(x26), .O(new_n145_));
  nand2  g94(.a(new_n145_), .b(new_n52_), .O(z15));
endmodule
