...
module FAU ( 
  ...
  aoi21  g022(.a(new_n73_), .b(new_n55_), .c(new_n71_), .O(new_n74_));
  aoi22  g023(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(x13), .O(z02));
  inv1   g024(.a(x22), .O(new_n76_));
  nand3  g025(.a(new_n73_), .b(new_n55_), .c(new_n76_), .O(new_n77_));
  inv1   g026(.a(x21), .O(new_n78_));
  nand4  g027(.a(new_n78_), .b(new_n63_), .c(new_n53_), .d(new_n52_), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(x22), .O(new_n80_));
  nand3  g029(.a(new_n80_), .b(new_n77_), .c(x16), .O(new_n81_));
  aoi21  g030(.a(new_n58_), .b(x12), .c(x18), .O(new_n82_));
  nand2  g031(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g032(.a(new_n83_), .b(new_n62_), .O(z03));
  nor2   g033(.a(x23), .b(x22), .O(new_n85_));
  nand3  g034(.a(new_n85_), .b(new_n73_), .c(new_n55_), .O(new_n86_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n73_), .c(new_n55_), .d(new_n76_), .O(new_n93_));
  nand2  g042(.a(new_n86_), .b(x24), .O(new_n94_));
  nand3  g043(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  aoi21  g044(.a(new_n58_), .b(x10), .c(x18), .O(new_n96_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n76_), .O(new_n102_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n85_), .c(new_n73_), .d(new_n55_), .O(new_n111_));
  ...
  oai21  g071(.a(x16), .b(new_n122_), .c(new_n70_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n121_), .c(new_n62_), .O(z08));
  oai21  g073(.a(new_n119_), .b(new_n77_), .c(x28), .O(new_n125_));
  inv1   g074(.a(new_n77_), .O(new_n126_));
  nor2   g075(.a(x28), .b(x27), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n118_), .c(new_n92_), .O(new_n128_));
  ...
  nand3  g084(.a(new_n135_), .b(new_n108_), .c(new_n87_), .O(new_n136_));
  oai21  g085(.a(new_n128_), .b(new_n77_), .c(x29), .O(new_n137_));
  ...
  nand2  g089(.a(new_n140_), .b(new_n62_), .O(z10));
  nor2   g090(.a(x30), .b(x29), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n127_), .c(new_n118_), .d(new_n100_), .O(new_n143_));
  ...
  nand2  g109(.a(new_n160_), .b(new_n62_), .O(z12));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n142_), .c(new_n127_), .d(new_n118_), .O(new_n163_));
  ...
  oai21  g117(.a(new_n163_), .b(new_n93_), .c(x33), .O(new_n169_));
  inv1   g118(.a(x26), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  inv1   g120(.a(x33), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n171_), .c(new_n117_), .d(new_n170_), .O(new_n173_));
  ...
  nand3  g130(.a(new_n174_), .b(new_n103_), .c(new_n181_), .O(new_n182_));
