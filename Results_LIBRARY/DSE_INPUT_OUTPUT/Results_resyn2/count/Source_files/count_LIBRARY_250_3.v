...
module FAU ( 
  ...
  nand4  g061(.a(new_n112_), .b(new_n87_), .c(new_n78_), .d(new_n55_), .O(new_n113_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n97_), .c(new_n63_), .O(new_n132_));
  ...
  oai21  g086(.a(new_n137_), .b(new_n92_), .c(new_n130_), .O(z09));
  ...
  nand4  g115(.a(new_n166_), .b(new_n131_), .c(new_n97_), .d(new_n63_), .O(new_n167_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n156_), .c(new_n97_), .d(new_n63_), .O(new_n180_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n173_), .c(new_n161_), .d(new_n124_), .O(new_n203_));
