...
module FAU ( 
  ...
  oai21  g013(.a(new_n54_), .b(new_n62_), .c(x16), .O(new_n65_));
  ...
  nand3  g028(.a(new_n71_), .b(new_n54_), .c(new_n79_), .O(new_n80_));
  aoi21  g029(.a(new_n72_), .b(x22), .c(new_n78_), .O(new_n81_));
  aoi22  g030(.a(new_n81_), .b(new_n80_), .c(new_n78_), .d(x12), .O(z03));
  ...
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n79_), .d(new_n69_), .O(new_n92_));
  ...
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n54_), .d(new_n62_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n83_), .c(new_n71_), .d(new_n54_), .O(new_n103_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n80_), .c(x16), .O(new_n128_));
  aoi21  g077(.a(new_n124_), .b(x28), .c(new_n128_), .O(new_n129_));
  inv1   g078(.a(x06), .O(new_n130_));
  oai21  g079(.a(x16), .b(new_n130_), .c(new_n77_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n129_), .c(new_n53_), .O(z09));
  oai21  g081(.a(new_n127_), .b(new_n80_), .c(x29), .O(new_n133_));
  nor2   g082(.a(x29), .b(x28), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n126_), .c(new_n116_), .d(new_n91_), .O(new_n135_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n125_), .c(new_n116_), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n110_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n85_), .c(new_n142_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n134_), .c(new_n123_), .d(new_n108_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n100_), .O(new_n153_));
  ...
  nand4  g108(.a(new_n159_), .b(new_n142_), .c(new_n143_), .d(new_n125_), .O(new_n160_));
  nor2   g109(.a(new_n160_), .b(new_n117_), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n93_), .c(new_n158_), .O(new_n162_));
  oai21  g111(.a(new_n152_), .b(new_n100_), .c(x32), .O(new_n163_));
  ...
  nand2  g115(.a(new_n166_), .b(new_n53_), .O(z13));
  nor2   g116(.a(x33), .b(x32), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n151_), .c(new_n134_), .d(new_n123_), .O(new_n169_));
  nor2   g118(.a(new_n169_), .b(new_n103_), .O(new_n170_));
  ...
  nor3   g123(.a(new_n169_), .b(new_n103_), .c(x34), .O(new_n175_));
  oai21  g124(.a(new_n169_), .b(new_n103_), .c(x34), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(x16), .O(new_n177_));
  aoi21  g126(.a(new_n58_), .b(x00), .c(x18), .O(new_n178_));
