...
module FAU ( 
  ...
  nand2  g028(.a(new_n72_), .b(new_n53_), .O(new_n80_));
  aoi21  g029(.a(new_n80_), .b(x23), .c(new_n56_), .O(new_n81_));
  oai21  g030(.a(new_n80_), .b(x23), .c(new_n81_), .O(new_n82_));
  aoi21  g031(.a(new_n56_), .b(x11), .c(x22), .O(new_n83_));
  nand2  g032(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(new_n52_), .O(z04));
  oai21  g034(.a(new_n80_), .b(x23), .c(x24), .O(new_n86_));
  nor2   g035(.a(x24), .b(x23), .O(new_n87_));
  nand3  g036(.a(new_n87_), .b(new_n72_), .c(new_n53_), .O(new_n88_));
  nand3  g037(.a(new_n88_), .b(new_n86_), .c(x16), .O(new_n89_));
  aoi21  g038(.a(new_n56_), .b(x10), .c(x22), .O(new_n90_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n71_), .O(new_n96_));
  inv1   g045(.a(new_n96_), .O(new_n97_));
  aoi22  g046(.a(new_n97_), .b(new_n62_), .c(new_n88_), .d(x25), .O(new_n98_));
  ...
  nor2   g050(.a(x25), .b(x21), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n87_), .c(new_n53_), .d(new_n60_), .O(new_n103_));
  nor2   g052(.a(x26), .b(x25), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n87_), .c(new_n72_), .d(new_n53_), .O(new_n105_));
  ...
  nand3  g065(.a(new_n116_), .b(new_n111_), .c(x16), .O(new_n117_));
  aoi21  g066(.a(new_n56_), .b(x07), .c(x22), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n52_), .O(z08));
  oai21  g069(.a(new_n114_), .b(new_n88_), .c(x28), .O(new_n121_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n97_), .c(new_n62_), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n121_), .c(x16), .O(new_n128_));
  aoi21  g077(.a(new_n56_), .b(x06), .c(x22), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n52_), .O(z09));
  inv1   g080(.a(x29), .O(new_n132_));
  nand3  g081(.a(new_n113_), .b(new_n124_), .c(new_n95_), .O(new_n133_));
  inv1   g082(.a(new_n133_), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n112_), .c(new_n132_), .O(new_n135_));
  oai21  g084(.a(new_n125_), .b(new_n103_), .c(x29), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n135_), .c(x16), .O(new_n137_));
  aoi21  g086(.a(new_n56_), .b(x05), .c(x22), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n52_), .O(z10));
  nand4  g089(.a(new_n87_), .b(new_n72_), .c(new_n53_), .d(new_n132_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n133_), .c(x30), .O(new_n142_));
  nor2   g091(.a(x30), .b(x29), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n134_), .c(new_n112_), .O(new_n144_));
  ...
  nand4  g098(.a(new_n143_), .b(new_n87_), .c(new_n72_), .d(new_n53_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n133_), .c(x31), .O(new_n151_));
  nor2   g100(.a(x31), .b(x28), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n143_), .O(new_n153_));
  inv1   g102(.a(new_n153_), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n115_), .c(new_n112_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n151_), .c(x16), .O(new_n156_));
  aoi21  g105(.a(new_n56_), .b(x03), .c(x22), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n52_), .O(z12));
  nand4  g108(.a(new_n152_), .b(new_n143_), .c(new_n113_), .d(new_n95_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n88_), .c(x32), .O(new_n161_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n126_), .c(new_n97_), .d(new_n62_), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n161_), .c(x16), .O(new_n168_));
  aoi21  g117(.a(new_n56_), .b(x02), .c(x22), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n52_), .O(z13));
  nor2   g120(.a(x33), .b(x32), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n152_), .c(new_n143_), .d(new_n113_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n103_), .O(new_n174_));
  aoi21  g123(.a(new_n167_), .b(x33), .c(new_n174_), .O(new_n175_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n179_), .c(new_n124_), .d(new_n123_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n165_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n106_), .O(new_n183_));
  oai21  g132(.a(new_n173_), .b(new_n103_), .c(x34), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n183_), .c(x16), .O(new_n185_));
  aoi21  g134(.a(new_n56_), .b(x00), .c(x22), .O(new_n186_));
