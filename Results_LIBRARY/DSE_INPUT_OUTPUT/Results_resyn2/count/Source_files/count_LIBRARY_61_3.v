...
module FAU ( 
  ...
  nor2   g031(.a(x18), .b(new_n58_), .O(new_n83_));
  oai21  g032(.a(new_n82_), .b(new_n79_), .c(new_n83_), .O(new_n84_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n78_), .d(new_n69_), .O(new_n98_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n109_), .d(new_n71_), .O(new_n192_));
