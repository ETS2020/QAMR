...
module FAU ( 
  ...
  nand4  g043(.a(new_n94_), .b(new_n93_), .c(new_n78_), .d(new_n69_), .O(new_n95_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n78_), .O(new_n105_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n86_), .c(new_n80_), .d(new_n55_), .O(new_n112_));
  ...
  nand4  g097(.a(new_n131_), .b(new_n130_), .c(new_n148_), .d(new_n94_), .O(new_n149_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n148_), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n114_), .c(new_n88_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n150_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n83_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n147_), .O(z11));
  ...
  nand4  g112(.a(new_n163_), .b(new_n153_), .c(new_n148_), .d(new_n152_), .O(new_n164_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n155_), .c(new_n96_), .d(new_n63_), .O(new_n179_));
  ...
  nand4  g136(.a(new_n187_), .b(new_n160_), .c(new_n131_), .d(new_n130_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n103_), .c(x33), .O(new_n189_));
  inv1   g138(.a(x33), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n176_), .c(new_n151_), .d(new_n175_), .O(new_n191_));
  inv1   g140(.a(new_n191_), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n165_), .c(new_n106_), .d(new_n71_), .O(new_n193_));
  ...
  nor2   g146(.a(new_n193_), .b(new_n197_), .O(new_n198_));
