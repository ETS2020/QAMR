...
module FAU ( 
  ...
  nand4  g037(.a(new_n88_), .b(new_n81_), .c(new_n53_), .d(new_n63_), .O(new_n89_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n88_), .c(new_n81_), .d(new_n62_), .O(new_n113_));
  ...
  oai21  g121(.a(x16), .b(new_n172_), .c(new_n60_), .O(new_n173_));
