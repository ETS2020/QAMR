...
module FAU ( 
  ...
  nand2  g039(.a(x25), .b(x08), .O(new_n123_));
  oai21  g040(.a(x19), .b(new_n118_), .c(new_n89_), .O(new_n124_));
  ...
  oai21  g068(.a(new_n148_), .b(x08), .c(new_n123_), .O(new_n152_));
  ...
  nand2  g073(.a(new_n85_), .b(new_n118_), .O(new_n157_));
  ...
  nand2  g080(.a(new_n163_), .b(new_n86_), .O(z15));
  ...
  nand2  g085(.a(new_n168_), .b(new_n86_), .O(z16));
  nand2  g086(.a(new_n165_), .b(new_n118_), .O(new_n170_));
  inv1   g087(.a(x29), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(x08), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n170_), .c(new_n92_), .O(new_n173_));
  inv1   g090(.a(new_n173_), .O(z17));
  nand2  g091(.a(new_n171_), .b(new_n118_), .O(new_n175_));
  ...
  nand2  g096(.a(new_n176_), .b(new_n118_), .O(new_n180_));
  ...
  nand3  g154(.a(new_n237_), .b(new_n236_), .c(new_n92_), .O(new_n238_));
  ...
  nand2  g175(.a(new_n258_), .b(new_n86_), .O(z33));
