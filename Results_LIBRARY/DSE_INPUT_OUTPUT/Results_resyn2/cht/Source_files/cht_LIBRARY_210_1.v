...
module FAU ( 
  ...
  aoi21  g043(.a(x18), .b(new_n121_), .c(x23), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(new_n126_), .c(x10), .O(z07));
  nand2  g045(.a(x20), .b(x08), .O(new_n129_));
  aoi21  g046(.a(x19), .b(new_n121_), .c(x23), .O(new_n130_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n121_), .O(new_n176_));
  ...
  aoi21  g097(.a(x31), .b(new_n180_), .c(x23), .O(new_n181_));
  ...
  aoi21  g106(.a(x33), .b(new_n180_), .c(x23), .O(new_n190_));
  ...
  aoi21  g120(.a(x36), .b(new_n180_), .c(x23), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z25));
  nand2  g122(.a(x38), .b(x09), .O(new_n206_));
  aoi21  g123(.a(x37), .b(new_n180_), .c(x23), .O(new_n207_));
  ...
  aoi21  g142(.a(new_n216_), .b(x41), .c(x23), .O(new_n226_));
  ...
  nand3  g151(.a(new_n234_), .b(new_n215_), .c(x09), .O(new_n235_));
  nand2  g152(.a(new_n216_), .b(new_n228_), .O(new_n236_));
  nand3  g153(.a(new_n236_), .b(new_n235_), .c(new_n86_), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(z32));
  inv1   g155(.a(x45), .O(new_n239_));
  nand3  g156(.a(new_n239_), .b(new_n215_), .c(x09), .O(new_n240_));
  nand2  g157(.a(new_n216_), .b(new_n234_), .O(new_n241_));
  ...
  aoi21  g161(.a(new_n216_), .b(x45), .c(x23), .O(new_n245_));
  aoi21  g162(.a(new_n245_), .b(new_n244_), .c(x10), .O(z34));
  nand2  g163(.a(new_n213_), .b(x00), .O(new_n247_));
  aoi21  g164(.a(new_n216_), .b(x46), .c(x23), .O(new_n248_));
