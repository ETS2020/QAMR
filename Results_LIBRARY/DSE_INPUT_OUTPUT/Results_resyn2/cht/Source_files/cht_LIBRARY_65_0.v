...
module FAU ( 
  ...
  inv1   g066(.a(new_n91_), .O(new_n150_));
  aoi21  g067(.a(new_n144_), .b(new_n118_), .c(new_n150_), .O(z13));
  inv1   g068(.a(x26), .O(new_n152_));
  aoi21  g069(.a(new_n152_), .b(x08), .c(new_n150_), .O(z14));
  ...
  aoi21  g107(.a(x34), .b(new_n178_), .c(new_n86_), .O(new_n191_));
  ...
  nand2  g127(.a(new_n204_), .b(new_n178_), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n91_), .O(new_n212_));
  aoi21  g129(.a(new_n210_), .b(x09), .c(new_n212_), .O(z27));
  nor2   g130(.a(x14), .b(new_n178_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(x40), .O(new_n215_));
  inv1   g132(.a(x14), .O(new_n216_));
  ...
  nand3  g137(.a(new_n220_), .b(new_n216_), .c(x09), .O(new_n221_));
  inv1   g138(.a(x40), .O(new_n222_));
  nand2  g139(.a(new_n217_), .b(new_n222_), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n221_), .c(new_n91_), .O(new_n224_));
  inv1   g141(.a(new_n224_), .O(z29));
  nand2  g142(.a(new_n214_), .b(x42), .O(new_n226_));
  aoi21  g143(.a(new_n217_), .b(x41), .c(new_n86_), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z30));
  inv1   g145(.a(x43), .O(new_n229_));
  nand3  g146(.a(new_n229_), .b(new_n216_), .c(x09), .O(new_n230_));
  inv1   g147(.a(x42), .O(new_n231_));
  nand2  g148(.a(new_n217_), .b(new_n231_), .O(new_n232_));
  nand3  g149(.a(new_n232_), .b(new_n230_), .c(new_n91_), .O(new_n233_));
  inv1   g150(.a(new_n233_), .O(z31));
  nand2  g151(.a(new_n214_), .b(x44), .O(new_n235_));
  aoi21  g152(.a(new_n217_), .b(x43), .c(new_n86_), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(new_n235_), .c(x10), .O(z32));
  inv1   g154(.a(x45), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(new_n216_), .c(x09), .O(new_n239_));
  inv1   g156(.a(x44), .O(new_n240_));
  nand2  g157(.a(new_n217_), .b(new_n240_), .O(new_n241_));
  nand3  g158(.a(new_n241_), .b(new_n239_), .c(new_n91_), .O(new_n242_));
  inv1   g159(.a(new_n242_), .O(z33));
  inv1   g160(.a(x46), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n216_), .c(x09), .O(new_n245_));
  nand2  g162(.a(new_n217_), .b(new_n238_), .O(new_n246_));
  nand3  g163(.a(new_n246_), .b(new_n245_), .c(new_n91_), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(z34));
  nand2  g165(.a(new_n214_), .b(x00), .O(new_n249_));
  aoi21  g166(.a(new_n217_), .b(x46), .c(new_n86_), .O(new_n250_));
