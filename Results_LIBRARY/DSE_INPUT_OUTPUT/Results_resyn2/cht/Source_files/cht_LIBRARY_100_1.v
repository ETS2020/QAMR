...
module FAU ( 
  ...
  nor2   g026(.a(x19), .b(new_n92_), .O(new_n110_));
  ...
  nor2   g041(.a(x24), .b(new_n92_), .O(new_n125_));
  ...
  nor2   g050(.a(x27), .b(new_n92_), .O(new_n134_));
  ...
  nand3  g070(.a(new_n153_), .b(new_n150_), .c(new_n86_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n93_), .O(z20));
  nor2   g072(.a(x33), .b(new_n151_), .O(new_n156_));
  oai21  g073(.a(x32), .b(x09), .c(new_n86_), .O(new_n157_));
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n93_), .O(z21));
  ...
  nand2  g086(.a(new_n165_), .b(new_n151_), .O(new_n170_));
  nand3  g087(.a(new_n170_), .b(new_n169_), .c(new_n86_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n93_), .O(z25));
  ...
  nand2  g093(.a(new_n176_), .b(new_n93_), .O(z26));
  ...
  aoi21  g098(.a(new_n173_), .b(new_n151_), .c(x10), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n93_), .O(z27));
  ...
  nand2  g127(.a(new_n210_), .b(new_n93_), .O(z32));
  ...
  nand2  g132(.a(new_n215_), .b(new_n93_), .O(z33));
