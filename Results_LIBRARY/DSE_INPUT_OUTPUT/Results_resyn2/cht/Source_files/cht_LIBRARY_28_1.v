...
module FAU ( 
  ...
  nor2   g026(.a(x19), .b(new_n84_), .O(new_n110_));
  ...
  nor2   g075(.a(x35), .b(new_n152_), .O(new_n159_));
  ...
  aoi21  g091(.a(new_n168_), .b(new_n152_), .c(x10), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n85_), .O(z27));
  ...
  nand3  g099(.a(new_n182_), .b(new_n179_), .c(new_n88_), .O(new_n183_));
  ...
  nand2  g115(.a(new_n198_), .b(new_n85_), .O(z31));
  ...
  nand2  g130(.a(new_n213_), .b(new_n85_), .O(z34));
  ...
  nand2  g134(.a(new_n217_), .b(new_n85_), .O(z35));
endmodule
