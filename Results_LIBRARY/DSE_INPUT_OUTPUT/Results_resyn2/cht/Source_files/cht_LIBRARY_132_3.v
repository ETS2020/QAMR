...
module FAU ( 
  ...
  oai21  g088(.a(x10), .b(new_n154_), .c(x36), .O(new_n172_));
  nand3  g089(.a(x37), .b(new_n86_), .c(x09), .O(new_n173_));
  ...
  nand2  g097(.a(x14), .b(new_n149_), .O(new_n181_));
  ...
  nand3  g136(.a(new_n178_), .b(x09), .c(new_n149_), .O(new_n220_));
