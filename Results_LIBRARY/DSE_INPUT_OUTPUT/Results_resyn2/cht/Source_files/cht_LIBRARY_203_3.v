...
module FAU ( 
  ...
  nand2  g041(.a(new_n86_), .b(new_n105_), .O(new_n125_));
  ...
  oai21  g058(.a(new_n125_), .b(new_n138_), .c(new_n141_), .O(z18));
  inv1   g059(.a(x30), .O(new_n143_));
  oai21  g060(.a(x10), .b(x00), .c(x08), .O(new_n144_));
  oai21  g061(.a(new_n125_), .b(new_n143_), .c(new_n144_), .O(z19));
  ...
  nand2  g096(.a(new_n179_), .b(new_n89_), .O(z28));
  ...
  nand2  g106(.a(new_n189_), .b(new_n89_), .O(z30));
  ...
  nand2  g111(.a(new_n194_), .b(new_n89_), .O(z31));
  ...
  nand2  g126(.a(new_n209_), .b(new_n89_), .O(z34));
  ...
  nand2  g130(.a(new_n213_), .b(new_n89_), .O(z35));
endmodule
