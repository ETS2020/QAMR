...
module FAU ( 
  ...
  oai21  g036(.a(new_n119_), .b(new_n118_), .c(new_n96_), .O(z08));
  ...
  oai21  g057(.a(new_n140_), .b(new_n139_), .c(new_n96_), .O(z15));
  ...
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n96_), .O(z17));
  ...
  nand2  g071(.a(new_n154_), .b(new_n96_), .O(z19));
  ...
  nand2  g134(.a(new_n217_), .b(new_n96_), .O(z34));
