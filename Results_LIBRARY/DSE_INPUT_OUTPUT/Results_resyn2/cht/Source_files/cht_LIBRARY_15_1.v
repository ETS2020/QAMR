...
module FAU ( 
  ...
  nor2   g002(.a(x28), .b(x10), .O(new_n86_));
  ...
  nand2  g038(.a(x18), .b(x08), .O(new_n122_));
  inv1   g039(.a(x08), .O(new_n123_));
  aoi21  g040(.a(x17), .b(new_n123_), .c(x28), .O(new_n124_));
  aoi21  g041(.a(new_n124_), .b(new_n122_), .c(x10), .O(z06));
  nand2  g042(.a(x19), .b(x08), .O(new_n126_));
  aoi21  g043(.a(x18), .b(new_n123_), .c(x28), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(new_n126_), .c(x10), .O(z07));
  inv1   g045(.a(x20), .O(new_n129_));
  nand2  g046(.a(new_n129_), .b(x08), .O(new_n130_));
  inv1   g047(.a(x19), .O(new_n131_));
  nand2  g048(.a(new_n131_), .b(new_n123_), .O(new_n132_));
  nand3  g049(.a(new_n132_), .b(new_n130_), .c(new_n86_), .O(new_n133_));
  inv1   g050(.a(new_n133_), .O(z08));
  nand2  g051(.a(x21), .b(x08), .O(new_n135_));
  aoi21  g052(.a(x20), .b(new_n123_), .c(x28), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n135_), .c(x10), .O(z09));
  inv1   g054(.a(x22), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(x08), .O(new_n139_));
  inv1   g056(.a(x21), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n123_), .O(new_n141_));
  ...
  nand2  g062(.a(new_n138_), .b(new_n123_), .O(new_n146_));
  ...
  nand2  g067(.a(new_n144_), .b(new_n123_), .O(new_n151_));
  ...
  nand2  g072(.a(new_n149_), .b(new_n123_), .O(new_n156_));
  nand3  g073(.a(new_n156_), .b(new_n155_), .c(new_n86_), .O(new_n157_));
  inv1   g074(.a(new_n157_), .O(z13));
  nand2  g075(.a(x26), .b(x08), .O(new_n159_));
  aoi21  g076(.a(x25), .b(new_n123_), .c(x28), .O(new_n160_));
  aoi21  g077(.a(new_n160_), .b(new_n159_), .c(x10), .O(z14));
  nand2  g078(.a(x27), .b(x08), .O(new_n162_));
  aoi21  g079(.a(x26), .b(new_n123_), .c(x28), .O(new_n163_));
  aoi21  g080(.a(new_n163_), .b(new_n162_), .c(x10), .O(z15));
  nand3  g081(.a(new_n86_), .b(x27), .c(new_n123_), .O(new_n165_));
  inv1   g082(.a(new_n165_), .O(z16));
  nand3  g083(.a(new_n86_), .b(x29), .c(x08), .O(new_n167_));
  inv1   g084(.a(new_n167_), .O(z17));
  nand2  g085(.a(x30), .b(x08), .O(new_n169_));
  aoi21  g086(.a(x29), .b(new_n123_), .c(x28), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n169_), .c(x10), .O(z18));
  nand2  g088(.a(x08), .b(x00), .O(new_n172_));
  aoi21  g089(.a(x30), .b(new_n123_), .c(x28), .O(new_n173_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n177_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n203_), .c(new_n86_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z26));
  inv1   g124(.a(x00), .O(new_n208_));
  nand2  g125(.a(x14), .b(new_n208_), .O(new_n209_));
  oai21  g126(.a(x39), .b(x14), .c(new_n209_), .O(new_n210_));
  oai21  g127(.a(x38), .b(x09), .c(new_n86_), .O(new_n211_));
  aoi21  g128(.a(new_n210_), .b(x09), .c(new_n211_), .O(z27));
  nor2   g129(.a(x14), .b(new_n177_), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(x40), .O(new_n214_));
  nand2  g131(.a(new_n106_), .b(x09), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(x39), .c(x28), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n214_), .c(x10), .O(z28));
  nand2  g134(.a(new_n213_), .b(x41), .O(new_n218_));
  aoi21  g135(.a(new_n215_), .b(x40), .c(x28), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z29));
  nand2  g137(.a(new_n213_), .b(x42), .O(new_n221_));
  aoi21  g138(.a(new_n215_), .b(x41), .c(x28), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n221_), .c(x10), .O(z30));
  nand2  g140(.a(new_n213_), .b(x43), .O(new_n224_));
  aoi21  g141(.a(new_n215_), .b(x42), .c(x28), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z31));
  nand2  g143(.a(new_n213_), .b(x44), .O(new_n227_));
  aoi21  g144(.a(new_n215_), .b(x43), .c(x28), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z32));
  inv1   g146(.a(x45), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(new_n106_), .c(x09), .O(new_n231_));
  inv1   g148(.a(x44), .O(new_n232_));
  nand2  g149(.a(new_n215_), .b(new_n232_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n231_), .c(new_n86_), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(z33));
  inv1   g152(.a(x46), .O(new_n236_));
  nand3  g153(.a(new_n236_), .b(new_n106_), .c(x09), .O(new_n237_));
  nand2  g154(.a(new_n215_), .b(new_n230_), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(new_n237_), .c(new_n86_), .O(new_n239_));
  inv1   g156(.a(new_n239_), .O(z34));
  nand3  g157(.a(new_n106_), .b(x09), .c(new_n208_), .O(new_n241_));
  nand2  g158(.a(new_n215_), .b(new_n236_), .O(new_n242_));
