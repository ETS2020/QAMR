...
module FAU ( 
  ...
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n85_), .O(z23));
  ...
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n85_), .O(z26));
  ...
  nand2  g105(.a(new_n188_), .b(new_n85_), .O(z29));
  ...
  nand2  g125(.a(new_n208_), .b(new_n85_), .O(z33));
