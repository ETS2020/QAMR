...
module FAU ( 
  ...
  aoi21  g001(.a(new_n84_), .b(x27), .c(x10), .O(new_n85_));
  ...
  nand2  g015(.a(new_n84_), .b(x27), .O(new_n99_));
  ...
  nand2  g097(.a(new_n176_), .b(new_n119_), .O(new_n181_));
  ...
  nand2  g104(.a(new_n182_), .b(new_n119_), .O(new_n188_));
  ...
  nand3  g112(.a(new_n195_), .b(new_n192_), .c(new_n101_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n99_), .O(z20));
  ...
  nand2  g131(.a(new_n209_), .b(new_n193_), .O(new_n215_));
  ...
  nand3  g137(.a(new_n220_), .b(new_n219_), .c(new_n101_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n99_), .O(z25));
  inv1   g139(.a(x38), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(x09), .O(new_n224_));
  nand2  g141(.a(new_n218_), .b(new_n193_), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n224_), .c(new_n101_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n99_), .O(z26));
  ...
  aoi21  g147(.a(new_n223_), .b(new_n193_), .c(x10), .O(new_n231_));
  ...
  aoi21  g157(.a(new_n237_), .b(new_n166_), .c(x41), .O(new_n241_));
  oai21  g158(.a(x14), .b(new_n193_), .c(new_n234_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n101_), .O(new_n243_));
  nor2   g160(.a(new_n243_), .b(new_n241_), .O(z29));
  nand3  g161(.a(new_n166_), .b(new_n104_), .c(x09), .O(new_n245_));
  ...
  nand2  g175(.a(new_n258_), .b(new_n99_), .O(z32));
