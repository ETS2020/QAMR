...
module FAU ( 
  ...
  nand2  g046(.a(new_n84_), .b(x25), .O(new_n130_));
  ...
  nand2  g078(.a(new_n158_), .b(new_n123_), .O(new_n162_));
  inv1   g079(.a(x25), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n162_), .c(new_n85_), .O(new_n165_));
  inv1   g082(.a(new_n165_), .O(z13));
  nand2  g083(.a(new_n163_), .b(new_n123_), .O(new_n167_));
  inv1   g084(.a(x26), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(x08), .O(new_n169_));
  nand3  g086(.a(new_n169_), .b(new_n167_), .c(new_n131_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n130_), .O(z14));
  oai21  g088(.a(x26), .b(x08), .c(new_n131_), .O(new_n172_));
  aoi21  g089(.a(new_n167_), .b(new_n84_), .c(new_n172_), .O(z15));
  inv1   g090(.a(x28), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(x08), .O(new_n175_));
  nand2  g092(.a(new_n84_), .b(new_n123_), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n175_), .c(new_n131_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n130_), .O(z16));
  nand2  g095(.a(new_n174_), .b(new_n123_), .O(new_n179_));
