...
module FAU ( 
  ...
  nand2  g051(.a(new_n130_), .b(new_n108_), .O(new_n135_));
  nand3  g052(.a(new_n135_), .b(new_n134_), .c(new_n88_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(new_n85_), .O(z13));
  nor2   g054(.a(x26), .b(new_n108_), .O(new_n138_));
  oai21  g055(.a(x25), .b(x08), .c(new_n88_), .O(new_n139_));
  oai21  g056(.a(new_n139_), .b(new_n138_), .c(new_n85_), .O(z14));
  ...
  nand2  g062(.a(new_n141_), .b(new_n108_), .O(new_n146_));
  ...
  nand2  g067(.a(new_n144_), .b(new_n108_), .O(new_n151_));
  nand3  g068(.a(new_n151_), .b(new_n150_), .c(new_n88_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n85_), .O(z17));
  nand2  g070(.a(new_n84_), .b(x08), .O(new_n154_));
  nand2  g071(.a(new_n149_), .b(new_n108_), .O(new_n155_));
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(new_n88_), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(new_n85_), .O(z18));
  inv1   g074(.a(x00), .O(new_n158_));
  oai21  g075(.a(x30), .b(x08), .c(new_n88_), .O(new_n159_));
  aoi21  g076(.a(x08), .b(new_n158_), .c(new_n159_), .O(z19));
  inv1   g077(.a(x09), .O(new_n161_));
  nor2   g078(.a(x32), .b(new_n161_), .O(new_n162_));
  oai21  g079(.a(x31), .b(x09), .c(new_n88_), .O(new_n163_));
  oai21  g080(.a(new_n163_), .b(new_n162_), .c(new_n85_), .O(z20));
  ...
  nor2   g084(.a(x34), .b(new_n161_), .O(new_n168_));
  oai21  g085(.a(x33), .b(x09), .c(new_n88_), .O(new_n169_));
  nor2   g086(.a(new_n169_), .b(new_n168_), .O(z22));
  nor2   g087(.a(x35), .b(new_n161_), .O(new_n171_));
  oai21  g088(.a(x34), .b(x09), .c(new_n88_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(new_n171_), .O(z23));
  nor2   g090(.a(x36), .b(new_n161_), .O(new_n174_));
  ...
  nand2  g098(.a(new_n177_), .b(new_n161_), .O(new_n182_));
  ...
  aoi21  g105(.a(new_n180_), .b(new_n161_), .c(x10), .O(new_n189_));
  ...
  nand3  g113(.a(new_n196_), .b(new_n193_), .c(new_n88_), .O(new_n197_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n85_), .O(z34));
  nand3  g145(.a(new_n186_), .b(x09), .c(new_n158_), .O(new_n229_));
  nand2  g146(.a(new_n195_), .b(new_n224_), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(new_n229_), .c(new_n88_), .O(new_n231_));
