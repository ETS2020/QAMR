...
module FAU ( 
  ...
  nand2  g056(.a(new_n133_), .b(new_n108_), .O(new_n140_));
  nand3  g057(.a(new_n140_), .b(new_n139_), .c(new_n86_), .O(new_n141_));
  nand2  g058(.a(new_n141_), .b(new_n93_), .O(z14));
  inv1   g059(.a(x27), .O(new_n143_));
  nand2  g060(.a(new_n143_), .b(x08), .O(new_n144_));
  nand2  g061(.a(new_n138_), .b(new_n108_), .O(new_n145_));
  nand3  g062(.a(new_n145_), .b(new_n144_), .c(new_n86_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n93_), .O(z15));
  nor2   g064(.a(x28), .b(new_n108_), .O(new_n148_));
  oai21  g065(.a(x27), .b(x08), .c(new_n86_), .O(new_n149_));
  oai21  g066(.a(new_n149_), .b(new_n148_), .c(new_n93_), .O(z16));
  ...
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n93_), .O(z21));
  ...
  nand2  g090(.a(new_n170_), .b(new_n163_), .O(new_n174_));
  ...
  nand2  g095(.a(new_n92_), .b(new_n163_), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n178_), .c(new_n86_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n93_), .O(z25));
  inv1   g098(.a(x38), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(x09), .O(new_n183_));
  nand2  g100(.a(new_n177_), .b(new_n163_), .O(new_n184_));
