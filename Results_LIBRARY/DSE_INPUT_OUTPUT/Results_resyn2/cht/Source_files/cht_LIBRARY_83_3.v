...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n91_,
    ...
    new_n229_, new_n230_;
  nand2  g000(.a(x37), .b(x10), .O(new_n84_));
  ...
  aoi21  g041(.a(new_n123_), .b(x08), .c(new_n124_), .O(z10));
  nor2   g042(.a(x23), .b(new_n107_), .O(new_n126_));
  oai21  g043(.a(x22), .b(x08), .c(new_n87_), .O(new_n127_));
  oai21  g044(.a(new_n127_), .b(new_n126_), .c(new_n84_), .O(z11));
  ...
  nand3  g078(.a(new_n161_), .b(new_n158_), .c(new_n87_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(new_n84_), .O(z20));
  inv1   g080(.a(x33), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(x09), .O(new_n165_));
  nand2  g082(.a(new_n157_), .b(new_n159_), .O(new_n166_));
  nand3  g083(.a(new_n166_), .b(new_n165_), .c(new_n87_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n84_), .O(z21));
  nor2   g085(.a(x34), .b(new_n159_), .O(new_n169_));
  oai21  g086(.a(x33), .b(x09), .c(new_n87_), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n84_), .O(z22));
  nor2   g088(.a(x35), .b(new_n159_), .O(new_n172_));
  oai21  g089(.a(x34), .b(x09), .c(new_n87_), .O(new_n173_));
  nor2   g090(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g091(.a(x36), .b(new_n159_), .O(new_n175_));
  oai21  g092(.a(x35), .b(x09), .c(new_n87_), .O(new_n176_));
  nor2   g093(.a(new_n176_), .b(new_n175_), .O(z24));
  nor2   g094(.a(x37), .b(new_n159_), .O(new_n178_));
  oai21  g095(.a(x36), .b(x09), .c(new_n87_), .O(new_n179_));
  nor2   g096(.a(new_n179_), .b(new_n178_), .O(z25));
  inv1   g097(.a(x38), .O(new_n181_));
  oai21  g098(.a(x37), .b(x09), .c(new_n87_), .O(new_n182_));
  ...
  aoi21  g104(.a(new_n181_), .b(new_n159_), .c(x10), .O(new_n188_));
  ...
  nand2  g113(.a(new_n196_), .b(new_n84_), .O(z28));
  ...
  nand2  g133(.a(new_n216_), .b(new_n84_), .O(z32));
