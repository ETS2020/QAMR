...
module FAU ( 
  ...
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n90_), .O(z21));
  nor2   g078(.a(x34), .b(new_n154_), .O(new_n162_));
  oai21  g079(.a(x33), .b(x09), .c(new_n86_), .O(new_n163_));
  nor2   g080(.a(new_n163_), .b(new_n162_), .O(z22));
  nor2   g081(.a(x35), .b(new_n154_), .O(new_n165_));
  ...
  nand2  g089(.a(new_n168_), .b(new_n154_), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n172_), .c(new_n86_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n90_), .O(z25));
  inv1   g092(.a(x38), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(x09), .O(new_n177_));
  nand2  g094(.a(new_n171_), .b(new_n154_), .O(new_n178_));
  ...
  aoi21  g101(.a(new_n176_), .b(new_n154_), .c(x10), .O(new_n185_));
  ...
  nand3  g136(.a(new_n89_), .b(new_n182_), .c(x09), .O(new_n220_));
  nand2  g137(.a(new_n191_), .b(new_n215_), .O(new_n221_));
  nand3  g138(.a(new_n221_), .b(new_n220_), .c(new_n86_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n90_), .O(z34));
  nand3  g140(.a(new_n182_), .b(x09), .c(new_n149_), .O(new_n224_));
  nand2  g141(.a(new_n191_), .b(new_n89_), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n224_), .c(new_n86_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n90_), .O(z35));
endmodule
