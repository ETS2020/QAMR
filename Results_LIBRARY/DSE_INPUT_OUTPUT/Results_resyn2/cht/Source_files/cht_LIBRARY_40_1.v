...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n87_), .c(x35), .O(new_n93_));
  aoi21  g010(.a(new_n93_), .b(new_n92_), .c(x10), .O(z01));
  nand2  g011(.a(x07), .b(x06), .O(new_n95_));
  aoi21  g012(.a(x13), .b(new_n87_), .c(x35), .O(new_n96_));
  ...
  aoi21  g021(.a(x15), .b(new_n87_), .c(x35), .O(new_n105_));
  aoi21  g022(.a(new_n105_), .b(new_n104_), .c(x10), .O(z04));
  nand2  g023(.a(x07), .b(x03), .O(new_n107_));
  aoi21  g024(.a(x16), .b(new_n87_), .c(x35), .O(new_n108_));
  ...
  aoi21  g049(.a(x21), .b(new_n112_), .c(x35), .O(new_n133_));
  ...
  aoi21  g063(.a(x24), .b(new_n112_), .c(x35), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n146_), .c(x10), .O(z13));
  nand2  g065(.a(x26), .b(x08), .O(new_n149_));
  aoi21  g066(.a(x25), .b(new_n112_), .c(x35), .O(new_n150_));
  ...
  aoi21  g075(.a(x27), .b(new_n112_), .c(x35), .O(new_n159_));
  ...
  nand2  g107(.a(new_n184_), .b(new_n179_), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n190_), .c(new_n86_), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z22));
  aoi21  g110(.a(x34), .b(new_n179_), .c(x35), .O(new_n194_));
  nor2   g111(.a(new_n194_), .b(x10), .O(z23));
  nand3  g112(.a(new_n86_), .b(x36), .c(x09), .O(new_n196_));
  ...
  nand2  g122(.a(new_n198_), .b(new_n179_), .O(new_n206_));
  ...
  oai21  g127(.a(new_n100_), .b(x00), .c(new_n210_), .O(new_n211_));
  oai21  g128(.a(x38), .b(x09), .c(new_n86_), .O(new_n212_));
  ...
  nand2  g155(.a(new_n216_), .b(new_n238_), .O(new_n239_));
  nand3  g156(.a(new_n239_), .b(new_n237_), .c(new_n86_), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(z34));
  nand2  g158(.a(new_n220_), .b(x00), .O(new_n242_));
  aoi21  g159(.a(new_n216_), .b(x46), .c(x35), .O(new_n243_));
