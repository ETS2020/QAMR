...
module FAU ( 
  ...
  nand2  g007(.a(x28), .b(new_n90_), .O(new_n91_));
  ...
  aoi21  g011(.a(x28), .b(new_n90_), .c(x10), .O(new_n95_));
  inv1   g012(.a(x13), .O(new_n96_));
  nand2  g013(.a(new_n96_), .b(new_n86_), .O(new_n97_));
  ...
  nor2   g018(.a(new_n86_), .b(x01), .O(new_n102_));
  oai21  g019(.a(x14), .b(x07), .c(new_n87_), .O(new_n103_));
  ...
  nor2   g027(.a(new_n86_), .b(x03), .O(new_n111_));
  oai21  g028(.a(x16), .b(x07), .c(new_n87_), .O(new_n112_));
  ...
  nand2  g082(.a(new_n84_), .b(x08), .O(new_n166_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n91_), .c(new_n87_), .O(new_n228_));
