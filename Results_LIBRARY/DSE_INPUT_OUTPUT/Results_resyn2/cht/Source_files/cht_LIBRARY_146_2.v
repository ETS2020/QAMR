...
module FAU ( 
  ...
  nand2  g015(.a(new_n98_), .b(x08), .O(new_n99_));
  inv1   g016(.a(x08), .O(new_n100_));
  inv1   g017(.a(x17), .O(new_n101_));
  nand2  g018(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g019(.a(new_n102_), .b(new_n99_), .c(new_n87_), .O(new_n103_));
  inv1   g020(.a(new_n103_), .O(z06));
  inv1   g021(.a(x19), .O(new_n105_));
  nand2  g022(.a(new_n105_), .b(x08), .O(new_n106_));
  nand2  g023(.a(new_n98_), .b(new_n100_), .O(new_n107_));
  nand3  g024(.a(new_n107_), .b(new_n106_), .c(new_n87_), .O(new_n108_));
  ...
  aoi21  g062(.a(x28), .b(new_n100_), .c(x07), .O(new_n146_));
  ...
  oai21  g107(.a(x38), .b(x09), .c(new_n87_), .O(new_n191_));
  ...
  nand2  g111(.a(new_n187_), .b(x09), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n188_), .O(new_n196_));
  ...
  nand2  g117(.a(new_n195_), .b(new_n193_), .O(new_n201_));
  ...
  nor2   g125(.a(x14), .b(new_n161_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(x43), .O(new_n210_));
  aoi21  g127(.a(new_n195_), .b(x42), .c(x07), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z31));
  nand2  g129(.a(new_n209_), .b(x44), .O(new_n213_));
  aoi21  g130(.a(new_n195_), .b(x43), .c(x07), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z32));
  nand2  g132(.a(new_n209_), .b(x45), .O(new_n216_));
  aoi21  g133(.a(new_n195_), .b(x44), .c(x07), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z33));
  nand2  g135(.a(new_n209_), .b(x46), .O(new_n219_));
  aoi21  g136(.a(new_n195_), .b(x45), .c(x07), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z34));
  nand2  g138(.a(new_n209_), .b(x00), .O(new_n222_));
  aoi21  g139(.a(new_n195_), .b(x46), .c(x07), .O(new_n223_));
