...
module FAU ( 
  ...
  aoi21  g084(.a(x36), .b(new_n146_), .c(x08), .O(new_n168_));
  ...
  nand2  g121(.a(new_n195_), .b(x44), .O(new_n205_));
  aoi21  g122(.a(new_n186_), .b(x43), .c(x08), .O(new_n206_));
  ...
  nand2  g130(.a(new_n195_), .b(x46), .O(new_n214_));
  aoi21  g131(.a(new_n186_), .b(x45), .c(x08), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n214_), .c(x10), .O(z34));
  nand2  g133(.a(new_n195_), .b(x00), .O(new_n217_));
  aoi21  g134(.a(new_n186_), .b(x46), .c(x08), .O(new_n218_));
