...
module FAU ( 
  ...
  nand2  g030(.a(new_n113_), .b(new_n90_), .O(z07));
  ...
  aoi21  g035(.a(new_n89_), .b(x08), .c(new_n118_), .O(z09));
  nor2   g036(.a(x22), .b(new_n111_), .O(new_n120_));
  oai21  g037(.a(x21), .b(x08), .c(new_n86_), .O(new_n121_));
  nor2   g038(.a(new_n121_), .b(new_n120_), .O(z10));
  nor2   g039(.a(x23), .b(new_n111_), .O(new_n123_));
  ...
  nand2  g049(.a(new_n132_), .b(new_n90_), .O(z13));
  ...
  nand2  g054(.a(new_n137_), .b(new_n90_), .O(z14));
  nor2   g055(.a(x27), .b(new_n111_), .O(new_n139_));
  oai21  g056(.a(x26), .b(x08), .c(new_n86_), .O(new_n140_));
  oai21  g057(.a(new_n140_), .b(new_n139_), .c(new_n90_), .O(z15));
  ...
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n90_), .O(z17));
  ...
  nand2  g084(.a(new_n161_), .b(new_n156_), .O(new_n168_));
  ...
  aoi21  g107(.a(new_n184_), .b(new_n156_), .c(x10), .O(new_n191_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n90_), .O(z29));
  ...
  nand3  g147(.a(new_n188_), .b(x09), .c(new_n151_), .O(new_n231_));
