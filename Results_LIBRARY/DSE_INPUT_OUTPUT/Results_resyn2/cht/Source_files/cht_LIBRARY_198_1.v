...
module FAU ( 
  ...
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n90_), .O(z26));
  ...
  nand2  g098(.a(new_n181_), .b(new_n90_), .O(z28));
  ...
  nand2  g123(.a(new_n206_), .b(new_n90_), .O(z33));
  ...
  nand2  g128(.a(new_n211_), .b(new_n90_), .O(z34));
  ...
  nand2  g132(.a(new_n215_), .b(new_n90_), .O(z35));
endmodule
