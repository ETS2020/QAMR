...
module FAU ( 
  ...
  nand2  g011(.a(x24), .b(x10), .O(new_n95_));
  ...
  nand2  g037(.a(new_n120_), .b(new_n95_), .O(z08));
  nor2   g038(.a(x21), .b(new_n107_), .O(new_n122_));
  oai21  g039(.a(x20), .b(x08), .c(new_n86_), .O(new_n123_));
  oai21  g040(.a(new_n123_), .b(new_n122_), .c(new_n95_), .O(z09));
  ...
  oai21  g046(.a(new_n129_), .b(new_n128_), .c(new_n95_), .O(z11));
  ...
  oai21  g050(.a(x10), .b(new_n107_), .c(x24), .O(new_n134_));
  nand3  g051(.a(x25), .b(new_n86_), .c(x08), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(new_n134_), .O(z13));
  nor2   g053(.a(x26), .b(new_n107_), .O(new_n137_));
  oai21  g054(.a(x25), .b(x08), .c(new_n86_), .O(new_n138_));
  oai21  g055(.a(new_n138_), .b(new_n137_), .c(new_n95_), .O(z14));
  ...
  nor2   g059(.a(x28), .b(new_n107_), .O(new_n143_));
  ...
  nand2  g072(.a(new_n155_), .b(new_n95_), .O(z19));
  ...
  nand2  g079(.a(new_n162_), .b(new_n95_), .O(z20));
  nor2   g080(.a(x33), .b(new_n159_), .O(new_n164_));
  oai21  g081(.a(x32), .b(x09), .c(new_n86_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n95_), .O(z21));
  ...
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n95_), .O(z24));
  ...
  oai21  g097(.a(new_n180_), .b(new_n179_), .c(new_n95_), .O(z26));
  ...
  nand2  g109(.a(new_n192_), .b(new_n95_), .O(z28));
  ...
  nand2  g134(.a(new_n217_), .b(new_n95_), .O(z33));
