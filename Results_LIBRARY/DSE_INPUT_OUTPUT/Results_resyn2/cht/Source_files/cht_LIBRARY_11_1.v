...
module FAU ( 
  ...
  nor2   g036(.a(x21), .b(new_n111_), .O(new_n120_));
  oai21  g037(.a(x20), .b(x08), .c(new_n88_), .O(new_n121_));
  oai21  g038(.a(new_n121_), .b(new_n120_), .c(new_n85_), .O(z09));
  nor2   g039(.a(x22), .b(new_n111_), .O(new_n123_));
  oai21  g040(.a(x21), .b(x08), .c(new_n88_), .O(new_n124_));
  nor2   g041(.a(new_n124_), .b(new_n123_), .O(z10));
  inv1   g042(.a(x23), .O(new_n126_));
  oai21  g043(.a(x22), .b(x08), .c(new_n88_), .O(new_n127_));
  aoi21  g044(.a(new_n126_), .b(x08), .c(new_n127_), .O(z11));
  inv1   g045(.a(x24), .O(new_n129_));
  nand2  g046(.a(new_n129_), .b(x08), .O(new_n130_));
  nand2  g047(.a(new_n126_), .b(new_n111_), .O(new_n131_));
  nand3  g048(.a(new_n131_), .b(new_n130_), .c(new_n88_), .O(new_n132_));
  nand2  g049(.a(new_n132_), .b(new_n85_), .O(z12));
  nor2   g050(.a(x25), .b(new_n111_), .O(new_n134_));
  oai21  g051(.a(x24), .b(x08), .c(new_n88_), .O(new_n135_));
  oai21  g052(.a(new_n135_), .b(new_n134_), .c(new_n85_), .O(z13));
  ...
  oai22  g083(.a(new_n166_), .b(x09), .c(new_n163_), .d(new_n165_), .O(z23));
  nor2   g084(.a(x36), .b(new_n84_), .O(new_n168_));
  oai21  g085(.a(x35), .b(x09), .c(new_n88_), .O(new_n169_));
  ...
  nand3  g105(.a(new_n188_), .b(new_n178_), .c(x09), .O(new_n189_));
  oai21  g106(.a(x14), .b(new_n84_), .c(new_n182_), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n189_), .c(new_n88_), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z29));
  inv1   g109(.a(x42), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n178_), .c(x09), .O(new_n194_));
  oai21  g111(.a(x14), .b(new_n84_), .c(new_n188_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n194_), .c(new_n88_), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z30));
  nand2  g114(.a(new_n178_), .b(x09), .O(new_n198_));
  oai21  g115(.a(x43), .b(x14), .c(new_n88_), .O(new_n199_));
  nor2   g116(.a(x42), .b(x10), .O(new_n200_));
  aoi22  g117(.a(new_n200_), .b(new_n198_), .c(new_n199_), .d(x09), .O(z31));
  inv1   g118(.a(x44), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n178_), .c(x09), .O(new_n203_));
  inv1   g120(.a(x43), .O(new_n204_));
  oai21  g121(.a(x14), .b(new_n84_), .c(new_n204_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n203_), .c(new_n88_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z32));
  inv1   g124(.a(x45), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n178_), .c(x09), .O(new_n209_));
  oai21  g126(.a(x14), .b(new_n84_), .c(new_n202_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n88_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z33));
  inv1   g129(.a(x46), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n178_), .c(x09), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n84_), .c(new_n208_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n88_), .O(new_n216_));
  inv1   g133(.a(new_n216_), .O(z34));
  nand3  g134(.a(new_n178_), .b(x09), .c(new_n152_), .O(new_n218_));
  oai21  g135(.a(x14), .b(new_n84_), .c(new_n213_), .O(new_n219_));
