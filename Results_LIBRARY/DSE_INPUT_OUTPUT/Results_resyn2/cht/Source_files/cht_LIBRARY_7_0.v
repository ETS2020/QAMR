...
module FAU ( 
  ...
  aoi21  g130(.a(x38), .b(new_n180_), .c(new_n86_), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z27));
  nor2   g132(.a(x14), .b(new_n180_), .O(new_n216_));
  ...
  inv1   g138(.a(new_n87_), .O(new_n222_));
  aoi21  g139(.a(new_n218_), .b(new_n221_), .c(new_n222_), .O(z29));
  nor2   g140(.a(x42), .b(new_n86_), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n216_), .c(x10), .O(z30));
  inv1   g142(.a(x43), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n210_), .c(x09), .O(new_n227_));
  ...
  nand2  g154(.a(new_n218_), .b(new_n237_), .O(new_n238_));
  ...
  nand2  g159(.a(new_n218_), .b(new_n235_), .O(new_n243_));
