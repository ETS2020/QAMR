...
module FAU ( 
  ...
  nand2  g083(.a(new_n161_), .b(new_n121_), .O(new_n167_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n85_), .O(z20));
  ...
  nand2  g137(.a(new_n220_), .b(new_n85_), .O(z25));
  ...
  nand3  g154(.a(new_n237_), .b(new_n234_), .c(new_n88_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n85_), .O(z28));
  ...
  nand2  g165(.a(new_n248_), .b(new_n85_), .O(z30));
