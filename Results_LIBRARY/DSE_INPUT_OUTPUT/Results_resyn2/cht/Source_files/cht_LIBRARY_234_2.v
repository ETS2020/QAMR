...
module FAU ( 
  ...
  nand2  g055(.a(new_n134_), .b(new_n111_), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(new_n138_), .c(new_n88_), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n85_), .O(z14));
  nor2   g058(.a(x27), .b(new_n111_), .O(new_n142_));
  oai21  g059(.a(x26), .b(x08), .c(new_n88_), .O(new_n143_));
  oai21  g060(.a(new_n143_), .b(new_n142_), .c(new_n85_), .O(z15));
  nor2   g061(.a(x28), .b(new_n111_), .O(new_n145_));
  ...
  nand2  g113(.a(new_n196_), .b(new_n85_), .O(z29));
  nand3  g114(.a(new_n84_), .b(new_n181_), .c(x09), .O(new_n198_));
  oai21  g115(.a(x14), .b(new_n157_), .c(new_n193_), .O(new_n199_));
  ...
  oai21  g120(.a(x14), .b(new_n157_), .c(new_n84_), .O(new_n204_));
  ...
  oai21  g125(.a(x14), .b(new_n157_), .c(new_n202_), .O(new_n209_));
  ...
  oai21  g139(.a(x14), .b(new_n157_), .c(new_n217_), .O(new_n223_));
