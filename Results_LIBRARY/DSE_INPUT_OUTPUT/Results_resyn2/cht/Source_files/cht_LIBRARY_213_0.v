...
module FAU ( 
  ...
  aoi21  g111(.a(x36), .b(new_n170_), .c(new_n86_), .O(new_n195_));
  ...
  aoi21  g132(.a(new_n209_), .b(x41), .c(new_n86_), .O(new_n216_));
  ...
  aoi21  g151(.a(new_n209_), .b(x45), .c(new_n86_), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n234_), .c(x10), .O(z34));
  nand2  g153(.a(new_n207_), .b(x00), .O(new_n237_));
  aoi21  g154(.a(new_n209_), .b(x46), .c(new_n86_), .O(new_n238_));
