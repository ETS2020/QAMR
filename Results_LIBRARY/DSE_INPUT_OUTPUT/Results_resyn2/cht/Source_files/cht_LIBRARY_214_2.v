...
module FAU ( 
  ...
  aoi21  g066(.a(x34), .b(new_n140_), .c(x08), .O(new_n150_));
  ...
  aoi21  g091(.a(new_n174_), .b(x39), .c(x08), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n173_), .c(x10), .O(z28));
  inv1   g093(.a(x41), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n100_), .c(x09), .O(new_n178_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(new_n90_), .O(new_n198_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n90_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand3  g121(.a(new_n100_), .b(x09), .c(new_n167_), .O(new_n205_));
