...
module FAU ( 
  ...
  aoi21  g072(.a(x33), .b(new_n147_), .c(x08), .O(new_n156_));
  ...
  aoi21  g081(.a(x35), .b(new_n147_), .c(x08), .O(new_n165_));
  ...
  aoi21  g090(.a(x37), .b(new_n147_), .c(x08), .O(new_n174_));
  ...
  nor2   g104(.a(x14), .b(new_n147_), .O(new_n188_));
  ...
  nand3  g112(.a(new_n195_), .b(new_n176_), .c(x09), .O(new_n196_));
  ...
  nand2  g126(.a(new_n184_), .b(new_n209_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n208_), .c(new_n86_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z34));
  nand2  g129(.a(new_n188_), .b(x00), .O(new_n213_));
  aoi21  g130(.a(new_n184_), .b(x46), .c(x08), .O(new_n214_));
