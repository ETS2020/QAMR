...
module FAU ( 
  ...
  oai21  g040(.a(new_n110_), .b(new_n122_), .c(new_n123_), .O(z12));
  ...
  nand2  g081(.a(new_n160_), .b(new_n145_), .O(new_n165_));
  nand3  g082(.a(new_n165_), .b(new_n164_), .c(new_n87_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n84_), .O(z25));
  ...
  nand2  g090(.a(x14), .b(new_n142_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g092(.a(x38), .b(x09), .c(new_n87_), .O(new_n176_));
  ...
  nand2  g103(.a(new_n186_), .b(new_n84_), .O(z29));
  ...
  nand2  g108(.a(new_n191_), .b(new_n84_), .O(z30));
  ...
  nand2  g113(.a(new_n196_), .b(new_n84_), .O(z31));
  ...
  nand2  g128(.a(new_n211_), .b(new_n84_), .O(z34));
  nand3  g129(.a(new_n171_), .b(x09), .c(new_n142_), .O(new_n213_));
  oai21  g130(.a(x14), .b(new_n145_), .c(new_n208_), .O(new_n214_));
