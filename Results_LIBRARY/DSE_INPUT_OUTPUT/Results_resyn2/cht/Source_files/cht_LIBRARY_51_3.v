...
module FAU ( 
  ...
  oai21  g046(.a(new_n129_), .b(new_n128_), .c(new_n89_), .O(z12));
  ...
  nand2  g054(.a(new_n137_), .b(new_n89_), .O(z14));
  nand2  g055(.a(new_n86_), .b(new_n105_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(x27), .O(new_n140_));
  oai21  g057(.a(new_n139_), .b(new_n134_), .c(new_n140_), .O(z15));
  ...
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n89_), .O(z17));
  ...
  aoi21  g072(.a(new_n154_), .b(x09), .c(new_n155_), .O(z20));
  inv1   g073(.a(x09), .O(new_n157_));
  nor2   g074(.a(x33), .b(new_n157_), .O(new_n158_));
  ...
  nor2   g085(.a(x36), .b(new_n157_), .O(new_n169_));
  oai21  g086(.a(x35), .b(x09), .c(new_n86_), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n89_), .O(z24));
  inv1   g088(.a(x37), .O(new_n172_));
  oai21  g089(.a(x36), .b(x09), .c(new_n86_), .O(new_n173_));
  aoi21  g090(.a(new_n172_), .b(x09), .c(new_n173_), .O(z25));
  nor2   g091(.a(x38), .b(new_n157_), .O(new_n175_));
  oai21  g092(.a(x37), .b(x09), .c(new_n86_), .O(new_n176_));
  oai21  g093(.a(new_n176_), .b(new_n175_), .c(new_n89_), .O(z26));
  ...
  oai21  g113(.a(x14), .b(new_n157_), .c(new_n190_), .O(new_n197_));
  ...
  oai21  g118(.a(x14), .b(new_n157_), .c(new_n195_), .O(new_n202_));
  ...
  oai21  g137(.a(x14), .b(new_n157_), .c(new_n215_), .O(new_n221_));
