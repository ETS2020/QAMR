...
module FAU ( 
  ...
  oai21  g044(.a(new_n108_), .b(new_n126_), .c(new_n127_), .O(z13));
  ...
  oai21  g057(.a(new_n108_), .b(new_n137_), .c(new_n140_), .O(z18));
  ...
  nor2   g076(.a(new_n159_), .b(new_n158_), .O(z23));
