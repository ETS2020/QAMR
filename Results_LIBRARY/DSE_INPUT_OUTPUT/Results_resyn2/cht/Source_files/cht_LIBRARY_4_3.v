...
module FAU ( 
  ...
  oai21  g043(.a(new_n113_), .b(new_n125_), .c(new_n126_), .O(z13));
  nor2   g044(.a(x26), .b(new_n105_), .O(new_n128_));
  oai21  g045(.a(x25), .b(x08), .c(new_n87_), .O(new_n129_));
  nor2   g046(.a(new_n129_), .b(new_n128_), .O(z14));
  nor2   g047(.a(x27), .b(new_n105_), .O(new_n131_));
  ...
  oai21  g057(.a(new_n113_), .b(new_n137_), .c(new_n140_), .O(z18));
  ...
  oai21  g070(.a(new_n153_), .b(new_n152_), .c(new_n84_), .O(z22));
  ...
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n84_), .O(z26));
  ...
  oai21  g092(.a(x14), .b(new_n145_), .c(new_n168_), .O(new_n176_));
  ...
  nand2  g104(.a(new_n187_), .b(new_n84_), .O(z30));
  ...
  nand2  g114(.a(new_n197_), .b(new_n84_), .O(z32));
