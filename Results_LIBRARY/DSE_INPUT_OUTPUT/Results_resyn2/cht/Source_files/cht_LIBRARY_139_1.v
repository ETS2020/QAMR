...
module FAU ( 
  ...
  nand2  g115(.a(new_n193_), .b(new_n187_), .O(new_n199_));
  ...
  oai21  g163(.a(x14), .b(new_n187_), .c(new_n240_), .O(new_n247_));
  ...
  nand2  g175(.a(new_n258_), .b(new_n93_), .O(z33));
  inv1   g176(.a(x46), .O(new_n260_));
  nand3  g177(.a(new_n260_), .b(new_n222_), .c(x09), .O(new_n261_));
  oai21  g178(.a(x14), .b(new_n187_), .c(new_n255_), .O(new_n262_));
  ...
  oai21  g182(.a(x14), .b(new_n187_), .c(new_n260_), .O(new_n266_));
