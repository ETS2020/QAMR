...
module FAU ( 
  ...
  nand2  g005(.a(x21), .b(x10), .O(new_n89_));
  ...
  nand2  g029(.a(new_n112_), .b(new_n89_), .O(z07));
  nor2   g030(.a(x20), .b(new_n110_), .O(new_n114_));
  oai21  g031(.a(x19), .b(x08), .c(new_n86_), .O(new_n115_));
  oai21  g032(.a(new_n115_), .b(new_n114_), .c(new_n89_), .O(z08));
  ...
  nor2   g039(.a(x23), .b(new_n110_), .O(new_n123_));
  ...
  nand2  g047(.a(new_n126_), .b(new_n110_), .O(new_n131_));
  ...
  nand2  g052(.a(new_n129_), .b(new_n110_), .O(new_n136_));
  ...
  oai21  g057(.a(new_n140_), .b(new_n139_), .c(new_n89_), .O(z15));
  ...
  nand2  g076(.a(new_n159_), .b(new_n89_), .O(z20));
  ...
  oai21  g099(.a(new_n182_), .b(new_n181_), .c(new_n89_), .O(z25));
  ...
  nand2  g109(.a(new_n192_), .b(new_n89_), .O(z27));
