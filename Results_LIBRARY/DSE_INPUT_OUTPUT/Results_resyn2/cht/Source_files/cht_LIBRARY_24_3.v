...
module FAU ( 
  ...
  nand2  g058(.a(new_n141_), .b(new_n89_), .O(z16));
  ...
  nand2  g089(.a(new_n86_), .b(new_n154_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(x38), .O(new_n174_));
  oai21  g091(.a(new_n173_), .b(new_n170_), .c(new_n174_), .O(z26));
  ...
  nand2  g103(.a(new_n186_), .b(new_n89_), .O(z28));
  ...
  nand2  g118(.a(new_n201_), .b(new_n89_), .O(z31));
  ...
  nand2  g128(.a(new_n211_), .b(new_n89_), .O(z33));
  ...
  nand2  g133(.a(new_n216_), .b(new_n89_), .O(z34));
  ...
  nand2  g137(.a(new_n220_), .b(new_n89_), .O(z35));
endmodule
