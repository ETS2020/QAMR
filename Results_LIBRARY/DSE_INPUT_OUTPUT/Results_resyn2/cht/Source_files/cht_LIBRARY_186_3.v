...
module FAU ( 
  ...
  nand2  g046(.a(new_n123_), .b(new_n107_), .O(new_n130_));
  ...
  oai21  g050(.a(x23), .b(x08), .c(new_n86_), .O(new_n134_));
  oai21  g051(.a(new_n134_), .b(new_n133_), .c(new_n89_), .O(z12));
  ...
  oai21  g055(.a(x10), .b(new_n107_), .c(x25), .O(new_n139_));
  nand3  g056(.a(x26), .b(new_n86_), .c(x08), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n139_), .O(z14));
  nor2   g058(.a(x27), .b(new_n107_), .O(new_n142_));
  oai21  g059(.a(x26), .b(x08), .c(new_n86_), .O(new_n143_));
  oai21  g060(.a(new_n143_), .b(new_n142_), .c(new_n89_), .O(z15));
  ...
  oai21  g092(.a(new_n175_), .b(new_n174_), .c(new_n89_), .O(z24));
