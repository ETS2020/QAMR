...
module FAU ( 
  ...
  nor2   g047(.a(x26), .b(new_n92_), .O(new_n131_));
  ...
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n93_), .O(z20));
  ...
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n93_), .O(z22));
  ...
  nand2  g080(.a(new_n159_), .b(new_n149_), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n86_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n93_), .O(z24));
  nor2   g083(.a(x37), .b(new_n149_), .O(new_n167_));
  oai21  g084(.a(x36), .b(x09), .c(new_n86_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n93_), .O(z25));
  nor2   g086(.a(x38), .b(new_n149_), .O(new_n170_));
  ...
  nand2  g092(.a(x14), .b(new_n146_), .O(new_n176_));
  ...
  oai21  g098(.a(x14), .b(new_n149_), .c(new_n174_), .O(new_n182_));
  ...
  oai21  g118(.a(x14), .b(new_n149_), .c(new_n195_), .O(new_n202_));
  ...
  oai21  g123(.a(x14), .b(new_n149_), .c(new_n200_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n86_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n93_), .O(z33));
  inv1   g126(.a(x46), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n173_), .c(x09), .O(new_n211_));
  oai21  g128(.a(x14), .b(new_n149_), .c(new_n205_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n211_), .c(new_n86_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand3  g131(.a(new_n173_), .b(x09), .c(new_n146_), .O(new_n215_));
  oai21  g132(.a(x14), .b(new_n149_), .c(new_n210_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n215_), .c(new_n86_), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(new_n93_), .O(z35));
endmodule
