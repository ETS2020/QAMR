...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n188_, new_n190_, new_n192_, new_n194_, new_n196_;
  ...
  nor2   g025(.a(x10), .b(x09), .O(new_n109_));
  inv1   g026(.a(x18), .O(new_n110_));
  nand2  g027(.a(new_n110_), .b(new_n104_), .O(new_n111_));
  nand3  g028(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(new_n112_));
  inv1   g029(.a(new_n112_), .O(z07));
  nand2  g030(.a(x20), .b(x08), .O(new_n114_));
  aoi21  g031(.a(x19), .b(new_n104_), .c(x09), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n114_), .c(x10), .O(z08));
  nand2  g033(.a(x21), .b(x08), .O(new_n117_));
  aoi21  g034(.a(x20), .b(new_n104_), .c(x09), .O(new_n118_));
  ...
  nand2  g039(.a(new_n122_), .b(new_n104_), .O(new_n123_));
  nand3  g040(.a(new_n123_), .b(new_n121_), .c(new_n109_), .O(new_n124_));
  inv1   g041(.a(new_n124_), .O(z10));
  nand2  g042(.a(x23), .b(x08), .O(new_n126_));
  aoi21  g043(.a(x22), .b(new_n104_), .c(x09), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(new_n126_), .c(x10), .O(z11));
  nand2  g045(.a(x24), .b(x08), .O(new_n129_));
  aoi21  g046(.a(x23), .b(new_n104_), .c(x09), .O(new_n130_));
  ...
  nand2  g051(.a(new_n134_), .b(new_n104_), .O(new_n135_));
  nand3  g052(.a(new_n135_), .b(new_n133_), .c(new_n109_), .O(new_n136_));
  inv1   g053(.a(new_n136_), .O(z13));
  nand2  g054(.a(x26), .b(x08), .O(new_n138_));
  aoi21  g055(.a(x25), .b(new_n104_), .c(x09), .O(new_n139_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n104_), .O(new_n144_));
  nand3  g061(.a(new_n144_), .b(new_n142_), .c(new_n109_), .O(new_n145_));
  inv1   g062(.a(new_n145_), .O(z15));
  inv1   g063(.a(x28), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(x08), .O(new_n148_));
  nand2  g065(.a(new_n141_), .b(new_n104_), .O(new_n149_));
  nand3  g066(.a(new_n149_), .b(new_n148_), .c(new_n109_), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z16));
  inv1   g068(.a(x29), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(x08), .O(new_n153_));
  nand2  g070(.a(new_n147_), .b(new_n104_), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n153_), .c(new_n109_), .O(new_n155_));
  inv1   g072(.a(new_n155_), .O(z17));
  inv1   g073(.a(x30), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(x08), .O(new_n158_));
  nand2  g075(.a(new_n152_), .b(new_n104_), .O(new_n159_));
  nand3  g076(.a(new_n159_), .b(new_n158_), .c(new_n109_), .O(new_n160_));
  inv1   g077(.a(new_n160_), .O(z18));
  nand2  g078(.a(x08), .b(x00), .O(new_n162_));
  aoi21  g079(.a(x30), .b(new_n104_), .c(x09), .O(new_n163_));
