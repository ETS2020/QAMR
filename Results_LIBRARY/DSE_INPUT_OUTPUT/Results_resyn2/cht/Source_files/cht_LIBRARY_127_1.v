...
module FAU ( 
  ...
  oai21  g040(.a(new_n123_), .b(new_n122_), .c(new_n85_), .O(z10));
  ...
  oai21  g060(.a(x28), .b(x08), .c(new_n88_), .O(new_n144_));
  nor2   g061(.a(new_n144_), .b(new_n143_), .O(z17));
  inv1   g062(.a(x30), .O(new_n146_));
  oai21  g063(.a(x29), .b(x08), .c(new_n88_), .O(new_n147_));
  ...
  nor2   g071(.a(x31), .b(x10), .O(new_n155_));
  nand2  g072(.a(new_n88_), .b(x09), .O(new_n156_));
  oai22  g073(.a(new_n156_), .b(new_n154_), .c(new_n155_), .d(x09), .O(z20));
  inv1   g074(.a(x33), .O(new_n158_));
  nor2   g075(.a(x32), .b(x10), .O(new_n159_));
  oai22  g076(.a(new_n159_), .b(x09), .c(new_n156_), .d(new_n158_), .O(z21));
  inv1   g077(.a(x34), .O(new_n161_));
  nor2   g078(.a(x33), .b(x10), .O(new_n162_));
  oai22  g079(.a(new_n162_), .b(x09), .c(new_n156_), .d(new_n161_), .O(z22));
  nor2   g080(.a(x35), .b(new_n84_), .O(new_n164_));
  oai21  g081(.a(x34), .b(x09), .c(new_n88_), .O(new_n165_));
  nor2   g082(.a(new_n165_), .b(new_n164_), .O(z23));
  nor2   g083(.a(x36), .b(new_n84_), .O(new_n167_));
  oai21  g084(.a(x35), .b(x09), .c(new_n88_), .O(new_n168_));
  nor2   g085(.a(new_n168_), .b(new_n167_), .O(z24));
  nor2   g086(.a(x37), .b(new_n84_), .O(new_n170_));
  oai21  g087(.a(x36), .b(x09), .c(new_n88_), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(new_n170_), .O(z25));
  inv1   g089(.a(x38), .O(new_n173_));
  nor2   g090(.a(x37), .b(x10), .O(new_n174_));
  oai22  g091(.a(new_n174_), .b(x09), .c(new_n156_), .d(new_n173_), .O(z26));
  nand2  g092(.a(x14), .b(x00), .O(new_n176_));
  inv1   g093(.a(x14), .O(new_n177_));
  aoi21  g094(.a(x39), .b(new_n177_), .c(new_n84_), .O(new_n178_));
  oai21  g095(.a(x38), .b(x09), .c(new_n88_), .O(new_n179_));
  ...
  nand3  g105(.a(new_n188_), .b(new_n177_), .c(x09), .O(new_n189_));
  ...
  oai21  g117(.a(x14), .b(new_n84_), .c(new_n194_), .O(new_n201_));
  ...
  oai21  g122(.a(x14), .b(new_n84_), .c(new_n199_), .O(new_n206_));
  ...
  aoi22  g127(.a(new_n210_), .b(new_n182_), .c(new_n209_), .d(x09), .O(z34));
  nand3  g128(.a(new_n177_), .b(x09), .c(new_n149_), .O(new_n212_));
  inv1   g129(.a(x46), .O(new_n213_));
  oai21  g130(.a(x14), .b(new_n84_), .c(new_n213_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n212_), .c(new_n88_), .O(new_n215_));
