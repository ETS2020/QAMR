...
module FAU ( 
  ...
  nor2   g084(.a(x10), .b(new_n152_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(x37), .O(new_n169_));
  oai21  g086(.a(new_n168_), .b(new_n165_), .c(new_n169_), .O(z25));
  ...
  aoi21  g094(.a(new_n171_), .b(new_n152_), .c(x10), .O(new_n178_));
  ...
  nand3  g134(.a(new_n175_), .b(x09), .c(new_n149_), .O(new_n218_));
