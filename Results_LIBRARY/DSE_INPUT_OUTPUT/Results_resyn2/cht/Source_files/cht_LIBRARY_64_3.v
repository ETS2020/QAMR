...
module FAU ( 
  ...
  nand2  g037(.a(new_n120_), .b(new_n89_), .O(z09));
  nor2   g038(.a(x22), .b(new_n105_), .O(new_n122_));
  oai21  g039(.a(x21), .b(x08), .c(new_n86_), .O(new_n123_));
  oai21  g040(.a(new_n123_), .b(new_n122_), .c(new_n89_), .O(z10));
  ...
  nand2  g060(.a(new_n143_), .b(new_n89_), .O(z16));
  ...
  nand2  g083(.a(new_n86_), .b(new_n154_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(x36), .O(new_n168_));
  oai21  g085(.a(new_n167_), .b(new_n164_), .c(new_n168_), .O(z24));
  oai21  g086(.a(x10), .b(new_n154_), .c(x36), .O(new_n170_));
  nand3  g087(.a(x37), .b(new_n86_), .c(x09), .O(new_n171_));
  ...
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n89_), .O(z26));
  ...
  nand2  g108(.a(new_n191_), .b(new_n89_), .O(z29));
  ...
  nand2  g123(.a(new_n206_), .b(new_n89_), .O(z32));
