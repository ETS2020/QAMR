...
module FAU ( 
  ...
  nand2  g049(.a(new_n126_), .b(new_n117_), .O(new_n133_));
  ...
  nand2  g098(.a(new_n181_), .b(new_n167_), .O(new_n182_));
  ...
  nand2  g103(.a(new_n179_), .b(new_n167_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n86_), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z25));
  nand2  g106(.a(x38), .b(x09), .O(new_n190_));
  aoi21  g107(.a(x37), .b(new_n167_), .c(x28), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z26));
  inv1   g109(.a(x00), .O(new_n193_));
  nand2  g110(.a(x14), .b(new_n193_), .O(new_n194_));
  inv1   g111(.a(x39), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n106_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n194_), .c(x09), .O(new_n197_));
  aoi21  g114(.a(x38), .b(new_n167_), .c(x28), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z27));
  nor2   g116(.a(x14), .b(new_n167_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(x40), .O(new_n201_));
  nand2  g118(.a(new_n106_), .b(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(x39), .c(x28), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n201_), .c(x10), .O(z28));
  nand2  g121(.a(new_n200_), .b(x41), .O(new_n205_));
  aoi21  g122(.a(new_n202_), .b(x40), .c(x28), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z29));
  nand2  g124(.a(new_n200_), .b(x42), .O(new_n208_));
  aoi21  g125(.a(new_n202_), .b(x41), .c(x28), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z30));
  inv1   g127(.a(x43), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n106_), .c(x09), .O(new_n212_));
  inv1   g129(.a(x42), .O(new_n213_));
  nand2  g130(.a(new_n202_), .b(new_n213_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n212_), .c(new_n86_), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z31));
  inv1   g133(.a(x44), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n106_), .c(x09), .O(new_n218_));
  nand2  g135(.a(new_n202_), .b(new_n211_), .O(new_n219_));
  ...
  aoi21  g139(.a(new_n202_), .b(x44), .c(x28), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(new_n222_), .c(x10), .O(z33));
  inv1   g141(.a(x46), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n106_), .c(x09), .O(new_n226_));
  inv1   g143(.a(x45), .O(new_n227_));
  nand2  g144(.a(new_n202_), .b(new_n227_), .O(new_n228_));
  nand3  g145(.a(new_n228_), .b(new_n226_), .c(new_n86_), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(z34));
  nand3  g147(.a(new_n106_), .b(x09), .c(new_n193_), .O(new_n231_));
  nand2  g148(.a(new_n202_), .b(new_n225_), .O(new_n232_));
