...
module FAU ( 
  ...
  nor2   g047(.a(x27), .b(new_n109_), .O(new_n131_));
  ...
  oai21  g059(.a(new_n110_), .b(new_n139_), .c(new_n142_), .O(z19));
  inv1   g060(.a(x09), .O(new_n144_));
  nor2   g061(.a(x32), .b(new_n144_), .O(new_n145_));
  oai21  g062(.a(x31), .b(x09), .c(new_n86_), .O(new_n146_));
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n89_), .O(z20));
  inv1   g064(.a(x33), .O(new_n148_));
  oai21  g065(.a(x32), .b(x09), .c(new_n86_), .O(new_n149_));
  aoi21  g066(.a(new_n148_), .b(x09), .c(new_n149_), .O(z21));
  inv1   g067(.a(x34), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(x09), .O(new_n152_));
  nand2  g069(.a(new_n148_), .b(new_n144_), .O(new_n153_));
  nand3  g070(.a(new_n153_), .b(new_n152_), .c(new_n86_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n89_), .O(z22));
  nor2   g072(.a(x35), .b(new_n144_), .O(new_n156_));
  oai21  g073(.a(x34), .b(x09), .c(new_n86_), .O(new_n157_));
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n89_), .O(z23));
  nor2   g075(.a(x36), .b(new_n144_), .O(new_n159_));
  ...
  nand2  g083(.a(new_n162_), .b(new_n144_), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n86_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n89_), .O(z26));
  ...
  aoi21  g090(.a(new_n165_), .b(new_n144_), .c(x10), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n89_), .O(z27));
  ...
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(z28));
  ...
  nand2  g104(.a(new_n187_), .b(new_n89_), .O(z29));
  ...
  nand2  g109(.a(new_n192_), .b(new_n89_), .O(z30));
  ...
  nand2  g129(.a(new_n212_), .b(new_n89_), .O(z34));
