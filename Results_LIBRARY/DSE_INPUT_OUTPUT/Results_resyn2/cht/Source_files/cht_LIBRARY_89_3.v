...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n91_,
    ...
    new_n271_, new_n272_;
  nand2  g000(.a(x39), .b(x21), .O(new_n84_));
  ...
  aoi21  g006(.a(x39), .b(x21), .c(x10), .O(new_n90_));
  ...
  nand2  g078(.a(new_n155_), .b(new_n120_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n87_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n84_), .O(z14));
  inv1   g081(.a(x27), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(x08), .O(new_n166_));
  nand2  g083(.a(new_n160_), .b(new_n120_), .O(new_n167_));
  ...
  nand3  g154(.a(new_n237_), .b(new_n234_), .c(new_n90_), .O(new_n238_));
  ...
  nand2  g160(.a(new_n243_), .b(new_n84_), .O(z29));
