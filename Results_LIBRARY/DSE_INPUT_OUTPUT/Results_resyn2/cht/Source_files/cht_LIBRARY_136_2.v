...
module FAU ( 
  ...
  nand2  g001(.a(new_n84_), .b(x29), .O(new_n85_));
  ...
  aoi21  g010(.a(new_n84_), .b(x29), .c(x10), .O(new_n94_));
  ...
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n94_), .O(new_n181_));
  ...
  nand3  g139(.a(new_n222_), .b(new_n220_), .c(new_n94_), .O(new_n223_));
  ...
  aoi21  g145(.a(new_n221_), .b(new_n190_), .c(x10), .O(new_n229_));
  ...
  nand2  g164(.a(new_n247_), .b(new_n85_), .O(z30));
  ...
  aoi21  g175(.a(new_n235_), .b(new_n174_), .c(x45), .O(new_n259_));
  oai21  g176(.a(x14), .b(new_n190_), .c(new_n254_), .O(new_n260_));
  nand2  g177(.a(new_n260_), .b(new_n88_), .O(new_n261_));
  nor2   g178(.a(new_n261_), .b(new_n259_), .O(z33));
  inv1   g179(.a(x46), .O(new_n263_));
  nand3  g180(.a(new_n263_), .b(new_n226_), .c(x09), .O(new_n264_));
  nand2  g181(.a(new_n235_), .b(new_n84_), .O(new_n265_));
