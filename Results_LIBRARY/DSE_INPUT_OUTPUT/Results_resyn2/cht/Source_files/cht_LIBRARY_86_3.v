...
module FAU ( 
  ...
  nand2  g000(.a(x32), .b(x11), .O(new_n84_));
  ...
  aoi21  g009(.a(x32), .b(x11), .c(x10), .O(new_n93_));
  ...
  nand2  g045(.a(new_n125_), .b(new_n112_), .O(new_n129_));
  ...
  nand2  g052(.a(new_n130_), .b(new_n112_), .O(new_n136_));
  ...
  nand3  g149(.a(new_n232_), .b(new_n229_), .c(new_n93_), .O(new_n233_));
  ...
  nand3  g183(.a(new_n266_), .b(new_n265_), .c(new_n93_), .O(new_n267_));
