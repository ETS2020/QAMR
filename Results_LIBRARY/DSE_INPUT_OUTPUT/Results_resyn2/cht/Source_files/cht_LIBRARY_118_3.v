...
module FAU ( 
  ...
  nand2  g008(.a(x27), .b(x10), .O(new_n92_));
  ...
  oai21  g047(.a(new_n130_), .b(new_n129_), .c(new_n92_), .O(z13));
  inv1   g048(.a(x26), .O(new_n132_));
  oai21  g049(.a(x25), .b(x08), .c(new_n86_), .O(new_n133_));
  aoi21  g050(.a(new_n132_), .b(x08), .c(new_n133_), .O(z14));
  nand2  g051(.a(new_n86_), .b(new_n105_), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(x27), .O(new_n136_));
  oai21  g053(.a(new_n135_), .b(new_n132_), .c(new_n136_), .O(z15));
  inv1   g054(.a(x27), .O(new_n138_));
  nor2   g055(.a(x10), .b(new_n105_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(x28), .O(new_n140_));
  oai21  g057(.a(new_n139_), .b(new_n138_), .c(new_n140_), .O(z16));
  ...
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n92_), .O(z18));
  ...
  nand2  g073(.a(new_n156_), .b(new_n92_), .O(z20));
  nor2   g074(.a(x33), .b(new_n153_), .O(new_n158_));
  oai21  g075(.a(x32), .b(x09), .c(new_n86_), .O(new_n159_));
  oai21  g076(.a(new_n159_), .b(new_n158_), .c(new_n92_), .O(z21));
  ...
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n92_), .O(z23));
  nor2   g083(.a(x36), .b(new_n153_), .O(new_n167_));
  ...
  nand2  g091(.a(new_n170_), .b(new_n153_), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n174_), .c(new_n86_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n92_), .O(z26));
  ...
  aoi21  g098(.a(new_n173_), .b(new_n153_), .c(x10), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n92_), .O(z27));
  ...
  nand2  g107(.a(new_n190_), .b(new_n92_), .O(z28));
  ...
  nand2  g122(.a(new_n205_), .b(new_n92_), .O(z31));
  ...
  nand2  g127(.a(new_n210_), .b(new_n92_), .O(z32));
  ...
  nand3  g138(.a(new_n179_), .b(x09), .c(new_n148_), .O(new_n222_));
