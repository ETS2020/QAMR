...
module FAU ( 
  ...
  nand2  g051(.a(new_n128_), .b(new_n108_), .O(new_n135_));
  ...
  nor2   g081(.a(x10), .b(x09), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(x31), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n164_), .O(z20));
  inv1   g084(.a(x33), .O(new_n168_));
  oai21  g085(.a(x32), .b(x09), .c(new_n87_), .O(new_n169_));
  aoi21  g086(.a(new_n168_), .b(x09), .c(new_n169_), .O(z21));
  inv1   g087(.a(new_n165_), .O(new_n171_));
  oai21  g088(.a(x34), .b(x10), .c(x09), .O(new_n172_));
  oai21  g089(.a(new_n171_), .b(new_n168_), .c(new_n172_), .O(z22));
  inv1   g090(.a(x09), .O(new_n174_));
  nor2   g091(.a(x35), .b(new_n174_), .O(new_n175_));
  ...
  oai21  g097(.a(x37), .b(x10), .c(x09), .O(new_n181_));
  oai21  g098(.a(new_n171_), .b(new_n178_), .c(new_n181_), .O(z25));
  oai21  g099(.a(x38), .b(x10), .c(x09), .O(new_n183_));
  nand2  g100(.a(new_n165_), .b(x37), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(z26));
  nand2  g102(.a(new_n165_), .b(x38), .O(new_n186_));
  ...
  nand3  g110(.a(new_n193_), .b(new_n188_), .c(x09), .O(new_n194_));
  inv1   g111(.a(x39), .O(new_n195_));
  nand2  g112(.a(new_n188_), .b(x09), .O(new_n196_));
  ...
  nand2  g116(.a(x10), .b(new_n174_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n196_), .c(x40), .O(new_n201_));
  aoi21  g118(.a(x41), .b(new_n188_), .c(x10), .O(new_n202_));
  oai21  g119(.a(new_n202_), .b(new_n174_), .c(new_n201_), .O(z29));
  nand3  g120(.a(new_n200_), .b(new_n196_), .c(x41), .O(new_n204_));
  aoi21  g121(.a(x42), .b(new_n188_), .c(x10), .O(new_n205_));
  oai21  g122(.a(new_n205_), .b(new_n174_), .c(new_n204_), .O(z30));
  inv1   g123(.a(x43), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n188_), .c(x09), .O(new_n208_));
  inv1   g125(.a(x42), .O(new_n209_));
  nand2  g126(.a(new_n196_), .b(new_n209_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n208_), .c(new_n87_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z31));
  nand3  g129(.a(new_n200_), .b(new_n196_), .c(x43), .O(new_n213_));
  aoi21  g130(.a(x44), .b(new_n188_), .c(x10), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(new_n174_), .c(new_n213_), .O(z32));
  nand3  g132(.a(new_n200_), .b(new_n196_), .c(x44), .O(new_n216_));
  aoi21  g133(.a(x45), .b(new_n188_), .c(x10), .O(new_n217_));
  oai21  g134(.a(new_n217_), .b(new_n174_), .c(new_n216_), .O(z33));
  inv1   g135(.a(x46), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n188_), .c(x09), .O(new_n220_));
  inv1   g137(.a(x45), .O(new_n221_));
  nand2  g138(.a(new_n196_), .b(new_n221_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n220_), .c(new_n87_), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(z34));
  nand3  g141(.a(new_n188_), .b(x09), .c(new_n159_), .O(new_n225_));
  nand2  g142(.a(new_n196_), .b(new_n219_), .O(new_n226_));
