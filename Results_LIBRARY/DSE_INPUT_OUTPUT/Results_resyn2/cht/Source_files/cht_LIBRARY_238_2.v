...
module FAU ( 
  ...
  nand2  g040(.a(new_n118_), .b(new_n108_), .O(new_n124_));
  nand3  g041(.a(new_n124_), .b(new_n123_), .c(new_n88_), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(new_n85_), .O(z09));
  nor2   g043(.a(x22), .b(new_n108_), .O(new_n127_));
  oai21  g044(.a(x21), .b(x08), .c(new_n88_), .O(new_n128_));
  oai21  g045(.a(new_n128_), .b(new_n127_), .c(new_n85_), .O(z10));
  nor2   g046(.a(x23), .b(new_n108_), .O(new_n130_));
  oai21  g047(.a(x22), .b(x08), .c(new_n88_), .O(new_n131_));
  nor2   g048(.a(new_n131_), .b(new_n130_), .O(z11));
  nor2   g049(.a(x24), .b(new_n108_), .O(new_n133_));
  ...
  nor2   g060(.a(x27), .b(new_n108_), .O(new_n144_));
  ...
  nor2   g065(.a(new_n148_), .b(new_n147_), .O(z16));
  ...
  nor2   g090(.a(x36), .b(new_n159_), .O(new_n174_));
  oai21  g091(.a(x35), .b(x09), .c(new_n88_), .O(new_n175_));
  oai21  g092(.a(new_n175_), .b(new_n174_), .c(new_n85_), .O(z24));
  nor2   g093(.a(x37), .b(new_n159_), .O(new_n177_));
  oai21  g094(.a(x36), .b(x09), .c(new_n88_), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(new_n177_), .O(z25));
  nor2   g096(.a(x38), .b(new_n159_), .O(new_n180_));
  ...
  nand2  g102(.a(x14), .b(new_n156_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  oai21  g104(.a(x38), .b(x09), .c(new_n88_), .O(new_n188_));
  ...
  oai21  g108(.a(x14), .b(new_n159_), .c(new_n184_), .O(new_n192_));
  ...
  nand2  g115(.a(new_n198_), .b(new_n85_), .O(z29));
  ...
  oai21  g138(.a(x14), .b(new_n159_), .c(new_n215_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(new_n88_), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(z34));
  nand3  g141(.a(new_n183_), .b(x09), .c(new_n156_), .O(new_n225_));
  oai21  g142(.a(x14), .b(new_n159_), .c(new_n220_), .O(new_n226_));
