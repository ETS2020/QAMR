...
module FAU ( 
  ...
  nand2  g013(.a(x07), .b(new_n95_), .O(new_n97_));
  inv1   g014(.a(x14), .O(new_n98_));
  nand2  g015(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  nand3  g016(.a(new_n99_), .b(new_n97_), .c(new_n86_), .O(new_n100_));
  nand2  g017(.a(new_n100_), .b(new_n96_), .O(z03));
  ...
  oai21  g023(.a(new_n106_), .b(new_n105_), .c(new_n96_), .O(z05));
  ...
  nor2   g047(.a(x24), .b(new_n108_), .O(new_n131_));
  oai21  g048(.a(x23), .b(x08), .c(new_n86_), .O(new_n132_));
  oai21  g049(.a(new_n132_), .b(new_n131_), .c(new_n96_), .O(z12));
  nor2   g050(.a(x25), .b(new_n108_), .O(new_n134_));
  ...
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n96_), .O(z17));
  ...
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n96_), .O(z22));
  nor2   g087(.a(x35), .b(new_n164_), .O(new_n171_));
  ...
  nand2  g098(.a(new_n177_), .b(new_n164_), .O(new_n182_));
  ...
  aoi21  g104(.a(new_n180_), .b(new_n164_), .c(x10), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n96_), .O(z27));
  inv1   g107(.a(x40), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n98_), .c(x09), .O(new_n192_));
  ...
  nand2  g113(.a(new_n196_), .b(new_n96_), .O(z28));
  ...
  nand2  g143(.a(new_n226_), .b(new_n96_), .O(z34));
  nand3  g144(.a(new_n98_), .b(x09), .c(new_n156_), .O(new_n228_));
