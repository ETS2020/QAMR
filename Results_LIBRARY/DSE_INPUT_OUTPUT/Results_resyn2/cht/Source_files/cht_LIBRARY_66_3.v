...
module FAU ( 
  ...
  nor2   g041(.a(x22), .b(new_n107_), .O(new_n125_));
  oai21  g042(.a(x21), .b(x08), .c(new_n87_), .O(new_n126_));
  nor2   g043(.a(new_n126_), .b(new_n125_), .O(z10));
  ...
  oai21  g049(.a(new_n132_), .b(new_n131_), .c(new_n84_), .O(z12));
  ...
  oai21  g076(.a(x32), .b(x10), .c(x09), .O(new_n160_));
  inv1   g077(.a(x09), .O(new_n161_));
  nand2  g078(.a(new_n87_), .b(new_n161_), .O(new_n162_));
  oai21  g079(.a(new_n162_), .b(new_n159_), .c(new_n160_), .O(z20));
  inv1   g080(.a(x32), .O(new_n164_));
  oai21  g081(.a(x33), .b(x10), .c(x09), .O(new_n165_));
  oai21  g082(.a(new_n162_), .b(new_n164_), .c(new_n165_), .O(z21));
  nor2   g083(.a(x34), .b(new_n161_), .O(new_n167_));
  oai21  g084(.a(x33), .b(x09), .c(new_n87_), .O(new_n168_));
  ...
  oai21  g090(.a(x35), .b(x09), .c(new_n87_), .O(new_n174_));
  aoi21  g091(.a(new_n173_), .b(x09), .c(new_n174_), .O(z24));
  oai21  g092(.a(x37), .b(x10), .c(x09), .O(new_n176_));
  oai21  g093(.a(new_n162_), .b(new_n173_), .c(new_n176_), .O(z25));
  nor2   g094(.a(x38), .b(new_n161_), .O(new_n178_));
  ...
  aoi21  g099(.a(x39), .b(new_n182_), .c(new_n161_), .O(new_n183_));
  oai21  g100(.a(x38), .b(x09), .c(new_n87_), .O(new_n184_));
  aoi21  g101(.a(new_n183_), .b(new_n181_), .c(new_n184_), .O(z27));
  nand2  g102(.a(new_n182_), .b(x09), .O(new_n186_));
  nand2  g103(.a(x10), .b(new_n161_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(x39), .O(new_n188_));
  inv1   g105(.a(x40), .O(new_n189_));
  oai21  g106(.a(new_n189_), .b(x14), .c(new_n87_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(x09), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n188_), .O(z28));
  inv1   g109(.a(x41), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n182_), .c(x09), .O(new_n194_));
  oai21  g111(.a(x14), .b(new_n161_), .c(new_n189_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n194_), .c(new_n87_), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z29));
  inv1   g114(.a(x42), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n182_), .c(x09), .O(new_n199_));
  oai21  g116(.a(x14), .b(new_n161_), .c(new_n193_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n199_), .c(new_n87_), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z30));
  inv1   g119(.a(x43), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n182_), .c(x09), .O(new_n204_));
  oai21  g121(.a(x14), .b(new_n161_), .c(new_n198_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(new_n87_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z31));
  inv1   g124(.a(x44), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n182_), .c(x09), .O(new_n209_));
  oai21  g126(.a(x14), .b(new_n161_), .c(new_n203_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n87_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z32));
  inv1   g129(.a(x45), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n182_), .c(x09), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n161_), .c(new_n208_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n87_), .O(new_n216_));
  inv1   g133(.a(new_n216_), .O(z33));
  nand3  g134(.a(new_n187_), .b(new_n186_), .c(x45), .O(new_n218_));
  ...
  nand3  g139(.a(new_n182_), .b(x09), .c(new_n156_), .O(new_n223_));
  oai21  g140(.a(x14), .b(new_n161_), .c(new_n219_), .O(new_n224_));
