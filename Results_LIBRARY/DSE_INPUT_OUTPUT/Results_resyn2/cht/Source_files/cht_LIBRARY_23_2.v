...
module FAU ( 
  ...
  nand2  g045(.a(new_n93_), .b(x23), .O(new_n129_));
  inv1   g046(.a(new_n129_), .O(z12));
  nand2  g047(.a(new_n93_), .b(x24), .O(new_n131_));
  inv1   g048(.a(new_n131_), .O(z13));
  inv1   g049(.a(x25), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(new_n120_), .c(x10), .O(z14));
  inv1   g051(.a(x26), .O(new_n135_));
  aoi21  g052(.a(new_n135_), .b(new_n120_), .c(x10), .O(z15));
  ...
  nand2  g057(.a(new_n93_), .b(x29), .O(new_n141_));
  inv1   g058(.a(new_n141_), .O(z18));
  inv1   g059(.a(x30), .O(new_n143_));
  aoi21  g060(.a(new_n143_), .b(new_n120_), .c(x10), .O(z19));
  ...
  nand3  g077(.a(new_n160_), .b(new_n159_), .c(new_n93_), .O(new_n161_));
  ...
  aoi21  g086(.a(x37), .b(new_n146_), .c(x08), .O(new_n170_));
  ...
  aoi21  g093(.a(x38), .b(new_n146_), .c(x08), .O(new_n177_));
  ...
  nand3  g099(.a(new_n182_), .b(new_n180_), .c(new_n93_), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z28));
  nor2   g101(.a(x14), .b(new_n146_), .O(new_n185_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n93_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z32));
  nand2  g121(.a(new_n185_), .b(x45), .O(new_n205_));
  aoi21  g122(.a(new_n181_), .b(x44), .c(x08), .O(new_n206_));
  ...
  nand3  g130(.a(new_n100_), .b(x09), .c(new_n172_), .O(new_n214_));
