...
module FAU ( 
  ...
  nand2  g093(.a(x14), .b(new_n143_), .O(new_n177_));
  ...
  nand3  g100(.a(new_n183_), .b(new_n104_), .c(x09), .O(new_n184_));
  nand2  g101(.a(new_n104_), .b(x09), .O(new_n185_));
  ...
  aoi21  g115(.a(new_n185_), .b(x42), .c(new_n86_), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z31));
  nand2  g117(.a(new_n194_), .b(x44), .O(new_n201_));
  aoi21  g118(.a(new_n185_), .b(x43), .c(new_n86_), .O(new_n202_));
  ...
  nand2  g123(.a(new_n185_), .b(new_n206_), .O(new_n207_));
  ...
  nand2  g128(.a(new_n185_), .b(new_n204_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n211_), .c(new_n87_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand2  g131(.a(new_n194_), .b(x00), .O(new_n215_));
  aoi21  g132(.a(new_n185_), .b(x46), .c(new_n86_), .O(new_n216_));
