...
module FAU ( 
  ...
  nor2   g002(.a(x23), .b(x10), .O(new_n86_));
  ...
  aoi21  g021(.a(x14), .b(new_n87_), .c(x23), .O(new_n105_));
  aoi21  g022(.a(new_n105_), .b(new_n104_), .c(x10), .O(z03));
  nand2  g023(.a(x07), .b(x02), .O(new_n107_));
  aoi21  g024(.a(x15), .b(new_n87_), .c(x23), .O(new_n108_));
  ...
  aoi21  g034(.a(x17), .b(new_n117_), .c(x23), .O(new_n118_));
  ...
  aoi21  g043(.a(x19), .b(new_n117_), .c(x23), .O(new_n127_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n172_), .c(new_n86_), .O(new_n176_));
  ...
  aoi21  g122(.a(x38), .b(new_n173_), .c(x23), .O(new_n206_));
  ...
  nand2  g144(.a(new_n208_), .b(x45), .O(new_n228_));
  aoi21  g145(.a(new_n210_), .b(x44), .c(x23), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z33));
  nand2  g147(.a(new_n208_), .b(x46), .O(new_n231_));
  aoi21  g148(.a(new_n210_), .b(x45), .c(x23), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n231_), .c(x10), .O(z34));
  nand2  g150(.a(new_n208_), .b(x00), .O(new_n234_));
  aoi21  g151(.a(new_n210_), .b(x46), .c(x23), .O(new_n235_));
