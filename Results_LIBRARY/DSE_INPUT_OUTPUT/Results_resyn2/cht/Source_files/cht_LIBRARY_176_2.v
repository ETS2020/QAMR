...
module FAU ( 
  ...
  oai21  g061(.a(new_n144_), .b(new_n143_), .c(new_n93_), .O(z16));
  ...
  nand2  g069(.a(new_n152_), .b(new_n93_), .O(z18));
  ...
  oai21  g095(.a(new_n178_), .b(new_n177_), .c(new_n93_), .O(z25));
  ...
  nand2  g105(.a(new_n188_), .b(new_n93_), .O(z27));
  ...
  nand2  g117(.a(new_n200_), .b(new_n93_), .O(z29));
  ...
  nand2  g127(.a(new_n210_), .b(new_n93_), .O(z31));
