...
module FAU ( 
  ...
  nand2  g065(.a(new_n144_), .b(new_n105_), .O(new_n149_));
  nand3  g066(.a(new_n149_), .b(new_n148_), .c(new_n86_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n89_), .O(z19));
  ...
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n89_), .O(z21));
  ...
  nor2   g084(.a(x37), .b(new_n155_), .O(new_n168_));
  ...
  oai21  g099(.a(x14), .b(new_n155_), .c(new_n175_), .O(new_n183_));
  ...
  oai21  g104(.a(x14), .b(new_n155_), .c(new_n181_), .O(new_n188_));
  ...
  oai21  g133(.a(x14), .b(new_n155_), .c(new_n211_), .O(new_n217_));
