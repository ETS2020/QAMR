...
module FAU ( 
  ...
  nor2   g049(.a(x20), .b(x08), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(x21), .c(x10), .O(z09));
  nor3   g051(.a(x22), .b(new_n86_), .c(new_n119_), .O(new_n135_));
  nor2   g052(.a(new_n135_), .b(x10), .O(z10));
  nand2  g053(.a(x23), .b(x08), .O(new_n137_));
  aoi21  g054(.a(x22), .b(new_n119_), .c(new_n86_), .O(new_n138_));
  ...
  nand2  g086(.a(new_n169_), .b(new_n119_), .O(new_n170_));
  ...
  nand3  g107(.a(new_n190_), .b(new_n189_), .c(new_n91_), .O(new_n191_));
  ...
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(new_n91_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z26));
  nand2  g124(.a(x14), .b(new_n167_), .O(new_n208_));
  inv1   g125(.a(x39), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n101_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n208_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(x38), .b(new_n174_), .c(new_n86_), .O(new_n212_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n233_), .c(new_n91_), .O(new_n236_));
  ...
  aoi21  g165(.a(new_n216_), .b(x46), .c(new_n86_), .O(new_n249_));
