...
module FAU ( 
  ...
  nand2  g032(.a(new_n90_), .b(x21), .O(new_n116_));
  inv1   g033(.a(new_n116_), .O(z10));
  inv1   g034(.a(x22), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n111_), .c(x10), .O(z11));
  nand2  g036(.a(new_n90_), .b(x23), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z12));
  nand2  g038(.a(new_n90_), .b(x24), .O(new_n122_));
  inv1   g039(.a(new_n122_), .O(z13));
  nand2  g040(.a(new_n90_), .b(x25), .O(new_n124_));
  inv1   g041(.a(new_n124_), .O(z14));
  inv1   g042(.a(x26), .O(new_n126_));
  aoi21  g043(.a(new_n126_), .b(new_n111_), .c(x10), .O(z15));
  nand2  g044(.a(new_n90_), .b(x27), .O(new_n128_));
  inv1   g045(.a(new_n128_), .O(z16));
  inv1   g046(.a(x28), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n111_), .c(x10), .O(z17));
  ...
  aoi21  g066(.a(x34), .b(new_n137_), .c(x08), .O(new_n150_));
  ...
  nand2  g071(.a(new_n154_), .b(new_n137_), .O(new_n155_));
  ...
  nand2  g076(.a(new_n152_), .b(new_n137_), .O(new_n160_));
  nand3  g077(.a(new_n160_), .b(new_n159_), .c(new_n90_), .O(new_n161_));
  ...
  nand3  g096(.a(new_n179_), .b(new_n168_), .c(x09), .O(new_n180_));
  inv1   g097(.a(x40), .O(new_n181_));
  nand2  g098(.a(new_n176_), .b(new_n181_), .O(new_n182_));
  ...
  nand2  g103(.a(new_n176_), .b(new_n179_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n90_), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z30));
  nand2  g106(.a(new_n174_), .b(x43), .O(new_n190_));
  aoi21  g107(.a(new_n176_), .b(x42), .c(x08), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z31));
  nand2  g109(.a(new_n174_), .b(x44), .O(new_n193_));
  aoi21  g110(.a(new_n176_), .b(x43), .c(x08), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z32));
  nand2  g112(.a(new_n174_), .b(x45), .O(new_n196_));
  aoi21  g113(.a(new_n176_), .b(x44), .c(x08), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z33));
  inv1   g115(.a(x46), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n168_), .c(x09), .O(new_n200_));
  inv1   g117(.a(x45), .O(new_n201_));
  nand2  g118(.a(new_n176_), .b(new_n201_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n200_), .c(new_n90_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand3  g121(.a(new_n168_), .b(x09), .c(new_n166_), .O(new_n205_));
  nand2  g122(.a(new_n176_), .b(new_n199_), .O(new_n206_));
