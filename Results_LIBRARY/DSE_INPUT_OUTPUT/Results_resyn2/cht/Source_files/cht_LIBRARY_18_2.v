...
module FAU ( 
  ...
  aoi21  g037(.a(x20), .b(new_n111_), .c(x09), .O(new_n121_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n111_), .O(new_n144_));
  ...
  nand2  g065(.a(new_n141_), .b(new_n111_), .O(new_n149_));
  ...
  aoi21  g079(.a(x30), .b(new_n111_), .c(x09), .O(new_n163_));
  ...
  nand2  g084(.a(new_n86_), .b(x32), .O(new_n168_));
  inv1   g085(.a(new_n168_), .O(z21));
  inv1   g086(.a(x33), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n165_), .c(x10), .O(z22));
  inv1   g088(.a(x34), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n165_), .c(x10), .O(z23));
  nand2  g090(.a(new_n86_), .b(x35), .O(new_n174_));
  inv1   g091(.a(new_n174_), .O(z24));
  inv1   g092(.a(x36), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n165_), .c(x10), .O(z25));
  nand2  g094(.a(new_n86_), .b(x37), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z26));
  inv1   g096(.a(x38), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n165_), .c(x10), .O(z27));
  inv1   g098(.a(x39), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n165_), .c(x10), .O(z28));
  inv1   g100(.a(x40), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n165_), .c(x10), .O(z29));
  inv1   g102(.a(x41), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n165_), .c(x10), .O(z30));
  inv1   g104(.a(x42), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n165_), .c(x10), .O(z31));
  nand2  g106(.a(new_n86_), .b(x43), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z32));
  nand2  g108(.a(new_n86_), .b(x44), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z33));
  nand2  g110(.a(new_n86_), .b(x45), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z34));
  nand2  g112(.a(new_n86_), .b(x46), .O(new_n196_));
