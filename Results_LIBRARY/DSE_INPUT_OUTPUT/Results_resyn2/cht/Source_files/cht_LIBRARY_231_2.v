...
module FAU ( 
  ...
  aoi21  g047(.a(x20), .b(new_n115_), .c(x09), .O(new_n131_));
  ...
  aoi21  g056(.a(x22), .b(new_n115_), .c(x09), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z11));
  nand2  g058(.a(x24), .b(x08), .O(new_n142_));
  aoi21  g059(.a(x23), .b(new_n115_), .c(x09), .O(new_n143_));
  ...
  aoi21  g087(.a(x29), .b(new_n115_), .c(x09), .O(new_n171_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n115_), .O(new_n176_));
  ...
  nand2  g098(.a(new_n86_), .b(x32), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z21));
  inv1   g100(.a(x33), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n179_), .c(x10), .O(z22));
  ...
  aoi21  g109(.a(new_n192_), .b(new_n179_), .c(x10), .O(z26));
  ...
  aoi21  g115(.a(new_n198_), .b(new_n179_), .c(x10), .O(z29));
  nand2  g116(.a(new_n86_), .b(x41), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z30));
  inv1   g118(.a(x42), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n179_), .c(x10), .O(z31));
  nand2  g120(.a(new_n86_), .b(x43), .O(new_n204_));
  ...
  aoi21  g127(.a(new_n210_), .b(new_n179_), .c(x10), .O(z35));
endmodule
