...
module FAU ( 
  ...
  nand2  g028(.a(new_n86_), .b(x18), .O(new_n112_));
  inv1   g029(.a(new_n112_), .O(z07));
  nand2  g030(.a(new_n86_), .b(x19), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z08));
  nand2  g032(.a(new_n86_), .b(x20), .O(new_n116_));
  inv1   g033(.a(new_n116_), .O(z09));
  nand2  g034(.a(new_n86_), .b(x21), .O(new_n118_));
  inv1   g035(.a(new_n118_), .O(z10));
  nand2  g036(.a(new_n86_), .b(x22), .O(new_n120_));
  ...
  nand2  g041(.a(new_n86_), .b(x24), .O(new_n125_));
  inv1   g042(.a(new_n125_), .O(z13));
  inv1   g043(.a(x25), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(new_n122_), .c(x10), .O(z14));
  ...
  aoi21  g052(.a(new_n135_), .b(new_n122_), .c(x10), .O(z18));
  inv1   g053(.a(x30), .O(new_n137_));
  aoi21  g054(.a(new_n137_), .b(new_n122_), .c(x10), .O(z19));
  ...
  nand3  g060(.a(new_n143_), .b(new_n140_), .c(new_n86_), .O(new_n144_));
  ...
  oai21  g093(.a(new_n100_), .b(x00), .c(new_n176_), .O(new_n177_));
  ...
  aoi21  g099(.a(new_n182_), .b(x39), .c(x08), .O(new_n183_));
  ...
  aoi21  g108(.a(new_n182_), .b(x41), .c(x08), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z30));
  nand2  g110(.a(new_n180_), .b(x43), .O(new_n194_));
  aoi21  g111(.a(new_n182_), .b(x42), .c(x08), .O(new_n195_));
  ...
  aoi21  g125(.a(new_n182_), .b(x45), .c(x08), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z34));
  nand2  g127(.a(new_n180_), .b(x00), .O(new_n211_));
  aoi21  g128(.a(new_n182_), .b(x46), .c(x08), .O(new_n212_));
