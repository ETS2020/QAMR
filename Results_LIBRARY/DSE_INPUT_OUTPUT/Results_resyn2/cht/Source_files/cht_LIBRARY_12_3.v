...
module FAU ( 
  ...
  nand2  g000(.a(x36), .b(x29), .O(new_n84_));
  ...
  aoi21  g006(.a(x36), .b(x29), .c(x10), .O(new_n90_));
  ...
  nand2  g045(.a(new_n125_), .b(new_n114_), .O(new_n129_));
  ...
  nand2  g052(.a(new_n130_), .b(new_n114_), .O(new_n136_));
  ...
  nand2  g090(.a(new_n169_), .b(new_n114_), .O(new_n174_));
  ...
  nand2  g129(.a(new_n207_), .b(new_n186_), .O(new_n213_));
  ...
  nand2  g136(.a(new_n219_), .b(new_n84_), .O(z26));
  ...
  aoi21  g141(.a(new_n216_), .b(new_n186_), .c(x10), .O(new_n225_));
  ...
  nand3  g149(.a(new_n232_), .b(new_n229_), .c(new_n87_), .O(new_n233_));
  ...
  nand2  g170(.a(new_n253_), .b(new_n84_), .O(z32));
