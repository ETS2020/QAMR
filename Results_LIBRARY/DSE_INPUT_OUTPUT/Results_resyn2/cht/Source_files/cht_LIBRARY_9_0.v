...
module FAU ( 
  ...
  aoi21  g048(.a(x20), .b(new_n116_), .c(new_n86_), .O(new_n132_));
  ...
  nand2  g058(.a(new_n134_), .b(new_n116_), .O(new_n142_));
  ...
  nand2  g063(.a(new_n140_), .b(new_n116_), .O(new_n147_));
  ...
  nand2  g068(.a(new_n145_), .b(new_n116_), .O(new_n152_));
  ...
  aoi21  g077(.a(x26), .b(new_n116_), .c(new_n86_), .O(new_n161_));
  aoi21  g078(.a(new_n161_), .b(new_n160_), .c(x10), .O(z15));
  nand2  g079(.a(x28), .b(x08), .O(new_n163_));
  aoi21  g080(.a(x27), .b(new_n116_), .c(new_n86_), .O(new_n164_));
  ...
  aoi21  g104(.a(x32), .b(new_n182_), .c(new_n86_), .O(new_n188_));
  ...
  nand2  g128(.a(new_n205_), .b(new_n182_), .O(new_n212_));
  ...
  oai21  g133(.a(new_n101_), .b(x00), .c(new_n216_), .O(new_n217_));
  nand2  g134(.a(new_n210_), .b(new_n182_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n87_), .O(new_n219_));
  aoi21  g136(.a(new_n217_), .b(x09), .c(new_n219_), .O(z27));
  nor2   g137(.a(x14), .b(new_n182_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x40), .O(new_n222_));
  nand2  g139(.a(new_n101_), .b(x09), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(x39), .c(new_n86_), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n222_), .c(x10), .O(z28));
  inv1   g142(.a(x40), .O(new_n226_));
  inv1   g143(.a(new_n87_), .O(new_n227_));
  aoi21  g144(.a(new_n223_), .b(new_n226_), .c(new_n227_), .O(z29));
  inv1   g145(.a(x42), .O(new_n229_));
  aoi21  g146(.a(new_n221_), .b(new_n229_), .c(new_n227_), .O(z30));
  nand2  g147(.a(new_n221_), .b(x43), .O(new_n231_));
  aoi21  g148(.a(new_n223_), .b(x42), .c(new_n86_), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n231_), .c(x10), .O(z31));
  nand2  g150(.a(new_n221_), .b(x44), .O(new_n234_));
  aoi21  g151(.a(new_n223_), .b(x43), .c(new_n86_), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n234_), .c(x10), .O(z32));
  nand2  g153(.a(new_n221_), .b(x45), .O(new_n237_));
  aoi21  g154(.a(new_n223_), .b(x44), .c(new_n86_), .O(new_n238_));
  ...
  nand2  g159(.a(new_n223_), .b(new_n242_), .O(new_n243_));
  nand3  g160(.a(new_n243_), .b(new_n241_), .c(new_n87_), .O(new_n244_));
  inv1   g161(.a(new_n244_), .O(z34));
  nand2  g162(.a(new_n221_), .b(x00), .O(new_n246_));
  aoi21  g163(.a(new_n223_), .b(x46), .c(new_n86_), .O(new_n247_));
