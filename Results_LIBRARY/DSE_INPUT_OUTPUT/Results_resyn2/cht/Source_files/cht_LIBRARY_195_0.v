...
module FAU ( 
  ...
  aoi21  g044(.a(x21), .b(new_n112_), .c(new_n93_), .O(new_n128_));
  ...
  nand4  g080(.a(new_n163_), .b(new_n161_), .c(new_n84_), .d(x09), .O(new_n164_));
  inv1   g081(.a(new_n164_), .O(z18));
  nand2  g082(.a(x08), .b(x00), .O(new_n166_));
  aoi21  g083(.a(x30), .b(new_n112_), .c(new_n93_), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z19));
  nor2   g085(.a(x10), .b(new_n93_), .O(new_n169_));
  ...
  aoi21  g101(.a(x39), .b(new_n101_), .c(new_n93_), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z27));
  nand2  g103(.a(x39), .b(x14), .O(new_n187_));
  aoi21  g104(.a(x40), .b(new_n101_), .c(new_n93_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z28));
  inv1   g106(.a(x40), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(x14), .O(new_n191_));
  inv1   g108(.a(x41), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n101_), .O(new_n193_));
  nand4  g110(.a(new_n193_), .b(new_n191_), .c(new_n84_), .d(x09), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z29));
  nand2  g112(.a(new_n192_), .b(x14), .O(new_n196_));
  inv1   g113(.a(x42), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n101_), .O(new_n198_));
  nand4  g115(.a(new_n198_), .b(new_n196_), .c(new_n84_), .d(x09), .O(new_n199_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n101_), .O(new_n208_));
  ...
  aoi21  g128(.a(x45), .b(new_n101_), .c(new_n93_), .O(new_n212_));
  ...
  aoi21  g137(.a(new_n101_), .b(x00), .c(new_n93_), .O(new_n221_));
