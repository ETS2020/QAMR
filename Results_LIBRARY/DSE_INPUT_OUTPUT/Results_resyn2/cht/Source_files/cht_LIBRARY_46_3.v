...
module FAU ( 
  ...
  oai21  g075(.a(new_n158_), .b(new_n157_), .c(new_n89_), .O(z20));
  ...
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(new_n89_), .O(z25));
  ...
  oai21  g100(.a(new_n183_), .b(x10), .c(new_n182_), .O(new_n184_));
  aoi21  g101(.a(x14), .b(new_n151_), .c(new_n156_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nor2   g103(.a(x10), .b(x09), .O(new_n187_));
  aoi22  g104(.a(new_n187_), .b(x38), .c(x14), .d(x10), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n186_), .O(z27));
  inv1   g106(.a(x40), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n182_), .c(x09), .O(new_n191_));
  oai21  g108(.a(x14), .b(new_n156_), .c(new_n183_), .O(new_n192_));
  ...
  nand2  g131(.a(new_n182_), .b(x09), .O(new_n215_));
  oai21  g132(.a(x45), .b(new_n156_), .c(new_n86_), .O(new_n216_));
  nor2   g133(.a(x44), .b(x10), .O(new_n217_));
  aoi22  g134(.a(new_n217_), .b(new_n215_), .c(new_n216_), .d(new_n182_), .O(z33));
  inv1   g135(.a(x46), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n182_), .c(x09), .O(new_n220_));
  inv1   g137(.a(x45), .O(new_n221_));
  oai21  g138(.a(x14), .b(new_n156_), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n220_), .c(new_n86_), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(z34));
  nand3  g141(.a(new_n182_), .b(x09), .c(new_n151_), .O(new_n225_));
  oai21  g142(.a(x14), .b(new_n156_), .c(new_n219_), .O(new_n226_));
