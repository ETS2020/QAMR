...
module FAU ( 
  ...
  oai21  g041(.a(new_n110_), .b(new_n121_), .c(new_n124_), .O(z12));
  ...
  oai21  g052(.a(new_n110_), .b(new_n132_), .c(new_n135_), .O(z16));
  ...
  aoi21  g064(.a(new_n146_), .b(x09), .c(new_n147_), .O(z20));
  inv1   g065(.a(x09), .O(new_n149_));
  nor2   g066(.a(x33), .b(new_n149_), .O(new_n150_));
  oai21  g067(.a(x32), .b(x09), .c(new_n86_), .O(new_n151_));
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n89_), .O(z21));
  nor2   g069(.a(x34), .b(new_n149_), .O(new_n153_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n89_), .O(z24));
  ...
  nand2  g084(.a(new_n167_), .b(new_n89_), .O(z25));
  ...
  nand2  g089(.a(new_n172_), .b(new_n89_), .O(z26));
  ...
  aoi21  g094(.a(new_n169_), .b(new_n149_), .c(x10), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n89_), .O(z27));
  ...
  nand3  g134(.a(new_n175_), .b(x09), .c(new_n143_), .O(new_n218_));
