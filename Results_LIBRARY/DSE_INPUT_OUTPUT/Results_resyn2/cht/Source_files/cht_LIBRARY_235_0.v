...
module FAU ( 
  ...
  nand2  g051(.a(new_n87_), .b(x30), .O(new_n135_));
  ...
  aoi21  g069(.a(x35), .b(new_n140_), .c(new_n86_), .O(new_n153_));
  ...
  nand2  g082(.a(x14), .b(new_n137_), .O(new_n166_));
  ...
  nor2   g095(.a(x14), .b(new_n140_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(x41), .O(new_n180_));
  aoi21  g097(.a(new_n175_), .b(x40), .c(new_n86_), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z29));
  inv1   g099(.a(x42), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n167_), .c(x09), .O(new_n184_));
  inv1   g101(.a(x41), .O(new_n185_));
  nand2  g102(.a(new_n175_), .b(new_n185_), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n184_), .c(new_n87_), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(z30));
  nand2  g105(.a(new_n179_), .b(x43), .O(new_n189_));
  aoi21  g106(.a(new_n175_), .b(x42), .c(new_n86_), .O(new_n190_));
  ...
  nand3  g115(.a(new_n198_), .b(new_n167_), .c(x09), .O(new_n199_));
  ...
  nand3  g120(.a(new_n203_), .b(new_n167_), .c(x09), .O(new_n204_));
  nand2  g121(.a(new_n175_), .b(new_n198_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(new_n87_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z34));
  nand3  g124(.a(new_n167_), .b(x09), .c(new_n137_), .O(new_n208_));
  nand2  g125(.a(new_n175_), .b(new_n203_), .O(new_n209_));
