...
module FAU ( 
  ...
  aoi21  g081(.a(x35), .b(new_n146_), .c(x08), .O(new_n165_));
  ...
  oai21  g094(.a(new_n103_), .b(x00), .c(new_n177_), .O(new_n178_));
  ...
  nand2  g121(.a(new_n187_), .b(x45), .O(new_n205_));
  aoi21  g122(.a(new_n183_), .b(x44), .c(x08), .O(new_n206_));
  ...
  nand2  g127(.a(new_n183_), .b(new_n210_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n209_), .c(new_n86_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand2  g130(.a(new_n187_), .b(x00), .O(new_n214_));
  aoi21  g131(.a(new_n183_), .b(x46), .c(x08), .O(new_n215_));
