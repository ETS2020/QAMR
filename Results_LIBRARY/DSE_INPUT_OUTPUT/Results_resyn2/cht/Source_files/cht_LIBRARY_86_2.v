...
module FAU ( 
  ...
  aoi21  g010(.a(new_n84_), .b(x11), .c(x10), .O(new_n94_));
  ...
  nand2  g068(.a(new_n146_), .b(new_n113_), .O(new_n152_));
  ...
  nand2  g096(.a(new_n176_), .b(new_n113_), .O(new_n180_));
  ...
  inv1   g102(.a(x11), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x32), .O(new_n187_));
  oai21  g104(.a(x31), .b(x09), .c(new_n88_), .O(new_n188_));
  nor2   g105(.a(new_n188_), .b(new_n187_), .O(z20));
  inv1   g106(.a(x33), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(x09), .O(new_n191_));
  nand2  g108(.a(new_n84_), .b(new_n185_), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n191_), .c(new_n88_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n85_), .O(z21));
  nand2  g111(.a(new_n190_), .b(new_n185_), .O(new_n195_));
  ...
  nand2  g118(.a(new_n196_), .b(new_n185_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n88_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n85_), .O(z23));
  nand2  g121(.a(new_n200_), .b(new_n185_), .O(new_n205_));
  ...
  nand2  g126(.a(new_n206_), .b(new_n185_), .O(new_n210_));
  ...
  nand3  g134(.a(new_n217_), .b(new_n215_), .c(new_n94_), .O(new_n218_));
  ...
  nand3  g180(.a(new_n221_), .b(x09), .c(new_n181_), .O(new_n264_));
