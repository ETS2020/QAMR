...
module FAU ( 
  ...
  nand2  g071(.a(new_n154_), .b(new_n146_), .O(new_n155_));
  ...
  nand2  g076(.a(new_n152_), .b(new_n146_), .O(new_n160_));
  ...
  nand2  g081(.a(new_n158_), .b(new_n146_), .O(new_n165_));
  ...
  nand3  g098(.a(new_n181_), .b(new_n103_), .c(x09), .O(new_n182_));
  ...
  nand3  g104(.a(new_n187_), .b(new_n103_), .c(x09), .O(new_n188_));
  nand2  g105(.a(new_n183_), .b(new_n181_), .O(new_n189_));
  ...
  nor2   g118(.a(x14), .b(new_n146_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(x44), .O(new_n203_));
  aoi21  g120(.a(new_n183_), .b(x43), .c(x08), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z32));
  nand2  g122(.a(new_n202_), .b(x45), .O(new_n206_));
  aoi21  g123(.a(new_n183_), .b(x44), .c(x08), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z33));
  inv1   g125(.a(x46), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n103_), .c(x09), .O(new_n210_));
  inv1   g127(.a(x45), .O(new_n211_));
  nand2  g128(.a(new_n183_), .b(new_n211_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n210_), .c(new_n86_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand3  g131(.a(new_n103_), .b(x09), .c(new_n174_), .O(new_n215_));
  nand2  g132(.a(new_n183_), .b(new_n209_), .O(new_n216_));
