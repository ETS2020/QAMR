...
module FAU ( 
  ...
  nand2  g034(.a(new_n117_), .b(new_n92_), .O(z08));
  nor2   g035(.a(x21), .b(new_n110_), .O(new_n119_));
  oai21  g036(.a(x20), .b(x08), .c(new_n86_), .O(new_n120_));
  oai21  g037(.a(new_n120_), .b(new_n119_), .c(new_n92_), .O(z09));
  ...
  nand2  g048(.a(new_n131_), .b(new_n92_), .O(z12));
  nor2   g049(.a(x25), .b(new_n110_), .O(new_n133_));
  oai21  g050(.a(x24), .b(x08), .c(new_n86_), .O(new_n134_));
  oai21  g051(.a(new_n134_), .b(new_n133_), .c(new_n92_), .O(z13));
  ...
  nand2  g069(.a(new_n148_), .b(new_n110_), .O(new_n153_));
  ...
  nor2   g073(.a(x10), .b(x09), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(x31), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n156_), .O(z20));
  oai21  g076(.a(x33), .b(x10), .c(x09), .O(new_n160_));
  nand2  g077(.a(new_n157_), .b(x32), .O(new_n161_));
  nand2  g078(.a(new_n161_), .b(new_n160_), .O(z21));
  oai21  g079(.a(x34), .b(x10), .c(x09), .O(new_n163_));
  nand2  g080(.a(new_n157_), .b(x33), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n163_), .O(z22));
  inv1   g082(.a(x09), .O(new_n166_));
  nor2   g083(.a(x35), .b(new_n166_), .O(new_n167_));
  oai21  g084(.a(x34), .b(x09), .c(new_n86_), .O(new_n168_));
  nor2   g085(.a(new_n168_), .b(new_n167_), .O(z23));
  nor2   g086(.a(x36), .b(new_n166_), .O(new_n170_));
  ...
  nand2  g090(.a(new_n157_), .b(x36), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n173_), .O(z25));
  nor2   g092(.a(x38), .b(new_n166_), .O(new_n176_));
  oai21  g093(.a(x37), .b(x09), .c(new_n86_), .O(new_n177_));
  nor2   g094(.a(new_n177_), .b(new_n176_), .O(z26));
  nand2  g095(.a(new_n157_), .b(x38), .O(new_n179_));
  ...
  nand2  g104(.a(x10), .b(new_n166_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  aoi21  g106(.a(x40), .b(new_n181_), .c(x10), .O(new_n190_));
  oai22  g107(.a(new_n190_), .b(new_n166_), .c(new_n189_), .d(new_n186_), .O(z28));
  inv1   g108(.a(x41), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n181_), .c(x09), .O(new_n193_));
  inv1   g110(.a(x40), .O(new_n194_));
  nand2  g111(.a(new_n187_), .b(new_n194_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n193_), .c(new_n86_), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z29));
  aoi21  g114(.a(x42), .b(new_n181_), .c(x10), .O(new_n198_));
  oai22  g115(.a(new_n198_), .b(new_n166_), .c(new_n189_), .d(new_n192_), .O(z30));
  inv1   g116(.a(x42), .O(new_n200_));
  aoi21  g117(.a(x43), .b(new_n181_), .c(x10), .O(new_n201_));
  oai22  g118(.a(new_n201_), .b(new_n166_), .c(new_n189_), .d(new_n200_), .O(z31));
  inv1   g119(.a(x43), .O(new_n203_));
  aoi21  g120(.a(x44), .b(new_n181_), .c(x10), .O(new_n204_));
  oai22  g121(.a(new_n204_), .b(new_n166_), .c(new_n189_), .d(new_n203_), .O(z32));
  inv1   g122(.a(x44), .O(new_n206_));
  aoi21  g123(.a(x45), .b(new_n181_), .c(x10), .O(new_n207_));
  oai22  g124(.a(new_n207_), .b(new_n166_), .c(new_n189_), .d(new_n206_), .O(z33));
  inv1   g125(.a(x46), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n181_), .c(x09), .O(new_n210_));
  inv1   g127(.a(x45), .O(new_n211_));
  nand2  g128(.a(new_n187_), .b(new_n211_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n210_), .c(new_n86_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand3  g131(.a(new_n181_), .b(x09), .c(new_n151_), .O(new_n215_));
