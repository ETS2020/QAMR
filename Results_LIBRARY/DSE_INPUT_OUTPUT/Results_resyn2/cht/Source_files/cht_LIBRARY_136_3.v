...
module FAU ( 
  ...
  nand2  g000(.a(x45), .b(x29), .O(new_n84_));
  ...
  aoi21  g009(.a(x45), .b(x29), .c(x10), .O(new_n93_));
  ...
  nand3  g023(.a(new_n106_), .b(new_n104_), .c(new_n93_), .O(new_n107_));
  ...
  nand3  g029(.a(new_n112_), .b(new_n110_), .c(new_n93_), .O(new_n113_));
  ...
  nand3  g036(.a(new_n119_), .b(new_n117_), .c(new_n93_), .O(new_n120_));
  ...
  nand3  g041(.a(new_n124_), .b(new_n122_), .c(new_n93_), .O(new_n125_));
  inv1   g042(.a(new_n125_), .O(z07));
  nand2  g043(.a(new_n123_), .b(new_n115_), .O(new_n127_));
  ...
  nand2  g050(.a(new_n128_), .b(new_n115_), .O(new_n134_));
  ...
  nand2  g055(.a(new_n132_), .b(new_n115_), .O(new_n139_));
  ...
  nand2  g063(.a(new_n143_), .b(new_n115_), .O(new_n147_));
  ...
  nand2  g068(.a(new_n148_), .b(new_n115_), .O(new_n152_));
  inv1   g069(.a(x25), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(x08), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n152_), .c(new_n93_), .O(new_n155_));
  inv1   g072(.a(new_n155_), .O(z13));
  nand2  g073(.a(new_n153_), .b(new_n115_), .O(new_n157_));
  inv1   g074(.a(x26), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(x08), .O(new_n159_));
  nand3  g076(.a(new_n159_), .b(new_n157_), .c(new_n93_), .O(new_n160_));
  ...
  nand2  g088(.a(new_n167_), .b(new_n115_), .O(new_n172_));
  ...
  nand2  g095(.a(new_n173_), .b(new_n115_), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n178_), .c(new_n93_), .O(new_n180_));
  ...
  nand3  g118(.a(new_n201_), .b(new_n199_), .c(new_n93_), .O(new_n202_));
  ...
  nand3  g128(.a(new_n211_), .b(new_n209_), .c(new_n93_), .O(new_n212_));
  ...
  nand3  g138(.a(new_n221_), .b(new_n219_), .c(new_n93_), .O(new_n222_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n232_), .c(new_n87_), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n84_), .O(z28));
  ...
  nand3  g162(.a(new_n245_), .b(new_n244_), .c(new_n87_), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(new_n84_), .O(z30));
  ...
  nand2  g168(.a(new_n251_), .b(new_n84_), .O(z31));
  ...
  nand3  g186(.a(new_n269_), .b(new_n268_), .c(new_n87_), .O(new_n270_));
  nand2  g187(.a(new_n270_), .b(new_n84_), .O(z35));
endmodule
