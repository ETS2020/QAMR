...
module FAU ( 
  ...
  nand3  g080(.a(new_n163_), .b(new_n160_), .c(new_n88_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n85_), .O(z20));
  ...
  nand2  g086(.a(new_n169_), .b(new_n85_), .O(z21));
  nor2   g087(.a(x34), .b(new_n161_), .O(new_n171_));
  oai21  g088(.a(x33), .b(x09), .c(new_n88_), .O(new_n172_));
  oai21  g089(.a(new_n172_), .b(new_n171_), .c(new_n85_), .O(z22));
  nor2   g090(.a(x35), .b(new_n161_), .O(new_n174_));
  oai21  g091(.a(x34), .b(x09), .c(new_n88_), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(new_n174_), .O(z23));
  nor2   g093(.a(x36), .b(new_n161_), .O(new_n177_));
  oai21  g094(.a(x35), .b(x09), .c(new_n88_), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(new_n177_), .O(z24));
  nor2   g096(.a(x37), .b(new_n161_), .O(new_n180_));
  oai21  g097(.a(x36), .b(x09), .c(new_n88_), .O(new_n181_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n85_), .O(z33));
