...
module FAU ( 
  ...
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n95_), .O(z20));
  ...
  nor2   g073(.a(x35), .b(new_n145_), .O(new_n157_));
  oai21  g074(.a(x34), .b(x09), .c(new_n86_), .O(new_n158_));
  oai21  g075(.a(new_n158_), .b(new_n157_), .c(new_n95_), .O(z23));
  inv1   g076(.a(x36), .O(new_n160_));
  oai21  g077(.a(x35), .b(x09), .c(new_n86_), .O(new_n161_));
  aoi21  g078(.a(new_n160_), .b(x09), .c(new_n161_), .O(z24));
  nor2   g079(.a(x37), .b(new_n145_), .O(new_n163_));
  oai21  g080(.a(x36), .b(x09), .c(new_n86_), .O(new_n164_));
  oai21  g081(.a(new_n164_), .b(new_n163_), .c(new_n95_), .O(z25));
  inv1   g082(.a(x38), .O(new_n166_));
  oai21  g083(.a(x37), .b(x09), .c(new_n86_), .O(new_n167_));
  aoi21  g084(.a(new_n166_), .b(x09), .c(new_n167_), .O(z26));
  ...
  nand2  g126(.a(new_n179_), .b(new_n203_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n86_), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n95_), .O(z34));
  nand3  g129(.a(new_n170_), .b(x09), .c(new_n142_), .O(new_n213_));
  nand2  g130(.a(new_n179_), .b(new_n208_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n86_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n95_), .O(z35));
endmodule
