...
module FAU ( 
  ...
  aoi21  g001(.a(new_n84_), .b(x19), .c(x10), .O(new_n85_));
  ...
  nand2  g009(.a(new_n84_), .b(x19), .O(new_n93_));
  ...
  nand2  g041(.a(new_n119_), .b(new_n116_), .O(new_n125_));
  ...
  nand2  g046(.a(new_n123_), .b(new_n116_), .O(new_n130_));
  ...
  oai21  g074(.a(x25), .b(x08), .c(new_n95_), .O(new_n158_));
  aoi21  g075(.a(new_n130_), .b(new_n84_), .c(new_n158_), .O(z14));
  inv1   g076(.a(x27), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x08), .O(new_n161_));
  nand2  g078(.a(new_n84_), .b(new_n116_), .O(new_n162_));
