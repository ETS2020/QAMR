...
module FAU ( 
  ...
  aoi21  g083(.a(x36), .b(new_n143_), .c(new_n86_), .O(new_n167_));
  ...
  aoi21  g098(.a(new_n181_), .b(x39), .c(new_n86_), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n179_), .c(x10), .O(z28));
  nand2  g100(.a(new_n178_), .b(x41), .O(new_n184_));
  aoi21  g101(.a(new_n181_), .b(x40), .c(new_n86_), .O(new_n185_));
  ...
  nand2  g106(.a(new_n181_), .b(new_n189_), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n188_), .c(new_n91_), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z30));
  nand2  g109(.a(new_n178_), .b(x43), .O(new_n193_));
  aoi21  g110(.a(new_n181_), .b(x42), .c(new_n86_), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z31));
  nand2  g112(.a(new_n178_), .b(x44), .O(new_n196_));
  aoi21  g113(.a(new_n181_), .b(x43), .c(new_n86_), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z32));
  nand2  g115(.a(new_n178_), .b(x45), .O(new_n199_));
  aoi21  g116(.a(new_n181_), .b(x44), .c(new_n86_), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z33));
  nand2  g118(.a(new_n178_), .b(x46), .O(new_n202_));
  aoi21  g119(.a(new_n181_), .b(x45), .c(new_n86_), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z34));
  nand3  g121(.a(new_n180_), .b(x09), .c(new_n140_), .O(new_n205_));
