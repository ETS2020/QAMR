...
module FAU ( 
  ...
  aoi21  g024(.a(x16), .b(new_n85_), .c(x34), .O(new_n108_));
  ...
  aoi21  g034(.a(x18), .b(new_n112_), .c(x34), .O(new_n118_));
  ...
  aoi21  g048(.a(x21), .b(new_n112_), .c(x34), .O(new_n132_));
  ...
  nand2  g053(.a(new_n136_), .b(new_n112_), .O(new_n137_));
  ...
  nand2  g058(.a(new_n134_), .b(new_n112_), .O(new_n142_));
  ...
  nand2  g063(.a(new_n140_), .b(new_n112_), .O(new_n147_));
  ...
  nand2  g068(.a(new_n145_), .b(new_n112_), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(new_n90_), .O(new_n153_));
  inv1   g070(.a(new_n153_), .O(z14));
  nand2  g071(.a(x27), .b(x08), .O(new_n155_));
  aoi21  g072(.a(x26), .b(new_n112_), .c(x34), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z15));
  nand2  g074(.a(x28), .b(x08), .O(new_n158_));
  aoi21  g075(.a(x27), .b(new_n112_), .c(x34), .O(new_n159_));
  ...
  aoi21  g084(.a(x29), .b(new_n112_), .c(x34), .O(new_n168_));
  ...
  nand2  g089(.a(new_n172_), .b(new_n112_), .O(new_n173_));
  ...
  nand3  g097(.a(new_n180_), .b(new_n177_), .c(new_n90_), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z20));
  inv1   g099(.a(x33), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(x09), .O(new_n184_));
  nand2  g101(.a(new_n176_), .b(new_n178_), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n184_), .c(new_n90_), .O(new_n186_));
  inv1   g103(.a(new_n186_), .O(z21));
  nand3  g104(.a(new_n90_), .b(x33), .c(new_n178_), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z22));
  nand3  g106(.a(new_n90_), .b(x35), .c(x09), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z23));
  nand2  g108(.a(x36), .b(x09), .O(new_n192_));
  aoi21  g109(.a(x35), .b(new_n178_), .c(x34), .O(new_n193_));
  ...
  aoi21  g118(.a(x37), .b(new_n178_), .c(x34), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z26));
  nand2  g120(.a(x14), .b(new_n170_), .O(new_n204_));
  ...
  nand2  g137(.a(new_n210_), .b(x42), .O(new_n221_));
  aoi21  g138(.a(new_n212_), .b(x41), .c(x34), .O(new_n222_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n100_), .c(x09), .O(new_n236_));
  ...
  nand3  g161(.a(new_n100_), .b(x09), .c(new_n170_), .O(new_n245_));
