...
module FAU ( 
  ...
  nand2  g042(.a(new_n125_), .b(new_n110_), .O(new_n126_));
  nand4  g043(.a(new_n126_), .b(new_n124_), .c(new_n95_), .d(x09), .O(new_n127_));
  inv1   g044(.a(new_n127_), .O(z09));
  nand2  g045(.a(x22), .b(x08), .O(new_n129_));
  aoi21  g046(.a(x21), .b(new_n110_), .c(new_n86_), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n129_), .c(x10), .O(z10));
  nand2  g048(.a(x23), .b(x08), .O(new_n132_));
  aoi21  g049(.a(x22), .b(new_n110_), .c(new_n86_), .O(new_n133_));
  ...
  nand4  g055(.a(new_n138_), .b(new_n136_), .c(new_n95_), .d(x09), .O(new_n139_));
  inv1   g056(.a(new_n139_), .O(z12));
  inv1   g057(.a(x25), .O(new_n141_));
  nand2  g058(.a(new_n141_), .b(x08), .O(new_n142_));
  nand2  g059(.a(new_n135_), .b(new_n110_), .O(new_n143_));
  nand4  g060(.a(new_n143_), .b(new_n142_), .c(new_n95_), .d(x09), .O(new_n144_));
  inv1   g061(.a(new_n144_), .O(z13));
  inv1   g062(.a(x26), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(x08), .O(new_n147_));
  nand2  g064(.a(new_n141_), .b(new_n110_), .O(new_n148_));
  nand4  g065(.a(new_n148_), .b(new_n147_), .c(new_n95_), .d(x09), .O(new_n149_));
  inv1   g066(.a(new_n149_), .O(z14));
  inv1   g067(.a(x27), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(x08), .O(new_n152_));
  nand2  g069(.a(new_n146_), .b(new_n110_), .O(new_n153_));
  nand4  g070(.a(new_n153_), .b(new_n152_), .c(new_n95_), .d(x09), .O(new_n154_));
  inv1   g071(.a(new_n154_), .O(z15));
  inv1   g072(.a(x28), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(x08), .O(new_n157_));
  nand2  g074(.a(new_n151_), .b(new_n110_), .O(new_n158_));
  nand4  g075(.a(new_n158_), .b(new_n157_), .c(new_n95_), .d(x09), .O(new_n159_));
  inv1   g076(.a(new_n159_), .O(z16));
  nand2  g077(.a(x29), .b(x08), .O(new_n161_));
  aoi21  g078(.a(x28), .b(new_n110_), .c(new_n86_), .O(new_n162_));
  ...
  nand2  g083(.a(new_n166_), .b(new_n110_), .O(new_n167_));
  nand4  g084(.a(new_n167_), .b(new_n165_), .c(new_n95_), .d(x09), .O(new_n168_));
  inv1   g085(.a(new_n168_), .O(z18));
  nand2  g086(.a(x08), .b(x00), .O(new_n170_));
  aoi21  g087(.a(x30), .b(new_n110_), .c(new_n86_), .O(new_n171_));
