...
module FAU ( 
  ...
  nand2  g060(.a(new_n143_), .b(new_n92_), .O(z15));
  inv1   g061(.a(x28), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(x08), .O(new_n146_));
  nand2  g063(.a(new_n140_), .b(new_n107_), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(new_n86_), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(new_n92_), .O(z16));
  inv1   g066(.a(x29), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(x08), .O(new_n151_));
  nand2  g068(.a(new_n145_), .b(new_n107_), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(new_n86_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n92_), .O(z17));
  nor2   g071(.a(x30), .b(new_n107_), .O(new_n155_));
  oai21  g072(.a(x29), .b(x08), .c(new_n86_), .O(new_n156_));
  oai21  g073(.a(new_n156_), .b(new_n155_), .c(new_n92_), .O(z18));
  ...
  nand2  g080(.a(new_n86_), .b(new_n163_), .O(new_n164_));
  oai21  g081(.a(new_n164_), .b(new_n161_), .c(new_n162_), .O(z20));
  nor2   g082(.a(x33), .b(new_n163_), .O(new_n166_));
  oai21  g083(.a(x32), .b(x09), .c(new_n86_), .O(new_n167_));
  nor2   g084(.a(new_n167_), .b(new_n166_), .O(z21));
  nor2   g085(.a(x34), .b(new_n163_), .O(new_n169_));
  ...
  oai21  g092(.a(new_n164_), .b(new_n172_), .c(new_n175_), .O(z24));
  inv1   g093(.a(x36), .O(new_n177_));
  oai21  g094(.a(x37), .b(x10), .c(x09), .O(new_n178_));
  oai21  g095(.a(new_n164_), .b(new_n177_), .c(new_n178_), .O(z25));
  inv1   g096(.a(x37), .O(new_n180_));
  oai21  g097(.a(x38), .b(x10), .c(x09), .O(new_n181_));
  oai21  g098(.a(new_n164_), .b(new_n180_), .c(new_n181_), .O(z26));
  nand2  g099(.a(x14), .b(x00), .O(new_n183_));
  inv1   g100(.a(x14), .O(new_n184_));
  aoi21  g101(.a(x39), .b(new_n184_), .c(new_n163_), .O(new_n185_));
  ...
  oai21  g107(.a(x14), .b(new_n163_), .c(new_n190_), .O(new_n191_));
  ...
  oai21  g112(.a(x14), .b(new_n163_), .c(new_n188_), .O(new_n196_));
  ...
  oai21  g117(.a(x14), .b(new_n163_), .c(new_n194_), .O(new_n201_));
  ...
  oai21  g122(.a(x14), .b(new_n163_), .c(new_n199_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n205_), .c(new_n86_), .O(new_n207_));
  inv1   g124(.a(new_n207_), .O(z31));
  nand2  g125(.a(new_n184_), .b(x09), .O(new_n209_));
  nand2  g126(.a(x10), .b(new_n163_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(x43), .O(new_n211_));
  inv1   g128(.a(x44), .O(new_n212_));
  oai21  g129(.a(new_n212_), .b(x14), .c(new_n86_), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(x09), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n211_), .O(z32));
  inv1   g132(.a(x45), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n184_), .c(x09), .O(new_n217_));
  oai21  g134(.a(x14), .b(new_n163_), .c(new_n212_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n86_), .O(new_n219_));
  inv1   g136(.a(new_n219_), .O(z33));
  nand3  g137(.a(new_n210_), .b(new_n209_), .c(x45), .O(new_n221_));
  inv1   g138(.a(x46), .O(new_n222_));
  oai21  g139(.a(new_n222_), .b(x14), .c(new_n86_), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(x09), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n221_), .O(z34));
  nand3  g142(.a(new_n210_), .b(new_n209_), .c(x46), .O(new_n226_));
  oai21  g143(.a(x14), .b(new_n158_), .c(new_n86_), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(x09), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n226_), .O(z35));
endmodule
