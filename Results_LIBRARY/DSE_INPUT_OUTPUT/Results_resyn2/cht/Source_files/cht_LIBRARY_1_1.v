...
module FAU ( 
  ...
  aoi21  g015(.a(x13), .b(new_n87_), .c(x32), .O(new_n99_));
  ...
  aoi21  g024(.a(x15), .b(new_n87_), .c(x32), .O(new_n108_));
  ...
  aoi21  g040(.a(x18), .b(new_n118_), .c(x32), .O(new_n124_));
  ...
  aoi21  g049(.a(x20), .b(new_n118_), .c(x32), .O(new_n133_));
  ...
  aoi21  g063(.a(x23), .b(new_n118_), .c(x32), .O(new_n147_));
  ...
  nand2  g073(.a(new_n149_), .b(new_n118_), .O(new_n157_));
  ...
  aoi21  g102(.a(x31), .b(new_n185_), .c(x32), .O(new_n186_));
  nor2   g103(.a(new_n186_), .b(x10), .O(z20));
  nand3  g104(.a(new_n86_), .b(x33), .c(x09), .O(new_n188_));
  ...
  nor2   g131(.a(x14), .b(new_n185_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(x40), .O(new_n216_));
  nand2  g133(.a(new_n103_), .b(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(x39), .c(x32), .O(new_n218_));
  ...
  nand3  g155(.a(new_n238_), .b(new_n103_), .c(x09), .O(new_n239_));
  ...
  aoi21  g160(.a(new_n217_), .b(x45), .c(x32), .O(new_n244_));
  aoi21  g161(.a(new_n244_), .b(new_n243_), .c(x10), .O(z34));
  nand2  g162(.a(new_n215_), .b(x00), .O(new_n246_));
  aoi21  g163(.a(new_n217_), .b(x46), .c(x32), .O(new_n247_));
