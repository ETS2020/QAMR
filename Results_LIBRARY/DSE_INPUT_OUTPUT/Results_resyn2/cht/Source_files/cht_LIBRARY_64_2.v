...
module FAU ( 
  ...
  nand2  g038(.a(new_n121_), .b(new_n90_), .O(z09));
  nor2   g039(.a(x22), .b(new_n106_), .O(new_n123_));
  oai21  g040(.a(x21), .b(x08), .c(new_n86_), .O(new_n124_));
  oai21  g041(.a(new_n124_), .b(new_n123_), .c(new_n90_), .O(z10));
  ...
  nand2  g061(.a(new_n144_), .b(new_n90_), .O(z16));
  nor2   g062(.a(x29), .b(new_n106_), .O(new_n146_));
  oai21  g063(.a(x28), .b(x08), .c(new_n86_), .O(new_n147_));
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n90_), .O(z17));
  ...
  nand2  g099(.a(x14), .b(new_n152_), .O(new_n183_));
  ...
  oai21  g105(.a(x14), .b(new_n155_), .c(new_n181_), .O(new_n189_));
  ...
  oai21  g110(.a(x14), .b(new_n155_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g130(.a(x14), .b(new_n155_), .c(new_n207_), .O(new_n214_));
  ...
  oai21  g135(.a(x14), .b(new_n155_), .c(new_n212_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(new_n86_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n90_), .O(z34));
  nand3  g138(.a(new_n180_), .b(x09), .c(new_n152_), .O(new_n222_));
  oai21  g139(.a(x14), .b(new_n155_), .c(new_n217_), .O(new_n223_));
