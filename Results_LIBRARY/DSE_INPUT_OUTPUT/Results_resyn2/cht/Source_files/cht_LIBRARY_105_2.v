...
module FAU ( 
  ...
  aoi21  g040(.a(x19), .b(new_n117_), .c(x09), .O(new_n124_));
  ...
  aoi21  g049(.a(x21), .b(new_n117_), .c(x09), .O(new_n133_));
  ...
  aoi21  g058(.a(x23), .b(new_n117_), .c(x09), .O(new_n142_));
  aoi21  g059(.a(new_n142_), .b(new_n141_), .c(x10), .O(z12));
  nand2  g060(.a(x25), .b(x08), .O(new_n144_));
  aoi21  g061(.a(x24), .b(new_n117_), .c(x09), .O(new_n145_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n117_), .O(new_n168_));
  ...
  nand2  g094(.a(new_n86_), .b(x34), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z23));
  inv1   g096(.a(x35), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n171_), .c(x10), .O(z24));
  ...
  aoi21  g117(.a(new_n200_), .b(new_n171_), .c(x10), .O(z34));
