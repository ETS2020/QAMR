...
module FAU ( 
  ...
  nand2  g044(.a(new_n127_), .b(new_n89_), .O(z12));
  ...
  oai21  g052(.a(new_n135_), .b(new_n134_), .c(new_n89_), .O(z14));
  ...
  nand2  g083(.a(new_n162_), .b(new_n152_), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n86_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n89_), .O(z24));
  nor2   g086(.a(x37), .b(new_n152_), .O(new_n170_));
  oai21  g087(.a(x36), .b(x09), .c(new_n86_), .O(new_n171_));
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n89_), .O(z25));
  nor2   g089(.a(x38), .b(new_n152_), .O(new_n173_));
  ...
  oai21  g101(.a(x14), .b(new_n152_), .c(new_n177_), .O(new_n185_));
