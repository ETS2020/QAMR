...
module FAU ( 
  ...
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n92_), .O(z20));
  ...
  oai21  g073(.a(new_n156_), .b(new_n155_), .c(new_n92_), .O(z23));
  ...
  oai21  g088(.a(x38), .b(x09), .c(new_n86_), .O(new_n172_));
  ...
  nand2  g094(.a(new_n177_), .b(new_n92_), .O(z28));
  ...
  nand2  g109(.a(new_n192_), .b(new_n92_), .O(z31));
  ...
  nand2  g114(.a(new_n197_), .b(new_n92_), .O(z32));
  ...
  nand2  g119(.a(new_n202_), .b(new_n92_), .O(z33));
  ...
  nand2  g124(.a(new_n207_), .b(new_n92_), .O(z34));
  ...
  nand2  g128(.a(new_n211_), .b(new_n92_), .O(z35));
endmodule
