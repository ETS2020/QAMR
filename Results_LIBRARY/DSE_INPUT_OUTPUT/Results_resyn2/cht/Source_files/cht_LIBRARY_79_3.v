...
module FAU ( 
  ...
  nand2  g046(.a(new_n125_), .b(new_n107_), .O(new_n130_));
  nand3  g047(.a(new_n130_), .b(new_n129_), .c(new_n87_), .O(new_n131_));
  nand2  g048(.a(new_n131_), .b(new_n84_), .O(z11));
  ...
  oai21  g057(.a(new_n140_), .b(new_n139_), .c(new_n84_), .O(z14));
  ...
  nor2   g064(.a(x29), .b(new_n107_), .O(new_n148_));
  ...
  nand2  g072(.a(new_n151_), .b(new_n107_), .O(new_n156_));
  ...
  nor2   g076(.a(x10), .b(x09), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x31), .O(new_n161_));
  nand2  g078(.a(new_n161_), .b(new_n159_), .O(z20));
  inv1   g079(.a(x09), .O(new_n163_));
  nor2   g080(.a(x33), .b(new_n163_), .O(new_n164_));
  ...
  nand2  g127(.a(x10), .b(new_n163_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n192_), .c(x43), .O(new_n212_));
  aoi21  g129(.a(x44), .b(new_n184_), .c(x10), .O(new_n213_));
  oai21  g130(.a(new_n213_), .b(new_n163_), .c(new_n212_), .O(z32));
  nand3  g131(.a(new_n211_), .b(new_n192_), .c(x44), .O(new_n215_));
  aoi21  g132(.a(x45), .b(new_n184_), .c(x10), .O(new_n216_));
  oai21  g133(.a(new_n216_), .b(new_n163_), .c(new_n215_), .O(z33));
  nand3  g134(.a(new_n211_), .b(new_n192_), .c(x45), .O(new_n218_));
  aoi21  g135(.a(x46), .b(new_n184_), .c(x10), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(new_n163_), .c(new_n218_), .O(z34));
  nand3  g137(.a(new_n184_), .b(x09), .c(new_n154_), .O(new_n221_));
  inv1   g138(.a(x46), .O(new_n222_));
  nand2  g139(.a(new_n192_), .b(new_n222_), .O(new_n223_));
