...
module FAU ( 
  ...
  nand2  g099(.a(new_n176_), .b(new_n151_), .O(new_n183_));
  ...
  aoi21  g106(.a(new_n181_), .b(new_n151_), .c(x10), .O(new_n190_));
  ...
  nand3  g146(.a(new_n187_), .b(x09), .c(new_n146_), .O(new_n230_));
