...
module FAU ( 
  ...
  nand2  g008(.a(x10), .b(x01), .O(new_n92_));
  ...
  oai21  g039(.a(new_n122_), .b(new_n121_), .c(new_n92_), .O(z11));
  ...
  nand2  g047(.a(new_n130_), .b(new_n92_), .O(z13));
  nor2   g048(.a(x26), .b(new_n105_), .O(new_n132_));
  oai21  g049(.a(x25), .b(x08), .c(new_n86_), .O(new_n133_));
  oai21  g050(.a(new_n133_), .b(new_n132_), .c(new_n92_), .O(z14));
  ...
  nand2  g061(.a(new_n144_), .b(new_n92_), .O(z17));
  ...
  nand2  g066(.a(new_n149_), .b(new_n92_), .O(z18));
  ...
  nand2  g078(.a(new_n161_), .b(new_n92_), .O(z20));
  ...
  nand2  g113(.a(new_n196_), .b(new_n92_), .O(z29));
  ...
  nand2  g128(.a(new_n211_), .b(new_n92_), .O(z32));
  ...
  nand2  g142(.a(new_n225_), .b(new_n92_), .O(z35));
endmodule
