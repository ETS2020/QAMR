...
module FAU ( 
  ...
  oai21  g040(.a(new_n123_), .b(new_n122_), .c(new_n90_), .O(z11));
  ...
  aoi21  g045(.a(new_n89_), .b(x08), .c(new_n128_), .O(z13));
  nor2   g046(.a(x26), .b(new_n106_), .O(new_n130_));
  oai21  g047(.a(x25), .b(x08), .c(new_n86_), .O(new_n131_));
  oai21  g048(.a(new_n131_), .b(new_n130_), .c(new_n90_), .O(z14));
  ...
  nor2   g057(.a(x29), .b(new_n106_), .O(new_n141_));
  oai21  g058(.a(x28), .b(x08), .c(new_n86_), .O(new_n142_));
  oai21  g059(.a(new_n142_), .b(new_n141_), .c(new_n90_), .O(z17));
  nor2   g060(.a(x30), .b(new_n106_), .O(new_n144_));
  ...
  oai21  g069(.a(new_n152_), .b(new_n151_), .c(new_n90_), .O(z20));
  ...
  nand2  g077(.a(new_n160_), .b(new_n90_), .O(z22));
  ...
  nand2  g082(.a(new_n165_), .b(new_n90_), .O(z23));
  nor2   g083(.a(x36), .b(new_n150_), .O(new_n167_));
  ...
  nand2  g091(.a(new_n170_), .b(new_n150_), .O(new_n175_));
  ...
  aoi21  g098(.a(new_n173_), .b(new_n150_), .c(x10), .O(new_n182_));
  ...
  nand3  g138(.a(new_n179_), .b(x09), .c(new_n147_), .O(new_n222_));
