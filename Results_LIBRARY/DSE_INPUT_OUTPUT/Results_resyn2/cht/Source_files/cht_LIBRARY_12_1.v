...
module FAU ( 
  ...
  nand2  g001(.a(x36), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g007(.a(x36), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand2  g076(.a(new_n155_), .b(new_n115_), .O(new_n160_));
  ...
  nand2  g086(.a(new_n84_), .b(x08), .O(new_n170_));
  ...
  aoi21  g091(.a(new_n174_), .b(x08), .c(x29), .O(new_n175_));
  oai21  g092(.a(x30), .b(new_n115_), .c(new_n88_), .O(new_n176_));
  nor2   g093(.a(new_n176_), .b(new_n175_), .O(z18));
  inv1   g094(.a(x30), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n115_), .O(new_n179_));
  ...
  aoi21  g140(.a(new_n215_), .b(new_n186_), .c(x10), .O(new_n224_));
  ...
  nand2  g179(.a(new_n262_), .b(new_n85_), .O(z34));
