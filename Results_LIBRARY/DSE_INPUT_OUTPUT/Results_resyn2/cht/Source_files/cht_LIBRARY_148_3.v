...
module FAU ( 
  ...
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n84_), .O(z18));
  ...
  nor2   g092(.a(x38), .b(new_n154_), .O(new_n176_));
  ...
  nand2  g106(.a(new_n179_), .b(x09), .O(new_n190_));
  ...
  nand3  g136(.a(new_n219_), .b(new_n179_), .c(x09), .O(new_n220_));
  ...
  nand3  g140(.a(new_n179_), .b(x09), .c(new_n149_), .O(new_n224_));
