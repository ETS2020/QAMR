...
module FAU ( 
  ...
  aoi21  g006(.a(x20), .b(x16), .c(x10), .O(new_n90_));
  ...
  nand2  g040(.a(new_n120_), .b(new_n114_), .O(new_n124_));
  ...
  nand2  g047(.a(new_n125_), .b(new_n114_), .O(new_n131_));
  ...
  nand2  g055(.a(new_n135_), .b(new_n114_), .O(new_n139_));
  ...
  nand2  g062(.a(new_n140_), .b(new_n114_), .O(new_n146_));
  ...
  nand2  g090(.a(new_n170_), .b(new_n114_), .O(new_n174_));
  ...
  nand2  g095(.a(new_n175_), .b(new_n114_), .O(new_n179_));
  ...
  nand2  g127(.a(new_n207_), .b(new_n184_), .O(new_n211_));
  ...
  nand2  g132(.a(new_n212_), .b(new_n184_), .O(new_n216_));
  ...
  aoi21  g141(.a(new_n217_), .b(new_n184_), .c(x10), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n224_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n84_), .O(z27));
  ...
  nand3  g149(.a(new_n232_), .b(new_n229_), .c(new_n90_), .O(new_n233_));
  ...
  nand2  g155(.a(new_n238_), .b(new_n84_), .O(z29));
  ...
  nand2  g160(.a(new_n243_), .b(new_n84_), .O(z30));
  ...
  nand2  g165(.a(new_n248_), .b(new_n84_), .O(z31));
  ...
  nand3  g174(.a(new_n257_), .b(new_n256_), .c(new_n90_), .O(new_n258_));
  ...
  nand3  g179(.a(new_n262_), .b(new_n261_), .c(new_n90_), .O(new_n263_));
