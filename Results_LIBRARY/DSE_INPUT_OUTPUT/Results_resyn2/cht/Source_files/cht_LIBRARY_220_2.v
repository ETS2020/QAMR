...
module FAU ( 
  ...
  aoi21  g001(.a(new_n84_), .b(x25), .c(x10), .O(new_n85_));
  ...
  nand2  g015(.a(new_n84_), .b(x25), .O(new_n99_));
  ...
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(new_n101_), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(new_n99_), .O(z13));
  inv1   g074(.a(x26), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(x08), .O(new_n159_));
  nand2  g076(.a(new_n153_), .b(new_n116_), .O(new_n160_));
  nand3  g077(.a(new_n160_), .b(new_n159_), .c(new_n101_), .O(new_n161_));
  nand2  g078(.a(new_n161_), .b(new_n99_), .O(z14));
  ...
  nand3  g092(.a(new_n175_), .b(new_n174_), .c(new_n101_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n99_), .O(z17));
  nand2  g094(.a(new_n173_), .b(new_n116_), .O(new_n178_));
  ...
  nand2  g099(.a(new_n179_), .b(new_n116_), .O(new_n183_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(new_n101_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n99_), .O(z21));
  ...
  nand2  g135(.a(new_n218_), .b(new_n99_), .O(z25));
  inv1   g136(.a(x38), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(x09), .O(new_n221_));
  nand2  g138(.a(new_n215_), .b(new_n188_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(new_n101_), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n99_), .O(z26));
  ...
  aoi21  g145(.a(new_n220_), .b(new_n188_), .c(x10), .O(new_n229_));
  ...
  nand3  g158(.a(new_n241_), .b(new_n240_), .c(new_n101_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n99_), .O(z29));
  ...
  aoi21  g165(.a(new_n235_), .b(new_n153_), .c(x43), .O(new_n249_));
  oai21  g166(.a(x14), .b(new_n188_), .c(new_n244_), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(new_n101_), .O(new_n251_));
  nor2   g168(.a(new_n251_), .b(new_n249_), .O(z31));
  inv1   g169(.a(x44), .O(new_n253_));
  nand3  g170(.a(new_n253_), .b(new_n226_), .c(x09), .O(new_n254_));
  nand2  g171(.a(new_n235_), .b(new_n84_), .O(new_n255_));
  ...
  nand3  g175(.a(new_n258_), .b(new_n226_), .c(x09), .O(new_n259_));
