...
module FAU ( 
  ...
  oai21  g052(.a(new_n135_), .b(new_n134_), .c(new_n90_), .O(z13));
  ...
  nor2   g083(.a(x35), .b(new_n155_), .O(new_n167_));
  oai21  g084(.a(x34), .b(x09), .c(new_n86_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n90_), .O(z23));
  ...
  nor2   g089(.a(x37), .b(new_n155_), .O(new_n173_));
  ...
  nand2  g098(.a(x14), .b(new_n152_), .O(new_n182_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n90_), .O(z30));
  ...
  nand3  g137(.a(new_n179_), .b(x09), .c(new_n152_), .O(new_n221_));
