...
module FAU ( 
  ...
  aoi21  g013(.a(x32), .b(new_n84_), .c(x10), .O(new_n97_));
  ...
  nand2  g113(.a(new_n188_), .b(new_n190_), .O(new_n197_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n200_), .c(new_n97_), .O(new_n203_));
  ...
  nand2  g142(.a(x39), .b(new_n98_), .O(new_n226_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n232_), .c(new_n97_), .O(new_n236_));
  ...
  nand3  g162(.a(new_n245_), .b(new_n244_), .c(new_n97_), .O(new_n246_));
  inv1   g163(.a(new_n246_), .O(z30));
  inv1   g164(.a(x43), .O(new_n248_));
  nand3  g165(.a(new_n248_), .b(new_n98_), .c(x09), .O(new_n249_));
  ...
  nand3  g172(.a(new_n255_), .b(new_n254_), .c(new_n97_), .O(new_n256_));
  inv1   g173(.a(new_n256_), .O(z32));
  inv1   g174(.a(x45), .O(new_n258_));
  nand3  g175(.a(new_n258_), .b(new_n98_), .c(x09), .O(new_n259_));
  ...
  nand3  g180(.a(new_n263_), .b(new_n98_), .c(x09), .O(new_n264_));
  nand2  g181(.a(new_n234_), .b(new_n258_), .O(new_n265_));
  nand3  g182(.a(new_n265_), .b(new_n264_), .c(new_n97_), .O(new_n266_));
  inv1   g183(.a(new_n266_), .O(z34));
  nand3  g184(.a(new_n98_), .b(x09), .c(new_n184_), .O(new_n268_));
