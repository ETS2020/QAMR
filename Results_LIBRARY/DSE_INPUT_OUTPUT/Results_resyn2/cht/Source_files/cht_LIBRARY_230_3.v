...
module FAU ( 
  ...
  oai21  g030(.a(new_n108_), .b(new_n110_), .c(new_n113_), .O(z08));
  inv1   g031(.a(x20), .O(new_n115_));
  oai21  g032(.a(x21), .b(x10), .c(x08), .O(new_n116_));
  oai21  g033(.a(new_n108_), .b(new_n115_), .c(new_n116_), .O(z09));
  ...
  aoi21  g089(.a(new_n166_), .b(new_n147_), .c(x10), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n92_), .O(z27));
  ...
  nand3  g129(.a(new_n170_), .b(x09), .c(new_n144_), .O(new_n213_));
