...
module FAU ( 
  ...
  aoi21  g030(.a(x16), .b(new_n85_), .c(x08), .O(new_n114_));
  ...
  nand2  g047(.a(new_n90_), .b(x24), .O(new_n131_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n103_), .O(new_n181_));
  oai21  g098(.a(new_n103_), .b(x00), .c(new_n181_), .O(new_n182_));
  ...
  nand2  g103(.a(new_n103_), .b(x09), .O(new_n187_));
  ...
  nand2  g115(.a(new_n185_), .b(x43), .O(new_n199_));
  aoi21  g116(.a(new_n187_), .b(x42), .c(x08), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z31));
  nand2  g118(.a(new_n185_), .b(x44), .O(new_n202_));
  aoi21  g119(.a(new_n187_), .b(x43), .c(x08), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z32));
  nand2  g121(.a(new_n185_), .b(x45), .O(new_n205_));
  aoi21  g122(.a(new_n187_), .b(x44), .c(x08), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z33));
  nand2  g124(.a(new_n185_), .b(x46), .O(new_n208_));
  aoi21  g125(.a(new_n187_), .b(x45), .c(x08), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z34));
  nand2  g127(.a(new_n185_), .b(x00), .O(new_n211_));
  aoi21  g128(.a(new_n187_), .b(x46), .c(x08), .O(new_n212_));
