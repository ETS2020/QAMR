...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_,
    ...
    new_n233_, new_n234_, new_n235_, new_n237_;
  ...
  nand3  g032(.a(new_n115_), .b(new_n113_), .c(new_n94_), .O(new_n116_));
  ...
  nand3  g067(.a(new_n150_), .b(new_n149_), .c(new_n94_), .O(new_n151_));
  inv1   g068(.a(new_n151_), .O(z15));
  inv1   g069(.a(x28), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(x08), .O(new_n154_));
  nand2  g071(.a(new_n148_), .b(new_n109_), .O(new_n155_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n170_), .c(new_n94_), .O(new_n174_));
  ...
  aoi21  g096(.a(x33), .b(new_n171_), .c(new_n86_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z22));
  nand2  g098(.a(x35), .b(x09), .O(new_n182_));
  aoi21  g099(.a(x34), .b(new_n171_), .c(new_n86_), .O(new_n183_));
  ...
  aoi21  g113(.a(x37), .b(new_n171_), .c(new_n86_), .O(new_n197_));
  ...
  nand3  g129(.a(new_n212_), .b(new_n201_), .c(x09), .O(new_n213_));
  ...
  nand3  g138(.a(new_n221_), .b(new_n201_), .c(x09), .O(new_n222_));
  inv1   g139(.a(x42), .O(new_n223_));
  nand2  g140(.a(new_n209_), .b(new_n223_), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n222_), .c(new_n94_), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(z31));
  inv1   g143(.a(x44), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n201_), .c(x09), .O(new_n228_));
  nand2  g145(.a(new_n209_), .b(new_n221_), .O(new_n229_));
  nand3  g146(.a(new_n229_), .b(new_n228_), .c(new_n94_), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(z32));
  inv1   g148(.a(x45), .O(new_n232_));
  nand3  g149(.a(new_n232_), .b(new_n201_), .c(x09), .O(new_n233_));
  nand2  g150(.a(new_n209_), .b(new_n227_), .O(new_n234_));
  nand3  g151(.a(new_n234_), .b(new_n233_), .c(new_n94_), .O(new_n235_));
  inv1   g152(.a(new_n235_), .O(z33));
  inv1   g153(.a(new_n94_), .O(new_n237_));
  aoi21  g154(.a(new_n209_), .b(new_n232_), .c(new_n237_), .O(z34));
  aoi21  g155(.a(new_n207_), .b(new_n199_), .c(new_n237_), .O(z35));
endmodule
