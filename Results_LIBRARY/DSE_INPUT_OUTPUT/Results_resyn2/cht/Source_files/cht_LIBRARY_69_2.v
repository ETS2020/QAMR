...
module FAU ( 
  ...
  nand2  g010(.a(new_n84_), .b(x15), .O(new_n94_));
  inv1   g011(.a(new_n94_), .O(z04));
  inv1   g012(.a(x16), .O(new_n96_));
  aoi21  g013(.a(new_n96_), .b(new_n87_), .c(x10), .O(z05));
  ...
  nand3  g019(.a(new_n102_), .b(new_n99_), .c(new_n84_), .O(new_n103_));
  ...
  nand3  g029(.a(new_n112_), .b(new_n111_), .c(new_n84_), .O(new_n113_));
  ...
  aoi21  g042(.a(x22), .b(new_n100_), .c(x07), .O(new_n126_));
  ...
  aoi21  g051(.a(x24), .b(new_n100_), .c(x07), .O(new_n135_));
  aoi21  g052(.a(new_n135_), .b(new_n134_), .c(x10), .O(z13));
  nand2  g053(.a(x26), .b(x08), .O(new_n137_));
  aoi21  g054(.a(x25), .b(new_n100_), .c(x07), .O(new_n138_));
  ...
  nand3  g060(.a(new_n143_), .b(new_n141_), .c(new_n84_), .O(new_n144_));
  inv1   g061(.a(new_n144_), .O(z15));
  nand2  g062(.a(x28), .b(x08), .O(new_n146_));
  aoi21  g063(.a(x27), .b(new_n100_), .c(x07), .O(new_n147_));
  ...
  aoi21  g072(.a(x29), .b(new_n100_), .c(x07), .O(new_n156_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n165_), .c(new_n84_), .O(new_n169_));
  inv1   g086(.a(new_n169_), .O(z20));
  nand2  g087(.a(x33), .b(x09), .O(new_n171_));
  aoi21  g088(.a(x32), .b(new_n166_), .c(x07), .O(new_n172_));
  ...
  aoi21  g107(.a(x36), .b(new_n166_), .c(x07), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z25));
  nand2  g109(.a(x38), .b(x09), .O(new_n193_));
  aoi21  g110(.a(x37), .b(new_n166_), .c(x07), .O(new_n194_));
  ...
  aoi21  g117(.a(x38), .b(new_n166_), .c(x07), .O(new_n201_));
  ...
  aoi21  g141(.a(new_n205_), .b(x43), .c(x07), .O(new_n225_));
  ...
  nand3  g147(.a(new_n230_), .b(new_n228_), .c(new_n84_), .O(new_n231_));
  inv1   g148(.a(new_n231_), .O(z33));
  nand2  g149(.a(new_n214_), .b(x46), .O(new_n233_));
  aoi21  g150(.a(new_n205_), .b(x45), .c(x07), .O(new_n234_));
  ...
  nand3  g155(.a(new_n238_), .b(new_n236_), .c(new_n84_), .O(new_n239_));
