...
module FAU ( 
  ...
  nand2  g000(.a(x45), .b(x10), .O(new_n84_));
  ...
  oai21  g054(.a(new_n137_), .b(new_n136_), .c(new_n84_), .O(z15));
  ...
  nor2   g085(.a(x35), .b(new_n157_), .O(new_n169_));
  ...
  nand2  g096(.a(new_n175_), .b(new_n157_), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n87_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n84_), .O(z26));
  ...
  nand3  g119(.a(new_n202_), .b(new_n184_), .c(x09), .O(new_n203_));
  ...
  nand3  g124(.a(new_n207_), .b(new_n184_), .c(x09), .O(new_n208_));
  ...
  nand3  g129(.a(new_n212_), .b(new_n184_), .c(x09), .O(new_n213_));
  nand2  g130(.a(new_n193_), .b(new_n207_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n87_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n84_), .O(z32));
  nand2  g133(.a(new_n193_), .b(new_n87_), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(x45), .O(new_n218_));
  nand3  g135(.a(new_n193_), .b(x44), .c(new_n87_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n218_), .O(z33));
  inv1   g137(.a(x46), .O(new_n221_));
  nand3  g138(.a(new_n184_), .b(new_n87_), .c(x09), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(x45), .O(new_n223_));
  oai21  g140(.a(new_n222_), .b(new_n221_), .c(new_n223_), .O(z34));
  nand3  g141(.a(new_n184_), .b(x09), .c(new_n152_), .O(new_n225_));
  nand2  g142(.a(new_n193_), .b(new_n221_), .O(new_n226_));
