...
module FAU ( 
  ...
  aoi21  g030(.a(x16), .b(new_n85_), .c(x09), .O(new_n114_));
  ...
  aoi21  g066(.a(x25), .b(new_n118_), .c(x09), .O(new_n150_));
  aoi21  g067(.a(new_n150_), .b(new_n149_), .c(x10), .O(z14));
  nand2  g068(.a(x27), .b(x08), .O(new_n152_));
  aoi21  g069(.a(x26), .b(new_n118_), .c(x09), .O(new_n153_));
  ...
  nand2  g088(.a(new_n164_), .b(new_n118_), .O(new_n172_));
  ...
  nand2  g094(.a(new_n90_), .b(x32), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z21));
  inv1   g096(.a(x33), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n175_), .c(x10), .O(z22));
  inv1   g098(.a(x34), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n175_), .c(x10), .O(z23));
  nand2  g100(.a(new_n90_), .b(x35), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z24));
  nand2  g102(.a(new_n90_), .b(x36), .O(new_n186_));
  inv1   g103(.a(new_n186_), .O(z25));
  nand2  g104(.a(new_n90_), .b(x37), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z26));
  nand2  g106(.a(new_n90_), .b(x38), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z27));
  nand2  g108(.a(new_n90_), .b(x39), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z28));
  nand2  g110(.a(new_n90_), .b(x40), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z29));
  inv1   g112(.a(x41), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n175_), .c(x10), .O(z30));
  inv1   g114(.a(x42), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n175_), .c(x10), .O(z31));
  nand2  g116(.a(new_n90_), .b(x43), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z32));
  inv1   g118(.a(x44), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n175_), .c(x10), .O(z33));
  inv1   g120(.a(x45), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n175_), .c(x10), .O(z34));
  nand2  g122(.a(new_n90_), .b(x46), .O(new_n206_));
