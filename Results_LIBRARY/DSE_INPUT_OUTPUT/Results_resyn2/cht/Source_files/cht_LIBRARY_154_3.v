...
module FAU ( 
  ...
  oai21  g053(.a(new_n113_), .b(new_n133_), .c(new_n136_), .O(z16));
  ...
  oai21  g061(.a(new_n113_), .b(new_n141_), .c(new_n144_), .O(z19));
  ...
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n84_), .O(z23));
  ...
  nand2  g080(.a(new_n159_), .b(new_n146_), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n87_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n84_), .O(z25));
  nor2   g083(.a(x38), .b(new_n146_), .O(new_n167_));
  oai21  g084(.a(x37), .b(x09), .c(new_n87_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n84_), .O(z26));
  ...
  nand2  g098(.a(new_n181_), .b(new_n84_), .O(z28));
  ...
  nand2  g118(.a(new_n201_), .b(new_n84_), .O(z32));
  ...
  nand2  g123(.a(new_n206_), .b(new_n84_), .O(z33));
