...
module FAU ( 
  ...
  aoi21  g007(.a(new_n84_), .b(x29), .c(x10), .O(new_n91_));
  ...
  nand2  g091(.a(new_n170_), .b(new_n115_), .O(new_n175_));
  ...
  nand2  g123(.a(new_n84_), .b(x09), .O(new_n207_));
  nand2  g124(.a(new_n203_), .b(new_n187_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n207_), .c(new_n88_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n85_), .O(z24));
  aoi21  g127(.a(new_n170_), .b(x09), .c(x36), .O(new_n211_));
  oai21  g128(.a(x37), .b(new_n187_), .c(new_n88_), .O(new_n212_));
  ...
  nand2  g133(.a(new_n216_), .b(new_n187_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n215_), .c(new_n88_), .O(new_n218_));
  ...
  aoi21  g140(.a(new_n214_), .b(new_n187_), .c(x10), .O(new_n224_));
