...
module FAU ( 
  ...
  nand2  g069(.a(new_n145_), .b(new_n111_), .O(new_n153_));
  ...
  nand2  g074(.a(new_n151_), .b(new_n111_), .O(new_n158_));
  ...
  aoi21  g094(.a(new_n177_), .b(new_n174_), .c(x10), .O(z21));
  inv1   g095(.a(x33), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n174_), .c(x10), .O(z22));
  nand2  g097(.a(new_n90_), .b(x34), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z23));
  nand2  g099(.a(new_n90_), .b(x35), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z24));
  nand2  g101(.a(new_n90_), .b(x36), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z25));
  inv1   g103(.a(x37), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n174_), .c(x10), .O(z26));
  nand2  g105(.a(new_n90_), .b(x38), .O(new_n189_));
  inv1   g106(.a(new_n189_), .O(z27));
  inv1   g107(.a(x39), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n174_), .c(x10), .O(z28));
  inv1   g109(.a(x40), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(new_n174_), .c(x10), .O(z29));
  nand2  g111(.a(new_n90_), .b(x41), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z30));
  nand2  g113(.a(new_n90_), .b(x42), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z31));
  nand2  g115(.a(new_n90_), .b(x43), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  nand2  g117(.a(new_n90_), .b(x44), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z33));
  inv1   g119(.a(x45), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n174_), .c(x10), .O(z34));
  nand2  g121(.a(new_n90_), .b(x46), .O(new_n205_));
