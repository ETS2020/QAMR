...
module FAU ( 
  ...
  nand3  g103(.a(new_n186_), .b(new_n175_), .c(x09), .O(new_n187_));
  ...
  aoi21  g119(.a(new_n183_), .b(x43), .c(new_n86_), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z32));
  nand2  g121(.a(new_n181_), .b(x45), .O(new_n205_));
  aoi21  g122(.a(new_n183_), .b(x44), .c(new_n86_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z33));
  nand2  g124(.a(new_n181_), .b(x46), .O(new_n208_));
  aoi21  g125(.a(new_n183_), .b(x45), .c(new_n86_), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z34));
  nand3  g127(.a(new_n175_), .b(x09), .c(new_n140_), .O(new_n211_));
  inv1   g128(.a(x46), .O(new_n212_));
  nand2  g129(.a(new_n183_), .b(new_n212_), .O(new_n213_));
