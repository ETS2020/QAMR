...
module FAU ( 
  ...
  nand2  g008(.a(x26), .b(x10), .O(new_n92_));
  ...
  nand2  g052(.a(new_n86_), .b(new_n105_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(x26), .O(new_n137_));
  oai21  g054(.a(new_n136_), .b(new_n131_), .c(new_n137_), .O(z14));
  ...
  nand2  g060(.a(new_n139_), .b(new_n105_), .O(new_n144_));
  nand3  g061(.a(new_n144_), .b(new_n143_), .c(new_n86_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n92_), .O(z16));
  ...
  nand2  g067(.a(new_n150_), .b(new_n92_), .O(z17));
  nor2   g068(.a(x30), .b(new_n105_), .O(new_n152_));
  oai21  g069(.a(x29), .b(x08), .c(new_n86_), .O(new_n153_));
  oai21  g070(.a(new_n153_), .b(new_n152_), .c(new_n92_), .O(z18));
  ...
  nand2  g098(.a(new_n177_), .b(new_n160_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n181_), .c(new_n86_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n92_), .O(z26));
  ...
  aoi21  g105(.a(new_n180_), .b(new_n160_), .c(x10), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n92_), .O(z27));
  ...
  nand2  g119(.a(new_n202_), .b(new_n92_), .O(z29));
  ...
  nand2  g134(.a(new_n217_), .b(new_n92_), .O(z32));
  ...
  nand2  g144(.a(new_n227_), .b(new_n92_), .O(z34));
  nand3  g145(.a(new_n186_), .b(x09), .c(new_n155_), .O(new_n229_));
  nand2  g146(.a(new_n195_), .b(new_n224_), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(new_n229_), .c(new_n86_), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n92_), .O(z35));
endmodule
