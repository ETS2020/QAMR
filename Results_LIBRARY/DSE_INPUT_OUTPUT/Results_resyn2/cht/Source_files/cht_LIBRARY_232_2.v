...
module FAU ( 
  ...
  nand2  g001(.a(new_n84_), .b(x18), .O(new_n85_));
  ...
  aoi21  g007(.a(new_n84_), .b(x18), .c(x10), .O(new_n91_));
  ...
  nor2   g032(.a(x17), .b(x08), .O(new_n116_));
  inv1   g033(.a(x08), .O(new_n117_));
  oai21  g034(.a(x18), .b(new_n117_), .c(new_n88_), .O(new_n118_));
  oai21  g035(.a(new_n118_), .b(new_n116_), .c(new_n85_), .O(z06));
  ...
  nand2  g046(.a(new_n129_), .b(new_n85_), .O(z08));
  ...
  nand2  g051(.a(new_n134_), .b(new_n85_), .O(z09));
  ...
  nand2  g056(.a(new_n139_), .b(new_n85_), .O(z10));
  ...
  nand2  g061(.a(new_n144_), .b(new_n85_), .O(z11));
  nand2  g062(.a(new_n141_), .b(new_n117_), .O(new_n146_));
  ...
  nand2  g073(.a(new_n84_), .b(new_n117_), .O(new_n157_));
