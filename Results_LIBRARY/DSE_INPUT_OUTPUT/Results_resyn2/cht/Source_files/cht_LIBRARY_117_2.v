...
module FAU ( 
  ...
  aoi21  g077(.a(x35), .b(new_n144_), .c(x08), .O(new_n161_));
  ...
  aoi21  g094(.a(x38), .b(new_n144_), .c(x08), .O(new_n178_));
  ...
  nor2   g102(.a(x14), .b(new_n144_), .O(new_n186_));
  ...
  nand2  g112(.a(new_n186_), .b(x43), .O(new_n196_));
  aoi21  g113(.a(new_n182_), .b(x42), .c(x08), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z31));
  nand2  g115(.a(new_n186_), .b(x44), .O(new_n199_));
  aoi21  g116(.a(new_n182_), .b(x43), .c(x08), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z32));
  nand2  g118(.a(new_n186_), .b(x45), .O(new_n202_));
  aoi21  g119(.a(new_n182_), .b(x44), .c(x08), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z33));
  inv1   g121(.a(x46), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n174_), .c(x09), .O(new_n206_));
  inv1   g123(.a(x45), .O(new_n207_));
  nand2  g124(.a(new_n182_), .b(new_n207_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n206_), .c(new_n90_), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  nand3  g127(.a(new_n174_), .b(x09), .c(new_n172_), .O(new_n211_));
  nand2  g128(.a(new_n182_), .b(new_n205_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n211_), .c(new_n90_), .O(new_n213_));
