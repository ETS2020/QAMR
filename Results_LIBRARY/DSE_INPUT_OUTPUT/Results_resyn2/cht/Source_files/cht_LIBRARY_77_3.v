...
module FAU ( 
  ...
  oai21  g044(.a(new_n110_), .b(new_n124_), .c(new_n127_), .O(z13));
  ...
  oai21  g051(.a(x28), .b(x10), .c(x08), .O(new_n135_));
  oai21  g052(.a(new_n110_), .b(new_n134_), .c(new_n135_), .O(z16));
  ...
  oai21  g057(.a(new_n110_), .b(new_n137_), .c(new_n140_), .O(z18));
  ...
  nand2  g067(.a(new_n150_), .b(new_n89_), .O(z20));
  ...
  nand2  g072(.a(new_n155_), .b(new_n89_), .O(z21));
  ...
  nand2  g077(.a(new_n160_), .b(new_n89_), .O(z22));
  nor2   g078(.a(x35), .b(new_n147_), .O(new_n162_));
  oai21  g079(.a(x34), .b(x09), .c(new_n86_), .O(new_n163_));
  oai21  g080(.a(new_n163_), .b(new_n162_), .c(new_n89_), .O(z23));
  nor2   g081(.a(x36), .b(new_n147_), .O(new_n165_));
  ...
  nand2  g089(.a(new_n168_), .b(new_n147_), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n172_), .c(new_n86_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n89_), .O(z26));
  ...
  nand2  g098(.a(new_n181_), .b(new_n89_), .O(z27));
  ...
  nand3  g104(.a(new_n187_), .b(new_n184_), .c(new_n86_), .O(new_n188_));
  ...
  nand3  g136(.a(new_n177_), .b(x09), .c(new_n142_), .O(new_n220_));
