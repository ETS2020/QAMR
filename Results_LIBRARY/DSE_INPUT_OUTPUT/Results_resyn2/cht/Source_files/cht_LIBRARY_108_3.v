...
module FAU ( 
  ...
  oai21  g041(.a(new_n108_), .b(new_n123_), .c(new_n124_), .O(z12));
  ...
  oai21  g049(.a(new_n108_), .b(new_n131_), .c(new_n132_), .O(z15));
  inv1   g050(.a(x27), .O(new_n134_));
  oai21  g051(.a(x28), .b(x10), .c(x08), .O(new_n135_));
  oai21  g052(.a(new_n108_), .b(new_n134_), .c(new_n135_), .O(z16));
  nor2   g053(.a(x29), .b(new_n107_), .O(new_n137_));
  ...
  oai21  g060(.a(new_n108_), .b(new_n140_), .c(new_n143_), .O(z19));
  ...
  oai21  g070(.a(new_n153_), .b(new_n152_), .c(new_n89_), .O(z21));
  ...
  oai21  g079(.a(new_n162_), .b(new_n161_), .c(new_n89_), .O(z24));
  nor2   g080(.a(x37), .b(new_n147_), .O(new_n164_));
  ...
  aoi21  g090(.a(new_n167_), .b(new_n147_), .c(x10), .O(new_n174_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n89_), .O(z31));
  ...
  nand2  g124(.a(new_n207_), .b(new_n89_), .O(z33));
