...
module FAU ( 
  ...
  oai21  g051(.a(new_n134_), .b(new_n133_), .c(new_n84_), .O(z15));
  ...
  oai21  g071(.a(new_n154_), .b(new_n153_), .c(new_n84_), .O(z20));
  ...
  oai21  g080(.a(new_n163_), .b(new_n162_), .c(new_n84_), .O(z23));
  nor2   g081(.a(x36), .b(new_n152_), .O(new_n165_));
  oai21  g082(.a(x35), .b(x09), .c(new_n87_), .O(new_n166_));
  nor2   g083(.a(new_n166_), .b(new_n165_), .O(z24));
  inv1   g084(.a(x37), .O(new_n168_));
  oai21  g085(.a(x36), .b(x09), .c(new_n87_), .O(new_n169_));
  aoi21  g086(.a(new_n168_), .b(x09), .c(new_n169_), .O(z25));
  nor2   g087(.a(x38), .b(new_n152_), .O(new_n171_));
  oai21  g088(.a(x37), .b(x09), .c(new_n87_), .O(new_n172_));
  oai21  g089(.a(new_n172_), .b(new_n171_), .c(new_n84_), .O(z26));
  inv1   g090(.a(x14), .O(new_n174_));
  inv1   g091(.a(x39), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g093(.a(x14), .b(new_n147_), .O(new_n177_));
  ...
  oai21  g099(.a(x14), .b(new_n152_), .c(new_n175_), .O(new_n183_));
  ...
  oai21  g104(.a(x14), .b(new_n152_), .c(new_n181_), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n187_), .c(new_n87_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n84_), .O(z29));
  ...
  nand2  g111(.a(new_n194_), .b(new_n84_), .O(z30));
  ...
  nand3  g132(.a(new_n174_), .b(x09), .c(new_n147_), .O(new_n216_));
  oai21  g133(.a(x14), .b(new_n152_), .c(new_n211_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n216_), .c(new_n87_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n84_), .O(z35));
endmodule
