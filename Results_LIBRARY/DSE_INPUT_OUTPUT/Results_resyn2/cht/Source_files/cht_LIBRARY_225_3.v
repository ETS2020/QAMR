...
module FAU ( 
  ...
  nand3  g056(.a(new_n139_), .b(new_n137_), .c(new_n90_), .O(new_n140_));
  ...
  nand2  g100(.a(new_n178_), .b(new_n115_), .O(new_n184_));
  ...
  nand2  g145(.a(new_n220_), .b(new_n189_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n90_), .O(new_n230_));
  ...
  nand3  g161(.a(new_n244_), .b(new_n243_), .c(new_n90_), .O(new_n245_));
