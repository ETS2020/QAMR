...
module FAU ( 
  ...
  aoi21  g007(.a(new_n84_), .b(x16), .c(x10), .O(new_n91_));
  ...
  inv1   g041(.a(x16), .O(new_n125_));
  aoi21  g042(.a(new_n125_), .b(new_n115_), .c(x20), .O(new_n126_));
  oai21  g043(.a(x19), .b(x08), .c(new_n88_), .O(new_n127_));
  ...
  nand3  g053(.a(new_n136_), .b(new_n134_), .c(new_n91_), .O(new_n137_));
  inv1   g054(.a(new_n137_), .O(z10));
  nand2  g055(.a(new_n135_), .b(new_n115_), .O(new_n139_));
  inv1   g056(.a(x23), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g058(.a(new_n141_), .b(new_n139_), .c(new_n91_), .O(new_n142_));
  inv1   g059(.a(new_n142_), .O(z11));
  inv1   g060(.a(x24), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(x08), .O(new_n145_));
  nand2  g062(.a(new_n140_), .b(new_n115_), .O(new_n146_));
  nand3  g063(.a(new_n146_), .b(new_n145_), .c(new_n88_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n85_), .O(z12));
  nand2  g065(.a(new_n144_), .b(new_n115_), .O(new_n149_));
  ...
  nand2  g070(.a(new_n150_), .b(new_n115_), .O(new_n154_));
  ...
  nand2  g075(.a(new_n155_), .b(new_n115_), .O(new_n159_));
  ...
  nand2  g085(.a(new_n165_), .b(new_n115_), .O(new_n169_));
  ...
  nand2  g090(.a(new_n170_), .b(new_n115_), .O(new_n174_));
  inv1   g091(.a(x30), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(x08), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n174_), .c(new_n91_), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z18));
  nand2  g095(.a(new_n175_), .b(new_n115_), .O(new_n179_));
