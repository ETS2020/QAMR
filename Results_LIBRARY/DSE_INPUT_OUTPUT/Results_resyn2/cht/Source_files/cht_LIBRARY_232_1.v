...
module FAU ( 
  ...
  nand2  g001(.a(x25), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g007(.a(x25), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand3  g036(.a(new_n119_), .b(new_n116_), .c(new_n88_), .O(new_n120_));
  nand2  g037(.a(new_n120_), .b(new_n85_), .O(z06));
  inv1   g038(.a(x25), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(x08), .O(new_n123_));
  oai21  g040(.a(x19), .b(new_n117_), .c(new_n88_), .O(new_n124_));
  aoi21  g041(.a(new_n123_), .b(new_n84_), .c(new_n124_), .O(z07));
  inv1   g042(.a(x20), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(x08), .O(new_n127_));
  inv1   g044(.a(x19), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(new_n117_), .O(new_n129_));
  nand3  g046(.a(new_n129_), .b(new_n127_), .c(new_n88_), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(new_n85_), .O(z08));
  inv1   g048(.a(x21), .O(new_n132_));
  nand2  g049(.a(new_n132_), .b(x08), .O(new_n133_));
  nand2  g050(.a(new_n126_), .b(new_n117_), .O(new_n134_));
  ...
  nand2  g091(.a(new_n171_), .b(new_n117_), .O(new_n175_));
  ...
  nand2  g096(.a(new_n176_), .b(new_n117_), .O(new_n180_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n85_), .c(new_n88_), .O(new_n228_));
  ...
  nand2  g150(.a(new_n233_), .b(new_n85_), .O(z28));
  ...
  nand3  g169(.a(new_n252_), .b(new_n251_), .c(new_n91_), .O(new_n253_));
  ...
  nand2  g180(.a(new_n263_), .b(new_n85_), .O(z34));
  ...
  nand2  g184(.a(new_n267_), .b(new_n85_), .O(z35));
endmodule
