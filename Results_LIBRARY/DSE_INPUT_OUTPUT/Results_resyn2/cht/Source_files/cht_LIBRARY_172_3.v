...
module FAU ( 
  ...
  oai21  g049(.a(new_n108_), .b(new_n129_), .c(new_n132_), .O(z15));
  ...
  nor2   g055(.a(x30), .b(new_n107_), .O(new_n139_));
  ...
  aoi21  g095(.a(new_n170_), .b(new_n145_), .c(x10), .O(new_n179_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n84_), .O(z32));
  ...
  nand2  g134(.a(new_n217_), .b(new_n84_), .O(z34));
  nand3  g135(.a(new_n176_), .b(x09), .c(new_n142_), .O(new_n219_));
  nand2  g136(.a(new_n185_), .b(new_n214_), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(new_n219_), .c(new_n87_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n84_), .O(z35));
endmodule
