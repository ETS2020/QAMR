...
module FAU ( 
  ...
  nand2  g032(.a(new_n90_), .b(x17), .O(new_n116_));
  ...
  nand2  g039(.a(new_n90_), .b(x20), .O(new_n123_));
  ...
  aoi21  g044(.a(new_n127_), .b(new_n118_), .c(x10), .O(z11));
  ...
  aoi21  g054(.a(new_n137_), .b(new_n118_), .c(x10), .O(z16));
  nand2  g055(.a(new_n90_), .b(x28), .O(new_n139_));
  inv1   g056(.a(new_n139_), .O(z17));
  inv1   g057(.a(x29), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(new_n118_), .c(x10), .O(z18));
  nand2  g059(.a(new_n90_), .b(x30), .O(new_n143_));
  ...
  aoi21  g069(.a(x32), .b(new_n147_), .c(x08), .O(new_n153_));
  ...
  aoi21  g083(.a(x35), .b(new_n147_), .c(x08), .O(new_n167_));
  ...
  nand2  g097(.a(x14), .b(new_n180_), .O(new_n181_));
  oai21  g098(.a(x39), .b(x14), .c(new_n181_), .O(new_n182_));
  oai21  g099(.a(x38), .b(x09), .c(new_n90_), .O(new_n183_));
  ...
  aoi21  g107(.a(new_n187_), .b(x40), .c(x08), .O(new_n191_));
  ...
  nand3  g116(.a(new_n199_), .b(new_n100_), .c(x09), .O(new_n200_));
  ...
  aoi21  g126(.a(new_n187_), .b(x44), .c(x08), .O(new_n210_));
  ...
  nand3  g134(.a(new_n100_), .b(x09), .c(new_n180_), .O(new_n218_));
  nand2  g135(.a(new_n187_), .b(new_n212_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(new_n90_), .O(new_n220_));
