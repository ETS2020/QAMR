...
module FAU ( 
  ...
  aoi21  g084(.a(x35), .b(new_n147_), .c(new_n86_), .O(new_n168_));
  ...
  nand2  g097(.a(x14), .b(new_n143_), .O(new_n181_));
  inv1   g098(.a(x14), .O(new_n182_));
  inv1   g099(.a(x39), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(new_n181_), .c(x09), .O(new_n185_));
  aoi21  g102(.a(x38), .b(new_n147_), .c(new_n86_), .O(new_n186_));
  ...
  nand2  g106(.a(new_n182_), .b(x09), .O(new_n190_));
  ...
  nand2  g112(.a(new_n190_), .b(new_n188_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n195_), .c(new_n87_), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z29));
  nor2   g115(.a(x14), .b(new_n147_), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(x42), .O(new_n200_));
  aoi21  g117(.a(new_n190_), .b(x41), .c(new_n86_), .O(new_n201_));
  ...
  nand2  g122(.a(new_n190_), .b(new_n205_), .O(new_n206_));
  ...
  nand2  g127(.a(new_n190_), .b(new_n203_), .O(new_n211_));
  ...
  nand2  g140(.a(new_n199_), .b(x00), .O(new_n224_));
  aoi21  g141(.a(new_n190_), .b(x46), .c(new_n86_), .O(new_n225_));
