...
module FAU ( 
  ...
  nand2  g014(.a(x10), .b(x03), .O(new_n98_));
  ...
  nand2  g019(.a(new_n86_), .b(new_n84_), .O(new_n103_));
  nand2  g020(.a(new_n103_), .b(x03), .O(new_n104_));
  oai21  g021(.a(new_n103_), .b(new_n102_), .c(new_n104_), .O(z05));
  ...
  oai21  g028(.a(new_n111_), .b(new_n110_), .c(new_n98_), .O(z07));
  ...
  oai21  g034(.a(new_n117_), .b(new_n116_), .c(new_n98_), .O(z09));
  ...
  nand2  g048(.a(new_n131_), .b(new_n98_), .O(z13));
  nor2   g049(.a(x26), .b(new_n109_), .O(new_n133_));
  oai21  g050(.a(x25), .b(x08), .c(new_n86_), .O(new_n134_));
  oai21  g051(.a(new_n134_), .b(new_n133_), .c(new_n98_), .O(z14));
  ...
  oai21  g060(.a(new_n143_), .b(new_n142_), .c(new_n98_), .O(z17));
  ...
  nand2  g068(.a(new_n151_), .b(new_n98_), .O(z19));
  ...
  oai21  g075(.a(new_n158_), .b(new_n157_), .c(new_n98_), .O(z21));
  nor2   g076(.a(x34), .b(new_n156_), .O(new_n160_));
  ...
  aoi21  g095(.a(new_n172_), .b(new_n156_), .c(x10), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n98_), .O(z27));
  ...
  nand2  g124(.a(new_n207_), .b(new_n98_), .O(z32));
  ...
  nand2  g129(.a(new_n212_), .b(new_n98_), .O(z33));
  ...
  nand3  g135(.a(new_n176_), .b(x09), .c(new_n148_), .O(new_n219_));
