...
module FAU ( 
  ...
  aoi21  g053(.a(x21), .b(new_n121_), .c(new_n86_), .O(new_n137_));
  ...
  aoi21  g085(.a(x29), .b(new_n121_), .c(new_n86_), .O(new_n169_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n121_), .O(new_n174_));
  ...
  nand2  g106(.a(new_n189_), .b(new_n179_), .O(new_n190_));
  ...
  nand2  g111(.a(new_n187_), .b(new_n179_), .O(new_n195_));
  ...
  nor3   g116(.a(x37), .b(new_n86_), .c(new_n179_), .O(new_n200_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n104_), .c(x09), .O(new_n217_));
  ...
  aoi21  g153(.a(new_n213_), .b(x45), .c(new_n86_), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z34));
  nand2  g155(.a(new_n211_), .b(x00), .O(new_n239_));
  aoi21  g156(.a(new_n213_), .b(x46), .c(new_n86_), .O(new_n240_));
