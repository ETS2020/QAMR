...
module FAU ( 
  ...
  nand2  g071(.a(new_n154_), .b(new_n143_), .O(new_n155_));
  ...
  nand2  g080(.a(new_n163_), .b(new_n143_), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n162_), .c(new_n87_), .O(new_n165_));
  inv1   g082(.a(new_n165_), .O(z25));
  nand2  g083(.a(x38), .b(x09), .O(new_n167_));
  aoi21  g084(.a(x37), .b(new_n143_), .c(new_n86_), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n167_), .c(x10), .O(z26));
  ...
  aoi21  g091(.a(x38), .b(new_n143_), .c(new_n86_), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z27));
  nor2   g093(.a(x14), .b(new_n143_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(x40), .O(new_n178_));
  nand2  g095(.a(new_n171_), .b(x09), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(x39), .c(new_n86_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n178_), .c(x10), .O(z28));
  nand2  g098(.a(new_n177_), .b(x41), .O(new_n182_));
  aoi21  g099(.a(new_n179_), .b(x40), .c(new_n86_), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z29));
  nand2  g101(.a(new_n177_), .b(x42), .O(new_n185_));
  aoi21  g102(.a(new_n179_), .b(x41), .c(new_n86_), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z30));
  inv1   g104(.a(x43), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n171_), .c(x09), .O(new_n189_));
  inv1   g106(.a(x42), .O(new_n190_));
  nand2  g107(.a(new_n179_), .b(new_n190_), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n189_), .c(new_n87_), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z31));
  nand2  g110(.a(new_n177_), .b(x44), .O(new_n194_));
  aoi21  g111(.a(new_n179_), .b(x43), .c(new_n86_), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z32));
  nand2  g113(.a(new_n177_), .b(x45), .O(new_n197_));
  aoi21  g114(.a(new_n179_), .b(x44), .c(new_n86_), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z33));
  inv1   g116(.a(x46), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n171_), .c(x09), .O(new_n201_));
  inv1   g118(.a(x45), .O(new_n202_));
  nand2  g119(.a(new_n179_), .b(new_n202_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n201_), .c(new_n87_), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z34));
  nand2  g122(.a(new_n177_), .b(x00), .O(new_n206_));
  aoi21  g123(.a(new_n179_), .b(x46), .c(new_n86_), .O(new_n207_));
