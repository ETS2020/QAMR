...
module FAU ( 
  ...
  nor2   g016(.a(x10), .b(new_n86_), .O(new_n100_));
  ...
  nand2  g035(.a(new_n100_), .b(x22), .O(new_n119_));
  ...
  aoi21  g048(.a(new_n131_), .b(x08), .c(x10), .O(z16));
  inv1   g049(.a(x29), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(x08), .c(x10), .O(z17));
  nand2  g051(.a(new_n100_), .b(x30), .O(new_n135_));
  ...
  nand3  g060(.a(new_n143_), .b(new_n140_), .c(new_n100_), .O(new_n144_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n147_), .c(new_n100_), .O(new_n149_));
  ...
  aoi21  g071(.a(x34), .b(new_n141_), .c(new_n86_), .O(new_n155_));
  ...
  aoi21  g080(.a(x36), .b(new_n141_), .c(new_n86_), .O(new_n164_));
  ...
  nand3  g086(.a(new_n169_), .b(new_n167_), .c(new_n100_), .O(new_n170_));
  inv1   g087(.a(new_n170_), .O(z26));
  nand2  g088(.a(x14), .b(new_n137_), .O(new_n172_));
  ...
  aoi21  g093(.a(x38), .b(new_n141_), .c(new_n86_), .O(new_n177_));
  ...
  nor2   g101(.a(x14), .b(new_n141_), .O(new_n185_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n190_), .c(new_n100_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z30));
  inv1   g111(.a(x43), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n173_), .c(x09), .O(new_n196_));
  nand2  g113(.a(new_n181_), .b(new_n189_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(new_n100_), .O(new_n198_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n100_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z32));
  nand2  g121(.a(new_n185_), .b(x45), .O(new_n205_));
  aoi21  g122(.a(new_n181_), .b(x44), .c(new_n86_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z33));
  inv1   g124(.a(x46), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n173_), .c(x09), .O(new_n209_));
  inv1   g126(.a(x45), .O(new_n210_));
  nand2  g127(.a(new_n181_), .b(new_n210_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n209_), .c(new_n100_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n173_), .b(x09), .c(new_n137_), .O(new_n214_));
  nand2  g131(.a(new_n181_), .b(new_n208_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n100_), .O(new_n216_));
