...
module FAU ( 
  ...
  nor2   g044(.a(x26), .b(new_n109_), .O(new_n128_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n84_), .O(z23));
  ...
  nand2  g082(.a(new_n165_), .b(new_n84_), .O(z24));
  nor2   g083(.a(x37), .b(new_n145_), .O(new_n167_));
  oai21  g084(.a(x36), .b(x09), .c(new_n87_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n84_), .O(z25));
  ...
  nand3  g133(.a(new_n174_), .b(x09), .c(new_n142_), .O(new_n217_));
