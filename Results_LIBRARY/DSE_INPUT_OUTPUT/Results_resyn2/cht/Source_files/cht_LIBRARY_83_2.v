...
module FAU ( 
  ...
  oai21  g045(.a(new_n128_), .b(new_n127_), .c(new_n85_), .O(z11));
  ...
  oai21  g056(.a(x26), .b(x08), .c(new_n88_), .O(new_n140_));
  ...
  nand2  g062(.a(new_n145_), .b(new_n85_), .O(z16));
  ...
  nand2  g067(.a(new_n150_), .b(new_n85_), .O(z17));
  ...
  nand2  g083(.a(new_n158_), .b(new_n160_), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n88_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n85_), .O(z21));
  nor2   g086(.a(x34), .b(new_n160_), .O(new_n170_));
  oai21  g087(.a(x33), .b(x09), .c(new_n88_), .O(new_n171_));
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n85_), .O(z22));
  nor2   g089(.a(x35), .b(new_n160_), .O(new_n173_));
  oai21  g090(.a(x34), .b(x09), .c(new_n88_), .O(new_n174_));
  nor2   g091(.a(new_n174_), .b(new_n173_), .O(z23));
  nor2   g092(.a(x36), .b(new_n160_), .O(new_n176_));
  oai21  g093(.a(x35), .b(x09), .c(new_n88_), .O(new_n177_));
  nor2   g094(.a(new_n177_), .b(new_n176_), .O(z24));
  oai21  g095(.a(x36), .b(x09), .c(new_n88_), .O(new_n179_));
  aoi21  g096(.a(new_n84_), .b(x09), .c(new_n179_), .O(z25));
  inv1   g097(.a(x38), .O(new_n181_));
  oai21  g098(.a(x37), .b(x09), .c(new_n88_), .O(new_n182_));
  ...
  aoi21  g104(.a(new_n181_), .b(new_n160_), .c(x10), .O(new_n188_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n85_), .O(z34));
  nand3  g144(.a(new_n185_), .b(x09), .c(new_n155_), .O(new_n228_));
