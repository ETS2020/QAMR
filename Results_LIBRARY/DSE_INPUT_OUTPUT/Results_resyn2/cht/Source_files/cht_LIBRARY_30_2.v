...
module FAU ( 
  ...
  nand2  g038(.a(new_n90_), .b(x21), .O(new_n122_));
  ...
  nand2  g048(.a(new_n90_), .b(x26), .O(new_n132_));
  ...
  aoi21  g079(.a(x35), .b(new_n143_), .c(x08), .O(new_n163_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n166_), .c(new_n90_), .O(new_n169_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n172_), .c(new_n90_), .O(new_n174_));
  ...
  oai21  g095(.a(x38), .b(x09), .c(new_n90_), .O(new_n179_));
  ...
  nand3  g128(.a(new_n103_), .b(x09), .c(new_n176_), .O(new_n212_));
  nand2  g129(.a(new_n183_), .b(new_n206_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(new_n90_), .O(new_n214_));
