...
module FAU ( 
  ...
  nor3   g051(.a(x10), .b(new_n86_), .c(new_n134_), .O(z19));
  nand2  g052(.a(x32), .b(x09), .O(new_n136_));
  inv1   g053(.a(x09), .O(new_n137_));
  aoi21  g054(.a(x31), .b(new_n137_), .c(new_n86_), .O(new_n138_));
  aoi21  g055(.a(new_n138_), .b(new_n136_), .c(x10), .O(z20));
  nand2  g056(.a(x33), .b(x09), .O(new_n140_));
  aoi21  g057(.a(x32), .b(new_n137_), .c(new_n86_), .O(new_n141_));
  ...
  nand2  g085(.a(x14), .b(new_n134_), .O(new_n169_));
  ...
  nand2  g105(.a(new_n178_), .b(new_n181_), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n188_), .c(new_n87_), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z30));
  nand2  g108(.a(new_n176_), .b(x43), .O(new_n192_));
  aoi21  g109(.a(new_n178_), .b(x42), .c(new_n86_), .O(new_n193_));
  ...
  nand2  g117(.a(new_n176_), .b(x45), .O(new_n201_));
  aoi21  g118(.a(new_n178_), .b(x44), .c(new_n86_), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z33));
  nand2  g120(.a(new_n176_), .b(x46), .O(new_n204_));
  aoi21  g121(.a(new_n178_), .b(x45), .c(new_n86_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z34));
  nand2  g123(.a(new_n176_), .b(x00), .O(new_n207_));
  aoi21  g124(.a(new_n178_), .b(x46), .c(new_n86_), .O(new_n208_));
