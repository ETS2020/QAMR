...
module FAU ( 
  ...
  nand2  g090(.a(new_n169_), .b(new_n149_), .O(new_n174_));
  ...
  aoi21  g097(.a(new_n172_), .b(new_n149_), .c(x10), .O(new_n181_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n85_), .O(z31));
  ...
  nand2  g126(.a(new_n209_), .b(new_n85_), .O(z32));
