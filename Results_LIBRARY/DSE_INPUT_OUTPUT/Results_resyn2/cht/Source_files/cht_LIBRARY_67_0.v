...
module FAU ( 
  ...
  nand3  g038(.a(new_n121_), .b(new_n119_), .c(new_n87_), .O(new_n122_));
  ...
  nand2  g064(.a(new_n140_), .b(new_n115_), .O(new_n148_));
  ...
  nand2  g069(.a(new_n146_), .b(new_n115_), .O(new_n153_));
  ...
  nand2  g111(.a(new_n194_), .b(new_n169_), .O(new_n195_));
  ...
  oai21  g116(.a(x39), .b(x14), .c(new_n199_), .O(new_n200_));
  nand2  g117(.a(new_n192_), .b(new_n169_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n87_), .O(new_n202_));
  aoi21  g119(.a(new_n200_), .b(x09), .c(new_n202_), .O(z27));
  nor2   g120(.a(x14), .b(new_n169_), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(x40), .O(new_n205_));
  nand2  g122(.a(new_n104_), .b(x09), .O(new_n206_));
  ...
  aoi21  g126(.a(new_n206_), .b(x40), .c(new_n86_), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z29));
  nand2  g128(.a(new_n204_), .b(x42), .O(new_n212_));
  aoi21  g129(.a(new_n206_), .b(x41), .c(new_n86_), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z30));
  nand2  g131(.a(new_n204_), .b(x43), .O(new_n215_));
  aoi21  g132(.a(new_n206_), .b(x42), .c(new_n86_), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z31));
  inv1   g134(.a(x44), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n104_), .c(x09), .O(new_n219_));
  inv1   g136(.a(x43), .O(new_n220_));
  nand2  g137(.a(new_n206_), .b(new_n220_), .O(new_n221_));
  ...
  nand2  g142(.a(new_n206_), .b(new_n218_), .O(new_n226_));
  ...
  nand2  g147(.a(new_n206_), .b(new_n224_), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(new_n230_), .c(new_n87_), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(z34));
  nand3  g150(.a(new_n104_), .b(x09), .c(new_n198_), .O(new_n234_));
  nand2  g151(.a(new_n206_), .b(new_n229_), .O(new_n235_));
