...
module FAU ( 
  ...
  nand2  g009(.a(x41), .b(new_n84_), .O(new_n93_));
  ...
  aoi21  g127(.a(new_n210_), .b(new_n187_), .c(x37), .O(new_n211_));
  oai21  g128(.a(x36), .b(x09), .c(new_n95_), .O(new_n212_));
  nor2   g129(.a(new_n212_), .b(new_n211_), .O(z25));
  nand2  g130(.a(new_n93_), .b(x38), .O(new_n214_));
  oai21  g131(.a(x37), .b(x09), .c(new_n95_), .O(new_n215_));
  aoi21  g132(.a(new_n214_), .b(x09), .c(new_n215_), .O(z26));
  inv1   g133(.a(x39), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(new_n101_), .O(new_n218_));
  nand2  g135(.a(x14), .b(new_n180_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n218_), .O(new_n220_));
  inv1   g137(.a(x38), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n187_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n93_), .c(new_n95_), .O(new_n223_));
  ...
  oai21  g143(.a(x14), .b(new_n187_), .c(new_n217_), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n226_), .c(new_n95_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n93_), .O(z28));
  nand3  g146(.a(new_n210_), .b(new_n101_), .c(x09), .O(new_n230_));
  oai21  g147(.a(x14), .b(new_n187_), .c(new_n225_), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(new_n230_), .c(new_n85_), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(z29));
  inv1   g150(.a(x42), .O(new_n234_));
  nand3  g151(.a(new_n234_), .b(new_n101_), .c(x09), .O(new_n235_));
  oai21  g152(.a(x14), .b(new_n187_), .c(new_n210_), .O(new_n236_));
  ...
  nand2  g169(.a(new_n252_), .b(new_n93_), .O(z33));
  ...
  nand2  g174(.a(new_n257_), .b(new_n93_), .O(z34));
  nand3  g175(.a(new_n101_), .b(x09), .c(new_n180_), .O(new_n259_));
  oai21  g176(.a(x14), .b(new_n187_), .c(new_n254_), .O(new_n260_));
  nand3  g177(.a(new_n260_), .b(new_n259_), .c(new_n95_), .O(new_n261_));
  nand2  g178(.a(new_n261_), .b(new_n93_), .O(z35));
endmodule
