...
module FAU ( 
  ...
  oai22  g031(.a(new_n114_), .b(x08), .c(new_n111_), .d(new_n113_), .O(z08));
  ...
  nor2   g050(.a(x27), .b(new_n84_), .O(new_n134_));
  ...
  oai22  g064(.a(new_n147_), .b(x08), .c(new_n111_), .d(new_n146_), .O(z19));
  ...
  nand2  g081(.a(new_n164_), .b(new_n85_), .O(z23));
  nor2   g082(.a(x36), .b(new_n149_), .O(new_n166_));
  oai21  g083(.a(x35), .b(x09), .c(new_n88_), .O(new_n167_));
  oai21  g084(.a(new_n167_), .b(new_n166_), .c(new_n85_), .O(z24));
  inv1   g085(.a(x37), .O(new_n169_));
  oai21  g086(.a(x36), .b(x09), .c(new_n88_), .O(new_n170_));
  aoi21  g087(.a(new_n169_), .b(x09), .c(new_n170_), .O(z25));
  nor2   g088(.a(x38), .b(new_n149_), .O(new_n172_));
  oai21  g089(.a(x37), .b(x09), .c(new_n88_), .O(new_n173_));
  oai21  g090(.a(new_n173_), .b(new_n172_), .c(new_n85_), .O(z26));
  ...
  oai21  g100(.a(x14), .b(new_n149_), .c(new_n176_), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(new_n183_), .c(new_n88_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n85_), .O(z28));
  inv1   g103(.a(x41), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n175_), .c(x09), .O(new_n188_));
  oai21  g105(.a(x14), .b(new_n149_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g110(.a(x14), .b(new_n149_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g115(.a(x14), .b(new_n149_), .c(new_n192_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n198_), .c(new_n88_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n85_), .O(z31));
  inv1   g118(.a(x44), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n175_), .c(x09), .O(new_n203_));
  oai21  g120(.a(x14), .b(new_n149_), .c(new_n197_), .O(new_n204_));
  ...
  oai21  g125(.a(x14), .b(new_n149_), .c(new_n202_), .O(new_n209_));
  ...
  oai21  g130(.a(x14), .b(new_n149_), .c(new_n207_), .O(new_n214_));
  ...
  oai21  g134(.a(x14), .b(new_n149_), .c(new_n212_), .O(new_n218_));
