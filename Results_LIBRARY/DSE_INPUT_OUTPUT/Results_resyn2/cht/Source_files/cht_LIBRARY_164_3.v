...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n89_), .O(z13));
  ...
  oai21  g073(.a(x33), .b(x10), .c(x09), .O(new_n157_));
  nor2   g074(.a(x10), .b(x09), .O(new_n158_));
  inv1   g075(.a(new_n158_), .O(new_n159_));
  oai21  g076(.a(new_n159_), .b(new_n154_), .c(new_n157_), .O(z21));
  ...
  oai21  g081(.a(new_n159_), .b(new_n161_), .c(new_n164_), .O(z23));
  oai21  g082(.a(x36), .b(x10), .c(x09), .O(new_n166_));
  nand2  g083(.a(new_n158_), .b(x35), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n166_), .O(z24));
  inv1   g085(.a(x09), .O(new_n169_));
  nor2   g086(.a(x37), .b(new_n169_), .O(new_n170_));
  oai21  g087(.a(x36), .b(x09), .c(new_n86_), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(new_n170_), .O(z25));
  nor2   g089(.a(x38), .b(new_n169_), .O(new_n173_));
  oai21  g090(.a(x37), .b(x09), .c(new_n86_), .O(new_n174_));
  nor2   g091(.a(new_n174_), .b(new_n173_), .O(z26));
  nand2  g092(.a(new_n158_), .b(x38), .O(new_n176_));
  ...
  nand3  g116(.a(new_n190_), .b(new_n186_), .c(x42), .O(new_n200_));
  aoi21  g117(.a(x43), .b(new_n178_), .c(x10), .O(new_n201_));
  oai21  g118(.a(new_n201_), .b(new_n169_), .c(new_n200_), .O(z31));
  inv1   g119(.a(x44), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n178_), .c(x09), .O(new_n204_));
  inv1   g121(.a(x43), .O(new_n205_));
  nand2  g122(.a(new_n186_), .b(new_n205_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n204_), .c(new_n86_), .O(new_n207_));
  inv1   g124(.a(new_n207_), .O(z32));
  nand3  g125(.a(new_n190_), .b(new_n186_), .c(x44), .O(new_n209_));
  aoi21  g126(.a(x45), .b(new_n178_), .c(x10), .O(new_n210_));
  oai21  g127(.a(new_n210_), .b(new_n169_), .c(new_n209_), .O(z33));
  ...
  nand3  g134(.a(new_n178_), .b(x09), .c(new_n151_), .O(new_n218_));
  nand2  g135(.a(new_n186_), .b(new_n212_), .O(new_n219_));
