...
module FAU ( 
  ...
  nand2  g050(.a(new_n127_), .b(new_n105_), .O(new_n134_));
  ...
  nand2  g057(.a(new_n140_), .b(new_n92_), .O(z15));
  ...
  nand2  g102(.a(new_n185_), .b(new_n92_), .O(z27));
  ...
  nand2  g114(.a(new_n197_), .b(new_n92_), .O(z29));
  ...
  nand2  g119(.a(new_n202_), .b(new_n92_), .O(z30));
  ...
  nand3  g140(.a(new_n181_), .b(x09), .c(new_n153_), .O(new_n224_));
