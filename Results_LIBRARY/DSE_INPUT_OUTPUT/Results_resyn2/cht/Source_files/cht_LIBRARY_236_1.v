...
module FAU ( 
  ...
  nand2  g064(.a(new_n147_), .b(new_n90_), .O(z17));
  ...
  oai21  g100(.a(x40), .b(x14), .c(new_n86_), .O(new_n184_));
  nand2  g101(.a(new_n179_), .b(x09), .O(new_n185_));
  nor2   g102(.a(x39), .b(x10), .O(new_n186_));
  aoi22  g103(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(x09), .O(z28));
  oai21  g104(.a(x41), .b(x14), .c(new_n86_), .O(new_n188_));
  nor2   g105(.a(x40), .b(x10), .O(new_n189_));
  aoi22  g106(.a(new_n189_), .b(new_n185_), .c(new_n188_), .d(x09), .O(z29));
  inv1   g107(.a(x42), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n179_), .c(x09), .O(new_n192_));
  inv1   g109(.a(x41), .O(new_n193_));
  oai21  g110(.a(x14), .b(new_n89_), .c(new_n193_), .O(new_n194_));
  ...
  aoi22  g115(.a(new_n198_), .b(new_n185_), .c(new_n197_), .d(x09), .O(z31));
  oai21  g116(.a(x44), .b(x14), .c(new_n86_), .O(new_n200_));
  nor2   g117(.a(x43), .b(x10), .O(new_n201_));
  aoi22  g118(.a(new_n201_), .b(new_n185_), .c(new_n200_), .d(x09), .O(z32));
  oai21  g119(.a(x45), .b(x14), .c(new_n86_), .O(new_n203_));
  nor2   g120(.a(x44), .b(x10), .O(new_n204_));
  aoi22  g121(.a(new_n204_), .b(new_n185_), .c(new_n203_), .d(x09), .O(z33));
