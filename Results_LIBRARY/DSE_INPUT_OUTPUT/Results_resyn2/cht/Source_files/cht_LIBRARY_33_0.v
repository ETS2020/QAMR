...
module FAU ( 
  ...
  aoi21  g054(.a(x22), .b(new_n113_), .c(new_n86_), .O(new_n138_));
  ...
  aoi21  g100(.a(x33), .b(new_n174_), .c(new_n86_), .O(new_n184_));
  ...
  aoi21  g115(.a(x37), .b(new_n174_), .c(new_n86_), .O(new_n199_));
  ...
  aoi21  g122(.a(x38), .b(new_n174_), .c(new_n86_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z27));
  inv1   g124(.a(x40), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n202_), .c(x09), .O(new_n209_));
  ...
  nand3  g131(.a(new_n214_), .b(new_n202_), .c(x09), .O(new_n215_));
  ...
  nor2   g135(.a(x14), .b(new_n174_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(x42), .O(new_n220_));
  aoi21  g137(.a(new_n210_), .b(x41), .c(new_n86_), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z30));
  inv1   g139(.a(x43), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n202_), .c(x09), .O(new_n224_));
  inv1   g141(.a(x42), .O(new_n225_));
  nand2  g142(.a(new_n210_), .b(new_n225_), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n224_), .c(new_n87_), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(z31));
  inv1   g145(.a(x44), .O(new_n229_));
  nand3  g146(.a(new_n229_), .b(new_n202_), .c(x09), .O(new_n230_));
  nand2  g147(.a(new_n210_), .b(new_n223_), .O(new_n231_));
  ...
  aoi21  g154(.a(new_n210_), .b(x45), .c(new_n86_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(new_n237_), .c(x10), .O(z34));
  nand3  g156(.a(new_n202_), .b(x09), .c(new_n168_), .O(new_n240_));
  inv1   g157(.a(x46), .O(new_n241_));
  nand2  g158(.a(new_n210_), .b(new_n241_), .O(new_n242_));
