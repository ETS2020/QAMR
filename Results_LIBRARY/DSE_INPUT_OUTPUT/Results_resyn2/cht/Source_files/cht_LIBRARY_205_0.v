...
module FAU ( 
  ...
  aoi21  g086(.a(x36), .b(new_n144_), .c(new_n86_), .O(new_n170_));
  ...
  nand2  g094(.a(x14), .b(new_n140_), .O(new_n178_));
  oai21  g095(.a(x39), .b(x14), .c(new_n178_), .O(new_n179_));
  nand2  g096(.a(new_n172_), .b(new_n144_), .O(new_n180_));
  ...
  nand3  g135(.a(new_n183_), .b(x09), .c(new_n140_), .O(new_n219_));
