...
module FAU ( 
  ...
  aoi21  g000(.a(x26), .b(x24), .c(x10), .O(new_n84_));
  ...
  nand2  g008(.a(x26), .b(x24), .O(new_n92_));
  ...
  nand2  g080(.a(new_n157_), .b(new_n117_), .O(new_n164_));
  ...
  nand2  g085(.a(new_n162_), .b(new_n117_), .O(new_n169_));
  ...
  nand3  g118(.a(new_n201_), .b(new_n199_), .c(new_n84_), .O(new_n202_));
  ...
  nand2  g146(.a(new_n229_), .b(new_n92_), .O(z27));
  ...
  nand3  g152(.a(new_n235_), .b(new_n232_), .c(new_n84_), .O(new_n236_));
  ...
  nand3  g167(.a(new_n250_), .b(new_n249_), .c(new_n84_), .O(new_n251_));
  ...
  nand2  g173(.a(new_n256_), .b(new_n92_), .O(z32));
  ...
  nand3  g177(.a(new_n260_), .b(new_n259_), .c(new_n84_), .O(new_n261_));
  ...
  nand3  g186(.a(new_n269_), .b(new_n268_), .c(new_n94_), .O(new_n270_));
  nand2  g187(.a(new_n270_), .b(new_n92_), .O(z35));
endmodule
