...
module FAU ( 
  ...
  aoi21  g087(.a(x30), .b(new_n115_), .c(new_n86_), .O(new_n171_));
  ...
  inv1   g096(.a(new_n94_), .O(new_n180_));
  nor2   g097(.a(x33), .b(x09), .O(new_n181_));
  nor2   g098(.a(new_n181_), .b(new_n180_), .O(z22));
  inv1   g099(.a(x35), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(x09), .c(new_n180_), .O(z23));
  inv1   g101(.a(x36), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(x09), .O(new_n186_));
  nand2  g103(.a(new_n183_), .b(new_n174_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n94_), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z24));
  nand2  g106(.a(x37), .b(x09), .O(new_n190_));
  aoi21  g107(.a(x36), .b(new_n174_), .c(new_n86_), .O(new_n191_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n174_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n194_), .c(new_n94_), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z26));
  inv1   g115(.a(x39), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n101_), .O(new_n200_));
  oai21  g117(.a(new_n101_), .b(x00), .c(new_n200_), .O(new_n201_));
  nand2  g118(.a(new_n193_), .b(new_n174_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n94_), .O(new_n203_));
  aoi21  g120(.a(new_n201_), .b(x09), .c(new_n203_), .O(z27));
  inv1   g121(.a(x40), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n101_), .c(x09), .O(new_n206_));
  ...
  aoi21  g129(.a(new_n207_), .b(x40), .c(new_n86_), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z29));
  inv1   g131(.a(x42), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n101_), .c(x09), .O(new_n216_));
  inv1   g133(.a(x41), .O(new_n217_));
  nand2  g134(.a(new_n207_), .b(new_n217_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n216_), .c(new_n94_), .O(new_n219_));
  inv1   g136(.a(new_n219_), .O(z30));
  inv1   g137(.a(x43), .O(new_n221_));
  nand3  g138(.a(new_n221_), .b(new_n101_), .c(x09), .O(new_n222_));
  nand2  g139(.a(new_n207_), .b(new_n215_), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n222_), .c(new_n94_), .O(new_n224_));
  ...
  nand2  g147(.a(new_n211_), .b(x45), .O(new_n231_));
  aoi21  g148(.a(new_n207_), .b(x44), .c(new_n86_), .O(new_n232_));
  ...
  nand2  g153(.a(new_n207_), .b(new_n236_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n235_), .c(new_n94_), .O(new_n238_));
  inv1   g155(.a(new_n238_), .O(z34));
  inv1   g156(.a(x00), .O(new_n240_));
  nand3  g157(.a(new_n101_), .b(x09), .c(new_n240_), .O(new_n241_));
  nand2  g158(.a(new_n207_), .b(new_n234_), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(new_n241_), .c(new_n94_), .O(new_n243_));
