...
module FAU ( 
  ...
  nand2  g001(.a(new_n84_), .b(x28), .O(new_n85_));
  ...
  aoi21  g007(.a(new_n84_), .b(x28), .c(x10), .O(new_n91_));
  ...
  nand2  g093(.a(new_n176_), .b(new_n85_), .O(z17));
  ...
  nand2  g101(.a(new_n178_), .b(new_n116_), .O(new_n185_));
  ...
  aoi21  g145(.a(new_n221_), .b(new_n188_), .c(x10), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n228_), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n85_), .O(z27));
  nand2  g148(.a(new_n226_), .b(x09), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n169_), .c(x40), .O(new_n233_));
  inv1   g150(.a(x39), .O(new_n234_));
  oai21  g151(.a(x14), .b(new_n188_), .c(new_n234_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n88_), .O(new_n236_));
  nor2   g153(.a(new_n236_), .b(new_n233_), .O(z28));
  inv1   g154(.a(x41), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(new_n226_), .c(x09), .O(new_n239_));
  nand2  g156(.a(new_n232_), .b(new_n84_), .O(new_n240_));
  ...
  nand3  g160(.a(new_n243_), .b(new_n226_), .c(x09), .O(new_n244_));
  nand2  g161(.a(new_n232_), .b(new_n238_), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(new_n244_), .c(new_n91_), .O(new_n246_));
  inv1   g163(.a(new_n246_), .O(z30));
  inv1   g164(.a(x43), .O(new_n248_));
  nand3  g165(.a(new_n248_), .b(new_n226_), .c(x09), .O(new_n249_));
  nand2  g166(.a(new_n232_), .b(new_n243_), .O(new_n250_));
  ...
  nand2  g171(.a(new_n232_), .b(new_n248_), .O(new_n255_));
  ...
  nand2  g176(.a(new_n232_), .b(new_n253_), .O(new_n260_));
  ...
  nand2  g181(.a(new_n232_), .b(new_n258_), .O(new_n265_));
  nand3  g182(.a(new_n265_), .b(new_n264_), .c(new_n88_), .O(new_n266_));
  nand2  g183(.a(new_n266_), .b(new_n85_), .O(z34));
  nand3  g184(.a(new_n226_), .b(x09), .c(new_n183_), .O(new_n268_));
  nand2  g185(.a(new_n232_), .b(new_n263_), .O(new_n269_));
