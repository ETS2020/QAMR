...
module FAU ( 
  ...
  nand2  g001(.a(x20), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g007(.a(x20), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand2  g041(.a(new_n121_), .b(new_n115_), .O(new_n125_));
  ...
  nand2  g048(.a(new_n126_), .b(new_n115_), .O(new_n132_));
  ...
  nand2  g056(.a(new_n136_), .b(new_n115_), .O(new_n140_));
  ...
  nand2  g063(.a(new_n141_), .b(new_n115_), .O(new_n147_));
  ...
  nand2  g081(.a(new_n161_), .b(new_n115_), .O(new_n165_));
  ...
  nand2  g086(.a(new_n166_), .b(new_n115_), .O(new_n170_));
  ...
  nand2  g091(.a(new_n171_), .b(new_n115_), .O(new_n175_));
  inv1   g092(.a(x30), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(x08), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n175_), .c(new_n91_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z18));
  nand2  g096(.a(new_n176_), .b(new_n115_), .O(new_n180_));
  ...
  nand2  g140(.a(x39), .b(new_n223_), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n222_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n218_), .b(new_n185_), .c(x10), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n225_), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(new_n85_), .O(z27));
  inv1   g145(.a(x40), .O(new_n229_));
  nand3  g146(.a(new_n229_), .b(new_n223_), .c(x09), .O(new_n230_));
  inv1   g147(.a(x39), .O(new_n231_));
  nand2  g148(.a(new_n223_), .b(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n230_), .c(new_n91_), .O(new_n234_));
  ...
  nand3  g155(.a(new_n238_), .b(new_n237_), .c(new_n88_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(new_n85_), .O(z29));
  ...
  nand2  g161(.a(new_n244_), .b(new_n85_), .O(z30));
  inv1   g162(.a(x43), .O(new_n246_));
  nand3  g163(.a(new_n246_), .b(new_n223_), .c(x09), .O(new_n247_));
  nand2  g164(.a(new_n232_), .b(new_n241_), .O(new_n248_));
  ...
  nand2  g169(.a(new_n232_), .b(new_n246_), .O(new_n253_));
  nand3  g170(.a(new_n253_), .b(new_n252_), .c(new_n91_), .O(new_n254_));
  inv1   g171(.a(new_n254_), .O(z32));
  inv1   g172(.a(x45), .O(new_n256_));
  nand3  g173(.a(new_n256_), .b(new_n223_), .c(x09), .O(new_n257_));
  nand2  g174(.a(new_n232_), .b(new_n251_), .O(new_n258_));
  ...
  nand2  g179(.a(new_n232_), .b(new_n256_), .O(new_n263_));
  ...
  nand2  g183(.a(new_n232_), .b(new_n261_), .O(new_n267_));
  nand3  g184(.a(new_n267_), .b(new_n266_), .c(new_n88_), .O(new_n268_));
  nand2  g185(.a(new_n268_), .b(new_n85_), .O(z35));
endmodule
