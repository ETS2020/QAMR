...
module FAU ( 
  ...
  oai21  g033(.a(new_n110_), .b(new_n115_), .c(new_n116_), .O(z09));
  ...
  oai21  g044(.a(new_n110_), .b(new_n126_), .c(new_n127_), .O(z13));
  ...
  oai21  g060(.a(new_n110_), .b(new_n140_), .c(new_n143_), .O(z19));
  ...
  nor2   g084(.a(x38), .b(new_n145_), .O(new_n168_));
  oai21  g085(.a(x37), .b(x09), .c(new_n87_), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n84_), .O(z26));
  ...
  oai21  g093(.a(x38), .b(x09), .c(new_n87_), .O(new_n177_));
  aoi21  g094(.a(new_n176_), .b(x09), .c(new_n177_), .O(z27));
  inv1   g095(.a(x40), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n171_), .c(x09), .O(new_n180_));
  oai21  g097(.a(x14), .b(new_n145_), .c(new_n172_), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(new_n180_), .c(new_n87_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n84_), .O(z28));
  ...
  nand2  g104(.a(new_n187_), .b(new_n84_), .O(z29));
  ...
  oai21  g127(.a(x14), .b(new_n145_), .c(new_n204_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n87_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n171_), .b(x09), .c(new_n174_), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n145_), .c(new_n209_), .O(new_n215_));
