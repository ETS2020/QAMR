...
module FAU ( 
  ...
  nand2  g001(.a(x40), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g007(.a(x40), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand2  g056(.a(new_n134_), .b(new_n116_), .O(new_n140_));
  ...
  nor2   g079(.a(x27), .b(new_n116_), .O(new_n163_));
  oai21  g080(.a(x26), .b(x08), .c(new_n88_), .O(new_n164_));
  oai21  g081(.a(new_n164_), .b(new_n163_), .c(new_n85_), .O(z15));
  inv1   g082(.a(x40), .O(new_n166_));
  aoi21  g083(.a(new_n166_), .b(new_n116_), .c(x28), .O(new_n167_));
  oai21  g084(.a(x27), .b(x08), .c(new_n88_), .O(new_n168_));
  nor2   g085(.a(new_n168_), .b(new_n167_), .O(z16));
  inv1   g086(.a(x29), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(x08), .O(new_n171_));
  nand2  g088(.a(new_n84_), .b(new_n116_), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n88_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n85_), .O(z17));
  inv1   g091(.a(x30), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(x08), .O(new_n176_));
  nand2  g093(.a(new_n170_), .b(new_n116_), .O(new_n177_));
  ...
  nand2  g098(.a(new_n175_), .b(new_n116_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n181_), .c(new_n88_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n85_), .O(z19));
  ...
  nand2  g113(.a(new_n193_), .b(new_n185_), .O(new_n197_));
  ...
  nand2  g118(.a(new_n198_), .b(new_n185_), .O(new_n202_));
  ...
  nand3  g145(.a(new_n166_), .b(new_n223_), .c(x09), .O(new_n229_));
  inv1   g146(.a(x39), .O(new_n230_));
  nand2  g147(.a(new_n223_), .b(x09), .O(new_n231_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n223_), .c(x09), .O(new_n236_));
  nand2  g153(.a(new_n231_), .b(new_n166_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n236_), .c(new_n88_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n85_), .O(z29));
  ...
  nand3  g181(.a(new_n223_), .b(x09), .c(new_n180_), .O(new_n265_));
