...
module FAU ( 
  ...
  aoi21  g001(.a(x37), .b(new_n84_), .c(x10), .O(new_n85_));
  ...
  nand2  g009(.a(x37), .b(new_n84_), .O(new_n93_));
  ...
  nand3  g044(.a(new_n127_), .b(new_n126_), .c(new_n95_), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(new_n93_), .O(z08));
  ...
  nand3  g054(.a(new_n137_), .b(new_n136_), .c(new_n95_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n93_), .O(z10));
  nand2  g056(.a(new_n135_), .b(new_n115_), .O(new_n140_));
  ...
  nand2  g061(.a(new_n141_), .b(new_n115_), .O(new_n145_));
  ...
  nand2  g066(.a(new_n146_), .b(new_n115_), .O(new_n150_));
  ...
  nand2  g073(.a(new_n151_), .b(new_n115_), .O(new_n157_));
  ...
  nand2  g081(.a(new_n160_), .b(new_n115_), .O(new_n165_));
  ...
  nand2  g091(.a(new_n84_), .b(x08), .O(new_n175_));
  ...
  nand2  g097(.a(new_n84_), .b(new_n115_), .O(new_n181_));
  ...
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(new_n95_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n93_), .O(z21));
  inv1   g112(.a(x34), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(x09), .O(new_n197_));
  nand2  g114(.a(new_n191_), .b(new_n184_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n197_), .c(new_n95_), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n93_), .O(z22));
  ...
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n95_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n93_), .O(z26));
  nand2  g137(.a(x14), .b(x00), .O(new_n221_));
  nand2  g138(.a(x39), .b(new_n101_), .O(new_n222_));
  ...
  nand2  g159(.a(new_n242_), .b(new_n93_), .O(z30));
  ...
  nand3  g163(.a(new_n246_), .b(new_n245_), .c(new_n95_), .O(new_n247_));
  nand2  g164(.a(new_n247_), .b(new_n93_), .O(z31));
  ...
  nand3  g168(.a(new_n251_), .b(new_n250_), .c(new_n85_), .O(new_n252_));
  ...
  nand2  g179(.a(new_n262_), .b(new_n93_), .O(z34));
  nand3  g180(.a(new_n101_), .b(x09), .c(new_n179_), .O(new_n264_));
