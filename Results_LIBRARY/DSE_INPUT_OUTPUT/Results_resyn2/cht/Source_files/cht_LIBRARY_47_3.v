...
module FAU ( 
  ...
  oai21  g036(.a(new_n108_), .b(new_n118_), .c(new_n119_), .O(z10));
  ...
  oai21  g100(.a(x38), .b(x09), .c(new_n87_), .O(new_n184_));
  ...
  oai21  g104(.a(x14), .b(new_n152_), .c(new_n180_), .O(new_n188_));
  ...
  oai21  g109(.a(x14), .b(new_n152_), .c(new_n186_), .O(new_n193_));
  ...
  oai21  g114(.a(x14), .b(new_n152_), .c(new_n191_), .O(new_n198_));
  ...
  oai21  g119(.a(x14), .b(new_n152_), .c(new_n196_), .O(new_n203_));
  ...
  oai21  g124(.a(x14), .b(new_n152_), .c(new_n201_), .O(new_n208_));
