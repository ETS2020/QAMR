...
module FAU ( 
  ...
  nor2   g071(.a(x26), .b(x08), .O(new_n155_));
  aoi21  g072(.a(new_n155_), .b(x27), .c(x10), .O(z15));
  nor2   g073(.a(x28), .b(new_n118_), .O(new_n157_));
  nor3   g074(.a(new_n157_), .b(new_n86_), .c(x10), .O(z16));
  nand2  g075(.a(x29), .b(x08), .O(new_n159_));
  aoi21  g076(.a(x28), .b(new_n118_), .c(new_n86_), .O(new_n160_));
  ...
  aoi21  g109(.a(x35), .b(new_n175_), .c(new_n86_), .O(new_n193_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n204_), .O(new_n214_));
  ...
  nand3  g139(.a(new_n222_), .b(new_n104_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n213_), .b(new_n217_), .O(new_n224_));
  ...
  nand2  g145(.a(new_n213_), .b(new_n222_), .O(new_n229_));
  ...
  nand2  g150(.a(new_n213_), .b(new_n227_), .O(new_n234_));
  ...
  aoi21  g155(.a(new_n213_), .b(x44), .c(new_n86_), .O(new_n239_));
  ...
  nand2  g160(.a(new_n213_), .b(new_n243_), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n242_), .c(new_n87_), .O(new_n245_));
  inv1   g162(.a(new_n245_), .O(z34));
  nand2  g163(.a(new_n237_), .b(x00), .O(new_n247_));
  aoi21  g164(.a(new_n213_), .b(x46), .c(new_n86_), .O(new_n248_));
