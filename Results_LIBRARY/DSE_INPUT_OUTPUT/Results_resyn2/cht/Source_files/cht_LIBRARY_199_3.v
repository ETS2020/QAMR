...
module FAU ( 
  ...
  nand2  g071(.a(new_n154_), .b(new_n89_), .O(z19));
  ...
  oai21  g078(.a(new_n161_), .b(new_n160_), .c(new_n89_), .O(z21));
  ...
  nand2  g094(.a(new_n177_), .b(new_n89_), .O(z25));
  ...
  nand2  g106(.a(new_n189_), .b(new_n89_), .O(z27));
  ...
  nand2  g147(.a(new_n230_), .b(new_n89_), .O(z35));
endmodule
