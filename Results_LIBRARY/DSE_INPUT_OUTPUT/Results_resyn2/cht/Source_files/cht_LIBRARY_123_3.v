...
module FAU ( 
  ...
  oai21  g045(.a(new_n128_), .b(new_n127_), .c(new_n84_), .O(z13));
  ...
  aoi21  g066(.a(new_n148_), .b(x09), .c(new_n149_), .O(z20));
  inv1   g067(.a(x33), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(x09), .O(new_n152_));
  inv1   g069(.a(x09), .O(new_n153_));
  nand2  g070(.a(new_n148_), .b(new_n153_), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n152_), .c(new_n87_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n84_), .O(z21));
  inv1   g073(.a(x34), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(x09), .O(new_n158_));
  nand2  g075(.a(new_n151_), .b(new_n153_), .O(new_n159_));
  nand3  g076(.a(new_n159_), .b(new_n158_), .c(new_n87_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n84_), .O(z22));
  inv1   g078(.a(x35), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(x09), .O(new_n163_));
  nand2  g080(.a(new_n157_), .b(new_n153_), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n87_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n84_), .O(z23));
  inv1   g083(.a(x36), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(x09), .O(new_n168_));
  nand2  g085(.a(new_n162_), .b(new_n153_), .O(new_n169_));
  nand3  g086(.a(new_n169_), .b(new_n168_), .c(new_n87_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n84_), .O(z24));
  nor2   g088(.a(x37), .b(new_n153_), .O(new_n172_));
  oai21  g089(.a(x36), .b(x09), .c(new_n87_), .O(new_n173_));
  oai21  g090(.a(new_n173_), .b(new_n172_), .c(new_n84_), .O(z25));
  nor2   g091(.a(x38), .b(new_n153_), .O(new_n175_));
  oai21  g092(.a(x37), .b(x09), .c(new_n87_), .O(new_n176_));
  nor2   g093(.a(new_n176_), .b(new_n175_), .O(z26));
  inv1   g094(.a(x14), .O(new_n178_));
  inv1   g095(.a(x39), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g097(.a(x14), .b(new_n145_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g099(.a(x38), .b(x09), .c(new_n87_), .O(new_n183_));
  ...
  oai21  g103(.a(x14), .b(new_n153_), .c(new_n179_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n87_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n84_), .O(z28));
  inv1   g106(.a(x41), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n178_), .c(x09), .O(new_n191_));
  oai21  g108(.a(x14), .b(new_n153_), .c(new_n185_), .O(new_n192_));
  ...
  oai21  g113(.a(x14), .b(new_n153_), .c(new_n190_), .O(new_n197_));
  ...
  oai21  g133(.a(x14), .b(new_n153_), .c(new_n210_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n216_), .c(new_n87_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n84_), .O(z34));
  nand3  g136(.a(new_n178_), .b(x09), .c(new_n145_), .O(new_n220_));
  oai21  g137(.a(x14), .b(new_n153_), .c(new_n215_), .O(new_n221_));
  nand3  g138(.a(new_n221_), .b(new_n220_), .c(new_n87_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n84_), .O(z35));
endmodule
