...
module FAU ( 
  ...
  nand2  g075(.a(new_n154_), .b(new_n150_), .O(new_n159_));
  nand3  g076(.a(new_n159_), .b(new_n158_), .c(new_n87_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n84_), .O(z22));
  nand2  g078(.a(new_n87_), .b(new_n150_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(x35), .O(new_n163_));
  oai21  g080(.a(new_n162_), .b(new_n157_), .c(new_n163_), .O(z23));
  inv1   g081(.a(x35), .O(new_n165_));
  nor2   g082(.a(x10), .b(new_n150_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(x36), .O(new_n167_));
  oai21  g084(.a(new_n166_), .b(new_n165_), .c(new_n167_), .O(z24));
  ...
  nand2  g090(.a(new_n169_), .b(new_n150_), .O(new_n174_));
  nand3  g091(.a(new_n174_), .b(new_n173_), .c(new_n87_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n84_), .O(z26));
  ...
  aoi21  g097(.a(new_n172_), .b(new_n150_), .c(x10), .O(new_n181_));
  ...
  nand3  g137(.a(new_n178_), .b(x09), .c(new_n147_), .O(new_n221_));
