...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x10), .O(new_n92_));
  ...
  nand2  g066(.a(new_n86_), .b(new_n149_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(x32), .O(new_n151_));
  oai21  g068(.a(new_n150_), .b(new_n148_), .c(new_n151_), .O(z20));
  ...
  nand2  g079(.a(new_n162_), .b(new_n92_), .O(z23));
  nor2   g080(.a(x36), .b(new_n149_), .O(new_n164_));
  oai21  g081(.a(x35), .b(x09), .c(new_n86_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n92_), .O(z24));
  ...
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n92_), .O(z26));
  ...
  nand2  g100(.a(new_n183_), .b(new_n92_), .O(z28));
  ...
  nand2  g130(.a(new_n213_), .b(new_n92_), .O(z34));
  ...
  nand2  g134(.a(new_n217_), .b(new_n92_), .O(z35));
endmodule
