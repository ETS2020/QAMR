...
module FAU ( 
  ...
  oai21  g039(.a(new_n122_), .b(new_n121_), .c(new_n89_), .O(z11));
  ...
  nand2  g056(.a(new_n139_), .b(new_n89_), .O(z16));
  nor2   g057(.a(x29), .b(new_n105_), .O(new_n141_));
  oai21  g058(.a(x28), .b(x08), .c(new_n86_), .O(new_n142_));
  oai21  g059(.a(new_n142_), .b(new_n141_), .c(new_n89_), .O(z17));
  ...
  oai21  g069(.a(new_n152_), .b(new_n151_), .c(new_n89_), .O(z20));
  ...
  nand2  g082(.a(new_n165_), .b(new_n89_), .O(z23));
