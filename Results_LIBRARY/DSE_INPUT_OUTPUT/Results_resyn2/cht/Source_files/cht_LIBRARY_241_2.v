...
module FAU ( 
  ...
  aoi21  g055(.a(new_n138_), .b(new_n113_), .c(x10), .O(z18));
  ...
  aoi21  g084(.a(x37), .b(new_n143_), .c(x08), .O(new_n168_));
  ...
  aoi21  g092(.a(x38), .b(new_n143_), .c(x08), .O(new_n176_));
  ...
  nand2  g102(.a(new_n178_), .b(x42), .O(new_n186_));
  aoi21  g103(.a(new_n180_), .b(x41), .c(x08), .O(new_n187_));
  ...
  nand2  g108(.a(new_n180_), .b(new_n191_), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n190_), .c(new_n86_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z31));
  nand2  g111(.a(new_n178_), .b(x44), .O(new_n195_));
  aoi21  g112(.a(new_n180_), .b(x43), .c(x08), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z32));
  nand2  g114(.a(new_n178_), .b(x45), .O(new_n198_));
  aoi21  g115(.a(new_n180_), .b(x44), .c(x08), .O(new_n199_));
  ...
  nand2  g120(.a(new_n180_), .b(new_n203_), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n202_), .c(new_n86_), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(z34));
  nand2  g123(.a(new_n178_), .b(x00), .O(new_n207_));
  aoi21  g124(.a(new_n180_), .b(x46), .c(x08), .O(new_n208_));
