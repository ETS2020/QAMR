...
module FAU ( 
  ...
  aoi21  g040(.a(new_n123_), .b(new_n122_), .c(x10), .O(z06));
  inv1   g041(.a(x18), .O(new_n125_));
  aoi21  g042(.a(new_n125_), .b(new_n122_), .c(x10), .O(z07));
  nand2  g043(.a(new_n86_), .b(x19), .O(new_n127_));
  inv1   g044(.a(new_n127_), .O(z08));
  nand2  g045(.a(new_n86_), .b(x20), .O(new_n129_));
  inv1   g046(.a(new_n129_), .O(z09));
  inv1   g047(.a(x21), .O(new_n131_));
  aoi21  g048(.a(new_n131_), .b(new_n122_), .c(x10), .O(z10));
  nand2  g049(.a(new_n86_), .b(x22), .O(new_n133_));
  inv1   g050(.a(new_n133_), .O(z11));
  inv1   g051(.a(x23), .O(new_n135_));
  aoi21  g052(.a(new_n135_), .b(new_n122_), .c(x10), .O(z12));
  nand2  g053(.a(new_n86_), .b(x24), .O(new_n137_));
  inv1   g054(.a(new_n137_), .O(z13));
  nand2  g055(.a(new_n86_), .b(x25), .O(new_n139_));
  inv1   g056(.a(new_n139_), .O(z14));
  inv1   g057(.a(x26), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(new_n122_), .c(x10), .O(z15));
  nand2  g059(.a(new_n86_), .b(x27), .O(new_n143_));
  inv1   g060(.a(new_n143_), .O(z16));
  nand2  g061(.a(new_n86_), .b(x28), .O(new_n145_));
  inv1   g062(.a(new_n145_), .O(z17));
  nand2  g063(.a(new_n86_), .b(x29), .O(new_n147_));
  inv1   g064(.a(new_n147_), .O(z18));
  nand2  g065(.a(new_n86_), .b(x30), .O(new_n149_));
  inv1   g066(.a(new_n149_), .O(z19));
  nand2  g067(.a(x32), .b(x09), .O(new_n151_));
  inv1   g068(.a(x09), .O(new_n152_));
  aoi21  g069(.a(x31), .b(new_n152_), .c(x08), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(new_n151_), .c(x10), .O(z20));
  nand2  g071(.a(x33), .b(x09), .O(new_n155_));
  aoi21  g072(.a(x32), .b(new_n152_), .c(x08), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z21));
  nand2  g074(.a(x34), .b(x09), .O(new_n158_));
  aoi21  g075(.a(x33), .b(new_n152_), .c(x08), .O(new_n159_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n106_), .c(x09), .O(new_n201_));
  inv1   g118(.a(x43), .O(new_n202_));
  nand2  g119(.a(new_n183_), .b(new_n202_), .O(new_n203_));
  ...
  nand2  g124(.a(new_n183_), .b(new_n200_), .O(new_n208_));
  ...
  nand2  g132(.a(new_n181_), .b(x00), .O(new_n216_));
  aoi21  g133(.a(new_n183_), .b(x46), .c(x08), .O(new_n217_));
