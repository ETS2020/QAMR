...
module FAU ( 
  ...
  nand2  g035(.a(new_n94_), .b(x19), .O(new_n119_));
  ...
  nand2  g053(.a(new_n94_), .b(x28), .O(new_n137_));
  inv1   g054(.a(new_n137_), .O(z16));
  nand2  g055(.a(new_n94_), .b(x29), .O(new_n139_));
  ...
  aoi21  g092(.a(x38), .b(new_n146_), .c(new_n86_), .O(new_n176_));
  ...
  nand3  g098(.a(new_n181_), .b(new_n179_), .c(new_n94_), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z28));
  nor2   g100(.a(x14), .b(new_n146_), .O(new_n184_));
  ...
  nand2  g120(.a(new_n184_), .b(x45), .O(new_n204_));
  aoi21  g121(.a(new_n180_), .b(x44), .c(new_n86_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z33));
  inv1   g123(.a(x46), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n101_), .c(x09), .O(new_n208_));
  ...
  nand2  g130(.a(new_n180_), .b(new_n207_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n94_), .O(new_n215_));
