...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n90_, new_n91_,
    ...
    new_n108_, new_n110_, new_n111_, new_n113_, new_n115_, new_n117_,
  ...
  aoi21  g024(.a(x15), .b(new_n85_), .c(x08), .O(new_n108_));
  ...
  nand2  g031(.a(new_n90_), .b(x18), .O(new_n115_));
  inv1   g032(.a(new_n115_), .O(z07));
  nand2  g033(.a(new_n90_), .b(x19), .O(new_n117_));
  inv1   g034(.a(new_n117_), .O(z08));
  nand2  g035(.a(new_n90_), .b(x20), .O(new_n119_));
  inv1   g036(.a(new_n119_), .O(z09));
  nand2  g037(.a(new_n90_), .b(x21), .O(new_n121_));
  inv1   g038(.a(new_n121_), .O(z10));
  nand2  g039(.a(new_n90_), .b(x22), .O(new_n123_));
  inv1   g040(.a(new_n123_), .O(z11));
  inv1   g041(.a(x08), .O(new_n125_));
  inv1   g042(.a(x23), .O(new_n126_));
  aoi21  g043(.a(new_n126_), .b(new_n125_), .c(x10), .O(z12));
  nand2  g044(.a(new_n90_), .b(x24), .O(new_n128_));
  inv1   g045(.a(new_n128_), .O(z13));
  inv1   g046(.a(x25), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n125_), .c(x10), .O(z14));
  inv1   g048(.a(x26), .O(new_n132_));
  aoi21  g049(.a(new_n132_), .b(new_n125_), .c(x10), .O(z15));
  ...
  aoi21  g057(.a(new_n140_), .b(new_n125_), .c(x10), .O(z19));
  ...
  nand3  g084(.a(new_n167_), .b(new_n165_), .c(new_n90_), .O(new_n168_));
  inv1   g085(.a(new_n168_), .O(z26));
  inv1   g086(.a(x00), .O(new_n170_));
  nand2  g087(.a(x14), .b(new_n170_), .O(new_n171_));
  inv1   g088(.a(x39), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n103_), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n171_), .c(x09), .O(new_n174_));
  aoi21  g091(.a(x38), .b(new_n143_), .c(x08), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z27));
  inv1   g093(.a(x40), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n103_), .c(x09), .O(new_n178_));
  nand2  g095(.a(new_n103_), .b(x09), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n172_), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n178_), .c(new_n90_), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z28));
  nor2   g099(.a(x14), .b(new_n143_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(x41), .O(new_n184_));
  aoi21  g101(.a(new_n179_), .b(x40), .c(x08), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z29));
  nand2  g103(.a(new_n183_), .b(x42), .O(new_n187_));
  aoi21  g104(.a(new_n179_), .b(x41), .c(x08), .O(new_n188_));
  ...
  nand2  g109(.a(new_n179_), .b(new_n192_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n191_), .c(new_n90_), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z31));
  inv1   g112(.a(x44), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n103_), .c(x09), .O(new_n197_));
  nand2  g114(.a(new_n179_), .b(new_n190_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n197_), .c(new_n90_), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  nand2  g117(.a(new_n183_), .b(x45), .O(new_n201_));
  aoi21  g118(.a(new_n179_), .b(x44), .c(x08), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z33));
  inv1   g120(.a(x46), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n103_), .c(x09), .O(new_n205_));
  inv1   g122(.a(x45), .O(new_n206_));
  nand2  g123(.a(new_n179_), .b(new_n206_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n205_), .c(new_n90_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z34));
  nand2  g126(.a(new_n183_), .b(x00), .O(new_n210_));
  aoi21  g127(.a(new_n179_), .b(x46), .c(x08), .O(new_n211_));
