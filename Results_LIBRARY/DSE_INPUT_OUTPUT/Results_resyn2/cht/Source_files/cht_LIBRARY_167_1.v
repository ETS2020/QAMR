...
module FAU ( 
  ...
  nand2  g086(.a(new_n169_), .b(new_n118_), .O(new_n170_));
  ...
  nand2  g121(.a(new_n198_), .b(new_n174_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(new_n90_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z26));
  nand2  g124(.a(x14), .b(new_n167_), .O(new_n208_));
  inv1   g125(.a(x39), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n100_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n208_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(x38), .b(new_n174_), .c(x21), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z27));
  inv1   g130(.a(x40), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n100_), .c(x09), .O(new_n215_));
  nand2  g132(.a(new_n100_), .b(x09), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n209_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n215_), .c(new_n90_), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(z28));
  inv1   g136(.a(x41), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(new_n100_), .c(x09), .O(new_n221_));
  nand2  g138(.a(new_n216_), .b(new_n214_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(new_n90_), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(z29));
  nor2   g141(.a(x14), .b(new_n174_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(x42), .O(new_n226_));
  aoi21  g143(.a(new_n216_), .b(x41), .c(x21), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z30));
  nand2  g145(.a(new_n225_), .b(x43), .O(new_n229_));
  aoi21  g146(.a(new_n216_), .b(x42), .c(x21), .O(new_n230_));
