...
module FAU ( 
  ...
  nand2  g045(.a(new_n128_), .b(new_n85_), .O(z11));
  ...
  nand2  g079(.a(new_n84_), .b(x09), .O(new_n163_));
  nand2  g080(.a(new_n160_), .b(new_n156_), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n88_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n85_), .O(z22));
  ...
  nand2  g090(.a(new_n173_), .b(new_n85_), .O(z24));
  nor2   g091(.a(x37), .b(new_n156_), .O(new_n175_));
  oai21  g092(.a(x36), .b(x09), .c(new_n88_), .O(new_n176_));
  oai21  g093(.a(new_n176_), .b(new_n175_), .c(new_n85_), .O(z25));
  ...
  aoi21  g101(.a(new_n178_), .b(new_n156_), .c(x10), .O(new_n185_));
  ...
  nand2  g135(.a(new_n218_), .b(new_n85_), .O(z33));
  ...
  nand3  g141(.a(new_n182_), .b(x09), .c(new_n153_), .O(new_n225_));
