...
module FAU ( 
  ...
  nand2  g000(.a(x39), .b(x10), .O(new_n84_));
  ...
  oai21  g057(.a(new_n140_), .b(new_n139_), .c(new_n84_), .O(z17));
  ...
  nand2  g080(.a(new_n157_), .b(new_n150_), .O(new_n164_));
  ...
  nand2  g085(.a(new_n162_), .b(new_n150_), .O(new_n169_));
  ...
  nand3  g098(.a(x14), .b(new_n87_), .c(x00), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(x09), .O(new_n184_));
  nor2   g101(.a(x10), .b(x09), .O(new_n185_));
  aoi22  g102(.a(new_n185_), .b(x38), .c(x39), .d(x10), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n184_), .O(z27));
  inv1   g104(.a(x40), .O(new_n188_));
  nand3  g105(.a(new_n180_), .b(new_n87_), .c(x09), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(x39), .O(new_n190_));
  oai21  g107(.a(new_n189_), .b(new_n188_), .c(new_n190_), .O(z28));
  ...
  nand2  g116(.a(new_n194_), .b(new_n192_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n199_), .c(new_n87_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n84_), .O(z30));
  ...
  nand2  g138(.a(new_n221_), .b(new_n84_), .O(z34));
  nand3  g139(.a(new_n180_), .b(x09), .c(new_n145_), .O(new_n223_));
  nand2  g140(.a(new_n194_), .b(new_n218_), .O(new_n224_));
