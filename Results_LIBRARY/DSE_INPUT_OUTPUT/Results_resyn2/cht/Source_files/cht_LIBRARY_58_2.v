...
module FAU ( 
  ...
  aoi21  g069(.a(x33), .b(new_n143_), .c(x08), .O(new_n153_));
  ...
  aoi21  g093(.a(x38), .b(new_n143_), .c(x08), .O(new_n177_));
  ...
  nor2   g101(.a(x14), .b(new_n143_), .O(new_n185_));
  ...
  nand3  g122(.a(new_n205_), .b(new_n100_), .c(x09), .O(new_n206_));
  nand2  g123(.a(new_n181_), .b(new_n200_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n90_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z33));
  nand2  g126(.a(new_n185_), .b(x46), .O(new_n210_));
  aoi21  g127(.a(new_n181_), .b(x45), .c(x08), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z34));
  nand3  g129(.a(new_n100_), .b(x09), .c(new_n172_), .O(new_n213_));
  inv1   g130(.a(x46), .O(new_n214_));
  nand2  g131(.a(new_n181_), .b(new_n214_), .O(new_n215_));
