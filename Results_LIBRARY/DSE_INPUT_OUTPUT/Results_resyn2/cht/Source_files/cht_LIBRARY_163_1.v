...
module FAU ( 
  ...
  nand2  g065(.a(new_n148_), .b(new_n90_), .O(z18));
  nor2   g066(.a(new_n106_), .b(x00), .O(new_n150_));
  oai21  g067(.a(x30), .b(x08), .c(new_n86_), .O(new_n151_));
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n90_), .O(z19));
  nor2   g069(.a(x32), .b(new_n89_), .O(new_n153_));
  ...
  aoi21  g075(.a(x34), .b(new_n86_), .c(new_n89_), .O(new_n159_));
  nor3   g076(.a(x33), .b(x10), .c(x09), .O(new_n160_));
  ...
  nor2   g084(.a(x37), .b(new_n89_), .O(new_n168_));
  ...
  aoi21  g092(.a(x39), .b(new_n175_), .c(new_n89_), .O(new_n176_));
  ...
  oai21  g098(.a(x14), .b(new_n89_), .c(new_n181_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n180_), .c(new_n86_), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z28));
  nand2  g101(.a(new_n175_), .b(x09), .O(new_n185_));
  oai21  g102(.a(x41), .b(x14), .c(new_n86_), .O(new_n186_));
  nor2   g103(.a(x40), .b(x10), .O(new_n187_));
  aoi22  g104(.a(new_n187_), .b(new_n185_), .c(new_n186_), .d(x09), .O(z29));
  oai21  g105(.a(x42), .b(x14), .c(new_n86_), .O(new_n189_));
  nor2   g106(.a(x41), .b(x10), .O(new_n190_));
  aoi22  g107(.a(new_n190_), .b(new_n185_), .c(new_n189_), .d(x09), .O(z30));
  inv1   g108(.a(x43), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n175_), .c(x09), .O(new_n193_));
  inv1   g110(.a(x42), .O(new_n194_));
  oai21  g111(.a(x14), .b(new_n89_), .c(new_n194_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n193_), .c(new_n86_), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z31));
  oai21  g114(.a(x44), .b(x14), .c(new_n86_), .O(new_n198_));
  nor2   g115(.a(x43), .b(x10), .O(new_n199_));
  aoi22  g116(.a(new_n199_), .b(new_n185_), .c(new_n198_), .d(x09), .O(z32));
  inv1   g117(.a(x45), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n175_), .c(x09), .O(new_n202_));
  inv1   g119(.a(x44), .O(new_n203_));
  oai21  g120(.a(x14), .b(new_n89_), .c(new_n203_), .O(new_n204_));
  ...
  oai21  g125(.a(x14), .b(new_n89_), .c(new_n201_), .O(new_n209_));
  ...
  aoi22  g130(.a(new_n213_), .b(new_n185_), .c(new_n212_), .d(x09), .O(z35));
endmodule
