...
module FAU ( 
  ...
  aoi21  g037(.a(new_n120_), .b(new_n117_), .c(x10), .O(z09));
  ...
  nand2  g046(.a(new_n90_), .b(x25), .O(new_n130_));
  ...
  aoi21  g057(.a(new_n140_), .b(new_n117_), .c(x10), .O(z19));
  ...
  aoi21  g083(.a(x36), .b(new_n143_), .c(x08), .O(new_n167_));
  ...
  oai21  g091(.a(x38), .b(x09), .c(new_n90_), .O(new_n175_));
  ...
  nand2  g099(.a(new_n177_), .b(x41), .O(new_n183_));
