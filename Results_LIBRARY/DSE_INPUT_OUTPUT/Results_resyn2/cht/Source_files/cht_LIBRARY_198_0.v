...
module FAU ( 
  ...
  aoi21  g094(.a(x37), .b(new_n147_), .c(new_n86_), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z26));
  inv1   g096(.a(x39), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n101_), .O(new_n181_));
  oai21  g098(.a(new_n101_), .b(x00), .c(new_n181_), .O(new_n182_));
  inv1   g099(.a(x38), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n147_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n87_), .O(new_n185_));
  aoi21  g102(.a(new_n182_), .b(x09), .c(new_n185_), .O(z27));
  nor2   g103(.a(x14), .b(new_n147_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(x40), .O(new_n188_));
  nand2  g105(.a(new_n101_), .b(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(x39), .c(new_n86_), .O(new_n190_));
  ...
  aoi21  g130(.a(new_n189_), .b(x44), .c(new_n86_), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z33));
  nand2  g132(.a(new_n187_), .b(x46), .O(new_n216_));
  aoi21  g133(.a(new_n189_), .b(x45), .c(new_n86_), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  nand2  g135(.a(new_n187_), .b(x00), .O(new_n219_));
  aoi21  g136(.a(new_n189_), .b(x46), .c(new_n86_), .O(new_n220_));
