...
module FAU ( 
  ...
  nand2  g076(.a(new_n159_), .b(new_n96_), .O(z21));
  ...
  nor2   g080(.a(x35), .b(new_n151_), .O(new_n164_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n96_), .O(z30));
  ...
  nand2  g132(.a(new_n215_), .b(new_n96_), .O(z33));
