...
module FAU ( 
  ...
  nand2  g048(.a(new_n127_), .b(new_n108_), .O(new_n132_));
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(new_n86_), .O(new_n133_));
  nand2  g050(.a(new_n133_), .b(new_n89_), .O(z14));
  nand2  g051(.a(new_n86_), .b(new_n108_), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(x27), .O(new_n136_));
  oai21  g053(.a(new_n135_), .b(new_n130_), .c(new_n136_), .O(z15));
  oai21  g054(.a(x10), .b(new_n108_), .c(x27), .O(new_n138_));
  nand3  g055(.a(x28), .b(new_n86_), .c(x08), .O(new_n139_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n108_), .O(new_n144_));
  nand3  g061(.a(new_n144_), .b(new_n142_), .c(new_n86_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n89_), .O(z17));
  nor2   g063(.a(x30), .b(new_n108_), .O(new_n147_));
  oai21  g064(.a(x29), .b(x08), .c(new_n86_), .O(new_n148_));
  oai21  g065(.a(new_n148_), .b(new_n147_), .c(new_n89_), .O(z18));
  ...
  nand3  g074(.a(new_n157_), .b(new_n154_), .c(new_n86_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n89_), .O(z20));
  ...
  oai21  g109(.a(x14), .b(new_n155_), .c(new_n185_), .O(new_n193_));
  ...
  oai21  g139(.a(x14), .b(new_n155_), .c(new_n216_), .O(new_n223_));
  ...
  oai21  g143(.a(x14), .b(new_n155_), .c(new_n221_), .O(new_n227_));
