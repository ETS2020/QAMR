...
module FAU ( 
  ...
  aoi21  g007(.a(x45), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand3  g067(.a(new_n150_), .b(new_n148_), .c(new_n91_), .O(new_n151_));
  ...
  nand2  g076(.a(new_n153_), .b(new_n118_), .O(new_n160_));
  ...
  nand2  g089(.a(new_n168_), .b(new_n118_), .O(new_n173_));
  ...
  nand2  g096(.a(new_n174_), .b(new_n118_), .O(new_n180_));
  ...
  aoi21  g144(.a(new_n219_), .b(new_n190_), .c(x10), .O(new_n228_));
