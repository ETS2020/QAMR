...
module FAU ( 
  ...
  aoi21  g111(.a(new_n194_), .b(x09), .c(x32), .O(new_n195_));
  oai21  g112(.a(x33), .b(new_n189_), .c(new_n95_), .O(new_n196_));
  nor2   g113(.a(new_n196_), .b(new_n195_), .O(z21));
  ...
  nand2  g122(.a(new_n198_), .b(new_n189_), .O(new_n206_));
  ...
  nand2  g127(.a(new_n204_), .b(new_n189_), .O(new_n211_));
  ...
  nand2  g141(.a(x39), .b(new_n104_), .O(new_n225_));
  ...
  nand3  g163(.a(new_n194_), .b(new_n104_), .c(x09), .O(new_n247_));
  nand2  g164(.a(new_n233_), .b(new_n242_), .O(new_n248_));
  ...
  nand2  g169(.a(new_n233_), .b(new_n194_), .O(new_n253_));
  nand3  g170(.a(new_n253_), .b(new_n252_), .c(new_n95_), .O(new_n254_));
  nand2  g171(.a(new_n254_), .b(new_n93_), .O(z32));
  inv1   g172(.a(x45), .O(new_n256_));
  nand3  g173(.a(new_n256_), .b(new_n104_), .c(x09), .O(new_n257_));
  nand2  g174(.a(new_n233_), .b(new_n251_), .O(new_n258_));
  ...
  nand2  g179(.a(new_n233_), .b(new_n256_), .O(new_n263_));
  nand3  g180(.a(new_n263_), .b(new_n262_), .c(new_n95_), .O(new_n264_));
  nand2  g181(.a(new_n264_), .b(new_n93_), .O(z34));
  nand3  g182(.a(new_n104_), .b(x09), .c(new_n183_), .O(new_n266_));
  nand2  g183(.a(new_n233_), .b(new_n261_), .O(new_n267_));
  nand3  g184(.a(new_n267_), .b(new_n266_), .c(new_n95_), .O(new_n268_));
  nand2  g185(.a(new_n268_), .b(new_n93_), .O(z35));
endmodule
