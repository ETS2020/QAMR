...
module FAU ( 
  ...
  aoi21  g007(.a(new_n84_), .b(x11), .c(x10), .O(new_n91_));
  ...
  nand2  g044(.a(new_n84_), .b(x08), .O(new_n128_));
  nand2  g045(.a(new_n124_), .b(new_n116_), .O(new_n129_));
  ...
  nand2  g050(.a(new_n84_), .b(new_n116_), .O(new_n134_));
  ...
  nand2  g093(.a(new_n173_), .b(new_n116_), .O(new_n177_));
  ...
  nand2  g141(.a(x39), .b(new_n101_), .O(new_n225_));
  ...
  nand2  g162(.a(new_n245_), .b(new_n85_), .O(z30));
  ...
  nand3  g166(.a(new_n249_), .b(new_n248_), .c(new_n91_), .O(new_n250_));
  ...
  nand2  g172(.a(new_n255_), .b(new_n85_), .O(z32));
  ...
  nand3  g179(.a(new_n262_), .b(new_n101_), .c(x09), .O(new_n263_));
  ...
  nand3  g183(.a(new_n101_), .b(x09), .c(new_n183_), .O(new_n267_));
  nand2  g184(.a(new_n233_), .b(new_n262_), .O(new_n268_));
  nand3  g185(.a(new_n268_), .b(new_n267_), .c(new_n91_), .O(new_n269_));
