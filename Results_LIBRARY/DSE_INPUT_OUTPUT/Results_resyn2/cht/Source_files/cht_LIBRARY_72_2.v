...
module FAU ( 
  ...
  nand2  g061(.a(new_n144_), .b(new_n90_), .O(z15));
  ...
  nand2  g066(.a(new_n149_), .b(new_n90_), .O(z16));
  nor2   g067(.a(x29), .b(new_n106_), .O(new_n151_));
  oai21  g068(.a(x28), .b(x08), .c(new_n86_), .O(new_n152_));
  oai21  g069(.a(new_n152_), .b(new_n151_), .c(new_n90_), .O(z17));
  nor2   g070(.a(x30), .b(new_n106_), .O(new_n154_));
  oai21  g071(.a(x29), .b(x08), .c(new_n86_), .O(new_n155_));
  nor2   g072(.a(new_n155_), .b(new_n154_), .O(z18));
  ...
  aoi21  g104(.a(new_n181_), .b(new_n165_), .c(x10), .O(new_n188_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n90_), .O(z34));
  nand3  g144(.a(new_n185_), .b(x09), .c(new_n157_), .O(new_n228_));
