...
module FAU ( 
  ...
  oai21  g109(.a(x14), .b(new_n151_), .c(new_n185_), .O(new_n193_));
  ...
  oai21  g134(.a(x14), .b(new_n151_), .c(new_n211_), .O(new_n218_));
  ...
  oai21  g139(.a(x14), .b(new_n151_), .c(new_n216_), .O(new_n223_));
  ...
  oai21  g143(.a(x14), .b(new_n151_), .c(new_n221_), .O(new_n227_));
