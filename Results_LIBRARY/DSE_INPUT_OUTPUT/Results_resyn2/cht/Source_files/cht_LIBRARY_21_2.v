...
module FAU ( 
  ...
  aoi21  g001(.a(new_n84_), .b(x13), .c(x10), .O(new_n85_));
  ...
  nand2  g015(.a(new_n84_), .b(x13), .O(new_n99_));
  ...
  inv1   g035(.a(x13), .O(new_n119_));
  aoi21  g036(.a(new_n119_), .b(x08), .c(x17), .O(new_n120_));
  inv1   g037(.a(x08), .O(new_n121_));
  oai21  g038(.a(x18), .b(new_n121_), .c(new_n101_), .O(new_n122_));
  ...
  nand3  g049(.a(new_n132_), .b(new_n130_), .c(new_n85_), .O(new_n133_));
  ...
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(new_n101_), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(new_n99_), .O(z11));
  ...
  nand3  g074(.a(new_n157_), .b(new_n156_), .c(new_n101_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n99_), .O(z13));
  inv1   g076(.a(x26), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x08), .O(new_n161_));
  nand2  g078(.a(new_n155_), .b(new_n121_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n101_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n99_), .O(z14));
  inv1   g081(.a(x27), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(x08), .O(new_n166_));
  nand2  g083(.a(new_n160_), .b(new_n121_), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n101_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n99_), .O(z15));
  ...
  nand3  g111(.a(new_n194_), .b(new_n191_), .c(new_n101_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n99_), .O(z20));
  ...
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(new_n101_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n99_), .O(z23));
  ...
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(new_n101_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n99_), .O(z25));
  ...
  nand2  g165(.a(new_n248_), .b(new_n99_), .O(z30));
  ...
  nand3  g169(.a(new_n252_), .b(new_n251_), .c(new_n85_), .O(new_n253_));
  ...
  nand3  g179(.a(new_n262_), .b(new_n261_), .c(new_n85_), .O(new_n263_));
  ...
  nand3  g188(.a(new_n271_), .b(new_n270_), .c(new_n85_), .O(new_n272_));
