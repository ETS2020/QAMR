...
module FAU ( 
  ...
  aoi21  g053(.a(x21), .b(new_n116_), .c(new_n86_), .O(new_n137_));
  ...
  nand2  g058(.a(new_n141_), .b(new_n116_), .O(new_n142_));
  ...
  aoi21  g068(.a(x25), .b(new_n116_), .c(new_n86_), .O(new_n152_));
  ...
  aoi21  g080(.a(x29), .b(new_n116_), .c(new_n86_), .O(new_n164_));
  aoi21  g081(.a(new_n164_), .b(new_n163_), .c(x10), .O(z18));
  nand2  g082(.a(x08), .b(x00), .O(new_n166_));
  aoi21  g083(.a(x30), .b(new_n116_), .c(new_n86_), .O(new_n167_));
  ...
  aoi21  g099(.a(x34), .b(new_n170_), .c(new_n86_), .O(new_n183_));
  ...
  nor2   g112(.a(x37), .b(x09), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(x38), .c(x10), .O(z26));
  inv1   g114(.a(new_n94_), .O(new_n198_));
  nand2  g115(.a(x14), .b(x00), .O(new_n199_));
  inv1   g116(.a(x14), .O(new_n200_));
  aoi21  g117(.a(x39), .b(new_n200_), .c(new_n170_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n199_), .c(new_n198_), .O(z27));
  ...
  nand3  g124(.a(new_n207_), .b(new_n204_), .c(new_n94_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z28));
  nor2   g126(.a(x14), .b(new_n170_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(x41), .O(new_n211_));
  aoi21  g128(.a(new_n206_), .b(x40), .c(new_n86_), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z29));
  nand2  g130(.a(new_n210_), .b(x42), .O(new_n214_));
  aoi21  g131(.a(new_n206_), .b(x41), .c(new_n86_), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n214_), .c(x10), .O(z30));
  nand2  g133(.a(new_n210_), .b(x43), .O(new_n217_));
  aoi21  g134(.a(new_n206_), .b(x42), .c(new_n86_), .O(new_n218_));
  ...
  nand2  g139(.a(new_n206_), .b(new_n222_), .O(new_n223_));
