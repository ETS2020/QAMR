...
module FAU ( 
  ...
  nand2  g008(.a(x20), .b(x10), .O(new_n92_));
  ...
  nand2  g030(.a(new_n86_), .b(new_n110_), .O(new_n114_));
  nand2  g031(.a(new_n114_), .b(x20), .O(new_n115_));
  oai21  g032(.a(new_n114_), .b(new_n108_), .c(new_n115_), .O(z08));
  inv1   g033(.a(x21), .O(new_n117_));
  oai21  g034(.a(x20), .b(x08), .c(new_n86_), .O(new_n118_));
  aoi21  g035(.a(new_n117_), .b(x08), .c(new_n118_), .O(z09));
  nor2   g036(.a(x22), .b(new_n110_), .O(new_n120_));
  ...
  nand2  g044(.a(new_n123_), .b(new_n110_), .O(new_n128_));
  ...
  oai21  g049(.a(new_n132_), .b(new_n131_), .c(new_n92_), .O(z13));
  ...
  nor2   g053(.a(x27), .b(new_n110_), .O(new_n137_));
  ...
  nor2   g059(.a(x29), .b(new_n110_), .O(new_n143_));
  oai21  g060(.a(x28), .b(x08), .c(new_n86_), .O(new_n144_));
  oai21  g061(.a(new_n144_), .b(new_n143_), .c(new_n92_), .O(z17));
  ...
  nand2  g067(.a(new_n146_), .b(new_n110_), .O(new_n151_));
  nand3  g068(.a(new_n151_), .b(new_n150_), .c(new_n86_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n92_), .O(z19));
  ...
  nand2  g097(.a(new_n180_), .b(new_n92_), .O(z26));
  ...
  aoi21  g102(.a(new_n177_), .b(new_n159_), .c(x10), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n92_), .O(z27));
  ...
  nand2  g111(.a(new_n194_), .b(new_n92_), .O(z28));
  ...
  nand2  g121(.a(new_n204_), .b(new_n92_), .O(z30));
  ...
  nand2  g126(.a(new_n209_), .b(new_n92_), .O(z31));
