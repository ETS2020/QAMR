...
module FAU ( 
  ...
  nor2   g026(.a(x19), .b(new_n95_), .O(new_n110_));
  ...
  nor2   g041(.a(x24), .b(new_n95_), .O(new_n125_));
  ...
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n96_), .O(z20));
  ...
  nand2  g082(.a(new_n165_), .b(new_n96_), .O(z24));
  nor2   g083(.a(x37), .b(new_n149_), .O(new_n167_));
  oai21  g084(.a(x36), .b(x09), .c(new_n86_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n96_), .O(z25));
  ...
  nand2  g105(.a(new_n188_), .b(new_n96_), .O(z29));
  ...
  nand2  g110(.a(new_n193_), .b(new_n96_), .O(z30));
  ...
  nand2  g130(.a(new_n213_), .b(new_n96_), .O(z34));
  ...
  nand2  g134(.a(new_n217_), .b(new_n96_), .O(z35));
endmodule
