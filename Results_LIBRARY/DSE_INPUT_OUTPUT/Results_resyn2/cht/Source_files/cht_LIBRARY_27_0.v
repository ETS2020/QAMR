...
module FAU ( 
  ...
  aoi21  g066(.a(x25), .b(new_n112_), .c(new_n86_), .O(new_n150_));
  ...
  aoi21  g075(.a(x27), .b(new_n112_), .c(new_n86_), .O(new_n159_));
  ...
  aoi21  g125(.a(x38), .b(new_n177_), .c(new_n86_), .O(new_n209_));
  ...
  nand2  g153(.a(new_n217_), .b(x45), .O(new_n237_));
  aoi21  g154(.a(new_n213_), .b(x44), .c(new_n86_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(new_n237_), .c(x10), .O(z33));
  nor2   g156(.a(new_n86_), .b(x45), .O(new_n240_));
  aoi21  g157(.a(new_n240_), .b(new_n213_), .c(x10), .O(z34));
  nor2   g158(.a(new_n86_), .b(x00), .O(new_n242_));
  aoi21  g159(.a(new_n242_), .b(new_n217_), .c(x10), .O(z35));
endmodule
