...
module FAU ( 
  ...
  aoi21  g001(.a(x36), .b(new_n84_), .c(x10), .O(new_n85_));
  ...
  nand2  g021(.a(x36), .b(new_n84_), .O(new_n105_));
  ...
  nand2  g077(.a(new_n84_), .b(x08), .O(new_n161_));
  nand2  g078(.a(new_n157_), .b(new_n121_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n107_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n105_), .O(z14));
  inv1   g081(.a(x36), .O(new_n165_));
  aoi21  g082(.a(new_n165_), .b(x08), .c(x26), .O(new_n166_));
  oai21  g083(.a(x27), .b(new_n121_), .c(new_n107_), .O(new_n167_));
  nor2   g084(.a(new_n167_), .b(new_n166_), .O(z15));
  inv1   g085(.a(x27), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n121_), .O(new_n170_));
  ...
  nand2  g091(.a(new_n171_), .b(new_n121_), .O(new_n175_));
  ...
  nand2  g096(.a(new_n176_), .b(new_n121_), .O(new_n180_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n191_), .c(new_n107_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n105_), .O(z20));
  ...
  nand2  g128(.a(new_n165_), .b(x09), .O(new_n212_));
  nand2  g129(.a(new_n208_), .b(new_n192_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(new_n107_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n105_), .O(z24));
  inv1   g132(.a(x37), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(x09), .O(new_n217_));
  nand2  g134(.a(new_n165_), .b(new_n192_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n107_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n105_), .O(z25));
  inv1   g137(.a(x38), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x09), .O(new_n222_));
  nand2  g139(.a(new_n216_), .b(new_n192_), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n222_), .c(new_n107_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n105_), .O(z26));
  nand2  g142(.a(x14), .b(x00), .O(new_n226_));
  inv1   g143(.a(x14), .O(new_n227_));
  nand2  g144(.a(x39), .b(new_n227_), .O(new_n228_));
  nand3  g145(.a(new_n228_), .b(new_n226_), .c(x09), .O(new_n229_));
  aoi21  g146(.a(new_n221_), .b(new_n192_), .c(x10), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n105_), .O(z27));
  inv1   g149(.a(x40), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n227_), .c(x09), .O(new_n234_));
  inv1   g151(.a(x39), .O(new_n235_));
  nand2  g152(.a(new_n227_), .b(x09), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n234_), .c(new_n107_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n105_), .O(z28));
  ...
  nand3  g159(.a(new_n242_), .b(new_n241_), .c(new_n107_), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(new_n105_), .O(z29));
