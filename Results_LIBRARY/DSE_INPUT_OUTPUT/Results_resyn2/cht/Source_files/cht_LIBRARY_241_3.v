...
module FAU ( 
  ...
  oai21  g042(.a(new_n108_), .b(new_n122_), .c(new_n125_), .O(z12));
  ...
  oai21  g076(.a(new_n159_), .b(new_n158_), .c(new_n89_), .O(z22));
  ...
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n89_), .O(z24));
  ...
  nand2  g090(.a(new_n173_), .b(new_n89_), .O(z26));
  ...
  nand2  g097(.a(new_n180_), .b(new_n89_), .O(z27));
  ...
  nand2  g104(.a(new_n187_), .b(new_n89_), .O(z28));
  ...
  nand2  g109(.a(new_n192_), .b(new_n89_), .O(z29));
  ...
  nand2  g114(.a(new_n197_), .b(new_n89_), .O(z30));
  ...
  nand2  g138(.a(new_n221_), .b(new_n89_), .O(z35));
endmodule
