...
module FAU ( 
  ...
  oai21  g084(.a(new_n167_), .b(new_n166_), .c(new_n90_), .O(z23));
  nor2   g085(.a(x36), .b(new_n151_), .O(new_n169_));
  ...
  nand2  g093(.a(new_n172_), .b(new_n151_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n176_), .c(new_n86_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n90_), .O(z26));
  ...
  nand2  g102(.a(new_n185_), .b(new_n90_), .O(z27));
  ...
  nand2  g134(.a(new_n217_), .b(new_n90_), .O(z33));
