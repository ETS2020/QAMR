...
module FAU ( 
  ...
  nand2  g063(.a(new_n141_), .b(new_n113_), .O(new_n147_));
  ...
  nand2  g088(.a(new_n166_), .b(new_n113_), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n95_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n93_), .O(z17));
  nand2  g091(.a(new_n170_), .b(new_n113_), .O(new_n175_));
  ...
  nand2  g104(.a(new_n84_), .b(new_n187_), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n186_), .c(new_n95_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n93_), .O(z20));
  nand2  g107(.a(new_n185_), .b(new_n187_), .O(new_n191_));
  ...
  nand2  g122(.a(new_n202_), .b(new_n187_), .O(new_n206_));
  ...
  nand2  g127(.a(new_n207_), .b(new_n187_), .O(new_n211_));
  ...
  nand2  g132(.a(new_n212_), .b(new_n187_), .O(new_n216_));
  ...
  nand3  g148(.a(new_n231_), .b(new_n230_), .c(new_n85_), .O(new_n232_));
