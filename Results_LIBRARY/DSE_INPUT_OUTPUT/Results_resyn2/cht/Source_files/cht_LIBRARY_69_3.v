...
module FAU ( 
  ...
  oai21  g006(.a(x10), .b(x05), .c(x07), .O(new_n90_));
  nand2  g007(.a(new_n86_), .b(new_n84_), .O(new_n91_));
  oai21  g008(.a(new_n91_), .b(new_n89_), .c(new_n90_), .O(z01));
  inv1   g009(.a(x13), .O(new_n93_));
  oai21  g010(.a(x10), .b(x06), .c(x07), .O(new_n94_));
  oai21  g011(.a(new_n91_), .b(new_n93_), .c(new_n94_), .O(z02));
  ...
  oai21  g019(.a(x10), .b(x03), .c(x07), .O(new_n103_));
  oai21  g020(.a(new_n91_), .b(new_n102_), .c(new_n103_), .O(z05));
  ...
  nand2  g037(.a(x10), .b(x07), .O(new_n121_));
