...
module FAU ( 
  ...
  nor2   g002(.a(x31), .b(x10), .O(new_n86_));
  ...
  aoi21  g015(.a(x13), .b(new_n87_), .c(x31), .O(new_n99_));
  ...
  aoi21  g024(.a(x15), .b(new_n87_), .c(x31), .O(new_n108_));
  aoi21  g025(.a(new_n108_), .b(new_n107_), .c(x10), .O(z04));
  nand2  g026(.a(x07), .b(x03), .O(new_n110_));
  aoi21  g027(.a(x16), .b(new_n87_), .c(x31), .O(new_n111_));
  ...
  aoi21  g037(.a(x18), .b(new_n115_), .c(x31), .O(new_n121_));
  ...
  aoi21  g046(.a(x20), .b(new_n115_), .c(x31), .O(new_n130_));
  ...
  nand3  g093(.a(new_n176_), .b(new_n173_), .c(new_n86_), .O(new_n177_));
  ...
  nand2  g115(.a(new_n198_), .b(new_n103_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n197_), .c(x09), .O(new_n200_));
  aoi21  g117(.a(x38), .b(new_n174_), .c(x31), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z27));
  inv1   g119(.a(x40), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n103_), .c(x09), .O(new_n204_));
  nand2  g121(.a(new_n103_), .b(x09), .O(new_n205_));
  ...
  nor2   g125(.a(x14), .b(new_n174_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(x41), .O(new_n210_));
  aoi21  g127(.a(new_n205_), .b(x40), .c(x31), .O(new_n211_));
  ...
  aoi21  g136(.a(new_n205_), .b(x42), .c(x31), .O(new_n220_));
  ...
  nand2  g146(.a(new_n205_), .b(new_n222_), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(new_n229_), .c(new_n86_), .O(new_n231_));
  inv1   g148(.a(new_n231_), .O(z33));
  nand2  g149(.a(new_n209_), .b(x46), .O(new_n233_));
  aoi21  g150(.a(new_n205_), .b(x45), .c(x31), .O(new_n234_));
  aoi21  g151(.a(new_n234_), .b(new_n233_), .c(x10), .O(z34));
  nand3  g152(.a(new_n103_), .b(x09), .c(new_n196_), .O(new_n236_));
