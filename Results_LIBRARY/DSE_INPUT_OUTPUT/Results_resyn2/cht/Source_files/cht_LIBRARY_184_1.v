...
module FAU ( 
  ...
  nand2  g077(.a(new_n156_), .b(new_n149_), .O(new_n161_));
  nand3  g078(.a(new_n161_), .b(new_n160_), .c(new_n86_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(new_n90_), .O(z23));
  ...
  nand2  g084(.a(new_n167_), .b(new_n90_), .O(z24));
  ...
  nand2  g089(.a(new_n172_), .b(new_n90_), .O(z25));
  nor2   g090(.a(x38), .b(new_n149_), .O(new_n174_));
  oai21  g091(.a(x37), .b(x09), .c(new_n86_), .O(new_n175_));
  oai21  g092(.a(new_n175_), .b(new_n174_), .c(new_n90_), .O(z26));
  inv1   g093(.a(x14), .O(new_n177_));
  inv1   g094(.a(x39), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g096(.a(x14), .b(new_n146_), .O(new_n180_));
  ...
  oai21  g102(.a(x14), .b(new_n149_), .c(new_n178_), .O(new_n186_));
  ...
  oai21  g107(.a(x14), .b(new_n149_), .c(new_n184_), .O(new_n191_));
  ...
  nand3  g135(.a(new_n177_), .b(x09), .c(new_n146_), .O(new_n219_));
  oai21  g136(.a(x14), .b(new_n149_), .c(new_n214_), .O(new_n220_));
