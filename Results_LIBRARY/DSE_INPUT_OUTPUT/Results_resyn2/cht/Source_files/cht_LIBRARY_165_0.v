...
module FAU ( 
  ...
  nand2  g097(.a(new_n171_), .b(new_n144_), .O(new_n181_));
  ...
  nor2   g106(.a(x14), .b(new_n144_), .O(new_n190_));
  ...
  nand2  g113(.a(new_n190_), .b(x43), .O(new_n197_));
  aoi21  g114(.a(new_n186_), .b(x42), .c(new_n86_), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z31));
  nand2  g116(.a(new_n190_), .b(x44), .O(new_n200_));
  aoi21  g117(.a(new_n186_), .b(x43), .c(new_n86_), .O(new_n201_));
  ...
  nand2  g127(.a(new_n186_), .b(new_n203_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n87_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n177_), .b(x09), .c(new_n140_), .O(new_n214_));
  nand2  g131(.a(new_n186_), .b(new_n209_), .O(new_n215_));
