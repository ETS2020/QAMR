...
module FAU ( 
  ...
  nand2  g047(.a(new_n130_), .b(new_n84_), .O(z13));
  nor2   g048(.a(x26), .b(new_n105_), .O(new_n132_));
  oai21  g049(.a(x25), .b(x08), .c(new_n87_), .O(new_n133_));
  oai21  g050(.a(new_n133_), .b(new_n132_), .c(new_n84_), .O(z14));
  ...
  nand2  g062(.a(new_n141_), .b(new_n105_), .O(new_n146_));
  nand3  g063(.a(new_n146_), .b(new_n145_), .c(new_n87_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n84_), .O(z18));
  ...
  nand2  g069(.a(new_n152_), .b(new_n84_), .O(z19));
  ...
  oai21  g078(.a(x33), .b(x09), .c(new_n87_), .O(new_n162_));
  aoi21  g079(.a(new_n161_), .b(x09), .c(new_n162_), .O(z22));
  oai21  g080(.a(x35), .b(x10), .c(x09), .O(new_n164_));
  nand2  g081(.a(new_n87_), .b(new_n154_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n161_), .c(new_n164_), .O(z23));
  inv1   g083(.a(x35), .O(new_n167_));
  oai21  g084(.a(x36), .b(x10), .c(x09), .O(new_n168_));
  oai21  g085(.a(new_n165_), .b(new_n167_), .c(new_n168_), .O(z24));
  inv1   g086(.a(x36), .O(new_n170_));
  oai21  g087(.a(x37), .b(x10), .c(x09), .O(new_n171_));
  oai21  g088(.a(new_n165_), .b(new_n170_), .c(new_n171_), .O(z25));
  ...
  nand2  g108(.a(new_n177_), .b(x09), .O(new_n192_));
  nand2  g109(.a(x10), .b(new_n154_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(x41), .O(new_n194_));
  inv1   g111(.a(x42), .O(new_n195_));
  oai21  g112(.a(new_n195_), .b(x14), .c(new_n87_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(x09), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n194_), .O(z30));
  nand3  g115(.a(new_n193_), .b(new_n192_), .c(x42), .O(new_n199_));
  inv1   g116(.a(x43), .O(new_n200_));
  oai21  g117(.a(new_n200_), .b(x14), .c(new_n87_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(x09), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n199_), .O(z31));
  nand3  g120(.a(new_n193_), .b(new_n192_), .c(x43), .O(new_n204_));
  inv1   g121(.a(x44), .O(new_n205_));
  oai21  g122(.a(new_n205_), .b(x14), .c(new_n87_), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(x09), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n204_), .O(z32));
  inv1   g125(.a(x45), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n177_), .c(x09), .O(new_n210_));
  oai21  g127(.a(x14), .b(new_n154_), .c(new_n205_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n87_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z33));
  nand3  g130(.a(new_n193_), .b(new_n192_), .c(x45), .O(new_n214_));
  inv1   g131(.a(x46), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(x14), .c(new_n87_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(x09), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(new_n214_), .O(z34));
  nand3  g135(.a(new_n193_), .b(new_n192_), .c(x46), .O(new_n219_));
  oai21  g136(.a(x14), .b(new_n149_), .c(new_n87_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(x09), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n219_), .O(z35));
endmodule
