...
module FAU ( 
  ...
  nand2  g001(.a(x32), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g010(.a(x32), .b(new_n84_), .c(x10), .O(new_n94_));
  ...
  nand2  g113(.a(new_n192_), .b(new_n185_), .O(new_n197_));
  ...
  nand2  g120(.a(new_n198_), .b(new_n185_), .O(new_n204_));
  ...
  nand3  g126(.a(new_n209_), .b(new_n207_), .c(new_n94_), .O(new_n210_));
  ...
  nand3  g150(.a(new_n233_), .b(new_n230_), .c(new_n94_), .O(new_n234_));
  ...
  nand3  g160(.a(new_n243_), .b(new_n242_), .c(new_n94_), .O(new_n244_));
  ...
  nand3  g170(.a(new_n253_), .b(new_n252_), .c(new_n94_), .O(new_n254_));
  ...
  nand3  g184(.a(new_n267_), .b(new_n266_), .c(new_n94_), .O(new_n268_));
