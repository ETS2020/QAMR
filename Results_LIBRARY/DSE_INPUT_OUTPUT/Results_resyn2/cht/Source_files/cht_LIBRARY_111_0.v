...
module FAU ( 
  ...
  aoi21  g077(.a(x34), .b(new_n146_), .c(new_n86_), .O(new_n161_));
  ...
  aoi21  g095(.a(x38), .b(new_n146_), .c(new_n86_), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z27));
  inv1   g097(.a(x40), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(new_n107_), .c(x09), .O(new_n182_));
  nand2  g099(.a(new_n107_), .b(x09), .O(new_n183_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n107_), .c(x09), .O(new_n192_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n107_), .c(x09), .O(new_n198_));
  nand2  g115(.a(new_n183_), .b(new_n191_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n198_), .c(new_n87_), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z31));
  nand2  g118(.a(new_n187_), .b(x44), .O(new_n202_));
  ...
  nand3  g122(.a(new_n205_), .b(new_n107_), .c(x09), .O(new_n206_));
  ...
  nand3  g128(.a(new_n211_), .b(new_n107_), .c(x09), .O(new_n212_));
  ...
  nand3  g132(.a(new_n107_), .b(x09), .c(new_n143_), .O(new_n216_));
