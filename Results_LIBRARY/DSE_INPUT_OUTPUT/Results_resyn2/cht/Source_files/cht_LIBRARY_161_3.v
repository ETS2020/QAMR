...
module FAU ( 
  ...
  nand2  g028(.a(new_n86_), .b(new_n105_), .O(new_n112_));
  nand2  g029(.a(new_n112_), .b(x20), .O(new_n113_));
  oai21  g030(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z08));
  oai21  g031(.a(x10), .b(new_n105_), .c(x20), .O(new_n115_));
  nand3  g032(.a(x21), .b(new_n86_), .c(x08), .O(new_n116_));
  nand2  g033(.a(new_n116_), .b(new_n115_), .O(z09));
  ...
  oai21  g045(.a(new_n128_), .b(new_n127_), .c(new_n89_), .O(z13));
  ...
  nand2  g053(.a(new_n136_), .b(new_n89_), .O(z15));
  nor2   g054(.a(x28), .b(new_n105_), .O(new_n138_));
  oai21  g055(.a(x27), .b(x08), .c(new_n86_), .O(new_n139_));
  oai21  g056(.a(new_n139_), .b(new_n138_), .c(new_n89_), .O(z16));
  ...
  oai21  g062(.a(new_n145_), .b(new_n144_), .c(new_n89_), .O(z18));
  ...
  nand2  g080(.a(new_n157_), .b(new_n152_), .O(new_n164_));
  ...
  oai21  g110(.a(x14), .b(new_n152_), .c(new_n186_), .O(new_n194_));
  ...
  oai21  g135(.a(x14), .b(new_n152_), .c(new_n212_), .O(new_n219_));
  ...
  oai21  g140(.a(x14), .b(new_n152_), .c(new_n217_), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n223_), .c(new_n86_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n89_), .O(z34));
  nand3  g143(.a(new_n185_), .b(x09), .c(new_n147_), .O(new_n227_));
  oai21  g144(.a(x14), .b(new_n152_), .c(new_n222_), .O(new_n228_));
