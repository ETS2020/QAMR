...
module FAU ( 
  ...
  nand2  g086(.a(new_n169_), .b(new_n140_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n94_), .O(new_n171_));
  aoi21  g088(.a(new_n168_), .b(x09), .c(new_n171_), .O(z27));
  ...
  aoi21  g093(.a(new_n176_), .b(x39), .c(new_n86_), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n174_), .c(x10), .O(z28));
  nand2  g095(.a(new_n173_), .b(x41), .O(new_n179_));
  aoi21  g096(.a(new_n176_), .b(x40), .c(new_n86_), .O(new_n180_));
  ...
  nand2  g104(.a(new_n173_), .b(x43), .O(new_n188_));
  aoi21  g105(.a(new_n176_), .b(x42), .c(new_n86_), .O(new_n189_));
  ...
  nand3  g121(.a(new_n204_), .b(new_n203_), .c(new_n94_), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(z34));
  nand3  g123(.a(new_n175_), .b(x09), .c(new_n137_), .O(new_n207_));
  nand2  g124(.a(new_n176_), .b(new_n202_), .O(new_n208_));
