...
module FAU ( 
  ...
  oai21  g044(.a(x24), .b(x08), .c(new_n88_), .O(new_n128_));
  aoi21  g045(.a(new_n84_), .b(x08), .c(new_n128_), .O(z13));
  nor2   g046(.a(x26), .b(new_n106_), .O(new_n130_));
  oai21  g047(.a(x25), .b(x08), .c(new_n88_), .O(new_n131_));
  nor2   g048(.a(new_n131_), .b(new_n130_), .O(z14));
  inv1   g049(.a(x27), .O(new_n133_));
  oai21  g050(.a(x26), .b(x08), .c(new_n88_), .O(new_n134_));
  aoi21  g051(.a(new_n133_), .b(x08), .c(new_n134_), .O(z15));
  nor2   g052(.a(x28), .b(new_n106_), .O(new_n136_));
  oai21  g053(.a(x27), .b(x08), .c(new_n88_), .O(new_n137_));
  oai21  g054(.a(new_n137_), .b(new_n136_), .c(new_n85_), .O(z16));
  inv1   g055(.a(x29), .O(new_n139_));
  oai21  g056(.a(x28), .b(x08), .c(new_n88_), .O(new_n140_));
  aoi21  g057(.a(new_n139_), .b(x08), .c(new_n140_), .O(z17));
  nor2   g058(.a(x30), .b(new_n106_), .O(new_n142_));
  oai21  g059(.a(x29), .b(x08), .c(new_n88_), .O(new_n143_));
  oai21  g060(.a(new_n143_), .b(new_n142_), .c(new_n85_), .O(z18));
  inv1   g061(.a(x00), .O(new_n145_));
  oai21  g062(.a(x30), .b(x08), .c(new_n88_), .O(new_n146_));
  ...
  nand3  g069(.a(new_n152_), .b(new_n149_), .c(new_n88_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n85_), .O(z20));
  ...
  nand2  g100(.a(new_n183_), .b(new_n85_), .O(z28));
  ...
  nand2  g110(.a(new_n193_), .b(new_n85_), .O(z30));
  ...
  nand2  g120(.a(new_n203_), .b(new_n85_), .O(z32));
