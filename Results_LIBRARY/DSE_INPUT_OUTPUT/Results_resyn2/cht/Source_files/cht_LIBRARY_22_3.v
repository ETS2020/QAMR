...
module FAU ( 
  ...
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n84_), .O(z20));
  ...
  nand2  g085(.a(x14), .b(new_n141_), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  oai21  g087(.a(x38), .b(x09), .c(new_n87_), .O(new_n171_));
  aoi21  g088(.a(new_n170_), .b(x09), .c(new_n171_), .O(z27));
  inv1   g089(.a(x40), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n166_), .c(x09), .O(new_n174_));
  oai21  g091(.a(x14), .b(new_n144_), .c(new_n167_), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n174_), .c(new_n87_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n84_), .O(z28));
  inv1   g094(.a(x41), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n166_), .c(x09), .O(new_n179_));
  oai21  g096(.a(x14), .b(new_n144_), .c(new_n173_), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n87_), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z29));
  inv1   g099(.a(x42), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n166_), .c(x09), .O(new_n184_));
  oai21  g101(.a(x14), .b(new_n144_), .c(new_n178_), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n184_), .c(new_n87_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n84_), .O(z30));
  inv1   g104(.a(x43), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n166_), .c(x09), .O(new_n189_));
  oai21  g106(.a(x14), .b(new_n144_), .c(new_n183_), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n189_), .c(new_n87_), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n84_), .O(z31));
  inv1   g109(.a(x44), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n166_), .c(x09), .O(new_n194_));
  oai21  g111(.a(x14), .b(new_n144_), .c(new_n188_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n194_), .c(new_n87_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n84_), .O(z32));
  inv1   g114(.a(x45), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n166_), .c(x09), .O(new_n199_));
  oai21  g116(.a(x14), .b(new_n144_), .c(new_n193_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n199_), .c(new_n87_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n84_), .O(z33));
  inv1   g119(.a(x46), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n166_), .c(x09), .O(new_n204_));
  oai21  g121(.a(x14), .b(new_n144_), .c(new_n198_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(new_n87_), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n84_), .O(z34));
  nand3  g124(.a(new_n166_), .b(x09), .c(new_n141_), .O(new_n208_));
  oai21  g125(.a(x14), .b(new_n144_), .c(new_n203_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(new_n87_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n84_), .O(z35));
endmodule
