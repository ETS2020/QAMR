...
module FAU ( 
  ...
  nand2  g071(.a(new_n154_), .b(new_n90_), .O(z20));
  ...
  nand2  g076(.a(new_n159_), .b(new_n90_), .O(z21));
  nor2   g077(.a(x34), .b(new_n151_), .O(new_n161_));
  oai21  g078(.a(x33), .b(x09), .c(new_n86_), .O(new_n162_));
  oai21  g079(.a(new_n162_), .b(new_n161_), .c(new_n90_), .O(z22));
  inv1   g080(.a(x35), .O(new_n164_));
  oai21  g081(.a(x34), .b(x09), .c(new_n86_), .O(new_n165_));
  aoi21  g082(.a(new_n164_), .b(x09), .c(new_n165_), .O(z23));
  nor2   g083(.a(x36), .b(new_n151_), .O(new_n167_));
  oai21  g084(.a(x35), .b(x09), .c(new_n86_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n90_), .O(z24));
  ...
  nand2  g091(.a(new_n170_), .b(new_n151_), .O(new_n175_));
  ...
  nand2  g100(.a(new_n183_), .b(new_n90_), .O(z27));
  ...
  nand2  g107(.a(new_n190_), .b(new_n90_), .O(z28));
  ...
  nand2  g112(.a(new_n195_), .b(new_n90_), .O(z29));
  ...
  nand2  g117(.a(new_n200_), .b(new_n90_), .O(z30));
