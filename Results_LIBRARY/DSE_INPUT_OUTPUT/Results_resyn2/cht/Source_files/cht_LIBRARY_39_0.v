...
module FAU ( 
  ...
  nand2  g093(.a(new_n176_), .b(new_n101_), .O(new_n177_));
  oai21  g094(.a(new_n101_), .b(x00), .c(new_n177_), .O(new_n178_));
  nand2  g095(.a(new_n171_), .b(new_n143_), .O(new_n179_));
  ...
  nand2  g100(.a(new_n101_), .b(x09), .O(new_n184_));
  ...
  aoi21  g119(.a(new_n184_), .b(x44), .c(new_n86_), .O(new_n203_));
  ...
  nand2  g124(.a(new_n184_), .b(new_n207_), .O(new_n208_));
