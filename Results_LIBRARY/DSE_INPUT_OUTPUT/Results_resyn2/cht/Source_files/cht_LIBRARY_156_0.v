...
module FAU ( 
  ...
  nand2  g095(.a(x14), .b(new_n143_), .O(new_n179_));
  ...
  aoi21  g100(.a(x38), .b(new_n147_), .c(new_n86_), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z27));
  nor2   g102(.a(x14), .b(new_n147_), .O(new_n186_));
  ...
  nand2  g115(.a(new_n188_), .b(new_n191_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n198_), .c(new_n87_), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z30));
  nand2  g118(.a(new_n186_), .b(x43), .O(new_n202_));
  aoi21  g119(.a(new_n188_), .b(x42), .c(new_n86_), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z31));
  inv1   g121(.a(x44), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n180_), .c(x09), .O(new_n206_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n180_), .c(x09), .O(new_n217_));
  nand2  g134(.a(new_n188_), .b(new_n211_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n87_), .O(new_n219_));
  inv1   g136(.a(new_n219_), .O(z34));
  nand3  g137(.a(new_n180_), .b(x09), .c(new_n143_), .O(new_n221_));
  nand2  g138(.a(new_n188_), .b(new_n216_), .O(new_n222_));
