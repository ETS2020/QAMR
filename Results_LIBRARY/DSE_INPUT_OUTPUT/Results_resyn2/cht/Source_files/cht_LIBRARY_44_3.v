...
module FAU ( 
  ...
  nor2   g061(.a(new_n105_), .b(x00), .O(new_n145_));
  oai21  g062(.a(x30), .b(x08), .c(new_n87_), .O(new_n146_));
  nor2   g063(.a(new_n146_), .b(new_n145_), .O(z19));
  oai21  g064(.a(x32), .b(x10), .c(x09), .O(new_n148_));
  nor2   g065(.a(x10), .b(x09), .O(new_n149_));
  nand2  g066(.a(new_n149_), .b(x31), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n148_), .O(z20));
  oai21  g068(.a(x33), .b(x10), .c(x09), .O(new_n152_));
  nand2  g069(.a(new_n149_), .b(x32), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n152_), .O(z21));
  inv1   g071(.a(x09), .O(new_n155_));
  nor2   g072(.a(x34), .b(new_n155_), .O(new_n156_));
  oai21  g073(.a(x33), .b(x09), .c(new_n87_), .O(new_n157_));
  nor2   g074(.a(new_n157_), .b(new_n156_), .O(z22));
  nor2   g075(.a(x35), .b(new_n155_), .O(new_n159_));
  oai21  g076(.a(x34), .b(x09), .c(new_n87_), .O(new_n160_));
  nor2   g077(.a(new_n160_), .b(new_n159_), .O(z23));
  nor2   g078(.a(x36), .b(new_n155_), .O(new_n162_));
  oai21  g079(.a(x35), .b(x09), .c(new_n87_), .O(new_n163_));
  nor2   g080(.a(new_n163_), .b(new_n162_), .O(z24));
  oai21  g081(.a(x37), .b(x10), .c(x09), .O(new_n165_));
  nand2  g082(.a(new_n149_), .b(x36), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n165_), .O(z25));
  nor2   g084(.a(x38), .b(new_n155_), .O(new_n168_));
  oai21  g085(.a(x37), .b(x09), .c(new_n87_), .O(new_n169_));
  nor2   g086(.a(new_n169_), .b(new_n168_), .O(z26));
  nand2  g087(.a(new_n149_), .b(x38), .O(new_n171_));
  ...
  nand2  g111(.a(x10), .b(new_n155_), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n181_), .c(x42), .O(new_n196_));
  aoi21  g113(.a(x43), .b(new_n173_), .c(x10), .O(new_n197_));
  oai21  g114(.a(new_n197_), .b(new_n155_), .c(new_n196_), .O(z31));
  nand3  g115(.a(new_n195_), .b(new_n181_), .c(x43), .O(new_n199_));
  aoi21  g116(.a(x44), .b(new_n173_), .c(x10), .O(new_n200_));
  oai21  g117(.a(new_n200_), .b(new_n155_), .c(new_n199_), .O(z32));
  nand3  g118(.a(new_n195_), .b(new_n181_), .c(x44), .O(new_n202_));
  aoi21  g119(.a(x45), .b(new_n173_), .c(x10), .O(new_n203_));
  oai21  g120(.a(new_n203_), .b(new_n155_), .c(new_n202_), .O(z33));
  inv1   g121(.a(x46), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n173_), .c(x09), .O(new_n206_));
  inv1   g123(.a(x45), .O(new_n207_));
  nand2  g124(.a(new_n181_), .b(new_n207_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n206_), .c(new_n87_), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  nand3  g127(.a(new_n195_), .b(new_n181_), .c(x46), .O(new_n211_));
  aoi21  g128(.a(new_n173_), .b(x00), .c(x10), .O(new_n212_));
  oai21  g129(.a(new_n212_), .b(new_n155_), .c(new_n211_), .O(z35));
endmodule
