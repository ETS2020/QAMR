...
module FAU ( 
  ...
  oai21  g081(.a(new_n164_), .b(new_n163_), .c(new_n84_), .O(z24));
  ...
  nand2  g087(.a(new_n166_), .b(new_n150_), .O(new_n171_));
  nand3  g088(.a(new_n171_), .b(new_n170_), .c(new_n87_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n84_), .O(z26));
  ...
  aoi21  g094(.a(new_n169_), .b(new_n150_), .c(x10), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n84_), .O(z27));
  ...
  nand3  g134(.a(new_n175_), .b(x09), .c(new_n147_), .O(new_n218_));
