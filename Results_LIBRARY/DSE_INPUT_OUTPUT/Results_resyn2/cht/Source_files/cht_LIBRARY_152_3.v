...
module FAU ( 
  ...
  nand2  g044(.a(new_n127_), .b(new_n84_), .O(z11));
  ...
  oai21  g052(.a(new_n135_), .b(new_n134_), .c(new_n84_), .O(z13));
  ...
  nor2   g065(.a(x30), .b(new_n107_), .O(new_n149_));
  ...
  nand2  g078(.a(new_n87_), .b(new_n155_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(x34), .O(new_n163_));
  oai21  g080(.a(new_n162_), .b(new_n159_), .c(new_n163_), .O(z22));
  ...
  aoi21  g099(.a(new_n176_), .b(new_n155_), .c(x10), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n84_), .O(z27));
