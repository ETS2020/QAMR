...
module FAU ( 
  ...
  nand2  g000(.a(x13), .b(x10), .O(new_n84_));
  ...
  nand2  g059(.a(new_n142_), .b(new_n84_), .O(z17));
  nor2   g060(.a(x30), .b(new_n108_), .O(new_n144_));
  ...
  nor2   g070(.a(x33), .b(new_n153_), .O(new_n154_));
  oai21  g071(.a(x32), .b(x09), .c(new_n87_), .O(new_n155_));
  oai21  g072(.a(new_n155_), .b(new_n154_), .c(new_n84_), .O(z21));
  nor2   g073(.a(x34), .b(new_n153_), .O(new_n157_));
  oai21  g074(.a(x33), .b(x09), .c(new_n87_), .O(new_n158_));
  nor2   g075(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g076(.a(x35), .b(new_n153_), .O(new_n160_));
  ...
  aoi21  g081(.a(new_n163_), .b(x09), .c(new_n164_), .O(z24));
  ...
  aoi21  g096(.a(new_n171_), .b(new_n153_), .c(x10), .O(new_n180_));
  ...
  nand3  g136(.a(new_n177_), .b(x09), .c(new_n147_), .O(new_n220_));
