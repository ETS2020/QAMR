...
module FAU ( 
  ...
  nand2  g084(.a(new_n167_), .b(new_n85_), .O(z24));
  ...
  nand2  g089(.a(new_n172_), .b(new_n85_), .O(z25));
  ...
  nand2  g094(.a(new_n177_), .b(new_n85_), .O(z26));
  ...
  aoi21  g099(.a(new_n174_), .b(new_n149_), .c(x10), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n85_), .O(z27));
  ...
  nand3  g107(.a(new_n190_), .b(new_n187_), .c(new_n88_), .O(new_n191_));
  ...
  nand2  g128(.a(new_n211_), .b(new_n85_), .O(z32));
