...
module FAU ( 
  ...
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n90_), .O(z21));
  ...
  oai21  g083(.a(new_n166_), .b(new_n165_), .c(new_n90_), .O(z24));
  nor2   g084(.a(x37), .b(new_n151_), .O(new_n168_));
  ...
  aoi21  g094(.a(new_n171_), .b(new_n151_), .c(x10), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n90_), .O(z27));
  ...
  nand2  g108(.a(new_n191_), .b(new_n90_), .O(z29));
  ...
  nand2  g118(.a(new_n201_), .b(new_n90_), .O(z31));
  ...
  nand2  g128(.a(new_n211_), .b(new_n90_), .O(z33));
  ...
  nand3  g134(.a(new_n175_), .b(x09), .c(new_n146_), .O(new_n218_));
