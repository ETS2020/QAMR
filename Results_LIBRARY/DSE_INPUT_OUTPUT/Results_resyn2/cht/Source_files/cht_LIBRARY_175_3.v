...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n91_,
    ...
    new_n271_, new_n272_;
  nand2  g000(.a(x28), .b(x23), .O(new_n84_));
  ...
  aoi21  g006(.a(x28), .b(x23), .c(x10), .O(new_n90_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n140_), .c(new_n90_), .O(new_n143_));
  inv1   g060(.a(new_n143_), .O(z10));
  inv1   g061(.a(x23), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(x08), .O(new_n146_));
  nand2  g063(.a(new_n141_), .b(new_n120_), .O(new_n147_));
