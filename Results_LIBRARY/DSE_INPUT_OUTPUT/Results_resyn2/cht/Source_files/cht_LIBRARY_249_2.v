...
module FAU ( 
  ...
  nand2  g039(.a(new_n122_), .b(new_n93_), .O(z10));
  nor2   g040(.a(x23), .b(new_n106_), .O(new_n124_));
  oai21  g041(.a(x22), .b(x08), .c(new_n86_), .O(new_n125_));
  oai21  g042(.a(new_n125_), .b(new_n124_), .c(new_n93_), .O(z11));
  ...
  nand2  g051(.a(new_n130_), .b(new_n106_), .O(new_n135_));
  ...
  oai21  g056(.a(new_n139_), .b(new_n138_), .c(new_n93_), .O(z15));
  ...
  nor2   g086(.a(x35), .b(new_n155_), .O(new_n170_));
  ...
  oai21  g110(.a(x14), .b(new_n155_), .c(new_n186_), .O(new_n194_));
  ...
  oai21  g119(.a(new_n202_), .b(new_n155_), .c(new_n86_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n92_), .O(new_n204_));
  nand2  g121(.a(new_n92_), .b(x09), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(x42), .c(new_n86_), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n204_), .O(z31));
  inv1   g124(.a(x44), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n92_), .c(x09), .O(new_n209_));
  oai21  g126(.a(x14), .b(new_n155_), .c(new_n202_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n86_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z32));
  inv1   g129(.a(x45), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n92_), .c(x09), .O(new_n214_));
  ...
  oai21  g136(.a(x14), .b(new_n155_), .c(new_n213_), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(new_n219_), .c(new_n86_), .O(new_n221_));
  inv1   g138(.a(new_n221_), .O(z34));
  oai21  g139(.a(new_n155_), .b(new_n150_), .c(new_n86_), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n92_), .O(new_n224_));
  nand3  g141(.a(new_n205_), .b(x46), .c(new_n86_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n224_), .O(z35));
endmodule
