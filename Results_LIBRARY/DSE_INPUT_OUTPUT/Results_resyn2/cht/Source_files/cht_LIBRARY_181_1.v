...
module FAU ( 
  ...
  oai22  g046(.a(new_n129_), .b(x08), .c(new_n114_), .d(new_n128_), .O(z13));
  ...
  oai21  g074(.a(new_n157_), .b(new_n156_), .c(new_n85_), .O(z22));
  ...
  nand2  g085(.a(new_n168_), .b(new_n85_), .O(z25));
  ...
  nand2  g104(.a(new_n187_), .b(new_n85_), .O(z28));
  ...
  nand2  g119(.a(new_n202_), .b(new_n85_), .O(z31));
  ...
  nand2  g138(.a(new_n221_), .b(new_n85_), .O(z35));
endmodule
