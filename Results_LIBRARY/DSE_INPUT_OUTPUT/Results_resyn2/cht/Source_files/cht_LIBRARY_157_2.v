...
module FAU ( 
  ...
  aoi21  g001(.a(new_n84_), .b(x30), .c(x10), .O(new_n85_));
  ...
  nand2  g009(.a(new_n84_), .b(x30), .O(new_n93_));
  ...
  nand2  g098(.a(new_n175_), .b(new_n115_), .O(new_n182_));
  ...
  aoi21  g126(.a(new_n175_), .b(new_n185_), .c(x37), .O(new_n210_));
  oai21  g127(.a(x36), .b(x09), .c(new_n95_), .O(new_n211_));
  nor2   g128(.a(new_n211_), .b(new_n210_), .O(z25));
  inv1   g129(.a(x38), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(x09), .O(new_n214_));
  nand2  g131(.a(new_n84_), .b(new_n185_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n95_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n93_), .O(z26));
  nand2  g134(.a(x14), .b(x00), .O(new_n218_));
  nand2  g135(.a(x39), .b(new_n101_), .O(new_n219_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n93_), .O(z27));
  ...
  nand3  g145(.a(new_n228_), .b(new_n225_), .c(new_n95_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n93_), .O(z28));
  ...
  nand3  g155(.a(new_n238_), .b(new_n237_), .c(new_n95_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(new_n93_), .O(z30));
  ...
  nand2  g161(.a(new_n244_), .b(new_n93_), .O(z31));
  inv1   g162(.a(x44), .O(new_n246_));
  nand3  g163(.a(new_n246_), .b(new_n101_), .c(x09), .O(new_n247_));
  ...
  nand3  g168(.a(new_n251_), .b(new_n101_), .c(x09), .O(new_n252_));
