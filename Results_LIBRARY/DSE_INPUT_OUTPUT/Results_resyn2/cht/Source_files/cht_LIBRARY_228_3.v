...
module FAU ( 
  ...
  nand2  g041(.a(new_n87_), .b(new_n105_), .O(new_n125_));
  oai21  g042(.a(new_n125_), .b(new_n121_), .c(new_n124_), .O(z12));
  ...
  oai21  g047(.a(new_n125_), .b(new_n127_), .c(new_n130_), .O(z14));
  inv1   g048(.a(x26), .O(new_n132_));
  oai21  g049(.a(x27), .b(x10), .c(x08), .O(new_n133_));
  oai21  g050(.a(new_n125_), .b(new_n132_), .c(new_n133_), .O(z15));
  nor2   g051(.a(x28), .b(new_n105_), .O(new_n135_));
  oai21  g052(.a(x27), .b(x08), .c(new_n87_), .O(new_n136_));
  nor2   g053(.a(new_n136_), .b(new_n135_), .O(z16));
  nor2   g054(.a(x29), .b(new_n105_), .O(new_n138_));
  ...
  oai21  g061(.a(new_n125_), .b(new_n141_), .c(new_n144_), .O(z19));
  ...
  aoi21  g090(.a(new_n172_), .b(x09), .c(new_n173_), .O(z26));
  ...
  aoi21  g095(.a(new_n172_), .b(new_n148_), .c(x10), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n84_), .O(z27));
  ...
  nand3  g103(.a(new_n186_), .b(new_n183_), .c(new_n87_), .O(new_n187_));
  ...
  nand2  g109(.a(new_n192_), .b(new_n84_), .O(z29));
  ...
  nand2  g129(.a(new_n212_), .b(new_n84_), .O(z33));
  ...
  nand3  g136(.a(new_n176_), .b(x09), .c(new_n219_), .O(new_n220_));
  nand2  g137(.a(new_n185_), .b(new_n214_), .O(new_n221_));
