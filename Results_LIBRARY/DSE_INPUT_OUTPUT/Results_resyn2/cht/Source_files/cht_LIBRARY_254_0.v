...
module FAU ( 
  ...
  nand2  g054(.a(new_n130_), .b(new_n118_), .O(new_n138_));
  nand3  g055(.a(new_n138_), .b(new_n137_), .c(new_n87_), .O(new_n139_));
  inv1   g056(.a(new_n139_), .O(z10));
  nor2   g057(.a(x22), .b(x08), .O(new_n141_));
  aoi21  g058(.a(new_n141_), .b(x23), .c(x10), .O(z11));
  inv1   g059(.a(x24), .O(new_n143_));
  nor2   g060(.a(new_n86_), .b(new_n118_), .O(new_n144_));
