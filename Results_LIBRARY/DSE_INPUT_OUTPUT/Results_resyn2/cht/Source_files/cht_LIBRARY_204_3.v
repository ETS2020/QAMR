...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n91_,
    ...
    new_n271_, new_n272_;
  nand2  g000(.a(x24), .b(x21), .O(new_n84_));
  ...
  aoi21  g006(.a(x24), .b(x21), .c(x10), .O(new_n90_));
  ...
  oai21  g032(.a(x16), .b(x07), .c(new_n87_), .O(new_n116_));
  oai21  g033(.a(new_n116_), .b(new_n115_), .c(new_n84_), .O(z05));
  ...
  nand3  g039(.a(new_n122_), .b(new_n119_), .c(new_n87_), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n84_), .O(z06));
  ...
  nand2  g058(.a(new_n136_), .b(new_n120_), .O(new_n142_));
  ...
  nand2  g070(.a(new_n153_), .b(new_n84_), .O(z12));
  ...
  nand2  g075(.a(new_n158_), .b(new_n84_), .O(z13));
  ...
  nand3  g116(.a(new_n199_), .b(new_n197_), .c(new_n90_), .O(new_n200_));
  ...
  nand2  g125(.a(new_n203_), .b(new_n192_), .O(new_n209_));
  ...
  nand2  g165(.a(new_n248_), .b(new_n84_), .O(z30));
  ...
  nand2  g175(.a(new_n258_), .b(new_n84_), .O(z32));
  ...
  nand3  g186(.a(new_n103_), .b(x09), .c(new_n186_), .O(new_n270_));
  nand2  g187(.a(new_n236_), .b(new_n265_), .O(new_n271_));
  nand3  g188(.a(new_n271_), .b(new_n270_), .c(new_n90_), .O(new_n272_));
