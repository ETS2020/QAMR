...
module FAU ( 
  ...
  nand2  g007(.a(new_n86_), .b(x07), .O(new_n91_));
  oai22  g008(.a(new_n91_), .b(new_n89_), .c(new_n90_), .d(x07), .O(z01));
  ...
  inv1   g018(.a(x03), .O(new_n102_));
  nor2   g019(.a(x16), .b(x10), .O(new_n103_));
  oai22  g020(.a(new_n103_), .b(x07), .c(new_n91_), .d(new_n102_), .O(z05));
  ...
  nand2  g037(.a(x10), .b(new_n84_), .O(new_n121_));
  nor2   g038(.a(x23), .b(new_n105_), .O(new_n122_));
  oai21  g039(.a(x22), .b(x08), .c(new_n86_), .O(new_n123_));
  oai21  g040(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(z11));
  ...
  oai21  g068(.a(x31), .b(x09), .c(new_n86_), .O(new_n152_));
  ...
  oai21  g073(.a(new_n156_), .b(new_n155_), .c(new_n121_), .O(z21));
  ...
  nand2  g087(.a(new_n170_), .b(new_n121_), .O(z25));
  ...
  nand2  g092(.a(new_n175_), .b(new_n121_), .O(z26));
  ...
  nand2  g099(.a(new_n182_), .b(new_n121_), .O(z27));
  ...
  nand2  g116(.a(new_n199_), .b(new_n121_), .O(z30));
  ...
  nand2  g126(.a(new_n209_), .b(new_n121_), .O(z32));
  ...
  nand2  g136(.a(new_n219_), .b(new_n121_), .O(z34));
