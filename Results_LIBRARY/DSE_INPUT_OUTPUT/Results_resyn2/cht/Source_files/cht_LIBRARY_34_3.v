...
module FAU ( 
  ...
  oai21  g033(.a(new_n113_), .b(new_n115_), .c(new_n116_), .O(z09));
  ...
  oai21  g038(.a(new_n113_), .b(new_n118_), .c(new_n121_), .O(z11));
  ...
  nor2   g042(.a(x25), .b(new_n105_), .O(new_n126_));
  ...
  oai21  g049(.a(new_n113_), .b(new_n129_), .c(new_n132_), .O(z15));
  ...
  oai21  g054(.a(new_n113_), .b(new_n134_), .c(new_n137_), .O(z17));
  nor2   g055(.a(x30), .b(new_n105_), .O(new_n139_));
  oai21  g056(.a(x29), .b(x08), .c(new_n87_), .O(new_n140_));
  ...
  nor2   g074(.a(x35), .b(new_n147_), .O(new_n158_));
  oai21  g075(.a(x34), .b(x09), .c(new_n87_), .O(new_n159_));
  oai21  g076(.a(new_n159_), .b(new_n158_), .c(new_n84_), .O(z23));
  nor2   g077(.a(x36), .b(new_n147_), .O(new_n161_));
  oai21  g078(.a(x35), .b(x09), .c(new_n87_), .O(new_n162_));
  nor2   g079(.a(new_n162_), .b(new_n161_), .O(z24));
  inv1   g080(.a(x37), .O(new_n164_));
  oai21  g081(.a(x36), .b(x09), .c(new_n87_), .O(new_n165_));
  aoi21  g082(.a(new_n164_), .b(x09), .c(new_n165_), .O(z25));
  inv1   g083(.a(x38), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(x09), .O(new_n168_));
  nand2  g085(.a(new_n164_), .b(new_n147_), .O(new_n169_));
  nand3  g086(.a(new_n169_), .b(new_n168_), .c(new_n87_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n84_), .O(z26));
  ...
  aoi21  g092(.a(new_n167_), .b(new_n147_), .c(x10), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n84_), .O(z27));
  ...
  nand2  g101(.a(new_n184_), .b(new_n84_), .O(z28));
  ...
  nand2  g116(.a(new_n199_), .b(new_n84_), .O(z31));
  ...
  nand2  g121(.a(new_n204_), .b(new_n84_), .O(z32));
  ...
  nand2  g126(.a(new_n209_), .b(new_n84_), .O(z33));
  ...
  nand3  g132(.a(new_n173_), .b(x09), .c(new_n142_), .O(new_n216_));
  nand2  g133(.a(new_n182_), .b(new_n211_), .O(new_n217_));
