...
module FAU ( 
  ...
  nand2  g053(.a(new_n133_), .b(new_n122_), .O(new_n137_));
  ...
  nand2  g099(.a(new_n179_), .b(new_n122_), .O(new_n183_));
  ...
  nand3  g124(.a(new_n207_), .b(new_n205_), .c(new_n92_), .O(new_n208_));
  ...
  nand3  g134(.a(new_n217_), .b(new_n215_), .c(new_n92_), .O(new_n218_));
  ...
  nand3  g139(.a(new_n222_), .b(new_n220_), .c(new_n92_), .O(new_n223_));
  ...
  nand3  g162(.a(new_n245_), .b(new_n244_), .c(new_n92_), .O(new_n246_));
  ...
  nand3  g172(.a(new_n255_), .b(new_n254_), .c(new_n92_), .O(new_n256_));
