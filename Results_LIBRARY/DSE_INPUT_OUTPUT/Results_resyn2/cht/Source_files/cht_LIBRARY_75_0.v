...
module FAU ( 
  ...
  nand2  g086(.a(new_n162_), .b(new_n144_), .O(new_n170_));
  nand3  g087(.a(new_n170_), .b(new_n169_), .c(new_n91_), .O(new_n171_));
  inv1   g088(.a(new_n171_), .O(z25));
  inv1   g089(.a(x38), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(x09), .O(new_n174_));
  nand2  g091(.a(new_n168_), .b(new_n144_), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n174_), .c(new_n91_), .O(new_n176_));
  ...
  oai21  g097(.a(new_n178_), .b(x00), .c(new_n180_), .O(new_n181_));
  nand2  g098(.a(new_n173_), .b(new_n144_), .O(new_n182_));
  ...
  nand2  g104(.a(new_n187_), .b(new_n179_), .O(new_n188_));
  ...
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(new_n91_), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z29));
  nor2   g112(.a(x14), .b(new_n144_), .O(new_n196_));
  ...
  nand3  g126(.a(new_n209_), .b(new_n178_), .c(x09), .O(new_n210_));
  nand2  g127(.a(new_n187_), .b(new_n203_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n91_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z33));
  inv1   g130(.a(x46), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n178_), .c(x09), .O(new_n215_));
  nand2  g132(.a(new_n187_), .b(new_n209_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n215_), .c(new_n91_), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(z34));
  nand3  g135(.a(new_n178_), .b(x09), .c(new_n140_), .O(new_n219_));
  nand2  g136(.a(new_n187_), .b(new_n214_), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(new_n219_), .c(new_n91_), .O(new_n221_));
