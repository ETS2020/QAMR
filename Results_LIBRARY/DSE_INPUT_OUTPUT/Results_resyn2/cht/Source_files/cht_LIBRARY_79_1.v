...
module FAU ( 
  ...
  nand2  g049(.a(new_n132_), .b(new_n85_), .O(z11));
  nor2   g050(.a(x24), .b(new_n108_), .O(new_n134_));
  oai21  g051(.a(x23), .b(x08), .c(new_n88_), .O(new_n135_));
  oai21  g052(.a(new_n135_), .b(new_n134_), .c(new_n85_), .O(z12));
  inv1   g053(.a(x25), .O(new_n137_));
  oai21  g054(.a(x24), .b(x08), .c(new_n88_), .O(new_n138_));
  aoi21  g055(.a(new_n137_), .b(x08), .c(new_n138_), .O(z13));
  nor2   g056(.a(x26), .b(new_n108_), .O(new_n140_));
  oai21  g057(.a(x25), .b(x08), .c(new_n88_), .O(new_n141_));
  oai21  g058(.a(new_n141_), .b(new_n140_), .c(new_n85_), .O(z14));
  ...
  oai22  g088(.a(new_n171_), .b(x09), .c(new_n162_), .d(new_n170_), .O(z23));
  inv1   g089(.a(x36), .O(new_n173_));
  nor2   g090(.a(x35), .b(x10), .O(new_n174_));
  oai22  g091(.a(new_n174_), .b(x09), .c(new_n162_), .d(new_n173_), .O(z24));
  ...
  oai21  g098(.a(x38), .b(x10), .c(new_n84_), .O(new_n182_));
  ...
  oai21  g112(.a(x14), .b(new_n84_), .c(new_n189_), .O(new_n196_));
  ...
  oai21  g126(.a(x44), .b(x14), .c(new_n88_), .O(new_n210_));
  nor2   g127(.a(x43), .b(x10), .O(new_n211_));
  aoi22  g128(.a(new_n211_), .b(new_n209_), .c(new_n210_), .d(x09), .O(z32));
  oai21  g129(.a(x45), .b(x14), .c(new_n88_), .O(new_n213_));
  nor2   g130(.a(x44), .b(x10), .O(new_n214_));
  aoi22  g131(.a(new_n214_), .b(new_n209_), .c(new_n213_), .d(x09), .O(z33));
  oai21  g132(.a(x46), .b(x14), .c(new_n88_), .O(new_n216_));
  nor2   g133(.a(x45), .b(x10), .O(new_n217_));
  aoi22  g134(.a(new_n217_), .b(new_n209_), .c(new_n216_), .d(x09), .O(z34));
  nand3  g135(.a(new_n184_), .b(x09), .c(new_n155_), .O(new_n219_));
