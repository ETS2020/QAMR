...
module FAU ( 
  ...
  nor2   g009(.a(x38), .b(x10), .O(new_n93_));
  ...
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(new_n93_), .O(new_n133_));
  inv1   g050(.a(new_n133_), .O(z09));
  nand2  g051(.a(x22), .b(x08), .O(new_n135_));
  aoi21  g052(.a(x21), .b(new_n115_), .c(x38), .O(new_n136_));
  ...
  aoi21  g098(.a(x34), .b(new_n169_), .c(x38), .O(new_n182_));
  ...
  nand2  g103(.a(new_n186_), .b(new_n169_), .O(new_n187_));
  ...
  nand2  g108(.a(new_n184_), .b(new_n169_), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n191_), .c(new_n93_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z25));
  aoi21  g111(.a(x37), .b(new_n169_), .c(x38), .O(new_n195_));
  nor2   g112(.a(new_n195_), .b(x10), .O(z26));
