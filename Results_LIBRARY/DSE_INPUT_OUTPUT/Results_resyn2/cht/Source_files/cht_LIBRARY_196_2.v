...
module FAU ( 
  ...
  aoi21  g052(.a(new_n134_), .b(x08), .c(new_n135_), .O(z15));
  nand2  g053(.a(new_n84_), .b(x08), .O(new_n137_));
  nand2  g054(.a(new_n134_), .b(new_n109_), .O(new_n138_));
  nand3  g055(.a(new_n138_), .b(new_n137_), .c(new_n88_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(new_n85_), .O(z16));
  ...
  nand2  g079(.a(new_n158_), .b(new_n154_), .O(new_n163_));
  nand3  g080(.a(new_n163_), .b(new_n162_), .c(new_n88_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n85_), .O(z22));
  nor2   g082(.a(x35), .b(new_n154_), .O(new_n166_));
  oai21  g083(.a(x34), .b(x09), .c(new_n88_), .O(new_n167_));
  oai21  g084(.a(new_n167_), .b(new_n166_), .c(new_n85_), .O(z23));
  inv1   g085(.a(x36), .O(new_n169_));
  oai21  g086(.a(x35), .b(x09), .c(new_n88_), .O(new_n170_));
  aoi21  g087(.a(new_n169_), .b(x09), .c(new_n170_), .O(z24));
  inv1   g088(.a(x37), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(x09), .O(new_n173_));
  nand2  g090(.a(new_n169_), .b(new_n154_), .O(new_n174_));
  nand3  g091(.a(new_n174_), .b(new_n173_), .c(new_n88_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n85_), .O(z25));
  inv1   g093(.a(x38), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(x09), .O(new_n178_));
  nand2  g095(.a(new_n172_), .b(new_n154_), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n178_), .c(new_n88_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n85_), .O(z26));
  nand2  g098(.a(x14), .b(x00), .O(new_n182_));
  inv1   g099(.a(x14), .O(new_n183_));
  nand2  g100(.a(x39), .b(new_n183_), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(new_n182_), .c(x09), .O(new_n185_));
  aoi21  g102(.a(new_n177_), .b(new_n154_), .c(x10), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n85_), .O(z27));
  inv1   g105(.a(x40), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n183_), .c(x09), .O(new_n190_));
  inv1   g107(.a(x39), .O(new_n191_));
  nand2  g108(.a(new_n183_), .b(x09), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n190_), .c(new_n88_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n85_), .O(z28));
  inv1   g112(.a(x41), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n183_), .c(x09), .O(new_n197_));
  nand2  g114(.a(new_n192_), .b(new_n189_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n197_), .c(new_n88_), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z29));
  inv1   g117(.a(x42), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n183_), .c(x09), .O(new_n202_));
  ...
  nand3  g123(.a(new_n206_), .b(new_n183_), .c(x09), .O(new_n207_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n183_), .c(x09), .O(new_n217_));
  ...
  nand3  g138(.a(new_n221_), .b(new_n183_), .c(x09), .O(new_n222_));
