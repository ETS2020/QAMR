...
module FAU ( 
  ...
  oai21  g053(.a(x28), .b(x10), .c(x08), .O(new_n137_));
  oai21  g054(.a(new_n108_), .b(new_n136_), .c(new_n137_), .O(z16));
  inv1   g055(.a(x28), .O(new_n139_));
  oai21  g056(.a(x29), .b(x10), .c(x08), .O(new_n140_));
  oai21  g057(.a(new_n108_), .b(new_n139_), .c(new_n140_), .O(z17));
  ...
  nand2  g074(.a(new_n157_), .b(new_n84_), .O(z22));
  nor2   g075(.a(x35), .b(new_n147_), .O(new_n159_));
  oai21  g076(.a(x34), .b(x09), .c(new_n87_), .O(new_n160_));
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n84_), .O(z23));
  ...
  oai21  g083(.a(new_n166_), .b(new_n165_), .c(new_n84_), .O(z25));
  ...
  nand2  g125(.a(new_n208_), .b(new_n84_), .O(z33));
