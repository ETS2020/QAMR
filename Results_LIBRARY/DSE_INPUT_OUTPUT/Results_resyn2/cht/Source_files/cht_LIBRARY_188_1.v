...
module FAU ( 
  ...
  nor2   g026(.a(x19), .b(new_n89_), .O(new_n110_));
  ...
  aoi21  g095(.a(new_n172_), .b(new_n154_), .c(x10), .O(new_n179_));
  ...
  nand2  g109(.a(new_n192_), .b(new_n90_), .O(z29));
  ...
  nand2  g138(.a(new_n221_), .b(new_n90_), .O(z35));
endmodule
