...
module FAU ( 
  ...
  oai21  g020(.a(new_n103_), .b(new_n102_), .c(new_n90_), .O(z04));
  ...
  oai21  g026(.a(x17), .b(x08), .c(new_n86_), .O(new_n110_));
  nor2   g027(.a(new_n110_), .b(new_n109_), .O(z06));
  inv1   g028(.a(x19), .O(new_n112_));
  oai21  g029(.a(x18), .b(x08), .c(new_n86_), .O(new_n113_));
  aoi21  g030(.a(new_n112_), .b(x08), .c(new_n113_), .O(z07));
  nor2   g031(.a(x20), .b(new_n108_), .O(new_n115_));
  oai21  g032(.a(x19), .b(x08), .c(new_n86_), .O(new_n116_));
  oai21  g033(.a(new_n116_), .b(new_n115_), .c(new_n90_), .O(z08));
  ...
  nor2   g042(.a(x23), .b(new_n108_), .O(new_n126_));
  oai21  g043(.a(x22), .b(x08), .c(new_n86_), .O(new_n127_));
  oai21  g044(.a(new_n127_), .b(new_n126_), .c(new_n90_), .O(z11));
  ...
  nor2   g060(.a(x29), .b(new_n108_), .O(new_n144_));
  ...
  nand2  g068(.a(new_n147_), .b(new_n108_), .O(new_n152_));
  ...
  aoi21  g101(.a(new_n176_), .b(new_n160_), .c(x10), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n90_), .O(z27));
  ...
  nand2  g115(.a(new_n198_), .b(new_n90_), .O(z29));
  ...
  nand2  g135(.a(new_n218_), .b(new_n90_), .O(z33));
  ...
  nand2  g140(.a(new_n223_), .b(new_n90_), .O(z34));
  nand3  g141(.a(new_n182_), .b(x09), .c(new_n150_), .O(new_n225_));
