...
module FAU ( 
  ...
  nand2  g037(.a(new_n93_), .b(x19), .O(new_n121_));
  ...
  aoi21  g088(.a(x38), .b(new_n146_), .c(x08), .O(new_n172_));
  ...
  nand3  g097(.a(new_n180_), .b(new_n100_), .c(x09), .O(new_n181_));
  ...
  nand2  g112(.a(new_n195_), .b(x44), .O(new_n196_));
  aoi21  g113(.a(new_n176_), .b(x43), .c(x08), .O(new_n197_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n200_), .c(new_n93_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z33));
  nand2  g121(.a(new_n195_), .b(x46), .O(new_n205_));
  aoi21  g122(.a(new_n176_), .b(x45), .c(x08), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z34));
  nand2  g124(.a(new_n195_), .b(x00), .O(new_n208_));
  aoi21  g125(.a(new_n176_), .b(x46), .c(x08), .O(new_n209_));
