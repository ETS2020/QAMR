...
module FAU ( 
  ...
  aoi21  g074(.a(x33), .b(new_n147_), .c(x08), .O(new_n158_));
  ...
  aoi21  g092(.a(x37), .b(new_n147_), .c(x08), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n175_), .c(x10), .O(z26));
  inv1   g094(.a(x39), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n103_), .O(new_n179_));
  oai21  g096(.a(new_n103_), .b(x00), .c(new_n179_), .O(new_n180_));
  oai21  g097(.a(x38), .b(x09), .c(new_n86_), .O(new_n181_));
  aoi21  g098(.a(new_n180_), .b(x09), .c(new_n181_), .O(z27));
  inv1   g099(.a(x40), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n103_), .c(x09), .O(new_n184_));
  nand2  g101(.a(new_n103_), .b(x09), .O(new_n185_));
  ...
  nor2   g110(.a(x14), .b(new_n147_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(x42), .O(new_n195_));
  aoi21  g112(.a(new_n185_), .b(x41), .c(x08), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z30));
  nand2  g114(.a(new_n194_), .b(x43), .O(new_n198_));
  aoi21  g115(.a(new_n185_), .b(x42), .c(x08), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z31));
  inv1   g117(.a(x44), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n103_), .c(x09), .O(new_n202_));
  inv1   g119(.a(x43), .O(new_n203_));
  nand2  g120(.a(new_n185_), .b(new_n203_), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n202_), .c(new_n86_), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(z32));
  nand2  g123(.a(new_n194_), .b(x45), .O(new_n207_));
  aoi21  g124(.a(new_n185_), .b(x44), .c(x08), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z33));
  nand2  g126(.a(new_n194_), .b(x46), .O(new_n210_));
  aoi21  g127(.a(new_n185_), .b(x45), .c(x08), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z34));
  inv1   g129(.a(x00), .O(new_n213_));
  nand3  g130(.a(new_n103_), .b(x09), .c(new_n213_), .O(new_n214_));
  inv1   g131(.a(x46), .O(new_n215_));
  nand2  g132(.a(new_n185_), .b(new_n215_), .O(new_n216_));
