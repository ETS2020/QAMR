...
module FAU ( 
  ...
  nand2  g048(.a(new_n84_), .b(new_n106_), .O(new_n132_));
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(new_n88_), .O(new_n133_));
  nand2  g050(.a(new_n133_), .b(new_n85_), .O(z14));
  ...
  nand2  g055(.a(new_n138_), .b(new_n85_), .O(z15));
  ...
  nand2  g065(.a(new_n148_), .b(new_n85_), .O(z17));
  nor2   g066(.a(x30), .b(new_n106_), .O(new_n150_));
  oai21  g067(.a(x29), .b(x08), .c(new_n88_), .O(new_n151_));
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n85_), .O(z18));
  ...
  oai21  g075(.a(new_n158_), .b(new_n157_), .c(new_n85_), .O(z20));
  ...
  nor2   g079(.a(x34), .b(new_n156_), .O(new_n163_));
  ...
  aoi21  g098(.a(new_n175_), .b(new_n156_), .c(x10), .O(new_n182_));
  ...
  nand2  g107(.a(new_n190_), .b(new_n85_), .O(z28));
  ...
  nand3  g138(.a(new_n179_), .b(x09), .c(new_n153_), .O(new_n222_));
