...
module FAU ( 
  ...
  nand2  g033(.a(new_n86_), .b(x20), .O(new_n117_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n100_), .O(new_n174_));
  ...
  nand2  g110(.a(new_n180_), .b(new_n186_), .O(new_n194_));
