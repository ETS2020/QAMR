...
module FAU ( 
  ...
  nor2   g036(.a(new_n119_), .b(new_n118_), .O(z09));
  ...
  nand2  g073(.a(new_n156_), .b(new_n89_), .O(z20));
  nor2   g074(.a(x33), .b(new_n153_), .O(new_n158_));
  oai21  g075(.a(x32), .b(x09), .c(new_n86_), .O(new_n159_));
  oai21  g076(.a(new_n159_), .b(new_n158_), .c(new_n89_), .O(z21));
  nor2   g077(.a(x34), .b(new_n153_), .O(new_n161_));
  oai21  g078(.a(x33), .b(x09), .c(new_n86_), .O(new_n162_));
  nor2   g079(.a(new_n162_), .b(new_n161_), .O(z22));
  nor2   g080(.a(x35), .b(new_n153_), .O(new_n164_));
  ...
  nand2  g088(.a(new_n167_), .b(new_n153_), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n86_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n89_), .O(z25));
  ...
  nand2  g095(.a(new_n178_), .b(new_n89_), .O(z26));
  ...
  aoi21  g100(.a(new_n175_), .b(new_n153_), .c(x10), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n89_), .O(z27));
  ...
  nand3  g108(.a(new_n191_), .b(new_n188_), .c(new_n86_), .O(new_n192_));
  ...
  nand2  g135(.a(new_n190_), .b(new_n86_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(x46), .O(new_n220_));
  nand3  g137(.a(new_n190_), .b(x45), .c(new_n86_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n220_), .O(z34));
  nand3  g139(.a(new_n181_), .b(new_n86_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(x46), .O(new_n224_));
  oai21  g141(.a(new_n223_), .b(new_n148_), .c(new_n224_), .O(z35));
endmodule
