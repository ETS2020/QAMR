...
module FAU ( 
  ...
  nand2  g000(.a(x10), .b(x02), .O(new_n84_));
  ...
  nand2  g016(.a(new_n87_), .b(new_n85_), .O(new_n100_));
  nand2  g017(.a(new_n100_), .b(x02), .O(new_n101_));
  oai21  g018(.a(new_n100_), .b(new_n99_), .c(new_n101_), .O(z04));
  ...
  oai21  g045(.a(new_n128_), .b(new_n127_), .c(new_n84_), .O(z12));
  ...
  nand2  g053(.a(new_n136_), .b(new_n84_), .O(z14));
  nor2   g054(.a(x27), .b(new_n106_), .O(new_n138_));
  oai21  g055(.a(x26), .b(x08), .c(new_n87_), .O(new_n139_));
  oai21  g056(.a(new_n139_), .b(new_n138_), .c(new_n84_), .O(z15));
  inv1   g057(.a(x28), .O(new_n141_));
  oai21  g058(.a(x27), .b(x08), .c(new_n87_), .O(new_n142_));
  ...
  oai21  g083(.a(new_n166_), .b(new_n165_), .c(new_n84_), .O(z23));
  ...
  nand2  g094(.a(new_n177_), .b(new_n84_), .O(z26));
