...
module FAU ( 
  ...
  aoi21  g007(.a(x37), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand2  g110(.a(new_n84_), .b(new_n193_), .O(new_n194_));
  ...
  nand2  g118(.a(new_n197_), .b(new_n193_), .O(new_n202_));
  ...
  nand2  g125(.a(new_n203_), .b(new_n193_), .O(new_n209_));
  ...
  nand2  g133(.a(new_n212_), .b(new_n193_), .O(new_n217_));
  ...
  nand2  g140(.a(new_n218_), .b(new_n193_), .O(new_n224_));
  ...
  nand2  g146(.a(x14), .b(new_n187_), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  nand2  g148(.a(new_n222_), .b(new_n193_), .O(new_n232_));
  nand3  g149(.a(new_n232_), .b(new_n85_), .c(new_n88_), .O(new_n233_));
  ...
  nand3  g186(.a(new_n227_), .b(x09), .c(new_n187_), .O(new_n270_));
