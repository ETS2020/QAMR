...
module FAU ( 
  ...
  nor2   g061(.a(x28), .b(new_n106_), .O(new_n145_));
  oai21  g062(.a(x27), .b(x08), .c(new_n88_), .O(new_n146_));
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n85_), .O(z16));
  oai21  g064(.a(x28), .b(x08), .c(new_n88_), .O(new_n148_));
  aoi21  g065(.a(new_n84_), .b(x08), .c(new_n148_), .O(z17));
  inv1   g066(.a(x30), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(x08), .O(new_n151_));
  nand2  g068(.a(new_n84_), .b(new_n106_), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(new_n88_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n85_), .O(z18));
  ...
  nor2   g089(.a(x36), .b(new_n160_), .O(new_n173_));
  ...
  aoi21  g102(.a(new_n179_), .b(new_n160_), .c(x10), .O(new_n186_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n85_), .O(z29));
  ...
  nand3  g142(.a(new_n183_), .b(x09), .c(new_n155_), .O(new_n226_));
