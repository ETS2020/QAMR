...
module FAU ( 
  ...
  nand4  g035(.a(new_n118_), .b(new_n115_), .c(new_n92_), .d(x09), .O(new_n119_));
  ...
  nand4  g044(.a(new_n127_), .b(new_n125_), .c(new_n92_), .d(x09), .O(new_n128_));
  ...
  aoi21  g101(.a(x39), .b(new_n184_), .c(new_n86_), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n183_), .c(x10), .O(z27));
  inv1   g103(.a(x39), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(x14), .O(new_n188_));
  inv1   g105(.a(x40), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n184_), .O(new_n190_));
  nand4  g107(.a(new_n190_), .b(new_n188_), .c(new_n92_), .d(x09), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z28));
  nand2  g109(.a(x40), .b(x14), .O(new_n193_));
  aoi21  g110(.a(x41), .b(new_n184_), .c(new_n86_), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z29));
  nand2  g112(.a(x41), .b(x14), .O(new_n196_));
  aoi21  g113(.a(x42), .b(new_n184_), .c(new_n86_), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z30));
  inv1   g115(.a(x42), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(x14), .O(new_n200_));
  inv1   g117(.a(x43), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n184_), .O(new_n202_));
  nand4  g119(.a(new_n202_), .b(new_n200_), .c(new_n92_), .d(x09), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z31));
  nand2  g121(.a(x43), .b(x14), .O(new_n205_));
  aoi21  g122(.a(x44), .b(new_n184_), .c(new_n86_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z32));
  nand2  g124(.a(x44), .b(x14), .O(new_n208_));
  aoi21  g125(.a(x45), .b(new_n184_), .c(new_n86_), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z33));
  inv1   g127(.a(x45), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(x14), .O(new_n212_));
  inv1   g129(.a(x46), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(new_n184_), .O(new_n214_));
  ...
  nand2  g135(.a(new_n184_), .b(new_n218_), .O(new_n219_));
  nand4  g136(.a(new_n219_), .b(new_n217_), .c(new_n92_), .d(x09), .O(new_n220_));
