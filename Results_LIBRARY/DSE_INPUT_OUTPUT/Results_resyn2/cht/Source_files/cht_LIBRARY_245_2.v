...
module FAU ( 
  ...
  aoi21  g039(.a(new_n122_), .b(new_n117_), .c(x10), .O(z10));
  ...
  aoi21  g047(.a(new_n130_), .b(new_n117_), .c(x10), .O(z14));
  ...
  nand2  g083(.a(new_n166_), .b(new_n144_), .O(new_n167_));
  ...
  aoi21  g092(.a(x38), .b(new_n144_), .c(x08), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n175_), .c(x10), .O(z27));
  nor2   g094(.a(x14), .b(new_n144_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(x40), .O(new_n179_));
  nand2  g096(.a(new_n172_), .b(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(x39), .c(x08), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n179_), .c(x10), .O(z28));
  nand2  g099(.a(new_n178_), .b(x41), .O(new_n183_));
  aoi21  g100(.a(new_n180_), .b(x40), .c(x08), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z29));
  inv1   g102(.a(x42), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n172_), .c(x09), .O(new_n187_));
  inv1   g104(.a(x41), .O(new_n188_));
  nand2  g105(.a(new_n180_), .b(new_n188_), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n187_), .c(new_n86_), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z30));
  nand2  g108(.a(new_n178_), .b(x43), .O(new_n192_));
  aoi21  g109(.a(new_n180_), .b(x42), .c(x08), .O(new_n193_));
  ...
  nand2  g114(.a(new_n180_), .b(new_n197_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n196_), .c(new_n86_), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  inv1   g117(.a(x45), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n172_), .c(x09), .O(new_n202_));
  nand2  g119(.a(new_n180_), .b(new_n195_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n202_), .c(new_n86_), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z33));
  inv1   g122(.a(x46), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n172_), .c(x09), .O(new_n207_));
  nand2  g124(.a(new_n180_), .b(new_n201_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n207_), .c(new_n86_), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  nand2  g127(.a(new_n178_), .b(x00), .O(new_n211_));
  aoi21  g128(.a(new_n180_), .b(x46), .c(x08), .O(new_n212_));
