...
module FAU ( 
  ...
  oai21  g040(.a(new_n108_), .b(new_n122_), .c(new_n123_), .O(z11));
  ...
  oai21  g045(.a(new_n108_), .b(new_n125_), .c(new_n128_), .O(z13));
  ...
  aoi21  g071(.a(new_n153_), .b(x09), .c(new_n154_), .O(z22));
  ...
  aoi21  g083(.a(new_n165_), .b(x09), .c(new_n166_), .O(z26));
  ...
  aoi21  g088(.a(new_n165_), .b(new_n146_), .c(x10), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n89_), .O(z27));
  ...
  nand2  g100(.a(new_n178_), .b(new_n175_), .O(new_n184_));
  ...
  nand2  g120(.a(new_n178_), .b(new_n197_), .O(new_n204_));
  ...
  nand2  g125(.a(new_n178_), .b(new_n202_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(new_n86_), .O(new_n210_));
  inv1   g127(.a(new_n210_), .O(z34));
  inv1   g128(.a(x00), .O(new_n212_));
  nand3  g129(.a(new_n169_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand2  g130(.a(new_n178_), .b(new_n207_), .O(new_n214_));
