...
module FAU ( 
  ...
  nor2   g045(.a(x24), .b(new_n106_), .O(new_n129_));
  ...
  nand2  g053(.a(new_n132_), .b(new_n106_), .O(new_n137_));
  ...
  nor2   g071(.a(x32), .b(new_n84_), .O(new_n155_));
  oai21  g072(.a(x31), .b(x09), .c(new_n88_), .O(new_n156_));
  nor2   g073(.a(new_n156_), .b(new_n155_), .O(z20));
  nor2   g074(.a(x33), .b(new_n84_), .O(new_n158_));
  oai21  g075(.a(x32), .b(x09), .c(new_n88_), .O(new_n159_));
  nor2   g076(.a(new_n159_), .b(new_n158_), .O(z21));
  inv1   g077(.a(x34), .O(new_n161_));
  nor2   g078(.a(x33), .b(x10), .O(new_n162_));
  nand2  g079(.a(new_n88_), .b(x09), .O(new_n163_));
  oai22  g080(.a(new_n163_), .b(new_n161_), .c(new_n162_), .d(x09), .O(z22));
  ...
  oai22  g086(.a(new_n169_), .b(x09), .c(new_n163_), .d(new_n168_), .O(z24));
  inv1   g087(.a(x37), .O(new_n171_));
  nor2   g088(.a(x36), .b(x10), .O(new_n172_));
  oai22  g089(.a(new_n172_), .b(x09), .c(new_n163_), .d(new_n171_), .O(z25));
  ...
  oai21  g093(.a(x38), .b(x10), .c(new_n84_), .O(new_n177_));
  nand2  g094(.a(x14), .b(new_n152_), .O(new_n178_));
  inv1   g095(.a(x14), .O(new_n179_));
  inv1   g096(.a(x39), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand4  g098(.a(new_n181_), .b(new_n178_), .c(new_n88_), .d(x09), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n177_), .O(z27));
  inv1   g100(.a(x40), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(new_n179_), .c(x09), .O(new_n185_));
  oai21  g102(.a(x14), .b(new_n84_), .c(new_n180_), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n185_), .c(new_n88_), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(z28));
  inv1   g105(.a(x41), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n179_), .c(x09), .O(new_n190_));
  oai21  g107(.a(x14), .b(new_n84_), .c(new_n184_), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n190_), .c(new_n88_), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z29));
  nand2  g110(.a(new_n179_), .b(x09), .O(new_n194_));
  oai21  g111(.a(x42), .b(x14), .c(new_n88_), .O(new_n195_));
  nor2   g112(.a(x41), .b(x10), .O(new_n196_));
  aoi22  g113(.a(new_n196_), .b(new_n194_), .c(new_n195_), .d(x09), .O(z30));
  inv1   g114(.a(x43), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n179_), .c(x09), .O(new_n199_));
  inv1   g116(.a(x42), .O(new_n200_));
  oai21  g117(.a(x14), .b(new_n84_), .c(new_n200_), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n199_), .c(new_n88_), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z31));
  oai21  g120(.a(x44), .b(x14), .c(new_n88_), .O(new_n204_));
  nor2   g121(.a(x43), .b(x10), .O(new_n205_));
  aoi22  g122(.a(new_n205_), .b(new_n194_), .c(new_n204_), .d(x09), .O(z32));
  oai21  g123(.a(x45), .b(x14), .c(new_n88_), .O(new_n207_));
  nor2   g124(.a(x44), .b(x10), .O(new_n208_));
  aoi22  g125(.a(new_n208_), .b(new_n194_), .c(new_n207_), .d(x09), .O(z33));
  inv1   g126(.a(x46), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n179_), .c(x09), .O(new_n211_));
  inv1   g128(.a(x45), .O(new_n212_));
  oai21  g129(.a(x14), .b(new_n84_), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n211_), .c(new_n88_), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(z34));
  oai21  g132(.a(x14), .b(x00), .c(new_n88_), .O(new_n216_));
  nor2   g133(.a(x46), .b(x10), .O(new_n217_));
  aoi22  g134(.a(new_n217_), .b(new_n194_), .c(new_n216_), .d(x09), .O(z35));
endmodule
