...
module FAU ( 
  ...
  aoi21  g007(.a(new_n84_), .b(x25), .c(x10), .O(new_n91_));
  ...
  nand2  g093(.a(new_n170_), .b(new_n113_), .O(new_n177_));
  ...
  nand3  g149(.a(new_n232_), .b(new_n231_), .c(new_n91_), .O(new_n233_));
  ...
  nand3  g161(.a(new_n84_), .b(new_n222_), .c(x09), .O(new_n245_));
  ...
  oai21  g167(.a(x14), .b(new_n187_), .c(new_n84_), .O(new_n251_));
