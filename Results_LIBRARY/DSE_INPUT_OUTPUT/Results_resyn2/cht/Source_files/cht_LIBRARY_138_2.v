...
module FAU ( 
  ...
  nand2  g052(.a(new_n131_), .b(new_n109_), .O(new_n136_));
  nand3  g053(.a(new_n136_), .b(new_n135_), .c(new_n88_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n85_), .O(z15));
  nor2   g055(.a(x28), .b(new_n109_), .O(new_n139_));
  oai21  g056(.a(x27), .b(x08), .c(new_n88_), .O(new_n140_));
  oai21  g057(.a(new_n140_), .b(new_n139_), .c(new_n85_), .O(z16));
  inv1   g058(.a(x29), .O(new_n142_));
  oai21  g059(.a(x28), .b(x08), .c(new_n88_), .O(new_n143_));
  aoi21  g060(.a(new_n142_), .b(x08), .c(new_n143_), .O(z17));
  nor2   g061(.a(x30), .b(new_n109_), .O(new_n145_));
  oai21  g062(.a(x29), .b(x08), .c(new_n88_), .O(new_n146_));
  oai21  g063(.a(new_n146_), .b(new_n145_), .c(new_n85_), .O(z18));
  inv1   g064(.a(x00), .O(new_n148_));
  oai21  g065(.a(x30), .b(x08), .c(new_n88_), .O(new_n149_));
  ...
  oai21  g074(.a(x33), .b(x09), .c(new_n88_), .O(new_n158_));
  aoi21  g075(.a(new_n84_), .b(x09), .c(new_n158_), .O(z22));
  inv1   g076(.a(x35), .O(new_n160_));
  oai21  g077(.a(x34), .b(x09), .c(new_n88_), .O(new_n161_));
  aoi21  g078(.a(new_n160_), .b(x09), .c(new_n161_), .O(z23));
  nor2   g079(.a(x36), .b(new_n151_), .O(new_n163_));
  oai21  g080(.a(x35), .b(x09), .c(new_n88_), .O(new_n164_));
  oai21  g081(.a(new_n164_), .b(new_n163_), .c(new_n85_), .O(z24));
  inv1   g082(.a(x37), .O(new_n166_));
  oai21  g083(.a(x36), .b(x09), .c(new_n88_), .O(new_n167_));
  aoi21  g084(.a(new_n166_), .b(x09), .c(new_n167_), .O(z25));
  inv1   g085(.a(x38), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(x09), .O(new_n170_));
  nand2  g087(.a(new_n166_), .b(new_n151_), .O(new_n171_));
  nand3  g088(.a(new_n171_), .b(new_n170_), .c(new_n88_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n85_), .O(z26));
  ...
  aoi21  g094(.a(new_n169_), .b(new_n151_), .c(x10), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n85_), .O(z27));
  ...
  nand3  g102(.a(new_n185_), .b(new_n182_), .c(new_n88_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n85_), .O(z28));
  ...
  nand3  g134(.a(new_n175_), .b(x09), .c(new_n148_), .O(new_n218_));
  nand2  g135(.a(new_n184_), .b(new_n213_), .O(new_n219_));
