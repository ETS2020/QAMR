...
module FAU ( 
  ...
  oai21  g071(.a(new_n154_), .b(new_n153_), .c(new_n89_), .O(z22));
  ...
  oai21  g080(.a(new_n163_), .b(new_n162_), .c(new_n89_), .O(z25));
  ...
  nand2  g100(.a(new_n183_), .b(new_n89_), .O(z29));
  ...
  nand2  g105(.a(new_n188_), .b(new_n89_), .O(z30));
  ...
  nand2  g110(.a(new_n193_), .b(new_n89_), .O(z31));
  ...
  nand2  g115(.a(new_n198_), .b(new_n89_), .O(z32));
