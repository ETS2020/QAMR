...
module FAU ( 
  ...
  nand2  g058(.a(new_n141_), .b(new_n85_), .O(z15));
  ...
  aoi21  g107(.a(new_n182_), .b(new_n163_), .c(x10), .O(new_n191_));
  ...
  nand2  g126(.a(new_n209_), .b(new_n85_), .O(z30));
  ...
  nand2  g136(.a(new_n219_), .b(new_n85_), .O(z32));
  ...
  nand3  g142(.a(new_n84_), .b(new_n188_), .c(x09), .O(new_n226_));
  nand2  g143(.a(new_n197_), .b(new_n221_), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n226_), .c(new_n88_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n85_), .O(z34));
  nand3  g146(.a(new_n188_), .b(x09), .c(new_n158_), .O(new_n230_));
  nand2  g147(.a(new_n197_), .b(new_n84_), .O(new_n231_));
