...
module FAU ( 
  ...
  oai21  g088(.a(x39), .b(x14), .c(new_n171_), .O(new_n172_));
  inv1   g089(.a(x38), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n144_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n87_), .O(new_n175_));
  aoi21  g092(.a(new_n172_), .b(x09), .c(new_n175_), .O(z27));
  nor2   g093(.a(x14), .b(new_n144_), .O(new_n177_));
  ...
  nand3  g099(.a(new_n182_), .b(new_n101_), .c(x09), .O(new_n183_));
  ...
  aoi21  g125(.a(new_n179_), .b(x46), .c(new_n86_), .O(new_n209_));
