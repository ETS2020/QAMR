...
module FAU ( 
  ...
  nand2  g001(.a(new_n84_), .b(x34), .O(new_n85_));
  ...
  aoi21  g007(.a(new_n84_), .b(x34), .c(x10), .O(new_n91_));
  ...
  nand2  g133(.a(new_n211_), .b(new_n190_), .O(new_n217_));
  ...
  nand2  g138(.a(new_n215_), .b(new_n190_), .O(new_n222_));
  ...
  aoi21  g145(.a(new_n220_), .b(new_n190_), .c(x10), .O(new_n229_));
  ...
  nand3  g153(.a(new_n236_), .b(new_n233_), .c(new_n91_), .O(new_n237_));
  ...
  nand3  g175(.a(new_n84_), .b(new_n226_), .c(x09), .O(new_n259_));
