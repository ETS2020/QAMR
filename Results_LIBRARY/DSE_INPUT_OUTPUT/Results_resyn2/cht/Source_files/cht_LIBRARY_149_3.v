...
module FAU ( 
  ...
  nand2  g005(.a(x43), .b(x10), .O(new_n89_));
  ...
  nand2  g041(.a(new_n124_), .b(new_n89_), .O(z10));
  nor2   g042(.a(x23), .b(new_n107_), .O(new_n126_));
  oai21  g043(.a(x22), .b(x08), .c(new_n86_), .O(new_n127_));
  oai21  g044(.a(new_n127_), .b(new_n126_), .c(new_n89_), .O(z11));
  ...
  oai21  g050(.a(new_n133_), .b(new_n132_), .c(new_n89_), .O(z13));
  ...
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n89_), .O(z22));
  ...
  nor2   g096(.a(x37), .b(new_n159_), .O(new_n180_));
  oai21  g097(.a(x36), .b(x09), .c(new_n86_), .O(new_n181_));
  oai21  g098(.a(new_n181_), .b(new_n180_), .c(new_n89_), .O(z25));
  ...
  aoi21  g106(.a(new_n183_), .b(new_n159_), .c(x10), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n89_), .O(z27));
  ...
  nand2  g126(.a(new_n196_), .b(new_n86_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(x43), .O(new_n211_));
  nand3  g128(.a(new_n196_), .b(x42), .c(new_n86_), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(new_n211_), .O(z31));
  inv1   g130(.a(x44), .O(new_n214_));
  nand3  g131(.a(new_n187_), .b(new_n86_), .c(x09), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(x43), .O(new_n216_));
  oai21  g133(.a(new_n215_), .b(new_n214_), .c(new_n216_), .O(z32));
  inv1   g134(.a(x45), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n187_), .c(x09), .O(new_n219_));
  nand2  g136(.a(new_n196_), .b(new_n214_), .O(new_n220_));
  ...
  nand3  g140(.a(new_n223_), .b(new_n187_), .c(x09), .O(new_n224_));
  nand2  g141(.a(new_n196_), .b(new_n218_), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n224_), .c(new_n86_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n89_), .O(z34));
  nand3  g144(.a(new_n187_), .b(x09), .c(new_n154_), .O(new_n228_));
  nand2  g145(.a(new_n196_), .b(new_n223_), .O(new_n229_));
