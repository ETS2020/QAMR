...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n89_, new_n90_,
    ...
    new_n271_, new_n272_;
  aoi21  g000(.a(x41), .b(x27), .c(x10), .O(new_n84_));
  ...
  nand2  g014(.a(x41), .b(x27), .O(new_n98_));
  ...
  nand2  g045(.a(new_n128_), .b(new_n98_), .O(z07));
  nand2  g046(.a(new_n125_), .b(new_n118_), .O(new_n130_));
  ...
  nand2  g096(.a(new_n175_), .b(new_n118_), .O(new_n180_));
  ...
  nand2  g103(.a(new_n181_), .b(new_n118_), .O(new_n187_));
  ...
  nand2  g118(.a(new_n198_), .b(new_n192_), .O(new_n202_));
  ...
  nand2  g123(.a(new_n203_), .b(new_n192_), .O(new_n207_));
  ...
  nand3  g141(.a(new_n224_), .b(new_n223_), .c(new_n100_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n98_), .O(z26));
  ...
  aoi21  g146(.a(new_n222_), .b(new_n192_), .c(x10), .O(new_n230_));
  ...
  nand3  g164(.a(new_n247_), .b(new_n246_), .c(new_n84_), .O(new_n248_));
  ...
  nand3  g169(.a(new_n252_), .b(new_n251_), .c(new_n100_), .O(new_n253_));
  nand2  g170(.a(new_n253_), .b(new_n98_), .O(z31));
  ...
  nand3  g174(.a(new_n257_), .b(new_n256_), .c(new_n100_), .O(new_n258_));
  nand2  g175(.a(new_n258_), .b(new_n98_), .O(z32));
  ...
  nand3  g188(.a(new_n271_), .b(new_n270_), .c(new_n100_), .O(new_n272_));
  nand2  g189(.a(new_n272_), .b(new_n98_), .O(z35));
endmodule
