...
module FAU ( 
  ...
  nand2  g042(.a(new_n84_), .b(x08), .O(new_n126_));
  nand2  g043(.a(new_n122_), .b(new_n116_), .O(new_n127_));
  nand3  g044(.a(new_n127_), .b(new_n126_), .c(new_n96_), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(new_n94_), .O(z08));
  inv1   g046(.a(x21), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(x08), .O(new_n131_));
  nand2  g048(.a(new_n84_), .b(new_n116_), .O(new_n132_));
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(new_n96_), .O(new_n133_));
  ...
  nand2  g056(.a(new_n135_), .b(new_n116_), .O(new_n140_));
  ...
  nand2  g073(.a(new_n151_), .b(new_n116_), .O(new_n157_));
  nand3  g074(.a(new_n157_), .b(new_n156_), .c(new_n96_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n94_), .O(z14));
  nand2  g076(.a(new_n155_), .b(new_n116_), .O(new_n160_));
  ...
  nand2  g088(.a(new_n166_), .b(new_n116_), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n96_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n94_), .O(z17));
  ...
  nand2  g104(.a(new_n85_), .b(new_n187_), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n186_), .c(new_n96_), .O(new_n189_));
  ...
  nand2  g112(.a(new_n192_), .b(new_n187_), .O(new_n196_));
  ...
  nand2  g117(.a(new_n197_), .b(new_n187_), .O(new_n201_));
  ...
  aoi21  g141(.a(new_n217_), .b(new_n187_), .c(x10), .O(new_n225_));
  ...
  nand3  g149(.a(new_n232_), .b(new_n229_), .c(new_n96_), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(new_n94_), .O(z28));
  ...
  nand3  g154(.a(new_n237_), .b(new_n236_), .c(new_n96_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n94_), .O(z29));
