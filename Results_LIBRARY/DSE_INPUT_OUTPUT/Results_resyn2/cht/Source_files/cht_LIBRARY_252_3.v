...
module FAU ( 
  ...
  nand2  g005(.a(x13), .b(x10), .O(new_n89_));
  ...
  oai21  g009(.a(x10), .b(new_n84_), .c(x13), .O(new_n93_));
  nand3  g010(.a(new_n86_), .b(x07), .c(x06), .O(new_n94_));
  nand2  g011(.a(new_n94_), .b(new_n93_), .O(z02));
  ...
  nand2  g032(.a(new_n115_), .b(new_n89_), .O(z08));
  nor2   g033(.a(x21), .b(new_n105_), .O(new_n117_));
  oai21  g034(.a(x20), .b(x08), .c(new_n86_), .O(new_n118_));
  oai21  g035(.a(new_n118_), .b(new_n117_), .c(new_n89_), .O(z09));
  ...
  nand2  g041(.a(new_n120_), .b(new_n105_), .O(new_n125_));
  ...
  nor2   g049(.a(x25), .b(new_n105_), .O(new_n133_));
  oai21  g050(.a(x24), .b(x08), .c(new_n86_), .O(new_n134_));
  oai21  g051(.a(new_n134_), .b(new_n133_), .c(new_n89_), .O(z13));
  ...
  oai21  g060(.a(new_n143_), .b(new_n142_), .c(new_n89_), .O(z16));
  ...
  oai21  g066(.a(new_n149_), .b(new_n148_), .c(new_n89_), .O(z18));
  ...
  oai21  g084(.a(new_n167_), .b(new_n166_), .c(new_n89_), .O(z23));
  nor2   g085(.a(x36), .b(new_n154_), .O(new_n169_));
  oai21  g086(.a(x35), .b(x09), .c(new_n86_), .O(new_n170_));
  nor2   g087(.a(new_n170_), .b(new_n169_), .O(z24));
  nor2   g088(.a(x37), .b(new_n154_), .O(new_n172_));
  oai21  g089(.a(x36), .b(x09), .c(new_n86_), .O(new_n173_));
  nor2   g090(.a(new_n173_), .b(new_n172_), .O(z25));
  ...
  nand2  g105(.a(new_n188_), .b(new_n89_), .O(z28));
  ...
  nand2  g110(.a(new_n193_), .b(new_n89_), .O(z29));
  ...
  nand2  g115(.a(new_n198_), .b(new_n89_), .O(z30));
  ...
  nand2  g125(.a(new_n208_), .b(new_n89_), .O(z32));
  ...
  nand2  g130(.a(new_n213_), .b(new_n89_), .O(z33));
