...
module FAU ( 
  ...
  nand2  g048(.a(new_n124_), .b(new_n118_), .O(new_n132_));
  ...
  aoi21  g052(.a(x21), .b(new_n118_), .c(new_n99_), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n135_), .c(x10), .O(z10));
  nand2  g054(.a(x23), .b(x08), .O(new_n138_));
  aoi21  g055(.a(x22), .b(new_n118_), .c(new_n99_), .O(new_n139_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n118_), .O(new_n144_));
  ...
  nand2  g065(.a(new_n141_), .b(new_n118_), .O(new_n149_));
  nand4  g066(.a(new_n149_), .b(new_n148_), .c(new_n84_), .d(x09), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z13));
  inv1   g068(.a(x26), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(x08), .O(new_n153_));
  nand2  g070(.a(new_n147_), .b(new_n118_), .O(new_n154_));
  ...
  aoi21  g079(.a(x27), .b(new_n118_), .c(new_n99_), .O(new_n163_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n118_), .O(new_n168_));
  ...
  aoi21  g088(.a(x29), .b(new_n118_), .c(new_n99_), .O(new_n172_));
  ...
  nand4  g115(.a(new_n198_), .b(new_n195_), .c(new_n84_), .d(x09), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z27));
  nand2  g117(.a(new_n197_), .b(x14), .O(new_n201_));
  inv1   g118(.a(x40), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n196_), .O(new_n203_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n196_), .O(new_n208_));
  ...
  nand2  g129(.a(new_n212_), .b(new_n196_), .O(new_n213_));
  ...
  aoi21  g133(.a(x43), .b(new_n196_), .c(new_n99_), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z31));
  nand2  g135(.a(x43), .b(x14), .O(new_n219_));
  aoi21  g136(.a(x44), .b(new_n196_), .c(new_n99_), .O(new_n220_));
  ...
  nand2  g141(.a(new_n224_), .b(new_n196_), .O(new_n225_));
  ...
  aoi21  g145(.a(x46), .b(new_n196_), .c(new_n99_), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z34));
  inv1   g147(.a(x46), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(x14), .O(new_n232_));
  nand2  g149(.a(new_n196_), .b(new_n174_), .O(new_n233_));
  nand4  g150(.a(new_n233_), .b(new_n232_), .c(new_n84_), .d(x09), .O(new_n234_));
