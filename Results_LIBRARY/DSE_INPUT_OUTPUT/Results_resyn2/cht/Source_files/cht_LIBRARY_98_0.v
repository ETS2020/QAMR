...
module FAU ( 
  ...
  nand2  g067(.a(new_n150_), .b(new_n116_), .O(new_n151_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n104_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n198_), .c(x09), .O(new_n201_));
  aoi21  g118(.a(x38), .b(new_n172_), .c(new_n86_), .O(new_n202_));
  ...
  nand2  g133(.a(new_n206_), .b(new_n216_), .O(new_n217_));
  ...
  aoi21  g137(.a(new_n206_), .b(x42), .c(new_n86_), .O(new_n221_));
  ...
  nand2  g142(.a(new_n206_), .b(new_n225_), .O(new_n226_));
  ...
  nand2  g147(.a(new_n206_), .b(new_n223_), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(new_n230_), .c(new_n87_), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(z33));
  nand2  g150(.a(new_n210_), .b(x46), .O(new_n234_));
  aoi21  g151(.a(new_n206_), .b(x45), .c(new_n86_), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n234_), .c(x10), .O(z34));
  nand3  g153(.a(new_n104_), .b(x09), .c(new_n197_), .O(new_n237_));
  inv1   g154(.a(x46), .O(new_n238_));
  nand2  g155(.a(new_n206_), .b(new_n238_), .O(new_n239_));
