...
module FAU ( 
  ...
  oai21  g066(.a(new_n149_), .b(new_n148_), .c(new_n92_), .O(z20));
  ...
  nand2  g078(.a(new_n157_), .b(new_n147_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n86_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n92_), .O(z24));
  nor2   g081(.a(x37), .b(new_n147_), .O(new_n165_));
  oai21  g082(.a(x36), .b(x09), .c(new_n86_), .O(new_n166_));
  oai21  g083(.a(new_n166_), .b(new_n165_), .c(new_n92_), .O(z25));
  ...
  aoi21  g091(.a(new_n168_), .b(new_n147_), .c(x10), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n92_), .O(z27));
  ...
  nand2  g110(.a(new_n193_), .b(new_n92_), .O(z30));
  ...
  nand2  g115(.a(new_n198_), .b(new_n92_), .O(z31));
  ...
  nand2  g120(.a(new_n203_), .b(new_n92_), .O(z32));
  ...
  nand2  g135(.a(new_n218_), .b(new_n92_), .O(z35));
endmodule
