...
module FAU ( 
  ...
  nand2  g014(.a(x10), .b(x08), .O(new_n98_));
  ...
  nor2   g049(.a(x27), .b(new_n107_), .O(new_n133_));
  ...
  oai21  g059(.a(new_n108_), .b(new_n139_), .c(new_n142_), .O(z18));
  ...
  oai21  g066(.a(new_n149_), .b(new_n148_), .c(new_n98_), .O(z20));
  ...
  aoi21  g072(.a(new_n154_), .b(x09), .c(new_n155_), .O(z22));
  inv1   g073(.a(x35), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(x09), .O(new_n158_));
  nand2  g075(.a(new_n154_), .b(new_n147_), .O(new_n159_));
  nand3  g076(.a(new_n159_), .b(new_n158_), .c(new_n86_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n98_), .O(z23));
  ...
  nand2  g082(.a(new_n165_), .b(new_n98_), .O(z24));
  nor2   g083(.a(x37), .b(new_n147_), .O(new_n167_));
  oai21  g084(.a(x36), .b(x09), .c(new_n86_), .O(new_n168_));
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n98_), .O(z25));
  ...
  aoi21  g093(.a(new_n170_), .b(new_n147_), .c(x10), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n98_), .O(z27));
  ...
  nand2  g107(.a(new_n190_), .b(new_n98_), .O(z29));
  ...
  nand2  g122(.a(new_n205_), .b(new_n98_), .O(z32));
