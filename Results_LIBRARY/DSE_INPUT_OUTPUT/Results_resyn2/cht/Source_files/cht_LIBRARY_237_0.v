...
module FAU ( 
  ...
  aoi21  g082(.a(x35), .b(new_n146_), .c(new_n86_), .O(new_n166_));
  aoi21  g083(.a(new_n166_), .b(new_n165_), .c(x10), .O(z24));
  nand2  g084(.a(x37), .b(x09), .O(new_n168_));
  aoi21  g085(.a(x36), .b(new_n146_), .c(new_n86_), .O(new_n169_));
  ...
  nand2  g097(.a(new_n171_), .b(new_n146_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n87_), .O(new_n182_));
  aoi21  g099(.a(new_n180_), .b(x09), .c(new_n182_), .O(z27));
  ...
  nor2   g106(.a(x14), .b(new_n146_), .O(new_n190_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n177_), .c(x09), .O(new_n198_));
  ...
  nand2  g121(.a(new_n186_), .b(new_n197_), .O(new_n205_));
  ...
  nand2  g126(.a(new_n186_), .b(new_n203_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n87_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z33));
  nand2  g129(.a(new_n190_), .b(x46), .O(new_n213_));
  aoi21  g130(.a(new_n186_), .b(x45), .c(new_n86_), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z34));
  nand2  g132(.a(new_n190_), .b(x00), .O(new_n216_));
  aoi21  g133(.a(new_n186_), .b(x46), .c(new_n86_), .O(new_n217_));
