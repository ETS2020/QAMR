...
module FAU ( 
  ...
  oai21  g037(.a(new_n120_), .b(new_n119_), .c(new_n93_), .O(z09));
  ...
  oai21  g048(.a(new_n131_), .b(new_n130_), .c(new_n93_), .O(z12));
  ...
  oai21  g054(.a(new_n137_), .b(new_n136_), .c(new_n93_), .O(z14));
  ...
  aoi21  g084(.a(new_n92_), .b(x09), .c(new_n167_), .O(z24));
  nor2   g085(.a(x37), .b(new_n154_), .O(new_n169_));
  oai21  g086(.a(x36), .b(x09), .c(new_n86_), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n93_), .O(z25));
  nor2   g088(.a(x38), .b(new_n154_), .O(new_n172_));
  ...
  nand2  g094(.a(x14), .b(new_n151_), .O(new_n178_));
  ...
  oai21  g100(.a(x14), .b(new_n154_), .c(new_n176_), .O(new_n184_));
  ...
  oai21  g105(.a(x14), .b(new_n154_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g120(.a(x14), .b(new_n154_), .c(new_n197_), .O(new_n204_));
  ...
  oai21  g125(.a(x14), .b(new_n154_), .c(new_n202_), .O(new_n209_));
  ...
  nand3  g133(.a(new_n175_), .b(x09), .c(new_n151_), .O(new_n217_));
