...
module FAU ( 
  ...
  nand2  g032(.a(new_n86_), .b(x18), .O(new_n116_));
  ...
  aoi21  g051(.a(new_n134_), .b(new_n113_), .c(x10), .O(z16));
  ...
  nand2  g076(.a(new_n159_), .b(new_n144_), .O(new_n160_));
  ...
  nand2  g081(.a(new_n157_), .b(new_n144_), .O(new_n165_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n144_), .O(new_n174_));
  ...
  nor2   g105(.a(x14), .b(new_n144_), .O(new_n189_));
  ...
  nand2  g112(.a(new_n189_), .b(x43), .O(new_n196_));
  aoi21  g113(.a(new_n185_), .b(x42), .c(x08), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z31));
  nand2  g115(.a(new_n189_), .b(x44), .O(new_n199_));
  aoi21  g116(.a(new_n185_), .b(x43), .c(x08), .O(new_n200_));
  ...
  nand3  g125(.a(new_n208_), .b(new_n177_), .c(x09), .O(new_n209_));
  ...
  nand3  g130(.a(new_n177_), .b(x09), .c(new_n213_), .O(new_n214_));
