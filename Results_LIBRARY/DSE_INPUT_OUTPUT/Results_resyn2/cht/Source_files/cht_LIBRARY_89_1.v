...
module FAU ( 
  ...
  nand2  g001(.a(x39), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g007(.a(x39), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand2  g052(.a(new_n84_), .b(x08), .O(new_n136_));
  nand2  g053(.a(new_n132_), .b(new_n121_), .O(new_n137_));
  nand3  g054(.a(new_n137_), .b(new_n136_), .c(new_n88_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n85_), .O(z09));
  inv1   g056(.a(x39), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(x08), .c(x21), .O(new_n141_));
  oai21  g058(.a(x22), .b(new_n121_), .c(new_n88_), .O(new_n142_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n85_), .O(z23));
  ...
  nand2  g132(.a(new_n215_), .b(new_n85_), .O(z24));
  ...
  nand2  g142(.a(new_n225_), .b(new_n85_), .O(z26));
  ...
  nand2  g152(.a(new_n235_), .b(new_n140_), .O(new_n236_));
  nand3  g153(.a(new_n236_), .b(new_n234_), .c(new_n91_), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(z28));
  inv1   g155(.a(x41), .O(new_n239_));
  nand3  g156(.a(new_n239_), .b(new_n101_), .c(x09), .O(new_n240_));
  nand2  g157(.a(new_n235_), .b(new_n233_), .O(new_n241_));
  nand3  g158(.a(new_n241_), .b(new_n240_), .c(new_n88_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n85_), .O(z29));
  ...
  nand2  g169(.a(new_n252_), .b(new_n85_), .O(z31));
  ...
  nand2  g174(.a(new_n257_), .b(new_n85_), .O(z32));
  ...
  nand3  g185(.a(new_n101_), .b(x09), .c(new_n186_), .O(new_n269_));
