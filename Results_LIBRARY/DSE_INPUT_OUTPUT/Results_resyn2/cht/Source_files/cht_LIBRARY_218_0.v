...
module FAU ( 
  ...
  nor2   g080(.a(x27), .b(new_n117_), .O(new_n164_));
  oai21  g081(.a(x26), .b(x08), .c(new_n89_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n86_), .O(z15));
  aoi21  g083(.a(x40), .b(new_n117_), .c(x28), .O(new_n167_));
  oai21  g084(.a(x27), .b(x08), .c(new_n89_), .O(new_n168_));
  nor2   g085(.a(new_n168_), .b(new_n167_), .O(z16));
  inv1   g086(.a(x29), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(x08), .O(new_n171_));
  nand2  g088(.a(new_n84_), .b(new_n117_), .O(new_n172_));
  ...
  nand2  g093(.a(new_n170_), .b(new_n117_), .O(new_n177_));
  ...
  nand2  g098(.a(new_n175_), .b(new_n117_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n181_), .c(new_n89_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n86_), .O(z19));
  ...
  nand2  g144(.a(new_n227_), .b(new_n86_), .O(z27));
  nand2  g145(.a(new_n223_), .b(x09), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(x28), .c(x40), .O(new_n230_));
  inv1   g147(.a(x39), .O(new_n231_));
  oai21  g148(.a(x14), .b(new_n185_), .c(new_n231_), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n89_), .O(new_n233_));
  nor2   g150(.a(new_n233_), .b(new_n230_), .O(z28));
  inv1   g151(.a(x41), .O(new_n235_));
  nand3  g152(.a(new_n235_), .b(new_n223_), .c(x09), .O(new_n236_));
  nand2  g153(.a(new_n229_), .b(new_n85_), .O(new_n237_));
  ...
  nand2  g158(.a(new_n229_), .b(new_n235_), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(new_n241_), .c(new_n92_), .O(new_n243_));
  inv1   g160(.a(new_n243_), .O(z30));
  inv1   g161(.a(x43), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(new_n223_), .c(x09), .O(new_n246_));
  nand2  g163(.a(new_n229_), .b(new_n240_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(new_n246_), .c(new_n92_), .O(new_n248_));
  inv1   g165(.a(new_n248_), .O(z31));
  inv1   g166(.a(x44), .O(new_n250_));
  nand3  g167(.a(new_n250_), .b(new_n223_), .c(x09), .O(new_n251_));
  nand2  g168(.a(new_n229_), .b(new_n245_), .O(new_n252_));
  nand3  g169(.a(new_n252_), .b(new_n251_), .c(new_n89_), .O(new_n253_));
  nand2  g170(.a(new_n253_), .b(new_n86_), .O(z32));
  inv1   g171(.a(x45), .O(new_n255_));
  nand3  g172(.a(new_n255_), .b(new_n223_), .c(x09), .O(new_n256_));
  nand2  g173(.a(new_n229_), .b(new_n250_), .O(new_n257_));
  nand3  g174(.a(new_n257_), .b(new_n256_), .c(new_n92_), .O(new_n258_));
  inv1   g175(.a(new_n258_), .O(z33));
  inv1   g176(.a(x46), .O(new_n260_));
  nand3  g177(.a(new_n260_), .b(new_n223_), .c(x09), .O(new_n261_));
  nand2  g178(.a(new_n229_), .b(new_n255_), .O(new_n262_));
  nand3  g179(.a(new_n262_), .b(new_n261_), .c(new_n89_), .O(new_n263_));
  nand2  g180(.a(new_n263_), .b(new_n86_), .O(z34));
  nand3  g181(.a(new_n223_), .b(x09), .c(new_n180_), .O(new_n265_));
  nand2  g182(.a(new_n229_), .b(new_n260_), .O(new_n266_));
