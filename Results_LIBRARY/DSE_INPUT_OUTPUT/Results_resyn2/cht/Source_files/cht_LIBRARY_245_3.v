...
module FAU ( 
  ...
  oai21  g046(.a(new_n113_), .b(new_n128_), .c(new_n129_), .O(z14));
  ...
  aoi21  g096(.a(new_n173_), .b(new_n151_), .c(x10), .O(new_n180_));
  ...
  nand3  g136(.a(new_n177_), .b(x09), .c(new_n143_), .O(new_n220_));
