...
module FAU ( 
  ...
  aoi21  g021(.a(x14), .b(new_n87_), .c(x25), .O(new_n105_));
  aoi21  g022(.a(new_n105_), .b(new_n104_), .c(x10), .O(z03));
  nand2  g023(.a(x07), .b(x02), .O(new_n107_));
  aoi21  g024(.a(x15), .b(new_n87_), .c(x25), .O(new_n108_));
  ...
  nand3  g066(.a(new_n86_), .b(x24), .c(new_n117_), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z13));
  nand3  g068(.a(new_n86_), .b(x26), .c(x08), .O(new_n152_));
  ...
  aoi21  g119(.a(x36), .b(new_n177_), .c(x25), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z25));
  nand2  g121(.a(x38), .b(x09), .O(new_n205_));
  aoi21  g122(.a(x37), .b(new_n177_), .c(x25), .O(new_n206_));
  ...
  aoi21  g129(.a(x38), .b(new_n177_), .c(x25), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n217_), .b(x39), .c(x25), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n216_), .c(x10), .O(z28));
  nand2  g136(.a(new_n215_), .b(x41), .O(new_n220_));
  aoi21  g137(.a(new_n217_), .b(x40), .c(x25), .O(new_n221_));
  ...
  nand3  g143(.a(new_n226_), .b(new_n224_), .c(new_n86_), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(z30));
  nand2  g145(.a(new_n215_), .b(x43), .O(new_n229_));
  aoi21  g146(.a(new_n217_), .b(x42), .c(x25), .O(new_n230_));
  ...
  aoi21  g160(.a(new_n217_), .b(x45), .c(x25), .O(new_n244_));
  aoi21  g161(.a(new_n244_), .b(new_n243_), .c(x10), .O(z34));
  nand2  g162(.a(new_n215_), .b(x00), .O(new_n246_));
  aoi21  g163(.a(new_n217_), .b(x46), .c(x25), .O(new_n247_));
