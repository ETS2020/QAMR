...
module FAU ( 
  ...
  aoi21  g034(.a(x17), .b(new_n117_), .c(x36), .O(new_n118_));
  ...
  nand2  g064(.a(new_n141_), .b(new_n117_), .O(new_n148_));
  ...
  aoi21  g078(.a(x27), .b(new_n117_), .c(x36), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(new_n161_), .c(x10), .O(z16));
  nand2  g080(.a(x29), .b(x08), .O(new_n164_));
  aoi21  g081(.a(x28), .b(new_n117_), .c(x36), .O(new_n165_));
  ...
  nand2  g091(.a(new_n167_), .b(new_n117_), .O(new_n175_));
  ...
  aoi21  g096(.a(x31), .b(new_n179_), .c(x36), .O(new_n180_));
  ...
  nor2   g133(.a(x14), .b(new_n179_), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(x41), .O(new_n218_));
  aoi21  g135(.a(new_n213_), .b(x40), .c(x36), .O(new_n219_));
  ...
  aoi21  g149(.a(new_n213_), .b(x43), .c(x36), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n232_), .c(x10), .O(z32));
  nand2  g151(.a(new_n217_), .b(x45), .O(new_n235_));
  aoi21  g152(.a(new_n213_), .b(x44), .c(x36), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(new_n235_), .c(x10), .O(z33));
  nand2  g154(.a(new_n217_), .b(x46), .O(new_n238_));
  aoi21  g155(.a(new_n213_), .b(x45), .c(x36), .O(new_n239_));
  aoi21  g156(.a(new_n239_), .b(new_n238_), .c(x10), .O(z34));
  nand3  g157(.a(new_n205_), .b(x09), .c(new_n173_), .O(new_n241_));
  inv1   g158(.a(x46), .O(new_n242_));
  nand2  g159(.a(new_n213_), .b(new_n242_), .O(new_n243_));
  nand3  g160(.a(new_n243_), .b(new_n241_), .c(new_n86_), .O(new_n244_));
