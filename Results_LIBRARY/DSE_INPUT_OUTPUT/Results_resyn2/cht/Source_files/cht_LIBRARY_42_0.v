...
module FAU ( 
  ...
  nand2  g040(.a(new_n84_), .b(x08), .O(new_n124_));
  nand2  g041(.a(new_n120_), .b(new_n117_), .O(new_n125_));
  nand3  g042(.a(new_n125_), .b(new_n124_), .c(new_n96_), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(new_n94_), .O(z07));
  aoi21  g044(.a(x26), .b(x08), .c(x19), .O(new_n128_));
  oai21  g045(.a(x20), .b(new_n117_), .c(new_n96_), .O(new_n129_));
  nor2   g046(.a(new_n129_), .b(new_n128_), .O(z08));
  ...
  nand2  g062(.a(new_n145_), .b(new_n94_), .O(z11));
  ...
  nand2  g067(.a(new_n150_), .b(new_n94_), .O(z12));
  ...
  aoi21  g073(.a(x19), .b(new_n117_), .c(x26), .O(new_n157_));
  oai21  g074(.a(x25), .b(x08), .c(new_n96_), .O(new_n158_));
  nor2   g075(.a(new_n158_), .b(new_n157_), .O(z14));
  inv1   g076(.a(x27), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x08), .O(new_n161_));
  nand2  g078(.a(new_n85_), .b(new_n117_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n96_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n94_), .O(z15));
  nand2  g081(.a(new_n160_), .b(new_n117_), .O(new_n165_));
  ...
  nand2  g086(.a(new_n166_), .b(new_n117_), .O(new_n170_));
  ...
  nand3  g106(.a(new_n189_), .b(new_n186_), .c(new_n96_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n94_), .O(z20));
  ...
  nand2  g127(.a(new_n210_), .b(new_n94_), .O(z24));
  ...
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(new_n96_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n94_), .O(z26));
  inv1   g138(.a(x39), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n102_), .O(new_n223_));
  ...
  nand3  g153(.a(new_n236_), .b(new_n235_), .c(new_n96_), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n94_), .O(z29));
  inv1   g155(.a(x42), .O(new_n239_));
  nand3  g156(.a(new_n239_), .b(new_n102_), .c(x09), .O(new_n240_));
  ...
  nand3  g168(.a(new_n251_), .b(new_n250_), .c(new_n96_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(new_n94_), .O(z32));
  ...
  nand3  g173(.a(new_n256_), .b(new_n255_), .c(new_n96_), .O(new_n257_));
  nand2  g174(.a(new_n257_), .b(new_n94_), .O(z33));
  ...
  nand3  g180(.a(new_n102_), .b(x09), .c(new_n181_), .O(new_n264_));
  oai21  g181(.a(x14), .b(new_n187_), .c(new_n259_), .O(new_n265_));
  nand3  g182(.a(new_n265_), .b(new_n264_), .c(new_n96_), .O(new_n266_));
  nand2  g183(.a(new_n266_), .b(new_n94_), .O(z35));
endmodule
