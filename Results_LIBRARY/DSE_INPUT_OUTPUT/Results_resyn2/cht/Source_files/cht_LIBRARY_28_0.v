...
module FAU ( 
  ...
  aoi21  g096(.a(x38), .b(new_n141_), .c(new_n86_), .O(new_n180_));
  ...
  nor2   g114(.a(x14), .b(new_n141_), .O(new_n198_));
  ...
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n91_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z33));
  nand2  g129(.a(new_n198_), .b(x46), .O(new_n213_));
  aoi21  g130(.a(new_n184_), .b(x45), .c(new_n86_), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z34));
  nand2  g132(.a(new_n198_), .b(x00), .O(new_n216_));
  aoi21  g133(.a(new_n184_), .b(x46), .c(new_n86_), .O(new_n217_));
