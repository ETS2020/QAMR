...
module FAU ( 
  ...
  aoi21  g069(.a(x33), .b(new_n143_), .c(new_n86_), .O(new_n153_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n143_), .O(new_n161_));
  ...
  nand2  g082(.a(new_n158_), .b(new_n143_), .O(new_n166_));
  ...
  aoi21  g092(.a(x38), .b(new_n143_), .c(new_n86_), .O(new_n176_));
  ...
  nor2   g100(.a(x14), .b(new_n143_), .O(new_n184_));
  ...
  nand3  g105(.a(new_n188_), .b(new_n101_), .c(x09), .O(new_n189_));
  ...
  nand2  g125(.a(new_n184_), .b(x46), .O(new_n209_));
  aoi21  g126(.a(new_n180_), .b(x45), .c(new_n86_), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z34));
  nand3  g128(.a(new_n101_), .b(x09), .c(new_n140_), .O(new_n212_));
  inv1   g129(.a(x46), .O(new_n213_));
  nand2  g130(.a(new_n180_), .b(new_n213_), .O(new_n214_));
