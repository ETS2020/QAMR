...
module FAU ( 
  ...
  nor2   g022(.a(x18), .b(new_n92_), .O(new_n106_));
  ...
  nor2   g044(.a(x25), .b(new_n92_), .O(new_n128_));
  ...
  nor2   g053(.a(x28), .b(new_n92_), .O(new_n137_));
  ...
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n93_), .O(z23));
  ...
  nand2  g098(.a(new_n181_), .b(new_n93_), .O(z28));
  ...
  nand2  g113(.a(new_n196_), .b(new_n93_), .O(z31));
  ...
  nand2  g118(.a(new_n201_), .b(new_n93_), .O(z32));
  ...
  nand2  g123(.a(new_n206_), .b(new_n93_), .O(z33));
  ...
  nand2  g128(.a(new_n211_), .b(new_n93_), .O(z34));
  ...
  nand2  g132(.a(new_n215_), .b(new_n93_), .O(z35));
endmodule
