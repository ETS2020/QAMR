...
module FAU ( 
  ...
  nand2  g035(.a(new_n91_), .b(x19), .O(new_n119_));
  inv1   g036(.a(new_n119_), .O(z07));
  nand2  g037(.a(new_n91_), .b(x20), .O(new_n121_));
  inv1   g038(.a(new_n121_), .O(z08));
  inv1   g039(.a(x21), .O(new_n123_));
  aoi21  g040(.a(new_n123_), .b(x08), .c(x10), .O(z09));
  nand2  g041(.a(new_n91_), .b(x22), .O(new_n125_));
  inv1   g042(.a(new_n125_), .O(z10));
  nand2  g043(.a(new_n91_), .b(x23), .O(new_n127_));
  ...
  nand2  g113(.a(new_n183_), .b(new_n196_), .O(new_n197_));
  ...
  nand2  g118(.a(new_n183_), .b(new_n194_), .O(new_n202_));
  ...
  nand2  g123(.a(new_n183_), .b(new_n200_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n91_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z33));
  nand2  g126(.a(new_n187_), .b(x46), .O(new_n210_));
  aoi21  g127(.a(new_n183_), .b(x45), .c(new_n86_), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z34));
  nand3  g129(.a(new_n101_), .b(x09), .c(new_n143_), .O(new_n213_));
  inv1   g130(.a(x46), .O(new_n214_));
  nand2  g131(.a(new_n183_), .b(new_n214_), .O(new_n215_));
