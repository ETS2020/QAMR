...
module FAU ( 
  ...
  nand3  g083(.a(new_n166_), .b(new_n165_), .c(new_n94_), .O(new_n167_));
  ...
  aoi21  g091(.a(x37), .b(new_n146_), .c(new_n86_), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z26));
  nand2  g093(.a(x14), .b(new_n143_), .O(new_n177_));
  oai21  g094(.a(x39), .b(x14), .c(new_n177_), .O(new_n178_));
  inv1   g095(.a(x38), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n146_), .O(new_n180_));
  ...
  nand2  g101(.a(new_n101_), .b(x09), .O(new_n185_));
  ...
  aoi21  g105(.a(new_n185_), .b(x40), .c(new_n86_), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z29));
  nand2  g107(.a(new_n183_), .b(x42), .O(new_n191_));
  aoi21  g108(.a(new_n185_), .b(x41), .c(new_n86_), .O(new_n192_));
  ...
  aoi21  g117(.a(new_n185_), .b(x43), .c(new_n86_), .O(new_n201_));
  ...
  nand3  g123(.a(new_n206_), .b(new_n204_), .c(new_n94_), .O(new_n207_));
  ...
  nand3  g130(.a(new_n101_), .b(x09), .c(new_n143_), .O(new_n214_));
  nand2  g131(.a(new_n185_), .b(new_n209_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n94_), .O(new_n216_));
