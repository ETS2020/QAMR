...
module FAU ( 
  ...
  aoi21  g083(.a(x37), .b(new_n143_), .c(x08), .O(new_n167_));
  ...
  nand3  g093(.a(new_n176_), .b(new_n103_), .c(x09), .O(new_n177_));
  nand2  g094(.a(new_n103_), .b(x09), .O(new_n178_));
  ...
  nor2   g118(.a(x14), .b(new_n143_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(x45), .O(new_n203_));
  aoi21  g120(.a(new_n178_), .b(x44), .c(x08), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z33));
  nand2  g122(.a(new_n202_), .b(x46), .O(new_n206_));
  aoi21  g123(.a(new_n178_), .b(x45), .c(x08), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z34));
  nand3  g125(.a(new_n103_), .b(x09), .c(new_n169_), .O(new_n209_));
