...
module FAU ( 
  ...
  nor2   g002(.a(x13), .b(x10), .O(new_n86_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n107_), .O(new_n163_));
  ...
  aoi21  g084(.a(x31), .b(new_n167_), .c(x13), .O(new_n168_));
  ...
  aoi21  g113(.a(x37), .b(new_n167_), .c(x13), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z26));
  nand2  g115(.a(x14), .b(new_n160_), .O(new_n199_));
  ...
  aoi21  g120(.a(x38), .b(new_n167_), .c(x13), .O(new_n204_));
  ...
  nand3  g129(.a(new_n212_), .b(new_n200_), .c(x09), .O(new_n213_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n200_), .c(x09), .O(new_n228_));
  ...
  nand3  g149(.a(new_n232_), .b(new_n200_), .c(x09), .O(new_n233_));
  ...
  nand3  g153(.a(x46), .b(new_n200_), .c(x09), .O(new_n237_));
  aoi21  g154(.a(new_n208_), .b(x45), .c(x13), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(new_n237_), .c(x10), .O(z34));
  nand3  g156(.a(new_n200_), .b(x09), .c(new_n160_), .O(new_n240_));
