...
module FAU ( 
  ...
  aoi21  g052(.a(x22), .b(new_n113_), .c(new_n86_), .O(new_n136_));
  ...
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n91_), .O(new_n173_));
  ...
  nand3  g096(.a(new_n179_), .b(new_n176_), .c(new_n91_), .O(new_n180_));
  inv1   g097(.a(new_n180_), .O(z20));
  nor2   g098(.a(x32), .b(x09), .O(new_n182_));
  nor3   g099(.a(new_n182_), .b(new_n86_), .c(x10), .O(z21));
  nor3   g100(.a(x34), .b(new_n86_), .c(new_n177_), .O(new_n184_));
  nor2   g101(.a(new_n184_), .b(x10), .O(z22));
  nand2  g102(.a(x35), .b(x09), .O(new_n186_));
  aoi21  g103(.a(x34), .b(new_n177_), .c(new_n86_), .O(new_n187_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n177_), .O(new_n201_));
  ...
  nand3  g152(.a(new_n211_), .b(x09), .c(new_n170_), .O(new_n236_));
  inv1   g153(.a(x46), .O(new_n237_));
  nand2  g154(.a(new_n212_), .b(new_n237_), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(new_n236_), .c(new_n91_), .O(new_n239_));
