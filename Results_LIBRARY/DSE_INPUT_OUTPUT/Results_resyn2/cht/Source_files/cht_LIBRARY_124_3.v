...
module FAU ( 
  ...
  oai21  g095(.a(x14), .b(new_n150_), .c(new_n170_), .O(new_n179_));
  ...
  nand2  g102(.a(new_n185_), .b(new_n95_), .O(z29));
  ...
  nand2  g107(.a(new_n190_), .b(new_n95_), .O(z30));
  ...
  nand2  g117(.a(new_n200_), .b(new_n95_), .O(z32));
  ...
  nand2  g122(.a(new_n205_), .b(new_n95_), .O(z33));
  ...
  oai21  g129(.a(x14), .b(new_n150_), .c(new_n207_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(new_n86_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n95_), .O(z35));
endmodule
