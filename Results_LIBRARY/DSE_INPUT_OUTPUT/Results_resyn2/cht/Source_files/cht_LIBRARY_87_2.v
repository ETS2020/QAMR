...
module FAU ( 
  ...
  aoi21  g049(.a(x21), .b(new_n115_), .c(x09), .O(new_n133_));
  ...
  aoi21  g063(.a(x24), .b(new_n115_), .c(x09), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n146_), .c(x10), .O(z13));
  nand2  g065(.a(x26), .b(x08), .O(new_n149_));
  aoi21  g066(.a(x25), .b(new_n115_), .c(x09), .O(new_n150_));
  ...
  nand2  g085(.a(new_n168_), .b(new_n115_), .O(new_n169_));
  ...
  nand2  g090(.a(new_n166_), .b(new_n115_), .O(new_n174_));
  ...
  nand2  g098(.a(new_n86_), .b(x33), .O(new_n182_));
  ...
  nand2  g108(.a(new_n86_), .b(x38), .O(new_n192_));
