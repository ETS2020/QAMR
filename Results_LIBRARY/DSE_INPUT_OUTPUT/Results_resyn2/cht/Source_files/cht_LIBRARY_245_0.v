...
module FAU ( 
  ...
  aoi21  g091(.a(x38), .b(new_n144_), .c(new_n86_), .O(new_n175_));
  ...
  nand3  g102(.a(new_n185_), .b(new_n171_), .c(x09), .O(new_n186_));
  ...
  nand2  g107(.a(new_n177_), .b(x43), .O(new_n191_));
  aoi21  g108(.a(new_n179_), .b(x42), .c(new_n86_), .O(new_n192_));
  ...
  nand2  g113(.a(new_n179_), .b(new_n196_), .O(new_n197_));
  ...
  nand2  g118(.a(new_n179_), .b(new_n194_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n87_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z33));
  inv1   g121(.a(x46), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n171_), .c(x09), .O(new_n206_));
  nand2  g123(.a(new_n179_), .b(new_n200_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n87_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z34));
  nand2  g126(.a(new_n177_), .b(x00), .O(new_n210_));
  aoi21  g127(.a(new_n179_), .b(x46), .c(new_n86_), .O(new_n211_));
