...
module FAU ( 
  ...
  nor2   g035(.a(x22), .b(new_n95_), .O(new_n119_));
  ...
  nor2   g050(.a(x27), .b(new_n95_), .O(new_n134_));
  ...
  oai21  g098(.a(x14), .b(new_n154_), .c(new_n174_), .O(new_n182_));
  ...
  oai21  g103(.a(x14), .b(new_n154_), .c(new_n180_), .O(new_n187_));
  ...
  nand2  g120(.a(new_n203_), .b(new_n96_), .O(z32));
  ...
  nand2  g125(.a(new_n208_), .b(new_n96_), .O(z33));
  ...
  oai21  g132(.a(x14), .b(new_n154_), .c(new_n210_), .O(new_n216_));
