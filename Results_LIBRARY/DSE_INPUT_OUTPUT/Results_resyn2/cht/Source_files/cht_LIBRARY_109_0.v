...
module FAU ( 
  ...
  nand2  g031(.a(new_n114_), .b(new_n109_), .O(new_n115_));
  nand3  g032(.a(new_n115_), .b(new_n113_), .c(new_n87_), .O(new_n116_));
  inv1   g033(.a(new_n116_), .O(z07));
  nand2  g034(.a(x20), .b(x08), .O(new_n118_));
  aoi21  g035(.a(x19), .b(new_n109_), .c(new_n86_), .O(new_n119_));
  ...
  nand2  g083(.a(new_n159_), .b(new_n109_), .O(new_n167_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n172_), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n199_), .c(new_n87_), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z26));
  nand2  g120(.a(x14), .b(new_n165_), .O(new_n204_));
  oai21  g121(.a(x39), .b(x14), .c(new_n204_), .O(new_n205_));
  nand2  g122(.a(new_n198_), .b(new_n172_), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n87_), .O(new_n207_));
  aoi21  g124(.a(new_n205_), .b(x09), .c(new_n207_), .O(z27));
  nor2   g125(.a(x14), .b(new_n172_), .O(new_n209_));
  ...
  inv1   g132(.a(new_n87_), .O(new_n216_));
  aoi21  g133(.a(new_n212_), .b(new_n215_), .c(new_n216_), .O(z29));
  inv1   g134(.a(x42), .O(new_n218_));
  aoi21  g135(.a(new_n209_), .b(new_n218_), .c(new_n216_), .O(z30));
  inv1   g136(.a(x43), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(new_n211_), .c(x09), .O(new_n221_));
  nand2  g138(.a(new_n212_), .b(new_n218_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(new_n87_), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(z31));
  inv1   g141(.a(x44), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n211_), .c(x09), .O(new_n226_));
  nand2  g143(.a(new_n212_), .b(new_n220_), .O(new_n227_));
  ...
  nand2  g148(.a(new_n212_), .b(new_n225_), .O(new_n232_));
  ...
  nand3  g156(.a(new_n211_), .b(x09), .c(new_n165_), .O(new_n240_));
  nand2  g157(.a(new_n212_), .b(new_n235_), .O(new_n241_));
