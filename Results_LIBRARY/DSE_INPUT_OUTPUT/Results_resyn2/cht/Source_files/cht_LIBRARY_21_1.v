...
module FAU ( 
  ...
  aoi21  g001(.a(x17), .b(new_n84_), .c(x10), .O(new_n85_));
  ...
  nand2  g015(.a(x17), .b(new_n84_), .O(new_n99_));
  ...
  nand2  g047(.a(new_n127_), .b(new_n119_), .O(new_n131_));
  ...
  nand2  g069(.a(new_n146_), .b(new_n119_), .O(new_n153_));
  ...
  nand2  g074(.a(new_n151_), .b(new_n119_), .O(new_n158_));
  ...
  nand3  g080(.a(new_n163_), .b(new_n162_), .c(new_n101_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n99_), .O(z14));
  ...
  nand2  g086(.a(new_n169_), .b(new_n99_), .O(z15));
  ...
  nand2  g092(.a(new_n171_), .b(new_n119_), .O(new_n176_));
  ...
  nand2  g099(.a(new_n177_), .b(new_n119_), .O(new_n183_));
  ...
  nand2  g139(.a(new_n218_), .b(new_n193_), .O(new_n223_));
  ...
  aoi21  g147(.a(new_n224_), .b(new_n193_), .c(x10), .O(new_n231_));
  ...
  nand3  g160(.a(new_n243_), .b(new_n242_), .c(new_n101_), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(new_n99_), .O(z29));
  ...
  nand3  g165(.a(new_n248_), .b(new_n247_), .c(new_n101_), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n99_), .O(z30));
  inv1   g167(.a(x43), .O(new_n251_));
  nand3  g168(.a(new_n251_), .b(new_n104_), .c(x09), .O(new_n252_));
  ...
  nand3  g173(.a(new_n256_), .b(new_n104_), .c(x09), .O(new_n257_));
  ...
  nand3  g178(.a(new_n261_), .b(new_n104_), .c(x09), .O(new_n262_));
  nand2  g179(.a(new_n237_), .b(new_n256_), .O(new_n263_));
  nand3  g180(.a(new_n263_), .b(new_n262_), .c(new_n85_), .O(new_n264_));
  inv1   g181(.a(new_n264_), .O(z33));
  inv1   g182(.a(x46), .O(new_n266_));
  nand3  g183(.a(new_n266_), .b(new_n104_), .c(x09), .O(new_n267_));
  ...
  nand3  g187(.a(new_n104_), .b(x09), .c(new_n186_), .O(new_n271_));
  nand2  g188(.a(new_n237_), .b(new_n266_), .O(new_n272_));
  nand3  g189(.a(new_n272_), .b(new_n271_), .c(new_n85_), .O(new_n273_));
