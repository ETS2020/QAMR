...
module FAU ( 
  ...
  aoi21  g000(.a(x31), .b(x20), .c(x10), .O(new_n84_));
  ...
  nand2  g008(.a(x31), .b(x20), .O(new_n92_));
  ...
  nand2  g075(.a(new_n154_), .b(new_n114_), .O(new_n159_));
  ...
  nand2  g080(.a(new_n160_), .b(new_n114_), .O(new_n164_));
  ...
  nand2  g087(.a(new_n165_), .b(new_n114_), .O(new_n171_));
  ...
  nand2  g092(.a(new_n169_), .b(new_n114_), .O(new_n176_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n92_), .O(z27));
  ...
  nand3  g149(.a(new_n232_), .b(new_n229_), .c(new_n94_), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(new_n92_), .O(z28));
  ...
  nand3  g154(.a(new_n237_), .b(new_n236_), .c(new_n94_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n92_), .O(z29));
  ...
  nand3  g179(.a(new_n262_), .b(new_n261_), .c(new_n94_), .O(new_n263_));
  nand2  g180(.a(new_n263_), .b(new_n92_), .O(z34));
  nand3  g181(.a(new_n222_), .b(x09), .c(new_n179_), .O(new_n265_));
  nand2  g182(.a(new_n231_), .b(new_n260_), .O(new_n266_));
  nand3  g183(.a(new_n266_), .b(new_n265_), .c(new_n94_), .O(new_n267_));
  nand2  g184(.a(new_n267_), .b(new_n92_), .O(z35));
endmodule
