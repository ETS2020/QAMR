...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n93_), .O(z09));
  ...
  oai21  g054(.a(new_n137_), .b(new_n136_), .c(new_n93_), .O(z15));
  ...
  oai21  g070(.a(new_n153_), .b(new_n152_), .c(new_n93_), .O(z20));
  ...
  oai21  g098(.a(x14), .b(new_n151_), .c(new_n174_), .O(new_n182_));
  ...
  oai21  g103(.a(x14), .b(new_n151_), .c(new_n180_), .O(new_n187_));
  ...
  nand2  g115(.a(new_n198_), .b(new_n93_), .O(z31));
  ...
  nand2  g120(.a(new_n203_), .b(new_n93_), .O(z32));
  ...
  nand3  g126(.a(new_n92_), .b(new_n173_), .c(x09), .O(new_n210_));
  oai21  g127(.a(x14), .b(new_n151_), .c(new_n205_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n86_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n173_), .b(x09), .c(new_n148_), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n151_), .c(new_n92_), .O(new_n215_));
