...
module FAU ( 
  ...
  nand2  g045(.a(new_n128_), .b(new_n112_), .O(new_n129_));
  ...
  nand3  g068(.a(new_n151_), .b(new_n150_), .c(new_n93_), .O(new_n152_));
  ...
  nand2  g090(.a(new_n93_), .b(x31), .O(new_n174_));
  inv1   g091(.a(new_n174_), .O(z20));
  nand2  g092(.a(new_n93_), .b(x32), .O(new_n176_));
  ...
  aoi21  g098(.a(new_n181_), .b(new_n178_), .c(x10), .O(z23));
  nand2  g099(.a(new_n93_), .b(x35), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z24));
  nand2  g101(.a(new_n93_), .b(x36), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z25));
  nand2  g103(.a(new_n93_), .b(x37), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(z26));
  nand2  g105(.a(new_n93_), .b(x38), .O(new_n189_));
  inv1   g106(.a(new_n189_), .O(z27));
  nand2  g107(.a(new_n93_), .b(x39), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z28));
  nand2  g109(.a(new_n93_), .b(x40), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z29));
  nand2  g111(.a(new_n93_), .b(x41), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z30));
  inv1   g113(.a(x42), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n178_), .c(x10), .O(z31));
  nand2  g115(.a(new_n93_), .b(x43), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  nand2  g117(.a(new_n93_), .b(x44), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z33));
  nand2  g119(.a(new_n93_), .b(x45), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand2  g121(.a(new_n93_), .b(x46), .O(new_n205_));
