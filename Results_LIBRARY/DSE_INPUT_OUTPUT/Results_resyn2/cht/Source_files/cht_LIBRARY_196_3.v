...
module FAU ( 
  ...
  nand2  g000(.a(x28), .b(x10), .O(new_n84_));
  ...
  nand2  g052(.a(new_n87_), .b(new_n108_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(x28), .O(new_n137_));
  oai21  g054(.a(new_n136_), .b(new_n133_), .c(new_n137_), .O(z16));
  ...
  oai21  g070(.a(x31), .b(x09), .c(new_n87_), .O(new_n154_));
  nor2   g071(.a(new_n154_), .b(new_n153_), .O(z20));
  inv1   g072(.a(x33), .O(new_n156_));
  oai21  g073(.a(x32), .b(x09), .c(new_n87_), .O(new_n157_));
  aoi21  g074(.a(new_n156_), .b(x09), .c(new_n157_), .O(z21));
  ...
  nor2   g080(.a(x35), .b(new_n152_), .O(new_n164_));
  ...
  aoi21  g100(.a(new_n175_), .b(new_n152_), .c(x10), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n84_), .O(z27));
  ...
  nand2  g109(.a(new_n192_), .b(new_n84_), .O(z28));
  ...
  nand2  g129(.a(new_n212_), .b(new_n84_), .O(z32));
  ...
  nand3  g140(.a(new_n181_), .b(x09), .c(new_n147_), .O(new_n224_));
