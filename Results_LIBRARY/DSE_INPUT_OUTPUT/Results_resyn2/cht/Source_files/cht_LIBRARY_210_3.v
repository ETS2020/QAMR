...
module FAU ( 
  ...
  nand2  g029(.a(new_n112_), .b(new_n95_), .O(z07));
  nor2   g030(.a(x20), .b(new_n110_), .O(new_n114_));
  oai21  g031(.a(x19), .b(x08), .c(new_n86_), .O(new_n115_));
  oai21  g032(.a(new_n115_), .b(new_n114_), .c(new_n95_), .O(z08));
  ...
  nand2  g040(.a(new_n123_), .b(new_n95_), .O(z10));
  nand2  g041(.a(new_n86_), .b(new_n110_), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(x23), .O(new_n126_));
  oai21  g043(.a(new_n125_), .b(new_n120_), .c(new_n126_), .O(z11));
  oai21  g044(.a(x10), .b(new_n110_), .c(x23), .O(new_n128_));
  nand3  g045(.a(x24), .b(new_n86_), .c(x08), .O(new_n129_));
  ...
  oai21  g071(.a(new_n154_), .b(new_n153_), .c(new_n95_), .O(z20));
  ...
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n95_), .O(z22));
  ...
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n95_), .O(z26));
  ...
  nand2  g103(.a(new_n186_), .b(new_n95_), .O(z28));
  ...
  nand2  g113(.a(new_n196_), .b(new_n95_), .O(z30));
  ...
  nand2  g133(.a(new_n216_), .b(new_n95_), .O(z34));
