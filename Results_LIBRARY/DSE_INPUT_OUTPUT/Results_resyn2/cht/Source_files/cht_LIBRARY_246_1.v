...
module FAU ( 
  ...
  aoi21  g010(.a(x20), .b(new_n84_), .c(x10), .O(new_n94_));
  ...
  aoi21  g030(.a(new_n113_), .b(x07), .c(x16), .O(new_n114_));
  oai21  g031(.a(new_n86_), .b(x03), .c(new_n88_), .O(new_n115_));
  ...
  nand3  g043(.a(new_n126_), .b(new_n124_), .c(new_n94_), .O(new_n127_));
  inv1   g044(.a(new_n127_), .O(z07));
  nand2  g045(.a(new_n125_), .b(new_n117_), .O(new_n129_));
  nand2  g046(.a(new_n113_), .b(x08), .O(new_n130_));
  ...
  nand2  g051(.a(new_n113_), .b(new_n117_), .O(new_n135_));
  ...
  nand2  g063(.a(new_n146_), .b(new_n85_), .O(z11));
  nand2  g064(.a(new_n143_), .b(new_n117_), .O(new_n148_));
  ...
  nand2  g069(.a(new_n149_), .b(new_n117_), .O(new_n153_));
  ...
  nand2  g079(.a(new_n159_), .b(new_n117_), .O(new_n163_));
  ...
  nand2  g086(.a(new_n164_), .b(new_n117_), .O(new_n170_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n190_), .c(new_n94_), .O(new_n193_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n195_), .c(new_n94_), .O(new_n198_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n200_), .c(new_n94_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z22));
  nand2  g121(.a(new_n201_), .b(new_n188_), .O(new_n205_));
  inv1   g122(.a(x35), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(x09), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n205_), .c(new_n94_), .O(new_n208_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n85_), .O(z26));
  ...
  nand3  g167(.a(new_n250_), .b(new_n249_), .c(new_n94_), .O(new_n251_));
  ...
  nand3  g172(.a(new_n255_), .b(new_n254_), .c(new_n94_), .O(new_n256_));
