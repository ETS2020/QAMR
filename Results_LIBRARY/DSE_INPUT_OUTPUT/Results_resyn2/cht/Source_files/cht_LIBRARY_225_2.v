...
module FAU ( 
  ...
  inv1   g000(.a(x42), .O(new_n84_));
  nand2  g001(.a(new_n84_), .b(x41), .O(new_n85_));
  ...
  aoi21  g007(.a(new_n84_), .b(x41), .c(x10), .O(new_n91_));
  ...
  oai21  g156(.a(x14), .b(new_n190_), .c(new_n233_), .O(new_n240_));
  nand3  g157(.a(new_n240_), .b(new_n239_), .c(new_n88_), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n85_), .O(z29));
  nand2  g159(.a(new_n225_), .b(x09), .O(new_n243_));
  nand2  g160(.a(x42), .b(new_n88_), .O(new_n244_));
  aoi21  g161(.a(new_n243_), .b(new_n238_), .c(new_n244_), .O(z30));
  inv1   g162(.a(x43), .O(new_n246_));
  nand3  g163(.a(new_n246_), .b(new_n225_), .c(x09), .O(new_n247_));
  oai21  g164(.a(x14), .b(new_n190_), .c(new_n84_), .O(new_n248_));
