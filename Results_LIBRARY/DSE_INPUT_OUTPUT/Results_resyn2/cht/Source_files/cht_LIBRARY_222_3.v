...
module FAU ( 
  ...
  nand2  g011(.a(x25), .b(x10), .O(new_n95_));
  ...
  oai21  g033(.a(new_n116_), .b(new_n115_), .c(new_n95_), .O(z09));
  ...
  nand2  g088(.a(new_n171_), .b(new_n95_), .O(z25));
  ...
  nand2  g093(.a(new_n176_), .b(new_n95_), .O(z26));
  ...
  nand2  g100(.a(new_n183_), .b(new_n95_), .O(z27));
  ...
  nand2  g107(.a(new_n190_), .b(new_n95_), .O(z28));
  ...
  nand2  g112(.a(new_n195_), .b(new_n95_), .O(z29));
  ...
  nand2  g122(.a(new_n205_), .b(new_n95_), .O(z31));
  ...
  nand2  g137(.a(new_n220_), .b(new_n95_), .O(z34));
  ...
  nand2  g141(.a(new_n224_), .b(new_n95_), .O(z35));
endmodule
