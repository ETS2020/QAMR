...
module FAU ( 
  ...
  aoi21  g013(.a(x43), .b(new_n84_), .c(x10), .O(new_n97_));
  ...
  nand2  g127(.a(new_n205_), .b(new_n188_), .O(new_n211_));
  ...
  nand2  g142(.a(x14), .b(new_n184_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n225_), .O(new_n227_));
  nand2  g144(.a(new_n220_), .b(new_n188_), .O(new_n228_));
  ...
  oai21  g149(.a(x14), .b(new_n188_), .c(new_n224_), .O(new_n233_));
  ...
  oai21  g154(.a(x14), .b(new_n188_), .c(new_n231_), .O(new_n238_));
  ...
  oai21  g159(.a(x14), .b(new_n188_), .c(new_n236_), .O(new_n243_));
  nand3  g160(.a(new_n243_), .b(new_n242_), .c(new_n88_), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(new_n85_), .O(z30));
  nand3  g162(.a(new_n195_), .b(new_n98_), .c(x09), .O(new_n246_));
  oai21  g163(.a(x14), .b(new_n188_), .c(new_n241_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(new_n246_), .c(new_n97_), .O(new_n248_));
  inv1   g165(.a(new_n248_), .O(z31));
  inv1   g166(.a(x44), .O(new_n250_));
  nand3  g167(.a(new_n250_), .b(new_n98_), .c(x09), .O(new_n251_));
  oai21  g168(.a(x14), .b(new_n188_), .c(new_n195_), .O(new_n252_));
  nand3  g169(.a(new_n252_), .b(new_n251_), .c(new_n97_), .O(new_n253_));
  inv1   g170(.a(new_n253_), .O(z32));
  inv1   g171(.a(x45), .O(new_n255_));
  nand3  g172(.a(new_n255_), .b(new_n98_), .c(x09), .O(new_n256_));
  ...
  nand3  g177(.a(new_n260_), .b(new_n98_), .c(x09), .O(new_n261_));
  ...
  nand3  g181(.a(new_n98_), .b(x09), .c(new_n184_), .O(new_n265_));
  oai21  g182(.a(x14), .b(new_n188_), .c(new_n260_), .O(new_n266_));
  nand3  g183(.a(new_n266_), .b(new_n265_), .c(new_n97_), .O(new_n267_));
