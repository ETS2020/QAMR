...
module FAU ( 
  ...
  nand2  g000(.a(x45), .b(x34), .O(new_n84_));
  ...
  aoi21  g006(.a(x45), .b(x34), .c(x10), .O(new_n90_));
  ...
  nand3  g066(.a(new_n149_), .b(new_n147_), .c(new_n90_), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z12));
  inv1   g068(.a(x25), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(x08), .O(new_n153_));
  nand2  g070(.a(new_n148_), .b(new_n117_), .O(new_n154_));
  ...
  nand2  g075(.a(new_n152_), .b(new_n117_), .O(new_n159_));
  ...
  nand2  g110(.a(new_n187_), .b(new_n189_), .O(new_n194_));
  ...
  nand2  g117(.a(new_n195_), .b(new_n189_), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n200_), .c(new_n87_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n84_), .O(z22));
  inv1   g120(.a(x35), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(x09), .O(new_n205_));
  nand2  g122(.a(new_n199_), .b(new_n189_), .O(new_n206_));
  ...
  aoi21  g144(.a(new_n219_), .b(new_n189_), .c(x10), .O(new_n228_));
  ...
  nand3  g177(.a(new_n260_), .b(new_n259_), .c(new_n87_), .O(new_n261_));
  nand2  g178(.a(new_n261_), .b(new_n84_), .O(z33));
