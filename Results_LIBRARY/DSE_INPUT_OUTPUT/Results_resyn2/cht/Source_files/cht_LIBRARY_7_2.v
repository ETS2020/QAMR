...
module FAU ( 
  ...
  nor2   g089(.a(x36), .b(new_n156_), .O(new_n173_));
  oai21  g090(.a(x35), .b(x09), .c(new_n86_), .O(new_n174_));
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n93_), .O(z24));
  ...
  nand2  g097(.a(new_n176_), .b(new_n156_), .O(new_n181_));
  ...
  nand3  g114(.a(new_n92_), .b(new_n185_), .c(x09), .O(new_n198_));
  nand2  g115(.a(new_n194_), .b(new_n191_), .O(new_n199_));
  ...
  nand2  g120(.a(new_n194_), .b(new_n92_), .O(new_n204_));
  ...
  nand2  g125(.a(new_n194_), .b(new_n202_), .O(new_n209_));
  ...
  nand2  g130(.a(new_n194_), .b(new_n207_), .O(new_n214_));
  ...
  nand2  g135(.a(new_n194_), .b(new_n212_), .O(new_n219_));
  ...
  nand2  g140(.a(new_n194_), .b(new_n217_), .O(new_n224_));
