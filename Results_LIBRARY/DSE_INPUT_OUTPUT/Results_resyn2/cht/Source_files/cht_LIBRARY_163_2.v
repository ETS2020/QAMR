...
module FAU ( 
  ...
  nand2  g050(.a(new_n133_), .b(new_n118_), .O(new_n134_));
  ...
  nand2  g055(.a(new_n131_), .b(new_n118_), .O(new_n139_));
  ...
  aoi21  g090(.a(x29), .b(new_n118_), .c(x09), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z18));
  nand2  g092(.a(x08), .b(x00), .O(new_n176_));
  aoi21  g093(.a(x30), .b(new_n118_), .c(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z19));
  nand2  g095(.a(new_n86_), .b(x31), .O(new_n179_));
  inv1   g096(.a(new_n179_), .O(z20));
  nand2  g097(.a(new_n86_), .b(x32), .O(new_n181_));
  ...
  nand2  g108(.a(new_n86_), .b(x37), .O(new_n192_));
  ...
  aoi21  g115(.a(new_n198_), .b(new_n183_), .c(x10), .O(z29));
  inv1   g116(.a(x41), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n183_), .c(x10), .O(z30));
  nand2  g118(.a(new_n86_), .b(x42), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z31));
  inv1   g120(.a(x43), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n183_), .c(x10), .O(z32));
  nand2  g122(.a(new_n86_), .b(x44), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z33));
  nand2  g124(.a(new_n86_), .b(x45), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z34));
  inv1   g126(.a(x46), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n183_), .c(x10), .O(z35));
endmodule
