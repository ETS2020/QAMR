...
module FAU ( 
  ...
  nand2  g060(.a(new_n136_), .b(new_n118_), .O(new_n144_));
  ...
  nand2  g065(.a(new_n142_), .b(new_n118_), .O(new_n149_));
  ...
  aoi21  g079(.a(x27), .b(new_n118_), .c(new_n86_), .O(new_n163_));
  ...
  nand2  g087(.a(new_n170_), .b(new_n118_), .O(new_n171_));
  ...
  nand2  g092(.a(new_n168_), .b(new_n118_), .O(new_n176_));
  ...
  aoi21  g115(.a(new_n198_), .b(x36), .c(x10), .O(z24));
  nor3   g116(.a(x37), .b(new_n86_), .c(new_n180_), .O(new_n200_));
  nor2   g117(.a(new_n200_), .b(x10), .O(z25));
  nand2  g118(.a(x38), .b(x09), .O(new_n202_));
  aoi21  g119(.a(x37), .b(new_n180_), .c(new_n86_), .O(new_n203_));
  ...
  nand3  g140(.a(new_n223_), .b(new_n205_), .c(x09), .O(new_n224_));
  ...
  nand3  g146(.a(new_n229_), .b(new_n205_), .c(x09), .O(new_n230_));
  ...
  nand2  g153(.a(new_n219_), .b(x45), .O(new_n237_));
  aoi21  g154(.a(new_n215_), .b(x44), .c(new_n86_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(new_n237_), .c(x10), .O(z33));
  nand2  g156(.a(new_n219_), .b(x46), .O(new_n240_));
  aoi21  g157(.a(new_n215_), .b(x45), .c(new_n86_), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n240_), .c(x10), .O(z34));
  nand3  g159(.a(new_n205_), .b(x09), .c(new_n174_), .O(new_n243_));
  inv1   g160(.a(x46), .O(new_n244_));
  nand2  g161(.a(new_n215_), .b(new_n244_), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(new_n243_), .c(new_n87_), .O(new_n246_));
