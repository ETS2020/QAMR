...
module FAU ( 
  ...
  nor2   g050(.a(x28), .b(new_n107_), .O(new_n134_));
  ...
  oai21  g065(.a(new_n148_), .b(new_n147_), .c(new_n95_), .O(z20));
  ...
  nand2  g079(.a(new_n162_), .b(new_n95_), .O(z24));
  nor2   g080(.a(x37), .b(new_n146_), .O(new_n164_));
  oai21  g081(.a(x36), .b(x09), .c(new_n86_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n95_), .O(z25));
  ...
  nand2  g089(.a(x14), .b(new_n143_), .O(new_n173_));
  ...
  oai21  g095(.a(x14), .b(new_n146_), .c(new_n171_), .O(new_n179_));
  ...
  oai21  g100(.a(x14), .b(new_n146_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g105(.a(x14), .b(new_n146_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g110(.a(x14), .b(new_n146_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g115(.a(x14), .b(new_n146_), .c(new_n192_), .O(new_n199_));
  ...
  oai21  g120(.a(x14), .b(new_n146_), .c(new_n197_), .O(new_n204_));
  ...
  oai21  g125(.a(x14), .b(new_n146_), .c(new_n202_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(new_n86_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n95_), .O(z34));
  nand3  g128(.a(new_n170_), .b(x09), .c(new_n143_), .O(new_n212_));
  oai21  g129(.a(x14), .b(new_n146_), .c(new_n207_), .O(new_n213_));
