...
module FAU ( 
  ...
  nand2  g085(.a(new_n93_), .b(x31), .O(new_n169_));
  ...
  nand2  g090(.a(new_n93_), .b(x33), .O(new_n174_));
  inv1   g091(.a(new_n174_), .O(z22));
  nand2  g092(.a(new_n93_), .b(x34), .O(new_n176_));
  inv1   g093(.a(new_n176_), .O(z23));
  nand2  g094(.a(new_n93_), .b(x35), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z24));
  nand2  g096(.a(new_n93_), .b(x36), .O(new_n180_));
  inv1   g097(.a(new_n180_), .O(z25));
  nand2  g098(.a(new_n93_), .b(x37), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z26));
  inv1   g100(.a(x38), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n171_), .c(x10), .O(z27));
  inv1   g102(.a(x39), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n171_), .c(x10), .O(z28));
  nand2  g104(.a(new_n93_), .b(x40), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z29));
  nand2  g106(.a(new_n93_), .b(x41), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z30));
  inv1   g108(.a(x42), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n171_), .c(x10), .O(z31));
  nand2  g110(.a(new_n93_), .b(x43), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z32));
  inv1   g112(.a(x44), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n171_), .c(x10), .O(z33));
  nand2  g114(.a(new_n93_), .b(x45), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z34));
  inv1   g116(.a(x46), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n171_), .c(x10), .O(z35));
endmodule
