...
module FAU ( 
  ...
  oai21  g043(.a(x10), .b(new_n105_), .c(x24), .O(new_n127_));
  nand3  g044(.a(x25), .b(new_n87_), .c(x08), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(new_n127_), .O(z13));
  ...
  nand2  g051(.a(new_n130_), .b(new_n105_), .O(new_n135_));
  nand3  g052(.a(new_n135_), .b(new_n134_), .c(new_n87_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(new_n84_), .O(z15));
  ...
  oai21  g062(.a(new_n145_), .b(new_n144_), .c(new_n84_), .O(z18));
  inv1   g063(.a(x00), .O(new_n147_));
  oai21  g064(.a(x30), .b(x08), .c(new_n87_), .O(new_n148_));
  aoi21  g065(.a(x08), .b(new_n147_), .c(new_n148_), .O(z19));
  inv1   g066(.a(x32), .O(new_n150_));
  oai21  g067(.a(x31), .b(x09), .c(new_n87_), .O(new_n151_));
  aoi21  g068(.a(new_n150_), .b(x09), .c(new_n151_), .O(z20));
  inv1   g069(.a(x33), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(x09), .O(new_n154_));
  inv1   g071(.a(x09), .O(new_n155_));
  nand2  g072(.a(new_n150_), .b(new_n155_), .O(new_n156_));
  ...
  oai21  g076(.a(x33), .b(x09), .c(new_n87_), .O(new_n160_));
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n84_), .O(z22));
  inv1   g078(.a(x35), .O(new_n162_));
  oai21  g079(.a(x34), .b(x09), .c(new_n87_), .O(new_n163_));
  aoi21  g080(.a(new_n162_), .b(x09), .c(new_n163_), .O(z23));
  inv1   g081(.a(x36), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(x09), .O(new_n166_));
  nand2  g083(.a(new_n162_), .b(new_n155_), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(new_n87_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n84_), .O(z24));
  nor2   g086(.a(x37), .b(new_n155_), .O(new_n170_));
  oai21  g087(.a(x36), .b(x09), .c(new_n87_), .O(new_n171_));
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n84_), .O(z25));
  nor2   g089(.a(x38), .b(new_n155_), .O(new_n173_));
  ...
  nand2  g095(.a(x14), .b(new_n147_), .O(new_n179_));
  ...
  oai21  g101(.a(x14), .b(new_n155_), .c(new_n177_), .O(new_n185_));
  ...
  oai21  g106(.a(x14), .b(new_n155_), .c(new_n183_), .O(new_n190_));
  ...
  oai21  g126(.a(x14), .b(new_n155_), .c(new_n203_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n87_), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n84_), .O(z33));
  inv1   g129(.a(x46), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n176_), .c(x09), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n155_), .c(new_n208_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n87_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n84_), .O(z34));
  nand3  g134(.a(new_n176_), .b(x09), .c(new_n147_), .O(new_n218_));
  oai21  g135(.a(x14), .b(new_n155_), .c(new_n213_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(new_n87_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n84_), .O(z35));
endmodule
