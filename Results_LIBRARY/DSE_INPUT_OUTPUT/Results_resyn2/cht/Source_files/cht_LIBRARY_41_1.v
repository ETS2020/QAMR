...
module FAU ( 
  ...
  nand2  g009(.a(x43), .b(new_n84_), .O(new_n93_));
  ...
  oai21  g155(.a(x14), .b(new_n188_), .c(new_n233_), .O(new_n239_));
  nand3  g156(.a(new_n239_), .b(new_n238_), .c(new_n95_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(new_n93_), .O(z29));
  inv1   g158(.a(x43), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(new_n225_), .c(x09), .O(new_n243_));
  inv1   g160(.a(x42), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n225_), .c(x09), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n95_), .O(new_n246_));
  aoi21  g163(.a(new_n243_), .b(new_n84_), .c(new_n246_), .O(z30));
  oai21  g164(.a(x14), .b(new_n188_), .c(new_n244_), .O(new_n248_));
  nand3  g165(.a(new_n248_), .b(new_n243_), .c(new_n95_), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n93_), .O(z31));
  inv1   g167(.a(x44), .O(new_n251_));
  nand3  g168(.a(new_n251_), .b(new_n225_), .c(x09), .O(new_n252_));
  oai21  g169(.a(x14), .b(new_n188_), .c(new_n242_), .O(new_n253_));
