...
module FAU ( 
  ...
  oai21  g079(.a(new_n162_), .b(new_n161_), .c(new_n96_), .O(z23));
  ...
  nand2  g095(.a(new_n178_), .b(new_n96_), .O(z27));
  ...
  nand2  g112(.a(new_n195_), .b(new_n96_), .O(z30));
  ...
  nand2  g122(.a(new_n205_), .b(new_n96_), .O(z32));
  ...
  nand2  g132(.a(new_n215_), .b(new_n96_), .O(z34));
  ...
  nand2  g136(.a(new_n219_), .b(new_n96_), .O(z35));
endmodule
