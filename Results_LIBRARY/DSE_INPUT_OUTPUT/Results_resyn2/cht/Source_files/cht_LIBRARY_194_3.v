...
module FAU ( 
  ...
  nand2  g041(.a(new_n124_), .b(new_n84_), .O(z10));
  inv1   g042(.a(x23), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(x08), .O(new_n127_));
  nand2  g044(.a(new_n121_), .b(new_n107_), .O(new_n128_));
