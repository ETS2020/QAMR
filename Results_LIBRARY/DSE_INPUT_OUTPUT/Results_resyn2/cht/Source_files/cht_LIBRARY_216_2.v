...
module FAU ( 
  ...
  nand2  g082(.a(new_n158_), .b(new_n160_), .O(new_n166_));
  nand3  g083(.a(new_n166_), .b(new_n165_), .c(new_n88_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n85_), .O(z22));
  nor2   g085(.a(x35), .b(new_n160_), .O(new_n169_));
  oai21  g086(.a(x34), .b(x09), .c(new_n88_), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n85_), .O(z23));
  nor2   g088(.a(x36), .b(new_n160_), .O(new_n172_));
  ...
  nand2  g096(.a(new_n175_), .b(new_n160_), .O(new_n180_));
  ...
  aoi21  g103(.a(new_n178_), .b(new_n160_), .c(x10), .O(new_n187_));
  ...
  nand3  g138(.a(new_n84_), .b(new_n184_), .c(x09), .O(new_n222_));
  nand2  g139(.a(new_n193_), .b(new_n217_), .O(new_n223_));
  ...
  nand2  g143(.a(new_n193_), .b(new_n84_), .O(new_n227_));
