...
module FAU ( 
  ...
  oai21  g033(.a(new_n116_), .b(new_n115_), .c(new_n89_), .O(z09));
  ...
  nand2  g042(.a(new_n86_), .b(new_n105_), .O(new_n126_));
  nand2  g043(.a(new_n126_), .b(x24), .O(new_n127_));
  oai21  g044(.a(new_n126_), .b(new_n121_), .c(new_n127_), .O(z12));
  inv1   g045(.a(x25), .O(new_n129_));
  nand2  g046(.a(new_n86_), .b(x08), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(x24), .O(new_n131_));
  oai21  g048(.a(new_n130_), .b(new_n129_), .c(new_n131_), .O(z13));
  inv1   g049(.a(x26), .O(new_n133_));
  nand2  g050(.a(new_n133_), .b(x08), .O(new_n134_));
  nand2  g051(.a(new_n129_), .b(new_n105_), .O(new_n135_));
  nand3  g052(.a(new_n135_), .b(new_n134_), .c(new_n86_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(new_n89_), .O(z14));
  ...
  nand2  g058(.a(new_n141_), .b(new_n89_), .O(z15));
  ...
  nand2  g063(.a(new_n146_), .b(new_n89_), .O(z16));
  nor2   g064(.a(x29), .b(new_n105_), .O(new_n148_));
  oai21  g065(.a(x28), .b(x08), .c(new_n86_), .O(new_n149_));
  oai21  g066(.a(new_n149_), .b(new_n148_), .c(new_n89_), .O(z17));
  nor2   g067(.a(x30), .b(new_n105_), .O(new_n151_));
  ...
  oai21  g084(.a(new_n167_), .b(new_n166_), .c(new_n89_), .O(z22));
  ...
  oai21  g090(.a(new_n173_), .b(new_n172_), .c(new_n89_), .O(z24));
  nor2   g091(.a(x37), .b(new_n162_), .O(new_n175_));
  ...
  aoi21  g101(.a(new_n178_), .b(new_n162_), .c(x10), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n89_), .O(z27));
  ...
  nand2  g135(.a(new_n218_), .b(new_n89_), .O(z33));
