...
module FAU ( 
  ...
  nand2  g047(.a(new_n91_), .b(x25), .O(new_n131_));
  ...
  nand2  g093(.a(new_n170_), .b(new_n146_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n176_), .c(new_n91_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z26));
  inv1   g096(.a(x39), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n104_), .O(new_n181_));
  oai21  g098(.a(new_n104_), .b(x00), .c(new_n181_), .O(new_n182_));
  nand2  g099(.a(new_n175_), .b(new_n146_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n91_), .O(new_n184_));
  aoi21  g101(.a(new_n182_), .b(x09), .c(new_n184_), .O(z27));
  nor2   g102(.a(x14), .b(new_n146_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(x40), .O(new_n187_));
  nand2  g104(.a(new_n104_), .b(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(x39), .c(new_n86_), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n187_), .c(x10), .O(z28));
  ...
  aoi21  g114(.a(new_n188_), .b(x41), .c(new_n86_), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z30));
  nand2  g116(.a(new_n186_), .b(x43), .O(new_n200_));
  aoi21  g117(.a(new_n188_), .b(x42), .c(new_n86_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z31));
  nand2  g119(.a(new_n186_), .b(x44), .O(new_n203_));
  aoi21  g120(.a(new_n188_), .b(x43), .c(new_n86_), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z32));
  nand2  g122(.a(new_n186_), .b(x45), .O(new_n206_));
  aoi21  g123(.a(new_n188_), .b(x44), .c(new_n86_), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z33));
  nand2  g125(.a(new_n186_), .b(x46), .O(new_n209_));
  aoi21  g126(.a(new_n188_), .b(x45), .c(new_n86_), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z34));
  nand2  g128(.a(new_n186_), .b(x00), .O(new_n212_));
  aoi21  g129(.a(new_n188_), .b(x46), .c(new_n86_), .O(new_n213_));
