...
module FAU ( 
  ...
  aoi21  g081(.a(x35), .b(new_n146_), .c(new_n86_), .O(new_n165_));
  ...
  oai21  g094(.a(new_n104_), .b(x00), .c(new_n177_), .O(new_n178_));
  nand2  g095(.a(new_n170_), .b(new_n146_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n87_), .O(new_n180_));
  aoi21  g097(.a(new_n178_), .b(x09), .c(new_n180_), .O(z27));
  inv1   g098(.a(x40), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n104_), .c(x09), .O(new_n183_));
  nand2  g100(.a(new_n104_), .b(x09), .O(new_n184_));
  ...
  aoi21  g106(.a(new_n184_), .b(x40), .c(new_n86_), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z29));
  nand2  g108(.a(new_n188_), .b(x42), .O(new_n192_));
  aoi21  g109(.a(new_n184_), .b(x41), .c(new_n86_), .O(new_n193_));
  ...
  nand2  g114(.a(new_n184_), .b(new_n197_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n196_), .c(new_n87_), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z31));
  inv1   g117(.a(x44), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n104_), .c(x09), .O(new_n202_));
  nand2  g119(.a(new_n184_), .b(new_n195_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n202_), .c(new_n87_), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z32));
  nand2  g122(.a(new_n188_), .b(x45), .O(new_n206_));
  aoi21  g123(.a(new_n184_), .b(x44), .c(new_n86_), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z33));
  inv1   g125(.a(x46), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n104_), .c(x09), .O(new_n210_));
  inv1   g127(.a(x45), .O(new_n211_));
  nand2  g128(.a(new_n184_), .b(new_n211_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n210_), .c(new_n87_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand2  g131(.a(new_n188_), .b(x00), .O(new_n215_));
  aoi21  g132(.a(new_n184_), .b(x46), .c(new_n86_), .O(new_n216_));
