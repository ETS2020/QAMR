...
module FAU ( 
  ...
  nand2  g097(.a(x14), .b(new_n152_), .O(new_n181_));
  ...
  nand2  g110(.a(new_n193_), .b(new_n85_), .O(z29));
  ...
  nand2  g135(.a(new_n218_), .b(new_n85_), .O(z34));
  nand3  g136(.a(new_n178_), .b(x09), .c(new_n152_), .O(new_n220_));
