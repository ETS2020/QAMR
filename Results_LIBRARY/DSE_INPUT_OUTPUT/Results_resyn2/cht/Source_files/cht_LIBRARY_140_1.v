...
module FAU ( 
  ...
  nand2  g035(.a(new_n118_), .b(new_n93_), .O(z08));
  nor2   g036(.a(x21), .b(new_n111_), .O(new_n120_));
  oai21  g037(.a(x20), .b(x08), .c(new_n86_), .O(new_n121_));
  oai21  g038(.a(new_n121_), .b(new_n120_), .c(new_n93_), .O(z09));
  ...
  nand2  g049(.a(new_n132_), .b(new_n93_), .O(z12));
  nor2   g050(.a(x25), .b(new_n111_), .O(new_n134_));
  oai21  g051(.a(x24), .b(x08), .c(new_n86_), .O(new_n135_));
  oai21  g052(.a(new_n135_), .b(new_n134_), .c(new_n93_), .O(z13));
  ...
  nand2  g070(.a(new_n149_), .b(new_n111_), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n153_), .c(new_n86_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n93_), .O(z19));
  inv1   g073(.a(x32), .O(new_n157_));
  nor2   g074(.a(x31), .b(x10), .O(new_n158_));
  nand2  g075(.a(new_n86_), .b(x09), .O(new_n159_));
  oai22  g076(.a(new_n159_), .b(new_n157_), .c(new_n158_), .d(x09), .O(z20));
  inv1   g077(.a(x33), .O(new_n161_));
  nor2   g078(.a(x32), .b(x10), .O(new_n162_));
  oai22  g079(.a(new_n162_), .b(x09), .c(new_n159_), .d(new_n161_), .O(z21));
  inv1   g080(.a(x34), .O(new_n164_));
  nor2   g081(.a(x33), .b(x10), .O(new_n165_));
  oai22  g082(.a(new_n165_), .b(x09), .c(new_n159_), .d(new_n164_), .O(z22));
  nor2   g083(.a(x35), .b(new_n92_), .O(new_n167_));
  oai21  g084(.a(x34), .b(x09), .c(new_n86_), .O(new_n168_));
  nor2   g085(.a(new_n168_), .b(new_n167_), .O(z23));
  nor2   g086(.a(x36), .b(new_n92_), .O(new_n170_));
  oai21  g087(.a(x35), .b(x09), .c(new_n86_), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(new_n170_), .O(z24));
  inv1   g089(.a(x37), .O(new_n173_));
  nor2   g090(.a(x36), .b(x10), .O(new_n174_));
  oai22  g091(.a(new_n174_), .b(x09), .c(new_n159_), .d(new_n173_), .O(z25));
  nor2   g092(.a(x38), .b(new_n92_), .O(new_n176_));
  oai21  g093(.a(x37), .b(x09), .c(new_n86_), .O(new_n177_));
  nor2   g094(.a(new_n177_), .b(new_n176_), .O(z26));
  oai21  g095(.a(x38), .b(x10), .c(new_n92_), .O(new_n179_));
  nand2  g096(.a(x14), .b(new_n152_), .O(new_n180_));
  inv1   g097(.a(x14), .O(new_n181_));
  inv1   g098(.a(x39), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand4  g100(.a(new_n183_), .b(new_n180_), .c(new_n86_), .d(x09), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n179_), .O(z27));
  oai21  g102(.a(x40), .b(x14), .c(new_n86_), .O(new_n186_));
  nand2  g103(.a(new_n181_), .b(x09), .O(new_n187_));
  nor2   g104(.a(x39), .b(x10), .O(new_n188_));
  aoi22  g105(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(x09), .O(z28));
  inv1   g106(.a(x41), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n181_), .c(x09), .O(new_n191_));
  inv1   g108(.a(x40), .O(new_n192_));
  oai21  g109(.a(x14), .b(new_n92_), .c(new_n192_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n191_), .c(new_n86_), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z29));
  oai21  g112(.a(x42), .b(x14), .c(new_n86_), .O(new_n196_));
  nor2   g113(.a(x41), .b(x10), .O(new_n197_));
  aoi22  g114(.a(new_n197_), .b(new_n187_), .c(new_n196_), .d(x09), .O(z30));
  oai21  g115(.a(x43), .b(x14), .c(new_n86_), .O(new_n199_));
  nor2   g116(.a(x42), .b(x10), .O(new_n200_));
  aoi22  g117(.a(new_n200_), .b(new_n187_), .c(new_n199_), .d(x09), .O(z31));
  oai21  g118(.a(x44), .b(x14), .c(new_n86_), .O(new_n202_));
  nor2   g119(.a(x43), .b(x10), .O(new_n203_));
  aoi22  g120(.a(new_n203_), .b(new_n187_), .c(new_n202_), .d(x09), .O(z32));
  oai21  g121(.a(x45), .b(x14), .c(new_n86_), .O(new_n205_));
  nor2   g122(.a(x44), .b(x10), .O(new_n206_));
  aoi22  g123(.a(new_n206_), .b(new_n187_), .c(new_n205_), .d(x09), .O(z33));
  inv1   g124(.a(x46), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n181_), .c(x09), .O(new_n209_));
  inv1   g126(.a(x45), .O(new_n210_));
  oai21  g127(.a(x14), .b(new_n92_), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n209_), .c(new_n86_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n181_), .b(x09), .c(new_n152_), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n92_), .c(new_n208_), .O(new_n215_));
