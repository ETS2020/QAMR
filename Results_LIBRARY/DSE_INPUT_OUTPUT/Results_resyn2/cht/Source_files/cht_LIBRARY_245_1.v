...
module FAU ( 
  ...
  nor2   g025(.a(x19), .b(new_n89_), .O(new_n109_));
  ...
  aoi21  g099(.a(new_n176_), .b(new_n154_), .c(x10), .O(new_n183_));
  ...
  nand2  g113(.a(new_n196_), .b(new_n90_), .O(z29));
