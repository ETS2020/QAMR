...
module FAU ( 
  ...
  aoi21  g001(.a(new_n84_), .b(x07), .c(x11), .O(new_n85_));
  inv1   g002(.a(x07), .O(new_n86_));
  inv1   g003(.a(x10), .O(new_n87_));
  oai21  g004(.a(new_n86_), .b(x04), .c(new_n87_), .O(new_n88_));
  nor2   g005(.a(new_n88_), .b(new_n85_), .O(z00));
  inv1   g006(.a(x11), .O(new_n90_));
  nand2  g007(.a(x40), .b(new_n90_), .O(new_n91_));
  nor2   g008(.a(new_n86_), .b(x05), .O(new_n92_));
  oai21  g009(.a(x12), .b(x07), .c(new_n87_), .O(new_n93_));
  oai21  g010(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(z01));
  nor2   g011(.a(new_n86_), .b(x06), .O(new_n95_));
  oai21  g012(.a(x13), .b(x07), .c(new_n87_), .O(new_n96_));
  oai21  g013(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z02));
  nor2   g014(.a(new_n86_), .b(x01), .O(new_n98_));
  oai21  g015(.a(x14), .b(x07), .c(new_n87_), .O(new_n99_));
  oai21  g016(.a(new_n99_), .b(new_n98_), .c(new_n91_), .O(z03));
  aoi21  g017(.a(x40), .b(new_n90_), .c(x10), .O(new_n101_));
  inv1   g018(.a(x15), .O(new_n102_));
  nand2  g019(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  ...
  nand3  g107(.a(new_n190_), .b(new_n187_), .c(new_n87_), .O(new_n191_));
  ...
  nand3  g145(.a(new_n228_), .b(new_n91_), .c(new_n87_), .O(new_n229_));
  aoi21  g146(.a(new_n227_), .b(x09), .c(new_n229_), .O(z27));
  nand3  g147(.a(new_n84_), .b(new_n223_), .c(x09), .O(new_n231_));
  ...
  oai21  g153(.a(x14), .b(new_n188_), .c(new_n84_), .O(new_n237_));
