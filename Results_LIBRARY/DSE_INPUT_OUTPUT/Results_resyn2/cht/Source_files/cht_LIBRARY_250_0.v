...
module FAU ( 
  ...
  nand2  g045(.a(new_n128_), .b(new_n113_), .O(new_n129_));
  ...
  nand2  g057(.a(new_n140_), .b(new_n113_), .O(new_n141_));
  ...
  nand2  g062(.a(new_n138_), .b(new_n113_), .O(new_n146_));
  ...
  nand2  g067(.a(new_n144_), .b(new_n113_), .O(new_n151_));
  ...
  aoi21  g081(.a(x28), .b(new_n113_), .c(new_n86_), .O(new_n165_));
  ...
  nand2  g113(.a(new_n189_), .b(new_n178_), .O(new_n197_));
  ...
  aoi21  g130(.a(x38), .b(new_n178_), .c(new_n86_), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z27));
  nor2   g132(.a(x14), .b(new_n178_), .O(new_n216_));
  ...
  nand3  g141(.a(new_n224_), .b(new_n210_), .c(x09), .O(new_n225_));
  ...
  nand2  g148(.a(new_n218_), .b(new_n224_), .O(new_n232_));
  nand3  g149(.a(new_n232_), .b(new_n231_), .c(new_n87_), .O(new_n233_));
  inv1   g150(.a(new_n233_), .O(z31));
  inv1   g151(.a(x44), .O(new_n235_));
  nand3  g152(.a(new_n235_), .b(new_n210_), .c(x09), .O(new_n236_));
  nand2  g153(.a(new_n218_), .b(new_n230_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n236_), .c(new_n87_), .O(new_n238_));
  inv1   g155(.a(new_n238_), .O(z32));
  nand2  g156(.a(new_n216_), .b(x45), .O(new_n240_));
  aoi21  g157(.a(new_n218_), .b(x44), .c(new_n86_), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n240_), .c(x10), .O(z33));
  nand2  g159(.a(new_n216_), .b(x46), .O(new_n243_));
  aoi21  g160(.a(new_n218_), .b(x45), .c(new_n86_), .O(new_n244_));
  aoi21  g161(.a(new_n244_), .b(new_n243_), .c(x10), .O(z34));
  nand2  g162(.a(new_n216_), .b(x00), .O(new_n246_));
  aoi21  g163(.a(new_n218_), .b(x46), .c(new_n86_), .O(new_n247_));
