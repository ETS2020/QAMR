...
module FAU ( 
  ...
  nand2  g000(.a(x29), .b(x10), .O(new_n84_));
  ...
  nor2   g066(.a(x10), .b(new_n105_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(x30), .O(new_n151_));
  oai21  g068(.a(new_n150_), .b(new_n147_), .c(new_n151_), .O(z18));
  inv1   g069(.a(x00), .O(new_n153_));
  nand2  g070(.a(x08), .b(new_n153_), .O(new_n154_));
  inv1   g071(.a(x30), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n105_), .O(new_n156_));
  ...
  nand2  g115(.a(new_n198_), .b(new_n84_), .O(z29));
  ...
  nand2  g125(.a(new_n208_), .b(new_n84_), .O(z31));
