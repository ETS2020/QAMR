...
module FAU ( 
  ...
  nand2  g027(.a(new_n84_), .b(x18), .O(new_n111_));
  ...
  nand3  g043(.a(new_n126_), .b(new_n123_), .c(new_n113_), .O(new_n127_));
  nand2  g044(.a(new_n127_), .b(new_n111_), .O(z06));
  inv1   g045(.a(x19), .O(new_n129_));
  nand2  g046(.a(new_n129_), .b(x08), .O(new_n130_));
  nand2  g047(.a(new_n122_), .b(new_n124_), .O(new_n131_));
  nand3  g048(.a(new_n131_), .b(new_n130_), .c(new_n113_), .O(new_n132_));
  nand2  g049(.a(new_n132_), .b(new_n111_), .O(z07));
  inv1   g050(.a(x20), .O(new_n134_));
  nand2  g051(.a(new_n134_), .b(x08), .O(new_n135_));
  nand2  g052(.a(new_n129_), .b(new_n124_), .O(new_n136_));
  nand3  g053(.a(new_n136_), .b(new_n135_), .c(new_n113_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n111_), .O(z08));
  inv1   g055(.a(x21), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(x08), .O(new_n140_));
  nand2  g057(.a(new_n134_), .b(new_n124_), .O(new_n141_));
  nand3  g058(.a(new_n141_), .b(new_n140_), .c(new_n113_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(new_n111_), .O(z09));
  ...
  nand3  g073(.a(new_n156_), .b(new_n154_), .c(new_n85_), .O(new_n157_));
  ...
  nand3  g078(.a(new_n161_), .b(new_n160_), .c(new_n113_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(new_n111_), .O(z13));
  inv1   g080(.a(x26), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(x08), .O(new_n165_));
  nand2  g082(.a(new_n159_), .b(new_n124_), .O(new_n166_));
  nand3  g083(.a(new_n166_), .b(new_n165_), .c(new_n113_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n111_), .O(z14));
  inv1   g085(.a(x27), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(x08), .O(new_n170_));
  nand2  g087(.a(new_n164_), .b(new_n124_), .O(new_n171_));
  nand3  g088(.a(new_n171_), .b(new_n170_), .c(new_n113_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n111_), .O(z15));
  ...
  nand3  g098(.a(new_n181_), .b(new_n180_), .c(new_n113_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n111_), .O(z17));
  nand2  g100(.a(new_n179_), .b(new_n124_), .O(new_n184_));
  inv1   g101(.a(x30), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(x08), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n184_), .c(new_n85_), .O(new_n187_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n190_), .c(new_n113_), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n111_), .O(z19));
  ...
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n113_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n111_), .O(z24));
  inv1   g137(.a(x37), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x09), .O(new_n222_));
  nand2  g139(.a(new_n216_), .b(new_n194_), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n222_), .c(new_n113_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n111_), .O(z25));
  inv1   g142(.a(x38), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(x09), .O(new_n227_));
  nand2  g144(.a(new_n221_), .b(new_n194_), .O(new_n228_));
  nand3  g145(.a(new_n228_), .b(new_n227_), .c(new_n113_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n111_), .O(z26));
  nand2  g147(.a(x14), .b(x00), .O(new_n231_));
  nand2  g148(.a(x39), .b(new_n105_), .O(new_n232_));
  ...
  nand3  g178(.a(new_n261_), .b(new_n260_), .c(new_n113_), .O(new_n262_));
  nand2  g179(.a(new_n262_), .b(new_n111_), .O(z32));
  nand3  g180(.a(new_n84_), .b(new_n105_), .c(x09), .O(new_n264_));
  ...
  nand3  g184(.a(new_n122_), .b(new_n105_), .c(x09), .O(new_n268_));
  inv1   g185(.a(x46), .O(new_n269_));
  nand3  g186(.a(new_n269_), .b(new_n105_), .c(x09), .O(new_n270_));
  nand2  g187(.a(new_n270_), .b(new_n113_), .O(new_n271_));
  aoi21  g188(.a(new_n268_), .b(new_n84_), .c(new_n271_), .O(z34));
  nand3  g189(.a(new_n105_), .b(x09), .c(new_n189_), .O(new_n273_));
