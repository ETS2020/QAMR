...
module FAU ( 
  ...
  oai21  g048(.a(new_n131_), .b(new_n130_), .c(new_n92_), .O(z14));
  ...
  nand2  g057(.a(new_n136_), .b(new_n105_), .O(new_n141_));
  nand3  g058(.a(new_n141_), .b(new_n140_), .c(new_n86_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(new_n92_), .O(z17));
  ...
  nand2  g064(.a(new_n147_), .b(new_n92_), .O(z18));
  ...
  oai21  g083(.a(x36), .b(x10), .c(x09), .O(new_n167_));
  oai21  g084(.a(new_n159_), .b(new_n166_), .c(new_n167_), .O(z24));
  nor2   g085(.a(x37), .b(new_n158_), .O(new_n169_));
  oai21  g086(.a(x36), .b(x09), .c(new_n86_), .O(new_n170_));
  nor2   g087(.a(new_n170_), .b(new_n169_), .O(z25));
  nor2   g088(.a(x38), .b(new_n158_), .O(new_n172_));
  ...
  aoi21  g093(.a(x39), .b(new_n176_), .c(new_n158_), .O(new_n177_));
  ...
  nand2  g097(.a(x10), .b(new_n158_), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(new_n180_), .c(x39), .O(new_n182_));
  inv1   g099(.a(x40), .O(new_n183_));
  oai21  g100(.a(new_n183_), .b(x14), .c(new_n86_), .O(new_n184_));
  ...
  nand3  g123(.a(new_n181_), .b(new_n180_), .c(x44), .O(new_n207_));
  inv1   g124(.a(x45), .O(new_n208_));
  oai21  g125(.a(new_n208_), .b(x14), .c(new_n86_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(x09), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n207_), .O(z33));
  inv1   g128(.a(x46), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n176_), .c(x09), .O(new_n213_));
  oai21  g130(.a(x14), .b(new_n158_), .c(new_n208_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n86_), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z34));
  nand3  g133(.a(new_n181_), .b(new_n180_), .c(x46), .O(new_n217_));
  oai21  g134(.a(x14), .b(new_n149_), .c(new_n86_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(x09), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n217_), .O(z35));
endmodule
