...
module FAU ( 
  ...
  nand2  g035(.a(new_n93_), .b(x21), .O(new_n119_));
  ...
  nand2  g051(.a(new_n93_), .b(x29), .O(new_n135_));
  ...
  nand2  g094(.a(new_n172_), .b(x41), .O(new_n178_));
  aoi21  g095(.a(new_n175_), .b(x40), .c(x08), .O(new_n179_));
  ...
  nand3  g101(.a(new_n184_), .b(new_n182_), .c(new_n93_), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z30));
  nand2  g103(.a(new_n172_), .b(x43), .O(new_n187_));
  aoi21  g104(.a(new_n175_), .b(x42), .c(x08), .O(new_n188_));
  ...
  nand3  g110(.a(new_n193_), .b(new_n191_), .c(new_n93_), .O(new_n194_));
  ...
  nand3  g115(.a(new_n198_), .b(new_n197_), .c(new_n93_), .O(new_n199_));
  ...
  nand3  g120(.a(new_n203_), .b(new_n202_), .c(new_n93_), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z34));
  nand3  g122(.a(new_n174_), .b(x09), .c(new_n167_), .O(new_n206_));
  nand2  g123(.a(new_n175_), .b(new_n201_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n93_), .O(new_n208_));
