...
module FAU ( 
  ...
  nand2  g076(.a(new_n159_), .b(new_n93_), .O(z22));
  nor2   g077(.a(x35), .b(new_n149_), .O(new_n161_));
  oai21  g078(.a(x34), .b(x09), .c(new_n86_), .O(new_n162_));
  oai21  g079(.a(new_n162_), .b(new_n161_), .c(new_n93_), .O(z23));
  ...
  nand2  g095(.a(new_n178_), .b(new_n93_), .O(z27));
  ...
  nand2  g107(.a(new_n190_), .b(new_n93_), .O(z29));
  ...
  nand2  g122(.a(new_n205_), .b(new_n93_), .O(z32));
