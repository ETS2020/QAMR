...
module FAU ( 
  ...
  nand2  g061(.a(new_n144_), .b(x09), .O(new_n145_));
  inv1   g062(.a(x09), .O(new_n146_));
  inv1   g063(.a(x31), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand3  g065(.a(new_n148_), .b(new_n145_), .c(new_n87_), .O(new_n149_));
  nand2  g066(.a(new_n149_), .b(new_n84_), .O(z20));
  inv1   g067(.a(x33), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(x09), .O(new_n152_));
  nand2  g069(.a(new_n144_), .b(new_n146_), .O(new_n153_));
  ...
  nand2  g074(.a(new_n151_), .b(new_n146_), .O(new_n158_));
  ...
  nand2  g079(.a(new_n156_), .b(new_n146_), .O(new_n163_));
  ...
  nand2  g089(.a(new_n166_), .b(new_n146_), .O(new_n173_));
  ...
  nand2  g094(.a(new_n171_), .b(new_n146_), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n177_), .c(new_n87_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n84_), .O(z26));
  ...
  aoi21  g101(.a(new_n176_), .b(new_n146_), .c(x10), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n84_), .O(z27));
  ...
  nand3  g109(.a(new_n192_), .b(new_n189_), .c(new_n87_), .O(new_n193_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n84_), .O(z32));
  ...
  nand2  g140(.a(new_n223_), .b(new_n84_), .O(z34));
  inv1   g141(.a(x00), .O(new_n225_));
  nand3  g142(.a(new_n182_), .b(x09), .c(new_n225_), .O(new_n226_));
  nand2  g143(.a(new_n191_), .b(new_n220_), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n226_), .c(new_n87_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n84_), .O(z35));
endmodule
