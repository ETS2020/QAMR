...
module FAU ( 
  ...
  oai21  g066(.a(x31), .b(x09), .c(new_n88_), .O(new_n150_));
  ...
  oai21  g071(.a(new_n154_), .b(new_n153_), .c(new_n85_), .O(z21));
  ...
  nor2   g078(.a(x36), .b(new_n152_), .O(new_n162_));
  oai21  g079(.a(x35), .b(x09), .c(new_n88_), .O(new_n163_));
  oai21  g080(.a(new_n163_), .b(new_n162_), .c(new_n85_), .O(z24));
  nor2   g081(.a(x37), .b(new_n152_), .O(new_n165_));
  oai21  g082(.a(x36), .b(x09), .c(new_n88_), .O(new_n166_));
  nor2   g083(.a(new_n166_), .b(new_n165_), .O(z25));
  nor2   g084(.a(x38), .b(new_n152_), .O(new_n168_));
  ...
  oai21  g096(.a(x14), .b(new_n152_), .c(new_n172_), .O(new_n180_));
  ...
  oai21  g101(.a(x14), .b(new_n152_), .c(new_n178_), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n184_), .c(new_n88_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n85_), .O(z29));
  inv1   g104(.a(x42), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n171_), .c(x09), .O(new_n189_));
  oai21  g106(.a(x14), .b(new_n152_), .c(new_n183_), .O(new_n190_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n85_), .O(z33));
  ...
  oai21  g130(.a(x14), .b(new_n152_), .c(new_n208_), .O(new_n214_));
