...
module FAU ( 
  ...
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n99_), .O(z20));
  ...
  nand2  g079(.a(new_n162_), .b(new_n99_), .O(z23));
  ...
  nand2  g084(.a(new_n167_), .b(new_n99_), .O(z24));
  nor2   g085(.a(x37), .b(new_n149_), .O(new_n169_));
  oai21  g086(.a(x36), .b(x09), .c(new_n86_), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n99_), .O(z25));
  ...
  aoi21  g095(.a(new_n172_), .b(new_n149_), .c(x10), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n99_), .O(z27));
  ...
  nand2  g124(.a(new_n207_), .b(new_n99_), .O(z32));
