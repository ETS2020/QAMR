...
module FAU ( 
  ...
  oai21  g098(.a(x38), .b(x09), .c(new_n90_), .O(new_n182_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n191_), .c(new_n90_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z29));
  nor2   g111(.a(x14), .b(new_n144_), .O(new_n195_));
  ...
  nand2  g121(.a(new_n186_), .b(new_n204_), .O(new_n205_));
  ...
  nand2  g126(.a(new_n186_), .b(new_n202_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n90_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z33));
  inv1   g129(.a(x46), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n178_), .c(x09), .O(new_n214_));
  nand2  g131(.a(new_n186_), .b(new_n208_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n90_), .O(new_n216_));
  inv1   g133(.a(new_n216_), .O(z34));
  inv1   g134(.a(x00), .O(new_n218_));
  nand3  g135(.a(new_n178_), .b(x09), .c(new_n218_), .O(new_n219_));
  nand2  g136(.a(new_n186_), .b(new_n213_), .O(new_n220_));
