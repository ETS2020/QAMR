...
module FAU ( 
  ...
  oai21  g049(.a(new_n132_), .b(new_n131_), .c(new_n93_), .O(z14));
  ...
  nand2  g060(.a(new_n143_), .b(new_n93_), .O(z17));
  ...
  nand2  g065(.a(new_n148_), .b(new_n93_), .O(z18));
  nor2   g066(.a(new_n106_), .b(x00), .O(new_n150_));
  oai21  g067(.a(x30), .b(x08), .c(new_n86_), .O(new_n151_));
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n93_), .O(z19));
  nor2   g069(.a(x32), .b(new_n92_), .O(new_n153_));
  oai21  g070(.a(x31), .b(x09), .c(new_n86_), .O(new_n154_));
  nor2   g071(.a(new_n154_), .b(new_n153_), .O(z20));
  inv1   g072(.a(x33), .O(new_n156_));
  nor2   g073(.a(x32), .b(x10), .O(new_n157_));
  nand2  g074(.a(new_n86_), .b(x09), .O(new_n158_));
  oai22  g075(.a(new_n158_), .b(new_n156_), .c(new_n157_), .d(x09), .O(z21));
  ...
  nor2   g080(.a(x34), .b(x10), .O(new_n164_));
  oai22  g081(.a(new_n164_), .b(x09), .c(new_n158_), .d(new_n163_), .O(z23));
  inv1   g082(.a(x36), .O(new_n166_));
  nor2   g083(.a(x35), .b(x10), .O(new_n167_));
  oai22  g084(.a(new_n167_), .b(x09), .c(new_n158_), .d(new_n166_), .O(z24));
  nor2   g085(.a(x37), .b(new_n92_), .O(new_n169_));
  oai21  g086(.a(x36), .b(x09), .c(new_n86_), .O(new_n170_));
  nor2   g087(.a(new_n170_), .b(new_n169_), .O(z25));
  nor2   g088(.a(x38), .b(new_n92_), .O(new_n172_));
  ...
  oai21  g103(.a(x14), .b(new_n92_), .c(new_n186_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n185_), .c(new_n86_), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z29));
  oai21  g106(.a(x42), .b(x14), .c(new_n86_), .O(new_n190_));
  nor2   g107(.a(x41), .b(x10), .O(new_n191_));
  aoi22  g108(.a(new_n191_), .b(new_n181_), .c(new_n190_), .d(x09), .O(z30));
  inv1   g109(.a(x43), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n176_), .c(x09), .O(new_n194_));
  inv1   g111(.a(x42), .O(new_n195_));
  oai21  g112(.a(x14), .b(new_n92_), .c(new_n195_), .O(new_n196_));
  ...
  aoi22  g117(.a(new_n200_), .b(new_n181_), .c(new_n199_), .d(x09), .O(z32));
  oai21  g118(.a(x45), .b(x14), .c(new_n86_), .O(new_n202_));
  nor2   g119(.a(x44), .b(x10), .O(new_n203_));
  aoi22  g120(.a(new_n203_), .b(new_n181_), .c(new_n202_), .d(x09), .O(z33));
  inv1   g121(.a(x46), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n176_), .c(x09), .O(new_n206_));
  inv1   g123(.a(x45), .O(new_n207_));
  oai21  g124(.a(x14), .b(new_n92_), .c(new_n207_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n206_), .c(new_n86_), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  oai21  g127(.a(x14), .b(x00), .c(new_n86_), .O(new_n211_));
  nor2   g128(.a(x46), .b(x10), .O(new_n212_));
  aoi22  g129(.a(new_n212_), .b(new_n181_), .c(new_n211_), .d(x09), .O(z35));
endmodule
