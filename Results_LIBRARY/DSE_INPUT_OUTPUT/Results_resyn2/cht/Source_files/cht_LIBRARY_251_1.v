...
module FAU ( 
  ...
  oai21  g079(.a(new_n162_), .b(new_n161_), .c(new_n85_), .O(z22));
  ...
  oai21  g085(.a(new_n168_), .b(new_n167_), .c(new_n85_), .O(z24));
  nor2   g086(.a(x37), .b(new_n151_), .O(new_n170_));
  oai21  g087(.a(x36), .b(x09), .c(new_n88_), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(new_n170_), .O(z25));
  nor2   g089(.a(x38), .b(new_n151_), .O(new_n173_));
  ...
  nand2  g095(.a(x14), .b(new_n146_), .O(new_n179_));
  ...
  oai21  g101(.a(x14), .b(new_n151_), .c(new_n177_), .O(new_n185_));
  ...
  oai21  g106(.a(x14), .b(new_n151_), .c(new_n183_), .O(new_n190_));
  ...
  oai21  g111(.a(x14), .b(new_n151_), .c(new_n188_), .O(new_n195_));
  ...
  oai21  g116(.a(x14), .b(new_n151_), .c(new_n193_), .O(new_n200_));
  ...
  oai21  g121(.a(x14), .b(new_n151_), .c(new_n198_), .O(new_n205_));
  ...
  oai21  g126(.a(x14), .b(new_n151_), .c(new_n203_), .O(new_n210_));
  ...
  oai21  g131(.a(x14), .b(new_n151_), .c(new_n208_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n88_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n85_), .O(z34));
  nand3  g134(.a(new_n176_), .b(x09), .c(new_n146_), .O(new_n218_));
  oai21  g135(.a(x14), .b(new_n151_), .c(new_n213_), .O(new_n219_));
