...
module FAU ( 
  ...
  nand2  g042(.a(new_n86_), .b(x08), .O(new_n126_));
  ...
  oai22  g061(.a(new_n144_), .b(x08), .c(new_n126_), .d(new_n143_), .O(z18));
  ...
  nand2  g108(.a(new_n191_), .b(new_n90_), .O(z30));
  ...
  nand2  g113(.a(new_n196_), .b(new_n90_), .O(z31));
