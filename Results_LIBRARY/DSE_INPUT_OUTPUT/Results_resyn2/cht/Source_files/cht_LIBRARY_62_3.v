...
module FAU ( 
  ...
  nor2   g043(.a(x23), .b(new_n105_), .O(new_n127_));
  oai21  g044(.a(x22), .b(x08), .c(new_n87_), .O(new_n128_));
  oai21  g045(.a(new_n128_), .b(new_n127_), .c(new_n84_), .O(z11));
  ...
  oai21  g060(.a(x26), .b(x08), .c(new_n87_), .O(new_n144_));
  oai21  g061(.a(new_n144_), .b(new_n143_), .c(new_n84_), .O(z15));
  inv1   g062(.a(x28), .O(new_n146_));
  oai21  g063(.a(x27), .b(x08), .c(new_n87_), .O(new_n147_));
  aoi21  g064(.a(new_n146_), .b(x08), .c(new_n147_), .O(z16));
  nor2   g065(.a(x29), .b(new_n105_), .O(new_n149_));
  oai21  g066(.a(x28), .b(x08), .c(new_n87_), .O(new_n150_));
  oai21  g067(.a(new_n150_), .b(new_n149_), .c(new_n84_), .O(z17));
  nor2   g068(.a(x30), .b(new_n105_), .O(new_n152_));
  oai21  g069(.a(x29), .b(x08), .c(new_n87_), .O(new_n153_));
  nor2   g070(.a(new_n153_), .b(new_n152_), .O(z18));
  inv1   g071(.a(x00), .O(new_n155_));
  oai21  g072(.a(x30), .b(x08), .c(new_n87_), .O(new_n156_));
  aoi21  g073(.a(x08), .b(new_n155_), .c(new_n156_), .O(z19));
  inv1   g074(.a(x31), .O(new_n158_));
  oai21  g075(.a(x32), .b(x10), .c(x09), .O(new_n159_));
  inv1   g076(.a(x09), .O(new_n160_));
  nand2  g077(.a(new_n87_), .b(new_n160_), .O(new_n161_));
  oai21  g078(.a(new_n161_), .b(new_n158_), .c(new_n159_), .O(z20));
  ...
  oai21  g083(.a(new_n161_), .b(new_n163_), .c(new_n166_), .O(z22));
  inv1   g084(.a(x34), .O(new_n168_));
  oai21  g085(.a(x35), .b(x10), .c(x09), .O(new_n169_));
  oai21  g086(.a(new_n161_), .b(new_n168_), .c(new_n169_), .O(z23));
  nor2   g087(.a(x36), .b(new_n160_), .O(new_n171_));
  oai21  g088(.a(x35), .b(x09), .c(new_n87_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(new_n171_), .O(z24));
  nor2   g090(.a(x37), .b(new_n160_), .O(new_n174_));
  oai21  g091(.a(x36), .b(x09), .c(new_n87_), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(new_n174_), .O(z25));
  nor2   g093(.a(x38), .b(new_n160_), .O(new_n177_));
  ...
  aoi21  g098(.a(x39), .b(new_n181_), .c(new_n160_), .O(new_n182_));
  ...
  oai21  g104(.a(x14), .b(new_n160_), .c(new_n187_), .O(new_n188_));
  ...
  oai21  g109(.a(x14), .b(new_n160_), .c(new_n185_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(new_n87_), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z29));
  nand2  g112(.a(new_n181_), .b(x09), .O(new_n196_));
  nand2  g113(.a(x10), .b(new_n160_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(x41), .O(new_n198_));
  inv1   g115(.a(x42), .O(new_n199_));
  oai21  g116(.a(new_n199_), .b(x14), .c(new_n87_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(x09), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n198_), .O(z30));
  nand3  g119(.a(new_n197_), .b(new_n196_), .c(x42), .O(new_n203_));
  inv1   g120(.a(x43), .O(new_n204_));
  oai21  g121(.a(new_n204_), .b(x14), .c(new_n87_), .O(new_n205_));
  ...
  oai21  g126(.a(x14), .b(new_n160_), .c(new_n204_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n87_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z32));
  nand3  g129(.a(new_n197_), .b(new_n196_), .c(x44), .O(new_n213_));
  inv1   g130(.a(x45), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(x14), .c(new_n87_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(x09), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n213_), .O(z33));
  nand3  g134(.a(new_n197_), .b(new_n196_), .c(x45), .O(new_n218_));
  inv1   g135(.a(x46), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(x14), .c(new_n87_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(x09), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n218_), .O(z34));
  nand3  g139(.a(new_n181_), .b(x09), .c(new_n155_), .O(new_n223_));
  oai21  g140(.a(x14), .b(new_n160_), .c(new_n219_), .O(new_n224_));
