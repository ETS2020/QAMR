...
module FAU ( 
  ...
  oai21  g035(.a(new_n110_), .b(new_n117_), .c(new_n118_), .O(z10));
  ...
  oai21  g043(.a(new_n110_), .b(new_n125_), .c(new_n126_), .O(z13));
  ...
  aoi21  g070(.a(new_n152_), .b(x09), .c(new_n153_), .O(z22));
  inv1   g071(.a(x35), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(x09), .O(new_n156_));
  nand2  g073(.a(new_n152_), .b(new_n145_), .O(new_n157_));
  nand3  g074(.a(new_n157_), .b(new_n156_), .c(new_n86_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n89_), .O(z23));
  ...
  nand2  g091(.a(new_n174_), .b(new_n89_), .O(z27));
  ...
  nand2  g113(.a(new_n196_), .b(new_n89_), .O(z31));
