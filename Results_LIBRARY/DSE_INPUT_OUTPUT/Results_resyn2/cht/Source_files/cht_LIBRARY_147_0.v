...
module FAU ( 
  ...
  aoi21  g047(.a(x21), .b(new_n112_), .c(new_n86_), .O(new_n131_));
  ...
  nand3  g053(.a(new_n136_), .b(new_n134_), .c(new_n97_), .O(new_n137_));
  inv1   g054(.a(new_n137_), .O(z11));
  nand2  g055(.a(x24), .b(x08), .O(new_n139_));
  aoi21  g056(.a(x23), .b(new_n112_), .c(new_n86_), .O(new_n140_));
  ...
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n97_), .O(new_n165_));
  ...
  nand3  g086(.a(new_n169_), .b(new_n168_), .c(new_n97_), .O(new_n170_));
  ...
  nand3  g096(.a(new_n179_), .b(new_n176_), .c(new_n97_), .O(new_n180_));
  ...
  nor2   g103(.a(x33), .b(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(x34), .c(x10), .O(z22));
  inv1   g105(.a(x35), .O(new_n189_));
  nor2   g106(.a(new_n86_), .b(new_n177_), .O(new_n190_));
  ...
  nand3  g121(.a(new_n204_), .b(new_n203_), .c(new_n97_), .O(new_n205_));
  ...
  aoi21  g128(.a(x38), .b(new_n177_), .c(new_n86_), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z27));
  nor2   g130(.a(x14), .b(new_n177_), .O(new_n214_));
  ...
  aoi21  g161(.a(new_n216_), .b(x46), .c(new_n86_), .O(new_n245_));
