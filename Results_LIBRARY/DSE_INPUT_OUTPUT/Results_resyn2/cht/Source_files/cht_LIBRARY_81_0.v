...
module FAU ( 
  ...
  aoi21  g044(.a(x19), .b(new_n119_), .c(new_n86_), .O(new_n128_));
  aoi21  g045(.a(new_n128_), .b(new_n127_), .c(x10), .O(z08));
  inv1   g046(.a(new_n87_), .O(new_n130_));
  nor2   g047(.a(x20), .b(x08), .O(new_n131_));
  nor2   g048(.a(new_n131_), .b(new_n130_), .O(z09));
  inv1   g049(.a(x22), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(x08), .c(new_n130_), .O(z10));
  inv1   g051(.a(x23), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(x08), .O(new_n136_));
  nand2  g053(.a(new_n133_), .b(new_n119_), .O(new_n137_));
  ...
  nand2  g073(.a(new_n156_), .b(new_n119_), .O(new_n157_));
  nand3  g074(.a(new_n157_), .b(new_n155_), .c(new_n87_), .O(new_n158_));
  inv1   g075(.a(new_n158_), .O(z16));
  nand2  g076(.a(x29), .b(x08), .O(new_n160_));
  aoi21  g077(.a(x28), .b(new_n119_), .c(new_n86_), .O(new_n161_));
  ...
  nand2  g087(.a(new_n163_), .b(new_n119_), .O(new_n171_));
  ...
  aoi21  g104(.a(x35), .b(new_n175_), .c(new_n86_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z24));
  nand2  g106(.a(x37), .b(x09), .O(new_n190_));
  aoi21  g107(.a(x36), .b(new_n175_), .c(new_n86_), .O(new_n191_));
  ...
  nand2  g132(.a(new_n207_), .b(new_n215_), .O(new_n216_));
  ...
  aoi21  g136(.a(new_n207_), .b(x42), .c(new_n86_), .O(new_n220_));
  ...
  nand2  g141(.a(new_n207_), .b(new_n224_), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n223_), .c(new_n87_), .O(new_n226_));
  inv1   g143(.a(new_n226_), .O(z32));
  nand2  g144(.a(new_n205_), .b(x45), .O(new_n228_));
  aoi21  g145(.a(new_n207_), .b(x44), .c(new_n86_), .O(new_n229_));
  ...
  nand2  g150(.a(new_n207_), .b(new_n233_), .O(new_n234_));
  nand3  g151(.a(new_n234_), .b(new_n232_), .c(new_n87_), .O(new_n235_));
  inv1   g152(.a(new_n235_), .O(z34));
  nand3  g153(.a(new_n101_), .b(x09), .c(new_n169_), .O(new_n237_));
  nand2  g154(.a(new_n207_), .b(new_n231_), .O(new_n238_));
