...
module FAU ( 
  ...
  aoi21  g034(.a(x19), .b(new_n108_), .c(x41), .O(new_n118_));
  ...
  aoi21  g043(.a(x21), .b(new_n108_), .c(x41), .O(new_n127_));
  ...
  nand2  g063(.a(new_n146_), .b(new_n108_), .O(new_n147_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n108_), .O(new_n161_));
  ...
  nand2  g082(.a(new_n158_), .b(new_n108_), .O(new_n166_));
  ...
  nand2  g099(.a(new_n176_), .b(new_n171_), .O(new_n183_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n171_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n198_), .c(new_n86_), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z26));
  nand2  g119(.a(x14), .b(new_n164_), .O(new_n203_));
  ...
  aoi21  g127(.a(new_n210_), .b(x39), .c(x41), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n208_), .c(x10), .O(z28));
  nand2  g129(.a(new_n86_), .b(x40), .O(new_n213_));
  nor2   g130(.a(new_n213_), .b(new_n207_), .O(z29));
  nand2  g131(.a(new_n86_), .b(x42), .O(new_n215_));
  nor2   g132(.a(new_n215_), .b(new_n210_), .O(z30));
  inv1   g133(.a(x43), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n209_), .c(x09), .O(new_n218_));
  inv1   g135(.a(x42), .O(new_n219_));
  nand2  g136(.a(new_n210_), .b(new_n219_), .O(new_n220_));
  ...
  nand2  g141(.a(new_n210_), .b(new_n217_), .O(new_n225_));
  nand3  g142(.a(new_n225_), .b(new_n224_), .c(new_n86_), .O(new_n226_));
  inv1   g143(.a(new_n226_), .O(z32));
  inv1   g144(.a(x45), .O(new_n228_));
  nand3  g145(.a(new_n228_), .b(new_n209_), .c(x09), .O(new_n229_));
  nand2  g146(.a(new_n210_), .b(new_n223_), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(new_n229_), .c(new_n86_), .O(new_n231_));
  inv1   g148(.a(new_n231_), .O(z33));
  inv1   g149(.a(x46), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n209_), .c(x09), .O(new_n234_));
  nand2  g151(.a(new_n210_), .b(new_n228_), .O(new_n235_));
  nand3  g152(.a(new_n235_), .b(new_n234_), .c(new_n86_), .O(new_n236_));
  inv1   g153(.a(new_n236_), .O(z34));
  nand3  g154(.a(new_n209_), .b(x09), .c(new_n164_), .O(new_n238_));
  nand2  g155(.a(new_n210_), .b(new_n233_), .O(new_n239_));
