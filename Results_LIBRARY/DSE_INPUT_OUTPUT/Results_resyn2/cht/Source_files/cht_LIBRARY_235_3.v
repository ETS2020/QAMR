...
module FAU ( 
  ...
  nand2  g068(.a(new_n151_), .b(new_n89_), .O(z20));
  ...
  nand2  g073(.a(new_n156_), .b(new_n89_), .O(z21));
  inv1   g074(.a(x34), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(x09), .O(new_n159_));
  nand2  g076(.a(new_n153_), .b(new_n148_), .O(new_n160_));
  nand3  g077(.a(new_n160_), .b(new_n159_), .c(new_n86_), .O(new_n161_));
  nand2  g078(.a(new_n161_), .b(new_n89_), .O(z22));
  ...
  nand2  g083(.a(new_n166_), .b(new_n89_), .O(z23));
  nor2   g084(.a(x36), .b(new_n148_), .O(new_n168_));
  oai21  g085(.a(x35), .b(x09), .c(new_n86_), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n89_), .O(z24));
  nor2   g087(.a(x37), .b(new_n148_), .O(new_n171_));
  ...
  aoi21  g097(.a(new_n174_), .b(new_n148_), .c(x10), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(z27));
  ...
  nand3  g138(.a(new_n178_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand2  g139(.a(new_n187_), .b(new_n216_), .O(new_n223_));
