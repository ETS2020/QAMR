...
module FAU ( 
  ...
  nand2  g038(.a(new_n84_), .b(new_n121_), .O(new_n122_));
  nand3  g039(.a(new_n122_), .b(new_n120_), .c(new_n101_), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n99_), .O(z06));
  inv1   g041(.a(x19), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(x08), .O(new_n126_));
  nand2  g043(.a(new_n119_), .b(new_n121_), .O(new_n127_));
  nand3  g044(.a(new_n127_), .b(new_n126_), .c(new_n101_), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(new_n99_), .O(z07));
  inv1   g046(.a(x20), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(x08), .O(new_n131_));
  nand2  g048(.a(new_n125_), .b(new_n121_), .O(new_n132_));
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(new_n101_), .O(new_n133_));
  nand2  g050(.a(new_n133_), .b(new_n99_), .O(z08));
  nand2  g051(.a(new_n130_), .b(new_n121_), .O(new_n135_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n140_), .c(new_n85_), .O(new_n143_));
  inv1   g060(.a(new_n143_), .O(z10));
  nand2  g061(.a(new_n141_), .b(new_n121_), .O(new_n145_));
  inv1   g062(.a(x23), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(x08), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(new_n145_), .c(new_n85_), .O(new_n148_));
  inv1   g065(.a(new_n148_), .O(z11));
  inv1   g066(.a(x24), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(x08), .O(new_n151_));
  nand2  g068(.a(new_n146_), .b(new_n121_), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(new_n101_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n99_), .O(z12));
  nand2  g071(.a(new_n150_), .b(new_n121_), .O(new_n155_));
  inv1   g072(.a(x25), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(x08), .O(new_n157_));
  nand3  g074(.a(new_n157_), .b(new_n155_), .c(new_n85_), .O(new_n158_));
  inv1   g075(.a(new_n158_), .O(z13));
  nand2  g076(.a(new_n156_), .b(new_n121_), .O(new_n160_));
  ...
  nand2  g081(.a(new_n161_), .b(new_n121_), .O(new_n165_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n99_), .O(z16));
  inv1   g091(.a(x29), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(x08), .O(new_n176_));
  nand2  g093(.a(new_n170_), .b(new_n121_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n176_), .c(new_n101_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n99_), .O(z17));
  inv1   g096(.a(x30), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(x08), .O(new_n181_));
  nand2  g098(.a(new_n175_), .b(new_n121_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n181_), .c(new_n101_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n99_), .O(z18));
  inv1   g101(.a(x00), .O(new_n185_));
  nand2  g102(.a(x08), .b(new_n185_), .O(new_n186_));
  nand2  g103(.a(new_n180_), .b(new_n121_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n101_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n99_), .O(z19));
  ...
  nand2  g115(.a(new_n193_), .b(new_n190_), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n198_), .c(new_n101_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n99_), .O(z21));
  inv1   g118(.a(x34), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(x09), .O(new_n203_));
  nand2  g120(.a(new_n197_), .b(new_n190_), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n203_), .c(new_n101_), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(new_n99_), .O(z22));
  nand2  g123(.a(new_n202_), .b(new_n190_), .O(new_n207_));
  inv1   g124(.a(x35), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(x09), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n207_), .c(new_n85_), .O(new_n210_));
  inv1   g127(.a(new_n210_), .O(z23));
  inv1   g128(.a(x36), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(x09), .O(new_n213_));
  nand2  g130(.a(new_n208_), .b(new_n190_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n101_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n99_), .O(z24));
  nand2  g133(.a(new_n212_), .b(new_n190_), .O(new_n217_));
  inv1   g134(.a(x37), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(x09), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n217_), .c(new_n85_), .O(new_n220_));
  inv1   g137(.a(new_n220_), .O(z25));
  nand2  g138(.a(new_n218_), .b(new_n190_), .O(new_n222_));
  inv1   g139(.a(x38), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(x09), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n222_), .c(new_n85_), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(z26));
  nand2  g143(.a(x14), .b(x00), .O(new_n227_));
  nand2  g144(.a(x39), .b(new_n104_), .O(new_n228_));
  nand3  g145(.a(new_n228_), .b(new_n227_), .c(x09), .O(new_n229_));
  aoi21  g146(.a(new_n223_), .b(new_n190_), .c(x10), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n99_), .O(z27));
  inv1   g149(.a(x40), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n104_), .c(x09), .O(new_n234_));
  inv1   g151(.a(x39), .O(new_n235_));
  nand2  g152(.a(new_n104_), .b(x09), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n234_), .c(new_n101_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n99_), .O(z28));
  inv1   g156(.a(x41), .O(new_n240_));
  nand3  g157(.a(new_n240_), .b(new_n104_), .c(x09), .O(new_n241_));
  ...
  nand3  g186(.a(new_n104_), .b(x09), .c(new_n185_), .O(new_n270_));
