...
module FAU ( 
  ...
  aoi21  g042(.a(new_n84_), .b(x08), .c(new_n125_), .O(z12));
  ...
  nand2  g053(.a(new_n136_), .b(new_n85_), .O(z15));
  nor2   g054(.a(x28), .b(new_n106_), .O(new_n138_));
  oai21  g055(.a(x27), .b(x08), .c(new_n88_), .O(new_n139_));
  oai21  g056(.a(new_n139_), .b(new_n138_), .c(new_n85_), .O(z16));
  ...
  oai21  g061(.a(x29), .b(x08), .c(new_n88_), .O(new_n145_));
  oai21  g062(.a(new_n145_), .b(new_n144_), .c(new_n85_), .O(z18));
  inv1   g063(.a(x00), .O(new_n147_));
  oai21  g064(.a(x30), .b(x08), .c(new_n88_), .O(new_n148_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n85_), .O(z21));
  nor2   g075(.a(x34), .b(new_n155_), .O(new_n159_));
  oai21  g076(.a(x33), .b(x09), .c(new_n88_), .O(new_n160_));
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n85_), .O(z22));
  ...
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n85_), .O(z25));
