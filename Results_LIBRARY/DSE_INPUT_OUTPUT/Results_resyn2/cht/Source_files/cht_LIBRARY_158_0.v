...
module FAU ( 
  ...
  nand2  g062(.a(new_n139_), .b(new_n116_), .O(new_n146_));
  ...
  aoi21  g071(.a(x25), .b(new_n116_), .c(new_n86_), .O(new_n155_));
  aoi21  g072(.a(new_n155_), .b(new_n154_), .c(x10), .O(z14));
  nor2   g073(.a(x26), .b(x08), .O(new_n157_));
  aoi21  g074(.a(new_n157_), .b(x27), .c(x10), .O(z15));
  nor3   g075(.a(x28), .b(new_n86_), .c(new_n116_), .O(new_n159_));
  nor2   g076(.a(new_n159_), .b(x10), .O(z16));
  nand2  g077(.a(x29), .b(x08), .O(new_n161_));
  aoi21  g078(.a(x28), .b(new_n116_), .c(new_n86_), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(new_n161_), .c(x10), .O(z17));
  nand2  g080(.a(x30), .b(x08), .O(new_n164_));
  aoi21  g081(.a(x29), .b(new_n116_), .c(new_n86_), .O(new_n165_));
  ...
  aoi21  g100(.a(x34), .b(new_n174_), .c(new_n86_), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z23));
  nand2  g102(.a(x36), .b(x09), .O(new_n186_));
  aoi21  g103(.a(x35), .b(new_n174_), .c(new_n86_), .O(new_n187_));
  ...
  aoi21  g112(.a(x37), .b(new_n174_), .c(new_n86_), .O(new_n196_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n174_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n87_), .O(new_n202_));
  aoi21  g119(.a(new_n199_), .b(x09), .c(new_n202_), .O(z27));
  ...
  nand2  g134(.a(new_n206_), .b(new_n217_), .O(new_n218_));
  ...
  nand2  g139(.a(new_n206_), .b(new_n215_), .O(new_n223_));
  ...
  nand2  g144(.a(new_n206_), .b(new_n221_), .O(new_n228_));
  ...
  nand2  g149(.a(new_n206_), .b(new_n226_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n232_), .c(new_n87_), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(z34));
  nand2  g152(.a(new_n204_), .b(x00), .O(new_n236_));
  aoi21  g153(.a(new_n206_), .b(x46), .c(new_n86_), .O(new_n237_));
