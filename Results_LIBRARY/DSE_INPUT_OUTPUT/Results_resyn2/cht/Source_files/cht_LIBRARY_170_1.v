...
module FAU ( 
  ...
  aoi21  g021(.a(x14), .b(new_n87_), .c(x24), .O(new_n105_));
  aoi21  g022(.a(new_n105_), .b(new_n104_), .c(x10), .O(z03));
  nand2  g023(.a(x07), .b(x02), .O(new_n107_));
  aoi21  g024(.a(x15), .b(new_n87_), .c(x24), .O(new_n108_));
  ...
  aoi21  g052(.a(x22), .b(new_n117_), .c(x24), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n135_), .c(x10), .O(z11));
  nand3  g054(.a(new_n86_), .b(x23), .c(new_n117_), .O(new_n138_));
  inv1   g055(.a(new_n138_), .O(z12));
  aoi21  g056(.a(x25), .b(x08), .c(x24), .O(new_n140_));
  nor2   g057(.a(new_n140_), .b(x10), .O(z13));
  nand2  g058(.a(x26), .b(x08), .O(new_n142_));
  aoi21  g059(.a(x25), .b(new_n117_), .c(x24), .O(new_n143_));
  ...
  aoi21  g083(.a(x30), .b(new_n117_), .c(x24), .O(new_n167_));
  ...
  aoi21  g090(.a(x32), .b(new_n170_), .c(x24), .O(new_n174_));
  ...
  aoi21  g104(.a(x35), .b(new_n170_), .c(x24), .O(new_n188_));
  ...
  nand3  g143(.a(new_n226_), .b(new_n206_), .c(x09), .O(new_n227_));
  ...
  nand2  g147(.a(new_n204_), .b(x45), .O(new_n231_));
  aoi21  g148(.a(new_n207_), .b(x44), .c(x24), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n231_), .c(x10), .O(z33));
  inv1   g150(.a(x46), .O(new_n234_));
  nand3  g151(.a(new_n234_), .b(new_n206_), .c(x09), .O(new_n235_));
  ...
  nand3  g156(.a(new_n206_), .b(x09), .c(new_n199_), .O(new_n240_));
  nand2  g157(.a(new_n207_), .b(new_n234_), .O(new_n241_));
