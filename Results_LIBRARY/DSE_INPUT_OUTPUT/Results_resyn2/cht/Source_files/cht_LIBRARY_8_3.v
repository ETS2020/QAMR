...
module FAU ( 
  ...
  nor2   g056(.a(x30), .b(new_n107_), .O(new_n140_));
  ...
  aoi21  g085(.a(new_n167_), .b(x09), .c(new_n168_), .O(z26));
  ...
  aoi21  g090(.a(new_n167_), .b(new_n146_), .c(x10), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n92_), .O(z27));
  ...
  nand2  g124(.a(new_n207_), .b(new_n92_), .O(z33));
  ...
  nand2  g129(.a(new_n212_), .b(new_n92_), .O(z34));
  nand3  g130(.a(new_n171_), .b(x09), .c(new_n143_), .O(new_n214_));
  nand2  g131(.a(new_n180_), .b(new_n209_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(new_n86_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n92_), .O(z35));
endmodule
