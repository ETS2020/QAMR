...
module FAU ( 
  ...
  nand2  g008(.a(x46), .b(x10), .O(new_n92_));
  ...
  nand2  g035(.a(new_n118_), .b(new_n92_), .O(z09));
  nor2   g036(.a(x22), .b(new_n105_), .O(new_n120_));
  oai21  g037(.a(x21), .b(x08), .c(new_n86_), .O(new_n121_));
  oai21  g038(.a(new_n121_), .b(new_n120_), .c(new_n92_), .O(z10));
  ...
  oai21  g053(.a(new_n136_), .b(new_n135_), .c(new_n92_), .O(z15));
  ...
  oai21  g069(.a(new_n152_), .b(new_n151_), .c(new_n92_), .O(z20));
  inv1   g070(.a(x33), .O(new_n154_));
  oai21  g071(.a(x32), .b(x09), .c(new_n86_), .O(new_n155_));
  aoi21  g072(.a(new_n154_), .b(x09), .c(new_n155_), .O(z21));
  nor2   g073(.a(x34), .b(new_n150_), .O(new_n157_));
  oai21  g074(.a(x33), .b(x09), .c(new_n86_), .O(new_n158_));
  oai21  g075(.a(new_n158_), .b(new_n157_), .c(new_n92_), .O(z22));
  ...
  oai21  g081(.a(new_n164_), .b(new_n163_), .c(new_n92_), .O(z24));
  ...
  oai21  g086(.a(x37), .b(x09), .c(new_n86_), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(new_n169_), .c(new_n92_), .O(z26));
  inv1   g088(.a(x14), .O(new_n172_));
  inv1   g089(.a(x39), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g091(.a(x14), .b(new_n147_), .O(new_n175_));
  ...
  oai21  g127(.a(x14), .b(new_n150_), .c(new_n204_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n86_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n172_), .b(x09), .c(new_n147_), .O(new_n214_));
  oai21  g131(.a(x14), .b(new_n150_), .c(new_n209_), .O(new_n215_));
