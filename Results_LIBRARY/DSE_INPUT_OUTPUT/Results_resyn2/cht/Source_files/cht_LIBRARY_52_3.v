...
module FAU ( 
  ...
  nor2   g056(.a(x27), .b(new_n107_), .O(new_n140_));
  oai21  g057(.a(x26), .b(x08), .c(new_n87_), .O(new_n141_));
  oai21  g058(.a(new_n141_), .b(new_n140_), .c(new_n84_), .O(z15));
  inv1   g059(.a(x28), .O(new_n143_));
  oai21  g060(.a(x27), .b(x08), .c(new_n87_), .O(new_n144_));
  aoi21  g061(.a(new_n143_), .b(x08), .c(new_n144_), .O(z16));
  nor2   g062(.a(x29), .b(new_n107_), .O(new_n146_));
  oai21  g063(.a(x28), .b(x08), .c(new_n87_), .O(new_n147_));
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n84_), .O(z17));
  ...
  nand2  g070(.a(new_n149_), .b(new_n107_), .O(new_n154_));
  ...
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n84_), .O(z21));
  ...
  nor2   g092(.a(x37), .b(new_n159_), .O(new_n176_));
  oai21  g093(.a(x36), .b(x09), .c(new_n87_), .O(new_n177_));
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(new_n84_), .O(z25));
  nor2   g095(.a(x38), .b(new_n159_), .O(new_n179_));
  ...
  nand2  g101(.a(x14), .b(new_n152_), .O(new_n185_));
  ...
  nand3  g140(.a(new_n182_), .b(x09), .c(new_n152_), .O(new_n224_));
  oai21  g141(.a(x14), .b(new_n159_), .c(new_n219_), .O(new_n225_));
