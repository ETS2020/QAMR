...
module FAU ( 
  ...
  nand2  g000(.a(x33), .b(x10), .O(new_n84_));
  ...
  nor2   g064(.a(x30), .b(new_n108_), .O(new_n148_));
  ...
  oai21  g077(.a(x10), .b(new_n154_), .c(x33), .O(new_n161_));
  nand3  g078(.a(x34), .b(new_n87_), .c(x09), .O(new_n162_));
  ...
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n84_), .O(z23));
  ...
  nand2  g095(.a(x14), .b(new_n151_), .O(new_n179_));
  ...
  nand2  g103(.a(new_n186_), .b(new_n84_), .O(z28));
  ...
  nand2  g108(.a(new_n191_), .b(new_n84_), .O(z29));
  ...
  nand3  g134(.a(new_n176_), .b(x09), .c(new_n151_), .O(new_n218_));
