...
module FAU ( 
  ...
  aoi21  g045(.a(x22), .b(new_n109_), .c(x09), .O(new_n129_));
  ...
  nand2  g050(.a(new_n133_), .b(new_n109_), .O(new_n134_));
  nand3  g051(.a(new_n134_), .b(new_n132_), .c(new_n96_), .O(new_n135_));
  inv1   g052(.a(new_n135_), .O(z12));
  inv1   g053(.a(x25), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(x08), .O(new_n138_));
  nand2  g055(.a(new_n131_), .b(new_n109_), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(new_n138_), .c(new_n96_), .O(new_n140_));
  inv1   g057(.a(new_n140_), .O(z13));
  inv1   g058(.a(x26), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(x08), .O(new_n143_));
  nand2  g060(.a(new_n137_), .b(new_n109_), .O(new_n144_));
  nand3  g061(.a(new_n144_), .b(new_n143_), .c(new_n96_), .O(new_n145_));
  inv1   g062(.a(new_n145_), .O(z14));
  inv1   g063(.a(x27), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(x08), .O(new_n148_));
  nand2  g065(.a(new_n142_), .b(new_n109_), .O(new_n149_));
  nand3  g066(.a(new_n149_), .b(new_n148_), .c(new_n96_), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z15));
  nand2  g068(.a(x28), .b(x08), .O(new_n152_));
  aoi21  g069(.a(x27), .b(new_n109_), .c(x09), .O(new_n153_));
  ...
  nand2  g074(.a(new_n157_), .b(new_n109_), .O(new_n158_));
  nand3  g075(.a(new_n158_), .b(new_n156_), .c(new_n96_), .O(new_n159_));
  inv1   g076(.a(new_n159_), .O(z17));
  nand2  g077(.a(x30), .b(x08), .O(new_n161_));
  aoi21  g078(.a(x29), .b(new_n109_), .c(x09), .O(new_n162_));
  ...
  nand2  g083(.a(new_n166_), .b(new_n109_), .O(new_n167_));
  ...
  aoi21  g090(.a(new_n173_), .b(new_n170_), .c(x10), .O(z21));
  nand2  g091(.a(new_n96_), .b(x33), .O(new_n175_));
  inv1   g092(.a(new_n175_), .O(z22));
  nand2  g093(.a(new_n96_), .b(x34), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z23));
  inv1   g095(.a(x35), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n170_), .c(x10), .O(z24));
  nand2  g097(.a(new_n96_), .b(x36), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z25));
  nand2  g099(.a(new_n96_), .b(x37), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z26));
  nand2  g101(.a(new_n96_), .b(x38), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z27));
  nand2  g103(.a(new_n96_), .b(x39), .O(new_n187_));
  ...
  aoi21  g110(.a(new_n193_), .b(new_n170_), .c(x10), .O(z31));
  inv1   g111(.a(x43), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n170_), .c(x10), .O(z32));
  nand2  g113(.a(new_n96_), .b(x44), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z33));
  nand2  g115(.a(new_n96_), .b(x45), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z34));
  nand2  g117(.a(new_n96_), .b(x46), .O(new_n201_));
