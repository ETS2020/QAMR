...
module FAU ( 
  ...
  nor2   g117(.a(x14), .b(new_n146_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(x44), .O(new_n202_));
  aoi21  g119(.a(new_n182_), .b(x43), .c(new_n86_), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n202_), .c(x10), .O(z32));
  nand2  g121(.a(new_n201_), .b(x45), .O(new_n205_));
  aoi21  g122(.a(new_n182_), .b(x44), .c(new_n86_), .O(new_n206_));
  ...
  nand2  g127(.a(new_n182_), .b(new_n210_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n209_), .c(new_n87_), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(z34));
  nand3  g130(.a(new_n104_), .b(x09), .c(new_n143_), .O(new_n214_));
  nand2  g131(.a(new_n182_), .b(new_n208_), .O(new_n215_));
