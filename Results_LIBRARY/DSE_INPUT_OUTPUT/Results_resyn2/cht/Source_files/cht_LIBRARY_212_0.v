...
module FAU ( 
  ...
  nand3  g031(.a(new_n114_), .b(new_n112_), .c(new_n94_), .O(new_n115_));
  inv1   g032(.a(new_n115_), .O(z05));
  nand2  g033(.a(new_n94_), .b(x18), .O(new_n117_));
  inv1   g034(.a(new_n117_), .O(z06));
  inv1   g035(.a(x19), .O(new_n119_));
  aoi21  g036(.a(new_n119_), .b(x08), .c(x10), .O(z07));
  nand2  g037(.a(new_n94_), .b(x20), .O(new_n121_));
  inv1   g038(.a(new_n121_), .O(z08));
  nand2  g039(.a(new_n94_), .b(x21), .O(new_n123_));
  ...
  nand2  g057(.a(new_n94_), .b(x30), .O(new_n141_));
  ...
  aoi21  g087(.a(x38), .b(new_n146_), .c(new_n86_), .O(new_n171_));
  aoi21  g088(.a(new_n171_), .b(new_n170_), .c(x10), .O(z27));
  inv1   g089(.a(x40), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n101_), .c(x09), .O(new_n174_));
  nand2  g091(.a(new_n101_), .b(x09), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n168_), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n174_), .c(new_n94_), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z28));
  inv1   g095(.a(x41), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n101_), .c(x09), .O(new_n180_));
  nand2  g097(.a(new_n175_), .b(new_n173_), .O(new_n181_));
  ...
  nand2  g102(.a(new_n175_), .b(new_n179_), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n185_), .c(new_n94_), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(z30));
  inv1   g105(.a(x43), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n101_), .c(x09), .O(new_n190_));
  nand2  g107(.a(new_n175_), .b(new_n184_), .O(new_n191_));
  ...
  nand2  g111(.a(new_n194_), .b(x44), .O(new_n195_));
  aoi21  g112(.a(new_n175_), .b(x43), .c(new_n86_), .O(new_n196_));
  ...
  nand2  g117(.a(new_n175_), .b(new_n200_), .O(new_n201_));
  nand3  g118(.a(new_n201_), .b(new_n199_), .c(new_n94_), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z33));
  nand2  g120(.a(new_n194_), .b(x46), .O(new_n204_));
  aoi21  g121(.a(new_n175_), .b(x45), .c(new_n86_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z34));
  nand2  g123(.a(new_n194_), .b(x00), .O(new_n207_));
  aoi21  g124(.a(new_n175_), .b(x46), .c(new_n86_), .O(new_n208_));
