...
module FAU ( 
  ...
  oai21  g052(.a(new_n108_), .b(new_n132_), .c(new_n135_), .O(z16));
  inv1   g053(.a(x28), .O(new_n137_));
  oai21  g054(.a(x29), .b(x10), .c(x08), .O(new_n138_));
  oai21  g055(.a(new_n108_), .b(new_n137_), .c(new_n138_), .O(z17));
  ...
  nand2  g068(.a(new_n151_), .b(new_n92_), .O(z20));
  nor2   g069(.a(x33), .b(new_n148_), .O(new_n153_));
  oai21  g070(.a(x32), .b(x09), .c(new_n86_), .O(new_n154_));
  oai21  g071(.a(new_n154_), .b(new_n153_), .c(new_n92_), .O(z21));
  ...
  nor2   g075(.a(x35), .b(new_n148_), .O(new_n159_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n92_), .O(z27));
  ...
  nand2  g124(.a(new_n207_), .b(new_n92_), .O(z32));
  ...
  nand2  g129(.a(new_n212_), .b(new_n92_), .O(z33));
