...
module FAU ( 
  ...
  nand2  g029(.a(new_n86_), .b(x18), .O(new_n113_));
  ...
  nand2  g045(.a(new_n86_), .b(x26), .O(new_n129_));
  inv1   g046(.a(new_n129_), .O(z15));
  nand2  g047(.a(new_n86_), .b(x27), .O(new_n131_));
  inv1   g048(.a(new_n131_), .O(z16));
  nand2  g049(.a(new_n86_), .b(x28), .O(new_n133_));
  inv1   g050(.a(new_n133_), .O(z17));
  nand2  g051(.a(new_n86_), .b(x29), .O(new_n135_));
  ...
  nand2  g068(.a(x36), .b(x09), .O(new_n152_));
  aoi21  g069(.a(x35), .b(new_n140_), .c(x08), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(new_n152_), .c(x10), .O(z24));
  inv1   g071(.a(x37), .O(new_n155_));
  ...
  nand3  g101(.a(new_n184_), .b(new_n168_), .c(x09), .O(new_n185_));
  ...
  nand2  g106(.a(new_n180_), .b(x43), .O(new_n190_));
  ...
  nand2  g112(.a(new_n176_), .b(new_n195_), .O(new_n196_));
  ...
  nand3  g125(.a(new_n168_), .b(x09), .c(new_n166_), .O(new_n209_));
  nand2  g126(.a(new_n176_), .b(new_n204_), .O(new_n210_));
