...
module FAU ( 
  ...
  oai21  g040(.a(x22), .b(x08), .c(new_n85_), .O(new_n124_));
  ...
  nand2  g086(.a(new_n163_), .b(new_n159_), .O(new_n170_));
  nand3  g087(.a(new_n170_), .b(new_n169_), .c(new_n85_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n92_), .O(z23));
  nor2   g089(.a(x36), .b(new_n159_), .O(new_n173_));
  oai21  g090(.a(x35), .b(x09), .c(new_n85_), .O(new_n174_));
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n92_), .O(z24));
  nor2   g092(.a(x37), .b(new_n159_), .O(new_n176_));
  oai21  g093(.a(x36), .b(x09), .c(new_n85_), .O(new_n177_));
  nor2   g094(.a(new_n177_), .b(new_n176_), .O(z25));
  nor2   g095(.a(x38), .b(new_n159_), .O(new_n179_));
  oai21  g096(.a(x37), .b(x09), .c(new_n85_), .O(new_n180_));
  ...
  nand2  g101(.a(x14), .b(new_n149_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  oai21  g103(.a(x38), .b(x09), .c(new_n85_), .O(new_n187_));
  ...
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(new_n85_), .O(new_n212_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n215_), .c(new_n85_), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(new_n92_), .O(z33));
