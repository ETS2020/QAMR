...
module FAU ( 
  ...
  nor2   g002(.a(x24), .b(x10), .O(new_n86_));
  ...
  aoi21  g009(.a(x12), .b(new_n87_), .c(x24), .O(new_n93_));
  ...
  nand3  g040(.a(new_n123_), .b(new_n120_), .c(new_n86_), .O(new_n124_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n121_), .O(new_n168_));
  ...
  nand2  g089(.a(new_n165_), .b(new_n121_), .O(new_n173_));
  ...
  aoi21  g100(.a(x32), .b(new_n178_), .c(x24), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z21));
  nand2  g102(.a(x34), .b(x09), .O(new_n186_));
  aoi21  g103(.a(x33), .b(new_n178_), .c(x24), .O(new_n187_));
  ...
  aoi21  g112(.a(x35), .b(new_n178_), .c(x24), .O(new_n196_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n103_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n209_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(x38), .b(new_n178_), .c(x24), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z27));
  inv1   g131(.a(x40), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n103_), .c(x09), .O(new_n216_));
  ...
  aoi21  g144(.a(new_n217_), .b(x41), .c(x24), .O(new_n228_));
