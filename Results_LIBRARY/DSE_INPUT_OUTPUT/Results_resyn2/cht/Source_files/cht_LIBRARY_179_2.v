...
module FAU ( 
  ...
  nand2  g058(.a(new_n137_), .b(new_n109_), .O(new_n142_));
  nand3  g059(.a(new_n142_), .b(new_n141_), .c(new_n88_), .O(new_n143_));
  nand2  g060(.a(new_n143_), .b(new_n85_), .O(z17));
  ...
  oai21  g068(.a(x31), .b(x09), .c(new_n88_), .O(new_n152_));
  aoi21  g069(.a(new_n151_), .b(x09), .c(new_n152_), .O(z20));
  inv1   g070(.a(x09), .O(new_n154_));
  nor2   g071(.a(x33), .b(new_n154_), .O(new_n155_));
  oai21  g072(.a(x32), .b(x09), .c(new_n88_), .O(new_n156_));
  oai21  g073(.a(new_n156_), .b(new_n155_), .c(new_n85_), .O(z21));
  nor2   g074(.a(x34), .b(new_n154_), .O(new_n158_));
  oai21  g075(.a(x33), .b(x09), .c(new_n88_), .O(new_n159_));
  nor2   g076(.a(new_n159_), .b(new_n158_), .O(z22));
  nor2   g077(.a(x35), .b(new_n154_), .O(new_n161_));
  ...
  aoi21  g097(.a(new_n172_), .b(new_n154_), .c(x10), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n85_), .O(z27));
  ...
  nand2  g111(.a(new_n194_), .b(new_n85_), .O(z29));
  ...
  nand2  g131(.a(new_n214_), .b(new_n85_), .O(z33));
  ...
  nand2  g136(.a(new_n219_), .b(new_n85_), .O(z34));
  nand3  g137(.a(new_n178_), .b(x09), .c(new_n148_), .O(new_n221_));
