...
module FAU ( 
  ...
  oai21  g039(.a(new_n122_), .b(new_n121_), .c(new_n90_), .O(z10));
  ...
  nor2   g071(.a(x32), .b(new_n89_), .O(new_n155_));
  ...
  nand2  g076(.a(new_n86_), .b(x09), .O(new_n160_));
  oai22  g077(.a(new_n160_), .b(new_n158_), .c(new_n159_), .d(x09), .O(z21));
  nor2   g078(.a(x34), .b(new_n89_), .O(new_n162_));
  ...
  oai22  g083(.a(new_n166_), .b(x09), .c(new_n160_), .d(new_n165_), .O(z23));
  inv1   g084(.a(x36), .O(new_n168_));
  nor2   g085(.a(x35), .b(x10), .O(new_n169_));
  oai22  g086(.a(new_n169_), .b(x09), .c(new_n160_), .d(new_n168_), .O(z24));
  nor2   g087(.a(x37), .b(new_n89_), .O(new_n171_));
  oai21  g088(.a(x36), .b(x09), .c(new_n86_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(new_n171_), .O(z25));
  nor2   g090(.a(x38), .b(new_n89_), .O(new_n174_));
  oai21  g091(.a(x37), .b(x09), .c(new_n86_), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(new_n174_), .O(z26));
  oai21  g093(.a(x38), .b(x10), .c(new_n89_), .O(new_n177_));
  ...
  oai21  g106(.a(x41), .b(x14), .c(new_n86_), .O(new_n190_));
  ...
  oai21  g115(.a(x43), .b(x14), .c(new_n86_), .O(new_n199_));
  nor2   g116(.a(x42), .b(x10), .O(new_n200_));
  aoi22  g117(.a(new_n200_), .b(new_n189_), .c(new_n199_), .d(x09), .O(z31));
  ...
  oai21  g124(.a(x45), .b(x14), .c(new_n86_), .O(new_n208_));
  nor2   g125(.a(x44), .b(x10), .O(new_n209_));
  aoi22  g126(.a(new_n209_), .b(new_n189_), .c(new_n208_), .d(x09), .O(z33));
  ...
  nand3  g133(.a(new_n179_), .b(x09), .c(new_n152_), .O(new_n217_));
  oai21  g134(.a(x14), .b(new_n89_), .c(new_n211_), .O(new_n218_));
