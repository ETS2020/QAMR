...
module FAU ( 
  ...
  inv1   g030(.a(new_n87_), .O(new_n114_));
  nor2   g031(.a(x17), .b(x08), .O(new_n115_));
  nor2   g032(.a(new_n115_), .b(new_n114_), .O(z06));
  inv1   g033(.a(x19), .O(new_n117_));
  aoi21  g034(.a(new_n117_), .b(x08), .c(new_n114_), .O(z07));
  inv1   g035(.a(x20), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(x08), .O(new_n120_));
  inv1   g037(.a(x08), .O(new_n121_));
  nand2  g038(.a(new_n117_), .b(new_n121_), .O(new_n122_));
  nand3  g039(.a(new_n122_), .b(new_n120_), .c(new_n87_), .O(new_n123_));
  ...
  nand2  g061(.a(new_n144_), .b(new_n121_), .O(new_n145_));
  nand3  g062(.a(new_n145_), .b(new_n143_), .c(new_n87_), .O(new_n146_));
  inv1   g063(.a(new_n146_), .O(z14));
  inv1   g064(.a(x27), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(x08), .O(new_n149_));
  nand2  g066(.a(new_n142_), .b(new_n121_), .O(new_n150_));
  ...
  nand2  g071(.a(new_n148_), .b(new_n121_), .O(new_n155_));
  ...
  nand2  g076(.a(new_n153_), .b(new_n121_), .O(new_n160_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n172_), .c(new_n87_), .O(new_n176_));
  ...
  nand2  g100(.a(new_n183_), .b(new_n173_), .O(new_n184_));
  ...
  aoi21  g122(.a(x38), .b(new_n173_), .c(new_n86_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z27));
  nor2   g124(.a(x14), .b(new_n173_), .O(new_n208_));
  ...
  nand2  g135(.a(new_n208_), .b(x42), .O(new_n219_));
  aoi21  g136(.a(new_n210_), .b(x41), .c(new_n86_), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z30));
  inv1   g138(.a(x43), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n101_), .c(x09), .O(new_n223_));
  ...
  nand2  g144(.a(new_n208_), .b(x44), .O(new_n228_));
  aoi21  g145(.a(new_n210_), .b(x43), .c(new_n86_), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z32));
  nand2  g147(.a(new_n208_), .b(x45), .O(new_n231_));
  aoi21  g148(.a(new_n210_), .b(x44), .c(new_n86_), .O(new_n232_));
  ...
  nand2  g153(.a(new_n210_), .b(new_n236_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n235_), .c(new_n87_), .O(new_n238_));
  inv1   g155(.a(new_n238_), .O(z34));
  nand2  g156(.a(new_n208_), .b(x00), .O(new_n240_));
  aoi21  g157(.a(new_n210_), .b(x46), .c(new_n86_), .O(new_n241_));
