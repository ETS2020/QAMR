...
module FAU ( 
  ...
  nand2  g039(.a(new_n94_), .b(x24), .O(new_n123_));
  ...
  nand2  g106(.a(new_n173_), .b(x43), .O(new_n190_));
  aoi21  g107(.a(new_n176_), .b(x42), .c(new_n86_), .O(new_n191_));
  ...
  aoi21  g121(.a(new_n176_), .b(x45), .c(new_n86_), .O(new_n205_));
