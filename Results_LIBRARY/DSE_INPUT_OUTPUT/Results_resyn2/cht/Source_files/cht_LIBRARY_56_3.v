...
module FAU ( 
  ...
  oai21  g036(.a(new_n110_), .b(new_n118_), .c(new_n119_), .O(z10));
  inv1   g037(.a(x22), .O(new_n121_));
  oai21  g038(.a(x23), .b(x10), .c(x08), .O(new_n122_));
  oai21  g039(.a(new_n110_), .b(new_n121_), .c(new_n122_), .O(z11));
  inv1   g040(.a(x23), .O(new_n124_));
  oai21  g041(.a(x24), .b(x10), .c(x08), .O(new_n125_));
  oai21  g042(.a(new_n110_), .b(new_n124_), .c(new_n125_), .O(z12));
  ...
  oai21  g047(.a(new_n110_), .b(new_n127_), .c(new_n130_), .O(z14));
  ...
  nor2   g051(.a(x28), .b(new_n109_), .O(new_n135_));
  ...
  oai21  g058(.a(new_n110_), .b(new_n138_), .c(new_n141_), .O(z18));
  ...
  nand2  g090(.a(new_n173_), .b(new_n84_), .O(z27));
  ...
  nand2  g097(.a(new_n180_), .b(new_n84_), .O(z28));
  ...
  nand2  g117(.a(new_n200_), .b(new_n84_), .O(z32));
  ...
  nand2  g127(.a(new_n210_), .b(new_n84_), .O(z34));
  ...
  nand2  g132(.a(new_n215_), .b(new_n84_), .O(z35));
endmodule
