...
module FAU ( 
  ...
  nand2  g116(.a(new_n185_), .b(x44), .O(new_n200_));
  aoi21  g117(.a(new_n181_), .b(x43), .c(x08), .O(new_n201_));
  ...
  nand2  g122(.a(new_n181_), .b(new_n205_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n204_), .c(new_n90_), .O(new_n207_));
  inv1   g124(.a(new_n207_), .O(z33));
  nand2  g125(.a(new_n185_), .b(x46), .O(new_n209_));
  aoi21  g126(.a(new_n181_), .b(x45), .c(x08), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z34));
  nand2  g128(.a(new_n185_), .b(x00), .O(new_n212_));
  aoi21  g129(.a(new_n181_), .b(x46), .c(x08), .O(new_n213_));
