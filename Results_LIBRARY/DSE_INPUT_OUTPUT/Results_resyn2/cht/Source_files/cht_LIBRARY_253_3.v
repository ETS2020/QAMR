...
module FAU ( 
  ...
  nand2  g033(.a(new_n112_), .b(new_n105_), .O(new_n117_));
  nand3  g034(.a(new_n117_), .b(new_n116_), .c(new_n86_), .O(new_n118_));
  nand2  g035(.a(new_n118_), .b(new_n89_), .O(z09));
  inv1   g036(.a(x22), .O(new_n120_));
  nand2  g037(.a(new_n120_), .b(x08), .O(new_n121_));
  nand2  g038(.a(new_n115_), .b(new_n105_), .O(new_n122_));
  ...
  nand2  g043(.a(new_n120_), .b(new_n105_), .O(new_n127_));
  nand3  g044(.a(new_n127_), .b(new_n126_), .c(new_n86_), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(new_n89_), .O(z11));
  nor2   g046(.a(x24), .b(new_n105_), .O(new_n130_));
  oai21  g047(.a(x23), .b(x08), .c(new_n86_), .O(new_n131_));
  oai21  g048(.a(new_n131_), .b(new_n130_), .c(new_n89_), .O(z12));
  ...
  oai21  g054(.a(new_n137_), .b(new_n136_), .c(new_n89_), .O(z14));
  ...
  oai21  g073(.a(new_n156_), .b(new_n155_), .c(new_n89_), .O(z20));
  ...
  nor2   g079(.a(new_n162_), .b(new_n161_), .O(z22));
  ...
  nand2  g091(.a(new_n170_), .b(new_n154_), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n174_), .c(new_n86_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n89_), .O(z26));
  ...
  aoi21  g098(.a(new_n173_), .b(new_n154_), .c(x10), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n89_), .O(z27));
  ...
  nand3  g106(.a(new_n189_), .b(new_n186_), .c(new_n86_), .O(new_n190_));
  ...
  nand2  g137(.a(new_n220_), .b(new_n89_), .O(z34));
  nand3  g138(.a(new_n179_), .b(x09), .c(new_n151_), .O(new_n222_));
