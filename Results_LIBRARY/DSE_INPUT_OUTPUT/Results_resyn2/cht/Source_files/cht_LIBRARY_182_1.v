...
module FAU ( 
  ...
  nand2  g079(.a(new_n162_), .b(new_n85_), .O(z23));
  nor2   g080(.a(x36), .b(new_n152_), .O(new_n164_));
  oai21  g081(.a(x35), .b(x09), .c(new_n88_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n85_), .O(z24));
  ...
  aoi21  g095(.a(new_n170_), .b(new_n152_), .c(x10), .O(new_n179_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n85_), .O(z30));
  ...
  nand2  g129(.a(new_n212_), .b(new_n85_), .O(z33));
