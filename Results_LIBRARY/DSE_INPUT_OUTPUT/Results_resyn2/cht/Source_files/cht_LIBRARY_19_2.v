...
module FAU ( 
  ...
  aoi21  g069(.a(x26), .b(new_n115_), .c(x09), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(new_n152_), .c(x10), .O(z15));
  nand2  g071(.a(x28), .b(x08), .O(new_n155_));
  aoi21  g072(.a(x27), .b(new_n115_), .c(x09), .O(new_n156_));
  ...
  aoi21  g100(.a(new_n183_), .b(new_n170_), .c(x10), .O(z26));
  inv1   g101(.a(x38), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n170_), .c(x10), .O(z27));
  inv1   g103(.a(x39), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n170_), .c(x10), .O(z28));
  nand2  g105(.a(new_n86_), .b(x40), .O(new_n189_));
  inv1   g106(.a(new_n189_), .O(z29));
  nand2  g107(.a(new_n86_), .b(x41), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z30));
  nand2  g109(.a(new_n86_), .b(x42), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z31));
  nand2  g111(.a(new_n86_), .b(x43), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z32));
  nand2  g113(.a(new_n86_), .b(x44), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z33));
  inv1   g115(.a(x45), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n170_), .c(x10), .O(z34));
  nand2  g117(.a(new_n86_), .b(x46), .O(new_n201_));
