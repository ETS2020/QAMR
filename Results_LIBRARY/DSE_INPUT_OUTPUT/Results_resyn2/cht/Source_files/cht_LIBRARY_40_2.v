...
module FAU ( 
  ...
  nand2  g048(.a(new_n131_), .b(new_n90_), .O(z13));
  nor2   g049(.a(x26), .b(new_n106_), .O(new_n133_));
  oai21  g050(.a(x25), .b(x08), .c(new_n86_), .O(new_n134_));
  oai21  g051(.a(new_n134_), .b(new_n133_), .c(new_n90_), .O(z14));
  ...
  nor2   g063(.a(new_n146_), .b(new_n145_), .O(z18));
  ...
  nand2  g077(.a(new_n89_), .b(x09), .O(new_n161_));
  nand2  g078(.a(new_n158_), .b(new_n151_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n86_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n90_), .O(z23));
  ...
  nand2  g093(.a(x14), .b(new_n148_), .O(new_n177_));
  ...
  nand2  g106(.a(new_n189_), .b(new_n90_), .O(z29));
  ...
  nand2  g111(.a(new_n194_), .b(new_n90_), .O(z30));
  ...
  nand3  g132(.a(new_n174_), .b(x09), .c(new_n148_), .O(new_n216_));
