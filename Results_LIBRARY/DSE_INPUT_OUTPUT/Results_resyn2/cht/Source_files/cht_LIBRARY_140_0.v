...
module FAU ( 
  ...
  nand2  g052(.a(new_n135_), .b(new_n119_), .O(new_n136_));
  ...
  nand2  g057(.a(new_n133_), .b(new_n119_), .O(new_n141_));
  ...
  aoi21  g061(.a(x23), .b(new_n119_), .c(new_n99_), .O(new_n145_));
  aoi21  g062(.a(new_n145_), .b(new_n144_), .c(x10), .O(z12));
  nand2  g063(.a(x25), .b(x08), .O(new_n147_));
  aoi21  g064(.a(x24), .b(new_n119_), .c(new_n99_), .O(new_n148_));
  ...
  aoi21  g073(.a(x26), .b(new_n119_), .c(new_n99_), .O(new_n157_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n119_), .O(new_n162_));
  ...
  nand2  g083(.a(new_n159_), .b(new_n119_), .O(new_n167_));
  nand4  g084(.a(new_n167_), .b(new_n166_), .c(new_n84_), .d(x09), .O(new_n168_));
  inv1   g085(.a(new_n168_), .O(z17));
  inv1   g086(.a(x30), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(x08), .O(new_n171_));
  nand2  g088(.a(new_n165_), .b(new_n119_), .O(new_n172_));
  nand4  g089(.a(new_n172_), .b(new_n171_), .c(new_n84_), .d(x09), .O(new_n173_));
  inv1   g090(.a(new_n173_), .O(z18));
  nand2  g091(.a(x08), .b(x00), .O(new_n175_));
  aoi21  g092(.a(x30), .b(new_n119_), .c(new_n99_), .O(new_n176_));
  ...
  nor2   g100(.a(x10), .b(new_n99_), .O(new_n184_));
  ...
  aoi21  g110(.a(x39), .b(new_n104_), .c(new_n99_), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z27));
  nand2  g112(.a(x39), .b(x14), .O(new_n196_));
  aoi21  g113(.a(x40), .b(new_n104_), .c(new_n99_), .O(new_n197_));
  ...
  nand2  g141(.a(new_n104_), .b(new_n224_), .O(new_n225_));
