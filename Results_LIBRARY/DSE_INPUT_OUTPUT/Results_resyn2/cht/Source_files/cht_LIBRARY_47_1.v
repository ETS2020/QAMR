...
module FAU ( 
  ...
  nand3  g072(.a(new_n155_), .b(new_n153_), .c(new_n88_), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(new_n85_), .O(z21));
  ...
  nand2  g091(.a(new_n168_), .b(new_n154_), .O(new_n175_));
  ...
  nand2  g100(.a(x14), .b(new_n146_), .O(new_n184_));
  ...
  nand2  g133(.a(new_n216_), .b(new_n85_), .O(z33));
  ...
  nand3  g139(.a(new_n181_), .b(x09), .c(new_n146_), .O(new_n223_));
