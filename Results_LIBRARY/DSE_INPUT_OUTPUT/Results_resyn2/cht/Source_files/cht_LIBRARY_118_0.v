...
module FAU ( 
  ...
  aoi21  g103(.a(x34), .b(new_n174_), .c(new_n86_), .O(new_n187_));
  ...
  aoi21  g117(.a(x37), .b(new_n174_), .c(new_n86_), .O(new_n201_));
  ...
  aoi21  g124(.a(x38), .b(new_n174_), .c(new_n86_), .O(new_n208_));
