...
module FAU ( 
  ...
  oai21  g050(.a(new_n133_), .b(new_n132_), .c(new_n90_), .O(z13));
  ...
  nor2   g054(.a(x27), .b(new_n109_), .O(new_n138_));
  ...
  nand2  g075(.a(new_n153_), .b(new_n158_), .O(new_n159_));
  nand3  g076(.a(new_n159_), .b(new_n157_), .c(new_n86_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(new_n90_), .O(z21));
  nor2   g078(.a(x34), .b(new_n158_), .O(new_n162_));
  oai21  g079(.a(x33), .b(x09), .c(new_n86_), .O(new_n163_));
  oai21  g080(.a(new_n163_), .b(new_n162_), .c(new_n90_), .O(z22));
  inv1   g081(.a(x35), .O(new_n165_));
  oai21  g082(.a(x34), .b(x09), .c(new_n86_), .O(new_n166_));
  aoi21  g083(.a(new_n165_), .b(x09), .c(new_n166_), .O(z23));
  nor2   g084(.a(x36), .b(new_n158_), .O(new_n168_));
  oai21  g085(.a(x35), .b(x09), .c(new_n86_), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n90_), .O(z24));
  nor2   g087(.a(x37), .b(new_n158_), .O(new_n171_));
  oai21  g088(.a(x36), .b(x09), .c(new_n86_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(new_n171_), .O(z25));
  nor2   g090(.a(x38), .b(new_n158_), .O(new_n174_));
  oai21  g091(.a(x37), .b(x09), .c(new_n86_), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(new_n174_), .O(z26));
  nand2  g093(.a(x14), .b(x00), .O(new_n177_));
  aoi21  g094(.a(x39), .b(new_n89_), .c(new_n158_), .O(new_n178_));
  oai21  g095(.a(x38), .b(x09), .c(new_n86_), .O(new_n179_));
  aoi21  g096(.a(new_n178_), .b(new_n177_), .c(new_n179_), .O(z27));
  nand2  g097(.a(x40), .b(x09), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n86_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(new_n183_));
  nand2  g100(.a(new_n89_), .b(x09), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(x39), .c(new_n86_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n183_), .O(z28));
  nand2  g103(.a(x41), .b(x09), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n86_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n89_), .O(new_n189_));
  nand3  g106(.a(new_n184_), .b(x40), .c(new_n86_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n189_), .O(z29));
  nand2  g108(.a(x42), .b(x09), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n86_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n89_), .O(new_n194_));
  nand3  g111(.a(new_n184_), .b(x41), .c(new_n86_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n194_), .O(z30));
  inv1   g113(.a(x43), .O(new_n197_));
  oai21  g114(.a(new_n197_), .b(new_n158_), .c(new_n86_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n89_), .O(new_n199_));
  nand3  g116(.a(new_n184_), .b(x42), .c(new_n86_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n199_), .O(z31));
  inv1   g118(.a(x44), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n89_), .c(x09), .O(new_n203_));
  oai21  g120(.a(x14), .b(new_n158_), .c(new_n197_), .O(new_n204_));
  ...
  oai21  g133(.a(new_n158_), .b(new_n150_), .c(new_n86_), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(new_n89_), .O(new_n218_));
  nand3  g135(.a(new_n184_), .b(x46), .c(new_n86_), .O(new_n219_));
