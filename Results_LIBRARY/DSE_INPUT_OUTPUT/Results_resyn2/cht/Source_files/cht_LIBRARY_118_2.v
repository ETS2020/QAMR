...
module FAU ( 
  ...
  oai21  g048(.a(new_n131_), .b(new_n130_), .c(new_n93_), .O(z13));
  inv1   g049(.a(x26), .O(new_n133_));
  oai21  g050(.a(x25), .b(x08), .c(new_n86_), .O(new_n134_));
  aoi21  g051(.a(new_n133_), .b(x08), .c(new_n134_), .O(z14));
  nand2  g052(.a(new_n92_), .b(x08), .O(new_n136_));
  nand2  g053(.a(new_n133_), .b(new_n106_), .O(new_n137_));
  nand3  g054(.a(new_n137_), .b(new_n136_), .c(new_n86_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n93_), .O(z15));
  nor2   g056(.a(x28), .b(new_n106_), .O(new_n140_));
  oai21  g057(.a(x27), .b(x08), .c(new_n86_), .O(new_n141_));
  oai21  g058(.a(new_n141_), .b(new_n140_), .c(new_n93_), .O(z16));
  ...
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n93_), .O(z18));
  ...
  nand2  g074(.a(new_n157_), .b(new_n93_), .O(z20));
  nor2   g075(.a(x33), .b(new_n154_), .O(new_n159_));
  oai21  g076(.a(x32), .b(x09), .c(new_n86_), .O(new_n160_));
  oai21  g077(.a(new_n160_), .b(new_n159_), .c(new_n93_), .O(z21));
  ...
  oai21  g083(.a(new_n166_), .b(new_n165_), .c(new_n93_), .O(z23));
  nor2   g084(.a(x36), .b(new_n154_), .O(new_n168_));
  ...
  nand2  g092(.a(new_n171_), .b(new_n154_), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n175_), .c(new_n86_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n93_), .O(z26));
  ...
  aoi21  g099(.a(new_n174_), .b(new_n154_), .c(x10), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n93_), .O(z27));
  ...
  nand3  g139(.a(new_n180_), .b(x09), .c(new_n149_), .O(new_n223_));
