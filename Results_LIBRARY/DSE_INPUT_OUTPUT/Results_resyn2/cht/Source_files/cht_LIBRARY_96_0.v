...
module FAU ( 
  ...
  nand4  g025(.a(new_n108_), .b(new_n106_), .c(new_n98_), .d(x09), .O(new_n109_));
  ...
  nand4  g041(.a(new_n124_), .b(new_n122_), .c(new_n98_), .d(x09), .O(new_n125_));
  ...
  nand4  g046(.a(new_n129_), .b(new_n128_), .c(new_n98_), .d(x09), .O(new_n130_));
  ...
  aoi21  g055(.a(x24), .b(new_n112_), .c(new_n86_), .O(new_n139_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n112_), .O(new_n144_));
  nand4  g061(.a(new_n144_), .b(new_n142_), .c(new_n98_), .d(x09), .O(new_n145_));
  inv1   g062(.a(new_n145_), .O(z14));
  nand2  g063(.a(x27), .b(x08), .O(new_n147_));
  aoi21  g064(.a(x26), .b(new_n112_), .c(new_n86_), .O(new_n148_));
  ...
  nand4  g070(.a(new_n153_), .b(new_n151_), .c(new_n98_), .d(x09), .O(new_n154_));
  ...
  nand4  g075(.a(new_n158_), .b(new_n157_), .c(new_n98_), .d(x09), .O(new_n159_));
  ...
  nand4  g080(.a(new_n163_), .b(new_n162_), .c(new_n98_), .d(x09), .O(new_n164_));
  ...
  nand4  g085(.a(new_n168_), .b(new_n167_), .c(new_n98_), .d(x09), .O(new_n169_));
