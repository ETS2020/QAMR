...
module FAU ( 
  ...
  nand3  g098(.a(new_n181_), .b(new_n100_), .c(x09), .O(new_n182_));
  ...
  nand3  g104(.a(new_n187_), .b(new_n100_), .c(x09), .O(new_n188_));
  ...
  aoi21  g112(.a(new_n178_), .b(x43), .c(x08), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z32));
  nand2  g114(.a(new_n176_), .b(x45), .O(new_n198_));
  aoi21  g115(.a(new_n178_), .b(x44), .c(x08), .O(new_n199_));
  ...
  nand2  g120(.a(new_n178_), .b(new_n203_), .O(new_n204_));
  ...
  aoi21  g124(.a(new_n178_), .b(x46), .c(x08), .O(new_n208_));
