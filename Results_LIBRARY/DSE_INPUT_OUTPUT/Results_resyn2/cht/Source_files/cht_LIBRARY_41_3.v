...
module FAU ( 
  ...
  aoi21  g000(.a(x43), .b(x41), .c(x10), .O(new_n84_));
  ...
  nand2  g008(.a(x43), .b(x41), .O(new_n92_));
  ...
  nand3  g041(.a(new_n124_), .b(new_n123_), .c(new_n94_), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(new_n92_), .O(z07));
  nand2  g043(.a(new_n122_), .b(new_n117_), .O(new_n127_));
  ...
  nand2  g070(.a(new_n147_), .b(new_n117_), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n153_), .c(new_n94_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(new_n92_), .O(z13));
  nand2  g073(.a(new_n152_), .b(new_n117_), .O(new_n157_));
  ...
  nand2  g080(.a(new_n158_), .b(new_n117_), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(new_n94_), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n92_), .O(z15));
  nand2  g083(.a(new_n162_), .b(new_n117_), .O(new_n167_));
  ...
  nand2  g090(.a(new_n168_), .b(new_n117_), .O(new_n174_));
  ...
  nand2  g135(.a(new_n214_), .b(new_n187_), .O(new_n219_));
  ...
  nand3  g156(.a(new_n239_), .b(new_n238_), .c(new_n94_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(new_n92_), .O(z29));
  ...
  nand3  g166(.a(new_n249_), .b(new_n248_), .c(new_n94_), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(new_n92_), .O(z31));
  ...
  nand2  g177(.a(new_n260_), .b(new_n92_), .O(z33));
