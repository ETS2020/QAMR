...
module FAU ( 
  ...
  nand3  g037(.a(new_n120_), .b(new_n119_), .c(new_n97_), .O(new_n121_));
  ...
  aoi21  g061(.a(x25), .b(new_n113_), .c(new_n86_), .O(new_n145_));
  ...
  nand2  g066(.a(new_n149_), .b(new_n113_), .O(new_n150_));
  ...
  nand2  g080(.a(new_n163_), .b(new_n113_), .O(new_n164_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n171_), .c(new_n97_), .O(new_n175_));
  ...
  nand3  g100(.a(new_n183_), .b(new_n181_), .c(new_n97_), .O(new_n184_));
  ...
  aoi21  g117(.a(x37), .b(new_n172_), .c(new_n86_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z26));
  inv1   g119(.a(x39), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n98_), .O(new_n204_));
  oai21  g121(.a(new_n98_), .b(x00), .c(new_n204_), .O(new_n205_));
  inv1   g122(.a(x38), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n172_), .O(new_n207_));
  ...
  nor2   g131(.a(new_n86_), .b(x40), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n212_), .c(x10), .O(z29));
  inv1   g133(.a(x42), .O(new_n217_));
  inv1   g134(.a(new_n97_), .O(new_n218_));
  aoi21  g135(.a(new_n210_), .b(new_n217_), .c(new_n218_), .O(z30));
  inv1   g136(.a(x43), .O(new_n220_));
  nand3  g137(.a(new_n220_), .b(new_n98_), .c(x09), .O(new_n221_));
  nand2  g138(.a(new_n212_), .b(new_n217_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(new_n97_), .O(new_n223_));
  inv1   g140(.a(new_n223_), .O(z31));
  nand2  g141(.a(new_n210_), .b(x44), .O(new_n225_));
  aoi21  g142(.a(new_n212_), .b(x43), .c(new_n86_), .O(new_n226_));
  ...
  nand2  g147(.a(new_n212_), .b(new_n230_), .O(new_n231_));
  ...
  aoi21  g151(.a(new_n212_), .b(x45), .c(new_n86_), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n234_), .c(x10), .O(z34));
  nand2  g153(.a(new_n210_), .b(x00), .O(new_n237_));
  aoi21  g154(.a(new_n212_), .b(x46), .c(new_n86_), .O(new_n238_));
