...
module FAU ( 
  ...
  oai21  g071(.a(new_n154_), .b(new_n153_), .c(new_n84_), .O(z22));
  ...
  oai21  g089(.a(x38), .b(x09), .c(new_n87_), .O(new_n173_));
  ...
  nand2  g095(.a(new_n178_), .b(new_n84_), .O(z28));
  ...
  nand2  g105(.a(new_n188_), .b(new_n84_), .O(z30));
  ...
  nand2  g110(.a(new_n193_), .b(new_n84_), .O(z31));
  ...
  nand2  g120(.a(new_n203_), .b(new_n84_), .O(z33));
  ...
  nand2  g125(.a(new_n208_), .b(new_n84_), .O(z34));
  ...
  nand2  g129(.a(new_n212_), .b(new_n84_), .O(z35));
endmodule
