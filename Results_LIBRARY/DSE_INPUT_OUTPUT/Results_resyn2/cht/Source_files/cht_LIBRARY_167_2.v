...
module FAU ( 
  ...
  nand2  g057(.a(new_n140_), .b(new_n85_), .O(z15));
  ...
  nor2   g068(.a(x30), .b(new_n109_), .O(new_n152_));
  ...
  aoi21  g100(.a(new_n177_), .b(new_n158_), .c(x10), .O(new_n184_));
  ...
  nand2  g119(.a(new_n202_), .b(new_n85_), .O(z30));
  ...
  nand2  g124(.a(new_n207_), .b(new_n85_), .O(z31));
