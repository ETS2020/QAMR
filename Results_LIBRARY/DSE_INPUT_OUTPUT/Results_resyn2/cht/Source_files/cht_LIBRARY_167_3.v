...
module FAU ( 
  ...
  nand2  g031(.a(new_n87_), .b(new_n108_), .O(new_n115_));
  nand2  g032(.a(new_n115_), .b(x21), .O(new_n116_));
  oai21  g033(.a(new_n115_), .b(new_n112_), .c(new_n116_), .O(z09));
  inv1   g034(.a(x22), .O(new_n118_));
  nand2  g035(.a(new_n87_), .b(x08), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(x21), .O(new_n120_));
  oai21  g037(.a(new_n119_), .b(new_n118_), .c(new_n120_), .O(z10));
  nor2   g038(.a(x23), .b(new_n108_), .O(new_n122_));
  oai21  g039(.a(x22), .b(x08), .c(new_n87_), .O(new_n123_));
  oai21  g040(.a(new_n123_), .b(new_n122_), .c(new_n84_), .O(z11));
  inv1   g041(.a(x24), .O(new_n125_));
  oai21  g042(.a(x23), .b(x08), .c(new_n87_), .O(new_n126_));
  aoi21  g043(.a(new_n125_), .b(x08), .c(new_n126_), .O(z12));
  nor2   g044(.a(x25), .b(new_n108_), .O(new_n128_));
  oai21  g045(.a(x24), .b(x08), .c(new_n87_), .O(new_n129_));
  oai21  g046(.a(new_n129_), .b(new_n128_), .c(new_n84_), .O(z13));
  ...
  nand2  g052(.a(new_n131_), .b(new_n108_), .O(new_n136_));
  ...
  nor2   g065(.a(x30), .b(new_n108_), .O(new_n149_));
