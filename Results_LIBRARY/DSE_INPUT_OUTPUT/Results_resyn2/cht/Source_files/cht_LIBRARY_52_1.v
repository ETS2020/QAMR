...
module FAU ( 
  ...
  aoi21  g021(.a(x15), .b(new_n85_), .c(x34), .O(new_n105_));
  ...
  aoi21  g049(.a(x22), .b(new_n114_), .c(x34), .O(new_n133_));
  ...
  aoi21  g077(.a(x28), .b(new_n114_), .c(x34), .O(new_n161_));
  ...
  nand2  g111(.a(new_n194_), .b(new_n173_), .O(new_n195_));
  ...
  oai21  g117(.a(x38), .b(x09), .c(new_n93_), .O(new_n201_));
  ...
  nand3  g123(.a(new_n206_), .b(new_n204_), .c(new_n93_), .O(new_n207_));
  inv1   g124(.a(new_n207_), .O(z28));
  nor2   g125(.a(x14), .b(new_n173_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(x41), .O(new_n210_));
  aoi21  g127(.a(new_n205_), .b(x40), .c(x34), .O(new_n211_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n214_), .c(new_n93_), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(z30));
  inv1   g135(.a(x43), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n100_), .c(x09), .O(new_n220_));
  nand2  g137(.a(new_n205_), .b(new_n213_), .O(new_n221_));
  nand3  g138(.a(new_n221_), .b(new_n220_), .c(new_n93_), .O(new_n222_));
  inv1   g139(.a(new_n222_), .O(z31));
  inv1   g140(.a(x44), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n100_), .c(x09), .O(new_n225_));
  nand2  g142(.a(new_n205_), .b(new_n219_), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n225_), .c(new_n93_), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(z32));
  nand2  g145(.a(new_n209_), .b(x45), .O(new_n229_));
  aoi21  g146(.a(new_n205_), .b(x44), .c(x34), .O(new_n230_));
  ...
  nand2  g151(.a(new_n205_), .b(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n235_), .b(new_n233_), .c(new_n93_), .O(new_n236_));
  inv1   g153(.a(new_n236_), .O(z34));
  inv1   g154(.a(x00), .O(new_n238_));
  nand3  g155(.a(new_n100_), .b(x09), .c(new_n238_), .O(new_n239_));
  nand2  g156(.a(new_n205_), .b(new_n232_), .O(new_n240_));
  nand3  g157(.a(new_n240_), .b(new_n239_), .c(new_n93_), .O(new_n241_));
