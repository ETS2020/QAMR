...
module FAU ( 
  ...
  nor2   g050(.a(x28), .b(new_n109_), .O(new_n134_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n84_), .O(z22));
  nor2   g079(.a(x35), .b(new_n148_), .O(new_n163_));
  oai21  g080(.a(x34), .b(x09), .c(new_n87_), .O(new_n164_));
  oai21  g081(.a(new_n164_), .b(new_n163_), .c(new_n84_), .O(z23));
  inv1   g082(.a(x36), .O(new_n166_));
  oai21  g083(.a(x35), .b(x09), .c(new_n87_), .O(new_n167_));
  ...
  nor2   g088(.a(x38), .b(new_n148_), .O(new_n172_));
  ...
  nand2  g094(.a(x14), .b(new_n143_), .O(new_n178_));
  ...
  oai21  g100(.a(x14), .b(new_n148_), .c(new_n176_), .O(new_n184_));
  ...
  oai21  g130(.a(x14), .b(new_n148_), .c(new_n207_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n87_), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z34));
  nand3  g133(.a(new_n175_), .b(x09), .c(new_n143_), .O(new_n217_));
  oai21  g134(.a(x14), .b(new_n148_), .c(new_n212_), .O(new_n218_));
