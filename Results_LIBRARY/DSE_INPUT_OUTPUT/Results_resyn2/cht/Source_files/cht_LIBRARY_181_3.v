...
module FAU ( 
  ...
  oai21  g041(.a(new_n113_), .b(new_n121_), .c(new_n124_), .O(z12));
  ...
  oai21  g047(.a(new_n113_), .b(new_n129_), .c(new_n130_), .O(z14));
  ...
  nor2   g057(.a(x30), .b(new_n105_), .O(new_n141_));
  ...
  oai21  g066(.a(new_n149_), .b(new_n148_), .c(new_n84_), .O(z20));
  ...
  oai21  g072(.a(new_n155_), .b(new_n154_), .c(new_n84_), .O(z22));
  ...
  aoi21  g093(.a(new_n168_), .b(new_n147_), .c(x10), .O(new_n177_));
  ...
  nand3  g133(.a(new_n174_), .b(x09), .c(new_n144_), .O(new_n217_));
