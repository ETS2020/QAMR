...
module FAU ( 
  ...
  nand2  g046(.a(new_n91_), .b(x26), .O(new_n130_));
  ...
  nand2  g096(.a(new_n172_), .b(x09), .O(new_n180_));
  ...
  nor2   g100(.a(x14), .b(new_n144_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(x41), .O(new_n185_));
  aoi21  g102(.a(new_n180_), .b(x40), .c(new_n86_), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z29));
  inv1   g104(.a(x42), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n172_), .c(x09), .O(new_n189_));
  inv1   g106(.a(x41), .O(new_n190_));
  nand2  g107(.a(new_n180_), .b(new_n190_), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n189_), .c(new_n91_), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z30));
  inv1   g110(.a(x43), .O(new_n194_));
  nand3  g111(.a(new_n194_), .b(new_n172_), .c(x09), .O(new_n195_));
  nand2  g112(.a(new_n180_), .b(new_n188_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n195_), .c(new_n91_), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z31));
  nand2  g115(.a(new_n184_), .b(x44), .O(new_n199_));
  aoi21  g116(.a(new_n180_), .b(x43), .c(new_n86_), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z32));
  inv1   g118(.a(x45), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n172_), .c(x09), .O(new_n203_));
  inv1   g120(.a(x44), .O(new_n204_));
  nand2  g121(.a(new_n180_), .b(new_n204_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n203_), .c(new_n91_), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z33));
  nand2  g124(.a(new_n184_), .b(x46), .O(new_n208_));
  aoi21  g125(.a(new_n180_), .b(x45), .c(new_n86_), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z34));
  nand2  g127(.a(new_n184_), .b(x00), .O(new_n211_));
  aoi21  g128(.a(new_n180_), .b(x46), .c(new_n86_), .O(new_n212_));
