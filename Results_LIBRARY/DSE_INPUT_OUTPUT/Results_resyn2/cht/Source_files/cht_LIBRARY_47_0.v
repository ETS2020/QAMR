...
module FAU ( 
  ...
  nand3  g060(.a(new_n143_), .b(new_n140_), .c(new_n91_), .O(new_n144_));
  ...
  nor2   g094(.a(x14), .b(new_n141_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(x41), .O(new_n179_));
  aoi21  g096(.a(new_n174_), .b(x40), .c(new_n86_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z29));
  inv1   g098(.a(x42), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n164_), .c(x09), .O(new_n183_));
  inv1   g100(.a(x41), .O(new_n184_));
  nand2  g101(.a(new_n174_), .b(new_n184_), .O(new_n185_));
  ...
  aoi21  g105(.a(new_n174_), .b(x42), .c(new_n86_), .O(new_n189_));
  ...
  nand2  g110(.a(new_n174_), .b(new_n193_), .O(new_n194_));
  nand3  g111(.a(new_n194_), .b(new_n192_), .c(new_n91_), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z32));
  nand2  g113(.a(new_n178_), .b(x45), .O(new_n197_));
  aoi21  g114(.a(new_n174_), .b(x44), .c(new_n86_), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z33));
  nand2  g116(.a(new_n178_), .b(x46), .O(new_n200_));
  aoi21  g117(.a(new_n174_), .b(x45), .c(new_n86_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z34));
  nand3  g119(.a(new_n164_), .b(x09), .c(new_n137_), .O(new_n203_));
