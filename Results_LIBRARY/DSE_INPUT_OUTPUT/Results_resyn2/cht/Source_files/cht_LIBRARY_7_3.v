...
module FAU ( 
  ...
  nand2  g008(.a(x41), .b(x10), .O(new_n92_));
  ...
  nor2   g074(.a(new_n157_), .b(new_n156_), .O(z20));
  ...
  nand2  g082(.a(new_n165_), .b(new_n92_), .O(z22));
  ...
  nand2  g087(.a(new_n170_), .b(new_n92_), .O(z23));
  nor2   g088(.a(x36), .b(new_n155_), .O(new_n172_));
  oai21  g089(.a(x35), .b(x09), .c(new_n86_), .O(new_n173_));
  oai21  g090(.a(new_n173_), .b(new_n172_), .c(new_n92_), .O(z24));
  ...
  nand2  g096(.a(new_n175_), .b(new_n155_), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n86_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n92_), .O(z26));
  ...
  aoi21  g103(.a(new_n178_), .b(new_n155_), .c(x10), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n92_), .O(z27));
  ...
  nand2  g112(.a(new_n195_), .b(new_n92_), .O(z28));
  ...
  nand3  g119(.a(new_n184_), .b(new_n86_), .c(x09), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(x41), .O(new_n204_));
  oai21  g121(.a(new_n203_), .b(new_n202_), .c(new_n204_), .O(z30));
  inv1   g122(.a(x43), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n184_), .c(x09), .O(new_n207_));
  nand2  g124(.a(new_n193_), .b(new_n202_), .O(new_n208_));
  ...
  nand2  g139(.a(new_n193_), .b(new_n216_), .O(new_n223_));
  ...
  nand2  g143(.a(new_n193_), .b(new_n221_), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n226_), .c(new_n86_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n92_), .O(z35));
endmodule
