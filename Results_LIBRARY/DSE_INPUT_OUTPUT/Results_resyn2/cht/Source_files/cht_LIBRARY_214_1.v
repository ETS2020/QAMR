...
module FAU ( 
  ...
  nor2   g091(.a(x38), .b(new_n151_), .O(new_n175_));
  ...
  nand2  g097(.a(x14), .b(new_n146_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g099(.a(x38), .b(x09), .c(new_n88_), .O(new_n183_));
  ...
  oai21  g103(.a(x14), .b(new_n151_), .c(new_n179_), .O(new_n187_));
  ...
  oai21  g108(.a(x14), .b(new_n151_), .c(new_n185_), .O(new_n192_));
  ...
  oai21  g113(.a(x14), .b(new_n151_), .c(new_n190_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(new_n88_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n85_), .O(z30));
  inv1   g116(.a(x43), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n178_), .c(x09), .O(new_n201_));
  oai21  g118(.a(x14), .b(new_n151_), .c(new_n195_), .O(new_n202_));
  ...
  oai21  g123(.a(x14), .b(new_n151_), .c(new_n200_), .O(new_n207_));
  ...
  oai21  g128(.a(x14), .b(new_n151_), .c(new_n205_), .O(new_n212_));
  ...
  oai21  g133(.a(x14), .b(new_n151_), .c(new_n210_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n216_), .c(new_n88_), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(z34));
  nand3  g136(.a(new_n178_), .b(x09), .c(new_n146_), .O(new_n220_));
  oai21  g137(.a(x14), .b(new_n151_), .c(new_n215_), .O(new_n221_));
