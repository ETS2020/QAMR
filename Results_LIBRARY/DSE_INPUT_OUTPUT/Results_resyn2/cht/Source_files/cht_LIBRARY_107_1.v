...
module FAU ( 
  ...
  nor2   g063(.a(x28), .b(new_n106_), .O(new_n147_));
  ...
  nand2  g098(.a(x14), .b(new_n156_), .O(new_n182_));
  ...
  oai21  g104(.a(x40), .b(x14), .c(new_n86_), .O(new_n188_));
  nand2  g105(.a(new_n183_), .b(x09), .O(new_n189_));
  nor2   g106(.a(x39), .b(x10), .O(new_n190_));
  aoi22  g107(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(x09), .O(z28));
  inv1   g108(.a(x41), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n183_), .c(x09), .O(new_n193_));
  ...
  oai21  g114(.a(x42), .b(x14), .c(new_n86_), .O(new_n198_));
  nor2   g115(.a(x41), .b(x10), .O(new_n199_));
  aoi22  g116(.a(new_n199_), .b(new_n189_), .c(new_n198_), .d(x09), .O(z30));
  oai21  g117(.a(x43), .b(x14), .c(new_n86_), .O(new_n201_));
  nor2   g118(.a(x42), .b(x10), .O(new_n202_));
  aoi22  g119(.a(new_n202_), .b(new_n189_), .c(new_n201_), .d(x09), .O(z31));
  inv1   g120(.a(x44), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n183_), .c(x09), .O(new_n205_));
  inv1   g122(.a(x43), .O(new_n206_));
  oai21  g123(.a(x14), .b(new_n89_), .c(new_n206_), .O(new_n207_));
  ...
  oai21  g128(.a(x14), .b(new_n89_), .c(new_n204_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n211_), .c(new_n86_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z33));
  oai21  g131(.a(x46), .b(x14), .c(new_n86_), .O(new_n215_));
  nor2   g132(.a(x45), .b(x10), .O(new_n216_));
  aoi22  g133(.a(new_n216_), .b(new_n189_), .c(new_n215_), .d(x09), .O(z34));
  nand3  g134(.a(new_n183_), .b(x09), .c(new_n156_), .O(new_n218_));
