...
module FAU ( 
  ...
  nand2  g049(.a(new_n90_), .b(x28), .O(new_n133_));
  ...
  nand3  g075(.a(new_n158_), .b(new_n156_), .c(new_n90_), .O(new_n159_));
  inv1   g076(.a(new_n159_), .O(z24));
  nand2  g077(.a(x37), .b(x09), .O(new_n161_));
  aoi21  g078(.a(x36), .b(new_n140_), .c(x08), .O(new_n162_));
  ...
  oai21  g085(.a(new_n100_), .b(x00), .c(new_n168_), .O(new_n169_));
  oai21  g086(.a(x38), .b(x09), .c(new_n90_), .O(new_n170_));
  aoi21  g087(.a(new_n169_), .b(x09), .c(new_n170_), .O(z27));
  inv1   g088(.a(x40), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n100_), .c(x09), .O(new_n173_));
  nand2  g090(.a(new_n100_), .b(x09), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n167_), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n173_), .c(new_n90_), .O(new_n176_));
  inv1   g093(.a(new_n176_), .O(z28));
  nor2   g094(.a(x14), .b(new_n140_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(x41), .O(new_n179_));
  aoi21  g096(.a(new_n174_), .b(x40), .c(x08), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z29));
  nand2  g098(.a(new_n178_), .b(x42), .O(new_n182_));
  aoi21  g099(.a(new_n174_), .b(x41), .c(x08), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z30));
  nand2  g101(.a(new_n178_), .b(x43), .O(new_n185_));
  aoi21  g102(.a(new_n174_), .b(x42), .c(x08), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z31));
  inv1   g104(.a(x44), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n100_), .c(x09), .O(new_n189_));
  inv1   g106(.a(x43), .O(new_n190_));
  nand2  g107(.a(new_n174_), .b(new_n190_), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n189_), .c(new_n90_), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z32));
  inv1   g110(.a(x45), .O(new_n194_));
  nand3  g111(.a(new_n194_), .b(new_n100_), .c(x09), .O(new_n195_));
  nand2  g112(.a(new_n174_), .b(new_n188_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n195_), .c(new_n90_), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z33));
  nand2  g115(.a(new_n178_), .b(x46), .O(new_n199_));
  aoi21  g116(.a(new_n174_), .b(x45), .c(x08), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z34));
  inv1   g118(.a(x00), .O(new_n202_));
  nand3  g119(.a(new_n100_), .b(x09), .c(new_n202_), .O(new_n203_));
  inv1   g120(.a(x46), .O(new_n204_));
  nand2  g121(.a(new_n174_), .b(new_n204_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n203_), .c(new_n90_), .O(new_n206_));
