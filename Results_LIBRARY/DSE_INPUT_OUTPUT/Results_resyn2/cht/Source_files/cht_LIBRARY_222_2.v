...
module FAU ( 
  ...
  oai21  g034(.a(new_n117_), .b(new_n116_), .c(new_n96_), .O(z09));
  ...
  aoi21  g045(.a(new_n95_), .b(x08), .c(new_n128_), .O(z13));
  ...
  nand2  g056(.a(new_n139_), .b(new_n96_), .O(z16));
  ...
  nand2  g061(.a(new_n144_), .b(new_n96_), .O(z17));
  nor2   g062(.a(x30), .b(new_n106_), .O(new_n146_));
  oai21  g063(.a(x29), .b(x08), .c(new_n86_), .O(new_n147_));
  oai21  g064(.a(new_n147_), .b(new_n146_), .c(new_n96_), .O(z18));
  ...
  aoi21  g098(.a(new_n173_), .b(new_n152_), .c(x10), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n96_), .O(z27));
  ...
  nand2  g107(.a(new_n190_), .b(new_n96_), .O(z28));
  ...
  nand2  g112(.a(new_n195_), .b(new_n96_), .O(z29));
  ...
  nand2  g122(.a(new_n205_), .b(new_n96_), .O(z31));
  ...
  nand2  g137(.a(new_n220_), .b(new_n96_), .O(z34));
  nand3  g138(.a(new_n179_), .b(x09), .c(new_n149_), .O(new_n222_));
