...
module FAU ( 
  ...
  nand2  g008(.a(x10), .b(x08), .O(new_n92_));
  ...
  nor2   g032(.a(x21), .b(new_n107_), .O(new_n116_));
  ...
  oai21  g039(.a(new_n108_), .b(new_n119_), .c(new_n122_), .O(z11));
  ...
  aoi21  g048(.a(new_n130_), .b(x08), .c(new_n131_), .O(z14));
  oai21  g049(.a(x27), .b(x10), .c(x08), .O(new_n133_));
  oai21  g050(.a(new_n108_), .b(new_n130_), .c(new_n133_), .O(z15));
  inv1   g051(.a(x27), .O(new_n135_));
  oai21  g052(.a(x28), .b(x10), .c(x08), .O(new_n136_));
  oai21  g053(.a(new_n108_), .b(new_n135_), .c(new_n136_), .O(z16));
  nor2   g054(.a(x29), .b(new_n107_), .O(new_n138_));
  ...
  nand2  g077(.a(new_n156_), .b(new_n146_), .O(new_n161_));
  nand3  g078(.a(new_n161_), .b(new_n160_), .c(new_n86_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(new_n92_), .O(z24));
  nor2   g080(.a(x37), .b(new_n146_), .O(new_n164_));
  oai21  g081(.a(x36), .b(x09), .c(new_n86_), .O(new_n165_));
  oai21  g082(.a(new_n165_), .b(new_n164_), .c(new_n92_), .O(z25));
  nor2   g083(.a(x38), .b(new_n146_), .O(new_n167_));
  ...
  nand2  g090(.a(x14), .b(new_n173_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  oai21  g092(.a(x38), .b(x09), .c(new_n86_), .O(new_n176_));
  aoi21  g093(.a(new_n175_), .b(x09), .c(new_n176_), .O(z27));
  inv1   g094(.a(x40), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n170_), .c(x09), .O(new_n179_));
  oai21  g096(.a(x14), .b(new_n146_), .c(new_n171_), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n179_), .c(new_n86_), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z28));
  inv1   g099(.a(x41), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n170_), .c(x09), .O(new_n184_));
  oai21  g101(.a(x14), .b(new_n146_), .c(new_n178_), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n184_), .c(new_n86_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n92_), .O(z29));
  inv1   g104(.a(x42), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n170_), .c(x09), .O(new_n189_));
  oai21  g106(.a(x14), .b(new_n146_), .c(new_n183_), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n189_), .c(new_n86_), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n92_), .O(z30));
  inv1   g109(.a(x43), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n170_), .c(x09), .O(new_n194_));
  ...
  nand3  g115(.a(new_n198_), .b(new_n170_), .c(x09), .O(new_n199_));
  ...
  nand3  g120(.a(new_n203_), .b(new_n170_), .c(x09), .O(new_n204_));
  oai21  g121(.a(x14), .b(new_n146_), .c(new_n198_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(new_n86_), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n92_), .O(z33));
  inv1   g124(.a(x46), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n170_), .c(x09), .O(new_n209_));
  oai21  g126(.a(x14), .b(new_n146_), .c(new_n203_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n86_), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(z34));
  nand3  g129(.a(new_n170_), .b(x09), .c(new_n173_), .O(new_n213_));
  oai21  g130(.a(x14), .b(new_n146_), .c(new_n208_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(new_n86_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n92_), .O(z35));
endmodule
