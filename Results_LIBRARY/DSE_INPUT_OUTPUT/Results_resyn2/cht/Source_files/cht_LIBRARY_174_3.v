...
module FAU ( 
  ...
  oai21  g059(.a(new_n108_), .b(new_n139_), .c(new_n142_), .O(z19));
  ...
  oai21  g068(.a(x33), .b(x09), .c(new_n86_), .O(new_n152_));
  aoi21  g069(.a(new_n151_), .b(x09), .c(new_n152_), .O(z22));
  nor2   g070(.a(x35), .b(new_n144_), .O(new_n154_));
  oai21  g071(.a(x34), .b(x09), .c(new_n86_), .O(new_n155_));
  oai21  g072(.a(new_n155_), .b(new_n154_), .c(new_n89_), .O(z23));
  inv1   g073(.a(x36), .O(new_n157_));
  oai21  g074(.a(x35), .b(x09), .c(new_n86_), .O(new_n158_));
  aoi21  g075(.a(new_n157_), .b(x09), .c(new_n158_), .O(z24));
  inv1   g076(.a(x37), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x09), .O(new_n161_));
  nand2  g078(.a(new_n157_), .b(new_n144_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n86_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n89_), .O(z25));
  inv1   g081(.a(x38), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(x09), .O(new_n166_));
  nand2  g083(.a(new_n160_), .b(new_n144_), .O(new_n167_));
