...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n89_, new_n91_,
    ...
    new_n271_, new_n272_;
  inv1   g000(.a(x23), .O(new_n84_));
  nand2  g001(.a(x28), .b(new_n84_), .O(new_n85_));
  ...
  aoi21  g007(.a(x28), .b(new_n84_), .c(x10), .O(new_n91_));
  ...
  nand2  g062(.a(new_n84_), .b(x08), .O(new_n146_));
  nand2  g063(.a(new_n142_), .b(new_n121_), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(new_n88_), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(new_n85_), .O(z11));
  inv1   g066(.a(x24), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(x08), .O(new_n151_));
  nand2  g068(.a(new_n84_), .b(new_n121_), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(new_n151_), .c(new_n88_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n85_), .O(z12));
  ...
  nand2  g075(.a(new_n158_), .b(new_n85_), .O(z13));
  ...
  nand2  g080(.a(new_n163_), .b(new_n85_), .O(z14));
  ...
  nand2  g101(.a(new_n181_), .b(new_n121_), .O(new_n185_));
  inv1   g102(.a(x00), .O(new_n186_));
  nand2  g103(.a(x08), .b(new_n186_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n185_), .c(new_n91_), .O(new_n188_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n85_), .O(z21));
  ...
  nand2  g122(.a(new_n205_), .b(new_n85_), .O(z22));
  ...
  nand3  g131(.a(new_n214_), .b(new_n212_), .c(new_n91_), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z24));
  nand2  g133(.a(new_n213_), .b(new_n190_), .O(new_n217_));
  ...
  nand3  g141(.a(new_n224_), .b(new_n222_), .c(new_n91_), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(z26));
  nand2  g143(.a(x14), .b(x00), .O(new_n227_));
  nand2  g144(.a(x39), .b(new_n101_), .O(new_n228_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n85_), .O(z27));
  inv1   g149(.a(x40), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n101_), .c(x09), .O(new_n234_));
  inv1   g151(.a(x39), .O(new_n235_));
  nand2  g152(.a(new_n101_), .b(x09), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n234_), .c(new_n91_), .O(new_n238_));
  inv1   g155(.a(new_n238_), .O(z28));
  ...
  nand3  g159(.a(new_n242_), .b(new_n241_), .c(new_n91_), .O(new_n243_));
  ...
  nand3  g174(.a(new_n257_), .b(new_n256_), .c(new_n91_), .O(new_n258_));
  ...
  nand3  g182(.a(new_n265_), .b(new_n101_), .c(x09), .O(new_n266_));
  nand2  g183(.a(new_n236_), .b(new_n260_), .O(new_n267_));
  nand3  g184(.a(new_n267_), .b(new_n266_), .c(new_n88_), .O(new_n268_));
  nand2  g185(.a(new_n268_), .b(new_n85_), .O(z34));
  nand3  g186(.a(new_n101_), .b(x09), .c(new_n186_), .O(new_n270_));
  nand2  g187(.a(new_n236_), .b(new_n265_), .O(new_n271_));
  nand3  g188(.a(new_n271_), .b(new_n270_), .c(new_n88_), .O(new_n272_));
  nand2  g189(.a(new_n272_), .b(new_n85_), .O(z35));
endmodule
