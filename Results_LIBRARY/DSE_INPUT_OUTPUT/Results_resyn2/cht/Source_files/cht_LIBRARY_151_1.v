...
module FAU ( 
  ...
  aoi21  g001(.a(x39), .b(new_n84_), .c(x10), .O(new_n85_));
  ...
  nand2  g027(.a(x39), .b(new_n84_), .O(new_n111_));
  ...
  nand3  g039(.a(new_n122_), .b(new_n120_), .c(new_n113_), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n111_), .O(z06));
  nand2  g041(.a(new_n119_), .b(new_n121_), .O(new_n125_));
  ...
  nand2  g048(.a(new_n126_), .b(new_n121_), .O(new_n132_));
  nand3  g049(.a(new_n132_), .b(new_n131_), .c(new_n113_), .O(new_n133_));
  nand2  g050(.a(new_n133_), .b(new_n111_), .O(z08));
  ...
  nand2  g066(.a(new_n146_), .b(new_n121_), .O(new_n150_));
  ...
  nand2  g073(.a(new_n151_), .b(new_n121_), .O(new_n157_));
  nand3  g074(.a(new_n157_), .b(new_n156_), .c(new_n113_), .O(new_n158_));
  nand2  g075(.a(new_n158_), .b(new_n111_), .O(z13));
  inv1   g076(.a(x26), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x08), .O(new_n161_));
  nand2  g078(.a(new_n155_), .b(new_n121_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n161_), .c(new_n113_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n111_), .O(z14));
  nand2  g081(.a(new_n160_), .b(new_n121_), .O(new_n165_));
  ...
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(new_n113_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n111_), .O(z16));
  inv1   g091(.a(x29), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(x08), .O(new_n176_));
  nand2  g093(.a(new_n170_), .b(new_n121_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n176_), .c(new_n113_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n111_), .O(z17));
  inv1   g096(.a(x30), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(x08), .O(new_n181_));
  nand2  g098(.a(new_n175_), .b(new_n121_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n181_), .c(new_n113_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n111_), .O(z18));
  nand2  g101(.a(new_n180_), .b(new_n121_), .O(new_n185_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n191_), .c(new_n113_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n111_), .O(z20));
  ...
  nand2  g144(.a(new_n227_), .b(new_n105_), .O(new_n228_));
  ...
  nand3  g185(.a(new_n105_), .b(x09), .c(new_n186_), .O(new_n269_));
