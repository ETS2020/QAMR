...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n85_), .O(z09));
  nor2   g037(.a(x22), .b(new_n106_), .O(new_n121_));
  oai21  g038(.a(x21), .b(x08), .c(new_n88_), .O(new_n122_));
  oai21  g039(.a(new_n122_), .b(new_n121_), .c(new_n85_), .O(z10));
  ...
  oai21  g062(.a(new_n145_), .b(new_n144_), .c(new_n85_), .O(z17));
  ...
  oai21  g071(.a(x31), .b(x09), .c(new_n88_), .O(new_n155_));
  nor2   g072(.a(new_n155_), .b(new_n154_), .O(z20));
  inv1   g073(.a(x33), .O(new_n157_));
  oai21  g074(.a(x32), .b(x09), .c(new_n88_), .O(new_n158_));
  aoi21  g075(.a(new_n157_), .b(x09), .c(new_n158_), .O(z21));
  nor2   g076(.a(x34), .b(new_n153_), .O(new_n160_));
  oai21  g077(.a(x33), .b(x09), .c(new_n88_), .O(new_n161_));
  oai21  g078(.a(new_n161_), .b(new_n160_), .c(new_n85_), .O(z22));
  nor2   g079(.a(x35), .b(new_n153_), .O(new_n163_));
  oai21  g080(.a(x34), .b(x09), .c(new_n88_), .O(new_n164_));
  nor2   g081(.a(new_n164_), .b(new_n163_), .O(z23));
  oai21  g082(.a(x35), .b(x09), .c(new_n88_), .O(new_n166_));
  aoi21  g083(.a(new_n84_), .b(x09), .c(new_n166_), .O(z24));
  nor2   g084(.a(x37), .b(new_n153_), .O(new_n168_));
  oai21  g085(.a(x36), .b(x09), .c(new_n88_), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n85_), .O(z25));
  ...
  aoi21  g094(.a(new_n171_), .b(new_n153_), .c(x10), .O(new_n178_));
  ...
  nand3  g134(.a(new_n175_), .b(x09), .c(new_n150_), .O(new_n218_));
