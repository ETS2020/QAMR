...
module FAU ( 
  ...
  inv1   g017(.a(x08), .O(new_n101_));
  nand2  g018(.a(x10), .b(new_n101_), .O(new_n102_));
  nor2   g019(.a(new_n84_), .b(x03), .O(new_n103_));
  oai21  g020(.a(x16), .b(x07), .c(new_n86_), .O(new_n104_));
  oai21  g021(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(z05));
  nor2   g022(.a(x18), .b(new_n101_), .O(new_n106_));
  ...
  nor2   g053(.a(x28), .b(new_n101_), .O(new_n137_));
  ...
  nor2   g059(.a(x30), .b(new_n101_), .O(new_n143_));
  ...
  nand2  g076(.a(new_n159_), .b(new_n102_), .O(z22));
  ...
  nand2  g081(.a(new_n164_), .b(new_n102_), .O(z23));
  ...
  nand2  g086(.a(new_n169_), .b(new_n102_), .O(z24));
  inv1   g087(.a(x37), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(x09), .O(new_n172_));
  nand2  g089(.a(new_n166_), .b(new_n149_), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n172_), .c(new_n86_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n102_), .O(z25));
  nor2   g092(.a(x38), .b(new_n149_), .O(new_n176_));
  oai21  g093(.a(x37), .b(x09), .c(new_n86_), .O(new_n177_));
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(new_n102_), .O(z26));
  inv1   g095(.a(x14), .O(new_n179_));
  inv1   g096(.a(x39), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g098(.a(x14), .b(new_n146_), .O(new_n182_));
  ...
  oai21  g104(.a(x14), .b(new_n149_), .c(new_n180_), .O(new_n188_));
  ...
  oai21  g109(.a(x14), .b(new_n149_), .c(new_n186_), .O(new_n193_));
  ...
  oai21  g114(.a(x14), .b(new_n149_), .c(new_n191_), .O(new_n198_));
  ...
  oai21  g134(.a(x14), .b(new_n149_), .c(new_n211_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n86_), .O(new_n219_));
  inv1   g136(.a(new_n219_), .O(z34));
  nand3  g137(.a(new_n179_), .b(x09), .c(new_n146_), .O(new_n221_));
  oai21  g138(.a(x14), .b(new_n149_), .c(new_n216_), .O(new_n222_));
