...
module FAU ( 
  ...
  nor2   g056(.a(x29), .b(new_n89_), .O(new_n140_));
  oai21  g057(.a(x28), .b(x08), .c(new_n86_), .O(new_n141_));
  nor2   g058(.a(new_n141_), .b(new_n140_), .O(z17));
  inv1   g059(.a(x30), .O(new_n143_));
  nor2   g060(.a(x29), .b(x10), .O(new_n144_));
  oai22  g061(.a(new_n144_), .b(x08), .c(new_n108_), .d(new_n143_), .O(z18));
  ...
  oai21  g068(.a(new_n151_), .b(new_n150_), .c(new_n90_), .O(z20));
  ...
  nor2   g078(.a(x36), .b(new_n149_), .O(new_n162_));
  ...
  oai21  g082(.a(x36), .b(x09), .c(new_n86_), .O(new_n166_));
  nor2   g083(.a(new_n166_), .b(new_n165_), .O(z25));
  inv1   g084(.a(x38), .O(new_n168_));
  oai21  g085(.a(x37), .b(x09), .c(new_n86_), .O(new_n169_));
  aoi21  g086(.a(new_n168_), .b(x09), .c(new_n169_), .O(z26));
  ...
  aoi21  g091(.a(new_n168_), .b(new_n149_), .c(x10), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n90_), .O(z27));
  inv1   g094(.a(x40), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n172_), .c(x09), .O(new_n179_));
  inv1   g096(.a(x39), .O(new_n180_));
  nand2  g097(.a(new_n172_), .b(x09), .O(new_n181_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n172_), .c(x09), .O(new_n201_));
  nand2  g118(.a(new_n181_), .b(new_n195_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n86_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z32));
  inv1   g121(.a(x45), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n172_), .c(x09), .O(new_n206_));
  nand2  g123(.a(new_n181_), .b(new_n200_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(new_n86_), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z33));
  inv1   g126(.a(x46), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n172_), .c(x09), .O(new_n211_));
  nand2  g128(.a(new_n181_), .b(new_n205_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n211_), .c(new_n86_), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(z34));
  nand3  g131(.a(new_n172_), .b(x09), .c(new_n146_), .O(new_n215_));
  nand2  g132(.a(new_n181_), .b(new_n210_), .O(new_n216_));
