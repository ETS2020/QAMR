...
module FAU ( 
  ...
  nand3  g049(.a(new_n132_), .b(new_n130_), .c(new_n90_), .O(new_n133_));
  ...
  aoi21  g075(.a(x27), .b(new_n114_), .c(x09), .O(new_n159_));
  ...
  nand3  g086(.a(new_n169_), .b(new_n168_), .c(new_n90_), .O(new_n170_));
  inv1   g087(.a(new_n170_), .O(z18));
  inv1   g088(.a(x00), .O(new_n172_));
  nand2  g089(.a(x08), .b(new_n172_), .O(new_n173_));
  nand2  g090(.a(new_n167_), .b(new_n114_), .O(new_n174_));
  nand3  g091(.a(new_n174_), .b(new_n173_), .c(new_n90_), .O(new_n175_));
  ...
  nand2  g100(.a(new_n90_), .b(x34), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z23));
  inv1   g102(.a(x35), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n177_), .c(x10), .O(z24));
  inv1   g104(.a(x36), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n177_), .c(x10), .O(z25));
  inv1   g106(.a(x37), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n177_), .c(x10), .O(z26));
  nand2  g108(.a(new_n90_), .b(x38), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z27));
  inv1   g110(.a(x39), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n177_), .c(x10), .O(z28));
  nand2  g112(.a(new_n90_), .b(x40), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z29));
  nand2  g114(.a(new_n90_), .b(x41), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z30));
  nand2  g116(.a(new_n90_), .b(x42), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z31));
  nand2  g118(.a(new_n90_), .b(x43), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z32));
  nand2  g120(.a(new_n90_), .b(x44), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z33));
  nand2  g122(.a(new_n90_), .b(x45), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z34));
  nand2  g124(.a(new_n90_), .b(x46), .O(new_n208_));
