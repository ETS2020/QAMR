...
module FAU ( 
  ...
  nand3  g159(.a(new_n242_), .b(new_n229_), .c(x09), .O(new_n243_));
  nand2  g160(.a(new_n238_), .b(new_n235_), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n243_), .c(new_n88_), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n85_), .O(z29));
  nand2  g163(.a(x42), .b(new_n88_), .O(new_n247_));
  aoi21  g164(.a(new_n238_), .b(new_n242_), .c(new_n247_), .O(z30));
  inv1   g165(.a(x43), .O(new_n249_));
  nand3  g166(.a(new_n249_), .b(new_n229_), .c(x09), .O(new_n250_));
  nand2  g167(.a(new_n238_), .b(new_n84_), .O(new_n251_));
  ...
  nand3  g171(.a(new_n254_), .b(new_n229_), .c(x09), .O(new_n255_));
  nand2  g172(.a(new_n238_), .b(new_n249_), .O(new_n256_));
  ...
  nand3  g176(.a(new_n259_), .b(new_n229_), .c(x09), .O(new_n260_));
  nand2  g177(.a(new_n238_), .b(new_n254_), .O(new_n261_));
  ...
  nand3  g181(.a(new_n264_), .b(new_n229_), .c(x09), .O(new_n265_));
  nand2  g182(.a(new_n238_), .b(new_n259_), .O(new_n266_));
  nand3  g183(.a(new_n266_), .b(new_n265_), .c(new_n91_), .O(new_n267_));
  inv1   g184(.a(new_n267_), .O(z34));
  nand3  g185(.a(new_n229_), .b(x09), .c(new_n187_), .O(new_n269_));
  nand2  g186(.a(new_n238_), .b(new_n264_), .O(new_n270_));
  nand3  g187(.a(new_n270_), .b(new_n269_), .c(new_n91_), .O(new_n271_));
