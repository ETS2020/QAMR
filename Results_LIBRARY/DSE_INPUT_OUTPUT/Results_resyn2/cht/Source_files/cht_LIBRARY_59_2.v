...
module FAU ( 
  ...
  oai21  g037(.a(new_n120_), .b(new_n119_), .c(new_n93_), .O(z10));
  ...
  oai21  g058(.a(new_n141_), .b(new_n140_), .c(new_n93_), .O(z17));
  oai21  g059(.a(x29), .b(x08), .c(new_n86_), .O(new_n143_));
  aoi21  g060(.a(new_n92_), .b(x08), .c(new_n143_), .O(z18));
  inv1   g061(.a(x00), .O(new_n145_));
  nand2  g062(.a(x08), .b(new_n145_), .O(new_n146_));
  nand2  g063(.a(new_n92_), .b(new_n106_), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(new_n86_), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(new_n93_), .O(z19));
  ...
  aoi21  g096(.a(new_n173_), .b(new_n150_), .c(x10), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n93_), .O(z27));
  ...
  nand2  g110(.a(new_n193_), .b(new_n93_), .O(z29));
  ...
  nand3  g136(.a(new_n177_), .b(x09), .c(new_n145_), .O(new_n220_));
