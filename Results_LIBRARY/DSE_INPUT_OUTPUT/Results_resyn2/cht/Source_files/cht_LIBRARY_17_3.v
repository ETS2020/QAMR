...
module FAU ( 
  ...
  aoi21  g000(.a(x22), .b(x15), .c(x10), .O(new_n84_));
  ...
  nand2  g008(.a(x22), .b(x15), .O(new_n92_));
  ...
  oai21  g017(.a(x14), .b(x07), .c(new_n94_), .O(new_n101_));
  oai21  g018(.a(new_n101_), .b(new_n100_), .c(new_n92_), .O(z03));
  ...
  nand2  g043(.a(new_n123_), .b(new_n117_), .O(new_n127_));
  inv1   g044(.a(x20), .O(new_n128_));
  nand2  g045(.a(new_n128_), .b(x08), .O(new_n129_));
  nand3  g046(.a(new_n129_), .b(new_n127_), .c(new_n84_), .O(new_n130_));
  inv1   g047(.a(new_n130_), .O(z08));
  nand2  g048(.a(new_n128_), .b(new_n117_), .O(new_n132_));
  ...
  nand2  g055(.a(new_n133_), .b(new_n117_), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(new_n138_), .c(new_n94_), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n92_), .O(z10));
  nand2  g058(.a(new_n137_), .b(new_n117_), .O(new_n142_));
  ...
  nand2  g063(.a(new_n143_), .b(new_n117_), .O(new_n147_));
  inv1   g064(.a(x24), .O(new_n148_));
  nand2  g065(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g066(.a(new_n149_), .b(new_n147_), .c(new_n84_), .O(new_n150_));
  ...
  nand3  g076(.a(new_n159_), .b(new_n157_), .c(new_n84_), .O(new_n160_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n172_), .c(new_n84_), .O(new_n175_));
  ...
  nand3  g096(.a(new_n179_), .b(new_n178_), .c(new_n94_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n92_), .O(z18));
  ...
  nand2  g139(.a(new_n222_), .b(new_n92_), .O(z26));
  ...
  nand2  g145(.a(new_n219_), .b(new_n187_), .O(new_n229_));
  ...
  nand3  g151(.a(new_n234_), .b(new_n233_), .c(new_n94_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n92_), .O(z28));
  ...
  nand3  g161(.a(new_n244_), .b(new_n243_), .c(new_n84_), .O(new_n245_));
  ...
  nand3  g181(.a(new_n264_), .b(new_n263_), .c(new_n84_), .O(new_n265_));
