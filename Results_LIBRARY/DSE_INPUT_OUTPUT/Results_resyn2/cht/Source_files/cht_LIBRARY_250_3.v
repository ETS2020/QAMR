...
module FAU ( 
  ...
  oai21  g018(.a(new_n101_), .b(new_n100_), .c(new_n89_), .O(z04));
  ...
  oai21  g031(.a(new_n114_), .b(new_n113_), .c(new_n89_), .O(z08));
  ...
  nand2  g039(.a(new_n122_), .b(new_n89_), .O(z10));
  ...
  oai21  g060(.a(new_n143_), .b(new_n142_), .c(new_n89_), .O(z17));
  ...
  nand2  g068(.a(new_n151_), .b(new_n89_), .O(z19));
  ...
  nand2  g094(.a(new_n177_), .b(new_n89_), .O(z26));
  ...
  aoi21  g099(.a(new_n174_), .b(new_n158_), .c(x10), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n89_), .O(z27));
  ...
  nand2  g113(.a(new_n196_), .b(new_n89_), .O(z29));
  ...
  nand3  g139(.a(new_n180_), .b(x09), .c(new_n148_), .O(new_n223_));
