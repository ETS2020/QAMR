...
module FAU ( 
  ...
  nand2  g046(.a(new_n125_), .b(new_n109_), .O(new_n130_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n85_), .O(z21));
  nand2  g080(.a(new_n84_), .b(x09), .O(new_n164_));
  nand2  g081(.a(new_n158_), .b(new_n160_), .O(new_n165_));
  nand3  g082(.a(new_n165_), .b(new_n164_), .c(new_n88_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n85_), .O(z22));
  nor2   g084(.a(x35), .b(new_n160_), .O(new_n168_));
  oai21  g085(.a(x34), .b(x09), .c(new_n88_), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(new_n168_), .c(new_n85_), .O(z23));
  ...
  nand2  g099(.a(x14), .b(new_n150_), .O(new_n183_));
  ...
  oai21  g105(.a(x14), .b(new_n160_), .c(new_n181_), .O(new_n189_));
  ...
  oai21  g110(.a(x14), .b(new_n160_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g115(.a(x14), .b(new_n160_), .c(new_n192_), .O(new_n199_));
  ...
  oai21  g120(.a(x14), .b(new_n160_), .c(new_n197_), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n203_), .c(new_n88_), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(new_n85_), .O(z31));
  inv1   g123(.a(x44), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n180_), .c(x09), .O(new_n208_));
  oai21  g125(.a(x14), .b(new_n160_), .c(new_n202_), .O(new_n209_));
  ...
  oai21  g130(.a(x14), .b(new_n160_), .c(new_n207_), .O(new_n214_));
  ...
  oai21  g135(.a(x14), .b(new_n160_), .c(new_n212_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(new_n88_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n85_), .O(z34));
  nand3  g138(.a(new_n180_), .b(x09), .c(new_n150_), .O(new_n222_));
  oai21  g139(.a(x14), .b(new_n160_), .c(new_n217_), .O(new_n223_));
