...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n62_, new_n64_, new_n66_, new_n68_, new_n72_, new_n74_;
  ...
  oai21  g25(.a(new_n52_), .b(x09), .c(new_n42_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z05));
  oai21  g27(.a(new_n52_), .b(x10), .c(new_n42_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x04), .O(z06));
  oai21  g29(.a(new_n52_), .b(x11), .c(new_n42_), .O(new_n64_));
  ...
  nand3  g34(.a(new_n54_), .b(new_n57_), .c(new_n68_), .O(z09));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n50_), .c(new_n43_), .O(z12));
  nand2  g39(.a(new_n57_), .b(x17), .O(new_n74_));
