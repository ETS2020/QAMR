...
module FAU ( 
  ...
  oai21  g26(.a(new_n60_), .b(new_n37_), .c(new_n54_), .O(new_n61_));
  ...
  nand3  g34(.a(new_n65_), .b(new_n53_), .c(new_n68_), .O(new_n69_));
  ...
  nand4  g39(.a(new_n65_), .b(new_n53_), .c(new_n73_), .d(new_n68_), .O(new_n74_));
  inv1   g40(.a(x09), .O(new_n75_));
  nand4  g41(.a(new_n68_), .b(new_n75_), .c(x08), .d(x07), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x11), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n74_), .c(new_n58_), .O(new_n78_));
  ...
  or2    g49(.a(new_n83_), .b(new_n69_), .O(new_n84_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n65_), .d(new_n53_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n87_), .c(new_n58_), .O(new_n91_));
  ...
  aoi21  g68(.a(x06), .b(new_n37_), .c(new_n35_), .O(z11));
