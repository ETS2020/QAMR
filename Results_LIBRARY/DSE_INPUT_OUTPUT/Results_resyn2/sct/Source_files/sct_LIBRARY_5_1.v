...
module FAU ( 
  ...
  oai21  g16(.a(new_n50_), .b(new_n49_), .c(new_n39_), .O(z02));
  inv1   g17(.a(new_n49_), .O(new_n52_));
  inv1   g18(.a(x07), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(x06), .O(new_n54_));
  oai21  g20(.a(new_n50_), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(new_n39_), .O(z03));
  nor2   g23(.a(x06), .b(x04), .O(new_n58_));
  inv1   g24(.a(new_n58_), .O(z13));
  aoi22  g25(.a(z13), .b(x08), .c(x07), .d(x06), .O(new_n60_));
  nand3  g26(.a(x08), .b(x07), .c(x06), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n52_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n60_), .c(new_n39_), .O(z04));
  nor2   g29(.a(new_n61_), .b(x09), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  inv1   g31(.a(x04), .O(new_n66_));
  nor2   g32(.a(new_n49_), .b(new_n66_), .O(new_n67_));
  nand2  g33(.a(new_n61_), .b(x09), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n65_), .O(z05));
  oai21  g35(.a(x10), .b(new_n66_), .c(new_n65_), .O(new_n70_));
  inv1   g36(.a(new_n61_), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n71_), .c(new_n49_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n70_), .c(new_n38_), .O(z06));
  ...
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n67_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand3  g46(.a(new_n77_), .b(new_n64_), .c(new_n80_), .O(new_n81_));
  nand2  g47(.a(new_n78_), .b(x12), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n67_), .O(z08));
  nand2  g49(.a(new_n81_), .b(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand3  g51(.a(new_n77_), .b(new_n85_), .c(new_n80_), .O(new_n86_));
  inv1   g52(.a(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n64_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n84_), .c(new_n67_), .O(z09));
  ...
  nand3  g59(.a(new_n93_), .b(x08), .c(x07), .O(new_n94_));
  aoi21  g60(.a(new_n92_), .b(x16), .c(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n91_), .c(new_n66_), .O(new_n96_));
  nand3  g62(.a(new_n49_), .b(x14), .c(x04), .O(new_n97_));
  ...
  oai21  g66(.a(new_n100_), .b(new_n66_), .c(new_n39_), .O(z12));
  inv1   g67(.a(x17), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(x04), .c(new_n58_), .O(z14));
endmodule
