...
module FAU ( 
  ...
  nand3  g15(.a(new_n49_), .b(x10), .c(new_n46_), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z02));
  inv1   g17(.a(new_n37_), .O(new_n52_));
  xnor2a g18(.a(x07), .b(x06), .O(new_n53_));
  oai21  g19(.a(new_n53_), .b(new_n48_), .c(new_n52_), .O(z03));
  nand2  g20(.a(x07), .b(x06), .O(new_n55_));
  xor2a  g21(.a(new_n55_), .b(x08), .O(new_n56_));
  oai21  g22(.a(new_n56_), .b(new_n48_), .c(new_n52_), .O(z04));
  inv1   g23(.a(x08), .O(new_n58_));
  oai22  g24(.a(new_n55_), .b(new_n58_), .c(new_n37_), .d(x09), .O(new_n59_));
  nand2  g25(.a(x08), .b(x07), .O(new_n60_));
  nor2   g26(.a(new_n60_), .b(x09), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x06), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n59_), .c(new_n49_), .O(z05));
  inv1   g29(.a(x10), .O(new_n64_));
  nand3  g30(.a(new_n61_), .b(new_n64_), .c(x06), .O(new_n65_));
  nand2  g31(.a(new_n48_), .b(new_n52_), .O(new_n66_));
  nand2  g32(.a(new_n62_), .b(x10), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z06));
  inv1   g34(.a(x11), .O(new_n69_));
  nor2   g35(.a(new_n61_), .b(new_n69_), .O(new_n70_));
  ...
  oai21  g40(.a(new_n74_), .b(new_n70_), .c(x06), .O(new_n75_));
  nand2  g41(.a(x11), .b(x10), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n66_), .O(z07));
  inv1   g43(.a(x12), .O(new_n78_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(new_n78_), .O(new_n79_));
  nand3  g45(.a(new_n61_), .b(x12), .c(new_n69_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(x06), .O(new_n81_));
  nand2  g47(.a(x12), .b(x10), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n66_), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nor2   g50(.a(x12), .b(x11), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n61_), .c(new_n84_), .O(new_n86_));
  nand3  g52(.a(new_n85_), .b(new_n84_), .c(new_n64_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(new_n72_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n86_), .c(x06), .O(new_n89_));
  aoi22  g55(.a(new_n48_), .b(new_n52_), .c(x13), .d(x10), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n89_), .O(z09));
  nor2   g57(.a(new_n37_), .b(x04), .O(new_n92_));
  nand2  g58(.a(x06), .b(x00), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n87_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n61_), .c(new_n47_), .O(new_n95_));
  inv1   g61(.a(x03), .O(new_n96_));
  inv1   g62(.a(x16), .O(new_n97_));
  aoi21  g63(.a(new_n96_), .b(x02), .c(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x14), .c(new_n37_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n95_), .c(new_n92_), .O(z10));
  nand2  g66(.a(new_n52_), .b(new_n36_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n36_), .c(x03), .O(new_n102_));
  nand2  g68(.a(new_n52_), .b(x04), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n102_), .O(z12));
  inv1   g70(.a(new_n92_), .O(z13));
