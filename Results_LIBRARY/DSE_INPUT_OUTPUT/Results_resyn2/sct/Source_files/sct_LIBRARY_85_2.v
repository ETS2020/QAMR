...
module FAU ( 
  ...
  nand2  g12(.a(x18), .b(x06), .O(new_n47_));
  ...
  nand3  g26(.a(new_n60_), .b(new_n59_), .c(new_n38_), .O(new_n61_));
  nor2   g27(.a(new_n61_), .b(new_n50_), .O(z04));
  nand2  g28(.a(new_n50_), .b(new_n38_), .O(new_n63_));
  oai21  g29(.a(new_n58_), .b(new_n53_), .c(x18), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x06), .O(new_n65_));
  inv1   g31(.a(x09), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(x08), .c(x07), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n47_), .O(new_n68_));
  aoi21  g34(.a(new_n65_), .b(x09), .c(new_n68_), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(new_n63_), .O(z05));
  nand2  g36(.a(new_n67_), .b(x18), .O(new_n71_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n63_), .O(z06));
  inv1   g42(.a(x11), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n67_), .c(x18), .O(new_n79_));
  ...
  nor2   g49(.a(new_n78_), .b(x12), .O(new_n84_));
  aoi22  g50(.a(new_n84_), .b(new_n68_), .c(new_n50_), .d(new_n38_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n83_), .O(z08));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n77_), .d(new_n74_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n67_), .c(x18), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand2  g57(.a(new_n84_), .b(new_n68_), .O(new_n92_));
  ...
  nand2  g62(.a(new_n89_), .b(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n68_), .c(new_n49_), .O(new_n98_));
  ...
  oai21  g70(.a(new_n104_), .b(new_n95_), .c(new_n38_), .O(z12));
  aoi21  g71(.a(new_n37_), .b(x06), .c(new_n95_), .O(z13));
