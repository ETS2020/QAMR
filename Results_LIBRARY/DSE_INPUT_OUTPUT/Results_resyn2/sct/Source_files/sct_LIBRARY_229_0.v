...
module FAU ( 
  ...
  oai21  g20(.a(new_n37_), .b(new_n36_), .c(new_n54_), .O(new_n55_));
  nor2   g21(.a(new_n54_), .b(new_n37_), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(new_n38_), .O(z03));
  nor2   g25(.a(new_n50_), .b(new_n36_), .O(new_n60_));
  ...
  nand2  g39(.a(new_n53_), .b(new_n70_), .O(new_n74_));
  nor2   g40(.a(new_n68_), .b(new_n50_), .O(new_n75_));
  inv1   g41(.a(new_n75_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(x04), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n73_), .O(z06));
  nand4  g44(.a(new_n56_), .b(new_n70_), .c(new_n67_), .d(x08), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(x11), .c(new_n50_), .O(new_n80_));
  oai21  g46(.a(new_n71_), .b(x11), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  oai21  g48(.a(new_n80_), .b(new_n36_), .c(new_n82_), .O(z07));
  ...
  nand3  g54(.a(new_n88_), .b(new_n84_), .c(new_n60_), .O(z08));
  ...
  aoi21  g60(.a(new_n88_), .b(x13), .c(new_n50_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n36_), .c(new_n94_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n92_), .b(new_n97_), .O(new_n98_));
  inv1   g64(.a(x14), .O(new_n99_));
  nor2   g65(.a(new_n53_), .b(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n98_), .b(new_n75_), .c(new_n100_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g68(.a(new_n38_), .b(new_n52_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n52_), .c(x03), .O(new_n104_));
