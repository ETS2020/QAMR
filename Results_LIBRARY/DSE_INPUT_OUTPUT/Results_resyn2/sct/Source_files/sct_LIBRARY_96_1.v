...
module FAU ( 
  ...
  nand3  g22(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(new_n57_));
  ...
  nor2   g32(.a(x09), .b(new_n47_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n64_), .c(new_n51_), .O(z05));
  ...
  oai21  g40(.a(new_n68_), .b(x10), .c(x11), .O(new_n75_));
  ...
  nor2   g46(.a(new_n65_), .b(x09), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n76_), .c(new_n80_), .O(new_n82_));
  nor2   g48(.a(x12), .b(x09), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n59_), .c(new_n49_), .O(new_n85_));
  ...
  nand4  g54(.a(new_n83_), .b(new_n76_), .c(x08), .d(x07), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x13), .O(new_n90_));
  nor2   g56(.a(x13), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n76_), .c(new_n67_), .d(new_n66_), .O(new_n92_));
  ...
  nand2  g62(.a(new_n91_), .b(new_n76_), .O(new_n97_));
  ...
  aoi21  g72(.a(x06), .b(new_n36_), .c(new_n48_), .O(z11));
