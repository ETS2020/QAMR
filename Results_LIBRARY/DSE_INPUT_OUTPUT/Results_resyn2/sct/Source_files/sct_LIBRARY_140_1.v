...
module FAU ( 
  ...
  nor2   g03(.a(new_n37_), .b(x10), .O(new_n38_));
  ...
  oai21  g22(.a(new_n56_), .b(new_n49_), .c(new_n47_), .O(z03));
  inv1   g23(.a(x03), .O(new_n58_));
  inv1   g24(.a(x16), .O(new_n59_));
  aoi21  g25(.a(new_n58_), .b(x02), .c(new_n59_), .O(new_n60_));
  nor2   g26(.a(new_n60_), .b(new_n44_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n47_), .O(new_n62_));
  nand2  g28(.a(new_n53_), .b(x08), .O(new_n63_));
  inv1   g29(.a(x08), .O(new_n64_));
  nand2  g30(.a(new_n54_), .b(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(new_n62_), .O(z04));
  nor2   g33(.a(x09), .b(new_n64_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n53_), .O(new_n69_));
  nand2  g35(.a(new_n63_), .b(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n69_), .c(new_n61_), .d(new_n47_), .O(z05));
  oai21  g37(.a(x12), .b(x10), .c(new_n69_), .O(new_n72_));
  inv1   g38(.a(x10), .O(new_n73_));
  inv1   g39(.a(new_n69_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n72_), .c(new_n61_), .O(z06));
  oai21  g42(.a(new_n69_), .b(x11), .c(new_n37_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand3  g44(.a(new_n74_), .b(new_n37_), .c(new_n73_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x11), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n61_), .O(z07));
  inv1   g47(.a(x11), .O(new_n82_));
  nand4  g48(.a(new_n68_), .b(new_n53_), .c(new_n82_), .d(new_n73_), .O(new_n83_));
  nand2  g49(.a(new_n61_), .b(new_n37_), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n83_), .c(new_n38_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(new_n87_), .O(new_n88_));
  nand3  g54(.a(new_n74_), .b(x13), .c(new_n82_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n37_), .O(new_n90_));
  aoi22  g56(.a(new_n49_), .b(new_n47_), .c(x13), .d(x10), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n90_), .O(z09));
  nand2  g58(.a(new_n60_), .b(x14), .O(new_n93_));
  nand4  g59(.a(new_n68_), .b(new_n53_), .c(new_n48_), .d(x00), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n47_), .O(new_n96_));
  nand4  g62(.a(new_n87_), .b(new_n37_), .c(new_n82_), .d(new_n73_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n74_), .c(new_n48_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n96_), .c(new_n44_), .O(z10));
  ...
  nand2  g69(.a(new_n47_), .b(new_n44_), .O(z13));
  inv1   g70(.a(x17), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n44_), .c(new_n47_), .O(z14));
endmodule
