...
module FAU ( 
  ...
  nand2  g28(.a(new_n49_), .b(new_n38_), .O(new_n63_));
  nand2  g29(.a(x08), .b(x07), .O(new_n64_));
  nor2   g30(.a(new_n64_), .b(x09), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(x13), .c(x06), .O(new_n66_));
  nand2  g32(.a(new_n64_), .b(x13), .O(new_n67_));
  ...
  oai21  g36(.a(new_n65_), .b(new_n37_), .c(x06), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x10), .O(new_n72_));
  inv1   g38(.a(x10), .O(new_n73_));
  nor2   g39(.a(new_n37_), .b(new_n47_), .O(new_n74_));
  nand3  g40(.a(new_n65_), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n72_), .c(new_n63_), .O(z06));
  inv1   g42(.a(x09), .O(new_n77_));
  nand4  g43(.a(new_n73_), .b(new_n77_), .c(x08), .d(x07), .O(new_n78_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n65_), .c(new_n74_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n63_), .O(z07));
  aoi21  g50(.a(new_n82_), .b(new_n65_), .c(new_n37_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n47_), .c(x12), .O(new_n86_));
  nand4  g52(.a(new_n77_), .b(x08), .c(x07), .d(x06), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand3  g54(.a(new_n82_), .b(x13), .c(new_n88_), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  aoi21  g56(.a(new_n49_), .b(new_n38_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n86_), .O(z08));
  inv1   g58(.a(new_n65_), .O(new_n93_));
  oai21  g59(.a(new_n89_), .b(new_n93_), .c(x06), .O(new_n94_));
  ...
  nand4  g65(.a(new_n65_), .b(new_n74_), .c(new_n48_), .d(x00), .O(new_n100_));
  ...
  aoi21  g69(.a(new_n37_), .b(x06), .c(x03), .O(new_n104_));
