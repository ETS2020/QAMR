...
module FAU ( 
  ...
  aoi21  g50(.a(new_n84_), .b(new_n73_), .c(new_n82_), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  nand3  g52(.a(new_n82_), .b(new_n86_), .c(x06), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n76_), .c(new_n47_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n85_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n81_), .O(z08));
  oai21  g56(.a(x13), .b(new_n37_), .c(new_n46_), .O(new_n91_));
  nand2  g57(.a(new_n82_), .b(new_n86_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n76_), .c(x13), .O(new_n93_));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n73_), .c(new_n64_), .d(new_n53_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n93_), .c(new_n47_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n91_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n94_), .b(new_n73_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  inv1   g67(.a(x03), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x02), .O(new_n103_));
  nand3  g69(.a(new_n75_), .b(x08), .c(x07), .O(new_n104_));
  aoi21  g70(.a(new_n103_), .b(x16), .c(new_n104_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n101_), .c(new_n37_), .O(new_n106_));
  nand3  g72(.a(new_n48_), .b(x14), .c(x04), .O(new_n107_));
