...
module FAU ( 
  ...
  aoi21  g34(.a(new_n60_), .b(x09), .c(new_n50_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n36_), .c(new_n68_), .O(z05));
  ...
  nand3  g41(.a(new_n75_), .b(new_n72_), .c(new_n51_), .O(z06));
  nand2  g42(.a(new_n75_), .b(x11), .O(new_n77_));
  nor2   g43(.a(x11), .b(x10), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n54_), .c(new_n65_), .d(x08), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n51_), .O(z07));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n73_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n66_), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  aoi21  g51(.a(new_n79_), .b(x12), .c(new_n50_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n36_), .c(new_n85_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n78_), .b(new_n74_), .c(new_n88_), .d(new_n82_), .O(new_n89_));
  oai21  g55(.a(new_n79_), .b(x12), .c(x13), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  oai21  g58(.a(new_n83_), .b(x13), .c(new_n92_), .O(new_n93_));
  nor2   g59(.a(new_n71_), .b(new_n50_), .O(new_n94_));
  ...
  nand2  g64(.a(new_n38_), .b(new_n98_), .O(z11));
