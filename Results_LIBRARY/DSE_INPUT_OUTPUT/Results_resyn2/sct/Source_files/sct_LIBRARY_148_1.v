...
module FAU ( 
  ...
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n58_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n74_), .O(z07));
  oai21  g47(.a(x12), .b(new_n36_), .c(new_n46_), .O(new_n82_));
  nand2  g48(.a(x08), .b(x07), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  nand3  g50(.a(new_n75_), .b(new_n84_), .c(new_n64_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n83_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(new_n61_), .O(new_n88_));
  nand4  g54(.a(new_n71_), .b(new_n88_), .c(new_n87_), .d(new_n75_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n58_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n82_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n87_), .c(new_n75_), .d(new_n84_), .O(new_n94_));
  or2    g60(.a(new_n94_), .b(new_n67_), .O(new_n95_));
  nand2  g61(.a(new_n89_), .b(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n50_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n94_), .b(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n47_), .b(x02), .O(new_n100_));
  nand3  g66(.a(new_n64_), .b(x08), .c(x07), .O(new_n101_));
  ...
  aoi21  g72(.a(x06), .b(new_n36_), .c(new_n106_), .O(z11));
