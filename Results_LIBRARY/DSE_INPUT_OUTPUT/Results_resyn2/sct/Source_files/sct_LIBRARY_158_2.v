...
module FAU ( 
  ...
  nand2  g24(.a(x06), .b(x04), .O(new_n59_));
  nor2   g25(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g26(.a(new_n53_), .b(x09), .O(new_n61_));
  ...
  nand3  g34(.a(new_n68_), .b(new_n65_), .c(new_n60_), .O(z06));
  ...
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n60_), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  aoi21  g46(.a(new_n77_), .b(new_n67_), .c(new_n80_), .O(new_n81_));
  nor2   g47(.a(x13), .b(x12), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n71_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n63_), .c(new_n50_), .O(new_n84_));
  ...
  nand3  g54(.a(new_n88_), .b(new_n67_), .c(new_n50_), .O(new_n89_));
  aoi21  g55(.a(new_n58_), .b(x14), .c(new_n36_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n47_), .O(z10));
  nand2  g57(.a(new_n37_), .b(new_n49_), .O(z11));
  aoi21  g58(.a(x16), .b(new_n49_), .c(x03), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n59_), .O(z12));
  inv1   g60(.a(new_n59_), .O(z13));
