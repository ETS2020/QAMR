...
module FAU ( 
  ...
  nand3  g33(.a(new_n67_), .b(new_n65_), .c(new_n54_), .O(new_n68_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n83_), .c(new_n50_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n85_), .b(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n47_), .b(x02), .O(new_n91_));
  inv1   g57(.a(x09), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(x08), .c(x07), .O(new_n93_));
  aoi21  g59(.a(new_n91_), .b(x16), .c(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n90_), .c(new_n36_), .O(new_n95_));
  nand3  g61(.a(new_n49_), .b(x14), .c(x04), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n46_), .c(new_n96_), .O(z10));
  inv1   g63(.a(x02), .O(new_n98_));
  aoi21  g64(.a(x06), .b(new_n36_), .c(new_n98_), .O(z11));
