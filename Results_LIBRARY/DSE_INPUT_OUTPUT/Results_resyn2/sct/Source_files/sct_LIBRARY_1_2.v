...
module FAU ( 
  ...
  nor2   g34(.a(new_n55_), .b(x09), .O(new_n69_));
  ...
  nand3  g62(.a(new_n96_), .b(new_n69_), .c(new_n61_), .O(new_n97_));
  aoi21  g63(.a(new_n50_), .b(x14), .c(new_n36_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n94_), .O(z10));
  nand2  g65(.a(new_n37_), .b(new_n60_), .O(z11));
  nand2  g66(.a(x16), .b(new_n60_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n48_), .c(new_n51_), .O(z12));
  inv1   g68(.a(new_n51_), .O(z13));
  nand2  g69(.a(z13), .b(x17), .O(new_n104_));
