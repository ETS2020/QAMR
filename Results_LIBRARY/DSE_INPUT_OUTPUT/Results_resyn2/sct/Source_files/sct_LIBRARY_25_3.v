...
module FAU ( 
  ...
  nor2   g25(.a(x06), .b(new_n48_), .O(new_n60_));
  nand3  g26(.a(new_n54_), .b(new_n60_), .c(new_n59_), .O(z05));
  inv1   g27(.a(x10), .O(new_n62_));
  nand3  g28(.a(new_n54_), .b(new_n60_), .c(new_n62_), .O(z06));
  inv1   g29(.a(x11), .O(new_n64_));
  nand3  g30(.a(new_n54_), .b(new_n60_), .c(new_n64_), .O(z07));
  oai21  g31(.a(new_n51_), .b(x12), .c(new_n41_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x04), .O(z08));
  oai21  g33(.a(new_n51_), .b(x13), .c(new_n41_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x04), .O(z09));
  nand2  g35(.a(new_n60_), .b(x14), .O(new_n70_));
