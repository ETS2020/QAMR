...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n68_,
    new_n70_;
  ...
  nand3  g23(.a(z13), .b(new_n57_), .c(new_n56_), .O(z06));
  inv1   g24(.a(x11), .O(new_n59_));
  nand3  g25(.a(z13), .b(new_n57_), .c(new_n59_), .O(z07));
  inv1   g26(.a(x12), .O(new_n61_));
  nand3  g27(.a(z13), .b(new_n57_), .c(new_n61_), .O(z08));
