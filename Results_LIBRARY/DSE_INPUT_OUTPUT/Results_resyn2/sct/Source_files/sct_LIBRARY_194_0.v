...
module FAU ( 
  ...
  aoi21  g43(.a(new_n71_), .b(x11), .c(new_n50_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n36_), .c(new_n77_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nor2   g46(.a(new_n74_), .b(new_n67_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  oai21  g48(.a(new_n74_), .b(new_n67_), .c(x12), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n51_), .O(z08));
  nand2  g50(.a(new_n82_), .b(x13), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand3  g52(.a(new_n81_), .b(new_n86_), .c(new_n80_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n51_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n86_), .b(new_n80_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n74_), .c(new_n89_), .O(new_n91_));
  nor2   g57(.a(new_n67_), .b(new_n50_), .O(new_n92_));
  ...
  aoi21  g66(.a(new_n100_), .b(new_n48_), .c(new_n36_), .O(z12));
