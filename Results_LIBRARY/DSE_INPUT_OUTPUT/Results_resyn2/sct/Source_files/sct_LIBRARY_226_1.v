...
module FAU ( 
  ...
  oai21  g22(.a(new_n56_), .b(new_n55_), .c(new_n39_), .O(z03));
  ...
  aoi21  g27(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(z04));
  ...
  nand2  g34(.a(x09), .b(new_n47_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n54_), .c(x04), .O(new_n70_));
  inv1   g36(.a(new_n70_), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n68_), .c(new_n38_), .O(z05));
  nand2  g38(.a(new_n66_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  and2   g40(.a(x08), .b(x07), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n65_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x06), .O(new_n78_));
  nor2   g44(.a(new_n74_), .b(x06), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n55_), .c(new_n39_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n78_), .O(z06));
  inv1   g47(.a(x11), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x06), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n55_), .c(new_n39_), .O(new_n84_));
  nand4  g50(.a(new_n75_), .b(x11), .c(new_n74_), .d(new_n65_), .O(new_n85_));
  nand2  g51(.a(new_n76_), .b(new_n82_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(x06), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n84_), .O(z07));
  nor2   g54(.a(x11), .b(x10), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n65_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n60_), .c(x12), .O(new_n91_));
  nor2   g57(.a(new_n90_), .b(new_n60_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n37_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n51_), .O(z08));
  nand2  g60(.a(new_n89_), .b(new_n37_), .O(new_n95_));
  ...
  oai21  g68(.a(x13), .b(x12), .c(new_n47_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n102_), .c(new_n96_), .d(new_n51_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nand2  g71(.a(new_n98_), .b(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n101_), .c(new_n54_), .O(new_n107_));
  nand3  g73(.a(new_n50_), .b(new_n39_), .c(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z10));
  nor2   g75(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n35_), .c(x03), .O(new_n111_));
  nor3   g77(.a(new_n111_), .b(new_n38_), .c(new_n44_), .O(z12));
  nand2  g78(.a(new_n39_), .b(new_n44_), .O(z13));
  inv1   g79(.a(x17), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n44_), .c(new_n39_), .O(z14));
endmodule
