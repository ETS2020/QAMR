...
module FAU ( 
  ...
  oai21  g24(.a(x03), .b(new_n35_), .c(x16), .O(new_n60_));
  nand2  g25(.a(new_n55_), .b(x09), .O(new_n61_));
  inv1   g26(.a(x09), .O(new_n62_));
  nand3  g27(.a(new_n62_), .b(x08), .c(x07), .O(new_n63_));
  nand3  g28(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(new_n64_));
  nand2  g29(.a(new_n64_), .b(x06), .O(new_n65_));
  nand2  g30(.a(new_n65_), .b(x04), .O(z05));
  inv1   g31(.a(x10), .O(new_n67_));
  nor2   g32(.a(new_n55_), .b(x09), .O(new_n68_));
  nand2  g33(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g34(.a(new_n63_), .b(x10), .O(new_n70_));
  nand3  g35(.a(new_n70_), .b(new_n69_), .c(new_n60_), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(x06), .O(new_n72_));
  nand2  g37(.a(new_n72_), .b(x04), .O(z06));
  nand2  g38(.a(new_n69_), .b(x11), .O(new_n74_));
  nor2   g39(.a(x11), .b(x10), .O(new_n75_));
  nand2  g40(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand3  g41(.a(new_n76_), .b(new_n74_), .c(new_n52_), .O(z07));
  nand2  g42(.a(new_n76_), .b(x12), .O(new_n78_));
  ...
  aoi21  g47(.a(new_n79_), .b(new_n68_), .c(new_n82_), .O(new_n83_));
  nor2   g48(.a(x13), .b(x12), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  oai21  g50(.a(new_n85_), .b(new_n63_), .c(new_n60_), .O(new_n86_));
  ...
  nand3  g55(.a(new_n90_), .b(new_n68_), .c(new_n60_), .O(new_n91_));
  inv1   g56(.a(x06), .O(new_n92_));
  aoi21  g57(.a(new_n51_), .b(x14), .c(new_n92_), .O(new_n93_));
  aoi21  g58(.a(new_n93_), .b(new_n91_), .c(new_n37_), .O(z10));
  nor2   g59(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g60(.a(x16), .b(new_n35_), .O(new_n96_));
  nor2   g61(.a(new_n92_), .b(x03), .O(new_n97_));
  aoi21  g62(.a(new_n97_), .b(new_n96_), .c(new_n37_), .O(z12));
