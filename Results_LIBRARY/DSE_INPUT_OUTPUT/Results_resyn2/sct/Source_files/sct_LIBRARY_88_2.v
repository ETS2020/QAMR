...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n94_, new_n95_, new_n96_, new_n99_, new_n100_, new_n102_;
  ...
  nor2   g36(.a(new_n60_), .b(x09), .O(new_n72_));
  nand2  g37(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g38(.a(new_n67_), .b(x10), .O(new_n74_));
  nand3  g39(.a(new_n74_), .b(new_n73_), .c(new_n53_), .O(new_n75_));
  nand2  g40(.a(new_n75_), .b(x06), .O(new_n76_));
  nand2  g41(.a(new_n76_), .b(x04), .O(z06));
  nand2  g42(.a(new_n73_), .b(x11), .O(new_n78_));
  nor2   g43(.a(x11), .b(x10), .O(new_n79_));
  nand2  g44(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  nand3  g45(.a(new_n80_), .b(new_n78_), .c(new_n59_), .O(z07));
  nand2  g46(.a(new_n80_), .b(x12), .O(new_n82_));
  nor3   g47(.a(x12), .b(x11), .c(x10), .O(new_n83_));
  nand2  g48(.a(new_n83_), .b(new_n72_), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(new_n82_), .c(new_n59_), .O(z08));
  inv1   g50(.a(x13), .O(new_n86_));
  aoi21  g51(.a(new_n83_), .b(new_n72_), .c(new_n86_), .O(new_n87_));
  nor2   g52(.a(x13), .b(x12), .O(new_n88_));
  nand2  g53(.a(new_n88_), .b(new_n79_), .O(new_n89_));
  oai21  g54(.a(new_n89_), .b(new_n67_), .c(new_n53_), .O(new_n90_));
  oai21  g55(.a(new_n90_), .b(new_n87_), .c(x06), .O(new_n91_));
  nand2  g56(.a(new_n91_), .b(x04), .O(z09));
  nand2  g57(.a(new_n58_), .b(x14), .O(new_n93_));
  inv1   g58(.a(x00), .O(new_n94_));
  nand2  g59(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nand3  g60(.a(new_n95_), .b(new_n72_), .c(new_n53_), .O(new_n96_));
  ...
  aoi21  g67(.a(new_n102_), .b(x06), .c(new_n50_), .O(z14));
  zero   g68(.O(z02));
  buf    g69(.a(x04), .O(z13));
endmodule
