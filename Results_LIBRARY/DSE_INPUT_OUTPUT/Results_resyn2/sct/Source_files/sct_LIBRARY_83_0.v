...
module FAU ( 
  ...
  oai21  g18(.a(new_n52_), .b(new_n42_), .c(new_n47_), .O(new_n53_));
  oai21  g19(.a(new_n53_), .b(new_n51_), .c(new_n50_), .O(z03));
  inv1   g20(.a(x08), .O(new_n55_));
  nor2   g21(.a(x08), .b(x07), .O(new_n56_));
  nand2  g22(.a(x08), .b(x07), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(x06), .c(x04), .O(new_n58_));
  oai22  g24(.a(new_n58_), .b(new_n56_), .c(new_n55_), .d(x06), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(new_n47_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n50_), .O(z04));
  nor2   g27(.a(x09), .b(new_n55_), .O(new_n62_));
  aoi21  g28(.a(new_n62_), .b(x07), .c(new_n41_), .O(new_n63_));
  ...
  oai21  g35(.a(new_n69_), .b(new_n66_), .c(x04), .O(new_n70_));
  oai21  g36(.a(new_n63_), .b(new_n42_), .c(new_n70_), .O(z05));
  ...
  nand2  g42(.a(new_n47_), .b(new_n76_), .O(new_n77_));
  ...
  nand4  g50(.a(new_n62_), .b(new_n76_), .c(x07), .d(x06), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(x11), .c(new_n66_), .O(new_n86_));
