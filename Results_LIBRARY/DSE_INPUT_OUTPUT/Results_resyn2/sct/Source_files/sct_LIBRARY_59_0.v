...
module FAU ( 
  ...
  oai21  g31(.a(new_n37_), .b(x10), .c(new_n63_), .O(new_n66_));
  inv1   g32(.a(x10), .O(new_n67_));
  aoi21  g33(.a(new_n62_), .b(new_n67_), .c(new_n47_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n66_), .O(z06));
  ...
  nand4  g40(.a(new_n67_), .b(new_n74_), .c(x08), .d(x07), .O(new_n75_));
  aoi22  g41(.a(new_n75_), .b(x11), .c(new_n73_), .d(new_n72_), .O(new_n76_));
  nand2  g42(.a(x11), .b(new_n70_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n46_), .c(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n49_), .O(new_n79_));
  oai21  g45(.a(new_n76_), .b(new_n70_), .c(new_n79_), .O(z07));
  nand3  g46(.a(new_n73_), .b(new_n72_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand3  g48(.a(new_n74_), .b(x08), .c(x07), .O(new_n83_));
  inv1   g49(.a(new_n73_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(x06), .O(new_n86_));
  nor2   g52(.a(new_n82_), .b(x06), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n47_), .c(new_n49_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n86_), .O(z08));
  nand3  g55(.a(new_n73_), .b(new_n62_), .c(new_n82_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x13), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand3  g58(.a(new_n73_), .b(new_n92_), .c(new_n82_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n62_), .O(new_n95_));
  nand2  g61(.a(new_n47_), .b(new_n49_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n93_), .b(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n52_), .b(x02), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(x16), .c(new_n70_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(new_n72_), .O(new_n102_));
  nand3  g68(.a(new_n54_), .b(new_n49_), .c(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z10));
  nand2  g70(.a(new_n49_), .b(new_n36_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n36_), .c(x03), .O(new_n106_));
  nand2  g72(.a(new_n49_), .b(x04), .O(new_n107_));
  nor2   g73(.a(new_n107_), .b(new_n106_), .O(z12));
  nand2  g74(.a(new_n49_), .b(new_n43_), .O(z13));
