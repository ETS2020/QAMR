...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(new_n55_), .c(new_n54_), .O(z05));
  inv1   g22(.a(x10), .O(new_n57_));
  nand3  g23(.a(new_n49_), .b(new_n55_), .c(new_n57_), .O(z06));
  oai21  g24(.a(new_n47_), .b(x11), .c(new_n38_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z07));
  inv1   g26(.a(x12), .O(new_n61_));
  nand3  g27(.a(new_n49_), .b(new_n55_), .c(new_n61_), .O(z08));
  inv1   g28(.a(x13), .O(new_n63_));
  nand3  g29(.a(new_n49_), .b(new_n55_), .c(new_n63_), .O(z09));
  ...
  and2   g34(.a(new_n68_), .b(new_n49_), .O(z12));
  inv1   g35(.a(x17), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n38_), .c(new_n37_), .O(z14));
  buf    g37(.a(x04), .O(z13));
endmodule
