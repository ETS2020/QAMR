...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n64_, new_n66_, new_n70_, new_n73_;
  ...
  aoi21  g20(.a(new_n54_), .b(new_n43_), .c(new_n52_), .O(z03));
  nand2  g21(.a(new_n53_), .b(x08), .O(new_n56_));
  aoi21  g22(.a(new_n56_), .b(new_n43_), .c(new_n52_), .O(z04));
  oai21  g23(.a(new_n49_), .b(x09), .c(new_n43_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x04), .O(z05));
  oai21  g25(.a(new_n49_), .b(x10), .c(new_n43_), .O(new_n60_));
  ...
  nor3   g33(.a(new_n50_), .b(new_n53_), .c(new_n36_), .O(z10));
  aoi21  g34(.a(x06), .b(x04), .c(new_n38_), .O(z11));
  nand2  g35(.a(x16), .b(new_n38_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n47_), .c(new_n50_), .O(z12));
  inv1   g37(.a(new_n50_), .O(z13));
