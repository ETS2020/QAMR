...
module FAU ( 
  ...
  aoi21  g18(.a(x06), .b(x04), .c(x07), .O(new_n53_));
  inv1   g19(.a(x07), .O(new_n54_));
  oai21  g20(.a(x03), .b(new_n35_), .c(x16), .O(new_n55_));
  oai21  g21(.a(new_n54_), .b(new_n38_), .c(new_n55_), .O(new_n56_));
  oai21  g22(.a(new_n56_), .b(new_n53_), .c(new_n39_), .O(z03));
  inv1   g23(.a(x08), .O(new_n58_));
  nor2   g24(.a(x08), .b(x07), .O(new_n59_));
  nand2  g25(.a(x08), .b(x07), .O(new_n60_));
  nand3  g26(.a(new_n60_), .b(x06), .c(x04), .O(new_n61_));
  oai22  g27(.a(new_n61_), .b(new_n59_), .c(new_n58_), .d(x06), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n55_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(new_n39_), .O(z04));
  nor2   g30(.a(x09), .b(new_n58_), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(x07), .c(new_n37_), .O(new_n66_));
  inv1   g32(.a(x09), .O(new_n67_));
  inv1   g33(.a(new_n60_), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(x06), .c(new_n67_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n51_), .c(x04), .O(new_n70_));
  oai21  g36(.a(new_n66_), .b(new_n38_), .c(new_n70_), .O(z05));
  ...
  nand2  g42(.a(new_n55_), .b(new_n76_), .O(new_n77_));
  nand4  g43(.a(new_n67_), .b(x08), .c(x07), .d(x06), .O(new_n78_));
  nor2   g44(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  inv1   g45(.a(new_n79_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n77_), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n75_), .O(z06));
  oai21  g48(.a(new_n73_), .b(x11), .c(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  nand4  g50(.a(new_n65_), .b(new_n76_), .c(x07), .d(x06), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(x11), .c(new_n51_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n37_), .c(new_n84_), .O(z07));
  nor2   g53(.a(x12), .b(x11), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n72_), .c(new_n68_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  nand4  g58(.a(new_n72_), .b(new_n68_), .c(new_n92_), .d(x06), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x12), .c(new_n51_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n37_), .c(new_n91_), .O(z08));
  oai21  g61(.a(new_n89_), .b(new_n38_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand3  g63(.a(new_n88_), .b(new_n97_), .c(new_n76_), .O(new_n98_));
  or2    g64(.a(new_n98_), .b(new_n78_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n98_), .b(new_n101_), .O(new_n102_));
  nor2   g68(.a(new_n55_), .b(new_n41_), .O(new_n103_));
  aoi21  g69(.a(new_n102_), .b(new_n79_), .c(new_n103_), .O(new_n104_));
  ...
  oai21  g73(.a(new_n107_), .b(new_n37_), .c(new_n39_), .O(z12));
