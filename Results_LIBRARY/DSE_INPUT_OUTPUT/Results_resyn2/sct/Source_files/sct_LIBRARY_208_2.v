...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n87_, new_n88_, new_n89_, new_n92_, new_n94_, new_n95_;
  ...
  nand3  g28(.a(new_n62_), .b(new_n60_), .c(new_n52_), .O(z05));
  nand2  g29(.a(new_n62_), .b(x10), .O(new_n64_));
  inv1   g30(.a(x09), .O(new_n65_));
  inv1   g31(.a(x10), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n65_), .c(x08), .d(x07), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n52_), .O(z06));
  inv1   g34(.a(x02), .O(new_n69_));
  oai21  g35(.a(x03), .b(new_n69_), .c(x16), .O(new_n70_));
  nand2  g36(.a(new_n67_), .b(x11), .O(new_n71_));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n65_), .c(x08), .d(x07), .O(new_n73_));
  ...
  nand3  g43(.a(new_n72_), .b(new_n61_), .c(new_n77_), .O(new_n78_));
  nand2  g44(.a(new_n73_), .b(x12), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n52_), .O(z08));
  nand2  g46(.a(new_n78_), .b(x13), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n72_), .b(new_n61_), .c(new_n82_), .d(new_n77_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n52_), .O(z09));
  nand2  g50(.a(new_n50_), .b(x14), .O(new_n85_));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n72_), .b(new_n82_), .c(new_n77_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n61_), .c(new_n70_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n85_), .c(new_n51_), .O(z10));
  nor2   g56(.a(z02), .b(new_n69_), .O(z11));
  nand2  g57(.a(x16), .b(new_n69_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n48_), .c(new_n51_), .O(z12));
  inv1   g59(.a(x04), .O(new_n94_));
  inv1   g60(.a(x17), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x06), .c(new_n94_), .O(z14));
  buf    g62(.a(x04), .O(z13));
endmodule
