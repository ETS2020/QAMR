...
module FAU ( 
  ...
  oai21  g21(.a(new_n55_), .b(new_n51_), .c(new_n50_), .O(z03));
  nor2   g22(.a(new_n48_), .b(new_n40_), .O(new_n57_));
  ...
  aoi21  g32(.a(new_n58_), .b(x09), .c(new_n48_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(new_n40_), .c(new_n66_), .O(z05));
  inv1   g34(.a(new_n58_), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g37(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n57_), .O(z06));
  nor2   g40(.a(x11), .b(x10), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n63_), .c(x08), .d(x07), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x04), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x06), .O(new_n78_));
  aoi21  g44(.a(new_n71_), .b(x11), .c(new_n48_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n40_), .c(new_n78_), .O(z07));
  oai21  g46(.a(new_n76_), .b(x12), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nor3   g49(.a(x11), .b(x10), .c(x09), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n69_), .c(new_n83_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n48_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n82_), .O(z08));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n75_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n64_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand4  g57(.a(new_n75_), .b(new_n69_), .c(new_n83_), .d(new_n63_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x13), .c(new_n48_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n40_), .c(new_n91_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n89_), .b(new_n95_), .O(new_n96_));
  nor2   g62(.a(new_n72_), .b(new_n48_), .O(new_n97_));
  nor2   g63(.a(new_n53_), .b(new_n36_), .O(new_n98_));
  aoi21  g64(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n40_), .c(new_n50_), .O(z10));
  nor2   g66(.a(new_n37_), .b(new_n52_), .O(z11));
  nand2  g67(.a(x16), .b(new_n52_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n46_), .c(new_n40_), .O(z12));
  nor2   g69(.a(new_n41_), .b(x04), .O(new_n104_));
