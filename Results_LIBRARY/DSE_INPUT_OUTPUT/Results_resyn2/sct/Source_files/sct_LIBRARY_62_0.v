...
module FAU ( 
  ...
  aoi21  g13(.a(new_n47_), .b(x00), .c(x06), .O(z02));
  ...
  oai21  g22(.a(new_n56_), .b(new_n54_), .c(new_n55_), .O(new_n57_));
  nand2  g23(.a(x07), .b(x06), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(new_n57_), .c(new_n53_), .O(new_n59_));
  ...
  oai21  g30(.a(new_n64_), .b(new_n47_), .c(new_n38_), .O(z04));
  ...
  nand3  g50(.a(new_n84_), .b(new_n46_), .c(x04), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n83_), .c(new_n37_), .O(z07));
  ...
  aoi21  g62(.a(new_n96_), .b(new_n93_), .c(new_n37_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(x06), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n47_), .c(new_n38_), .O(new_n100_));
  ...
  nand3  g70(.a(new_n52_), .b(new_n38_), .c(x14), .O(new_n105_));
  nand3  g71(.a(new_n80_), .b(new_n98_), .c(new_n88_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n54_), .O(new_n107_));
  nor2   g73(.a(new_n52_), .b(new_n55_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n107_), .c(new_n94_), .d(new_n66_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n105_), .c(new_n49_), .O(z10));
  nor2   g76(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g77(.a(x16), .b(new_n35_), .c(x03), .O(new_n112_));
  nand2  g78(.a(new_n38_), .b(x04), .O(new_n113_));
