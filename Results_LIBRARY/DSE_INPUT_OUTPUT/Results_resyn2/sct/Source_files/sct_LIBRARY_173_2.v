...
module FAU ( 
  ...
  nor2   g30(.a(new_n60_), .b(x09), .O(new_n66_));
  inv1   g31(.a(new_n66_), .O(new_n67_));
  nand3  g32(.a(new_n67_), .b(new_n65_), .c(new_n59_), .O(z05));
  inv1   g33(.a(x10), .O(new_n69_));
  nand2  g34(.a(new_n66_), .b(new_n69_), .O(new_n70_));
  nand2  g35(.a(new_n67_), .b(x10), .O(new_n71_));
  nand3  g36(.a(new_n71_), .b(new_n70_), .c(new_n59_), .O(z06));
  nand2  g37(.a(new_n70_), .b(x11), .O(new_n73_));
  nor2   g38(.a(x11), .b(x10), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(new_n66_), .O(new_n75_));
  nand3  g40(.a(new_n75_), .b(new_n73_), .c(new_n59_), .O(z07));
  inv1   g41(.a(x12), .O(new_n77_));
  nand3  g42(.a(new_n74_), .b(new_n66_), .c(new_n77_), .O(new_n78_));
  nand2  g43(.a(new_n75_), .b(x12), .O(new_n79_));
  nand3  g44(.a(new_n79_), .b(new_n78_), .c(new_n59_), .O(z08));
  nand2  g45(.a(new_n78_), .b(x13), .O(new_n81_));
  inv1   g46(.a(x11), .O(new_n82_));
  inv1   g47(.a(x13), .O(new_n83_));
  nand4  g48(.a(new_n83_), .b(new_n77_), .c(new_n82_), .d(new_n69_), .O(new_n84_));
  inv1   g49(.a(new_n84_), .O(new_n85_));
  nand2  g50(.a(new_n85_), .b(new_n66_), .O(new_n86_));
  nand3  g51(.a(new_n86_), .b(new_n81_), .c(new_n59_), .O(z09));
  inv1   g52(.a(x00), .O(new_n88_));
  nand2  g53(.a(new_n84_), .b(new_n88_), .O(new_n89_));
  nand3  g54(.a(new_n89_), .b(new_n66_), .c(new_n53_), .O(new_n90_));
  nand2  g55(.a(new_n58_), .b(x14), .O(new_n91_));
  aoi21  g56(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(z10));
  nand2  g57(.a(new_n37_), .b(new_n52_), .O(z11));
  nand2  g58(.a(x16), .b(new_n52_), .O(new_n94_));
  nor2   g59(.a(new_n36_), .b(x03), .O(new_n95_));
  aoi21  g60(.a(new_n95_), .b(new_n94_), .c(new_n50_), .O(z12));
  inv1   g61(.a(x17), .O(new_n97_));
  aoi21  g62(.a(new_n97_), .b(x06), .c(new_n50_), .O(z14));
  zero   g63(.O(z02));
  buf    g64(.a(x04), .O(z13));
endmodule
