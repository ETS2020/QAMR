...
module FAU ( 
  ...
  nor2   g30(.a(new_n55_), .b(x09), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g32(.a(new_n62_), .b(x10), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n48_), .O(new_n68_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n54_), .O(z07));
  ...
  aoi21  g45(.a(new_n76_), .b(new_n65_), .c(new_n79_), .O(new_n80_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n65_), .c(new_n48_), .O(new_n88_));
