...
module FAU ( 
  ...
  nor2   g20(.a(x06), .b(new_n47_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(x08), .O(new_n56_));
  nor2   g22(.a(new_n56_), .b(new_n50_), .O(z04));
  inv1   g23(.a(x09), .O(new_n58_));
  nand3  g24(.a(new_n52_), .b(new_n55_), .c(new_n58_), .O(z05));
  oai21  g25(.a(new_n50_), .b(x10), .c(new_n40_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z06));
  inv1   g27(.a(x11), .O(new_n62_));
  nand3  g28(.a(new_n52_), .b(new_n55_), .c(new_n62_), .O(z07));
  inv1   g29(.a(x12), .O(new_n64_));
  nand3  g30(.a(new_n52_), .b(new_n55_), .c(new_n64_), .O(z08));
  oai21  g31(.a(new_n50_), .b(x13), .c(new_n40_), .O(new_n66_));
  ...
  nand2  g38(.a(new_n55_), .b(x17), .O(new_n73_));
