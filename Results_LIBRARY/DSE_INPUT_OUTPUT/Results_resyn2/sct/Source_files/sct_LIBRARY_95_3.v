...
module FAU ( 
  ...
  nor2   g19(.a(x06), .b(new_n49_), .O(new_n54_));
  ...
  aoi21  g24(.a(new_n58_), .b(new_n42_), .c(new_n49_), .O(z04));
  inv1   g25(.a(x09), .O(new_n60_));
  nand3  g26(.a(new_n57_), .b(new_n54_), .c(new_n60_), .O(z05));
  inv1   g27(.a(x10), .O(new_n62_));
  nand3  g28(.a(new_n57_), .b(new_n54_), .c(new_n62_), .O(z06));
  inv1   g29(.a(x11), .O(new_n64_));
  nand3  g30(.a(new_n57_), .b(new_n54_), .c(new_n64_), .O(z07));
  ...
  nor3   g35(.a(new_n57_), .b(new_n43_), .c(new_n39_), .O(z10));
  ...
  nand2  g39(.a(new_n54_), .b(x17), .O(new_n74_));
