...
module FAU ( 
  ...
  aoi21  g35(.a(new_n64_), .b(new_n69_), .c(new_n37_), .O(new_n70_));
  inv1   g36(.a(x09), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(x08), .c(x07), .d(x06), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(x10), .c(new_n48_), .O(new_n73_));
  oai22  g39(.a(new_n73_), .b(new_n37_), .c(new_n70_), .d(new_n38_), .O(z06));
  inv1   g40(.a(x11), .O(new_n75_));
  inv1   g41(.a(new_n72_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(new_n77_));
  ...
  nand3  g50(.a(new_n84_), .b(new_n80_), .c(new_n49_), .O(z08));
  nand3  g51(.a(new_n71_), .b(x08), .c(x07), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n75_), .d(new_n69_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n86_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  aoi21  g57(.a(new_n84_), .b(x13), .c(new_n48_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n37_), .c(new_n91_), .O(z09));
  nand2  g59(.a(new_n48_), .b(x14), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n89_), .b(new_n95_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n76_), .c(new_n53_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n94_), .c(new_n37_), .O(z10));
  aoi21  g64(.a(new_n38_), .b(new_n37_), .c(new_n35_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n35_), .c(x03), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n37_), .c(new_n39_), .O(z12));
