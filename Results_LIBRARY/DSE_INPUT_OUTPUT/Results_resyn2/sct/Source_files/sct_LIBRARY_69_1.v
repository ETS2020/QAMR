...
module FAU ( 
  ...
  oai21  g30(.a(x09), .b(new_n36_), .c(new_n58_), .O(new_n65_));
  inv1   g31(.a(x09), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n50_), .O(z06));
  oai21  g40(.a(new_n67_), .b(x10), .c(x11), .O(new_n75_));
  nor2   g41(.a(x11), .b(x10), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n72_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n50_), .O(z07));
  inv1   g44(.a(x12), .O(new_n79_));
  inv1   g45(.a(new_n53_), .O(new_n80_));
  nor2   g46(.a(x09), .b(new_n59_), .O(new_n81_));
  nand4  g47(.a(new_n76_), .b(new_n81_), .c(new_n80_), .d(new_n79_), .O(new_n82_));
  inv1   g48(.a(new_n76_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n67_), .c(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n82_), .c(new_n50_), .O(z08));
  nand2  g51(.a(new_n82_), .b(x13), .O(new_n86_));
  inv1   g52(.a(x11), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n79_), .c(new_n87_), .d(new_n71_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n72_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n86_), .c(new_n50_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n89_), .b(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n72_), .c(new_n64_), .O(new_n95_));
  nand2  g61(.a(new_n49_), .b(x14), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n95_), .c(new_n36_), .O(z10));
  nand2  g63(.a(new_n37_), .b(new_n63_), .O(z11));
  nand2  g64(.a(x16), .b(new_n63_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n47_), .c(new_n36_), .O(z12));
  nor2   g66(.a(x06), .b(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z13));
  inv1   g68(.a(x17), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(x04), .c(new_n101_), .O(z14));
endmodule
