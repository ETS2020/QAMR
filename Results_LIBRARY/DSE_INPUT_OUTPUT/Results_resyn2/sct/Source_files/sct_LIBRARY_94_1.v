...
module FAU ( 
  ...
  oai21  g28(.a(new_n62_), .b(new_n49_), .c(x09), .O(new_n63_));
  inv1   g29(.a(x09), .O(new_n64_));
  nand4  g30(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n65_));
  nor2   g31(.a(new_n48_), .b(new_n36_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(z05));
  oai21  g33(.a(x10), .b(new_n36_), .c(new_n49_), .O(new_n68_));
  inv1   g34(.a(x10), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n64_), .c(x08), .d(x07), .O(new_n70_));
  nor2   g36(.a(new_n70_), .b(new_n49_), .O(new_n71_));
  oai21  g37(.a(new_n62_), .b(x09), .c(x10), .O(new_n72_));
  ...
  oai21  g41(.a(x11), .b(new_n36_), .c(new_n49_), .O(new_n76_));
  ...
  nand2  g46(.a(new_n70_), .b(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n47_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n76_), .O(z07));
  inv1   g50(.a(x12), .O(new_n85_));
  nand3  g51(.a(new_n71_), .b(new_n85_), .c(new_n77_), .O(new_n86_));
  nand2  g52(.a(new_n80_), .b(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n66_), .O(z08));
  oai21  g54(.a(new_n80_), .b(x12), .c(x13), .O(new_n89_));
  inv1   g55(.a(new_n65_), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n85_), .c(new_n77_), .d(new_n69_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n89_), .c(new_n66_), .O(z09));
  nand2  g61(.a(new_n48_), .b(x14), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n92_), .b(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n90_), .c(new_n47_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n96_), .c(new_n36_), .O(z10));
  aoi21  g66(.a(x06), .b(new_n36_), .c(new_n46_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n46_), .c(x03), .O(new_n102_));
