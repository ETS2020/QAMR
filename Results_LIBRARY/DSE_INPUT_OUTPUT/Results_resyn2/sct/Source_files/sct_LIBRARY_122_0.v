...
module FAU ( 
  ...
  nand2  g22(.a(new_n56_), .b(new_n38_), .O(new_n57_));
  ...
  oai21  g37(.a(new_n71_), .b(new_n37_), .c(x06), .O(new_n72_));
  ...
  nand3  g49(.a(new_n80_), .b(new_n79_), .c(new_n83_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n82_), .c(new_n52_), .O(z07));
  nor2   g51(.a(x12), .b(x11), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n71_), .c(new_n37_), .O(new_n87_));
  aoi21  g53(.a(new_n84_), .b(x12), .c(new_n51_), .O(new_n88_));
  oai22  g54(.a(new_n88_), .b(new_n37_), .c(new_n87_), .d(new_n38_), .O(z08));
  nand3  g55(.a(new_n66_), .b(x08), .c(x07), .O(new_n90_));
  nor2   g56(.a(x13), .b(x10), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n86_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n90_), .c(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x06), .O(new_n94_));
  nand3  g60(.a(new_n86_), .b(new_n80_), .c(new_n79_), .O(new_n95_));
  ...
  nor2   g65(.a(new_n73_), .b(new_n41_), .O(new_n100_));
  aoi21  g66(.a(new_n99_), .b(new_n75_), .c(new_n100_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n37_), .c(new_n39_), .O(z10));
  nand2  g68(.a(new_n39_), .b(new_n35_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n35_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n37_), .c(new_n39_), .O(z12));
