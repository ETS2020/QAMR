...
module FAU ( 
  ...
  oai21  g20(.a(x08), .b(new_n54_), .c(new_n47_), .O(new_n55_));
  ...
  nand3  g25(.a(new_n59_), .b(new_n51_), .c(x06), .O(new_n60_));
  ...
  aoi21  g30(.a(x08), .b(x07), .c(new_n62_), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n51_), .c(new_n38_), .O(z05));
  oai21  g33(.a(x09), .b(new_n54_), .c(x10), .O(new_n68_));
  ...
  nand2  g38(.a(new_n50_), .b(new_n41_), .O(new_n73_));
  nand2  g39(.a(x10), .b(new_n37_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z06));
  oai22  g41(.a(new_n70_), .b(new_n47_), .c(new_n38_), .d(x11), .O(new_n76_));
  ...
  xor2a  g45(.a(new_n78_), .b(x12), .O(new_n80_));
  oai21  g46(.a(x12), .b(x08), .c(new_n47_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n51_), .O(z08));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n77_), .b(new_n83_), .c(new_n62_), .d(x07), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand3  g51(.a(new_n77_), .b(new_n85_), .c(new_n83_), .O(new_n86_));
  inv1   g52(.a(new_n86_), .O(new_n87_));
  aoi22  g53(.a(new_n87_), .b(new_n64_), .c(new_n84_), .d(x13), .O(new_n88_));
  aoi22  g54(.a(new_n50_), .b(new_n41_), .c(x13), .d(new_n37_), .O(new_n89_));
  oai21  g55(.a(new_n88_), .b(new_n47_), .c(new_n89_), .O(z09));
  ...
  aoi21  g61(.a(new_n95_), .b(x16), .c(new_n63_), .O(new_n96_));
  nor2   g62(.a(new_n49_), .b(new_n36_), .O(new_n97_));
  aoi21  g63(.a(new_n96_), .b(new_n93_), .c(new_n97_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n91_), .c(new_n41_), .O(z10));
  nor2   g65(.a(new_n38_), .b(new_n48_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n48_), .c(x03), .O(new_n101_));
