...
module FAU ( 
  ...
  nand3  g16(.a(new_n50_), .b(x14), .c(new_n46_), .O(new_n51_));
  ...
  oai21  g24(.a(new_n36_), .b(new_n58_), .c(new_n53_), .O(new_n59_));
  ...
  and2   g32(.a(new_n66_), .b(new_n40_), .O(z05));
  ...
  and2   g39(.a(new_n73_), .b(new_n40_), .O(z06));
  ...
  inv1   g43(.a(x02), .O(new_n78_));
  oai21  g44(.a(x03), .b(new_n78_), .c(x16), .O(new_n79_));
  nand2  g45(.a(x11), .b(new_n46_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n40_), .O(new_n82_));
  oai21  g48(.a(new_n77_), .b(new_n46_), .c(new_n82_), .O(z07));
  nand4  g49(.a(new_n76_), .b(new_n63_), .c(x08), .d(x07), .O(new_n84_));
  xor2a  g50(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g51(.a(x12), .b(new_n46_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n79_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n40_), .O(new_n88_));
  oai21  g54(.a(new_n85_), .b(new_n46_), .c(new_n88_), .O(z08));
  oai21  g55(.a(new_n84_), .b(x12), .c(x13), .O(new_n90_));
  ...
  oai21  g62(.a(new_n35_), .b(x13), .c(new_n46_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(new_n90_), .d(new_n50_), .O(z09));
  nand3  g64(.a(new_n49_), .b(x16), .c(x14), .O(new_n99_));
  inv1   g65(.a(x00), .O(new_n100_));
  nand2  g66(.a(new_n94_), .b(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n91_), .c(new_n79_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n99_), .c(new_n47_), .O(z10));
  nor2   g69(.a(new_n36_), .b(new_n78_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n78_), .c(x03), .O(new_n105_));
  nand2  g71(.a(new_n40_), .b(x04), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(new_n105_), .O(z12));
  nand2  g73(.a(new_n40_), .b(new_n47_), .O(z13));
