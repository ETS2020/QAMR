...
module FAU ( 
  ...
  nand2  g20(.a(new_n47_), .b(new_n54_), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z03));
  xor2a  g23(.a(new_n53_), .b(x08), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n50_), .c(new_n39_), .O(z04));
  ...
  nand2  g29(.a(new_n50_), .b(new_n39_), .O(new_n64_));
  ...
  aoi21  g37(.a(new_n66_), .b(x10), .c(new_n50_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n71_), .O(z06));
  ...
  oai21  g43(.a(new_n77_), .b(new_n75_), .c(x18), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x06), .O(new_n79_));
  oai21  g45(.a(new_n69_), .b(new_n47_), .c(x11), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n52_), .O(z07));
  nand2  g47(.a(new_n79_), .b(x12), .O(new_n82_));
  nor2   g48(.a(new_n75_), .b(new_n47_), .O(new_n83_));
  nor2   g49(.a(new_n77_), .b(x12), .O(new_n84_));
  aoi22  g50(.a(new_n84_), .b(new_n83_), .c(new_n50_), .d(new_n39_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n82_), .O(z08));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n76_), .d(new_n68_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n75_), .c(x18), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand2  g57(.a(new_n84_), .b(new_n83_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x13), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n52_), .O(z09));
  nor2   g60(.a(new_n38_), .b(x04), .O(new_n95_));
  inv1   g61(.a(x00), .O(new_n96_));
  nand2  g62(.a(new_n89_), .b(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n65_), .c(new_n49_), .d(x06), .O(new_n98_));
  ...
  nor3   g72(.a(new_n106_), .b(new_n38_), .c(new_n105_), .O(z12));
  inv1   g73(.a(new_n95_), .O(z13));
  inv1   g74(.a(x17), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n105_), .c(new_n39_), .O(z14));
endmodule
