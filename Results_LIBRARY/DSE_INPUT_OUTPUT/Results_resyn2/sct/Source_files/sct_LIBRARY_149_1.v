...
module FAU ( 
  ...
  nor2   g15(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  ...
  nand2  g21(.a(new_n53_), .b(new_n37_), .O(new_n56_));
  ...
  nand2  g36(.a(new_n68_), .b(x04), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n66_), .c(new_n49_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n70_), .c(new_n38_), .O(z06));
  inv1   g39(.a(x11), .O(new_n74_));
  nand4  g40(.a(new_n65_), .b(new_n54_), .c(new_n74_), .d(new_n68_), .O(new_n75_));
  oai21  g41(.a(new_n66_), .b(x10), .c(x11), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n50_), .O(z07));
  nand2  g43(.a(new_n75_), .b(x12), .O(new_n78_));
  nor2   g44(.a(x12), .b(x11), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n69_), .c(new_n68_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n50_), .O(z08));
  oai21  g47(.a(x13), .b(new_n47_), .c(new_n37_), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n74_), .O(new_n84_));
  inv1   g50(.a(x09), .O(new_n85_));
  nand4  g51(.a(new_n68_), .b(new_n85_), .c(x08), .d(x07), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n84_), .c(x13), .O(new_n87_));
  nor2   g53(.a(x13), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n79_), .c(new_n65_), .d(new_n54_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n87_), .c(new_n48_), .O(new_n90_));
  ...
  nand3  g62(.a(new_n96_), .b(new_n69_), .c(new_n48_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n93_), .c(new_n47_), .O(z10));
  nor2   g64(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n35_), .c(x03), .O(new_n100_));
  nor2   g66(.a(new_n100_), .b(new_n47_), .O(z12));
