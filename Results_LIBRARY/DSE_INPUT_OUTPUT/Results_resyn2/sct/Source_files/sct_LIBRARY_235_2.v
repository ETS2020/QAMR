...
module FAU ( 
  ...
  nor2   g34(.a(new_n58_), .b(x09), .O(new_n69_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n57_), .O(z08));
  inv1   g47(.a(x13), .O(new_n82_));
  aoi21  g48(.a(new_n79_), .b(new_n69_), .c(new_n82_), .O(new_n83_));
  nor2   g49(.a(x13), .b(x12), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n73_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n65_), .c(new_n50_), .O(new_n86_));
  ...
  nand3  g56(.a(new_n90_), .b(new_n69_), .c(new_n50_), .O(new_n91_));
  aoi21  g57(.a(new_n55_), .b(x14), .c(new_n36_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n47_), .O(z10));
  nor2   g59(.a(z02), .b(new_n49_), .O(z11));
  nand2  g60(.a(x16), .b(new_n49_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n53_), .c(new_n56_), .O(z12));
  inv1   g62(.a(new_n56_), .O(z13));
