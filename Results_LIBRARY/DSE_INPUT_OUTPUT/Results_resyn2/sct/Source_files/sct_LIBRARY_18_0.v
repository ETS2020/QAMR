...
module FAU ( 
  ...
  nor2   g17(.a(new_n51_), .b(new_n47_), .O(new_n52_));
  ...
  nand2  g29(.a(new_n63_), .b(new_n41_), .O(z04));
  ...
  nand4  g35(.a(new_n69_), .b(new_n66_), .c(new_n65_), .d(x04), .O(new_n70_));
  and2   g36(.a(new_n70_), .b(new_n41_), .O(z05));
  inv1   g37(.a(x10), .O(new_n72_));
  nor2   g38(.a(new_n62_), .b(x09), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g40(.a(new_n62_), .b(x09), .c(x10), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n65_), .c(x04), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(new_n74_), .c(new_n37_), .O(z06));
  oai21  g44(.a(new_n47_), .b(x11), .c(new_n55_), .O(new_n79_));
  nor3   g45(.a(x11), .b(x10), .c(x09), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n68_), .O(new_n81_));
  nand2  g47(.a(x08), .b(x07), .O(new_n82_));
  nand2  g48(.a(new_n72_), .b(new_n67_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n82_), .c(x11), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n79_), .d(new_n51_), .O(z07));
  nand3  g51(.a(new_n80_), .b(x08), .c(x07), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand3  g54(.a(new_n80_), .b(new_n68_), .c(new_n88_), .O(new_n89_));
  oai21  g55(.a(new_n47_), .b(x12), .c(new_n55_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n87_), .d(new_n51_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n80_), .b(new_n68_), .c(new_n92_), .d(new_n88_), .O(new_n93_));
  oai21  g59(.a(new_n37_), .b(x13), .c(new_n89_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n51_), .O(z09));
  ...
  nor2   g67(.a(new_n37_), .b(new_n101_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n65_), .c(x04), .O(new_n103_));
  aoi21  g69(.a(new_n100_), .b(new_n65_), .c(new_n103_), .O(z10));
  nor2   g70(.a(new_n37_), .b(new_n36_), .O(z11));
  nand2  g71(.a(x16), .b(new_n36_), .O(new_n106_));
  nor2   g72(.a(new_n37_), .b(x03), .O(new_n107_));
  aoi22  g73(.a(new_n107_), .b(new_n106_), .c(new_n41_), .d(new_n48_), .O(z12));
  nand2  g74(.a(new_n41_), .b(new_n48_), .O(z13));
  nor2   g75(.a(new_n47_), .b(new_n48_), .O(z14));
endmodule
