...
module FAU ( 
  ...
  nor2   g14(.a(new_n48_), .b(new_n38_), .O(new_n49_));
  nand2  g15(.a(new_n49_), .b(new_n39_), .O(new_n50_));
  ...
  nor3   g27(.a(x09), .b(new_n57_), .c(new_n53_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n38_), .c(x06), .O(new_n63_));
  oai21  g29(.a(x03), .b(new_n36_), .c(x16), .O(new_n64_));
  nand2  g30(.a(new_n59_), .b(x09), .O(new_n65_));
  ...
  nand2  g44(.a(new_n78_), .b(new_n73_), .O(z06));
  oai21  g45(.a(new_n71_), .b(new_n39_), .c(x11), .O(new_n80_));
  nand4  g46(.a(new_n69_), .b(x08), .c(x07), .d(x06), .O(new_n81_));
  inv1   g47(.a(new_n81_), .O(new_n82_));
  nor2   g48(.a(x11), .b(x10), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n80_), .c(new_n49_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n83_), .b(new_n76_), .c(new_n75_), .d(new_n86_), .O(new_n87_));
  inv1   g53(.a(new_n83_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n81_), .c(x12), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n87_), .c(new_n49_), .O(z08));
  nand2  g56(.a(new_n87_), .b(x13), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n86_), .c(new_n92_), .d(new_n70_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n82_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n91_), .c(new_n49_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n94_), .b(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n82_), .c(new_n64_), .O(new_n100_));
  nand2  g66(.a(new_n48_), .b(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n38_), .O(z10));
  nand2  g68(.a(new_n40_), .b(new_n36_), .O(z11));
