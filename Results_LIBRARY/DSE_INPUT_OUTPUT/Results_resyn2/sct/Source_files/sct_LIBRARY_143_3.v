...
module FAU ( 
  ...
  nor2   g17(.a(x06), .b(new_n41_), .O(new_n52_));
  ...
  aoi21  g23(.a(new_n57_), .b(new_n47_), .c(new_n41_), .O(z04));
  inv1   g24(.a(x09), .O(new_n59_));
  nand3  g25(.a(new_n56_), .b(new_n52_), .c(new_n59_), .O(z05));
  oai21  g26(.a(new_n50_), .b(x10), .c(new_n47_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z06));
  oai21  g28(.a(new_n50_), .b(x11), .c(new_n47_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z07));
  oai21  g30(.a(new_n50_), .b(x12), .c(new_n47_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(z08));
  inv1   g32(.a(x13), .O(new_n67_));
  nand3  g33(.a(new_n56_), .b(new_n52_), .c(new_n67_), .O(z09));
  nand2  g34(.a(new_n50_), .b(x14), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n47_), .c(new_n41_), .O(z10));
  nand2  g36(.a(new_n36_), .b(new_n55_), .O(z11));
  nand2  g37(.a(x16), .b(new_n55_), .O(new_n72_));
  nor2   g38(.a(x06), .b(x03), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n72_), .c(new_n41_), .O(z12));
  nand2  g40(.a(new_n52_), .b(x17), .O(new_n75_));
