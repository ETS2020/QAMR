...
module FAU ( 
  ...
  aoi21  g23(.a(x06), .b(new_n51_), .c(new_n49_), .O(new_n58_));
  nand2  g24(.a(new_n53_), .b(x08), .O(new_n59_));
  ...
  oai21  g34(.a(new_n68_), .b(new_n51_), .c(new_n67_), .O(z05));
  ...
  nand3  g40(.a(new_n74_), .b(new_n71_), .c(new_n52_), .O(z06));
  ...
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n52_), .O(z07));
  ...
  oai21  g51(.a(new_n85_), .b(new_n51_), .c(new_n84_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n77_), .b(new_n73_), .c(new_n87_), .d(new_n81_), .O(new_n88_));
  oai21  g54(.a(new_n78_), .b(x12), .c(x13), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n52_), .O(z09));
  inv1   g56(.a(new_n49_), .O(new_n91_));
  inv1   g57(.a(x00), .O(new_n92_));
  oai21  g58(.a(new_n82_), .b(x13), .c(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n73_), .c(new_n91_), .O(new_n94_));
  nand2  g60(.a(new_n49_), .b(x14), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n51_), .O(z10));
  nor2   g62(.a(new_n37_), .b(new_n36_), .O(z11));
  nand2  g63(.a(x16), .b(new_n36_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n47_), .c(new_n51_), .O(z12));
