...
module FAU ( 
  ...
  nand3  g24(.a(z13), .b(new_n55_), .c(new_n58_), .O(z05));
  inv1   g25(.a(x10), .O(new_n60_));
  nand3  g26(.a(z13), .b(new_n55_), .c(new_n60_), .O(z06));
  inv1   g27(.a(x11), .O(new_n62_));
  nand3  g28(.a(z13), .b(new_n55_), .c(new_n62_), .O(z07));
  oai21  g29(.a(new_n50_), .b(x12), .c(new_n43_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z08));
  inv1   g31(.a(x13), .O(new_n66_));
  nand3  g32(.a(z13), .b(new_n55_), .c(new_n66_), .O(z09));
