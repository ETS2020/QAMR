...
module FAU ( 
  ...
  oai21  g19(.a(new_n38_), .b(x04), .c(new_n53_), .O(new_n54_));
  xnor2a g20(.a(x07), .b(x06), .O(new_n55_));
  oai21  g21(.a(new_n55_), .b(new_n54_), .c(new_n39_), .O(z03));
  and2   g22(.a(x07), .b(x06), .O(new_n57_));
  xnor2a g23(.a(new_n57_), .b(x08), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n54_), .c(new_n39_), .O(z04));
  nor2   g25(.a(new_n51_), .b(new_n37_), .O(new_n60_));
  ...
  nand4  g33(.a(new_n57_), .b(new_n67_), .c(new_n63_), .d(x08), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n60_), .O(z06));
  nor2   g35(.a(x11), .b(x10), .O(new_n70_));
  nand3  g36(.a(new_n63_), .b(x08), .c(x07), .O(new_n71_));
  inv1   g37(.a(new_n71_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n70_), .c(new_n37_), .O(new_n73_));
  aoi21  g39(.a(new_n68_), .b(x11), .c(new_n51_), .O(new_n74_));
  oai22  g40(.a(new_n74_), .b(new_n37_), .c(new_n73_), .d(new_n38_), .O(z07));
  oai21  g41(.a(new_n68_), .b(x11), .c(x12), .O(new_n76_));
  inv1   g42(.a(new_n61_), .O(new_n77_));
  nor2   g43(.a(x12), .b(x09), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n70_), .c(new_n77_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n76_), .c(new_n60_), .O(z08));
  nor2   g46(.a(x13), .b(x12), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n71_), .c(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  aoi21  g50(.a(new_n79_), .b(x13), .c(new_n51_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n37_), .c(new_n84_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n82_), .b(new_n87_), .O(new_n88_));
  nor2   g54(.a(new_n64_), .b(new_n51_), .O(new_n89_));
  nor2   g55(.a(new_n53_), .b(new_n41_), .O(new_n90_));
  aoi21  g56(.a(new_n89_), .b(new_n88_), .c(new_n90_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n37_), .c(new_n39_), .O(z10));
  nand2  g58(.a(new_n39_), .b(new_n35_), .O(z11));
  aoi21  g59(.a(x16), .b(new_n35_), .c(x03), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n37_), .c(new_n39_), .O(z12));
