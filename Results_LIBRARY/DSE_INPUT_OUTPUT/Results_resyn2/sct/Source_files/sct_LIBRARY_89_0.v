...
module FAU ( 
  ...
  nor2   g43(.a(new_n69_), .b(new_n50_), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n74_), .O(z06));
  nand4  g47(.a(new_n57_), .b(new_n71_), .c(new_n68_), .d(x08), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(x11), .c(new_n50_), .O(new_n83_));
  oai21  g49(.a(new_n72_), .b(x11), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  oai21  g51(.a(new_n83_), .b(new_n36_), .c(new_n85_), .O(z07));
  ...
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n51_), .O(z08));
  nand3  g58(.a(new_n68_), .b(x08), .c(x07), .O(new_n93_));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n89_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n93_), .c(x04), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x06), .O(new_n97_));
  aoi21  g63(.a(new_n91_), .b(x13), .c(new_n50_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n36_), .c(new_n97_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand2  g66(.a(new_n95_), .b(new_n100_), .O(new_n101_));
  inv1   g67(.a(x14), .O(new_n102_));
  nor2   g68(.a(new_n76_), .b(new_n102_), .O(new_n103_));
  aoi21  g69(.a(new_n101_), .b(new_n78_), .c(new_n103_), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g71(.a(new_n38_), .b(new_n75_), .O(z11));
  nand2  g72(.a(x16), .b(new_n75_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n48_), .c(new_n36_), .O(z12));
  inv1   g74(.a(new_n54_), .O(z13));
  nor2   g75(.a(x17), .b(new_n36_), .O(new_n110_));
  nor2   g76(.a(new_n110_), .b(new_n54_), .O(z14));
endmodule
