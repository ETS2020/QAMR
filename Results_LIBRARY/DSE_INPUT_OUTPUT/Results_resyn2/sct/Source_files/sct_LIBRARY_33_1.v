...
module FAU ( 
  ...
  oai21  g20(.a(new_n37_), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n52_), .c(new_n49_), .O(new_n56_));
  ...
  nor2   g28(.a(new_n62_), .b(new_n48_), .O(z04));
  nor2   g29(.a(new_n61_), .b(x09), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n61_), .b(x09), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n65_), .c(new_n47_), .d(x04), .O(new_n67_));
  and2   g33(.a(new_n67_), .b(new_n58_), .O(z05));
  nand2  g34(.a(new_n65_), .b(x10), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  nand2  g36(.a(new_n64_), .b(new_n70_), .O(new_n71_));
  oai21  g37(.a(x10), .b(x06), .c(new_n53_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n69_), .d(new_n49_), .O(z06));
  nand2  g39(.a(new_n71_), .b(x11), .O(new_n74_));
  nor2   g40(.a(x11), .b(x10), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n64_), .O(new_n76_));
  oai21  g42(.a(x11), .b(x06), .c(new_n53_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n74_), .d(new_n49_), .O(z07));
  xor2a  g44(.a(new_n76_), .b(x12), .O(new_n79_));
  oai21  g45(.a(x12), .b(x06), .c(new_n53_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n49_), .O(z08));
  nor2   g47(.a(x12), .b(x09), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n75_), .c(x08), .d(x07), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n70_), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  aoi22  g54(.a(new_n88_), .b(new_n64_), .c(new_n83_), .d(x13), .O(new_n89_));
  nor2   g55(.a(new_n86_), .b(x06), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n48_), .c(new_n58_), .O(new_n91_));
  oai21  g57(.a(new_n89_), .b(new_n53_), .c(new_n91_), .O(z09));
  inv1   g58(.a(x03), .O(new_n93_));
  inv1   g59(.a(x16), .O(new_n94_));
  aoi21  g60(.a(new_n93_), .b(x02), .c(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n64_), .b(x00), .c(new_n95_), .O(new_n96_));
  inv1   g62(.a(x14), .O(new_n97_));
  oai21  g63(.a(new_n38_), .b(new_n97_), .c(new_n95_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x04), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(new_n96_), .O(z10));
  nor2   g66(.a(new_n38_), .b(new_n36_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n36_), .c(x03), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n44_), .c(new_n58_), .O(z12));
