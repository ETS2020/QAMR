...
module FAU ( 
  ...
  oai21  g20(.a(new_n42_), .b(x04), .c(new_n54_), .O(new_n55_));
  ...
  or2    g26(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n55_), .c(new_n53_), .O(z04));
  nand2  g28(.a(new_n58_), .b(x09), .O(new_n63_));
  inv1   g29(.a(x09), .O(new_n64_));
  nand2  g30(.a(new_n59_), .b(new_n64_), .O(new_n65_));
  ...
  aoi21  g36(.a(new_n65_), .b(x10), .c(new_n49_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n41_), .c(new_n70_), .O(z06));
  inv1   g38(.a(x11), .O(new_n73_));
  nand4  g39(.a(new_n67_), .b(new_n73_), .c(x08), .d(x07), .O(new_n74_));
  ...
  nand3  g54(.a(new_n82_), .b(new_n88_), .c(new_n80_), .O(new_n89_));
  ...
  nand3  g61(.a(new_n95_), .b(new_n81_), .c(new_n54_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n93_), .c(new_n41_), .O(z10));
