...
module FAU ( 
  ...
  oai21  g06(.a(x06), .b(x05), .c(new_n38_), .O(new_n41_));
  ...
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(z05));
  oai21  g32(.a(x10), .b(new_n38_), .c(new_n45_), .O(new_n67_));
  ...
  nand2  g40(.a(new_n74_), .b(new_n67_), .O(z06));
  oai21  g41(.a(x11), .b(new_n38_), .c(new_n45_), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  nand3  g43(.a(new_n71_), .b(new_n63_), .c(new_n77_), .O(new_n78_));
  nand3  g44(.a(new_n71_), .b(x08), .c(x07), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x11), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n68_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n76_), .O(z07));
  oai21  g49(.a(x12), .b(new_n38_), .c(new_n45_), .O(new_n84_));
  nand2  g50(.a(x08), .b(x07), .O(new_n85_));
  inv1   g51(.a(x10), .O(new_n86_));
  nand3  g52(.a(new_n77_), .b(new_n86_), .c(new_n62_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n85_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n71_), .b(new_n63_), .c(new_n89_), .d(new_n77_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n88_), .c(new_n68_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n89_), .c(new_n77_), .d(new_n86_), .O(new_n96_));
  or2    g62(.a(new_n96_), .b(new_n64_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n94_), .c(new_n49_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n96_), .b(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n46_), .b(x02), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(x16), .c(new_n69_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n38_), .O(new_n103_));
  nand3  g69(.a(new_n48_), .b(x14), .c(x04), .O(new_n104_));
  oai21  g70(.a(new_n103_), .b(new_n45_), .c(new_n104_), .O(z10));
  nand2  g71(.a(new_n39_), .b(new_n36_), .O(z11));
  nand2  g72(.a(x16), .b(new_n36_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n46_), .c(new_n38_), .O(z12));
