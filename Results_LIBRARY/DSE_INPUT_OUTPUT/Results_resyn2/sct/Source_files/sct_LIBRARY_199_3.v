...
module FAU ( 
  ...
  oai21  g24(.a(new_n51_), .b(x09), .c(new_n42_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z05));
  oai21  g26(.a(new_n51_), .b(x10), .c(new_n42_), .O(new_n61_));
  ...
  nand2  g31(.a(z02), .b(new_n65_), .O(z08));
  ...
  aoi21  g39(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z12));
  inv1   g40(.a(x17), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n42_), .c(new_n71_), .O(z14));
  buf    g42(.a(x04), .O(z13));
endmodule
