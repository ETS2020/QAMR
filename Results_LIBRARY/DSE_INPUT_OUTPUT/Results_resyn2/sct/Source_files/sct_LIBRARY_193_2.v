...
module FAU ( 
  ...
  nand3  g28(.a(new_n62_), .b(new_n60_), .c(new_n54_), .O(new_n63_));
  ...
  nor2   g33(.a(new_n55_), .b(x09), .O(new_n68_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n54_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x06), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(z07));
  inv1   g42(.a(x12), .O(new_n77_));
  aoi21  g43(.a(new_n72_), .b(new_n68_), .c(new_n77_), .O(new_n78_));
  ...
  nand3  g56(.a(new_n90_), .b(new_n68_), .c(new_n54_), .O(new_n91_));
  nand2  g57(.a(new_n50_), .b(x14), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n44_), .O(z10));
  nor2   g59(.a(z02), .b(new_n35_), .O(z11));
  nand2  g60(.a(x16), .b(new_n35_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n48_), .c(new_n44_), .O(z12));
