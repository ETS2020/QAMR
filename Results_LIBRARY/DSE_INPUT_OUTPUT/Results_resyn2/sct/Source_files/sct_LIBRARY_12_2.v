...
module FAU ( 
  ...
  inv1   g18(.a(x12), .O(new_n53_));
  oai21  g19(.a(new_n53_), .b(new_n37_), .c(new_n52_), .O(new_n54_));
  ...
  oai21  g31(.a(new_n65_), .b(new_n53_), .c(x06), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x09), .O(new_n67_));
  nand2  g33(.a(new_n48_), .b(new_n58_), .O(new_n68_));
  nor2   g34(.a(new_n64_), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(x12), .c(x06), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n67_), .O(z05));
  ...
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n49_), .O(z06));
  oai21  g43(.a(new_n73_), .b(x11), .c(x12), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x06), .O(new_n79_));
  oai21  g45(.a(new_n70_), .b(x10), .c(x11), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n49_), .O(z07));
  inv1   g47(.a(x11), .O(new_n82_));
  nand2  g48(.a(new_n72_), .b(new_n82_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n59_), .c(x12), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n68_), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nor2   g52(.a(new_n38_), .b(new_n44_), .O(z13));
  nand3  g53(.a(z13), .b(new_n47_), .c(new_n86_), .O(z09));
  inv1   g54(.a(x03), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x02), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(x16), .c(x14), .O(new_n91_));
  and2   g57(.a(x06), .b(x00), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n69_), .c(new_n47_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n58_), .O(z10));
  nor2   g62(.a(new_n38_), .b(new_n36_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n36_), .c(x03), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n44_), .c(new_n58_), .O(z12));
