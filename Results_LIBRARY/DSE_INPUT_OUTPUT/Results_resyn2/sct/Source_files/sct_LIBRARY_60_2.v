...
module FAU ( 
  ...
  nor2   g34(.a(new_n58_), .b(x09), .O(new_n70_));
  nand2  g35(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g36(.a(new_n65_), .b(x10), .O(new_n72_));
  nand3  g37(.a(new_n72_), .b(new_n71_), .c(new_n52_), .O(z06));
  nand2  g38(.a(new_n71_), .b(x11), .O(new_n74_));
  nor2   g39(.a(x11), .b(x10), .O(new_n75_));
  nand2  g40(.a(new_n75_), .b(new_n70_), .O(new_n76_));
  nand3  g41(.a(new_n76_), .b(new_n74_), .c(new_n52_), .O(z07));
  inv1   g42(.a(x11), .O(new_n78_));
  nand2  g43(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  oai21  g44(.a(new_n79_), .b(new_n65_), .c(x12), .O(new_n80_));
  nor3   g45(.a(x12), .b(x11), .c(x10), .O(new_n81_));
  nand2  g46(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  nand3  g47(.a(new_n82_), .b(new_n80_), .c(new_n57_), .O(new_n83_));
  nand2  g48(.a(new_n83_), .b(x06), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(x04), .O(z08));
  inv1   g50(.a(x13), .O(new_n86_));
  aoi21  g51(.a(new_n81_), .b(new_n70_), .c(new_n86_), .O(new_n87_));
  nor2   g52(.a(x13), .b(x12), .O(new_n88_));
  nand2  g53(.a(new_n88_), .b(new_n75_), .O(new_n89_));
  oai21  g54(.a(new_n89_), .b(new_n65_), .c(new_n57_), .O(new_n90_));
  oai21  g55(.a(new_n90_), .b(new_n87_), .c(x06), .O(new_n91_));
  nand2  g56(.a(new_n91_), .b(x04), .O(z09));
  inv1   g57(.a(x00), .O(new_n93_));
  nand2  g58(.a(new_n89_), .b(new_n93_), .O(new_n94_));
  nand3  g59(.a(new_n94_), .b(new_n70_), .c(new_n57_), .O(new_n95_));
  aoi21  g60(.a(new_n50_), .b(x14), .c(new_n38_), .O(new_n96_));
  aoi21  g61(.a(new_n96_), .b(new_n95_), .c(new_n55_), .O(z10));
  nand2  g62(.a(new_n39_), .b(new_n56_), .O(z11));
  nand2  g63(.a(x16), .b(new_n56_), .O(new_n99_));
  aoi21  g64(.a(new_n99_), .b(new_n48_), .c(new_n51_), .O(z12));
  inv1   g65(.a(new_n51_), .O(z13));
  inv1   g66(.a(x17), .O(new_n102_));
  aoi21  g67(.a(new_n102_), .b(x06), .c(new_n55_), .O(z14));
  zero   g68(.O(z02));
endmodule
