...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n107_, new_n110_, new_n112_, new_n114_;
  ...
  nand2  g37(.a(new_n69_), .b(x04), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n67_), .c(new_n50_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n71_), .c(new_n38_), .O(z06));
  oai21  g40(.a(x11), .b(new_n47_), .c(new_n37_), .O(new_n75_));
  inv1   g41(.a(new_n50_), .O(new_n76_));
  nand3  g42(.a(new_n65_), .b(x08), .c(x07), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(x10), .c(x11), .O(new_n78_));
  nor2   g44(.a(x09), .b(new_n60_), .O(new_n79_));
  nor2   g45(.a(x11), .b(x10), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n66_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n76_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n75_), .O(z07));
  oai21  g50(.a(x12), .b(new_n47_), .c(new_n37_), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n69_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n77_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(new_n59_), .O(new_n90_));
  nand4  g56(.a(new_n80_), .b(new_n90_), .c(new_n89_), .d(new_n65_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n88_), .c(new_n76_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n85_), .O(z08));
  oai21  g60(.a(x13), .b(new_n47_), .c(new_n37_), .O(new_n95_));
  nand3  g61(.a(new_n89_), .b(new_n86_), .c(new_n69_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n77_), .c(x13), .O(new_n97_));
  nor2   g63(.a(x13), .b(x12), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n80_), .c(new_n79_), .d(new_n66_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n76_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n95_), .O(z09));
  nand2  g68(.a(new_n50_), .b(x14), .O(new_n103_));
  inv1   g69(.a(x00), .O(new_n104_));
  nand2  g70(.a(new_n98_), .b(new_n80_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n70_), .c(new_n76_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n103_), .c(new_n47_), .O(z10));
  nand2  g74(.a(new_n39_), .b(new_n35_), .O(z11));
  aoi21  g75(.a(x16), .b(new_n35_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n47_), .c(new_n39_), .O(z12));
  nor2   g77(.a(x06), .b(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z13));
  inv1   g79(.a(x17), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(x04), .c(new_n112_), .O(z14));
endmodule
