...
module FAU ( 
  ...
  nor2   g18(.a(new_n52_), .b(x05), .O(new_n53_));
  nor2   g19(.a(new_n53_), .b(x06), .O(z02));
  nand2  g20(.a(x07), .b(x06), .O(new_n55_));
  inv1   g21(.a(x07), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  ...
  oai21  g32(.a(new_n38_), .b(x09), .c(new_n60_), .O(new_n67_));
  ...
  oai21  g39(.a(x10), .b(x05), .c(new_n44_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n73_), .c(new_n70_), .d(new_n52_), .O(z06));
  ...
  nand2  g49(.a(x11), .b(new_n44_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(x04), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n82_), .c(new_n38_), .O(z07));
  ...
  oai21  g57(.a(x12), .b(x05), .c(new_n44_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n89_), .d(new_n52_), .O(z08));
  nand2  g59(.a(new_n90_), .b(x06), .O(new_n94_));
  oai22  g60(.a(new_n94_), .b(new_n88_), .c(new_n38_), .d(x13), .O(new_n95_));
  ...
  nand3  g65(.a(new_n99_), .b(new_n95_), .c(new_n52_), .O(z09));
  ...
  nand3  g69(.a(new_n51_), .b(new_n39_), .c(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n48_), .O(z10));
  nand2  g71(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g72(.a(x16), .b(new_n35_), .O(new_n107_));
  nor2   g73(.a(new_n38_), .b(x03), .O(new_n108_));
  aoi22  g74(.a(new_n108_), .b(new_n107_), .c(new_n39_), .d(new_n48_), .O(z12));
  nand2  g75(.a(new_n39_), .b(new_n48_), .O(z13));
