...
module FAU ( 
  ...
  nor2   g06(.a(x06), .b(new_n35_), .O(new_n41_));
  ...
  nand3  g16(.a(new_n50_), .b(new_n46_), .c(new_n35_), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(z02));
  nand2  g18(.a(new_n49_), .b(x16), .O(new_n53_));
  ...
  oai21  g24(.a(new_n58_), .b(new_n54_), .c(new_n42_), .O(z03));
  ...
  nor3   g29(.a(new_n63_), .b(new_n54_), .c(new_n41_), .O(z04));
  ...
  and2   g34(.a(new_n68_), .b(new_n42_), .O(z05));
  inv1   g35(.a(x10), .O(new_n70_));
  nand2  g36(.a(new_n65_), .b(new_n70_), .O(new_n71_));
  oai21  g37(.a(new_n41_), .b(x10), .c(new_n66_), .O(new_n72_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n75_), .c(new_n50_), .O(new_n80_));
  and2   g46(.a(new_n80_), .b(new_n42_), .O(z07));
  nand2  g47(.a(new_n75_), .b(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand3  g49(.a(new_n74_), .b(new_n65_), .c(new_n83_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n50_), .d(new_n42_), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x06), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n54_), .c(new_n42_), .O(new_n88_));
  ...
  nand4  g60(.a(new_n49_), .b(new_n42_), .c(x16), .d(x14), .O(new_n95_));
  inv1   g61(.a(x00), .O(new_n96_));
  nand3  g62(.a(new_n74_), .b(new_n86_), .c(new_n83_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n91_), .c(new_n53_), .d(x06), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n95_), .c(new_n47_), .O(z10));
  nor2   g66(.a(new_n41_), .b(new_n36_), .O(z11));
  nand2  g67(.a(new_n42_), .b(x04), .O(new_n102_));
  aoi21  g68(.a(x16), .b(new_n36_), .c(x03), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n102_), .O(z12));
  inv1   g70(.a(new_n102_), .O(z13));
  inv1   g71(.a(x17), .O(new_n106_));
  nor2   g72(.a(new_n102_), .b(new_n106_), .O(z14));
endmodule
