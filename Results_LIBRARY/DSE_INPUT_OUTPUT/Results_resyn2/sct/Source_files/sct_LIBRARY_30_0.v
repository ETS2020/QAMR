...
module FAU ( 
  ...
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n52_), .O(z06));
  ...
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n52_), .O(z08));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n48_), .O(z10));
  nor2   g61(.a(new_n37_), .b(new_n36_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n36_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n48_), .c(new_n41_), .O(z12));
  nor2   g64(.a(new_n47_), .b(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z13));
  nor2   g66(.a(x17), .b(new_n48_), .O(new_n101_));
