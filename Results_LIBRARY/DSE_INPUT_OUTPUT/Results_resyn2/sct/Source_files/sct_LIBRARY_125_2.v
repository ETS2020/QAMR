...
module FAU ( 
  ...
  oai21  g21(.a(new_n55_), .b(new_n48_), .c(new_n39_), .O(z04));
  ...
  nor3   g30(.a(new_n58_), .b(new_n57_), .c(x09), .O(new_n65_));
  ...
  oai21  g35(.a(new_n65_), .b(new_n64_), .c(new_n69_), .O(z06));
  nand2  g36(.a(new_n68_), .b(x06), .O(new_n71_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(z07));
  nand4  g42(.a(new_n66_), .b(new_n74_), .c(x08), .d(x07), .O(new_n77_));
  ...
  aoi22  g47(.a(new_n81_), .b(new_n65_), .c(new_n48_), .d(new_n39_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n80_), .O(z08));
  nand3  g49(.a(new_n81_), .b(new_n61_), .c(x06), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x13), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n73_), .O(z09));
  inv1   g52(.a(x04), .O(new_n87_));
  nand3  g53(.a(x13), .b(x06), .c(x00), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n61_), .c(new_n47_), .O(new_n90_));
  inv1   g56(.a(new_n47_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n39_), .c(x14), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n90_), .c(new_n87_), .O(z10));
  nor2   g59(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g60(.a(x16), .b(new_n35_), .c(x03), .O(new_n95_));
  nor3   g61(.a(new_n95_), .b(new_n38_), .c(new_n87_), .O(z12));
  nand2  g62(.a(new_n39_), .b(new_n87_), .O(z13));
  inv1   g63(.a(x17), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n87_), .c(new_n39_), .O(z14));
endmodule
