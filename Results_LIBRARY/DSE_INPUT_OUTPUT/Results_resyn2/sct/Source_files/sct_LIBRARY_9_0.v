...
module FAU ( 
  ...
  nor2   g16(.a(new_n37_), .b(x04), .O(new_n51_));
  nor2   g17(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  ...
  nor2   g32(.a(new_n49_), .b(new_n36_), .O(new_n67_));
  ...
  nor2   g41(.a(new_n66_), .b(new_n49_), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n72_), .O(z06));
  oai21  g45(.a(new_n70_), .b(x11), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand4  g47(.a(new_n54_), .b(new_n69_), .c(new_n65_), .d(x08), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(x11), .c(new_n49_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n36_), .c(new_n81_), .O(z07));
  inv1   g50(.a(x11), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  inv1   g52(.a(new_n66_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n69_), .O(new_n88_));
  oai21  g54(.a(new_n82_), .b(x11), .c(x12), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n67_), .O(z08));
  nand2  g56(.a(new_n88_), .b(x13), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n86_), .c(new_n85_), .d(new_n69_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n87_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n91_), .c(new_n67_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n93_), .b(new_n97_), .O(new_n98_));
  inv1   g64(.a(x14), .O(new_n99_));
  nor2   g65(.a(new_n74_), .b(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n98_), .b(new_n76_), .c(new_n100_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g68(.a(new_n38_), .b(new_n73_), .O(z11));
  nand2  g69(.a(x16), .b(new_n73_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n47_), .c(new_n36_), .O(z12));
  nor2   g71(.a(x17), .b(new_n36_), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(new_n51_), .O(z14));
  buf    g73(.a(x04), .O(z13));
endmodule
