...
module FAU ( 
  ...
  nor2   g24(.a(new_n58_), .b(new_n44_), .O(new_n59_));
  ...
  nor2   g30(.a(new_n61_), .b(new_n64_), .O(new_n65_));
  inv1   g31(.a(x09), .O(new_n66_));
  nand4  g32(.a(new_n64_), .b(new_n66_), .c(x08), .d(x07), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n48_), .O(new_n68_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n59_), .O(z08));
  ...
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n59_), .O(z09));
  ...
  aoi21  g55(.a(new_n58_), .b(x14), .c(new_n89_), .O(new_n90_));
  ...
  aoi21  g59(.a(new_n93_), .b(new_n56_), .c(new_n44_), .O(z12));
