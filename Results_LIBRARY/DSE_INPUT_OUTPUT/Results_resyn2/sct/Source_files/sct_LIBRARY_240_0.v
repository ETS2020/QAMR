...
module FAU ( 
  ...
  nand4  g20(.a(new_n54_), .b(new_n52_), .c(new_n51_), .d(x04), .O(new_n55_));
  inv1   g21(.a(new_n55_), .O(z03));
  nand2  g22(.a(x06), .b(new_n37_), .O(z13));
  inv1   g23(.a(x08), .O(new_n58_));
  nand2  g24(.a(new_n52_), .b(new_n58_), .O(new_n59_));
  nand3  g25(.a(x08), .b(x07), .c(x06), .O(new_n60_));
  nand4  g26(.a(new_n60_), .b(new_n59_), .c(z13), .d(new_n51_), .O(new_n61_));
  ...
  oai21  g34(.a(new_n68_), .b(new_n37_), .c(new_n66_), .O(z05));
  ...
  nor2   g39(.a(new_n67_), .b(x09), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nand2  g41(.a(new_n51_), .b(new_n70_), .O(new_n76_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n49_), .c(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n80_), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n81_), .c(new_n70_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n64_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  nor2   g56(.a(x11), .b(x10), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n82_), .c(new_n63_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x12), .c(new_n49_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n37_), .c(new_n90_), .O(z08));
  oai21  g60(.a(new_n92_), .b(x12), .c(x13), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand3  g62(.a(new_n91_), .b(new_n96_), .c(new_n87_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n74_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n95_), .c(new_n51_), .d(x04), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n97_), .b(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n74_), .c(new_n51_), .O(new_n103_));
  nand2  g69(.a(new_n49_), .b(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n37_), .O(z10));
  aoi21  g71(.a(new_n38_), .b(new_n37_), .c(new_n35_), .O(z11));
  nand2  g72(.a(x16), .b(new_n35_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n47_), .c(new_n37_), .O(z12));
  nor2   g74(.a(x17), .b(new_n37_), .O(new_n109_));
  aoi21  g75(.a(x06), .b(new_n37_), .c(new_n109_), .O(z14));
endmodule
