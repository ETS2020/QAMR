...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    new_n43_, new_n45_, new_n46_, new_n47_, new_n50_, new_n52_, new_n53_,
  ...
  aoi21  g19(.a(new_n53_), .b(new_n38_), .c(new_n37_), .O(z04));
  oai21  g20(.a(new_n47_), .b(x09), .c(new_n38_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(x04), .O(z05));
  inv1   g22(.a(x10), .O(new_n57_));
  nand3  g23(.a(z13), .b(new_n52_), .c(new_n57_), .O(z06));
  inv1   g24(.a(x11), .O(new_n59_));
  nand3  g25(.a(z13), .b(new_n52_), .c(new_n59_), .O(z07));
  oai21  g26(.a(new_n47_), .b(x12), .c(new_n38_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z08));
  inv1   g28(.a(x13), .O(new_n63_));
  nand3  g29(.a(z13), .b(new_n52_), .c(new_n63_), .O(z09));
  nand2  g30(.a(z13), .b(x14), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n52_), .O(z10));
