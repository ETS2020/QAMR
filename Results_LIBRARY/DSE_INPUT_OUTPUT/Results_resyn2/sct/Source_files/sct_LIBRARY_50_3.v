...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n63_, new_n65_, new_n66_, new_n68_, new_n72_, new_n74_;
  ...
  nor2   g23(.a(new_n57_), .b(new_n52_), .O(z04));
  oai21  g24(.a(new_n52_), .b(x09), .c(new_n42_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z05));
  oai21  g26(.a(new_n52_), .b(x10), .c(new_n42_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z06));
  oai21  g28(.a(new_n52_), .b(x11), .c(new_n42_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z07));
  inv1   g30(.a(x12), .O(new_n65_));
  oai21  g31(.a(x03), .b(new_n35_), .c(x16), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n54_), .c(new_n65_), .O(z08));
  oai21  g33(.a(new_n52_), .b(x13), .c(new_n42_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x04), .O(z09));
  nor3   g35(.a(new_n66_), .b(new_n43_), .c(new_n39_), .O(z10));
