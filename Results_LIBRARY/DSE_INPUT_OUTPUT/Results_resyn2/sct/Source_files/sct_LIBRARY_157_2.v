...
module FAU ( 
  ...
  nand3  g01(.a(x04), .b(new_n35_), .c(x01), .O(new_n36_));
  ...
  nand2  g15(.a(new_n49_), .b(new_n41_), .O(z02));
  ...
  nor2   g31(.a(x04), .b(x01), .O(new_n66_));
  inv1   g32(.a(new_n66_), .O(z13));
  nand2  g33(.a(new_n64_), .b(x10), .O(new_n68_));
  inv1   g34(.a(x10), .O(new_n69_));
  nor2   g35(.a(x09), .b(new_n58_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n52_), .c(new_n69_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n68_), .c(new_n46_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x04), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(z13), .O(z06));
  ...
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n48_), .O(z07));
  inv1   g45(.a(x11), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n69_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n64_), .c(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  inv1   g49(.a(new_n57_), .O(new_n84_));
  nand4  g50(.a(new_n77_), .b(new_n84_), .c(new_n83_), .d(new_n63_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n82_), .c(new_n46_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(z13), .O(z08));
  nand4  g54(.a(new_n83_), .b(new_n80_), .c(new_n69_), .d(new_n63_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n57_), .c(x13), .O(new_n90_));
  nor2   g56(.a(x13), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n77_), .c(new_n70_), .d(new_n52_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n90_), .c(new_n46_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(z13), .O(z09));
  nand2  g61(.a(new_n47_), .b(x14), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n91_), .b(new_n77_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n76_), .c(new_n46_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n96_), .c(new_n40_), .O(z10));
  aoi21  g67(.a(new_n40_), .b(x01), .c(new_n35_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n35_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n40_), .c(new_n41_), .O(z12));
  inv1   g70(.a(x17), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x04), .c(new_n66_), .O(z14));
endmodule
