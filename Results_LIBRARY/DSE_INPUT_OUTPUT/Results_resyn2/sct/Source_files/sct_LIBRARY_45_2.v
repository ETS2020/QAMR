...
module FAU ( 
  ...
  nand3  g19(.a(x17), .b(new_n53_), .c(x02), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(x16), .c(new_n43_), .O(new_n55_));
  ...
  nand4  g30(.a(new_n64_), .b(new_n62_), .c(new_n48_), .d(x04), .O(new_n65_));
  and2   g31(.a(new_n65_), .b(new_n46_), .O(z05));
  nor3   g32(.a(new_n56_), .b(x10), .c(x09), .O(new_n67_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n79_), .c(new_n38_), .O(z09));
  inv1   g50(.a(x00), .O(new_n85_));
  nand2  g51(.a(new_n81_), .b(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n53_), .b(x02), .c(new_n37_), .O(new_n87_));
  nor2   g53(.a(new_n64_), .b(new_n87_), .O(new_n88_));
  nor2   g54(.a(new_n48_), .b(new_n36_), .O(new_n89_));
  aoi21  g55(.a(new_n88_), .b(new_n86_), .c(new_n89_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n43_), .c(new_n46_), .O(z10));
  nor2   g57(.a(new_n38_), .b(new_n47_), .O(z11));
  aoi21  g58(.a(x16), .b(new_n47_), .c(x03), .O(new_n93_));
  nor3   g59(.a(new_n93_), .b(new_n38_), .c(new_n43_), .O(z12));
