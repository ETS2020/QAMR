...
module FAU ( 
  ...
  oai21  g23(.a(new_n37_), .b(new_n57_), .c(new_n50_), .O(new_n58_));
  nand3  g24(.a(x08), .b(x07), .c(x06), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(new_n58_), .c(new_n56_), .O(new_n60_));
  ...
  aoi21  g30(.a(new_n62_), .b(x09), .c(new_n51_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n56_), .O(z05));
  inv1   g32(.a(x10), .O(new_n67_));
  inv1   g33(.a(new_n62_), .O(new_n68_));
  nand2  g34(.a(new_n63_), .b(new_n67_), .O(new_n69_));
  oai21  g35(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x06), .O(new_n71_));
  nand2  g37(.a(new_n48_), .b(new_n41_), .O(new_n72_));
  nand2  g38(.a(x10), .b(x09), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z06));
  nand2  g40(.a(new_n69_), .b(x11), .O(new_n75_));
  inv1   g41(.a(x09), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n68_), .c(new_n76_), .O(new_n78_));
  oai21  g44(.a(x11), .b(new_n76_), .c(new_n51_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n78_), .c(new_n75_), .d(new_n56_), .O(z07));
  nand3  g46(.a(new_n77_), .b(x08), .c(x07), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x12), .O(new_n82_));
  oai21  g48(.a(new_n78_), .b(x12), .c(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  aoi22  g50(.a(new_n48_), .b(new_n41_), .c(x12), .d(x09), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n84_), .O(z08));
  oai21  g52(.a(new_n78_), .b(x12), .c(x13), .O(new_n87_));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n77_), .c(new_n68_), .d(new_n76_), .O(new_n89_));
  oai21  g55(.a(x13), .b(new_n76_), .c(new_n51_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n87_), .d(new_n56_), .O(z09));
  aoi21  g57(.a(new_n88_), .b(new_n77_), .c(x00), .O(new_n92_));
  nand2  g58(.a(new_n63_), .b(new_n47_), .O(new_n93_));
  ...
  nand2  g64(.a(new_n98_), .b(new_n41_), .O(z10));
  nand2  g65(.a(new_n41_), .b(new_n36_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n36_), .c(x03), .O(new_n101_));
  nand2  g67(.a(new_n41_), .b(x04), .O(new_n102_));
