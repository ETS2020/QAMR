...
module FAU ( 
  ...
  oai21  g32(.a(x10), .b(new_n42_), .c(new_n65_), .O(new_n67_));
  ...
  oai21  g41(.a(x12), .b(new_n42_), .c(new_n37_), .O(new_n76_));
  ...
  oai21  g53(.a(x13), .b(new_n42_), .c(new_n37_), .O(new_n88_));
  ...
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n42_), .O(new_n103_));
  nand3  g69(.a(new_n49_), .b(x14), .c(x04), .O(new_n104_));
  oai21  g70(.a(new_n103_), .b(new_n37_), .c(new_n104_), .O(z10));
  nor2   g71(.a(new_n38_), .b(new_n36_), .O(z11));
  nand2  g72(.a(x16), .b(new_n36_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n47_), .c(new_n42_), .O(z12));
  nor2   g74(.a(x06), .b(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z13));
  inv1   g76(.a(x17), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(x04), .c(new_n109_), .O(z14));
endmodule
