...
module FAU ( 
  ...
  nand3  g24(.a(new_n58_), .b(new_n55_), .c(new_n39_), .O(new_n59_));
  nor2   g25(.a(new_n59_), .b(new_n49_), .O(z04));
  nand4  g26(.a(x15), .b(x08), .c(x07), .d(x06), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x09), .O(new_n62_));
  inv1   g28(.a(x09), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(x08), .c(x07), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x15), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x06), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n62_), .c(new_n50_), .O(z05));
  oai21  g33(.a(new_n64_), .b(x10), .c(x15), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x06), .O(new_n69_));
  oai21  g35(.a(new_n61_), .b(x09), .c(x10), .O(new_n70_));
  ...
  oai21  g40(.a(new_n74_), .b(new_n64_), .c(x15), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  nor2   g42(.a(new_n55_), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(x15), .c(new_n72_), .O(new_n78_));
  ...
  oai21  g49(.a(new_n83_), .b(new_n64_), .c(x15), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n50_), .O(z08));
  nand2  g52(.a(new_n85_), .b(x13), .O(new_n87_));
  nor2   g53(.a(new_n61_), .b(x09), .O(new_n88_));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n82_), .c(new_n73_), .d(new_n72_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  aoi22  g57(.a(new_n91_), .b(new_n88_), .c(new_n49_), .d(new_n39_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n87_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n90_), .b(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n77_), .c(new_n48_), .O(new_n96_));
  inv1   g62(.a(x03), .O(new_n97_));
  inv1   g63(.a(x16), .O(new_n98_));
  aoi21  g64(.a(new_n97_), .b(x02), .c(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(x14), .c(new_n38_), .O(new_n100_));
  aoi22  g66(.a(new_n100_), .b(new_n96_), .c(new_n39_), .d(new_n42_), .O(z10));
  nor2   g67(.a(new_n38_), .b(new_n35_), .O(z11));
  inv1   g68(.a(new_n43_), .O(new_n103_));
  aoi21  g69(.a(x16), .b(new_n35_), .c(x03), .O(new_n104_));
  nor2   g70(.a(new_n104_), .b(new_n103_), .O(z12));
  nand2  g71(.a(new_n39_), .b(new_n42_), .O(z13));
  and2   g72(.a(new_n43_), .b(x17), .O(z14));
endmodule
