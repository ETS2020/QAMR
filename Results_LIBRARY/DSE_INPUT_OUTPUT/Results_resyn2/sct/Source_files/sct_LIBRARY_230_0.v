...
module FAU ( 
  ...
  nand2  g20(.a(new_n48_), .b(new_n38_), .O(new_n55_));
  ...
  nor2   g31(.a(new_n62_), .b(x10), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(new_n52_), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n65_), .c(new_n37_), .O(z06));
  oai21  g34(.a(new_n62_), .b(x10), .c(x11), .O(new_n69_));
  inv1   g35(.a(new_n62_), .O(new_n70_));
  nor2   g36(.a(x11), .b(x10), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n70_), .c(new_n52_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n69_), .c(new_n37_), .O(z07));
  inv1   g39(.a(new_n55_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n88_), .b(new_n70_), .c(new_n51_), .O(new_n89_));
  inv1   g55(.a(new_n51_), .O(new_n90_));
