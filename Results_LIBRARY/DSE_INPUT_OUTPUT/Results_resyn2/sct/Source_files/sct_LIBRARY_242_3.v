...
module FAU ( 
  ...
  nand2  g02(.a(x09), .b(x07), .O(new_n37_));
  ...
  oai21  g21(.a(x09), .b(new_n55_), .c(new_n47_), .O(new_n56_));
  ...
  nor3   g31(.a(new_n65_), .b(new_n62_), .c(new_n60_), .O(z04));
  inv1   g32(.a(x09), .O(new_n67_));
  nand3  g33(.a(new_n61_), .b(new_n54_), .c(new_n67_), .O(z05));
  inv1   g34(.a(x10), .O(new_n69_));
  aoi21  g35(.a(x08), .b(x06), .c(new_n69_), .O(new_n70_));
  nor2   g36(.a(new_n61_), .b(x10), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n70_), .c(new_n67_), .O(new_n72_));
  nand2  g38(.a(new_n60_), .b(new_n37_), .O(new_n73_));
  nand2  g39(.a(x10), .b(new_n55_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z06));
  nand2  g41(.a(new_n71_), .b(new_n67_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x11), .O(new_n77_));
  inv1   g43(.a(x11), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n69_), .c(x08), .d(x06), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n67_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x07), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n77_), .c(new_n54_), .O(z07));
  nand2  g48(.a(new_n79_), .b(x12), .O(new_n83_));
  nor2   g49(.a(x12), .b(x11), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n62_), .c(new_n69_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(x07), .O(new_n89_));
  aoi21  g55(.a(new_n60_), .b(new_n37_), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n87_), .O(z08));
  nand3  g57(.a(new_n84_), .b(new_n71_), .c(new_n67_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x13), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n88_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n79_), .c(new_n67_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x07), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n93_), .c(new_n54_), .O(z09));
  nor2   g64(.a(new_n38_), .b(x04), .O(new_n99_));
  inv1   g65(.a(x00), .O(new_n100_));
  nand2  g66(.a(new_n78_), .b(new_n69_), .O(new_n101_));
  oai21  g67(.a(new_n95_), .b(new_n101_), .c(new_n100_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n62_), .c(new_n48_), .O(new_n103_));
  aoi21  g69(.a(new_n53_), .b(x14), .c(new_n38_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(z10));
  nor2   g71(.a(new_n38_), .b(new_n36_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n36_), .c(x03), .O(new_n107_));
  nor3   g73(.a(new_n107_), .b(new_n38_), .c(new_n44_), .O(z12));
  inv1   g74(.a(new_n99_), .O(z13));
  inv1   g75(.a(x17), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n44_), .c(new_n37_), .O(z14));
endmodule
