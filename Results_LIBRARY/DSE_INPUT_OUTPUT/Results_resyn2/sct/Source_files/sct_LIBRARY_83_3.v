...
module FAU ( 
  ...
  aoi21  g23(.a(new_n57_), .b(new_n41_), .c(new_n52_), .O(z04));
  oai21  g24(.a(new_n50_), .b(x09), .c(new_n41_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z05));
  oai21  g26(.a(new_n50_), .b(x10), .c(new_n41_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z06));
  oai21  g28(.a(new_n50_), .b(x11), .c(new_n41_), .O(new_n63_));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n41_), .c(new_n52_), .O(z10));
  aoi21  g36(.a(x06), .b(x04), .c(new_n53_), .O(z11));
  nand2  g37(.a(x16), .b(new_n53_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n48_), .c(new_n42_), .O(z12));
  inv1   g39(.a(new_n42_), .O(z13));
