...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n53_, new_n55_, new_n57_, new_n60_, new_n62_, new_n64_, new_n66_,
  ...
  nor2   g23(.a(x06), .b(new_n45_), .O(z13));
  nand3  g24(.a(z13), .b(new_n50_), .c(new_n57_), .O(z06));
  ...
  nand3  g30(.a(z13), .b(new_n50_), .c(new_n64_), .O(z09));
