...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n51_, new_n54_, new_n55_, new_n57_, new_n59_, new_n61_, new_n63_,
    new_n65_, new_n67_, new_n71_, new_n73_;
  ...
  inv1   g18(.a(new_n43_), .O(z13));
  oai21  g19(.a(x03), .b(new_n35_), .c(x16), .O(new_n54_));
  nand3  g20(.a(new_n54_), .b(z13), .c(x07), .O(new_n55_));
  inv1   g21(.a(new_n55_), .O(z03));
  nand3  g22(.a(new_n54_), .b(z13), .c(x08), .O(new_n57_));
