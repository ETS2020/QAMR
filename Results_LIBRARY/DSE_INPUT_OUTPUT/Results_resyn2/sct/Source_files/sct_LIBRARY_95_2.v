...
module FAU ( 
  ...
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n54_), .O(new_n78_));
  ...
  oai21  g50(.a(new_n84_), .b(new_n62_), .c(new_n54_), .O(new_n85_));
  ...
  nand3  g56(.a(new_n90_), .b(new_n65_), .c(new_n54_), .O(new_n91_));
