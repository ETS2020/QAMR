...
module FAU ( 
  ...
  nand2  g21(.a(new_n46_), .b(new_n37_), .O(z13));
  nand3  g22(.a(z13), .b(new_n55_), .c(new_n53_), .O(new_n57_));
  oai21  g23(.a(new_n57_), .b(new_n49_), .c(new_n38_), .O(z03));
  ...
  oai21  g34(.a(x10), .b(new_n37_), .c(new_n66_), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n65_), .c(new_n49_), .O(new_n71_));
  aoi22  g37(.a(new_n71_), .b(new_n69_), .c(x06), .d(new_n37_), .O(z06));
  nand2  g38(.a(new_n70_), .b(new_n65_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x11), .O(new_n74_));
  nor2   g40(.a(new_n59_), .b(x09), .O(new_n75_));
  ...
  nand3  g45(.a(new_n76_), .b(new_n75_), .c(new_n79_), .O(new_n80_));
  ...
  nand3  g57(.a(new_n64_), .b(x08), .c(x07), .O(new_n92_));
  aoi21  g58(.a(new_n91_), .b(x16), .c(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n90_), .c(new_n37_), .O(new_n94_));
  nand3  g60(.a(new_n49_), .b(x14), .c(x04), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n46_), .c(new_n95_), .O(z10));
