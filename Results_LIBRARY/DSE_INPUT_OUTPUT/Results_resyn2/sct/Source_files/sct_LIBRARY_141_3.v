...
module FAU ( 
  ...
  nor2   g13(.a(x12), .b(new_n47_), .O(new_n48_));
  ...
  oai21  g22(.a(x12), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g29(.a(new_n63_), .b(new_n62_), .c(new_n37_), .O(new_n64_));
  nor2   g30(.a(new_n64_), .b(new_n50_), .O(z04));
  inv1   g31(.a(x09), .O(new_n66_));
  inv1   g32(.a(new_n63_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g34(.a(new_n63_), .b(x09), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n68_), .c(new_n49_), .d(x04), .O(new_n70_));
  and2   g36(.a(new_n70_), .b(new_n37_), .O(z05));
  nand2  g37(.a(x08), .b(x07), .O(new_n72_));
  nor2   g38(.a(new_n72_), .b(x09), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(x12), .c(x06), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x10), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand3  g42(.a(new_n73_), .b(new_n48_), .c(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n50_), .b(new_n37_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(z06));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n76_), .b(new_n66_), .c(x08), .d(x07), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x11), .O(new_n84_));
  inv1   g50(.a(new_n72_), .O(new_n85_));
  nor2   g51(.a(x11), .b(x10), .O(new_n86_));
  nor2   g52(.a(x09), .b(new_n47_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n80_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n84_), .c(new_n78_), .O(z07));
  nand3  g55(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n55_), .c(new_n80_), .O(z08));
  nand3  g57(.a(new_n66_), .b(x08), .c(x07), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand2  g59(.a(new_n86_), .b(new_n93_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n92_), .c(new_n80_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x06), .O(new_n96_));
  nand2  g62(.a(new_n88_), .b(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n55_), .O(z09));
  nand2  g64(.a(new_n37_), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n54_), .b(x14), .O(new_n100_));
  nor2   g66(.a(new_n63_), .b(x09), .O(new_n101_));
  inv1   g67(.a(x00), .O(new_n102_));
  nand2  g68(.a(new_n94_), .b(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n101_), .c(new_n49_), .d(new_n80_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n100_), .c(new_n99_), .O(z10));
  nor2   g71(.a(new_n38_), .b(new_n36_), .O(z11));
  nand2  g72(.a(x16), .b(new_n36_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n52_), .c(new_n99_), .O(z12));
