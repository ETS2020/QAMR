...
module FAU ( 
  ...
  nor2   g19(.a(new_n42_), .b(x04), .O(new_n54_));
  nor2   g20(.a(new_n54_), .b(new_n49_), .O(new_n55_));
  nand2  g21(.a(x07), .b(x06), .O(new_n56_));
  inv1   g22(.a(x07), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  ...
  nor2   g33(.a(new_n61_), .b(x09), .O(new_n68_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n71_), .c(new_n50_), .O(z06));
  nand2  g42(.a(x08), .b(x07), .O(new_n77_));
  inv1   g43(.a(x11), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n73_), .c(new_n72_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n77_), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  aoi21  g47(.a(new_n75_), .b(x11), .c(new_n49_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n41_), .c(new_n81_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n78_), .c(new_n73_), .d(new_n72_), .O(new_n85_));
  ...
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n72_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x12), .c(new_n49_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n41_), .c(new_n87_), .O(z08));
  oai21  g58(.a(new_n85_), .b(new_n66_), .c(x13), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand3  g60(.a(new_n89_), .b(new_n94_), .c(new_n84_), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n68_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n93_), .c(new_n50_), .O(z09));
  ...
  nand3  g68(.a(new_n102_), .b(new_n68_), .c(new_n100_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n99_), .c(new_n41_), .O(z10));
  ...
  inv1   g73(.a(new_n54_), .O(z13));
  nor2   g74(.a(x17), .b(new_n41_), .O(new_n109_));
  nor2   g75(.a(new_n109_), .b(new_n54_), .O(z14));
endmodule
