...
module FAU ( 
  ...
  nand3  g35(.a(new_n70_), .b(new_n69_), .c(new_n50_), .O(new_n71_));
  ...
  nand3  g41(.a(new_n76_), .b(new_n74_), .c(new_n57_), .O(z07));
  ...
  nand3  g47(.a(new_n82_), .b(new_n80_), .c(new_n50_), .O(new_n83_));
  ...
  oai21  g54(.a(new_n89_), .b(new_n65_), .c(new_n50_), .O(new_n90_));
  oai21  g55(.a(new_n90_), .b(new_n87_), .c(x06), .O(new_n91_));
  nand2  g56(.a(new_n91_), .b(x04), .O(z09));
  nand2  g57(.a(new_n55_), .b(x14), .O(new_n93_));
  inv1   g58(.a(x00), .O(new_n94_));
  nand2  g59(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nand3  g60(.a(new_n95_), .b(new_n68_), .c(new_n50_), .O(new_n96_));
  aoi21  g61(.a(new_n96_), .b(new_n93_), .c(new_n56_), .O(z10));
  aoi21  g62(.a(new_n38_), .b(x04), .c(new_n49_), .O(z11));
  nand2  g63(.a(x16), .b(new_n49_), .O(new_n99_));
  aoi21  g64(.a(new_n99_), .b(new_n53_), .c(new_n56_), .O(z12));
  inv1   g65(.a(new_n56_), .O(z13));
