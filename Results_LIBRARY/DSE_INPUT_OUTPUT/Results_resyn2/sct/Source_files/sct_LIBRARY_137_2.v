...
module FAU ( 
  ...
  oai21  g22(.a(new_n56_), .b(new_n48_), .c(new_n52_), .O(z03));
  ...
  oai21  g27(.a(new_n61_), .b(new_n48_), .c(new_n52_), .O(z04));
  inv1   g28(.a(x17), .O(new_n63_));
  nor3   g29(.a(new_n60_), .b(new_n63_), .c(x09), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n48_), .b(new_n52_), .O(new_n66_));
  nor2   g32(.a(new_n58_), .b(new_n54_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(new_n63_), .c(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n65_), .O(z05));
  nand2  g36(.a(new_n65_), .b(x10), .O(new_n71_));
  inv1   g37(.a(x09), .O(new_n72_));
  inv1   g38(.a(x10), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(x08), .d(x07), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n63_), .c(x06), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n71_), .c(new_n49_), .O(z06));
  nor2   g43(.a(x10), .b(x09), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(new_n67_), .c(new_n63_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n37_), .c(x11), .O(new_n80_));
  nor2   g46(.a(x11), .b(new_n37_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n75_), .c(x17), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n66_), .O(z07));
  nor2   g49(.a(x12), .b(x11), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n78_), .c(x08), .d(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x17), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nand2  g53(.a(new_n82_), .b(x12), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n49_), .O(z08));
  nand2  g55(.a(new_n87_), .b(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand3  g57(.a(new_n84_), .b(new_n91_), .c(new_n73_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  aoi22  g59(.a(new_n93_), .b(new_n64_), .c(new_n48_), .d(new_n52_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n90_), .O(z09));
  nor2   g61(.a(new_n60_), .b(x09), .O(new_n96_));
  ...
  aoi22  g69(.a(new_n103_), .b(new_n99_), .c(new_n52_), .d(new_n44_), .O(z10));
  nor2   g70(.a(new_n38_), .b(new_n36_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n36_), .c(x03), .O(new_n106_));
  nor3   g72(.a(new_n106_), .b(new_n38_), .c(new_n44_), .O(z12));
  nand2  g73(.a(new_n52_), .b(new_n44_), .O(z13));
  oai21  g74(.a(new_n63_), .b(new_n44_), .c(new_n52_), .O(z14));
endmodule
