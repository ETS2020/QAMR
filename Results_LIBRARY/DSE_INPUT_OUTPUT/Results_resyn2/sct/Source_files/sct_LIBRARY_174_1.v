...
module FAU ( 
  ...
  nand3  g22(.a(new_n56_), .b(new_n54_), .c(new_n49_), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(new_n37_), .O(z03));
  aoi21  g24(.a(x08), .b(x04), .c(new_n55_), .O(new_n59_));
  nand3  g25(.a(x08), .b(x07), .c(x06), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n49_), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n59_), .c(new_n37_), .O(z04));
  oai21  g28(.a(x09), .b(new_n36_), .c(new_n60_), .O(new_n63_));
  inv1   g29(.a(x08), .O(new_n64_));
  nor2   g30(.a(x09), .b(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n55_), .O(new_n66_));
  ...
  nand3  g37(.a(new_n65_), .b(new_n55_), .c(new_n71_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(z06));
  inv1   g39(.a(x11), .O(new_n74_));
  nand4  g40(.a(new_n65_), .b(new_n55_), .c(new_n74_), .d(new_n71_), .O(new_n75_));
  nand2  g41(.a(new_n72_), .b(x11), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(z07));
  ...
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n69_), .O(z08));
  oai21  g48(.a(x13), .b(new_n36_), .c(new_n53_), .O(new_n83_));
  inv1   g49(.a(x09), .O(new_n84_));
  nand4  g50(.a(new_n71_), .b(new_n84_), .c(x08), .d(x06), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n80_), .c(x13), .O(new_n86_));
  nor2   g52(.a(x12), .b(x11), .O(new_n87_));
  nor2   g53(.a(x13), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n65_), .d(new_n55_), .O(new_n89_));
  ...
  nand3  g61(.a(new_n84_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g62(.a(new_n48_), .b(x16), .c(new_n96_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n95_), .c(new_n36_), .O(new_n98_));
  nand4  g64(.a(new_n48_), .b(x16), .c(x14), .d(x04), .O(new_n99_));
  oai21  g65(.a(new_n98_), .b(new_n53_), .c(new_n99_), .O(z10));
  inv1   g66(.a(x02), .O(new_n101_));
  aoi21  g67(.a(x07), .b(new_n36_), .c(new_n101_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n101_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n36_), .c(new_n37_), .O(z12));
  nor2   g70(.a(x07), .b(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z13));
  inv1   g72(.a(x17), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(x04), .c(new_n105_), .O(z14));
endmodule
