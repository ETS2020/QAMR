...
module FAU ( 
  ...
  nand2  g02(.a(x15), .b(x06), .O(new_n37_));
  ...
  nor3   g19(.a(new_n53_), .b(new_n51_), .c(new_n47_), .O(z04));
  nand2  g20(.a(new_n47_), .b(new_n37_), .O(new_n55_));
  inv1   g21(.a(x06), .O(new_n56_));
  aoi21  g22(.a(x08), .b(x07), .c(x15), .O(new_n57_));
  oai21  g23(.a(new_n57_), .b(new_n56_), .c(x09), .O(new_n58_));
  ...
  nand3  g30(.a(new_n64_), .b(new_n58_), .c(new_n55_), .O(z05));
  nand2  g31(.a(x08), .b(x07), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(x09), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(x15), .c(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x10), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  inv1   g36(.a(new_n62_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n67_), .c(new_n70_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n69_), .c(new_n55_), .O(z06));
  nand4  g39(.a(new_n70_), .b(new_n59_), .c(x08), .d(x07), .O(new_n74_));
  ...
  nand3  g44(.a(new_n78_), .b(new_n71_), .c(new_n67_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n55_), .O(z07));
  aoi21  g46(.a(new_n78_), .b(new_n67_), .c(x15), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n56_), .c(x12), .O(new_n82_));
  nor3   g48(.a(x12), .b(x11), .c(x10), .O(new_n83_));
  aoi22  g49(.a(new_n83_), .b(new_n63_), .c(new_n47_), .d(new_n37_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n82_), .O(z08));
  inv1   g51(.a(new_n47_), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand3  g54(.a(new_n78_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n60_), .c(new_n61_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand2  g57(.a(new_n83_), .b(new_n63_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x13), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n86_), .O(z09));
  nand2  g60(.a(new_n37_), .b(x04), .O(new_n95_));
  inv1   g61(.a(new_n46_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x14), .O(new_n97_));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n89_), .b(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n63_), .c(new_n46_), .O(new_n100_));
