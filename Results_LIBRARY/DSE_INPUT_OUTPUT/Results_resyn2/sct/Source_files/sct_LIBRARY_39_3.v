...
module FAU ( 
  ...
  nor2   g14(.a(x06), .b(new_n37_), .O(new_n49_));
  ...
  nand3  g23(.a(new_n49_), .b(new_n57_), .c(new_n56_), .O(z06));
  inv1   g24(.a(x11), .O(new_n59_));
  nand3  g25(.a(new_n49_), .b(new_n57_), .c(new_n59_), .O(z07));
  inv1   g26(.a(x12), .O(new_n61_));
  nand3  g27(.a(new_n49_), .b(new_n57_), .c(new_n61_), .O(z08));
  oai21  g28(.a(new_n47_), .b(x13), .c(new_n38_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z09));
  nand2  g30(.a(new_n49_), .b(x14), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n57_), .O(z10));
