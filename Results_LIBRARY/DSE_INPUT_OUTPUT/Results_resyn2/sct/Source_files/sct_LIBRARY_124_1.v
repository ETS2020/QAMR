...
module FAU ( 
  ...
  inv1   g17(.a(new_n48_), .O(new_n52_));
  ...
  aoi21  g24(.a(new_n54_), .b(new_n50_), .c(new_n58_), .O(new_n59_));
  nor3   g25(.a(x08), .b(new_n53_), .c(new_n49_), .O(new_n60_));
  oai21  g26(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(new_n61_));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n63_), .c(new_n48_), .O(new_n68_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n52_), .d(x04), .O(z06));
  nand2  g40(.a(new_n73_), .b(x11), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  nand3  g42(.a(new_n72_), .b(new_n71_), .c(new_n76_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n52_), .d(x04), .O(z07));
  oai21  g44(.a(x12), .b(new_n37_), .c(new_n49_), .O(new_n79_));
  nor3   g45(.a(x12), .b(x11), .c(x10), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  nand2  g47(.a(x08), .b(x07), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  nand3  g49(.a(new_n76_), .b(new_n83_), .c(new_n66_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n82_), .c(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n52_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n79_), .O(z08));
  oai21  g54(.a(x13), .b(new_n37_), .c(new_n49_), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand3  g56(.a(new_n80_), .b(new_n64_), .c(new_n90_), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n76_), .c(new_n83_), .O(new_n93_));
  nand3  g59(.a(new_n66_), .b(x08), .c(x07), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n93_), .c(x13), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n91_), .c(new_n52_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n89_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand4  g65(.a(new_n90_), .b(new_n92_), .c(new_n76_), .d(new_n83_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g67(.a(new_n46_), .b(x02), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(x16), .c(new_n94_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n37_), .O(new_n104_));
  nand3  g70(.a(new_n48_), .b(x14), .c(x04), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(new_n49_), .c(new_n105_), .O(z10));
  nand2  g72(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g73(.a(x16), .b(new_n35_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n46_), .c(new_n37_), .O(z12));
