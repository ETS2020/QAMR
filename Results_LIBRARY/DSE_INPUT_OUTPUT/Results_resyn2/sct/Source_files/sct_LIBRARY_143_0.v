...
module FAU ( 
  ...
  nand2  g39(.a(new_n59_), .b(new_n70_), .O(new_n74_));
  ...
  nand3  g47(.a(new_n81_), .b(new_n53_), .c(new_n70_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(x11), .c(new_n49_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n36_), .c(new_n80_), .O(z07));
  inv1   g50(.a(x11), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nor2   g52(.a(x10), .b(new_n52_), .O(new_n87_));
  ...
  nand2  g58(.a(new_n92_), .b(new_n59_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n90_), .O(z08));
  oai21  g61(.a(new_n88_), .b(new_n37_), .c(x13), .O(new_n96_));
  ...
  nand3  g65(.a(new_n99_), .b(new_n96_), .c(new_n51_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n98_), .b(new_n101_), .O(new_n102_));
  inv1   g68(.a(x14), .O(new_n103_));
  nor2   g69(.a(new_n59_), .b(new_n103_), .O(new_n104_));
  aoi21  g70(.a(new_n102_), .b(new_n75_), .c(new_n104_), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g72(.a(new_n38_), .b(new_n58_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n58_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n36_), .c(new_n38_), .O(z12));
