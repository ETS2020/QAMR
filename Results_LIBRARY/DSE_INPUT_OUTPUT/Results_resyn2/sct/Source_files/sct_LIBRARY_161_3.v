...
module FAU ( 
  ...
  oai21  g19(.a(new_n38_), .b(x05), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g25(.a(new_n59_), .b(new_n58_), .c(new_n40_), .O(new_n60_));
  nor2   g26(.a(new_n60_), .b(new_n48_), .O(z04));
  nand2  g27(.a(new_n59_), .b(x09), .O(new_n62_));
  inv1   g28(.a(x09), .O(new_n63_));
  inv1   g29(.a(new_n59_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n49_), .d(new_n40_), .O(z05));
  nor3   g32(.a(new_n59_), .b(x10), .c(x09), .O(new_n67_));
  ...
  aoi22  g38(.a(new_n48_), .b(new_n40_), .c(x10), .d(new_n38_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(z06));
  oai21  g40(.a(new_n65_), .b(x10), .c(x11), .O(new_n75_));
  nor2   g41(.a(x11), .b(x10), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n64_), .c(new_n63_), .O(new_n77_));
  oai21  g43(.a(x11), .b(x06), .c(x05), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n75_), .d(new_n49_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n76_), .b(new_n64_), .c(new_n80_), .d(new_n63_), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n68_), .c(new_n63_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n69_), .c(x12), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n37_), .O(new_n86_));
  aoi22  g52(.a(new_n48_), .b(new_n40_), .c(x12), .d(new_n38_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(z08));
  xor2a  g54(.a(new_n81_), .b(x13), .O(new_n89_));
  oai21  g55(.a(x13), .b(x06), .c(x05), .O(new_n90_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n64_), .c(new_n47_), .d(new_n63_), .O(new_n97_));
  inv1   g63(.a(x03), .O(new_n98_));
  inv1   g64(.a(x16), .O(new_n99_));
  aoi21  g65(.a(new_n98_), .b(x02), .c(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(x14), .c(new_n39_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n97_), .c(new_n92_), .O(z10));
  nor2   g68(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g69(.a(x16), .b(new_n35_), .O(new_n104_));
  nor2   g70(.a(new_n39_), .b(x03), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n92_), .O(z12));
  inv1   g72(.a(new_n92_), .O(z13));
  inv1   g73(.a(x17), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n44_), .c(new_n40_), .O(z14));
endmodule
