...
module FAU ( 
  ...
  oai21  g18(.a(new_n38_), .b(x04), .c(new_n52_), .O(new_n53_));
  xnor2a g19(.a(x07), .b(x06), .O(new_n54_));
  oai21  g20(.a(new_n54_), .b(new_n53_), .c(new_n39_), .O(z03));
  and2   g21(.a(x07), .b(x06), .O(new_n56_));
  xnor2a g22(.a(new_n56_), .b(x08), .O(new_n57_));
  oai21  g23(.a(new_n57_), .b(new_n53_), .c(new_n39_), .O(z04));
  ...
  aoi21  g29(.a(new_n63_), .b(x09), .c(new_n48_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n37_), .c(new_n62_), .O(z05));
  nand4  g31(.a(new_n59_), .b(x08), .c(x07), .d(x06), .O(new_n66_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n56_), .c(new_n59_), .d(x08), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n72_), .c(new_n49_), .O(z07));
  inv1   g41(.a(x11), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n68_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n60_), .c(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x06), .O(new_n80_));
  aoi21  g46(.a(new_n74_), .b(x12), .c(new_n48_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n37_), .c(new_n80_), .O(z08));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n77_), .c(new_n76_), .d(new_n68_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n60_), .c(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  inv1   g52(.a(new_n63_), .O(new_n87_));
  nor2   g53(.a(x12), .b(x09), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n73_), .c(new_n87_), .O(new_n89_));
  ...
  nand3  g59(.a(new_n93_), .b(new_n69_), .c(new_n52_), .O(new_n94_));
