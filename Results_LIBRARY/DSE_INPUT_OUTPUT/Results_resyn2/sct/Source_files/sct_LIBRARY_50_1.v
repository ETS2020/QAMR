...
module FAU ( 
  ...
  oai21  g29(.a(x09), .b(new_n42_), .c(new_n58_), .O(new_n64_));
  inv1   g30(.a(x09), .O(new_n65_));
  inv1   g31(.a(new_n53_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(x08), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n63_), .O(new_n68_));
  ...
  nand2  g65(.a(new_n93_), .b(new_n80_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n71_), .c(new_n63_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n98_), .c(new_n42_), .O(z10));
  nor2   g69(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g70(.a(x16), .b(new_n35_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n47_), .c(new_n42_), .O(z12));
