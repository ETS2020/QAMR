...
module FAU ( 
  ...
  nand2  g38(.a(new_n56_), .b(new_n69_), .O(new_n73_));
  nor2   g39(.a(new_n67_), .b(new_n51_), .O(new_n74_));
  ...
  oai21  g46(.a(new_n67_), .b(x10), .c(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n79_), .b(new_n83_), .c(new_n78_), .d(new_n69_), .O(new_n84_));
  nand2  g50(.a(new_n80_), .b(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n52_), .O(z08));
  nand2  g52(.a(new_n84_), .b(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n83_), .c(new_n78_), .d(new_n69_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n79_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n52_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n89_), .b(new_n93_), .O(new_n94_));
  nor2   g60(.a(new_n56_), .b(new_n41_), .O(new_n95_));
  aoi21  g61(.a(new_n94_), .b(new_n74_), .c(new_n95_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n37_), .c(new_n39_), .O(z10));
  nand2  g63(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g64(.a(x16), .b(new_n35_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n49_), .c(new_n37_), .O(z12));
  nand2  g66(.a(x06), .b(new_n37_), .O(z13));
