...
module FAU ( 
  ...
  aoi22  g04(.a(new_n38_), .b(new_n36_), .c(x14), .d(new_n35_), .O(z00));
  nor2   g05(.a(x15), .b(x05), .O(new_n40_));
  nor2   g06(.a(new_n36_), .b(new_n35_), .O(new_n41_));
  inv1   g07(.a(new_n41_), .O(new_n42_));
  nand2  g08(.a(x05), .b(x04), .O(new_n43_));
  nand2  g09(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  aoi21  g10(.a(new_n40_), .b(x18), .c(new_n44_), .O(z01));
  ...
  oai21  g17(.a(new_n51_), .b(new_n47_), .c(new_n42_), .O(z03));
  aoi21  g18(.a(x07), .b(x06), .c(x08), .O(new_n53_));
  nand3  g19(.a(x08), .b(x07), .c(x06), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n42_), .O(new_n55_));
  ...
  and2   g26(.a(new_n60_), .b(new_n42_), .O(z05));
  ...
  nand2  g33(.a(x10), .b(x01), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n67_), .c(new_n62_), .d(new_n48_), .O(z06));
  and2   g35(.a(new_n65_), .b(x11), .O(new_n70_));
  inv1   g36(.a(x11), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nor2   g39(.a(new_n73_), .b(new_n54_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n70_), .c(new_n35_), .O(new_n75_));
  aoi22  g41(.a(new_n47_), .b(new_n42_), .c(x11), .d(new_n36_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n75_), .O(z07));
  nor2   g43(.a(x12), .b(x11), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n72_), .c(x08), .d(x07), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n35_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  oai21  g47(.a(new_n73_), .b(new_n54_), .c(x12), .O(new_n82_));
  nand2  g48(.a(x12), .b(x01), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n48_), .O(z08));
  inv1   g50(.a(x12), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n71_), .d(new_n64_), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  aoi22  g54(.a(new_n88_), .b(new_n57_), .c(new_n79_), .d(x13), .O(new_n89_));
  nor2   g55(.a(new_n86_), .b(x06), .O(new_n90_));
  aoi21  g56(.a(new_n47_), .b(new_n42_), .c(new_n90_), .O(new_n91_));
  oai21  g57(.a(new_n89_), .b(x01), .c(new_n91_), .O(z09));
  inv1   g58(.a(x04), .O(new_n93_));
  nor2   g59(.a(new_n41_), .b(new_n93_), .O(z13));
  inv1   g60(.a(z13), .O(new_n95_));
  inv1   g61(.a(new_n46_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x14), .O(new_n97_));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n87_), .b(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n57_), .c(new_n46_), .d(new_n35_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n97_), .c(new_n95_), .O(z10));
  nor2   g67(.a(new_n41_), .b(new_n37_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n37_), .c(x03), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n95_), .O(z12));
  nand2  g70(.a(z13), .b(x17), .O(new_n105_));
