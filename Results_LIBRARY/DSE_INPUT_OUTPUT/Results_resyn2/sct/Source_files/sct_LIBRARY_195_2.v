...
module FAU ( 
  ...
  oai21  g45(.a(new_n79_), .b(new_n61_), .c(new_n63_), .O(new_n80_));
  ...
  oai21  g52(.a(new_n79_), .b(new_n61_), .c(x13), .O(new_n87_));
  ...
  nand3  g57(.a(new_n91_), .b(new_n71_), .c(new_n63_), .O(new_n92_));
  aoi21  g58(.a(new_n49_), .b(x14), .c(new_n37_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n89_), .O(z10));
  nand2  g60(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g61(.a(x16), .b(new_n35_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n47_), .c(new_n50_), .O(z12));
  inv1   g63(.a(new_n50_), .O(z13));
