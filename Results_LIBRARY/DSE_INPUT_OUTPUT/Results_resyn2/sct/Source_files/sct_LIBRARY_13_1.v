...
module FAU ( 
  ...
  oai21  g08(.a(new_n42_), .b(x05), .c(x04), .O(z01));
  ...
  nor2   g32(.a(x18), .b(x04), .O(new_n67_));
  ...
  nand3  g38(.a(new_n72_), .b(new_n52_), .c(new_n71_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n69_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(z13), .O(z06));
  oai21  g42(.a(new_n64_), .b(x10), .c(x11), .O(new_n77_));
  nor2   g43(.a(x11), .b(x10), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n72_), .c(new_n52_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n69_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(z13), .O(z07));
  inv1   g48(.a(x11), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n71_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n64_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  inv1   g52(.a(new_n57_), .O(new_n87_));
  nand4  g53(.a(new_n78_), .b(new_n87_), .c(new_n86_), .d(new_n63_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n85_), .c(new_n69_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(z13), .O(z08));
  nand4  g57(.a(new_n86_), .b(new_n83_), .c(new_n71_), .d(new_n63_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n57_), .c(x13), .O(new_n93_));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n78_), .c(new_n72_), .d(new_n52_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n93_), .c(new_n69_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(z13), .O(z09));
  nand2  g64(.a(new_n47_), .b(x14), .O(new_n99_));
  inv1   g65(.a(new_n64_), .O(new_n100_));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n94_), .b(new_n78_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n100_), .c(new_n69_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n99_), .c(new_n37_), .O(z10));
  aoi21  g71(.a(x18), .b(new_n37_), .c(new_n35_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n35_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n37_), .c(new_n38_), .O(z12));
  inv1   g74(.a(x17), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(x04), .c(new_n67_), .O(z14));
endmodule
