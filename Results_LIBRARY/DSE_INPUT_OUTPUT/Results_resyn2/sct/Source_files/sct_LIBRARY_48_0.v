...
module FAU ( 
  ...
  nor2   g15(.a(new_n38_), .b(new_n49_), .O(z14));
  nand2  g16(.a(z14), .b(new_n37_), .O(new_n51_));
  nor2   g17(.a(new_n51_), .b(new_n48_), .O(z02));
  inv1   g18(.a(x03), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(x02), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(x16), .c(new_n49_), .O(new_n55_));
  ...
  nand3  g29(.a(new_n63_), .b(new_n62_), .c(new_n55_), .O(new_n64_));
  ...
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n55_), .O(new_n69_));
  and2   g35(.a(new_n69_), .b(new_n39_), .O(z05));
  ...
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(new_n76_));
  and2   g42(.a(new_n76_), .b(new_n39_), .O(z06));
  nand4  g43(.a(new_n71_), .b(new_n66_), .c(x08), .d(x07), .O(new_n78_));
  nor2   g44(.a(x11), .b(x10), .O(new_n79_));
  aoi22  g45(.a(new_n79_), .b(new_n73_), .c(new_n78_), .d(x11), .O(new_n80_));
  nand2  g46(.a(x11), .b(new_n37_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n47_), .c(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n39_), .O(new_n83_));
  oai21  g49(.a(new_n80_), .b(new_n37_), .c(new_n83_), .O(z07));
  ...
  nand3  g53(.a(new_n87_), .b(new_n47_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n39_), .O(new_n89_));
  oai21  g55(.a(new_n86_), .b(new_n37_), .c(new_n89_), .O(z08));
  ...
  nand3  g60(.a(new_n79_), .b(new_n94_), .c(new_n93_), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  oai21  g63(.a(new_n38_), .b(x13), .c(new_n37_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n91_), .d(new_n55_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand2  g66(.a(new_n95_), .b(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n92_), .c(new_n47_), .O(new_n102_));
  nand3  g68(.a(new_n48_), .b(new_n39_), .c(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n49_), .O(z10));
