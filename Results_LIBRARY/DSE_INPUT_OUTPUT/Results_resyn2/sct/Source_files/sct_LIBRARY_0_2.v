...
module FAU ( 
  ...
  nand2  g21(.a(x06), .b(x04), .O(new_n56_));
  ...
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n57_), .O(z06));
  nand2  g37(.a(new_n69_), .b(x11), .O(new_n72_));
  nor2   g38(.a(x11), .b(x10), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n68_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n72_), .c(new_n57_), .O(z07));
  nand2  g41(.a(new_n74_), .b(x12), .O(new_n76_));
  nor3   g42(.a(x12), .b(x11), .c(x10), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n68_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n57_), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  aoi21  g46(.a(new_n77_), .b(new_n68_), .c(new_n80_), .O(new_n81_));
  nor2   g47(.a(x13), .b(x12), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n73_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n65_), .c(new_n50_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n81_), .c(x06), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(z09));
  nand2  g52(.a(new_n55_), .b(x14), .O(new_n87_));
  inv1   g53(.a(x00), .O(new_n88_));
  nand2  g54(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n68_), .c(new_n50_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n87_), .c(new_n56_), .O(z10));
  nand2  g57(.a(new_n37_), .b(new_n49_), .O(z11));
  nand2  g58(.a(x16), .b(new_n49_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n53_), .c(new_n56_), .O(z12));
  inv1   g60(.a(new_n56_), .O(z13));
