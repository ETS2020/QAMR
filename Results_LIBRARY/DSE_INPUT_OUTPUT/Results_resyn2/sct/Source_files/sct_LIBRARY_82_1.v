...
module FAU ( 
  ...
  aoi21  g23(.a(x08), .b(x04), .c(new_n53_), .O(new_n58_));
  nand2  g24(.a(new_n53_), .b(x08), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(new_n47_), .O(new_n60_));
  oai21  g26(.a(new_n60_), .b(new_n58_), .c(new_n38_), .O(z04));
  ...
  nand3  g31(.a(new_n65_), .b(new_n62_), .c(new_n49_), .O(z05));
  ...
  nand4  g38(.a(new_n64_), .b(new_n53_), .c(new_n72_), .d(new_n68_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n77_), .b(new_n69_), .c(new_n68_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n49_), .O(z08));
  oai21  g45(.a(x13), .b(new_n37_), .c(new_n52_), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  inv1   g48(.a(x09), .O(new_n83_));
  nand4  g49(.a(new_n68_), .b(new_n83_), .c(x08), .d(x06), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n82_), .c(x13), .O(new_n85_));
  nor2   g51(.a(x13), .b(x10), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n77_), .c(new_n64_), .d(new_n53_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n47_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n80_), .O(z09));
  nand2  g56(.a(new_n48_), .b(x14), .O(new_n91_));
  inv1   g57(.a(x00), .O(new_n92_));
  nand2  g58(.a(new_n86_), .b(new_n77_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n69_), .c(new_n47_), .O(new_n95_));
  ...
  oai21  g64(.a(new_n98_), .b(new_n37_), .c(new_n38_), .O(z12));
  nor2   g65(.a(x07), .b(x04), .O(new_n100_));
