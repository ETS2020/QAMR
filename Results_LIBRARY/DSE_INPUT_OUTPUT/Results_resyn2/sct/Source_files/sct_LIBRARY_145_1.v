...
module FAU ( 
  ...
  oai21  g17(.a(new_n51_), .b(new_n49_), .c(new_n37_), .O(z02));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n67_), .c(new_n49_), .O(new_n70_));
  aoi22  g36(.a(new_n70_), .b(new_n66_), .c(x06), .d(new_n36_), .O(z05));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(new_n66_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nor2   g40(.a(new_n49_), .b(new_n36_), .O(new_n75_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n68_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n75_), .O(z07));
  oai21  g48(.a(x12), .b(new_n36_), .c(new_n50_), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n72_), .c(new_n68_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n64_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n80_), .b(new_n79_), .c(new_n87_), .d(new_n68_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n53_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n83_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand3  g58(.a(new_n80_), .b(new_n92_), .c(new_n87_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n73_), .O(new_n95_));
  nand2  g61(.a(new_n88_), .b(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n75_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n93_), .b(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n47_), .b(x02), .O(new_n100_));
  nand3  g66(.a(new_n68_), .b(x08), .c(x07), .O(new_n101_));
  aoi21  g67(.a(new_n100_), .b(x16), .c(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n99_), .c(new_n36_), .O(new_n103_));
  nand3  g69(.a(new_n49_), .b(x14), .c(x04), .O(new_n104_));
  oai21  g70(.a(new_n103_), .b(new_n50_), .c(new_n104_), .O(z10));
  inv1   g71(.a(x02), .O(new_n106_));
  nand2  g72(.a(new_n37_), .b(new_n106_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n106_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n36_), .c(new_n37_), .O(z12));
