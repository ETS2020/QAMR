...
module FAU ( 
  ...
  nor2   g16(.a(x17), .b(x06), .O(new_n51_));
  ...
  nor3   g23(.a(new_n57_), .b(new_n49_), .c(new_n44_), .O(z03));
  ...
  oai21  g30(.a(new_n64_), .b(x09), .c(new_n59_), .O(new_n65_));
  ...
  nand3  g40(.a(new_n74_), .b(new_n69_), .c(new_n50_), .O(z06));
  ...
  oai21  g45(.a(x17), .b(x11), .c(new_n37_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n77_), .d(new_n50_), .O(z07));
  ...
  oai21  g51(.a(x17), .b(x12), .c(new_n37_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n50_), .O(z08));
  ...
  nand3  g70(.a(new_n49_), .b(new_n38_), .c(x14), .O(new_n105_));
  ...
  oai21  g74(.a(new_n108_), .b(new_n44_), .c(new_n38_), .O(z12));
  nor2   g75(.a(new_n64_), .b(new_n44_), .O(z13));
  nand3  g76(.a(x17), .b(x06), .c(x04), .O(new_n111_));
