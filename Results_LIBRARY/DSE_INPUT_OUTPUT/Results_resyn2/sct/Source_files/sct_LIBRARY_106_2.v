...
module FAU ( 
  ...
  nor2   g18(.a(new_n37_), .b(new_n46_), .O(new_n53_));
  ...
  oai21  g25(.a(new_n59_), .b(new_n48_), .c(new_n38_), .O(z04));
  nand2  g26(.a(new_n48_), .b(new_n38_), .O(new_n61_));
  nand3  g27(.a(x08), .b(x07), .c(x06), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n38_), .c(x09), .O(new_n63_));
  inv1   g29(.a(x09), .O(new_n64_));
  inv1   g30(.a(new_n62_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(x17), .c(new_n64_), .O(new_n66_));
  ...
  aoi21  g39(.a(new_n66_), .b(x10), .c(new_n48_), .O(new_n74_));
  ...
  oai21  g45(.a(new_n71_), .b(new_n54_), .c(x11), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n49_), .O(z07));
  inv1   g47(.a(x11), .O(new_n82_));
  nand4  g48(.a(new_n70_), .b(new_n53_), .c(new_n82_), .d(new_n68_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x12), .O(new_n84_));
  nand3  g50(.a(new_n64_), .b(x08), .c(x07), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n68_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n85_), .c(x17), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n84_), .c(new_n49_), .O(z08));
  nand2  g56(.a(new_n89_), .b(x13), .O(new_n91_));
  nor3   g57(.a(new_n62_), .b(new_n37_), .c(x09), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand3  g59(.a(new_n76_), .b(new_n93_), .c(new_n86_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  aoi22  g61(.a(new_n95_), .b(new_n92_), .c(new_n48_), .d(new_n38_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n91_), .O(z09));
  ...
  nand3  g69(.a(new_n103_), .b(new_n92_), .c(new_n47_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n101_), .c(new_n98_), .O(z10));
  ...
  nand2  g75(.a(new_n38_), .b(new_n98_), .O(z13));
  oai21  g76(.a(new_n37_), .b(new_n98_), .c(new_n38_), .O(z14));
endmodule
