...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
  ...
  nor2   g06(.a(new_n37_), .b(new_n40_), .O(z13));
  nor2   g07(.a(x15), .b(x05), .O(new_n42_));
  aoi22  g08(.a(new_n42_), .b(x18), .c(z13), .d(x05), .O(z01));
  ...
  and2   g33(.a(new_n67_), .b(new_n55_), .O(z05));
  inv1   g34(.a(x10), .O(new_n69_));
  inv1   g35(.a(new_n66_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g37(.a(new_n66_), .b(x10), .c(new_n53_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n71_), .c(new_n37_), .O(z06));
  inv1   g39(.a(x18), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(x11), .c(new_n44_), .O(new_n75_));
  inv1   g41(.a(new_n61_), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n65_), .O(new_n78_));
  nand4  g44(.a(new_n69_), .b(new_n65_), .c(x08), .d(x07), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x11), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n75_), .d(new_n48_), .O(z07));
  ...
  oai21  g52(.a(new_n74_), .b(x12), .c(new_n44_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n82_), .d(new_n48_), .O(z08));
  ...
  oai21  g60(.a(new_n74_), .b(x13), .c(new_n44_), .O(new_n95_));
  ...
  nor2   g66(.a(new_n66_), .b(new_n47_), .O(new_n101_));
  nor2   g67(.a(new_n52_), .b(new_n36_), .O(new_n102_));
  aoi21  g68(.a(new_n101_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n40_), .c(new_n55_), .O(z10));
  nand2  g70(.a(new_n55_), .b(new_n51_), .O(z11));
  inv1   g71(.a(z13), .O(new_n106_));
  aoi21  g72(.a(x16), .b(new_n51_), .c(x03), .O(new_n107_));
