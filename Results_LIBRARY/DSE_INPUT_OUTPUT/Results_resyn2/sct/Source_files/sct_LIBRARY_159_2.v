...
module FAU ( 
  ...
  nor2   g35(.a(new_n58_), .b(x09), .O(new_n70_));
  ...
  aoi21  g44(.a(new_n75_), .b(new_n70_), .c(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(new_n78_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n65_), .c(new_n57_), .O(new_n81_));
  ...
  nand2  g52(.a(new_n86_), .b(new_n70_), .O(new_n87_));
  oai21  g53(.a(new_n80_), .b(new_n65_), .c(x13), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n52_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n70_), .c(new_n57_), .O(new_n92_));
  nand2  g58(.a(new_n50_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n51_), .O(z10));
  nor2   g60(.a(z02), .b(new_n56_), .O(z11));
  nand2  g61(.a(x16), .b(new_n56_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n48_), .c(new_n51_), .O(z12));
