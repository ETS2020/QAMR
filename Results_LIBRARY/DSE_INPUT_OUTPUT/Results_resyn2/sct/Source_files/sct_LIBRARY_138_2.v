...
module FAU ( 
  ...
  nand4  g23(.a(new_n57_), .b(new_n56_), .c(new_n54_), .d(new_n39_), .O(new_n58_));
  ...
  nand3  g33(.a(new_n67_), .b(new_n63_), .c(new_n54_), .O(z05));
  nand2  g34(.a(new_n67_), .b(x10), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  nand3  g36(.a(x17), .b(new_n70_), .c(x06), .O(new_n71_));
  or2    g37(.a(new_n71_), .b(new_n65_), .O(new_n72_));
  nand2  g38(.a(new_n48_), .b(new_n39_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n69_), .O(z06));
  inv1   g40(.a(x11), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n70_), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n65_), .c(x17), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x06), .O(new_n78_));
  nand2  g44(.a(new_n72_), .b(x11), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(z07));
  ...
  aoi21  g51(.a(new_n48_), .b(new_n39_), .c(new_n85_), .O(new_n86_));
  ...
  oai21  g57(.a(new_n84_), .b(new_n62_), .c(x13), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n54_), .O(z09));
  inv1   g59(.a(new_n62_), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n89_), .b(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n94_), .c(new_n47_), .d(new_n64_), .O(new_n97_));
  nand3  g63(.a(new_n53_), .b(new_n39_), .c(x14), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n50_), .O(z10));
  nor2   g65(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n35_), .c(x03), .O(new_n101_));
  nor3   g67(.a(new_n101_), .b(new_n38_), .c(new_n50_), .O(z12));
  nand2  g68(.a(new_n39_), .b(new_n50_), .O(z13));
