...
module FAU ( 
  ...
  oai21  g23(.a(new_n57_), .b(new_n53_), .c(new_n38_), .O(z03));
  ...
  aoi21  g30(.a(new_n64_), .b(x07), .c(new_n36_), .O(new_n65_));
  aoi21  g31(.a(new_n59_), .b(x09), .c(new_n49_), .O(new_n66_));
  oai22  g32(.a(new_n66_), .b(new_n36_), .c(new_n65_), .d(new_n37_), .O(z05));
  ...
  nand4  g37(.a(new_n64_), .b(new_n71_), .c(x07), .d(x06), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n50_), .O(z06));
  nor2   g39(.a(x11), .b(x10), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n64_), .c(x07), .O(new_n75_));
  ...
  oai21  g44(.a(new_n78_), .b(new_n36_), .c(new_n77_), .O(z07));
  oai21  g45(.a(new_n75_), .b(x12), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  inv1   g47(.a(new_n74_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n69_), .c(x12), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n55_), .O(new_n84_));
  ...
  nand3  g54(.a(new_n74_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x13), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand3  g57(.a(new_n74_), .b(new_n91_), .c(new_n87_), .O(new_n92_));
  ...
  nor2   g63(.a(new_n69_), .b(new_n49_), .O(new_n98_));
  inv1   g64(.a(x14), .O(new_n99_));
  nor2   g65(.a(new_n55_), .b(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n98_), .b(new_n97_), .c(new_n100_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g68(.a(new_n38_), .b(new_n54_), .O(z11));
  nand2  g69(.a(x16), .b(new_n54_), .O(new_n104_));
