...
module FAU ( 
  ...
  nor3   g32(.a(new_n66_), .b(new_n37_), .c(new_n46_), .O(new_n67_));
  nand2  g33(.a(new_n58_), .b(x10), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n63_), .O(z06));
  nand2  g35(.a(new_n63_), .b(x11), .O(new_n70_));
  nor2   g36(.a(x11), .b(x10), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n57_), .c(x08), .d(x07), .O(new_n72_));
  ...
  nand3  g43(.a(new_n71_), .b(new_n77_), .c(new_n76_), .O(new_n78_));
  nand2  g44(.a(new_n72_), .b(x12), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n67_), .O(z08));
  ...
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n67_), .O(z09));
  inv1   g50(.a(x00), .O(new_n85_));
  nand3  g51(.a(new_n71_), .b(new_n82_), .c(new_n76_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n77_), .c(new_n48_), .O(new_n88_));
  aoi21  g54(.a(new_n66_), .b(x14), .c(new_n37_), .O(new_n89_));
