...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n64_, new_n66_, new_n68_, new_n72_, new_n74_;
  ...
  aoi21  g38(.a(new_n72_), .b(new_n49_), .c(new_n43_), .O(z12));
  inv1   g39(.a(x17), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n42_), .c(new_n53_), .O(z14));
endmodule
