...
module FAU ( 
  ...
  aoi21  g19(.a(x06), .b(new_n47_), .c(new_n50_), .O(new_n54_));
  ...
  nand2  g24(.a(new_n58_), .b(new_n40_), .O(z03));
  ...
  nand4  g44(.a(new_n71_), .b(new_n78_), .c(new_n74_), .d(new_n70_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(x12), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n51_), .O(z08));
  nand2  g47(.a(new_n79_), .b(x13), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n78_), .c(new_n74_), .d(new_n70_), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n71_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n51_), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  nand2  g54(.a(new_n84_), .b(new_n88_), .O(new_n89_));
  nor2   g55(.a(new_n67_), .b(new_n50_), .O(new_n90_));
  inv1   g56(.a(x02), .O(new_n91_));
  oai21  g57(.a(x03), .b(new_n91_), .c(x16), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n36_), .O(new_n93_));
  aoi21  g59(.a(new_n90_), .b(new_n89_), .c(new_n93_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n47_), .c(new_n40_), .O(z10));
  nor2   g61(.a(new_n37_), .b(new_n91_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n91_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n47_), .c(new_n40_), .O(z12));
  nand2  g64(.a(x06), .b(new_n47_), .O(z13));
