...
module FAU ( 
  ...
  nor2   g24(.a(new_n52_), .b(x09), .O(new_n60_));
  inv1   g25(.a(new_n60_), .O(new_n61_));
  nand3  g26(.a(new_n61_), .b(new_n59_), .c(new_n58_), .O(z05));
  inv1   g27(.a(x10), .O(new_n63_));
  nor2   g28(.a(new_n60_), .b(new_n63_), .O(new_n64_));
  inv1   g29(.a(x09), .O(new_n65_));
  nand4  g30(.a(new_n63_), .b(new_n65_), .c(x08), .d(x07), .O(new_n66_));
  nand2  g31(.a(new_n66_), .b(new_n49_), .O(new_n67_));
  oai21  g32(.a(new_n67_), .b(new_n64_), .c(x06), .O(new_n68_));
  nand2  g33(.a(new_n68_), .b(x04), .O(z06));
  nand2  g34(.a(new_n66_), .b(x11), .O(new_n70_));
  nor2   g35(.a(x11), .b(x10), .O(new_n71_));
  nand4  g36(.a(new_n71_), .b(new_n65_), .c(x08), .d(x07), .O(new_n72_));
  nand3  g37(.a(new_n72_), .b(new_n70_), .c(new_n49_), .O(new_n73_));
  nand2  g38(.a(new_n73_), .b(x06), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(x04), .O(z07));
  inv1   g40(.a(x12), .O(new_n76_));
  nand3  g41(.a(new_n71_), .b(new_n60_), .c(new_n76_), .O(new_n77_));
  nand2  g42(.a(new_n72_), .b(x12), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n77_), .c(new_n58_), .O(z08));
  nand2  g44(.a(new_n77_), .b(x13), .O(new_n80_));
  inv1   g45(.a(x13), .O(new_n81_));
  nand4  g46(.a(new_n71_), .b(new_n60_), .c(new_n81_), .d(new_n76_), .O(new_n82_));
  nand3  g47(.a(new_n82_), .b(new_n80_), .c(new_n58_), .O(z09));
  nand2  g48(.a(new_n57_), .b(x14), .O(new_n84_));
  inv1   g49(.a(x00), .O(new_n85_));
  nand3  g50(.a(new_n71_), .b(new_n81_), .c(new_n76_), .O(new_n86_));
  nand2  g51(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g52(.a(new_n87_), .b(new_n60_), .c(new_n49_), .O(new_n88_));
  aoi21  g53(.a(new_n88_), .b(new_n84_), .c(new_n44_), .O(z10));
  nor2   g54(.a(new_n38_), .b(new_n36_), .O(z11));
  aoi21  g55(.a(x16), .b(new_n36_), .c(x03), .O(new_n91_));
  nor2   g56(.a(new_n91_), .b(new_n44_), .O(z12));
  inv1   g57(.a(new_n44_), .O(z13));
  nand2  g58(.a(z13), .b(x17), .O(new_n94_));
  inv1   g59(.a(new_n94_), .O(z14));
  zero   g60(.O(z02));
endmodule
