...
module FAU ( 
  ...
  nand4  g39(.a(new_n73_), .b(new_n53_), .c(new_n64_), .d(x08), .O(new_n74_));
  ...
  aoi21  g47(.a(new_n74_), .b(x12), .c(new_n49_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n51_), .c(new_n81_), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n78_), .c(new_n77_), .d(new_n68_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n76_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  inv1   g53(.a(new_n58_), .O(new_n88_));
  nor2   g54(.a(x12), .b(x09), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n73_), .c(new_n88_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x13), .c(new_n49_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n51_), .c(new_n87_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n85_), .b(new_n93_), .O(new_n94_));
  nor2   g60(.a(new_n65_), .b(new_n49_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g62(.a(new_n49_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n51_), .O(z10));
