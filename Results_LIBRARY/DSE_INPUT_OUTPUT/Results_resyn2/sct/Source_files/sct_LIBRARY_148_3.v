...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    new_n43_, new_n44_, new_n45_, new_n48_, new_n49_, new_n51_, new_n53_,
  ...
  nor2   g12(.a(x06), .b(new_n41_), .O(z13));
  inv1   g13(.a(x02), .O(new_n48_));
  oai21  g14(.a(x03), .b(new_n48_), .c(x16), .O(new_n49_));
  and2   g15(.a(new_n49_), .b(z13), .O(z02));
  nand3  g16(.a(new_n49_), .b(z13), .c(x07), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(z03));
  inv1   g18(.a(x06), .O(new_n53_));
  nand2  g19(.a(new_n49_), .b(x08), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(new_n53_), .c(new_n41_), .O(z04));
  inv1   g21(.a(x09), .O(new_n56_));
  nand3  g22(.a(new_n49_), .b(z13), .c(new_n56_), .O(z05));
  inv1   g23(.a(x10), .O(new_n58_));
  nand3  g24(.a(new_n49_), .b(z13), .c(new_n58_), .O(z06));
  inv1   g25(.a(x03), .O(new_n60_));
  inv1   g26(.a(x16), .O(new_n61_));
  aoi21  g27(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(x11), .c(new_n53_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z07));
  oai21  g30(.a(new_n62_), .b(x12), .c(new_n53_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(z08));
  inv1   g32(.a(x13), .O(new_n67_));
  nand3  g33(.a(new_n49_), .b(z13), .c(new_n67_), .O(z09));
  nand2  g34(.a(new_n62_), .b(x14), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n53_), .c(new_n41_), .O(z10));
  aoi21  g36(.a(x06), .b(x04), .c(new_n48_), .O(z11));
  nand2  g37(.a(x16), .b(new_n48_), .O(new_n72_));
  nor2   g38(.a(x06), .b(x03), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n72_), .c(new_n41_), .O(z12));
  inv1   g40(.a(x17), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n53_), .c(new_n41_), .O(z14));
endmodule
