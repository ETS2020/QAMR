...
module FAU ( 
  ...
  nand3  g16(.a(new_n50_), .b(new_n38_), .c(new_n45_), .O(new_n51_));
  ...
  nand2  g23(.a(new_n55_), .b(new_n45_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  oai21  g25(.a(new_n59_), .b(new_n54_), .c(new_n38_), .O(z03));
  xor2a  g26(.a(new_n57_), .b(x08), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n54_), .c(new_n38_), .O(z04));
  nand2  g28(.a(new_n50_), .b(new_n38_), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  nand2  g30(.a(new_n56_), .b(x08), .O(new_n65_));
  ...
  nor2   g38(.a(new_n72_), .b(new_n54_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n71_), .c(new_n37_), .O(z06));
  inv1   g40(.a(x10), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  nand3  g42(.a(new_n68_), .b(new_n76_), .c(new_n75_), .O(new_n77_));
  nand4  g43(.a(new_n56_), .b(new_n75_), .c(new_n66_), .d(x08), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(x11), .c(new_n54_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n77_), .c(new_n37_), .O(z07));
  nand2  g46(.a(new_n77_), .b(x12), .O(new_n81_));
  nor2   g47(.a(x12), .b(x11), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n72_), .c(new_n54_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n81_), .c(new_n37_), .O(z08));
  ...
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n64_), .O(z09));
  ...
  nand3  g59(.a(new_n93_), .b(new_n68_), .c(new_n53_), .O(new_n94_));
  aoi21  g60(.a(new_n49_), .b(x14), .c(new_n37_), .O(new_n95_));
