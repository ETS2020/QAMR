...
module FAU ( 
  ...
  nand3  g37(.a(new_n71_), .b(new_n68_), .c(new_n50_), .O(z06));
  nand2  g38(.a(new_n71_), .b(x11), .O(new_n73_));
  nor2   g39(.a(x11), .b(x10), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n54_), .c(new_n65_), .d(x08), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n50_), .O(z07));
  nand2  g42(.a(new_n65_), .b(x08), .O(new_n77_));
  inv1   g43(.a(x11), .O(new_n78_));
  inv1   g44(.a(x12), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n78_), .c(new_n69_), .d(x07), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n77_), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  aoi21  g48(.a(new_n75_), .b(x12), .c(new_n49_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n36_), .c(new_n82_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n74_), .b(new_n70_), .c(new_n85_), .d(new_n79_), .O(new_n86_));
  oai21  g52(.a(new_n75_), .b(x12), .c(x13), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n50_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand3  g55(.a(new_n74_), .b(new_n85_), .c(new_n79_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nor2   g57(.a(new_n66_), .b(new_n49_), .O(new_n92_));
  inv1   g58(.a(x14), .O(new_n93_));
  inv1   g59(.a(x02), .O(new_n94_));
  oai21  g60(.a(x03), .b(new_n94_), .c(x16), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g62(.a(new_n92_), .b(new_n91_), .c(new_n96_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g64(.a(new_n38_), .b(new_n94_), .O(z11));
  nand2  g65(.a(x16), .b(new_n94_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n47_), .c(new_n36_), .O(z12));
  nor2   g67(.a(new_n37_), .b(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z13));
  nor2   g69(.a(x17), .b(new_n36_), .O(new_n104_));
