...
module FAU ( 
  ...
  nor3   g15(.a(new_n49_), .b(new_n44_), .c(x06), .O(z02));
  ...
  oai21  g25(.a(new_n37_), .b(new_n59_), .c(new_n53_), .O(new_n60_));
  inv1   g26(.a(new_n53_), .O(new_n61_));
  ...
  nand4  g36(.a(new_n61_), .b(x10), .c(new_n66_), .d(x08), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n52_), .c(new_n37_), .O(z06));
  ...
  oai21  g45(.a(x11), .b(new_n41_), .c(new_n54_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n75_), .d(new_n52_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand3  g48(.a(new_n78_), .b(new_n82_), .c(x06), .O(new_n83_));
  ...
  oai21  g52(.a(x12), .b(new_n41_), .c(new_n54_), .O(new_n87_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n82_), .c(new_n76_), .d(new_n69_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  oai21  g60(.a(x13), .b(new_n41_), .c(new_n54_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n89_), .d(new_n52_), .O(z09));
  ...
  aoi21  g67(.a(new_n49_), .b(x14), .c(new_n37_), .O(new_n102_));
  ...
  nand2  g71(.a(new_n38_), .b(x04), .O(new_n106_));
