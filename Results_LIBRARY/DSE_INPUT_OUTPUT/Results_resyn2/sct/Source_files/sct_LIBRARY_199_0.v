...
module FAU ( 
  ...
  oai21  g28(.a(new_n62_), .b(new_n37_), .c(x06), .O(new_n63_));
  inv1   g29(.a(x09), .O(new_n64_));
  inv1   g30(.a(new_n59_), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n48_), .c(x04), .O(new_n67_));
  ...
  nand4  g38(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(x10), .c(new_n48_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n37_), .c(new_n72_), .O(z06));
  oai21  g41(.a(new_n70_), .b(x11), .c(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  inv1   g43(.a(x11), .O(new_n78_));
  aoi21  g44(.a(new_n69_), .b(new_n65_), .c(new_n78_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n48_), .c(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n77_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  inv1   g48(.a(new_n70_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n78_), .d(x06), .O(new_n84_));
  and2   g50(.a(x08), .b(x07), .O(new_n85_));
  nand4  g51(.a(new_n69_), .b(new_n85_), .c(new_n78_), .d(x06), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n49_), .O(z08));
  oai21  g54(.a(new_n86_), .b(x12), .c(x13), .O(new_n89_));
  inv1   g55(.a(new_n73_), .O(new_n90_));
  inv1   g56(.a(x10), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n82_), .c(new_n78_), .d(new_n91_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n89_), .c(new_n49_), .O(z09));
  ...
  aoi21  g67(.a(new_n101_), .b(new_n97_), .c(new_n37_), .O(z10));
  ...
  nor2   g71(.a(new_n38_), .b(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z13));
  nor2   g73(.a(x17), .b(new_n37_), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n106_), .O(z14));
endmodule
