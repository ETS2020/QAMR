...
module FAU ( 
  ...
  aoi21  g23(.a(new_n57_), .b(x02), .c(new_n37_), .O(new_n58_));
  nor2   g24(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  ...
  oai21  g31(.a(new_n38_), .b(x09), .c(new_n63_), .O(new_n66_));
  nand2  g32(.a(x08), .b(x07), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(x09), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x06), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n59_), .O(z05));
  oai21  g36(.a(x16), .b(x10), .c(new_n47_), .O(new_n71_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n62_), .c(x08), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n71_), .d(new_n59_), .O(z06));
  oai21  g43(.a(new_n73_), .b(x10), .c(x11), .O(new_n78_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n78_), .d(new_n59_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  aoi21  g50(.a(new_n80_), .b(new_n68_), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n80_), .b(new_n84_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n73_), .c(new_n50_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n85_), .c(x06), .O(new_n88_));
  oai21  g54(.a(new_n84_), .b(x06), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n39_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n88_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand3  g58(.a(new_n80_), .b(new_n92_), .c(new_n84_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n79_), .O(new_n95_));
  oai21  g61(.a(new_n86_), .b(new_n73_), .c(x13), .O(new_n96_));
  oai21  g62(.a(x16), .b(x13), .c(new_n47_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n59_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n68_), .c(new_n50_), .O(new_n101_));
  nand2  g67(.a(new_n58_), .b(x14), .O(new_n102_));
  nand2  g68(.a(x06), .b(x04), .O(new_n103_));
  aoi21  g69(.a(new_n102_), .b(new_n101_), .c(new_n103_), .O(z10));
  nand2  g70(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g71(.a(x16), .b(new_n35_), .O(new_n106_));
  nor2   g72(.a(new_n38_), .b(x03), .O(new_n107_));
  aoi22  g73(.a(new_n107_), .b(new_n106_), .c(new_n39_), .d(new_n56_), .O(z12));
  nand2  g74(.a(new_n39_), .b(new_n56_), .O(z13));
  nand2  g75(.a(x17), .b(x04), .O(new_n110_));
  nor2   g76(.a(new_n110_), .b(new_n38_), .O(z14));
endmodule
