...
module FAU ( 
  ...
  nor2   g02(.a(x18), .b(x04), .O(new_n37_));
  ...
  inv1   g32(.a(x18), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(x04), .O(new_n68_));
  inv1   g34(.a(new_n68_), .O(z13));
  ...
  nand3  g39(.a(new_n73_), .b(new_n52_), .c(new_n72_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n71_), .c(new_n70_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(z13), .O(z06));
  oai21  g43(.a(new_n64_), .b(x10), .c(x11), .O(new_n78_));
  nor2   g44(.a(x11), .b(x10), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n73_), .c(new_n52_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n70_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(z13), .O(z07));
  inv1   g49(.a(x11), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n72_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n64_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  inv1   g53(.a(new_n57_), .O(new_n88_));
  nand4  g54(.a(new_n79_), .b(new_n88_), .c(new_n87_), .d(new_n63_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n70_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(z13), .O(z08));
  nand4  g58(.a(new_n87_), .b(new_n84_), .c(new_n72_), .d(new_n63_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n57_), .c(x13), .O(new_n94_));
  nor2   g60(.a(x13), .b(x12), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n79_), .c(new_n73_), .d(new_n52_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n94_), .c(new_n70_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(z13), .O(z09));
  nand2  g65(.a(new_n47_), .b(x14), .O(new_n100_));
  inv1   g66(.a(new_n64_), .O(new_n101_));
  inv1   g67(.a(x00), .O(new_n102_));
  nand2  g68(.a(new_n95_), .b(new_n79_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n101_), .c(new_n70_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n100_), .c(new_n44_), .O(z10));
  ...
  nor2   g75(.a(x17), .b(new_n44_), .O(new_n110_));
  nor2   g76(.a(new_n110_), .b(new_n68_), .O(z14));
endmodule
