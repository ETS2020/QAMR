...
module FAU ( 
  ...
  nand3  g28(.a(new_n62_), .b(new_n60_), .c(new_n56_), .O(new_n63_));
  ...
  oai21  g34(.a(new_n41_), .b(x10), .c(new_n45_), .O(new_n69_));
  ...
  oai21  g45(.a(new_n41_), .b(x11), .c(new_n45_), .O(new_n80_));
  ...
  oai21  g51(.a(new_n41_), .b(x12), .c(new_n45_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n50_), .O(z08));
  nand2  g53(.a(x13), .b(new_n45_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n53_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n56_), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand3  g57(.a(new_n82_), .b(new_n76_), .c(new_n71_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n70_), .c(new_n91_), .O(new_n93_));
  nor2   g59(.a(new_n78_), .b(x09), .O(new_n94_));
  nor3   g60(.a(x12), .b(x11), .c(x10), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n93_), .c(x06), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n90_), .O(z09));
  inv1   g64(.a(new_n67_), .O(new_n99_));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n91_), .b(new_n82_), .c(new_n76_), .d(new_n71_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n99_), .c(new_n53_), .O(new_n103_));
  nand3  g69(.a(new_n49_), .b(new_n56_), .c(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n46_), .O(z10));
  nor2   g71(.a(new_n37_), .b(new_n36_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n36_), .c(x03), .O(new_n107_));
  nor2   g73(.a(new_n37_), .b(new_n46_), .O(z13));
  inv1   g74(.a(z13), .O(new_n109_));
  nor2   g75(.a(new_n109_), .b(new_n107_), .O(z12));
