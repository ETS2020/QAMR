...
module FAU ( 
  ...
  nor3   g37(.a(x12), .b(x11), .c(x10), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n63_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n57_), .O(z08));
  inv1   g40(.a(x13), .O(new_n75_));
  aoi21  g41(.a(new_n72_), .b(new_n63_), .c(new_n75_), .O(new_n76_));
  nor2   g42(.a(x13), .b(x12), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n68_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n60_), .c(new_n48_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n76_), .c(x06), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(z09));
  inv1   g47(.a(x00), .O(new_n82_));
  nand2  g48(.a(new_n78_), .b(new_n82_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n63_), .c(new_n48_), .O(new_n84_));
  inv1   g50(.a(x06), .O(new_n85_));
  aoi21  g51(.a(new_n56_), .b(x14), .c(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n84_), .c(new_n37_), .O(z10));
  nor2   g53(.a(z02), .b(new_n36_), .O(z11));
  nand2  g54(.a(x16), .b(new_n36_), .O(new_n89_));
  nor2   g55(.a(new_n85_), .b(x03), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n37_), .O(z12));
  inv1   g57(.a(new_n44_), .O(z13));
  nand2  g58(.a(z13), .b(x17), .O(new_n93_));
