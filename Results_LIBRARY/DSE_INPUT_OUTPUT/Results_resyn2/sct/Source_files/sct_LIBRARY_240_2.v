...
module FAU ( 
  ...
  nand4  g34(.a(new_n68_), .b(new_n62_), .c(x08), .d(x07), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n55_), .O(new_n70_));
