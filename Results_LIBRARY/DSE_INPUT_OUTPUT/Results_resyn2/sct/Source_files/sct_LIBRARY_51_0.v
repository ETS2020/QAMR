...
module FAU ( 
  ...
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n52_), .O(z06));
  ...
  aoi21  g48(.a(new_n75_), .b(x11), .c(new_n51_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n37_), .c(new_n82_), .O(z07));
  oai21  g50(.a(new_n80_), .b(x12), .c(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nor3   g53(.a(x11), .b(x10), .c(x09), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n73_), .c(new_n87_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n51_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n86_), .O(z08));
  nor2   g57(.a(x13), .b(x12), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n68_), .c(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  nand4  g61(.a(new_n79_), .b(new_n73_), .c(new_n87_), .d(new_n67_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(x13), .c(new_n51_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n37_), .c(new_n95_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nor2   g66(.a(new_n76_), .b(new_n51_), .O(new_n101_));
  nor2   g67(.a(new_n60_), .b(new_n41_), .O(new_n102_));
  ...
  aoi21  g74(.a(x06), .b(new_n37_), .c(new_n108_), .O(z14));
endmodule
