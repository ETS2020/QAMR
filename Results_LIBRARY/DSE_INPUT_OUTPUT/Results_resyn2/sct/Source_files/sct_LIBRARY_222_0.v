...
module FAU ( 
  ...
  nor2   g16(.a(new_n49_), .b(new_n41_), .O(new_n51_));
  inv1   g17(.a(x07), .O(new_n52_));
  nor2   g18(.a(new_n52_), .b(new_n42_), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(new_n54_));
  nand2  g20(.a(new_n52_), .b(new_n42_), .O(new_n55_));
  ...
  nand4  g37(.a(new_n53_), .b(new_n71_), .c(new_n63_), .d(x08), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n51_), .O(z06));
  nor2   g39(.a(x11), .b(x10), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n64_), .c(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  aoi21  g43(.a(new_n72_), .b(x11), .c(new_n49_), .O(new_n78_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n74_), .c(new_n81_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n80_), .c(new_n51_), .O(z08));
  and2   g50(.a(x08), .b(x07), .O(new_n85_));
  nor2   g51(.a(x13), .b(x12), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n74_), .c(new_n85_), .d(new_n63_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x13), .c(new_n49_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n41_), .c(new_n89_), .O(z09));
  nand2  g57(.a(new_n49_), .b(x14), .O(new_n92_));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n86_), .b(new_n74_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nor2   g61(.a(new_n69_), .b(new_n49_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n92_), .c(new_n41_), .O(z10));
  nor2   g64(.a(new_n37_), .b(new_n36_), .O(z11));
  nand2  g65(.a(x16), .b(new_n36_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n47_), .c(new_n41_), .O(z12));
  nand2  g67(.a(x17), .b(x04), .O(new_n102_));
  oai21  g68(.a(x06), .b(x04), .c(new_n102_), .O(z14));
  buf    g69(.a(x04), .O(z13));
endmodule
