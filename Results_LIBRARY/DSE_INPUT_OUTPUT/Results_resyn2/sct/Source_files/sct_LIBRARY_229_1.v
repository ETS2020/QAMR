...
module FAU ( 
  ...
  nand3  g36(.a(new_n67_), .b(new_n60_), .c(new_n70_), .O(new_n71_));
  nand2  g37(.a(new_n70_), .b(x04), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n68_), .c(new_n51_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n71_), .c(new_n38_), .O(z06));
  oai21  g40(.a(x11), .b(new_n48_), .c(new_n37_), .O(new_n75_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n67_), .c(new_n60_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n56_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n75_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n79_), .b(new_n67_), .c(new_n60_), .d(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n80_), .b(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(z08));
  oai21  g53(.a(x13), .b(new_n48_), .c(new_n37_), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  nand3  g55(.a(new_n84_), .b(new_n89_), .c(new_n70_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n77_), .c(x13), .O(new_n91_));
  nor2   g57(.a(x13), .b(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n79_), .c(new_n67_), .d(new_n60_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n56_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n88_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n92_), .b(new_n79_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g65(.a(new_n49_), .b(x02), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(x16), .c(new_n77_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n48_), .O(new_n102_));
  nand3  g68(.a(new_n51_), .b(x14), .c(x04), .O(new_n103_));
  oai21  g69(.a(new_n102_), .b(new_n37_), .c(new_n103_), .O(z10));
  nand2  g70(.a(new_n42_), .b(new_n36_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n36_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n48_), .c(new_n42_), .O(z12));
