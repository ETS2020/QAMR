...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n47_), .c(x06), .d(x04), .O(new_n50_));
  ...
  nor2   g32(.a(new_n53_), .b(x09), .O(new_n67_));
  ...
  aoi21  g45(.a(new_n76_), .b(new_n67_), .c(new_n79_), .O(new_n80_));
  nor2   g46(.a(x13), .b(x12), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n64_), .c(new_n49_), .O(new_n83_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n67_), .c(new_n49_), .O(new_n88_));
  aoi21  g54(.a(new_n60_), .b(x14), .c(new_n36_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(new_n52_), .O(z10));
  nor2   g56(.a(z02), .b(new_n48_), .O(z11));
  nand2  g57(.a(x16), .b(new_n48_), .O(new_n92_));
  nor2   g58(.a(new_n36_), .b(x03), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n52_), .O(z12));
  inv1   g60(.a(x17), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x06), .c(new_n52_), .O(z14));
  buf    g62(.a(x04), .O(z13));
endmodule
