...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n37_), .c(new_n47_), .d(x04), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z02));
  nand2  g17(.a(new_n49_), .b(x04), .O(new_n52_));
  xnor2a g18(.a(x07), .b(x06), .O(new_n53_));
  oai21  g19(.a(new_n53_), .b(new_n52_), .c(new_n37_), .O(z03));
  nand3  g20(.a(new_n49_), .b(new_n37_), .c(x04), .O(new_n55_));
  nand2  g21(.a(x07), .b(x06), .O(new_n56_));
  xor2a  g22(.a(new_n56_), .b(x08), .O(new_n57_));
  nor2   g23(.a(new_n57_), .b(new_n55_), .O(z04));
  inv1   g24(.a(x04), .O(new_n59_));
  inv1   g25(.a(x03), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x02), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(x16), .c(new_n59_), .O(new_n62_));
  inv1   g28(.a(x08), .O(new_n63_));
  oai21  g29(.a(new_n56_), .b(new_n63_), .c(x09), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n62_), .c(new_n37_), .O(z05));
  inv1   g31(.a(x10), .O(new_n66_));
  inv1   g32(.a(new_n37_), .O(new_n67_));
  aoi21  g33(.a(new_n62_), .b(new_n66_), .c(new_n67_), .O(z06));
  inv1   g34(.a(x11), .O(new_n69_));
  aoi21  g35(.a(new_n62_), .b(new_n69_), .c(new_n67_), .O(z07));
  inv1   g36(.a(x12), .O(new_n71_));
  aoi21  g37(.a(new_n62_), .b(new_n71_), .c(new_n67_), .O(z08));
  inv1   g38(.a(x13), .O(new_n73_));
  nand3  g39(.a(new_n62_), .b(new_n37_), .c(new_n73_), .O(z09));
  nand2  g40(.a(new_n37_), .b(x04), .O(new_n75_));
  nand3  g41(.a(new_n61_), .b(x16), .c(x14), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n75_), .O(z10));
  nand2  g43(.a(new_n37_), .b(new_n48_), .O(z11));
  aoi21  g44(.a(x16), .b(new_n48_), .c(x03), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n59_), .c(new_n37_), .O(z12));
  inv1   g46(.a(new_n75_), .O(z13));
  nand2  g47(.a(x17), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n37_), .O(z14));
endmodule
