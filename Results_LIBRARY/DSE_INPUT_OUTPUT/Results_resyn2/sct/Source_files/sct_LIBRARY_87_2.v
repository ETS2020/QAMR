...
module FAU ( 
  ...
  oai21  g45(.a(new_n79_), .b(new_n60_), .c(new_n50_), .O(new_n80_));
  ...
  oai21  g52(.a(new_n79_), .b(new_n60_), .c(x13), .O(new_n87_));
  nor2   g53(.a(new_n36_), .b(new_n47_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n50_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n71_), .c(new_n50_), .O(new_n92_));
  inv1   g58(.a(new_n50_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x14), .c(new_n36_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n92_), .c(new_n47_), .O(z10));
  nor2   g61(.a(z02), .b(new_n49_), .O(z11));
  nand2  g62(.a(x16), .b(new_n49_), .O(new_n97_));
  nor2   g63(.a(new_n36_), .b(x03), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n47_), .O(z12));
