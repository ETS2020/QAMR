...
module FAU ( 
  ...
  aoi21  g19(.a(new_n37_), .b(new_n42_), .c(new_n49_), .O(new_n54_));
  ...
  nand2  g29(.a(new_n63_), .b(new_n53_), .O(z04));
  oai21  g30(.a(x09), .b(new_n42_), .c(new_n37_), .O(new_n65_));
  ...
  oai21  g38(.a(x10), .b(new_n42_), .c(new_n68_), .O(new_n73_));
  inv1   g39(.a(new_n60_), .O(new_n74_));
  nor2   g40(.a(x10), .b(x09), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n74_), .c(new_n49_), .O(new_n76_));
  ...
  nand2  g45(.a(new_n75_), .b(new_n74_), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n80_), .c(new_n49_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n79_), .c(new_n38_), .O(z07));
  inv1   g50(.a(x12), .O(new_n85_));
  nand3  g51(.a(new_n78_), .b(new_n67_), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g56(.a(new_n78_), .b(new_n90_), .c(new_n85_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n67_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n89_), .c(new_n50_), .O(z09));
  ...
  aoi21  g65(.a(new_n97_), .b(x16), .c(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n96_), .c(new_n42_), .O(new_n101_));
  nand3  g67(.a(new_n49_), .b(x14), .c(x04), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n37_), .c(new_n102_), .O(z10));
  nand2  g69(.a(new_n53_), .b(new_n36_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n36_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n42_), .c(new_n53_), .O(z12));
  nand2  g72(.a(new_n37_), .b(new_n42_), .O(z13));
