...
module FAU ( 
  ...
  aoi21  g33(.a(new_n59_), .b(x09), .c(new_n49_), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(new_n37_), .c(new_n67_), .O(z05));
  nand4  g35(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x10), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(new_n70_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n71_), .c(new_n50_), .O(z06));
  nand2  g41(.a(new_n74_), .b(x11), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n53_), .c(new_n64_), .d(x08), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n50_), .O(z07));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n72_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n65_), .c(x04), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  aoi21  g50(.a(new_n78_), .b(x12), .c(new_n49_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n37_), .c(new_n84_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n81_), .c(new_n80_), .d(new_n72_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n65_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x06), .O(new_n90_));
  inv1   g56(.a(new_n59_), .O(new_n91_));
  nor2   g57(.a(x12), .b(x09), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n77_), .c(new_n91_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x13), .c(new_n49_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n37_), .c(new_n90_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand2  g62(.a(new_n88_), .b(new_n96_), .O(new_n97_));
  nor2   g63(.a(new_n70_), .b(new_n49_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g65(.a(new_n49_), .b(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n37_), .O(z10));
  nand2  g67(.a(new_n39_), .b(new_n35_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n35_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n37_), .c(new_n39_), .O(z12));
  nand2  g70(.a(x06), .b(new_n37_), .O(z13));
