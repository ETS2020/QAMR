...
module FAU ( 
  ...
  oai21  g31(.a(new_n37_), .b(x09), .c(new_n59_), .O(new_n66_));
  ...
  oai21  g39(.a(new_n73_), .b(x10), .c(new_n46_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n69_), .d(new_n51_), .O(z06));
  ...
  nand2  g45(.a(new_n76_), .b(new_n68_), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(new_n71_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n79_), .c(x06), .O(new_n82_));
  oai21  g48(.a(x03), .b(new_n35_), .c(x16), .O(new_n83_));
  nand2  g49(.a(x11), .b(new_n46_), .O(new_n84_));
  ...
  oai21  g53(.a(new_n80_), .b(new_n71_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n76_), .c(new_n68_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n64_), .O(new_n92_));
  oai21  g58(.a(new_n73_), .b(x12), .c(new_n46_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n88_), .d(new_n51_), .O(z08));
  oai21  g60(.a(new_n90_), .b(new_n71_), .c(x13), .O(new_n95_));
  inv1   g61(.a(new_n71_), .O(new_n96_));
  nand3  g62(.a(new_n91_), .b(new_n96_), .c(new_n73_), .O(new_n97_));
  nor2   g63(.a(new_n50_), .b(new_n46_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n95_), .d(x04), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  oai21  g66(.a(new_n90_), .b(x13), .c(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n98_), .c(new_n96_), .O(new_n102_));
  ...
  nand2  g73(.a(new_n38_), .b(new_n47_), .O(z13));
