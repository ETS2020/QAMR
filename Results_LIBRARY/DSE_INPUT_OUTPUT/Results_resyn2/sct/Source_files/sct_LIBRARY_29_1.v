...
module FAU ( 
  ...
  oai21  g19(.a(new_n51_), .b(new_n37_), .c(new_n45_), .O(new_n54_));
  nand3  g20(.a(new_n54_), .b(new_n53_), .c(new_n46_), .O(new_n55_));
  ...
  or2    g36(.a(new_n69_), .b(x11), .O(new_n71_));
  nand2  g37(.a(new_n69_), .b(x11), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n48_), .O(z07));
  oai21  g39(.a(x12), .b(new_n37_), .c(new_n45_), .O(new_n74_));
  inv1   g40(.a(x12), .O(new_n75_));
  nor2   g41(.a(new_n58_), .b(new_n51_), .O(new_n76_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n68_), .c(new_n67_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n78_), .c(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n74_), .O(z08));
  oai21  g49(.a(x13), .b(new_n37_), .c(new_n45_), .O(new_n84_));
  nand4  g50(.a(new_n79_), .b(new_n68_), .c(x08), .d(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x13), .O(new_n86_));
  nor2   g52(.a(x13), .b(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n79_), .c(new_n63_), .d(new_n52_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n46_), .O(new_n89_));
  ...
  nand2  g59(.a(new_n87_), .b(new_n79_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n63_), .c(new_n52_), .d(new_n46_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n92_), .c(new_n37_), .O(z10));
  ...
  nand2  g66(.a(new_n45_), .b(new_n37_), .O(z13));
