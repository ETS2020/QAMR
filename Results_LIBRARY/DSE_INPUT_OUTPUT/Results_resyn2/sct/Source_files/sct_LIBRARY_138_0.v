...
module FAU ( 
  ...
  nand2  g19(.a(new_n50_), .b(new_n53_), .O(new_n54_));
  ...
  oai21  g27(.a(new_n37_), .b(x09), .c(new_n55_), .O(new_n62_));
  ...
  oai21  g32(.a(new_n55_), .b(x09), .c(x10), .O(new_n67_));
  ...
  oai21  g36(.a(new_n37_), .b(x11), .c(new_n66_), .O(new_n71_));
  nand3  g37(.a(new_n59_), .b(x08), .c(x07), .O(new_n72_));
  inv1   g38(.a(new_n72_), .O(new_n73_));
  nor2   g39(.a(x11), .b(x10), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(x06), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n71_), .c(new_n58_), .O(z07));
  inv1   g42(.a(x12), .O(new_n77_));
  nor2   g43(.a(new_n77_), .b(x06), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n47_), .c(new_n38_), .O(new_n79_));
  nand3  g45(.a(new_n74_), .b(new_n73_), .c(x12), .O(new_n80_));
  inv1   g46(.a(new_n74_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n72_), .c(new_n77_), .O(new_n82_));
  ...
  oai22  g51(.a(new_n85_), .b(new_n61_), .c(new_n37_), .d(x13), .O(new_n86_));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n65_), .c(new_n47_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n73_), .c(new_n46_), .d(x06), .O(new_n96_));
  inv1   g62(.a(new_n46_), .O(new_n97_));
  ...
  nor3   g67(.a(new_n101_), .b(new_n37_), .c(new_n93_), .O(z12));
  nand2  g68(.a(new_n38_), .b(new_n93_), .O(z13));
  nand2  g69(.a(x17), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n38_), .O(z14));
endmodule
