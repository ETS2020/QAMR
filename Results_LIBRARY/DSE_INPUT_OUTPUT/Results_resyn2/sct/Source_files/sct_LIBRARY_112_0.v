...
module FAU ( 
  ...
  nor2   g17(.a(new_n51_), .b(new_n50_), .O(z14));
  nand2  g18(.a(z14), .b(new_n49_), .O(new_n53_));
  nor2   g19(.a(new_n53_), .b(new_n48_), .O(z02));
  ...
  oai21  g30(.a(new_n64_), .b(new_n56_), .c(new_n38_), .O(z04));
  inv1   g31(.a(x09), .O(new_n66_));
  inv1   g32(.a(new_n63_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g34(.a(new_n63_), .b(x09), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n68_), .c(new_n55_), .d(x04), .O(new_n70_));
  and2   g36(.a(new_n70_), .b(new_n38_), .O(z05));
  inv1   g37(.a(new_n56_), .O(new_n72_));
  oai21  g38(.a(new_n51_), .b(x10), .c(new_n49_), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  inv1   g40(.a(new_n58_), .O(new_n75_));
  nor2   g41(.a(x09), .b(new_n61_), .O(new_n76_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n73_), .d(new_n72_), .O(z06));
  oai21  g46(.a(new_n37_), .b(x11), .c(new_n77_), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  nand4  g48(.a(new_n76_), .b(new_n75_), .c(new_n82_), .d(new_n74_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n72_), .O(z07));
  nand2  g50(.a(x08), .b(x07), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(x09), .O(new_n86_));
  nor2   g52(.a(x11), .b(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n66_), .c(x08), .d(x07), .O(new_n88_));
  nor3   g54(.a(x12), .b(x11), .c(x10), .O(new_n89_));
  aoi22  g55(.a(new_n89_), .b(new_n86_), .c(new_n88_), .d(x12), .O(new_n90_));
  nand2  g56(.a(x12), .b(new_n49_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n55_), .c(x04), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n38_), .O(new_n93_));
  oai21  g59(.a(new_n90_), .b(new_n49_), .c(new_n93_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x06), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n56_), .c(new_n38_), .O(new_n97_));
  nand3  g63(.a(new_n89_), .b(new_n86_), .c(x13), .O(new_n98_));
  inv1   g64(.a(x12), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n82_), .c(new_n74_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n78_), .c(new_n95_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n98_), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n97_), .O(z09));
  nor2   g69(.a(new_n37_), .b(x04), .O(new_n104_));
  nor2   g70(.a(new_n63_), .b(x09), .O(new_n105_));
  inv1   g71(.a(x00), .O(new_n106_));
  oai21  g72(.a(new_n100_), .b(x13), .c(new_n106_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n105_), .c(new_n55_), .O(new_n108_));
  aoi21  g74(.a(new_n48_), .b(x14), .c(new_n37_), .O(new_n109_));
  ...
  nor2   g78(.a(new_n37_), .b(x03), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n112_), .c(new_n104_), .O(z12));
