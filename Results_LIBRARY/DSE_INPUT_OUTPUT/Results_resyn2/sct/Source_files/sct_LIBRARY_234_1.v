...
module FAU ( 
  ...
  oai21  g22(.a(new_n56_), .b(new_n49_), .c(new_n37_), .O(z03));
  ...
  oai21  g33(.a(x10), .b(new_n36_), .c(new_n46_), .O(new_n68_));
  ...
  oai21  g42(.a(x11), .b(new_n36_), .c(new_n46_), .O(new_n77_));
  ...
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n36_), .O(new_n104_));
  nand3  g70(.a(new_n49_), .b(x14), .c(x04), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(new_n46_), .c(new_n105_), .O(z10));
  inv1   g72(.a(x02), .O(new_n107_));
  aoi21  g73(.a(x06), .b(new_n36_), .c(new_n107_), .O(z11));
  aoi21  g74(.a(x16), .b(new_n107_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n36_), .c(new_n37_), .O(z12));
  nand2  g76(.a(new_n46_), .b(new_n36_), .O(z13));
