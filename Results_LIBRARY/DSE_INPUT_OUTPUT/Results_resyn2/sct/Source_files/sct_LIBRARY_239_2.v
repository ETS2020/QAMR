...
module FAU ( 
  ...
  oai21  g20(.a(new_n54_), .b(new_n50_), .c(new_n37_), .O(z03));
  ...
  nand3  g25(.a(new_n59_), .b(new_n56_), .c(new_n37_), .O(new_n60_));
  nor2   g26(.a(new_n60_), .b(new_n50_), .O(z04));
  nand4  g27(.a(x17), .b(x08), .c(x07), .d(x06), .O(new_n62_));
  ...
  nand3  g33(.a(new_n67_), .b(new_n63_), .c(new_n51_), .O(z05));
  nand2  g34(.a(new_n67_), .b(x10), .O(new_n69_));
  nand2  g35(.a(new_n50_), .b(new_n37_), .O(new_n70_));
  ...
  nand4  g40(.a(new_n71_), .b(new_n64_), .c(x08), .d(x07), .O(new_n75_));
  ...
  nand4  g45(.a(new_n72_), .b(new_n79_), .c(new_n71_), .d(new_n64_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n70_), .O(z07));
  nand2  g47(.a(new_n80_), .b(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n71_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n65_), .c(x17), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n51_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n83_), .c(new_n79_), .d(new_n71_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n65_), .c(x17), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand4  g57(.a(new_n83_), .b(new_n79_), .c(new_n71_), .d(new_n64_), .O(new_n92_));
  ...
  nand4  g63(.a(new_n97_), .b(new_n72_), .c(new_n49_), .d(new_n64_), .O(new_n98_));
  ...
  nand2  g68(.a(new_n37_), .b(new_n48_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n48_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n95_), .c(new_n37_), .O(z12));
  aoi21  g71(.a(new_n36_), .b(x06), .c(new_n95_), .O(z13));
  oai21  g72(.a(new_n36_), .b(new_n95_), .c(new_n37_), .O(z14));
endmodule
