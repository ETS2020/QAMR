...
module FAU ( 
  ...
  nand3  g17(.a(new_n51_), .b(new_n36_), .c(new_n42_), .O(new_n52_));
  ...
  oai21  g53(.a(x12), .b(x05), .c(new_n36_), .O(new_n88_));
  ...
  aoi21  g64(.a(new_n50_), .b(x16), .c(new_n36_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(new_n83_), .O(new_n100_));
  nand4  g66(.a(new_n50_), .b(new_n37_), .c(x16), .d(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n48_), .O(z10));
  inv1   g68(.a(x02), .O(new_n103_));
  nor2   g69(.a(new_n65_), .b(new_n103_), .O(z11));
