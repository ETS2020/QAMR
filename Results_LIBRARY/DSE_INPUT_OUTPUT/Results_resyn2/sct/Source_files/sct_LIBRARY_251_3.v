...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n64_, new_n66_, new_n68_, new_n70_, new_n73_, new_n75_;
  ...
  nor2   g22(.a(x06), .b(new_n48_), .O(z13));
  nand2  g23(.a(z13), .b(x08), .O(new_n58_));
  nor2   g24(.a(new_n58_), .b(new_n51_), .O(z04));
  inv1   g25(.a(x09), .O(new_n60_));
  nand3  g26(.a(new_n54_), .b(z13), .c(new_n60_), .O(z05));
  inv1   g27(.a(x10), .O(new_n62_));
  nand3  g28(.a(new_n54_), .b(z13), .c(new_n62_), .O(z06));
  oai21  g29(.a(new_n51_), .b(x11), .c(new_n41_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(z07));
  inv1   g31(.a(x12), .O(new_n66_));
  nand3  g32(.a(new_n54_), .b(z13), .c(new_n66_), .O(z08));
  oai21  g33(.a(new_n51_), .b(x13), .c(new_n41_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x04), .O(z09));
  nand2  g35(.a(new_n51_), .b(x14), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n41_), .c(new_n48_), .O(z10));
