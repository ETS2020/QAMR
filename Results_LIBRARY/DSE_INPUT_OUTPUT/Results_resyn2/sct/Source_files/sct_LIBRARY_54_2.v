...
module FAU ( 
  ...
  nand4  g40(.a(new_n74_), .b(new_n65_), .c(x08), .d(x06), .O(new_n75_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n83_), .c(new_n65_), .d(x08), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  oai21  g52(.a(new_n75_), .b(new_n55_), .c(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n52_), .O(z08));
  nand2  g54(.a(new_n65_), .b(x08), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand3  g56(.a(new_n74_), .b(new_n90_), .c(new_n83_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n89_), .c(x07), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  oai21  g59(.a(new_n84_), .b(new_n59_), .c(x13), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n52_), .O(z09));
  inv1   g61(.a(new_n70_), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n91_), .b(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n78_), .O(new_n99_));
  nand3  g65(.a(new_n51_), .b(new_n42_), .c(x14), .O(new_n100_));
  ...
  nor3   g69(.a(new_n103_), .b(new_n38_), .c(new_n48_), .O(z12));
  nand2  g70(.a(new_n42_), .b(new_n48_), .O(z13));
  inv1   g71(.a(x17), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n48_), .c(new_n42_), .O(z14));
endmodule
