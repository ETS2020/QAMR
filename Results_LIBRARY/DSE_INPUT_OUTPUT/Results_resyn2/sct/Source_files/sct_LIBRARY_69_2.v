...
module FAU ( 
  ...
  nor2   g35(.a(new_n57_), .b(x09), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g37(.a(new_n66_), .b(x10), .O(new_n73_));
  nand3  g38(.a(new_n73_), .b(new_n72_), .c(new_n54_), .O(z06));
  nand2  g39(.a(new_n72_), .b(x11), .O(new_n75_));
  nor2   g40(.a(x11), .b(x10), .O(new_n76_));
  nand2  g41(.a(new_n76_), .b(new_n71_), .O(new_n77_));
  nand3  g42(.a(new_n77_), .b(new_n75_), .c(new_n54_), .O(z07));
  inv1   g43(.a(x12), .O(new_n79_));
  nand3  g44(.a(new_n76_), .b(new_n71_), .c(new_n79_), .O(new_n80_));
  nand2  g45(.a(new_n77_), .b(x12), .O(new_n81_));
  nand3  g46(.a(new_n81_), .b(new_n80_), .c(new_n54_), .O(z08));
  nand2  g47(.a(new_n80_), .b(x13), .O(new_n83_));
  inv1   g48(.a(x11), .O(new_n84_));
  inv1   g49(.a(x13), .O(new_n85_));
  nand4  g50(.a(new_n85_), .b(new_n79_), .c(new_n84_), .d(new_n70_), .O(new_n86_));
  inv1   g51(.a(new_n86_), .O(new_n87_));
  nand2  g52(.a(new_n87_), .b(new_n71_), .O(new_n88_));
  nand3  g53(.a(new_n88_), .b(new_n83_), .c(new_n54_), .O(z09));
  inv1   g54(.a(x00), .O(new_n90_));
  nand2  g55(.a(new_n86_), .b(new_n90_), .O(new_n91_));
  nand3  g56(.a(new_n91_), .b(new_n71_), .c(new_n63_), .O(new_n92_));
  nand2  g57(.a(new_n53_), .b(x14), .O(new_n93_));
  aoi21  g58(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(z10));
  nand2  g59(.a(new_n37_), .b(new_n62_), .O(z11));
  nand2  g60(.a(x16), .b(new_n62_), .O(new_n96_));
  aoi21  g61(.a(new_n96_), .b(new_n51_), .c(new_n46_), .O(z12));
  inv1   g62(.a(x04), .O(new_n98_));
  inv1   g63(.a(x17), .O(new_n99_));
  aoi21  g64(.a(new_n99_), .b(x06), .c(new_n98_), .O(z14));
  zero   g65(.O(z02));
  buf    g66(.a(x04), .O(z13));
endmodule
