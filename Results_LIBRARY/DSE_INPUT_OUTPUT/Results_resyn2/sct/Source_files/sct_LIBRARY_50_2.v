...
module FAU ( 
  ...
  nand3  g47(.a(new_n81_), .b(new_n79_), .c(new_n51_), .O(z08));
  inv1   g48(.a(x13), .O(new_n83_));
  aoi21  g49(.a(new_n80_), .b(new_n73_), .c(new_n83_), .O(new_n84_));
  nor2   g50(.a(x13), .b(x12), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n62_), .c(new_n59_), .O(new_n87_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n73_), .c(new_n59_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n90_), .c(new_n44_), .O(z10));
  nor2   g60(.a(z02), .b(new_n35_), .O(z11));
  nand2  g61(.a(x16), .b(new_n35_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n48_), .c(new_n44_), .O(z12));
