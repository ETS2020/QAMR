...
module FAU ( 
  ...
  oai21  g25(.a(new_n59_), .b(new_n55_), .c(new_n39_), .O(z03));
  xor2a  g26(.a(new_n56_), .b(x08), .O(new_n61_));
  oai21  g27(.a(new_n61_), .b(new_n55_), .c(new_n39_), .O(z04));
  ...
  nand4  g32(.a(x13), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  ...
  nand3  g44(.a(x13), .b(new_n78_), .c(x06), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  aoi21  g46(.a(new_n55_), .b(new_n39_), .c(new_n80_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n77_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n78_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n72_), .c(x13), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  oai21  g52(.a(new_n79_), .b(new_n72_), .c(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n51_), .O(z08));
  aoi21  g54(.a(x13), .b(new_n37_), .c(new_n50_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n85_), .c(new_n39_), .d(x04), .O(z09));
  nand3  g56(.a(new_n50_), .b(new_n39_), .c(x14), .O(new_n91_));
  nor2   g57(.a(new_n63_), .b(new_n37_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n65_), .c(new_n54_), .d(x00), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n47_), .O(z10));
  nor2   g60(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g61(.a(x16), .b(new_n35_), .c(x03), .O(new_n96_));
  nor3   g62(.a(new_n96_), .b(new_n38_), .c(new_n47_), .O(z12));
  nand2  g63(.a(new_n39_), .b(new_n47_), .O(z13));
  inv1   g64(.a(x17), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n47_), .c(new_n39_), .O(z14));
endmodule
