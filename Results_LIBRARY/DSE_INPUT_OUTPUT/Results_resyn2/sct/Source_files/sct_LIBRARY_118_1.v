...
module FAU ( 
  ...
  nand2  g03(.a(x12), .b(new_n37_), .O(new_n38_));
  ...
  nand3  g17(.a(new_n51_), .b(new_n46_), .c(new_n37_), .O(new_n52_));
  ...
  nor3   g26(.a(new_n60_), .b(new_n58_), .c(new_n55_), .O(z04));
  ...
  nand4  g34(.a(new_n68_), .b(new_n67_), .c(x08), .d(x07), .O(new_n69_));
  nand2  g35(.a(x08), .b(x07), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(x09), .c(x10), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x06), .O(new_n73_));
  nand3  g39(.a(new_n46_), .b(x10), .c(new_n37_), .O(new_n74_));
  nand2  g40(.a(new_n55_), .b(new_n38_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(z06));
  nor2   g42(.a(new_n70_), .b(x09), .O(new_n77_));
  nor2   g43(.a(x11), .b(x10), .O(new_n78_));
  aoi22  g44(.a(new_n78_), .b(new_n77_), .c(new_n69_), .d(x11), .O(new_n79_));
  nand2  g45(.a(x11), .b(new_n37_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n54_), .c(x04), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n38_), .O(new_n82_));
  oai21  g48(.a(new_n79_), .b(new_n37_), .c(new_n82_), .O(z07));
  nand4  g49(.a(new_n78_), .b(new_n67_), .c(x08), .d(x07), .O(new_n84_));
  xor2a  g50(.a(new_n84_), .b(x12), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n37_), .c(new_n75_), .O(z08));
  ...
  oai21  g56(.a(new_n90_), .b(new_n69_), .c(new_n87_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n46_), .O(new_n92_));
  oai21  g58(.a(x13), .b(x12), .c(new_n37_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n55_), .O(new_n94_));
  nor2   g60(.a(new_n89_), .b(new_n37_), .O(new_n95_));
  oai21  g61(.a(new_n84_), .b(x12), .c(new_n95_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n94_), .c(new_n92_), .O(z09));
  nor2   g63(.a(new_n62_), .b(x04), .O(new_n98_));
  inv1   g64(.a(x00), .O(new_n99_));
  nand3  g65(.a(new_n78_), .b(new_n89_), .c(new_n46_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n64_), .c(new_n54_), .O(new_n102_));
  aoi21  g68(.a(new_n50_), .b(x14), .c(new_n62_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z10));
  nand2  g70(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n35_), .c(x03), .O(new_n106_));
  nor3   g72(.a(new_n106_), .b(new_n62_), .c(new_n47_), .O(z12));
