...
module FAU ( 
  ...
  nor2   g17(.a(x06), .b(new_n47_), .O(z13));
  nand2  g18(.a(z13), .b(x07), .O(new_n53_));
  nor2   g19(.a(new_n53_), .b(new_n50_), .O(z03));
  nand2  g20(.a(z13), .b(x08), .O(new_n55_));
  nor2   g21(.a(new_n55_), .b(new_n50_), .O(z04));
  inv1   g22(.a(x09), .O(new_n57_));
  oai21  g23(.a(x03), .b(new_n38_), .c(x16), .O(new_n58_));
  nand3  g24(.a(z13), .b(new_n58_), .c(new_n57_), .O(z05));
  ...
  oai21  g31(.a(new_n50_), .b(x13), .c(new_n43_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x04), .O(z09));
  nand2  g33(.a(new_n43_), .b(x04), .O(new_n68_));
  nor3   g34(.a(new_n68_), .b(new_n58_), .c(new_n36_), .O(z10));
  nand2  g35(.a(new_n40_), .b(new_n38_), .O(z11));
