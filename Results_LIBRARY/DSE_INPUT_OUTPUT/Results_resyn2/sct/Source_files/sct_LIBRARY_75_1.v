...
module FAU ( 
  ...
  oai21  g22(.a(new_n56_), .b(new_n48_), .c(new_n37_), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n51_), .c(new_n42_), .O(z03));
  ...
  oai21  g30(.a(x09), .b(new_n48_), .c(new_n37_), .O(new_n65_));
  inv1   g31(.a(new_n51_), .O(new_n66_));
  nor2   g32(.a(new_n60_), .b(x09), .O(new_n67_));
  inv1   g33(.a(new_n67_), .O(new_n68_));
  oai21  g34(.a(new_n61_), .b(new_n56_), .c(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(new_n70_));
  ...
  nand3  g42(.a(new_n76_), .b(new_n73_), .c(new_n52_), .O(z06));
  nor2   g43(.a(x11), .b(x10), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n76_), .c(new_n51_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n79_), .c(new_n38_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand3  g50(.a(new_n78_), .b(new_n67_), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n79_), .b(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(z08));
  nand2  g53(.a(new_n85_), .b(x13), .O(new_n88_));
  inv1   g54(.a(x13), .O(new_n89_));
  nand3  g55(.a(new_n78_), .b(new_n89_), .c(new_n84_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n67_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n52_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n90_), .b(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n49_), .b(x02), .O(new_n96_));
  inv1   g62(.a(x09), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x08), .c(x07), .O(new_n98_));
  aoi21  g64(.a(new_n96_), .b(x16), .c(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n95_), .c(new_n48_), .O(new_n100_));
  nand3  g66(.a(new_n51_), .b(x14), .c(x04), .O(new_n101_));
  oai21  g67(.a(new_n100_), .b(new_n37_), .c(new_n101_), .O(z10));
  nor2   g68(.a(new_n38_), .b(new_n36_), .O(z11));
  nand2  g69(.a(x16), .b(new_n36_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n49_), .c(new_n48_), .O(z12));
  nand2  g71(.a(new_n37_), .b(new_n48_), .O(z13));
