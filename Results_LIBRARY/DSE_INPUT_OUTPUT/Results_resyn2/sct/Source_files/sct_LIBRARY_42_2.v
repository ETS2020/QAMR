...
module FAU ( 
  ...
  and2   g08(.a(x05), .b(x04), .O(new_n43_));
  aoi22  g09(.a(new_n43_), .b(new_n39_), .c(new_n42_), .d(x18), .O(z01));
  inv1   g10(.a(x06), .O(new_n45_));
  inv1   g11(.a(x04), .O(new_n46_));
  inv1   g12(.a(x03), .O(new_n47_));
  nand3  g13(.a(x18), .b(new_n47_), .c(x02), .O(new_n48_));
  ...
  oai21  g29(.a(new_n63_), .b(new_n58_), .c(new_n39_), .O(z04));
  ...
  nand3  g40(.a(new_n71_), .b(new_n74_), .c(new_n70_), .O(new_n75_));
  nand2  g41(.a(new_n72_), .b(x11), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n49_), .O(z07));
  nand2  g43(.a(new_n75_), .b(x12), .O(new_n78_));
  nor2   g44(.a(x09), .b(new_n61_), .O(new_n79_));
  nor2   g45(.a(x12), .b(x11), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n59_), .d(new_n70_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n49_), .O(z08));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n71_), .c(new_n58_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n83_), .c(new_n38_), .O(z09));
  nor2   g54(.a(new_n38_), .b(x04), .O(new_n89_));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n71_), .c(new_n57_), .O(new_n92_));
  inv1   g58(.a(new_n57_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x14), .c(new_n38_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n92_), .c(new_n89_), .O(z10));
  nand2  g61(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g62(.a(x18), .b(x02), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x16), .c(x03), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n89_), .O(z12));
  inv1   g65(.a(new_n89_), .O(z13));
  inv1   g66(.a(x17), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n46_), .c(new_n39_), .O(z14));
endmodule
