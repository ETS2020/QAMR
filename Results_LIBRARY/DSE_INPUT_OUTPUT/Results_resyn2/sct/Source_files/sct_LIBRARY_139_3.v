...
module FAU ( 
  ...
  nor2   g16(.a(x06), .b(new_n40_), .O(new_n51_));
  nand2  g17(.a(new_n51_), .b(x07), .O(new_n52_));
  nor2   g18(.a(new_n52_), .b(new_n49_), .O(z03));
  ...
  nand3  g23(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(z05));
  inv1   g24(.a(x10), .O(new_n59_));
  nand3  g25(.a(new_n57_), .b(new_n51_), .c(new_n59_), .O(z06));
  oai21  g26(.a(new_n49_), .b(x11), .c(new_n46_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x04), .O(z07));
  inv1   g28(.a(x12), .O(new_n63_));
  nand3  g29(.a(new_n57_), .b(new_n51_), .c(new_n63_), .O(z08));
