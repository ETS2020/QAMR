...
module FAU ( 
  ...
  nand3  g38(.a(new_n62_), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  nand3  g39(.a(new_n67_), .b(x08), .c(x07), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x11), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n46_), .O(new_n76_));
  ...
  nand4  g45(.a(new_n67_), .b(new_n72_), .c(x08), .d(x07), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n67_), .b(new_n66_), .c(new_n82_), .d(new_n72_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n46_), .O(new_n84_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n82_), .c(new_n72_), .d(new_n71_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n62_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n48_), .O(z09));
