...
module FAU ( 
  ...
  nor2   g21(.a(x06), .b(new_n41_), .O(new_n56_));
  nand2  g22(.a(new_n56_), .b(x08), .O(new_n57_));
  nor2   g23(.a(new_n57_), .b(new_n50_), .O(z04));
  oai21  g24(.a(new_n50_), .b(x09), .c(new_n47_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x04), .O(z05));
  inv1   g26(.a(x10), .O(new_n61_));
  nand3  g27(.a(new_n53_), .b(new_n56_), .c(new_n61_), .O(z06));
  inv1   g28(.a(x11), .O(new_n63_));
  nand3  g29(.a(new_n53_), .b(new_n56_), .c(new_n63_), .O(z07));
  inv1   g30(.a(x12), .O(new_n65_));
  nand3  g31(.a(new_n53_), .b(new_n56_), .c(new_n65_), .O(z08));
  inv1   g32(.a(x13), .O(new_n67_));
  nand3  g33(.a(new_n53_), .b(new_n56_), .c(new_n67_), .O(z09));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n47_), .c(new_n41_), .O(z14));
  buf    g42(.a(x04), .O(z13));
endmodule
