...
module FAU ( 
  ...
  oai21  g25(.a(new_n59_), .b(new_n36_), .c(new_n54_), .O(new_n60_));
  nand3  g26(.a(x08), .b(x07), .c(x06), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n37_), .O(z04));
  oai21  g29(.a(x09), .b(new_n36_), .c(new_n61_), .O(new_n64_));
  ...
  nand4  g54(.a(new_n83_), .b(new_n81_), .c(x08), .d(x07), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x13), .O(new_n90_));
  nor2   g56(.a(x13), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n81_), .c(new_n66_), .d(new_n65_), .O(new_n92_));
  ...
  nand2  g62(.a(new_n91_), .b(new_n81_), .O(new_n97_));
  ...
  nand3  g67(.a(new_n101_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g68(.a(new_n100_), .b(x16), .c(new_n102_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n98_), .c(new_n36_), .O(new_n104_));
  nand3  g70(.a(new_n50_), .b(x14), .c(x04), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(new_n47_), .c(new_n105_), .O(z10));
  nand2  g72(.a(new_n37_), .b(new_n48_), .O(z11));
  nand2  g73(.a(x16), .b(new_n48_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n99_), .c(new_n36_), .O(z12));
