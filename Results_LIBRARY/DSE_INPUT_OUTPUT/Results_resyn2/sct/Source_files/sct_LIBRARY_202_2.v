...
module FAU ( 
  ...
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n51_), .O(z06));
  ...
  oai21  g42(.a(new_n76_), .b(new_n62_), .c(x12), .O(new_n77_));
  nor3   g43(.a(x12), .b(x11), .c(x10), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n66_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n54_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(z08));
  inv1   g48(.a(x13), .O(new_n83_));
  aoi21  g49(.a(new_n78_), .b(new_n66_), .c(new_n83_), .O(new_n84_));
  nor2   g50(.a(x13), .b(x12), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n70_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n62_), .c(new_n54_), .O(new_n87_));
  ...
  nand3  g57(.a(new_n91_), .b(new_n66_), .c(new_n54_), .O(new_n92_));
  inv1   g58(.a(x06), .O(new_n93_));
  aoi21  g59(.a(new_n50_), .b(x14), .c(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n92_), .c(new_n37_), .O(z10));
  nor2   g61(.a(z02), .b(new_n35_), .O(z11));
  nand2  g62(.a(x16), .b(new_n35_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n48_), .c(new_n44_), .O(z12));
  inv1   g64(.a(x17), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(x06), .c(new_n37_), .O(z14));
  buf    g66(.a(x04), .O(z13));
endmodule
