...
module FAU ( 
  ...
  inv1   g32(.a(new_n50_), .O(new_n67_));
  ...
  oai21  g37(.a(new_n60_), .b(x10), .c(x11), .O(new_n72_));
  ...
  aoi21  g44(.a(new_n73_), .b(new_n65_), .c(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n73_), .b(new_n78_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n60_), .c(new_n50_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n79_), .c(x06), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nand3  g50(.a(new_n73_), .b(new_n84_), .c(new_n78_), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  oai21  g53(.a(new_n80_), .b(new_n60_), .c(x13), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n69_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n65_), .c(new_n50_), .O(new_n92_));
  nand2  g58(.a(new_n67_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n68_), .O(z10));
  nor2   g60(.a(z02), .b(new_n49_), .O(z11));
  nand2  g61(.a(x16), .b(new_n49_), .O(new_n96_));
  nor2   g62(.a(new_n36_), .b(x03), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n47_), .O(z12));
  inv1   g64(.a(new_n68_), .O(z13));
  inv1   g65(.a(x17), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(x06), .c(new_n47_), .O(z14));
endmodule
