...
module FAU ( 
  ...
  nand2  g31(.a(new_n59_), .b(x09), .O(new_n66_));
  ...
  nand3  g43(.a(new_n73_), .b(new_n64_), .c(new_n77_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n50_), .O(z08));
  nand2  g45(.a(new_n78_), .b(x13), .O(new_n80_));
  inv1   g46(.a(x13), .O(new_n81_));
  nand3  g47(.a(new_n73_), .b(new_n81_), .c(new_n77_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n64_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n80_), .c(new_n50_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n47_), .b(x02), .O(new_n88_));
  inv1   g54(.a(x09), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(x08), .c(x07), .O(new_n90_));
  aoi21  g56(.a(new_n88_), .b(x16), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n87_), .c(new_n37_), .O(new_n92_));
  nand3  g58(.a(new_n49_), .b(x14), .c(x04), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n46_), .c(new_n93_), .O(z10));
  aoi21  g60(.a(x06), .b(new_n37_), .c(new_n35_), .O(z11));
  aoi21  g61(.a(x16), .b(new_n35_), .c(x03), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n37_), .c(new_n38_), .O(z12));
  nand2  g63(.a(new_n46_), .b(new_n37_), .O(z13));
