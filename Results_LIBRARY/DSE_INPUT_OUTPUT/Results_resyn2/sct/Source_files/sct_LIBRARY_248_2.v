...
module FAU ( 
  ...
  nand3  g14(.a(new_n48_), .b(new_n45_), .c(new_n41_), .O(new_n49_));
  inv1   g15(.a(new_n49_), .O(z02));
  inv1   g16(.a(x07), .O(new_n51_));
  nand2  g17(.a(new_n51_), .b(new_n45_), .O(new_n52_));
  oai21  g18(.a(x06), .b(x01), .c(x07), .O(new_n53_));
  ...
  oai21  g24(.a(new_n51_), .b(new_n45_), .c(new_n58_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  oai21  g26(.a(new_n60_), .b(new_n47_), .c(new_n56_), .O(z04));
  oai21  g27(.a(new_n42_), .b(x09), .c(new_n57_), .O(new_n62_));
  inv1   g28(.a(x09), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(z05));
  oai21  g31(.a(new_n42_), .b(x10), .c(new_n64_), .O(new_n66_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n63_), .c(x08), .d(x07), .O(new_n74_));
  ...
  oai21  g44(.a(new_n78_), .b(new_n47_), .c(new_n56_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n76_), .O(z07));
  xor2a  g46(.a(new_n74_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x06), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n47_), .c(new_n56_), .O(new_n84_));
  oai21  g50(.a(new_n81_), .b(new_n45_), .c(new_n84_), .O(z08));
  oai21  g51(.a(new_n74_), .b(x12), .c(x13), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand3  g53(.a(new_n73_), .b(new_n87_), .c(new_n82_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n68_), .O(new_n90_));
  oai21  g56(.a(x13), .b(x01), .c(new_n45_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n86_), .d(new_n48_), .O(z09));
