...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(x04), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g24(.a(new_n58_), .b(new_n53_), .c(new_n38_), .O(z04));
  nor2   g25(.a(new_n49_), .b(new_n36_), .O(new_n60_));
  ...
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n60_), .O(z06));
  inv1   g36(.a(x11), .O(new_n71_));
  nor2   g37(.a(x09), .b(new_n56_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n57_), .c(new_n71_), .d(new_n67_), .O(new_n73_));
  oai21  g39(.a(new_n64_), .b(x10), .c(x11), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n60_), .O(z07));
  nand2  g41(.a(new_n73_), .b(x12), .O(new_n76_));
  nor2   g42(.a(x12), .b(x11), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n72_), .c(new_n57_), .d(new_n67_), .O(new_n78_));
  ...
  nand3  g51(.a(new_n85_), .b(new_n80_), .c(new_n60_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(new_n87_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n68_), .c(new_n52_), .O(new_n89_));
  nand2  g55(.a(new_n49_), .b(x14), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n36_), .O(z10));
  nand2  g57(.a(new_n38_), .b(new_n51_), .O(z11));
  nand2  g58(.a(x16), .b(new_n51_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n47_), .c(new_n36_), .O(z12));
