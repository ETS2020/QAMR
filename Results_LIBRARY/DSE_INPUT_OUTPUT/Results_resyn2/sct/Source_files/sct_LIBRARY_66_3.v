...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n63_, new_n65_, new_n67_, new_n71_, new_n73_, new_n74_;
  ...
  nor2   g17(.a(new_n51_), .b(new_n43_), .O(z02));
  inv1   g18(.a(new_n43_), .O(new_n53_));
  oai21  g19(.a(x03), .b(new_n35_), .c(x16), .O(new_n54_));
  nand3  g20(.a(new_n54_), .b(new_n53_), .c(x07), .O(new_n55_));
  inv1   g21(.a(new_n55_), .O(z03));
  nand3  g22(.a(new_n54_), .b(new_n53_), .c(x08), .O(new_n57_));
  inv1   g23(.a(new_n57_), .O(z04));
  inv1   g24(.a(x09), .O(new_n59_));
  nand2  g25(.a(z02), .b(new_n59_), .O(z05));
  inv1   g26(.a(x10), .O(new_n61_));
  nand2  g27(.a(z02), .b(new_n61_), .O(z06));
  oai21  g28(.a(new_n51_), .b(x11), .c(new_n42_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z07));
  oai21  g30(.a(new_n51_), .b(x12), .c(new_n42_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(z08));
  inv1   g32(.a(x13), .O(new_n67_));
  nand2  g33(.a(z02), .b(new_n67_), .O(z09));
  nor3   g34(.a(new_n54_), .b(new_n43_), .c(new_n39_), .O(z10));
  aoi21  g35(.a(x06), .b(x04), .c(new_n35_), .O(z11));
  nand2  g36(.a(x16), .b(new_n35_), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n49_), .c(new_n43_), .O(z12));
  inv1   g38(.a(x04), .O(new_n73_));
  inv1   g39(.a(x17), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n42_), .c(new_n73_), .O(z14));
  buf    g41(.a(x04), .O(z13));
endmodule
