...
module FAU ( 
  ...
  nand2  g35(.a(new_n68_), .b(x04), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n66_), .c(new_n49_), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n69_), .c(new_n38_), .O(z06));
  oai21  g38(.a(x11), .b(new_n42_), .c(new_n37_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n77_), .b(new_n65_), .c(new_n58_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n54_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x04), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n73_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n77_), .b(new_n65_), .c(new_n58_), .d(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n78_), .b(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n50_), .O(z08));
  oai21  g51(.a(x13), .b(new_n42_), .c(new_n37_), .O(new_n86_));
  inv1   g52(.a(x11), .O(new_n87_));
  nand3  g53(.a(new_n82_), .b(new_n87_), .c(new_n68_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n75_), .c(x13), .O(new_n89_));
  nor2   g55(.a(x13), .b(x12), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n77_), .c(new_n65_), .d(new_n58_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n89_), .c(new_n54_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n86_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n90_), .b(new_n77_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g63(.a(new_n47_), .b(x02), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x16), .c(new_n75_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n97_), .c(new_n42_), .O(new_n100_));
  ...
  oai21  g70(.a(new_n104_), .b(new_n42_), .c(new_n39_), .O(z12));
