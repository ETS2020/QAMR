...
module FAU ( 
  ...
  aoi21  g36(.a(new_n70_), .b(new_n68_), .c(new_n46_), .O(new_n71_));
  oai21  g37(.a(new_n70_), .b(new_n68_), .c(new_n71_), .O(new_n72_));
  nand3  g38(.a(x12), .b(x10), .c(new_n46_), .O(new_n73_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z06));
  oai22  g41(.a(new_n66_), .b(x10), .c(new_n37_), .d(x11), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  nor2   g44(.a(new_n78_), .b(new_n70_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x06), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n76_), .c(new_n50_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand3  g48(.a(new_n79_), .b(new_n82_), .c(x06), .O(new_n83_));
  nand2  g49(.a(new_n80_), .b(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n74_), .O(z08));
  ...
  oai21  g55(.a(new_n78_), .b(new_n70_), .c(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n88_), .c(x06), .O(new_n91_));
  nand2  g57(.a(x13), .b(x12), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n74_), .O(z09));
  aoi22  g59(.a(new_n86_), .b(new_n77_), .c(x06), .d(x00), .O(new_n94_));
  oai21  g60(.a(x03), .b(new_n36_), .c(x16), .O(new_n95_));
  nand2  g61(.a(new_n65_), .b(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n49_), .b(x14), .O(new_n97_));
  oai21  g63(.a(new_n96_), .b(new_n94_), .c(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n53_), .O(z10));
  nor2   g66(.a(new_n37_), .b(new_n36_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n36_), .c(x03), .O(new_n102_));
  nand2  g68(.a(new_n53_), .b(x04), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n102_), .O(z12));
  inv1   g70(.a(new_n103_), .O(z13));
  nand2  g71(.a(x17), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n53_), .O(z14));
endmodule
