...
module FAU ( 
  ...
  nor2   g23(.a(x06), .b(new_n45_), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(new_n50_), .c(new_n57_), .O(z06));
  oai21  g25(.a(new_n48_), .b(x11), .c(new_n41_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(z07));
  inv1   g27(.a(x12), .O(new_n62_));
  nand3  g28(.a(new_n58_), .b(new_n50_), .c(new_n62_), .O(z08));
  inv1   g29(.a(x13), .O(new_n64_));
  nand3  g30(.a(new_n58_), .b(new_n50_), .c(new_n64_), .O(z09));
  ...
  nand2  g37(.a(new_n58_), .b(x17), .O(new_n72_));
