...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(x04), .O(new_n42_));
  ...
  and2   g31(.a(new_n65_), .b(new_n37_), .O(z05));
  ...
  nor2   g41(.a(x18), .b(x04), .O(new_n76_));
  ...
  inv1   g48(.a(new_n57_), .O(new_n83_));
  nand4  g49(.a(new_n73_), .b(new_n83_), .c(new_n82_), .d(new_n63_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n78_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n77_), .O(z08));
  nand4  g53(.a(new_n82_), .b(new_n79_), .c(new_n68_), .d(new_n63_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n57_), .c(x13), .O(new_n89_));
  nor2   g55(.a(x09), .b(new_n58_), .O(new_n90_));
  nor2   g56(.a(x13), .b(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n73_), .c(new_n90_), .d(new_n52_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n89_), .c(new_n78_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n77_), .O(z09));
  nand2  g61(.a(new_n47_), .b(x14), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n91_), .b(new_n73_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n69_), .c(new_n78_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n96_), .c(new_n36_), .O(z10));
  inv1   g67(.a(x02), .O(new_n102_));
  aoi21  g68(.a(x18), .b(new_n36_), .c(new_n102_), .O(z11));
  nand2  g69(.a(x16), .b(new_n102_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n45_), .c(new_n36_), .O(z12));
  inv1   g71(.a(x17), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(x04), .c(new_n76_), .O(z14));
  buf    g73(.a(x04), .O(z13));
endmodule
