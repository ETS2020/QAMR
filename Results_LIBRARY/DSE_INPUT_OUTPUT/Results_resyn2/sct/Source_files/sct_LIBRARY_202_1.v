...
module FAU ( 
  ...
  nor2   g17(.a(new_n51_), .b(new_n45_), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(new_n53_));
  nand2  g19(.a(new_n51_), .b(new_n45_), .O(new_n54_));
  nand3  g20(.a(new_n54_), .b(new_n53_), .c(new_n48_), .O(new_n55_));
  inv1   g21(.a(new_n55_), .O(z03));
  nand2  g22(.a(new_n52_), .b(x08), .O(new_n57_));
  inv1   g23(.a(x08), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n37_), .c(new_n53_), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(new_n57_), .c(new_n46_), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n38_), .O(z04));
  nand2  g27(.a(new_n57_), .b(x09), .O(new_n62_));
  nor2   g28(.a(x09), .b(new_n58_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(z05));
  inv1   g31(.a(x10), .O(new_n66_));
  nand3  g32(.a(new_n63_), .b(new_n52_), .c(new_n66_), .O(new_n67_));
  nand2  g33(.a(new_n64_), .b(x10), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n48_), .O(z06));
  oai21  g35(.a(x11), .b(new_n37_), .c(new_n45_), .O(new_n70_));
  nor2   g36(.a(x11), .b(x10), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n63_), .c(new_n52_), .O(new_n72_));
  inv1   g38(.a(x09), .O(new_n73_));
  nand4  g39(.a(new_n66_), .b(new_n73_), .c(x08), .d(x07), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x11), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n72_), .c(new_n46_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x04), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n70_), .O(z07));
  oai21  g44(.a(x12), .b(new_n37_), .c(new_n45_), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nand2  g46(.a(x08), .b(x07), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n71_), .c(new_n80_), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand3  g50(.a(new_n80_), .b(new_n84_), .c(x06), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n74_), .c(new_n46_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n83_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n79_), .O(z08));
  oai21  g54(.a(x13), .b(new_n37_), .c(new_n45_), .O(new_n89_));
  nand2  g55(.a(new_n80_), .b(new_n84_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n74_), .c(x13), .O(new_n91_));
  nor2   g57(.a(x13), .b(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n71_), .c(new_n63_), .d(new_n52_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n46_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n89_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n92_), .b(new_n71_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  inv1   g65(.a(x03), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x02), .O(new_n101_));
  nand3  g67(.a(new_n73_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g68(.a(new_n101_), .b(x16), .c(new_n102_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n99_), .c(new_n37_), .O(new_n104_));
  nand3  g70(.a(new_n47_), .b(x14), .c(x04), .O(new_n105_));
  ...
  aoi21  g74(.a(new_n108_), .b(new_n100_), .c(new_n37_), .O(z12));
  nor2   g75(.a(x06), .b(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z13));
  inv1   g77(.a(x17), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(x04), .c(new_n110_), .O(z14));
endmodule
