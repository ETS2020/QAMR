...
module FAU ( 
  ...
  oai21  g24(.a(new_n58_), .b(new_n55_), .c(new_n41_), .O(z03));
  ...
  nor2   g38(.a(new_n66_), .b(new_n51_), .O(new_n73_));
  oai21  g39(.a(new_n51_), .b(x10), .c(x04), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z06));
  oai21  g41(.a(new_n70_), .b(new_n47_), .c(x11), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  inv1   g43(.a(new_n60_), .O(new_n78_));
  nand3  g44(.a(new_n69_), .b(new_n78_), .c(new_n77_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n76_), .c(new_n52_), .O(z07));
  aoi21  g46(.a(new_n79_), .b(x12), .c(new_n51_), .O(new_n81_));
  nand3  g47(.a(new_n65_), .b(x08), .c(x07), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n77_), .c(new_n83_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n82_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  oai21  g53(.a(new_n81_), .b(new_n48_), .c(new_n87_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n84_), .c(new_n77_), .d(new_n83_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n82_), .c(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x06), .O(new_n92_));
  nor2   g58(.a(x12), .b(x11), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n69_), .c(new_n78_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(x13), .c(new_n51_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n48_), .c(new_n92_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n90_), .b(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n73_), .O(new_n99_));
  ...
  aoi21  g69(.a(new_n103_), .b(new_n49_), .c(new_n48_), .O(z12));
