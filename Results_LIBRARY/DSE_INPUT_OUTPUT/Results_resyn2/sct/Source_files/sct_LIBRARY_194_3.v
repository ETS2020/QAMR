...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n66_, new_n67_, new_n70_, new_n72_;
  ...
  nand3  g17(.a(new_n51_), .b(new_n50_), .c(x07), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z03));
  nand3  g19(.a(new_n51_), .b(new_n50_), .c(x08), .O(new_n54_));
  ...
  oai21  g25(.a(new_n47_), .b(x11), .c(new_n41_), .O(new_n60_));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n41_), .c(new_n66_), .O(z10));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n41_), .c(new_n66_), .O(z14));
  buf    g39(.a(x04), .O(z13));
endmodule
