...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n64_, new_n66_, new_n70_, new_n71_, new_n73_;
  ...
  oai21  g27(.a(new_n49_), .b(x11), .c(new_n43_), .O(new_n62_));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n70_), .c(new_n52_), .O(z12));
  inv1   g38(.a(x17), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n43_), .c(new_n52_), .O(z14));
  buf    g40(.a(x04), .O(z13));
endmodule
