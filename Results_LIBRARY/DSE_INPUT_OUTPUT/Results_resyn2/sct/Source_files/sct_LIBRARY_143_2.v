...
module FAU ( 
  ...
  aoi21  g24(.a(new_n58_), .b(x06), .c(new_n37_), .O(z04));
  nand2  g25(.a(new_n55_), .b(x09), .O(new_n60_));
  inv1   g26(.a(x09), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(x08), .c(x07), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(z05));
  nand2  g29(.a(new_n62_), .b(x10), .O(new_n64_));
  inv1   g30(.a(x10), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n61_), .c(x08), .d(x07), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n64_), .c(new_n54_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x04), .O(z06));
  nand2  g35(.a(new_n66_), .b(x11), .O(new_n70_));
  nor2   g36(.a(new_n55_), .b(x09), .O(new_n71_));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n54_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x06), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(z07));
  inv1   g42(.a(x12), .O(new_n77_));
  aoi21  g43(.a(new_n72_), .b(new_n71_), .c(new_n77_), .O(new_n78_));
  nand2  g44(.a(new_n72_), .b(new_n77_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n62_), .c(new_n54_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n78_), .c(x06), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(z08));
  inv1   g48(.a(x13), .O(new_n83_));
  nand3  g49(.a(new_n72_), .b(new_n83_), .c(new_n77_), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n71_), .O(new_n86_));
  oai21  g52(.a(new_n79_), .b(new_n62_), .c(x13), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n51_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n84_), .b(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n71_), .c(new_n54_), .O(new_n91_));
  inv1   g57(.a(x06), .O(new_n92_));
  aoi21  g58(.a(new_n50_), .b(x14), .c(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n37_), .O(z10));
  oai21  g60(.a(x06), .b(new_n37_), .c(new_n36_), .O(z11));
  nand2  g61(.a(x16), .b(new_n36_), .O(new_n96_));
  nor2   g62(.a(new_n92_), .b(x03), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n37_), .O(z12));
