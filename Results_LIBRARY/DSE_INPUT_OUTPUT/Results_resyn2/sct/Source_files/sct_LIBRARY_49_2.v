...
module FAU ( 
  ...
  oai21  g21(.a(new_n55_), .b(new_n48_), .c(new_n39_), .O(z03));
  ...
  oai21  g26(.a(new_n60_), .b(new_n48_), .c(new_n39_), .O(z04));
  nand2  g27(.a(new_n48_), .b(new_n39_), .O(new_n62_));
  nand2  g28(.a(x08), .b(x07), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  nor2   g30(.a(x09), .b(new_n37_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(x13), .O(new_n66_));
  inv1   g32(.a(x13), .O(new_n67_));
  oai21  g33(.a(new_n64_), .b(new_n67_), .c(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n62_), .O(z05));
  nor2   g36(.a(new_n63_), .b(x09), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n67_), .c(x06), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  nand4  g40(.a(new_n65_), .b(new_n64_), .c(x13), .d(new_n74_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n62_), .O(z06));
  ...
  oai21  g46(.a(new_n80_), .b(new_n78_), .c(x13), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x06), .O(new_n82_));
  nand2  g48(.a(new_n75_), .b(x11), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n49_), .O(z07));
  nand2  g50(.a(new_n82_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n77_), .O(new_n87_));
  nor3   g53(.a(new_n87_), .b(new_n80_), .c(new_n59_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x13), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n85_), .c(new_n62_), .O(z08));
  oai21  g56(.a(new_n88_), .b(new_n67_), .c(new_n62_), .O(z09));
  inv1   g57(.a(x03), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x02), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x16), .c(x14), .O(new_n94_));
  and2   g60(.a(x06), .b(x00), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n71_), .c(new_n47_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n39_), .O(z10));
  nor2   g65(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n35_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n44_), .c(new_n39_), .O(z12));
  nor2   g68(.a(new_n38_), .b(new_n44_), .O(z13));
  nand2  g69(.a(x17), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n39_), .O(z14));
endmodule
