...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n51_, new_n54_, new_n56_, new_n58_, new_n60_, new_n61_, new_n63_,
  ...
  nor2   g18(.a(x06), .b(new_n48_), .O(z13));
  nand2  g19(.a(z13), .b(x07), .O(new_n54_));
  nor2   g20(.a(new_n54_), .b(new_n51_), .O(z03));
  nand2  g21(.a(z13), .b(x08), .O(new_n56_));
  nor2   g22(.a(new_n56_), .b(new_n51_), .O(z04));
  oai21  g23(.a(new_n51_), .b(x09), .c(new_n41_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x04), .O(z05));
  inv1   g25(.a(x10), .O(new_n60_));
  inv1   g26(.a(new_n51_), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(z13), .c(new_n60_), .O(z06));
  oai21  g28(.a(new_n51_), .b(x11), .c(new_n41_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z07));
  inv1   g30(.a(x12), .O(new_n65_));
  nand3  g31(.a(new_n61_), .b(z13), .c(new_n65_), .O(z08));
  oai21  g32(.a(new_n51_), .b(x13), .c(new_n41_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x04), .O(z09));
  nand2  g34(.a(z13), .b(x14), .O(new_n69_));
  nor2   g35(.a(new_n69_), .b(new_n61_), .O(z10));
  inv1   g36(.a(x02), .O(new_n71_));
  aoi21  g37(.a(x06), .b(x04), .c(new_n71_), .O(z11));
