...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n95_, new_n96_, new_n99_, new_n100_, new_n102_;
  ...
  nor2   g18(.a(new_n36_), .b(new_n47_), .O(z13));
  and2   g19(.a(z13), .b(new_n50_), .O(new_n54_));
  ...
  oai21  g44(.a(new_n78_), .b(new_n62_), .c(x12), .O(new_n79_));
  ...
  oai21  g54(.a(new_n88_), .b(new_n62_), .c(new_n50_), .O(new_n89_));
  ...
  nand3  g59(.a(new_n93_), .b(new_n71_), .c(new_n50_), .O(new_n94_));
  inv1   g60(.a(new_n50_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x14), .c(new_n36_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n47_), .O(z10));
  nor2   g63(.a(z02), .b(new_n49_), .O(z11));
  nand2  g64(.a(x16), .b(new_n49_), .O(new_n99_));
  nor2   g65(.a(new_n36_), .b(x03), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n47_), .O(z12));
  inv1   g67(.a(x17), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(x06), .c(new_n47_), .O(z14));
endmodule
