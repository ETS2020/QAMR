...
module FAU ( 
  ...
  nand2  g19(.a(x06), .b(x04), .O(new_n54_));
  ...
  nand2  g41(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n55_), .O(z07));
  inv1   g43(.a(x12), .O(new_n78_));
  aoi21  g44(.a(new_n75_), .b(new_n68_), .c(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(new_n78_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n63_), .c(new_n48_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n79_), .c(x06), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nand3  g50(.a(new_n75_), .b(new_n84_), .c(new_n78_), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n68_), .O(new_n87_));
  oai21  g53(.a(new_n80_), .b(new_n63_), .c(x13), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n55_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n68_), .c(new_n48_), .O(new_n92_));
  nand2  g58(.a(new_n53_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n54_), .O(z10));
