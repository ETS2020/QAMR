...
module FAU ( 
  ...
  oai21  g30(.a(x09), .b(new_n36_), .c(new_n47_), .O(new_n65_));
  ...
  nand3  g52(.a(new_n83_), .b(new_n66_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g57(.a(new_n83_), .b(new_n91_), .c(new_n86_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n66_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n90_), .c(new_n51_), .O(z09));
  ...
  nand3  g66(.a(new_n50_), .b(x14), .c(x04), .O(new_n101_));
  oai21  g67(.a(new_n100_), .b(new_n47_), .c(new_n101_), .O(z10));
