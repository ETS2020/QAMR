...
module FAU ( 
  ...
  oai21  g26(.a(new_n38_), .b(x09), .c(new_n60_), .O(new_n61_));
  ...
  aoi21  g34(.a(new_n68_), .b(new_n67_), .c(new_n38_), .O(z06));
  ...
  oai21  g41(.a(x11), .b(x05), .c(new_n50_), .O(new_n76_));
  ...
  oai21  g46(.a(x12), .b(x05), .c(new_n50_), .O(new_n81_));
  ...
  nand3  g57(.a(new_n74_), .b(new_n83_), .c(new_n79_), .O(new_n92_));
