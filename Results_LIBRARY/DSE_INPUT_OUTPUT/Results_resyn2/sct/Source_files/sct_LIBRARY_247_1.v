...
module FAU ( 
  ...
  and2   g15(.a(new_n49_), .b(x04), .O(new_n50_));
  ...
  nor2   g28(.a(x16), .b(x04), .O(new_n63_));
  ...
  nand2  g35(.a(new_n69_), .b(z13), .O(z05));
  nor2   g36(.a(new_n67_), .b(x10), .O(new_n71_));
  ...
  nand4  g52(.a(new_n78_), .b(new_n86_), .c(new_n85_), .d(new_n66_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n49_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(z13), .O(z08));
  nand2  g56(.a(new_n87_), .b(x13), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n78_), .b(new_n77_), .c(new_n92_), .d(new_n85_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n50_), .O(z09));
  inv1   g60(.a(x03), .O(new_n95_));
  inv1   g61(.a(x14), .O(new_n96_));
  aoi21  g62(.a(new_n95_), .b(x02), .c(new_n96_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n36_), .c(x16), .O(new_n98_));
  inv1   g64(.a(x00), .O(new_n99_));
  nand3  g65(.a(new_n78_), .b(new_n92_), .c(new_n85_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n77_), .c(new_n50_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n98_), .O(z10));
  nand2  g69(.a(new_n37_), .b(new_n48_), .O(z11));
  nand2  g70(.a(x16), .b(new_n48_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n95_), .c(new_n36_), .O(z12));
  inv1   g72(.a(x17), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(x04), .c(new_n63_), .O(z14));
endmodule
