...
module FAU ( 
  ...
  nand4  g29(.a(new_n63_), .b(new_n57_), .c(x08), .d(x07), .O(new_n64_));
  ...
  nor2   g35(.a(new_n51_), .b(x09), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(new_n71_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n63_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n58_), .c(x12), .O(new_n76_));
  nor3   g42(.a(x12), .b(x11), .c(x10), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n70_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(new_n79_));
  ...
  nand3  g49(.a(new_n77_), .b(new_n70_), .c(new_n83_), .O(new_n84_));
  nor2   g50(.a(new_n37_), .b(new_n46_), .O(z13));
  nand4  g51(.a(z13), .b(new_n84_), .c(new_n82_), .d(new_n48_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n69_), .c(new_n63_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(x13), .c(new_n87_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n70_), .c(new_n48_), .O(new_n91_));
  inv1   g57(.a(new_n48_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x14), .c(new_n37_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n46_), .O(z10));
  nand2  g60(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g61(.a(x16), .b(new_n35_), .O(new_n96_));
  nor2   g62(.a(new_n37_), .b(x03), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n46_), .O(z12));
