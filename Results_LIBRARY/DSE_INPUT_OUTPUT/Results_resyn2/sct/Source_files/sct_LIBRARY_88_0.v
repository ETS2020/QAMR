...
module FAU ( 
  ...
  oai21  g21(.a(new_n37_), .b(new_n36_), .c(new_n55_), .O(new_n56_));
  ...
  oai21  g33(.a(new_n67_), .b(new_n36_), .c(x06), .O(new_n68_));
  aoi21  g34(.a(new_n62_), .b(x09), .c(new_n49_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n36_), .c(new_n68_), .O(z05));
  oai21  g36(.a(new_n66_), .b(x10), .c(x04), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x06), .O(new_n72_));
  nand3  g38(.a(new_n67_), .b(new_n54_), .c(x06), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  aoi21  g40(.a(new_n54_), .b(new_n74_), .c(new_n36_), .O(new_n75_));
  ...
  nand2  g47(.a(new_n80_), .b(new_n79_), .O(new_n82_));
  ...
  nand3  g52(.a(new_n86_), .b(new_n80_), .c(new_n79_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n50_), .O(z08));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n78_), .d(new_n74_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n66_), .c(x04), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  aoi21  g59(.a(new_n87_), .b(x13), .c(new_n49_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n36_), .c(new_n93_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand2  g62(.a(new_n91_), .b(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n67_), .c(new_n54_), .d(x06), .O(new_n98_));
  nand2  g64(.a(new_n49_), .b(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n36_), .O(z10));
  nand2  g66(.a(new_n38_), .b(new_n53_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n53_), .c(x03), .O(new_n102_));
