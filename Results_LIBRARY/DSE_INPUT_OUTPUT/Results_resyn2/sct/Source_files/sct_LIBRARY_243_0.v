...
module FAU ( 
  ...
  oai21  g28(.a(new_n37_), .b(new_n62_), .c(new_n57_), .O(new_n63_));
  nand3  g29(.a(x08), .b(x07), .c(x06), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n63_), .c(new_n52_), .O(new_n65_));
  inv1   g31(.a(new_n65_), .O(z04));
  oai21  g32(.a(new_n62_), .b(new_n58_), .c(x09), .O(new_n67_));
  ...
  nand3  g37(.a(x13), .b(x09), .c(new_n47_), .O(new_n72_));
  nand2  g38(.a(new_n56_), .b(new_n41_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z05));
  inv1   g40(.a(x10), .O(new_n75_));
  xor2a  g41(.a(new_n69_), .b(new_n75_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  nand2  g43(.a(x10), .b(new_n47_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n55_), .c(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n41_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n77_), .O(z06));
  oai21  g47(.a(new_n69_), .b(x10), .c(x11), .O(new_n82_));
  inv1   g48(.a(new_n64_), .O(new_n83_));
  nor2   g49(.a(x11), .b(x10), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n68_), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(x11), .c(new_n47_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n82_), .d(new_n52_), .O(z07));
  inv1   g54(.a(new_n84_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n69_), .c(x12), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand4  g57(.a(new_n84_), .b(new_n83_), .c(new_n91_), .d(new_n68_), .O(new_n92_));
  oai21  g58(.a(new_n86_), .b(x12), .c(new_n47_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n90_), .d(new_n52_), .O(z08));
  nand2  g60(.a(new_n92_), .b(x13), .O(new_n95_));
  inv1   g61(.a(x11), .O(new_n96_));
  nand4  g62(.a(new_n86_), .b(new_n91_), .c(new_n96_), .d(new_n75_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n68_), .b(x08), .c(x07), .d(x06), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n95_), .c(new_n73_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n97_), .b(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n100_), .c(new_n55_), .O(new_n105_));
  nand3  g71(.a(new_n51_), .b(new_n41_), .c(x14), .O(new_n106_));
  ...
  nand2  g75(.a(new_n41_), .b(x04), .O(new_n110_));
  nor2   g76(.a(new_n110_), .b(new_n109_), .O(z12));
  nand2  g77(.a(new_n41_), .b(new_n48_), .O(z13));
