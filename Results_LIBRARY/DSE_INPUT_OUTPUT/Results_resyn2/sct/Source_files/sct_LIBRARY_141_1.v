...
module FAU ( 
  ...
  oai21  g20(.a(new_n54_), .b(new_n36_), .c(new_n37_), .O(new_n55_));
  ...
  nor2   g25(.a(new_n59_), .b(new_n57_), .O(z04));
  nor2   g26(.a(new_n48_), .b(x06), .O(new_n61_));
  ...
  nand3  g34(.a(new_n68_), .b(new_n50_), .c(x04), .O(new_n69_));
  inv1   g35(.a(new_n69_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n67_), .c(new_n61_), .O(z05));
  nand2  g37(.a(new_n65_), .b(x10), .O(new_n72_));
  inv1   g38(.a(x10), .O(new_n73_));
  and2   g39(.a(x08), .b(x07), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n64_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x06), .O(new_n77_));
  nor2   g43(.a(new_n73_), .b(x06), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n51_), .c(new_n37_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n77_), .O(z06));
  inv1   g46(.a(x11), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(x06), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n51_), .c(new_n37_), .O(new_n83_));
  nand4  g49(.a(new_n74_), .b(x11), .c(new_n73_), .d(new_n64_), .O(new_n84_));
  nand2  g50(.a(new_n75_), .b(new_n81_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(x06), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n83_), .O(z07));
  inv1   g53(.a(new_n51_), .O(new_n88_));
  nor2   g54(.a(x11), .b(x10), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n64_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n58_), .c(x12), .O(new_n91_));
  nor2   g57(.a(new_n90_), .b(new_n58_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n48_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n88_), .O(z08));
  nand2  g60(.a(new_n89_), .b(new_n48_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n65_), .c(x13), .O(new_n96_));
  nor2   g62(.a(x13), .b(x12), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  ...
  oai21  g68(.a(x13), .b(x12), .c(new_n36_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n102_), .c(new_n96_), .d(new_n88_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nand2  g71(.a(new_n98_), .b(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n101_), .c(new_n50_), .O(new_n107_));
  inv1   g73(.a(x03), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x02), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n37_), .c(x16), .d(x14), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n107_), .c(new_n45_), .O(z10));
  nor2   g77(.a(new_n61_), .b(new_n49_), .O(z11));
  aoi21  g78(.a(x16), .b(new_n49_), .c(x03), .O(new_n113_));
  nor3   g79(.a(new_n113_), .b(new_n61_), .c(new_n45_), .O(z12));
  nor2   g80(.a(new_n61_), .b(new_n45_), .O(z13));
