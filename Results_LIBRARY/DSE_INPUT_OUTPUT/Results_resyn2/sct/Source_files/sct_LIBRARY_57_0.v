...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n86_, new_n88_, new_n89_, new_n90_, new_n91_, new_n94_;
  inv1   g00(.a(x02), .O(new_n35_));
  nand2  g01(.a(new_n35_), .b(x01), .O(new_n36_));
  nor2   g02(.a(x17), .b(x16), .O(new_n37_));
  ...
  nand4  g21(.a(new_n55_), .b(new_n54_), .c(new_n53_), .d(new_n38_), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z03));
  xor2a  g23(.a(new_n55_), .b(x08), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n47_), .c(new_n38_), .O(z04));
  ...
  nand4  g29(.a(new_n63_), .b(new_n61_), .c(new_n53_), .d(new_n38_), .O(z05));
  ...
  nand4  g34(.a(new_n68_), .b(new_n67_), .c(new_n53_), .d(new_n38_), .O(z06));
  oai21  g35(.a(new_n63_), .b(x10), .c(x11), .O(new_n70_));
  nor2   g36(.a(x11), .b(x10), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n66_), .c(new_n47_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n70_), .c(new_n37_), .O(z07));
  ...
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n65_), .d(new_n62_), .O(new_n78_));
  nor2   g44(.a(new_n78_), .b(new_n60_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(new_n47_), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(new_n75_), .c(new_n37_), .O(z08));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n66_), .c(new_n47_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n82_), .c(new_n37_), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  nand2  g54(.a(new_n84_), .b(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n66_), .c(new_n46_), .O(new_n90_));
  aoi21  g56(.a(new_n52_), .b(x14), .c(new_n37_), .O(new_n91_));
  aoi22  g57(.a(new_n91_), .b(new_n90_), .c(new_n38_), .d(new_n49_), .O(z10));
  nand2  g58(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g59(.a(x17), .b(x03), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n46_), .c(new_n49_), .O(z12));
  nand2  g61(.a(new_n38_), .b(new_n49_), .O(z13));
