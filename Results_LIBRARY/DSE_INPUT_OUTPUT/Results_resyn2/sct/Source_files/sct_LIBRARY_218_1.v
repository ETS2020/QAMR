...
module FAU ( 
  ...
  oai21  g29(.a(x09), .b(new_n37_), .c(new_n58_), .O(new_n64_));
  ...
  oai21  g34(.a(x10), .b(new_n37_), .c(new_n45_), .O(new_n69_));
  nand3  g35(.a(new_n65_), .b(x08), .c(x07), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x10), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  nand4  g38(.a(new_n52_), .b(new_n72_), .c(new_n65_), .d(x08), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n63_), .O(new_n74_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n77_), .c(new_n49_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand3  g48(.a(new_n79_), .b(new_n78_), .c(new_n82_), .O(new_n83_));
  ...
  nand3  g56(.a(new_n90_), .b(new_n86_), .c(new_n49_), .O(z09));
  nand2  g57(.a(new_n48_), .b(x14), .O(new_n92_));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n88_), .b(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n78_), .c(new_n63_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n92_), .c(new_n37_), .O(z10));
  nand2  g62(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g63(.a(x16), .b(new_n35_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n46_), .c(new_n37_), .O(z12));
