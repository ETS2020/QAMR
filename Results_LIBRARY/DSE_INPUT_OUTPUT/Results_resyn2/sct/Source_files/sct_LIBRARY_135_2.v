...
module FAU ( 
  ...
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  ...
  oai21  g52(.a(new_n86_), .b(new_n62_), .c(new_n74_), .O(new_n87_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n65_), .c(new_n74_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n90_), .c(new_n51_), .O(z10));
  nor2   g60(.a(z02), .b(new_n73_), .O(z11));
  inv1   g61(.a(x04), .O(new_n96_));
  nand2  g62(.a(x16), .b(new_n73_), .O(new_n97_));
  nor2   g63(.a(new_n36_), .b(x03), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(z12));
