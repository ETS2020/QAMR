...
module FAU ( 
  ...
  nor2   g21(.a(x06), .b(new_n45_), .O(new_n56_));
  nand3  g22(.a(new_n56_), .b(new_n50_), .c(new_n55_), .O(z05));
  oai21  g23(.a(new_n48_), .b(x10), .c(new_n41_), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x04), .O(z06));
  inv1   g25(.a(x11), .O(new_n60_));
  nand3  g26(.a(new_n56_), .b(new_n50_), .c(new_n60_), .O(z07));
  inv1   g27(.a(x12), .O(new_n62_));
  nand3  g28(.a(new_n56_), .b(new_n50_), .c(new_n62_), .O(z08));
  inv1   g29(.a(x13), .O(new_n64_));
  nand3  g30(.a(new_n56_), .b(new_n50_), .c(new_n64_), .O(z09));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n41_), .c(new_n45_), .O(z14));
  buf    g39(.a(x04), .O(z13));
endmodule
