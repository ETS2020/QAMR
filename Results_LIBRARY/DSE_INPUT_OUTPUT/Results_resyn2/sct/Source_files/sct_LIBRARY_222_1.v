...
module FAU ( 
  ...
  oai21  g29(.a(x09), .b(new_n36_), .c(new_n59_), .O(new_n64_));
  nor2   g30(.a(x09), .b(new_n60_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n54_), .O(new_n66_));
  ...
  nand4  g41(.a(new_n65_), .b(new_n54_), .c(new_n75_), .d(new_n69_), .O(new_n76_));
  inv1   g42(.a(x09), .O(new_n77_));
  nand4  g43(.a(new_n69_), .b(new_n77_), .c(x08), .d(x07), .O(new_n78_));
  ...
  nand3  g50(.a(new_n84_), .b(new_n70_), .c(new_n69_), .O(new_n85_));
  ...
  oai21  g55(.a(new_n89_), .b(new_n78_), .c(x13), .O(new_n90_));
  nor2   g56(.a(x13), .b(x10), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n84_), .c(new_n65_), .d(new_n54_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n90_), .c(new_n48_), .O(new_n93_));
  ...
  nand3  g65(.a(new_n99_), .b(new_n70_), .c(new_n48_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n96_), .c(new_n36_), .O(z10));
  aoi21  g67(.a(x06), .b(new_n36_), .c(new_n47_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n47_), .c(x03), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n36_), .O(z12));
