...
module FAU ( 
  ...
  nor2   g16(.a(x06), .b(new_n37_), .O(z13));
  nand3  g17(.a(z13), .b(new_n50_), .c(x07), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z03));
  nand2  g19(.a(new_n50_), .b(x08), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(new_n38_), .c(new_n37_), .O(z04));
  ...
  aoi21  g36(.a(new_n70_), .b(new_n69_), .c(new_n37_), .O(z12));
