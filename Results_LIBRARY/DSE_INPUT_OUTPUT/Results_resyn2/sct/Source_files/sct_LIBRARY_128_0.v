...
module FAU ( 
  ...
  nor2   g17(.a(new_n51_), .b(x04), .O(new_n52_));
  ...
  aoi21  g34(.a(new_n59_), .b(x09), .c(new_n49_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n64_), .c(new_n68_), .O(z05));
  nor2   g36(.a(new_n49_), .b(new_n64_), .O(new_n71_));
  inv1   g37(.a(new_n59_), .O(new_n72_));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g40(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x10), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(z06));
  inv1   g43(.a(x10), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n65_), .O(new_n80_));
  nand2  g46(.a(x08), .b(x07), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n80_), .c(x04), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  aoi21  g49(.a(new_n74_), .b(x11), .c(new_n49_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n64_), .c(new_n83_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n79_), .c(new_n78_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n66_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x06), .O(new_n89_));
  nand3  g55(.a(new_n73_), .b(new_n72_), .c(new_n79_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x12), .c(new_n49_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n64_), .c(new_n89_), .O(z08));
  oai21  g58(.a(new_n90_), .b(x12), .c(x13), .O(new_n93_));
  inv1   g59(.a(new_n75_), .O(new_n94_));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n86_), .c(new_n79_), .d(new_n78_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n93_), .c(new_n71_), .O(z09));
  inv1   g65(.a(new_n49_), .O(new_n100_));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n96_), .b(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n94_), .c(new_n100_), .O(new_n103_));
  nand2  g69(.a(new_n49_), .b(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n64_), .O(z10));
  nor2   g71(.a(new_n37_), .b(new_n36_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n36_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n64_), .c(new_n41_), .O(z12));
  nor2   g74(.a(x17), .b(new_n64_), .O(new_n109_));
  nor2   g75(.a(new_n109_), .b(new_n52_), .O(z14));
  buf    g76(.a(x04), .O(z13));
endmodule
