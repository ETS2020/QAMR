...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
    new_n54_, new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_,
    new_n67_, new_n70_, new_n72_;
  ...
  inv1   g16(.a(new_n48_), .O(z13));
  nand3  g17(.a(z13), .b(new_n50_), .c(x07), .O(new_n52_));
  inv1   g18(.a(new_n52_), .O(z03));
  inv1   g19(.a(x04), .O(new_n54_));
  nand2  g20(.a(new_n50_), .b(x08), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n41_), .c(new_n54_), .O(z04));
  oai21  g22(.a(new_n47_), .b(x09), .c(new_n41_), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(x04), .O(z05));
  inv1   g24(.a(x10), .O(new_n59_));
  nand2  g25(.a(z02), .b(new_n59_), .O(z06));
  inv1   g26(.a(x11), .O(new_n61_));
  nand2  g27(.a(z02), .b(new_n61_), .O(z07));
  oai21  g28(.a(new_n47_), .b(x12), .c(new_n41_), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x04), .O(z08));
  oai21  g30(.a(new_n47_), .b(x13), .c(new_n41_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(z09));
  nand2  g32(.a(new_n47_), .b(x14), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n41_), .c(new_n54_), .O(z10));
  nand2  g34(.a(new_n37_), .b(new_n36_), .O(z11));
  nand2  g35(.a(x16), .b(new_n36_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n45_), .c(new_n48_), .O(z12));
  inv1   g37(.a(x17), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n41_), .c(new_n54_), .O(z14));
endmodule
