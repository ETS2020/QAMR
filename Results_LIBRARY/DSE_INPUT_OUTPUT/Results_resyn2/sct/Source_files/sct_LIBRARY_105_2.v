...
module FAU ( 
  ...
  nor3   g23(.a(new_n58_), .b(new_n38_), .c(new_n46_), .O(new_n59_));
  nand2  g24(.a(new_n51_), .b(x09), .O(new_n60_));
  nor2   g25(.a(new_n51_), .b(x09), .O(new_n61_));
  inv1   g26(.a(new_n61_), .O(new_n62_));
  nand3  g27(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z05));
  inv1   g28(.a(x10), .O(new_n64_));
  nand2  g29(.a(new_n61_), .b(new_n64_), .O(new_n65_));
  nand2  g30(.a(new_n62_), .b(x10), .O(new_n66_));
  nand3  g31(.a(new_n66_), .b(new_n65_), .c(new_n59_), .O(z06));
  nand2  g32(.a(new_n65_), .b(x11), .O(new_n68_));
  nor2   g33(.a(x11), .b(x10), .O(new_n69_));
  nand2  g34(.a(new_n69_), .b(new_n61_), .O(new_n70_));
  nand3  g35(.a(new_n70_), .b(new_n68_), .c(new_n59_), .O(z07));
  inv1   g36(.a(x12), .O(new_n72_));
  nand3  g37(.a(new_n69_), .b(new_n61_), .c(new_n72_), .O(new_n73_));
  nand2  g38(.a(new_n70_), .b(x12), .O(new_n74_));
  nand3  g39(.a(new_n74_), .b(new_n73_), .c(new_n59_), .O(z08));
  nand2  g40(.a(new_n73_), .b(x13), .O(new_n76_));
  inv1   g41(.a(x11), .O(new_n77_));
  inv1   g42(.a(x13), .O(new_n78_));
  nand4  g43(.a(new_n78_), .b(new_n72_), .c(new_n77_), .d(new_n64_), .O(new_n79_));
  inv1   g44(.a(new_n79_), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(new_n61_), .O(new_n81_));
  nand3  g46(.a(new_n81_), .b(new_n76_), .c(new_n59_), .O(z09));
  inv1   g47(.a(x00), .O(new_n83_));
  nand2  g48(.a(new_n79_), .b(new_n83_), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(new_n61_), .c(new_n48_), .O(new_n85_));
  aoi21  g50(.a(new_n58_), .b(x14), .c(new_n38_), .O(new_n86_));
  aoi21  g51(.a(new_n86_), .b(new_n85_), .c(new_n46_), .O(z10));
  aoi21  g52(.a(new_n38_), .b(x04), .c(new_n36_), .O(z11));
  nand2  g53(.a(x16), .b(new_n36_), .O(new_n89_));
  nor2   g54(.a(new_n38_), .b(x03), .O(new_n90_));
  aoi21  g55(.a(new_n90_), .b(new_n89_), .c(new_n46_), .O(z12));
  nand3  g56(.a(x17), .b(x06), .c(x04), .O(new_n92_));
  inv1   g57(.a(new_n92_), .O(z14));
  zero   g58(.O(z02));
  buf    g59(.a(x04), .O(z13));
endmodule
