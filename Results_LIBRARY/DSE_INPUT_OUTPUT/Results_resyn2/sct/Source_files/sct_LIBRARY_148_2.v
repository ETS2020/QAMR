...
module FAU ( 
  ...
  oai21  g19(.a(x03), .b(new_n36_), .c(x16), .O(new_n55_));
  ...
  aoi21  g24(.a(new_n59_), .b(x06), .c(new_n37_), .O(z04));
  nand2  g25(.a(new_n56_), .b(x09), .O(new_n61_));
  inv1   g26(.a(x09), .O(new_n62_));
  nand3  g27(.a(new_n62_), .b(x08), .c(x07), .O(new_n63_));
  nand3  g28(.a(new_n63_), .b(new_n61_), .c(new_n52_), .O(z05));
  nand2  g29(.a(new_n63_), .b(x10), .O(new_n65_));
  inv1   g30(.a(x10), .O(new_n66_));
  nor2   g31(.a(new_n56_), .b(x09), .O(new_n67_));
  nand2  g32(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g33(.a(new_n68_), .b(new_n65_), .c(new_n52_), .O(z06));
  oai21  g34(.a(new_n63_), .b(x10), .c(x11), .O(new_n70_));
  nor2   g35(.a(x11), .b(x10), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(new_n67_), .O(new_n72_));
  nand3  g37(.a(new_n72_), .b(new_n70_), .c(new_n55_), .O(new_n73_));
  nand2  g38(.a(new_n73_), .b(x06), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(x04), .O(z07));
  inv1   g40(.a(x12), .O(new_n76_));
  aoi21  g41(.a(new_n71_), .b(new_n67_), .c(new_n76_), .O(new_n77_));
  nand2  g42(.a(new_n71_), .b(new_n76_), .O(new_n78_));
  oai21  g43(.a(new_n78_), .b(new_n63_), .c(new_n55_), .O(new_n79_));
  ...
  nand2  g49(.a(new_n84_), .b(new_n67_), .O(new_n85_));
  oai21  g50(.a(new_n78_), .b(new_n63_), .c(x13), .O(new_n86_));
  nand3  g51(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(z09));
  inv1   g52(.a(x00), .O(new_n88_));
  nand2  g53(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  nand3  g54(.a(new_n89_), .b(new_n67_), .c(new_n55_), .O(new_n90_));
  inv1   g55(.a(x06), .O(new_n91_));
  aoi21  g56(.a(new_n51_), .b(x14), .c(new_n91_), .O(new_n92_));
  aoi21  g57(.a(new_n92_), .b(new_n90_), .c(new_n37_), .O(z10));
  nor2   g58(.a(new_n38_), .b(new_n36_), .O(z11));
  nand2  g59(.a(x16), .b(new_n36_), .O(new_n95_));
  nor2   g60(.a(new_n91_), .b(x03), .O(new_n96_));
  aoi21  g61(.a(new_n96_), .b(new_n95_), .c(new_n37_), .O(z12));
  inv1   g62(.a(new_n44_), .O(z13));
  inv1   g63(.a(x17), .O(new_n99_));
  aoi21  g64(.a(new_n99_), .b(x06), .c(new_n37_), .O(z14));
  zero   g65(.O(z02));
endmodule
