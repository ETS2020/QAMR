...
module FAU ( 
  ...
  nand3  g39(.a(new_n73_), .b(new_n69_), .c(new_n50_), .O(z06));
  nand2  g40(.a(new_n73_), .b(x11), .O(new_n75_));
  inv1   g41(.a(new_n66_), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n64_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n50_), .O(z07));
  oai21  g45(.a(x12), .b(new_n36_), .c(new_n46_), .O(new_n80_));
  inv1   g46(.a(new_n49_), .O(new_n81_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n76_), .c(new_n86_), .d(new_n64_), .O(new_n87_));
