...
module FAU ( 
  ...
  oai21  g30(.a(new_n38_), .b(x09), .c(new_n60_), .O(new_n65_));
  nor2   g31(.a(new_n60_), .b(x09), .O(new_n66_));
  inv1   g32(.a(new_n66_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n65_), .c(new_n52_), .O(z05));
  oai21  g34(.a(new_n38_), .b(x10), .c(new_n67_), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  nand2  g36(.a(new_n66_), .b(new_n70_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n52_), .O(z06));
  inv1   g38(.a(x11), .O(new_n73_));
  inv1   g39(.a(x09), .O(new_n74_));
  nand4  g40(.a(new_n70_), .b(new_n74_), .c(x08), .d(x07), .O(new_n75_));
  xor2a  g41(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n77_), .c(new_n38_), .O(z07));
  oai21  g48(.a(new_n75_), .b(x11), .c(x12), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  inv1   g50(.a(new_n75_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n73_), .d(x06), .O(new_n86_));
  oai21  g52(.a(x13), .b(x12), .c(new_n47_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n83_), .d(new_n52_), .O(z08));
  nand2  g54(.a(new_n86_), .b(x13), .O(new_n89_));
  nand4  g55(.a(new_n37_), .b(new_n84_), .c(new_n73_), .d(new_n70_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n66_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n89_), .c(new_n52_), .O(z09));
  nand3  g59(.a(new_n51_), .b(new_n39_), .c(x14), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n90_), .b(new_n95_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n66_), .c(new_n78_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n94_), .c(new_n48_), .O(z10));
  nor2   g64(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n35_), .c(x03), .O(new_n100_));
  nor3   g66(.a(new_n100_), .b(new_n38_), .c(new_n48_), .O(z12));
  nand2  g67(.a(new_n39_), .b(new_n48_), .O(z13));
  inv1   g68(.a(x17), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n48_), .c(new_n39_), .O(z14));
endmodule
