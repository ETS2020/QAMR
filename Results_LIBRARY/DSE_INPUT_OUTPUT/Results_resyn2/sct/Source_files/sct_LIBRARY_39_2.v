...
module FAU ( 
  ...
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n52_), .O(z07));
  ...
  aoi21  g47(.a(new_n78_), .b(new_n69_), .c(new_n81_), .O(new_n82_));
  nor2   g48(.a(x13), .b(x12), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n74_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n64_), .c(new_n61_), .O(new_n85_));
  ...
  nand3  g56(.a(new_n90_), .b(new_n69_), .c(new_n61_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n88_), .c(new_n51_), .O(z10));
  nor2   g58(.a(z02), .b(new_n60_), .O(z11));
  inv1   g59(.a(x04), .O(new_n94_));
  nand2  g60(.a(x16), .b(new_n60_), .O(new_n95_));
  nor2   g61(.a(new_n36_), .b(x03), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(z12));
  inv1   g63(.a(x17), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x06), .c(new_n94_), .O(z14));
  buf    g65(.a(x04), .O(z13));
endmodule
