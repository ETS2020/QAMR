...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n101_, new_n102_, new_n105_, new_n107_, new_n109_;
  ...
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n51_), .O(z05));
  oai21  g35(.a(x10), .b(new_n42_), .c(new_n37_), .O(new_n70_));
  inv1   g36(.a(new_n50_), .O(new_n71_));
  nand3  g37(.a(new_n65_), .b(x08), .c(x07), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  nor2   g39(.a(new_n61_), .b(new_n54_), .O(new_n74_));
  nor2   g40(.a(x10), .b(new_n37_), .O(new_n75_));
  ...
  nand2  g44(.a(new_n78_), .b(new_n70_), .O(z06));
  oai21  g45(.a(x11), .b(new_n42_), .c(new_n76_), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x10), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x06), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n72_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n81_), .c(new_n50_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n80_), .c(new_n38_), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nand3  g53(.a(new_n84_), .b(new_n87_), .c(new_n81_), .O(new_n88_));
  oai21  g54(.a(new_n76_), .b(x11), .c(x12), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n51_), .O(z08));
  nand2  g56(.a(new_n88_), .b(x13), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n87_), .c(new_n81_), .d(new_n82_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n66_), .c(new_n65_), .O(new_n95_));
  ...
  aoi21  g65(.a(new_n99_), .b(x16), .c(new_n72_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n98_), .c(new_n42_), .O(new_n101_));
  nand3  g67(.a(new_n50_), .b(x14), .c(x04), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n37_), .c(new_n102_), .O(z10));
  nand2  g69(.a(new_n47_), .b(new_n36_), .O(z11));
  nand2  g70(.a(x16), .b(new_n36_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n48_), .c(new_n42_), .O(z12));
  nor2   g72(.a(x06), .b(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z13));
  inv1   g74(.a(x17), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(x04), .c(new_n107_), .O(z14));
endmodule
