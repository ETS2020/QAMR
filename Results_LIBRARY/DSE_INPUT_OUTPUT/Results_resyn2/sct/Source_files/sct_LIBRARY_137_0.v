...
module FAU ( 
  ...
  nor4   g15(.a(new_n49_), .b(new_n46_), .c(x06), .d(new_n43_), .O(z02));
  ...
  and2   g30(.a(new_n64_), .b(new_n51_), .O(z05));
  ...
  oai21  g37(.a(new_n46_), .b(x10), .c(new_n71_), .O(new_n72_));
  ...
  oai21  g58(.a(new_n92_), .b(new_n53_), .c(new_n51_), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n49_), .b(x14), .c(new_n37_), .O(new_n98_));
  aoi22  g64(.a(new_n98_), .b(new_n97_), .c(new_n51_), .d(new_n43_), .O(z10));
  nor2   g65(.a(new_n37_), .b(new_n36_), .O(z11));
  aoi21  g66(.a(x16), .b(new_n36_), .c(x03), .O(new_n101_));
  nor3   g67(.a(new_n101_), .b(new_n37_), .c(new_n43_), .O(z12));
  nand2  g68(.a(new_n51_), .b(new_n43_), .O(z13));
  oai21  g69(.a(new_n46_), .b(new_n43_), .c(new_n51_), .O(z14));
endmodule
