...
module FAU ( 
  ...
  nand2  g26(.a(x08), .b(x04), .O(new_n61_));
  ...
  oai21  g31(.a(x09), .b(new_n48_), .c(new_n63_), .O(new_n66_));
  nor2   g32(.a(new_n63_), .b(x09), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(new_n66_), .c(new_n38_), .O(z05));
  inv1   g35(.a(x10), .O(new_n70_));
  nand2  g36(.a(new_n67_), .b(new_n70_), .O(new_n71_));
  oai21  g37(.a(new_n63_), .b(x09), .c(x10), .O(new_n72_));
  ...
  oai21  g44(.a(x12), .b(new_n48_), .c(new_n37_), .O(new_n79_));
  nand2  g45(.a(new_n74_), .b(new_n70_), .O(new_n80_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n83_), .c(new_n60_), .O(new_n88_));
  ...
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n52_), .O(z09));
  ...
  nand3  g64(.a(new_n98_), .b(new_n67_), .c(new_n60_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n95_), .c(new_n48_), .O(z10));
