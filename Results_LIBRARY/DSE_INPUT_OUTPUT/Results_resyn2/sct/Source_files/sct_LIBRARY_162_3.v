...
module FAU ( 
  ...
  nand4  g32(.a(new_n66_), .b(new_n65_), .c(new_n48_), .d(x04), .O(new_n67_));
  and2   g33(.a(new_n67_), .b(new_n40_), .O(z05));
  ...
  nor2   g39(.a(x12), .b(new_n37_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n70_), .c(new_n73_), .O(new_n75_));
  nand2  g41(.a(new_n49_), .b(new_n40_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n72_), .O(z06));
  nand4  g43(.a(new_n73_), .b(new_n62_), .c(x08), .d(x07), .O(new_n78_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n73_), .c(new_n62_), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n63_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n38_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n76_), .O(z07));
  nand3  g52(.a(new_n48_), .b(new_n38_), .c(x04), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(new_n39_), .O(z08));
  aoi21  g55(.a(new_n84_), .b(new_n38_), .c(x13), .O(new_n90_));
  nand3  g56(.a(x13), .b(x08), .c(x07), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n82_), .c(new_n73_), .d(new_n62_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n38_), .c(new_n37_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n90_), .c(new_n76_), .O(z09));
  nor2   g61(.a(new_n39_), .b(new_n45_), .O(z13));
  inv1   g62(.a(z13), .O(new_n97_));
  nand2  g63(.a(new_n53_), .b(x14), .O(new_n98_));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n82_), .b(new_n73_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(x13), .c(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n74_), .c(new_n70_), .d(new_n48_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n98_), .c(new_n97_), .O(z10));
  nand2  g69(.a(new_n40_), .b(new_n35_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n35_), .c(x03), .O(new_n105_));
  nor2   g71(.a(new_n105_), .b(new_n97_), .O(z12));
  nand2  g72(.a(z13), .b(x17), .O(new_n107_));
