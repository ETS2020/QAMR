...
module FAU ( 
  ...
  nor2   g17(.a(x06), .b(new_n51_), .O(z13));
  nand3  g18(.a(z13), .b(new_n50_), .c(x07), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(z03));
  nand3  g20(.a(z13), .b(new_n50_), .c(x08), .O(new_n55_));
  ...
  nand2  g32(.a(z13), .b(x14), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(new_n50_), .O(z10));
  nand2  g34(.a(new_n37_), .b(new_n36_), .O(z11));
  nand2  g35(.a(x16), .b(new_n36_), .O(new_n70_));
  nor2   g36(.a(x06), .b(x03), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n70_), .c(new_n51_), .O(z12));
  inv1   g38(.a(x17), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n41_), .c(new_n51_), .O(z14));
endmodule
