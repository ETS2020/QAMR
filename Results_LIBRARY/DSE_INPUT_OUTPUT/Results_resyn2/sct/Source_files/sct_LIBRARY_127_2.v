...
module FAU ( 
  ...
  nor3   g28(.a(new_n59_), .b(new_n62_), .c(x09), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  nand2  g30(.a(new_n48_), .b(new_n39_), .O(new_n65_));
  nor2   g31(.a(new_n57_), .b(new_n53_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n62_), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x09), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n65_), .c(new_n64_), .O(z05));
  nand2  g35(.a(new_n64_), .b(x10), .O(new_n70_));
  inv1   g36(.a(x09), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(x08), .d(x07), .O(new_n73_));
  inv1   g39(.a(new_n73_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n62_), .c(x06), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n70_), .c(new_n49_), .O(z06));
  nor2   g42(.a(x10), .b(x09), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(new_n66_), .c(new_n62_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n37_), .c(x11), .O(new_n79_));
  nor2   g45(.a(x11), .b(new_n37_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n74_), .c(x17), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n79_), .c(new_n65_), .O(z07));
  nor2   g48(.a(x12), .b(x11), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n77_), .c(x08), .d(x07), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x17), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  nand2  g52(.a(new_n81_), .b(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n49_), .O(z08));
  nand2  g54(.a(new_n86_), .b(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand3  g56(.a(new_n83_), .b(new_n90_), .c(new_n72_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  aoi22  g58(.a(new_n92_), .b(new_n63_), .c(new_n48_), .d(new_n39_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n89_), .O(z09));
  inv1   g60(.a(x04), .O(new_n95_));
  nor2   g61(.a(new_n59_), .b(x09), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand2  g63(.a(new_n91_), .b(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n47_), .O(new_n99_));
  ...
  aoi22  g69(.a(new_n103_), .b(new_n99_), .c(new_n39_), .d(new_n95_), .O(z10));
  nor2   g70(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n35_), .c(x03), .O(new_n106_));
  nor3   g72(.a(new_n106_), .b(new_n38_), .c(new_n95_), .O(z12));
  nand2  g73(.a(new_n39_), .b(new_n95_), .O(z13));
  oai21  g74(.a(new_n62_), .b(new_n95_), .c(new_n39_), .O(z14));
endmodule
