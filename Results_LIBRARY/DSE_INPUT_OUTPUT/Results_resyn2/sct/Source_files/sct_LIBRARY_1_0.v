...
module FAU ( 
  ...
  nand3  g26(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(new_n61_));
  ...
  aoi21  g32(.a(new_n60_), .b(x09), .c(new_n50_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(new_n36_), .c(new_n66_), .O(z05));
  inv1   g34(.a(x10), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n63_), .c(x08), .d(x07), .O(new_n70_));
  inv1   g36(.a(new_n70_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n36_), .c(x06), .O(new_n72_));
  inv1   g38(.a(x02), .O(new_n73_));
  oai21  g39(.a(x03), .b(new_n73_), .c(x16), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  nand4  g41(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n72_), .O(z06));
  ...
  nand3  g52(.a(new_n86_), .b(new_n84_), .c(new_n52_), .O(z07));
  nor2   g53(.a(x12), .b(x11), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n71_), .c(new_n36_), .O(new_n89_));
  aoi21  g55(.a(new_n86_), .b(x12), .c(new_n50_), .O(new_n90_));
  oai22  g56(.a(new_n90_), .b(new_n36_), .c(new_n89_), .d(new_n37_), .O(z08));
  nor2   g57(.a(x13), .b(x10), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n64_), .c(x04), .O(new_n94_));
  ...
  nor2   g67(.a(new_n74_), .b(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n100_), .b(new_n77_), .c(new_n102_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n36_), .c(new_n38_), .O(z10));
  nand2  g70(.a(new_n38_), .b(new_n73_), .O(z11));
  nand2  g71(.a(x16), .b(new_n73_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n48_), .c(new_n36_), .O(z12));
