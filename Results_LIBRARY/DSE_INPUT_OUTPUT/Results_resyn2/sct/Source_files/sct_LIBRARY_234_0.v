...
module FAU ( 
  ...
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n50_), .O(z05));
  inv1   g35(.a(x10), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n67_), .c(x08), .d(x07), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x04), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x06), .O(new_n73_));
  nand2  g39(.a(new_n54_), .b(new_n70_), .O(new_n74_));
  nor2   g40(.a(new_n68_), .b(new_n49_), .O(new_n75_));
  inv1   g41(.a(new_n75_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(x04), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n73_), .O(z06));
  oai21  g44(.a(new_n71_), .b(x11), .c(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x06), .O(new_n80_));
  nor2   g46(.a(x09), .b(new_n62_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n57_), .c(new_n70_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(x11), .c(new_n49_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n41_), .c(new_n80_), .O(z07));
  inv1   g50(.a(x11), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nor2   g52(.a(x10), .b(new_n55_), .O(new_n87_));
  ...
  nand2  g56(.a(new_n85_), .b(new_n70_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n68_), .c(x12), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n54_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n90_), .O(z08));
  oai21  g61(.a(new_n88_), .b(new_n42_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n86_), .c(new_n85_), .d(new_n70_), .O(new_n98_));
  or2    g64(.a(new_n98_), .b(new_n68_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n96_), .c(new_n50_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n98_), .b(new_n101_), .O(new_n102_));
  inv1   g68(.a(x14), .O(new_n103_));
  nor2   g69(.a(new_n54_), .b(new_n103_), .O(new_n104_));
  aoi21  g70(.a(new_n102_), .b(new_n75_), .c(new_n104_), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n41_), .c(new_n53_), .O(z10));
  nor2   g72(.a(new_n37_), .b(new_n36_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n36_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n41_), .c(new_n53_), .O(z12));
  nand2  g75(.a(x06), .b(new_n41_), .O(z13));
