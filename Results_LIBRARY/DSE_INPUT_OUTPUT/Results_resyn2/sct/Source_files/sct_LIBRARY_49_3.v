...
module FAU ( 
  ...
  oai21  g25(.a(new_n59_), .b(new_n55_), .c(new_n37_), .O(z03));
  ...
  oai21  g30(.a(new_n64_), .b(new_n55_), .c(new_n37_), .O(z04));
  inv1   g31(.a(x09), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  nand2  g33(.a(new_n63_), .b(x09), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n50_), .O(new_n69_));
  and2   g35(.a(new_n69_), .b(new_n37_), .O(z05));
  nand2  g36(.a(x08), .b(x07), .O(new_n71_));
  inv1   g37(.a(new_n71_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n66_), .c(x13), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n46_), .c(x10), .O(new_n74_));
  ...
  aoi21  g44(.a(new_n55_), .b(new_n37_), .c(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n74_), .O(z06));
  inv1   g46(.a(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n75_), .c(new_n66_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n71_), .c(new_n76_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x06), .O(new_n84_));
  oai21  g50(.a(new_n77_), .b(new_n67_), .c(x11), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n50_), .O(z07));
  nand2  g52(.a(new_n84_), .b(x12), .O(new_n87_));
  nor2   g53(.a(x12), .b(x11), .O(new_n88_));
  aoi22  g54(.a(new_n88_), .b(new_n78_), .c(new_n55_), .d(new_n37_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n87_), .O(z08));
  nor3   g56(.a(x11), .b(x10), .c(x09), .O(new_n91_));
  nor2   g57(.a(x12), .b(new_n46_), .O(new_n92_));
  ...
  nand2  g61(.a(x13), .b(new_n46_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand3  g64(.a(new_n88_), .b(new_n76_), .c(new_n75_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n66_), .b(x08), .c(x07), .d(x06), .O(new_n101_));
  nor2   g67(.a(new_n101_), .b(new_n49_), .O(new_n102_));
  nor2   g68(.a(new_n54_), .b(new_n36_), .O(new_n103_));
  aoi21  g69(.a(new_n102_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n43_), .c(new_n37_), .O(z10));
  nor2   g71(.a(new_n38_), .b(new_n53_), .O(z11));
  aoi21  g72(.a(x16), .b(new_n53_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n43_), .c(new_n37_), .O(z12));
  nor2   g74(.a(new_n38_), .b(new_n43_), .O(z13));
