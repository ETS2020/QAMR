...
module FAU ( 
  ...
  oai21  g26(.a(new_n54_), .b(new_n37_), .c(new_n60_), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n59_), .c(new_n38_), .O(new_n62_));
  nor3   g28(.a(new_n62_), .b(new_n50_), .c(new_n44_), .O(z04));
  inv1   g29(.a(x09), .O(new_n64_));
  inv1   g30(.a(new_n59_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  inv1   g32(.a(new_n38_), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(x09), .c(new_n59_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n51_), .O(z05));
  oai21  g35(.a(x10), .b(x00), .c(new_n37_), .O(new_n70_));
  nand3  g36(.a(new_n64_), .b(x08), .c(x07), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n64_), .O(new_n73_));
  nor2   g39(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  aoi21  g40(.a(new_n71_), .b(x10), .c(new_n74_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n70_), .c(new_n51_), .O(z06));
  inv1   g42(.a(x11), .O(new_n77_));
  nand2  g43(.a(new_n74_), .b(new_n77_), .O(new_n78_));
  nand2  g44(.a(x08), .b(x07), .O(new_n79_));
  oai21  g45(.a(new_n73_), .b(new_n79_), .c(x11), .O(new_n80_));
  oai21  g46(.a(x11), .b(x00), .c(new_n37_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n80_), .c(new_n78_), .d(new_n51_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nand3  g49(.a(new_n74_), .b(new_n83_), .c(new_n77_), .O(new_n84_));
  nand2  g50(.a(new_n77_), .b(new_n72_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n71_), .c(x12), .O(new_n86_));
  oai21  g52(.a(x12), .b(x00), .c(new_n37_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n51_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand2  g55(.a(new_n38_), .b(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n83_), .b(new_n77_), .c(new_n72_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n66_), .c(new_n90_), .O(new_n92_));
  nor2   g58(.a(new_n59_), .b(x09), .O(new_n93_));
  nand4  g59(.a(new_n89_), .b(new_n83_), .c(new_n77_), .d(new_n72_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n92_), .c(new_n51_), .O(z09));
  oai21  g63(.a(x03), .b(new_n35_), .c(x16), .O(new_n98_));
  nand2  g64(.a(new_n94_), .b(new_n47_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n93_), .c(new_n98_), .O(new_n100_));
  nand3  g66(.a(new_n50_), .b(new_n38_), .c(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n44_), .O(z10));
  nor2   g68(.a(new_n67_), .b(new_n35_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n35_), .c(x03), .O(new_n104_));
  nor3   g70(.a(new_n104_), .b(new_n67_), .c(new_n44_), .O(z12));
  nand2  g71(.a(new_n38_), .b(new_n44_), .O(z13));
  inv1   g72(.a(x17), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n44_), .c(new_n38_), .O(z14));
endmodule
