...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n54_, new_n56_, new_n59_, new_n61_, new_n63_, new_n65_, new_n68_,
    new_n69_, new_n71_;
  ...
  aoi21  g18(.a(new_n52_), .b(new_n38_), .c(new_n37_), .O(z04));
  oai21  g19(.a(new_n47_), .b(x09), .c(new_n38_), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(x04), .O(z05));
  inv1   g21(.a(x10), .O(new_n56_));
  nor2   g22(.a(x06), .b(new_n37_), .O(z13));
  nand3  g23(.a(z13), .b(new_n49_), .c(new_n56_), .O(z06));
  ...
  inv1   g28(.a(x13), .O(new_n63_));
  nand3  g29(.a(z13), .b(new_n49_), .c(new_n63_), .O(z09));
  nand2  g30(.a(z13), .b(x14), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n49_), .O(z10));
