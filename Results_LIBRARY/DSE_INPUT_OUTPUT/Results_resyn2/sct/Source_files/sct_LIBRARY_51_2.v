...
module FAU ( 
  ...
  nand3  g14(.a(new_n49_), .b(new_n47_), .c(new_n46_), .O(new_n50_));
  inv1   g15(.a(new_n50_), .O(z03));
  nand2  g16(.a(x08), .b(x07), .O(new_n52_));
  inv1   g17(.a(x08), .O(new_n53_));
  nand2  g18(.a(new_n53_), .b(new_n46_), .O(new_n54_));
  nand3  g19(.a(new_n54_), .b(new_n52_), .c(new_n47_), .O(new_n55_));
  aoi21  g20(.a(new_n55_), .b(x06), .c(new_n48_), .O(z04));
  nand2  g21(.a(new_n52_), .b(x09), .O(new_n57_));
  inv1   g22(.a(x09), .O(new_n58_));
  nand3  g23(.a(new_n58_), .b(x08), .c(x07), .O(new_n59_));
  nand3  g24(.a(new_n59_), .b(new_n57_), .c(new_n47_), .O(new_n60_));
  ...
  nand4  g31(.a(new_n66_), .b(new_n63_), .c(new_n49_), .d(new_n47_), .O(z06));
  oai21  g32(.a(new_n59_), .b(x10), .c(x11), .O(new_n68_));
  nor2   g33(.a(x11), .b(x10), .O(new_n69_));
  nand2  g34(.a(new_n69_), .b(new_n65_), .O(new_n70_));
  nand3  g35(.a(new_n70_), .b(new_n68_), .c(new_n47_), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(x06), .O(new_n72_));
  nand2  g37(.a(new_n72_), .b(x04), .O(z07));
  inv1   g38(.a(x11), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(new_n64_), .O(new_n75_));
  oai21  g40(.a(new_n75_), .b(new_n59_), .c(x12), .O(new_n76_));
  nor3   g41(.a(x12), .b(x11), .c(x10), .O(new_n77_));
  nand2  g42(.a(new_n77_), .b(new_n65_), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n76_), .c(new_n47_), .O(new_n79_));
  nand2  g44(.a(new_n79_), .b(x06), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(x04), .O(z08));
  inv1   g46(.a(x13), .O(new_n82_));
  aoi21  g47(.a(new_n77_), .b(new_n65_), .c(new_n82_), .O(new_n83_));
  nor2   g48(.a(x13), .b(x12), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(new_n69_), .O(new_n85_));
  oai21  g50(.a(new_n85_), .b(new_n59_), .c(new_n47_), .O(new_n86_));
  ...
  nand3  g55(.a(new_n90_), .b(new_n65_), .c(new_n47_), .O(new_n91_));
  inv1   g56(.a(new_n47_), .O(new_n92_));
  aoi21  g57(.a(new_n92_), .b(x14), .c(new_n38_), .O(new_n93_));
  aoi21  g58(.a(new_n93_), .b(new_n91_), .c(new_n48_), .O(z10));
  nand2  g59(.a(new_n39_), .b(new_n36_), .O(z11));
  nand2  g60(.a(x16), .b(new_n36_), .O(new_n96_));
  nor2   g61(.a(new_n38_), .b(x03), .O(new_n97_));
  aoi21  g62(.a(new_n97_), .b(new_n96_), .c(new_n48_), .O(z12));
  inv1   g63(.a(x17), .O(new_n99_));
  aoi21  g64(.a(new_n99_), .b(x06), .c(new_n48_), .O(z14));
  zero   g65(.O(z02));
  buf    g66(.a(x04), .O(z13));
endmodule
