...
module FAU ( 
  ...
  nor2   g28(.a(new_n58_), .b(x09), .O(new_n64_));
  ...
  nand3  g49(.a(new_n84_), .b(new_n79_), .c(new_n57_), .O(z09));
  inv1   g50(.a(x00), .O(new_n86_));
  nand2  g51(.a(new_n82_), .b(new_n86_), .O(new_n87_));
  nand3  g52(.a(new_n87_), .b(new_n64_), .c(new_n50_), .O(new_n88_));
  nand2  g53(.a(new_n55_), .b(x14), .O(new_n89_));
  aoi21  g54(.a(new_n89_), .b(new_n88_), .c(new_n56_), .O(z10));
  aoi21  g55(.a(new_n38_), .b(x04), .c(new_n49_), .O(z11));
  nand2  g56(.a(x16), .b(new_n49_), .O(new_n92_));
  nor2   g57(.a(new_n38_), .b(x03), .O(new_n93_));
  aoi21  g58(.a(new_n93_), .b(new_n92_), .c(new_n47_), .O(z12));
