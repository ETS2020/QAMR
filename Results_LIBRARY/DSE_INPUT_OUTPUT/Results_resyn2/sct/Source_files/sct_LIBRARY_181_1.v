...
module FAU ( 
  ...
  nor2   g15(.a(new_n49_), .b(new_n42_), .O(new_n50_));
  ...
  oai21  g28(.a(x09), .b(new_n42_), .c(new_n60_), .O(new_n63_));
  inv1   g29(.a(new_n53_), .O(new_n64_));
  nor2   g30(.a(x09), .b(new_n58_), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n63_), .c(new_n38_), .O(z05));
  inv1   g33(.a(x09), .O(new_n68_));
  inv1   g34(.a(x10), .O(new_n69_));
  inv1   g35(.a(new_n60_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  nand2  g37(.a(new_n65_), .b(new_n64_), .O(new_n72_));
  nand2  g38(.a(new_n69_), .b(x04), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n72_), .c(new_n49_), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n71_), .c(new_n38_), .O(z06));
  inv1   g41(.a(x11), .O(new_n76_));
  nand4  g42(.a(new_n70_), .b(new_n76_), .c(new_n69_), .d(new_n68_), .O(new_n77_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n76_), .c(new_n69_), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n80_), .c(new_n50_), .O(z08));
  oai21  g52(.a(x13), .b(new_n42_), .c(new_n37_), .O(new_n87_));
  inv1   g53(.a(new_n49_), .O(new_n88_));
  oai21  g54(.a(new_n83_), .b(new_n81_), .c(x13), .O(new_n89_));
  nor2   g55(.a(x12), .b(x11), .O(new_n90_));
  nor2   g56(.a(x13), .b(x10), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n65_), .d(new_n64_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n89_), .c(new_n88_), .O(new_n93_));
  ...
  nand2  g64(.a(new_n47_), .b(x02), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(x16), .c(new_n81_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n98_), .c(new_n42_), .O(new_n101_));
  nand3  g67(.a(new_n49_), .b(x14), .c(x04), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n37_), .c(new_n102_), .O(z10));
  nor2   g69(.a(new_n38_), .b(new_n35_), .O(z11));
  aoi21  g70(.a(x16), .b(new_n35_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n42_), .c(new_n39_), .O(z12));
