...
module FAU ( 
  ...
  oai21  g48(.a(new_n82_), .b(new_n61_), .c(new_n68_), .O(new_n83_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n65_), .c(new_n68_), .O(new_n88_));
  ...
  nor2   g59(.a(new_n89_), .b(x03), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n37_), .O(z12));
