...
module FAU ( 
  ...
  oai21  g13(.a(x03), .b(new_n35_), .c(x16), .O(new_n49_));
  ...
  nand2  g21(.a(new_n52_), .b(x09), .O(new_n57_));
  inv1   g22(.a(x09), .O(new_n58_));
  nand3  g23(.a(new_n58_), .b(x08), .c(x07), .O(new_n59_));
  nand3  g24(.a(new_n59_), .b(new_n57_), .c(new_n49_), .O(new_n60_));
  nand2  g25(.a(new_n60_), .b(x06), .O(new_n61_));
  nand2  g26(.a(new_n61_), .b(x04), .O(z05));
  inv1   g27(.a(x10), .O(new_n63_));
  nor2   g28(.a(new_n52_), .b(x09), .O(new_n64_));
  nand2  g29(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  inv1   g30(.a(new_n49_), .O(new_n66_));
  nor2   g31(.a(new_n66_), .b(new_n44_), .O(new_n67_));
  nand2  g32(.a(new_n59_), .b(x10), .O(new_n68_));
  nand3  g33(.a(new_n68_), .b(new_n67_), .c(new_n65_), .O(z06));
  nand2  g34(.a(new_n65_), .b(x11), .O(new_n70_));
  nor2   g35(.a(x11), .b(x10), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  nand3  g37(.a(new_n72_), .b(new_n70_), .c(new_n67_), .O(z07));
  inv1   g38(.a(x11), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(new_n63_), .O(new_n75_));
  oai21  g40(.a(new_n75_), .b(new_n59_), .c(x12), .O(new_n76_));
  nor3   g41(.a(x12), .b(x11), .c(x10), .O(new_n77_));
  nand2  g42(.a(new_n77_), .b(new_n64_), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n76_), .c(new_n49_), .O(new_n79_));
  nand2  g44(.a(new_n79_), .b(x06), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(x04), .O(z08));
  inv1   g46(.a(x13), .O(new_n82_));
  aoi21  g47(.a(new_n77_), .b(new_n64_), .c(new_n82_), .O(new_n83_));
  nor2   g48(.a(x13), .b(x12), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  oai21  g50(.a(new_n85_), .b(new_n59_), .c(new_n49_), .O(new_n86_));
  oai21  g51(.a(new_n86_), .b(new_n83_), .c(x06), .O(new_n87_));
  nand2  g52(.a(new_n87_), .b(x04), .O(z09));
  nand2  g53(.a(new_n66_), .b(x14), .O(new_n89_));
  inv1   g54(.a(x00), .O(new_n90_));
  nand2  g55(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nand3  g56(.a(new_n91_), .b(new_n64_), .c(new_n49_), .O(new_n92_));
  aoi21  g57(.a(new_n92_), .b(new_n89_), .c(new_n44_), .O(z10));
  nor2   g58(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g59(.a(x16), .b(new_n35_), .O(new_n95_));
  inv1   g60(.a(x06), .O(new_n96_));
  nor2   g61(.a(new_n96_), .b(x03), .O(new_n97_));
  aoi21  g62(.a(new_n97_), .b(new_n95_), .c(new_n37_), .O(z12));
