...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(new_n63_), .c(new_n57_), .O(z05));
  ...
  nand2  g38(.a(new_n53_), .b(new_n67_), .O(new_n73_));
  nor2   g39(.a(new_n65_), .b(new_n48_), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n72_), .O(z06));
  oai21  g43(.a(new_n70_), .b(new_n41_), .c(x11), .O(new_n78_));
  inv1   g44(.a(new_n65_), .O(new_n79_));
  nor2   g45(.a(x11), .b(x10), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n57_), .O(z07));
  nand2  g48(.a(new_n81_), .b(x12), .O(new_n83_));
  inv1   g49(.a(new_n58_), .O(new_n84_));
  nor2   g50(.a(x12), .b(x09), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n80_), .c(new_n84_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n83_), .c(new_n57_), .O(z08));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n80_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n68_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  aoi21  g57(.a(new_n86_), .b(x13), .c(new_n48_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n40_), .c(new_n91_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n89_), .b(new_n94_), .O(new_n95_));
  nor2   g61(.a(new_n53_), .b(new_n36_), .O(new_n96_));
  aoi21  g62(.a(new_n95_), .b(new_n74_), .c(new_n96_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n40_), .c(new_n50_), .O(z10));
  nor2   g64(.a(new_n37_), .b(new_n52_), .O(z11));
  nand2  g65(.a(x16), .b(new_n52_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n46_), .c(new_n40_), .O(z12));
  nand2  g67(.a(x06), .b(new_n40_), .O(z13));
