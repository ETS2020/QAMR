...
module FAU ( 
  ...
  nand2  g02(.a(x13), .b(x04), .O(new_n37_));
  or2    g03(.a(x14), .b(x01), .O(new_n38_));
  nand3  g04(.a(new_n38_), .b(new_n37_), .c(new_n36_), .O(z00));
  inv1   g05(.a(x13), .O(new_n40_));
  ...
  nand3  g42(.a(new_n70_), .b(new_n76_), .c(new_n75_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n70_), .b(new_n76_), .c(new_n81_), .d(new_n75_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n51_), .O(z08));
  nand2  g49(.a(new_n82_), .b(new_n51_), .O(z09));
  inv1   g50(.a(x04), .O(new_n85_));
  inv1   g51(.a(x00), .O(new_n86_));
  inv1   g52(.a(x10), .O(new_n87_));
  nand3  g53(.a(new_n81_), .b(new_n75_), .c(new_n87_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n65_), .c(new_n68_), .O(new_n90_));
  aoi21  g56(.a(new_n50_), .b(x14), .c(x13), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(new_n85_), .O(z10));
  aoi21  g58(.a(x13), .b(x04), .c(new_n35_), .O(z11));
  nand2  g59(.a(x16), .b(new_n35_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n48_), .c(new_n41_), .O(z12));
  inv1   g61(.a(new_n41_), .O(z13));
