...
module FAU ( 
  ...
  nor2   g16(.a(new_n37_), .b(new_n46_), .O(new_n51_));
  and2   g17(.a(new_n51_), .b(new_n48_), .O(new_n52_));
  ...
  nand3  g26(.a(new_n60_), .b(new_n58_), .c(new_n48_), .O(new_n61_));
  ...
  oai21  g34(.a(new_n60_), .b(x10), .c(x11), .O(new_n69_));
  ...
  aoi21  g41(.a(new_n70_), .b(new_n66_), .c(new_n75_), .O(new_n76_));
  ...
  nand2  g49(.a(new_n83_), .b(new_n66_), .O(new_n84_));
  oai21  g50(.a(new_n77_), .b(new_n60_), .c(x13), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n52_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n82_), .b(new_n87_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n66_), .c(new_n48_), .O(new_n89_));
  inv1   g55(.a(new_n48_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x14), .c(new_n37_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n89_), .c(new_n46_), .O(z10));
  nor2   g58(.a(z02), .b(new_n35_), .O(z11));
  nand2  g59(.a(x16), .b(new_n35_), .O(new_n94_));
  nor2   g60(.a(new_n37_), .b(x03), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n46_), .O(z12));
  nand2  g62(.a(new_n51_), .b(x17), .O(new_n97_));
