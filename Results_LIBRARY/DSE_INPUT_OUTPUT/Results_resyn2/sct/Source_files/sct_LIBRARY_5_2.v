...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n87_, new_n88_, new_n89_, new_n92_, new_n93_, new_n95_;
  ...
  nor3   g24(.a(new_n58_), .b(new_n37_), .c(new_n46_), .O(new_n59_));
  nand2  g25(.a(new_n51_), .b(x09), .O(new_n60_));
  nor2   g26(.a(new_n51_), .b(x09), .O(new_n61_));
  inv1   g27(.a(new_n61_), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z05));
  oai21  g29(.a(new_n51_), .b(x09), .c(x10), .O(new_n64_));
  inv1   g30(.a(x09), .O(new_n65_));
  inv1   g31(.a(x10), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n65_), .c(x08), .d(x07), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n48_), .O(new_n68_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n59_), .O(z07));
  inv1   g40(.a(x12), .O(new_n75_));
  nand3  g41(.a(new_n71_), .b(new_n61_), .c(new_n75_), .O(new_n76_));
  nand2  g42(.a(new_n72_), .b(x12), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n59_), .O(z08));
  nand2  g44(.a(new_n76_), .b(x13), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n75_), .c(new_n80_), .d(new_n66_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n61_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n79_), .c(new_n59_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(new_n86_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n61_), .c(new_n48_), .O(new_n88_));
  aoi21  g54(.a(new_n58_), .b(x14), .c(new_n37_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(new_n46_), .O(z10));
  nor2   g56(.a(z02), .b(new_n35_), .O(z11));
  nand2  g57(.a(x16), .b(new_n35_), .O(new_n92_));
  nor2   g58(.a(new_n37_), .b(x03), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(z12));
  inv1   g60(.a(x17), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x06), .c(new_n46_), .O(z14));
  buf    g62(.a(x04), .O(z13));
endmodule
