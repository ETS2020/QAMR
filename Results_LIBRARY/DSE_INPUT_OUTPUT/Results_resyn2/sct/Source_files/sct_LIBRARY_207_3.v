...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n60_), .c(new_n37_), .O(z04));
  oai21  g31(.a(new_n63_), .b(x13), .c(x09), .O(new_n66_));
  nand2  g32(.a(x08), .b(x07), .O(new_n67_));
  nor2   g33(.a(new_n67_), .b(x09), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(x13), .c(x06), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n66_), .c(new_n51_), .O(z05));
  nand2  g36(.a(new_n69_), .b(x10), .O(new_n71_));
  nand2  g37(.a(new_n60_), .b(new_n37_), .O(new_n72_));
  inv1   g38(.a(x13), .O(new_n73_));
  inv1   g39(.a(new_n63_), .O(new_n74_));
  nor2   g40(.a(x10), .b(x09), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n72_), .c(new_n71_), .O(z06));
  inv1   g43(.a(new_n67_), .O(new_n78_));
  aoi21  g44(.a(new_n75_), .b(new_n78_), .c(x13), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n47_), .c(x11), .O(new_n80_));
  nor2   g46(.a(x11), .b(x10), .O(new_n81_));
  nor3   g47(.a(new_n63_), .b(x13), .c(x09), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n80_), .c(new_n72_), .O(z07));
  aoi21  g50(.a(new_n81_), .b(new_n68_), .c(x13), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n47_), .c(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand2  g53(.a(new_n81_), .b(new_n87_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  aoi22  g55(.a(new_n89_), .b(new_n82_), .c(new_n60_), .d(new_n37_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n86_), .O(z08));
  inv1   g57(.a(x09), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(x08), .c(x07), .d(x06), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n88_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n60_), .c(new_n73_), .O(new_n95_));
  nand2  g61(.a(x13), .b(new_n47_), .O(new_n96_));
