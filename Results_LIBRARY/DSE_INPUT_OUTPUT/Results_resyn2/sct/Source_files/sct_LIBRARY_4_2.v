...
module FAU ( 
  ...
  aoi21  g17(.a(new_n51_), .b(x06), .c(new_n48_), .O(z03));
  ...
  aoi21  g22(.a(new_n56_), .b(x06), .c(new_n48_), .O(z04));
  ...
  nand3  g32(.a(new_n66_), .b(new_n64_), .c(new_n50_), .O(new_n67_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n50_), .O(new_n74_));
  ...
  oai21  g54(.a(new_n88_), .b(new_n60_), .c(new_n50_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n86_), .c(x06), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(z09));
  nand2  g57(.a(x06), .b(x04), .O(new_n92_));
  or2    g58(.a(new_n50_), .b(new_n40_), .O(new_n93_));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n88_), .b(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n71_), .c(new_n50_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n93_), .c(new_n92_), .O(z10));
  nor2   g63(.a(z02), .b(new_n35_), .O(z11));
  nand2  g64(.a(x16), .b(new_n35_), .O(new_n99_));
  nor2   g65(.a(new_n37_), .b(x03), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n48_), .O(z12));
  inv1   g67(.a(new_n92_), .O(z13));
  nand2  g68(.a(z13), .b(x17), .O(new_n103_));
