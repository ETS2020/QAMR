...
module FAU ( 
  ...
  inv1   g24(.a(x02), .O(new_n60_));
  oai21  g25(.a(x03), .b(new_n60_), .c(x16), .O(new_n61_));
  nand2  g26(.a(new_n55_), .b(x09), .O(new_n62_));
  ...
  nor2   g33(.a(new_n55_), .b(x09), .O(new_n69_));
  nand2  g34(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g35(.a(new_n64_), .b(x10), .O(new_n71_));
  nand3  g36(.a(new_n71_), .b(new_n70_), .c(new_n52_), .O(z06));
  nand2  g37(.a(new_n70_), .b(x11), .O(new_n73_));
  nor2   g38(.a(x11), .b(x10), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  nand3  g40(.a(new_n75_), .b(new_n73_), .c(new_n52_), .O(z07));
  inv1   g41(.a(x12), .O(new_n77_));
  aoi21  g42(.a(new_n74_), .b(new_n69_), .c(new_n77_), .O(new_n78_));
  nand2  g43(.a(new_n74_), .b(new_n77_), .O(new_n79_));
  oai21  g44(.a(new_n79_), .b(new_n64_), .c(new_n61_), .O(new_n80_));
  oai21  g45(.a(new_n80_), .b(new_n78_), .c(x06), .O(new_n81_));
  nand2  g46(.a(new_n81_), .b(x04), .O(z08));
  inv1   g47(.a(x13), .O(new_n83_));
  nand3  g48(.a(new_n74_), .b(new_n83_), .c(new_n77_), .O(new_n84_));
  inv1   g49(.a(new_n84_), .O(new_n85_));
  nand2  g50(.a(new_n85_), .b(new_n69_), .O(new_n86_));
  oai21  g51(.a(new_n79_), .b(new_n64_), .c(x13), .O(new_n87_));
  nand3  g52(.a(new_n87_), .b(new_n86_), .c(new_n52_), .O(z09));
  inv1   g53(.a(x00), .O(new_n89_));
  nand2  g54(.a(new_n84_), .b(new_n89_), .O(new_n90_));
  nand3  g55(.a(new_n90_), .b(new_n69_), .c(new_n61_), .O(new_n91_));
  nand2  g56(.a(new_n50_), .b(x14), .O(new_n92_));
  aoi21  g57(.a(new_n92_), .b(new_n91_), .c(new_n51_), .O(z10));
  nand2  g58(.a(new_n39_), .b(new_n60_), .O(z11));
  inv1   g59(.a(x04), .O(new_n95_));
  nand2  g60(.a(x16), .b(new_n60_), .O(new_n96_));
  nor2   g61(.a(new_n38_), .b(x03), .O(new_n97_));
  aoi21  g62(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(z12));
  inv1   g63(.a(new_n51_), .O(z13));
  inv1   g64(.a(x17), .O(new_n100_));
  aoi21  g65(.a(new_n100_), .b(x06), .c(new_n95_), .O(z14));
  zero   g66(.O(z02));
endmodule
