...
module FAU ( 
  ...
  nand2  g25(.a(x08), .b(x04), .O(new_n60_));
  ...
  oai21  g30(.a(x09), .b(new_n47_), .c(new_n62_), .O(new_n65_));
  nor2   g31(.a(new_n62_), .b(x09), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(new_n50_), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n65_), .c(new_n38_), .O(z05));
  oai21  g34(.a(x10), .b(new_n47_), .c(new_n37_), .O(new_n69_));
  ...
  nand3  g40(.a(new_n74_), .b(new_n72_), .c(new_n59_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n69_), .O(z06));
  oai21  g43(.a(x11), .b(new_n47_), .c(new_n37_), .O(new_n78_));
  nor2   g44(.a(x11), .b(x10), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n66_), .O(new_n80_));
  nand3  g46(.a(new_n71_), .b(x08), .c(x07), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x11), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n59_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n78_), .O(z07));
  oai21  g51(.a(x12), .b(new_n47_), .c(new_n37_), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nor2   g53(.a(new_n73_), .b(x09), .O(new_n88_));
  aoi21  g54(.a(new_n79_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  nor2   g55(.a(x12), .b(x11), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n71_), .c(new_n70_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n59_), .O(new_n92_));
  ...
  nand3  g63(.a(new_n90_), .b(new_n97_), .c(new_n96_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n66_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n95_), .c(new_n51_), .O(z09));
  nand2  g67(.a(new_n50_), .b(x14), .O(new_n102_));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n98_), .b(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n66_), .c(new_n59_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n102_), .c(new_n47_), .O(z10));
  nor2   g72(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g73(.a(x16), .b(new_n35_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n48_), .c(new_n47_), .O(z12));
