...
module FAU ( 
  ...
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n50_), .O(z08));
  nand2  g50(.a(new_n83_), .b(x13), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n75_), .d(new_n71_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n72_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n85_), .c(new_n50_), .O(z09));
  inv1   g57(.a(x02), .O(new_n92_));
  oai21  g58(.a(x03), .b(new_n92_), .c(x16), .O(new_n93_));
  inv1   g59(.a(x00), .O(new_n94_));
  nand2  g60(.a(new_n88_), .b(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n72_), .c(new_n93_), .O(new_n96_));
  nand2  g62(.a(new_n49_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n36_), .O(z10));
  nand2  g64(.a(new_n38_), .b(new_n92_), .O(z11));
  nand2  g65(.a(x16), .b(new_n92_), .O(new_n100_));
