...
module FAU ( 
  ...
  oai21  g20(.a(new_n54_), .b(new_n37_), .c(new_n46_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  oai21  g22(.a(new_n56_), .b(new_n49_), .c(new_n38_), .O(z03));
  ...
  oai21  g28(.a(x09), .b(new_n37_), .c(new_n46_), .O(new_n63_));
  ...
  nand3  g35(.a(new_n69_), .b(new_n67_), .c(new_n64_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x04), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n63_), .O(z05));
  inv1   g38(.a(x10), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n65_), .c(x08), .d(x07), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  nand2  g42(.a(new_n67_), .b(x10), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n50_), .O(z06));
  oai21  g44(.a(x11), .b(new_n37_), .c(new_n46_), .O(new_n79_));
  nand2  g45(.a(new_n74_), .b(x11), .O(new_n80_));
  nor2   g46(.a(x11), .b(x10), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n66_), .c(new_n65_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n64_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n79_), .O(z07));
  oai21  g51(.a(x12), .b(new_n37_), .c(new_n46_), .O(new_n86_));
  inv1   g52(.a(x11), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n73_), .c(new_n65_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n68_), .c(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n81_), .b(new_n66_), .c(new_n90_), .d(new_n65_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n89_), .c(new_n64_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n86_), .O(z08));
  nand2  g60(.a(new_n91_), .b(x13), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nor2   g62(.a(new_n88_), .b(new_n58_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n90_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n95_), .c(new_n50_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand3  g66(.a(new_n81_), .b(new_n96_), .c(new_n90_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g68(.a(new_n47_), .b(x02), .O(new_n103_));
  nand3  g69(.a(new_n65_), .b(x08), .c(x07), .O(new_n104_));
  aoi21  g70(.a(new_n103_), .b(x16), .c(new_n104_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n102_), .c(new_n37_), .O(new_n106_));
  nand3  g72(.a(new_n49_), .b(x14), .c(x04), .O(new_n107_));
  oai21  g73(.a(new_n106_), .b(new_n46_), .c(new_n107_), .O(z10));
  aoi21  g74(.a(x06), .b(new_n37_), .c(new_n35_), .O(z11));
  aoi21  g75(.a(x16), .b(new_n35_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n37_), .c(new_n38_), .O(z12));
  nand2  g77(.a(new_n46_), .b(new_n37_), .O(z13));
