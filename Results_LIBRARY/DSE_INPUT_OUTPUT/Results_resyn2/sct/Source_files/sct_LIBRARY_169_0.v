...
module FAU ( 
  ...
  aoi21  g23(.a(x06), .b(new_n37_), .c(new_n49_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n74_), .b(new_n52_), .c(new_n65_), .d(x08), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n51_), .O(z07));
  ...
  oai21  g49(.a(new_n83_), .b(new_n37_), .c(new_n82_), .O(z08));
  ...
  nand3  g57(.a(new_n74_), .b(new_n85_), .c(new_n79_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n70_), .c(new_n90_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n89_), .c(new_n37_), .O(z10));
  aoi21  g61(.a(new_n38_), .b(new_n37_), .c(new_n35_), .O(z11));
  nand2  g62(.a(x16), .b(new_n35_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n47_), .c(new_n37_), .O(z12));
