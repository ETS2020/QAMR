...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(new_n52_), .c(new_n55_), .O(z05));
  inv1   g22(.a(x10), .O(new_n57_));
  nand3  g23(.a(new_n49_), .b(new_n52_), .c(new_n57_), .O(z06));
  inv1   g24(.a(x11), .O(new_n59_));
  nand3  g25(.a(new_n49_), .b(new_n52_), .c(new_n59_), .O(z07));
  inv1   g26(.a(x12), .O(new_n61_));
  nand3  g27(.a(new_n49_), .b(new_n52_), .c(new_n61_), .O(z08));
