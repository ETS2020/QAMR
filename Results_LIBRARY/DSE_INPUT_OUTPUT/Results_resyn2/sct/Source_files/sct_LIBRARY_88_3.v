...
module FAU ( 
  ...
  nand4  g22(.a(new_n54_), .b(x08), .c(new_n41_), .d(x04), .O(new_n57_));
  ...
  oai21  g32(.a(new_n50_), .b(x13), .c(new_n41_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x04), .O(z09));
  inv1   g34(.a(x14), .O(new_n69_));
  nor3   g35(.a(new_n54_), .b(new_n42_), .c(new_n69_), .O(z10));
  nand2  g36(.a(new_n36_), .b(new_n53_), .O(z11));
  nand2  g37(.a(x16), .b(new_n53_), .O(new_n72_));
  nor2   g38(.a(x06), .b(x03), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n72_), .c(new_n52_), .O(z12));
