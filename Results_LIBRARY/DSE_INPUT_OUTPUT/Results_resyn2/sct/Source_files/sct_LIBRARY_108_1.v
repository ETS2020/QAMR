...
module FAU ( 
  ...
  nand3  g34(.a(new_n68_), .b(new_n65_), .c(new_n52_), .O(z05));
  inv1   g35(.a(x10), .O(new_n70_));
  nand3  g36(.a(new_n67_), .b(new_n66_), .c(new_n70_), .O(new_n71_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n67_), .c(new_n66_), .O(new_n80_));
  ...
  oai21  g49(.a(x12), .b(new_n48_), .c(new_n37_), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n70_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n77_), .c(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  inv1   g54(.a(new_n60_), .O(new_n89_));
  nand4  g55(.a(new_n79_), .b(new_n89_), .c(new_n88_), .d(new_n76_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n87_), .c(new_n56_), .O(new_n91_));
  ...
  nand3  g60(.a(new_n88_), .b(new_n85_), .c(new_n70_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n77_), .c(x13), .O(new_n96_));
  nor2   g62(.a(x13), .b(x12), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n79_), .c(new_n67_), .d(new_n66_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n96_), .c(new_n56_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n94_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  nand2  g68(.a(new_n97_), .b(new_n79_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g70(.a(new_n49_), .b(x02), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x16), .c(new_n77_), .O(new_n106_));
  ...
  oai21  g77(.a(new_n111_), .b(new_n48_), .c(new_n42_), .O(z12));
