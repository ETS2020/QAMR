...
module FAU ( 
  ...
  aoi21  g19(.a(new_n53_), .b(new_n40_), .c(new_n51_), .O(z03));
  nand2  g20(.a(new_n52_), .b(x08), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n40_), .c(new_n51_), .O(z04));
  ...
  aoi21  g33(.a(new_n67_), .b(new_n40_), .c(new_n51_), .O(z10));
  aoi21  g34(.a(x06), .b(x04), .c(new_n35_), .O(z11));
  nand2  g35(.a(x16), .b(new_n35_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n47_), .c(new_n41_), .O(z12));
  inv1   g37(.a(new_n41_), .O(z13));
  inv1   g38(.a(x17), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n40_), .c(new_n51_), .O(z14));
endmodule
