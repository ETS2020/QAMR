...
module FAU ( 
  ...
  oai21  g33(.a(x03), .b(new_n35_), .c(x16), .O(new_n69_));
  oai21  g34(.a(new_n62_), .b(x10), .c(x11), .O(new_n70_));
  nor2   g35(.a(x11), .b(x10), .O(new_n71_));
  nand2  g36(.a(new_n71_), .b(new_n66_), .O(new_n72_));
  nand3  g37(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(new_n73_));
  nand2  g38(.a(new_n73_), .b(x06), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(x04), .O(z07));
  inv1   g40(.a(x12), .O(new_n76_));
  aoi21  g41(.a(new_n71_), .b(new_n66_), .c(new_n76_), .O(new_n77_));
  nand2  g42(.a(new_n71_), .b(new_n76_), .O(new_n78_));
  oai21  g43(.a(new_n78_), .b(new_n62_), .c(new_n69_), .O(new_n79_));
  oai21  g44(.a(new_n79_), .b(new_n77_), .c(x06), .O(new_n80_));
  nand2  g45(.a(new_n80_), .b(x04), .O(z08));
  inv1   g46(.a(x13), .O(new_n82_));
  nand3  g47(.a(new_n71_), .b(new_n82_), .c(new_n76_), .O(new_n83_));
  inv1   g48(.a(new_n83_), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(new_n66_), .O(new_n85_));
  oai21  g50(.a(new_n78_), .b(new_n62_), .c(x13), .O(new_n86_));
  nand3  g51(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(z09));
  inv1   g52(.a(x00), .O(new_n88_));
  nand2  g53(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  nand3  g54(.a(new_n89_), .b(new_n66_), .c(new_n69_), .O(new_n90_));
  nand2  g55(.a(new_n51_), .b(x14), .O(new_n91_));
  aoi21  g56(.a(new_n91_), .b(new_n90_), .c(new_n44_), .O(z10));
  nor2   g57(.a(new_n38_), .b(new_n35_), .O(z11));
  nand2  g58(.a(x16), .b(new_n35_), .O(new_n94_));
  aoi21  g59(.a(new_n94_), .b(new_n49_), .c(new_n44_), .O(z12));
