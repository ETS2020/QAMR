...
module FAU ( 
  ...
  nor2   g20(.a(new_n38_), .b(x04), .O(new_n55_));
  nor2   g21(.a(new_n55_), .b(new_n51_), .O(new_n56_));
  ...
  nand2  g26(.a(new_n60_), .b(new_n39_), .O(z03));
  nand3  g27(.a(x08), .b(x07), .c(x06), .O(new_n62_));
  inv1   g28(.a(x08), .O(new_n63_));
  nand2  g29(.a(new_n57_), .b(new_n63_), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n62_), .c(new_n56_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n39_), .O(z04));
  ...
  oai21  g37(.a(new_n71_), .b(new_n37_), .c(new_n70_), .O(z05));
  ...
  nand3  g43(.a(new_n77_), .b(new_n74_), .c(new_n52_), .O(z06));
  ...
  oai21  g51(.a(new_n85_), .b(new_n73_), .c(x12), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  nand4  g54(.a(new_n80_), .b(new_n67_), .c(x08), .d(x07), .O(new_n89_));
  ...
  nand3  g63(.a(new_n80_), .b(new_n93_), .c(new_n67_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n62_), .c(x13), .O(new_n99_));
  ...
  nor2   g70(.a(new_n73_), .b(new_n51_), .O(new_n105_));
  nor2   g71(.a(new_n83_), .b(new_n41_), .O(new_n106_));
  aoi21  g72(.a(new_n105_), .b(new_n104_), .c(new_n106_), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n37_), .c(new_n39_), .O(z10));
  nand2  g74(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g75(.a(x16), .b(new_n35_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n49_), .c(new_n37_), .O(z12));
  nor2   g77(.a(x17), .b(new_n37_), .O(new_n112_));
  nor2   g78(.a(new_n112_), .b(new_n55_), .O(z14));
  buf    g79(.a(x04), .O(z13));
endmodule
