...
module FAU ( 
  ...
  nand3  g30(.a(new_n64_), .b(new_n60_), .c(new_n49_), .O(z05));
  oai21  g31(.a(new_n62_), .b(x10), .c(new_n38_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x06), .O(new_n67_));
  nor3   g33(.a(new_n54_), .b(x15), .c(x09), .O(new_n68_));
  inv1   g34(.a(new_n68_), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x10), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n67_), .c(new_n49_), .O(z06));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(x11), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n62_), .c(new_n38_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  nor2   g42(.a(new_n54_), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n38_), .c(new_n72_), .O(new_n78_));
  ...
  oai21  g49(.a(new_n83_), .b(new_n62_), .c(new_n38_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x06), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n49_), .O(z08));
  nand2  g52(.a(new_n85_), .b(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n82_), .c(new_n73_), .d(new_n72_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  aoi22  g56(.a(new_n90_), .b(new_n68_), .c(new_n48_), .d(new_n40_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n87_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n89_), .b(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n77_), .c(new_n47_), .O(new_n95_));
  inv1   g61(.a(x03), .O(new_n96_));
  inv1   g62(.a(x16), .O(new_n97_));
  aoi21  g63(.a(new_n96_), .b(x02), .c(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x14), .c(new_n39_), .O(new_n99_));
  aoi22  g65(.a(new_n99_), .b(new_n95_), .c(new_n40_), .d(new_n43_), .O(z10));
  nor2   g66(.a(new_n39_), .b(new_n35_), .O(z11));
  aoi21  g67(.a(x16), .b(new_n35_), .c(x03), .O(new_n102_));
  nor3   g68(.a(new_n102_), .b(new_n39_), .c(new_n43_), .O(z12));
  nand2  g69(.a(new_n40_), .b(new_n43_), .O(z13));
  nand2  g70(.a(new_n44_), .b(x17), .O(new_n105_));
