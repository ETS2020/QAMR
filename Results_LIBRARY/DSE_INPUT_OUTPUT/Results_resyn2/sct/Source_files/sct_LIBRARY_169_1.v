...
module FAU ( 
  ...
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n65_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n68_), .c(new_n50_), .O(z06));
  nand2  g38(.a(new_n71_), .b(x11), .O(new_n73_));
  nor2   g39(.a(x11), .b(x10), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n70_), .c(new_n65_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n50_), .O(z07));
  oai21  g42(.a(x12), .b(new_n37_), .c(new_n46_), .O(new_n77_));
  nand2  g43(.a(x08), .b(x07), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n69_), .c(new_n65_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n78_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n74_), .b(new_n70_), .c(new_n82_), .d(new_n65_), .O(new_n83_));
