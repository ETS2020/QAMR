...
module FAU ( 
  ...
  oai21  g53(.a(new_n87_), .b(new_n47_), .c(new_n38_), .O(new_n88_));
  ...
  nand2  g61(.a(new_n47_), .b(new_n38_), .O(new_n96_));
  ...
  nand3  g68(.a(new_n54_), .b(new_n38_), .c(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n51_), .O(z10));
  nor2   g70(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n35_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n51_), .c(new_n38_), .O(z12));
  nor2   g73(.a(new_n37_), .b(new_n51_), .O(z13));
