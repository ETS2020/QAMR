...
module FAU ( 
  ...
  nand2  g22(.a(new_n48_), .b(new_n39_), .O(new_n57_));
  nand2  g23(.a(x08), .b(x07), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x17), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x06), .O(new_n60_));
  inv1   g26(.a(x09), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(x08), .c(x07), .O(new_n62_));
  nand2  g28(.a(x17), .b(x06), .O(new_n63_));
  nor2   g29(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g30(.a(new_n60_), .b(x09), .c(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n57_), .O(z05));
  ...
  nand4  g40(.a(new_n71_), .b(new_n61_), .c(x08), .d(x07), .O(new_n75_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n72_), .c(new_n68_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n57_), .O(z07));
  aoi21  g47(.a(new_n79_), .b(new_n68_), .c(new_n67_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n37_), .c(x12), .O(new_n83_));
  nor3   g49(.a(x12), .b(x11), .c(x10), .O(new_n84_));
  aoi22  g50(.a(new_n84_), .b(new_n64_), .c(new_n48_), .d(new_n39_), .O(new_n85_));
  ...
  oai21  g55(.a(new_n89_), .b(new_n62_), .c(x17), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand2  g57(.a(new_n84_), .b(new_n64_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x13), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(new_n49_), .O(z09));
  ...
  nor2   g71(.a(new_n38_), .b(new_n95_), .O(z13));
  nor2   g72(.a(new_n67_), .b(new_n95_), .O(z14));
endmodule
