...
module FAU ( 
  ...
  nor2   g18(.a(x06), .b(new_n52_), .O(z13));
  inv1   g19(.a(x02), .O(new_n54_));
  oai21  g20(.a(x03), .b(new_n54_), .c(x16), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(z13), .c(x07), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z03));
  nand3  g23(.a(new_n55_), .b(z13), .c(x08), .O(new_n58_));
