...
module FAU ( 
  ...
  nand3  g43(.a(new_n77_), .b(new_n73_), .c(new_n58_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n52_), .O(z07));
  nor2   g45(.a(x12), .b(new_n56_), .O(new_n80_));
  ...
  aoi21  g49(.a(new_n78_), .b(x12), .c(new_n51_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n48_), .c(new_n83_), .O(z08));
  oai21  g51(.a(new_n81_), .b(x13), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  nor2   g53(.a(x12), .b(x09), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n77_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n62_), .c(x13), .O(new_n90_));
  ...
  nor2   g63(.a(new_n69_), .b(new_n51_), .O(new_n98_));
  ...
  oai21  g67(.a(new_n101_), .b(new_n48_), .c(new_n41_), .O(z10));
