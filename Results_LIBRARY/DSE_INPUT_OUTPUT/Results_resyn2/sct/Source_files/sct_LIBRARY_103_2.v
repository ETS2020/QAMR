...
module FAU ( 
  ...
  nor2   g10(.a(new_n44_), .b(new_n37_), .O(new_n45_));
  inv1   g11(.a(new_n45_), .O(new_n46_));
  nand2  g12(.a(new_n46_), .b(x05), .O(new_n47_));
  oai21  g13(.a(new_n43_), .b(x05), .c(new_n47_), .O(z01));
  ...
  nand4  g21(.a(new_n55_), .b(new_n53_), .c(new_n50_), .d(new_n45_), .O(new_n56_));
  ...
  nand4  g33(.a(new_n67_), .b(new_n64_), .c(new_n50_), .d(new_n45_), .O(z06));
  ...
  nand3  g57(.a(new_n91_), .b(new_n66_), .c(new_n50_), .O(new_n92_));
  inv1   g58(.a(new_n50_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x14), .c(new_n44_), .O(new_n94_));
  ...
  nor2   g63(.a(new_n97_), .b(new_n46_), .O(z12));
