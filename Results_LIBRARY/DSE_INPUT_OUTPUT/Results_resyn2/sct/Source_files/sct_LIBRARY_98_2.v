...
module FAU ( 
  ...
  nand3  g38(.a(x17), .b(new_n72_), .c(x06), .O(new_n73_));
  nor2   g39(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  aoi21  g40(.a(new_n48_), .b(new_n39_), .c(new_n74_), .O(new_n75_));
  ...
  oai21  g45(.a(new_n79_), .b(new_n77_), .c(x17), .O(new_n80_));
  ...
  oai21  g51(.a(new_n85_), .b(new_n77_), .c(x17), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x06), .O(new_n87_));
  inv1   g53(.a(new_n52_), .O(new_n88_));
  inv1   g54(.a(x08), .O(new_n89_));
  nor2   g55(.a(x09), .b(new_n89_), .O(new_n90_));
  nor3   g56(.a(x12), .b(x11), .c(x10), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n88_), .d(x17), .O(new_n92_));
  ...
  nor2   g74(.a(new_n55_), .b(new_n105_), .O(z14));
endmodule
