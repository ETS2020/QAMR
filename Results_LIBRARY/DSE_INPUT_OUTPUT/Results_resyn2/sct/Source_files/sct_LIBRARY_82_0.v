...
module FAU ( 
  ...
  nand2  g20(.a(new_n38_), .b(new_n47_), .O(new_n55_));
  ...
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n51_), .O(z05));
  ...
  nand3  g46(.a(new_n80_), .b(new_n76_), .c(new_n51_), .O(z08));
  nand3  g47(.a(new_n63_), .b(x08), .c(x06), .O(new_n82_));
  ...
  oai21  g54(.a(new_n88_), .b(new_n37_), .c(new_n87_), .O(z09));
  nand2  g55(.a(new_n50_), .b(x14), .O(new_n90_));
  inv1   g56(.a(x00), .O(new_n91_));
  nand2  g57(.a(new_n85_), .b(new_n91_), .O(new_n92_));
  nor2   g58(.a(new_n64_), .b(new_n50_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n90_), .c(new_n37_), .O(z10));
  nand2  g61(.a(new_n39_), .b(new_n35_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n35_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n37_), .c(new_n39_), .O(z12));
  nor2   g64(.a(new_n38_), .b(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z13));
  nor2   g66(.a(x17), .b(new_n37_), .O(new_n101_));
