...
module FAU ( 
  ...
  inv1   g16(.a(new_n41_), .O(z13));
  oai21  g17(.a(x03), .b(new_n35_), .c(x16), .O(new_n52_));
  nand3  g18(.a(new_n52_), .b(z13), .c(x07), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(z03));
  nand3  g20(.a(new_n52_), .b(z13), .c(x08), .O(new_n55_));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(z12));
