...
module FAU ( 
  ...
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n63_), .O(new_n68_));
  ...
  oai21  g48(.a(new_n82_), .b(new_n61_), .c(new_n63_), .O(new_n83_));
  ...
  nand3  g54(.a(new_n88_), .b(new_n65_), .c(new_n63_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n86_), .c(new_n50_), .O(z10));
