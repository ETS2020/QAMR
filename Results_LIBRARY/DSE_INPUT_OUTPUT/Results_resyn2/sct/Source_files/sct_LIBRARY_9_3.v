...
module FAU ( 
  ...
  inv1   g25(.a(new_n42_), .O(z13));
  nand3  g26(.a(new_n54_), .b(z13), .c(new_n59_), .O(z05));
  oai21  g27(.a(new_n51_), .b(x10), .c(new_n41_), .O(new_n62_));
  ...
  nand3  g34(.a(new_n54_), .b(z13), .c(new_n68_), .O(z09));
