...
module FAU ( 
  ...
  nor2   g09(.a(new_n43_), .b(z02), .O(new_n44_));
  nand2  g10(.a(x06), .b(x04), .O(new_n45_));
  nand2  g11(.a(new_n45_), .b(x05), .O(new_n46_));
  ...
  aoi21  g25(.a(new_n59_), .b(x06), .c(new_n37_), .O(z04));
  ...
  nor2   g33(.a(new_n56_), .b(x09), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g35(.a(new_n63_), .b(x10), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n52_), .O(z06));
  nand2  g37(.a(new_n69_), .b(x11), .O(new_n72_));
  nor2   g38(.a(x11), .b(x10), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n68_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n72_), .c(new_n52_), .O(z07));
  inv1   g41(.a(x12), .O(new_n76_));
  nand3  g42(.a(new_n73_), .b(new_n68_), .c(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n74_), .b(x12), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(z08));
  nand2  g45(.a(new_n77_), .b(x13), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n76_), .c(new_n81_), .d(new_n67_), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n68_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n80_), .c(new_n52_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(new_n87_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n68_), .c(new_n55_), .O(new_n89_));
  inv1   g55(.a(x06), .O(new_n90_));
  aoi21  g56(.a(new_n51_), .b(x14), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n89_), .c(new_n37_), .O(z10));
  nor2   g58(.a(z02), .b(new_n35_), .O(z11));
  nand2  g59(.a(x16), .b(new_n35_), .O(new_n94_));
  nor2   g60(.a(new_n90_), .b(x03), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n37_), .O(z12));
  inv1   g62(.a(new_n45_), .O(z13));
