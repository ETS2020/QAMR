...
module FAU ( 
  ...
  nand2  g15(.a(new_n37_), .b(x04), .O(new_n50_));
  oai21  g16(.a(new_n50_), .b(new_n49_), .c(new_n42_), .O(z02));
  inv1   g17(.a(x07), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(x06), .O(new_n53_));
  oai21  g19(.a(new_n50_), .b(new_n52_), .c(new_n53_), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n48_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(new_n42_), .O(z03));
  inv1   g22(.a(x08), .O(new_n57_));
  aoi21  g23(.a(new_n53_), .b(new_n50_), .c(new_n57_), .O(new_n58_));
  nor3   g24(.a(x08), .b(new_n52_), .c(new_n37_), .O(new_n59_));
  ...
  oai21  g29(.a(x09), .b(new_n62_), .c(new_n63_), .O(new_n64_));
  nor2   g30(.a(new_n63_), .b(x09), .O(new_n65_));
  nor2   g31(.a(new_n65_), .b(new_n49_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n64_), .c(new_n38_), .O(z05));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n48_), .d(x04), .O(z06));
  nor2   g37(.a(new_n57_), .b(new_n52_), .O(new_n72_));
  nand4  g38(.a(new_n69_), .b(new_n72_), .c(new_n48_), .d(x11), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x04), .O(new_n74_));
  inv1   g40(.a(x11), .O(new_n75_));
  nand4  g41(.a(new_n70_), .b(new_n48_), .c(new_n75_), .d(x04), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  aoi21  g43(.a(new_n74_), .b(x06), .c(new_n77_), .O(z07));
  oai21  g44(.a(x12), .b(new_n62_), .c(new_n37_), .O(new_n79_));
  nand4  g45(.a(new_n69_), .b(new_n75_), .c(x08), .d(x07), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x12), .O(new_n81_));
  nor2   g47(.a(x12), .b(x11), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n69_), .c(new_n72_), .d(x06), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n79_), .O(z08));
  inv1   g52(.a(x10), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand3  g54(.a(new_n82_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n65_), .O(new_n91_));
  nand2  g57(.a(new_n83_), .b(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n48_), .d(x04), .O(z09));
  nand2  g59(.a(new_n49_), .b(x14), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand2  g61(.a(new_n89_), .b(new_n95_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n65_), .c(new_n48_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n94_), .c(new_n62_), .O(z10));
  nor2   g64(.a(new_n38_), .b(new_n36_), .O(z11));
  aoi21  g65(.a(x16), .b(new_n36_), .c(x03), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n62_), .c(new_n42_), .O(z12));
  nand2  g67(.a(x17), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n42_), .O(z14));
  buf    g69(.a(x04), .O(z13));
endmodule
