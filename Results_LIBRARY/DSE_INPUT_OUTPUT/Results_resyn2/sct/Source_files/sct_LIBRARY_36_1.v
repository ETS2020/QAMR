...
module FAU ( 
  ...
  oai21  g28(.a(x09), .b(new_n36_), .c(new_n62_), .O(new_n63_));
  nand2  g29(.a(x08), .b(x07), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  nor2   g31(.a(x09), .b(new_n49_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n63_), .c(new_n47_), .O(new_n68_));
  ...
  nor2   g39(.a(new_n48_), .b(new_n36_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z06));
  or2    g41(.a(new_n72_), .b(x11), .O(new_n76_));
  nand2  g42(.a(new_n72_), .b(x11), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(z07));
  oai21  g44(.a(x12), .b(new_n36_), .c(new_n49_), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nor2   g46(.a(new_n64_), .b(x11), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n71_), .c(new_n80_), .O(new_n82_));
  nor2   g48(.a(x12), .b(x11), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n71_), .c(new_n70_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n82_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n79_), .O(z08));
  oai21  g53(.a(x13), .b(new_n36_), .c(new_n49_), .O(new_n88_));
  nand4  g54(.a(new_n83_), .b(new_n71_), .c(x08), .d(x07), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x13), .O(new_n90_));
  nor2   g56(.a(x13), .b(x10), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n83_), .c(new_n66_), .d(new_n65_), .O(new_n92_));
  ...
  nand2  g63(.a(new_n91_), .b(new_n83_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n66_), .c(new_n65_), .d(new_n47_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n96_), .c(new_n36_), .O(z10));
  nand2  g67(.a(new_n37_), .b(new_n46_), .O(z11));
