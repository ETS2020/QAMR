...
module FAU ( 
  ...
  nor2   g37(.a(x10), .b(new_n37_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n52_), .O(z06));
  oai21  g40(.a(x11), .b(new_n48_), .c(new_n73_), .O(new_n75_));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n76_), .c(new_n51_), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n38_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nand3  g49(.a(new_n80_), .b(new_n83_), .c(new_n76_), .O(new_n84_));
  oai21  g50(.a(new_n73_), .b(x11), .c(x12), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n52_), .O(z08));
  nand2  g52(.a(new_n84_), .b(x13), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n83_), .c(new_n76_), .d(new_n78_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n56_), .c(new_n67_), .d(x08), .O(new_n91_));
  ...
  aoi21  g61(.a(new_n95_), .b(x16), .c(new_n77_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n48_), .O(new_n97_));
  nand3  g63(.a(new_n51_), .b(x14), .c(x04), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n37_), .c(new_n98_), .O(z10));
  nand2  g65(.a(new_n42_), .b(new_n36_), .O(z11));
  nand2  g66(.a(x16), .b(new_n36_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n49_), .c(new_n48_), .O(z12));
  nor2   g68(.a(x06), .b(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z13));
  inv1   g70(.a(x17), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x04), .c(new_n103_), .O(z14));
endmodule
