...
module FAU ( 
  ...
  oai21  g20(.a(new_n54_), .b(new_n49_), .c(new_n37_), .O(z04));
  ...
  nand3  g27(.a(new_n61_), .b(new_n59_), .c(new_n37_), .O(z05));
  inv1   g28(.a(x10), .O(new_n63_));
  nand3  g29(.a(new_n59_), .b(new_n37_), .c(new_n63_), .O(z06));
  inv1   g30(.a(x11), .O(new_n65_));
  nand3  g31(.a(new_n59_), .b(new_n37_), .c(new_n65_), .O(z07));
  inv1   g32(.a(x12), .O(new_n67_));
  nand3  g33(.a(new_n59_), .b(new_n37_), .c(new_n67_), .O(z08));
  inv1   g34(.a(x13), .O(new_n69_));
  inv1   g35(.a(new_n37_), .O(new_n70_));
  aoi21  g36(.a(new_n59_), .b(new_n69_), .c(new_n70_), .O(z09));
  nand2  g37(.a(new_n37_), .b(x04), .O(new_n72_));
  nand3  g38(.a(new_n58_), .b(x16), .c(x14), .O(new_n73_));
  nor2   g39(.a(new_n73_), .b(new_n72_), .O(z10));
  nand2  g40(.a(new_n37_), .b(new_n47_), .O(z11));
  aoi21  g41(.a(x16), .b(new_n47_), .c(x03), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n72_), .O(z12));
  inv1   g43(.a(new_n72_), .O(z13));
  inv1   g44(.a(x17), .O(new_n79_));
  nor2   g45(.a(new_n72_), .b(new_n79_), .O(z14));
endmodule
