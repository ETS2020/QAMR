...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x04), .O(new_n41_));
  ...
  nand3  g11(.a(new_n45_), .b(new_n42_), .c(new_n38_), .O(z01));
  ...
  oai21  g34(.a(x03), .b(new_n35_), .c(x16), .O(new_n69_));
  oai21  g35(.a(new_n59_), .b(x09), .c(x10), .O(new_n70_));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(x08), .c(x07), .d(x06), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x13), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x04), .O(z06));
  nand2  g41(.a(new_n72_), .b(x11), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  nand3  g43(.a(new_n71_), .b(new_n66_), .c(new_n77_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n51_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n71_), .b(new_n66_), .c(new_n80_), .d(new_n77_), .O(new_n81_));
  nand2  g47(.a(new_n78_), .b(x12), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n51_), .O(z08));
  inv1   g49(.a(new_n81_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n51_), .O(z09));
  inv1   g51(.a(x04), .O(new_n86_));
  nand4  g52(.a(new_n66_), .b(new_n69_), .c(new_n65_), .d(x00), .O(new_n87_));
  aoi21  g53(.a(new_n50_), .b(x14), .c(new_n37_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(z10));
  aoi21  g55(.a(new_n37_), .b(x04), .c(new_n35_), .O(z11));
  nand2  g56(.a(x16), .b(new_n35_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n48_), .c(new_n41_), .O(z12));
  inv1   g58(.a(new_n41_), .O(z13));
