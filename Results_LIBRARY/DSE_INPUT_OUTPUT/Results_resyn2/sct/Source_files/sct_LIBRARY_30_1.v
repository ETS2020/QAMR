...
module FAU ( 
  ...
  aoi21  g19(.a(x07), .b(x04), .c(x06), .O(new_n54_));
  ...
  oai21  g24(.a(new_n58_), .b(new_n54_), .c(new_n37_), .O(z03));
  ...
  nand4  g42(.a(new_n76_), .b(new_n60_), .c(new_n75_), .d(new_n71_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n76_), .c(new_n60_), .d(new_n71_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n51_), .O(z08));
  ...
  nand3  g55(.a(new_n89_), .b(new_n84_), .c(new_n51_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand2  g57(.a(new_n87_), .b(new_n91_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n72_), .c(new_n56_), .O(new_n93_));
  nand2  g59(.a(new_n50_), .b(x14), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n36_), .O(z10));
  aoi21  g61(.a(x06), .b(new_n36_), .c(new_n55_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n55_), .c(x03), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n36_), .c(new_n37_), .O(z12));
  nor2   g64(.a(x06), .b(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z13));
  inv1   g66(.a(x17), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(x04), .c(new_n99_), .O(z14));
endmodule
