...
module FAU ( 
  ...
  nand4  g08(.a(new_n18_), .b(x8), .c(new_n25_), .d(new_n24_), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(new_n27_));
  aoi22  g10(.a(new_n27_), .b(new_n23_), .c(x9), .d(new_n22_), .O(z3));
  nand3  g11(.a(new_n18_), .b(x7), .c(x6), .O(z4));
  nand3  g12(.a(new_n23_), .b(x8), .c(x2), .O(new_n30_));
  ...
  nand2  g17(.a(x9), .b(new_n22_), .O(new_n35_));
  nand3  g18(.a(x9), .b(new_n25_), .c(x5), .O(new_n36_));
  ...
  nand4  g25(.a(x9), .b(new_n24_), .c(new_n42_), .d(new_n41_), .O(new_n43_));
  nand3  g26(.a(new_n18_), .b(x4), .c(x3), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n43_), .c(new_n25_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n40_), .c(x8), .O(new_n46_));
  inv1   g29(.a(x6), .O(new_n47_));
  oai21  g30(.a(z2), .b(new_n47_), .c(new_n35_), .O(new_n48_));
