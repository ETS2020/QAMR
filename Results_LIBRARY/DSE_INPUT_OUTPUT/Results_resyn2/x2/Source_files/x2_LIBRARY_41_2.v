...
module FAU ( 
  ...
  oai21  g06(.a(x9), .b(x1), .c(new_n20_), .O(new_n24_));
  ...
  nand2  g19(.a(new_n18_), .b(x1), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(x7), .d(x6), .O(z4));
  inv1   g21(.a(x5), .O(new_n39_));
  oai21  g22(.a(new_n30_), .b(new_n39_), .c(x6), .O(new_n40_));
  ...
  nand2  g27(.a(new_n36_), .b(x7), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n30_), .c(x2), .d(new_n31_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x6), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n44_), .c(new_n19_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n41_), .O(z5));
  ...
  oai21  g36(.a(new_n53_), .b(new_n50_), .c(x7), .O(new_n54_));
  inv1   g37(.a(x6), .O(new_n55_));
  oai21  g38(.a(new_n36_), .b(new_n39_), .c(new_n27_), .O(new_n56_));
  aoi22  g39(.a(new_n56_), .b(new_n20_), .c(new_n37_), .d(new_n55_), .O(new_n57_));
