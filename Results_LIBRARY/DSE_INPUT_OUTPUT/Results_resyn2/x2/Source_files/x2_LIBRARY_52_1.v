...
module FAU ( 
  ...
  aoi21  g11(.a(new_n22_), .b(new_n18_), .c(new_n25_), .O(z2));
  ...
  nand2  g26(.a(new_n36_), .b(new_n26_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n25_), .O(new_n45_));
  oai21  g28(.a(x6), .b(new_n24_), .c(x9), .O(new_n46_));
  nand4  g29(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n22_), .c(x6), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n45_), .O(z6));
endmodule
