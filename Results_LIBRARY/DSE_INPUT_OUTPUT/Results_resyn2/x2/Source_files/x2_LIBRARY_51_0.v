...
module FAU ( 
  ...
  nand2  g08(.a(x9), .b(x7), .O(new_n28_));
  nand2  g09(.a(new_n28_), .b(x8), .O(new_n29_));
  nor2   g10(.a(x1), .b(x0), .O(new_n30_));
  nand4  g11(.a(new_n30_), .b(new_n29_), .c(new_n20_), .d(x2), .O(new_n31_));
  inv1   g12(.a(x5), .O(new_n32_));
  oai21  g13(.a(new_n19_), .b(new_n32_), .c(x9), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n26_), .O(new_n34_));
  inv1   g15(.a(x3), .O(new_n35_));
  oai21  g16(.a(x4), .b(new_n35_), .c(x8), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(new_n18_), .O(new_n37_));
  nand4  g18(.a(new_n37_), .b(new_n34_), .c(new_n31_), .d(x6), .O(z5));
  nand2  g19(.a(x4), .b(x3), .O(new_n39_));
  oai22  g20(.a(new_n39_), .b(x9), .c(x7), .d(new_n32_), .O(new_n40_));
  aoi21  g21(.a(new_n18_), .b(new_n26_), .c(new_n19_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  inv1   g23(.a(x6), .O(new_n43_));
  oai21  g24(.a(x9), .b(x7), .c(new_n43_), .O(new_n44_));
  inv1   g25(.a(new_n28_), .O(new_n45_));
  nor3   g26(.a(x2), .b(x1), .c(x0), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n19_), .c(new_n45_), .O(new_n47_));
