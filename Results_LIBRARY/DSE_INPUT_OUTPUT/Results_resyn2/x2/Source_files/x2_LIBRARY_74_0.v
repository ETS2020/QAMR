...
module FAU ( 
  ...
  nand2  g13(.a(x8), .b(x7), .O(new_n32_));
  inv1   g14(.a(x0), .O(new_n33_));
  nand3  g15(.a(x2), .b(new_n18_), .c(new_n33_), .O(new_n34_));
  aoi21  g16(.a(new_n26_), .b(new_n32_), .c(new_n34_), .O(new_n35_));
  nand3  g17(.a(x8), .b(new_n24_), .c(x5), .O(new_n36_));
  nand2  g18(.a(new_n36_), .b(x6), .O(new_n37_));
  oai21  g19(.a(new_n37_), .b(new_n35_), .c(x9), .O(new_n38_));
  ...
  inv1   g26(.a(new_n36_), .O(new_n45_));
  inv1   g27(.a(x2), .O(new_n46_));
  nand3  g28(.a(new_n46_), .b(new_n18_), .c(new_n33_), .O(new_n47_));
  aoi21  g29(.a(new_n47_), .b(x8), .c(new_n24_), .O(new_n48_));
  oai21  g30(.a(new_n48_), .b(new_n45_), .c(x9), .O(new_n49_));
  xnor2a g31(.a(x8), .b(x7), .O(new_n50_));
  nand2  g32(.a(x7), .b(new_n40_), .O(new_n51_));
  inv1   g33(.a(x3), .O(new_n52_));
  nand2  g34(.a(x7), .b(new_n52_), .O(new_n53_));
  nand4  g35(.a(new_n53_), .b(new_n51_), .c(new_n50_), .d(new_n21_), .O(new_n54_));
  nand2  g36(.a(new_n54_), .b(x6), .O(new_n55_));
  nand2  g37(.a(new_n55_), .b(new_n29_), .O(new_n56_));
  nand2  g38(.a(new_n56_), .b(new_n49_), .O(z6));
  one    g39(.O(z3));
endmodule
