...
module FAU ( 
  ...
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n28_), .d(x8), .O(new_n31_));
  ...
  oai21  g22(.a(new_n28_), .b(new_n22_), .c(x7), .O(new_n40_));
  ...
  nand4  g31(.a(new_n28_), .b(x8), .c(x4), .d(x3), .O(new_n49_));
  ...
  nand2  g36(.a(new_n21_), .b(x6), .O(new_n54_));
