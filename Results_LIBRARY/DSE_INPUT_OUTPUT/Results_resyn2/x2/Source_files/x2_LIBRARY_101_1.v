...
module FAU ( 
  ...
  nor2   g06(.a(new_n19_), .b(new_n18_), .O(new_n24_));
  aoi21  g07(.a(x9), .b(new_n20_), .c(x8), .O(new_n25_));
  oai21  g08(.a(new_n24_), .b(new_n20_), .c(new_n25_), .O(z1));
  ...
  oai21  g16(.a(new_n19_), .b(x2), .c(new_n33_), .O(new_n34_));
  nand2  g17(.a(x9), .b(x8), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(x7), .O(new_n36_));
  oai21  g19(.a(new_n19_), .b(x2), .c(new_n36_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n34_), .O(z4));
  nand2  g21(.a(x8), .b(new_n20_), .O(new_n39_));
  nand3  g22(.a(new_n36_), .b(new_n39_), .c(new_n29_), .O(new_n40_));
  ...
  oai21  g35(.a(x7), .b(new_n52_), .c(x8), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n27_), .c(new_n24_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n51_), .c(new_n34_), .O(z6));
endmodule
