...
module FAU ( 
  ...
  nand3  g10(.a(new_n18_), .b(x8), .c(new_n20_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(new_n29_));
  aoi22  g12(.a(new_n29_), .b(new_n27_), .c(x9), .d(new_n21_), .O(z3));
  ...
  oai21  g17(.a(new_n34_), .b(new_n26_), .c(new_n33_), .O(new_n35_));
  ...
  nand4  g26(.a(x9), .b(new_n43_), .c(new_n25_), .d(new_n24_), .O(new_n44_));
  ...
  nand2  g31(.a(new_n37_), .b(x6), .O(new_n49_));
