...
module FAU ( 
  ...
  nand3  g10(.a(new_n27_), .b(new_n25_), .c(new_n20_), .O(z3));
  nand2  g11(.a(x9), .b(x8), .O(new_n29_));
  inv1   g12(.a(x6), .O(new_n30_));
  nor2   g13(.a(new_n20_), .b(new_n30_), .O(new_n31_));
  aoi22  g14(.a(new_n31_), .b(new_n29_), .c(x9), .d(new_n20_), .O(z4));
  ...
  aoi22  g22(.a(new_n21_), .b(new_n30_), .c(new_n18_), .d(new_n24_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n39_), .O(z5));
  inv1   g24(.a(x2), .O(new_n42_));
  nand4  g25(.a(x9), .b(new_n42_), .c(new_n36_), .d(new_n35_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n22_), .b(new_n30_), .c(new_n21_), .O(new_n47_));
