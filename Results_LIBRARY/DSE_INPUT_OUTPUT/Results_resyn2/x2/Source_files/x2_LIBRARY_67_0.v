...
module FAU ( 
  ...
  nor2   g12(.a(z2), .b(new_n29_), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n28_), .c(x7), .O(z4));
  ...
  nand3  g26(.a(x9), .b(new_n19_), .c(x5), .O(new_n44_));
  ...
  oai21  g30(.a(x9), .b(x8), .c(new_n29_), .O(new_n48_));
  oai21  g31(.a(new_n26_), .b(new_n22_), .c(new_n23_), .O(new_n49_));
