...
module FAU ( 
  ...
  nand4  g16(.a(new_n33_), .b(new_n31_), .c(new_n18_), .d(new_n30_), .O(z3));
  ...
  nand4  g23(.a(new_n38_), .b(new_n32_), .c(new_n31_), .d(x2), .O(new_n41_));
  ...
  nand2  g31(.a(new_n31_), .b(new_n30_), .O(new_n49_));
  nand4  g32(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n50_));
  oai21  g33(.a(new_n49_), .b(new_n21_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x7), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n36_), .c(z1), .O(z6));
endmodule
