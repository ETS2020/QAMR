...
module FAU ( 
  ...
  nand3  g12(.a(new_n29_), .b(new_n23_), .c(new_n20_), .O(new_n30_));
  ...
  oai21  g18(.a(new_n35_), .b(x7), .c(new_n20_), .O(new_n36_));
  ...
  nand3  g26(.a(new_n43_), .b(x9), .c(new_n20_), .O(new_n44_));
  ...
  nand2  g31(.a(new_n21_), .b(x8), .O(new_n49_));
