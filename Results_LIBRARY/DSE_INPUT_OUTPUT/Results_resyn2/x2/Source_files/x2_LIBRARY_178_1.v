...
module FAU ( 
  ...
  nand4  g15(.a(new_n32_), .b(new_n30_), .c(new_n19_), .d(new_n29_), .O(z3));
  ...
  nand4  g23(.a(new_n35_), .b(new_n31_), .c(new_n30_), .d(x2), .O(new_n41_));
  ...
  nand3  g33(.a(new_n29_), .b(new_n50_), .c(new_n49_), .O(new_n51_));
  ...
  oai21  g38(.a(x9), .b(x8), .c(new_n38_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n20_), .c(new_n18_), .O(new_n57_));
