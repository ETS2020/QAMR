...
module FAU ( 
  ...
  nand4  g12(.a(new_n30_), .b(new_n29_), .c(new_n27_), .d(x2), .O(new_n31_));
  ...
  aoi21  g22(.a(new_n18_), .b(new_n23_), .c(new_n20_), .O(new_n41_));
  ...
  oai21  g28(.a(new_n46_), .b(new_n20_), .c(new_n45_), .O(new_n47_));
