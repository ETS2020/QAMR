...
module FAU ( 
  ...
  nand3  g23(.a(new_n40_), .b(new_n32_), .c(x2), .O(new_n41_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n45_), .c(new_n41_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x6), .O(new_n50_));
  inv1   g33(.a(x6), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n50_), .O(z5));
  aoi21  g36(.a(new_n33_), .b(x8), .c(new_n26_), .O(new_n54_));
  nand3  g37(.a(new_n19_), .b(x4), .c(x3), .O(new_n55_));
  inv1   g38(.a(new_n55_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n54_), .c(x7), .O(new_n57_));
  oai21  g40(.a(x9), .b(x8), .c(new_n46_), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n24_), .c(new_n51_), .O(new_n59_));
