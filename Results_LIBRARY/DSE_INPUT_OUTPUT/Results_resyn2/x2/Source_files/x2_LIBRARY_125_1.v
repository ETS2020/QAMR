...
module FAU ( 
  ...
  aoi22  g05(.a(new_n22_), .b(new_n21_), .c(x9), .d(new_n20_), .O(z1));
  ...
  nand3  g26(.a(new_n43_), .b(new_n26_), .c(x7), .O(new_n44_));
  nand3  g27(.a(x9), .b(x8), .c(x5), .O(new_n45_));
  inv1   g28(.a(new_n45_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n25_), .c(new_n28_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(new_n44_), .c(new_n24_), .d(x6), .O(z6));
endmodule
