...
module FAU ( 
  ...
  nand2  g26(.a(new_n35_), .b(x9), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n19_), .O(new_n45_));
  nand2  g28(.a(new_n24_), .b(new_n38_), .O(new_n46_));
  nand4  g29(.a(new_n21_), .b(new_n18_), .c(x4), .d(x3), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(z6));
endmodule
