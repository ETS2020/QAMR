...
module FAU ( 
  ...
  nand2  g12(.a(new_n29_), .b(new_n27_), .O(z1));
  nor2   g13(.a(new_n26_), .b(x9), .O(z2));
  inv1   g14(.a(x0), .O(new_n32_));
  inv1   g15(.a(x1), .O(new_n33_));
  inv1   g16(.a(x2), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(new_n20_), .c(new_n18_), .O(new_n36_));
  inv1   g19(.a(x3), .O(new_n37_));
  nand2  g20(.a(x9), .b(new_n37_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x7), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n36_), .c(new_n29_), .O(z3));
  inv1   g23(.a(x6), .O(new_n41_));
  nand3  g24(.a(new_n38_), .b(x7), .c(new_n41_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n29_), .c(new_n19_), .O(z4));
  nand3  g26(.a(x8), .b(new_n25_), .c(x5), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x3), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(x9), .c(new_n41_), .O(new_n46_));
  ...
  nand2  g33(.a(x9), .b(x8), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n25_), .c(new_n26_), .O(new_n52_));
  nand4  g35(.a(new_n52_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n50_), .c(new_n46_), .O(z5));
  aoi21  g37(.a(new_n35_), .b(x8), .c(new_n21_), .O(new_n55_));
  nand4  g38(.a(new_n21_), .b(x8), .c(x4), .d(x3), .O(new_n56_));
  inv1   g39(.a(new_n56_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n55_), .c(x7), .O(new_n58_));
  inv1   g41(.a(x5), .O(new_n59_));
  oai21  g42(.a(new_n51_), .b(new_n59_), .c(new_n22_), .O(new_n60_));
  nand2  g43(.a(new_n38_), .b(x6), .O(new_n61_));
  aoi21  g44(.a(new_n60_), .b(new_n25_), .c(new_n61_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n58_), .O(z6));
endmodule
