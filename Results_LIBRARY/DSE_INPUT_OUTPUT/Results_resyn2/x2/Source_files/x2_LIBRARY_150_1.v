...
module FAU ( 
  ...
  nand2  g10(.a(x9), .b(new_n20_), .O(new_n28_));
  nand2  g11(.a(new_n18_), .b(x7), .O(new_n29_));
  nand2  g12(.a(x9), .b(new_n25_), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(new_n31_));
  oai21  g14(.a(new_n25_), .b(x6), .c(new_n31_), .O(z4));
  ...
  aoi21  g31(.a(new_n18_), .b(x7), .c(x8), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n48_), .c(new_n30_), .O(new_n50_));
