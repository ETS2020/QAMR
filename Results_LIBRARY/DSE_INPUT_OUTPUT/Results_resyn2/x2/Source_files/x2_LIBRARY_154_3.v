...
module FAU ( 
  ...
  oai21  g12(.a(new_n29_), .b(new_n27_), .c(new_n20_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n22_), .O(z3));
  nand3  g14(.a(new_n18_), .b(x7), .c(x6), .O(z4));
  inv1   g15(.a(x8), .O(new_n33_));
  nand3  g16(.a(x2), .b(new_n26_), .c(new_n25_), .O(new_n34_));
