...
module FAU ( 
  ...
  nor2   g13(.a(x9), .b(new_n26_), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(new_n30_), .c(new_n21_), .d(new_n29_), .O(z3));
  aoi21  g15(.a(x9), .b(x8), .c(new_n21_), .O(new_n33_));
  aoi22  g16(.a(new_n33_), .b(x6), .c(x9), .d(new_n20_), .O(z4));
  inv1   g17(.a(new_n33_), .O(new_n35_));
  nand2  g18(.a(x8), .b(new_n21_), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(new_n35_), .c(new_n30_), .d(x2), .O(new_n37_));
  ...
  nand2  g25(.a(new_n27_), .b(x6), .O(new_n43_));
  ...
  nand2  g35(.a(new_n41_), .b(new_n27_), .O(new_n53_));
  nand2  g36(.a(new_n25_), .b(x6), .O(new_n54_));
