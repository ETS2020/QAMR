...
module FAU ( 
  ...
  oai21  g17(.a(new_n34_), .b(new_n30_), .c(x6), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n18_), .O(z3));
  nand2  g19(.a(x9), .b(x8), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(x7), .c(x6), .O(z4));
  nand3  g21(.a(new_n20_), .b(new_n19_), .c(x6), .O(new_n39_));
  oai21  g22(.a(new_n37_), .b(new_n19_), .c(new_n39_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(x2), .c(new_n32_), .d(new_n31_), .O(new_n41_));
  inv1   g24(.a(x5), .O(new_n42_));
  oai21  g25(.a(new_n30_), .b(new_n42_), .c(x6), .O(new_n43_));
  ...
  oai21  g34(.a(new_n51_), .b(new_n27_), .c(new_n24_), .O(new_n52_));
  aoi21  g35(.a(new_n34_), .b(x8), .c(new_n19_), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n43_), .c(x9), .O(new_n54_));
