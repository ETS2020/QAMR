...
module FAU ( 
  ...
  nand4  g14(.a(new_n31_), .b(new_n29_), .c(new_n21_), .d(new_n28_), .O(z3));
  nand2  g15(.a(x9), .b(x8), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(x7), .c(x6), .O(z4));
  nand2  g17(.a(new_n30_), .b(new_n22_), .O(new_n35_));
  oai21  g18(.a(new_n33_), .b(new_n22_), .c(new_n35_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n29_), .c(x2), .O(new_n37_));
  ...
  aoi21  g26(.a(new_n43_), .b(new_n22_), .c(new_n20_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n41_), .c(new_n37_), .O(z5));
  oai21  g28(.a(new_n43_), .b(new_n25_), .c(new_n21_), .O(new_n46_));
  inv1   g29(.a(x0), .O(new_n47_));
  inv1   g30(.a(x1), .O(new_n48_));
  nand3  g31(.a(new_n28_), .b(new_n48_), .c(new_n47_), .O(new_n49_));
