...
module FAU ( 
  ...
  nand3  g07(.a(new_n24_), .b(x9), .c(x6), .O(new_n25_));
  ...
  oai21  g17(.a(new_n20_), .b(new_n34_), .c(new_n18_), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n25_), .O(z4));
  ...
  nand4  g26(.a(x9), .b(x8), .c(x6), .d(x5), .O(new_n44_));
  inv1   g27(.a(new_n44_), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(new_n20_), .c(new_n34_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z5));
  nand2  g30(.a(x9), .b(x6), .O(new_n48_));
  aoi21  g31(.a(new_n31_), .b(x8), .c(new_n48_), .O(new_n49_));
  ...
  aoi22  g36(.a(new_n53_), .b(new_n20_), .c(new_n18_), .d(new_n34_), .O(new_n54_));
