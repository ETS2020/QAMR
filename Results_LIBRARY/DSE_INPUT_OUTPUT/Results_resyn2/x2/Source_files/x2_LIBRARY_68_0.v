...
module FAU ( 
  ...
  nand2  g11(.a(new_n28_), .b(new_n23_), .O(z1));
  nand3  g12(.a(new_n27_), .b(new_n24_), .c(new_n22_), .O(new_n30_));
  inv1   g13(.a(new_n30_), .O(z2));
  inv1   g14(.a(x0), .O(new_n32_));
  inv1   g15(.a(x1), .O(new_n33_));
  inv1   g16(.a(x2), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(new_n35_));
  nand3  g18(.a(new_n27_), .b(x8), .c(new_n22_), .O(new_n36_));
  or2    g19(.a(new_n36_), .b(new_n35_), .O(z3));
  nand2  g20(.a(new_n18_), .b(new_n26_), .O(new_n38_));
  nand2  g21(.a(x9), .b(x8), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(x7), .d(x6), .O(z4));
  nand3  g23(.a(x2), .b(new_n33_), .c(new_n32_), .O(new_n41_));
  aoi21  g24(.a(new_n25_), .b(new_n19_), .c(new_n41_), .O(new_n42_));
  nand3  g25(.a(x8), .b(new_n22_), .c(x5), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x6), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(x9), .O(new_n45_));
  inv1   g28(.a(x4), .O(new_n46_));
  aoi21  g29(.a(x7), .b(new_n46_), .c(new_n24_), .O(new_n47_));
