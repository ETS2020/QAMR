...
module FAU ( 
  ...
  nand2  g01(.a(x9), .b(x6), .O(new_n19_));
  ...
  nand3  g10(.a(new_n27_), .b(new_n25_), .c(new_n19_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z1));
  inv1   g12(.a(new_n27_), .O(z2));
  nor2   g13(.a(x1), .b(x0), .O(new_n31_));
  inv1   g14(.a(x2), .O(new_n32_));
  nand4  g15(.a(new_n18_), .b(x8), .c(new_n21_), .d(new_n32_), .O(new_n33_));
  ...
  oai21  g26(.a(new_n43_), .b(new_n26_), .c(new_n18_), .O(new_n44_));
