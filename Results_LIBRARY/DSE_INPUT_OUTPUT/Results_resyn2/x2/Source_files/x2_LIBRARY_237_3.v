...
module FAU ( 
  ...
  nand3  g12(.a(new_n18_), .b(x8), .c(new_n22_), .O(new_n30_));
  inv1   g13(.a(new_n30_), .O(new_n31_));
  aoi21  g14(.a(new_n31_), .b(new_n29_), .c(new_n21_), .O(z3));
  ...
  aoi21  g24(.a(new_n41_), .b(new_n37_), .c(new_n35_), .O(new_n42_));
  ...
  oai21  g29(.a(new_n42_), .b(x5), .c(new_n46_), .O(z5));
  inv1   g30(.a(x2), .O(new_n48_));
  nand4  g31(.a(x9), .b(new_n48_), .c(new_n39_), .d(new_n38_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n52_), .b(z1), .c(x6), .O(z6));
endmodule
