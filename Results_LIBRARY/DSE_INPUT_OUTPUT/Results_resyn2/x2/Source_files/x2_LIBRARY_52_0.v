...
module FAU ( 
  ...
  nand2  g20(.a(x7), .b(new_n37_), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(new_n36_), .c(x8), .O(new_n39_));
  ...
  aoi21  g26(.a(new_n43_), .b(new_n28_), .c(new_n41_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n40_), .c(new_n35_), .O(z5));
  inv1   g28(.a(x2), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n26_), .c(new_n31_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(x8), .c(new_n20_), .O(new_n48_));
  nand3  g31(.a(x8), .b(new_n20_), .c(x5), .O(new_n49_));
  inv1   g32(.a(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n48_), .c(x9), .O(new_n51_));
  nand2  g34(.a(x7), .b(new_n36_), .O(new_n52_));
  nand4  g35(.a(new_n52_), .b(new_n38_), .c(new_n32_), .d(new_n18_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x6), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(z3), .O(new_n55_));
