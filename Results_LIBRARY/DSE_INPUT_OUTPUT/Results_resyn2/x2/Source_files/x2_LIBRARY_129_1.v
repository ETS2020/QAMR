...
module FAU ( 
  ...
  nand3  g02(.a(new_n19_), .b(x7), .c(x2), .O(z0));
  inv1   g03(.a(x2), .O(new_n21_));
  inv1   g04(.a(x7), .O(new_n22_));
  oai21  g05(.a(new_n22_), .b(new_n21_), .c(x9), .O(new_n23_));
  ...
  nand4  g11(.a(new_n28_), .b(new_n19_), .c(new_n22_), .d(new_n21_), .O(z3));
  ...
  nand2  g29(.a(new_n46_), .b(new_n37_), .O(z5));
  aoi21  g30(.a(x4), .b(x3), .c(x9), .O(new_n48_));
  nand3  g31(.a(new_n35_), .b(new_n30_), .c(x7), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n48_), .c(x6), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x2), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n37_), .O(z6));
endmodule
