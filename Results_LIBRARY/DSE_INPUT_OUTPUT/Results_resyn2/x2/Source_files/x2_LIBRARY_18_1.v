...
module FAU ( 
  ...
  oai22  g36(.a(new_n53_), .b(new_n18_), .c(x9), .d(x8), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n19_), .c(new_n52_), .O(new_n55_));
