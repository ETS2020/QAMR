...
module FAU ( 
  ...
  nand4  g09(.a(new_n27_), .b(new_n20_), .c(x8), .d(new_n26_), .O(z3));
  nand4  g10(.a(x9), .b(new_n19_), .c(x7), .d(x6), .O(z4));
  oai21  g11(.a(new_n20_), .b(x6), .c(x7), .O(new_n30_));
  nand3  g12(.a(x9), .b(x8), .c(x5), .O(new_n31_));
  nand3  g13(.a(new_n31_), .b(new_n21_), .c(x6), .O(new_n32_));
  nand2  g14(.a(new_n32_), .b(new_n30_), .O(new_n33_));
  nor2   g15(.a(x1), .b(x0), .O(new_n34_));
  nand2  g16(.a(x8), .b(new_n26_), .O(new_n35_));
  nand4  g17(.a(new_n35_), .b(new_n34_), .c(new_n23_), .d(x2), .O(new_n36_));
  nand2  g18(.a(new_n36_), .b(new_n33_), .O(z5));
  oai21  g19(.a(new_n27_), .b(new_n22_), .c(x7), .O(new_n38_));
  nand2  g20(.a(new_n38_), .b(new_n33_), .O(z6));
  one    g21(.O(z0));
endmodule
