...
module FAU ( 
  ...
  nor2   g17(.a(x9), .b(new_n27_), .O(new_n35_));
  nand4  g18(.a(new_n35_), .b(new_n34_), .c(new_n26_), .d(x6), .O(z3));
  oai21  g19(.a(x8), .b(new_n22_), .c(x9), .O(new_n37_));
  oai21  g20(.a(x7), .b(new_n22_), .c(new_n37_), .O(z4));
  ...
  oai21  g36(.a(x9), .b(new_n22_), .c(new_n42_), .O(new_n54_));
  aoi21  g37(.a(new_n18_), .b(x8), .c(x7), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n54_), .c(new_n22_), .O(new_n56_));
