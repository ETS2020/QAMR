...
module FAU ( 
  ...
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n18_), .d(new_n21_), .O(z3));
  aoi21  g14(.a(x9), .b(x8), .c(new_n21_), .O(new_n32_));
  aoi22  g15(.a(new_n32_), .b(x6), .c(x9), .d(new_n20_), .O(z4));
  ...
  nand2  g26(.a(new_n43_), .b(new_n32_), .O(new_n44_));
  inv1   g27(.a(x6), .O(new_n45_));
  nand2  g28(.a(new_n18_), .b(new_n45_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n27_), .c(new_n25_), .O(new_n47_));
  inv1   g30(.a(new_n47_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n36_), .O(z6));
endmodule
