...
module FAU ( 
  ...
  nor2   g11(.a(new_n24_), .b(new_n29_), .O(new_n30_));
  nor2   g12(.a(x9), .b(x0), .O(new_n31_));
  oai22  g13(.a(new_n31_), .b(new_n30_), .c(new_n21_), .d(new_n25_), .O(z4));
  nand2  g14(.a(x8), .b(x7), .O(new_n33_));
  inv1   g15(.a(x1), .O(new_n34_));
  nand3  g16(.a(x2), .b(new_n34_), .c(new_n18_), .O(new_n35_));
  aoi21  g17(.a(new_n26_), .b(new_n33_), .c(new_n35_), .O(new_n36_));
  nand3  g18(.a(x8), .b(new_n24_), .c(x5), .O(new_n37_));
  ...
  oai21  g24(.a(new_n42_), .b(new_n29_), .c(x0), .O(new_n43_));
  nand2  g25(.a(new_n43_), .b(new_n39_), .O(z5));
  inv1   g26(.a(x2), .O(new_n45_));
  nand3  g27(.a(x7), .b(new_n45_), .c(new_n34_), .O(new_n46_));
  nand2  g28(.a(new_n46_), .b(x9), .O(new_n47_));
  nand2  g29(.a(new_n47_), .b(new_n18_), .O(new_n48_));
  nand2  g30(.a(new_n21_), .b(new_n25_), .O(new_n49_));
  nand3  g31(.a(x9), .b(x8), .c(x5), .O(new_n50_));
  nand2  g32(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g33(.a(new_n51_), .b(new_n24_), .O(new_n52_));
  nand2  g34(.a(x4), .b(x3), .O(new_n53_));
  oai21  g35(.a(new_n53_), .b(x9), .c(x8), .O(new_n54_));
  nand3  g36(.a(new_n54_), .b(new_n49_), .c(x7), .O(new_n55_));
  nand4  g37(.a(new_n55_), .b(new_n52_), .c(new_n48_), .d(x6), .O(z6));
  one    g38(.O(z3));
endmodule
