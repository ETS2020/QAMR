...
module FAU ( 
  ...
  nand4  g14(.a(new_n31_), .b(new_n30_), .c(new_n22_), .d(new_n29_), .O(z3));
  oai21  g15(.a(x8), .b(new_n24_), .c(x9), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(x7), .c(x6), .O(z4));
  nand3  g17(.a(x8), .b(new_n22_), .c(x5), .O(new_n35_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n30_), .c(x2), .O(new_n44_));
  ...
  aoi21  g37(.a(new_n18_), .b(x8), .c(x7), .O(new_n55_));
