...
module FAU ( 
  ...
  nand2  g06(.a(new_n18_), .b(new_n19_), .O(new_n24_));
  ...
  aoi22  g20(.a(new_n37_), .b(new_n36_), .c(new_n18_), .d(x2), .O(z4));
  ...
  nand3  g31(.a(x9), .b(new_n31_), .c(new_n30_), .O(new_n49_));
  ...
  oai21  g37(.a(new_n24_), .b(x8), .c(new_n45_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n20_), .c(new_n54_), .O(new_n56_));
