...
module FAU ( 
  ...
  nor2   g22(.a(new_n18_), .b(new_n27_), .O(new_n41_));
  oai21  g23(.a(new_n40_), .b(new_n19_), .c(new_n41_), .O(new_n42_));
  ...
  nand2  g29(.a(z3), .b(new_n47_), .O(new_n48_));
  nand3  g30(.a(new_n48_), .b(new_n46_), .c(new_n42_), .O(z6));
  zero   g31(.O(z2));
endmodule
