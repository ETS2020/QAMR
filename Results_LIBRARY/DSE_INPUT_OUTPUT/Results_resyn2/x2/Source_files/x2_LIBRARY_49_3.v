...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n26_,
    new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n35_, new_n36_,
  ...
  nand2  g31(.a(new_n26_), .b(new_n48_), .O(new_n49_));
  oai21  g32(.a(new_n35_), .b(new_n21_), .c(new_n28_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n23_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(z6));
endmodule
