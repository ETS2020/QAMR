...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n22_, new_n24_, new_n28_, new_n29_,
  ...
  nand2  g07(.a(new_n18_), .b(new_n24_), .O(z3));
  inv1   g08(.a(z3), .O(z2));
  ...
  nand2  g21(.a(new_n24_), .b(x5), .O(new_n39_));
  ...
  nor2   g26(.a(new_n18_), .b(new_n24_), .O(new_n44_));
