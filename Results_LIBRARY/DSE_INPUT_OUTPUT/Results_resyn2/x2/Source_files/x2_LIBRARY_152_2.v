...
module FAU ( 
  ...
  nor3   g07(.a(x9), .b(x7), .c(x6), .O(new_n25_));
  oai21  g08(.a(new_n25_), .b(new_n24_), .c(new_n21_), .O(z1));
  nand2  g09(.a(new_n25_), .b(new_n21_), .O(new_n27_));
  ...
  nand2  g21(.a(new_n21_), .b(x7), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(new_n29_), .d(x2), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n33_), .b(x8), .c(new_n20_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n44_), .c(x9), .O(new_n46_));
