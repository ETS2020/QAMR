...
module FAU ( 
  ...
  nand2  g08(.a(new_n25_), .b(new_n21_), .O(z1));
  ...
  oai21  g20(.a(x9), .b(x6), .c(new_n37_), .O(z4));
  oai21  g21(.a(new_n35_), .b(new_n20_), .c(new_n27_), .O(new_n39_));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n20_), .c(new_n18_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n44_), .c(new_n40_), .O(z5));
  aoi21  g31(.a(new_n32_), .b(x8), .c(new_n19_), .O(new_n49_));
