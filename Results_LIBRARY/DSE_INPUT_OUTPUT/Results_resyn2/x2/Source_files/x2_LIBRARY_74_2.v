...
module FAU ( 
  ...
  nand3  g27(.a(x8), .b(new_n27_), .c(x5), .O(new_n45_));
  ...
  nand2  g32(.a(new_n30_), .b(x9), .O(new_n50_));
  ...
  oai22  g38(.a(new_n32_), .b(new_n55_), .c(new_n20_), .d(x8), .O(new_n56_));
  aoi22  g39(.a(new_n56_), .b(new_n27_), .c(new_n33_), .d(new_n54_), .O(new_n57_));
