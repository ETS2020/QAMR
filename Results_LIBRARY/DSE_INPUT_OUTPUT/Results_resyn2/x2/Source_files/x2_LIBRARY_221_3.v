...
module FAU ( 
  ...
  nor2   g09(.a(x9), .b(x7), .O(new_n27_));
  nor2   g10(.a(x1), .b(x0), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(x8), .d(new_n26_), .O(new_n29_));
  and2   g12(.a(new_n29_), .b(new_n21_), .O(z3));
  ...
  nand4  g17(.a(x9), .b(x8), .c(new_n34_), .d(x5), .O(new_n35_));
  ...
  nand3  g27(.a(x9), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  ...
  oai21  g31(.a(x9), .b(x6), .c(new_n21_), .O(new_n49_));
  aoi21  g32(.a(new_n23_), .b(new_n20_), .c(new_n49_), .O(new_n50_));
