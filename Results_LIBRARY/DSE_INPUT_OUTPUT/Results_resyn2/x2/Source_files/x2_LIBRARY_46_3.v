...
module FAU ( 
  ...
  aoi22  g13(.a(x9), .b(x8), .c(x7), .d(x6), .O(z4));
  nand4  g14(.a(new_n20_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n32_));
  ...
  aoi22  g22(.a(new_n39_), .b(new_n38_), .c(new_n36_), .d(new_n35_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n34_), .O(z5));
  nand3  g24(.a(x8), .b(x4), .c(x3), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n22_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n36_), .c(x7), .O(new_n44_));
  aoi21  g27(.a(new_n36_), .b(new_n35_), .c(z2), .O(new_n45_));
