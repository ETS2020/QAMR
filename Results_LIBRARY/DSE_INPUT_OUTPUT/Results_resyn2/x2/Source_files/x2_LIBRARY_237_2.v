...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(new_n28_), .c(new_n18_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n19_), .O(z3));
  nand2  g17(.a(new_n19_), .b(x5), .O(new_n35_));
  ...
  oai21  g23(.a(new_n28_), .b(new_n18_), .c(x6), .O(new_n41_));
  ...
  oai21  g32(.a(new_n32_), .b(new_n19_), .c(new_n49_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x7), .O(new_n51_));
  nand2  g34(.a(new_n28_), .b(x9), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x5), .O(new_n53_));
  nor2   g36(.a(new_n22_), .b(new_n43_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(z6));
endmodule
