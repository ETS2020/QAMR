...
module FAU ( 
  ...
  oai21  g25(.a(new_n42_), .b(new_n40_), .c(x6), .O(new_n43_));
  inv1   g26(.a(x9), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(x7), .c(x3), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x6), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n18_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n43_), .O(z5));
  aoi21  g31(.a(new_n32_), .b(x8), .c(new_n44_), .O(new_n49_));
  nand4  g32(.a(new_n44_), .b(x8), .c(x4), .d(x3), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n49_), .c(x7), .O(new_n52_));
  inv1   g35(.a(x6), .O(new_n53_));
  oai21  g36(.a(x9), .b(x8), .c(new_n41_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n26_), .c(new_n53_), .O(new_n55_));
