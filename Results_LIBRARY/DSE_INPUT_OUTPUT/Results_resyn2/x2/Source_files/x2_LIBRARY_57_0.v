...
module FAU ( 
  ...
  nor2   g06(.a(new_n22_), .b(x7), .O(new_n25_));
  nor3   g07(.a(x2), .b(x1), .c(x0), .O(new_n26_));
  nand3  g08(.a(new_n26_), .b(new_n25_), .c(new_n18_), .O(z3));
  nand2  g09(.a(x9), .b(x8), .O(new_n28_));
  nand2  g10(.a(new_n18_), .b(new_n22_), .O(new_n29_));
  nand4  g11(.a(new_n29_), .b(new_n28_), .c(x7), .d(x6), .O(z4));
  nor2   g12(.a(x1), .b(x0), .O(new_n31_));
  nand2  g13(.a(new_n22_), .b(x7), .O(new_n32_));
  nand4  g14(.a(new_n32_), .b(new_n31_), .c(new_n20_), .d(x2), .O(new_n33_));
  nand2  g15(.a(new_n25_), .b(x5), .O(new_n34_));
  ...
  nor2   g23(.a(new_n18_), .b(new_n19_), .O(new_n42_));
  oai21  g24(.a(new_n26_), .b(new_n22_), .c(new_n42_), .O(new_n43_));
  inv1   g25(.a(x6), .O(new_n44_));
  nand2  g26(.a(new_n29_), .b(new_n44_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n49_), .b(new_n45_), .c(new_n43_), .O(z6));
  zero   g32(.O(z2));
endmodule
