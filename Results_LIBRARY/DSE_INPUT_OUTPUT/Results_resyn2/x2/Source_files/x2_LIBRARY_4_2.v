...
module FAU ( 
  ...
  oai21  g08(.a(new_n25_), .b(new_n20_), .c(new_n24_), .O(z1));
  ...
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n19_), .d(x8), .O(z3));
  ...
  aoi22  g37(.a(new_n54_), .b(new_n23_), .c(new_n33_), .d(new_n53_), .O(new_n55_));
