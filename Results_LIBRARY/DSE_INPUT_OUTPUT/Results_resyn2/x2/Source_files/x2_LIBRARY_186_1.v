...
module FAU ( 
  ...
  nand3  g06(.a(x9), .b(x7), .c(x6), .O(new_n24_));
  oai21  g07(.a(x9), .b(x7), .c(new_n24_), .O(new_n25_));
  ...
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(new_n21_), .O(new_n34_));
  ...
  aoi21  g31(.a(new_n32_), .b(x8), .c(new_n21_), .O(new_n49_));
  ...
  aoi21  g36(.a(new_n53_), .b(new_n19_), .c(new_n44_), .O(new_n54_));
