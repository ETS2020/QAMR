...
module FAU ( 
  ...
  oai21  g16(.a(new_n20_), .b(x6), .c(x7), .O(new_n35_));
  nand3  g17(.a(x9), .b(x8), .c(x5), .O(new_n36_));
  nand3  g18(.a(new_n36_), .b(new_n21_), .c(x6), .O(new_n37_));
  nand2  g19(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  nand2  g20(.a(x8), .b(new_n25_), .O(new_n39_));
  nand4  g21(.a(new_n28_), .b(new_n39_), .c(new_n23_), .d(x2), .O(new_n40_));
  nand2  g22(.a(new_n40_), .b(new_n38_), .O(z5));
