...
module FAU ( 
  ...
  nand3  g18(.a(new_n19_), .b(x8), .c(new_n28_), .O(new_n36_));
  nor2   g19(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  aoi21  g20(.a(x9), .b(new_n31_), .c(new_n37_), .O(z3));
  nand2  g21(.a(x9), .b(x8), .O(new_n39_));
  nor2   g22(.a(x9), .b(x6), .O(new_n40_));
  aoi21  g23(.a(new_n28_), .b(x6), .c(new_n40_), .O(new_n41_));
  oai21  g24(.a(new_n39_), .b(new_n31_), .c(new_n41_), .O(z4));
  nand4  g25(.a(x9), .b(x8), .c(x6), .d(x5), .O(new_n43_));
  inv1   g26(.a(new_n43_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n28_), .c(new_n31_), .O(new_n45_));
  ...
  oai21  g32(.a(new_n39_), .b(new_n28_), .c(new_n29_), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n49_), .c(new_n45_), .O(z5));
  aoi21  g35(.a(new_n35_), .b(x8), .c(new_n21_), .O(new_n53_));
  ...
  nand2  g39(.a(new_n43_), .b(new_n20_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(new_n28_), .c(new_n40_), .O(new_n58_));
