...
module FAU ( 
  ...
  nand4  g13(.a(new_n31_), .b(new_n30_), .c(new_n20_), .d(x2), .O(new_n32_));
  nand2  g14(.a(x8), .b(x5), .O(new_n33_));
  nand2  g15(.a(new_n33_), .b(x9), .O(new_n34_));
  nand2  g16(.a(new_n34_), .b(new_n29_), .O(new_n35_));
  ...
  nand3  g23(.a(x9), .b(new_n29_), .c(x5), .O(new_n42_));
  nand2  g24(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g25(.a(new_n43_), .b(x8), .O(new_n44_));
  nand2  g26(.a(z3), .b(new_n36_), .O(new_n45_));
  nor2   g27(.a(new_n18_), .b(new_n29_), .O(new_n46_));
  nor3   g28(.a(x2), .b(x1), .c(x0), .O(new_n47_));
  oai21  g29(.a(new_n47_), .b(new_n19_), .c(new_n46_), .O(new_n48_));
  nand3  g30(.a(new_n48_), .b(new_n45_), .c(new_n44_), .O(z6));
  zero   g31(.O(z2));
endmodule
