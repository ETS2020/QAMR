...
module FAU ( 
  ...
  nand3  g18(.a(x2), .b(new_n29_), .c(new_n28_), .O(new_n36_));
  ...
  nand2  g29(.a(new_n39_), .b(x9), .O(new_n47_));
  nand2  g30(.a(new_n18_), .b(x8), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n47_), .c(new_n19_), .O(new_n49_));
  nand2  g32(.a(new_n23_), .b(new_n42_), .O(new_n50_));
  nand4  g33(.a(new_n21_), .b(new_n18_), .c(x4), .d(x3), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(z6));
endmodule
