...
module FAU ( 
  ...
  nand3  g16(.a(new_n27_), .b(new_n33_), .c(new_n32_), .O(new_n34_));
  ...
  aoi21  g20(.a(new_n37_), .b(x6), .c(new_n18_), .O(z4));
  ...
  oai21  g25(.a(new_n42_), .b(new_n39_), .c(new_n25_), .O(new_n43_));
  and2   g26(.a(x9), .b(x5), .O(new_n44_));
  nor2   g27(.a(x1), .b(x0), .O(new_n45_));
  nand2  g28(.a(new_n26_), .b(x7), .O(new_n46_));
  ...
  nand2  g37(.a(new_n26_), .b(new_n19_), .O(new_n55_));
  nand2  g38(.a(new_n45_), .b(new_n33_), .O(new_n56_));
