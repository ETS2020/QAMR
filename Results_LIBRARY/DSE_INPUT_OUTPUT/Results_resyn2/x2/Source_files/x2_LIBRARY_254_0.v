...
module FAU ( 
  ...
  aoi21  g21(.a(new_n38_), .b(new_n37_), .c(new_n36_), .O(z4));
  ...
  nand4  g31(.a(new_n48_), .b(new_n45_), .c(new_n42_), .d(x6), .O(z5));
  aoi21  g32(.a(new_n32_), .b(x8), .c(new_n18_), .O(new_n50_));
  nand2  g33(.a(x8), .b(x4), .O(new_n51_));
  nor2   g34(.a(new_n51_), .b(x9), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n50_), .c(x7), .O(new_n53_));
  oai21  g36(.a(x9), .b(x8), .c(new_n43_), .O(new_n54_));
  oai21  g37(.a(x9), .b(x3), .c(x6), .O(new_n55_));
  aoi21  g38(.a(new_n54_), .b(new_n19_), .c(new_n55_), .O(new_n56_));
