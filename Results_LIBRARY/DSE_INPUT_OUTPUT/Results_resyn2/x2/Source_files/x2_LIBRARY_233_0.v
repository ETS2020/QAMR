...
module FAU ( 
  ...
  nand2  g24(.a(new_n25_), .b(new_n24_), .O(new_n42_));
  nand3  g25(.a(x9), .b(x8), .c(x7), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n41_), .c(new_n40_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n39_), .c(x6), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x2), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n35_), .O(z5));
  nand3  g31(.a(new_n18_), .b(new_n41_), .c(new_n40_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(x8), .c(new_n24_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n34_), .c(x9), .O(new_n51_));
  nand4  g34(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n42_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n21_), .c(new_n32_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n51_), .c(new_n28_), .O(z6));
endmodule
