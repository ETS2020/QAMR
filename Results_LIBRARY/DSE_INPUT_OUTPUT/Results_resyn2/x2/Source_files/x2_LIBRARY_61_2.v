...
module FAU ( 
  ...
  nand3  g17(.a(new_n34_), .b(new_n32_), .c(new_n18_), .O(z3));
  ...
  aoi21  g32(.a(new_n31_), .b(x8), .c(new_n18_), .O(new_n50_));
  ...
  oai21  g37(.a(new_n36_), .b(new_n46_), .c(new_n54_), .O(new_n55_));
  oai21  g38(.a(x9), .b(new_n19_), .c(x6), .O(new_n56_));
  aoi21  g39(.a(new_n55_), .b(new_n20_), .c(new_n56_), .O(new_n57_));
