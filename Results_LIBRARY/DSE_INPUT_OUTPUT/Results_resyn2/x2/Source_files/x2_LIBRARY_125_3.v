...
module FAU ( 
  ...
  nand3  g05(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n23_));
  nand3  g06(.a(x9), .b(new_n22_), .c(x7), .O(new_n24_));
  nand3  g07(.a(new_n24_), .b(new_n23_), .c(new_n20_), .O(new_n25_));
  inv1   g08(.a(new_n25_), .O(z1));
  nand2  g09(.a(new_n23_), .b(new_n20_), .O(z2));
  nor2   g10(.a(x2), .b(x1), .O(new_n28_));
  nor2   g11(.a(x7), .b(x0), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n18_), .d(x8), .O(z3));
  oai21  g13(.a(x8), .b(x0), .c(x9), .O(new_n31_));
  ...
  oai21  g21(.a(new_n38_), .b(x0), .c(x9), .O(new_n39_));
  inv1   g22(.a(x3), .O(new_n40_));
  nor2   g23(.a(x9), .b(new_n40_), .O(new_n41_));
  nor2   g24(.a(new_n21_), .b(x4), .O(new_n42_));
  oai21  g25(.a(x9), .b(x8), .c(x6), .O(new_n43_));
  aoi21  g26(.a(new_n42_), .b(new_n41_), .c(new_n43_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n39_), .c(new_n36_), .O(z5));
  ...
  nand2  g33(.a(new_n37_), .b(x9), .O(new_n51_));
  aoi21  g34(.a(new_n18_), .b(x8), .c(x7), .O(new_n52_));
  nand2  g35(.a(new_n20_), .b(x6), .O(new_n53_));
