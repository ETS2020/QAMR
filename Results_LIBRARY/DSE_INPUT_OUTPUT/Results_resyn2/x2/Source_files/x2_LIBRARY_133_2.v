...
module FAU ( 
  ...
  nand4  g14(.a(new_n31_), .b(new_n30_), .c(new_n24_), .d(x2), .O(new_n32_));
  inv1   g15(.a(x6), .O(new_n33_));
  nor2   g16(.a(new_n18_), .b(x7), .O(new_n34_));
  and2   g17(.a(x8), .b(x5), .O(new_n35_));
  aoi21  g18(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n32_), .c(new_n25_), .O(z5));
  oai21  g20(.a(new_n27_), .b(new_n18_), .c(x7), .O(new_n38_));
  nand2  g21(.a(new_n22_), .b(new_n20_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(z6));
endmodule
