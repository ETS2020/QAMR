...
module FAU ( 
  ...
  nand3  g15(.a(x8), .b(new_n20_), .c(x5), .O(new_n34_));
  inv1   g16(.a(new_n34_), .O(new_n35_));
  oai21  g17(.a(new_n35_), .b(new_n33_), .c(x9), .O(new_n36_));
  nand3  g18(.a(new_n36_), .b(new_n32_), .c(new_n23_), .O(z5));
  inv1   g19(.a(x2), .O(new_n38_));
  nand3  g20(.a(new_n38_), .b(new_n29_), .c(new_n28_), .O(new_n39_));
  aoi21  g21(.a(new_n39_), .b(x8), .c(new_n20_), .O(new_n40_));
  oai21  g22(.a(new_n40_), .b(new_n35_), .c(x9), .O(new_n41_));
  aoi21  g23(.a(z0), .b(new_n33_), .c(z2), .O(new_n42_));
  nand2  g24(.a(new_n42_), .b(new_n41_), .O(z6));
  one    g25(.O(z3));
endmodule
