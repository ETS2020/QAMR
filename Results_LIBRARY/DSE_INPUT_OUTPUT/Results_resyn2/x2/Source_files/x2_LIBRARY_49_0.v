...
module FAU ( 
  ...
  oai21  g15(.a(new_n30_), .b(new_n24_), .c(new_n26_), .O(new_n34_));
  ...
  nand2  g20(.a(new_n38_), .b(new_n21_), .O(new_n39_));
  inv1   g21(.a(x6), .O(new_n40_));
  inv1   g22(.a(new_n30_), .O(new_n41_));
  inv1   g23(.a(x5), .O(new_n42_));
  nor2   g24(.a(x7), .b(new_n42_), .O(new_n43_));
  aoi21  g25(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(new_n44_));
  nand3  g26(.a(new_n44_), .b(new_n39_), .c(new_n35_), .O(z5));
  nand3  g27(.a(new_n18_), .b(new_n33_), .c(new_n32_), .O(new_n46_));
  ...
  aoi21  g33(.a(new_n51_), .b(new_n26_), .c(x9), .O(new_n52_));
  oai21  g34(.a(new_n52_), .b(new_n40_), .c(new_n29_), .O(new_n53_));
