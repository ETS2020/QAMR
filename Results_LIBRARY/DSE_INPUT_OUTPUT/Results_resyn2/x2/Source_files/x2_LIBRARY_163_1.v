...
module FAU ( 
  ...
  nand4  g09(.a(new_n18_), .b(x8), .c(new_n20_), .d(new_n26_), .O(new_n27_));
  inv1   g10(.a(new_n27_), .O(new_n28_));
  aoi21  g11(.a(new_n28_), .b(new_n25_), .c(new_n24_), .O(z3));
  nor2   g12(.a(x9), .b(new_n20_), .O(new_n30_));
  aoi21  g13(.a(new_n30_), .b(x6), .c(new_n24_), .O(z4));
  nand3  g14(.a(new_n25_), .b(x8), .c(x2), .O(new_n32_));
  ...
  nand4  g28(.a(x9), .b(new_n26_), .c(new_n45_), .d(new_n44_), .O(new_n46_));
