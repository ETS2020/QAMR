...
module FAU ( 
  ...
  nor2   g09(.a(new_n19_), .b(x7), .O(new_n28_));
  nand4  g10(.a(new_n28_), .b(new_n27_), .c(new_n20_), .d(new_n26_), .O(z3));
  ...
  oai21  g17(.a(new_n35_), .b(new_n34_), .c(new_n22_), .O(new_n36_));
  xnor2a g18(.a(x8), .b(x7), .O(new_n37_));
  nand3  g19(.a(new_n37_), .b(new_n27_), .c(x2), .O(new_n38_));
  aoi21  g20(.a(new_n20_), .b(x7), .c(new_n30_), .O(new_n39_));
  nand3  g21(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(z5));
