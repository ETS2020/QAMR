...
module FAU ( 
  ...
  nor2   g05(.a(new_n18_), .b(new_n19_), .O(new_n23_));
  nor2   g06(.a(x9), .b(x8), .O(new_n24_));
  aoi21  g07(.a(new_n24_), .b(new_n19_), .c(new_n23_), .O(z1));
  ...
  oai21  g18(.a(new_n18_), .b(new_n19_), .c(new_n35_), .O(new_n36_));
  nand3  g19(.a(x9), .b(x8), .c(x5), .O(new_n37_));
  inv1   g20(.a(x0), .O(new_n38_));
  inv1   g21(.a(x1), .O(new_n39_));
  nand4  g22(.a(new_n20_), .b(x2), .c(new_n39_), .d(new_n38_), .O(new_n40_));
  ...
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n36_), .O(z6));
endmodule
