...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(new_n28_), .c(x3), .O(new_n33_));
  ...
  or2    g20(.a(new_n37_), .b(new_n35_), .O(z4));
  nand2  g21(.a(x8), .b(x7), .O(new_n39_));
  nand2  g22(.a(new_n25_), .b(new_n24_), .O(new_n40_));
  nand3  g23(.a(x2), .b(new_n30_), .c(new_n29_), .O(new_n41_));
  aoi21  g24(.a(new_n40_), .b(new_n39_), .c(new_n41_), .O(new_n42_));
  inv1   g25(.a(x5), .O(new_n43_));
  oai21  g26(.a(new_n28_), .b(new_n43_), .c(x6), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(x9), .O(new_n45_));
  inv1   g28(.a(x4), .O(new_n46_));
  aoi21  g29(.a(x7), .b(new_n46_), .c(new_n25_), .O(new_n47_));
  ...
  nor3   g34(.a(x9), .b(new_n25_), .c(new_n46_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n51_), .c(x7), .O(new_n53_));
  nand2  g36(.a(new_n21_), .b(new_n25_), .O(new_n54_));
  oai21  g37(.a(new_n36_), .b(new_n43_), .c(new_n54_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n24_), .c(new_n35_), .O(new_n56_));
