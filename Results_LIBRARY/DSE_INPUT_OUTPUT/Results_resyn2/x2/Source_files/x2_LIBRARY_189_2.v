...
module FAU ( 
  ...
  oai21  g06(.a(new_n23_), .b(new_n18_), .c(new_n20_), .O(z0));
  aoi21  g07(.a(x9), .b(new_n18_), .c(x8), .O(new_n25_));
  oai21  g08(.a(new_n19_), .b(x9), .c(new_n25_), .O(z1));
  inv1   g09(.a(x8), .O(new_n27_));
  nand3  g10(.a(new_n19_), .b(new_n21_), .c(new_n27_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  inv1   g12(.a(x0), .O(new_n30_));
  inv1   g13(.a(x1), .O(new_n31_));
  inv1   g14(.a(x2), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n33_));
  nand2  g16(.a(new_n23_), .b(new_n19_), .O(new_n34_));
  ...
  nand3  g21(.a(new_n38_), .b(new_n36_), .c(new_n20_), .O(z4));
  nand2  g22(.a(new_n18_), .b(x4), .O(new_n40_));
  nand3  g23(.a(new_n21_), .b(x7), .c(x3), .O(new_n41_));
  nand4  g24(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n42_));
  aoi21  g25(.a(new_n42_), .b(new_n41_), .c(x4), .O(new_n43_));
  nand2  g26(.a(new_n21_), .b(new_n27_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x6), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n43_), .c(new_n40_), .O(new_n46_));
  oai21  g29(.a(new_n20_), .b(x8), .c(new_n36_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(x2), .c(new_n31_), .d(new_n30_), .O(new_n48_));
  ...
  oai21  g37(.a(new_n22_), .b(new_n54_), .c(x7), .O(new_n55_));
  oai21  g38(.a(new_n44_), .b(x7), .c(x6), .O(new_n56_));
  aoi21  g39(.a(new_n55_), .b(x4), .c(new_n56_), .O(new_n57_));
