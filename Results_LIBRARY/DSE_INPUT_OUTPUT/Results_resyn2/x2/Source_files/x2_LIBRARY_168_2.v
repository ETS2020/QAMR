...
module FAU ( 
  ...
  nand2  g14(.a(new_n21_), .b(x7), .O(new_n32_));
  nor2   g15(.a(new_n27_), .b(new_n24_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n25_), .c(new_n32_), .O(new_n34_));
  inv1   g17(.a(x7), .O(new_n35_));
  nand3  g18(.a(x9), .b(x8), .c(x5), .O(new_n36_));
  inv1   g19(.a(new_n36_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n20_), .c(new_n35_), .O(new_n38_));
  nand2  g21(.a(z0), .b(new_n29_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(new_n34_), .O(z5));
  inv1   g23(.a(x0), .O(new_n41_));
  inv1   g24(.a(x1), .O(new_n42_));
  nand3  g25(.a(new_n24_), .b(new_n42_), .c(new_n41_), .O(new_n43_));
  aoi21  g26(.a(new_n43_), .b(x8), .c(new_n35_), .O(new_n44_));
  nand3  g27(.a(x8), .b(new_n35_), .c(x5), .O(new_n45_));
  inv1   g28(.a(new_n45_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n44_), .c(x9), .O(new_n47_));
  aoi21  g30(.a(z0), .b(new_n29_), .c(z2), .O(new_n48_));
