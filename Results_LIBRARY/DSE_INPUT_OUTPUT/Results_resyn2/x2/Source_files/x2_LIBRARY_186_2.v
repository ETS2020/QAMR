...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(new_n29_), .c(new_n19_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n18_), .O(z3));
  nand2  g17(.a(x9), .b(x6), .O(new_n35_));
  nand2  g18(.a(new_n21_), .b(x7), .O(new_n36_));
  or2    g19(.a(new_n36_), .b(new_n35_), .O(z4));
  nor2   g20(.a(new_n21_), .b(x7), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(x5), .c(new_n35_), .O(new_n39_));
  nand4  g22(.a(new_n36_), .b(new_n31_), .c(new_n29_), .d(x2), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n39_), .O(z5));
  nor3   g24(.a(x2), .b(x1), .c(x0), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n21_), .c(x7), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n39_), .O(z6));
endmodule
