...
module FAU ( 
  ...
  aoi21  g07(.a(new_n20_), .b(new_n19_), .c(x6), .O(new_n25_));
  ...
  nor2   g13(.a(new_n20_), .b(x7), .O(new_n31_));
  ...
  nand4  g18(.a(new_n35_), .b(new_n30_), .c(new_n23_), .d(x2), .O(new_n36_));
  nand3  g19(.a(x8), .b(new_n19_), .c(x5), .O(new_n37_));
  ...
  aoi21  g25(.a(new_n42_), .b(x8), .c(new_n19_), .O(new_n43_));
