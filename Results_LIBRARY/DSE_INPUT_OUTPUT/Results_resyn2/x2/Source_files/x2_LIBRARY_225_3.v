...
module FAU ( 
  ...
  oai21  g13(.a(new_n18_), .b(new_n21_), .c(new_n30_), .O(new_n31_));
  nand2  g14(.a(x9), .b(x8), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(x7), .O(new_n33_));
  oai21  g16(.a(new_n18_), .b(new_n21_), .c(new_n33_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n31_), .O(z4));
  nand4  g18(.a(x9), .b(x8), .c(new_n23_), .d(x5), .O(new_n36_));
  ...
  nand4  g27(.a(new_n44_), .b(new_n33_), .c(x2), .d(new_n43_), .O(new_n45_));
  nand2  g28(.a(x9), .b(new_n23_), .O(new_n46_));
  aoi22  g29(.a(new_n46_), .b(new_n30_), .c(x9), .d(x1), .O(new_n47_));
  ...
  nand2  g38(.a(new_n22_), .b(x8), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n55_), .c(new_n23_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n53_), .c(new_n31_), .O(z6));
endmodule
