...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(new_n28_), .c(x5), .O(new_n36_));
  ...
  nand3  g27(.a(new_n26_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  ...
  nand2  g32(.a(x9), .b(new_n33_), .O(new_n50_));
  aoi21  g33(.a(new_n18_), .b(x8), .c(x7), .O(new_n51_));
  oai21  g34(.a(new_n18_), .b(x5), .c(x6), .O(new_n52_));
