...
module FAU ( 
  ...
  nand3  g27(.a(new_n44_), .b(new_n39_), .c(x6), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x2), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n35_), .O(z5));
  nand3  g30(.a(new_n18_), .b(new_n41_), .c(new_n40_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(x8), .c(new_n24_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n34_), .c(x9), .O(new_n50_));
  nand4  g33(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n26_), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n21_), .c(new_n32_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n50_), .c(new_n28_), .O(z6));
endmodule
