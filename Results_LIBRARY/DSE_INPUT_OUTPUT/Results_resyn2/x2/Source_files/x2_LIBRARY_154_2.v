...
module FAU ( 
  ...
  oai21  g11(.a(new_n29_), .b(new_n21_), .c(new_n20_), .O(new_n30_));
  nand2  g12(.a(new_n30_), .b(new_n22_), .O(z3));
  nand4  g13(.a(x9), .b(new_n21_), .c(x7), .d(x6), .O(z4));
  nand2  g14(.a(new_n21_), .b(x7), .O(new_n33_));
  nand2  g15(.a(x8), .b(new_n20_), .O(new_n34_));
  nand4  g16(.a(new_n34_), .b(new_n33_), .c(new_n28_), .d(x2), .O(new_n35_));
  inv1   g17(.a(x6), .O(new_n36_));
  inv1   g18(.a(x5), .O(new_n37_));
  nor2   g19(.a(x7), .b(new_n37_), .O(new_n38_));
  aoi21  g20(.a(new_n38_), .b(new_n23_), .c(new_n36_), .O(new_n39_));
  nand2  g21(.a(new_n34_), .b(new_n22_), .O(new_n40_));
  nand3  g22(.a(new_n40_), .b(new_n39_), .c(new_n35_), .O(z5));
  nor3   g23(.a(x2), .b(x1), .c(x0), .O(new_n42_));
  oai21  g24(.a(new_n42_), .b(new_n22_), .c(x7), .O(new_n43_));
  oai21  g25(.a(new_n22_), .b(x7), .c(new_n21_), .O(new_n44_));
