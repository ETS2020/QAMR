...
module FAU ( 
  ...
  oai21  g17(.a(new_n34_), .b(new_n20_), .c(new_n32_), .O(new_n35_));
  nor2   g18(.a(new_n24_), .b(new_n26_), .O(new_n36_));
  nand2  g19(.a(new_n23_), .b(x7), .O(new_n37_));
  ...
  aoi21  g25(.a(new_n42_), .b(x8), .c(new_n32_), .O(new_n43_));
  nand3  g26(.a(x8), .b(new_n32_), .c(x5), .O(new_n44_));
  inv1   g27(.a(new_n44_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n43_), .c(x9), .O(new_n46_));
  oai21  g29(.a(new_n20_), .b(new_n29_), .c(z0), .O(new_n47_));
