...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n25_, new_n27_, new_n29_,
  ...
  nor2   g16(.a(z2), .b(new_n33_), .O(new_n34_));
  ...
  oai21  g20(.a(new_n25_), .b(new_n20_), .c(x9), .O(new_n38_));
  nand4  g21(.a(new_n21_), .b(new_n18_), .c(x4), .d(x3), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(new_n34_), .O(z6));
endmodule
