...
module FAU ( 
  ...
  aoi21  g12(.a(new_n25_), .b(new_n21_), .c(new_n22_), .O(z2));
  inv1   g13(.a(x0), .O(new_n31_));
  nor2   g14(.a(x7), .b(x2), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n19_), .c(new_n20_), .d(new_n31_), .O(z3));
  nand2  g16(.a(x9), .b(x8), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n22_), .c(x6), .O(z4));
  nand3  g18(.a(new_n18_), .b(x2), .c(new_n31_), .O(new_n36_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n21_), .c(new_n43_), .O(new_n46_));
  ...
  oai21  g33(.a(x6), .b(new_n20_), .c(x7), .O(new_n51_));
  nand3  g34(.a(new_n44_), .b(new_n25_), .c(x6), .O(new_n52_));
