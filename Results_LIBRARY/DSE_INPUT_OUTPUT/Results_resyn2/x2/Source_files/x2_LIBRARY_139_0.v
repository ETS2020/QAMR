...
module FAU ( 
  ...
  nand2  g02(.a(x8), .b(x4), .O(new_n20_));
  ...
  nor2   g20(.a(new_n24_), .b(new_n37_), .O(new_n38_));
  aoi22  g21(.a(new_n38_), .b(new_n36_), .c(new_n18_), .d(new_n23_), .O(z4));
  oai21  g22(.a(new_n36_), .b(new_n24_), .c(new_n27_), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n20_), .b(new_n18_), .c(new_n37_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n41_), .O(z5));
  aoi21  g29(.a(new_n32_), .b(x8), .c(new_n18_), .O(new_n47_));
  nand2  g30(.a(x8), .b(x3), .O(new_n48_));
  nor2   g31(.a(new_n48_), .b(x9), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n47_), .c(x7), .O(new_n50_));
  oai21  g33(.a(x9), .b(x8), .c(new_n42_), .O(new_n51_));
  oai21  g34(.a(x9), .b(x4), .c(x6), .O(new_n52_));
  aoi21  g35(.a(new_n51_), .b(new_n24_), .c(new_n52_), .O(new_n53_));
