...
module FAU ( 
  ...
  nand3  g13(.a(new_n30_), .b(new_n21_), .c(new_n26_), .O(z3));
  ...
  oai21  g20(.a(new_n37_), .b(new_n29_), .c(new_n36_), .O(new_n38_));
  ...
  aoi21  g30(.a(new_n32_), .b(new_n20_), .c(new_n40_), .O(new_n48_));
