...
module FAU ( 
  ...
  aoi22  g07(.a(new_n24_), .b(new_n23_), .c(x6), .d(new_n19_), .O(z1));
  ...
  nand2  g12(.a(x8), .b(new_n22_), .O(new_n30_));
  ...
  nand3  g27(.a(new_n38_), .b(new_n31_), .c(new_n30_), .O(new_n45_));
  ...
  oai21  g35(.a(new_n47_), .b(new_n26_), .c(new_n22_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n52_), .c(new_n36_), .O(z6));
endmodule
