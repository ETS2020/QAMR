...
module FAU ( 
  ...
  nand4  g16(.a(new_n33_), .b(new_n32_), .c(new_n24_), .d(x2), .O(new_n34_));
  nor2   g17(.a(new_n18_), .b(x7), .O(new_n35_));
  and2   g18(.a(x8), .b(x5), .O(new_n36_));
  aoi21  g19(.a(new_n36_), .b(new_n35_), .c(new_n29_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n34_), .c(new_n25_), .O(z5));
  oai21  g21(.a(new_n27_), .b(new_n18_), .c(x7), .O(new_n39_));
  nand2  g22(.a(new_n22_), .b(new_n20_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n39_), .c(new_n37_), .O(z6));
endmodule
