...
module FAU ( 
  ...
  nand2  g04(.a(x8), .b(new_n22_), .O(new_n23_));
  ...
  nand4  g10(.a(new_n28_), .b(new_n24_), .c(new_n27_), .d(new_n26_), .O(z3));
  inv1   g11(.a(x6), .O(new_n30_));
  oai21  g12(.a(x8), .b(new_n30_), .c(x9), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(x7), .O(z4));
  nor2   g14(.a(x9), .b(new_n22_), .O(new_n33_));
  nand3  g15(.a(x9), .b(x8), .c(x5), .O(new_n34_));
  oai21  g16(.a(x9), .b(x8), .c(new_n34_), .O(new_n35_));
  aoi21  g17(.a(new_n35_), .b(new_n22_), .c(new_n30_), .O(new_n36_));
  nand2  g18(.a(new_n20_), .b(x7), .O(new_n37_));
  nand4  g19(.a(new_n37_), .b(new_n28_), .c(new_n23_), .d(x2), .O(new_n38_));
  oai21  g20(.a(new_n36_), .b(new_n33_), .c(new_n38_), .O(z5));
  inv1   g21(.a(x0), .O(new_n40_));
  inv1   g22(.a(x1), .O(new_n41_));
  nand3  g23(.a(new_n26_), .b(new_n41_), .c(new_n40_), .O(new_n42_));
  ...
  oai22  g28(.a(new_n19_), .b(new_n30_), .c(x9), .d(new_n22_), .O(new_n47_));
