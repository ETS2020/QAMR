...
module FAU ( 
  ...
  nand3  g10(.a(new_n19_), .b(new_n27_), .c(new_n26_), .O(new_n28_));
  ...
  nand2  g16(.a(new_n27_), .b(new_n26_), .O(new_n35_));
  inv1   g17(.a(x0), .O(new_n36_));
  nand3  g18(.a(x2), .b(new_n18_), .c(new_n36_), .O(new_n37_));
  aoi21  g19(.a(new_n35_), .b(new_n20_), .c(new_n37_), .O(new_n38_));
  nand3  g20(.a(x8), .b(new_n26_), .c(x5), .O(new_n39_));
  ...
  nand3  g30(.a(new_n48_), .b(new_n18_), .c(new_n36_), .O(new_n49_));
  aoi21  g31(.a(new_n49_), .b(x8), .c(new_n26_), .O(new_n50_));
  oai21  g32(.a(new_n50_), .b(new_n47_), .c(x9), .O(new_n51_));
  nand2  g33(.a(new_n23_), .b(new_n18_), .O(new_n52_));
