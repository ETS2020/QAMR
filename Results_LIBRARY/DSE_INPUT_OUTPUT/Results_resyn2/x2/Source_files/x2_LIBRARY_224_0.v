...
module FAU ( 
  ...
  aoi21  g29(.a(new_n46_), .b(new_n25_), .c(new_n44_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n43_), .c(new_n38_), .O(z5));
  aoi21  g31(.a(new_n31_), .b(x8), .c(new_n39_), .O(new_n49_));
  nand4  g32(.a(new_n39_), .b(x8), .c(x4), .d(x3), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n49_), .c(x7), .O(new_n52_));
  oai21  g35(.a(x9), .b(x8), .c(new_n45_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n25_), .c(new_n44_), .O(new_n54_));
