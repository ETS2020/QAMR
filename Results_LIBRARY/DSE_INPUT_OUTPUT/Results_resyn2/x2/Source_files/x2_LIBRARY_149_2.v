...
module FAU ( 
  ...
  inv1   g11(.a(x8), .O(new_n30_));
  nand4  g12(.a(x9), .b(new_n30_), .c(x7), .d(x6), .O(z4));
  nor2   g13(.a(x9), .b(new_n22_), .O(new_n32_));
  inv1   g14(.a(x6), .O(new_n33_));
  nand3  g15(.a(x9), .b(x8), .c(x5), .O(new_n34_));
  oai21  g16(.a(x9), .b(x8), .c(new_n34_), .O(new_n35_));
  aoi21  g17(.a(new_n35_), .b(new_n22_), .c(new_n33_), .O(new_n36_));
  nand2  g18(.a(new_n20_), .b(x7), .O(new_n37_));
  nand4  g19(.a(new_n37_), .b(new_n28_), .c(new_n23_), .d(x2), .O(new_n38_));
  oai21  g20(.a(new_n36_), .b(new_n32_), .c(new_n38_), .O(z5));
  ...
  oai22  g28(.a(new_n19_), .b(new_n33_), .c(x9), .d(new_n22_), .O(new_n47_));
