...
module FAU ( 
  ...
  nand3  g25(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(new_n44_));
  aoi21  g26(.a(new_n44_), .b(x8), .c(new_n27_), .O(new_n45_));
  oai21  g27(.a(new_n45_), .b(new_n40_), .c(x9), .O(new_n46_));
  nand3  g28(.a(x8), .b(x4), .c(x3), .O(new_n47_));
  nand2  g29(.a(new_n47_), .b(x7), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(new_n18_), .O(new_n49_));
  nand3  g31(.a(new_n49_), .b(new_n46_), .c(x6), .O(z6));
  zero   g32(.O(z2));
endmodule
