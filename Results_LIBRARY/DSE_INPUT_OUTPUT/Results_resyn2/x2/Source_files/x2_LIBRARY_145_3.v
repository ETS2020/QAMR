...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n25_,
    new_n26_, new_n28_, new_n30_, new_n31_, new_n32_, new_n35_, new_n36_,
    new_n38_;
  ...
  oai21  g07(.a(new_n20_), .b(x6), .c(x7), .O(new_n25_));
  aoi21  g08(.a(x9), .b(new_n18_), .c(x8), .O(new_n26_));
  ...
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(x8), .d(new_n30_), .O(z3));
  ...
  nand4  g21(.a(new_n38_), .b(new_n28_), .c(new_n20_), .d(x6), .O(z6));
endmodule
