...
module FAU ( 
  ...
  oai21  g07(.a(x9), .b(x5), .c(new_n20_), .O(new_n25_));
  ...
  nor3   g19(.a(x8), .b(new_n20_), .c(new_n36_), .O(new_n37_));
  oai21  g20(.a(new_n20_), .b(new_n36_), .c(new_n19_), .O(new_n38_));
  oai21  g21(.a(new_n37_), .b(new_n18_), .c(new_n38_), .O(z4));
  xor2a  g22(.a(x8), .b(x7), .O(new_n40_));
  nand3  g23(.a(x2), .b(new_n31_), .c(new_n30_), .O(new_n41_));
  nor2   g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  oai21  g25(.a(new_n29_), .b(new_n19_), .c(x6), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n42_), .c(x9), .O(new_n44_));
  ...
  oai21  g33(.a(new_n33_), .b(new_n18_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x7), .O(new_n52_));
  oai22  g35(.a(new_n40_), .b(new_n18_), .c(new_n24_), .d(x5), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n52_), .c(x6), .O(z6));
endmodule
