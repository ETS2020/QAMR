...
module FAU ( 
  ...
  oai21  g15(.a(new_n32_), .b(new_n31_), .c(x6), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n21_), .O(z3));
  oai21  g17(.a(x8), .b(new_n18_), .c(x9), .O(new_n35_));
  oai21  g18(.a(x7), .b(new_n18_), .c(new_n35_), .O(z4));
  nand2  g19(.a(new_n25_), .b(new_n24_), .O(new_n37_));
  nand2  g20(.a(x9), .b(x8), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(new_n24_), .c(new_n37_), .O(new_n39_));
  ...
  nand2  g28(.a(new_n24_), .b(x5), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n45_), .c(new_n18_), .O(new_n48_));
  ...
  aoi21  g35(.a(new_n31_), .b(x8), .c(new_n24_), .O(new_n53_));
  oai21  g36(.a(new_n46_), .b(new_n25_), .c(x6), .O(new_n54_));
