...
module FAU ( 
  ...
  nand4  g21(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n39_));
  nand3  g22(.a(x9), .b(new_n26_), .c(x5), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(x8), .O(new_n42_));
  nand2  g25(.a(z3), .b(new_n34_), .O(new_n43_));
  nor2   g26(.a(new_n18_), .b(new_n26_), .O(new_n44_));
  nor3   g27(.a(x2), .b(x1), .c(x0), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n19_), .c(new_n44_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n42_), .O(z6));
endmodule
