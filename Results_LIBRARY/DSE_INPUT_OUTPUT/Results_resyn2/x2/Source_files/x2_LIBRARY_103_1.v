...
module FAU ( 
  ...
  nand3  g06(.a(new_n18_), .b(new_n23_), .c(new_n20_), .O(z1));
  nor2   g07(.a(new_n21_), .b(x8), .O(z2));
  nor3   g08(.a(x2), .b(x1), .c(x0), .O(new_n26_));
  nand3  g09(.a(new_n18_), .b(x8), .c(new_n20_), .O(new_n27_));
  inv1   g10(.a(new_n27_), .O(new_n28_));
  aoi21  g11(.a(new_n28_), .b(new_n26_), .c(new_n19_), .O(z3));
  nand2  g12(.a(new_n21_), .b(x6), .O(z4));
