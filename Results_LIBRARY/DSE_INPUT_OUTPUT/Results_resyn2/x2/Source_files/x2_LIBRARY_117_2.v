...
module FAU ( 
  ...
  nand4  g11(.a(new_n18_), .b(x8), .c(new_n28_), .d(new_n27_), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n21_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n24_), .O(z3));
  nand2  g14(.a(new_n24_), .b(new_n21_), .O(new_n32_));
  inv1   g15(.a(x6), .O(new_n33_));
  nor2   g16(.a(new_n18_), .b(new_n20_), .O(new_n34_));
  oai21  g17(.a(new_n34_), .b(new_n33_), .c(x7), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n32_), .O(z4));
  nand4  g19(.a(x9), .b(x8), .c(new_n28_), .d(new_n27_), .O(new_n37_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n34_), .c(new_n33_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z5));
  nor3   g30(.a(x2), .b(x1), .c(x0), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n20_), .c(new_n25_), .O(new_n49_));
  ...
  oai21  g36(.a(x9), .b(x8), .c(new_n21_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n24_), .c(new_n33_), .O(new_n55_));
