...
module FAU ( 
  ...
  oai21  g16(.a(x8), .b(x4), .c(x9), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(x7), .c(x6), .O(z4));
  nand3  g18(.a(x2), .b(new_n28_), .c(new_n27_), .O(new_n36_));
  nand2  g19(.a(x9), .b(x8), .O(new_n37_));
  nand3  g20(.a(new_n18_), .b(new_n20_), .c(x3), .O(new_n38_));
  oai21  g21(.a(new_n37_), .b(new_n36_), .c(new_n38_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(x7), .O(new_n40_));
  nand3  g23(.a(x9), .b(x8), .c(x5), .O(new_n41_));
  oai21  g24(.a(new_n36_), .b(x8), .c(new_n41_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n23_), .O(new_n43_));
  nor2   g26(.a(x9), .b(x8), .O(new_n44_));
  nand2  g27(.a(x9), .b(x4), .O(new_n45_));
  ...
  aoi21  g31(.a(new_n30_), .b(x8), .c(new_n21_), .O(new_n49_));
  ...
  oai22  g36(.a(new_n41_), .b(x4), .c(x9), .d(x8), .O(new_n54_));
  aoi22  g37(.a(new_n54_), .b(new_n23_), .c(new_n45_), .d(new_n53_), .O(new_n55_));
