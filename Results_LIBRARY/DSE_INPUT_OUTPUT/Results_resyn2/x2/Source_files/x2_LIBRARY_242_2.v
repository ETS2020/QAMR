...
module FAU ( 
  ...
  nand2  g08(.a(new_n21_), .b(new_n22_), .O(new_n26_));
  ...
  nor2   g14(.a(x9), .b(x5), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n29_), .d(new_n28_), .O(z3));
  inv1   g16(.a(x6), .O(new_n34_));
  oai22  g17(.a(x9), .b(new_n18_), .c(new_n22_), .d(new_n34_), .O(new_n35_));
  nand2  g18(.a(x9), .b(x8), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n35_), .O(z4));
  oai21  g20(.a(new_n21_), .b(x7), .c(x9), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(x5), .c(new_n34_), .O(new_n39_));
  nand2  g22(.a(new_n36_), .b(x7), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n30_), .c(new_n29_), .d(x2), .O(new_n41_));
  ...
  nor2   g35(.a(x9), .b(x7), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n23_), .c(new_n21_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(new_n39_), .O(z6));
endmodule
