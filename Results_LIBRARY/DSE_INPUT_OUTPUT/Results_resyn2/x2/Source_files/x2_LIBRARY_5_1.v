...
module FAU ( 
  ...
  aoi22  g15(.a(new_n32_), .b(new_n31_), .c(x9), .d(new_n19_), .O(z4));
  ...
  oai21  g21(.a(new_n38_), .b(new_n31_), .c(new_n35_), .O(new_n39_));
  ...
  oai21  g26(.a(new_n27_), .b(new_n20_), .c(x9), .O(new_n44_));
  nand4  g27(.a(new_n21_), .b(new_n18_), .c(x4), .d(x3), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n44_), .c(new_n24_), .d(x6), .O(z6));
endmodule
