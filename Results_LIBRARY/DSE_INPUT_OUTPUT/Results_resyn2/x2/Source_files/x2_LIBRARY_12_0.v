...
module FAU ( 
  ...
  nand3  g15(.a(new_n24_), .b(x8), .c(new_n19_), .O(new_n33_));
  ...
  oai21  g20(.a(new_n35_), .b(new_n19_), .c(new_n37_), .O(new_n38_));
  ...
  nand2  g27(.a(new_n19_), .b(x5), .O(new_n45_));
  ...
  aoi21  g34(.a(new_n32_), .b(x8), .c(new_n19_), .O(new_n52_));
  oai21  g35(.a(new_n45_), .b(new_n20_), .c(x6), .O(new_n53_));
