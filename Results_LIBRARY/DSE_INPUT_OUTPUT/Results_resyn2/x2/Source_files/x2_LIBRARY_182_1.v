...
module FAU ( 
  ...
  oai21  g25(.a(new_n42_), .b(new_n41_), .c(new_n23_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n39_), .O(z5));
  inv1   g27(.a(x2), .O(new_n45_));
  nand4  g28(.a(x9), .b(new_n45_), .c(new_n26_), .d(new_n25_), .O(new_n46_));
  ...
  nand2  g33(.a(new_n23_), .b(x6), .O(new_n51_));
