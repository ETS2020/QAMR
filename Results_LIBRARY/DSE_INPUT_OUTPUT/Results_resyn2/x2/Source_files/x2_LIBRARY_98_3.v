...
module FAU ( 
  ...
  oai21  g14(.a(new_n18_), .b(new_n31_), .c(new_n30_), .O(new_n32_));
  ...
  nand3  g22(.a(new_n39_), .b(new_n32_), .c(new_n29_), .O(z5));
  inv1   g23(.a(z2), .O(new_n41_));
  nand3  g24(.a(x8), .b(x4), .c(x3), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n18_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x7), .O(new_n44_));
  nand4  g27(.a(new_n44_), .b(new_n33_), .c(new_n41_), .d(x6), .O(z6));
endmodule
