...
module FAU ( 
  ...
  nand2  g10(.a(x8), .b(new_n28_), .O(new_n29_));
  nand4  g11(.a(new_n29_), .b(new_n27_), .c(new_n26_), .d(x2), .O(new_n30_));
  nand3  g12(.a(x8), .b(new_n28_), .c(x5), .O(new_n31_));
  ...
  aoi21  g25(.a(new_n43_), .b(x8), .c(new_n28_), .O(new_n44_));
