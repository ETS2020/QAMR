...
module FAU ( 
  ...
  oai21  g10(.a(new_n27_), .b(new_n20_), .c(new_n21_), .O(new_n28_));
  ...
  nand3  g16(.a(new_n33_), .b(new_n26_), .c(x2), .O(new_n34_));
  nor2   g17(.a(new_n18_), .b(x7), .O(new_n35_));
  and2   g18(.a(x8), .b(x5), .O(new_n36_));
  aoi21  g19(.a(new_n36_), .b(new_n35_), .c(new_n30_), .O(new_n37_));
  oai21  g20(.a(new_n20_), .b(x7), .c(new_n18_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n37_), .c(new_n34_), .O(z5));
