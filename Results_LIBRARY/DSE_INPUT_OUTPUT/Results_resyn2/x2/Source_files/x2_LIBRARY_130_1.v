...
module FAU ( 
  ...
  nand3  g11(.a(new_n28_), .b(new_n26_), .c(new_n22_), .O(z3));
  nand2  g12(.a(x9), .b(x8), .O(new_n30_));
  inv1   g13(.a(x6), .O(new_n31_));
  nor2   g14(.a(new_n22_), .b(new_n31_), .O(new_n32_));
  aoi22  g15(.a(new_n32_), .b(new_n30_), .c(x9), .d(new_n22_), .O(z4));
  ...
  nand2  g24(.a(new_n41_), .b(new_n23_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n40_), .O(z5));
  oai21  g26(.a(new_n28_), .b(new_n20_), .c(x9), .O(new_n44_));
  nand2  g27(.a(x4), .b(x3), .O(new_n45_));
  or2    g28(.a(new_n45_), .b(z0), .O(new_n46_));
  aoi21  g29(.a(new_n25_), .b(new_n22_), .c(new_n31_), .O(new_n47_));
