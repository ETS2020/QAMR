...
module FAU ( 
  ...
  oai21  g05(.a(x9), .b(x4), .c(new_n22_), .O(new_n23_));
  ...
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(new_n26_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n18_), .O(z3));
  nand2  g18(.a(x9), .b(x8), .O(new_n36_));
  inv1   g19(.a(x6), .O(new_n37_));
  nor2   g20(.a(new_n22_), .b(new_n37_), .O(new_n38_));
  aoi22  g21(.a(new_n38_), .b(new_n36_), .c(new_n18_), .d(x4), .O(z4));
  oai21  g22(.a(new_n36_), .b(new_n22_), .c(new_n27_), .O(new_n40_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n45_), .c(new_n37_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n41_), .O(z5));
  aoi21  g32(.a(new_n32_), .b(x8), .c(new_n22_), .O(new_n50_));
