...
module FAU ( 
  ...
  nand4  g13(.a(new_n30_), .b(new_n26_), .c(x8), .d(new_n21_), .O(z3));
  aoi21  g14(.a(new_n22_), .b(x6), .c(new_n20_), .O(z4));
  inv1   g15(.a(x4), .O(new_n33_));
  nand3  g16(.a(new_n26_), .b(new_n33_), .c(x3), .O(new_n34_));
  nand3  g17(.a(x9), .b(x8), .c(x2), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(new_n29_), .c(new_n34_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  nand2  g20(.a(x9), .b(x5), .O(new_n38_));
  nor2   g21(.a(new_n38_), .b(x7), .O(new_n39_));
  nand2  g22(.a(x8), .b(x6), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(new_n39_), .c(new_n19_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n37_), .O(z5));
  inv1   g25(.a(x2), .O(new_n43_));
  nand4  g26(.a(x9), .b(new_n43_), .c(new_n28_), .d(new_n27_), .O(new_n44_));
  ...
  aoi21  g30(.a(new_n38_), .b(x8), .c(x7), .O(new_n48_));
  nand2  g31(.a(new_n19_), .b(x6), .O(new_n49_));
