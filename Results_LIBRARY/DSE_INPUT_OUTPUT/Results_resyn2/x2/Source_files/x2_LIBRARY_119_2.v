...
module FAU ( 
  ...
  oai21  g18(.a(x9), .b(x8), .c(new_n35_), .O(new_n36_));
  aoi21  g19(.a(new_n36_), .b(new_n18_), .c(new_n34_), .O(new_n37_));
  nand2  g20(.a(new_n22_), .b(x7), .O(new_n38_));
  aoi21  g21(.a(x8), .b(new_n18_), .c(new_n29_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(new_n28_), .d(new_n27_), .O(new_n40_));
  oai21  g23(.a(new_n37_), .b(new_n19_), .c(new_n40_), .O(z5));
  aoi21  g24(.a(new_n30_), .b(x8), .c(new_n18_), .O(new_n42_));
  nand3  g25(.a(x8), .b(new_n18_), .c(x5), .O(new_n43_));
  inv1   g26(.a(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(x9), .O(new_n45_));
  oai21  g28(.a(new_n21_), .b(new_n34_), .c(z0), .O(new_n46_));
