...
module FAU ( 
  ...
  nand2  g08(.a(x9), .b(x1), .O(new_n26_));
  inv1   g09(.a(x8), .O(new_n27_));
  nand2  g10(.a(new_n18_), .b(new_n27_), .O(new_n28_));
  oai21  g11(.a(new_n28_), .b(x7), .c(new_n26_), .O(z2));
  inv1   g12(.a(x0), .O(new_n30_));
  inv1   g13(.a(x2), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n30_), .O(new_n32_));
  inv1   g15(.a(new_n32_), .O(new_n33_));
  nor2   g16(.a(x7), .b(x1), .O(new_n34_));
  nand4  g17(.a(new_n34_), .b(new_n33_), .c(new_n18_), .d(x8), .O(z3));
  inv1   g18(.a(x6), .O(new_n36_));
  nand2  g19(.a(new_n26_), .b(new_n36_), .O(new_n37_));
  ...
  nand2  g24(.a(x8), .b(new_n23_), .O(new_n42_));
  nand4  g25(.a(new_n42_), .b(new_n39_), .c(x2), .d(new_n30_), .O(new_n43_));
  ...
  aoi21  g34(.a(new_n32_), .b(x8), .c(new_n21_), .O(new_n52_));
  ...
  oai21  g39(.a(new_n56_), .b(new_n21_), .c(new_n28_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n23_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n55_), .c(new_n37_), .O(z6));
endmodule
