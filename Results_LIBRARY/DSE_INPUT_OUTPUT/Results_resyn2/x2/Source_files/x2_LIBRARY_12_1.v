...
module FAU ( 
  ...
  oai21  g21(.a(new_n37_), .b(new_n28_), .c(new_n29_), .O(new_n39_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n28_), .c(new_n45_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(new_n40_), .O(z5));
  aoi21  g32(.a(new_n34_), .b(x8), .c(new_n18_), .O(new_n50_));
  ...
  nand2  g36(.a(new_n46_), .b(new_n21_), .O(new_n54_));
  aoi22  g37(.a(new_n54_), .b(new_n28_), .c(new_n20_), .d(new_n45_), .O(new_n55_));
