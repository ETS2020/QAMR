...
module FAU ( 
  ...
  nor2   g08(.a(new_n26_), .b(x7), .O(new_n27_));
  nand4  g09(.a(new_n27_), .b(new_n25_), .c(new_n24_), .d(new_n23_), .O(z3));
  nand4  g10(.a(x9), .b(new_n26_), .c(x7), .d(x6), .O(z4));
  nand2  g11(.a(new_n20_), .b(x7), .O(new_n30_));
  nor2   g12(.a(new_n27_), .b(new_n23_), .O(new_n31_));
  nand3  g13(.a(new_n31_), .b(new_n25_), .c(new_n30_), .O(new_n32_));
  inv1   g14(.a(x7), .O(new_n33_));
  nand3  g15(.a(x9), .b(x8), .c(x5), .O(new_n34_));
  inv1   g16(.a(new_n34_), .O(new_n35_));
  oai21  g17(.a(new_n35_), .b(new_n19_), .c(new_n33_), .O(new_n36_));
  aoi21  g18(.a(new_n24_), .b(x7), .c(x6), .O(new_n37_));
  inv1   g19(.a(new_n37_), .O(new_n38_));
  nand3  g20(.a(new_n38_), .b(new_n36_), .c(new_n32_), .O(z5));
  inv1   g21(.a(x0), .O(new_n40_));
  inv1   g22(.a(x1), .O(new_n41_));
  nand3  g23(.a(new_n23_), .b(new_n41_), .c(new_n40_), .O(new_n42_));
  aoi21  g24(.a(new_n42_), .b(x8), .c(new_n33_), .O(new_n43_));
  nand3  g25(.a(x8), .b(new_n33_), .c(x5), .O(new_n44_));
  inv1   g26(.a(new_n44_), .O(new_n45_));
  oai21  g27(.a(new_n45_), .b(new_n43_), .c(x9), .O(new_n46_));
  nor2   g28(.a(new_n37_), .b(z2), .O(new_n47_));
