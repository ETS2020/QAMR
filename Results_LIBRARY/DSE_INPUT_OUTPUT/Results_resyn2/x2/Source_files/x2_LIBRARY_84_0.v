...
module FAU ( 
  ...
  nand2  g19(.a(new_n35_), .b(x7), .O(new_n37_));
  nand2  g20(.a(x8), .b(new_n24_), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n37_), .c(new_n31_), .d(x2), .O(new_n39_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n24_), .c(new_n21_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z5));
  inv1   g30(.a(x0), .O(new_n48_));
  inv1   g31(.a(x1), .O(new_n49_));
  nand3  g32(.a(new_n20_), .b(new_n49_), .c(new_n48_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(x8), .c(new_n26_), .O(new_n51_));
  ...
  oai21  g37(.a(x9), .b(x8), .c(new_n44_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n24_), .c(new_n21_), .O(new_n56_));
