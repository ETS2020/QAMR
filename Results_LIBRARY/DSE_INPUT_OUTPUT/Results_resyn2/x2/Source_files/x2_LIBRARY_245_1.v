...
module FAU ( 
  ...
  oai21  g06(.a(x9), .b(new_n21_), .c(new_n18_), .O(z1));
  ...
  nand3  g13(.a(new_n30_), .b(x8), .c(new_n21_), .O(new_n31_));
  inv1   g14(.a(new_n31_), .O(new_n32_));
  aoi21  g15(.a(new_n32_), .b(new_n29_), .c(new_n20_), .O(z3));
  nor2   g16(.a(new_n22_), .b(new_n19_), .O(new_n34_));
  aoi21  g17(.a(new_n22_), .b(x6), .c(new_n34_), .O(z4));
  inv1   g18(.a(x4), .O(new_n36_));
  nand3  g19(.a(new_n30_), .b(new_n36_), .c(x3), .O(new_n37_));
