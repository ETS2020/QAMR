...
module FAU ( 
  ...
  nor3   g05(.a(new_n18_), .b(new_n22_), .c(x4), .O(new_n23_));
  ...
  nand2  g12(.a(new_n21_), .b(x8), .O(new_n30_));
  inv1   g13(.a(new_n30_), .O(new_n31_));
  aoi21  g14(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(z3));
  ...
  nor2   g28(.a(x8), .b(x7), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(x9), .c(x4), .O(new_n47_));
  inv1   g30(.a(x5), .O(new_n48_));
  nor2   g31(.a(x7), .b(new_n48_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n33_), .c(new_n35_), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(new_n47_), .c(new_n45_), .d(new_n41_), .O(z5));
  nand3  g34(.a(x9), .b(new_n22_), .c(x5), .O(new_n52_));
  nand3  g35(.a(x7), .b(x4), .c(x3), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x8), .O(new_n55_));
  nor2   g38(.a(new_n18_), .b(new_n22_), .O(new_n56_));
  oai21  g39(.a(new_n29_), .b(new_n20_), .c(new_n56_), .O(new_n57_));
  nand3  g40(.a(new_n26_), .b(new_n25_), .c(x6), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n57_), .c(new_n55_), .O(z6));
endmodule
