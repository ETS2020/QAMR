...
module FAU ( 
  ...
  nand3  g20(.a(new_n37_), .b(new_n26_), .c(x2), .O(new_n38_));
  aoi21  g21(.a(new_n18_), .b(x7), .c(new_n30_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(z5));
  nand2  g23(.a(x8), .b(x7), .O(new_n41_));
  aoi21  g24(.a(new_n26_), .b(new_n25_), .c(new_n41_), .O(new_n42_));
  ...
  nand2  g29(.a(new_n46_), .b(z0), .O(new_n47_));
  oai21  g30(.a(new_n45_), .b(new_n42_), .c(new_n47_), .O(z6));
endmodule
