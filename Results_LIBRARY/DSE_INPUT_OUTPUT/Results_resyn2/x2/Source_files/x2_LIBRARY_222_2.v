...
module FAU ( 
  ...
  nand2  g12(.a(x9), .b(x5), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(x8), .O(new_n32_));
  nand2  g14(.a(x9), .b(new_n19_), .O(new_n33_));
  nand3  g15(.a(new_n33_), .b(new_n32_), .c(new_n22_), .O(new_n34_));
  nand2  g16(.a(new_n19_), .b(x7), .O(new_n35_));
  nor2   g17(.a(new_n28_), .b(new_n26_), .O(new_n36_));
  nand3  g18(.a(new_n36_), .b(new_n35_), .c(new_n27_), .O(new_n37_));
  nand4  g19(.a(new_n37_), .b(new_n34_), .c(new_n21_), .d(x6), .O(z5));
  inv1   g20(.a(x0), .O(new_n39_));
  inv1   g21(.a(x1), .O(new_n40_));
  nand3  g22(.a(new_n26_), .b(new_n40_), .c(new_n39_), .O(new_n41_));
  ...
  aoi21  g28(.a(new_n21_), .b(new_n46_), .c(z2), .O(new_n47_));
