...
module FAU ( 
  ...
  aoi21  g06(.a(new_n23_), .b(x5), .c(x9), .O(z2));
  ...
  aoi21  g20(.a(new_n37_), .b(new_n35_), .c(new_n34_), .O(z4));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n19_), .c(new_n36_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n44_), .c(new_n40_), .O(z5));
  aoi21  g31(.a(new_n30_), .b(x8), .c(new_n18_), .O(new_n49_));
  ...
  oai21  g36(.a(x9), .b(x5), .c(x6), .O(new_n54_));
