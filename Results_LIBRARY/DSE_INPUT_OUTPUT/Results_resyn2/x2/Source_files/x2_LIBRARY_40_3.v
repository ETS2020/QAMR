...
module FAU ( 
  ...
  oai21  g07(.a(new_n24_), .b(new_n18_), .c(new_n21_), .O(z1));
  nand2  g08(.a(new_n18_), .b(new_n21_), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(z2));
  inv1   g10(.a(x0), .O(new_n28_));
  inv1   g11(.a(x1), .O(new_n29_));
  nor2   g12(.a(new_n21_), .b(x2), .O(new_n30_));
  nand4  g13(.a(new_n30_), .b(new_n18_), .c(new_n29_), .d(new_n28_), .O(z3));
  aoi22  g14(.a(x9), .b(x8), .c(x7), .d(x6), .O(z4));
  nand4  g15(.a(new_n22_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n33_));
  ...
  nand4  g27(.a(new_n44_), .b(new_n41_), .c(new_n26_), .d(x6), .O(z6));
endmodule
