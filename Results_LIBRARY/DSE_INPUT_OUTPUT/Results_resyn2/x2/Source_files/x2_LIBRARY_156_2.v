...
module FAU ( 
  ...
  aoi21  g07(.a(new_n24_), .b(new_n22_), .c(x9), .O(z2));
  nor2   g08(.a(x8), .b(new_n23_), .O(new_n26_));
  aoi21  g09(.a(new_n26_), .b(x9), .c(z2), .O(z1));
  inv1   g10(.a(x0), .O(new_n28_));
  inv1   g11(.a(x1), .O(new_n29_));
  inv1   g12(.a(x2), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(new_n31_));
  nand3  g14(.a(new_n20_), .b(new_n18_), .c(new_n23_), .O(new_n32_));
  ...
  oai21  g19(.a(new_n34_), .b(new_n23_), .c(new_n24_), .O(new_n37_));
