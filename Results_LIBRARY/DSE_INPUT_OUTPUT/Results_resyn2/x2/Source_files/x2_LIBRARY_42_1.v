...
module FAU ( 
  ...
  nor2   g05(.a(new_n22_), .b(x9), .O(z2));
  oai21  g06(.a(x8), .b(new_n20_), .c(x6), .O(new_n24_));
  ...
  oai21  g16(.a(new_n32_), .b(new_n20_), .c(new_n22_), .O(new_n34_));
  ...
  aoi21  g27(.a(new_n29_), .b(x8), .c(new_n18_), .O(new_n45_));
  ...
  oai21  g31(.a(x9), .b(x8), .c(new_n41_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n20_), .c(new_n40_), .O(new_n50_));
