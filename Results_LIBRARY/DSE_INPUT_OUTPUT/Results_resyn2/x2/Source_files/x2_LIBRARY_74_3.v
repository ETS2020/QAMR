...
module FAU ( 
  ...
  aoi21  g30(.a(new_n31_), .b(x8), .c(new_n22_), .O(new_n48_));
  ...
  aoi21  g34(.a(x9), .b(x1), .c(x6), .O(new_n52_));
  inv1   g35(.a(x5), .O(new_n53_));
  oai21  g36(.a(new_n22_), .b(new_n53_), .c(x8), .O(new_n54_));
  aoi21  g37(.a(x9), .b(new_n26_), .c(x7), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n51_), .O(z6));
endmodule
