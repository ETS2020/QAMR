...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(new_n28_), .c(new_n21_), .O(new_n31_));
  oai21  g14(.a(x9), .b(new_n21_), .c(new_n31_), .O(z3));
  nand3  g15(.a(new_n18_), .b(x7), .c(x6), .O(z4));
  nand3  g16(.a(x9), .b(x8), .c(x5), .O(new_n34_));
  nand4  g17(.a(new_n22_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n21_), .O(new_n37_));
  inv1   g20(.a(x6), .O(new_n38_));
  nand2  g21(.a(new_n20_), .b(new_n38_), .O(new_n39_));
