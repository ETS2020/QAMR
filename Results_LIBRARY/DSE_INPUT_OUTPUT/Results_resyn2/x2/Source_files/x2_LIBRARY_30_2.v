...
module FAU ( 
  ...
  nand3  g09(.a(new_n18_), .b(new_n21_), .c(new_n19_), .O(new_n27_));
  or2    g10(.a(new_n27_), .b(x7), .O(new_n28_));
  ...
  nand2  g19(.a(new_n18_), .b(x2), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(x7), .d(x6), .O(z4));
  xor2a  g21(.a(x8), .b(x7), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(new_n32_), .c(x9), .O(new_n40_));
  ...
  nand2  g37(.a(new_n45_), .b(new_n27_), .O(new_n55_));
  aoi22  g38(.a(new_n55_), .b(new_n20_), .c(new_n37_), .d(new_n54_), .O(new_n56_));
