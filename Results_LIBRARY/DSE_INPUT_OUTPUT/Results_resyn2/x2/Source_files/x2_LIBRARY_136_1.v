...
module FAU ( 
  ...
  oai21  g14(.a(x8), .b(new_n24_), .c(x9), .O(new_n32_));
  ...
  aoi21  g20(.a(new_n35_), .b(new_n29_), .c(new_n37_), .O(new_n38_));
  ...
  oai21  g25(.a(new_n38_), .b(new_n24_), .c(new_n42_), .O(z5));
  ...
  oai21  g30(.a(new_n47_), .b(x9), .c(x8), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n44_), .c(x7), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(new_n46_), .c(new_n25_), .d(x6), .O(z6));
endmodule
