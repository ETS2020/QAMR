...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(new_n19_), .c(x8), .d(new_n23_), .O(z3));
  oai21  g18(.a(x8), .b(x3), .c(x9), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(x7), .c(x6), .O(z4));
  nand3  g20(.a(x9), .b(x8), .c(x7), .O(new_n38_));
  nand3  g21(.a(x2), .b(new_n31_), .c(new_n30_), .O(new_n39_));
  aoi21  g22(.a(new_n38_), .b(new_n28_), .c(new_n39_), .O(new_n40_));
  ...
  aoi21  g31(.a(new_n33_), .b(x8), .c(new_n22_), .O(new_n49_));
  ...
  aoi21  g35(.a(x9), .b(x3), .c(x6), .O(new_n53_));
  nand2  g36(.a(x8), .b(x5), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n22_), .c(new_n20_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n23_), .c(new_n53_), .O(new_n56_));
