...
module FAU ( 
  ...
  nand4  g15(.a(x9), .b(x8), .c(new_n20_), .d(x5), .O(new_n33_));
  ...
  oai21  g23(.a(x6), .b(new_n21_), .c(x9), .O(new_n41_));
  nand4  g24(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n26_), .c(x6), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n41_), .O(new_n44_));
  nand2  g27(.a(x8), .b(x7), .O(new_n45_));
  nand2  g28(.a(x8), .b(x5), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n22_), .c(new_n45_), .O(new_n48_));
