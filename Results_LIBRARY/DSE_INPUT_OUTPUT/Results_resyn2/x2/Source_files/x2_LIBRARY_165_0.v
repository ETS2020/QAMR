...
module FAU ( 
  ...
  nand4  g10(.a(new_n29_), .b(new_n27_), .c(new_n26_), .d(x2), .O(new_n30_));
  nand3  g11(.a(x8), .b(new_n28_), .c(x5), .O(new_n31_));
  ...
  inv1   g22(.a(x2), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(x8), .c(new_n28_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n39_), .c(x9), .O(new_n45_));
  nand3  g26(.a(x8), .b(x4), .c(x3), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x7), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n18_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n45_), .c(x6), .O(z6));
  zero   g30(.O(z2));
  one    g31(.O(z3));
endmodule
