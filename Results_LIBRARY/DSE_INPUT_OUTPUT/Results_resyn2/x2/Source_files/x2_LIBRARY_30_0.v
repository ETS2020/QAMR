...
module FAU ( 
  ...
  oai21  g17(.a(new_n30_), .b(new_n19_), .c(new_n34_), .O(new_n35_));
  ...
  nand3  g21(.a(new_n38_), .b(x8), .c(x2), .O(new_n39_));
  ...
  nand3  g28(.a(new_n45_), .b(new_n40_), .c(new_n36_), .O(z5));
  nand3  g29(.a(new_n23_), .b(new_n33_), .c(new_n32_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(x8), .c(new_n19_), .O(new_n48_));
  nand3  g31(.a(x8), .b(new_n19_), .c(x5), .O(new_n49_));
  inv1   g32(.a(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n48_), .c(x9), .O(new_n51_));
  nand4  g34(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n34_), .c(x9), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n41_), .c(z3), .O(new_n54_));
