...
module FAU ( 
  ...
  nand2  g11(.a(x9), .b(new_n20_), .O(new_n30_));
  oai21  g12(.a(x9), .b(new_n23_), .c(new_n30_), .O(new_n31_));
  nand3  g13(.a(new_n31_), .b(x7), .c(x6), .O(z4));
  inv1   g14(.a(x0), .O(new_n33_));
  inv1   g15(.a(x1), .O(new_n34_));
  nand3  g16(.a(x9), .b(x8), .c(x7), .O(new_n35_));
  nand2  g17(.a(new_n35_), .b(new_n27_), .O(new_n36_));
  ...
  nand4  g23(.a(x9), .b(x8), .c(new_n19_), .d(x5), .O(new_n42_));
  and2   g24(.a(new_n42_), .b(x6), .O(new_n43_));
  nand3  g25(.a(new_n43_), .b(new_n41_), .c(new_n37_), .O(z5));
  nand3  g26(.a(x7), .b(new_n34_), .c(new_n33_), .O(new_n45_));
  nand2  g27(.a(new_n45_), .b(x9), .O(new_n46_));
  nand2  g28(.a(new_n46_), .b(new_n23_), .O(new_n47_));
  nand4  g29(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(new_n30_), .O(new_n49_));
  nand2  g31(.a(new_n49_), .b(x7), .O(new_n50_));
  nand3  g32(.a(new_n18_), .b(new_n20_), .c(new_n19_), .O(new_n51_));
  nand3  g33(.a(new_n51_), .b(new_n42_), .c(x6), .O(new_n52_));
