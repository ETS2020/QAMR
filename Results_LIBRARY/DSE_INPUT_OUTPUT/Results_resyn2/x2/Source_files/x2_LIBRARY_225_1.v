...
module FAU ( 
  ...
  oai21  g08(.a(new_n20_), .b(x9), .c(new_n25_), .O(z1));
  nor2   g09(.a(new_n20_), .b(x9), .O(new_n27_));
  nor2   g10(.a(new_n22_), .b(new_n27_), .O(z2));
  inv1   g11(.a(x7), .O(new_n29_));
  nor2   g12(.a(x1), .b(x0), .O(new_n30_));
  nor2   g13(.a(x9), .b(x2), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(new_n30_), .c(x8), .d(new_n29_), .O(z3));
  nand2  g15(.a(x9), .b(x8), .O(new_n33_));
  inv1   g16(.a(x6), .O(new_n34_));
  nor2   g17(.a(new_n29_), .b(new_n34_), .O(new_n35_));
  aoi22  g18(.a(new_n35_), .b(new_n33_), .c(x9), .d(new_n21_), .O(z4));
  nand3  g19(.a(x8), .b(new_n29_), .c(x5), .O(new_n37_));
  ...
  nand2  g27(.a(new_n37_), .b(new_n24_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n22_), .O(new_n46_));
  oai21  g29(.a(new_n18_), .b(x1), .c(new_n34_), .O(new_n47_));
  nand4  g30(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n48_));
  inv1   g31(.a(new_n48_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n20_), .c(new_n18_), .O(new_n50_));
