...
module FAU ( 
  ...
  nand4  g10(.a(new_n27_), .b(new_n26_), .c(new_n19_), .d(x8), .O(z3));
  nor2   g11(.a(x9), .b(new_n22_), .O(new_n29_));
  ...
  nand4  g26(.a(new_n29_), .b(x8), .c(x4), .d(x3), .O(new_n44_));
  nand2  g27(.a(new_n24_), .b(new_n39_), .O(new_n45_));
  nand2  g28(.a(new_n19_), .b(x8), .O(new_n46_));
  nand2  g29(.a(new_n36_), .b(x9), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n22_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n45_), .c(new_n44_), .O(z6));
endmodule
