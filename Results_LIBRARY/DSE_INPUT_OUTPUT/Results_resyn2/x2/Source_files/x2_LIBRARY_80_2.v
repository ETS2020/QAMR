...
module FAU ( 
  ...
  nand2  g08(.a(new_n18_), .b(new_n19_), .O(new_n26_));
  oai21  g09(.a(new_n26_), .b(new_n25_), .c(new_n24_), .O(z1));
  nand3  g10(.a(new_n25_), .b(new_n18_), .c(new_n19_), .O(new_n28_));
  ...
  oai21  g17(.a(x9), .b(new_n19_), .c(x6), .O(new_n35_));
  oai21  g18(.a(new_n18_), .b(new_n21_), .c(x7), .O(new_n36_));
  or2    g19(.a(new_n36_), .b(new_n35_), .O(z4));
  aoi21  g20(.a(x8), .b(new_n20_), .c(new_n31_), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n36_), .c(new_n19_), .d(new_n30_), .O(new_n39_));
  ...
  nand4  g29(.a(new_n46_), .b(new_n43_), .c(new_n39_), .d(x6), .O(z5));
  nand3  g30(.a(new_n31_), .b(new_n19_), .c(new_n30_), .O(new_n48_));
  ...
  oai21  g35(.a(x9), .b(x8), .c(new_n44_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n20_), .c(new_n35_), .O(new_n54_));
