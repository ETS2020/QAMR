...
module FAU ( 
  ...
  nor2   g07(.a(new_n23_), .b(x8), .O(z2));
  inv1   g08(.a(x7), .O(new_n26_));
  oai21  g09(.a(x8), .b(new_n26_), .c(x6), .O(new_n27_));
  ...
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(new_n20_), .O(new_n34_));
  ...
  nand4  g22(.a(new_n39_), .b(new_n33_), .c(new_n38_), .d(x2), .O(new_n40_));
  ...
  nor2   g35(.a(x9), .b(x6), .O(new_n53_));
  nand2  g36(.a(x6), .b(x5), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n36_), .c(new_n21_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n26_), .c(new_n53_), .O(new_n56_));
