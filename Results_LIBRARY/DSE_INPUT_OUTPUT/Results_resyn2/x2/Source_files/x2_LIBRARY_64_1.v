...
module FAU ( 
  ...
  oai21  g20(.a(new_n37_), .b(new_n31_), .c(new_n34_), .O(new_n38_));
  ...
  nand2  g25(.a(new_n24_), .b(new_n20_), .O(new_n43_));
  oai21  g26(.a(new_n27_), .b(new_n19_), .c(x9), .O(new_n44_));
  nand4  g27(.a(new_n21_), .b(new_n18_), .c(x4), .d(x3), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(x6), .O(z6));
endmodule
