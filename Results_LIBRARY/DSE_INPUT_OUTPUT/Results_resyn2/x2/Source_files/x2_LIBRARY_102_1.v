...
module FAU ( 
  ...
  nor2   g06(.a(new_n21_), .b(x8), .O(new_n24_));
  aoi21  g07(.a(new_n24_), .b(new_n23_), .c(new_n19_), .O(z1));
  inv1   g08(.a(x8), .O(new_n26_));
  inv1   g09(.a(x9), .O(new_n27_));
  inv1   g10(.a(new_n19_), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(new_n26_), .d(new_n20_), .O(new_n29_));
  inv1   g12(.a(new_n29_), .O(z2));
  inv1   g13(.a(x0), .O(new_n31_));
  nand2  g14(.a(x8), .b(new_n20_), .O(new_n32_));
  inv1   g15(.a(x1), .O(new_n33_));
  inv1   g16(.a(x2), .O(new_n34_));
  nand3  g17(.a(new_n27_), .b(new_n34_), .c(new_n33_), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(new_n32_), .c(new_n18_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n31_), .O(z3));
  nand2  g20(.a(x9), .b(x8), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n28_), .c(x7), .d(x6), .O(z4));
  nand2  g22(.a(new_n38_), .b(x7), .O(new_n40_));
  nor2   g23(.a(x1), .b(x0), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n40_), .c(new_n32_), .d(x2), .O(new_n42_));
  ...
  nand2  g31(.a(new_n27_), .b(new_n26_), .O(new_n49_));
  nand3  g32(.a(x9), .b(x8), .c(new_n20_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x6), .O(new_n51_));
  nand4  g34(.a(x9), .b(x8), .c(new_n20_), .d(new_n18_), .O(new_n52_));
  ...
  nand2  g40(.a(new_n57_), .b(new_n48_), .O(z5));
  nand3  g41(.a(new_n52_), .b(new_n51_), .c(x0), .O(new_n59_));
  inv1   g42(.a(new_n41_), .O(new_n60_));
  nand3  g43(.a(x9), .b(x7), .c(new_n34_), .O(new_n61_));
  ...
  nand4  g49(.a(new_n66_), .b(new_n64_), .c(new_n49_), .d(new_n28_), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n63_), .c(new_n59_), .d(new_n29_), .O(z6));
endmodule
