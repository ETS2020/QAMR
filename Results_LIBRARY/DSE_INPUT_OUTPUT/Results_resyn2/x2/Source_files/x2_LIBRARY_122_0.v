...
module FAU ( 
  ...
  nor2   g13(.a(z2), .b(new_n30_), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(new_n29_), .c(x7), .O(z4));
  nand2  g15(.a(new_n29_), .b(x7), .O(new_n33_));
  nand4  g16(.a(new_n33_), .b(new_n27_), .c(new_n20_), .d(x2), .O(new_n34_));
  ...
  aoi21  g24(.a(new_n41_), .b(new_n39_), .c(new_n30_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n38_), .c(new_n34_), .O(z5));
  inv1   g26(.a(x0), .O(new_n44_));
  inv1   g27(.a(x1), .O(new_n45_));
  nand3  g28(.a(new_n25_), .b(new_n45_), .c(new_n44_), .O(new_n46_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n42_), .c(z1), .O(z6));
endmodule
