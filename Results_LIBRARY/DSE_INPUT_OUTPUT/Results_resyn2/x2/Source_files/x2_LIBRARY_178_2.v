...
module FAU ( 
  ...
  nand2  g16(.a(new_n29_), .b(x5), .O(new_n34_));
  nor2   g17(.a(x1), .b(x0), .O(new_n35_));
  nand2  g18(.a(x8), .b(new_n19_), .O(new_n36_));
  nand4  g19(.a(new_n31_), .b(new_n36_), .c(new_n35_), .d(x2), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n34_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x9), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(x6), .O(z5));
  oai21  g23(.a(new_n28_), .b(new_n20_), .c(x7), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n34_), .c(x9), .d(x6), .O(z6));
endmodule
