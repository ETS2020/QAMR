...
module FAU ( 
  ...
  nand4  g10(.a(new_n18_), .b(x8), .c(new_n22_), .d(new_n27_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(new_n29_));
  aoi22  g12(.a(new_n29_), .b(new_n26_), .c(x9), .d(x5), .O(z3));
  ...
  nand3  g17(.a(new_n34_), .b(new_n26_), .c(x2), .O(new_n35_));
