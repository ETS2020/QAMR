...
module FAU ( 
  ...
  oai21  g17(.a(new_n34_), .b(new_n19_), .c(new_n23_), .O(z4));
  ...
  nor2   g22(.a(z2), .b(new_n33_), .O(new_n40_));
  ...
  oai21  g26(.a(new_n43_), .b(new_n20_), .c(x9), .O(new_n44_));
  nand4  g27(.a(new_n21_), .b(new_n18_), .c(x4), .d(x3), .O(new_n45_));
