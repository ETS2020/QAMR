...
module FAU ( 
  ...
  nand4  g09(.a(new_n27_), .b(new_n23_), .c(new_n26_), .d(new_n25_), .O(z3));
  nand4  g10(.a(x9), .b(new_n22_), .c(x7), .d(x6), .O(z4));
  inv1   g11(.a(x7), .O(new_n30_));
  nand3  g12(.a(x9), .b(x8), .c(x5), .O(new_n31_));
  inv1   g13(.a(new_n31_), .O(new_n32_));
  oai21  g14(.a(new_n32_), .b(new_n19_), .c(new_n30_), .O(new_n33_));
  nand2  g15(.a(new_n22_), .b(x7), .O(new_n34_));
  nor2   g16(.a(new_n23_), .b(new_n25_), .O(new_n35_));
  nand3  g17(.a(new_n35_), .b(new_n34_), .c(new_n27_), .O(new_n36_));
  inv1   g18(.a(x6), .O(new_n37_));
  aoi21  g19(.a(new_n26_), .b(x7), .c(new_n37_), .O(new_n38_));
  nand3  g20(.a(new_n38_), .b(new_n36_), .c(new_n33_), .O(z5));
  inv1   g21(.a(x0), .O(new_n40_));
  inv1   g22(.a(x1), .O(new_n41_));
  nand3  g23(.a(new_n25_), .b(new_n41_), .c(new_n40_), .O(new_n42_));
  aoi21  g24(.a(new_n42_), .b(x8), .c(new_n30_), .O(new_n43_));
  nand3  g25(.a(x8), .b(new_n30_), .c(x5), .O(new_n44_));
  inv1   g26(.a(new_n44_), .O(new_n45_));
  oai21  g27(.a(new_n45_), .b(new_n43_), .c(x9), .O(new_n46_));
  oai22  g28(.a(new_n19_), .b(new_n37_), .c(x9), .d(new_n30_), .O(new_n47_));
