...
module FAU ( 
  ...
  nand2  g13(.a(z3), .b(new_n30_), .O(new_n31_));
  nand2  g14(.a(z3), .b(new_n19_), .O(new_n32_));
  nand2  g15(.a(x9), .b(x8), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(z4));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n30_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n38_), .O(z5));
  nand3  g30(.a(new_n23_), .b(new_n36_), .c(new_n35_), .O(new_n48_));
  ...
  aoi22  g37(.a(new_n54_), .b(new_n24_), .c(z3), .d(new_n30_), .O(new_n55_));
