...
module FAU ( 
  ...
  nand3  g13(.a(new_n19_), .b(new_n30_), .c(new_n29_), .O(new_n31_));
  inv1   g14(.a(new_n31_), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n18_), .c(x8), .d(new_n20_), .O(z3));
  nand2  g16(.a(x7), .b(x6), .O(new_n34_));
  oai21  g17(.a(x9), .b(new_n19_), .c(new_n34_), .O(new_n35_));
  oai21  g18(.a(new_n18_), .b(new_n21_), .c(new_n35_), .O(z4));
  nand2  g19(.a(new_n30_), .b(new_n29_), .O(new_n37_));
  xor2a  g20(.a(x8), .b(x7), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(new_n37_), .c(x9), .O(new_n39_));
  ...
  oai21  g27(.a(new_n44_), .b(x7), .c(x6), .O(new_n45_));
  aoi21  g28(.a(new_n43_), .b(new_n18_), .c(new_n45_), .O(new_n46_));
  ...
  oai21  g34(.a(x9), .b(x8), .c(new_n44_), .O(new_n52_));
  oai21  g35(.a(x9), .b(new_n19_), .c(x6), .O(new_n53_));
