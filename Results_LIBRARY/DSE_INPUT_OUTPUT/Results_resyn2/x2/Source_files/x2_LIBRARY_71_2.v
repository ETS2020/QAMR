...
module FAU ( 
  ...
  aoi22  g14(.a(new_n31_), .b(new_n30_), .c(new_n25_), .d(x2), .O(z4));
  inv1   g15(.a(new_n28_), .O(new_n33_));
  ...
  aoi21  g24(.a(new_n39_), .b(new_n25_), .c(new_n41_), .O(new_n42_));
  ...
  aoi21  g32(.a(new_n25_), .b(x2), .c(x6), .O(new_n50_));
  nand2  g33(.a(new_n18_), .b(new_n22_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n40_), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n21_), .c(new_n50_), .O(new_n53_));
