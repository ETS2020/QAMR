...
module FAU ( 
  ...
  nand2  g03(.a(new_n20_), .b(new_n18_), .O(z1));
  inv1   g04(.a(z1), .O(z2));
  nor2   g05(.a(x1), .b(x0), .O(new_n23_));
  nor2   g06(.a(x7), .b(x2), .O(new_n24_));
  nand4  g07(.a(new_n24_), .b(new_n23_), .c(new_n18_), .d(x8), .O(z3));
  oai21  g08(.a(x9), .b(x6), .c(x7), .O(z4));
  inv1   g09(.a(x7), .O(new_n27_));
  nand3  g10(.a(x9), .b(x8), .c(x5), .O(new_n28_));
  ...
  nand4  g20(.a(new_n27_), .b(x2), .c(new_n37_), .d(new_n36_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x9), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n35_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n34_), .c(new_n30_), .O(z5));
  ...
  oai21  g28(.a(new_n20_), .b(new_n45_), .c(new_n18_), .O(new_n46_));
