...
module FAU ( 
  ...
  oai21  g11(.a(x9), .b(x8), .c(new_n29_), .O(new_n30_));
  nand2  g12(.a(new_n22_), .b(x7), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(z0), .O(new_n32_));
  nand2  g14(.a(new_n32_), .b(new_n30_), .O(z4));
  nor2   g15(.a(x1), .b(x0), .O(new_n34_));
  nand4  g16(.a(new_n31_), .b(new_n34_), .c(new_n20_), .d(x2), .O(new_n35_));
  ...
  nor2   g25(.a(new_n18_), .b(new_n19_), .O(new_n44_));
  oai21  g26(.a(new_n25_), .b(new_n22_), .c(new_n44_), .O(new_n45_));
  nand3  g27(.a(x9), .b(new_n19_), .c(x5), .O(new_n46_));
  nand4  g28(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n47_));
  nand2  g29(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(x8), .O(new_n49_));
  nand3  g31(.a(new_n49_), .b(new_n45_), .c(new_n30_), .O(z6));
  zero   g32(.O(z2));
endmodule
