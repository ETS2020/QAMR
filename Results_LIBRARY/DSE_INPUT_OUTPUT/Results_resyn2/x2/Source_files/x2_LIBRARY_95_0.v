...
module FAU ( 
  ...
  aoi22  g07(.a(new_n24_), .b(new_n23_), .c(new_n18_), .d(new_n22_), .O(z1));
  ...
  nand2  g18(.a(new_n18_), .b(new_n22_), .O(new_n36_));
  ...
  aoi21  g22(.a(new_n27_), .b(new_n19_), .c(new_n39_), .O(new_n40_));
  oai21  g23(.a(new_n29_), .b(new_n22_), .c(x6), .O(new_n41_));
  ...
  nor2   g35(.a(new_n18_), .b(new_n26_), .O(new_n53_));
  nand2  g36(.a(new_n33_), .b(x8), .O(new_n54_));
  aoi22  g37(.a(new_n54_), .b(new_n53_), .c(new_n36_), .d(new_n43_), .O(new_n55_));
