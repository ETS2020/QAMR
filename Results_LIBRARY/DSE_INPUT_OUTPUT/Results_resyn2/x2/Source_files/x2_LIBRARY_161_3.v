...
module FAU ( 
  ...
  nand3  g12(.a(new_n18_), .b(x8), .c(new_n21_), .O(new_n30_));
  ...
  aoi21  g18(.a(new_n35_), .b(new_n33_), .c(new_n28_), .O(z4));
  ...
  nand4  g27(.a(new_n44_), .b(new_n40_), .c(new_n27_), .d(x6), .O(z5));
  inv1   g28(.a(x2), .O(new_n46_));
  inv1   g29(.a(x5), .O(new_n47_));
  nand4  g30(.a(new_n37_), .b(x9), .c(new_n47_), .d(new_n46_), .O(new_n48_));
  ...
  aoi22  g34(.a(new_n27_), .b(new_n34_), .c(new_n22_), .d(new_n20_), .O(new_n52_));
