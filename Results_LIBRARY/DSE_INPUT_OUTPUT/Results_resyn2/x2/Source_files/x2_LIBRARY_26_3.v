...
module FAU ( 
  ...
  nor2   g05(.a(new_n22_), .b(x5), .O(new_n23_));
  ...
  oai21  g11(.a(x8), .b(x5), .c(x9), .O(new_n29_));
  ...
  nand3  g23(.a(new_n40_), .b(new_n37_), .c(new_n33_), .O(z5));
  ...
  aoi21  g32(.a(new_n49_), .b(new_n20_), .c(new_n39_), .O(new_n50_));
