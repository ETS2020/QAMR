...
module FAU ( 
  ...
  aoi22  g15(.a(new_n32_), .b(new_n30_), .c(x9), .d(new_n20_), .O(z4));
  ...
  aoi21  g24(.a(new_n21_), .b(new_n31_), .c(new_n41_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n40_), .O(z5));
  nand3  g26(.a(new_n26_), .b(x9), .c(new_n25_), .O(new_n44_));
  ...
  oai21  g30(.a(new_n22_), .b(new_n31_), .c(new_n21_), .O(new_n48_));
