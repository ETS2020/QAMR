...
module FAU ( 
  ...
  nand4  g09(.a(new_n18_), .b(new_n20_), .c(new_n19_), .d(x0), .O(new_n27_));
  ...
  nand3  g16(.a(x2), .b(new_n33_), .c(new_n23_), .O(new_n34_));
  ...
  nand3  g29(.a(new_n46_), .b(new_n33_), .c(new_n23_), .O(new_n47_));
