...
module FAU ( 
  ...
  nand2  g10(.a(x8), .b(new_n23_), .O(new_n28_));
  inv1   g11(.a(x0), .O(new_n29_));
  inv1   g12(.a(x1), .O(new_n30_));
  inv1   g13(.a(x2), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(new_n30_), .c(new_n29_), .O(new_n32_));
  oai21  g15(.a(new_n32_), .b(new_n28_), .c(new_n27_), .O(new_n33_));
  ...
  aoi21  g32(.a(new_n32_), .b(x8), .c(new_n23_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n49_), .c(x9), .O(new_n51_));
  nand2  g34(.a(new_n40_), .b(new_n27_), .O(new_n52_));
