...
module FAU ( 
  ...
  nand3  g10(.a(new_n27_), .b(x8), .c(new_n22_), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n18_), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n26_), .O(z3));
  oai21  g13(.a(x8), .b(new_n26_), .c(x9), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(x7), .c(x6), .O(z4));
  nand4  g15(.a(x9), .b(x8), .c(new_n22_), .d(x5), .O(new_n33_));
  ...
  oai21  g28(.a(new_n20_), .b(new_n45_), .c(new_n21_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n44_), .c(new_n35_), .O(z6));
endmodule
