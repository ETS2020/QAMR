...
module FAU ( 
  ...
  nand3  g13(.a(new_n22_), .b(x8), .c(new_n30_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(new_n29_), .c(new_n20_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n26_), .O(z3));
  nand3  g16(.a(new_n22_), .b(x7), .c(x6), .O(z4));
  ...
  oai21  g21(.a(x4), .b(new_n38_), .c(new_n22_), .O(new_n39_));
  ...
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n23_), .O(z6));
endmodule
