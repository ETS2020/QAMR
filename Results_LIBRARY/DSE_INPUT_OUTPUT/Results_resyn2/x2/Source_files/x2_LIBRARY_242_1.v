...
module FAU ( 
  ...
  aoi22  g19(.a(new_n36_), .b(new_n34_), .c(x9), .d(new_n20_), .O(z4));
  nand2  g20(.a(new_n26_), .b(x7), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n30_), .c(x2), .O(new_n39_));
  ...
  nand2  g36(.a(new_n34_), .b(new_n27_), .O(new_n54_));
  nand2  g37(.a(new_n25_), .b(x6), .O(new_n55_));
