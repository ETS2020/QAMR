...
module FAU ( 
  ...
  aoi21  g11(.a(new_n28_), .b(x5), .c(x9), .O(z2));
  ...
  nor2   g19(.a(new_n26_), .b(new_n36_), .O(new_n37_));
  nor2   g20(.a(x9), .b(x5), .O(new_n38_));
  oai22  g21(.a(new_n38_), .b(new_n37_), .c(new_n18_), .d(new_n27_), .O(z4));
  ...
  oai21  g30(.a(new_n47_), .b(new_n36_), .c(x5), .O(new_n48_));
  ...
  oai21  g38(.a(x9), .b(x5), .c(x6), .O(new_n56_));
  aoi21  g39(.a(new_n55_), .b(new_n26_), .c(new_n56_), .O(new_n57_));
