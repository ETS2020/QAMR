...
module FAU ( 
  ...
  nand2  g14(.a(new_n32_), .b(new_n26_), .O(new_n33_));
  ...
  nand4  g20(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n39_));
  nand3  g21(.a(x9), .b(new_n26_), .c(x5), .O(new_n40_));
  nand2  g22(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g23(.a(new_n41_), .b(x8), .O(new_n42_));
  oai21  g24(.a(x9), .b(x7), .c(new_n34_), .O(new_n43_));
  nor2   g25(.a(new_n18_), .b(new_n26_), .O(new_n44_));
