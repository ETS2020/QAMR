...
module FAU ( 
  ...
  inv1   g07(.a(new_n20_), .O(new_n27_));
  nand2  g08(.a(x8), .b(new_n19_), .O(new_n28_));
  nor2   g09(.a(x1), .b(x0), .O(new_n29_));
  nand4  g10(.a(new_n29_), .b(new_n28_), .c(new_n27_), .d(x2), .O(new_n30_));
  nand3  g11(.a(x8), .b(new_n19_), .c(x5), .O(new_n31_));
  nand4  g12(.a(new_n31_), .b(new_n30_), .c(x9), .d(x6), .O(z5));
  inv1   g13(.a(new_n31_), .O(new_n33_));
  inv1   g14(.a(x0), .O(new_n34_));
  inv1   g15(.a(x1), .O(new_n35_));
  inv1   g16(.a(x2), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(new_n37_));
  aoi21  g18(.a(new_n37_), .b(x8), .c(new_n19_), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n33_), .c(x9), .O(new_n39_));
  nor2   g20(.a(new_n25_), .b(x6), .O(new_n40_));
  nor2   g21(.a(new_n40_), .b(z2), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n39_), .O(z6));
  one    g23(.O(z0));
  one    g24(.O(z3));
endmodule
