...
module FAU ( 
  ...
  nand4  g12(.a(x9), .b(new_n21_), .c(x7), .d(x6), .O(z4));
  nor2   g13(.a(x1), .b(x0), .O(new_n32_));
  nand2  g14(.a(new_n21_), .b(x7), .O(new_n33_));
  nand4  g15(.a(new_n33_), .b(new_n32_), .c(new_n26_), .d(x2), .O(new_n34_));
  inv1   g16(.a(x6), .O(new_n35_));
  inv1   g17(.a(x5), .O(new_n36_));
  nor2   g18(.a(x7), .b(new_n36_), .O(new_n37_));
  aoi21  g19(.a(new_n37_), .b(new_n23_), .c(new_n35_), .O(new_n38_));
  nand3  g20(.a(new_n38_), .b(new_n34_), .c(new_n27_), .O(z5));
  oai21  g21(.a(new_n29_), .b(new_n22_), .c(x7), .O(new_n40_));
  oai21  g22(.a(new_n22_), .b(x7), .c(new_n21_), .O(new_n41_));
  nand3  g23(.a(new_n41_), .b(new_n40_), .c(new_n38_), .O(z6));
  one    g24(.O(z0));
endmodule
