...
module FAU ( 
  ...
  nand2  g15(.a(new_n32_), .b(new_n29_), .O(z3));
  ...
  nand2  g22(.a(new_n30_), .b(new_n39_), .O(new_n40_));
  nand3  g23(.a(x9), .b(x8), .c(x5), .O(new_n41_));
  nand4  g24(.a(new_n20_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n19_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n40_), .c(new_n38_), .O(z5));
  oai21  g28(.a(x9), .b(x8), .c(new_n41_), .O(new_n46_));
