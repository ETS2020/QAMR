...
module FAU ( 
  ...
  nand2  g16(.a(new_n20_), .b(x7), .O(new_n34_));
  nor2   g17(.a(new_n24_), .b(new_n26_), .O(new_n35_));
  nand3  g18(.a(new_n35_), .b(new_n34_), .c(new_n27_), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(new_n33_), .c(z0), .d(x6), .O(z5));
  inv1   g20(.a(x0), .O(new_n38_));
  inv1   g21(.a(x1), .O(new_n39_));
  nand3  g22(.a(new_n26_), .b(new_n39_), .c(new_n38_), .O(new_n40_));
  ...
  oai21  g28(.a(new_n30_), .b(new_n45_), .c(z0), .O(new_n46_));
