...
module FAU ( 
  ...
  oai21  g17(.a(new_n34_), .b(new_n33_), .c(x3), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n18_), .O(z3));
  and2   g19(.a(x7), .b(x6), .O(new_n37_));
  nor2   g20(.a(x9), .b(x3), .O(new_n38_));
  ...
  oai21  g26(.a(new_n34_), .b(new_n43_), .c(x6), .O(new_n44_));
  ...
  nor3   g34(.a(x9), .b(new_n27_), .c(new_n46_), .O(new_n52_));
  ...
  oai21  g38(.a(x9), .b(x3), .c(x6), .O(new_n56_));
