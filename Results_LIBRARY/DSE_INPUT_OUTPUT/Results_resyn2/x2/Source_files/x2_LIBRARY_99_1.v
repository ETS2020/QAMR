...
module FAU ( 
  ...
  nand2  g00(.a(x9), .b(x6), .O(new_n18_));
  ...
  nand3  g07(.a(x9), .b(x7), .c(x6), .O(new_n25_));
  inv1   g08(.a(new_n25_), .O(new_n26_));
  oai21  g09(.a(new_n26_), .b(new_n22_), .c(new_n19_), .O(z1));
  ...
  nand4  g18(.a(new_n35_), .b(new_n20_), .c(x8), .d(new_n28_), .O(z3));
  inv1   g19(.a(x6), .O(new_n37_));
  nand2  g20(.a(x9), .b(x8), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(x7), .c(new_n37_), .O(new_n39_));
  nor2   g22(.a(x9), .b(x6), .O(new_n40_));
  or2    g23(.a(new_n40_), .b(new_n39_), .O(z4));
  oai21  g24(.a(new_n38_), .b(new_n28_), .c(new_n29_), .O(new_n42_));
  ...
  nand4  g30(.a(x9), .b(x8), .c(x6), .d(x5), .O(new_n48_));
  inv1   g31(.a(new_n48_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n28_), .c(new_n37_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n47_), .c(new_n43_), .O(z5));
  aoi21  g34(.a(new_n34_), .b(x8), .c(new_n18_), .O(new_n52_));
  nand4  g35(.a(new_n20_), .b(x8), .c(x4), .d(x3), .O(new_n53_));
  inv1   g36(.a(new_n53_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n52_), .c(x7), .O(new_n55_));
  nand2  g38(.a(new_n48_), .b(new_n21_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n28_), .c(new_n40_), .O(new_n57_));
