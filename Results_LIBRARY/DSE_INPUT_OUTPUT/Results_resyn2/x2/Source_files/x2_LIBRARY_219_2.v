...
module FAU ( 
  ...
  nand2  g17(.a(new_n18_), .b(x3), .O(new_n35_));
  ...
  nand3  g22(.a(x8), .b(new_n20_), .c(x5), .O(new_n40_));
  inv1   g23(.a(new_n40_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(x9), .O(new_n42_));
  inv1   g25(.a(x6), .O(new_n43_));
  nand2  g26(.a(x8), .b(new_n19_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n18_), .c(new_n43_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n42_), .c(new_n39_), .O(z5));
  aoi21  g29(.a(new_n32_), .b(x8), .c(new_n20_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n41_), .c(x9), .O(new_n48_));
  nor2   g31(.a(z2), .b(new_n43_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n48_), .O(z6));
endmodule
