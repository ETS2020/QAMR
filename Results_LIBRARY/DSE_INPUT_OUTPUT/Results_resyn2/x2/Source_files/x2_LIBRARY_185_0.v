...
module FAU ( 
  ...
  nor2   g08(.a(new_n22_), .b(x7), .O(new_n26_));
  ...
  oai21  g13(.a(new_n29_), .b(z2), .c(new_n30_), .O(z4));
  nand2  g14(.a(new_n22_), .b(x7), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n27_), .c(new_n20_), .d(x2), .O(new_n33_));
  ...
  nand3  g24(.a(new_n27_), .b(x9), .c(new_n25_), .O(new_n42_));
