...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n22_, new_n24_, new_n25_, new_n26_, new_n28_,
  ...
  nand4  g09(.a(new_n26_), .b(new_n25_), .c(new_n18_), .d(new_n24_), .O(z3));
  nand2  g10(.a(x9), .b(x8), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n22_), .c(x7), .d(x6), .O(z4));
  inv1   g12(.a(x7), .O(new_n30_));
  nand2  g13(.a(x8), .b(new_n30_), .O(new_n31_));
  nand2  g14(.a(new_n20_), .b(x7), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n25_), .d(x2), .O(new_n33_));
  nand2  g16(.a(new_n26_), .b(x5), .O(new_n34_));
