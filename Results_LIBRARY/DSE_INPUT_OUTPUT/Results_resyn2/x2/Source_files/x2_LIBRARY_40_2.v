...
module FAU ( 
  ...
  nand3  g08(.a(new_n20_), .b(x7), .c(x6), .O(new_n27_));
  and2   g09(.a(new_n27_), .b(z0), .O(z4));
  xnor2a g10(.a(x8), .b(x7), .O(new_n29_));
  nor2   g11(.a(x1), .b(x0), .O(new_n30_));
  nand3  g12(.a(new_n30_), .b(new_n29_), .c(x2), .O(new_n31_));
  nand3  g13(.a(x8), .b(new_n21_), .c(x5), .O(new_n32_));
  nand4  g14(.a(new_n32_), .b(new_n31_), .c(x9), .d(x6), .O(z5));
  nor3   g15(.a(x2), .b(x1), .c(x0), .O(new_n34_));
  oai21  g16(.a(new_n34_), .b(new_n20_), .c(new_n22_), .O(new_n35_));
