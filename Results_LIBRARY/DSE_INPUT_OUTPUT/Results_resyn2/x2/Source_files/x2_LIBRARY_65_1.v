...
module FAU ( 
  ...
  aoi22  g16(.a(new_n33_), .b(new_n31_), .c(x9), .d(new_n20_), .O(z4));
  ...
  oai21  g29(.a(new_n22_), .b(new_n32_), .c(new_n21_), .O(new_n47_));
