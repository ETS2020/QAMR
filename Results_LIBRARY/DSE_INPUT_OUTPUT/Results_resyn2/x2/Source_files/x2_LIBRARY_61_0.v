...
module FAU ( 
  ...
  nand4  g10(.a(new_n18_), .b(new_n27_), .c(new_n23_), .d(x0), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  inv1   g12(.a(x6), .O(new_n31_));
  nor2   g13(.a(new_n23_), .b(new_n31_), .O(new_n32_));
  nor2   g14(.a(x9), .b(x0), .O(new_n33_));
  oai22  g15(.a(new_n33_), .b(new_n32_), .c(new_n18_), .d(new_n27_), .O(z4));
  nand2  g16(.a(new_n27_), .b(new_n23_), .O(new_n35_));
  inv1   g17(.a(x1), .O(new_n36_));
  nand3  g18(.a(x2), .b(new_n36_), .c(new_n22_), .O(new_n37_));
  ...
  oai21  g26(.a(new_n44_), .b(new_n31_), .c(x0), .O(new_n45_));
  nand2  g27(.a(new_n45_), .b(new_n41_), .O(z5));
  inv1   g28(.a(x2), .O(new_n47_));
  nand3  g29(.a(x7), .b(new_n47_), .c(new_n36_), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(x9), .O(new_n49_));
  nand2  g31(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  nand2  g32(.a(new_n18_), .b(new_n27_), .O(new_n51_));
  nand3  g33(.a(x9), .b(x8), .c(x5), .O(new_n52_));
  nand2  g34(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g35(.a(new_n53_), .b(new_n23_), .O(new_n54_));
  nand2  g36(.a(x4), .b(x3), .O(new_n55_));
  oai21  g37(.a(new_n55_), .b(x9), .c(x8), .O(new_n56_));
  nand3  g38(.a(new_n56_), .b(new_n51_), .c(x7), .O(new_n57_));
  nand4  g39(.a(new_n57_), .b(new_n54_), .c(new_n50_), .d(x6), .O(z6));
  one    g40(.O(z3));
endmodule
