...
module FAU ( 
  ...
  oai21  g20(.a(new_n21_), .b(x7), .c(x9), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(x5), .c(new_n37_), .O(new_n39_));
  nand4  g22(.a(new_n34_), .b(new_n30_), .c(new_n28_), .d(x2), .O(new_n40_));
  ...
  nand4  g30(.a(x9), .b(new_n29_), .c(new_n47_), .d(new_n46_), .O(new_n48_));
  ...
  nand3  g36(.a(new_n53_), .b(new_n51_), .c(new_n39_), .O(z6));
endmodule
