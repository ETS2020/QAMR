...
module FAU ( 
  ...
  nand2  g07(.a(new_n24_), .b(new_n20_), .O(z0));
  ...
  aoi21  g13(.a(new_n27_), .b(new_n19_), .c(new_n23_), .O(z2));
  inv1   g14(.a(x0), .O(new_n32_));
  inv1   g15(.a(x1), .O(new_n33_));
  inv1   g16(.a(x2), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(new_n18_), .c(new_n21_), .O(new_n36_));
  nand2  g19(.a(x9), .b(new_n22_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(x7), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n36_), .c(new_n29_), .O(z3));
  inv1   g22(.a(new_n21_), .O(new_n40_));
  inv1   g23(.a(x6), .O(new_n41_));
  nand3  g24(.a(new_n37_), .b(x7), .c(new_n41_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n29_), .c(new_n40_), .O(z4));
  nand3  g26(.a(x9), .b(x8), .c(x7), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n27_), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n46_));
  ...
  aoi21  g33(.a(new_n50_), .b(new_n19_), .c(x4), .O(new_n51_));
  nand2  g34(.a(new_n20_), .b(x6), .O(new_n52_));
  nor2   g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n49_), .c(new_n46_), .O(z5));
  aoi21  g37(.a(new_n35_), .b(x8), .c(new_n19_), .O(new_n55_));
  ...
  nand2  g41(.a(new_n47_), .b(new_n20_), .O(new_n59_));
  nand2  g42(.a(new_n37_), .b(x6), .O(new_n60_));
  aoi21  g43(.a(new_n59_), .b(new_n26_), .c(new_n60_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n58_), .O(z6));
endmodule
