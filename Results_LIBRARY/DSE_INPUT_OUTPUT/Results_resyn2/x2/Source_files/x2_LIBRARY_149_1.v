...
module FAU ( 
  ...
  nand3  g12(.a(new_n18_), .b(new_n29_), .c(x3), .O(new_n30_));
  inv1   g13(.a(x0), .O(new_n31_));
  inv1   g14(.a(x1), .O(new_n32_));
  nand3  g15(.a(x2), .b(new_n32_), .c(new_n31_), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n27_), .c(new_n30_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x7), .O(new_n35_));
  nand2  g18(.a(x9), .b(new_n24_), .O(new_n36_));
  oai21  g19(.a(x9), .b(x8), .c(x6), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n35_), .O(z5));
  inv1   g22(.a(x2), .O(new_n40_));
  nand4  g23(.a(x9), .b(new_n40_), .c(new_n32_), .d(new_n31_), .O(new_n41_));
  ...
  aoi21  g28(.a(new_n18_), .b(x7), .c(x8), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n45_), .c(new_n36_), .O(new_n47_));
