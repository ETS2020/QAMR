...
module FAU ( 
  ...
  oai21  g13(.a(x9), .b(new_n20_), .c(new_n30_), .O(z3));
  nand3  g14(.a(new_n18_), .b(x7), .c(x6), .O(z4));
  nand3  g15(.a(x9), .b(x8), .c(x5), .O(new_n33_));
  nand4  g16(.a(new_n21_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n34_));
