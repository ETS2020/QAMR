...
module FAU ( 
  ...
  nor2   g14(.a(new_n21_), .b(x4), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(new_n18_), .c(new_n20_), .O(new_n33_));
  or2    g16(.a(new_n33_), .b(new_n31_), .O(z3));
  inv1   g17(.a(x6), .O(new_n35_));
  oai22  g18(.a(x9), .b(new_n19_), .c(new_n20_), .d(new_n35_), .O(new_n36_));
  nand2  g19(.a(x9), .b(x8), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n36_), .O(z4));
  oai21  g21(.a(new_n37_), .b(new_n20_), .c(new_n24_), .O(new_n39_));
