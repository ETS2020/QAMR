...
module FAU ( 
  ...
  oai21  g19(.a(new_n36_), .b(x7), .c(new_n21_), .O(new_n37_));
  ...
  nand3  g27(.a(new_n44_), .b(x9), .c(new_n21_), .O(new_n45_));
  ...
  nand2  g32(.a(new_n30_), .b(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n36_), .b(new_n22_), .c(new_n20_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n26_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n50_), .c(new_n48_), .O(z6));
endmodule
