...
module FAU ( 
  ...
  aoi21  g19(.a(new_n36_), .b(new_n18_), .c(new_n32_), .O(new_n37_));
  oai21  g20(.a(new_n25_), .b(new_n21_), .c(x7), .O(new_n38_));
  aoi21  g21(.a(x8), .b(new_n18_), .c(new_n28_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(new_n27_), .d(new_n26_), .O(new_n40_));
  oai21  g23(.a(new_n37_), .b(new_n19_), .c(new_n40_), .O(z5));
  aoi21  g24(.a(new_n29_), .b(x8), .c(new_n18_), .O(new_n42_));
