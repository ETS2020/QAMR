...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n23_, new_n24_, new_n26_, new_n27_, new_n29_,
  ...
  oai21  g08(.a(x8), .b(new_n26_), .c(x9), .O(new_n27_));
  nand2  g09(.a(new_n27_), .b(x7), .O(z4));
  oai21  g10(.a(x9), .b(new_n19_), .c(new_n26_), .O(new_n29_));
