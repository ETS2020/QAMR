...
module FAU ( 
  ...
  oai21  g07(.a(x9), .b(x7), .c(x6), .O(new_n25_));
  oai21  g08(.a(new_n25_), .b(new_n24_), .c(new_n19_), .O(z1));
  nand2  g09(.a(new_n23_), .b(x6), .O(new_n27_));
  inv1   g10(.a(new_n27_), .O(new_n28_));
  nand3  g11(.a(new_n28_), .b(new_n19_), .c(new_n22_), .O(new_n29_));
  ...
  nor2   g19(.a(new_n36_), .b(new_n18_), .O(z3));
  inv1   g20(.a(x6), .O(new_n38_));
  oai22  g21(.a(new_n28_), .b(new_n19_), .c(x7), .d(new_n38_), .O(z4));
  ...
  aoi21  g31(.a(new_n48_), .b(new_n22_), .c(new_n38_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n46_), .c(new_n42_), .O(z5));
  nand2  g33(.a(x9), .b(x6), .O(new_n51_));
  aoi21  g34(.a(new_n34_), .b(x8), .c(new_n51_), .O(new_n52_));
  ...
  nor2   g38(.a(new_n19_), .b(x6), .O(new_n56_));
  oai21  g39(.a(new_n27_), .b(x8), .c(new_n47_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(new_n22_), .c(new_n56_), .O(new_n58_));
