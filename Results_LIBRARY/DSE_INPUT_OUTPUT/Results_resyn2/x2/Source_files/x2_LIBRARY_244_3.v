...
module FAU ( 
  ...
  nand4  g18(.a(new_n18_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n36_));
  nand3  g19(.a(x9), .b(x8), .c(x5), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n36_), .c(x6), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(z4), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n35_), .O(z5));
  nand2  g23(.a(new_n37_), .b(new_n20_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n22_), .O(new_n42_));
  inv1   g25(.a(x6), .O(new_n43_));
  nand2  g26(.a(new_n24_), .b(new_n43_), .O(new_n44_));
  nand4  g27(.a(new_n28_), .b(x7), .c(x4), .d(x3), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n42_), .O(z6));
endmodule
