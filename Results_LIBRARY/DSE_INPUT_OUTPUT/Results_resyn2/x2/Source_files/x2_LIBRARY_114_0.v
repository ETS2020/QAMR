...
module FAU ( 
  ...
  aoi21  g05(.a(new_n22_), .b(x6), .c(x9), .O(z2));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n20_), .c(new_n33_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n42_), .c(new_n38_), .O(z5));
  aoi21  g29(.a(new_n29_), .b(x8), .c(new_n18_), .O(new_n47_));
