...
module FAU ( 
  ...
  oai21  g12(.a(new_n29_), .b(new_n25_), .c(new_n23_), .O(new_n30_));
  ...
  aoi21  g20(.a(x8), .b(new_n23_), .c(new_n28_), .O(new_n38_));
  nand2  g21(.a(new_n25_), .b(x7), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(new_n27_), .d(new_n26_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n37_), .c(z0), .d(x6), .O(z5));
  aoi21  g24(.a(new_n29_), .b(x8), .c(new_n23_), .O(new_n42_));
  nand3  g25(.a(x8), .b(new_n23_), .c(x5), .O(new_n43_));
  inv1   g26(.a(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(x9), .O(new_n45_));
  oai21  g28(.a(new_n20_), .b(new_n32_), .c(z0), .O(new_n46_));
