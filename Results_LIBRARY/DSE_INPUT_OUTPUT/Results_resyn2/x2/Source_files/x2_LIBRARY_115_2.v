...
module FAU ( 
  ...
  aoi21  g07(.a(x8), .b(new_n25_), .c(x9), .O(z2));
  inv1   g08(.a(x2), .O(new_n27_));
  nor2   g09(.a(x1), .b(x0), .O(new_n28_));
  nand2  g10(.a(new_n28_), .b(new_n27_), .O(new_n29_));
  oai21  g11(.a(new_n29_), .b(new_n19_), .c(new_n25_), .O(new_n30_));
  nand2  g12(.a(new_n30_), .b(new_n20_), .O(z3));
  nand4  g13(.a(x9), .b(new_n19_), .c(x7), .d(x6), .O(z4));
  oai21  g14(.a(new_n20_), .b(x6), .c(x7), .O(new_n33_));
  nand3  g15(.a(x9), .b(x8), .c(x5), .O(new_n34_));
  nand3  g16(.a(new_n34_), .b(new_n21_), .c(x6), .O(new_n35_));
  nand2  g17(.a(new_n35_), .b(new_n33_), .O(new_n36_));
  nand2  g18(.a(x8), .b(new_n25_), .O(new_n37_));
  nand4  g19(.a(new_n28_), .b(new_n37_), .c(new_n23_), .d(x2), .O(new_n38_));
  nand2  g20(.a(new_n38_), .b(new_n36_), .O(z5));
  nor3   g21(.a(x2), .b(x1), .c(x0), .O(new_n40_));
  oai21  g22(.a(new_n40_), .b(new_n22_), .c(x7), .O(new_n41_));
  nand2  g23(.a(new_n41_), .b(new_n36_), .O(z6));
  one    g24(.O(z0));
endmodule
