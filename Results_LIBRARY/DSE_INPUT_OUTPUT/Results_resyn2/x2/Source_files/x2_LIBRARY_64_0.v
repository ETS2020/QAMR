...
module FAU ( 
  ...
  nand2  g05(.a(new_n18_), .b(new_n23_), .O(z3));
  nand2  g06(.a(x9), .b(x8), .O(new_n25_));
  nand3  g07(.a(new_n25_), .b(x7), .c(x6), .O(z4));
  nand2  g08(.a(new_n20_), .b(x7), .O(new_n27_));
  ...
  aoi21  g25(.a(new_n43_), .b(x8), .c(new_n23_), .O(new_n44_));
  oai21  g26(.a(new_n44_), .b(new_n39_), .c(x9), .O(new_n45_));
  nand3  g27(.a(x8), .b(x4), .c(x3), .O(new_n46_));
