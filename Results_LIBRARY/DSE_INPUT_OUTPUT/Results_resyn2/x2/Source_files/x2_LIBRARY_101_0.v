...
module FAU ( 
  ...
  nor2   g15(.a(new_n19_), .b(new_n32_), .O(new_n33_));
  aoi21  g16(.a(new_n33_), .b(new_n31_), .c(new_n29_), .O(z4));
  nand3  g17(.a(x8), .b(new_n19_), .c(x5), .O(new_n35_));
  inv1   g18(.a(new_n35_), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(new_n32_), .c(x9), .O(new_n37_));
  ...
  nand2  g26(.a(new_n20_), .b(new_n19_), .O(new_n44_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n41_), .c(x6), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x2), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n37_), .O(z5));
  nand3  g33(.a(new_n23_), .b(new_n43_), .c(new_n42_), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(x8), .c(new_n19_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n36_), .c(x9), .O(new_n53_));
  nand4  g36(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n44_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n18_), .c(new_n32_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n53_), .c(new_n29_), .O(z6));
endmodule
