...
module FAU ( 
  ...
  aoi22  g19(.a(new_n36_), .b(new_n34_), .c(x9), .d(new_n24_), .O(z4));
  nand2  g20(.a(new_n20_), .b(x7), .O(new_n38_));
  nand3  g21(.a(new_n30_), .b(new_n38_), .c(x2), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n31_), .c(x5), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n18_), .c(new_n35_), .O(new_n45_));
  ...
  nand2  g36(.a(new_n18_), .b(new_n20_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n34_), .O(new_n55_));
  nand2  g38(.a(new_n25_), .b(x6), .O(new_n56_));
  aoi21  g39(.a(new_n55_), .b(new_n22_), .c(new_n56_), .O(new_n57_));
