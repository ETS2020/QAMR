...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n22_, new_n25_, new_n27_, new_n28_,
  ...
  nand4  g07(.a(new_n25_), .b(new_n18_), .c(x8), .d(new_n19_), .O(z3));
  inv1   g08(.a(x6), .O(new_n27_));
  oai21  g09(.a(x9), .b(x8), .c(new_n27_), .O(new_n28_));
  oai21  g10(.a(new_n18_), .b(new_n22_), .c(x7), .O(new_n29_));
  oai21  g11(.a(x9), .b(x8), .c(new_n29_), .O(new_n30_));
  nand2  g12(.a(new_n30_), .b(new_n28_), .O(z4));
  nor2   g13(.a(x1), .b(x0), .O(new_n32_));
  nand4  g14(.a(new_n29_), .b(new_n32_), .c(new_n20_), .d(x2), .O(new_n33_));
  ...
  nand3  g19(.a(x9), .b(new_n19_), .c(x5), .O(new_n38_));
  ...
  oai21  g24(.a(new_n25_), .b(new_n22_), .c(new_n42_), .O(new_n43_));
  ...
  nand3  g28(.a(new_n46_), .b(new_n43_), .c(new_n28_), .O(z6));
  zero   g29(.O(z2));
endmodule
