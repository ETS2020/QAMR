...
module FAU ( 
  ...
  nand4  g10(.a(new_n22_), .b(x8), .c(new_n21_), .d(new_n27_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(new_n29_));
  aoi21  g12(.a(new_n29_), .b(new_n26_), .c(new_n23_), .O(z3));
  nor2   g13(.a(x9), .b(new_n21_), .O(new_n31_));
  ...
  oai21  g27(.a(new_n22_), .b(new_n21_), .c(new_n44_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n43_), .c(new_n36_), .O(z5));
  inv1   g29(.a(new_n37_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n18_), .c(new_n21_), .O(new_n48_));
  nand4  g31(.a(new_n31_), .b(x8), .c(x4), .d(x3), .O(new_n49_));
