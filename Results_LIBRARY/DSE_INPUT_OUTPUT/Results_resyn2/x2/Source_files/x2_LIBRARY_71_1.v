...
module FAU ( 
  ...
  aoi21  g07(.a(new_n22_), .b(new_n18_), .c(new_n24_), .O(z2));
  ...
  oai21  g14(.a(new_n18_), .b(x2), .c(new_n31_), .O(new_n32_));
  oai21  g15(.a(new_n18_), .b(new_n21_), .c(x7), .O(new_n33_));
  oai21  g16(.a(new_n18_), .b(x2), .c(new_n33_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n32_), .O(z4));
  ...
  nand2  g25(.a(x8), .b(new_n20_), .O(new_n43_));
  nand3  g26(.a(new_n33_), .b(new_n43_), .c(new_n28_), .O(new_n44_));
  nand2  g27(.a(x9), .b(new_n20_), .O(new_n45_));
  aoi22  g28(.a(new_n45_), .b(new_n31_), .c(x9), .d(new_n23_), .O(new_n46_));
  nand4  g29(.a(new_n46_), .b(new_n44_), .c(new_n42_), .d(new_n38_), .O(z5));
  nand2  g30(.a(x8), .b(x7), .O(new_n48_));
  nand2  g31(.a(x4), .b(x3), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n48_), .c(new_n22_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  nand2  g34(.a(x8), .b(x5), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n20_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n24_), .c(new_n48_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n51_), .c(new_n32_), .O(z6));
endmodule
