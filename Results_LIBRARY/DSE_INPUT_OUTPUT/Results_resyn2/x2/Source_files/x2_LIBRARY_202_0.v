...
module FAU ( 
  ...
  oai22  g09(.a(new_n23_), .b(new_n18_), .c(new_n26_), .d(x6), .O(z4));
  nor2   g10(.a(x1), .b(x0), .O(new_n28_));
  nand2  g11(.a(x8), .b(new_n26_), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n22_), .d(x2), .O(new_n30_));
  ...
  aoi21  g17(.a(new_n34_), .b(x3), .c(new_n21_), .O(new_n35_));
