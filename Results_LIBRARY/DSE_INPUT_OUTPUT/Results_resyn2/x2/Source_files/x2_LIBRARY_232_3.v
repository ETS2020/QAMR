...
module FAU ( 
  ...
  nand3  g08(.a(x9), .b(new_n20_), .c(x7), .O(new_n26_));
  ...
  aoi21  g16(.a(new_n33_), .b(new_n21_), .c(new_n19_), .O(z3));
  nand3  g17(.a(new_n23_), .b(x7), .c(x6), .O(z4));
  inv1   g18(.a(x4), .O(new_n36_));
  nand3  g19(.a(x7), .b(new_n36_), .c(x3), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n21_), .c(x6), .O(z5));
