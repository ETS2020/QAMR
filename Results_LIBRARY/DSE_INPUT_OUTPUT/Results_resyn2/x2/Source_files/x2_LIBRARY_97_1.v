...
module FAU ( 
  ...
  nor2   g07(.a(new_n21_), .b(x8), .O(new_n25_));
  aoi21  g08(.a(new_n24_), .b(new_n18_), .c(new_n25_), .O(z1));
  nor2   g09(.a(new_n22_), .b(x8), .O(z2));
  inv1   g10(.a(x2), .O(new_n28_));
  nor2   g11(.a(x1), .b(x0), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n28_), .O(new_n30_));
  oai21  g13(.a(new_n30_), .b(new_n19_), .c(new_n21_), .O(new_n31_));
  ...
  aoi21  g22(.a(new_n24_), .b(new_n18_), .c(new_n33_), .O(new_n40_));
  nand4  g23(.a(new_n29_), .b(x9), .c(x8), .d(x2), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(z5));
  ...
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n40_), .O(z6));
endmodule
