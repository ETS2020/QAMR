...
module FAU ( 
  ...
  aoi21  g15(.a(new_n32_), .b(new_n27_), .c(new_n26_), .O(z3));
  oai21  g16(.a(x9), .b(x6), .c(x7), .O(z4));
  nand3  g17(.a(x2), .b(new_n29_), .c(new_n28_), .O(new_n35_));
  ...
  nand4  g28(.a(new_n27_), .b(x7), .c(x4), .d(x3), .O(new_n46_));
  nand2  g29(.a(new_n24_), .b(new_n41_), .O(new_n47_));
  nand2  g30(.a(new_n19_), .b(x8), .O(new_n48_));
  nand2  g31(.a(new_n38_), .b(x9), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n48_), .c(new_n22_), .O(new_n50_));
