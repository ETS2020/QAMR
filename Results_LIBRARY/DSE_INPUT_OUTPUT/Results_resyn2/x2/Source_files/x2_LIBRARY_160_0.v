...
module FAU ( 
  ...
  nand3  g08(.a(new_n25_), .b(new_n18_), .c(x0), .O(new_n26_));
  nand2  g09(.a(new_n26_), .b(new_n23_), .O(z1));
  nand4  g10(.a(new_n18_), .b(new_n24_), .c(new_n22_), .d(x0), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  inv1   g12(.a(x0), .O(new_n30_));
  nand2  g13(.a(new_n18_), .b(new_n30_), .O(z3));
  nand2  g14(.a(x9), .b(x8), .O(new_n32_));
  inv1   g15(.a(x6), .O(new_n33_));
  nor2   g16(.a(new_n22_), .b(new_n33_), .O(new_n34_));
  aoi22  g17(.a(new_n34_), .b(new_n32_), .c(new_n18_), .d(new_n30_), .O(z4));
  inv1   g18(.a(x1), .O(new_n36_));
  nand3  g19(.a(x2), .b(new_n36_), .c(new_n30_), .O(new_n37_));
  aoi21  g20(.a(new_n25_), .b(new_n19_), .c(new_n37_), .O(new_n38_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n36_), .c(new_n30_), .O(new_n49_));
  ...
  oai21  g36(.a(new_n53_), .b(new_n33_), .c(z3), .O(new_n54_));
