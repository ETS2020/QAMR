...
module FAU ( 
  ...
  oai21  g16(.a(x8), .b(new_n24_), .c(x9), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(x7), .c(x6), .O(z4));
  nand4  g18(.a(x9), .b(x8), .c(new_n29_), .d(x5), .O(new_n36_));
  ...
  nand2  g26(.a(new_n20_), .b(x7), .O(new_n44_));
  nand3  g27(.a(x8), .b(new_n29_), .c(x5), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(x9), .c(x0), .O(new_n47_));
  nand4  g30(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n48_));
  inv1   g31(.a(new_n48_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n22_), .c(new_n18_), .O(new_n50_));
  inv1   g33(.a(x6), .O(new_n51_));
  nand2  g34(.a(new_n25_), .b(new_n51_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n50_), .c(new_n47_), .O(z6));
endmodule
