...
module FAU ( 
  ...
  oai21  g08(.a(new_n18_), .b(new_n26_), .c(x8), .O(new_n28_));
  ...
  nand2  g15(.a(x8), .b(x5), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(x9), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n26_), .c(new_n34_), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n33_), .c(new_n30_), .O(z5));
  nor2   g19(.a(new_n18_), .b(new_n26_), .O(new_n39_));
  nor3   g20(.a(x2), .b(x1), .c(x0), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n20_), .c(new_n39_), .O(new_n41_));
  nand4  g22(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n37_), .O(z6));
  zero   g24(.O(z2));
  one    g25(.O(z3));
endmodule
