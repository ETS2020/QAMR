...
module FAU ( 
  ...
  nand3  g14(.a(new_n21_), .b(x8), .c(new_n24_), .O(new_n32_));
  ...
  aoi22  g19(.a(new_n36_), .b(new_n34_), .c(new_n18_), .d(new_n20_), .O(z4));
  oai21  g20(.a(new_n34_), .b(new_n24_), .c(new_n26_), .O(new_n38_));
  ...
  nand2  g25(.a(x8), .b(x4), .O(new_n43_));
  aoi21  g26(.a(new_n43_), .b(new_n18_), .c(new_n35_), .O(new_n44_));
  ...
  oai21  g32(.a(x9), .b(x8), .c(new_n40_), .O(new_n50_));
  oai21  g33(.a(x9), .b(x4), .c(x6), .O(new_n51_));
