...
module FAU ( 
  ...
  nand2  g17(.a(new_n20_), .b(x2), .O(new_n35_));
  nand4  g18(.a(new_n35_), .b(new_n34_), .c(x7), .d(x6), .O(z4));
  xor2a  g19(.a(x8), .b(x7), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n30_), .c(x9), .O(new_n38_));
  ...
  aoi21  g27(.a(new_n42_), .b(new_n20_), .c(new_n44_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n39_), .O(z5));
  nor2   g29(.a(new_n20_), .b(x8), .O(new_n47_));
  nand3  g30(.a(x9), .b(new_n29_), .c(new_n28_), .O(new_n48_));
  nand4  g31(.a(new_n20_), .b(x8), .c(x4), .d(x3), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n48_), .c(x2), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n47_), .c(x7), .O(new_n51_));
  inv1   g34(.a(x6), .O(new_n52_));
  nand2  g35(.a(new_n18_), .b(new_n24_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n43_), .O(new_n54_));
  aoi22  g37(.a(new_n54_), .b(new_n23_), .c(new_n35_), .d(new_n52_), .O(new_n55_));
