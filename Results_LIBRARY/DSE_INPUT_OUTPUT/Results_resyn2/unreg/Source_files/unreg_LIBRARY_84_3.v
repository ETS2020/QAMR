...
module FAU ( 
  ...
  aoi21  g11(.a(new_n63_), .b(new_n60_), .c(x12), .O(new_n64_));
  ...
  aoi21  g33(.a(new_n85_), .b(new_n83_), .c(x12), .O(new_n86_));
  ...
  aoi21  g52(.a(new_n104_), .b(new_n102_), .c(x12), .O(new_n105_));
  inv1   g53(.a(x29), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n59_), .O(new_n107_));
  oai21  g55(.a(new_n105_), .b(new_n59_), .c(new_n107_), .O(z09));
  ...
  oai22  g68(.a(new_n120_), .b(new_n55_), .c(x32), .d(x19), .O(z12));
  nand2  g69(.a(x34), .b(x18), .O(new_n122_));
  inv1   g70(.a(x14), .O(new_n123_));
  aoi21  g71(.a(new_n62_), .b(new_n123_), .c(x17), .O(new_n124_));
  aoi21  g72(.a(new_n124_), .b(new_n122_), .c(x12), .O(new_n125_));
  inv1   g73(.a(x33), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(new_n59_), .O(new_n127_));
  oai21  g75(.a(new_n125_), .b(new_n59_), .c(new_n127_), .O(z13));
  nand2  g76(.a(x35), .b(x18), .O(new_n129_));
  inv1   g77(.a(x13), .O(new_n130_));
  aoi21  g78(.a(new_n62_), .b(new_n130_), .c(x17), .O(new_n131_));
  aoi21  g79(.a(new_n131_), .b(new_n129_), .c(x12), .O(new_n132_));
  inv1   g80(.a(x34), .O(new_n133_));
  nand2  g81(.a(new_n133_), .b(new_n59_), .O(new_n134_));
  oai21  g82(.a(new_n132_), .b(new_n59_), .c(new_n134_), .O(z14));
  inv1   g83(.a(x28), .O(new_n136_));
  nand3  g84(.a(new_n136_), .b(x18), .c(new_n54_), .O(new_n137_));
  nand2  g85(.a(new_n137_), .b(new_n53_), .O(new_n138_));
  nand2  g86(.a(new_n138_), .b(x19), .O(new_n139_));
