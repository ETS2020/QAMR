...
module FAU ( 
  ...
  nand3  g090(.a(new_n142_), .b(x32), .c(x18), .O(new_n143_));
  nand2  g091(.a(new_n57_), .b(x15), .O(new_n144_));
  oai21  g092(.a(new_n144_), .b(new_n61_), .c(new_n143_), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n55_), .O(new_n146_));
  inv1   g094(.a(x32), .O(new_n147_));
  nand3  g095(.a(x33), .b(new_n147_), .c(new_n54_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n146_), .O(z12));
  nand3  g097(.a(new_n142_), .b(x32), .c(new_n54_), .O(new_n150_));
  inv1   g098(.a(new_n61_), .O(new_n151_));
  ...
  oai21  g102(.a(new_n154_), .b(new_n152_), .c(new_n150_), .O(z13));
