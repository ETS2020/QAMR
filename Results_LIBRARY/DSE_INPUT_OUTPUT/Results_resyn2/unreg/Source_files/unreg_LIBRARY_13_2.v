...
module FAU ( 
  ...
  aoi21  g051(.a(x33), .b(x19), .c(new_n103_), .O(new_n104_));
  ...
  nand4  g060(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n68_), .O(new_n113_));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n68_), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n116_), .c(new_n65_), .O(z08));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n68_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n65_), .O(z09));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n68_), .O(new_n134_));
  ...
  nand3  g089(.a(new_n141_), .b(new_n139_), .c(new_n63_), .O(z11));
  nand2  g090(.a(x33), .b(x18), .O(new_n143_));
  inv1   g091(.a(x15), .O(new_n144_));
  nand2  g092(.a(new_n57_), .b(new_n144_), .O(new_n145_));
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n68_), .O(new_n146_));
  nand2  g094(.a(x32), .b(new_n54_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n63_), .O(new_n148_));
  aoi21  g096(.a(new_n146_), .b(x19), .c(new_n148_), .O(z12));
  oai21  g097(.a(x26), .b(new_n54_), .c(new_n62_), .O(new_n150_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n68_), .O(new_n168_));
