...
module FAU ( 
  ...
  nand2  g099(.a(x33), .b(new_n55_), .O(new_n152_));
  nand2  g100(.a(x19), .b(x18), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(x11), .O(new_n154_));
  ...
  aoi21  g105(.a(x19), .b(x11), .c(new_n53_), .O(new_n158_));
