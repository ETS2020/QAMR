...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x09), .O(new_n61_));
  ...
  oai21  g082(.a(new_n134_), .b(x19), .c(new_n61_), .O(new_n135_));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n67_), .O(new_n156_));
  ...
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n67_), .O(new_n163_));
