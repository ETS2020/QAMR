...
module FAU ( 
  ...
  nand2  g001(.a(x30), .b(new_n53_), .O(new_n54_));
  ...
  nand2  g075(.a(new_n103_), .b(new_n56_), .O(new_n128_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n128_), .c(new_n54_), .O(z10));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n54_), .O(z12));
