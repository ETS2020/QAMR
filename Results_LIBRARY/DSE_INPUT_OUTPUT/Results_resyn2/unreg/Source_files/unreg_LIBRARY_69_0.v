...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x22), .O(new_n61_));
  ...
  inv1   g019(.a(x34), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n55_), .O(new_n74_));
  nand2  g022(.a(x23), .b(x18), .O(new_n75_));
  oai21  g023(.a(x18), .b(x01), .c(new_n75_), .O(new_n76_));
  nand3  g024(.a(x34), .b(new_n71_), .c(new_n54_), .O(new_n77_));
  oai21  g025(.a(new_n76_), .b(new_n74_), .c(new_n77_), .O(z02));
  ...
  nand2  g032(.a(new_n84_), .b(new_n73_), .O(new_n85_));
  oai21  g033(.a(new_n83_), .b(new_n74_), .c(new_n85_), .O(z03));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n88_), .c(new_n61_), .O(z04));
  ...
  nor2   g047(.a(new_n99_), .b(new_n61_), .O(new_n100_));
  ...
  nor2   g054(.a(new_n106_), .b(new_n61_), .O(new_n107_));
  ...
  nor2   g061(.a(new_n113_), .b(new_n61_), .O(new_n114_));
  ...
  nor2   g068(.a(new_n120_), .b(new_n61_), .O(new_n121_));
  ...
  nor2   g075(.a(new_n127_), .b(new_n61_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n126_), .O(z09));
  nand2  g077(.a(x31), .b(x18), .O(new_n130_));
  inv1   g078(.a(x09), .O(new_n131_));
  nand2  g079(.a(new_n57_), .b(new_n131_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n55_), .O(new_n133_));
  nor2   g081(.a(x30), .b(x19), .O(new_n134_));
  nor2   g082(.a(new_n134_), .b(new_n61_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n89_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n61_), .O(z11));
  ...
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n61_), .O(z12));
  ...
  nor2   g103(.a(new_n155_), .b(new_n61_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n154_), .O(z13));
  nand2  g105(.a(x35), .b(x18), .O(new_n158_));
  oai21  g106(.a(x18), .b(x13), .c(new_n158_), .O(new_n159_));
  nand3  g107(.a(new_n72_), .b(x22), .c(new_n54_), .O(new_n160_));
  oai21  g108(.a(new_n159_), .b(new_n74_), .c(new_n160_), .O(z14));
  ...
  nor2   g114(.a(new_n166_), .b(new_n61_), .O(new_n167_));
