...
module FAU ( 
  ...
  oai21  g002(.a(x34), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  ...
  oai21  g011(.a(x34), .b(new_n63_), .c(new_n53_), .O(new_n64_));
  ...
  oai21  g018(.a(x34), .b(new_n70_), .c(new_n53_), .O(new_n71_));
  ...
  oai21  g025(.a(x34), .b(new_n77_), .c(new_n53_), .O(new_n78_));
  ...
  oai21  g033(.a(x34), .b(new_n85_), .c(new_n53_), .O(new_n86_));
  ...
  nor2   g040(.a(x34), .b(x19), .O(new_n93_));
  ...
  oai21  g048(.a(x34), .b(new_n100_), .c(new_n53_), .O(new_n101_));
  ...
  oai21  g069(.a(x34), .b(new_n121_), .c(new_n53_), .O(new_n122_));
  ...
  oai21  g076(.a(x34), .b(new_n128_), .c(new_n53_), .O(new_n129_));
  ...
  nand2  g083(.a(new_n93_), .b(new_n135_), .O(new_n136_));
  ...
  oai21  g090(.a(x34), .b(new_n142_), .c(new_n53_), .O(new_n143_));
  ...
  nand2  g097(.a(new_n93_), .b(new_n149_), .O(new_n150_));
  ...
  inv1   g103(.a(new_n93_), .O(new_n156_));
  ...
  nand2  g110(.a(new_n93_), .b(new_n162_), .O(new_n163_));
