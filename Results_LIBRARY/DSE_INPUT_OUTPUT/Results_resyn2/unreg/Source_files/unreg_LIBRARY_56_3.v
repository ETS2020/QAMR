...
module FAU ( 
  ...
  inv1   g09(.a(x12), .O(new_n62_));
  inv1   g10(.a(x17), .O(new_n63_));
  nand3  g11(.a(x19), .b(new_n63_), .c(new_n62_), .O(new_n64_));
  ...
  aoi21  g18(.a(new_n70_), .b(new_n68_), .c(x12), .O(new_n71_));
  ...
  aoi21  g26(.a(new_n78_), .b(new_n76_), .c(x12), .O(new_n79_));
  ...
  oai22  g32(.a(new_n84_), .b(new_n64_), .c(x24), .d(x19), .O(z04));
  nand2  g33(.a(x26), .b(x18), .O(new_n86_));
  oai21  g34(.a(x18), .b(x06), .c(new_n86_), .O(new_n87_));
  oai22  g35(.a(new_n87_), .b(new_n64_), .c(x25), .d(x19), .O(z05));
  ...
  oai22  g45(.a(new_n97_), .b(new_n64_), .c(x27), .d(x19), .O(z07));
  ...
  aoi21  g56(.a(new_n108_), .b(new_n106_), .c(x12), .O(new_n109_));
  ...
  aoi21  g63(.a(new_n115_), .b(new_n113_), .c(x12), .O(new_n116_));
  ...
  aoi21  g70(.a(new_n122_), .b(new_n120_), .c(x12), .O(new_n123_));
  ...
  oai22  g76(.a(new_n128_), .b(new_n64_), .c(x32), .d(x19), .O(z12));
  nand2  g77(.a(x34), .b(x18), .O(new_n130_));
  inv1   g78(.a(x14), .O(new_n131_));
  aoi21  g79(.a(new_n56_), .b(new_n131_), .c(x17), .O(new_n132_));
  aoi21  g80(.a(new_n132_), .b(new_n130_), .c(x12), .O(new_n133_));
  inv1   g81(.a(x33), .O(new_n134_));
  nand2  g82(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  oai21  g83(.a(new_n133_), .b(new_n53_), .c(new_n135_), .O(z13));
  nand2  g84(.a(x35), .b(x18), .O(new_n137_));
  oai21  g85(.a(x18), .b(x13), .c(new_n137_), .O(new_n138_));
  oai22  g86(.a(new_n138_), .b(new_n64_), .c(x34), .d(x19), .O(z14));
  nand3  g87(.a(new_n103_), .b(x18), .c(new_n63_), .O(new_n140_));
  nand2  g88(.a(new_n140_), .b(new_n62_), .O(new_n141_));
  nand2  g89(.a(new_n141_), .b(x19), .O(new_n142_));
  oai21  g90(.a(x35), .b(x19), .c(new_n142_), .O(z15));
endmodule
