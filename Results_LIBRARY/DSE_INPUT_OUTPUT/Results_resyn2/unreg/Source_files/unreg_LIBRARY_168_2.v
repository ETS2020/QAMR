...
module FAU ( 
  ...
  oai21  g050(.a(x24), .b(new_n56_), .c(new_n53_), .O(new_n103_));
  ...
  nand3  g069(.a(new_n121_), .b(new_n119_), .c(new_n54_), .O(z08));
  ...
  oai21  g084(.a(new_n53_), .b(x18), .c(x24), .O(new_n137_));
  inv1   g085(.a(x08), .O(new_n138_));
  nand2  g086(.a(new_n62_), .b(new_n138_), .O(new_n139_));
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n73_), .O(new_n140_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n59_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n55_), .O(z12));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n62_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n73_), .O(new_n154_));
