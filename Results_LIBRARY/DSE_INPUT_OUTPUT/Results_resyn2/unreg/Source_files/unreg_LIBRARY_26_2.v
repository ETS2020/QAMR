...
module FAU ( 
  ...
  oai21  g034(.a(new_n86_), .b(x11), .c(new_n85_), .O(new_n87_));
  ...
  oai21  g041(.a(new_n93_), .b(x11), .c(new_n85_), .O(new_n94_));
  ...
  oai21  g048(.a(new_n100_), .b(x11), .c(new_n85_), .O(new_n101_));
  ...
  oai21  g076(.a(new_n128_), .b(x11), .c(new_n85_), .O(new_n129_));
  ...
  oai21  g083(.a(new_n135_), .b(x11), .c(new_n85_), .O(new_n136_));
  ...
  oai21  g090(.a(new_n142_), .b(x11), .c(new_n85_), .O(new_n143_));
  ...
  oai21  g104(.a(new_n156_), .b(x11), .c(new_n85_), .O(new_n157_));
