...
module FAU ( 
  ...
  nand2  g073(.a(new_n125_), .b(new_n117_), .O(new_n126_));
  oai21  g074(.a(new_n124_), .b(new_n118_), .c(new_n126_), .O(z09));
  ...
  nand3  g091(.a(new_n116_), .b(x28), .c(new_n54_), .O(new_n144_));
  oai21  g092(.a(new_n143_), .b(new_n118_), .c(new_n144_), .O(z12));
