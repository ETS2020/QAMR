...
module FAU ( 
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n109_), .O(new_n127_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n109_), .O(new_n141_));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n109_), .O(new_n162_));
