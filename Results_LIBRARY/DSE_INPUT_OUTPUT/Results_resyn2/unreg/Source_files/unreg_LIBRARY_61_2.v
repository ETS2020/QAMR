...
module FAU ( 
  ...
  nand2  g052(.a(new_n61_), .b(new_n53_), .O(new_n105_));
  nand4  g053(.a(new_n105_), .b(new_n104_), .c(x19), .d(new_n58_), .O(new_n106_));
  aoi21  g054(.a(new_n106_), .b(new_n103_), .c(new_n54_), .O(z06));
  ...
  oai21  g091(.a(new_n55_), .b(x05), .c(new_n143_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n61_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n79_), .O(new_n148_));
