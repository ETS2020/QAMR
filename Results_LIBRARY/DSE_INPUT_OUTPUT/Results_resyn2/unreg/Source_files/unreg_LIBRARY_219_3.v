...
module FAU ( 
  ...
  nand2  g008(.a(x27), .b(x23), .O(new_n61_));
  ...
  oai21  g049(.a(x23), .b(x18), .c(x27), .O(new_n102_));
  ...
  nand3  g054(.a(new_n61_), .b(new_n106_), .c(new_n54_), .O(new_n107_));
  ...
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n89_), .O(new_n163_));
  ...
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n89_), .O(new_n170_));
