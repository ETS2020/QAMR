...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x00), .O(new_n63_));
  ...
  nand2  g026(.a(new_n63_), .b(new_n55_), .O(new_n79_));
  ...
  oai21  g034(.a(new_n84_), .b(new_n79_), .c(new_n86_), .O(z03));
  inv1   g035(.a(new_n63_), .O(new_n88_));
  ...
  nand4  g042(.a(new_n94_), .b(new_n92_), .c(x19), .d(new_n91_), .O(new_n95_));
  aoi21  g043(.a(new_n95_), .b(new_n90_), .c(new_n88_), .O(z04));
  ...
  nand3  g050(.a(new_n102_), .b(new_n100_), .c(new_n63_), .O(z05));
  ...
  nand4  g056(.a(new_n108_), .b(new_n106_), .c(x19), .d(new_n91_), .O(new_n109_));
  aoi21  g057(.a(new_n109_), .b(new_n105_), .c(new_n88_), .O(z06));
  ...
  inv1   g062(.a(x27), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n54_), .O(new_n116_));
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n63_), .O(z07));
  nand2  g065(.a(x29), .b(x18), .O(new_n118_));
  oai21  g066(.a(x18), .b(x11), .c(new_n118_), .O(new_n119_));
  nand3  g067(.a(new_n62_), .b(new_n54_), .c(new_n80_), .O(new_n120_));
  oai21  g068(.a(new_n119_), .b(new_n79_), .c(new_n120_), .O(z08));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n91_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n130_), .c(new_n88_), .O(z10));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n91_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n88_), .O(z11));
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n91_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n88_), .O(z12));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n91_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n88_), .O(z13));
