...
module FAU ( 
  ...
  nor2   g000(.a(x28), .b(x24), .O(new_n53_));
  ...
  nand2  g034(.a(new_n58_), .b(new_n86_), .O(new_n87_));
  nand2  g035(.a(x25), .b(x18), .O(new_n88_));
  oai21  g036(.a(x18), .b(x07), .c(new_n88_), .O(new_n89_));
  inv1   g037(.a(x24), .O(new_n90_));
  nand3  g038(.a(x28), .b(new_n90_), .c(new_n54_), .O(new_n91_));
  oai21  g039(.a(new_n89_), .b(new_n87_), .c(new_n91_), .O(z04));
  ...
  oai21  g062(.a(new_n90_), .b(new_n54_), .c(new_n114_), .O(new_n115_));
  ...
  inv1   g082(.a(x17), .O(new_n135_));
  nand2  g083(.a(x24), .b(x18), .O(new_n136_));
  inv1   g084(.a(x08), .O(new_n137_));
  nand2  g085(.a(new_n60_), .b(new_n137_), .O(new_n138_));
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n135_), .O(new_n139_));
  nand2  g087(.a(x31), .b(new_n54_), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n86_), .O(new_n141_));
  aoi21  g089(.a(new_n139_), .b(x19), .c(new_n141_), .O(z11));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n58_), .O(new_n153_));
  ...
  nand4  g105(.a(new_n157_), .b(x19), .c(x18), .d(new_n135_), .O(new_n158_));
  inv1   g106(.a(x34), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n54_), .O(new_n160_));
  nand4  g108(.a(x19), .b(new_n60_), .c(new_n135_), .d(x13), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  and2   g110(.a(new_n162_), .b(new_n86_), .O(z14));
  nand4  g111(.a(new_n114_), .b(x19), .c(x18), .d(new_n135_), .O(new_n164_));
  nand2  g112(.a(new_n157_), .b(new_n54_), .O(new_n165_));
  nand4  g113(.a(x19), .b(new_n60_), .c(new_n135_), .d(x12), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  and2   g115(.a(new_n167_), .b(new_n86_), .O(z15));
endmodule
