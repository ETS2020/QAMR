// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:52 2020
...
module FAU ( 
  ...
  nand3  g026(.a(new_n78_), .b(new_n76_), .c(new_n63_), .O(z02));
  nor2   g027(.a(new_n57_), .b(x16), .O(new_n80_));
  oai21  g028(.a(x18), .b(x00), .c(new_n55_), .O(new_n81_));
  nor2   g029(.a(x23), .b(x19), .O(new_n82_));
  nor2   g030(.a(new_n82_), .b(new_n65_), .O(new_n83_));
  oai21  g031(.a(new_n81_), .b(new_n80_), .c(new_n83_), .O(z03));
  ...
  nand3  g038(.a(new_n90_), .b(new_n88_), .c(new_n63_), .O(z04));
  ...
  aoi21  g045(.a(new_n97_), .b(new_n93_), .c(new_n65_), .O(z05));
  nand2  g046(.a(x27), .b(x18), .O(new_n99_));
  inv1   g047(.a(x05), .O(new_n100_));
  nand2  g048(.a(new_n57_), .b(new_n100_), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n55_), .O(new_n102_));
  inv1   g050(.a(x26), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n54_), .O(new_n104_));
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n63_), .O(z06));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n107_), .c(new_n65_), .O(z07));
  ...
  aoi21  g066(.a(new_n118_), .b(new_n114_), .c(new_n65_), .O(z08));
  ...
  aoi21  g073(.a(new_n125_), .b(new_n121_), .c(new_n65_), .O(z09));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n63_), .O(z10));
  ...
  inv1   g088(.a(new_n55_), .O(new_n141_));
  nor2   g089(.a(x35), .b(new_n57_), .O(new_n142_));
  inv1   g090(.a(x15), .O(new_n143_));
  nor2   g091(.a(x18), .b(new_n143_), .O(new_n144_));
  aoi22  g092(.a(new_n144_), .b(new_n63_), .c(new_n142_), .d(new_n62_), .O(new_n145_));
  nor2   g093(.a(x32), .b(x19), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n63_), .O(new_n147_));
  oai21  g095(.a(new_n145_), .b(new_n141_), .c(new_n147_), .O(z12));
  inv1   g096(.a(x34), .O(new_n149_));
  inv1   g097(.a(x14), .O(new_n150_));
  aoi21  g098(.a(new_n57_), .b(new_n150_), .c(x17), .O(new_n151_));
  oai21  g099(.a(new_n149_), .b(new_n57_), .c(new_n151_), .O(new_n152_));
  oai21  g100(.a(new_n62_), .b(x19), .c(new_n63_), .O(new_n153_));
  aoi21  g101(.a(new_n152_), .b(x19), .c(new_n153_), .O(z13));
  inv1   g102(.a(x13), .O(new_n155_));
  nor2   g103(.a(x18), .b(new_n155_), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n142_), .c(new_n55_), .O(new_n157_));
  nand2  g105(.a(new_n149_), .b(new_n54_), .O(new_n158_));
  nand3  g106(.a(new_n158_), .b(new_n157_), .c(new_n63_), .O(z14));
  inv1   g107(.a(x35), .O(new_n160_));
  aoi21  g108(.a(x33), .b(x19), .c(new_n160_), .O(new_n161_));
  inv1   g109(.a(x12), .O(new_n162_));
  aoi21  g110(.a(new_n57_), .b(new_n162_), .c(x17), .O(new_n163_));
  oai21  g111(.a(new_n113_), .b(new_n57_), .c(new_n163_), .O(new_n164_));
  aoi21  g112(.a(new_n164_), .b(x19), .c(new_n161_), .O(z15));
endmodule
