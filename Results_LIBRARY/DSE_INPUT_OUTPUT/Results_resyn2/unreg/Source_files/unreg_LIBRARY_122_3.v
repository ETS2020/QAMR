...
module FAU ( 
  ...
  aoi21  g11(.a(new_n63_), .b(new_n60_), .c(x10), .O(new_n64_));
  ...
  oai22  g17(.a(new_n69_), .b(new_n55_), .c(x22), .d(x19), .O(z02));
  ...
  aoi21  g22(.a(new_n74_), .b(new_n72_), .c(x10), .O(new_n75_));
  inv1   g23(.a(x23), .O(new_n76_));
  nand2  g24(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  oai21  g25(.a(new_n75_), .b(new_n59_), .c(new_n77_), .O(z03));
  nand2  g26(.a(x25), .b(x18), .O(new_n79_));
  inv1   g27(.a(x07), .O(new_n80_));
  aoi21  g28(.a(new_n62_), .b(new_n80_), .c(x17), .O(new_n81_));
  aoi21  g29(.a(new_n81_), .b(new_n79_), .c(x10), .O(new_n82_));
  ...
  aoi21  g36(.a(new_n88_), .b(new_n86_), .c(x10), .O(new_n89_));
  inv1   g37(.a(x25), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n59_), .O(new_n91_));
  oai21  g39(.a(new_n89_), .b(new_n59_), .c(new_n91_), .O(z05));
  nand2  g40(.a(x27), .b(x18), .O(new_n93_));
  inv1   g41(.a(x05), .O(new_n94_));
  aoi21  g42(.a(new_n62_), .b(new_n94_), .c(x17), .O(new_n95_));
  aoi21  g43(.a(new_n95_), .b(new_n93_), .c(x10), .O(new_n96_));
  inv1   g44(.a(x26), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n59_), .c(new_n98_), .O(z06));
  nand2  g47(.a(x20), .b(x18), .O(new_n100_));
  oai21  g48(.a(x18), .b(x04), .c(new_n100_), .O(new_n101_));
  oai22  g49(.a(new_n101_), .b(new_n55_), .c(x27), .d(x19), .O(z07));
  ...
  oai21  g56(.a(new_n106_), .b(new_n59_), .c(new_n108_), .O(z08));
  inv1   g57(.a(x30), .O(new_n110_));
  nand3  g58(.a(new_n110_), .b(x18), .c(new_n54_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n53_), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(x19), .O(new_n113_));
  oai21  g61(.a(x29), .b(x19), .c(new_n113_), .O(z09));
  nand2  g62(.a(x31), .b(x18), .O(new_n115_));
  oai21  g63(.a(x18), .b(x09), .c(new_n115_), .O(new_n116_));
  oai22  g64(.a(new_n116_), .b(new_n55_), .c(x30), .d(x19), .O(z10));
  nand2  g65(.a(x24), .b(x18), .O(new_n118_));
  inv1   g66(.a(x08), .O(new_n119_));
  aoi21  g67(.a(new_n62_), .b(new_n119_), .c(x17), .O(new_n120_));
  aoi21  g68(.a(new_n120_), .b(new_n118_), .c(x10), .O(new_n121_));
  inv1   g69(.a(x31), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n59_), .O(new_n123_));
  oai21  g71(.a(new_n121_), .b(new_n59_), .c(new_n123_), .O(z11));
  nand2  g72(.a(x33), .b(x18), .O(new_n125_));
  inv1   g73(.a(x15), .O(new_n126_));
  aoi21  g74(.a(new_n62_), .b(new_n126_), .c(x17), .O(new_n127_));
  aoi21  g75(.a(new_n127_), .b(new_n125_), .c(x10), .O(new_n128_));
  inv1   g76(.a(x32), .O(new_n129_));
  nand2  g77(.a(new_n129_), .b(new_n59_), .O(new_n130_));
  oai21  g78(.a(new_n128_), .b(new_n59_), .c(new_n130_), .O(z12));
  nand2  g79(.a(x34), .b(x18), .O(new_n132_));
  oai21  g80(.a(x18), .b(x14), .c(new_n132_), .O(new_n133_));
  oai22  g81(.a(new_n133_), .b(new_n55_), .c(x33), .d(x19), .O(z13));
  nand2  g82(.a(x35), .b(x18), .O(new_n135_));
  inv1   g83(.a(x13), .O(new_n136_));
  aoi21  g84(.a(new_n62_), .b(new_n136_), .c(x17), .O(new_n137_));
  aoi21  g85(.a(new_n137_), .b(new_n135_), .c(x10), .O(new_n138_));
  inv1   g86(.a(x34), .O(new_n139_));
  nand2  g87(.a(new_n139_), .b(new_n59_), .O(new_n140_));
  oai21  g88(.a(new_n138_), .b(new_n59_), .c(new_n140_), .O(z14));
  nand2  g89(.a(x28), .b(x18), .O(new_n142_));
  inv1   g90(.a(x12), .O(new_n143_));
  aoi21  g91(.a(new_n62_), .b(new_n143_), .c(x17), .O(new_n144_));
  aoi21  g92(.a(new_n144_), .b(new_n142_), .c(x10), .O(new_n145_));
  inv1   g93(.a(x35), .O(new_n146_));
  nand2  g94(.a(new_n146_), .b(new_n59_), .O(new_n147_));
  oai21  g95(.a(new_n145_), .b(new_n59_), .c(new_n147_), .O(z15));
endmodule
