...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x29), .O(new_n54_));
  ...
  nand2  g022(.a(new_n74_), .b(new_n56_), .O(new_n75_));
  nand2  g023(.a(x23), .b(x18), .O(new_n76_));
  inv1   g024(.a(x01), .O(new_n77_));
  nand2  g025(.a(new_n62_), .b(new_n77_), .O(new_n78_));
  nand4  g026(.a(new_n78_), .b(new_n76_), .c(x19), .d(new_n59_), .O(new_n79_));
  aoi21  g027(.a(new_n79_), .b(new_n75_), .c(new_n55_), .O(z02));
  ...
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n66_), .O(new_n113_));
  ...
  oai21  g064(.a(new_n53_), .b(x18), .c(x29), .O(new_n117_));
  inv1   g065(.a(x11), .O(new_n118_));
  nand2  g066(.a(new_n62_), .b(new_n118_), .O(new_n119_));
  nand3  g067(.a(new_n119_), .b(new_n117_), .c(new_n66_), .O(new_n120_));
  ...
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n66_), .O(new_n127_));
  ...
  nand4  g083(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n59_), .O(new_n136_));
  ...
  nand3  g088(.a(new_n140_), .b(new_n138_), .c(new_n66_), .O(new_n141_));
  ...
  oai21  g092(.a(x29), .b(new_n56_), .c(new_n53_), .O(new_n145_));
  nand2  g093(.a(x33), .b(x18), .O(new_n146_));
  inv1   g094(.a(x15), .O(new_n147_));
  nand2  g095(.a(new_n62_), .b(new_n147_), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n146_), .c(new_n66_), .O(new_n149_));
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n54_), .O(z13));
  ...
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n59_), .O(new_n163_));
  aoi21  g111(.a(new_n163_), .b(new_n159_), .c(new_n55_), .O(z14));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n62_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n66_), .O(new_n168_));
  inv1   g116(.a(x35), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n56_), .O(new_n170_));
  nand3  g118(.a(new_n170_), .b(new_n168_), .c(new_n54_), .O(z15));
endmodule
