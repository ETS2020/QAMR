...
module FAU ( 
  ...
  nand2  g019(.a(x34), .b(x22), .O(new_n72_));
  ...
  nand2  g055(.a(x34), .b(x27), .O(new_n108_));
  ...
  nand2  g099(.a(x19), .b(new_n61_), .O(new_n152_));
  inv1   g100(.a(x33), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n58_), .c(new_n54_), .O(new_n154_));
  aoi22  g102(.a(new_n154_), .b(new_n152_), .c(new_n151_), .d(x19), .O(z13));
  nand2  g103(.a(x35), .b(x18), .O(new_n156_));
  inv1   g104(.a(x13), .O(new_n157_));
  nand2  g105(.a(new_n61_), .b(new_n157_), .O(new_n158_));
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n59_), .O(new_n159_));
  inv1   g107(.a(new_n159_), .O(z14));
  nand2  g108(.a(x35), .b(x34), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n58_), .O(new_n162_));
  nand2  g110(.a(x28), .b(x18), .O(new_n163_));
  inv1   g111(.a(x12), .O(new_n164_));
  nand2  g112(.a(new_n61_), .b(new_n164_), .O(new_n165_));
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n59_), .O(new_n166_));
