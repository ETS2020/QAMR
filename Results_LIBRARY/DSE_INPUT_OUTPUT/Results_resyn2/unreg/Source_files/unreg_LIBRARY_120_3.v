...
module FAU ( 
  ...
  and2   g000(.a(x35), .b(x08), .O(new_n53_));
  ...
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n53_), .O(z10));
  inv1   g082(.a(x35), .O(new_n135_));
  inv1   g083(.a(x17), .O(new_n136_));
  nand3  g084(.a(x19), .b(new_n60_), .c(new_n136_), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(x08), .O(new_n139_));
  nor2   g087(.a(x31), .b(x19), .O(new_n140_));
  nor2   g088(.a(x24), .b(new_n60_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n58_), .c(new_n140_), .O(new_n142_));
  ...
  nor2   g096(.a(new_n148_), .b(new_n53_), .O(new_n149_));
  ...
  nor2   g103(.a(new_n155_), .b(new_n53_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n154_), .O(z13));
  inv1   g105(.a(x13), .O(new_n158_));
  nand2  g106(.a(new_n60_), .b(new_n158_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n136_), .c(new_n54_), .O(new_n160_));
  nand2  g108(.a(x34), .b(new_n54_), .O(new_n161_));
  aoi21  g109(.a(x19), .b(x18), .c(x08), .O(new_n162_));
  oai21  g110(.a(new_n162_), .b(new_n135_), .c(new_n161_), .O(new_n163_));
  nor2   g111(.a(new_n163_), .b(new_n160_), .O(z14));
  ...
  aoi21  g116(.a(new_n135_), .b(new_n54_), .c(new_n53_), .O(new_n169_));
