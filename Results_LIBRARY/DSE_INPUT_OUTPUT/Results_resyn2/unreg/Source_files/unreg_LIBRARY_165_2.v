...
module FAU ( 
  ...
  nand2  g036(.a(new_n57_), .b(new_n61_), .O(new_n89_));
  nand3  g037(.a(new_n89_), .b(new_n88_), .c(new_n67_), .O(new_n90_));
  inv1   g038(.a(x24), .O(new_n91_));
  oai22  g039(.a(x32), .b(new_n61_), .c(new_n91_), .d(x19), .O(new_n92_));
  aoi21  g040(.a(new_n90_), .b(x19), .c(new_n92_), .O(z04));
  ...
  oai21  g091(.a(new_n54_), .b(x07), .c(new_n143_), .O(new_n144_));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n67_), .O(new_n162_));
