...
module FAU ( 
  ...
  nand4  g083(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n68_), .O(new_n136_));
  ...
  oai21  g093(.a(x18), .b(x15), .c(new_n68_), .O(new_n146_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n68_), .O(new_n152_));
  ...
  nor2   g113(.a(new_n165_), .b(new_n63_), .O(new_n166_));
