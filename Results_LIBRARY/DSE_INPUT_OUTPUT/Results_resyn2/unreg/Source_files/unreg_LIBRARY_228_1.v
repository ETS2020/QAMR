...
module FAU ( 
  ...
  nor2   g075(.a(new_n127_), .b(new_n64_), .O(new_n128_));
  ...
  nor2   g089(.a(new_n141_), .b(new_n64_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n140_), .O(z11));
  aoi21  g091(.a(x20), .b(x19), .c(new_n63_), .O(new_n144_));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n64_), .O(z13));
