// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:23 2020
...
module FAU ( 
  ...
  nand3  g017(.a(new_n69_), .b(new_n67_), .c(new_n58_), .O(new_n70_));
  aoi21  g018(.a(new_n70_), .b(new_n66_), .c(new_n64_), .O(z01));
  ...
  nor2   g024(.a(new_n76_), .b(new_n64_), .O(new_n77_));
  ...
  nor2   g031(.a(new_n83_), .b(new_n64_), .O(new_n84_));
  ...
  aoi21  g039(.a(new_n91_), .b(new_n87_), .c(new_n64_), .O(z04));
  ...
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n58_), .O(new_n98_));
  aoi21  g046(.a(new_n98_), .b(new_n94_), .c(new_n64_), .O(z05));
  inv1   g047(.a(new_n64_), .O(new_n100_));
  inv1   g048(.a(x17), .O(new_n101_));
  inv1   g049(.a(x27), .O(new_n102_));
  nand4  g050(.a(new_n102_), .b(x19), .c(x18), .d(new_n101_), .O(new_n103_));
  inv1   g051(.a(x26), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n53_), .O(new_n105_));
  nand4  g053(.a(x19), .b(new_n60_), .c(new_n101_), .d(x05), .O(new_n106_));
  nand3  g054(.a(new_n106_), .b(new_n105_), .c(new_n103_), .O(new_n107_));
  and2   g055(.a(new_n107_), .b(new_n100_), .O(z06));
  nand4  g056(.a(new_n54_), .b(x19), .c(x18), .d(new_n101_), .O(new_n109_));
  nand2  g057(.a(new_n102_), .b(new_n53_), .O(new_n110_));
  nand4  g058(.a(x19), .b(new_n60_), .c(new_n101_), .d(x04), .O(new_n111_));
  nand3  g059(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  and2   g060(.a(new_n112_), .b(new_n100_), .O(z07));
  nand2  g061(.a(x29), .b(x18), .O(new_n114_));
  inv1   g062(.a(x11), .O(new_n115_));
  nand2  g063(.a(new_n60_), .b(new_n115_), .O(new_n116_));
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n58_), .O(new_n117_));
  nor2   g065(.a(x28), .b(x19), .O(new_n118_));
  nor2   g066(.a(new_n118_), .b(new_n64_), .O(new_n119_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n58_), .O(new_n124_));
  nor2   g072(.a(x29), .b(x19), .O(new_n125_));
  nor2   g073(.a(new_n125_), .b(new_n64_), .O(new_n126_));
  nand2  g074(.a(new_n126_), .b(new_n124_), .O(z09));
  nand2  g075(.a(x31), .b(x18), .O(new_n128_));
  inv1   g076(.a(x09), .O(new_n129_));
  nand2  g077(.a(new_n60_), .b(new_n129_), .O(new_n130_));
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n58_), .O(new_n131_));
  nor2   g079(.a(x30), .b(x19), .O(new_n132_));
  nor2   g080(.a(new_n132_), .b(new_n64_), .O(new_n133_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n58_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n64_), .O(z11));
  oai21  g089(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(new_n142_));
  nand2  g090(.a(x33), .b(x18), .O(new_n143_));
  inv1   g091(.a(x15), .O(new_n144_));
  nand2  g092(.a(new_n60_), .b(new_n144_), .O(new_n145_));
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n58_), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n142_), .O(z12));
  nand2  g095(.a(x34), .b(x18), .O(new_n148_));
  inv1   g096(.a(x14), .O(new_n149_));
  nand2  g097(.a(new_n60_), .b(new_n149_), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n58_), .O(new_n151_));
  nor2   g099(.a(x33), .b(x19), .O(new_n152_));
  nor2   g100(.a(new_n152_), .b(new_n64_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n58_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n64_), .O(z14));
  ...
  nor2   g114(.a(new_n166_), .b(new_n64_), .O(new_n167_));
