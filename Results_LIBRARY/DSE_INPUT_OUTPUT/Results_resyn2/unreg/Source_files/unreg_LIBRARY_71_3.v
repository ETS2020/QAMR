// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:51 2020
...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x30), .O(new_n61_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n96_), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(new_n95_), .c(new_n62_), .O(z05));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n96_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n96_), .O(new_n114_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n96_), .O(new_n141_));
  ...
  aoi21  g094(.a(new_n131_), .b(new_n54_), .c(new_n62_), .O(new_n147_));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n96_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n96_), .O(new_n168_));
