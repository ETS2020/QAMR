// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:42 2020
...
module FAU ( 
  ...
  oai21  g034(.a(new_n86_), .b(new_n54_), .c(new_n85_), .O(new_n87_));
  ...
  oai21  g047(.a(new_n85_), .b(new_n54_), .c(new_n86_), .O(new_n100_));
  ...
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n58_), .O(new_n116_));
  ...
  inv1   g074(.a(new_n53_), .O(new_n127_));
  inv1   g075(.a(x17), .O(new_n128_));
  inv1   g076(.a(x31), .O(new_n129_));
  nand4  g077(.a(new_n129_), .b(x19), .c(x18), .d(new_n128_), .O(new_n130_));
  inv1   g078(.a(x30), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(new_n54_), .O(new_n132_));
  nand4  g080(.a(x19), .b(new_n60_), .c(new_n128_), .d(x09), .O(new_n133_));
  nand3  g081(.a(new_n133_), .b(new_n132_), .c(new_n130_), .O(new_n134_));
  and2   g082(.a(new_n134_), .b(new_n127_), .O(z10));
  nand4  g083(.a(new_n85_), .b(x19), .c(x18), .d(new_n128_), .O(new_n136_));
  nand2  g084(.a(new_n129_), .b(new_n54_), .O(new_n137_));
  nand4  g085(.a(x19), .b(new_n60_), .c(new_n128_), .d(x08), .O(new_n138_));
  nand3  g086(.a(new_n138_), .b(new_n137_), .c(new_n136_), .O(new_n139_));
  and2   g087(.a(new_n139_), .b(new_n127_), .O(z11));
