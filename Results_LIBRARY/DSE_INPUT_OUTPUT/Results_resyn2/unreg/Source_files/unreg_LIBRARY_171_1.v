...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x25), .O(new_n54_));
  ...
  oai21  g043(.a(x32), .b(new_n55_), .c(new_n95_), .O(new_n96_));
  nand2  g044(.a(x26), .b(x18), .O(new_n97_));
  inv1   g045(.a(x06), .O(new_n98_));
  nand2  g046(.a(new_n61_), .b(new_n98_), .O(new_n99_));
  nand3  g047(.a(new_n99_), .b(new_n97_), .c(new_n79_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n96_), .O(z05));
  ...
  aoi21  g091(.a(x25), .b(x19), .c(new_n53_), .O(new_n144_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n79_), .O(new_n151_));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n79_), .O(new_n158_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n79_), .O(new_n165_));
