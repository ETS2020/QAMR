...
module FAU ( 
  ...
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n66_), .O(new_n105_));
  ...
  nand2  g063(.a(new_n92_), .b(new_n56_), .O(new_n116_));
  ...
  nand3  g068(.a(new_n120_), .b(new_n116_), .c(new_n54_), .O(z08));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n59_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n55_), .O(z09));
  ...
  nor2   g083(.a(x28), .b(x24), .O(new_n136_));
  aoi21  g084(.a(x24), .b(new_n62_), .c(new_n136_), .O(new_n137_));
  inv1   g085(.a(x08), .O(new_n138_));
  nand2  g086(.a(new_n62_), .b(new_n138_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n66_), .O(new_n140_));
  nor2   g088(.a(x31), .b(x19), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n54_), .O(new_n142_));
  oai21  g090(.a(new_n140_), .b(new_n137_), .c(new_n142_), .O(z11));
  ...
  nand3  g097(.a(new_n149_), .b(new_n147_), .c(new_n54_), .O(z12));
