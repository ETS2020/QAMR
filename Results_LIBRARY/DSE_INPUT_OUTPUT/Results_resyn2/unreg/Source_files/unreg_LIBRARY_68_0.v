...
module FAU ( 
  ...
  nand3  g008(.a(x35), .b(new_n53_), .c(new_n56_), .O(new_n61_));
  ...
  nand3  g019(.a(new_n71_), .b(new_n68_), .c(new_n57_), .O(new_n72_));
  nor2   g020(.a(x35), .b(x20), .O(new_n73_));
  nor2   g021(.a(x22), .b(x19), .O(new_n74_));
  nor2   g022(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n72_), .O(z02));
  ...
  aoi21  g032(.a(new_n84_), .b(new_n78_), .c(new_n73_), .O(z03));
  ...
  nor2   g038(.a(new_n90_), .b(new_n73_), .O(new_n91_));
  ...
  aoi21  g046(.a(new_n98_), .b(new_n94_), .c(new_n73_), .O(z05));
  ...
  nor2   g052(.a(new_n104_), .b(new_n73_), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n103_), .O(z06));
  nand2  g054(.a(x20), .b(x18), .O(new_n107_));
  inv1   g055(.a(x04), .O(new_n108_));
  nand2  g056(.a(new_n70_), .b(new_n108_), .O(new_n109_));
  nand3  g057(.a(new_n109_), .b(new_n107_), .c(new_n79_), .O(new_n110_));
  nand2  g058(.a(x27), .b(new_n56_), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n55_), .O(new_n112_));
  aoi21  g060(.a(new_n110_), .b(x19), .c(new_n112_), .O(z07));
