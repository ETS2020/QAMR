...
module FAU ( 
  ...
  oai21  g057(.a(x28), .b(new_n54_), .c(new_n62_), .O(new_n110_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n68_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n65_), .O(z12));
  ...
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n68_), .O(new_n163_));
  aoi21  g111(.a(new_n163_), .b(new_n159_), .c(new_n65_), .O(z14));
