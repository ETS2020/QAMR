...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n64_, new_n66_, new_n68_, new_n70_, new_n71_, new_n72_,
  ...
  nand4  g11(.a(x19), .b(new_n59_), .c(new_n54_), .d(x00), .O(new_n64_));
  oai21  g12(.a(x23), .b(x19), .c(new_n64_), .O(z03));
  nand4  g13(.a(x19), .b(new_n59_), .c(new_n54_), .d(x07), .O(new_n66_));
  oai21  g14(.a(x24), .b(x19), .c(new_n66_), .O(z04));
  nand4  g15(.a(x19), .b(new_n59_), .c(new_n54_), .d(x06), .O(new_n68_));
  oai21  g16(.a(x25), .b(x19), .c(new_n68_), .O(z05));
  aoi21  g17(.a(new_n54_), .b(x05), .c(x18), .O(new_n70_));
  inv1   g18(.a(x26), .O(new_n71_));
  nand2  g19(.a(new_n71_), .b(new_n53_), .O(new_n72_));
  oai21  g20(.a(new_n70_), .b(new_n53_), .c(new_n72_), .O(z06));
  aoi21  g21(.a(new_n54_), .b(x04), .c(x18), .O(new_n74_));
  inv1   g22(.a(x27), .O(new_n75_));
  nand2  g23(.a(new_n75_), .b(new_n53_), .O(new_n76_));
  oai21  g24(.a(new_n74_), .b(new_n53_), .c(new_n76_), .O(z07));
  ...
  nand4  g51(.a(x19), .b(new_n59_), .c(new_n54_), .d(x12), .O(new_n104_));
