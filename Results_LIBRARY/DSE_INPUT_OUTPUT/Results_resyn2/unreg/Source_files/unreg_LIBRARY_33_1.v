// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:31 2020
...
module FAU ( 
  ...
  nand2  g019(.a(new_n63_), .b(new_n55_), .O(new_n72_));
  nand2  g020(.a(x23), .b(x18), .O(new_n73_));
  oai21  g021(.a(x18), .b(x01), .c(new_n73_), .O(new_n74_));
  inv1   g022(.a(x35), .O(new_n75_));
  nand3  g023(.a(new_n75_), .b(new_n62_), .c(new_n54_), .O(new_n76_));
  oai21  g024(.a(new_n74_), .b(new_n72_), .c(new_n76_), .O(z02));
  inv1   g025(.a(x00), .O(new_n78_));
  nand2  g026(.a(new_n57_), .b(new_n78_), .O(new_n79_));
  ...
  nand2  g031(.a(new_n83_), .b(new_n63_), .O(new_n84_));
  oai21  g032(.a(new_n82_), .b(new_n72_), .c(new_n84_), .O(z03));
  inv1   g033(.a(new_n63_), .O(new_n86_));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n86_), .O(z07));
  ...
  oai21  g105(.a(new_n62_), .b(x18), .c(x35), .O(new_n158_));
  ...
  aoi21  g112(.a(x22), .b(x19), .c(new_n75_), .O(new_n165_));
  nand2  g113(.a(x28), .b(x18), .O(new_n166_));
  inv1   g114(.a(x12), .O(new_n167_));
  nand2  g115(.a(new_n57_), .b(new_n167_), .O(new_n168_));
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n89_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(x19), .c(new_n165_), .O(z15));
endmodule
