...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x24), .O(new_n53_));
  ...
  nand3  g040(.a(new_n92_), .b(new_n90_), .c(new_n71_), .O(new_n93_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n57_), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n53_), .O(z05));
  nand2  g049(.a(x27), .b(x18), .O(new_n102_));
  inv1   g050(.a(x05), .O(new_n103_));
  nand2  g051(.a(new_n60_), .b(new_n103_), .O(new_n104_));
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n71_), .O(new_n105_));
  nor2   g053(.a(x26), .b(x19), .O(new_n106_));
  nor2   g054(.a(new_n106_), .b(new_n53_), .O(new_n107_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n71_), .O(new_n112_));
