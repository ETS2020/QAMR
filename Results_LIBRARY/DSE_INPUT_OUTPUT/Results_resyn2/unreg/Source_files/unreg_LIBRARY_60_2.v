...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x31), .O(new_n54_));
  ...
  oai21  g078(.a(new_n53_), .b(x18), .c(x31), .O(new_n131_));
  ...
  nand2  g103(.a(x33), .b(new_n56_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n54_), .O(new_n157_));
  aoi21  g105(.a(new_n155_), .b(x19), .c(new_n157_), .O(z13));
  oai21  g106(.a(x31), .b(new_n56_), .c(new_n53_), .O(new_n159_));
