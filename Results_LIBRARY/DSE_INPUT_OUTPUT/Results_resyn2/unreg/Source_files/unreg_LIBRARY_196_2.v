...
module FAU ( 
  ...
  nor2   g009(.a(x28), .b(new_n61_), .O(new_n62_));
  ...
  nand2  g014(.a(new_n66_), .b(x28), .O(new_n67_));
  ...
  nor2   g063(.a(new_n54_), .b(x02), .O(new_n116_));
  ...
  oai21  g068(.a(new_n116_), .b(x28), .c(new_n120_), .O(z08));
