...
module FAU ( 
  ...
  nand3  g054(.a(new_n106_), .b(new_n104_), .c(new_n60_), .O(new_n107_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n60_), .O(new_n126_));
  inv1   g074(.a(x29), .O(new_n127_));
  nand2  g075(.a(new_n127_), .b(new_n56_), .O(new_n128_));
  nand3  g076(.a(new_n128_), .b(new_n126_), .c(new_n54_), .O(z09));
  ...
  nand3  g083(.a(new_n135_), .b(new_n133_), .c(new_n54_), .O(z10));
  ...
  nand3  g089(.a(new_n141_), .b(new_n139_), .c(new_n60_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n55_), .O(z11));
  inv1   g091(.a(new_n60_), .O(new_n144_));
  nor2   g092(.a(x35), .b(new_n62_), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nor2   g094(.a(x18), .b(new_n146_), .O(new_n147_));
  aoi22  g095(.a(new_n147_), .b(new_n54_), .c(new_n145_), .d(new_n53_), .O(new_n148_));
  nor2   g096(.a(x32), .b(x19), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n54_), .O(new_n150_));
  oai21  g098(.a(new_n148_), .b(new_n144_), .c(new_n150_), .O(z12));
  inv1   g099(.a(x35), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n56_), .O(new_n153_));
  nand2  g101(.a(new_n60_), .b(new_n54_), .O(new_n154_));
  nand2  g102(.a(x34), .b(x18), .O(new_n155_));
  oai21  g103(.a(x18), .b(x14), .c(new_n155_), .O(new_n156_));
  oai22  g104(.a(new_n156_), .b(new_n154_), .c(new_n153_), .d(x33), .O(z13));
  inv1   g105(.a(x13), .O(new_n158_));
  nor2   g106(.a(x18), .b(new_n158_), .O(new_n159_));
  oai21  g107(.a(new_n159_), .b(new_n145_), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g115(.a(new_n167_), .b(new_n153_), .c(new_n54_), .O(z15));
endmodule
