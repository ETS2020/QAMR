...
module FAU ( 
  ...
  nand3  g11(.a(x19), .b(new_n63_), .c(x12), .O(new_n64_));
  ...
  aoi21  g86(.a(new_n57_), .b(new_n138_), .c(x17), .O(new_n139_));
  aoi21  g87(.a(new_n139_), .b(new_n137_), .c(new_n54_), .O(new_n140_));
  inv1   g88(.a(x34), .O(new_n141_));
  nand2  g89(.a(new_n141_), .b(new_n53_), .O(new_n142_));
  oai21  g90(.a(new_n140_), .b(new_n53_), .c(new_n142_), .O(z14));
  oai21  g91(.a(new_n111_), .b(new_n57_), .c(new_n63_), .O(new_n144_));
  nor2   g92(.a(new_n53_), .b(new_n54_), .O(new_n145_));
  aoi22  g93(.a(new_n145_), .b(new_n144_), .c(x35), .d(new_n53_), .O(z15));
endmodule
