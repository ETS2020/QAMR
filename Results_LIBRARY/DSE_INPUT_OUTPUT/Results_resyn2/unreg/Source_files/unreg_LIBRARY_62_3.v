...
module FAU ( 
  ...
  nand3  g029(.a(new_n81_), .b(new_n79_), .c(new_n66_), .O(new_n82_));
  nor2   g030(.a(x23), .b(x19), .O(new_n83_));
  nor2   g031(.a(new_n83_), .b(new_n55_), .O(new_n84_));
  ...
  nand3  g057(.a(new_n109_), .b(new_n107_), .c(new_n66_), .O(new_n110_));
