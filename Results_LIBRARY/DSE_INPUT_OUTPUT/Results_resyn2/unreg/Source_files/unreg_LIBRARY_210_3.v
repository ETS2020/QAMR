...
module FAU ( 
  ...
  aoi21  g064(.a(new_n54_), .b(x19), .c(new_n53_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n109_), .O(new_n124_));
  ...
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n109_), .O(new_n131_));
  ...
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n109_), .O(new_n138_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n109_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n109_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n109_), .O(new_n165_));
