...
module FAU ( 
  ...
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n65_), .O(z11));
  ...
  aoi21  g103(.a(x28), .b(x19), .c(new_n120_), .O(new_n156_));
  nand2  g104(.a(x35), .b(x18), .O(new_n157_));
  inv1   g105(.a(x13), .O(new_n158_));
  nand2  g106(.a(new_n57_), .b(new_n158_), .O(new_n159_));
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n68_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(x19), .c(new_n156_), .O(z14));
