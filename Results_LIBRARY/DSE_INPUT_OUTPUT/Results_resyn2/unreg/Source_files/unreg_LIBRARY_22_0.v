...
module FAU ( 
  ...
  inv1   g032(.a(new_n61_), .O(new_n85_));
  ...
  nand4  g038(.a(x19), .b(new_n57_), .c(new_n86_), .d(x07), .O(new_n91_));
  ...
  nand2  g103(.a(new_n85_), .b(new_n55_), .O(new_n156_));
  nand2  g104(.a(x35), .b(x18), .O(new_n157_));
  oai21  g105(.a(x18), .b(x13), .c(new_n157_), .O(new_n158_));
  nand3  g106(.a(new_n100_), .b(x26), .c(new_n54_), .O(new_n159_));
  oai21  g107(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(z14));
  nand2  g108(.a(x28), .b(x18), .O(new_n161_));
  oai21  g109(.a(x18), .b(x12), .c(new_n161_), .O(new_n162_));
  nor2   g110(.a(x35), .b(x19), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n85_), .O(new_n164_));
  oai21  g112(.a(new_n162_), .b(new_n156_), .c(new_n164_), .O(z15));
endmodule
