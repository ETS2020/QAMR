...
module FAU ( 
  ...
  nor2   g008(.a(x28), .b(x26), .O(new_n61_));
  ...
  oai21  g062(.a(new_n100_), .b(new_n54_), .c(new_n101_), .O(new_n115_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n94_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n94_), .O(new_n154_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n94_), .O(new_n168_));
