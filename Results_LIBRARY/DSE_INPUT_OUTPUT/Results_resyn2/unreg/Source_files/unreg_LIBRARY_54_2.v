...
module FAU ( 
  ...
  aoi21  g079(.a(x33), .b(x19), .c(new_n131_), .O(new_n132_));
  nand2  g080(.a(x31), .b(x18), .O(new_n133_));
  inv1   g081(.a(x09), .O(new_n134_));
  nand2  g082(.a(new_n57_), .b(new_n134_), .O(new_n135_));
  nand3  g083(.a(new_n135_), .b(new_n133_), .c(new_n75_), .O(new_n136_));
  aoi21  g084(.a(new_n136_), .b(x19), .c(new_n132_), .O(z10));
  ...
  nor2   g101(.a(x33), .b(x30), .O(new_n154_));
  aoi21  g102(.a(x33), .b(x19), .c(new_n154_), .O(new_n155_));
