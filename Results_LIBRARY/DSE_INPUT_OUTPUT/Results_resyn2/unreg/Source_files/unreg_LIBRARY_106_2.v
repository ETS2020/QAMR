...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x13), .O(new_n63_));
  ...
  aoi21  g034(.a(new_n86_), .b(new_n81_), .c(new_n79_), .O(z03));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n79_), .O(z04));
  ...
  nand4  g064(.a(x19), .b(new_n57_), .c(new_n116_), .d(x11), .O(new_n117_));
  inv1   g065(.a(x29), .O(new_n118_));
  nand4  g066(.a(new_n118_), .b(x19), .c(x18), .d(new_n116_), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n54_), .O(new_n121_));
  nand3  g069(.a(new_n121_), .b(new_n119_), .c(new_n117_), .O(new_n122_));
  and2   g070(.a(new_n122_), .b(new_n63_), .O(z08));
  nand4  g071(.a(x19), .b(new_n57_), .c(new_n116_), .d(x10), .O(new_n124_));
  nand4  g072(.a(new_n62_), .b(x19), .c(x18), .d(new_n116_), .O(new_n125_));
  nand2  g073(.a(new_n118_), .b(new_n54_), .O(new_n126_));
  nand3  g074(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  and2   g075(.a(new_n127_), .b(new_n63_), .O(z09));
  oai21  g076(.a(new_n54_), .b(x13), .c(new_n62_), .O(new_n129_));
  ...
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n79_), .O(z12));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n116_), .O(new_n159_));
  nand2  g107(.a(x34), .b(new_n54_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n63_), .O(new_n161_));
  aoi21  g109(.a(new_n159_), .b(x19), .c(new_n161_), .O(z14));
  ...
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n79_), .O(z15));
endmodule
