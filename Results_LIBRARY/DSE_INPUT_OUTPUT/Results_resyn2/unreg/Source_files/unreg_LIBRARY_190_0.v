...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x05), .O(new_n61_));
  ...
  aoi21  g048(.a(x32), .b(x18), .c(x05), .O(new_n101_));
  nand2  g049(.a(x27), .b(x18), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(x19), .c(new_n66_), .O(new_n103_));
  inv1   g051(.a(x26), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n54_), .O(new_n105_));
  oai22  g053(.a(new_n105_), .b(new_n61_), .c(new_n103_), .d(new_n101_), .O(z06));
  ...
  nand2  g090(.a(x19), .b(x05), .O(new_n143_));
