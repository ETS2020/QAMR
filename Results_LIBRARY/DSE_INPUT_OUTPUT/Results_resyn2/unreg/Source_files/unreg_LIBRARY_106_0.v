...
module FAU ( 
  ...
  inv1   g027(.a(new_n64_), .O(new_n80_));
  ...
  aoi21  g035(.a(new_n87_), .b(new_n82_), .c(new_n80_), .O(z03));
  ...
  aoi21  g042(.a(new_n94_), .b(new_n90_), .c(new_n80_), .O(z04));
  ...
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n64_), .O(z05));
  ...
  nand4  g066(.a(new_n118_), .b(x19), .c(x18), .d(new_n117_), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n54_), .O(new_n121_));
  nand4  g069(.a(x19), .b(new_n57_), .c(new_n117_), .d(x11), .O(new_n122_));
  nand3  g070(.a(new_n122_), .b(new_n121_), .c(new_n119_), .O(new_n123_));
  and2   g071(.a(new_n123_), .b(new_n64_), .O(z08));
  aoi21  g072(.a(x30), .b(x18), .c(x17), .O(new_n125_));
  oai21  g073(.a(x18), .b(x10), .c(new_n125_), .O(new_n126_));
  oai21  g074(.a(new_n118_), .b(x19), .c(new_n64_), .O(new_n127_));
  aoi21  g075(.a(new_n126_), .b(x19), .c(new_n127_), .O(z09));
  oai21  g076(.a(new_n54_), .b(new_n62_), .c(new_n63_), .O(new_n129_));
  ...
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n80_), .O(z12));
  ...
  aoi21  g103(.a(x30), .b(x18), .c(x13), .O(new_n156_));
  nand2  g104(.a(x35), .b(x18), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n55_), .O(new_n158_));
  inv1   g106(.a(x34), .O(new_n159_));
  nand3  g107(.a(new_n64_), .b(new_n159_), .c(new_n54_), .O(new_n160_));
  oai21  g108(.a(new_n158_), .b(new_n156_), .c(new_n160_), .O(z14));
  ...
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n80_), .O(z15));
endmodule
