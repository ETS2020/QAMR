...
module FAU ( 
  ...
  nand3  g056(.a(x19), .b(new_n53_), .c(x11), .O(new_n109_));
  inv1   g057(.a(x29), .O(new_n110_));
  nand2  g058(.a(new_n110_), .b(x18), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g060(.a(new_n112_), .b(new_n62_), .O(new_n113_));
  inv1   g061(.a(x28), .O(new_n114_));
  oai21  g062(.a(new_n114_), .b(x18), .c(new_n54_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n113_), .O(z08));
  nand3  g064(.a(x19), .b(new_n53_), .c(x10), .O(new_n117_));
  ...
  oai21  g069(.a(new_n110_), .b(x18), .c(new_n54_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n121_), .O(z09));
  nand2  g071(.a(x31), .b(x18), .O(new_n124_));
  inv1   g072(.a(x09), .O(new_n125_));
  nand2  g073(.a(new_n53_), .b(new_n125_), .O(new_n126_));
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n57_), .O(new_n127_));
  oai21  g075(.a(new_n55_), .b(x30), .c(new_n127_), .O(z10));
