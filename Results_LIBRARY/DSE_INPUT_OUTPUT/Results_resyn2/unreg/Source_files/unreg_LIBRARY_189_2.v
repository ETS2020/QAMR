...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x31), .O(new_n63_));
  ...
  nand3  g027(.a(new_n79_), .b(new_n77_), .c(new_n63_), .O(z02));
  ...
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n63_), .O(z05));
  ...
  oai21  g078(.a(new_n62_), .b(x18), .c(x31), .O(new_n131_));
  ...
  nand2  g083(.a(new_n135_), .b(new_n63_), .O(new_n136_));
  ...
  nand3  g092(.a(new_n62_), .b(new_n142_), .c(new_n54_), .O(new_n145_));
  nand2  g093(.a(new_n63_), .b(new_n55_), .O(new_n146_));
