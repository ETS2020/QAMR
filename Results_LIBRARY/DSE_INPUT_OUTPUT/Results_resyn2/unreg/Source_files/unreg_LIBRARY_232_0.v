...
module FAU ( 
  ...
  aoi21  g034(.a(new_n86_), .b(new_n80_), .c(new_n61_), .O(z03));
  ...
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n61_), .O(z05));
  ...
  oai21  g105(.a(new_n64_), .b(new_n54_), .c(new_n65_), .O(new_n158_));
