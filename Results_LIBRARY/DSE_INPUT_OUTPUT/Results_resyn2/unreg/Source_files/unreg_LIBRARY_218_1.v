...
module FAU ( 
  ...
  aoi21  g062(.a(x19), .b(x10), .c(new_n61_), .O(new_n115_));
  ...
  aoi21  g066(.a(new_n61_), .b(x18), .c(x10), .O(new_n119_));
  inv1   g067(.a(x17), .O(new_n120_));
  nand2  g068(.a(x30), .b(x18), .O(new_n121_));
  nand3  g069(.a(new_n121_), .b(x19), .c(new_n120_), .O(new_n122_));
  inv1   g070(.a(x29), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n54_), .O(new_n124_));
  oai22  g072(.a(new_n124_), .b(new_n62_), .c(new_n122_), .d(new_n119_), .O(z09));
  ...
  aoi21  g079(.a(new_n131_), .b(new_n127_), .c(new_n62_), .O(z10));
  ...
  nor2   g092(.a(new_n144_), .b(new_n62_), .O(new_n145_));
  ...
  nor2   g108(.a(x18), .b(x12), .O(new_n161_));
  oai21  g109(.a(new_n161_), .b(x17), .c(x19), .O(new_n162_));
  nand2  g110(.a(x35), .b(new_n54_), .O(new_n163_));
  nand2  g111(.a(x19), .b(x18), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(x10), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(x28), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n163_), .c(new_n162_), .O(new_n167_));
  inv1   g115(.a(new_n167_), .O(z15));
endmodule
