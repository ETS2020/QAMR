// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:30 2020
...
module FAU ( 
  ...
  aoi21  g024(.a(new_n76_), .b(new_n72_), .c(new_n53_), .O(z02));
  ...
  inv1   g033(.a(new_n53_), .O(new_n86_));
  inv1   g034(.a(x17), .O(new_n87_));
  inv1   g035(.a(x25), .O(new_n88_));
  nand4  g036(.a(new_n88_), .b(x19), .c(x18), .d(new_n87_), .O(new_n89_));
  inv1   g037(.a(x24), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  nand4  g039(.a(x19), .b(new_n60_), .c(new_n87_), .d(x07), .O(new_n92_));
  nand3  g040(.a(new_n92_), .b(new_n91_), .c(new_n89_), .O(new_n93_));
  and2   g041(.a(new_n93_), .b(new_n86_), .O(z04));
  inv1   g042(.a(x26), .O(new_n95_));
  nand4  g043(.a(new_n95_), .b(x19), .c(x18), .d(new_n87_), .O(new_n96_));
  nand2  g044(.a(new_n88_), .b(new_n54_), .O(new_n97_));
  nand4  g045(.a(x19), .b(new_n60_), .c(new_n87_), .d(x06), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  and2   g047(.a(new_n99_), .b(new_n86_), .O(z05));
  inv1   g048(.a(x32), .O(new_n101_));
  oai21  g049(.a(new_n101_), .b(new_n54_), .c(new_n95_), .O(new_n102_));
  nand2  g050(.a(x27), .b(x18), .O(new_n103_));
  inv1   g051(.a(x05), .O(new_n104_));
  nand2  g052(.a(new_n60_), .b(new_n104_), .O(new_n105_));
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n58_), .O(new_n106_));
  ...
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n58_), .O(new_n113_));
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n53_), .O(z07));
  ...
  nor2   g067(.a(new_n119_), .b(new_n53_), .O(new_n120_));
  ...
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n58_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n53_), .O(z09));
  ...
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n58_), .O(new_n134_));
  ...
  nand3  g088(.a(new_n140_), .b(new_n138_), .c(new_n58_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n53_), .O(z11));
  oai21  g090(.a(new_n95_), .b(new_n54_), .c(new_n101_), .O(new_n143_));
  ...
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n58_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n53_), .O(z13));
  ...
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n58_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n58_), .O(new_n168_));
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n53_), .O(z15));
endmodule
