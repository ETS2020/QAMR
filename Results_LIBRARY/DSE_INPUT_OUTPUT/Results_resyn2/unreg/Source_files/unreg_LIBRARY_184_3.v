...
module FAU ( 
  ...
  nand2  g000(.a(x32), .b(x27), .O(new_n53_));
  ...
  oai21  g049(.a(x32), .b(x18), .c(x27), .O(new_n102_));
  ...
  nand3  g054(.a(new_n53_), .b(new_n106_), .c(new_n55_), .O(new_n107_));
  ...
  aoi21  g092(.a(new_n113_), .b(x19), .c(new_n144_), .O(new_n145_));
