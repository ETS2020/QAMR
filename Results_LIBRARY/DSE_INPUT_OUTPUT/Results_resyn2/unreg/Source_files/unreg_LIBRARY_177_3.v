...
module FAU ( 
  ...
  and2   g008(.a(x30), .b(x15), .O(new_n61_));
  ...
  oai21  g067(.a(x18), .b(x15), .c(x30), .O(new_n120_));
  ...
  oai21  g073(.a(new_n125_), .b(new_n61_), .c(new_n123_), .O(z09));
  ...
  aoi21  g079(.a(new_n131_), .b(new_n54_), .c(new_n61_), .O(new_n132_));
  ...
  nand3  g089(.a(x19), .b(new_n57_), .c(new_n141_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n131_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(x15), .O(new_n144_));
  nor2   g092(.a(x32), .b(x19), .O(new_n145_));
  nor2   g093(.a(x33), .b(new_n57_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n55_), .c(new_n145_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n144_), .O(z12));
