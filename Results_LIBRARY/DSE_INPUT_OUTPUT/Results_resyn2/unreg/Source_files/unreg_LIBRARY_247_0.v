...
module FAU ( 
  ...
  nand2  g001(.a(x32), .b(x20), .O(new_n54_));
  ...
  nand2  g019(.a(x32), .b(x22), .O(new_n72_));
  ...
  nand2  g048(.a(x32), .b(x26), .O(new_n101_));
  ...
  nand2  g069(.a(x32), .b(x29), .O(new_n122_));
  ...
  nand2  g076(.a(x32), .b(x30), .O(new_n129_));
  ...
  inv1   g094(.a(new_n146_), .O(z12));
  inv1   g095(.a(x33), .O(new_n148_));
  nand2  g096(.a(new_n65_), .b(new_n148_), .O(new_n149_));
  ...
  nand2  g102(.a(x34), .b(x32), .O(new_n155_));
  ...
  nand2  g109(.a(x35), .b(x32), .O(new_n162_));
