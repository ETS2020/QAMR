...
module FAU ( 
  ...
  oai22  g30(.a(new_n71_), .b(x25), .c(x18), .d(new_n82_), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n69_), .O(new_n84_));
  nand2  g32(.a(x24), .b(x18), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(new_n84_), .O(z04));
  inv1   g35(.a(x25), .O(new_n88_));
  nand2  g36(.a(new_n63_), .b(new_n88_), .O(new_n89_));
  nor2   g37(.a(x18), .b(x06), .O(new_n90_));
  ...
  oai22  g42(.a(new_n71_), .b(x27), .c(x18), .d(new_n94_), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n69_), .O(new_n96_));
  nand2  g44(.a(new_n91_), .b(new_n54_), .O(new_n97_));
  ...
  oai21  g50(.a(new_n60_), .b(x27), .c(new_n102_), .O(z07));
  ...
  oai21  g55(.a(new_n60_), .b(x28), .c(new_n107_), .O(z08));
  ...
  oai21  g60(.a(new_n60_), .b(x29), .c(new_n112_), .O(z09));
  inv1   g61(.a(x30), .O(new_n114_));
  nand2  g62(.a(new_n63_), .b(new_n114_), .O(new_n115_));
  nor2   g63(.a(x18), .b(x09), .O(new_n116_));
  ...
  nand2  g67(.a(new_n117_), .b(new_n54_), .O(new_n120_));
  nand2  g68(.a(new_n60_), .b(new_n69_), .O(new_n121_));
  oai21  g69(.a(x18), .b(x08), .c(new_n85_), .O(new_n122_));
  oai21  g70(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(z11));
  inv1   g71(.a(x32), .O(new_n124_));
  nand2  g72(.a(new_n63_), .b(new_n124_), .O(new_n125_));
  ...
  nand2  g77(.a(new_n127_), .b(new_n54_), .O(new_n130_));
  nand2  g78(.a(x34), .b(x18), .O(new_n131_));
  oai21  g79(.a(x18), .b(x14), .c(new_n131_), .O(new_n132_));
  oai21  g80(.a(new_n132_), .b(new_n121_), .c(new_n130_), .O(z13));
  ...
  oai21  g84(.a(new_n136_), .b(new_n121_), .c(new_n134_), .O(z14));
  inv1   g85(.a(x12), .O(new_n138_));
  oai22  g86(.a(new_n71_), .b(x28), .c(x18), .d(new_n138_), .O(new_n139_));
  nand2  g87(.a(new_n139_), .b(new_n69_), .O(new_n140_));
  nand2  g88(.a(new_n135_), .b(new_n54_), .O(new_n141_));
