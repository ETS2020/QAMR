...
module FAU ( 
  ...
  oai21  g070(.a(x34), .b(x18), .c(x30), .O(new_n123_));
  ...
  aoi21  g106(.a(new_n134_), .b(x19), .c(new_n158_), .O(new_n159_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n81_), .O(new_n168_));
