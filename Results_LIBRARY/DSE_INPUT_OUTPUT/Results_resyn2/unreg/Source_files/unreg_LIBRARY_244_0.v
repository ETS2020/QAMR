...
module FAU ( 
  ...
  inv1   g007(.a(new_n59_), .O(z00));
  inv1   g008(.a(x21), .O(new_n61_));
  inv1   g009(.a(x20), .O(new_n62_));
  nor2   g010(.a(new_n62_), .b(x19), .O(new_n63_));
  ...
  nand2  g025(.a(new_n63_), .b(new_n77_), .O(new_n78_));
  ...
  nand2  g047(.a(new_n63_), .b(new_n99_), .O(new_n100_));
  ...
  oai21  g054(.a(x18), .b(x04), .c(new_n106_), .O(new_n107_));
  nand2  g055(.a(x19), .b(new_n57_), .O(new_n108_));
  inv1   g056(.a(x27), .O(new_n109_));
  aoi21  g057(.a(new_n109_), .b(new_n54_), .c(new_n62_), .O(new_n110_));
  aoi22  g058(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(x19), .O(z07));
  nand2  g059(.a(x28), .b(x20), .O(new_n112_));
  ...
  nand2  g067(.a(new_n63_), .b(new_n119_), .O(new_n120_));
  ...
  nand2  g073(.a(x30), .b(x20), .O(new_n126_));
  ...
  nand2  g088(.a(new_n63_), .b(new_n140_), .O(new_n141_));
  ...
  nand2  g094(.a(x33), .b(x20), .O(new_n147_));
  ...
  nand2  g101(.a(x34), .b(x20), .O(new_n154_));
  ...
  nand2  g109(.a(new_n63_), .b(new_n161_), .O(new_n162_));
