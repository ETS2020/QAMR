...
module FAU ( 
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n89_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n89_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n69_), .O(z15));
endmodule
