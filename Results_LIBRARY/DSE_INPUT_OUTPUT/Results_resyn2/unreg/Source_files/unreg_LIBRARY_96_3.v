...
module FAU ( 
  ...
  nand2  g008(.a(x35), .b(x20), .O(new_n61_));
  ...
  oai21  g056(.a(x35), .b(x18), .c(x20), .O(new_n109_));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n81_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n62_), .O(z13));
  oai21  g105(.a(x20), .b(x18), .c(x35), .O(new_n158_));
  ...
  aoi21  g113(.a(new_n60_), .b(x19), .c(new_n165_), .O(new_n166_));
  nand2  g114(.a(x28), .b(x18), .O(new_n167_));
  inv1   g115(.a(x12), .O(new_n168_));
  nand2  g116(.a(new_n57_), .b(new_n168_), .O(new_n169_));
  nand3  g117(.a(new_n169_), .b(new_n167_), .c(new_n81_), .O(new_n170_));
