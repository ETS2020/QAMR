...
module FAU ( 
  ...
  nor2   g008(.a(x30), .b(x15), .O(new_n61_));
  ...
  inv1   g075(.a(x15), .O(new_n128_));
  inv1   g076(.a(x30), .O(new_n129_));
  oai21  g077(.a(new_n54_), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  ...
  nand2  g091(.a(new_n57_), .b(new_n128_), .O(new_n144_));
  nand3  g092(.a(new_n144_), .b(new_n143_), .c(new_n55_), .O(new_n145_));
