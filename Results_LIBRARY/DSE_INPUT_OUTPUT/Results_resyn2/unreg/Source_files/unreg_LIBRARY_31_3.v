...
module FAU ( 
  ...
  nand2  g030(.a(new_n62_), .b(new_n82_), .O(new_n83_));
  nand3  g031(.a(new_n83_), .b(new_n81_), .c(new_n60_), .O(new_n84_));
  nor2   g032(.a(x23), .b(x19), .O(new_n85_));
  nor2   g033(.a(new_n85_), .b(new_n55_), .O(new_n86_));
  ...
  nand3  g047(.a(new_n99_), .b(new_n97_), .c(new_n60_), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n55_), .O(z05));
  inv1   g049(.a(x17), .O(new_n102_));
  nand3  g050(.a(x19), .b(new_n62_), .c(new_n102_), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n54_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(x05), .O(new_n105_));
  nor2   g053(.a(x26), .b(x19), .O(new_n106_));
  nor2   g054(.a(x27), .b(new_n62_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n60_), .c(new_n106_), .O(new_n108_));
  nand2  g056(.a(new_n108_), .b(new_n105_), .O(z06));
  ...
  aoi21  g064(.a(x19), .b(new_n53_), .c(new_n54_), .O(new_n117_));
  aoi21  g065(.a(x29), .b(x18), .c(x17), .O(new_n118_));
  oai21  g066(.a(x18), .b(x11), .c(new_n118_), .O(new_n119_));
  aoi21  g067(.a(new_n119_), .b(x19), .c(new_n117_), .O(z08));
  nand2  g068(.a(x30), .b(x18), .O(new_n121_));
  inv1   g069(.a(x10), .O(new_n122_));
  nand2  g070(.a(new_n62_), .b(new_n122_), .O(new_n123_));
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n60_), .O(new_n133_));
  ...
  nand2  g086(.a(new_n62_), .b(new_n138_), .O(new_n139_));
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n60_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n55_), .O(z11));
  nand2  g089(.a(x33), .b(x18), .O(new_n142_));
  inv1   g090(.a(x15), .O(new_n143_));
  nand2  g091(.a(new_n62_), .b(new_n143_), .O(new_n144_));
  nand3  g092(.a(new_n144_), .b(new_n142_), .c(new_n60_), .O(new_n145_));
  nor2   g093(.a(x32), .b(x19), .O(new_n146_));
  nor2   g094(.a(new_n146_), .b(new_n55_), .O(new_n147_));
  ...
  nor2   g101(.a(new_n153_), .b(new_n55_), .O(new_n154_));
  ...
  nor2   g108(.a(new_n160_), .b(new_n55_), .O(new_n161_));
