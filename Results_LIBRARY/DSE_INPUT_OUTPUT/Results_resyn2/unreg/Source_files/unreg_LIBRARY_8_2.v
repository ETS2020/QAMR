...
module FAU ( 
  ...
  aoi21  g065(.a(x35), .b(x19), .c(new_n117_), .O(new_n118_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n90_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n87_), .O(z09));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n90_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n130_), .c(new_n87_), .O(z10));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n90_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n87_), .O(z11));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n90_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n87_), .O(z13));
  nor2   g104(.a(x35), .b(x28), .O(new_n157_));
  aoi21  g105(.a(x35), .b(new_n57_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g111(.a(new_n161_), .b(new_n158_), .c(new_n163_), .O(z14));
  nand2  g112(.a(new_n157_), .b(new_n54_), .O(new_n165_));
  oai21  g113(.a(new_n62_), .b(x18), .c(x28), .O(new_n166_));
