...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x07), .O(new_n53_));
  ...
  nand2  g090(.a(new_n142_), .b(new_n87_), .O(new_n143_));
  nand2  g091(.a(new_n71_), .b(new_n143_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n142_), .b(new_n54_), .c(x07), .O(new_n147_));
