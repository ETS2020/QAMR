...
module FAU ( 
  ...
  aoi21  g042(.a(new_n94_), .b(new_n89_), .c(new_n63_), .O(z04));
  ...
  nand4  g048(.a(new_n100_), .b(new_n98_), .c(x19), .d(new_n90_), .O(new_n101_));
  ...
  nand2  g081(.a(new_n57_), .b(new_n61_), .O(new_n134_));
  nand4  g082(.a(new_n134_), .b(new_n133_), .c(x19), .d(new_n90_), .O(new_n135_));
  aoi21  g083(.a(new_n135_), .b(new_n132_), .c(new_n63_), .O(z10));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n90_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n90_), .O(new_n156_));
