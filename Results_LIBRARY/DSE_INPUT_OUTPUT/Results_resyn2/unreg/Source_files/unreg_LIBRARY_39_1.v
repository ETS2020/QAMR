...
module FAU ( 
  ...
  inv1   g010(.a(x32), .O(new_n63_));
  nor2   g011(.a(new_n63_), .b(x20), .O(new_n64_));
  ...
  nand2  g017(.a(new_n59_), .b(new_n69_), .O(new_n70_));
  ...
  nand3  g023(.a(new_n75_), .b(new_n73_), .c(new_n57_), .O(new_n76_));
  ...
  nand3  g031(.a(new_n83_), .b(new_n81_), .c(new_n57_), .O(new_n84_));
  nor2   g032(.a(x23), .b(x19), .O(new_n85_));
  nor2   g033(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n57_), .O(new_n119_));
  nor2   g067(.a(x28), .b(x19), .O(new_n120_));
  nor2   g068(.a(new_n120_), .b(new_n64_), .O(new_n121_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n67_), .O(new_n135_));
  aoi21  g083(.a(new_n135_), .b(new_n131_), .c(new_n64_), .O(z10));
  ...
  aoi21  g095(.a(new_n63_), .b(new_n53_), .c(new_n64_), .O(new_n148_));
  ...
  nand2  g115(.a(new_n59_), .b(new_n167_), .O(new_n168_));
