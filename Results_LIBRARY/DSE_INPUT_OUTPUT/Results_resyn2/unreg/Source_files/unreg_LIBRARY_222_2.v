...
module FAU ( 
  ...
  nand4  g034(.a(new_n86_), .b(new_n84_), .c(x19), .d(new_n75_), .O(new_n87_));
  aoi21  g035(.a(new_n87_), .b(new_n82_), .c(new_n72_), .O(z03));
  ...
  aoi21  g051(.a(x34), .b(x19), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n63_), .O(z08));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n75_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n72_), .O(z09));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n75_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n130_), .c(new_n72_), .O(z10));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n75_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n72_), .O(z11));
  ...
  oai21  g104(.a(x26), .b(new_n54_), .c(new_n62_), .O(new_n157_));
  ...
  nand2  g115(.a(new_n167_), .b(new_n54_), .O(new_n168_));
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n63_), .O(z15));
endmodule
