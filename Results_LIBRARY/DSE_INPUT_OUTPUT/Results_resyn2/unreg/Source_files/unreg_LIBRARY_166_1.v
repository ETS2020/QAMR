...
module FAU ( 
  ...
  nand3  g086(.a(new_n138_), .b(new_n53_), .c(new_n56_), .O(new_n139_));
  nand2  g087(.a(new_n66_), .b(new_n54_), .O(new_n140_));
  nand2  g088(.a(x24), .b(x18), .O(new_n141_));
  oai21  g089(.a(x18), .b(x08), .c(new_n141_), .O(new_n142_));
  oai21  g090(.a(new_n142_), .b(new_n140_), .c(new_n139_), .O(z11));
  nand2  g091(.a(new_n138_), .b(new_n56_), .O(new_n144_));
