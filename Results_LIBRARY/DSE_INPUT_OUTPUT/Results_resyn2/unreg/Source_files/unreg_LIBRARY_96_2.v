// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:04 2020
...
module FAU ( 
  ...
  inv1   g007(.a(x35), .O(new_n60_));
  nand2  g008(.a(new_n60_), .b(x20), .O(new_n61_));
  ...
  nand3  g018(.a(new_n70_), .b(new_n68_), .c(new_n61_), .O(z01));
  ...
  nand2  g024(.a(new_n76_), .b(new_n54_), .O(new_n77_));
  nand3  g025(.a(new_n77_), .b(new_n75_), .c(new_n61_), .O(z02));
  inv1   g026(.a(new_n61_), .O(new_n79_));
  ...
  nand4  g034(.a(new_n86_), .b(new_n84_), .c(x19), .d(new_n82_), .O(new_n87_));
  aoi21  g035(.a(new_n87_), .b(new_n81_), .c(new_n79_), .O(z03));
  ...
  nand4  g041(.a(new_n93_), .b(new_n91_), .c(x19), .d(new_n82_), .O(new_n94_));
  aoi21  g042(.a(new_n94_), .b(new_n90_), .c(new_n79_), .O(z04));
  ...
  inv1   g047(.a(x25), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n54_), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n61_), .O(z05));
  ...
  nand4  g055(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n82_), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(new_n104_), .c(new_n79_), .O(z06));
  oai21  g057(.a(new_n60_), .b(x18), .c(x20), .O(new_n110_));
  ...
  nand4  g069(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n82_), .O(new_n122_));
  aoi21  g070(.a(new_n122_), .b(new_n118_), .c(new_n79_), .O(z08));
  ...
  nand3  g077(.a(new_n129_), .b(new_n127_), .c(new_n61_), .O(z09));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n61_), .O(z10));
  ...
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n61_), .O(z11));
  ...
  nand4  g097(.a(new_n149_), .b(new_n147_), .c(x19), .d(new_n82_), .O(new_n150_));
  aoi21  g098(.a(new_n150_), .b(new_n146_), .c(new_n79_), .O(z12));
  ...
  nand4  g104(.a(new_n156_), .b(new_n154_), .c(x19), .d(new_n82_), .O(new_n157_));
  aoi21  g105(.a(new_n157_), .b(new_n153_), .c(new_n79_), .O(z13));
  nor2   g106(.a(x35), .b(x20), .O(new_n159_));
  aoi21  g107(.a(x35), .b(new_n57_), .c(new_n159_), .O(new_n160_));
  ...
  nand2  g112(.a(new_n164_), .b(new_n61_), .O(new_n165_));
  oai21  g113(.a(new_n163_), .b(new_n160_), .c(new_n165_), .O(z14));
  nand2  g114(.a(new_n61_), .b(new_n55_), .O(new_n167_));
  nand2  g115(.a(x28), .b(x18), .O(new_n168_));
  oai21  g116(.a(x18), .b(x12), .c(new_n168_), .O(new_n169_));
  nand3  g117(.a(new_n60_), .b(new_n62_), .c(new_n54_), .O(new_n170_));
  oai21  g118(.a(new_n169_), .b(new_n167_), .c(new_n170_), .O(z15));
endmodule
