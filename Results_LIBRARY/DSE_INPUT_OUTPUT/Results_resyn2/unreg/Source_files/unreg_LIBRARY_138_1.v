...
module FAU ( 
  ...
  aoi21  g38(.a(new_n90_), .b(new_n54_), .c(new_n55_), .O(new_n91_));
  nand2  g39(.a(new_n87_), .b(new_n53_), .O(new_n92_));
  oai21  g40(.a(new_n91_), .b(new_n53_), .c(new_n92_), .O(z10));
  oai21  g41(.a(x24), .b(x17), .c(x18), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(x19), .O(new_n95_));
  nand2  g43(.a(new_n90_), .b(new_n53_), .O(new_n96_));
