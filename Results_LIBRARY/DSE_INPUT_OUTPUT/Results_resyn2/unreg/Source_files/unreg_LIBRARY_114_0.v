...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x12), .O(new_n61_));
  ...
  nand3  g095(.a(new_n143_), .b(new_n54_), .c(x12), .O(new_n148_));
  ...
  nand2  g110(.a(new_n57_), .b(new_n142_), .O(new_n163_));
  nand3  g111(.a(new_n163_), .b(new_n162_), .c(new_n55_), .O(new_n164_));
