...
module FAU ( 
  ...
  aoi21  g035(.a(x32), .b(x19), .c(new_n61_), .O(new_n88_));
  ...
  nand4  g044(.a(new_n96_), .b(new_n94_), .c(x19), .d(new_n67_), .O(new_n97_));
  aoi21  g045(.a(new_n97_), .b(new_n93_), .c(new_n62_), .O(z05));
  ...
  nand4  g051(.a(new_n103_), .b(new_n101_), .c(x19), .d(new_n67_), .O(new_n104_));
  aoi21  g052(.a(new_n104_), .b(new_n100_), .c(new_n62_), .O(z06));
