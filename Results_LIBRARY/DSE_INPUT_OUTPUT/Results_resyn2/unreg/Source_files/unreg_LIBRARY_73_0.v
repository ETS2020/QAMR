...
module FAU ( 
  ...
  nor2   g008(.a(x35), .b(x33), .O(new_n61_));
  ...
  aoi21  g064(.a(new_n116_), .b(new_n112_), .c(new_n61_), .O(z08));
  ...
  nor2   g076(.a(x30), .b(x19), .O(new_n129_));
  ...
  nor2   g084(.a(new_n136_), .b(new_n61_), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n135_), .O(z11));
  inv1   g086(.a(x33), .O(new_n139_));
  nand3  g087(.a(x35), .b(new_n139_), .c(x18), .O(new_n140_));
  ...
  inv1   g091(.a(new_n61_), .O(new_n144_));
  nor2   g092(.a(x32), .b(x19), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n143_), .O(z12));
  nand3  g095(.a(x35), .b(new_n139_), .c(new_n54_), .O(new_n148_));
  nand2  g096(.a(new_n144_), .b(new_n55_), .O(new_n149_));
  nand2  g097(.a(x34), .b(x18), .O(new_n150_));
  oai21  g098(.a(x18), .b(x14), .c(new_n150_), .O(new_n151_));
  oai21  g099(.a(new_n151_), .b(new_n149_), .c(new_n148_), .O(z13));
  ...
  aoi21  g113(.a(new_n165_), .b(new_n161_), .c(new_n61_), .O(z15));
endmodule
