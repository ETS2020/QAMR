...
module FAU ( 
  ...
  inv1   g086(.a(new_n61_), .O(new_n139_));
  ...
  nand3  g091(.a(x35), .b(new_n143_), .c(new_n54_), .O(new_n144_));
  oai21  g092(.a(new_n142_), .b(new_n140_), .c(new_n144_), .O(z12));
  nand2  g093(.a(x34), .b(x18), .O(new_n146_));
  oai21  g094(.a(x18), .b(x14), .c(new_n146_), .O(new_n147_));
  nor2   g095(.a(x33), .b(x19), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n139_), .O(new_n149_));
  oai21  g097(.a(new_n147_), .b(new_n140_), .c(new_n149_), .O(z13));
  inv1   g098(.a(x35), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(x32), .c(x18), .O(new_n152_));
  nand2  g100(.a(new_n57_), .b(x13), .O(new_n153_));
  oai21  g101(.a(new_n153_), .b(new_n61_), .c(new_n152_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n55_), .O(new_n155_));
  nor2   g103(.a(x34), .b(x19), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n139_), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n155_), .O(z14));
  nand3  g106(.a(new_n151_), .b(x32), .c(new_n54_), .O(new_n159_));
  nand2  g107(.a(x28), .b(x18), .O(new_n160_));
  oai21  g108(.a(x18), .b(x12), .c(new_n160_), .O(new_n161_));
  oai21  g109(.a(new_n161_), .b(new_n140_), .c(new_n159_), .O(z15));
endmodule
