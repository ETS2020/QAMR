// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:45 2020
...
module FAU ( 
  ...
  nand3  g014(.a(x19), .b(new_n57_), .c(new_n66_), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(new_n62_), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(x02), .O(new_n69_));
  nor2   g017(.a(x21), .b(x19), .O(new_n70_));
  nor2   g018(.a(x22), .b(new_n57_), .O(new_n71_));
  aoi21  g019(.a(new_n71_), .b(new_n55_), .c(new_n70_), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(new_n69_), .O(z01));
  ...
  nor2   g026(.a(new_n78_), .b(new_n63_), .O(new_n79_));
  ...
  nand3  g062(.a(new_n114_), .b(new_n112_), .c(new_n55_), .O(new_n115_));
  ...
  nand3  g069(.a(new_n121_), .b(new_n119_), .c(new_n55_), .O(new_n122_));
  ...
  aoi21  g077(.a(new_n129_), .b(new_n125_), .c(new_n63_), .O(z09));
  ...
  aoi21  g084(.a(new_n136_), .b(new_n132_), .c(new_n63_), .O(z10));
  ...
  aoi21  g092(.a(x19), .b(new_n61_), .c(new_n62_), .O(new_n145_));
  ...
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n63_), .O(z14));
  ...
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n63_), .O(z15));
endmodule
