...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nor2   g000(.a(x32), .b(x28), .O(new_n53_));
  ...
  aoi21  g054(.a(new_n106_), .b(new_n102_), .c(new_n53_), .O(z06));
  ...
  nand2  g063(.a(x32), .b(x19), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand2  g065(.a(x29), .b(x18), .O(new_n118_));
  inv1   g066(.a(x11), .O(new_n119_));
  nand2  g067(.a(new_n60_), .b(new_n119_), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n64_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n117_), .O(z08));
  nand2  g070(.a(x30), .b(x18), .O(new_n123_));
  inv1   g071(.a(x10), .O(new_n124_));
  nand2  g072(.a(new_n60_), .b(new_n124_), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n64_), .O(new_n126_));
  nor2   g074(.a(x29), .b(x19), .O(new_n127_));
  nor2   g075(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n64_), .O(new_n133_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n64_), .O(new_n140_));
  nor2   g088(.a(x31), .b(x19), .O(new_n141_));
  nor2   g089(.a(new_n141_), .b(new_n53_), .O(new_n142_));
  ...
  nand2  g096(.a(new_n148_), .b(x28), .O(new_n149_));
  aoi22  g097(.a(new_n149_), .b(new_n116_), .c(new_n147_), .d(x19), .O(z12));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n60_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n64_), .O(new_n154_));
  ...
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n57_), .O(new_n163_));
  aoi21  g111(.a(new_n163_), .b(new_n159_), .c(new_n53_), .O(z14));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n60_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n64_), .O(new_n168_));
  nor2   g116(.a(x35), .b(x19), .O(new_n169_));
  nor2   g117(.a(new_n169_), .b(new_n53_), .O(new_n170_));
