...
module FAU ( 
  ...
  nor2   g008(.a(x26), .b(x24), .O(new_n61_));
  ...
  nand4  g065(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n66_), .O(new_n118_));
  ...
  oai21  g085(.a(new_n135_), .b(new_n103_), .c(new_n137_), .O(z11));
  ...
  nand4  g091(.a(new_n143_), .b(new_n141_), .c(x19), .d(new_n66_), .O(new_n144_));
  aoi21  g092(.a(new_n144_), .b(new_n140_), .c(new_n61_), .O(z12));
  ...
  nand4  g098(.a(new_n150_), .b(new_n148_), .c(x19), .d(new_n66_), .O(new_n151_));
  aoi21  g099(.a(new_n151_), .b(new_n147_), .c(new_n61_), .O(z13));
