...
module FAU ( 
  ...
  nand2  g078(.a(new_n64_), .b(new_n130_), .O(new_n131_));
  nand2  g079(.a(x31), .b(x18), .O(new_n132_));
  oai21  g080(.a(x18), .b(x09), .c(new_n132_), .O(new_n133_));
  nand3  g081(.a(x32), .b(new_n128_), .c(new_n54_), .O(new_n134_));
  ...
  nand2  g086(.a(new_n138_), .b(new_n130_), .O(new_n139_));
  ...
  nand3  g090(.a(new_n129_), .b(x30), .c(new_n54_), .O(new_n143_));
  oai21  g091(.a(new_n142_), .b(new_n131_), .c(new_n143_), .O(z12));
  nand2  g092(.a(x34), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x14), .c(new_n145_), .O(new_n146_));
  nor2   g094(.a(x33), .b(x19), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n130_), .O(new_n148_));
  oai21  g096(.a(new_n146_), .b(new_n131_), .c(new_n148_), .O(z13));
  ...
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n53_), .O(z14));
  ...
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n53_), .O(z15));
endmodule
