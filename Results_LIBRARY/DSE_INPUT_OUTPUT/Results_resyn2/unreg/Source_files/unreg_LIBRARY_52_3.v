...
module FAU ( 
  ...
  nand3  g047(.a(new_n99_), .b(new_n97_), .c(new_n75_), .O(new_n100_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n75_), .O(new_n153_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n75_), .O(new_n160_));
