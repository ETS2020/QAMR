// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:36 2020
...
module FAU ( 
  ...
  oai21  g002(.a(x22), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  ...
  oai21  g011(.a(x22), .b(new_n63_), .c(new_n53_), .O(new_n64_));
  ...
  nor2   g017(.a(x22), .b(x19), .O(new_n70_));
  ...
  oai21  g025(.a(new_n77_), .b(x22), .c(new_n53_), .O(new_n78_));
  ...
  oai21  g040(.a(new_n92_), .b(x22), .c(new_n53_), .O(new_n93_));
  ...
  oai21  g047(.a(new_n99_), .b(x22), .c(new_n53_), .O(new_n100_));
  ...
  oai21  g054(.a(new_n106_), .b(x22), .c(new_n53_), .O(new_n107_));
  ...
  nand2  g061(.a(new_n70_), .b(new_n113_), .O(new_n114_));
  ...
  oai21  g068(.a(new_n120_), .b(x22), .c(new_n53_), .O(new_n121_));
  ...
  oai21  g075(.a(new_n127_), .b(x22), .c(new_n53_), .O(new_n128_));
  ...
  oai21  g096(.a(new_n148_), .b(x22), .c(new_n53_), .O(new_n149_));
  ...
  nand2  g110(.a(new_n70_), .b(new_n162_), .O(new_n163_));
