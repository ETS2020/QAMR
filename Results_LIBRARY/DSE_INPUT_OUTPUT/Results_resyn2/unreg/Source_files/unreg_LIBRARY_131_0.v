...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x06), .O(new_n53_));
  ...
  aoi21  g041(.a(x34), .b(x18), .c(x06), .O(new_n94_));
  ...
  oai22  g046(.a(new_n98_), .b(new_n53_), .c(new_n96_), .d(new_n94_), .O(z05));
  ...
  nand2  g098(.a(new_n150_), .b(new_n71_), .O(new_n151_));
  ...
  aoi21  g102(.a(x35), .b(x18), .c(x17), .O(new_n155_));
  oai21  g103(.a(x18), .b(x13), .c(new_n155_), .O(new_n156_));
  inv1   g104(.a(x06), .O(new_n157_));
  ...
  aoi21  g109(.a(new_n156_), .b(x19), .c(new_n161_), .O(z14));
