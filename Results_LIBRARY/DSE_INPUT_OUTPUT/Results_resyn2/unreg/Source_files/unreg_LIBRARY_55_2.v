...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x24), .O(new_n63_));
  ...
  nand3  g064(.a(new_n62_), .b(new_n93_), .c(new_n54_), .O(new_n117_));
  ...
  oai21  g068(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(z08));
  ...
  oai21  g081(.a(new_n62_), .b(x18), .c(x24), .O(new_n134_));
  ...
  nand2  g086(.a(new_n138_), .b(new_n63_), .O(new_n139_));
  ...
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n63_), .O(z14));
  nand2  g109(.a(x28), .b(x18), .O(new_n162_));
  inv1   g110(.a(x12), .O(new_n163_));
  nand2  g111(.a(new_n57_), .b(new_n163_), .O(new_n164_));
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n68_), .O(new_n165_));
  nand2  g113(.a(x35), .b(new_n54_), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n63_), .O(new_n167_));
  aoi21  g115(.a(new_n165_), .b(x19), .c(new_n167_), .O(z15));
endmodule
