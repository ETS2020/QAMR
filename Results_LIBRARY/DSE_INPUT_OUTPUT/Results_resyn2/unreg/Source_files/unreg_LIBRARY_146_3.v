...
module FAU ( 
  ...
  oai21  g043(.a(x32), .b(x18), .c(x26), .O(new_n96_));
  ...
  oai21  g048(.a(new_n54_), .b(new_n53_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n95_), .O(new_n147_));
