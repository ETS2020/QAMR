...
module FAU ( 
  ...
  inv1   g24(.a(x17), .O(new_n77_));
  nand3  g25(.a(x32), .b(x19), .c(new_n77_), .O(new_n78_));
  inv1   g26(.a(x00), .O(new_n79_));
  nand2  g27(.a(new_n57_), .b(new_n79_), .O(new_n80_));
  oai21  g28(.a(new_n57_), .b(x16), .c(new_n80_), .O(new_n81_));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n90_), .c(x17), .O(new_n91_));
  aoi21  g39(.a(new_n91_), .b(new_n89_), .c(new_n54_), .O(new_n92_));
  ...
  aoi21  g48(.a(new_n57_), .b(new_n100_), .c(x17), .O(new_n101_));
  aoi21  g49(.a(new_n101_), .b(new_n99_), .c(new_n54_), .O(new_n102_));
  ...
  aoi21  g55(.a(new_n57_), .b(new_n107_), .c(x17), .O(new_n108_));
  aoi21  g56(.a(new_n108_), .b(new_n106_), .c(new_n54_), .O(new_n109_));
  ...
  aoi21  g62(.a(new_n57_), .b(new_n114_), .c(x17), .O(new_n115_));
  aoi21  g63(.a(new_n115_), .b(new_n113_), .c(new_n54_), .O(new_n116_));
  ...
  aoi21  g69(.a(new_n57_), .b(new_n121_), .c(x17), .O(new_n122_));
  aoi21  g70(.a(new_n122_), .b(new_n120_), .c(new_n54_), .O(new_n123_));
  ...
  oai21  g75(.a(x18), .b(x15), .c(new_n127_), .O(new_n128_));
  oai22  g76(.a(new_n128_), .b(new_n78_), .c(x32), .d(x19), .O(z12));
  nand2  g77(.a(x34), .b(x18), .O(new_n130_));
  oai21  g78(.a(x18), .b(x14), .c(new_n130_), .O(new_n131_));
  oai22  g79(.a(new_n131_), .b(new_n78_), .c(x33), .d(x19), .O(z13));
  nand2  g80(.a(x35), .b(x18), .O(new_n133_));
  inv1   g81(.a(x13), .O(new_n134_));
  aoi21  g82(.a(new_n57_), .b(new_n134_), .c(x17), .O(new_n135_));
  aoi21  g83(.a(new_n135_), .b(new_n133_), .c(new_n54_), .O(new_n136_));
  inv1   g84(.a(x34), .O(new_n137_));
  nand2  g85(.a(new_n137_), .b(new_n53_), .O(new_n138_));
  oai21  g86(.a(new_n136_), .b(new_n53_), .c(new_n138_), .O(z14));
  nand2  g87(.a(x28), .b(x18), .O(new_n140_));
  oai21  g88(.a(x18), .b(x12), .c(new_n140_), .O(new_n141_));
  oai22  g89(.a(new_n141_), .b(new_n78_), .c(x35), .d(x19), .O(z15));
endmodule
