...
module FAU ( 
  ...
  nor2   g016(.a(x30), .b(x20), .O(new_n69_));
  ...
  nand3  g024(.a(new_n76_), .b(new_n74_), .c(new_n58_), .O(new_n77_));
  aoi21  g025(.a(new_n77_), .b(new_n73_), .c(new_n69_), .O(z02));
  ...
  nand3  g032(.a(new_n84_), .b(new_n82_), .c(new_n58_), .O(new_n85_));
  aoi21  g033(.a(new_n85_), .b(new_n80_), .c(new_n69_), .O(z03));
  nand2  g034(.a(x25), .b(x18), .O(new_n87_));
  inv1   g035(.a(x07), .O(new_n88_));
  nand2  g036(.a(new_n60_), .b(new_n88_), .O(new_n89_));
  nand3  g037(.a(new_n89_), .b(new_n87_), .c(new_n58_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n58_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n58_), .O(new_n104_));
  nor2   g052(.a(x26), .b(x19), .O(new_n105_));
  nor2   g053(.a(new_n105_), .b(new_n69_), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n104_), .O(z06));
  inv1   g055(.a(new_n69_), .O(new_n108_));
  nand2  g056(.a(new_n108_), .b(new_n58_), .O(new_n109_));
  nand2  g057(.a(x20), .b(x18), .O(new_n110_));
  oai21  g058(.a(x18), .b(x04), .c(new_n110_), .O(new_n111_));
  nor2   g059(.a(x27), .b(x19), .O(new_n112_));
  nand2  g060(.a(new_n112_), .b(new_n108_), .O(new_n113_));
  oai21  g061(.a(new_n111_), .b(new_n109_), .c(new_n113_), .O(z07));
  inv1   g062(.a(x17), .O(new_n115_));
  inv1   g063(.a(x29), .O(new_n116_));
  nand4  g064(.a(new_n116_), .b(x19), .c(x18), .d(new_n115_), .O(new_n117_));
  inv1   g065(.a(x28), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n53_), .O(new_n119_));
  nand4  g067(.a(x19), .b(new_n60_), .c(new_n115_), .d(x11), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n119_), .c(new_n117_), .O(new_n121_));
  and2   g069(.a(new_n121_), .b(new_n108_), .O(z08));
  nand4  g070(.a(new_n55_), .b(x19), .c(x18), .d(new_n115_), .O(new_n123_));
  nand2  g071(.a(new_n116_), .b(new_n53_), .O(new_n124_));
  nand4  g072(.a(x19), .b(new_n60_), .c(new_n115_), .d(x10), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(new_n126_));
  and2   g074(.a(new_n126_), .b(new_n108_), .O(z09));
  nand2  g075(.a(x31), .b(x18), .O(new_n128_));
  oai21  g076(.a(x18), .b(x09), .c(new_n128_), .O(new_n129_));
  nand3  g077(.a(new_n55_), .b(x20), .c(new_n53_), .O(new_n130_));
  oai21  g078(.a(new_n129_), .b(new_n109_), .c(new_n130_), .O(z10));
  ...
  nor2   g083(.a(x31), .b(x19), .O(new_n136_));
  nor2   g084(.a(new_n136_), .b(new_n69_), .O(new_n137_));
  ...
  aoi21  g099(.a(new_n151_), .b(new_n147_), .c(new_n69_), .O(z13));
  nand2  g100(.a(x35), .b(x18), .O(new_n153_));
  inv1   g101(.a(x13), .O(new_n154_));
  nand2  g102(.a(new_n60_), .b(new_n154_), .O(new_n155_));
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n58_), .O(new_n156_));
  nor2   g104(.a(x34), .b(x19), .O(new_n157_));
  nor2   g105(.a(new_n157_), .b(new_n69_), .O(new_n158_));
  ...
  nand3  g110(.a(new_n162_), .b(new_n160_), .c(new_n58_), .O(new_n163_));
  nor2   g111(.a(x35), .b(x19), .O(new_n164_));
  nor2   g112(.a(new_n164_), .b(new_n69_), .O(new_n165_));
