...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x00), .O(new_n53_));
  ...
  nand2  g091(.a(new_n64_), .b(new_n143_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n142_), .b(new_n54_), .c(x00), .O(new_n147_));
  ...
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n64_), .O(new_n164_));
