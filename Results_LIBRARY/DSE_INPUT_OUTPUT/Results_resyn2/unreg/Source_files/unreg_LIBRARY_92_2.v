...
module FAU ( 
  ...
  aoi21  g049(.a(new_n101_), .b(new_n97_), .c(new_n87_), .O(z05));
  ...
  nand4  g069(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n90_), .O(new_n122_));
  aoi21  g070(.a(new_n122_), .b(new_n118_), .c(new_n87_), .O(z08));
  ...
  nand4  g083(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n90_), .O(new_n136_));
  aoi21  g084(.a(new_n136_), .b(new_n132_), .c(new_n87_), .O(z10));
  ...
  nand3  g092(.a(new_n60_), .b(new_n62_), .c(new_n54_), .O(new_n145_));
  nand2  g093(.a(new_n61_), .b(new_n55_), .O(new_n146_));
  ...
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n61_), .O(z13));
  ...
  nand3  g110(.a(new_n162_), .b(new_n160_), .c(new_n61_), .O(z14));
  ...
  nand3  g117(.a(new_n169_), .b(new_n167_), .c(new_n61_), .O(z15));
endmodule
