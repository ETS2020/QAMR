...
module FAU ( 
  ...
  oai22  g18(.a(new_n55_), .b(x23), .c(x18), .d(new_n70_), .O(new_n71_));
  nand2  g19(.a(new_n71_), .b(new_n53_), .O(new_n72_));
  nand2  g20(.a(new_n63_), .b(new_n58_), .O(new_n73_));
  nand2  g21(.a(new_n73_), .b(new_n72_), .O(z02));
  inv1   g22(.a(x16), .O(new_n75_));
  nand2  g23(.a(x18), .b(new_n75_), .O(new_n76_));
  inv1   g24(.a(x00), .O(new_n77_));
  nand2  g25(.a(new_n66_), .b(new_n77_), .O(new_n78_));
  nand3  g26(.a(new_n78_), .b(new_n76_), .c(new_n64_), .O(new_n79_));
  oai21  g27(.a(new_n62_), .b(x23), .c(new_n79_), .O(z03));
  nand2  g28(.a(x24), .b(x18), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n58_), .O(new_n82_));
  nand2  g30(.a(new_n62_), .b(new_n53_), .O(new_n83_));
  nand2  g31(.a(x25), .b(x18), .O(new_n84_));
  oai21  g32(.a(x18), .b(x07), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g37(.a(new_n84_), .b(new_n58_), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n89_), .O(z05));
  nand2  g39(.a(x27), .b(x18), .O(new_n92_));
  inv1   g40(.a(x05), .O(new_n93_));
  nand2  g41(.a(new_n66_), .b(new_n93_), .O(new_n94_));
  nand3  g42(.a(new_n94_), .b(new_n92_), .c(new_n64_), .O(new_n95_));
  oai21  g43(.a(new_n62_), .b(x26), .c(new_n95_), .O(z06));
  inv1   g44(.a(x27), .O(new_n97_));
  nor2   g45(.a(x19), .b(new_n66_), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nor2   g47(.a(x18), .b(x04), .O(new_n100_));
  nand2  g48(.a(new_n64_), .b(new_n59_), .O(new_n101_));
  oai21  g49(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(z07));
  nand2  g50(.a(x28), .b(x18), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n58_), .O(new_n104_));
  nand2  g52(.a(x29), .b(x18), .O(new_n105_));
  oai21  g53(.a(x18), .b(x11), .c(new_n105_), .O(new_n106_));
  oai21  g54(.a(new_n106_), .b(new_n83_), .c(new_n104_), .O(z08));
  nand2  g55(.a(new_n105_), .b(new_n58_), .O(new_n108_));
  nand2  g56(.a(x30), .b(x18), .O(new_n109_));
  oai21  g57(.a(x18), .b(x10), .c(new_n109_), .O(new_n110_));
  oai21  g58(.a(new_n110_), .b(new_n83_), .c(new_n108_), .O(z09));
  inv1   g59(.a(x09), .O(new_n112_));
  oai22  g60(.a(new_n55_), .b(x31), .c(x18), .d(new_n112_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  nand2  g62(.a(new_n109_), .b(new_n58_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n114_), .O(z10));
  inv1   g64(.a(x31), .O(new_n117_));
  nand2  g65(.a(new_n98_), .b(new_n117_), .O(new_n118_));
  nor2   g66(.a(x18), .b(x08), .O(new_n119_));
  nand2  g67(.a(new_n81_), .b(new_n64_), .O(new_n120_));
  oai21  g68(.a(new_n120_), .b(new_n119_), .c(new_n118_), .O(z11));
  inv1   g69(.a(x15), .O(new_n122_));
  oai22  g70(.a(new_n55_), .b(x33), .c(x18), .d(new_n122_), .O(new_n123_));
  ...
  nand2  g77(.a(new_n66_), .b(new_n129_), .O(new_n130_));
  nand3  g78(.a(new_n130_), .b(new_n128_), .c(new_n64_), .O(new_n131_));
  oai21  g79(.a(new_n62_), .b(x33), .c(new_n131_), .O(z13));
  inv1   g80(.a(x34), .O(new_n133_));
  nand2  g81(.a(new_n98_), .b(new_n133_), .O(new_n134_));
  nor2   g82(.a(x18), .b(x13), .O(new_n135_));
  nand2  g83(.a(x35), .b(x18), .O(new_n136_));
  nand2  g84(.a(new_n136_), .b(new_n64_), .O(new_n137_));
  oai21  g85(.a(new_n137_), .b(new_n135_), .c(new_n134_), .O(z14));
  nand2  g86(.a(new_n136_), .b(new_n58_), .O(new_n139_));
  oai21  g87(.a(x18), .b(x12), .c(new_n103_), .O(new_n140_));
  oai21  g88(.a(new_n140_), .b(new_n83_), .c(new_n139_), .O(z15));
endmodule
