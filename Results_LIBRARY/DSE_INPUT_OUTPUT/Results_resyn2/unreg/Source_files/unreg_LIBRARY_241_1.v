...
module FAU ( 
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n89_), .O(new_n114_));
  ...
  aoi21  g077(.a(new_n61_), .b(x18), .c(x09), .O(new_n130_));
  nand2  g078(.a(x31), .b(x18), .O(new_n131_));
  nand3  g079(.a(new_n131_), .b(x19), .c(new_n89_), .O(new_n132_));
  inv1   g080(.a(x30), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n54_), .O(new_n134_));
  oai22  g082(.a(new_n134_), .b(new_n62_), .c(new_n132_), .d(new_n130_), .O(z10));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n89_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n62_), .O(z11));
  aoi21  g090(.a(x19), .b(x09), .c(new_n61_), .O(new_n143_));
  ...
  nor2   g099(.a(new_n151_), .b(new_n62_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n89_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n155_), .c(new_n62_), .O(z14));
  ...
  nand4  g113(.a(new_n165_), .b(new_n163_), .c(x19), .d(new_n89_), .O(new_n166_));
  aoi21  g114(.a(new_n166_), .b(new_n162_), .c(new_n62_), .O(z15));
endmodule
