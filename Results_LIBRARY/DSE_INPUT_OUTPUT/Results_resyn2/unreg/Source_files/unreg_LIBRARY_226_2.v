...
module FAU ( 
  ...
  nand3  g050(.a(new_n53_), .b(new_n93_), .c(new_n56_), .O(new_n103_));
  nand2  g051(.a(new_n66_), .b(new_n54_), .O(new_n104_));
  nand2  g052(.a(x27), .b(x18), .O(new_n105_));
  oai21  g053(.a(x18), .b(x05), .c(new_n105_), .O(new_n106_));
  oai21  g054(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z06));
  ...
  oai21  g059(.a(new_n109_), .b(new_n104_), .c(new_n111_), .O(z07));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n54_), .O(z11));
