...
module FAU ( 
  ...
  aoi21  g066(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n119_));
  ...
  nor2   g073(.a(new_n125_), .b(new_n62_), .O(new_n126_));
  ...
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n62_), .O(z10));
  ...
  nor2   g094(.a(new_n146_), .b(new_n62_), .O(new_n147_));
  ...
  oai21  g111(.a(new_n163_), .b(x17), .c(x19), .O(new_n164_));
  nand2  g112(.a(x35), .b(new_n54_), .O(new_n165_));
  nand2  g113(.a(x19), .b(x18), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(x10), .O(new_n167_));
  nand2  g115(.a(new_n167_), .b(x28), .O(new_n168_));
  nand3  g116(.a(new_n168_), .b(new_n165_), .c(new_n164_), .O(new_n169_));
  inv1   g117(.a(new_n169_), .O(z15));
endmodule
