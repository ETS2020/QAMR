...
module FAU ( 
  ...
  oai21  g027(.a(x18), .b(x00), .c(new_n55_), .O(new_n80_));
  nor2   g028(.a(x23), .b(x19), .O(new_n81_));
  nor2   g029(.a(new_n81_), .b(new_n62_), .O(new_n82_));
  oai21  g030(.a(new_n80_), .b(new_n79_), .c(new_n82_), .O(z03));
  ...
  aoi21  g037(.a(new_n89_), .b(new_n85_), .c(new_n62_), .O(z04));
  nand2  g038(.a(x26), .b(x18), .O(new_n91_));
  inv1   g039(.a(x06), .O(new_n92_));
  nand2  g040(.a(new_n57_), .b(new_n92_), .O(new_n93_));
  nand3  g041(.a(new_n93_), .b(new_n91_), .c(new_n55_), .O(new_n94_));
  nor2   g042(.a(x25), .b(x19), .O(new_n95_));
  nor2   g043(.a(new_n95_), .b(new_n62_), .O(new_n96_));
  ...
  nand3  g048(.a(new_n100_), .b(new_n98_), .c(new_n55_), .O(new_n101_));
  nor2   g049(.a(x26), .b(x19), .O(new_n102_));
  nor2   g050(.a(new_n102_), .b(new_n62_), .O(new_n103_));
  ...
  aoi21  g058(.a(new_n110_), .b(new_n106_), .c(new_n62_), .O(z07));
  ...
  aoi21  g072(.a(new_n124_), .b(new_n120_), .c(new_n62_), .O(z09));
  ...
  aoi21  g086(.a(new_n138_), .b(new_n134_), .c(new_n62_), .O(z11));
  nand2  g087(.a(x33), .b(x19), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(x32), .O(new_n141_));
  inv1   g089(.a(x15), .O(new_n142_));
  nor2   g090(.a(x18), .b(new_n142_), .O(new_n143_));
  nor2   g091(.a(x33), .b(x32), .O(new_n144_));
  aoi22  g092(.a(new_n144_), .b(x18), .c(new_n143_), .d(new_n141_), .O(new_n145_));
  nand2  g093(.a(new_n61_), .b(new_n54_), .O(new_n146_));
  oai21  g094(.a(new_n145_), .b(x17), .c(new_n146_), .O(z12));
  aoi21  g095(.a(x33), .b(x19), .c(new_n144_), .O(new_n148_));
  ...
  nand2  g101(.a(new_n149_), .b(new_n54_), .O(new_n154_));
  ...
  aoi21  g106(.a(new_n158_), .b(new_n154_), .c(new_n62_), .O(z14));
  ...
  nor2   g112(.a(new_n164_), .b(new_n62_), .O(new_n165_));
