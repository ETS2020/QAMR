...
module FAU ( 
  ...
  oai21  g026(.a(x27), .b(new_n54_), .c(new_n62_), .O(new_n79_));
  ...
  oai21  g031(.a(new_n83_), .b(new_n80_), .c(new_n79_), .O(z03));
  inv1   g032(.a(new_n63_), .O(new_n85_));
  ...
  aoi21  g040(.a(new_n92_), .b(new_n87_), .c(new_n85_), .O(z04));
  ...
  oai21  g048(.a(new_n62_), .b(x18), .c(x27), .O(new_n101_));
  ...
  aoi21  g068(.a(new_n120_), .b(new_n116_), .c(new_n85_), .O(z08));
  ...
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n85_), .O(z13));
  ...
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n85_), .O(z14));
  ...
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n85_), .O(z15));
endmodule
