...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x09), .O(new_n63_));
  ...
  inv1   g034(.a(new_n63_), .O(new_n87_));
  ...
  nand4  g062(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n90_), .O(new_n115_));
  aoi21  g063(.a(new_n115_), .b(new_n111_), .c(new_n87_), .O(z07));
  ...
  nand4  g076(.a(new_n128_), .b(new_n126_), .c(x19), .d(new_n90_), .O(new_n129_));
  aoi21  g077(.a(new_n129_), .b(new_n125_), .c(new_n87_), .O(z09));
  nand2  g078(.a(x31), .b(x18), .O(new_n131_));
  inv1   g079(.a(x09), .O(new_n132_));
  nand2  g080(.a(new_n57_), .b(new_n132_), .O(new_n133_));
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n90_), .O(new_n134_));
  nand2  g082(.a(x30), .b(new_n54_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n63_), .O(new_n136_));
  aoi21  g084(.a(new_n134_), .b(x19), .c(new_n136_), .O(z10));
  nand2  g085(.a(new_n63_), .b(new_n55_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n62_), .b(new_n54_), .c(new_n132_), .O(new_n146_));
  oai21  g094(.a(new_n145_), .b(new_n138_), .c(new_n146_), .O(z12));
  ...
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n63_), .O(z13));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n90_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n87_), .O(z14));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n90_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n87_), .O(z15));
endmodule
