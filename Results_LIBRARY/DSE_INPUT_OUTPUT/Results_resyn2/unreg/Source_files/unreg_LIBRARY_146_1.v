...
module FAU ( 
  ...
  inv1   g034(.a(new_n54_), .O(new_n87_));
  inv1   g035(.a(x17), .O(new_n88_));
  inv1   g036(.a(x25), .O(new_n89_));
  nand4  g037(.a(new_n89_), .b(x19), .c(x18), .d(new_n88_), .O(new_n90_));
  inv1   g038(.a(x24), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n55_), .O(new_n92_));
  nand4  g040(.a(x19), .b(new_n61_), .c(new_n88_), .d(x07), .O(new_n93_));
  nand3  g041(.a(new_n93_), .b(new_n92_), .c(new_n90_), .O(new_n94_));
  and2   g042(.a(new_n94_), .b(new_n87_), .O(z04));
  inv1   g043(.a(x26), .O(new_n96_));
  nand4  g044(.a(new_n96_), .b(x19), .c(x18), .d(new_n88_), .O(new_n97_));
  nand2  g045(.a(new_n89_), .b(new_n55_), .O(new_n98_));
  nand4  g046(.a(x19), .b(new_n61_), .c(new_n88_), .d(x06), .O(new_n99_));
  nand3  g047(.a(new_n99_), .b(new_n98_), .c(new_n97_), .O(new_n100_));
  and2   g048(.a(new_n100_), .b(new_n87_), .O(z05));
  oai21  g049(.a(x32), .b(new_n55_), .c(new_n96_), .O(new_n102_));
  ...
  nand2  g067(.a(new_n119_), .b(new_n55_), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n87_), .O(z08));
  ...
  nand3  g095(.a(new_n147_), .b(new_n146_), .c(new_n87_), .O(z12));
