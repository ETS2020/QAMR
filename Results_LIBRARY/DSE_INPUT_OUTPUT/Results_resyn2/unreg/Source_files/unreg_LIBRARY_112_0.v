...
module FAU ( 
  ...
  nor2   g008(.a(x28), .b(x27), .O(new_n61_));
  ...
  oai21  g055(.a(new_n107_), .b(new_n54_), .c(new_n106_), .O(new_n108_));
  ...
  oai21  g061(.a(new_n106_), .b(new_n54_), .c(new_n107_), .O(new_n114_));
  ...
  aoi21  g094(.a(new_n146_), .b(new_n142_), .c(new_n61_), .O(z12));
  ...
  inv1   g102(.a(new_n61_), .O(new_n155_));
  ...
  nand2  g107(.a(new_n159_), .b(new_n54_), .O(new_n160_));
  nand4  g108(.a(x19), .b(new_n57_), .c(new_n156_), .d(x13), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  and2   g110(.a(new_n162_), .b(new_n155_), .O(z14));
  nand4  g111(.a(new_n107_), .b(x19), .c(x18), .d(new_n156_), .O(new_n164_));
  nand2  g112(.a(new_n157_), .b(new_n54_), .O(new_n165_));
  nand4  g113(.a(x19), .b(new_n57_), .c(new_n156_), .d(x12), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  and2   g115(.a(new_n167_), .b(new_n155_), .O(z15));
endmodule
