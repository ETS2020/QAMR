// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:39 2020
...
module FAU ( 
  ...
  inv1   g043(.a(x32), .O(new_n96_));
  nand3  g044(.a(new_n96_), .b(new_n62_), .c(new_n54_), .O(new_n97_));
  nand2  g045(.a(new_n63_), .b(new_n55_), .O(new_n98_));
  nand2  g046(.a(x26), .b(x18), .O(new_n99_));
  oai21  g047(.a(x18), .b(x06), .c(new_n99_), .O(new_n100_));
  oai21  g048(.a(new_n100_), .b(new_n98_), .c(new_n97_), .O(z05));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n68_), .O(new_n107_));
  ...
  nand3  g062(.a(new_n114_), .b(new_n112_), .c(new_n63_), .O(z07));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n68_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n65_), .O(z08));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n68_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n65_), .O(z09));
  ...
  nand3  g083(.a(new_n135_), .b(new_n133_), .c(new_n63_), .O(z10));
  ...
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n63_), .O(z11));
  nand2  g091(.a(new_n96_), .b(new_n54_), .O(new_n144_));
  ...
  nand3  g096(.a(new_n148_), .b(new_n144_), .c(new_n63_), .O(z12));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n68_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n65_), .O(z13));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n68_), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n65_), .O(z14));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n68_), .O(new_n169_));
