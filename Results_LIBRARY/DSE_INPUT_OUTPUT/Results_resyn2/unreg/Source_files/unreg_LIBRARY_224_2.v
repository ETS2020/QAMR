...
module FAU ( 
  ...
  nand4  g055(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n75_), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(new_n104_), .c(new_n72_), .O(z06));
  ...
  nand3  g092(.a(new_n62_), .b(new_n135_), .c(new_n54_), .O(new_n145_));
