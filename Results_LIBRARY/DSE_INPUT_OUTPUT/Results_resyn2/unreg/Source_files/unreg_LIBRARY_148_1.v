...
module FAU ( 
  ...
  nand2  g075(.a(x29), .b(new_n56_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n54_), .O(new_n129_));
  aoi21  g077(.a(new_n127_), .b(x19), .c(new_n129_), .O(z09));
  inv1   g078(.a(x32), .O(new_n131_));
  nand3  g079(.a(new_n131_), .b(new_n53_), .c(new_n56_), .O(new_n132_));
  nand2  g080(.a(new_n73_), .b(new_n54_), .O(new_n133_));
  nand2  g081(.a(x31), .b(x18), .O(new_n134_));
  oai21  g082(.a(x18), .b(x09), .c(new_n134_), .O(new_n135_));
  oai21  g083(.a(new_n135_), .b(new_n133_), .c(new_n132_), .O(z10));
  ...
  oai21  g088(.a(new_n138_), .b(new_n133_), .c(new_n140_), .O(z11));
  nand2  g089(.a(new_n131_), .b(new_n56_), .O(new_n142_));
  nand2  g090(.a(x33), .b(x18), .O(new_n143_));
  inv1   g091(.a(x15), .O(new_n144_));
  nand2  g092(.a(new_n62_), .b(new_n144_), .O(new_n145_));
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n73_), .O(new_n146_));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n54_), .O(z15));
endmodule
