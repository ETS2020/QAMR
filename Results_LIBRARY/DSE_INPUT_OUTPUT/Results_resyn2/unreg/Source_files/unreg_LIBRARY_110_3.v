...
module FAU ( 
  ...
  oai21  g000(.a(x32), .b(x18), .c(x21), .O(new_n53_));
  ...
  nor2   g009(.a(x20), .b(x19), .O(new_n62_));
  oai21  g010(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(new_n63_));
  nand2  g011(.a(new_n63_), .b(new_n59_), .O(z00));
  aoi21  g012(.a(new_n61_), .b(x19), .c(new_n60_), .O(new_n65_));
  ...
  aoi21  g018(.a(new_n70_), .b(x19), .c(new_n65_), .O(z01));
  ...
  nor2   g023(.a(new_n61_), .b(new_n60_), .O(new_n76_));
  nor2   g024(.a(x22), .b(x19), .O(new_n77_));
  nor2   g025(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g026(.a(new_n78_), .b(new_n75_), .O(z02));
  ...
  nand4  g033(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n66_), .O(new_n86_));
  aoi21  g034(.a(new_n86_), .b(new_n81_), .c(new_n76_), .O(z03));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n66_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n76_), .O(z04));
  ...
  nor2   g054(.a(new_n106_), .b(new_n76_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n66_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n76_), .O(z07));
  ...
  nor2   g068(.a(new_n120_), .b(new_n76_), .O(new_n121_));
  ...
  nor2   g075(.a(new_n127_), .b(new_n76_), .O(new_n128_));
  ...
  nor2   g082(.a(new_n134_), .b(new_n76_), .O(new_n135_));
  ...
  nor2   g089(.a(new_n141_), .b(new_n76_), .O(new_n142_));
  ...
  aoi21  g095(.a(new_n61_), .b(new_n54_), .c(new_n76_), .O(new_n148_));
  ...
  nor2   g102(.a(new_n154_), .b(new_n76_), .O(new_n155_));
  ...
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n76_), .O(z14));
  ...
  nor2   g116(.a(new_n168_), .b(new_n76_), .O(new_n169_));
