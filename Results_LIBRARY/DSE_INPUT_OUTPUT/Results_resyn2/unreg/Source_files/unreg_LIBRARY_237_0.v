...
module FAU ( 
  ...
  aoi21  g076(.a(x32), .b(x18), .c(x09), .O(new_n129_));
  nand2  g077(.a(x31), .b(x18), .O(new_n130_));
  nand3  g078(.a(new_n130_), .b(x19), .c(new_n66_), .O(new_n131_));
  inv1   g079(.a(x30), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n54_), .O(new_n133_));
  oai22  g081(.a(new_n133_), .b(new_n61_), .c(new_n131_), .d(new_n129_), .O(z10));
  ...
  nand2  g090(.a(x19), .b(x09), .O(new_n143_));
