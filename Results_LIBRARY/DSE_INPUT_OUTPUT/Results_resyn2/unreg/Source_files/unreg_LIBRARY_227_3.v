...
module FAU ( 
  ...
  aoi21  g062(.a(new_n88_), .b(x19), .c(new_n89_), .O(new_n115_));
  ...
  nand2  g075(.a(new_n61_), .b(new_n127_), .O(new_n128_));
  nand3  g076(.a(new_n128_), .b(new_n126_), .c(new_n65_), .O(new_n129_));
  inv1   g077(.a(x30), .O(new_n130_));
  aoi21  g078(.a(new_n130_), .b(new_n55_), .c(new_n54_), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(new_n129_), .O(z10));
  oai21  g080(.a(x28), .b(x18), .c(x24), .O(new_n133_));
  inv1   g081(.a(x08), .O(new_n134_));
  nand2  g082(.a(new_n61_), .b(new_n134_), .O(new_n135_));
  nand3  g083(.a(new_n135_), .b(new_n133_), .c(new_n65_), .O(new_n136_));
  inv1   g084(.a(x31), .O(new_n137_));
  nand3  g085(.a(new_n53_), .b(new_n137_), .c(new_n55_), .O(new_n138_));
  ...
  nand4  g092(.a(new_n144_), .b(new_n142_), .c(x19), .d(new_n58_), .O(new_n145_));
  aoi21  g093(.a(new_n145_), .b(new_n141_), .c(new_n54_), .O(z12));
  ...
  oai21  g108(.a(x24), .b(x18), .c(x28), .O(new_n161_));
