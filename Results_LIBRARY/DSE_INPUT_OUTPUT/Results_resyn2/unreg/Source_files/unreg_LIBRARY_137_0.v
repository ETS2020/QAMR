...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x21), .O(new_n61_));
  ...
  nand4  g066(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n66_), .O(new_n119_));
  ...
  oai21  g090(.a(new_n64_), .b(new_n54_), .c(new_n142_), .O(new_n143_));
