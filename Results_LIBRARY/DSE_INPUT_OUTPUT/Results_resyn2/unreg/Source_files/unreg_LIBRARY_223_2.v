...
module FAU ( 
  ...
  aoi21  g060(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n113_));
  nand2  g061(.a(new_n113_), .b(new_n112_), .O(z07));
  nand2  g062(.a(x29), .b(x18), .O(new_n115_));
  inv1   g063(.a(x11), .O(new_n116_));
  nand2  g064(.a(new_n61_), .b(new_n116_), .O(new_n117_));
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n65_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n65_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n65_), .O(new_n132_));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n65_), .O(new_n139_));
  ...
  oai21  g091(.a(x27), .b(new_n55_), .c(new_n143_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n61_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n65_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n144_), .O(z12));
  inv1   g097(.a(x33), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n55_), .O(new_n151_));
  nand2  g099(.a(x34), .b(x18), .O(new_n152_));
  inv1   g100(.a(x14), .O(new_n153_));
  nand2  g101(.a(new_n61_), .b(new_n153_), .O(new_n154_));
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n58_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n54_), .O(z13));
  ...
  nand2  g108(.a(new_n61_), .b(new_n160_), .O(new_n161_));
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n58_), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n54_), .O(z14));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  inv1   g112(.a(x12), .O(new_n165_));
  nand2  g113(.a(new_n61_), .b(new_n165_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n65_), .O(new_n167_));
  nor2   g115(.a(x35), .b(x19), .O(new_n168_));
  nor2   g116(.a(new_n168_), .b(new_n54_), .O(new_n169_));
