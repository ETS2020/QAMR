...
module FAU ( 
  ...
  nor2   g079(.a(x32), .b(x30), .O(new_n132_));
  aoi21  g080(.a(x30), .b(x19), .c(new_n132_), .O(new_n133_));
  aoi21  g081(.a(new_n131_), .b(x19), .c(new_n133_), .O(z10));
  ...
  aoi21  g089(.a(x30), .b(x19), .c(new_n53_), .O(new_n142_));
  ...
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n65_), .O(new_n156_));
  nor2   g104(.a(x34), .b(x19), .O(new_n157_));
  nor2   g105(.a(new_n157_), .b(new_n54_), .O(new_n158_));
