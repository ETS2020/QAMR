...
module FAU ( 
  ...
  nand2  g000(.a(x32), .b(x30), .O(new_n53_));
  ...
  oai21  g070(.a(x32), .b(x18), .c(x30), .O(new_n123_));
  inv1   g071(.a(x10), .O(new_n124_));
  nand2  g072(.a(new_n61_), .b(new_n124_), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n72_), .O(new_n126_));
  inv1   g074(.a(x29), .O(new_n127_));
  nand3  g075(.a(new_n53_), .b(new_n127_), .c(new_n55_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n126_), .O(z09));
  inv1   g077(.a(x30), .O(new_n130_));
  inv1   g078(.a(x32), .O(new_n131_));
  aoi21  g079(.a(new_n131_), .b(x19), .c(new_n130_), .O(new_n132_));
  aoi21  g080(.a(x31), .b(x18), .c(x17), .O(new_n133_));
  oai21  g081(.a(x18), .b(x09), .c(new_n133_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(x19), .c(new_n132_), .O(z10));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n72_), .O(new_n146_));
  aoi21  g094(.a(new_n131_), .b(new_n55_), .c(new_n54_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n146_), .O(z12));
  inv1   g096(.a(x33), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n55_), .O(new_n150_));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n61_), .b(new_n152_), .O(new_n153_));
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n58_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n54_), .O(z13));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n58_), .O(new_n161_));
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n54_), .O(z14));
