...
module FAU ( 
  ...
  nand2  g017(.a(x29), .b(x22), .O(new_n70_));
  ...
  nand2  g024(.a(x29), .b(x23), .O(new_n77_));
  ...
  nand2  g032(.a(x29), .b(x24), .O(new_n85_));
  ...
  inv1   g073(.a(new_n125_), .O(z09));
  inv1   g074(.a(x30), .O(new_n127_));
  nand2  g075(.a(new_n94_), .b(new_n127_), .O(new_n128_));
  ...
  nand2  g082(.a(new_n94_), .b(new_n134_), .O(new_n135_));
  ...
  nand2  g089(.a(new_n94_), .b(new_n141_), .O(new_n142_));
  ...
  nand2  g102(.a(x34), .b(x29), .O(new_n155_));
  ...
  nand2  g109(.a(x35), .b(x29), .O(new_n162_));
