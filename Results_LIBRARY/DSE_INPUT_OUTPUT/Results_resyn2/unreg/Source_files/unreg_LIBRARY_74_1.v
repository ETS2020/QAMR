...
module FAU ( 
  ...
  nand2  g057(.a(new_n62_), .b(new_n54_), .O(new_n110_));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n68_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n65_), .O(z13));
