...
module FAU ( 
  ...
  nor2   g092(.a(x34), .b(x33), .O(new_n145_));
  aoi21  g093(.a(x33), .b(new_n57_), .c(new_n145_), .O(new_n146_));
  inv1   g094(.a(x15), .O(new_n147_));
  nand2  g095(.a(new_n57_), .b(new_n147_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n55_), .O(new_n149_));
  nor2   g097(.a(x32), .b(x19), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n63_), .O(new_n151_));
  oai21  g099(.a(new_n149_), .b(new_n146_), .c(new_n151_), .O(z12));
  nand2  g100(.a(new_n145_), .b(new_n54_), .O(new_n153_));
  oai21  g101(.a(new_n62_), .b(x18), .c(x34), .O(new_n154_));
  ...
  nand2  g105(.a(new_n157_), .b(new_n153_), .O(z13));
  inv1   g106(.a(x34), .O(new_n159_));
  aoi21  g107(.a(x33), .b(x19), .c(new_n159_), .O(new_n160_));
  aoi21  g108(.a(x35), .b(x18), .c(x17), .O(new_n161_));
  oai21  g109(.a(x18), .b(x13), .c(new_n161_), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(x19), .c(new_n160_), .O(z14));
