...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x26), .O(new_n53_));
  ...
  nand3  g053(.a(x30), .b(new_n100_), .c(new_n54_), .O(new_n106_));
  ...
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n64_), .O(new_n116_));
  ...
  oai21  g074(.a(new_n100_), .b(new_n54_), .c(new_n101_), .O(new_n127_));
  ...
  nand4  g085(.a(new_n137_), .b(new_n135_), .c(x19), .d(new_n57_), .O(new_n138_));
  aoi21  g086(.a(new_n138_), .b(new_n134_), .c(new_n53_), .O(z11));
  nand2  g087(.a(x33), .b(x18), .O(new_n140_));
  inv1   g088(.a(x15), .O(new_n141_));
  nand2  g089(.a(new_n60_), .b(new_n141_), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n64_), .O(new_n143_));
  nor2   g091(.a(x32), .b(x19), .O(new_n144_));
  nor2   g092(.a(new_n144_), .b(new_n53_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n151_), .b(new_n149_), .c(x19), .d(new_n57_), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n148_), .c(new_n53_), .O(z13));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n57_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n155_), .c(new_n53_), .O(z14));
  ...
  nand4  g113(.a(new_n165_), .b(new_n163_), .c(x19), .d(new_n57_), .O(new_n166_));
  aoi21  g114(.a(new_n166_), .b(new_n162_), .c(new_n53_), .O(z15));
endmodule
