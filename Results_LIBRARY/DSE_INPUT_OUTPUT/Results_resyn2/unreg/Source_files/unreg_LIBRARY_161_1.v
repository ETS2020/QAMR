...
module FAU ( 
  ...
  nand4  g37(.a(new_n56_), .b(x19), .c(x18), .d(new_n71_), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n89_), .O(z07));
  oai21  g39(.a(x29), .b(x17), .c(x18), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(x19), .O(new_n93_));
  inv1   g41(.a(x28), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n55_), .O(new_n95_));
  ...
  nand4  g47(.a(new_n99_), .b(x19), .c(x18), .d(new_n71_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n98_), .O(z09));
  oai21  g49(.a(x31), .b(x17), .c(x18), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(x19), .O(new_n103_));
  nand2  g51(.a(new_n99_), .b(new_n55_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n103_), .O(z10));
  inv1   g53(.a(x31), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n55_), .O(new_n107_));
  nand4  g55(.a(new_n74_), .b(x19), .c(x18), .d(new_n71_), .O(new_n108_));
  ...
  nand2  g75(.a(new_n127_), .b(new_n55_), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n126_), .O(z15));
endmodule
