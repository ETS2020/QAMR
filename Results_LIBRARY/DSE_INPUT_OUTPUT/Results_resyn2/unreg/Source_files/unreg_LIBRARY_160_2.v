...
module FAU ( 
  ...
  nand4  g039(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n80_), .O(new_n92_));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n80_), .O(new_n120_));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n80_), .O(new_n134_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n80_), .O(new_n141_));
  ...
  oai21  g105(.a(x20), .b(new_n54_), .c(new_n157_), .O(new_n158_));
