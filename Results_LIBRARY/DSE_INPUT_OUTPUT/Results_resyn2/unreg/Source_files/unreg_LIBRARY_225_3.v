...
module FAU ( 
  ...
  aoi21  g013(.a(new_n62_), .b(x19), .c(new_n61_), .O(new_n66_));
  ...
  nand3  g018(.a(new_n70_), .b(new_n68_), .c(new_n67_), .O(new_n71_));
  aoi21  g019(.a(new_n71_), .b(x19), .c(new_n66_), .O(z01));
  ...
  aoi21  g039(.a(new_n62_), .b(new_n54_), .c(new_n63_), .O(new_n92_));
  nand2  g040(.a(new_n92_), .b(new_n91_), .O(z04));
  ...
  nor2   g046(.a(new_n98_), .b(new_n63_), .O(new_n99_));
  ...
  nor2   g053(.a(new_n105_), .b(new_n63_), .O(new_n106_));
  ...
  nand4  g060(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n67_), .O(new_n113_));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n67_), .O(new_n120_));
  ...
  nor2   g095(.a(new_n147_), .b(new_n63_), .O(new_n148_));
  ...
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n63_), .O(z13));
  ...
  nor2   g109(.a(new_n161_), .b(new_n63_), .O(new_n162_));
  ...
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n63_), .O(z15));
endmodule
