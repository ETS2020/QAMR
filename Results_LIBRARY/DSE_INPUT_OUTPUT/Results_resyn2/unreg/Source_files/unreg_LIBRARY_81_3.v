// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:56 2020
...
module FAU ( 
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n59_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n55_), .O(z04));
  nor2   g042(.a(new_n56_), .b(x17), .O(new_n95_));
  nand2  g043(.a(x26), .b(x18), .O(new_n96_));
  inv1   g044(.a(x06), .O(new_n97_));
  nand2  g045(.a(new_n62_), .b(new_n97_), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n96_), .c(new_n95_), .O(new_n99_));
  nor2   g047(.a(x25), .b(x19), .O(new_n100_));
  nor2   g048(.a(new_n100_), .b(new_n55_), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n99_), .O(z05));
  nand2  g050(.a(x27), .b(x18), .O(new_n103_));
  inv1   g051(.a(x05), .O(new_n104_));
  nand2  g052(.a(new_n62_), .b(new_n104_), .O(new_n105_));
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n95_), .O(new_n106_));
  aoi21  g054(.a(new_n53_), .b(new_n56_), .c(new_n55_), .O(new_n107_));
  nand2  g055(.a(new_n107_), .b(new_n106_), .O(z06));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n95_), .O(new_n119_));
  ...
  nand2  g071(.a(new_n123_), .b(new_n56_), .O(new_n124_));
  nand2  g072(.a(x30), .b(x18), .O(new_n125_));
  inv1   g073(.a(x10), .O(new_n126_));
  nand2  g074(.a(new_n62_), .b(new_n126_), .O(new_n127_));
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n59_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n55_), .O(z09));
  nand2  g077(.a(x31), .b(x18), .O(new_n130_));
  inv1   g078(.a(x09), .O(new_n131_));
  nand2  g079(.a(new_n62_), .b(new_n131_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n95_), .O(new_n133_));
  nor2   g081(.a(x30), .b(x19), .O(new_n134_));
  nor2   g082(.a(new_n134_), .b(new_n55_), .O(new_n135_));
