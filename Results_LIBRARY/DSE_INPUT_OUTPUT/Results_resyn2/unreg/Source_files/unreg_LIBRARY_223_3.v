...
module FAU ( 
  ...
  aoi21  g061(.a(new_n53_), .b(new_n56_), .c(new_n55_), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n113_), .O(z07));
  nand2  g063(.a(x29), .b(x18), .O(new_n116_));
  inv1   g064(.a(x11), .O(new_n117_));
  nand2  g065(.a(new_n62_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n66_), .O(new_n119_));
