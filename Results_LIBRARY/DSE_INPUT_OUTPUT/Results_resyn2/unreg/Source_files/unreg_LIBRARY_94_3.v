...
module FAU ( 
  ...
  aoi21  g05(.a(new_n57_), .b(new_n54_), .c(x24), .O(new_n58_));
  ...
  aoi21  g12(.a(new_n64_), .b(new_n62_), .c(x24), .O(new_n65_));
  ...
  aoi21  g26(.a(new_n78_), .b(new_n76_), .c(x24), .O(new_n79_));
  ...
  oai21  g33(.a(new_n83_), .b(new_n56_), .c(new_n85_), .O(new_n86_));
  aoi21  g34(.a(new_n86_), .b(x19), .c(x24), .O(z04));
  nand2  g35(.a(x26), .b(x18), .O(new_n88_));
  inv1   g36(.a(x06), .O(new_n89_));
  aoi21  g37(.a(new_n56_), .b(new_n89_), .c(x17), .O(new_n90_));
  aoi21  g38(.a(new_n90_), .b(new_n88_), .c(x24), .O(new_n91_));
  nand2  g39(.a(new_n83_), .b(new_n53_), .O(new_n92_));
  oai21  g40(.a(new_n91_), .b(new_n53_), .c(new_n92_), .O(z05));
  nand2  g41(.a(x27), .b(x18), .O(new_n94_));
  inv1   g42(.a(x05), .O(new_n95_));
  aoi21  g43(.a(new_n56_), .b(new_n95_), .c(x17), .O(new_n96_));
  aoi21  g44(.a(new_n96_), .b(new_n94_), .c(x24), .O(new_n97_));
  inv1   g45(.a(x26), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  oai21  g47(.a(new_n97_), .b(new_n53_), .c(new_n99_), .O(z06));
  nand2  g48(.a(x20), .b(x18), .O(new_n101_));
  oai21  g49(.a(x18), .b(x04), .c(new_n101_), .O(new_n102_));
  oai22  g50(.a(new_n102_), .b(new_n71_), .c(x27), .d(x19), .O(z07));
  nand2  g51(.a(x29), .b(x18), .O(new_n104_));
  inv1   g52(.a(x11), .O(new_n105_));
  aoi21  g53(.a(new_n56_), .b(new_n105_), .c(x17), .O(new_n106_));
  aoi21  g54(.a(new_n106_), .b(new_n104_), .c(x24), .O(new_n107_));
  inv1   g55(.a(x28), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n53_), .O(new_n109_));
  oai21  g57(.a(new_n107_), .b(new_n53_), .c(new_n109_), .O(z08));
  nand2  g58(.a(x30), .b(x18), .O(new_n111_));
  inv1   g59(.a(x10), .O(new_n112_));
  aoi21  g60(.a(new_n56_), .b(new_n112_), .c(x17), .O(new_n113_));
  aoi21  g61(.a(new_n113_), .b(new_n111_), .c(x24), .O(new_n114_));
  inv1   g62(.a(x29), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n53_), .O(new_n116_));
  oai21  g64(.a(new_n114_), .b(new_n53_), .c(new_n116_), .O(z09));
  nand2  g65(.a(x31), .b(x18), .O(new_n118_));
  inv1   g66(.a(x09), .O(new_n119_));
  aoi21  g67(.a(new_n56_), .b(new_n119_), .c(x17), .O(new_n120_));
  aoi21  g68(.a(new_n120_), .b(new_n118_), .c(x24), .O(new_n121_));
  inv1   g69(.a(x30), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  oai21  g71(.a(new_n121_), .b(new_n53_), .c(new_n123_), .O(z10));
  nor2   g72(.a(x18), .b(x08), .O(new_n125_));
  oai22  g73(.a(new_n125_), .b(new_n71_), .c(x31), .d(x19), .O(z11));
  nand2  g74(.a(x33), .b(x18), .O(new_n127_));
  inv1   g75(.a(x15), .O(new_n128_));
  aoi21  g76(.a(new_n56_), .b(new_n128_), .c(x17), .O(new_n129_));
  aoi21  g77(.a(new_n129_), .b(new_n127_), .c(x24), .O(new_n130_));
  ...
  oai22  g83(.a(new_n135_), .b(new_n71_), .c(x33), .d(x19), .O(z13));
  nand2  g84(.a(x35), .b(x18), .O(new_n137_));
  inv1   g85(.a(x13), .O(new_n138_));
  aoi21  g86(.a(new_n56_), .b(new_n138_), .c(x17), .O(new_n139_));
  aoi21  g87(.a(new_n139_), .b(new_n137_), .c(x24), .O(new_n140_));
  inv1   g88(.a(x34), .O(new_n141_));
  nand2  g89(.a(new_n141_), .b(new_n53_), .O(new_n142_));
  oai21  g90(.a(new_n140_), .b(new_n53_), .c(new_n142_), .O(z14));
  nand2  g91(.a(x28), .b(x18), .O(new_n144_));
  oai21  g92(.a(x18), .b(x12), .c(new_n144_), .O(new_n145_));
  oai22  g93(.a(new_n145_), .b(new_n71_), .c(x35), .d(x19), .O(z15));
endmodule
