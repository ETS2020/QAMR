// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:02 2020
...
module FAU ( 
  ...
  nand2  g008(.a(x35), .b(x32), .O(new_n61_));
  ...
  aoi21  g017(.a(new_n69_), .b(new_n54_), .c(new_n62_), .O(new_n70_));
  ...
  nand4  g033(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n74_), .O(new_n86_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n54_), .c(new_n62_), .O(new_n114_));
  ...
  aoi21  g068(.a(new_n120_), .b(new_n54_), .c(new_n62_), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n134_), .b(new_n54_), .c(new_n62_), .O(new_n135_));
  ...
  aoi21  g089(.a(new_n141_), .b(new_n54_), .c(new_n62_), .O(new_n142_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n55_), .O(new_n147_));
  inv1   g095(.a(x32), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n54_), .c(new_n62_), .O(new_n149_));
  ...
  aoi21  g103(.a(new_n155_), .b(new_n54_), .c(new_n62_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n154_), .O(z13));
  oai21  g105(.a(x32), .b(x18), .c(x35), .O(new_n158_));
