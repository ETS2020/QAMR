...
module FAU ( 
  ...
  oai21  g035(.a(new_n87_), .b(new_n54_), .c(new_n86_), .O(new_n88_));
  nand2  g036(.a(x25), .b(x18), .O(new_n89_));
  inv1   g037(.a(x07), .O(new_n90_));
  nand2  g038(.a(new_n60_), .b(new_n90_), .O(new_n91_));
  nand3  g039(.a(new_n91_), .b(new_n89_), .c(new_n79_), .O(new_n92_));
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n79_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n79_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n79_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n79_), .O(new_n132_));
  ...
  nand2  g090(.a(new_n87_), .b(new_n86_), .O(new_n143_));
  nand2  g091(.a(new_n79_), .b(new_n143_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n87_), .b(x24), .c(new_n54_), .O(new_n147_));
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n79_), .O(new_n157_));
