...
module FAU ( 
  ...
  nand2  g038(.a(new_n61_), .b(new_n53_), .O(new_n91_));
  nand4  g039(.a(new_n91_), .b(new_n90_), .c(x19), .d(new_n58_), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n89_), .c(new_n54_), .O(z04));
  nand2  g041(.a(x26), .b(x18), .O(new_n94_));
  inv1   g042(.a(x06), .O(new_n95_));
  nand2  g043(.a(new_n61_), .b(new_n95_), .O(new_n96_));
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n79_), .O(new_n97_));
  ...
  nand4  g053(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n58_), .O(new_n106_));
  ...
  oai21  g105(.a(new_n55_), .b(x07), .c(new_n157_), .O(new_n158_));
  nand2  g106(.a(x35), .b(x18), .O(new_n159_));
  inv1   g107(.a(x13), .O(new_n160_));
  nand2  g108(.a(new_n61_), .b(new_n160_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n79_), .O(new_n162_));
