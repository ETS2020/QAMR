...
module FAU ( 
  ...
  nand2  g18(.a(x19), .b(x16), .O(new_n71_));
  oai21  g19(.a(new_n71_), .b(new_n57_), .c(new_n70_), .O(z03));
  ...
  oai21  g29(.a(new_n81_), .b(new_n57_), .c(new_n79_), .O(z05));
  nand2  g30(.a(new_n80_), .b(new_n53_), .O(new_n83_));
  ...
  nand2  g53(.a(new_n75_), .b(x19), .O(new_n106_));
  ...
  nand2  g71(.a(new_n92_), .b(x19), .O(new_n124_));
  oai21  g72(.a(new_n124_), .b(new_n57_), .c(new_n123_), .O(z15));
endmodule
