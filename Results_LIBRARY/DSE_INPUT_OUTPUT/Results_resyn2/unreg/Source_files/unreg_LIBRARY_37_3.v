...
module FAU ( 
  ...
  nand3  g058(.a(new_n110_), .b(new_n108_), .c(new_n65_), .O(new_n111_));
  inv1   g059(.a(x27), .O(new_n112_));
  aoi21  g060(.a(new_n112_), .b(new_n55_), .c(new_n54_), .O(new_n113_));
  ...
  aoi21  g067(.a(new_n119_), .b(new_n55_), .c(new_n54_), .O(new_n120_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n65_), .O(new_n146_));
  aoi21  g094(.a(new_n103_), .b(new_n55_), .c(new_n54_), .O(new_n147_));
  ...
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n65_), .O(new_n166_));
