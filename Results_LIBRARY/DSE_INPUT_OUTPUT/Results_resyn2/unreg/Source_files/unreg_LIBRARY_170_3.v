// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:44 2020
...
module FAU ( 
  ...
  nand2  g000(.a(x32), .b(x26), .O(new_n53_));
  ...
  nand3  g023(.a(new_n75_), .b(new_n73_), .c(new_n65_), .O(new_n76_));
  inv1   g024(.a(x22), .O(new_n77_));
  aoi21  g025(.a(new_n77_), .b(new_n55_), .c(new_n54_), .O(new_n78_));
  ...
  oai21  g042(.a(x32), .b(x18), .c(x26), .O(new_n95_));
  ...
  nand3  g047(.a(new_n53_), .b(new_n99_), .c(new_n55_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n98_), .O(z05));
  nand2  g049(.a(x27), .b(x18), .O(new_n102_));
  inv1   g050(.a(x05), .O(new_n103_));
  nand2  g051(.a(new_n61_), .b(new_n103_), .O(new_n104_));
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n65_), .O(new_n105_));
  inv1   g053(.a(x26), .O(new_n106_));
  aoi21  g054(.a(new_n106_), .b(new_n55_), .c(new_n54_), .O(new_n107_));
  ...
  aoi21  g092(.a(new_n106_), .b(x19), .c(new_n144_), .O(new_n145_));
  aoi21  g093(.a(x33), .b(x18), .c(x17), .O(new_n146_));
  oai21  g094(.a(x18), .b(x15), .c(new_n146_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(x19), .c(new_n145_), .O(z12));
  nand2  g096(.a(x34), .b(x18), .O(new_n149_));
  inv1   g097(.a(x14), .O(new_n150_));
  nand2  g098(.a(new_n61_), .b(new_n150_), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n65_), .O(new_n152_));
  inv1   g100(.a(x33), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n55_), .c(new_n54_), .O(new_n154_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n65_), .O(new_n159_));
  inv1   g107(.a(x34), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n55_), .c(new_n54_), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n159_), .O(z14));
  inv1   g110(.a(x35), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n55_), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n61_), .b(new_n166_), .O(new_n167_));
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n58_), .O(new_n168_));
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n54_), .O(z15));
endmodule
