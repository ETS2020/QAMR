...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x12), .O(new_n53_));
  ...
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n64_), .O(new_n138_));
  ...
  nand2  g090(.a(x19), .b(x12), .O(new_n143_));
  ...
  aoi21  g111(.a(x32), .b(x18), .c(x12), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  nand3  g113(.a(new_n165_), .b(x19), .c(new_n57_), .O(new_n166_));
  inv1   g114(.a(x35), .O(new_n167_));
  nand2  g115(.a(new_n167_), .b(new_n54_), .O(new_n168_));
  oai22  g116(.a(new_n168_), .b(new_n53_), .c(new_n166_), .d(new_n164_), .O(z15));
endmodule
