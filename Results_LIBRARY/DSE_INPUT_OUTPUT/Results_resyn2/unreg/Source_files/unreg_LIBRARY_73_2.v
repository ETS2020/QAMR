...
module FAU ( 
  ...
  oai21  g092(.a(new_n62_), .b(x18), .c(x33), .O(new_n145_));
  ...
  nor2   g096(.a(x32), .b(x19), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n63_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n148_), .O(z12));
  inv1   g099(.a(x33), .O(new_n152_));
  aoi21  g100(.a(x35), .b(x19), .c(new_n152_), .O(new_n153_));
  nand2  g101(.a(x34), .b(x18), .O(new_n154_));
  inv1   g102(.a(x14), .O(new_n155_));
  nand2  g103(.a(new_n57_), .b(new_n155_), .O(new_n156_));
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n68_), .O(new_n157_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n63_), .O(z14));
  nand2  g113(.a(new_n62_), .b(new_n54_), .O(new_n166_));
  nand2  g114(.a(x28), .b(x18), .O(new_n167_));
  inv1   g115(.a(x12), .O(new_n168_));
  nand2  g116(.a(new_n57_), .b(new_n168_), .O(new_n169_));
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n68_), .O(new_n170_));
  aoi21  g118(.a(new_n170_), .b(new_n166_), .c(new_n65_), .O(z15));
endmodule
