...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x11), .O(new_n54_));
  ...
  nand3  g048(.a(new_n100_), .b(new_n98_), .c(new_n54_), .O(z05));
  ...
  nand2  g054(.a(new_n106_), .b(new_n56_), .O(new_n107_));
  nand3  g055(.a(new_n107_), .b(new_n105_), .c(new_n54_), .O(z06));
  ...
  nand2  g061(.a(new_n113_), .b(new_n56_), .O(new_n114_));
  nand3  g062(.a(new_n114_), .b(new_n112_), .c(new_n54_), .O(z07));
  inv1   g063(.a(x17), .O(new_n116_));
  nand3  g064(.a(x19), .b(new_n62_), .c(new_n116_), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(x34), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(x11), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n56_), .O(new_n121_));
  inv1   g069(.a(x29), .O(new_n122_));
  nand3  g070(.a(new_n60_), .b(new_n122_), .c(x18), .O(new_n123_));
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n119_), .O(z08));
  nand2  g072(.a(new_n122_), .b(new_n56_), .O(new_n125_));
  ...
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n54_), .O(z11));
  inv1   g092(.a(x33), .O(new_n145_));
  nand4  g093(.a(new_n145_), .b(x19), .c(x18), .d(new_n116_), .O(new_n146_));
  inv1   g094(.a(x32), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n56_), .O(new_n148_));
  nand4  g096(.a(x19), .b(new_n62_), .c(new_n116_), .d(x15), .O(new_n149_));
  nand3  g097(.a(new_n149_), .b(new_n148_), .c(new_n146_), .O(new_n150_));
  and2   g098(.a(new_n150_), .b(new_n54_), .O(z12));
  nand4  g099(.a(new_n53_), .b(x19), .c(x18), .d(new_n116_), .O(new_n152_));
  nand2  g100(.a(new_n145_), .b(new_n56_), .O(new_n153_));
  nand4  g101(.a(x19), .b(new_n62_), .c(new_n116_), .d(x14), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  and2   g103(.a(new_n155_), .b(new_n54_), .O(z13));
  aoi21  g104(.a(x35), .b(x18), .c(x17), .O(new_n157_));
  oai21  g105(.a(x18), .b(x13), .c(new_n157_), .O(new_n158_));
  oai21  g106(.a(new_n53_), .b(x19), .c(new_n54_), .O(new_n159_));
  ...
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n60_), .O(new_n164_));
  inv1   g112(.a(x35), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(new_n56_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n54_), .O(z15));
endmodule
