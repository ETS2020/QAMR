...
module FAU ( 
  ...
  nor2   g000(.a(x31), .b(x30), .O(new_n53_));
  ...
  nand3  g043(.a(new_n95_), .b(new_n93_), .c(new_n71_), .O(new_n96_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n71_), .O(new_n124_));
  ...
  nor2   g094(.a(new_n146_), .b(new_n53_), .O(new_n147_));
