...
module FAU ( 
  ...
  nor2   g10(.a(new_n53_), .b(x17), .O(new_n63_));
  nand2  g11(.a(new_n63_), .b(x32), .O(new_n64_));
  ...
  aoi21  g41(.a(new_n57_), .b(new_n93_), .c(x17), .O(new_n94_));
  aoi21  g42(.a(new_n94_), .b(new_n92_), .c(new_n54_), .O(new_n95_));
  ...
  oai22  g55(.a(new_n107_), .b(new_n64_), .c(x29), .d(x19), .O(z09));
  ...
  nand2  g64(.a(new_n116_), .b(new_n63_), .O(new_n117_));
  oai21  g65(.a(new_n117_), .b(new_n115_), .c(x32), .O(z12));
