...
module FAU ( 
  ...
  nand2  g043(.a(new_n63_), .b(new_n55_), .O(new_n96_));
  nand2  g044(.a(x26), .b(x18), .O(new_n97_));
  oai21  g045(.a(x18), .b(x06), .c(new_n97_), .O(new_n98_));
  inv1   g046(.a(x32), .O(new_n99_));
  nand3  g047(.a(new_n99_), .b(new_n62_), .c(new_n54_), .O(new_n100_));
  oai21  g048(.a(new_n98_), .b(new_n96_), .c(new_n100_), .O(z05));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n75_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n72_), .O(z07));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n75_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n72_), .O(z11));
  aoi21  g091(.a(x25), .b(x19), .c(new_n99_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n57_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n75_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n75_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n72_), .O(z13));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n75_), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n72_), .O(z14));
