...
module FAU ( 
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n80_), .O(new_n148_));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n80_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n80_), .O(new_n169_));
