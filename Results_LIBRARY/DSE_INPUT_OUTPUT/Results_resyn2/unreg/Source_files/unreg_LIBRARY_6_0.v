...
module FAU ( 
  ...
  nor2   g008(.a(x30), .b(x02), .O(new_n61_));
  nor2   g009(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g010(.a(new_n62_), .b(new_n59_), .O(z00));
  aoi21  g011(.a(x30), .b(x18), .c(x02), .O(new_n64_));
  inv1   g012(.a(x17), .O(new_n65_));
  nand2  g013(.a(x22), .b(x18), .O(new_n66_));
  nand3  g014(.a(new_n66_), .b(x19), .c(new_n65_), .O(new_n67_));
  inv1   g015(.a(x21), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(new_n54_), .O(new_n69_));
  oai22  g017(.a(new_n69_), .b(new_n61_), .c(new_n67_), .d(new_n64_), .O(z01));
  ...
  nand4  g023(.a(new_n75_), .b(new_n73_), .c(x19), .d(new_n65_), .O(new_n76_));
  ...
  nand4  g031(.a(new_n83_), .b(new_n81_), .c(x19), .d(new_n65_), .O(new_n84_));
  ...
  nand4  g038(.a(new_n90_), .b(new_n88_), .c(x19), .d(new_n65_), .O(new_n91_));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n65_), .O(new_n112_));
  ...
  oai21  g073(.a(new_n123_), .b(new_n121_), .c(new_n125_), .O(z09));
  ...
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n65_), .O(new_n132_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n65_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n65_), .O(new_n153_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n65_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n65_), .O(new_n167_));
