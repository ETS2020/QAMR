...
module FAU ( 
  ...
  nand3  g067(.a(new_n119_), .b(new_n117_), .c(new_n95_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n95_), .O(new_n134_));
  ...
  nand2  g093(.a(new_n95_), .b(new_n54_), .O(new_n146_));
