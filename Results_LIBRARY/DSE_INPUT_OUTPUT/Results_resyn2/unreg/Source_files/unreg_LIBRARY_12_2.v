...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x00), .O(new_n54_));
  ...
  nand2  g029(.a(new_n81_), .b(x32), .O(new_n82_));
  ...
  nand2  g091(.a(new_n60_), .b(new_n54_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n145_), .O(new_n146_));
  inv1   g094(.a(x00), .O(new_n147_));
  nand3  g095(.a(new_n53_), .b(new_n56_), .c(new_n147_), .O(new_n148_));
