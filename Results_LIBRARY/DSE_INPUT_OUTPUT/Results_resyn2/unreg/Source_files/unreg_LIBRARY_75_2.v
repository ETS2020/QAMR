...
module FAU ( 
  ...
  nor2   g010(.a(x28), .b(new_n62_), .O(new_n63_));
  ...
  aoi21  g019(.a(new_n71_), .b(new_n67_), .c(new_n63_), .O(z01));
  ...
  aoi21  g040(.a(new_n92_), .b(new_n88_), .c(new_n63_), .O(z04));
  ...
  nand3  g063(.a(x19), .b(new_n57_), .c(new_n115_), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(x28), .O(new_n117_));
  ...
  nand3  g069(.a(new_n55_), .b(new_n121_), .c(x18), .O(new_n122_));
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n118_), .O(z08));
  nand2  g071(.a(new_n121_), .b(new_n54_), .O(new_n124_));
  ...
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n63_), .O(z09));
  ...
  aoi21  g083(.a(new_n135_), .b(new_n131_), .c(new_n63_), .O(z10));
  ...
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n64_), .O(z11));
  ...
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n63_), .O(z12));
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n64_), .O(z13));
  inv1   g105(.a(x35), .O(new_n158_));
  nand4  g106(.a(new_n158_), .b(x19), .c(x18), .d(new_n115_), .O(new_n159_));
  inv1   g107(.a(x34), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n54_), .O(new_n161_));
  nand4  g109(.a(x19), .b(new_n57_), .c(new_n115_), .d(x13), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(new_n161_), .c(new_n159_), .O(new_n163_));
  and2   g111(.a(new_n163_), .b(new_n64_), .O(z14));
  nand4  g112(.a(new_n119_), .b(x19), .c(x18), .d(new_n115_), .O(new_n165_));
  nand2  g113(.a(new_n158_), .b(new_n54_), .O(new_n166_));
  nand4  g114(.a(x19), .b(new_n57_), .c(new_n115_), .d(x12), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n166_), .c(new_n165_), .O(new_n168_));
  and2   g116(.a(new_n168_), .b(new_n64_), .O(z15));
endmodule
