...
module FAU ( 
  ...
  nand2  g008(.a(x27), .b(x22), .O(new_n61_));
  ...
  oai21  g012(.a(x27), .b(x18), .c(x22), .O(new_n65_));
  ...
  nand3  g017(.a(new_n61_), .b(new_n69_), .c(new_n54_), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n68_), .O(z01));
  inv1   g019(.a(x22), .O(new_n72_));
  inv1   g020(.a(x27), .O(new_n73_));
  aoi21  g021(.a(new_n73_), .b(x19), .c(new_n72_), .O(new_n74_));
  aoi21  g022(.a(x23), .b(x18), .c(x17), .O(new_n75_));
  oai21  g023(.a(x18), .b(x01), .c(new_n75_), .O(new_n76_));
  aoi21  g024(.a(new_n76_), .b(x19), .c(new_n74_), .O(z02));
  ...
  aoi21  g033(.a(new_n85_), .b(new_n79_), .c(new_n62_), .O(z03));
  ...
  aoi21  g046(.a(new_n98_), .b(new_n54_), .c(new_n62_), .O(new_n99_));
  ...
  aoi21  g059(.a(new_n73_), .b(new_n54_), .c(new_n62_), .O(new_n112_));
  nand2  g060(.a(new_n112_), .b(new_n111_), .O(z07));
  ...
  aoi21  g066(.a(new_n118_), .b(new_n54_), .c(new_n62_), .O(new_n119_));
  ...
  aoi21  g073(.a(new_n125_), .b(new_n54_), .c(new_n62_), .O(new_n126_));
  ...
  aoi21  g080(.a(new_n132_), .b(new_n54_), .c(new_n62_), .O(new_n133_));
  ...
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n62_), .O(z12));
