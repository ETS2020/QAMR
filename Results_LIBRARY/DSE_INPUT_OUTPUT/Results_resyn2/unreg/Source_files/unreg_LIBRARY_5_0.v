...
module FAU ( 
  ...
  oai21  g090(.a(new_n54_), .b(new_n115_), .c(new_n142_), .O(new_n143_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n71_), .O(new_n159_));
  ...
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n71_), .O(new_n166_));
