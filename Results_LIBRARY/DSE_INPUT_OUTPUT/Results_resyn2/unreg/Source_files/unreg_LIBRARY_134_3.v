...
module FAU ( 
  ...
  nand2  g068(.a(new_n62_), .b(new_n120_), .O(new_n121_));
  nand4  g069(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n59_), .O(new_n122_));
  aoi21  g070(.a(new_n122_), .b(new_n118_), .c(new_n55_), .O(z08));
  ...
  nand4  g076(.a(new_n128_), .b(new_n126_), .c(x19), .d(new_n59_), .O(new_n129_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n73_), .O(new_n152_));
  nor2   g100(.a(x33), .b(x19), .O(new_n153_));
  nor2   g101(.a(new_n153_), .b(new_n55_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n152_), .O(z13));
  aoi21  g103(.a(new_n53_), .b(x19), .c(new_n54_), .O(new_n156_));
  aoi21  g104(.a(x35), .b(x18), .c(x17), .O(new_n157_));
  oai21  g105(.a(x18), .b(x13), .c(new_n157_), .O(new_n158_));
  aoi21  g106(.a(new_n158_), .b(x19), .c(new_n156_), .O(z14));
  inv1   g107(.a(x35), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n56_), .O(new_n161_));
  nand2  g109(.a(x28), .b(x18), .O(new_n162_));
  inv1   g110(.a(x12), .O(new_n163_));
  nand2  g111(.a(new_n62_), .b(new_n163_), .O(new_n164_));
  nand4  g112(.a(new_n164_), .b(new_n162_), .c(x19), .d(new_n59_), .O(new_n165_));
  aoi21  g113(.a(new_n165_), .b(new_n161_), .c(new_n55_), .O(z15));
endmodule
