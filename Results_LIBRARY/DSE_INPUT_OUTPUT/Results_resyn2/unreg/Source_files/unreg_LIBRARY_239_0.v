...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x02), .O(new_n53_));
  ...
  aoi21  g011(.a(x32), .b(x18), .c(x02), .O(new_n64_));
  nand2  g012(.a(x22), .b(x18), .O(new_n65_));
  nand3  g013(.a(new_n65_), .b(x19), .c(new_n57_), .O(new_n66_));
  inv1   g014(.a(x21), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(new_n54_), .O(new_n68_));
  oai22  g016(.a(new_n68_), .b(new_n53_), .c(new_n66_), .d(new_n64_), .O(z01));
  ...
  nand4  g022(.a(new_n74_), .b(new_n72_), .c(x19), .d(new_n57_), .O(new_n75_));
  aoi21  g023(.a(new_n75_), .b(new_n71_), .c(new_n53_), .O(z02));
  ...
  nand4  g030(.a(new_n82_), .b(new_n80_), .c(x19), .d(new_n57_), .O(new_n83_));
  aoi21  g031(.a(new_n83_), .b(new_n78_), .c(new_n53_), .O(z03));
  nor2   g032(.a(new_n54_), .b(x17), .O(new_n85_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n85_), .O(new_n124_));
  ...
  nand2  g090(.a(x19), .b(x02), .O(new_n143_));
  ...
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n85_), .O(new_n148_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n85_), .O(new_n160_));
  nor2   g108(.a(x34), .b(x19), .O(new_n161_));
  nor2   g109(.a(new_n161_), .b(new_n53_), .O(new_n162_));
