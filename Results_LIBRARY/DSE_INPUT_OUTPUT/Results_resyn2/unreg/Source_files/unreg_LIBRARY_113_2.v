...
module FAU ( 
  ...
  aoi21  g049(.a(new_n101_), .b(new_n97_), .c(new_n79_), .O(z05));
  ...
  nand3  g078(.a(new_n62_), .b(new_n93_), .c(new_n54_), .O(new_n131_));
  nand2  g079(.a(new_n63_), .b(new_n55_), .O(new_n132_));
  nand2  g080(.a(x31), .b(x18), .O(new_n133_));
  oai21  g081(.a(x18), .b(x09), .c(new_n133_), .O(new_n134_));
  oai21  g082(.a(new_n134_), .b(new_n132_), .c(new_n131_), .O(z10));
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n82_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n79_), .O(z12));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n82_), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n79_), .O(z14));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n82_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n79_), .O(z15));
endmodule
