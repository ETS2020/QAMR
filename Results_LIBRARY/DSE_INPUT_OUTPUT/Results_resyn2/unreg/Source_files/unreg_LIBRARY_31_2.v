...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x05), .O(new_n54_));
  ...
  nand2  g033(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  nand3  g034(.a(new_n86_), .b(new_n84_), .c(new_n54_), .O(z03));
  ...
  nand2  g051(.a(new_n103_), .b(x28), .O(new_n104_));
  ...
  aoi21  g064(.a(x29), .b(x18), .c(x17), .O(new_n117_));
  oai21  g065(.a(x18), .b(x11), .c(new_n117_), .O(new_n118_));
  nand2  g066(.a(x28), .b(new_n56_), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n54_), .O(new_n120_));
  aoi21  g068(.a(new_n118_), .b(x19), .c(new_n120_), .O(z08));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n60_), .O(new_n153_));
  inv1   g101(.a(x33), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n56_), .O(new_n155_));
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n54_), .O(z13));
  nand2  g104(.a(x35), .b(x18), .O(new_n157_));
  inv1   g105(.a(x13), .O(new_n158_));
  nand2  g106(.a(new_n62_), .b(new_n158_), .O(new_n159_));
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n60_), .O(new_n160_));
  inv1   g108(.a(x34), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n56_), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(new_n160_), .c(new_n54_), .O(z14));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  inv1   g112(.a(x12), .O(new_n165_));
  nand2  g113(.a(new_n62_), .b(new_n165_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n60_), .O(new_n167_));
