...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x08), .O(new_n62_));
  ...
  aoi21  g084(.a(new_n61_), .b(x18), .c(x08), .O(new_n137_));
  nand2  g085(.a(x24), .b(x18), .O(new_n138_));
  nand3  g086(.a(new_n138_), .b(x19), .c(new_n89_), .O(new_n139_));
  inv1   g087(.a(x31), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n54_), .O(new_n141_));
  oai22  g089(.a(new_n141_), .b(new_n62_), .c(new_n139_), .d(new_n137_), .O(z11));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n89_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n89_), .O(new_n168_));
