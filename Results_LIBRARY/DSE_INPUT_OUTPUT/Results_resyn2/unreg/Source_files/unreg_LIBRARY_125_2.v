...
module FAU ( 
  ...
  aoi21  g035(.a(x32), .b(x19), .c(new_n53_), .O(new_n88_));
  ...
  nand4  g044(.a(new_n96_), .b(new_n94_), .c(x19), .d(new_n58_), .O(new_n97_));
  aoi21  g045(.a(new_n97_), .b(new_n93_), .c(new_n54_), .O(z05));
  nand2  g046(.a(x27), .b(x18), .O(new_n99_));
  inv1   g047(.a(x05), .O(new_n100_));
  nand2  g048(.a(new_n61_), .b(new_n100_), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n72_), .O(new_n102_));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n72_), .O(new_n137_));
