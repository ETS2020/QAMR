...
module FAU ( 
  ...
  nand2  g008(.a(x33), .b(x26), .O(new_n61_));
  ...
  oai21  g042(.a(x33), .b(x18), .c(x26), .O(new_n95_));
  ...
  nand3  g047(.a(new_n61_), .b(new_n99_), .c(new_n54_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n98_), .O(z05));
  inv1   g049(.a(x26), .O(new_n102_));
  inv1   g050(.a(x33), .O(new_n103_));
  aoi21  g051(.a(new_n103_), .b(x19), .c(new_n102_), .O(new_n104_));
  aoi21  g052(.a(x27), .b(x18), .c(x17), .O(new_n105_));
  oai21  g053(.a(x18), .b(x05), .c(new_n105_), .O(new_n106_));
  aoi21  g054(.a(new_n106_), .b(x19), .c(new_n104_), .O(z06));
  ...
  oai21  g090(.a(x26), .b(x18), .c(x33), .O(new_n143_));
  ...
  nand3  g095(.a(new_n61_), .b(new_n147_), .c(new_n54_), .O(new_n148_));
  ...
  aoi21  g101(.a(new_n103_), .b(new_n54_), .c(new_n62_), .O(new_n154_));
  ...
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n62_), .O(z15));
endmodule
