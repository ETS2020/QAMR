...
module FAU ( 
  ...
  and2   g00(.a(x21), .b(x18), .O(new_n53_));
  inv1   g01(.a(x17), .O(new_n54_));
  nand3  g02(.a(x19), .b(new_n54_), .c(x03), .O(new_n55_));
  oai22  g03(.a(new_n55_), .b(new_n53_), .c(x20), .d(x19), .O(z00));
  nand2  g04(.a(x22), .b(x18), .O(new_n57_));
  oai21  g05(.a(x18), .b(x02), .c(new_n57_), .O(new_n58_));
  oai22  g06(.a(new_n58_), .b(new_n55_), .c(x21), .d(x19), .O(z01));
  inv1   g07(.a(x19), .O(new_n60_));
  inv1   g08(.a(x03), .O(new_n61_));
