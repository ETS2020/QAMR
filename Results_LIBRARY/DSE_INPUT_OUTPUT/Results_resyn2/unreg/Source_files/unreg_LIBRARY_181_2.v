...
module FAU ( 
  ...
  nand3  g063(.a(x19), .b(new_n61_), .c(new_n115_), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(x32), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(x11), .O(new_n118_));
  nor2   g066(.a(x28), .b(x19), .O(new_n119_));
  nor2   g067(.a(x29), .b(new_n61_), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n59_), .c(new_n119_), .O(new_n121_));
  ...
  nor2   g091(.a(new_n55_), .b(x11), .O(new_n144_));
  ...
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n59_), .O(new_n155_));
  ...
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n59_), .O(new_n162_));
