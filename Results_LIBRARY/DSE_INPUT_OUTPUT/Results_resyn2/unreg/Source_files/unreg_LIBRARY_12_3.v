...
module FAU ( 
  ...
  nand3  g028(.a(x19), .b(new_n62_), .c(new_n80_), .O(new_n81_));
  nand2  g029(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  nand2  g030(.a(new_n82_), .b(x00), .O(new_n83_));
  nor2   g031(.a(x23), .b(x19), .O(new_n84_));
  and2   g032(.a(x18), .b(x16), .O(new_n85_));
  aoi21  g033(.a(new_n85_), .b(new_n60_), .c(new_n84_), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(new_n83_), .O(z03));
  ...
  nand3  g061(.a(new_n113_), .b(new_n111_), .c(new_n60_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n55_), .O(z07));
  inv1   g063(.a(x28), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(new_n56_), .O(new_n117_));
  nand2  g065(.a(x29), .b(x18), .O(new_n118_));
  inv1   g066(.a(x11), .O(new_n119_));
  nand2  g067(.a(new_n62_), .b(new_n119_), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n60_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n55_), .O(z08));
  ...
  nand3  g075(.a(new_n127_), .b(new_n125_), .c(new_n60_), .O(new_n128_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n60_), .O(new_n165_));
