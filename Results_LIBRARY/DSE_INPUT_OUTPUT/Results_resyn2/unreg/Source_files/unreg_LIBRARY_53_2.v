// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:41 2020
...
module FAU ( 
  ...
  aoi21  g042(.a(x34), .b(x19), .c(new_n61_), .O(new_n95_));
  nand2  g043(.a(x26), .b(x18), .O(new_n96_));
  inv1   g044(.a(x06), .O(new_n97_));
  nand2  g045(.a(new_n57_), .b(new_n97_), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n96_), .c(new_n67_), .O(new_n99_));
  aoi21  g047(.a(new_n99_), .b(x19), .c(new_n95_), .O(z05));
  ...
  oai21  g105(.a(x25), .b(new_n54_), .c(new_n157_), .O(new_n158_));
