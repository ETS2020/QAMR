...
module FAU ( 
  ...
  oai21  g041(.a(new_n62_), .b(x18), .c(x26), .O(new_n94_));
  ...
  nand2  g046(.a(new_n98_), .b(new_n63_), .O(new_n99_));
  ...
  oai21  g062(.a(x26), .b(new_n54_), .c(new_n62_), .O(new_n115_));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n124_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n123_), .c(new_n121_), .O(z09));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n124_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n121_), .O(z13));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n124_), .O(new_n168_));
