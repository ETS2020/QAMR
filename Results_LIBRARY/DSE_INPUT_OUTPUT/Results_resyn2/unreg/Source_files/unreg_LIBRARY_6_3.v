...
module FAU ( 
  ...
  nand4  g018(.a(new_n70_), .b(new_n69_), .c(x19), .d(new_n68_), .O(new_n71_));
  ...
  nand4  g025(.a(new_n77_), .b(new_n75_), .c(x19), .d(new_n68_), .O(new_n78_));
  ...
  nand4  g033(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n68_), .O(new_n86_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n68_), .O(new_n93_));
  ...
  aoi21  g077(.a(x19), .b(new_n61_), .c(new_n62_), .O(new_n130_));
