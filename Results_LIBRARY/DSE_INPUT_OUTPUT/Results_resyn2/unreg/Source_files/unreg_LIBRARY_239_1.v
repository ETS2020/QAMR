...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x02), .O(new_n54_));
  ...
  aoi21  g012(.a(new_n53_), .b(x18), .c(x02), .O(new_n65_));
  nand2  g013(.a(x22), .b(x18), .O(new_n66_));
  nand3  g014(.a(new_n66_), .b(x19), .c(new_n58_), .O(new_n67_));
  inv1   g015(.a(x21), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(new_n55_), .O(new_n69_));
  oai22  g017(.a(new_n69_), .b(new_n54_), .c(new_n67_), .d(new_n65_), .O(z01));
  ...
  nand4  g023(.a(new_n75_), .b(new_n73_), .c(x19), .d(new_n58_), .O(new_n76_));
  aoi21  g024(.a(new_n76_), .b(new_n72_), .c(new_n54_), .O(z02));
  ...
  nand4  g031(.a(new_n83_), .b(new_n81_), .c(x19), .d(new_n58_), .O(new_n84_));
  aoi21  g032(.a(new_n84_), .b(new_n79_), .c(new_n54_), .O(z03));
  nor2   g033(.a(new_n55_), .b(x17), .O(new_n86_));
  nand2  g034(.a(x25), .b(x18), .O(new_n87_));
  inv1   g035(.a(x07), .O(new_n88_));
  nand2  g036(.a(new_n61_), .b(new_n88_), .O(new_n89_));
  nand3  g037(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n86_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n86_), .O(new_n104_));
  ...
  nand3  g058(.a(new_n110_), .b(new_n108_), .c(new_n86_), .O(new_n111_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n86_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n86_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n86_), .O(new_n132_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n86_), .O(new_n146_));
  aoi21  g094(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n147_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n86_), .O(new_n159_));
  nor2   g107(.a(x34), .b(x19), .O(new_n160_));
  nor2   g108(.a(new_n160_), .b(new_n54_), .O(new_n161_));
