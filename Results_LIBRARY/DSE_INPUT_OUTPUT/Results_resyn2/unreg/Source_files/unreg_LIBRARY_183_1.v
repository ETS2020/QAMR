...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x11), .O(new_n54_));
  ...
  aoi21  g063(.a(new_n53_), .b(x18), .c(x11), .O(new_n116_));
  nand2  g064(.a(x29), .b(x18), .O(new_n117_));
  nand3  g065(.a(new_n117_), .b(x19), .c(new_n58_), .O(new_n118_));
  inv1   g066(.a(x28), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n55_), .O(new_n120_));
  oai22  g068(.a(new_n120_), .b(new_n54_), .c(new_n118_), .d(new_n116_), .O(z08));
  ...
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n72_), .O(new_n132_));
  ...
  nor2   g099(.a(new_n151_), .b(new_n54_), .O(new_n152_));
