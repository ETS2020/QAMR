...
module FAU ( 
  ...
  nand2  g008(.a(x34), .b(x30), .O(new_n61_));
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n74_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n62_), .O(z12));
  oai21  g097(.a(x30), .b(x18), .c(x34), .O(new_n150_));
  ...
  nand3  g102(.a(new_n61_), .b(new_n154_), .c(new_n54_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n153_), .O(z13));
  aoi21  g104(.a(new_n130_), .b(x19), .c(new_n131_), .O(new_n157_));
  ...
  aoi21  g113(.a(new_n165_), .b(new_n54_), .c(new_n62_), .O(new_n166_));
