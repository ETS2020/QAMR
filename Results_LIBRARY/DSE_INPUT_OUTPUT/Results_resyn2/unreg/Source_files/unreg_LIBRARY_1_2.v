...
module FAU ( 
  ...
  aoi21  g070(.a(x32), .b(x19), .c(new_n53_), .O(new_n123_));
  ...
  aoi21  g075(.a(new_n127_), .b(x19), .c(new_n123_), .O(z09));
  ...
  nor2   g092(.a(x32), .b(x29), .O(new_n145_));
  aoi21  g093(.a(x32), .b(x19), .c(new_n145_), .O(new_n146_));
  aoi21  g094(.a(new_n144_), .b(x19), .c(new_n146_), .O(z12));
