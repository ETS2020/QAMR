...
module FAU ( 
  ...
  nor2   g000(.a(x28), .b(x26), .O(new_n53_));
  ...
  nor2   g016(.a(new_n68_), .b(new_n53_), .O(new_n69_));
  ...
  inv1   g039(.a(x17), .O(new_n92_));
  nand2  g040(.a(x26), .b(x18), .O(new_n93_));
  inv1   g041(.a(x06), .O(new_n94_));
  nand2  g042(.a(new_n60_), .b(new_n94_), .O(new_n95_));
  nand3  g043(.a(new_n95_), .b(new_n93_), .c(new_n92_), .O(new_n96_));
  inv1   g044(.a(new_n53_), .O(new_n97_));
  nand2  g045(.a(x25), .b(new_n54_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  aoi21  g047(.a(new_n96_), .b(x19), .c(new_n99_), .O(z05));
  nand2  g048(.a(new_n58_), .b(new_n97_), .O(new_n101_));
  nand2  g049(.a(x27), .b(x18), .O(new_n102_));
  oai21  g050(.a(x18), .b(x05), .c(new_n102_), .O(new_n103_));
  inv1   g051(.a(x26), .O(new_n104_));
  nand3  g052(.a(x28), .b(new_n104_), .c(new_n54_), .O(new_n105_));
  oai21  g053(.a(new_n103_), .b(new_n101_), .c(new_n105_), .O(z06));
  ...
  oai21  g058(.a(new_n108_), .b(new_n101_), .c(new_n110_), .O(z07));
  nand2  g059(.a(x29), .b(x18), .O(new_n112_));
  oai21  g060(.a(x18), .b(x11), .c(new_n112_), .O(new_n113_));
  inv1   g061(.a(x28), .O(new_n114_));
  nand3  g062(.a(new_n114_), .b(x26), .c(new_n54_), .O(new_n115_));
  oai21  g063(.a(new_n113_), .b(new_n101_), .c(new_n115_), .O(z08));
  nand2  g064(.a(x30), .b(x18), .O(new_n117_));
  oai21  g065(.a(x18), .b(x10), .c(new_n117_), .O(new_n118_));
  nor2   g066(.a(x29), .b(x19), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n97_), .O(new_n120_));
  oai21  g068(.a(new_n118_), .b(new_n101_), .c(new_n120_), .O(z09));
  ...
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n53_), .O(z10));
  ...
  aoi21  g082(.a(new_n134_), .b(new_n130_), .c(new_n53_), .O(z11));
  nand2  g083(.a(x33), .b(x18), .O(new_n136_));
  ...
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n53_), .O(z13));
  inv1   g097(.a(x35), .O(new_n150_));
  nand4  g098(.a(new_n150_), .b(x19), .c(x18), .d(new_n92_), .O(new_n151_));
  inv1   g099(.a(x34), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n54_), .O(new_n153_));
  nand4  g101(.a(x19), .b(new_n60_), .c(new_n92_), .d(x13), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n153_), .c(new_n151_), .O(new_n155_));
  and2   g103(.a(new_n155_), .b(new_n97_), .O(z14));
  nand4  g104(.a(new_n114_), .b(x19), .c(x18), .d(new_n92_), .O(new_n157_));
  nand2  g105(.a(new_n150_), .b(new_n54_), .O(new_n158_));
  nand4  g106(.a(x19), .b(new_n60_), .c(new_n92_), .d(x12), .O(new_n159_));
  nand3  g107(.a(new_n159_), .b(new_n158_), .c(new_n157_), .O(new_n160_));
  and2   g108(.a(new_n160_), .b(new_n97_), .O(z15));
endmodule
