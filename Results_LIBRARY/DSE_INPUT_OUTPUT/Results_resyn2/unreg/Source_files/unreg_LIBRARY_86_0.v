...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x30), .O(new_n61_));
  ...
  nor2   g037(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n88_), .O(z04));
  nand2  g039(.a(x26), .b(x18), .O(new_n92_));
  inv1   g040(.a(x06), .O(new_n93_));
  nand2  g041(.a(new_n57_), .b(new_n93_), .O(new_n94_));
  nand3  g042(.a(new_n94_), .b(new_n92_), .c(new_n55_), .O(new_n95_));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n107_), .c(new_n61_), .O(z07));
  ...
  aoi21  g066(.a(new_n118_), .b(new_n114_), .c(new_n61_), .O(z08));
  ...
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(new_n131_));
  inv1   g079(.a(x30), .O(new_n132_));
  inv1   g080(.a(x34), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g082(.a(x30), .b(new_n54_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  aoi21  g084(.a(new_n131_), .b(x19), .c(new_n136_), .O(z10));
  ...
  nor2   g090(.a(new_n142_), .b(new_n61_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n141_), .O(z11));
  inv1   g092(.a(x33), .O(new_n145_));
  nand4  g093(.a(new_n145_), .b(x19), .c(x18), .d(new_n127_), .O(new_n146_));
  inv1   g094(.a(x32), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n54_), .O(new_n148_));
  nand4  g096(.a(x19), .b(new_n57_), .c(new_n127_), .d(x15), .O(new_n149_));
  nand3  g097(.a(new_n149_), .b(new_n148_), .c(new_n146_), .O(new_n150_));
  and2   g098(.a(new_n150_), .b(new_n134_), .O(z12));
  nand4  g099(.a(new_n133_), .b(x19), .c(x18), .d(new_n127_), .O(new_n152_));
  nand2  g100(.a(new_n145_), .b(new_n54_), .O(new_n153_));
  nand4  g101(.a(x19), .b(new_n57_), .c(new_n127_), .d(x14), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  and2   g103(.a(new_n155_), .b(new_n134_), .O(z13));
  nand2  g104(.a(new_n134_), .b(new_n55_), .O(new_n157_));
  nand2  g105(.a(x35), .b(x18), .O(new_n158_));
  oai21  g106(.a(x18), .b(x13), .c(new_n158_), .O(new_n159_));
  oai22  g107(.a(new_n159_), .b(new_n157_), .c(new_n135_), .d(x34), .O(z14));
  nand2  g108(.a(x28), .b(x18), .O(new_n161_));
  inv1   g109(.a(x12), .O(new_n162_));
  nand2  g110(.a(new_n57_), .b(new_n162_), .O(new_n163_));
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n55_), .O(new_n164_));
  nor2   g112(.a(x35), .b(x19), .O(new_n165_));
  nor2   g113(.a(new_n165_), .b(new_n61_), .O(new_n166_));
