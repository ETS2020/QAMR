...
module FAU ( 
  ...
  oai21  g071(.a(x18), .b(new_n62_), .c(x30), .O(new_n124_));
  ...
  oai21  g106(.a(x30), .b(new_n57_), .c(new_n62_), .O(new_n159_));
  oai21  g107(.a(x18), .b(new_n62_), .c(x35), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(new_n159_), .c(new_n55_), .O(new_n161_));
  ...
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n82_), .O(new_n170_));
  aoi21  g118(.a(new_n170_), .b(new_n166_), .c(new_n79_), .O(z15));
endmodule
