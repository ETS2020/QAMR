...
module FAU ( 
  ...
  oai21  g002(.a(x28), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  ...
  aoi21  g026(.a(new_n78_), .b(new_n74_), .c(new_n64_), .O(z02));
  ...
  aoi21  g067(.a(new_n63_), .b(new_n53_), .c(new_n64_), .O(new_n120_));
  ...
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n64_), .O(z12));
  ...
  nor2   g116(.a(new_n168_), .b(new_n64_), .O(new_n169_));
