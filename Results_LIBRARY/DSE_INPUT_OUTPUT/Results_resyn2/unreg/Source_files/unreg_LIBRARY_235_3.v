...
module FAU ( 
  ...
  aoi21  g18(.a(new_n70_), .b(new_n68_), .c(x10), .O(new_n71_));
  ...
  aoi21  g40(.a(new_n56_), .b(new_n92_), .c(x17), .O(new_n93_));
  ...
  nand3  g46(.a(new_n98_), .b(x18), .c(new_n63_), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n62_), .O(new_n100_));
  ...
  oai22  g72(.a(new_n124_), .b(new_n64_), .c(x34), .d(x19), .O(z14));
  nand2  g73(.a(x28), .b(x18), .O(new_n126_));
  oai21  g74(.a(x18), .b(x12), .c(new_n126_), .O(new_n127_));
  oai22  g75(.a(new_n127_), .b(new_n64_), .c(x35), .d(x19), .O(z15));
endmodule
