...
module FAU ( 
  ...
  nor2   g009(.a(x33), .b(new_n61_), .O(new_n62_));
  ...
  nand2  g090(.a(x33), .b(x19), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(x32), .O(new_n144_));
  inv1   g092(.a(x15), .O(new_n145_));
  nor2   g093(.a(x18), .b(new_n145_), .O(new_n146_));
  nor2   g094(.a(x33), .b(x32), .O(new_n147_));
  aoi22  g095(.a(new_n147_), .b(x18), .c(new_n146_), .d(new_n144_), .O(new_n148_));
  nand2  g096(.a(new_n61_), .b(new_n54_), .O(new_n149_));
  oai21  g097(.a(new_n148_), .b(x17), .c(new_n149_), .O(z12));
  aoi21  g098(.a(x33), .b(x19), .c(new_n147_), .O(new_n151_));
  inv1   g099(.a(x34), .O(new_n152_));
  inv1   g100(.a(x14), .O(new_n153_));
  aoi21  g101(.a(new_n57_), .b(new_n153_), .c(x17), .O(new_n154_));
  oai21  g102(.a(new_n152_), .b(new_n57_), .c(new_n154_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(x19), .c(new_n151_), .O(z13));
  nand2  g104(.a(new_n152_), .b(new_n54_), .O(new_n157_));
