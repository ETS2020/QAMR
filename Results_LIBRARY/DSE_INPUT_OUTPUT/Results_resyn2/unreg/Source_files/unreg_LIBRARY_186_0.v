...
module FAU ( 
  ...
  nand3  g056(.a(new_n108_), .b(new_n106_), .c(new_n58_), .O(new_n109_));
  ...
  oai21  g062(.a(new_n114_), .b(new_n54_), .c(new_n113_), .O(new_n115_));
  ...
  oai21  g089(.a(new_n113_), .b(new_n54_), .c(new_n114_), .O(new_n142_));
  ...
  inv1   g102(.a(new_n53_), .O(new_n155_));
  ...
  nand4  g108(.a(x19), .b(new_n60_), .c(new_n156_), .d(x13), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  and2   g110(.a(new_n162_), .b(new_n155_), .O(z14));
  nand4  g111(.a(new_n113_), .b(x19), .c(x18), .d(new_n156_), .O(new_n164_));
  nand2  g112(.a(new_n157_), .b(new_n54_), .O(new_n165_));
  nand4  g113(.a(x19), .b(new_n60_), .c(new_n156_), .d(x12), .O(new_n166_));
