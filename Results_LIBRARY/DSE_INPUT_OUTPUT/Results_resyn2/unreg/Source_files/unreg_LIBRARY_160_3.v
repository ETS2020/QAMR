...
module FAU ( 
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n81_), .O(new_n93_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n81_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n81_), .O(new_n142_));
