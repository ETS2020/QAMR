...
module FAU ( 
  ...
  nor2   g061(.a(new_n113_), .b(new_n62_), .O(new_n114_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n74_), .O(new_n121_));
  ...
  nor2   g075(.a(new_n127_), .b(new_n62_), .O(new_n128_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n74_), .O(new_n135_));
  ...
  aoi21  g091(.a(x21), .b(x19), .c(new_n61_), .O(new_n144_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n74_), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n62_), .O(z13));
  ...
  nor2   g107(.a(new_n159_), .b(new_n62_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n74_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n62_), .O(z15));
endmodule
