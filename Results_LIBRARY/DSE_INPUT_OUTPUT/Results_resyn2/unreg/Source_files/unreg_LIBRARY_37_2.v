...
module FAU ( 
  ...
  aoi21  g051(.a(x32), .b(x19), .c(new_n103_), .O(new_n104_));
  ...
  oai21  g090(.a(x26), .b(new_n56_), .c(new_n53_), .O(new_n143_));
  nand2  g091(.a(x33), .b(x18), .O(new_n144_));
  inv1   g092(.a(x15), .O(new_n145_));
  nand2  g093(.a(new_n62_), .b(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n66_), .O(new_n147_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n59_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n55_), .O(z13));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n59_), .O(new_n161_));
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n55_), .O(z14));
  ...
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n54_), .O(z15));
endmodule
