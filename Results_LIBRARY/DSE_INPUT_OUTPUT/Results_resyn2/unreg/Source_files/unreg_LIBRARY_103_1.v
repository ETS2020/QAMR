...
module FAU ( 
  ...
  oai21  g36(.a(x31), .b(x17), .c(x18), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(x19), .O(new_n90_));
  nand2  g38(.a(new_n86_), .b(new_n57_), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n90_), .O(z10));
  inv1   g40(.a(x24), .O(new_n93_));
  nand4  g41(.a(new_n93_), .b(x19), .c(x18), .d(new_n53_), .O(new_n94_));
  ...
  nand2  g46(.a(new_n98_), .b(new_n57_), .O(new_n99_));
  ...
  nand2  g53(.a(new_n101_), .b(new_n57_), .O(new_n106_));
  oai21  g54(.a(new_n105_), .b(new_n57_), .c(new_n106_), .O(z14));
