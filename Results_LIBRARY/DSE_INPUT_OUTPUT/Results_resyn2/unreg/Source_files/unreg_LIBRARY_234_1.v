...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x02), .O(new_n62_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n74_), .O(new_n100_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n74_), .O(new_n169_));
