...
module FAU ( 
  ...
  oai21  g011(.a(new_n63_), .b(x12), .c(new_n53_), .O(new_n64_));
  ...
  oai21  g018(.a(new_n70_), .b(x12), .c(new_n53_), .O(new_n71_));
  ...
  oai21  g025(.a(new_n77_), .b(x12), .c(new_n53_), .O(new_n78_));
  ...
  nor2   g033(.a(x19), .b(x12), .O(new_n86_));
  ...
  nand2  g048(.a(new_n86_), .b(new_n100_), .O(new_n101_));
  ...
  oai21  g055(.a(new_n107_), .b(x12), .c(new_n53_), .O(new_n108_));
  ...
  nand2  g062(.a(new_n86_), .b(new_n114_), .O(new_n115_));
  ...
  nand2  g069(.a(new_n86_), .b(new_n121_), .O(new_n122_));
  ...
  nand2  g083(.a(new_n86_), .b(new_n135_), .O(new_n136_));
  ...
  nand2  g090(.a(new_n86_), .b(new_n142_), .O(new_n143_));
  ...
  nand2  g097(.a(new_n86_), .b(new_n149_), .O(new_n150_));
  ...
  nand2  g104(.a(new_n86_), .b(new_n156_), .O(new_n157_));
  ...
  nand2  g111(.a(new_n86_), .b(new_n163_), .O(new_n164_));
