...
module FAU ( 
  ...
  nand2  g039(.a(new_n53_), .b(new_n91_), .O(new_n92_));
  nand3  g040(.a(new_n92_), .b(new_n90_), .c(new_n57_), .O(new_n93_));
  oai21  g041(.a(new_n55_), .b(x25), .c(new_n93_), .O(z05));
  nand3  g042(.a(x19), .b(new_n53_), .c(x05), .O(new_n95_));
  inv1   g043(.a(x27), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(x18), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n67_), .O(new_n99_));
  inv1   g047(.a(x26), .O(new_n100_));
  oai21  g048(.a(new_n100_), .b(x18), .c(new_n54_), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n99_), .O(z06));
  nand2  g050(.a(x20), .b(x18), .O(new_n103_));
  inv1   g051(.a(x04), .O(new_n104_));
  nand2  g052(.a(new_n53_), .b(new_n104_), .O(new_n105_));
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n57_), .O(new_n106_));
  oai21  g054(.a(new_n55_), .b(x27), .c(new_n106_), .O(z07));
  nand2  g055(.a(x29), .b(x18), .O(new_n108_));
  inv1   g056(.a(x11), .O(new_n109_));
  nand2  g057(.a(new_n53_), .b(new_n109_), .O(new_n110_));
  nand3  g058(.a(new_n110_), .b(new_n108_), .c(new_n57_), .O(new_n111_));
  oai21  g059(.a(new_n55_), .b(x28), .c(new_n111_), .O(z08));
  nand2  g060(.a(x30), .b(x18), .O(new_n113_));
  inv1   g061(.a(x10), .O(new_n114_));
  nand2  g062(.a(new_n53_), .b(new_n114_), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n57_), .O(new_n116_));
  oai21  g064(.a(new_n55_), .b(x29), .c(new_n116_), .O(z09));
  nand2  g065(.a(x31), .b(x18), .O(new_n118_));
  inv1   g066(.a(x09), .O(new_n119_));
  nand2  g067(.a(new_n53_), .b(new_n119_), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n57_), .O(new_n121_));
  oai21  g069(.a(new_n55_), .b(x30), .c(new_n121_), .O(z10));
  nand3  g070(.a(x19), .b(new_n53_), .c(x08), .O(new_n123_));
  nand2  g071(.a(new_n87_), .b(x18), .O(new_n124_));
  nand2  g072(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n67_), .O(new_n126_));
  inv1   g074(.a(x31), .O(new_n127_));
  oai21  g075(.a(new_n127_), .b(x18), .c(new_n54_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n126_), .O(z11));
  nand2  g077(.a(x33), .b(x18), .O(new_n130_));
  inv1   g078(.a(x15), .O(new_n131_));
  nand2  g079(.a(new_n53_), .b(new_n131_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n57_), .O(new_n133_));
  oai21  g081(.a(new_n55_), .b(x32), .c(new_n133_), .O(z12));
  nand3  g082(.a(x19), .b(new_n53_), .c(x14), .O(new_n135_));
  ...
  oai21  g088(.a(new_n140_), .b(x18), .c(new_n54_), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n139_), .O(z13));
  nand3  g090(.a(x19), .b(new_n53_), .c(x13), .O(new_n143_));
  inv1   g091(.a(x35), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(x18), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n67_), .O(new_n147_));
  oai21  g095(.a(new_n136_), .b(x18), .c(new_n54_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n147_), .O(z14));
  nand3  g097(.a(x19), .b(new_n53_), .c(x12), .O(new_n150_));
  inv1   g098(.a(x28), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(x18), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n67_), .O(new_n154_));
  oai21  g102(.a(new_n144_), .b(x18), .c(new_n54_), .O(new_n155_));
