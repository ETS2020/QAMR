...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x11), .O(new_n61_));
  ...
  nand4  g046(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n80_), .O(new_n99_));
  ...
  nand4  g053(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n80_), .O(new_n106_));
  ...
  nand3  g109(.a(new_n157_), .b(new_n54_), .c(x11), .O(new_n162_));
  oai21  g110(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(z14));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  oai21  g112(.a(x18), .b(x12), .c(new_n164_), .O(new_n165_));
  nor2   g113(.a(x35), .b(x19), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n158_), .O(new_n167_));
  oai21  g115(.a(new_n165_), .b(new_n159_), .c(new_n167_), .O(z15));
endmodule
