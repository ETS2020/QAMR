...
module FAU ( 
  ...
  nor2   g000(.a(x33), .b(x32), .O(new_n53_));
  ...
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n64_), .O(new_n97_));
  ...
  nand2  g093(.a(new_n64_), .b(new_n145_), .O(new_n146_));
  nand2  g094(.a(x33), .b(x18), .O(new_n147_));
  oai21  g095(.a(x18), .b(x15), .c(new_n147_), .O(new_n148_));
  nand3  g096(.a(x33), .b(new_n143_), .c(new_n54_), .O(new_n149_));
  oai21  g097(.a(new_n148_), .b(new_n146_), .c(new_n149_), .O(z12));
  oai21  g098(.a(new_n143_), .b(new_n54_), .c(new_n144_), .O(new_n151_));
  nand2  g099(.a(x34), .b(x18), .O(new_n152_));
  inv1   g100(.a(x14), .O(new_n153_));
  nand2  g101(.a(new_n60_), .b(new_n153_), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n64_), .O(new_n155_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n64_), .O(new_n160_));
