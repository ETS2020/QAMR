...
module FAU ( 
  ...
  aoi21  g39(.a(new_n57_), .b(new_n91_), .c(x17), .O(new_n92_));
  aoi21  g40(.a(new_n92_), .b(new_n90_), .c(new_n54_), .O(new_n93_));
  ...
  oai22  g53(.a(new_n105_), .b(new_n68_), .c(x28), .d(x19), .O(z08));
  nand2  g54(.a(x30), .b(x18), .O(new_n107_));
  inv1   g55(.a(x10), .O(new_n108_));
  aoi21  g56(.a(new_n57_), .b(new_n108_), .c(x17), .O(new_n109_));
  aoi21  g57(.a(new_n109_), .b(new_n107_), .c(new_n54_), .O(new_n110_));
  ...
  oai22  g70(.a(new_n122_), .b(new_n68_), .c(x31), .d(x19), .O(z11));
  nand2  g71(.a(x33), .b(x18), .O(new_n124_));
  oai21  g72(.a(x18), .b(x15), .c(new_n124_), .O(new_n125_));
  oai22  g73(.a(new_n125_), .b(new_n68_), .c(x32), .d(x19), .O(z12));
  ...
  oai22  g83(.a(new_n135_), .b(new_n68_), .c(x34), .d(x19), .O(z14));
  nand2  g84(.a(x28), .b(x18), .O(new_n137_));
  oai21  g85(.a(x18), .b(x12), .c(new_n137_), .O(new_n138_));
  oai22  g86(.a(new_n138_), .b(new_n68_), .c(x35), .d(x19), .O(z15));
endmodule
