...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x24), .O(new_n54_));
  ...
  oai21  g036(.a(x26), .b(new_n55_), .c(new_n88_), .O(new_n89_));
  nand2  g037(.a(x25), .b(x18), .O(new_n90_));
  inv1   g038(.a(x07), .O(new_n91_));
  nand2  g039(.a(new_n61_), .b(new_n91_), .O(new_n92_));
  nand3  g040(.a(new_n92_), .b(new_n90_), .c(new_n65_), .O(new_n93_));
  ...
  aoi21  g049(.a(x24), .b(x19), .c(new_n53_), .O(new_n102_));
  aoi21  g050(.a(x27), .b(x18), .c(x17), .O(new_n103_));
  oai21  g051(.a(x18), .b(x05), .c(new_n103_), .O(new_n104_));
  aoi21  g052(.a(new_n104_), .b(x19), .c(new_n102_), .O(z06));
  ...
  nand2  g061(.a(new_n113_), .b(new_n55_), .O(new_n114_));
  nand2  g062(.a(x29), .b(x18), .O(new_n115_));
  inv1   g063(.a(x11), .O(new_n116_));
  nand2  g064(.a(new_n61_), .b(new_n116_), .O(new_n117_));
  nand4  g065(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n58_), .O(new_n118_));
  aoi21  g066(.a(new_n118_), .b(new_n114_), .c(new_n54_), .O(z08));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n65_), .O(new_n158_));
