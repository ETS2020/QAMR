...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x10), .O(new_n61_));
  ...
  aoi21  g069(.a(x32), .b(x18), .c(x10), .O(new_n122_));
  nand2  g070(.a(x30), .b(x18), .O(new_n123_));
  nand3  g071(.a(new_n123_), .b(x19), .c(new_n66_), .O(new_n124_));
  inv1   g072(.a(x29), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n54_), .O(new_n126_));
  oai22  g074(.a(new_n126_), .b(new_n61_), .c(new_n124_), .d(new_n122_), .O(z09));
  ...
  nand3  g095(.a(new_n143_), .b(new_n54_), .c(x10), .O(new_n148_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n66_), .O(new_n160_));
