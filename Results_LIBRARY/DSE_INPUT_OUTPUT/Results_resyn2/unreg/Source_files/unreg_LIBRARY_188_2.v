...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x17), .O(new_n63_));
  ...
  nand2  g060(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  nand3  g061(.a(new_n113_), .b(new_n111_), .c(new_n63_), .O(z07));
  nand2  g062(.a(x29), .b(x18), .O(new_n115_));
  oai21  g063(.a(x18), .b(x11), .c(new_n115_), .O(new_n116_));
  inv1   g064(.a(x17), .O(new_n117_));
  aoi21  g065(.a(x19), .b(new_n117_), .c(new_n62_), .O(new_n118_));
  aoi21  g066(.a(new_n116_), .b(new_n55_), .c(new_n118_), .O(z08));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n63_), .O(z09));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n63_), .O(z12));
  ...
  nand2  g100(.a(new_n152_), .b(new_n63_), .O(new_n153_));
  ...
  nand2  g107(.a(new_n159_), .b(new_n63_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n158_), .O(z14));
  nand2  g109(.a(new_n62_), .b(x18), .O(new_n162_));
  nand3  g110(.a(new_n57_), .b(new_n117_), .c(x12), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(x19), .O(new_n165_));
  inv1   g113(.a(x35), .O(new_n166_));
  aoi22  g114(.a(new_n166_), .b(new_n54_), .c(new_n62_), .d(x17), .O(new_n167_));
