...
module FAU ( 
  ...
  oai21  g043(.a(new_n95_), .b(x18), .c(x26), .O(new_n96_));
  inv1   g044(.a(x06), .O(new_n97_));
  nand2  g045(.a(new_n61_), .b(new_n97_), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(new_n99_));
  nor2   g047(.a(x25), .b(x19), .O(new_n100_));
  oai21  g048(.a(x32), .b(new_n53_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n94_), .O(new_n106_));
  aoi21  g054(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n107_));
  ...
  oai21  g091(.a(x26), .b(new_n55_), .c(new_n95_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n61_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n94_), .O(new_n148_));
