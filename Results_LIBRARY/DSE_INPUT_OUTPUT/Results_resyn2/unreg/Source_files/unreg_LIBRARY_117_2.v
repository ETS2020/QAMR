...
module FAU ( 
  ...
  nor2   g001(.a(x33), .b(new_n53_), .O(new_n54_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n59_), .O(new_n118_));
  ...
  nand2  g090(.a(new_n53_), .b(new_n55_), .O(new_n143_));
  inv1   g091(.a(x17), .O(new_n144_));
  nor2   g092(.a(x18), .b(x15), .O(new_n145_));
  inv1   g093(.a(x33), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n53_), .O(new_n147_));
  nand4  g095(.a(x33), .b(x19), .c(new_n61_), .d(x15), .O(new_n148_));
  oai21  g096(.a(new_n147_), .b(new_n145_), .c(new_n148_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n143_), .O(z12));
  oai21  g099(.a(x32), .b(new_n55_), .c(new_n146_), .O(new_n152_));
  nand2  g100(.a(x34), .b(x18), .O(new_n153_));
  inv1   g101(.a(x14), .O(new_n154_));
  nand2  g102(.a(new_n61_), .b(new_n154_), .O(new_n155_));
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n59_), .O(new_n156_));
  ...
  nand3  g110(.a(new_n162_), .b(new_n160_), .c(new_n59_), .O(new_n163_));
  ...
  nor2   g117(.a(new_n169_), .b(new_n54_), .O(new_n170_));
