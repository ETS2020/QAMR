...
module FAU ( 
  ...
  aoi21  g020(.a(x28), .b(x19), .c(new_n72_), .O(new_n73_));
  ...
  aoi21  g040(.a(new_n92_), .b(new_n88_), .c(new_n77_), .O(z04));
  ...
  aoi21  g047(.a(new_n99_), .b(new_n95_), .c(new_n77_), .O(z05));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n77_), .O(z07));
  nor2   g062(.a(x28), .b(x22), .O(new_n115_));
  ...
  oai21  g067(.a(new_n119_), .b(new_n117_), .c(new_n116_), .O(z08));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n80_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n77_), .O(z11));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n80_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n77_), .O(z13));
  ...
  aoi21  g110(.a(x28), .b(new_n57_), .c(new_n115_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n166_), .b(new_n163_), .c(new_n168_), .O(z15));
endmodule
