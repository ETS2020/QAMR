...
module FAU ( 
  ...
  oai21  g048(.a(new_n100_), .b(new_n54_), .c(new_n99_), .O(new_n101_));
  ...
  inv1   g056(.a(x17), .O(new_n109_));
  nand2  g057(.a(x20), .b(x18), .O(new_n110_));
  inv1   g058(.a(x04), .O(new_n111_));
  nand2  g059(.a(new_n57_), .b(new_n111_), .O(new_n112_));
  nand4  g060(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n109_), .O(new_n113_));
  aoi21  g061(.a(new_n113_), .b(new_n108_), .c(new_n61_), .O(z07));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n109_), .O(new_n120_));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n109_), .O(new_n134_));
  ...
  oai21  g090(.a(new_n99_), .b(new_n54_), .c(new_n100_), .O(new_n143_));
