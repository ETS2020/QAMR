...
module FAU ( 
  ...
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n72_), .O(z10));
  ...
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n72_), .O(z11));
  ...
  aoi21  g106(.a(new_n158_), .b(new_n154_), .c(new_n72_), .O(z14));
