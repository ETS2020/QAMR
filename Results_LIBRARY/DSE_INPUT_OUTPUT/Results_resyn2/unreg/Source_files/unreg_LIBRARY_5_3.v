...
module FAU ( 
  ...
  nand2  g034(.a(new_n60_), .b(new_n86_), .O(new_n87_));
  nand3  g035(.a(new_n87_), .b(new_n85_), .c(new_n58_), .O(new_n88_));
  nor2   g036(.a(x24), .b(x19), .O(new_n89_));
  nor2   g037(.a(new_n89_), .b(new_n53_), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n88_), .O(z04));
  nand2  g039(.a(x26), .b(x18), .O(new_n92_));
  inv1   g040(.a(x06), .O(new_n93_));
  nand2  g041(.a(new_n60_), .b(new_n93_), .O(new_n94_));
  nand3  g042(.a(new_n94_), .b(new_n92_), .c(new_n58_), .O(new_n95_));
  nor2   g043(.a(x25), .b(x19), .O(new_n96_));
  nor2   g044(.a(new_n96_), .b(new_n53_), .O(new_n97_));
  ...
  aoi21  g052(.a(new_n104_), .b(new_n100_), .c(new_n53_), .O(z06));
  ...
  inv1   g060(.a(x32), .O(new_n113_));
  inv1   g061(.a(x17), .O(new_n114_));
  nand3  g062(.a(x19), .b(new_n60_), .c(new_n114_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(x11), .O(new_n117_));
  nor2   g065(.a(x28), .b(x19), .O(new_n118_));
  nor2   g066(.a(x29), .b(new_n60_), .O(new_n119_));
  aoi21  g067(.a(new_n119_), .b(new_n58_), .c(new_n118_), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n117_), .O(z08));
  ...
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n58_), .O(new_n132_));
  ...
  aoi21  g094(.a(new_n113_), .b(new_n54_), .c(new_n53_), .O(new_n147_));
  ...
  nor2   g108(.a(new_n160_), .b(new_n53_), .O(new_n161_));
