...
module FAU ( 
  ...
  aoi21  g065(.a(x34), .b(x19), .c(new_n117_), .O(new_n118_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n68_), .O(new_n141_));
  ...
  nand2  g104(.a(new_n62_), .b(new_n54_), .O(new_n157_));
