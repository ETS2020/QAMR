...
module FAU ( 
  ...
  nor2   g000(.a(x35), .b(x26), .O(new_n53_));
  ...
  nand3  g053(.a(x35), .b(new_n100_), .c(new_n54_), .O(new_n106_));
  ...
  nand2  g069(.a(new_n60_), .b(new_n121_), .O(new_n122_));
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n64_), .O(new_n123_));
  nor2   g071(.a(x29), .b(x19), .O(new_n124_));
  nor2   g072(.a(new_n124_), .b(new_n53_), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n123_), .O(z09));
  nand2  g074(.a(x31), .b(x18), .O(new_n127_));
  inv1   g075(.a(x09), .O(new_n128_));
  nand2  g076(.a(new_n60_), .b(new_n128_), .O(new_n129_));
  nand3  g077(.a(new_n129_), .b(new_n127_), .c(new_n64_), .O(new_n130_));
  nor2   g078(.a(x30), .b(x19), .O(new_n131_));
  nor2   g079(.a(new_n131_), .b(new_n53_), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n130_), .O(z10));
  inv1   g081(.a(x31), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n54_), .O(new_n135_));
  ...
  aoi21  g087(.a(new_n139_), .b(new_n135_), .c(new_n53_), .O(z11));
  nand2  g088(.a(x33), .b(x18), .O(new_n141_));
  inv1   g089(.a(x15), .O(new_n142_));
  nand2  g090(.a(new_n60_), .b(new_n142_), .O(new_n143_));
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n64_), .O(new_n144_));
  nor2   g092(.a(x32), .b(x19), .O(new_n145_));
  nor2   g093(.a(new_n145_), .b(new_n53_), .O(new_n146_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n64_), .O(new_n151_));
  ...
  oai21  g109(.a(new_n100_), .b(new_n54_), .c(new_n101_), .O(new_n162_));
