...
module FAU ( 
  ...
  nand3  g054(.a(new_n106_), .b(new_n104_), .c(new_n64_), .O(z06));
  ...
  nand2  g059(.a(new_n62_), .b(new_n54_), .O(new_n112_));
  nand3  g060(.a(new_n112_), .b(new_n111_), .c(new_n64_), .O(z07));
  inv1   g061(.a(x28), .O(new_n114_));
  oai21  g062(.a(x27), .b(new_n54_), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n64_), .O(z09));
  ...
  nand3  g088(.a(new_n140_), .b(new_n138_), .c(new_n64_), .O(z11));
  ...
  and2   g110(.a(new_n162_), .b(new_n64_), .O(z14));
  nand4  g111(.a(new_n114_), .b(x19), .c(x18), .d(new_n156_), .O(new_n164_));
  ...
  and2   g115(.a(new_n167_), .b(new_n64_), .O(z15));
endmodule
