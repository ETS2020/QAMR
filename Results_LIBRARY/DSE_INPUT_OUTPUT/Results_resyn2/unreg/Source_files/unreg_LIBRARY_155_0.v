...
module FAU ( 
  ...
  nor2   g008(.a(x31), .b(x14), .O(new_n61_));
  ...
  nor2   g076(.a(x18), .b(x09), .O(new_n129_));
  ...
  oai21  g081(.a(new_n131_), .b(new_n129_), .c(new_n133_), .O(z10));
  ...
  aoi21  g096(.a(x31), .b(x18), .c(x14), .O(new_n149_));
  nand2  g097(.a(x34), .b(x18), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(x19), .c(new_n80_), .O(new_n151_));
  inv1   g099(.a(x33), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n54_), .O(new_n153_));
  oai22  g101(.a(new_n153_), .b(new_n61_), .c(new_n151_), .d(new_n149_), .O(z13));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n80_), .O(new_n160_));
