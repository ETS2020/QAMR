...
module FAU ( 
  ...
  aoi21  g012(.a(new_n61_), .b(x18), .c(x02), .O(new_n65_));
  inv1   g013(.a(x17), .O(new_n66_));
  nand2  g014(.a(x22), .b(x18), .O(new_n67_));
  nand3  g015(.a(new_n67_), .b(x19), .c(new_n66_), .O(new_n68_));
  inv1   g016(.a(x21), .O(new_n69_));
  nand2  g017(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  oai22  g018(.a(new_n70_), .b(new_n62_), .c(new_n68_), .d(new_n65_), .O(z01));
  ...
  nand4  g092(.a(new_n144_), .b(new_n142_), .c(x19), .d(new_n66_), .O(new_n145_));
  aoi21  g093(.a(new_n145_), .b(new_n141_), .c(new_n62_), .O(z12));
  ...
  nand4  g099(.a(new_n151_), .b(new_n149_), .c(x19), .d(new_n66_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n66_), .O(new_n159_));
