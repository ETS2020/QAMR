...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nand2  g000(.a(x32), .b(x29), .O(new_n53_));
  ...
  oai21  g063(.a(x32), .b(x18), .c(x29), .O(new_n116_));
  ...
  nand3  g068(.a(new_n53_), .b(new_n120_), .c(new_n55_), .O(new_n121_));
  ...
  aoi21  g117(.a(new_n169_), .b(new_n55_), .c(new_n54_), .O(new_n170_));
