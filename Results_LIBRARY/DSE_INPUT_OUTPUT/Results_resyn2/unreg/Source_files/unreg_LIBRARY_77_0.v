...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x30), .O(new_n61_));
  ...
  nor2   g039(.a(new_n91_), .b(new_n61_), .O(new_n92_));
  ...
  nand4  g046(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n66_), .O(new_n99_));
  aoi21  g047(.a(new_n99_), .b(new_n95_), .c(new_n61_), .O(z05));
  ...
  nand4  g053(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n66_), .O(new_n106_));
  aoi21  g054(.a(new_n106_), .b(new_n102_), .c(new_n61_), .O(z06));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n66_), .O(new_n120_));
  ...
  nand3  g082(.a(x32), .b(new_n129_), .c(new_n54_), .O(new_n135_));
  oai21  g083(.a(new_n134_), .b(new_n132_), .c(new_n135_), .O(z10));
  nand2  g084(.a(x24), .b(x18), .O(new_n137_));
  oai21  g085(.a(x18), .b(x08), .c(new_n137_), .O(new_n138_));
  nor2   g086(.a(x31), .b(x19), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n131_), .O(new_n140_));
  oai21  g088(.a(new_n138_), .b(new_n132_), .c(new_n140_), .O(z11));
  nand2  g089(.a(x33), .b(x18), .O(new_n142_));
  oai21  g090(.a(x18), .b(x15), .c(new_n142_), .O(new_n143_));
  nand3  g091(.a(new_n130_), .b(x30), .c(new_n54_), .O(new_n144_));
  oai21  g092(.a(new_n143_), .b(new_n132_), .c(new_n144_), .O(z12));
  ...
  nor2   g098(.a(new_n150_), .b(new_n61_), .O(new_n151_));
  ...
  nand4  g105(.a(new_n157_), .b(new_n155_), .c(x19), .d(new_n66_), .O(new_n158_));
