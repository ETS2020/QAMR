...
module FAU ( 
  ...
  inv1   g035(.a(x17), .O(new_n88_));
  nand2  g036(.a(x25), .b(x18), .O(new_n89_));
  inv1   g037(.a(x07), .O(new_n90_));
  nand2  g038(.a(new_n60_), .b(new_n90_), .O(new_n91_));
  nand4  g039(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n88_), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n87_), .c(new_n69_), .O(z04));
  ...
  nand4  g046(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n88_), .O(new_n99_));
  aoi21  g047(.a(new_n99_), .b(new_n95_), .c(new_n69_), .O(z05));
  ...
  nand2  g055(.a(new_n55_), .b(new_n54_), .O(new_n108_));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n88_), .O(new_n120_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n88_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n69_), .O(z09));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n88_), .O(new_n134_));
