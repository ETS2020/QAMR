...
module FAU ( 
  ...
  nand2  g063(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  ...
  nand3  g067(.a(x32), .b(new_n114_), .c(new_n54_), .O(new_n120_));
  oai21  g068(.a(new_n119_), .b(new_n117_), .c(new_n120_), .O(z08));
  ...
  oai21  g073(.a(new_n123_), .b(new_n117_), .c(new_n125_), .O(z09));
  ...
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n66_), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(new_n128_), .c(new_n61_), .O(z10));
  ...
  nor2   g086(.a(new_n138_), .b(new_n61_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n137_), .O(z11));
  nand2  g088(.a(x33), .b(x18), .O(new_n141_));
  oai21  g089(.a(x18), .b(x15), .c(new_n141_), .O(new_n142_));
  nand3  g090(.a(new_n115_), .b(x28), .c(new_n54_), .O(new_n143_));
  oai21  g091(.a(new_n142_), .b(new_n117_), .c(new_n143_), .O(z12));
  nand2  g092(.a(x34), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x14), .c(new_n145_), .O(new_n146_));
  nor2   g094(.a(x33), .b(x19), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n116_), .O(new_n148_));
  oai21  g096(.a(new_n146_), .b(new_n117_), .c(new_n148_), .O(z13));
  nand2  g097(.a(x35), .b(x18), .O(new_n150_));
  ...
  nor2   g108(.a(x35), .b(x19), .O(new_n161_));
