...
module FAU ( 
  ...
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n86_), .O(z11));
  ...
  aoi21  g105(.a(x22), .b(x19), .c(new_n75_), .O(new_n158_));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n63_), .O(z15));
endmodule
