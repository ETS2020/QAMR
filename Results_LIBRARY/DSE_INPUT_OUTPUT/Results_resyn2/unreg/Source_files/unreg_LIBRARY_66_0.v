...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x30), .O(new_n53_));
  ...
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n58_), .O(new_n102_));
  ...
  inv1   g060(.a(new_n53_), .O(new_n113_));
  inv1   g061(.a(x17), .O(new_n114_));
  inv1   g062(.a(x29), .O(new_n115_));
  nand4  g063(.a(new_n115_), .b(x19), .c(x18), .d(new_n114_), .O(new_n116_));
  inv1   g064(.a(x28), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  nand4  g066(.a(x19), .b(new_n60_), .c(new_n114_), .d(x11), .O(new_n119_));
  nand3  g067(.a(new_n119_), .b(new_n118_), .c(new_n116_), .O(new_n120_));
  and2   g068(.a(new_n120_), .b(new_n113_), .O(z08));
  inv1   g069(.a(x30), .O(new_n122_));
  nand4  g070(.a(new_n122_), .b(x19), .c(x18), .d(new_n114_), .O(new_n123_));
  nand2  g071(.a(new_n115_), .b(new_n54_), .O(new_n124_));
  nand4  g072(.a(x19), .b(new_n60_), .c(new_n114_), .d(x10), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(new_n126_));
  and2   g074(.a(new_n126_), .b(new_n113_), .O(z09));
  nand2  g075(.a(x34), .b(x19), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n122_), .O(new_n129_));
  ...
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n53_), .O(z12));
  ...
  aoi21  g103(.a(x35), .b(x18), .c(x17), .O(new_n156_));
  oai21  g104(.a(x18), .b(x13), .c(new_n156_), .O(new_n157_));
  inv1   g105(.a(x34), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(x30), .O(new_n159_));
  aoi22  g107(.a(new_n159_), .b(new_n128_), .c(new_n157_), .d(x19), .O(z14));
