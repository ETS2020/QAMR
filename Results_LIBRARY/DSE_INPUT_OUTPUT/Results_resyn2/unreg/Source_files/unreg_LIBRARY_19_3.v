...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n72_, new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n84_,
  ...
  nand4  g29(.a(x19), .b(new_n54_), .c(new_n53_), .d(x09), .O(new_n82_));
  oai21  g30(.a(x30), .b(x19), .c(new_n82_), .O(z10));
  aoi21  g31(.a(new_n53_), .b(x08), .c(x18), .O(new_n84_));
  inv1   g32(.a(x31), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n57_), .O(new_n86_));
  oai21  g34(.a(new_n84_), .b(new_n57_), .c(new_n86_), .O(z11));
  aoi21  g35(.a(new_n53_), .b(x15), .c(x18), .O(new_n88_));
  inv1   g36(.a(x32), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(new_n57_), .O(new_n90_));
  oai21  g38(.a(new_n88_), .b(new_n57_), .c(new_n90_), .O(z12));
  aoi21  g39(.a(new_n53_), .b(x14), .c(x18), .O(new_n92_));
  inv1   g40(.a(x33), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n57_), .O(new_n94_));
  oai21  g42(.a(new_n92_), .b(new_n57_), .c(new_n94_), .O(z13));
  aoi21  g43(.a(new_n53_), .b(x13), .c(x18), .O(new_n96_));
  inv1   g44(.a(x34), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n57_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n57_), .c(new_n98_), .O(z14));
