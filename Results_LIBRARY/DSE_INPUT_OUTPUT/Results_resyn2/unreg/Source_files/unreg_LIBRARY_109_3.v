...
module FAU ( 
  ...
  nand4  g062(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n75_), .O(new_n115_));
  aoi21  g063(.a(new_n115_), .b(new_n111_), .c(new_n63_), .O(z07));
  aoi21  g064(.a(new_n62_), .b(x19), .c(new_n61_), .O(new_n117_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n75_), .O(new_n126_));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n75_), .O(new_n133_));
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n63_), .O(z10));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n75_), .O(new_n140_));
  ...
  nand4  g105(.a(new_n157_), .b(new_n155_), .c(x19), .d(new_n75_), .O(new_n158_));
