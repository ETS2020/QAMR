...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x07), .O(new_n61_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n88_), .c(new_n67_), .O(new_n91_));
  inv1   g039(.a(x24), .O(new_n92_));
  oai21  g040(.a(new_n92_), .b(x19), .c(new_n61_), .O(new_n93_));
  aoi21  g041(.a(new_n91_), .b(x19), .c(new_n93_), .O(z04));
