...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x05), .O(new_n54_));
  ...
  aoi21  g063(.a(x19), .b(x05), .c(new_n53_), .O(new_n116_));
  aoi21  g064(.a(x29), .b(x18), .c(x17), .O(new_n117_));
  oai21  g065(.a(x18), .b(x11), .c(new_n117_), .O(new_n118_));
  aoi21  g066(.a(new_n118_), .b(x19), .c(new_n116_), .O(z08));
  nand2  g067(.a(x30), .b(x18), .O(new_n120_));
  inv1   g068(.a(x10), .O(new_n121_));
  nand2  g069(.a(new_n61_), .b(new_n121_), .O(new_n122_));
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n72_), .O(new_n123_));
  ...
  nand2  g082(.a(new_n134_), .b(new_n55_), .O(new_n135_));
  nand2  g083(.a(x24), .b(x18), .O(new_n136_));
  inv1   g084(.a(x08), .O(new_n137_));
  nand2  g085(.a(new_n61_), .b(new_n137_), .O(new_n138_));
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n58_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n135_), .c(new_n54_), .O(z11));
  nand2  g088(.a(x33), .b(x18), .O(new_n141_));
  inv1   g089(.a(x15), .O(new_n142_));
  nand2  g090(.a(new_n61_), .b(new_n142_), .O(new_n143_));
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n72_), .O(new_n144_));
  nor2   g092(.a(x32), .b(x19), .O(new_n145_));
  nor2   g093(.a(new_n145_), .b(new_n54_), .O(new_n146_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n72_), .O(new_n151_));
