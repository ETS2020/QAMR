...
module FAU ( 
  ...
  nor2   g009(.a(x35), .b(new_n61_), .O(new_n62_));
  ...
  nand2  g080(.a(new_n57_), .b(new_n61_), .O(new_n133_));
  nand4  g081(.a(new_n133_), .b(new_n132_), .c(x19), .d(new_n89_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n131_), .c(new_n62_), .O(z10));
  ...
  oai21  g112(.a(new_n54_), .b(x09), .c(new_n164_), .O(new_n165_));
