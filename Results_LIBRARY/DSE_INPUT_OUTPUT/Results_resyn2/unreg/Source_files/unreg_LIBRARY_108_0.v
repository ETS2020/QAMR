...
module FAU ( 
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n73_), .O(new_n126_));
  ...
  oai21  g091(.a(new_n143_), .b(new_n54_), .c(new_n142_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n73_), .O(new_n155_));
  ...
  oai21  g111(.a(new_n142_), .b(new_n54_), .c(new_n143_), .O(new_n164_));
