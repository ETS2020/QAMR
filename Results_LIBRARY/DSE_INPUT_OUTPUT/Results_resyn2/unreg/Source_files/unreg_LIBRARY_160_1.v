...
module FAU ( 
  ...
  aoi21  g034(.a(new_n86_), .b(new_n80_), .c(new_n69_), .O(z03));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n69_), .O(z04));
  ...
  nor2   g047(.a(new_n99_), .b(new_n69_), .O(new_n100_));
  ...
  nor2   g054(.a(new_n106_), .b(new_n69_), .O(new_n107_));
  ...
  nor2   g096(.a(new_n148_), .b(new_n69_), .O(new_n149_));
  ...
  nor2   g103(.a(new_n155_), .b(new_n69_), .O(new_n156_));
  ...
  aoi21  g109(.a(new_n68_), .b(new_n53_), .c(new_n69_), .O(new_n162_));
