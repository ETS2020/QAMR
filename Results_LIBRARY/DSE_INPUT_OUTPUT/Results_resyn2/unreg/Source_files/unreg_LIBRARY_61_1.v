...
module FAU ( 
  ...
  aoi21  g049(.a(new_n53_), .b(x18), .c(x05), .O(new_n102_));
  nand2  g050(.a(x27), .b(x18), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(x19), .c(new_n58_), .O(new_n104_));
  inv1   g052(.a(x26), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n55_), .O(new_n106_));
  oai22  g054(.a(new_n106_), .b(new_n54_), .c(new_n104_), .d(new_n102_), .O(z06));
  nand2  g055(.a(x20), .b(x18), .O(new_n108_));
  inv1   g056(.a(x04), .O(new_n109_));
  nand2  g057(.a(new_n61_), .b(new_n109_), .O(new_n110_));
  nand3  g058(.a(new_n110_), .b(new_n108_), .c(new_n79_), .O(new_n111_));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n58_), .O(new_n120_));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n79_), .O(new_n139_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n79_), .O(new_n146_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n79_), .O(new_n159_));
