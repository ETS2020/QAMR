...
module FAU ( 
  ...
  nand3  g042(.a(new_n94_), .b(new_n92_), .c(new_n61_), .O(z04));
  ...
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n68_), .O(new_n106_));
  nand2  g054(.a(x26), .b(new_n54_), .O(new_n107_));
  nand2  g055(.a(new_n107_), .b(new_n61_), .O(new_n108_));
  aoi21  g056(.a(new_n106_), .b(x19), .c(new_n108_), .O(z06));
  nand3  g057(.a(new_n60_), .b(new_n62_), .c(new_n54_), .O(new_n110_));
  oai21  g058(.a(new_n60_), .b(x18), .c(x20), .O(new_n111_));
