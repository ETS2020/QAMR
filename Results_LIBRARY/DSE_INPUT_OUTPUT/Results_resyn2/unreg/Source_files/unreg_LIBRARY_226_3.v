...
module FAU ( 
  ...
  aoi21  g040(.a(new_n53_), .b(new_n56_), .c(new_n55_), .O(new_n93_));
  ...
  nand4  g058(.a(new_n110_), .b(new_n108_), .c(x19), .d(new_n59_), .O(new_n111_));
  aoi21  g059(.a(new_n111_), .b(new_n107_), .c(new_n55_), .O(z07));
  ...
  nand4  g065(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n59_), .O(new_n118_));
  aoi21  g066(.a(new_n118_), .b(new_n114_), .c(new_n55_), .O(z08));
  ...
  nand4  g072(.a(new_n124_), .b(new_n122_), .c(x19), .d(new_n59_), .O(new_n125_));
  aoi21  g073(.a(new_n125_), .b(new_n121_), .c(new_n55_), .O(z09));
  inv1   g074(.a(x30), .O(new_n127_));
  nand2  g075(.a(new_n127_), .b(new_n56_), .O(new_n128_));
  nand2  g076(.a(x31), .b(x18), .O(new_n129_));
  inv1   g077(.a(x09), .O(new_n130_));
  nand2  g078(.a(new_n62_), .b(new_n130_), .O(new_n131_));
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n59_), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(new_n128_), .c(new_n55_), .O(z10));
  nand2  g081(.a(x24), .b(x18), .O(new_n134_));
  inv1   g082(.a(x08), .O(new_n135_));
  nand2  g083(.a(new_n62_), .b(new_n135_), .O(new_n136_));
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n66_), .O(new_n137_));
  ...
  nand2  g089(.a(new_n141_), .b(new_n56_), .O(new_n142_));
  nand2  g090(.a(x33), .b(x18), .O(new_n143_));
  inv1   g091(.a(x15), .O(new_n144_));
  nand2  g092(.a(new_n62_), .b(new_n144_), .O(new_n145_));
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n59_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n142_), .c(new_n55_), .O(z12));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n66_), .O(new_n158_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n66_), .O(new_n165_));
