...
module FAU ( 
  ...
  inv1   g049(.a(x32), .O(new_n102_));
  oai21  g050(.a(new_n102_), .b(new_n54_), .c(new_n101_), .O(new_n103_));
  nand2  g051(.a(x27), .b(x18), .O(new_n104_));
  inv1   g052(.a(x05), .O(new_n105_));
  nand2  g053(.a(new_n60_), .b(new_n105_), .O(new_n106_));
  nand3  g054(.a(new_n106_), .b(new_n104_), .c(new_n93_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n57_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n53_), .O(z07));
  nand2  g063(.a(x29), .b(x18), .O(new_n116_));
  inv1   g064(.a(x11), .O(new_n117_));
  nand2  g065(.a(new_n60_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n93_), .O(new_n119_));
  nor2   g067(.a(x28), .b(x19), .O(new_n120_));
  nor2   g068(.a(new_n120_), .b(new_n53_), .O(new_n121_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n93_), .O(new_n133_));
  ...
  nand2  g091(.a(new_n102_), .b(new_n101_), .O(new_n144_));
  nand2  g092(.a(new_n93_), .b(new_n144_), .O(new_n145_));
  nand2  g093(.a(x33), .b(x18), .O(new_n146_));
  oai21  g094(.a(x18), .b(x15), .c(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n102_), .b(x26), .c(new_n54_), .O(new_n148_));
  ...
  nand2  g100(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  oai21  g101(.a(new_n151_), .b(new_n145_), .c(new_n153_), .O(z13));
  ...
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n53_), .O(z14));
