...
module FAU ( 
  ...
  and2   g000(.a(x32), .b(x06), .O(new_n53_));
  ...
  aoi21  g038(.a(new_n90_), .b(new_n86_), .c(new_n53_), .O(z04));
  inv1   g039(.a(x32), .O(new_n92_));
  inv1   g040(.a(x17), .O(new_n93_));
  nand3  g041(.a(x19), .b(new_n60_), .c(new_n93_), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(x06), .O(new_n96_));
  nor2   g044(.a(x25), .b(x19), .O(new_n97_));
  nor2   g045(.a(x26), .b(new_n60_), .O(new_n98_));
  aoi21  g046(.a(new_n98_), .b(new_n58_), .c(new_n97_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n96_), .O(z05));
  ...
  aoi21  g094(.a(new_n92_), .b(new_n54_), .c(new_n53_), .O(new_n147_));
