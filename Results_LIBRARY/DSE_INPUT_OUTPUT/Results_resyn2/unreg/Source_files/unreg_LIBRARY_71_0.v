...
module FAU ( 
  ...
  nand4  g045(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n94_), .O(new_n98_));
  aoi21  g046(.a(new_n98_), .b(new_n93_), .c(new_n61_), .O(z05));
  ...
  nand4  g052(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n94_), .O(new_n105_));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n94_), .O(new_n112_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n94_), .O(new_n124_));
  ...
  nand2  g078(.a(new_n127_), .b(new_n55_), .O(new_n131_));
  nand2  g079(.a(x31), .b(x18), .O(new_n132_));
  oai21  g080(.a(x18), .b(x09), .c(new_n132_), .O(new_n133_));
  nand3  g081(.a(x32), .b(new_n125_), .c(new_n54_), .O(new_n134_));
  oai21  g082(.a(new_n133_), .b(new_n131_), .c(new_n134_), .O(z10));
  nand2  g083(.a(x24), .b(x18), .O(new_n136_));
  oai21  g084(.a(x18), .b(x08), .c(new_n136_), .O(new_n137_));
  nor2   g085(.a(x31), .b(x19), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(new_n127_), .O(new_n139_));
  oai21  g087(.a(new_n137_), .b(new_n131_), .c(new_n139_), .O(z11));
  oai21  g088(.a(new_n125_), .b(new_n54_), .c(new_n126_), .O(new_n141_));
  ...
  nor2   g099(.a(new_n151_), .b(new_n61_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n94_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n155_), .c(new_n61_), .O(z14));
  ...
  nand4  g113(.a(new_n165_), .b(new_n163_), .c(x19), .d(new_n94_), .O(new_n166_));
