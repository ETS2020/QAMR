...
module FAU ( 
  ...
  nand2  g085(.a(new_n61_), .b(new_n137_), .O(new_n138_));
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n59_), .O(new_n139_));
  nor2   g087(.a(x31), .b(x19), .O(new_n140_));
  nor2   g088(.a(new_n140_), .b(new_n54_), .O(new_n141_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n59_), .O(new_n146_));
  nor2   g094(.a(x32), .b(x19), .O(new_n147_));
  nor2   g095(.a(new_n147_), .b(new_n54_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n146_), .O(z12));
  ...
  nor2   g104(.a(x18), .b(x13), .O(new_n157_));
  oai21  g105(.a(new_n157_), .b(x17), .c(x19), .O(new_n158_));
  nand2  g106(.a(x34), .b(new_n55_), .O(new_n159_));
  nand2  g107(.a(x19), .b(x18), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(x08), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(x35), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(new_n159_), .c(new_n158_), .O(new_n163_));
  inv1   g111(.a(new_n163_), .O(z14));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n61_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n59_), .O(new_n168_));
  aoi21  g116(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n168_), .O(z15));
endmodule
