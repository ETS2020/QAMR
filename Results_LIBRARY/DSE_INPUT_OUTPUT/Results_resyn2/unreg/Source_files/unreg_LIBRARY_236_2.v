...
module FAU ( 
  ...
  nand2  g021(.a(new_n61_), .b(new_n53_), .O(new_n74_));
  nand3  g022(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(new_n75_));
  inv1   g023(.a(x22), .O(new_n76_));
  oai22  g024(.a(x32), .b(new_n53_), .c(new_n76_), .d(x19), .O(new_n77_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n87_), .c(new_n65_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n65_), .O(new_n97_));
  ...
  oai21  g091(.a(new_n55_), .b(x01), .c(new_n143_), .O(new_n144_));
