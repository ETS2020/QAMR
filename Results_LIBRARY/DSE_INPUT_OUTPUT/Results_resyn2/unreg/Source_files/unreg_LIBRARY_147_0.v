...
module FAU ( 
  ...
  oai21  g090(.a(new_n100_), .b(new_n54_), .c(new_n101_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n73_), .O(new_n154_));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n73_), .O(new_n161_));
