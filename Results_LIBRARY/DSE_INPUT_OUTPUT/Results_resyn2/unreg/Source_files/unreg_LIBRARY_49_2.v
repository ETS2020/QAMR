...
module FAU ( 
  ...
  inv1   g012(.a(new_n61_), .O(new_n65_));
  ...
  nand3  g027(.a(new_n79_), .b(new_n77_), .c(new_n61_), .O(z02));
  ...
  nand3  g035(.a(new_n87_), .b(new_n85_), .c(new_n61_), .O(z03));
  ...
  oai21  g064(.a(x20), .b(new_n54_), .c(new_n60_), .O(new_n117_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n68_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n68_), .O(new_n142_));
  ...
  nand3  g097(.a(new_n149_), .b(new_n147_), .c(new_n61_), .O(z12));
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n61_), .O(z13));
  ...
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n61_), .O(z14));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n57_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n68_), .O(new_n168_));
  nand2  g116(.a(x35), .b(new_n54_), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n61_), .O(new_n170_));
  aoi21  g118(.a(new_n168_), .b(x19), .c(new_n170_), .O(z15));
endmodule
