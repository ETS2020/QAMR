...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x27), .O(new_n63_));
  ...
  aoi21  g057(.a(x35), .b(x19), .c(new_n109_), .O(new_n110_));
  inv1   g058(.a(x04), .O(new_n111_));
  aoi21  g059(.a(new_n57_), .b(new_n111_), .c(x17), .O(new_n112_));
  oai21  g060(.a(new_n60_), .b(new_n57_), .c(new_n112_), .O(new_n113_));
  aoi21  g061(.a(new_n113_), .b(x19), .c(new_n110_), .O(z07));
  ...
  nand3  g075(.a(new_n127_), .b(new_n125_), .c(new_n63_), .O(z09));
  ...
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n65_), .O(z12));
  ...
  inv1   g104(.a(new_n55_), .O(new_n157_));
  nor2   g105(.a(x35), .b(x27), .O(new_n158_));
  inv1   g106(.a(x13), .O(new_n159_));
  nor2   g107(.a(x18), .b(new_n159_), .O(new_n160_));
  aoi22  g108(.a(new_n160_), .b(new_n63_), .c(new_n158_), .d(x18), .O(new_n161_));
  nor2   g109(.a(x34), .b(x19), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n63_), .O(new_n163_));
  oai21  g111(.a(new_n161_), .b(new_n157_), .c(new_n163_), .O(z14));
  nand2  g112(.a(new_n158_), .b(new_n54_), .O(new_n165_));
  nand2  g113(.a(new_n63_), .b(new_n55_), .O(new_n166_));
  nand2  g114(.a(x28), .b(x18), .O(new_n167_));
  oai21  g115(.a(x18), .b(x12), .c(new_n167_), .O(new_n168_));
  oai21  g116(.a(new_n168_), .b(new_n166_), .c(new_n165_), .O(z15));
endmodule
