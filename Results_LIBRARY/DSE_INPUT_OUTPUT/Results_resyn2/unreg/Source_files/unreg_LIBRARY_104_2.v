...
module FAU ( 
  ...
  aoi21  g033(.a(new_n85_), .b(new_n80_), .c(new_n62_), .O(z03));
  ...
  inv1   g055(.a(x17), .O(new_n108_));
  nand3  g056(.a(x19), .b(new_n57_), .c(new_n108_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(x32), .O(new_n110_));
  nand2  g058(.a(new_n110_), .b(x04), .O(new_n111_));
  nor2   g059(.a(x27), .b(x19), .O(new_n112_));
  nor2   g060(.a(x20), .b(new_n57_), .O(new_n113_));
  aoi21  g061(.a(new_n113_), .b(new_n55_), .c(new_n112_), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n111_), .O(z07));
  ...
  nor2   g091(.a(new_n54_), .b(x04), .O(new_n144_));
  ...
  nor2   g102(.a(new_n154_), .b(new_n62_), .O(new_n155_));
