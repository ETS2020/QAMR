...
module FAU ( 
  ...
  nor2   g008(.a(x35), .b(x22), .O(new_n61_));
  ...
  oai21  g016(.a(new_n66_), .b(new_n64_), .c(new_n68_), .O(z01));
  nand2  g017(.a(x23), .b(x18), .O(new_n70_));
  inv1   g018(.a(x01), .O(new_n71_));
  aoi21  g019(.a(new_n57_), .b(new_n71_), .c(x17), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  inv1   g021(.a(new_n61_), .O(new_n74_));
  nand2  g022(.a(x22), .b(new_n54_), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g024(.a(new_n73_), .b(x19), .c(new_n76_), .O(z02));
  ...
  inv1   g103(.a(new_n55_), .O(new_n156_));
  nor2   g104(.a(new_n65_), .b(x35), .O(new_n157_));
  inv1   g105(.a(x13), .O(new_n158_));
  nor2   g106(.a(x18), .b(new_n158_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n74_), .c(new_n157_), .O(new_n160_));
  nor2   g108(.a(x34), .b(x19), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n74_), .O(new_n162_));
  oai21  g110(.a(new_n160_), .b(new_n156_), .c(new_n162_), .O(z14));
  nand2  g111(.a(new_n74_), .b(new_n55_), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  oai21  g113(.a(x18), .b(x12), .c(new_n165_), .O(new_n166_));
  oai22  g114(.a(new_n166_), .b(new_n164_), .c(new_n75_), .d(x35), .O(z15));
endmodule
