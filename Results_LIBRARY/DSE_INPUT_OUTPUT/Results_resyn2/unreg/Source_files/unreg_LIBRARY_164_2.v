...
module FAU ( 
  ...
  aoi21  g44(.a(new_n57_), .b(new_n96_), .c(x17), .O(new_n97_));
  ...
  nand2  g62(.a(new_n57_), .b(x15), .O(new_n115_));
  oai22  g63(.a(new_n115_), .b(new_n64_), .c(x32), .d(x19), .O(z12));
  nand2  g64(.a(x34), .b(x18), .O(new_n117_));
  oai21  g65(.a(x18), .b(x14), .c(new_n117_), .O(new_n118_));
  oai22  g66(.a(new_n118_), .b(new_n64_), .c(x33), .d(x19), .O(z13));
  nand2  g67(.a(x35), .b(x18), .O(new_n120_));
  oai21  g68(.a(x18), .b(x13), .c(new_n120_), .O(new_n121_));
  oai22  g69(.a(new_n121_), .b(new_n64_), .c(x34), .d(x19), .O(z14));
  nand2  g70(.a(x28), .b(x18), .O(new_n123_));
  oai21  g71(.a(x18), .b(x12), .c(new_n123_), .O(new_n124_));
  oai22  g72(.a(new_n124_), .b(new_n64_), .c(x35), .d(x19), .O(z15));
endmodule
