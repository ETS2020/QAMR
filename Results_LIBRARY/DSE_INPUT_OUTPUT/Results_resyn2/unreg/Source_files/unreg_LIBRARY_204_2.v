...
module FAU ( 
  ...
  nor2   g01(.a(new_n53_), .b(x17), .O(new_n54_));
  nand2  g02(.a(new_n54_), .b(x28), .O(new_n55_));
  ...
  oai22  g31(.a(new_n83_), .b(new_n55_), .c(x25), .d(x19), .O(z05));
  ...
  aoi21  g42(.a(new_n94_), .b(new_n92_), .c(new_n62_), .O(new_n95_));
  inv1   g43(.a(x27), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n53_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n53_), .c(new_n97_), .O(z07));
  nor2   g46(.a(x18), .b(x11), .O(new_n99_));
  nand2  g47(.a(x29), .b(x18), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n54_), .O(new_n101_));
  oai21  g49(.a(new_n101_), .b(new_n99_), .c(x28), .O(z08));
  nand2  g50(.a(x30), .b(x18), .O(new_n103_));
  oai21  g51(.a(x18), .b(x10), .c(new_n103_), .O(new_n104_));
  oai22  g52(.a(new_n104_), .b(new_n55_), .c(x29), .d(x19), .O(z09));
  nand2  g53(.a(x31), .b(x18), .O(new_n106_));
  inv1   g54(.a(x09), .O(new_n107_));
  aoi21  g55(.a(new_n65_), .b(new_n107_), .c(x17), .O(new_n108_));
  aoi21  g56(.a(new_n108_), .b(new_n106_), .c(new_n62_), .O(new_n109_));
  inv1   g57(.a(x30), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n53_), .O(new_n111_));
  oai21  g59(.a(new_n109_), .b(new_n53_), .c(new_n111_), .O(z10));
  nand2  g60(.a(x24), .b(x18), .O(new_n113_));
  inv1   g61(.a(x08), .O(new_n114_));
  aoi21  g62(.a(new_n65_), .b(new_n114_), .c(x17), .O(new_n115_));
  aoi21  g63(.a(new_n115_), .b(new_n113_), .c(new_n62_), .O(new_n116_));
  inv1   g64(.a(x31), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n53_), .O(new_n118_));
  oai21  g66(.a(new_n116_), .b(new_n53_), .c(new_n118_), .O(z11));
  nand2  g67(.a(x33), .b(x18), .O(new_n120_));
  oai21  g68(.a(x18), .b(x15), .c(new_n120_), .O(new_n121_));
  oai22  g69(.a(new_n121_), .b(new_n55_), .c(x32), .d(x19), .O(z12));
  nand2  g70(.a(x34), .b(x18), .O(new_n123_));
  inv1   g71(.a(x14), .O(new_n124_));
  aoi21  g72(.a(new_n65_), .b(new_n124_), .c(x17), .O(new_n125_));
  aoi21  g73(.a(new_n125_), .b(new_n123_), .c(new_n62_), .O(new_n126_));
  ...
  nand3  g81(.a(new_n65_), .b(new_n133_), .c(x12), .O(new_n134_));
  nand2  g82(.a(new_n134_), .b(x28), .O(new_n135_));
  nand2  g83(.a(new_n135_), .b(x19), .O(new_n136_));
  oai21  g84(.a(x35), .b(x19), .c(new_n136_), .O(z15));
endmodule
