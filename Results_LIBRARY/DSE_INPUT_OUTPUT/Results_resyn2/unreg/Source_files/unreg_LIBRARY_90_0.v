...
module FAU ( 
  ...
  nor2   g000(.a(x35), .b(x33), .O(new_n53_));
  ...
  nand3  g090(.a(x35), .b(new_n142_), .c(x18), .O(new_n143_));
  nand2  g091(.a(new_n60_), .b(x15), .O(new_n144_));
  oai21  g092(.a(new_n144_), .b(new_n53_), .c(new_n143_), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n58_), .O(new_n146_));
  inv1   g094(.a(new_n53_), .O(new_n147_));
  nor2   g095(.a(x32), .b(x19), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n146_), .O(z12));
  nand3  g098(.a(x35), .b(new_n142_), .c(new_n54_), .O(new_n151_));
  nand2  g099(.a(new_n58_), .b(new_n147_), .O(new_n152_));
  nand2  g100(.a(x34), .b(x18), .O(new_n153_));
  oai21  g101(.a(x18), .b(x14), .c(new_n153_), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(new_n152_), .c(new_n151_), .O(z13));
  ...
  nor2   g110(.a(new_n142_), .b(new_n54_), .O(new_n163_));
  ...
  oai21  g115(.a(new_n163_), .b(x35), .c(new_n167_), .O(z15));
endmodule
