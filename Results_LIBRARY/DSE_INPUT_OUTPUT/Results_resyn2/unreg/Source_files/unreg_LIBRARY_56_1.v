...
module FAU ( 
  ...
  aoi21  g79(.a(new_n57_), .b(new_n131_), .c(x17), .O(new_n132_));
  aoi21  g80(.a(new_n132_), .b(new_n130_), .c(new_n54_), .O(new_n133_));
  ...
  oai21  g87(.a(new_n103_), .b(new_n57_), .c(new_n63_), .O(new_n140_));
  nor2   g88(.a(new_n53_), .b(new_n54_), .O(new_n141_));
  aoi22  g89(.a(new_n141_), .b(new_n140_), .c(x35), .d(new_n53_), .O(z15));
endmodule
