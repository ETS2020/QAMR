...
module FAU ( 
  ...
  nand3  g27(.a(x22), .b(x19), .c(new_n63_), .O(new_n80_));
  ...
  oai21  g54(.a(new_n104_), .b(new_n53_), .c(new_n106_), .O(z08));
  ...
  oai21  g61(.a(new_n111_), .b(new_n53_), .c(new_n113_), .O(z09));
  ...
  oai21  g74(.a(new_n124_), .b(new_n53_), .c(new_n126_), .O(z12));
  ...
  oai21  g84(.a(new_n134_), .b(new_n53_), .c(new_n136_), .O(z14));
