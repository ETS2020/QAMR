...
module FAU ( 
  ...
  nor2   g009(.a(x24), .b(new_n61_), .O(new_n62_));
  nor2   g010(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g011(.a(new_n63_), .b(new_n59_), .O(z00));
  aoi21  g012(.a(x24), .b(x19), .c(new_n61_), .O(new_n65_));
  ...
  oai21  g035(.a(x21), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  ...
  nor2   g046(.a(new_n98_), .b(new_n62_), .O(new_n99_));
  ...
  aoi21  g068(.a(new_n120_), .b(new_n116_), .c(new_n62_), .O(z08));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n66_), .O(new_n127_));
  ...
  nor2   g095(.a(new_n147_), .b(new_n62_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n66_), .O(new_n155_));
