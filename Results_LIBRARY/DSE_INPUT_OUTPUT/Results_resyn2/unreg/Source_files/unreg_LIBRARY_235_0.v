...
module FAU ( 
  ...
  nand2  g001(.a(x20), .b(x10), .O(new_n54_));
  ...
  inv1   g011(.a(x10), .O(new_n64_));
  nor2   g012(.a(x19), .b(new_n64_), .O(new_n65_));
  nand2  g013(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand2  g014(.a(x22), .b(x18), .O(new_n67_));
  inv1   g015(.a(x02), .O(new_n68_));
  nand2  g016(.a(new_n59_), .b(new_n68_), .O(new_n69_));
  nand4  g017(.a(new_n69_), .b(new_n67_), .c(x19), .d(new_n56_), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n66_), .O(z01));
  nand2  g019(.a(x22), .b(x10), .O(new_n72_));
  ...
  nand2  g035(.a(new_n65_), .b(new_n87_), .O(new_n88_));
  ...
  nand2  g042(.a(new_n65_), .b(new_n94_), .O(new_n95_));
  ...
  nand2  g049(.a(new_n65_), .b(new_n101_), .O(new_n102_));
  ...
  nand2  g056(.a(new_n65_), .b(new_n108_), .O(new_n109_));
  ...
  nand2  g072(.a(new_n59_), .b(new_n64_), .O(new_n125_));
  nand4  g073(.a(new_n125_), .b(new_n124_), .c(x19), .d(new_n56_), .O(new_n126_));
  ...
  nand2  g097(.a(new_n65_), .b(new_n149_), .O(new_n150_));
  ...
  nand2  g104(.a(new_n65_), .b(new_n156_), .O(new_n157_));
