...
module FAU ( 
  ...
  nand2  g017(.a(x34), .b(x22), .O(new_n70_));
  ...
  nand2  g024(.a(x34), .b(x23), .O(new_n77_));
  ...
  nand2  g032(.a(x34), .b(x24), .O(new_n85_));
  ...
  inv1   g040(.a(x34), .O(new_n93_));
  nor2   g041(.a(new_n93_), .b(x19), .O(new_n94_));
  ...
  nand2  g048(.a(x34), .b(x26), .O(new_n101_));
  ...
  nand2  g056(.a(new_n94_), .b(new_n108_), .O(new_n109_));
  ...
  nand2  g063(.a(new_n94_), .b(new_n115_), .O(new_n116_));
  ...
  nand2  g069(.a(x34), .b(x29), .O(new_n122_));
  ...
  nand2  g076(.a(x34), .b(x30), .O(new_n129_));
  ...
  nand2  g084(.a(new_n94_), .b(new_n136_), .O(new_n137_));
  ...
  nand2  g090(.a(x34), .b(x32), .O(new_n143_));
  ...
  nand2  g098(.a(new_n94_), .b(new_n150_), .O(new_n151_));
  ...
  nand2  g110(.a(new_n94_), .b(new_n162_), .O(new_n163_));
