...
module FAU ( 
  ...
  aoi21  g071(.a(new_n54_), .b(x19), .c(new_n53_), .O(new_n124_));
  nand2  g072(.a(x30), .b(x18), .O(new_n125_));
  inv1   g073(.a(x10), .O(new_n126_));
  nand2  g074(.a(new_n62_), .b(new_n126_), .O(new_n127_));
  nand3  g075(.a(new_n127_), .b(new_n125_), .c(new_n59_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(x19), .c(new_n124_), .O(z09));
