...
module FAU ( 
  ...
  aoi21  g096(.a(new_n54_), .b(new_n56_), .c(new_n55_), .O(new_n149_));
  ...
  nor2   g110(.a(new_n162_), .b(new_n55_), .O(new_n163_));
  ...
  nand2  g115(.a(new_n62_), .b(new_n53_), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n167_), .c(x19), .d(new_n59_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n166_), .c(new_n55_), .O(z15));
endmodule
