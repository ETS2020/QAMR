...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x24), .O(new_n53_));
  ...
  inv1   g034(.a(x32), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g036(.a(new_n71_), .b(new_n88_), .O(new_n89_));
  nand2  g037(.a(x25), .b(x18), .O(new_n90_));
  oai21  g038(.a(x18), .b(x07), .c(new_n90_), .O(new_n91_));
  nand3  g039(.a(x32), .b(new_n86_), .c(new_n54_), .O(new_n92_));
  oai21  g040(.a(new_n91_), .b(new_n89_), .c(new_n92_), .O(z04));
  nand2  g041(.a(x26), .b(x18), .O(new_n94_));
  oai21  g042(.a(x18), .b(x06), .c(new_n94_), .O(new_n95_));
  nor2   g043(.a(x25), .b(x19), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  oai21  g045(.a(new_n95_), .b(new_n89_), .c(new_n97_), .O(z05));
  nand2  g046(.a(x27), .b(x18), .O(new_n99_));
  inv1   g047(.a(x05), .O(new_n100_));
  nand2  g048(.a(new_n60_), .b(new_n100_), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n71_), .O(new_n102_));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n71_), .O(new_n137_));
  nor2   g085(.a(x31), .b(x19), .O(new_n138_));
  nor2   g086(.a(new_n138_), .b(new_n53_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n137_), .O(z11));
  oai21  g088(.a(new_n86_), .b(new_n54_), .c(new_n87_), .O(new_n141_));
  nand2  g089(.a(x33), .b(x18), .O(new_n142_));
  inv1   g090(.a(x15), .O(new_n143_));
  nand2  g091(.a(new_n60_), .b(new_n143_), .O(new_n144_));
  nand3  g092(.a(new_n144_), .b(new_n142_), .c(new_n71_), .O(new_n145_));
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n71_), .O(new_n157_));
  nor2   g105(.a(x34), .b(x19), .O(new_n158_));
  nor2   g106(.a(new_n158_), .b(new_n53_), .O(new_n159_));
  ...
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n71_), .O(new_n164_));
  nor2   g112(.a(x35), .b(x19), .O(new_n165_));
  nor2   g113(.a(new_n165_), .b(new_n53_), .O(new_n166_));
