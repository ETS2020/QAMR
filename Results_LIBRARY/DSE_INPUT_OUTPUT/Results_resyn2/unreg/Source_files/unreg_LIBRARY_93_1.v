...
module FAU ( 
  ...
  aoi21  g034(.a(new_n53_), .b(x18), .c(x07), .O(new_n87_));
  inv1   g035(.a(x17), .O(new_n88_));
  nand2  g036(.a(x25), .b(x18), .O(new_n89_));
  nand3  g037(.a(new_n89_), .b(x19), .c(new_n88_), .O(new_n90_));
  inv1   g038(.a(x24), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n55_), .O(new_n92_));
  oai22  g040(.a(new_n92_), .b(new_n54_), .c(new_n90_), .d(new_n87_), .O(z04));
  ...
  aoi21  g109(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n162_));
