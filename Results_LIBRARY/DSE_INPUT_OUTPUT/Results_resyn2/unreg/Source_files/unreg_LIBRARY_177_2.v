// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:47 2020
...
module FAU ( 
  ...
  nor2   g009(.a(x30), .b(new_n61_), .O(new_n62_));
  ...
  nor2   g039(.a(new_n91_), .b(new_n62_), .O(new_n92_));
  ...
  nor2   g053(.a(new_n105_), .b(new_n62_), .O(new_n106_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n62_), .O(z07));
  ...
  nor2   g076(.a(new_n54_), .b(x15), .O(new_n129_));
  ...
  oai21  g081(.a(new_n129_), .b(x30), .c(new_n133_), .O(z10));
  ...
  nor2   g087(.a(new_n139_), .b(new_n62_), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n138_), .O(z11));
  inv1   g089(.a(x17), .O(new_n142_));
  nand3  g090(.a(x19), .b(new_n57_), .c(new_n142_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(x30), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(x15), .O(new_n145_));
  nor2   g093(.a(x32), .b(x19), .O(new_n146_));
  nor2   g094(.a(x33), .b(new_n57_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(new_n55_), .c(new_n146_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n145_), .O(z12));
  ...
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n55_), .O(new_n155_));
  ...
  nor2   g109(.a(new_n161_), .b(new_n62_), .O(new_n162_));
  ...
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n55_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n62_), .O(z15));
endmodule
