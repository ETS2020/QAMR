...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x12), .O(new_n54_));
  ...
  aoi21  g111(.a(new_n53_), .b(x18), .c(x12), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  nand3  g113(.a(new_n165_), .b(x19), .c(new_n58_), .O(new_n166_));
  inv1   g114(.a(x35), .O(new_n167_));
  nand2  g115(.a(new_n167_), .b(new_n55_), .O(new_n168_));
  oai22  g116(.a(new_n168_), .b(new_n54_), .c(new_n166_), .d(new_n164_), .O(z15));
endmodule
