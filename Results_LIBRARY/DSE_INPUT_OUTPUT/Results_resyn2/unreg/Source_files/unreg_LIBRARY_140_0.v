...
module FAU ( 
  ...
  nand2  g017(.a(new_n67_), .b(new_n53_), .O(new_n70_));
  ...
  nand2  g023(.a(x23), .b(x22), .O(new_n76_));
  ...
  nor2   g032(.a(new_n67_), .b(x19), .O(new_n85_));
  ...
  nand2  g039(.a(x25), .b(x22), .O(new_n92_));
  ...
  nand2  g046(.a(x26), .b(x22), .O(new_n99_));
  ...
  nand2  g054(.a(new_n85_), .b(new_n106_), .O(new_n107_));
  ...
  nand2  g060(.a(x28), .b(x22), .O(new_n113_));
  ...
  nand2  g067(.a(x29), .b(x22), .O(new_n120_));
  ...
  nand2  g075(.a(new_n85_), .b(new_n127_), .O(new_n128_));
  ...
  nand2  g082(.a(new_n85_), .b(new_n134_), .O(new_n135_));
  ...
  nand2  g088(.a(x32), .b(x22), .O(new_n141_));
  ...
  nand2  g096(.a(new_n85_), .b(new_n148_), .O(new_n149_));
  ...
  nand2  g102(.a(x34), .b(x22), .O(new_n155_));
  ...
  nand2  g110(.a(new_n85_), .b(new_n162_), .O(new_n163_));
