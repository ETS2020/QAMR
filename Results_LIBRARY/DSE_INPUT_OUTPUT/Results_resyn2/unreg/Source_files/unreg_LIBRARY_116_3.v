...
module FAU ( 
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n66_), .O(new_n152_));
  ...
  aoi21  g110(.a(new_n53_), .b(x19), .c(new_n54_), .O(new_n163_));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  inv1   g112(.a(x12), .O(new_n165_));
  nand2  g113(.a(new_n62_), .b(new_n165_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n59_), .O(new_n167_));
