...
module FAU ( 
  ...
  aoi21  g047(.a(new_n99_), .b(new_n95_), .c(new_n63_), .O(z05));
  ...
  nand3  g061(.a(new_n113_), .b(new_n111_), .c(new_n64_), .O(z07));
  ...
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n64_), .O(z08));
  ...
  nand2  g078(.a(new_n130_), .b(x34), .O(new_n131_));
  ...
  nand3  g083(.a(new_n55_), .b(new_n135_), .c(x18), .O(new_n136_));
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n132_), .O(z10));
  ...
  nand2  g089(.a(new_n135_), .b(new_n54_), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(new_n141_), .c(new_n64_), .O(z11));
  inv1   g091(.a(x33), .O(new_n144_));
  nand4  g092(.a(new_n144_), .b(x19), .c(x18), .d(new_n129_), .O(new_n145_));
  inv1   g093(.a(x32), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n54_), .O(new_n147_));
  nand4  g095(.a(x19), .b(new_n57_), .c(new_n129_), .d(x15), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n147_), .c(new_n145_), .O(new_n149_));
  and2   g097(.a(new_n149_), .b(new_n64_), .O(z12));
  inv1   g098(.a(x34), .O(new_n151_));
  nand4  g099(.a(new_n151_), .b(x19), .c(x18), .d(new_n129_), .O(new_n152_));
  nand2  g100(.a(new_n144_), .b(new_n54_), .O(new_n153_));
  nand4  g101(.a(x19), .b(new_n57_), .c(new_n129_), .d(x14), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  and2   g103(.a(new_n155_), .b(new_n64_), .O(z13));
  oai21  g104(.a(new_n54_), .b(x09), .c(new_n151_), .O(new_n157_));
