...
module FAU ( 
  ...
  nand2  g008(.a(x35), .b(x28), .O(new_n61_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n89_), .O(new_n127_));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n89_), .O(new_n134_));
  ...
  oai21  g104(.a(x28), .b(x18), .c(x35), .O(new_n157_));
  ...
  aoi22  g111(.a(new_n117_), .b(new_n57_), .c(new_n116_), .d(x19), .O(new_n164_));
  oai21  g112(.a(x18), .b(x12), .c(new_n89_), .O(new_n165_));
  oai22  g113(.a(new_n165_), .b(new_n164_), .c(x35), .d(x19), .O(z15));
endmodule
