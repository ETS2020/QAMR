...
module FAU ( 
  ...
  inv1   g008(.a(x26), .O(new_n61_));
  nor2   g009(.a(new_n61_), .b(x24), .O(new_n62_));
  ...
  aoi21  g049(.a(x24), .b(x19), .c(new_n61_), .O(new_n102_));
  ...
  nand4  g058(.a(new_n110_), .b(new_n108_), .c(x19), .d(new_n67_), .O(new_n111_));
  aoi21  g059(.a(new_n111_), .b(new_n107_), .c(new_n62_), .O(z07));
  ...
  nand4  g065(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n67_), .O(new_n118_));
  aoi21  g066(.a(new_n118_), .b(new_n114_), .c(new_n62_), .O(z08));
  ...
  nor2   g072(.a(new_n124_), .b(new_n62_), .O(new_n125_));
  ...
  nor2   g079(.a(new_n131_), .b(new_n62_), .O(new_n132_));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n67_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n67_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n67_), .O(new_n153_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n67_), .O(new_n160_));
