...
module FAU ( 
  ...
  aoi21  g40(.a(new_n92_), .b(new_n90_), .c(x12), .O(new_n93_));
  ...
  aoi21  g47(.a(new_n99_), .b(new_n97_), .c(x12), .O(new_n100_));
  ...
  oai22  g73(.a(new_n125_), .b(new_n64_), .c(x31), .d(x19), .O(z11));
  nand2  g74(.a(x33), .b(x18), .O(new_n127_));
  inv1   g75(.a(x15), .O(new_n128_));
  aoi21  g76(.a(new_n56_), .b(new_n128_), .c(x17), .O(new_n129_));
  aoi21  g77(.a(new_n129_), .b(new_n127_), .c(x12), .O(new_n130_));
  inv1   g78(.a(x32), .O(new_n131_));
  nand2  g79(.a(new_n131_), .b(new_n53_), .O(new_n132_));
  oai21  g80(.a(new_n130_), .b(new_n53_), .c(new_n132_), .O(z12));
  nand2  g81(.a(x34), .b(x18), .O(new_n134_));
  oai21  g82(.a(x18), .b(x14), .c(new_n134_), .O(new_n135_));
  oai22  g83(.a(new_n135_), .b(new_n64_), .c(x33), .d(x19), .O(z13));
  nand2  g84(.a(x35), .b(x18), .O(new_n137_));
  inv1   g85(.a(x13), .O(new_n138_));
  aoi21  g86(.a(new_n56_), .b(new_n138_), .c(x17), .O(new_n139_));
  aoi21  g87(.a(new_n139_), .b(new_n137_), .c(x12), .O(new_n140_));
  inv1   g88(.a(x34), .O(new_n141_));
  nand2  g89(.a(new_n141_), .b(new_n53_), .O(new_n142_));
  oai21  g90(.a(new_n140_), .b(new_n53_), .c(new_n142_), .O(z14));
  nand3  g91(.a(new_n111_), .b(x18), .c(new_n63_), .O(new_n144_));
  nand2  g92(.a(new_n144_), .b(new_n62_), .O(new_n145_));
  nand2  g93(.a(new_n145_), .b(x19), .O(new_n146_));
  oai21  g94(.a(x35), .b(x19), .c(new_n146_), .O(z15));
endmodule
