...
module FAU ( 
  ...
  aoi21  g039(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n92_));
  ...
  oai21  g077(.a(x24), .b(new_n55_), .c(new_n129_), .O(new_n130_));
  nand2  g078(.a(x31), .b(x18), .O(new_n131_));
  inv1   g079(.a(x09), .O(new_n132_));
  nand2  g080(.a(new_n61_), .b(new_n132_), .O(new_n133_));
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n72_), .O(new_n134_));
