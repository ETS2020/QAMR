...
module FAU ( 
  ...
  aoi21  g052(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n105_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n108_), .c(new_n62_), .O(z07));
  ...
  oai21  g091(.a(x26), .b(new_n54_), .c(new_n143_), .O(new_n144_));
