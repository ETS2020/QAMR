...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_,
    ...
    new_n71_, new_n73_, new_n74_, new_n75_, new_n77_, new_n79_, new_n81_,
  ...
  aoi21  g06(.a(new_n55_), .b(x02), .c(x18), .O(new_n59_));
  inv1   g07(.a(x21), .O(new_n60_));
  nand2  g08(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  oai21  g09(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(z01));
  aoi21  g10(.a(new_n55_), .b(x01), .c(x18), .O(new_n63_));
  inv1   g11(.a(x22), .O(new_n64_));
  nand2  g12(.a(new_n64_), .b(new_n58_), .O(new_n65_));
  oai21  g13(.a(new_n63_), .b(new_n58_), .c(new_n65_), .O(z02));
  nand2  g14(.a(new_n55_), .b(x00), .O(new_n67_));
  oai22  g15(.a(new_n67_), .b(new_n54_), .c(x23), .d(x19), .O(z03));
  aoi21  g16(.a(new_n55_), .b(x07), .c(x18), .O(new_n69_));
  inv1   g17(.a(x24), .O(new_n70_));
  nand2  g18(.a(new_n70_), .b(new_n58_), .O(new_n71_));
  oai21  g19(.a(new_n69_), .b(new_n58_), .c(new_n71_), .O(z04));
  aoi21  g20(.a(new_n55_), .b(x06), .c(x18), .O(new_n73_));
  inv1   g21(.a(x25), .O(new_n74_));
  nand2  g22(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  oai21  g23(.a(new_n73_), .b(new_n58_), .c(new_n75_), .O(z05));
  nand2  g24(.a(new_n55_), .b(x05), .O(new_n77_));
  oai22  g25(.a(new_n77_), .b(new_n54_), .c(x26), .d(x19), .O(z06));
  nand2  g26(.a(new_n55_), .b(x04), .O(new_n79_));
  oai22  g27(.a(new_n79_), .b(new_n54_), .c(x27), .d(x19), .O(z07));
  nand2  g28(.a(new_n55_), .b(x11), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n54_), .c(x28), .d(x19), .O(z08));
  nand2  g30(.a(new_n55_), .b(x10), .O(new_n83_));
  oai22  g31(.a(new_n83_), .b(new_n54_), .c(x29), .d(x19), .O(z09));
  nand2  g32(.a(new_n55_), .b(x09), .O(new_n85_));
  oai22  g33(.a(new_n85_), .b(new_n54_), .c(x30), .d(x19), .O(z10));
  aoi21  g34(.a(new_n55_), .b(x08), .c(x18), .O(new_n87_));
  inv1   g35(.a(x31), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n58_), .O(new_n89_));
  oai21  g37(.a(new_n87_), .b(new_n58_), .c(new_n89_), .O(z11));
  aoi21  g38(.a(new_n55_), .b(x15), .c(x18), .O(new_n91_));
  inv1   g39(.a(x32), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(new_n58_), .O(new_n93_));
  oai21  g41(.a(new_n91_), .b(new_n58_), .c(new_n93_), .O(z12));
  nand2  g42(.a(new_n55_), .b(x14), .O(new_n95_));
  oai22  g43(.a(new_n95_), .b(new_n54_), .c(x33), .d(x19), .O(z13));
  nand2  g44(.a(new_n55_), .b(x13), .O(new_n97_));
  oai22  g45(.a(new_n97_), .b(new_n54_), .c(x34), .d(x19), .O(z14));
