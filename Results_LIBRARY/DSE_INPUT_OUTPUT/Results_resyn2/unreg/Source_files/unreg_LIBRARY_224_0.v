...
module FAU ( 
  ...
  nand4  g032(.a(new_n84_), .b(new_n82_), .c(x19), .d(new_n73_), .O(new_n85_));
  ...
  nand4  g053(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n73_), .O(new_n106_));
  ...
  oai21  g078(.a(new_n130_), .b(new_n54_), .c(new_n129_), .O(new_n131_));
  ...
  nand2  g091(.a(new_n130_), .b(new_n54_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n57_), .b(new_n146_), .O(new_n147_));
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n73_), .O(new_n148_));
