...
module FAU ( 
  ...
  inv1   g013(.a(x34), .O(new_n66_));
  oai21  g014(.a(new_n66_), .b(x18), .c(x22), .O(new_n67_));
  inv1   g015(.a(x02), .O(new_n68_));
  nand2  g016(.a(new_n61_), .b(new_n68_), .O(new_n69_));
  nand3  g017(.a(new_n69_), .b(new_n67_), .c(new_n65_), .O(new_n70_));
  nor2   g018(.a(x21), .b(x19), .O(new_n71_));
  oai21  g019(.a(x34), .b(new_n53_), .c(new_n71_), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(new_n70_), .O(z01));
  aoi21  g021(.a(x34), .b(x19), .c(new_n53_), .O(new_n74_));
  ...
  nand3  g036(.a(new_n88_), .b(new_n86_), .c(new_n65_), .O(new_n89_));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n58_), .O(new_n112_));
  aoi21  g060(.a(new_n112_), .b(new_n108_), .c(new_n54_), .O(z07));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n58_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n54_), .O(z09));
  ...
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n65_), .O(new_n138_));
  ...
  oai21  g103(.a(x22), .b(new_n55_), .c(new_n66_), .O(new_n156_));
