...
module FAU ( 
  ...
  nor2   g008(.a(x35), .b(x09), .O(new_n61_));
  ...
  nand4  g045(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g052(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n87_), .O(new_n105_));
  ...
  aoi21  g075(.a(x35), .b(x18), .c(x09), .O(new_n128_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n87_), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n61_), .O(z13));
  nor2   g102(.a(x18), .b(x13), .O(new_n155_));
  ...
  nand2  g109(.a(x19), .b(x09), .O(new_n162_));
