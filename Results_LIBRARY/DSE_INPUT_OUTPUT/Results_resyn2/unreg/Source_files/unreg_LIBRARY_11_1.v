// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:20 2020
...
module FAU ( 
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n89_), .O(new_n107_));
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n89_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n89_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n62_), .O(z13));
  nor2   g104(.a(x35), .b(new_n57_), .O(new_n157_));
  inv1   g105(.a(x13), .O(new_n158_));
  nor2   g106(.a(x18), .b(new_n158_), .O(new_n159_));
  oai21  g107(.a(new_n159_), .b(new_n157_), .c(new_n55_), .O(new_n160_));
  ...
  aoi21  g115(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(new_n167_), .O(z15));
endmodule
