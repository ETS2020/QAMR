...
module FAU ( 
  ...
  nand2  g012(.a(new_n63_), .b(new_n55_), .O(new_n65_));
  nand2  g013(.a(x22), .b(x18), .O(new_n66_));
  oai21  g014(.a(x18), .b(x02), .c(new_n66_), .O(new_n67_));
  nor2   g015(.a(x21), .b(x19), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  oai21  g017(.a(new_n67_), .b(new_n65_), .c(new_n69_), .O(z01));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n71_), .O(z04));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n71_), .O(z07));
  ...
  inv1   g079(.a(x02), .O(new_n132_));
  nand3  g080(.a(new_n62_), .b(new_n54_), .c(new_n132_), .O(new_n133_));
  oai21  g081(.a(new_n131_), .b(new_n65_), .c(new_n133_), .O(z10));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n74_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n71_), .O(z12));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n74_), .O(new_n161_));
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n71_), .O(z14));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n74_), .O(new_n168_));
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n71_), .O(z15));
endmodule
