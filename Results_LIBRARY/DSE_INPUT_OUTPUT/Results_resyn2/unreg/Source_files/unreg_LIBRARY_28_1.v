...
module FAU ( 
  ...
  aoi21  g41(.a(new_n64_), .b(new_n93_), .c(x17), .O(new_n94_));
  aoi21  g42(.a(new_n94_), .b(new_n92_), .c(new_n70_), .O(new_n95_));
  inv1   g43(.a(x27), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n69_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n69_), .c(new_n97_), .O(z07));
  ...
  nand2  g54(.a(new_n106_), .b(new_n69_), .O(new_n107_));
  oai21  g55(.a(new_n105_), .b(new_n69_), .c(new_n107_), .O(z09));
  nand2  g56(.a(x31), .b(x18), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n53_), .O(new_n110_));
  nor2   g58(.a(new_n69_), .b(new_n70_), .O(new_n111_));
  aoi22  g59(.a(new_n111_), .b(new_n110_), .c(x30), .d(new_n69_), .O(z10));
  nand2  g60(.a(x24), .b(x18), .O(new_n113_));
  oai21  g61(.a(x18), .b(x08), .c(new_n113_), .O(new_n114_));
  oai22  g62(.a(new_n114_), .b(new_n54_), .c(x31), .d(x19), .O(z11));
  nand2  g63(.a(x33), .b(x18), .O(new_n116_));
  inv1   g64(.a(x15), .O(new_n117_));
  aoi21  g65(.a(new_n64_), .b(new_n117_), .c(x17), .O(new_n118_));
  aoi21  g66(.a(new_n118_), .b(new_n116_), .c(new_n70_), .O(new_n119_));
  inv1   g67(.a(x32), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(new_n69_), .O(new_n121_));
  oai21  g69(.a(new_n119_), .b(new_n69_), .c(new_n121_), .O(z12));
  nand2  g70(.a(x34), .b(x18), .O(new_n123_));
  inv1   g71(.a(x14), .O(new_n124_));
  aoi21  g72(.a(new_n64_), .b(new_n124_), .c(x17), .O(new_n125_));
  aoi21  g73(.a(new_n125_), .b(new_n123_), .c(new_n70_), .O(new_n126_));
  inv1   g74(.a(x33), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n69_), .O(new_n128_));
  oai21  g76(.a(new_n126_), .b(new_n69_), .c(new_n128_), .O(z13));
  ...
  oai22  g82(.a(new_n134_), .b(new_n54_), .c(x35), .d(x19), .O(z15));
endmodule
