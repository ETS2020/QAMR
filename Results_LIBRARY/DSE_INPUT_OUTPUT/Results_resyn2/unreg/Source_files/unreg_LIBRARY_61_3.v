...
module FAU ( 
  ...
  nand2  g053(.a(new_n62_), .b(new_n53_), .O(new_n106_));
  nand4  g054(.a(new_n106_), .b(new_n105_), .c(x19), .d(new_n59_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n104_), .c(new_n55_), .O(z06));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n59_), .O(new_n121_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n80_), .O(new_n140_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n80_), .O(new_n160_));
