...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x14), .O(new_n54_));
  ...
  aoi21  g091(.a(x19), .b(x14), .c(new_n53_), .O(new_n144_));
  ...
  aoi21  g095(.a(new_n53_), .b(x18), .c(x14), .O(new_n148_));
  nand2  g096(.a(x34), .b(x18), .O(new_n149_));
  nand3  g097(.a(new_n149_), .b(x19), .c(new_n58_), .O(new_n150_));
  inv1   g098(.a(x33), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n55_), .O(new_n152_));
  oai22  g100(.a(new_n152_), .b(new_n54_), .c(new_n150_), .d(new_n148_), .O(z13));
