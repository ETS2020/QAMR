...
module FAU ( 
  ...
  aoi21  g14(.a(new_n66_), .b(new_n63_), .c(x32), .O(new_n67_));
  ...
  aoi21  g59(.a(new_n111_), .b(new_n109_), .c(x32), .O(new_n112_));
  inv1   g60(.a(x30), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n62_), .O(new_n114_));
  oai21  g62(.a(new_n112_), .b(new_n62_), .c(new_n114_), .O(z10));
  nand2  g63(.a(x24), .b(x18), .O(new_n116_));
  oai21  g64(.a(x18), .b(x08), .c(new_n116_), .O(new_n117_));
  oai22  g65(.a(new_n117_), .b(new_n55_), .c(x31), .d(x19), .O(z11));
  inv1   g66(.a(x33), .O(new_n119_));
  inv1   g67(.a(x15), .O(new_n120_));
  aoi21  g68(.a(new_n65_), .b(new_n120_), .c(x17), .O(new_n121_));
  oai21  g69(.a(new_n119_), .b(new_n65_), .c(new_n121_), .O(new_n122_));
  ...
  nand2  g75(.a(new_n119_), .b(new_n62_), .O(new_n128_));
  oai21  g76(.a(new_n127_), .b(new_n62_), .c(new_n128_), .O(z13));
  nand2  g77(.a(x35), .b(x18), .O(new_n130_));
  inv1   g78(.a(x13), .O(new_n131_));
  aoi21  g79(.a(new_n65_), .b(new_n131_), .c(x17), .O(new_n132_));
  aoi21  g80(.a(new_n132_), .b(new_n130_), .c(x32), .O(new_n133_));
  inv1   g81(.a(x34), .O(new_n134_));
  nand2  g82(.a(new_n134_), .b(new_n62_), .O(new_n135_));
  oai21  g83(.a(new_n133_), .b(new_n62_), .c(new_n135_), .O(z14));
  nand2  g84(.a(x28), .b(x18), .O(new_n137_));
  oai21  g85(.a(x18), .b(x12), .c(new_n137_), .O(new_n138_));
  oai22  g86(.a(new_n138_), .b(new_n55_), .c(x35), .d(x19), .O(z15));
endmodule
