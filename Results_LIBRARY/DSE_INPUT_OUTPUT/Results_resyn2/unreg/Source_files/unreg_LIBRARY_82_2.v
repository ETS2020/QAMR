...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x11), .O(new_n63_));
  ...
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n79_), .O(z05));
  ...
  aoi21  g055(.a(new_n107_), .b(new_n103_), .c(new_n79_), .O(z06));
  ...
  nand3  g064(.a(x19), .b(new_n57_), .c(new_n116_), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(x34), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(x11), .O(new_n119_));
  nor2   g067(.a(x28), .b(x19), .O(new_n120_));
  nor2   g068(.a(x29), .b(new_n57_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n55_), .c(new_n120_), .O(new_n122_));
  ...
  aoi21  g084(.a(new_n136_), .b(new_n132_), .c(new_n79_), .O(z10));
  ...
  nand2  g106(.a(new_n63_), .b(new_n55_), .O(new_n159_));
  nand2  g107(.a(x35), .b(x18), .O(new_n160_));
  oai21  g108(.a(x18), .b(x13), .c(new_n160_), .O(new_n161_));
  inv1   g109(.a(x11), .O(new_n162_));
  nand3  g110(.a(new_n62_), .b(new_n54_), .c(new_n162_), .O(new_n163_));
  oai21  g111(.a(new_n161_), .b(new_n159_), .c(new_n163_), .O(z14));
  ...
  oai21  g116(.a(new_n166_), .b(new_n159_), .c(new_n168_), .O(z15));
endmodule
