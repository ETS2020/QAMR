...
module FAU ( 
  ...
  oai21  g049(.a(new_n101_), .b(new_n100_), .c(x28), .O(new_n102_));
  ...
  oai21  g056(.a(new_n108_), .b(new_n107_), .c(x28), .O(new_n109_));
  ...
  nand2  g062(.a(new_n80_), .b(new_n114_), .O(new_n115_));
  nand2  g063(.a(x29), .b(x18), .O(new_n116_));
  nand3  g064(.a(new_n116_), .b(new_n115_), .c(x19), .O(new_n117_));
  aoi22  g065(.a(new_n117_), .b(x28), .c(x19), .d(x17), .O(z08));
  and2   g066(.a(x30), .b(x18), .O(new_n119_));
  oai21  g067(.a(x18), .b(x10), .c(x19), .O(new_n120_));
  oai21  g068(.a(new_n120_), .b(new_n119_), .c(x28), .O(new_n121_));
  ...
  oai21  g075(.a(new_n127_), .b(new_n126_), .c(x28), .O(new_n128_));
  ...
  oai21  g082(.a(new_n134_), .b(new_n133_), .c(x28), .O(new_n135_));
  ...
  oai21  g089(.a(new_n141_), .b(new_n140_), .c(x28), .O(new_n142_));
  ...
  oai21  g098(.a(new_n148_), .b(new_n62_), .c(new_n150_), .O(z13));
  ...
  oai21  g103(.a(new_n153_), .b(new_n62_), .c(new_n155_), .O(z14));
  nand3  g104(.a(x19), .b(new_n80_), .c(x12), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(x28), .O(new_n158_));
