...
module FAU ( 
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n74_), .O(new_n126_));
  inv1   g074(.a(x29), .O(new_n127_));
  oai22  g075(.a(new_n61_), .b(x30), .c(new_n127_), .d(x19), .O(new_n128_));
  aoi21  g076(.a(new_n126_), .b(x19), .c(new_n128_), .O(z09));
  aoi21  g077(.a(x31), .b(x18), .c(x17), .O(new_n130_));
  oai21  g078(.a(x18), .b(x09), .c(new_n130_), .O(new_n131_));
  nor2   g079(.a(x33), .b(x30), .O(new_n132_));
  ...
  aoi21  g096(.a(x30), .b(x19), .c(new_n61_), .O(new_n149_));
  nand2  g097(.a(x34), .b(x18), .O(new_n150_));
  inv1   g098(.a(x14), .O(new_n151_));
  nand2  g099(.a(new_n57_), .b(new_n151_), .O(new_n152_));
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n74_), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(x19), .c(new_n149_), .O(z13));
