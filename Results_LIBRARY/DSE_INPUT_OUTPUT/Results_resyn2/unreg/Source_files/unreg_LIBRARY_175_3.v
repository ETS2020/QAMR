...
module FAU ( 
  ...
  aoi21  g078(.a(new_n54_), .b(x19), .c(new_n53_), .O(new_n131_));
  ...
  nand4  g098(.a(new_n150_), .b(new_n148_), .c(x19), .d(new_n59_), .O(new_n151_));
  aoi21  g099(.a(new_n151_), .b(new_n147_), .c(new_n55_), .O(z13));
  nand2  g100(.a(x35), .b(x18), .O(new_n153_));
  inv1   g101(.a(x13), .O(new_n154_));
  nand2  g102(.a(new_n62_), .b(new_n154_), .O(new_n155_));
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n66_), .O(new_n156_));
  nor2   g104(.a(x34), .b(x19), .O(new_n157_));
  nor2   g105(.a(new_n157_), .b(new_n55_), .O(new_n158_));
  ...
  nor2   g112(.a(new_n164_), .b(new_n55_), .O(new_n165_));
