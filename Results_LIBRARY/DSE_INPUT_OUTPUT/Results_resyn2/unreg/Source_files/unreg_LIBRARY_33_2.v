...
module FAU ( 
  ...
  nand2  g019(.a(x35), .b(x19), .O(new_n72_));
  aoi21  g020(.a(x23), .b(x18), .c(x17), .O(new_n73_));
  oai21  g021(.a(x18), .b(x01), .c(new_n73_), .O(new_n74_));
  aoi22  g022(.a(new_n74_), .b(x19), .c(new_n72_), .d(x22), .O(z02));
  inv1   g023(.a(new_n63_), .O(new_n76_));
  ...
  aoi21  g031(.a(new_n83_), .b(new_n78_), .c(new_n76_), .O(z03));
  ...
  aoi21  g038(.a(new_n90_), .b(new_n86_), .c(new_n76_), .O(z04));
  ...
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n63_), .O(z05));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n107_), .c(new_n76_), .O(z07));
  ...
  aoi21  g066(.a(new_n118_), .b(new_n114_), .c(new_n76_), .O(z08));
  ...
  aoi21  g073(.a(new_n125_), .b(new_n121_), .c(new_n76_), .O(z09));
  ...
  nor2   g103(.a(x35), .b(x22), .O(new_n156_));
  inv1   g104(.a(x13), .O(new_n157_));
  nor2   g105(.a(x18), .b(new_n157_), .O(new_n158_));
  aoi22  g106(.a(new_n158_), .b(new_n63_), .c(new_n156_), .d(x18), .O(new_n159_));
  nor2   g107(.a(x34), .b(x19), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n63_), .O(new_n161_));
  oai21  g109(.a(new_n159_), .b(new_n155_), .c(new_n161_), .O(z14));
  nand2  g110(.a(new_n156_), .b(new_n54_), .O(new_n163_));
  nand2  g111(.a(new_n63_), .b(new_n55_), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  oai21  g113(.a(x18), .b(x12), .c(new_n165_), .O(new_n166_));
  oai21  g114(.a(new_n166_), .b(new_n164_), .c(new_n163_), .O(z15));
endmodule
