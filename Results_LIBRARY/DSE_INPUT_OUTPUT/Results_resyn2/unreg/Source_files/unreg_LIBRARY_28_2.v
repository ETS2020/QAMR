...
module FAU ( 
  ...
  nor2   g001(.a(x19), .b(x09), .O(new_n54_));
  ...
  nand2  g018(.a(new_n54_), .b(new_n70_), .O(new_n71_));
  ...
  nand2  g025(.a(new_n54_), .b(new_n77_), .O(new_n78_));
  ...
  inv1   g032(.a(x19), .O(new_n85_));
  inv1   g033(.a(x24), .O(new_n86_));
  oai21  g034(.a(new_n86_), .b(x09), .c(new_n85_), .O(new_n87_));
  ...
  oai21  g041(.a(new_n93_), .b(x09), .c(new_n85_), .O(new_n94_));
  ...
  oai21  g048(.a(new_n100_), .b(x09), .c(new_n85_), .O(new_n101_));
  ...
  oai21  g055(.a(new_n107_), .b(x09), .c(new_n85_), .O(new_n108_));
  ...
  oai21  g069(.a(new_n121_), .b(x09), .c(new_n85_), .O(new_n122_));
  ...
  aoi21  g076(.a(new_n128_), .b(new_n56_), .c(new_n85_), .O(new_n129_));
  nand2  g077(.a(x19), .b(x18), .O(new_n130_));
  inv1   g078(.a(x30), .O(new_n131_));
  aoi21  g079(.a(new_n131_), .b(new_n85_), .c(x09), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(new_n130_), .c(new_n129_), .O(z10));
  inv1   g081(.a(x31), .O(new_n134_));
  nand2  g082(.a(new_n54_), .b(new_n134_), .O(new_n135_));
  ...
  oai21  g089(.a(new_n141_), .b(x09), .c(new_n85_), .O(new_n142_));
  ...
  oai21  g096(.a(new_n148_), .b(x09), .c(new_n85_), .O(new_n149_));
