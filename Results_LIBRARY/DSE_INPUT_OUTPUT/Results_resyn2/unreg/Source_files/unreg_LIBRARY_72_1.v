...
module FAU ( 
  ...
  oai21  g050(.a(x32), .b(new_n55_), .c(new_n102_), .O(new_n103_));
  nand2  g051(.a(x27), .b(x18), .O(new_n104_));
  inv1   g052(.a(x05), .O(new_n105_));
  nand2  g053(.a(new_n61_), .b(new_n105_), .O(new_n106_));
  nand3  g054(.a(new_n106_), .b(new_n104_), .c(new_n72_), .O(new_n107_));
  ...
  aoi21  g091(.a(x26), .b(x19), .c(new_n53_), .O(new_n144_));
