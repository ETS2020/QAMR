...
module FAU ( 
  ...
  nor2   g008(.a(x27), .b(x23), .O(new_n61_));
  ...
  inv1   g026(.a(x27), .O(new_n79_));
  oai21  g027(.a(new_n79_), .b(new_n54_), .c(new_n78_), .O(new_n80_));
  nor2   g028(.a(new_n57_), .b(x16), .O(new_n81_));
  inv1   g029(.a(x00), .O(new_n82_));
  nand2  g030(.a(new_n57_), .b(new_n82_), .O(new_n83_));
  nand2  g031(.a(new_n83_), .b(new_n55_), .O(new_n84_));
  ...
  aoi21  g040(.a(new_n92_), .b(new_n87_), .c(new_n61_), .O(z04));
  ...
  oai22  g053(.a(x27), .b(x23), .c(new_n105_), .d(x19), .O(new_n106_));
  aoi21  g054(.a(new_n104_), .b(x19), .c(new_n106_), .O(z06));
  oai21  g055(.a(new_n78_), .b(new_n54_), .c(new_n79_), .O(new_n108_));
  ...
  nand4  g066(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n88_), .O(new_n119_));
