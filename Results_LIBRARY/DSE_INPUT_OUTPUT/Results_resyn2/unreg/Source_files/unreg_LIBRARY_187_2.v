...
module FAU ( 
  ...
  nand2  g071(.a(new_n63_), .b(new_n55_), .O(new_n124_));
  ...
  nand3  g094(.a(new_n62_), .b(new_n54_), .c(new_n146_), .O(new_n147_));
  oai21  g095(.a(new_n145_), .b(new_n124_), .c(new_n147_), .O(z12));
  ...
  oai21  g100(.a(new_n150_), .b(new_n124_), .c(new_n152_), .O(z13));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n68_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n155_), .c(new_n65_), .O(z14));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n63_), .O(z15));
endmodule
