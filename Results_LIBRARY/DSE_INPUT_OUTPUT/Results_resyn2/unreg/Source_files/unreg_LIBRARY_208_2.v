...
module FAU ( 
  ...
  nand3  g11(.a(x33), .b(x19), .c(new_n63_), .O(new_n64_));
  ...
  nand2  g66(.a(new_n57_), .b(x15), .O(new_n119_));
  ...
  oai22  g70(.a(new_n122_), .b(new_n64_), .c(x33), .d(x19), .O(z13));
  nand2  g71(.a(x35), .b(x18), .O(new_n124_));
  inv1   g72(.a(x13), .O(new_n125_));
  aoi21  g73(.a(new_n57_), .b(new_n125_), .c(x17), .O(new_n126_));
  aoi21  g74(.a(new_n126_), .b(new_n124_), .c(new_n54_), .O(new_n127_));
  inv1   g75(.a(x34), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n53_), .O(new_n129_));
  oai21  g77(.a(new_n127_), .b(new_n53_), .c(new_n129_), .O(z14));
  nand2  g78(.a(x28), .b(x18), .O(new_n131_));
  inv1   g79(.a(x12), .O(new_n132_));
  aoi21  g80(.a(new_n57_), .b(new_n132_), .c(x17), .O(new_n133_));
  aoi21  g81(.a(new_n133_), .b(new_n131_), .c(new_n54_), .O(new_n134_));
  inv1   g82(.a(x35), .O(new_n135_));
  nand2  g83(.a(new_n135_), .b(new_n53_), .O(new_n136_));
  oai21  g84(.a(new_n134_), .b(new_n53_), .c(new_n136_), .O(z15));
endmodule
