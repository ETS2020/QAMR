// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:55 2020
...
module FAU ( 
  ...
  nor2   g040(.a(new_n92_), .b(new_n63_), .O(new_n93_));
  ...
  aoi21  g091(.a(x19), .b(new_n61_), .c(new_n62_), .O(new_n144_));
  ...
  nand3  g096(.a(x19), .b(new_n57_), .c(new_n148_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n62_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(x14), .O(new_n151_));
  nor2   g099(.a(x33), .b(x19), .O(new_n152_));
  nor2   g100(.a(x34), .b(new_n57_), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n55_), .c(new_n152_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n151_), .O(z13));
  ...
  nor2   g108(.a(new_n160_), .b(new_n63_), .O(new_n161_));
