...
module FAU ( 
  ...
  nor2   g036(.a(x28), .b(x24), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n56_), .O(new_n90_));
  nand2  g038(.a(new_n66_), .b(new_n54_), .O(new_n91_));
  nand2  g039(.a(x25), .b(x18), .O(new_n92_));
  oai21  g040(.a(x18), .b(x07), .c(new_n92_), .O(new_n93_));
  oai21  g041(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(z04));
  ...
  aoi21  g062(.a(x24), .b(x19), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g076(.a(new_n128_), .b(new_n126_), .c(new_n66_), .O(new_n129_));
  inv1   g077(.a(x30), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n56_), .O(new_n131_));
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n54_), .O(z10));
  aoi21  g080(.a(x24), .b(new_n62_), .c(new_n89_), .O(new_n133_));
  inv1   g081(.a(x08), .O(new_n134_));
  nand2  g082(.a(new_n62_), .b(new_n134_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n66_), .O(new_n136_));
  nor2   g084(.a(x31), .b(x19), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n54_), .O(new_n138_));
  oai21  g086(.a(new_n136_), .b(new_n133_), .c(new_n138_), .O(z11));
  ...
  nand4  g092(.a(new_n144_), .b(new_n142_), .c(x19), .d(new_n59_), .O(new_n145_));
  aoi21  g093(.a(new_n145_), .b(new_n141_), .c(new_n55_), .O(z12));
