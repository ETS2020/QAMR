...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x07), .O(new_n54_));
  ...
  nand3  g036(.a(x19), .b(new_n62_), .c(new_n88_), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(x32), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(x07), .O(new_n91_));
  nor2   g039(.a(x24), .b(x19), .O(new_n92_));
  nor2   g040(.a(x25), .b(new_n62_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n60_), .c(new_n92_), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n91_), .O(z04));
  ...
  nand3  g048(.a(new_n100_), .b(new_n98_), .c(new_n60_), .O(new_n101_));
  ...
  nand3  g055(.a(new_n107_), .b(new_n105_), .c(new_n60_), .O(new_n108_));
  ...
  nand3  g067(.a(new_n119_), .b(new_n117_), .c(new_n60_), .O(new_n120_));
  ...
  nand2  g092(.a(new_n60_), .b(new_n54_), .O(new_n145_));
  nand2  g093(.a(x33), .b(x18), .O(new_n146_));
  oai21  g094(.a(x18), .b(x15), .c(new_n146_), .O(new_n147_));
  inv1   g095(.a(x07), .O(new_n148_));
  nand3  g096(.a(new_n53_), .b(new_n56_), .c(new_n148_), .O(new_n149_));
  ...
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n54_), .O(z14));
  inv1   g110(.a(x35), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n56_), .O(new_n164_));
  ...
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n55_), .O(z15));
endmodule
