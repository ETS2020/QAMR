...
module FAU ( 
  ...
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n54_), .O(z08));
  ...
  nand3  g077(.a(new_n129_), .b(new_n127_), .c(new_n54_), .O(z09));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n54_), .O(z10));
  ...
  nand3  g092(.a(new_n53_), .b(new_n121_), .c(new_n56_), .O(new_n145_));
  nand2  g093(.a(new_n73_), .b(new_n54_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n73_), .O(new_n153_));
  ...
  oai21  g111(.a(new_n53_), .b(x18), .c(x28), .O(new_n164_));
  inv1   g112(.a(x12), .O(new_n165_));
  nand2  g113(.a(new_n62_), .b(new_n165_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n73_), .O(new_n167_));
  nor2   g115(.a(x35), .b(x19), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(new_n54_), .O(new_n169_));
