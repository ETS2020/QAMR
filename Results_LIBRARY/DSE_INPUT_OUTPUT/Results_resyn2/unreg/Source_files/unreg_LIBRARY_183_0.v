...
module FAU ( 
  ...
  aoi21  g061(.a(x32), .b(x18), .c(x11), .O(new_n114_));
  nand2  g062(.a(x29), .b(x18), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(x19), .c(new_n57_), .O(new_n116_));
  inv1   g064(.a(x28), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  oai22  g066(.a(new_n118_), .b(new_n53_), .c(new_n116_), .d(new_n114_), .O(z08));
