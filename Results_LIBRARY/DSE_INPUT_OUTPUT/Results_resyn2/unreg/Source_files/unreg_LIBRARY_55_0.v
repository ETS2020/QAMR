...
module FAU ( 
  ...
  nor2   g008(.a(x28), .b(x24), .O(new_n61_));
  ...
  nand2  g063(.a(new_n88_), .b(new_n87_), .O(new_n116_));
  ...
  nand3  g067(.a(new_n88_), .b(x24), .c(new_n54_), .O(new_n120_));
  ...
  oai21  g082(.a(x18), .b(x08), .c(new_n134_), .O(new_n135_));
  nor2   g083(.a(x31), .b(x19), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n116_), .O(new_n137_));
  oai21  g085(.a(new_n135_), .b(new_n117_), .c(new_n137_), .O(z11));
  ...
  nand2  g111(.a(x35), .b(new_n54_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n116_), .O(new_n165_));
  aoi21  g113(.a(new_n163_), .b(x19), .c(new_n165_), .O(z15));
endmodule
