...
module FAU ( 
  ...
  nand3  g01(.a(x32), .b(x19), .c(new_n53_), .O(new_n54_));
  ...
  oai22  g25(.a(new_n77_), .b(new_n54_), .c(x23), .d(x19), .O(z03));
  ...
  oai21  g77(.a(x18), .b(x13), .c(new_n129_), .O(new_n130_));
  oai22  g78(.a(new_n130_), .b(new_n54_), .c(x34), .d(x19), .O(z14));
  nand2  g79(.a(x28), .b(x18), .O(new_n132_));
  oai21  g80(.a(x18), .b(x12), .c(new_n132_), .O(new_n133_));
  oai22  g81(.a(new_n133_), .b(new_n54_), .c(x35), .d(x19), .O(z15));
endmodule
