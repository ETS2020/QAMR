...
module FAU ( 
  ...
  nand2  g064(.a(new_n63_), .b(new_n55_), .O(new_n117_));
  nand2  g065(.a(x29), .b(x18), .O(new_n118_));
  oai21  g066(.a(x18), .b(x11), .c(new_n118_), .O(new_n119_));
  inv1   g067(.a(x32), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n62_), .c(new_n54_), .O(new_n121_));
  oai21  g069(.a(new_n119_), .b(new_n117_), .c(new_n121_), .O(z08));
  nand2  g070(.a(x30), .b(x18), .O(new_n123_));
  oai21  g071(.a(x18), .b(x10), .c(new_n123_), .O(new_n124_));
  nor2   g072(.a(x29), .b(x19), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n63_), .O(new_n126_));
  oai21  g074(.a(new_n124_), .b(new_n117_), .c(new_n126_), .O(z09));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n68_), .O(new_n133_));
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n65_), .O(z10));
  ...
  aoi21  g089(.a(x28), .b(x19), .c(new_n120_), .O(new_n142_));
  ...
  nand4  g098(.a(new_n150_), .b(new_n148_), .c(x19), .d(new_n68_), .O(new_n151_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n63_), .O(z14));
  ...
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n63_), .O(z15));
endmodule
