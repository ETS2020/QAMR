...
module FAU ( 
  ...
  inv1   g041(.a(new_n63_), .O(new_n94_));
  ...
  nand4  g048(.a(new_n100_), .b(new_n98_), .c(x19), .d(new_n97_), .O(new_n101_));
  aoi21  g049(.a(new_n101_), .b(new_n96_), .c(new_n94_), .O(z05));
  ...
  nand4  g055(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n97_), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(new_n104_), .c(new_n94_), .O(z06));
  ...
  nand4  g062(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n97_), .O(new_n115_));
  aoi21  g063(.a(new_n115_), .b(new_n111_), .c(new_n94_), .O(z07));
  ...
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n97_), .O(new_n127_));
  ...
  nand3  g079(.a(new_n131_), .b(new_n62_), .c(new_n54_), .O(new_n132_));
  nand2  g080(.a(new_n63_), .b(new_n55_), .O(new_n133_));
  ...
  nand2  g089(.a(new_n131_), .b(new_n54_), .O(new_n142_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n142_), .c(new_n63_), .O(z12));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n97_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n94_), .O(z14));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n97_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n94_), .O(z15));
endmodule
