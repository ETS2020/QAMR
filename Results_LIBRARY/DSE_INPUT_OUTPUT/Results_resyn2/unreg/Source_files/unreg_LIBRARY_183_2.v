...
module FAU ( 
  ...
  nand2  g068(.a(x28), .b(new_n56_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n54_), .O(new_n122_));
  aoi21  g070(.a(new_n120_), .b(x19), .c(new_n122_), .O(z08));
  ...
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n54_), .O(z11));
  nand2  g091(.a(x33), .b(x18), .O(new_n144_));
  oai21  g092(.a(x18), .b(x15), .c(new_n144_), .O(new_n145_));
  nand3  g093(.a(new_n53_), .b(new_n56_), .c(new_n118_), .O(new_n146_));
  oai21  g094(.a(new_n145_), .b(new_n124_), .c(new_n146_), .O(z12));
