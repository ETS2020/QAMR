...
module FAU ( 
  ...
  nand2  g008(.a(x34), .b(x26), .O(new_n61_));
  ...
  aoi21  g024(.a(new_n76_), .b(new_n54_), .c(new_n62_), .O(new_n77_));
  ...
  aoi21  g032(.a(new_n84_), .b(new_n54_), .c(new_n62_), .O(new_n85_));
  ...
  aoi21  g039(.a(new_n91_), .b(new_n54_), .c(new_n62_), .O(new_n92_));
  nand2  g040(.a(new_n92_), .b(new_n90_), .O(z04));
  oai21  g041(.a(x34), .b(x18), .c(x26), .O(new_n94_));
  ...
  nand3  g046(.a(new_n61_), .b(new_n98_), .c(new_n54_), .O(new_n99_));
  ...
  aoi21  g053(.a(new_n105_), .b(new_n54_), .c(new_n62_), .O(new_n106_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n110_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n109_), .c(new_n62_), .O(z07));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n110_), .O(new_n121_));
  ...
  aoi21  g075(.a(new_n127_), .b(new_n54_), .c(new_n62_), .O(new_n128_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n110_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n62_), .O(z12));
  oai21  g098(.a(x26), .b(x18), .c(x34), .O(new_n151_));
  ...
  nand3  g103(.a(new_n61_), .b(new_n155_), .c(new_n54_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n154_), .O(z13));
  inv1   g105(.a(x34), .O(new_n158_));
  aoi21  g106(.a(new_n105_), .b(x19), .c(new_n158_), .O(new_n159_));
  ...
  aoi21  g115(.a(new_n167_), .b(new_n54_), .c(new_n62_), .O(new_n168_));
