...
module FAU ( 
  ...
  oai21  g049(.a(x34), .b(new_n54_), .c(new_n62_), .O(new_n102_));
  ...
  inv1   g055(.a(new_n63_), .O(new_n108_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n94_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(z07));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n94_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n108_), .O(z08));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n94_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n108_), .O(z12));
  ...
  aoi21  g106(.a(x26), .b(x19), .c(new_n158_), .O(new_n159_));
