...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n164_;
  nor2   g000(.a(x34), .b(x32), .O(new_n53_));
  ...
  nand4  g066(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n57_), .O(new_n119_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n57_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n53_), .O(z09));
  nand2  g075(.a(x31), .b(x18), .O(new_n128_));
  inv1   g076(.a(x09), .O(new_n129_));
  nand2  g077(.a(new_n60_), .b(new_n129_), .O(new_n130_));
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n71_), .O(new_n131_));
  ...
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n71_), .O(new_n138_));
  ...
  nand2  g092(.a(new_n71_), .b(new_n144_), .O(new_n145_));
  nand2  g093(.a(x33), .b(x18), .O(new_n146_));
  oai21  g094(.a(x18), .b(x15), .c(new_n146_), .O(new_n147_));
  nand3  g095(.a(x34), .b(new_n142_), .c(new_n54_), .O(new_n148_));
  oai21  g096(.a(new_n147_), .b(new_n145_), .c(new_n148_), .O(z12));
  ...
  nand3  g106(.a(new_n143_), .b(x32), .c(new_n54_), .O(new_n159_));
  oai21  g107(.a(new_n158_), .b(new_n145_), .c(new_n159_), .O(z14));
  nand2  g108(.a(x28), .b(x18), .O(new_n161_));
  oai21  g109(.a(x18), .b(x12), .c(new_n161_), .O(new_n162_));
  nor2   g110(.a(x35), .b(x19), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n144_), .O(new_n164_));
  oai21  g112(.a(new_n162_), .b(new_n145_), .c(new_n164_), .O(z15));
endmodule
