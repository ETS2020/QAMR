...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x30), .O(new_n63_));
  ...
  inv1   g026(.a(new_n63_), .O(new_n79_));
  ...
  nand4  g062(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n82_), .O(new_n115_));
  aoi21  g063(.a(new_n115_), .b(new_n111_), .c(new_n79_), .O(z07));
  ...
  oai21  g071(.a(new_n62_), .b(x18), .c(x30), .O(new_n124_));
  ...
  nand2  g076(.a(new_n128_), .b(new_n63_), .O(new_n129_));
  ...
  inv1   g096(.a(x32), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n54_), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n63_), .O(z12));
  ...
  nand3  g106(.a(new_n62_), .b(new_n135_), .c(new_n54_), .O(new_n159_));
