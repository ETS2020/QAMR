...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x27), .O(new_n54_));
  ...
  oai22  g054(.a(new_n53_), .b(x27), .c(new_n106_), .d(x19), .O(new_n107_));
  aoi21  g055(.a(new_n105_), .b(x19), .c(new_n107_), .O(z06));
  inv1   g056(.a(x27), .O(new_n109_));
  oai21  g057(.a(x32), .b(new_n55_), .c(new_n109_), .O(new_n110_));
  nand2  g058(.a(x20), .b(x18), .O(new_n111_));
  inv1   g059(.a(x04), .O(new_n112_));
  nand2  g060(.a(new_n61_), .b(new_n112_), .O(new_n113_));
  nand3  g061(.a(new_n113_), .b(new_n111_), .c(new_n72_), .O(new_n114_));
  ...
  aoi21  g091(.a(x27), .b(x19), .c(new_n53_), .O(new_n144_));
