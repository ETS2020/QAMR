...
module FAU ( 
  ...
  aoi21  g041(.a(new_n93_), .b(new_n88_), .c(new_n69_), .O(z04));
  ...
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n69_), .O(z05));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n69_), .O(z07));
  ...
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n69_), .O(z09));
  ...
  nor2   g089(.a(new_n141_), .b(new_n69_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n140_), .O(z11));
  aoi21  g091(.a(x20), .b(x19), .c(new_n68_), .O(new_n144_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n57_), .O(new_n151_));
  nor2   g099(.a(x33), .b(x19), .O(new_n152_));
  nor2   g100(.a(new_n152_), .b(new_n69_), .O(new_n153_));
  ...
  nor2   g107(.a(new_n159_), .b(new_n69_), .O(new_n160_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n57_), .O(new_n165_));
