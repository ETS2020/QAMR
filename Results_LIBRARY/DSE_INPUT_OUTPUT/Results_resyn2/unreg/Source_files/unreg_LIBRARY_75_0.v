...
module FAU ( 
  ...
  nor2   g008(.a(x28), .b(x11), .O(new_n61_));
  ...
  oai21  g062(.a(new_n54_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g063(.a(x29), .b(x18), .O(new_n116_));
  nand2  g064(.a(new_n57_), .b(new_n113_), .O(new_n117_));
  nand3  g065(.a(new_n117_), .b(new_n116_), .c(new_n55_), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n115_), .O(z08));
  ...
  nand2  g102(.a(new_n114_), .b(new_n113_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n156_), .O(new_n167_));
  oai21  g115(.a(new_n157_), .b(x19), .c(new_n155_), .O(new_n168_));
  aoi21  g116(.a(new_n167_), .b(x19), .c(new_n168_), .O(z15));
endmodule
