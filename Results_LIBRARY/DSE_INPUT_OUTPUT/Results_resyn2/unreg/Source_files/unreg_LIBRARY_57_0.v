// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:43 2020
...
module FAU ( 
  ...
  nand3  g037(.a(new_n89_), .b(new_n87_), .c(new_n64_), .O(new_n90_));
  ...
  nand2  g091(.a(x34), .b(x19), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g093(.a(x33), .b(x18), .O(new_n146_));
  inv1   g094(.a(x15), .O(new_n147_));
  nand2  g095(.a(new_n60_), .b(new_n147_), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n146_), .c(new_n64_), .O(new_n149_));
  ...
  nand2  g110(.a(new_n162_), .b(x32), .O(new_n163_));
  aoi22  g111(.a(new_n163_), .b(new_n144_), .c(new_n161_), .d(x19), .O(z14));
