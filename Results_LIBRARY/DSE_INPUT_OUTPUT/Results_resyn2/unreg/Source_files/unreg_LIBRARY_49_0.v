...
module FAU ( 
  ...
  nor2   g011(.a(x28), .b(x20), .O(new_n64_));
  ...
  nor2   g046(.a(new_n98_), .b(new_n64_), .O(new_n99_));
  ...
  nor2   g053(.a(new_n105_), .b(new_n64_), .O(new_n106_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n64_), .O(z07));
  oai21  g062(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(new_n115_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n67_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n64_), .O(z09));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n67_), .O(new_n133_));
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n64_), .O(z10));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n67_), .O(new_n140_));
  ...
  nand3  g092(.a(new_n144_), .b(new_n142_), .c(new_n58_), .O(new_n145_));
  nor2   g093(.a(x32), .b(x19), .O(new_n146_));
  nor2   g094(.a(new_n146_), .b(new_n64_), .O(new_n147_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n58_), .O(new_n152_));
  nor2   g100(.a(x33), .b(x19), .O(new_n153_));
  nor2   g101(.a(new_n153_), .b(new_n64_), .O(new_n154_));
