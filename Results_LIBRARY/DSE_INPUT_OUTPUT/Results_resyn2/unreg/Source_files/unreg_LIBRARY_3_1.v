...
module FAU ( 
  ...
  aoi21  g21(.a(new_n73_), .b(new_n59_), .c(new_n66_), .O(new_n74_));
  nand2  g22(.a(new_n70_), .b(new_n55_), .O(new_n75_));
  oai21  g23(.a(new_n74_), .b(new_n55_), .c(new_n75_), .O(z05));
  oai21  g24(.a(x27), .b(x17), .c(x18), .O(new_n77_));
  nand2  g25(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g26(.a(new_n73_), .b(new_n55_), .O(new_n79_));
  ...
  aoi21  g38(.a(new_n90_), .b(new_n59_), .c(new_n66_), .O(new_n91_));
  nand2  g39(.a(new_n86_), .b(new_n55_), .O(new_n92_));
  oai21  g40(.a(new_n91_), .b(new_n55_), .c(new_n92_), .O(z10));
  oai21  g41(.a(x24), .b(x17), .c(x18), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(x19), .O(new_n95_));
  nand2  g43(.a(new_n90_), .b(new_n55_), .O(new_n96_));
