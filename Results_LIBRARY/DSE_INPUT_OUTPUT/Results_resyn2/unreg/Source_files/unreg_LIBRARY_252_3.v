...
module FAU ( 
  ...
  nand4  g25(.a(x19), .b(new_n63_), .c(new_n54_), .d(x05), .O(new_n78_));
  ...
  nand4  g31(.a(x19), .b(new_n63_), .c(new_n54_), .d(x11), .O(new_n84_));
  ...
  aoi21  g47(.a(new_n54_), .b(x14), .c(x18), .O(new_n100_));
  inv1   g48(.a(x33), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  oai21  g50(.a(new_n100_), .b(new_n53_), .c(new_n102_), .O(z13));
  aoi21  g51(.a(new_n54_), .b(x13), .c(x18), .O(new_n104_));
  inv1   g52(.a(x34), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  oai21  g54(.a(new_n104_), .b(new_n53_), .c(new_n106_), .O(z14));
  aoi21  g55(.a(new_n54_), .b(x12), .c(x18), .O(new_n108_));
  inv1   g56(.a(x35), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n53_), .O(new_n110_));
  oai21  g58(.a(new_n108_), .b(new_n53_), .c(new_n110_), .O(z15));
endmodule
