// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:17 2020
...
module FAU ( 
  ...
  nand2  g54(.a(new_n106_), .b(new_n55_), .O(new_n107_));
  ...
  nand4  g73(.a(new_n91_), .b(x19), .c(x18), .d(new_n61_), .O(new_n126_));
