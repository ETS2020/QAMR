...
module FAU ( 
  ...
  nor2   g097(.a(new_n149_), .b(new_n63_), .O(new_n150_));
  ...
  nor2   g103(.a(x33), .b(x19), .O(new_n156_));
  nor2   g104(.a(new_n156_), .b(new_n63_), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n155_), .O(z13));
  aoi22  g106(.a(new_n62_), .b(x19), .c(new_n61_), .d(new_n57_), .O(new_n159_));
  oai21  g107(.a(x18), .b(x13), .c(new_n68_), .O(new_n160_));
  oai22  g108(.a(new_n160_), .b(new_n159_), .c(x34), .d(x19), .O(z14));
  aoi21  g109(.a(new_n61_), .b(x19), .c(new_n62_), .O(new_n162_));
  nand2  g110(.a(x28), .b(x18), .O(new_n163_));
  inv1   g111(.a(x12), .O(new_n164_));
  nand2  g112(.a(new_n57_), .b(new_n164_), .O(new_n165_));
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n68_), .O(new_n166_));
  aoi21  g114(.a(new_n166_), .b(x19), .c(new_n162_), .O(z15));
endmodule
