...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x23), .O(new_n61_));
  ...
  nand3  g019(.a(x32), .b(new_n71_), .c(x18), .O(new_n72_));
  nand2  g020(.a(new_n57_), .b(x01), .O(new_n73_));
  oai21  g021(.a(new_n73_), .b(new_n61_), .c(new_n72_), .O(new_n74_));
  nand2  g022(.a(new_n74_), .b(new_n55_), .O(new_n75_));
  inv1   g023(.a(new_n61_), .O(new_n76_));
  nor2   g024(.a(x22), .b(x19), .O(new_n77_));
  nand2  g025(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g026(.a(new_n78_), .b(new_n75_), .O(z02));
  nand3  g027(.a(x32), .b(new_n71_), .c(new_n54_), .O(new_n80_));
  nand2  g028(.a(new_n76_), .b(new_n55_), .O(new_n81_));
  inv1   g029(.a(x16), .O(new_n82_));
  nand2  g030(.a(x18), .b(new_n82_), .O(new_n83_));
  oai21  g031(.a(x18), .b(x00), .c(new_n83_), .O(new_n84_));
  oai21  g032(.a(new_n84_), .b(new_n81_), .c(new_n80_), .O(z03));
  ...
  nor2   g089(.a(new_n71_), .b(new_n54_), .O(new_n142_));
  ...
  oai21  g094(.a(new_n142_), .b(x32), .c(new_n146_), .O(z12));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n61_), .O(z13));
  ...
  nor2   g107(.a(new_n159_), .b(new_n61_), .O(new_n160_));
