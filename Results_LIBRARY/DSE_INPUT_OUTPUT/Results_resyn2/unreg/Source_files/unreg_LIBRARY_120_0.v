...
module FAU ( 
  ...
  nor2   g000(.a(x35), .b(x08), .O(new_n53_));
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n71_), .O(new_n104_));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n71_), .O(new_n139_));
  ...
  nor2   g095(.a(new_n147_), .b(new_n53_), .O(new_n148_));
  ...
  oai22  g109(.a(x35), .b(x08), .c(new_n161_), .d(x19), .O(new_n162_));
  aoi21  g110(.a(new_n160_), .b(x19), .c(new_n162_), .O(z14));
  inv1   g111(.a(x35), .O(new_n164_));
  oai21  g112(.a(new_n54_), .b(new_n137_), .c(new_n164_), .O(new_n165_));
  nand2  g113(.a(x28), .b(x18), .O(new_n166_));
  inv1   g114(.a(x12), .O(new_n167_));
  nand2  g115(.a(new_n60_), .b(new_n167_), .O(new_n168_));
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n71_), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n165_), .O(z15));
endmodule
