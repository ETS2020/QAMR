...
module FAU ( 
  ...
  nand2  g010(.a(x33), .b(new_n62_), .O(new_n63_));
  ...
  nand4  g040(.a(x19), .b(new_n57_), .c(new_n88_), .d(x07), .O(new_n93_));
  nand3  g041(.a(new_n93_), .b(new_n92_), .c(new_n90_), .O(new_n94_));
  and2   g042(.a(new_n94_), .b(new_n63_), .O(z04));
  nand4  g043(.a(new_n62_), .b(x19), .c(x18), .d(new_n88_), .O(new_n96_));
  nand2  g044(.a(new_n89_), .b(new_n54_), .O(new_n97_));
  nand4  g045(.a(x19), .b(new_n57_), .c(new_n88_), .d(x06), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  and2   g047(.a(new_n99_), .b(new_n63_), .O(z05));
  inv1   g048(.a(x33), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n54_), .O(new_n102_));
  nand2  g050(.a(new_n63_), .b(new_n55_), .O(new_n103_));
  nand2  g051(.a(x27), .b(x18), .O(new_n104_));
  oai21  g052(.a(x18), .b(x05), .c(new_n104_), .O(new_n105_));
  oai22  g053(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(x26), .O(z06));
  ...
  oai21  g058(.a(new_n108_), .b(new_n103_), .c(new_n110_), .O(z07));
  ...
  aoi21  g065(.a(new_n117_), .b(new_n113_), .c(new_n65_), .O(z08));
  ...
  aoi21  g072(.a(new_n124_), .b(new_n120_), .c(new_n65_), .O(z09));
  ...
  aoi21  g079(.a(new_n131_), .b(new_n127_), .c(new_n65_), .O(z10));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n63_), .O(z11));
  oai21  g087(.a(new_n62_), .b(x18), .c(x33), .O(new_n140_));
  ...
  nand2  g092(.a(new_n144_), .b(new_n63_), .O(new_n145_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n102_), .c(new_n63_), .O(z13));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n63_), .O(z14));
  ...
  aoi21  g112(.a(new_n164_), .b(new_n160_), .c(new_n65_), .O(z15));
endmodule
