...
module FAU ( 
  ...
  inv1   g019(.a(new_n64_), .O(new_n72_));
  ...
  nor2   g027(.a(new_n59_), .b(x16), .O(new_n80_));
  ...
  nand3  g067(.a(new_n119_), .b(new_n117_), .c(new_n72_), .O(z08));
  ...
  nand2  g093(.a(new_n63_), .b(new_n53_), .O(new_n146_));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n72_), .O(z15));
endmodule
