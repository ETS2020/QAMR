...
module FAU ( 
  ...
  oai22  g045(.a(x32), .b(x26), .c(new_n97_), .d(x19), .O(new_n98_));
  ...
  nand2  g051(.a(x26), .b(x19), .O(new_n104_));
  inv1   g052(.a(x26), .O(new_n105_));
  nand2  g053(.a(x32), .b(new_n105_), .O(new_n106_));
  aoi22  g054(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(x19), .O(z06));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n92_), .O(new_n127_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n92_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n61_), .O(z11));
  inv1   g090(.a(x32), .O(new_n143_));
  nand2  g091(.a(new_n104_), .b(new_n143_), .O(new_n144_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n92_), .O(new_n169_));
