// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:11 2020
...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x01), .O(new_n53_));
  ...
  aoi21  g019(.a(x32), .b(x18), .c(x01), .O(new_n72_));
  nand2  g020(.a(x23), .b(x18), .O(new_n73_));
  nand3  g021(.a(new_n73_), .b(x19), .c(new_n57_), .O(new_n74_));
  inv1   g022(.a(x22), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n54_), .O(new_n76_));
  oai22  g024(.a(new_n76_), .b(new_n53_), .c(new_n74_), .d(new_n72_), .O(z02));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n57_), .O(new_n112_));
  aoi21  g060(.a(new_n112_), .b(new_n108_), .c(new_n53_), .O(z07));
  nand2  g061(.a(x29), .b(x18), .O(new_n114_));
  inv1   g062(.a(x11), .O(new_n115_));
  nand2  g063(.a(new_n60_), .b(new_n115_), .O(new_n116_));
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n64_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n64_), .O(new_n124_));
  ...
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n64_), .O(new_n131_));
  ...
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n53_), .O(z11));
  inv1   g089(.a(x32), .O(new_n142_));
  nand2  g090(.a(x19), .b(x01), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n60_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n64_), .O(new_n148_));
