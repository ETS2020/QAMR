...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x31), .O(new_n61_));
  ...
  oai21  g077(.a(x32), .b(x18), .c(x31), .O(new_n130_));
  ...
  nand3  g082(.a(new_n61_), .b(new_n134_), .c(new_n54_), .O(new_n135_));
  ...
  aoi21  g092(.a(new_n141_), .b(x19), .c(new_n144_), .O(new_n145_));
