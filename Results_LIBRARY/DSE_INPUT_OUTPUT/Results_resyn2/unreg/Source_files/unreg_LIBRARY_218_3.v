...
module FAU ( 
  ...
  nand2  g008(.a(x28), .b(x10), .O(new_n61_));
  ...
  aoi21  g065(.a(x19), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  ...
  aoi21  g069(.a(x30), .b(x18), .c(x17), .O(new_n122_));
  oai21  g070(.a(x18), .b(x10), .c(new_n122_), .O(new_n123_));
  inv1   g071(.a(x29), .O(new_n124_));
  oai21  g072(.a(new_n124_), .b(x19), .c(new_n61_), .O(new_n125_));
  aoi21  g073(.a(new_n123_), .b(x19), .c(new_n125_), .O(z09));
  ...
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n89_), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(new_n128_), .c(new_n62_), .O(z10));
  ...
  aoi21  g086(.a(new_n138_), .b(new_n54_), .c(new_n62_), .O(new_n139_));
  ...
  aoi21  g093(.a(new_n145_), .b(new_n54_), .c(new_n62_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n89_), .O(new_n153_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n89_), .O(new_n160_));
  ...
  aoi21  g111(.a(new_n163_), .b(new_n89_), .c(new_n54_), .O(new_n164_));
  nand2  g112(.a(x35), .b(new_n54_), .O(new_n165_));
  aoi21  g113(.a(x19), .b(x18), .c(x10), .O(new_n166_));
  oai21  g114(.a(new_n166_), .b(new_n117_), .c(new_n165_), .O(new_n167_));
  nor2   g115(.a(new_n167_), .b(new_n164_), .O(z15));
endmodule
