...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nand2  g000(.a(x32), .b(x24), .O(new_n53_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n88_), .c(new_n79_), .O(new_n91_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n58_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n54_), .O(z08));
  ...
  oai21  g084(.a(x32), .b(x18), .c(x24), .O(new_n137_));
  inv1   g085(.a(x08), .O(new_n138_));
  nand2  g086(.a(new_n61_), .b(new_n138_), .O(new_n139_));
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n79_), .O(new_n140_));
  inv1   g088(.a(x31), .O(new_n141_));
  nand3  g089(.a(new_n53_), .b(new_n141_), .c(new_n55_), .O(new_n142_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n79_), .O(new_n147_));
  ...
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n79_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n79_), .O(new_n161_));
  inv1   g109(.a(x34), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(new_n55_), .c(new_n54_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n161_), .O(z14));
  inv1   g112(.a(x35), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(new_n55_), .O(new_n166_));
  nand2  g114(.a(x28), .b(x18), .O(new_n167_));
  inv1   g115(.a(x12), .O(new_n168_));
  nand2  g116(.a(new_n61_), .b(new_n168_), .O(new_n169_));
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n58_), .O(new_n170_));
  aoi21  g118(.a(new_n170_), .b(new_n166_), .c(new_n54_), .O(z15));
endmodule
