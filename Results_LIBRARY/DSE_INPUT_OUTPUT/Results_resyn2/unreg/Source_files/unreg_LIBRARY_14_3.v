...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x23), .O(new_n61_));
  ...
  nand3  g025(.a(new_n61_), .b(new_n77_), .c(new_n54_), .O(new_n78_));
  nand2  g026(.a(new_n78_), .b(new_n76_), .O(z02));
  inv1   g027(.a(x23), .O(new_n80_));
  inv1   g028(.a(x32), .O(new_n81_));
  aoi21  g029(.a(new_n81_), .b(x19), .c(new_n80_), .O(new_n82_));
  ...
  nand3  g034(.a(new_n86_), .b(new_n84_), .c(new_n67_), .O(new_n87_));
  aoi21  g035(.a(new_n87_), .b(x19), .c(new_n82_), .O(z03));
  ...
  nand4  g041(.a(new_n93_), .b(new_n91_), .c(x19), .d(new_n67_), .O(new_n94_));
  aoi21  g042(.a(new_n94_), .b(new_n90_), .c(new_n62_), .O(z04));
  ...
  aoi21  g048(.a(new_n100_), .b(new_n54_), .c(new_n62_), .O(new_n101_));
  ...
  nand4  g055(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n67_), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(new_n104_), .c(new_n62_), .O(z06));
  ...
  nand4  g062(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n67_), .O(new_n115_));
  aoi21  g063(.a(new_n115_), .b(new_n111_), .c(new_n62_), .O(z07));
  ...
  nand4  g069(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n67_), .O(new_n122_));
  aoi21  g070(.a(new_n122_), .b(new_n118_), .c(new_n62_), .O(z08));
  ...
  aoi21  g096(.a(new_n81_), .b(new_n54_), .c(new_n62_), .O(new_n149_));
