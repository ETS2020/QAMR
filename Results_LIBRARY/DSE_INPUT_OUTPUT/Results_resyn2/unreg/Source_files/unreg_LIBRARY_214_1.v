...
module FAU ( 
  ...
  oai21  g036(.a(x32), .b(new_n55_), .c(new_n88_), .O(new_n89_));
  nand2  g037(.a(x25), .b(x18), .O(new_n90_));
  inv1   g038(.a(x07), .O(new_n91_));
  nand2  g039(.a(new_n61_), .b(new_n91_), .O(new_n92_));
  nand3  g040(.a(new_n92_), .b(new_n90_), .c(new_n79_), .O(new_n93_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n79_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n79_), .O(new_n160_));
