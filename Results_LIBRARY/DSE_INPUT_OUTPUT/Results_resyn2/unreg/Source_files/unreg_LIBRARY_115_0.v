...
module FAU ( 
  ...
  nor2   g008(.a(x27), .b(x22), .O(new_n61_));
  ...
  inv1   g017(.a(x27), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g019(.a(x21), .b(new_n54_), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  aoi21  g021(.a(new_n68_), .b(x19), .c(new_n73_), .O(z01));
  nand2  g022(.a(new_n71_), .b(new_n55_), .O(new_n75_));
  nand2  g023(.a(x23), .b(x18), .O(new_n76_));
  oai21  g024(.a(x18), .b(x01), .c(new_n76_), .O(new_n77_));
  nand3  g025(.a(x27), .b(new_n69_), .c(new_n54_), .O(new_n78_));
  ...
  nand2  g033(.a(new_n85_), .b(new_n71_), .O(new_n86_));
  oai21  g034(.a(new_n84_), .b(new_n75_), .c(new_n86_), .O(z03));
  ...
  oai21  g056(.a(new_n69_), .b(new_n54_), .c(new_n70_), .O(new_n109_));
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n64_), .O(new_n148_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n64_), .O(new_n169_));
