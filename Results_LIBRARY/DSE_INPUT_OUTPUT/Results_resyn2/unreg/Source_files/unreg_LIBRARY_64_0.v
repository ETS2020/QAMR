...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x28), .O(new_n61_));
  ...
  aoi21  g043(.a(new_n95_), .b(new_n91_), .c(new_n61_), .O(z05));
  ...
  aoi21  g060(.a(new_n57_), .b(new_n112_), .c(x17), .O(new_n113_));
  oai21  g061(.a(new_n111_), .b(new_n57_), .c(new_n113_), .O(new_n114_));
  ...
  nand2  g067(.a(new_n111_), .b(new_n54_), .O(new_n120_));
  ...
  aoi21  g072(.a(new_n124_), .b(new_n120_), .c(new_n61_), .O(z09));
  ...
  aoi21  g086(.a(new_n138_), .b(new_n134_), .c(new_n61_), .O(z11));
  ...
  nand3  g100(.a(new_n117_), .b(new_n57_), .c(x13), .O(new_n153_));
  inv1   g101(.a(x35), .O(new_n154_));
  nand3  g102(.a(new_n117_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n55_), .O(new_n157_));
  nand3  g105(.a(new_n116_), .b(x28), .c(new_n54_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n157_), .O(z14));
  inv1   g107(.a(new_n55_), .O(new_n160_));
  nor2   g108(.a(new_n61_), .b(x18), .O(new_n161_));
  nor2   g109(.a(new_n148_), .b(x28), .O(new_n162_));
  aoi21  g110(.a(new_n161_), .b(x12), .c(new_n162_), .O(new_n163_));
  nand3  g111(.a(new_n117_), .b(new_n154_), .c(new_n54_), .O(new_n164_));
  oai21  g112(.a(new_n163_), .b(new_n160_), .c(new_n164_), .O(z15));
endmodule
