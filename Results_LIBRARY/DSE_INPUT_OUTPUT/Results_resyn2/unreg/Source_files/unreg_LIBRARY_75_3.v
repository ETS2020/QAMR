...
module FAU ( 
  ...
  nor2   g025(.a(new_n77_), .b(new_n63_), .O(new_n78_));
  ...
  nor2   g033(.a(new_n85_), .b(new_n63_), .O(new_n86_));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n63_), .O(z04));
  ...
  nor2   g047(.a(new_n99_), .b(new_n63_), .O(new_n100_));
  ...
  nand2  g064(.a(x19), .b(x18), .O(new_n117_));
  oai22  g065(.a(new_n117_), .b(x29), .c(x18), .d(new_n61_), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  aoi21  g067(.a(new_n62_), .b(new_n54_), .c(new_n63_), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n119_), .O(z08));
  ...
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n63_), .O(z09));
  ...
  aoi21  g082(.a(new_n134_), .b(new_n130_), .c(new_n63_), .O(z10));
  ...
  nor2   g088(.a(new_n140_), .b(new_n63_), .O(new_n141_));
  ...
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n63_), .O(z12));
  ...
  nor2   g102(.a(new_n154_), .b(new_n63_), .O(new_n155_));
  ...
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n63_), .O(z14));
  inv1   g111(.a(x12), .O(new_n164_));
  nand2  g112(.a(new_n57_), .b(new_n164_), .O(new_n165_));
  aoi21  g113(.a(new_n165_), .b(new_n116_), .c(new_n54_), .O(new_n166_));
  nand2  g114(.a(x35), .b(new_n54_), .O(new_n167_));
  aoi21  g115(.a(x19), .b(x18), .c(x11), .O(new_n168_));
  oai21  g116(.a(new_n168_), .b(new_n62_), .c(new_n167_), .O(new_n169_));
  nor2   g117(.a(new_n169_), .b(new_n166_), .O(z15));
endmodule
