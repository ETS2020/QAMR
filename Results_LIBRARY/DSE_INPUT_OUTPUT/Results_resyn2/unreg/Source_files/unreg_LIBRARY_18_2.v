...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x10), .O(new_n63_));
  ...
  inv1   g030(.a(x10), .O(new_n83_));
  nor2   g031(.a(x28), .b(new_n83_), .O(new_n84_));
  nor2   g032(.a(x23), .b(x19), .O(new_n85_));
  nor2   g033(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  oai21  g034(.a(new_n82_), .b(new_n79_), .c(new_n86_), .O(z03));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n84_), .O(z04));
  ...
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n84_), .O(z05));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n84_), .O(z07));
  oai21  g063(.a(new_n54_), .b(x10), .c(new_n62_), .O(new_n116_));
  ...
  inv1   g069(.a(x17), .O(new_n122_));
  nand3  g070(.a(x19), .b(new_n57_), .c(new_n122_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(x28), .O(new_n124_));
  nand2  g072(.a(new_n124_), .b(x10), .O(new_n125_));
  nor2   g073(.a(x29), .b(x19), .O(new_n126_));
  nor2   g074(.a(x30), .b(new_n57_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n55_), .c(new_n126_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n125_), .O(z09));
  ...
  aoi21  g083(.a(new_n135_), .b(new_n131_), .c(new_n84_), .O(z10));
  ...
  nand4  g106(.a(new_n158_), .b(x19), .c(x18), .d(new_n122_), .O(new_n159_));
  inv1   g107(.a(x34), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n54_), .O(new_n161_));
  nand4  g109(.a(x19), .b(new_n57_), .c(new_n122_), .d(x13), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(new_n161_), .c(new_n159_), .O(new_n163_));
  and2   g111(.a(new_n163_), .b(new_n63_), .O(z14));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n57_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n122_), .O(new_n168_));
  oai21  g116(.a(new_n158_), .b(x19), .c(new_n63_), .O(new_n169_));
