...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x08), .O(new_n61_));
  ...
  aoi21  g082(.a(x32), .b(x18), .c(x08), .O(new_n135_));
  nand2  g083(.a(x24), .b(x18), .O(new_n136_));
  nand3  g084(.a(new_n136_), .b(x19), .c(new_n87_), .O(new_n137_));
  inv1   g085(.a(x31), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(new_n54_), .O(new_n139_));
  oai22  g087(.a(new_n139_), .b(new_n61_), .c(new_n137_), .d(new_n135_), .O(z11));
  inv1   g088(.a(x32), .O(new_n141_));
  nand2  g089(.a(x19), .b(x08), .O(new_n142_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n87_), .O(new_n154_));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n87_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n87_), .O(new_n168_));
