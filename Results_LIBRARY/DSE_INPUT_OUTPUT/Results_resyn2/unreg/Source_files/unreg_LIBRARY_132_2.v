...
module FAU ( 
  ...
  aoi21  g063(.a(x32), .b(x19), .c(new_n61_), .O(new_n116_));
  ...
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n67_), .O(new_n132_));
  ...
  oai21  g089(.a(x28), .b(new_n54_), .c(new_n141_), .O(new_n142_));
