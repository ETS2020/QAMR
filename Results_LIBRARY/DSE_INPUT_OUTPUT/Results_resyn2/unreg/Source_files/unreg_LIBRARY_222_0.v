...
module FAU ( 
  ...
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n73_), .O(new_n97_));
  inv1   g045(.a(x25), .O(new_n98_));
  oai22  g046(.a(x34), .b(x26), .c(new_n98_), .d(x19), .O(new_n99_));
  ...
  nand2  g054(.a(x34), .b(new_n106_), .O(new_n107_));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n73_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n61_), .O(z09));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n73_), .O(new_n135_));
  ...
  nor2   g096(.a(new_n148_), .b(new_n61_), .O(new_n149_));
  ...
  nand2  g106(.a(new_n105_), .b(new_n158_), .O(new_n159_));
  ...
  nor2   g117(.a(new_n169_), .b(new_n61_), .O(new_n170_));
