...
module FAU ( 
  ...
  aoi21  g017(.a(new_n61_), .b(new_n54_), .c(new_n63_), .O(new_n70_));
  ...
  aoi21  g026(.a(new_n78_), .b(new_n73_), .c(new_n63_), .O(z02));
  ...
  aoi21  g091(.a(new_n61_), .b(x19), .c(new_n62_), .O(new_n144_));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n63_), .O(z13));
  ...
  nor2   g107(.a(new_n159_), .b(new_n63_), .O(new_n160_));
