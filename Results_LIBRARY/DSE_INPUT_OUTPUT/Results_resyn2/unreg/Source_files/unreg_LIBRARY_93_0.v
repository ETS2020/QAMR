...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x07), .O(new_n53_));
  ...
  nor2   g026(.a(new_n54_), .b(x17), .O(new_n79_));
  ...
  oai21  g032(.a(new_n82_), .b(new_n78_), .c(new_n84_), .O(z03));
  aoi21  g033(.a(x34), .b(x18), .c(x07), .O(new_n86_));
  nand2  g034(.a(x25), .b(x18), .O(new_n87_));
  nand3  g035(.a(new_n87_), .b(x19), .c(new_n57_), .O(new_n88_));
  inv1   g036(.a(x24), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n54_), .O(new_n90_));
  oai22  g038(.a(new_n90_), .b(new_n53_), .c(new_n88_), .d(new_n86_), .O(z04));
  nand2  g039(.a(x26), .b(x18), .O(new_n92_));
  inv1   g040(.a(x06), .O(new_n93_));
  nand2  g041(.a(new_n60_), .b(new_n93_), .O(new_n94_));
  nand3  g042(.a(new_n94_), .b(new_n92_), .c(new_n79_), .O(new_n95_));
  ...
  nand2  g055(.a(new_n60_), .b(new_n107_), .O(new_n108_));
  nand3  g056(.a(new_n108_), .b(new_n106_), .c(new_n79_), .O(new_n109_));
  nor2   g057(.a(x27), .b(x19), .O(new_n110_));
  nor2   g058(.a(new_n110_), .b(new_n53_), .O(new_n111_));
  ...
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n79_), .O(new_n116_));
  ...
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n79_), .O(new_n123_));
  ...
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n79_), .O(new_n144_));
  ...
  nand2  g103(.a(x19), .b(x07), .O(new_n156_));
