...
module FAU ( 
  ...
  nand2  g050(.a(new_n61_), .b(new_n53_), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n102_), .c(new_n58_), .O(new_n104_));
  inv1   g052(.a(x26), .O(new_n105_));
  oai22  g053(.a(x34), .b(new_n53_), .c(new_n105_), .d(x19), .O(new_n106_));
  ...
  oai21  g105(.a(new_n55_), .b(x05), .c(new_n157_), .O(new_n158_));
  nand2  g106(.a(x35), .b(x18), .O(new_n159_));
  inv1   g107(.a(x13), .O(new_n160_));
  nand2  g108(.a(new_n61_), .b(new_n160_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n72_), .O(new_n162_));
