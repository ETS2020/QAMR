...
module FAU ( 
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n97_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n94_), .O(z11));
  oai21  g090(.a(x30), .b(new_n54_), .c(new_n62_), .O(new_n143_));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n97_), .O(new_n161_));
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n94_), .O(z14));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n97_), .O(new_n168_));
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n94_), .O(z15));
endmodule
