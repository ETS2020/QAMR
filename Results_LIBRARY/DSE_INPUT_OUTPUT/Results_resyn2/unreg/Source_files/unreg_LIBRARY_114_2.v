...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x12), .O(new_n63_));
  ...
  nand2  g091(.a(new_n63_), .b(new_n55_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n145_), .O(new_n146_));
  inv1   g094(.a(x12), .O(new_n147_));
  nand3  g095(.a(new_n62_), .b(new_n54_), .c(new_n147_), .O(new_n148_));
  oai21  g096(.a(new_n146_), .b(new_n144_), .c(new_n148_), .O(z12));
  ...
  oai21  g101(.a(new_n151_), .b(new_n144_), .c(new_n153_), .O(z13));
  ...
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n65_), .O(z14));
  inv1   g109(.a(x17), .O(new_n162_));
  nand3  g110(.a(x19), .b(new_n57_), .c(new_n162_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(x32), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(x12), .O(new_n165_));
  nor2   g113(.a(x35), .b(x19), .O(new_n166_));
  nor2   g114(.a(x28), .b(new_n57_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n55_), .c(new_n166_), .O(new_n168_));
