...
module FAU ( 
  ...
  nand2  g032(.a(new_n57_), .b(new_n61_), .O(new_n85_));
  nand4  g033(.a(new_n85_), .b(new_n84_), .c(x19), .d(new_n82_), .O(new_n86_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n82_), .O(new_n93_));
  ...
  aoi21  g063(.a(x19), .b(new_n61_), .c(new_n62_), .O(new_n116_));
  ...
  nor2   g072(.a(new_n124_), .b(new_n63_), .O(new_n125_));
  ...
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n82_), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(new_n128_), .c(new_n63_), .O(z10));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n82_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n135_), .c(new_n63_), .O(z11));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n82_), .O(new_n153_));
