...
module FAU ( 
  ...
  nor2   g047(.a(new_n99_), .b(new_n54_), .O(new_n100_));
  ...
  nor2   g054(.a(new_n106_), .b(new_n54_), .O(new_n107_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n72_), .O(new_n112_));
  ...
  oai21  g064(.a(x32), .b(new_n55_), .c(new_n116_), .O(new_n117_));
  nand2  g065(.a(x29), .b(x18), .O(new_n118_));
  inv1   g066(.a(x11), .O(new_n119_));
  nand2  g067(.a(new_n61_), .b(new_n119_), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n118_), .c(new_n72_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n117_), .O(z08));
  ...
  nand2  g078(.a(new_n130_), .b(new_n55_), .O(new_n131_));
  nand2  g079(.a(x31), .b(x18), .O(new_n132_));
  inv1   g080(.a(x09), .O(new_n133_));
  nand2  g081(.a(new_n61_), .b(new_n133_), .O(new_n134_));
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n58_), .O(new_n135_));
  aoi21  g083(.a(new_n135_), .b(new_n131_), .c(new_n54_), .O(z10));
  ...
  nor2   g089(.a(new_n141_), .b(new_n54_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n140_), .O(z11));
  aoi21  g091(.a(x28), .b(x19), .c(new_n53_), .O(new_n144_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n58_), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n54_), .O(z13));
  nand2  g102(.a(x35), .b(x18), .O(new_n155_));
  inv1   g103(.a(x13), .O(new_n156_));
  nand2  g104(.a(new_n61_), .b(new_n156_), .O(new_n157_));
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n72_), .O(new_n158_));
  nor2   g106(.a(x34), .b(x19), .O(new_n159_));
  nor2   g107(.a(new_n159_), .b(new_n54_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n158_), .O(z14));
  nand2  g109(.a(x28), .b(x18), .O(new_n162_));
  inv1   g110(.a(x12), .O(new_n163_));
  nand2  g111(.a(new_n61_), .b(new_n163_), .O(new_n164_));
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n72_), .O(new_n165_));
  nor2   g113(.a(x35), .b(x19), .O(new_n166_));
  nor2   g114(.a(new_n166_), .b(new_n54_), .O(new_n167_));
