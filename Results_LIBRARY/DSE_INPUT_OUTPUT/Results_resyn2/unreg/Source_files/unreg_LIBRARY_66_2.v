...
module FAU ( 
  ...
  oai21  g071(.a(new_n53_), .b(x18), .c(x30), .O(new_n124_));
  ...
  nand4  g097(.a(new_n149_), .b(new_n147_), .c(x19), .d(new_n59_), .O(new_n150_));
  ...
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n73_), .O(new_n155_));
  ...
  nand3  g106(.a(new_n53_), .b(new_n135_), .c(new_n56_), .O(new_n159_));
  nand2  g107(.a(new_n73_), .b(new_n54_), .O(new_n160_));
