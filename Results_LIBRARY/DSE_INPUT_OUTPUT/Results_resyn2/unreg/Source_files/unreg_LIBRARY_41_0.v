...
module FAU ( 
  ...
  nor2   g036(.a(new_n54_), .b(x17), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g038(.a(x25), .b(x18), .O(new_n91_));
  oai21  g039(.a(x18), .b(x07), .c(new_n91_), .O(new_n92_));
  nand3  g040(.a(x32), .b(new_n86_), .c(new_n54_), .O(new_n93_));
  oai21  g041(.a(new_n92_), .b(new_n90_), .c(new_n93_), .O(z04));
  nand2  g042(.a(x26), .b(x18), .O(new_n95_));
  oai21  g043(.a(x18), .b(x06), .c(new_n95_), .O(new_n96_));
  nor2   g044(.a(x25), .b(x19), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n88_), .O(new_n98_));
  oai21  g046(.a(new_n96_), .b(new_n90_), .c(new_n98_), .O(z05));
  nand2  g047(.a(x27), .b(x18), .O(new_n100_));
  inv1   g048(.a(x05), .O(new_n101_));
  nand2  g049(.a(new_n60_), .b(new_n101_), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(new_n100_), .c(new_n89_), .O(new_n103_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n89_), .O(new_n117_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n89_), .O(new_n151_));
