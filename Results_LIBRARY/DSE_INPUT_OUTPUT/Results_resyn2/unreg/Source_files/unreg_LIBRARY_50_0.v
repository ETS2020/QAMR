...
module FAU ( 
  ...
  nand2  g31(.a(new_n54_), .b(new_n62_), .O(new_n84_));
  ...
  oai22  g36(.a(new_n64_), .b(x26), .c(x18), .d(new_n88_), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(new_n62_), .O(new_n90_));
  nand2  g38(.a(new_n85_), .b(new_n53_), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n90_), .O(z05));
  inv1   g40(.a(x26), .O(new_n93_));
  nand2  g41(.a(new_n70_), .b(new_n93_), .O(new_n94_));
  nor2   g42(.a(x18), .b(x05), .O(new_n95_));
  nand2  g43(.a(x27), .b(x18), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n56_), .O(new_n97_));
  oai21  g45(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(z06));
  inv1   g46(.a(x04), .O(new_n99_));
  oai22  g47(.a(new_n64_), .b(x20), .c(x18), .d(new_n99_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n62_), .O(new_n101_));
  nand2  g49(.a(new_n96_), .b(new_n53_), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n101_), .O(z07));
  nand2  g51(.a(x29), .b(x18), .O(new_n104_));
  inv1   g52(.a(x11), .O(new_n105_));
  nand2  g53(.a(new_n58_), .b(new_n105_), .O(new_n106_));
  nand3  g54(.a(new_n106_), .b(new_n104_), .c(new_n56_), .O(new_n107_));
  oai21  g55(.a(new_n54_), .b(x28), .c(new_n107_), .O(z08));
  inv1   g56(.a(x29), .O(new_n109_));
  nand2  g57(.a(new_n70_), .b(new_n109_), .O(new_n110_));
  ...
  oai22  g63(.a(new_n64_), .b(x31), .c(x18), .d(new_n115_), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n62_), .O(new_n117_));
  nand2  g65(.a(new_n112_), .b(new_n53_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n117_), .O(z10));
  inv1   g67(.a(x31), .O(new_n120_));
  nand2  g68(.a(new_n70_), .b(new_n120_), .O(new_n121_));
  nor2   g69(.a(x18), .b(x08), .O(new_n122_));
  nand2  g70(.a(new_n82_), .b(new_n56_), .O(new_n123_));
  oai21  g71(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(z11));
  ...
  oai21  g76(.a(new_n128_), .b(new_n84_), .c(new_n126_), .O(z12));
  ...
  oai21  g80(.a(new_n132_), .b(new_n84_), .c(new_n130_), .O(z13));
  inv1   g81(.a(x13), .O(new_n134_));
  oai22  g82(.a(new_n64_), .b(x35), .c(x18), .d(new_n134_), .O(new_n135_));
  nand2  g83(.a(new_n135_), .b(new_n62_), .O(new_n136_));
  ...
  nand2  g88(.a(new_n58_), .b(new_n140_), .O(new_n141_));
  nand3  g89(.a(new_n141_), .b(new_n139_), .c(new_n56_), .O(new_n142_));
  oai21  g90(.a(new_n54_), .b(x35), .c(new_n142_), .O(z15));
endmodule
