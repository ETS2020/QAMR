...
module FAU ( 
  ...
  nand2  g008(.a(x27), .b(x20), .O(new_n61_));
  ...
  oai21  g049(.a(x20), .b(x18), .c(x27), .O(new_n102_));
  ...
  aoi22  g057(.a(new_n109_), .b(new_n57_), .c(new_n60_), .d(x19), .O(new_n110_));
  oai21  g058(.a(x18), .b(x04), .c(new_n67_), .O(new_n111_));
  oai22  g059(.a(new_n111_), .b(new_n110_), .c(x27), .d(x19), .O(z07));
  ...
  nand4  g072(.a(new_n124_), .b(new_n122_), .c(x19), .d(new_n67_), .O(new_n125_));
  ...
  aoi21  g100(.a(new_n152_), .b(new_n54_), .c(new_n62_), .O(new_n153_));
  ...
  aoi21  g114(.a(new_n166_), .b(new_n54_), .c(new_n62_), .O(new_n167_));
