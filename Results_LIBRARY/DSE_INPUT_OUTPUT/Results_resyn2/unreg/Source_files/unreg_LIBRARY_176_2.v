...
module FAU ( 
  ...
  inv1   g008(.a(x33), .O(new_n61_));
  nor2   g009(.a(x34), .b(new_n61_), .O(new_n62_));
  ...
  nand3  g100(.a(x19), .b(new_n57_), .c(x14), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand2  g103(.a(x34), .b(x33), .O(new_n156_));
  oai21  g104(.a(x33), .b(new_n54_), .c(new_n156_), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n155_), .O(z13));
  oai21  g106(.a(x33), .b(new_n54_), .c(new_n151_), .O(new_n159_));
  ...
  nand2  g111(.a(new_n163_), .b(new_n159_), .O(z14));
  ...
  nor2   g117(.a(new_n169_), .b(new_n62_), .O(new_n170_));
