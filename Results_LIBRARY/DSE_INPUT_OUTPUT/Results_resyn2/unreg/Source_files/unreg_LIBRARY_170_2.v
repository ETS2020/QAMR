...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x26), .O(new_n54_));
  ...
  oai21  g043(.a(new_n53_), .b(x18), .c(x26), .O(new_n96_));
  ...
  nand3  g092(.a(new_n53_), .b(new_n107_), .c(new_n56_), .O(new_n145_));
  nand2  g093(.a(new_n66_), .b(new_n54_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n66_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n66_), .O(new_n160_));
