...
module FAU ( 
  ...
  nand2  g063(.a(new_n65_), .b(new_n115_), .O(new_n116_));
  ...
  nand2  g069(.a(x33), .b(x29), .O(new_n122_));
  ...
  nand2  g083(.a(x33), .b(x31), .O(new_n136_));
  ...
  nand2  g102(.a(x34), .b(x33), .O(new_n155_));
  ...
  nand2  g109(.a(x35), .b(x33), .O(new_n162_));
