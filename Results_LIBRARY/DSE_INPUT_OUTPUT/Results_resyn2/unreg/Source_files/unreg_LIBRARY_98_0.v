...
module FAU ( 
  ...
  nand3  g066(.a(x32), .b(new_n118_), .c(new_n54_), .O(new_n119_));
  oai21  g067(.a(new_n117_), .b(new_n115_), .c(new_n119_), .O(z08));
  nand2  g068(.a(x30), .b(x18), .O(new_n121_));
  oai21  g069(.a(x18), .b(x10), .c(new_n121_), .O(new_n122_));
  nor2   g070(.a(x29), .b(x19), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n114_), .O(new_n124_));
  oai21  g072(.a(new_n122_), .b(new_n115_), .c(new_n124_), .O(z09));
  ...
  nor2   g087(.a(new_n118_), .b(new_n54_), .O(new_n140_));
  ...
  oai21  g092(.a(new_n140_), .b(x32), .c(new_n144_), .O(z12));
  ...
  and2   g107(.a(new_n159_), .b(new_n114_), .O(z14));
  nand4  g108(.a(new_n118_), .b(x19), .c(x18), .d(new_n153_), .O(new_n161_));
  ...
  and2   g112(.a(new_n164_), .b(new_n114_), .O(z15));
endmodule
