...
module FAU ( 
  ...
  nand3  g042(.a(x19), .b(new_n61_), .c(new_n94_), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(x32), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(x06), .O(new_n97_));
  nor2   g045(.a(x25), .b(x19), .O(new_n98_));
  nor2   g046(.a(x26), .b(new_n61_), .O(new_n99_));
  aoi21  g047(.a(new_n99_), .b(new_n59_), .c(new_n98_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n97_), .O(z05));
  ...
  nor2   g091(.a(new_n55_), .b(x06), .O(new_n144_));
