...
module FAU ( 
  ...
  aoi21  g027(.a(new_n79_), .b(new_n74_), .c(new_n63_), .O(z02));
  ...
  nand4  g048(.a(new_n100_), .b(new_n98_), .c(x19), .d(new_n75_), .O(new_n101_));
  ...
  nor2   g055(.a(new_n107_), .b(new_n63_), .O(new_n108_));
  ...
  aoi21  g091(.a(new_n143_), .b(new_n139_), .c(new_n63_), .O(z11));
  aoi21  g092(.a(new_n62_), .b(x19), .c(new_n61_), .O(new_n145_));
  ...
  nor2   g101(.a(new_n153_), .b(new_n63_), .O(new_n154_));
  ...
  aoi21  g107(.a(new_n62_), .b(new_n54_), .c(new_n63_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n75_), .O(new_n167_));
