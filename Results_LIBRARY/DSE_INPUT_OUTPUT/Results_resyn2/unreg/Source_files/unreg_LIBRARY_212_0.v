// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:02 2020
...
module FAU ( 
  ...
  nor2   g008(.a(x28), .b(x00), .O(new_n61_));
  ...
  nand2  g026(.a(x28), .b(x18), .O(new_n79_));
  ...
  oai21  g032(.a(x28), .b(x00), .c(new_n84_), .O(new_n85_));
  ...
  aoi21  g055(.a(new_n107_), .b(new_n103_), .c(new_n61_), .O(z06));
  ...
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n61_), .O(z08));
  ...
  aoi21  g083(.a(new_n135_), .b(new_n131_), .c(new_n61_), .O(z10));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n89_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n61_), .O(z13));
  ...
  nor2   g112(.a(x18), .b(x12), .O(new_n165_));
  nand2  g113(.a(new_n79_), .b(new_n55_), .O(new_n166_));
  nor2   g114(.a(x35), .b(x19), .O(new_n167_));
  nor2   g115(.a(new_n167_), .b(new_n61_), .O(new_n168_));
  oai21  g116(.a(new_n166_), .b(new_n165_), .c(new_n168_), .O(z15));
endmodule
