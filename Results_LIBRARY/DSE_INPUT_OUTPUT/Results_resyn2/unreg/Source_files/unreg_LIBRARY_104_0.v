...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x04), .O(new_n61_));
  ...
  nand4  g039(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n73_), .O(new_n92_));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n73_), .O(new_n120_));
  ...
  oai21  g091(.a(new_n54_), .b(new_n109_), .c(new_n143_), .O(new_n144_));
