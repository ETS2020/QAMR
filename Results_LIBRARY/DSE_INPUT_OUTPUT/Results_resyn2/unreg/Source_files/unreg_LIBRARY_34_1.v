...
module FAU ( 
  ...
  oai21  g049(.a(x28), .b(new_n54_), .c(new_n62_), .O(new_n102_));
  ...
  inv1   g069(.a(new_n63_), .O(new_n122_));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n94_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n122_), .O(z09));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n94_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n122_), .O(z13));
