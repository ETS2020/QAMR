...
module FAU ( 
  ...
  oai21  g05(.a(x18), .b(x03), .c(new_n57_), .O(new_n58_));
  oai22  g06(.a(new_n58_), .b(new_n56_), .c(x20), .d(x19), .O(z00));
  nand2  g07(.a(x22), .b(x18), .O(new_n60_));
  oai21  g08(.a(x18), .b(x02), .c(new_n60_), .O(new_n61_));
  oai22  g09(.a(new_n61_), .b(new_n56_), .c(x21), .d(x19), .O(z01));
  ...
  nand3  g14(.a(new_n66_), .b(new_n63_), .c(new_n55_), .O(new_n67_));
  inv1   g15(.a(x22), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(new_n54_), .O(new_n69_));
  nand2  g17(.a(x28), .b(x19), .O(new_n70_));
  nand3  g18(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(z02));
  inv1   g19(.a(x00), .O(new_n72_));
  nand2  g20(.a(new_n65_), .b(new_n72_), .O(new_n73_));
  oai21  g21(.a(new_n65_), .b(x16), .c(new_n73_), .O(new_n74_));
  oai22  g22(.a(new_n74_), .b(new_n56_), .c(x23), .d(x19), .O(z03));
  nand2  g23(.a(x25), .b(x18), .O(new_n76_));
  inv1   g24(.a(x07), .O(new_n77_));
  nand2  g25(.a(new_n65_), .b(new_n77_), .O(new_n78_));
  nand3  g26(.a(new_n78_), .b(new_n76_), .c(new_n55_), .O(new_n79_));
  inv1   g27(.a(x24), .O(new_n80_));
  nand2  g28(.a(new_n80_), .b(new_n54_), .O(new_n81_));
  nand3  g29(.a(new_n81_), .b(new_n79_), .c(new_n70_), .O(z04));
  nand2  g30(.a(x26), .b(x18), .O(new_n83_));
  oai21  g31(.a(x18), .b(x06), .c(new_n83_), .O(new_n84_));
  oai22  g32(.a(new_n84_), .b(new_n56_), .c(x25), .d(x19), .O(z05));
  nand2  g33(.a(x27), .b(x18), .O(new_n86_));
  inv1   g34(.a(x05), .O(new_n87_));
  nand2  g35(.a(new_n65_), .b(new_n87_), .O(new_n88_));
  nand3  g36(.a(new_n88_), .b(new_n86_), .c(new_n55_), .O(new_n89_));
  inv1   g37(.a(x26), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  nand3  g39(.a(new_n91_), .b(new_n89_), .c(new_n70_), .O(z06));
  nand2  g40(.a(x20), .b(x18), .O(new_n93_));
  inv1   g41(.a(x04), .O(new_n94_));
  nand2  g42(.a(new_n65_), .b(new_n94_), .O(new_n95_));
  nand3  g43(.a(new_n95_), .b(new_n93_), .c(new_n55_), .O(new_n96_));
  inv1   g44(.a(x27), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n54_), .O(new_n98_));
  nand3  g46(.a(new_n98_), .b(new_n96_), .c(new_n70_), .O(z07));
  nand2  g47(.a(x29), .b(x18), .O(new_n100_));
  inv1   g48(.a(x11), .O(new_n101_));
  aoi21  g49(.a(new_n65_), .b(new_n101_), .c(x17), .O(new_n102_));
  aoi21  g50(.a(new_n102_), .b(new_n100_), .c(new_n54_), .O(new_n103_));
  oai21  g51(.a(new_n103_), .b(x28), .c(new_n70_), .O(z08));
  nand2  g52(.a(x30), .b(x18), .O(new_n105_));
  oai21  g53(.a(x18), .b(x10), .c(new_n105_), .O(new_n106_));
  oai22  g54(.a(new_n106_), .b(new_n56_), .c(x29), .d(x19), .O(z09));
  nand2  g55(.a(x31), .b(x18), .O(new_n108_));
  inv1   g56(.a(x09), .O(new_n109_));
  nand2  g57(.a(new_n65_), .b(new_n109_), .O(new_n110_));
  nand3  g58(.a(new_n110_), .b(new_n108_), .c(new_n55_), .O(new_n111_));
  inv1   g59(.a(x30), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  nand3  g61(.a(new_n113_), .b(new_n111_), .c(new_n70_), .O(z10));
  ...
  nand2  g67(.a(new_n119_), .b(new_n54_), .O(new_n120_));
  nand3  g68(.a(new_n120_), .b(new_n118_), .c(new_n70_), .O(z11));
  nand2  g69(.a(x33), .b(x18), .O(new_n122_));
  oai21  g70(.a(x18), .b(x15), .c(new_n122_), .O(new_n123_));
  oai22  g71(.a(new_n123_), .b(new_n56_), .c(x32), .d(x19), .O(z12));
  ...
  nand2  g77(.a(new_n129_), .b(new_n54_), .O(new_n130_));
  nand3  g78(.a(new_n130_), .b(new_n128_), .c(new_n70_), .O(z13));
  nand2  g79(.a(x35), .b(x18), .O(new_n132_));
  oai21  g80(.a(x18), .b(x13), .c(new_n132_), .O(new_n133_));
  oai22  g81(.a(new_n133_), .b(new_n56_), .c(x34), .d(x19), .O(z14));
  oai21  g82(.a(x18), .b(x12), .c(new_n55_), .O(new_n135_));
  inv1   g83(.a(x35), .O(new_n136_));
  nand2  g84(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  nand3  g85(.a(new_n137_), .b(new_n135_), .c(new_n70_), .O(z15));
endmodule
