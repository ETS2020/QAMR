...
module FAU ( 
  ...
  nor2   g081(.a(new_n133_), .b(new_n69_), .O(new_n134_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n88_), .O(new_n154_));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n88_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n88_), .O(new_n168_));
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n69_), .O(z15));
endmodule
