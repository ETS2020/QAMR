...
module FAU ( 
  ...
  nand2  g008(.a(x26), .b(x24), .O(new_n61_));
  ...
  aoi21  g050(.a(new_n92_), .b(x19), .c(new_n102_), .O(new_n103_));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n67_), .O(new_n112_));
  aoi21  g060(.a(new_n112_), .b(new_n108_), .c(new_n62_), .O(z07));
  ...
  nand4  g066(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n67_), .O(new_n119_));
  aoi21  g067(.a(new_n119_), .b(new_n115_), .c(new_n62_), .O(z08));
  ...
  oai21  g082(.a(x26), .b(x18), .c(x24), .O(new_n135_));
  ...
  nand3  g087(.a(new_n61_), .b(new_n139_), .c(new_n54_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n67_), .O(new_n147_));
