...
module FAU ( 
  ...
  inv1   g009(.a(x34), .O(new_n62_));
  nor2   g010(.a(new_n62_), .b(x30), .O(new_n63_));
  ...
  aoi21  g034(.a(new_n86_), .b(new_n81_), .c(new_n63_), .O(z03));
  ...
  nand3  g041(.a(new_n93_), .b(new_n91_), .c(new_n64_), .O(z04));
  ...
  nand3  g048(.a(new_n100_), .b(new_n98_), .c(new_n64_), .O(z05));
  ...
  nand3  g054(.a(new_n106_), .b(new_n104_), .c(new_n55_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n103_), .c(new_n63_), .O(z06));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n63_), .O(z07));
  inv1   g063(.a(x17), .O(new_n116_));
  inv1   g064(.a(x29), .O(new_n117_));
  nand4  g065(.a(new_n117_), .b(x19), .c(x18), .d(new_n116_), .O(new_n118_));
  inv1   g066(.a(x28), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n54_), .O(new_n120_));
  nand4  g068(.a(x19), .b(new_n57_), .c(new_n116_), .d(x11), .O(new_n121_));
  nand3  g069(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(new_n122_));
  and2   g070(.a(new_n122_), .b(new_n64_), .O(z08));
  inv1   g071(.a(x30), .O(new_n124_));
  nand4  g072(.a(new_n124_), .b(x19), .c(x18), .d(new_n116_), .O(new_n125_));
  nand2  g073(.a(new_n117_), .b(new_n54_), .O(new_n126_));
  nand4  g074(.a(x19), .b(new_n57_), .c(new_n116_), .d(x10), .O(new_n127_));
  nand3  g075(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  and2   g076(.a(new_n128_), .b(new_n64_), .O(z09));
  oai21  g077(.a(x34), .b(new_n54_), .c(new_n124_), .O(new_n130_));
  ...
  nand2  g088(.a(new_n140_), .b(new_n54_), .O(new_n141_));
  nand3  g089(.a(new_n141_), .b(new_n139_), .c(new_n64_), .O(z11));
  ...
  nand3  g096(.a(new_n148_), .b(new_n146_), .c(new_n64_), .O(z12));
  ...
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n64_), .O(z13));
  aoi21  g104(.a(x30), .b(x19), .c(new_n62_), .O(new_n157_));
  ...
  aoi21  g114(.a(new_n166_), .b(new_n162_), .c(new_n63_), .O(z15));
endmodule
