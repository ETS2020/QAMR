...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x26), .O(new_n53_));
  ...
  nor2   g025(.a(new_n60_), .b(x16), .O(new_n78_));
  inv1   g026(.a(x00), .O(new_n79_));
  nand2  g027(.a(new_n60_), .b(new_n79_), .O(new_n80_));
  nand2  g028(.a(new_n80_), .b(new_n58_), .O(new_n81_));
  nor2   g029(.a(x23), .b(x19), .O(new_n82_));
  nor2   g030(.a(new_n82_), .b(new_n53_), .O(new_n83_));
  oai21  g031(.a(new_n81_), .b(new_n78_), .c(new_n83_), .O(z03));
  inv1   g032(.a(new_n53_), .O(new_n85_));
  inv1   g033(.a(x17), .O(new_n86_));
  inv1   g034(.a(x25), .O(new_n87_));
  nand4  g035(.a(new_n87_), .b(x19), .c(x18), .d(new_n86_), .O(new_n88_));
  inv1   g036(.a(x24), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n54_), .O(new_n90_));
  nand4  g038(.a(x19), .b(new_n60_), .c(new_n86_), .d(x07), .O(new_n91_));
  nand3  g039(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(new_n92_));
  and2   g040(.a(new_n92_), .b(new_n85_), .O(z04));
  inv1   g041(.a(x26), .O(new_n94_));
  nand4  g042(.a(new_n94_), .b(x19), .c(x18), .d(new_n86_), .O(new_n95_));
  nand2  g043(.a(new_n87_), .b(new_n54_), .O(new_n96_));
  nand4  g044(.a(x19), .b(new_n60_), .c(new_n86_), .d(x06), .O(new_n97_));
  nand3  g045(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  and2   g046(.a(new_n98_), .b(new_n85_), .O(z05));
  inv1   g047(.a(x32), .O(new_n100_));
  oai21  g048(.a(new_n100_), .b(new_n54_), .c(new_n94_), .O(new_n101_));
  ...
  nand2  g065(.a(new_n60_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n58_), .O(new_n119_));
  aoi21  g067(.a(new_n119_), .b(new_n115_), .c(new_n53_), .O(z08));
  ...
  nor2   g073(.a(new_n125_), .b(new_n53_), .O(new_n126_));
  ...
  nand2  g084(.a(new_n60_), .b(new_n136_), .O(new_n137_));
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n58_), .O(new_n138_));
  nor2   g086(.a(x31), .b(x19), .O(new_n139_));
  nor2   g087(.a(new_n139_), .b(new_n53_), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n138_), .O(z11));
  oai21  g089(.a(new_n94_), .b(new_n54_), .c(new_n100_), .O(new_n142_));
  ...
  nor2   g100(.a(new_n152_), .b(new_n53_), .O(new_n153_));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n58_), .O(new_n158_));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n58_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n53_), .O(z15));
endmodule
