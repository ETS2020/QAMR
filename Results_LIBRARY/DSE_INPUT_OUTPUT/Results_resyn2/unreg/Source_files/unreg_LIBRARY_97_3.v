...
module FAU ( 
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n66_), .O(new_n157_));
  nor2   g105(.a(x34), .b(x19), .O(new_n158_));
  nor2   g106(.a(new_n158_), .b(new_n55_), .O(new_n159_));
  ...
  nand4  g113(.a(new_n165_), .b(new_n163_), .c(x19), .d(new_n59_), .O(new_n166_));
  aoi21  g114(.a(new_n166_), .b(new_n162_), .c(new_n55_), .O(z15));
endmodule
