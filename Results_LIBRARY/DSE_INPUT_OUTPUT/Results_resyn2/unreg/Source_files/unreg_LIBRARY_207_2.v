...
module FAU ( 
  ...
  oai21  g092(.a(new_n55_), .b(x12), .c(new_n144_), .O(new_n145_));
  nand2  g093(.a(x33), .b(x18), .O(new_n146_));
  inv1   g094(.a(x15), .O(new_n147_));
  nand2  g095(.a(new_n61_), .b(new_n147_), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n146_), .c(new_n65_), .O(new_n149_));
  ...
  nand2  g115(.a(new_n61_), .b(new_n53_), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n167_), .c(x19), .d(new_n58_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n166_), .c(new_n54_), .O(z15));
endmodule
