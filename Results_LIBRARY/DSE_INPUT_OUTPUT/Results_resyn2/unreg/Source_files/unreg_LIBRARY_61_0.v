...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x05), .O(new_n53_));
  ...
  nand3  g036(.a(new_n88_), .b(new_n86_), .c(new_n79_), .O(new_n89_));
  ...
  aoi21  g047(.a(x32), .b(x18), .c(x05), .O(new_n100_));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n79_), .O(new_n137_));
  ...
  nand2  g089(.a(x19), .b(x05), .O(new_n142_));
