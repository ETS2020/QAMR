...
module FAU ( 
  ...
  aoi21  g14(.a(new_n66_), .b(new_n63_), .c(x34), .O(new_n67_));
  inv1   g15(.a(x22), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(new_n62_), .O(new_n69_));
  oai21  g17(.a(new_n67_), .b(new_n62_), .c(new_n69_), .O(z02));
  ...
  aoi21  g22(.a(new_n74_), .b(new_n72_), .c(x34), .O(new_n75_));
  inv1   g23(.a(x23), .O(new_n76_));
  nand2  g24(.a(new_n76_), .b(new_n62_), .O(new_n77_));
  oai21  g25(.a(new_n75_), .b(new_n62_), .c(new_n77_), .O(z03));
  nand2  g26(.a(x25), .b(x18), .O(new_n79_));
  inv1   g27(.a(x07), .O(new_n80_));
  aoi21  g28(.a(new_n65_), .b(new_n80_), .c(x17), .O(new_n81_));
  aoi21  g29(.a(new_n81_), .b(new_n79_), .c(x34), .O(new_n82_));
  inv1   g30(.a(x24), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n62_), .O(new_n84_));
  oai21  g32(.a(new_n82_), .b(new_n62_), .c(new_n84_), .O(z04));
  ...
  aoi21  g38(.a(new_n65_), .b(new_n90_), .c(x17), .O(new_n91_));
  aoi21  g39(.a(new_n91_), .b(new_n89_), .c(x34), .O(new_n92_));
  inv1   g40(.a(x26), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n62_), .O(new_n94_));
  oai21  g42(.a(new_n92_), .b(new_n62_), .c(new_n94_), .O(z06));
  nand2  g43(.a(x20), .b(x18), .O(new_n96_));
  inv1   g44(.a(x04), .O(new_n97_));
  aoi21  g45(.a(new_n65_), .b(new_n97_), .c(x17), .O(new_n98_));
  aoi21  g46(.a(new_n98_), .b(new_n96_), .c(x34), .O(new_n99_));
  inv1   g47(.a(x27), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n62_), .O(new_n101_));
  oai21  g49(.a(new_n99_), .b(new_n62_), .c(new_n101_), .O(z07));
  ...
  nand2  g55(.a(new_n107_), .b(new_n62_), .O(new_n108_));
  oai21  g56(.a(new_n106_), .b(new_n62_), .c(new_n108_), .O(z08));
  nand2  g57(.a(x30), .b(x18), .O(new_n110_));
  inv1   g58(.a(x10), .O(new_n111_));
  aoi21  g59(.a(new_n65_), .b(new_n111_), .c(x17), .O(new_n112_));
  aoi21  g60(.a(new_n112_), .b(new_n110_), .c(x34), .O(new_n113_));
  inv1   g61(.a(x29), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n62_), .O(new_n115_));
  oai21  g63(.a(new_n113_), .b(new_n62_), .c(new_n115_), .O(z09));
  nand2  g64(.a(x31), .b(x18), .O(new_n117_));
  oai21  g65(.a(x18), .b(x09), .c(new_n117_), .O(new_n118_));
  oai22  g66(.a(new_n118_), .b(new_n55_), .c(x30), .d(x19), .O(z10));
  nand2  g67(.a(x24), .b(x18), .O(new_n120_));
  oai21  g68(.a(x18), .b(x08), .c(new_n120_), .O(new_n121_));
  oai22  g69(.a(new_n121_), .b(new_n55_), .c(x31), .d(x19), .O(z11));
  nand2  g70(.a(x33), .b(x18), .O(new_n123_));
  oai21  g71(.a(x18), .b(x15), .c(new_n123_), .O(new_n124_));
  oai22  g72(.a(new_n124_), .b(new_n55_), .c(x32), .d(x19), .O(z12));
  oai21  g73(.a(x18), .b(x14), .c(new_n53_), .O(new_n126_));
  nor2   g74(.a(x34), .b(new_n62_), .O(new_n127_));
  aoi22  g75(.a(new_n127_), .b(new_n126_), .c(x33), .d(new_n62_), .O(z13));
  inv1   g76(.a(x35), .O(new_n129_));
  inv1   g77(.a(x13), .O(new_n130_));
  aoi21  g78(.a(new_n65_), .b(new_n130_), .c(x17), .O(new_n131_));
  oai21  g79(.a(new_n129_), .b(new_n65_), .c(new_n131_), .O(new_n132_));
  aoi21  g80(.a(new_n132_), .b(x19), .c(x34), .O(z14));
  nand2  g81(.a(x28), .b(x18), .O(new_n134_));
  inv1   g82(.a(x12), .O(new_n135_));
  aoi21  g83(.a(new_n65_), .b(new_n135_), .c(x17), .O(new_n136_));
  aoi21  g84(.a(new_n136_), .b(new_n134_), .c(x34), .O(new_n137_));
  nand2  g85(.a(new_n129_), .b(new_n62_), .O(new_n138_));
  oai21  g86(.a(new_n137_), .b(new_n62_), .c(new_n138_), .O(z15));
endmodule
