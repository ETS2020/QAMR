...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x10), .O(new_n62_));
  ...
  aoi21  g070(.a(new_n61_), .b(x18), .c(x10), .O(new_n123_));
  nand2  g071(.a(x30), .b(x18), .O(new_n124_));
  nand3  g072(.a(new_n124_), .b(x19), .c(new_n67_), .O(new_n125_));
  inv1   g073(.a(x29), .O(new_n126_));
  nand2  g074(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  oai22  g075(.a(new_n127_), .b(new_n62_), .c(new_n125_), .d(new_n123_), .O(z09));
  ...
  aoi21  g090(.a(x19), .b(x10), .c(new_n61_), .O(new_n143_));
  ...
  nand4  g099(.a(new_n151_), .b(new_n149_), .c(x19), .d(new_n67_), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n148_), .c(new_n62_), .O(z13));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n67_), .O(new_n159_));
  ...
  nor2   g113(.a(new_n165_), .b(new_n62_), .O(new_n166_));
