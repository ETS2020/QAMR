...
module FAU ( 
  ...
  nand3  g065(.a(new_n117_), .b(new_n62_), .c(new_n54_), .O(new_n118_));
  nand2  g066(.a(new_n63_), .b(new_n55_), .O(new_n119_));
  nand2  g067(.a(x29), .b(x18), .O(new_n120_));
  oai21  g068(.a(x18), .b(x11), .c(new_n120_), .O(new_n121_));
  oai21  g069(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(z08));
  ...
  nand2  g091(.a(new_n117_), .b(new_n54_), .O(new_n144_));
