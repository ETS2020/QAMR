// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:29 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x34), .b(new_n53_), .O(new_n54_));
  ...
  nor2   g018(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand2  g019(.a(new_n71_), .b(new_n69_), .O(z01));
  aoi21  g020(.a(x34), .b(x19), .c(new_n53_), .O(new_n73_));
  ...
  nand4  g030(.a(new_n82_), .b(new_n80_), .c(x19), .d(new_n58_), .O(new_n83_));
  aoi21  g031(.a(new_n83_), .b(new_n78_), .c(new_n54_), .O(z03));
  inv1   g032(.a(x24), .O(new_n85_));
  nand2  g033(.a(new_n85_), .b(new_n55_), .O(new_n86_));
  nand2  g034(.a(x25), .b(x18), .O(new_n87_));
  inv1   g035(.a(x07), .O(new_n88_));
  nand2  g036(.a(new_n61_), .b(new_n88_), .O(new_n89_));
  nand4  g037(.a(new_n89_), .b(new_n87_), .c(x19), .d(new_n58_), .O(new_n90_));
  aoi21  g038(.a(new_n90_), .b(new_n86_), .c(new_n54_), .O(z04));
  nand2  g039(.a(x26), .b(x18), .O(new_n92_));
  inv1   g040(.a(x06), .O(new_n93_));
  nand2  g041(.a(new_n61_), .b(new_n93_), .O(new_n94_));
  nand3  g042(.a(new_n94_), .b(new_n92_), .c(new_n65_), .O(new_n95_));
  nor2   g043(.a(x25), .b(x19), .O(new_n96_));
  nor2   g044(.a(new_n96_), .b(new_n54_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n95_), .O(z05));
  inv1   g046(.a(x26), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n55_), .O(new_n100_));
  nand2  g048(.a(x27), .b(x18), .O(new_n101_));
  inv1   g049(.a(x05), .O(new_n102_));
  nand2  g050(.a(new_n61_), .b(new_n102_), .O(new_n103_));
  nand4  g051(.a(new_n103_), .b(new_n101_), .c(x19), .d(new_n58_), .O(new_n104_));
  aoi21  g052(.a(new_n104_), .b(new_n100_), .c(new_n54_), .O(z06));
  ...
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n65_), .O(new_n116_));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n65_), .O(new_n137_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n58_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n142_), .c(new_n54_), .O(z12));
  nand2  g095(.a(x34), .b(x18), .O(new_n148_));
  inv1   g096(.a(x14), .O(new_n149_));
  nand2  g097(.a(new_n61_), .b(new_n149_), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n65_), .O(new_n151_));
  ...
  oai21  g103(.a(x22), .b(new_n55_), .c(new_n155_), .O(new_n156_));
  nand2  g104(.a(x35), .b(x18), .O(new_n157_));
  inv1   g105(.a(x13), .O(new_n158_));
  nand2  g106(.a(new_n61_), .b(new_n158_), .O(new_n159_));
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n65_), .O(new_n160_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n65_), .O(new_n165_));
