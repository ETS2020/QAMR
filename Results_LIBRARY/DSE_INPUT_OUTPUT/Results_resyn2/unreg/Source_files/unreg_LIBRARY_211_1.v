...
module FAU ( 
  ...
  nand2  g036(.a(new_n63_), .b(new_n55_), .O(new_n89_));
  nand2  g037(.a(x25), .b(x18), .O(new_n90_));
  oai21  g038(.a(x18), .b(x07), .c(new_n90_), .O(new_n91_));
  inv1   g039(.a(x32), .O(new_n92_));
  nand3  g040(.a(new_n92_), .b(new_n62_), .c(new_n54_), .O(new_n93_));
  ...
  nand2  g045(.a(new_n97_), .b(new_n63_), .O(new_n98_));
  oai21  g046(.a(new_n96_), .b(new_n89_), .c(new_n98_), .O(z05));
  ...
  nand4  g052(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n68_), .O(new_n105_));
  aoi21  g053(.a(new_n105_), .b(new_n101_), .c(new_n65_), .O(z06));
  ...
  aoi21  g089(.a(x24), .b(x19), .c(new_n92_), .O(new_n142_));
