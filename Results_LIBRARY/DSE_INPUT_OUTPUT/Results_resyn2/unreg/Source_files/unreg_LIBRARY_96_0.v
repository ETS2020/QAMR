...
module FAU ( 
  ...
  nor2   g016(.a(x35), .b(x20), .O(new_n69_));
  ...
  nand3  g039(.a(new_n91_), .b(new_n89_), .c(new_n58_), .O(new_n92_));
  ...
  inv1   g048(.a(new_n69_), .O(new_n101_));
  inv1   g049(.a(x17), .O(new_n102_));
  nand4  g050(.a(x19), .b(new_n60_), .c(new_n102_), .d(x05), .O(new_n103_));
  inv1   g051(.a(x27), .O(new_n104_));
  nand4  g052(.a(new_n104_), .b(x19), .c(x18), .d(new_n102_), .O(new_n105_));
  inv1   g053(.a(x26), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n53_), .O(new_n107_));
  nand3  g055(.a(new_n107_), .b(new_n105_), .c(new_n103_), .O(new_n108_));
  and2   g056(.a(new_n108_), .b(new_n101_), .O(z06));
  nand4  g057(.a(x19), .b(new_n60_), .c(new_n102_), .d(x04), .O(new_n110_));
  nand4  g058(.a(new_n54_), .b(x19), .c(x18), .d(new_n102_), .O(new_n111_));
  nand2  g059(.a(new_n104_), .b(new_n53_), .O(new_n112_));
  nand3  g060(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  and2   g061(.a(new_n113_), .b(new_n101_), .O(z07));
  ...
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n69_), .O(z12));
  ...
  nand3  g104(.a(new_n55_), .b(x20), .c(x18), .O(new_n157_));
  nand2  g105(.a(new_n60_), .b(x13), .O(new_n158_));
  oai21  g106(.a(new_n158_), .b(new_n69_), .c(new_n157_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n58_), .O(new_n160_));
  nor2   g108(.a(x34), .b(x19), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n101_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n160_), .O(z14));
  nand3  g111(.a(new_n55_), .b(x20), .c(new_n53_), .O(new_n164_));
  nand2  g112(.a(new_n101_), .b(new_n58_), .O(new_n165_));
