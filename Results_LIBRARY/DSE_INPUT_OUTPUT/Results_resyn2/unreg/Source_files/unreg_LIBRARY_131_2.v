...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x06), .O(new_n54_));
  ...
  nand2  g036(.a(new_n73_), .b(new_n54_), .O(new_n89_));
  ...
  oai21  g041(.a(new_n91_), .b(new_n89_), .c(new_n93_), .O(z04));
  aoi21  g042(.a(x26), .b(x18), .c(x17), .O(new_n95_));
  oai21  g043(.a(x18), .b(x06), .c(new_n95_), .O(new_n96_));
  nand2  g044(.a(x25), .b(new_n56_), .O(new_n97_));
  ...
  nand3  g057(.a(new_n109_), .b(new_n107_), .c(new_n73_), .O(new_n110_));
  inv1   g058(.a(x27), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n56_), .O(new_n112_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n73_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n73_), .O(new_n124_));
  inv1   g072(.a(x29), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n56_), .O(new_n126_));
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n54_), .O(z09));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n59_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n59_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n55_), .O(z12));
  ...
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n54_), .O(z13));
  nand2  g103(.a(x35), .b(x18), .O(new_n156_));
  oai21  g104(.a(x18), .b(x13), .c(new_n156_), .O(new_n157_));
  inv1   g105(.a(x06), .O(new_n158_));
  nand3  g106(.a(new_n53_), .b(new_n56_), .c(new_n158_), .O(new_n159_));
  oai21  g107(.a(new_n157_), .b(new_n89_), .c(new_n159_), .O(z14));
