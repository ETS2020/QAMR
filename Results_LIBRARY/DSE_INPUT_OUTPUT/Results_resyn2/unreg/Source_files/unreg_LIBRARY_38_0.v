...
module FAU ( 
  ...
  aoi21  g027(.a(new_n74_), .b(x19), .c(new_n79_), .O(z02));
  oai21  g028(.a(new_n76_), .b(new_n54_), .c(new_n75_), .O(new_n81_));
  nor2   g029(.a(new_n60_), .b(x16), .O(new_n82_));
  nor2   g030(.a(new_n54_), .b(x17), .O(new_n83_));
  inv1   g031(.a(x00), .O(new_n84_));
  nand2  g032(.a(new_n60_), .b(new_n84_), .O(new_n85_));
  nand2  g033(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  oai21  g034(.a(new_n86_), .b(new_n82_), .c(new_n81_), .O(z03));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n57_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n53_), .O(z04));
  ...
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n83_), .O(new_n105_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n83_), .O(new_n112_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n83_), .O(new_n119_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n83_), .O(new_n133_));
  ...
  nand2  g091(.a(new_n83_), .b(new_n77_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n76_), .b(x23), .c(new_n54_), .O(new_n147_));
  ...
  nand2  g099(.a(new_n151_), .b(new_n77_), .O(new_n152_));
