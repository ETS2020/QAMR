...
module FAU ( 
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n72_), .O(new_n147_));
  aoi21  g095(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n148_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n72_), .O(new_n160_));
  nor2   g108(.a(x34), .b(x19), .O(new_n161_));
  nor2   g109(.a(new_n161_), .b(new_n54_), .O(new_n162_));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n72_), .O(new_n167_));
