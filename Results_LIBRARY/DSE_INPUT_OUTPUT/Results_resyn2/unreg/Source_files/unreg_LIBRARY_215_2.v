...
module FAU ( 
  ...
  nand3  g050(.a(new_n62_), .b(new_n93_), .c(new_n54_), .O(new_n103_));
  nand2  g051(.a(new_n63_), .b(new_n55_), .O(new_n104_));
  ...
  nand2  g058(.a(new_n110_), .b(new_n63_), .O(new_n111_));
  ...
  nand4  g065(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n68_), .O(new_n118_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n68_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n142_), .c(new_n65_), .O(z12));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n65_), .O(z13));
