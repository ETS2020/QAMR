...
module FAU ( 
  ...
  nor2   g018(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  ...
  aoi21  g035(.a(new_n87_), .b(new_n81_), .c(new_n63_), .O(z03));
  ...
  aoi21  g042(.a(new_n94_), .b(new_n90_), .c(new_n63_), .O(z04));
  ...
  nand4  g048(.a(new_n100_), .b(new_n98_), .c(x19), .d(new_n82_), .O(new_n101_));
  ...
  nor2   g062(.a(new_n114_), .b(new_n63_), .O(new_n115_));
  ...
  nor2   g069(.a(new_n121_), .b(new_n63_), .O(new_n122_));
  ...
  nor2   g083(.a(new_n135_), .b(new_n63_), .O(new_n136_));
  ...
  nor2   g090(.a(new_n142_), .b(new_n63_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n141_), .O(z11));
  aoi22  g092(.a(new_n62_), .b(x19), .c(new_n61_), .d(new_n57_), .O(new_n145_));
  oai21  g093(.a(x18), .b(x15), .c(new_n82_), .O(new_n146_));
  oai22  g094(.a(new_n146_), .b(new_n145_), .c(x32), .d(x19), .O(z12));
  aoi21  g095(.a(new_n61_), .b(x19), .c(new_n62_), .O(new_n148_));
  nand2  g096(.a(x34), .b(x18), .O(new_n149_));
  inv1   g097(.a(x14), .O(new_n150_));
  nand2  g098(.a(new_n57_), .b(new_n150_), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n82_), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(x19), .c(new_n148_), .O(z13));
  ...
  nand4  g106(.a(new_n158_), .b(new_n156_), .c(x19), .d(new_n82_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n155_), .c(new_n63_), .O(z14));
  ...
  nand4  g113(.a(new_n165_), .b(new_n163_), .c(x19), .d(new_n82_), .O(new_n166_));
