...
module FAU ( 
  ...
  oai21  g065(.a(new_n62_), .b(x19), .c(new_n63_), .O(new_n118_));
  aoi21  g066(.a(new_n117_), .b(x19), .c(new_n118_), .O(z08));
  aoi21  g067(.a(x30), .b(x18), .c(x17), .O(new_n120_));
  oai21  g068(.a(x18), .b(x10), .c(new_n120_), .O(new_n121_));
  nand2  g069(.a(x29), .b(new_n54_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n63_), .O(new_n123_));
  aoi21  g071(.a(new_n121_), .b(x19), .c(new_n123_), .O(z09));
  ...
  aoi21  g078(.a(new_n130_), .b(new_n126_), .c(new_n84_), .O(z10));
  ...
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n63_), .O(z11));
  ...
  nand3  g092(.a(new_n144_), .b(new_n142_), .c(new_n63_), .O(z12));
  ...
  aoi21  g099(.a(new_n151_), .b(new_n147_), .c(new_n84_), .O(z13));
