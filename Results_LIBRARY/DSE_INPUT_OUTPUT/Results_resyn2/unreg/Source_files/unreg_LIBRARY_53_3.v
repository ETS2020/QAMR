...
module FAU ( 
  ...
  nor2   g068(.a(new_n120_), .b(new_n63_), .O(new_n121_));
  ...
  nor2   g096(.a(new_n148_), .b(new_n63_), .O(new_n149_));
  ...
  nor2   g103(.a(new_n155_), .b(new_n63_), .O(new_n156_));
  ...
  aoi21  g109(.a(new_n62_), .b(new_n54_), .c(new_n63_), .O(new_n162_));
