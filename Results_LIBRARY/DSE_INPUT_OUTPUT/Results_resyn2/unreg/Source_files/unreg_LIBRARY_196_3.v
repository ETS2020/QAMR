...
module FAU ( 
  ...
  aoi21  g026(.a(new_n78_), .b(new_n74_), .c(new_n61_), .O(z02));
  ...
  nor2   g032(.a(new_n84_), .b(new_n61_), .O(new_n85_));
  ...
  aoi21  g066(.a(new_n64_), .b(new_n54_), .c(new_n61_), .O(new_n119_));
