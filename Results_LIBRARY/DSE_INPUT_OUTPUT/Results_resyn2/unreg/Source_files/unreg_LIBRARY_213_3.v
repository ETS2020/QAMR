...
module FAU ( 
  ...
  nand2  g008(.a(x34), .b(x33), .O(new_n61_));
  ...
  oai21  g091(.a(x34), .b(x18), .c(x33), .O(new_n144_));
  ...
  aoi22  g100(.a(new_n152_), .b(x19), .c(new_n151_), .d(new_n57_), .O(new_n153_));
  oai21  g101(.a(x18), .b(x14), .c(new_n67_), .O(new_n154_));
  oai22  g102(.a(new_n154_), .b(new_n153_), .c(x33), .d(x19), .O(z13));
  aoi21  g103(.a(new_n151_), .b(x19), .c(new_n152_), .O(new_n156_));
  ...
  aoi21  g112(.a(new_n164_), .b(new_n54_), .c(new_n62_), .O(new_n165_));
