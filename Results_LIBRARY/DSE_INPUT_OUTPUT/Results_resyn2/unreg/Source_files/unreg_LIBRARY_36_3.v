...
module FAU ( 
  ...
  nand4  g010(.a(new_n62_), .b(new_n59_), .c(x19), .d(new_n53_), .O(new_n63_));
  aoi21  g011(.a(new_n63_), .b(new_n58_), .c(new_n55_), .O(z00));
  inv1   g012(.a(x21), .O(new_n65_));
  nand2  g013(.a(new_n65_), .b(new_n56_), .O(new_n66_));
  nand2  g014(.a(x22), .b(x18), .O(new_n67_));
  inv1   g015(.a(x02), .O(new_n68_));
  nand2  g016(.a(new_n61_), .b(new_n68_), .O(new_n69_));
  nand4  g017(.a(new_n69_), .b(new_n67_), .c(x19), .d(new_n53_), .O(new_n70_));
  aoi21  g018(.a(new_n70_), .b(new_n66_), .c(new_n55_), .O(z01));
  nor2   g019(.a(new_n56_), .b(x17), .O(new_n72_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n88_), .c(new_n72_), .O(new_n91_));
  ...
  nand2  g043(.a(new_n95_), .b(new_n56_), .O(new_n96_));
  ...
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n55_), .O(z05));
  ...
  nand2  g060(.a(new_n61_), .b(new_n112_), .O(new_n113_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n72_), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n56_), .c(new_n55_), .O(new_n121_));
  ...
  nand2  g074(.a(new_n61_), .b(new_n126_), .O(new_n127_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n72_), .O(new_n133_));
  ...
  nand2  g086(.a(new_n61_), .b(new_n138_), .O(new_n139_));
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n72_), .O(new_n140_));
  nor2   g088(.a(x31), .b(x19), .O(new_n141_));
  nor2   g089(.a(new_n141_), .b(new_n55_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n140_), .O(z11));
  nand2  g091(.a(new_n54_), .b(new_n56_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n61_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n72_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n144_), .O(z12));
  nand2  g097(.a(x34), .b(x18), .O(new_n150_));
  inv1   g098(.a(x14), .O(new_n151_));
  nand2  g099(.a(new_n61_), .b(new_n151_), .O(new_n152_));
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n72_), .O(new_n153_));
  nor2   g101(.a(x33), .b(x19), .O(new_n154_));
  nor2   g102(.a(new_n154_), .b(new_n55_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n153_), .O(z13));
  nand2  g104(.a(new_n61_), .b(x13), .O(new_n157_));
  inv1   g105(.a(x35), .O(new_n158_));
  aoi21  g106(.a(new_n158_), .b(x18), .c(new_n56_), .O(new_n159_));
  nand2  g107(.a(x34), .b(new_n56_), .O(new_n160_));
  oai21  g108(.a(x32), .b(x19), .c(x17), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  aoi21  g110(.a(new_n159_), .b(new_n157_), .c(new_n162_), .O(z14));
  nand2  g111(.a(new_n61_), .b(x12), .O(new_n164_));
  aoi21  g112(.a(new_n120_), .b(x18), .c(new_n56_), .O(new_n165_));
  oai21  g113(.a(new_n158_), .b(x19), .c(new_n161_), .O(new_n166_));
  aoi21  g114(.a(new_n165_), .b(new_n164_), .c(new_n166_), .O(z15));
endmodule
