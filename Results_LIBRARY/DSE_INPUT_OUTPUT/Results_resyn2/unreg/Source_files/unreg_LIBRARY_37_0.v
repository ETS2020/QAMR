...
module FAU ( 
  ...
  oai22  g046(.a(x32), .b(x26), .c(new_n98_), .d(x19), .O(new_n99_));
  aoi21  g047(.a(new_n97_), .b(x19), .c(new_n99_), .O(z05));
  ...
  nand2  g052(.a(x26), .b(x19), .O(new_n105_));
  inv1   g053(.a(x26), .O(new_n106_));
  nand2  g054(.a(x32), .b(new_n106_), .O(new_n107_));
  aoi22  g055(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(x19), .O(z06));
  nand2  g056(.a(x20), .b(x18), .O(new_n109_));
  inv1   g057(.a(x04), .O(new_n110_));
  nand2  g058(.a(new_n60_), .b(new_n110_), .O(new_n111_));
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n64_), .O(new_n112_));
  nor2   g060(.a(x27), .b(x19), .O(new_n113_));
  nor2   g061(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n64_), .O(new_n119_));
  ...
  nand2  g092(.a(new_n105_), .b(new_n144_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n57_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n53_), .O(z13));
