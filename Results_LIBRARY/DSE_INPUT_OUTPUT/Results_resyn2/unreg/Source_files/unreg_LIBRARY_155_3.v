// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:35 2020
...
module FAU ( 
  ...
  nand2  g008(.a(x31), .b(x14), .O(new_n61_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n81_), .O(new_n114_));
  ...
  aoi21  g086(.a(x19), .b(new_n137_), .c(new_n138_), .O(new_n139_));
  nand2  g087(.a(x24), .b(x18), .O(new_n140_));
  inv1   g088(.a(x08), .O(new_n141_));
  nand2  g089(.a(new_n57_), .b(new_n141_), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n81_), .O(new_n143_));
  aoi21  g091(.a(new_n143_), .b(x19), .c(new_n139_), .O(z11));
  ...
  nand4  g097(.a(new_n149_), .b(new_n147_), .c(x19), .d(new_n81_), .O(new_n150_));
  aoi21  g098(.a(new_n150_), .b(new_n146_), .c(new_n62_), .O(z12));
  aoi21  g099(.a(x34), .b(x18), .c(x17), .O(new_n152_));
  oai21  g100(.a(x18), .b(x14), .c(new_n152_), .O(new_n153_));
  inv1   g101(.a(x33), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(x19), .c(new_n61_), .O(new_n155_));
  aoi21  g103(.a(new_n153_), .b(x19), .c(new_n155_), .O(z13));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n81_), .O(new_n162_));
  ...
  aoi21  g116(.a(new_n168_), .b(new_n54_), .c(new_n62_), .O(new_n169_));
