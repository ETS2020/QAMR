...
module FAU ( 
  ...
  nand3  g098(.a(x19), .b(new_n57_), .c(new_n150_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(x32), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(x14), .O(new_n153_));
  nor2   g101(.a(x33), .b(x19), .O(new_n154_));
  nor2   g102(.a(x34), .b(new_n57_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n55_), .c(new_n154_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n153_), .O(z13));
