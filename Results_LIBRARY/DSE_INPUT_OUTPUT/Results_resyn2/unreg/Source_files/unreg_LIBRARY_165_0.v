...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x07), .O(new_n61_));
  ...
  aoi21  g034(.a(x32), .b(x18), .c(x07), .O(new_n87_));
  nand2  g035(.a(x25), .b(x18), .O(new_n88_));
  nand3  g036(.a(new_n88_), .b(x19), .c(new_n66_), .O(new_n89_));
  inv1   g037(.a(x24), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  oai22  g039(.a(new_n91_), .b(new_n61_), .c(new_n89_), .d(new_n87_), .O(z04));
  ...
  nand2  g090(.a(x19), .b(x07), .O(new_n143_));
