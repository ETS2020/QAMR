...
module FAU ( 
  ...
  nand3  g022(.a(new_n74_), .b(new_n53_), .c(new_n56_), .O(new_n75_));
  nand2  g023(.a(new_n66_), .b(new_n54_), .O(new_n76_));
  nand2  g024(.a(x23), .b(x18), .O(new_n77_));
  oai21  g025(.a(x18), .b(x01), .c(new_n77_), .O(new_n78_));
  oai21  g026(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(z02));
  inv1   g027(.a(x00), .O(new_n80_));
  nand2  g028(.a(new_n62_), .b(new_n80_), .O(new_n81_));
  ...
  oai21  g034(.a(new_n84_), .b(new_n76_), .c(new_n86_), .O(z03));
  ...
  nand2  g105(.a(new_n74_), .b(new_n56_), .O(new_n158_));
