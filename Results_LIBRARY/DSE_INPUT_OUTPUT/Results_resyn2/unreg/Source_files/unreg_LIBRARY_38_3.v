...
module FAU ( 
  ...
  oai21  g021(.a(x32), .b(x18), .c(x23), .O(new_n74_));
  ...
  oai21  g026(.a(new_n54_), .b(new_n53_), .c(new_n78_), .O(new_n79_));
  ...
  aoi21  g033(.a(new_n53_), .b(new_n56_), .c(new_n55_), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(new_n85_), .O(z03));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n59_), .O(new_n100_));
  ...
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n73_), .O(new_n105_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n73_), .O(new_n112_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n73_), .O(new_n119_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n73_), .O(new_n133_));
