...
module FAU ( 
  ...
  oai22  g025(.a(new_n53_), .b(x23), .c(new_n77_), .d(x19), .O(new_n78_));
  aoi21  g026(.a(new_n76_), .b(x19), .c(new_n78_), .O(z02));
  inv1   g027(.a(x23), .O(new_n80_));
  oai21  g028(.a(x32), .b(new_n55_), .c(new_n80_), .O(new_n81_));
  nor2   g029(.a(new_n61_), .b(x16), .O(new_n82_));
