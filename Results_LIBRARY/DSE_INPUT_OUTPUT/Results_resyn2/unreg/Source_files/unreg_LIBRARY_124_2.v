...
module FAU ( 
  ...
  nand3  g11(.a(x32), .b(x19), .c(new_n63_), .O(new_n64_));
  ...
  oai21  g59(.a(x18), .b(x15), .c(new_n111_), .O(new_n112_));
  oai22  g60(.a(new_n112_), .b(new_n64_), .c(x32), .d(x19), .O(z12));
  nand2  g61(.a(x34), .b(x18), .O(new_n114_));
  inv1   g62(.a(x14), .O(new_n115_));
  ...
  oai21  g67(.a(new_n117_), .b(new_n53_), .c(new_n119_), .O(z13));
  nand2  g68(.a(x35), .b(x18), .O(new_n121_));
  inv1   g69(.a(x13), .O(new_n122_));
  ...
  oai21  g74(.a(new_n124_), .b(new_n53_), .c(new_n126_), .O(z14));
