...
module FAU ( 
  ...
  aoi21  g020(.a(new_n62_), .b(x19), .c(new_n61_), .O(new_n73_));
  ...
  aoi21  g032(.a(new_n84_), .b(new_n78_), .c(new_n63_), .O(z03));
  ...
  nand4  g038(.a(new_n90_), .b(new_n88_), .c(x19), .d(new_n79_), .O(new_n91_));
  aoi21  g039(.a(new_n91_), .b(new_n87_), .c(new_n63_), .O(z04));
  ...
  nor2   g045(.a(new_n97_), .b(new_n63_), .O(new_n98_));
  ...
  nor2   g052(.a(new_n104_), .b(new_n63_), .O(new_n105_));
  ...
  nor2   g059(.a(new_n111_), .b(new_n63_), .O(new_n112_));
  ...
  nor2   g073(.a(new_n125_), .b(new_n63_), .O(new_n126_));
  ...
  nor2   g080(.a(new_n132_), .b(new_n63_), .O(new_n133_));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n79_), .O(new_n147_));
  ...
  aoi21  g103(.a(new_n61_), .b(x19), .c(new_n62_), .O(new_n156_));
