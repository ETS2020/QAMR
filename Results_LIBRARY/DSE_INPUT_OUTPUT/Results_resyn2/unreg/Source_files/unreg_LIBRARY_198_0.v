...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x28), .O(new_n61_));
  ...
  inv1   g020(.a(x17), .O(new_n73_));
  nand2  g021(.a(x23), .b(x18), .O(new_n74_));
  inv1   g022(.a(x01), .O(new_n75_));
  nand2  g023(.a(new_n57_), .b(new_n75_), .O(new_n76_));
  nand4  g024(.a(new_n76_), .b(new_n74_), .c(x19), .d(new_n73_), .O(new_n77_));
  aoi21  g025(.a(new_n77_), .b(new_n72_), .c(new_n61_), .O(z02));
  ...
  nor2   g059(.a(new_n111_), .b(new_n61_), .O(new_n112_));
  nand2  g060(.a(new_n112_), .b(new_n110_), .O(z07));
  inv1   g061(.a(x28), .O(new_n114_));
  inv1   g062(.a(x32), .O(new_n115_));
  oai21  g063(.a(new_n115_), .b(new_n54_), .c(new_n114_), .O(new_n116_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n73_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n61_), .O(z09));
  ...
  nor2   g081(.a(new_n133_), .b(new_n61_), .O(new_n134_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n73_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n61_), .O(z11));
  nand2  g090(.a(new_n115_), .b(new_n114_), .O(new_n143_));
  ...
  nand3  g094(.a(new_n115_), .b(x28), .c(new_n54_), .O(new_n147_));
  ...
  oai21  g109(.a(x18), .b(x12), .c(new_n161_), .O(new_n162_));
  nor2   g110(.a(x35), .b(x19), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n143_), .O(new_n164_));
  oai21  g112(.a(new_n162_), .b(new_n144_), .c(new_n164_), .O(z15));
endmodule
