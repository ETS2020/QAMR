...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x30), .O(new_n54_));
  ...
  oai21  g078(.a(x31), .b(new_n55_), .c(new_n130_), .O(new_n131_));
  nand2  g079(.a(x31), .b(x18), .O(new_n132_));
  inv1   g080(.a(x09), .O(new_n133_));
  nand2  g081(.a(new_n61_), .b(new_n133_), .O(new_n134_));
  nand3  g082(.a(new_n134_), .b(new_n132_), .c(new_n72_), .O(new_n135_));
  ...
  aoi21  g088(.a(new_n53_), .b(new_n55_), .c(new_n54_), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n140_), .O(z11));
