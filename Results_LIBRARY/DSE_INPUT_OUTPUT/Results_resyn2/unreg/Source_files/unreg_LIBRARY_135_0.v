...
module FAU ( 
  ...
  nand2  g51(.a(new_n60_), .b(new_n74_), .O(new_n104_));
  nand2  g52(.a(x29), .b(x18), .O(new_n105_));
  oai21  g53(.a(x18), .b(x11), .c(new_n105_), .O(new_n106_));
  oai21  g54(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z08));
  ...
  oai21  g58(.a(new_n110_), .b(new_n104_), .c(new_n108_), .O(z09));
  inv1   g59(.a(x09), .O(new_n112_));
  oai22  g60(.a(new_n77_), .b(x31), .c(x18), .d(new_n112_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n74_), .O(new_n114_));
  ...
  oai21  g68(.a(new_n60_), .b(x31), .c(new_n120_), .O(z11));
  inv1   g69(.a(x15), .O(new_n122_));
  oai22  g70(.a(new_n77_), .b(x33), .c(x18), .d(new_n122_), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n74_), .O(new_n124_));
  ...
  nand2  g76(.a(new_n68_), .b(new_n128_), .O(new_n129_));
  ...
  nand2  g81(.a(new_n131_), .b(new_n54_), .O(new_n134_));
  nand2  g82(.a(x35), .b(x18), .O(new_n135_));
  oai21  g83(.a(x18), .b(x13), .c(new_n135_), .O(new_n136_));
  oai21  g84(.a(new_n136_), .b(new_n104_), .c(new_n134_), .O(z14));
  nand2  g85(.a(new_n135_), .b(new_n54_), .O(new_n138_));
  oai21  g86(.a(x18), .b(x12), .c(new_n102_), .O(new_n139_));
  oai21  g87(.a(new_n139_), .b(new_n104_), .c(new_n138_), .O(z15));
endmodule
