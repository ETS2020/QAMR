...
module FAU ( 
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n88_), .O(new_n126_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n88_), .O(new_n147_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n88_), .O(new_n153_));
