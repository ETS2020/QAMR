...
module FAU ( 
  ...
  nand3  g051(.a(x19), .b(new_n53_), .c(x04), .O(new_n104_));
  inv1   g052(.a(x20), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(x18), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g055(.a(new_n107_), .b(new_n62_), .O(new_n108_));
  oai21  g056(.a(new_n98_), .b(x18), .c(new_n54_), .O(new_n109_));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n57_), .O(new_n137_));
  oai21  g085(.a(new_n55_), .b(x32), .c(new_n137_), .O(z12));
  nand3  g086(.a(x19), .b(new_n53_), .c(x14), .O(new_n139_));
  ...
  oai21  g092(.a(new_n144_), .b(x18), .c(new_n54_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(x18), .c(new_n54_), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n151_), .O(z14));
  nand3  g101(.a(x19), .b(new_n53_), .c(x12), .O(new_n154_));
  ...
  oai21  g106(.a(new_n148_), .b(x18), .c(new_n54_), .O(new_n159_));
