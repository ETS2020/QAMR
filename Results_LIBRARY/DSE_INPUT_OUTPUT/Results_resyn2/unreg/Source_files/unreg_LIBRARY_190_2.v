...
module FAU ( 
  ...
  nand2  g052(.a(new_n57_), .b(new_n61_), .O(new_n105_));
  nand4  g053(.a(new_n105_), .b(new_n104_), .c(x19), .d(new_n67_), .O(new_n106_));
  aoi21  g054(.a(new_n106_), .b(new_n103_), .c(new_n62_), .O(z06));
  ...
  oai21  g091(.a(new_n54_), .b(x05), .c(new_n143_), .O(new_n144_));
