...
module FAU ( 
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n95_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n95_), .O(new_n140_));
  ...
  aoi21  g091(.a(x28), .b(x19), .c(new_n120_), .O(new_n144_));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n95_), .O(new_n158_));
  ...
  nand2  g113(.a(x35), .b(new_n56_), .O(new_n166_));
