...
module FAU ( 
  ...
  nand2  g008(.a(x33), .b(x30), .O(new_n61_));
  ...
  oai21  g070(.a(x33), .b(x18), .c(x30), .O(new_n123_));
  ...
  aoi21  g097(.a(new_n130_), .b(x19), .c(new_n131_), .O(new_n150_));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n57_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n74_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(x19), .c(new_n150_), .O(z13));
