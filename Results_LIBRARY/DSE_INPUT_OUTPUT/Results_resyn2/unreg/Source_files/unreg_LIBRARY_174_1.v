...
module FAU ( 
  ...
  oai21  g43(.a(x24), .b(x17), .c(x18), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(x19), .O(new_n97_));
  nand2  g45(.a(new_n93_), .b(new_n53_), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n97_), .O(z11));
  oai21  g47(.a(x33), .b(x17), .c(x18), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(x19), .O(new_n101_));
  inv1   g49(.a(x32), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n53_), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n101_), .O(z12));
  inv1   g52(.a(x34), .O(new_n105_));
  nand4  g53(.a(new_n105_), .b(x19), .c(x18), .d(new_n54_), .O(new_n106_));
  oai21  g54(.a(x33), .b(x19), .c(new_n106_), .O(z13));
  inv1   g55(.a(x35), .O(new_n108_));
  aoi21  g56(.a(new_n108_), .b(new_n54_), .c(new_n55_), .O(new_n109_));
  nand2  g57(.a(new_n105_), .b(new_n53_), .O(new_n110_));
  oai21  g58(.a(new_n109_), .b(new_n53_), .c(new_n110_), .O(z14));
  aoi21  g59(.a(new_n86_), .b(new_n54_), .c(new_n55_), .O(new_n112_));
  nand2  g60(.a(new_n108_), .b(new_n53_), .O(new_n113_));
  oai21  g61(.a(new_n112_), .b(new_n53_), .c(new_n113_), .O(z15));
endmodule
