...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x03), .O(new_n61_));
  ...
  nand4  g024(.a(new_n76_), .b(new_n74_), .c(x19), .d(new_n66_), .O(new_n77_));
  aoi21  g025(.a(new_n77_), .b(new_n73_), .c(new_n61_), .O(z02));
  ...
  nand4  g045(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n66_), .O(new_n98_));
  ...
  nand4  g052(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n66_), .O(new_n105_));
  aoi21  g053(.a(new_n105_), .b(new_n101_), .c(new_n61_), .O(z06));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n66_), .O(new_n112_));
  aoi21  g060(.a(new_n112_), .b(new_n108_), .c(new_n61_), .O(z07));
  ...
  nor2   g073(.a(new_n125_), .b(new_n61_), .O(new_n126_));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n66_), .O(new_n133_));
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n61_), .O(z10));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n66_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n61_), .O(z11));
  inv1   g089(.a(x32), .O(new_n142_));
  oai21  g090(.a(new_n54_), .b(new_n56_), .c(new_n142_), .O(new_n143_));
  ...
  nor2   g101(.a(new_n153_), .b(new_n61_), .O(new_n154_));
  ...
  nor2   g108(.a(new_n160_), .b(new_n61_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n66_), .O(new_n168_));
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n61_), .O(z15));
endmodule
