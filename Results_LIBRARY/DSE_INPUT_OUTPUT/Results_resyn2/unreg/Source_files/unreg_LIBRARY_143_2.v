...
module FAU ( 
  ...
  nand3  g11(.a(x23), .b(x19), .c(new_n63_), .O(new_n64_));
  ...
  nand2  g15(.a(new_n57_), .b(x01), .O(new_n68_));
  oai22  g16(.a(new_n68_), .b(new_n64_), .c(x22), .d(x19), .O(z02));
  nor2   g17(.a(new_n57_), .b(x16), .O(new_n70_));
  nor2   g18(.a(new_n53_), .b(x17), .O(new_n71_));
  oai21  g19(.a(x18), .b(x00), .c(new_n71_), .O(new_n72_));
  oai21  g20(.a(new_n72_), .b(new_n70_), .c(x23), .O(z03));
  nand2  g21(.a(x25), .b(x18), .O(new_n74_));
  inv1   g22(.a(x07), .O(new_n75_));
  aoi21  g23(.a(new_n57_), .b(new_n75_), .c(x17), .O(new_n76_));
  aoi21  g24(.a(new_n76_), .b(new_n74_), .c(new_n54_), .O(new_n77_));
  inv1   g25(.a(x24), .O(new_n78_));
  nand2  g26(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  oai21  g27(.a(new_n77_), .b(new_n53_), .c(new_n79_), .O(z04));
  ...
  aoi21  g57(.a(new_n57_), .b(new_n109_), .c(x17), .O(new_n110_));
  aoi21  g58(.a(new_n110_), .b(new_n108_), .c(new_n54_), .O(new_n111_));
  inv1   g59(.a(x30), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n53_), .O(new_n113_));
  oai21  g61(.a(new_n111_), .b(new_n53_), .c(new_n113_), .O(z10));
  ...
  oai21  g68(.a(new_n118_), .b(new_n53_), .c(new_n120_), .O(z11));
  ...
  inv1   g73(.a(x32), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(new_n53_), .O(new_n127_));
  oai21  g75(.a(new_n125_), .b(new_n53_), .c(new_n127_), .O(z12));
