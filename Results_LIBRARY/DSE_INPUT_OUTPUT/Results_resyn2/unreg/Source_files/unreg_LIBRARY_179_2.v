...
module FAU ( 
  ...
  aoi21  g049(.a(x32), .b(x19), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n63_), .O(z08));
  inv1   g067(.a(new_n63_), .O(new_n120_));
  ...
  aoi21  g075(.a(new_n127_), .b(new_n122_), .c(new_n120_), .O(z09));
  ...
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n120_), .O(z11));
  oai21  g090(.a(x26), .b(new_n54_), .c(new_n62_), .O(new_n143_));
  ...
  aoi21  g116(.a(new_n168_), .b(new_n164_), .c(new_n120_), .O(z15));
endmodule
