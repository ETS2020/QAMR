...
module FAU ( 
  ...
  nand2  g037(.a(new_n89_), .b(new_n56_), .O(new_n90_));
  nand2  g038(.a(x25), .b(x18), .O(new_n91_));
  inv1   g039(.a(x07), .O(new_n92_));
  nand2  g040(.a(new_n62_), .b(new_n92_), .O(new_n93_));
  nand4  g041(.a(new_n93_), .b(new_n91_), .c(x19), .d(new_n59_), .O(new_n94_));
  aoi21  g042(.a(new_n94_), .b(new_n90_), .c(new_n55_), .O(z04));
  ...
  nand2  g051(.a(new_n103_), .b(new_n56_), .O(new_n104_));
  nand2  g052(.a(x27), .b(x18), .O(new_n105_));
  inv1   g053(.a(x05), .O(new_n106_));
  nand2  g054(.a(new_n62_), .b(new_n106_), .O(new_n107_));
  nand4  g055(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n59_), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(new_n104_), .c(new_n55_), .O(z06));
  nand2  g057(.a(x20), .b(x18), .O(new_n110_));
  inv1   g058(.a(x04), .O(new_n111_));
  nand2  g059(.a(new_n62_), .b(new_n111_), .O(new_n112_));
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n80_), .O(new_n113_));
  nor2   g061(.a(x27), .b(x19), .O(new_n114_));
  nor2   g062(.a(new_n114_), .b(new_n55_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n113_), .O(z07));
  nand2  g064(.a(x29), .b(x18), .O(new_n117_));
  inv1   g065(.a(x11), .O(new_n118_));
  nand2  g066(.a(new_n62_), .b(new_n118_), .O(new_n119_));
  nand3  g067(.a(new_n119_), .b(new_n117_), .c(new_n80_), .O(new_n120_));
  ...
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n80_), .O(new_n127_));
  ...
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n80_), .O(new_n134_));
  ...
  nand2  g088(.a(new_n62_), .b(new_n53_), .O(new_n141_));
  nand4  g089(.a(new_n141_), .b(new_n140_), .c(x19), .d(new_n59_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n139_), .c(new_n55_), .O(z11));
  aoi21  g091(.a(x19), .b(new_n53_), .c(new_n54_), .O(new_n144_));
