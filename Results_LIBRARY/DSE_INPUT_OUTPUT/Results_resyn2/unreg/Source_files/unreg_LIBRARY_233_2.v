...
module FAU ( 
  ...
  nand4  g033(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n81_), .O(new_n86_));
  aoi21  g034(.a(new_n86_), .b(new_n80_), .c(new_n62_), .O(z03));
  ...
  aoi21  g077(.a(x32), .b(x19), .c(new_n61_), .O(new_n130_));
  aoi21  g078(.a(x31), .b(x18), .c(x17), .O(new_n131_));
  oai21  g079(.a(x18), .b(x09), .c(new_n131_), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(x19), .c(new_n130_), .O(z10));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n81_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n135_), .c(new_n62_), .O(z11));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n81_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n142_), .c(new_n62_), .O(z12));
  ...
  nor2   g100(.a(new_n152_), .b(new_n62_), .O(new_n153_));
  ...
  nor2   g114(.a(new_n166_), .b(new_n62_), .O(new_n167_));
