...
module FAU ( 
  ...
  nand2  g008(.a(x34), .b(x28), .O(new_n61_));
  ...
  aoi21  g095(.a(new_n147_), .b(new_n54_), .c(new_n62_), .O(new_n148_));
  ...
  aoi21  g102(.a(new_n154_), .b(new_n54_), .c(new_n62_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n153_), .O(z13));
  aoi21  g104(.a(new_n116_), .b(x19), .c(new_n117_), .O(new_n157_));
  ...
  oai21  g108(.a(x34), .b(x18), .c(x28), .O(new_n161_));
  ...
  nand3  g113(.a(new_n61_), .b(new_n165_), .c(new_n54_), .O(new_n166_));
