...
module FAU ( 
  ...
  nand2  g26(.a(new_n76_), .b(new_n55_), .O(new_n79_));
  inv1   g27(.a(x26), .O(new_n80_));
  nand4  g28(.a(new_n80_), .b(x19), .c(x18), .d(new_n71_), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n79_), .O(z05));
  oai21  g30(.a(x27), .b(x17), .c(x18), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(x19), .O(new_n84_));
  nand2  g32(.a(new_n80_), .b(new_n55_), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n84_), .O(z06));
  ...
  nand2  g53(.a(new_n105_), .b(new_n55_), .O(new_n106_));
  nand4  g54(.a(new_n74_), .b(x19), .c(x18), .d(new_n71_), .O(new_n107_));
  ...
  nand2  g62(.a(new_n114_), .b(new_n55_), .O(new_n115_));
  inv1   g63(.a(x34), .O(new_n116_));
  nand4  g64(.a(new_n116_), .b(x19), .c(x18), .d(new_n71_), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n115_), .O(z13));
  nand2  g66(.a(new_n116_), .b(new_n55_), .O(new_n119_));
  inv1   g67(.a(x35), .O(new_n120_));
  nand4  g68(.a(new_n120_), .b(x19), .c(x18), .d(new_n71_), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n119_), .O(z14));
  oai21  g70(.a(x28), .b(x17), .c(x18), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(x19), .O(new_n124_));
  nand2  g72(.a(new_n120_), .b(new_n55_), .O(new_n125_));
