...
module FAU ( 
  ...
  nor2   g016(.a(x34), .b(x20), .O(new_n69_));
  ...
  aoi21  g039(.a(new_n91_), .b(new_n87_), .c(new_n69_), .O(z04));
  ...
  aoi21  g046(.a(new_n98_), .b(new_n94_), .c(new_n69_), .O(z05));
  ...
  nor2   g052(.a(new_n104_), .b(new_n69_), .O(new_n105_));
  ...
  nor2   g059(.a(new_n111_), .b(new_n69_), .O(new_n112_));
  ...
  aoi21  g067(.a(new_n119_), .b(new_n115_), .c(new_n69_), .O(z08));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n58_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n69_), .O(z09));
  ...
  nor2   g080(.a(new_n132_), .b(new_n69_), .O(new_n133_));
  ...
  nor2   g087(.a(new_n139_), .b(new_n69_), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n138_), .O(z11));
  inv1   g089(.a(new_n69_), .O(new_n142_));
  inv1   g090(.a(x17), .O(new_n143_));
  inv1   g091(.a(x33), .O(new_n144_));
  nand4  g092(.a(new_n144_), .b(x19), .c(x18), .d(new_n143_), .O(new_n145_));
  inv1   g093(.a(x32), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n53_), .O(new_n147_));
  nand4  g095(.a(x19), .b(new_n60_), .c(new_n143_), .d(x15), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n147_), .c(new_n145_), .O(new_n149_));
  and2   g097(.a(new_n149_), .b(new_n142_), .O(z12));
  nand4  g098(.a(new_n55_), .b(x19), .c(x18), .d(new_n143_), .O(new_n151_));
  nand2  g099(.a(new_n144_), .b(new_n53_), .O(new_n152_));
  nand4  g100(.a(x19), .b(new_n60_), .c(new_n143_), .d(x14), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  and2   g102(.a(new_n154_), .b(new_n142_), .O(z13));
  oai21  g103(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(new_n156_));
  ...
  nor2   g114(.a(new_n166_), .b(new_n69_), .O(new_n167_));
