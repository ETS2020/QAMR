...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x02), .O(new_n61_));
  ...
  nand4  g038(.a(new_n90_), .b(new_n88_), .c(x19), .d(new_n73_), .O(new_n91_));
  ...
  nand4  g052(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n73_), .O(new_n105_));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n73_), .O(new_n112_));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n73_), .O(new_n133_));
  ...
  oai21  g090(.a(new_n54_), .b(new_n65_), .c(new_n142_), .O(new_n143_));
