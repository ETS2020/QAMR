// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:05 2020
...
module FAU ( 
  ...
  nand2  g001(.a(x34), .b(x20), .O(new_n54_));
  ...
  nand2  g010(.a(x34), .b(x21), .O(new_n63_));
  ...
  nand2  g026(.a(x34), .b(x23), .O(new_n79_));
  ...
  nand2  g034(.a(x34), .b(x24), .O(new_n87_));
  ...
  nand2  g041(.a(x34), .b(x25), .O(new_n94_));
  ...
  nand2  g049(.a(new_n72_), .b(new_n101_), .O(new_n102_));
  ...
  nand2  g056(.a(new_n72_), .b(new_n108_), .O(new_n109_));
  ...
  nand2  g062(.a(x34), .b(x28), .O(new_n115_));
  ...
  nand2  g070(.a(new_n72_), .b(new_n122_), .O(new_n123_));
  ...
  nand2  g077(.a(new_n72_), .b(new_n129_), .O(new_n130_));
  ...
  nand2  g084(.a(new_n72_), .b(new_n136_), .O(new_n137_));
  ...
  nand2  g091(.a(new_n72_), .b(new_n143_), .O(new_n144_));
  ...
  nand2  g098(.a(new_n72_), .b(new_n150_), .O(new_n151_));
  ...
  inv1   g108(.a(new_n160_), .O(z14));
  nand2  g109(.a(x35), .b(x34), .O(new_n162_));
