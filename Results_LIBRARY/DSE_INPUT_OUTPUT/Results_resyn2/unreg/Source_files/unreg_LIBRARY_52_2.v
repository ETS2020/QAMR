...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x25), .O(new_n63_));
  ...
  aoi21  g044(.a(x32), .b(x19), .c(new_n96_), .O(new_n97_));
  nand2  g045(.a(x26), .b(x18), .O(new_n98_));
  inv1   g046(.a(x06), .O(new_n99_));
  nand2  g047(.a(new_n57_), .b(new_n99_), .O(new_n100_));
  nand3  g048(.a(new_n100_), .b(new_n98_), .c(new_n75_), .O(new_n101_));
  aoi21  g049(.a(new_n101_), .b(x19), .c(new_n97_), .O(z05));
  ...
  nand3  g095(.a(new_n62_), .b(new_n96_), .c(new_n54_), .O(new_n148_));
  ...
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n72_), .O(z14));
