...
module FAU ( 
  ...
  nand2  g001(.a(x33), .b(x20), .O(new_n54_));
  ...
  nor2   g012(.a(new_n64_), .b(x19), .O(new_n65_));
  ...
  nand2  g041(.a(x33), .b(x25), .O(new_n94_));
  ...
  nand2  g048(.a(x33), .b(x26), .O(new_n101_));
  ...
  nand2  g062(.a(x33), .b(x28), .O(new_n115_));
  ...
  nand2  g070(.a(new_n65_), .b(new_n122_), .O(new_n123_));
  ...
  nand2  g076(.a(x33), .b(x30), .O(new_n129_));
  ...
  nand2  g084(.a(new_n65_), .b(new_n136_), .O(new_n137_));
  ...
  nand2  g091(.a(new_n65_), .b(new_n143_), .O(new_n144_));
  ...
  inv1   g101(.a(new_n153_), .O(z13));
  inv1   g102(.a(x34), .O(new_n155_));
  nand2  g103(.a(new_n65_), .b(new_n155_), .O(new_n156_));
  ...
  nand2  g110(.a(new_n65_), .b(new_n162_), .O(new_n163_));
