...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x23), .O(new_n53_));
  ...
  oai22  g024(.a(x32), .b(x23), .c(new_n76_), .d(x19), .O(new_n77_));
  aoi21  g025(.a(new_n75_), .b(x19), .c(new_n77_), .O(z02));
  inv1   g026(.a(x23), .O(new_n79_));
  inv1   g027(.a(x32), .O(new_n80_));
  oai21  g028(.a(new_n80_), .b(new_n54_), .c(new_n79_), .O(new_n81_));
  nor2   g029(.a(new_n60_), .b(x16), .O(new_n82_));
  inv1   g030(.a(x00), .O(new_n83_));
  nand2  g031(.a(new_n60_), .b(new_n83_), .O(new_n84_));
  nand2  g032(.a(new_n84_), .b(new_n64_), .O(new_n85_));
  oai21  g033(.a(new_n85_), .b(new_n82_), .c(new_n81_), .O(z03));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n64_), .O(new_n118_));
  ...
  oai21  g090(.a(new_n79_), .b(new_n54_), .c(new_n80_), .O(new_n143_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n64_), .O(new_n159_));
