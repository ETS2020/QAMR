...
module FAU ( 
  ...
  aoi21  g084(.a(x32), .b(x19), .c(new_n53_), .O(new_n137_));
  ...
  aoi21  g089(.a(new_n141_), .b(x19), .c(new_n137_), .O(z11));
  inv1   g090(.a(x32), .O(new_n143_));
  oai21  g091(.a(x31), .b(new_n55_), .c(new_n143_), .O(new_n144_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n65_), .O(new_n153_));
  ...
  nand2  g112(.a(new_n164_), .b(new_n55_), .O(new_n165_));
  nand2  g113(.a(x28), .b(x18), .O(new_n166_));
  inv1   g114(.a(x12), .O(new_n167_));
  nand2  g115(.a(new_n61_), .b(new_n167_), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n58_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n54_), .O(z15));
endmodule
