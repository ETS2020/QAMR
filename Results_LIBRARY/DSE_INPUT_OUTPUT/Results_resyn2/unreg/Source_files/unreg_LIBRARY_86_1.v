...
module FAU ( 
  ...
  nand2  g078(.a(new_n62_), .b(new_n54_), .O(new_n131_));
  ...
  aoi21  g083(.a(new_n135_), .b(new_n131_), .c(new_n72_), .O(z10));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n75_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n72_), .O(z12));
  oai21  g098(.a(new_n62_), .b(x18), .c(x34), .O(new_n151_));
  ...
  aoi21  g106(.a(x30), .b(x19), .c(new_n158_), .O(new_n159_));
