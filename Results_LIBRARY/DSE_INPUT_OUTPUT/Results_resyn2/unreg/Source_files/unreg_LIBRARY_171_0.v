...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x25), .O(new_n53_));
  ...
  nand2  g041(.a(x32), .b(x19), .O(new_n94_));
  ...
  nand3  g046(.a(new_n98_), .b(new_n96_), .c(new_n79_), .O(new_n99_));
  ...
  nand2  g095(.a(new_n147_), .b(x25), .O(new_n148_));
  aoi22  g096(.a(new_n148_), .b(new_n94_), .c(new_n146_), .d(x19), .O(z12));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n79_), .O(new_n167_));
