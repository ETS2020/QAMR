...
module FAU ( 
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n73_), .O(new_n126_));
  ...
  aoi21  g081(.a(new_n54_), .b(new_n56_), .c(new_n55_), .O(new_n134_));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n73_), .O(new_n139_));
  nor2   g087(.a(x31), .b(x19), .O(new_n140_));
  nor2   g088(.a(new_n140_), .b(new_n55_), .O(new_n141_));
  ...
  nor2   g095(.a(new_n147_), .b(new_n55_), .O(new_n148_));
