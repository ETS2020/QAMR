// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:13 2020
...
module FAU ( 
  ...
  nand2  g008(.a(x30), .b(x20), .O(new_n61_));
  ...
  oai21  g056(.a(x30), .b(x18), .c(x20), .O(new_n109_));
  ...
  oai21  g070(.a(x20), .b(x18), .c(x30), .O(new_n123_));
  ...
  nand3  g075(.a(new_n61_), .b(new_n127_), .c(new_n54_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n126_), .O(z09));
  inv1   g077(.a(x30), .O(new_n130_));
  aoi21  g078(.a(new_n60_), .b(x19), .c(new_n130_), .O(new_n131_));
  ...
  aoi21  g087(.a(new_n139_), .b(new_n54_), .c(new_n62_), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n138_), .O(z11));
  nand2  g089(.a(x33), .b(x18), .O(new_n142_));
  inv1   g090(.a(x15), .O(new_n143_));
  nand2  g091(.a(new_n57_), .b(new_n143_), .O(new_n144_));
  nand3  g092(.a(new_n144_), .b(new_n142_), .c(new_n55_), .O(new_n145_));
  inv1   g093(.a(x32), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n54_), .c(new_n62_), .O(new_n147_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n74_), .O(new_n154_));
  ...
  aoi21  g108(.a(new_n160_), .b(new_n54_), .c(new_n62_), .O(new_n161_));
