...
module FAU ( 
  ...
  inv1   g36(.a(x04), .O(new_n89_));
  aoi21  g37(.a(new_n62_), .b(new_n89_), .c(x17), .O(new_n90_));
  aoi21  g38(.a(new_n90_), .b(new_n88_), .c(new_n59_), .O(new_n91_));
  inv1   g39(.a(x27), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(new_n58_), .O(new_n93_));
  oai21  g41(.a(new_n91_), .b(new_n58_), .c(new_n93_), .O(z07));
  ...
  aoi21  g49(.a(new_n62_), .b(new_n101_), .c(x17), .O(new_n102_));
  aoi21  g50(.a(new_n102_), .b(new_n100_), .c(new_n59_), .O(new_n103_));
  ...
  aoi21  g59(.a(new_n62_), .b(new_n111_), .c(x17), .O(new_n112_));
  aoi21  g60(.a(new_n112_), .b(new_n110_), .c(new_n59_), .O(new_n113_));
  ...
  aoi21  g76(.a(new_n62_), .b(new_n128_), .c(x17), .O(new_n129_));
  aoi21  g77(.a(new_n129_), .b(new_n127_), .c(new_n59_), .O(new_n130_));
