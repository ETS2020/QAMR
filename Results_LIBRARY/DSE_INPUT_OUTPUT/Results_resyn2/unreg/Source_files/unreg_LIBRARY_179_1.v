...
module FAU ( 
  ...
  nand3  g018(.a(new_n70_), .b(new_n68_), .c(new_n63_), .O(z01));
  ...
  nand3  g025(.a(new_n77_), .b(new_n75_), .c(new_n63_), .O(z02));
  ...
  nand3  g033(.a(new_n85_), .b(new_n83_), .c(new_n63_), .O(z03));
  ...
  inv1   g041(.a(x17), .O(new_n94_));
  nand2  g042(.a(x26), .b(x18), .O(new_n95_));
  inv1   g043(.a(x06), .O(new_n96_));
  nand2  g044(.a(new_n57_), .b(new_n96_), .O(new_n97_));
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(new_n98_));
  nand2  g046(.a(x25), .b(new_n54_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n63_), .O(new_n100_));
  aoi21  g048(.a(new_n98_), .b(x19), .c(new_n100_), .O(z05));
  aoi21  g049(.a(x27), .b(x18), .c(x17), .O(new_n102_));
  oai21  g050(.a(x18), .b(x05), .c(new_n102_), .O(new_n103_));
  nand2  g051(.a(x26), .b(new_n54_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n63_), .O(new_n105_));
  aoi21  g053(.a(new_n103_), .b(x19), .c(new_n105_), .O(z06));
  ...
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n63_), .O(z07));
  ...
  inv1   g068(.a(new_n63_), .O(new_n121_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n94_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n121_), .O(z09));
  ...
  nand3  g082(.a(new_n134_), .b(new_n132_), .c(new_n63_), .O(z10));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n94_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n137_), .c(new_n121_), .O(z11));
  ...
  nand2  g095(.a(new_n147_), .b(new_n54_), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n146_), .c(new_n63_), .O(z12));
  ...
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n63_), .O(z13));
  ...
  nand3  g110(.a(new_n162_), .b(new_n160_), .c(new_n63_), .O(z14));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n94_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n121_), .O(z15));
endmodule
