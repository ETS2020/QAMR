...
module FAU ( 
  ...
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(new_n113_));
  ...
  inv1   g064(.a(x34), .O(new_n117_));
  nand3  g065(.a(new_n117_), .b(new_n53_), .c(new_n56_), .O(new_n118_));
  nand2  g066(.a(new_n109_), .b(new_n54_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n109_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n109_), .O(new_n133_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n109_), .O(new_n140_));
  ...
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n109_), .O(new_n154_));
  ...
  nand2  g105(.a(new_n117_), .b(new_n56_), .O(new_n158_));
  nand2  g106(.a(x35), .b(x18), .O(new_n159_));
  inv1   g107(.a(x13), .O(new_n160_));
  nand2  g108(.a(new_n62_), .b(new_n160_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n109_), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(new_n158_), .c(new_n54_), .O(z14));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  inv1   g112(.a(x12), .O(new_n165_));
  nand2  g113(.a(new_n62_), .b(new_n165_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n109_), .O(new_n167_));
