...
module FAU ( 
  ...
  oai21  g092(.a(new_n144_), .b(x18), .c(x33), .O(new_n145_));
  ...
  nand3  g096(.a(new_n61_), .b(new_n144_), .c(new_n54_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n148_), .O(z12));
  aoi21  g098(.a(x32), .b(x19), .c(new_n61_), .O(new_n151_));
  nand2  g099(.a(x34), .b(x18), .O(new_n152_));
  inv1   g100(.a(x14), .O(new_n153_));
  nand2  g101(.a(new_n57_), .b(new_n153_), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n81_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(x19), .c(new_n151_), .O(z13));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n81_), .O(new_n169_));
