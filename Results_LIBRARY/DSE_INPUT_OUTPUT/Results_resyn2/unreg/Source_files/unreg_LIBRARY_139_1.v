...
module FAU ( 
  ...
  oai21  g002(.a(x29), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  ...
  oai21  g011(.a(x29), .b(new_n63_), .c(new_n53_), .O(new_n64_));
  ...
  oai21  g018(.a(x29), .b(new_n70_), .c(new_n53_), .O(new_n71_));
  ...
  oai21  g025(.a(x29), .b(new_n77_), .c(new_n53_), .O(new_n78_));
  ...
  oai21  g033(.a(x29), .b(new_n85_), .c(new_n53_), .O(new_n86_));
  ...
  nor2   g040(.a(x29), .b(x19), .O(new_n93_));
  ...
  oai21  g048(.a(x29), .b(new_n100_), .c(new_n53_), .O(new_n101_));
  ...
  nand2  g055(.a(new_n93_), .b(new_n107_), .O(new_n108_));
  ...
  nand2  g062(.a(new_n93_), .b(new_n114_), .O(new_n115_));
  ...
  inv1   g068(.a(new_n93_), .O(new_n121_));
  ...
  nand2  g075(.a(new_n93_), .b(new_n127_), .O(new_n128_));
  ...
  nand2  g082(.a(new_n93_), .b(new_n134_), .O(new_n135_));
  ...
  nand2  g089(.a(new_n93_), .b(new_n141_), .O(new_n142_));
  ...
  oai21  g096(.a(new_n148_), .b(x29), .c(new_n53_), .O(new_n149_));
  ...
  oai21  g103(.a(new_n155_), .b(x29), .c(new_n53_), .O(new_n156_));
  ...
  oai21  g110(.a(new_n162_), .b(x29), .c(new_n53_), .O(new_n163_));
