...
module FAU ( 
  ...
  nand3  g050(.a(new_n102_), .b(new_n100_), .c(new_n64_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n108_), .b(new_n54_), .c(new_n107_), .O(new_n109_));
  nand2  g057(.a(x20), .b(x18), .O(new_n110_));
  inv1   g058(.a(x04), .O(new_n111_));
  nand2  g059(.a(new_n60_), .b(new_n111_), .O(new_n112_));
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n64_), .O(new_n113_));
  ...
  oai21  g090(.a(new_n107_), .b(new_n54_), .c(new_n108_), .O(new_n143_));
