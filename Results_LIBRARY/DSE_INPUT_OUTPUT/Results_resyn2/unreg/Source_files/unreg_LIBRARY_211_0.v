...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x24), .O(new_n61_));
  ...
  nand4  g051(.a(new_n103_), .b(new_n101_), .c(x19), .d(new_n66_), .O(new_n104_));
  ...
  nand4  g072(.a(new_n124_), .b(new_n122_), .c(x19), .d(new_n66_), .O(new_n125_));
  ...
  nand3  g090(.a(new_n87_), .b(x24), .c(new_n54_), .O(new_n143_));
  oai21  g091(.a(new_n142_), .b(new_n89_), .c(new_n143_), .O(z12));
  ...
  nor2   g097(.a(new_n149_), .b(new_n61_), .O(new_n150_));
