...
module FAU ( 
  ...
  nor2   g008(.a(x35), .b(x34), .O(new_n61_));
  ...
  aoi21  g032(.a(new_n84_), .b(new_n79_), .c(new_n61_), .O(z03));
  ...
  nor2   g080(.a(new_n132_), .b(new_n61_), .O(new_n133_));
  ...
  nor2   g094(.a(new_n146_), .b(new_n61_), .O(new_n147_));
  ...
  nor2   g100(.a(new_n152_), .b(new_n61_), .O(new_n153_));
  oai21  g101(.a(new_n151_), .b(new_n149_), .c(new_n153_), .O(z13));
  inv1   g102(.a(new_n55_), .O(new_n155_));
  inv1   g103(.a(new_n61_), .O(new_n156_));
  nor2   g104(.a(new_n150_), .b(x35), .O(new_n157_));
  inv1   g105(.a(x13), .O(new_n158_));
  nor2   g106(.a(x18), .b(new_n158_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n156_), .c(new_n157_), .O(new_n160_));
  inv1   g108(.a(x34), .O(new_n161_));
  nand3  g109(.a(x35), .b(new_n161_), .c(new_n54_), .O(new_n162_));
  oai21  g110(.a(new_n160_), .b(new_n155_), .c(new_n162_), .O(z14));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  inv1   g112(.a(x12), .O(new_n165_));
  aoi21  g113(.a(new_n57_), .b(new_n165_), .c(x17), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand2  g115(.a(x35), .b(new_n54_), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(new_n156_), .O(new_n169_));
  aoi21  g117(.a(new_n167_), .b(x19), .c(new_n169_), .O(z15));
endmodule
