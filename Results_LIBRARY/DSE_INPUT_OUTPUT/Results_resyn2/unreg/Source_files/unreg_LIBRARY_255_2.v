...
module FAU ( 
  ...
  nand2  g031(.a(new_n60_), .b(new_n54_), .O(new_n84_));
  nand2  g032(.a(x25), .b(x18), .O(new_n85_));
  nor2   g033(.a(new_n60_), .b(x17), .O(new_n86_));
  ...
  oai21  g037(.a(new_n84_), .b(x24), .c(new_n89_), .O(z04));
  ...
  nand3  g062(.a(new_n114_), .b(new_n112_), .c(new_n86_), .O(new_n115_));
  oai21  g063(.a(new_n84_), .b(x28), .c(new_n115_), .O(z08));
  ...
  oai21  g077(.a(new_n118_), .b(x18), .c(new_n60_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n129_), .O(z10));
  nand3  g079(.a(x19), .b(new_n54_), .c(x08), .O(new_n132_));
  inv1   g080(.a(x24), .O(new_n133_));
  ...
  oai21  g084(.a(new_n126_), .b(x18), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g089(.a(new_n141_), .b(new_n139_), .c(new_n86_), .O(new_n142_));
  oai21  g090(.a(new_n84_), .b(x32), .c(new_n142_), .O(z12));
  nand2  g091(.a(x34), .b(x18), .O(new_n144_));
  inv1   g092(.a(x14), .O(new_n145_));
  nand2  g093(.a(new_n54_), .b(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n86_), .O(new_n147_));
  oai21  g095(.a(new_n84_), .b(x33), .c(new_n147_), .O(z13));
  nand2  g096(.a(x35), .b(x18), .O(new_n149_));
  inv1   g097(.a(x13), .O(new_n150_));
  nand2  g098(.a(new_n54_), .b(new_n150_), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n86_), .O(new_n152_));
  oai21  g100(.a(new_n84_), .b(x34), .c(new_n152_), .O(z14));
  nand3  g101(.a(x19), .b(new_n54_), .c(x12), .O(new_n154_));
