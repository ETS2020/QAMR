...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x05), .O(new_n62_));
  ...
  aoi21  g049(.a(new_n61_), .b(x18), .c(x05), .O(new_n102_));
  nand2  g050(.a(x27), .b(x18), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(x19), .c(new_n67_), .O(new_n104_));
  inv1   g052(.a(x26), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n54_), .O(new_n106_));
  oai22  g054(.a(new_n106_), .b(new_n62_), .c(new_n104_), .d(new_n102_), .O(z06));
  ...
  nor2   g101(.a(new_n153_), .b(new_n62_), .O(new_n154_));
  ...
  nor2   g108(.a(new_n160_), .b(new_n62_), .O(new_n161_));
