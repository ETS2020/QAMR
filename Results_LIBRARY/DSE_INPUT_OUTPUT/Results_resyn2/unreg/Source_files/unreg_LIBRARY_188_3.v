...
module FAU ( 
  ...
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n65_), .O(z11));
  ...
  nand3  g097(.a(new_n149_), .b(new_n147_), .c(new_n65_), .O(z12));
  nand2  g098(.a(new_n57_), .b(x14), .O(new_n151_));
  inv1   g099(.a(x34), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(x18), .c(new_n54_), .O(new_n153_));
  nand2  g101(.a(x33), .b(new_n54_), .O(new_n154_));
  oai21  g102(.a(x28), .b(x19), .c(x17), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  aoi21  g104(.a(new_n153_), .b(new_n151_), .c(new_n156_), .O(z13));
  nand2  g105(.a(new_n57_), .b(x13), .O(new_n158_));
  inv1   g106(.a(x35), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(x18), .c(new_n54_), .O(new_n160_));
  oai21  g108(.a(new_n152_), .b(x19), .c(new_n155_), .O(new_n161_));
  aoi21  g109(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(z14));
  ...
  nand2  g114(.a(new_n159_), .b(new_n54_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n166_), .c(new_n65_), .O(z15));
endmodule
