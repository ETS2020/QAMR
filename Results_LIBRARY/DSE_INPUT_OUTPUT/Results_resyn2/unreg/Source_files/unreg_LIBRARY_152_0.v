...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x27), .O(new_n53_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n71_), .O(new_n119_));
  ...
  oai22  g103(.a(x34), .b(x27), .c(new_n155_), .d(x19), .O(new_n156_));
  aoi21  g104(.a(new_n154_), .b(x19), .c(new_n156_), .O(z13));
  oai21  g105(.a(new_n108_), .b(new_n54_), .c(new_n109_), .O(new_n158_));
  nand2  g106(.a(x35), .b(x18), .O(new_n159_));
  inv1   g107(.a(x13), .O(new_n160_));
  nand2  g108(.a(new_n60_), .b(new_n160_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n71_), .O(new_n162_));
