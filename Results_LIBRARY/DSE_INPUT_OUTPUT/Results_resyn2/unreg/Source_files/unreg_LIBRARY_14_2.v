...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x23), .O(new_n63_));
  ...
  oai21  g021(.a(new_n62_), .b(x18), .c(x23), .O(new_n74_));
  ...
  aoi21  g029(.a(x32), .b(x19), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g034(.a(new_n86_), .b(new_n84_), .c(new_n68_), .O(new_n87_));
  ...
  oai21  g092(.a(x23), .b(new_n54_), .c(new_n62_), .O(new_n145_));
  ...
  nand3  g118(.a(new_n170_), .b(new_n168_), .c(new_n63_), .O(z15));
endmodule
