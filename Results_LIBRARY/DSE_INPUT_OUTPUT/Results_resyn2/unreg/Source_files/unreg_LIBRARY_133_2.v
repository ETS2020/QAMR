...
module FAU ( 
  ...
  nand4  g090(.a(new_n142_), .b(new_n140_), .c(x19), .d(new_n68_), .O(new_n143_));
  aoi21  g091(.a(new_n143_), .b(new_n139_), .c(new_n65_), .O(z11));
  oai21  g092(.a(x20), .b(new_n54_), .c(new_n60_), .O(new_n145_));
  ...
  nand2  g117(.a(new_n169_), .b(new_n54_), .O(new_n170_));
  nand3  g118(.a(new_n170_), .b(new_n168_), .c(new_n61_), .O(z15));
endmodule
