...
module FAU ( 
  ...
  aoi21  g054(.a(new_n61_), .b(new_n54_), .c(new_n63_), .O(new_n107_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n68_), .O(new_n153_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n68_), .O(new_n167_));
