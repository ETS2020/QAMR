...
module FAU ( 
  ...
  nand2  g041(.a(x25), .b(x12), .O(new_n94_));
  ...
  nand2  g048(.a(x26), .b(x12), .O(new_n101_));
  ...
  nand2  g062(.a(x28), .b(x12), .O(new_n115_));
  ...
  nand2  g076(.a(x30), .b(x12), .O(new_n129_));
  ...
  nand2  g090(.a(x32), .b(x12), .O(new_n143_));
  ...
  nand2  g098(.a(new_n65_), .b(new_n150_), .O(new_n151_));
  ...
  nand2  g114(.a(new_n59_), .b(new_n64_), .O(new_n167_));
  nand4  g115(.a(new_n167_), .b(new_n166_), .c(x19), .d(new_n56_), .O(new_n168_));
