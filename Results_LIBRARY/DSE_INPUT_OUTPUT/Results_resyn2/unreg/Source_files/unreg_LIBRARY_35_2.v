...
module FAU ( 
  ...
  nand3  g44(.a(x19), .b(new_n54_), .c(x04), .O(new_n97_));
  nand2  g45(.a(new_n61_), .b(x18), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  inv1   g48(.a(x27), .O(new_n101_));
  oai21  g49(.a(new_n101_), .b(x18), .c(new_n60_), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n100_), .O(z07));
  nand2  g51(.a(x29), .b(x18), .O(new_n104_));
  inv1   g52(.a(x11), .O(new_n105_));
  nand2  g53(.a(new_n54_), .b(new_n105_), .O(new_n106_));
  nand3  g54(.a(new_n106_), .b(new_n104_), .c(new_n66_), .O(new_n107_));
  oai21  g55(.a(new_n64_), .b(x28), .c(new_n107_), .O(z08));
  nand2  g56(.a(x30), .b(x18), .O(new_n109_));
  inv1   g57(.a(x10), .O(new_n110_));
  nand2  g58(.a(new_n54_), .b(new_n110_), .O(new_n111_));
  nand3  g59(.a(new_n111_), .b(new_n109_), .c(new_n66_), .O(new_n112_));
  oai21  g60(.a(new_n64_), .b(x29), .c(new_n112_), .O(z09));
  nand2  g61(.a(x31), .b(x18), .O(new_n114_));
  inv1   g62(.a(x09), .O(new_n115_));
  nand2  g63(.a(new_n54_), .b(new_n115_), .O(new_n116_));
  nand3  g64(.a(new_n116_), .b(new_n114_), .c(new_n66_), .O(new_n117_));
  oai21  g65(.a(new_n64_), .b(x30), .c(new_n117_), .O(z10));
  nand3  g66(.a(x19), .b(new_n54_), .c(x08), .O(new_n119_));
  inv1   g67(.a(x24), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(x18), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  inv1   g71(.a(x31), .O(new_n124_));
  oai21  g72(.a(new_n124_), .b(x18), .c(new_n60_), .O(new_n125_));
  nand2  g73(.a(new_n125_), .b(new_n123_), .O(z11));
  nand3  g74(.a(x19), .b(new_n54_), .c(x15), .O(new_n127_));
  ...
  oai21  g80(.a(new_n132_), .b(x18), .c(new_n60_), .O(new_n133_));
  ...
  nand2  g92(.a(x28), .b(x18), .O(new_n145_));
  inv1   g93(.a(x12), .O(new_n146_));
  nand2  g94(.a(new_n54_), .b(new_n146_), .O(new_n147_));
  nand3  g95(.a(new_n147_), .b(new_n145_), .c(new_n66_), .O(new_n148_));
  oai21  g96(.a(new_n64_), .b(x35), .c(new_n148_), .O(z15));
endmodule
