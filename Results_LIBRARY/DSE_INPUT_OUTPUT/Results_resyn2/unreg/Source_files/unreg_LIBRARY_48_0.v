...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x25), .O(new_n61_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n66_), .O(new_n126_));
  ...
  oai21  g090(.a(new_n93_), .b(new_n54_), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n66_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n61_), .O(z13));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n66_), .O(new_n161_));
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n61_), .O(z14));
