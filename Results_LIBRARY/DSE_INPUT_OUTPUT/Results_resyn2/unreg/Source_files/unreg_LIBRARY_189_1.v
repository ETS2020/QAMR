...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x31), .O(new_n62_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n67_), .O(new_n133_));
  inv1   g081(.a(x30), .O(new_n134_));
  oai22  g082(.a(new_n61_), .b(x31), .c(new_n134_), .d(x19), .O(new_n135_));
  aoi21  g083(.a(new_n133_), .b(x19), .c(new_n135_), .O(z10));
  inv1   g084(.a(x31), .O(new_n137_));
  oai21  g085(.a(x32), .b(new_n54_), .c(new_n137_), .O(new_n138_));
  ...
  aoi21  g091(.a(x31), .b(x19), .c(new_n61_), .O(new_n144_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n67_), .O(new_n167_));
