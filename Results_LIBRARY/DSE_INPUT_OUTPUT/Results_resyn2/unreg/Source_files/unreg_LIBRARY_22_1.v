...
module FAU ( 
  ...
  nor2   g010(.a(new_n62_), .b(x26), .O(new_n63_));
  ...
  nand4  g039(.a(x19), .b(new_n57_), .c(new_n87_), .d(x07), .O(new_n92_));
  nand3  g040(.a(new_n92_), .b(new_n91_), .c(new_n89_), .O(new_n93_));
  and2   g041(.a(new_n93_), .b(new_n64_), .O(z04));
  ...
  nand4  g045(.a(x19), .b(new_n57_), .c(new_n87_), .d(x06), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  and2   g047(.a(new_n99_), .b(new_n64_), .O(z05));
  oai21  g048(.a(x34), .b(new_n54_), .c(new_n95_), .O(new_n101_));
  ...
  aoi21  g067(.a(new_n119_), .b(new_n115_), .c(new_n63_), .O(z08));
  ...
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n63_), .O(z09));
  ...
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n64_), .O(z10));
  ...
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n63_), .O(z12));
  ...
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n64_), .O(z13));
  aoi21  g103(.a(x26), .b(x19), .c(new_n62_), .O(new_n156_));
  ...
  aoi21  g113(.a(new_n165_), .b(new_n161_), .c(new_n63_), .O(z15));
endmodule
