...
module FAU ( 
  ...
  inv1   g030(.a(x26), .O(new_n83_));
  nor2   g031(.a(x34), .b(new_n83_), .O(new_n84_));
  ...
  oai21  g042(.a(new_n62_), .b(x18), .c(x26), .O(new_n95_));
  ...
  nand2  g053(.a(new_n83_), .b(new_n54_), .O(new_n106_));
  nand3  g054(.a(new_n106_), .b(new_n105_), .c(new_n63_), .O(z06));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n84_), .O(z07));
  ...
  aoi21  g068(.a(new_n120_), .b(new_n116_), .c(new_n84_), .O(z08));
  ...
  nand4  g095(.a(x19), .b(new_n57_), .c(new_n143_), .d(x15), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n147_), .c(new_n145_), .O(new_n149_));
  and2   g097(.a(new_n149_), .b(new_n63_), .O(z12));
  nand4  g098(.a(new_n62_), .b(x19), .c(x18), .d(new_n143_), .O(new_n151_));
  nand2  g099(.a(new_n144_), .b(new_n54_), .O(new_n152_));
  nand4  g100(.a(x19), .b(new_n57_), .c(new_n143_), .d(x14), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  and2   g102(.a(new_n154_), .b(new_n63_), .O(z13));
  nand2  g103(.a(new_n63_), .b(new_n55_), .O(new_n156_));
  nand2  g104(.a(x35), .b(x18), .O(new_n157_));
  oai21  g105(.a(x18), .b(x13), .c(new_n157_), .O(new_n158_));
  oai22  g106(.a(new_n158_), .b(new_n156_), .c(new_n106_), .d(x34), .O(z14));
