// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:42 2020
...
module FAU ( 
  ...
  nand2  g010(.a(x28), .b(new_n62_), .O(new_n63_));
  ...
  oai21  g036(.a(x28), .b(new_n54_), .c(new_n62_), .O(new_n89_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n68_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n65_), .O(z07));
  inv1   g063(.a(x28), .O(new_n116_));
  aoi21  g064(.a(x24), .b(x19), .c(new_n116_), .O(new_n117_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n68_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n65_), .O(z09));
  ...
  nand3  g085(.a(new_n137_), .b(new_n135_), .c(new_n68_), .O(new_n138_));
  nand2  g086(.a(x31), .b(new_n54_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n63_), .O(new_n140_));
  aoi21  g088(.a(new_n138_), .b(x19), .c(new_n140_), .O(z11));
  ...
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n63_), .O(z12));
  ...
  oai21  g110(.a(new_n62_), .b(x18), .c(x28), .O(new_n163_));
  ...
  nand2  g115(.a(new_n167_), .b(new_n63_), .O(new_n168_));
