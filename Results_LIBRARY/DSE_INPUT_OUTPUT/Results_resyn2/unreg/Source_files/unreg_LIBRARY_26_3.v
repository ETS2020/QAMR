...
module FAU ( 
  ...
  nand2  g17(.a(x25), .b(x18), .O(new_n70_));
  inv1   g18(.a(x07), .O(new_n71_));
  aoi21  g19(.a(new_n64_), .b(new_n71_), .c(x17), .O(new_n72_));
  aoi21  g20(.a(new_n72_), .b(new_n70_), .c(x11), .O(new_n73_));
  inv1   g21(.a(x24), .O(new_n74_));
  nand2  g22(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  oai21  g23(.a(new_n73_), .b(new_n69_), .c(new_n75_), .O(z04));
  nand2  g24(.a(x26), .b(x18), .O(new_n77_));
  inv1   g25(.a(x06), .O(new_n78_));
  aoi21  g26(.a(new_n64_), .b(new_n78_), .c(x17), .O(new_n79_));
  aoi21  g27(.a(new_n79_), .b(new_n77_), .c(x11), .O(new_n80_));
  inv1   g28(.a(x25), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n69_), .O(new_n82_));
  oai21  g30(.a(new_n80_), .b(new_n69_), .c(new_n82_), .O(z05));
  nand2  g31(.a(x27), .b(x18), .O(new_n84_));
  inv1   g32(.a(x05), .O(new_n85_));
  aoi21  g33(.a(new_n64_), .b(new_n85_), .c(x17), .O(new_n86_));
  aoi21  g34(.a(new_n86_), .b(new_n84_), .c(x11), .O(new_n87_));
  inv1   g35(.a(x26), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n69_), .O(new_n89_));
  oai21  g37(.a(new_n87_), .b(new_n69_), .c(new_n89_), .O(z06));
  ...
  nand2  g42(.a(new_n94_), .b(x18), .O(new_n95_));
  oai22  g43(.a(new_n95_), .b(new_n54_), .c(x28), .d(x19), .O(z08));
  nand2  g44(.a(x30), .b(x18), .O(new_n97_));
  oai21  g45(.a(x18), .b(x10), .c(new_n97_), .O(new_n98_));
  oai22  g46(.a(new_n98_), .b(new_n54_), .c(x29), .d(x19), .O(z09));
  nand2  g47(.a(x31), .b(x18), .O(new_n100_));
  inv1   g48(.a(x09), .O(new_n101_));
  aoi21  g49(.a(new_n64_), .b(new_n101_), .c(x17), .O(new_n102_));
  aoi21  g50(.a(new_n102_), .b(new_n100_), .c(x11), .O(new_n103_));
  inv1   g51(.a(x30), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n69_), .O(new_n105_));
  oai21  g53(.a(new_n103_), .b(new_n69_), .c(new_n105_), .O(z10));
  nand2  g54(.a(x24), .b(x18), .O(new_n107_));
  inv1   g55(.a(x08), .O(new_n108_));
  aoi21  g56(.a(new_n64_), .b(new_n108_), .c(x17), .O(new_n109_));
  aoi21  g57(.a(new_n109_), .b(new_n107_), .c(x11), .O(new_n110_));
  inv1   g58(.a(x31), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n69_), .O(new_n112_));
  oai21  g60(.a(new_n110_), .b(new_n69_), .c(new_n112_), .O(z11));
  nand2  g61(.a(x33), .b(x18), .O(new_n114_));
  inv1   g62(.a(x15), .O(new_n115_));
  aoi21  g63(.a(new_n64_), .b(new_n115_), .c(x17), .O(new_n116_));
  aoi21  g64(.a(new_n116_), .b(new_n114_), .c(x11), .O(new_n117_));
  inv1   g65(.a(x32), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n69_), .O(new_n119_));
  oai21  g67(.a(new_n117_), .b(new_n69_), .c(new_n119_), .O(z12));
  ...
  aoi21  g74(.a(new_n126_), .b(new_n124_), .c(x11), .O(new_n127_));
  inv1   g75(.a(x34), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n69_), .O(new_n129_));
  oai21  g77(.a(new_n127_), .b(new_n69_), .c(new_n129_), .O(z14));
