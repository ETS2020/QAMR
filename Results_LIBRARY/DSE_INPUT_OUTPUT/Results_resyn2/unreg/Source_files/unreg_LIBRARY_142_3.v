...
module FAU ( 
  ...
  nand2  g008(.a(x28), .b(x22), .O(new_n61_));
  ...
  oai21  g012(.a(x28), .b(x18), .c(x22), .O(new_n65_));
  ...
  aoi21  g062(.a(new_n72_), .b(x19), .c(new_n73_), .O(new_n115_));
  ...
  aoi21  g071(.a(new_n123_), .b(new_n54_), .c(new_n62_), .O(new_n124_));
  ...
  aoi21  g078(.a(new_n130_), .b(new_n54_), .c(new_n62_), .O(new_n131_));
  ...
  nand4  g085(.a(new_n137_), .b(new_n135_), .c(x19), .d(new_n80_), .O(new_n138_));
  ...
  aoi21  g092(.a(new_n144_), .b(new_n54_), .c(new_n62_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n151_), .b(new_n149_), .c(x19), .d(new_n80_), .O(new_n152_));
  ...
  aoi21  g106(.a(new_n158_), .b(new_n54_), .c(new_n62_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n157_), .O(z14));
  oai21  g108(.a(x22), .b(x18), .c(x28), .O(new_n161_));
