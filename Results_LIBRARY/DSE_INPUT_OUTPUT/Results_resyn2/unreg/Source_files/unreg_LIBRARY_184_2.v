...
module FAU ( 
  ...
  oai21  g050(.a(new_n53_), .b(x18), .c(x27), .O(new_n103_));
  ...
  nand3  g092(.a(new_n53_), .b(new_n114_), .c(new_n56_), .O(new_n145_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n73_), .O(new_n160_));
