...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nand2  g000(.a(x32), .b(x28), .O(new_n53_));
  inv1   g001(.a(new_n53_), .O(new_n54_));
  ...
  nor2   g012(.a(new_n55_), .b(x17), .O(new_n65_));
  nand2  g013(.a(x22), .b(x18), .O(new_n66_));
  inv1   g014(.a(x02), .O(new_n67_));
  nand2  g015(.a(new_n61_), .b(new_n67_), .O(new_n68_));
  nand3  g016(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(new_n69_));
  inv1   g017(.a(x21), .O(new_n70_));
  aoi21  g018(.a(new_n70_), .b(new_n55_), .c(new_n54_), .O(new_n71_));
  nand2  g019(.a(new_n71_), .b(new_n69_), .O(z01));
  inv1   g020(.a(x22), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n55_), .O(new_n74_));
  nand2  g022(.a(x23), .b(x18), .O(new_n75_));
  inv1   g023(.a(x01), .O(new_n76_));
  nand2  g024(.a(new_n61_), .b(new_n76_), .O(new_n77_));
  nand4  g025(.a(new_n77_), .b(new_n75_), .c(x19), .d(new_n58_), .O(new_n78_));
  aoi21  g026(.a(new_n78_), .b(new_n74_), .c(new_n54_), .O(z02));
  ...
  nand3  g031(.a(new_n83_), .b(new_n81_), .c(new_n65_), .O(new_n84_));
  inv1   g032(.a(x23), .O(new_n85_));
  aoi21  g033(.a(new_n85_), .b(new_n55_), .c(new_n54_), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(new_n84_), .O(z03));
  nand2  g035(.a(x25), .b(x18), .O(new_n88_));
  inv1   g036(.a(x07), .O(new_n89_));
  nand2  g037(.a(new_n61_), .b(new_n89_), .O(new_n90_));
  nand3  g038(.a(new_n90_), .b(new_n88_), .c(new_n65_), .O(new_n91_));
  inv1   g039(.a(x24), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n55_), .c(new_n54_), .O(new_n93_));
  nand2  g041(.a(new_n93_), .b(new_n91_), .O(z04));
  nand2  g042(.a(x26), .b(x18), .O(new_n95_));
  inv1   g043(.a(x06), .O(new_n96_));
  nand2  g044(.a(new_n61_), .b(new_n96_), .O(new_n97_));
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n65_), .O(new_n98_));
  inv1   g046(.a(x25), .O(new_n99_));
  aoi21  g047(.a(new_n99_), .b(new_n55_), .c(new_n54_), .O(new_n100_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n65_), .O(new_n112_));
  inv1   g060(.a(x27), .O(new_n113_));
  aoi21  g061(.a(new_n113_), .b(new_n55_), .c(new_n54_), .O(new_n114_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n65_), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n55_), .c(new_n54_), .O(new_n121_));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n65_), .O(new_n126_));
  inv1   g074(.a(x29), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n55_), .c(new_n54_), .O(new_n128_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n65_), .O(new_n133_));
  inv1   g081(.a(x30), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n55_), .c(new_n54_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n133_), .O(z10));
  inv1   g084(.a(x31), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n55_), .O(new_n138_));
  nand2  g086(.a(x24), .b(x18), .O(new_n139_));
  inv1   g087(.a(x08), .O(new_n140_));
  nand2  g088(.a(new_n61_), .b(new_n140_), .O(new_n141_));
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n58_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n54_), .O(z11));
  nand2  g091(.a(x33), .b(x18), .O(new_n144_));
  inv1   g092(.a(x15), .O(new_n145_));
  nand2  g093(.a(new_n61_), .b(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n65_), .O(new_n147_));
  inv1   g095(.a(x32), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n55_), .c(new_n54_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n147_), .O(z12));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n61_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n65_), .O(new_n154_));
  inv1   g102(.a(x33), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n55_), .c(new_n54_), .O(new_n156_));
  ...
  nand2  g109(.a(new_n61_), .b(new_n161_), .O(new_n162_));
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n58_), .O(new_n163_));
  aoi21  g111(.a(new_n163_), .b(new_n159_), .c(new_n54_), .O(z14));
  oai21  g112(.a(x32), .b(x18), .c(x28), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n61_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n65_), .O(new_n168_));
  inv1   g116(.a(x35), .O(new_n169_));
  nand3  g117(.a(new_n53_), .b(new_n169_), .c(new_n55_), .O(new_n170_));
