...
module FAU ( 
  ...
  nand2  g024(.a(new_n60_), .b(new_n76_), .O(new_n77_));
  nand4  g025(.a(new_n77_), .b(new_n75_), .c(x19), .d(new_n74_), .O(new_n78_));
  aoi21  g026(.a(new_n78_), .b(new_n73_), .c(new_n69_), .O(z02));
  ...
  nand4  g039(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n74_), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n88_), .c(new_n69_), .O(z04));
  ...
  nand4  g046(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n74_), .O(new_n99_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n69_), .O(z07));
  ...
  nor2   g067(.a(new_n119_), .b(new_n69_), .O(new_n120_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n74_), .O(new_n141_));
  ...
  nor2   g101(.a(new_n153_), .b(new_n69_), .O(new_n154_));
