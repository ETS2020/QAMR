...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x33), .O(new_n54_));
  ...
  oai21  g092(.a(new_n53_), .b(x18), .c(x33), .O(new_n145_));
  ...
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n59_), .O(new_n157_));
  ...
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n66_), .O(new_n162_));
  inv1   g110(.a(x34), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n56_), .O(new_n164_));
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n54_), .O(z14));
  oai21  g113(.a(x33), .b(new_n56_), .c(new_n53_), .O(new_n166_));
  nand2  g114(.a(x28), .b(x18), .O(new_n167_));
  inv1   g115(.a(x12), .O(new_n168_));
  nand2  g116(.a(new_n62_), .b(new_n168_), .O(new_n169_));
  nand3  g117(.a(new_n169_), .b(new_n167_), .c(new_n66_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(new_n166_), .O(z15));
endmodule
