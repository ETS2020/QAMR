...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nand2  g000(.a(x31), .b(x28), .O(new_n53_));
  ...
  nor2   g041(.a(new_n55_), .b(x17), .O(new_n94_));
  ...
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n94_), .O(new_n105_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n94_), .O(new_n112_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n94_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n94_), .O(new_n126_));
  ...
  oai21  g077(.a(x28), .b(x18), .c(x31), .O(new_n130_));
  inv1   g078(.a(x09), .O(new_n131_));
  nand2  g079(.a(new_n61_), .b(new_n131_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n94_), .O(new_n133_));
  inv1   g081(.a(x30), .O(new_n134_));
  nand3  g082(.a(new_n53_), .b(new_n134_), .c(new_n55_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n133_), .O(z10));
  inv1   g084(.a(x31), .O(new_n137_));
  aoi21  g085(.a(new_n120_), .b(x19), .c(new_n137_), .O(new_n138_));
  ...
  nand2  g102(.a(new_n61_), .b(new_n154_), .O(new_n155_));
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n58_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n54_), .O(z13));
  ...
  oai21  g112(.a(x31), .b(x18), .c(x28), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n61_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n94_), .O(new_n168_));
