...
module FAU ( 
  ...
  aoi21  g068(.a(new_n53_), .b(new_n56_), .c(new_n55_), .O(new_n121_));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n66_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n66_), .O(new_n140_));
