...
module FAU ( 
  ...
  nor2   g034(.a(new_n55_), .b(x17), .O(new_n87_));
  ...
  aoi21  g056(.a(x32), .b(x19), .c(new_n53_), .O(new_n109_));
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n87_), .O(new_n125_));
  ...
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n87_), .O(new_n148_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n87_), .O(new_n153_));
