...
module FAU ( 
  ...
  aoi21  g045(.a(new_n97_), .b(new_n93_), .c(new_n53_), .O(z05));
  ...
  nand2  g061(.a(x32), .b(x19), .O(new_n114_));
  ...
  aoi21  g089(.a(x33), .b(x18), .c(x17), .O(new_n142_));
  oai21  g090(.a(x18), .b(x15), .c(new_n142_), .O(new_n143_));
  inv1   g091(.a(x32), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(x28), .O(new_n145_));
  aoi22  g093(.a(new_n145_), .b(new_n114_), .c(new_n143_), .d(x19), .O(z12));
  ...
  inv1   g101(.a(new_n53_), .O(new_n154_));
  inv1   g102(.a(x17), .O(new_n155_));
  inv1   g103(.a(x35), .O(new_n156_));
  nand4  g104(.a(new_n156_), .b(x19), .c(x18), .d(new_n155_), .O(new_n157_));
  inv1   g105(.a(x34), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n54_), .O(new_n159_));
  nand4  g107(.a(x19), .b(new_n60_), .c(new_n155_), .d(x13), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(new_n159_), .c(new_n157_), .O(new_n161_));
  and2   g109(.a(new_n161_), .b(new_n154_), .O(z14));
  nand4  g110(.a(new_n113_), .b(x19), .c(x18), .d(new_n155_), .O(new_n163_));
  nand2  g111(.a(new_n156_), .b(new_n54_), .O(new_n164_));
  nand4  g112(.a(x19), .b(new_n60_), .c(new_n155_), .d(x12), .O(new_n165_));
  nand3  g113(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(new_n166_));
  and2   g114(.a(new_n166_), .b(new_n154_), .O(z15));
endmodule
