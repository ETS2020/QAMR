...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x23), .O(new_n54_));
  ...
  oai22  g024(.a(new_n53_), .b(x23), .c(new_n76_), .d(x19), .O(new_n77_));
  aoi21  g025(.a(new_n75_), .b(x19), .c(new_n77_), .O(z02));
  inv1   g026(.a(x23), .O(new_n79_));
  oai21  g027(.a(x32), .b(new_n55_), .c(new_n79_), .O(new_n80_));
  nor2   g028(.a(new_n61_), .b(x16), .O(new_n81_));
  nor2   g029(.a(new_n55_), .b(x17), .O(new_n82_));
  inv1   g030(.a(x00), .O(new_n83_));
  nand2  g031(.a(new_n61_), .b(new_n83_), .O(new_n84_));
  nand2  g032(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  oai21  g033(.a(new_n85_), .b(new_n81_), .c(new_n80_), .O(z03));
  inv1   g034(.a(x24), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n55_), .O(new_n88_));
  nand2  g036(.a(x25), .b(x18), .O(new_n89_));
  inv1   g037(.a(x07), .O(new_n90_));
  nand2  g038(.a(new_n61_), .b(new_n90_), .O(new_n91_));
  nand4  g039(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n58_), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n88_), .c(new_n54_), .O(z04));
  ...
  nand4  g046(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n58_), .O(new_n99_));
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n82_), .O(new_n104_));
  ...
  nand3  g058(.a(new_n110_), .b(new_n108_), .c(new_n82_), .O(new_n111_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n82_), .O(new_n118_));
  ...
  nand2  g070(.a(new_n122_), .b(new_n55_), .O(new_n123_));
  nand2  g071(.a(x30), .b(x18), .O(new_n124_));
  inv1   g072(.a(x10), .O(new_n125_));
  nand2  g073(.a(new_n61_), .b(new_n125_), .O(new_n126_));
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n58_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n54_), .O(z09));
  nand2  g076(.a(x31), .b(x18), .O(new_n129_));
  inv1   g077(.a(x09), .O(new_n130_));
  nand2  g078(.a(new_n61_), .b(new_n130_), .O(new_n131_));
  nand3  g079(.a(new_n131_), .b(new_n129_), .c(new_n82_), .O(new_n132_));
  nor2   g080(.a(x30), .b(x19), .O(new_n133_));
  nor2   g081(.a(new_n133_), .b(new_n54_), .O(new_n134_));
  ...
  aoi21  g090(.a(x23), .b(x19), .c(new_n53_), .O(new_n143_));
  ...
  nand4  g113(.a(new_n165_), .b(new_n163_), .c(x19), .d(new_n58_), .O(new_n166_));
  aoi21  g114(.a(new_n166_), .b(new_n162_), .c(new_n54_), .O(z15));
endmodule
