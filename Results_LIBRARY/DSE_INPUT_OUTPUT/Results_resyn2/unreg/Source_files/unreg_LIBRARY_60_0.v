...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x31), .O(new_n53_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n64_), .O(new_n146_));
  ...
  oai21  g104(.a(new_n135_), .b(new_n54_), .c(new_n136_), .O(new_n157_));
  nand2  g105(.a(x35), .b(x18), .O(new_n158_));
  inv1   g106(.a(x13), .O(new_n159_));
  nand2  g107(.a(new_n60_), .b(new_n159_), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n64_), .O(new_n161_));
