...
module FAU ( 
  ...
  aoi21  g053(.a(new_n61_), .b(new_n54_), .c(new_n63_), .O(new_n106_));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n109_), .c(new_n63_), .O(z07));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n110_), .O(new_n128_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n110_), .O(new_n142_));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n110_), .O(new_n162_));
