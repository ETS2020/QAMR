...
module FAU ( 
  ...
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n80_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n80_), .O(new_n161_));
  ...
  nand2  g116(.a(new_n62_), .b(new_n168_), .O(new_n169_));
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n59_), .O(new_n170_));
  aoi21  g118(.a(new_n170_), .b(new_n166_), .c(new_n55_), .O(z15));
endmodule
