...
module FAU ( 
  ...
  nand2  g008(.a(x34), .b(x20), .O(new_n61_));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n88_), .c(new_n62_), .O(z04));
  ...
  oai21  g098(.a(x20), .b(x18), .c(x34), .O(new_n151_));
  ...
  aoi21  g117(.a(new_n169_), .b(new_n54_), .c(new_n62_), .O(new_n170_));
