...
module FAU ( 
  ...
  nor2   g016(.a(new_n61_), .b(new_n60_), .O(new_n69_));
  aoi21  g017(.a(new_n60_), .b(new_n54_), .c(new_n69_), .O(new_n70_));
  ...
  nor2   g068(.a(new_n120_), .b(new_n69_), .O(new_n121_));
  ...
  nor2   g082(.a(new_n134_), .b(new_n69_), .O(new_n135_));
  ...
  aoi21  g091(.a(new_n60_), .b(x19), .c(new_n61_), .O(new_n144_));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n149_), .c(new_n69_), .O(z13));
