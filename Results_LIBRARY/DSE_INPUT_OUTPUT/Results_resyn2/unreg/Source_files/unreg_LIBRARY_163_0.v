...
module FAU ( 
  ...
  inv1   g061(.a(new_n61_), .O(new_n114_));
  ...
  nand4  g067(.a(x19), .b(new_n57_), .c(new_n115_), .d(x11), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n119_), .c(new_n117_), .O(new_n121_));
  and2   g069(.a(new_n121_), .b(new_n114_), .O(z08));
  inv1   g070(.a(x30), .O(new_n123_));
  nand4  g071(.a(new_n123_), .b(x19), .c(x18), .d(new_n115_), .O(new_n124_));
  nand2  g072(.a(new_n116_), .b(new_n54_), .O(new_n125_));
  nand4  g073(.a(x19), .b(new_n57_), .c(new_n115_), .d(x10), .O(new_n126_));
  nand3  g074(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  and2   g075(.a(new_n127_), .b(new_n114_), .O(z09));
  inv1   g076(.a(x34), .O(new_n129_));
  oai21  g077(.a(new_n129_), .b(new_n54_), .c(new_n123_), .O(new_n130_));
  ...
  nand2  g104(.a(new_n114_), .b(new_n55_), .O(new_n157_));
  nand2  g105(.a(x35), .b(x18), .O(new_n158_));
  oai21  g106(.a(x18), .b(x13), .c(new_n158_), .O(new_n159_));
  nand3  g107(.a(new_n129_), .b(x30), .c(new_n54_), .O(new_n160_));
  ...
  nand2  g112(.a(new_n164_), .b(new_n114_), .O(new_n165_));
