...
module FAU ( 
  ...
  aoi21  g049(.a(x35), .b(x19), .c(new_n53_), .O(new_n102_));
  ...
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n65_), .O(new_n123_));
  ...
  nand3  g077(.a(new_n129_), .b(new_n127_), .c(new_n65_), .O(new_n130_));
  ...
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n65_), .O(new_n144_));
  ...
  oai21  g110(.a(x26), .b(new_n55_), .c(new_n162_), .O(new_n163_));
