...
module FAU ( 
  ...
  nand4  g15(.a(new_n67_), .b(x19), .c(x18), .d(new_n66_), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(new_n65_), .O(z02));
  nand2  g17(.a(new_n67_), .b(new_n55_), .O(new_n70_));
  nand4  g18(.a(x19), .b(x18), .c(new_n66_), .d(x16), .O(new_n71_));
  ...
  nand4  g23(.a(new_n75_), .b(x19), .c(x18), .d(new_n66_), .O(new_n76_));
  ...
  nand4  g36(.a(new_n56_), .b(x19), .c(x18), .d(new_n66_), .O(new_n89_));
  ...
  nand2  g46(.a(new_n98_), .b(new_n55_), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n97_), .O(z09));
  inv1   g48(.a(x30), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n55_), .O(new_n102_));
  inv1   g50(.a(x31), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(x19), .c(x18), .d(new_n66_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n102_), .O(z10));
  oai21  g53(.a(x24), .b(x17), .c(x18), .O(new_n106_));
  ...
  oai21  g57(.a(x33), .b(x17), .c(x18), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(x19), .O(new_n111_));
  inv1   g59(.a(x32), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n55_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n111_), .O(z12));
  inv1   g62(.a(x33), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n55_), .O(new_n116_));
  inv1   g64(.a(x34), .O(new_n117_));
  nand4  g65(.a(new_n117_), .b(x19), .c(x18), .d(new_n66_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n116_), .O(z13));
  oai21  g67(.a(x35), .b(x17), .c(x18), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(x19), .O(new_n121_));
  nand2  g69(.a(new_n117_), .b(new_n55_), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n121_), .O(z14));
  inv1   g71(.a(x35), .O(new_n124_));
  nand2  g72(.a(new_n124_), .b(new_n55_), .O(new_n125_));
  nand4  g73(.a(new_n93_), .b(x19), .c(x18), .d(new_n66_), .O(new_n126_));
