...
module FAU ( 
  ...
  nand2  g000(.a(x32), .b(x14), .O(new_n53_));
  ...
  aoi21  g093(.a(x19), .b(new_n144_), .c(new_n145_), .O(new_n146_));
  aoi21  g094(.a(x33), .b(x18), .c(x17), .O(new_n147_));
  oai21  g095(.a(x18), .b(x15), .c(new_n147_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(x19), .c(new_n146_), .O(z12));
  aoi21  g097(.a(x34), .b(x18), .c(x17), .O(new_n150_));
  oai21  g098(.a(x18), .b(x14), .c(new_n150_), .O(new_n151_));
  inv1   g099(.a(x33), .O(new_n152_));
  oai21  g100(.a(new_n152_), .b(x19), .c(new_n53_), .O(new_n153_));
  aoi21  g101(.a(new_n151_), .b(x19), .c(new_n153_), .O(z13));
