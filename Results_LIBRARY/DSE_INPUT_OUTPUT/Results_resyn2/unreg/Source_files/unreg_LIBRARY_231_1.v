// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:09 2020
...
module FAU ( 
  ...
  nand2  g001(.a(x28), .b(new_n53_), .O(new_n54_));
  ...
  nand2  g034(.a(new_n86_), .b(new_n56_), .O(new_n87_));
  nand3  g035(.a(new_n87_), .b(new_n85_), .c(new_n54_), .O(z03));
  ...
  nor2   g043(.a(x28), .b(x26), .O(new_n96_));
  aoi21  g044(.a(x26), .b(new_n62_), .c(new_n96_), .O(new_n97_));
  inv1   g045(.a(x06), .O(new_n98_));
  nand2  g046(.a(new_n62_), .b(new_n98_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n66_), .O(new_n100_));
  nor2   g048(.a(x25), .b(x19), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n54_), .O(new_n102_));
  oai21  g050(.a(new_n100_), .b(new_n97_), .c(new_n102_), .O(z05));
  nand2  g051(.a(new_n96_), .b(new_n56_), .O(new_n104_));
  nand2  g052(.a(new_n66_), .b(new_n54_), .O(new_n105_));
  nand2  g053(.a(x27), .b(x18), .O(new_n106_));
  oai21  g054(.a(x18), .b(x05), .c(new_n106_), .O(new_n107_));
  oai21  g055(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(z06));
  nand2  g056(.a(x20), .b(x18), .O(new_n109_));
  oai21  g057(.a(x18), .b(x04), .c(new_n109_), .O(new_n110_));
  nor2   g058(.a(x27), .b(x19), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n54_), .O(new_n112_));
  oai21  g060(.a(new_n110_), .b(new_n105_), .c(new_n112_), .O(z07));
  inv1   g061(.a(x28), .O(new_n114_));
  aoi21  g062(.a(x26), .b(x19), .c(new_n114_), .O(new_n115_));
  aoi21  g063(.a(x29), .b(x18), .c(x17), .O(new_n116_));
  oai21  g064(.a(x18), .b(x11), .c(new_n116_), .O(new_n117_));
  aoi21  g065(.a(new_n117_), .b(x19), .c(new_n115_), .O(z08));
  ...
  nand4  g071(.a(new_n123_), .b(new_n121_), .c(x19), .d(new_n59_), .O(new_n124_));
  aoi21  g072(.a(new_n124_), .b(new_n120_), .c(new_n55_), .O(z09));
  ...
  nand4  g078(.a(new_n130_), .b(new_n128_), .c(x19), .d(new_n59_), .O(new_n131_));
  aoi21  g079(.a(new_n131_), .b(new_n127_), .c(new_n55_), .O(z10));
  ...
  nand4  g085(.a(new_n137_), .b(new_n135_), .c(x19), .d(new_n59_), .O(new_n138_));
  aoi21  g086(.a(new_n138_), .b(new_n134_), .c(new_n55_), .O(z11));
  nand2  g087(.a(x33), .b(x18), .O(new_n140_));
  inv1   g088(.a(x15), .O(new_n141_));
  nand2  g089(.a(new_n62_), .b(new_n141_), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n66_), .O(new_n143_));
  inv1   g091(.a(x32), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n56_), .O(new_n145_));
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n54_), .O(z12));
  ...
  nand2  g098(.a(new_n62_), .b(new_n150_), .O(new_n151_));
  nand4  g099(.a(new_n151_), .b(new_n149_), .c(x19), .d(new_n59_), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n148_), .c(new_n55_), .O(z13));
  ...
  oai21  g108(.a(new_n53_), .b(x18), .c(x28), .O(new_n161_));
  inv1   g109(.a(x12), .O(new_n162_));
  nand2  g110(.a(new_n62_), .b(new_n162_), .O(new_n163_));
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n66_), .O(new_n164_));
