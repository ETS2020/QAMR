...
module FAU ( 
  ...
  nor2   g012(.a(new_n56_), .b(x17), .O(new_n65_));
  ...
  oai21  g107(.a(x32), .b(x19), .c(x17), .O(new_n160_));
  nand2  g108(.a(x34), .b(new_n56_), .O(new_n161_));
  ...
  aoi21  g115(.a(new_n158_), .b(new_n56_), .c(new_n55_), .O(new_n168_));
