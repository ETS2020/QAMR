...
module FAU ( 
  ...
  nand2  g074(.a(new_n57_), .b(new_n61_), .O(new_n127_));
  nand4  g075(.a(new_n127_), .b(new_n126_), .c(x19), .d(new_n68_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n125_), .c(new_n63_), .O(z09));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n68_), .O(new_n160_));
  ...
  nor2   g114(.a(new_n166_), .b(new_n63_), .O(new_n167_));
