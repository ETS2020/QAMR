...
module FAU ( 
  ...
  nand2  g19(.a(new_n62_), .b(new_n71_), .O(new_n72_));
  oai21  g20(.a(new_n62_), .b(x16), .c(new_n72_), .O(new_n73_));
  oai22  g21(.a(new_n73_), .b(new_n54_), .c(x23), .d(x19), .O(z03));
  nand2  g22(.a(x25), .b(x18), .O(new_n75_));
  inv1   g23(.a(x07), .O(new_n76_));
  aoi21  g24(.a(new_n62_), .b(new_n76_), .c(x17), .O(new_n77_));
  aoi21  g25(.a(new_n77_), .b(new_n75_), .c(new_n59_), .O(new_n78_));
  inv1   g26(.a(x24), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(new_n58_), .O(new_n80_));
  oai21  g28(.a(new_n78_), .b(new_n58_), .c(new_n80_), .O(z04));
  ...
  aoi21  g41(.a(new_n62_), .b(new_n93_), .c(x17), .O(new_n94_));
  aoi21  g42(.a(new_n94_), .b(new_n92_), .c(new_n59_), .O(new_n95_));
  inv1   g43(.a(x27), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n58_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n58_), .c(new_n97_), .O(z07));
  inv1   g46(.a(x29), .O(new_n99_));
  ...
  nand2  g53(.a(new_n99_), .b(new_n58_), .O(new_n106_));
  oai21  g54(.a(new_n105_), .b(new_n58_), .c(new_n106_), .O(z09));
  ...
  oai21  g77(.a(new_n127_), .b(new_n58_), .c(new_n129_), .O(z14));
