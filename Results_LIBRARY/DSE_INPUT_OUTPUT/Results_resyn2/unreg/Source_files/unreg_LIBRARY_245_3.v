...
module FAU ( 
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n94_), .O(new_n125_));
  inv1   g073(.a(x29), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n55_), .c(new_n54_), .O(new_n127_));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n94_), .O(new_n139_));
  inv1   g087(.a(x31), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n55_), .c(new_n54_), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n139_), .O(z11));
  aoi21  g090(.a(new_n116_), .b(x19), .c(new_n117_), .O(new_n143_));
  ...
  nand2  g103(.a(new_n61_), .b(new_n155_), .O(new_n156_));
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n94_), .O(new_n157_));
  inv1   g105(.a(x34), .O(new_n158_));
  aoi21  g106(.a(new_n158_), .b(new_n55_), .c(new_n54_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n157_), .O(z14));
  oai21  g108(.a(x32), .b(x18), .c(x28), .O(new_n161_));
  inv1   g109(.a(x12), .O(new_n162_));
  nand2  g110(.a(new_n61_), .b(new_n162_), .O(new_n163_));
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n94_), .O(new_n164_));
  inv1   g112(.a(x35), .O(new_n165_));
  nand3  g113(.a(new_n53_), .b(new_n165_), .c(new_n55_), .O(new_n166_));
