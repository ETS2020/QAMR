...
module FAU ( 
  ...
  nor2   g008(.a(x28), .b(x22), .O(new_n61_));
  ...
  nand3  g025(.a(x28), .b(new_n69_), .c(new_n54_), .O(new_n78_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n64_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n61_), .O(z04));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n64_), .O(new_n100_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n64_), .O(new_n114_));
  ...
  nand3  g065(.a(new_n70_), .b(x22), .c(new_n54_), .O(new_n118_));
  oai21  g066(.a(new_n117_), .b(new_n75_), .c(new_n118_), .O(z08));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n64_), .O(new_n139_));
  ...
  nor2   g093(.a(new_n145_), .b(new_n61_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n150_), .c(x19), .d(new_n64_), .O(new_n153_));
  ...
  nand2  g114(.a(new_n166_), .b(new_n71_), .O(new_n167_));
