...
module FAU ( 
  ...
  nand2  g010(.a(x27), .b(new_n62_), .O(new_n63_));
  ...
  nand2  g017(.a(x21), .b(new_n54_), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  aoi21  g019(.a(new_n69_), .b(x19), .c(new_n71_), .O(z01));
  inv1   g020(.a(x27), .O(new_n73_));
  nand3  g021(.a(new_n73_), .b(new_n62_), .c(new_n54_), .O(new_n74_));
  nand2  g022(.a(new_n63_), .b(new_n55_), .O(new_n75_));
  nand2  g023(.a(x23), .b(x18), .O(new_n76_));
  oai21  g024(.a(x18), .b(x01), .c(new_n76_), .O(new_n77_));
  oai21  g025(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(z02));
  ...
  oai21  g033(.a(new_n83_), .b(new_n75_), .c(new_n85_), .O(z03));
  ...
  nand2  g055(.a(new_n73_), .b(new_n54_), .O(new_n108_));
  ...
  nand3  g060(.a(new_n112_), .b(new_n108_), .c(new_n63_), .O(z07));
  ...
  inv1   g089(.a(new_n63_), .O(new_n142_));
  ...
  nand4  g095(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n65_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n144_), .c(new_n142_), .O(z12));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n65_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n142_), .O(z15));
endmodule
