// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:55 2020
...
module FAU ( 
  ...
  nand2  g032(.a(new_n60_), .b(new_n84_), .O(new_n85_));
  nand4  g033(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n67_), .O(new_n86_));
  aoi21  g034(.a(new_n86_), .b(new_n81_), .c(new_n64_), .O(z03));
  ...
  aoi21  g041(.a(new_n93_), .b(new_n89_), .c(new_n64_), .O(z04));
  ...
  nand2  g046(.a(new_n60_), .b(new_n98_), .O(new_n99_));
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n67_), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n64_), .O(z05));
  ...
  nand2  g053(.a(new_n60_), .b(new_n105_), .O(new_n106_));
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n67_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n103_), .c(new_n64_), .O(z06));
  nand2  g056(.a(x20), .b(x18), .O(new_n109_));
  inv1   g057(.a(x04), .O(new_n110_));
  nand2  g058(.a(new_n60_), .b(new_n110_), .O(new_n111_));
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n58_), .O(new_n112_));
  nor2   g060(.a(x27), .b(x19), .O(new_n113_));
  nor2   g061(.a(new_n113_), .b(new_n64_), .O(new_n114_));
  ...
  nand2  g067(.a(new_n60_), .b(new_n119_), .O(new_n120_));
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n67_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n64_), .O(z08));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n67_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n64_), .O(z09));
  nand2  g077(.a(x31), .b(x18), .O(new_n130_));
  inv1   g078(.a(x09), .O(new_n131_));
  nand2  g079(.a(new_n60_), .b(new_n131_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n58_), .O(new_n133_));
  nor2   g081(.a(x30), .b(x19), .O(new_n134_));
  nor2   g082(.a(new_n134_), .b(new_n64_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n67_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n64_), .O(z11));
  oai21  g091(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n60_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n58_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n67_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n64_), .O(z13));
  ...
  nor2   g109(.a(new_n161_), .b(new_n64_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n67_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n64_), .O(z15));
endmodule
