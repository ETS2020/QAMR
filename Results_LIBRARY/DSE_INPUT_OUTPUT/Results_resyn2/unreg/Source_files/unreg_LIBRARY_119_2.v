...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(new_n60_), .O(new_n61_));
  inv1   g009(.a(new_n61_), .O(new_n62_));
  nand2  g010(.a(new_n60_), .b(new_n54_), .O(new_n63_));
  nand3  g011(.a(new_n63_), .b(new_n62_), .c(new_n59_), .O(z00));
  ...
  nand3  g018(.a(new_n70_), .b(new_n68_), .c(new_n62_), .O(z01));
  ...
  nand3  g025(.a(new_n77_), .b(new_n75_), .c(new_n62_), .O(z02));
  ...
  aoi21  g046(.a(new_n98_), .b(new_n94_), .c(new_n61_), .O(z05));
  ...
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n62_), .O(z06));
  ...
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n62_), .O(z07));
  ...
  nand2  g065(.a(new_n57_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n55_), .O(new_n119_));
  aoi21  g067(.a(new_n119_), .b(new_n115_), .c(new_n61_), .O(z08));
  ...
  nand2  g072(.a(new_n57_), .b(new_n124_), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n55_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n61_), .O(z09));
  ...
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n62_), .O(z10));
  ...
  nand3  g088(.a(new_n140_), .b(new_n138_), .c(new_n62_), .O(z11));
  inv1   g089(.a(x17), .O(new_n142_));
  inv1   g090(.a(x33), .O(new_n143_));
  nand4  g091(.a(new_n143_), .b(x19), .c(x18), .d(new_n142_), .O(new_n144_));
  inv1   g092(.a(x32), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n54_), .O(new_n146_));
  nand4  g094(.a(x19), .b(new_n57_), .c(new_n142_), .d(x15), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n146_), .c(new_n144_), .O(new_n148_));
  and2   g096(.a(new_n148_), .b(new_n62_), .O(z12));
  inv1   g097(.a(x34), .O(new_n150_));
  nand4  g098(.a(new_n150_), .b(x19), .c(x18), .d(new_n142_), .O(new_n151_));
  nand2  g099(.a(new_n143_), .b(new_n54_), .O(new_n152_));
  nand4  g100(.a(x19), .b(new_n57_), .c(new_n142_), .d(x14), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  and2   g102(.a(new_n154_), .b(new_n62_), .O(z13));
  oai21  g103(.a(x20), .b(new_n54_), .c(new_n150_), .O(new_n156_));
  ...
  nand2  g111(.a(new_n57_), .b(new_n163_), .O(new_n164_));
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n55_), .O(new_n165_));
  inv1   g113(.a(x35), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n54_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n62_), .O(z15));
endmodule
