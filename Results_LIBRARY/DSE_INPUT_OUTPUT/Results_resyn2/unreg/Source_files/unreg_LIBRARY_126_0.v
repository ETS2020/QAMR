...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x09), .O(new_n61_));
  ...
  inv1   g088(.a(new_n61_), .O(new_n141_));
  ...
  and2   g096(.a(new_n148_), .b(new_n141_), .O(z12));
  ...
  and2   g102(.a(new_n154_), .b(new_n141_), .O(z13));
  oai21  g103(.a(new_n54_), .b(new_n128_), .c(new_n150_), .O(new_n156_));
