...
module FAU ( 
  ...
  nand2  g079(.a(new_n64_), .b(new_n131_), .O(new_n132_));
  ...
  nand3  g093(.a(new_n130_), .b(x30), .c(new_n54_), .O(new_n146_));
  oai21  g094(.a(new_n145_), .b(new_n132_), .c(new_n146_), .O(z12));
  nand2  g095(.a(x34), .b(x18), .O(new_n148_));
  oai21  g096(.a(x18), .b(x14), .c(new_n148_), .O(new_n149_));
  nor2   g097(.a(x33), .b(x19), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n131_), .O(new_n151_));
  oai21  g099(.a(new_n149_), .b(new_n132_), .c(new_n151_), .O(z13));
