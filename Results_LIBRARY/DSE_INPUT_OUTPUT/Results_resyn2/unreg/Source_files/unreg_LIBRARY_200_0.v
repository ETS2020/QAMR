...
module FAU ( 
  ...
  nor2   g000(.a(x31), .b(x28), .O(new_n53_));
  ...
  nand3  g067(.a(new_n119_), .b(new_n117_), .c(new_n58_), .O(new_n120_));
  ...
  nand3  g076(.a(new_n115_), .b(x28), .c(x18), .O(new_n129_));
  nand2  g077(.a(new_n60_), .b(x09), .O(new_n130_));
  oai21  g078(.a(new_n130_), .b(new_n53_), .c(new_n129_), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(new_n58_), .O(new_n132_));
  inv1   g080(.a(new_n53_), .O(new_n133_));
  nor2   g081(.a(x30), .b(x19), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n132_), .O(z10));
  nand3  g084(.a(new_n115_), .b(x28), .c(new_n54_), .O(new_n137_));
  nand2  g085(.a(new_n58_), .b(new_n133_), .O(new_n138_));
  nand2  g086(.a(x24), .b(x18), .O(new_n139_));
  oai21  g087(.a(x18), .b(x08), .c(new_n139_), .O(new_n140_));
  oai21  g088(.a(new_n140_), .b(new_n138_), .c(new_n137_), .O(z11));
  ...
  nand4  g104(.a(x19), .b(new_n60_), .c(new_n156_), .d(x13), .O(new_n157_));
  inv1   g105(.a(x35), .O(new_n158_));
  nand4  g106(.a(new_n158_), .b(x19), .c(x18), .d(new_n156_), .O(new_n159_));
  inv1   g107(.a(x34), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n54_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n157_), .O(new_n162_));
  and2   g110(.a(new_n162_), .b(new_n133_), .O(z14));
  nand4  g111(.a(x19), .b(new_n60_), .c(new_n156_), .d(x12), .O(new_n164_));
  nand4  g112(.a(new_n114_), .b(x19), .c(x18), .d(new_n156_), .O(new_n165_));
  nand2  g113(.a(new_n158_), .b(new_n54_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  and2   g115(.a(new_n167_), .b(new_n133_), .O(z15));
endmodule
