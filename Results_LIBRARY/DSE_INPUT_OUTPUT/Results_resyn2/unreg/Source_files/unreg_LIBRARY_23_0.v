...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x32), .O(new_n61_));
  ...
  nand4  g045(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n73_), .O(new_n98_));
  ...
  nand4  g066(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n73_), .O(new_n119_));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n73_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n73_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n61_), .O(z12));
  ...
  oai21  g104(.a(new_n142_), .b(new_n54_), .c(new_n156_), .O(new_n157_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n73_), .O(new_n168_));
