...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x34), .O(new_n62_));
  ...
  oai21  g106(.a(new_n158_), .b(x18), .c(x35), .O(new_n159_));
  ...
  nand3  g110(.a(new_n61_), .b(new_n158_), .c(new_n54_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n162_), .O(z14));
  aoi21  g112(.a(x34), .b(x19), .c(new_n61_), .O(new_n165_));
