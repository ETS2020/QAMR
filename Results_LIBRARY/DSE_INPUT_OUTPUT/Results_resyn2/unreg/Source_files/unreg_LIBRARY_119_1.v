// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:16 2020
...
module FAU ( 
  ...
  oai21  g002(.a(x34), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g016(.a(x34), .b(new_n54_), .O(new_n69_));
  nand3  g017(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(z01));
  nand2  g018(.a(x23), .b(x18), .O(new_n71_));
  inv1   g019(.a(x01), .O(new_n72_));
  nand2  g020(.a(new_n59_), .b(new_n72_), .O(new_n73_));
  nand3  g021(.a(new_n73_), .b(new_n71_), .c(new_n57_), .O(new_n74_));
  inv1   g022(.a(x22), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n53_), .O(new_n76_));
  nand3  g024(.a(new_n76_), .b(new_n74_), .c(new_n69_), .O(z02));
  ...
  nand3  g029(.a(new_n81_), .b(new_n79_), .c(new_n57_), .O(new_n82_));
  inv1   g030(.a(x23), .O(new_n83_));
  nand2  g031(.a(new_n83_), .b(new_n53_), .O(new_n84_));
  nand3  g032(.a(new_n84_), .b(new_n82_), .c(new_n69_), .O(z03));
  inv1   g033(.a(new_n69_), .O(new_n86_));
  inv1   g034(.a(x24), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n53_), .O(new_n88_));
  inv1   g036(.a(x17), .O(new_n89_));
  nand2  g037(.a(x25), .b(x18), .O(new_n90_));
  inv1   g038(.a(x07), .O(new_n91_));
  nand2  g039(.a(new_n59_), .b(new_n91_), .O(new_n92_));
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n89_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n88_), .c(new_n86_), .O(z04));
  ...
  nand2  g046(.a(new_n59_), .b(new_n98_), .O(new_n99_));
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n89_), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n86_), .O(z05));
  ...
  nand3  g055(.a(new_n107_), .b(new_n105_), .c(new_n69_), .O(z06));
  ...
  nand2  g061(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  nand3  g062(.a(new_n114_), .b(new_n112_), .c(new_n69_), .O(z07));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n89_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n86_), .O(z08));
  ...
  nand2  g074(.a(new_n59_), .b(new_n126_), .O(new_n127_));
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n89_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n86_), .O(z09));
  ...
  nand3  g083(.a(new_n135_), .b(new_n133_), .c(new_n69_), .O(z10));
  nand2  g084(.a(x24), .b(x18), .O(new_n137_));
  inv1   g085(.a(x08), .O(new_n138_));
  nand2  g086(.a(new_n59_), .b(new_n138_), .O(new_n139_));
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n57_), .O(new_n140_));
  inv1   g088(.a(x31), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n53_), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n69_), .O(z11));
  ...
  nand2  g095(.a(new_n59_), .b(new_n147_), .O(new_n148_));
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n89_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n86_), .O(z12));
  oai21  g098(.a(new_n54_), .b(x18), .c(x34), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n59_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n57_), .O(new_n154_));
  nor2   g102(.a(x33), .b(x19), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n69_), .O(new_n156_));
