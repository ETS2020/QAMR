...
module FAU ( 
  ...
  aoi21  g026(.a(new_n78_), .b(new_n74_), .c(new_n72_), .O(z02));
  ...
  aoi21  g034(.a(new_n86_), .b(new_n81_), .c(new_n72_), .O(z03));
  ...
  nand3  g041(.a(new_n93_), .b(new_n91_), .c(new_n61_), .O(z04));
  ...
  nand3  g048(.a(new_n100_), .b(new_n98_), .c(new_n61_), .O(z05));
  ...
  nand3  g055(.a(new_n107_), .b(new_n105_), .c(new_n61_), .O(z06));
  oai21  g056(.a(new_n60_), .b(x18), .c(x20), .O(new_n109_));
  ...
  and2   g070(.a(new_n122_), .b(new_n61_), .O(z08));
  nand4  g071(.a(new_n60_), .b(x19), .c(x18), .d(new_n116_), .O(new_n124_));
  nand2  g072(.a(new_n117_), .b(new_n54_), .O(new_n125_));
  nand4  g073(.a(x19), .b(new_n57_), .c(new_n116_), .d(x10), .O(new_n126_));
  nand3  g074(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  and2   g075(.a(new_n127_), .b(new_n61_), .O(z09));
  nand2  g076(.a(new_n61_), .b(new_n55_), .O(new_n129_));
  nand2  g077(.a(x31), .b(x18), .O(new_n130_));
  oai21  g078(.a(x18), .b(x09), .c(new_n130_), .O(new_n131_));
  oai22  g079(.a(new_n131_), .b(new_n129_), .c(new_n63_), .d(x30), .O(z10));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n61_), .O(z11));
  ...
  nand3  g093(.a(new_n145_), .b(new_n143_), .c(new_n61_), .O(z12));
  ...
  aoi21  g100(.a(new_n152_), .b(new_n148_), .c(new_n72_), .O(z13));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n61_), .O(z14));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n61_), .O(z15));
endmodule
