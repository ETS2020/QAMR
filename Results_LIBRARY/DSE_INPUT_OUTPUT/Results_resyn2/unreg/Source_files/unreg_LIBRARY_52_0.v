...
module FAU ( 
  ...
  inv1   g042(.a(x32), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n55_), .O(new_n97_));
  nand2  g045(.a(x26), .b(x18), .O(new_n98_));
  oai21  g046(.a(x18), .b(x06), .c(new_n98_), .O(new_n99_));
  nand3  g047(.a(x32), .b(new_n94_), .c(new_n54_), .O(new_n100_));
  oai21  g048(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(z05));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n73_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n61_), .O(z07));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n73_), .O(new_n142_));
  ...
  nand3  g093(.a(new_n95_), .b(x25), .c(new_n54_), .O(new_n146_));
  oai21  g094(.a(new_n145_), .b(new_n97_), .c(new_n146_), .O(z12));
  nand2  g095(.a(x34), .b(x18), .O(new_n148_));
  oai21  g096(.a(x18), .b(x14), .c(new_n148_), .O(new_n149_));
  nor2   g097(.a(x33), .b(x19), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n96_), .O(new_n151_));
  oai21  g099(.a(new_n149_), .b(new_n97_), .c(new_n151_), .O(z13));
  ...
  nand4  g105(.a(new_n157_), .b(new_n155_), .c(x19), .d(new_n73_), .O(new_n158_));
