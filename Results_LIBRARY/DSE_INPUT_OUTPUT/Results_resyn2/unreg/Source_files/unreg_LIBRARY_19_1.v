...
module FAU ( 
  ...
  nand2  g40(.a(new_n89_), .b(new_n59_), .O(new_n93_));
  oai21  g41(.a(new_n92_), .b(new_n59_), .c(new_n93_), .O(z11));
  inv1   g42(.a(x33), .O(new_n95_));
  aoi21  g43(.a(new_n95_), .b(new_n53_), .c(new_n65_), .O(new_n96_));
  inv1   g44(.a(x32), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n59_), .c(new_n98_), .O(z12));
  inv1   g47(.a(x34), .O(new_n100_));
  aoi21  g48(.a(new_n100_), .b(new_n53_), .c(new_n65_), .O(new_n101_));
  nand2  g49(.a(new_n95_), .b(new_n59_), .O(new_n102_));
  oai21  g50(.a(new_n101_), .b(new_n59_), .c(new_n102_), .O(z13));
  inv1   g51(.a(x35), .O(new_n104_));
  aoi21  g52(.a(new_n104_), .b(new_n53_), .c(new_n65_), .O(new_n105_));
  nand2  g53(.a(new_n100_), .b(new_n59_), .O(new_n106_));
  oai21  g54(.a(new_n105_), .b(new_n59_), .c(new_n106_), .O(z14));
  oai21  g55(.a(x28), .b(x17), .c(x18), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(x19), .O(new_n109_));
  nand2  g57(.a(new_n104_), .b(new_n59_), .O(new_n110_));
