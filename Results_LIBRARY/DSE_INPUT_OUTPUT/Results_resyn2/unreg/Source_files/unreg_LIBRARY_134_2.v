...
module FAU ( 
  ...
  aoi21  g093(.a(x34), .b(x19), .c(new_n145_), .O(new_n146_));
  ...
  nand2  g104(.a(new_n73_), .b(new_n54_), .O(new_n157_));
  nand2  g105(.a(x35), .b(x18), .O(new_n158_));
  oai21  g106(.a(x18), .b(x13), .c(new_n158_), .O(new_n159_));
  nand3  g107(.a(new_n53_), .b(new_n145_), .c(new_n56_), .O(new_n160_));
  oai21  g108(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(z14));
  ...
  oai21  g113(.a(new_n163_), .b(new_n157_), .c(new_n165_), .O(z15));
endmodule
