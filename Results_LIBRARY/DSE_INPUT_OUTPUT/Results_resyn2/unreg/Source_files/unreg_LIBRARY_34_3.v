...
module FAU ( 
  ...
  nand2  g008(.a(x28), .b(x26), .O(new_n61_));
  ...
  oai21  g041(.a(x28), .b(x18), .c(x26), .O(new_n94_));
  ...
  aoi21  g060(.a(new_n112_), .b(new_n54_), .c(new_n62_), .O(new_n113_));
  ...
  aoi21  g067(.a(new_n119_), .b(new_n54_), .c(new_n62_), .O(new_n120_));
  ...
  aoi21  g076(.a(new_n128_), .b(new_n123_), .c(new_n62_), .O(z09));
  ...
  oai21  g112(.a(x26), .b(x18), .c(x28), .O(new_n165_));
