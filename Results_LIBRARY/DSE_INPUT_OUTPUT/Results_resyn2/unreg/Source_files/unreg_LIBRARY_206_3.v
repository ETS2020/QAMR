...
module FAU ( 
  ...
  nand4  g19(.a(x19), .b(new_n67_), .c(new_n54_), .d(x06), .O(new_n72_));
  ...
  nand4  g25(.a(x19), .b(new_n67_), .c(new_n54_), .d(x04), .O(new_n78_));
  ...
  nand4  g31(.a(x19), .b(new_n67_), .c(new_n54_), .d(x10), .O(new_n84_));
  ...
  nand4  g37(.a(x19), .b(new_n67_), .c(new_n54_), .d(x08), .O(new_n90_));
  ...
  nand4  g43(.a(x19), .b(new_n67_), .c(new_n54_), .d(x14), .O(new_n96_));
  oai21  g44(.a(x33), .b(x19), .c(new_n96_), .O(z13));
  nand4  g45(.a(x19), .b(new_n67_), .c(new_n54_), .d(x13), .O(new_n98_));
