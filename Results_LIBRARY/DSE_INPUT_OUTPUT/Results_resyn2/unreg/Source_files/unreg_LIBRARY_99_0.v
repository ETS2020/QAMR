...
module FAU ( 
  ...
  nor2   g008(.a(x34), .b(x26), .O(new_n61_));
  ...
  inv1   g039(.a(new_n61_), .O(new_n92_));
  ...
  oai21  g045(.a(new_n95_), .b(new_n93_), .c(new_n97_), .O(z05));
  inv1   g046(.a(x34), .O(new_n99_));
  ...
  oai21  g052(.a(new_n100_), .b(x26), .c(new_n104_), .O(z06));
  ...
  nand4  g090(.a(new_n142_), .b(x19), .c(x18), .d(new_n141_), .O(new_n143_));
  inv1   g091(.a(x32), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n54_), .O(new_n145_));
  nand4  g093(.a(x19), .b(new_n57_), .c(new_n141_), .d(x15), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(new_n145_), .c(new_n143_), .O(new_n147_));
  and2   g095(.a(new_n147_), .b(new_n92_), .O(z12));
  nand4  g096(.a(new_n99_), .b(x19), .c(x18), .d(new_n141_), .O(new_n149_));
  nand2  g097(.a(new_n142_), .b(new_n54_), .O(new_n150_));
  nand4  g098(.a(x19), .b(new_n57_), .c(new_n141_), .d(x14), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  and2   g100(.a(new_n152_), .b(new_n92_), .O(z13));
  nand2  g101(.a(x35), .b(x18), .O(new_n154_));
  oai21  g102(.a(x18), .b(x13), .c(new_n154_), .O(new_n155_));
  nand3  g103(.a(new_n99_), .b(x26), .c(new_n54_), .O(new_n156_));
  oai21  g104(.a(new_n155_), .b(new_n93_), .c(new_n156_), .O(z14));
