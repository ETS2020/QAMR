...
module FAU ( 
  ...
  nand2  g008(.a(x35), .b(x33), .O(new_n61_));
  ...
  oai21  g091(.a(x35), .b(x18), .c(x33), .O(new_n144_));
  ...
  nand3  g096(.a(new_n61_), .b(new_n148_), .c(new_n54_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n147_), .O(z12));
  inv1   g098(.a(x33), .O(new_n151_));
  inv1   g099(.a(x35), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(x19), .c(new_n151_), .O(new_n153_));
  nand2  g101(.a(x34), .b(x18), .O(new_n154_));
  inv1   g102(.a(x14), .O(new_n155_));
  nand2  g103(.a(new_n57_), .b(new_n155_), .O(new_n156_));
  nand3  g104(.a(new_n156_), .b(new_n154_), .c(new_n67_), .O(new_n157_));
  aoi21  g105(.a(new_n157_), .b(x19), .c(new_n153_), .O(z13));
  ...
  aoi21  g111(.a(new_n163_), .b(new_n54_), .c(new_n62_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n162_), .O(z14));
  aoi21  g113(.a(new_n151_), .b(x19), .c(new_n152_), .O(new_n166_));
