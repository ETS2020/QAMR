...
module FAU ( 
  ...
  inv1   g008(.a(x23), .O(new_n61_));
  nor2   g009(.a(x27), .b(new_n61_), .O(new_n62_));
  ...
  aoi21  g031(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n84_));
  ...
  aoi21  g040(.a(new_n92_), .b(new_n87_), .c(new_n62_), .O(z04));
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n88_), .O(new_n104_));
  inv1   g052(.a(x26), .O(new_n105_));
  oai22  g053(.a(x27), .b(new_n61_), .c(new_n105_), .d(x19), .O(new_n106_));
  aoi21  g054(.a(new_n104_), .b(x19), .c(new_n106_), .O(z06));
  inv1   g055(.a(x27), .O(new_n108_));
  oai21  g056(.a(x23), .b(new_n54_), .c(new_n108_), .O(new_n109_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n88_), .O(new_n155_));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n88_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n88_), .O(new_n169_));
