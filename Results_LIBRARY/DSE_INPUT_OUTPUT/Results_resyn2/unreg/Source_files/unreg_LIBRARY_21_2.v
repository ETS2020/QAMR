...
module FAU ( 
  ...
  oai21  g46(.a(x18), .b(x10), .c(new_n98_), .O(new_n99_));
  oai22  g47(.a(new_n99_), .b(new_n64_), .c(x29), .d(x19), .O(z09));
  ...
  oai21  g61(.a(new_n111_), .b(new_n53_), .c(new_n113_), .O(z11));
  nor2   g62(.a(x18), .b(x15), .O(new_n115_));
  inv1   g63(.a(x33), .O(new_n116_));
  oai21  g64(.a(new_n116_), .b(new_n57_), .c(new_n63_), .O(new_n117_));
  oai21  g65(.a(new_n117_), .b(new_n115_), .c(x32), .O(z12));
  nand2  g66(.a(x34), .b(x18), .O(new_n119_));
  inv1   g67(.a(x14), .O(new_n120_));
  aoi21  g68(.a(new_n57_), .b(new_n120_), .c(x17), .O(new_n121_));
  aoi21  g69(.a(new_n121_), .b(new_n119_), .c(new_n54_), .O(new_n122_));
  nand2  g70(.a(new_n116_), .b(new_n53_), .O(new_n123_));
  oai21  g71(.a(new_n122_), .b(new_n53_), .c(new_n123_), .O(z13));
  nand2  g72(.a(x35), .b(x18), .O(new_n125_));
  oai21  g73(.a(x18), .b(x13), .c(new_n125_), .O(new_n126_));
  oai22  g74(.a(new_n126_), .b(new_n64_), .c(x34), .d(x19), .O(z14));
  nand2  g75(.a(x28), .b(x18), .O(new_n128_));
  oai21  g76(.a(x18), .b(x12), .c(new_n128_), .O(new_n129_));
  oai22  g77(.a(new_n129_), .b(new_n64_), .c(x35), .d(x19), .O(z15));
endmodule
