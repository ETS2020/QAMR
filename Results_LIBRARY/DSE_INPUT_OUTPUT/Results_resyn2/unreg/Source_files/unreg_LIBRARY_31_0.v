...
module FAU ( 
  ...
  nor2   g000(.a(x28), .b(x05), .O(new_n53_));
  ...
  aoi21  g061(.a(x29), .b(x18), .c(x17), .O(new_n114_));
  oai21  g062(.a(x18), .b(x11), .c(new_n114_), .O(new_n115_));
  inv1   g063(.a(x28), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  nand2  g065(.a(x28), .b(new_n54_), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g067(.a(new_n115_), .b(x19), .c(new_n119_), .O(z08));
