...
module FAU ( 
  ...
  nand2  g078(.a(new_n63_), .b(new_n55_), .O(new_n131_));
  nand2  g079(.a(x31), .b(x18), .O(new_n132_));
  oai21  g080(.a(x18), .b(x09), .c(new_n132_), .O(new_n133_));
  inv1   g081(.a(x32), .O(new_n134_));
  nand3  g082(.a(new_n134_), .b(new_n62_), .c(new_n54_), .O(new_n135_));
  oai21  g083(.a(new_n133_), .b(new_n131_), .c(new_n135_), .O(z10));
  ...
  oai21  g088(.a(new_n138_), .b(new_n131_), .c(new_n140_), .O(z11));
  aoi21  g089(.a(x30), .b(x19), .c(new_n134_), .O(new_n142_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n63_), .O(z13));
  ...
  aoi21  g106(.a(new_n158_), .b(new_n154_), .c(new_n65_), .O(z14));
