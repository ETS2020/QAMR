...
module FAU ( 
  ...
  nor2   g008(.a(x33), .b(x30), .O(new_n61_));
  ...
  nand3  g099(.a(new_n126_), .b(x30), .c(new_n54_), .O(new_n152_));
  nand2  g100(.a(new_n127_), .b(new_n55_), .O(new_n153_));
  nand2  g101(.a(x34), .b(x18), .O(new_n154_));
  oai21  g102(.a(x18), .b(x14), .c(new_n154_), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n153_), .c(new_n152_), .O(z13));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n73_), .O(new_n162_));
