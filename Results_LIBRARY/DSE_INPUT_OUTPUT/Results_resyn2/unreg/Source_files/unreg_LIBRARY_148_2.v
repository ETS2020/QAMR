...
module FAU ( 
  ...
  oai21  g090(.a(x30), .b(new_n56_), .c(new_n53_), .O(new_n143_));
  nand2  g091(.a(x33), .b(x18), .O(new_n144_));
  inv1   g092(.a(x15), .O(new_n145_));
  nand2  g093(.a(new_n62_), .b(new_n145_), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n73_), .O(new_n147_));
  ...
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n73_), .O(new_n166_));
