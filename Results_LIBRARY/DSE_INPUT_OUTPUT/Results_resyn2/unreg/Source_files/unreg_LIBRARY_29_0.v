...
module FAU ( 
  ...
  nand4  g060(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n73_), .O(new_n113_));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n73_), .O(new_n134_));
  ...
  nand2  g090(.a(new_n101_), .b(new_n54_), .O(new_n143_));
