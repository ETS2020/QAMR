...
module FAU ( 
  ...
  aoi21  g091(.a(x35), .b(x19), .c(new_n53_), .O(new_n144_));
  ...
  aoi21  g111(.a(x28), .b(x18), .c(x17), .O(new_n164_));
  oai21  g112(.a(x18), .b(x12), .c(new_n164_), .O(new_n165_));
  nor2   g113(.a(x35), .b(x32), .O(new_n166_));
  aoi21  g114(.a(x35), .b(x19), .c(new_n166_), .O(new_n167_));
