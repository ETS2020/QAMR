...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x23), .O(new_n54_));
  ...
  oai21  g021(.a(new_n53_), .b(x18), .c(x23), .O(new_n74_));
  ...
  nand3  g081(.a(new_n133_), .b(new_n131_), .c(new_n66_), .O(new_n134_));
  ...
  oai21  g092(.a(x23), .b(new_n56_), .c(new_n53_), .O(new_n145_));
  ...
  nand2  g099(.a(new_n151_), .b(new_n56_), .O(new_n152_));
  nand2  g100(.a(x34), .b(x18), .O(new_n153_));
  inv1   g101(.a(x14), .O(new_n154_));
  nand2  g102(.a(new_n62_), .b(new_n154_), .O(new_n155_));
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n59_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n55_), .O(z13));
  nand2  g105(.a(x35), .b(x18), .O(new_n158_));
  inv1   g106(.a(x13), .O(new_n159_));
  nand2  g107(.a(new_n62_), .b(new_n159_), .O(new_n160_));
  ...
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n54_), .O(z14));
