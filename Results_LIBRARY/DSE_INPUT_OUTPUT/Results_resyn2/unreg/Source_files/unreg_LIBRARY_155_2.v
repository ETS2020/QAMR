...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x14), .O(new_n63_));
  ...
  nand3  g089(.a(new_n62_), .b(new_n54_), .c(new_n141_), .O(new_n142_));
  ...
  aoi21  g096(.a(x34), .b(x18), .c(x17), .O(new_n149_));
  oai21  g097(.a(x18), .b(x14), .c(new_n149_), .O(new_n150_));
  nand2  g098(.a(x33), .b(new_n54_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n63_), .O(new_n152_));
  aoi21  g100(.a(new_n150_), .b(x19), .c(new_n152_), .O(z13));
  ...
  aoi21  g107(.a(new_n159_), .b(new_n155_), .c(new_n79_), .O(z14));
