...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n164_;
  nor2   g000(.a(x32), .b(x22), .O(new_n53_));
  ...
  nand3  g092(.a(new_n73_), .b(x22), .c(new_n54_), .O(new_n145_));
  oai21  g093(.a(new_n144_), .b(new_n75_), .c(new_n145_), .O(z12));
  nand2  g094(.a(x34), .b(x18), .O(new_n147_));
  oai21  g095(.a(x18), .b(x14), .c(new_n147_), .O(new_n148_));
  nor2   g096(.a(x33), .b(x19), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n74_), .O(new_n150_));
  oai21  g098(.a(new_n148_), .b(new_n75_), .c(new_n150_), .O(z13));
  ...
  nand4  g104(.a(new_n156_), .b(new_n154_), .c(x19), .d(new_n57_), .O(new_n157_));
  aoi21  g105(.a(new_n157_), .b(new_n153_), .c(new_n53_), .O(z14));
  nand2  g106(.a(x28), .b(x18), .O(new_n159_));
  inv1   g107(.a(x12), .O(new_n160_));
  nand2  g108(.a(new_n60_), .b(new_n160_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n64_), .O(new_n162_));
  nor2   g110(.a(x35), .b(x19), .O(new_n163_));
  nor2   g111(.a(new_n163_), .b(new_n53_), .O(new_n164_));
