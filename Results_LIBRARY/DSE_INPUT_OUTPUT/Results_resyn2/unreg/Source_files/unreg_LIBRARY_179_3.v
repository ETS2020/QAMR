...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x26), .O(new_n61_));
  ...
  oai21  g041(.a(x32), .b(x18), .c(x26), .O(new_n94_));
  ...
  aoi21  g050(.a(new_n102_), .b(x19), .c(new_n101_), .O(new_n103_));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n54_), .c(new_n62_), .O(new_n112_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n123_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n122_), .c(new_n62_), .O(z09));
  ...
  aoi21  g081(.a(new_n133_), .b(new_n54_), .c(new_n62_), .O(new_n134_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n123_), .O(new_n141_));
  ...
  aoi21  g094(.a(new_n102_), .b(new_n54_), .c(new_n62_), .O(new_n147_));
  ...
  nand4  g115(.a(new_n167_), .b(new_n165_), .c(x19), .d(new_n123_), .O(new_n168_));
