...
module FAU ( 
  ...
  nand3  g053(.a(new_n105_), .b(new_n103_), .c(new_n80_), .O(new_n106_));
  ...
  nand3  g092(.a(new_n53_), .b(new_n93_), .c(new_n56_), .O(new_n145_));
  nand2  g093(.a(new_n80_), .b(new_n54_), .O(new_n146_));
  ...
  nand2  g107(.a(new_n159_), .b(new_n56_), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n54_), .O(z14));
