...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x08), .O(new_n53_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n79_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n79_), .O(new_n124_));
  ...
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n79_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n136_), .b(x19), .c(new_n57_), .O(new_n137_));
  inv1   g085(.a(x31), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(new_n54_), .O(new_n139_));
  oai22  g087(.a(new_n139_), .b(new_n53_), .c(new_n137_), .d(new_n135_), .O(z11));
  ...
  nand3  g094(.a(new_n142_), .b(new_n54_), .c(x08), .O(new_n147_));
