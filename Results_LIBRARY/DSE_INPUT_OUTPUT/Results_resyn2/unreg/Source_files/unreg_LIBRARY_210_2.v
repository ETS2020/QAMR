...
module FAU ( 
  ...
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n108_), .O(new_n123_));
  ...
  nand3  g077(.a(new_n129_), .b(new_n127_), .c(new_n108_), .O(new_n130_));
  ...
  nand3  g084(.a(new_n136_), .b(new_n134_), .c(new_n108_), .O(new_n137_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n108_), .O(new_n151_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n108_), .O(new_n160_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n108_), .O(new_n165_));
