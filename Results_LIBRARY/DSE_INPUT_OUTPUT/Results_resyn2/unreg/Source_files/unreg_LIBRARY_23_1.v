...
module FAU ( 
  ...
  nand2  g010(.a(x34), .b(new_n62_), .O(new_n63_));
  ...
  aoi21  g049(.a(new_n101_), .b(new_n97_), .c(new_n72_), .O(z05));
  ...
  nand3  g093(.a(new_n145_), .b(new_n62_), .c(new_n54_), .O(new_n146_));
  nand2  g094(.a(new_n63_), .b(new_n55_), .O(new_n147_));
  nand2  g095(.a(x33), .b(x18), .O(new_n148_));
  oai21  g096(.a(x18), .b(x15), .c(new_n148_), .O(new_n149_));
  oai21  g097(.a(new_n149_), .b(new_n147_), .c(new_n146_), .O(z12));
  ...
  nand2  g105(.a(new_n145_), .b(new_n54_), .O(new_n158_));
  ...
  nand3  g110(.a(new_n162_), .b(new_n158_), .c(new_n63_), .O(z14));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n75_), .O(new_n169_));
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n72_), .O(z15));
endmodule
