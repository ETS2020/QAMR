...
module FAU ( 
  ...
  inv1   g057(.a(x32), .O(new_n110_));
  nand3  g058(.a(new_n110_), .b(new_n53_), .c(new_n56_), .O(new_n111_));
  nand2  g059(.a(new_n88_), .b(new_n54_), .O(new_n112_));
  nand2  g060(.a(x20), .b(x18), .O(new_n113_));
  oai21  g061(.a(x18), .b(x04), .c(new_n113_), .O(new_n114_));
  oai21  g062(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(z07));
  ...
  nand2  g091(.a(new_n110_), .b(new_n56_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n62_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n88_), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n144_), .c(new_n54_), .O(z12));
