...
module FAU ( 
  ...
  and2   g008(.a(x28), .b(x07), .O(new_n61_));
  ...
  nand3  g035(.a(x19), .b(new_n57_), .c(new_n87_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(x07), .O(new_n90_));
  nor2   g038(.a(x24), .b(x19), .O(new_n91_));
  nor2   g039(.a(x25), .b(new_n57_), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n55_), .c(new_n91_), .O(new_n93_));
  nand2  g041(.a(new_n93_), .b(new_n90_), .O(z04));
  ...
  aoi21  g067(.a(new_n86_), .b(new_n54_), .c(new_n61_), .O(new_n120_));
