...
module FAU ( 
  ...
  aoi21  g063(.a(new_n115_), .b(new_n111_), .c(new_n72_), .O(z07));
  ...
  nand4  g083(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n75_), .O(new_n136_));
  aoi21  g084(.a(new_n136_), .b(new_n132_), .c(new_n72_), .O(z10));
  ...
  nand3  g092(.a(new_n62_), .b(new_n107_), .c(new_n54_), .O(new_n145_));
