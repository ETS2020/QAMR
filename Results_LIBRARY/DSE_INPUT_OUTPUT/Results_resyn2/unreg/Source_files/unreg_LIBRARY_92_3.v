...
module FAU ( 
  ...
  nand2  g008(.a(x32), .b(x20), .O(new_n61_));
  ...
  oai21  g056(.a(x32), .b(x18), .c(x20), .O(new_n109_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n89_), .O(new_n135_));
  ...
  aoi21  g092(.a(new_n60_), .b(x19), .c(new_n144_), .O(new_n145_));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n54_), .c(new_n62_), .O(new_n154_));
