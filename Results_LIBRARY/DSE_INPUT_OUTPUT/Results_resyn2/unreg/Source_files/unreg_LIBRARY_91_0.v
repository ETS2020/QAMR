// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:01 2020
...
module FAU ( 
  ...
  nor2   g008(.a(x35), .b(x32), .O(new_n61_));
  ...
  nor2   g087(.a(new_n139_), .b(new_n61_), .O(new_n140_));
  ...
  oai21  g095(.a(new_n143_), .b(x32), .c(new_n147_), .O(z12));
  ...
  nand3  g103(.a(new_n142_), .b(x32), .c(x18), .O(new_n156_));
  nand2  g104(.a(new_n57_), .b(x13), .O(new_n157_));
  oai21  g105(.a(new_n157_), .b(new_n61_), .c(new_n156_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n55_), .O(new_n159_));
  inv1   g107(.a(new_n61_), .O(new_n160_));
  nor2   g108(.a(x34), .b(x19), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n159_), .O(z14));
  nand3  g111(.a(new_n142_), .b(x32), .c(new_n54_), .O(new_n164_));
  nand2  g112(.a(new_n160_), .b(new_n55_), .O(new_n165_));
  nand2  g113(.a(x28), .b(x18), .O(new_n166_));
  oai21  g114(.a(x18), .b(x12), .c(new_n166_), .O(new_n167_));
  oai21  g115(.a(new_n167_), .b(new_n165_), .c(new_n164_), .O(z15));
endmodule
