...
module FAU ( 
  ...
  nor2   g000(.a(x32), .b(x14), .O(new_n53_));
  ...
  aoi21  g096(.a(new_n143_), .b(x19), .c(new_n148_), .O(z12));
  aoi21  g097(.a(x32), .b(x18), .c(x14), .O(new_n150_));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(x19), .c(new_n57_), .O(new_n152_));
  inv1   g100(.a(x33), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n54_), .O(new_n154_));
  oai22  g102(.a(new_n154_), .b(new_n53_), .c(new_n152_), .d(new_n150_), .O(z13));
