...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x28), .O(new_n54_));
  ...
  nand2  g048(.a(new_n100_), .b(new_n56_), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n54_), .O(z05));
  ...
  nand3  g056(.a(new_n108_), .b(new_n106_), .c(new_n54_), .O(z06));
  nand2  g057(.a(x20), .b(x18), .O(new_n110_));
  inv1   g058(.a(x04), .O(new_n111_));
  nand2  g059(.a(new_n62_), .b(new_n111_), .O(new_n112_));
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n95_), .O(new_n113_));
  inv1   g061(.a(x27), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n56_), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n54_), .O(z07));
  inv1   g064(.a(x28), .O(new_n117_));
  aoi21  g065(.a(x32), .b(x19), .c(new_n117_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n95_), .O(new_n125_));
  ...
  nand3  g086(.a(new_n138_), .b(new_n136_), .c(new_n95_), .O(new_n139_));
  inv1   g087(.a(x31), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n56_), .O(new_n141_));
  nand3  g089(.a(new_n141_), .b(new_n139_), .c(new_n54_), .O(z11));
  nand2  g090(.a(new_n95_), .b(new_n54_), .O(new_n143_));
  nand2  g091(.a(x33), .b(x18), .O(new_n144_));
  oai21  g092(.a(x18), .b(x15), .c(new_n144_), .O(new_n145_));
  nand3  g093(.a(new_n53_), .b(new_n117_), .c(new_n56_), .O(new_n146_));
  ...
  nand2  g102(.a(new_n62_), .b(new_n154_), .O(new_n155_));
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n95_), .O(new_n156_));
  inv1   g104(.a(x34), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n56_), .O(new_n158_));
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n54_), .O(z14));
  oai21  g107(.a(new_n53_), .b(x18), .c(x28), .O(new_n160_));
  inv1   g108(.a(x12), .O(new_n161_));
  nand2  g109(.a(new_n62_), .b(new_n161_), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(new_n160_), .c(new_n95_), .O(new_n163_));
