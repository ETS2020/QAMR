...
module FAU ( 
  ...
  nand2  g034(.a(x32), .b(x24), .O(new_n87_));
  ...
  nand2  g055(.a(x32), .b(x27), .O(new_n108_));
  ...
  nand2  g062(.a(x32), .b(x28), .O(new_n115_));
  ...
  nand2  g077(.a(new_n65_), .b(new_n129_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n64_), .b(new_n53_), .O(new_n143_));
