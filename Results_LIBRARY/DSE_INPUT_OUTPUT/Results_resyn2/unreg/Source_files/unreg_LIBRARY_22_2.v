// Benchmark "FAU" written by ABC on Tue Aug 11 19:59:25 2020
...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x26), .O(new_n63_));
  ...
  nand4  g041(.a(new_n93_), .b(new_n91_), .c(x19), .d(new_n75_), .O(new_n94_));
  aoi21  g042(.a(new_n94_), .b(new_n90_), .c(new_n72_), .O(z04));
  oai21  g043(.a(new_n62_), .b(x18), .c(x26), .O(new_n96_));
  ...
  nand2  g048(.a(new_n100_), .b(new_n63_), .O(new_n101_));
  ...
  nand4  g069(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n75_), .O(new_n122_));
  aoi21  g070(.a(new_n122_), .b(new_n118_), .c(new_n72_), .O(z08));
  ...
  nand4  g076(.a(new_n128_), .b(new_n126_), .c(x19), .d(new_n75_), .O(new_n129_));
  aoi21  g077(.a(new_n129_), .b(new_n125_), .c(new_n72_), .O(z09));
  ...
  nand4  g090(.a(new_n142_), .b(new_n140_), .c(x19), .d(new_n75_), .O(new_n143_));
  aoi21  g091(.a(new_n143_), .b(new_n139_), .c(new_n72_), .O(z11));
  ...
  nand4  g097(.a(new_n149_), .b(new_n147_), .c(x19), .d(new_n75_), .O(new_n150_));
  aoi21  g098(.a(new_n150_), .b(new_n146_), .c(new_n72_), .O(z12));
  ...
  inv1   g103(.a(x33), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n54_), .O(new_n157_));
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n63_), .O(z13));
  nand3  g106(.a(new_n62_), .b(new_n107_), .c(new_n54_), .O(new_n159_));
  nand2  g107(.a(new_n63_), .b(new_n55_), .O(new_n160_));
  nand2  g108(.a(x35), .b(x18), .O(new_n161_));
  oai21  g109(.a(x18), .b(x13), .c(new_n161_), .O(new_n162_));
  oai21  g110(.a(new_n162_), .b(new_n160_), .c(new_n159_), .O(z14));
  nand2  g111(.a(x28), .b(x18), .O(new_n164_));
  oai21  g112(.a(x18), .b(x12), .c(new_n164_), .O(new_n165_));
  nor2   g113(.a(x35), .b(x19), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n63_), .O(new_n167_));
  oai21  g115(.a(new_n165_), .b(new_n160_), .c(new_n167_), .O(z15));
endmodule
