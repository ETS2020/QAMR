...
module FAU ( 
  ...
  oai21  g026(.a(x28), .b(new_n57_), .c(new_n62_), .O(new_n79_));
  ...
  inv1   g033(.a(x28), .O(new_n86_));
  nor2   g034(.a(new_n86_), .b(x00), .O(new_n87_));
  ...
  nand4  g055(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n90_), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(new_n104_), .c(new_n87_), .O(z06));
  ...
  aoi21  g064(.a(x19), .b(x00), .c(new_n86_), .O(new_n117_));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n90_), .O(new_n133_));
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n87_), .O(z10));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n90_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n87_), .O(z11));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n90_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n87_), .O(z12));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n90_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n87_), .O(z13));
  ...
  nor2   g110(.a(x28), .b(new_n57_), .O(new_n163_));
  inv1   g111(.a(x12), .O(new_n164_));
  nor2   g112(.a(x18), .b(new_n164_), .O(new_n165_));
  oai21  g113(.a(new_n165_), .b(new_n163_), .c(new_n55_), .O(new_n166_));
  nor2   g114(.a(x35), .b(x19), .O(new_n167_));
  nor2   g115(.a(new_n167_), .b(new_n87_), .O(new_n168_));
