...
module FAU ( 
  ...
  nand2  g019(.a(x35), .b(x22), .O(new_n72_));
  ...
  nand2  g041(.a(x35), .b(x25), .O(new_n94_));
  ...
  nand2  g048(.a(x35), .b(x26), .O(new_n101_));
  ...
  nand2  g069(.a(x35), .b(x29), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n71_), .O(new_n123_));
  ...
  nand2  g090(.a(x35), .b(x32), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n71_), .O(new_n144_));
  ...
  nand2  g111(.a(new_n54_), .b(new_n71_), .O(new_n164_));
