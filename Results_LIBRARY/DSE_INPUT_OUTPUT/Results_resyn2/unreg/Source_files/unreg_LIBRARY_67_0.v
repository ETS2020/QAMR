...
module FAU ( 
  ...
  inv1   g012(.a(x32), .O(new_n65_));
  oai21  g013(.a(new_n65_), .b(new_n54_), .c(new_n64_), .O(new_n66_));
  ...
  aoi21  g026(.a(new_n78_), .b(new_n73_), .c(new_n61_), .O(z02));
  ...
  aoi21  g034(.a(new_n86_), .b(new_n81_), .c(new_n61_), .O(z03));
  ...
  nand2  g091(.a(new_n65_), .b(new_n64_), .O(new_n144_));
  ...
  nand3  g095(.a(new_n65_), .b(x21), .c(new_n54_), .O(new_n148_));
