...
module FAU ( 
  ...
  nand2  g010(.a(x32), .b(x21), .O(new_n63_));
  ...
  nand2  g017(.a(x32), .b(x22), .O(new_n70_));
  ...
  inv1   g025(.a(x32), .O(new_n78_));
  nor2   g026(.a(new_n78_), .b(x19), .O(new_n79_));
  ...
  nand2  g035(.a(new_n79_), .b(new_n87_), .O(new_n88_));
  ...
  nand2  g042(.a(new_n79_), .b(new_n94_), .O(new_n95_));
  ...
  nand2  g056(.a(new_n79_), .b(new_n108_), .O(new_n109_));
  ...
  nand2  g096(.a(new_n79_), .b(new_n148_), .O(new_n149_));
  ...
  nand2  g110(.a(new_n79_), .b(new_n162_), .O(new_n163_));
