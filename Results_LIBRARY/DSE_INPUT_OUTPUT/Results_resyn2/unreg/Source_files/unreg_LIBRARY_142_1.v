...
module FAU ( 
  ...
  nor2   g012(.a(x28), .b(x22), .O(new_n65_));
  aoi21  g013(.a(x22), .b(new_n57_), .c(new_n65_), .O(new_n66_));
  inv1   g014(.a(x02), .O(new_n67_));
  nand2  g015(.a(new_n57_), .b(new_n67_), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(new_n55_), .O(new_n69_));
  nor2   g017(.a(x21), .b(x19), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  oai21  g019(.a(new_n69_), .b(new_n66_), .c(new_n71_), .O(z01));
  nand2  g020(.a(new_n65_), .b(new_n54_), .O(new_n73_));
  nand2  g021(.a(new_n63_), .b(new_n55_), .O(new_n74_));
  nand2  g022(.a(x23), .b(x18), .O(new_n75_));
  oai21  g023(.a(x18), .b(x01), .c(new_n75_), .O(new_n76_));
  oai21  g024(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(z02));
  ...
  oai21  g032(.a(new_n82_), .b(new_n74_), .c(new_n84_), .O(z03));
  ...
  aoi21  g064(.a(x22), .b(x19), .c(new_n116_), .O(new_n117_));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n89_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n86_), .O(z11));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n89_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n86_), .O(z13));
