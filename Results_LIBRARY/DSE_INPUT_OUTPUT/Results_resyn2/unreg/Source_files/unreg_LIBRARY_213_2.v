// Benchmark "FAU" written by ABC on Tue Aug 11 20:01:03 2020
...
module FAU ( 
  ...
  nand2  g010(.a(new_n62_), .b(x33), .O(new_n63_));
  ...
  nand3  g041(.a(new_n93_), .b(new_n91_), .c(new_n63_), .O(z04));
  ...
  nand3  g069(.a(new_n121_), .b(new_n119_), .c(new_n63_), .O(z08));
  ...
  nor2   g091(.a(x18), .b(x15), .O(new_n144_));
  oai21  g092(.a(new_n144_), .b(x17), .c(x19), .O(new_n145_));
  nor2   g093(.a(new_n54_), .b(new_n57_), .O(new_n146_));
  oai21  g094(.a(new_n146_), .b(new_n62_), .c(x33), .O(new_n147_));
  nand2  g095(.a(x32), .b(new_n54_), .O(new_n148_));
  nand3  g096(.a(new_n148_), .b(new_n147_), .c(new_n145_), .O(new_n149_));
  inv1   g097(.a(new_n149_), .O(z12));
  nand2  g098(.a(x34), .b(x19), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(x33), .O(new_n152_));
  inv1   g100(.a(x14), .O(new_n153_));
  nor2   g101(.a(x18), .b(new_n153_), .O(new_n154_));
  nor2   g102(.a(x34), .b(x33), .O(new_n155_));
  aoi22  g103(.a(new_n155_), .b(new_n146_), .c(new_n154_), .d(new_n152_), .O(new_n156_));
  inv1   g104(.a(x33), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n54_), .O(new_n158_));
  oai21  g106(.a(new_n156_), .b(x17), .c(new_n158_), .O(z13));
  ...
  oai22  g110(.a(new_n162_), .b(new_n160_), .c(new_n158_), .d(x34), .O(z14));
  ...
  nand3  g117(.a(new_n169_), .b(new_n167_), .c(new_n63_), .O(z15));
endmodule
