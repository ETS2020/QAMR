// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:11 2020
...
module FAU ( 
  ...
  nand3  g007(.a(new_n59_), .b(new_n56_), .c(new_n54_), .O(new_n60_));
  inv1   g008(.a(x21), .O(new_n61_));
  nor2   g009(.a(x20), .b(x19), .O(new_n62_));
  oai21  g010(.a(x32), .b(new_n61_), .c(new_n62_), .O(new_n63_));
  nand2  g011(.a(new_n63_), .b(new_n60_), .O(z00));
  aoi21  g012(.a(x32), .b(x19), .c(new_n61_), .O(new_n65_));
  ...
  nand2  g021(.a(new_n58_), .b(new_n73_), .O(new_n74_));
  nand3  g022(.a(new_n74_), .b(new_n72_), .c(new_n56_), .O(new_n75_));
  nor2   g023(.a(x32), .b(new_n61_), .O(new_n76_));
  ...
  nand2  g039(.a(new_n58_), .b(new_n91_), .O(new_n92_));
  ...
  nand2  g044(.a(new_n58_), .b(new_n96_), .O(new_n97_));
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n56_), .O(new_n98_));
  ...
  nand2  g051(.a(new_n58_), .b(new_n103_), .O(new_n104_));
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n56_), .O(new_n105_));
  ...
  nand2  g060(.a(new_n58_), .b(new_n112_), .O(new_n113_));
  ...
  nand2  g065(.a(new_n58_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n56_), .O(new_n119_));
  ...
  nand2  g072(.a(new_n58_), .b(new_n124_), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n56_), .O(new_n126_));
  ...
  nand2  g079(.a(new_n58_), .b(new_n131_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n56_), .O(new_n133_));
  ...
  oai21  g091(.a(x21), .b(new_n55_), .c(new_n53_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n58_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n56_), .O(new_n148_));
  ...
  nand2  g108(.a(new_n58_), .b(new_n160_), .O(new_n161_));
