...
module FAU ( 
  ...
  nand2  g039(.a(new_n62_), .b(new_n53_), .O(new_n92_));
  nand4  g040(.a(new_n92_), .b(new_n91_), .c(x19), .d(new_n59_), .O(new_n93_));
  aoi21  g041(.a(new_n93_), .b(new_n90_), .c(new_n55_), .O(z04));
  nand2  g042(.a(x26), .b(x18), .O(new_n95_));
  inv1   g043(.a(x06), .O(new_n96_));
  nand2  g044(.a(new_n62_), .b(new_n96_), .O(new_n97_));
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n80_), .O(new_n98_));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n80_), .O(new_n112_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n80_), .O(new_n147_));
  ...
  aoi21  g100(.a(new_n152_), .b(new_n59_), .c(new_n56_), .O(new_n153_));
  nand2  g101(.a(x33), .b(new_n56_), .O(new_n154_));
  aoi21  g102(.a(x19), .b(x18), .c(x07), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n54_), .c(new_n154_), .O(new_n156_));
  nor2   g104(.a(new_n156_), .b(new_n153_), .O(z13));
  ...
  aoi21  g109(.a(new_n54_), .b(new_n56_), .c(new_n55_), .O(new_n162_));
