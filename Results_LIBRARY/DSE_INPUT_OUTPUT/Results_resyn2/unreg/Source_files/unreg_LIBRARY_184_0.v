...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nor2   g000(.a(x32), .b(x27), .O(new_n53_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n87_), .c(new_n71_), .O(new_n90_));
  ...
  nor2   g046(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  ...
  oai22  g053(.a(x32), .b(x27), .c(new_n105_), .d(x19), .O(new_n106_));
  aoi21  g054(.a(new_n104_), .b(x19), .c(new_n106_), .O(z06));
  inv1   g055(.a(x27), .O(new_n108_));
  nand2  g056(.a(x32), .b(x19), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g058(.a(x20), .b(x18), .O(new_n111_));
  inv1   g059(.a(x04), .O(new_n112_));
  nand2  g060(.a(new_n60_), .b(new_n112_), .O(new_n113_));
  nand3  g061(.a(new_n113_), .b(new_n111_), .c(new_n71_), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n110_), .O(z07));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n57_), .O(new_n121_));
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n53_), .O(z08));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n57_), .O(new_n128_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n57_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n57_), .O(new_n142_));
  ...
  nand2  g096(.a(new_n148_), .b(x27), .O(new_n149_));
  aoi22  g097(.a(new_n149_), .b(new_n109_), .c(new_n147_), .d(x19), .O(z12));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n60_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n71_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n71_), .O(new_n161_));
  nor2   g109(.a(x34), .b(x19), .O(new_n162_));
  nor2   g110(.a(new_n162_), .b(new_n53_), .O(new_n163_));
  ...
  nand2  g116(.a(new_n60_), .b(new_n168_), .O(new_n169_));
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n57_), .O(new_n170_));
  aoi21  g118(.a(new_n170_), .b(new_n166_), .c(new_n53_), .O(z15));
endmodule
