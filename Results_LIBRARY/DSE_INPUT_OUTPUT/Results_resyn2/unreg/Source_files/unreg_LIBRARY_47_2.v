...
module FAU ( 
  ...
  nand3  g077(.a(x19), .b(new_n57_), .c(new_n129_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(x32), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(x09), .O(new_n132_));
  nor2   g080(.a(x30), .b(x19), .O(new_n133_));
  nor2   g081(.a(x31), .b(new_n57_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n55_), .c(new_n133_), .O(new_n135_));
  ...
  nor2   g091(.a(new_n54_), .b(x09), .O(new_n144_));
