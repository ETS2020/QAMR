...
module FAU ( 
  ...
  nand3  g060(.a(new_n112_), .b(new_n110_), .c(new_n73_), .O(new_n113_));
  ...
  nand2  g071(.a(new_n73_), .b(new_n54_), .O(new_n124_));
  nand2  g072(.a(x30), .b(x18), .O(new_n125_));
  oai21  g073(.a(x18), .b(x10), .c(new_n125_), .O(new_n126_));
  inv1   g074(.a(x32), .O(new_n127_));
  nand3  g075(.a(new_n127_), .b(new_n53_), .c(new_n56_), .O(new_n128_));
  oai21  g076(.a(new_n126_), .b(new_n124_), .c(new_n128_), .O(z09));
  ...
  aoi21  g091(.a(x29), .b(x19), .c(new_n127_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x18), .O(new_n145_));
  inv1   g093(.a(x15), .O(new_n146_));
  nand2  g094(.a(new_n62_), .b(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n59_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(x19), .c(new_n144_), .O(z12));
