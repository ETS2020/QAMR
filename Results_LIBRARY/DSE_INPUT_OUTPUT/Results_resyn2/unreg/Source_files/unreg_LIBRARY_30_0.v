...
module FAU ( 
  ...
  nand3  g025(.a(x34), .b(new_n72_), .c(new_n54_), .O(new_n78_));
  ...
  nand2  g033(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n57_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n103_), .c(new_n53_), .O(z06));
  ...
  oai21  g105(.a(new_n72_), .b(new_n54_), .c(new_n73_), .O(new_n158_));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n64_), .O(new_n167_));
