...
module FAU ( 
  ...
  aoi21  g036(.a(new_n62_), .b(x19), .c(new_n61_), .O(new_n89_));
  ...
  nand4  g045(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n68_), .O(new_n98_));
  aoi21  g046(.a(new_n98_), .b(new_n94_), .c(new_n63_), .O(z05));
  ...
  aoi21  g053(.a(new_n105_), .b(new_n101_), .c(new_n63_), .O(z06));
