...
module FAU ( 
  ...
  inv1   g42(.a(x05), .O(new_n95_));
  nand2  g43(.a(new_n66_), .b(new_n95_), .O(new_n96_));
  nand3  g44(.a(new_n96_), .b(new_n94_), .c(new_n64_), .O(new_n97_));
  oai21  g45(.a(new_n62_), .b(x26), .c(new_n97_), .O(z06));
  ...
  oai22  g52(.a(new_n55_), .b(x29), .c(x18), .d(new_n104_), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  nand2  g54(.a(x28), .b(x18), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n58_), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n106_), .O(z08));
  inv1   g57(.a(x29), .O(new_n110_));
  nand2  g58(.a(new_n71_), .b(new_n110_), .O(new_n111_));
  nor2   g59(.a(x18), .b(x10), .O(new_n112_));
  nand2  g60(.a(x30), .b(x18), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n64_), .O(new_n114_));
  oai21  g62(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(z09));
  inv1   g63(.a(x09), .O(new_n116_));
  oai22  g64(.a(new_n55_), .b(x31), .c(x18), .d(new_n116_), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n53_), .O(new_n118_));
  nand2  g66(.a(new_n113_), .b(new_n58_), .O(new_n119_));
  nand2  g67(.a(new_n119_), .b(new_n118_), .O(z10));
  inv1   g68(.a(x31), .O(new_n121_));
  nand2  g69(.a(new_n71_), .b(new_n121_), .O(new_n122_));
  nor2   g70(.a(x18), .b(x08), .O(new_n123_));
  nand2  g71(.a(new_n86_), .b(new_n64_), .O(new_n124_));
  oai21  g72(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(z11));
  inv1   g73(.a(x15), .O(new_n126_));
  oai22  g74(.a(new_n55_), .b(x33), .c(x18), .d(new_n126_), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  nand2  g76(.a(x32), .b(x18), .O(new_n129_));
  nand2  g77(.a(new_n129_), .b(new_n58_), .O(new_n130_));
  nand2  g78(.a(new_n130_), .b(new_n128_), .O(z12));
  nand2  g79(.a(x34), .b(x18), .O(new_n132_));
  inv1   g80(.a(x14), .O(new_n133_));
  nand2  g81(.a(new_n66_), .b(new_n133_), .O(new_n134_));
  nand3  g82(.a(new_n134_), .b(new_n132_), .c(new_n64_), .O(new_n135_));
  oai21  g83(.a(new_n62_), .b(x33), .c(new_n135_), .O(z13));
  inv1   g84(.a(x34), .O(new_n137_));
  nand2  g85(.a(new_n71_), .b(new_n137_), .O(new_n138_));
  nor2   g86(.a(x18), .b(x13), .O(new_n139_));
  nand2  g87(.a(x35), .b(x18), .O(new_n140_));
  nand2  g88(.a(new_n140_), .b(new_n64_), .O(new_n141_));
  oai21  g89(.a(new_n141_), .b(new_n139_), .c(new_n138_), .O(z14));
  nand2  g90(.a(new_n140_), .b(new_n58_), .O(new_n143_));
  nand2  g91(.a(new_n62_), .b(new_n53_), .O(new_n144_));
  oai21  g92(.a(x18), .b(x12), .c(new_n107_), .O(new_n145_));
  oai21  g93(.a(new_n145_), .b(new_n144_), .c(new_n143_), .O(z15));
endmodule
