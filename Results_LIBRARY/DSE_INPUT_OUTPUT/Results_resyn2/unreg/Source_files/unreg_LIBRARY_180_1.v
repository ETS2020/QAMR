...
module FAU ( 
  ...
  nand3  g01(.a(x19), .b(new_n53_), .c(x09), .O(new_n54_));
  ...
  aoi21  g55(.a(new_n62_), .b(new_n107_), .c(x17), .O(new_n108_));
  aoi21  g56(.a(new_n108_), .b(new_n106_), .c(new_n59_), .O(new_n109_));
  inv1   g57(.a(x29), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n58_), .O(new_n111_));
  oai21  g59(.a(new_n109_), .b(new_n58_), .c(new_n111_), .O(z09));
  and2   g60(.a(x31), .b(x18), .O(new_n113_));
