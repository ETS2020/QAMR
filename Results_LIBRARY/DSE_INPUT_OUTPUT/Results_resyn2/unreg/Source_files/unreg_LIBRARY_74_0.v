...
module FAU ( 
  ...
  nor2   g008(.a(x35), .b(x27), .O(new_n61_));
  ...
  oai21  g052(.a(new_n102_), .b(new_n100_), .c(new_n104_), .O(z06));
  aoi21  g053(.a(x20), .b(x18), .c(x17), .O(new_n106_));
  oai21  g054(.a(x18), .b(x04), .c(new_n106_), .O(new_n107_));
  inv1   g055(.a(new_n61_), .O(new_n108_));
  nand2  g056(.a(x27), .b(new_n54_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  aoi21  g058(.a(new_n107_), .b(x19), .c(new_n110_), .O(z07));
  ...
  nor2   g070(.a(x29), .b(x19), .O(new_n123_));
  ...
  aoi21  g093(.a(new_n145_), .b(new_n141_), .c(new_n61_), .O(z12));
  ...
  inv1   g101(.a(new_n55_), .O(new_n154_));
  nor2   g102(.a(new_n101_), .b(x35), .O(new_n155_));
  inv1   g103(.a(x13), .O(new_n156_));
  nor2   g104(.a(x18), .b(new_n156_), .O(new_n157_));
  aoi21  g105(.a(new_n157_), .b(new_n108_), .c(new_n155_), .O(new_n158_));
  nor2   g106(.a(x34), .b(x19), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n108_), .O(new_n160_));
  oai21  g108(.a(new_n158_), .b(new_n154_), .c(new_n160_), .O(z14));
  nand2  g109(.a(new_n108_), .b(new_n55_), .O(new_n162_));
  nand2  g110(.a(x28), .b(x18), .O(new_n163_));
  oai21  g111(.a(x18), .b(x12), .c(new_n163_), .O(new_n164_));
  oai22  g112(.a(new_n164_), .b(new_n162_), .c(new_n109_), .d(x35), .O(z15));
endmodule
