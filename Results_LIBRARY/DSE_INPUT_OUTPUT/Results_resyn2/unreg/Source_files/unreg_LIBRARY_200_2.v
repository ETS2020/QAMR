...
module FAU ( 
  ...
  nand3  g074(.a(new_n126_), .b(new_n124_), .c(new_n95_), .O(new_n127_));
  ...
  nor2   g078(.a(x31), .b(x28), .O(new_n131_));
  aoi21  g079(.a(x31), .b(new_n62_), .c(new_n131_), .O(new_n132_));
  inv1   g080(.a(x09), .O(new_n133_));
  nand2  g081(.a(new_n62_), .b(new_n133_), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n95_), .O(new_n135_));
  nor2   g083(.a(x30), .b(x19), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  oai21  g085(.a(new_n135_), .b(new_n132_), .c(new_n137_), .O(z10));
  nand2  g086(.a(new_n95_), .b(new_n54_), .O(new_n139_));
  nand2  g087(.a(x24), .b(x18), .O(new_n140_));
  oai21  g088(.a(x18), .b(x08), .c(new_n140_), .O(new_n141_));
  nand3  g089(.a(new_n53_), .b(new_n121_), .c(new_n56_), .O(new_n142_));
  oai21  g090(.a(new_n141_), .b(new_n139_), .c(new_n142_), .O(z11));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n95_), .O(new_n168_));
