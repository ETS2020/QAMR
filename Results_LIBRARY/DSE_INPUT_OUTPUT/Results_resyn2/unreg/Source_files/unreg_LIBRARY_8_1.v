...
module FAU ( 
  ...
  nor2   g010(.a(new_n62_), .b(x28), .O(new_n63_));
  ...
  nor2   g030(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  ...
  aoi21  g038(.a(new_n90_), .b(new_n86_), .c(new_n63_), .O(z04));
  ...
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n64_), .O(z05));
  ...
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n64_), .O(z06));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n64_), .O(z07));
  nand2  g060(.a(new_n64_), .b(new_n55_), .O(new_n113_));
  nand2  g061(.a(x29), .b(x18), .O(new_n114_));
  oai21  g062(.a(x18), .b(x11), .c(new_n114_), .O(new_n115_));
  nor2   g063(.a(x35), .b(x28), .O(new_n116_));
  ...
  oai21  g070(.a(new_n120_), .b(new_n113_), .c(new_n122_), .O(z09));
  ...
  aoi21  g077(.a(new_n129_), .b(new_n125_), .c(new_n63_), .O(z10));
  ...
  aoi21  g084(.a(new_n136_), .b(new_n132_), .c(new_n63_), .O(z11));
  ...
  aoi21  g098(.a(new_n150_), .b(new_n146_), .c(new_n63_), .O(z13));
  nor2   g099(.a(x18), .b(x13), .O(new_n152_));
  oai21  g100(.a(new_n152_), .b(x17), .c(x19), .O(new_n153_));
  nand2  g101(.a(x34), .b(new_n54_), .O(new_n154_));
  inv1   g102(.a(x28), .O(new_n155_));
  nor2   g103(.a(new_n54_), .b(new_n57_), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n155_), .c(x35), .O(new_n157_));
  nand3  g105(.a(new_n157_), .b(new_n154_), .c(new_n153_), .O(new_n158_));
  inv1   g106(.a(new_n158_), .O(z14));
  nand2  g107(.a(new_n62_), .b(new_n54_), .O(new_n160_));
  nand2  g108(.a(x28), .b(x19), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(x35), .O(new_n162_));
  inv1   g110(.a(x12), .O(new_n163_));
  nor2   g111(.a(x18), .b(new_n163_), .O(new_n164_));
  aoi22  g112(.a(new_n164_), .b(new_n162_), .c(new_n156_), .d(new_n116_), .O(new_n165_));
  oai21  g113(.a(new_n165_), .b(x17), .c(new_n160_), .O(z15));
endmodule
