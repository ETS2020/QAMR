...
module FAU ( 
  ...
  nand4  g072(.a(new_n124_), .b(new_n122_), .c(x19), .d(new_n74_), .O(new_n125_));
  aoi21  g073(.a(new_n125_), .b(new_n121_), .c(new_n62_), .O(z09));
  ...
  nand4  g079(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n74_), .O(new_n132_));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n74_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n74_), .O(new_n146_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n74_), .O(new_n160_));
