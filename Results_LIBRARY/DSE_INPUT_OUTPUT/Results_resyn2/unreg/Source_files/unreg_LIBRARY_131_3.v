...
module FAU ( 
  ...
  nand2  g000(.a(x34), .b(x06), .O(new_n53_));
  ...
  aoi21  g042(.a(x26), .b(x18), .c(x17), .O(new_n95_));
  oai21  g043(.a(x18), .b(x06), .c(new_n95_), .O(new_n96_));
  inv1   g044(.a(x25), .O(new_n97_));
  oai21  g045(.a(new_n97_), .b(x19), .c(new_n53_), .O(new_n98_));
  aoi21  g046(.a(new_n96_), .b(x19), .c(new_n98_), .O(z05));
  nand2  g047(.a(x27), .b(x18), .O(new_n100_));
  inv1   g048(.a(x05), .O(new_n101_));
  nand2  g049(.a(new_n61_), .b(new_n101_), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(new_n100_), .c(new_n72_), .O(new_n103_));
  inv1   g051(.a(x26), .O(new_n104_));
  aoi21  g052(.a(new_n104_), .b(new_n55_), .c(new_n54_), .O(new_n105_));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n55_), .c(new_n54_), .O(new_n112_));
  ...
  aoi21  g066(.a(new_n118_), .b(new_n55_), .c(new_n54_), .O(new_n119_));
  ...
  aoi21  g073(.a(new_n125_), .b(new_n55_), .c(new_n54_), .O(new_n126_));
  ...
  nand4  g080(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n58_), .O(new_n133_));
  aoi21  g081(.a(new_n133_), .b(new_n129_), .c(new_n54_), .O(z10));
  ...
  nand4  g087(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n58_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n136_), .c(new_n54_), .O(z11));
  ...
  nand4  g094(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n58_), .O(new_n147_));
  aoi21  g095(.a(new_n147_), .b(new_n143_), .c(new_n54_), .O(z12));
  ...
  aoi21  g105(.a(x19), .b(new_n156_), .c(new_n157_), .O(new_n158_));
  aoi21  g106(.a(x35), .b(x18), .c(x17), .O(new_n159_));
  oai21  g107(.a(x18), .b(x13), .c(new_n159_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(x19), .c(new_n158_), .O(z14));
  ...
  aoi21  g114(.a(new_n166_), .b(new_n55_), .c(new_n54_), .O(new_n167_));
