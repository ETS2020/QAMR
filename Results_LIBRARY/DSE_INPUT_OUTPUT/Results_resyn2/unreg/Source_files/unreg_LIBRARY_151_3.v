// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:33 2020
...
module FAU ( 
  ...
  nand4  g025(.a(new_n77_), .b(new_n75_), .c(x19), .d(new_n61_), .O(new_n78_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n61_), .O(new_n93_));
  ...
  nor2   g054(.a(new_n106_), .b(new_n63_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n61_), .O(new_n114_));
  ...
  aoi21  g068(.a(new_n120_), .b(new_n54_), .c(new_n63_), .O(new_n121_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n61_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n63_), .O(z11));
  nand2  g091(.a(new_n62_), .b(new_n54_), .O(new_n144_));
  ...
  nand2  g104(.a(new_n57_), .b(x13), .O(new_n157_));
  inv1   g105(.a(x35), .O(new_n158_));
  aoi21  g106(.a(new_n158_), .b(x18), .c(new_n54_), .O(new_n159_));
  nand2  g107(.a(x34), .b(new_n54_), .O(new_n160_));
  ...
  nand2  g111(.a(new_n57_), .b(x12), .O(new_n164_));
  aoi21  g112(.a(new_n120_), .b(x18), .c(new_n54_), .O(new_n165_));
