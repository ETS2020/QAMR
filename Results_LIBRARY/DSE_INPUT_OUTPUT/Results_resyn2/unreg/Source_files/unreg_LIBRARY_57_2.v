...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x32), .O(new_n54_));
  ...
  nand2  g097(.a(new_n149_), .b(new_n56_), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(new_n148_), .c(new_n54_), .O(z12));
  nand2  g099(.a(x34), .b(x18), .O(new_n152_));
  inv1   g100(.a(x14), .O(new_n153_));
  nand2  g101(.a(new_n62_), .b(new_n153_), .O(new_n154_));
  nand3  g102(.a(new_n154_), .b(new_n152_), .c(new_n66_), .O(new_n155_));
  inv1   g103(.a(x33), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n56_), .O(new_n157_));
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n54_), .O(z13));
  nand3  g106(.a(new_n53_), .b(new_n149_), .c(new_n56_), .O(new_n159_));
  nand2  g107(.a(new_n66_), .b(new_n54_), .O(new_n160_));
