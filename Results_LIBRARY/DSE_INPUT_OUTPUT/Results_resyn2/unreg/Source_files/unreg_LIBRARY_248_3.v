...
module FAU ( 
  ...
  aoi21  g093(.a(new_n145_), .b(x19), .c(new_n144_), .O(new_n146_));
  ...
  oai21  g104(.a(x32), .b(x18), .c(x35), .O(new_n157_));
  ...
  nand3  g109(.a(new_n61_), .b(new_n161_), .c(new_n54_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n160_), .O(z14));
  aoi21  g111(.a(new_n144_), .b(x19), .c(new_n145_), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n57_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n67_), .O(new_n168_));
