...
module FAU ( 
  ...
  nand2  g001(.a(new_n53_), .b(x25), .O(new_n54_));
  ...
  nand3  g092(.a(new_n53_), .b(new_n100_), .c(new_n56_), .O(new_n145_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n150_), .c(new_n80_), .O(new_n153_));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n80_), .O(new_n167_));
