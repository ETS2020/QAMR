...
module FAU ( 
  ...
  nor2   g000(.a(x34), .b(x05), .O(new_n53_));
  ...
  nand3  g036(.a(new_n88_), .b(new_n86_), .c(new_n71_), .O(new_n89_));
  ...
  aoi21  g047(.a(x34), .b(x18), .c(x05), .O(new_n100_));
  nand2  g048(.a(x27), .b(x18), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(x19), .c(new_n57_), .O(new_n102_));
  inv1   g050(.a(x26), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n54_), .O(new_n104_));
  oai22  g052(.a(new_n104_), .b(new_n53_), .c(new_n102_), .d(new_n100_), .O(z06));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n107_), .c(new_n53_), .O(z07));
  nand2  g060(.a(x29), .b(x18), .O(new_n113_));
  inv1   g061(.a(x11), .O(new_n114_));
  nand2  g062(.a(new_n60_), .b(new_n114_), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(new_n113_), .c(new_n71_), .O(new_n116_));
  nor2   g064(.a(x28), .b(x19), .O(new_n117_));
  nor2   g065(.a(new_n117_), .b(new_n53_), .O(new_n118_));
  ...
  nand3  g077(.a(new_n129_), .b(new_n127_), .c(new_n71_), .O(new_n130_));
  ...
  nor2   g095(.a(x18), .b(x14), .O(new_n148_));
  nand2  g096(.a(x34), .b(x18), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n71_), .O(new_n150_));
  nor2   g098(.a(x33), .b(x19), .O(new_n151_));
  nor2   g099(.a(new_n151_), .b(new_n53_), .O(new_n152_));
  oai21  g100(.a(new_n150_), .b(new_n148_), .c(new_n152_), .O(z13));
  inv1   g101(.a(x34), .O(new_n154_));
  nand2  g102(.a(x19), .b(x05), .O(new_n155_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n71_), .O(new_n160_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n162_), .c(new_n71_), .O(new_n165_));
