// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:13 2020
...
module FAU ( 
  ...
  aoi21  g040(.a(new_n61_), .b(new_n54_), .c(new_n63_), .O(new_n93_));
  nand2  g041(.a(new_n93_), .b(new_n92_), .O(z04));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n82_), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(new_n96_), .c(new_n63_), .O(z05));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n82_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n82_), .O(new_n121_));
  ...
  aoi21  g077(.a(new_n61_), .b(x19), .c(new_n62_), .O(new_n130_));
  ...
  nor2   g086(.a(new_n138_), .b(new_n63_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n82_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n142_), .c(new_n63_), .O(z12));
  ...
  nor2   g100(.a(new_n152_), .b(new_n63_), .O(new_n153_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n82_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n63_), .O(z14));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n82_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n63_), .O(z15));
endmodule
