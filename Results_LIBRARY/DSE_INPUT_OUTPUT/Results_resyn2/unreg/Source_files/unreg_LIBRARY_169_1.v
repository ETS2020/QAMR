// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:43 2020
...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x30), .O(new_n62_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n81_), .O(new_n100_));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n81_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n81_), .O(new_n121_));
  ...
  oai21  g078(.a(x32), .b(new_n54_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g083(.a(new_n135_), .b(new_n131_), .O(z10));
  ...
  aoi21  g091(.a(x30), .b(x19), .c(new_n61_), .O(new_n144_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n81_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n62_), .O(z14));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n81_), .O(new_n167_));
