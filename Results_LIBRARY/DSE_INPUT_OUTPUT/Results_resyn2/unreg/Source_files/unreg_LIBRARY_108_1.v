...
module FAU ( 
  ...
  inv1   g008(.a(x35), .O(new_n61_));
  nor2   g009(.a(new_n61_), .b(x32), .O(new_n62_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n74_), .O(new_n93_));
  ...
  nand2  g053(.a(new_n57_), .b(new_n105_), .O(new_n106_));
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n74_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n103_), .c(new_n62_), .O(z06));
  ...
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n74_), .O(new_n114_));
  ...
  nor2   g068(.a(new_n120_), .b(new_n62_), .O(new_n121_));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n74_), .O(new_n128_));
  ...
  nor2   g082(.a(new_n134_), .b(new_n62_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n74_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n138_), .c(new_n62_), .O(z11));
  ...
  nand2  g102(.a(new_n57_), .b(new_n154_), .O(new_n155_));
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n74_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n62_), .O(z13));
  ...
  nor2   g109(.a(x34), .b(x19), .O(new_n162_));
  nor2   g110(.a(new_n162_), .b(new_n62_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n161_), .O(z14));
  ...
  aoi21  g116(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n169_));
