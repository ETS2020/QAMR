...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x33), .O(new_n62_));
  ...
  nor2   g096(.a(new_n148_), .b(new_n62_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n147_), .O(z12));
  inv1   g098(.a(x33), .O(new_n151_));
  oai21  g099(.a(x34), .b(new_n54_), .c(new_n151_), .O(new_n152_));
  nand2  g100(.a(x34), .b(x18), .O(new_n153_));
  inv1   g101(.a(x14), .O(new_n154_));
  nand2  g102(.a(new_n57_), .b(new_n154_), .O(new_n155_));
  nand3  g103(.a(new_n155_), .b(new_n153_), .c(new_n55_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n152_), .O(z13));
