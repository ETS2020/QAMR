...
module FAU ( 
  ...
  nor2   g008(.a(x32), .b(x09), .O(new_n61_));
  ...
  nand4  g038(.a(new_n90_), .b(new_n88_), .c(x19), .d(new_n87_), .O(new_n91_));
  aoi21  g039(.a(new_n91_), .b(new_n86_), .c(new_n61_), .O(z04));
  ...
  nand4  g059(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n87_), .O(new_n112_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n87_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n122_), .c(new_n61_), .O(z09));
  aoi21  g075(.a(x32), .b(x18), .c(x09), .O(new_n128_));
  nand2  g076(.a(x31), .b(x18), .O(new_n129_));
  nand3  g077(.a(new_n129_), .b(x19), .c(new_n87_), .O(new_n130_));
  inv1   g078(.a(x30), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(new_n54_), .O(new_n132_));
  oai22  g080(.a(new_n132_), .b(new_n61_), .c(new_n130_), .d(new_n128_), .O(z10));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n87_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n135_), .c(new_n61_), .O(z11));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n87_), .O(new_n146_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n87_), .O(new_n160_));
  aoi21  g108(.a(new_n160_), .b(new_n156_), .c(new_n61_), .O(z14));
  ...
  nand4  g114(.a(new_n166_), .b(new_n164_), .c(x19), .d(new_n87_), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n163_), .c(new_n61_), .O(z15));
endmodule
