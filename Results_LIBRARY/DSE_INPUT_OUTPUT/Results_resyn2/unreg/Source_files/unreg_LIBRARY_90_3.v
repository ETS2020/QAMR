...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nand2  g000(.a(x35), .b(x33), .O(new_n53_));
  ...
  nand3  g096(.a(new_n53_), .b(new_n148_), .c(new_n55_), .O(new_n149_));
  ...
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n65_), .O(new_n162_));
  inv1   g110(.a(x34), .O(new_n163_));
  aoi21  g111(.a(new_n163_), .b(new_n55_), .c(new_n54_), .O(new_n164_));
  ...
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n65_), .O(new_n169_));
  aoi21  g117(.a(new_n152_), .b(new_n55_), .c(new_n54_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(new_n169_), .O(z15));
endmodule
