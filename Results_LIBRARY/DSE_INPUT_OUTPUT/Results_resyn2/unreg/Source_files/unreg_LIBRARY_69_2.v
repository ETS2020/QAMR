...
module FAU ( 
  ...
  aoi21  g019(.a(x34), .b(x19), .c(new_n61_), .O(new_n72_));
  aoi21  g020(.a(x23), .b(x18), .c(x17), .O(new_n73_));
  oai21  g021(.a(x18), .b(x01), .c(new_n73_), .O(new_n74_));
  aoi21  g022(.a(new_n74_), .b(x19), .c(new_n72_), .O(z02));
  ...
  nand4  g030(.a(new_n82_), .b(new_n80_), .c(x19), .d(new_n78_), .O(new_n83_));
  aoi21  g031(.a(new_n83_), .b(new_n77_), .c(new_n62_), .O(z03));
  ...
  nand4  g037(.a(new_n89_), .b(new_n87_), .c(x19), .d(new_n78_), .O(new_n90_));
  aoi21  g038(.a(new_n90_), .b(new_n86_), .c(new_n62_), .O(z04));
  ...
  nor2   g044(.a(new_n96_), .b(new_n62_), .O(new_n97_));
  ...
  nor2   g051(.a(new_n103_), .b(new_n62_), .O(new_n104_));
  ...
  nor2   g058(.a(new_n110_), .b(new_n62_), .O(new_n111_));
  ...
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n78_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n143_), .c(x19), .d(new_n78_), .O(new_n146_));
  ...
  nand4  g107(.a(new_n159_), .b(new_n157_), .c(x19), .d(new_n78_), .O(new_n160_));
