...
module FAU ( 
  ...
  aoi21  g038(.a(new_n90_), .b(new_n86_), .c(new_n65_), .O(z04));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n63_), .O(z07));
  ...
  nand2  g088(.a(x35), .b(x19), .O(new_n141_));
  aoi21  g089(.a(x33), .b(x18), .c(x17), .O(new_n142_));
  oai21  g090(.a(x18), .b(x15), .c(new_n142_), .O(new_n143_));
  aoi22  g091(.a(new_n143_), .b(x19), .c(new_n141_), .d(x32), .O(z12));
  ...
  aoi21  g098(.a(new_n150_), .b(new_n146_), .c(new_n65_), .O(z13));
  inv1   g099(.a(new_n55_), .O(new_n152_));
  nor2   g100(.a(x35), .b(x32), .O(new_n153_));
  inv1   g101(.a(x13), .O(new_n154_));
  nor2   g102(.a(x18), .b(new_n154_), .O(new_n155_));
  aoi22  g103(.a(new_n155_), .b(new_n63_), .c(new_n153_), .d(x18), .O(new_n156_));
  nor2   g104(.a(x34), .b(x19), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n63_), .O(new_n158_));
  oai21  g106(.a(new_n156_), .b(new_n152_), .c(new_n158_), .O(z14));
  nand2  g107(.a(new_n153_), .b(new_n54_), .O(new_n160_));
  nand2  g108(.a(new_n63_), .b(new_n55_), .O(new_n161_));
  nand2  g109(.a(x28), .b(x18), .O(new_n162_));
  oai21  g110(.a(x18), .b(x12), .c(new_n162_), .O(new_n163_));
  oai21  g111(.a(new_n163_), .b(new_n161_), .c(new_n160_), .O(z15));
endmodule
