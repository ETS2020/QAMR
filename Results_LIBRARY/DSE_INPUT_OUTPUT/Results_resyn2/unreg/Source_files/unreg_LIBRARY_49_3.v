...
module FAU ( 
  ...
  nand2  g008(.a(x28), .b(x20), .O(new_n61_));
  ...
  aoi21  g025(.a(new_n77_), .b(new_n54_), .c(new_n62_), .O(new_n78_));
  ...
  aoi21  g033(.a(new_n85_), .b(new_n54_), .c(new_n62_), .O(new_n86_));
  ...
  oai21  g056(.a(x28), .b(x18), .c(x20), .O(new_n109_));
  ...
  nand3  g061(.a(new_n61_), .b(new_n113_), .c(new_n54_), .O(new_n114_));
  ...
  aoi21  g110(.a(new_n162_), .b(new_n54_), .c(new_n62_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n161_), .O(z14));
  oai21  g112(.a(x20), .b(x18), .c(x28), .O(new_n165_));
  ...
  nand3  g117(.a(new_n61_), .b(new_n169_), .c(new_n54_), .O(new_n170_));
