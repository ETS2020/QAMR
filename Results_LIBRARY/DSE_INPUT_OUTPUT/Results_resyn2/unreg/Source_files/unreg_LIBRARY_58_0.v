...
module FAU ( 
  ...
  nor2   g033(.a(new_n54_), .b(x17), .O(new_n86_));
  ...
  aoi21  g057(.a(x20), .b(x18), .c(x17), .O(new_n110_));
  nand2  g058(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g059(.a(x27), .b(x19), .O(new_n112_));
  inv1   g060(.a(x27), .O(new_n113_));
  nand2  g061(.a(x32), .b(new_n113_), .O(new_n114_));
  aoi22  g062(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(x19), .O(z07));
  nand2  g063(.a(x29), .b(x18), .O(new_n116_));
  inv1   g064(.a(x11), .O(new_n117_));
  nand2  g065(.a(new_n60_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n86_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n86_), .O(new_n126_));
  ...
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n86_), .O(new_n154_));
