...
module FAU ( 
  ...
  nor2   g093(.a(x34), .b(x32), .O(new_n146_));
  aoi21  g094(.a(x32), .b(x19), .c(new_n146_), .O(new_n147_));
  aoi21  g095(.a(new_n145_), .b(x19), .c(new_n147_), .O(z12));
  ...
  nor2   g101(.a(new_n153_), .b(new_n54_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n152_), .O(z13));
  aoi21  g103(.a(x32), .b(x19), .c(new_n53_), .O(new_n156_));
  ...
  nand4  g112(.a(new_n164_), .b(new_n162_), .c(x19), .d(new_n58_), .O(new_n165_));
