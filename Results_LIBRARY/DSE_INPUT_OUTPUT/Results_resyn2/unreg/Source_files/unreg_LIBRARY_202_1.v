...
module FAU ( 
  ...
  oai21  g19(.a(new_n71_), .b(new_n62_), .c(new_n70_), .O(z03));
  ...
  nand2  g33(.a(new_n83_), .b(new_n55_), .O(new_n86_));
  nand2  g34(.a(new_n56_), .b(x19), .O(new_n87_));
  oai21  g35(.a(new_n87_), .b(new_n62_), .c(new_n86_), .O(z07));
  ...
  oai21  g41(.a(x30), .b(x17), .c(x18), .O(new_n94_));
  ...
  nand2  g60(.a(new_n110_), .b(new_n55_), .O(new_n113_));
  inv1   g61(.a(x34), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(x19), .O(new_n115_));
  oai21  g63(.a(new_n115_), .b(new_n62_), .c(new_n113_), .O(z13));
  nand2  g64(.a(new_n114_), .b(new_n55_), .O(new_n117_));
  ...
  nand2  g71(.a(new_n123_), .b(new_n122_), .O(z15));
endmodule
