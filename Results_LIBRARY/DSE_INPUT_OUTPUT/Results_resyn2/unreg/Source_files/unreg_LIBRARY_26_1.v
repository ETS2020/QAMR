...
module FAU ( 
  ...
  aoi21  g34(.a(new_n64_), .b(new_n86_), .c(x17), .O(new_n87_));
  aoi21  g35(.a(new_n87_), .b(new_n85_), .c(new_n70_), .O(new_n88_));
  inv1   g36(.a(x26), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(new_n69_), .O(new_n90_));
  oai21  g38(.a(new_n88_), .b(new_n69_), .c(new_n90_), .O(z06));
  ...
  and2   g42(.a(x29), .b(x18), .O(new_n95_));
  ...
  aoi21  g50(.a(new_n102_), .b(new_n100_), .c(new_n70_), .O(new_n103_));
  ...
  aoi21  g57(.a(new_n109_), .b(new_n107_), .c(new_n70_), .O(new_n110_));
  ...
  aoi21  g64(.a(new_n116_), .b(new_n114_), .c(new_n70_), .O(new_n117_));
  ...
  aoi21  g74(.a(new_n126_), .b(new_n124_), .c(new_n70_), .O(new_n127_));
