...
module FAU ( 
  ...
  nand2  g008(.a(x35), .b(x22), .O(new_n61_));
  ...
  nand4  g060(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n80_), .O(new_n113_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n80_), .O(new_n127_));
  ...
  oai21  g104(.a(x22), .b(x18), .c(x35), .O(new_n157_));
  ...
  aoi21  g111(.a(new_n72_), .b(x19), .c(new_n73_), .O(new_n164_));
  nand2  g112(.a(x28), .b(x18), .O(new_n165_));
  inv1   g113(.a(x12), .O(new_n166_));
  nand2  g114(.a(new_n57_), .b(new_n166_), .O(new_n167_));
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n80_), .O(new_n168_));
