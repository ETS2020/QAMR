...
module FAU ( 
  ...
  nand3  g18(.a(x34), .b(x19), .c(new_n70_), .O(new_n71_));
  ...
  nand2  g69(.a(new_n57_), .b(x14), .O(new_n122_));
  ...
  oai22  g73(.a(new_n125_), .b(new_n71_), .c(x34), .d(x19), .O(z14));
  ...
  oai21  g80(.a(new_n130_), .b(new_n53_), .c(new_n132_), .O(z15));
endmodule
