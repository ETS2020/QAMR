...
module FAU ( 
  ...
  nand2  g047(.a(x32), .b(x19), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  ...
  nand2  g092(.a(new_n144_), .b(x26), .O(new_n145_));
  aoi22  g093(.a(new_n145_), .b(new_n100_), .c(new_n143_), .d(x19), .O(z12));
