...
module FAU ( 
  ...
  nor2   g024(.a(new_n67_), .b(x19), .O(new_n77_));
  ...
  nand2  g032(.a(x24), .b(x22), .O(new_n85_));
  ...
  nand2  g053(.a(x27), .b(x22), .O(new_n106_));
  ...
  nand2  g068(.a(new_n77_), .b(new_n120_), .O(new_n121_));
  ...
  nand2  g074(.a(x30), .b(x22), .O(new_n127_));
  ...
  nand2  g081(.a(x31), .b(x22), .O(new_n134_));
  ...
  nand2  g095(.a(x33), .b(x22), .O(new_n148_));
  ...
  nand2  g103(.a(new_n77_), .b(new_n155_), .O(new_n156_));
  ...
  nand2  g110(.a(new_n77_), .b(new_n162_), .O(new_n163_));
