...
module FAU ( 
  ...
  nor2   g018(.a(x21), .b(x19), .O(new_n71_));
  nor2   g019(.a(new_n71_), .b(new_n55_), .O(new_n72_));
  ...
  nand3  g046(.a(new_n98_), .b(new_n96_), .c(new_n66_), .O(new_n99_));
  nor2   g047(.a(x25), .b(x19), .O(new_n100_));
  nor2   g048(.a(new_n100_), .b(new_n55_), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n99_), .O(z05));
  aoi21  g050(.a(new_n54_), .b(x19), .c(new_n53_), .O(new_n103_));
  aoi21  g051(.a(x27), .b(x18), .c(x17), .O(new_n104_));
  oai21  g052(.a(x18), .b(x05), .c(new_n104_), .O(new_n105_));
  aoi21  g053(.a(new_n105_), .b(x19), .c(new_n103_), .O(z06));
  ...
  nand3  g064(.a(new_n116_), .b(new_n114_), .c(new_n66_), .O(new_n117_));
  nor2   g065(.a(x28), .b(x19), .O(new_n118_));
  nor2   g066(.a(new_n118_), .b(new_n55_), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(z08));
  nand2  g068(.a(x30), .b(x18), .O(new_n121_));
  inv1   g069(.a(x10), .O(new_n122_));
  nand2  g070(.a(new_n62_), .b(new_n122_), .O(new_n123_));
  nand3  g071(.a(new_n123_), .b(new_n121_), .c(new_n66_), .O(new_n124_));
  ...
  nand2  g077(.a(new_n62_), .b(new_n129_), .O(new_n130_));
  nand3  g078(.a(new_n130_), .b(new_n128_), .c(new_n66_), .O(new_n131_));
  aoi21  g079(.a(new_n54_), .b(new_n56_), .c(new_n55_), .O(new_n132_));
  ...
  nand2  g085(.a(new_n62_), .b(new_n137_), .O(new_n138_));
  nand4  g086(.a(new_n138_), .b(new_n136_), .c(x19), .d(new_n59_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n135_), .c(new_n55_), .O(z11));
  nand2  g088(.a(x33), .b(x18), .O(new_n141_));
  inv1   g089(.a(x15), .O(new_n142_));
  nand2  g090(.a(new_n62_), .b(new_n142_), .O(new_n143_));
  nand3  g091(.a(new_n143_), .b(new_n141_), .c(new_n66_), .O(new_n144_));
  nor2   g092(.a(x32), .b(x19), .O(new_n145_));
  nor2   g093(.a(new_n145_), .b(new_n55_), .O(new_n146_));
