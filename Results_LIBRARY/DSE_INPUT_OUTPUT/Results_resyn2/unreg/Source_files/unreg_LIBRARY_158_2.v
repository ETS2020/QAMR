...
module FAU ( 
  ...
  nand2  g085(.a(new_n80_), .b(new_n54_), .O(new_n138_));
  nand2  g086(.a(x24), .b(x18), .O(new_n139_));
  oai21  g087(.a(x18), .b(x08), .c(new_n139_), .O(new_n140_));
  nor2   g088(.a(x31), .b(x19), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n54_), .O(new_n142_));
  oai21  g090(.a(new_n140_), .b(new_n138_), .c(new_n142_), .O(z11));
  nand2  g091(.a(x33), .b(x18), .O(new_n144_));
  oai21  g092(.a(x18), .b(x15), .c(new_n144_), .O(new_n145_));
  inv1   g093(.a(x08), .O(new_n146_));
  nand3  g094(.a(new_n53_), .b(new_n56_), .c(new_n146_), .O(new_n147_));
  oai21  g095(.a(new_n145_), .b(new_n138_), .c(new_n147_), .O(z12));
  ...
  oai21  g100(.a(new_n150_), .b(new_n138_), .c(new_n152_), .O(z13));
  ...
  nand3  g111(.a(new_n163_), .b(new_n161_), .c(new_n80_), .O(new_n164_));
