...
module FAU ( 
  ...
  nand2  g088(.a(new_n57_), .b(new_n61_), .O(new_n141_));
  nand4  g089(.a(new_n141_), .b(new_n140_), .c(x19), .d(new_n90_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(new_n139_), .c(new_n63_), .O(z11));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n90_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n166_), .c(x19), .d(new_n90_), .O(new_n169_));
