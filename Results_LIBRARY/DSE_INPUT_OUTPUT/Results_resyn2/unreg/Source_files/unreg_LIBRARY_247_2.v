...
module FAU ( 
  ...
  oai22  g64(.a(new_n116_), .b(new_n64_), .c(x32), .d(x19), .O(z12));
  nand2  g65(.a(x34), .b(x18), .O(new_n118_));
  oai21  g66(.a(x18), .b(x14), .c(new_n118_), .O(new_n119_));
  oai22  g67(.a(new_n119_), .b(new_n64_), .c(x33), .d(x19), .O(z13));
