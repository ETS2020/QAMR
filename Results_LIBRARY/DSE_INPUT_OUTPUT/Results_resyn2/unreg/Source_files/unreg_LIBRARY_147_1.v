// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:31 2020
...
module FAU ( 
  ...
  nor2   g009(.a(new_n61_), .b(x26), .O(new_n62_));
  ...
  oai21  g050(.a(x32), .b(new_n54_), .c(new_n102_), .O(new_n103_));
  ...
  nand2  g055(.a(new_n107_), .b(new_n103_), .O(z06));
  ...
  aoi21  g095(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n154_), .b(new_n152_), .c(x19), .d(new_n74_), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n62_), .O(z13));
  ...
  nand4  g109(.a(new_n161_), .b(new_n159_), .c(x19), .d(new_n74_), .O(new_n162_));
  aoi21  g110(.a(new_n162_), .b(new_n158_), .c(new_n62_), .O(z14));
