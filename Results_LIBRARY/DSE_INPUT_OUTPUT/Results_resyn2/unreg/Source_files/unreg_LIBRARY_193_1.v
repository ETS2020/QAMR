...
module FAU ( 
  ...
  oai21  g37(.a(x18), .b(x05), .c(new_n89_), .O(new_n90_));
  oai22  g38(.a(new_n90_), .b(new_n54_), .c(x26), .d(x19), .O(z06));
  ...
  aoi21  g44(.a(new_n62_), .b(new_n96_), .c(x17), .O(new_n97_));
  aoi21  g45(.a(new_n97_), .b(new_n95_), .c(new_n59_), .O(new_n98_));
  inv1   g46(.a(x28), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n58_), .O(new_n100_));
  oai21  g48(.a(new_n98_), .b(new_n58_), .c(new_n100_), .O(z08));
  nand2  g49(.a(x30), .b(x18), .O(new_n102_));
  oai21  g50(.a(x18), .b(x10), .c(new_n102_), .O(new_n103_));
  oai22  g51(.a(new_n103_), .b(new_n54_), .c(x29), .d(x19), .O(z09));
  nand2  g52(.a(x31), .b(x18), .O(new_n105_));
  inv1   g53(.a(x09), .O(new_n106_));
  aoi21  g54(.a(new_n62_), .b(new_n106_), .c(x17), .O(new_n107_));
  aoi21  g55(.a(new_n107_), .b(new_n105_), .c(new_n59_), .O(new_n108_));
  inv1   g56(.a(x30), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n58_), .O(new_n110_));
  oai21  g58(.a(new_n108_), .b(new_n58_), .c(new_n110_), .O(z10));
  ...
  aoi21  g69(.a(new_n121_), .b(new_n119_), .c(new_n59_), .O(new_n122_));
  inv1   g70(.a(x32), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n58_), .O(new_n124_));
  oai21  g72(.a(new_n122_), .b(new_n58_), .c(new_n124_), .O(z12));
  nand2  g73(.a(x34), .b(x18), .O(new_n126_));
  oai21  g74(.a(x18), .b(x14), .c(new_n126_), .O(new_n127_));
  oai22  g75(.a(new_n127_), .b(new_n54_), .c(x33), .d(x19), .O(z13));
  ...
  nor2   g79(.a(new_n99_), .b(new_n62_), .O(new_n132_));
