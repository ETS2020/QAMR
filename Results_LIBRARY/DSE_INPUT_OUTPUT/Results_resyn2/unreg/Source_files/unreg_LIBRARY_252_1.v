...
module FAU ( 
  ...
  aoi21  g19(.a(new_n71_), .b(new_n54_), .c(new_n55_), .O(new_n72_));
  ...
  nand2  g26(.a(new_n78_), .b(new_n77_), .O(z05));
  inv1   g27(.a(x27), .O(new_n80_));
  nand4  g28(.a(new_n80_), .b(x19), .c(x18), .d(new_n54_), .O(new_n81_));
  oai21  g29(.a(x26), .b(x19), .c(new_n81_), .O(z06));
  aoi21  g30(.a(new_n58_), .b(new_n54_), .c(new_n55_), .O(new_n83_));
  nand2  g31(.a(new_n80_), .b(new_n53_), .O(new_n84_));
  ...
  aoi21  g43(.a(new_n73_), .b(new_n54_), .c(new_n55_), .O(new_n96_));
  nand2  g44(.a(new_n93_), .b(new_n53_), .O(new_n97_));
  oai21  g45(.a(new_n96_), .b(new_n53_), .c(new_n97_), .O(z11));
  inv1   g46(.a(x33), .O(new_n99_));
  aoi21  g47(.a(new_n99_), .b(new_n54_), .c(new_n55_), .O(new_n100_));
  ...
  nand2  g53(.a(new_n99_), .b(new_n53_), .O(new_n106_));
  oai21  g54(.a(new_n105_), .b(new_n53_), .c(new_n106_), .O(z13));
