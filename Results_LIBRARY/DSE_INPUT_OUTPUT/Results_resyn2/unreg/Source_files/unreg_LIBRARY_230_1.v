...
module FAU ( 
  ...
  nand4  g33(.a(new_n85_), .b(x19), .c(x18), .d(new_n61_), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(new_n84_), .O(z06));
  nand2  g35(.a(new_n85_), .b(new_n55_), .O(new_n88_));
  nand4  g36(.a(new_n56_), .b(x19), .c(x18), .d(new_n61_), .O(new_n89_));
  ...
  nand4  g55(.a(new_n75_), .b(x19), .c(x18), .d(new_n61_), .O(new_n108_));
