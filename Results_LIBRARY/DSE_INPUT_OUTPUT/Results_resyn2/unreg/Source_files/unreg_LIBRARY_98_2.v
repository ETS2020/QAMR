...
module FAU ( 
  ...
  oai21  g090(.a(x28), .b(new_n54_), .c(new_n62_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n68_), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n65_), .O(z13));
  ...
  nand4  g108(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n68_), .O(new_n161_));
  aoi21  g109(.a(new_n161_), .b(new_n157_), .c(new_n65_), .O(z14));
