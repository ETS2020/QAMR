...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n170_;
  nor2   g000(.a(x34), .b(x28), .O(new_n53_));
  ...
  nand2  g066(.a(x28), .b(x19), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  nand2  g068(.a(x34), .b(new_n120_), .O(new_n121_));
  aoi22  g069(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(x19), .O(z08));
  nand2  g070(.a(x30), .b(x18), .O(new_n123_));
  inv1   g071(.a(x10), .O(new_n124_));
  nand2  g072(.a(new_n60_), .b(new_n124_), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n107_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n107_), .O(new_n133_));
  ...
  nand3  g087(.a(new_n139_), .b(new_n137_), .c(new_n107_), .O(new_n140_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n57_), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n145_), .c(new_n53_), .O(z12));
  nand2  g098(.a(x34), .b(x18), .O(new_n151_));
  inv1   g099(.a(x14), .O(new_n152_));
  nand2  g100(.a(new_n60_), .b(new_n152_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n151_), .c(new_n107_), .O(new_n154_));
  ...
  nand3  g115(.a(new_n167_), .b(new_n165_), .c(new_n107_), .O(new_n168_));
