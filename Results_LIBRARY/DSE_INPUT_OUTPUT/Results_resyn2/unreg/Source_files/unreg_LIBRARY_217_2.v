...
module FAU ( 
  ...
  inv1   g076(.a(x17), .O(new_n129_));
  inv1   g077(.a(x31), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(x18), .O(new_n131_));
  nand3  g079(.a(x19), .b(new_n61_), .c(x09), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand2  g082(.a(x31), .b(x30), .O(new_n135_));
  oai21  g083(.a(x30), .b(new_n55_), .c(new_n135_), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n134_), .O(z10));
  oai21  g085(.a(x30), .b(new_n55_), .c(new_n130_), .O(new_n138_));
  ...
  nand3  g117(.a(new_n169_), .b(new_n167_), .c(new_n59_), .O(new_n170_));
