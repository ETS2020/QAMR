...
module FAU ( 
  ...
  nand2  g010(.a(x24), .b(new_n62_), .O(new_n63_));
  nand3  g011(.a(new_n63_), .b(new_n61_), .c(new_n59_), .O(z00));
  inv1   g012(.a(x24), .O(new_n65_));
  nand3  g013(.a(new_n65_), .b(new_n62_), .c(new_n54_), .O(new_n66_));
  nand2  g014(.a(new_n63_), .b(new_n55_), .O(new_n67_));
  nand2  g015(.a(x22), .b(x18), .O(new_n68_));
  oai21  g016(.a(x18), .b(x02), .c(new_n68_), .O(new_n69_));
  oai21  g017(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(z01));
  ...
  nand3  g034(.a(new_n86_), .b(new_n84_), .c(new_n63_), .O(z03));
  nand2  g035(.a(new_n65_), .b(new_n54_), .O(new_n88_));
  ...
  nand3  g040(.a(new_n92_), .b(new_n88_), .c(new_n63_), .O(z04));
  ...
  nand4  g060(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n74_), .O(new_n113_));
  aoi21  g061(.a(new_n113_), .b(new_n109_), .c(new_n71_), .O(z07));
  ...
  nand4  g067(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n74_), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n116_), .c(new_n71_), .O(z08));
  ...
  nand4  g074(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n74_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n123_), .c(new_n71_), .O(z09));
  ...
  nand4  g081(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n74_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n130_), .c(new_n71_), .O(z10));
  ...
  aoi21  g103(.a(new_n155_), .b(new_n151_), .c(new_n71_), .O(z13));
  ...
  aoi21  g117(.a(new_n169_), .b(new_n165_), .c(new_n71_), .O(z15));
endmodule
