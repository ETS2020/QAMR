...
module FAU ( 
  ...
  nand2  g078(.a(new_n57_), .b(new_n61_), .O(new_n131_));
  nand3  g079(.a(new_n131_), .b(new_n130_), .c(new_n67_), .O(new_n132_));
  inv1   g080(.a(x30), .O(new_n133_));
  oai22  g081(.a(x32), .b(new_n61_), .c(new_n133_), .d(x19), .O(new_n134_));
  ...
  oai21  g091(.a(new_n54_), .b(x09), .c(new_n143_), .O(new_n144_));
