...
module FAU ( 
  ...
  nor2   g008(.a(x30), .b(x24), .O(new_n61_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n80_), .O(new_n100_));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n80_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n80_), .O(new_n121_));
  ...
  nand2  g077(.a(new_n88_), .b(new_n54_), .O(new_n130_));
