// Benchmark "FAU" written by ABC on Tue Aug 11 20:00:51 2020
...
module FAU ( 
  ...
  nand2  g000(.a(x32), .b(x11), .O(new_n53_));
  ...
  nand3  g031(.a(new_n83_), .b(new_n81_), .c(new_n72_), .O(new_n84_));
  ...
  nand3  g045(.a(new_n97_), .b(new_n95_), .c(new_n72_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n72_), .O(new_n105_));
  ...
  nand2  g057(.a(new_n109_), .b(new_n55_), .O(new_n110_));
  nand2  g058(.a(x20), .b(x18), .O(new_n111_));
  inv1   g059(.a(x04), .O(new_n112_));
  nand2  g060(.a(new_n61_), .b(new_n112_), .O(new_n113_));
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n58_), .O(new_n114_));
  aoi21  g062(.a(new_n114_), .b(new_n110_), .c(new_n54_), .O(z07));
  nand2  g063(.a(x29), .b(x18), .O(new_n116_));
  inv1   g064(.a(x11), .O(new_n117_));
  nand2  g065(.a(new_n61_), .b(new_n117_), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(new_n116_), .c(new_n58_), .O(new_n119_));
  inv1   g067(.a(x28), .O(new_n120_));
  oai21  g068(.a(new_n120_), .b(x19), .c(new_n53_), .O(new_n121_));
  aoi21  g069(.a(new_n119_), .b(x19), .c(new_n121_), .O(z08));
  inv1   g070(.a(x29), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n55_), .O(new_n124_));
  nand2  g072(.a(x30), .b(x18), .O(new_n125_));
  inv1   g073(.a(x10), .O(new_n126_));
  nand2  g074(.a(new_n61_), .b(new_n126_), .O(new_n127_));
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n58_), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n124_), .c(new_n54_), .O(z09));
  ...
  aoi21  g089(.a(new_n141_), .b(new_n55_), .c(new_n54_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n140_), .O(z11));
  inv1   g091(.a(x32), .O(new_n144_));
  aoi21  g092(.a(x19), .b(new_n117_), .c(new_n144_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n149_), .c(new_n72_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n158_), .b(new_n156_), .c(new_n72_), .O(new_n159_));
  ...
  nand2  g112(.a(new_n61_), .b(new_n164_), .O(new_n165_));
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n72_), .O(new_n166_));
  inv1   g114(.a(x35), .O(new_n167_));
  aoi21  g115(.a(new_n167_), .b(new_n55_), .c(new_n54_), .O(new_n168_));
