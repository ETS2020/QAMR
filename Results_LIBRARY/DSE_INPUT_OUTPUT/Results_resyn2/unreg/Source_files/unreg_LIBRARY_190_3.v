...
module FAU ( 
  ...
  nor2   g048(.a(new_n100_), .b(new_n63_), .O(new_n101_));
  ...
  nand2  g053(.a(new_n57_), .b(new_n61_), .O(new_n106_));
  nand4  g054(.a(new_n106_), .b(new_n105_), .c(x19), .d(new_n68_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(new_n104_), .c(new_n63_), .O(z06));
  ...
  nor2   g061(.a(new_n113_), .b(new_n63_), .O(new_n114_));
  ...
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n63_), .O(z08));
  ...
  nor2   g075(.a(new_n127_), .b(new_n63_), .O(new_n128_));
  ...
  nor2   g082(.a(new_n134_), .b(new_n63_), .O(new_n135_));
  ...
  nor2   g089(.a(new_n141_), .b(new_n63_), .O(new_n142_));
  ...
  aoi21  g095(.a(new_n62_), .b(new_n54_), .c(new_n63_), .O(new_n148_));
  ...
  nor2   g116(.a(new_n168_), .b(new_n63_), .O(new_n169_));
