...
module FAU ( 
  ...
  and2   g008(.a(x28), .b(x10), .O(new_n61_));
  ...
  aoi21  g065(.a(new_n117_), .b(new_n54_), .c(new_n61_), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n116_), .O(z08));
  inv1   g067(.a(x17), .O(new_n120_));
  nand3  g068(.a(x19), .b(new_n57_), .c(new_n120_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(x10), .O(new_n123_));
  nor2   g071(.a(x29), .b(x19), .O(new_n124_));
  nor2   g072(.a(x30), .b(new_n57_), .O(new_n125_));
  aoi21  g073(.a(new_n125_), .b(new_n55_), .c(new_n124_), .O(new_n126_));
  ...
  aoi21  g112(.a(new_n164_), .b(new_n120_), .c(new_n54_), .O(new_n165_));
  nand2  g113(.a(x35), .b(new_n54_), .O(new_n166_));
  aoi21  g114(.a(x19), .b(x18), .c(x10), .O(new_n167_));
  oai21  g115(.a(new_n167_), .b(new_n117_), .c(new_n166_), .O(new_n168_));
  nor2   g116(.a(new_n168_), .b(new_n165_), .O(z15));
endmodule
