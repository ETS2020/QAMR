...
module FAU ( 
  ...
  oai22  g068(.a(new_n53_), .b(x29), .c(new_n120_), .d(x19), .O(new_n121_));
  aoi21  g069(.a(new_n119_), .b(x19), .c(new_n121_), .O(z08));
  inv1   g070(.a(x29), .O(new_n123_));
  oai21  g071(.a(x32), .b(new_n55_), .c(new_n123_), .O(new_n124_));
  nand2  g072(.a(x30), .b(x18), .O(new_n125_));
  inv1   g073(.a(x10), .O(new_n126_));
  nand2  g074(.a(new_n61_), .b(new_n126_), .O(new_n127_));
  nand3  g075(.a(new_n127_), .b(new_n125_), .c(new_n65_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n124_), .O(z09));
