...
module FAU ( 
  ...
  aoi21  g096(.a(new_n61_), .b(new_n54_), .c(new_n63_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n75_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n152_), .c(new_n63_), .O(z13));
  ...
  nor2   g110(.a(new_n162_), .b(new_n63_), .O(new_n163_));
  ...
  aoi21  g116(.a(new_n62_), .b(new_n54_), .c(new_n63_), .O(new_n169_));
