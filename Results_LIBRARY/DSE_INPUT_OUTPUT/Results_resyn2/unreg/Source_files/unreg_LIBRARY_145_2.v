...
module FAU ( 
  ...
  nand2  g44(.a(new_n96_), .b(new_n61_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n61_), .c(new_n97_), .O(z07));
  nand2  g46(.a(x29), .b(x18), .O(new_n99_));
  inv1   g47(.a(x11), .O(new_n100_));
  aoi21  g48(.a(new_n65_), .b(new_n100_), .c(x17), .O(new_n101_));
  aoi21  g49(.a(new_n101_), .b(new_n99_), .c(new_n62_), .O(new_n102_));
  inv1   g50(.a(x28), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n61_), .O(new_n104_));
  oai21  g52(.a(new_n102_), .b(new_n61_), .c(new_n104_), .O(z08));
  ...
  aoi21  g59(.a(new_n111_), .b(new_n109_), .c(new_n62_), .O(new_n112_));
  inv1   g60(.a(x30), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n61_), .O(new_n114_));
  oai21  g62(.a(new_n112_), .b(new_n61_), .c(new_n114_), .O(z10));
  nand2  g63(.a(x24), .b(x18), .O(new_n116_));
  oai21  g64(.a(x18), .b(x08), .c(new_n116_), .O(new_n117_));
  oai22  g65(.a(new_n117_), .b(new_n54_), .c(x31), .d(x19), .O(z11));
  ...
  oai21  g75(.a(new_n125_), .b(new_n61_), .c(new_n127_), .O(z13));
  ...
  oai21  g82(.a(new_n132_), .b(new_n61_), .c(new_n134_), .O(z14));
  nand2  g83(.a(x28), .b(x18), .O(new_n136_));
  oai21  g84(.a(x18), .b(x12), .c(new_n136_), .O(new_n137_));
  oai22  g85(.a(new_n137_), .b(new_n54_), .c(x35), .d(x19), .O(z15));
endmodule
