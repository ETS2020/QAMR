...
module FAU ( 
  ...
  nand2  g008(.a(x30), .b(x13), .O(new_n61_));
  ...
  oai21  g070(.a(x18), .b(x13), .c(x30), .O(new_n123_));
  ...
  nand3  g108(.a(new_n160_), .b(new_n159_), .c(new_n81_), .O(new_n161_));
  inv1   g109(.a(x34), .O(new_n162_));
  oai21  g110(.a(new_n162_), .b(x19), .c(new_n61_), .O(new_n163_));
  ...
  nand4  g117(.a(new_n169_), .b(new_n167_), .c(x19), .d(new_n81_), .O(new_n170_));
