...
module FAU ( 
  ...
  inv1   g009(.a(x35), .O(new_n62_));
  nand2  g010(.a(new_n62_), .b(x34), .O(new_n63_));
  ...
  nand3  g076(.a(new_n128_), .b(new_n126_), .c(new_n63_), .O(z09));
  ...
  nand3  g097(.a(new_n149_), .b(new_n147_), .c(new_n63_), .O(z12));
  inv1   g098(.a(x14), .O(new_n151_));
  nor2   g099(.a(x18), .b(new_n151_), .O(new_n152_));
  nor2   g100(.a(x34), .b(new_n57_), .O(new_n153_));
  oai21  g101(.a(new_n153_), .b(new_n152_), .c(new_n55_), .O(new_n154_));
  ...
  nand2  g105(.a(x35), .b(x19), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(x34), .O(new_n159_));
  inv1   g107(.a(x13), .O(new_n160_));
  nor2   g108(.a(x18), .b(new_n160_), .O(new_n161_));
  aoi22  g109(.a(new_n161_), .b(new_n159_), .c(new_n153_), .d(new_n62_), .O(new_n162_));
  inv1   g110(.a(x34), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n54_), .O(new_n164_));
  oai21  g112(.a(new_n162_), .b(x17), .c(new_n164_), .O(z14));
  inv1   g113(.a(x12), .O(new_n166_));
  aoi21  g114(.a(new_n57_), .b(new_n166_), .c(x17), .O(new_n167_));
  oai21  g115(.a(new_n116_), .b(new_n57_), .c(new_n167_), .O(new_n168_));
  oai21  g116(.a(new_n62_), .b(x19), .c(new_n63_), .O(new_n169_));
  aoi21  g117(.a(new_n168_), .b(x19), .c(new_n169_), .O(z15));
endmodule
