...
module FAU ( 
  ...
  nor2   g001(.a(new_n53_), .b(x01), .O(new_n54_));
  ...
  aoi21  g020(.a(new_n53_), .b(x18), .c(x01), .O(new_n73_));
  nand2  g021(.a(x23), .b(x18), .O(new_n74_));
  nand3  g022(.a(new_n74_), .b(x19), .c(new_n58_), .O(new_n75_));
  inv1   g023(.a(x22), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n55_), .O(new_n77_));
  oai22  g025(.a(new_n77_), .b(new_n54_), .c(new_n75_), .d(new_n73_), .O(z02));
