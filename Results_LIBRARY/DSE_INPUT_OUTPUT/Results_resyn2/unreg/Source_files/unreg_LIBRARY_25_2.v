...
module FAU ( 
  ...
  nand2  g087(.a(new_n57_), .b(new_n61_), .O(new_n140_));
  nand4  g088(.a(new_n140_), .b(new_n139_), .c(x19), .d(new_n89_), .O(new_n141_));
  aoi21  g089(.a(new_n141_), .b(new_n138_), .c(new_n62_), .O(z11));
  inv1   g090(.a(x32), .O(new_n143_));
  oai21  g091(.a(new_n54_), .b(x08), .c(new_n143_), .O(new_n144_));
