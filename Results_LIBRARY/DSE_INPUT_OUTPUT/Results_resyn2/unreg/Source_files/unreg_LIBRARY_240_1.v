...
module FAU ( 
  ...
  oai21  g002(.a(x30), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g016(.a(x30), .b(new_n54_), .O(new_n69_));
  nand3  g017(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(z01));
  inv1   g018(.a(new_n69_), .O(new_n71_));
  ...
  nand2  g024(.a(new_n59_), .b(new_n76_), .O(new_n77_));
  nand4  g025(.a(new_n77_), .b(new_n75_), .c(x19), .d(new_n74_), .O(new_n78_));
  aoi21  g026(.a(new_n78_), .b(new_n73_), .c(new_n71_), .O(z02));
  ...
  nand3  g059(.a(new_n111_), .b(new_n109_), .c(new_n74_), .O(new_n112_));
  nand2  g060(.a(x27), .b(new_n53_), .O(new_n113_));
  nand2  g061(.a(new_n113_), .b(new_n69_), .O(new_n114_));
  aoi21  g062(.a(new_n112_), .b(x19), .c(new_n114_), .O(z07));
  ...
  aoi21  g069(.a(new_n121_), .b(new_n117_), .c(new_n71_), .O(z08));
  oai21  g070(.a(new_n54_), .b(x18), .c(x30), .O(new_n123_));
  ...
  nand2  g075(.a(new_n127_), .b(new_n69_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n126_), .O(z09));
  inv1   g077(.a(x30), .O(new_n130_));
  aoi21  g078(.a(x20), .b(x19), .c(new_n130_), .O(new_n131_));
  ...
  nand3  g088(.a(new_n140_), .b(new_n138_), .c(new_n69_), .O(z11));
  ...
  nand3  g095(.a(new_n147_), .b(new_n145_), .c(new_n69_), .O(z12));
  ...
  aoi21  g102(.a(new_n154_), .b(new_n150_), .c(new_n71_), .O(z13));
  ...
  nand3  g109(.a(new_n161_), .b(new_n159_), .c(new_n69_), .O(z14));
  ...
  nand3  g116(.a(new_n168_), .b(new_n166_), .c(new_n69_), .O(z15));
endmodule
