...
module FAU ( 
  ...
  nand2  g22(.a(new_n80_), .b(new_n67_), .O(new_n86_));
  nand2  g23(.a(new_n86_), .b(new_n63_), .O(z06));
  ...
  nand3  g36(.a(x34), .b(x27), .c(x26), .O(new_n100_));
  nand2  g37(.a(new_n63_), .b(x11), .O(new_n101_));
  nor2   g38(.a(new_n101_), .b(new_n100_), .O(z09));
  inv1   g39(.a(x07), .O(new_n103_));
  nor2   g40(.a(new_n103_), .b(x04), .O(new_n104_));
  aoi22  g41(.a(new_n104_), .b(new_n74_), .c(x37), .d(x06), .O(new_n105_));
  oai21  g42(.a(new_n105_), .b(new_n66_), .c(new_n63_), .O(z10));
  nor2   g43(.a(x30), .b(x09), .O(new_n107_));
  inv1   g44(.a(x28), .O(new_n108_));
  inv1   g45(.a(x08), .O(new_n109_));
  nand2  g46(.a(new_n66_), .b(new_n109_), .O(new_n110_));
  nand2  g47(.a(x27), .b(x04), .O(new_n111_));
  nand4  g48(.a(new_n111_), .b(new_n110_), .c(x35), .d(new_n108_), .O(new_n112_));
  nand2  g49(.a(new_n112_), .b(new_n107_), .O(new_n113_));
  nand2  g50(.a(new_n113_), .b(new_n63_), .O(z11));
  nor2   g51(.a(new_n69_), .b(z08), .O(z12));
  nor2   g52(.a(x19), .b(x18), .O(new_n116_));
  nand2  g53(.a(new_n116_), .b(x20), .O(new_n117_));
  inv1   g54(.a(new_n117_), .O(new_n118_));
  aoi21  g55(.a(new_n118_), .b(new_n69_), .c(z08), .O(z14));
  inv1   g56(.a(z14), .O(z13));
  inv1   g57(.a(x12), .O(new_n121_));
  oai21  g58(.a(new_n100_), .b(new_n121_), .c(new_n63_), .O(z15));
  nand2  g59(.a(x22), .b(x01), .O(new_n123_));
  oai21  g60(.a(new_n123_), .b(x23), .c(new_n63_), .O(z16));
  inv1   g61(.a(x24), .O(new_n125_));
  nand2  g62(.a(new_n125_), .b(x23), .O(new_n126_));
  oai21  g63(.a(new_n126_), .b(new_n123_), .c(new_n63_), .O(z17));
  nand3  g64(.a(new_n112_), .b(new_n107_), .c(new_n63_), .O(z18));
  aoi21  g65(.a(new_n108_), .b(x08), .c(x27), .O(new_n129_));
  oai21  g66(.a(new_n129_), .b(new_n72_), .c(new_n107_), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(new_n63_), .O(z20));
  one    g68(.O(z02));
  nand2  g69(.a(new_n113_), .b(new_n63_), .O(z19));
endmodule
