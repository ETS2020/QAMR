...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n161_, new_n163_, new_n164_, new_n168_, new_n169_;
  ...
  nor2   g009(.a(x22), .b(x01), .O(new_n72_));
  ...
  nand2  g049(.a(new_n100_), .b(new_n87_), .O(z08));
  nand2  g050(.a(x34), .b(x27), .O(new_n113_));
  nand2  g051(.a(x26), .b(x11), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(new_n113_), .c(new_n100_), .O(z09));
  nor2   g053(.a(x32), .b(x30), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n87_), .O(new_n117_));
  inv1   g055(.a(x07), .O(new_n118_));
  nand2  g056(.a(new_n87_), .b(new_n118_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n79_), .c(new_n117_), .O(new_n120_));
  oai21  g058(.a(new_n87_), .b(x05), .c(new_n65_), .O(new_n121_));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n78_), .c(new_n126_), .O(new_n128_));
  nand2  g066(.a(new_n127_), .b(x27), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  inv1   g068(.a(new_n78_), .O(new_n131_));
  nor2   g069(.a(new_n75_), .b(x04), .O(new_n132_));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(new_n80_), .b(new_n133_), .O(new_n134_));
  aoi21  g072(.a(new_n132_), .b(new_n131_), .c(new_n134_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n130_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n100_), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand3  g076(.a(new_n100_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n141_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x20), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n63_), .c(new_n145_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  aoi21  g087(.a(new_n144_), .b(new_n117_), .c(new_n72_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z13));
  nand2  g089(.a(new_n144_), .b(new_n141_), .O(new_n152_));
  nand3  g090(.a(new_n142_), .b(new_n116_), .c(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(new_n147_), .O(new_n155_));
  aoi21  g093(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n152_), .c(new_n63_), .d(new_n75_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n100_), .O(z14));
  nand2  g096(.a(x26), .b(x12), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n113_), .c(new_n72_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(x23), .c(new_n100_), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x23), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n161_), .c(new_n100_), .O(z17));
  nand3  g103(.a(new_n135_), .b(new_n130_), .c(new_n100_), .O(z18));
  inv1   g104(.a(z18), .O(z19));
  nand2  g105(.a(x35), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n80_), .c(new_n133_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n128_), .c(new_n100_), .O(z20));
endmodule
