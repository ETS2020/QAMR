...
module FAU ( 
  ...
  nand2  g043(.a(x25), .b(new_n73_), .O(new_n106_));
  ...
  nand2  g051(.a(new_n99_), .b(new_n89_), .O(z08));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n144_), .c(new_n74_), .O(z13));
  inv1   g092(.a(new_n144_), .O(new_n155_));
  aoi21  g093(.a(new_n151_), .b(new_n148_), .c(new_n77_), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n155_), .c(new_n74_), .O(z14));
  nand3  g095(.a(new_n116_), .b(new_n99_), .c(x12), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n99_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x23), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n160_), .c(new_n99_), .O(z17));
  aoi21  g102(.a(new_n137_), .b(new_n132_), .c(new_n74_), .O(z18));
  inv1   g103(.a(z18), .O(z19));
  nand2  g104(.a(x35), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n82_), .c(new_n135_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n130_), .c(new_n99_), .O(z20));
endmodule
