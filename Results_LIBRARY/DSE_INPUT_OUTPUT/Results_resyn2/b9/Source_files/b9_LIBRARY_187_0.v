...
module FAU ( 
  ...
  nor2   g009(.a(x40), .b(x02), .O(new_n72_));
  ...
  aoi21  g023(.a(new_n85_), .b(new_n84_), .c(new_n63_), .O(new_n86_));
  ...
  nand2  g033(.a(new_n95_), .b(new_n84_), .O(new_n96_));
  nand3  g034(.a(new_n90_), .b(new_n96_), .c(new_n89_), .O(z05));
  ...
  nand2  g048(.a(new_n96_), .b(new_n63_), .O(z08));
  ...
  nand3  g053(.a(new_n96_), .b(new_n63_), .c(x07), .O(new_n116_));
  ...
  nor2   g060(.a(new_n79_), .b(new_n68_), .O(new_n123_));
  ...
  oai21  g064(.a(new_n76_), .b(x27), .c(new_n126_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x08), .O(new_n128_));
  nand3  g066(.a(new_n77_), .b(x27), .c(new_n67_), .O(new_n129_));
  nor3   g067(.a(new_n72_), .b(x30), .c(x09), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(z18));
  inv1   g069(.a(z18), .O(z11));
  nand2  g070(.a(new_n69_), .b(x27), .O(new_n133_));
  nand2  g071(.a(new_n64_), .b(x10), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n96_), .b(new_n135_), .O(z12));
  inv1   g074(.a(x13), .O(new_n137_));
  nand2  g075(.a(x36), .b(x35), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x28), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n64_), .c(new_n137_), .O(new_n140_));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x20), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n65_), .c(new_n140_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  aoi21  g082(.a(new_n123_), .b(new_n137_), .c(new_n72_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  nand2  g084(.a(new_n64_), .b(new_n137_), .O(new_n147_));
  nand2  g085(.a(new_n75_), .b(x27), .O(new_n148_));
  and2   g086(.a(new_n148_), .b(new_n79_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n147_), .c(new_n65_), .d(new_n114_), .O(new_n150_));
  nand3  g088(.a(new_n138_), .b(new_n79_), .c(x28), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n64_), .c(new_n137_), .O(new_n152_));
  ...
  nand2  g093(.a(new_n155_), .b(new_n96_), .O(z15));
  ...
  nand2  g099(.a(new_n126_), .b(new_n76_), .O(new_n162_));
  oai21  g100(.a(new_n88_), .b(new_n114_), .c(new_n130_), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(x08), .c(new_n163_), .O(z20));
