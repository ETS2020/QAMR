// Benchmark "FAU" written by ABC on Sat Aug  8 23:39:17 2020
...
module FAU ( 
  ...
  nor2   g008(.a(x33), .b(x14), .O(new_n71_));
  ...
  inv1   g021(.a(new_n71_), .O(new_n84_));
  nor2   g022(.a(x27), .b(x08), .O(new_n85_));
  oai21  g023(.a(new_n85_), .b(new_n76_), .c(x04), .O(new_n86_));
  inv1   g024(.a(x02), .O(new_n87_));
  nand2  g025(.a(x29), .b(x08), .O(new_n88_));
  nand2  g026(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g027(.a(new_n89_), .b(new_n86_), .c(new_n84_), .d(new_n83_), .O(z02));
  inv1   g028(.a(x35), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n75_), .c(x27), .O(new_n92_));
  inv1   g030(.a(x27), .O(new_n93_));
  inv1   g031(.a(x37), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n92_), .c(new_n84_), .d(x21), .O(z03));
  aoi21  g034(.a(new_n94_), .b(new_n93_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n92_), .c(new_n71_), .O(z04));
  aoi21  g036(.a(x28), .b(x27), .c(x37), .O(new_n99_));
  nor2   g037(.a(new_n99_), .b(new_n71_), .O(z05));
  ...
  nand2  g050(.a(new_n84_), .b(new_n82_), .O(z08));
  nand2  g051(.a(x34), .b(x27), .O(new_n114_));
  nand2  g052(.a(x26), .b(x11), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(new_n114_), .c(new_n84_), .O(z09));
  nand3  g054(.a(x40), .b(x39), .c(x05), .O(new_n117_));
  nand2  g055(.a(new_n82_), .b(x07), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(new_n77_), .c(x27), .O(new_n120_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(new_n71_), .O(z10));
  inv1   g065(.a(x08), .O(new_n128_));
  nand3  g066(.a(x40), .b(x39), .c(x29), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n76_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nor2   g070(.a(new_n91_), .b(new_n93_), .O(new_n133_));
  nor2   g071(.a(x28), .b(x04), .O(new_n134_));
  or2    g072(.a(x30), .b(x09), .O(new_n135_));
  aoi21  g073(.a(new_n134_), .b(new_n133_), .c(new_n135_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n132_), .c(new_n84_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  nand2  g076(.a(new_n84_), .b(new_n69_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z12));
  aoi21  g078(.a(x36), .b(x35), .c(new_n75_), .O(new_n141_));
  inv1   g079(.a(x13), .O(new_n142_));
  nand3  g080(.a(new_n83_), .b(new_n142_), .c(new_n63_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x20), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n66_), .c(new_n143_), .d(new_n141_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nor2   g085(.a(new_n143_), .b(new_n79_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n71_), .O(z13));
  nand4  g088(.a(new_n83_), .b(new_n75_), .c(new_n142_), .d(new_n63_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n66_), .c(new_n93_), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n79_), .c(x28), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n83_), .c(new_n142_), .d(new_n63_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n145_), .c(new_n71_), .O(new_n156_));
  oai21  g094(.a(new_n152_), .b(new_n148_), .c(new_n156_), .O(z14));
  nand2  g095(.a(x26), .b(x12), .O(new_n158_));
  nor3   g096(.a(new_n158_), .b(new_n114_), .c(new_n71_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n84_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x23), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n160_), .c(new_n84_), .O(z17));
  aoi21  g102(.a(new_n136_), .b(new_n132_), .c(new_n71_), .O(z18));
  inv1   g103(.a(z18), .O(z19));
  nor4   g104(.a(new_n135_), .b(new_n133_), .c(new_n130_), .d(new_n71_), .O(z20));
endmodule
