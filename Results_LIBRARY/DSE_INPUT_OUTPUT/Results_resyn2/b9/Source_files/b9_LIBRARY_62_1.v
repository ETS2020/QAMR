...
module FAU ( 
  ...
  oai21  g28(.a(new_n90_), .b(new_n63_), .c(x40), .O(z02));
  ...
  and2   g50(.a(x40), .b(x05), .O(new_n113_));
  inv1   g51(.a(x07), .O(new_n114_));
  nor2   g52(.a(x40), .b(new_n114_), .O(new_n115_));
  ...
  nand2  g57(.a(x40), .b(x29), .O(new_n120_));
  ...
  nand2  g65(.a(new_n77_), .b(x39), .O(new_n128_));
  aoi21  g66(.a(new_n128_), .b(x40), .c(new_n71_), .O(z12));
  ...
  nand3  g72(.a(x40), .b(new_n134_), .c(new_n73_), .O(new_n135_));
  ...
  oai21  g76(.a(new_n138_), .b(new_n82_), .c(x39), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x40), .O(new_n140_));
