...
module FAU ( 
  ...
  nand2  g50(.a(new_n112_), .b(new_n96_), .O(z09));
  ...
  nand3  g84(.a(new_n63_), .b(x22), .c(x01), .O(new_n147_));
  nand2  g85(.a(new_n147_), .b(new_n96_), .O(z16));
  inv1   g86(.a(x24), .O(new_n149_));
  nand3  g87(.a(new_n149_), .b(x22), .c(x01), .O(new_n150_));
  aoi21  g88(.a(new_n150_), .b(x34), .c(new_n63_), .O(z17));
  inv1   g89(.a(z11), .O(z18));
  oai21  g90(.a(new_n69_), .b(new_n66_), .c(new_n128_), .O(new_n153_));
  oai21  g91(.a(new_n153_), .b(new_n125_), .c(new_n96_), .O(z20));
