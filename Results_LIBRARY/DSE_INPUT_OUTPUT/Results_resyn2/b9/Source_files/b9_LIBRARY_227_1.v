...
module FAU ( 
  ...
  nand2  g003(.a(x40), .b(new_n65_), .O(new_n66_));
  ...
  nand3  g007(.a(x40), .b(x10), .c(new_n65_), .O(new_n70_));
  ...
  nand3  g013(.a(new_n75_), .b(new_n72_), .c(x16), .O(z00));
  ...
  aoi21  g022(.a(new_n77_), .b(new_n83_), .c(new_n84_), .O(new_n85_));
  inv1   g023(.a(x39), .O(new_n86_));
  aoi21  g024(.a(x29), .b(x08), .c(x02), .O(new_n87_));
  nor3   g025(.a(new_n87_), .b(new_n73_), .c(new_n86_), .O(new_n88_));
  ...
  nand3  g033(.a(new_n93_), .b(new_n75_), .c(new_n95_), .O(z04));
  aoi21  g034(.a(new_n92_), .b(new_n91_), .c(new_n74_), .O(z05));
  nand2  g035(.a(new_n92_), .b(new_n91_), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n74_), .O(z06));
  ...
  nor3   g050(.a(new_n112_), .b(new_n74_), .c(new_n111_), .O(z09));
  nor2   g051(.a(new_n79_), .b(new_n77_), .O(new_n114_));
  and2   g052(.a(x40), .b(x05), .O(new_n115_));
  inv1   g053(.a(x07), .O(new_n116_));
  nor2   g054(.a(x40), .b(new_n116_), .O(new_n117_));
  aoi22  g055(.a(new_n117_), .b(new_n114_), .c(new_n115_), .d(new_n81_), .O(new_n118_));
  nand3  g056(.a(x37), .b(x27), .c(x06), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n74_), .O(new_n121_));
  oai21  g059(.a(new_n118_), .b(x04), .c(new_n121_), .O(z10));
  nand2  g060(.a(x40), .b(x29), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n84_), .c(new_n83_), .O(new_n124_));
  nand2  g062(.a(new_n123_), .b(x27), .O(new_n125_));
  nand4  g063(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n126_));
  nor2   g064(.a(x30), .b(x09), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n75_), .O(new_n128_));
  aoi21  g066(.a(new_n125_), .b(new_n124_), .c(new_n128_), .O(z11));
  nand2  g067(.a(new_n75_), .b(new_n71_), .O(z12));
  inv1   g068(.a(x18), .O(new_n131_));
  inv1   g069(.a(x19), .O(new_n132_));
  nand3  g070(.a(x20), .b(new_n132_), .c(new_n131_), .O(new_n133_));
  aoi21  g071(.a(x36), .b(x35), .c(new_n78_), .O(new_n134_));
  nor2   g072(.a(x13), .b(x04), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  oai22  g074(.a(new_n136_), .b(new_n134_), .c(new_n133_), .d(new_n67_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x27), .O(new_n138_));
  nor3   g076(.a(new_n80_), .b(x13), .c(x04), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n86_), .c(x40), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(z13));
  or2    g079(.a(new_n133_), .b(new_n67_), .O(new_n142_));
  oai21  g080(.a(new_n135_), .b(new_n86_), .c(x40), .O(new_n143_));
  oai21  g081(.a(new_n142_), .b(new_n77_), .c(new_n143_), .O(new_n144_));
  inv1   g082(.a(new_n133_), .O(new_n145_));
  oai21  g083(.a(x37), .b(x35), .c(new_n145_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n134_), .c(new_n77_), .O(new_n147_));
  nand2  g085(.a(new_n80_), .b(x39), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n144_), .O(z14));
  inv1   g087(.a(x12), .O(new_n150_));
  oai21  g088(.a(new_n112_), .b(new_n150_), .c(new_n75_), .O(z15));
  nand2  g089(.a(x22), .b(x01), .O(new_n152_));
  nor3   g090(.a(new_n152_), .b(new_n74_), .c(x23), .O(z16));
  inv1   g091(.a(x24), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x23), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n152_), .c(new_n75_), .O(z17));
  oai21  g094(.a(new_n77_), .b(new_n65_), .c(new_n85_), .O(new_n157_));
  oai21  g095(.a(new_n123_), .b(new_n83_), .c(new_n127_), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n157_), .c(new_n74_), .O(z18));
  inv1   g098(.a(z18), .O(z19));
  nand2  g099(.a(new_n127_), .b(new_n75_), .O(new_n162_));
  nor2   g100(.a(new_n90_), .b(new_n77_), .O(new_n163_));
  nor3   g101(.a(new_n163_), .b(new_n162_), .c(new_n124_), .O(z20));
  buf    g102(.a(x40), .O(z08));
endmodule
