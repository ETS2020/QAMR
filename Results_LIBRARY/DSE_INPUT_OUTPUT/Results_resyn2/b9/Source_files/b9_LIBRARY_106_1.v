...
module FAU ( 
  ...
  oai21  g025(.a(new_n87_), .b(x18), .c(new_n86_), .O(new_n88_));
  ...
  nor2   g038(.a(new_n100_), .b(new_n72_), .O(z05));
  inv1   g039(.a(new_n100_), .O(new_n102_));
  nor2   g040(.a(new_n102_), .b(new_n72_), .O(z06));
  ...
  inv1   g062(.a(new_n120_), .O(new_n125_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n131_), .O(new_n146_));
  inv1   g084(.a(x19), .O(new_n147_));
  nand2  g085(.a(new_n92_), .b(new_n95_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(x20), .c(new_n147_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(new_n94_), .O(new_n150_));
  nand2  g088(.a(new_n145_), .b(new_n131_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(new_n80_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(new_n71_), .O(new_n153_));
  inv1   g091(.a(new_n151_), .O(new_n154_));
  inv1   g092(.a(new_n144_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n94_), .c(new_n80_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n154_), .c(x02), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n153_), .O(z13));
  oai21  g096(.a(new_n144_), .b(new_n124_), .c(new_n154_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n147_), .c(new_n71_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  aoi21  g099(.a(new_n76_), .b(x27), .c(new_n124_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n151_), .c(new_n66_), .d(new_n94_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n104_), .O(z14));
  nand4  g102(.a(new_n117_), .b(new_n104_), .c(x26), .d(x12), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z15));
  inv1   g104(.a(x01), .O(new_n167_));
  inv1   g105(.a(x22), .O(new_n168_));
  nor4   g106(.a(new_n72_), .b(x23), .c(new_n168_), .d(new_n167_), .O(z16));
  inv1   g107(.a(x24), .O(new_n170_));
  nor2   g108(.a(new_n168_), .b(new_n167_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n104_), .c(new_n170_), .d(x23), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  aoi21  g111(.a(new_n138_), .b(new_n135_), .c(new_n72_), .O(z18));
  nand2  g112(.a(x35), .b(x27), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n136_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n133_), .c(new_n104_), .O(z20));
  nand2  g115(.a(new_n139_), .b(new_n104_), .O(z19));
endmodule
