...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n155_, new_n156_, new_n158_, new_n159_, new_n162_;
  ...
  nor2   g008(.a(x23), .b(x14), .O(new_n71_));
  ...
  nor2   g019(.a(new_n71_), .b(new_n63_), .O(new_n82_));
  oai21  g020(.a(new_n81_), .b(new_n78_), .c(new_n82_), .O(z01));
  nand2  g021(.a(x40), .b(x39), .O(new_n84_));
  inv1   g022(.a(new_n84_), .O(new_n85_));
  inv1   g023(.a(new_n71_), .O(new_n86_));
  ...
  oai21  g031(.a(new_n93_), .b(new_n76_), .c(x27), .O(new_n94_));
  nor2   g032(.a(x37), .b(x27), .O(new_n95_));
  nor2   g033(.a(new_n95_), .b(new_n71_), .O(new_n96_));
  ...
  nand2  g066(.a(new_n85_), .b(x29), .O(new_n129_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n132_), .c(new_n86_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n86_), .b(new_n69_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z12));
  oai21  g077(.a(new_n75_), .b(new_n93_), .c(x28), .O(new_n140_));
  nor2   g078(.a(x13), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n85_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n141_), .b(new_n81_), .c(new_n85_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n71_), .O(z13));
  aoi21  g087(.a(new_n145_), .b(new_n142_), .c(new_n74_), .O(new_n150_));
  inv1   g088(.a(new_n148_), .O(new_n151_));
  nor3   g089(.a(new_n151_), .b(new_n150_), .c(new_n71_), .O(z14));
  nand4  g090(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n86_), .O(z15));
  inv1   g092(.a(x23), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x22), .c(x14), .d(x01), .O(new_n156_));
  ...
  aoi21  g098(.a(new_n135_), .b(new_n132_), .c(new_n71_), .O(z18));
  oai21  g099(.a(new_n93_), .b(new_n74_), .c(new_n134_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n130_), .c(new_n86_), .O(z20));
  inv1   g101(.a(new_n136_), .O(z19));
endmodule
