...
module FAU ( 
  ...
  nor2   g01(.a(x24), .b(new_n63_), .O(new_n64_));
  ...
  nand2  g49(.a(new_n111_), .b(new_n97_), .O(z07));
  nand2  g50(.a(new_n87_), .b(new_n97_), .O(z08));
  and2   g51(.a(x34), .b(x27), .O(new_n114_));
  nand3  g52(.a(new_n114_), .b(x26), .c(x11), .O(new_n115_));
  nand2  g53(.a(new_n115_), .b(new_n97_), .O(z09));
  nor2   g54(.a(new_n80_), .b(new_n66_), .O(new_n117_));
  nand2  g55(.a(new_n72_), .b(x05), .O(new_n118_));
  inv1   g56(.a(new_n118_), .O(new_n119_));
  and2   g57(.a(new_n87_), .b(x07), .O(new_n120_));
  aoi22  g58(.a(new_n120_), .b(new_n117_), .c(new_n119_), .d(new_n82_), .O(new_n121_));
  ...
  nand4  g67(.a(x35), .b(new_n79_), .c(x27), .d(new_n68_), .O(new_n130_));
  nor2   g68(.a(x30), .b(x09), .O(new_n131_));
  nand3  g69(.a(new_n131_), .b(new_n130_), .c(new_n97_), .O(new_n132_));
  aoi21  g70(.a(new_n129_), .b(new_n128_), .c(new_n132_), .O(z11));
  inv1   g71(.a(new_n74_), .O(new_n134_));
  nand3  g72(.a(new_n75_), .b(new_n134_), .c(new_n97_), .O(new_n135_));
  ...
  oai21  g80(.a(new_n138_), .b(new_n81_), .c(new_n97_), .O(new_n143_));
  aoi21  g81(.a(new_n142_), .b(x27), .c(new_n143_), .O(z14));
  inv1   g82(.a(z14), .O(z13));
  nand4  g83(.a(new_n114_), .b(new_n97_), .c(x26), .d(x12), .O(new_n146_));
  inv1   g84(.a(new_n146_), .O(z15));
  inv1   g85(.a(x23), .O(new_n148_));
  nand4  g86(.a(x24), .b(new_n148_), .c(x22), .d(x01), .O(new_n149_));
  inv1   g87(.a(new_n149_), .O(z16));
  inv1   g88(.a(z11), .O(z18));
  oai21  g89(.a(new_n69_), .b(new_n66_), .c(new_n131_), .O(new_n153_));
  oai21  g90(.a(new_n153_), .b(new_n128_), .c(new_n97_), .O(z20));
  zero   g91(.O(z17));
  aoi21  g92(.a(new_n129_), .b(new_n128_), .c(new_n132_), .O(z19));
endmodule
