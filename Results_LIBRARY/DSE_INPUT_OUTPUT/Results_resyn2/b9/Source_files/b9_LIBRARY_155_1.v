...
module FAU ( 
  ...
  nor2   g01(.a(new_n63_), .b(x03), .O(new_n64_));
  ...
  inv1   g28(.a(new_n64_), .O(new_n91_));
  oai21  g29(.a(new_n69_), .b(new_n79_), .c(x27), .O(new_n92_));
  inv1   g30(.a(x37), .O(new_n93_));
  nand2  g31(.a(new_n93_), .b(new_n66_), .O(new_n94_));
  nand4  g32(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(x21), .O(z03));
  aoi21  g33(.a(new_n93_), .b(new_n66_), .c(x21), .O(new_n96_));
  aoi21  g34(.a(new_n96_), .b(new_n92_), .c(new_n64_), .O(z04));
  aoi21  g35(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nand2  g36(.a(new_n98_), .b(new_n91_), .O(z05));
  inv1   g37(.a(new_n98_), .O(new_n100_));
  nand2  g38(.a(new_n100_), .b(new_n91_), .O(z06));
  inv1   g39(.a(x25), .O(new_n102_));
  nand2  g40(.a(new_n102_), .b(x00), .O(new_n103_));
  nand2  g41(.a(x25), .b(new_n63_), .O(new_n104_));
  nand3  g42(.a(new_n104_), .b(new_n103_), .c(x38), .O(new_n105_));
  inv1   g43(.a(x17), .O(new_n106_));
  nor2   g44(.a(new_n106_), .b(x15), .O(new_n107_));
  or2    g45(.a(x33), .b(x31), .O(new_n108_));
  oai21  g46(.a(new_n108_), .b(new_n107_), .c(x14), .O(new_n109_));
  nand3  g47(.a(new_n109_), .b(new_n105_), .c(x03), .O(new_n110_));
  nand2  g48(.a(new_n110_), .b(new_n91_), .O(z07));
  nand2  g49(.a(new_n87_), .b(new_n91_), .O(z08));
  and2   g50(.a(x34), .b(x27), .O(new_n113_));
  nand3  g51(.a(new_n113_), .b(x26), .c(x11), .O(new_n114_));
  nand2  g52(.a(new_n114_), .b(new_n91_), .O(z09));
  nor2   g53(.a(new_n80_), .b(new_n66_), .O(new_n116_));
  nand2  g54(.a(new_n72_), .b(x05), .O(new_n117_));
  inv1   g55(.a(new_n117_), .O(new_n118_));
  and2   g56(.a(new_n87_), .b(x07), .O(new_n119_));
  aoi22  g57(.a(new_n119_), .b(new_n116_), .c(new_n118_), .d(new_n82_), .O(new_n120_));
  ...
  nand2  g63(.a(new_n72_), .b(x29), .O(new_n126_));
  aoi21  g64(.a(new_n126_), .b(new_n84_), .c(new_n125_), .O(new_n127_));
  nand2  g65(.a(new_n126_), .b(x27), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  inv1   g67(.a(new_n84_), .O(new_n130_));
  nor2   g68(.a(new_n66_), .b(x04), .O(new_n131_));
  nor2   g69(.a(x30), .b(x09), .O(new_n132_));
  inv1   g70(.a(new_n132_), .O(new_n133_));
  aoi21  g71(.a(new_n131_), .b(new_n130_), .c(new_n133_), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(new_n129_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n91_), .O(z11));
  inv1   g74(.a(new_n74_), .O(new_n137_));
  nand3  g75(.a(new_n75_), .b(new_n137_), .c(new_n91_), .O(new_n138_));
  ...
  oai21  g83(.a(new_n141_), .b(new_n81_), .c(new_n91_), .O(new_n146_));
  aoi21  g84(.a(new_n145_), .b(x27), .c(new_n146_), .O(z14));
  inv1   g85(.a(z14), .O(z13));
  nand4  g86(.a(new_n113_), .b(new_n91_), .c(x26), .d(x12), .O(new_n149_));
  inv1   g87(.a(new_n149_), .O(z15));
  nand2  g88(.a(x22), .b(x01), .O(new_n151_));
  nor3   g89(.a(new_n151_), .b(new_n64_), .c(x23), .O(z16));
  inv1   g90(.a(x24), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(x23), .O(new_n154_));
  oai21  g92(.a(new_n154_), .b(new_n151_), .c(new_n91_), .O(z17));
  aoi21  g93(.a(new_n134_), .b(new_n129_), .c(new_n64_), .O(z18));
  nand3  g94(.a(new_n134_), .b(new_n129_), .c(new_n91_), .O(new_n157_));
  inv1   g95(.a(new_n157_), .O(z19));
  oai21  g96(.a(new_n69_), .b(new_n66_), .c(new_n132_), .O(new_n159_));
  oai21  g97(.a(new_n159_), .b(new_n127_), .c(new_n91_), .O(z20));
endmodule
