...
module FAU ( 
  ...
  inv1   g35(.a(new_n64_), .O(new_n98_));
  nand3  g36(.a(new_n95_), .b(new_n98_), .c(new_n97_), .O(z04));
  nand3  g37(.a(new_n94_), .b(new_n98_), .c(new_n93_), .O(z05));
  ...
  and2   g46(.a(x34), .b(x27), .O(new_n109_));
  nand3  g47(.a(new_n109_), .b(x26), .c(x11), .O(new_n110_));
  nand2  g48(.a(new_n110_), .b(new_n98_), .O(z09));
  aoi21  g49(.a(new_n80_), .b(new_n79_), .c(new_n89_), .O(new_n112_));
  inv1   g50(.a(new_n112_), .O(new_n113_));
  inv1   g51(.a(x07), .O(new_n114_));
  nand2  g52(.a(new_n89_), .b(new_n114_), .O(new_n115_));
  nand3  g53(.a(new_n115_), .b(new_n83_), .c(x27), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  inv1   g55(.a(x05), .O(new_n118_));
  aoi21  g56(.a(new_n72_), .b(new_n118_), .c(x04), .O(new_n119_));
  nand2  g57(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g58(.a(x37), .b(x27), .c(x06), .O(new_n121_));
  aoi21  g59(.a(new_n121_), .b(new_n120_), .c(new_n64_), .O(z10));
  inv1   g60(.a(x08), .O(new_n123_));
  nand2  g61(.a(new_n72_), .b(x29), .O(new_n124_));
  aoi21  g62(.a(new_n124_), .b(new_n82_), .c(new_n123_), .O(new_n125_));
  nand2  g63(.a(new_n124_), .b(x27), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  inv1   g65(.a(new_n82_), .O(new_n128_));
  nor2   g66(.a(new_n66_), .b(x04), .O(new_n129_));
  inv1   g67(.a(x09), .O(new_n130_));
  nand2  g68(.a(new_n79_), .b(new_n130_), .O(new_n131_));
  aoi21  g69(.a(new_n129_), .b(new_n128_), .c(new_n131_), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n127_), .c(new_n98_), .O(new_n133_));
  inv1   g71(.a(new_n133_), .O(z11));
  inv1   g72(.a(new_n74_), .O(new_n135_));
  nand3  g73(.a(new_n75_), .b(new_n135_), .c(new_n98_), .O(new_n136_));
  ...
  oai21  g80(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n143_));
  nand3  g81(.a(new_n143_), .b(new_n138_), .c(new_n72_), .O(new_n144_));
  nand2  g82(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g83(.a(new_n145_), .b(x27), .O(new_n146_));
  aoi21  g84(.a(new_n146_), .b(new_n139_), .c(new_n64_), .O(z13));
  nand2  g85(.a(new_n146_), .b(new_n139_), .O(new_n148_));
  nand2  g86(.a(new_n148_), .b(new_n98_), .O(z14));
  nand4  g87(.a(new_n109_), .b(new_n98_), .c(x26), .d(x12), .O(new_n150_));
  inv1   g88(.a(new_n150_), .O(z15));
  nand2  g89(.a(x22), .b(x01), .O(new_n152_));
  oai21  g90(.a(new_n152_), .b(x23), .c(new_n98_), .O(z16));
  inv1   g91(.a(x24), .O(new_n154_));
  inv1   g92(.a(new_n152_), .O(new_n155_));
  nand4  g93(.a(new_n155_), .b(new_n98_), .c(new_n154_), .d(x23), .O(new_n156_));
  inv1   g94(.a(new_n156_), .O(z17));
  aoi21  g95(.a(new_n132_), .b(new_n127_), .c(new_n64_), .O(z18));
  nor2   g96(.a(new_n131_), .b(new_n64_), .O(new_n159_));
  oai21  g97(.a(new_n69_), .b(new_n66_), .c(new_n159_), .O(new_n160_));
  nor2   g98(.a(new_n160_), .b(new_n125_), .O(z20));
  inv1   g99(.a(new_n133_), .O(z19));
endmodule
