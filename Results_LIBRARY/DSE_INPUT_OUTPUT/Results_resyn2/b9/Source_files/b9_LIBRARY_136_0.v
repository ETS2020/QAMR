...
module FAU ( 
  ...
  nor2   g009(.a(x32), .b(x23), .O(new_n72_));
  ...
  nand2  g018(.a(new_n80_), .b(x23), .O(new_n81_));
  oai22  g019(.a(new_n81_), .b(new_n79_), .c(new_n72_), .d(x04), .O(z01));
  ...
  nand3  g035(.a(new_n97_), .b(new_n89_), .c(new_n92_), .O(z05));
  ...
  nand3  g046(.a(new_n108_), .b(new_n89_), .c(x03), .O(new_n109_));
  nor2   g047(.a(new_n109_), .b(new_n104_), .O(z07));
  nor2   g048(.a(new_n72_), .b(new_n85_), .O(z08));
  inv1   g049(.a(x11), .O(new_n112_));
  nand4  g050(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n113_));
  nor2   g051(.a(new_n113_), .b(new_n112_), .O(z09));
  inv1   g052(.a(x23), .O(new_n115_));
  inv1   g053(.a(x32), .O(new_n116_));
  ...
  nand2  g058(.a(new_n85_), .b(new_n120_), .O(new_n121_));
  nand2  g059(.a(x23), .b(x05), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(x40), .c(x39), .O(new_n123_));
  nand4  g061(.a(new_n123_), .b(new_n121_), .c(new_n119_), .d(new_n117_), .O(new_n124_));
  nand3  g062(.a(new_n89_), .b(x37), .c(x06), .O(new_n125_));
  ...
  oai21  g067(.a(new_n129_), .b(new_n115_), .c(new_n116_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n128_), .c(x05), .d(new_n65_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n127_), .O(z10));
  inv1   g070(.a(x08), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n78_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n134_), .b(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nor2   g075(.a(new_n118_), .b(new_n75_), .O(new_n138_));
  nor2   g076(.a(x28), .b(x04), .O(new_n139_));
  inv1   g077(.a(x09), .O(new_n140_));
  nand2  g078(.a(new_n129_), .b(new_n140_), .O(new_n141_));
  aoi21  g079(.a(new_n139_), .b(new_n138_), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n137_), .c(new_n89_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z11));
  nand2  g082(.a(new_n67_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n89_), .b(new_n68_), .c(new_n145_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(z12));
  nor2   g085(.a(x13), .b(x04), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n128_), .O(new_n149_));
  aoi21  g087(.a(x36), .b(x35), .c(new_n77_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x20), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(new_n63_), .c(new_n150_), .d(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  oai21  g092(.a(new_n149_), .b(new_n80_), .c(new_n89_), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(z13));
  aoi21  g095(.a(new_n153_), .b(x27), .c(new_n155_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  nor2   g097(.a(new_n113_), .b(new_n159_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(x32), .c(x23), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x23), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n161_), .c(new_n89_), .O(z17));
  aoi21  g103(.a(new_n142_), .b(new_n137_), .c(new_n72_), .O(z18));
  nand2  g104(.a(new_n142_), .b(new_n137_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n89_), .O(z19));
  oai21  g106(.a(new_n118_), .b(new_n75_), .c(new_n89_), .O(new_n169_));
  nor3   g107(.a(new_n169_), .b(new_n141_), .c(new_n135_), .O(z20));
endmodule
