...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n155_, new_n157_, new_n159_, new_n161_, new_n164_;
  ...
  inv1   g010(.a(x33), .O(new_n73_));
  nand2  g011(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g012(.a(new_n74_), .b(new_n71_), .c(x16), .O(z00));
  ...
  nand2  g021(.a(x33), .b(x16), .O(new_n84_));
  inv1   g022(.a(new_n84_), .O(new_n85_));
  nor2   g023(.a(new_n85_), .b(new_n65_), .O(new_n86_));
  oai21  g024(.a(new_n83_), .b(new_n80_), .c(new_n86_), .O(z01));
  ...
  nand2  g049(.a(new_n73_), .b(new_n111_), .O(new_n112_));
  ...
  nand2  g053(.a(new_n84_), .b(new_n90_), .O(z08));
  nand2  g054(.a(x34), .b(x27), .O(new_n117_));
  nand2  g055(.a(x26), .b(x11), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(new_n117_), .c(new_n84_), .O(z09));
  aoi21  g057(.a(new_n82_), .b(new_n81_), .c(new_n90_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n90_), .b(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n80_), .c(new_n120_), .O(new_n123_));
  oai21  g061(.a(new_n90_), .b(x05), .c(new_n65_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  and2   g063(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  oai21  g064(.a(new_n124_), .b(new_n123_), .c(new_n126_), .O(z10));
  ...
  and2   g070(.a(x35), .b(x27), .O(new_n133_));
  nor2   g071(.a(x28), .b(x04), .O(new_n134_));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(new_n81_), .b(new_n135_), .O(new_n136_));
  aoi21  g074(.a(new_n134_), .b(new_n133_), .c(new_n136_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n84_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n84_), .b(new_n69_), .c(new_n140_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z12));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n120_), .O(new_n144_));
  nand2  g082(.a(new_n94_), .b(new_n96_), .O(new_n145_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n144_), .c(new_n85_), .O(z13));
  inv1   g091(.a(new_n144_), .O(new_n154_));
  aoi21  g092(.a(new_n150_), .b(new_n147_), .c(new_n76_), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n154_), .c(new_n85_), .O(z14));
  nand3  g094(.a(new_n84_), .b(x26), .c(x12), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(new_n117_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n84_), .O(z16));
  inv1   g098(.a(x23), .O(new_n161_));
  nor4   g099(.a(new_n159_), .b(new_n85_), .c(x24), .d(new_n161_), .O(z17));
  nand3  g100(.a(new_n137_), .b(new_n132_), .c(new_n84_), .O(z18));
  or2    g101(.a(new_n133_), .b(new_n85_), .O(new_n164_));
  nor3   g102(.a(new_n164_), .b(new_n136_), .c(new_n130_), .O(z20));
  nand2  g103(.a(new_n138_), .b(new_n84_), .O(z19));
endmodule
