...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n164_, new_n165_, new_n166_, new_n168_, new_n170_;
  ...
  aoi21  g016(.a(new_n78_), .b(new_n77_), .c(x15), .O(new_n79_));
  ...
  nand2  g051(.a(new_n74_), .b(new_n64_), .O(z08));
  ...
  nand3  g059(.a(new_n121_), .b(new_n84_), .c(new_n76_), .O(new_n122_));
  nand3  g060(.a(x37), .b(x27), .c(x06), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(new_n124_));
  nor3   g062(.a(new_n119_), .b(new_n86_), .c(x04), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n122_), .c(new_n65_), .O(z10));
  ...
  nand3  g073(.a(new_n135_), .b(new_n132_), .c(new_n64_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n68_), .c(new_n138_), .O(new_n140_));
  nor2   g078(.a(new_n69_), .b(new_n68_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n74_), .b(x04), .c(new_n142_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n140_), .c(new_n64_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand4  g083(.a(x40), .b(x39), .c(new_n145_), .d(new_n70_), .O(new_n146_));
  oai21  g084(.a(x28), .b(new_n68_), .c(new_n86_), .O(new_n147_));
  nor2   g085(.a(new_n77_), .b(new_n68_), .O(new_n148_));
  nor2   g086(.a(new_n78_), .b(new_n63_), .O(new_n149_));
  aoi22  g087(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n64_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  nand4  g089(.a(new_n78_), .b(x20), .c(new_n63_), .d(new_n151_), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(new_n142_), .c(new_n150_), .d(new_n146_), .O(z13));
  nor2   g091(.a(new_n152_), .b(new_n142_), .O(new_n154_));
  nand2  g092(.a(new_n147_), .b(new_n64_), .O(new_n155_));
  nand3  g093(.a(new_n149_), .b(new_n141_), .c(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n155_), .c(new_n146_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(new_n154_), .O(z14));
  nand3  g096(.a(new_n116_), .b(new_n64_), .c(x12), .O(new_n159_));
  ...
  nand2  g105(.a(new_n135_), .b(new_n132_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n64_), .O(z19));
  or2    g107(.a(new_n148_), .b(new_n134_), .O(new_n170_));
