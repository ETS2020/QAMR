...
module FAU ( 
  ...
  or2    g018(.a(x32), .b(x30), .O(new_n81_));
  nor2   g019(.a(new_n73_), .b(new_n65_), .O(new_n82_));
  oai21  g020(.a(new_n81_), .b(new_n80_), .c(new_n82_), .O(z01));
  ...
  nand2  g036(.a(new_n98_), .b(new_n90_), .O(z05));
  inv1   g037(.a(new_n98_), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n90_), .O(z06));
  ...
  nand2  g053(.a(new_n115_), .b(new_n90_), .O(z09));
  inv1   g054(.a(new_n86_), .O(new_n117_));
  nand2  g055(.a(new_n81_), .b(new_n117_), .O(new_n118_));
  oai21  g056(.a(new_n91_), .b(x28), .c(new_n77_), .O(new_n119_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n90_), .O(z10));
  ...
  oai21  g078(.a(new_n63_), .b(new_n76_), .c(new_n66_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n90_), .O(z12));
  ...
  oai22  g085(.a(new_n147_), .b(new_n63_), .c(new_n145_), .d(new_n143_), .O(new_n148_));
  ...
  nand4  g092(.a(new_n114_), .b(new_n90_), .c(x26), .d(x12), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(x36), .c(new_n72_), .O(z17));
  nand4  g098(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n90_), .O(z18));
  oai21  g099(.a(new_n91_), .b(new_n76_), .c(new_n135_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n131_), .c(new_n90_), .O(z20));
  nand2  g101(.a(new_n136_), .b(new_n90_), .O(z19));
endmodule
