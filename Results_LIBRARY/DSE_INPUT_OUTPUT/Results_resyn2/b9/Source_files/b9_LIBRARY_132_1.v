...
module FAU ( 
  ...
  nand4  g030(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(x22), .O(z02));
  ...
  nand3  g038(.a(new_n96_), .b(new_n72_), .c(new_n95_), .O(z05));
  ...
  aoi21  g051(.a(new_n90_), .b(x22), .c(new_n91_), .O(z08));
  ...
  oai21  g055(.a(new_n94_), .b(x28), .c(new_n76_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  oai21  g057(.a(new_n91_), .b(new_n90_), .c(new_n119_), .O(new_n120_));
  ...
  aoi21  g061(.a(new_n92_), .b(new_n123_), .c(x04), .O(new_n124_));
  ...
  nand3  g076(.a(new_n138_), .b(new_n132_), .c(new_n72_), .O(z18));
  ...
  nand2  g081(.a(new_n143_), .b(new_n95_), .O(new_n144_));
  aoi22  g082(.a(new_n144_), .b(x27), .c(x39), .d(new_n64_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n142_), .c(x22), .O(new_n146_));
  ...
  nand4  g092(.a(new_n154_), .b(new_n152_), .c(new_n92_), .d(x22), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  nand4  g095(.a(new_n152_), .b(new_n92_), .c(new_n81_), .d(x22), .O(new_n158_));
  ...
  nand2  g106(.a(new_n168_), .b(new_n72_), .O(z15));
  ...
  nand2  g112(.a(new_n138_), .b(new_n132_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n72_), .O(z19));
  nand2  g114(.a(x35), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n136_), .c(new_n135_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n130_), .c(new_n72_), .O(z20));
endmodule
