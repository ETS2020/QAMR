...
module FAU ( 
  ...
  aoi21  g056(.a(new_n71_), .b(x39), .c(new_n118_), .O(new_n119_));
  ...
  nor2   g077(.a(new_n71_), .b(new_n88_), .O(new_n140_));
  ...
  nand3  g091(.a(x39), .b(new_n153_), .c(new_n64_), .O(new_n154_));
