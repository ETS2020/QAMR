...
module FAU ( 
  ...
  inv1   g012(.a(x25), .O(new_n75_));
  nor2   g013(.a(x35), .b(new_n75_), .O(new_n76_));
  ...
  aoi21  g018(.a(new_n80_), .b(new_n79_), .c(x25), .O(new_n81_));
  ...
  oai21  g029(.a(x25), .b(x04), .c(new_n91_), .O(new_n92_));
  ...
  aoi21  g038(.a(new_n95_), .b(new_n94_), .c(new_n76_), .O(z05));
  nand2  g039(.a(new_n95_), .b(new_n94_), .O(new_n102_));
  nor2   g040(.a(new_n102_), .b(new_n76_), .O(z06));
  nand2  g041(.a(new_n75_), .b(x00), .O(new_n104_));
  ...
  nor2   g051(.a(new_n76_), .b(new_n69_), .O(z08));
  ...
  aoi21  g057(.a(x35), .b(new_n82_), .c(x36), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  oai21  g059(.a(new_n120_), .b(new_n119_), .c(new_n80_), .O(new_n122_));
  nand2  g060(.a(new_n65_), .b(x05), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(new_n124_));
  and2   g062(.a(new_n69_), .b(x07), .O(new_n125_));
  aoi22  g063(.a(new_n125_), .b(new_n121_), .c(new_n124_), .d(new_n122_), .O(new_n126_));
  nand3  g064(.a(x37), .b(x27), .c(x06), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n76_), .O(new_n129_));
  oai21  g067(.a(new_n126_), .b(x04), .c(new_n129_), .O(z10));
  inv1   g068(.a(x08), .O(new_n131_));
  nand2  g069(.a(x35), .b(new_n82_), .O(new_n132_));
  nand2  g070(.a(new_n65_), .b(x29), .O(new_n133_));
  ...
  nand4  g074(.a(x35), .b(new_n82_), .c(x27), .d(new_n64_), .O(new_n137_));
  nor2   g075(.a(x30), .b(x09), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n136_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n99_), .O(z11));
  oai21  g078(.a(new_n70_), .b(x28), .c(x35), .O(new_n141_));
  aoi21  g079(.a(new_n70_), .b(x36), .c(x37), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n99_), .b(new_n71_), .O(new_n144_));
  aoi21  g082(.a(new_n143_), .b(x27), .c(new_n144_), .O(z12));
  inv1   g083(.a(x18), .O(new_n146_));
  inv1   g084(.a(x19), .O(new_n147_));
  nand4  g085(.a(x37), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n148_));
  nor2   g086(.a(x13), .b(x04), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n65_), .c(new_n82_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n148_), .c(new_n119_), .O(new_n151_));
  nand2  g089(.a(new_n149_), .b(new_n65_), .O(new_n152_));
  nor2   g090(.a(new_n152_), .b(new_n80_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n99_), .O(new_n154_));
  nand3  g092(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n155_));
  oai22  g093(.a(new_n152_), .b(new_n79_), .c(new_n155_), .d(new_n82_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(x35), .c(x27), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n154_), .O(z13));
  aoi21  g096(.a(x36), .b(x35), .c(new_n82_), .O(new_n159_));
  oai22  g097(.a(new_n159_), .b(new_n152_), .c(new_n155_), .d(new_n67_), .O(new_n160_));
  oai21  g098(.a(new_n152_), .b(new_n80_), .c(new_n99_), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(x27), .c(new_n161_), .O(z14));
  nand3  g100(.a(new_n116_), .b(new_n99_), .c(x12), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z15));
  nand2  g102(.a(x22), .b(x01), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(x23), .c(new_n99_), .O(z16));
  inv1   g104(.a(x24), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x23), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n165_), .c(new_n99_), .O(z17));
  nand4  g107(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n99_), .O(z18));
  oai21  g108(.a(new_n91_), .b(new_n119_), .c(new_n138_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n134_), .c(new_n99_), .O(z20));
  nand2  g110(.a(new_n139_), .b(new_n99_), .O(z19));
endmodule
