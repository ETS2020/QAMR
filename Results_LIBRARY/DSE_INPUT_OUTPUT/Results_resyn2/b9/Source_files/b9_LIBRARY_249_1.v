...
module FAU ( 
  ...
  aoi21  g038(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n64_), .O(z04));
  oai21  g040(.a(new_n82_), .b(new_n66_), .c(new_n67_), .O(new_n103_));
  ...
  nor2   g053(.a(new_n93_), .b(new_n64_), .O(z08));
  nand3  g054(.a(x34), .b(x27), .c(x26), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n97_), .c(x11), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(z09));
  nor2   g058(.a(new_n83_), .b(new_n66_), .O(new_n121_));
  nand2  g059(.a(new_n75_), .b(x05), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(new_n123_));
  and2   g061(.a(new_n93_), .b(x07), .O(new_n124_));
  aoi22  g062(.a(new_n124_), .b(new_n121_), .c(new_n123_), .d(new_n85_), .O(new_n125_));
  nand3  g063(.a(x37), .b(x27), .c(x06), .O(new_n126_));
  inv1   g064(.a(new_n126_), .O(new_n127_));
  nor2   g065(.a(new_n127_), .b(new_n64_), .O(new_n128_));
  oai21  g066(.a(new_n125_), .b(x04), .c(new_n128_), .O(z10));
  nand2  g067(.a(new_n75_), .b(x29), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n94_), .c(new_n87_), .O(new_n131_));
  nand2  g069(.a(new_n130_), .b(x27), .O(new_n132_));
  nand4  g070(.a(x35), .b(new_n82_), .c(x27), .d(new_n71_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n97_), .O(new_n135_));
  aoi21  g073(.a(new_n132_), .b(new_n131_), .c(new_n135_), .O(z11));
  inv1   g074(.a(new_n77_), .O(new_n137_));
  nand3  g075(.a(new_n78_), .b(new_n137_), .c(new_n97_), .O(new_n138_));
  ...
  nor2   g085(.a(new_n147_), .b(new_n84_), .O(new_n148_));
  ...
  nand3  g089(.a(new_n118_), .b(new_n97_), .c(x12), .O(new_n152_));
  ...
  nand4  g095(.a(new_n157_), .b(new_n97_), .c(new_n156_), .d(x23), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(z17));
  inv1   g097(.a(z11), .O(z18));
  oai21  g098(.a(new_n72_), .b(new_n66_), .c(new_n134_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n131_), .c(new_n97_), .O(z20));
