...
module FAU ( 
  ...
  nand3  g036(.a(new_n98_), .b(new_n89_), .c(new_n93_), .O(z05));
  ...
  nand2  g049(.a(new_n89_), .b(new_n85_), .O(z08));
  nand4  g050(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n89_), .O(z09));
  nor2   g052(.a(new_n92_), .b(x04), .O(new_n115_));
  or2    g053(.a(new_n85_), .b(x05), .O(new_n116_));
  inv1   g054(.a(x07), .O(new_n117_));
  nand2  g055(.a(new_n85_), .b(new_n117_), .O(new_n118_));
  nand4  g056(.a(new_n118_), .b(new_n116_), .c(new_n115_), .d(new_n79_), .O(new_n119_));
  nor2   g057(.a(new_n76_), .b(new_n66_), .O(new_n120_));
  nand3  g058(.a(x37), .b(x27), .c(x06), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n120_), .b(x05), .c(new_n122_), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n119_), .c(new_n73_), .O(z10));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n130_), .c(new_n133_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n129_), .c(new_n89_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(z11));
  nand2  g074(.a(new_n67_), .b(x27), .O(new_n137_));
  nand3  g075(.a(new_n89_), .b(new_n68_), .c(new_n137_), .O(new_n138_));
  ...
  nor2   g081(.a(new_n85_), .b(x04), .O(new_n144_));
  oai21  g082(.a(new_n72_), .b(new_n90_), .c(x28), .O(new_n145_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n144_), .c(new_n143_), .O(new_n150_));
  ...
  nand2  g092(.a(new_n154_), .b(new_n89_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x23), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n156_), .c(new_n89_), .O(z17));
  aoi21  g098(.a(new_n134_), .b(new_n129_), .c(new_n73_), .O(z18));
  nor2   g099(.a(new_n133_), .b(new_n73_), .O(new_n162_));
  oai21  g100(.a(new_n90_), .b(new_n92_), .c(new_n162_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n127_), .O(z20));
  inv1   g102(.a(new_n135_), .O(z19));
endmodule
