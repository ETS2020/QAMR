...
module FAU ( 
  ...
  nor2   g022(.a(new_n63_), .b(new_n84_), .O(new_n85_));
  ...
  oai21  g052(.a(new_n114_), .b(new_n113_), .c(new_n105_), .O(z09));
  inv1   g053(.a(x35), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(x28), .c(new_n78_), .O(new_n117_));
  ...
  oai21  g059(.a(new_n78_), .b(new_n118_), .c(new_n121_), .O(new_n122_));
  inv1   g060(.a(x05), .O(new_n123_));
  nand3  g061(.a(x40), .b(x39), .c(new_n123_), .O(new_n124_));
  nand4  g062(.a(new_n124_), .b(new_n122_), .c(new_n120_), .d(new_n117_), .O(new_n125_));
  nand3  g063(.a(new_n105_), .b(x37), .c(x06), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x27), .O(new_n128_));
  nor3   g066(.a(new_n82_), .b(new_n74_), .c(x04), .O(new_n129_));
  ...
  nor2   g072(.a(new_n116_), .b(x28), .O(new_n135_));
  oai21  g073(.a(new_n66_), .b(new_n84_), .c(new_n135_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n134_), .c(new_n105_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand3  g076(.a(new_n135_), .b(x27), .c(new_n84_), .O(new_n139_));
  oai21  g077(.a(new_n78_), .b(x27), .c(new_n121_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n139_), .c(new_n138_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n137_), .c(new_n133_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n66_), .c(new_n71_), .O(new_n144_));
  or2    g082(.a(new_n75_), .b(new_n69_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n105_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  oai21  g085(.a(new_n78_), .b(new_n116_), .c(x28), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n75_), .c(new_n147_), .O(new_n149_));
  nand2  g087(.a(new_n68_), .b(new_n67_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n150_), .c(new_n105_), .d(x20), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n129_), .b(new_n147_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  inv1   g094(.a(new_n148_), .O(new_n157_));
  nand2  g095(.a(new_n67_), .b(new_n116_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n151_), .c(x20), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n157_), .c(new_n66_), .O(new_n160_));
  nand2  g098(.a(new_n75_), .b(new_n147_), .O(new_n161_));
  nand3  g099(.a(new_n151_), .b(new_n69_), .c(x20), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n63_), .O(new_n163_));
  oai21  g101(.a(new_n160_), .b(new_n83_), .c(new_n163_), .O(z14));
  nand2  g102(.a(x26), .b(x12), .O(new_n165_));
  nor3   g103(.a(new_n165_), .b(new_n113_), .c(new_n63_), .O(z15));
  inv1   g104(.a(x23), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(x22), .c(x01), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n105_), .O(z16));
  nor2   g107(.a(x24), .b(new_n167_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n105_), .c(x22), .d(x01), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z17));
  aoi21  g110(.a(new_n134_), .b(new_n80_), .c(new_n138_), .O(new_n173_));
  nand2  g111(.a(new_n134_), .b(x27), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n139_), .c(new_n132_), .d(new_n105_), .O(z18));
  nand3  g114(.a(new_n175_), .b(new_n139_), .c(new_n132_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n105_), .O(z19));
  oai21  g116(.a(new_n116_), .b(new_n66_), .c(new_n132_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n173_), .c(new_n105_), .O(z20));
endmodule
