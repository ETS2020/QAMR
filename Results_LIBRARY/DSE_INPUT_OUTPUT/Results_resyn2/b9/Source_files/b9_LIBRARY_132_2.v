...
module FAU ( 
  ...
  nand2  g009(.a(new_n71_), .b(x22), .O(new_n72_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n131_), .c(new_n72_), .O(z18));
  ...
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n115_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x20), .O(new_n147_));
  nand2  g085(.a(x35), .b(x28), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n93_), .O(new_n149_));
  nand2  g087(.a(new_n72_), .b(new_n149_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n147_), .c(new_n145_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand3  g090(.a(new_n144_), .b(new_n115_), .c(new_n82_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand2  g092(.a(new_n144_), .b(new_n115_), .O(new_n155_));
  nand4  g093(.a(new_n142_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(new_n147_), .O(new_n158_));
  aoi21  g096(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n159_));
  oai22  g097(.a(new_n159_), .b(new_n155_), .c(new_n66_), .d(new_n75_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(new_n72_), .O(z14));
  nand4  g099(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n72_), .O(z15));
  inv1   g101(.a(x23), .O(new_n164_));
  nand4  g102(.a(x40), .b(new_n164_), .c(x22), .d(x01), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z16));
  inv1   g104(.a(x22), .O(new_n167_));
  inv1   g105(.a(x24), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x23), .c(x01), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(x40), .c(new_n167_), .O(z17));
  nand2  g108(.a(new_n136_), .b(new_n131_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n72_), .O(z19));
  nand2  g110(.a(x35), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n80_), .c(new_n134_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n129_), .c(new_n72_), .O(z20));
endmodule
