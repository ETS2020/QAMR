...
module FAU ( 
  ...
  nor2   g008(.a(x18), .b(x02), .O(new_n71_));
  ...
  oai21  g020(.a(x27), .b(new_n63_), .c(x02), .O(new_n83_));
  nand2  g021(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  inv1   g022(.a(x02), .O(new_n85_));
  nand2  g023(.a(x29), .b(x18), .O(new_n86_));
  nand2  g024(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g025(.a(x40), .b(x39), .O(new_n88_));
  aoi21  g026(.a(new_n76_), .b(x04), .c(new_n88_), .O(new_n89_));
  nand3  g027(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(z02));
  ...
  nor2   g039(.a(new_n101_), .b(new_n71_), .O(z06));
  inv1   g040(.a(new_n71_), .O(new_n103_));
  ...
  nor2   g052(.a(new_n71_), .b(new_n88_), .O(z08));
  ...
  nand2  g077(.a(new_n103_), .b(new_n69_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  aoi21  g079(.a(x36), .b(x35), .c(new_n75_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(new_n93_), .O(new_n143_));
  nor2   g081(.a(new_n143_), .b(new_n123_), .O(new_n144_));
  nor2   g082(.a(x13), .b(x04), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(z08), .O(new_n146_));
  or2    g084(.a(new_n66_), .b(new_n93_), .O(new_n147_));
  ...
  nand2  g089(.a(new_n151_), .b(x02), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(new_n147_), .c(new_n146_), .d(new_n144_), .O(z13));
  nand2  g091(.a(new_n145_), .b(new_n130_), .O(new_n154_));
  nand2  g092(.a(new_n142_), .b(new_n79_), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(new_n150_), .O(new_n157_));
  aoi21  g095(.a(new_n75_), .b(x27), .c(new_n123_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n154_), .c(new_n147_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n157_), .c(new_n103_), .O(z14));
  nand2  g098(.a(x26), .b(x12), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n116_), .c(new_n71_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  nor3   g101(.a(new_n163_), .b(new_n71_), .c(x23), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  inv1   g103(.a(new_n163_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n103_), .c(new_n165_), .d(x23), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z17));
  aoi21  g106(.a(new_n137_), .b(new_n134_), .c(new_n71_), .O(z18));
  nand2  g107(.a(x35), .b(x27), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n135_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n132_), .c(new_n103_), .O(z20));
  nand2  g110(.a(new_n138_), .b(new_n103_), .O(z19));
endmodule
