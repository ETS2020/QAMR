...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n147_, new_n148_, new_n151_, new_n153_, new_n155_, new_n158_;
  inv1   g00(.a(x02), .O(new_n63_));
  inv1   g01(.a(x14), .O(new_n64_));
  ...
  nand2  g31(.a(new_n93_), .b(new_n63_), .O(new_n94_));
  nor2   g32(.a(new_n79_), .b(new_n65_), .O(z08));
  nand3  g33(.a(z08), .b(new_n94_), .c(new_n92_), .O(z02));
  inv1   g34(.a(new_n65_), .O(new_n97_));
  nand2  g35(.a(new_n69_), .b(x27), .O(new_n98_));
  nand2  g36(.a(new_n68_), .b(new_n67_), .O(new_n99_));
  nand4  g37(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(x21), .O(z03));
  ...
  aoi21  g41(.a(new_n103_), .b(new_n68_), .c(new_n65_), .O(z05));
  inv1   g42(.a(z05), .O(z06));
  inv1   g43(.a(x25), .O(new_n106_));
  nand2  g44(.a(new_n106_), .b(x00), .O(new_n107_));
  nand2  g45(.a(x25), .b(new_n64_), .O(new_n108_));
  ...
  nand2  g52(.a(new_n114_), .b(new_n97_), .O(z07));
  inv1   g53(.a(x11), .O(new_n116_));
  nand4  g54(.a(new_n97_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g55(.a(new_n117_), .b(new_n116_), .O(z09));
  nor2   g56(.a(new_n86_), .b(new_n67_), .O(new_n119_));
  nand2  g57(.a(new_n76_), .b(x05), .O(new_n120_));
  inv1   g58(.a(new_n120_), .O(new_n121_));
  and2   g59(.a(new_n79_), .b(x07), .O(new_n122_));
  aoi22  g60(.a(new_n122_), .b(new_n119_), .c(new_n121_), .d(new_n88_), .O(new_n123_));
  nand3  g61(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  inv1   g62(.a(new_n124_), .O(new_n125_));
  nor2   g63(.a(new_n125_), .b(new_n65_), .O(new_n126_));
  oai21  g64(.a(new_n123_), .b(x04), .c(new_n126_), .O(z10));
  inv1   g65(.a(x08), .O(new_n128_));
  nand2  g66(.a(new_n76_), .b(x29), .O(new_n129_));
  aoi21  g67(.a(new_n129_), .b(new_n90_), .c(new_n128_), .O(new_n130_));
  ...
  nand2  g83(.a(new_n140_), .b(new_n76_), .O(new_n146_));
  nor2   g84(.a(new_n146_), .b(new_n87_), .O(new_n147_));
  inv1   g85(.a(new_n147_), .O(new_n148_));
  aoi21  g86(.a(new_n148_), .b(new_n145_), .c(new_n65_), .O(z13));
  nor3   g87(.a(new_n147_), .b(new_n144_), .c(new_n65_), .O(z14));
  inv1   g88(.a(x12), .O(new_n151_));
  nor2   g89(.a(new_n117_), .b(new_n151_), .O(z15));
  nand2  g90(.a(x22), .b(x01), .O(new_n153_));
  oai21  g91(.a(new_n153_), .b(x23), .c(new_n97_), .O(z16));
  inv1   g92(.a(x23), .O(new_n155_));
  nor4   g93(.a(new_n153_), .b(new_n65_), .c(x24), .d(new_n155_), .O(z17));
  inv1   g94(.a(z11), .O(z18));
  oai21  g95(.a(new_n73_), .b(new_n67_), .c(new_n133_), .O(new_n158_));
  oai21  g96(.a(new_n158_), .b(new_n130_), .c(new_n97_), .O(z20));
  aoi21  g97(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z19));
endmodule
