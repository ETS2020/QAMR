...
module FAU ( 
  ...
  inv1   g011(.a(x22), .O(new_n74_));
  nor2   g012(.a(new_n74_), .b(x01), .O(new_n75_));
  ...
  nor2   g028(.a(new_n90_), .b(new_n68_), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(new_n89_), .c(new_n75_), .O(z02));
  ...
  inv1   g045(.a(new_n75_), .O(new_n108_));
  ...
  nand2  g052(.a(new_n108_), .b(new_n68_), .O(z08));
  nand3  g053(.a(x34), .b(x27), .c(x26), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(new_n117_));
  nand3  g055(.a(new_n117_), .b(new_n108_), .c(x11), .O(new_n118_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n128_), .c(new_n75_), .O(z10));
  inv1   g068(.a(x08), .O(new_n131_));
  nand2  g069(.a(new_n69_), .b(x29), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n81_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n132_), .b(x27), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n80_), .c(x27), .d(new_n65_), .O(new_n135_));
  nor2   g073(.a(x30), .b(x09), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n108_), .O(new_n137_));
  aoi21  g075(.a(new_n134_), .b(new_n133_), .c(new_n137_), .O(z11));
  and2   g076(.a(new_n67_), .b(x27), .O(new_n139_));
  oai21  g077(.a(new_n71_), .b(new_n139_), .c(new_n108_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  nand3  g079(.a(new_n69_), .b(new_n141_), .c(new_n65_), .O(new_n142_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n85_), .c(new_n75_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  nand3  g088(.a(new_n143_), .b(new_n84_), .c(new_n83_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n145_), .O(new_n153_));
  aoi21  g091(.a(new_n80_), .b(x27), .c(new_n85_), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(new_n142_), .c(new_n63_), .d(new_n78_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(new_n108_), .O(z14));
  nand3  g094(.a(new_n117_), .b(new_n108_), .c(x12), .O(new_n157_));
  ...
  oai21  g102(.a(new_n93_), .b(new_n78_), .c(new_n136_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n133_), .c(new_n108_), .O(z20));
  aoi21  g104(.a(new_n134_), .b(new_n133_), .c(new_n137_), .O(z19));
endmodule
