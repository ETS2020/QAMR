...
module FAU ( 
  ...
  nor3   g053(.a(new_n115_), .b(new_n72_), .c(new_n114_), .O(z09));
  ...
  nor2   g064(.a(new_n112_), .b(x04), .O(new_n127_));
  inv1   g065(.a(new_n78_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(x05), .O(new_n129_));
  oai21  g067(.a(new_n126_), .b(new_n84_), .c(new_n129_), .O(z10));
  nand3  g068(.a(x35), .b(new_n121_), .c(new_n65_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n84_), .c(new_n83_), .O(new_n132_));
  nand3  g070(.a(x40), .b(x39), .c(x29), .O(new_n133_));
  nor2   g071(.a(new_n84_), .b(new_n65_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n122_), .c(new_n133_), .O(new_n135_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n105_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand2  g078(.a(new_n68_), .b(new_n140_), .O(new_n141_));
  nand2  g079(.a(new_n105_), .b(new_n141_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  oai21  g081(.a(new_n120_), .b(new_n75_), .c(x28), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n127_), .c(new_n143_), .O(new_n145_));
  oai21  g083(.a(new_n75_), .b(new_n121_), .c(new_n90_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n105_), .c(new_n146_), .d(x20), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand3  g088(.a(new_n128_), .b(new_n127_), .c(new_n143_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(new_n147_), .b(new_n146_), .c(x20), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n145_), .O(new_n154_));
  nand2  g092(.a(new_n151_), .b(new_n105_), .O(new_n155_));
  aoi21  g093(.a(new_n154_), .b(x27), .c(new_n155_), .O(z14));
  inv1   g094(.a(x12), .O(new_n157_));
  oai21  g095(.a(new_n115_), .b(new_n157_), .c(new_n105_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n105_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n105_), .O(z17));
  aoi21  g101(.a(new_n84_), .b(new_n83_), .c(new_n122_), .O(new_n164_));
  inv1   g102(.a(new_n134_), .O(new_n165_));
  inv1   g103(.a(new_n137_), .O(new_n166_));
  aoi21  g104(.a(new_n165_), .b(new_n164_), .c(new_n166_), .O(new_n167_));
  nand3  g105(.a(z08), .b(x29), .c(x08), .O(new_n168_));
  oai21  g106(.a(new_n167_), .b(new_n72_), .c(new_n168_), .O(z18));
  nand2  g107(.a(new_n137_), .b(new_n105_), .O(new_n170_));
  nand2  g108(.a(new_n131_), .b(x39), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n83_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n135_), .c(new_n170_), .O(z19));
  aoi21  g112(.a(new_n133_), .b(new_n122_), .c(new_n83_), .O(new_n175_));
  nor2   g113(.a(new_n75_), .b(new_n84_), .O(new_n176_));
  nor3   g114(.a(new_n176_), .b(new_n175_), .c(new_n170_), .O(z20));
endmodule
