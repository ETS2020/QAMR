...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n166_, new_n168_, new_n169_, new_n173_;
  ...
  nor3   g025(.a(new_n87_), .b(new_n72_), .c(new_n86_), .O(new_n88_));
  ...
  nand4  g032(.a(new_n94_), .b(new_n91_), .c(new_n76_), .d(x21), .O(z03));
  aoi21  g033(.a(new_n93_), .b(new_n92_), .c(x21), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n91_), .c(new_n73_), .O(z04));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n73_), .O(z05));
  inv1   g037(.a(new_n98_), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n73_), .O(z06));
  ...
  nand2  g051(.a(new_n113_), .b(new_n76_), .O(z09));
  ...
  aoi21  g056(.a(new_n78_), .b(new_n118_), .c(x04), .O(new_n119_));
  nand2  g057(.a(x37), .b(x06), .O(new_n120_));
  aoi21  g058(.a(x40), .b(new_n86_), .c(new_n120_), .O(new_n121_));
  aoi21  g059(.a(new_n119_), .b(new_n117_), .c(new_n121_), .O(new_n122_));
  inv1   g060(.a(new_n116_), .O(new_n123_));
  nor2   g061(.a(new_n81_), .b(x04), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g063(.a(new_n122_), .b(new_n92_), .c(new_n125_), .O(z10));
  ...
  nor2   g069(.a(new_n92_), .b(x04), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(new_n134_));
  aoi21  g072(.a(new_n132_), .b(new_n79_), .c(new_n134_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n76_), .O(z11));
  nor2   g075(.a(new_n66_), .b(new_n92_), .O(new_n138_));
  inv1   g076(.a(x10), .O(new_n139_));
  oai21  g077(.a(new_n63_), .b(new_n92_), .c(new_n139_), .O(new_n140_));
  ...
  nor3   g089(.a(new_n81_), .b(x13), .c(x04), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n86_), .c(x40), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n151_), .O(z13));
  nand2  g092(.a(new_n93_), .b(new_n90_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x20), .c(new_n145_), .d(new_n144_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n147_), .c(new_n92_), .O(new_n157_));
  nand2  g095(.a(new_n81_), .b(x39), .O(new_n158_));
  oai21  g096(.a(new_n148_), .b(new_n86_), .c(x40), .O(new_n159_));
  inv1   g097(.a(new_n146_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n138_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  oai21  g100(.a(new_n158_), .b(new_n157_), .c(new_n162_), .O(z14));
  nand4  g101(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n76_), .O(z15));
  nand2  g103(.a(x22), .b(x01), .O(new_n166_));
  nor3   g104(.a(new_n166_), .b(new_n73_), .c(x23), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x23), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n166_), .c(new_n76_), .O(z17));
  nand3  g108(.a(new_n135_), .b(new_n131_), .c(new_n76_), .O(z18));
  inv1   g109(.a(z18), .O(z19));
  oai21  g110(.a(new_n90_), .b(new_n92_), .c(new_n133_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n129_), .c(new_n76_), .O(z20));
  buf    g112(.a(x40), .O(z08));
endmodule
