...
module FAU ( 
  ...
  nand2  g025(.a(new_n74_), .b(new_n87_), .O(z08));
  aoi21  g026(.a(x29), .b(x08), .c(x02), .O(new_n89_));
  nor2   g027(.a(new_n78_), .b(x28), .O(new_n90_));
  ...
  nand2  g068(.a(new_n90_), .b(new_n66_), .O(new_n131_));
  ...
  aoi21  g078(.a(new_n133_), .b(x08), .c(new_n140_), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n66_), .c(new_n71_), .O(new_n143_));
  or2    g081(.a(new_n75_), .b(new_n69_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n87_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  oai21  g084(.a(new_n79_), .b(new_n78_), .c(x28), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n75_), .c(new_n146_), .O(new_n148_));
  nand2  g086(.a(new_n68_), .b(new_n67_), .O(new_n149_));
  nor2   g087(.a(x19), .b(x18), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n149_), .c(new_n87_), .d(x20), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n118_), .b(new_n75_), .c(new_n146_), .O(new_n154_));
  ...
  oai21  g103(.a(new_n165_), .b(new_n162_), .c(new_n87_), .O(z17));
  nand2  g104(.a(x27), .b(x04), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n92_), .c(new_n90_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n137_), .c(new_n136_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n87_), .O(new_n170_));
  nand3  g108(.a(new_n117_), .b(x29), .c(x08), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(z18));
  oai21  g110(.a(new_n78_), .b(x28), .c(new_n132_), .O(new_n173_));
  oai21  g111(.a(new_n78_), .b(new_n66_), .c(new_n139_), .O(new_n174_));
  aoi21  g112(.a(new_n173_), .b(x08), .c(new_n174_), .O(z20));
  aoi21  g113(.a(new_n133_), .b(x08), .c(new_n140_), .O(z19));
endmodule
