...
module FAU ( 
  ...
  nand2  g011(.a(new_n73_), .b(x14), .O(new_n74_));
  oai21  g012(.a(new_n72_), .b(new_n70_), .c(new_n74_), .O(z00));
  ...
  nor2   g021(.a(x16), .b(x14), .O(new_n84_));
  ...
  aoi21  g029(.a(new_n91_), .b(new_n88_), .c(new_n84_), .O(z02));
  nand2  g030(.a(x35), .b(x28), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(x27), .c(new_n84_), .O(new_n94_));
  ...
  nand2  g052(.a(new_n108_), .b(new_n89_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand4  g054(.a(new_n108_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(z09));
  nor2   g056(.a(x32), .b(x30), .O(new_n119_));
  nor2   g057(.a(new_n119_), .b(new_n89_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n89_), .b(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n80_), .c(new_n120_), .O(new_n123_));
  oai21  g061(.a(new_n89_), .b(x05), .c(new_n65_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(new_n84_), .O(new_n127_));
  ...
  nor2   g072(.a(new_n76_), .b(x04), .O(new_n135_));
  inv1   g073(.a(x09), .O(new_n136_));
  nand2  g074(.a(new_n81_), .b(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n133_), .c(new_n108_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  nand2  g078(.a(new_n67_), .b(x27), .O(new_n141_));
  nand3  g079(.a(new_n108_), .b(new_n68_), .c(new_n141_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z12));
  inv1   g081(.a(new_n89_), .O(new_n144_));
  ...
  oai21  g089(.a(new_n151_), .b(new_n63_), .c(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(new_n147_), .b(new_n120_), .c(new_n84_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand2  g093(.a(new_n147_), .b(new_n144_), .O(new_n156_));
  nand3  g094(.a(new_n145_), .b(new_n119_), .c(x28), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(new_n151_), .O(new_n159_));
  aoi21  g097(.a(new_n78_), .b(x27), .c(new_n83_), .O(new_n160_));
  oai22  g098(.a(new_n160_), .b(new_n156_), .c(new_n63_), .d(new_n76_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n108_), .O(z14));
  inv1   g100(.a(x12), .O(new_n163_));
  nor2   g101(.a(new_n117_), .b(new_n163_), .O(z15));
  nand2  g102(.a(x22), .b(x01), .O(new_n165_));
  nor3   g103(.a(new_n165_), .b(new_n84_), .c(x23), .O(z16));
  ...
  aoi21  g108(.a(new_n138_), .b(new_n133_), .c(new_n84_), .O(z18));
  nand2  g109(.a(new_n138_), .b(new_n133_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n108_), .O(z19));
  nand2  g111(.a(x35), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n81_), .c(new_n136_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n131_), .c(new_n108_), .O(z20));
endmodule
