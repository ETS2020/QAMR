...
module FAU ( 
  ...
  nor2   g023(.a(new_n75_), .b(x28), .O(new_n86_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n82_), .c(new_n85_), .O(z02));
  nand2  g031(.a(x35), .b(x28), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x37), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n88_), .c(new_n72_), .O(new_n97_));
  ...
  nand2  g039(.a(new_n101_), .b(new_n84_), .O(z05));
  inv1   g040(.a(new_n101_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n84_), .O(z06));
  ...
  nand2  g060(.a(new_n83_), .b(new_n122_), .O(new_n123_));
  ...
  nor2   g085(.a(new_n83_), .b(x04), .O(new_n148_));
  oai21  g086(.a(new_n76_), .b(new_n75_), .c(x28), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n147_), .O(new_n150_));
  nand2  g088(.a(new_n94_), .b(new_n96_), .O(new_n151_));
  nor2   g089(.a(x19), .b(x18), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n84_), .c(new_n151_), .d(x20), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n120_), .b(new_n148_), .c(new_n147_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(new_n152_), .b(new_n151_), .c(x20), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n150_), .O(new_n159_));
  nand2  g097(.a(new_n156_), .b(new_n84_), .O(new_n160_));
  aoi21  g098(.a(new_n159_), .b(x27), .c(new_n160_), .O(z14));
  inv1   g099(.a(x12), .O(new_n162_));
  oai21  g100(.a(new_n118_), .b(new_n162_), .c(new_n84_), .O(z15));
  inv1   g101(.a(x23), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(x22), .c(x01), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n84_), .O(z16));
  nor2   g104(.a(x24), .b(new_n164_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n84_), .c(x22), .d(x01), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z17));
  nand3  g107(.a(new_n141_), .b(new_n136_), .c(new_n84_), .O(z18));
  inv1   g108(.a(z18), .O(z19));
  nor2   g109(.a(new_n140_), .b(new_n72_), .O(new_n172_));
  oai21  g110(.a(new_n75_), .b(new_n88_), .c(new_n172_), .O(new_n173_));
