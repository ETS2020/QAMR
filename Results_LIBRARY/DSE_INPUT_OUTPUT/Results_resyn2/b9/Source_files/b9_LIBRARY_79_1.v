...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x32), .O(new_n72_));
  ...
  nand3  g016(.a(new_n78_), .b(new_n77_), .c(new_n71_), .O(new_n79_));
  oai21  g017(.a(new_n72_), .b(x04), .c(new_n79_), .O(z01));
  ...
  nor2   g034(.a(new_n96_), .b(new_n72_), .O(z06));
  ...
  nand2  g047(.a(new_n103_), .b(new_n85_), .O(z08));
  nand3  g048(.a(x34), .b(x27), .c(x26), .O(new_n111_));
  inv1   g049(.a(new_n111_), .O(new_n112_));
  nand3  g050(.a(new_n112_), .b(new_n103_), .c(x11), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z09));
  aoi21  g052(.a(x35), .b(new_n81_), .c(x36), .O(new_n115_));
  nand2  g053(.a(new_n85_), .b(x07), .O(new_n116_));
  nand3  g054(.a(x40), .b(x39), .c(x05), .O(new_n117_));
  oai22  g055(.a(new_n117_), .b(new_n82_), .c(new_n116_), .d(new_n115_), .O(new_n118_));
  nor2   g056(.a(new_n117_), .b(new_n78_), .O(new_n119_));
  aoi21  g057(.a(new_n118_), .b(x27), .c(new_n119_), .O(new_n120_));
  ...
  inv1   g063(.a(new_n85_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x29), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n82_), .c(new_n125_), .O(new_n128_));
  nand2  g066(.a(new_n127_), .b(x27), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g068(.a(new_n76_), .b(x27), .c(new_n63_), .O(new_n131_));
  nor2   g069(.a(x30), .b(x09), .O(new_n132_));
  and2   g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n130_), .c(new_n103_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z11));
  nand2  g073(.a(new_n103_), .b(new_n69_), .O(new_n136_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n126_), .O(new_n142_));
  nand2  g080(.a(new_n71_), .b(new_n81_), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(new_n72_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  aoi21  g083(.a(new_n71_), .b(x30), .c(x32), .O(new_n146_));
  or2    g084(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  nand4  g086(.a(new_n139_), .b(new_n138_), .c(x27), .d(x20), .O(new_n149_));
  inv1   g087(.a(x27), .O(new_n150_));
  oai21  g088(.a(x28), .b(new_n150_), .c(new_n78_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n141_), .c(new_n126_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n149_), .c(new_n103_), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(z14));
  nand3  g092(.a(new_n112_), .b(new_n103_), .c(x12), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n103_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  inv1   g097(.a(new_n157_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n103_), .c(new_n159_), .d(x23), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z17));
  aoi21  g100(.a(new_n133_), .b(new_n130_), .c(new_n72_), .O(z18));
  nand2  g101(.a(new_n133_), .b(new_n130_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n103_), .O(z19));
  oai21  g103(.a(new_n75_), .b(new_n150_), .c(new_n132_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n128_), .c(new_n103_), .O(z20));
endmodule
