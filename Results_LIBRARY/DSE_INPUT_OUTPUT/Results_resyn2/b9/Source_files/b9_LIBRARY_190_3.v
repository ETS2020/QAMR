...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n162_, new_n164_, new_n165_, new_n169_;
  ...
  nand2  g013(.a(x16), .b(x14), .O(new_n76_));
  ...
  aoi21  g056(.a(new_n79_), .b(new_n78_), .c(new_n89_), .O(new_n119_));
  ...
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(new_n76_), .O(z10));
  ...
  nand2  g075(.a(new_n78_), .b(new_n137_), .O(new_n138_));
  aoi21  g076(.a(new_n136_), .b(new_n135_), .c(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n134_), .c(new_n76_), .O(new_n140_));
  ...
  nand4  g099(.a(new_n76_), .b(new_n161_), .c(x22), .d(x01), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x23), .c(x22), .d(x01), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n76_), .O(z17));
  aoi21  g104(.a(new_n139_), .b(new_n134_), .c(new_n77_), .O(z18));
  inv1   g105(.a(z18), .O(z19));
  or2    g106(.a(new_n135_), .b(new_n77_), .O(new_n169_));
  nor3   g107(.a(new_n169_), .b(new_n138_), .c(new_n132_), .O(z20));
endmodule
