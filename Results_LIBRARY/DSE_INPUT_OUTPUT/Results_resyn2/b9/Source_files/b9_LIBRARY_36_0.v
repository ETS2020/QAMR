...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n167_, new_n169_, new_n171_, new_n172_, new_n176_, new_n177_;
  ...
  nor2   g013(.a(x16), .b(x14), .O(new_n76_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n90_), .c(new_n86_), .d(new_n85_), .O(z02));
  ...
  nand4  g037(.a(new_n99_), .b(new_n96_), .c(new_n86_), .d(x21), .O(z03));
  aoi21  g038(.a(new_n98_), .b(new_n97_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n76_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n86_), .c(new_n98_), .O(z05));
  ...
  nand3  g051(.a(new_n113_), .b(new_n86_), .c(x03), .O(new_n114_));
  nor2   g052(.a(new_n114_), .b(new_n109_), .O(z07));
  nand2  g053(.a(new_n86_), .b(new_n84_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand3  g055(.a(x34), .b(x27), .c(x26), .O(new_n118_));
  nor3   g056(.a(new_n118_), .b(new_n76_), .c(new_n117_), .O(z09));
  ...
  aoi21  g066(.a(new_n85_), .b(new_n128_), .c(x04), .O(new_n129_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n88_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n134_), .b(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  inv1   g075(.a(new_n88_), .O(new_n138_));
  nor2   g076(.a(new_n97_), .b(x04), .O(new_n139_));
  inv1   g077(.a(x09), .O(new_n140_));
  nand2  g078(.a(new_n120_), .b(new_n140_), .O(new_n141_));
  aoi21  g079(.a(new_n139_), .b(new_n138_), .c(new_n141_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n137_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n86_), .O(z11));
  nand2  g082(.a(new_n67_), .b(x27), .O(new_n145_));
  nand2  g083(.a(new_n68_), .b(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n86_), .b(new_n146_), .O(z12));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  nor2   g087(.a(x13), .b(x04), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n85_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand3  g091(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n63_), .c(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  inv1   g094(.a(new_n123_), .O(new_n157_));
  aoi21  g095(.a(new_n150_), .b(new_n157_), .c(new_n76_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(z13));
  nand2  g097(.a(new_n150_), .b(new_n85_), .O(new_n160_));
  nand3  g098(.a(new_n148_), .b(new_n81_), .c(x28), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(new_n154_), .O(new_n163_));
  aoi21  g101(.a(new_n87_), .b(x27), .c(new_n122_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n160_), .c(new_n63_), .d(new_n97_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n163_), .c(new_n86_), .O(z14));
  inv1   g104(.a(x12), .O(new_n167_));
  oai21  g105(.a(new_n118_), .b(new_n167_), .c(new_n86_), .O(z15));
  nand2  g106(.a(x22), .b(x01), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(x23), .c(new_n86_), .O(z16));
  inv1   g108(.a(x24), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x23), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n169_), .c(new_n86_), .O(z17));
  nand3  g111(.a(new_n142_), .b(new_n137_), .c(new_n86_), .O(z18));
  inv1   g112(.a(z18), .O(z19));
  nand2  g113(.a(x35), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n120_), .c(new_n140_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n135_), .c(new_n86_), .O(z20));
endmodule
