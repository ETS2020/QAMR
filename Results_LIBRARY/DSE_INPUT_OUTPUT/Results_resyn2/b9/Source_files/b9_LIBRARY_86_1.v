...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x24), .O(new_n72_));
  ...
  nand3  g024(.a(x40), .b(x39), .c(x24), .O(new_n87_));
  ...
  inv1   g034(.a(x24), .O(new_n97_));
  nand2  g035(.a(x40), .b(new_n97_), .O(new_n98_));
  ...
  aoi21  g058(.a(new_n120_), .b(x24), .c(new_n71_), .O(new_n121_));
  nand4  g059(.a(x40), .b(x39), .c(x24), .d(x05), .O(new_n122_));
  oai21  g060(.a(new_n121_), .b(new_n119_), .c(new_n122_), .O(new_n123_));
  aoi21  g061(.a(new_n78_), .b(new_n76_), .c(x04), .O(new_n124_));
  ...
  inv1   g065(.a(new_n122_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n81_), .c(new_n63_), .O(new_n129_));
  oai21  g067(.a(new_n127_), .b(new_n75_), .c(new_n129_), .O(z10));
  nand3  g068(.a(x40), .b(x39), .c(x29), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n78_), .c(new_n84_), .O(new_n132_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n134_), .c(new_n98_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nand2  g080(.a(new_n66_), .b(new_n92_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  inv1   g082(.a(new_n67_), .O(new_n145_));
  aoi22  g083(.a(new_n145_), .b(x27), .c(x39), .d(new_n63_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n144_), .c(x24), .O(new_n147_));
  ...
  nand2  g091(.a(new_n98_), .b(new_n145_), .O(new_n154_));
  nor2   g092(.a(new_n71_), .b(new_n120_), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x28), .O(new_n157_));
  nor2   g095(.a(x13), .b(x04), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n155_), .d(x24), .O(new_n159_));
  oai21  g097(.a(new_n154_), .b(new_n153_), .c(new_n159_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n158_), .b(z08), .c(new_n81_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  nand2  g101(.a(new_n158_), .b(new_n155_), .O(new_n164_));
  nand3  g102(.a(new_n156_), .b(new_n80_), .c(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(new_n153_), .O(new_n167_));
  aoi21  g105(.a(new_n77_), .b(x27), .c(new_n81_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n164_), .c(new_n148_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n167_), .c(new_n98_), .O(z14));
  nand3  g108(.a(new_n116_), .b(new_n98_), .c(x12), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z15));
  nand2  g110(.a(x22), .b(x01), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(x23), .c(new_n98_), .O(z16));
  nand3  g112(.a(new_n71_), .b(new_n97_), .c(x23), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n173_), .O(z17));
  nand2  g114(.a(x27), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n85_), .c(new_n139_), .O(new_n178_));
  oai22  g116(.a(new_n178_), .b(new_n72_), .c(new_n88_), .d(new_n87_), .O(z18));
  nand2  g117(.a(new_n140_), .b(new_n134_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n98_), .O(z19));
  nand2  g119(.a(x35), .b(x27), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n138_), .c(new_n137_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n132_), .c(new_n98_), .O(z20));
endmodule
