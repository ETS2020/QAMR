...
module FAU ( 
  ...
  nand2  g011(.a(x23), .b(new_n73_), .O(new_n74_));
  ...
  aoi21  g029(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(z02));
  ...
  aoi21  g034(.a(new_n96_), .b(x21), .c(new_n85_), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi21  g036(.a(new_n96_), .b(new_n98_), .c(new_n85_), .O(z04));
  nand3  g037(.a(new_n95_), .b(new_n74_), .c(new_n94_), .O(z05));
  nand2  g038(.a(new_n95_), .b(new_n94_), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n74_), .O(z06));
  ...
  nand3  g049(.a(new_n111_), .b(new_n74_), .c(x03), .O(new_n112_));
  nor2   g050(.a(new_n112_), .b(new_n107_), .O(z07));
  nand2  g051(.a(new_n74_), .b(new_n68_), .O(z08));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(new_n85_), .O(z10));
  ...
  nand4  g069(.a(x35), .b(new_n79_), .c(x27), .d(new_n65_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n74_), .O(new_n134_));
  ...
  oai21  g076(.a(new_n71_), .b(new_n138_), .c(new_n74_), .O(z12));
  oai21  g077(.a(new_n78_), .b(new_n93_), .c(x28), .O(new_n140_));
  nor2   g078(.a(x13), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n69_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n141_), .b(new_n84_), .c(new_n69_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n85_), .O(z13));
  aoi21  g087(.a(new_n145_), .b(new_n142_), .c(new_n77_), .O(new_n150_));
  inv1   g088(.a(new_n148_), .O(new_n151_));
  nor3   g089(.a(new_n151_), .b(new_n150_), .c(new_n85_), .O(z14));
  nand4  g090(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n74_), .O(z15));
  ...
  nor2   g098(.a(new_n93_), .b(new_n77_), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n134_), .c(new_n130_), .O(z20));
