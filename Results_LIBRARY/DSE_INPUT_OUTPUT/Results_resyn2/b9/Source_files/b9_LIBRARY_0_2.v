...
module FAU ( 
  ...
  aoi21  g027(.a(new_n89_), .b(new_n87_), .c(new_n88_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(new_n86_), .O(z02));
  inv1   g029(.a(x40), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x11), .O(new_n93_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n73_), .O(z04));
  aoi21  g039(.a(x28), .b(x27), .c(x37), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n93_), .O(z05));
  inv1   g041(.a(new_n102_), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(new_n93_), .O(z06));
  ...
  nand3  g052(.a(new_n114_), .b(new_n93_), .c(x03), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n110_), .O(z07));
  inv1   g054(.a(new_n88_), .O(z08));
  nand2  g055(.a(x34), .b(x27), .O(new_n118_));
  nand3  g056(.a(x40), .b(x26), .c(x11), .O(new_n119_));
  ...
  nand2  g061(.a(new_n88_), .b(new_n123_), .O(new_n124_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n93_), .O(z10));
  ...
  nor2   g075(.a(new_n96_), .b(x04), .O(new_n138_));
  inv1   g076(.a(x09), .O(new_n139_));
  inv1   g077(.a(x30), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  aoi21  g079(.a(new_n138_), .b(new_n137_), .c(new_n141_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n136_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n93_), .O(z11));
  nand2  g082(.a(new_n67_), .b(x27), .O(new_n145_));
  nand2  g083(.a(new_n68_), .b(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n93_), .b(new_n146_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nor2   g086(.a(new_n88_), .b(x04), .O(new_n149_));
  oai21  g087(.a(new_n77_), .b(new_n76_), .c(x28), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n148_), .O(new_n151_));
  nand2  g089(.a(new_n94_), .b(new_n97_), .O(new_n152_));
  nor2   g090(.a(x19), .b(x18), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n93_), .c(new_n152_), .d(x20), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n121_), .b(new_n149_), .c(new_n148_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(new_n153_), .b(new_n152_), .c(x20), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n151_), .O(new_n160_));
  nand2  g098(.a(new_n157_), .b(new_n93_), .O(new_n161_));
  aoi21  g099(.a(new_n160_), .b(x27), .c(new_n161_), .O(z14));
  nand2  g100(.a(x26), .b(x12), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n118_), .c(new_n93_), .O(z15));
  nand2  g102(.a(x22), .b(x01), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(x23), .c(new_n93_), .O(z16));
  inv1   g104(.a(x24), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x23), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n165_), .c(new_n93_), .O(z17));
  nand3  g107(.a(new_n142_), .b(new_n136_), .c(new_n93_), .O(z18));
  inv1   g108(.a(z18), .O(z19));
  nor2   g109(.a(new_n141_), .b(new_n73_), .O(new_n172_));
  oai21  g110(.a(new_n76_), .b(new_n96_), .c(new_n172_), .O(new_n173_));
