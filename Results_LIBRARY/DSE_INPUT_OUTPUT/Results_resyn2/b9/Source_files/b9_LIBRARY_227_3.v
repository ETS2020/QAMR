...
module FAU ( 
  ...
  oai22  g17(.a(new_n80_), .b(new_n72_), .c(new_n65_), .d(x27), .O(new_n81_));
  aoi21  g18(.a(new_n81_), .b(x21), .c(z08), .O(z03));
  inv1   g19(.a(x21), .O(new_n83_));
  nand3  g20(.a(new_n81_), .b(new_n69_), .c(new_n83_), .O(z04));
  aoi21  g21(.a(new_n80_), .b(new_n65_), .c(z08), .O(z05));
  nand3  g22(.a(new_n80_), .b(new_n69_), .c(new_n65_), .O(new_n86_));
  inv1   g23(.a(new_n86_), .O(z06));
  inv1   g24(.a(x00), .O(new_n88_));
  oai21  g25(.a(x25), .b(new_n88_), .c(x38), .O(new_n89_));
  nand2  g26(.a(x17), .b(new_n63_), .O(new_n90_));
  ...
  nand2  g35(.a(new_n98_), .b(new_n69_), .O(z07));
  nand3  g36(.a(x34), .b(x27), .c(x26), .O(new_n100_));
  nand2  g37(.a(new_n69_), .b(x11), .O(new_n101_));
  ...
  oai21  g42(.a(new_n105_), .b(new_n64_), .c(new_n69_), .O(z10));
  nor2   g43(.a(x30), .b(x09), .O(new_n107_));
  nand2  g44(.a(new_n107_), .b(new_n69_), .O(new_n108_));
  inv1   g45(.a(new_n108_), .O(new_n109_));
  inv1   g46(.a(x28), .O(new_n110_));
  nand2  g47(.a(x27), .b(x04), .O(new_n111_));
  nand3  g48(.a(new_n111_), .b(x35), .c(new_n110_), .O(new_n112_));
  inv1   g49(.a(new_n112_), .O(new_n113_));
  oai21  g50(.a(x27), .b(x08), .c(new_n113_), .O(new_n114_));
  and2   g51(.a(new_n114_), .b(new_n109_), .O(z11));
  nand2  g52(.a(new_n69_), .b(new_n67_), .O(z12));
  nor2   g53(.a(x19), .b(x18), .O(new_n117_));
  nand2  g54(.a(new_n117_), .b(x20), .O(new_n118_));
  inv1   g55(.a(new_n118_), .O(new_n119_));
  aoi21  g56(.a(new_n119_), .b(new_n67_), .c(z08), .O(z14));
  inv1   g57(.a(z14), .O(z13));
  inv1   g58(.a(x12), .O(new_n122_));
  oai21  g59(.a(new_n100_), .b(new_n122_), .c(new_n69_), .O(z15));
  inv1   g60(.a(x23), .O(new_n124_));
  nand4  g61(.a(new_n69_), .b(new_n124_), .c(x22), .d(x01), .O(new_n125_));
  inv1   g62(.a(new_n125_), .O(z16));
  inv1   g63(.a(x24), .O(new_n127_));
  nand4  g64(.a(new_n127_), .b(x23), .c(x22), .d(x01), .O(new_n128_));
  nand2  g65(.a(new_n128_), .b(new_n69_), .O(z17));
  aoi21  g66(.a(new_n114_), .b(new_n107_), .c(z08), .O(z18));
  nand2  g67(.a(new_n114_), .b(new_n107_), .O(new_n131_));
  nand2  g68(.a(new_n131_), .b(new_n69_), .O(z19));
  inv1   g69(.a(x08), .O(new_n133_));
  oai21  g70(.a(x28), .b(new_n133_), .c(new_n64_), .O(new_n134_));
  aoi21  g71(.a(new_n134_), .b(x35), .c(new_n108_), .O(z20));
  one    g72(.O(z02));
endmodule
