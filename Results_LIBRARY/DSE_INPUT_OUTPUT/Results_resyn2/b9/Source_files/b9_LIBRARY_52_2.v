...
module FAU ( 
  ...
  nor2   g018(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  inv1   g019(.a(new_n81_), .O(new_n82_));
  nand3  g020(.a(new_n82_), .b(new_n77_), .c(new_n76_), .O(new_n83_));
  aoi21  g021(.a(new_n83_), .b(x04), .c(new_n75_), .O(z01));
  nand2  g022(.a(x35), .b(new_n79_), .O(new_n85_));
  nor2   g023(.a(x27), .b(x08), .O(new_n86_));
  oai21  g024(.a(new_n86_), .b(new_n85_), .c(x04), .O(new_n87_));
  nor2   g025(.a(new_n75_), .b(new_n63_), .O(z08));
  ...
  aoi21  g036(.a(new_n96_), .b(new_n98_), .c(new_n75_), .O(z04));
  nand2  g037(.a(new_n95_), .b(new_n94_), .O(new_n100_));
  and2   g038(.a(new_n100_), .b(new_n72_), .O(z05));
  nor2   g039(.a(new_n100_), .b(new_n75_), .O(z06));
  ...
  aoi21  g074(.a(new_n136_), .b(new_n130_), .c(new_n75_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  nand2  g076(.a(new_n72_), .b(new_n70_), .O(new_n139_));
  ...
  nand2  g081(.a(new_n72_), .b(new_n143_), .O(new_n144_));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(new_n64_), .b(new_n145_), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n76_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n146_), .c(new_n144_), .d(new_n142_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  oai21  g089(.a(new_n134_), .b(x14), .c(new_n71_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n64_), .c(new_n145_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n151_), .O(z13));
  nand3  g092(.a(new_n94_), .b(new_n93_), .c(x28), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x27), .c(x30), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(x14), .c(new_n71_), .O(new_n157_));
  nand4  g095(.a(new_n147_), .b(new_n142_), .c(new_n77_), .d(x28), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  nand2  g097(.a(new_n143_), .b(x27), .O(new_n160_));
  oai22  g098(.a(new_n160_), .b(new_n142_), .c(new_n159_), .d(new_n146_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n157_), .O(z14));
  ...
  nor4   g104(.a(new_n75_), .b(x23), .c(new_n166_), .d(new_n165_), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  nor2   g106(.a(new_n166_), .b(new_n165_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n72_), .c(new_n168_), .d(x23), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(z17));
  nand3  g109(.a(new_n136_), .b(new_n130_), .c(new_n72_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z19));
  nor2   g111(.a(new_n93_), .b(new_n78_), .O(new_n174_));
  nor4   g112(.a(new_n174_), .b(new_n135_), .c(new_n128_), .d(new_n75_), .O(z20));
endmodule
