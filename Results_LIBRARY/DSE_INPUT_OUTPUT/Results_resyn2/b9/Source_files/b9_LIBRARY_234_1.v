...
module FAU ( 
  ...
  nor2   g01(.a(new_n63_), .b(x05), .O(new_n64_));
  ...
  nand2  g36(.a(new_n93_), .b(new_n92_), .O(new_n99_));
  nor2   g37(.a(new_n99_), .b(new_n64_), .O(z06));
  ...
  inv1   g48(.a(new_n72_), .O(new_n111_));
  nand2  g49(.a(new_n111_), .b(new_n79_), .O(z08));
  inv1   g50(.a(x11), .O(new_n113_));
  nand3  g51(.a(x34), .b(x27), .c(x26), .O(new_n114_));
  nor3   g52(.a(new_n114_), .b(new_n64_), .c(new_n113_), .O(z09));
  ...
  nor2   g68(.a(new_n69_), .b(new_n66_), .O(new_n131_));
  nand3  g69(.a(new_n131_), .b(new_n80_), .c(new_n68_), .O(new_n132_));
  nor2   g70(.a(x30), .b(x09), .O(new_n133_));
  and2   g71(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n130_), .c(new_n79_), .O(z18));
  inv1   g73(.a(z18), .O(z11));
  inv1   g74(.a(new_n74_), .O(new_n137_));
  nand3  g75(.a(new_n75_), .b(new_n137_), .c(new_n79_), .O(new_n138_));
  inv1   g76(.a(new_n138_), .O(z12));
  nor2   g77(.a(x13), .b(x04), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n72_), .O(new_n141_));
  aoi21  g79(.a(x36), .b(x35), .c(new_n80_), .O(new_n142_));
  nor2   g80(.a(x19), .b(x18), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(x20), .O(new_n144_));
  oai22  g82(.a(new_n144_), .b(new_n67_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  oai21  g83(.a(new_n141_), .b(new_n82_), .c(new_n79_), .O(new_n146_));
  aoi21  g84(.a(new_n145_), .b(x27), .c(new_n146_), .O(z14));
  inv1   g85(.a(z14), .O(z13));
  inv1   g86(.a(x12), .O(new_n149_));
  oai21  g87(.a(new_n114_), .b(new_n149_), .c(new_n79_), .O(z15));
  nand2  g88(.a(x22), .b(x01), .O(new_n151_));
  oai21  g89(.a(new_n151_), .b(x23), .c(new_n79_), .O(z16));
  inv1   g90(.a(x24), .O(new_n153_));
  inv1   g91(.a(new_n151_), .O(new_n154_));
  nand4  g92(.a(new_n154_), .b(new_n79_), .c(new_n153_), .d(x23), .O(new_n155_));
  inv1   g93(.a(new_n155_), .O(z17));
  nand2  g94(.a(new_n134_), .b(new_n130_), .O(new_n157_));
  nand2  g95(.a(new_n157_), .b(new_n79_), .O(z19));
  nor2   g96(.a(new_n131_), .b(new_n64_), .O(new_n159_));
