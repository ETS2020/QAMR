...
module FAU ( 
  ...
  wire new_n63_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_,
    ...
    new_n118_, new_n120_, new_n121_, new_n123_, new_n126_, new_n127_;
  ...
  nand2  g17(.a(new_n66_), .b(new_n80_), .O(new_n81_));
  nand4  g18(.a(new_n81_), .b(new_n79_), .c(new_n63_), .d(x21), .O(z03));
  aoi21  g19(.a(new_n66_), .b(new_n80_), .c(x21), .O(new_n83_));
  aoi21  g20(.a(new_n83_), .b(new_n79_), .c(z08), .O(z04));
  nand2  g21(.a(x28), .b(x27), .O(new_n85_));
  aoi21  g22(.a(new_n85_), .b(new_n66_), .c(z08), .O(z05));
  ...
  inv1   g38(.a(x07), .O(new_n102_));
  nor2   g39(.a(new_n102_), .b(x04), .O(new_n103_));
  aoi22  g40(.a(new_n103_), .b(new_n73_), .c(x37), .d(x06), .O(new_n104_));
  oai21  g41(.a(new_n104_), .b(new_n80_), .c(new_n63_), .O(z10));
  nor2   g42(.a(x30), .b(x09), .O(new_n106_));
  nor2   g43(.a(x27), .b(x08), .O(new_n107_));
  inv1   g44(.a(x28), .O(new_n108_));
  nand2  g45(.a(x27), .b(x04), .O(new_n109_));
  nand3  g46(.a(new_n109_), .b(x35), .c(new_n108_), .O(new_n110_));
  oai21  g47(.a(new_n110_), .b(new_n107_), .c(new_n106_), .O(new_n111_));
  nor2   g48(.a(new_n111_), .b(z08), .O(z11));
  nand3  g49(.a(new_n68_), .b(new_n63_), .c(x27), .O(z12));
  nor2   g50(.a(x19), .b(x18), .O(new_n114_));
  nand2  g51(.a(new_n114_), .b(x20), .O(new_n115_));
  nor2   g52(.a(new_n115_), .b(z12), .O(z13));
  inv1   g53(.a(z13), .O(z14));
  nand4  g54(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(new_n63_), .O(z15));
  inv1   g56(.a(x23), .O(new_n120_));
  nand4  g57(.a(new_n63_), .b(new_n120_), .c(x22), .d(x01), .O(new_n121_));
  inv1   g58(.a(new_n121_), .O(z16));
  nand2  g59(.a(x22), .b(x01), .O(new_n123_));
  nor4   g60(.a(new_n123_), .b(z08), .c(x24), .d(new_n120_), .O(z17));
  and2   g61(.a(new_n111_), .b(new_n63_), .O(z18));
  aoi21  g62(.a(new_n108_), .b(x08), .c(x27), .O(new_n126_));
  oai21  g63(.a(new_n126_), .b(new_n71_), .c(new_n106_), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(new_n63_), .O(z20));
  one    g65(.O(z02));
  nor2   g66(.a(new_n111_), .b(z08), .O(z19));
endmodule
