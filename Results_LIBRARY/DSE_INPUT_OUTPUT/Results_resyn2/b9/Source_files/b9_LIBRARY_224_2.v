...
module FAU ( 
  ...
  nor3   g025(.a(new_n87_), .b(new_n86_), .c(new_n72_), .O(new_n88_));
  ...
  aoi21  g058(.a(new_n86_), .b(x39), .c(new_n120_), .O(new_n121_));
  ...
  aoi21  g080(.a(new_n142_), .b(x39), .c(new_n138_), .O(z12));
  ...
  nand2  g086(.a(new_n148_), .b(x39), .O(new_n149_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n86_), .c(x39), .O(new_n153_));
  ...
  nand2  g095(.a(new_n81_), .b(x40), .O(new_n158_));
  oai21  g096(.a(new_n148_), .b(new_n86_), .c(x39), .O(new_n159_));
