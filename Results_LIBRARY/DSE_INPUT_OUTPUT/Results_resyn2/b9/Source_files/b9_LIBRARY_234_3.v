...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n150_, new_n152_, new_n154_, new_n156_;
  nand2  g00(.a(x14), .b(x05), .O(new_n63_));
  ...
  nand3  g71(.a(new_n133_), .b(new_n127_), .c(new_n63_), .O(z18));
  inv1   g72(.a(z18), .O(z11));
  inv1   g73(.a(new_n74_), .O(new_n136_));
  nand3  g74(.a(new_n75_), .b(new_n136_), .c(new_n63_), .O(new_n137_));
  inv1   g75(.a(new_n137_), .O(z12));
  nor2   g76(.a(x13), .b(x04), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n72_), .O(new_n140_));
  aoi21  g78(.a(x36), .b(x35), .c(new_n79_), .O(new_n141_));
  nor2   g79(.a(x19), .b(x18), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(x20), .O(new_n143_));
  oai22  g81(.a(new_n143_), .b(new_n67_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  oai21  g82(.a(new_n140_), .b(new_n81_), .c(new_n63_), .O(new_n145_));
  aoi21  g83(.a(new_n144_), .b(x27), .c(new_n145_), .O(z14));
  inv1   g84(.a(z14), .O(z13));
  inv1   g85(.a(x12), .O(new_n148_));
  oai21  g86(.a(new_n112_), .b(new_n148_), .c(new_n63_), .O(z15));
  nand2  g87(.a(x22), .b(x01), .O(new_n150_));
  oai21  g88(.a(new_n150_), .b(x23), .c(new_n63_), .O(z16));
  inv1   g89(.a(x23), .O(new_n152_));
  nor4   g90(.a(new_n150_), .b(new_n64_), .c(x24), .d(new_n152_), .O(z17));
  nand2  g91(.a(new_n133_), .b(new_n127_), .O(new_n154_));
  nand2  g92(.a(new_n154_), .b(new_n63_), .O(z19));
  oai21  g93(.a(new_n69_), .b(new_n66_), .c(new_n63_), .O(new_n156_));
  nor3   g94(.a(new_n156_), .b(new_n132_), .c(new_n125_), .O(z20));
endmodule
