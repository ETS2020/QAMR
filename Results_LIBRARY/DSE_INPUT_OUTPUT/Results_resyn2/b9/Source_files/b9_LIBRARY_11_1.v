...
module FAU ( 
  ...
  nor2   g049(.a(new_n72_), .b(new_n82_), .O(z08));
  ...
  aoi21  g062(.a(x40), .b(new_n82_), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g086(.a(x40), .b(new_n148_), .c(new_n64_), .O(new_n149_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n79_), .c(x39), .O(new_n153_));
