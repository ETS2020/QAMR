...
module FAU ( 
  ...
  aoi21  g029(.a(new_n91_), .b(x21), .c(new_n71_), .O(z03));
  nor2   g030(.a(new_n71_), .b(x21), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n91_), .O(z04));
  aoi21  g032(.a(new_n90_), .b(new_n89_), .c(new_n71_), .O(z05));
  nand2  g033(.a(new_n90_), .b(new_n89_), .O(new_n96_));
  nor2   g034(.a(new_n96_), .b(new_n71_), .O(z06));
  ...
  nand2  g047(.a(new_n98_), .b(new_n84_), .O(z08));
  ...
  nand3  g060(.a(new_n122_), .b(new_n121_), .c(new_n98_), .O(z10));
  inv1   g061(.a(x08), .O(new_n124_));
  nand2  g062(.a(new_n113_), .b(x29), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n77_), .c(new_n124_), .O(new_n126_));
  nand2  g064(.a(new_n125_), .b(x27), .O(new_n127_));
  nand4  g065(.a(x35), .b(new_n76_), .c(x27), .d(new_n63_), .O(new_n128_));
  nor3   g066(.a(new_n71_), .b(x30), .c(x09), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g068(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z11));
  nand2  g069(.a(new_n68_), .b(x27), .O(new_n132_));
  nand2  g070(.a(new_n65_), .b(x10), .O(new_n133_));
  nand3  g071(.a(new_n98_), .b(new_n133_), .c(new_n132_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z12));
  inv1   g073(.a(x27), .O(new_n136_));
  nand2  g074(.a(x35), .b(x28), .O(new_n137_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n113_), .c(new_n76_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n140_), .c(new_n136_), .O(new_n143_));
  nand2  g081(.a(new_n141_), .b(new_n113_), .O(new_n144_));
  nor2   g082(.a(new_n144_), .b(new_n74_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n143_), .c(new_n98_), .O(new_n146_));
  inv1   g084(.a(new_n144_), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x36), .c(x35), .d(x27), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(z13));
  aoi21  g087(.a(x36), .b(x35), .c(new_n76_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n144_), .c(new_n140_), .O(new_n151_));
  oai21  g089(.a(new_n144_), .b(new_n74_), .c(new_n98_), .O(new_n152_));
  aoi21  g090(.a(new_n151_), .b(x27), .c(new_n152_), .O(z14));
  nand4  g091(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n98_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n71_), .c(x23), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  inv1   g096(.a(new_n156_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n98_), .c(new_n158_), .d(x23), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z17));
  nand2  g099(.a(new_n127_), .b(new_n126_), .O(new_n162_));
  nand3  g100(.a(new_n129_), .b(new_n128_), .c(new_n162_), .O(z18));
  nor2   g101(.a(x30), .b(x09), .O(new_n164_));
  oai21  g102(.a(new_n88_), .b(new_n136_), .c(new_n164_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n126_), .c(new_n98_), .O(z20));
  aoi21  g104(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z19));
endmodule
