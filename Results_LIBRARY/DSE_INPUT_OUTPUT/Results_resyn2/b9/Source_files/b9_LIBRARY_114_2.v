...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n94_, new_n96_, new_n97_, new_n98_, new_n101_, new_n103_,
    ...
    new_n153_, new_n154_, new_n156_, new_n158_, new_n163_, new_n164_;
  ...
  nand3  g014(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(new_n77_));
  ...
  nand2  g035(.a(new_n97_), .b(x23), .O(new_n98_));
  nand3  g036(.a(new_n94_), .b(new_n98_), .c(new_n96_), .O(z04));
  nand3  g037(.a(new_n93_), .b(new_n98_), .c(new_n92_), .O(z05));
  nand2  g038(.a(new_n93_), .b(new_n92_), .O(new_n101_));
  ...
  nand3  g055(.a(new_n75_), .b(new_n98_), .c(x07), .O(new_n118_));
  ...
  oai21  g064(.a(new_n124_), .b(new_n68_), .c(new_n126_), .O(z10));
  inv1   g065(.a(x08), .O(new_n128_));
  nand3  g066(.a(x40), .b(x39), .c(x29), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n86_), .c(new_n128_), .O(new_n130_));
  ...
  nand2  g071(.a(new_n133_), .b(new_n80_), .O(new_n134_));
  ...
  oai21  g076(.a(x36), .b(x35), .c(new_n76_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n66_), .c(new_n68_), .O(new_n140_));
  nand2  g078(.a(new_n76_), .b(x10), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n140_), .c(new_n98_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  oai21  g082(.a(new_n120_), .b(new_n79_), .c(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n76_), .c(new_n144_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n67_), .c(x20), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand3  g088(.a(new_n125_), .b(new_n76_), .c(new_n144_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n98_), .O(z13));
  aoi21  g090(.a(new_n148_), .b(new_n146_), .c(new_n68_), .O(new_n153_));
  inv1   g091(.a(new_n151_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(new_n98_), .O(z14));
  nand4  g093(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n98_), .O(z15));
  nand2  g095(.a(x22), .b(x01), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x23), .O(z16));
  nor4   g097(.a(new_n158_), .b(new_n97_), .c(x24), .d(new_n63_), .O(z17));
  nand3  g098(.a(new_n136_), .b(new_n132_), .c(new_n98_), .O(z18));
  inv1   g099(.a(z18), .O(z19));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n135_), .c(new_n98_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(new_n130_), .O(z20));
endmodule
