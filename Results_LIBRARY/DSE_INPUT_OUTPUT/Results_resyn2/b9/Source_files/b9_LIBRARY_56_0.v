...
module FAU ( 
  ...
  nor2   g008(.a(x36), .b(x00), .O(new_n71_));
  ...
  nor2   g022(.a(new_n71_), .b(new_n84_), .O(z08));
  ...
  nand3  g035(.a(new_n92_), .b(new_n97_), .c(new_n91_), .O(z05));
  ...
  nand3  g062(.a(new_n124_), .b(new_n123_), .c(new_n97_), .O(z10));
  ...
  aoi21  g071(.a(new_n133_), .b(new_n130_), .c(new_n71_), .O(z18));
  inv1   g072(.a(z18), .O(z11));
  nand2  g073(.a(new_n68_), .b(x27), .O(new_n136_));
  nand2  g074(.a(new_n65_), .b(x10), .O(new_n137_));
  nand3  g075(.a(new_n97_), .b(new_n137_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z12));
  inv1   g077(.a(x27), .O(new_n140_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n115_), .c(new_n76_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n144_), .c(new_n140_), .O(new_n147_));
  nand2  g085(.a(new_n145_), .b(new_n115_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(new_n74_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n97_), .O(new_n150_));
  ...
  oai21  g093(.a(new_n148_), .b(new_n74_), .c(new_n97_), .O(new_n156_));
  aoi21  g094(.a(new_n155_), .b(x27), .c(new_n156_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n113_), .b(new_n158_), .c(new_n97_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n97_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x23), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n160_), .c(new_n97_), .O(z17));
  nand3  g102(.a(new_n133_), .b(new_n130_), .c(new_n97_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z19));
  oai21  g104(.a(new_n90_), .b(new_n140_), .c(new_n132_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n128_), .c(new_n97_), .O(z20));
endmodule
