...
module FAU ( 
  ...
  nor2   g010(.a(x38), .b(new_n72_), .O(new_n73_));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n76_), .c(new_n73_), .O(new_n95_));
  ...
  nand3  g043(.a(new_n105_), .b(new_n104_), .c(x00), .O(new_n106_));
  aoi21  g044(.a(x17), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nor2   g045(.a(x25), .b(x00), .O(new_n108_));
  oai21  g046(.a(new_n108_), .b(x14), .c(x38), .O(new_n109_));
  oai21  g047(.a(new_n109_), .b(new_n107_), .c(x03), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(new_n99_), .O(z07));
  nand2  g049(.a(new_n99_), .b(new_n88_), .O(z08));
  ...
  nand2  g055(.a(new_n83_), .b(new_n117_), .O(new_n118_));
  inv1   g056(.a(x35), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x28), .c(new_n77_), .O(new_n120_));
  ...
  aoi21  g063(.a(new_n117_), .b(new_n125_), .c(x04), .O(new_n126_));
  ...
  nand4  g073(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n136_));
  and2   g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n99_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n99_), .b(new_n68_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n117_), .O(new_n146_));
  ...
  nand3  g089(.a(new_n145_), .b(new_n83_), .c(new_n117_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n151_), .c(new_n73_), .O(z13));
  nand2  g091(.a(new_n145_), .b(new_n117_), .O(new_n154_));
  nand2  g092(.a(new_n148_), .b(x20), .O(new_n155_));
  nand4  g093(.a(new_n143_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n154_), .c(new_n155_), .O(new_n158_));
  aoi21  g096(.a(new_n78_), .b(x27), .c(new_n83_), .O(new_n159_));
  oai22  g097(.a(new_n159_), .b(new_n154_), .c(new_n63_), .d(new_n76_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(new_n99_), .O(z14));
  nand3  g099(.a(new_n114_), .b(new_n99_), .c(x12), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z15));
  inv1   g101(.a(x01), .O(new_n164_));
  inv1   g102(.a(x22), .O(new_n165_));
  nor4   g103(.a(new_n73_), .b(x23), .c(new_n165_), .d(new_n164_), .O(z16));
  inv1   g104(.a(x24), .O(new_n167_));
  nor2   g105(.a(new_n165_), .b(new_n164_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n99_), .c(new_n167_), .d(x23), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(z17));
  aoi21  g108(.a(new_n137_), .b(new_n134_), .c(new_n73_), .O(z18));
  oai21  g109(.a(new_n119_), .b(new_n76_), .c(new_n135_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n132_), .c(new_n99_), .O(z20));
  nand2  g111(.a(new_n138_), .b(new_n99_), .O(z19));
endmodule
