...
module FAU ( 
  ...
  oai21  g018(.a(new_n76_), .b(x28), .c(new_n63_), .O(new_n81_));
  ...
  and2   g022(.a(x40), .b(x39), .O(new_n85_));
  ...
  oai21  g028(.a(x36), .b(x04), .c(new_n76_), .O(new_n91_));
  nand4  g029(.a(new_n91_), .b(new_n90_), .c(new_n87_), .d(new_n85_), .O(z02));
  ...
  nand2  g066(.a(x35), .b(new_n72_), .O(new_n129_));
  ...
  nand4  g072(.a(x35), .b(new_n72_), .c(x27), .d(new_n68_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n98_), .O(z11));
  aoi22  g075(.a(new_n77_), .b(new_n74_), .c(new_n70_), .d(new_n98_), .O(z12));
  nor2   g076(.a(x13), .b(x04), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n85_), .O(new_n140_));
  ...
  nand2  g082(.a(new_n80_), .b(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n139_), .c(new_n85_), .O(new_n146_));
  nand3  g084(.a(new_n141_), .b(x37), .c(x20), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n140_), .b(new_n80_), .c(new_n75_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n98_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n144_), .O(z13));
  nand3  g089(.a(new_n139_), .b(new_n85_), .c(x27), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x35), .c(new_n63_), .O(new_n153_));
  oai21  g091(.a(x28), .b(new_n75_), .c(new_n80_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n139_), .c(new_n85_), .O(new_n155_));
  oai21  g093(.a(new_n76_), .b(new_n72_), .c(new_n93_), .O(new_n156_));
  ...
  nand4  g097(.a(new_n114_), .b(new_n98_), .c(x26), .d(x12), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z15));
  inv1   g099(.a(x01), .O(new_n162_));
  inv1   g100(.a(x22), .O(new_n163_));
  nor4   g101(.a(new_n64_), .b(x23), .c(new_n163_), .d(new_n162_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  nor2   g103(.a(new_n163_), .b(new_n162_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n98_), .c(new_n165_), .d(x23), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z17));
  nand4  g106(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n98_), .O(z18));
  oai21  g107(.a(new_n76_), .b(new_n75_), .c(new_n134_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n131_), .c(new_n98_), .O(z20));
  nand2  g109(.a(new_n136_), .b(new_n98_), .O(z19));
endmodule
