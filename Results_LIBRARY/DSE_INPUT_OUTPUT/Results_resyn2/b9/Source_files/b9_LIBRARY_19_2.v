...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x31), .O(new_n64_));
  ...
  aoi21  g030(.a(new_n92_), .b(new_n89_), .c(new_n65_), .O(z02));
  ...
  nor2   g039(.a(new_n100_), .b(new_n65_), .O(z06));
  inv1   g040(.a(x00), .O(new_n103_));
  inv1   g041(.a(x14), .O(new_n104_));
  aoi21  g042(.a(x25), .b(new_n104_), .c(new_n63_), .O(new_n105_));
  oai21  g043(.a(x25), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand2  g044(.a(x17), .b(new_n66_), .O(new_n107_));
  nor2   g045(.a(x33), .b(x31), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  oai21  g047(.a(new_n65_), .b(x14), .c(new_n109_), .O(new_n110_));
  nand3  g048(.a(new_n110_), .b(new_n106_), .c(x03), .O(new_n111_));
  inv1   g049(.a(new_n111_), .O(z07));
  nor2   g050(.a(new_n90_), .b(new_n65_), .O(z08));
  nand3  g051(.a(x34), .b(x27), .c(x26), .O(new_n114_));
  nand2  g052(.a(new_n64_), .b(x11), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  nand2  g054(.a(new_n81_), .b(new_n80_), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n73_), .O(new_n118_));
  ...
  nor2   g070(.a(new_n70_), .b(new_n67_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n82_), .c(new_n69_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  and2   g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n132_), .c(new_n64_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  oai21  g076(.a(new_n77_), .b(new_n75_), .c(new_n64_), .O(z12));
  nor2   g077(.a(x13), .b(x04), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n117_), .c(new_n73_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(new_n142_));
  inv1   g080(.a(new_n68_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(x20), .O(new_n145_));
  oai21  g083(.a(new_n71_), .b(new_n70_), .c(x28), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n140_), .c(new_n73_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n67_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(new_n142_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n64_), .O(z13));
  oai21  g088(.a(new_n148_), .b(new_n142_), .c(new_n64_), .O(z14));
  inv1   g089(.a(x12), .O(new_n152_));
  oai21  g090(.a(new_n114_), .b(new_n152_), .c(new_n64_), .O(z15));
  nand2  g091(.a(x22), .b(x01), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(x23), .c(new_n64_), .O(z16));
  inv1   g093(.a(x24), .O(new_n156_));
  inv1   g094(.a(new_n154_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n64_), .c(new_n156_), .d(x23), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(z17));
  aoi21  g097(.a(new_n136_), .b(new_n132_), .c(new_n65_), .O(z18));
  nand2  g098(.a(new_n136_), .b(new_n132_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n64_), .O(z19));
  nor2   g100(.a(new_n133_), .b(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n135_), .O(new_n164_));
