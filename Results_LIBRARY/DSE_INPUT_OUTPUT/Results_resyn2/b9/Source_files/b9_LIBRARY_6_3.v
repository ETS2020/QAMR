...
module FAU ( 
  ...
  aoi21  g033(.a(new_n95_), .b(x27), .c(new_n74_), .O(new_n96_));
  ...
  oai21  g040(.a(new_n87_), .b(new_n97_), .c(new_n98_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n86_), .O(z06));
  ...
  nand2  g052(.a(new_n114_), .b(new_n86_), .O(z07));
  ...
  nand3  g080(.a(new_n142_), .b(new_n137_), .c(new_n86_), .O(new_n143_));
  ...
  nand3  g094(.a(new_n150_), .b(new_n122_), .c(new_n85_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n156_), .c(new_n74_), .O(z13));
  nand2  g096(.a(new_n150_), .b(new_n85_), .O(new_n159_));
  ...
  oai22  g102(.a(new_n164_), .b(new_n159_), .c(new_n63_), .d(new_n97_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n163_), .c(new_n86_), .O(z14));
  nor3   g104(.a(new_n118_), .b(x14), .c(new_n72_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand4  g106(.a(new_n86_), .b(new_n168_), .c(x22), .d(x01), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(z16));
  inv1   g108(.a(x24), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(x23), .c(x22), .d(x01), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n86_), .O(z17));
  aoi21  g111(.a(new_n142_), .b(new_n137_), .c(new_n74_), .O(z18));
  nand2  g112(.a(x35), .b(x27), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n86_), .c(new_n120_), .d(new_n140_), .O(new_n176_));
  nor2   g114(.a(new_n176_), .b(new_n135_), .O(z20));
  inv1   g115(.a(new_n143_), .O(z19));
endmodule
