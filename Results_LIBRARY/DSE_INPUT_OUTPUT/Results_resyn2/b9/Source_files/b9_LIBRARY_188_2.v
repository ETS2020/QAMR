...
module FAU ( 
  ...
  aoi21  g049(.a(new_n111_), .b(x14), .c(new_n73_), .O(z07));
  inv1   g050(.a(x11), .O(new_n113_));
  nand3  g051(.a(x34), .b(x27), .c(x26), .O(new_n114_));
  nor3   g052(.a(new_n114_), .b(new_n74_), .c(new_n113_), .O(z09));
  ...
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n102_), .O(z10));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n143_), .c(new_n74_), .O(z13));
  inv1   g090(.a(new_n143_), .O(new_n153_));
  aoi21  g091(.a(new_n149_), .b(new_n146_), .c(new_n96_), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n153_), .c(new_n74_), .O(z14));
  inv1   g093(.a(x12), .O(new_n156_));
  oai21  g094(.a(new_n114_), .b(new_n156_), .c(new_n102_), .O(z15));
  nand2  g095(.a(x22), .b(x01), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(x23), .c(new_n102_), .O(z16));
  inv1   g097(.a(x24), .O(new_n160_));
  inv1   g098(.a(new_n158_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n102_), .c(new_n160_), .d(x23), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z17));
  aoi21  g101(.a(new_n136_), .b(new_n131_), .c(new_n74_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n77_), .c(new_n134_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n129_), .c(new_n102_), .O(z20));
endmodule
