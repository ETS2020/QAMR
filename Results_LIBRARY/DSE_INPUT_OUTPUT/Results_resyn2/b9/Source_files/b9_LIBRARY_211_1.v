...
module FAU ( 
  ...
  nand3  g016(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(new_n79_));
  ...
  aoi21  g037(.a(new_n69_), .b(new_n68_), .c(new_n65_), .O(new_n100_));
  ...
  nand2  g042(.a(new_n104_), .b(new_n64_), .O(z05));
  inv1   g043(.a(new_n104_), .O(new_n106_));
  nand2  g044(.a(new_n106_), .b(new_n64_), .O(z06));
  ...
  aoi21  g057(.a(new_n118_), .b(x12), .c(new_n119_), .O(z08));
  nand3  g058(.a(x34), .b(x27), .c(x26), .O(new_n121_));
  nand2  g059(.a(new_n64_), .b(x11), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n121_), .O(z09));
  nor2   g061(.a(new_n85_), .b(new_n77_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x05), .O(new_n125_));
  oai21  g063(.a(new_n90_), .b(x28), .c(new_n81_), .O(new_n126_));
  inv1   g064(.a(x05), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(new_n127_), .O(new_n128_));
  inv1   g066(.a(x07), .O(new_n129_));
  nand2  g067(.a(new_n77_), .b(new_n129_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n128_), .c(new_n126_), .d(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n125_), .O(new_n132_));
  ...
  aoi21  g075(.a(new_n137_), .b(new_n83_), .c(new_n92_), .O(new_n138_));
  ...
  nor2   g081(.a(new_n68_), .b(x04), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n91_), .c(new_n143_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n140_), .c(new_n64_), .O(z18));
  inv1   g084(.a(z18), .O(z11));
  nor3   g085(.a(x37), .b(x36), .c(x35), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n68_), .c(new_n73_), .O(new_n149_));
  nor2   g087(.a(new_n77_), .b(x04), .O(new_n150_));
  ...
  nand3  g093(.a(new_n155_), .b(new_n150_), .c(new_n153_), .O(new_n156_));
  nand2  g094(.a(new_n70_), .b(new_n69_), .O(new_n157_));
  nor2   g095(.a(x19), .b(x18), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n64_), .d(x20), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n124_), .b(new_n76_), .c(new_n153_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  nand2  g101(.a(new_n150_), .b(new_n153_), .O(new_n164_));
  nand2  g102(.a(new_n158_), .b(x20), .O(new_n165_));
  nand3  g103(.a(new_n154_), .b(new_n85_), .c(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n164_), .c(new_n165_), .O(new_n168_));
  inv1   g106(.a(new_n71_), .O(new_n169_));
  aoi21  g107(.a(new_n82_), .b(x27), .c(new_n86_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n164_), .c(new_n169_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n168_), .c(new_n64_), .O(z14));
  inv1   g110(.a(new_n121_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x12), .O(new_n174_));
  ...
  nor2   g116(.a(x24), .b(new_n176_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n64_), .c(x22), .d(x01), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z17));
  nand2  g119(.a(new_n145_), .b(new_n140_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n64_), .O(z19));
  nand2  g121(.a(x35), .b(x27), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n142_), .c(new_n141_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n138_), .c(new_n64_), .O(z20));
endmodule
