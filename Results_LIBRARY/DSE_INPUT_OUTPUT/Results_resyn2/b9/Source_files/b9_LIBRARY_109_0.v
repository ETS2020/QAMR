...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n157_, new_n159_, new_n161_, new_n162_;
  nor2   g000(.a(x14), .b(x03), .O(new_n63_));
  ...
  aoi21  g017(.a(new_n79_), .b(new_n69_), .c(new_n65_), .O(new_n80_));
  ...
  oai21  g024(.a(new_n86_), .b(new_n79_), .c(x04), .O(new_n87_));
  ...
  oai22  g031(.a(new_n93_), .b(new_n68_), .c(new_n92_), .d(x27), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(x21), .c(new_n63_), .O(z03));
  inv1   g033(.a(x21), .O(new_n96_));
  aoi21  g034(.a(new_n94_), .b(new_n96_), .c(new_n63_), .O(z04));
  ...
  nor2   g049(.a(new_n88_), .b(new_n63_), .O(z08));
  inv1   g050(.a(x11), .O(new_n113_));
  nand4  g051(.a(new_n98_), .b(x34), .c(x27), .d(x26), .O(new_n114_));
  nor2   g052(.a(new_n114_), .b(new_n113_), .O(z09));
  nand2  g053(.a(new_n83_), .b(new_n71_), .O(new_n116_));
  nand2  g054(.a(new_n79_), .b(new_n69_), .O(new_n117_));
  ...
  aoi21  g060(.a(new_n71_), .b(new_n122_), .c(x04), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n124_), .c(new_n63_), .O(z10));
  inv1   g064(.a(x08), .O(new_n127_));
  nand2  g065(.a(new_n71_), .b(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n79_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nor2   g069(.a(new_n68_), .b(new_n65_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n78_), .c(new_n67_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  and2   g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n131_), .c(new_n98_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  inv1   g075(.a(new_n73_), .O(new_n138_));
  nand3  g076(.a(new_n74_), .b(new_n138_), .c(new_n98_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z12));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x20), .O(new_n142_));
  aoi21  g080(.a(x36), .b(x35), .c(new_n78_), .O(new_n143_));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n71_), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n143_), .c(new_n142_), .d(new_n66_), .O(new_n146_));
  nand3  g084(.a(new_n144_), .b(new_n83_), .c(new_n71_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n98_), .O(new_n148_));
  aoi21  g086(.a(new_n146_), .b(x27), .c(new_n148_), .O(z14));
  inv1   g087(.a(z14), .O(z13));
  ...
  nand4  g094(.a(new_n156_), .b(new_n98_), .c(new_n155_), .d(x23), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z17));
  nand2  g096(.a(new_n135_), .b(new_n131_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n98_), .O(z19));
  nor2   g098(.a(new_n132_), .b(new_n63_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n134_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n129_), .O(z20));
endmodule
