...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n93_, new_n94_, new_n97_, new_n98_, new_n99_, new_n101_, new_n105_,
  ...
  nor2   g009(.a(x40), .b(x05), .O(new_n72_));
  ...
  oai21  g032(.a(new_n85_), .b(new_n93_), .c(new_n94_), .O(z08));
  oai21  g033(.a(new_n92_), .b(new_n85_), .c(z08), .O(z02));
  inv1   g034(.a(x37), .O(new_n97_));
  nand2  g035(.a(x28), .b(x27), .O(new_n98_));
  oai22  g036(.a(new_n98_), .b(new_n86_), .c(new_n97_), .d(x27), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(x21), .c(new_n72_), .O(z03));
  nor2   g038(.a(new_n72_), .b(x21), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n99_), .O(z04));
  aoi21  g040(.a(new_n98_), .b(new_n97_), .c(new_n72_), .O(z05));
  ...
  oai21  g055(.a(new_n117_), .b(new_n116_), .c(new_n94_), .O(z09));
  ...
  aoi21  g060(.a(new_n122_), .b(new_n120_), .c(new_n121_), .O(new_n123_));
  ...
  nor2   g064(.a(new_n85_), .b(new_n93_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(new_n82_), .c(x05), .d(new_n64_), .O(new_n128_));
  ...
  oai21  g070(.a(new_n86_), .b(x28), .c(new_n132_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x08), .O(new_n134_));
  nand3  g072(.a(new_n87_), .b(x27), .c(new_n64_), .O(new_n135_));
  nand3  g073(.a(new_n132_), .b(x27), .c(x04), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n131_), .c(new_n94_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n94_), .b(new_n68_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n127_), .O(new_n146_));
  oai21  g084(.a(new_n86_), .b(new_n77_), .c(new_n97_), .O(new_n147_));
  nor2   g085(.a(x19), .b(x18), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n94_), .c(new_n147_), .d(x20), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand3  g089(.a(new_n145_), .b(new_n127_), .c(new_n82_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand2  g091(.a(new_n145_), .b(new_n127_), .O(new_n154_));
  ...
  oai22  g097(.a(new_n159_), .b(new_n154_), .c(new_n66_), .d(new_n75_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(new_n94_), .O(z14));
  nand2  g099(.a(x26), .b(x12), .O(new_n162_));
  nor3   g100(.a(new_n162_), .b(new_n116_), .c(new_n72_), .O(z15));
  inv1   g101(.a(x23), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(x22), .c(x01), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n94_), .O(z16));
  nor2   g104(.a(x24), .b(new_n164_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n94_), .c(x22), .d(x01), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z17));
  nor2   g107(.a(new_n75_), .b(new_n64_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n90_), .c(new_n130_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n94_), .O(new_n172_));
  nand3  g110(.a(new_n127_), .b(x29), .c(x08), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(z18));
  inv1   g112(.a(new_n134_), .O(new_n175_));
  nand2  g113(.a(new_n132_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n135_), .b(new_n130_), .c(new_n94_), .O(new_n177_));
  aoi21  g115(.a(new_n176_), .b(new_n175_), .c(new_n177_), .O(z19));
  oai21  g116(.a(new_n86_), .b(new_n75_), .c(new_n130_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n175_), .c(new_n94_), .O(z20));
endmodule
