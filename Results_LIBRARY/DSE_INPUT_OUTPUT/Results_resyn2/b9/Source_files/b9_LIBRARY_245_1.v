...
module FAU ( 
  ...
  nor2   g001(.a(new_n63_), .b(x33), .O(new_n64_));
  ...
  nor2   g034(.a(new_n96_), .b(new_n64_), .O(new_n97_));
  ...
  nand2  g039(.a(new_n101_), .b(new_n80_), .O(z05));
  inv1   g040(.a(new_n101_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n80_), .O(z06));
  ...
  nand2  g052(.a(new_n73_), .b(new_n80_), .O(z08));
  and2   g053(.a(x34), .b(x27), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(x26), .c(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n80_), .O(z09));
  or2    g056(.a(new_n73_), .b(x05), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(new_n73_), .b(new_n120_), .O(new_n121_));
  nand4  g059(.a(new_n121_), .b(new_n119_), .c(new_n83_), .d(new_n75_), .O(new_n122_));
  nand3  g060(.a(x40), .b(x39), .c(new_n69_), .O(new_n123_));
  nor2   g061(.a(new_n85_), .b(new_n123_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n124_), .b(x05), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n122_), .c(new_n64_), .O(z10));
  ...
  aoi21  g073(.a(new_n134_), .b(new_n75_), .c(new_n135_), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n133_), .c(new_n64_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  oai21  g076(.a(new_n76_), .b(new_n123_), .c(new_n68_), .O(new_n139_));
  nand2  g077(.a(new_n70_), .b(new_n80_), .O(new_n140_));
  aoi21  g078(.a(new_n139_), .b(x27), .c(new_n140_), .O(z12));
  ...
  oai21  g084(.a(new_n63_), .b(new_n94_), .c(x28), .O(new_n147_));
  ...
  nand2  g088(.a(new_n124_), .b(new_n145_), .O(new_n151_));
  ...
  nand4  g092(.a(new_n116_), .b(new_n80_), .c(x26), .d(x12), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n80_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  inv1   g097(.a(new_n157_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n80_), .c(new_n159_), .d(x23), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z17));
  nor2   g100(.a(new_n135_), .b(new_n64_), .O(new_n163_));
  oai21  g101(.a(new_n94_), .b(new_n67_), .c(new_n163_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(new_n131_), .O(z20));
