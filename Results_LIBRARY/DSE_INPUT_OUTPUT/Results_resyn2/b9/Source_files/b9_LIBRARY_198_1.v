...
module FAU ( 
  ...
  aoi21  g023(.a(new_n85_), .b(new_n84_), .c(new_n78_), .O(new_n86_));
  inv1   g024(.a(x02), .O(new_n87_));
  nand2  g025(.a(x40), .b(x39), .O(new_n88_));
  inv1   g026(.a(new_n88_), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(x20), .O(new_n90_));
  nand2  g028(.a(x29), .b(x08), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(new_n87_), .c(new_n90_), .O(new_n92_));
  oai21  g030(.a(new_n86_), .b(new_n65_), .c(new_n92_), .O(z02));
  ...
  nor2   g038(.a(new_n100_), .b(new_n75_), .O(z05));
  ...
  nand2  g050(.a(new_n112_), .b(new_n72_), .O(z07));
  nand3  g051(.a(x40), .b(x39), .c(x20), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z08));
  and2   g053(.a(x34), .b(x27), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(x26), .c(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n72_), .O(z09));
  nand2  g056(.a(x37), .b(x06), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(new_n88_), .b(new_n120_), .O(new_n121_));
  nand3  g059(.a(new_n121_), .b(new_n79_), .c(new_n65_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  inv1   g061(.a(x05), .O(new_n124_));
  nand3  g062(.a(new_n119_), .b(x39), .c(new_n124_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x20), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(x40), .c(new_n85_), .O(new_n127_));
  ...
  inv1   g069(.a(new_n90_), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(new_n131_), .c(x05), .d(new_n65_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n128_), .O(z10));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n84_), .c(x04), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x20), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x40), .O(new_n138_));
  nand3  g076(.a(x40), .b(x39), .c(x29), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x27), .c(x04), .O(new_n140_));
  nand2  g078(.a(new_n139_), .b(new_n78_), .O(new_n141_));
  oai21  g079(.a(new_n78_), .b(new_n85_), .c(new_n84_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n135_), .O(new_n144_));
  ...
  nand2  g085(.a(new_n72_), .b(new_n147_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n89_), .c(new_n149_), .d(new_n65_), .O(new_n152_));
  nand2  g090(.a(x35), .b(x28), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n94_), .O(new_n154_));
  ...
  nor2   g096(.a(new_n88_), .b(x04), .O(new_n159_));
  nand3  g097(.a(new_n131_), .b(new_n159_), .c(new_n149_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n158_), .c(new_n71_), .O(z13));
  nand2  g099(.a(new_n159_), .b(new_n149_), .O(new_n162_));
  nand3  g100(.a(new_n150_), .b(new_n81_), .c(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n162_), .c(x19), .d(x18), .O(new_n165_));
  aoi21  g103(.a(new_n77_), .b(x27), .c(new_n131_), .O(new_n166_));
  oai22  g104(.a(new_n166_), .b(new_n162_), .c(new_n63_), .d(new_n85_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n165_), .c(x20), .O(z14));
  nand4  g106(.a(new_n116_), .b(new_n72_), .c(x26), .d(x12), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(z15));
  nand2  g108(.a(x22), .b(x01), .O(new_n171_));
  nor3   g109(.a(new_n171_), .b(new_n75_), .c(x23), .O(z16));
  inv1   g110(.a(x24), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x23), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n171_), .c(new_n72_), .O(z17));
  nand2  g113(.a(new_n139_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n141_), .c(x08), .O(new_n177_));
  inv1   g115(.a(new_n78_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(x27), .c(new_n65_), .O(new_n179_));
  and2   g117(.a(new_n135_), .b(new_n72_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n179_), .c(new_n177_), .O(z18));
  nand2  g119(.a(new_n85_), .b(new_n84_), .O(new_n182_));
  nand2  g120(.a(x27), .b(x04), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n182_), .c(new_n178_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n135_), .O(new_n185_));
  nor2   g123(.a(new_n114_), .b(new_n91_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(new_n72_), .c(new_n186_), .O(z19));
  nand2  g125(.a(x35), .b(x27), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n180_), .O(new_n189_));
  aoi21  g127(.a(new_n141_), .b(x08), .c(new_n189_), .O(z20));
endmodule
