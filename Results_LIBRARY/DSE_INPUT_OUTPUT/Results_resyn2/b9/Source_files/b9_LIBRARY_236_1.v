...
module FAU ( 
  ...
  nor2   g027(.a(new_n89_), .b(new_n71_), .O(z08));
  nand3  g028(.a(z08), .b(new_n88_), .c(new_n85_), .O(z02));
  ...
  oai21  g036(.a(new_n77_), .b(new_n75_), .c(new_n94_), .O(new_n99_));
  ...
  nand2  g052(.a(new_n80_), .b(x40), .O(new_n115_));
  ...
  oai21  g078(.a(new_n76_), .b(new_n116_), .c(x28), .O(new_n141_));
  nor2   g079(.a(x13), .b(x04), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(z08), .O(new_n143_));
  nand2  g081(.a(new_n92_), .b(new_n94_), .O(new_n144_));
  ...
  nand3  g086(.a(new_n142_), .b(z08), .c(new_n80_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  oai21  g088(.a(new_n142_), .b(new_n71_), .c(x40), .O(new_n151_));
  nand3  g089(.a(new_n145_), .b(new_n135_), .c(x20), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  inv1   g091(.a(new_n141_), .O(new_n154_));
  nand2  g092(.a(new_n94_), .b(new_n116_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n145_), .c(x20), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n154_), .c(new_n75_), .O(new_n157_));
  or2    g095(.a(new_n80_), .b(new_n71_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n153_), .O(z14));
  nand4  g097(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n72_), .O(z15));
  inv1   g099(.a(x01), .O(new_n162_));
  inv1   g100(.a(x22), .O(new_n163_));
  nor4   g101(.a(new_n81_), .b(x23), .c(new_n163_), .d(new_n162_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  nor2   g103(.a(new_n163_), .b(new_n162_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n72_), .c(new_n165_), .d(x23), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z17));
  aoi21  g106(.a(new_n132_), .b(new_n129_), .c(new_n81_), .O(z18));
  nand2  g107(.a(x40), .b(x29), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n78_), .O(new_n171_));
  nand2  g109(.a(x35), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n130_), .c(new_n72_), .O(new_n173_));
  aoi21  g111(.a(new_n171_), .b(x08), .c(new_n173_), .O(z20));
  nand2  g112(.a(new_n133_), .b(new_n72_), .O(z19));
endmodule
