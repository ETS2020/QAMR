...
module FAU ( 
  ...
  nor2   g008(.a(x23), .b(x22), .O(new_n71_));
  ...
  aoi21  g032(.a(new_n94_), .b(x21), .c(new_n71_), .O(z03));
  inv1   g033(.a(x21), .O(new_n96_));
  aoi21  g034(.a(new_n94_), .b(new_n96_), .c(new_n71_), .O(z04));
  nand3  g035(.a(new_n93_), .b(new_n84_), .c(new_n92_), .O(z05));
  nand2  g036(.a(new_n93_), .b(new_n92_), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n84_), .O(z06));
  ...
  nand3  g047(.a(new_n109_), .b(new_n84_), .c(x03), .O(new_n110_));
  ...
  nand2  g065(.a(new_n83_), .b(x29), .O(new_n128_));
  ...
  nand4  g070(.a(x35), .b(new_n75_), .c(x27), .d(new_n63_), .O(new_n133_));
  ...
  nand2  g074(.a(new_n84_), .b(new_n69_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  nand3  g077(.a(new_n83_), .b(new_n139_), .c(new_n63_), .O(new_n140_));
  ...
  aoi21  g084(.a(new_n146_), .b(new_n120_), .c(new_n71_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  nand2  g086(.a(new_n141_), .b(new_n79_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n143_), .O(new_n151_));
  inv1   g089(.a(x27), .O(new_n152_));
  aoi21  g090(.a(new_n75_), .b(x27), .c(new_n120_), .O(new_n153_));
  oai22  g091(.a(new_n153_), .b(new_n140_), .c(new_n66_), .d(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n151_), .c(new_n84_), .O(z14));
  inv1   g093(.a(x12), .O(new_n156_));
  oai21  g094(.a(new_n114_), .b(new_n156_), .c(new_n84_), .O(z15));
  ...
  aoi21  g100(.a(new_n134_), .b(new_n131_), .c(new_n71_), .O(z18));
  oai21  g101(.a(new_n91_), .b(new_n152_), .c(new_n132_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n129_), .c(new_n84_), .O(z20));
  nand2  g103(.a(new_n135_), .b(new_n84_), .O(z19));
endmodule
