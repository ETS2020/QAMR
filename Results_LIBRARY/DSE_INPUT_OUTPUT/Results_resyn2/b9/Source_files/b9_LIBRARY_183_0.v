...
module FAU ( 
  ...
  nor2   g017(.a(x23), .b(x16), .O(new_n80_));
  ...
  aoi21  g029(.a(new_n91_), .b(x21), .c(new_n80_), .O(z03));
  inv1   g030(.a(x21), .O(new_n93_));
  aoi21  g031(.a(new_n91_), .b(new_n93_), .c(new_n80_), .O(z04));
  aoi21  g032(.a(x28), .b(x27), .c(x37), .O(new_n95_));
  nor2   g033(.a(new_n95_), .b(new_n80_), .O(z05));
  inv1   g034(.a(new_n95_), .O(new_n97_));
  nor2   g035(.a(new_n97_), .b(new_n80_), .O(z06));
  ...
  nand2  g048(.a(new_n99_), .b(new_n85_), .O(z08));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(new_n99_), .O(z09));
  inv1   g051(.a(new_n85_), .O(new_n114_));
  nand2  g052(.a(new_n79_), .b(new_n114_), .O(new_n115_));
  inv1   g053(.a(x35), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(x28), .c(new_n73_), .O(new_n117_));
  ...
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n99_), .O(z10));
  inv1   g064(.a(x08), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n75_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nor2   g069(.a(x30), .b(x09), .O(new_n132_));
  nand4  g070(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n133_));
  and2   g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n99_), .O(z11));
  nand2  g074(.a(new_n67_), .b(x27), .O(new_n137_));
  nand3  g075(.a(new_n99_), .b(new_n68_), .c(new_n137_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n114_), .O(new_n143_));
  ...
  nand3  g087(.a(new_n142_), .b(new_n79_), .c(new_n114_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n149_), .c(new_n80_), .O(z13));
  nand2  g089(.a(new_n142_), .b(new_n114_), .O(new_n152_));
  nand2  g090(.a(new_n146_), .b(x20), .O(new_n153_));
  nand4  g091(.a(new_n140_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n152_), .c(new_n153_), .O(new_n156_));
  aoi21  g094(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n157_));
  oai22  g095(.a(new_n157_), .b(new_n152_), .c(new_n63_), .d(new_n72_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n156_), .c(new_n99_), .O(z14));
  nand4  g097(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n99_), .O(z15));
  inv1   g099(.a(x23), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x22), .c(x16), .d(x01), .O(new_n163_));
  ...
  aoi21  g105(.a(new_n134_), .b(new_n131_), .c(new_n80_), .O(z18));
  oai21  g106(.a(new_n116_), .b(new_n72_), .c(new_n132_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n129_), .c(new_n99_), .O(z20));
  nand2  g108(.a(new_n135_), .b(new_n99_), .O(z19));
endmodule
