...
module FAU ( 
  ...
  nand3  g007(.a(new_n67_), .b(x10), .c(new_n65_), .O(new_n70_));
  nand2  g008(.a(new_n70_), .b(x21), .O(new_n71_));
  ...
  nor2   g019(.a(x21), .b(x15), .O(new_n82_));
  ...
  nand4  g028(.a(new_n90_), .b(new_n87_), .c(new_n85_), .d(new_n67_), .O(z02));
  ...
  nand2  g051(.a(new_n85_), .b(new_n66_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand3  g053(.a(x34), .b(x27), .c(x26), .O(new_n116_));
  nor3   g054(.a(new_n116_), .b(new_n82_), .c(new_n115_), .O(z09));
  ...
  nand2  g074(.a(new_n136_), .b(new_n85_), .O(z11));
  nand2  g075(.a(new_n85_), .b(new_n70_), .O(new_n138_));
  aoi21  g076(.a(new_n69_), .b(x27), .c(new_n138_), .O(z12));
  oai21  g077(.a(new_n75_), .b(new_n92_), .c(x28), .O(new_n140_));
  ...
  nand3  g085(.a(new_n141_), .b(new_n81_), .c(new_n67_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n82_), .O(z13));
  aoi21  g087(.a(new_n145_), .b(new_n142_), .c(new_n74_), .O(new_n150_));
  inv1   g088(.a(new_n148_), .O(new_n151_));
  nor3   g089(.a(new_n151_), .b(new_n150_), .c(new_n82_), .O(z14));
  inv1   g090(.a(x12), .O(new_n153_));
  oai21  g091(.a(new_n116_), .b(new_n153_), .c(new_n85_), .O(z15));
  nand2  g092(.a(x22), .b(x01), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n82_), .c(x23), .O(z16));
  inv1   g094(.a(x24), .O(new_n157_));
  inv1   g095(.a(new_n155_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n85_), .c(new_n157_), .d(x23), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z17));
  nand4  g098(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n85_), .O(z18));
  oai21  g099(.a(new_n92_), .b(new_n74_), .c(new_n135_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n131_), .c(new_n85_), .O(z20));
  nand2  g101(.a(new_n136_), .b(new_n85_), .O(z19));
endmodule
