...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n156_, new_n157_, new_n161_, new_n162_;
  inv1   g000(.a(x05), .O(new_n63_));
  nand2  g001(.a(x14), .b(new_n63_), .O(new_n64_));
  ...
  aoi21  g036(.a(new_n96_), .b(new_n98_), .c(new_n65_), .O(z04));
  ...
  nor2   g051(.a(new_n76_), .b(new_n65_), .O(z08));
  and2   g052(.a(x34), .b(x27), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x26), .c(x11), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n64_), .O(z09));
  aoi21  g055(.a(new_n76_), .b(new_n105_), .c(x05), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n76_), .b(new_n119_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n84_), .c(new_n69_), .O(new_n121_));
  ...
  nand3  g063(.a(new_n125_), .b(new_n77_), .c(x05), .O(new_n126_));
  ...
  oai21  g076(.a(new_n79_), .b(new_n75_), .c(new_n64_), .O(z12));
  inv1   g077(.a(new_n68_), .O(new_n140_));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(x20), .O(new_n142_));
  inv1   g080(.a(x13), .O(new_n143_));
  oai21  g081(.a(new_n71_), .b(new_n70_), .c(x28), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n77_), .c(new_n143_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n142_), .c(new_n67_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n125_), .b(new_n77_), .c(new_n143_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n65_), .O(z13));
  inv1   g087(.a(new_n148_), .O(new_n150_));
  nor3   g088(.a(new_n150_), .b(new_n146_), .c(new_n65_), .O(z14));
  nand4  g089(.a(new_n115_), .b(new_n64_), .c(x26), .d(x12), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(z15));
  nand2  g091(.a(x22), .b(x01), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n65_), .c(x23), .O(z16));
  inv1   g093(.a(x24), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x23), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n154_), .c(new_n64_), .O(z17));
  nand3  g096(.a(new_n136_), .b(new_n132_), .c(new_n64_), .O(z18));
  inv1   g097(.a(z18), .O(z19));
  nor2   g098(.a(new_n135_), .b(new_n65_), .O(new_n161_));
  oai21  g099(.a(new_n70_), .b(new_n67_), .c(new_n161_), .O(new_n162_));
