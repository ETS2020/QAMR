...
module FAU ( 
  ...
  aoi21  g067(.a(new_n129_), .b(new_n90_), .c(new_n88_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nor2   g069(.a(new_n81_), .b(x28), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x27), .c(new_n73_), .O(new_n133_));
  ...
  nand3  g074(.a(new_n69_), .b(new_n82_), .c(new_n81_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x27), .c(x10), .O(new_n138_));
  nand2  g076(.a(new_n70_), .b(new_n69_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(x27), .c(x40), .d(new_n73_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n138_), .c(x39), .O(new_n141_));
  inv1   g079(.a(new_n71_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n63_), .c(new_n105_), .O(new_n143_));
  ...
  nand4  g087(.a(new_n149_), .b(new_n139_), .c(new_n64_), .d(x20), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand3  g090(.a(new_n147_), .b(new_n117_), .c(z08), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand2  g092(.a(new_n149_), .b(x20), .O(new_n155_));
  nand3  g093(.a(new_n145_), .b(new_n85_), .c(x28), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n147_), .c(z08), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n89_), .b(x27), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n85_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n147_), .c(z08), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n142_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n158_), .c(new_n65_), .O(z14));
  nand4  g101(.a(new_n114_), .b(new_n64_), .c(x26), .d(x12), .O(new_n164_));
  ...
  nand2  g109(.a(new_n68_), .b(new_n88_), .O(new_n172_));
  nand2  g110(.a(x27), .b(x04), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n132_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n134_), .O(new_n175_));
  ...
  nand2  g116(.a(new_n134_), .b(new_n64_), .O(new_n179_));
  nor2   g117(.a(new_n81_), .b(new_n68_), .O(new_n180_));
  nor3   g118(.a(new_n180_), .b(new_n179_), .c(new_n130_), .O(z20));
  aoi21  g119(.a(new_n131_), .b(new_n130_), .c(new_n135_), .O(z19));
endmodule
