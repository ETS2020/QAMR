...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n167_, new_n169_, new_n170_, new_n174_, new_n175_;
  ...
  nor2   g009(.a(x40), .b(x01), .O(new_n72_));
  ...
  aoi21  g064(.a(new_n120_), .b(new_n126_), .c(x04), .O(new_n127_));
  ...
  nor2   g074(.a(new_n92_), .b(x04), .O(new_n137_));
  inv1   g075(.a(x09), .O(new_n138_));
  nand2  g076(.a(new_n117_), .b(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n137_), .b(new_n136_), .c(new_n139_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n135_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n98_), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand3  g081(.a(new_n98_), .b(new_n68_), .c(new_n143_), .O(new_n144_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n66_), .c(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  inv1   g092(.a(new_n121_), .O(new_n155_));
  aoi21  g093(.a(new_n148_), .b(new_n155_), .c(new_n72_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand2  g095(.a(new_n148_), .b(new_n120_), .O(new_n158_));
  nand3  g096(.a(new_n146_), .b(new_n79_), .c(x28), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(new_n152_), .O(new_n161_));
  aoi21  g099(.a(new_n82_), .b(x27), .c(new_n119_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n158_), .c(new_n66_), .d(new_n92_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n98_), .O(z14));
  nand2  g102(.a(x26), .b(x12), .O(new_n165_));
  nor3   g103(.a(new_n165_), .b(new_n114_), .c(new_n72_), .O(z15));
  ...
  nand3  g109(.a(new_n140_), .b(new_n135_), .c(new_n98_), .O(z18));
  inv1   g110(.a(z18), .O(z19));
  nand2  g111(.a(x35), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n117_), .c(new_n138_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n133_), .c(new_n98_), .O(z20));
endmodule
