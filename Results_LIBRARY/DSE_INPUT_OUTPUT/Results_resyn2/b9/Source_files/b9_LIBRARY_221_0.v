...
module FAU ( 
  ...
  oai21  g023(.a(new_n84_), .b(new_n65_), .c(new_n85_), .O(new_n86_));
  ...
  nor2   g028(.a(new_n77_), .b(new_n63_), .O(z08));
  ...
  aoi21  g033(.a(new_n67_), .b(x27), .c(new_n63_), .O(new_n96_));
  ...
  nand4  g054(.a(new_n116_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n115_), .O(z09));
  nor2   g056(.a(new_n84_), .b(new_n65_), .O(new_n119_));
  nand2  g057(.a(new_n74_), .b(x05), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(new_n121_));
  and2   g059(.a(new_n77_), .b(x07), .O(new_n122_));
  ...
  nand2  g066(.a(new_n74_), .b(x29), .O(new_n129_));
  ...
  nor2   g071(.a(new_n65_), .b(x04), .O(new_n134_));
  ...
  nand3  g075(.a(new_n137_), .b(new_n132_), .c(new_n116_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  inv1   g077(.a(new_n76_), .O(new_n140_));
  nand3  g078(.a(new_n79_), .b(new_n140_), .c(new_n116_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  oai21  g081(.a(new_n72_), .b(new_n71_), .c(x28), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(new_n74_), .c(new_n143_), .d(new_n70_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n68_), .c(x20), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n65_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  nand3  g087(.a(new_n74_), .b(new_n143_), .c(new_n70_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n85_), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n149_), .c(new_n116_), .O(z13));
  oai21  g091(.a(new_n151_), .b(new_n148_), .c(new_n116_), .O(z14));
  inv1   g092(.a(x12), .O(new_n155_));
  nor2   g093(.a(new_n117_), .b(new_n155_), .O(z15));
  ...
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n116_), .O(z17));
  aoi21  g099(.a(new_n137_), .b(new_n132_), .c(new_n63_), .O(z18));
  oai21  g100(.a(new_n71_), .b(new_n65_), .c(new_n135_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n130_), .c(new_n116_), .O(z20));
