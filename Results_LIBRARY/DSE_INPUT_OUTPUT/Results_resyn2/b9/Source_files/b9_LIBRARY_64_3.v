...
module FAU ( 
  ...
  aoi22  g40(.a(new_n103_), .b(new_n74_), .c(x37), .d(x06), .O(new_n104_));
  oai21  g41(.a(new_n104_), .b(new_n66_), .c(new_n63_), .O(z10));
  nor2   g42(.a(x30), .b(x09), .O(new_n106_));
  inv1   g43(.a(x28), .O(new_n107_));
  inv1   g44(.a(x08), .O(new_n108_));
  nand2  g45(.a(new_n66_), .b(new_n108_), .O(new_n109_));
  nand2  g46(.a(x27), .b(x04), .O(new_n110_));
  nand4  g47(.a(new_n110_), .b(new_n109_), .c(x35), .d(new_n107_), .O(new_n111_));
  nand2  g48(.a(new_n111_), .b(new_n106_), .O(new_n112_));
  nand2  g49(.a(new_n112_), .b(new_n63_), .O(z11));
  nand2  g50(.a(new_n69_), .b(new_n63_), .O(z12));
  nor2   g51(.a(x19), .b(x18), .O(new_n115_));
  nand2  g52(.a(new_n115_), .b(x20), .O(new_n116_));
  inv1   g53(.a(new_n116_), .O(new_n117_));
  aoi21  g54(.a(new_n117_), .b(new_n69_), .c(z08), .O(z14));
  inv1   g55(.a(z14), .O(z13));
  nand4  g56(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n120_));
  nand2  g57(.a(new_n120_), .b(new_n63_), .O(z15));
  inv1   g58(.a(x23), .O(new_n122_));
  nand4  g59(.a(new_n63_), .b(new_n122_), .c(x22), .d(x01), .O(new_n123_));
  inv1   g60(.a(new_n123_), .O(z16));
  nand2  g61(.a(x22), .b(x01), .O(new_n125_));
  nor4   g62(.a(new_n125_), .b(z08), .c(x24), .d(new_n122_), .O(z17));
  nand3  g63(.a(new_n111_), .b(new_n106_), .c(new_n63_), .O(z18));
  inv1   g64(.a(z18), .O(z19));
  aoi21  g65(.a(new_n107_), .b(x08), .c(x27), .O(new_n129_));
  oai21  g66(.a(new_n129_), .b(new_n72_), .c(new_n106_), .O(new_n130_));
