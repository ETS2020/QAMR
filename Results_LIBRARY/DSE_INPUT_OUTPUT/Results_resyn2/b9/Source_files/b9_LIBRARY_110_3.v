...
module FAU ( 
  ...
  nand2  g008(.a(x22), .b(x01), .O(new_n71_));
  ...
  inv1   g019(.a(new_n71_), .O(z16));
  nor2   g020(.a(z16), .b(new_n65_), .O(new_n83_));
  ...
  aoi21  g027(.a(new_n89_), .b(new_n86_), .c(z16), .O(z02));
  ...
  aoi21  g032(.a(new_n94_), .b(x21), .c(z16), .O(z03));
  ...
  nand2  g049(.a(new_n71_), .b(new_n87_), .O(z08));
  nand2  g050(.a(x34), .b(x27), .O(new_n113_));
  nand2  g051(.a(x26), .b(x11), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(new_n113_), .c(new_n71_), .O(z09));
  ...
  aoi21  g057(.a(new_n119_), .b(new_n78_), .c(new_n117_), .O(new_n120_));
  oai21  g058(.a(new_n87_), .b(x05), .c(new_n65_), .O(new_n121_));
  nand3  g059(.a(x37), .b(x27), .c(x06), .O(new_n122_));
  and2   g060(.a(new_n122_), .b(new_n71_), .O(new_n123_));
  oai21  g061(.a(new_n121_), .b(new_n120_), .c(new_n123_), .O(z10));
  ...
  nand3  g075(.a(new_n71_), .b(new_n68_), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n63_), .c(new_n144_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  aoi21  g086(.a(new_n143_), .b(new_n117_), .c(z16), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand2  g088(.a(new_n143_), .b(new_n140_), .O(new_n151_));
  nand3  g089(.a(new_n141_), .b(new_n116_), .c(x28), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n146_), .O(new_n154_));
  aoi21  g092(.a(new_n76_), .b(x27), .c(new_n81_), .O(new_n155_));
  oai22  g093(.a(new_n155_), .b(new_n151_), .c(new_n63_), .d(new_n74_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n154_), .c(new_n71_), .O(z14));
  nand3  g095(.a(new_n71_), .b(x26), .c(x12), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(new_n113_), .O(z15));
  nand3  g097(.a(new_n134_), .b(new_n129_), .c(new_n71_), .O(z18));
  inv1   g098(.a(z18), .O(z19));
  nand2  g099(.a(x35), .b(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n79_), .c(new_n132_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n127_), .c(new_n71_), .O(z20));
  inv1   g102(.a(new_n71_), .O(z17));
endmodule
