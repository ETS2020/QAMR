...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n71_,
    ...
    new_n80_, new_n82_, new_n85_, new_n87_, new_n88_, new_n89_, new_n90_,
  ...
  aoi21  g18(.a(new_n80_), .b(x21), .c(new_n71_), .O(z03));
  inv1   g19(.a(x21), .O(new_n82_));
  aoi21  g20(.a(new_n80_), .b(new_n82_), .c(new_n71_), .O(z04));
  nand3  g21(.a(new_n79_), .b(z02), .c(new_n65_), .O(z05));
  nand2  g22(.a(new_n79_), .b(new_n65_), .O(new_n85_));
  ...
  nand4  g37(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n101_));
  ...
  oai21  g42(.a(new_n105_), .b(new_n64_), .c(z02), .O(z10));
  inv1   g43(.a(x09), .O(new_n107_));
  inv1   g44(.a(x30), .O(new_n108_));
  nand3  g45(.a(z02), .b(new_n108_), .c(new_n107_), .O(new_n109_));
  inv1   g46(.a(x08), .O(new_n110_));
  nand2  g47(.a(new_n64_), .b(new_n110_), .O(new_n111_));
  ...
  aoi21  g52(.a(new_n115_), .b(new_n111_), .c(new_n109_), .O(z11));
  nor2   g53(.a(new_n71_), .b(new_n67_), .O(z12));
  inv1   g54(.a(x18), .O(new_n118_));
  inv1   g55(.a(x19), .O(new_n119_));
  nand4  g56(.a(new_n67_), .b(x20), .c(new_n119_), .d(new_n118_), .O(new_n120_));
  nand2  g57(.a(new_n120_), .b(z02), .O(z13));
  inv1   g58(.a(new_n120_), .O(new_n122_));
  nand2  g59(.a(new_n122_), .b(z02), .O(z14));
  inv1   g60(.a(x12), .O(new_n124_));
  nor2   g61(.a(new_n101_), .b(new_n124_), .O(z15));
  inv1   g62(.a(x23), .O(new_n126_));
  nand4  g63(.a(z02), .b(new_n126_), .c(x22), .d(x01), .O(new_n127_));
  inv1   g64(.a(new_n127_), .O(z16));
  inv1   g65(.a(x24), .O(new_n129_));
  nand4  g66(.a(new_n129_), .b(x23), .c(x22), .d(x01), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(z02), .O(z17));
  inv1   g68(.a(z11), .O(z18));
  oai21  g69(.a(x28), .b(new_n110_), .c(new_n64_), .O(new_n133_));
  aoi21  g70(.a(new_n133_), .b(x35), .c(new_n109_), .O(z20));
  zero   g71(.O(z08));
  aoi21  g72(.a(new_n115_), .b(new_n111_), .c(new_n109_), .O(z19));
endmodule
