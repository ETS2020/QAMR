...
module FAU ( 
  ...
  and2   g008(.a(x33), .b(x14), .O(new_n71_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n71_), .O(z05));
  ...
  oai21  g046(.a(new_n108_), .b(x31), .c(x14), .O(new_n109_));
  nand3  g047(.a(new_n109_), .b(new_n106_), .c(x03), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(new_n84_), .O(z07));
  nand2  g049(.a(new_n84_), .b(new_n82_), .O(z08));
  nand2  g050(.a(x34), .b(x27), .O(new_n113_));
  nand2  g051(.a(x26), .b(x11), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(new_n113_), .c(new_n84_), .O(z09));
  nand3  g053(.a(x40), .b(x39), .c(x05), .O(new_n116_));
  nand2  g054(.a(new_n82_), .b(x07), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n77_), .c(x27), .O(new_n119_));
  inv1   g057(.a(new_n79_), .O(new_n120_));
  inv1   g058(.a(new_n116_), .O(new_n121_));
  ...
  nor2   g069(.a(new_n91_), .b(new_n93_), .O(new_n132_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n131_), .c(new_n84_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n84_), .b(new_n69_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z12));
  aoi21  g077(.a(x36), .b(x35), .c(new_n75_), .O(new_n140_));
  inv1   g078(.a(x13), .O(new_n141_));
  nand3  g079(.a(new_n83_), .b(new_n141_), .c(new_n63_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x20), .O(new_n144_));
  oai22  g082(.a(new_n144_), .b(new_n66_), .c(new_n142_), .d(new_n140_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  nor2   g084(.a(new_n142_), .b(new_n79_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n71_), .O(z13));
  nand4  g087(.a(new_n83_), .b(new_n75_), .c(new_n141_), .d(new_n63_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n66_), .c(new_n93_), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n79_), .c(x28), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n83_), .c(new_n141_), .d(new_n63_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n144_), .c(new_n71_), .O(new_n155_));
  oai21  g093(.a(new_n151_), .b(new_n147_), .c(new_n155_), .O(z14));
  nand2  g094(.a(x26), .b(x12), .O(new_n157_));
  nor3   g095(.a(new_n157_), .b(new_n113_), .c(new_n71_), .O(z15));
  ...
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n84_), .O(z17));
  aoi21  g101(.a(new_n135_), .b(new_n131_), .c(new_n71_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nor4   g103(.a(new_n134_), .b(new_n132_), .c(new_n129_), .d(new_n71_), .O(z20));
endmodule
