...
module FAU ( 
  ...
  aoi21  g058(.a(new_n83_), .b(new_n81_), .c(x04), .O(new_n121_));
  nand2  g059(.a(x37), .b(x06), .O(new_n122_));
  aoi21  g060(.a(new_n63_), .b(x39), .c(new_n122_), .O(new_n123_));
  ...
  oai21  g084(.a(new_n81_), .b(new_n88_), .c(x28), .O(new_n147_));
  ...
  nand3  g089(.a(new_n148_), .b(new_n85_), .c(new_n78_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  inv1   g091(.a(new_n147_), .O(new_n154_));
  nand2  g092(.a(new_n69_), .b(new_n88_), .O(new_n155_));
  ...
  nand3  g097(.a(x39), .b(new_n159_), .c(new_n73_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n158_), .c(new_n65_), .O(new_n161_));
  oai21  g099(.a(new_n157_), .b(new_n85_), .c(new_n161_), .O(z14));
  nand3  g100(.a(new_n115_), .b(new_n64_), .c(x12), .O(new_n163_));
  ...
  nor2   g108(.a(new_n68_), .b(new_n73_), .O(new_n171_));
  oai21  g109(.a(new_n129_), .b(new_n128_), .c(new_n134_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n171_), .b(new_n90_), .c(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n64_), .O(z19));
  nor2   g113(.a(new_n88_), .b(new_n68_), .O(new_n176_));
  nor3   g114(.a(new_n176_), .b(new_n135_), .c(new_n130_), .O(z20));
