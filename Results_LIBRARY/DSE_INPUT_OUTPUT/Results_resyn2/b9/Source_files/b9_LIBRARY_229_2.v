...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n149_, new_n150_, new_n152_, new_n153_, new_n156_;
  inv1   g00(.a(x22), .O(new_n63_));
  nor2   g01(.a(x34), .b(new_n63_), .O(new_n64_));
  ...
  nand2  g22(.a(x35), .b(new_n79_), .O(new_n85_));
  ...
  nand4  g28(.a(new_n90_), .b(new_n87_), .c(new_n72_), .d(new_n84_), .O(z02));
  ...
  nand2  g38(.a(x17), .b(new_n65_), .O(new_n101_));
  nor2   g39(.a(x33), .b(x31), .O(new_n102_));
  aoi21  g40(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(new_n103_));
  inv1   g41(.a(x25), .O(new_n104_));
  nand2  g42(.a(new_n104_), .b(x00), .O(new_n105_));
  nand2  g43(.a(x25), .b(new_n100_), .O(new_n106_));
  nand3  g44(.a(new_n106_), .b(new_n105_), .c(x38), .O(new_n107_));
  nand3  g45(.a(new_n107_), .b(new_n84_), .c(x03), .O(new_n108_));
  nor2   g46(.a(new_n108_), .b(new_n103_), .O(z07));
  inv1   g47(.a(new_n72_), .O(new_n110_));
  nand2  g48(.a(new_n110_), .b(new_n84_), .O(z08));
  nand4  g49(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  nand2  g50(.a(new_n112_), .b(new_n84_), .O(z09));
  ...
  nor2   g55(.a(new_n72_), .b(new_n117_), .O(new_n118_));
  aoi22  g56(.a(new_n118_), .b(new_n114_), .c(new_n116_), .d(new_n82_), .O(new_n119_));
  ...
  aoi21  g63(.a(new_n125_), .b(new_n85_), .c(new_n124_), .O(new_n126_));
  nand2  g64(.a(new_n125_), .b(x27), .O(new_n127_));
  nand4  g65(.a(x35), .b(new_n79_), .c(x27), .d(new_n68_), .O(new_n128_));
  nor2   g66(.a(x30), .b(x09), .O(new_n129_));
  nand3  g67(.a(new_n129_), .b(new_n128_), .c(new_n84_), .O(new_n130_));
  aoi21  g68(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z11));
  oai21  g69(.a(new_n76_), .b(new_n74_), .c(new_n84_), .O(z12));
  inv1   g70(.a(x13), .O(new_n133_));
  oai21  g71(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n134_));
  nand4  g72(.a(new_n134_), .b(new_n72_), .c(new_n133_), .d(new_n68_), .O(new_n135_));
  ...
  nand3  g78(.a(new_n72_), .b(new_n133_), .c(new_n68_), .O(new_n141_));
  nor2   g79(.a(new_n141_), .b(new_n81_), .O(new_n142_));
  inv1   g80(.a(new_n142_), .O(new_n143_));
  aoi21  g81(.a(new_n143_), .b(new_n140_), .c(new_n64_), .O(z13));
  aoi21  g82(.a(new_n138_), .b(new_n135_), .c(new_n66_), .O(new_n145_));
  oai21  g83(.a(new_n142_), .b(new_n145_), .c(new_n84_), .O(z14));
  nand4  g84(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n147_));
  nand2  g85(.a(new_n147_), .b(new_n84_), .O(z15));
  inv1   g86(.a(x23), .O(new_n149_));
  nand4  g87(.a(x34), .b(new_n149_), .c(x22), .d(x01), .O(new_n150_));
  inv1   g88(.a(new_n150_), .O(z16));
  inv1   g89(.a(x24), .O(new_n152_));
  nand3  g90(.a(new_n152_), .b(x23), .c(x01), .O(new_n153_));
  aoi21  g91(.a(new_n153_), .b(x34), .c(new_n63_), .O(z17));
  inv1   g92(.a(z11), .O(z18));
  oai21  g93(.a(new_n69_), .b(new_n66_), .c(new_n129_), .O(new_n156_));
  oai21  g94(.a(new_n156_), .b(new_n126_), .c(new_n84_), .O(z20));
  aoi21  g95(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z19));
endmodule
