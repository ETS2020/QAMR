...
module FAU ( 
  ...
  xor2a  g029(.a(new_n91_), .b(new_n83_), .O(z02));
  ...
  oai21  g034(.a(new_n96_), .b(new_n71_), .c(x21), .O(z03));
  ...
  nand2  g051(.a(new_n72_), .b(new_n88_), .O(z08));
  ...
  oai21  g058(.a(new_n93_), .b(x28), .c(new_n76_), .O(new_n121_));
  ...
  aoi21  g070(.a(new_n132_), .b(new_n78_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n132_), .b(x27), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  inv1   g073(.a(new_n78_), .O(new_n136_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n72_), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand2  g081(.a(new_n68_), .b(new_n143_), .O(new_n144_));
  nand2  g082(.a(new_n72_), .b(new_n144_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nor2   g084(.a(new_n88_), .b(x04), .O(new_n147_));
  oai21  g085(.a(new_n76_), .b(new_n93_), .c(x28), .O(new_n148_));
  ...
  nand4  g090(.a(new_n152_), .b(new_n72_), .c(new_n151_), .d(x20), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n82_), .b(new_n147_), .c(new_n146_), .O(new_n156_));
  ...
  nand2  g097(.a(new_n156_), .b(new_n72_), .O(new_n160_));
  aoi21  g098(.a(new_n159_), .b(x27), .c(new_n160_), .O(z14));
  nand3  g099(.a(new_n116_), .b(new_n72_), .c(x12), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z15));
  nand2  g101(.a(x22), .b(x01), .O(new_n164_));
  nor3   g102(.a(new_n164_), .b(new_n83_), .c(x23), .O(z16));
  inv1   g103(.a(x24), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x23), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n164_), .c(new_n72_), .O(z17));
  nand3  g106(.a(new_n140_), .b(new_n135_), .c(new_n72_), .O(z18));
  inv1   g107(.a(z18), .O(z19));
  nand2  g108(.a(x35), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n138_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n133_), .c(new_n72_), .O(z20));
endmodule
