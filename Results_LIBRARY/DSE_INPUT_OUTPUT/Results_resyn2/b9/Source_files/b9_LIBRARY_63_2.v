...
module FAU ( 
  ...
  nor2   g010(.a(x14), .b(new_n72_), .O(new_n73_));
  ...
  inv1   g021(.a(x14), .O(new_n84_));
  oai21  g022(.a(x29), .b(new_n84_), .c(x08), .O(new_n85_));
  nand2  g023(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  inv1   g024(.a(new_n73_), .O(new_n87_));
  nor2   g025(.a(new_n76_), .b(x28), .O(new_n88_));
  oai21  g026(.a(x27), .b(x08), .c(new_n88_), .O(new_n89_));
  nand3  g027(.a(new_n89_), .b(new_n87_), .c(x04), .O(new_n90_));
  nand2  g028(.a(x40), .b(x39), .O(new_n91_));
  nand2  g029(.a(new_n87_), .b(new_n91_), .O(z08));
  nand3  g030(.a(z08), .b(new_n90_), .c(new_n86_), .O(z02));
  nand2  g031(.a(x35), .b(x28), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(x27), .c(new_n73_), .O(new_n95_));
  ...
  oai21  g040(.a(new_n102_), .b(new_n96_), .c(new_n97_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n87_), .O(z06));
  inv1   g042(.a(z06), .O(z05));
  inv1   g043(.a(x25), .O(new_n106_));
  nand2  g044(.a(new_n106_), .b(x00), .O(new_n107_));
  nand2  g045(.a(x25), .b(new_n84_), .O(new_n108_));
  ...
  inv1   g056(.a(new_n91_), .O(new_n119_));
  ...
  nand2  g062(.a(new_n91_), .b(new_n124_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n78_), .c(x27), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  inv1   g065(.a(x05), .O(new_n128_));
  aoi21  g066(.a(new_n119_), .b(new_n128_), .c(x04), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand3  g068(.a(x37), .b(x27), .c(x06), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n87_), .O(z10));
  nand2  g070(.a(x35), .b(new_n102_), .O(new_n133_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(x08), .O(new_n137_));
  nor2   g075(.a(x30), .b(x09), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n102_), .c(x27), .d(new_n65_), .O(new_n139_));
  and2   g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n137_), .c(new_n73_), .O(z18));
  inv1   g079(.a(z18), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand2  g081(.a(new_n68_), .b(new_n143_), .O(new_n144_));
  nand2  g082(.a(new_n87_), .b(new_n144_), .O(z12));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x28), .O(new_n147_));
  nor2   g085(.a(x13), .b(x04), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n147_), .c(new_n119_), .O(new_n149_));
  nand2  g087(.a(new_n94_), .b(new_n97_), .O(new_n150_));
  ...
  nand3  g092(.a(new_n148_), .b(new_n122_), .c(new_n119_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n154_), .c(new_n73_), .O(z13));
  nand2  g094(.a(new_n148_), .b(new_n119_), .O(new_n157_));
  nand2  g095(.a(new_n151_), .b(x20), .O(new_n158_));
  nand3  g096(.a(new_n146_), .b(new_n80_), .c(x28), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n158_), .O(new_n161_));
  aoi21  g099(.a(new_n102_), .b(x27), .c(new_n122_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n157_), .c(new_n63_), .d(new_n96_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n87_), .O(z14));
  nand4  g102(.a(new_n116_), .b(new_n87_), .c(x26), .d(x12), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z15));
  nand2  g104(.a(x22), .b(x01), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(x23), .c(new_n87_), .O(z16));
  inv1   g106(.a(x24), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x23), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n167_), .c(new_n87_), .O(z17));
  nand2  g109(.a(new_n140_), .b(new_n137_), .O(new_n172_));
  aoi21  g110(.a(new_n139_), .b(new_n72_), .c(x14), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n172_), .O(z19));
  aoi21  g112(.a(new_n134_), .b(new_n133_), .c(new_n72_), .O(new_n175_));
  oai21  g113(.a(new_n76_), .b(new_n96_), .c(new_n138_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n175_), .c(new_n87_), .O(z20));
endmodule
