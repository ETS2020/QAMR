...
module FAU ( 
  ...
  nor2   g020(.a(x23), .b(new_n71_), .O(new_n83_));
  ...
  nor2   g038(.a(new_n100_), .b(new_n83_), .O(z06));
  inv1   g039(.a(new_n83_), .O(new_n102_));
  ...
  nand2  g051(.a(new_n102_), .b(new_n88_), .O(z08));
  ...
  nand3  g078(.a(new_n102_), .b(new_n68_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g090(.a(new_n145_), .b(new_n82_), .c(new_n117_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n152_), .c(new_n83_), .O(z13));
  nand2  g092(.a(new_n145_), .b(new_n117_), .O(new_n155_));
  nand2  g093(.a(new_n149_), .b(x20), .O(new_n156_));
  nand4  g094(.a(new_n143_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n155_), .c(new_n156_), .O(new_n159_));
  aoi21  g097(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n160_));
  oai22  g098(.a(new_n160_), .b(new_n155_), .c(new_n63_), .d(new_n75_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n102_), .O(z14));
  nand4  g100(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n102_), .O(z15));
  nand4  g102(.a(new_n72_), .b(x22), .c(new_n71_), .d(x01), .O(new_n165_));
  ...
  aoi21  g107(.a(new_n137_), .b(new_n134_), .c(new_n83_), .O(z18));
  oai21  g108(.a(new_n119_), .b(new_n75_), .c(new_n135_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n132_), .c(new_n102_), .O(z20));
  nand2  g110(.a(new_n138_), .b(new_n102_), .O(z19));
endmodule
