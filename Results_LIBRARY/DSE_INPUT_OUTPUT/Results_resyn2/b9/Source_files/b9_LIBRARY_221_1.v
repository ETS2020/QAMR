...
module FAU ( 
  ...
  nor2   g029(.a(new_n78_), .b(new_n64_), .O(z08));
  ...
  aoi21  g034(.a(new_n68_), .b(x27), .c(new_n64_), .O(new_n97_));
  ...
  oai21  g040(.a(new_n84_), .b(new_n66_), .c(new_n67_), .O(new_n103_));
  and2   g041(.a(new_n103_), .b(new_n102_), .O(z05));
  ...
  nand3  g055(.a(new_n117_), .b(new_n102_), .c(x11), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z09));
  nor2   g057(.a(new_n85_), .b(new_n66_), .O(new_n120_));
  nand2  g058(.a(new_n75_), .b(x05), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(new_n122_));
  and2   g060(.a(new_n78_), .b(x07), .O(new_n123_));
  aoi22  g061(.a(new_n123_), .b(new_n120_), .c(new_n122_), .d(new_n87_), .O(new_n124_));
  ...
  inv1   g071(.a(new_n89_), .O(new_n134_));
  ...
  nand3  g076(.a(new_n138_), .b(new_n133_), .c(new_n102_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  inv1   g078(.a(new_n77_), .O(new_n141_));
  nand3  g079(.a(new_n80_), .b(new_n141_), .c(new_n102_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  oai21  g082(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(new_n75_), .c(new_n144_), .d(new_n71_), .O(new_n146_));
  ...
  nand3  g088(.a(new_n75_), .b(new_n144_), .c(new_n71_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(new_n86_), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n150_), .c(new_n102_), .O(z13));
  oai21  g092(.a(new_n152_), .b(new_n149_), .c(new_n102_), .O(z14));
  nand3  g093(.a(new_n117_), .b(new_n102_), .c(x12), .O(new_n156_));
  ...
  oai21  g099(.a(new_n161_), .b(new_n158_), .c(new_n102_), .O(z17));
  aoi21  g100(.a(new_n138_), .b(new_n133_), .c(new_n64_), .O(z18));
  oai21  g101(.a(new_n72_), .b(new_n66_), .c(new_n136_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n131_), .c(new_n102_), .O(z20));
