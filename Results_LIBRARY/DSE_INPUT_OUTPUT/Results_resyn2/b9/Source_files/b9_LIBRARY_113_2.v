...
module FAU ( 
  ...
  oai21  g009(.a(new_n71_), .b(new_n69_), .c(x16), .O(z00));
  ...
  xor2a  g025(.a(new_n87_), .b(new_n74_), .O(z02));
  inv1   g026(.a(x35), .O(new_n89_));
  oai21  g027(.a(new_n89_), .b(new_n75_), .c(x27), .O(new_n90_));
  ...
  nor2   g034(.a(new_n96_), .b(new_n74_), .O(z05));
  inv1   g035(.a(x40), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(x16), .O(new_n99_));
  and2   g037(.a(new_n96_), .b(new_n99_), .O(z06));
  ...
  nor2   g062(.a(new_n84_), .b(x04), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(x05), .O(new_n126_));
  oai21  g064(.a(new_n123_), .b(new_n115_), .c(new_n126_), .O(z10));
  ...
  nand3  g069(.a(new_n77_), .b(x27), .c(new_n63_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n99_), .O(new_n134_));
  aoi21  g072(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z11));
  inv1   g073(.a(x37), .O(new_n136_));
  aoi21  g074(.a(new_n66_), .b(new_n136_), .c(new_n115_), .O(new_n137_));
  inv1   g075(.a(new_n125_), .O(new_n138_));
  inv1   g076(.a(new_n67_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n138_), .c(new_n74_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n125_), .c(new_n143_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x20), .O(new_n148_));
  nand2  g086(.a(new_n99_), .b(new_n139_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n146_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand3  g089(.a(new_n125_), .b(new_n124_), .c(new_n143_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand2  g091(.a(new_n125_), .b(new_n143_), .O(new_n154_));
  nand3  g092(.a(new_n144_), .b(new_n79_), .c(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(new_n148_), .O(new_n157_));
  aoi21  g095(.a(new_n75_), .b(x27), .c(new_n124_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n154_), .c(new_n140_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n157_), .c(new_n74_), .O(z14));
  nand4  g098(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n99_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  nor3   g101(.a(new_n163_), .b(new_n74_), .c(x23), .O(z16));
  ...
  inv1   g106(.a(new_n134_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(z18));
  oai21  g108(.a(new_n89_), .b(new_n115_), .c(new_n133_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n130_), .c(new_n99_), .O(z20));
  aoi21  g110(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z19));
endmodule
