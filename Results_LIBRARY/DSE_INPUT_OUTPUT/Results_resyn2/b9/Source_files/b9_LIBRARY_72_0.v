...
module FAU ( 
  ...
  oai21  g029(.a(new_n91_), .b(new_n77_), .c(x27), .O(new_n92_));
  ...
  nand4  g061(.a(new_n82_), .b(z08), .c(x05), .d(new_n65_), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(new_n75_), .c(new_n124_), .O(z10));
  nand3  g063(.a(x40), .b(x39), .c(x29), .O(new_n126_));
  oai21  g064(.a(new_n78_), .b(x27), .c(new_n126_), .O(new_n127_));
  nor2   g065(.a(new_n91_), .b(x28), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x27), .c(new_n65_), .O(new_n129_));
  nor3   g067(.a(new_n72_), .b(x30), .c(x09), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  aoi21  g069(.a(new_n127_), .b(x08), .c(new_n131_), .O(z11));
  nand2  g070(.a(new_n67_), .b(x27), .O(new_n133_));
  nand2  g071(.a(new_n68_), .b(new_n133_), .O(new_n134_));
  nand2  g072(.a(new_n98_), .b(new_n134_), .O(z12));
  aoi21  g073(.a(x36), .b(x35), .c(new_n77_), .O(new_n136_));
  inv1   g074(.a(x13), .O(new_n137_));
  nand4  g075(.a(x40), .b(x39), .c(new_n137_), .d(new_n65_), .O(new_n138_));
  nor2   g076(.a(x19), .b(x18), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x20), .O(new_n140_));
  oai22  g078(.a(new_n140_), .b(new_n63_), .c(new_n138_), .d(new_n136_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x27), .O(new_n142_));
  inv1   g080(.a(new_n138_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n82_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n142_), .c(new_n98_), .O(z13));
  nand2  g083(.a(new_n144_), .b(new_n98_), .O(new_n146_));
  aoi21  g084(.a(new_n141_), .b(x27), .c(new_n146_), .O(z14));
  nand4  g085(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n98_), .O(z15));
  nand2  g087(.a(x22), .b(x01), .O(new_n150_));
  nor3   g088(.a(new_n150_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g089(.a(x23), .O(new_n152_));
  nor2   g090(.a(x24), .b(new_n152_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n98_), .c(x22), .d(x01), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(z17));
  nor2   g093(.a(x30), .b(x09), .O(new_n156_));
  nand2  g094(.a(new_n75_), .b(new_n85_), .O(new_n157_));
  nand2  g095(.a(x27), .b(x04), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n157_), .c(new_n128_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n98_), .O(new_n161_));
  nand3  g099(.a(z08), .b(x29), .c(x08), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z18));
  inv1   g101(.a(new_n162_), .O(new_n164_));
  aoi21  g102(.a(new_n160_), .b(new_n98_), .c(new_n164_), .O(z19));
  aoi21  g103(.a(new_n126_), .b(new_n78_), .c(new_n85_), .O(new_n166_));
  oai21  g104(.a(new_n91_), .b(new_n75_), .c(new_n130_), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(new_n166_), .O(z20));
endmodule
