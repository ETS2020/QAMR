...
module FAU ( 
  ...
  nor2   g009(.a(x33), .b(x31), .O(new_n72_));
  ...
  nor2   g024(.a(new_n72_), .b(new_n86_), .O(z08));
  ...
  nor2   g041(.a(x25), .b(x00), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(x38), .O(new_n105_));
  nand4  g043(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(x03), .O(new_n106_));
  inv1   g044(.a(new_n106_), .O(z07));
  inv1   g045(.a(x11), .O(new_n108_));
  nand4  g046(.a(new_n103_), .b(x34), .c(x27), .d(x26), .O(new_n109_));
  nor2   g047(.a(new_n109_), .b(new_n108_), .O(z09));
  inv1   g048(.a(new_n86_), .O(new_n111_));
  inv1   g049(.a(x30), .O(new_n112_));
  ...
  nand2  g054(.a(new_n86_), .b(new_n116_), .O(new_n117_));
  nand3  g055(.a(new_n117_), .b(new_n77_), .c(x27), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  inv1   g057(.a(x05), .O(new_n120_));
  aoi21  g058(.a(new_n111_), .b(new_n120_), .c(x04), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g060(.a(x37), .b(x27), .c(x06), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(new_n103_), .O(z10));
  ...
  nand2  g071(.a(new_n112_), .b(new_n133_), .O(new_n134_));
  aoi21  g072(.a(new_n132_), .b(new_n130_), .c(new_n134_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n129_), .c(new_n103_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand3  g076(.a(new_n103_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  ...
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n111_), .O(new_n144_));
  ...
  inv1   g086(.a(new_n115_), .O(new_n149_));
  aoi21  g087(.a(new_n143_), .b(new_n149_), .c(new_n72_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n148_), .O(z13));
  nand2  g089(.a(new_n143_), .b(new_n111_), .O(new_n152_));
  nand3  g090(.a(new_n141_), .b(new_n79_), .c(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(new_n146_), .O(new_n155_));
  aoi21  g093(.a(new_n82_), .b(x27), .c(new_n114_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n152_), .c(new_n63_), .d(new_n131_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n103_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  nor2   g097(.a(new_n109_), .b(new_n159_), .O(z15));
  inv1   g098(.a(x23), .O(new_n161_));
  and2   g099(.a(x22), .b(x01), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n103_), .O(z16));
  nor2   g102(.a(x24), .b(new_n161_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n162_), .c(new_n103_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  nand2  g105(.a(new_n135_), .b(new_n129_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n103_), .O(z19));
  nand2  g107(.a(x35), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n112_), .c(new_n133_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n127_), .c(new_n103_), .O(z20));
endmodule
