...
module FAU ( 
  ...
  nor2   g011(.a(new_n73_), .b(x01), .O(new_n74_));
  ...
  inv1   g024(.a(new_n74_), .O(new_n87_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(new_n74_), .O(z04));
  ...
  nand3  g096(.a(new_n73_), .b(x22), .c(x01), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n87_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x22), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(x01), .c(new_n73_), .O(z17));
  aoi21  g101(.a(new_n137_), .b(new_n132_), .c(new_n74_), .O(z18));
  nand2  g102(.a(x35), .b(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n82_), .c(new_n135_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n130_), .c(new_n87_), .O(z20));
