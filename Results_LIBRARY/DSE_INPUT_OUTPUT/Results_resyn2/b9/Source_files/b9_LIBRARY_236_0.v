...
module FAU ( 
  ...
  oai21  g027(.a(new_n85_), .b(new_n65_), .c(new_n89_), .O(z02));
  nand2  g028(.a(x35), .b(x28), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x27), .O(new_n92_));
  inv1   g030(.a(x37), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(new_n75_), .c(new_n72_), .O(new_n94_));
  ...
  nand2  g053(.a(z08), .b(new_n81_), .O(new_n116_));
  inv1   g054(.a(x35), .O(new_n117_));
  oai21  g055(.a(new_n117_), .b(x28), .c(new_n76_), .O(new_n118_));
  ...
  aoi21  g061(.a(z08), .b(new_n123_), .c(x04), .O(new_n124_));
  ...
  nor2   g070(.a(new_n117_), .b(x28), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x27), .c(new_n65_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n132_), .c(new_n131_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n106_), .O(z11));
  nand2  g074(.a(new_n64_), .b(new_n93_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x27), .c(x10), .O(new_n138_));
  nand2  g076(.a(new_n91_), .b(new_n93_), .O(new_n139_));
  inv1   g077(.a(x40), .O(new_n140_));
  nor2   g078(.a(new_n140_), .b(x04), .O(new_n141_));
  aoi21  g079(.a(new_n139_), .b(x27), .c(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n138_), .c(x39), .O(new_n143_));
  nand2  g081(.a(new_n139_), .b(x27), .O(new_n144_));
  nor2   g082(.a(new_n140_), .b(x39), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n143_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n141_), .c(x39), .d(new_n148_), .O(new_n151_));
  nor2   g089(.a(x19), .b(x18), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n106_), .c(new_n139_), .d(x20), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nor2   g093(.a(x13), .b(x04), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(z08), .c(new_n81_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand2  g096(.a(new_n152_), .b(x20), .O(new_n159_));
  nand3  g097(.a(new_n149_), .b(new_n80_), .c(x28), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n141_), .c(x39), .d(new_n148_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  oai21  g100(.a(x28), .b(new_n75_), .c(new_n80_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n156_), .c(z08), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n144_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n162_), .c(new_n72_), .O(z14));
  nand4  g104(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n106_), .O(z15));
  nand2  g106(.a(x22), .b(x01), .O(new_n169_));
  nor3   g107(.a(new_n169_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g108(.a(x23), .O(new_n171_));
  nor2   g109(.a(x24), .b(new_n171_), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n106_), .c(x22), .d(x01), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z17));
  nand2  g112(.a(new_n75_), .b(new_n84_), .O(new_n175_));
  nand2  g113(.a(x27), .b(x04), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n133_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n132_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n106_), .O(new_n179_));
  inv1   g117(.a(new_n88_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(z08), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n179_), .O(z18));
  inv1   g120(.a(new_n181_), .O(new_n183_));
  aoi21  g121(.a(new_n178_), .b(new_n106_), .c(new_n183_), .O(z19));
  nand2  g122(.a(x35), .b(x27), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n132_), .c(new_n106_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n129_), .O(z20));
endmodule
