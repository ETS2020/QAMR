...
module FAU ( 
  ...
  nand2  g051(.a(new_n113_), .b(new_n85_), .O(z07));
  nand2  g052(.a(new_n85_), .b(new_n83_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand3  g054(.a(x34), .b(x27), .c(x26), .O(new_n117_));
  nor3   g055(.a(new_n117_), .b(new_n73_), .c(new_n116_), .O(z09));
  ...
  nand3  g093(.a(new_n149_), .b(new_n121_), .c(new_n84_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n155_), .c(new_n73_), .O(z13));
  nand2  g095(.a(new_n149_), .b(new_n84_), .O(new_n158_));
  ...
  aoi21  g100(.a(new_n86_), .b(x27), .c(new_n121_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n158_), .c(new_n63_), .d(new_n96_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(new_n85_), .O(z14));
  ...
  nor3   g107(.a(new_n169_), .b(new_n73_), .c(x23), .O(z16));
  inv1   g108(.a(x24), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x23), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n169_), .c(new_n85_), .O(z17));
  aoi21  g111(.a(new_n141_), .b(new_n136_), .c(new_n73_), .O(z18));
  nor2   g112(.a(new_n140_), .b(new_n73_), .O(new_n175_));
  oai21  g113(.a(new_n76_), .b(new_n96_), .c(new_n175_), .O(new_n176_));
