...
module FAU ( 
  ...
  aoi21  g020(.a(new_n82_), .b(new_n70_), .c(new_n66_), .O(new_n83_));
  inv1   g021(.a(new_n64_), .O(new_n84_));
  nor2   g022(.a(x32), .b(x30), .O(new_n85_));
  nand2  g023(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  oai22  g024(.a(new_n86_), .b(new_n83_), .c(new_n64_), .d(x04), .O(z01));
  ...
  nand2  g038(.a(new_n100_), .b(new_n84_), .O(z05));
  nand2  g039(.a(new_n99_), .b(new_n84_), .O(z06));
  ...
  nand2  g050(.a(new_n112_), .b(new_n84_), .O(z07));
  nor2   g051(.a(new_n75_), .b(new_n64_), .O(z08));
  and2   g052(.a(x34), .b(x27), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x26), .c(x11), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n84_), .O(z09));
  aoi21  g055(.a(new_n105_), .b(x05), .c(x04), .O(new_n118_));
  nand2  g056(.a(new_n82_), .b(new_n70_), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(new_n75_), .b(new_n120_), .O(new_n121_));
  nand2  g059(.a(new_n72_), .b(new_n63_), .O(new_n122_));
  nand4  g060(.a(new_n122_), .b(new_n121_), .c(new_n119_), .d(new_n118_), .O(new_n123_));
  nand3  g061(.a(new_n84_), .b(x37), .c(x06), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  inv1   g064(.a(new_n85_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(new_n76_), .c(x14), .d(x05), .O(new_n128_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n84_), .O(z11));
  oai21  g078(.a(new_n78_), .b(new_n74_), .c(new_n84_), .O(z12));
  ...
  oai21  g083(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n76_), .c(new_n145_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n144_), .c(new_n66_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  nand3  g087(.a(new_n127_), .b(new_n76_), .c(new_n145_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n149_), .c(new_n64_), .O(z13));
  inv1   g089(.a(new_n150_), .O(new_n152_));
  nor3   g090(.a(new_n152_), .b(new_n148_), .c(new_n64_), .O(z14));
  nand4  g091(.a(new_n115_), .b(new_n84_), .c(x26), .d(x12), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n64_), .c(x23), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x23), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n156_), .c(new_n84_), .O(z17));
  nand3  g098(.a(new_n138_), .b(new_n134_), .c(new_n84_), .O(z18));
  inv1   g099(.a(z18), .O(z19));
  nor2   g100(.a(new_n137_), .b(new_n64_), .O(new_n163_));
  oai21  g101(.a(new_n69_), .b(new_n66_), .c(new_n163_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(new_n132_), .O(z20));
endmodule
