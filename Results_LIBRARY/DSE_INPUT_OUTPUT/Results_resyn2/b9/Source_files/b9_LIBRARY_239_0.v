...
module FAU ( 
  ...
  nor2   g029(.a(new_n91_), .b(new_n63_), .O(z08));
  ...
  aoi21  g034(.a(new_n67_), .b(x27), .c(new_n63_), .O(new_n97_));
  nand2  g035(.a(new_n66_), .b(new_n65_), .O(new_n98_));
  ...
  inv1   g053(.a(new_n63_), .O(new_n116_));
  nand2  g054(.a(x34), .b(x27), .O(new_n117_));
  nand2  g055(.a(x26), .b(x11), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(z09));
  nand2  g057(.a(new_n86_), .b(new_n74_), .O(new_n120_));
  nand2  g058(.a(new_n82_), .b(new_n72_), .O(new_n121_));
  ...
  aoi21  g064(.a(new_n74_), .b(new_n126_), .c(x04), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g066(.a(x37), .b(x27), .c(x06), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n128_), .c(new_n63_), .O(z10));
  ...
  nor2   g074(.a(new_n65_), .b(x04), .O(new_n137_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n116_), .O(z11));
  inv1   g080(.a(new_n76_), .O(new_n143_));
  nand3  g081(.a(new_n77_), .b(new_n143_), .c(new_n116_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z12));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n86_), .c(new_n74_), .O(new_n147_));
  nor2   g085(.a(x19), .b(x18), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n68_), .c(x20), .O(new_n149_));
  oai21  g087(.a(new_n72_), .b(new_n71_), .c(x28), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n146_), .c(new_n74_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n149_), .c(new_n65_), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n147_), .c(new_n63_), .O(z13));
  inv1   g092(.a(new_n147_), .O(new_n155_));
  nor3   g093(.a(new_n152_), .b(new_n155_), .c(new_n63_), .O(z14));
  nand2  g094(.a(x26), .b(x12), .O(new_n157_));
  nor3   g095(.a(new_n157_), .b(new_n117_), .c(new_n63_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n63_), .c(x23), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n116_), .O(z17));
  nand3  g101(.a(new_n140_), .b(new_n135_), .c(new_n116_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n84_), .c(new_n138_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n133_), .c(new_n116_), .O(z20));
endmodule
