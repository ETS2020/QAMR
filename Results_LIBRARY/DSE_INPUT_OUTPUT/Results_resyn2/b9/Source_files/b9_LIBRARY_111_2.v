...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n156_, new_n158_, new_n159_, new_n160_, new_n164_;
  ...
  nand3  g012(.a(new_n74_), .b(new_n72_), .c(x16), .O(z00));
  ...
  oai21  g025(.a(new_n87_), .b(new_n73_), .c(x39), .O(z02));
  ...
  nand2  g047(.a(new_n109_), .b(new_n74_), .O(z07));
  and2   g048(.a(x40), .b(x39), .O(z08));
  nand3  g049(.a(x34), .b(x27), .c(x26), .O(new_n112_));
  nand2  g050(.a(new_n74_), .b(x11), .O(new_n113_));
  nor2   g051(.a(new_n113_), .b(new_n112_), .O(z09));
  nor2   g052(.a(new_n79_), .b(new_n77_), .O(new_n115_));
  and2   g053(.a(x39), .b(x05), .O(new_n116_));
  inv1   g054(.a(x07), .O(new_n117_));
  nor2   g055(.a(x39), .b(new_n117_), .O(new_n118_));
  aoi22  g056(.a(new_n118_), .b(new_n115_), .c(new_n116_), .d(new_n81_), .O(new_n119_));
  nand3  g057(.a(x37), .b(x27), .c(x06), .O(new_n120_));
  and2   g058(.a(new_n120_), .b(new_n74_), .O(new_n121_));
  oai21  g059(.a(new_n119_), .b(x04), .c(new_n121_), .O(z10));
  inv1   g060(.a(x08), .O(new_n123_));
  nand2  g061(.a(x39), .b(x29), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n84_), .c(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n124_), .b(x27), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nor2   g065(.a(new_n77_), .b(x04), .O(new_n128_));
  or2    g066(.a(x30), .b(x09), .O(new_n129_));
  aoi21  g067(.a(new_n128_), .b(new_n85_), .c(new_n129_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n74_), .O(z11));
  nand2  g070(.a(new_n74_), .b(new_n71_), .O(z12));
  ...
  nand2  g078(.a(new_n74_), .b(new_n140_), .O(new_n141_));
  oai22  g079(.a(new_n141_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x27), .O(new_n143_));
  or2    g081(.a(new_n136_), .b(new_n80_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(z13));
  oai21  g083(.a(new_n135_), .b(new_n73_), .c(x39), .O(new_n146_));
  inv1   g084(.a(new_n139_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n140_), .c(x27), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  oai21  g087(.a(x37), .b(x35), .c(new_n147_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n134_), .c(new_n77_), .O(new_n151_));
  nand2  g089(.a(new_n80_), .b(x40), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n149_), .O(z14));
  inv1   g091(.a(x12), .O(new_n154_));
  oai21  g092(.a(new_n112_), .b(new_n154_), .c(new_n74_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(x23), .c(new_n74_), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  inv1   g096(.a(new_n156_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n74_), .c(new_n158_), .d(x23), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z17));
  nand3  g099(.a(new_n130_), .b(new_n127_), .c(new_n74_), .O(z18));
  inv1   g100(.a(z18), .O(z19));
  nor2   g101(.a(new_n89_), .b(new_n77_), .O(new_n164_));
  nor4   g102(.a(new_n164_), .b(new_n129_), .c(new_n125_), .d(new_n76_), .O(z20));
endmodule
