...
module FAU ( 
  ...
  nor2   g012(.a(new_n74_), .b(new_n65_), .O(new_n75_));
  ...
  nand3  g031(.a(new_n93_), .b(new_n90_), .c(new_n75_), .O(z02));
  ...
  nand3  g059(.a(x40), .b(x39), .c(new_n70_), .O(new_n122_));
  nor2   g060(.a(new_n86_), .b(new_n122_), .O(new_n123_));
  nand3  g061(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  aoi21  g063(.a(new_n123_), .b(x05), .c(new_n125_), .O(new_n126_));
  ...
  oai21  g079(.a(new_n141_), .b(new_n68_), .c(new_n140_), .O(new_n142_));
  oai21  g080(.a(new_n69_), .b(new_n68_), .c(new_n122_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n81_), .O(z12));
  ...
  nor2   g086(.a(new_n74_), .b(x04), .O(new_n149_));
  oai21  g087(.a(new_n64_), .b(new_n77_), .c(x28), .O(new_n150_));
  ...
  nand2  g091(.a(new_n123_), .b(new_n148_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n153_), .c(new_n81_), .O(z13));
  nand2  g093(.a(new_n154_), .b(new_n81_), .O(new_n156_));
  aoi21  g094(.a(new_n152_), .b(x27), .c(new_n156_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n116_), .b(new_n158_), .c(new_n81_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n81_), .O(z16));
  or2    g099(.a(new_n160_), .b(x24), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n64_), .c(new_n63_), .O(z17));
  nand2  g101(.a(new_n137_), .b(new_n132_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n81_), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n81_), .c(new_n135_), .d(new_n134_), .O(new_n167_));
