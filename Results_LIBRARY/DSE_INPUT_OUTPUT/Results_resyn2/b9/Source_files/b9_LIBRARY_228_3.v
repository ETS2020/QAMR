...
module FAU ( 
  ...
  nand3  g22(.a(new_n85_), .b(new_n69_), .c(new_n65_), .O(z05));
  ...
  inv1   g36(.a(x11), .O(new_n101_));
  nand4  g37(.a(new_n69_), .b(x34), .c(x27), .d(x26), .O(new_n102_));
  nor2   g38(.a(new_n102_), .b(new_n101_), .O(z09));
  inv1   g39(.a(x07), .O(new_n104_));
  nor2   g40(.a(new_n104_), .b(x04), .O(new_n105_));
  aoi22  g41(.a(new_n105_), .b(new_n73_), .c(x37), .d(x06), .O(new_n106_));
  oai21  g42(.a(new_n106_), .b(new_n64_), .c(new_n69_), .O(z10));
  ...
  nand3  g50(.a(new_n114_), .b(new_n109_), .c(new_n108_), .O(new_n115_));
  ...
  nor2   g58(.a(new_n102_), .b(new_n122_), .O(z15));
  nand2  g59(.a(x22), .b(x01), .O(new_n124_));
  oai21  g60(.a(new_n124_), .b(x23), .c(new_n69_), .O(z16));
  inv1   g61(.a(x23), .O(new_n126_));
  nor4   g62(.a(new_n124_), .b(new_n80_), .c(x24), .d(new_n126_), .O(z17));
  nand3  g63(.a(new_n69_), .b(new_n109_), .c(new_n108_), .O(new_n128_));
  inv1   g64(.a(new_n128_), .O(new_n129_));
  nand2  g65(.a(new_n129_), .b(new_n114_), .O(z18));
  oai21  g66(.a(x28), .b(new_n112_), .c(new_n64_), .O(new_n131_));
  aoi21  g67(.a(new_n131_), .b(x35), .c(new_n128_), .O(z20));
  one    g68(.O(z02));
  zero   g69(.O(z08));
  nand2  g70(.a(new_n115_), .b(new_n69_), .O(z19));
endmodule
