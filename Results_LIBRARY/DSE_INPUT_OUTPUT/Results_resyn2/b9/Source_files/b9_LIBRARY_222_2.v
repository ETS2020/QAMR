...
module FAU ( 
  ...
  aoi21  g032(.a(new_n94_), .b(new_n93_), .c(new_n73_), .O(new_n95_));
  ...
  nand3  g038(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z05));
  ...
  aoi21  g065(.a(new_n121_), .b(new_n127_), .c(x04), .O(new_n128_));
  ...
  nor2   g075(.a(new_n93_), .b(x04), .O(new_n138_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n99_), .O(z11));
  nand2  g081(.a(new_n67_), .b(x27), .O(new_n144_));
  nand3  g082(.a(new_n99_), .b(new_n68_), .c(new_n144_), .O(new_n145_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n121_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand3  g090(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n66_), .c(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  inv1   g093(.a(new_n122_), .O(new_n156_));
  aoi21  g094(.a(new_n149_), .b(new_n156_), .c(new_n73_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand2  g096(.a(new_n149_), .b(new_n121_), .O(new_n159_));
  nand3  g097(.a(new_n147_), .b(new_n80_), .c(x28), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(new_n153_), .O(new_n162_));
  aoi21  g100(.a(new_n83_), .b(x27), .c(new_n120_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n159_), .c(new_n66_), .d(new_n93_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(new_n99_), .O(z14));
  nand4  g103(.a(new_n115_), .b(new_n99_), .c(x26), .d(x12), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z15));
  nand3  g105(.a(x40), .b(x22), .c(x01), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(x23), .O(z16));
  inv1   g107(.a(x23), .O(new_n170_));
  nor3   g108(.a(new_n168_), .b(x24), .c(new_n170_), .O(z17));
  nand3  g109(.a(new_n141_), .b(new_n136_), .c(new_n99_), .O(z18));
  inv1   g110(.a(z18), .O(z19));
  nand2  g111(.a(x35), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n118_), .c(new_n139_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n134_), .c(new_n99_), .O(z20));
endmodule
