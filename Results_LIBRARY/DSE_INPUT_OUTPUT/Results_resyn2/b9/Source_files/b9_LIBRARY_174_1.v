...
module FAU ( 
  ...
  nand3  g030(.a(new_n92_), .b(x35), .c(new_n82_), .O(new_n93_));
  ...
  oai21  g034(.a(new_n69_), .b(x27), .c(new_n96_), .O(new_n97_));
  ...
  and2   g040(.a(new_n101_), .b(new_n64_), .O(z06));
  ...
  nand2  g054(.a(new_n87_), .b(x40), .O(new_n117_));
  inv1   g055(.a(x35), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x28), .c(new_n81_), .O(new_n119_));
  ...
  oai21  g066(.a(new_n63_), .b(x29), .c(x40), .O(new_n129_));
  nand2  g067(.a(x27), .b(x04), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x35), .c(new_n82_), .O(new_n131_));
  ...
  nand2  g074(.a(new_n136_), .b(new_n91_), .O(new_n137_));
  nor2   g075(.a(x30), .b(x09), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n137_), .b(new_n132_), .c(new_n139_), .O(z11));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n68_), .c(new_n74_), .O(new_n142_));
  ...
  oai21  g086(.a(new_n81_), .b(new_n118_), .c(x28), .O(new_n149_));
  nor2   g087(.a(x13), .b(x04), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n78_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n150_), .b(new_n87_), .c(new_n78_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand3  g093(.a(new_n147_), .b(new_n146_), .c(x20), .O(new_n156_));
  nand3  g094(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g096(.a(new_n150_), .b(new_n87_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x39), .c(new_n77_), .O(new_n160_));
  aoi21  g098(.a(new_n158_), .b(x27), .c(new_n160_), .O(z14));
  nand4  g099(.a(new_n114_), .b(new_n64_), .c(x26), .d(x12), .O(new_n162_));
  ...
  aoi21  g107(.a(new_n68_), .b(new_n91_), .c(new_n83_), .O(new_n170_));
  aoi21  g108(.a(new_n130_), .b(new_n170_), .c(new_n139_), .O(new_n171_));
  nand3  g109(.a(new_n78_), .b(x29), .c(x08), .O(new_n172_));
  oai21  g110(.a(new_n171_), .b(new_n65_), .c(new_n172_), .O(z18));
  nand2  g111(.a(x40), .b(x04), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(x35), .c(new_n82_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x39), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n133_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n91_), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n132_), .c(new_n139_), .O(z19));
  inv1   g117(.a(new_n172_), .O(new_n180_));
  aoi21  g118(.a(new_n82_), .b(x08), .c(x27), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n118_), .c(new_n138_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n64_), .c(new_n180_), .O(z20));
  buf    g121(.a(x40), .O(z08));
endmodule
