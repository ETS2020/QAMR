...
module FAU ( 
  ...
  nor2   g027(.a(new_n74_), .b(new_n64_), .O(z08));
  ...
  oai22  g034(.a(new_n96_), .b(new_n76_), .c(new_n95_), .d(x27), .O(new_n97_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n131_), .c(new_n100_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n66_), .c(new_n138_), .O(new_n140_));
  nand3  g078(.a(x40), .b(x39), .c(new_n69_), .O(new_n141_));
  oai21  g079(.a(new_n67_), .b(new_n66_), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n140_), .c(new_n100_), .O(z12));
  ...
  nand2  g085(.a(new_n81_), .b(new_n147_), .O(new_n148_));
  oai22  g086(.a(new_n148_), .b(new_n141_), .c(new_n146_), .d(new_n67_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  inv1   g088(.a(new_n141_), .O(new_n151_));
  aoi21  g089(.a(new_n85_), .b(new_n151_), .c(x36), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(x13), .c(new_n150_), .O(z13));
  oai21  g091(.a(x28), .b(new_n66_), .c(new_n84_), .O(new_n154_));
  ...
  nand2  g095(.a(new_n157_), .b(new_n68_), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  aoi21  g097(.a(new_n156_), .b(new_n147_), .c(new_n159_), .O(z14));
  nand4  g098(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n100_), .O(z15));
  ...
  oai21  g104(.a(new_n166_), .b(new_n163_), .c(new_n100_), .O(z17));
  aoi21  g105(.a(new_n135_), .b(new_n131_), .c(new_n64_), .O(z18));
  nand2  g106(.a(new_n135_), .b(new_n131_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n100_), .O(z19));
  nand2  g108(.a(x35), .b(x27), .O(new_n171_));
  nor2   g109(.a(new_n134_), .b(new_n64_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n129_), .O(z20));
endmodule
