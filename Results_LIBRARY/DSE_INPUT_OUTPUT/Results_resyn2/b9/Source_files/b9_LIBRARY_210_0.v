...
module FAU ( 
  ...
  and2   g014(.a(x40), .b(x39), .O(z08));
  nand4  g015(.a(z08), .b(new_n76_), .c(new_n67_), .d(new_n73_), .O(new_n78_));
  ...
  aoi21  g034(.a(new_n96_), .b(new_n69_), .c(new_n66_), .O(new_n97_));
  ...
  and2   g040(.a(new_n101_), .b(new_n65_), .O(z06));
  ...
  aoi21  g054(.a(x40), .b(new_n63_), .c(new_n96_), .O(new_n117_));
  inv1   g055(.a(x36), .O(new_n118_));
  aoi21  g056(.a(new_n87_), .b(new_n118_), .c(x04), .O(new_n119_));
  inv1   g057(.a(x05), .O(new_n120_));
  aoi21  g058(.a(x40), .b(x39), .c(x07), .O(new_n121_));
  aoi21  g059(.a(z08), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n119_), .c(new_n117_), .O(new_n123_));
  inv1   g061(.a(new_n83_), .O(new_n124_));
  nand4  g062(.a(x40), .b(x39), .c(x05), .d(new_n73_), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n124_), .c(new_n66_), .O(new_n127_));
  oai21  g065(.a(new_n123_), .b(new_n69_), .c(new_n127_), .O(z10));
  inv1   g066(.a(x08), .O(new_n129_));
  nand3  g067(.a(x40), .b(x39), .c(x29), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n87_), .c(new_n129_), .O(new_n131_));
  ...
  nand3  g075(.a(x40), .b(x39), .c(new_n73_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n75_), .c(new_n70_), .O(new_n139_));
  nor2   g077(.a(new_n90_), .b(x04), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x10), .O(new_n141_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n140_), .c(new_n144_), .O(new_n147_));
  nand2  g085(.a(new_n94_), .b(new_n96_), .O(new_n148_));
  ...
  nand3  g090(.a(new_n140_), .b(new_n124_), .c(new_n144_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand2  g092(.a(new_n140_), .b(new_n144_), .O(new_n155_));
  nand2  g093(.a(new_n149_), .b(x20), .O(new_n156_));
  nand3  g094(.a(new_n145_), .b(new_n83_), .c(x28), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n155_), .c(new_n156_), .O(new_n159_));
  inv1   g097(.a(new_n71_), .O(new_n160_));
  aoi21  g098(.a(new_n86_), .b(x27), .c(new_n124_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n155_), .c(new_n160_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n159_), .c(new_n65_), .O(z14));
  nand4  g101(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n65_), .O(z15));
  nand2  g103(.a(x22), .b(x01), .O(new_n166_));
  nor3   g104(.a(new_n166_), .b(new_n66_), .c(x23), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x23), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n166_), .c(new_n65_), .O(z17));
  nand4  g108(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n65_), .O(z18));
  oai21  g109(.a(new_n80_), .b(new_n69_), .c(new_n134_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n131_), .c(new_n65_), .O(z20));
  nand2  g111(.a(new_n136_), .b(new_n65_), .O(z19));
endmodule
