...
module FAU ( 
  ...
  nand2  g041(.a(x25), .b(new_n63_), .O(new_n104_));
  ...
  aoi21  g060(.a(new_n72_), .b(new_n122_), .c(x04), .O(new_n123_));
  ...
  nand3  g077(.a(new_n75_), .b(new_n139_), .c(new_n98_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  nor2   g079(.a(x13), .b(x04), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n116_), .O(new_n143_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n142_), .c(new_n72_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n143_), .c(new_n64_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n143_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n98_), .O(z14));
  nand4  g091(.a(new_n113_), .b(new_n98_), .c(x26), .d(x12), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(x23), .c(new_n98_), .O(z16));
  ...
  oai21  g101(.a(new_n69_), .b(new_n66_), .c(new_n163_), .O(new_n164_));
