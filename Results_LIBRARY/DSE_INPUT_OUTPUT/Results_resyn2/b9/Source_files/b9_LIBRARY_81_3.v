...
module FAU ( 
  ...
  oai22  g17(.a(new_n79_), .b(new_n72_), .c(new_n65_), .d(x27), .O(new_n80_));
  aoi21  g18(.a(new_n80_), .b(x21), .c(z08), .O(z03));
  inv1   g19(.a(x21), .O(new_n82_));
  aoi21  g20(.a(new_n80_), .b(new_n82_), .c(z08), .O(z04));
  aoi21  g21(.a(new_n79_), .b(new_n65_), .c(z08), .O(z05));
  nand3  g22(.a(new_n79_), .b(z02), .c(new_n65_), .O(new_n85_));
  inv1   g23(.a(new_n85_), .O(z06));
  inv1   g24(.a(x00), .O(new_n87_));
  oai21  g25(.a(x25), .b(new_n87_), .c(x38), .O(new_n88_));
  nand2  g26(.a(x17), .b(new_n63_), .O(new_n89_));
  ...
  nand2  g39(.a(x37), .b(x06), .O(new_n102_));
  inv1   g40(.a(x04), .O(new_n103_));
  nand3  g41(.a(new_n74_), .b(x07), .c(new_n103_), .O(new_n104_));
  nand2  g42(.a(z02), .b(x27), .O(new_n105_));
  aoi21  g43(.a(new_n104_), .b(new_n102_), .c(new_n105_), .O(z10));
  nor2   g44(.a(x30), .b(x09), .O(new_n107_));
  nand2  g45(.a(new_n107_), .b(z02), .O(new_n108_));
  inv1   g46(.a(x08), .O(new_n109_));
  nand2  g47(.a(new_n64_), .b(new_n109_), .O(new_n110_));
  ...
  aoi21  g52(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(z11));
  nor2   g53(.a(z08), .b(new_n67_), .O(z12));
  nor2   g54(.a(x19), .b(x18), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(x20), .O(new_n118_));
  inv1   g56(.a(new_n118_), .O(new_n119_));
  aoi21  g57(.a(new_n119_), .b(new_n67_), .c(z08), .O(z14));
  inv1   g58(.a(z14), .O(z13));
  inv1   g59(.a(x12), .O(new_n122_));
  oai21  g60(.a(new_n99_), .b(new_n122_), .c(z02), .O(z15));
  nand2  g61(.a(x22), .b(x01), .O(new_n124_));
  oai21  g62(.a(new_n124_), .b(x23), .c(z02), .O(z16));
  inv1   g63(.a(x24), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(x23), .O(new_n127_));
  oai21  g65(.a(new_n127_), .b(new_n124_), .c(z02), .O(z17));
  nand2  g66(.a(new_n114_), .b(new_n110_), .O(new_n129_));
  aoi21  g67(.a(new_n129_), .b(new_n107_), .c(z08), .O(z18));
  oai21  g68(.a(x28), .b(new_n109_), .c(new_n64_), .O(new_n131_));
  aoi21  g69(.a(new_n131_), .b(x35), .c(new_n108_), .O(z20));
  aoi21  g70(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(z19));
endmodule
