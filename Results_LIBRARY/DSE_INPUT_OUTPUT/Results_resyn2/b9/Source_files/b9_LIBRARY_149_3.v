...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n159_, new_n161_, new_n163_, new_n164_, new_n166_, new_n170_;
  ...
  nor2   g023(.a(new_n73_), .b(new_n85_), .O(z08));
  ...
  nand4  g033(.a(new_n95_), .b(new_n92_), .c(new_n72_), .d(x21), .O(z03));
  nand3  g034(.a(new_n95_), .b(new_n92_), .c(new_n71_), .O(z04));
  ...
  nand3  g064(.a(new_n126_), .b(new_n125_), .c(new_n98_), .O(z10));
  ...
  nand4  g070(.a(x35), .b(new_n77_), .c(x27), .d(new_n63_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  and2   g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n132_), .c(new_n98_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n93_), .c(new_n138_), .O(new_n140_));
  oai21  g078(.a(new_n66_), .b(new_n93_), .c(new_n64_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n98_), .O(z12));
  nand2  g080(.a(new_n91_), .b(new_n94_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(x20), .O(new_n145_));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n117_), .c(new_n77_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n93_), .O(new_n148_));
  nand2  g086(.a(new_n146_), .b(new_n117_), .O(new_n149_));
  nor2   g087(.a(new_n149_), .b(new_n76_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n98_), .O(new_n151_));
  inv1   g089(.a(new_n149_), .O(new_n152_));
  inv1   g090(.a(x35), .O(new_n153_));
  nor2   g091(.a(new_n72_), .b(new_n153_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n152_), .c(x27), .d(new_n71_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n151_), .O(z13));
  nor2   g094(.a(new_n154_), .b(new_n77_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n149_), .c(new_n145_), .O(new_n158_));
  oai21  g096(.a(new_n149_), .b(new_n76_), .c(new_n98_), .O(new_n159_));
  aoi21  g097(.a(new_n158_), .b(x27), .c(new_n159_), .O(z14));
  nand2  g098(.a(x26), .b(x12), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n114_), .c(new_n73_), .O(z15));
  inv1   g100(.a(x23), .O(new_n163_));
  nand4  g101(.a(new_n98_), .b(new_n163_), .c(x22), .d(x01), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z16));
  nand2  g103(.a(x22), .b(x01), .O(new_n166_));
  nor4   g104(.a(new_n166_), .b(new_n73_), .c(x24), .d(new_n163_), .O(z17));
  aoi21  g105(.a(new_n135_), .b(new_n132_), .c(new_n73_), .O(z18));
  inv1   g106(.a(z18), .O(z19));
  oai21  g107(.a(new_n153_), .b(new_n93_), .c(new_n134_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n130_), .c(new_n98_), .O(z20));
endmodule
