...
module FAU ( 
  ...
  inv1   g011(.a(x08), .O(new_n74_));
  nor2   g012(.a(x13), .b(new_n74_), .O(new_n75_));
  ...
  nor2   g022(.a(new_n75_), .b(new_n65_), .O(new_n85_));
  ...
  aoi21  g035(.a(new_n97_), .b(x21), .c(new_n75_), .O(z03));
  inv1   g036(.a(x21), .O(new_n99_));
  aoi21  g037(.a(new_n97_), .b(new_n99_), .c(new_n75_), .O(z04));
  inv1   g038(.a(new_n75_), .O(new_n101_));
  nand3  g039(.a(new_n96_), .b(new_n101_), .c(new_n95_), .O(z05));
  ...
  nand2  g054(.a(new_n81_), .b(new_n79_), .O(new_n117_));
  ...
  nand2  g060(.a(new_n122_), .b(new_n84_), .O(new_n123_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(new_n75_), .O(z10));
  nor2   g065(.a(x30), .b(x09), .O(new_n128_));
  nand2  g066(.a(x27), .b(new_n65_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n81_), .c(new_n74_), .O(new_n130_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n128_), .c(new_n75_), .O(z18));
  inv1   g073(.a(z18), .O(z11));
  and2   g074(.a(new_n67_), .b(x27), .O(new_n137_));
  oai21  g075(.a(new_n71_), .b(new_n137_), .c(new_n101_), .O(z12));
  aoi21  g076(.a(x36), .b(x35), .c(new_n80_), .O(new_n139_));
  inv1   g077(.a(x13), .O(new_n140_));
  nand2  g078(.a(new_n69_), .b(new_n140_), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x20), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n63_), .c(new_n141_), .d(new_n139_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  oai21  g083(.a(new_n83_), .b(new_n66_), .c(new_n74_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n140_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  aoi21  g086(.a(new_n80_), .b(x27), .c(new_n84_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n141_), .c(new_n63_), .d(new_n78_), .O(new_n150_));
  nand2  g088(.a(new_n139_), .b(new_n83_), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n141_), .c(new_n143_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n150_), .c(new_n101_), .O(z14));
  nand4  g092(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n101_), .O(z15));
  ...
  aoi21  g099(.a(new_n131_), .b(new_n81_), .c(new_n74_), .O(new_n162_));
  oai21  g100(.a(new_n94_), .b(new_n78_), .c(new_n128_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n101_), .O(z20));
