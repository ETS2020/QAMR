...
module FAU ( 
  ...
  aoi21  g102(.a(new_n136_), .b(new_n133_), .c(new_n72_), .O(z18));
  oai21  g103(.a(new_n92_), .b(new_n154_), .c(new_n134_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n131_), .c(new_n85_), .O(z20));
  nand2  g105(.a(new_n137_), .b(new_n85_), .O(z19));
endmodule
