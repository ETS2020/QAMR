...
module FAU ( 
  ...
  inv1   g007(.a(x18), .O(new_n70_));
  nand2  g008(.a(new_n70_), .b(x14), .O(new_n71_));
  ...
  aoi21  g029(.a(x35), .b(x28), .c(new_n74_), .O(new_n92_));
  nor2   g030(.a(new_n92_), .b(new_n81_), .O(new_n93_));
  ...
  nand3  g037(.a(new_n99_), .b(new_n71_), .c(new_n94_), .O(z05));
  ...
  nand4  g043(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(x18), .O(new_n106_));
  ...
  aoi21  g050(.a(new_n106_), .b(x14), .c(new_n112_), .O(z07));
  ...
  inv1   g059(.a(new_n119_), .O(new_n122_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(new_n81_), .O(z10));
  inv1   g065(.a(x08), .O(new_n128_));
  inv1   g066(.a(new_n86_), .O(new_n129_));
  ...
  nand2  g076(.a(new_n71_), .b(new_n69_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z12));
  aoi21  g078(.a(x36), .b(x35), .c(new_n76_), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(new_n74_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(new_n80_), .O(new_n143_));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(z08), .O(new_n145_));
  or2    g083(.a(new_n66_), .b(new_n74_), .O(new_n146_));
  inv1   g084(.a(x19), .O(new_n147_));
  nand3  g085(.a(x20), .b(new_n147_), .c(new_n70_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n109_), .O(new_n150_));
  oai22  g088(.a(new_n150_), .b(new_n146_), .c(new_n145_), .d(new_n143_), .O(z13));
  nand2  g089(.a(new_n144_), .b(new_n129_), .O(new_n152_));
  nand2  g090(.a(new_n141_), .b(new_n79_), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(new_n148_), .O(new_n155_));
  aoi21  g093(.a(new_n76_), .b(x27), .c(new_n80_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n152_), .c(new_n146_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n71_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  oai21  g097(.a(new_n114_), .b(new_n159_), .c(new_n71_), .O(z15));
  ...
  nand4  g103(.a(new_n165_), .b(new_n71_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  inv1   g105(.a(z11), .O(z18));
  and2   g106(.a(x35), .b(x27), .O(new_n169_));
  nor3   g107(.a(new_n169_), .b(new_n135_), .c(new_n131_), .O(z20));
  aoi21  g108(.a(new_n132_), .b(new_n131_), .c(new_n137_), .O(z19));
endmodule
