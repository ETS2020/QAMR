...
module FAU ( 
  ...
  nand2  g049(.a(new_n64_), .b(new_n63_), .O(new_n112_));
  ...
  oai21  g055(.a(new_n117_), .b(new_n116_), .c(new_n101_), .O(z09));
  nand2  g056(.a(new_n85_), .b(new_n73_), .O(new_n119_));
  nand2  g057(.a(new_n81_), .b(new_n71_), .O(new_n120_));
  ...
  aoi21  g063(.a(new_n73_), .b(new_n125_), .c(x04), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand3  g065(.a(x37), .b(x27), .c(x06), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n127_), .c(new_n65_), .O(z10));
  inv1   g067(.a(x08), .O(new_n130_));
  nand2  g068(.a(new_n73_), .b(x29), .O(new_n131_));
  ...
  nor2   g073(.a(new_n67_), .b(x04), .O(new_n136_));
  inv1   g074(.a(x09), .O(new_n137_));
  nand2  g075(.a(new_n83_), .b(new_n137_), .O(new_n138_));
  aoi21  g076(.a(new_n136_), .b(new_n135_), .c(new_n138_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n101_), .O(z11));
  oai21  g079(.a(new_n77_), .b(new_n75_), .c(new_n101_), .O(z12));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n85_), .c(new_n73_), .O(new_n144_));
  inv1   g082(.a(new_n68_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(x20), .O(new_n147_));
  oai21  g085(.a(new_n71_), .b(new_n70_), .c(x28), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n143_), .c(new_n73_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n144_), .c(new_n65_), .O(z13));
  nand2  g090(.a(new_n151_), .b(new_n144_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n101_), .O(z14));
  nand2  g092(.a(x26), .b(x12), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n116_), .c(new_n65_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n101_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x23), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n101_), .O(z17));
  aoi21  g099(.a(new_n139_), .b(new_n134_), .c(new_n65_), .O(z18));
  nand3  g100(.a(new_n139_), .b(new_n134_), .c(new_n101_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z19));
  nand2  g102(.a(x35), .b(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n83_), .c(new_n137_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n132_), .c(new_n101_), .O(z20));
endmodule
