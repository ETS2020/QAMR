...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n156_, new_n157_, new_n158_, new_n162_;
  nand2  g000(.a(x23), .b(x07), .O(new_n63_));
  ...
  nor3   g028(.a(new_n90_), .b(new_n75_), .c(new_n64_), .O(new_n91_));
  ...
  nand2  g050(.a(new_n75_), .b(new_n63_), .O(z08));
  ...
  nand2  g056(.a(new_n76_), .b(x05), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n84_), .c(new_n118_), .O(new_n121_));
  inv1   g059(.a(new_n82_), .O(new_n122_));
  nor2   g060(.a(new_n66_), .b(x04), .O(new_n123_));
  inv1   g061(.a(x07), .O(new_n124_));
  nor2   g062(.a(x23), .b(new_n124_), .O(new_n125_));
  nand4  g063(.a(new_n125_), .b(new_n123_), .c(new_n122_), .d(new_n75_), .O(new_n126_));
  oai21  g064(.a(new_n121_), .b(new_n64_), .c(new_n126_), .O(z10));
  ...
  nand2  g069(.a(new_n123_), .b(new_n86_), .O(new_n132_));
  ...
  nand3  g086(.a(new_n72_), .b(new_n141_), .c(new_n68_), .O(new_n149_));
  nor2   g087(.a(new_n149_), .b(new_n83_), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n148_), .c(new_n63_), .O(z13));
  oai21  g090(.a(new_n150_), .b(new_n147_), .c(new_n63_), .O(z14));
  inv1   g091(.a(x12), .O(new_n154_));
  oai21  g092(.a(new_n114_), .b(new_n154_), .c(new_n63_), .O(z15));
  inv1   g093(.a(x23), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x07), .O(new_n157_));
  nand2  g095(.a(x22), .b(x01), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n156_), .c(new_n157_), .O(z16));
  nor4   g097(.a(new_n158_), .b(x24), .c(new_n156_), .d(x07), .O(z17));
  inv1   g098(.a(z11), .O(z18));
  oai21  g099(.a(new_n69_), .b(new_n66_), .c(new_n135_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n130_), .O(z20));
  aoi21  g101(.a(new_n131_), .b(new_n130_), .c(new_n136_), .O(z19));
endmodule
