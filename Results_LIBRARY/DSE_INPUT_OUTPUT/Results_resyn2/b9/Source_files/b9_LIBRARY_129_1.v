...
module FAU ( 
  ...
  nand3  g078(.a(new_n140_), .b(new_n135_), .c(new_n64_), .O(z18));
  ...
  oai21  g083(.a(new_n77_), .b(x04), .c(new_n145_), .O(new_n146_));
  ...
  nand4  g087(.a(new_n149_), .b(new_n148_), .c(new_n64_), .d(x20), .O(new_n150_));
  oai21  g088(.a(new_n81_), .b(new_n119_), .c(x28), .O(new_n151_));
  nor2   g089(.a(x13), .b(x04), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n151_), .c(new_n78_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n152_), .b(new_n87_), .c(new_n78_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(new_n149_), .b(new_n148_), .c(x20), .O(new_n158_));
  nand3  g096(.a(new_n152_), .b(new_n151_), .c(x40), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g098(.a(new_n152_), .b(new_n87_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(x39), .c(new_n77_), .O(new_n162_));
  aoi21  g100(.a(new_n160_), .b(x27), .c(new_n162_), .O(z14));
  nand4  g101(.a(new_n115_), .b(new_n64_), .c(x26), .d(x12), .O(new_n164_));
  ...
  nand2  g108(.a(new_n140_), .b(new_n135_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n64_), .O(z19));
  nand2  g110(.a(x35), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n85_), .c(new_n138_), .O(new_n174_));
