...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n173_, new_n175_, new_n176_, new_n179_;
  ...
  oai21  g031(.a(new_n67_), .b(x27), .c(new_n93_), .O(new_n94_));
  ...
  inv1   g055(.a(new_n83_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n76_), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(new_n75_), .b(new_n120_), .O(new_n121_));
  nand3  g059(.a(new_n121_), .b(new_n81_), .c(x27), .O(new_n122_));
  ...
  nand4  g074(.a(x35), .b(new_n86_), .c(x27), .d(new_n71_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n98_), .O(z11));
  nand3  g077(.a(new_n67_), .b(new_n80_), .c(new_n79_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x27), .c(x10), .O(new_n141_));
  nand2  g079(.a(new_n68_), .b(new_n67_), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(x27), .c(x40), .d(new_n71_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n141_), .c(x39), .O(new_n144_));
  inv1   g082(.a(x39), .O(new_n145_));
  inv1   g083(.a(new_n69_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(x40), .c(new_n145_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(z12));
  inv1   g086(.a(x18), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nand4  g088(.a(new_n142_), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n151_));
  ...
  nand3  g103(.a(new_n165_), .b(new_n161_), .c(new_n98_), .O(new_n166_));
  ...
  oai21  g109(.a(new_n116_), .b(new_n171_), .c(new_n98_), .O(z15));
  nand2  g110(.a(x22), .b(x01), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(x23), .c(new_n98_), .O(z16));
  inv1   g112(.a(x24), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x23), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n173_), .c(new_n98_), .O(z17));
  nand4  g115(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n98_), .O(z18));
  oai21  g116(.a(new_n79_), .b(new_n66_), .c(new_n136_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n133_), .c(new_n98_), .O(z20));
  nand2  g118(.a(new_n138_), .b(new_n98_), .O(z19));
endmodule
