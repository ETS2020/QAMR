...
module FAU ( 
  ...
  aoi21  g020(.a(new_n75_), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nand2  g021(.a(x40), .b(x39), .O(new_n84_));
  aoi21  g022(.a(x29), .b(x08), .c(x02), .O(new_n85_));
  nor2   g023(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  oai21  g024(.a(new_n83_), .b(new_n65_), .c(new_n86_), .O(z02));
  inv1   g025(.a(new_n72_), .O(new_n88_));
  ...
  nand4  g030(.a(new_n92_), .b(new_n90_), .c(new_n88_), .d(x21), .O(z03));
  aoi21  g031(.a(new_n91_), .b(new_n75_), .c(x21), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n90_), .c(new_n72_), .O(z04));
  aoi21  g033(.a(x28), .b(x27), .c(x37), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(new_n88_), .O(z05));
  inv1   g035(.a(new_n96_), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n88_), .O(z06));
  ...
  xnor2a g048(.a(x40), .b(x39), .O(z08));
  inv1   g049(.a(x11), .O(new_n112_));
  nand4  g050(.a(new_n88_), .b(x34), .c(x27), .d(x26), .O(new_n113_));
  ...
  aoi21  g056(.a(new_n82_), .b(new_n118_), .c(x04), .O(new_n119_));
  ...
  nor2   g060(.a(new_n78_), .b(new_n66_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x05), .O(new_n124_));
  oai21  g062(.a(new_n122_), .b(new_n75_), .c(new_n124_), .O(z10));
  nand3  g063(.a(x35), .b(new_n76_), .c(new_n65_), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n75_), .c(new_n81_), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(x29), .O(new_n128_));
  nor2   g066(.a(new_n75_), .b(new_n65_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n82_), .c(new_n128_), .O(new_n130_));
  ...
  nand2  g071(.a(new_n133_), .b(new_n88_), .O(z11));
  nand2  g072(.a(new_n67_), .b(x27), .O(new_n135_));
  nand2  g073(.a(new_n68_), .b(new_n135_), .O(new_n136_));
  nand2  g074(.a(new_n88_), .b(new_n136_), .O(z12));
  inv1   g075(.a(x13), .O(new_n138_));
  nor2   g076(.a(new_n84_), .b(x04), .O(new_n139_));
  nand2  g077(.a(x36), .b(x35), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x28), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n139_), .c(new_n138_), .O(new_n142_));
  nand2  g080(.a(new_n89_), .b(new_n91_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(new_n88_), .c(new_n143_), .d(x20), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand2  g085(.a(new_n123_), .b(new_n138_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n147_), .O(z13));
  nand2  g087(.a(new_n139_), .b(new_n138_), .O(new_n150_));
  nand2  g088(.a(new_n76_), .b(x27), .O(new_n151_));
  and2   g089(.a(new_n151_), .b(new_n78_), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(new_n150_), .c(new_n63_), .d(new_n75_), .O(new_n153_));
  nand2  g091(.a(new_n144_), .b(x20), .O(new_n154_));
  nand3  g092(.a(new_n140_), .b(new_n78_), .c(x28), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n139_), .c(new_n138_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n154_), .c(new_n72_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n153_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  nor2   g097(.a(new_n113_), .b(new_n159_), .O(z15));
  inv1   g098(.a(x23), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(x22), .c(x01), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n88_), .O(z16));
  nor2   g101(.a(x24), .b(new_n161_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n88_), .c(x22), .d(x01), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z17));
  inv1   g104(.a(new_n129_), .O(new_n167_));
  inv1   g105(.a(new_n132_), .O(new_n168_));
  aoi21  g106(.a(new_n167_), .b(new_n83_), .c(new_n168_), .O(new_n169_));
  nand4  g107(.a(x40), .b(x39), .c(x29), .d(x08), .O(new_n170_));
  oai21  g108(.a(new_n169_), .b(new_n72_), .c(new_n170_), .O(z18));
  nand2  g109(.a(new_n132_), .b(new_n88_), .O(new_n172_));
  nand2  g110(.a(new_n126_), .b(x39), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n81_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n130_), .c(new_n172_), .O(z19));
  aoi21  g114(.a(new_n128_), .b(new_n82_), .c(new_n81_), .O(new_n177_));
  and2   g115(.a(x35), .b(x27), .O(new_n178_));
  nor3   g116(.a(new_n178_), .b(new_n177_), .c(new_n172_), .O(z20));
endmodule
