...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x03), .O(new_n72_));
  ...
  nand2  g034(.a(new_n96_), .b(new_n95_), .O(z06));
  ...
  nand2  g047(.a(new_n95_), .b(new_n84_), .O(z08));
  ...
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(new_n95_), .O(z10));
  ...
  nor2   g068(.a(new_n88_), .b(new_n130_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n76_), .c(new_n63_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  and2   g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n129_), .c(new_n95_), .O(z18));
  inv1   g073(.a(z18), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n130_), .c(new_n137_), .O(new_n139_));
  oai21  g077(.a(new_n66_), .b(new_n130_), .c(new_n64_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n139_), .c(new_n95_), .O(z12));
  ...
  nand3  g084(.a(new_n146_), .b(new_n114_), .c(new_n76_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n130_), .O(new_n148_));
  nand2  g086(.a(new_n146_), .b(new_n114_), .O(new_n149_));
  nor2   g087(.a(new_n149_), .b(new_n75_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n95_), .O(new_n151_));
  inv1   g089(.a(x03), .O(new_n152_));
  nor2   g090(.a(x13), .b(new_n152_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n131_), .c(new_n65_), .d(x36), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(z13));
  aoi21  g093(.a(x36), .b(x35), .c(new_n76_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n149_), .c(new_n145_), .O(new_n157_));
  oai21  g095(.a(new_n149_), .b(new_n75_), .c(new_n95_), .O(new_n158_));
  aoi21  g096(.a(new_n157_), .b(x27), .c(new_n158_), .O(z14));
  nand4  g097(.a(new_n111_), .b(new_n95_), .c(x26), .d(x12), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z15));
  nand2  g099(.a(x22), .b(x01), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x23), .c(new_n95_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  inv1   g102(.a(new_n162_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n95_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  nand2  g105(.a(new_n134_), .b(new_n129_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n95_), .O(z19));
  nor2   g107(.a(new_n131_), .b(new_n72_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n133_), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(new_n127_), .O(z20));
endmodule
