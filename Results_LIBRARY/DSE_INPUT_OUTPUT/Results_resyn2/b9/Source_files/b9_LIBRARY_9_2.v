...
module FAU ( 
  ...
  nor2   g001(.a(x23), .b(new_n63_), .O(new_n64_));
  ...
  nand4  g030(.a(new_n92_), .b(new_n89_), .c(new_n72_), .d(new_n86_), .O(z02));
  ...
  aoi21  g036(.a(new_n96_), .b(new_n98_), .c(new_n64_), .O(z04));
  ...
  nand2  g051(.a(new_n75_), .b(new_n86_), .O(z08));
  ...
  aoi21  g059(.a(new_n121_), .b(new_n84_), .c(new_n119_), .O(new_n122_));
  inv1   g060(.a(new_n82_), .O(new_n123_));
  nand2  g061(.a(x23), .b(x07), .O(new_n124_));
  nor2   g062(.a(new_n124_), .b(new_n72_), .O(new_n125_));
  nand4  g063(.a(new_n125_), .b(new_n123_), .c(x27), .d(new_n68_), .O(new_n126_));
  oai21  g064(.a(new_n122_), .b(new_n64_), .c(new_n126_), .O(z10));
  ...
  nand4  g070(.a(x35), .b(new_n81_), .c(x27), .d(new_n68_), .O(new_n133_));
  ...
  nand3  g077(.a(new_n77_), .b(new_n139_), .c(new_n86_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  inv1   g079(.a(x13), .O(new_n142_));
  oai21  g080(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n72_), .c(new_n142_), .d(new_n68_), .O(new_n144_));
  ...
  nand3  g087(.a(new_n72_), .b(new_n142_), .c(new_n68_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n83_), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n149_), .c(new_n86_), .O(z13));
  oai21  g091(.a(new_n151_), .b(new_n148_), .c(new_n86_), .O(z14));
  inv1   g092(.a(x12), .O(new_n155_));
  oai21  g093(.a(new_n116_), .b(new_n155_), .c(new_n86_), .O(z15));
  ...
  nor2   g099(.a(new_n69_), .b(new_n66_), .O(new_n162_));
  nor3   g100(.a(new_n162_), .b(new_n135_), .c(new_n130_), .O(z20));
