...
module FAU ( 
  ...
  nand2  g10(.a(x23), .b(x22), .O(new_n73_));
  and2   g11(.a(new_n73_), .b(x16), .O(new_n74_));
  oai21  g12(.a(new_n72_), .b(x15), .c(new_n74_), .O(z00));
  inv1   g13(.a(x27), .O(new_n76_));
  inv1   g14(.a(x36), .O(new_n77_));
  inv1   g15(.a(x28), .O(new_n78_));
  nand2  g16(.a(x35), .b(new_n78_), .O(new_n79_));
  aoi21  g17(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(new_n80_));
  inv1   g18(.a(x30), .O(new_n81_));
  inv1   g19(.a(x32), .O(new_n82_));
  nand2  g20(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  inv1   g21(.a(new_n73_), .O(new_n84_));
  nor2   g22(.a(new_n84_), .b(new_n65_), .O(new_n85_));
  oai21  g23(.a(new_n83_), .b(new_n80_), .c(new_n85_), .O(z01));
  nor2   g24(.a(x27), .b(x08), .O(new_n87_));
  oai21  g25(.a(new_n87_), .b(new_n79_), .c(x04), .O(new_n88_));
  aoi21  g26(.a(x29), .b(x08), .c(x02), .O(new_n89_));
  nor2   g27(.a(new_n89_), .b(new_n68_), .O(new_n90_));
  aoi21  g28(.a(new_n90_), .b(new_n88_), .c(new_n84_), .O(z02));
  ...
  aoi21  g33(.a(new_n95_), .b(x21), .c(new_n84_), .O(z03));
  inv1   g34(.a(x21), .O(new_n97_));
  aoi21  g35(.a(new_n95_), .b(new_n97_), .c(new_n84_), .O(z04));
  nand3  g36(.a(new_n94_), .b(new_n73_), .c(new_n93_), .O(z05));
  nand2  g37(.a(new_n94_), .b(new_n93_), .O(new_n100_));
  nand2  g38(.a(new_n100_), .b(new_n73_), .O(z06));
  ...
  nand3  g48(.a(new_n110_), .b(new_n73_), .c(x03), .O(new_n111_));
  nor2   g49(.a(new_n111_), .b(new_n106_), .O(z07));
  nand2  g50(.a(new_n73_), .b(new_n68_), .O(z08));
  nand4  g51(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n114_));
  nand2  g52(.a(new_n114_), .b(new_n73_), .O(z09));
  ...
  aoi21  g63(.a(new_n125_), .b(new_n124_), .c(new_n84_), .O(z10));
  ...
  nand4  g68(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n131_));
  inv1   g69(.a(x09), .O(new_n132_));
  nand3  g70(.a(new_n73_), .b(new_n81_), .c(new_n132_), .O(new_n133_));
  ...
  and2   g74(.a(new_n67_), .b(x27), .O(new_n137_));
  oai21  g75(.a(new_n71_), .b(new_n137_), .c(new_n73_), .O(z12));
  oai21  g76(.a(new_n77_), .b(new_n92_), .c(x28), .O(new_n139_));
  nor2   g77(.a(x13), .b(x04), .O(new_n140_));
  nand3  g78(.a(new_n140_), .b(new_n139_), .c(new_n69_), .O(new_n141_));
  inv1   g79(.a(new_n63_), .O(new_n142_));
  ...
  nand3  g84(.a(new_n140_), .b(new_n83_), .c(new_n69_), .O(new_n147_));
  aoi21  g85(.a(new_n147_), .b(new_n146_), .c(new_n84_), .O(z13));
  aoi21  g86(.a(new_n144_), .b(new_n141_), .c(new_n76_), .O(new_n149_));
  inv1   g87(.a(new_n147_), .O(new_n150_));
  nor3   g88(.a(new_n150_), .b(new_n149_), .c(new_n84_), .O(z14));
  ...
  oai21  g94(.a(new_n92_), .b(new_n76_), .c(new_n134_), .O(new_n158_));
  nor2   g95(.a(new_n158_), .b(new_n129_), .O(z20));
  zero   g96(.O(z17));
  aoi21  g97(.a(new_n130_), .b(new_n129_), .c(new_n135_), .O(z19));
endmodule
