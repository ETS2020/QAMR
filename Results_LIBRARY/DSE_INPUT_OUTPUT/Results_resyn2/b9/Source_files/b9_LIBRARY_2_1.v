...
module FAU ( 
  ...
  nand3  g034(.a(new_n96_), .b(x21), .c(x17), .O(z03));
  aoi21  g035(.a(new_n96_), .b(new_n63_), .c(new_n64_), .O(z04));
  nand2  g036(.a(new_n95_), .b(new_n94_), .O(new_n99_));
  inv1   g037(.a(new_n99_), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n87_), .O(z05));
  nand2  g039(.a(new_n99_), .b(new_n87_), .O(z06));
