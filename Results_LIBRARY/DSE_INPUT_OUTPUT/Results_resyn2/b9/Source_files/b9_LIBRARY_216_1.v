...
module FAU ( 
  ...
  oai21  g016(.a(new_n78_), .b(x28), .c(new_n72_), .O(new_n79_));
  ...
  inv1   g060(.a(new_n87_), .O(new_n123_));
  ...
  nor2   g071(.a(new_n78_), .b(new_n133_), .O(new_n134_));
  nor2   g072(.a(x28), .b(x04), .O(new_n135_));
  inv1   g073(.a(x09), .O(new_n136_));
  nand2  g074(.a(new_n76_), .b(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n132_), .c(new_n101_), .O(z18));
  ...
  oai21  g086(.a(new_n72_), .b(new_n78_), .c(x28), .O(new_n149_));
  ...
  nand3  g092(.a(new_n154_), .b(new_n153_), .c(new_n101_), .O(z13));
  nand2  g093(.a(new_n154_), .b(new_n101_), .O(new_n156_));
  aoi21  g094(.a(new_n152_), .b(x27), .c(new_n156_), .O(z14));
  nand4  g095(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n101_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n101_), .O(z16));
  ...
  nand2  g103(.a(new_n165_), .b(new_n101_), .O(z19));
  inv1   g104(.a(new_n134_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n101_), .O(new_n168_));
