...
module FAU ( 
  ...
  oai21  g012(.a(new_n73_), .b(x29), .c(new_n74_), .O(new_n75_));
  ...
  oai21  g023(.a(new_n85_), .b(new_n67_), .c(new_n83_), .O(new_n86_));
  aoi21  g024(.a(new_n86_), .b(x04), .c(new_n64_), .O(z01));
  nand2  g025(.a(x35), .b(new_n84_), .O(new_n88_));
  nor2   g026(.a(x27), .b(x08), .O(new_n89_));
  oai21  g027(.a(new_n89_), .b(new_n88_), .c(x04), .O(new_n90_));
  nor2   g028(.a(new_n76_), .b(new_n64_), .O(z08));
  inv1   g029(.a(x02), .O(new_n92_));
  inv1   g030(.a(x08), .O(new_n93_));
  oai21  g031(.a(new_n63_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n67_), .c(new_n64_), .O(new_n99_));
  ...
  oai21  g041(.a(new_n84_), .b(new_n67_), .c(new_n98_), .O(new_n104_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n103_), .c(x03), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n110_), .O(z07));
  and2   g054(.a(x34), .b(x27), .O(new_n117_));
  nand3  g055(.a(new_n117_), .b(x26), .c(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n103_), .O(z09));
  oai21  g057(.a(new_n85_), .b(new_n67_), .c(new_n76_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  oai21  g059(.a(new_n76_), .b(x05), .c(new_n69_), .O(new_n122_));
  aoi21  g060(.a(new_n76_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n120_), .c(new_n86_), .O(new_n124_));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n88_), .c(new_n93_), .O(new_n128_));
  nand2  g066(.a(new_n127_), .b(x27), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  inv1   g068(.a(new_n88_), .O(new_n131_));
  inv1   g069(.a(x09), .O(new_n132_));
  inv1   g070(.a(x30), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  aoi21  g072(.a(new_n131_), .b(new_n78_), .c(new_n134_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n103_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  aoi22  g075(.a(new_n80_), .b(new_n75_), .c(new_n71_), .d(new_n103_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  nand3  g077(.a(new_n77_), .b(new_n139_), .c(new_n69_), .O(new_n140_));
  aoi21  g078(.a(x36), .b(x35), .c(new_n84_), .O(new_n141_));
  nand2  g079(.a(new_n96_), .b(new_n98_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(x20), .O(new_n144_));
  oai21  g082(.a(new_n141_), .b(new_n140_), .c(new_n144_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  inv1   g084(.a(new_n83_), .O(new_n147_));
  inv1   g085(.a(new_n140_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n64_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n146_), .O(z13));
  nand2  g088(.a(new_n98_), .b(new_n73_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n143_), .c(x20), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n141_), .c(new_n67_), .O(new_n153_));
  nand4  g091(.a(new_n143_), .b(new_n142_), .c(x27), .d(x20), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n140_), .c(new_n64_), .O(new_n155_));
  oai21  g093(.a(new_n153_), .b(new_n147_), .c(new_n155_), .O(z14));
  nand4  g094(.a(new_n117_), .b(new_n103_), .c(x26), .d(x12), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n103_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n103_), .O(z17));
  nand2  g101(.a(new_n135_), .b(new_n130_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n103_), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n133_), .c(new_n132_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n128_), .c(new_n103_), .O(z20));
endmodule
