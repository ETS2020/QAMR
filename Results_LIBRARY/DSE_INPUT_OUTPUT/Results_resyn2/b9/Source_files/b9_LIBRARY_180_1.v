...
module FAU ( 
  ...
  nor2   g010(.a(new_n72_), .b(x07), .O(new_n73_));
  ...
  aoi21  g034(.a(new_n94_), .b(new_n96_), .c(new_n73_), .O(z04));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n73_), .O(z05));
  inv1   g037(.a(x07), .O(new_n100_));
  nand2  g038(.a(x32), .b(new_n100_), .O(new_n101_));
  and2   g039(.a(new_n98_), .b(new_n101_), .O(z06));
  ...
  nand2  g051(.a(new_n101_), .b(new_n86_), .O(z08));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n101_), .c(x11), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z09));
  aoi21  g056(.a(new_n79_), .b(new_n77_), .c(x04), .O(new_n119_));
  inv1   g057(.a(new_n86_), .O(new_n120_));
  nand2  g058(.a(new_n72_), .b(x05), .O(new_n121_));
  aoi21  g059(.a(x40), .b(x39), .c(x07), .O(new_n122_));
  aoi21  g060(.a(new_n121_), .b(new_n120_), .c(new_n122_), .O(new_n123_));
  nand2  g061(.a(x37), .b(x06), .O(new_n124_));
  aoi21  g062(.a(x32), .b(new_n100_), .c(new_n124_), .O(new_n125_));
  aoi21  g063(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(new_n126_));
  nand4  g064(.a(new_n87_), .b(new_n82_), .c(x05), .d(new_n65_), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(new_n76_), .c(new_n127_), .O(z10));
  ...
  nor2   g073(.a(new_n76_), .b(x04), .O(new_n136_));
  inv1   g074(.a(x09), .O(new_n137_));
  inv1   g075(.a(x30), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  aoi21  g077(.a(new_n136_), .b(new_n135_), .c(new_n139_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n133_), .c(new_n101_), .O(z18));
  inv1   g079(.a(z18), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand3  g081(.a(new_n101_), .b(new_n68_), .c(new_n143_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z12));
  nand2  g083(.a(x35), .b(x28), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n92_), .O(new_n147_));
  nor2   g085(.a(x19), .b(x18), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n101_), .c(new_n147_), .d(x20), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x28), .O(new_n151_));
  nor2   g089(.a(x13), .b(x04), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n151_), .c(new_n120_), .d(new_n72_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n152_), .b(new_n87_), .c(new_n82_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand2  g095(.a(new_n148_), .b(x20), .O(new_n158_));
  nand3  g096(.a(new_n152_), .b(x40), .c(x39), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n101_), .O(new_n160_));
  nand3  g098(.a(new_n150_), .b(new_n81_), .c(x28), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  aoi21  g101(.a(new_n78_), .b(x27), .c(new_n82_), .O(new_n164_));
  aoi21  g102(.a(new_n147_), .b(x27), .c(new_n73_), .O(new_n165_));
  oai21  g103(.a(new_n164_), .b(new_n159_), .c(new_n165_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z14));
  nand3  g105(.a(new_n116_), .b(new_n101_), .c(x12), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z15));
  nand2  g107(.a(x22), .b(x01), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(x23), .c(new_n101_), .O(z16));
  inv1   g109(.a(x24), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x23), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n170_), .c(new_n101_), .O(z17));
  nand2  g112(.a(new_n140_), .b(new_n133_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n101_), .O(z19));
  nand2  g114(.a(x35), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n138_), .c(new_n137_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n131_), .c(new_n101_), .O(z20));
endmodule
