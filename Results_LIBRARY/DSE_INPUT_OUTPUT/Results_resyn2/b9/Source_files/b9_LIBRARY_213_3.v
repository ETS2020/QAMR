...
module FAU ( 
  ...
  nand2  g42(.a(new_n89_), .b(new_n63_), .O(z08));
  ...
  aoi21  g74(.a(x36), .b(x35), .c(new_n81_), .O(new_n137_));
  ...
  nand2  g78(.a(new_n138_), .b(new_n109_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n63_), .O(new_n142_));
  aoi21  g80(.a(new_n140_), .b(x27), .c(new_n142_), .O(z14));
  inv1   g81(.a(z14), .O(z13));
  nand3  g82(.a(new_n63_), .b(x26), .c(x12), .O(new_n145_));
  nor2   g83(.a(new_n145_), .b(new_n106_), .O(z15));
  ...
  nand2  g89(.a(new_n151_), .b(new_n63_), .O(z17));
