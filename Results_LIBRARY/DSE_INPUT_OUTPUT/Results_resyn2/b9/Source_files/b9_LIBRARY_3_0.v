...
module FAU ( 
  ...
  nor2   g009(.a(x33), .b(x17), .O(new_n72_));
  ...
  aoi21  g026(.a(new_n88_), .b(new_n85_), .c(new_n72_), .O(z02));
  ...
  aoi21  g031(.a(new_n93_), .b(new_n92_), .c(new_n72_), .O(new_n94_));
  ...
  nand2  g040(.a(new_n102_), .b(x15), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(x33), .c(x14), .O(new_n104_));
  ...
  nor2   g072(.a(new_n75_), .b(new_n92_), .O(new_n135_));
  nor2   g073(.a(x28), .b(x04), .O(new_n136_));
  ...
  nand2  g079(.a(new_n98_), .b(new_n141_), .O(z12));
  nand2  g080(.a(x36), .b(x35), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x28), .O(new_n144_));
  nor2   g082(.a(x13), .b(x04), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n116_), .O(new_n146_));
  nand2  g084(.a(new_n90_), .b(new_n93_), .O(new_n147_));
  ...
  nand3  g089(.a(new_n145_), .b(new_n117_), .c(new_n116_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n151_), .c(new_n72_), .O(z13));
  inv1   g091(.a(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n145_), .b(new_n116_), .c(new_n82_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n63_), .c(new_n92_), .O(new_n156_));
  nand2  g094(.a(new_n148_), .b(x20), .O(new_n157_));
  nand3  g095(.a(new_n143_), .b(new_n79_), .c(x28), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n145_), .c(new_n116_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n157_), .c(new_n72_), .O(new_n160_));
  oai21  g098(.a(new_n156_), .b(new_n154_), .c(new_n160_), .O(z14));
  inv1   g099(.a(x12), .O(new_n162_));
  oai21  g100(.a(new_n114_), .b(new_n162_), .c(new_n98_), .O(z15));
  inv1   g101(.a(x23), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(x22), .c(x01), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n98_), .O(z16));
  nor2   g104(.a(x24), .b(new_n164_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n98_), .c(x22), .d(x01), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z17));
  aoi21  g107(.a(new_n137_), .b(new_n132_), .c(new_n72_), .O(z18));
  nand2  g108(.a(new_n133_), .b(new_n98_), .O(new_n171_));
  nor3   g109(.a(new_n171_), .b(new_n135_), .c(new_n130_), .O(z20));
  nand2  g110(.a(new_n138_), .b(new_n98_), .O(z19));
endmodule
