...
module FAU ( 
  ...
  nor2   g009(.a(x32), .b(x07), .O(new_n72_));
  ...
  nand3  g019(.a(new_n81_), .b(new_n80_), .c(x07), .O(new_n82_));
  oai22  g020(.a(new_n82_), .b(new_n79_), .c(new_n72_), .d(x04), .O(z01));
  ...
  nor2   g027(.a(new_n72_), .b(new_n89_), .O(new_n90_));
  ...
  nand2  g051(.a(new_n102_), .b(new_n89_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n102_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n115_), .O(z09));
  nand3  g055(.a(new_n102_), .b(x37), .c(x06), .O(new_n118_));
  inv1   g056(.a(x35), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x28), .c(new_n76_), .O(new_n120_));
  inv1   g058(.a(x05), .O(new_n121_));
  nand3  g059(.a(x40), .b(x39), .c(new_n121_), .O(new_n122_));
  inv1   g060(.a(x07), .O(new_n123_));
  nor2   g061(.a(new_n123_), .b(x04), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n122_), .c(new_n120_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n118_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x27), .O(new_n127_));
  aoi21  g065(.a(x30), .b(x07), .c(x32), .O(new_n128_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n136_), .c(new_n102_), .O(z18));
  inv1   g080(.a(z18), .O(z11));
  nand2  g081(.a(new_n67_), .b(x27), .O(new_n144_));
  nand3  g082(.a(new_n102_), .b(new_n68_), .c(new_n144_), .O(new_n145_));
  ...
  nand4  g087(.a(new_n149_), .b(new_n102_), .c(new_n148_), .d(x20), .O(new_n150_));
  inv1   g088(.a(x13), .O(new_n151_));
  nor2   g089(.a(new_n89_), .b(x04), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n123_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n152_), .c(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n150_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  nand2  g095(.a(new_n129_), .b(new_n151_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  oai21  g097(.a(new_n66_), .b(x13), .c(new_n102_), .O(new_n160_));
  inv1   g098(.a(new_n82_), .O(new_n161_));
  aoi21  g099(.a(x36), .b(x35), .c(new_n77_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n75_), .c(new_n161_), .O(new_n163_));
  nand4  g101(.a(new_n149_), .b(new_n148_), .c(x27), .d(x20), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n163_), .b(new_n160_), .c(new_n165_), .O(z14));
  inv1   g104(.a(x12), .O(new_n167_));
  nor2   g105(.a(new_n116_), .b(new_n167_), .O(z15));
  nand2  g106(.a(x22), .b(x01), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(x23), .c(new_n102_), .O(z16));
  inv1   g108(.a(x24), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x23), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n169_), .c(new_n102_), .O(z17));
  nand2  g111(.a(new_n141_), .b(new_n136_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n102_), .O(z19));
  nand2  g113(.a(x35), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n80_), .c(new_n139_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n134_), .c(new_n102_), .O(z20));
endmodule
