...
module FAU ( 
  ...
  nor2   g009(.a(x29), .b(new_n71_), .O(new_n72_));
  ...
  aoi21  g027(.a(new_n89_), .b(new_n86_), .c(new_n72_), .O(z02));
  inv1   g028(.a(new_n72_), .O(new_n91_));
  inv1   g029(.a(x35), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n77_), .c(x27), .O(new_n93_));
  inv1   g031(.a(x37), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n75_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(x21), .O(z03));
  aoi21  g034(.a(new_n94_), .b(new_n75_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n93_), .c(new_n72_), .O(z04));
  aoi21  g036(.a(x28), .b(x27), .c(x37), .O(new_n99_));
  nor2   g037(.a(new_n99_), .b(new_n72_), .O(z05));
  inv1   g038(.a(new_n99_), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n72_), .O(z06));
  ...
  nand4  g044(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(x29), .O(new_n107_));
  inv1   g045(.a(x25), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(x00), .O(new_n109_));
  nand2  g047(.a(x25), .b(new_n71_), .O(new_n110_));
  ...
  inv1   g071(.a(new_n78_), .O(new_n134_));
  nor2   g072(.a(new_n75_), .b(x04), .O(new_n135_));
  inv1   g073(.a(x09), .O(new_n136_));
  nand2  g074(.a(new_n80_), .b(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n91_), .O(z11));
  nand2  g078(.a(new_n91_), .b(new_n69_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z12));
  aoi21  g080(.a(x36), .b(x35), .c(new_n77_), .O(new_n143_));
  inv1   g081(.a(x13), .O(new_n144_));
  inv1   g082(.a(new_n87_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n63_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x20), .O(new_n148_));
  oai22  g086(.a(new_n148_), .b(new_n66_), .c(new_n146_), .d(new_n143_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  inv1   g088(.a(new_n146_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n82_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n150_), .c(new_n72_), .O(z13));
  nand3  g091(.a(new_n143_), .b(new_n81_), .c(new_n80_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n148_), .O(new_n156_));
  aoi21  g094(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n157_));
  oai22  g095(.a(new_n157_), .b(new_n146_), .c(new_n66_), .d(new_n75_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n156_), .c(new_n91_), .O(z14));
  inv1   g097(.a(x12), .O(new_n160_));
  oai21  g098(.a(new_n116_), .b(new_n160_), .c(new_n91_), .O(z15));
  nand2  g099(.a(x22), .b(x01), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x23), .c(new_n91_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  inv1   g102(.a(new_n162_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n91_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  nand3  g105(.a(new_n138_), .b(new_n133_), .c(new_n91_), .O(z18));
  inv1   g106(.a(z18), .O(z19));
  nor2   g107(.a(new_n92_), .b(new_n75_), .O(new_n170_));
  nor4   g108(.a(new_n170_), .b(new_n137_), .c(new_n131_), .d(new_n72_), .O(z20));
endmodule
