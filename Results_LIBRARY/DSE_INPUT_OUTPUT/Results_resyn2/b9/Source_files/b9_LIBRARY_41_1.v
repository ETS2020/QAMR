...
module FAU ( 
  ...
  oai22  g031(.a(new_n93_), .b(new_n85_), .c(new_n92_), .d(x27), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(x21), .c(new_n82_), .O(z03));
  inv1   g033(.a(x40), .O(new_n96_));
  nand3  g034(.a(new_n94_), .b(new_n96_), .c(new_n71_), .O(z04));
  ...
  aoi21  g050(.a(new_n112_), .b(x21), .c(new_n96_), .O(z08));
  ...
  nor2   g055(.a(new_n96_), .b(new_n112_), .O(new_n118_));
  nand2  g056(.a(new_n81_), .b(new_n118_), .O(new_n119_));
  nand2  g057(.a(new_n78_), .b(new_n76_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  oai21  g059(.a(new_n96_), .b(new_n112_), .c(new_n121_), .O(new_n122_));
  ...
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(new_n72_), .O(z10));
  inv1   g067(.a(x08), .O(new_n130_));
  nor2   g068(.a(x30), .b(x09), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(x04), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x21), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x40), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x27), .c(x04), .O(new_n136_));
  nand2  g074(.a(new_n135_), .b(new_n78_), .O(new_n137_));
  oai21  g075(.a(new_n78_), .b(new_n75_), .c(new_n130_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n136_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n131_), .O(new_n140_));
  ...
  nand2  g081(.a(new_n72_), .b(new_n143_), .O(z12));
  inv1   g082(.a(new_n63_), .O(new_n145_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n72_), .c(new_n145_), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x28), .O(new_n152_));
  nor2   g090(.a(x13), .b(x04), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n152_), .c(new_n118_), .d(x21), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand4  g094(.a(new_n153_), .b(new_n81_), .c(new_n118_), .d(x21), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(new_n151_), .b(new_n80_), .c(x28), .O(new_n159_));
  inv1   g097(.a(x13), .O(new_n160_));
  nand3  g098(.a(x39), .b(new_n160_), .c(new_n65_), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n159_), .c(new_n71_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n96_), .c(new_n148_), .O(new_n164_));
  nand2  g102(.a(new_n145_), .b(x27), .O(new_n165_));
  nand2  g103(.a(new_n77_), .b(x27), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n80_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n162_), .c(new_n71_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n96_), .c(new_n165_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n164_), .O(z14));
  nand3  g108(.a(new_n115_), .b(new_n72_), .c(x12), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z15));
  nand2  g110(.a(x22), .b(x01), .O(new_n173_));
  nor3   g111(.a(new_n173_), .b(new_n82_), .c(x23), .O(z16));
  inv1   g112(.a(x24), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x23), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n173_), .c(new_n72_), .O(z17));
  aoi21  g115(.a(new_n135_), .b(new_n78_), .c(new_n130_), .O(new_n178_));
  nand2  g116(.a(new_n135_), .b(x27), .O(new_n179_));
  nand3  g117(.a(new_n86_), .b(x27), .c(new_n65_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n131_), .c(new_n72_), .O(new_n181_));
  aoi21  g119(.a(new_n179_), .b(new_n178_), .c(new_n181_), .O(z19));
  inv1   g120(.a(z19), .O(z18));
  oai21  g121(.a(new_n85_), .b(new_n75_), .c(new_n131_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n178_), .c(new_n72_), .O(z20));
endmodule
