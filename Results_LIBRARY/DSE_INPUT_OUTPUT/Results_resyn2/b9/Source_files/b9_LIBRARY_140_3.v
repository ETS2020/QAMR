...
module FAU ( 
  ...
  nand2  g00(.a(x25), .b(x22), .O(new_n63_));
  ...
  nand3  g35(.a(new_n92_), .b(new_n63_), .c(new_n91_), .O(new_n98_));
  inv1   g36(.a(new_n98_), .O(z06));
  ...
  nand2  g47(.a(new_n109_), .b(new_n63_), .O(z07));
  nand2  g48(.a(new_n87_), .b(new_n63_), .O(z08));
  nand3  g49(.a(x34), .b(x27), .c(x26), .O(new_n112_));
  nand2  g50(.a(new_n63_), .b(x11), .O(new_n113_));
  nor2   g51(.a(new_n113_), .b(new_n112_), .O(z09));
  ...
  nor2   g65(.a(new_n69_), .b(new_n66_), .O(new_n128_));
  nor2   g66(.a(x28), .b(x04), .O(new_n129_));
  inv1   g67(.a(x09), .O(new_n130_));
  inv1   g68(.a(x30), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  aoi21  g70(.a(new_n129_), .b(new_n128_), .c(new_n132_), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(new_n127_), .c(new_n63_), .O(new_n134_));
  inv1   g72(.a(new_n134_), .O(z11));
  oai21  g73(.a(new_n76_), .b(new_n74_), .c(new_n63_), .O(z12));
  ...
  oai21  g80(.a(new_n138_), .b(new_n81_), .c(new_n63_), .O(new_n143_));
  aoi21  g81(.a(new_n142_), .b(x27), .c(new_n143_), .O(z14));
  inv1   g82(.a(z14), .O(z13));
  inv1   g83(.a(x12), .O(new_n146_));
  oai21  g84(.a(new_n112_), .b(new_n146_), .c(new_n63_), .O(z15));
  inv1   g85(.a(x22), .O(new_n148_));
  inv1   g86(.a(x23), .O(new_n149_));
  nand2  g87(.a(new_n149_), .b(x01), .O(new_n150_));
  aoi21  g88(.a(new_n150_), .b(new_n100_), .c(new_n148_), .O(z16));
  inv1   g89(.a(x24), .O(new_n152_));
  nand3  g90(.a(new_n152_), .b(x23), .c(x01), .O(new_n153_));
  aoi21  g91(.a(new_n153_), .b(new_n100_), .c(new_n148_), .O(z17));
  aoi21  g92(.a(new_n133_), .b(new_n127_), .c(new_n64_), .O(z18));
  nand2  g93(.a(new_n133_), .b(new_n127_), .O(new_n156_));
  nand2  g94(.a(new_n156_), .b(new_n63_), .O(z19));
  oai21  g95(.a(new_n69_), .b(new_n66_), .c(new_n63_), .O(new_n158_));
  nor3   g96(.a(new_n158_), .b(new_n132_), .c(new_n125_), .O(z20));
endmodule
