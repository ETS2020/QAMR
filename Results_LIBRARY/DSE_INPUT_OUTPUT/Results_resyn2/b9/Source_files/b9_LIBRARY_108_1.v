...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x02), .O(new_n72_));
  ...
  aoi21  g033(.a(new_n95_), .b(x21), .c(new_n72_), .O(z03));
  ...
  nor2   g050(.a(new_n72_), .b(new_n89_), .O(z08));
  nand3  g051(.a(x34), .b(x27), .c(x26), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(new_n98_), .c(x11), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z09));
  inv1   g055(.a(new_n89_), .O(new_n118_));
  nand2  g056(.a(new_n80_), .b(new_n118_), .O(new_n119_));
  nand2  g057(.a(new_n77_), .b(new_n71_), .O(new_n120_));
  ...
  aoi21  g063(.a(new_n118_), .b(new_n125_), .c(x04), .O(new_n126_));
  ...
  aoi21  g068(.a(new_n130_), .b(new_n77_), .c(new_n83_), .O(new_n131_));
  nand2  g069(.a(new_n130_), .b(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nor2   g071(.a(new_n92_), .b(new_n75_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n76_), .c(new_n63_), .O(new_n135_));
  nor2   g073(.a(x30), .b(x09), .O(new_n136_));
  and2   g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n133_), .c(new_n98_), .O(new_n138_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n118_), .c(new_n76_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n75_), .O(new_n150_));
  nand2  g088(.a(new_n148_), .b(new_n118_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(new_n79_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(new_n98_), .O(new_n153_));
  nor2   g091(.a(x13), .b(new_n86_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n134_), .c(new_n65_), .d(x36), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(z13));
  aoi21  g094(.a(x36), .b(x35), .c(new_n76_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n151_), .c(new_n147_), .O(new_n158_));
  oai21  g096(.a(new_n151_), .b(new_n79_), .c(new_n98_), .O(new_n159_));
  aoi21  g097(.a(new_n158_), .b(x27), .c(new_n159_), .O(z14));
  nand3  g098(.a(new_n115_), .b(new_n98_), .c(x12), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(x23), .c(new_n98_), .O(z16));
  ...
  aoi21  g106(.a(new_n137_), .b(new_n133_), .c(new_n72_), .O(z18));
  nand2  g107(.a(new_n137_), .b(new_n133_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n98_), .O(z19));
  nor2   g109(.a(new_n134_), .b(new_n72_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n136_), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n131_), .O(z20));
endmodule
