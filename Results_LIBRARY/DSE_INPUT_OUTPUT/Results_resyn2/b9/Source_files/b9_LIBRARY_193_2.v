...
module FAU ( 
  ...
  aoi21  g056(.a(new_n86_), .b(new_n118_), .c(new_n67_), .O(new_n119_));
  nand2  g057(.a(new_n88_), .b(x07), .O(new_n120_));
  nand2  g058(.a(x39), .b(x05), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nor2   g060(.a(new_n121_), .b(new_n81_), .O(new_n123_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n86_), .c(new_n84_), .O(new_n130_));
  ...
  aoi21  g074(.a(new_n136_), .b(new_n79_), .c(new_n135_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n132_), .c(new_n98_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  nor3   g077(.a(new_n75_), .b(new_n69_), .c(new_n64_), .O(z12));
  aoi21  g078(.a(x36), .b(x35), .c(new_n85_), .O(new_n141_));
  inv1   g079(.a(x13), .O(new_n142_));
  nand4  g080(.a(x40), .b(x39), .c(new_n142_), .d(new_n73_), .O(new_n143_));
  ...
  nor2   g085(.a(new_n143_), .b(new_n81_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(new_n64_), .O(new_n149_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n143_), .c(new_n145_), .O(new_n154_));
  inv1   g092(.a(new_n69_), .O(new_n155_));
  ...
  nand3  g097(.a(new_n159_), .b(new_n154_), .c(new_n98_), .O(z14));
  nand3  g098(.a(new_n115_), .b(new_n98_), .c(x12), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  nor3   g101(.a(new_n163_), .b(new_n64_), .c(x23), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x23), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n163_), .c(new_n98_), .O(z17));
  nand2  g105(.a(x27), .b(x04), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n87_), .c(new_n135_), .O(new_n169_));
  nand3  g107(.a(z08), .b(x29), .c(x08), .O(new_n170_));
  oai21  g108(.a(new_n169_), .b(new_n64_), .c(new_n170_), .O(z18));
  ...
  oai21  g113(.a(new_n175_), .b(new_n130_), .c(new_n98_), .O(z20));
endmodule
