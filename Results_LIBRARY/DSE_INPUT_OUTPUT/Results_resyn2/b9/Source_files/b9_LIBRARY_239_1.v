...
module FAU ( 
  ...
  nand2  g046(.a(x25), .b(new_n63_), .O(new_n109_));
  ...
  nand2  g057(.a(new_n87_), .b(new_n75_), .O(new_n120_));
  nand2  g058(.a(new_n83_), .b(new_n73_), .O(new_n121_));
  inv1   g059(.a(x07), .O(new_n122_));
  nand2  g060(.a(new_n92_), .b(new_n122_), .O(new_n123_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n103_), .O(z11));
  inv1   g080(.a(new_n77_), .O(new_n143_));
  nand3  g081(.a(new_n78_), .b(new_n143_), .c(new_n103_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z12));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n87_), .c(new_n75_), .O(new_n147_));
  nor2   g085(.a(x19), .b(x18), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n69_), .c(x20), .O(new_n149_));
  oai21  g087(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n146_), .c(new_n75_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n149_), .c(new_n66_), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n147_), .c(new_n64_), .O(z13));
  inv1   g092(.a(new_n147_), .O(new_n155_));
  nor3   g093(.a(new_n152_), .b(new_n155_), .c(new_n64_), .O(z14));
  nand4  g094(.a(new_n117_), .b(new_n103_), .c(x26), .d(x12), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n64_), .c(x23), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n103_), .O(z17));
  nand3  g101(.a(new_n140_), .b(new_n135_), .c(new_n103_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n85_), .c(new_n138_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n133_), .c(new_n103_), .O(z20));
endmodule
