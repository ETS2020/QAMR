...
module FAU ( 
  ...
  and2   g051(.a(x40), .b(x05), .O(new_n114_));
  inv1   g052(.a(x07), .O(new_n115_));
  nor2   g053(.a(x40), .b(new_n115_), .O(new_n116_));
  ...
  aoi21  g071(.a(new_n133_), .b(x40), .c(new_n130_), .O(z12));
  ...
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(x39), .O(new_n141_));
  ...
  nand2  g092(.a(new_n78_), .b(x39), .O(new_n155_));
