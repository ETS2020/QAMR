...
module FAU ( 
  ...
  nor2   g034(.a(new_n72_), .b(x21), .O(new_n97_));
  ...
  nand2  g054(.a(z08), .b(new_n82_), .O(new_n117_));
  oai21  g055(.a(new_n92_), .b(x28), .c(new_n76_), .O(new_n118_));
  ...
  nand3  g074(.a(new_n99_), .b(new_n68_), .c(new_n136_), .O(new_n137_));
  ...
  nand4  g083(.a(new_n145_), .b(new_n99_), .c(new_n144_), .d(x20), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand3  g086(.a(new_n141_), .b(z08), .c(new_n82_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand2  g088(.a(new_n141_), .b(z08), .O(new_n151_));
  nand2  g089(.a(new_n145_), .b(x20), .O(new_n152_));
  nand4  g090(.a(new_n139_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n151_), .c(new_n152_), .O(new_n155_));
  aoi21  g093(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n151_), .c(new_n63_), .d(new_n75_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n99_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  nor2   g097(.a(new_n115_), .b(new_n159_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g100(.a(x23), .O(new_n163_));
  nor2   g101(.a(x24), .b(new_n163_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n99_), .c(x22), .d(x01), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z17));
  nand2  g104(.a(new_n131_), .b(new_n130_), .O(new_n167_));
  inv1   g105(.a(new_n134_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n167_), .O(z18));
  oai21  g107(.a(new_n92_), .b(new_n75_), .c(new_n133_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n130_), .c(new_n99_), .O(z20));
  aoi21  g109(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z19));
endmodule
