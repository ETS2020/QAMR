...
module FAU ( 
  ...
  oai21  g031(.a(new_n93_), .b(new_n84_), .c(new_n85_), .O(z02));
  nand2  g032(.a(x35), .b(x28), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x37), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n75_), .c(new_n72_), .O(new_n98_));
  ...
  nand2  g039(.a(new_n84_), .b(x12), .O(new_n102_));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n102_), .c(new_n97_), .O(z05));
  ...
  nand2  g057(.a(new_n102_), .b(x11), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n119_), .O(z09));
  nand2  g059(.a(z08), .b(x05), .O(new_n122_));
  nand3  g060(.a(new_n117_), .b(new_n102_), .c(x07), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  aoi21  g062(.a(new_n78_), .b(new_n76_), .c(x04), .O(new_n125_));
  nand2  g063(.a(x37), .b(x06), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(new_n72_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n124_), .c(new_n127_), .O(new_n128_));
  nand4  g066(.a(z08), .b(new_n81_), .c(x05), .d(new_n63_), .O(new_n129_));
  oai21  g067(.a(new_n128_), .b(new_n75_), .c(new_n129_), .O(z10));
  nor2   g068(.a(x30), .b(x09), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x29), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x27), .c(x04), .O(new_n133_));
  nand2  g071(.a(new_n132_), .b(new_n78_), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n77_), .c(x27), .d(new_n63_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n86_), .O(new_n136_));
  ...
  nand2  g077(.a(new_n66_), .b(new_n97_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x27), .c(x10), .O(new_n141_));
  nand2  g079(.a(new_n95_), .b(new_n97_), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(x27), .c(x39), .d(new_n63_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n141_), .c(x40), .O(new_n144_));
  nand2  g082(.a(new_n142_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n84_), .c(new_n71_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n144_), .O(z12));
  aoi21  g085(.a(x36), .b(x35), .c(new_n77_), .O(new_n148_));
  inv1   g086(.a(x13), .O(new_n149_));
  nand3  g087(.a(z08), .b(new_n149_), .c(new_n63_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x20), .O(new_n152_));
  nand2  g090(.a(new_n102_), .b(new_n142_), .O(new_n153_));
  oai22  g091(.a(new_n153_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  inv1   g093(.a(new_n150_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n81_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand2  g096(.a(new_n148_), .b(new_n80_), .O(new_n159_));
  ...
  oai21  g100(.a(new_n162_), .b(new_n150_), .c(new_n145_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n102_), .O(z14));
  aoi21  g102(.a(new_n119_), .b(x40), .c(new_n71_), .O(z15));
  ...
  nand4  g108(.a(new_n170_), .b(new_n102_), .c(new_n169_), .d(x23), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z17));
  aoi21  g110(.a(new_n75_), .b(new_n86_), .c(new_n78_), .O(new_n173_));
  inv1   g111(.a(new_n131_), .O(new_n174_));
  nand2  g112(.a(x27), .b(x04), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n173_), .c(new_n174_), .O(new_n176_));
  oai22  g114(.a(new_n176_), .b(new_n72_), .c(new_n117_), .d(new_n90_), .O(z18));
  aoi21  g115(.a(new_n132_), .b(new_n78_), .c(new_n86_), .O(new_n178_));
  nand2  g116(.a(new_n132_), .b(x27), .O(new_n179_));
  nor2   g117(.a(new_n174_), .b(new_n72_), .O(new_n180_));
  ...
  nor2   g122(.a(new_n184_), .b(new_n178_), .O(z20));
endmodule
