...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x11), .O(new_n72_));
  ...
  nand4  g028(.a(new_n90_), .b(new_n87_), .c(new_n85_), .d(new_n84_), .O(z02));
  ...
  nand3  g035(.a(new_n95_), .b(new_n85_), .c(new_n97_), .O(z04));
  nand2  g036(.a(new_n94_), .b(new_n93_), .O(new_n99_));
  inv1   g037(.a(new_n99_), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n85_), .O(z05));
  nand2  g039(.a(new_n99_), .b(new_n85_), .O(z06));
  ...
  nand2  g051(.a(new_n85_), .b(new_n83_), .O(z08));
  and2   g052(.a(x34), .b(x27), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x26), .c(x11), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n85_), .O(z09));
  nand3  g055(.a(x40), .b(x39), .c(x05), .O(new_n118_));
  nand2  g056(.a(new_n83_), .b(x07), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n78_), .c(x27), .O(new_n121_));
  inv1   g059(.a(new_n80_), .O(new_n122_));
  ...
  inv1   g071(.a(new_n77_), .O(new_n134_));
  inv1   g072(.a(x27), .O(new_n135_));
  nor2   g073(.a(new_n135_), .b(x04), .O(new_n136_));
  or2    g074(.a(x30), .b(x09), .O(new_n137_));
  aoi21  g075(.a(new_n136_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n85_), .O(z11));
  nand2  g078(.a(new_n85_), .b(new_n69_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z12));
  aoi21  g080(.a(x36), .b(x35), .c(new_n76_), .O(new_n143_));
  inv1   g081(.a(x13), .O(new_n144_));
  nand3  g082(.a(new_n84_), .b(new_n144_), .c(new_n63_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x20), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n66_), .c(new_n145_), .d(new_n143_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  inv1   g087(.a(new_n145_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n122_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n149_), .c(new_n72_), .O(z13));
  nand2  g090(.a(new_n143_), .b(new_n80_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n147_), .O(new_n155_));
  aoi21  g093(.a(new_n76_), .b(x27), .c(new_n122_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n145_), .c(new_n66_), .d(new_n135_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n85_), .O(z14));
  nand4  g096(.a(new_n115_), .b(new_n85_), .c(x26), .d(x12), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z15));
  nand3  g098(.a(x22), .b(x11), .c(x01), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x23), .O(z16));
  inv1   g100(.a(x23), .O(new_n163_));
  nor3   g101(.a(new_n161_), .b(x24), .c(new_n163_), .O(z17));
  nand3  g102(.a(new_n138_), .b(new_n133_), .c(new_n85_), .O(z18));
  inv1   g103(.a(z18), .O(z19));
  nor2   g104(.a(new_n92_), .b(new_n135_), .O(new_n167_));
  nor4   g105(.a(new_n167_), .b(new_n137_), .c(new_n131_), .d(new_n72_), .O(z20));
endmodule
