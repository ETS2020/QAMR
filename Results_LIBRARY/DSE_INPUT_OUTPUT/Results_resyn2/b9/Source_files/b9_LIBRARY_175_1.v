...
module FAU ( 
  ...
  nand4  g031(.a(new_n93_), .b(new_n90_), .c(new_n75_), .d(new_n82_), .O(z02));
  aoi21  g032(.a(new_n68_), .b(x27), .c(new_n64_), .O(new_n95_));
  ...
  inv1   g050(.a(new_n75_), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n82_), .O(z08));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n82_), .c(x11), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z09));
  nor2   g056(.a(new_n84_), .b(new_n66_), .O(new_n119_));
  nand2  g057(.a(new_n75_), .b(x05), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(new_n121_));
  inv1   g059(.a(x07), .O(new_n122_));
  nor2   g060(.a(new_n75_), .b(new_n122_), .O(new_n123_));
  aoi22  g061(.a(new_n123_), .b(new_n119_), .c(new_n121_), .d(new_n86_), .O(new_n124_));
  ...
  nand4  g071(.a(x35), .b(new_n83_), .c(x27), .d(new_n71_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n82_), .O(new_n136_));
  ...
  nand3  g078(.a(new_n78_), .b(new_n140_), .c(new_n82_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z12));
  oai21  g080(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n143_));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n75_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n69_), .c(x20), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n66_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  nand2  g087(.a(new_n144_), .b(new_n75_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n85_), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n64_), .O(z13));
  nor3   g091(.a(new_n151_), .b(new_n148_), .c(new_n64_), .O(z14));
  nand3  g092(.a(new_n116_), .b(new_n82_), .c(x12), .O(new_n155_));
  ...
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n82_), .O(z17));
  nor2   g099(.a(new_n72_), .b(new_n66_), .O(new_n162_));
