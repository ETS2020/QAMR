...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x00), .O(new_n72_));
  ...
  nor2   g022(.a(new_n72_), .b(new_n84_), .O(z08));
  ...
  nand2  g037(.a(new_n99_), .b(new_n96_), .O(z05));
  nand2  g038(.a(new_n98_), .b(new_n96_), .O(z06));
  ...
  nand2  g049(.a(new_n111_), .b(new_n96_), .O(z07));
  ...
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n96_), .O(z10));
  ...
  aoi21  g075(.a(new_n134_), .b(new_n132_), .c(new_n137_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n131_), .c(new_n72_), .O(z18));
  inv1   g077(.a(z18), .O(z11));
  nand2  g078(.a(new_n68_), .b(x27), .O(new_n141_));
  nand2  g079(.a(new_n65_), .b(x10), .O(new_n142_));
  nand3  g080(.a(new_n96_), .b(new_n142_), .c(new_n141_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z12));
  nand2  g082(.a(x35), .b(x28), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n91_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(x20), .O(new_n148_));
  nor2   g086(.a(x13), .b(x04), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n116_), .c(new_n76_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n148_), .c(new_n133_), .O(new_n151_));
  nand2  g089(.a(new_n149_), .b(new_n116_), .O(new_n152_));
  nor2   g090(.a(new_n152_), .b(new_n75_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n96_), .O(new_n154_));
  nand2  g092(.a(x35), .b(x27), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  inv1   g094(.a(x00), .O(new_n157_));
  nor2   g095(.a(x13), .b(new_n157_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n156_), .c(new_n65_), .d(x36), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n154_), .O(z13));
  aoi21  g098(.a(x36), .b(x35), .c(new_n76_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n152_), .c(new_n148_), .O(new_n162_));
  oai21  g100(.a(new_n152_), .b(new_n75_), .c(new_n96_), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(x27), .c(new_n163_), .O(z14));
  inv1   g102(.a(x12), .O(new_n165_));
  oai21  g103(.a(new_n114_), .b(new_n165_), .c(new_n96_), .O(z15));
  nand2  g104(.a(x22), .b(x01), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(x23), .c(new_n96_), .O(z16));
  inv1   g106(.a(x24), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x23), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n167_), .c(new_n96_), .O(z17));
  nand3  g109(.a(new_n138_), .b(new_n131_), .c(new_n96_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z19));
  nand3  g111(.a(new_n155_), .b(new_n136_), .c(new_n135_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n129_), .c(new_n96_), .O(z20));
endmodule
