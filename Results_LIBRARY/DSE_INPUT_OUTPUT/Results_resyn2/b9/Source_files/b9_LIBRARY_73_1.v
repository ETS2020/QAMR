...
module FAU ( 
  ...
  inv1   g012(.a(x23), .O(new_n75_));
  nand2  g013(.a(x26), .b(new_n75_), .O(new_n76_));
  ...
  aoi21  g055(.a(new_n117_), .b(x23), .c(new_n116_), .O(z09));
  ...
  inv1   g061(.a(new_n120_), .O(new_n124_));
  ...
  aoi21  g066(.a(new_n128_), .b(new_n127_), .c(new_n86_), .O(z10));
  inv1   g067(.a(x08), .O(new_n130_));
  nand2  g068(.a(new_n71_), .b(x29), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n81_), .c(new_n130_), .O(new_n132_));
  nand2  g070(.a(new_n131_), .b(x27), .O(new_n133_));
  nand4  g071(.a(x35), .b(new_n80_), .c(x27), .d(new_n66_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n76_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  aoi21  g076(.a(new_n133_), .b(new_n132_), .c(new_n138_), .O(z11));
  nand2  g077(.a(new_n76_), .b(new_n73_), .O(z12));
  aoi21  g078(.a(x36), .b(x35), .c(new_n80_), .O(new_n141_));
  inv1   g079(.a(x13), .O(new_n142_));
  nand3  g080(.a(new_n71_), .b(new_n142_), .c(new_n66_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x20), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n64_), .c(new_n143_), .d(new_n141_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  inv1   g085(.a(new_n143_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n85_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n147_), .c(new_n86_), .O(z13));
  nand3  g088(.a(new_n141_), .b(new_n84_), .c(new_n83_), .O(new_n151_));
  ...
  oai22  g092(.a(new_n154_), .b(new_n143_), .c(new_n64_), .d(new_n78_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(new_n76_), .O(z14));
  nand2  g094(.a(x23), .b(x12), .O(new_n157_));
  nand3  g095(.a(x34), .b(x27), .c(x26), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(new_n157_), .O(z15));
  nand4  g097(.a(new_n116_), .b(new_n75_), .c(x22), .d(x01), .O(new_n160_));
  ...
  and2   g103(.a(x35), .b(x27), .O(new_n166_));
  nor3   g104(.a(new_n166_), .b(new_n136_), .c(new_n132_), .O(z20));
  aoi21  g105(.a(new_n133_), .b(new_n132_), .c(new_n138_), .O(z19));
endmodule
