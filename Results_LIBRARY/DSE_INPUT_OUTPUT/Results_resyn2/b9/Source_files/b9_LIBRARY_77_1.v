...
module FAU ( 
  ...
  and2   g044(.a(x25), .b(x14), .O(new_n107_));
  oai21  g045(.a(x25), .b(x00), .c(x10), .O(new_n108_));
  oai21  g046(.a(new_n108_), .b(new_n107_), .c(x38), .O(new_n109_));
  ...
  aoi21  g056(.a(new_n83_), .b(new_n82_), .c(new_n89_), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(new_n89_), .b(new_n120_), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(new_n81_), .c(new_n119_), .O(new_n122_));
  oai21  g060(.a(new_n89_), .b(x05), .c(new_n65_), .O(new_n123_));
  ...
  nand3  g078(.a(new_n102_), .b(new_n69_), .c(new_n140_), .O(new_n141_));
  ...
  aoi21  g092(.a(new_n150_), .b(new_n147_), .c(new_n77_), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n154_), .c(new_n74_), .O(z14));
  inv1   g094(.a(x12), .O(new_n157_));
  oai21  g095(.a(new_n117_), .b(new_n157_), .c(new_n102_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n74_), .c(x23), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n102_), .O(z17));
  nand3  g101(.a(new_n137_), .b(new_n132_), .c(new_n102_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n82_), .c(new_n135_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n130_), .c(new_n102_), .O(z20));
endmodule
