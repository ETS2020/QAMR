...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n94_, new_n95_, new_n96_, new_n97_, new_n99_, new_n103_, new_n104_,
    ...
    new_n157_, new_n158_, new_n159_, new_n162_, new_n163_;
  ...
  nor2   g009(.a(x17), .b(x03), .O(new_n72_));
  ...
  aoi21  g035(.a(new_n97_), .b(x21), .c(new_n72_), .O(z03));
  inv1   g036(.a(x21), .O(new_n99_));
  aoi21  g037(.a(new_n97_), .b(new_n99_), .c(new_n72_), .O(z04));
  nand3  g038(.a(new_n96_), .b(new_n87_), .c(new_n95_), .O(z05));
  ...
  nand2  g051(.a(new_n87_), .b(new_n85_), .O(z08));
  nand4  g052(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n87_), .O(z09));
  aoi21  g054(.a(new_n81_), .b(new_n80_), .c(new_n85_), .O(new_n117_));
  ...
  oai21  g058(.a(new_n85_), .b(x05), .c(new_n65_), .O(new_n121_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n87_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand3  g076(.a(new_n87_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g081(.a(new_n76_), .b(new_n94_), .c(x28), .O(new_n144_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n87_), .O(z13));
  nand2  g088(.a(new_n149_), .b(new_n87_), .O(new_n151_));
  aoi21  g089(.a(new_n147_), .b(x27), .c(new_n151_), .O(z14));
  nand4  g090(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n87_), .O(z15));
  nand2  g092(.a(x22), .b(x01), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g094(.a(x23), .O(new_n157_));
  nor2   g095(.a(x24), .b(new_n157_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n87_), .c(x22), .d(x01), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z17));
  aoi21  g098(.a(new_n135_), .b(new_n130_), .c(new_n72_), .O(z18));
  nand2  g099(.a(x35), .b(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n80_), .c(new_n133_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n128_), .c(new_n87_), .O(z20));
