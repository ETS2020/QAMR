...
module FAU ( 
  ...
  aoi21  g020(.a(new_n82_), .b(new_n63_), .c(new_n66_), .O(new_n83_));
  ...
  nand2  g051(.a(new_n74_), .b(new_n99_), .O(z08));
  ...
  nand2  g056(.a(new_n74_), .b(x07), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nor2   g058(.a(new_n118_), .b(new_n84_), .O(new_n121_));
  aoi21  g059(.a(new_n120_), .b(new_n83_), .c(new_n121_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n142_), .c(new_n99_), .O(z12));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n85_), .c(new_n64_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(z13));
  nand2  g093(.a(new_n148_), .b(new_n84_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n150_), .O(new_n158_));
  aoi21  g096(.a(new_n81_), .b(x27), .c(new_n85_), .O(new_n159_));
  ...
  oai21  g100(.a(new_n116_), .b(new_n162_), .c(new_n99_), .O(z15));
  nand2  g101(.a(x22), .b(x01), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(x23), .c(new_n99_), .O(z16));
  inv1   g103(.a(x24), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x23), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n164_), .c(new_n99_), .O(z17));
  aoi21  g106(.a(new_n137_), .b(new_n131_), .c(new_n64_), .O(z18));
  nor2   g107(.a(new_n136_), .b(new_n64_), .O(new_n170_));
  oai21  g108(.a(new_n76_), .b(new_n66_), .c(new_n170_), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(new_n129_), .O(z20));
  nand2  g110(.a(new_n138_), .b(new_n99_), .O(z19));
endmodule
