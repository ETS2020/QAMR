...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n158_, new_n160_, new_n162_, new_n163_;
  nor2   g000(.a(x36), .b(x23), .O(new_n63_));
  ...
  aoi21  g010(.a(x35), .b(x23), .c(x36), .O(new_n73_));
  ...
  nand3  g048(.a(new_n110_), .b(new_n86_), .c(x03), .O(new_n111_));
  nor2   g049(.a(new_n111_), .b(new_n106_), .O(z07));
  nand2  g050(.a(new_n72_), .b(new_n86_), .O(z08));
  inv1   g051(.a(x11), .O(new_n114_));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  nor3   g053(.a(new_n115_), .b(new_n63_), .c(new_n114_), .O(z09));
  nor2   g054(.a(new_n72_), .b(x04), .O(new_n117_));
  nand3  g055(.a(new_n83_), .b(new_n117_), .c(x05), .O(new_n118_));
  nand3  g056(.a(x37), .b(x27), .c(x06), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n86_), .O(new_n121_));
  inv1   g059(.a(new_n80_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(x23), .c(x36), .O(new_n123_));
  inv1   g061(.a(x07), .O(new_n124_));
  nand2  g062(.a(new_n72_), .b(new_n124_), .O(new_n125_));
  inv1   g063(.a(x05), .O(new_n126_));
  aoi21  g064(.a(new_n87_), .b(new_n126_), .c(new_n74_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n123_), .c(new_n121_), .O(z10));
  ...
  inv1   g072(.a(new_n74_), .O(new_n135_));
  or2    g073(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g074(.a(new_n122_), .b(new_n135_), .c(new_n136_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n134_), .c(new_n86_), .O(z18));
  inv1   g076(.a(z18), .O(z11));
  aoi21  g077(.a(new_n70_), .b(new_n86_), .c(new_n75_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  oai21  g079(.a(new_n78_), .b(new_n94_), .c(x28), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n117_), .c(new_n141_), .O(new_n143_));
  ...
  nand3  g086(.a(new_n83_), .b(new_n117_), .c(new_n141_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n86_), .O(z13));
  nand2  g088(.a(new_n149_), .b(new_n86_), .O(new_n151_));
  aoi21  g089(.a(new_n147_), .b(x27), .c(new_n151_), .O(z14));
  inv1   g090(.a(x12), .O(new_n153_));
  oai21  g091(.a(new_n115_), .b(new_n153_), .c(new_n86_), .O(z15));
  nand2  g092(.a(x22), .b(x01), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x36), .c(x23), .O(z16));
  inv1   g094(.a(x24), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x23), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n155_), .c(new_n86_), .O(z17));
  nand2  g097(.a(new_n137_), .b(new_n134_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n86_), .O(z19));
  nor2   g099(.a(new_n136_), .b(new_n63_), .O(new_n162_));
  oai21  g100(.a(new_n94_), .b(new_n66_), .c(new_n162_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n132_), .O(z20));
endmodule
