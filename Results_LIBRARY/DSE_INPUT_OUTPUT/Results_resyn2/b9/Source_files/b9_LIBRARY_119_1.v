...
module FAU ( 
  ...
  nor2   g024(.a(new_n86_), .b(new_n71_), .O(z08));
  ...
  aoi21  g033(.a(new_n95_), .b(x21), .c(new_n81_), .O(z03));
  inv1   g034(.a(x21), .O(new_n97_));
  nand3  g035(.a(new_n95_), .b(new_n72_), .c(new_n97_), .O(z04));
  ...
  nand3  g051(.a(new_n113_), .b(new_n72_), .c(x11), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z09));
  nand2  g053(.a(new_n80_), .b(x40), .O(new_n116_));
  oai21  g054(.a(new_n92_), .b(x28), .c(new_n76_), .O(new_n117_));
  ...
  nor2   g072(.a(new_n66_), .b(new_n75_), .O(new_n135_));
  inv1   g073(.a(x10), .O(new_n136_));
  oai21  g074(.a(new_n63_), .b(new_n75_), .c(new_n136_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n64_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x39), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x40), .c(new_n135_), .O(z12));
  nand2  g078(.a(x35), .b(x28), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n93_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n72_), .c(new_n142_), .d(x20), .O(new_n144_));
  oai21  g082(.a(new_n76_), .b(new_n92_), .c(x28), .O(new_n145_));
  ...
  nand4  g087(.a(new_n146_), .b(new_n80_), .c(x40), .d(x39), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z13));
  inv1   g089(.a(new_n145_), .O(new_n152_));
  nand2  g090(.a(new_n93_), .b(new_n92_), .O(new_n153_));
  ...
  oai21  g094(.a(new_n144_), .b(new_n75_), .c(new_n156_), .O(new_n157_));
  oai21  g095(.a(new_n155_), .b(new_n80_), .c(new_n157_), .O(z14));
  nand3  g096(.a(new_n113_), .b(new_n72_), .c(x12), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z15));
  inv1   g098(.a(x01), .O(new_n161_));
  inv1   g099(.a(x22), .O(new_n162_));
  nor4   g100(.a(new_n81_), .b(x23), .c(new_n162_), .d(new_n161_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  nor2   g102(.a(new_n162_), .b(new_n161_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n72_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  inv1   g105(.a(z11), .O(z18));
  oai21  g106(.a(new_n92_), .b(new_n75_), .c(new_n132_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n129_), .c(new_n72_), .O(z20));
  aoi21  g108(.a(new_n130_), .b(new_n129_), .c(new_n133_), .O(z19));
endmodule
