...
module FAU ( 
  ...
  inv1   g36(.a(x11), .O(new_n99_));
  nand4  g37(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n100_));
  nor2   g38(.a(new_n100_), .b(new_n99_), .O(z09));
  nand2  g39(.a(z02), .b(x27), .O(new_n102_));
  nand2  g40(.a(x37), .b(x06), .O(new_n103_));
  inv1   g41(.a(x04), .O(new_n104_));
  nand3  g42(.a(new_n74_), .b(x07), .c(new_n104_), .O(new_n105_));
  aoi21  g43(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(z10));
  nor2   g44(.a(x30), .b(x09), .O(new_n107_));
  inv1   g45(.a(x28), .O(new_n108_));
  inv1   g46(.a(x08), .O(new_n109_));
  nand2  g47(.a(new_n64_), .b(new_n109_), .O(new_n110_));
  nand2  g48(.a(x27), .b(x04), .O(new_n111_));
  nand4  g49(.a(new_n111_), .b(new_n110_), .c(x35), .d(new_n108_), .O(new_n112_));
  aoi21  g50(.a(new_n112_), .b(new_n107_), .c(z08), .O(z18));
  inv1   g51(.a(z18), .O(z11));
  nor2   g52(.a(z08), .b(new_n67_), .O(z12));
  nor2   g53(.a(x19), .b(x18), .O(new_n116_));
  nand3  g54(.a(new_n116_), .b(new_n67_), .c(x20), .O(new_n117_));
  nor2   g55(.a(new_n117_), .b(z08), .O(z13));
  and2   g56(.a(new_n117_), .b(z02), .O(z14));
  inv1   g57(.a(x12), .O(new_n120_));
  nor2   g58(.a(new_n100_), .b(new_n120_), .O(z15));
  nand2  g59(.a(x22), .b(x01), .O(new_n122_));
  oai21  g60(.a(new_n122_), .b(x23), .c(z02), .O(z16));
  inv1   g61(.a(x23), .O(new_n124_));
  nor4   g62(.a(new_n122_), .b(z08), .c(x24), .d(new_n124_), .O(z17));
  aoi21  g63(.a(new_n108_), .b(x08), .c(x27), .O(new_n126_));
  oai21  g64(.a(new_n126_), .b(new_n72_), .c(new_n107_), .O(new_n127_));
  nand2  g65(.a(new_n127_), .b(z02), .O(z20));
  inv1   g66(.a(z18), .O(z19));
endmodule
