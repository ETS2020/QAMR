...
module FAU ( 
  ...
  oai21  g013(.a(new_n74_), .b(x20), .c(new_n75_), .O(new_n76_));
  nor2   g014(.a(new_n67_), .b(x04), .O(new_n77_));
  nand4  g015(.a(new_n77_), .b(new_n76_), .c(new_n73_), .d(new_n65_), .O(new_n78_));
  oai21  g016(.a(new_n72_), .b(new_n64_), .c(new_n78_), .O(z00));
  inv1   g017(.a(x28), .O(new_n80_));
  nand2  g018(.a(x35), .b(new_n80_), .O(new_n81_));
  aoi21  g019(.a(new_n81_), .b(new_n75_), .c(new_n67_), .O(new_n82_));
  nor2   g020(.a(x32), .b(x30), .O(new_n83_));
  inv1   g021(.a(new_n83_), .O(new_n84_));
  nor2   g022(.a(new_n64_), .b(new_n69_), .O(new_n85_));
  ...
  oai21  g030(.a(new_n74_), .b(new_n80_), .c(x27), .O(new_n93_));
  nor2   g031(.a(x37), .b(x27), .O(new_n94_));
  nor2   g032(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  ...
  nand2  g055(.a(new_n117_), .b(new_n103_), .O(z09));
  nand3  g056(.a(x37), .b(x27), .c(x06), .O(new_n119_));
  nor2   g057(.a(new_n89_), .b(x04), .O(new_n120_));
  nand3  g058(.a(new_n84_), .b(new_n120_), .c(x05), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n103_), .O(new_n123_));
  oai21  g061(.a(new_n81_), .b(x20), .c(new_n75_), .O(new_n124_));
  inv1   g062(.a(x07), .O(new_n125_));
  nand2  g063(.a(new_n89_), .b(new_n125_), .O(new_n126_));
  inv1   g064(.a(x05), .O(new_n127_));
  nand2  g065(.a(new_n73_), .b(new_n127_), .O(new_n128_));
  nand4  g066(.a(new_n128_), .b(new_n126_), .c(new_n124_), .d(new_n77_), .O(new_n129_));
  ...
  aoi21  g077(.a(new_n136_), .b(new_n77_), .c(new_n139_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n135_), .c(new_n64_), .O(z18));
  ...
  nand2  g083(.a(new_n70_), .b(new_n103_), .O(new_n146_));
  aoi21  g084(.a(new_n145_), .b(x27), .c(new_n146_), .O(z12));
  oai21  g085(.a(x28), .b(new_n67_), .c(new_n83_), .O(new_n148_));
  nor2   g086(.a(new_n74_), .b(new_n67_), .O(new_n149_));
  aoi22  g087(.a(new_n149_), .b(x36), .c(new_n148_), .d(new_n103_), .O(new_n150_));
  inv1   g088(.a(x13), .O(new_n151_));
  nand3  g089(.a(new_n73_), .b(new_n151_), .c(new_n69_), .O(new_n152_));
  nor2   g090(.a(new_n68_), .b(new_n67_), .O(new_n153_));
  ...
  nand3  g095(.a(new_n157_), .b(new_n153_), .c(x36), .O(new_n158_));
  oai21  g096(.a(new_n152_), .b(new_n150_), .c(new_n158_), .O(z13));
  inv1   g097(.a(x32), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n138_), .c(x28), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n157_), .c(x37), .O(new_n162_));
  inv1   g100(.a(new_n152_), .O(new_n163_));
  nand2  g101(.a(new_n161_), .b(new_n163_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(new_n74_), .O(new_n165_));
  oai21  g103(.a(x37), .b(x28), .c(x27), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n156_), .c(new_n152_), .O(new_n167_));
  nand2  g105(.a(new_n161_), .b(new_n63_), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n75_), .c(new_n83_), .d(new_n67_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n167_), .c(new_n165_), .O(z14));
  nand4  g108(.a(new_n116_), .b(new_n103_), .c(x26), .d(x12), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z15));
  nand2  g110(.a(x22), .b(x01), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(x23), .c(new_n103_), .O(z16));
  inv1   g112(.a(x24), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x23), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n173_), .c(new_n103_), .O(z17));
  or2    g115(.a(new_n149_), .b(new_n139_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n133_), .c(new_n103_), .O(z20));
