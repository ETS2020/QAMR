...
module FAU ( 
  ...
  nand4  g30(.a(new_n92_), .b(new_n89_), .c(new_n74_), .d(new_n81_), .O(z02));
  ...
  nor2   g37(.a(new_n99_), .b(new_n63_), .O(z05));
  ...
  inv1   g49(.a(new_n111_), .O(z07));
  inv1   g50(.a(new_n74_), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(new_n81_), .O(z08));
  inv1   g52(.a(x11), .O(new_n115_));
  nand4  g53(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g54(.a(new_n116_), .b(new_n115_), .O(z09));
  nor2   g55(.a(new_n83_), .b(new_n65_), .O(new_n118_));
  nand2  g56(.a(new_n74_), .b(x05), .O(new_n119_));
  inv1   g57(.a(new_n119_), .O(new_n120_));
  inv1   g58(.a(x07), .O(new_n121_));
  nor2   g59(.a(new_n74_), .b(new_n121_), .O(new_n122_));
  aoi22  g60(.a(new_n122_), .b(new_n118_), .c(new_n120_), .d(new_n85_), .O(new_n123_));
  nand3  g61(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  inv1   g62(.a(new_n124_), .O(new_n125_));
  nor2   g63(.a(new_n125_), .b(new_n63_), .O(new_n126_));
  oai21  g64(.a(new_n123_), .b(x04), .c(new_n126_), .O(z10));
  inv1   g65(.a(x08), .O(new_n128_));
  nand2  g66(.a(new_n74_), .b(x29), .O(new_n129_));
  aoi21  g67(.a(new_n129_), .b(new_n87_), .c(new_n128_), .O(new_n130_));
  nand2  g68(.a(new_n129_), .b(x27), .O(new_n131_));
  nand4  g69(.a(x35), .b(new_n82_), .c(x27), .d(new_n70_), .O(new_n132_));
  nor3   g70(.a(new_n63_), .b(x30), .c(x09), .O(new_n133_));
  ...
  nand3  g74(.a(new_n77_), .b(new_n136_), .c(new_n81_), .O(new_n137_));
  ...
  nor2   g89(.a(new_n116_), .b(new_n151_), .O(z15));
  ...
  oai21  g94(.a(new_n156_), .b(new_n153_), .c(new_n81_), .O(z17));
  inv1   g95(.a(z11), .O(z18));
  oai21  g96(.a(new_n71_), .b(new_n65_), .c(new_n133_), .O(new_n159_));
  nor2   g97(.a(new_n159_), .b(new_n130_), .O(z20));
  aoi21  g98(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z19));
endmodule
