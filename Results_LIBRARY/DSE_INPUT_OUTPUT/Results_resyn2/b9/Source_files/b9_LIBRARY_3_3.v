...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n166_, new_n168_, new_n170_, new_n173_;
  ...
  aoi21  g033(.a(new_n95_), .b(new_n94_), .c(new_n74_), .O(new_n96_));
  ...
  nor2   g046(.a(new_n72_), .b(x15), .O(new_n109_));
  inv1   g047(.a(x31), .O(new_n110_));
  nand2  g048(.a(new_n73_), .b(new_n110_), .O(new_n111_));
  ...
  nor2   g076(.a(new_n77_), .b(new_n94_), .O(new_n139_));
  ...
  nand3  g093(.a(new_n149_), .b(new_n120_), .c(new_n119_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n155_), .c(new_n74_), .O(z13));
  inv1   g095(.a(new_n156_), .O(new_n158_));
  nand3  g096(.a(new_n149_), .b(new_n119_), .c(new_n84_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n63_), .c(new_n94_), .O(new_n160_));
  nand2  g098(.a(new_n152_), .b(x20), .O(new_n161_));
  nand3  g099(.a(new_n147_), .b(new_n81_), .c(x28), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n149_), .c(new_n119_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n161_), .c(new_n74_), .O(new_n164_));
  oai21  g102(.a(new_n160_), .b(new_n158_), .c(new_n164_), .O(z14));
  inv1   g103(.a(x12), .O(new_n166_));
  oai21  g104(.a(new_n117_), .b(new_n166_), .c(new_n100_), .O(z15));
  nand2  g105(.a(x22), .b(x01), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(x23), .c(new_n100_), .O(z16));
  inv1   g107(.a(x23), .O(new_n170_));
  nor4   g108(.a(new_n168_), .b(new_n74_), .c(x24), .d(new_n170_), .O(z17));
  aoi21  g109(.a(new_n141_), .b(new_n135_), .c(new_n74_), .O(z18));
  nand3  g110(.a(new_n100_), .b(new_n137_), .c(new_n136_), .O(new_n173_));
  nor3   g111(.a(new_n173_), .b(new_n139_), .c(new_n133_), .O(z20));
  nand2  g112(.a(new_n142_), .b(new_n100_), .O(z19));
endmodule
