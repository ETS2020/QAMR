...
module FAU ( 
  ...
  oai21  g012(.a(new_n74_), .b(new_n68_), .c(new_n73_), .O(new_n75_));
  and2   g013(.a(x40), .b(x39), .O(z08));
  nand4  g014(.a(z08), .b(new_n75_), .c(new_n66_), .d(new_n72_), .O(new_n77_));
  ...
  and2   g039(.a(new_n100_), .b(new_n64_), .O(z06));
  ...
  oai21  g053(.a(new_n95_), .b(new_n68_), .c(x40), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(x06), .O(new_n117_));
  inv1   g055(.a(x36), .O(new_n118_));
  aoi21  g056(.a(new_n86_), .b(new_n118_), .c(new_n68_), .O(new_n119_));
  nand3  g057(.a(x40), .b(x39), .c(x05), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n82_), .O(new_n121_));
  inv1   g059(.a(x05), .O(new_n122_));
  aoi21  g060(.a(x40), .b(x39), .c(x07), .O(new_n123_));
  aoi21  g061(.a(z08), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n119_), .c(new_n121_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(x04), .c(new_n117_), .O(z10));
  inv1   g064(.a(x08), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n86_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nor2   g069(.a(x30), .b(x09), .O(new_n132_));
  nand3  g070(.a(new_n80_), .b(x27), .c(new_n72_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n64_), .O(z11));
  nand3  g073(.a(x40), .b(x39), .c(new_n72_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n74_), .c(new_n69_), .O(new_n137_));
  nor2   g075(.a(new_n89_), .b(x04), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x10), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n64_), .O(new_n140_));
  aoi21  g078(.a(new_n137_), .b(x27), .c(new_n140_), .O(z12));
  inv1   g079(.a(x13), .O(new_n142_));
  nand2  g080(.a(x36), .b(x35), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x28), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n138_), .c(new_n142_), .O(new_n145_));
  nand2  g083(.a(new_n93_), .b(new_n95_), .O(new_n146_));
  ...
  inv1   g088(.a(new_n82_), .O(new_n151_));
  nand3  g089(.a(new_n138_), .b(new_n151_), .c(new_n142_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z13));
  nand2  g091(.a(new_n138_), .b(new_n142_), .O(new_n154_));
  nand2  g092(.a(new_n147_), .b(x20), .O(new_n155_));
  nand3  g093(.a(new_n143_), .b(new_n82_), .c(x28), .O(new_n156_));
  ...
  aoi21  g097(.a(new_n85_), .b(x27), .c(new_n151_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n154_), .c(new_n159_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n158_), .c(new_n64_), .O(z14));
  nand4  g100(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n64_), .O(z15));
  nand2  g102(.a(x22), .b(x01), .O(new_n165_));
  nor3   g103(.a(new_n165_), .b(new_n65_), .c(x23), .O(z16));
  inv1   g104(.a(x24), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x23), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n165_), .c(new_n64_), .O(z17));
  nand4  g107(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n64_), .O(z18));
  oai21  g108(.a(new_n79_), .b(new_n68_), .c(new_n132_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n129_), .c(new_n64_), .O(z20));
  nand2  g110(.a(new_n134_), .b(new_n64_), .O(z19));
endmodule
