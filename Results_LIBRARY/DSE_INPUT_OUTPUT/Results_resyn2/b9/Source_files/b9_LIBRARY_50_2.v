...
module FAU ( 
  ...
  oai22  g036(.a(new_n98_), .b(new_n91_), .c(new_n69_), .d(x27), .O(new_n99_));
  ...
  nand3  g040(.a(new_n98_), .b(new_n64_), .c(new_n69_), .O(z05));
  ...
  nand3  g055(.a(new_n117_), .b(new_n64_), .c(x11), .O(new_n118_));
  ...
  aoi21  g062(.a(new_n63_), .b(x39), .c(new_n124_), .O(new_n125_));
  aoi21  g063(.a(new_n123_), .b(new_n122_), .c(new_n125_), .O(new_n126_));
  inv1   g064(.a(new_n121_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n87_), .c(new_n73_), .O(new_n128_));
  oai21  g066(.a(new_n126_), .b(new_n68_), .c(new_n128_), .O(z10));
  nand2  g067(.a(x39), .b(x29), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n83_), .c(new_n93_), .O(new_n131_));
  nand2  g069(.a(new_n130_), .b(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  nand3  g072(.a(new_n92_), .b(x27), .c(new_n73_), .O(new_n135_));
  ...
  oai21  g080(.a(new_n81_), .b(new_n91_), .c(x28), .O(new_n143_));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n78_), .O(new_n145_));
  ...
  nand4  g089(.a(new_n87_), .b(new_n78_), .c(new_n151_), .d(new_n73_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z13));
  nand3  g091(.a(new_n147_), .b(new_n146_), .c(x20), .O(new_n154_));
  nand3  g092(.a(new_n144_), .b(new_n143_), .c(x39), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g094(.a(new_n87_), .b(new_n151_), .c(new_n73_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x40), .c(new_n77_), .O(new_n158_));
  aoi21  g096(.a(new_n156_), .b(x27), .c(new_n158_), .O(z14));
  nand3  g097(.a(new_n117_), .b(new_n64_), .c(x12), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z15));
  inv1   g099(.a(x01), .O(new_n162_));
  inv1   g100(.a(x22), .O(new_n163_));
  nor4   g101(.a(new_n65_), .b(x23), .c(new_n163_), .d(new_n162_), .O(z16));
  ...
  nand3  g107(.a(new_n169_), .b(new_n94_), .c(new_n92_), .O(new_n170_));
  oai21  g108(.a(new_n130_), .b(new_n93_), .c(new_n134_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n65_), .O(z18));
  oai21  g111(.a(new_n91_), .b(new_n68_), .c(new_n134_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n131_), .c(new_n64_), .O(z20));
  buf    g113(.a(x39), .O(z08));
  nand2  g114(.a(new_n136_), .b(new_n64_), .O(z19));
endmodule
