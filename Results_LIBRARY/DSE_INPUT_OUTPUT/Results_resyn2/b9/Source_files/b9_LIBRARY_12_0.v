...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n150_, new_n153_;
  nor2   g00(.a(x24), .b(x22), .O(new_n63_));
  ...
  oai21  g27(.a(new_n68_), .b(new_n78_), .c(x27), .O(new_n90_));
  nor2   g28(.a(x37), .b(x27), .O(new_n91_));
  nor2   g29(.a(new_n91_), .b(new_n63_), .O(new_n92_));
  nand3  g30(.a(new_n92_), .b(new_n90_), .c(x21), .O(z03));
  inv1   g31(.a(x21), .O(new_n94_));
  nand3  g32(.a(new_n92_), .b(new_n90_), .c(new_n94_), .O(z04));
  inv1   g33(.a(new_n63_), .O(new_n96_));
  aoi21  g34(.a(x28), .b(x27), .c(x37), .O(new_n97_));
  nand2  g35(.a(new_n97_), .b(new_n96_), .O(z05));
  inv1   g36(.a(new_n97_), .O(new_n99_));
  nand2  g37(.a(new_n99_), .b(new_n96_), .O(z06));
  ...
  nand2  g49(.a(new_n86_), .b(new_n96_), .O(z08));
  nand2  g50(.a(x34), .b(x27), .O(new_n113_));
  nand2  g51(.a(x26), .b(x11), .O(new_n114_));
  oai21  g52(.a(new_n114_), .b(new_n113_), .c(new_n96_), .O(z09));
  nor2   g53(.a(new_n79_), .b(new_n65_), .O(new_n116_));
  nand2  g54(.a(new_n71_), .b(x05), .O(new_n117_));
  inv1   g55(.a(new_n117_), .O(new_n118_));
  and2   g56(.a(new_n86_), .b(x07), .O(new_n119_));
  aoi22  g57(.a(new_n119_), .b(new_n116_), .c(new_n118_), .d(new_n81_), .O(new_n120_));
  nand3  g58(.a(x37), .b(x27), .c(x06), .O(new_n121_));
  inv1   g59(.a(new_n121_), .O(new_n122_));
  nor2   g60(.a(new_n122_), .b(new_n63_), .O(new_n123_));
  oai21  g61(.a(new_n120_), .b(x04), .c(new_n123_), .O(z10));
  inv1   g62(.a(x08), .O(new_n125_));
  nand2  g63(.a(new_n71_), .b(x29), .O(new_n126_));
  aoi21  g64(.a(new_n126_), .b(new_n83_), .c(new_n125_), .O(new_n127_));
  nand2  g65(.a(new_n126_), .b(x27), .O(new_n128_));
  nand4  g66(.a(x35), .b(new_n78_), .c(x27), .d(new_n67_), .O(new_n129_));
  nor2   g67(.a(x30), .b(x09), .O(new_n130_));
  nand3  g68(.a(new_n130_), .b(new_n129_), .c(new_n96_), .O(new_n131_));
  aoi21  g69(.a(new_n128_), .b(new_n127_), .c(new_n131_), .O(z11));
  inv1   g70(.a(new_n73_), .O(new_n133_));
  nand3  g71(.a(new_n74_), .b(new_n133_), .c(new_n96_), .O(new_n134_));
  inv1   g72(.a(new_n134_), .O(z12));
  nor2   g73(.a(x13), .b(x04), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(new_n71_), .O(new_n137_));
  aoi21  g75(.a(x36), .b(x35), .c(new_n78_), .O(new_n138_));
  nor2   g76(.a(x19), .b(x18), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x20), .O(new_n140_));
  oai22  g78(.a(new_n140_), .b(new_n66_), .c(new_n138_), .d(new_n137_), .O(new_n141_));
  oai21  g79(.a(new_n137_), .b(new_n80_), .c(new_n96_), .O(new_n142_));
  aoi21  g80(.a(new_n141_), .b(x27), .c(new_n142_), .O(z14));
  inv1   g81(.a(z14), .O(z13));
  nand2  g82(.a(x26), .b(x12), .O(new_n145_));
  nor3   g83(.a(new_n145_), .b(new_n113_), .c(new_n63_), .O(z15));
  ...
  oai21  g90(.a(new_n68_), .b(new_n65_), .c(new_n130_), .O(new_n153_));
  oai21  g91(.a(new_n153_), .b(new_n127_), .c(new_n96_), .O(z20));
  aoi21  g92(.a(new_n128_), .b(new_n127_), .c(new_n131_), .O(z19));
endmodule
