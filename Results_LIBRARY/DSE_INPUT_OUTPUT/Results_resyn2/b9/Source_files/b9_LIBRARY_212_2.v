...
module FAU ( 
  ...
  aoi21  g059(.a(new_n71_), .b(x39), .c(new_n121_), .O(new_n122_));
  ...
  aoi21  g078(.a(new_n140_), .b(x39), .c(new_n136_), .O(z12));
  ...
  nand2  g094(.a(new_n79_), .b(x40), .O(new_n157_));
  oai21  g095(.a(new_n147_), .b(new_n71_), .c(x39), .O(new_n158_));
