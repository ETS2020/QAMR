...
module FAU ( 
  ...
  aoi21  g030(.a(new_n92_), .b(x27), .c(new_n74_), .O(new_n93_));
  ...
  nand4  g047(.a(new_n109_), .b(new_n108_), .c(x14), .d(x03), .O(new_n110_));
  aoi21  g048(.a(new_n106_), .b(x38), .c(new_n110_), .O(z07));
  nor2   g049(.a(new_n74_), .b(new_n88_), .O(z08));
  nand3  g050(.a(x34), .b(x27), .c(x26), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(new_n114_));
  nand3  g052(.a(new_n114_), .b(new_n100_), .c(x11), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(z09));
  aoi21  g054(.a(new_n78_), .b(new_n77_), .c(new_n88_), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n88_), .b(new_n119_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n82_), .c(x27), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  inv1   g060(.a(x05), .O(new_n123_));
  aoi21  g061(.a(new_n68_), .b(new_n123_), .c(x04), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand3  g063(.a(x37), .b(x27), .c(x06), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n125_), .c(new_n100_), .O(z10));
  ...
  nor2   g071(.a(new_n94_), .b(x04), .O(new_n134_));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(new_n77_), .b(new_n135_), .O(new_n136_));
  aoi21  g074(.a(new_n134_), .b(new_n133_), .c(new_n136_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n132_), .c(new_n100_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n100_), .b(new_n69_), .c(new_n140_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z12));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n117_), .O(new_n144_));
  nand2  g082(.a(new_n92_), .b(new_n95_), .O(new_n145_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n144_), .c(new_n74_), .O(z13));
  inv1   g091(.a(new_n144_), .O(new_n154_));
  aoi21  g092(.a(new_n150_), .b(new_n147_), .c(new_n94_), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n154_), .c(new_n74_), .O(z14));
  nand3  g094(.a(new_n114_), .b(new_n100_), .c(x12), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n100_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n100_), .O(z17));
  aoi21  g101(.a(new_n137_), .b(new_n132_), .c(new_n74_), .O(z18));
  nand2  g102(.a(x35), .b(x27), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n100_), .c(new_n77_), .d(new_n135_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n130_), .O(z20));
  inv1   g105(.a(new_n138_), .O(z19));
endmodule
