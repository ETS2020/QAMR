...
module FAU ( 
  ...
  oai21  g037(.a(new_n78_), .b(new_n76_), .c(new_n95_), .O(new_n100_));
  and2   g038(.a(new_n100_), .b(new_n92_), .O(z05));
  ...
  nand2  g047(.a(new_n72_), .b(new_n71_), .O(new_n110_));
  ...
  nor2   g051(.a(new_n73_), .b(new_n88_), .O(z08));
  ...
  nand2  g077(.a(new_n92_), .b(new_n69_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  inv1   g079(.a(x13), .O(new_n142_));
  inv1   g080(.a(new_n88_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n63_), .O(new_n144_));
  aoi21  g082(.a(x36), .b(x35), .c(new_n78_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x20), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n66_), .c(new_n145_), .d(new_n144_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  inv1   g087(.a(new_n144_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n83_), .c(new_n73_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z13));
  nand3  g090(.a(new_n145_), .b(new_n82_), .c(new_n81_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n147_), .O(new_n155_));
  aoi21  g093(.a(new_n78_), .b(x27), .c(new_n83_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n144_), .c(new_n66_), .d(new_n76_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n92_), .O(z14));
  nand4  g096(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n92_), .O(z15));
  inv1   g098(.a(x23), .O(new_n161_));
  nand4  g099(.a(new_n92_), .b(new_n161_), .c(x22), .d(x01), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x23), .c(x22), .d(x01), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n92_), .O(z17));
  nand3  g104(.a(new_n137_), .b(new_n132_), .c(new_n92_), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z19));
  nor2   g106(.a(new_n93_), .b(new_n76_), .O(new_n169_));
  nor4   g107(.a(new_n169_), .b(new_n136_), .c(new_n130_), .d(new_n73_), .O(z20));
endmodule
