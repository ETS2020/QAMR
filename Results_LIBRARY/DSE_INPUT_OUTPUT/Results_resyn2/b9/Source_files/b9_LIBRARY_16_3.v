...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n168_, new_n171_, new_n173_, new_n174_;
  nand2  g000(.a(x36), .b(x03), .O(new_n63_));
  ...
  oai21  g031(.a(new_n76_), .b(new_n87_), .c(x27), .O(new_n94_));
  ...
  oai21  g037(.a(new_n87_), .b(new_n66_), .c(new_n95_), .O(new_n100_));
  ...
  nor2   g058(.a(new_n118_), .b(new_n82_), .O(new_n121_));
  aoi21  g059(.a(new_n120_), .b(new_n117_), .c(new_n121_), .O(new_n122_));
  ...
  aoi21  g072(.a(new_n83_), .b(new_n131_), .c(new_n134_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n63_), .O(new_n136_));
  ...
  oai21  g079(.a(new_n74_), .b(x04), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n140_), .c(new_n63_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand4  g082(.a(x40), .b(x39), .c(new_n144_), .d(new_n69_), .O(new_n145_));
  aoi21  g083(.a(x36), .b(x35), .c(new_n87_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x20), .O(new_n148_));
  oai22  g086(.a(new_n148_), .b(new_n67_), .c(new_n146_), .d(new_n145_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nor2   g088(.a(new_n145_), .b(new_n82_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(new_n64_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z13));
  inv1   g091(.a(new_n145_), .O(new_n154_));
  nand2  g092(.a(new_n146_), .b(new_n82_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n148_), .O(new_n157_));
  oai21  g095(.a(x28), .b(new_n66_), .c(new_n82_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n141_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n157_), .c(new_n63_), .O(z14));
  inv1   g099(.a(x12), .O(new_n162_));
  oai21  g100(.a(new_n114_), .b(new_n162_), .c(new_n63_), .O(z15));
  ...
  nand2  g106(.a(new_n168_), .b(new_n63_), .O(z17));
  aoi21  g107(.a(new_n135_), .b(new_n130_), .c(new_n64_), .O(z18));
  nand2  g108(.a(new_n135_), .b(new_n130_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n63_), .O(z19));
  nand2  g110(.a(x35), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n133_), .c(new_n132_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n128_), .c(new_n63_), .O(z20));
endmodule
