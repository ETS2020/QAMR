...
module FAU ( 
  ...
  and2   g028(.a(new_n75_), .b(new_n90_), .O(z08));
  ...
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n90_), .d(x21), .O(z03));
  aoi21  g036(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n64_), .O(z04));
  oai21  g038(.a(new_n82_), .b(new_n66_), .c(new_n67_), .O(new_n101_));
  and2   g039(.a(new_n101_), .b(new_n90_), .O(z05));
  ...
  nor2   g054(.a(new_n83_), .b(new_n66_), .O(new_n117_));
  nand2  g055(.a(new_n75_), .b(x05), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nor2   g058(.a(new_n75_), .b(new_n120_), .O(new_n121_));
  aoi22  g059(.a(new_n121_), .b(new_n117_), .c(new_n119_), .d(new_n85_), .O(new_n122_));
  ...
  aoi21  g066(.a(new_n128_), .b(new_n87_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  inv1   g069(.a(new_n87_), .O(new_n132_));
  ...
  oai21  g075(.a(new_n79_), .b(new_n77_), .c(new_n90_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  oai21  g077(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n75_), .c(new_n139_), .d(new_n71_), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n69_), .c(x20), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n75_), .b(new_n139_), .c(new_n71_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(new_n84_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n145_), .c(new_n64_), .O(z13));
  aoi21  g087(.a(new_n143_), .b(new_n141_), .c(new_n66_), .O(new_n150_));
  oai21  g088(.a(new_n147_), .b(new_n150_), .c(new_n90_), .O(z14));
  nand4  g089(.a(new_n114_), .b(new_n90_), .c(x26), .d(x12), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(z15));
  nand3  g091(.a(new_n63_), .b(x22), .c(x01), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n90_), .O(z16));
  inv1   g093(.a(x24), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x23), .c(x22), .d(x01), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z17));
  nand3  g096(.a(new_n135_), .b(new_n131_), .c(new_n90_), .O(z18));
  inv1   g097(.a(z18), .O(z19));
  nor2   g098(.a(new_n134_), .b(new_n64_), .O(new_n161_));
  oai21  g099(.a(new_n72_), .b(new_n66_), .c(new_n161_), .O(new_n162_));
