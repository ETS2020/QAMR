...
module FAU ( 
  ...
  nand2  g007(.a(x18), .b(x14), .O(new_n70_));
  ...
  nor2   g018(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  oai21  g019(.a(new_n79_), .b(new_n77_), .c(new_n81_), .O(z01));
  nor2   g020(.a(x27), .b(x08), .O(new_n83_));
  oai21  g021(.a(new_n83_), .b(new_n76_), .c(x04), .O(new_n84_));
  nand2  g022(.a(x40), .b(x39), .O(new_n85_));
  nor2   g023(.a(new_n80_), .b(new_n85_), .O(z08));
  ...
  aoi21  g029(.a(new_n91_), .b(x27), .c(new_n80_), .O(new_n92_));
  inv1   g030(.a(x37), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n73_), .O(new_n94_));
  ...
  nor3   g041(.a(x33), .b(x31), .c(x18), .O(new_n104_));
  ...
  nand2  g050(.a(new_n70_), .b(x11), .O(new_n113_));
  nor2   g051(.a(new_n113_), .b(new_n112_), .O(z09));
  nand2  g052(.a(new_n76_), .b(new_n74_), .O(new_n115_));
  ...
  nand2  g058(.a(new_n120_), .b(new_n79_), .O(new_n121_));
  ...
  aoi21  g062(.a(new_n124_), .b(new_n123_), .c(new_n80_), .O(z10));
  inv1   g063(.a(x08), .O(new_n126_));
  inv1   g064(.a(new_n85_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n76_), .c(new_n126_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand4  g068(.a(x35), .b(new_n75_), .c(x27), .d(new_n63_), .O(new_n131_));
  nor2   g069(.a(x30), .b(x09), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n70_), .O(new_n133_));
  ...
  nand2  g074(.a(new_n70_), .b(new_n69_), .O(new_n137_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n127_), .O(new_n143_));
  inv1   g081(.a(x19), .O(new_n144_));
  nand2  g082(.a(new_n91_), .b(new_n93_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(x20), .c(new_n144_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n143_), .c(new_n73_), .O(new_n147_));
  nand2  g085(.a(new_n142_), .b(new_n127_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(new_n78_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n139_), .O(new_n150_));
  inv1   g088(.a(new_n148_), .O(new_n151_));
  inv1   g089(.a(new_n141_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n73_), .c(new_n78_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n151_), .c(new_n101_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n150_), .O(z13));
  oai21  g093(.a(new_n141_), .b(new_n79_), .c(new_n151_), .O(new_n156_));
  nand3  g094(.a(x20), .b(new_n144_), .c(new_n139_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  aoi21  g096(.a(new_n75_), .b(x27), .c(new_n79_), .O(new_n159_));
  oai22  g097(.a(new_n159_), .b(new_n148_), .c(new_n66_), .d(new_n73_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(new_n70_), .O(z14));
  inv1   g099(.a(x12), .O(new_n162_));
  oai21  g100(.a(new_n112_), .b(new_n162_), .c(new_n70_), .O(z15));
  inv1   g101(.a(x23), .O(new_n164_));
  nand4  g102(.a(new_n70_), .b(new_n164_), .c(x22), .d(x01), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z16));
  nand2  g104(.a(x22), .b(x01), .O(new_n167_));
  nor4   g105(.a(new_n167_), .b(new_n80_), .c(x24), .d(new_n164_), .O(z17));
  inv1   g106(.a(z11), .O(z18));
  nand2  g107(.a(x35), .b(x27), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n134_), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(new_n129_), .O(z20));
  aoi21  g110(.a(new_n130_), .b(new_n129_), .c(new_n135_), .O(z19));
endmodule
