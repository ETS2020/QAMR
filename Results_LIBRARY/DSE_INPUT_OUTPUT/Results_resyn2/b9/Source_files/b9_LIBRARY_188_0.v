...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n162_, new_n163_, new_n164_, new_n168_, new_n169_;
  ...
  nor2   g039(.a(new_n101_), .b(new_n73_), .O(z05));
  inv1   g040(.a(z05), .O(z06));
  nand2  g041(.a(x25), .b(x14), .O(new_n104_));
  inv1   g042(.a(x00), .O(new_n105_));
  nand2  g043(.a(x03), .b(new_n105_), .O(new_n106_));
  oai21  g044(.a(new_n106_), .b(x25), .c(new_n104_), .O(new_n107_));
  ...
  nand4  g049(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(x03), .O(new_n112_));
  aoi22  g050(.a(new_n112_), .b(x14), .c(new_n107_), .d(x38), .O(z07));
  inv1   g051(.a(x11), .O(new_n114_));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  nor3   g053(.a(new_n115_), .b(new_n73_), .c(new_n114_), .O(z09));
  inv1   g054(.a(new_n73_), .O(new_n117_));
  aoi21  g055(.a(new_n77_), .b(new_n76_), .c(new_n87_), .O(new_n118_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n117_), .O(z10));
  ...
  nor2   g072(.a(new_n95_), .b(x04), .O(new_n135_));
  ...
  nand3  g076(.a(new_n138_), .b(new_n133_), .c(new_n117_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  nand2  g078(.a(new_n67_), .b(x27), .O(new_n141_));
  nand3  g079(.a(new_n117_), .b(new_n69_), .c(new_n141_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z12));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n118_), .O(new_n145_));
  ...
  aoi21  g093(.a(new_n151_), .b(new_n148_), .c(new_n95_), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n155_), .c(new_n73_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n115_), .b(new_n158_), .c(new_n117_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n117_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  inv1   g100(.a(new_n160_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n117_), .c(new_n162_), .d(x23), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z17));
  aoi21  g103(.a(new_n138_), .b(new_n133_), .c(new_n73_), .O(z18));
  inv1   g104(.a(z18), .O(z19));
  nand2  g105(.a(x35), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n76_), .c(new_n136_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n131_), .c(new_n117_), .O(z20));
endmodule
