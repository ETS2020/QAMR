...
module FAU ( 
  ...
  nor2   g010(.a(x23), .b(x01), .O(new_n73_));
  ...
  nand4  g029(.a(new_n91_), .b(new_n88_), .c(new_n86_), .d(new_n68_), .O(z02));
  ...
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n86_), .d(x21), .O(z03));
  ...
  nand2  g052(.a(new_n86_), .b(new_n114_), .O(z08));
  nand4  g053(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n86_), .O(z09));
  aoi21  g055(.a(new_n82_), .b(new_n81_), .c(new_n114_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n114_), .b(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n80_), .c(new_n118_), .O(new_n121_));
  oai21  g059(.a(new_n114_), .b(x05), .c(new_n65_), .O(new_n122_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n131_), .c(new_n86_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  nand2  g076(.a(new_n67_), .b(x27), .O(new_n139_));
  nand3  g077(.a(new_n86_), .b(new_n69_), .c(new_n139_), .O(new_n140_));
  ...
  aoi21  g091(.a(new_n149_), .b(new_n146_), .c(new_n76_), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n153_), .c(new_n73_), .O(z14));
  nand4  g093(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n86_), .O(z15));
  inv1   g095(.a(x22), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x01), .c(x23), .O(z16));
  inv1   g097(.a(x24), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x23), .c(x22), .d(x01), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n86_), .O(z17));
  aoi21  g100(.a(new_n136_), .b(new_n131_), .c(new_n73_), .O(z18));
  nand2  g101(.a(x35), .b(x27), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n81_), .c(new_n134_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n129_), .c(new_n86_), .O(z20));
  inv1   g104(.a(new_n137_), .O(z19));
endmodule
