...
module FAU ( 
  ...
  nor3   g027(.a(new_n89_), .b(new_n71_), .c(new_n88_), .O(new_n90_));
  ...
  nor2   g049(.a(new_n71_), .b(new_n88_), .O(z08));
  ...
  oai21  g063(.a(new_n71_), .b(x29), .c(x39), .O(new_n126_));
  ...
  nand3  g096(.a(x40), .b(new_n81_), .c(new_n80_), .O(new_n159_));
  oai21  g097(.a(new_n148_), .b(new_n71_), .c(x39), .O(new_n160_));
