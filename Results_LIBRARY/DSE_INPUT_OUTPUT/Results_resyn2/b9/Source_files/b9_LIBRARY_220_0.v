...
module FAU ( 
  ...
  nor2   g034(.a(new_n73_), .b(x21), .O(new_n97_));
  ...
  inv1   g050(.a(new_n73_), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n88_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n113_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n115_), .O(z09));
  aoi21  g055(.a(new_n82_), .b(new_n81_), .c(new_n88_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n88_), .b(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n80_), .c(new_n118_), .O(new_n121_));
  oai21  g059(.a(new_n88_), .b(x05), .c(new_n65_), .O(new_n122_));
  nand3  g060(.a(x37), .b(x27), .c(x06), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(new_n124_));
  nor2   g062(.a(new_n124_), .b(new_n73_), .O(new_n125_));
  oai21  g063(.a(new_n122_), .b(new_n121_), .c(new_n125_), .O(z10));
  ...
  nand3  g087(.a(new_n149_), .b(new_n142_), .c(new_n68_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n143_), .c(new_n73_), .O(z13));
  inv1   g091(.a(new_n143_), .O(new_n154_));
  aoi21  g092(.a(new_n150_), .b(new_n147_), .c(new_n76_), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n154_), .c(new_n73_), .O(z14));
  inv1   g094(.a(x12), .O(new_n157_));
  nor2   g095(.a(new_n116_), .b(new_n157_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n113_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n113_), .O(z17));
  aoi21  g101(.a(new_n136_), .b(new_n131_), .c(new_n73_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n81_), .c(new_n134_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n129_), .c(new_n113_), .O(z20));
endmodule
