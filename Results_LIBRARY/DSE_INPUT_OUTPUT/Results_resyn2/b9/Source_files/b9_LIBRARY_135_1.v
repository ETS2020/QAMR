...
module FAU ( 
  ...
  aoi21  g058(.a(x40), .b(new_n63_), .c(new_n120_), .O(new_n121_));
  ...
  nand2  g073(.a(new_n77_), .b(x39), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x40), .c(new_n71_), .O(z12));
  ...
  nand3  g086(.a(new_n142_), .b(new_n141_), .c(x40), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n142_), .b(new_n86_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x39), .c(new_n78_), .O(new_n152_));
