...
module FAU ( 
  ...
  nand2  g049(.a(new_n111_), .b(new_n72_), .O(z09));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n118_), .c(new_n83_), .O(new_n128_));
  ...
  nand3  g082(.a(new_n141_), .b(z08), .c(new_n123_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  nand3  g084(.a(new_n138_), .b(new_n137_), .c(x20), .O(new_n147_));
  oai21  g085(.a(new_n141_), .b(new_n71_), .c(x40), .O(new_n148_));
  oai21  g086(.a(new_n147_), .b(new_n84_), .c(new_n148_), .O(new_n149_));
  inv1   g087(.a(new_n140_), .O(new_n150_));
  nand2  g088(.a(new_n91_), .b(new_n76_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n138_), .c(x20), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n150_), .c(new_n84_), .O(new_n153_));
  nand2  g091(.a(new_n79_), .b(x39), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(new_n149_), .O(z14));
  nand4  g093(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n72_), .O(z15));
  inv1   g095(.a(x01), .O(new_n158_));
  inv1   g096(.a(x22), .O(new_n159_));
  nor4   g097(.a(new_n75_), .b(x23), .c(new_n159_), .d(new_n158_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nor2   g099(.a(new_n159_), .b(new_n158_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n72_), .c(new_n161_), .d(x23), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z17));
  nand2  g102(.a(new_n129_), .b(new_n128_), .O(new_n165_));
  inv1   g103(.a(new_n132_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(z18));
  oai21  g105(.a(new_n76_), .b(new_n84_), .c(new_n131_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n128_), .c(new_n72_), .O(z20));
  aoi21  g107(.a(new_n129_), .b(new_n128_), .c(new_n132_), .O(z19));
endmodule
