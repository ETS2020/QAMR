...
module FAU ( 
  ...
  nor3   g025(.a(new_n87_), .b(new_n86_), .c(new_n73_), .O(new_n88_));
  ...
  oai21  g077(.a(new_n139_), .b(new_n86_), .c(x39), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(z13));
  or2    g079(.a(new_n133_), .b(new_n67_), .O(new_n142_));
  oai21  g080(.a(new_n135_), .b(new_n86_), .c(x39), .O(new_n143_));
  ...
  nand2  g085(.a(new_n80_), .b(x40), .O(new_n148_));
