...
module FAU ( 
  ...
  nand2  g035(.a(new_n97_), .b(new_n69_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n65_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n97_), .b(new_n69_), .c(x21), .O(new_n100_));
  ...
  oai21  g059(.a(new_n73_), .b(x28), .c(new_n74_), .O(new_n122_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n82_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n134_), .b(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n81_), .c(x27), .d(new_n86_), .O(new_n138_));
  nor2   g076(.a(x30), .b(x09), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n65_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n138_), .c(new_n137_), .O(z18));
  inv1   g080(.a(z18), .O(z11));
  nand2  g081(.a(new_n78_), .b(new_n75_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n70_), .c(new_n69_), .O(new_n145_));
  nand2  g083(.a(new_n78_), .b(x10), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n145_), .c(new_n65_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x28), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n78_), .c(new_n149_), .O(new_n152_));
  ...
  nand3  g096(.a(new_n120_), .b(new_n149_), .c(new_n86_), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n85_), .c(new_n66_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  nand3  g101(.a(new_n150_), .b(new_n84_), .c(x28), .O(new_n164_));
