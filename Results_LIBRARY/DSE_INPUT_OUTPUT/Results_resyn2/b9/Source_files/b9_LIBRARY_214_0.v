...
module FAU ( 
  ...
  aoi21  g026(.a(x35), .b(new_n88_), .c(x36), .O(new_n89_));
  nor2   g027(.a(x32), .b(x30), .O(new_n90_));
  oai21  g028(.a(new_n89_), .b(new_n64_), .c(new_n90_), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(x04), .c(new_n87_), .O(z01));
  nand2  g030(.a(x35), .b(new_n88_), .O(new_n93_));
  nor2   g031(.a(x27), .b(x08), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n93_), .c(x04), .O(new_n95_));
  aoi21  g033(.a(x29), .b(x08), .c(x02), .O(new_n96_));
  nor2   g034(.a(new_n96_), .b(new_n79_), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n95_), .O(z02));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  oai22  g037(.a(new_n99_), .b(new_n73_), .c(new_n68_), .d(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(x21), .c(new_n87_), .O(z03));
  nor2   g039(.a(new_n87_), .b(x21), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n100_), .O(z04));
  aoi21  g041(.a(new_n99_), .b(new_n68_), .c(new_n87_), .O(z05));
  ...
  nor2   g061(.a(new_n89_), .b(x04), .O(new_n124_));
  ...
  nor3   g065(.a(new_n90_), .b(new_n79_), .c(x04), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x05), .O(new_n129_));
  oai21  g067(.a(new_n127_), .b(new_n64_), .c(new_n129_), .O(z10));
  inv1   g068(.a(x08), .O(new_n131_));
  nand2  g069(.a(new_n76_), .b(x29), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n93_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n132_), .b(x27), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n88_), .c(x27), .d(new_n72_), .O(new_n135_));
  ...
  aoi21  g076(.a(new_n134_), .b(new_n133_), .c(new_n138_), .O(z11));
  ...
  nand3  g083(.a(new_n145_), .b(new_n80_), .c(new_n143_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x20), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n71_), .c(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n128_), .b(new_n143_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand2  g090(.a(new_n80_), .b(new_n143_), .O(new_n153_));
  inv1   g091(.a(new_n90_), .O(new_n154_));
  aoi21  g092(.a(new_n88_), .b(x27), .c(new_n154_), .O(new_n155_));
  oai22  g093(.a(new_n155_), .b(new_n153_), .c(new_n140_), .d(new_n64_), .O(new_n156_));
  nand3  g094(.a(new_n144_), .b(new_n90_), .c(x28), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n80_), .c(new_n143_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n148_), .c(new_n87_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z14));
  inv1   g098(.a(x12), .O(new_n161_));
  nor2   g099(.a(new_n119_), .b(new_n161_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(x23), .c(new_n67_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  inv1   g103(.a(new_n163_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n67_), .c(new_n165_), .d(x23), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z17));
  nand2  g106(.a(new_n134_), .b(new_n133_), .O(new_n169_));
  nand3  g107(.a(new_n137_), .b(new_n135_), .c(new_n169_), .O(z18));
  oai21  g108(.a(new_n73_), .b(new_n64_), .c(new_n136_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n133_), .c(new_n67_), .O(z20));
  aoi21  g110(.a(new_n134_), .b(new_n133_), .c(new_n138_), .O(z19));
endmodule
