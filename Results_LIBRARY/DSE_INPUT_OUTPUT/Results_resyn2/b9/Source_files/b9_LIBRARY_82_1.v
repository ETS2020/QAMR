...
module FAU ( 
  ...
  nor2   g010(.a(new_n72_), .b(x14), .O(new_n73_));
  ...
  aoi21  g041(.a(new_n103_), .b(x00), .c(new_n72_), .O(new_n104_));
  inv1   g042(.a(x17), .O(new_n105_));
  nor2   g043(.a(x33), .b(x31), .O(new_n106_));
  oai21  g044(.a(new_n105_), .b(x15), .c(new_n106_), .O(new_n107_));
  oai21  g045(.a(new_n107_), .b(new_n104_), .c(x14), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(x03), .O(new_n109_));
  nand2  g047(.a(new_n109_), .b(new_n99_), .O(z07));
  nand2  g048(.a(new_n99_), .b(new_n88_), .O(z08));
  ...
  nand2  g054(.a(new_n83_), .b(new_n116_), .O(new_n117_));
  inv1   g055(.a(x35), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x28), .c(new_n77_), .O(new_n119_));
  ...
  nand4  g072(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n135_));
  and2   g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n99_), .O(z11));
  nand2  g076(.a(new_n67_), .b(x27), .O(new_n139_));
  nand3  g077(.a(new_n99_), .b(new_n68_), .c(new_n139_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n116_), .O(new_n145_));
  nand2  g083(.a(new_n92_), .b(new_n94_), .O(new_n146_));
  ...
  nand3  g088(.a(new_n144_), .b(new_n83_), .c(new_n116_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n150_), .c(new_n73_), .O(z13));
  nand2  g090(.a(new_n144_), .b(new_n116_), .O(new_n153_));
  nand2  g091(.a(new_n147_), .b(x20), .O(new_n154_));
  nand4  g092(.a(new_n142_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n155_));
  ...
  oai22  g096(.a(new_n158_), .b(new_n153_), .c(new_n63_), .d(new_n76_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n157_), .c(new_n99_), .O(z14));
  nand3  g098(.a(new_n113_), .b(new_n99_), .c(x12), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z15));
  inv1   g100(.a(x01), .O(new_n163_));
  inv1   g101(.a(x22), .O(new_n164_));
  nor4   g102(.a(new_n73_), .b(x23), .c(new_n164_), .d(new_n163_), .O(z16));
  ...
  aoi21  g107(.a(new_n136_), .b(new_n133_), .c(new_n73_), .O(z18));
  oai21  g108(.a(new_n118_), .b(new_n76_), .c(new_n134_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n131_), .c(new_n99_), .O(z20));
  nand2  g110(.a(new_n137_), .b(new_n99_), .O(z19));
endmodule
