...
module FAU ( 
  ...
  nand2  g049(.a(new_n105_), .b(new_n87_), .O(z08));
  nand4  g050(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n105_), .O(z09));
  oai21  g052(.a(new_n91_), .b(x28), .c(new_n76_), .O(new_n115_));
  ...
  oai21  g057(.a(new_n76_), .b(new_n116_), .c(new_n119_), .O(new_n120_));
  inv1   g058(.a(x05), .O(new_n121_));
  nand3  g059(.a(x40), .b(x39), .c(new_n121_), .O(new_n122_));
  nand4  g060(.a(new_n122_), .b(new_n120_), .c(new_n118_), .d(new_n115_), .O(new_n123_));
  nand3  g061(.a(new_n105_), .b(x37), .c(x06), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  nor2   g064(.a(new_n87_), .b(x04), .O(new_n127_));
  nand3  g065(.a(new_n82_), .b(new_n127_), .c(x05), .O(new_n128_));
  ...
  nand4  g072(.a(x35), .b(new_n77_), .c(x27), .d(new_n65_), .O(new_n135_));
  nor2   g073(.a(x30), .b(x09), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n105_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n135_), .c(new_n134_), .O(z18));
  ...
  oai21  g081(.a(new_n63_), .b(new_n75_), .c(new_n66_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n105_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  oai21  g084(.a(new_n76_), .b(new_n91_), .c(x28), .O(new_n147_));
  ...
  nand3  g092(.a(new_n82_), .b(new_n127_), .c(new_n146_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand2  g094(.a(new_n155_), .b(new_n105_), .O(new_n157_));
  aoi21  g095(.a(new_n152_), .b(x27), .c(new_n157_), .O(z14));
  nand4  g096(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n105_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(x23), .c(new_n105_), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x23), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n161_), .c(new_n105_), .O(z17));
  nor2   g103(.a(new_n91_), .b(new_n75_), .O(new_n166_));
  nor3   g104(.a(new_n166_), .b(new_n137_), .c(new_n132_), .O(z20));
