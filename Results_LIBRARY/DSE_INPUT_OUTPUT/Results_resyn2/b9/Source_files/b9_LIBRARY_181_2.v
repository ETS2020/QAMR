...
module FAU ( 
  ...
  oai21  g016(.a(new_n69_), .b(x28), .c(new_n70_), .O(new_n79_));
  ...
  nand3  g040(.a(new_n98_), .b(new_n84_), .c(new_n97_), .O(z05));
  ...
  nand2  g052(.a(new_n91_), .b(new_n84_), .O(z08));
  and2   g053(.a(x34), .b(x27), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(x26), .c(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n84_), .O(z09));
  nand2  g056(.a(new_n72_), .b(x05), .O(new_n119_));
  nand4  g057(.a(new_n79_), .b(new_n91_), .c(x27), .d(x07), .O(new_n120_));
  oai21  g058(.a(new_n119_), .b(new_n83_), .c(new_n120_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n68_), .O(new_n122_));
  nand3  g060(.a(x37), .b(x27), .c(x06), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n64_), .O(z10));
  inv1   g062(.a(x08), .O(new_n125_));
  nand2  g063(.a(new_n72_), .b(x29), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n88_), .c(new_n125_), .O(new_n127_));
  nand2  g065(.a(new_n126_), .b(x27), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nor2   g067(.a(x28), .b(new_n66_), .O(new_n130_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n129_), .c(new_n84_), .O(z18));
  inv1   g073(.a(z18), .O(z11));
  oai21  g074(.a(new_n76_), .b(new_n74_), .c(new_n84_), .O(z12));
  or2    g075(.a(new_n67_), .b(new_n66_), .O(new_n138_));
  nor2   g076(.a(x19), .b(x18), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x20), .O(new_n140_));
  oai21  g078(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(new_n82_), .O(new_n142_));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n92_), .O(new_n144_));
  oai22  g082(.a(new_n144_), .b(new_n142_), .c(new_n140_), .d(new_n138_), .O(z13));
  nand2  g083(.a(new_n143_), .b(new_n72_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  oai21  g085(.a(new_n130_), .b(new_n82_), .c(new_n147_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n138_), .c(x20), .O(new_n149_));
  nand4  g087(.a(new_n81_), .b(new_n80_), .c(new_n66_), .d(new_n63_), .O(new_n150_));
  oai21  g088(.a(new_n141_), .b(new_n82_), .c(new_n147_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n140_), .c(new_n84_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n150_), .c(new_n149_), .O(z14));
  nand4  g091(.a(new_n116_), .b(new_n84_), .c(x26), .d(x12), .O(new_n154_));
  ...
  nand4  g098(.a(new_n160_), .b(new_n84_), .c(new_n159_), .d(x23), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z17));
  nand2  g100(.a(new_n134_), .b(new_n129_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n84_), .O(z19));
  nor2   g102(.a(new_n69_), .b(new_n66_), .O(new_n165_));
  nor4   g103(.a(new_n165_), .b(new_n133_), .c(new_n127_), .d(new_n64_), .O(z20));
endmodule
