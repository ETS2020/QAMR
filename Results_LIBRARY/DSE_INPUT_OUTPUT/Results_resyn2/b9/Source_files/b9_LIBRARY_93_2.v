...
module FAU ( 
  ...
  nand2  g050(.a(new_n87_), .b(new_n98_), .O(z08));
  nand3  g051(.a(x34), .b(x27), .c(x26), .O(new_n114_));
  nand2  g052(.a(new_n98_), .b(x11), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  nand3  g054(.a(x40), .b(x39), .c(x05), .O(new_n117_));
  nand3  g055(.a(new_n87_), .b(new_n98_), .c(x07), .O(new_n118_));
  ...
  nand3  g062(.a(new_n124_), .b(new_n81_), .c(new_n63_), .O(new_n125_));
  oai21  g063(.a(new_n123_), .b(new_n75_), .c(new_n125_), .O(z10));
  nand3  g064(.a(x40), .b(x39), .c(x29), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n78_), .c(new_n84_), .O(new_n128_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(new_n98_), .O(new_n133_));
  aoi21  g071(.a(new_n129_), .b(new_n128_), .c(new_n133_), .O(z11));
  nand2  g072(.a(new_n66_), .b(new_n92_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(x27), .c(x10), .O(new_n136_));
  nor2   g074(.a(new_n67_), .b(new_n75_), .O(new_n137_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n97_), .c(new_n71_), .O(new_n141_));
  ...
  nand4  g083(.a(x40), .b(x39), .c(new_n145_), .d(new_n63_), .O(new_n146_));
  aoi21  g084(.a(x36), .b(x35), .c(new_n77_), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n146_), .c(new_n144_), .d(new_n67_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  inv1   g087(.a(new_n146_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n81_), .c(new_n72_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z13));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n80_), .c(x28), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n146_), .c(new_n144_), .O(new_n156_));
  aoi21  g094(.a(new_n77_), .b(x27), .c(new_n81_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n146_), .c(new_n140_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n156_), .c(new_n72_), .O(z14));
  inv1   g097(.a(x12), .O(new_n160_));
  oai21  g098(.a(new_n114_), .b(new_n160_), .c(new_n98_), .O(z15));
  nand2  g099(.a(x22), .b(x01), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x23), .O(z16));
  nor4   g101(.a(new_n162_), .b(new_n97_), .c(x24), .d(new_n71_), .O(z17));
  nand2  g102(.a(new_n75_), .b(new_n84_), .O(new_n165_));
  nand2  g103(.a(x27), .b(x04), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n165_), .c(new_n130_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n132_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n98_), .O(new_n169_));
  or2    g107(.a(new_n88_), .b(new_n87_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(z18));
  inv1   g109(.a(new_n170_), .O(new_n172_));
  aoi21  g110(.a(new_n168_), .b(new_n98_), .c(new_n172_), .O(z19));
  nand2  g111(.a(new_n132_), .b(new_n98_), .O(new_n174_));
