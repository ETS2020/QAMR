...
module FAU ( 
  ...
  nor2   g025(.a(new_n87_), .b(new_n69_), .O(new_n88_));
  ...
  nand2  g053(.a(new_n115_), .b(new_n99_), .O(z09));
  nand2  g054(.a(z08), .b(x05), .O(new_n117_));
  nand3  g055(.a(new_n99_), .b(new_n69_), .c(x07), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  inv1   g057(.a(x36), .O(new_n120_));
  aoi21  g058(.a(new_n84_), .b(new_n120_), .c(x04), .O(new_n121_));
  ...
  nor2   g062(.a(new_n69_), .b(x04), .O(new_n125_));
  inv1   g063(.a(new_n80_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n125_), .c(x05), .O(new_n127_));
  oai21  g065(.a(new_n124_), .b(new_n92_), .c(new_n127_), .O(z10));
  ...
  nand4  g071(.a(x35), .b(new_n83_), .c(x27), .d(new_n66_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  and2   g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n133_), .c(new_n99_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  oai21  g076(.a(x36), .b(x35), .c(new_n125_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n64_), .c(new_n92_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n72_), .c(new_n99_), .O(z12));
  inv1   g079(.a(x13), .O(new_n142_));
  nand2  g080(.a(new_n125_), .b(new_n142_), .O(new_n143_));
  aoi21  g081(.a(x36), .b(x35), .c(new_n83_), .O(new_n144_));
  nand2  g082(.a(new_n90_), .b(new_n93_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(x20), .O(new_n147_));
  oai21  g085(.a(new_n144_), .b(new_n143_), .c(new_n147_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  inv1   g087(.a(new_n143_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n126_), .c(new_n76_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z13));
  aoi21  g090(.a(new_n83_), .b(x27), .c(new_n126_), .O(new_n153_));
  aoi21  g091(.a(new_n145_), .b(x27), .c(new_n76_), .O(new_n154_));
  oai21  g092(.a(new_n153_), .b(new_n143_), .c(new_n154_), .O(new_n155_));
  nand2  g093(.a(new_n144_), .b(new_n80_), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  aoi21  g095(.a(new_n146_), .b(x20), .c(new_n76_), .O(new_n158_));
  oai21  g096(.a(new_n157_), .b(new_n143_), .c(new_n158_), .O(new_n159_));
  ...
  nand4  g104(.a(new_n166_), .b(new_n99_), .c(new_n165_), .d(x23), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z17));
  nand2  g106(.a(new_n136_), .b(new_n133_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n99_), .O(z19));
  oai21  g108(.a(new_n77_), .b(new_n92_), .c(new_n135_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n131_), .c(new_n99_), .O(z20));
endmodule
