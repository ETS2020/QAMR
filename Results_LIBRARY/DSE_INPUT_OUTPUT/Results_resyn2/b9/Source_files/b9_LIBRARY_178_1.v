...
module FAU ( 
  ...
  nand2  g052(.a(new_n98_), .b(new_n88_), .O(z08));
  ...
  aoi21  g078(.a(new_n140_), .b(new_n134_), .c(new_n74_), .O(z18));
  inv1   g079(.a(z18), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand3  g081(.a(new_n98_), .b(new_n69_), .c(new_n143_), .O(new_n144_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n146_), .c(new_n68_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n147_), .c(new_n74_), .O(z13));
  inv1   g095(.a(new_n147_), .O(new_n158_));
  aoi21  g096(.a(new_n154_), .b(new_n151_), .c(new_n136_), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n158_), .c(new_n74_), .O(z14));
  inv1   g098(.a(x12), .O(new_n161_));
  oai21  g099(.a(new_n117_), .b(new_n161_), .c(new_n98_), .O(z15));
  ...
  nand3  g105(.a(new_n140_), .b(new_n134_), .c(new_n98_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z19));
  nor2   g107(.a(new_n139_), .b(new_n74_), .O(new_n170_));
  oai21  g108(.a(new_n92_), .b(new_n136_), .c(new_n170_), .O(new_n171_));
