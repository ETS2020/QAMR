...
module FAU ( 
  ...
  nand2  g41(.a(x25), .b(new_n103_), .O(new_n104_));
  nand3  g42(.a(new_n104_), .b(new_n102_), .c(x38), .O(new_n105_));
  ...
  nand2  g48(.a(new_n110_), .b(new_n96_), .O(z07));
  nand2  g49(.a(new_n87_), .b(new_n96_), .O(z08));
  ...
  nor2   g67(.a(new_n69_), .b(new_n66_), .O(new_n130_));
  nand3  g68(.a(new_n130_), .b(new_n79_), .c(new_n68_), .O(new_n131_));
  nor2   g69(.a(x30), .b(x09), .O(new_n132_));
  and2   g70(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(new_n129_), .c(new_n96_), .O(new_n134_));
  inv1   g72(.a(new_n134_), .O(z11));
  oai21  g73(.a(new_n76_), .b(new_n74_), .c(new_n96_), .O(z12));
  nor2   g74(.a(x13), .b(x04), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(new_n72_), .O(new_n138_));
  aoi21  g76(.a(x36), .b(x35), .c(new_n79_), .O(new_n139_));
  nor2   g77(.a(x19), .b(x18), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(x20), .O(new_n141_));
  oai22  g79(.a(new_n141_), .b(new_n67_), .c(new_n139_), .d(new_n138_), .O(new_n142_));
  oai21  g80(.a(new_n138_), .b(new_n81_), .c(new_n96_), .O(new_n143_));
  aoi21  g81(.a(new_n142_), .b(x27), .c(new_n143_), .O(z14));
  inv1   g82(.a(z14), .O(z13));
  inv1   g83(.a(x12), .O(new_n146_));
  oai21  g84(.a(new_n114_), .b(new_n146_), .c(new_n96_), .O(z15));
  inv1   g85(.a(x23), .O(new_n148_));
  nand2  g86(.a(new_n148_), .b(x01), .O(new_n149_));
  aoi21  g87(.a(new_n149_), .b(x25), .c(new_n63_), .O(z16));
  inv1   g88(.a(x24), .O(new_n151_));
  nand3  g89(.a(new_n151_), .b(x23), .c(x01), .O(new_n152_));
  aoi21  g90(.a(new_n152_), .b(x25), .c(new_n63_), .O(z17));
  aoi21  g91(.a(new_n133_), .b(new_n129_), .c(new_n64_), .O(z18));
  nand2  g92(.a(new_n133_), .b(new_n129_), .O(new_n155_));
  nand2  g93(.a(new_n155_), .b(new_n96_), .O(z19));
  nor2   g94(.a(new_n130_), .b(new_n64_), .O(new_n157_));
  nand2  g95(.a(new_n157_), .b(new_n132_), .O(new_n158_));
  nor2   g96(.a(new_n158_), .b(new_n127_), .O(z20));
endmodule
