...
module FAU ( 
  ...
  oai21  g026(.a(new_n88_), .b(new_n71_), .c(x39), .O(z02));
  ...
  nand2  g053(.a(new_n115_), .b(x39), .O(new_n116_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n71_), .c(x39), .O(new_n153_));
  ...
  oai21  g096(.a(new_n148_), .b(new_n71_), .c(x39), .O(new_n159_));
