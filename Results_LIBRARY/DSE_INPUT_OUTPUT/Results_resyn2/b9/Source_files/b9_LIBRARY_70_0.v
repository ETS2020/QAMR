...
module FAU ( 
  ...
  nor2   g009(.a(x32), .b(x22), .O(new_n72_));
  ...
  aoi21  g017(.a(new_n79_), .b(x27), .c(x30), .O(new_n80_));
  oai21  g018(.a(new_n80_), .b(new_n75_), .c(new_n76_), .O(new_n81_));
  ...
  aoi21  g055(.a(new_n76_), .b(new_n75_), .c(x04), .O(new_n118_));
  nand2  g056(.a(x22), .b(x05), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(x40), .c(x39), .O(new_n120_));
  ...
  nand3  g061(.a(new_n101_), .b(x37), .c(x06), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  aoi21  g064(.a(x30), .b(x22), .c(x32), .O(new_n127_));
  nor2   g065(.a(new_n127_), .b(new_n66_), .O(new_n128_));
  ...
  nand4  g072(.a(x35), .b(new_n83_), .c(x27), .d(new_n65_), .O(new_n135_));
  ...
  nand2  g079(.a(new_n93_), .b(new_n96_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n101_), .c(new_n142_), .d(x20), .O(new_n144_));
  inv1   g082(.a(x13), .O(new_n145_));
  nor2   g083(.a(new_n87_), .b(x04), .O(new_n146_));
  oai21  g084(.a(new_n78_), .b(new_n77_), .c(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n146_), .c(x22), .d(new_n145_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n128_), .b(new_n145_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(new_n96_), .b(new_n77_), .c(x28), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x27), .c(x30), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n75_), .c(new_n76_), .O(new_n155_));
  nand2  g093(.a(new_n143_), .b(x20), .O(new_n156_));
  aoi21  g094(.a(x36), .b(x35), .c(new_n83_), .O(new_n157_));
  nor2   g095(.a(x32), .b(x30), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n157_), .c(new_n156_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n146_), .c(new_n145_), .O(new_n160_));
  nand4  g098(.a(new_n143_), .b(new_n142_), .c(x27), .d(x20), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n155_), .O(z14));
  nand4  g101(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n101_), .O(z15));
  ...
  inv1   g108(.a(z11), .O(z18));
  oai21  g109(.a(new_n77_), .b(new_n95_), .c(new_n136_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n133_), .c(new_n101_), .O(z20));
  aoi21  g111(.a(new_n134_), .b(new_n133_), .c(new_n137_), .O(z19));
endmodule
