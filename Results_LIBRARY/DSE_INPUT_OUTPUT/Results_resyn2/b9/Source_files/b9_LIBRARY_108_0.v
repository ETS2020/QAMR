...
module FAU ( 
  ...
  nor2   g008(.a(x36), .b(x02), .O(new_n71_));
  ...
  nand2  g024(.a(x36), .b(x29), .O(new_n87_));
  ...
  aoi21  g033(.a(new_n95_), .b(x21), .c(new_n71_), .O(z03));
  nor2   g034(.a(new_n71_), .b(x21), .O(new_n97_));
  ...
  nor2   g050(.a(new_n71_), .b(new_n89_), .O(z08));
  inv1   g051(.a(x11), .O(new_n114_));
  nand4  g052(.a(new_n99_), .b(x34), .c(x27), .d(x26), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  inv1   g054(.a(new_n89_), .O(new_n117_));
  nand2  g055(.a(new_n80_), .b(new_n117_), .O(new_n118_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n77_), .c(new_n83_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nor2   g070(.a(new_n92_), .b(new_n74_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n76_), .c(new_n63_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  and2   g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n132_), .c(new_n99_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  nand2  g076(.a(new_n68_), .b(x27), .O(new_n139_));
  nand2  g077(.a(new_n65_), .b(x10), .O(new_n140_));
  nand3  g078(.a(new_n99_), .b(new_n140_), .c(new_n139_), .O(new_n141_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n117_), .c(new_n76_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n74_), .O(new_n149_));
  nand2  g087(.a(new_n147_), .b(new_n117_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n79_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(new_n99_), .O(new_n152_));
  ...
  aoi21  g093(.a(x36), .b(x35), .c(new_n76_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n150_), .c(new_n146_), .O(new_n157_));
  oai21  g095(.a(new_n150_), .b(new_n79_), .c(new_n99_), .O(new_n158_));
  aoi21  g096(.a(new_n157_), .b(x27), .c(new_n158_), .O(z14));
  inv1   g097(.a(x12), .O(new_n160_));
  nor2   g098(.a(new_n115_), .b(new_n160_), .O(z15));
  nand2  g099(.a(x22), .b(x01), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x23), .c(new_n99_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  inv1   g102(.a(new_n162_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n99_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  aoi21  g105(.a(new_n136_), .b(new_n132_), .c(new_n71_), .O(z18));
  nand2  g106(.a(new_n136_), .b(new_n132_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n99_), .O(z19));
  nor2   g108(.a(new_n133_), .b(new_n71_), .O(new_n171_));
