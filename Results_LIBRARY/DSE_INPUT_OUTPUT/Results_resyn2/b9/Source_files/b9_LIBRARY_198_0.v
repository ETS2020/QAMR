...
module FAU ( 
  ...
  nand2  g084(.a(new_n124_), .b(new_n138_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z13));
  aoi22  g086(.a(new_n145_), .b(x27), .c(new_n124_), .d(new_n138_), .O(z14));
  nand2  g087(.a(x26), .b(x12), .O(new_n150_));
  nor3   g088(.a(new_n150_), .b(new_n113_), .c(new_n72_), .O(z15));
  nand2  g089(.a(x22), .b(x01), .O(new_n152_));
  nor3   g090(.a(new_n152_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g091(.a(x24), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x23), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n152_), .c(new_n100_), .O(z17));
  nand4  g094(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n100_), .O(z18));
  inv1   g095(.a(new_n127_), .O(new_n158_));
  nand2  g096(.a(new_n82_), .b(new_n81_), .O(new_n159_));
  nand2  g097(.a(x27), .b(x04), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n159_), .c(new_n76_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n132_), .O(new_n162_));
  aoi22  g100(.a(new_n162_), .b(new_n100_), .c(new_n158_), .d(x08), .O(z19));
  nand2  g101(.a(x35), .b(x27), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n132_), .c(new_n100_), .O(new_n165_));
