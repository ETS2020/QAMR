...
module FAU ( 
  ...
  nand2  g008(.a(new_n70_), .b(x32), .O(new_n71_));
  ...
  oai22  g018(.a(new_n80_), .b(new_n78_), .c(new_n74_), .d(x04), .O(z01));
  ...
  aoi21  g032(.a(new_n92_), .b(new_n94_), .c(new_n74_), .O(z04));
  nand2  g033(.a(new_n91_), .b(new_n90_), .O(new_n96_));
  and2   g034(.a(new_n96_), .b(new_n71_), .O(z05));
  nor2   g035(.a(new_n96_), .b(new_n74_), .O(z06));
  ...
  nand3  g050(.a(new_n112_), .b(new_n71_), .c(x11), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z09));
  inv1   g052(.a(x30), .O(new_n115_));
  oai21  g053(.a(new_n77_), .b(new_n75_), .c(new_n115_), .O(new_n116_));
  inv1   g054(.a(new_n85_), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(x05), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(new_n119_));
  and2   g057(.a(new_n85_), .b(x07), .O(new_n120_));
  aoi22  g058(.a(new_n120_), .b(new_n78_), .c(new_n119_), .d(new_n116_), .O(new_n121_));
  inv1   g059(.a(x05), .O(new_n122_));
  oai21  g060(.a(new_n64_), .b(new_n122_), .c(x36), .O(new_n123_));
  nand3  g061(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  aoi21  g063(.a(new_n123_), .b(x32), .c(new_n125_), .O(new_n126_));
  oai21  g064(.a(new_n121_), .b(x04), .c(new_n126_), .O(z10));
  inv1   g065(.a(x08), .O(new_n128_));
  nand2  g066(.a(new_n117_), .b(x29), .O(new_n129_));
  ...
  nand4  g070(.a(x35), .b(new_n76_), .c(x27), .d(new_n63_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  and2   g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n132_), .c(new_n71_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n71_), .b(new_n69_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z12));
  oai21  g077(.a(new_n70_), .b(new_n89_), .c(x28), .O(new_n140_));
  nor2   g078(.a(x13), .b(x04), .O(new_n141_));
  nand2  g079(.a(x32), .b(new_n76_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n117_), .O(new_n143_));
  ...
  nand2  g085(.a(new_n71_), .b(new_n147_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n146_), .c(new_n143_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand4  g088(.a(new_n141_), .b(new_n80_), .c(new_n71_), .d(new_n117_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand2  g090(.a(new_n141_), .b(new_n117_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n71_), .O(new_n154_));
  oai21  g092(.a(new_n140_), .b(new_n80_), .c(new_n154_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n146_), .O(new_n156_));
  aoi21  g094(.a(new_n76_), .b(x27), .c(new_n80_), .O(new_n157_));
  aoi21  g095(.a(new_n147_), .b(x27), .c(new_n74_), .O(new_n158_));
  oai21  g096(.a(new_n157_), .b(new_n153_), .c(new_n158_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z14));
  nand3  g098(.a(new_n112_), .b(new_n71_), .c(x12), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(x23), .c(new_n71_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  inv1   g103(.a(new_n163_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n71_), .c(new_n165_), .d(x23), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z17));
  aoi21  g106(.a(new_n135_), .b(new_n132_), .c(new_n74_), .O(z18));
  nand2  g107(.a(new_n135_), .b(new_n132_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n71_), .O(z19));
  oai21  g109(.a(new_n89_), .b(new_n75_), .c(new_n134_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n130_), .c(new_n71_), .O(z20));
endmodule
