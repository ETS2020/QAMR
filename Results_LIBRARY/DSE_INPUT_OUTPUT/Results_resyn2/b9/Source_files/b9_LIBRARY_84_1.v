...
module FAU ( 
  ...
  nor3   g027(.a(new_n89_), .b(new_n88_), .c(new_n72_), .O(new_n90_));
  ...
  nand3  g036(.a(new_n94_), .b(new_n73_), .c(new_n93_), .O(z05));
  nand2  g037(.a(new_n94_), .b(new_n93_), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n73_), .O(z06));
  ...
  nand3  g050(.a(x40), .b(x39), .c(x23), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z08));
  nand4  g052(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n73_), .O(z09));
  inv1   g054(.a(new_n82_), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n68_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n88_), .b(new_n119_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(new_n80_), .c(x27), .O(new_n121_));
  ...
  nand3  g064(.a(new_n126_), .b(new_n125_), .c(new_n73_), .O(z10));
  nor2   g065(.a(x30), .b(x09), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n85_), .c(x04), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x23), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x40), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n78_), .c(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n85_), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nor2   g072(.a(new_n86_), .b(new_n65_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n79_), .c(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n128_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n131_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand2  g078(.a(new_n69_), .b(new_n140_), .O(new_n141_));
  nand2  g079(.a(new_n73_), .b(new_n141_), .O(z12));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x20), .O(new_n144_));
  oai21  g082(.a(new_n92_), .b(new_n78_), .c(new_n93_), .O(new_n145_));
  nand2  g083(.a(new_n73_), .b(new_n145_), .O(new_n146_));
  ...
  oai21  g088(.a(new_n146_), .b(new_n144_), .c(new_n150_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand4  g090(.a(new_n149_), .b(new_n117_), .c(new_n68_), .d(x23), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  inv1   g092(.a(x40), .O(new_n155_));
  nand3  g093(.a(new_n147_), .b(new_n82_), .c(x28), .O(new_n156_));
  inv1   g094(.a(x13), .O(new_n157_));
  nand3  g095(.a(x39), .b(new_n157_), .c(new_n65_), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(new_n72_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n155_), .c(new_n144_), .O(new_n161_));
  nand2  g099(.a(new_n145_), .b(x27), .O(new_n162_));
  nand2  g100(.a(new_n78_), .b(x27), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n82_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n159_), .c(new_n72_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n155_), .c(new_n162_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n161_), .O(z14));
  nand4  g105(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n73_), .O(z15));
  nand4  g107(.a(new_n155_), .b(new_n72_), .c(x22), .d(x01), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(z16));
  inv1   g109(.a(x24), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(x23), .c(x22), .d(x01), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n73_), .O(z17));
  inv1   g112(.a(new_n128_), .O(new_n175_));
  inv1   g113(.a(new_n135_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n87_), .c(new_n175_), .O(new_n177_));
  nand3  g115(.a(z08), .b(x29), .c(x08), .O(new_n178_));
  oai21  g116(.a(new_n177_), .b(new_n76_), .c(new_n178_), .O(z18));
  oai21  g117(.a(new_n132_), .b(x04), .c(new_n85_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n136_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n128_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n73_), .O(z19));
  aoi21  g121(.a(new_n134_), .b(new_n79_), .c(new_n85_), .O(new_n184_));
  oai21  g122(.a(new_n92_), .b(new_n86_), .c(new_n128_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n184_), .c(new_n73_), .O(z20));
endmodule
