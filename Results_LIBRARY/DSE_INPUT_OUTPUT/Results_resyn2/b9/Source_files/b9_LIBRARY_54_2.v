...
module FAU ( 
  ...
  nand2  g010(.a(x33), .b(new_n72_), .O(new_n73_));
  ...
  aoi21  g034(.a(new_n96_), .b(new_n75_), .c(new_n85_), .O(new_n97_));
  ...
  nand2  g049(.a(new_n83_), .b(new_n111_), .O(new_n112_));
  ...
  nand2  g056(.a(new_n118_), .b(new_n84_), .O(z09));
  aoi21  g057(.a(new_n81_), .b(new_n80_), .c(new_n90_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n90_), .b(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n79_), .c(new_n120_), .O(new_n123_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n77_), .c(new_n65_), .O(new_n134_));
  ...
  nand2  g075(.a(new_n137_), .b(new_n84_), .O(z11));
  nand2  g076(.a(new_n67_), .b(x27), .O(new_n139_));
  nand3  g077(.a(new_n84_), .b(new_n69_), .c(new_n139_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  nor2   g079(.a(x13), .b(x04), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n120_), .O(new_n143_));
  nand2  g081(.a(new_n94_), .b(new_n96_), .O(new_n144_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n142_), .c(new_n68_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n143_), .c(new_n85_), .O(z13));
  inv1   g090(.a(new_n143_), .O(new_n153_));
  aoi21  g091(.a(new_n149_), .b(new_n146_), .c(new_n75_), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n153_), .c(new_n85_), .O(z14));
  nand4  g093(.a(new_n117_), .b(new_n84_), .c(x26), .d(x12), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(z15));
  nand2  g095(.a(x22), .b(x01), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(x23), .c(new_n84_), .O(z16));
  inv1   g097(.a(x24), .O(new_n160_));
  inv1   g098(.a(new_n158_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n84_), .c(new_n160_), .d(x23), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z17));
  nand3  g101(.a(new_n136_), .b(new_n132_), .c(new_n84_), .O(z18));
  nor2   g102(.a(new_n133_), .b(new_n85_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n135_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n130_), .O(z20));
  nand2  g105(.a(new_n137_), .b(new_n84_), .O(z19));
endmodule
