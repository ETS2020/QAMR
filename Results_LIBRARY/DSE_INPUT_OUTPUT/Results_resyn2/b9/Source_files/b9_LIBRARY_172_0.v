...
module FAU ( 
  ...
  oai21  g012(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(new_n75_));
  ...
  nand3  g018(.a(new_n80_), .b(new_n75_), .c(new_n64_), .O(new_n81_));
  oai21  g019(.a(new_n71_), .b(new_n63_), .c(new_n81_), .O(z00));
  nor2   g020(.a(x32), .b(x30), .O(new_n83_));
  inv1   g021(.a(x28), .O(new_n84_));
  aoi21  g022(.a(x35), .b(new_n84_), .c(x36), .O(new_n85_));
  oai21  g023(.a(new_n85_), .b(new_n66_), .c(new_n83_), .O(new_n86_));
  ...
  nor2   g028(.a(new_n76_), .b(new_n63_), .O(z08));
  inv1   g029(.a(x02), .O(new_n92_));
  inv1   g030(.a(x08), .O(new_n93_));
  oai21  g031(.a(new_n72_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n66_), .c(new_n63_), .O(new_n99_));
  ...
  inv1   g047(.a(new_n63_), .O(new_n110_));
  ...
  nor2   g053(.a(new_n115_), .b(new_n109_), .O(z07));
  nand2  g054(.a(x34), .b(x27), .O(new_n117_));
  nand2  g055(.a(x26), .b(x11), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(new_n117_), .c(new_n110_), .O(z09));
  oai21  g057(.a(new_n85_), .b(new_n66_), .c(new_n76_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  oai21  g059(.a(new_n76_), .b(x05), .c(new_n68_), .O(new_n122_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n110_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  aoi22  g075(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n110_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  nand3  g077(.a(new_n77_), .b(new_n139_), .c(new_n68_), .O(new_n140_));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n63_), .O(new_n149_));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n140_), .c(new_n63_), .O(new_n155_));
