...
module FAU ( 
  ...
  nor2   g012(.a(x26), .b(x23), .O(new_n75_));
  ...
  nor2   g022(.a(new_n75_), .b(new_n66_), .O(new_n85_));
  ...
  nand4  g029(.a(new_n91_), .b(new_n88_), .c(new_n76_), .d(new_n71_), .O(z02));
  nand2  g030(.a(x35), .b(x28), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n76_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n95_), .b(new_n78_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n75_), .O(z04));
  aoi21  g037(.a(x28), .b(x27), .c(x37), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n75_), .O(z05));
  inv1   g039(.a(new_n100_), .O(new_n102_));
  nor2   g040(.a(new_n102_), .b(new_n75_), .O(z06));
  ...
  nand3  g049(.a(new_n111_), .b(new_n76_), .c(x03), .O(new_n112_));
  nor2   g050(.a(new_n112_), .b(new_n107_), .O(z07));
  nand2  g051(.a(new_n76_), .b(new_n70_), .O(z08));
  ...
  nand2  g056(.a(new_n70_), .b(x07), .O(new_n119_));
  ...
  nand4  g069(.a(x35), .b(new_n80_), .c(x27), .d(new_n66_), .O(new_n132_));
  nor3   g070(.a(new_n75_), .b(x30), .c(x09), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  aoi21  g072(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z11));
  nand2  g073(.a(new_n76_), .b(new_n73_), .O(z12));
  aoi21  g074(.a(x36), .b(x35), .c(new_n80_), .O(new_n137_));
  inv1   g075(.a(x13), .O(new_n138_));
  nand3  g076(.a(new_n71_), .b(new_n138_), .c(new_n66_), .O(new_n139_));
  nor2   g077(.a(x19), .b(x18), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x20), .O(new_n141_));
  oai22  g079(.a(new_n141_), .b(new_n64_), .c(new_n139_), .d(new_n137_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x27), .O(new_n143_));
  inv1   g081(.a(new_n139_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n84_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n143_), .c(new_n75_), .O(z13));
  nand2  g084(.a(new_n137_), .b(new_n83_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n141_), .O(new_n149_));
  aoi21  g087(.a(new_n80_), .b(x27), .c(new_n84_), .O(new_n150_));
  oai22  g088(.a(new_n150_), .b(new_n139_), .c(new_n64_), .d(new_n78_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n149_), .c(new_n76_), .O(z14));
  nand4  g090(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(z15));
  inv1   g092(.a(x23), .O(new_n155_));
  nand4  g093(.a(x26), .b(new_n155_), .c(x22), .d(x01), .O(new_n156_));
  ...
  nand2  g100(.a(new_n162_), .b(new_n133_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n130_), .O(z20));
  aoi21  g102(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z19));
endmodule
