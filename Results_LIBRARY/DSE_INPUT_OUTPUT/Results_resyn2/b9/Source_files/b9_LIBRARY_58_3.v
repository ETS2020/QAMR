...
module FAU ( 
  ...
  nand2  g007(.a(x36), .b(x30), .O(new_n70_));
  ...
  oai22  g018(.a(new_n80_), .b(new_n78_), .c(new_n73_), .d(x04), .O(z01));
  ...
  nor2   g025(.a(new_n73_), .b(new_n87_), .O(new_n88_));
  nand3  g026(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(z02));
  ...
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n70_), .d(x21), .O(z03));
  aoi21  g032(.a(new_n92_), .b(new_n74_), .c(x21), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n91_), .c(new_n73_), .O(z04));
  aoi21  g034(.a(x28), .b(x27), .c(x37), .O(new_n97_));
  nor2   g035(.a(new_n97_), .b(new_n73_), .O(z05));
  nand2  g036(.a(new_n97_), .b(new_n70_), .O(new_n99_));
  ...
  nand2  g049(.a(new_n70_), .b(new_n87_), .O(z08));
  nand4  g050(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n70_), .O(z09));
  nand3  g052(.a(x37), .b(x27), .c(x06), .O(new_n115_));
  nand2  g053(.a(x32), .b(x05), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(new_n64_), .c(new_n115_), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n70_), .O(new_n118_));
  nand3  g056(.a(x40), .b(x39), .c(x05), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n87_), .b(x07), .c(new_n120_), .O(new_n121_));
  inv1   g059(.a(x35), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(x28), .c(new_n75_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n70_), .c(x27), .O(new_n124_));
  nand3  g062(.a(new_n120_), .b(new_n75_), .c(x30), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(new_n121_), .c(new_n125_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n63_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n118_), .O(z10));
  ...
  aoi21  g073(.a(new_n132_), .b(new_n131_), .c(new_n135_), .O(z19));
  inv1   g074(.a(z19), .O(z18));
  nand2  g075(.a(z18), .b(new_n70_), .O(z11));
  inv1   g076(.a(x10), .O(new_n139_));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n74_), .c(new_n139_), .O(new_n141_));
  oai21  g079(.a(new_n66_), .b(new_n74_), .c(new_n64_), .O(new_n142_));
  ...
  aoi21  g084(.a(x36), .b(x35), .c(new_n76_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n74_), .c(new_n79_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n90_), .b(new_n92_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(x20), .O(new_n152_));
  or2    g090(.a(new_n152_), .b(new_n74_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n149_), .c(new_n73_), .O(z13));
  oai21  g092(.a(new_n147_), .b(new_n145_), .c(new_n152_), .O(new_n155_));
  oai21  g093(.a(new_n145_), .b(new_n79_), .c(new_n70_), .O(new_n156_));
  aoi21  g094(.a(new_n155_), .b(x27), .c(new_n156_), .O(z14));
  nand4  g095(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n70_), .O(z15));
  inv1   g097(.a(x23), .O(new_n160_));
  nand4  g098(.a(new_n70_), .b(new_n160_), .c(x22), .d(x01), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z16));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  nor4   g101(.a(new_n163_), .b(new_n73_), .c(x24), .d(new_n160_), .O(z17));
  oai21  g102(.a(new_n122_), .b(new_n74_), .c(new_n134_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n131_), .c(new_n70_), .O(z20));
endmodule
