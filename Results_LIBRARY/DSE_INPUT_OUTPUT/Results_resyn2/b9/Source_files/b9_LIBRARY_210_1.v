...
module FAU ( 
  ...
  nor2   g014(.a(new_n63_), .b(x04), .O(new_n77_));
  nand4  g015(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n66_), .O(new_n78_));
  ...
  nor2   g051(.a(new_n81_), .b(new_n68_), .O(new_n114_));
  nand2  g052(.a(new_n76_), .b(x05), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(new_n116_));
  and2   g054(.a(new_n89_), .b(x07), .O(new_n117_));
  aoi22  g055(.a(new_n117_), .b(new_n114_), .c(new_n116_), .d(new_n83_), .O(new_n118_));
  nor2   g056(.a(new_n68_), .b(new_n63_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(x37), .c(new_n65_), .O(new_n120_));
  oai21  g058(.a(new_n118_), .b(x04), .c(new_n120_), .O(z10));
  inv1   g059(.a(x08), .O(new_n122_));
  nor2   g060(.a(x30), .b(x09), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(x04), .O(new_n124_));
  ...
  oai21  g067(.a(new_n85_), .b(new_n68_), .c(new_n122_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n123_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n126_), .O(z11));
  inv1   g071(.a(x35), .O(new_n134_));
  inv1   g072(.a(x36), .O(new_n135_));
  nand3  g073(.a(new_n69_), .b(new_n135_), .c(new_n134_), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x27), .c(x10), .O(new_n137_));
  inv1   g075(.a(x04), .O(new_n138_));
  aoi21  g076(.a(x39), .b(new_n138_), .c(new_n71_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n137_), .c(x06), .O(new_n140_));
  oai21  g078(.a(new_n71_), .b(x40), .c(new_n140_), .O(z12));
  inv1   g079(.a(x13), .O(new_n142_));
  oai21  g080(.a(new_n135_), .b(new_n134_), .c(x28), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n76_), .c(new_n142_), .d(new_n138_), .O(new_n144_));
  ...
  oai21  g085(.a(new_n144_), .b(new_n63_), .c(new_n147_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nand3  g087(.a(new_n76_), .b(new_n142_), .c(new_n138_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n82_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x06), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(z13));
  nand3  g091(.a(new_n146_), .b(new_n145_), .c(x20), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n144_), .c(new_n68_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n151_), .c(new_n64_), .O(z14));
  nand4  g094(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n64_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n65_), .c(x23), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n64_), .O(z17));
  aoi21  g101(.a(new_n127_), .b(new_n85_), .c(new_n122_), .O(new_n164_));
  nand2  g102(.a(new_n127_), .b(x27), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand4  g104(.a(x35), .b(new_n80_), .c(x27), .d(new_n138_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n166_), .c(new_n123_), .d(new_n64_), .O(z18));
  nand3  g106(.a(new_n167_), .b(new_n166_), .c(new_n123_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n64_), .O(z19));
  oai21  g108(.a(new_n134_), .b(new_n68_), .c(new_n123_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n164_), .c(new_n64_), .O(z20));
endmodule
