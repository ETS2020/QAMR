...
module FAU ( 
  ...
  oai21  g030(.a(new_n90_), .b(new_n86_), .c(new_n92_), .O(z02));
  inv1   g031(.a(x35), .O(new_n94_));
  nand2  g032(.a(x28), .b(x27), .O(new_n95_));
  oai22  g033(.a(new_n95_), .b(new_n94_), .c(new_n69_), .d(x27), .O(new_n96_));
  ...
  nand2  g038(.a(new_n95_), .b(new_n69_), .O(new_n101_));
  ...
  nor2   g055(.a(new_n117_), .b(new_n84_), .O(new_n118_));
  inv1   g056(.a(x05), .O(new_n119_));
  aoi21  g057(.a(x40), .b(x39), .c(x07), .O(new_n120_));
  aoi21  g058(.a(z08), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(new_n83_), .c(new_n118_), .O(new_n122_));
  nand3  g060(.a(x37), .b(x27), .c(x06), .O(new_n123_));
  and2   g061(.a(new_n123_), .b(new_n64_), .O(new_n124_));
  oai21  g062(.a(new_n122_), .b(x04), .c(new_n124_), .O(z10));
  nor2   g063(.a(x30), .b(x09), .O(new_n126_));
  nand2  g064(.a(x27), .b(new_n86_), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n82_), .c(new_n89_), .O(new_n128_));
  nand2  g066(.a(x39), .b(x29), .O(new_n129_));
  nand2  g067(.a(x27), .b(x04), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x35), .c(new_n81_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n126_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n64_), .O(z11));
  nor3   g073(.a(x37), .b(x36), .c(x35), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n68_), .c(new_n73_), .O(new_n137_));
  or2    g075(.a(new_n77_), .b(new_n71_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n64_), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  oai21  g078(.a(new_n80_), .b(new_n94_), .c(x28), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n77_), .c(new_n140_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n85_), .b(new_n77_), .c(new_n140_), .O(new_n148_));
  ...
  nand2  g092(.a(new_n154_), .b(new_n64_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(x23), .c(new_n64_), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x23), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n156_), .c(new_n64_), .O(z17));
  nand2  g098(.a(new_n130_), .b(new_n90_), .O(new_n161_));
  nand2  g099(.a(new_n129_), .b(x40), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x08), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n126_), .O(z18));
  nand2  g102(.a(new_n128_), .b(new_n63_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n133_), .c(new_n126_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z19));
  aoi21  g105(.a(new_n129_), .b(new_n82_), .c(new_n89_), .O(new_n168_));
  oai21  g106(.a(new_n94_), .b(new_n68_), .c(new_n126_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n64_), .O(z20));
endmodule
