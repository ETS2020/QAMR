...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n160_, new_n162_, new_n164_, new_n165_, new_n168_, new_n169_;
  ...
  nand2  g044(.a(x25), .b(new_n73_), .O(new_n107_));
  ...
  nand3  g055(.a(new_n117_), .b(new_n100_), .c(x11), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z09));
  aoi21  g057(.a(new_n78_), .b(new_n77_), .c(new_n88_), .O(new_n120_));
  ...
  nor2   g074(.a(new_n94_), .b(x04), .O(new_n137_));
  inv1   g075(.a(x09), .O(new_n138_));
  nand2  g076(.a(new_n77_), .b(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n137_), .b(new_n136_), .c(new_n139_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n135_), .c(new_n100_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand3  g081(.a(new_n100_), .b(new_n69_), .c(new_n143_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z12));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n120_), .O(new_n147_));
  nand2  g085(.a(new_n92_), .b(new_n95_), .O(new_n148_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n146_), .c(new_n68_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n147_), .c(new_n74_), .O(z13));
  inv1   g094(.a(new_n147_), .O(new_n157_));
  aoi21  g095(.a(new_n153_), .b(new_n150_), .c(new_n94_), .O(new_n158_));
  nor3   g096(.a(new_n158_), .b(new_n157_), .c(new_n74_), .O(z14));
  nand3  g097(.a(new_n117_), .b(new_n100_), .c(x12), .O(new_n160_));
  ...
  aoi21  g104(.a(new_n140_), .b(new_n135_), .c(new_n74_), .O(z18));
  nand2  g105(.a(x35), .b(x27), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n100_), .c(new_n77_), .d(new_n138_), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(new_n133_), .O(z20));
  inv1   g108(.a(new_n141_), .O(z19));
endmodule
