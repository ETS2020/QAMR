...
module FAU ( 
  ...
  nand2  g034(.a(new_n96_), .b(x12), .O(new_n97_));
  ...
  nand2  g051(.a(new_n97_), .b(x11), .O(new_n114_));
  ...
  aoi21  g058(.a(new_n78_), .b(new_n120_), .c(x04), .O(new_n121_));
  ...
  nor2   g062(.a(new_n81_), .b(new_n66_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x05), .O(new_n126_));
  oai21  g064(.a(new_n124_), .b(new_n116_), .c(new_n126_), .O(z10));
  ...
  nand3  g069(.a(new_n79_), .b(x27), .c(new_n65_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n97_), .O(new_n134_));
  aoi21  g072(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z11));
  nand2  g073(.a(new_n67_), .b(x27), .O(new_n136_));
  nand2  g074(.a(new_n69_), .b(new_n136_), .O(new_n137_));
  nand2  g075(.a(new_n97_), .b(new_n137_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  oai21  g077(.a(new_n120_), .b(new_n90_), .c(x28), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(z08), .c(new_n139_), .d(new_n65_), .O(new_n141_));
  inv1   g079(.a(new_n63_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n97_), .c(new_n142_), .d(x20), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  nand2  g084(.a(new_n125_), .b(new_n139_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z13));
  nand3  g086(.a(new_n143_), .b(new_n142_), .c(x20), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n141_), .c(new_n116_), .O(new_n150_));
  nand2  g088(.a(new_n147_), .b(new_n97_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(new_n150_), .O(z14));
  aoi21  g090(.a(new_n113_), .b(x40), .c(new_n73_), .O(z15));
  nand2  g091(.a(x22), .b(x01), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(x23), .c(new_n97_), .O(z16));
  inv1   g093(.a(x24), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x23), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n154_), .c(new_n97_), .O(z17));
  nand2  g096(.a(new_n131_), .b(new_n130_), .O(new_n159_));
  inv1   g097(.a(new_n134_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z18));
  oai21  g099(.a(new_n90_), .b(new_n116_), .c(new_n133_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n130_), .c(new_n97_), .O(z20));
  aoi21  g101(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z19));
endmodule
