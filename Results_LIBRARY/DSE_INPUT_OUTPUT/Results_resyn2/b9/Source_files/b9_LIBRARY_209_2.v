...
module FAU ( 
  ...
  nor2   g010(.a(x28), .b(new_n72_), .O(new_n73_));
  ...
  nor2   g020(.a(new_n73_), .b(new_n65_), .O(new_n83_));
  ...
  oai21  g032(.a(x27), .b(x25), .c(new_n78_), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g034(.a(x35), .b(x27), .O(new_n97_));
  aoi21  g035(.a(x37), .b(new_n76_), .c(new_n73_), .O(new_n98_));
  oai21  g036(.a(new_n97_), .b(new_n78_), .c(new_n98_), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n96_), .O(z03));
  nand2  g038(.a(new_n95_), .b(x21), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n99_), .O(z04));
  aoi21  g040(.a(x28), .b(x27), .c(x37), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n87_), .O(z05));
  inv1   g042(.a(new_n103_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n87_), .O(z06));
  nand2  g044(.a(new_n72_), .b(x00), .O(new_n107_));
  ...
  nand2  g053(.a(new_n115_), .b(new_n87_), .O(z07));
  nand2  g054(.a(new_n87_), .b(new_n85_), .O(z08));
  nand3  g055(.a(x34), .b(x27), .c(x26), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(new_n87_), .c(x11), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(z09));
  nor2   g059(.a(new_n81_), .b(new_n85_), .O(new_n122_));
  inv1   g060(.a(x07), .O(new_n123_));
  nand2  g061(.a(new_n85_), .b(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n80_), .c(new_n122_), .O(new_n125_));
  oai21  g063(.a(new_n85_), .b(x05), .c(new_n65_), .O(new_n126_));
  nand3  g064(.a(x37), .b(x27), .c(x06), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n73_), .O(new_n129_));
  oai21  g067(.a(new_n126_), .b(new_n125_), .c(new_n129_), .O(z10));
  nor2   g068(.a(x30), .b(x09), .O(new_n131_));
  nor2   g069(.a(new_n97_), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n78_), .c(x08), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n79_), .O(new_n135_));
  nand3  g073(.a(new_n134_), .b(x27), .c(x04), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n133_), .c(new_n131_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n87_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n87_), .b(new_n68_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n86_), .O(new_n146_));
  nor2   g084(.a(x19), .b(x18), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x20), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n63_), .c(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  aoi21  g088(.a(new_n145_), .b(new_n122_), .c(new_n73_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand2  g090(.a(new_n145_), .b(new_n86_), .O(new_n153_));
  nand3  g091(.a(new_n143_), .b(new_n81_), .c(x28), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(new_n148_), .O(new_n156_));
  inv1   g094(.a(x35), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x28), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(x37), .c(x27), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n81_), .O(new_n160_));
  inv1   g098(.a(new_n63_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x27), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n153_), .c(new_n73_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n160_), .c(new_n156_), .O(z14));
  nand3  g102(.a(new_n119_), .b(new_n87_), .c(x12), .O(new_n165_));
  ...
  nand4  g109(.a(new_n171_), .b(new_n87_), .c(new_n170_), .d(x23), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  nand2  g111(.a(new_n134_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n135_), .c(x08), .O(new_n175_));
  oai21  g113(.a(new_n132_), .b(x25), .c(new_n78_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n131_), .O(z18));
  and2   g115(.a(new_n135_), .b(x08), .O(new_n178_));
  nand2  g116(.a(new_n131_), .b(new_n97_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n178_), .c(new_n87_), .O(z20));
  nand2  g118(.a(new_n138_), .b(new_n87_), .O(z19));
endmodule
