...
module FAU ( 
  ...
  nor2   g009(.a(x22), .b(new_n71_), .O(new_n72_));
  ...
  aoi21  g053(.a(new_n115_), .b(x22), .c(new_n71_), .O(z09));
  nand3  g054(.a(x40), .b(x39), .c(x05), .O(new_n117_));
  nand2  g055(.a(new_n83_), .b(x07), .O(new_n118_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n85_), .O(z11));
  nand2  g077(.a(new_n85_), .b(new_n69_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  aoi21  g079(.a(x36), .b(x35), .c(new_n76_), .O(new_n142_));
  inv1   g080(.a(x13), .O(new_n143_));
  nand3  g081(.a(new_n84_), .b(new_n143_), .c(new_n63_), .O(new_n144_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n148_), .c(new_n72_), .O(z13));
  nand2  g089(.a(new_n142_), .b(new_n80_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n146_), .O(new_n154_));
  aoi21  g092(.a(new_n76_), .b(x27), .c(new_n121_), .O(new_n155_));
  oai22  g093(.a(new_n155_), .b(new_n144_), .c(new_n66_), .d(new_n134_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n154_), .c(new_n85_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  nor3   g096(.a(new_n115_), .b(new_n72_), .c(new_n158_), .O(z15));
  ...
  nand3  g102(.a(new_n137_), .b(new_n132_), .c(new_n85_), .O(z18));
  inv1   g103(.a(z18), .O(z19));
  nor2   g104(.a(new_n92_), .b(new_n134_), .O(new_n167_));
  nor4   g105(.a(new_n167_), .b(new_n136_), .c(new_n130_), .d(new_n72_), .O(z20));
endmodule
