...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n157_, new_n158_, new_n162_, new_n163_;
  ...
  nor2   g010(.a(x23), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g094(.a(new_n157_), .b(x01), .O(new_n158_));
  aoi21  g095(.a(new_n158_), .b(x23), .c(new_n72_), .O(z17));
  nand3  g096(.a(new_n135_), .b(new_n130_), .c(new_n98_), .O(z18));
  inv1   g097(.a(z18), .O(z19));
  nand2  g098(.a(x35), .b(x27), .O(new_n162_));
  nand3  g099(.a(new_n162_), .b(new_n81_), .c(new_n133_), .O(new_n163_));
  oai21  g100(.a(new_n163_), .b(new_n128_), .c(new_n98_), .O(z20));
  zero   g101(.O(z16));
endmodule
