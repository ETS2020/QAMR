...
module FAU ( 
  ...
  oai21  g055(.a(new_n82_), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  ...
  nor2   g063(.a(new_n112_), .b(x04), .O(new_n126_));
  inv1   g064(.a(new_n78_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(x05), .O(new_n128_));
  oai21  g066(.a(new_n125_), .b(new_n84_), .c(new_n128_), .O(z10));
  nand2  g067(.a(z08), .b(x29), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n121_), .c(new_n83_), .O(new_n131_));
  nand2  g069(.a(new_n130_), .b(x27), .O(new_n132_));
  nand4  g070(.a(x35), .b(new_n120_), .c(x27), .d(new_n65_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n90_), .O(new_n135_));
  ...
  nand2  g076(.a(new_n90_), .b(new_n138_), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  oai21  g078(.a(new_n119_), .b(new_n75_), .c(x28), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n126_), .c(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n91_), .b(new_n93_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(new_n90_), .c(new_n143_), .d(x20), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand3  g085(.a(new_n127_), .b(new_n126_), .c(new_n140_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n147_), .O(z13));
  nand3  g087(.a(new_n144_), .b(new_n143_), .c(x20), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n142_), .O(new_n151_));
  nand2  g089(.a(new_n148_), .b(new_n90_), .O(new_n152_));
  aoi21  g090(.a(new_n151_), .b(x27), .c(new_n152_), .O(z14));
  nand4  g091(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n90_), .O(z15));
  nand2  g093(.a(x22), .b(x01), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g095(.a(x23), .O(new_n158_));
  nor2   g096(.a(x24), .b(new_n158_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n90_), .c(x22), .d(x01), .O(new_n160_));
  ...
  oai21  g102(.a(new_n75_), .b(new_n84_), .c(new_n134_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n131_), .c(new_n90_), .O(z20));
  aoi21  g104(.a(new_n132_), .b(new_n131_), .c(new_n135_), .O(z19));
endmodule
