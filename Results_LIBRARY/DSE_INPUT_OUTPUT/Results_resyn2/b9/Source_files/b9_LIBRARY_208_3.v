...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n149_, new_n151_, new_n154_, new_n155_;
  ...
  nand2  g20(.a(new_n82_), .b(new_n70_), .O(new_n83_));
  nand2  g21(.a(new_n83_), .b(x27), .O(new_n84_));
  nand3  g22(.a(new_n84_), .b(new_n80_), .c(new_n79_), .O(new_n85_));
  aoi21  g23(.a(new_n85_), .b(x04), .c(new_n64_), .O(z01));
  nor2   g24(.a(x27), .b(x08), .O(new_n87_));
  oai21  g25(.a(new_n87_), .b(new_n82_), .c(x04), .O(new_n88_));
  ...
  nand2  g43(.a(x34), .b(x27), .O(new_n106_));
  nand2  g44(.a(x26), .b(x11), .O(new_n107_));
  oai21  g45(.a(new_n107_), .b(new_n106_), .c(new_n63_), .O(z09));
  aoi21  g46(.a(new_n80_), .b(new_n79_), .c(new_n89_), .O(new_n109_));
  inv1   g47(.a(new_n109_), .O(new_n110_));
  inv1   g48(.a(x07), .O(new_n111_));
  nand2  g49(.a(new_n89_), .b(new_n111_), .O(new_n112_));
  nand3  g50(.a(new_n112_), .b(new_n83_), .c(x27), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  ...
  inv1   g62(.a(new_n82_), .O(new_n125_));
  ...
  nand3  g67(.a(new_n129_), .b(new_n124_), .c(new_n63_), .O(new_n130_));
  ...
  nand2  g73(.a(new_n135_), .b(new_n109_), .O(new_n136_));
  inv1   g74(.a(new_n67_), .O(new_n137_));
  nor2   g75(.a(x19), .b(x18), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(new_n137_), .c(x20), .O(new_n139_));
  oai21  g77(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n140_));
  nand3  g78(.a(new_n140_), .b(new_n135_), .c(new_n72_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(x27), .O(new_n143_));
  aoi21  g81(.a(new_n143_), .b(new_n136_), .c(new_n64_), .O(z13));
  nand2  g82(.a(new_n143_), .b(new_n136_), .O(new_n145_));
  nand2  g83(.a(new_n145_), .b(new_n63_), .O(z14));
  nand3  g84(.a(new_n63_), .b(x26), .c(x12), .O(new_n147_));
  nor2   g85(.a(new_n147_), .b(new_n106_), .O(z15));
  nand2  g86(.a(x22), .b(x01), .O(new_n149_));
  oai21  g87(.a(new_n149_), .b(x23), .c(new_n63_), .O(z16));
  inv1   g88(.a(x23), .O(new_n151_));
  nor4   g89(.a(new_n149_), .b(new_n64_), .c(x24), .d(new_n151_), .O(z17));
  aoi21  g90(.a(new_n129_), .b(new_n124_), .c(new_n64_), .O(z18));
  nand2  g91(.a(x35), .b(x27), .O(new_n154_));
  nand4  g92(.a(new_n154_), .b(new_n63_), .c(new_n79_), .d(new_n127_), .O(new_n155_));
  nor2   g93(.a(new_n155_), .b(new_n122_), .O(z20));
  inv1   g94(.a(new_n130_), .O(z19));
endmodule
