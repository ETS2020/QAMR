...
module FAU ( 
  ...
  nand2  g025(.a(new_n87_), .b(new_n78_), .O(new_n88_));
  aoi21  g026(.a(new_n88_), .b(x04), .c(new_n84_), .O(new_n89_));
  oai21  g027(.a(new_n89_), .b(new_n82_), .c(z08), .O(z02));
  ...
  inv1   g038(.a(new_n72_), .O(new_n101_));
  ...
  aoi21  g059(.a(new_n121_), .b(new_n119_), .c(x04), .O(new_n122_));
  ...
  inv1   g064(.a(new_n117_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n65_), .O(new_n128_));
  oai21  g066(.a(new_n125_), .b(new_n86_), .c(new_n128_), .O(z10));
  nand3  g067(.a(x40), .b(x39), .c(x29), .O(new_n130_));
  oai21  g068(.a(new_n121_), .b(x27), .c(new_n130_), .O(new_n131_));
  nand3  g069(.a(new_n78_), .b(x27), .c(new_n65_), .O(new_n132_));
  inv1   g070(.a(x09), .O(new_n133_));
  nand2  g071(.a(new_n75_), .b(new_n133_), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(new_n72_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  aoi21  g074(.a(new_n131_), .b(x08), .c(new_n136_), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand3  g076(.a(new_n101_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  ...
  nor2   g081(.a(new_n143_), .b(new_n63_), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  inv1   g083(.a(x13), .O(new_n146_));
  nand4  g084(.a(x40), .b(x39), .c(new_n146_), .d(new_n65_), .O(new_n147_));
  aoi21  g085(.a(new_n145_), .b(x28), .c(new_n147_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n144_), .c(x27), .O(new_n149_));
  inv1   g087(.a(x40), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n82_), .O(new_n151_));
  nor2   g089(.a(x13), .b(x04), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n126_), .c(new_n151_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n149_), .c(new_n101_), .O(z13));
  nand2  g092(.a(new_n153_), .b(new_n101_), .O(new_n155_));
  inv1   g093(.a(new_n63_), .O(new_n156_));
  inv1   g094(.a(new_n143_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  inv1   g096(.a(new_n145_), .O(new_n159_));
  nand4  g097(.a(new_n152_), .b(new_n159_), .c(new_n151_), .d(new_n156_), .O(new_n160_));
  nand3  g098(.a(new_n152_), .b(new_n151_), .c(new_n120_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(x27), .c(new_n155_), .O(z14));
  inv1   g101(.a(x12), .O(new_n164_));
  oai21  g102(.a(new_n114_), .b(new_n164_), .c(new_n101_), .O(z15));
  nand2  g103(.a(x22), .b(x01), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(x23), .c(new_n101_), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x23), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n166_), .c(new_n101_), .O(z17));
  aoi21  g108(.a(new_n86_), .b(new_n85_), .c(new_n121_), .O(new_n171_));
  nand2  g109(.a(x27), .b(x04), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(new_n134_), .O(new_n173_));
  nand3  g111(.a(new_n151_), .b(x29), .c(x08), .O(new_n174_));
  oai21  g112(.a(new_n173_), .b(new_n72_), .c(new_n174_), .O(z18));
  aoi21  g113(.a(new_n130_), .b(new_n121_), .c(new_n85_), .O(new_n176_));
  oai21  g114(.a(new_n77_), .b(new_n86_), .c(new_n135_), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n176_), .O(z20));
  aoi21  g116(.a(new_n131_), .b(x08), .c(new_n136_), .O(z19));
endmodule
