...
module FAU ( 
  ...
  nand3  g71(.a(new_n133_), .b(new_n128_), .c(new_n63_), .O(new_n134_));
  ...
  nor4   g93(.a(new_n155_), .b(new_n64_), .c(x24), .d(new_n152_), .O(z17));
  aoi21  g94(.a(new_n133_), .b(new_n128_), .c(new_n64_), .O(z18));
  nand2  g95(.a(x35), .b(x27), .O(new_n158_));
  nand4  g96(.a(new_n158_), .b(new_n63_), .c(new_n85_), .d(new_n131_), .O(new_n159_));
  nor2   g97(.a(new_n159_), .b(new_n126_), .O(z20));
  inv1   g98(.a(new_n134_), .O(z19));
endmodule
