...
module FAU ( 
  ...
  aoi21  g033(.a(new_n93_), .b(new_n84_), .c(x21), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n92_), .c(new_n72_), .O(z04));
  ...
  nor2   g050(.a(new_n81_), .b(new_n112_), .O(z08));
  inv1   g051(.a(x11), .O(new_n114_));
  nand4  g052(.a(new_n90_), .b(x34), .c(x27), .d(x26), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  inv1   g054(.a(x07), .O(new_n117_));
  nand3  g055(.a(x40), .b(x39), .c(x05), .O(new_n118_));
  oai21  g056(.a(new_n82_), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  inv1   g057(.a(x36), .O(new_n120_));
  nand2  g058(.a(x35), .b(new_n91_), .O(new_n121_));
  ...
  inv1   g064(.a(x32), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  inv1   g066(.a(new_n118_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n65_), .O(new_n130_));
  oai21  g068(.a(new_n125_), .b(new_n84_), .c(new_n130_), .O(z10));
  nand3  g069(.a(x40), .b(x39), .c(x29), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n121_), .c(new_n83_), .O(new_n133_));
  nand2  g071(.a(new_n132_), .b(x27), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nor2   g073(.a(x30), .b(x09), .O(new_n136_));
  nand3  g074(.a(new_n76_), .b(x27), .c(new_n65_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n90_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n90_), .b(new_n68_), .c(new_n140_), .O(new_n141_));
  ...
  inv1   g084(.a(new_n63_), .O(new_n147_));
  ...
  nand2  g090(.a(new_n152_), .b(new_n146_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n143_), .b(z08), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n128_), .c(new_n72_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n154_), .O(z13));
  nand3  g096(.a(new_n144_), .b(new_n78_), .c(x28), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n155_), .c(new_n150_), .O(new_n161_));
  aoi21  g099(.a(new_n91_), .b(x27), .c(new_n128_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n155_), .c(new_n63_), .d(new_n84_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n90_), .O(z14));
  inv1   g102(.a(x12), .O(new_n165_));
  nor2   g103(.a(new_n115_), .b(new_n165_), .O(z15));
  nand2  g104(.a(x22), .b(x01), .O(new_n167_));
  nor3   g105(.a(new_n167_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g106(.a(x24), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x23), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n167_), .c(new_n90_), .O(z17));
  aoi21  g109(.a(new_n84_), .b(new_n83_), .c(new_n121_), .O(new_n172_));
  inv1   g110(.a(new_n136_), .O(new_n173_));
  nand2  g111(.a(x27), .b(x04), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g113(.a(z08), .b(x29), .c(x08), .O(new_n176_));
  oai21  g114(.a(new_n175_), .b(new_n72_), .c(new_n176_), .O(z18));
  oai21  g115(.a(new_n75_), .b(new_n84_), .c(new_n136_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n133_), .c(new_n90_), .O(z20));
  nand2  g117(.a(new_n138_), .b(new_n90_), .O(z19));
endmodule
