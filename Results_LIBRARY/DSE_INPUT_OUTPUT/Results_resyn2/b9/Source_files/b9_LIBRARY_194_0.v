...
module FAU ( 
  ...
  nor2   g011(.a(x40), .b(x19), .O(new_n74_));
  ...
  inv1   g026(.a(new_n74_), .O(new_n89_));
  ...
  inv1   g049(.a(new_n68_), .O(z08));
  inv1   g050(.a(x11), .O(new_n113_));
  nand4  g051(.a(new_n89_), .b(x34), .c(x27), .d(x26), .O(new_n114_));
  nor2   g052(.a(new_n114_), .b(new_n113_), .O(z09));
  inv1   g053(.a(x05), .O(new_n116_));
  nand2  g054(.a(new_n68_), .b(x07), .O(new_n117_));
  oai22  g055(.a(new_n117_), .b(new_n74_), .c(new_n68_), .d(new_n116_), .O(new_n118_));
  inv1   g056(.a(x36), .O(new_n119_));
  aoi21  g057(.a(new_n78_), .b(new_n119_), .c(x04), .O(new_n120_));
  ...
  nor2   g061(.a(new_n81_), .b(new_n66_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x05), .O(new_n125_));
  oai21  g063(.a(new_n123_), .b(new_n92_), .c(new_n125_), .O(z10));
  ...
  nand3  g068(.a(new_n79_), .b(x27), .c(new_n65_), .O(new_n131_));
  nor3   g069(.a(new_n74_), .b(x30), .c(x09), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  aoi21  g071(.a(new_n130_), .b(new_n129_), .c(new_n133_), .O(z11));
  and2   g072(.a(new_n67_), .b(x27), .O(new_n135_));
  oai21  g073(.a(new_n71_), .b(new_n135_), .c(new_n89_), .O(z12));
  aoi21  g074(.a(x36), .b(x35), .c(new_n77_), .O(new_n137_));
  inv1   g075(.a(x13), .O(new_n138_));
  nand2  g076(.a(new_n69_), .b(new_n138_), .O(new_n139_));
  nor2   g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  inv1   g078(.a(x18), .O(new_n141_));
  nand2  g079(.a(x20), .b(new_n141_), .O(new_n142_));
  nor3   g080(.a(new_n142_), .b(new_n63_), .c(x19), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n140_), .c(x27), .O(new_n144_));
  aoi21  g082(.a(new_n124_), .b(new_n138_), .c(new_n74_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  inv1   g084(.a(new_n81_), .O(new_n147_));
  inv1   g085(.a(x40), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(x27), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nor2   g088(.a(x37), .b(x35), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n142_), .c(x40), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n137_), .c(new_n149_), .O(new_n154_));
  nand3  g092(.a(x27), .b(x20), .c(new_n141_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n63_), .c(x40), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n150_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n139_), .O(new_n158_));
  oai21  g096(.a(new_n154_), .b(new_n147_), .c(new_n158_), .O(z14));
  inv1   g097(.a(x12), .O(new_n160_));
  nor2   g098(.a(new_n114_), .b(new_n160_), .O(z15));
  nand2  g099(.a(x22), .b(x01), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x23), .c(new_n89_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x23), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n162_), .c(new_n89_), .O(z17));
  inv1   g104(.a(z11), .O(z18));
  oai21  g105(.a(new_n90_), .b(new_n92_), .c(new_n132_), .O(new_n168_));
