...
module FAU ( 
  ...
  nand2  g012(.a(x33), .b(new_n74_), .O(new_n75_));
  ...
  nor2   g022(.a(x33), .b(x16), .O(new_n85_));
  ...
  aoi21  g034(.a(new_n96_), .b(new_n77_), .c(new_n85_), .O(new_n97_));
  ...
  inv1   g041(.a(new_n85_), .O(new_n104_));
  ...
  nand2  g053(.a(new_n104_), .b(new_n90_), .O(z08));
  nand2  g054(.a(x34), .b(x27), .O(new_n117_));
  nand2  g055(.a(x26), .b(x11), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(new_n117_), .c(new_n104_), .O(z09));
  aoi21  g057(.a(new_n83_), .b(new_n82_), .c(new_n90_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n90_), .b(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n81_), .c(new_n120_), .O(new_n123_));
  ...
  nor2   g064(.a(new_n126_), .b(new_n85_), .O(new_n127_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n79_), .c(new_n65_), .O(new_n135_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n104_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n104_), .b(new_n69_), .c(new_n140_), .O(new_n141_));
  ...
  nor3   g095(.a(new_n157_), .b(new_n117_), .c(new_n85_), .O(z15));
  ...
  nand4  g100(.a(new_n162_), .b(new_n104_), .c(new_n161_), .d(x23), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z17));
  nand3  g102(.a(new_n137_), .b(new_n133_), .c(new_n104_), .O(z18));
  nor2   g103(.a(new_n134_), .b(new_n85_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n136_), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(new_n131_), .O(z20));
  nand2  g106(.a(new_n138_), .b(new_n104_), .O(z19));
endmodule
