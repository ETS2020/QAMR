...
module FAU ( 
  ...
  nand2  g013(.a(x40), .b(new_n72_), .O(new_n76_));
  ...
  nand3  g027(.a(x40), .b(x39), .c(x16), .O(new_n90_));
  nor2   g028(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n88_), .O(z02));
  oai21  g030(.a(new_n78_), .b(new_n85_), .c(x27), .O(new_n93_));
  nor2   g031(.a(x37), .b(x27), .O(new_n94_));
  nor2   g032(.a(new_n94_), .b(new_n77_), .O(new_n95_));
  ...
  nand2  g037(.a(new_n99_), .b(new_n76_), .O(z05));
  inv1   g038(.a(new_n99_), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n76_), .O(z06));
  ...
  nand2  g055(.a(x39), .b(new_n117_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(x16), .c(new_n73_), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(x40), .b(x39), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n80_), .c(new_n63_), .O(new_n123_));
  nand3  g061(.a(new_n76_), .b(x37), .c(x06), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(new_n119_), .c(new_n124_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  inv1   g064(.a(new_n82_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(new_n65_), .c(x16), .d(x05), .O(new_n128_));
  ...
  nand4  g072(.a(x35), .b(new_n85_), .c(x27), .d(new_n63_), .O(new_n135_));
  nor2   g073(.a(x30), .b(x09), .O(new_n136_));
  and2   g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n134_), .c(new_n76_), .O(z18));
  ...
  nand2  g080(.a(new_n76_), .b(new_n142_), .O(z12));
  ...
  nand3  g090(.a(new_n149_), .b(new_n127_), .c(x39), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x16), .c(new_n73_), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n152_), .O(z13));
  inv1   g094(.a(new_n146_), .O(new_n157_));
  nand3  g095(.a(new_n148_), .b(new_n82_), .c(x28), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n149_), .c(x39), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x16), .c(new_n73_), .O(new_n160_));
  inv1   g098(.a(x27), .O(new_n161_));
  nand4  g099(.a(new_n149_), .b(x40), .c(x39), .d(new_n85_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n66_), .c(new_n161_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n154_), .c(new_n160_), .d(new_n157_), .O(z14));
  nand4  g102(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n76_), .O(z15));
  inv1   g104(.a(x01), .O(new_n167_));
  inv1   g105(.a(x22), .O(new_n168_));
  nor4   g106(.a(new_n77_), .b(x23), .c(new_n168_), .d(new_n167_), .O(z16));
  inv1   g107(.a(x24), .O(new_n170_));
  nor2   g108(.a(new_n168_), .b(new_n167_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n76_), .c(new_n170_), .d(x23), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  nand2  g111(.a(new_n137_), .b(new_n134_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n76_), .O(z19));
  oai21  g113(.a(new_n78_), .b(new_n161_), .c(new_n136_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n132_), .c(new_n76_), .O(z20));
endmodule
