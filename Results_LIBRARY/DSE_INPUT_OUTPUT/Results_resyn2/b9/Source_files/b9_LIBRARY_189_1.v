...
module FAU ( 
  ...
  oai21  g047(.a(x15), .b(new_n107_), .c(x13), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(x17), .O(new_n111_));
  oai21  g049(.a(x33), .b(x31), .c(x14), .O(new_n112_));
  nand4  g050(.a(new_n112_), .b(new_n111_), .c(new_n109_), .d(x03), .O(new_n113_));
  ...
  aoi21  g057(.a(new_n88_), .b(x05), .c(new_n78_), .O(new_n120_));
  nand2  g058(.a(new_n90_), .b(new_n73_), .O(new_n121_));
  nand3  g059(.a(new_n121_), .b(x27), .c(x07), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n78_), .O(new_n123_));
  ...
  oai21  g065(.a(new_n124_), .b(new_n120_), .c(new_n127_), .O(z10));
  ...
  nand3  g079(.a(new_n80_), .b(new_n141_), .c(new_n84_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  oai21  g082(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n79_), .c(new_n144_), .O(new_n146_));
  ...
  oai21  g089(.a(new_n87_), .b(new_n151_), .c(new_n63_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(z13));
  nor3   g092(.a(new_n87_), .b(new_n151_), .c(x13), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n149_), .c(new_n84_), .O(z14));
  nand3  g094(.a(new_n117_), .b(new_n84_), .c(x12), .O(new_n157_));
  ...
  aoi21  g101(.a(new_n138_), .b(new_n133_), .c(new_n64_), .O(z18));
  nand3  g102(.a(new_n138_), .b(new_n133_), .c(new_n84_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z19));
  oai21  g104(.a(new_n72_), .b(new_n66_), .c(new_n136_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n131_), .c(new_n84_), .O(z20));
endmodule
