...
module FAU ( 
  ...
  nand2  g007(.a(x10), .b(new_n69_), .O(new_n70_));
  ...
  oai21  g011(.a(new_n68_), .b(x04), .c(new_n73_), .O(new_n74_));
  ...
  nand2  g017(.a(x35), .b(new_n73_), .O(new_n80_));
  nand2  g018(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  nand2  g019(.a(new_n81_), .b(new_n76_), .O(new_n82_));
  nor2   g020(.a(x32), .b(x30), .O(new_n83_));
  nand2  g021(.a(new_n81_), .b(x27), .O(new_n84_));
  nand3  g022(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  ...
  aoi21  g028(.a(new_n90_), .b(new_n89_), .c(new_n68_), .O(new_n91_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n75_), .c(new_n64_), .O(new_n96_));
  ...
  nand2  g039(.a(new_n101_), .b(new_n100_), .O(z05));
  ...
  nor2   g060(.a(new_n121_), .b(new_n83_), .O(new_n123_));
  aoi21  g061(.a(new_n122_), .b(new_n119_), .c(new_n123_), .O(new_n124_));
  inv1   g062(.a(new_n67_), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(x06), .c(new_n64_), .O(new_n126_));
  oai21  g064(.a(new_n124_), .b(x04), .c(new_n126_), .O(z10));
  inv1   g065(.a(x08), .O(new_n128_));
  nand3  g066(.a(x40), .b(x39), .c(x29), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n80_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  nand4  g071(.a(x35), .b(new_n73_), .c(x27), .d(new_n69_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n100_), .O(z11));
  aoi22  g074(.a(new_n77_), .b(new_n74_), .c(new_n71_), .d(new_n100_), .O(z12));
  inv1   g075(.a(new_n68_), .O(new_n138_));
  nor2   g076(.a(x13), .b(x04), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(x28), .c(x20), .O(new_n142_));
  oai21  g080(.a(new_n140_), .b(new_n63_), .c(new_n142_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n77_), .O(new_n144_));
  nand2  g082(.a(new_n83_), .b(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n139_), .c(new_n138_), .O(new_n146_));
  nand3  g084(.a(new_n141_), .b(x37), .c(x20), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n140_), .b(new_n83_), .c(new_n75_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n100_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n144_), .O(z13));
  nand3  g089(.a(new_n139_), .b(new_n138_), .c(x27), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x35), .c(new_n63_), .O(new_n153_));
  oai21  g091(.a(x28), .b(new_n75_), .c(new_n83_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n139_), .c(new_n138_), .O(new_n155_));
  nand2  g093(.a(new_n93_), .b(new_n95_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n141_), .c(x27), .d(x20), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(new_n153_), .O(z14));
  nand4  g097(.a(new_n116_), .b(new_n100_), .c(x26), .d(x12), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z15));
  nand2  g099(.a(x22), .b(x01), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x23), .c(new_n100_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x23), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n162_), .c(new_n100_), .O(z17));
  oai21  g104(.a(new_n90_), .b(new_n68_), .c(new_n133_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n100_), .O(new_n168_));
  nor2   g106(.a(new_n87_), .b(new_n80_), .O(new_n169_));
  oai21  g107(.a(new_n75_), .b(new_n69_), .c(new_n169_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n168_), .O(z18));
  nor2   g109(.a(new_n77_), .b(new_n64_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n133_), .O(new_n173_));
  nor2   g111(.a(new_n173_), .b(new_n130_), .O(z20));
  nand2  g112(.a(new_n135_), .b(new_n100_), .O(z19));
endmodule
