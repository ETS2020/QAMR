...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n93_, new_n95_, new_n96_, new_n97_, new_n98_, new_n100_, new_n104_,
  ...
  inv1   g009(.a(x03), .O(new_n72_));
  nor2   g010(.a(x17), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g031(.a(new_n93_), .b(new_n90_), .c(new_n88_), .d(new_n87_), .O(z02));
  ...
  aoi21  g036(.a(new_n98_), .b(x21), .c(new_n73_), .O(z03));
  inv1   g037(.a(x21), .O(new_n100_));
  aoi21  g038(.a(new_n98_), .b(new_n100_), .c(new_n73_), .O(z04));
  nand3  g039(.a(new_n97_), .b(new_n88_), .c(new_n96_), .O(z05));
  inv1   g040(.a(z05), .O(z06));
  inv1   g041(.a(x31), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(x15), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(x33), .c(x14), .O(new_n106_));
  ...
  nand4  g049(.a(new_n111_), .b(new_n106_), .c(x17), .d(x03), .O(new_n112_));
  inv1   g050(.a(new_n112_), .O(z07));
  nand2  g051(.a(new_n88_), .b(new_n86_), .O(z08));
  nand4  g052(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n88_), .O(z09));
  aoi21  g054(.a(new_n82_), .b(new_n81_), .c(new_n86_), .O(new_n117_));
  inv1   g055(.a(x07), .O(new_n118_));
  nand2  g056(.a(new_n86_), .b(new_n118_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n80_), .c(new_n117_), .O(new_n120_));
  oai21  g058(.a(new_n86_), .b(x05), .c(new_n65_), .O(new_n121_));
  nand3  g059(.a(x37), .b(x27), .c(x06), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(new_n123_));
  nor2   g061(.a(new_n123_), .b(new_n73_), .O(new_n124_));
  oai21  g062(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(z10));
  inv1   g063(.a(x08), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x29), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n79_), .c(new_n126_), .O(new_n128_));
  nand2  g066(.a(new_n127_), .b(x27), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  inv1   g068(.a(new_n79_), .O(new_n131_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n88_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand3  g076(.a(new_n88_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z12));
  inv1   g078(.a(new_n63_), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(x20), .O(new_n143_));
  oai21  g081(.a(new_n77_), .b(new_n95_), .c(x28), .O(new_n144_));
  nor2   g082(.a(x13), .b(x04), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n87_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand2  g086(.a(new_n145_), .b(new_n117_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n88_), .O(z13));
  nand2  g088(.a(new_n149_), .b(new_n88_), .O(new_n151_));
  aoi21  g089(.a(new_n147_), .b(x27), .c(new_n151_), .O(z14));
  nand4  g090(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n88_), .O(z15));
  inv1   g092(.a(x01), .O(new_n155_));
  inv1   g093(.a(x22), .O(new_n156_));
  nor4   g094(.a(new_n73_), .b(x23), .c(new_n156_), .d(new_n155_), .O(z16));
  inv1   g095(.a(x24), .O(new_n158_));
  nor2   g096(.a(new_n156_), .b(new_n155_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n88_), .c(new_n158_), .d(x23), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z17));
  aoi21  g099(.a(new_n135_), .b(new_n130_), .c(new_n73_), .O(z18));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n81_), .c(new_n133_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n128_), .c(new_n88_), .O(z20));
  inv1   g103(.a(new_n136_), .O(z19));
endmodule
