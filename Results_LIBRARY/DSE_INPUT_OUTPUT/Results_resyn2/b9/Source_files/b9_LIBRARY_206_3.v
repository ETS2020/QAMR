...
module FAU ( 
  ...
  nand2  g07(.a(x21), .b(x15), .O(new_n70_));
  ...
  oai21  g33(.a(new_n95_), .b(x15), .c(x21), .O(z03));
  inv1   g34(.a(x21), .O(new_n97_));
  aoi21  g35(.a(new_n95_), .b(new_n97_), .c(new_n81_), .O(z04));
  aoi21  g36(.a(new_n94_), .b(new_n93_), .c(new_n81_), .O(z05));
  nand3  g37(.a(new_n94_), .b(new_n70_), .c(new_n93_), .O(new_n100_));
  ...
  nand2  g49(.a(new_n111_), .b(new_n70_), .O(z07));
  nand2  g50(.a(new_n70_), .b(new_n84_), .O(z08));
  nand3  g51(.a(x34), .b(x27), .c(x26), .O(new_n114_));
  nand2  g52(.a(new_n70_), .b(x11), .O(new_n115_));
  nor2   g53(.a(new_n115_), .b(new_n114_), .O(z09));
  nand2  g54(.a(new_n76_), .b(new_n74_), .O(new_n117_));
  nand3  g55(.a(x40), .b(x39), .c(x05), .O(new_n118_));
  nand2  g56(.a(new_n84_), .b(x07), .O(new_n119_));
  ...
  nand2  g60(.a(new_n122_), .b(new_n80_), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(new_n63_), .O(new_n125_));
  nand3  g63(.a(x37), .b(x27), .c(x06), .O(new_n126_));
  aoi21  g64(.a(new_n126_), .b(new_n125_), .c(new_n81_), .O(z10));
  inv1   g65(.a(x08), .O(new_n128_));
  nand2  g66(.a(new_n85_), .b(x29), .O(new_n129_));
  aoi21  g67(.a(new_n129_), .b(new_n76_), .c(new_n128_), .O(new_n130_));
  nand2  g68(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g70(.a(x35), .b(new_n75_), .c(x27), .d(new_n63_), .O(new_n133_));
  nor2   g71(.a(x30), .b(x09), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n70_), .O(z11));
  ...
  oai21  g90(.a(new_n114_), .b(new_n152_), .c(new_n70_), .O(z15));
  inv1   g91(.a(x23), .O(new_n154_));
  nand4  g92(.a(new_n70_), .b(new_n154_), .c(x22), .d(x01), .O(new_n155_));
  inv1   g93(.a(new_n155_), .O(z16));
  nand2  g94(.a(x22), .b(x01), .O(new_n157_));
  nor4   g95(.a(new_n157_), .b(new_n81_), .c(x24), .d(new_n154_), .O(z17));
  nand4  g96(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n70_), .O(z18));
  oai21  g97(.a(new_n92_), .b(new_n73_), .c(new_n134_), .O(new_n160_));
  oai21  g98(.a(new_n160_), .b(new_n130_), .c(new_n70_), .O(z20));
  nand2  g99(.a(new_n135_), .b(new_n70_), .O(z19));
endmodule
