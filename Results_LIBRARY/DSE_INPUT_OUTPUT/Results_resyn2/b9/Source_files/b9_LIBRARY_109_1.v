...
module FAU ( 
  ...
  nand2  g054(.a(new_n84_), .b(new_n72_), .O(new_n117_));
  nand2  g055(.a(new_n80_), .b(new_n70_), .O(new_n118_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n79_), .c(new_n68_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  and2   g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n132_), .c(new_n99_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  inv1   g076(.a(new_n74_), .O(new_n139_));
  nand3  g077(.a(new_n75_), .b(new_n139_), .c(new_n99_), .O(new_n140_));
  ...
  oai22  g084(.a(new_n146_), .b(new_n144_), .c(new_n143_), .d(new_n67_), .O(new_n147_));
  nand3  g085(.a(new_n145_), .b(new_n84_), .c(new_n72_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n99_), .O(new_n149_));
  aoi21  g087(.a(new_n147_), .b(x27), .c(new_n149_), .O(z14));
  inv1   g088(.a(z14), .O(z13));
  nand3  g089(.a(new_n114_), .b(new_n99_), .c(x12), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(z15));
  inv1   g091(.a(x01), .O(new_n154_));
  inv1   g092(.a(x22), .O(new_n155_));
  nor4   g093(.a(new_n64_), .b(x23), .c(new_n155_), .d(new_n154_), .O(z16));
  inv1   g094(.a(x24), .O(new_n157_));
  nor2   g095(.a(new_n155_), .b(new_n154_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n99_), .c(new_n157_), .d(x23), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z17));
  nand2  g098(.a(new_n136_), .b(new_n132_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n99_), .O(z19));
  nor2   g100(.a(new_n133_), .b(new_n64_), .O(new_n163_));
