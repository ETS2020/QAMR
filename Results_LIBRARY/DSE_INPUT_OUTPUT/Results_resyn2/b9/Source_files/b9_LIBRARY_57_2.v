...
module FAU ( 
  ...
  aoi21  g059(.a(new_n63_), .b(x39), .c(new_n121_), .O(new_n122_));
  ...
  nand2  g072(.a(new_n76_), .b(x40), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(x39), .c(new_n70_), .O(z12));
  ...
  nand2  g083(.a(new_n145_), .b(x39), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n143_), .O(z13));
  aoi22  g085(.a(new_n145_), .b(x39), .c(new_n142_), .d(x27), .O(z14));
