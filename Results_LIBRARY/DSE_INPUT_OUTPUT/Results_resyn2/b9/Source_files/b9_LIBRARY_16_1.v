...
module FAU ( 
  ...
  nand2  g014(.a(x27), .b(new_n69_), .O(new_n77_));
  aoi21  g015(.a(new_n63_), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  aoi21  g016(.a(new_n78_), .b(new_n75_), .c(new_n73_), .O(new_n79_));
  aoi21  g017(.a(new_n79_), .b(new_n72_), .c(new_n64_), .O(z00));
  ...
  oai21  g031(.a(new_n76_), .b(new_n86_), .c(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n66_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n93_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n95_), .b(new_n66_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n64_), .O(z04));
  oai21  g037(.a(new_n86_), .b(new_n66_), .c(new_n95_), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n93_), .O(z06));
  ...
  nand2  g051(.a(new_n74_), .b(new_n93_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand3  g053(.a(x34), .b(x27), .c(x26), .O(new_n116_));
  nor3   g054(.a(new_n116_), .b(new_n64_), .c(new_n115_), .O(z09));
  aoi21  g055(.a(new_n87_), .b(new_n63_), .c(new_n66_), .O(new_n118_));
  ...
  nor2   g059(.a(new_n119_), .b(new_n81_), .O(new_n122_));
  aoi21  g060(.a(new_n121_), .b(new_n118_), .c(new_n122_), .O(new_n123_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n87_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  inv1   g070(.a(new_n77_), .O(new_n133_));
  inv1   g071(.a(x09), .O(new_n134_));
  inv1   g072(.a(x30), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  aoi21  g074(.a(new_n82_), .b(new_n133_), .c(new_n136_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n132_), .c(new_n93_), .O(new_n138_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n142_), .c(new_n93_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand4  g084(.a(x40), .b(x39), .c(new_n146_), .d(new_n69_), .O(new_n147_));
  aoi21  g085(.a(x36), .b(x35), .c(new_n86_), .O(new_n148_));
  ...
  nor2   g090(.a(new_n147_), .b(new_n81_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(new_n64_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(z13));
  inv1   g093(.a(new_n147_), .O(new_n156_));
  nand2  g094(.a(new_n148_), .b(new_n81_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n150_), .O(new_n159_));
  oai21  g097(.a(x28), .b(new_n66_), .c(new_n81_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n143_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n159_), .c(new_n93_), .O(z14));
  inv1   g101(.a(x12), .O(new_n164_));
  oai21  g102(.a(new_n116_), .b(new_n164_), .c(new_n93_), .O(z15));
  nand2  g103(.a(x22), .b(x01), .O(new_n166_));
  nor3   g104(.a(new_n166_), .b(new_n64_), .c(x23), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x23), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n166_), .c(new_n93_), .O(z17));
  aoi21  g108(.a(new_n137_), .b(new_n132_), .c(new_n64_), .O(z18));
  nand2  g109(.a(new_n137_), .b(new_n132_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n93_), .O(z19));
  nand2  g111(.a(x35), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n135_), .c(new_n134_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n130_), .c(new_n93_), .O(z20));
endmodule
