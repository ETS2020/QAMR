...
module FAU ( 
  ...
  nand3  g065(.a(new_n77_), .b(x27), .c(new_n64_), .O(new_n128_));
  nor2   g066(.a(x30), .b(x09), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n72_), .O(new_n130_));
  aoi21  g068(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z11));
  nor2   g069(.a(new_n66_), .b(new_n84_), .O(new_n132_));
  inv1   g070(.a(x10), .O(new_n133_));
  oai21  g071(.a(new_n63_), .b(new_n84_), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g086(.a(new_n89_), .b(new_n76_), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x20), .c(new_n139_), .d(new_n138_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n141_), .c(new_n84_), .O(new_n151_));
  nand2  g089(.a(new_n79_), .b(x39), .O(new_n152_));
  oai21  g090(.a(new_n142_), .b(new_n71_), .c(x40), .O(new_n153_));
  inv1   g091(.a(new_n140_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n132_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  oai21  g094(.a(new_n152_), .b(new_n151_), .c(new_n156_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n109_), .b(new_n158_), .c(new_n72_), .O(z15));
  ...
  nand3  g103(.a(new_n165_), .b(new_n85_), .c(new_n77_), .O(new_n166_));
  oai21  g104(.a(new_n125_), .b(new_n83_), .c(new_n129_), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n75_), .O(z18));
  nand2  g107(.a(new_n129_), .b(new_n72_), .O(new_n170_));
  nor2   g108(.a(new_n76_), .b(new_n84_), .O(new_n171_));
  nor3   g109(.a(new_n171_), .b(new_n170_), .c(new_n126_), .O(z20));
  buf    g110(.a(x40), .O(z08));
  aoi21  g111(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z19));
endmodule
