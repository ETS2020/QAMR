...
module FAU ( 
  ...
  nor2   g011(.a(new_n73_), .b(x22), .O(new_n74_));
  nor2   g012(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  oai21  g013(.a(new_n71_), .b(x15), .c(new_n75_), .O(z00));
  inv1   g014(.a(x22), .O(new_n77_));
  nand2  g015(.a(x32), .b(new_n77_), .O(new_n78_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n79_), .c(new_n74_), .O(new_n96_));
  ...
  nand2  g050(.a(new_n112_), .b(new_n78_), .O(z07));
  nand4  g051(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n78_), .O(z09));
  oai21  g053(.a(new_n73_), .b(x22), .c(new_n65_), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n81_), .O(new_n117_));
  nand2  g055(.a(new_n73_), .b(x05), .O(new_n118_));
  aoi21  g056(.a(x40), .b(x39), .c(x07), .O(new_n119_));
  aoi21  g057(.a(new_n118_), .b(new_n68_), .c(new_n119_), .O(new_n120_));
  ...
  nand4  g062(.a(z08), .b(new_n124_), .c(x05), .d(new_n65_), .O(new_n125_));
  oai21  g063(.a(new_n123_), .b(new_n79_), .c(new_n125_), .O(z10));
  inv1   g064(.a(x08), .O(new_n127_));
  nand2  g065(.a(new_n68_), .b(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n85_), .c(new_n127_), .O(new_n129_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(new_n78_), .O(new_n133_));
  ...
  nand2  g074(.a(new_n78_), .b(new_n136_), .O(z12));
  nor2   g075(.a(x19), .b(x18), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x20), .O(new_n139_));
  nand2  g077(.a(new_n93_), .b(new_n95_), .O(new_n140_));
  nand2  g078(.a(new_n78_), .b(new_n140_), .O(new_n141_));
  aoi21  g079(.a(x36), .b(x35), .c(new_n80_), .O(new_n142_));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n68_), .c(new_n73_), .O(new_n144_));
  oai22  g082(.a(new_n144_), .b(new_n142_), .c(new_n141_), .d(new_n139_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  nand3  g084(.a(new_n143_), .b(z08), .c(new_n124_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z13));
  nand2  g086(.a(new_n143_), .b(new_n68_), .O(new_n149_));
  nand2  g087(.a(new_n142_), .b(new_n82_), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(new_n139_), .O(new_n152_));
  aoi21  g090(.a(new_n80_), .b(x27), .c(new_n124_), .O(new_n153_));
  oai22  g091(.a(new_n153_), .b(new_n149_), .c(new_n63_), .d(new_n79_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n152_), .c(new_n78_), .O(z14));
  nand4  g093(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n78_), .O(z15));
  nand2  g095(.a(x22), .b(x01), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(x23), .c(new_n78_), .O(z16));
  inv1   g097(.a(x24), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x23), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n158_), .c(new_n78_), .O(z17));
  inv1   g100(.a(z11), .O(z18));
  nand2  g101(.a(x35), .b(x27), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n132_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n129_), .c(new_n78_), .O(z20));
