...
module FAU ( 
  ...
  nand2  g009(.a(new_n71_), .b(x26), .O(new_n72_));
  ...
  nand3  g017(.a(new_n79_), .b(new_n72_), .c(x04), .O(z01));
  ...
  nand2  g036(.a(new_n98_), .b(new_n72_), .O(z05));
  inv1   g037(.a(new_n98_), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n72_), .O(z06));
  ...
  nand3  g052(.a(x40), .b(x26), .c(x11), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  inv1   g054(.a(x36), .O(new_n117_));
  aoi21  g055(.a(new_n82_), .b(new_n117_), .c(new_n75_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(x07), .c(z08), .O(new_n119_));
  inv1   g057(.a(x05), .O(new_n120_));
  aoi21  g058(.a(z08), .b(new_n120_), .c(x04), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n79_), .O(new_n122_));
  ...
  aoi21  g094(.a(new_n76_), .b(x27), .c(new_n153_), .O(new_n157_));
  oai22  g095(.a(new_n157_), .b(new_n156_), .c(new_n63_), .d(new_n75_), .O(new_n158_));
  nand2  g096(.a(new_n148_), .b(x20), .O(new_n159_));
  nand3  g097(.a(new_n144_), .b(new_n78_), .c(x28), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n143_), .c(new_n142_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n159_), .c(new_n81_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n158_), .O(z14));
  inv1   g101(.a(x26), .O(new_n164_));
  nand3  g102(.a(x34), .b(x27), .c(x12), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(x40), .c(new_n164_), .O(z15));
  inv1   g104(.a(x01), .O(new_n167_));
  inv1   g105(.a(x22), .O(new_n168_));
  nor4   g106(.a(new_n81_), .b(x23), .c(new_n168_), .d(new_n167_), .O(z16));
  inv1   g107(.a(x24), .O(new_n170_));
  nor2   g108(.a(new_n168_), .b(new_n167_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n72_), .c(new_n170_), .d(x23), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  nand3  g111(.a(new_n136_), .b(new_n130_), .c(new_n72_), .O(z18));
  inv1   g112(.a(z18), .O(z19));
  nand2  g113(.a(x35), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n134_), .c(new_n133_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n128_), .c(new_n72_), .O(z20));
endmodule
