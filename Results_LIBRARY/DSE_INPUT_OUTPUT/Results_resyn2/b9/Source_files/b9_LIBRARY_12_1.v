...
module FAU ( 
  ...
  nand4  g87(.a(new_n63_), .b(x23), .c(x22), .d(x01), .O(new_n150_));
  inv1   g88(.a(new_n150_), .O(z17));
  inv1   g89(.a(z11), .O(z18));
  oai21  g90(.a(new_n69_), .b(new_n66_), .c(new_n131_), .O(new_n153_));
  oai21  g91(.a(new_n153_), .b(new_n128_), .c(new_n97_), .O(z20));
