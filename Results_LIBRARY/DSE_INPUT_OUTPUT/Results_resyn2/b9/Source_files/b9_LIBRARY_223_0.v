...
module FAU ( 
  ...
  nor2   g015(.a(new_n70_), .b(x28), .O(new_n78_));
  ...
  nor2   g025(.a(new_n87_), .b(new_n74_), .O(new_n88_));
  ...
  aoi21  g030(.a(new_n92_), .b(new_n66_), .c(new_n63_), .O(new_n93_));
  ...
  inv1   g050(.a(new_n74_), .O(z08));
  inv1   g051(.a(x11), .O(new_n114_));
  nand4  g052(.a(new_n101_), .b(x34), .c(x27), .d(x26), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  aoi21  g054(.a(new_n84_), .b(new_n71_), .c(new_n66_), .O(new_n117_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n131_), .c(new_n101_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  nand2  g076(.a(new_n75_), .b(new_n72_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n67_), .c(new_n66_), .O(new_n140_));
  nand2  g078(.a(new_n75_), .b(x10), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n140_), .c(new_n101_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n75_), .c(new_n144_), .O(new_n147_));
  ...
  nand2  g092(.a(new_n154_), .b(new_n133_), .O(new_n155_));
  inv1   g093(.a(x04), .O(new_n156_));
  nand3  g094(.a(z08), .b(new_n144_), .c(new_n156_), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n63_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n153_), .O(z13));
  nand3  g098(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n161_));
  nand3  g099(.a(new_n145_), .b(new_n80_), .c(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n157_), .c(new_n161_), .O(new_n164_));
  nand2  g102(.a(new_n150_), .b(x27), .O(new_n165_));
  aoi21  g103(.a(new_n83_), .b(x27), .c(new_n155_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n157_), .c(new_n165_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n164_), .c(new_n63_), .O(z14));
  inv1   g106(.a(x12), .O(new_n169_));
  nor2   g107(.a(new_n115_), .b(new_n169_), .O(z15));
  nand2  g108(.a(x22), .b(x01), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(x23), .c(new_n101_), .O(z16));
  inv1   g110(.a(x24), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x23), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n171_), .c(new_n101_), .O(z17));
  nand2  g113(.a(new_n136_), .b(new_n131_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n101_), .O(z19));
  nand2  g115(.a(x35), .b(x27), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n133_), .c(new_n132_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n129_), .c(new_n101_), .O(z20));
endmodule
