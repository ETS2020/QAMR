...
module FAU ( 
  ...
  or2    g021(.a(x32), .b(x30), .O(new_n84_));
  inv1   g022(.a(x04), .O(new_n85_));
  nor2   g023(.a(new_n65_), .b(new_n85_), .O(new_n86_));
  oai21  g024(.a(new_n84_), .b(new_n83_), .c(new_n86_), .O(z01));
  ...
  nand2  g037(.a(new_n99_), .b(new_n64_), .O(z05));
  ...
  inv1   g050(.a(new_n76_), .O(z08));
  inv1   g051(.a(x11), .O(new_n114_));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(x40), .c(new_n114_), .O(z09));
  nand2  g054(.a(new_n84_), .b(z08), .O(new_n117_));
  inv1   g055(.a(x35), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x28), .c(new_n80_), .O(new_n119_));
  ...
  nor2   g072(.a(new_n118_), .b(x28), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x27), .c(new_n85_), .O(new_n136_));
  nor2   g074(.a(x30), .b(x09), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(new_n134_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n64_), .O(z11));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n68_), .c(new_n73_), .O(new_n141_));
  or2    g079(.a(new_n77_), .b(new_n71_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n64_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  oai21  g082(.a(new_n80_), .b(new_n118_), .c(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n77_), .c(new_n144_), .O(new_n146_));
  nand2  g084(.a(new_n70_), .b(new_n69_), .O(new_n147_));
  nor2   g085(.a(x19), .b(x18), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n147_), .c(new_n64_), .d(x20), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand3  g089(.a(new_n84_), .b(new_n77_), .c(new_n144_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand3  g091(.a(new_n148_), .b(new_n147_), .c(x20), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n146_), .O(new_n155_));
  nand2  g093(.a(new_n152_), .b(new_n64_), .O(new_n156_));
  aoi21  g094(.a(new_n155_), .b(x27), .c(new_n156_), .O(z14));
  nand2  g095(.a(new_n64_), .b(x12), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(new_n115_), .O(z15));
  ...
  nand4  g101(.a(new_n163_), .b(new_n64_), .c(x22), .d(x01), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z17));
  inv1   g103(.a(new_n88_), .O(new_n166_));
  nand2  g104(.a(x27), .b(x04), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n135_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n137_), .O(new_n169_));
  ...
  aoi21  g112(.a(new_n169_), .b(new_n64_), .c(new_n174_), .O(z19));
  nand2  g113(.a(x35), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n137_), .c(new_n64_), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n132_), .O(z20));
endmodule
