...
module FAU ( 
  ...
  nor2   g009(.a(x31), .b(x13), .O(new_n72_));
  ...
  aoi21  g024(.a(new_n86_), .b(new_n84_), .c(new_n72_), .O(z02));
  ...
  nand3  g033(.a(new_n90_), .b(new_n95_), .c(new_n89_), .O(z05));
  ...
  aoi21  g061(.a(new_n123_), .b(new_n77_), .c(new_n122_), .O(new_n124_));
  ...
  nor2   g066(.a(x28), .b(new_n128_), .O(new_n129_));
  nor2   g067(.a(new_n88_), .b(x04), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n127_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n126_), .c(new_n72_), .O(z18));
  inv1   g070(.a(z18), .O(z11));
  nand2  g071(.a(new_n95_), .b(new_n70_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z12));
  inv1   g073(.a(x13), .O(new_n136_));
  oai21  g074(.a(new_n80_), .b(new_n68_), .c(x31), .O(new_n137_));
  ...
  nand2  g079(.a(new_n64_), .b(new_n136_), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n65_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n138_), .O(z13));
  inv1   g083(.a(x31), .O(new_n146_));
  nand2  g084(.a(new_n141_), .b(new_n80_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n64_), .c(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(x13), .c(new_n140_), .O(new_n149_));
  oai21  g087(.a(x28), .b(new_n128_), .c(new_n80_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n64_), .c(new_n146_), .O(new_n151_));
  oai22  g089(.a(new_n151_), .b(x13), .c(new_n65_), .d(new_n128_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(z14));
  inv1   g091(.a(x12), .O(new_n154_));
  nor2   g092(.a(new_n111_), .b(new_n154_), .O(z15));
  ...
  oai21  g097(.a(new_n159_), .b(new_n156_), .c(new_n95_), .O(z17));
  nor2   g098(.a(new_n88_), .b(new_n128_), .O(new_n161_));
  nor4   g099(.a(new_n161_), .b(new_n127_), .c(new_n124_), .d(new_n72_), .O(z20));
