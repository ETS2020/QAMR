...
module FAU ( 
  ...
  nor2   g011(.a(x23), .b(new_n73_), .O(z16));
  nor2   g012(.a(z16), .b(new_n72_), .O(new_n75_));
  ...
  nor2   g022(.a(z16), .b(new_n65_), .O(new_n85_));
  oai21  g023(.a(new_n84_), .b(new_n81_), .c(new_n85_), .O(z01));
  inv1   g024(.a(z16), .O(new_n87_));
  ...
  nand4  g030(.a(new_n92_), .b(new_n89_), .c(new_n87_), .d(new_n68_), .O(z02));
  ...
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n87_), .d(x21), .O(z03));
  aoi21  g036(.a(new_n96_), .b(new_n77_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(z16), .O(z04));
  oai21  g038(.a(new_n79_), .b(new_n77_), .c(new_n96_), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n87_), .O(z06));
  ...
  nand3  g075(.a(new_n137_), .b(new_n132_), .c(new_n87_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  nand2  g077(.a(new_n67_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n87_), .b(new_n69_), .c(new_n140_), .O(new_n141_));
  ...
  aoi21  g090(.a(new_n152_), .b(new_n144_), .c(z16), .O(z13));
  inv1   g091(.a(new_n144_), .O(new_n154_));
  aoi21  g092(.a(new_n150_), .b(new_n147_), .c(new_n77_), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n154_), .c(z16), .O(z14));
  nand4  g094(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n87_), .O(z15));
  inv1   g096(.a(x24), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x22), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x23), .c(new_n73_), .O(z17));
  aoi21  g099(.a(new_n137_), .b(new_n132_), .c(z16), .O(z18));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n82_), .c(new_n135_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n130_), .c(new_n87_), .O(z20));
  inv1   g103(.a(new_n138_), .O(z19));
endmodule
