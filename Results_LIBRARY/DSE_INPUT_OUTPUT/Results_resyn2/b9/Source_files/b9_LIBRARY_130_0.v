...
module FAU ( 
  ...
  and2   g041(.a(new_n99_), .b(new_n103_), .O(z06));
  ...
  inv1   g052(.a(new_n74_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand4  g054(.a(new_n103_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  ...
  aoi21  g061(.a(new_n123_), .b(new_n80_), .c(new_n121_), .O(new_n124_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n103_), .O(z11));
  nand2  g078(.a(new_n75_), .b(new_n72_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n67_), .c(new_n66_), .O(new_n142_));
  nand2  g080(.a(new_n75_), .b(x10), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n142_), .c(new_n103_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n75_), .c(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n92_), .b(new_n94_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n150_), .c(new_n103_), .d(x20), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand3  g092(.a(new_n83_), .b(new_n75_), .c(new_n146_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand2  g094(.a(new_n75_), .b(new_n146_), .O(new_n157_));
  nand2  g095(.a(new_n151_), .b(x20), .O(new_n158_));
  nand3  g096(.a(new_n147_), .b(new_n119_), .c(x28), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n158_), .O(new_n161_));
  aoi21  g099(.a(new_n78_), .b(x27), .c(new_n83_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n157_), .c(new_n67_), .d(new_n66_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n103_), .O(z14));
  inv1   g102(.a(x12), .O(new_n165_));
  nor2   g103(.a(new_n117_), .b(new_n165_), .O(z15));
  nand2  g104(.a(x22), .b(x01), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(x23), .c(new_n103_), .O(z16));
  inv1   g106(.a(x24), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x23), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n167_), .c(new_n103_), .O(z17));
  nand3  g109(.a(new_n138_), .b(new_n133_), .c(new_n103_), .O(z18));
  inv1   g110(.a(z18), .O(z19));
  nor2   g111(.a(new_n136_), .b(new_n63_), .O(new_n174_));
  oai21  g112(.a(new_n70_), .b(new_n66_), .c(new_n174_), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n131_), .O(z20));
endmodule
