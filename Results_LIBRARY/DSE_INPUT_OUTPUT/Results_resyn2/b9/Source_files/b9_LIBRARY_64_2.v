...
module FAU ( 
  ...
  and2   g049(.a(x39), .b(x05), .O(new_n112_));
  inv1   g050(.a(x07), .O(new_n113_));
  nor2   g051(.a(x39), .b(new_n113_), .O(new_n114_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n133_), .c(x40), .O(new_n138_));
  ...
  nand2  g083(.a(new_n133_), .b(x40), .O(new_n146_));
  ...
  nand2  g089(.a(new_n80_), .b(x40), .O(new_n152_));
