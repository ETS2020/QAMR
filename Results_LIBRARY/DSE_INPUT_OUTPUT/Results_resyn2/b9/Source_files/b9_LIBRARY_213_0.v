...
module FAU ( 
  ...
  nand2  g019(.a(new_n81_), .b(new_n69_), .O(new_n82_));
  ...
  inv1   g069(.a(new_n81_), .O(new_n132_));
  nor2   g070(.a(new_n65_), .b(x04), .O(new_n133_));
  ...
  inv1   g076(.a(new_n73_), .O(new_n139_));
  nand3  g077(.a(new_n74_), .b(new_n139_), .c(new_n98_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x20), .O(new_n143_));
  aoi21  g081(.a(x36), .b(x35), .c(new_n80_), .O(new_n144_));
  ...
  nand2  g085(.a(new_n145_), .b(new_n116_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n98_), .O(new_n149_));
  aoi21  g087(.a(new_n147_), .b(x27), .c(new_n149_), .O(z14));
  inv1   g088(.a(z14), .O(z13));
  ...
  oai21  g095(.a(new_n157_), .b(new_n154_), .c(new_n98_), .O(z17));
  aoi21  g096(.a(new_n136_), .b(new_n131_), .c(new_n63_), .O(z18));
  nor2   g097(.a(new_n135_), .b(new_n63_), .O(new_n160_));
  oai21  g098(.a(new_n68_), .b(new_n65_), .c(new_n160_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(new_n129_), .O(z20));
  inv1   g100(.a(new_n137_), .O(z19));
endmodule
