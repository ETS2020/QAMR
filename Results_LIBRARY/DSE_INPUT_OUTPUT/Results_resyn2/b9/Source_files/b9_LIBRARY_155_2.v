...
module FAU ( 
  ...
  oai21  g40(.a(x25), .b(new_n102_), .c(x38), .O(new_n103_));
  nand2  g41(.a(x17), .b(new_n65_), .O(new_n104_));
  nor2   g42(.a(x33), .b(x31), .O(new_n105_));
  nand3  g43(.a(new_n105_), .b(new_n104_), .c(new_n103_), .O(new_n106_));
  aoi21  g44(.a(new_n106_), .b(x14), .c(new_n63_), .O(z07));
  nand2  g45(.a(new_n87_), .b(new_n91_), .O(z08));
  and2   g46(.a(x34), .b(x27), .O(new_n109_));
  nand3  g47(.a(new_n109_), .b(x26), .c(x11), .O(new_n110_));
  nand2  g48(.a(new_n110_), .b(new_n91_), .O(z09));
  nor2   g49(.a(new_n80_), .b(new_n66_), .O(new_n112_));
  nand2  g50(.a(new_n72_), .b(x05), .O(new_n113_));
  inv1   g51(.a(new_n113_), .O(new_n114_));
  and2   g52(.a(new_n87_), .b(x07), .O(new_n115_));
  ...
  nor2   g56(.a(new_n118_), .b(new_n64_), .O(new_n119_));
  oai21  g57(.a(new_n116_), .b(x04), .c(new_n119_), .O(z10));
  inv1   g58(.a(x08), .O(new_n121_));
  nand2  g59(.a(new_n72_), .b(x29), .O(new_n122_));
  aoi21  g60(.a(new_n122_), .b(new_n84_), .c(new_n121_), .O(new_n123_));
  nand2  g61(.a(new_n122_), .b(x27), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  inv1   g63(.a(new_n84_), .O(new_n126_));
  nor2   g64(.a(new_n66_), .b(x04), .O(new_n127_));
  nor2   g65(.a(x30), .b(x09), .O(new_n128_));
  inv1   g66(.a(new_n128_), .O(new_n129_));
  aoi21  g67(.a(new_n127_), .b(new_n126_), .c(new_n129_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(new_n125_), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n91_), .O(z11));
  inv1   g70(.a(new_n74_), .O(new_n133_));
  nand3  g71(.a(new_n75_), .b(new_n133_), .c(new_n91_), .O(new_n134_));
  inv1   g72(.a(new_n134_), .O(z12));
  ...
  oai21  g79(.a(new_n137_), .b(new_n81_), .c(new_n91_), .O(new_n142_));
  aoi21  g80(.a(new_n141_), .b(x27), .c(new_n142_), .O(z14));
  inv1   g81(.a(z14), .O(z13));
  nand4  g82(.a(new_n109_), .b(new_n91_), .c(x26), .d(x12), .O(new_n145_));
  inv1   g83(.a(new_n145_), .O(z15));
  nand2  g84(.a(x22), .b(x01), .O(new_n147_));
  nor3   g85(.a(new_n147_), .b(new_n64_), .c(x23), .O(z16));
  inv1   g86(.a(x24), .O(new_n149_));
  nand2  g87(.a(new_n149_), .b(x23), .O(new_n150_));
  oai21  g88(.a(new_n150_), .b(new_n147_), .c(new_n91_), .O(z17));
  aoi21  g89(.a(new_n130_), .b(new_n125_), .c(new_n64_), .O(z18));
  nand3  g90(.a(new_n130_), .b(new_n125_), .c(new_n91_), .O(new_n153_));
  inv1   g91(.a(new_n153_), .O(z19));
  oai21  g92(.a(new_n69_), .b(new_n66_), .c(new_n128_), .O(new_n155_));
  oai21  g93(.a(new_n155_), .b(new_n123_), .c(new_n91_), .O(z20));
endmodule
