...
module FAU ( 
  ...
  nand2  g008(.a(new_n70_), .b(x00), .O(new_n71_));
  ...
  nor2   g022(.a(new_n74_), .b(new_n84_), .O(z08));
  ...
  nand2  g049(.a(new_n71_), .b(x11), .O(new_n112_));
  ...
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(new_n71_), .O(z10));
  ...
  aoi21  g070(.a(new_n132_), .b(new_n129_), .c(new_n74_), .O(z18));
  inv1   g071(.a(z18), .O(z11));
  nand2  g072(.a(new_n68_), .b(x27), .O(new_n135_));
  nand2  g073(.a(new_n65_), .b(x10), .O(new_n136_));
  nand3  g074(.a(new_n71_), .b(new_n136_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z12));
  inv1   g076(.a(x27), .O(new_n139_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n114_), .c(new_n76_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n143_), .c(new_n139_), .O(new_n146_));
  nand2  g084(.a(new_n144_), .b(new_n114_), .O(new_n147_));
  nor2   g085(.a(new_n147_), .b(new_n75_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n146_), .c(new_n71_), .O(new_n149_));
  ...
  oai21  g092(.a(new_n147_), .b(new_n75_), .c(new_n71_), .O(new_n155_));
  aoi21  g093(.a(new_n154_), .b(x27), .c(new_n155_), .O(z14));
  inv1   g094(.a(x12), .O(new_n157_));
  oai21  g095(.a(new_n111_), .b(new_n157_), .c(new_n71_), .O(z15));
  ...
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n71_), .O(z17));
  nand3  g101(.a(new_n132_), .b(new_n129_), .c(new_n71_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z19));
  oai21  g103(.a(new_n90_), .b(new_n139_), .c(new_n131_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n127_), .c(new_n71_), .O(z20));
endmodule
