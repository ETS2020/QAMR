...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n153_, new_n155_, new_n157_, new_n159_, new_n162_;
  ...
  inv1   g029(.a(new_n74_), .O(new_n92_));
  ...
  aoi21  g035(.a(new_n95_), .b(new_n77_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n74_), .O(z04));
  aoi21  g037(.a(x28), .b(x27), .c(x37), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n92_), .O(z05));
  inv1   g039(.a(new_n100_), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n92_), .O(z06));
  ...
  nand2  g051(.a(new_n113_), .b(new_n92_), .O(z07));
  nor2   g052(.a(new_n74_), .b(new_n88_), .O(z08));
  nand2  g053(.a(x34), .b(x27), .O(new_n116_));
  nand2  g054(.a(x26), .b(x11), .O(new_n117_));
  oai21  g055(.a(new_n117_), .b(new_n116_), .c(new_n92_), .O(z09));
  aoi21  g056(.a(new_n82_), .b(new_n81_), .c(new_n88_), .O(new_n119_));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(new_n88_), .b(new_n120_), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(new_n80_), .c(new_n119_), .O(new_n122_));
  oai21  g060(.a(new_n88_), .b(x05), .c(new_n65_), .O(new_n123_));
  ...
  nand4  g070(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n92_), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n77_), .c(new_n137_), .O(new_n139_));
  oai21  g077(.a(new_n63_), .b(new_n77_), .c(new_n66_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n139_), .c(new_n92_), .O(z12));
  inv1   g079(.a(new_n63_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(x20), .O(new_n144_));
  inv1   g082(.a(new_n88_), .O(new_n145_));
  oai21  g083(.a(new_n73_), .b(new_n93_), .c(x28), .O(new_n146_));
  ...
  nand2  g088(.a(new_n147_), .b(new_n119_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n92_), .O(z13));
  nand2  g090(.a(new_n151_), .b(new_n92_), .O(new_n153_));
  aoi21  g091(.a(new_n149_), .b(x27), .c(new_n153_), .O(z14));
  nand2  g092(.a(x26), .b(x12), .O(new_n155_));
  nor3   g093(.a(new_n155_), .b(new_n116_), .c(new_n74_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x23), .O(z16));
  or2    g096(.a(new_n157_), .b(x24), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n73_), .c(new_n72_), .O(z17));
  nand4  g098(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n92_), .O(z18));
  oai21  g099(.a(new_n93_), .b(new_n77_), .c(new_n134_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n130_), .c(new_n92_), .O(z20));
  nand2  g101(.a(new_n135_), .b(new_n92_), .O(z19));
endmodule
