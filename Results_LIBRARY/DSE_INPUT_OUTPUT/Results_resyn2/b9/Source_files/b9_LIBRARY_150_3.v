...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n153_, new_n155_, new_n157_, new_n159_, new_n162_, new_n163_;
  ...
  aoi21  g026(.a(new_n88_), .b(new_n85_), .c(new_n74_), .O(z02));
  inv1   g027(.a(new_n74_), .O(new_n90_));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n92_), .c(new_n74_), .O(z04));
  ...
  nand3  g048(.a(new_n110_), .b(new_n90_), .c(x03), .O(new_n111_));
  nor2   g049(.a(new_n111_), .b(new_n106_), .O(z07));
  nand2  g050(.a(new_n90_), .b(new_n86_), .O(z08));
  nand4  g051(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n90_), .O(z09));
  nor2   g053(.a(new_n93_), .b(x04), .O(new_n116_));
  or2    g054(.a(new_n86_), .b(x05), .O(new_n117_));
  inv1   g055(.a(x07), .O(new_n118_));
  nand2  g056(.a(new_n86_), .b(new_n118_), .O(new_n119_));
  nand4  g057(.a(new_n119_), .b(new_n117_), .c(new_n116_), .d(new_n80_), .O(new_n120_));
  nor2   g058(.a(new_n77_), .b(new_n66_), .O(new_n121_));
  nand3  g059(.a(x37), .b(x27), .c(x06), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(new_n123_));
  aoi21  g061(.a(new_n121_), .b(x05), .c(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n120_), .c(new_n74_), .O(z10));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n131_), .c(new_n134_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n90_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand3  g076(.a(new_n90_), .b(new_n68_), .c(new_n138_), .O(new_n139_));
  ...
  nor2   g082(.a(new_n86_), .b(x04), .O(new_n145_));
  oai21  g083(.a(new_n73_), .b(new_n91_), .c(x28), .O(new_n146_));
  ...
  inv1   g087(.a(new_n77_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n145_), .c(new_n144_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n149_), .c(new_n90_), .O(z13));
  nand2  g090(.a(new_n151_), .b(new_n90_), .O(new_n153_));
  aoi21  g091(.a(new_n148_), .b(x27), .c(new_n153_), .O(z14));
  nand4  g092(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n90_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n90_), .O(z16));
  or2    g096(.a(new_n157_), .b(x24), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n73_), .c(new_n72_), .O(z17));
  aoi21  g098(.a(new_n135_), .b(new_n130_), .c(new_n74_), .O(z18));
  nand2  g099(.a(x35), .b(x27), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n90_), .c(new_n133_), .d(new_n132_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n128_), .O(z20));
  inv1   g102(.a(new_n136_), .O(z19));
endmodule
