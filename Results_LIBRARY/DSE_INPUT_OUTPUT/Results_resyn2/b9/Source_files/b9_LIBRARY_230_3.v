...
module FAU ( 
  ...
  nor2   g023(.a(new_n76_), .b(new_n65_), .O(new_n86_));
  ...
  nor2   g027(.a(new_n76_), .b(new_n68_), .O(z08));
  ...
  aoi21  g036(.a(new_n98_), .b(x21), .c(new_n76_), .O(z03));
  inv1   g037(.a(x21), .O(new_n100_));
  aoi21  g038(.a(new_n98_), .b(new_n100_), .c(new_n76_), .O(z04));
  ...
  nand2  g054(.a(new_n116_), .b(new_n102_), .O(z09));
  nand3  g055(.a(x40), .b(x39), .c(x05), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n85_), .O(new_n120_));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n76_), .O(z10));
  nor2   g066(.a(x30), .b(x09), .O(new_n129_));
  nand2  g067(.a(x27), .b(new_n65_), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(new_n82_), .c(new_n74_), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x29), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n82_), .O(new_n133_));
  nand3  g071(.a(new_n132_), .b(x27), .c(x04), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n131_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n129_), .c(new_n76_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  and2   g075(.a(new_n67_), .b(x27), .O(new_n138_));
  oai21  g076(.a(new_n71_), .b(new_n138_), .c(new_n102_), .O(z12));
  nand2  g077(.a(new_n69_), .b(new_n75_), .O(new_n140_));
  aoi21  g078(.a(x36), .b(x35), .c(new_n81_), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x20), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n63_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  inv1   g083(.a(new_n140_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n85_), .c(new_n76_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  aoi21  g086(.a(new_n81_), .b(x27), .c(new_n85_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n140_), .c(new_n63_), .d(new_n79_), .O(new_n150_));
  nand2  g088(.a(new_n141_), .b(new_n84_), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n140_), .c(new_n143_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n150_), .c(new_n102_), .O(z14));
  nand4  g092(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n102_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n102_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x23), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n102_), .O(z17));
  aoi21  g099(.a(new_n132_), .b(new_n82_), .c(new_n74_), .O(new_n162_));
  oai21  g100(.a(new_n95_), .b(new_n79_), .c(new_n129_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n102_), .O(z20));
