...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n170_, new_n171_, new_n172_, new_n174_, new_n175_;
  ...
  oai21  g028(.a(new_n86_), .b(new_n65_), .c(new_n90_), .O(z02));
  inv1   g029(.a(x37), .O(new_n92_));
  nand2  g030(.a(x28), .b(x27), .O(new_n93_));
  oai22  g031(.a(new_n93_), .b(new_n76_), .c(new_n92_), .d(x27), .O(new_n94_));
  ...
  nand2  g037(.a(new_n99_), .b(new_n75_), .O(z06));
  ...
  nand2  g048(.a(new_n110_), .b(new_n75_), .O(z07));
  ...
  nand4  g082(.a(new_n144_), .b(new_n75_), .c(new_n143_), .d(x20), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand2  g085(.a(new_n123_), .b(new_n137_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n147_), .O(z13));
  nand2  g087(.a(new_n138_), .b(new_n137_), .O(new_n150_));
  nand2  g088(.a(new_n84_), .b(x27), .O(new_n151_));
  and2   g089(.a(new_n151_), .b(new_n79_), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(new_n150_), .c(new_n63_), .d(new_n83_), .O(new_n153_));
  nand2  g091(.a(new_n144_), .b(x20), .O(new_n154_));
  nand3  g092(.a(new_n139_), .b(new_n79_), .c(x28), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n138_), .c(new_n137_), .O(new_n156_));
  ...
  nand2  g097(.a(new_n159_), .b(new_n75_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x23), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n161_), .c(new_n75_), .O(z17));
  nand4  g103(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n75_), .O(z18));
  inv1   g104(.a(new_n88_), .O(new_n167_));
  inv1   g105(.a(new_n89_), .O(new_n168_));
  nand2  g106(.a(new_n83_), .b(new_n82_), .O(new_n169_));
  nand2  g107(.a(x27), .b(x04), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n77_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n131_), .O(new_n172_));
  aoi22  g110(.a(new_n172_), .b(new_n75_), .c(new_n168_), .d(new_n167_), .O(z19));
  nand2  g111(.a(x35), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n131_), .c(new_n75_), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n127_), .O(z20));
endmodule
