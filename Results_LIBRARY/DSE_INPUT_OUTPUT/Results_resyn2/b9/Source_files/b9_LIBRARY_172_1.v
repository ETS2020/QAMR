...
module FAU ( 
  ...
  nand2  g013(.a(x27), .b(new_n69_), .O(new_n76_));
  aoi21  g014(.a(new_n63_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  nand3  g015(.a(new_n77_), .b(z08), .c(new_n65_), .O(new_n78_));
  oai21  g016(.a(new_n72_), .b(new_n64_), .c(new_n78_), .O(z00));
  nor2   g017(.a(x32), .b(x30), .O(new_n80_));
  aoi21  g018(.a(new_n80_), .b(new_n67_), .c(new_n69_), .O(new_n81_));
  ...
  oai21  g029(.a(new_n75_), .b(new_n82_), .c(x27), .O(new_n92_));
  ...
  oai21  g036(.a(new_n82_), .b(new_n67_), .c(new_n93_), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n98_), .O(z06));
  ...
  nand2  g051(.a(new_n113_), .b(new_n98_), .O(z09));
  nor3   g052(.a(new_n80_), .b(new_n73_), .c(x04), .O(new_n115_));
  nand3  g053(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(new_n117_));
  aoi21  g055(.a(new_n115_), .b(x05), .c(new_n117_), .O(new_n118_));
  nor2   g056(.a(new_n67_), .b(x04), .O(new_n119_));
  ...
  nand2  g060(.a(new_n83_), .b(new_n63_), .O(new_n123_));
  nand4  g061(.a(new_n123_), .b(new_n122_), .c(new_n119_), .d(new_n98_), .O(new_n124_));
  oai21  g062(.a(new_n118_), .b(new_n64_), .c(new_n124_), .O(z10));
  ...
  aoi21  g072(.a(new_n131_), .b(new_n119_), .c(new_n134_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n130_), .c(new_n98_), .O(z18));
  inv1   g074(.a(z18), .O(z11));
  aoi22  g075(.a(new_n77_), .b(z08), .c(new_n71_), .d(new_n98_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  nor2   g077(.a(new_n73_), .b(x04), .O(new_n140_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n68_), .c(new_n143_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  aoi21  g086(.a(new_n115_), .b(new_n139_), .c(new_n64_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand2  g088(.a(new_n140_), .b(new_n139_), .O(new_n151_));
  nand3  g089(.a(new_n141_), .b(new_n80_), .c(x28), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n146_), .O(new_n154_));
  nand2  g092(.a(new_n82_), .b(x27), .O(new_n155_));
  and2   g093(.a(new_n155_), .b(new_n80_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n151_), .c(new_n68_), .d(new_n67_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n154_), .c(new_n98_), .O(z14));
  nand4  g096(.a(new_n112_), .b(new_n98_), .c(x26), .d(x12), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(x23), .c(new_n98_), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x23), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n161_), .c(new_n98_), .O(z17));
  nand2  g103(.a(new_n135_), .b(new_n130_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n98_), .O(z19));
  nand2  g105(.a(x35), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n133_), .c(new_n132_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n128_), .c(new_n98_), .O(z20));
endmodule
