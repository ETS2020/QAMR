...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n161_, new_n163_, new_n164_, new_n165_, new_n169_;
  ...
  nor2   g008(.a(x29), .b(x14), .O(new_n71_));
  ...
  aoi21  g034(.a(new_n96_), .b(new_n92_), .c(new_n71_), .O(z04));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n71_), .O(z05));
  inv1   g037(.a(new_n98_), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n71_), .O(z06));
  ...
  nor2   g050(.a(new_n71_), .b(new_n86_), .O(z08));
  ...
  nor2   g071(.a(new_n74_), .b(x04), .O(new_n134_));
  ...
  nand2  g077(.a(new_n90_), .b(new_n69_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n63_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x20), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n66_), .c(new_n145_), .d(new_n142_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  inv1   g087(.a(new_n145_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n81_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n149_), .c(new_n71_), .O(z13));
  nand3  g090(.a(new_n142_), .b(new_n80_), .c(new_n79_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n147_), .O(new_n155_));
  aoi21  g093(.a(new_n76_), .b(x27), .c(new_n81_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n145_), .c(new_n66_), .d(new_n74_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n90_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  oai21  g097(.a(new_n115_), .b(new_n159_), .c(new_n90_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(x23), .c(new_n90_), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  inv1   g101(.a(new_n161_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n90_), .c(new_n163_), .d(x23), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z17));
  nand3  g104(.a(new_n137_), .b(new_n132_), .c(new_n90_), .O(z18));
  inv1   g105(.a(z18), .O(z19));
  nor2   g106(.a(new_n91_), .b(new_n74_), .O(new_n169_));
  nor4   g107(.a(new_n169_), .b(new_n136_), .c(new_n130_), .d(new_n71_), .O(z20));
endmodule
