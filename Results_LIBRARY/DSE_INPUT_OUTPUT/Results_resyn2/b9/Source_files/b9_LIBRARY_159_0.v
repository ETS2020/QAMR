...
module FAU ( 
  ...
  nand2  g052(.a(new_n114_), .b(new_n105_), .O(z09));
  ...
  nand2  g057(.a(x35), .b(new_n90_), .O(new_n120_));
  ...
  nor2   g062(.a(new_n78_), .b(new_n66_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x05), .O(new_n126_));
  oai21  g064(.a(new_n124_), .b(new_n84_), .c(new_n126_), .O(z10));
  nand3  g065(.a(x35), .b(new_n90_), .c(new_n65_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n84_), .c(new_n83_), .O(new_n129_));
  nand3  g067(.a(x40), .b(x39), .c(x29), .O(new_n130_));
  nor2   g068(.a(new_n84_), .b(new_n65_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n120_), .c(new_n130_), .O(new_n132_));
  ...
  nand2  g073(.a(new_n135_), .b(new_n105_), .O(z11));
  nand2  g074(.a(new_n67_), .b(x27), .O(new_n137_));
  nand2  g075(.a(new_n68_), .b(new_n137_), .O(new_n138_));
  nand2  g076(.a(new_n105_), .b(new_n138_), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  nor2   g078(.a(new_n112_), .b(x04), .O(new_n141_));
  ...
  aoi21  g090(.a(new_n125_), .b(new_n140_), .c(new_n72_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand2  g092(.a(new_n141_), .b(new_n140_), .O(new_n155_));
  nand2  g093(.a(new_n90_), .b(x27), .O(new_n156_));
  and2   g094(.a(new_n156_), .b(new_n78_), .O(new_n157_));
  oai22  g095(.a(new_n157_), .b(new_n155_), .c(new_n63_), .d(new_n84_), .O(new_n158_));
  nand3  g096(.a(new_n142_), .b(new_n78_), .c(x28), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n141_), .c(new_n140_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n148_), .c(new_n72_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z14));
  nand4  g100(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n105_), .O(z15));
  nand2  g102(.a(x22), .b(x01), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(x23), .c(new_n105_), .O(z16));
  inv1   g104(.a(x24), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x23), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n165_), .c(new_n105_), .O(z17));
  aoi21  g107(.a(new_n84_), .b(new_n83_), .c(new_n120_), .O(new_n170_));
  inv1   g108(.a(new_n131_), .O(new_n171_));
  inv1   g109(.a(new_n134_), .O(new_n172_));
  aoi21  g110(.a(new_n171_), .b(new_n170_), .c(new_n172_), .O(new_n173_));
  nand3  g111(.a(z08), .b(x29), .c(x08), .O(new_n174_));
  oai21  g112(.a(new_n173_), .b(new_n72_), .c(new_n174_), .O(z18));
  nand2  g113(.a(new_n128_), .b(x39), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n83_), .O(new_n178_));
  nand2  g116(.a(new_n134_), .b(new_n105_), .O(new_n179_));
  aoi21  g117(.a(new_n178_), .b(new_n132_), .c(new_n179_), .O(z19));
  aoi21  g118(.a(new_n130_), .b(new_n120_), .c(new_n83_), .O(new_n181_));
  oai21  g119(.a(new_n75_), .b(new_n84_), .c(new_n134_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(new_n105_), .O(z20));
endmodule
