...
module FAU ( 
  ...
  nor2   g008(.a(x22), .b(x11), .O(new_n71_));
  ...
  nor2   g033(.a(new_n71_), .b(x21), .O(new_n96_));
  ...
  nand2  g088(.a(new_n141_), .b(new_n79_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n145_), .O(new_n153_));
  aoi21  g091(.a(new_n75_), .b(x27), .c(new_n120_), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(new_n143_), .c(new_n66_), .d(new_n133_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(new_n84_), .O(z14));
  ...
  nand3  g101(.a(new_n136_), .b(new_n131_), .c(new_n84_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nor2   g103(.a(new_n91_), .b(new_n133_), .O(new_n166_));
  nor4   g104(.a(new_n166_), .b(new_n135_), .c(new_n129_), .d(new_n71_), .O(z20));
endmodule
