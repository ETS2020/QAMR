...
module FAU ( 
  ...
  nor2   g01(.a(new_n63_), .b(x24), .O(new_n64_));
  ...
  nand2  g40(.a(new_n63_), .b(x00), .O(new_n103_));
  ...
  nand2  g49(.a(new_n111_), .b(new_n79_), .O(z07));
  nand4  g50(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(new_n79_), .O(z09));
  nor2   g52(.a(new_n81_), .b(new_n66_), .O(new_n115_));
  nand2  g53(.a(new_n72_), .b(x05), .O(new_n116_));
  inv1   g54(.a(new_n116_), .O(new_n117_));
  inv1   g55(.a(x07), .O(new_n118_));
  nor2   g56(.a(new_n72_), .b(new_n118_), .O(new_n119_));
  aoi22  g57(.a(new_n119_), .b(new_n115_), .c(new_n117_), .d(new_n83_), .O(new_n120_));
  ...
  inv1   g67(.a(new_n85_), .O(new_n130_));
  nor2   g68(.a(new_n66_), .b(x04), .O(new_n131_));
  or2    g69(.a(x30), .b(x09), .O(new_n132_));
  aoi21  g70(.a(new_n131_), .b(new_n130_), .c(new_n132_), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(new_n129_), .c(new_n79_), .O(new_n134_));
  inv1   g72(.a(new_n134_), .O(z11));
  oai21  g73(.a(new_n76_), .b(new_n74_), .c(new_n79_), .O(z12));
  oai21  g74(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n137_));
  nor2   g75(.a(x13), .b(x04), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(new_n137_), .c(new_n72_), .O(new_n139_));
  ...
  nand2  g82(.a(new_n138_), .b(new_n72_), .O(new_n145_));
  nor2   g83(.a(new_n145_), .b(new_n82_), .O(new_n146_));
  inv1   g84(.a(new_n146_), .O(new_n147_));
  aoi21  g85(.a(new_n147_), .b(new_n144_), .c(new_n64_), .O(z13));
  nor3   g86(.a(new_n146_), .b(new_n143_), .c(new_n64_), .O(z14));
  nand4  g87(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n150_));
  nand2  g88(.a(new_n150_), .b(new_n79_), .O(z15));
  nand2  g89(.a(x22), .b(x01), .O(new_n152_));
  oai21  g90(.a(new_n152_), .b(x23), .c(new_n79_), .O(z16));
  nand3  g91(.a(x23), .b(x22), .c(x01), .O(new_n154_));
  aoi21  g92(.a(new_n154_), .b(new_n63_), .c(x24), .O(z17));
  aoi21  g93(.a(new_n133_), .b(new_n129_), .c(new_n64_), .O(z18));
  nor2   g94(.a(new_n132_), .b(new_n64_), .O(new_n157_));
  oai21  g95(.a(new_n69_), .b(new_n66_), .c(new_n157_), .O(new_n158_));
  nor2   g96(.a(new_n158_), .b(new_n127_), .O(z20));
  inv1   g97(.a(new_n134_), .O(z19));
endmodule
