...
module FAU ( 
  ...
  nand2  g032(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(x21), .O(z03));
  aoi21  g034(.a(new_n94_), .b(new_n76_), .c(x21), .O(new_n97_));
  ...
  nor2   g051(.a(new_n73_), .b(new_n87_), .O(z08));
  and2   g052(.a(x34), .b(x27), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x26), .c(x11), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n91_), .O(z09));
  aoi21  g055(.a(new_n81_), .b(new_n80_), .c(new_n87_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n87_), .b(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n79_), .c(new_n118_), .O(new_n121_));
  oai21  g059(.a(new_n87_), .b(x05), .c(new_n65_), .O(new_n122_));
  ...
  nand4  g069(.a(x35), .b(new_n77_), .c(x27), .d(new_n65_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n91_), .O(z11));
  ...
  oai21  g076(.a(new_n63_), .b(new_n76_), .c(new_n66_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n91_), .O(z12));
  ...
  oai21  g082(.a(new_n72_), .b(new_n92_), .c(x28), .O(new_n145_));
  ...
  nand2  g087(.a(new_n146_), .b(new_n118_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n91_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n91_), .O(new_n152_));
  aoi21  g090(.a(new_n148_), .b(x27), .c(new_n152_), .O(z14));
  nand4  g091(.a(new_n115_), .b(new_n91_), .c(x26), .d(x12), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(z15));
  inv1   g093(.a(x23), .O(new_n156_));
  nand4  g094(.a(new_n72_), .b(new_n156_), .c(x22), .d(x01), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(x23), .c(x22), .d(x01), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n91_), .O(z17));
  nand4  g099(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n91_), .O(z18));
  oai21  g100(.a(new_n92_), .b(new_n76_), .c(new_n133_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n129_), .c(new_n91_), .O(z20));
  nand2  g102(.a(new_n134_), .b(new_n91_), .O(z19));
endmodule
