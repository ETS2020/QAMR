...
module FAU ( 
  ...
  nand2  g049(.a(new_n87_), .b(new_n98_), .O(z08));
  ...
  oai21  g054(.a(new_n91_), .b(x28), .c(new_n76_), .O(new_n117_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n131_), .c(new_n98_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  nand2  g076(.a(new_n67_), .b(x27), .O(new_n139_));
  nand3  g077(.a(new_n98_), .b(new_n68_), .c(new_n139_), .O(new_n140_));
  ...
  nand4  g086(.a(new_n148_), .b(new_n98_), .c(new_n147_), .d(x20), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand3  g089(.a(new_n144_), .b(new_n115_), .c(new_n82_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand2  g091(.a(new_n144_), .b(new_n115_), .O(new_n154_));
  ...
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(new_n98_), .O(z14));
  nand4  g099(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n98_), .O(z15));
  ...
  oai21  g105(.a(new_n167_), .b(new_n164_), .c(new_n98_), .O(z17));
  nand2  g106(.a(new_n136_), .b(new_n131_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n98_), .O(z19));
  nand2  g108(.a(x35), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n134_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n129_), .c(new_n98_), .O(z20));
endmodule
