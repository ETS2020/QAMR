...
module FAU ( 
  ...
  nor2   g008(.a(x36), .b(x03), .O(new_n71_));
  ...
  aoi21  g031(.a(new_n91_), .b(new_n93_), .c(new_n71_), .O(z04));
  ...
  inv1   g045(.a(new_n71_), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(new_n84_), .O(z08));
  nand2  g047(.a(x34), .b(x27), .O(new_n110_));
  nand2  g048(.a(x26), .b(x11), .O(new_n111_));
  oai21  g049(.a(new_n111_), .b(new_n110_), .c(new_n108_), .O(z09));
  ...
  nand3  g060(.a(new_n122_), .b(new_n121_), .c(new_n108_), .O(z10));
  ...
  nand3  g071(.a(new_n133_), .b(new_n128_), .c(new_n108_), .O(z18));
  ...
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n108_), .O(z12));
  ...
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n108_), .O(new_n150_));
  ...
  oai21  g093(.a(new_n148_), .b(new_n74_), .c(new_n108_), .O(new_n156_));
  aoi21  g094(.a(new_n155_), .b(x27), .c(new_n156_), .O(z14));
  nand2  g095(.a(x26), .b(x12), .O(new_n158_));
  nor3   g096(.a(new_n158_), .b(new_n110_), .c(new_n71_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n108_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  inv1   g100(.a(new_n160_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n108_), .c(new_n162_), .d(x23), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z17));
  nand2  g103(.a(new_n133_), .b(new_n128_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n108_), .O(z19));
  nor2   g105(.a(new_n130_), .b(new_n71_), .O(new_n168_));
