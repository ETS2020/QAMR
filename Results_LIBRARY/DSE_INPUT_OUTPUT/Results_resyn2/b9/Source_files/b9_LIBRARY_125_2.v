...
module FAU ( 
  ...
  nor2   g014(.a(new_n76_), .b(new_n63_), .O(z08));
  ...
  aoi21  g019(.a(new_n81_), .b(new_n73_), .c(new_n67_), .O(new_n82_));
  ...
  nor2   g025(.a(new_n72_), .b(x28), .O(new_n88_));
  ...
  oai21  g030(.a(new_n92_), .b(new_n76_), .c(x39), .O(z02));
  ...
  aoi21  g059(.a(new_n81_), .b(new_n73_), .c(x04), .O(new_n122_));
  nand2  g060(.a(x37), .b(x06), .O(new_n123_));
  aoi21  g061(.a(new_n76_), .b(x39), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n81_), .c(new_n89_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand3  g069(.a(new_n88_), .b(x27), .c(new_n71_), .O(new_n132_));
  nor2   g070(.a(x30), .b(x09), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n132_), .c(new_n104_), .O(new_n134_));
  aoi21  g072(.a(new_n131_), .b(new_n130_), .c(new_n134_), .O(z11));
  nand2  g073(.a(new_n75_), .b(x40), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x39), .c(new_n69_), .O(z12));
  aoi21  g075(.a(x36), .b(x35), .c(new_n80_), .O(new_n138_));
  inv1   g076(.a(x13), .O(new_n139_));
  nand3  g077(.a(x39), .b(new_n139_), .c(new_n71_), .O(new_n140_));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x20), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n68_), .c(new_n140_), .d(new_n138_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nand2  g082(.a(new_n139_), .b(new_n71_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n83_), .c(x40), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x39), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(z13));
  nand2  g086(.a(new_n94_), .b(new_n72_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n141_), .c(x20), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n138_), .c(new_n67_), .O(new_n151_));
  nand2  g089(.a(x35), .b(x28), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n94_), .O(new_n153_));
  nand4  g091(.a(new_n141_), .b(new_n153_), .c(x27), .d(x20), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n140_), .c(new_n64_), .O(new_n155_));
  oai21  g093(.a(new_n151_), .b(new_n84_), .c(new_n155_), .O(z14));
  nand4  g094(.a(new_n116_), .b(new_n104_), .c(x26), .d(x12), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z15));
  inv1   g096(.a(x23), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(x22), .c(x01), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n104_), .O(z16));
  nor2   g099(.a(x24), .b(new_n159_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n104_), .c(x22), .d(x01), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z17));
  nand2  g102(.a(new_n131_), .b(new_n130_), .O(new_n165_));
  inv1   g103(.a(new_n134_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(z18));
  oai21  g105(.a(new_n72_), .b(new_n67_), .c(new_n133_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n130_), .c(new_n104_), .O(z20));
