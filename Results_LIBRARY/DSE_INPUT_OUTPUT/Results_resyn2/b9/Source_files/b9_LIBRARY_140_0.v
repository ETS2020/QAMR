...
module FAU ( 
  ...
  nor2   g00(.a(x25), .b(x22), .O(new_n63_));
  ...
  nor2   g52(.a(new_n79_), .b(new_n65_), .O(new_n115_));
  nand2  g53(.a(new_n71_), .b(x05), .O(new_n116_));
  inv1   g54(.a(new_n116_), .O(new_n117_));
  and2   g55(.a(new_n86_), .b(x07), .O(new_n118_));
  aoi22  g56(.a(new_n118_), .b(new_n115_), .c(new_n117_), .d(new_n81_), .O(new_n119_));
  ...
  nor2   g66(.a(new_n68_), .b(new_n65_), .O(new_n129_));
  nand3  g67(.a(new_n129_), .b(new_n78_), .c(new_n67_), .O(new_n130_));
  nor2   g68(.a(x30), .b(x09), .O(new_n131_));
  and2   g69(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n128_), .c(new_n99_), .O(new_n133_));
  inv1   g71(.a(new_n133_), .O(z11));
  oai21  g72(.a(new_n75_), .b(new_n73_), .c(new_n99_), .O(z12));
  ...
  oai21  g79(.a(new_n137_), .b(new_n80_), .c(new_n99_), .O(new_n142_));
  aoi21  g80(.a(new_n141_), .b(x27), .c(new_n142_), .O(z14));
  inv1   g81(.a(z14), .O(z13));
  inv1   g82(.a(x12), .O(new_n145_));
  oai21  g83(.a(new_n113_), .b(new_n145_), .c(new_n99_), .O(z15));
  nand2  g84(.a(x22), .b(x01), .O(new_n147_));
  oai21  g85(.a(new_n147_), .b(x23), .c(new_n99_), .O(z16));
  inv1   g86(.a(x24), .O(new_n149_));
  nand2  g87(.a(new_n149_), .b(x23), .O(new_n150_));
  oai21  g88(.a(new_n150_), .b(new_n147_), .c(new_n99_), .O(z17));
  aoi21  g89(.a(new_n132_), .b(new_n128_), .c(new_n63_), .O(z18));
  nand2  g90(.a(new_n132_), .b(new_n128_), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(new_n99_), .O(z19));
  nor2   g92(.a(new_n129_), .b(new_n63_), .O(new_n155_));
