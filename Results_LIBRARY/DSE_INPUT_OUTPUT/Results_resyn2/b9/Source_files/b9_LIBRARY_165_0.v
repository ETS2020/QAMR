...
module FAU ( 
  ...
  nand3  g078(.a(new_n140_), .b(new_n135_), .c(new_n116_), .O(new_n141_));
  ...
  nand4  g100(.a(new_n162_), .b(new_n116_), .c(new_n161_), .d(x23), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z17));
  aoi21  g102(.a(new_n140_), .b(new_n135_), .c(new_n63_), .O(z18));
  nor2   g103(.a(new_n139_), .b(new_n63_), .O(new_n166_));
  oai21  g104(.a(new_n71_), .b(new_n65_), .c(new_n166_), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(new_n133_), .O(z20));
  inv1   g106(.a(new_n141_), .O(z19));
endmodule
