...
module FAU ( 
  ...
  nand2  g020(.a(x35), .b(new_n76_), .O(new_n83_));
  aoi21  g021(.a(new_n75_), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  inv1   g022(.a(new_n84_), .O(new_n85_));
  aoi21  g023(.a(new_n85_), .b(x04), .c(new_n81_), .O(new_n86_));
  ...
  nand2  g033(.a(new_n95_), .b(new_n71_), .O(z05));
  ...
  nand2  g048(.a(new_n71_), .b(x11), .O(new_n111_));
  nor2   g049(.a(new_n111_), .b(new_n110_), .O(z09));
  nor2   g050(.a(new_n77_), .b(new_n75_), .O(new_n113_));
  and2   g051(.a(x39), .b(x05), .O(new_n114_));
  inv1   g052(.a(x07), .O(new_n115_));
  nor2   g053(.a(x39), .b(new_n115_), .O(new_n116_));
  aoi22  g054(.a(new_n116_), .b(new_n113_), .c(new_n114_), .d(new_n79_), .O(new_n117_));
  ...
  aoi21  g059(.a(new_n121_), .b(new_n83_), .c(new_n82_), .O(new_n122_));
  nand2  g060(.a(new_n121_), .b(x27), .O(new_n123_));
  nand4  g061(.a(x35), .b(new_n76_), .c(x27), .d(new_n63_), .O(new_n124_));
  ...
  aoi21  g066(.a(new_n123_), .b(new_n122_), .c(new_n128_), .O(z11));
  nor2   g067(.a(new_n67_), .b(new_n75_), .O(new_n130_));
  nor2   g068(.a(new_n66_), .b(new_n75_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(x10), .c(new_n63_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x40), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(x39), .c(new_n130_), .O(z12));
  ...
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(x40), .O(new_n141_));
  ...
  nand2  g084(.a(new_n146_), .b(new_n130_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n142_), .O(z13));
  nand2  g086(.a(new_n136_), .b(x40), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x39), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  inv1   g089(.a(new_n139_), .O(new_n152_));
  oai21  g090(.a(x37), .b(x35), .c(new_n146_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n152_), .c(new_n75_), .O(new_n154_));
  nand2  g092(.a(new_n78_), .b(x40), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n154_), .c(new_n151_), .O(z14));
  inv1   g094(.a(x12), .O(new_n157_));
  oai21  g095(.a(new_n110_), .b(new_n157_), .c(new_n71_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n71_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  inv1   g099(.a(new_n159_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n71_), .c(new_n161_), .d(x23), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z17));
  inv1   g102(.a(z11), .O(z18));
  oai21  g103(.a(new_n75_), .b(new_n63_), .c(new_n84_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n121_), .b(new_n82_), .c(new_n125_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n71_), .O(z19));
  nor2   g107(.a(new_n88_), .b(new_n75_), .O(new_n170_));
  nor3   g108(.a(new_n170_), .b(new_n126_), .c(new_n122_), .O(z20));
