...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n76_), .c(x40), .O(z02));
  ...
  aoi21  g061(.a(x40), .b(new_n76_), .c(new_n123_), .O(new_n124_));
  ...
  nand2  g073(.a(new_n75_), .b(x39), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x40), .c(new_n69_), .O(z12));
  aoi21  g075(.a(x36), .b(x35), .c(new_n80_), .O(new_n138_));
  inv1   g076(.a(x13), .O(new_n139_));
  nand3  g077(.a(x40), .b(new_n139_), .c(new_n71_), .O(new_n140_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n83_), .c(x39), .O(new_n146_));
