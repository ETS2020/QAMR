...
module FAU ( 
  ...
  nor2   g027(.a(new_n73_), .b(new_n89_), .O(z08));
  nand3  g028(.a(z08), .b(new_n88_), .c(new_n86_), .O(z02));
  ...
  inv1   g052(.a(new_n89_), .O(new_n115_));
  ...
  aoi21  g110(.a(new_n139_), .b(new_n133_), .c(new_n73_), .O(z18));
  nand3  g111(.a(new_n139_), .b(new_n133_), .c(new_n98_), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(z19));
  nand2  g113(.a(x35), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n116_), .c(new_n137_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n131_), .c(new_n98_), .O(z20));
endmodule
