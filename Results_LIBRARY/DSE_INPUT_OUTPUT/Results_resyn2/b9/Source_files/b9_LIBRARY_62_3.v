...
module FAU ( 
  ...
  inv1   g40(.a(x07), .O(new_n103_));
  nor2   g41(.a(new_n103_), .b(x04), .O(new_n104_));
  and2   g42(.a(x37), .b(x06), .O(new_n105_));
  aoi21  g43(.a(new_n104_), .b(new_n74_), .c(new_n105_), .O(new_n106_));
  oai21  g44(.a(new_n106_), .b(new_n66_), .c(z02), .O(z10));
  nor2   g45(.a(x30), .b(x09), .O(new_n108_));
  nor2   g46(.a(x27), .b(x08), .O(new_n109_));
  inv1   g47(.a(x28), .O(new_n110_));
  nand2  g48(.a(x27), .b(x04), .O(new_n111_));
  nand3  g49(.a(new_n111_), .b(x35), .c(new_n110_), .O(new_n112_));
  oai21  g50(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(z02), .O(z11));
  nor2   g52(.a(new_n69_), .b(z08), .O(z12));
  nor2   g53(.a(x19), .b(x18), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(x20), .O(new_n117_));
  inv1   g55(.a(new_n117_), .O(new_n118_));
  aoi21  g56(.a(new_n118_), .b(new_n69_), .c(z08), .O(z14));
  inv1   g57(.a(z14), .O(z13));
  inv1   g58(.a(x12), .O(new_n121_));
  oai21  g59(.a(new_n100_), .b(new_n121_), .c(z02), .O(z15));
  nand2  g60(.a(x22), .b(x01), .O(new_n123_));
  oai21  g61(.a(new_n123_), .b(x23), .c(z02), .O(z16));
  inv1   g62(.a(x24), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(x23), .O(new_n126_));
  oai21  g64(.a(new_n126_), .b(new_n123_), .c(z02), .O(z17));
  inv1   g65(.a(z11), .O(z18));
  nor2   g66(.a(new_n113_), .b(z08), .O(z19));
  aoi21  g67(.a(new_n110_), .b(x08), .c(x27), .O(new_n130_));
  oai21  g68(.a(new_n130_), .b(new_n72_), .c(new_n108_), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(z02), .O(z20));
endmodule
