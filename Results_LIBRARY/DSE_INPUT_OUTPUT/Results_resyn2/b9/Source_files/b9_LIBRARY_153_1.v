...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n76_), .c(x27), .O(new_n93_));
  inv1   g031(.a(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n93_), .c(new_n85_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n95_), .b(new_n94_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n93_), .c(new_n72_), .O(z04));
  oai21  g037(.a(new_n76_), .b(new_n94_), .c(new_n95_), .O(new_n100_));
  and2   g038(.a(new_n100_), .b(new_n85_), .O(z05));
  inv1   g039(.a(z05), .O(z06));
  nor2   g040(.a(x25), .b(x00), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(x38), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(x03), .O(new_n105_));
  inv1   g043(.a(x15), .O(new_n106_));
  nand2  g044(.a(x17), .b(new_n106_), .O(new_n107_));
  nand2  g045(.a(x38), .b(x25), .O(new_n108_));
  nor2   g046(.a(x33), .b(x31), .O(new_n109_));
  nand3  g047(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(new_n110_));
  aoi22  g048(.a(new_n110_), .b(x14), .c(new_n105_), .d(new_n71_), .O(z07));
  nand2  g049(.a(new_n85_), .b(new_n83_), .O(z08));
  and2   g050(.a(x34), .b(x27), .O(new_n113_));
  nand3  g051(.a(new_n113_), .b(x26), .c(x11), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n85_), .O(z09));
  nand3  g053(.a(x40), .b(x39), .c(x05), .O(new_n116_));
  nand2  g054(.a(new_n83_), .b(x07), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n78_), .c(x27), .O(new_n119_));
  inv1   g057(.a(new_n80_), .O(new_n120_));
  ...
  nor2   g069(.a(new_n92_), .b(new_n94_), .O(new_n132_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n131_), .c(new_n85_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nand2  g075(.a(new_n85_), .b(new_n69_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z12));
  aoi21  g077(.a(x36), .b(x35), .c(new_n76_), .O(new_n140_));
  inv1   g078(.a(x13), .O(new_n141_));
  nand3  g079(.a(new_n84_), .b(new_n141_), .c(new_n63_), .O(new_n142_));
  ...
  nor2   g084(.a(new_n142_), .b(new_n80_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n72_), .O(z13));
  nand4  g087(.a(new_n84_), .b(new_n76_), .c(new_n141_), .d(new_n63_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n66_), .c(new_n94_), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n80_), .c(x28), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n84_), .c(new_n141_), .d(new_n63_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n144_), .c(new_n72_), .O(new_n155_));
  oai21  g093(.a(new_n151_), .b(new_n147_), .c(new_n155_), .O(z14));
  nand4  g094(.a(new_n113_), .b(new_n85_), .c(x26), .d(x12), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n85_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n85_), .O(z17));
  aoi21  g101(.a(new_n135_), .b(new_n131_), .c(new_n72_), .O(z18));
  inv1   g102(.a(z18), .O(z19));
  nor4   g103(.a(new_n134_), .b(new_n132_), .c(new_n129_), .d(new_n72_), .O(z20));
endmodule
