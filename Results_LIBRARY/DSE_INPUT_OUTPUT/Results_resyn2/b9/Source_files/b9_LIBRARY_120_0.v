...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n156_, new_n157_, new_n159_, new_n160_, new_n163_;
  ...
  nor2   g009(.a(x36), .b(x23), .O(new_n72_));
  ...
  nor2   g018(.a(new_n72_), .b(new_n65_), .O(new_n81_));
  oai21  g019(.a(new_n80_), .b(new_n79_), .c(new_n81_), .O(z01));
  ...
  aoi21  g025(.a(new_n87_), .b(new_n84_), .c(new_n72_), .O(z02));
  inv1   g026(.a(new_n72_), .O(new_n89_));
  inv1   g027(.a(x35), .O(new_n90_));
  oai21  g028(.a(new_n90_), .b(new_n77_), .c(x27), .O(new_n91_));
  inv1   g029(.a(x37), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n75_), .O(new_n93_));
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(x21), .O(z03));
  aoi21  g032(.a(new_n92_), .b(new_n75_), .c(x21), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n91_), .c(new_n72_), .O(z04));
  aoi21  g034(.a(x28), .b(x27), .c(x37), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n89_), .O(z05));
  inv1   g036(.a(new_n97_), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n89_), .O(z06));
  ...
  nand2  g048(.a(new_n110_), .b(new_n89_), .O(z07));
  nor2   g049(.a(new_n72_), .b(new_n85_), .O(z08));
  nand2  g050(.a(x34), .b(x27), .O(new_n113_));
  nand2  g051(.a(x26), .b(x11), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(new_n113_), .c(new_n89_), .O(z09));
  inv1   g053(.a(new_n85_), .O(new_n116_));
  nand2  g054(.a(new_n80_), .b(new_n116_), .O(new_n117_));
  oai21  g055(.a(new_n90_), .b(x28), .c(new_n76_), .O(new_n118_));
  ...
  nand3  g064(.a(new_n126_), .b(new_n125_), .c(new_n89_), .O(z10));
  ...
  nand4  g070(.a(x35), .b(new_n77_), .c(x27), .d(new_n65_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n89_), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n75_), .c(new_n137_), .O(new_n139_));
  oai21  g077(.a(new_n63_), .b(new_n75_), .c(new_n66_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n139_), .c(new_n89_), .O(z12));
  aoi21  g079(.a(x36), .b(x35), .c(new_n77_), .O(new_n142_));
  inv1   g080(.a(x13), .O(new_n143_));
  nand4  g081(.a(x40), .b(x39), .c(new_n143_), .d(new_n65_), .O(new_n144_));
  nor2   g082(.a(x19), .b(x18), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x20), .O(new_n146_));
  oai22  g084(.a(new_n146_), .b(new_n63_), .c(new_n144_), .d(new_n142_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  inv1   g086(.a(new_n144_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n80_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n89_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n89_), .O(new_n152_));
  aoi21  g090(.a(new_n147_), .b(x27), .c(new_n152_), .O(z14));
  nand2  g091(.a(x26), .b(x12), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n113_), .c(new_n72_), .O(z15));
  inv1   g093(.a(x23), .O(new_n156_));
  nand4  g094(.a(x36), .b(new_n156_), .c(x22), .d(x01), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(x23), .c(x22), .d(x01), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n89_), .O(z17));
  nand4  g099(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n89_), .O(z18));
  oai21  g100(.a(new_n90_), .b(new_n75_), .c(new_n134_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n130_), .c(new_n89_), .O(z20));
  nand2  g102(.a(new_n135_), .b(new_n89_), .O(z19));
endmodule
