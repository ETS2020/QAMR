...
module FAU ( 
  ...
  oai21  g009(.a(new_n67_), .b(x15), .c(new_n71_), .O(new_n72_));
  ...
  nand2  g020(.a(x38), .b(x10), .O(new_n83_));
  ...
  nor2   g027(.a(new_n84_), .b(new_n89_), .O(z08));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n75_), .c(new_n84_), .O(new_n98_));
  ...
  nand2  g040(.a(new_n102_), .b(new_n83_), .O(z05));
  inv1   g041(.a(new_n102_), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(new_n83_), .O(z06));
  inv1   g043(.a(x10), .O(new_n106_));
  nand2  g044(.a(x25), .b(x14), .O(new_n107_));
  or2    g045(.a(x25), .b(x00), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(new_n109_));
  nand2  g047(.a(new_n109_), .b(x38), .O(new_n110_));
  ...
  nand2  g055(.a(new_n83_), .b(x11), .O(new_n118_));
  ...
  nor2   g060(.a(x32), .b(x30), .O(new_n123_));
  nor2   g061(.a(new_n120_), .b(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n122_), .b(new_n79_), .c(new_n124_), .O(new_n125_));
  nand3  g063(.a(x37), .b(x27), .c(x06), .O(new_n126_));
  and2   g064(.a(new_n126_), .b(new_n83_), .O(new_n127_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n83_), .O(z11));
  aoi21  g078(.a(new_n67_), .b(new_n71_), .c(new_n106_), .O(new_n141_));
  aoi21  g079(.a(new_n69_), .b(x27), .c(new_n141_), .O(z12));
  nand2  g080(.a(x36), .b(x35), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x28), .O(new_n144_));
  nor2   g082(.a(x13), .b(x04), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n66_), .O(new_n146_));
  ...
  nand3  g089(.a(new_n145_), .b(new_n82_), .c(new_n66_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n151_), .c(new_n84_), .O(z13));
  nand2  g091(.a(new_n145_), .b(new_n66_), .O(new_n154_));
  nand2  g092(.a(new_n148_), .b(x20), .O(new_n155_));
  nand3  g093(.a(new_n143_), .b(new_n123_), .c(x28), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n154_), .c(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n147_), .b(x27), .O(new_n159_));
  aoi21  g097(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n154_), .c(new_n159_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(new_n84_), .O(z14));
  inv1   g100(.a(x12), .O(new_n163_));
  oai21  g101(.a(new_n117_), .b(new_n163_), .c(new_n83_), .O(z15));
  inv1   g102(.a(x23), .O(new_n165_));
  nand4  g103(.a(new_n83_), .b(new_n165_), .c(x22), .d(x01), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(x23), .c(x22), .d(x01), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n83_), .O(z17));
  nand3  g108(.a(new_n138_), .b(new_n133_), .c(new_n83_), .O(z18));
  inv1   g109(.a(z18), .O(z19));
  nand2  g110(.a(x35), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n80_), .c(new_n135_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n131_), .c(new_n83_), .O(z20));
endmodule
