...
module FAU ( 
  ...
  nor2   g009(.a(x36), .b(x22), .O(new_n72_));
  ...
  nand2  g049(.a(new_n100_), .b(new_n86_), .O(z08));
  nand4  g050(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n100_), .O(z09));
  inv1   g052(.a(new_n86_), .O(new_n115_));
  inv1   g053(.a(new_n75_), .O(new_n116_));
  ...
  nor2   g070(.a(new_n76_), .b(new_n132_), .O(new_n133_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n131_), .c(new_n100_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  inv1   g076(.a(x10), .O(new_n139_));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n132_), .c(new_n139_), .O(new_n141_));
  oai21  g079(.a(new_n63_), .b(new_n132_), .c(new_n66_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n100_), .O(z12));
  aoi21  g081(.a(x36), .b(x35), .c(new_n82_), .O(new_n144_));
  ...
  oai22  g086(.a(new_n148_), .b(new_n63_), .c(new_n146_), .d(new_n144_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  oai21  g088(.a(new_n146_), .b(new_n75_), .c(new_n100_), .O(new_n151_));
  ...
  nand2  g093(.a(new_n155_), .b(new_n100_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n100_), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(x23), .c(x22), .d(x01), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z17));
  nand2  g099(.a(new_n136_), .b(new_n131_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n100_), .O(z19));
  oai21  g101(.a(new_n76_), .b(new_n132_), .c(new_n100_), .O(new_n164_));
  nor3   g102(.a(new_n164_), .b(new_n135_), .c(new_n129_), .O(z20));
endmodule
