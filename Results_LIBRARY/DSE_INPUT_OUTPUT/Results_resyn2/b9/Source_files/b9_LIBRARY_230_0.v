...
module FAU ( 
  ...
  nor2   g011(.a(x13), .b(x08), .O(new_n74_));
  ...
  nor2   g021(.a(new_n74_), .b(new_n65_), .O(new_n84_));
  oai21  g022(.a(new_n83_), .b(new_n81_), .c(new_n84_), .O(z01));
  inv1   g023(.a(x08), .O(new_n86_));
  oai21  g024(.a(x27), .b(new_n65_), .c(x13), .O(new_n87_));
  ...
  aoi21  g029(.a(new_n80_), .b(x04), .c(new_n68_), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(new_n91_), .c(new_n88_), .O(z02));
  ...
  aoi21  g037(.a(new_n97_), .b(new_n99_), .c(new_n74_), .O(z04));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n74_), .O(z10));
  nor2   g066(.a(x30), .b(x09), .O(new_n129_));
  nor2   g067(.a(new_n129_), .b(new_n74_), .O(new_n130_));
  inv1   g068(.a(new_n68_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x29), .O(new_n132_));
  inv1   g070(.a(new_n80_), .O(new_n133_));
  oai21  g071(.a(new_n77_), .b(new_n65_), .c(new_n133_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  inv1   g073(.a(x13), .O(new_n136_));
  nand3  g074(.a(new_n133_), .b(x27), .c(new_n65_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n136_), .c(new_n86_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n135_), .c(new_n130_), .O(z11));
  and2   g077(.a(new_n67_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n71_), .b(new_n140_), .c(new_n101_), .O(z12));
  aoi21  g079(.a(x36), .b(x35), .c(new_n79_), .O(new_n142_));
  nand2  g080(.a(new_n69_), .b(new_n136_), .O(new_n143_));
  ...
  oai21  g085(.a(new_n82_), .b(new_n66_), .c(x08), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n136_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  aoi21  g088(.a(new_n79_), .b(x27), .c(new_n83_), .O(new_n151_));
  oai22  g089(.a(new_n151_), .b(new_n143_), .c(new_n63_), .d(new_n77_), .O(new_n152_));
  nand2  g090(.a(new_n142_), .b(new_n82_), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n143_), .c(new_n145_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n101_), .O(z14));
  nand4  g094(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n101_), .O(z15));
  nand2  g096(.a(x22), .b(x01), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(x23), .c(new_n101_), .O(z16));
  inv1   g098(.a(x24), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x23), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n159_), .c(new_n101_), .O(z17));
  aoi21  g101(.a(x27), .b(x13), .c(x08), .O(new_n164_));
  and2   g102(.a(x29), .b(x08), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n131_), .c(new_n130_), .O(new_n166_));
  oai21  g104(.a(new_n164_), .b(new_n134_), .c(new_n166_), .O(z18));
  aoi21  g105(.a(new_n132_), .b(new_n80_), .c(new_n86_), .O(new_n168_));
  oai21  g106(.a(new_n94_), .b(new_n77_), .c(new_n129_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n101_), .O(z20));
  aoi21  g108(.a(new_n138_), .b(new_n135_), .c(new_n130_), .O(z19));
endmodule
