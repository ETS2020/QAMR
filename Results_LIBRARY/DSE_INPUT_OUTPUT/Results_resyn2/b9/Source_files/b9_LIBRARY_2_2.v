...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n152_, new_n155_, new_n157_, new_n158_, new_n160_, new_n161_,
  ...
  aoi21  g018(.a(new_n80_), .b(new_n70_), .c(new_n66_), .O(new_n81_));
  inv1   g019(.a(x30), .O(new_n82_));
  inv1   g020(.a(x32), .O(new_n83_));
  nand2  g021(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nor2   g022(.a(new_n64_), .b(new_n68_), .O(new_n85_));
  ...
  nor2   g046(.a(new_n63_), .b(x15), .O(new_n109_));
  ...
  nand2  g050(.a(new_n112_), .b(new_n87_), .O(z07));
  nand2  g051(.a(x40), .b(x39), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n87_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand3  g054(.a(x34), .b(x27), .c(x26), .O(new_n117_));
  nor3   g055(.a(new_n117_), .b(new_n64_), .c(new_n116_), .O(z09));
  nand2  g056(.a(new_n84_), .b(new_n72_), .O(new_n119_));
  nand2  g057(.a(new_n80_), .b(new_n70_), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n114_), .b(new_n121_), .O(new_n122_));
  ...
  aoi21  g063(.a(new_n72_), .b(new_n125_), .c(x04), .O(new_n126_));
  ...
  nand3  g080(.a(new_n75_), .b(new_n142_), .c(new_n87_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z12));
  nor2   g082(.a(x19), .b(x18), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x20), .O(new_n146_));
  aoi21  g084(.a(x36), .b(x35), .c(new_n79_), .O(new_n147_));
  nor2   g085(.a(x13), .b(x04), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n72_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n147_), .c(new_n146_), .d(new_n67_), .O(new_n150_));
  nand3  g088(.a(new_n148_), .b(new_n84_), .c(new_n72_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n87_), .O(new_n152_));
  aoi21  g090(.a(new_n150_), .b(x27), .c(new_n152_), .O(z14));
  inv1   g091(.a(z14), .O(z13));
  inv1   g092(.a(x12), .O(new_n155_));
  oai21  g093(.a(new_n117_), .b(new_n155_), .c(new_n87_), .O(z15));
  inv1   g094(.a(x01), .O(new_n157_));
  inv1   g095(.a(x22), .O(new_n158_));
  nor4   g096(.a(new_n64_), .b(x23), .c(new_n158_), .d(new_n157_), .O(z16));
  inv1   g097(.a(x24), .O(new_n160_));
  nor2   g098(.a(new_n158_), .b(new_n157_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n87_), .c(new_n160_), .d(x23), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z17));
  aoi21  g101(.a(new_n139_), .b(new_n134_), .c(new_n64_), .O(z18));
  nor2   g102(.a(new_n138_), .b(new_n64_), .O(new_n165_));
  oai21  g103(.a(new_n69_), .b(new_n66_), .c(new_n165_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n132_), .O(z20));
  inv1   g105(.a(new_n140_), .O(z19));
endmodule
