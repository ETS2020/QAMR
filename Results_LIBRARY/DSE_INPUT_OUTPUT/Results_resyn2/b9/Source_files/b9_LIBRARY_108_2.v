...
module FAU ( 
  ...
  nor2   g026(.a(new_n72_), .b(new_n88_), .O(z08));
  ...
  nand3  g051(.a(new_n113_), .b(new_n97_), .c(x11), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z09));
  inv1   g053(.a(new_n88_), .O(new_n116_));
  nand2  g054(.a(new_n81_), .b(new_n116_), .O(new_n117_));
  ...
  nand3  g064(.a(new_n126_), .b(new_n125_), .c(new_n97_), .O(z10));
  ...
  nor2   g070(.a(new_n91_), .b(new_n75_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n77_), .c(new_n63_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  and2   g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n132_), .c(new_n97_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  nand2  g076(.a(new_n68_), .b(x27), .O(new_n139_));
  nand2  g077(.a(new_n65_), .b(x10), .O(new_n140_));
  nand3  g078(.a(new_n97_), .b(new_n140_), .c(new_n139_), .O(new_n141_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n116_), .c(new_n77_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(new_n75_), .O(new_n149_));
  nand2  g087(.a(new_n147_), .b(new_n116_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n80_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(new_n97_), .O(new_n152_));
  ...
  oai21  g094(.a(new_n156_), .b(new_n150_), .c(new_n146_), .O(new_n157_));
  oai21  g095(.a(new_n150_), .b(new_n80_), .c(new_n97_), .O(new_n158_));
  aoi21  g096(.a(new_n157_), .b(x27), .c(new_n158_), .O(z14));
  nand3  g097(.a(new_n113_), .b(new_n97_), .c(x12), .O(new_n160_));
  ...
  nand4  g103(.a(new_n165_), .b(new_n97_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  aoi21  g105(.a(new_n136_), .b(new_n132_), .c(new_n72_), .O(z18));
  nand2  g106(.a(new_n136_), .b(new_n132_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n97_), .O(z19));
  nor2   g108(.a(new_n133_), .b(new_n72_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n135_), .O(new_n172_));
