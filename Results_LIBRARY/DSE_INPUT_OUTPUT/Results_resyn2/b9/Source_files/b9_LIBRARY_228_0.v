...
module FAU ( 
  ...
  nand4  g052(.a(new_n98_), .b(x34), .c(x27), .d(x26), .O(new_n115_));
  nor2   g053(.a(new_n115_), .b(new_n114_), .O(z09));
  nand2  g054(.a(z08), .b(new_n81_), .O(new_n117_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n98_), .O(z10));
  nand3  g066(.a(x40), .b(x39), .c(x29), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n78_), .c(new_n84_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nor2   g070(.a(new_n118_), .b(x28), .O(new_n133_));
  ...
  nand2  g075(.a(new_n64_), .b(new_n93_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x27), .c(x10), .O(new_n139_));
  nand2  g077(.a(new_n91_), .b(new_n93_), .O(new_n140_));
  inv1   g078(.a(x40), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(x04), .O(new_n142_));
  aoi21  g080(.a(new_n140_), .b(x27), .c(new_n142_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n139_), .c(x39), .O(new_n144_));
  nand2  g082(.a(new_n140_), .b(x27), .O(new_n145_));
  nor2   g083(.a(new_n141_), .b(x39), .O(new_n146_));
  ...
  nand4  g089(.a(new_n151_), .b(new_n142_), .c(x39), .d(new_n149_), .O(new_n152_));
  nor2   g090(.a(x19), .b(x18), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n98_), .c(new_n140_), .d(x20), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nor2   g094(.a(x13), .b(x04), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(z08), .c(new_n81_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(z13));
  nand2  g097(.a(new_n153_), .b(x20), .O(new_n160_));
  nand3  g098(.a(new_n150_), .b(new_n80_), .c(x28), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n142_), .c(x39), .d(new_n149_), .O(new_n162_));
  ...
  nand2  g103(.a(new_n165_), .b(new_n145_), .O(new_n166_));
  ...
  nand2  g109(.a(new_n171_), .b(new_n98_), .O(z16));
  nor2   g110(.a(x24), .b(new_n170_), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n98_), .c(x22), .d(x01), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(z17));
  nand4  g113(.a(new_n135_), .b(new_n134_), .c(new_n132_), .d(new_n98_), .O(z18));
  inv1   g114(.a(new_n88_), .O(new_n177_));
  nand2  g115(.a(new_n75_), .b(new_n84_), .O(new_n178_));
  nand2  g116(.a(x27), .b(x04), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n178_), .c(new_n133_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n135_), .O(new_n181_));
  aoi22  g119(.a(new_n181_), .b(new_n98_), .c(new_n177_), .d(z08), .O(z19));
  nand2  g120(.a(x35), .b(x27), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n135_), .c(new_n98_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n130_), .O(z20));
endmodule
