...
module FAU ( 
  ...
  nor2   g009(.a(x23), .b(x22), .O(new_n72_));
  ...
  nor2   g035(.a(new_n72_), .b(x37), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n93_), .O(z05));
  ...
  oai21  g053(.a(new_n115_), .b(new_n114_), .c(new_n101_), .O(z09));
  aoi21  g054(.a(new_n81_), .b(new_n80_), .c(new_n87_), .O(new_n117_));
  ...
  oai21  g082(.a(new_n76_), .b(new_n91_), .c(x28), .O(new_n145_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n101_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n101_), .O(new_n152_));
  aoi21  g090(.a(new_n148_), .b(x27), .c(new_n152_), .O(z14));
  nand2  g091(.a(x26), .b(x12), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n114_), .c(new_n72_), .O(z15));
  ...
  nand3  g098(.a(new_n135_), .b(new_n130_), .c(new_n101_), .O(z18));
  inv1   g099(.a(z18), .O(z19));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n80_), .c(new_n133_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n128_), .c(new_n101_), .O(z20));
endmodule
