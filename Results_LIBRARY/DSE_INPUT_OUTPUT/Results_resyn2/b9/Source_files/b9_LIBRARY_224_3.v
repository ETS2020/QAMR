...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n125_, new_n127_, new_n128_, new_n132_, new_n133_;
  ...
  nand2  g16(.a(new_n65_), .b(new_n64_), .O(new_n80_));
  nand4  g17(.a(new_n80_), .b(new_n79_), .c(new_n69_), .d(x21), .O(z03));
  inv1   g18(.a(new_n69_), .O(z08));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(x21), .O(new_n83_));
  aoi21  g20(.a(new_n83_), .b(new_n79_), .c(z08), .O(z04));
  aoi21  g21(.a(x28), .b(x27), .c(x37), .O(new_n85_));
  nor2   g22(.a(new_n85_), .b(z08), .O(z05));
  nand2  g23(.a(new_n85_), .b(new_n69_), .O(new_n87_));
  ...
  nand2  g38(.a(new_n101_), .b(new_n69_), .O(z09));
  nand2  g39(.a(x37), .b(x06), .O(new_n103_));
  inv1   g40(.a(x04), .O(new_n104_));
  nand3  g41(.a(new_n73_), .b(x07), .c(new_n104_), .O(new_n105_));
  nand2  g42(.a(new_n69_), .b(x27), .O(new_n106_));
  aoi21  g43(.a(new_n105_), .b(new_n103_), .c(new_n106_), .O(z10));
  ...
  nand2  g50(.a(new_n113_), .b(new_n108_), .O(new_n114_));
  nand2  g51(.a(new_n114_), .b(new_n69_), .O(z11));
  ...
  nand4  g58(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n122_));
  nand2  g59(.a(new_n122_), .b(new_n69_), .O(z15));
  ...
  nand3  g66(.a(new_n113_), .b(new_n108_), .c(new_n69_), .O(z18));
  inv1   g67(.a(z18), .O(z19));
  aoi21  g68(.a(new_n109_), .b(x08), .c(x27), .O(new_n132_));
  oai21  g69(.a(new_n132_), .b(new_n71_), .c(new_n108_), .O(new_n133_));
  nand2  g70(.a(new_n133_), .b(new_n69_), .O(z20));
  one    g71(.O(z02));
endmodule
