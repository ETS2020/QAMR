...
module FAU ( 
  ...
  nor2   g015(.a(x04), .b(new_n63_), .O(new_n78_));
  nand4  g016(.a(new_n78_), .b(new_n77_), .c(new_n75_), .d(new_n66_), .O(new_n79_));
  ...
  nand2  g066(.a(new_n128_), .b(x00), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(x40), .c(new_n68_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nor2   g069(.a(new_n86_), .b(new_n76_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n78_), .c(x05), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x08), .O(new_n135_));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n83_), .c(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n136_), .b(x27), .O(new_n138_));
  inv1   g076(.a(x09), .O(new_n139_));
  inv1   g077(.a(x30), .O(new_n140_));
  nand3  g078(.a(new_n90_), .b(x27), .c(new_n122_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n64_), .c(new_n140_), .d(new_n139_), .O(new_n142_));
  aoi21  g080(.a(new_n138_), .b(new_n137_), .c(new_n142_), .O(z11));
  nand3  g081(.a(new_n69_), .b(new_n81_), .c(new_n89_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n122_), .c(new_n71_), .O(new_n146_));
  ...
  nand3  g094(.a(new_n156_), .b(new_n152_), .c(new_n64_), .O(new_n157_));
  nand2  g095(.a(x36), .b(x35), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x28), .O(new_n159_));
  inv1   g097(.a(x13), .O(new_n160_));
  nand3  g098(.a(x39), .b(new_n160_), .c(new_n122_), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(new_n162_));
  nor2   g100(.a(new_n148_), .b(new_n63_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n159_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n157_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x27), .O(new_n166_));
  nand3  g104(.a(new_n132_), .b(new_n78_), .c(new_n160_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  nand3  g106(.a(new_n158_), .b(new_n86_), .c(x28), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n162_), .c(new_n63_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n148_), .c(new_n155_), .O(new_n171_));
  nand2  g109(.a(new_n82_), .b(x27), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n86_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n162_), .c(new_n63_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n148_), .c(new_n149_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n171_), .O(z14));
  nand3  g114(.a(new_n118_), .b(new_n64_), .c(x12), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z15));
  nand2  g116(.a(x22), .b(x01), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(x23), .c(new_n64_), .O(z16));
  inv1   g118(.a(x24), .O(new_n181_));
  inv1   g119(.a(new_n179_), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n64_), .c(new_n181_), .d(x23), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z17));
  nand2  g122(.a(new_n138_), .b(new_n137_), .O(new_n185_));
  inv1   g123(.a(new_n142_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n185_), .O(z18));
  nand3  g125(.a(new_n64_), .b(new_n140_), .c(new_n139_), .O(new_n188_));
  nor2   g126(.a(new_n89_), .b(new_n68_), .O(new_n189_));
  nor3   g127(.a(new_n189_), .b(new_n188_), .c(new_n137_), .O(z20));
  aoi21  g128(.a(new_n138_), .b(new_n137_), .c(new_n142_), .O(z19));
endmodule
