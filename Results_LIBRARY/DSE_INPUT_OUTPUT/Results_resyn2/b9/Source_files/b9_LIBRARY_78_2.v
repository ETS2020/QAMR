...
module FAU ( 
  ...
  oai21  g014(.a(new_n75_), .b(x11), .c(new_n76_), .O(new_n77_));
  ...
  nand2  g021(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  ...
  aoi21  g052(.a(new_n114_), .b(x36), .c(new_n63_), .O(z09));
  nor2   g053(.a(new_n81_), .b(new_n73_), .O(new_n116_));
  ...
  aoi21  g060(.a(new_n74_), .b(new_n122_), .c(x04), .O(new_n123_));
  ...
  nand3  g070(.a(new_n78_), .b(x35), .c(new_n82_), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(new_n98_), .c(new_n132_), .d(new_n131_), .O(new_n134_));
  aoi21  g072(.a(new_n130_), .b(new_n129_), .c(new_n134_), .O(z11));
  nor2   g073(.a(x36), .b(x35), .O(new_n136_));
  nand2  g074(.a(new_n74_), .b(new_n69_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n136_), .c(new_n68_), .O(new_n138_));
  nand2  g076(.a(new_n70_), .b(new_n98_), .O(new_n139_));
  aoi21  g077(.a(new_n138_), .b(x27), .c(new_n139_), .O(z12));
  aoi21  g078(.a(x36), .b(x35), .c(new_n82_), .O(new_n141_));
  nor2   g079(.a(x13), .b(x04), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n74_), .O(new_n143_));
  ...
  aoi21  g085(.a(new_n142_), .b(new_n116_), .c(new_n64_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n147_), .O(z13));
  inv1   g087(.a(new_n81_), .O(new_n150_));
  nand2  g088(.a(new_n93_), .b(new_n75_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n144_), .c(x20), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n141_), .c(new_n67_), .O(new_n153_));
  oai21  g091(.a(new_n75_), .b(new_n82_), .c(new_n93_), .O(new_n154_));
  nand4  g092(.a(new_n144_), .b(new_n154_), .c(x27), .d(x20), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n143_), .c(new_n64_), .O(new_n156_));
  oai21  g094(.a(new_n153_), .b(new_n150_), .c(new_n156_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n114_), .b(new_n158_), .c(new_n98_), .O(z15));
  ...
  nand4  g102(.a(new_n164_), .b(new_n98_), .c(new_n163_), .d(x23), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z17));
  nand2  g104(.a(new_n130_), .b(new_n129_), .O(new_n167_));
  inv1   g105(.a(new_n134_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n167_), .O(z18));
  nand2  g107(.a(x35), .b(x27), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n98_), .c(new_n132_), .d(new_n131_), .O(new_n171_));
