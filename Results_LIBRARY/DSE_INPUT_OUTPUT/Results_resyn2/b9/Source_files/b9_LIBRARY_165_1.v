...
module FAU ( 
  ...
  nand3  g078(.a(new_n140_), .b(new_n135_), .c(new_n103_), .O(new_n141_));
  ...
  nor4   g098(.a(new_n64_), .b(x23), .c(new_n160_), .d(new_n159_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  nor2   g100(.a(new_n160_), .b(new_n159_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n103_), .c(new_n162_), .d(x23), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z17));
  aoi21  g103(.a(new_n140_), .b(new_n135_), .c(new_n64_), .O(z18));
  nor2   g104(.a(new_n139_), .b(new_n64_), .O(new_n167_));
  oai21  g105(.a(new_n72_), .b(new_n66_), .c(new_n167_), .O(new_n168_));
