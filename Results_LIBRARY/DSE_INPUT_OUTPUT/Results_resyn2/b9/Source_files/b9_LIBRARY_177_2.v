...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n141_, new_n144_, new_n146_, new_n148_, new_n149_, new_n150_,
    new_n152_;
  inv1   g00(.a(x14), .O(new_n63_));
  nor2   g01(.a(x33), .b(new_n63_), .O(new_n64_));
  ...
  nand2  g41(.a(new_n103_), .b(new_n96_), .O(z07));
  nand2  g42(.a(new_n87_), .b(new_n96_), .O(z08));
  inv1   g43(.a(x11), .O(new_n106_));
  nand3  g44(.a(x34), .b(x27), .c(x26), .O(new_n107_));
  nor3   g45(.a(new_n107_), .b(new_n64_), .c(new_n106_), .O(z09));
  nand2  g46(.a(new_n82_), .b(new_n72_), .O(new_n109_));
  nand2  g47(.a(new_n80_), .b(new_n70_), .O(new_n110_));
  inv1   g48(.a(x07), .O(new_n111_));
  nand2  g49(.a(new_n87_), .b(new_n111_), .O(new_n112_));
  ...
  nand4  g62(.a(x35), .b(new_n79_), .c(x27), .d(new_n68_), .O(new_n125_));
  nor2   g63(.a(x30), .b(x09), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(new_n96_), .O(new_n127_));
  inv1   g65(.a(new_n127_), .O(new_n128_));
  nand3  g66(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(z18));
  inv1   g67(.a(z18), .O(z11));
  oai21  g68(.a(new_n76_), .b(new_n74_), .c(new_n96_), .O(z12));
  nor2   g69(.a(x13), .b(x04), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n82_), .c(new_n72_), .O(new_n133_));
  ...
  nand3  g76(.a(new_n138_), .b(new_n132_), .c(new_n72_), .O(new_n139_));
  aoi21  g77(.a(new_n139_), .b(new_n137_), .c(new_n66_), .O(new_n140_));
  nor2   g78(.a(new_n140_), .b(new_n134_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n96_), .O(z13));
  oai21  g80(.a(new_n140_), .b(new_n134_), .c(new_n96_), .O(z14));
  inv1   g81(.a(x12), .O(new_n144_));
  oai21  g82(.a(new_n107_), .b(new_n144_), .c(new_n96_), .O(z15));
  nand2  g83(.a(x22), .b(x01), .O(new_n146_));
  oai21  g84(.a(new_n146_), .b(x23), .c(new_n96_), .O(z16));
  inv1   g85(.a(x24), .O(new_n148_));
  inv1   g86(.a(new_n146_), .O(new_n149_));
  nand4  g87(.a(new_n149_), .b(new_n96_), .c(new_n148_), .d(x23), .O(new_n150_));
  inv1   g88(.a(new_n150_), .O(z17));
  nor2   g89(.a(new_n69_), .b(new_n66_), .O(new_n152_));
  nor3   g90(.a(new_n152_), .b(new_n127_), .c(new_n122_), .O(z20));
