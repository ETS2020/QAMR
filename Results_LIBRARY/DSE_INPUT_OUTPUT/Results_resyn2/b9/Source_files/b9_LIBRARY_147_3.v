...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n71_,
    ...
    new_n125_, new_n127_, new_n130_, new_n132_, new_n133_;
  ...
  aoi21  g16(.a(new_n64_), .b(new_n79_), .c(z08), .O(new_n80_));
  nand2  g17(.a(new_n65_), .b(x27), .O(new_n81_));
  ...
  nand2  g35(.a(new_n98_), .b(new_n68_), .O(z07));
  nand4  g36(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n100_));
  nand2  g37(.a(new_n100_), .b(new_n68_), .O(z09));
  nand2  g38(.a(new_n68_), .b(x27), .O(new_n102_));
  nand2  g39(.a(x37), .b(x06), .O(new_n103_));
  inv1   g40(.a(x04), .O(new_n104_));
  nand3  g41(.a(new_n73_), .b(x07), .c(new_n104_), .O(new_n105_));
  aoi21  g42(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(z10));
  nor2   g43(.a(x30), .b(x09), .O(new_n107_));
  nand2  g44(.a(new_n107_), .b(new_n68_), .O(new_n108_));
  ...
  nand3  g52(.a(new_n68_), .b(new_n66_), .c(x27), .O(z12));
  nor2   g53(.a(x19), .b(x18), .O(new_n117_));
  nand3  g54(.a(new_n117_), .b(x27), .c(x20), .O(new_n118_));
  aoi21  g55(.a(new_n65_), .b(new_n64_), .c(new_n118_), .O(new_n119_));
  nand2  g56(.a(new_n119_), .b(new_n68_), .O(new_n120_));
  inv1   g57(.a(new_n120_), .O(z13));
  nor2   g58(.a(new_n119_), .b(z08), .O(z14));
  nand3  g59(.a(x34), .b(x26), .c(x12), .O(new_n123_));
  nor2   g60(.a(new_n123_), .b(new_n102_), .O(z15));
  nand2  g61(.a(x22), .b(x01), .O(new_n125_));
  oai21  g62(.a(new_n125_), .b(x23), .c(new_n68_), .O(z16));
  inv1   g63(.a(x23), .O(new_n127_));
  nor4   g64(.a(new_n125_), .b(z08), .c(x24), .d(new_n127_), .O(z17));
  aoi21  g65(.a(new_n114_), .b(new_n107_), .c(z08), .O(z18));
  nand2  g66(.a(new_n114_), .b(new_n107_), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(new_n68_), .O(z19));
  inv1   g68(.a(x08), .O(new_n132_));
  oai21  g69(.a(x28), .b(new_n132_), .c(new_n79_), .O(new_n133_));
  aoi21  g70(.a(new_n133_), .b(x35), .c(new_n108_), .O(z20));
  one    g71(.O(z02));
endmodule
