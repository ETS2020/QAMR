// Benchmark "FAU" written by ABC on Sat Aug  8 23:38:20 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n160_, new_n162_, new_n164_, new_n165_, new_n169_, new_n170_;
  ...
  nor2   g009(.a(x40), .b(x11), .O(new_n72_));
  ...
  nand4  g034(.a(new_n96_), .b(new_n93_), .c(new_n91_), .d(x21), .O(z03));
  ...
  nand2  g038(.a(new_n100_), .b(new_n91_), .O(z05));
  inv1   g039(.a(new_n100_), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n91_), .O(z06));
  ...
  nand3  g050(.a(new_n112_), .b(new_n91_), .c(x03), .O(new_n113_));
  nor2   g051(.a(new_n113_), .b(new_n108_), .O(z07));
  inv1   g052(.a(new_n87_), .O(z08));
  nand4  g053(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z09));
  inv1   g055(.a(new_n79_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(z08), .O(new_n119_));
  ...
  nand2  g081(.a(new_n91_), .b(new_n143_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nor2   g083(.a(new_n87_), .b(x04), .O(new_n146_));
  oai21  g084(.a(new_n76_), .b(new_n75_), .c(x28), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(new_n148_));
  nand2  g086(.a(new_n92_), .b(new_n95_), .O(new_n149_));
  nor2   g087(.a(x19), .b(x18), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n91_), .c(new_n149_), .d(x20), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n118_), .b(new_n146_), .c(new_n145_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand3  g093(.a(new_n150_), .b(new_n149_), .c(x20), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n148_), .O(new_n157_));
  nand2  g095(.a(new_n154_), .b(new_n91_), .O(new_n158_));
  aoi21  g096(.a(new_n157_), .b(x27), .c(new_n158_), .O(z14));
  nand4  g097(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n91_), .O(z15));
  ...
  nand3  g104(.a(new_n139_), .b(new_n133_), .c(new_n91_), .O(z18));
  inv1   g105(.a(z18), .O(z19));
  nor2   g106(.a(new_n138_), .b(new_n72_), .O(new_n169_));
  oai21  g107(.a(new_n75_), .b(new_n94_), .c(new_n169_), .O(new_n170_));
