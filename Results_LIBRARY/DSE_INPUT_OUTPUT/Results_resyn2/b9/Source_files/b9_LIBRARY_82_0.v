...
module FAU ( 
  ...
  nor2   g009(.a(x38), .b(x14), .O(new_n72_));
  ...
  nand2  g045(.a(new_n98_), .b(new_n107_), .O(new_n108_));
  ...
  nand3  g050(.a(new_n112_), .b(new_n108_), .c(new_n106_), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z07));
  nand2  g052(.a(new_n98_), .b(new_n87_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand4  g054(.a(new_n98_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(z09));
  inv1   g056(.a(new_n87_), .O(new_n119_));
  nand2  g057(.a(new_n82_), .b(new_n119_), .O(new_n120_));
  inv1   g058(.a(x35), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(x28), .c(new_n76_), .O(new_n122_));
  ...
  aoi21  g065(.a(new_n119_), .b(new_n127_), .c(x04), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g067(.a(x37), .b(x27), .c(x06), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n98_), .O(z10));
  ...
  nand4  g075(.a(x35), .b(new_n77_), .c(x27), .d(new_n65_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n98_), .b(new_n68_), .c(new_n142_), .O(new_n143_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n119_), .O(new_n148_));
  nand2  g086(.a(new_n91_), .b(new_n93_), .O(new_n149_));
  ...
  nand3  g091(.a(new_n147_), .b(new_n82_), .c(new_n119_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n153_), .c(new_n72_), .O(z13));
  nand2  g093(.a(new_n147_), .b(new_n119_), .O(new_n156_));
  ...
  aoi21  g098(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n161_));
  oai22  g099(.a(new_n161_), .b(new_n156_), .c(new_n63_), .d(new_n75_), .O(new_n162_));
  ...
  aoi21  g109(.a(new_n139_), .b(new_n136_), .c(new_n72_), .O(z18));
  oai21  g110(.a(new_n121_), .b(new_n75_), .c(new_n137_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n134_), .c(new_n98_), .O(z20));
