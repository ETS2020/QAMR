...
module FAU ( 
  ...
  aoi21  g035(.a(new_n95_), .b(new_n76_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n73_), .O(z04));
  aoi21  g037(.a(x28), .b(x27), .c(x37), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n73_), .O(z05));
  and2   g039(.a(new_n100_), .b(new_n92_), .O(z06));
  ...
  nand2  g050(.a(new_n112_), .b(new_n92_), .O(z07));
  nand2  g051(.a(new_n92_), .b(new_n86_), .O(z08));
  nand4  g052(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n92_), .O(z09));
  nor2   g054(.a(x30), .b(x28), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(x35), .c(x36), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n86_), .b(new_n119_), .O(new_n120_));
  inv1   g058(.a(x05), .O(new_n121_));
  nand3  g059(.a(x40), .b(x39), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n120_), .c(new_n65_), .O(new_n123_));
  nand3  g061(.a(new_n92_), .b(x37), .c(x06), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(new_n118_), .c(new_n124_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  nand4  g064(.a(new_n87_), .b(new_n82_), .c(x05), .d(new_n65_), .O(new_n127_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(z18));
  nand2  g074(.a(z18), .b(new_n92_), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n76_), .c(new_n138_), .O(new_n140_));
  or2    g078(.a(new_n63_), .b(new_n76_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n66_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n140_), .c(new_n92_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand4  g082(.a(x40), .b(x39), .c(new_n144_), .d(new_n65_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  nand3  g084(.a(x36), .b(x35), .c(x28), .O(new_n147_));
  oai21  g085(.a(x30), .b(x28), .c(new_n147_), .O(new_n148_));
  ...
  aoi21  g090(.a(new_n77_), .b(x30), .c(new_n63_), .O(new_n153_));
  aoi22  g091(.a(new_n153_), .b(new_n152_), .c(new_n148_), .d(new_n146_), .O(new_n154_));
  nand4  g092(.a(new_n87_), .b(new_n82_), .c(new_n144_), .d(new_n65_), .O(new_n155_));
  oai21  g093(.a(new_n154_), .b(new_n76_), .c(new_n155_), .O(z13));
  nand2  g094(.a(x36), .b(x35), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n81_), .c(x28), .O(new_n158_));
  oai21  g096(.a(new_n146_), .b(new_n73_), .c(new_n158_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n151_), .O(new_n160_));
  oai21  g098(.a(x28), .b(new_n76_), .c(new_n81_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n146_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n141_), .c(new_n92_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z14));
  nand4  g102(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n92_), .O(z15));
  inv1   g104(.a(x01), .O(new_n167_));
  inv1   g105(.a(x22), .O(new_n168_));
  nor4   g106(.a(new_n73_), .b(x23), .c(new_n168_), .d(new_n167_), .O(z16));
  inv1   g107(.a(x24), .O(new_n170_));
  nor2   g108(.a(new_n168_), .b(new_n167_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n92_), .c(new_n170_), .d(x23), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  inv1   g111(.a(z18), .O(z19));
  nand2  g112(.a(x35), .b(x27), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n135_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n131_), .c(new_n92_), .O(z20));
endmodule
