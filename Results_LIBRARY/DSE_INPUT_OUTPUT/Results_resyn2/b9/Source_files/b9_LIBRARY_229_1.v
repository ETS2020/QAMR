...
module FAU ( 
  ...
  aoi21  g50(.a(new_n112_), .b(x22), .c(new_n63_), .O(z09));
  ...
  nand3  g84(.a(x27), .b(x26), .c(x12), .O(new_n147_));
  aoi21  g85(.a(new_n147_), .b(x22), .c(new_n63_), .O(z15));
  ...
  oai21  g90(.a(new_n152_), .b(new_n149_), .c(new_n84_), .O(z17));
  inv1   g91(.a(z11), .O(z18));
  oai21  g92(.a(new_n69_), .b(new_n66_), .c(new_n129_), .O(new_n155_));
  oai21  g93(.a(new_n155_), .b(new_n126_), .c(new_n84_), .O(z20));
  aoi21  g94(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z19));
endmodule
