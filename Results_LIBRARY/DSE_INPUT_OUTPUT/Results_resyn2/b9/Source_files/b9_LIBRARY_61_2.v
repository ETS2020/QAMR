...
module FAU ( 
  ...
  inv1   g023(.a(x22), .O(new_n86_));
  nand2  g024(.a(new_n71_), .b(new_n86_), .O(new_n87_));
  inv1   g025(.a(x35), .O(new_n88_));
  nor2   g026(.a(new_n88_), .b(x28), .O(new_n89_));
  inv1   g027(.a(x08), .O(new_n90_));
  nand2  g028(.a(new_n75_), .b(new_n90_), .O(new_n91_));
  ...
  oai21  g033(.a(new_n95_), .b(new_n71_), .c(new_n87_), .O(z02));
  inv1   g034(.a(x37), .O(new_n97_));
  nand2  g035(.a(x28), .b(x27), .O(new_n98_));
  oai22  g036(.a(new_n98_), .b(new_n88_), .c(new_n97_), .d(x27), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(x21), .c(new_n83_), .O(z03));
  inv1   g038(.a(x21), .O(new_n101_));
  nand3  g039(.a(new_n99_), .b(new_n72_), .c(new_n101_), .O(z04));
  nand3  g040(.a(new_n98_), .b(new_n72_), .c(new_n97_), .O(z05));
  ...
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n72_), .O(z10));
  nand3  g070(.a(x40), .b(x39), .c(x29), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n78_), .c(new_n90_), .O(new_n134_));
  ...
  aoi21  g077(.a(new_n137_), .b(new_n89_), .c(new_n139_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n136_), .c(new_n72_), .O(z18));
  inv1   g079(.a(z18), .O(z11));
  nand2  g080(.a(new_n63_), .b(new_n97_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  nand2  g082(.a(x35), .b(x28), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n97_), .O(new_n146_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n71_), .c(new_n86_), .O(new_n150_));
  ...
  nand2  g095(.a(new_n72_), .b(new_n146_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n155_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x27), .O(new_n160_));
  nand3  g098(.a(new_n154_), .b(new_n121_), .c(new_n82_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand2  g100(.a(new_n154_), .b(new_n121_), .O(new_n163_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n163_), .c(new_n149_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n166_), .c(new_n72_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  oai21  g108(.a(new_n118_), .b(new_n170_), .c(new_n72_), .O(z15));
  inv1   g109(.a(x23), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x01), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(x40), .c(new_n86_), .O(z16));
  nand2  g112(.a(x22), .b(x01), .O(new_n175_));
  nor4   g113(.a(new_n175_), .b(new_n71_), .c(x24), .d(new_n172_), .O(z17));
  ...
  oai21  g118(.a(new_n180_), .b(new_n134_), .c(new_n72_), .O(z20));
endmodule
