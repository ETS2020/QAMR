...
module FAU ( 
  ...
  nand2  g42(.a(x25), .b(new_n63_), .O(new_n105_));
  ...
  nand2  g49(.a(new_n111_), .b(new_n88_), .O(z07));
  nand2  g50(.a(x40), .b(x39), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(new_n88_), .O(z08));
  inv1   g52(.a(x11), .O(new_n115_));
  nand3  g53(.a(x34), .b(x27), .c(x26), .O(new_n116_));
  nor3   g54(.a(new_n116_), .b(new_n64_), .c(new_n115_), .O(z09));
  nand2  g55(.a(new_n85_), .b(new_n75_), .O(new_n118_));
  nand2  g56(.a(new_n83_), .b(new_n73_), .O(new_n119_));
  inv1   g57(.a(x07), .O(new_n120_));
  nand2  g58(.a(new_n113_), .b(new_n120_), .O(new_n121_));
  nand3  g59(.a(new_n121_), .b(new_n119_), .c(x27), .O(new_n122_));
  nand2  g60(.a(new_n122_), .b(new_n118_), .O(new_n123_));
  inv1   g61(.a(x05), .O(new_n124_));
  aoi21  g62(.a(new_n75_), .b(new_n124_), .c(x04), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g64(.a(x37), .b(x27), .c(x06), .O(new_n127_));
  aoi21  g65(.a(new_n127_), .b(new_n126_), .c(new_n64_), .O(z10));
  inv1   g66(.a(x08), .O(new_n129_));
  nand2  g67(.a(new_n75_), .b(x29), .O(new_n130_));
  aoi21  g68(.a(new_n130_), .b(new_n83_), .c(new_n129_), .O(new_n131_));
  nand2  g69(.a(new_n130_), .b(x27), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g71(.a(x35), .b(new_n82_), .c(x27), .d(new_n71_), .O(new_n134_));
  nor2   g72(.a(x30), .b(x09), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n88_), .O(new_n136_));
  inv1   g74(.a(new_n136_), .O(new_n137_));
  nand3  g75(.a(new_n137_), .b(new_n134_), .c(new_n133_), .O(z18));
  inv1   g76(.a(z18), .O(z11));
  oai21  g77(.a(new_n79_), .b(new_n77_), .c(new_n88_), .O(z12));
  nor2   g78(.a(x13), .b(x04), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n85_), .c(new_n75_), .O(new_n142_));
  nor2   g80(.a(x19), .b(x18), .O(new_n143_));
  nand3  g81(.a(new_n143_), .b(new_n69_), .c(x20), .O(new_n144_));
  oai21  g82(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n145_));
  nand3  g83(.a(new_n145_), .b(new_n141_), .c(new_n75_), .O(new_n146_));
  aoi21  g84(.a(new_n146_), .b(new_n144_), .c(new_n66_), .O(new_n147_));
  inv1   g85(.a(new_n147_), .O(new_n148_));
  aoi21  g86(.a(new_n148_), .b(new_n142_), .c(new_n64_), .O(z13));
  inv1   g87(.a(new_n142_), .O(new_n150_));
  nor3   g88(.a(new_n147_), .b(new_n150_), .c(new_n64_), .O(z14));
  inv1   g89(.a(x12), .O(new_n152_));
  oai21  g90(.a(new_n116_), .b(new_n152_), .c(new_n88_), .O(z15));
  ...
  oai21  g95(.a(new_n157_), .b(new_n154_), .c(new_n88_), .O(z17));
  nor2   g96(.a(new_n72_), .b(new_n66_), .O(new_n159_));
  nor3   g97(.a(new_n159_), .b(new_n136_), .c(new_n131_), .O(z20));
