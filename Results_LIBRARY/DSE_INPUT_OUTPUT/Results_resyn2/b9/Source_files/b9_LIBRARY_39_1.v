...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n156_, new_n158_, new_n159_, new_n163_, new_n164_;
  ...
  inv1   g009(.a(x23), .O(new_n72_));
  nor2   g010(.a(new_n72_), .b(x22), .O(new_n73_));
  ...
  aoi21  g028(.a(new_n90_), .b(new_n87_), .c(new_n73_), .O(z02));
  ...
  nand3  g037(.a(new_n94_), .b(new_n98_), .c(new_n93_), .O(z05));
  ...
  nand2  g049(.a(new_n111_), .b(new_n98_), .O(z07));
  nand2  g050(.a(new_n98_), .b(new_n88_), .O(z08));
  and2   g051(.a(x34), .b(x27), .O(new_n114_));
  nand3  g052(.a(new_n114_), .b(x26), .c(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n98_), .O(z09));
  aoi21  g054(.a(new_n82_), .b(new_n81_), .c(new_n88_), .O(new_n117_));
  ...
  oai21  g058(.a(new_n88_), .b(x05), .c(new_n65_), .O(new_n121_));
  ...
  nand2  g077(.a(new_n98_), .b(new_n139_), .O(z12));
  ...
  oai21  g082(.a(new_n77_), .b(new_n92_), .c(x28), .O(new_n145_));
  ...
  nand2  g087(.a(new_n146_), .b(new_n117_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n98_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n98_), .O(new_n152_));
  aoi21  g090(.a(new_n148_), .b(x27), .c(new_n152_), .O(z14));
  nand4  g091(.a(new_n114_), .b(new_n98_), .c(x26), .d(x12), .O(new_n154_));
  ...
  aoi21  g097(.a(new_n159_), .b(x22), .c(new_n72_), .O(z17));
  nand3  g098(.a(new_n135_), .b(new_n130_), .c(new_n98_), .O(z18));
  inv1   g099(.a(z18), .O(z19));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n81_), .c(new_n133_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n128_), .c(new_n98_), .O(z20));
endmodule
