...
module FAU ( 
  ...
  oai21  g045(.a(x33), .b(x31), .c(x14), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n107_), .c(x03), .O(new_n109_));
  nand2  g047(.a(new_n109_), .b(new_n99_), .O(z07));
  nand2  g048(.a(new_n99_), .b(new_n87_), .O(z08));
  inv1   g049(.a(x11), .O(new_n112_));
  nand3  g050(.a(x34), .b(x27), .c(x26), .O(new_n113_));
  nor3   g051(.a(new_n113_), .b(new_n73_), .c(new_n112_), .O(z09));
  inv1   g052(.a(new_n87_), .O(new_n115_));
  inv1   g053(.a(new_n80_), .O(new_n116_));
  ...
  nor2   g071(.a(new_n76_), .b(new_n93_), .O(new_n134_));
  ...
  nand2  g078(.a(new_n99_), .b(new_n140_), .O(z12));
  ...
  nand2  g083(.a(new_n91_), .b(new_n94_), .O(new_n146_));
  ...
  nand3  g088(.a(new_n144_), .b(new_n116_), .c(new_n115_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n150_), .c(new_n73_), .O(z13));
  inv1   g090(.a(new_n151_), .O(new_n153_));
  nand3  g091(.a(new_n144_), .b(new_n115_), .c(new_n83_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n63_), .c(new_n93_), .O(new_n155_));
  nand2  g093(.a(new_n147_), .b(x20), .O(new_n156_));
  nand3  g094(.a(new_n142_), .b(new_n80_), .c(x28), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n144_), .c(new_n115_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n156_), .c(new_n73_), .O(new_n159_));
  oai21  g097(.a(new_n155_), .b(new_n153_), .c(new_n159_), .O(z14));
  inv1   g098(.a(x12), .O(new_n161_));
  oai21  g099(.a(new_n113_), .b(new_n161_), .c(new_n99_), .O(z15));
  ...
  aoi21  g106(.a(new_n136_), .b(new_n131_), .c(new_n73_), .O(z18));
  nand2  g107(.a(new_n132_), .b(new_n99_), .O(new_n170_));
  nor3   g108(.a(new_n170_), .b(new_n134_), .c(new_n129_), .O(z20));
  nand2  g109(.a(new_n137_), .b(new_n99_), .O(z19));
endmodule
