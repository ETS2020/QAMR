...
module FAU ( 
  ...
  aoi21  g025(.a(new_n87_), .b(new_n84_), .c(new_n73_), .O(z02));
  inv1   g026(.a(new_n73_), .O(new_n89_));
  ...
  aoi21  g032(.a(new_n92_), .b(new_n76_), .c(x21), .O(new_n95_));
  ...
  nand2  g048(.a(new_n89_), .b(new_n85_), .O(z08));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(new_n89_), .O(z09));
  oai21  g051(.a(new_n79_), .b(new_n76_), .c(new_n85_), .O(new_n114_));
  ...
  aoi21  g060(.a(new_n122_), .b(new_n121_), .c(new_n73_), .O(z10));
  ...
  nand4  g066(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n129_));
  nor2   g067(.a(x30), .b(x09), .O(new_n130_));
  and2   g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n128_), .c(new_n89_), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(z11));
  nand2  g071(.a(new_n67_), .b(x27), .O(new_n134_));
  nand3  g072(.a(new_n89_), .b(new_n68_), .c(new_n134_), .O(new_n135_));
  ...
  nor2   g078(.a(new_n85_), .b(x04), .O(new_n141_));
  ...
  nor2   g084(.a(new_n77_), .b(x13), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n141_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n89_), .O(z13));
  nand2  g087(.a(new_n148_), .b(new_n89_), .O(new_n150_));
  aoi21  g088(.a(new_n145_), .b(x27), .c(new_n150_), .O(z14));
  nand4  g089(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n89_), .O(z15));
  nand3  g091(.a(new_n72_), .b(x22), .c(x01), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n89_), .O(z16));
  inv1   g093(.a(x24), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(x22), .c(x01), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x36), .c(new_n72_), .O(z17));
  aoi21  g096(.a(new_n131_), .b(new_n128_), .c(new_n73_), .O(z18));
  nand2  g097(.a(x35), .b(x27), .O(new_n160_));
  nand3  g098(.a(new_n130_), .b(new_n160_), .c(new_n89_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(new_n126_), .O(z20));
