...
module FAU ( 
  ...
  nor2   g011(.a(x22), .b(x01), .O(new_n74_));
  ...
  aoi21  g028(.a(new_n90_), .b(new_n88_), .c(new_n74_), .O(z02));
  ...
  aoi21  g036(.a(new_n94_), .b(new_n93_), .c(new_n74_), .O(z05));
  nand2  g037(.a(new_n94_), .b(new_n93_), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n74_), .O(z06));
  ...
  inv1   g044(.a(new_n74_), .O(new_n107_));
  ...
  nand2  g051(.a(new_n107_), .b(new_n68_), .O(z08));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n107_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  ...
  oai21  g077(.a(new_n71_), .b(new_n139_), .c(new_n107_), .O(z12));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n84_), .c(new_n74_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  nand3  g088(.a(new_n143_), .b(new_n83_), .c(new_n82_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n145_), .O(new_n153_));
  aoi21  g091(.a(new_n79_), .b(x27), .c(new_n84_), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(new_n142_), .c(new_n63_), .d(new_n77_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(new_n107_), .O(z14));
  ...
  oai21  g102(.a(new_n92_), .b(new_n77_), .c(new_n134_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n131_), .c(new_n107_), .O(z20));
  aoi21  g104(.a(new_n132_), .b(new_n131_), .c(new_n137_), .O(z19));
endmodule
