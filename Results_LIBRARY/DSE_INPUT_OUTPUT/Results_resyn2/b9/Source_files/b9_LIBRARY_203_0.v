...
module FAU ( 
  ...
  nor2   g012(.a(x20), .b(x03), .O(new_n75_));
  ...
  aoi21  g022(.a(new_n84_), .b(x04), .c(new_n75_), .O(z01));
  nor2   g023(.a(x27), .b(x08), .O(new_n86_));
  oai21  g024(.a(new_n86_), .b(new_n80_), .c(x04), .O(new_n87_));
  nor2   g025(.a(new_n75_), .b(new_n70_), .O(z08));
  ...
  aoi21  g031(.a(new_n93_), .b(x27), .c(new_n75_), .O(new_n94_));
  ...
  nor2   g039(.a(new_n101_), .b(new_n75_), .O(z05));
  inv1   g040(.a(new_n101_), .O(new_n103_));
  nor2   g041(.a(new_n103_), .b(new_n75_), .O(z06));
  ...
  or2    g060(.a(new_n119_), .b(new_n83_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n66_), .O(new_n125_));
  ...
  nand2  g075(.a(new_n137_), .b(new_n76_), .O(z11));
  ...
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n71_), .O(new_n143_));
  inv1   g081(.a(x18), .O(new_n144_));
  inv1   g082(.a(x19), .O(new_n145_));
  nand2  g083(.a(new_n93_), .b(new_n96_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n143_), .c(new_n95_), .O(new_n148_));
  nand2  g086(.a(new_n142_), .b(new_n71_), .O(new_n149_));
  nor2   g087(.a(new_n149_), .b(new_n83_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(x20), .O(new_n151_));
  inv1   g089(.a(new_n149_), .O(new_n152_));
  nand2  g090(.a(new_n141_), .b(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n83_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n152_), .c(x03), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n151_), .O(z13));
  nand3  g094(.a(new_n142_), .b(new_n71_), .c(new_n79_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n64_), .c(new_n95_), .O(new_n158_));
  nand3  g096(.a(x20), .b(new_n145_), .c(new_n144_), .O(new_n159_));
  nand3  g097(.a(new_n140_), .b(new_n83_), .c(x28), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n142_), .c(new_n71_), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n159_), .c(new_n75_), .O(new_n162_));
  oai21  g100(.a(new_n158_), .b(new_n150_), .c(new_n162_), .O(z14));
  inv1   g101(.a(x12), .O(new_n164_));
  nor2   g102(.a(new_n117_), .b(new_n164_), .O(z15));
  nand2  g103(.a(x22), .b(x01), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(x23), .c(new_n76_), .O(z16));
  inv1   g105(.a(x24), .O(new_n168_));
  inv1   g106(.a(new_n166_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n76_), .c(new_n168_), .d(x23), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(z17));
  nand3  g109(.a(new_n136_), .b(new_n132_), .c(new_n76_), .O(z18));
  nor4   g110(.a(new_n135_), .b(new_n133_), .c(new_n130_), .d(new_n75_), .O(z20));
  nand2  g111(.a(new_n137_), .b(new_n76_), .O(z19));
endmodule
