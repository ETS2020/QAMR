...
module FAU ( 
  ...
  aoi21  g035(.a(new_n97_), .b(new_n69_), .c(new_n66_), .O(new_n98_));
  ...
  nand2  g053(.a(new_n77_), .b(new_n65_), .O(z08));
  nand3  g054(.a(x34), .b(x27), .c(x26), .O(new_n117_));
  nand2  g055(.a(new_n65_), .b(x11), .O(new_n118_));
  ...
  and2   g064(.a(new_n126_), .b(new_n65_), .O(new_n127_));
  ...
  nand3  g076(.a(new_n138_), .b(new_n133_), .c(new_n65_), .O(z18));
  inv1   g077(.a(z18), .O(z11));
  nand2  g078(.a(new_n78_), .b(new_n75_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n70_), .c(new_n69_), .O(new_n142_));
  nand2  g080(.a(new_n78_), .b(x10), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n142_), .c(new_n65_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n78_), .c(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n95_), .b(new_n97_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n150_), .c(new_n65_), .d(x20), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand3  g092(.a(new_n86_), .b(new_n78_), .c(new_n146_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand2  g094(.a(new_n78_), .b(new_n146_), .O(new_n157_));
  nand2  g095(.a(new_n151_), .b(x20), .O(new_n158_));
  nand3  g096(.a(new_n147_), .b(new_n120_), .c(x28), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n158_), .O(new_n161_));
  aoi21  g099(.a(new_n81_), .b(x27), .c(new_n86_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n157_), .c(new_n70_), .d(new_n69_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(new_n65_), .O(z14));
  inv1   g102(.a(new_n117_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x12), .O(new_n166_));
  ...
  nand4  g109(.a(new_n171_), .b(new_n65_), .c(x22), .d(x01), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  nand2  g111(.a(new_n138_), .b(new_n133_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n65_), .O(z19));
  nand2  g113(.a(x35), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n84_), .c(new_n135_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n131_), .c(new_n65_), .O(z20));
endmodule
