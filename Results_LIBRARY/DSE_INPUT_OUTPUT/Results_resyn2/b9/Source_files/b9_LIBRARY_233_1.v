...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n154_, new_n156_, new_n158_, new_n159_, new_n162_;
  ...
  nor2   g010(.a(new_n72_), .b(x01), .O(new_n73_));
  ...
  inv1   g031(.a(new_n73_), .O(new_n94_));
  inv1   g032(.a(x35), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n78_), .c(x27), .O(new_n96_));
  inv1   g034(.a(x37), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n76_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n94_), .d(x21), .O(z03));
  aoi21  g037(.a(new_n97_), .b(new_n76_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n73_), .O(z04));
  oai21  g039(.a(new_n78_), .b(new_n76_), .c(new_n97_), .O(new_n102_));
  ...
  nand3  g051(.a(new_n113_), .b(new_n94_), .c(x03), .O(new_n114_));
  nor2   g052(.a(new_n114_), .b(new_n109_), .O(z07));
  nand3  g053(.a(x34), .b(x27), .c(x26), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(new_n117_));
  nand3  g055(.a(new_n117_), .b(new_n94_), .c(x11), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z09));
  aoi21  g057(.a(new_n82_), .b(new_n81_), .c(new_n88_), .O(new_n120_));
  ...
  oai21  g061(.a(new_n88_), .b(x05), .c(new_n65_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(new_n73_), .O(new_n127_));
  oai21  g065(.a(new_n124_), .b(new_n123_), .c(new_n127_), .O(z10));
  inv1   g066(.a(x08), .O(new_n129_));
  nand3  g067(.a(x40), .b(x39), .c(x29), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n79_), .c(new_n129_), .O(new_n131_));
  nand2  g069(.a(new_n130_), .b(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g071(.a(x35), .b(new_n78_), .c(x27), .d(new_n65_), .O(new_n134_));
  nor2   g072(.a(x30), .b(x09), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n94_), .O(z11));
  nand2  g075(.a(new_n67_), .b(x27), .O(new_n138_));
  nand2  g076(.a(new_n68_), .b(new_n138_), .O(new_n139_));
  nand2  g077(.a(new_n94_), .b(new_n139_), .O(z12));
  inv1   g078(.a(new_n63_), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(x20), .O(new_n143_));
  inv1   g081(.a(new_n88_), .O(new_n144_));
  oai21  g082(.a(new_n77_), .b(new_n95_), .c(x28), .O(new_n145_));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nand2  g087(.a(new_n146_), .b(new_n120_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n94_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n94_), .O(new_n152_));
  aoi21  g090(.a(new_n148_), .b(x27), .c(new_n152_), .O(z14));
  nand3  g091(.a(new_n117_), .b(new_n94_), .c(x12), .O(new_n154_));
  ...
  nand4  g098(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n94_), .O(z18));
  oai21  g099(.a(new_n95_), .b(new_n76_), .c(new_n135_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n131_), .c(new_n94_), .O(z20));
  nand2  g101(.a(new_n136_), .b(new_n94_), .O(z19));
endmodule
