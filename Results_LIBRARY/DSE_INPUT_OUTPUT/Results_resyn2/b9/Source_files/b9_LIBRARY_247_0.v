...
module FAU ( 
  ...
  nor2   g008(.a(x40), .b(x06), .O(new_n71_));
  ...
  nand2  g019(.a(new_n81_), .b(x06), .O(new_n82_));
  ...
  aoi21  g029(.a(new_n91_), .b(new_n75_), .c(new_n71_), .O(new_n92_));
  ...
  nor2   g034(.a(new_n96_), .b(new_n71_), .O(z05));
  inv1   g035(.a(new_n96_), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n71_), .O(z06));
  ...
  nand4  g050(.a(new_n74_), .b(x34), .c(x27), .d(x26), .O(new_n113_));
  nor2   g051(.a(new_n113_), .b(new_n112_), .O(z09));
  nor2   g052(.a(new_n77_), .b(new_n75_), .O(new_n115_));
  nand2  g053(.a(z08), .b(x05), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(new_n117_));
  oai21  g055(.a(x40), .b(x06), .c(x07), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(z08), .O(new_n119_));
  aoi22  g057(.a(new_n119_), .b(new_n115_), .c(new_n117_), .d(new_n79_), .O(new_n120_));
  nand3  g058(.a(x37), .b(x27), .c(x06), .O(new_n121_));
  oai21  g059(.a(new_n120_), .b(x04), .c(new_n121_), .O(z10));
  inv1   g060(.a(x08), .O(new_n123_));
  nand2  g061(.a(x35), .b(new_n76_), .O(new_n124_));
  ...
  nand3  g067(.a(new_n84_), .b(x27), .c(new_n63_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n74_), .O(z11));
  nand2  g070(.a(new_n66_), .b(new_n91_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(x27), .c(x10), .O(new_n134_));
  nor2   g072(.a(new_n67_), .b(new_n75_), .O(new_n135_));
  aoi21  g073(.a(x39), .b(new_n63_), .c(new_n135_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(x40), .O(new_n137_));
  inv1   g075(.a(new_n135_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n81_), .c(x06), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  nand3  g079(.a(z08), .b(new_n141_), .c(new_n63_), .O(new_n142_));
  aoi21  g080(.a(x36), .b(x35), .c(new_n76_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x20), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n67_), .c(new_n143_), .d(new_n142_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  inv1   g085(.a(new_n78_), .O(new_n148_));
  inv1   g086(.a(new_n142_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n148_), .c(new_n71_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n147_), .O(z13));
  nand2  g089(.a(new_n143_), .b(new_n78_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n145_), .O(new_n154_));
  aoi21  g092(.a(new_n76_), .b(x27), .c(new_n148_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n142_), .c(new_n138_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n154_), .c(new_n74_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  nor2   g096(.a(new_n113_), .b(new_n158_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  nor3   g098(.a(new_n160_), .b(new_n71_), .c(x23), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  inv1   g100(.a(new_n160_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n74_), .c(new_n162_), .d(x23), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z17));
  nor2   g103(.a(new_n75_), .b(new_n63_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n85_), .c(new_n129_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n74_), .O(new_n168_));
  nand2  g106(.a(z08), .b(new_n86_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(z18));
  oai21  g108(.a(new_n83_), .b(new_n75_), .c(new_n129_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n126_), .c(new_n74_), .O(z20));
  nand2  g110(.a(new_n131_), .b(new_n74_), .O(z19));
endmodule
