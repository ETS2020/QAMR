...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n167_, new_n168_, new_n170_, new_n171_, new_n175_, new_n176_;
  ...
  nor2   g052(.a(new_n72_), .b(new_n83_), .O(z08));
  nand3  g053(.a(x34), .b(x27), .c(x26), .O(new_n116_));
  nand2  g054(.a(new_n99_), .b(x11), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(z09));
  inv1   g056(.a(new_n80_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(x40), .O(new_n120_));
  inv1   g058(.a(x07), .O(new_n121_));
  nand2  g059(.a(new_n72_), .b(new_n121_), .O(new_n122_));
  ...
  inv1   g067(.a(x28), .O(new_n130_));
  nand2  g068(.a(x35), .b(new_n130_), .O(new_n131_));
  ...
  nor2   g073(.a(new_n87_), .b(x04), .O(new_n136_));
  inv1   g074(.a(x09), .O(new_n137_));
  inv1   g075(.a(x30), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  aoi21  g077(.a(new_n136_), .b(new_n85_), .c(new_n139_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n135_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n99_), .O(z11));
  nand2  g080(.a(new_n67_), .b(x27), .O(new_n143_));
  nand2  g081(.a(new_n68_), .b(new_n143_), .O(new_n144_));
  nand2  g082(.a(new_n99_), .b(new_n144_), .O(z12));
  oai21  g083(.a(new_n77_), .b(new_n76_), .c(x28), .O(new_n146_));
  nor2   g084(.a(x13), .b(x04), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(z08), .O(new_n148_));
  nand2  g086(.a(new_n92_), .b(new_n94_), .O(new_n149_));
  nor2   g087(.a(x19), .b(x18), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n99_), .c(new_n149_), .d(x20), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n147_), .b(z08), .c(new_n119_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  inv1   g093(.a(new_n146_), .O(new_n156_));
  nand2  g094(.a(new_n94_), .b(new_n76_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n150_), .c(x20), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n156_), .c(new_n87_), .O(new_n159_));
  nand2  g097(.a(new_n80_), .b(x39), .O(new_n160_));
  oai21  g098(.a(new_n147_), .b(new_n83_), .c(x40), .O(new_n161_));
  nand4  g099(.a(new_n150_), .b(new_n149_), .c(x27), .d(x20), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  oai21  g101(.a(new_n160_), .b(new_n159_), .c(new_n163_), .O(z14));
  ...
  nand2  g106(.a(new_n168_), .b(new_n99_), .O(z16));
  nor2   g107(.a(x24), .b(new_n167_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n99_), .c(x22), .d(x01), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z17));
  nand3  g110(.a(new_n140_), .b(new_n135_), .c(new_n99_), .O(z18));
  inv1   g111(.a(z18), .O(z19));
  nor2   g112(.a(new_n139_), .b(new_n73_), .O(new_n175_));
  oai21  g113(.a(new_n76_), .b(new_n87_), .c(new_n175_), .O(new_n176_));
