...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x21), .O(new_n72_));
  ...
  nor2   g033(.a(x36), .b(x21), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n94_), .c(new_n91_), .O(z04));
  ...
  inv1   g054(.a(new_n84_), .O(new_n117_));
  oai21  g055(.a(x32), .b(x30), .c(new_n117_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(new_n84_), .b(new_n119_), .O(new_n120_));
  ...
  oai21  g078(.a(new_n66_), .b(new_n92_), .c(new_n64_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n98_), .O(z12));
  nand2  g080(.a(new_n90_), .b(new_n93_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(x20), .O(new_n145_));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n117_), .c(new_n76_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n145_), .c(new_n92_), .O(new_n148_));
  nand2  g086(.a(new_n146_), .b(new_n117_), .O(new_n149_));
  nor2   g087(.a(new_n149_), .b(new_n75_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n98_), .O(new_n151_));
  inv1   g089(.a(new_n149_), .O(new_n152_));
  inv1   g090(.a(x35), .O(new_n153_));
  nor2   g091(.a(new_n71_), .b(new_n153_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n152_), .c(x27), .d(x21), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n151_), .O(z13));
  nor2   g094(.a(new_n154_), .b(new_n76_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n149_), .c(new_n145_), .O(new_n158_));
  oai21  g096(.a(new_n149_), .b(new_n75_), .c(new_n98_), .O(new_n159_));
  aoi21  g097(.a(new_n158_), .b(x27), .c(new_n159_), .O(z14));
  nand4  g098(.a(new_n114_), .b(new_n98_), .c(x26), .d(x12), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z15));
  inv1   g100(.a(x01), .O(new_n163_));
  inv1   g101(.a(x22), .O(new_n164_));
  nor4   g102(.a(new_n72_), .b(x23), .c(new_n164_), .d(new_n163_), .O(z16));
  inv1   g103(.a(x24), .O(new_n166_));
  nor2   g104(.a(new_n164_), .b(new_n163_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n98_), .c(new_n166_), .d(x23), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z17));
  aoi21  g107(.a(new_n135_), .b(new_n132_), .c(new_n72_), .O(z18));
  inv1   g108(.a(z18), .O(z19));
  oai21  g109(.a(new_n153_), .b(new_n92_), .c(new_n134_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n130_), .c(new_n98_), .O(z20));
endmodule
