...
module FAU ( 
  ...
  nor2   g011(.a(x33), .b(new_n73_), .O(new_n74_));
  ...
  nor3   g054(.a(new_n116_), .b(new_n74_), .c(new_n115_), .O(z09));
  aoi21  g055(.a(new_n78_), .b(new_n77_), .c(new_n88_), .O(new_n118_));
  ...
  aoi21  g062(.a(new_n68_), .b(new_n124_), .c(x04), .O(new_n125_));
  ...
  inv1   g071(.a(new_n81_), .O(new_n134_));
  ...
  aoi21  g076(.a(new_n136_), .b(new_n134_), .c(new_n138_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n133_), .c(new_n74_), .O(z18));
  inv1   g078(.a(z18), .O(z11));
  nand2  g079(.a(new_n67_), .b(x27), .O(new_n142_));
  nand3  g080(.a(new_n98_), .b(new_n69_), .c(new_n142_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z12));
  nor2   g082(.a(x13), .b(x04), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n118_), .O(new_n146_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n145_), .c(new_n68_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n146_), .c(new_n74_), .O(z13));
  inv1   g094(.a(new_n146_), .O(new_n157_));
  aoi21  g095(.a(new_n153_), .b(new_n150_), .c(new_n135_), .O(new_n158_));
  nor3   g096(.a(new_n158_), .b(new_n157_), .c(new_n74_), .O(z14));
  inv1   g097(.a(x12), .O(new_n160_));
  oai21  g098(.a(new_n116_), .b(new_n160_), .c(new_n98_), .O(z15));
  inv1   g099(.a(x23), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x01), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(x33), .c(new_n73_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(x23), .c(x01), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(x33), .c(new_n73_), .O(z17));
  nand3  g105(.a(new_n139_), .b(new_n133_), .c(new_n98_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z19));
  nor2   g107(.a(new_n138_), .b(new_n74_), .O(new_n170_));
  oai21  g108(.a(new_n92_), .b(new_n135_), .c(new_n170_), .O(new_n171_));
