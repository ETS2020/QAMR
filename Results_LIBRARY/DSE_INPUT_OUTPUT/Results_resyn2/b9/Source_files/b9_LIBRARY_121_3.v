...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n168_, new_n170_, new_n172_, new_n174_, new_n175_;
  ...
  nand2  g048(.a(new_n73_), .b(new_n72_), .O(new_n111_));
  oai22  g049(.a(new_n111_), .b(new_n110_), .c(new_n74_), .d(x14), .O(new_n112_));
  nand3  g050(.a(new_n112_), .b(new_n108_), .c(x03), .O(new_n113_));
  inv1   g051(.a(new_n113_), .O(z07));
  inv1   g052(.a(x11), .O(new_n115_));
  nand4  g053(.a(new_n99_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  nor2   g054(.a(new_n116_), .b(new_n115_), .O(z09));
  inv1   g055(.a(new_n88_), .O(new_n118_));
  ...
  nand3  g062(.a(new_n124_), .b(new_n79_), .c(x27), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  inv1   g064(.a(x05), .O(new_n127_));
  aoi21  g065(.a(new_n118_), .b(new_n127_), .c(x04), .O(new_n128_));
  ...
  nand2  g078(.a(new_n119_), .b(new_n140_), .O(new_n141_));
  aoi21  g079(.a(new_n139_), .b(new_n137_), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n136_), .c(new_n99_), .O(z18));
  inv1   g081(.a(z18), .O(z11));
  nand2  g082(.a(new_n67_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n99_), .b(new_n68_), .c(new_n145_), .O(new_n146_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n118_), .O(new_n151_));
  nor2   g089(.a(x19), .b(x18), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x20), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n63_), .c(new_n151_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  inv1   g093(.a(new_n122_), .O(new_n156_));
  aoi21  g094(.a(new_n150_), .b(new_n156_), .c(new_n74_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(z13));
  nand2  g096(.a(new_n150_), .b(new_n118_), .O(new_n159_));
  nand3  g097(.a(new_n148_), .b(new_n81_), .c(x28), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(new_n153_), .O(new_n162_));
  aoi21  g100(.a(new_n84_), .b(x27), .c(new_n121_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n159_), .c(new_n63_), .d(new_n138_), .O(new_n164_));
