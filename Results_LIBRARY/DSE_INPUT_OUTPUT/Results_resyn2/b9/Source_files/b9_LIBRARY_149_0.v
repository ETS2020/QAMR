...
module FAU ( 
  ...
  nor2   g008(.a(x36), .b(x21), .O(new_n71_));
  ...
  nor2   g033(.a(new_n75_), .b(x21), .O(new_n96_));
  ...
  nor2   g087(.a(new_n149_), .b(new_n74_), .O(new_n150_));
  ...
  aoi21  g092(.a(x36), .b(x35), .c(new_n76_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n149_), .c(new_n145_), .O(new_n156_));
  oai21  g094(.a(new_n149_), .b(new_n74_), .c(new_n98_), .O(new_n157_));
  aoi21  g095(.a(new_n156_), .b(x27), .c(new_n157_), .O(z14));
  nand2  g096(.a(x26), .b(x12), .O(new_n159_));
  nor3   g097(.a(new_n159_), .b(new_n114_), .c(new_n71_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n71_), .c(x23), .O(z16));
  ...
  aoi21  g104(.a(new_n135_), .b(new_n132_), .c(new_n71_), .O(z18));
