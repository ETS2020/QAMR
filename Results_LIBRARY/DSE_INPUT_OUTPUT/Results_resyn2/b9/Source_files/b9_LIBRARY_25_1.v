...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n94_, new_n96_, new_n97_, new_n98_, new_n100_, new_n104_,
  ...
  nand3  g038(.a(new_n98_), .b(new_n64_), .c(new_n100_), .O(z04));
  nand3  g039(.a(new_n97_), .b(new_n64_), .c(new_n96_), .O(z05));
  ...
  oai21  g047(.a(new_n109_), .b(x15), .c(new_n63_), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(x14), .O(new_n111_));
  nand3  g049(.a(new_n111_), .b(new_n108_), .c(x03), .O(new_n112_));
  ...
  oai21  g077(.a(new_n77_), .b(new_n75_), .c(new_n64_), .O(z12));
  nor2   g078(.a(x13), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n85_), .c(new_n73_), .O(new_n142_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n141_), .c(new_n73_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n142_), .c(new_n65_), .O(z13));
  nand2  g088(.a(new_n149_), .b(new_n142_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n64_), .O(z14));
  nand4  g090(.a(new_n114_), .b(new_n64_), .c(x26), .d(x12), .O(new_n153_));
  ...
  oai21  g096(.a(new_n158_), .b(new_n155_), .c(new_n64_), .O(z17));
  aoi21  g097(.a(new_n137_), .b(new_n132_), .c(new_n65_), .O(z18));
  nand3  g098(.a(new_n137_), .b(new_n132_), .c(new_n64_), .O(new_n161_));
  inv1   g099(.a(new_n161_), .O(z19));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n83_), .c(new_n135_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n130_), .c(new_n64_), .O(z20));
endmodule
