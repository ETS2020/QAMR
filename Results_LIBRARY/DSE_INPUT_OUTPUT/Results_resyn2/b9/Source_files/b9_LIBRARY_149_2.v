...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n92_), .c(x36), .d(x21), .O(z03));
  ...
  oai21  g094(.a(new_n149_), .b(new_n75_), .c(new_n98_), .O(new_n157_));
  aoi21  g095(.a(new_n156_), .b(x27), .c(new_n157_), .O(z14));
  nand4  g096(.a(new_n114_), .b(new_n98_), .c(x26), .d(x12), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(z15));
  inv1   g098(.a(x01), .O(new_n161_));
  inv1   g099(.a(x22), .O(new_n162_));
  nor4   g100(.a(new_n72_), .b(x23), .c(new_n162_), .d(new_n161_), .O(z16));
  inv1   g101(.a(x24), .O(new_n164_));
  nor2   g102(.a(new_n162_), .b(new_n161_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n98_), .c(new_n164_), .d(x23), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  aoi21  g105(.a(new_n135_), .b(new_n132_), .c(new_n72_), .O(z18));
  inv1   g106(.a(z18), .O(z19));
  nand2  g107(.a(x35), .b(x27), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n134_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n130_), .c(new_n98_), .O(z20));
endmodule
