...
module FAU ( 
  ...
  oai21  g084(.a(new_n69_), .b(new_n68_), .c(x28), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n142_), .c(new_n71_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n143_), .c(new_n63_), .O(z13));
  nand2  g089(.a(new_n150_), .b(new_n143_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n98_), .O(z14));
  nand2  g091(.a(x26), .b(x12), .O(new_n154_));
  nor3   g092(.a(new_n154_), .b(new_n113_), .c(new_n63_), .O(z15));
  ...
  nor2   g100(.a(new_n135_), .b(new_n63_), .O(new_n163_));
