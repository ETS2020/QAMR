...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x34), .O(new_n72_));
  ...
  nand2  g015(.a(new_n77_), .b(new_n71_), .O(new_n78_));
  ...
  aoi21  g033(.a(new_n90_), .b(new_n89_), .c(new_n72_), .O(z05));
  nand2  g034(.a(new_n90_), .b(new_n89_), .O(new_n97_));
  nor2   g035(.a(new_n97_), .b(new_n72_), .O(z06));
  ...
  nand2  g046(.a(new_n108_), .b(new_n94_), .O(z07));
  nand2  g047(.a(new_n94_), .b(new_n84_), .O(z08));
  ...
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(new_n94_), .O(z10));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n94_), .O(new_n131_));
  aoi21  g069(.a(new_n128_), .b(new_n127_), .c(new_n131_), .O(z11));
  nand2  g070(.a(new_n68_), .b(x27), .O(new_n133_));
  nand2  g071(.a(new_n65_), .b(x10), .O(new_n134_));
  nand3  g072(.a(new_n94_), .b(new_n134_), .c(new_n133_), .O(new_n135_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n114_), .c(new_n76_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(new_n141_), .c(new_n137_), .O(new_n144_));
  nand2  g082(.a(new_n142_), .b(new_n114_), .O(new_n145_));
  nor2   g083(.a(new_n145_), .b(new_n75_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n144_), .c(new_n94_), .O(new_n147_));
  inv1   g085(.a(new_n145_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n111_), .c(x36), .d(x35), .O(new_n149_));
  ...
  oai21  g090(.a(new_n145_), .b(new_n75_), .c(new_n94_), .O(new_n153_));
  aoi21  g091(.a(new_n152_), .b(x27), .c(new_n153_), .O(z14));
  nand3  g092(.a(new_n111_), .b(x26), .c(x12), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n94_), .O(z15));
  inv1   g094(.a(x01), .O(new_n157_));
  inv1   g095(.a(x22), .O(new_n158_));
  nor4   g096(.a(new_n72_), .b(x23), .c(new_n158_), .d(new_n157_), .O(z16));
  inv1   g097(.a(x24), .O(new_n160_));
  nor2   g098(.a(new_n158_), .b(new_n157_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n94_), .c(new_n160_), .d(x23), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z17));
  inv1   g101(.a(z11), .O(z18));
  oai21  g102(.a(new_n88_), .b(new_n137_), .c(new_n130_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n127_), .c(new_n94_), .O(z20));
  aoi21  g104(.a(new_n128_), .b(new_n127_), .c(new_n131_), .O(z19));
endmodule
