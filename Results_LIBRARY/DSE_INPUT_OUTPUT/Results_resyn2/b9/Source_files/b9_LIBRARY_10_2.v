...
module FAU ( 
  ...
  inv1   g008(.a(x12), .O(new_n71_));
  nor2   g009(.a(x36), .b(new_n71_), .O(new_n72_));
  ...
  oai21  g035(.a(new_n77_), .b(new_n92_), .c(new_n93_), .O(new_n98_));
  ...
  oai21  g054(.a(x32), .b(x30), .c(new_n116_), .O(new_n117_));
  ...
  aoi21  g060(.a(new_n116_), .b(new_n122_), .c(x04), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g062(.a(x37), .b(x27), .c(x06), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n89_), .O(z10));
  inv1   g064(.a(x08), .O(new_n127_));
  nand2  g065(.a(new_n116_), .b(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n78_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand4  g068(.a(x35), .b(new_n77_), .c(x27), .d(new_n63_), .O(new_n131_));
  nor3   g069(.a(new_n72_), .b(x30), .c(x09), .O(new_n132_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n92_), .c(new_n135_), .O(new_n137_));
  oai21  g075(.a(new_n66_), .b(new_n92_), .c(new_n64_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n89_), .O(z12));
  nand2  g077(.a(new_n90_), .b(new_n93_), .O(new_n140_));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(x20), .O(new_n142_));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n116_), .c(new_n77_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n142_), .c(new_n92_), .O(new_n145_));
  nand2  g083(.a(new_n143_), .b(new_n116_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(new_n75_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n145_), .c(new_n89_), .O(new_n148_));
  inv1   g086(.a(new_n146_), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x36), .c(x35), .d(x27), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n148_), .O(z13));
  aoi21  g089(.a(x36), .b(x35), .c(new_n77_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n146_), .c(new_n142_), .O(new_n153_));
  oai21  g091(.a(new_n146_), .b(new_n75_), .c(new_n89_), .O(new_n154_));
  aoi21  g092(.a(new_n153_), .b(x27), .c(new_n154_), .O(z14));
  aoi21  g093(.a(new_n114_), .b(x36), .c(new_n71_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  nor3   g095(.a(new_n157_), .b(new_n72_), .c(x23), .O(z16));
  inv1   g096(.a(x24), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x23), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n157_), .c(new_n89_), .O(z17));
  nand2  g099(.a(new_n130_), .b(new_n129_), .O(new_n162_));
  nand3  g100(.a(new_n132_), .b(new_n131_), .c(new_n162_), .O(z18));
  nand2  g101(.a(x35), .b(x27), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n132_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n129_), .O(z20));
  aoi21  g104(.a(new_n130_), .b(new_n129_), .c(new_n133_), .O(z19));
endmodule
