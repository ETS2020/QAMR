...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n162_, new_n163_, new_n167_, new_n168_;
  ...
  nor2   g010(.a(x38), .b(x10), .O(new_n73_));
  ...
  aoi21  g034(.a(new_n96_), .b(new_n76_), .c(new_n73_), .O(new_n97_));
  ...
  nand2  g040(.a(new_n102_), .b(new_n101_), .O(z05));
  inv1   g041(.a(new_n102_), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(new_n101_), .O(z06));
  ...
  nor3   g056(.a(new_n118_), .b(new_n73_), .c(new_n117_), .O(z09));
  ...
  nand2  g077(.a(new_n139_), .b(new_n101_), .O(z11));
  nand2  g078(.a(new_n67_), .b(x27), .O(new_n141_));
  nand3  g079(.a(new_n101_), .b(new_n69_), .c(new_n141_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z12));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n120_), .O(new_n145_));
  nand2  g083(.a(new_n94_), .b(new_n96_), .O(new_n146_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n144_), .c(new_n68_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n145_), .c(new_n73_), .O(z13));
  inv1   g092(.a(new_n145_), .O(new_n155_));
  aoi21  g093(.a(new_n151_), .b(new_n148_), .c(new_n76_), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n155_), .c(new_n73_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n118_), .b(new_n158_), .c(new_n101_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  nor3   g098(.a(new_n160_), .b(new_n73_), .c(x23), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x23), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n160_), .c(new_n101_), .O(z17));
  nand3  g102(.a(new_n138_), .b(new_n133_), .c(new_n101_), .O(z18));
  inv1   g103(.a(z18), .O(z19));
  nand2  g104(.a(x35), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n81_), .c(new_n136_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n131_), .c(new_n101_), .O(z20));
endmodule
