...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n160_, new_n162_, new_n164_, new_n166_, new_n167_, new_n171_,
    new_n172_;
  ...
  nand2  g053(.a(new_n68_), .b(new_n94_), .O(z08));
  ...
  nand2  g060(.a(new_n68_), .b(new_n122_), .O(new_n123_));
  ...
  aoi21  g064(.a(new_n76_), .b(new_n126_), .c(x04), .O(new_n127_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n135_), .c(new_n94_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  aoi22  g080(.a(new_n79_), .b(new_n75_), .c(new_n71_), .d(new_n94_), .O(z12));
  ...
  oai21  g087(.a(new_n146_), .b(new_n144_), .c(new_n149_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  aoi21  g089(.a(new_n145_), .b(new_n120_), .c(new_n63_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  inv1   g091(.a(new_n82_), .O(new_n154_));
  inv1   g092(.a(x35), .O(new_n155_));
  nand2  g093(.a(new_n97_), .b(new_n155_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n148_), .c(x20), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n144_), .c(new_n66_), .O(new_n158_));
  nand4  g096(.a(new_n148_), .b(new_n147_), .c(x27), .d(x20), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n146_), .c(new_n63_), .O(new_n160_));
  oai21  g098(.a(new_n158_), .b(new_n154_), .c(new_n160_), .O(z14));
  inv1   g099(.a(x12), .O(new_n162_));
  oai21  g100(.a(new_n118_), .b(new_n162_), .c(new_n94_), .O(z15));
  nand2  g101(.a(x22), .b(x01), .O(new_n164_));
  nor3   g102(.a(new_n164_), .b(new_n63_), .c(x23), .O(z16));
  inv1   g103(.a(x24), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x23), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n164_), .c(new_n94_), .O(z17));
  aoi21  g106(.a(new_n140_), .b(new_n135_), .c(new_n63_), .O(z18));
  inv1   g107(.a(z18), .O(z19));
  nand2  g108(.a(x35), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n138_), .c(new_n137_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n133_), .c(new_n94_), .O(z20));
endmodule
