...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n155_, new_n157_, new_n158_, new_n162_, new_n163_;
  nand2  g000(.a(x14), .b(x05), .O(new_n63_));
  ...
  nor2   g050(.a(new_n75_), .b(new_n64_), .O(z08));
  nand2  g051(.a(x34), .b(x27), .O(new_n114_));
  nand2  g052(.a(x26), .b(x11), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(new_n114_), .c(new_n63_), .O(z09));
  nand2  g054(.a(new_n63_), .b(new_n68_), .O(new_n117_));
  aoi21  g055(.a(new_n82_), .b(new_n70_), .c(new_n117_), .O(new_n118_));
  inv1   g056(.a(x07), .O(new_n119_));
  nor2   g057(.a(new_n75_), .b(x05), .O(new_n120_));
  aoi21  g058(.a(new_n75_), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  and2   g059(.a(x37), .b(x06), .O(new_n122_));
  aoi22  g060(.a(new_n122_), .b(new_n63_), .c(new_n121_), .d(new_n118_), .O(new_n123_));
  inv1   g061(.a(new_n85_), .O(new_n124_));
  nand4  g062(.a(new_n124_), .b(new_n76_), .c(new_n104_), .d(x05), .O(new_n125_));
  ...
  aoi21  g073(.a(new_n132_), .b(new_n83_), .c(new_n135_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n131_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n63_), .O(z11));
  oai21  g076(.a(new_n78_), .b(new_n74_), .c(new_n63_), .O(z12));
  oai21  g077(.a(new_n70_), .b(new_n69_), .c(x28), .O(new_n140_));
  nor2   g078(.a(x13), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n72_), .O(new_n142_));
  inv1   g080(.a(new_n67_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(x20), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n142_), .c(new_n66_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n141_), .b(new_n124_), .c(new_n72_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(new_n64_), .O(z13));
  inv1   g087(.a(new_n148_), .O(new_n150_));
  nor3   g088(.a(new_n150_), .b(new_n146_), .c(new_n64_), .O(z14));
  nand3  g089(.a(new_n63_), .b(x26), .c(x12), .O(new_n152_));
  nor2   g090(.a(new_n152_), .b(new_n114_), .O(z15));
  ...
  nand3  g097(.a(new_n136_), .b(new_n131_), .c(new_n63_), .O(z18));
  inv1   g098(.a(z18), .O(z19));
  nand2  g099(.a(x35), .b(x27), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n63_), .c(new_n134_), .d(new_n133_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n129_), .O(z20));
endmodule
