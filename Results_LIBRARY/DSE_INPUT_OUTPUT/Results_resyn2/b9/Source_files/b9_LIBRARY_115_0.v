...
module FAU ( 
  ...
  nor2   g010(.a(x14), .b(x03), .O(new_n73_));
  ...
  aoi21  g021(.a(new_n83_), .b(x04), .c(new_n73_), .O(z01));
  ...
  inv1   g036(.a(new_n73_), .O(new_n99_));
  aoi21  g037(.a(x28), .b(x27), .c(x37), .O(new_n100_));
  nand2  g038(.a(new_n100_), .b(new_n99_), .O(z05));
  inv1   g039(.a(new_n100_), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n99_), .O(z06));
  ...
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(new_n99_), .O(z10));
  inv1   g067(.a(x08), .O(new_n130_));
  nand3  g068(.a(x40), .b(x39), .c(x29), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n80_), .c(new_n130_), .O(new_n132_));
  nand2  g070(.a(new_n131_), .b(x27), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  inv1   g072(.a(new_n80_), .O(new_n135_));
  nor2   g073(.a(new_n93_), .b(x04), .O(new_n136_));
  inv1   g074(.a(x09), .O(new_n137_));
  nand2  g075(.a(new_n76_), .b(new_n137_), .O(new_n138_));
  aoi21  g076(.a(new_n136_), .b(new_n135_), .c(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n134_), .c(new_n99_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z11));
  nand2  g079(.a(new_n67_), .b(x27), .O(new_n142_));
  nand3  g080(.a(new_n99_), .b(new_n69_), .c(new_n142_), .O(new_n143_));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n146_), .c(new_n73_), .O(z13));
  inv1   g093(.a(new_n146_), .O(new_n156_));
  aoi21  g094(.a(new_n152_), .b(new_n149_), .c(new_n93_), .O(new_n157_));
  nor3   g095(.a(new_n157_), .b(new_n156_), .c(new_n73_), .O(z14));
  inv1   g096(.a(x12), .O(new_n159_));
  nor2   g097(.a(new_n117_), .b(new_n159_), .O(z15));
  ...
  aoi21  g103(.a(new_n139_), .b(new_n134_), .c(new_n73_), .O(z18));
  nand2  g104(.a(x35), .b(x27), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n99_), .c(new_n76_), .d(new_n137_), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(new_n132_), .O(z20));
  inv1   g107(.a(new_n140_), .O(z19));
endmodule
