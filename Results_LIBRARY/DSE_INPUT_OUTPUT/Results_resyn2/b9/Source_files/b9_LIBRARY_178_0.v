...
module FAU ( 
  ...
  nor2   g010(.a(x33), .b(x22), .O(new_n73_));
  ...
  nor2   g033(.a(new_n73_), .b(x21), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(new_n94_), .O(z04));
  aoi21  g035(.a(new_n93_), .b(new_n92_), .c(new_n73_), .O(z05));
  ...
  nor3   g052(.a(new_n114_), .b(new_n73_), .c(new_n113_), .O(z09));
  aoi21  g053(.a(new_n77_), .b(new_n76_), .c(new_n87_), .O(new_n116_));
  ...
  aoi21  g060(.a(new_n68_), .b(new_n122_), .c(x04), .O(new_n123_));
  ...
  aoi21  g066(.a(new_n128_), .b(new_n80_), .c(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n128_), .b(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  inv1   g069(.a(new_n80_), .O(new_n132_));
  inv1   g070(.a(x27), .O(new_n133_));
  nor2   g071(.a(new_n133_), .b(x04), .O(new_n134_));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(new_n76_), .b(new_n135_), .O(new_n136_));
  aoi21  g074(.a(new_n134_), .b(new_n132_), .c(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n131_), .c(new_n73_), .O(z18));
  ...
  nand2  g081(.a(new_n143_), .b(new_n116_), .O(new_n144_));
  nand2  g082(.a(x35), .b(x28), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n92_), .O(new_n146_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n143_), .c(new_n68_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n144_), .c(new_n73_), .O(z13));
  inv1   g092(.a(new_n144_), .O(new_n155_));
  aoi21  g093(.a(new_n151_), .b(new_n148_), .c(new_n133_), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(new_n155_), .c(new_n73_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n114_), .b(new_n158_), .c(new_n100_), .O(z15));
  nand2  g097(.a(x22), .b(x01), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x23), .c(new_n100_), .O(z16));
  inv1   g099(.a(x24), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x23), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n160_), .c(new_n100_), .O(z17));
  nand3  g102(.a(new_n137_), .b(new_n131_), .c(new_n100_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z19));
  nor2   g104(.a(new_n136_), .b(new_n73_), .O(new_n167_));
  oai21  g105(.a(new_n91_), .b(new_n133_), .c(new_n167_), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(new_n129_), .O(z20));
endmodule
