...
module FAU ( 
  ...
  nor2   g009(.a(x14), .b(x02), .O(new_n72_));
  ...
  oai21  g020(.a(x27), .b(new_n65_), .c(x02), .O(new_n83_));
  nand2  g021(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  inv1   g022(.a(x02), .O(new_n85_));
  nand2  g023(.a(x29), .b(x14), .O(new_n86_));
  ...
  nand3  g029(.a(new_n91_), .b(new_n87_), .c(new_n84_), .O(z02));
  ...
  nor2   g050(.a(new_n72_), .b(new_n88_), .O(z08));
  nand2  g051(.a(x34), .b(x27), .O(new_n114_));
  nand2  g052(.a(x26), .b(x11), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(new_n114_), .c(new_n99_), .O(z09));
  ...
  aoi21  g069(.a(new_n131_), .b(new_n90_), .c(new_n82_), .O(new_n132_));
  nand2  g070(.a(new_n131_), .b(x27), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  inv1   g072(.a(new_n90_), .O(new_n135_));
  ...
  nand3  g081(.a(new_n99_), .b(new_n68_), .c(new_n143_), .O(new_n144_));
  ...
  nand2  g088(.a(new_n150_), .b(new_n93_), .O(new_n151_));
  ...
  nand3  g097(.a(new_n146_), .b(new_n79_), .c(x28), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n158_), .c(new_n159_), .O(new_n162_));
  aoi21  g100(.a(new_n89_), .b(x27), .c(new_n120_), .O(new_n163_));
  ...
  nor3   g104(.a(new_n166_), .b(new_n114_), .c(new_n72_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x22), .c(x01), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n99_), .O(z16));
  nor2   g108(.a(x24), .b(new_n168_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n99_), .c(x22), .d(x01), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  aoi21  g111(.a(new_n140_), .b(new_n134_), .c(new_n72_), .O(z18));
  nand3  g112(.a(new_n140_), .b(new_n134_), .c(new_n99_), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(z19));
  nand2  g114(.a(x35), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n118_), .c(new_n138_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n132_), .c(new_n99_), .O(z20));
endmodule
