...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n157_, new_n159_, new_n160_, new_n162_;
  ...
  nor2   g030(.a(new_n92_), .b(new_n78_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(new_n91_), .c(new_n64_), .O(z02));
  ...
  nand4  g044(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(x13), .O(new_n107_));
  inv1   g045(.a(x25), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(x00), .O(new_n109_));
  nand2  g047(.a(x25), .b(new_n63_), .O(new_n110_));
  ...
  nand2  g051(.a(new_n78_), .b(new_n95_), .O(z08));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n95_), .c(x11), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(z09));
  aoi21  g056(.a(new_n87_), .b(x05), .c(new_n78_), .O(new_n119_));
  nand2  g057(.a(new_n89_), .b(new_n73_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(x27), .c(x07), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n78_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n71_), .O(new_n123_));
  ...
  nand2  g066(.a(new_n75_), .b(x29), .O(new_n129_));
  ...
  nand2  g072(.a(new_n134_), .b(new_n95_), .O(new_n135_));
  ...
  nand3  g077(.a(new_n80_), .b(new_n139_), .c(new_n95_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z12));
  inv1   g079(.a(x13), .O(new_n142_));
  oai21  g080(.a(new_n73_), .b(new_n72_), .c(x28), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n79_), .c(new_n142_), .O(new_n144_));
  nor2   g082(.a(x19), .b(x18), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n69_), .c(x20), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n144_), .c(new_n66_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  inv1   g086(.a(new_n79_), .O(new_n149_));
  oai21  g087(.a(new_n86_), .b(new_n149_), .c(new_n63_), .O(new_n150_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n147_), .c(new_n95_), .O(z14));
  nand3  g092(.a(new_n116_), .b(new_n95_), .c(x12), .O(new_n155_));
