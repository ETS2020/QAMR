...
module FAU ( 
  ...
  nand2  g049(.a(new_n89_), .b(new_n99_), .O(z08));
  ...
  nand3  g074(.a(new_n136_), .b(new_n131_), .c(new_n99_), .O(new_n137_));
  ...
  aoi21  g081(.a(x36), .b(x35), .c(new_n81_), .O(new_n144_));
  ...
  nand4  g089(.a(new_n113_), .b(new_n99_), .c(x26), .d(x12), .O(new_n152_));
  ...
  oai21  g095(.a(new_n157_), .b(new_n154_), .c(new_n99_), .O(z17));
  aoi21  g096(.a(new_n136_), .b(new_n131_), .c(new_n64_), .O(z18));
  nor2   g097(.a(new_n135_), .b(new_n64_), .O(new_n160_));
  oai21  g098(.a(new_n69_), .b(new_n66_), .c(new_n160_), .O(new_n161_));
