...
module FAU ( 
  ...
  nand2  g17(.a(new_n65_), .b(new_n64_), .O(new_n80_));
  nand4  g18(.a(new_n80_), .b(new_n79_), .c(z02), .d(x21), .O(z03));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(x21), .O(new_n82_));
  aoi21  g20(.a(new_n82_), .b(new_n79_), .c(new_n71_), .O(z04));
  nand2  g21(.a(x28), .b(x27), .O(new_n84_));
  nand3  g22(.a(new_n84_), .b(z02), .c(new_n65_), .O(z05));
  ...
  inv1   g45(.a(x28), .O(new_n109_));
  inv1   g46(.a(x08), .O(new_n110_));
  nand2  g47(.a(new_n64_), .b(new_n110_), .O(new_n111_));
  nand2  g48(.a(x27), .b(x04), .O(new_n112_));
  nand4  g49(.a(new_n112_), .b(new_n111_), .c(x35), .d(new_n109_), .O(new_n113_));
  aoi21  g50(.a(new_n113_), .b(new_n108_), .c(new_n71_), .O(z18));
  inv1   g51(.a(z18), .O(z11));
  nor2   g52(.a(new_n71_), .b(new_n67_), .O(z12));
  inv1   g53(.a(x18), .O(new_n117_));
  inv1   g54(.a(x19), .O(new_n118_));
  nand4  g55(.a(new_n67_), .b(x20), .c(new_n118_), .d(new_n117_), .O(new_n119_));
  nand2  g56(.a(new_n119_), .b(z02), .O(z13));
  inv1   g57(.a(new_n119_), .O(new_n121_));
  nand2  g58(.a(new_n121_), .b(z02), .O(z14));
  inv1   g59(.a(x12), .O(new_n123_));
  nor2   g60(.a(new_n101_), .b(new_n123_), .O(z15));
  inv1   g61(.a(x23), .O(new_n125_));
  nand4  g62(.a(z02), .b(new_n125_), .c(x22), .d(x01), .O(new_n126_));
  inv1   g63(.a(new_n126_), .O(z16));
  inv1   g64(.a(x24), .O(new_n128_));
  nand4  g65(.a(new_n128_), .b(x23), .c(x22), .d(x01), .O(new_n129_));
  nand2  g66(.a(new_n129_), .b(z02), .O(z17));
  aoi21  g67(.a(new_n109_), .b(x08), .c(x27), .O(new_n131_));
  oai21  g68(.a(new_n131_), .b(new_n72_), .c(new_n108_), .O(new_n132_));
  nand2  g69(.a(new_n132_), .b(z02), .O(z20));
  zero   g70(.O(z08));
  inv1   g71(.a(z18), .O(z19));
endmodule
