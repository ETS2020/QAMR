...
module FAU ( 
  ...
  oai21  g028(.a(new_n86_), .b(new_n64_), .c(new_n90_), .O(z02));
  nand2  g029(.a(x35), .b(x28), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x27), .O(new_n93_));
  inv1   g031(.a(x37), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n75_), .c(new_n82_), .O(new_n95_));
  ...
  inv1   g042(.a(x38), .O(new_n105_));
  aoi21  g043(.a(x25), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  oai21  g044(.a(x25), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  ...
  nor2   g056(.a(new_n88_), .b(new_n80_), .O(new_n119_));
  ...
  oai21  g060(.a(new_n88_), .b(x05), .c(new_n64_), .O(new_n123_));
  nand3  g061(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  and2   g062(.a(new_n124_), .b(new_n72_), .O(new_n125_));
  oai21  g063(.a(new_n123_), .b(new_n122_), .c(new_n125_), .O(z10));
  nand3  g064(.a(x40), .b(x39), .c(x29), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n78_), .c(new_n85_), .O(new_n128_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n133_), .c(new_n130_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  nand2  g076(.a(new_n63_), .b(new_n94_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x27), .c(x10), .O(new_n140_));
  nand2  g078(.a(new_n92_), .b(new_n94_), .O(new_n141_));
  aoi22  g079(.a(new_n141_), .b(x27), .c(x39), .d(new_n64_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n140_), .c(x40), .O(new_n143_));
  nand2  g081(.a(new_n141_), .b(x27), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n71_), .c(new_n105_), .O(new_n145_));
  ...
  oai21  g088(.a(new_n76_), .b(new_n131_), .c(x28), .O(new_n151_));
  inv1   g089(.a(x13), .O(new_n152_));
  nand4  g090(.a(x40), .b(x39), .c(new_n152_), .d(new_n64_), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  aoi22  g092(.a(new_n154_), .b(new_n151_), .c(new_n150_), .d(new_n141_), .O(new_n155_));
  nor2   g093(.a(x13), .b(x04), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n119_), .c(new_n82_), .O(new_n157_));
  oai21  g095(.a(new_n155_), .b(new_n75_), .c(new_n157_), .O(z13));
  oai21  g096(.a(new_n151_), .b(new_n81_), .c(new_n154_), .O(new_n159_));
  nor2   g097(.a(new_n150_), .b(new_n82_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  oai21  g099(.a(x28), .b(new_n75_), .c(new_n80_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n156_), .c(z08), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n144_), .c(new_n72_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z14));
  nand3  g103(.a(new_n116_), .b(new_n72_), .c(x12), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z15));
  inv1   g105(.a(x23), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x22), .c(x01), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n72_), .O(z16));
  nor2   g108(.a(x24), .b(new_n168_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n72_), .c(x22), .d(x01), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z17));
  inv1   g111(.a(new_n89_), .O(new_n174_));
  nand2  g112(.a(new_n75_), .b(new_n85_), .O(new_n175_));
  nand2  g113(.a(x27), .b(x04), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n132_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n134_), .O(new_n178_));
  aoi22  g116(.a(new_n178_), .b(new_n72_), .c(new_n174_), .d(z08), .O(z19));
  nor2   g117(.a(new_n131_), .b(new_n75_), .O(new_n180_));
  nor3   g118(.a(new_n180_), .b(new_n135_), .c(new_n128_), .O(z20));
endmodule
