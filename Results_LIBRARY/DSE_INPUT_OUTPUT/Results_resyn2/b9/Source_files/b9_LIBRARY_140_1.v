...
module FAU ( 
  ...
  inv1   g00(.a(x25), .O(new_n63_));
  nor2   g01(.a(new_n63_), .b(x22), .O(new_n64_));
  ...
  aoi21  g35(.a(new_n92_), .b(new_n91_), .c(new_n64_), .O(z05));
  nand2  g36(.a(new_n92_), .b(new_n91_), .O(new_n99_));
  nor2   g37(.a(new_n99_), .b(new_n64_), .O(z06));
  nand2  g38(.a(new_n63_), .b(x00), .O(new_n101_));
  ...
  inv1   g49(.a(x11), .O(new_n112_));
  nand3  g50(.a(x34), .b(x27), .c(x26), .O(new_n113_));
  nor3   g51(.a(new_n113_), .b(new_n64_), .c(new_n112_), .O(z09));
  ...
  nand3  g70(.a(new_n132_), .b(new_n128_), .c(new_n96_), .O(new_n133_));
  inv1   g71(.a(new_n133_), .O(z11));
  oai21  g72(.a(new_n76_), .b(new_n74_), .c(new_n96_), .O(z12));
  nor2   g73(.a(x13), .b(x04), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(new_n72_), .O(new_n137_));
  aoi21  g75(.a(x36), .b(x35), .c(new_n79_), .O(new_n138_));
  nor2   g76(.a(x19), .b(x18), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x20), .O(new_n140_));
  oai22  g78(.a(new_n140_), .b(new_n67_), .c(new_n138_), .d(new_n137_), .O(new_n141_));
  oai21  g79(.a(new_n137_), .b(new_n81_), .c(new_n96_), .O(new_n142_));
  aoi21  g80(.a(new_n141_), .b(x27), .c(new_n142_), .O(z14));
  inv1   g81(.a(z14), .O(z13));
  inv1   g82(.a(x12), .O(new_n145_));
  oai21  g83(.a(new_n113_), .b(new_n145_), .c(new_n96_), .O(z15));
  nand2  g84(.a(x22), .b(x01), .O(new_n147_));
  oai21  g85(.a(new_n147_), .b(x23), .c(new_n96_), .O(z16));
  inv1   g86(.a(x24), .O(new_n149_));
  nand2  g87(.a(new_n149_), .b(x23), .O(new_n150_));
  oai21  g88(.a(new_n150_), .b(new_n147_), .c(new_n96_), .O(z17));
  aoi21  g89(.a(new_n132_), .b(new_n128_), .c(new_n64_), .O(z18));
  nand2  g90(.a(new_n132_), .b(new_n128_), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(new_n96_), .O(z19));
  nor2   g92(.a(new_n129_), .b(new_n64_), .O(new_n155_));
  nand2  g93(.a(new_n155_), .b(new_n131_), .O(new_n156_));
  nor2   g94(.a(new_n156_), .b(new_n126_), .O(z20));
endmodule
