...
module FAU ( 
  ...
  aoi21  g057(.a(new_n71_), .b(x39), .c(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n118_), .b(new_n114_), .c(new_n120_), .O(new_n121_));
  inv1   g059(.a(new_n113_), .O(new_n122_));
  nor2   g060(.a(new_n79_), .b(x04), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  oai21  g062(.a(new_n121_), .b(new_n84_), .c(new_n124_), .O(z10));
  nand2  g063(.a(x39), .b(x29), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n117_), .c(new_n83_), .O(new_n127_));
  ...
  aoi21  g070(.a(new_n130_), .b(new_n77_), .c(new_n132_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n129_), .c(new_n72_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z11));
  nand2  g073(.a(new_n67_), .b(x27), .O(new_n136_));
  nand2  g074(.a(new_n68_), .b(new_n136_), .O(new_n137_));
  nand2  g075(.a(new_n72_), .b(new_n137_), .O(z12));
  inv1   g076(.a(x18), .O(new_n139_));
  inv1   g077(.a(x19), .O(new_n140_));
  nand3  g078(.a(x20), .b(new_n140_), .c(new_n139_), .O(new_n141_));
  aoi21  g079(.a(x36), .b(x35), .c(new_n116_), .O(new_n142_));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x39), .O(new_n144_));
  oai22  g082(.a(new_n144_), .b(new_n142_), .c(new_n141_), .d(new_n66_), .O(new_n145_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n151_), .c(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g092(.a(new_n89_), .b(new_n76_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x20), .c(new_n140_), .d(new_n139_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n142_), .c(new_n84_), .O(new_n157_));
  nand2  g095(.a(new_n79_), .b(x40), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n154_), .O(z14));
  nand4  g097(.a(new_n109_), .b(new_n72_), .c(x26), .d(x12), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(z15));
  inv1   g099(.a(x23), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(x22), .c(x01), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n72_), .O(z16));
  nor2   g102(.a(x24), .b(new_n162_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n72_), .c(x22), .d(x01), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(z17));
  nand2  g105(.a(x27), .b(x04), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n85_), .c(new_n77_), .O(new_n169_));
  oai21  g107(.a(new_n126_), .b(new_n83_), .c(new_n131_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n75_), .O(z18));
  nand2  g110(.a(new_n133_), .b(new_n129_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n72_), .O(z19));
  oai21  g112(.a(new_n76_), .b(new_n84_), .c(new_n131_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n127_), .c(new_n72_), .O(z20));
