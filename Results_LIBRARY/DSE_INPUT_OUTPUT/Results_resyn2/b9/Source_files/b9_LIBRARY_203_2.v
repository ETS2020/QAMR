...
module FAU ( 
  ...
  nor2   g013(.a(x20), .b(new_n75_), .O(new_n76_));
  ...
  or2    g061(.a(new_n120_), .b(new_n84_), .O(new_n124_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n77_), .O(z11));
  nand2  g077(.a(new_n77_), .b(new_n73_), .O(z12));
  ...
  aoi21  g086(.a(new_n148_), .b(new_n144_), .c(new_n96_), .O(new_n149_));
  nand2  g087(.a(new_n143_), .b(new_n71_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n84_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(x20), .O(new_n152_));
  inv1   g090(.a(new_n150_), .O(new_n153_));
  nand2  g091(.a(new_n142_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n84_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(new_n75_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n152_), .O(z13));
  nand3  g095(.a(new_n143_), .b(new_n71_), .c(new_n80_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n64_), .c(new_n96_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n160_));
  nand3  g098(.a(new_n141_), .b(new_n84_), .c(x28), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n143_), .c(new_n71_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n160_), .c(new_n76_), .O(new_n163_));
  oai21  g101(.a(new_n159_), .b(new_n151_), .c(new_n163_), .O(z14));
  nand3  g102(.a(new_n117_), .b(new_n77_), .c(x12), .O(new_n165_));
  ...
  nand4  g108(.a(new_n170_), .b(new_n77_), .c(new_n169_), .d(x23), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(z17));
  nand3  g110(.a(new_n137_), .b(new_n133_), .c(new_n77_), .O(z18));
  nor4   g111(.a(new_n136_), .b(new_n134_), .c(new_n131_), .d(new_n76_), .O(z20));
  nand2  g112(.a(new_n138_), .b(new_n77_), .O(z19));
endmodule
