...
module FAU ( 
  ...
  nand3  g049(.a(new_n111_), .b(new_n85_), .c(x03), .O(new_n112_));
  ...
  nand2  g067(.a(new_n84_), .b(x29), .O(new_n130_));
  ...
  nand2  g075(.a(new_n137_), .b(new_n85_), .O(z11));
  nand2  g076(.a(new_n85_), .b(new_n69_), .O(new_n139_));
  ...
  oai22  g083(.a(new_n145_), .b(new_n66_), .c(new_n143_), .d(new_n142_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  inv1   g085(.a(new_n142_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n122_), .c(new_n72_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  nand2  g088(.a(new_n143_), .b(new_n80_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n145_), .O(new_n153_));
  inv1   g091(.a(x27), .O(new_n154_));
  aoi21  g092(.a(new_n76_), .b(x27), .c(new_n122_), .O(new_n155_));
  oai22  g093(.a(new_n155_), .b(new_n142_), .c(new_n66_), .d(new_n154_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n153_), .c(new_n85_), .O(z14));
  inv1   g095(.a(x12), .O(new_n158_));
  oai21  g096(.a(new_n116_), .b(new_n158_), .c(new_n85_), .O(z15));
  inv1   g097(.a(x24), .O(new_n161_));
  nand4  g098(.a(new_n161_), .b(x23), .c(x22), .d(x01), .O(new_n162_));
  inv1   g099(.a(new_n162_), .O(z17));
  aoi21  g100(.a(new_n136_), .b(new_n133_), .c(new_n72_), .O(z18));
  oai21  g101(.a(new_n92_), .b(new_n154_), .c(new_n134_), .O(new_n165_));
  oai21  g102(.a(new_n165_), .b(new_n131_), .c(new_n85_), .O(z20));
  zero   g103(.O(z16));
  nand2  g104(.a(new_n137_), .b(new_n85_), .O(z19));
endmodule
