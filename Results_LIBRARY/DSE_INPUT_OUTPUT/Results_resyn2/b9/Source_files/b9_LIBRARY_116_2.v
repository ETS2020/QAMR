...
module FAU ( 
  ...
  nand3  g018(.a(new_n80_), .b(new_n72_), .c(x04), .O(z01));
  ...
  oai22  g030(.a(new_n92_), .b(new_n75_), .c(new_n91_), .d(x27), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(x21), .c(new_n82_), .O(z03));
  inv1   g032(.a(x21), .O(new_n95_));
  nand3  g033(.a(new_n93_), .b(new_n72_), .c(new_n95_), .O(z04));
  nand2  g034(.a(new_n92_), .b(new_n91_), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n72_), .O(z06));
  ...
  nand2  g048(.a(new_n72_), .b(new_n87_), .O(z08));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(new_n72_), .O(z09));
  inv1   g051(.a(x07), .O(new_n114_));
  inv1   g052(.a(x39), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n114_), .c(x04), .O(new_n116_));
  oai21  g054(.a(x36), .b(new_n114_), .c(new_n71_), .O(new_n117_));
  inv1   g055(.a(x05), .O(new_n118_));
  nand3  g056(.a(x40), .b(x39), .c(new_n118_), .O(new_n119_));
  nand4  g057(.a(new_n119_), .b(new_n117_), .c(new_n116_), .d(new_n77_), .O(new_n120_));
  nand3  g058(.a(new_n72_), .b(x37), .c(x06), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(x27), .O(new_n123_));
  nor2   g061(.a(new_n87_), .b(x04), .O(new_n124_));
  ...
  nand4  g071(.a(x35), .b(new_n83_), .c(x27), .d(new_n64_), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(new_n72_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  aoi21  g073(.a(new_n131_), .b(new_n130_), .c(new_n135_), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  inv1   g075(.a(x27), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n138_), .c(new_n137_), .O(new_n140_));
  oai22  g078(.a(new_n87_), .b(x04), .c(new_n66_), .d(new_n138_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(new_n72_), .O(z12));
  oai21  g080(.a(new_n75_), .b(new_n83_), .c(new_n91_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(new_n72_), .c(new_n143_), .d(x20), .O(new_n145_));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n124_), .c(new_n146_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand3  g089(.a(new_n125_), .b(new_n124_), .c(new_n146_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand3  g091(.a(new_n144_), .b(new_n143_), .c(x20), .O(new_n154_));
  inv1   g092(.a(new_n65_), .O(new_n155_));
  nand2  g093(.a(new_n147_), .b(new_n71_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n148_), .c(new_n155_), .d(new_n146_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g096(.a(new_n152_), .b(new_n72_), .O(new_n159_));
  aoi21  g097(.a(new_n158_), .b(x27), .c(new_n159_), .O(z14));
  nand4  g098(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n72_), .O(z15));
  nand2  g100(.a(x22), .b(x01), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(x23), .c(new_n72_), .O(z16));
  inv1   g102(.a(x24), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x23), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n163_), .c(new_n72_), .O(z17));
  inv1   g105(.a(z11), .O(z18));
  nand3  g106(.a(new_n72_), .b(new_n133_), .c(new_n132_), .O(new_n169_));
  nor2   g107(.a(new_n75_), .b(new_n138_), .O(new_n170_));
  nor3   g108(.a(new_n170_), .b(new_n169_), .c(new_n130_), .O(z20));
  aoi21  g109(.a(new_n131_), .b(new_n130_), .c(new_n135_), .O(z19));
endmodule
