...
module FAU ( 
  ...
  nor2   g009(.a(new_n71_), .b(x08), .O(new_n72_));
  ...
  or2    g023(.a(new_n85_), .b(new_n63_), .O(new_n86_));
  ...
  aoi21  g028(.a(x35), .b(x28), .c(new_n75_), .O(new_n91_));
  nor2   g029(.a(new_n91_), .b(new_n72_), .O(new_n92_));
  inv1   g030(.a(x37), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n75_), .O(new_n94_));
  ...
  nand4  g043(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(x08), .O(new_n106_));
  ...
  aoi21  g049(.a(new_n106_), .b(x14), .c(new_n111_), .O(z07));
  nor2   g050(.a(new_n72_), .b(new_n87_), .O(z08));
  nand4  g051(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n98_), .O(z09));
  nand2  g053(.a(new_n78_), .b(new_n76_), .O(new_n116_));
  ...
  nand2  g059(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  ...
  aoi21  g063(.a(new_n125_), .b(new_n124_), .c(new_n72_), .O(z10));
  nand3  g064(.a(x40), .b(x39), .c(x29), .O(new_n127_));
  nand2  g065(.a(x27), .b(x04), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x35), .c(new_n77_), .O(new_n129_));
  nor2   g067(.a(x28), .b(x04), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x35), .c(x27), .O(new_n131_));
  aoi22  g069(.a(new_n131_), .b(new_n84_), .c(new_n129_), .d(new_n127_), .O(new_n132_));
  or2    g070(.a(x30), .b(x09), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n132_), .c(new_n98_), .O(z11));
  nand2  g072(.a(new_n98_), .b(new_n69_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(z12));
  aoi21  g074(.a(x36), .b(x35), .c(new_n77_), .O(new_n137_));
  inv1   g075(.a(x13), .O(new_n138_));
  inv1   g076(.a(new_n87_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n63_), .O(new_n140_));
  nor2   g078(.a(x19), .b(x18), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x20), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n66_), .c(new_n140_), .d(new_n137_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nor2   g082(.a(new_n140_), .b(new_n80_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n144_), .c(new_n72_), .O(z13));
  nand4  g085(.a(new_n139_), .b(new_n77_), .c(new_n138_), .d(new_n63_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n66_), .c(new_n75_), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n80_), .c(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n139_), .c(new_n138_), .d(new_n63_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n142_), .c(new_n72_), .O(new_n153_));
  oai21  g091(.a(new_n149_), .b(new_n145_), .c(new_n153_), .O(z14));
  nand4  g092(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n98_), .O(z15));
  nand2  g094(.a(x22), .b(x01), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x23), .c(new_n98_), .O(z16));
  ...
  nand2  g100(.a(new_n128_), .b(new_n85_), .O(new_n163_));
  nand3  g101(.a(new_n139_), .b(x29), .c(x08), .O(new_n164_));
  nor2   g102(.a(new_n133_), .b(new_n72_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(z18));
  nand2  g104(.a(x35), .b(x27), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n71_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n130_), .O(new_n169_));
  inv1   g107(.a(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  aoi21  g109(.a(x27), .b(x04), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  aoi22  g111(.a(new_n173_), .b(new_n127_), .c(new_n169_), .d(new_n84_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n133_), .c(new_n98_), .O(z19));
  aoi21  g113(.a(new_n127_), .b(new_n78_), .c(new_n84_), .O(new_n176_));
  nand2  g114(.a(new_n165_), .b(new_n167_), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n176_), .O(z20));
endmodule
