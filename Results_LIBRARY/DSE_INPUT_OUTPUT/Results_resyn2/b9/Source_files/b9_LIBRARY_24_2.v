...
module FAU ( 
  ...
  aoi21  g027(.a(new_n89_), .b(x04), .c(new_n84_), .O(new_n90_));
  oai21  g028(.a(new_n90_), .b(new_n71_), .c(x39), .O(z02));
  ...
  nand2  g037(.a(new_n99_), .b(new_n72_), .O(z05));
  inv1   g038(.a(new_n99_), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n72_), .O(z06));
  ...
  nand3  g049(.a(new_n111_), .b(new_n72_), .c(x03), .O(new_n112_));
  nor2   g050(.a(new_n112_), .b(new_n107_), .O(z07));
  and2   g051(.a(x40), .b(x39), .O(z08));
  nand3  g052(.a(x34), .b(x27), .c(x26), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n72_), .c(x11), .O(new_n117_));
  ...
  aoi21  g061(.a(new_n71_), .b(x39), .c(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n122_), .b(new_n121_), .c(new_n124_), .O(new_n125_));
  inv1   g063(.a(new_n120_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n80_), .c(new_n64_), .O(new_n127_));
  oai21  g065(.a(new_n125_), .b(new_n75_), .c(new_n127_), .O(z10));
  nand2  g066(.a(x39), .b(x29), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n78_), .c(new_n87_), .O(new_n130_));
  nand2  g068(.a(new_n129_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g070(.a(new_n86_), .b(x27), .c(new_n64_), .O(new_n133_));
  nor2   g071(.a(x30), .b(x09), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n72_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n133_), .c(new_n132_), .O(z18));
  inv1   g075(.a(z18), .O(z11));
  nand2  g076(.a(new_n67_), .b(x27), .O(new_n139_));
  nand2  g077(.a(new_n68_), .b(new_n139_), .O(new_n140_));
  nand2  g078(.a(new_n72_), .b(new_n140_), .O(z12));
  nand2  g079(.a(new_n92_), .b(new_n94_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n72_), .c(new_n142_), .d(x20), .O(new_n144_));
  oai21  g082(.a(new_n76_), .b(new_n85_), .c(x28), .O(new_n145_));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(z08), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nand3  g087(.a(new_n146_), .b(z08), .c(new_n80_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z13));
  inv1   g089(.a(new_n145_), .O(new_n152_));
  nand2  g090(.a(new_n94_), .b(new_n85_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n143_), .c(x20), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n152_), .c(new_n75_), .O(new_n155_));
  nand4  g093(.a(new_n143_), .b(new_n142_), .c(x27), .d(x20), .O(new_n156_));
  inv1   g094(.a(x13), .O(new_n157_));
  nand3  g095(.a(x39), .b(new_n157_), .c(new_n64_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n156_), .c(new_n81_), .O(new_n159_));
  oai21  g097(.a(new_n155_), .b(new_n80_), .c(new_n159_), .O(z14));
  nand3  g098(.a(new_n116_), .b(new_n72_), .c(x12), .O(new_n161_));
  ...
  nor2   g105(.a(new_n75_), .b(new_n64_), .O(new_n168_));
  oai21  g106(.a(new_n129_), .b(new_n87_), .c(new_n134_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  oai21  g108(.a(new_n168_), .b(new_n89_), .c(new_n170_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n72_), .O(z19));
  nor2   g110(.a(new_n85_), .b(new_n75_), .O(new_n173_));
  nor3   g111(.a(new_n173_), .b(new_n135_), .c(new_n130_), .O(z20));
endmodule
