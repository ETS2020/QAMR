...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n159_, new_n161_, new_n163_, new_n165_, new_n166_, new_n170_,
    new_n171_;
  ...
  nand3  g035(.a(new_n95_), .b(x40), .c(new_n97_), .O(z04));
  inv1   g036(.a(new_n72_), .O(new_n99_));
  nand3  g037(.a(new_n94_), .b(new_n99_), .c(new_n93_), .O(z05));
  ...
  nand2  g056(.a(new_n82_), .b(new_n118_), .O(new_n119_));
  oai21  g057(.a(new_n92_), .b(x28), .c(new_n76_), .O(new_n120_));
  ...
  inv1   g072(.a(new_n78_), .O(new_n135_));
  nor2   g073(.a(new_n75_), .b(x04), .O(new_n136_));
  ...
  nor2   g083(.a(new_n87_), .b(x04), .O(new_n146_));
  oai21  g084(.a(new_n76_), .b(new_n92_), .c(x28), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(new_n148_));
  nand2  g086(.a(x35), .b(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n93_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n99_), .c(new_n150_), .d(x20), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand3  g092(.a(new_n82_), .b(new_n146_), .c(new_n145_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand3  g094(.a(new_n151_), .b(new_n150_), .c(x20), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n148_), .O(new_n158_));
  nand2  g096(.a(new_n155_), .b(new_n99_), .O(new_n159_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n163_), .c(new_n99_), .O(z17));
  nand3  g105(.a(new_n139_), .b(new_n134_), .c(new_n99_), .O(z18));
  inv1   g106(.a(z18), .O(z19));
  nand2  g107(.a(x35), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n80_), .c(new_n137_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n132_), .c(new_n99_), .O(z20));
endmodule
