...
module FAU ( 
  ...
  aoi21  g047(.a(new_n109_), .b(x14), .c(new_n72_), .O(z07));
  nand2  g048(.a(new_n85_), .b(new_n83_), .O(z08));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(new_n85_), .O(z09));
  inv1   g051(.a(new_n80_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n84_), .O(new_n115_));
  ...
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(new_n85_), .O(z10));
  inv1   g062(.a(x08), .O(new_n125_));
  nand2  g063(.a(new_n84_), .b(x29), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n87_), .c(new_n125_), .O(new_n127_));
  nand2  g065(.a(new_n126_), .b(x27), .O(new_n128_));
  inv1   g066(.a(x09), .O(new_n129_));
  inv1   g067(.a(x30), .O(new_n130_));
  nand4  g068(.a(x35), .b(new_n86_), .c(x27), .d(new_n65_), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n85_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  aoi21  g070(.a(new_n128_), .b(new_n127_), .c(new_n132_), .O(z11));
  nand2  g071(.a(new_n67_), .b(x27), .O(new_n134_));
  nand3  g072(.a(new_n85_), .b(new_n68_), .c(new_n134_), .O(new_n135_));
  ...
  nand3  g084(.a(new_n139_), .b(new_n114_), .c(new_n84_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n146_), .c(new_n73_), .O(z13));
  nand2  g086(.a(new_n139_), .b(new_n84_), .O(new_n149_));
  nand2  g087(.a(new_n143_), .b(x20), .O(new_n150_));
  nand3  g088(.a(new_n137_), .b(new_n80_), .c(x28), .O(new_n151_));
  ...
  aoi21  g092(.a(new_n86_), .b(x27), .c(new_n114_), .O(new_n155_));
  ...
  nand2  g096(.a(new_n158_), .b(new_n85_), .O(z15));
  ...
  oai21  g101(.a(new_n163_), .b(new_n160_), .c(new_n85_), .O(z17));
  nand2  g102(.a(new_n128_), .b(new_n127_), .O(new_n165_));
  inv1   g103(.a(new_n132_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(z18));
  nand2  g105(.a(x35), .b(x27), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n85_), .c(new_n130_), .d(new_n129_), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(new_n127_), .O(z20));
  aoi21  g108(.a(new_n128_), .b(new_n127_), .c(new_n132_), .O(z19));
endmodule
