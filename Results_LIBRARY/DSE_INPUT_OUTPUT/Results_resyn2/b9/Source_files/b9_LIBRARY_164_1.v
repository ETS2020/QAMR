...
module FAU ( 
  ...
  nand2  g008(.a(x18), .b(new_n70_), .O(new_n71_));
  ...
  aoi21  g030(.a(new_n92_), .b(x27), .c(new_n81_), .O(new_n93_));
  ...
  inv1   g064(.a(new_n86_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x29), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n77_), .c(new_n126_), .O(new_n129_));
  ...
  nand2  g082(.a(new_n92_), .b(new_n94_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(x20), .c(new_n144_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n143_), .c(new_n74_), .O(new_n147_));
  nand2  g085(.a(new_n142_), .b(new_n127_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(new_n79_), .O(new_n149_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n74_), .c(new_n79_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n151_), .c(x14), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n150_), .O(z13));
  oai21  g093(.a(new_n141_), .b(new_n80_), .c(new_n151_), .O(new_n156_));
  nand3  g094(.a(x20), .b(new_n144_), .c(new_n139_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  aoi21  g096(.a(new_n76_), .b(x27), .c(new_n80_), .O(new_n159_));
  oai22  g097(.a(new_n159_), .b(new_n148_), .c(new_n66_), .d(new_n74_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(new_n71_), .O(z14));
  inv1   g099(.a(x12), .O(new_n162_));
  oai21  g100(.a(new_n112_), .b(new_n162_), .c(new_n71_), .O(z15));
  ...
  nand4  g106(.a(new_n168_), .b(new_n71_), .c(new_n167_), .d(x23), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(z17));
  inv1   g108(.a(z11), .O(z18));
  and2   g109(.a(x35), .b(x27), .O(new_n172_));
  nor3   g110(.a(new_n172_), .b(new_n133_), .c(new_n129_), .O(z20));
  aoi21  g111(.a(new_n130_), .b(new_n129_), .c(new_n135_), .O(z19));
endmodule
