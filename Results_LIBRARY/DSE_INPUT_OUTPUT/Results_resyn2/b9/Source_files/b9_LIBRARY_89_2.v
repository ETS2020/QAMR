...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x04), .O(new_n64_));
  ...
  nand3  g015(.a(new_n77_), .b(new_n75_), .c(new_n66_), .O(new_n78_));
  ...
  aoi21  g020(.a(new_n82_), .b(new_n80_), .c(new_n68_), .O(new_n83_));
  nor2   g021(.a(x32), .b(x30), .O(new_n84_));
  nand2  g022(.a(new_n84_), .b(x40), .O(new_n85_));
  ...
  nor2   g027(.a(new_n89_), .b(new_n76_), .O(new_n90_));
  aoi21  g028(.a(new_n90_), .b(new_n88_), .c(new_n65_), .O(z02));
  nand3  g029(.a(x35), .b(x28), .c(x27), .O(new_n92_));
  oai21  g030(.a(new_n69_), .b(x27), .c(new_n92_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(x21), .c(new_n65_), .O(z03));
  inv1   g032(.a(x21), .O(new_n95_));
  nand3  g033(.a(new_n93_), .b(new_n64_), .c(new_n95_), .O(z04));
  aoi21  g034(.a(x28), .b(x27), .c(x37), .O(new_n97_));
  nor2   g035(.a(new_n97_), .b(new_n65_), .O(z05));
  and2   g036(.a(new_n97_), .b(new_n64_), .O(z06));
  ...
  nand2  g047(.a(new_n109_), .b(new_n64_), .O(z07));
  nand2  g048(.a(new_n76_), .b(new_n64_), .O(z08));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(new_n64_), .O(z09));
  aoi21  g051(.a(new_n82_), .b(new_n80_), .c(x04), .O(new_n114_));
  inv1   g052(.a(x05), .O(new_n115_));
  and2   g053(.a(x40), .b(x39), .O(new_n116_));
  aoi21  g054(.a(x40), .b(x39), .c(x07), .O(new_n117_));
  aoi21  g055(.a(new_n116_), .b(new_n115_), .c(new_n117_), .O(new_n118_));
  nand2  g056(.a(x37), .b(x06), .O(new_n119_));
  aoi21  g057(.a(new_n63_), .b(x04), .c(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n118_), .b(new_n114_), .c(new_n120_), .O(new_n121_));
  inv1   g059(.a(new_n84_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n77_), .c(x05), .O(new_n123_));
  oai21  g061(.a(new_n121_), .b(new_n68_), .c(new_n123_), .O(z10));
  oai21  g062(.a(new_n63_), .b(x27), .c(x04), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(x35), .c(new_n81_), .O(new_n126_));
  nand2  g064(.a(new_n116_), .b(x29), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  inv1   g066(.a(x04), .O(new_n129_));
  nand4  g067(.a(x35), .b(new_n81_), .c(x27), .d(new_n129_), .O(new_n130_));
  oai21  g068(.a(x30), .b(x09), .c(new_n64_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  aoi21  g070(.a(new_n128_), .b(x08), .c(new_n132_), .O(z11));
  nor3   g071(.a(x37), .b(x36), .c(x35), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n68_), .c(new_n73_), .O(new_n135_));
  inv1   g073(.a(new_n71_), .O(new_n136_));
  inv1   g074(.a(new_n77_), .O(new_n137_));
  oai21  g075(.a(new_n136_), .b(new_n65_), .c(new_n137_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  nand2  g078(.a(x36), .b(x35), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x28), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n77_), .c(new_n140_), .O(new_n143_));
  ...
  nand3  g086(.a(new_n122_), .b(new_n77_), .c(new_n140_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand2  g088(.a(new_n77_), .b(new_n140_), .O(new_n151_));
  aoi21  g089(.a(new_n81_), .b(x27), .c(new_n122_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n136_), .O(new_n153_));
  nand2  g091(.a(new_n145_), .b(x20), .O(new_n154_));
  nand3  g092(.a(new_n141_), .b(new_n84_), .c(x28), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n77_), .c(new_n140_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n154_), .c(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n153_), .O(z14));
  nand4  g096(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n64_), .O(z15));
  nand2  g098(.a(x22), .b(x01), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n65_), .c(x23), .O(z16));
  inv1   g100(.a(x24), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x23), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n161_), .c(new_n64_), .O(z17));
  nand3  g103(.a(new_n116_), .b(x29), .c(x08), .O(new_n166_));
  nor2   g104(.a(new_n87_), .b(new_n82_), .O(new_n167_));
  nand2  g105(.a(new_n125_), .b(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n166_), .c(new_n131_), .O(z18));
  nand2  g107(.a(new_n166_), .b(new_n131_), .O(new_n170_));
  inv1   g108(.a(x08), .O(new_n171_));
  oai21  g109(.a(x28), .b(new_n171_), .c(new_n68_), .O(new_n172_));
  and2   g110(.a(new_n64_), .b(x35), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(new_n170_), .O(z20));
  aoi21  g112(.a(new_n128_), .b(x08), .c(new_n132_), .O(z19));
endmodule
