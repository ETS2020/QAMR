...
module FAU ( 
  ...
  nand3  g23(.a(new_n37_), .b(x2), .c(new_n15_), .O(new_n38_));
  ...
  aoi21  g32(.a(new_n19_), .b(x1), .c(new_n37_), .O(new_n47_));
  nand3  g33(.a(new_n17_), .b(new_n37_), .c(new_n15_), .O(new_n48_));
  ...
  nand4  g67(.a(new_n81_), .b(new_n80_), .c(new_n37_), .d(new_n15_), .O(new_n82_));
  nand2  g68(.a(new_n82_), .b(new_n79_), .O(z3));
  nand4  g69(.a(new_n74_), .b(new_n31_), .c(x6), .d(new_n15_), .O(new_n84_));
  oai21  g70(.a(new_n16_), .b(new_n32_), .c(new_n84_), .O(z4));
endmodule
