...
module FAU ( 
  ...
  nand4  g56(.a(new_n70_), .b(new_n69_), .c(new_n31_), .d(new_n18_), .O(new_n71_));
  oai21  g57(.a(new_n40_), .b(x1), .c(x4), .O(new_n72_));
  nand3  g58(.a(new_n72_), .b(new_n69_), .c(new_n34_), .O(new_n73_));
  inv1   g59(.a(new_n69_), .O(new_n74_));
  aoi21  g60(.a(new_n31_), .b(new_n18_), .c(new_n21_), .O(new_n75_));
  nand2  g61(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand4  g62(.a(new_n76_), .b(new_n73_), .c(new_n71_), .d(new_n68_), .O(new_n77_));
  nand2  g63(.a(new_n77_), .b(new_n16_), .O(new_n78_));
  oai21  g64(.a(new_n37_), .b(new_n17_), .c(x7), .O(new_n79_));
  aoi21  g65(.a(new_n79_), .b(new_n36_), .c(new_n16_), .O(new_n80_));
  nor2   g66(.a(x4), .b(x1), .O(new_n81_));
  aoi21  g67(.a(new_n40_), .b(x5), .c(new_n74_), .O(new_n82_));
  oai21  g68(.a(new_n81_), .b(new_n80_), .c(new_n82_), .O(new_n83_));
  nand2  g69(.a(new_n55_), .b(new_n35_), .O(new_n84_));
  nand2  g70(.a(new_n84_), .b(new_n38_), .O(new_n85_));
  inv1   g71(.a(new_n85_), .O(new_n86_));
  nor3   g72(.a(new_n69_), .b(new_n16_), .c(x5), .O(new_n87_));
  aoi22  g73(.a(new_n87_), .b(new_n86_), .c(x5), .d(x0), .O(new_n88_));
  nand3  g74(.a(new_n88_), .b(new_n83_), .c(new_n78_), .O(z2));
  nand3  g75(.a(new_n55_), .b(new_n53_), .c(new_n35_), .O(new_n90_));
  nand3  g76(.a(new_n53_), .b(x7), .c(new_n37_), .O(new_n91_));
  nand4  g77(.a(new_n91_), .b(new_n90_), .c(new_n28_), .d(new_n15_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(x0), .O(new_n93_));
  inv1   g79(.a(x0), .O(new_n94_));
  nand2  g80(.a(new_n85_), .b(new_n53_), .O(new_n95_));
  nand4  g81(.a(new_n95_), .b(new_n28_), .c(new_n15_), .d(new_n94_), .O(new_n96_));
  inv1   g82(.a(new_n19_), .O(new_n97_));
  nor2   g83(.a(new_n22_), .b(x6), .O(new_n98_));
  oai21  g84(.a(new_n75_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand3  g85(.a(new_n99_), .b(new_n96_), .c(new_n93_), .O(z3));
  nand3  g86(.a(new_n95_), .b(new_n28_), .c(new_n94_), .O(new_n101_));
  nand2  g87(.a(new_n101_), .b(new_n15_), .O(z4));
endmodule
