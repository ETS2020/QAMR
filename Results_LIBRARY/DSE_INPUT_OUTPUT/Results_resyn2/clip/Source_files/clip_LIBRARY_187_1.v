...
module FAU ( 
  ...
  nand3  g30(.a(new_n44_), .b(new_n38_), .c(new_n30_), .O(z1));
  ...
  aoi22  g42(.a(new_n56_), .b(x4), .c(new_n40_), .d(new_n27_), .O(new_n57_));
  nand2  g43(.a(new_n57_), .b(x6), .O(new_n58_));
  nand2  g44(.a(new_n18_), .b(new_n27_), .O(new_n59_));
  ...
  nand3  g49(.a(new_n63_), .b(new_n55_), .c(new_n30_), .O(new_n64_));
  ...
  aoi21  g55(.a(new_n31_), .b(new_n18_), .c(new_n16_), .O(new_n70_));
  ...
  nand3  g65(.a(new_n40_), .b(new_n27_), .c(x1), .O(new_n80_));
  ...
  aoi21  g75(.a(new_n89_), .b(new_n88_), .c(new_n29_), .O(z4));
endmodule
