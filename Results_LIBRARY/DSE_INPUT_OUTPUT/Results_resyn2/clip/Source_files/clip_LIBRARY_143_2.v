...
module FAU ( 
  ...
  nand2  g37(.a(new_n28_), .b(new_n23_), .O(new_n52_));
  nand2  g38(.a(new_n27_), .b(x2), .O(new_n53_));
  nand4  g39(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n36_), .O(new_n54_));
  inv1   g40(.a(new_n52_), .O(new_n55_));
  nor2   g41(.a(x7), .b(x4), .O(new_n56_));
  aoi21  g42(.a(new_n51_), .b(new_n36_), .c(new_n56_), .O(new_n57_));
  nand2  g43(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  aoi21  g44(.a(x4), .b(x1), .c(x7), .O(new_n59_));
  oai21  g45(.a(new_n23_), .b(x4), .c(new_n28_), .O(new_n60_));
  nand2  g46(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g47(.a(new_n61_), .b(new_n58_), .c(new_n54_), .O(new_n62_));
  nand3  g48(.a(new_n62_), .b(new_n17_), .c(new_n45_), .O(new_n63_));
  aoi22  g49(.a(new_n18_), .b(x4), .c(new_n34_), .d(x1), .O(new_n64_));
  inv1   g50(.a(new_n64_), .O(new_n65_));
  nand2  g51(.a(new_n26_), .b(new_n17_), .O(new_n66_));
  nor2   g52(.a(new_n66_), .b(new_n45_), .O(new_n67_));
  nand4  g53(.a(new_n67_), .b(new_n65_), .c(new_n55_), .d(new_n20_), .O(new_n68_));
  nand2  g54(.a(new_n65_), .b(new_n20_), .O(new_n69_));
  inv1   g55(.a(new_n26_), .O(new_n70_));
  nor2   g56(.a(x4), .b(x1), .O(new_n71_));
  nor2   g57(.a(new_n71_), .b(x6), .O(new_n72_));
  aoi21  g58(.a(new_n70_), .b(new_n22_), .c(new_n72_), .O(new_n73_));
  nand4  g59(.a(new_n73_), .b(new_n69_), .c(new_n52_), .d(new_n17_), .O(new_n74_));
  nand3  g60(.a(new_n74_), .b(new_n68_), .c(new_n63_), .O(z2));
  inv1   g61(.a(x5), .O(new_n76_));
  oai21  g62(.a(new_n64_), .b(new_n19_), .c(new_n23_), .O(new_n77_));
  nand3  g63(.a(new_n77_), .b(new_n28_), .c(new_n76_), .O(new_n78_));
  oai21  g64(.a(x4), .b(x1), .c(x3), .O(new_n79_));
  nand2  g65(.a(new_n79_), .b(x8), .O(new_n80_));
  nand2  g66(.a(new_n24_), .b(x2), .O(new_n81_));
  nand2  g67(.a(x4), .b(x1), .O(new_n82_));
  nand2  g68(.a(new_n82_), .b(x7), .O(new_n83_));
  nand3  g69(.a(new_n83_), .b(new_n81_), .c(new_n80_), .O(new_n84_));
  nand3  g70(.a(new_n84_), .b(new_n23_), .c(x0), .O(new_n85_));
  nand2  g71(.a(new_n85_), .b(new_n78_), .O(new_n86_));
  nand2  g72(.a(new_n86_), .b(x6), .O(new_n87_));
  nand2  g73(.a(new_n71_), .b(new_n27_), .O(new_n88_));
  aoi21  g74(.a(new_n88_), .b(x5), .c(new_n15_), .O(new_n89_));
  nand2  g75(.a(new_n22_), .b(new_n27_), .O(new_n90_));
  nor2   g76(.a(new_n22_), .b(new_n27_), .O(new_n91_));
  oai21  g77(.a(new_n91_), .b(new_n57_), .c(new_n90_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(new_n15_), .O(new_n93_));
  aoi22  g79(.a(x8), .b(x3), .c(x7), .d(x4), .O(new_n94_));
  oai21  g80(.a(new_n59_), .b(new_n34_), .c(new_n94_), .O(new_n95_));
  aoi21  g81(.a(new_n79_), .b(new_n22_), .c(new_n15_), .O(new_n96_));
  aoi21  g82(.a(new_n96_), .b(new_n95_), .c(x6), .O(new_n97_));
  aoi21  g83(.a(new_n97_), .b(new_n93_), .c(new_n89_), .O(new_n98_));
  nand2  g84(.a(new_n98_), .b(new_n87_), .O(z3));
  aoi21  g85(.a(new_n77_), .b(new_n28_), .c(x0), .O(new_n100_));
  aoi21  g86(.a(new_n88_), .b(x6), .c(new_n15_), .O(new_n101_));
  aoi21  g87(.a(new_n101_), .b(new_n92_), .c(new_n66_), .O(new_n102_));
  oai21  g88(.a(new_n100_), .b(new_n45_), .c(new_n102_), .O(z4));
endmodule
