...
module FAU ( 
  ...
  nand3  g13(.a(new_n27_), .b(new_n26_), .c(new_n25_), .O(new_n28_));
  ...
  nand2  g18(.a(x6), .b(new_n32_), .O(new_n33_));
  inv1   g19(.a(x2), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x1), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n33_), .c(new_n31_), .d(new_n29_), .O(z0));
  nand2  g22(.a(new_n26_), .b(new_n24_), .O(new_n37_));
  nand3  g23(.a(new_n19_), .b(new_n15_), .c(x0), .O(new_n38_));
  aoi21  g24(.a(new_n38_), .b(new_n16_), .c(new_n34_), .O(new_n39_));
  aoi21  g25(.a(x6), .b(x0), .c(x2), .O(new_n40_));
  nor3   g26(.a(new_n40_), .b(new_n39_), .c(new_n30_), .O(new_n41_));
  nand3  g27(.a(new_n35_), .b(x6), .c(x0), .O(new_n42_));
  nand2  g28(.a(x2), .b(x1), .O(new_n43_));
  aoi22  g29(.a(new_n43_), .b(new_n16_), .c(new_n26_), .d(new_n24_), .O(new_n44_));
  nand2  g30(.a(new_n27_), .b(new_n22_), .O(new_n45_));
  and2   g31(.a(new_n45_), .b(new_n37_), .O(new_n46_));
  aoi22  g32(.a(new_n46_), .b(new_n21_), .c(new_n44_), .d(new_n42_), .O(new_n47_));
  oai21  g33(.a(new_n41_), .b(new_n37_), .c(new_n47_), .O(z1));
  oai22  g34(.a(new_n45_), .b(x1), .c(x6), .d(x5), .O(new_n49_));
  nand2  g35(.a(new_n49_), .b(new_n19_), .O(new_n50_));
  nand2  g36(.a(new_n35_), .b(x7), .O(new_n51_));
  xor2a  g37(.a(x8), .b(x3), .O(new_n52_));
  oai21  g38(.a(x7), .b(x2), .c(new_n22_), .O(new_n53_));
  nand3  g39(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  inv1   g40(.a(new_n52_), .O(new_n55_));
  nor2   g41(.a(new_n23_), .b(x4), .O(new_n56_));
  aoi22  g42(.a(new_n23_), .b(x4), .c(new_n34_), .d(x1), .O(new_n57_));
  ...
  nand2  g47(.a(new_n43_), .b(new_n26_), .O(new_n62_));
  ...
  nor2   g52(.a(x6), .b(new_n32_), .O(new_n67_));
  inv1   g53(.a(new_n19_), .O(new_n68_));
  aoi21  g54(.a(new_n63_), .b(new_n27_), .c(new_n68_), .O(new_n69_));
  nand2  g55(.a(new_n69_), .b(x5), .O(new_n70_));
  nand2  g56(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  oai21  g57(.a(new_n69_), .b(x6), .c(new_n32_), .O(new_n72_));
  ...
  nand2  g65(.a(new_n79_), .b(new_n33_), .O(z4));
endmodule
