...
module FAU ( 
  ...
  nand3  g31(.a(new_n45_), .b(new_n43_), .c(new_n34_), .O(z1));
  ...
  nand4  g42(.a(new_n56_), .b(new_n34_), .c(new_n23_), .d(new_n16_), .O(new_n57_));
  ...
  aoi21  g54(.a(new_n68_), .b(new_n66_), .c(new_n33_), .O(new_n69_));
  nand2  g55(.a(new_n35_), .b(new_n17_), .O(new_n70_));
