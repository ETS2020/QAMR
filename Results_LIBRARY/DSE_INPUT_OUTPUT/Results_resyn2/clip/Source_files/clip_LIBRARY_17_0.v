...
module FAU ( 
  ...
  nand2  g20(.a(new_n29_), .b(x4), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n34_), .c(new_n32_), .O(new_n36_));
  inv1   g22(.a(x3), .O(new_n37_));
  nand2  g23(.a(x8), .b(new_n37_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n36_), .c(x6), .d(new_n27_), .O(new_n39_));
  nand2  g25(.a(new_n28_), .b(new_n21_), .O(new_n40_));
  ...
  nand2  g30(.a(new_n29_), .b(new_n44_), .O(new_n45_));
  ...
  nand2  g38(.a(new_n38_), .b(new_n28_), .O(new_n53_));
  nand2  g39(.a(new_n41_), .b(new_n48_), .O(new_n54_));
  nor2   g40(.a(new_n33_), .b(x3), .O(new_n55_));
  nor2   g41(.a(new_n55_), .b(new_n30_), .O(new_n56_));
  oai21  g42(.a(new_n48_), .b(new_n28_), .c(x1), .O(new_n57_));
  nand2  g43(.a(new_n57_), .b(new_n34_), .O(new_n58_));
  oai21  g44(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(new_n59_));
  aoi22  g45(.a(new_n59_), .b(new_n47_), .c(new_n53_), .d(new_n52_), .O(new_n60_));
  nand3  g46(.a(new_n20_), .b(new_n18_), .c(new_n15_), .O(new_n61_));
  inv1   g47(.a(new_n35_), .O(new_n62_));
  nand2  g48(.a(new_n50_), .b(new_n49_), .O(new_n63_));
  oai21  g49(.a(new_n62_), .b(new_n30_), .c(new_n63_), .O(new_n64_));
  nand3  g50(.a(new_n64_), .b(new_n61_), .c(new_n51_), .O(new_n65_));
  nand2  g51(.a(new_n65_), .b(x0), .O(new_n66_));
  oai21  g52(.a(new_n60_), .b(new_n15_), .c(new_n66_), .O(z1));
  oai21  g53(.a(new_n33_), .b(x1), .c(x4), .O(new_n68_));
  xnor2a g54(.a(x8), .b(x3), .O(new_n69_));
  inv1   g55(.a(new_n69_), .O(new_n70_));
  nand3  g56(.a(new_n70_), .b(new_n68_), .c(new_n29_), .O(new_n71_));
  nand3  g57(.a(new_n33_), .b(x3), .c(new_n21_), .O(new_n72_));
  nand2  g58(.a(new_n72_), .b(x2), .O(new_n73_));
  nand3  g59(.a(new_n73_), .b(new_n70_), .c(new_n22_), .O(new_n74_));
  nand2  g60(.a(new_n41_), .b(new_n22_), .O(new_n75_));
  nand3  g61(.a(new_n75_), .b(new_n69_), .c(new_n45_), .O(new_n76_));
  nand3  g62(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(new_n77_));
  nand2  g63(.a(new_n28_), .b(x1), .O(new_n78_));
  aoi21  g64(.a(new_n78_), .b(new_n35_), .c(new_n30_), .O(new_n79_));
  ...
  nand2  g69(.a(new_n78_), .b(new_n35_), .O(new_n84_));
  nand2  g70(.a(new_n84_), .b(new_n31_), .O(new_n85_));
  nand2  g71(.a(new_n85_), .b(new_n69_), .O(new_n86_));
  aoi21  g72(.a(new_n79_), .b(new_n70_), .c(new_n48_), .O(new_n87_));
  nand2  g73(.a(new_n75_), .b(new_n45_), .O(new_n88_));
  oai21  g74(.a(new_n19_), .b(new_n15_), .c(new_n48_), .O(new_n89_));
  aoi21  g75(.a(new_n88_), .b(new_n19_), .c(new_n89_), .O(new_n90_));
  aoi21  g76(.a(new_n87_), .b(new_n86_), .c(new_n90_), .O(new_n91_));
  oai22  g77(.a(new_n91_), .b(new_n27_), .c(new_n83_), .d(new_n15_), .O(z2));
  nand2  g78(.a(new_n88_), .b(new_n16_), .O(new_n93_));
  nand2  g79(.a(new_n93_), .b(new_n20_), .O(new_n94_));
  inv1   g80(.a(new_n94_), .O(new_n95_));
  nand2  g81(.a(new_n95_), .b(new_n27_), .O(new_n96_));
  aoi21  g82(.a(new_n94_), .b(x0), .c(new_n15_), .O(new_n97_));
  nand3  g83(.a(new_n38_), .b(x6), .c(x0), .O(new_n98_));
  aoi21  g84(.a(new_n85_), .b(new_n34_), .c(new_n98_), .O(new_n99_));
  aoi21  g85(.a(new_n97_), .b(new_n96_), .c(new_n99_), .O(z3));
  oai21  g86(.a(new_n95_), .b(new_n15_), .c(x0), .O(z4));
endmodule
