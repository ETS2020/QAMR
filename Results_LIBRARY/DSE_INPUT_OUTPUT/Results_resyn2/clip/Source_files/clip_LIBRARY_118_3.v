...
module FAU ( 
  ...
  and2   g76(.a(new_n37_), .b(new_n29_), .O(new_n91_));
  nand2  g77(.a(new_n78_), .b(new_n91_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(new_n32_), .O(new_n93_));
  nand3  g79(.a(new_n93_), .b(x6), .c(x0), .O(new_n94_));
  inv1   g80(.a(new_n32_), .O(new_n95_));
  aoi21  g81(.a(new_n78_), .b(new_n91_), .c(new_n95_), .O(new_n96_));
  oai21  g82(.a(new_n96_), .b(new_n46_), .c(new_n45_), .O(new_n97_));
  nand3  g83(.a(new_n97_), .b(new_n94_), .c(new_n15_), .O(new_n98_));
  nand2  g84(.a(new_n83_), .b(new_n16_), .O(new_n99_));
  nand3  g85(.a(new_n99_), .b(new_n20_), .c(new_n45_), .O(new_n100_));
  nand2  g86(.a(new_n100_), .b(new_n98_), .O(z3));
  nand2  g87(.a(new_n93_), .b(x6), .O(new_n102_));
