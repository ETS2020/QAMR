...
module FAU ( 
  ...
  nor2   g31(.a(new_n45_), .b(new_n29_), .O(new_n46_));
  oai22  g32(.a(new_n46_), .b(new_n20_), .c(new_n29_), .d(new_n43_), .O(new_n47_));
  ...
  nand3  g74(.a(new_n82_), .b(new_n27_), .c(new_n24_), .O(new_n89_));
  nand2  g75(.a(new_n89_), .b(new_n21_), .O(new_n90_));
  nand3  g76(.a(new_n90_), .b(x5), .c(x0), .O(new_n91_));
  nand3  g77(.a(new_n89_), .b(new_n21_), .c(new_n43_), .O(new_n92_));
  nand3  g78(.a(new_n92_), .b(new_n91_), .c(new_n29_), .O(new_n93_));
  nand2  g79(.a(new_n71_), .b(new_n55_), .O(new_n94_));
  aoi21  g80(.a(new_n94_), .b(new_n40_), .c(new_n45_), .O(new_n95_));
  nand4  g81(.a(new_n95_), .b(x6), .c(new_n15_), .d(new_n43_), .O(new_n96_));
  nand2  g82(.a(new_n96_), .b(new_n93_), .O(z3));
  oai21  g83(.a(new_n90_), .b(x6), .c(x0), .O(new_n98_));
  nand2  g84(.a(new_n98_), .b(x5), .O(new_n99_));
  oai21  g85(.a(new_n95_), .b(x0), .c(x6), .O(new_n100_));
