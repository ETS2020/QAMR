...
module FAU ( 
  ...
  nand3  g51(.a(new_n65_), .b(new_n22_), .c(new_n40_), .O(new_n66_));
  nand2  g52(.a(new_n25_), .b(x1), .O(new_n67_));
  aoi21  g53(.a(new_n67_), .b(new_n29_), .c(new_n44_), .O(new_n68_));
  aoi21  g54(.a(new_n21_), .b(x0), .c(new_n40_), .O(new_n69_));
  nand4  g55(.a(new_n69_), .b(new_n68_), .c(new_n55_), .d(new_n16_), .O(new_n70_));
  nand2  g56(.a(new_n67_), .b(new_n29_), .O(new_n71_));
  nand2  g57(.a(new_n71_), .b(new_n33_), .O(new_n72_));
  inv1   g58(.a(new_n16_), .O(new_n73_));
  aoi21  g59(.a(new_n32_), .b(new_n24_), .c(x6), .O(new_n74_));
  aoi21  g60(.a(new_n73_), .b(new_n17_), .c(new_n74_), .O(new_n75_));
  nand4  g61(.a(new_n75_), .b(new_n72_), .c(new_n53_), .d(new_n22_), .O(new_n76_));
  nand3  g62(.a(new_n76_), .b(new_n70_), .c(new_n66_), .O(z2));
  nor2   g63(.a(x8), .b(new_n51_), .O(new_n78_));
  nor2   g64(.a(new_n18_), .b(new_n40_), .O(new_n79_));
  oai21  g65(.a(new_n68_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nor2   g66(.a(x7), .b(x4), .O(new_n81_));
  nand2  g67(.a(x8), .b(x3), .O(new_n82_));
  oai21  g68(.a(new_n62_), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  oai21  g69(.a(x8), .b(x3), .c(new_n40_), .O(new_n84_));
  inv1   g70(.a(new_n84_), .O(new_n85_));
  aoi21  g71(.a(new_n85_), .b(new_n83_), .c(x0), .O(new_n86_));
  nand2  g72(.a(new_n86_), .b(new_n80_), .O(new_n87_));
  aoi21  g73(.a(new_n82_), .b(new_n59_), .c(new_n84_), .O(new_n88_));
  oai21  g74(.a(new_n88_), .b(new_n21_), .c(x0), .O(new_n89_));
  nand2  g75(.a(new_n72_), .b(new_n30_), .O(new_n90_));
  nand2  g76(.a(new_n85_), .b(new_n83_), .O(new_n91_));
  nand4  g77(.a(new_n91_), .b(new_n79_), .c(new_n90_), .d(x5), .O(new_n92_));
  nand3  g78(.a(new_n92_), .b(new_n89_), .c(new_n87_), .O(new_n93_));
  inv1   g79(.a(new_n93_), .O(z3));
  nand2  g80(.a(new_n80_), .b(new_n21_), .O(new_n95_));
  and2   g81(.a(new_n95_), .b(new_n89_), .O(z4));
endmodule
