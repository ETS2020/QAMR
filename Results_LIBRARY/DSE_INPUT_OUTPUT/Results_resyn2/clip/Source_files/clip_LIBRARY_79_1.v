...
module FAU ( 
  ...
  oai21  g42(.a(new_n56_), .b(new_n52_), .c(new_n23_), .O(new_n57_));
  nor2   g43(.a(new_n17_), .b(x4), .O(new_n58_));
  aoi22  g44(.a(new_n17_), .b(x4), .c(new_n34_), .d(x1), .O(new_n59_));
  oai21  g45(.a(new_n59_), .b(new_n58_), .c(new_n49_), .O(new_n60_));
  inv1   g46(.a(x4), .O(new_n61_));
  oai21  g47(.a(x7), .b(new_n61_), .c(x2), .O(new_n62_));
  nand2  g48(.a(new_n18_), .b(x7), .O(new_n63_));
  nand3  g49(.a(new_n63_), .b(new_n62_), .c(new_n50_), .O(new_n64_));
  nand3  g50(.a(new_n64_), .b(new_n60_), .c(x6), .O(new_n65_));
  aoi21  g51(.a(new_n50_), .b(new_n20_), .c(new_n31_), .O(new_n66_));
  nand3  g52(.a(new_n66_), .b(new_n65_), .c(new_n57_), .O(z2));
  inv1   g53(.a(new_n31_), .O(new_n68_));
  oai21  g54(.a(new_n54_), .b(new_n16_), .c(new_n26_), .O(new_n69_));
  inv1   g55(.a(x0), .O(new_n70_));
  nor2   g56(.a(new_n27_), .b(new_n70_), .O(new_n71_));
  inv1   g57(.a(new_n71_), .O(new_n72_));
  aoi21  g58(.a(new_n69_), .b(new_n70_), .c(x6), .O(new_n73_));
  oai21  g59(.a(new_n72_), .b(new_n69_), .c(new_n73_), .O(new_n74_));
  nand2  g60(.a(x8), .b(new_n24_), .O(new_n75_));
  nand2  g61(.a(new_n25_), .b(x3), .O(new_n76_));
  oai21  g62(.a(new_n59_), .b(new_n58_), .c(new_n76_), .O(new_n77_));
  nor2   g63(.a(x5), .b(x0), .O(new_n78_));
  nand3  g64(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(new_n79_));
  inv1   g65(.a(new_n79_), .O(new_n80_));
  aoi21  g66(.a(new_n77_), .b(new_n75_), .c(new_n70_), .O(new_n81_));
  oai21  g67(.a(new_n81_), .b(new_n80_), .c(x6), .O(new_n82_));
  nand3  g68(.a(new_n82_), .b(new_n74_), .c(new_n68_), .O(z3));
  oai21  g69(.a(new_n80_), .b(new_n71_), .c(x6), .O(new_n84_));
  nand2  g70(.a(new_n71_), .b(new_n69_), .O(new_n85_));
