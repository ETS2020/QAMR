...
module FAU ( 
  ...
  aoi21  g17(.a(new_n30_), .b(new_n28_), .c(new_n31_), .O(new_n32_));
  oai21  g18(.a(new_n27_), .b(new_n23_), .c(new_n32_), .O(z0));
  xor2a  g19(.a(x6), .b(x2), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x1), .O(new_n35_));
  nand2  g21(.a(new_n17_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n25_), .b(new_n36_), .O(new_n37_));
  and2   g23(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  inv1   g24(.a(new_n31_), .O(new_n39_));
  oai21  g25(.a(new_n37_), .b(new_n35_), .c(new_n39_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n38_), .c(new_n23_), .O(z1));
  nand3  g27(.a(new_n22_), .b(new_n15_), .c(x0), .O(new_n42_));
  inv1   g28(.a(new_n35_), .O(new_n43_));
  ...
  aoi22  g41(.a(new_n55_), .b(x4), .c(new_n17_), .d(new_n29_), .O(new_n56_));
  nand2  g42(.a(new_n56_), .b(x6), .O(new_n57_));
  nand2  g43(.a(new_n25_), .b(new_n29_), .O(new_n58_));
  nand2  g44(.a(new_n58_), .b(new_n36_), .O(new_n59_));
  ...
  nand3  g48(.a(new_n62_), .b(new_n54_), .c(new_n39_), .O(new_n63_));
  nand2  g49(.a(new_n63_), .b(new_n42_), .O(z2));
  nand3  g50(.a(new_n58_), .b(new_n36_), .c(x8), .O(new_n65_));
  ...
  nand2  g54(.a(new_n28_), .b(new_n25_), .O(new_n69_));
  aoi21  g55(.a(new_n69_), .b(new_n36_), .c(x8), .O(new_n70_));
  ...
  inv1   g65(.a(x0), .O(new_n80_));
  nand3  g66(.a(new_n17_), .b(new_n29_), .c(x1), .O(new_n81_));
  nand2  g67(.a(new_n81_), .b(new_n16_), .O(new_n82_));
  nand3  g68(.a(new_n82_), .b(new_n55_), .c(new_n51_), .O(new_n83_));
  aoi21  g69(.a(new_n83_), .b(new_n49_), .c(new_n20_), .O(new_n84_));
  nand2  g70(.a(new_n69_), .b(new_n36_), .O(new_n85_));
  aoi21  g71(.a(new_n85_), .b(new_n18_), .c(new_n21_), .O(new_n86_));
  oai21  g72(.a(new_n86_), .b(new_n84_), .c(new_n80_), .O(new_n87_));
  nand3  g73(.a(new_n87_), .b(new_n79_), .c(new_n77_), .O(z3));
  nand2  g74(.a(new_n84_), .b(new_n80_), .O(new_n89_));
  aoi22  g75(.a(new_n89_), .b(new_n15_), .c(new_n86_), .d(x0), .O(z4));
endmodule
