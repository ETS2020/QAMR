...
module FAU ( 
  ...
  inv1   g61(.a(new_n68_), .O(new_n76_));
  ...
  inv1   g70(.a(new_n25_), .O(new_n85_));
  nand3  g71(.a(new_n22_), .b(new_n18_), .c(x1), .O(new_n86_));
  nand2  g72(.a(new_n86_), .b(new_n27_), .O(new_n87_));
  aoi21  g73(.a(new_n87_), .b(new_n79_), .c(new_n85_), .O(new_n88_));
  oai21  g74(.a(new_n24_), .b(new_n51_), .c(new_n72_), .O(new_n89_));
  aoi21  g75(.a(new_n24_), .b(new_n51_), .c(x6), .O(new_n90_));
  nand2  g76(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g77(.a(new_n88_), .b(x5), .c(new_n91_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(new_n78_), .O(new_n93_));
  oai21  g79(.a(new_n69_), .b(new_n31_), .c(new_n25_), .O(new_n94_));
  nand2  g80(.a(new_n94_), .b(x6), .O(new_n95_));
  aoi21  g81(.a(new_n90_), .b(new_n89_), .c(new_n78_), .O(new_n96_));
  aoi21  g82(.a(new_n96_), .b(new_n95_), .c(new_n15_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(new_n93_), .O(z3));
  nand2  g84(.a(new_n91_), .b(x5), .O(new_n99_));
  aoi22  g85(.a(new_n99_), .b(x0), .c(new_n95_), .d(new_n29_), .O(z4));
endmodule
