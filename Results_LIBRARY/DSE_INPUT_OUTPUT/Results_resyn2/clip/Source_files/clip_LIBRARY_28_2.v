...
module FAU ( 
  ...
  nor2   g15(.a(new_n27_), .b(x3), .O(new_n30_));
  ...
  nor2   g38(.a(x8), .b(new_n52_), .O(new_n53_));
  ...
  oai22  g42(.a(new_n56_), .b(new_n54_), .c(new_n30_), .d(new_n53_), .O(new_n57_));
  xnor2a g43(.a(x8), .b(x3), .O(new_n58_));
  nand2  g44(.a(new_n25_), .b(new_n22_), .O(new_n59_));
  nand2  g45(.a(x7), .b(x4), .O(new_n60_));
  nand2  g46(.a(new_n60_), .b(new_n17_), .O(new_n61_));
  nand2  g47(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  aoi21  g48(.a(new_n62_), .b(new_n58_), .c(x6), .O(new_n63_));
  nand3  g49(.a(new_n30_), .b(new_n22_), .c(new_n18_), .O(new_n64_));
  inv1   g50(.a(new_n64_), .O(new_n65_));
  aoi21  g51(.a(new_n63_), .b(new_n57_), .c(new_n65_), .O(new_n66_));
  nand2  g52(.a(new_n19_), .b(x1), .O(new_n67_));
  nand2  g53(.a(new_n67_), .b(new_n26_), .O(new_n68_));
  nand2  g54(.a(new_n68_), .b(new_n23_), .O(new_n69_));
  xnor2a g55(.a(new_n69_), .b(new_n58_), .O(new_n70_));
  nand2  g56(.a(new_n33_), .b(new_n31_), .O(new_n71_));
  nand2  g57(.a(new_n71_), .b(x6), .O(new_n72_));
  oai22  g58(.a(new_n72_), .b(new_n70_), .c(new_n66_), .d(x0), .O(z2));
  nand2  g59(.a(new_n69_), .b(new_n28_), .O(new_n74_));
  nand2  g60(.a(new_n32_), .b(new_n37_), .O(new_n75_));
  nand3  g61(.a(new_n75_), .b(new_n74_), .c(new_n31_), .O(new_n76_));
  aoi21  g62(.a(new_n68_), .b(new_n23_), .c(new_n53_), .O(new_n77_));
  oai21  g63(.a(new_n77_), .b(new_n30_), .c(new_n37_), .O(new_n78_));
  nand3  g64(.a(new_n78_), .b(new_n76_), .c(x6), .O(new_n79_));
  oai21  g65(.a(new_n27_), .b(new_n52_), .c(new_n62_), .O(new_n80_));
  nand2  g66(.a(new_n27_), .b(new_n52_), .O(new_n81_));
  nand4  g67(.a(new_n81_), .b(new_n80_), .c(new_n15_), .d(new_n37_), .O(new_n82_));
  nand2  g68(.a(new_n82_), .b(new_n79_), .O(z3));
  nand4  g69(.a(new_n74_), .b(new_n31_), .c(x6), .d(new_n37_), .O(new_n84_));
  nand3  g70(.a(new_n84_), .b(new_n16_), .c(new_n32_), .O(z4));
endmodule
