...
module FAU ( 
  ...
  nand2  g59(.a(new_n42_), .b(new_n22_), .O(new_n74_));
  nand3  g60(.a(new_n74_), .b(new_n68_), .c(new_n49_), .O(new_n75_));
  ...
  nand2  g68(.a(new_n74_), .b(new_n49_), .O(new_n83_));
  oai21  g69(.a(new_n19_), .b(x0), .c(new_n46_), .O(new_n84_));
  aoi21  g70(.a(new_n83_), .b(new_n19_), .c(new_n84_), .O(new_n85_));
  nand3  g71(.a(new_n78_), .b(new_n69_), .c(new_n29_), .O(new_n86_));
  nand2  g72(.a(new_n78_), .b(new_n29_), .O(new_n87_));
  aoi21  g73(.a(new_n87_), .b(new_n68_), .c(new_n46_), .O(new_n88_));
  aoi21  g74(.a(new_n88_), .b(new_n86_), .c(new_n85_), .O(new_n89_));
  oai22  g75(.a(new_n89_), .b(x5), .c(new_n82_), .d(x0), .O(z2));
  aoi22  g76(.a(new_n33_), .b(x4), .c(new_n27_), .d(x1), .O(new_n91_));
  oai21  g77(.a(new_n91_), .b(new_n55_), .c(new_n32_), .O(new_n92_));
  nand2  g78(.a(new_n92_), .b(x6), .O(new_n93_));
  xor2a  g79(.a(new_n93_), .b(x0), .O(new_n94_));
  nand2  g80(.a(new_n83_), .b(new_n16_), .O(new_n95_));
  nand3  g81(.a(new_n95_), .b(new_n20_), .c(new_n45_), .O(new_n96_));
  oai21  g82(.a(new_n94_), .b(x5), .c(new_n96_), .O(z3));
  oai21  g83(.a(new_n93_), .b(x0), .c(new_n15_), .O(z4));
endmodule
