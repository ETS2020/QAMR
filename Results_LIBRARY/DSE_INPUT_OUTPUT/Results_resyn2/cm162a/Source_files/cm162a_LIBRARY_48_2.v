...
module FAU ( 
  ...
  aoi21  g14(.a(x05), .b(x03), .c(new_n33_), .O(new_n34_));
  ...
  nand3  g19(.a(new_n38_), .b(new_n36_), .c(x05), .O(new_n39_));
  inv1   g20(.a(new_n39_), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(new_n35_), .c(new_n34_), .O(z1));
  nand2  g22(.a(new_n30_), .b(new_n33_), .O(new_n42_));
  ...
  aoi21  g27(.a(x06), .b(new_n29_), .c(new_n30_), .O(new_n47_));
  ...
  oai21  g38(.a(new_n55_), .b(new_n29_), .c(new_n57_), .O(z3));
  nand3  g39(.a(x13), .b(x09), .c(x04), .O(new_n59_));
  aoi21  g40(.a(new_n30_), .b(x01), .c(new_n59_), .O(z4));
endmodule
