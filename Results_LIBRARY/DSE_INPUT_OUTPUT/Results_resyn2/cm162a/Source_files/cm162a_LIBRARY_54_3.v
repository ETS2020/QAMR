...
module FAU ( 
  ...
  aoi21  g06(.a(new_n25_), .b(x00), .c(x13), .O(new_n26_));
  ...
  aoi21  g13(.a(new_n25_), .b(x01), .c(x13), .O(new_n33_));
  ...
  aoi21  g29(.a(x07), .b(new_n25_), .c(x13), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(x05), .O(z3));
  nand4  g32(.a(x13), .b(x09), .c(new_n39_), .d(x04), .O(new_n52_));
