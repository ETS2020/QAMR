...
module FAU ( 
  ...
  oai21  g16(.a(x10), .b(x08), .c(new_n32_), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n35_), .c(new_n31_), .O(new_n37_));
  aoi22  g18(.a(new_n37_), .b(new_n34_), .c(new_n31_), .d(x01), .O(z1));
  ...
  oai21  g24(.a(new_n43_), .b(new_n42_), .c(new_n35_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n41_), .O(new_n45_));
  inv1   g26(.a(x10), .O(new_n46_));
  nand3  g27(.a(x11), .b(new_n46_), .c(new_n20_), .O(new_n47_));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n35_), .c(x12), .O(new_n56_));
  ...
  oai22  g43(.a(new_n32_), .b(new_n62_), .c(x05), .d(new_n39_), .O(z4));
endmodule
