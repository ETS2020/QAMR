...
module FAU ( 
  ...
  nand3  g12(.a(new_n31_), .b(new_n21_), .c(x05), .O(new_n32_));
  aoi21  g13(.a(new_n32_), .b(new_n24_), .c(new_n22_), .O(new_n33_));
  oai21  g14(.a(new_n22_), .b(x08), .c(x05), .O(new_n34_));
  aoi21  g15(.a(new_n34_), .b(new_n24_), .c(new_n31_), .O(new_n35_));
  oai21  g16(.a(new_n35_), .b(new_n33_), .c(x03), .O(new_n36_));
  inv1   g17(.a(x01), .O(new_n37_));
  nor2   g18(.a(new_n28_), .b(x03), .O(new_n38_));
  inv1   g19(.a(x09), .O(new_n39_));
  nor2   g20(.a(new_n39_), .b(x05), .O(new_n40_));
  aoi21  g21(.a(new_n38_), .b(new_n37_), .c(new_n40_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n36_), .O(z1));
  inv1   g23(.a(x11), .O(new_n43_));
  nand4  g24(.a(new_n31_), .b(new_n21_), .c(x04), .d(x02), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(x05), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n24_), .c(new_n43_), .O(new_n46_));
  nand2  g27(.a(new_n32_), .b(new_n24_), .O(new_n47_));
  nand2  g28(.a(new_n24_), .b(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n47_), .c(new_n23_), .O(new_n49_));
  inv1   g30(.a(new_n49_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n46_), .c(x03), .O(new_n51_));
  inv1   g32(.a(x06), .O(new_n52_));
  aoi21  g33(.a(new_n38_), .b(new_n52_), .c(new_n40_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand2  g36(.a(new_n49_), .b(new_n55_), .O(new_n56_));
  oai21  g37(.a(new_n44_), .b(x11), .c(x05), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n24_), .c(x12), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n56_), .c(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n38_), .b(new_n60_), .c(new_n40_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n24_), .b(new_n63_), .c(x09), .d(x05), .O(z4));
endmodule
