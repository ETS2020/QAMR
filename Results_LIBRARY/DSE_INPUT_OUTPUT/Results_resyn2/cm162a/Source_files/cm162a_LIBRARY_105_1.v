...
module FAU ( 
  ...
  nor2   g19(.a(x10), .b(x05), .O(new_n39_));
  nor2   g20(.a(new_n28_), .b(x03), .O(new_n40_));
  ...
  nand3  g28(.a(new_n31_), .b(new_n22_), .c(new_n21_), .O(new_n48_));
  aoi22  g29(.a(new_n48_), .b(x11), .c(new_n47_), .d(new_n22_), .O(new_n49_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n33_), .c(new_n24_), .O(new_n55_));
  nor3   g36(.a(x11), .b(x10), .c(x08), .O(new_n56_));
  nand2  g37(.a(x12), .b(x05), .O(new_n57_));
  aoi21  g38(.a(new_n56_), .b(new_n22_), .c(new_n57_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n55_), .c(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n40_), .b(new_n60_), .c(new_n39_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n21_), .b(new_n63_), .c(new_n44_), .d(x05), .O(z4));
endmodule
