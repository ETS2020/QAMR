...
module FAU ( 
  ...
  aoi21  g12(.a(x05), .b(x03), .c(new_n31_), .O(new_n32_));
  oai21  g13(.a(new_n22_), .b(x08), .c(x10), .O(new_n33_));
  inv1   g14(.a(new_n24_), .O(new_n34_));
  nand2  g15(.a(new_n23_), .b(new_n34_), .O(new_n35_));
  inv1   g16(.a(x10), .O(new_n36_));
  nand3  g17(.a(new_n23_), .b(new_n36_), .c(new_n21_), .O(new_n37_));
  nand4  g18(.a(new_n37_), .b(new_n35_), .c(x05), .d(x03), .O(new_n38_));
  inv1   g19(.a(new_n38_), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(new_n33_), .c(new_n32_), .O(z1));
  inv1   g21(.a(x11), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n36_), .c(new_n21_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n24_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n23_), .O(new_n44_));
  inv1   g25(.a(new_n44_), .O(new_n45_));
  inv1   g26(.a(new_n37_), .O(new_n46_));
  ...
  nand4  g33(.a(new_n24_), .b(x12), .c(x04), .d(x02), .O(new_n53_));
  ...
  nand2  g38(.a(new_n28_), .b(new_n31_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n57_), .O(z3));
  nand2  g40(.a(new_n34_), .b(x04), .O(new_n60_));
  aoi21  g41(.a(new_n28_), .b(x01), .c(new_n60_), .O(z4));
endmodule
