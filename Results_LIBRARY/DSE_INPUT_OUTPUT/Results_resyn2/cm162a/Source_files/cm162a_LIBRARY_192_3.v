...
module FAU ( 
  ...
  aoi21  g12(.a(new_n22_), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  nand2  g13(.a(new_n31_), .b(new_n30_), .O(new_n33_));
  ...
  nand4  g19(.a(new_n38_), .b(new_n35_), .c(new_n27_), .d(x05), .O(z1));
  inv1   g20(.a(new_n20_), .O(new_n40_));
  nor3   g21(.a(x11), .b(x10), .c(x08), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n40_), .c(new_n22_), .O(new_n42_));
  oai21  g23(.a(new_n33_), .b(new_n23_), .c(x11), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n42_), .c(x03), .O(new_n44_));
  aoi21  g25(.a(x06), .b(new_n37_), .c(x07), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x05), .O(z2));
  inv1   g28(.a(x12), .O(new_n48_));
  nand2  g29(.a(new_n42_), .b(new_n48_), .O(new_n49_));
  nand4  g30(.a(new_n41_), .b(new_n22_), .c(new_n20_), .d(x12), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n49_), .c(new_n37_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(x07), .c(x05), .O(z3));
  nand2  g33(.a(new_n40_), .b(x04), .O(new_n53_));
  aoi21  g34(.a(x07), .b(x05), .c(new_n53_), .O(z4));
endmodule
