...
module FAU ( 
  ...
  oai21  g18(.a(x09), .b(new_n20_), .c(x05), .O(new_n38_));
  ...
  oai21  g25(.a(new_n24_), .b(x10), .c(x11), .O(new_n45_));
  nand3  g26(.a(x13), .b(x04), .c(x02), .O(new_n46_));
  inv1   g27(.a(new_n46_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(x11), .c(x08), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n45_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n44_), .c(x03), .O(new_n50_));
  nor2   g31(.a(x06), .b(x03), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(new_n38_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  nand3  g34(.a(new_n20_), .b(x04), .c(x02), .O(new_n54_));
  nand2  g35(.a(new_n42_), .b(new_n41_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(x12), .O(new_n56_));
  inv1   g37(.a(x12), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n42_), .c(new_n41_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n33_), .O(new_n59_));
  inv1   g40(.a(x02), .O(new_n60_));
  oai21  g41(.a(x08), .b(new_n60_), .c(new_n57_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  nand2  g43(.a(new_n47_), .b(x08), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n62_), .c(new_n56_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(x03), .O(new_n65_));
  nor2   g46(.a(x07), .b(x03), .O(new_n66_));
  nor2   g47(.a(new_n66_), .b(new_n38_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n65_), .O(z3));
  nand3  g49(.a(x13), .b(x09), .c(x04), .O(new_n69_));
