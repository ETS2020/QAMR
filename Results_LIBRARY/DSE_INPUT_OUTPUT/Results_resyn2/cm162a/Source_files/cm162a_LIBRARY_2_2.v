...
module FAU ( 
  ...
  nand3  g32(.a(new_n51_), .b(new_n21_), .c(x12), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(x05), .c(new_n44_), .O(new_n53_));
  oai21  g34(.a(new_n43_), .b(x12), .c(x03), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  nor2   g36(.a(new_n37_), .b(x03), .O(new_n56_));
  aoi22  g37(.a(new_n56_), .b(new_n55_), .c(new_n37_), .d(new_n44_), .O(new_n57_));
  oai21  g38(.a(new_n54_), .b(new_n53_), .c(new_n57_), .O(z3));
  aoi21  g39(.a(new_n32_), .b(x05), .c(new_n44_), .O(z4));
endmodule
