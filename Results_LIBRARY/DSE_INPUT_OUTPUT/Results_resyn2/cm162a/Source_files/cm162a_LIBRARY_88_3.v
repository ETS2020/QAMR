...
module FAU ( 
  ...
  nand2  g00(.a(x09), .b(x07), .O(new_n20_));
  ...
  nor2   g08(.a(x07), .b(new_n27_), .O(new_n28_));
  nand4  g09(.a(new_n28_), .b(x13), .c(x09), .d(x08), .O(new_n29_));
  ...
  nand4  g14(.a(new_n32_), .b(new_n22_), .c(x04), .d(x02), .O(new_n34_));
  ...
  nand4  g29(.a(new_n42_), .b(new_n31_), .c(x12), .d(new_n48_), .O(new_n49_));
  oai21  g30(.a(x09), .b(new_n27_), .c(x07), .O(new_n50_));
  inv1   g31(.a(x12), .O(new_n51_));
  nand3  g32(.a(new_n42_), .b(new_n31_), .c(new_n48_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n50_), .c(new_n49_), .O(new_n54_));
  inv1   g35(.a(x05), .O(new_n55_));
  nand2  g36(.a(new_n20_), .b(new_n55_), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n23_), .b(new_n51_), .c(new_n32_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n27_), .c(new_n57_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n56_), .c(new_n54_), .O(z3));
  inv1   g41(.a(x09), .O(new_n61_));
  nand2  g42(.a(x13), .b(x04), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n57_), .c(new_n61_), .O(z4));
endmodule
