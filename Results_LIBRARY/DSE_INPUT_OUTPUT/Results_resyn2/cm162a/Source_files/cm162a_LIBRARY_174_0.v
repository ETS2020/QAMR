...
module FAU ( 
  ...
  nand2  g20(.a(x07), .b(new_n28_), .O(new_n40_));
  inv1   g21(.a(x11), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n31_), .c(new_n33_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n21_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n23_), .O(new_n44_));
  oai21  g25(.a(new_n34_), .b(new_n24_), .c(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n44_), .c(x03), .O(new_n46_));
  aoi21  g27(.a(x06), .b(new_n20_), .c(new_n28_), .O(new_n47_));
  ...
  oai21  g32(.a(new_n51_), .b(new_n42_), .c(x03), .O(new_n52_));
  aoi21  g33(.a(new_n44_), .b(new_n50_), .c(new_n52_), .O(new_n53_));
  nor2   g34(.a(x07), .b(x03), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n53_), .c(x05), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n40_), .O(z3));
  inv1   g37(.a(x04), .O(new_n57_));
  nor2   g38(.a(x07), .b(x05), .O(new_n58_));
