...
module FAU ( 
  ...
  nand2  g14(.a(x07), .b(new_n31_), .O(new_n34_));
  oai21  g15(.a(new_n20_), .b(x08), .c(x10), .O(new_n35_));
  nor2   g16(.a(x10), .b(x08), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(x04), .c(x02), .O(new_n37_));
  nand4  g18(.a(new_n37_), .b(new_n35_), .c(new_n26_), .d(x03), .O(new_n38_));
  aoi21  g19(.a(new_n30_), .b(x01), .c(new_n31_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n34_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n36_), .b(new_n23_), .c(new_n42_), .O(new_n43_));
  nand2  g24(.a(new_n37_), .b(x11), .O(new_n44_));
  ...
  nand4  g31(.a(new_n36_), .b(new_n23_), .c(new_n50_), .d(new_n42_), .O(new_n51_));
  ...
  aoi21  g43(.a(new_n59_), .b(new_n31_), .c(new_n62_), .O(z4));
endmodule
