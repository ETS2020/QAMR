...
module FAU ( 
  ...
  nand4  g10(.a(new_n29_), .b(new_n27_), .c(new_n26_), .d(x03), .O(new_n30_));
  inv1   g11(.a(x03), .O(new_n31_));
  aoi21  g12(.a(new_n31_), .b(x00), .c(new_n20_), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(new_n30_), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n22_), .O(z0));
  oai21  g15(.a(new_n23_), .b(x08), .c(x10), .O(new_n35_));
  ...
  aoi21  g19(.a(new_n31_), .b(x01), .c(new_n20_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n22_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n36_), .b(new_n24_), .c(new_n42_), .O(new_n43_));
  ...
  aoi21  g28(.a(new_n47_), .b(new_n31_), .c(new_n20_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n36_), .b(new_n24_), .c(new_n50_), .d(new_n42_), .O(new_n51_));
  ...
  nand3  g36(.a(new_n25_), .b(new_n24_), .c(x05), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n51_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x03), .O(new_n58_));
  aoi21  g39(.a(new_n21_), .b(new_n31_), .c(new_n20_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n58_), .O(z3));
  nand2  g41(.a(new_n25_), .b(x04), .O(new_n61_));
  aoi21  g42(.a(x07), .b(new_n20_), .c(new_n61_), .O(z4));
endmodule
