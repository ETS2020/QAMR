...
module FAU ( 
  ...
  nor2   g12(.a(new_n31_), .b(x05), .O(new_n32_));
  nand2  g13(.a(new_n20_), .b(x01), .O(new_n33_));
  ...
  nand4  g18(.a(new_n37_), .b(new_n36_), .c(new_n34_), .d(x03), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n33_), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(x05), .c(new_n32_), .O(z1));
  ...
  aoi21  g28(.a(new_n31_), .b(new_n20_), .c(new_n28_), .O(new_n48_));
  oai21  g29(.a(new_n47_), .b(new_n20_), .c(new_n48_), .O(z2));
  aoi21  g30(.a(new_n45_), .b(new_n22_), .c(x12), .O(new_n50_));
  nand3  g31(.a(new_n22_), .b(new_n21_), .c(x12), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n44_), .c(x03), .O(new_n52_));
  ...
  oai22  g37(.a(new_n21_), .b(new_n56_), .c(new_n31_), .d(x05), .O(z4));
endmodule
