...
module FAU ( 
  ...
  inv1   g13(.a(new_n25_), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(new_n32_), .c(new_n22_), .O(new_n34_));
  oai21  g15(.a(new_n25_), .b(x08), .c(x10), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(new_n34_), .c(new_n31_), .O(new_n36_));
  ...
  oai21  g23(.a(new_n42_), .b(new_n24_), .c(new_n33_), .O(new_n43_));
  ...
  oai22  g38(.a(new_n23_), .b(new_n57_), .c(x05), .d(x03), .O(z4));
endmodule
