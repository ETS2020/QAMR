...
module FAU ( 
  ...
  nand3  g15(.a(new_n23_), .b(new_n34_), .c(new_n21_), .O(new_n35_));
  nand4  g16(.a(new_n35_), .b(new_n33_), .c(new_n31_), .d(x03), .O(new_n36_));
  inv1   g17(.a(x06), .O(new_n37_));
  aoi21  g18(.a(new_n20_), .b(x01), .c(new_n37_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x05), .O(z1));
  inv1   g21(.a(x11), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n34_), .c(new_n21_), .O(new_n42_));
  ...
  nand2  g29(.a(x06), .b(x03), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x05), .O(z2));
  ...
  aoi21  g34(.a(new_n44_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  nor2   g35(.a(x07), .b(x03), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(x06), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x05), .O(z3));
  nand2  g38(.a(new_n32_), .b(x04), .O(new_n58_));
  aoi21  g39(.a(new_n37_), .b(x05), .c(new_n58_), .O(z4));
endmodule
