...
module FAU ( 
  ...
  nand4  g19(.a(new_n38_), .b(new_n36_), .c(new_n26_), .d(x03), .O(new_n39_));
  aoi21  g20(.a(new_n30_), .b(x01), .c(new_n31_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n35_), .O(z1));
  inv1   g23(.a(x11), .O(new_n43_));
  nand3  g24(.a(new_n37_), .b(new_n23_), .c(new_n43_), .O(new_n44_));
  ...
  nand4  g32(.a(new_n37_), .b(new_n23_), .c(new_n51_), .d(new_n43_), .O(new_n52_));
  ...
  aoi21  g40(.a(new_n34_), .b(new_n30_), .c(new_n31_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n59_), .O(z3));
  nand2  g42(.a(new_n25_), .b(x04), .O(new_n62_));
  aoi21  g43(.a(x07), .b(new_n31_), .c(new_n62_), .O(z4));
endmodule
