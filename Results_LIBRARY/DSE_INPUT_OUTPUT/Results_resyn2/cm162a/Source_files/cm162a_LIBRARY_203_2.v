...
module FAU ( 
  ...
  aoi21  g27(.a(new_n42_), .b(new_n21_), .c(x12), .O(new_n47_));
  nand3  g28(.a(new_n21_), .b(new_n20_), .c(x12), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n41_), .c(x03), .O(new_n49_));
  inv1   g30(.a(x07), .O(new_n50_));
  nand2  g31(.a(x06), .b(x05), .O(new_n51_));
  aoi21  g32(.a(new_n50_), .b(new_n34_), .c(new_n51_), .O(new_n52_));
  oai21  g33(.a(new_n49_), .b(new_n47_), .c(new_n52_), .O(z3));
