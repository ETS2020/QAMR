...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n32_), .c(x03), .O(new_n38_));
  ...
  nor2   g27(.a(new_n43_), .b(new_n28_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n22_), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  nor2   g30(.a(new_n28_), .b(x03), .O(new_n50_));
  aoi22  g31(.a(new_n50_), .b(new_n49_), .c(new_n28_), .d(x04), .O(new_n51_));
  oai21  g32(.a(new_n48_), .b(new_n20_), .c(new_n51_), .O(z2));
  aoi21  g33(.a(new_n45_), .b(new_n22_), .c(x12), .O(new_n53_));
