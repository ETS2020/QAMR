...
module FAU ( 
  ...
  nand2  g09(.a(x13), .b(x07), .O(new_n29_));
  ...
  inv1   g17(.a(new_n21_), .O(new_n37_));
  nand3  g18(.a(x13), .b(x09), .c(new_n23_), .O(new_n38_));
  inv1   g19(.a(new_n38_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x03), .O(new_n40_));
  inv1   g21(.a(new_n40_), .O(new_n41_));
  oai21  g22(.a(new_n37_), .b(x10), .c(new_n41_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n36_), .O(z1));
  nand2  g24(.a(new_n33_), .b(x11), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  nor2   g26(.a(x10), .b(x08), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n37_), .c(new_n45_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n44_), .c(new_n20_), .O(new_n48_));
  oai21  g29(.a(x06), .b(x03), .c(x05), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(new_n29_), .O(new_n50_));
  oai21  g31(.a(new_n37_), .b(x11), .c(new_n41_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n50_), .O(z2));
  nand2  g33(.a(new_n46_), .b(new_n45_), .O(new_n53_));
  nor2   g34(.a(x12), .b(x02), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x03), .c(x02), .O(new_n56_));
  oai22  g37(.a(new_n56_), .b(new_n53_), .c(new_n54_), .d(new_n38_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x04), .O(new_n58_));
  nor2   g39(.a(new_n55_), .b(new_n20_), .O(new_n59_));
  nand2  g40(.a(new_n23_), .b(new_n20_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n29_), .c(x05), .O(new_n61_));
  aoi21  g42(.a(new_n59_), .b(new_n47_), .c(new_n61_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n58_), .O(z3));
  nand2  g44(.a(new_n39_), .b(x04), .O(new_n64_));
