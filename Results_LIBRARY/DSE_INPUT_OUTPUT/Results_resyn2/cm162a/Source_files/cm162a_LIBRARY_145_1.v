...
module FAU ( 
  ...
  nand2  g08(.a(new_n25_), .b(new_n21_), .O(new_n28_));
  nand2  g09(.a(new_n28_), .b(x10), .O(new_n29_));
  inv1   g10(.a(new_n21_), .O(new_n30_));
  nor2   g11(.a(x10), .b(x08), .O(new_n31_));
  oai21  g12(.a(new_n31_), .b(new_n30_), .c(new_n22_), .O(new_n32_));
  nand4  g13(.a(new_n32_), .b(new_n29_), .c(x05), .d(x03), .O(z1));
  inv1   g14(.a(x08), .O(new_n34_));
  inv1   g15(.a(x10), .O(new_n35_));
  inv1   g16(.a(x11), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n21_), .O(new_n38_));
  nand3  g19(.a(new_n31_), .b(new_n22_), .c(new_n21_), .O(new_n39_));
  aoi22  g20(.a(new_n39_), .b(x11), .c(new_n38_), .d(new_n22_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n20_), .c(x05), .O(z2));
  aoi21  g22(.a(new_n38_), .b(new_n22_), .c(x12), .O(new_n42_));
  nand3  g23(.a(new_n22_), .b(new_n21_), .c(x12), .O(new_n43_));
  ...
  aoi21  g27(.a(x05), .b(new_n20_), .c(new_n46_), .O(z4));
endmodule
