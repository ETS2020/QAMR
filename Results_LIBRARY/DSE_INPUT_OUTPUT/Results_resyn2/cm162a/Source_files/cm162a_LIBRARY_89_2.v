...
module FAU ( 
  ...
  inv1   g21(.a(new_n27_), .O(new_n41_));
  inv1   g22(.a(x10), .O(new_n42_));
  nand2  g23(.a(new_n23_), .b(new_n42_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n41_), .c(x03), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n40_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n42_), .c(new_n25_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n27_), .c(new_n23_), .O(new_n48_));
  nand3  g29(.a(new_n36_), .b(new_n27_), .c(new_n26_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x11), .c(new_n48_), .O(new_n50_));
  nand2  g31(.a(new_n21_), .b(x05), .O(new_n51_));
  ...
  nand3  g36(.a(new_n27_), .b(new_n26_), .c(x12), .O(new_n56_));
  ...
  nand2  g41(.a(new_n41_), .b(x04), .O(new_n61_));
