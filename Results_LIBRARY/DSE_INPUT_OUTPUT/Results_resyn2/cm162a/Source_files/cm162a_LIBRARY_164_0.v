...
module FAU ( 
  ...
  oai21  g17(.a(x10), .b(x05), .c(new_n36_), .O(new_n37_));
  oai21  g18(.a(new_n35_), .b(new_n20_), .c(new_n37_), .O(z1));
  inv1   g19(.a(x10), .O(new_n39_));
  inv1   g20(.a(x11), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n39_), .c(new_n21_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n24_), .c(new_n22_), .O(new_n42_));
  nand4  g23(.a(new_n23_), .b(new_n24_), .c(new_n39_), .d(new_n21_), .O(new_n43_));
  ...
  nand3  g29(.a(new_n34_), .b(x13), .c(x09), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nor2   g31(.a(x10), .b(x08), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n23_), .c(new_n50_), .d(new_n40_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n49_), .c(new_n48_), .O(new_n53_));
  ...
  aoi21  g39(.a(new_n39_), .b(new_n28_), .c(new_n58_), .O(z4));
endmodule
