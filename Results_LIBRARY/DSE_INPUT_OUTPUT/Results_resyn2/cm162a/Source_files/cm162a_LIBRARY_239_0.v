...
module FAU ( 
  ...
  nand3  g23(.a(new_n42_), .b(new_n31_), .c(new_n41_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n21_), .O(new_n44_));
  nand3  g25(.a(new_n34_), .b(new_n22_), .c(new_n21_), .O(new_n45_));
  ...
  oai22  g37(.a(new_n21_), .b(new_n56_), .c(x07), .d(x05), .O(z4));
endmodule
