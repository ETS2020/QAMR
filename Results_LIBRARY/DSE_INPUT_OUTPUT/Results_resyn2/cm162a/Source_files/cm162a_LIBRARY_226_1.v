...
module FAU ( 
  ...
  nand2  g28(.a(new_n37_), .b(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n47_), .c(x03), .O(new_n49_));
  aoi21  g30(.a(x06), .b(new_n41_), .c(new_n20_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n22_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n23_), .b(x12), .c(x04), .d(x02), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n45_), .c(x03), .O(new_n55_));
  aoi21  g36(.a(new_n47_), .b(new_n53_), .c(new_n55_), .O(new_n56_));
  nor2   g37(.a(x07), .b(x03), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n56_), .c(x05), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n22_), .O(z3));
  nand2  g40(.a(x13), .b(x04), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(x05), .c(new_n21_), .O(z4));
endmodule
