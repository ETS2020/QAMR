...
module FAU ( 
  ...
  oai21  g12(.a(new_n31_), .b(x08), .c(x10), .O(new_n32_));
  nor2   g13(.a(x10), .b(x08), .O(new_n33_));
  oai21  g14(.a(new_n33_), .b(new_n22_), .c(new_n21_), .O(new_n34_));
  ...
  nand3  g23(.a(x13), .b(x09), .c(x05), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n42_), .c(new_n31_), .O(new_n44_));
  nand2  g25(.a(x11), .b(x05), .O(new_n45_));
  aoi21  g26(.a(new_n33_), .b(new_n21_), .c(new_n45_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n44_), .c(x03), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  nor2   g29(.a(new_n28_), .b(x03), .O(new_n49_));
  nor2   g30(.a(x10), .b(x05), .O(new_n50_));
  aoi21  g31(.a(new_n49_), .b(new_n48_), .c(new_n50_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n47_), .O(z2));
  nand2  g33(.a(new_n43_), .b(new_n42_), .O(new_n53_));
  nand2  g34(.a(new_n43_), .b(x12), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n53_), .c(new_n21_), .O(new_n55_));
  nand3  g36(.a(new_n33_), .b(new_n21_), .c(new_n41_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x12), .c(x05), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n49_), .b(new_n60_), .c(new_n50_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  nand2  g43(.a(new_n22_), .b(x04), .O(new_n63_));
  aoi21  g44(.a(x10), .b(new_n28_), .c(new_n63_), .O(z4));
endmodule
