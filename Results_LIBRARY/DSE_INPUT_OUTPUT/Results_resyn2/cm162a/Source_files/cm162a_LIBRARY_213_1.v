...
module FAU ( 
  ...
  nor2   g23(.a(new_n37_), .b(x11), .O(new_n43_));
  nand2  g24(.a(new_n27_), .b(new_n26_), .O(new_n44_));
  nor2   g25(.a(x10), .b(x08), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x11), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n44_), .c(x03), .O(new_n47_));
  inv1   g28(.a(x13), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x03), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n20_), .c(new_n32_), .O(new_n50_));
  oai21  g31(.a(new_n47_), .b(new_n43_), .c(new_n50_), .O(z2));
  ...
  nand4  g36(.a(new_n45_), .b(new_n26_), .c(x12), .d(new_n53_), .O(new_n56_));
  ...
  nand4  g44(.a(new_n63_), .b(new_n62_), .c(x06), .d(x03), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n61_), .O(z3));
  nand2  g46(.a(x09), .b(x04), .O(new_n66_));
  aoi21  g47(.a(new_n66_), .b(x06), .c(new_n48_), .O(z4));
endmodule
