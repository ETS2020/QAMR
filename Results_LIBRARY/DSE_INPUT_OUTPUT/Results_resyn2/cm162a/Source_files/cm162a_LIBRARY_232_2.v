...
module FAU ( 
  ...
  oai21  g22(.a(new_n41_), .b(new_n32_), .c(new_n23_), .O(new_n42_));
  ...
  oai21  g26(.a(new_n45_), .b(new_n20_), .c(new_n40_), .O(z2));
  ...
  aoi21  g32(.a(new_n42_), .b(new_n47_), .c(new_n51_), .O(new_n52_));
