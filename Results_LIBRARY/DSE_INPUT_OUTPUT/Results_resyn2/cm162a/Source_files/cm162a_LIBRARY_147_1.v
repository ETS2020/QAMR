...
module FAU ( 
  ...
  aoi21  g36(.a(new_n55_), .b(new_n45_), .c(new_n36_), .O(new_n56_));
  oai21  g37(.a(new_n54_), .b(new_n52_), .c(new_n56_), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  inv1   g39(.a(x05), .O(new_n59_));
  oai22  g40(.a(new_n20_), .b(new_n58_), .c(new_n59_), .d(x01), .O(z4));
endmodule
