...
module FAU ( 
  ...
  nand4  g17(.a(new_n36_), .b(new_n34_), .c(new_n33_), .d(x03), .O(new_n37_));
  ...
  aoi21  g29(.a(new_n31_), .b(new_n20_), .c(new_n28_), .O(new_n49_));
  oai21  g30(.a(new_n48_), .b(new_n20_), .c(new_n49_), .O(z2));
  ...
  oai22  g39(.a(new_n24_), .b(new_n58_), .c(new_n31_), .d(x05), .O(z4));
endmodule
