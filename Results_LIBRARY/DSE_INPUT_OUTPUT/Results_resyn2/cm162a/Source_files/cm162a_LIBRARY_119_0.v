...
module FAU ( 
  ...
  nand2  g11(.a(new_n28_), .b(x01), .O(new_n31_));
  oai21  g12(.a(new_n22_), .b(x08), .c(x10), .O(new_n32_));
  inv1   g13(.a(new_n24_), .O(new_n33_));
  nand2  g14(.a(new_n23_), .b(new_n33_), .O(new_n34_));
  inv1   g15(.a(x10), .O(new_n35_));
  nand3  g16(.a(new_n23_), .b(new_n35_), .c(new_n21_), .O(new_n36_));
  ...
  nand3  g22(.a(new_n41_), .b(new_n35_), .c(new_n21_), .O(new_n42_));
  ...
  nor2   g40(.a(x05), .b(x01), .O(new_n60_));
  nor3   g41(.a(new_n60_), .b(new_n24_), .c(new_n59_), .O(z4));
endmodule
