...
module FAU ( 
  ...
  nor2   g27(.a(new_n43_), .b(new_n27_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n33_), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  inv1   g30(.a(x04), .O(new_n50_));
  nor2   g31(.a(x05), .b(new_n50_), .O(new_n51_));
  nor2   g32(.a(new_n27_), .b(x03), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n49_), .c(new_n51_), .O(new_n53_));
  oai21  g34(.a(new_n48_), .b(new_n20_), .c(new_n53_), .O(z2));
  nor2   g35(.a(x12), .b(x11), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n34_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n41_), .c(new_n21_), .O(new_n57_));
  nor3   g38(.a(x11), .b(x10), .c(x08), .O(new_n58_));
  nand2  g39(.a(x12), .b(x05), .O(new_n59_));
  aoi21  g40(.a(new_n58_), .b(new_n22_), .c(new_n59_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n57_), .c(x03), .O(new_n61_));
  inv1   g42(.a(x07), .O(new_n62_));
  aoi21  g43(.a(new_n52_), .b(new_n62_), .c(new_n51_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  nand2  g45(.a(new_n27_), .b(new_n50_), .O(new_n65_));
  oai21  g46(.a(new_n41_), .b(new_n50_), .c(new_n65_), .O(z4));
endmodule
