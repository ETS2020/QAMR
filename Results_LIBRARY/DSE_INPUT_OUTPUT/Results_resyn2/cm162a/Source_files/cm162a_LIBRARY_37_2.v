...
module FAU ( 
  ...
  nand4  g14(.a(new_n33_), .b(new_n31_), .c(new_n29_), .d(x03), .O(new_n34_));
  inv1   g15(.a(x03), .O(new_n35_));
  inv1   g16(.a(x07), .O(new_n36_));
  ...
  nand3  g25(.a(new_n32_), .b(new_n21_), .c(new_n20_), .O(new_n45_));
  ...
  aoi21  g31(.a(new_n44_), .b(new_n21_), .c(x12), .O(new_n51_));
  nand3  g32(.a(new_n21_), .b(new_n20_), .c(x12), .O(new_n52_));
  nor2   g33(.a(new_n36_), .b(new_n35_), .O(new_n53_));
  oai21  g34(.a(new_n52_), .b(new_n43_), .c(new_n53_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n51_), .c(x05), .O(z3));
  nand2  g36(.a(new_n30_), .b(x04), .O(new_n56_));
  aoi21  g37(.a(new_n36_), .b(x05), .c(new_n56_), .O(z4));
endmodule
