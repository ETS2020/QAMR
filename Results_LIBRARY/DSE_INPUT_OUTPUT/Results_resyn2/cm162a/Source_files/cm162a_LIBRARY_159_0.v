...
module FAU ( 
  ...
  and2   g13(.a(x13), .b(x09), .O(new_n33_));
  nor2   g14(.a(x10), .b(x08), .O(new_n34_));
  oai21  g15(.a(new_n34_), .b(new_n33_), .c(new_n21_), .O(new_n35_));
  ...
  aoi21  g24(.a(new_n43_), .b(new_n24_), .c(new_n23_), .O(new_n44_));
  nand2  g25(.a(x11), .b(x05), .O(new_n45_));
  aoi21  g26(.a(new_n34_), .b(new_n21_), .c(new_n45_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n44_), .c(x03), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  nor2   g29(.a(new_n29_), .b(x03), .O(new_n49_));
  inv1   g30(.a(x02), .O(new_n50_));
  nor2   g31(.a(x05), .b(new_n50_), .O(new_n51_));
  aoi21  g32(.a(new_n49_), .b(new_n48_), .c(new_n51_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n47_), .O(z2));
  nand2  g34(.a(new_n43_), .b(new_n24_), .O(new_n54_));
  nand2  g35(.a(new_n24_), .b(x12), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n54_), .c(new_n21_), .O(new_n56_));
  nand3  g37(.a(new_n34_), .b(new_n21_), .c(new_n42_), .O(new_n57_));
  ...
  aoi21  g42(.a(new_n49_), .b(new_n61_), .c(new_n51_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  nand2  g44(.a(new_n33_), .b(x04), .O(new_n64_));
  aoi21  g45(.a(new_n29_), .b(new_n50_), .c(new_n64_), .O(z4));
endmodule
