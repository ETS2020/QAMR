...
module FAU ( 
  ...
  aoi21  g18(.a(new_n33_), .b(new_n22_), .c(x11), .O(new_n38_));
  inv1   g19(.a(x10), .O(new_n39_));
  nand3  g20(.a(x11), .b(new_n39_), .c(new_n30_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n23_), .c(x03), .O(new_n41_));
  inv1   g22(.a(x05), .O(new_n42_));
  nor2   g23(.a(x06), .b(x03), .O(new_n43_));
  nor3   g24(.a(new_n43_), .b(new_n42_), .c(x01), .O(new_n44_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n46_), .c(new_n39_), .d(new_n30_), .O(new_n50_));
  ...
  aoi21  g35(.a(x07), .b(new_n54_), .c(x01), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x05), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  oai22  g39(.a(new_n20_), .b(new_n58_), .c(new_n42_), .d(new_n27_), .O(z4));
endmodule
