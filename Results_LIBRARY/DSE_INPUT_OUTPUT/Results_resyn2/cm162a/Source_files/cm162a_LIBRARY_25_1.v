...
module FAU ( 
  ...
  nor2   g10(.a(new_n29_), .b(x07), .O(new_n30_));
  ...
  nor2   g33(.a(new_n47_), .b(x12), .O(new_n53_));
  inv1   g34(.a(x10), .O(new_n54_));
  nand3  g35(.a(x12), .b(new_n44_), .c(new_n54_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n36_), .c(x03), .O(new_n56_));
  aoi21  g37(.a(new_n29_), .b(x03), .c(x07), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(new_n28_), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n53_), .c(new_n58_), .O(z3));
  inv1   g40(.a(x04), .O(new_n60_));
  nor3   g41(.a(new_n30_), .b(new_n33_), .c(new_n60_), .O(z4));
endmodule
