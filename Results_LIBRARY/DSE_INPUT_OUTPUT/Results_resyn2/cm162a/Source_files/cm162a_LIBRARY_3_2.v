...
module FAU ( 
  ...
  oai21  g21(.a(new_n36_), .b(new_n29_), .c(new_n40_), .O(z1));
  ...
  oai21  g30(.a(new_n49_), .b(new_n38_), .c(x05), .O(z2));
  nand3  g31(.a(new_n42_), .b(new_n44_), .c(x03), .O(new_n51_));
  aoi21  g32(.a(x07), .b(new_n29_), .c(new_n38_), .O(new_n52_));
  ...
  oai21  g36(.a(x12), .b(new_n37_), .c(new_n55_), .O(z4));
endmodule
