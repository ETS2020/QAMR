...
module FAU ( 
  ...
  inv1   g21(.a(new_n28_), .O(new_n41_));
  aoi21  g22(.a(new_n34_), .b(new_n23_), .c(x11), .O(new_n42_));
  inv1   g23(.a(x10), .O(new_n43_));
  nand3  g24(.a(x11), .b(new_n43_), .c(new_n31_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n24_), .c(x03), .O(new_n45_));
  oai21  g26(.a(new_n45_), .b(new_n42_), .c(new_n41_), .O(z2));
  inv1   g27(.a(x11), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n43_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n32_), .c(x12), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n47_), .c(new_n43_), .d(new_n31_), .O(new_n51_));
  ...
  aoi21  g35(.a(x07), .b(new_n20_), .c(new_n37_), .O(new_n55_));
  ...
  oai22  g40(.a(new_n21_), .b(new_n58_), .c(x06), .d(new_n59_), .O(z4));
endmodule
