...
module FAU ( 
  ...
  or2    g12(.a(x03), .b(x01), .O(new_n32_));
  oai21  g13(.a(x10), .b(x08), .c(new_n20_), .O(new_n33_));
  nand3  g14(.a(x04), .b(x03), .c(x02), .O(new_n34_));
  inv1   g15(.a(new_n34_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n33_), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n32_), .c(new_n31_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n26_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(x05), .O(z1));
  nor2   g20(.a(x06), .b(x03), .O(new_n40_));
  aoi21  g21(.a(new_n35_), .b(new_n33_), .c(new_n40_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(x11), .c(x05), .O(z2));
  nand3  g23(.a(x13), .b(new_n26_), .c(x09), .O(new_n43_));
  inv1   g24(.a(x10), .O(new_n44_));
  inv1   g25(.a(x12), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n44_), .c(new_n29_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n43_), .c(new_n22_), .O(new_n47_));
  nor2   g28(.a(new_n22_), .b(x08), .O(new_n48_));
  ...
  nand2  g32(.a(new_n26_), .b(x05), .O(new_n52_));
  nor2   g33(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n50_), .O(z3));
  nand3  g35(.a(x13), .b(x09), .c(x04), .O(new_n55_));
  aoi21  g36(.a(x11), .b(x05), .c(new_n55_), .O(z4));
endmodule
