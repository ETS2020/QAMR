...
module FAU ( 
  ...
  aoi21  g20(.a(new_n35_), .b(new_n23_), .c(x11), .O(new_n40_));
  inv1   g21(.a(x10), .O(new_n41_));
  nand3  g22(.a(x11), .b(new_n41_), .c(new_n32_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n24_), .c(x03), .O(new_n43_));
  nor2   g24(.a(x06), .b(x03), .O(new_n44_));
  nor2   g25(.a(new_n44_), .b(new_n29_), .O(new_n45_));
  oai21  g26(.a(new_n43_), .b(new_n40_), .c(new_n45_), .O(z2));
  inv1   g27(.a(x11), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n41_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n33_), .c(x12), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n47_), .c(new_n41_), .d(new_n32_), .O(new_n51_));
  ...
  aoi21  g35(.a(x07), .b(new_n20_), .c(x01), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x05), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  nand2  g39(.a(x05), .b(x01), .O(new_n59_));
  oai21  g40(.a(new_n21_), .b(new_n58_), .c(new_n59_), .O(z4));
endmodule
