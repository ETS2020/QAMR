...
module FAU ( 
  ...
  nand2  g26(.a(x11), .b(x05), .O(new_n46_));
  aoi21  g27(.a(new_n34_), .b(new_n23_), .c(new_n46_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n45_), .c(x03), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  nor2   g30(.a(new_n30_), .b(x03), .O(new_n50_));
  nor2   g31(.a(x08), .b(x05), .O(new_n51_));
  aoi21  g32(.a(new_n50_), .b(new_n49_), .c(new_n51_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n48_), .O(z2));
  nand2  g34(.a(new_n44_), .b(new_n43_), .O(new_n54_));
  nand2  g35(.a(new_n44_), .b(x12), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n54_), .c(new_n23_), .O(new_n56_));
  nand3  g37(.a(new_n34_), .b(new_n23_), .c(new_n42_), .O(new_n57_));
  ...
  aoi21  g42(.a(new_n50_), .b(new_n61_), .c(new_n51_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  nand3  g44(.a(x13), .b(x09), .c(x04), .O(new_n64_));
  oai21  g45(.a(new_n22_), .b(x05), .c(new_n64_), .O(z4));
endmodule
