...
module FAU ( 
  ...
  nand3  g10(.a(new_n21_), .b(new_n20_), .c(x02), .O(new_n30_));
  nand2  g11(.a(new_n30_), .b(x10), .O(new_n31_));
  oai21  g12(.a(x10), .b(x08), .c(new_n21_), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(x02), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(new_n31_), .c(x03), .O(new_n34_));
  aoi21  g15(.a(new_n25_), .b(x01), .c(new_n26_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(x05), .O(z1));
  aoi21  g18(.a(new_n32_), .b(x02), .c(x11), .O(new_n38_));
  inv1   g19(.a(x10), .O(new_n39_));
  nand2  g20(.a(x11), .b(new_n39_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n30_), .c(x03), .O(new_n41_));
  inv1   g22(.a(x06), .O(new_n42_));
  nand2  g23(.a(x05), .b(x04), .O(new_n43_));
  aoi21  g24(.a(new_n42_), .b(new_n25_), .c(new_n43_), .O(new_n44_));
  oai21  g25(.a(new_n41_), .b(new_n38_), .c(new_n44_), .O(z2));
  inv1   g26(.a(x11), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n39_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n30_), .c(x12), .O(new_n48_));
  inv1   g29(.a(x12), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(new_n46_), .c(new_n39_), .d(new_n20_), .O(new_n50_));
  ...
  aoi21  g34(.a(x07), .b(new_n25_), .c(new_n26_), .O(new_n54_));
