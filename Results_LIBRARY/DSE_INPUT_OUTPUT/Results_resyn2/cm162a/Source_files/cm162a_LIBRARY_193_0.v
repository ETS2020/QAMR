...
module FAU ( 
  ...
  nand2  g07(.a(new_n23_), .b(new_n26_), .O(new_n27_));
  nand4  g08(.a(new_n27_), .b(new_n25_), .c(new_n24_), .d(x03), .O(new_n28_));
  inv1   g09(.a(x03), .O(new_n29_));
  aoi21  g10(.a(new_n29_), .b(x00), .c(new_n20_), .O(new_n30_));
  nand2  g11(.a(new_n30_), .b(new_n28_), .O(new_n31_));
  nand2  g12(.a(new_n31_), .b(new_n21_), .O(z0));
  ...
  nand3  g21(.a(new_n34_), .b(new_n40_), .c(new_n23_), .O(new_n41_));
  ...
  aoi21  g26(.a(new_n44_), .b(new_n40_), .c(new_n45_), .O(new_n46_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n43_), .c(new_n42_), .d(new_n26_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nand3  g35(.a(new_n34_), .b(new_n23_), .c(new_n43_), .O(new_n55_));
  aoi22  g36(.a(new_n55_), .b(x12), .c(new_n54_), .d(new_n23_), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n29_), .c(new_n20_), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n29_), .c(new_n58_), .O(z3));
  nand3  g40(.a(x13), .b(x09), .c(x04), .O(new_n60_));
  aoi21  g41(.a(new_n43_), .b(new_n20_), .c(new_n60_), .O(z4));
endmodule
