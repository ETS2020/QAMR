...
module FAU ( 
  ...
  nand3  g22(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(new_n42_));
  ...
  nand2  g26(.a(x06), .b(x03), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n45_), .c(x05), .O(z2));
  aoi21  g28(.a(new_n43_), .b(new_n22_), .c(x12), .O(new_n48_));
