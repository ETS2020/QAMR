...
module FAU ( 
  ...
  nor2   g27(.a(new_n28_), .b(new_n20_), .O(new_n47_));
  inv1   g28(.a(new_n47_), .O(new_n48_));
  nand2  g29(.a(x06), .b(x05), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n46_), .c(new_n50_), .O(z2));
  aoi21  g32(.a(new_n44_), .b(new_n22_), .c(x12), .O(new_n52_));
  nand3  g33(.a(new_n22_), .b(new_n21_), .c(x12), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n43_), .c(new_n47_), .O(new_n54_));
