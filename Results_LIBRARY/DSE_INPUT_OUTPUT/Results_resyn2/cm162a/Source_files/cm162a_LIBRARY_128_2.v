...
module FAU ( 
  ...
  oai21  g13(.a(new_n22_), .b(new_n32_), .c(x03), .O(new_n33_));
  ...
  nand3  g18(.a(new_n20_), .b(new_n37_), .c(x03), .O(new_n38_));
  inv1   g19(.a(x10), .O(new_n39_));
  aoi21  g20(.a(x06), .b(new_n28_), .c(new_n39_), .O(new_n40_));
  ...
  aoi21  g25(.a(x07), .b(new_n28_), .c(new_n39_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x05), .O(z3));
  nand2  g28(.a(new_n32_), .b(x04), .O(new_n48_));
  aoi21  g29(.a(new_n39_), .b(x05), .c(new_n48_), .O(z4));
endmodule
