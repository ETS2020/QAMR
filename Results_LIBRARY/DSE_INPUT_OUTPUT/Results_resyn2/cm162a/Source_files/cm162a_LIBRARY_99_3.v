...
module FAU ( 
  ...
  nor2   g02(.a(new_n21_), .b(x02), .O(new_n22_));
  ...
  nand3  g14(.a(new_n33_), .b(new_n31_), .c(new_n22_), .O(z2));
  inv1   g15(.a(x02), .O(new_n35_));
  nand2  g16(.a(x07), .b(new_n24_), .O(new_n36_));
  inv1   g17(.a(x12), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x03), .O(new_n38_));
  nand3  g19(.a(new_n38_), .b(new_n36_), .c(new_n35_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x05), .O(z3));
  nand3  g21(.a(x13), .b(x09), .c(x04), .O(new_n41_));
  oai21  g22(.a(new_n21_), .b(new_n35_), .c(new_n41_), .O(z4));
endmodule
