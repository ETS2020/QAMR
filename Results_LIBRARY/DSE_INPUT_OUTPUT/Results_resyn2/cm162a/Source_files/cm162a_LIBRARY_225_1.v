...
module FAU ( 
  ...
  nand2  g15(.a(new_n32_), .b(new_n31_), .O(new_n35_));
  aoi21  g16(.a(new_n35_), .b(new_n23_), .c(new_n25_), .O(new_n36_));
  ...
  oai21  g24(.a(new_n43_), .b(new_n42_), .c(new_n33_), .O(new_n44_));
  oai21  g25(.a(new_n35_), .b(new_n24_), .c(x11), .O(new_n45_));
  ...
  nand2  g29(.a(new_n48_), .b(new_n22_), .O(z2));
  nand4  g30(.a(new_n43_), .b(new_n33_), .c(new_n23_), .d(x03), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(x05), .c(new_n21_), .O(new_n51_));
  inv1   g32(.a(x11), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n32_), .c(new_n31_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n23_), .c(new_n25_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(x12), .c(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n39_), .c(new_n20_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n55_), .c(new_n51_), .O(z3));
  nand2  g39(.a(new_n42_), .b(x04), .O(new_n59_));
  aoi21  g40(.a(x12), .b(new_n20_), .c(new_n59_), .O(z4));
endmodule
