...
module FAU ( 
  ...
  nand3  g22(.a(new_n41_), .b(new_n40_), .c(new_n27_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(new_n43_));
  ...
  nor2   g29(.a(new_n20_), .b(x03), .O(new_n49_));
  ...
  nand2  g34(.a(new_n42_), .b(new_n22_), .O(new_n54_));
  nand2  g35(.a(new_n22_), .b(x12), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n54_), .c(new_n24_), .O(new_n56_));
  and2   g37(.a(x12), .b(x05), .O(new_n57_));
  oai21  g38(.a(new_n42_), .b(new_n23_), .c(new_n57_), .O(new_n58_));
  ...
  aoi21  g45(.a(new_n20_), .b(new_n50_), .c(new_n64_), .O(z4));
endmodule
