...
module FAU ( 
  ...
  nand2  g08(.a(new_n21_), .b(new_n27_), .O(new_n28_));
  nand2  g09(.a(x10), .b(x03), .O(new_n29_));
  nand4  g10(.a(new_n29_), .b(new_n28_), .c(x05), .d(new_n20_), .O(z1));
  ...
  nand2  g16(.a(x07), .b(new_n21_), .O(new_n36_));
  inv1   g17(.a(x12), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x03), .O(new_n38_));
  nand3  g19(.a(new_n38_), .b(new_n36_), .c(new_n20_), .O(new_n39_));
