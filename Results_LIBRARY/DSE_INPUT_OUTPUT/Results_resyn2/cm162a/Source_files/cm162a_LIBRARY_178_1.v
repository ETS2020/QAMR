...
module FAU ( 
  ...
  aoi21  g26(.a(new_n45_), .b(new_n44_), .c(new_n25_), .O(new_n46_));
  nand2  g27(.a(x11), .b(x05), .O(new_n47_));
  aoi21  g28(.a(new_n33_), .b(new_n23_), .c(new_n47_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n46_), .c(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  nor2   g31(.a(new_n37_), .b(x03), .O(new_n51_));
  ...
  nand3  g37(.a(new_n33_), .b(new_n23_), .c(new_n43_), .O(new_n57_));
  ...
  aoi21  g45(.a(x10), .b(new_n37_), .c(new_n64_), .O(z4));
endmodule
