...
module FAU ( 
  ...
  oai21  g08(.a(new_n24_), .b(x08), .c(x10), .O(new_n28_));
  ...
  nand3  g13(.a(new_n22_), .b(new_n32_), .c(new_n31_), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(new_n30_), .c(new_n28_), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(x03), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(x05), .O(z1));
  inv1   g17(.a(x11), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n32_), .c(new_n31_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n21_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n22_), .O(new_n40_));
  oai21  g21(.a(new_n33_), .b(new_n29_), .c(x11), .O(new_n41_));
  ...
  nand2  g27(.a(new_n29_), .b(x04), .O(new_n47_));
