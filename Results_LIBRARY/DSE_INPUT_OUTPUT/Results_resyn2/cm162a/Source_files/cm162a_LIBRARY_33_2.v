...
module FAU ( 
  ...
  nor2   g01(.a(x07), .b(new_n20_), .O(new_n21_));
  ...
  nor3   g21(.a(new_n40_), .b(new_n21_), .c(new_n29_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n39_), .O(z1));
  aoi21  g23(.a(x07), .b(x03), .c(new_n20_), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n33_), .c(new_n22_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n23_), .O(new_n46_));
  nand3  g27(.a(new_n36_), .b(new_n25_), .c(new_n23_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(x11), .c(new_n46_), .d(new_n25_), .O(new_n48_));
  inv1   g29(.a(new_n21_), .O(new_n49_));
  oai21  g30(.a(x06), .b(x03), .c(x05), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  oai21  g32(.a(new_n48_), .b(new_n43_), .c(new_n51_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  aoi21  g35(.a(new_n45_), .b(new_n23_), .c(new_n54_), .O(new_n55_));
  aoi21  g36(.a(x13), .b(x09), .c(new_n24_), .O(new_n56_));
