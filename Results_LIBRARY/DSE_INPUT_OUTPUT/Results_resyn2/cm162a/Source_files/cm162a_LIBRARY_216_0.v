...
module FAU ( 
  ...
  and2   g13(.a(new_n32_), .b(x03), .O(new_n33_));
  inv1   g14(.a(x08), .O(new_n34_));
  inv1   g15(.a(x10), .O(new_n35_));
  nand4  g16(.a(new_n35_), .b(new_n34_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nor2   g39(.a(x12), .b(x05), .O(new_n59_));
