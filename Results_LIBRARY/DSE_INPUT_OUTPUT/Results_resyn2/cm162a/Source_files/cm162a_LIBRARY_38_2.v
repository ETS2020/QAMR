...
module FAU ( 
  ...
  nand3  g10(.a(new_n29_), .b(new_n27_), .c(new_n24_), .O(new_n30_));
  nand3  g11(.a(new_n30_), .b(x05), .c(x03), .O(new_n31_));
  ...
  nand3  g16(.a(new_n35_), .b(new_n33_), .c(new_n29_), .O(new_n36_));
  ...
  nand3  g23(.a(new_n34_), .b(new_n26_), .c(new_n42_), .O(new_n43_));
  nand2  g24(.a(new_n35_), .b(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(new_n29_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x03), .O(new_n46_));
  inv1   g27(.a(x06), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n20_), .c(new_n39_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n34_), .b(new_n26_), .c(new_n50_), .d(new_n42_), .O(new_n51_));
  ...
  nand3  g36(.a(new_n28_), .b(new_n26_), .c(x05), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n51_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x03), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n20_), .c(new_n39_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(z3));
  nand2  g42(.a(new_n28_), .b(x04), .O(new_n62_));
  aoi21  g43(.a(new_n39_), .b(x03), .c(new_n62_), .O(z4));
endmodule
