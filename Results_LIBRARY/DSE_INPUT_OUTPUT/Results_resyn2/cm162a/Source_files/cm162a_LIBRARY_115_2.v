...
module FAU ( 
  ...
  nand2  g11(.a(new_n28_), .b(new_n27_), .O(new_n31_));
  ...
  nand3  g21(.a(new_n35_), .b(new_n23_), .c(new_n21_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(x11), .O(new_n42_));
  nor3   g23(.a(x11), .b(x10), .c(x08), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n33_), .c(new_n23_), .O(new_n44_));
  ...
  nand2  g31(.a(new_n35_), .b(new_n50_), .O(new_n51_));
  nand4  g32(.a(new_n21_), .b(x12), .c(x04), .d(x02), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x03), .O(new_n53_));
  aoi21  g34(.a(new_n44_), .b(new_n49_), .c(new_n53_), .O(new_n54_));
  nor2   g35(.a(x07), .b(x03), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(x05), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n31_), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  oai22  g39(.a(new_n21_), .b(new_n58_), .c(x05), .d(new_n27_), .O(z4));
endmodule
