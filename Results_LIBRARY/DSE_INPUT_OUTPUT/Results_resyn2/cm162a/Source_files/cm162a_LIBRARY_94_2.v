...
module FAU ( 
  ...
  oai21  g09(.a(new_n21_), .b(x08), .c(x10), .O(new_n29_));
  ...
  nand3  g14(.a(new_n22_), .b(new_n33_), .c(new_n32_), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(new_n31_), .c(new_n29_), .O(new_n35_));
  ...
  aoi21  g35(.a(new_n46_), .b(new_n52_), .c(new_n54_), .O(new_n55_));
  ...
  aoi21  g41(.a(new_n59_), .b(x05), .c(new_n60_), .O(z4));
endmodule
