...
module FAU ( 
  ...
  nand2  g07(.a(new_n24_), .b(new_n21_), .O(new_n27_));
  ...
  nand2  g13(.a(new_n32_), .b(new_n28_), .O(z1));
  aoi21  g14(.a(new_n30_), .b(new_n29_), .c(x11), .O(new_n34_));
  nor2   g15(.a(x10), .b(x08), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(x11), .O(new_n36_));
  oai21  g17(.a(new_n36_), .b(new_n22_), .c(x03), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(new_n34_), .c(x05), .O(z2));
  inv1   g19(.a(x04), .O(new_n39_));
  nor3   g20(.a(x11), .b(x10), .c(x08), .O(new_n40_));
  inv1   g21(.a(x02), .O(new_n41_));
  nor2   g22(.a(x12), .b(new_n41_), .O(new_n42_));
  inv1   g23(.a(x12), .O(new_n43_));
  nand3  g24(.a(x13), .b(x09), .c(x03), .O(new_n44_));
  aoi21  g25(.a(new_n43_), .b(new_n41_), .c(new_n44_), .O(new_n45_));
  aoi21  g26(.a(new_n42_), .b(new_n40_), .c(new_n45_), .O(new_n46_));
  inv1   g27(.a(x11), .O(new_n47_));
  nand4  g28(.a(new_n35_), .b(new_n47_), .c(x04), .d(x02), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(x12), .c(new_n31_), .O(new_n49_));
  oai21  g30(.a(new_n46_), .b(new_n39_), .c(new_n49_), .O(z3));
  nand3  g31(.a(x13), .b(x09), .c(x04), .O(new_n51_));
  aoi21  g32(.a(x05), .b(new_n20_), .c(new_n51_), .O(z4));
endmodule
