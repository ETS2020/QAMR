...
module FAU ( 
  ...
  oai21  g15(.a(new_n34_), .b(new_n33_), .c(new_n25_), .O(new_n35_));
  ...
  oai21  g22(.a(new_n41_), .b(new_n33_), .c(new_n25_), .O(new_n42_));
  nand3  g23(.a(new_n34_), .b(new_n25_), .c(new_n23_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(x11), .O(new_n44_));
  and2   g25(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  inv1   g26(.a(x06), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n37_), .c(new_n20_), .O(new_n47_));
  oai21  g28(.a(new_n45_), .b(new_n37_), .c(new_n47_), .O(z2));
  ...
  nand2  g37(.a(new_n56_), .b(new_n22_), .O(z3));
  nand2  g38(.a(x13), .b(x04), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x05), .c(new_n21_), .O(z4));
endmodule
