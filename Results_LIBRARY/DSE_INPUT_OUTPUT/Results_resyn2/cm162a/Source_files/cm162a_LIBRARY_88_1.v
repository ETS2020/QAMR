...
module FAU ( 
  ...
  nand2  g01(.a(x09), .b(new_n20_), .O(new_n21_));
  ...
  nand3  g18(.a(new_n27_), .b(new_n26_), .c(new_n25_), .O(new_n38_));
  ...
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n21_), .O(new_n57_));
  inv1   g38(.a(x09), .O(new_n58_));
  nand3  g39(.a(x07), .b(x04), .c(x02), .O(new_n59_));
  nor2   g40(.a(new_n59_), .b(new_n27_), .O(new_n60_));
  aoi21  g41(.a(new_n58_), .b(new_n32_), .c(new_n60_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n57_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  nor2   g44(.a(x07), .b(x03), .O(new_n64_));
  aoi22  g45(.a(new_n64_), .b(new_n58_), .c(x07), .d(new_n32_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n63_), .O(z3));
  nand2  g47(.a(x13), .b(x04), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(x07), .c(new_n58_), .O(z4));
endmodule
