...
module FAU ( 
  ...
  nand2  g14(.a(new_n22_), .b(new_n33_), .O(new_n34_));
  ...
  oai21  g20(.a(new_n35_), .b(new_n33_), .c(x11), .O(new_n40_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n40_), .c(x03), .O(new_n45_));
  ...
  nand2  g35(.a(new_n33_), .b(x04), .O(new_n55_));
