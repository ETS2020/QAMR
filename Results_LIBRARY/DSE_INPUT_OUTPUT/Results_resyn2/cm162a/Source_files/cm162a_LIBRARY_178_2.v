...
module FAU ( 
  ...
  nand2  g13(.a(new_n26_), .b(x01), .O(new_n33_));
  oai21  g14(.a(new_n32_), .b(new_n23_), .c(new_n33_), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(x10), .c(x05), .O(z1));
  inv1   g16(.a(x11), .O(new_n36_));
  nand3  g17(.a(new_n24_), .b(new_n36_), .c(x03), .O(new_n37_));
  aoi21  g18(.a(x06), .b(new_n26_), .c(new_n27_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x05), .O(z2));
  inv1   g21(.a(x12), .O(new_n41_));
  nand3  g22(.a(new_n24_), .b(new_n41_), .c(x03), .O(new_n42_));
  aoi21  g23(.a(x07), .b(new_n26_), .c(new_n27_), .O(new_n43_));
