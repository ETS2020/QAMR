...
module FAU ( 
  ...
  nor2   g12(.a(x07), .b(new_n31_), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(new_n30_), .c(new_n27_), .O(z0));
  ...
  aoi21  g19(.a(new_n29_), .b(x01), .c(x07), .O(new_n39_));
  ...
  nand3  g26(.a(new_n45_), .b(new_n42_), .c(new_n35_), .O(new_n46_));
  aoi21  g27(.a(x06), .b(new_n29_), .c(x07), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x05), .O(z2));
  nand2  g30(.a(new_n45_), .b(x12), .O(new_n50_));
  nand2  g31(.a(x13), .b(x09), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  nand3  g33(.a(new_n44_), .b(new_n52_), .c(new_n43_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  aoi21  g35(.a(new_n52_), .b(new_n20_), .c(new_n21_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n50_), .c(new_n32_), .d(x03), .O(z3));
  nand2  g38(.a(x07), .b(x05), .O(new_n58_));
  oai21  g39(.a(new_n51_), .b(new_n21_), .c(new_n58_), .O(z4));
endmodule
