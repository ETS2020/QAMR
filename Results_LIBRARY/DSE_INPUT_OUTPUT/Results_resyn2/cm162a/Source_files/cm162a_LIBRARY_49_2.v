...
module FAU ( 
  ...
  oai21  g16(.a(new_n20_), .b(x08), .c(x10), .O(new_n36_));
  nor2   g17(.a(x10), .b(x08), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(x04), .c(x02), .O(new_n38_));
  nand3  g19(.a(new_n38_), .b(new_n36_), .c(new_n26_), .O(new_n39_));
  nor2   g20(.a(new_n31_), .b(new_n30_), .O(new_n40_));
  ...
  nand3  g26(.a(new_n37_), .b(new_n23_), .c(new_n45_), .O(new_n46_));
  nand2  g27(.a(new_n38_), .b(x11), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n46_), .c(new_n26_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n40_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n44_), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n37_), .b(new_n23_), .c(new_n51_), .d(new_n45_), .O(new_n52_));
  ...
  nand3  g37(.a(new_n25_), .b(new_n23_), .c(x05), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n56_), .c(new_n52_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n30_), .c(new_n31_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  nand2  g43(.a(new_n25_), .b(x04), .O(new_n63_));
  aoi21  g44(.a(new_n31_), .b(x03), .c(new_n63_), .O(z4));
endmodule
