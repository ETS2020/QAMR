// Benchmark "FAU" written by ABC on Sat Aug  8 23:02:52 2020
...
module FAU ( 
  ...
  oai21  g09(.a(new_n20_), .b(x08), .c(x10), .O(new_n29_));
  nand2  g10(.a(new_n22_), .b(new_n25_), .O(new_n30_));
  inv1   g11(.a(x10), .O(new_n31_));
  nand3  g12(.a(new_n25_), .b(new_n31_), .c(new_n24_), .O(new_n32_));
  ...
  oai21  g16(.a(new_n32_), .b(new_n22_), .c(x11), .O(new_n36_));
  inv1   g17(.a(x11), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n31_), .c(new_n24_), .O(new_n38_));
  ...
  nand2  g27(.a(new_n22_), .b(x04), .O(new_n47_));
  aoi21  g28(.a(x05), .b(new_n46_), .c(new_n47_), .O(z4));
endmodule
