...
module FAU ( 
  ...
  nand3  g08(.a(x05), .b(new_n20_), .c(new_n27_), .O(new_n28_));
  ...
  aoi21  g27(.a(new_n46_), .b(new_n20_), .c(new_n38_), .O(new_n47_));
  ...
  aoi21  g33(.a(new_n52_), .b(new_n20_), .c(new_n38_), .O(new_n53_));
  oai21  g34(.a(new_n51_), .b(new_n49_), .c(new_n53_), .O(z3));
  nand3  g35(.a(x13), .b(x09), .c(x04), .O(new_n55_));
  aoi21  g36(.a(new_n38_), .b(new_n20_), .c(new_n55_), .O(z4));
endmodule
