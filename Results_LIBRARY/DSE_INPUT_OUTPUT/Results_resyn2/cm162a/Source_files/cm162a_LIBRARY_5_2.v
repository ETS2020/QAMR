...
module FAU ( 
  ...
  nor2   g04(.a(new_n23_), .b(x13), .O(new_n24_));
  ...
  oai21  g16(.a(new_n35_), .b(x13), .c(new_n22_), .O(new_n36_));
  ...
  oai21  g41(.a(x09), .b(new_n27_), .c(new_n60_), .O(z4));
endmodule
