...
module FAU ( 
  ...
  oai21  g12(.a(new_n31_), .b(new_n23_), .c(x03), .O(new_n32_));
  inv1   g13(.a(x01), .O(new_n33_));
  nand2  g14(.a(x10), .b(x05), .O(new_n34_));
  aoi21  g15(.a(new_n26_), .b(new_n33_), .c(new_n34_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n32_), .O(z1));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n26_), .c(new_n34_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z3));
  nand2  g27(.a(new_n27_), .b(x05), .O(new_n47_));
  nand2  g28(.a(new_n31_), .b(x04), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n47_), .O(z4));
endmodule
