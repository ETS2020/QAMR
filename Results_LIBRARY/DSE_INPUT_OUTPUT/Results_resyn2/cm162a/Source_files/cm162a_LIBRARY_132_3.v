...
module FAU ( 
  ...
  nand2  g22(.a(new_n36_), .b(x11), .O(new_n42_));
  inv1   g23(.a(x11), .O(new_n43_));
  nor2   g24(.a(x10), .b(x08), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n23_), .c(new_n43_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n42_), .c(new_n26_), .O(new_n46_));
  ...
  nand3  g34(.a(new_n53_), .b(new_n25_), .c(new_n30_), .O(new_n54_));
  nand4  g35(.a(new_n44_), .b(new_n52_), .c(new_n43_), .d(x02), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x04), .O(new_n57_));
  nand3  g38(.a(new_n30_), .b(x05), .c(x03), .O(new_n58_));
  aoi21  g39(.a(new_n45_), .b(x12), .c(new_n58_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(z3));
  nand2  g41(.a(new_n25_), .b(x04), .O(new_n61_));
  aoi21  g42(.a(x07), .b(x05), .c(new_n61_), .O(z4));
endmodule
