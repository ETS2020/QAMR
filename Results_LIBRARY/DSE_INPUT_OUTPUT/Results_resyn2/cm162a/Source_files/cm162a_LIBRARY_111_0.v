...
module FAU ( 
  ...
  aoi21  g04(.a(new_n23_), .b(new_n22_), .c(new_n21_), .O(new_n24_));
  ...
  oai21  g16(.a(new_n25_), .b(x08), .c(x10), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(new_n37_));
  ...
  nand3  g26(.a(new_n34_), .b(new_n23_), .c(new_n22_), .O(new_n46_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n29_), .c(new_n30_), .O(new_n55_));
  oai21  g36(.a(new_n53_), .b(new_n51_), .c(new_n55_), .O(z3));
  inv1   g37(.a(x04), .O(new_n57_));
  oai22  g38(.a(new_n22_), .b(new_n57_), .c(x11), .d(x05), .O(z4));
endmodule
