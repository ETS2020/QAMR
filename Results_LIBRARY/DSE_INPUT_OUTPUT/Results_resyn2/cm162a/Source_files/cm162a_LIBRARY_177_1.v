...
module FAU ( 
  ...
  oai21  g07(.a(x03), .b(new_n26_), .c(x05), .O(new_n27_));
  oai22  g08(.a(new_n27_), .b(new_n25_), .c(x11), .d(x05), .O(z0));
  oai21  g09(.a(new_n23_), .b(x08), .c(x10), .O(new_n29_));
  nand3  g10(.a(new_n21_), .b(x13), .c(x09), .O(new_n30_));
  ...
  nor2   g27(.a(new_n42_), .b(new_n37_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n21_), .O(new_n48_));
  oai21  g29(.a(x06), .b(x03), .c(x05), .O(new_n49_));
  oai21  g30(.a(new_n42_), .b(x05), .c(new_n49_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n36_), .c(new_n50_), .O(z2));
  aoi21  g32(.a(new_n45_), .b(new_n21_), .c(x12), .O(new_n52_));
  nor3   g33(.a(x11), .b(x10), .c(x08), .O(new_n53_));
  nand4  g34(.a(new_n44_), .b(new_n53_), .c(new_n21_), .d(x12), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n36_), .c(new_n37_), .O(new_n57_));
  oai21  g38(.a(new_n55_), .b(new_n52_), .c(new_n57_), .O(z3));
  nand3  g39(.a(x13), .b(x09), .c(x04), .O(new_n59_));
  aoi21  g40(.a(x11), .b(new_n37_), .c(new_n59_), .O(z4));
endmodule
