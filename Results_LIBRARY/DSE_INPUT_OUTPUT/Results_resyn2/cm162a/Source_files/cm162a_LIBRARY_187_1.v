...
module FAU ( 
  ...
  aoi21  g12(.a(new_n31_), .b(new_n21_), .c(new_n24_), .O(new_n32_));
  ...
  nand3  g17(.a(new_n36_), .b(new_n28_), .c(new_n35_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n21_), .O(new_n38_));
  nand3  g19(.a(new_n30_), .b(new_n22_), .c(new_n21_), .O(new_n39_));
