...
module FAU ( 
  ...
  nand4  g33(.a(new_n42_), .b(new_n44_), .c(new_n52_), .d(new_n22_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  aoi22  g35(.a(new_n54_), .b(new_n23_), .c(new_n45_), .d(x12), .O(new_n55_));
  ...
  aoi21  g40(.a(x12), .b(new_n31_), .c(new_n59_), .O(z4));
endmodule
