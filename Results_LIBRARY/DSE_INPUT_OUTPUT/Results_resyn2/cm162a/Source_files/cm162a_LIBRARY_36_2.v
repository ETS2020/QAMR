...
module FAU ( 
  ...
  oai21  g15(.a(new_n25_), .b(new_n34_), .c(x03), .O(new_n35_));
  inv1   g16(.a(x09), .O(new_n36_));
  aoi21  g17(.a(new_n20_), .b(x01), .c(new_n36_), .O(new_n37_));
  oai21  g18(.a(new_n35_), .b(new_n33_), .c(new_n37_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(x05), .O(z1));
  nor3   g20(.a(x11), .b(x10), .c(x08), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(x13), .c(new_n23_), .O(new_n41_));
  oai21  g22(.a(new_n32_), .b(new_n24_), .c(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(x03), .O(new_n43_));
  aoi21  g24(.a(x06), .b(new_n20_), .c(new_n36_), .O(new_n44_));
  ...
  aoi21  g29(.a(new_n31_), .b(new_n48_), .c(x13), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n22_), .c(new_n47_), .O(new_n50_));
  nand4  g31(.a(new_n21_), .b(x12), .c(x04), .d(x02), .O(new_n51_));
  inv1   g32(.a(new_n51_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n40_), .c(new_n20_), .O(new_n53_));
  nor2   g34(.a(x07), .b(x03), .O(new_n54_));
  aoi21  g35(.a(new_n53_), .b(new_n50_), .c(new_n54_), .O(new_n55_));
