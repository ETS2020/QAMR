...
module FAU ( 
  ...
  nand3  g18(.a(new_n37_), .b(new_n35_), .c(new_n26_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(x03), .O(new_n39_));
  inv1   g20(.a(x01), .O(new_n40_));
  aoi21  g21(.a(new_n20_), .b(new_n40_), .c(new_n31_), .O(new_n41_));
  ...
  nand3  g26(.a(new_n36_), .b(new_n24_), .c(new_n45_), .O(new_n46_));
  nand2  g27(.a(new_n37_), .b(x11), .O(new_n47_));
  ...
  nand4  g32(.a(new_n36_), .b(new_n24_), .c(new_n51_), .d(new_n45_), .O(new_n52_));
