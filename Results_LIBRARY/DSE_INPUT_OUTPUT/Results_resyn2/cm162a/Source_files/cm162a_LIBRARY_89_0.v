...
module FAU ( 
  ...
  aoi21  g17(.a(new_n36_), .b(new_n34_), .c(new_n29_), .O(new_n37_));
  oai21  g18(.a(x03), .b(x01), .c(x05), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n37_), .c(new_n33_), .O(new_n39_));
  inv1   g20(.a(new_n25_), .O(new_n40_));
  nand2  g21(.a(new_n21_), .b(new_n35_), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n40_), .c(x03), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n39_), .O(z1));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n35_), .c(new_n23_), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n25_), .c(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n25_), .b(new_n22_), .c(new_n35_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(x11), .c(new_n46_), .O(new_n48_));
  nor2   g29(.a(x06), .b(x03), .O(new_n49_));
  nand2  g30(.a(new_n33_), .b(x05), .O(new_n50_));
  nor2   g31(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  oai21  g32(.a(new_n48_), .b(new_n29_), .c(new_n51_), .O(z2));
  nor2   g33(.a(new_n46_), .b(x12), .O(new_n53_));
  inv1   g34(.a(new_n22_), .O(new_n54_));
  nand4  g35(.a(new_n25_), .b(x12), .c(new_n44_), .d(new_n35_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(x03), .O(new_n56_));
  nor2   g37(.a(x07), .b(x03), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(new_n50_), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n53_), .c(new_n58_), .O(z3));
  nand2  g40(.a(new_n40_), .b(x04), .O(new_n60_));
