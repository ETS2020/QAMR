...
module FAU ( 
  ...
  nand3  g17(.a(new_n36_), .b(new_n34_), .c(new_n22_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x03), .O(new_n38_));
  nor2   g19(.a(x03), .b(x01), .O(new_n39_));
  nor2   g20(.a(new_n39_), .b(new_n31_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n38_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nor2   g23(.a(x10), .b(x08), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(new_n42_), .c(x04), .d(x02), .O(new_n44_));
  ...
  nor2   g29(.a(new_n48_), .b(new_n31_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n47_), .O(z2));
  nand2  g31(.a(x13), .b(x09), .O(new_n51_));
  nor2   g32(.a(x12), .b(x02), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n43_), .b(new_n53_), .c(new_n42_), .d(x02), .O(new_n54_));
  oai21  g35(.a(new_n52_), .b(new_n51_), .c(new_n54_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x04), .O(new_n56_));
  nand3  g37(.a(new_n30_), .b(x05), .c(x03), .O(new_n57_));
  aoi21  g38(.a(new_n44_), .b(x12), .c(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(z3));
  nand2  g40(.a(x07), .b(x05), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n20_), .O(z4));
endmodule
