...
module FAU ( 
  ...
  nand3  g15(.a(new_n24_), .b(new_n34_), .c(new_n33_), .O(new_n35_));
  nand4  g16(.a(new_n35_), .b(new_n32_), .c(new_n31_), .d(x03), .O(new_n36_));
  ...
  nand3  g22(.a(new_n41_), .b(new_n34_), .c(new_n33_), .O(new_n42_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n37_), .c(new_n20_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n37_), .c(new_n50_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n22_), .b(x12), .c(x04), .d(x02), .O(new_n53_));
  ...
  nand2  g38(.a(new_n57_), .b(new_n21_), .O(z3));
  inv1   g39(.a(x04), .O(new_n59_));
  oai22  g40(.a(new_n22_), .b(new_n59_), .c(x05), .d(x01), .O(z4));
endmodule
