...
module FAU ( 
  ...
  nand4  g17(.a(new_n23_), .b(new_n22_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nand3  g28(.a(new_n35_), .b(new_n24_), .c(new_n23_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n49_));
  inv1   g30(.a(x10), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n23_), .c(new_n26_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(x11), .c(x03), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n49_), .c(new_n45_), .O(z2));
  nor2   g35(.a(new_n47_), .b(x11), .O(new_n55_));
  aoi21  g36(.a(new_n23_), .b(x11), .c(x12), .O(new_n56_));
  aoi22  g37(.a(new_n56_), .b(new_n52_), .c(new_n55_), .d(new_n48_), .O(new_n57_));
  ...
  nand3  g41(.a(new_n34_), .b(new_n20_), .c(x04), .O(new_n61_));
