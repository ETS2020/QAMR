...
module FAU ( 
  ...
  nand2  g08(.a(x09), .b(x05), .O(new_n28_));
  ...
  nand2  g12(.a(new_n23_), .b(x13), .O(new_n32_));
  ...
  aoi21  g17(.a(new_n20_), .b(x01), .c(new_n36_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(x05), .O(z1));
  inv1   g20(.a(x11), .O(new_n40_));
  aoi21  g21(.a(new_n33_), .b(new_n40_), .c(x13), .O(new_n41_));
  nor2   g22(.a(new_n41_), .b(new_n22_), .O(new_n42_));
  nand3  g23(.a(new_n33_), .b(new_n23_), .c(new_n21_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(x11), .c(new_n42_), .O(new_n44_));
  ...
  oai21  g29(.a(new_n41_), .b(new_n22_), .c(new_n48_), .O(new_n49_));
  nor3   g30(.a(x11), .b(x10), .c(x08), .O(new_n50_));
  nand4  g31(.a(new_n21_), .b(x12), .c(x04), .d(x02), .O(new_n51_));
  inv1   g32(.a(new_n51_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n50_), .c(new_n20_), .O(new_n53_));
  nor2   g34(.a(x07), .b(x03), .O(new_n54_));
  aoi21  g35(.a(new_n53_), .b(new_n49_), .c(new_n54_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n36_), .c(x05), .O(z3));
