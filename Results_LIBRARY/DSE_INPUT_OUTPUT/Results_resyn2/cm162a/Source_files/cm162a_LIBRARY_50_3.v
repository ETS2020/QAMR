...
module FAU ( 
  ...
  nand2  g09(.a(new_n21_), .b(new_n28_), .O(new_n29_));
  nand4  g10(.a(new_n29_), .b(new_n27_), .c(x05), .d(new_n20_), .O(z1));
  nand2  g11(.a(x06), .b(new_n21_), .O(new_n31_));
  inv1   g12(.a(x11), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(x03), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(new_n31_), .c(new_n20_), .O(new_n34_));
  ...
  nand4  g19(.a(new_n38_), .b(new_n36_), .c(x05), .d(new_n20_), .O(z3));
  nand2  g20(.a(x05), .b(x02), .O(new_n40_));
  nand3  g21(.a(x13), .b(x09), .c(x04), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(z4));
endmodule
