...
module FAU ( 
  ...
  nand2  g20(.a(new_n30_), .b(x11), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n22_), .c(x03), .O(new_n41_));
  ...
  nand2  g26(.a(new_n30_), .b(new_n45_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n22_), .c(x12), .O(new_n47_));
  inv1   g28(.a(new_n23_), .O(new_n48_));
  inv1   g29(.a(x08), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n45_), .c(new_n33_), .d(new_n49_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n21_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n47_), .c(x03), .O(new_n54_));
  aoi21  g35(.a(x07), .b(new_n20_), .c(new_n35_), .O(new_n55_));
  ...
  oai22  g40(.a(new_n21_), .b(new_n58_), .c(new_n59_), .d(x01), .O(z4));
endmodule
