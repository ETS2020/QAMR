...
module FAU ( 
  ...
  nor2   g16(.a(new_n27_), .b(new_n35_), .O(new_n36_));
  nor2   g17(.a(x10), .b(x08), .O(new_n37_));
  inv1   g18(.a(new_n37_), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(new_n23_), .c(new_n26_), .O(new_n39_));
  oai21  g20(.a(new_n39_), .b(new_n36_), .c(new_n30_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n34_), .O(z1));
  inv1   g22(.a(x08), .O(new_n42_));
  inv1   g23(.a(x11), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n35_), .c(new_n42_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n23_), .O(new_n45_));
  nand3  g26(.a(new_n37_), .b(new_n24_), .c(new_n23_), .O(new_n46_));
