...
module FAU ( 
  ...
  nand4  g21(.a(new_n40_), .b(new_n38_), .c(x10), .d(x05), .O(z2));
  inv1   g22(.a(x12), .O(new_n42_));
  nand3  g23(.a(new_n24_), .b(new_n42_), .c(x03), .O(new_n43_));
  aoi21  g24(.a(x07), .b(new_n26_), .c(new_n27_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x05), .O(z3));
