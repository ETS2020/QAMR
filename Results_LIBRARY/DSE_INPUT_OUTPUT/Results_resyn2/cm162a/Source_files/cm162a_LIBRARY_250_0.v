...
module FAU ( 
  ...
  nand2  g30(.a(x07), .b(new_n20_), .O(new_n50_));
  nor3   g31(.a(x11), .b(x10), .c(x08), .O(new_n51_));
  nor2   g32(.a(new_n49_), .b(new_n20_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n51_), .c(new_n22_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n50_), .c(new_n27_), .O(new_n54_));
  oai21  g35(.a(new_n42_), .b(new_n20_), .c(x05), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n49_), .c(new_n54_), .O(z3));
  nand3  g37(.a(x13), .b(x09), .c(x04), .O(new_n57_));
  aoi21  g38(.a(new_n49_), .b(new_n27_), .c(new_n57_), .O(z4));
endmodule
