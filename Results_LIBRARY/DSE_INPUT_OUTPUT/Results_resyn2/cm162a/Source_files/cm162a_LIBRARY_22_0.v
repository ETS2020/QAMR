...
module FAU ( 
  ...
  oai21  g11(.a(new_n27_), .b(x08), .c(x10), .O(new_n31_));
  ...
  aoi21  g20(.a(new_n21_), .b(new_n38_), .c(new_n39_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n37_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n34_), .b(new_n25_), .c(new_n42_), .O(new_n43_));
  ...
  aoi21  g28(.a(new_n47_), .b(new_n21_), .c(new_n39_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n34_), .b(new_n25_), .c(new_n50_), .d(new_n42_), .O(new_n51_));
