...
module FAU ( 
  ...
  oai21  g13(.a(new_n32_), .b(x13), .c(new_n23_), .O(new_n33_));
  oai21  g14(.a(new_n25_), .b(new_n31_), .c(new_n33_), .O(new_n34_));
  ...
  aoi21  g20(.a(new_n32_), .b(new_n39_), .c(x13), .O(new_n40_));
  nor2   g21(.a(new_n40_), .b(new_n22_), .O(new_n41_));
  nand3  g22(.a(new_n32_), .b(new_n23_), .c(new_n21_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(x11), .c(new_n41_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n40_), .b(new_n22_), .c(new_n48_), .O(new_n49_));
  ...
  oai21  g36(.a(new_n55_), .b(new_n47_), .c(x05), .O(z3));
