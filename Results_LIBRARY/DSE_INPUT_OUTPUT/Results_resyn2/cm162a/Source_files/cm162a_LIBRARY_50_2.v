...
module FAU ( 
  ...
  oai21  g22(.a(x06), .b(x03), .c(x05), .O(new_n42_));
  oai21  g23(.a(x05), .b(new_n41_), .c(new_n42_), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nor2   g25(.a(new_n44_), .b(x10), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n21_), .c(new_n24_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(x05), .c(new_n41_), .O(new_n47_));
  oai21  g28(.a(new_n34_), .b(x11), .c(x03), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(new_n43_), .O(z2));
  nand2  g30(.a(x07), .b(new_n30_), .O(new_n50_));
  inv1   g31(.a(x12), .O(new_n51_));
  nor2   g32(.a(x10), .b(x08), .O(new_n52_));
  nor2   g33(.a(new_n25_), .b(x11), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  nand3  g35(.a(new_n44_), .b(x04), .c(x02), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n33_), .c(x12), .O(new_n56_));
  nand4  g37(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n57_));
  and2   g38(.a(new_n57_), .b(x03), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n50_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x05), .O(z3));
  oai22  g42(.a(new_n31_), .b(new_n20_), .c(x05), .d(new_n41_), .O(z4));
endmodule
