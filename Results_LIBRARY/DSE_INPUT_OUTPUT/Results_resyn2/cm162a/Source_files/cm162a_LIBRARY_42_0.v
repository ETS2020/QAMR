...
module FAU ( 
  ...
  nor2   g20(.a(x10), .b(new_n27_), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n22_), .c(x11), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(x05), .c(x08), .O(new_n42_));
  oai21  g23(.a(new_n34_), .b(x11), .c(x03), .O(new_n43_));
  inv1   g24(.a(x06), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n27_), .c(new_n28_), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n43_), .c(new_n42_), .O(z2));
  inv1   g27(.a(x12), .O(new_n47_));
  nor2   g28(.a(new_n47_), .b(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n40_), .c(new_n22_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x05), .c(x08), .O(new_n50_));
  inv1   g31(.a(new_n21_), .O(new_n51_));
  oai21  g32(.a(x10), .b(x08), .c(new_n31_), .O(new_n52_));
  nand2  g33(.a(new_n31_), .b(x11), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n47_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x03), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n27_), .c(new_n28_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(new_n50_), .O(z3));
  nand3  g40(.a(x13), .b(x09), .c(x04), .O(new_n60_));
  aoi21  g41(.a(new_n20_), .b(new_n28_), .c(new_n60_), .O(z4));
endmodule
