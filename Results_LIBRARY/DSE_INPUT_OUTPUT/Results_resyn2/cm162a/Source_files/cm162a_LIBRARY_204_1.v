...
module FAU ( 
  ...
  nor2   g13(.a(x11), .b(x05), .O(new_n33_));
  ...
  nand4  g18(.a(new_n37_), .b(new_n35_), .c(new_n25_), .d(x03), .O(new_n38_));
  ...
  nor2   g31(.a(new_n30_), .b(x03), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n50_), .c(new_n33_), .O(new_n52_));
  ...
  aoi21  g42(.a(new_n51_), .b(new_n61_), .c(new_n33_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  nand3  g44(.a(x13), .b(x09), .c(x04), .O(new_n64_));
  oai21  g45(.a(new_n43_), .b(x05), .c(new_n64_), .O(z4));
endmodule
