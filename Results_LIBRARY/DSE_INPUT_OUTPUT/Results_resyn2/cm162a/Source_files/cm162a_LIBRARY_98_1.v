...
module FAU ( 
  ...
  nor2   g11(.a(x11), .b(x05), .O(new_n31_));
  ...
  aoi21  g19(.a(new_n27_), .b(x01), .c(new_n28_), .O(new_n39_));
  ...
  aoi21  g26(.a(new_n45_), .b(new_n44_), .c(new_n34_), .O(new_n46_));
  nand2  g27(.a(x11), .b(x05), .O(new_n47_));
  aoi21  g28(.a(new_n36_), .b(new_n21_), .c(new_n47_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n46_), .c(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  nor2   g31(.a(new_n28_), .b(x03), .O(new_n51_));
  ...
  nand3  g37(.a(new_n36_), .b(new_n21_), .c(new_n43_), .O(new_n57_));
  ...
  aoi21  g42(.a(new_n51_), .b(new_n61_), .c(new_n31_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  nand2  g44(.a(new_n22_), .b(x04), .O(new_n64_));
  aoi21  g45(.a(x11), .b(new_n28_), .c(new_n64_), .O(z4));
endmodule
