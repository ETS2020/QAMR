...
module FAU ( 
  ...
  aoi21  g16(.a(new_n35_), .b(new_n21_), .c(new_n24_), .O(new_n36_));
  oai21  g17(.a(new_n36_), .b(new_n33_), .c(new_n31_), .O(new_n37_));
  nand2  g18(.a(x05), .b(x01), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n20_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n37_), .O(z1));
  inv1   g21(.a(new_n31_), .O(new_n41_));
  ...
  nand3  g26(.a(new_n34_), .b(new_n22_), .c(new_n21_), .O(new_n46_));
  ...
  oai21  g30(.a(new_n47_), .b(new_n41_), .c(new_n49_), .O(z2));
