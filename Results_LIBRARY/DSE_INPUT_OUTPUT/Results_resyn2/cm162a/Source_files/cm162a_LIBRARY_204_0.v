...
module FAU ( 
  ...
  aoi21  g18(.a(new_n29_), .b(x01), .c(new_n30_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  oai21  g20(.a(new_n33_), .b(x05), .c(new_n39_), .O(z1));
  nand2  g21(.a(x13), .b(x09), .O(new_n41_));
  nand3  g22(.a(new_n35_), .b(new_n41_), .c(new_n23_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x11), .O(new_n43_));
  inv1   g24(.a(x10), .O(new_n44_));
  nand3  g25(.a(new_n33_), .b(new_n44_), .c(new_n22_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n41_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n23_), .c(x05), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n43_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x03), .O(new_n49_));
  oai21  g30(.a(x06), .b(x03), .c(x05), .O(new_n50_));
  oai21  g31(.a(x11), .b(x05), .c(new_n50_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n49_), .O(z2));
  and2   g33(.a(x12), .b(x03), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n35_), .c(new_n41_), .d(new_n23_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(x05), .c(x11), .O(new_n55_));
  aoi21  g36(.a(new_n45_), .b(new_n41_), .c(new_n20_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(x12), .c(x03), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n29_), .c(new_n30_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n57_), .c(new_n55_), .O(z3));
  inv1   g41(.a(x04), .O(new_n61_));
  oai22  g42(.a(new_n41_), .b(new_n61_), .c(x11), .d(x05), .O(z4));
endmodule
