...
module FAU ( 
  ...
  nand3  g21(.a(new_n40_), .b(new_n34_), .c(new_n21_), .O(new_n41_));
  ...
  oai21  g33(.a(new_n52_), .b(new_n41_), .c(x03), .O(new_n53_));
  aoi21  g34(.a(new_n43_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  ...
  oai22  g39(.a(new_n24_), .b(new_n58_), .c(x05), .d(x01), .O(z4));
endmodule
