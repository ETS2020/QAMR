...
module FAU ( 
  ...
  nand3  g16(.a(new_n25_), .b(new_n35_), .c(new_n34_), .O(new_n36_));
  nand4  g17(.a(new_n36_), .b(new_n33_), .c(new_n32_), .d(x03), .O(new_n37_));
  inv1   g18(.a(x03), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(x01), .c(new_n20_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n22_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n35_), .c(new_n34_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n23_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n25_), .O(new_n45_));
  inv1   g26(.a(new_n45_), .O(new_n46_));
  inv1   g27(.a(new_n36_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n23_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(x11), .c(new_n46_), .O(new_n49_));
  aoi21  g30(.a(new_n21_), .b(new_n38_), .c(new_n20_), .O(new_n50_));
  oai21  g31(.a(new_n49_), .b(new_n38_), .c(new_n50_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n23_), .b(x12), .c(x04), .d(x02), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n43_), .c(x03), .O(new_n54_));
  aoi21  g35(.a(new_n45_), .b(new_n52_), .c(new_n54_), .O(new_n55_));
  nor2   g36(.a(x07), .b(x03), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n55_), .c(x05), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n22_), .O(z3));
  inv1   g39(.a(x04), .O(new_n59_));
  oai22  g40(.a(new_n23_), .b(new_n59_), .c(new_n21_), .d(x05), .O(z4));
endmodule
