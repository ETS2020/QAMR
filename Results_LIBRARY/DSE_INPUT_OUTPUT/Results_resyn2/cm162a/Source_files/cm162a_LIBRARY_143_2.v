...
module FAU ( 
  ...
  aoi21  g22(.a(new_n41_), .b(new_n38_), .c(new_n31_), .O(z1));
  oai21  g23(.a(new_n35_), .b(x10), .c(x11), .O(new_n43_));
  oai21  g24(.a(x10), .b(x08), .c(new_n23_), .O(new_n44_));
  nand2  g25(.a(new_n23_), .b(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n44_), .c(new_n22_), .O(new_n46_));
  ...
  oai21  g32(.a(new_n35_), .b(x10), .c(x12), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand3  g34(.a(new_n44_), .b(new_n22_), .c(new_n53_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n52_), .c(new_n27_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x03), .O(new_n56_));
  nor2   g37(.a(x07), .b(x03), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(new_n28_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(z3));
  nand2  g40(.a(new_n32_), .b(x04), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n31_), .O(z4));
endmodule
