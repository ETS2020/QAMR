...
module FAU ( 
  ...
  nor2   g06(.a(new_n25_), .b(new_n21_), .O(new_n26_));
  aoi21  g07(.a(new_n22_), .b(new_n21_), .c(new_n26_), .O(new_n27_));
  ...
  nand2  g21(.a(x05), .b(new_n20_), .O(new_n41_));
  oai21  g22(.a(new_n34_), .b(new_n23_), .c(x11), .O(new_n42_));
  nor3   g23(.a(x11), .b(x10), .c(x08), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n23_), .c(new_n22_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n42_), .c(x05), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x03), .O(new_n46_));
  oai21  g27(.a(new_n41_), .b(x06), .c(new_n46_), .O(z2));
  inv1   g28(.a(x12), .O(new_n48_));
  nand2  g29(.a(new_n44_), .b(new_n48_), .O(new_n49_));
  nand3  g30(.a(new_n43_), .b(new_n25_), .c(x12), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n49_), .c(new_n29_), .O(new_n51_));
  or2    g32(.a(new_n41_), .b(x07), .O(new_n52_));
  oai21  g33(.a(new_n51_), .b(new_n20_), .c(new_n52_), .O(z3));
  nand2  g34(.a(new_n23_), .b(x04), .O(new_n54_));
  oai21  g35(.a(x05), .b(x03), .c(new_n54_), .O(z4));
endmodule
