...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_;
  ...
  nand3  g14(.a(new_n33_), .b(new_n32_), .c(new_n24_), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(x03), .O(new_n35_));
  inv1   g16(.a(x01), .O(new_n36_));
  nand2  g17(.a(x11), .b(x05), .O(new_n37_));
  ...
  aoi21  g22(.a(x06), .b(new_n26_), .c(new_n27_), .O(new_n42_));
  oai21  g23(.a(new_n41_), .b(new_n32_), .c(new_n42_), .O(new_n43_));
  ...
  aoi21  g28(.a(new_n47_), .b(new_n26_), .c(new_n37_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(z3));
  nand3  g30(.a(x13), .b(x09), .c(x04), .O(new_n50_));
  aoi21  g31(.a(new_n27_), .b(x05), .c(new_n50_), .O(z4));
endmodule
