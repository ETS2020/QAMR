...
module FAU ( 
  ...
  aoi21  g13(.a(new_n32_), .b(new_n31_), .c(new_n20_), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n30_), .O(z1));
  inv1   g15(.a(x11), .O(new_n35_));
  nand3  g16(.a(new_n28_), .b(new_n35_), .c(x03), .O(new_n36_));
  inv1   g17(.a(x08), .O(new_n37_));
  aoi21  g18(.a(x06), .b(new_n32_), .c(new_n37_), .O(new_n38_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n32_), .c(new_n20_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z3));
  nand3  g27(.a(x13), .b(x09), .c(x04), .O(new_n47_));
  aoi21  g28(.a(new_n37_), .b(x05), .c(new_n47_), .O(z4));
endmodule
