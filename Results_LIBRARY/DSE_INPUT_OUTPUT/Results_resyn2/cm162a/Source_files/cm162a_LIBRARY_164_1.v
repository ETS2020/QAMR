...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n32_), .c(new_n24_), .O(new_n34_));
  nand2  g15(.a(x10), .b(x05), .O(new_n35_));
  ...
  oai21  g20(.a(new_n38_), .b(x05), .c(new_n39_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n37_), .O(z1));
  inv1   g22(.a(x08), .O(new_n42_));
  inv1   g23(.a(x11), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n38_), .c(new_n42_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n31_), .b(new_n22_), .c(new_n21_), .O(new_n46_));
  ...
  nand2  g31(.a(new_n44_), .b(new_n33_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n22_), .c(x12), .O(new_n52_));
  nand3  g33(.a(new_n33_), .b(new_n22_), .c(x12), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n44_), .c(x03), .O(new_n54_));
  ...
  aoi21  g39(.a(x10), .b(new_n28_), .c(new_n58_), .O(z4));
endmodule
