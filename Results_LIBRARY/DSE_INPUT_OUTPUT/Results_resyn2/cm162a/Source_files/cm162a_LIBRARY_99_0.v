...
module FAU ( 
  ...
  nand3  g07(.a(new_n26_), .b(new_n25_), .c(new_n21_), .O(new_n27_));
  ...
  nand3  g17(.a(new_n36_), .b(new_n34_), .c(new_n21_), .O(new_n37_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n52_), .c(new_n35_), .d(new_n22_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n51_), .c(new_n23_), .O(new_n55_));
  nand2  g36(.a(x12), .b(x05), .O(new_n56_));
  aoi21  g37(.a(new_n42_), .b(new_n24_), .c(new_n56_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n55_), .c(x03), .O(new_n58_));
  oai21  g39(.a(x07), .b(x03), .c(x05), .O(new_n59_));
  oai21  g40(.a(x05), .b(x02), .c(new_n59_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(z3));
  nand2  g42(.a(new_n20_), .b(x04), .O(new_n62_));
  oai21  g43(.a(x05), .b(x02), .c(new_n62_), .O(z4));
endmodule
