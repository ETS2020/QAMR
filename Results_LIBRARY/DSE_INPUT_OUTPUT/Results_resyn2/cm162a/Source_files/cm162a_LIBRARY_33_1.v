...
module FAU ( 
  ...
  nand2  g20(.a(new_n21_), .b(x05), .O(new_n40_));
  ...
  oai21  g27(.a(new_n46_), .b(new_n45_), .c(new_n25_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n44_), .O(new_n48_));
  aoi21  g29(.a(x13), .b(x09), .c(new_n27_), .O(new_n49_));
  nand3  g30(.a(x11), .b(new_n35_), .c(new_n23_), .O(new_n50_));
  inv1   g31(.a(new_n50_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n49_), .c(new_n31_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  aoi21  g34(.a(new_n20_), .b(new_n31_), .c(new_n32_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n22_), .O(z2));
  nand2  g36(.a(new_n46_), .b(new_n44_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n24_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n25_), .c(x12), .O(new_n58_));
  nand2  g39(.a(new_n49_), .b(x12), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n56_), .c(x03), .O(new_n60_));
  nor2   g41(.a(x07), .b(x03), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n40_), .O(new_n62_));
  oai21  g43(.a(new_n60_), .b(new_n58_), .c(new_n62_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  oai21  g45(.a(new_n24_), .b(new_n64_), .c(new_n21_), .O(z4));
endmodule
