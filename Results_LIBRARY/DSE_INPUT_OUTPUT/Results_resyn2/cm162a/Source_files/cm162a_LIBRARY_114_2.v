...
module FAU ( 
  ...
  nand3  g24(.a(new_n38_), .b(new_n26_), .c(new_n43_), .O(new_n44_));
  nand2  g25(.a(new_n39_), .b(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n44_), .c(new_n28_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x03), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n20_), .c(new_n23_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n47_), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n38_), .b(new_n26_), .c(new_n51_), .d(new_n43_), .O(new_n52_));
  inv1   g33(.a(x10), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n30_), .O(new_n54_));
  nand3  g35(.a(new_n43_), .b(x04), .c(x02), .O(new_n55_));
