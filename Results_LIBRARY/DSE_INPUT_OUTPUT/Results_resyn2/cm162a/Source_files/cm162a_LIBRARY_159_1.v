...
module FAU ( 
  ...
  nand2  g08(.a(x05), .b(x02), .O(new_n28_));
  ...
  oai21  g13(.a(new_n32_), .b(new_n31_), .c(x04), .O(new_n33_));
  inv1   g14(.a(new_n33_), .O(new_n34_));
  inv1   g15(.a(x10), .O(new_n35_));
  inv1   g16(.a(new_n31_), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n21_), .c(new_n35_), .O(new_n37_));
  ...
  nand3  g26(.a(x11), .b(new_n35_), .c(new_n22_), .O(new_n46_));
  inv1   g27(.a(new_n46_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n23_), .c(new_n27_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n45_), .c(new_n43_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n42_), .c(x05), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand3  g32(.a(new_n32_), .b(new_n51_), .c(new_n44_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n36_), .c(new_n20_), .O(new_n53_));
  nand3  g34(.a(new_n32_), .b(new_n44_), .c(x04), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x12), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x03), .O(new_n56_));
  aoi21  g37(.a(x07), .b(new_n27_), .c(new_n42_), .O(new_n57_));
  oai21  g38(.a(new_n56_), .b(new_n53_), .c(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x05), .O(z3));
  nand2  g40(.a(new_n31_), .b(x04), .O(new_n60_));
  aoi21  g41(.a(x05), .b(new_n42_), .c(new_n60_), .O(z4));
endmodule
