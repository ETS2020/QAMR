...
module FAU ( 
  ...
  nand3  g22(.a(new_n34_), .b(new_n41_), .c(new_n23_), .O(new_n42_));
  ...
  nand3  g28(.a(new_n47_), .b(new_n23_), .c(x05), .O(new_n48_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n34_), .c(new_n41_), .d(new_n23_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(x05), .c(x11), .O(new_n56_));
  aoi21  g37(.a(new_n46_), .b(new_n41_), .c(new_n20_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(x12), .c(x03), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n29_), .c(new_n30_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(z3));
  nand3  g42(.a(x13), .b(x09), .c(x04), .O(new_n62_));
  aoi21  g43(.a(new_n45_), .b(new_n30_), .c(new_n62_), .O(z4));
endmodule
