...
module FAU ( 
  ...
  nand4  g18(.a(new_n37_), .b(new_n35_), .c(new_n33_), .d(x03), .O(new_n38_));
  aoi21  g19(.a(new_n20_), .b(x01), .c(new_n28_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n32_), .O(z1));
  nand3  g22(.a(new_n36_), .b(new_n22_), .c(new_n21_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x11), .O(new_n43_));
  nor3   g24(.a(x11), .b(x10), .c(x08), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n34_), .c(new_n22_), .O(new_n45_));
  ...
  nand2  g29(.a(new_n48_), .b(new_n32_), .O(z2));
  inv1   g30(.a(x11), .O(new_n50_));
  nand2  g31(.a(new_n36_), .b(new_n50_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n21_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n22_), .c(x12), .O(new_n53_));
  nand3  g34(.a(new_n22_), .b(new_n21_), .c(x12), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n51_), .c(x03), .O(new_n55_));
  aoi21  g36(.a(new_n31_), .b(new_n20_), .c(new_n28_), .O(new_n56_));
  oai21  g37(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  oai22  g39(.a(new_n21_), .b(new_n58_), .c(new_n31_), .d(x05), .O(z4));
endmodule
