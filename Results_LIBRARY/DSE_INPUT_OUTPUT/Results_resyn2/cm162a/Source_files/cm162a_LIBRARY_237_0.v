...
module FAU ( 
  ...
  nor2   g11(.a(x06), .b(x05), .O(new_n31_));
  ...
  nand4  g17(.a(new_n36_), .b(new_n35_), .c(new_n33_), .d(x03), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n32_), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(x05), .c(new_n31_), .O(z1));
  ...
  oai22  g37(.a(new_n21_), .b(new_n56_), .c(x06), .d(x05), .O(z4));
endmodule
