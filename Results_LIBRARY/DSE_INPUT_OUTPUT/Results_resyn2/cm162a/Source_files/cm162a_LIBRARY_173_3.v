...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n50_, new_n52_, new_n53_, new_n54_, new_n55_, new_n57_;
  ...
  nand2  g29(.a(new_n29_), .b(x05), .O(new_n49_));
  nor2   g30(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  oai21  g31(.a(new_n47_), .b(new_n38_), .c(new_n50_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand2  g33(.a(new_n43_), .b(new_n52_), .O(new_n53_));
  nand3  g34(.a(new_n42_), .b(new_n24_), .c(x12), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n38_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(x07), .c(x05), .O(z3));
