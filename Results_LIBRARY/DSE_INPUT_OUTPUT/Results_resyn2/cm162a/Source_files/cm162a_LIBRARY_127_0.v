...
module FAU ( 
  ...
  oai21  g12(.a(x13), .b(x05), .c(new_n31_), .O(new_n32_));
  nand2  g13(.a(new_n22_), .b(x10), .O(new_n33_));
  aoi22  g14(.a(new_n33_), .b(x05), .c(x13), .d(x09), .O(new_n34_));
  aoi21  g15(.a(new_n24_), .b(x08), .c(new_n21_), .O(new_n35_));
  oai21  g16(.a(new_n35_), .b(x10), .c(x03), .O(new_n36_));
  oai21  g17(.a(new_n36_), .b(new_n34_), .c(new_n32_), .O(z1));
  ...
  nand4  g23(.a(new_n24_), .b(new_n23_), .c(new_n39_), .d(new_n38_), .O(new_n43_));
  ...
  nand2  g28(.a(new_n24_), .b(x12), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n42_), .c(new_n23_), .O(new_n49_));
  nand2  g30(.a(new_n40_), .b(new_n39_), .O(new_n50_));
  nand4  g31(.a(new_n24_), .b(new_n38_), .c(x04), .d(x02), .O(new_n51_));
  ...
  oai22  g39(.a(new_n24_), .b(new_n58_), .c(x13), .d(x05), .O(z4));
endmodule
