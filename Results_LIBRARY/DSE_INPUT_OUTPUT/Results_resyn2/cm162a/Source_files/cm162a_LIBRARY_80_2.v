...
module FAU ( 
  ...
  nor2   g21(.a(new_n34_), .b(x11), .O(new_n41_));
  nand3  g22(.a(x11), .b(new_n32_), .c(new_n31_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n24_), .c(x03), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(z2));
  inv1   g25(.a(x11), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n32_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n35_), .c(x12), .O(new_n47_));
  inv1   g28(.a(x12), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n45_), .c(new_n32_), .d(new_n31_), .O(new_n49_));
  ...
  oai22  g39(.a(new_n21_), .b(new_n57_), .c(x06), .d(new_n58_), .O(z4));
endmodule
