...
module FAU ( 
  ...
  oai21  g17(.a(new_n26_), .b(new_n33_), .c(new_n36_), .O(new_n37_));
  ...
  oai21  g23(.a(new_n42_), .b(new_n22_), .c(new_n34_), .O(new_n43_));
  nand3  g24(.a(new_n35_), .b(new_n34_), .c(new_n21_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(x11), .O(new_n45_));
  and2   g26(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  inv1   g27(.a(x06), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n29_), .c(new_n30_), .O(new_n48_));
  oai21  g29(.a(new_n46_), .b(new_n29_), .c(new_n48_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand2  g31(.a(new_n43_), .b(new_n50_), .O(new_n51_));
  nand3  g32(.a(new_n42_), .b(new_n24_), .c(x12), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n51_), .c(new_n30_), .O(new_n53_));
  inv1   g34(.a(x07), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x05), .c(new_n29_), .O(new_n55_));
  oai21  g36(.a(new_n53_), .b(new_n29_), .c(new_n55_), .O(z3));
  nand2  g37(.a(new_n22_), .b(x04), .O(new_n57_));
  aoi21  g38(.a(new_n30_), .b(new_n29_), .c(new_n57_), .O(z4));
endmodule
