...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n32_), .c(x09), .O(new_n34_));
  nor2   g15(.a(new_n34_), .b(new_n24_), .O(new_n35_));
  nor2   g16(.a(x09), .b(x08), .O(new_n36_));
  ...
  oai21  g20(.a(x13), .b(new_n20_), .c(x05), .O(new_n40_));
  ...
  nand4  g26(.a(new_n45_), .b(new_n26_), .c(x11), .d(new_n20_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n44_), .c(x03), .O(new_n47_));
  inv1   g28(.a(x05), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n22_), .c(new_n48_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n47_), .c(new_n21_), .O(z2));
  nand2  g32(.a(new_n45_), .b(new_n43_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n20_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n26_), .c(x12), .O(new_n54_));
  nand2  g35(.a(new_n45_), .b(new_n26_), .O(new_n55_));
  nand3  g36(.a(x12), .b(new_n43_), .c(new_n20_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n55_), .c(x03), .O(new_n57_));
  nor2   g38(.a(x07), .b(x03), .O(new_n58_));
  nor2   g39(.a(new_n58_), .b(new_n40_), .O(new_n59_));
  oai21  g40(.a(new_n57_), .b(new_n54_), .c(new_n59_), .O(z3));
  inv1   g41(.a(x04), .O(new_n61_));
  aoi21  g42(.a(x13), .b(new_n61_), .c(new_n20_), .O(z4));
endmodule
