...
module FAU ( 
  ...
  inv1   g11(.a(new_n29_), .O(new_n31_));
  inv1   g12(.a(x10), .O(new_n32_));
  nor2   g13(.a(new_n27_), .b(new_n32_), .O(new_n33_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n32_), .c(new_n42_), .O(new_n44_));
  ...
  oai21  g33(.a(new_n52_), .b(new_n44_), .c(new_n31_), .O(new_n53_));
