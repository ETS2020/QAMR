...
module FAU ( 
  ...
  nand2  g15(.a(new_n24_), .b(new_n22_), .O(new_n35_));
  ...
  nand4  g21(.a(new_n32_), .b(new_n24_), .c(x11), .d(x04), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(x05), .c(new_n40_), .O(new_n42_));
  oai21  g23(.a(new_n34_), .b(x11), .c(x03), .O(new_n43_));
  nand2  g24(.a(new_n28_), .b(x02), .O(new_n44_));
  ...
  nand4  g29(.a(new_n48_), .b(new_n24_), .c(x12), .d(x04), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x05), .c(new_n40_), .O(new_n50_));
  inv1   g31(.a(x12), .O(new_n51_));
  oai21  g32(.a(new_n48_), .b(new_n31_), .c(new_n23_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(x03), .c(new_n28_), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x05), .c(new_n20_), .O(new_n56_));
  oai21  g37(.a(new_n54_), .b(new_n50_), .c(new_n56_), .O(z3));
  inv1   g38(.a(new_n44_), .O(new_n58_));
  nand2  g39(.a(new_n31_), .b(x04), .O(new_n59_));
