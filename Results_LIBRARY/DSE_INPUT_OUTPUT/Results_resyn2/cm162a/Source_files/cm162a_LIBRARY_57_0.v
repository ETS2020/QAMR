...
module FAU ( 
  ...
  nand2  g15(.a(new_n25_), .b(new_n21_), .O(new_n35_));
  ...
  nor2   g20(.a(x10), .b(new_n20_), .O(new_n40_));
  nand4  g21(.a(new_n40_), .b(new_n23_), .c(new_n21_), .d(x11), .O(new_n41_));
  ...
  inv1   g30(.a(new_n21_), .O(new_n50_));
  nand3  g31(.a(new_n23_), .b(new_n50_), .c(x05), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  nor2   g33(.a(x10), .b(x08), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n23_), .c(new_n52_), .d(new_n47_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n51_), .c(new_n49_), .O(new_n55_));
  ...
  nand2  g40(.a(new_n50_), .b(x04), .O(new_n60_));
  aoi21  g41(.a(new_n31_), .b(new_n28_), .c(new_n60_), .O(z4));
endmodule
