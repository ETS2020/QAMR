...
module FAU ( 
  ...
  nand3  g20(.a(new_n33_), .b(new_n22_), .c(new_n21_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x11), .O(new_n41_));
  nor3   g22(.a(x11), .b(x10), .c(x08), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n32_), .c(new_n22_), .O(new_n43_));
