...
module FAU ( 
  ...
  oai21  g16(.a(new_n25_), .b(new_n33_), .c(x03), .O(new_n36_));
  aoi21  g17(.a(new_n20_), .b(x01), .c(new_n28_), .O(new_n37_));
  oai21  g18(.a(new_n36_), .b(new_n35_), .c(new_n37_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n31_), .O(z1));
  inv1   g20(.a(x11), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n33_), .c(new_n32_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n21_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n23_), .O(new_n43_));
  oai21  g24(.a(new_n34_), .b(new_n24_), .c(x11), .O(new_n44_));
  ...
  aoi21  g32(.a(new_n43_), .b(new_n49_), .c(new_n51_), .O(new_n52_));
  nor2   g33(.a(x07), .b(x03), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n52_), .c(x05), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n31_), .O(z3));
  nand3  g36(.a(x13), .b(x09), .c(x04), .O(new_n56_));
  aoi21  g37(.a(new_n28_), .b(x00), .c(new_n56_), .O(z4));
endmodule
