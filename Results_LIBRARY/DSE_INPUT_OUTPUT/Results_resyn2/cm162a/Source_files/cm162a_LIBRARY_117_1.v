...
module FAU ( 
  ...
  nand4  g12(.a(new_n31_), .b(new_n29_), .c(new_n28_), .d(x03), .O(new_n32_));
  inv1   g13(.a(x03), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(x01), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(new_n32_), .c(x00), .O(new_n35_));
  ...
  nand3  g22(.a(new_n30_), .b(new_n21_), .c(new_n20_), .O(new_n42_));
  aoi22  g23(.a(new_n42_), .b(x11), .c(new_n41_), .d(new_n21_), .O(new_n43_));
  inv1   g24(.a(x06), .O(new_n44_));
  nand2  g25(.a(x05), .b(x00), .O(new_n45_));
  aoi21  g26(.a(new_n44_), .b(new_n33_), .c(new_n45_), .O(new_n46_));
  oai21  g27(.a(new_n43_), .b(new_n33_), .c(new_n46_), .O(z2));
  aoi21  g28(.a(new_n41_), .b(new_n21_), .c(x12), .O(new_n48_));
  ...
  aoi21  g32(.a(new_n51_), .b(new_n33_), .c(new_n45_), .O(new_n52_));
  oai21  g33(.a(new_n50_), .b(new_n48_), .c(new_n52_), .O(z3));
  inv1   g34(.a(x04), .O(new_n54_));
  inv1   g35(.a(x05), .O(new_n55_));
  oai22  g36(.a(new_n20_), .b(new_n54_), .c(new_n55_), .d(x00), .O(z4));
endmodule
