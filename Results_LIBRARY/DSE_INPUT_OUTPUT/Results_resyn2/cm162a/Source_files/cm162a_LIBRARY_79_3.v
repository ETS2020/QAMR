...
module FAU ( 
  ...
  nor2   g12(.a(new_n24_), .b(new_n31_), .O(new_n32_));
  inv1   g13(.a(x08), .O(new_n33_));
  nand2  g14(.a(new_n31_), .b(new_n33_), .O(new_n34_));
  ...
  inv1   g20(.a(new_n23_), .O(new_n40_));
  oai21  g21(.a(x10), .b(x08), .c(new_n21_), .O(new_n41_));
  nand2  g22(.a(new_n21_), .b(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(new_n43_));
  oai21  g24(.a(new_n34_), .b(new_n22_), .c(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n45_));
  aoi21  g26(.a(x06), .b(new_n20_), .c(x12), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x05), .O(z2));
  nor2   g29(.a(x07), .b(x03), .O(new_n49_));
  nor2   g30(.a(new_n49_), .b(new_n28_), .O(new_n50_));
  oai21  g31(.a(new_n43_), .b(new_n20_), .c(new_n50_), .O(z3));
  nand3  g32(.a(x13), .b(x09), .c(x04), .O(new_n52_));
  aoi21  g33(.a(x12), .b(x05), .c(new_n52_), .O(z4));
endmodule
