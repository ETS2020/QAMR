...
module FAU ( 
  ...
  nand4  g25(.a(new_n35_), .b(new_n41_), .c(new_n44_), .d(x02), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x04), .O(new_n47_));
  nand3  g28(.a(new_n35_), .b(new_n29_), .c(new_n44_), .O(new_n48_));
  ...
  oai22  g33(.a(new_n21_), .b(new_n51_), .c(new_n52_), .d(x03), .O(z4));
endmodule
