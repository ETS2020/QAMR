...
module FAU ( 
  ...
  nand2  g23(.a(new_n42_), .b(new_n31_), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n35_), .b(new_n23_), .c(new_n44_), .O(new_n45_));
  nand2  g26(.a(new_n36_), .b(x11), .O(new_n46_));
  nand4  g27(.a(new_n46_), .b(new_n45_), .c(new_n26_), .d(x03), .O(new_n47_));
  aoi21  g28(.a(x06), .b(new_n30_), .c(new_n31_), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n52_), .d(new_n22_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  aoi22  g36(.a(new_n55_), .b(new_n23_), .c(new_n45_), .d(x12), .O(new_n56_));
  aoi21  g37(.a(new_n42_), .b(new_n30_), .c(new_n31_), .O(new_n57_));
  oai21  g38(.a(new_n56_), .b(new_n30_), .c(new_n57_), .O(z3));
  nand2  g39(.a(new_n25_), .b(x04), .O(new_n59_));
  aoi21  g40(.a(x07), .b(new_n31_), .c(new_n59_), .O(z4));
endmodule
