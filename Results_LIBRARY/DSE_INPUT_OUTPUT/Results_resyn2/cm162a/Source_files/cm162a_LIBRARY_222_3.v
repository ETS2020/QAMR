...
module FAU ( 
  ...
  nand4  g15(.a(new_n34_), .b(new_n32_), .c(new_n30_), .d(x03), .O(new_n35_));
  aoi21  g16(.a(new_n20_), .b(x01), .c(x12), .O(new_n36_));
  ...
  oai21  g23(.a(new_n40_), .b(new_n31_), .c(new_n42_), .O(new_n43_));
  inv1   g24(.a(new_n33_), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  nor2   g26(.a(new_n45_), .b(new_n20_), .O(new_n46_));
  oai21  g27(.a(new_n44_), .b(new_n22_), .c(new_n46_), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n20_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(new_n47_), .c(new_n43_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n39_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x05), .O(z2));
  nand2  g33(.a(new_n33_), .b(new_n45_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n21_), .c(new_n41_), .O(new_n54_));
  nor2   g35(.a(x07), .b(x03), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(new_n39_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x05), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  oai22  g39(.a(new_n21_), .b(new_n58_), .c(new_n39_), .d(new_n26_), .O(z4));
endmodule
