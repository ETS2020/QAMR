...
module FAU ( 
  ...
  oai21  g13(.a(new_n23_), .b(x08), .c(x10), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(new_n32_), .c(new_n30_), .O(new_n34_));
  ...
  nand3  g26(.a(new_n31_), .b(new_n21_), .c(new_n20_), .O(new_n46_));
  aoi22  g27(.a(new_n46_), .b(x11), .c(new_n45_), .d(new_n21_), .O(new_n47_));
  nor2   g28(.a(x06), .b(x03), .O(new_n48_));
  nor2   g29(.a(new_n48_), .b(new_n37_), .O(new_n49_));
  oai21  g30(.a(new_n47_), .b(new_n40_), .c(new_n49_), .O(z2));
  nand3  g31(.a(new_n45_), .b(new_n21_), .c(x03), .O(new_n51_));
  nor2   g32(.a(x07), .b(x03), .O(new_n52_));
  nor2   g33(.a(new_n52_), .b(new_n37_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z3));
  inv1   g35(.a(x04), .O(new_n55_));
  nand2  g36(.a(x12), .b(x05), .O(new_n56_));
  oai21  g37(.a(new_n20_), .b(new_n55_), .c(new_n56_), .O(z4));
endmodule
