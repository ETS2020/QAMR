...
module FAU ( 
  ...
  aoi21  g15(.a(new_n34_), .b(new_n32_), .c(new_n21_), .O(new_n35_));
  ...
  nand3  g21(.a(new_n40_), .b(new_n30_), .c(new_n33_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n32_), .c(new_n21_), .O(new_n42_));
  inv1   g23(.a(new_n21_), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(new_n32_), .c(new_n30_), .d(new_n33_), .O(new_n44_));
  ...
  nand3  g31(.a(new_n50_), .b(new_n22_), .c(x03), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(x05), .c(new_n49_), .O(new_n52_));
  oai21  g33(.a(new_n42_), .b(x12), .c(x03), .O(new_n53_));
  inv1   g34(.a(x07), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n20_), .c(new_n27_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(z3));
  nand3  g37(.a(x13), .b(x09), .c(x04), .O(new_n57_));
  aoi21  g38(.a(x12), .b(new_n27_), .c(new_n57_), .O(z4));
endmodule
