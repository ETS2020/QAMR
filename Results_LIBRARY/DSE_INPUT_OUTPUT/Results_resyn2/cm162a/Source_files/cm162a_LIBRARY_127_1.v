...
module FAU ( 
  ...
  nand2  g11(.a(new_n20_), .b(x01), .O(new_n31_));
  ...
  nand2  g17(.a(new_n36_), .b(new_n31_), .O(new_n37_));
  ...
  nand2  g23(.a(new_n34_), .b(new_n42_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n41_), .c(new_n23_), .O(new_n44_));
  aoi21  g25(.a(new_n34_), .b(new_n24_), .c(new_n42_), .O(new_n45_));
  ...
  nor2   g30(.a(new_n44_), .b(x12), .O(new_n50_));
  nand2  g31(.a(new_n24_), .b(x12), .O(new_n51_));
  ...
  aoi21  g37(.a(new_n56_), .b(x05), .c(new_n38_), .O(z4));
endmodule
