...
module FAU ( 
  ...
  nor2   g26(.a(new_n41_), .b(new_n28_), .O(new_n46_));
  aoi22  g27(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n22_), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(x05), .O(new_n48_));
  oai21  g29(.a(new_n40_), .b(x05), .c(new_n48_), .O(new_n49_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n43_), .c(new_n33_), .d(new_n41_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n20_), .c(new_n28_), .O(new_n57_));
  oai21  g38(.a(new_n55_), .b(new_n51_), .c(new_n57_), .O(z3));
  nand3  g39(.a(x13), .b(x09), .c(x04), .O(new_n59_));
  aoi21  g40(.a(x08), .b(new_n28_), .c(new_n59_), .O(z4));
endmodule
