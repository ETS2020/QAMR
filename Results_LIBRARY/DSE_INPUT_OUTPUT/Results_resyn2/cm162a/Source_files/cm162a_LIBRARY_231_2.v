...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n59_;
  nand2  g00(.a(x13), .b(x05), .O(new_n20_));
  ...
  oai21  g08(.a(x09), .b(new_n26_), .c(new_n27_), .O(new_n28_));
  ...
  inv1   g12(.a(x09), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(new_n26_), .O(new_n33_));
  oai21  g14(.a(new_n33_), .b(new_n24_), .c(x10), .O(new_n34_));
  oai21  g15(.a(x10), .b(x08), .c(new_n32_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n27_), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n34_), .c(x03), .O(new_n37_));
  inv1   g18(.a(x13), .O(new_n38_));
  aoi21  g19(.a(new_n22_), .b(x01), .c(new_n38_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x05), .O(z1));
  aoi21  g22(.a(new_n35_), .b(new_n27_), .c(x11), .O(new_n42_));
  inv1   g23(.a(x10), .O(new_n43_));
  nand3  g24(.a(new_n27_), .b(x11), .c(new_n43_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n33_), .c(x03), .O(new_n45_));
  inv1   g26(.a(x06), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n22_), .c(new_n20_), .O(new_n47_));
  oai21  g28(.a(new_n45_), .b(new_n42_), .c(new_n47_), .O(z2));
  inv1   g29(.a(x11), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(new_n43_), .c(new_n26_), .O(new_n50_));
  nand2  g31(.a(x13), .b(x09), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n27_), .c(x12), .O(new_n53_));
  nand3  g34(.a(new_n51_), .b(new_n27_), .c(x12), .O(new_n54_));
