...
module FAU ( 
  ...
  nand2  g20(.a(x05), .b(x03), .O(new_n40_));
  nand3  g21(.a(new_n33_), .b(new_n23_), .c(new_n21_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(x11), .O(new_n42_));
  inv1   g23(.a(x08), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n31_), .c(new_n43_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n23_), .c(new_n40_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n42_), .c(new_n40_), .d(x06), .O(z2));
  inv1   g29(.a(x12), .O(new_n49_));
  nand2  g30(.a(new_n46_), .b(new_n23_), .O(new_n50_));
  nand4  g31(.a(new_n21_), .b(x12), .c(x04), .d(x02), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n45_), .c(x03), .O(new_n52_));
  aoi21  g33(.a(new_n50_), .b(new_n49_), .c(new_n52_), .O(new_n53_));
  ...
  nand2  g39(.a(new_n32_), .b(x04), .O(new_n59_));
  aoi21  g40(.a(x06), .b(new_n28_), .c(new_n59_), .O(z4));
endmodule
