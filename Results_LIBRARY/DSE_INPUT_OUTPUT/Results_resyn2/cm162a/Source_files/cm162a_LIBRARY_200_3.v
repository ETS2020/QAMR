...
module FAU ( 
  ...
  nor2   g14(.a(new_n33_), .b(new_n23_), .O(new_n34_));
  ...
  and2   g26(.a(new_n45_), .b(x03), .O(new_n46_));
  ...
  aoi21  g32(.a(x07), .b(new_n20_), .c(x08), .O(new_n52_));
  ...
  oai21  g37(.a(new_n27_), .b(new_n55_), .c(new_n56_), .O(z4));
endmodule
