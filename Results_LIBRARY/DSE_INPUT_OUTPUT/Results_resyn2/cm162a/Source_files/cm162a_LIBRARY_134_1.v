...
module FAU ( 
  ...
  nand3  g05(.a(x09), .b(x08), .c(x03), .O(new_n25_));
  nand2  g06(.a(new_n25_), .b(x10), .O(new_n26_));
  oai21  g07(.a(x03), .b(x00), .c(x05), .O(new_n27_));
  aoi21  g08(.a(new_n26_), .b(x13), .c(new_n27_), .O(new_n28_));
  nand2  g09(.a(new_n28_), .b(new_n24_), .O(z0));
  inv1   g10(.a(x03), .O(new_n30_));
  inv1   g11(.a(x10), .O(new_n31_));
  nand2  g12(.a(x13), .b(new_n31_), .O(new_n32_));
  ...
  nor2   g17(.a(x13), .b(x10), .O(new_n37_));
  aoi22  g18(.a(new_n37_), .b(new_n23_), .c(new_n36_), .d(x10), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n30_), .c(new_n34_), .O(z1));
  nand3  g20(.a(x13), .b(x10), .c(x09), .O(new_n40_));
  inv1   g21(.a(x11), .O(new_n41_));
  nand3  g22(.a(new_n37_), .b(new_n41_), .c(new_n20_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n40_), .c(new_n22_), .O(new_n43_));
  inv1   g24(.a(x13), .O(new_n44_));
  oai21  g25(.a(new_n22_), .b(x08), .c(new_n44_), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n31_), .c(new_n41_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n43_), .c(x03), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(x05), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n32_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n47_), .O(z2));
  nand4  g31(.a(new_n41_), .b(new_n20_), .c(x04), .d(x02), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n44_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n31_), .O(new_n53_));
  nand2  g34(.a(new_n40_), .b(x12), .O(new_n54_));
  aoi22  g35(.a(new_n54_), .b(new_n43_), .c(new_n53_), .d(x12), .O(new_n55_));
  ...
  inv1   g39(.a(new_n40_), .O(new_n59_));
