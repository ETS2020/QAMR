...
module FAU ( 
  ...
  nor2   g09(.a(new_n25_), .b(new_n28_), .O(new_n29_));
  ...
  oai21  g14(.a(new_n33_), .b(new_n29_), .c(x03), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(x05), .O(z1));
  inv1   g16(.a(x08), .O(new_n36_));
  inv1   g17(.a(x11), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n28_), .c(new_n36_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n21_), .O(new_n39_));
  nand3  g20(.a(new_n31_), .b(new_n22_), .c(new_n21_), .O(new_n40_));
  aoi22  g21(.a(new_n40_), .b(x11), .c(new_n39_), .d(new_n22_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n20_), .c(x05), .O(z2));
