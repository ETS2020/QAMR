...
module FAU ( 
  ...
  oai21  g22(.a(new_n41_), .b(new_n34_), .c(new_n22_), .O(new_n42_));
  nand3  g23(.a(new_n35_), .b(new_n22_), .c(new_n21_), .O(new_n43_));
  ...
  nand2  g28(.a(new_n47_), .b(new_n32_), .O(z2));
  ...
  nand2  g38(.a(x09), .b(x04), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x05), .c(new_n31_), .O(z4));
endmodule
