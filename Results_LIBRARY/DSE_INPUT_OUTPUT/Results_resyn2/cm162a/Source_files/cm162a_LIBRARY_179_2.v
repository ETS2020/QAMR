...
module FAU ( 
  ...
  nor2   g19(.a(new_n24_), .b(new_n38_), .O(new_n39_));
  oai21  g20(.a(new_n39_), .b(new_n37_), .c(x03), .O(new_n40_));
  inv1   g21(.a(x01), .O(new_n41_));
  nand2  g22(.a(new_n30_), .b(new_n41_), .O(new_n42_));
  nand4  g23(.a(new_n42_), .b(new_n40_), .c(new_n21_), .d(x05), .O(z1));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n38_), .c(new_n25_), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n34_), .c(new_n23_), .O(new_n46_));
  aoi21  g27(.a(new_n35_), .b(new_n26_), .c(new_n44_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n46_), .c(x03), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n30_), .c(new_n31_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n48_), .c(new_n22_), .O(z2));
  inv1   g32(.a(new_n23_), .O(new_n52_));
  nand2  g33(.a(new_n45_), .b(new_n34_), .O(new_n53_));
  aoi21  g34(.a(new_n34_), .b(x12), .c(x01), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n55_));
  nand3  g36(.a(new_n34_), .b(x04), .c(x02), .O(new_n56_));
  oai21  g37(.a(new_n45_), .b(new_n56_), .c(x12), .O(new_n57_));
  ...
  oai21  g44(.a(new_n34_), .b(new_n63_), .c(new_n21_), .O(z4));
endmodule
