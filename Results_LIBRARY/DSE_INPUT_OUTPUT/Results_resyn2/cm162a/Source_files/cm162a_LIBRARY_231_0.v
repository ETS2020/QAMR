...
module FAU ( 
  ...
  nand2  g11(.a(x09), .b(x03), .O(new_n31_));
  oai21  g12(.a(new_n31_), .b(new_n22_), .c(x05), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(x13), .O(new_n33_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n35_), .c(new_n41_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n21_), .c(new_n22_), .O(new_n44_));
  nand3  g25(.a(new_n25_), .b(new_n21_), .c(new_n35_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n23_), .b(new_n21_), .c(x12), .O(new_n51_));
