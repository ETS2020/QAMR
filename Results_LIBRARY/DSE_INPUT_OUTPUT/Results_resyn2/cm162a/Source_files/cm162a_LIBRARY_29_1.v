...
module FAU ( 
  ...
  nand3  g08(.a(new_n27_), .b(x03), .c(x00), .O(new_n28_));
  ...
  nand4  g13(.a(new_n32_), .b(new_n30_), .c(new_n26_), .d(x03), .O(new_n33_));
  ...
  nand3  g20(.a(new_n31_), .b(new_n23_), .c(new_n39_), .O(new_n40_));
  nand2  g21(.a(new_n32_), .b(x11), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n40_), .c(new_n26_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x03), .O(new_n43_));
  inv1   g24(.a(x06), .O(new_n44_));
  nand2  g25(.a(x05), .b(x00), .O(new_n45_));
  aoi21  g26(.a(new_n44_), .b(new_n35_), .c(new_n45_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n43_), .O(z2));
  inv1   g28(.a(x12), .O(new_n48_));
  nand4  g29(.a(new_n31_), .b(new_n23_), .c(new_n48_), .d(new_n39_), .O(new_n49_));
  inv1   g30(.a(x10), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  nand3  g32(.a(new_n39_), .b(x04), .c(x02), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x12), .O(new_n53_));
  nand3  g34(.a(new_n25_), .b(new_n23_), .c(x00), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n53_), .c(new_n49_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x03), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n35_), .c(new_n45_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(z3));
  nand2  g40(.a(new_n25_), .b(x04), .O(new_n60_));
  aoi21  g41(.a(x05), .b(new_n34_), .c(new_n60_), .O(z4));
endmodule
