...
module FAU ( 
  ...
  nand3  g32(.a(new_n51_), .b(new_n32_), .c(new_n31_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n23_), .c(new_n25_), .O(new_n53_));
  nand4  g34(.a(new_n43_), .b(new_n33_), .c(new_n23_), .d(x12), .O(new_n54_));
  oai21  g35(.a(new_n53_), .b(x12), .c(new_n54_), .O(new_n55_));
  nor2   g36(.a(new_n50_), .b(new_n21_), .O(new_n56_));
  aoi21  g37(.a(new_n55_), .b(new_n50_), .c(new_n56_), .O(z3));
  nand2  g38(.a(new_n42_), .b(x04), .O(new_n58_));
  aoi21  g39(.a(x07), .b(new_n20_), .c(new_n58_), .O(z4));
endmodule
