...
module FAU ( 
  ...
  aoi21  g20(.a(new_n39_), .b(new_n20_), .c(new_n21_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n38_), .O(z1));
  nand3  g22(.a(new_n35_), .b(new_n24_), .c(new_n23_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x11), .O(new_n43_));
  nor3   g24(.a(x11), .b(x10), .c(x08), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n33_), .c(new_n24_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n43_), .c(x03), .O(new_n46_));
  aoi21  g27(.a(x06), .b(new_n39_), .c(new_n21_), .O(new_n47_));
  ...
  aoi21  g33(.a(new_n52_), .b(new_n24_), .c(x12), .O(new_n53_));
  nand3  g34(.a(new_n24_), .b(new_n23_), .c(x12), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n51_), .c(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n39_), .c(new_n21_), .O(new_n57_));
  oai21  g38(.a(new_n55_), .b(new_n53_), .c(new_n57_), .O(z3));
  inv1   g39(.a(x04), .O(new_n59_));
  oai22  g40(.a(new_n23_), .b(new_n59_), .c(x05), .d(new_n20_), .O(z4));
endmodule
