...
module FAU ( 
  ...
  nand2  g30(.a(new_n33_), .b(new_n49_), .O(new_n50_));
  nand4  g31(.a(new_n21_), .b(x12), .c(x04), .d(x02), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(x03), .O(new_n52_));
  aoi21  g33(.a(new_n41_), .b(new_n48_), .c(new_n52_), .O(new_n53_));
  nor2   g34(.a(x07), .b(x03), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n53_), .c(x05), .O(new_n55_));
  inv1   g36(.a(x09), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n28_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n55_), .O(z3));
  nand3  g39(.a(new_n32_), .b(x05), .c(x04), .O(new_n59_));
