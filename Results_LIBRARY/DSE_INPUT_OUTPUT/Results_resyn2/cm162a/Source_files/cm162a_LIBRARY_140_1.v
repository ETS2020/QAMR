...
module FAU ( 
  ...
  oai21  g16(.a(new_n35_), .b(new_n34_), .c(new_n23_), .O(new_n36_));
  ...
  oai21  g22(.a(new_n41_), .b(new_n34_), .c(new_n23_), .O(new_n42_));
  nand3  g23(.a(new_n35_), .b(new_n23_), .c(new_n21_), .O(new_n43_));
  ...
  nand2  g37(.a(new_n56_), .b(new_n32_), .O(z3));
  nand3  g38(.a(new_n34_), .b(x05), .c(x04), .O(new_n58_));
