...
module FAU ( 
  ...
  aoi21  g16(.a(new_n35_), .b(new_n22_), .c(new_n23_), .O(new_n36_));
  nand2  g17(.a(x10), .b(x05), .O(new_n37_));
  aoi21  g18(.a(new_n24_), .b(new_n27_), .c(new_n37_), .O(new_n38_));
  ...
  nor2   g26(.a(new_n36_), .b(x11), .O(new_n46_));
  nand2  g27(.a(new_n34_), .b(x11), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n25_), .c(x03), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n26_), .c(new_n20_), .O(new_n50_));
  ...
  nand4  g38(.a(new_n34_), .b(new_n54_), .c(new_n57_), .d(x02), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(new_n41_), .O(new_n59_));
  nor3   g40(.a(x11), .b(x10), .c(x08), .O(new_n60_));
  nand2  g41(.a(x12), .b(x05), .O(new_n61_));
  aoi21  g42(.a(new_n60_), .b(new_n24_), .c(new_n61_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n59_), .c(x03), .O(new_n63_));
  inv1   g44(.a(x07), .O(new_n64_));
  aoi21  g45(.a(new_n43_), .b(new_n64_), .c(new_n42_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n63_), .O(z3));
  nand2  g47(.a(new_n52_), .b(x04), .O(new_n67_));
