...
module FAU ( 
  ...
  nand2  g32(.a(new_n20_), .b(x03), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n45_), .c(new_n51_), .O(new_n53_));
  inv1   g34(.a(x10), .O(new_n54_));
  nand2  g35(.a(new_n42_), .b(new_n54_), .O(new_n55_));
  nor2   g36(.a(new_n51_), .b(new_n22_), .O(new_n56_));
  oai21  g37(.a(new_n55_), .b(new_n34_), .c(new_n56_), .O(new_n57_));
  aoi21  g38(.a(new_n20_), .b(new_n22_), .c(new_n39_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n57_), .c(new_n53_), .O(z3));
  inv1   g40(.a(x04), .O(new_n60_));
  nor3   g41(.a(new_n31_), .b(new_n21_), .c(new_n60_), .O(z4));
endmodule
