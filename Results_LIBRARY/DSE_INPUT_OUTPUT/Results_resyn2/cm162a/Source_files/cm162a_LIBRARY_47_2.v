...
module FAU ( 
  ...
  aoi21  g07(.a(new_n26_), .b(new_n25_), .c(new_n20_), .O(new_n27_));
  aoi22  g08(.a(new_n27_), .b(new_n24_), .c(new_n20_), .d(x00), .O(z0));
  ...
  nand2  g13(.a(new_n26_), .b(new_n22_), .O(new_n33_));
  inv1   g14(.a(x10), .O(new_n34_));
  nand3  g15(.a(new_n26_), .b(new_n34_), .c(new_n25_), .O(new_n35_));
  ...
  nand3  g22(.a(new_n41_), .b(new_n34_), .c(new_n25_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n21_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n26_), .O(new_n44_));
  inv1   g25(.a(new_n44_), .O(new_n45_));
  inv1   g26(.a(new_n35_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n21_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(x11), .c(new_n45_), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n37_), .c(new_n30_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n37_), .c(new_n50_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n21_), .b(x12), .c(x04), .d(x02), .O(new_n53_));
  ...
  nand2  g38(.a(new_n57_), .b(new_n31_), .O(z3));
  nand2  g39(.a(new_n22_), .b(x04), .O(new_n59_));
  aoi21  g40(.a(new_n30_), .b(x00), .c(new_n59_), .O(z4));
endmodule
