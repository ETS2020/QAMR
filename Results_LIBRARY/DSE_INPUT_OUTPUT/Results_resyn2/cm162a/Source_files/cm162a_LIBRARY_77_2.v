...
module FAU ( 
  ...
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(new_n31_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n25_), .O(new_n46_));
  nand3  g27(.a(new_n35_), .b(new_n25_), .c(new_n24_), .O(new_n47_));
  ...
  oai21  g31(.a(new_n48_), .b(new_n38_), .c(new_n50_), .O(z2));
  aoi21  g32(.a(new_n46_), .b(new_n24_), .c(x12), .O(new_n52_));
  nand3  g33(.a(new_n25_), .b(new_n24_), .c(x12), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n45_), .c(x03), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n52_), .c(new_n21_), .O(z3));
  nand2  g36(.a(new_n34_), .b(x04), .O(new_n56_));
  aoi21  g37(.a(new_n39_), .b(x05), .c(new_n56_), .O(z4));
endmodule
