...
module FAU ( 
  ...
  nand2  g11(.a(x06), .b(x05), .O(new_n31_));
  ...
  nand4  g17(.a(new_n36_), .b(new_n34_), .c(new_n26_), .d(x03), .O(new_n37_));
  inv1   g18(.a(x06), .O(new_n38_));
  aoi21  g19(.a(new_n30_), .b(x01), .c(new_n38_), .O(new_n39_));
