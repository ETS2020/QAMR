...
module FAU ( 
  ...
  nand4  g19(.a(new_n38_), .b(new_n37_), .c(new_n34_), .d(x03), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n33_), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(x05), .c(new_n32_), .O(z1));
  aoi21  g22(.a(x05), .b(x03), .c(new_n31_), .O(new_n42_));
  inv1   g23(.a(new_n21_), .O(new_n43_));
  oai21  g24(.a(new_n37_), .b(new_n43_), .c(x11), .O(new_n44_));
  nand2  g25(.a(x05), .b(x03), .O(new_n45_));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n36_), .c(new_n35_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n21_), .c(new_n22_), .O(new_n48_));
  nor2   g29(.a(new_n48_), .b(new_n45_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n44_), .c(new_n42_), .O(z2));
  nor2   g31(.a(new_n48_), .b(x12), .O(new_n51_));
  nand3  g32(.a(new_n23_), .b(new_n21_), .c(x12), .O(new_n52_));
  ...
  oai22  g38(.a(new_n21_), .b(new_n57_), .c(new_n31_), .d(x05), .O(z4));
endmodule
