...
module FAU ( 
  ...
  aoi21  g28(.a(new_n21_), .b(new_n37_), .c(new_n20_), .O(new_n48_));
  oai21  g29(.a(new_n47_), .b(new_n37_), .c(new_n48_), .O(z2));
  aoi21  g30(.a(new_n45_), .b(new_n24_), .c(x12), .O(new_n50_));
  ...
  aoi21  g34(.a(new_n53_), .b(new_n37_), .c(new_n20_), .O(new_n54_));
