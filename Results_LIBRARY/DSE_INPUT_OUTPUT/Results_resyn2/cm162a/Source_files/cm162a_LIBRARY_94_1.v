...
module FAU ( 
  ...
  aoi21  g32(.a(new_n21_), .b(new_n41_), .c(new_n20_), .O(new_n52_));
  oai21  g33(.a(new_n51_), .b(new_n41_), .c(new_n52_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n23_), .b(x12), .c(x04), .d(x02), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n45_), .c(x03), .O(new_n56_));
  aoi21  g37(.a(new_n47_), .b(new_n54_), .c(new_n56_), .O(new_n57_));
  ...
  aoi21  g42(.a(x06), .b(new_n20_), .c(new_n61_), .O(z4));
endmodule
