...
module FAU ( 
  ...
  nand3  g08(.a(new_n27_), .b(new_n26_), .c(new_n23_), .O(new_n28_));
  ...
  nand3  g24(.a(new_n36_), .b(new_n43_), .c(new_n25_), .O(new_n44_));
  ...
  nand3  g30(.a(new_n49_), .b(new_n25_), .c(new_n20_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n45_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x03), .O(new_n52_));
  oai21  g33(.a(x06), .b(x03), .c(x05), .O(new_n53_));
  oai21  g34(.a(new_n20_), .b(x11), .c(new_n53_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  aoi21  g36(.a(new_n48_), .b(new_n43_), .c(new_n22_), .O(new_n56_));
  oai21  g37(.a(x07), .b(x03), .c(x05), .O(new_n57_));
  aoi21  g38(.a(new_n56_), .b(x03), .c(new_n57_), .O(new_n58_));
  aoi21  g39(.a(x07), .b(new_n31_), .c(new_n20_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n32_), .c(x11), .O(new_n60_));
  oai21  g41(.a(new_n58_), .b(x12), .c(new_n60_), .O(z3));
  inv1   g42(.a(x04), .O(new_n62_));
  nor3   g43(.a(new_n43_), .b(new_n21_), .c(new_n62_), .O(z4));
endmodule
