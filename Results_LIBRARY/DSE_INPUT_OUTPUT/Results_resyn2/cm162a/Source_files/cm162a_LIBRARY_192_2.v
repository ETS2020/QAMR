...
module FAU ( 
  ...
  oai21  g06(.a(x03), .b(new_n25_), .c(x07), .O(new_n26_));
  ...
  aoi21  g13(.a(new_n32_), .b(new_n20_), .c(new_n22_), .O(new_n33_));
  ...
  nand4  g18(.a(new_n37_), .b(new_n34_), .c(x07), .d(x05), .O(z1));
  inv1   g19(.a(x11), .O(new_n39_));
  nand3  g20(.a(new_n39_), .b(new_n29_), .c(new_n28_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n20_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n30_), .O(new_n42_));
  oai21  g23(.a(new_n32_), .b(new_n21_), .c(x11), .O(new_n43_));
  ...
  aoi21  g29(.a(new_n41_), .b(new_n30_), .c(x12), .O(new_n49_));
  nand3  g30(.a(new_n30_), .b(new_n20_), .c(x12), .O(new_n50_));
  nor2   g31(.a(new_n45_), .b(new_n36_), .O(new_n51_));
  oai21  g32(.a(new_n50_), .b(new_n40_), .c(new_n51_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n49_), .c(x05), .O(z3));
  nand3  g34(.a(x13), .b(x09), .c(x04), .O(new_n54_));
  aoi21  g35(.a(new_n45_), .b(x05), .c(new_n54_), .O(z4));
endmodule
