...
module FAU ( 
  ...
  aoi21  g35(.a(new_n49_), .b(x03), .c(new_n54_), .O(new_n55_));
  aoi21  g36(.a(x07), .b(new_n31_), .c(new_n20_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n32_), .c(x11), .O(new_n57_));
  oai21  g38(.a(new_n55_), .b(x12), .c(new_n57_), .O(z3));
  inv1   g39(.a(x04), .O(new_n59_));
  nor3   g40(.a(new_n44_), .b(new_n21_), .c(new_n59_), .O(z4));
endmodule
