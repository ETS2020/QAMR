...
module FAU ( 
  ...
  nor2   g14(.a(new_n25_), .b(new_n33_), .O(new_n34_));
  nor2   g15(.a(x10), .b(x08), .O(new_n35_));
  inv1   g16(.a(new_n35_), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n21_), .c(new_n24_), .O(new_n37_));
  nor2   g18(.a(new_n28_), .b(new_n20_), .O(new_n38_));
  oai21  g19(.a(new_n37_), .b(new_n34_), .c(new_n38_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n32_), .O(z1));
  inv1   g21(.a(x08), .O(new_n41_));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n33_), .c(new_n41_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n21_), .O(new_n44_));
  nand3  g25(.a(new_n35_), .b(new_n22_), .c(new_n21_), .O(new_n45_));
  ...
  oai21  g32(.a(new_n51_), .b(new_n43_), .c(new_n38_), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n28_), .b(x03), .c(new_n56_), .O(z4));
endmodule
