...
module FAU ( 
  ...
  nor2   g022(.a(x116), .b(new_n178_), .O(z07));
  ...
  nand2  g374(.a(new_n530_), .b(new_n180_), .O(z13));
  ...
  nand2  g415(.a(new_n180_), .b(new_n571_), .O(new_n572_));
  ...
  zero   g421(.O(z23));
  zero   g422(.O(z27));
  nor2   g423(.a(x116), .b(new_n178_), .O(z16));
  nor2   g424(.a(x116), .b(new_n178_), .O(z18));
  nor2   g425(.a(x116), .b(new_n178_), .O(z20));
  nor2   g426(.a(x116), .b(new_n178_), .O(z21));
  nor2   g427(.a(x116), .b(new_n178_), .O(z24));
  nor2   g428(.a(x116), .b(new_n178_), .O(z25));
  nor2   g429(.a(x116), .b(new_n178_), .O(z26));
endmodule
