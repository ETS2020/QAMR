// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:42 2020
...
module FAU ( 
  ...
  nand2  g141(.a(new_n270_), .b(new_n261_), .O(new_n298_));
  ...
  nand2  g148(.a(new_n262_), .b(new_n265_), .O(new_n305_));
  ...
  aoi21  g155(.a(new_n304_), .b(new_n266_), .c(new_n311_), .O(new_n312_));
  ...
  oai21  g325(.a(new_n479_), .b(new_n474_), .c(new_n254_), .O(new_n482_));
  aoi21  g326(.a(x052), .b(x036), .c(new_n252_), .O(new_n483_));
  nand4  g327(.a(new_n483_), .b(new_n482_), .c(new_n481_), .d(new_n478_), .O(new_n484_));
  and2   g328(.a(new_n484_), .b(new_n241_), .O(z12));
  nor2   g329(.a(new_n284_), .b(x053), .O(new_n486_));
  nand2  g330(.a(x085), .b(x005), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(x037), .c(new_n264_), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n486_), .c(x077), .O(new_n489_));
  oai21  g333(.a(new_n309_), .b(new_n266_), .c(new_n489_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n177_), .O(new_n491_));
  oai21  g335(.a(x037), .b(x013), .c(x021), .O(new_n492_));
  oai21  g336(.a(new_n272_), .b(x029), .c(new_n492_), .O(new_n493_));
  nand2  g337(.a(new_n275_), .b(new_n278_), .O(new_n494_));
  oai21  g338(.a(new_n268_), .b(new_n265_), .c(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n493_), .c(x069), .O(new_n496_));
  nand3  g340(.a(new_n282_), .b(x125), .c(new_n265_), .O(new_n497_));
  nand3  g341(.a(x101), .b(x069), .c(new_n266_), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n497_), .c(new_n286_), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n496_), .c(x005), .O(new_n500_));
  nand2  g344(.a(x069), .b(new_n266_), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n305_), .c(new_n261_), .O(new_n502_));
  nand3  g346(.a(new_n268_), .b(new_n262_), .c(x029), .O(new_n503_));
  nor2   g347(.a(x021), .b(x013), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n503_), .c(x085), .O(new_n505_));
  oai21  g349(.a(new_n505_), .b(new_n502_), .c(new_n276_), .O(new_n506_));
  oai21  g350(.a(new_n263_), .b(x021), .c(new_n271_), .O(new_n507_));
  and2   g351(.a(new_n507_), .b(x069), .O(new_n508_));
  oai21  g352(.a(x069), .b(x013), .c(x021), .O(new_n509_));
  nand4  g353(.a(new_n509_), .b(new_n494_), .c(new_n268_), .d(x029), .O(new_n510_));
  inv1   g354(.a(new_n510_), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n508_), .c(new_n286_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n506_), .c(new_n500_), .O(new_n513_));
  nand2  g357(.a(new_n494_), .b(x005), .O(new_n514_));
  nand3  g358(.a(new_n286_), .b(x029), .c(new_n264_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n514_), .c(x069), .O(new_n516_));
  nand2  g360(.a(new_n507_), .b(new_n286_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n309_), .O(new_n518_));
  oai21  g362(.a(new_n518_), .b(new_n516_), .c(x037), .O(new_n519_));
  oai21  g363(.a(new_n487_), .b(x013), .c(new_n284_), .O(new_n520_));
  nand3  g364(.a(new_n309_), .b(x037), .c(x013), .O(new_n521_));
  aoi21  g365(.a(new_n521_), .b(new_n520_), .c(x045), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n519_), .O(new_n523_));
  aoi21  g367(.a(new_n513_), .b(new_n309_), .c(new_n523_), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(x077), .c(new_n491_), .O(z13));
  inv1   g369(.a(new_n375_), .O(new_n526_));
  ...
  oai22  g377(.a(new_n367_), .b(new_n335_), .c(new_n323_), .d(x030), .O(new_n534_));
  oai21  g378(.a(new_n327_), .b(new_n335_), .c(new_n530_), .O(new_n535_));
  aoi21  g379(.a(new_n535_), .b(new_n534_), .c(x070), .O(new_n536_));
  nand3  g380(.a(x102), .b(x070), .c(new_n359_), .O(new_n537_));
  nand3  g381(.a(new_n314_), .b(x126), .c(new_n335_), .O(new_n538_));
  nand3  g382(.a(new_n538_), .b(new_n537_), .c(new_n319_), .O(new_n539_));
  oai21  g383(.a(new_n539_), .b(new_n536_), .c(x006), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n533_), .c(x078), .O(new_n541_));
  nand2  g385(.a(x070), .b(new_n359_), .O(new_n542_));
  aoi21  g386(.a(new_n542_), .b(new_n353_), .c(new_n334_), .O(new_n543_));
  nand3  g387(.a(new_n327_), .b(new_n315_), .c(x030), .O(new_n544_));
  aoi21  g388(.a(new_n544_), .b(new_n335_), .c(x086), .O(new_n545_));
  oai21  g389(.a(new_n545_), .b(new_n543_), .c(new_n352_), .O(new_n546_));
  nand2  g390(.a(new_n546_), .b(new_n365_), .O(new_n547_));
  nand2  g391(.a(new_n547_), .b(new_n346_), .O(new_n548_));
  oai21  g392(.a(new_n317_), .b(new_n352_), .c(new_n548_), .O(new_n549_));
  ...
  nand3  g396(.a(new_n319_), .b(x030), .c(new_n552_), .O(new_n553_));
  ...
  nand2  g401(.a(new_n557_), .b(new_n317_), .O(new_n558_));
  aoi21  g402(.a(new_n527_), .b(x038), .c(new_n317_), .O(new_n559_));
  ...
  aoi21  g409(.a(new_n561_), .b(new_n352_), .c(new_n565_), .O(new_n566_));
  ...
  zero   g415(.O(z21));
  zero   g416(.O(z22));
  nor2   g417(.a(x077), .b(new_n177_), .O(z15));
  ...
  nor2   g422(.a(x077), .b(new_n177_), .O(z26));
  nor2   g423(.a(x077), .b(new_n177_), .O(z27));
endmodule
