...
module FAU ( 
  ...
  nand2  g002(.a(x099), .b(new_n158_), .O(new_n159_));
  ...
  oai21  g059(.a(new_n215_), .b(new_n203_), .c(new_n159_), .O(z02));
  ...
  oai21  g073(.a(new_n229_), .b(new_n217_), .c(new_n159_), .O(z03));
  ...
  zero   g418(.O(z26));
  zero   g419(.O(z27));
  inv1   g420(.a(new_n159_), .O(z15));
  inv1   g421(.a(new_n159_), .O(z16));
  inv1   g422(.a(new_n159_), .O(z17));
  inv1   g423(.a(new_n159_), .O(z19));
  inv1   g424(.a(new_n159_), .O(z21));
  inv1   g425(.a(new_n159_), .O(z23));
endmodule
