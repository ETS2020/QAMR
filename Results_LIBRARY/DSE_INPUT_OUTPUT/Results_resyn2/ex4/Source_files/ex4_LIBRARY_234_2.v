...
module FAU ( 
  ...
  nor2   g021(.a(x119), .b(new_n177_), .O(z07));
  ...
  zero   g423(.O(z26));
  zero   g424(.O(z27));
  nor2   g425(.a(x119), .b(new_n177_), .O(z15));
  nor2   g426(.a(x119), .b(new_n177_), .O(z16));
  nor2   g427(.a(x119), .b(new_n177_), .O(z17));
  nor2   g428(.a(x119), .b(new_n177_), .O(z18));
  nor2   g429(.a(x119), .b(new_n177_), .O(z20));
  nor2   g430(.a(x119), .b(new_n177_), .O(z21));
  nor2   g431(.a(x119), .b(new_n177_), .O(z23));
  nor2   g432(.a(x119), .b(new_n177_), .O(z24));
endmodule
