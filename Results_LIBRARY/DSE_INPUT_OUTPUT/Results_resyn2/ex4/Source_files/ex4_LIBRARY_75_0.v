...
module FAU ( 
  ...
  and2   g155(.a(x045), .b(x013), .O(new_n312_));
  nand4  g156(.a(new_n312_), .b(new_n311_), .c(new_n310_), .d(new_n307_), .O(new_n313_));
  nand2  g157(.a(new_n313_), .b(new_n254_), .O(new_n314_));
  nand2  g158(.a(new_n314_), .b(new_n309_), .O(z05));
  ...
  nand3  g185(.a(new_n324_), .b(new_n323_), .c(new_n337_), .O(new_n342_));
  nand2  g186(.a(new_n342_), .b(new_n332_), .O(new_n343_));
  aoi21  g187(.a(new_n343_), .b(new_n341_), .c(new_n317_), .O(new_n344_));
  ...
  nand2  g198(.a(new_n317_), .b(new_n337_), .O(new_n355_));
  ...
  nand2  g205(.a(new_n332_), .b(new_n336_), .O(new_n362_));
  nand3  g206(.a(x086), .b(new_n322_), .c(x014), .O(new_n363_));
  aoi21  g207(.a(new_n363_), .b(new_n362_), .c(new_n317_), .O(new_n364_));
  nor2   g208(.a(new_n330_), .b(new_n321_), .O(new_n365_));
  oai21  g209(.a(new_n365_), .b(new_n364_), .c(new_n361_), .O(new_n366_));
  nand2  g210(.a(new_n321_), .b(x014), .O(new_n367_));
  inv1   g211(.a(new_n367_), .O(new_n368_));
  nor2   g212(.a(x038), .b(x014), .O(new_n369_));
  inv1   g213(.a(new_n369_), .O(new_n370_));
  aoi22  g214(.a(new_n370_), .b(new_n356_), .c(new_n368_), .d(new_n336_), .O(new_n371_));
  aoi21  g215(.a(new_n371_), .b(new_n366_), .c(new_n354_), .O(new_n372_));
  nor2   g216(.a(x054), .b(x038), .O(new_n373_));
  nand3  g217(.a(new_n321_), .b(x038), .c(new_n336_), .O(new_n374_));
  ...
  aoi21  g221(.a(new_n376_), .b(new_n360_), .c(new_n377_), .O(z06));
  inv1   g222(.a(x040), .O(new_n380_));
  inv1   g223(.a(x072), .O(new_n381_));
  inv1   g224(.a(x000), .O(new_n382_));
  ...
  aoi21  g240(.a(new_n397_), .b(new_n392_), .c(new_n382_), .O(new_n398_));
  ...
  oai21  g248(.a(new_n405_), .b(new_n398_), .c(new_n381_), .O(new_n406_));
  or2    g249(.a(x112), .b(x104), .O(new_n407_));
  nand2  g250(.a(x064), .b(new_n169_), .O(new_n408_));
  aoi21  g251(.a(new_n408_), .b(new_n160_), .c(new_n382_), .O(new_n409_));
  nand3  g252(.a(new_n383_), .b(new_n159_), .c(x024), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(new_n158_), .c(x080), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(new_n409_), .c(new_n381_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n173_), .O(new_n413_));
  nor2   g256(.a(new_n159_), .b(new_n158_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(x072), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(new_n416_));
  aoi21  g259(.a(new_n413_), .b(new_n407_), .c(new_n416_), .O(new_n417_));
  aoi21  g260(.a(new_n417_), .b(new_n406_), .c(x048), .O(new_n418_));
  nand2  g261(.a(new_n402_), .b(x000), .O(new_n419_));
  nand3  g262(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n419_), .c(x064), .O(new_n421_));
  inv1   g264(.a(new_n400_), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(new_n390_), .c(x080), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n421_), .c(x032), .O(new_n424_));
  inv1   g267(.a(new_n414_), .O(new_n425_));
  nand2  g268(.a(x080), .b(x000), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  aoi21  g270(.a(new_n170_), .b(x032), .c(new_n425_), .O(new_n428_));
  oai21  g271(.a(new_n428_), .b(new_n157_), .c(new_n427_), .O(new_n429_));
  nand2  g272(.a(new_n429_), .b(new_n424_), .O(new_n430_));
  nand2  g273(.a(new_n430_), .b(new_n381_), .O(new_n431_));
  oai21  g274(.a(new_n426_), .b(x032), .c(new_n157_), .O(new_n432_));
  aoi22  g275(.a(new_n432_), .b(x072), .c(x048), .d(x032), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n431_), .O(new_n434_));
  oai21  g277(.a(new_n434_), .b(new_n418_), .c(new_n380_), .O(new_n435_));
  ...
  nand2  g333(.a(new_n255_), .b(new_n252_), .O(new_n491_));
  oai21  g334(.a(new_n252_), .b(x037), .c(new_n491_), .O(new_n492_));
  nor2   g335(.a(x037), .b(new_n294_), .O(new_n493_));
  nand2  g336(.a(x077), .b(new_n264_), .O(new_n494_));
  aoi21  g337(.a(new_n493_), .b(x085), .c(new_n494_), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n492_), .c(x045), .O(z13));
  inv1   g339(.a(new_n377_), .O(new_n497_));
  inv1   g340(.a(x054), .O(new_n498_));
  aoi21  g341(.a(x030), .b(new_n337_), .c(new_n325_), .O(new_n499_));
  oai21  g342(.a(x070), .b(x014), .c(x022), .O(new_n500_));
  nand2  g343(.a(new_n347_), .b(new_n345_), .O(new_n501_));
  nand4  g344(.a(new_n501_), .b(new_n500_), .c(new_n329_), .d(x030), .O(new_n502_));
  oai21  g345(.a(new_n499_), .b(new_n317_), .c(new_n502_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n321_), .O(new_n504_));
  oai22  g347(.a(new_n369_), .b(new_n337_), .c(new_n325_), .d(x030), .O(new_n505_));
  oai21  g348(.a(new_n329_), .b(new_n337_), .c(new_n501_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n505_), .c(x070), .O(new_n507_));
  nand3  g350(.a(x102), .b(x070), .c(new_n361_), .O(new_n508_));
  nand3  g351(.a(new_n316_), .b(x126), .c(new_n337_), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n508_), .c(new_n321_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n507_), .c(x006), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n504_), .c(x078), .O(new_n512_));
  nand2  g355(.a(x070), .b(new_n361_), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n355_), .c(new_n336_), .O(new_n514_));
  nand3  g357(.a(new_n329_), .b(new_n317_), .c(x030), .O(new_n515_));
  aoi21  g358(.a(new_n515_), .b(new_n337_), .c(x086), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(new_n514_), .c(new_n354_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n367_), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n348_), .O(new_n519_));
  oai21  g362(.a(new_n319_), .b(new_n354_), .c(new_n519_), .O(new_n520_));
  oai21  g363(.a(new_n520_), .b(new_n512_), .c(new_n498_), .O(new_n521_));
  nand2  g364(.a(new_n501_), .b(x006), .O(new_n522_));
  inv1   g365(.a(x014), .O(new_n523_));
  nand3  g366(.a(new_n321_), .b(x030), .c(new_n523_), .O(new_n524_));
  aoi21  g367(.a(new_n524_), .b(new_n522_), .c(x070), .O(new_n525_));
  nor2   g368(.a(new_n499_), .b(x086), .O(new_n526_));
  oai21  g369(.a(new_n526_), .b(new_n525_), .c(x038), .O(new_n527_));
  nand2  g370(.a(x086), .b(x006), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n319_), .O(new_n529_));
  aoi21  g372(.a(new_n498_), .b(x038), .c(new_n319_), .O(new_n530_));
  oai21  g373(.a(new_n530_), .b(new_n523_), .c(new_n529_), .O(new_n531_));
  nand2  g374(.a(new_n531_), .b(new_n527_), .O(new_n532_));
  oai21  g375(.a(new_n528_), .b(x038), .c(new_n523_), .O(new_n533_));
  nand2  g376(.a(new_n533_), .b(x078), .O(new_n534_));
  aoi21  g377(.a(x054), .b(x038), .c(z15), .O(new_n535_));
  nand2  g378(.a(new_n535_), .b(new_n534_), .O(new_n536_));
  aoi21  g379(.a(new_n532_), .b(new_n354_), .c(new_n536_), .O(new_n537_));
  aoi21  g380(.a(new_n537_), .b(new_n521_), .c(new_n497_), .O(z14));
  zero   g381(.O(z07));
  zero   g382(.O(z17));
  zero   g383(.O(z20));
  nor2   g384(.a(x077), .b(x045), .O(z16));
  nor2   g385(.a(x077), .b(x045), .O(z18));
  nor2   g386(.a(x077), .b(x045), .O(z19));
  nor2   g387(.a(x077), .b(x045), .O(z21));
  nor2   g388(.a(x077), .b(x045), .O(z22));
  nor2   g389(.a(x077), .b(x045), .O(z23));
  nor2   g390(.a(x077), .b(x045), .O(z24));
  nor2   g391(.a(x077), .b(x045), .O(z25));
  nor2   g392(.a(x077), .b(x045), .O(z26));
  nor2   g393(.a(x077), .b(x045), .O(z27));
endmodule
