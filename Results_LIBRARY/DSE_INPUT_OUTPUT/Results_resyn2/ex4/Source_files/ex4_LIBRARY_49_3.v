// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:19 2020
...
module FAU ( 
  ...
  nand2  g265(.a(new_n180_), .b(new_n422_), .O(new_n423_));
  ...
  nand3  g272(.a(new_n429_), .b(new_n427_), .c(new_n192_), .O(new_n430_));
  nand2  g273(.a(new_n428_), .b(new_n425_), .O(new_n431_));
  nand2  g274(.a(new_n426_), .b(x009), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(new_n431_), .c(new_n191_), .O(new_n433_));
  nand2  g276(.a(new_n428_), .b(new_n426_), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n184_), .O(new_n435_));
  ...
  nand3  g287(.a(new_n444_), .b(new_n442_), .c(new_n206_), .O(new_n445_));
  nand2  g288(.a(new_n443_), .b(new_n440_), .O(new_n446_));
  nand2  g289(.a(new_n441_), .b(x010), .O(new_n447_));
  nand3  g290(.a(new_n447_), .b(new_n446_), .c(new_n205_), .O(new_n448_));
  ...
  nand2  g295(.a(new_n452_), .b(new_n197_), .O(new_n453_));
  ...
  aoi22  g300(.a(new_n457_), .b(x011), .c(x051), .d(new_n214_), .O(new_n458_));
  ...
  oai21  g305(.a(new_n460_), .b(new_n456_), .c(new_n226_), .O(new_n463_));
  aoi21  g306(.a(x051), .b(x035), .c(new_n223_), .O(new_n464_));
  ...
  inv1   g323(.a(new_n252_), .O(new_n481_));
  nand2  g324(.a(x085), .b(x005), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(x037), .c(new_n264_), .O(new_n483_));
  aoi21  g326(.a(new_n481_), .b(new_n293_), .c(new_n483_), .O(new_n484_));
  oai22  g327(.a(new_n484_), .b(new_n177_), .c(new_n293_), .d(new_n292_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n178_), .O(new_n486_));
  nand2  g329(.a(x069), .b(new_n292_), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n299_), .c(new_n274_), .O(new_n488_));
  nand3  g331(.a(new_n267_), .b(new_n253_), .c(x029), .O(new_n489_));
  ...
  oai21  g336(.a(new_n257_), .b(x021), .c(new_n493_), .O(new_n494_));
  and2   g337(.a(new_n494_), .b(x069), .O(new_n495_));
  nand2  g338(.a(new_n285_), .b(new_n283_), .O(new_n496_));
  ...
  oai21  g342(.a(new_n499_), .b(new_n495_), .c(new_n256_), .O(new_n500_));
  oai21  g343(.a(x037), .b(x013), .c(x021), .O(new_n501_));
  oai21  g344(.a(new_n260_), .b(x029), .c(new_n501_), .O(new_n502_));
  oai21  g345(.a(new_n267_), .b(new_n275_), .c(new_n496_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n502_), .c(x069), .O(new_n504_));
  nand3  g347(.a(new_n250_), .b(x125), .c(new_n275_), .O(new_n505_));
  nand3  g348(.a(x101), .b(x069), .c(new_n292_), .O(new_n506_));
  ...
  nand2  g352(.a(new_n509_), .b(new_n293_), .O(new_n510_));
  oai21  g353(.a(x053), .b(new_n292_), .c(new_n481_), .O(new_n511_));
  aoi22  g354(.a(new_n511_), .b(x013), .c(new_n482_), .d(new_n252_), .O(new_n512_));
  ...
  aoi21  g359(.a(new_n494_), .b(new_n256_), .c(x053), .O(new_n517_));
  ...
  nand2  g363(.a(new_n520_), .b(new_n177_), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n486_), .c(x045), .O(z13));
  inv1   g365(.a(new_n313_), .O(new_n523_));
  nand2  g366(.a(x054), .b(new_n337_), .O(new_n524_));
  nand2  g367(.a(x070), .b(new_n337_), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n352_), .c(new_n336_), .O(new_n526_));
  nand3  g369(.a(new_n327_), .b(new_n315_), .c(x030), .O(new_n527_));
  aoi21  g370(.a(new_n527_), .b(new_n330_), .c(x086), .O(new_n528_));
  oai21  g371(.a(new_n528_), .b(new_n526_), .c(new_n345_), .O(new_n529_));
  aoi21  g372(.a(x030), .b(new_n330_), .c(new_n323_), .O(new_n530_));
  nand2  g373(.a(new_n344_), .b(new_n342_), .O(new_n531_));
  oai21  g374(.a(x070), .b(x014), .c(x022), .O(new_n532_));
  nand4  g375(.a(new_n532_), .b(new_n531_), .c(new_n327_), .d(x030), .O(new_n533_));
  oai21  g376(.a(new_n530_), .b(new_n315_), .c(new_n533_), .O(new_n534_));
  nand2  g377(.a(new_n534_), .b(new_n319_), .O(new_n535_));
  oai22  g378(.a(new_n364_), .b(new_n330_), .c(new_n323_), .d(x030), .O(new_n536_));
  oai21  g379(.a(new_n327_), .b(new_n330_), .c(new_n531_), .O(new_n537_));
  aoi21  g380(.a(new_n537_), .b(new_n536_), .c(x070), .O(new_n538_));
  nand3  g381(.a(x102), .b(x070), .c(new_n337_), .O(new_n539_));
  nand3  g382(.a(new_n314_), .b(x126), .c(new_n330_), .O(new_n540_));
  nand3  g383(.a(new_n540_), .b(new_n539_), .c(new_n319_), .O(new_n541_));
  ...
  oai21  g388(.a(new_n317_), .b(new_n351_), .c(new_n545_), .O(new_n546_));
  aoi21  g389(.a(new_n363_), .b(new_n345_), .c(new_n546_), .O(new_n547_));
  ...
  nand3  g393(.a(new_n319_), .b(x030), .c(new_n329_), .O(new_n551_));
  ...
  oai21  g397(.a(new_n319_), .b(new_n336_), .c(new_n317_), .O(new_n555_));
  aoi21  g398(.a(new_n545_), .b(x038), .c(new_n317_), .O(new_n556_));
  oai21  g399(.a(new_n556_), .b(new_n329_), .c(new_n555_), .O(new_n557_));
  ...
  aoi21  g403(.a(new_n560_), .b(new_n329_), .c(new_n351_), .O(new_n561_));
  aoi21  g404(.a(new_n558_), .b(new_n351_), .c(new_n561_), .O(new_n562_));
  ...
  zero   g414(.O(z24));
  zero   g415(.O(z25));
  nor2   g416(.a(new_n178_), .b(new_n177_), .O(z17));
  nor2   g417(.a(new_n178_), .b(new_n177_), .O(z26));
  nor2   g418(.a(new_n178_), .b(new_n177_), .O(z27));
endmodule
