...
module FAU ( 
  ...
  oai21  g134(.a(new_n289_), .b(new_n215_), .c(new_n290_), .O(new_n291_));
  ...
  aoi22  g153(.a(new_n309_), .b(new_n215_), .c(new_n253_), .d(new_n307_), .O(new_n310_));
  ...
  oai21  g348(.a(new_n504_), .b(new_n491_), .c(new_n215_), .O(new_n505_));
  ...
  oai21  g355(.a(new_n511_), .b(new_n509_), .c(new_n215_), .O(new_n512_));
  ...
  oai21  g367(.a(new_n523_), .b(new_n521_), .c(new_n215_), .O(new_n524_));
  ...
  nand3  g411(.a(new_n567_), .b(new_n566_), .c(new_n179_), .O(new_n568_));
  aoi21  g412(.a(new_n564_), .b(new_n352_), .c(new_n568_), .O(new_n569_));
  aoi22  g413(.a(new_n569_), .b(new_n554_), .c(new_n179_), .d(x046), .O(z14));
  zero   g414(.O(z15));
  zero   g415(.O(z17));
  zero   g416(.O(z18));
  zero   g417(.O(z22));
  zero   g418(.O(z23));
  zero   g419(.O(z26));
  nor2   g420(.a(x077), .b(new_n177_), .O(z16));
  nor2   g421(.a(x077), .b(new_n177_), .O(z19));
  nor2   g422(.a(x077), .b(new_n177_), .O(z20));
  nor2   g423(.a(x077), .b(new_n177_), .O(z21));
  nor2   g424(.a(x077), .b(new_n177_), .O(z24));
  nor2   g425(.a(x077), .b(new_n177_), .O(z25));
  nor2   g426(.a(x077), .b(new_n177_), .O(z27));
endmodule
