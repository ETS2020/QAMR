...
module FAU ( 
  ...
  nor2   g021(.a(x100), .b(new_n177_), .O(z07));
  ...
  zero   g417(.O(z25));
  zero   g418(.O(z27));
  nor2   g419(.a(x100), .b(new_n177_), .O(z16));
  nor2   g420(.a(x100), .b(new_n177_), .O(z19));
  nor2   g421(.a(x100), .b(new_n177_), .O(z20));
  nor2   g422(.a(x100), .b(new_n177_), .O(z22));
  nor2   g423(.a(x100), .b(new_n177_), .O(z23));
  nor2   g424(.a(x100), .b(new_n177_), .O(z24));
  nor2   g425(.a(x100), .b(new_n177_), .O(z26));
endmodule
