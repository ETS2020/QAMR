...
module FAU ( 
  ...
  aoi21  g153(.a(new_n309_), .b(new_n294_), .c(new_n177_), .O(z05));
  ...
  nand4  g167(.a(new_n323_), .b(new_n320_), .c(new_n319_), .d(new_n312_), .O(new_n324_));
  ...
  nand2  g190(.a(x070), .b(new_n312_), .O(new_n347_));
  oai21  g191(.a(new_n347_), .b(new_n330_), .c(x022), .O(new_n348_));
  aoi21  g192(.a(new_n348_), .b(x086), .c(new_n346_), .O(new_n349_));
  nand2  g193(.a(x086), .b(new_n316_), .O(new_n350_));
  oai21  g194(.a(new_n349_), .b(new_n344_), .c(new_n350_), .O(new_n351_));
  nand2  g195(.a(new_n318_), .b(new_n317_), .O(new_n352_));
  nor2   g196(.a(new_n352_), .b(x078), .O(new_n353_));
  aoi21  g197(.a(new_n351_), .b(new_n343_), .c(new_n353_), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(new_n342_), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(x054), .O(new_n356_));
  inv1   g200(.a(x038), .O(new_n357_));
  inv1   g201(.a(x006), .O(new_n358_));
  nand2  g202(.a(new_n320_), .b(new_n358_), .O(new_n359_));
  nand3  g203(.a(x086), .b(new_n312_), .c(x014), .O(new_n360_));
  aoi21  g204(.a(new_n360_), .b(new_n359_), .c(new_n318_), .O(new_n361_));
  nor2   g205(.a(new_n314_), .b(new_n311_), .O(new_n362_));
  oai21  g206(.a(new_n362_), .b(new_n361_), .c(new_n357_), .O(new_n363_));
  nand2  g207(.a(new_n311_), .b(x014), .O(new_n364_));
  inv1   g208(.a(new_n364_), .O(new_n365_));
  nor2   g209(.a(x038), .b(x014), .O(new_n366_));
  nor2   g210(.a(new_n366_), .b(new_n352_), .O(new_n367_));
  aoi21  g211(.a(new_n365_), .b(new_n358_), .c(new_n367_), .O(new_n368_));
  aoi21  g212(.a(new_n368_), .b(new_n363_), .c(new_n344_), .O(new_n369_));
  nor2   g213(.a(x054), .b(x038), .O(new_n370_));
  nand3  g214(.a(new_n311_), .b(x038), .c(new_n358_), .O(new_n371_));
  ...
  aoi21  g218(.a(new_n373_), .b(new_n356_), .c(new_n374_), .O(z06));
  ...
  nand2  g254(.a(new_n410_), .b(new_n399_), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(new_n157_), .O(new_n412_));
  nand2  g256(.a(new_n379_), .b(x000), .O(new_n413_));
  nand3  g257(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n414_));
  aoi21  g258(.a(new_n414_), .b(new_n413_), .c(x064), .O(new_n415_));
  and2   g259(.a(new_n394_), .b(new_n173_), .O(new_n416_));
  oai21  g260(.a(new_n416_), .b(new_n415_), .c(x032), .O(new_n417_));
  nand2  g261(.a(x080), .b(x000), .O(new_n418_));
  nand2  g262(.a(new_n418_), .b(new_n408_), .O(new_n419_));
  aoi21  g263(.a(new_n157_), .b(x032), .c(new_n408_), .O(new_n420_));
  ...
  oai21  g326(.a(new_n269_), .b(x029), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(new_n272_), .b(new_n275_), .O(new_n484_));
  oai21  g328(.a(new_n265_), .b(new_n262_), .c(new_n484_), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n483_), .c(x069), .O(new_n486_));
  nand3  g330(.a(new_n279_), .b(x125), .c(new_n262_), .O(new_n487_));
  nand3  g331(.a(x101), .b(x069), .c(new_n263_), .O(new_n488_));
  nand3  g332(.a(new_n488_), .b(new_n487_), .c(new_n283_), .O(new_n489_));
  oai21  g333(.a(new_n489_), .b(new_n486_), .c(x005), .O(new_n490_));
  nand2  g334(.a(x069), .b(new_n263_), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n302_), .c(new_n258_), .O(new_n492_));
  nand3  g336(.a(new_n265_), .b(new_n259_), .c(x029), .O(new_n493_));
  nor2   g337(.a(x021), .b(x013), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n493_), .c(x085), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n492_), .c(new_n273_), .O(new_n496_));
  oai21  g340(.a(new_n260_), .b(x021), .c(new_n268_), .O(new_n497_));
  and2   g341(.a(new_n497_), .b(x069), .O(new_n498_));
  oai21  g342(.a(x069), .b(x013), .c(x021), .O(new_n499_));
  nand4  g343(.a(new_n499_), .b(new_n484_), .c(new_n265_), .d(x029), .O(new_n500_));
  inv1   g344(.a(new_n500_), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(new_n498_), .c(new_n283_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n496_), .c(new_n490_), .O(new_n503_));
  nand2  g347(.a(new_n484_), .b(x005), .O(new_n504_));
  nand3  g348(.a(new_n283_), .b(x029), .c(new_n261_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n504_), .c(x069), .O(new_n506_));
  nand2  g350(.a(new_n497_), .b(new_n283_), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n306_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n506_), .c(x037), .O(new_n509_));
  nand2  g353(.a(x085), .b(x005), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(x013), .c(new_n281_), .O(new_n511_));
  nand3  g355(.a(new_n306_), .b(x037), .c(x013), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n511_), .c(x045), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n509_), .O(new_n514_));
  aoi21  g358(.a(new_n503_), .b(new_n306_), .c(new_n514_), .O(new_n515_));
  nor2   g359(.a(new_n281_), .b(x053), .O(new_n516_));
  oai21  g360(.a(new_n510_), .b(x037), .c(new_n261_), .O(new_n517_));
  oai21  g361(.a(new_n517_), .b(new_n516_), .c(x077), .O(new_n518_));
  oai21  g362(.a(new_n306_), .b(new_n263_), .c(new_n518_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n177_), .O(new_n520_));
  oai21  g364(.a(new_n515_), .b(x077), .c(new_n520_), .O(z13));
  inv1   g365(.a(x054), .O(new_n522_));
  aoi21  g366(.a(x030), .b(new_n317_), .c(new_n323_), .O(new_n523_));
  oai21  g367(.a(x070), .b(x014), .c(x022), .O(new_n524_));
  nand2  g368(.a(new_n337_), .b(new_n333_), .O(new_n525_));
  nand4  g369(.a(new_n525_), .b(new_n524_), .c(new_n313_), .d(x030), .O(new_n526_));
  oai21  g370(.a(new_n523_), .b(new_n318_), .c(new_n526_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n311_), .O(new_n528_));
  oai22  g372(.a(new_n366_), .b(new_n317_), .c(new_n323_), .d(x030), .O(new_n529_));
  oai21  g373(.a(new_n313_), .b(new_n317_), .c(new_n525_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n529_), .c(x070), .O(new_n531_));
  nand3  g375(.a(x102), .b(x070), .c(new_n357_), .O(new_n532_));
  nand3  g376(.a(new_n343_), .b(x126), .c(new_n317_), .O(new_n533_));
  nand3  g377(.a(new_n533_), .b(new_n532_), .c(new_n311_), .O(new_n534_));
  oai21  g378(.a(new_n534_), .b(new_n531_), .c(x006), .O(new_n535_));
  aoi21  g379(.a(new_n535_), .b(new_n528_), .c(x078), .O(new_n536_));
  inv1   g380(.a(new_n336_), .O(new_n537_));
  nand2  g381(.a(x070), .b(new_n357_), .O(new_n538_));
  aoi21  g382(.a(new_n538_), .b(new_n352_), .c(new_n358_), .O(new_n539_));
  nand3  g383(.a(new_n313_), .b(new_n318_), .c(x030), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n317_), .c(x086), .O(new_n541_));
  oai21  g385(.a(new_n541_), .b(new_n539_), .c(new_n344_), .O(new_n542_));
  nand2  g386(.a(new_n542_), .b(new_n364_), .O(new_n543_));
  nand2  g387(.a(new_n543_), .b(new_n537_), .O(new_n544_));
  nand3  g388(.a(x078), .b(x070), .c(x022), .O(new_n545_));
  nand2  g389(.a(new_n545_), .b(new_n544_), .O(new_n546_));
  oai21  g390(.a(new_n546_), .b(new_n536_), .c(new_n522_), .O(new_n547_));
  nand2  g391(.a(new_n525_), .b(x006), .O(new_n548_));
  nand3  g392(.a(new_n311_), .b(x030), .c(new_n316_), .O(new_n549_));
  aoi21  g393(.a(new_n549_), .b(new_n548_), .c(x070), .O(new_n550_));
  nor2   g394(.a(new_n523_), .b(x086), .O(new_n551_));
  oai21  g395(.a(new_n551_), .b(new_n550_), .c(x038), .O(new_n552_));
  nand2  g396(.a(x086), .b(x006), .O(new_n553_));
  oai21  g397(.a(new_n553_), .b(x014), .c(new_n345_), .O(new_n554_));
  oai21  g398(.a(new_n357_), .b(new_n316_), .c(new_n554_), .O(new_n555_));
  nand2  g399(.a(new_n555_), .b(new_n552_), .O(new_n556_));
  oai21  g400(.a(new_n553_), .b(x038), .c(new_n316_), .O(new_n557_));
  nand2  g401(.a(new_n557_), .b(x078), .O(new_n558_));
  oai21  g402(.a(new_n522_), .b(new_n357_), .c(new_n558_), .O(new_n559_));
  aoi21  g403(.a(new_n556_), .b(new_n344_), .c(new_n559_), .O(new_n560_));
  inv1   g404(.a(x046), .O(new_n561_));
  nand2  g405(.a(new_n179_), .b(new_n561_), .O(new_n562_));
  aoi21  g406(.a(new_n560_), .b(new_n547_), .c(new_n562_), .O(z14));
  zero   g407(.O(z16));
  zero   g408(.O(z23));
  zero   g409(.O(z25));
  zero   g410(.O(z27));
  nor2   g411(.a(x077), .b(new_n177_), .O(z15));
  nor2   g412(.a(x077), .b(new_n177_), .O(z17));
  ...
  nor2   g418(.a(x077), .b(new_n177_), .O(z24));
