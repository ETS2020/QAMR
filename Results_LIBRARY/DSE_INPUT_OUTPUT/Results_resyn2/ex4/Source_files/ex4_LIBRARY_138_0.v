...
module FAU ( 
  ...
  nand2  g113(.a(new_n269_), .b(x058), .O(new_n270_));
  ...
  zero   g420(.O(z25));
  zero   g421(.O(z26));
  nor2   g422(.a(x077), .b(x058), .O(z15));
  nor2   g423(.a(x077), .b(x058), .O(z16));
  nor2   g424(.a(x077), .b(x058), .O(z20));
  nor2   g425(.a(x077), .b(x058), .O(z24));
  nor2   g426(.a(x077), .b(x058), .O(z27));
endmodule
