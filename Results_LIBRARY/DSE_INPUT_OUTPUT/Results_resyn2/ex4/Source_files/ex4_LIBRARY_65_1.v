...
module FAU ( 
  ...
  nor2   g022(.a(new_n178_), .b(x067), .O(z18));
  ...
  nand2  g155(.a(new_n311_), .b(x067), .O(new_n312_));
  ...
  oai21  g357(.a(new_n258_), .b(new_n178_), .c(new_n514_), .O(new_n515_));
  aoi21  g358(.a(new_n513_), .b(new_n178_), .c(new_n515_), .O(new_n516_));
  ...
  aoi21  g371(.a(new_n525_), .b(new_n178_), .c(new_n528_), .O(new_n529_));
  ...
  nand2  g376(.a(x070), .b(new_n377_), .O(new_n534_));
  aoi21  g377(.a(new_n534_), .b(new_n362_), .c(new_n343_), .O(new_n535_));
  nand2  g378(.a(x094), .b(x062), .O(new_n536_));
  nand3  g379(.a(new_n536_), .b(new_n321_), .c(x030), .O(new_n537_));
  aoi21  g380(.a(new_n537_), .b(new_n337_), .c(x086), .O(new_n538_));
  oai21  g381(.a(new_n538_), .b(new_n535_), .c(new_n355_), .O(new_n539_));
  aoi21  g382(.a(x030), .b(new_n337_), .c(new_n329_), .O(new_n540_));
  oai21  g383(.a(x070), .b(x014), .c(x022), .O(new_n541_));
  nand2  g384(.a(new_n353_), .b(new_n351_), .O(new_n542_));
  nand4  g385(.a(new_n542_), .b(new_n541_), .c(new_n536_), .d(x030), .O(new_n543_));
  oai21  g386(.a(new_n540_), .b(new_n321_), .c(new_n543_), .O(new_n544_));
  nand2  g387(.a(new_n544_), .b(new_n325_), .O(new_n545_));
  oai21  g388(.a(x038), .b(x014), .c(x022), .O(new_n546_));
  oai21  g389(.a(new_n329_), .b(x030), .c(new_n546_), .O(new_n547_));
  oai21  g390(.a(new_n536_), .b(new_n337_), .c(new_n542_), .O(new_n548_));
  aoi21  g391(.a(new_n548_), .b(new_n547_), .c(x070), .O(new_n549_));
  nand3  g392(.a(x102), .b(x070), .c(new_n377_), .O(new_n550_));
  nand3  g393(.a(new_n320_), .b(x126), .c(new_n337_), .O(new_n551_));
  nand3  g394(.a(new_n551_), .b(new_n550_), .c(new_n325_), .O(new_n552_));
  oai21  g395(.a(new_n552_), .b(new_n549_), .c(x006), .O(new_n553_));
  nand3  g396(.a(new_n553_), .b(new_n545_), .c(new_n539_), .O(new_n554_));
  oai22  g397(.a(new_n373_), .b(new_n354_), .c(new_n323_), .d(new_n361_), .O(new_n555_));
  aoi21  g398(.a(new_n554_), .b(new_n361_), .c(new_n555_), .O(new_n556_));
  ...
  oai21  g405(.a(new_n562_), .b(x014), .c(new_n323_), .O(new_n563_));
  nand2  g406(.a(new_n563_), .b(new_n344_), .O(new_n564_));
  nand2  g407(.a(new_n564_), .b(new_n561_), .O(new_n565_));
  oai21  g408(.a(new_n562_), .b(x038), .c(new_n336_), .O(new_n566_));
  nand2  g409(.a(new_n566_), .b(x078), .O(new_n567_));
  oai21  g410(.a(new_n319_), .b(new_n377_), .c(new_n567_), .O(new_n568_));
  aoi21  g411(.a(new_n565_), .b(new_n361_), .c(new_n568_), .O(new_n569_));
