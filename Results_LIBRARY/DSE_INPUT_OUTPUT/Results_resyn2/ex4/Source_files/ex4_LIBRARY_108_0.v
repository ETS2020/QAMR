// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:59 2020
...
module FAU ( 
  ...
  nor2   g167(.a(z07), .b(x046), .O(new_n324_));
  ...
  nand4  g181(.a(new_n337_), .b(new_n336_), .c(new_n333_), .d(new_n326_), .O(new_n338_));
  ...
  aoi21  g186(.a(new_n340_), .b(new_n331_), .c(new_n342_), .O(new_n343_));
  ...
  nand2  g201(.a(x070), .b(x022), .O(new_n358_));
  aoi21  g202(.a(new_n358_), .b(new_n348_), .c(x006), .O(new_n359_));
  nand3  g203(.a(new_n336_), .b(x070), .c(new_n326_), .O(new_n360_));
  aoi21  g204(.a(new_n360_), .b(x022), .c(new_n325_), .O(new_n361_));
  oai21  g205(.a(new_n361_), .b(new_n359_), .c(x078), .O(new_n362_));
  nand2  g206(.a(x086), .b(new_n330_), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(new_n362_), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(new_n357_), .O(new_n365_));
  inv1   g209(.a(x078), .O(new_n366_));
  nand3  g210(.a(new_n366_), .b(new_n332_), .c(new_n331_), .O(new_n367_));
  nand3  g211(.a(new_n367_), .b(new_n365_), .c(new_n356_), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(x054), .O(new_n369_));
  inv1   g213(.a(x038), .O(new_n370_));
  inv1   g214(.a(x006), .O(new_n371_));
  nand2  g215(.a(new_n337_), .b(new_n371_), .O(new_n372_));
  nand3  g216(.a(x086), .b(new_n326_), .c(x014), .O(new_n373_));
  aoi21  g217(.a(new_n373_), .b(new_n372_), .c(new_n332_), .O(new_n374_));
  nor2   g218(.a(new_n328_), .b(new_n325_), .O(new_n375_));
  oai21  g219(.a(new_n375_), .b(new_n374_), .c(new_n370_), .O(new_n376_));
  nand2  g220(.a(new_n332_), .b(new_n331_), .O(new_n377_));
  aoi21  g221(.a(x054), .b(new_n370_), .c(new_n377_), .O(new_n378_));
  oai21  g222(.a(x086), .b(x006), .c(new_n377_), .O(new_n379_));
  aoi21  g223(.a(new_n379_), .b(x014), .c(new_n378_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(new_n376_), .O(new_n381_));
  nor2   g225(.a(x086), .b(x006), .O(new_n382_));
  aoi21  g226(.a(new_n382_), .b(x038), .c(new_n330_), .O(new_n383_));
  inv1   g227(.a(x054), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n370_), .c(z07), .O(new_n385_));
  oai21  g229(.a(new_n383_), .b(x078), .c(new_n385_), .O(new_n386_));
  aoi21  g230(.a(new_n381_), .b(x078), .c(new_n386_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n369_), .c(new_n324_), .O(z06));
  inv1   g232(.a(x040), .O(new_n389_));
  inv1   g233(.a(x072), .O(new_n390_));
  nand2  g234(.a(x088), .b(x056), .O(new_n391_));
  oai21  g235(.a(x120), .b(x096), .c(new_n391_), .O(new_n392_));
  aoi21  g236(.a(new_n169_), .b(new_n170_), .c(new_n158_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(new_n392_), .O(new_n394_));
  inv1   g238(.a(x024), .O(new_n395_));
  inv1   g239(.a(x096), .O(new_n396_));
  inv1   g240(.a(x120), .O(new_n397_));
  nor2   g241(.a(x088), .b(x056), .O(new_n398_));
  nand4  g242(.a(new_n398_), .b(new_n397_), .c(new_n396_), .d(new_n395_), .O(new_n399_));
  nand3  g243(.a(new_n399_), .b(new_n394_), .c(new_n159_), .O(new_n400_));
  ...
  nand3  g247(.a(new_n403_), .b(new_n402_), .c(new_n173_), .O(new_n404_));
  inv1   g248(.a(new_n404_), .O(new_n405_));
  aoi21  g249(.a(new_n405_), .b(new_n400_), .c(new_n172_), .O(new_n406_));
  inv1   g250(.a(new_n398_), .O(new_n407_));
  nor2   g251(.a(new_n395_), .b(x016), .O(new_n408_));
  oai21  g252(.a(new_n408_), .b(new_n407_), .c(x064), .O(new_n409_));
  nand2  g253(.a(new_n397_), .b(new_n396_), .O(new_n410_));
  oai21  g254(.a(x064), .b(x008), .c(x016), .O(new_n411_));
  nand4  g255(.a(new_n411_), .b(new_n391_), .c(new_n410_), .d(x024), .O(new_n412_));
  aoi21  g256(.a(new_n412_), .b(new_n409_), .c(x080), .O(new_n413_));
  oai21  g257(.a(new_n413_), .b(new_n406_), .c(new_n390_), .O(new_n414_));
  or2    g258(.a(x112), .b(x104), .O(new_n415_));
  nand2  g259(.a(new_n173_), .b(x008), .O(new_n416_));
  nand2  g260(.a(x064), .b(new_n169_), .O(new_n417_));
  aoi21  g261(.a(new_n417_), .b(new_n160_), .c(new_n172_), .O(new_n418_));
  nand3  g262(.a(new_n391_), .b(new_n159_), .c(x024), .O(new_n419_));
  aoi21  g263(.a(new_n419_), .b(new_n158_), .c(x080), .O(new_n420_));
  oai21  g264(.a(new_n420_), .b(new_n418_), .c(new_n390_), .O(new_n421_));
  nand2  g265(.a(new_n421_), .b(new_n416_), .O(new_n422_));
  nor2   g266(.a(new_n159_), .b(new_n158_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(x072), .O(new_n424_));
  inv1   g268(.a(new_n424_), .O(new_n425_));
  aoi21  g269(.a(new_n422_), .b(new_n415_), .c(new_n425_), .O(new_n426_));
  aoi21  g270(.a(new_n426_), .b(new_n414_), .c(x048), .O(new_n427_));
  nand2  g271(.a(new_n410_), .b(x000), .O(new_n428_));
  nand3  g272(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n429_));
  aoi21  g273(.a(new_n429_), .b(new_n428_), .c(x064), .O(new_n430_));
  inv1   g274(.a(new_n408_), .O(new_n431_));
  aoi21  g275(.a(new_n431_), .b(new_n398_), .c(x080), .O(new_n432_));
  oai21  g276(.a(new_n432_), .b(new_n430_), .c(x032), .O(new_n433_));
  inv1   g277(.a(new_n423_), .O(new_n434_));
  nand2  g278(.a(x080), .b(x000), .O(new_n435_));
  nand2  g279(.a(new_n435_), .b(new_n434_), .O(new_n436_));
  aoi21  g280(.a(new_n157_), .b(x032), .c(new_n434_), .O(new_n437_));
  oai21  g281(.a(new_n437_), .b(new_n170_), .c(new_n436_), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(new_n433_), .O(new_n439_));
  nand2  g283(.a(new_n439_), .b(new_n390_), .O(new_n440_));
  oai21  g284(.a(new_n435_), .b(x032), .c(new_n170_), .O(new_n441_));
  aoi22  g285(.a(new_n441_), .b(x072), .c(x048), .d(x032), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n440_), .O(new_n443_));
  oai21  g287(.a(new_n443_), .b(new_n427_), .c(new_n389_), .O(new_n444_));
  ...
  oai21  g322(.a(new_n476_), .b(new_n472_), .c(new_n237_), .O(new_n479_));
  aoi21  g323(.a(x051), .b(x035), .c(new_n233_), .O(new_n480_));
  nand4  g324(.a(new_n480_), .b(new_n479_), .c(new_n478_), .d(new_n475_), .O(new_n481_));
  and2   g325(.a(new_n481_), .b(new_n222_), .O(z11));
  nand2  g326(.a(x068), .b(x020), .O(new_n483_));
  inv1   g327(.a(new_n483_), .O(new_n484_));
  nand2  g328(.a(x084), .b(x004), .O(new_n485_));
  aoi22  g329(.a(new_n485_), .b(x012), .c(x052), .d(new_n245_), .O(new_n486_));
  ...
  oai21  g334(.a(new_n488_), .b(new_n484_), .c(new_n257_), .O(new_n491_));
  aoi21  g335(.a(x052), .b(x036), .c(new_n254_), .O(new_n492_));
  ...
  nand2  g339(.a(new_n263_), .b(new_n261_), .O(new_n496_));
  oai21  g340(.a(new_n261_), .b(x037), .c(new_n496_), .O(new_n497_));
  nor2   g341(.a(x037), .b(new_n302_), .O(new_n498_));
  nand2  g342(.a(x077), .b(new_n272_), .O(new_n499_));
  aoi21  g343(.a(new_n498_), .b(x085), .c(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(new_n497_), .c(x045), .O(z13));
  inv1   g345(.a(new_n324_), .O(new_n502_));
  inv1   g346(.a(new_n350_), .O(new_n503_));
  nand2  g347(.a(x070), .b(new_n370_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n377_), .c(new_n371_), .O(new_n505_));
  nand3  g349(.a(new_n327_), .b(new_n332_), .c(x030), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n331_), .c(x086), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n505_), .c(new_n503_), .O(new_n508_));
  aoi21  g352(.a(x030), .b(new_n331_), .c(new_n336_), .O(new_n509_));
  oai21  g353(.a(x070), .b(x014), .c(x022), .O(new_n510_));
  nand2  g354(.a(new_n351_), .b(new_n347_), .O(new_n511_));
  nand4  g355(.a(new_n511_), .b(new_n510_), .c(new_n327_), .d(x030), .O(new_n512_));
  oai21  g356(.a(new_n509_), .b(new_n332_), .c(new_n512_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n325_), .O(new_n514_));
  oai21  g358(.a(x038), .b(x014), .c(x022), .O(new_n515_));
  nand3  g359(.a(new_n335_), .b(new_n334_), .c(new_n326_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  oai22  g361(.a(new_n327_), .b(new_n331_), .c(x126), .d(x102), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n517_), .c(x070), .O(new_n519_));
  nand3  g363(.a(x102), .b(x070), .c(new_n370_), .O(new_n520_));
  nand3  g364(.a(new_n357_), .b(x126), .c(new_n331_), .O(new_n521_));
  nand3  g365(.a(new_n521_), .b(new_n520_), .c(new_n325_), .O(new_n522_));
  oai21  g366(.a(new_n522_), .b(new_n519_), .c(x006), .O(new_n523_));
  nand3  g367(.a(new_n523_), .b(new_n514_), .c(new_n508_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n366_), .O(new_n525_));
  inv1   g369(.a(new_n358_), .O(new_n526_));
  nor2   g370(.a(x086), .b(new_n330_), .O(new_n527_));
  aoi22  g371(.a(new_n527_), .b(new_n503_), .c(new_n526_), .d(x078), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n525_), .O(new_n529_));
  nand2  g373(.a(new_n529_), .b(new_n384_), .O(new_n530_));
  nand2  g374(.a(new_n511_), .b(x006), .O(new_n531_));
  nand3  g375(.a(new_n325_), .b(x030), .c(new_n330_), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n531_), .c(x070), .O(new_n533_));
  nor2   g377(.a(new_n509_), .b(x086), .O(new_n534_));
  oai21  g378(.a(new_n534_), .b(new_n533_), .c(x038), .O(new_n535_));
  nand2  g379(.a(x086), .b(x006), .O(new_n536_));
  oai21  g380(.a(new_n536_), .b(x014), .c(new_n358_), .O(new_n537_));
  nand2  g381(.a(new_n537_), .b(new_n340_), .O(new_n538_));
  nand2  g382(.a(new_n538_), .b(new_n535_), .O(new_n539_));
  oai21  g383(.a(new_n536_), .b(x038), .c(new_n330_), .O(new_n540_));
  nand2  g384(.a(new_n540_), .b(x078), .O(new_n541_));
  oai21  g385(.a(new_n384_), .b(new_n370_), .c(new_n541_), .O(new_n542_));
  aoi21  g386(.a(new_n539_), .b(new_n366_), .c(new_n542_), .O(new_n543_));
  aoi21  g387(.a(new_n543_), .b(new_n530_), .c(new_n502_), .O(z14));
  zero   g388(.O(z15));
  zero   g389(.O(z16));
  zero   g390(.O(z17));
  zero   g391(.O(z18));
  ...
  zero   g394(.O(z22));
  zero   g395(.O(z27));
  inv1   g396(.a(new_n179_), .O(z21));
  inv1   g397(.a(new_n179_), .O(z23));
  inv1   g398(.a(new_n179_), .O(z24));
  inv1   g399(.a(new_n179_), .O(z25));
  inv1   g400(.a(new_n179_), .O(z26));
endmodule
