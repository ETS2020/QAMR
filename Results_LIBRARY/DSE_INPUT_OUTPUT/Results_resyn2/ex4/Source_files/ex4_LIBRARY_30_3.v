// Benchmark "FAU" written by ABC on Wed Aug 12 10:04:32 2020
...
module FAU ( 
  ...
  nand2  g170(.a(new_n180_), .b(x046), .O(new_n327_));
  ...
  inv1   g229(.a(x009), .O(new_n387_));
  nand2  g230(.a(x065), .b(x017), .O(new_n388_));
  nand2  g231(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  nand2  g232(.a(x081), .b(x001), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(x009), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n389_), .c(new_n192_), .O(new_n392_));
  nand2  g235(.a(new_n390_), .b(new_n387_), .O(new_n393_));
  nand2  g236(.a(new_n388_), .b(x009), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(new_n393_), .c(new_n191_), .O(new_n395_));
  nand2  g238(.a(new_n390_), .b(new_n388_), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(new_n184_), .O(new_n397_));
  aoi22  g240(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n398_));
  nand4  g241(.a(new_n398_), .b(new_n397_), .c(new_n395_), .d(new_n392_), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(new_n183_), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(new_n180_), .O(z09));
  nand2  g244(.a(x066), .b(x018), .O(new_n402_));
  inv1   g245(.a(new_n402_), .O(new_n403_));
  nand2  g246(.a(x082), .b(x002), .O(new_n404_));
  aoi22  g247(.a(new_n404_), .b(x010), .c(x050), .d(new_n200_), .O(new_n405_));
  oai21  g248(.a(new_n403_), .b(x010), .c(new_n405_), .O(new_n406_));
  inv1   g249(.a(new_n404_), .O(new_n407_));
  aoi21  g250(.a(new_n402_), .b(x010), .c(x034), .O(new_n408_));
  oai21  g251(.a(new_n407_), .b(x010), .c(new_n408_), .O(new_n409_));
  oai21  g252(.a(new_n407_), .b(new_n403_), .c(new_n212_), .O(new_n410_));
  aoi21  g253(.a(x050), .b(x034), .c(new_n209_), .O(new_n411_));
  nand4  g254(.a(new_n411_), .b(new_n410_), .c(new_n409_), .d(new_n406_), .O(new_n412_));
  inv1   g255(.a(new_n412_), .O(new_n413_));
  nor3   g256(.a(new_n413_), .b(z16), .c(x042), .O(z10));
  nand2  g257(.a(x067), .b(x019), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(new_n416_));
  nand2  g259(.a(x083), .b(x003), .O(new_n417_));
  aoi22  g260(.a(new_n417_), .b(x011), .c(x051), .d(new_n219_), .O(new_n418_));
  oai21  g261(.a(new_n416_), .b(x011), .c(new_n418_), .O(new_n419_));
  inv1   g262(.a(new_n417_), .O(new_n420_));
  aoi21  g263(.a(new_n415_), .b(x011), .c(x035), .O(new_n421_));
  oai21  g264(.a(new_n420_), .b(x011), .c(new_n421_), .O(new_n422_));
  oai21  g265(.a(new_n420_), .b(new_n416_), .c(new_n231_), .O(new_n423_));
  aoi21  g266(.a(x051), .b(x035), .c(new_n228_), .O(new_n424_));
  nand4  g267(.a(new_n424_), .b(new_n423_), .c(new_n422_), .d(new_n419_), .O(new_n425_));
  inv1   g268(.a(new_n425_), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(x043), .c(new_n180_), .O(z11));
  nand2  g270(.a(x068), .b(x020), .O(new_n428_));
  inv1   g271(.a(new_n428_), .O(new_n429_));
  nand2  g272(.a(x084), .b(x004), .O(new_n430_));
  aoi22  g273(.a(new_n430_), .b(x012), .c(x052), .d(new_n238_), .O(new_n431_));
  ...
  oai21  g278(.a(new_n433_), .b(new_n429_), .c(new_n250_), .O(new_n436_));
  aoi21  g279(.a(x052), .b(x036), .c(new_n247_), .O(new_n437_));
  nand4  g280(.a(new_n437_), .b(new_n436_), .c(new_n435_), .d(new_n432_), .O(new_n438_));
  inv1   g281(.a(new_n438_), .O(new_n439_));
  nor3   g282(.a(new_n439_), .b(z16), .c(x044), .O(z12));
  nand2  g283(.a(new_n258_), .b(new_n257_), .O(new_n441_));
  nand2  g284(.a(x069), .b(new_n260_), .O(new_n442_));
  aoi21  g285(.a(new_n442_), .b(new_n441_), .c(new_n254_), .O(new_n443_));
  nand2  g286(.a(x093), .b(x061), .O(new_n444_));
  nand3  g287(.a(new_n444_), .b(new_n258_), .c(x029), .O(new_n445_));
  aoi21  g288(.a(new_n445_), .b(new_n257_), .c(x085), .O(new_n446_));
  ...
  oai21  g301(.a(new_n458_), .b(new_n453_), .c(new_n258_), .O(new_n459_));
  nand3  g302(.a(x101), .b(x069), .c(new_n260_), .O(new_n460_));
  nand2  g303(.a(x117), .b(x109), .O(new_n461_));
  nand3  g304(.a(new_n461_), .b(x125), .c(new_n257_), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n460_), .c(new_n255_), .O(new_n463_));
  ...
  nand2  g312(.a(new_n255_), .b(x013), .O(new_n470_));
  oai22  g313(.a(new_n470_), .b(new_n468_), .c(new_n469_), .d(new_n178_), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n261_), .O(new_n472_));
  nand2  g315(.a(new_n453_), .b(x005), .O(new_n473_));
  nand3  g316(.a(new_n255_), .b(x029), .c(new_n263_), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n473_), .c(x069), .O(new_n475_));
  and2   g318(.a(new_n450_), .b(new_n255_), .O(new_n476_));
  ...
  aoi21  g322(.a(new_n261_), .b(x037), .c(new_n469_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n263_), .c(new_n479_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n477_), .O(new_n482_));
  oai21  g325(.a(new_n478_), .b(x037), .c(new_n263_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(x077), .O(new_n484_));
  oai21  g327(.a(new_n261_), .b(new_n260_), .c(new_n484_), .O(new_n485_));
  ...
  nand2  g331(.a(x070), .b(new_n312_), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n306_), .c(new_n287_), .O(new_n490_));
  nand3  g333(.a(new_n280_), .b(new_n268_), .c(x030), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n288_), .c(x086), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n490_), .c(new_n299_), .O(new_n493_));
  aoi21  g336(.a(x030), .b(new_n288_), .c(new_n276_), .O(new_n494_));
  oai21  g337(.a(x070), .b(x014), .c(x022), .O(new_n495_));
  nand2  g338(.a(new_n298_), .b(new_n296_), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n495_), .c(new_n280_), .d(x030), .O(new_n497_));
  oai21  g340(.a(new_n494_), .b(new_n268_), .c(new_n497_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n272_), .O(new_n499_));
  oai21  g342(.a(x038), .b(x014), .c(x022), .O(new_n500_));
  nand3  g343(.a(new_n275_), .b(new_n274_), .c(new_n273_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  oai22  g345(.a(new_n280_), .b(new_n288_), .c(x126), .d(x102), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n502_), .c(x070), .O(new_n504_));
  nand3  g347(.a(x102), .b(x070), .c(new_n312_), .O(new_n505_));
  nand3  g348(.a(new_n267_), .b(x126), .c(new_n288_), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n505_), .c(new_n272_), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(new_n504_), .c(x006), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n499_), .c(new_n493_), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n305_), .O(new_n510_));
  inv1   g353(.a(new_n270_), .O(new_n511_));
  aoi22  g354(.a(new_n319_), .b(new_n299_), .c(new_n511_), .d(x078), .O(new_n512_));
  nand2  g355(.a(new_n512_), .b(new_n510_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n488_), .O(new_n514_));
  nand2  g357(.a(new_n496_), .b(x006), .O(new_n515_));
  nand3  g358(.a(new_n272_), .b(x030), .c(new_n318_), .O(new_n516_));
  aoi21  g359(.a(new_n516_), .b(new_n515_), .c(x070), .O(new_n517_));
  nor2   g360(.a(new_n494_), .b(x086), .O(new_n518_));
  oai21  g361(.a(new_n518_), .b(new_n517_), .c(x038), .O(new_n519_));
  nand2  g362(.a(x086), .b(x006), .O(new_n520_));
  oai21  g363(.a(new_n520_), .b(x014), .c(new_n270_), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(new_n289_), .O(new_n522_));
  nand2  g365(.a(new_n522_), .b(new_n519_), .O(new_n523_));
  oai21  g366(.a(new_n520_), .b(x038), .c(new_n318_), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(x078), .O(new_n525_));
  oai21  g368(.a(new_n488_), .b(new_n312_), .c(new_n525_), .O(new_n526_));
  aoi21  g369(.a(new_n523_), .b(new_n305_), .c(new_n526_), .O(new_n527_));
  inv1   g370(.a(x046), .O(new_n528_));
  nand2  g371(.a(new_n180_), .b(new_n528_), .O(new_n529_));
  aoi21  g372(.a(new_n527_), .b(new_n514_), .c(new_n529_), .O(z14));
  zero   g373(.O(z07));
  zero   g374(.O(z15));
  zero   g375(.O(z17));
  zero   g376(.O(z19));
  ...
  nor2   g385(.a(new_n178_), .b(new_n177_), .O(z27));
endmodule
