...
module FAU ( 
  ...
  nand2  g349(.a(new_n505_), .b(new_n178_), .O(new_n506_));
  ...
  zero   g415(.O(z22));
  zero   g416(.O(z25));
  inv1   g417(.a(new_n179_), .O(z15));
  inv1   g418(.a(new_n179_), .O(z16));
  inv1   g419(.a(new_n179_), .O(z17));
  inv1   g420(.a(new_n179_), .O(z23));
  inv1   g421(.a(new_n179_), .O(z24));
  inv1   g422(.a(new_n179_), .O(z26));
  inv1   g423(.a(new_n179_), .O(z27));
endmodule
