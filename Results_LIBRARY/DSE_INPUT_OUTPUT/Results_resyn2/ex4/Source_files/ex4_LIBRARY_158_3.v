...
module FAU ( 
  ...
  nand2  g021(.a(x107), .b(x077), .O(new_n178_));
  ...
  oai21  g050(.a(new_n206_), .b(new_n194_), .c(new_n178_), .O(z02));
  ...
  nand2  g068(.a(new_n178_), .b(x043), .O(new_n225_));
  aoi21  g069(.a(new_n224_), .b(new_n214_), .c(new_n225_), .O(z03));
  inv1   g070(.a(new_n178_), .O(z25));
  ...
  nor2   g085(.a(new_n241_), .b(z25), .O(new_n242_));
  oai21  g086(.a(x052), .b(x036), .c(new_n242_), .O(new_n243_));
  inv1   g087(.a(new_n243_), .O(new_n244_));
  nand4  g088(.a(new_n244_), .b(new_n240_), .c(new_n238_), .d(new_n235_), .O(new_n245_));
  inv1   g089(.a(new_n245_), .O(new_n246_));
  nor2   g090(.a(new_n246_), .b(new_n228_), .O(z04));
  ...
  nand2  g214(.a(new_n370_), .b(new_n178_), .O(z06));
  ...
  nand2  g267(.a(new_n424_), .b(new_n178_), .O(z08));
  ...
  aoi22  g301(.a(new_n458_), .b(x011), .c(x051), .d(new_n211_), .O(new_n459_));
  ...
  oai21  g306(.a(new_n461_), .b(new_n457_), .c(new_n223_), .O(new_n464_));
  aoi21  g307(.a(x051), .b(x035), .c(new_n220_), .O(new_n465_));
  nand4  g308(.a(new_n465_), .b(new_n464_), .c(new_n463_), .d(new_n460_), .O(new_n466_));
  inv1   g309(.a(new_n466_), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(x043), .c(new_n178_), .O(z11));
  ...
  oai21  g320(.a(new_n475_), .b(new_n470_), .c(new_n241_), .O(new_n478_));
  aoi21  g321(.a(x052), .b(x036), .c(new_n239_), .O(new_n479_));
  nand4  g322(.a(new_n479_), .b(new_n478_), .c(new_n477_), .d(new_n474_), .O(new_n480_));
  and2   g323(.a(new_n480_), .b(new_n228_), .O(z12));
  ...
  nand2  g370(.a(new_n527_), .b(new_n178_), .O(z13));
