// Benchmark "FAU" written by ABC on Wed Aug 12 10:08:14 2020
...
module FAU ( 
  ...
  nand2  g208(.a(new_n179_), .b(x046), .O(new_n365_));
  ...
  aoi21  g216(.a(new_n169_), .b(new_n157_), .c(new_n158_), .O(new_n373_));
  ...
  nand4  g222(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n375_), .O(new_n379_));
  nand3  g223(.a(new_n379_), .b(new_n374_), .c(new_n159_), .O(new_n380_));
  nand2  g224(.a(x112), .b(x104), .O(new_n381_));
  nand3  g225(.a(new_n381_), .b(x120), .c(new_n158_), .O(new_n382_));
  nand3  g226(.a(x096), .b(x064), .c(new_n169_), .O(new_n383_));
  nand3  g227(.a(new_n383_), .b(new_n382_), .c(new_n172_), .O(new_n384_));
  inv1   g228(.a(new_n384_), .O(new_n385_));
  aoi21  g229(.a(new_n385_), .b(new_n380_), .c(new_n370_), .O(new_n386_));
  inv1   g230(.a(new_n378_), .O(new_n387_));
  nor2   g231(.a(new_n375_), .b(x016), .O(new_n388_));
  oai21  g232(.a(new_n388_), .b(new_n387_), .c(x064), .O(new_n389_));
  nand2  g233(.a(new_n377_), .b(new_n376_), .O(new_n390_));
  oai21  g234(.a(x064), .b(x008), .c(x016), .O(new_n391_));
  nand4  g235(.a(new_n391_), .b(new_n371_), .c(new_n390_), .d(x024), .O(new_n392_));
  aoi21  g236(.a(new_n392_), .b(new_n389_), .c(x080), .O(new_n393_));
  oai21  g237(.a(new_n393_), .b(new_n386_), .c(new_n369_), .O(new_n394_));
  or2    g238(.a(x112), .b(x104), .O(new_n395_));
  nand2  g239(.a(x064), .b(new_n169_), .O(new_n396_));
  aoi21  g240(.a(new_n396_), .b(new_n160_), .c(new_n370_), .O(new_n397_));
  nand3  g241(.a(new_n371_), .b(new_n159_), .c(x024), .O(new_n398_));
  ...
  aoi21  g248(.a(new_n401_), .b(new_n395_), .c(new_n404_), .O(new_n405_));
  aoi21  g249(.a(new_n405_), .b(new_n394_), .c(x048), .O(new_n406_));
  nand2  g250(.a(new_n390_), .b(x000), .O(new_n407_));
  nand3  g251(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n407_), .c(x064), .O(new_n409_));
  inv1   g253(.a(new_n388_), .O(new_n410_));
  aoi21  g254(.a(new_n410_), .b(new_n378_), .c(x080), .O(new_n411_));
  ...
  aoi21  g259(.a(new_n170_), .b(x032), .c(new_n413_), .O(new_n416_));
  oai21  g260(.a(new_n416_), .b(new_n157_), .c(new_n415_), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n412_), .O(new_n418_));
  nand2  g262(.a(new_n418_), .b(new_n369_), .O(new_n419_));
  oai21  g263(.a(new_n414_), .b(x032), .c(new_n157_), .O(new_n420_));
  ...
  nand3  g299(.a(new_n455_), .b(new_n453_), .c(new_n228_), .O(new_n456_));
  nand2  g300(.a(new_n454_), .b(new_n451_), .O(new_n457_));
  nand2  g301(.a(new_n452_), .b(x011), .O(new_n458_));
  nand3  g302(.a(new_n458_), .b(new_n457_), .c(new_n227_), .O(new_n459_));
  ...
  nand2  g307(.a(new_n463_), .b(new_n219_), .O(new_n464_));
  ...
  aoi22  g312(.a(new_n468_), .b(x012), .c(x052), .d(new_n236_), .O(new_n469_));
  ...
  oai21  g317(.a(new_n471_), .b(new_n467_), .c(new_n248_), .O(new_n474_));
  aoi21  g318(.a(x052), .b(x036), .c(new_n245_), .O(new_n475_));
  ...
  nand2  g344(.a(new_n500_), .b(new_n178_), .O(new_n501_));
  ...
  aoi21  g361(.a(new_n514_), .b(new_n178_), .c(new_n517_), .O(new_n518_));
  ...
  zero   g414(.O(z26));
  zero   g415(.O(z27));
  inv1   g416(.a(new_n179_), .O(z16));
  inv1   g417(.a(new_n179_), .O(z18));
  inv1   g418(.a(new_n179_), .O(z21));
endmodule
