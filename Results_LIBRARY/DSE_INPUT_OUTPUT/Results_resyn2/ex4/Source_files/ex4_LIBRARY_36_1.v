// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:02 2020
...
module FAU ( 
  ...
  nor2   g021(.a(new_n177_), .b(x025), .O(z19));
  ...
  nand2  g148(.a(new_n304_), .b(x025), .O(new_n305_));
  ...
  nand2  g331(.a(x069), .b(new_n291_), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n298_), .c(new_n273_), .O(new_n490_));
  nand3  g333(.a(new_n266_), .b(new_n252_), .c(x029), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n274_), .c(x085), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n490_), .c(new_n285_), .O(new_n493_));
  aoi21  g336(.a(x029), .b(new_n274_), .c(new_n259_), .O(new_n494_));
  oai21  g337(.a(x069), .b(x013), .c(x021), .O(new_n495_));
  nand2  g338(.a(new_n284_), .b(new_n282_), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n495_), .c(new_n266_), .d(x029), .O(new_n497_));
  oai21  g340(.a(new_n494_), .b(new_n252_), .c(new_n497_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n255_), .O(new_n499_));
  oai21  g342(.a(x037), .b(x013), .c(x021), .O(new_n500_));
  oai21  g343(.a(new_n259_), .b(x029), .c(new_n500_), .O(new_n501_));
  oai21  g344(.a(new_n266_), .b(new_n274_), .c(new_n496_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n501_), .c(x069), .O(new_n503_));
  nand3  g346(.a(x101), .b(x069), .c(new_n291_), .O(new_n504_));
  nand3  g347(.a(new_n249_), .b(x125), .c(new_n274_), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n504_), .c(new_n255_), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(new_n503_), .c(x005), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n499_), .c(new_n493_), .O(new_n508_));
  nand3  g351(.a(new_n285_), .b(new_n255_), .c(x013), .O(new_n509_));
  oai21  g352(.a(new_n251_), .b(new_n177_), .c(new_n509_), .O(new_n510_));
  aoi21  g353(.a(new_n508_), .b(new_n177_), .c(new_n510_), .O(new_n511_));
  nand2  g354(.a(new_n496_), .b(x005), .O(new_n512_));
  nand3  g355(.a(new_n255_), .b(x029), .c(new_n263_), .O(new_n513_));
  ...
  oai21  g360(.a(new_n517_), .b(x013), .c(new_n251_), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n275_), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n516_), .O(new_n520_));
  oai21  g363(.a(new_n517_), .b(x037), .c(new_n263_), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(x077), .O(new_n522_));
  oai21  g365(.a(new_n292_), .b(new_n291_), .c(new_n522_), .O(new_n523_));
  aoi21  g366(.a(new_n520_), .b(new_n177_), .c(new_n523_), .O(new_n524_));
  oai21  g367(.a(new_n511_), .b(x053), .c(new_n524_), .O(new_n525_));
  nand2  g368(.a(new_n525_), .b(new_n248_), .O(new_n526_));
  nand2  g369(.a(new_n526_), .b(new_n179_), .O(z13));
  inv1   g370(.a(x046), .O(new_n528_));
  nand2  g371(.a(x070), .b(new_n370_), .O(new_n529_));
  aoi21  g372(.a(new_n529_), .b(new_n355_), .c(new_n336_), .O(new_n530_));
  nand2  g373(.a(x094), .b(x062), .O(new_n531_));
  nand3  g374(.a(new_n531_), .b(new_n314_), .c(x030), .O(new_n532_));
  aoi21  g375(.a(new_n532_), .b(new_n330_), .c(x086), .O(new_n533_));
  oai21  g376(.a(new_n533_), .b(new_n530_), .c(new_n348_), .O(new_n534_));
  aoi21  g377(.a(x030), .b(new_n330_), .c(new_n322_), .O(new_n535_));
  oai21  g378(.a(x070), .b(x014), .c(x022), .O(new_n536_));
  nand2  g379(.a(new_n346_), .b(new_n344_), .O(new_n537_));
  nand4  g380(.a(new_n537_), .b(new_n536_), .c(new_n531_), .d(x030), .O(new_n538_));
  oai21  g381(.a(new_n535_), .b(new_n314_), .c(new_n538_), .O(new_n539_));
  nand2  g382(.a(new_n539_), .b(new_n318_), .O(new_n540_));
  oai21  g383(.a(x038), .b(x014), .c(x022), .O(new_n541_));
  oai21  g384(.a(new_n322_), .b(x030), .c(new_n541_), .O(new_n542_));
  oai21  g385(.a(new_n531_), .b(new_n330_), .c(new_n537_), .O(new_n543_));
  aoi21  g386(.a(new_n543_), .b(new_n542_), .c(x070), .O(new_n544_));
  nand3  g387(.a(x102), .b(x070), .c(new_n370_), .O(new_n545_));
  nand3  g388(.a(new_n313_), .b(x126), .c(new_n330_), .O(new_n546_));
  nand3  g389(.a(new_n546_), .b(new_n545_), .c(new_n318_), .O(new_n547_));
  oai21  g390(.a(new_n547_), .b(new_n544_), .c(x006), .O(new_n548_));
  nand3  g391(.a(new_n548_), .b(new_n540_), .c(new_n534_), .O(new_n549_));
  oai22  g392(.a(new_n366_), .b(new_n347_), .c(new_n316_), .d(new_n354_), .O(new_n550_));
  aoi21  g393(.a(new_n549_), .b(new_n354_), .c(new_n550_), .O(new_n551_));
  ...
  nand2  g401(.a(new_n558_), .b(new_n337_), .O(new_n559_));
  nand2  g402(.a(new_n559_), .b(new_n556_), .O(new_n560_));
  oai21  g403(.a(new_n557_), .b(x038), .c(new_n329_), .O(new_n561_));
  nand2  g404(.a(new_n561_), .b(x078), .O(new_n562_));
  oai21  g405(.a(new_n312_), .b(new_n370_), .c(new_n562_), .O(new_n563_));
  ...
  nand2  g409(.a(new_n566_), .b(new_n179_), .O(z14));
  zero   g410(.O(z07));
  zero   g411(.O(z15));
  zero   g412(.O(z16));
  zero   g413(.O(z17));
  ...
  zero   g416(.O(z23));
  zero   g417(.O(z27));
  nor2   g418(.a(new_n177_), .b(x025), .O(z20));
  nor2   g419(.a(new_n177_), .b(x025), .O(z21));
  nor2   g420(.a(new_n177_), .b(x025), .O(z24));
  nor2   g421(.a(new_n177_), .b(x025), .O(z25));
  nor2   g422(.a(new_n177_), .b(x025), .O(z26));
endmodule
