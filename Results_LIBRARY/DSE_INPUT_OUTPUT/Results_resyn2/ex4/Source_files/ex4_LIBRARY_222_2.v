...
module FAU ( 
  ...
  oai21  g304(.a(new_n458_), .b(new_n453_), .c(new_n228_), .O(new_n461_));
  aoi21  g305(.a(x051), .b(x035), .c(new_n226_), .O(new_n462_));
  nand4  g306(.a(new_n462_), .b(new_n461_), .c(new_n460_), .d(new_n457_), .O(new_n463_));
  and2   g307(.a(new_n463_), .b(new_n215_), .O(z11));
  ...
  nand2  g402(.a(new_n179_), .b(new_n558_), .O(new_n559_));
  ...
  nor2   g411(.a(x077), .b(new_n177_), .O(z19));
  nor2   g412(.a(x077), .b(new_n177_), .O(z22));
  nor2   g413(.a(x077), .b(new_n177_), .O(z23));
  nor2   g414(.a(x077), .b(new_n177_), .O(z24));
  nor2   g415(.a(x077), .b(new_n177_), .O(z26));
  nor2   g416(.a(x077), .b(new_n177_), .O(z27));
endmodule
