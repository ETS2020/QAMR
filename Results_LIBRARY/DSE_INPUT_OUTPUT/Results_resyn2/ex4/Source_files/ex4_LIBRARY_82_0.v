...
module FAU ( 
  ...
  nor2   g061(.a(new_n217_), .b(z17), .O(new_n218_));
  ...
  nor2   g100(.a(new_n256_), .b(z17), .O(new_n257_));
  ...
  aoi22  g296(.a(new_n453_), .b(x010), .c(x050), .d(new_n215_), .O(new_n454_));
  ...
  oai21  g313(.a(new_n468_), .b(new_n464_), .c(new_n237_), .O(new_n471_));
  ...
  aoi22  g321(.a(new_n478_), .b(x012), .c(x052), .d(new_n254_), .O(new_n479_));
  ...
  oai21  g326(.a(new_n481_), .b(new_n477_), .c(new_n256_), .O(new_n484_));
  ...
  inv1   g330(.a(new_n264_), .O(new_n488_));
  nand2  g331(.a(x053), .b(new_n304_), .O(new_n489_));
  oai21  g332(.a(new_n488_), .b(x053), .c(new_n489_), .O(new_n490_));
  nor2   g333(.a(x037), .b(new_n284_), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(x085), .c(x013), .O(new_n492_));
  nand2  g335(.a(x077), .b(new_n177_), .O(new_n493_));
  aoi21  g336(.a(new_n492_), .b(new_n490_), .c(new_n493_), .O(z13));
  inv1   g337(.a(x054), .O(new_n495_));
  nand2  g338(.a(x070), .b(new_n363_), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n357_), .c(new_n338_), .O(new_n497_));
  nand3  g340(.a(new_n331_), .b(new_n319_), .c(x030), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n339_), .c(x086), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n497_), .c(new_n350_), .O(new_n500_));
  aoi21  g343(.a(x030), .b(new_n339_), .c(new_n327_), .O(new_n501_));
  oai21  g344(.a(x070), .b(x014), .c(x022), .O(new_n502_));
  nand2  g345(.a(new_n349_), .b(new_n347_), .O(new_n503_));
  nand4  g346(.a(new_n503_), .b(new_n502_), .c(new_n331_), .d(x030), .O(new_n504_));
  ...
  nand3  g350(.a(new_n326_), .b(new_n325_), .c(new_n324_), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  oai22  g352(.a(new_n331_), .b(new_n339_), .c(x126), .d(x102), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n509_), .c(x070), .O(new_n511_));
  nand3  g354(.a(x102), .b(x070), .c(new_n363_), .O(new_n512_));
  nand3  g355(.a(new_n318_), .b(x126), .c(new_n339_), .O(new_n513_));
  ...
  nand2  g359(.a(new_n516_), .b(new_n356_), .O(new_n517_));
  inv1   g360(.a(new_n321_), .O(new_n518_));
  aoi22  g361(.a(new_n370_), .b(new_n350_), .c(new_n518_), .d(x078), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n517_), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n495_), .O(new_n521_));
  nand2  g364(.a(new_n503_), .b(x006), .O(new_n522_));
  nand3  g365(.a(new_n323_), .b(x030), .c(new_n369_), .O(new_n523_));
  ...
  oai21  g370(.a(new_n527_), .b(x014), .c(new_n321_), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n340_), .O(new_n529_));
  nand2  g372(.a(new_n529_), .b(new_n526_), .O(new_n530_));
  oai21  g373(.a(new_n527_), .b(x038), .c(new_n369_), .O(new_n531_));
  nand2  g374(.a(new_n531_), .b(x078), .O(new_n532_));
  oai21  g375(.a(new_n495_), .b(new_n363_), .c(new_n532_), .O(new_n533_));
  aoi21  g376(.a(new_n530_), .b(new_n356_), .c(new_n533_), .O(new_n534_));
  inv1   g377(.a(x046), .O(new_n535_));
  nand2  g378(.a(new_n179_), .b(new_n535_), .O(new_n536_));
  aoi21  g379(.a(new_n534_), .b(new_n521_), .c(new_n536_), .O(z14));
  zero   g380(.O(z07));
  zero   g381(.O(z15));
  zero   g382(.O(z16));
  zero   g383(.O(z18));
  ...
  zero   g385(.O(z24));
  zero   g386(.O(z26));
  inv1   g387(.a(new_n179_), .O(z19));
  inv1   g388(.a(new_n179_), .O(z20));
  inv1   g389(.a(new_n179_), .O(z21));
  inv1   g390(.a(new_n179_), .O(z22));
