...
module FAU ( 
  ...
  nor2   g002(.a(x092), .b(new_n158_), .O(z15));
  ...
  nor2   g080(.a(z15), .b(x044), .O(new_n237_));
  ...
  nor2   g094(.a(new_n250_), .b(z15), .O(new_n251_));
  ...
  oai21  g138(.a(new_n293_), .b(new_n158_), .c(new_n294_), .O(new_n295_));
  ...
  aoi22  g157(.a(new_n313_), .b(new_n158_), .c(new_n257_), .d(new_n311_), .O(new_n314_));
  ...
  oai21  g280(.a(new_n435_), .b(new_n430_), .c(new_n197_), .O(new_n438_));
  aoi21  g281(.a(x049), .b(x033), .c(new_n195_), .O(new_n439_));
  nand4  g282(.a(new_n439_), .b(new_n438_), .c(new_n437_), .d(new_n434_), .O(new_n440_));
  and2   g283(.a(new_n440_), .b(new_n184_), .O(z09));
  ...
  oai21  g346(.a(new_n503_), .b(new_n490_), .c(new_n158_), .O(new_n504_));
  ...
  oai21  g353(.a(new_n510_), .b(new_n508_), .c(new_n158_), .O(new_n511_));
  ...
  oai21  g365(.a(new_n522_), .b(new_n520_), .c(new_n158_), .O(new_n523_));
  ...
  zero   g420(.O(z25));
  zero   g421(.O(z27));
  nor2   g422(.a(x092), .b(new_n158_), .O(z17));
  nor2   g423(.a(x092), .b(new_n158_), .O(z18));
  nor2   g424(.a(x092), .b(new_n158_), .O(z20));
  nor2   g425(.a(x092), .b(new_n158_), .O(z22));
  nor2   g426(.a(x092), .b(new_n158_), .O(z26));
endmodule
