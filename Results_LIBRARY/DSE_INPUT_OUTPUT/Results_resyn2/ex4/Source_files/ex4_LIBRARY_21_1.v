...
module FAU ( 
  ...
  nor2   g021(.a(new_n177_), .b(x047), .O(z07));
  ...
  nand2  g206(.a(new_n179_), .b(x046), .O(new_n363_));
  ...
  nand2  g260(.a(new_n416_), .b(new_n179_), .O(z08));
  ...
  nand2  g288(.a(new_n444_), .b(new_n179_), .O(z10));
  ...
  nand2  g303(.a(new_n459_), .b(new_n179_), .O(z11));
  ...
  nand2  g318(.a(new_n474_), .b(new_n179_), .O(z12));
  ...
  zero   g412(.O(z25));
  zero   g413(.O(z26));
  nor2   g414(.a(new_n177_), .b(x047), .O(z15));
  nor2   g415(.a(new_n177_), .b(x047), .O(z17));
  nor2   g416(.a(new_n177_), .b(x047), .O(z19));
  nor2   g417(.a(new_n177_), .b(x047), .O(z20));
  nor2   g418(.a(new_n177_), .b(x047), .O(z21));
  nor2   g419(.a(new_n177_), .b(x047), .O(z22));
  nor2   g420(.a(new_n177_), .b(x047), .O(z27));
endmodule
