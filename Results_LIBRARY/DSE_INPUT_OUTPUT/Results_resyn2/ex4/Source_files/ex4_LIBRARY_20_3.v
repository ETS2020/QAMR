// Benchmark "FAU" written by ABC on Wed Aug 12 10:03:26 2020
...
module FAU ( 
  ...
  nand2  g082(.a(new_n181_), .b(x043), .O(new_n239_));
  ...
  nand2  g101(.a(new_n181_), .b(x044), .O(new_n258_));
  ...
  nand2  g177(.a(new_n333_), .b(new_n181_), .O(z06));
  inv1   g178(.a(x040), .O(new_n335_));
  inv1   g179(.a(x072), .O(new_n336_));
  inv1   g180(.a(x000), .O(new_n337_));
  ...
  aoi21  g186(.a(new_n169_), .b(new_n157_), .c(new_n158_), .O(new_n343_));
  nand2  g187(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  inv1   g188(.a(x024), .O(new_n345_));
  nor2   g189(.a(x088), .b(x056), .O(new_n346_));
  nand4  g190(.a(new_n346_), .b(new_n339_), .c(new_n338_), .d(new_n345_), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(new_n344_), .c(new_n159_), .O(new_n348_));
  ...
  nand3  g195(.a(new_n351_), .b(new_n350_), .c(new_n172_), .O(new_n352_));
  inv1   g196(.a(new_n352_), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n348_), .c(new_n337_), .O(new_n354_));
  oai21  g198(.a(new_n345_), .b(x016), .c(new_n346_), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(x064), .O(new_n356_));
  oai21  g200(.a(x064), .b(x008), .c(x016), .O(new_n357_));
  nand4  g201(.a(new_n357_), .b(new_n341_), .c(new_n340_), .d(x024), .O(new_n358_));
  aoi21  g202(.a(new_n358_), .b(new_n356_), .c(x080), .O(new_n359_));
  oai21  g203(.a(new_n359_), .b(new_n354_), .c(new_n336_), .O(new_n360_));
  or2    g204(.a(x112), .b(x104), .O(new_n361_));
  nand2  g205(.a(x064), .b(new_n169_), .O(new_n362_));
  aoi21  g206(.a(new_n362_), .b(new_n160_), .c(new_n337_), .O(new_n363_));
  nand3  g207(.a(new_n341_), .b(new_n159_), .c(x024), .O(new_n364_));
  aoi21  g208(.a(new_n364_), .b(new_n158_), .c(x080), .O(new_n365_));
  oai21  g209(.a(new_n365_), .b(new_n363_), .c(new_n336_), .O(new_n366_));
  nand2  g210(.a(new_n366_), .b(new_n173_), .O(new_n367_));
  nand2  g211(.a(x064), .b(x016), .O(new_n368_));
  inv1   g212(.a(new_n368_), .O(new_n369_));
  aoi22  g213(.a(new_n369_), .b(x072), .c(new_n367_), .d(new_n361_), .O(new_n370_));
  aoi21  g214(.a(new_n370_), .b(new_n360_), .c(x048), .O(new_n371_));
  nand2  g215(.a(new_n340_), .b(x000), .O(new_n372_));
  nand3  g216(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n373_));
  aoi21  g217(.a(new_n373_), .b(new_n372_), .c(x064), .O(new_n374_));
  and2   g218(.a(new_n355_), .b(new_n172_), .O(new_n375_));
  oai21  g219(.a(new_n375_), .b(new_n374_), .c(x032), .O(new_n376_));
  nand2  g220(.a(x080), .b(x000), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n368_), .O(new_n378_));
  aoi21  g222(.a(new_n170_), .b(x032), .c(new_n368_), .O(new_n379_));
  oai21  g223(.a(new_n379_), .b(new_n157_), .c(new_n378_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(new_n376_), .O(new_n381_));
  nand2  g225(.a(new_n381_), .b(new_n336_), .O(new_n382_));
  oai21  g226(.a(new_n377_), .b(x032), .c(new_n157_), .O(new_n383_));
  aoi22  g227(.a(new_n383_), .b(x072), .c(x048), .d(x032), .O(new_n384_));
  nand2  g228(.a(new_n384_), .b(new_n382_), .O(new_n385_));
  oai21  g229(.a(new_n385_), .b(new_n371_), .c(new_n335_), .O(new_n386_));
  nand2  g230(.a(new_n386_), .b(new_n181_), .O(z08));
  nand2  g231(.a(x065), .b(x017), .O(new_n388_));
  inv1   g232(.a(new_n388_), .O(new_n389_));
  inv1   g233(.a(x033), .O(new_n390_));
  nand2  g234(.a(x081), .b(x001), .O(new_n391_));
  aoi22  g235(.a(new_n391_), .b(x009), .c(x049), .d(new_n390_), .O(new_n392_));
  oai21  g236(.a(new_n389_), .b(x009), .c(new_n392_), .O(new_n393_));
  inv1   g237(.a(new_n391_), .O(new_n394_));
  aoi21  g238(.a(new_n388_), .b(x009), .c(x033), .O(new_n395_));
  oai21  g239(.a(new_n394_), .b(x009), .c(new_n395_), .O(new_n396_));
  oai21  g240(.a(new_n394_), .b(new_n389_), .c(new_n196_), .O(new_n397_));
  aoi21  g241(.a(x049), .b(x033), .c(new_n194_), .O(new_n398_));
  nand4  g242(.a(new_n398_), .b(new_n397_), .c(new_n396_), .d(new_n393_), .O(new_n399_));
  and2   g243(.a(new_n399_), .b(new_n183_), .O(z09));
  nand2  g244(.a(x066), .b(x018), .O(new_n401_));
  inv1   g245(.a(new_n401_), .O(new_n402_));
  nand2  g246(.a(x082), .b(x002), .O(new_n403_));
  aoi22  g247(.a(new_n403_), .b(x010), .c(x050), .d(new_n206_), .O(new_n404_));
  oai21  g248(.a(new_n402_), .b(x010), .c(new_n404_), .O(new_n405_));
  inv1   g249(.a(new_n403_), .O(new_n406_));
  aoi21  g250(.a(new_n401_), .b(x010), .c(x034), .O(new_n407_));
  oai21  g251(.a(new_n406_), .b(x010), .c(new_n407_), .O(new_n408_));
  oai21  g252(.a(new_n406_), .b(new_n402_), .c(new_n218_), .O(new_n409_));
  aoi21  g253(.a(x050), .b(x034), .c(new_n215_), .O(new_n410_));
  nand4  g254(.a(new_n410_), .b(new_n409_), .c(new_n408_), .d(new_n405_), .O(new_n411_));
  inv1   g255(.a(new_n411_), .O(new_n412_));
  nor3   g256(.a(new_n412_), .b(z07), .c(x042), .O(z10));
  nand2  g257(.a(x067), .b(x019), .O(new_n414_));
  inv1   g258(.a(new_n414_), .O(new_n415_));
  nand2  g259(.a(x083), .b(x003), .O(new_n416_));
  aoi22  g260(.a(new_n416_), .b(x011), .c(x051), .d(new_n225_), .O(new_n417_));
  ...
  oai21  g265(.a(new_n419_), .b(new_n415_), .c(new_n237_), .O(new_n422_));
  aoi21  g266(.a(x051), .b(x035), .c(new_n234_), .O(new_n423_));
  nand4  g267(.a(new_n423_), .b(new_n422_), .c(new_n421_), .d(new_n418_), .O(new_n424_));
  inv1   g268(.a(new_n424_), .O(new_n425_));
  oai21  g269(.a(new_n425_), .b(x043), .c(new_n181_), .O(z11));
  nand2  g270(.a(x068), .b(x020), .O(new_n427_));
  inv1   g271(.a(new_n427_), .O(new_n428_));
  nand2  g272(.a(x084), .b(x004), .O(new_n429_));
  aoi22  g273(.a(new_n429_), .b(x012), .c(x052), .d(new_n244_), .O(new_n430_));
  oai21  g274(.a(new_n428_), .b(x012), .c(new_n430_), .O(new_n431_));
  inv1   g275(.a(new_n429_), .O(new_n432_));
  aoi21  g276(.a(new_n427_), .b(x012), .c(x036), .O(new_n433_));
  oai21  g277(.a(new_n432_), .b(x012), .c(new_n433_), .O(new_n434_));
  oai21  g278(.a(new_n432_), .b(new_n428_), .c(new_n256_), .O(new_n435_));
  aoi21  g279(.a(x052), .b(x036), .c(new_n253_), .O(new_n436_));
  nand4  g280(.a(new_n436_), .b(new_n435_), .c(new_n434_), .d(new_n431_), .O(new_n437_));
  inv1   g281(.a(new_n437_), .O(new_n438_));
  nor3   g282(.a(new_n438_), .b(z07), .c(x044), .O(z12));
  nand2  g283(.a(new_n264_), .b(new_n263_), .O(new_n440_));
  nand2  g284(.a(x069), .b(new_n266_), .O(new_n441_));
  aoi21  g285(.a(new_n441_), .b(new_n440_), .c(new_n260_), .O(new_n442_));
  nand2  g286(.a(x093), .b(x061), .O(new_n443_));
  nand3  g287(.a(new_n443_), .b(new_n264_), .c(x029), .O(new_n444_));
  aoi21  g288(.a(new_n444_), .b(new_n263_), .c(x085), .O(new_n445_));
  oai22  g289(.a(new_n445_), .b(new_n442_), .c(x117), .d(x109), .O(new_n446_));
  inv1   g290(.a(x029), .O(new_n447_));
  nor2   g291(.a(x093), .b(x061), .O(new_n448_));
  oai21  g292(.a(new_n447_), .b(x021), .c(new_n448_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(x069), .O(new_n450_));
  oai21  g294(.a(x069), .b(x013), .c(x021), .O(new_n451_));
  or2    g295(.a(x125), .b(x101), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n451_), .c(new_n443_), .d(x029), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(new_n450_), .c(x085), .O(new_n454_));
  oai21  g298(.a(x037), .b(x013), .c(x021), .O(new_n455_));
  aoi21  g299(.a(new_n452_), .b(new_n443_), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n448_), .b(new_n447_), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(new_n452_), .c(new_n264_), .O(new_n458_));
  nand3  g302(.a(x101), .b(x069), .c(new_n266_), .O(new_n459_));
  nand2  g303(.a(x117), .b(x109), .O(new_n460_));
  nand3  g304(.a(new_n460_), .b(x125), .c(new_n263_), .O(new_n461_));
  nand3  g305(.a(new_n461_), .b(new_n459_), .c(new_n261_), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  oai21  g307(.a(new_n458_), .b(new_n456_), .c(new_n463_), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(x005), .c(new_n454_), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n446_), .c(x077), .O(new_n466_));
  nor2   g310(.a(x117), .b(x109), .O(new_n467_));
  nand2  g311(.a(x069), .b(x021), .O(new_n468_));
  nand2  g312(.a(new_n261_), .b(x013), .O(new_n469_));
  oai22  g313(.a(new_n469_), .b(new_n467_), .c(new_n468_), .d(new_n179_), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n466_), .c(new_n267_), .O(new_n471_));
  nand2  g315(.a(new_n452_), .b(x005), .O(new_n472_));
  nand3  g316(.a(new_n261_), .b(x029), .c(new_n269_), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n472_), .c(x069), .O(new_n474_));
  and2   g318(.a(new_n449_), .b(new_n261_), .O(new_n475_));
  oai21  g319(.a(new_n475_), .b(new_n474_), .c(x037), .O(new_n476_));
  nand2  g320(.a(x085), .b(x005), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n468_), .O(new_n478_));
  aoi21  g322(.a(new_n267_), .b(x037), .c(new_n468_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n269_), .c(new_n478_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n476_), .O(new_n481_));
  oai21  g325(.a(new_n477_), .b(x037), .c(new_n269_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x077), .O(new_n483_));
  oai21  g327(.a(new_n267_), .b(new_n266_), .c(new_n483_), .O(new_n484_));
  aoi21  g328(.a(new_n481_), .b(new_n179_), .c(new_n484_), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n471_), .c(x045), .O(z13));
  inv1   g330(.a(x046), .O(new_n487_));
  oai21  g331(.a(new_n276_), .b(x022), .c(new_n284_), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x070), .O(new_n489_));
  nand2  g333(.a(x094), .b(x062), .O(new_n490_));
  oai21  g334(.a(x070), .b(x014), .c(x022), .O(new_n491_));
  nand2  g335(.a(new_n298_), .b(new_n294_), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n491_), .c(new_n490_), .d(x030), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n489_), .c(x086), .O(new_n494_));
  oai21  g338(.a(x038), .b(x014), .c(x022), .O(new_n495_));
  inv1   g339(.a(x062), .O(new_n496_));
  inv1   g340(.a(x094), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n496_), .c(new_n276_), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n495_), .O(new_n499_));
  oai22  g343(.a(new_n490_), .b(new_n281_), .c(x126), .d(x102), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n275_), .O(new_n502_));
  nand3  g346(.a(x102), .b(x070), .c(new_n328_), .O(new_n503_));
  nand3  g347(.a(new_n304_), .b(x126), .c(new_n281_), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n503_), .c(new_n274_), .O(new_n505_));
  inv1   g349(.a(new_n505_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n502_), .c(new_n317_), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n494_), .c(new_n305_), .O(new_n508_));
  inv1   g352(.a(new_n297_), .O(new_n509_));
  inv1   g353(.a(new_n306_), .O(new_n510_));
  nand2  g354(.a(x070), .b(new_n328_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n313_), .c(new_n317_), .O(new_n512_));
  nand3  g356(.a(new_n490_), .b(new_n275_), .c(x030), .O(new_n513_));
  aoi21  g357(.a(new_n513_), .b(new_n281_), .c(x086), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(new_n512_), .c(new_n305_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n324_), .O(new_n516_));
  aoi22  g360(.a(new_n516_), .b(new_n509_), .c(new_n510_), .d(x078), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n508_), .c(x054), .O(new_n518_));
  nand2  g362(.a(new_n492_), .b(x006), .O(new_n519_));
  nand3  g363(.a(new_n274_), .b(x030), .c(new_n280_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n519_), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n275_), .O(new_n522_));
  nand2  g366(.a(new_n488_), .b(new_n274_), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n522_), .c(new_n328_), .O(new_n524_));
  nand3  g368(.a(x086), .b(new_n280_), .c(x006), .O(new_n525_));
  aoi22  g369(.a(new_n525_), .b(new_n306_), .c(x038), .d(x014), .O(new_n526_));
  oai21  g370(.a(new_n526_), .b(new_n524_), .c(new_n305_), .O(new_n527_));
  nand2  g371(.a(x086), .b(x006), .O(new_n528_));
  oai21  g372(.a(new_n528_), .b(x038), .c(new_n280_), .O(new_n529_));
  aoi22  g373(.a(new_n529_), .b(x078), .c(x054), .d(x038), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n527_), .O(new_n531_));
  oai21  g375(.a(new_n531_), .b(new_n518_), .c(new_n487_), .O(new_n532_));
  nand2  g376(.a(new_n532_), .b(new_n181_), .O(z14));
  zero   g377(.O(z18));
  zero   g378(.O(z19));
  zero   g379(.O(z25));
  zero   g380(.O(z26));
  nor2   g381(.a(new_n179_), .b(new_n178_), .O(z15));
  nor2   g382(.a(new_n179_), .b(new_n178_), .O(z16));
  nor2   g383(.a(new_n179_), .b(new_n178_), .O(z17));
  nor2   g384(.a(new_n179_), .b(new_n178_), .O(z20));
  nor2   g385(.a(new_n179_), .b(new_n178_), .O(z21));
  nor2   g386(.a(new_n179_), .b(new_n178_), .O(z22));
  nor2   g387(.a(new_n179_), .b(new_n178_), .O(z23));
  nor2   g388(.a(new_n179_), .b(new_n178_), .O(z24));
  nor2   g389(.a(new_n179_), .b(new_n178_), .O(z27));
endmodule
