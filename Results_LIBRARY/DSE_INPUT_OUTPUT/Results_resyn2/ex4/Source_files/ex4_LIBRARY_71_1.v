...
module FAU ( 
  ...
  nor2   g021(.a(new_n177_), .b(x057), .O(z07));
  ...
  nand2  g272(.a(new_n179_), .b(new_n428_), .O(new_n429_));
  ...
  aoi22  g290(.a(new_n446_), .b(x010), .c(x050), .d(new_n204_), .O(new_n447_));
  ...
  oai21  g295(.a(new_n449_), .b(new_n445_), .c(new_n216_), .O(new_n452_));
  ...
  aoi22  g303(.a(new_n459_), .b(x011), .c(x051), .d(new_n223_), .O(new_n460_));
  ...
  oai21  g308(.a(new_n462_), .b(new_n458_), .c(new_n235_), .O(new_n465_));
  aoi21  g309(.a(x051), .b(x035), .c(new_n232_), .O(new_n466_));
  ...
  nand2  g372(.a(new_n528_), .b(new_n179_), .O(z13));
  ...
  aoi22  g412(.a(new_n568_), .b(new_n553_), .c(new_n179_), .d(x046), .O(z14));
  zero   g413(.O(z15));
  zero   g414(.O(z17));
  zero   g415(.O(z20));
  zero   g416(.O(z22));
  zero   g417(.O(z26));
  zero   g418(.O(z27));
  nor2   g419(.a(new_n177_), .b(x057), .O(z16));
  nor2   g420(.a(new_n177_), .b(x057), .O(z18));
  nor2   g421(.a(new_n177_), .b(x057), .O(z19));
  nor2   g422(.a(new_n177_), .b(x057), .O(z21));
  nor2   g423(.a(new_n177_), .b(x057), .O(z23));
  nor2   g424(.a(new_n177_), .b(x057), .O(z24));
  nor2   g425(.a(new_n177_), .b(x057), .O(z25));
endmodule
