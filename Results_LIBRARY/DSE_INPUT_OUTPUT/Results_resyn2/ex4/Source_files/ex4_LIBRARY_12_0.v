...
module FAU ( 
  ...
  aoi22  g308(.a(new_n465_), .b(x011), .c(x051), .d(new_n222_), .O(new_n466_));
  ...
  oai21  g313(.a(new_n468_), .b(new_n464_), .c(new_n234_), .O(new_n471_));
  aoi21  g314(.a(x051), .b(x035), .c(new_n231_), .O(new_n472_));
  ...
  inv1   g331(.a(new_n261_), .O(new_n489_));
  nand2  g332(.a(x053), .b(new_n302_), .O(new_n490_));
  oai21  g333(.a(new_n489_), .b(x053), .c(new_n490_), .O(new_n491_));
  nor2   g334(.a(x037), .b(new_n281_), .O(new_n492_));
  nand2  g335(.a(x077), .b(new_n274_), .O(new_n493_));
  aoi21  g336(.a(new_n492_), .b(x085), .c(new_n493_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n491_), .c(x045), .O(z13));
  inv1   g338(.a(new_n377_), .O(new_n496_));
  inv1   g339(.a(x054), .O(new_n497_));
  aoi21  g340(.a(x030), .b(new_n337_), .c(new_n325_), .O(new_n498_));
  oai21  g341(.a(x070), .b(x014), .c(x022), .O(new_n499_));
  nand2  g342(.a(new_n347_), .b(new_n345_), .O(new_n500_));
  nand4  g343(.a(new_n500_), .b(new_n499_), .c(new_n329_), .d(x030), .O(new_n501_));
  oai21  g344(.a(new_n498_), .b(new_n317_), .c(new_n501_), .O(new_n502_));
  nand2  g345(.a(new_n502_), .b(new_n321_), .O(new_n503_));
  oai22  g346(.a(new_n369_), .b(new_n337_), .c(new_n325_), .d(x030), .O(new_n504_));
  oai21  g347(.a(new_n329_), .b(new_n337_), .c(new_n500_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n504_), .c(x070), .O(new_n506_));
  nand3  g349(.a(x102), .b(x070), .c(new_n361_), .O(new_n507_));
  nand3  g350(.a(new_n316_), .b(x126), .c(new_n337_), .O(new_n508_));
  ...
  nand2  g354(.a(x070), .b(new_n361_), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(new_n355_), .c(new_n336_), .O(new_n513_));
  nand3  g356(.a(new_n329_), .b(new_n317_), .c(x030), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(new_n337_), .c(x086), .O(new_n515_));
  oai21  g358(.a(new_n515_), .b(new_n513_), .c(new_n354_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n367_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n348_), .O(new_n518_));
  oai21  g361(.a(new_n319_), .b(new_n354_), .c(new_n518_), .O(new_n519_));
  ...
  nand3  g365(.a(new_n321_), .b(x030), .c(new_n522_), .O(new_n523_));
  ...
  nand2  g370(.a(new_n527_), .b(new_n319_), .O(new_n528_));
  aoi21  g371(.a(new_n497_), .b(x038), .c(new_n319_), .O(new_n529_));
  ...
  aoi21  g376(.a(x054), .b(x038), .c(z17), .O(new_n534_));
  nand2  g377(.a(new_n534_), .b(new_n533_), .O(new_n535_));
  aoi21  g378(.a(new_n531_), .b(new_n354_), .c(new_n535_), .O(new_n536_));
