// Benchmark "FAU" written by ABC on Wed Aug 12 10:09:48 2020
...
module FAU ( 
  ...
  aoi21  g118(.a(new_n265_), .b(x021), .c(new_n274_), .O(new_n275_));
  oai21  g119(.a(new_n260_), .b(new_n269_), .c(new_n270_), .O(new_n276_));
  nand2  g120(.a(x125), .b(x101), .O(new_n277_));
  nand4  g121(.a(new_n277_), .b(new_n276_), .c(new_n267_), .d(new_n265_), .O(new_n278_));
  oai21  g122(.a(new_n275_), .b(x069), .c(new_n278_), .O(new_n279_));
  nand2  g123(.a(new_n279_), .b(x085), .O(new_n280_));
  inv1   g124(.a(x005), .O(new_n281_));
  inv1   g125(.a(x037), .O(new_n282_));
  oai21  g126(.a(new_n282_), .b(new_n269_), .c(new_n270_), .O(new_n283_));
  oai21  g127(.a(new_n274_), .b(new_n265_), .c(new_n283_), .O(new_n284_));
  oai21  g128(.a(new_n267_), .b(x021), .c(new_n277_), .O(new_n285_));
  ...
  nand3  g137(.a(new_n293_), .b(new_n280_), .c(new_n273_), .O(new_n294_));
  nand2  g138(.a(new_n294_), .b(x053), .O(new_n295_));
  nand2  g139(.a(new_n277_), .b(new_n281_), .O(new_n296_));
  nand3  g140(.a(x085), .b(new_n265_), .c(x013), .O(new_n297_));
  nand2  g141(.a(new_n297_), .b(new_n296_), .O(new_n298_));
  nand2  g142(.a(new_n298_), .b(x069), .O(new_n299_));
  inv1   g143(.a(new_n275_), .O(new_n300_));
  ...
  nand2  g147(.a(new_n260_), .b(new_n270_), .O(new_n304_));
  nand3  g148(.a(new_n264_), .b(x013), .c(new_n281_), .O(new_n305_));
  oai21  g149(.a(new_n304_), .b(new_n303_), .c(new_n305_), .O(new_n306_));
  aoi21  g150(.a(new_n302_), .b(new_n282_), .c(new_n306_), .O(new_n307_));
  nand2  g151(.a(x077), .b(x045), .O(new_n308_));
  aoi21  g152(.a(new_n307_), .b(new_n295_), .c(new_n308_), .O(z05));
  ...
  inv1   g216(.a(x040), .O(new_n373_));
  inv1   g217(.a(x072), .O(new_n374_));
  nand2  g218(.a(x088), .b(x056), .O(new_n375_));
  oai21  g219(.a(x120), .b(x096), .c(new_n375_), .O(new_n376_));
  ...
  nand4  g226(.a(new_n382_), .b(new_n381_), .c(new_n380_), .d(new_n379_), .O(new_n383_));
  nand3  g227(.a(new_n383_), .b(new_n378_), .c(new_n159_), .O(new_n384_));
  ...
  inv1   g234(.a(new_n382_), .O(new_n391_));
  nor2   g235(.a(new_n379_), .b(x016), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n391_), .c(x064), .O(new_n393_));
  nand2  g237(.a(new_n381_), .b(new_n380_), .O(new_n394_));
  oai21  g238(.a(x064), .b(x008), .c(x016), .O(new_n395_));
  nand4  g239(.a(new_n395_), .b(new_n375_), .c(new_n394_), .d(x024), .O(new_n396_));
  aoi21  g240(.a(new_n396_), .b(new_n393_), .c(x080), .O(new_n397_));
  oai21  g241(.a(new_n397_), .b(new_n390_), .c(new_n374_), .O(new_n398_));
  or2    g242(.a(x112), .b(x104), .O(new_n399_));
  nand2  g243(.a(new_n173_), .b(x008), .O(new_n400_));
  nand2  g244(.a(x064), .b(new_n169_), .O(new_n401_));
  aoi21  g245(.a(new_n401_), .b(new_n160_), .c(new_n172_), .O(new_n402_));
  nand3  g246(.a(new_n375_), .b(new_n159_), .c(x024), .O(new_n403_));
  aoi21  g247(.a(new_n403_), .b(new_n158_), .c(x080), .O(new_n404_));
  oai21  g248(.a(new_n404_), .b(new_n402_), .c(new_n374_), .O(new_n405_));
  nand2  g249(.a(new_n405_), .b(new_n400_), .O(new_n406_));
  nor2   g250(.a(new_n159_), .b(new_n158_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(x072), .O(new_n408_));
  inv1   g252(.a(new_n408_), .O(new_n409_));
  aoi21  g253(.a(new_n406_), .b(new_n399_), .c(new_n409_), .O(new_n410_));
  aoi21  g254(.a(new_n410_), .b(new_n398_), .c(x048), .O(new_n411_));
  ...
  inv1   g258(.a(new_n392_), .O(new_n415_));
  aoi21  g259(.a(new_n415_), .b(new_n382_), .c(x080), .O(new_n416_));
  oai21  g260(.a(new_n416_), .b(new_n414_), .c(x032), .O(new_n417_));
  inv1   g261(.a(new_n407_), .O(new_n418_));
  nand2  g262(.a(x080), .b(x000), .O(new_n419_));
  nand2  g263(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  aoi21  g264(.a(new_n157_), .b(x032), .c(new_n418_), .O(new_n421_));
  oai21  g265(.a(new_n421_), .b(new_n170_), .c(new_n420_), .O(new_n422_));
  nand2  g266(.a(new_n422_), .b(new_n417_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n374_), .O(new_n424_));
  oai21  g268(.a(new_n419_), .b(x032), .c(new_n170_), .O(new_n425_));
  aoi22  g269(.a(new_n425_), .b(x072), .c(x048), .d(x032), .O(new_n426_));
  nand2  g270(.a(new_n426_), .b(new_n424_), .O(new_n427_));
  oai21  g271(.a(new_n427_), .b(new_n411_), .c(new_n373_), .O(new_n428_));
  nand2  g272(.a(new_n428_), .b(new_n179_), .O(z08));
  ...
  oai21  g285(.a(new_n441_), .b(x041), .c(new_n179_), .O(z09));
  ...
  inv1   g314(.a(x036), .O(new_n471_));
  nand2  g315(.a(x084), .b(x004), .O(new_n472_));
  aoi22  g316(.a(new_n472_), .b(x012), .c(x052), .d(new_n471_), .O(new_n473_));
  oai21  g317(.a(new_n470_), .b(x012), .c(new_n473_), .O(new_n474_));
  inv1   g318(.a(new_n472_), .O(new_n475_));
  aoi21  g319(.a(new_n469_), .b(x012), .c(x036), .O(new_n476_));
  oai21  g320(.a(new_n475_), .b(x012), .c(new_n476_), .O(new_n477_));
  oai21  g321(.a(new_n475_), .b(new_n470_), .c(new_n252_), .O(new_n478_));
  aoi21  g322(.a(x052), .b(x036), .c(new_n250_), .O(new_n479_));
  nand4  g323(.a(new_n479_), .b(new_n478_), .c(new_n477_), .d(new_n474_), .O(new_n480_));
  and2   g324(.a(new_n480_), .b(new_n239_), .O(z12));
  inv1   g325(.a(x053), .O(new_n482_));
  nor2   g326(.a(new_n262_), .b(x053), .O(new_n483_));
  nand2  g327(.a(x085), .b(x005), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(x037), .c(new_n269_), .O(new_n485_));
  oai21  g329(.a(new_n485_), .b(new_n483_), .c(x077), .O(new_n486_));
  oai21  g330(.a(new_n482_), .b(new_n282_), .c(new_n486_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n177_), .O(new_n488_));
  oai22  g332(.a(new_n303_), .b(new_n270_), .c(new_n267_), .d(x029), .O(new_n489_));
  nand2  g333(.a(new_n287_), .b(new_n290_), .O(new_n490_));
  oai21  g334(.a(new_n274_), .b(new_n270_), .c(new_n490_), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n489_), .c(x069), .O(new_n492_));
  nand3  g336(.a(new_n259_), .b(x125), .c(new_n270_), .O(new_n493_));
  nand3  g337(.a(x101), .b(x069), .c(new_n282_), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n493_), .c(new_n264_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n492_), .c(x005), .O(new_n496_));
  nand2  g340(.a(x069), .b(new_n282_), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n304_), .c(new_n281_), .O(new_n498_));
  nand3  g342(.a(new_n274_), .b(new_n260_), .c(x029), .O(new_n499_));
  nor2   g343(.a(x021), .b(x013), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(new_n499_), .c(x085), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(new_n498_), .c(new_n288_), .O(new_n502_));
  oai21  g346(.a(new_n265_), .b(x021), .c(new_n266_), .O(new_n503_));
  and2   g347(.a(new_n503_), .b(x069), .O(new_n504_));
  oai21  g348(.a(x069), .b(x013), .c(x021), .O(new_n505_));
  nand4  g349(.a(new_n505_), .b(new_n490_), .c(new_n274_), .d(x029), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n504_), .c(new_n264_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n502_), .c(new_n496_), .O(new_n509_));
  nand2  g353(.a(new_n490_), .b(x005), .O(new_n510_));
  nand3  g354(.a(new_n264_), .b(x029), .c(new_n269_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n510_), .c(x069), .O(new_n512_));
  nand2  g356(.a(new_n503_), .b(new_n264_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n482_), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(new_n512_), .c(x037), .O(new_n515_));
  oai21  g359(.a(new_n484_), .b(x013), .c(new_n262_), .O(new_n516_));
  nand3  g360(.a(new_n482_), .b(x037), .c(x013), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n516_), .c(x045), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(new_n515_), .O(new_n519_));
  aoi21  g363(.a(new_n509_), .b(new_n482_), .c(new_n519_), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(x077), .c(new_n488_), .O(z13));
  inv1   g365(.a(new_n371_), .O(new_n522_));
  inv1   g366(.a(x054), .O(new_n523_));
  aoi21  g367(.a(x030), .b(new_n331_), .c(new_n319_), .O(new_n524_));
  oai21  g368(.a(x070), .b(x014), .c(x022), .O(new_n525_));
  nand2  g369(.a(new_n341_), .b(new_n339_), .O(new_n526_));
  nand4  g370(.a(new_n526_), .b(new_n525_), .c(new_n323_), .d(x030), .O(new_n527_));
  oai21  g371(.a(new_n524_), .b(new_n311_), .c(new_n527_), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n315_), .O(new_n529_));
  oai22  g373(.a(new_n363_), .b(new_n331_), .c(new_n319_), .d(x030), .O(new_n530_));
  oai21  g374(.a(new_n323_), .b(new_n331_), .c(new_n526_), .O(new_n531_));
  aoi21  g375(.a(new_n531_), .b(new_n530_), .c(x070), .O(new_n532_));
  nand3  g376(.a(x102), .b(x070), .c(new_n355_), .O(new_n533_));
  nand3  g377(.a(new_n310_), .b(x126), .c(new_n331_), .O(new_n534_));
  nand3  g378(.a(new_n534_), .b(new_n533_), .c(new_n315_), .O(new_n535_));
  oai21  g379(.a(new_n535_), .b(new_n532_), .c(x006), .O(new_n536_));
  aoi21  g380(.a(new_n536_), .b(new_n529_), .c(x078), .O(new_n537_));
  nand2  g381(.a(x070), .b(new_n355_), .O(new_n538_));
  aoi21  g382(.a(new_n538_), .b(new_n349_), .c(new_n330_), .O(new_n539_));
  nand3  g383(.a(new_n323_), .b(new_n311_), .c(x030), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n331_), .c(x086), .O(new_n541_));
  oai21  g385(.a(new_n541_), .b(new_n539_), .c(new_n348_), .O(new_n542_));
  nand2  g386(.a(new_n542_), .b(new_n361_), .O(new_n543_));
  nand2  g387(.a(new_n543_), .b(new_n342_), .O(new_n544_));
  oai21  g388(.a(new_n313_), .b(new_n348_), .c(new_n544_), .O(new_n545_));
  ...
  nand3  g392(.a(new_n315_), .b(x030), .c(new_n548_), .O(new_n549_));
  ...
  nand2  g397(.a(new_n553_), .b(new_n313_), .O(new_n554_));
  aoi21  g398(.a(new_n523_), .b(x038), .c(new_n313_), .O(new_n555_));
  ...
  aoi21  g405(.a(new_n557_), .b(new_n348_), .c(new_n561_), .O(new_n562_));
  ...
  zero   g413(.O(z24));
  zero   g414(.O(z27));
  nor2   g415(.a(x077), .b(new_n177_), .O(z18));
  nor2   g416(.a(x077), .b(new_n177_), .O(z20));
