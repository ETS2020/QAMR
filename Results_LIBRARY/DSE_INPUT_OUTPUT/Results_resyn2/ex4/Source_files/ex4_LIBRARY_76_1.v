// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:50 2020
...
module FAU ( 
  ...
  nor2   g002(.a(new_n158_), .b(x002), .O(z16));
  ...
  nand3  g045(.a(new_n201_), .b(new_n200_), .c(x034), .O(new_n202_));
  ...
  nand3  g050(.a(new_n206_), .b(new_n205_), .c(new_n202_), .O(new_n207_));
  inv1   g051(.a(new_n207_), .O(new_n208_));
  oai21  g052(.a(new_n208_), .b(new_n199_), .c(new_n160_), .O(new_n209_));
  aoi21  g053(.a(new_n200_), .b(x034), .c(x010), .O(new_n210_));
  nand2  g054(.a(x074), .b(x010), .O(new_n211_));
  nand2  g055(.a(x034), .b(x010), .O(new_n212_));
  nand2  g056(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nor3   g057(.a(x082), .b(x077), .c(x002), .O(new_n214_));
  oai21  g058(.a(new_n213_), .b(new_n210_), .c(new_n214_), .O(new_n215_));
  aoi21  g059(.a(new_n215_), .b(new_n209_), .c(new_n198_), .O(z02));
  ...
  oai21  g112(.a(new_n268_), .b(new_n261_), .c(x077), .O(new_n269_));
  inv1   g113(.a(x013), .O(new_n270_));
  nand2  g114(.a(x085), .b(new_n270_), .O(new_n271_));
  aoi21  g115(.a(new_n271_), .b(new_n269_), .c(new_n257_), .O(new_n272_));
  nand2  g116(.a(x093), .b(x061), .O(new_n273_));
  aoi21  g117(.a(new_n263_), .b(x021), .c(new_n273_), .O(new_n274_));
  aoi21  g118(.a(x069), .b(x013), .c(x021), .O(new_n275_));
  nand2  g119(.a(x125), .b(x101), .O(new_n276_));
  nand3  g120(.a(new_n276_), .b(new_n266_), .c(new_n263_), .O(new_n277_));
  ...
  nand3  g129(.a(new_n265_), .b(new_n264_), .c(new_n281_), .O(new_n286_));
  ...
  aoi21  g139(.a(new_n295_), .b(new_n279_), .c(new_n158_), .O(new_n296_));
  oai21  g140(.a(new_n296_), .b(new_n272_), .c(x053), .O(new_n297_));
  inv1   g141(.a(x037), .O(new_n298_));
  inv1   g142(.a(x053), .O(new_n299_));
  nand2  g143(.a(new_n276_), .b(new_n280_), .O(new_n300_));
  nand3  g144(.a(x085), .b(new_n263_), .c(x013), .O(new_n301_));
  aoi21  g145(.a(new_n301_), .b(new_n300_), .c(new_n259_), .O(new_n302_));
  nor2   g146(.a(new_n274_), .b(new_n262_), .O(new_n303_));
  oai21  g147(.a(new_n303_), .b(new_n302_), .c(new_n298_), .O(new_n304_));
  nand2  g148(.a(new_n259_), .b(new_n281_), .O(new_n305_));
  aoi21  g149(.a(x053), .b(new_n298_), .c(new_n305_), .O(new_n306_));
  ...
  aoi22  g153(.a(new_n309_), .b(x077), .c(new_n299_), .d(new_n298_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(new_n297_), .O(new_n311_));
  nand2  g155(.a(new_n311_), .b(x002), .O(new_n312_));
  nand2  g156(.a(new_n299_), .b(new_n298_), .O(new_n313_));
  nand3  g157(.a(new_n262_), .b(x037), .c(new_n280_), .O(new_n314_));
  nand3  g158(.a(new_n259_), .b(x053), .c(new_n281_), .O(new_n315_));
  nand4  g159(.a(new_n315_), .b(new_n314_), .c(new_n313_), .d(x013), .O(new_n316_));
  nand2  g160(.a(new_n316_), .b(new_n158_), .O(new_n317_));
  aoi21  g161(.a(new_n317_), .b(new_n312_), .c(new_n255_), .O(z05));
  ...
  aoi21  g174(.a(new_n330_), .b(x022), .c(new_n327_), .O(new_n331_));
  oai21  g175(.a(new_n331_), .b(new_n326_), .c(new_n322_), .O(new_n332_));
  nand2  g176(.a(x094), .b(x062), .O(new_n333_));
  aoi21  g177(.a(new_n328_), .b(x022), .c(new_n333_), .O(new_n334_));
  nand2  g178(.a(x126), .b(x102), .O(new_n335_));
  inv1   g179(.a(x014), .O(new_n336_));
  inv1   g180(.a(x022), .O(new_n337_));
  oai21  g181(.a(new_n323_), .b(new_n336_), .c(new_n337_), .O(new_n338_));
  nand4  g182(.a(new_n338_), .b(new_n335_), .c(new_n329_), .d(new_n328_), .O(new_n339_));
  ...
  oai21  g187(.a(new_n343_), .b(new_n336_), .c(new_n337_), .O(new_n344_));
  oai21  g188(.a(new_n333_), .b(new_n328_), .c(new_n344_), .O(new_n345_));
  oai21  g189(.a(new_n329_), .b(x022), .c(new_n335_), .O(new_n346_));
  aoi21  g190(.a(new_n346_), .b(new_n345_), .c(new_n323_), .O(new_n347_));
  inv1   g191(.a(x102), .O(new_n348_));
  nand3  g192(.a(new_n348_), .b(new_n323_), .c(x038), .O(new_n349_));
  ...
  oai21  g197(.a(new_n353_), .b(new_n347_), .c(new_n342_), .O(new_n354_));
  nand3  g198(.a(new_n354_), .b(new_n341_), .c(new_n332_), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(x078), .O(new_n356_));
  nand3  g200(.a(new_n322_), .b(x086), .c(new_n336_), .O(new_n357_));
  inv1   g201(.a(x078), .O(new_n358_));
  nand2  g202(.a(new_n323_), .b(new_n337_), .O(new_n359_));
  inv1   g203(.a(new_n359_), .O(new_n360_));
  nand2  g204(.a(new_n360_), .b(new_n358_), .O(new_n361_));
  nand3  g205(.a(new_n361_), .b(new_n357_), .c(x054), .O(new_n362_));
  inv1   g206(.a(new_n362_), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(new_n356_), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(new_n321_), .O(new_n365_));
  nand2  g209(.a(new_n335_), .b(new_n342_), .O(new_n366_));
  nand3  g210(.a(x086), .b(new_n328_), .c(x014), .O(new_n367_));
  aoi21  g211(.a(new_n367_), .b(new_n366_), .c(new_n323_), .O(new_n368_));
  nor2   g212(.a(new_n334_), .b(new_n327_), .O(new_n369_));
  oai21  g213(.a(new_n369_), .b(new_n368_), .c(new_n343_), .O(new_n370_));
  nand2  g214(.a(x054), .b(new_n343_), .O(new_n371_));
  oai21  g215(.a(x086), .b(x006), .c(new_n359_), .O(new_n372_));
  aoi22  g216(.a(new_n372_), .b(x014), .c(new_n371_), .d(new_n360_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n370_), .O(new_n374_));
  nand3  g218(.a(new_n371_), .b(new_n327_), .c(new_n342_), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(x014), .c(x078), .O(new_n376_));
  aoi21  g220(.a(new_n374_), .b(x078), .c(new_n376_), .O(new_n377_));
  aoi21  g221(.a(new_n377_), .b(new_n365_), .c(new_n319_), .O(z06));
  nand2  g222(.a(new_n160_), .b(new_n157_), .O(new_n380_));
  nor2   g223(.a(x088), .b(x056), .O(new_n381_));
  nand2  g224(.a(x024), .b(new_n163_), .O(new_n382_));
  and2   g225(.a(new_n382_), .b(new_n381_), .O(new_n383_));
  ...
  nand4  g231(.a(new_n388_), .b(new_n385_), .c(new_n384_), .d(x024), .O(new_n389_));
  oai21  g232(.a(new_n383_), .b(new_n164_), .c(new_n389_), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n173_), .O(new_n391_));
  oai21  g234(.a(x032), .b(x008), .c(x016), .O(new_n392_));
  aoi21  g235(.a(new_n388_), .b(new_n384_), .c(new_n392_), .O(new_n393_));
  inv1   g236(.a(x024), .O(new_n394_));
  nand2  g237(.a(new_n381_), .b(new_n394_), .O(new_n395_));
  oai21  g238(.a(new_n395_), .b(new_n388_), .c(new_n164_), .O(new_n396_));
  nand2  g239(.a(x112), .b(x104), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(x120), .c(new_n163_), .O(new_n398_));
  aoi21  g241(.a(new_n398_), .b(new_n396_), .c(new_n393_), .O(new_n399_));
  nand2  g242(.a(x064), .b(new_n170_), .O(new_n400_));
  oai21  g243(.a(new_n400_), .b(new_n386_), .c(new_n173_), .O(new_n401_));
  oai21  g244(.a(new_n401_), .b(new_n399_), .c(x000), .O(new_n402_));
  aoi21  g245(.a(new_n402_), .b(new_n391_), .c(x072), .O(new_n403_));
  nand2  g246(.a(x064), .b(x016), .O(new_n404_));
  nor2   g247(.a(x112), .b(x104), .O(new_n405_));
  nand2  g248(.a(new_n173_), .b(x008), .O(new_n406_));
  aoi21  g249(.a(new_n400_), .b(new_n165_), .c(new_n172_), .O(new_n407_));
  nand3  g250(.a(new_n384_), .b(new_n164_), .c(x024), .O(new_n408_));
  aoi21  g251(.a(new_n408_), .b(new_n163_), .c(x080), .O(new_n409_));
  oai21  g252(.a(new_n409_), .b(new_n407_), .c(new_n179_), .O(new_n410_));
  and2   g253(.a(new_n410_), .b(new_n406_), .O(new_n411_));
  oai22  g254(.a(new_n411_), .b(new_n405_), .c(new_n404_), .d(new_n179_), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(new_n403_), .c(new_n167_), .O(new_n413_));
  nand2  g256(.a(new_n388_), .b(x000), .O(new_n414_));
  nand3  g257(.a(new_n173_), .b(x024), .c(new_n161_), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n414_), .c(x064), .O(new_n416_));
  nor2   g259(.a(new_n383_), .b(x080), .O(new_n417_));
  oai21  g260(.a(new_n417_), .b(new_n416_), .c(x032), .O(new_n418_));
  nand2  g261(.a(x080), .b(x000), .O(new_n419_));
  nand2  g262(.a(new_n419_), .b(new_n404_), .O(new_n420_));
  aoi21  g263(.a(new_n167_), .b(x032), .c(new_n404_), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(new_n161_), .c(new_n420_), .O(new_n422_));
  nand2  g265(.a(new_n422_), .b(new_n418_), .O(new_n423_));
  oai21  g266(.a(new_n419_), .b(x032), .c(new_n161_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(x072), .O(new_n425_));
  oai21  g268(.a(new_n167_), .b(new_n170_), .c(new_n425_), .O(new_n426_));
  aoi21  g269(.a(new_n423_), .b(new_n179_), .c(new_n426_), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n413_), .c(new_n380_), .O(z08));
  ...
  nand3  g276(.a(new_n433_), .b(new_n431_), .c(new_n193_), .O(new_n434_));
  nand2  g277(.a(new_n432_), .b(new_n429_), .O(new_n435_));
  nand2  g278(.a(new_n430_), .b(x009), .O(new_n436_));
  nand3  g279(.a(new_n436_), .b(new_n435_), .c(new_n192_), .O(new_n437_));
  nand2  g280(.a(new_n432_), .b(new_n430_), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(new_n185_), .O(new_n439_));
  aoi22  g282(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n440_));
  nand4  g283(.a(new_n440_), .b(new_n439_), .c(new_n437_), .d(new_n434_), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n184_), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n160_), .O(z09));
  nand3  g286(.a(x066), .b(x018), .c(new_n203_), .O(new_n444_));
  aoi21  g287(.a(new_n444_), .b(new_n200_), .c(new_n204_), .O(new_n445_));
  nand2  g288(.a(x074), .b(x050), .O(new_n446_));
  nand4  g289(.a(new_n446_), .b(x066), .c(new_n204_), .d(x018), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n211_), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(new_n445_), .c(new_n160_), .O(new_n449_));
  nand2  g292(.a(new_n212_), .b(new_n205_), .O(new_n450_));
  and2   g293(.a(x082), .b(x002), .O(new_n451_));
  oai21  g294(.a(new_n450_), .b(new_n199_), .c(new_n451_), .O(new_n452_));
  aoi21  g295(.a(new_n452_), .b(new_n449_), .c(x042), .O(z10));
  nand2  g296(.a(x067), .b(x019), .O(new_n454_));
  inv1   g297(.a(new_n454_), .O(new_n455_));
  nand2  g298(.a(x083), .b(x003), .O(new_n456_));
  aoi22  g299(.a(new_n456_), .b(x011), .c(x051), .d(new_n220_), .O(new_n457_));
  ...
  oai21  g304(.a(new_n459_), .b(new_n455_), .c(new_n232_), .O(new_n462_));
  aoi21  g305(.a(x051), .b(x035), .c(new_n229_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n462_), .c(new_n461_), .d(new_n458_), .O(new_n464_));
  inv1   g307(.a(new_n464_), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(x043), .c(new_n160_), .O(z11));
  nand2  g309(.a(x068), .b(x020), .O(new_n467_));
  inv1   g310(.a(new_n467_), .O(new_n468_));
  nand2  g311(.a(x084), .b(x004), .O(new_n469_));
  aoi22  g312(.a(new_n469_), .b(x012), .c(x052), .d(new_n239_), .O(new_n470_));
  ...
  oai21  g317(.a(new_n472_), .b(new_n468_), .c(new_n251_), .O(new_n475_));
  aoi21  g318(.a(x052), .b(x036), .c(new_n248_), .O(new_n476_));
  ...
  inv1   g322(.a(new_n258_), .O(new_n480_));
  nand2  g323(.a(x085), .b(x005), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(x037), .c(new_n270_), .O(new_n482_));
  aoi21  g325(.a(new_n480_), .b(new_n299_), .c(new_n482_), .O(new_n483_));
  oai22  g326(.a(new_n483_), .b(new_n158_), .c(new_n299_), .d(new_n298_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(x002), .O(new_n485_));
  nand2  g328(.a(x069), .b(new_n298_), .O(new_n486_));
  aoi21  g329(.a(new_n486_), .b(new_n305_), .c(new_n280_), .O(new_n487_));
  nand3  g330(.a(new_n273_), .b(new_n259_), .c(x029), .O(new_n488_));
  nor2   g331(.a(x021), .b(x013), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n488_), .c(x085), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(new_n487_), .c(new_n292_), .O(new_n491_));
  nor2   g334(.a(x093), .b(x061), .O(new_n492_));
  oai21  g335(.a(new_n263_), .b(x021), .c(new_n492_), .O(new_n493_));
  and2   g336(.a(new_n493_), .b(x069), .O(new_n494_));
  nand2  g337(.a(new_n291_), .b(new_n289_), .O(new_n495_));
  oai21  g338(.a(x069), .b(x013), .c(x021), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n495_), .c(new_n273_), .d(x029), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n494_), .c(new_n262_), .O(new_n499_));
  oai21  g342(.a(x037), .b(x013), .c(x021), .O(new_n500_));
  oai21  g343(.a(new_n266_), .b(x029), .c(new_n500_), .O(new_n501_));
  oai21  g344(.a(new_n273_), .b(new_n281_), .c(new_n495_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n501_), .c(x069), .O(new_n503_));
  nand3  g346(.a(new_n256_), .b(x125), .c(new_n281_), .O(new_n504_));
  nand3  g347(.a(x101), .b(x069), .c(new_n298_), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n504_), .c(new_n262_), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(new_n503_), .c(x005), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n499_), .c(new_n491_), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n299_), .O(new_n509_));
  oai21  g352(.a(x053), .b(new_n298_), .c(new_n480_), .O(new_n510_));
  aoi22  g353(.a(new_n510_), .b(x013), .c(new_n481_), .d(new_n258_), .O(new_n511_));
  nand2  g354(.a(new_n495_), .b(x005), .O(new_n512_));
  nand3  g355(.a(new_n262_), .b(x029), .c(new_n270_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n259_), .O(new_n515_));
  aoi21  g358(.a(new_n493_), .b(new_n262_), .c(x053), .O(new_n516_));
  ...
  nand2  g362(.a(new_n519_), .b(new_n158_), .O(new_n520_));
  aoi21  g363(.a(new_n520_), .b(new_n485_), .c(x045), .O(z13));
  inv1   g364(.a(new_n319_), .O(new_n522_));
  nand2  g365(.a(x070), .b(new_n343_), .O(new_n523_));
  aoi21  g366(.a(new_n523_), .b(new_n359_), .c(new_n342_), .O(new_n524_));
  nand3  g367(.a(new_n333_), .b(new_n323_), .c(x030), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n337_), .c(x086), .O(new_n526_));
  oai21  g369(.a(new_n526_), .b(new_n524_), .c(new_n351_), .O(new_n527_));
  aoi21  g370(.a(x030), .b(new_n337_), .c(new_n329_), .O(new_n528_));
  oai21  g371(.a(x070), .b(x014), .c(x022), .O(new_n529_));
  nand2  g372(.a(new_n350_), .b(new_n348_), .O(new_n530_));
  nand4  g373(.a(new_n530_), .b(new_n529_), .c(new_n333_), .d(x030), .O(new_n531_));
  oai21  g374(.a(new_n528_), .b(new_n323_), .c(new_n531_), .O(new_n532_));
  nand2  g375(.a(new_n532_), .b(new_n327_), .O(new_n533_));
  oai21  g376(.a(x038), .b(x014), .c(x022), .O(new_n534_));
  oai21  g377(.a(new_n329_), .b(x030), .c(new_n534_), .O(new_n535_));
  oai21  g378(.a(new_n333_), .b(new_n337_), .c(new_n530_), .O(new_n536_));
  aoi21  g379(.a(new_n536_), .b(new_n535_), .c(x070), .O(new_n537_));
  nand3  g380(.a(x102), .b(x070), .c(new_n343_), .O(new_n538_));
  nand3  g381(.a(new_n322_), .b(x126), .c(new_n337_), .O(new_n539_));
  ...
  nand2  g385(.a(new_n542_), .b(new_n358_), .O(new_n543_));
  inv1   g386(.a(new_n325_), .O(new_n544_));
  nor2   g387(.a(x086), .b(new_n336_), .O(new_n545_));
  aoi22  g388(.a(new_n545_), .b(new_n351_), .c(new_n544_), .d(x078), .O(new_n546_));
  nand2  g389(.a(new_n546_), .b(new_n543_), .O(new_n547_));
  nand2  g390(.a(new_n547_), .b(new_n320_), .O(new_n548_));
  nand2  g391(.a(new_n530_), .b(x006), .O(new_n549_));
  nand3  g392(.a(new_n327_), .b(x030), .c(new_n336_), .O(new_n550_));
  ...
  nor2   g396(.a(new_n327_), .b(new_n342_), .O(new_n554_));
  aoi21  g397(.a(new_n320_), .b(x038), .c(new_n325_), .O(new_n555_));
  oai22  g398(.a(new_n555_), .b(new_n336_), .c(new_n554_), .d(new_n544_), .O(new_n556_));
  nand2  g399(.a(new_n556_), .b(new_n553_), .O(new_n557_));
  aoi21  g400(.a(new_n554_), .b(new_n343_), .c(x014), .O(new_n558_));
  aoi21  g401(.a(x054), .b(x038), .c(z16), .O(new_n559_));
  oai21  g402(.a(new_n558_), .b(new_n358_), .c(new_n559_), .O(new_n560_));
  aoi21  g403(.a(new_n557_), .b(new_n358_), .c(new_n560_), .O(new_n561_));
  ...
  zero   g408(.O(z25));
  zero   g409(.O(z26));
  nor2   g410(.a(new_n158_), .b(x002), .O(z17));
  nor2   g411(.a(new_n158_), .b(x002), .O(z18));
  nor2   g412(.a(new_n158_), .b(x002), .O(z19));
  nor2   g413(.a(new_n158_), .b(x002), .O(z21));
  nor2   g414(.a(new_n158_), .b(x002), .O(z22));
  nor2   g415(.a(new_n158_), .b(x002), .O(z23));
  nor2   g416(.a(new_n158_), .b(x002), .O(z24));
  nor2   g417(.a(new_n158_), .b(x002), .O(z27));
endmodule
