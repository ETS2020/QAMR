// Benchmark "FAU" written by ABC on Wed Aug 12 10:09:19 2020
...
module FAU ( 
  ...
  nand2  g090(.a(new_n159_), .b(x044), .O(new_n247_));
  ...
  nand2  g215(.a(new_n371_), .b(new_n159_), .O(z06));
  nand2  g216(.a(new_n159_), .b(new_n157_), .O(new_n373_));
  nand2  g217(.a(x064), .b(new_n169_), .O(new_n374_));
  aoi21  g218(.a(new_n374_), .b(new_n164_), .c(new_n171_), .O(new_n375_));
  nand2  g219(.a(x088), .b(x056), .O(new_n376_));
  nand3  g220(.a(new_n376_), .b(new_n163_), .c(x024), .O(new_n377_));
  aoi21  g221(.a(new_n377_), .b(new_n162_), .c(x080), .O(new_n378_));
  ...
  nand3  g237(.a(new_n393_), .b(x120), .c(new_n162_), .O(new_n394_));
  nand3  g238(.a(new_n394_), .b(new_n392_), .c(new_n172_), .O(new_n395_));
  ...
  nand2  g243(.a(new_n172_), .b(x008), .O(new_n400_));
  nor2   g244(.a(x112), .b(x104), .O(new_n401_));
  nand2  g245(.a(x064), .b(x016), .O(new_n402_));
  oai22  g246(.a(new_n402_), .b(new_n178_), .c(new_n401_), .d(new_n400_), .O(new_n403_));
  oai21  g247(.a(new_n403_), .b(new_n399_), .c(new_n166_), .O(new_n404_));
  nand2  g248(.a(new_n385_), .b(x000), .O(new_n405_));
  nand3  g249(.a(new_n172_), .b(x024), .c(new_n160_), .O(new_n406_));
  aoi21  g250(.a(new_n406_), .b(new_n405_), .c(x064), .O(new_n407_));
  and2   g251(.a(new_n382_), .b(new_n172_), .O(new_n408_));
  ...
  aoi21  g255(.a(new_n166_), .b(x032), .c(new_n402_), .O(new_n412_));
  oai21  g256(.a(new_n412_), .b(new_n160_), .c(new_n411_), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n409_), .O(new_n414_));
  oai21  g258(.a(new_n410_), .b(x032), .c(new_n160_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(x072), .O(new_n416_));
  oai21  g260(.a(new_n166_), .b(new_n169_), .c(new_n416_), .O(new_n417_));
  aoi21  g261(.a(new_n414_), .b(new_n178_), .c(new_n417_), .O(new_n418_));
  ...
  oai21  g275(.a(new_n431_), .b(x041), .c(new_n159_), .O(z09));
  ...
  nand3  g281(.a(new_n437_), .b(new_n435_), .c(new_n211_), .O(new_n438_));
  nand2  g282(.a(new_n436_), .b(new_n433_), .O(new_n439_));
  nand2  g283(.a(new_n434_), .b(x010), .O(new_n440_));
  nand3  g284(.a(new_n440_), .b(new_n439_), .c(new_n210_), .O(new_n441_));
  nand2  g285(.a(new_n436_), .b(new_n434_), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n203_), .O(new_n443_));
  ...
  nand2  g290(.a(new_n446_), .b(new_n159_), .O(z10));
  ...
  oai21  g314(.a(new_n468_), .b(new_n464_), .c(new_n245_), .O(new_n471_));
  aoi21  g315(.a(x052), .b(x036), .c(new_n242_), .O(new_n472_));
  nand4  g316(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n467_), .O(new_n473_));
  inv1   g317(.a(new_n473_), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(x044), .c(new_n159_), .O(z12));
  inv1   g319(.a(x045), .O(new_n476_));
  oai21  g320(.a(new_n252_), .b(x021), .c(new_n260_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(x069), .O(new_n478_));
  nand2  g322(.a(x093), .b(x061), .O(new_n479_));
  oai21  g323(.a(x069), .b(x013), .c(x021), .O(new_n480_));
  nand2  g324(.a(new_n274_), .b(new_n270_), .O(new_n481_));
  ...
  nand3  g330(.a(new_n486_), .b(new_n485_), .c(new_n252_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n484_), .O(new_n488_));
  oai22  g332(.a(new_n479_), .b(new_n257_), .c(x125), .d(x101), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n488_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n251_), .O(new_n491_));
  nand3  g335(.a(x101), .b(x069), .c(new_n304_), .O(new_n492_));
  nand3  g336(.a(new_n280_), .b(x125), .c(new_n257_), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n492_), .c(new_n250_), .O(new_n494_));
  inv1   g338(.a(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n491_), .c(new_n293_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n483_), .c(new_n281_), .O(new_n497_));
  inv1   g341(.a(new_n273_), .O(new_n498_));
  inv1   g342(.a(new_n282_), .O(new_n499_));
  nand2  g343(.a(x069), .b(new_n304_), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(new_n289_), .c(new_n293_), .O(new_n501_));
  nand3  g345(.a(new_n479_), .b(new_n251_), .c(x029), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n257_), .c(x085), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n501_), .c(new_n281_), .O(new_n504_));
  ...
  nand3  g352(.a(new_n250_), .b(x029), .c(new_n256_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n508_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n251_), .O(new_n511_));
  nand2  g355(.a(new_n477_), .b(new_n250_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n511_), .c(new_n304_), .O(new_n513_));
  nand3  g357(.a(x085), .b(new_n256_), .c(x005), .O(new_n514_));
  aoi22  g358(.a(new_n514_), .b(new_n282_), .c(x037), .d(x013), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n513_), .c(new_n281_), .O(new_n516_));
  nand2  g360(.a(x085), .b(x005), .O(new_n517_));
  oai21  g361(.a(new_n517_), .b(x037), .c(new_n256_), .O(new_n518_));
  ...
  nand3  g377(.a(new_n533_), .b(new_n532_), .c(new_n314_), .O(new_n534_));
  nand2  g378(.a(new_n534_), .b(new_n531_), .O(new_n535_));
  oai22  g379(.a(new_n526_), .b(new_n319_), .c(x126), .d(x102), .O(new_n536_));
  nand2  g380(.a(new_n536_), .b(new_n535_), .O(new_n537_));
  nand2  g381(.a(new_n537_), .b(new_n313_), .O(new_n538_));
  nand3  g382(.a(x102), .b(x070), .c(new_n366_), .O(new_n539_));
  nand3  g383(.a(new_n342_), .b(x126), .c(new_n319_), .O(new_n540_));
  nand3  g384(.a(new_n540_), .b(new_n539_), .c(new_n312_), .O(new_n541_));
  inv1   g385(.a(new_n541_), .O(new_n542_));
  aoi21  g386(.a(new_n542_), .b(new_n538_), .c(new_n355_), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n530_), .c(new_n343_), .O(new_n544_));
  inv1   g388(.a(new_n335_), .O(new_n545_));
  inv1   g389(.a(new_n344_), .O(new_n546_));
  nand2  g390(.a(x070), .b(new_n366_), .O(new_n547_));
  aoi21  g391(.a(new_n547_), .b(new_n351_), .c(new_n355_), .O(new_n548_));
  nand3  g392(.a(new_n526_), .b(new_n313_), .c(x030), .O(new_n549_));
  aoi21  g393(.a(new_n549_), .b(new_n319_), .c(x086), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(new_n548_), .c(new_n343_), .O(new_n551_));
  nand2  g395(.a(new_n551_), .b(new_n362_), .O(new_n552_));
  ...
  nand3  g399(.a(new_n312_), .b(x030), .c(new_n318_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n555_), .O(new_n557_));
  nand2  g401(.a(new_n557_), .b(new_n313_), .O(new_n558_));
  nand2  g402(.a(new_n524_), .b(new_n312_), .O(new_n559_));
  aoi21  g403(.a(new_n559_), .b(new_n558_), .c(new_n366_), .O(new_n560_));
  nand3  g404(.a(x086), .b(new_n318_), .c(x006), .O(new_n561_));
  aoi22  g405(.a(new_n561_), .b(new_n344_), .c(x038), .d(x014), .O(new_n562_));
  oai21  g406(.a(new_n562_), .b(new_n560_), .c(new_n343_), .O(new_n563_));
  nand2  g407(.a(x086), .b(x006), .O(new_n564_));
  oai21  g408(.a(new_n564_), .b(x038), .c(new_n318_), .O(new_n565_));
  ...
  nand2  g412(.a(new_n568_), .b(new_n159_), .O(z14));
  zero   g413(.O(z18));
  zero   g414(.O(z20));
  zero   g415(.O(z22));
  zero   g416(.O(z24));
  ...
  zero   g418(.O(z26));
  zero   g419(.O(z27));
  nor2   g420(.a(x099), .b(x077), .O(z15));
  nor2   g421(.a(x099), .b(x077), .O(z16));
  nor2   g422(.a(x099), .b(x077), .O(z17));
  nor2   g423(.a(x099), .b(x077), .O(z19));
  nor2   g424(.a(x099), .b(x077), .O(z21));
  nor2   g425(.a(x099), .b(x077), .O(z23));
endmodule
