// Benchmark "FAU" written by ABC on Wed Aug 12 10:03:38 2020
...
module FAU ( 
  ...
  nand3  g113(.a(new_n269_), .b(x069), .c(new_n267_), .O(new_n270_));
  ...
  aoi21  g120(.a(new_n267_), .b(x021), .c(new_n276_), .O(new_n277_));
  oai21  g121(.a(new_n262_), .b(new_n271_), .c(new_n272_), .O(new_n278_));
  nand2  g122(.a(x125), .b(x101), .O(new_n279_));
  nand4  g123(.a(new_n279_), .b(new_n278_), .c(new_n269_), .d(new_n267_), .O(new_n280_));
  ...
  oai21  g128(.a(new_n284_), .b(new_n271_), .c(new_n272_), .O(new_n285_));
  oai21  g129(.a(new_n276_), .b(new_n267_), .c(new_n285_), .O(new_n286_));
  oai21  g130(.a(new_n269_), .b(x021), .c(new_n279_), .O(new_n287_));
  aoi21  g131(.a(new_n287_), .b(new_n286_), .c(new_n262_), .O(new_n288_));
  ...
  nand3  g142(.a(x085), .b(new_n267_), .c(x013), .O(new_n299_));
  ...
  nand2  g149(.a(new_n262_), .b(new_n272_), .O(new_n306_));
  nand3  g150(.a(new_n266_), .b(x013), .c(new_n283_), .O(new_n307_));
  oai21  g151(.a(new_n306_), .b(new_n305_), .c(new_n307_), .O(new_n308_));
  aoi21  g152(.a(new_n304_), .b(new_n284_), .c(new_n308_), .O(new_n309_));
  nand2  g153(.a(x077), .b(x045), .O(new_n310_));
  aoi21  g154(.a(new_n309_), .b(new_n297_), .c(new_n310_), .O(z05));
  ...
  nand3  g181(.a(new_n320_), .b(new_n319_), .c(new_n333_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n328_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n337_), .c(new_n313_), .O(new_n340_));
  ...
  nand2  g194(.a(new_n313_), .b(new_n333_), .O(new_n351_));
  ...
  nand2  g201(.a(new_n328_), .b(new_n332_), .O(new_n358_));
  nand3  g202(.a(x086), .b(new_n318_), .c(x014), .O(new_n359_));
  aoi21  g203(.a(new_n359_), .b(new_n358_), .c(new_n313_), .O(new_n360_));
  nor2   g204(.a(new_n326_), .b(new_n317_), .O(new_n361_));
  oai21  g205(.a(new_n361_), .b(new_n360_), .c(new_n357_), .O(new_n362_));
  nand2  g206(.a(new_n317_), .b(x014), .O(new_n363_));
  inv1   g207(.a(new_n363_), .O(new_n364_));
  nor2   g208(.a(x038), .b(x014), .O(new_n365_));
  inv1   g209(.a(new_n365_), .O(new_n366_));
  aoi22  g210(.a(new_n366_), .b(new_n352_), .c(new_n364_), .d(new_n332_), .O(new_n367_));
  aoi21  g211(.a(new_n367_), .b(new_n362_), .c(new_n350_), .O(new_n368_));
  nor2   g212(.a(x054), .b(x038), .O(new_n369_));
  nand3  g213(.a(new_n317_), .b(x038), .c(new_n332_), .O(new_n370_));
  aoi21  g214(.a(new_n370_), .b(x014), .c(x078), .O(new_n371_));
  nor3   g215(.a(new_n371_), .b(new_n369_), .c(new_n368_), .O(new_n372_));
  nand2  g216(.a(new_n160_), .b(x046), .O(new_n373_));
  aoi21  g217(.a(new_n372_), .b(new_n356_), .c(new_n373_), .O(z06));
  nand2  g218(.a(new_n160_), .b(new_n157_), .O(new_n375_));
  nand2  g219(.a(x064), .b(new_n170_), .O(new_n376_));
  aoi21  g220(.a(new_n376_), .b(new_n165_), .c(new_n172_), .O(new_n377_));
  nand2  g221(.a(x088), .b(x056), .O(new_n378_));
  nand3  g222(.a(new_n378_), .b(new_n164_), .c(x024), .O(new_n379_));
  aoi21  g223(.a(new_n379_), .b(new_n163_), .c(x080), .O(new_n380_));
  ...
  oai21  g236(.a(new_n392_), .b(new_n387_), .c(new_n164_), .O(new_n393_));
  nand3  g237(.a(x096), .b(x064), .c(new_n170_), .O(new_n394_));
  nand2  g238(.a(x112), .b(x104), .O(new_n395_));
  nand3  g239(.a(new_n395_), .b(x120), .c(new_n163_), .O(new_n396_));
  nand3  g240(.a(new_n396_), .b(new_n394_), .c(new_n173_), .O(new_n397_));
  ...
  oai22  g248(.a(new_n404_), .b(new_n179_), .c(new_n403_), .d(new_n402_), .O(new_n405_));
  oai21  g249(.a(new_n405_), .b(new_n401_), .c(new_n167_), .O(new_n406_));
  nand2  g250(.a(new_n387_), .b(x000), .O(new_n407_));
  nand3  g251(.a(new_n173_), .b(x024), .c(new_n161_), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n407_), .c(x064), .O(new_n409_));
  and2   g253(.a(new_n384_), .b(new_n173_), .O(new_n410_));
  ...
  aoi21  g257(.a(new_n167_), .b(x032), .c(new_n404_), .O(new_n414_));
  oai21  g258(.a(new_n414_), .b(new_n161_), .c(new_n413_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n411_), .O(new_n416_));
  oai21  g260(.a(new_n412_), .b(x032), .c(new_n161_), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(x072), .O(new_n418_));
  oai21  g262(.a(new_n167_), .b(new_n170_), .c(new_n418_), .O(new_n419_));
  aoi21  g263(.a(new_n416_), .b(new_n179_), .c(new_n419_), .O(new_n420_));
  aoi21  g264(.a(new_n420_), .b(new_n406_), .c(new_n375_), .O(z08));
  nand2  g265(.a(x065), .b(x017), .O(new_n422_));
  inv1   g266(.a(new_n422_), .O(new_n423_));
  nand2  g267(.a(x081), .b(x001), .O(new_n424_));
  aoi22  g268(.a(new_n424_), .b(x009), .c(x049), .d(new_n187_), .O(new_n425_));
  ...
  oai21  g273(.a(new_n427_), .b(new_n423_), .c(new_n199_), .O(new_n430_));
  aoi21  g274(.a(x049), .b(x033), .c(new_n196_), .O(new_n431_));
  nand4  g275(.a(new_n431_), .b(new_n430_), .c(new_n429_), .d(new_n426_), .O(new_n432_));
  inv1   g276(.a(new_n432_), .O(new_n433_));
  oai21  g277(.a(new_n433_), .b(x041), .c(new_n160_), .O(z09));
  nand2  g278(.a(x066), .b(x018), .O(new_n435_));
  inv1   g279(.a(new_n435_), .O(new_n436_));
  nand2  g280(.a(x082), .b(x002), .O(new_n437_));
  aoi22  g281(.a(new_n437_), .b(x010), .c(x050), .d(new_n206_), .O(new_n438_));
  ...
  oai21  g286(.a(new_n440_), .b(new_n436_), .c(new_n218_), .O(new_n443_));
  aoi21  g287(.a(x050), .b(x034), .c(new_n215_), .O(new_n444_));
  nand4  g288(.a(new_n444_), .b(new_n443_), .c(new_n442_), .d(new_n439_), .O(new_n445_));
  inv1   g289(.a(new_n445_), .O(new_n446_));
  oai21  g290(.a(new_n446_), .b(x042), .c(new_n160_), .O(z10));
  nand2  g291(.a(x067), .b(x019), .O(new_n448_));
  inv1   g292(.a(new_n448_), .O(new_n449_));
  nand2  g293(.a(x083), .b(x003), .O(new_n450_));
  aoi22  g294(.a(new_n450_), .b(x011), .c(x051), .d(new_n225_), .O(new_n451_));
  ...
  oai21  g299(.a(new_n453_), .b(new_n449_), .c(new_n237_), .O(new_n456_));
  aoi21  g300(.a(x051), .b(x035), .c(new_n234_), .O(new_n457_));
  nand4  g301(.a(new_n457_), .b(new_n456_), .c(new_n455_), .d(new_n452_), .O(new_n458_));
  inv1   g302(.a(new_n458_), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(x043), .c(new_n160_), .O(z11));
  nand2  g304(.a(x068), .b(x020), .O(new_n461_));
  inv1   g305(.a(new_n461_), .O(new_n462_));
  inv1   g306(.a(x036), .O(new_n463_));
  nand2  g307(.a(x084), .b(x004), .O(new_n464_));
  aoi22  g308(.a(new_n464_), .b(x012), .c(x052), .d(new_n463_), .O(new_n465_));
  oai21  g309(.a(new_n462_), .b(x012), .c(new_n465_), .O(new_n466_));
  inv1   g310(.a(new_n464_), .O(new_n467_));
  aoi21  g311(.a(new_n461_), .b(x012), .c(x036), .O(new_n468_));
  oai21  g312(.a(new_n467_), .b(x012), .c(new_n468_), .O(new_n469_));
  oai21  g313(.a(new_n467_), .b(new_n462_), .c(new_n254_), .O(new_n470_));
  aoi21  g314(.a(x052), .b(x036), .c(new_n252_), .O(new_n471_));
  nand4  g315(.a(new_n471_), .b(new_n470_), .c(new_n469_), .d(new_n466_), .O(new_n472_));
  and2   g316(.a(new_n472_), .b(new_n241_), .O(z12));
  inv1   g317(.a(x053), .O(new_n474_));
  nor2   g318(.a(new_n264_), .b(x053), .O(new_n475_));
  nand2  g319(.a(x085), .b(x005), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(x037), .c(new_n271_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(new_n475_), .c(x077), .O(new_n478_));
  oai21  g322(.a(new_n474_), .b(new_n284_), .c(new_n478_), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n158_), .O(new_n480_));
  oai22  g324(.a(new_n305_), .b(new_n272_), .c(new_n269_), .d(x029), .O(new_n481_));
  nand2  g325(.a(new_n289_), .b(new_n292_), .O(new_n482_));
  oai21  g326(.a(new_n276_), .b(new_n272_), .c(new_n482_), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(new_n481_), .c(x069), .O(new_n484_));
  nand3  g328(.a(new_n261_), .b(x125), .c(new_n272_), .O(new_n485_));
  nand3  g329(.a(x101), .b(x069), .c(new_n284_), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(new_n485_), .c(new_n266_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n484_), .c(x005), .O(new_n488_));
  nand2  g332(.a(x069), .b(new_n284_), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n306_), .c(new_n283_), .O(new_n490_));
  nand3  g334(.a(new_n276_), .b(new_n262_), .c(x029), .O(new_n491_));
  nor2   g335(.a(x021), .b(x013), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n491_), .c(x085), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n490_), .c(new_n290_), .O(new_n494_));
  oai21  g338(.a(new_n267_), .b(x021), .c(new_n268_), .O(new_n495_));
  and2   g339(.a(new_n495_), .b(x069), .O(new_n496_));
  oai21  g340(.a(x069), .b(x013), .c(x021), .O(new_n497_));
  nand4  g341(.a(new_n497_), .b(new_n482_), .c(new_n276_), .d(x029), .O(new_n498_));
  inv1   g342(.a(new_n498_), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n496_), .c(new_n266_), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n494_), .c(new_n488_), .O(new_n501_));
  nand2  g345(.a(new_n482_), .b(x005), .O(new_n502_));
  nand3  g346(.a(new_n266_), .b(x029), .c(new_n271_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n502_), .c(x069), .O(new_n504_));
  nand2  g348(.a(new_n495_), .b(new_n266_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n474_), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n504_), .c(x037), .O(new_n507_));
  oai21  g351(.a(new_n476_), .b(x013), .c(new_n264_), .O(new_n508_));
  nand3  g352(.a(new_n474_), .b(x037), .c(x013), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n508_), .c(x045), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n507_), .O(new_n511_));
  aoi21  g355(.a(new_n501_), .b(new_n474_), .c(new_n511_), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(x077), .c(new_n480_), .O(z13));
  inv1   g357(.a(new_n373_), .O(new_n514_));
  inv1   g358(.a(x054), .O(new_n515_));
  aoi21  g359(.a(x030), .b(new_n333_), .c(new_n321_), .O(new_n516_));
  oai21  g360(.a(x070), .b(x014), .c(x022), .O(new_n517_));
  nand2  g361(.a(new_n343_), .b(new_n341_), .O(new_n518_));
  nand4  g362(.a(new_n518_), .b(new_n517_), .c(new_n325_), .d(x030), .O(new_n519_));
  oai21  g363(.a(new_n516_), .b(new_n313_), .c(new_n519_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n317_), .O(new_n521_));
  oai22  g365(.a(new_n365_), .b(new_n333_), .c(new_n321_), .d(x030), .O(new_n522_));
  oai21  g366(.a(new_n325_), .b(new_n333_), .c(new_n518_), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n522_), .c(x070), .O(new_n524_));
  nand3  g368(.a(x102), .b(x070), .c(new_n357_), .O(new_n525_));
  nand3  g369(.a(new_n312_), .b(x126), .c(new_n333_), .O(new_n526_));
  nand3  g370(.a(new_n526_), .b(new_n525_), .c(new_n317_), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n524_), .c(x006), .O(new_n528_));
  aoi21  g372(.a(new_n528_), .b(new_n521_), .c(x078), .O(new_n529_));
  nand2  g373(.a(x070), .b(new_n357_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n351_), .c(new_n332_), .O(new_n531_));
  nand3  g375(.a(new_n325_), .b(new_n313_), .c(x030), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n333_), .c(x086), .O(new_n533_));
  oai21  g377(.a(new_n533_), .b(new_n531_), .c(new_n350_), .O(new_n534_));
  nand2  g378(.a(new_n534_), .b(new_n363_), .O(new_n535_));
  nand2  g379(.a(new_n535_), .b(new_n344_), .O(new_n536_));
  oai21  g380(.a(new_n315_), .b(new_n350_), .c(new_n536_), .O(new_n537_));
  oai21  g381(.a(new_n537_), .b(new_n529_), .c(new_n515_), .O(new_n538_));
  nand2  g382(.a(new_n518_), .b(x006), .O(new_n539_));
  inv1   g383(.a(x014), .O(new_n540_));
  nand3  g384(.a(new_n317_), .b(x030), .c(new_n540_), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n539_), .c(x070), .O(new_n542_));
  nor2   g386(.a(new_n516_), .b(x086), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n542_), .c(x038), .O(new_n544_));
  nand2  g388(.a(x086), .b(x006), .O(new_n545_));
  nand2  g389(.a(new_n545_), .b(new_n315_), .O(new_n546_));
  aoi21  g390(.a(new_n515_), .b(x038), .c(new_n315_), .O(new_n547_));
  oai21  g391(.a(new_n547_), .b(new_n540_), .c(new_n546_), .O(new_n548_));
  nand2  g392(.a(new_n548_), .b(new_n544_), .O(new_n549_));
  oai21  g393(.a(new_n545_), .b(x038), .c(new_n540_), .O(new_n550_));
  nand2  g394(.a(new_n550_), .b(x078), .O(new_n551_));
  nand2  g395(.a(x054), .b(x038), .O(new_n552_));
  nand3  g396(.a(new_n552_), .b(new_n551_), .c(new_n160_), .O(new_n553_));
  aoi21  g397(.a(new_n549_), .b(new_n350_), .c(new_n553_), .O(new_n554_));
  aoi21  g398(.a(new_n554_), .b(new_n538_), .c(new_n514_), .O(z14));
  zero   g399(.O(z15));
  zero   g400(.O(z20));
  zero   g401(.O(z21));
  zero   g402(.O(z22));
  zero   g403(.O(z25));
  nor2   g404(.a(x077), .b(new_n158_), .O(z16));
  nor2   g405(.a(x077), .b(new_n158_), .O(z17));
  nor2   g406(.a(x077), .b(new_n158_), .O(z18));
  nor2   g407(.a(x077), .b(new_n158_), .O(z19));
  nor2   g408(.a(x077), .b(new_n158_), .O(z23));
  nor2   g409(.a(x077), .b(new_n158_), .O(z24));
  nor2   g410(.a(x077), .b(new_n158_), .O(z26));
  nor2   g411(.a(x077), .b(new_n158_), .O(z27));
endmodule
