...
module FAU ( 
  ...
  nor2   g021(.a(x095), .b(new_n177_), .O(z15));
  ...
  aoi22  g156(.a(new_n312_), .b(new_n177_), .c(new_n255_), .d(new_n311_), .O(new_n313_));
  ...
  nand2  g290(.a(new_n447_), .b(new_n179_), .O(z09));
  ...
  oai21  g313(.a(new_n468_), .b(new_n463_), .c(new_n229_), .O(new_n471_));
  aoi21  g314(.a(x051), .b(x035), .c(new_n227_), .O(new_n472_));
  nand4  g315(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n467_), .O(new_n473_));
  and2   g316(.a(new_n473_), .b(new_n216_), .O(z11));
  nand2  g317(.a(x068), .b(x020), .O(new_n475_));
  inv1   g318(.a(new_n475_), .O(new_n476_));
  nand2  g319(.a(x084), .b(x004), .O(new_n477_));
  aoi22  g320(.a(new_n477_), .b(x012), .c(x052), .d(new_n239_), .O(new_n478_));
  ...
  oai21  g325(.a(new_n480_), .b(new_n476_), .c(new_n251_), .O(new_n483_));
  aoi21  g326(.a(x052), .b(x036), .c(new_n248_), .O(new_n484_));
  ...
  oai22  g334(.a(new_n491_), .b(new_n177_), .c(new_n255_), .d(new_n311_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(x095), .O(new_n493_));
  ...
  zero   g418(.O(z23));
  zero   g419(.O(z26));
  nor2   g420(.a(x095), .b(new_n177_), .O(z16));
  nor2   g421(.a(x095), .b(new_n177_), .O(z17));
  nor2   g422(.a(x095), .b(new_n177_), .O(z18));
  nor2   g423(.a(x095), .b(new_n177_), .O(z20));
  nor2   g424(.a(x095), .b(new_n177_), .O(z22));
  nor2   g425(.a(x095), .b(new_n177_), .O(z24));
  nor2   g426(.a(x095), .b(new_n177_), .O(z25));
  nor2   g427(.a(x095), .b(new_n177_), .O(z27));
endmodule
