...
module FAU ( 
  ...
  oai21  g284(.a(new_n440_), .b(x041), .c(new_n178_), .O(z09));
  ...
  oai21  g297(.a(new_n453_), .b(x042), .c(new_n178_), .O(z10));
  nand2  g298(.a(x067), .b(x019), .O(new_n455_));
  inv1   g299(.a(new_n455_), .O(new_n456_));
  nand2  g300(.a(x083), .b(x003), .O(new_n457_));
  aoi22  g301(.a(new_n457_), .b(x011), .c(x051), .d(new_n222_), .O(new_n458_));
  ...
  oai21  g306(.a(new_n460_), .b(new_n456_), .c(new_n234_), .O(new_n463_));
  ...
  oai21  g310(.a(new_n466_), .b(x043), .c(new_n178_), .O(z11));
  ...
  oai21  g320(.a(new_n474_), .b(new_n469_), .c(new_n252_), .O(new_n477_));
  aoi21  g321(.a(x052), .b(x036), .c(new_n249_), .O(new_n478_));
  nand4  g322(.a(new_n478_), .b(new_n477_), .c(new_n476_), .d(new_n473_), .O(new_n479_));
  and2   g323(.a(new_n479_), .b(new_n238_), .O(z12));
  ...
  zero   g419(.O(z26));
  zero   g420(.O(z27));
  nor2   g421(.a(x077), .b(x057), .O(z16));
  nor2   g422(.a(x077), .b(x057), .O(z18));
  nor2   g423(.a(x077), .b(x057), .O(z19));
  nor2   g424(.a(x077), .b(x057), .O(z21));
  nor2   g425(.a(x077), .b(x057), .O(z23));
  nor2   g426(.a(x077), .b(x057), .O(z24));
  nor2   g427(.a(x077), .b(x057), .O(z25));
endmodule
