// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:43 2020
...
module FAU ( 
  ...
  oai21  g060(.a(new_n216_), .b(new_n204_), .c(new_n160_), .O(z02));
  ...
  nor2   g080(.a(z07), .b(x044), .O(new_n237_));
  inv1   g081(.a(x012), .O(new_n238_));
  nor2   g082(.a(x068), .b(x020), .O(new_n239_));
  inv1   g083(.a(x052), .O(new_n240_));
  nor2   g084(.a(x084), .b(x004), .O(new_n241_));
  inv1   g085(.a(new_n241_), .O(new_n242_));
  aoi21  g086(.a(new_n242_), .b(new_n238_), .c(new_n240_), .O(new_n243_));
  oai21  g087(.a(new_n239_), .b(new_n238_), .c(new_n243_), .O(new_n244_));
  nand2  g088(.a(new_n242_), .b(x012), .O(new_n245_));
  oai21  g089(.a(x068), .b(x020), .c(new_n238_), .O(new_n246_));
  nand3  g090(.a(new_n246_), .b(new_n245_), .c(x036), .O(new_n247_));
  and2   g091(.a(x076), .b(x012), .O(new_n248_));
  oai21  g092(.a(new_n241_), .b(new_n239_), .c(new_n248_), .O(new_n249_));
  nor2   g093(.a(x076), .b(x012), .O(new_n250_));
  nor2   g094(.a(new_n250_), .b(z07), .O(new_n251_));
  oai21  g095(.a(x052), .b(x036), .c(new_n251_), .O(new_n252_));
  inv1   g096(.a(new_n252_), .O(new_n253_));
  nand4  g097(.a(new_n253_), .b(new_n249_), .c(new_n247_), .d(new_n244_), .O(new_n254_));
  inv1   g098(.a(new_n254_), .O(new_n255_));
  nor2   g099(.a(new_n255_), .b(new_n237_), .O(z04));
  ...
  nand2  g111(.a(new_n267_), .b(new_n158_), .O(new_n268_));
  ...
  nand2  g136(.a(x093), .b(x061), .O(new_n293_));
  inv1   g137(.a(x037), .O(new_n294_));
  oai21  g138(.a(new_n294_), .b(new_n262_), .c(new_n280_), .O(new_n295_));
  oai21  g139(.a(new_n293_), .b(new_n275_), .c(new_n295_), .O(new_n296_));
  ...
  aoi21  g160(.a(new_n313_), .b(new_n294_), .c(new_n316_), .O(new_n317_));
  ...
  aoi21  g183(.a(new_n329_), .b(x022), .c(new_n339_), .O(new_n340_));
  aoi21  g184(.a(x070), .b(x014), .c(x022), .O(new_n341_));
  nand2  g185(.a(x126), .b(x102), .O(new_n342_));
  nand3  g186(.a(new_n342_), .b(new_n332_), .c(new_n329_), .O(new_n343_));
  oai22  g187(.a(new_n343_), .b(new_n341_), .c(new_n340_), .d(x070), .O(new_n344_));
  ...
  nand3  g195(.a(new_n331_), .b(new_n330_), .c(new_n347_), .O(new_n352_));
  nand2  g196(.a(new_n352_), .b(new_n342_), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n351_), .c(new_n325_), .O(new_n354_));
  inv1   g198(.a(x102), .O(new_n355_));
  nand3  g199(.a(new_n355_), .b(new_n325_), .c(x038), .O(new_n356_));
  ...
  oai21  g204(.a(new_n360_), .b(new_n354_), .c(new_n346_), .O(new_n361_));
  aoi21  g205(.a(new_n361_), .b(new_n345_), .c(new_n158_), .O(new_n362_));
  oai21  g206(.a(new_n362_), .b(new_n338_), .c(x054), .O(new_n363_));
  inv1   g207(.a(x038), .O(new_n364_));
  inv1   g208(.a(x054), .O(new_n365_));
  nand2  g209(.a(new_n342_), .b(new_n346_), .O(new_n366_));
  nand3  g210(.a(x086), .b(new_n329_), .c(x014), .O(new_n367_));
  aoi21  g211(.a(new_n367_), .b(new_n366_), .c(new_n325_), .O(new_n368_));
  nor2   g212(.a(new_n340_), .b(new_n328_), .O(new_n369_));
  oai21  g213(.a(new_n369_), .b(new_n368_), .c(new_n364_), .O(new_n370_));
  nand2  g214(.a(new_n325_), .b(new_n347_), .O(new_n371_));
  aoi21  g215(.a(x054), .b(new_n364_), .c(new_n371_), .O(new_n372_));
  oai21  g216(.a(x086), .b(x006), .c(new_n371_), .O(new_n373_));
  aoi21  g217(.a(new_n373_), .b(x014), .c(new_n372_), .O(new_n374_));
  ...
  nand2  g221(.a(new_n377_), .b(x077), .O(new_n378_));
  nand2  g222(.a(new_n365_), .b(new_n364_), .O(new_n379_));
  nand3  g223(.a(new_n328_), .b(x038), .c(new_n346_), .O(new_n380_));
  nand3  g224(.a(new_n325_), .b(x054), .c(new_n347_), .O(new_n381_));
  nand4  g225(.a(new_n381_), .b(new_n380_), .c(new_n379_), .d(x014), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n158_), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n378_), .c(new_n321_), .O(z06));
  nand2  g228(.a(new_n160_), .b(new_n157_), .O(new_n385_));
  nor2   g229(.a(x088), .b(x056), .O(new_n386_));
  nand2  g230(.a(x024), .b(new_n163_), .O(new_n387_));
  and2   g231(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  ...
  nand4  g237(.a(new_n393_), .b(new_n390_), .c(new_n389_), .d(x024), .O(new_n394_));
  oai21  g238(.a(new_n388_), .b(new_n164_), .c(new_n394_), .O(new_n395_));
  nand2  g239(.a(new_n395_), .b(new_n173_), .O(new_n396_));
  oai21  g240(.a(x032), .b(x008), .c(x016), .O(new_n397_));
  aoi21  g241(.a(new_n393_), .b(new_n389_), .c(new_n397_), .O(new_n398_));
  inv1   g242(.a(x024), .O(new_n399_));
  nand2  g243(.a(new_n386_), .b(new_n399_), .O(new_n400_));
  oai21  g244(.a(new_n400_), .b(new_n393_), .c(new_n164_), .O(new_n401_));
  nand2  g245(.a(x112), .b(x104), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(x120), .c(new_n163_), .O(new_n403_));
  aoi21  g247(.a(new_n403_), .b(new_n401_), .c(new_n398_), .O(new_n404_));
  nand2  g248(.a(x064), .b(new_n170_), .O(new_n405_));
  oai21  g249(.a(new_n405_), .b(new_n391_), .c(new_n173_), .O(new_n406_));
  oai21  g250(.a(new_n406_), .b(new_n404_), .c(x000), .O(new_n407_));
  aoi21  g251(.a(new_n407_), .b(new_n396_), .c(x072), .O(new_n408_));
  nand2  g252(.a(x064), .b(x016), .O(new_n409_));
  nor2   g253(.a(x112), .b(x104), .O(new_n410_));
  nand2  g254(.a(new_n173_), .b(x008), .O(new_n411_));
  aoi21  g255(.a(new_n405_), .b(new_n165_), .c(new_n172_), .O(new_n412_));
  nand3  g256(.a(new_n389_), .b(new_n164_), .c(x024), .O(new_n413_));
  aoi21  g257(.a(new_n413_), .b(new_n163_), .c(x080), .O(new_n414_));
  oai21  g258(.a(new_n414_), .b(new_n412_), .c(new_n179_), .O(new_n415_));
  and2   g259(.a(new_n415_), .b(new_n411_), .O(new_n416_));
  oai22  g260(.a(new_n416_), .b(new_n410_), .c(new_n409_), .d(new_n179_), .O(new_n417_));
  oai21  g261(.a(new_n417_), .b(new_n408_), .c(new_n167_), .O(new_n418_));
  nand2  g262(.a(new_n393_), .b(x000), .O(new_n419_));
  nand3  g263(.a(new_n173_), .b(x024), .c(new_n161_), .O(new_n420_));
  aoi21  g264(.a(new_n420_), .b(new_n419_), .c(x064), .O(new_n421_));
  nor2   g265(.a(new_n388_), .b(x080), .O(new_n422_));
  ...
  aoi21  g269(.a(new_n167_), .b(x032), .c(new_n409_), .O(new_n426_));
  ...
  aoi21  g276(.a(new_n432_), .b(new_n418_), .c(new_n385_), .O(z08));
  ...
  oai21  g313(.a(new_n467_), .b(new_n463_), .c(new_n233_), .O(new_n470_));
  aoi21  g314(.a(x051), .b(x035), .c(new_n230_), .O(new_n471_));
  nand4  g315(.a(new_n471_), .b(new_n470_), .c(new_n469_), .d(new_n466_), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(new_n473_));
  oai21  g317(.a(new_n473_), .b(x043), .c(new_n160_), .O(z11));
  nand2  g318(.a(x068), .b(x020), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(new_n476_));
  inv1   g320(.a(x036), .O(new_n477_));
  nand2  g321(.a(x084), .b(x004), .O(new_n478_));
  aoi22  g322(.a(new_n478_), .b(x012), .c(x052), .d(new_n477_), .O(new_n479_));
  oai21  g323(.a(new_n476_), .b(x012), .c(new_n479_), .O(new_n480_));
  inv1   g324(.a(new_n478_), .O(new_n481_));
  aoi21  g325(.a(new_n475_), .b(x012), .c(x036), .O(new_n482_));
  oai21  g326(.a(new_n481_), .b(x012), .c(new_n482_), .O(new_n483_));
  oai21  g327(.a(new_n481_), .b(new_n476_), .c(new_n250_), .O(new_n484_));
  aoi21  g328(.a(x052), .b(x036), .c(new_n248_), .O(new_n485_));
  nand4  g329(.a(new_n485_), .b(new_n484_), .c(new_n483_), .d(new_n480_), .O(new_n486_));
  and2   g330(.a(new_n486_), .b(new_n237_), .O(z12));
  inv1   g331(.a(new_n300_), .O(new_n488_));
  nand2  g332(.a(x069), .b(new_n294_), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n261_), .c(new_n292_), .O(new_n490_));
  nand3  g334(.a(new_n293_), .b(new_n270_), .c(x029), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n280_), .c(x085), .O(new_n492_));
  oai21  g336(.a(new_n492_), .b(new_n490_), .c(new_n258_), .O(new_n493_));
  nand2  g337(.a(new_n274_), .b(x013), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n493_), .c(new_n488_), .O(new_n495_));
  aoi21  g339(.a(x029), .b(new_n280_), .c(new_n278_), .O(new_n496_));
  oai21  g340(.a(x069), .b(x013), .c(x021), .O(new_n497_));
  nand2  g341(.a(new_n299_), .b(new_n302_), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n497_), .c(new_n293_), .d(x029), .O(new_n499_));
  oai21  g343(.a(new_n496_), .b(new_n270_), .c(new_n499_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n274_), .O(new_n501_));
  oai21  g345(.a(x037), .b(x013), .c(x021), .O(new_n502_));
  nand3  g346(.a(new_n277_), .b(new_n276_), .c(new_n275_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  oai22  g348(.a(new_n293_), .b(new_n280_), .c(x125), .d(x101), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n504_), .c(x069), .O(new_n506_));
  nand3  g350(.a(x101), .b(x069), .c(new_n294_), .O(new_n507_));
  nand3  g351(.a(new_n269_), .b(x125), .c(new_n280_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n274_), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(new_n506_), .c(x005), .O(new_n510_));
  aoi21  g354(.a(new_n510_), .b(new_n501_), .c(x077), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n495_), .c(new_n259_), .O(new_n512_));
  nand2  g356(.a(new_n498_), .b(x005), .O(new_n513_));
  nand3  g357(.a(new_n274_), .b(x029), .c(new_n262_), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n513_), .c(x069), .O(new_n515_));
  nor2   g359(.a(new_n496_), .b(x085), .O(new_n516_));
  oai21  g360(.a(new_n516_), .b(new_n515_), .c(x037), .O(new_n517_));
  oai21  g361(.a(new_n274_), .b(new_n292_), .c(new_n272_), .O(new_n518_));
  aoi21  g362(.a(new_n259_), .b(x037), .c(new_n272_), .O(new_n519_));
  oai21  g363(.a(new_n519_), .b(new_n262_), .c(new_n518_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n517_), .O(new_n521_));
  nor2   g365(.a(new_n259_), .b(new_n294_), .O(new_n522_));
  aoi21  g366(.a(new_n521_), .b(new_n258_), .c(new_n522_), .O(new_n523_));
  nand2  g367(.a(new_n523_), .b(new_n512_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n158_), .O(new_n525_));
  nor3   g369(.a(new_n274_), .b(x037), .c(new_n292_), .O(new_n526_));
  nor2   g370(.a(new_n522_), .b(x013), .O(new_n527_));
  oai21  g371(.a(new_n272_), .b(x053), .c(new_n527_), .O(new_n528_));
  oai21  g372(.a(new_n528_), .b(new_n526_), .c(x077), .O(new_n529_));
  aoi21  g373(.a(new_n529_), .b(new_n525_), .c(x045), .O(z13));
  inv1   g374(.a(new_n324_), .O(new_n531_));
  nand2  g375(.a(x086), .b(x006), .O(new_n532_));
  oai21  g376(.a(new_n532_), .b(x038), .c(new_n336_), .O(new_n533_));
  aoi21  g377(.a(new_n531_), .b(new_n365_), .c(new_n533_), .O(new_n534_));
  oai22  g378(.a(new_n534_), .b(new_n158_), .c(new_n365_), .d(new_n364_), .O(new_n535_));
  nand2  g379(.a(new_n535_), .b(x077), .O(new_n536_));
  nand2  g380(.a(x070), .b(new_n364_), .O(new_n537_));
  aoi21  g381(.a(new_n537_), .b(new_n371_), .c(new_n346_), .O(new_n538_));
  nand3  g382(.a(new_n339_), .b(new_n325_), .c(x030), .O(new_n539_));
  nor2   g383(.a(x022), .b(x014), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n539_), .c(x086), .O(new_n541_));
  oai21  g385(.a(new_n541_), .b(new_n538_), .c(new_n358_), .O(new_n542_));
  nor2   g386(.a(x094), .b(x062), .O(new_n543_));
  oai21  g387(.a(new_n329_), .b(x022), .c(new_n543_), .O(new_n544_));
  and2   g388(.a(new_n544_), .b(x070), .O(new_n545_));
  nand2  g389(.a(new_n357_), .b(new_n355_), .O(new_n546_));
  oai21  g390(.a(x070), .b(x014), .c(x022), .O(new_n547_));
  nand4  g391(.a(new_n547_), .b(new_n546_), .c(new_n339_), .d(x030), .O(new_n548_));
  inv1   g392(.a(new_n548_), .O(new_n549_));
  oai21  g393(.a(new_n549_), .b(new_n545_), .c(new_n328_), .O(new_n550_));
  oai21  g394(.a(x038), .b(x014), .c(x022), .O(new_n551_));
  oai21  g395(.a(new_n332_), .b(x030), .c(new_n551_), .O(new_n552_));
  oai21  g396(.a(new_n339_), .b(new_n347_), .c(new_n546_), .O(new_n553_));
  aoi21  g397(.a(new_n553_), .b(new_n552_), .c(x070), .O(new_n554_));
  nand3  g398(.a(new_n322_), .b(x126), .c(new_n347_), .O(new_n555_));
  nand3  g399(.a(x102), .b(x070), .c(new_n364_), .O(new_n556_));
  nand3  g400(.a(new_n556_), .b(new_n555_), .c(new_n328_), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n554_), .c(x006), .O(new_n558_));
  nand3  g402(.a(new_n558_), .b(new_n550_), .c(new_n542_), .O(new_n559_));
  nand2  g403(.a(new_n559_), .b(new_n365_), .O(new_n560_));
  oai21  g404(.a(x054), .b(new_n364_), .c(new_n531_), .O(new_n561_));
  aoi22  g405(.a(new_n561_), .b(x014), .c(new_n532_), .d(new_n324_), .O(new_n562_));
  nand2  g406(.a(new_n546_), .b(x006), .O(new_n563_));
  nand3  g407(.a(new_n328_), .b(x030), .c(new_n336_), .O(new_n564_));
  nand2  g408(.a(new_n564_), .b(new_n563_), .O(new_n565_));
  nand2  g409(.a(new_n565_), .b(new_n325_), .O(new_n566_));
  aoi21  g410(.a(new_n544_), .b(new_n328_), .c(x054), .O(new_n567_));
  nand2  g411(.a(new_n567_), .b(new_n566_), .O(new_n568_));
  aoi21  g412(.a(new_n568_), .b(x038), .c(new_n562_), .O(new_n569_));
  nand2  g413(.a(new_n569_), .b(new_n560_), .O(new_n570_));
  nand2  g414(.a(new_n570_), .b(new_n158_), .O(new_n571_));
  aoi21  g415(.a(new_n571_), .b(new_n536_), .c(x046), .O(z14));
  zero   g416(.O(z17));
  zero   g417(.O(z21));
  zero   g418(.O(z22));
  zero   g419(.O(z24));
  zero   g420(.O(z25));
  zero   g421(.O(z26));
  nor2   g422(.a(new_n158_), .b(x077), .O(z15));
  nor2   g423(.a(new_n158_), .b(x077), .O(z16));
  nor2   g424(.a(new_n158_), .b(x077), .O(z18));
  nor2   g425(.a(new_n158_), .b(x077), .O(z19));
  nor2   g426(.a(new_n158_), .b(x077), .O(z20));
  nor2   g427(.a(new_n158_), .b(x077), .O(z23));
  nor2   g428(.a(new_n158_), .b(x077), .O(z27));
endmodule
