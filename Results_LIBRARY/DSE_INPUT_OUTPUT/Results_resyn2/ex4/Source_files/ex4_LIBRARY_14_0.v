...
module FAU ( 
  ...
  aoi22  g139(.a(new_n295_), .b(new_n256_), .c(new_n294_), .d(new_n179_), .O(new_n296_));
  ...
  aoi21  g155(.a(new_n311_), .b(new_n298_), .c(new_n178_), .O(z05));
  ...
  inv1   g220(.a(x000), .O(new_n377_));
  nand2  g221(.a(x088), .b(x056), .O(new_n378_));
  oai21  g222(.a(x120), .b(x096), .c(new_n378_), .O(new_n379_));
  aoi21  g223(.a(new_n169_), .b(new_n157_), .c(new_n158_), .O(new_n380_));
  ...
  aoi21  g236(.a(new_n392_), .b(new_n387_), .c(new_n377_), .O(new_n393_));
  ...
  oai21  g244(.a(new_n400_), .b(new_n393_), .c(new_n376_), .O(new_n401_));
  or2    g245(.a(x112), .b(x104), .O(new_n402_));
  nand2  g246(.a(x064), .b(new_n169_), .O(new_n403_));
  aoi21  g247(.a(new_n403_), .b(new_n160_), .c(new_n377_), .O(new_n404_));
  nand3  g248(.a(new_n378_), .b(new_n159_), .c(x024), .O(new_n405_));
  ...
  aoi21  g255(.a(new_n408_), .b(new_n402_), .c(new_n411_), .O(new_n412_));
  aoi21  g256(.a(new_n412_), .b(new_n401_), .c(x048), .O(new_n413_));
  ...
  inv1   g260(.a(new_n395_), .O(new_n417_));
  aoi21  g261(.a(new_n417_), .b(new_n385_), .c(x080), .O(new_n418_));
  ...
  nand2  g332(.a(x077), .b(new_n178_), .O(new_n489_));
  ...
  zero   g385(.O(z25));
  zero   g386(.O(z27));
  inv1   g387(.a(new_n180_), .O(z19));
  inv1   g388(.a(new_n180_), .O(z21));
  inv1   g389(.a(new_n180_), .O(z26));
endmodule
