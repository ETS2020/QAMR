// Benchmark "FAU" written by ABC on Wed Aug 12 10:09:57 2020
...
module FAU ( 
  ...
  aoi21  g108(.a(new_n257_), .b(x021), .c(new_n264_), .O(new_n265_));
  aoi21  g109(.a(new_n259_), .b(new_n258_), .c(x029), .O(new_n266_));
  ...
  nand3  g114(.a(new_n270_), .b(new_n269_), .c(new_n266_), .O(new_n271_));
  oai21  g115(.a(new_n265_), .b(x069), .c(new_n271_), .O(new_n272_));
  nand2  g116(.a(new_n272_), .b(x085), .O(new_n273_));
  inv1   g117(.a(x005), .O(new_n274_));
  nand2  g118(.a(new_n270_), .b(new_n260_), .O(new_n275_));
  aoi21  g119(.a(x037), .b(x013), .c(x021), .O(new_n276_));
  nand3  g120(.a(x093), .b(x061), .c(x029), .O(new_n277_));
  oai21  g121(.a(new_n277_), .b(new_n270_), .c(x069), .O(new_n278_));
  aoi21  g122(.a(new_n276_), .b(new_n275_), .c(new_n278_), .O(new_n279_));
  inv1   g123(.a(x101), .O(new_n280_));
  nand3  g124(.a(new_n280_), .b(new_n252_), .c(x037), .O(new_n281_));
  or2    g125(.a(x117), .b(x109), .O(new_n282_));
  nor2   g126(.a(x125), .b(new_n268_), .O(new_n283_));
  ...
  nand3  g130(.a(new_n286_), .b(new_n273_), .c(new_n263_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(x077), .O(new_n288_));
  inv1   g132(.a(x077), .O(new_n289_));
  nor2   g133(.a(x069), .b(x021), .O(new_n290_));
  nor2   g134(.a(new_n256_), .b(x013), .O(new_n291_));
  aoi22  g135(.a(new_n291_), .b(new_n251_), .c(new_n290_), .d(new_n289_), .O(new_n292_));
  nand2  g136(.a(new_n292_), .b(new_n288_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(x053), .O(new_n294_));
  inv1   g138(.a(x037), .O(new_n295_));
  nand2  g139(.a(new_n270_), .b(new_n274_), .O(new_n296_));
  nand3  g140(.a(x085), .b(new_n257_), .c(x013), .O(new_n297_));
  aoi21  g141(.a(new_n297_), .b(new_n296_), .c(new_n252_), .O(new_n298_));
  nor2   g142(.a(new_n265_), .b(new_n256_), .O(new_n299_));
  oai21  g143(.a(new_n299_), .b(new_n298_), .c(new_n295_), .O(new_n300_));
  nor2   g144(.a(x085), .b(x005), .O(new_n301_));
  nand3  g145(.a(x053), .b(new_n295_), .c(new_n267_), .O(new_n302_));
  aoi22  g146(.a(new_n302_), .b(new_n290_), .c(new_n301_), .d(x013), .O(new_n303_));
  nand2  g147(.a(new_n303_), .b(new_n300_), .O(new_n304_));
  aoi21  g148(.a(new_n301_), .b(x037), .c(new_n267_), .O(new_n305_));
  oai22  g149(.a(new_n305_), .b(x077), .c(x053), .d(x037), .O(new_n306_));
  aoi21  g150(.a(new_n304_), .b(x077), .c(new_n306_), .O(new_n307_));
  aoi21  g151(.a(new_n307_), .b(new_n294_), .c(new_n250_), .O(z05));
  nor2   g152(.a(z07), .b(x046), .O(new_n309_));
  inv1   g153(.a(x086), .O(new_n310_));
  inv1   g154(.a(x030), .O(new_n311_));
  nand2  g155(.a(x094), .b(x062), .O(new_n312_));
  aoi21  g156(.a(new_n311_), .b(x022), .c(new_n312_), .O(new_n313_));
  or2    g157(.a(new_n313_), .b(x070), .O(new_n314_));
  inv1   g158(.a(x014), .O(new_n315_));
  inv1   g159(.a(x022), .O(new_n316_));
  inv1   g160(.a(x070), .O(new_n317_));
  oai21  g161(.a(new_n317_), .b(new_n315_), .c(new_n316_), .O(new_n318_));
  ...
  nand4  g166(.a(new_n322_), .b(new_n321_), .c(new_n318_), .d(new_n311_), .O(new_n323_));
  aoi21  g167(.a(new_n323_), .b(new_n314_), .c(new_n310_), .O(new_n324_));
  nand2  g168(.a(x038), .b(x014), .O(new_n325_));
  nand3  g169(.a(x094), .b(x062), .c(x030), .O(new_n326_));
  inv1   g170(.a(new_n326_), .O(new_n327_));
  aoi21  g171(.a(new_n325_), .b(new_n316_), .c(new_n327_), .O(new_n328_));
  nor2   g172(.a(x094), .b(x062), .O(new_n329_));
  aoi22  g173(.a(new_n329_), .b(new_n316_), .c(x126), .d(x102), .O(new_n330_));
  oai21  g174(.a(new_n330_), .b(new_n328_), .c(x070), .O(new_n331_));
  inv1   g175(.a(x102), .O(new_n332_));
  nand2  g176(.a(new_n317_), .b(x038), .O(new_n333_));
  inv1   g177(.a(new_n333_), .O(new_n334_));
  nor2   g178(.a(x118), .b(x110), .O(new_n335_));
  inv1   g179(.a(x126), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(x022), .O(new_n337_));
  oai21  g181(.a(new_n337_), .b(new_n335_), .c(x086), .O(new_n338_));
  aoi21  g182(.a(new_n334_), .b(new_n332_), .c(new_n338_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n331_), .c(x006), .O(new_n340_));
  oai21  g184(.a(new_n340_), .b(new_n324_), .c(x078), .O(new_n341_));
  nand2  g185(.a(x118), .b(x110), .O(new_n342_));
  nand2  g186(.a(x070), .b(x022), .O(new_n343_));
  aoi21  g187(.a(new_n343_), .b(new_n333_), .c(x006), .O(new_n344_));
  nand3  g188(.a(new_n321_), .b(x070), .c(new_n311_), .O(new_n345_));
  aoi21  g189(.a(new_n345_), .b(x022), .c(new_n310_), .O(new_n346_));
  oai21  g190(.a(new_n346_), .b(new_n344_), .c(x078), .O(new_n347_));
  nand2  g191(.a(x086), .b(new_n315_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(new_n342_), .O(new_n350_));
  inv1   g194(.a(x078), .O(new_n351_));
  nand3  g195(.a(new_n351_), .b(new_n317_), .c(new_n316_), .O(new_n352_));
  nand3  g196(.a(new_n352_), .b(new_n350_), .c(new_n341_), .O(new_n353_));
  ...
  nand3  g201(.a(x086), .b(new_n311_), .c(x014), .O(new_n358_));
  aoi21  g202(.a(new_n358_), .b(new_n357_), .c(new_n317_), .O(new_n359_));
  nor2   g203(.a(new_n313_), .b(new_n310_), .O(new_n360_));
  oai21  g204(.a(new_n360_), .b(new_n359_), .c(new_n355_), .O(new_n361_));
  nand2  g205(.a(new_n317_), .b(new_n316_), .O(new_n362_));
  ...
  aoi21  g211(.a(new_n367_), .b(x038), .c(new_n315_), .O(new_n368_));
  inv1   g212(.a(x054), .O(new_n369_));
  aoi21  g213(.a(new_n369_), .b(new_n355_), .c(z07), .O(new_n370_));
  oai21  g214(.a(new_n368_), .b(x078), .c(new_n370_), .O(new_n371_));
  aoi21  g215(.a(new_n366_), .b(x078), .c(new_n371_), .O(new_n372_));
  aoi21  g216(.a(new_n372_), .b(new_n354_), .c(new_n309_), .O(z06));
  nand2  g217(.a(x064), .b(new_n167_), .O(new_n374_));
  aoi21  g218(.a(new_n374_), .b(new_n159_), .c(new_n170_), .O(new_n375_));
  inv1   g219(.a(x016), .O(new_n376_));
  inv1   g220(.a(x064), .O(new_n377_));
  nand2  g221(.a(x088), .b(x056), .O(new_n378_));
  nand3  g222(.a(new_n378_), .b(new_n377_), .c(x024), .O(new_n379_));
  aoi21  g223(.a(new_n379_), .b(new_n376_), .c(x080), .O(new_n380_));
  oai22  g224(.a(new_n380_), .b(new_n375_), .c(x112), .d(x104), .O(new_n381_));
  inv1   g225(.a(x024), .O(new_n382_));
  nor2   g226(.a(x088), .b(x056), .O(new_n383_));
  oai21  g227(.a(new_n382_), .b(x016), .c(new_n383_), .O(new_n384_));
  nand2  g228(.a(new_n384_), .b(x064), .O(new_n385_));
  oai21  g229(.a(x064), .b(x008), .c(x016), .O(new_n386_));
  or2    g230(.a(x120), .b(x096), .O(new_n387_));
  nand4  g231(.a(new_n387_), .b(new_n386_), .c(new_n378_), .d(x024), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n385_), .c(x080), .O(new_n389_));
  oai21  g233(.a(x032), .b(x008), .c(x016), .O(new_n390_));
  aoi21  g234(.a(new_n387_), .b(new_n378_), .c(new_n390_), .O(new_n391_));
  nand2  g235(.a(new_n383_), .b(new_n382_), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n387_), .c(new_n377_), .O(new_n393_));
  nand3  g237(.a(x096), .b(x064), .c(new_n167_), .O(new_n394_));
  nand2  g238(.a(x112), .b(x104), .O(new_n395_));
  nand3  g239(.a(new_n395_), .b(x120), .c(new_n376_), .O(new_n396_));
  nand3  g240(.a(new_n396_), .b(new_n394_), .c(new_n171_), .O(new_n397_));
  inv1   g241(.a(new_n397_), .O(new_n398_));
  oai21  g242(.a(new_n393_), .b(new_n391_), .c(new_n398_), .O(new_n399_));
  aoi21  g243(.a(new_n399_), .b(x000), .c(new_n389_), .O(new_n400_));
  aoi21  g244(.a(new_n400_), .b(new_n381_), .c(x072), .O(new_n401_));
  inv1   g245(.a(x072), .O(new_n402_));
  nand2  g246(.a(new_n171_), .b(x008), .O(new_n403_));
  nor2   g247(.a(x112), .b(x104), .O(new_n404_));
  nand2  g248(.a(x064), .b(x016), .O(new_n405_));
  oai22  g249(.a(new_n405_), .b(new_n402_), .c(new_n404_), .d(new_n403_), .O(new_n406_));
  oai21  g250(.a(new_n406_), .b(new_n401_), .c(new_n157_), .O(new_n407_));
  nand2  g251(.a(new_n387_), .b(x000), .O(new_n408_));
  nand3  g252(.a(new_n171_), .b(x024), .c(new_n168_), .O(new_n409_));
  aoi21  g253(.a(new_n409_), .b(new_n408_), .c(x064), .O(new_n410_));
  and2   g254(.a(new_n384_), .b(new_n171_), .O(new_n411_));
  ...
  oai21  g259(.a(new_n415_), .b(new_n168_), .c(new_n414_), .O(new_n416_));
  nand2  g260(.a(new_n416_), .b(new_n412_), .O(new_n417_));
  oai21  g261(.a(new_n413_), .b(x032), .c(new_n168_), .O(new_n418_));
  nand2  g262(.a(new_n418_), .b(x072), .O(new_n419_));
  oai21  g263(.a(new_n157_), .b(new_n167_), .c(new_n419_), .O(new_n420_));
  aoi21  g264(.a(new_n417_), .b(new_n402_), .c(new_n420_), .O(new_n421_));
  inv1   g265(.a(x040), .O(new_n422_));
  nand2  g266(.a(new_n176_), .b(new_n422_), .O(new_n423_));
  aoi21  g267(.a(new_n421_), .b(new_n407_), .c(new_n423_), .O(z08));
  nand2  g268(.a(x065), .b(x017), .O(new_n425_));
  inv1   g269(.a(new_n425_), .O(new_n426_));
  nand2  g270(.a(x081), .b(x001), .O(new_n427_));
  aoi22  g271(.a(new_n427_), .b(x009), .c(x049), .d(new_n182_), .O(new_n428_));
  ...
  oai21  g276(.a(new_n430_), .b(new_n426_), .c(new_n194_), .O(new_n433_));
  aoi21  g277(.a(x049), .b(x033), .c(new_n191_), .O(new_n434_));
  nand4  g278(.a(new_n434_), .b(new_n433_), .c(new_n432_), .d(new_n429_), .O(new_n435_));
  inv1   g279(.a(new_n435_), .O(new_n436_));
  oai21  g280(.a(new_n436_), .b(x041), .c(new_n176_), .O(z09));
  inv1   g281(.a(x010), .O(new_n438_));
  nand2  g282(.a(x066), .b(x018), .O(new_n439_));
  nand2  g283(.a(new_n439_), .b(new_n438_), .O(new_n440_));
  nand2  g284(.a(x082), .b(x002), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(x010), .O(new_n442_));
  nand3  g286(.a(new_n442_), .b(new_n440_), .c(new_n207_), .O(new_n443_));
  nand2  g287(.a(new_n441_), .b(new_n438_), .O(new_n444_));
  nand2  g288(.a(new_n439_), .b(x010), .O(new_n445_));
  nand3  g289(.a(new_n445_), .b(new_n444_), .c(new_n206_), .O(new_n446_));
  nand2  g290(.a(new_n441_), .b(new_n439_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n199_), .O(new_n448_));
  aoi22  g292(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n449_));
  nand4  g293(.a(new_n449_), .b(new_n448_), .c(new_n446_), .d(new_n443_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n198_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n176_), .O(z10));
  nand2  g296(.a(x067), .b(x019), .O(new_n453_));
  inv1   g297(.a(new_n453_), .O(new_n454_));
  nand2  g298(.a(x083), .b(x003), .O(new_n455_));
  aoi22  g299(.a(new_n455_), .b(x011), .c(x051), .d(new_n215_), .O(new_n456_));
  oai21  g300(.a(new_n454_), .b(x011), .c(new_n456_), .O(new_n457_));
  inv1   g301(.a(new_n455_), .O(new_n458_));
  aoi21  g302(.a(new_n453_), .b(x011), .c(x035), .O(new_n459_));
  oai21  g303(.a(new_n458_), .b(x011), .c(new_n459_), .O(new_n460_));
  oai21  g304(.a(new_n458_), .b(new_n454_), .c(new_n227_), .O(new_n461_));
  aoi21  g305(.a(x051), .b(x035), .c(new_n224_), .O(new_n462_));
  nand4  g306(.a(new_n462_), .b(new_n461_), .c(new_n460_), .d(new_n457_), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(x043), .c(new_n176_), .O(z11));
  nand2  g309(.a(x068), .b(x020), .O(new_n466_));
  inv1   g310(.a(new_n466_), .O(new_n467_));
  nand2  g311(.a(x084), .b(x004), .O(new_n468_));
  aoi22  g312(.a(new_n468_), .b(x012), .c(x052), .d(new_n234_), .O(new_n469_));
  ...
  oai21  g317(.a(new_n471_), .b(new_n467_), .c(new_n246_), .O(new_n474_));
  aoi21  g318(.a(x052), .b(x036), .c(new_n243_), .O(new_n475_));
  nand4  g319(.a(new_n475_), .b(new_n474_), .c(new_n473_), .d(new_n470_), .O(new_n476_));
  inv1   g320(.a(new_n476_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(x044), .c(new_n176_), .O(z12));
  inv1   g322(.a(new_n254_), .O(new_n479_));
  nand2  g323(.a(x053), .b(new_n295_), .O(new_n480_));
  oai21  g324(.a(new_n479_), .b(x053), .c(new_n480_), .O(new_n481_));
  nor2   g325(.a(x037), .b(new_n274_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(x085), .c(x013), .O(new_n483_));
  nand2  g327(.a(x077), .b(new_n250_), .O(new_n484_));
  aoi21  g328(.a(new_n483_), .b(new_n481_), .c(new_n484_), .O(z13));
  inv1   g329(.a(new_n309_), .O(new_n486_));
  inv1   g330(.a(new_n335_), .O(new_n487_));
  nand2  g331(.a(x070), .b(new_n355_), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n362_), .c(new_n356_), .O(new_n489_));
  nand3  g333(.a(new_n312_), .b(new_n317_), .c(x030), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n316_), .c(x086), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n489_), .c(new_n487_), .O(new_n492_));
  aoi21  g336(.a(x030), .b(new_n316_), .c(new_n321_), .O(new_n493_));
  oai21  g337(.a(x070), .b(x014), .c(x022), .O(new_n494_));
  nand2  g338(.a(new_n336_), .b(new_n332_), .O(new_n495_));
  nand4  g339(.a(new_n495_), .b(new_n494_), .c(new_n312_), .d(x030), .O(new_n496_));
  oai21  g340(.a(new_n493_), .b(new_n317_), .c(new_n496_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n310_), .O(new_n498_));
  oai21  g342(.a(x038), .b(x014), .c(x022), .O(new_n499_));
  nand3  g343(.a(new_n320_), .b(new_n319_), .c(new_n311_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  oai22  g345(.a(new_n312_), .b(new_n316_), .c(x126), .d(x102), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n501_), .c(x070), .O(new_n503_));
  nand3  g347(.a(x102), .b(x070), .c(new_n355_), .O(new_n504_));
  nand3  g348(.a(new_n342_), .b(x126), .c(new_n316_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n310_), .O(new_n506_));
  ...
  inv1   g353(.a(new_n343_), .O(new_n510_));
  nor2   g354(.a(x086), .b(new_n315_), .O(new_n511_));
  aoi22  g355(.a(new_n511_), .b(new_n487_), .c(new_n510_), .d(x078), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n509_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n369_), .O(new_n514_));
  nand2  g358(.a(new_n495_), .b(x006), .O(new_n515_));
  nand3  g359(.a(new_n310_), .b(x030), .c(new_n315_), .O(new_n516_));
  ...
  oai21  g364(.a(new_n520_), .b(x014), .c(new_n343_), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n325_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n519_), .O(new_n523_));
  oai21  g367(.a(new_n520_), .b(x038), .c(new_n315_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(x078), .O(new_n525_));
  oai21  g369(.a(new_n369_), .b(new_n355_), .c(new_n525_), .O(new_n526_));
  aoi21  g370(.a(new_n523_), .b(new_n351_), .c(new_n526_), .O(new_n527_));
  ...
  nor2   g381(.a(x077), .b(x045), .O(z20));
  nor2   g382(.a(x077), .b(x045), .O(z21));
  nor2   g383(.a(x077), .b(x045), .O(z25));
