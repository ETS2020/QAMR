// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:48 2020
...
module FAU ( 
  ...
  nand3  g003(.a(new_n159_), .b(x032), .c(new_n158_), .O(new_n160_));
  inv1   g004(.a(x000), .O(new_n161_));
  inv1   g005(.a(x080), .O(new_n162_));
  inv1   g006(.a(x032), .O(new_n163_));
  inv1   g007(.a(x072), .O(new_n164_));
  nand3  g008(.a(new_n164_), .b(new_n163_), .c(x008), .O(new_n165_));
  nand3  g009(.a(new_n165_), .b(new_n162_), .c(new_n161_), .O(new_n166_));
  aoi21  g010(.a(new_n166_), .b(new_n160_), .c(new_n157_), .O(new_n167_));
  nand2  g011(.a(new_n159_), .b(new_n158_), .O(new_n168_));
  nand2  g012(.a(new_n168_), .b(x048), .O(new_n169_));
  oai21  g013(.a(x080), .b(x000), .c(new_n157_), .O(new_n170_));
  nand3  g014(.a(new_n170_), .b(new_n169_), .c(x008), .O(new_n171_));
  inv1   g015(.a(x008), .O(new_n172_));
  nand2  g016(.a(new_n164_), .b(new_n172_), .O(new_n173_));
  oai21  g017(.a(new_n168_), .b(new_n164_), .c(x032), .O(new_n174_));
  nand2  g018(.a(new_n174_), .b(new_n157_), .O(new_n175_));
  nand3  g019(.a(new_n175_), .b(new_n173_), .c(new_n171_), .O(new_n176_));
  oai21  g020(.a(new_n176_), .b(new_n167_), .c(x040), .O(new_n177_));
  nor2   g021(.a(x077), .b(x048), .O(z17));
  ...
  nand2  g111(.a(new_n267_), .b(x048), .O(new_n268_));
  ...
  aoi21  g231(.a(new_n163_), .b(new_n172_), .c(new_n158_), .O(new_n389_));
  ...
  nand3  g237(.a(new_n394_), .b(new_n390_), .c(new_n159_), .O(new_n395_));
  nand2  g238(.a(x112), .b(x104), .O(new_n396_));
  nand3  g239(.a(new_n396_), .b(x120), .c(new_n158_), .O(new_n397_));
  nand3  g240(.a(x096), .b(x064), .c(new_n163_), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n397_), .c(new_n162_), .O(new_n399_));
  inv1   g242(.a(new_n399_), .O(new_n400_));
  aoi21  g243(.a(new_n400_), .b(new_n395_), .c(x072), .O(new_n401_));
  nor2   g244(.a(new_n162_), .b(x032), .O(new_n402_));
  oai21  g245(.a(new_n402_), .b(new_n401_), .c(x000), .O(new_n403_));
  nand2  g246(.a(x064), .b(new_n163_), .O(new_n404_));
  aoi21  g247(.a(new_n404_), .b(new_n168_), .c(new_n161_), .O(new_n405_));
  nand3  g248(.a(new_n387_), .b(new_n159_), .c(x024), .O(new_n406_));
  aoi21  g249(.a(new_n406_), .b(new_n158_), .c(x080), .O(new_n407_));
  oai21  g250(.a(new_n407_), .b(new_n405_), .c(new_n164_), .O(new_n408_));
  oai21  g251(.a(x080), .b(new_n172_), .c(new_n408_), .O(new_n409_));
  oai21  g252(.a(x112), .b(x104), .c(new_n409_), .O(new_n410_));
  oai21  g253(.a(new_n391_), .b(x016), .c(new_n393_), .O(new_n411_));
  nand3  g254(.a(new_n411_), .b(new_n162_), .c(new_n164_), .O(new_n412_));
  nor2   g255(.a(x072), .b(new_n163_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(x008), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(x016), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n412_), .c(new_n159_), .O(new_n416_));
  oai21  g259(.a(x064), .b(x008), .c(x016), .O(new_n417_));
  nand2  g260(.a(new_n417_), .b(x024), .O(new_n418_));
  nor4   g261(.a(new_n418_), .b(new_n388_), .c(x080), .d(x072), .O(new_n419_));
  nor2   g262(.a(new_n419_), .b(new_n416_), .O(new_n420_));
  nand3  g263(.a(new_n420_), .b(new_n410_), .c(new_n403_), .O(new_n421_));
  aoi21  g264(.a(new_n418_), .b(new_n393_), .c(x080), .O(new_n422_));
  nor3   g265(.a(new_n392_), .b(x064), .c(new_n161_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n422_), .c(new_n413_), .O(new_n424_));
  nand3  g267(.a(new_n164_), .b(x064), .c(x016), .O(new_n425_));
  nand3  g268(.a(x080), .b(new_n172_), .c(x000), .O(new_n426_));
  nand3  g269(.a(new_n426_), .b(new_n425_), .c(new_n163_), .O(new_n427_));
  aoi22  g270(.a(new_n427_), .b(x048), .c(x072), .d(x008), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n424_), .O(new_n429_));
  aoi21  g272(.a(new_n421_), .b(new_n157_), .c(new_n429_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(x040), .c(new_n179_), .O(z08));
  ...
  aoi22  g303(.a(new_n460_), .b(x011), .c(x051), .d(new_n222_), .O(new_n461_));
  ...
  oai21  g308(.a(new_n463_), .b(new_n459_), .c(new_n234_), .O(new_n466_));
  aoi21  g309(.a(x051), .b(x035), .c(new_n231_), .O(new_n467_));
  nand4  g310(.a(new_n467_), .b(new_n466_), .c(new_n465_), .d(new_n462_), .O(new_n468_));
  inv1   g311(.a(new_n468_), .O(new_n469_));
  nor3   g312(.a(new_n469_), .b(z17), .c(x043), .O(z11));
  ...
  inv1   g326(.a(new_n300_), .O(new_n484_));
  nand2  g327(.a(x069), .b(new_n294_), .O(new_n485_));
  aoi21  g328(.a(new_n485_), .b(new_n261_), .c(new_n292_), .O(new_n486_));
  nand3  g329(.a(new_n293_), .b(new_n270_), .c(x029), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n280_), .c(x085), .O(new_n488_));
  oai21  g331(.a(new_n488_), .b(new_n486_), .c(new_n258_), .O(new_n489_));
  nand2  g332(.a(new_n274_), .b(x013), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n489_), .c(new_n484_), .O(new_n491_));
  aoi21  g334(.a(x029), .b(new_n280_), .c(new_n278_), .O(new_n492_));
  oai21  g335(.a(x069), .b(x013), .c(x021), .O(new_n493_));
  nand2  g336(.a(new_n299_), .b(new_n302_), .O(new_n494_));
  nand4  g337(.a(new_n494_), .b(new_n493_), .c(new_n293_), .d(x029), .O(new_n495_));
  oai21  g338(.a(new_n492_), .b(new_n270_), .c(new_n495_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n274_), .O(new_n497_));
  oai21  g340(.a(x037), .b(x013), .c(x021), .O(new_n498_));
  nand3  g341(.a(new_n277_), .b(new_n276_), .c(new_n275_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n498_), .O(new_n500_));
  oai22  g343(.a(new_n293_), .b(new_n280_), .c(x125), .d(x101), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n500_), .c(x069), .O(new_n502_));
  nand3  g345(.a(x101), .b(x069), .c(new_n294_), .O(new_n503_));
  nand3  g346(.a(new_n269_), .b(x125), .c(new_n280_), .O(new_n504_));
  nand3  g347(.a(new_n504_), .b(new_n503_), .c(new_n274_), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n502_), .c(x005), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n497_), .c(x077), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(new_n491_), .c(new_n259_), .O(new_n508_));
  nand2  g351(.a(new_n494_), .b(x005), .O(new_n509_));
  nand3  g352(.a(new_n274_), .b(x029), .c(new_n262_), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n509_), .c(x069), .O(new_n511_));
  nor2   g354(.a(new_n492_), .b(x085), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(new_n511_), .c(x037), .O(new_n513_));
  oai21  g356(.a(new_n274_), .b(new_n292_), .c(new_n272_), .O(new_n514_));
  aoi21  g357(.a(new_n259_), .b(x037), .c(new_n272_), .O(new_n515_));
  oai21  g358(.a(new_n515_), .b(new_n262_), .c(new_n514_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n513_), .O(new_n517_));
  nor2   g360(.a(new_n259_), .b(new_n294_), .O(new_n518_));
  aoi21  g361(.a(new_n517_), .b(new_n258_), .c(new_n518_), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n508_), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(x048), .O(new_n521_));
  nor3   g364(.a(new_n274_), .b(x037), .c(new_n292_), .O(new_n522_));
  nor2   g365(.a(new_n518_), .b(x013), .O(new_n523_));
  oai21  g366(.a(new_n272_), .b(x053), .c(new_n523_), .O(new_n524_));
  oai21  g367(.a(new_n524_), .b(new_n522_), .c(x077), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n521_), .c(x045), .O(z13));
  inv1   g369(.a(x046), .O(new_n527_));
  nand2  g370(.a(x070), .b(new_n379_), .O(new_n528_));
  aoi21  g371(.a(new_n528_), .b(new_n364_), .c(new_n345_), .O(new_n529_));
  nand2  g372(.a(x094), .b(x062), .O(new_n530_));
  nand3  g373(.a(new_n530_), .b(new_n323_), .c(x030), .O(new_n531_));
  aoi21  g374(.a(new_n531_), .b(new_n339_), .c(x086), .O(new_n532_));
  oai21  g375(.a(new_n532_), .b(new_n529_), .c(new_n357_), .O(new_n533_));
  aoi21  g376(.a(x030), .b(new_n339_), .c(new_n331_), .O(new_n534_));
  oai21  g377(.a(x070), .b(x014), .c(x022), .O(new_n535_));
  nand2  g378(.a(new_n355_), .b(new_n353_), .O(new_n536_));
  nand4  g379(.a(new_n536_), .b(new_n535_), .c(new_n530_), .d(x030), .O(new_n537_));
  oai21  g380(.a(new_n534_), .b(new_n323_), .c(new_n537_), .O(new_n538_));
  nand2  g381(.a(new_n538_), .b(new_n327_), .O(new_n539_));
  oai21  g382(.a(x038), .b(x014), .c(x022), .O(new_n540_));
  oai21  g383(.a(new_n331_), .b(x030), .c(new_n540_), .O(new_n541_));
  oai21  g384(.a(new_n530_), .b(new_n339_), .c(new_n536_), .O(new_n542_));
  aoi21  g385(.a(new_n542_), .b(new_n541_), .c(x070), .O(new_n543_));
  nand3  g386(.a(x102), .b(x070), .c(new_n379_), .O(new_n544_));
  nand3  g387(.a(new_n322_), .b(x126), .c(new_n339_), .O(new_n545_));
  nand3  g388(.a(new_n545_), .b(new_n544_), .c(new_n327_), .O(new_n546_));
  oai21  g389(.a(new_n546_), .b(new_n543_), .c(x006), .O(new_n547_));
  nand3  g390(.a(new_n547_), .b(new_n539_), .c(new_n533_), .O(new_n548_));
  oai22  g391(.a(new_n375_), .b(new_n356_), .c(new_n325_), .d(new_n363_), .O(new_n549_));
  aoi21  g392(.a(new_n548_), .b(new_n363_), .c(new_n549_), .O(new_n550_));
  nand2  g393(.a(new_n536_), .b(x006), .O(new_n551_));
  nand3  g394(.a(new_n327_), .b(x030), .c(new_n338_), .O(new_n552_));
  ...
  oai21  g399(.a(new_n556_), .b(x014), .c(new_n325_), .O(new_n557_));
  nand2  g400(.a(new_n557_), .b(new_n346_), .O(new_n558_));
  nand2  g401(.a(new_n558_), .b(new_n555_), .O(new_n559_));
  oai21  g402(.a(new_n556_), .b(x038), .c(new_n338_), .O(new_n560_));
  nand2  g403(.a(new_n560_), .b(x078), .O(new_n561_));
  oai21  g404(.a(new_n321_), .b(new_n379_), .c(new_n561_), .O(new_n562_));
  aoi21  g405(.a(new_n559_), .b(new_n363_), .c(new_n562_), .O(new_n563_));
  ...
  zero   g415(.O(z26));
  zero   g416(.O(z27));
  nor2   g417(.a(x077), .b(x048), .O(z18));
  nor2   g418(.a(x077), .b(x048), .O(z21));
  nor2   g419(.a(x077), .b(x048), .O(z22));
  nor2   g420(.a(x077), .b(x048), .O(z24));
  nor2   g421(.a(x077), .b(x048), .O(z25));
endmodule
