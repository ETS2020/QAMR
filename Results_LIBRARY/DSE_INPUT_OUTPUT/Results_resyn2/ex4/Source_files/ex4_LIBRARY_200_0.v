...
module FAU ( 
  ...
  aoi22  g273(.a(new_n429_), .b(x009), .c(x049), .d(new_n184_), .O(new_n430_));
  ...
  oai21  g278(.a(new_n432_), .b(new_n428_), .c(new_n196_), .O(new_n435_));
  aoi21  g279(.a(x049), .b(x033), .c(new_n193_), .O(new_n436_));
  ...
  nor3   g295(.a(new_n451_), .b(z07), .c(x042), .O(z10));
  ...
  nor2   g387(.a(x077), .b(x045), .O(z25));
  nor2   g388(.a(x077), .b(x045), .O(z26));
  nor2   g389(.a(x077), .b(x045), .O(z27));
endmodule
