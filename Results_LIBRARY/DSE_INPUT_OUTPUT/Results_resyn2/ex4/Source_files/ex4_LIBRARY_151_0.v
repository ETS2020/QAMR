...
module FAU ( 
  ...
  nor2   g038(.a(z15), .b(x042), .O(new_n195_));
  ...
  nor3   g053(.a(new_n209_), .b(new_n208_), .c(z15), .O(new_n210_));
  ...
  nor2   g057(.a(z15), .b(x043), .O(new_n214_));
  ...
  nor3   g072(.a(new_n228_), .b(new_n227_), .c(z15), .O(new_n229_));
  ...
  nand2  g281(.a(new_n438_), .b(new_n178_), .O(z09));
  ...
  oai21  g291(.a(new_n446_), .b(new_n441_), .c(new_n209_), .O(new_n449_));
  aoi21  g292(.a(x050), .b(x034), .c(new_n206_), .O(new_n450_));
  nand4  g293(.a(new_n450_), .b(new_n449_), .c(new_n448_), .d(new_n445_), .O(new_n451_));
  and2   g294(.a(new_n451_), .b(new_n195_), .O(z10));
  ...
  oai21  g316(.a(new_n471_), .b(new_n467_), .c(new_n248_), .O(new_n474_));
  aoi21  g317(.a(x052), .b(x036), .c(new_n245_), .O(new_n475_));
  ...
  zero   g376(.O(z21));
  zero   g377(.O(z25));
  nor2   g378(.a(x077), .b(x045), .O(z16));
  nor2   g379(.a(x077), .b(x045), .O(z17));
  nor2   g380(.a(x077), .b(x045), .O(z18));
  nor2   g381(.a(x077), .b(x045), .O(z19));
  nor2   g382(.a(x077), .b(x045), .O(z22));
  nor2   g383(.a(x077), .b(x045), .O(z23));
  nor2   g384(.a(x077), .b(x045), .O(z24));
  nor2   g385(.a(x077), .b(x045), .O(z26));
