...
module FAU ( 
  ...
  nand2  g020(.a(x077), .b(x047), .O(new_n177_));
  ...
  oai21  g057(.a(new_n213_), .b(new_n201_), .c(new_n177_), .O(z02));
  ...
  oai21  g071(.a(new_n227_), .b(new_n215_), .c(new_n177_), .O(z03));
  ...
  oai21  g085(.a(new_n241_), .b(new_n229_), .c(new_n177_), .O(z04));
  ...
  nand2  g206(.a(new_n177_), .b(x046), .O(new_n363_));
  ...
  nand2  g260(.a(new_n416_), .b(new_n177_), .O(z08));
  ...
  oai21  g270(.a(new_n424_), .b(new_n419_), .c(new_n194_), .O(new_n427_));
  aoi21  g271(.a(x049), .b(x033), .c(new_n192_), .O(new_n428_));
  nand4  g272(.a(new_n428_), .b(new_n427_), .c(new_n426_), .d(new_n423_), .O(new_n429_));
  and2   g273(.a(new_n429_), .b(new_n181_), .O(z09));
  ...
  nand3  g309(.a(new_n465_), .b(new_n463_), .c(new_n238_), .O(new_n466_));
  nand2  g310(.a(new_n464_), .b(new_n461_), .O(new_n467_));
  nand2  g311(.a(new_n462_), .b(x012), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n467_), .c(new_n237_), .O(new_n469_));
  ...
  nand2  g317(.a(new_n473_), .b(new_n229_), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n177_), .O(z12));
  inv1   g319(.a(x045), .O(new_n476_));
  oai21  g320(.a(new_n246_), .b(x021), .c(new_n254_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(x069), .O(new_n478_));
  nand2  g322(.a(x093), .b(x061), .O(new_n479_));
  oai21  g323(.a(x069), .b(x013), .c(x021), .O(new_n480_));
  nand2  g324(.a(new_n268_), .b(new_n264_), .O(new_n481_));
  ...
  nand3  g330(.a(new_n486_), .b(new_n485_), .c(new_n246_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n484_), .O(new_n488_));
  oai22  g332(.a(new_n479_), .b(new_n251_), .c(x125), .d(x101), .O(new_n489_));
  ...
  nand3  g336(.a(new_n274_), .b(x125), .c(new_n251_), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n492_), .c(new_n244_), .O(new_n494_));
  inv1   g338(.a(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n491_), .c(new_n287_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n483_), .c(new_n275_), .O(new_n497_));
  inv1   g341(.a(new_n267_), .O(new_n498_));
  ...
  nand3  g345(.a(new_n479_), .b(new_n245_), .c(x029), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n251_), .c(x085), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n501_), .c(new_n275_), .O(new_n504_));
  ...
  nand3  g352(.a(new_n244_), .b(x029), .c(new_n250_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n508_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n245_), .O(new_n511_));
  nand2  g355(.a(new_n477_), .b(new_n244_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n511_), .c(new_n298_), .O(new_n513_));
  nand3  g357(.a(x085), .b(new_n250_), .c(x005), .O(new_n514_));
  aoi22  g358(.a(new_n514_), .b(new_n276_), .c(x037), .d(x013), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n513_), .c(new_n275_), .O(new_n516_));
  nand2  g360(.a(x085), .b(x005), .O(new_n517_));
  oai21  g361(.a(new_n517_), .b(x037), .c(new_n250_), .O(new_n518_));
  ...
  nand2  g365(.a(new_n521_), .b(new_n177_), .O(z13));
  ...
  nand2  g406(.a(new_n177_), .b(new_n562_), .O(new_n563_));
  ...
  zero   g412(.O(z25));
  zero   g413(.O(z26));
  inv1   g414(.a(new_n177_), .O(z15));
  inv1   g415(.a(new_n177_), .O(z17));
  inv1   g416(.a(new_n177_), .O(z19));
  inv1   g417(.a(new_n177_), .O(z20));
  inv1   g418(.a(new_n177_), .O(z21));
  inv1   g419(.a(new_n177_), .O(z22));
  inv1   g420(.a(new_n177_), .O(z27));
endmodule
