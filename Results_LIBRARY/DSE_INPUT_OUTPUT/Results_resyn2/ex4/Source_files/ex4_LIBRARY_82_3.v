// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:23 2020
...
module FAU ( 
  ...
  nor2   g082(.a(z17), .b(x044), .O(new_n239_));
  ...
  nor2   g096(.a(new_n252_), .b(z17), .O(new_n253_));
  ...
  aoi21  g181(.a(new_n169_), .b(new_n170_), .c(new_n158_), .O(new_n339_));
  ...
  oai21  g202(.a(new_n359_), .b(new_n352_), .c(new_n336_), .O(new_n360_));
  or2    g203(.a(x112), .b(x104), .O(new_n361_));
  nand2  g204(.a(new_n173_), .b(x008), .O(new_n362_));
  nand2  g205(.a(x064), .b(new_n169_), .O(new_n363_));
  aoi21  g206(.a(new_n363_), .b(new_n160_), .c(new_n172_), .O(new_n364_));
  nand3  g207(.a(new_n337_), .b(new_n159_), .c(x024), .O(new_n365_));
  aoi21  g208(.a(new_n365_), .b(new_n158_), .c(x080), .O(new_n366_));
  oai21  g209(.a(new_n366_), .b(new_n364_), .c(new_n336_), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n362_), .O(new_n368_));
  nor2   g211(.a(new_n159_), .b(new_n158_), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(x072), .O(new_n370_));
  inv1   g213(.a(new_n370_), .O(new_n371_));
  aoi21  g214(.a(new_n368_), .b(new_n361_), .c(new_n371_), .O(new_n372_));
  aoi21  g215(.a(new_n372_), .b(new_n360_), .c(x048), .O(new_n373_));
  nand2  g216(.a(new_n356_), .b(x000), .O(new_n374_));
  nand3  g217(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n375_));
  aoi21  g218(.a(new_n375_), .b(new_n374_), .c(x064), .O(new_n376_));
  inv1   g219(.a(new_n354_), .O(new_n377_));
  aoi21  g220(.a(new_n377_), .b(new_n344_), .c(x080), .O(new_n378_));
  oai21  g221(.a(new_n378_), .b(new_n376_), .c(x032), .O(new_n379_));
  inv1   g222(.a(new_n369_), .O(new_n380_));
  nand2  g223(.a(x080), .b(x000), .O(new_n381_));
  nand2  g224(.a(new_n381_), .b(new_n380_), .O(new_n382_));
  aoi21  g225(.a(new_n157_), .b(x032), .c(new_n380_), .O(new_n383_));
  oai21  g226(.a(new_n383_), .b(new_n170_), .c(new_n382_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n379_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n336_), .O(new_n386_));
  oai21  g229(.a(new_n381_), .b(x032), .c(new_n170_), .O(new_n387_));
  aoi22  g230(.a(new_n387_), .b(x072), .c(x048), .d(x032), .O(new_n388_));
  nand2  g231(.a(new_n388_), .b(new_n386_), .O(new_n389_));
  oai21  g232(.a(new_n389_), .b(new_n373_), .c(new_n335_), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n177_), .O(z08));
  nand2  g234(.a(x065), .b(x017), .O(new_n392_));
  inv1   g235(.a(new_n392_), .O(new_n393_));
  nand2  g236(.a(x081), .b(x001), .O(new_n394_));
  aoi22  g237(.a(new_n394_), .b(x009), .c(x049), .d(new_n183_), .O(new_n395_));
  oai21  g238(.a(new_n393_), .b(x009), .c(new_n395_), .O(new_n396_));
  inv1   g239(.a(new_n394_), .O(new_n397_));
  aoi21  g240(.a(new_n392_), .b(x009), .c(x033), .O(new_n398_));
  oai21  g241(.a(new_n397_), .b(x009), .c(new_n398_), .O(new_n399_));
  oai21  g242(.a(new_n397_), .b(new_n393_), .c(new_n195_), .O(new_n400_));
  aoi21  g243(.a(x049), .b(x033), .c(new_n192_), .O(new_n401_));
  nand4  g244(.a(new_n401_), .b(new_n400_), .c(new_n399_), .d(new_n396_), .O(new_n402_));
  inv1   g245(.a(new_n402_), .O(new_n403_));
  nor3   g246(.a(new_n403_), .b(z17), .c(x041), .O(z09));
  nand2  g247(.a(x066), .b(x018), .O(new_n405_));
  inv1   g248(.a(new_n405_), .O(new_n406_));
  inv1   g249(.a(x034), .O(new_n407_));
  nand2  g250(.a(x082), .b(x002), .O(new_n408_));
  aoi22  g251(.a(new_n408_), .b(x010), .c(x050), .d(new_n407_), .O(new_n409_));
  oai21  g252(.a(new_n406_), .b(x010), .c(new_n409_), .O(new_n410_));
  inv1   g253(.a(new_n408_), .O(new_n411_));
  aoi21  g254(.a(new_n405_), .b(x010), .c(x034), .O(new_n412_));
  oai21  g255(.a(new_n411_), .b(x010), .c(new_n412_), .O(new_n413_));
  oai21  g256(.a(new_n411_), .b(new_n406_), .c(new_n213_), .O(new_n414_));
  aoi21  g257(.a(x050), .b(x034), .c(new_n211_), .O(new_n415_));
  nand4  g258(.a(new_n415_), .b(new_n414_), .c(new_n413_), .d(new_n410_), .O(new_n416_));
  and2   g259(.a(new_n416_), .b(new_n200_), .O(z10));
  nand2  g260(.a(x067), .b(x019), .O(new_n418_));
  inv1   g261(.a(new_n418_), .O(new_n419_));
  nand2  g262(.a(x083), .b(x003), .O(new_n420_));
  aoi22  g263(.a(new_n420_), .b(x011), .c(x051), .d(new_n223_), .O(new_n421_));
  oai21  g264(.a(new_n419_), .b(x011), .c(new_n421_), .O(new_n422_));
  inv1   g265(.a(new_n420_), .O(new_n423_));
  aoi21  g266(.a(new_n418_), .b(x011), .c(x035), .O(new_n424_));
  oai21  g267(.a(new_n423_), .b(x011), .c(new_n424_), .O(new_n425_));
  oai21  g268(.a(new_n423_), .b(new_n419_), .c(new_n235_), .O(new_n426_));
  aoi21  g269(.a(x051), .b(x035), .c(new_n232_), .O(new_n427_));
  nand4  g270(.a(new_n427_), .b(new_n426_), .c(new_n425_), .d(new_n422_), .O(new_n428_));
  inv1   g271(.a(new_n428_), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(x043), .c(new_n177_), .O(z11));
  nand2  g273(.a(x068), .b(x020), .O(new_n431_));
  inv1   g274(.a(new_n431_), .O(new_n432_));
  inv1   g275(.a(x036), .O(new_n433_));
  nand2  g276(.a(x084), .b(x004), .O(new_n434_));
  aoi22  g277(.a(new_n434_), .b(x012), .c(x052), .d(new_n433_), .O(new_n435_));
  oai21  g278(.a(new_n432_), .b(x012), .c(new_n435_), .O(new_n436_));
  inv1   g279(.a(new_n434_), .O(new_n437_));
  aoi21  g280(.a(new_n431_), .b(x012), .c(x036), .O(new_n438_));
  oai21  g281(.a(new_n437_), .b(x012), .c(new_n438_), .O(new_n439_));
  oai21  g282(.a(new_n437_), .b(new_n432_), .c(new_n252_), .O(new_n440_));
  aoi21  g283(.a(x052), .b(x036), .c(new_n250_), .O(new_n441_));
  nand4  g284(.a(new_n441_), .b(new_n440_), .c(new_n439_), .d(new_n436_), .O(new_n442_));
  and2   g285(.a(new_n442_), .b(new_n239_), .O(z12));
  inv1   g286(.a(x053), .O(new_n444_));
  inv1   g287(.a(x005), .O(new_n445_));
  nand2  g288(.a(x069), .b(new_n259_), .O(new_n446_));
  aoi21  g289(.a(new_n446_), .b(new_n262_), .c(new_n445_), .O(new_n447_));
  nand2  g290(.a(x093), .b(x061), .O(new_n448_));
  nand3  g291(.a(new_n448_), .b(new_n261_), .c(x029), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n260_), .c(x085), .O(new_n450_));
  ...
  nand3  g306(.a(x101), .b(x069), .c(new_n259_), .O(new_n464_));
  nand2  g307(.a(x117), .b(x109), .O(new_n465_));
  nand3  g308(.a(new_n465_), .b(x125), .c(new_n260_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n464_), .c(new_n266_), .O(new_n467_));
  ...
  nand2  g316(.a(new_n266_), .b(x013), .O(new_n474_));
  oai22  g317(.a(new_n474_), .b(new_n472_), .c(new_n473_), .d(new_n269_), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n471_), .c(new_n444_), .O(new_n476_));
  nand2  g319(.a(new_n457_), .b(x005), .O(new_n477_));
  nand3  g320(.a(new_n266_), .b(x029), .c(new_n265_), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n477_), .c(x069), .O(new_n479_));
  and2   g322(.a(new_n454_), .b(new_n266_), .O(new_n480_));
  ...
  aoi21  g326(.a(new_n444_), .b(x037), .c(new_n473_), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n265_), .c(new_n483_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n481_), .O(new_n486_));
  oai21  g329(.a(new_n482_), .b(x037), .c(new_n265_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(x077), .O(new_n488_));
  oai21  g331(.a(new_n444_), .b(new_n259_), .c(new_n488_), .O(new_n489_));
  aoi21  g332(.a(new_n486_), .b(new_n269_), .c(new_n489_), .O(new_n490_));
