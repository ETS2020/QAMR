...
module FAU ( 
  ...
  aoi21  g325(.a(x052), .b(x036), .c(new_n249_), .O(new_n482_));
  nand4  g326(.a(new_n482_), .b(new_n481_), .c(new_n480_), .d(new_n477_), .O(new_n483_));
  and2   g327(.a(new_n483_), .b(new_n238_), .O(z12));
  ...
  zero   g423(.O(z24));
  zero   g424(.O(z26));
  nor2   g425(.a(x077), .b(x060), .O(z17));
  nor2   g426(.a(x077), .b(x060), .O(z18));
  nor2   g427(.a(x077), .b(x060), .O(z19));
  nor2   g428(.a(x077), .b(x060), .O(z21));
  nor2   g429(.a(x077), .b(x060), .O(z22));
  nor2   g430(.a(x077), .b(x060), .O(z25));
