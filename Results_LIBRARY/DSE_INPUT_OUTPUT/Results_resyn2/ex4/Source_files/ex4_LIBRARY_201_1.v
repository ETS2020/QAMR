// Benchmark "FAU" written by ABC on Wed Aug 12 10:08:56 2020
...
module FAU ( 
  ...
  oai21  g126(.a(new_n272_), .b(new_n265_), .c(new_n282_), .O(new_n283_));
  oai21  g127(.a(new_n268_), .b(x021), .c(new_n275_), .O(new_n284_));
  aoi21  g128(.a(new_n284_), .b(new_n283_), .c(new_n260_), .O(new_n285_));
  inv1   g129(.a(x101), .O(new_n286_));
  nand3  g130(.a(new_n286_), .b(new_n260_), .c(x037), .O(new_n287_));
  ...
  nand3  g136(.a(new_n292_), .b(new_n278_), .c(new_n271_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(x077), .O(new_n294_));
  nor2   g138(.a(x069), .b(x021), .O(new_n295_));
  nor2   g139(.a(new_n264_), .b(x013), .O(new_n296_));
  aoi22  g140(.a(new_n296_), .b(new_n259_), .c(new_n295_), .d(new_n177_), .O(new_n297_));
  nand2  g141(.a(new_n297_), .b(new_n294_), .O(new_n298_));
  nand2  g142(.a(new_n298_), .b(x053), .O(new_n299_));
  inv1   g143(.a(x037), .O(new_n300_));
  nand2  g144(.a(new_n275_), .b(new_n279_), .O(new_n301_));
  ...
  aoi22  g152(.a(new_n308_), .b(x013), .c(new_n307_), .d(new_n295_), .O(new_n309_));
  nand2  g153(.a(new_n309_), .b(new_n305_), .O(new_n310_));
  inv1   g154(.a(x013), .O(new_n311_));
  aoi21  g155(.a(new_n308_), .b(x037), .c(new_n311_), .O(new_n312_));
  oai22  g156(.a(new_n312_), .b(x077), .c(x053), .d(x037), .O(new_n313_));
  aoi21  g157(.a(new_n310_), .b(x077), .c(new_n313_), .O(new_n314_));
  aoi21  g158(.a(new_n314_), .b(new_n299_), .c(new_n258_), .O(z05));
  ...
  oai21  g238(.a(new_n394_), .b(new_n389_), .c(new_n159_), .O(new_n395_));
  ...
  oai22  g251(.a(new_n407_), .b(new_n404_), .c(new_n406_), .d(new_n405_), .O(new_n408_));
  oai21  g252(.a(new_n408_), .b(new_n403_), .c(new_n157_), .O(new_n409_));
  nand2  g253(.a(new_n389_), .b(x000), .O(new_n410_));
  nand3  g254(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n411_));
  aoi21  g255(.a(new_n411_), .b(new_n410_), .c(x064), .O(new_n412_));
  and2   g256(.a(new_n386_), .b(new_n173_), .O(new_n413_));
  ...
  aoi21  g266(.a(new_n419_), .b(new_n404_), .c(new_n422_), .O(new_n423_));
  ...
  aoi22  g286(.a(new_n442_), .b(x010), .c(x050), .d(new_n204_), .O(new_n443_));
  ...
  oai21  g291(.a(new_n445_), .b(new_n441_), .c(new_n216_), .O(new_n448_));
  aoi21  g292(.a(x050), .b(x034), .c(new_n213_), .O(new_n449_));
  ...
  aoi22  g299(.a(new_n455_), .b(x011), .c(x051), .d(new_n223_), .O(new_n456_));
  ...
  oai21  g304(.a(new_n458_), .b(new_n454_), .c(new_n235_), .O(new_n461_));
  aoi21  g305(.a(x051), .b(x035), .c(new_n232_), .O(new_n462_));
  nand4  g306(.a(new_n462_), .b(new_n461_), .c(new_n460_), .d(new_n457_), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(x043), .c(new_n179_), .O(z11));
  ...
  oai21  g321(.a(new_n477_), .b(x044), .c(new_n179_), .O(z12));
  inv1   g322(.a(x053), .O(new_n479_));
  oai22  g323(.a(new_n306_), .b(new_n280_), .c(new_n268_), .d(x029), .O(new_n480_));
  nand2  g324(.a(new_n288_), .b(new_n286_), .O(new_n481_));
  oai21  g325(.a(new_n272_), .b(new_n280_), .c(new_n481_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n480_), .c(x069), .O(new_n483_));
  nand3  g327(.a(x101), .b(x069), .c(new_n300_), .O(new_n484_));
  nand3  g328(.a(new_n259_), .b(x125), .c(new_n280_), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(new_n484_), .c(new_n264_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n483_), .c(x005), .O(new_n487_));
  aoi21  g331(.a(x069), .b(new_n300_), .c(new_n295_), .O(new_n488_));
  nor2   g332(.a(new_n488_), .b(new_n279_), .O(new_n489_));
  nand3  g333(.a(new_n272_), .b(new_n260_), .c(x029), .O(new_n490_));
  nor2   g334(.a(x021), .b(x013), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n490_), .c(x085), .O(new_n492_));
  oai21  g336(.a(new_n492_), .b(new_n489_), .c(new_n289_), .O(new_n493_));
  aoi21  g337(.a(x029), .b(new_n280_), .c(new_n268_), .O(new_n494_));
  oai21  g338(.a(x069), .b(x013), .c(x021), .O(new_n495_));
  nand4  g339(.a(new_n495_), .b(new_n481_), .c(new_n272_), .d(x029), .O(new_n496_));
  oai21  g340(.a(new_n494_), .b(new_n260_), .c(new_n496_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n264_), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n493_), .c(new_n487_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n479_), .O(new_n500_));
  nand2  g344(.a(new_n481_), .b(x005), .O(new_n501_));
  nand3  g345(.a(new_n264_), .b(x029), .c(new_n311_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n501_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n260_), .O(new_n504_));
  inv1   g348(.a(new_n494_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n264_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n504_), .c(new_n479_), .O(new_n507_));
  nand3  g351(.a(x085), .b(new_n311_), .c(x005), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n262_), .O(new_n509_));
  oai21  g353(.a(new_n281_), .b(x053), .c(new_n509_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n177_), .O(new_n511_));
  aoi21  g355(.a(new_n507_), .b(x037), .c(new_n511_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n500_), .c(x045), .O(z13));
  inv1   g357(.a(x046), .O(new_n514_));
  oai21  g358(.a(new_n319_), .b(x022), .c(new_n327_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(x070), .O(new_n516_));
  nand2  g360(.a(x094), .b(x062), .O(new_n517_));
  oai21  g361(.a(x070), .b(x014), .c(x022), .O(new_n518_));
  nand2  g362(.a(new_n341_), .b(new_n337_), .O(new_n519_));
  nand4  g363(.a(new_n519_), .b(new_n518_), .c(new_n517_), .d(x030), .O(new_n520_));
  aoi21  g364(.a(new_n520_), .b(new_n516_), .c(x086), .O(new_n521_));
  oai21  g365(.a(x038), .b(x014), .c(x022), .O(new_n522_));
  inv1   g366(.a(x062), .O(new_n523_));
  inv1   g367(.a(x094), .O(new_n524_));
  nand3  g368(.a(new_n524_), .b(new_n523_), .c(new_n319_), .O(new_n525_));
  nand2  g369(.a(new_n525_), .b(new_n522_), .O(new_n526_));
  oai22  g370(.a(new_n517_), .b(new_n324_), .c(x126), .d(x102), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n526_), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n318_), .O(new_n529_));
  nand3  g373(.a(x102), .b(x070), .c(new_n371_), .O(new_n530_));
  nand3  g374(.a(new_n347_), .b(x126), .c(new_n324_), .O(new_n531_));
  nand3  g375(.a(new_n531_), .b(new_n530_), .c(new_n317_), .O(new_n532_));
  inv1   g376(.a(new_n532_), .O(new_n533_));
  aoi21  g377(.a(new_n533_), .b(new_n529_), .c(new_n360_), .O(new_n534_));
  oai21  g378(.a(new_n534_), .b(new_n521_), .c(new_n348_), .O(new_n535_));
  inv1   g379(.a(new_n340_), .O(new_n536_));
  inv1   g380(.a(new_n349_), .O(new_n537_));
  nand2  g381(.a(x070), .b(new_n371_), .O(new_n538_));
  aoi21  g382(.a(new_n538_), .b(new_n356_), .c(new_n360_), .O(new_n539_));
  nand3  g383(.a(new_n517_), .b(new_n318_), .c(x030), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n324_), .c(x086), .O(new_n541_));
  oai21  g385(.a(new_n541_), .b(new_n539_), .c(new_n348_), .O(new_n542_));
  nand2  g386(.a(new_n542_), .b(new_n367_), .O(new_n543_));
  aoi22  g387(.a(new_n543_), .b(new_n536_), .c(new_n537_), .d(x078), .O(new_n544_));
  aoi21  g388(.a(new_n544_), .b(new_n535_), .c(x054), .O(new_n545_));
  nand2  g389(.a(new_n519_), .b(x006), .O(new_n546_));
  nand3  g390(.a(new_n317_), .b(x030), .c(new_n323_), .O(new_n547_));
  nand2  g391(.a(new_n547_), .b(new_n546_), .O(new_n548_));
  nand2  g392(.a(new_n548_), .b(new_n318_), .O(new_n549_));
  nand2  g393(.a(new_n515_), .b(new_n317_), .O(new_n550_));
  aoi21  g394(.a(new_n550_), .b(new_n549_), .c(new_n371_), .O(new_n551_));
  nand3  g395(.a(x086), .b(new_n323_), .c(x006), .O(new_n552_));
  aoi22  g396(.a(new_n552_), .b(new_n349_), .c(x038), .d(x014), .O(new_n553_));
  oai21  g397(.a(new_n553_), .b(new_n551_), .c(new_n348_), .O(new_n554_));
  nand2  g398(.a(x086), .b(x006), .O(new_n555_));
  oai21  g399(.a(new_n555_), .b(x038), .c(new_n323_), .O(new_n556_));
  aoi22  g400(.a(new_n556_), .b(x078), .c(x054), .d(x038), .O(new_n557_));
  nand2  g401(.a(new_n557_), .b(new_n554_), .O(new_n558_));
  oai21  g402(.a(new_n558_), .b(new_n545_), .c(new_n514_), .O(new_n559_));
  nand2  g403(.a(new_n559_), .b(new_n179_), .O(z14));
  zero   g404(.O(z15));
  zero   g405(.O(z16));
  zero   g406(.O(z17));
  zero   g407(.O(z19));
  ...
  zero   g411(.O(z25));
  zero   g412(.O(z27));
  nor2   g413(.a(new_n177_), .b(x045), .O(z18));
  nor2   g414(.a(new_n177_), .b(x045), .O(z21));
  nor2   g415(.a(new_n177_), .b(x045), .O(z24));
  nor2   g416(.a(new_n177_), .b(x045), .O(z26));
endmodule
