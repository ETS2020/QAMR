...
module FAU ( 
  ...
  zero   g418(.O(z24));
  zero   g419(.O(z27));
  nor2   g420(.a(x114), .b(new_n178_), .O(z17));
  nor2   g421(.a(x114), .b(new_n178_), .O(z18));
  nor2   g422(.a(x114), .b(new_n178_), .O(z19));
  nor2   g423(.a(x114), .b(new_n178_), .O(z20));
  nor2   g424(.a(x114), .b(new_n178_), .O(z21));
  nor2   g425(.a(x114), .b(new_n178_), .O(z22));
  nor2   g426(.a(x114), .b(new_n178_), .O(z25));
  nor2   g427(.a(x114), .b(new_n178_), .O(z26));
endmodule
