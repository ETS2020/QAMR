// Benchmark "FAU" written by ABC on Wed Aug 12 10:10:22 2020
...
module FAU ( 
  ...
  aoi22  g106(.a(new_n262_), .b(new_n178_), .c(new_n256_), .d(new_n255_), .O(new_n263_));
  inv1   g107(.a(x005), .O(new_n264_));
  inv1   g108(.a(x069), .O(new_n265_));
  inv1   g109(.a(x029), .O(new_n266_));
  nor2   g110(.a(new_n255_), .b(new_n259_), .O(new_n267_));
  nand2  g111(.a(x093), .b(x061), .O(new_n268_));
  oai22  g112(.a(new_n268_), .b(new_n266_), .c(new_n267_), .d(x021), .O(new_n269_));
  ...
  aoi21  g117(.a(new_n273_), .b(new_n269_), .c(new_n265_), .O(new_n274_));
  ...
  nand3  g122(.a(new_n278_), .b(new_n265_), .c(x037), .O(new_n279_));
  nand3  g123(.a(new_n279_), .b(new_n277_), .c(x085), .O(new_n280_));
  oai21  g124(.a(new_n280_), .b(new_n274_), .c(new_n264_), .O(new_n281_));
  nand2  g125(.a(x117), .b(x109), .O(new_n282_));
  nand2  g126(.a(new_n265_), .b(x037), .O(new_n283_));
  nand2  g127(.a(x069), .b(x021), .O(new_n284_));
  aoi21  g128(.a(new_n284_), .b(new_n283_), .c(x005), .O(new_n285_));
  inv1   g129(.a(x085), .O(new_n286_));
  nand3  g130(.a(new_n272_), .b(x069), .c(new_n266_), .O(new_n287_));
  inv1   g131(.a(x021), .O(new_n288_));
  nor2   g132(.a(new_n288_), .b(new_n259_), .O(new_n289_));
  aoi21  g133(.a(new_n289_), .b(new_n287_), .c(new_n286_), .O(new_n290_));
  oai21  g134(.a(new_n290_), .b(new_n285_), .c(new_n282_), .O(new_n291_));
  aoi21  g135(.a(new_n266_), .b(x021), .c(new_n268_), .O(new_n292_));
  aoi21  g136(.a(x069), .b(x013), .c(x021), .O(new_n293_));
  nand3  g137(.a(new_n272_), .b(new_n270_), .c(new_n266_), .O(new_n294_));
  oai22  g138(.a(new_n294_), .b(new_n293_), .c(new_n292_), .d(x069), .O(new_n295_));
  nand2  g139(.a(new_n295_), .b(x085), .O(new_n296_));
  nand3  g140(.a(new_n296_), .b(new_n291_), .c(new_n281_), .O(new_n297_));
  nand2  g141(.a(new_n270_), .b(new_n264_), .O(new_n298_));
  nand3  g142(.a(x085), .b(new_n266_), .c(x013), .O(new_n299_));
  aoi21  g143(.a(new_n299_), .b(new_n298_), .c(new_n265_), .O(new_n300_));
  oai21  g144(.a(new_n292_), .b(new_n286_), .c(x053), .O(new_n301_));
  oai21  g145(.a(new_n301_), .b(new_n300_), .c(new_n255_), .O(new_n302_));
  oai21  g146(.a(new_n260_), .b(new_n257_), .c(x013), .O(new_n303_));
  oai21  g147(.a(new_n256_), .b(x037), .c(new_n257_), .O(new_n304_));
  nand4  g148(.a(new_n304_), .b(new_n303_), .c(new_n302_), .d(x045), .O(new_n305_));
  aoi21  g149(.a(new_n297_), .b(x053), .c(new_n305_), .O(new_n306_));
  oai22  g150(.a(new_n306_), .b(new_n178_), .c(new_n263_), .d(new_n254_), .O(z05));
  ...
  aoi21  g221(.a(new_n169_), .b(new_n157_), .c(new_n158_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(new_n377_), .O(new_n379_));
  inv1   g223(.a(x024), .O(new_n380_));
  nor2   g224(.a(x088), .b(x056), .O(new_n381_));
  nand4  g225(.a(new_n381_), .b(new_n374_), .c(new_n373_), .d(new_n380_), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(new_n379_), .c(new_n159_), .O(new_n383_));
  ...
  nand3  g230(.a(new_n386_), .b(new_n385_), .c(new_n172_), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n383_), .c(new_n372_), .O(new_n389_));
  oai21  g233(.a(new_n380_), .b(x016), .c(new_n381_), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(x064), .O(new_n391_));
  oai21  g235(.a(x064), .b(x008), .c(x016), .O(new_n392_));
  nand4  g236(.a(new_n392_), .b(new_n376_), .c(new_n375_), .d(x024), .O(new_n393_));
  aoi21  g237(.a(new_n393_), .b(new_n391_), .c(x080), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n389_), .c(new_n371_), .O(new_n395_));
  or2    g239(.a(x112), .b(x104), .O(new_n396_));
  nand2  g240(.a(x064), .b(new_n169_), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n160_), .c(new_n372_), .O(new_n398_));
  nand3  g242(.a(new_n376_), .b(new_n159_), .c(x024), .O(new_n399_));
  aoi21  g243(.a(new_n399_), .b(new_n158_), .c(x080), .O(new_n400_));
  oai21  g244(.a(new_n400_), .b(new_n398_), .c(new_n371_), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(new_n173_), .O(new_n402_));
  nand2  g246(.a(x064), .b(x016), .O(new_n403_));
  inv1   g247(.a(new_n403_), .O(new_n404_));
  aoi22  g248(.a(new_n404_), .b(x072), .c(new_n402_), .d(new_n396_), .O(new_n405_));
  aoi21  g249(.a(new_n405_), .b(new_n395_), .c(x048), .O(new_n406_));
  nand2  g250(.a(new_n375_), .b(x000), .O(new_n407_));
  nand3  g251(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n407_), .c(x064), .O(new_n409_));
  and2   g253(.a(new_n390_), .b(new_n172_), .O(new_n410_));
  ...
  aoi21  g257(.a(new_n170_), .b(x032), .c(new_n403_), .O(new_n414_));
  oai21  g258(.a(new_n414_), .b(new_n157_), .c(new_n413_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n411_), .O(new_n416_));
  nand2  g260(.a(new_n416_), .b(new_n371_), .O(new_n417_));
  oai21  g261(.a(new_n412_), .b(x032), .c(new_n157_), .O(new_n418_));
  ...
  inv1   g268(.a(x033), .O(new_n425_));
  nand2  g269(.a(x081), .b(x001), .O(new_n426_));
  aoi22  g270(.a(new_n426_), .b(x009), .c(x049), .d(new_n425_), .O(new_n427_));
  oai21  g271(.a(new_n424_), .b(x009), .c(new_n427_), .O(new_n428_));
  inv1   g272(.a(new_n426_), .O(new_n429_));
  aoi21  g273(.a(new_n423_), .b(x009), .c(x033), .O(new_n430_));
  oai21  g274(.a(new_n429_), .b(x009), .c(new_n430_), .O(new_n431_));
  oai21  g275(.a(new_n429_), .b(new_n424_), .c(new_n195_), .O(new_n432_));
  aoi21  g276(.a(x049), .b(x033), .c(new_n193_), .O(new_n433_));
  nand4  g277(.a(new_n433_), .b(new_n432_), .c(new_n431_), .d(new_n428_), .O(new_n434_));
  and2   g278(.a(new_n434_), .b(new_n182_), .O(z09));
  nand2  g279(.a(x066), .b(x018), .O(new_n436_));
  inv1   g280(.a(new_n436_), .O(new_n437_));
  nand2  g281(.a(x082), .b(x002), .O(new_n438_));
  aoi22  g282(.a(new_n438_), .b(x010), .c(x050), .d(new_n205_), .O(new_n439_));
  ...
  oai21  g287(.a(new_n441_), .b(new_n437_), .c(new_n217_), .O(new_n444_));
  aoi21  g288(.a(x050), .b(x034), .c(new_n214_), .O(new_n445_));
  ...
  oai21  g315(.a(new_n469_), .b(new_n465_), .c(new_n250_), .O(new_n472_));
  aoi21  g316(.a(x052), .b(x036), .c(new_n247_), .O(new_n473_));
  nand4  g317(.a(new_n473_), .b(new_n472_), .c(new_n471_), .d(new_n468_), .O(new_n474_));
  inv1   g318(.a(new_n474_), .O(new_n475_));
  oai21  g319(.a(new_n475_), .b(x044), .c(new_n180_), .O(z12));
  oai21  g320(.a(x037), .b(x013), .c(x021), .O(new_n477_));
  oai21  g321(.a(new_n272_), .b(x029), .c(new_n477_), .O(new_n478_));
  nand2  g322(.a(new_n275_), .b(new_n278_), .O(new_n479_));
  oai21  g323(.a(new_n268_), .b(new_n288_), .c(new_n479_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n478_), .c(x069), .O(new_n481_));
  nand3  g325(.a(new_n282_), .b(x125), .c(new_n288_), .O(new_n482_));
  nand3  g326(.a(x101), .b(x069), .c(new_n255_), .O(new_n483_));
  nand3  g327(.a(new_n483_), .b(new_n482_), .c(new_n286_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n481_), .c(x005), .O(new_n485_));
  nand2  g329(.a(x069), .b(new_n255_), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n258_), .c(new_n264_), .O(new_n487_));
  nand3  g331(.a(new_n268_), .b(new_n265_), .c(x029), .O(new_n488_));
  nor2   g332(.a(x021), .b(x013), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n488_), .c(x085), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n487_), .c(new_n276_), .O(new_n491_));
  oai21  g335(.a(new_n266_), .b(x021), .c(new_n271_), .O(new_n492_));
  and2   g336(.a(new_n492_), .b(x069), .O(new_n493_));
  oai21  g337(.a(x069), .b(x013), .c(x021), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n479_), .c(new_n268_), .d(x029), .O(new_n495_));
  inv1   g339(.a(new_n495_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n493_), .c(new_n286_), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n491_), .c(new_n485_), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n256_), .O(new_n499_));
  nand2  g343(.a(new_n479_), .b(x005), .O(new_n500_));
  nand3  g344(.a(new_n286_), .b(x029), .c(new_n259_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n265_), .O(new_n503_));
  aoi21  g347(.a(new_n492_), .b(new_n286_), .c(x053), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n503_), .O(new_n505_));
  nand3  g349(.a(x085), .b(new_n259_), .c(x005), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n284_), .O(new_n507_));
  nand2  g351(.a(new_n267_), .b(new_n256_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n178_), .O(new_n510_));
  aoi21  g354(.a(new_n505_), .b(x037), .c(new_n510_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n499_), .c(x045), .O(z13));
  inv1   g356(.a(x046), .O(new_n513_));
  oai21  g357(.a(new_n311_), .b(x022), .c(new_n319_), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(x070), .O(new_n515_));
  nand2  g359(.a(x094), .b(x062), .O(new_n516_));
  oai21  g360(.a(x070), .b(x014), .c(x022), .O(new_n517_));
  nand2  g361(.a(new_n333_), .b(new_n329_), .O(new_n518_));
  nand4  g362(.a(new_n518_), .b(new_n517_), .c(new_n516_), .d(x030), .O(new_n519_));
  aoi21  g363(.a(new_n519_), .b(new_n515_), .c(x086), .O(new_n520_));
  oai21  g364(.a(x038), .b(x014), .c(x022), .O(new_n521_));
  inv1   g365(.a(x062), .O(new_n522_));
  inv1   g366(.a(x094), .O(new_n523_));
  nand3  g367(.a(new_n523_), .b(new_n522_), .c(new_n311_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n521_), .O(new_n525_));
  oai22  g369(.a(new_n516_), .b(new_n316_), .c(x126), .d(x102), .O(new_n526_));
  nand2  g370(.a(new_n526_), .b(new_n525_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n310_), .O(new_n528_));
  nand3  g372(.a(x102), .b(x070), .c(new_n363_), .O(new_n529_));
  nand3  g373(.a(new_n339_), .b(x126), .c(new_n316_), .O(new_n530_));
  nand3  g374(.a(new_n530_), .b(new_n529_), .c(new_n309_), .O(new_n531_));
  inv1   g375(.a(new_n531_), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n528_), .c(new_n352_), .O(new_n533_));
  oai21  g377(.a(new_n533_), .b(new_n520_), .c(new_n340_), .O(new_n534_));
  inv1   g378(.a(new_n332_), .O(new_n535_));
  inv1   g379(.a(new_n341_), .O(new_n536_));
  nand2  g380(.a(x070), .b(new_n363_), .O(new_n537_));
  aoi21  g381(.a(new_n537_), .b(new_n348_), .c(new_n352_), .O(new_n538_));
  nand3  g382(.a(new_n516_), .b(new_n310_), .c(x030), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n316_), .c(x086), .O(new_n540_));
  oai21  g384(.a(new_n540_), .b(new_n538_), .c(new_n340_), .O(new_n541_));
  nand2  g385(.a(new_n541_), .b(new_n359_), .O(new_n542_));
  aoi22  g386(.a(new_n542_), .b(new_n535_), .c(new_n536_), .d(x078), .O(new_n543_));
  aoi21  g387(.a(new_n543_), .b(new_n534_), .c(x054), .O(new_n544_));
  nand2  g388(.a(new_n518_), .b(x006), .O(new_n545_));
  nand3  g389(.a(new_n309_), .b(x030), .c(new_n315_), .O(new_n546_));
  nand2  g390(.a(new_n546_), .b(new_n545_), .O(new_n547_));
  nand2  g391(.a(new_n547_), .b(new_n310_), .O(new_n548_));
  nand2  g392(.a(new_n514_), .b(new_n309_), .O(new_n549_));
  aoi21  g393(.a(new_n549_), .b(new_n548_), .c(new_n363_), .O(new_n550_));
  nand3  g394(.a(x086), .b(new_n315_), .c(x006), .O(new_n551_));
  aoi22  g395(.a(new_n551_), .b(new_n341_), .c(x038), .d(x014), .O(new_n552_));
  oai21  g396(.a(new_n552_), .b(new_n550_), .c(new_n340_), .O(new_n553_));
  nand2  g397(.a(x086), .b(x006), .O(new_n554_));
  oai21  g398(.a(new_n554_), .b(x038), .c(new_n315_), .O(new_n555_));
  aoi22  g399(.a(new_n555_), .b(x078), .c(x054), .d(x038), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n553_), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n544_), .c(new_n513_), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n180_), .O(z14));
  zero   g403(.O(z15));
  zero   g404(.O(z16));
  zero   g405(.O(z25));
  zero   g406(.O(z26));
  zero   g407(.O(z27));
  nor2   g408(.a(new_n178_), .b(x045), .O(z17));
  nor2   g409(.a(new_n178_), .b(x045), .O(z18));
  nor2   g410(.a(new_n178_), .b(x045), .O(z19));
  nor2   g411(.a(new_n178_), .b(x045), .O(z20));
  nor2   g412(.a(new_n178_), .b(x045), .O(z21));
  nor2   g413(.a(new_n178_), .b(x045), .O(z22));
  nor2   g414(.a(new_n178_), .b(x045), .O(z23));
  nor2   g415(.a(new_n178_), .b(x045), .O(z24));
endmodule
