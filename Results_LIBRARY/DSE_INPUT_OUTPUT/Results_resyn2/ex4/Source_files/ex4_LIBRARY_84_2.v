...
module FAU ( 
  ...
  nor2   g021(.a(x089), .b(new_n177_), .O(z15));
  ...
  nand3  g334(.a(new_n491_), .b(new_n490_), .c(new_n256_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n489_), .O(new_n493_));
  oai22  g336(.a(new_n484_), .b(new_n261_), .c(x125), .d(x101), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n255_), .O(new_n496_));
  nand3  g339(.a(x101), .b(x069), .c(new_n307_), .O(new_n497_));
  nand3  g340(.a(new_n284_), .b(x125), .c(new_n261_), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n497_), .c(new_n254_), .O(new_n499_));
  ...
  inv1   g345(.a(new_n277_), .O(new_n503_));
  ...
  nand3  g349(.a(new_n484_), .b(new_n255_), .c(x029), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n261_), .c(x085), .O(new_n508_));
  ...
  oai21  g365(.a(new_n522_), .b(x037), .c(new_n260_), .O(new_n523_));
  ...
  zero   g416(.O(z21));
  zero   g417(.O(z22));
  nor2   g418(.a(x089), .b(new_n177_), .O(z18));
  nor2   g419(.a(x089), .b(new_n177_), .O(z19));
  nor2   g420(.a(x089), .b(new_n177_), .O(z23));
  nor2   g421(.a(x089), .b(new_n177_), .O(z24));
  nor2   g422(.a(x089), .b(new_n177_), .O(z25));
  nor2   g423(.a(x089), .b(new_n177_), .O(z26));
  nor2   g424(.a(x089), .b(new_n177_), .O(z27));
endmodule
