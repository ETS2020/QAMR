// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:31 2020
...
module FAU ( 
  ...
  nor2   g002(.a(x077), .b(new_n158_), .O(z17));
  ...
  aoi21  g023(.a(new_n179_), .b(new_n161_), .c(z17), .O(new_n180_));
  ...
  nor2   g087(.a(new_n243_), .b(x036), .O(new_n244_));
  ...
  aoi22  g092(.a(new_n248_), .b(new_n246_), .c(new_n244_), .d(new_n242_), .O(new_n249_));
  nand2  g093(.a(new_n246_), .b(x052), .O(new_n250_));
  oai22  g094(.a(new_n250_), .b(new_n241_), .c(new_n249_), .d(x076), .O(new_n251_));
  nand2  g095(.a(new_n242_), .b(x036), .O(new_n252_));
  inv1   g096(.a(x012), .O(new_n253_));
  nand2  g097(.a(x052), .b(x036), .O(new_n254_));
  nand2  g098(.a(new_n254_), .b(new_n253_), .O(new_n255_));
  aoi21  g099(.a(new_n252_), .b(new_n250_), .c(new_n255_), .O(new_n256_));
  oai21  g100(.a(new_n252_), .b(new_n245_), .c(x077), .O(new_n257_));
  oai21  g101(.a(new_n257_), .b(new_n256_), .c(x076), .O(new_n258_));
  nand2  g102(.a(new_n258_), .b(x044), .O(new_n259_));
  aoi21  g103(.a(new_n251_), .b(x012), .c(new_n259_), .O(z04));
  ...
  oai21  g191(.a(new_n332_), .b(x022), .c(new_n339_), .O(new_n348_));
  ...
  nand3  g200(.a(new_n356_), .b(new_n342_), .c(new_n335_), .O(new_n357_));
  nand2  g201(.a(new_n357_), .b(x078), .O(new_n358_));
  inv1   g202(.a(x078), .O(new_n359_));
  nand2  g203(.a(new_n324_), .b(new_n344_), .O(new_n360_));
  inv1   g204(.a(new_n360_), .O(new_n361_));
  nor2   g205(.a(new_n328_), .b(x014), .O(new_n362_));
  aoi22  g206(.a(new_n362_), .b(new_n323_), .c(new_n361_), .d(new_n359_), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(new_n358_), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(x054), .O(new_n365_));
  inv1   g209(.a(x038), .O(new_n366_));
  nand2  g210(.a(new_n339_), .b(new_n343_), .O(new_n367_));
  ...
  aoi22  g218(.a(new_n374_), .b(new_n361_), .c(new_n373_), .d(new_n343_), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n371_), .c(new_n359_), .O(new_n376_));
  nor2   g220(.a(x054), .b(x038), .O(new_n377_));
  nand3  g221(.a(new_n328_), .b(x038), .c(new_n343_), .O(new_n378_));
  aoi21  g222(.a(new_n378_), .b(x014), .c(x078), .O(new_n379_));
  nor3   g223(.a(new_n379_), .b(new_n377_), .c(new_n376_), .O(new_n380_));
  nand2  g224(.a(new_n160_), .b(x046), .O(new_n381_));
  aoi21  g225(.a(new_n380_), .b(new_n365_), .c(new_n381_), .O(z06));
  nand2  g226(.a(new_n160_), .b(new_n157_), .O(new_n384_));
  nand2  g227(.a(x064), .b(new_n170_), .O(new_n385_));
  aoi21  g228(.a(new_n385_), .b(new_n165_), .c(new_n172_), .O(new_n386_));
  nand2  g229(.a(x088), .b(x056), .O(new_n387_));
  nand3  g230(.a(new_n387_), .b(new_n164_), .c(x024), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n163_), .c(x080), .O(new_n389_));
  ...
  oai21  g244(.a(new_n401_), .b(new_n396_), .c(new_n164_), .O(new_n402_));
  nand3  g245(.a(x096), .b(x064), .c(new_n170_), .O(new_n403_));
  ...
  oai22  g256(.a(new_n413_), .b(new_n179_), .c(new_n412_), .d(new_n411_), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(new_n410_), .c(new_n167_), .O(new_n415_));
  nand2  g258(.a(new_n396_), .b(x000), .O(new_n416_));
  nand3  g259(.a(new_n173_), .b(x024), .c(new_n161_), .O(new_n417_));
  aoi21  g260(.a(new_n417_), .b(new_n416_), .c(x064), .O(new_n418_));
  and2   g261(.a(new_n393_), .b(new_n173_), .O(new_n419_));
  ...
  aoi21  g265(.a(new_n167_), .b(x032), .c(new_n413_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n161_), .c(new_n422_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n420_), .O(new_n425_));
  oai21  g268(.a(new_n421_), .b(x032), .c(new_n161_), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(x072), .O(new_n427_));
  oai21  g270(.a(new_n167_), .b(new_n170_), .c(new_n427_), .O(new_n428_));
  aoi21  g271(.a(new_n425_), .b(new_n179_), .c(new_n428_), .O(new_n429_));
  aoi21  g272(.a(new_n429_), .b(new_n415_), .c(new_n384_), .O(z08));
  nand2  g273(.a(x065), .b(x017), .O(new_n431_));
  inv1   g274(.a(new_n431_), .O(new_n432_));
  nand2  g275(.a(x081), .b(x001), .O(new_n433_));
  aoi22  g276(.a(new_n433_), .b(x009), .c(x049), .d(new_n187_), .O(new_n434_));
  ...
  oai21  g294(.a(new_n449_), .b(new_n445_), .c(new_n218_), .O(new_n452_));
  aoi21  g295(.a(x050), .b(x034), .c(new_n215_), .O(new_n453_));
  ...
  aoi22  g302(.a(new_n459_), .b(x011), .c(x051), .d(new_n225_), .O(new_n460_));
  ...
  oai21  g307(.a(new_n462_), .b(new_n458_), .c(new_n237_), .O(new_n465_));
  aoi21  g308(.a(x051), .b(x035), .c(new_n234_), .O(new_n466_));
  ...
  nor2   g314(.a(new_n471_), .b(x036), .O(new_n472_));
  nand2  g315(.a(x068), .b(x020), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n244_), .c(new_n253_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n472_), .c(x076), .O(new_n475_));
  aoi21  g318(.a(new_n473_), .b(new_n471_), .c(x012), .O(new_n476_));
  oai22  g319(.a(new_n473_), .b(x036), .c(new_n471_), .d(x052), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(new_n476_), .c(new_n158_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n475_), .c(new_n254_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n470_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n160_), .O(z12));
  inv1   g324(.a(x045), .O(new_n482_));
  oai21  g325(.a(new_n264_), .b(x021), .c(new_n272_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(x069), .O(new_n484_));
  nand2  g327(.a(x093), .b(x061), .O(new_n485_));
  oai21  g328(.a(x069), .b(x013), .c(x021), .O(new_n486_));
  nand2  g329(.a(new_n286_), .b(new_n282_), .O(new_n487_));
  ...
  nand3  g335(.a(new_n492_), .b(new_n491_), .c(new_n264_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n490_), .O(new_n494_));
  oai22  g337(.a(new_n485_), .b(new_n269_), .c(x125), .d(x101), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n494_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n263_), .O(new_n497_));
  nand3  g340(.a(x101), .b(x069), .c(new_n316_), .O(new_n498_));
  nand3  g341(.a(new_n292_), .b(x125), .c(new_n269_), .O(new_n499_));
  nand3  g342(.a(new_n499_), .b(new_n498_), .c(new_n262_), .O(new_n500_));
  inv1   g343(.a(new_n500_), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n497_), .c(new_n305_), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n489_), .c(new_n293_), .O(new_n503_));
  inv1   g346(.a(new_n285_), .O(new_n504_));
  inv1   g347(.a(new_n294_), .O(new_n505_));
  nand2  g348(.a(x069), .b(new_n316_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n301_), .c(new_n305_), .O(new_n507_));
  nand3  g350(.a(new_n485_), .b(new_n263_), .c(x029), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n269_), .c(x085), .O(new_n509_));
  oai21  g352(.a(new_n509_), .b(new_n507_), .c(new_n293_), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n312_), .O(new_n511_));
  ...
  nand3  g357(.a(new_n262_), .b(x029), .c(new_n268_), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n514_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n263_), .O(new_n517_));
  nand2  g360(.a(new_n483_), .b(new_n262_), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n517_), .c(new_n316_), .O(new_n519_));
  nand3  g362(.a(x085), .b(new_n268_), .c(x005), .O(new_n520_));
  aoi22  g363(.a(new_n520_), .b(new_n294_), .c(x037), .d(x013), .O(new_n521_));
  oai21  g364(.a(new_n521_), .b(new_n519_), .c(new_n293_), .O(new_n522_));
  nand2  g365(.a(x085), .b(x005), .O(new_n523_));
  oai21  g366(.a(new_n523_), .b(x037), .c(new_n268_), .O(new_n524_));
  ...
  nand2  g370(.a(new_n527_), .b(new_n160_), .O(z13));
  ...
  nand3  g374(.a(new_n336_), .b(new_n324_), .c(x030), .O(new_n532_));
  aoi21  g375(.a(new_n532_), .b(new_n344_), .c(x086), .O(new_n533_));
  oai21  g376(.a(new_n533_), .b(new_n531_), .c(new_n353_), .O(new_n534_));
  aoi21  g377(.a(x030), .b(new_n344_), .c(new_n332_), .O(new_n535_));
  oai21  g378(.a(x070), .b(x014), .c(x022), .O(new_n536_));
  nand2  g379(.a(new_n352_), .b(new_n350_), .O(new_n537_));
  nand4  g380(.a(new_n537_), .b(new_n536_), .c(new_n336_), .d(x030), .O(new_n538_));
  oai21  g381(.a(new_n535_), .b(new_n324_), .c(new_n538_), .O(new_n539_));
  nand2  g382(.a(new_n539_), .b(new_n328_), .O(new_n540_));
  oai21  g383(.a(x038), .b(x014), .c(x022), .O(new_n541_));
  oai21  g384(.a(new_n332_), .b(x030), .c(new_n541_), .O(new_n542_));
  oai21  g385(.a(new_n336_), .b(new_n344_), .c(new_n537_), .O(new_n543_));
  aoi21  g386(.a(new_n543_), .b(new_n542_), .c(x070), .O(new_n544_));
  nand3  g387(.a(x102), .b(x070), .c(new_n366_), .O(new_n545_));
  nand3  g388(.a(new_n323_), .b(x126), .c(new_n344_), .O(new_n546_));
  ...
  inv1   g393(.a(new_n326_), .O(new_n551_));
  ...
  nand3  g398(.a(new_n328_), .b(x030), .c(new_n372_), .O(new_n556_));
  ...
  oai21  g403(.a(new_n560_), .b(x014), .c(new_n326_), .O(new_n561_));
  ...
  nand2  g411(.a(new_n160_), .b(new_n568_), .O(new_n569_));
  ...
  zero   g421(.O(z25));
  zero   g422(.O(z26));
  nor2   g423(.a(x077), .b(new_n158_), .O(z22));
  nor2   g424(.a(x077), .b(new_n158_), .O(z23));
  nor2   g425(.a(x077), .b(new_n158_), .O(z27));
endmodule
