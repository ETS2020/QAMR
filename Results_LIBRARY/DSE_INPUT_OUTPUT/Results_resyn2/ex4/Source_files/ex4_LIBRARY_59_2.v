// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:30 2020
...
module FAU ( 
  ...
  nand2  g138(.a(x069), .b(new_n264_), .O(new_n295_));
  oai21  g139(.a(new_n295_), .b(new_n272_), .c(x021), .O(new_n296_));
  aoi21  g140(.a(new_n296_), .b(x085), .c(new_n294_), .O(new_n297_));
  nand2  g141(.a(x085), .b(new_n268_), .O(new_n298_));
  oai21  g142(.a(new_n297_), .b(new_n158_), .c(new_n298_), .O(new_n299_));
  nand2  g143(.a(new_n263_), .b(new_n269_), .O(new_n300_));
  nor2   g144(.a(new_n300_), .b(x077), .O(new_n301_));
  aoi21  g145(.a(new_n299_), .b(new_n292_), .c(new_n301_), .O(new_n302_));
  aoi21  g146(.a(new_n302_), .b(new_n291_), .c(new_n261_), .O(new_n303_));
  inv1   g147(.a(x005), .O(new_n304_));
  nand2  g148(.a(new_n271_), .b(new_n304_), .O(new_n305_));
  nand3  g149(.a(x085), .b(new_n264_), .c(x013), .O(new_n306_));
  nand2  g150(.a(new_n306_), .b(new_n305_), .O(new_n307_));
  nand2  g151(.a(new_n307_), .b(x069), .O(new_n308_));
  nand2  g152(.a(new_n266_), .b(x085), .O(new_n309_));
  aoi21  g153(.a(new_n309_), .b(new_n308_), .c(x037), .O(new_n310_));
  nand2  g154(.a(new_n262_), .b(x013), .O(new_n311_));
  ...
  nand3  g159(.a(new_n262_), .b(x037), .c(new_n304_), .O(new_n316_));
  nand2  g160(.a(new_n316_), .b(x013), .O(new_n317_));
  aoi22  g161(.a(new_n317_), .b(new_n158_), .c(new_n261_), .d(new_n315_), .O(new_n318_));
  ...
  nand2  g226(.a(new_n382_), .b(new_n160_), .O(z06));
  ...
  oai21  g308(.a(new_n462_), .b(new_n458_), .c(new_n238_), .O(new_n465_));
  aoi21  g309(.a(x051), .b(x035), .c(new_n235_), .O(new_n466_));
  ...
  aoi22  g316(.a(new_n472_), .b(x012), .c(x052), .d(new_n245_), .O(new_n473_));
  ...
  nand3  g337(.a(new_n493_), .b(new_n492_), .c(new_n264_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n491_), .O(new_n495_));
  oai22  g339(.a(new_n486_), .b(new_n269_), .c(x125), .d(x101), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n495_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n263_), .O(new_n498_));
  nand3  g342(.a(x101), .b(x069), .c(new_n315_), .O(new_n499_));
  nand3  g343(.a(new_n292_), .b(x125), .c(new_n269_), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(new_n262_), .O(new_n501_));
  inv1   g345(.a(new_n501_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n498_), .c(new_n304_), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n490_), .c(new_n158_), .O(new_n504_));
  inv1   g348(.a(new_n285_), .O(new_n505_));
  inv1   g349(.a(new_n293_), .O(new_n506_));
  nand2  g350(.a(x069), .b(new_n315_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n300_), .c(new_n304_), .O(new_n508_));
  nand3  g352(.a(new_n486_), .b(new_n263_), .c(x029), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n269_), .c(x085), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n508_), .c(new_n158_), .O(new_n511_));
  ...
  nand3  g359(.a(new_n262_), .b(x029), .c(new_n268_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n263_), .O(new_n518_));
  nand2  g362(.a(new_n484_), .b(new_n262_), .O(new_n519_));
  aoi21  g363(.a(new_n519_), .b(new_n518_), .c(new_n315_), .O(new_n520_));
  nand3  g364(.a(x085), .b(new_n268_), .c(x005), .O(new_n521_));
  aoi22  g365(.a(new_n521_), .b(new_n293_), .c(x037), .d(x013), .O(new_n522_));
  oai21  g366(.a(new_n522_), .b(new_n520_), .c(new_n158_), .O(new_n523_));
  nand2  g367(.a(x085), .b(x005), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(x037), .c(new_n268_), .O(new_n525_));
  ...
  oai21  g374(.a(new_n325_), .b(x022), .c(new_n333_), .O(new_n531_));
  nand2  g375(.a(new_n531_), .b(x070), .O(new_n532_));
  nand2  g376(.a(x094), .b(x062), .O(new_n533_));
  oai21  g377(.a(x070), .b(x014), .c(x022), .O(new_n534_));
  nand2  g378(.a(new_n347_), .b(new_n343_), .O(new_n535_));
  nand4  g379(.a(new_n535_), .b(new_n534_), .c(new_n533_), .d(x030), .O(new_n536_));
  aoi21  g380(.a(new_n536_), .b(new_n532_), .c(x086), .O(new_n537_));
  oai21  g381(.a(x038), .b(x014), .c(x022), .O(new_n538_));
  inv1   g382(.a(x062), .O(new_n539_));
  inv1   g383(.a(x094), .O(new_n540_));
  nand3  g384(.a(new_n540_), .b(new_n539_), .c(new_n325_), .O(new_n541_));
  nand2  g385(.a(new_n541_), .b(new_n538_), .O(new_n542_));
  oai22  g386(.a(new_n533_), .b(new_n330_), .c(x126), .d(x102), .O(new_n543_));
  nand2  g387(.a(new_n543_), .b(new_n542_), .O(new_n544_));
  nand2  g388(.a(new_n544_), .b(new_n324_), .O(new_n545_));
  nand3  g389(.a(x102), .b(x070), .c(new_n377_), .O(new_n546_));
  nand3  g390(.a(new_n353_), .b(x126), .c(new_n330_), .O(new_n547_));
  nand3  g391(.a(new_n547_), .b(new_n546_), .c(new_n323_), .O(new_n548_));
  inv1   g392(.a(new_n548_), .O(new_n549_));
  aoi21  g393(.a(new_n549_), .b(new_n545_), .c(new_n366_), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(new_n537_), .c(new_n354_), .O(new_n551_));
  inv1   g395(.a(new_n346_), .O(new_n552_));
  inv1   g396(.a(new_n355_), .O(new_n553_));
  nand2  g397(.a(x070), .b(new_n377_), .O(new_n554_));
  aoi21  g398(.a(new_n554_), .b(new_n362_), .c(new_n366_), .O(new_n555_));
  nand3  g399(.a(new_n533_), .b(new_n324_), .c(x030), .O(new_n556_));
  aoi21  g400(.a(new_n556_), .b(new_n330_), .c(x086), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n555_), .c(new_n354_), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n373_), .O(new_n559_));
  aoi22  g403(.a(new_n559_), .b(new_n552_), .c(new_n553_), .d(x078), .O(new_n560_));
  aoi21  g404(.a(new_n560_), .b(new_n551_), .c(x054), .O(new_n561_));
  nand2  g405(.a(new_n535_), .b(x006), .O(new_n562_));
  nand3  g406(.a(new_n323_), .b(x030), .c(new_n329_), .O(new_n563_));
  nand2  g407(.a(new_n563_), .b(new_n562_), .O(new_n564_));
  nand2  g408(.a(new_n564_), .b(new_n324_), .O(new_n565_));
  nand2  g409(.a(new_n531_), .b(new_n323_), .O(new_n566_));
  aoi21  g410(.a(new_n566_), .b(new_n565_), .c(new_n377_), .O(new_n567_));
  nand3  g411(.a(x086), .b(new_n329_), .c(x006), .O(new_n568_));
  aoi22  g412(.a(new_n568_), .b(new_n355_), .c(x038), .d(x014), .O(new_n569_));
  oai21  g413(.a(new_n569_), .b(new_n567_), .c(new_n354_), .O(new_n570_));
  nand2  g414(.a(x086), .b(x006), .O(new_n571_));
  oai21  g415(.a(new_n571_), .b(x038), .c(new_n329_), .O(new_n572_));
  aoi22  g416(.a(new_n572_), .b(x078), .c(x054), .d(x038), .O(new_n573_));
  nand2  g417(.a(new_n573_), .b(new_n570_), .O(new_n574_));
  oai21  g418(.a(new_n574_), .b(new_n561_), .c(new_n530_), .O(new_n575_));
  nand2  g419(.a(new_n575_), .b(new_n160_), .O(z14));
  zero   g420(.O(z15));
  zero   g421(.O(z18));
  zero   g422(.O(z19));
  zero   g423(.O(z21));
  ...
  zero   g426(.O(z26));
  zero   g427(.O(z27));
  nor2   g428(.a(x106), .b(new_n158_), .O(z16));
  nor2   g429(.a(x106), .b(new_n158_), .O(z17));
  nor2   g430(.a(x106), .b(new_n158_), .O(z20));
  nor2   g431(.a(x106), .b(new_n158_), .O(z23));
  nor2   g432(.a(x106), .b(new_n158_), .O(z25));
endmodule
