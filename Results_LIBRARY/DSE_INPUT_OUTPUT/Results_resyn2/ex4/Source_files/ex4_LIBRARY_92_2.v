// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:33 2020
...
module FAU ( 
  ...
  aoi21  g109(.a(new_n265_), .b(new_n262_), .c(new_n257_), .O(new_n266_));
  oai21  g110(.a(new_n266_), .b(new_n256_), .c(new_n252_), .O(new_n267_));
  nand2  g111(.a(x093), .b(x061), .O(new_n268_));
  aoi21  g112(.a(new_n258_), .b(x021), .c(new_n268_), .O(new_n269_));
  oai21  g113(.a(new_n253_), .b(new_n263_), .c(new_n264_), .O(new_n270_));
  nand2  g114(.a(x125), .b(x101), .O(new_n271_));
  nand4  g115(.a(new_n271_), .b(new_n270_), .c(new_n261_), .d(new_n258_), .O(new_n272_));
  oai21  g116(.a(new_n269_), .b(x069), .c(new_n272_), .O(new_n273_));
  nand2  g117(.a(new_n273_), .b(x085), .O(new_n274_));
  inv1   g118(.a(x005), .O(new_n275_));
  inv1   g119(.a(x037), .O(new_n276_));
  nor2   g120(.a(new_n276_), .b(new_n263_), .O(new_n277_));
  oai22  g121(.a(new_n277_), .b(x021), .c(new_n268_), .d(new_n258_), .O(new_n278_));
  oai21  g122(.a(new_n261_), .b(x021), .c(new_n271_), .O(new_n279_));
  aoi21  g123(.a(new_n279_), .b(new_n278_), .c(new_n253_), .O(new_n280_));
  ...
  nand3  g128(.a(new_n284_), .b(new_n253_), .c(x037), .O(new_n285_));
  nand3  g129(.a(new_n285_), .b(new_n283_), .c(x085), .O(new_n286_));
  oai21  g130(.a(new_n286_), .b(new_n280_), .c(new_n275_), .O(new_n287_));
  nand3  g131(.a(new_n287_), .b(new_n274_), .c(new_n267_), .O(new_n288_));
  nand2  g132(.a(new_n288_), .b(x053), .O(new_n289_));
  nand2  g133(.a(new_n271_), .b(new_n275_), .O(new_n290_));
  nand3  g134(.a(x085), .b(new_n258_), .c(x013), .O(new_n291_));
  ...
  nor2   g140(.a(x085), .b(new_n263_), .O(new_n297_));
  nand2  g141(.a(new_n297_), .b(new_n275_), .O(new_n298_));
  nor2   g142(.a(x037), .b(x013), .O(new_n299_));
  nand2  g143(.a(new_n253_), .b(new_n264_), .O(new_n300_));
  oai21  g144(.a(new_n300_), .b(new_n299_), .c(new_n298_), .O(new_n301_));
  aoi21  g145(.a(new_n296_), .b(new_n276_), .c(new_n301_), .O(new_n302_));
  nand2  g146(.a(x077), .b(x045), .O(new_n303_));
  aoi21  g147(.a(new_n302_), .b(new_n289_), .c(new_n303_), .O(z05));
  ...
  aoi21  g219(.a(new_n169_), .b(new_n157_), .c(new_n158_), .O(new_n376_));
  nand2  g220(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  inv1   g221(.a(x024), .O(new_n378_));
  nor2   g222(.a(x088), .b(x056), .O(new_n379_));
  nand4  g223(.a(new_n379_), .b(new_n372_), .c(new_n371_), .d(new_n378_), .O(new_n380_));
  nand3  g224(.a(new_n380_), .b(new_n377_), .c(new_n159_), .O(new_n381_));
  ...
  nand3  g228(.a(new_n384_), .b(new_n383_), .c(new_n172_), .O(new_n385_));
  inv1   g229(.a(new_n385_), .O(new_n386_));
  aoi21  g230(.a(new_n386_), .b(new_n381_), .c(new_n370_), .O(new_n387_));
  oai21  g231(.a(new_n378_), .b(x016), .c(new_n379_), .O(new_n388_));
  nand2  g232(.a(new_n388_), .b(x064), .O(new_n389_));
  oai21  g233(.a(x064), .b(x008), .c(x016), .O(new_n390_));
  nand4  g234(.a(new_n390_), .b(new_n374_), .c(new_n373_), .d(x024), .O(new_n391_));
  aoi21  g235(.a(new_n391_), .b(new_n389_), .c(x080), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n387_), .c(new_n369_), .O(new_n393_));
  or2    g237(.a(x112), .b(x104), .O(new_n394_));
  nand2  g238(.a(x064), .b(new_n169_), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n160_), .c(new_n370_), .O(new_n396_));
  nand3  g240(.a(new_n374_), .b(new_n159_), .c(x024), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n158_), .c(x080), .O(new_n398_));
  oai21  g242(.a(new_n398_), .b(new_n396_), .c(new_n369_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(new_n173_), .O(new_n400_));
  nand2  g244(.a(x064), .b(x016), .O(new_n401_));
  inv1   g245(.a(new_n401_), .O(new_n402_));
  aoi22  g246(.a(new_n402_), .b(x072), .c(new_n400_), .d(new_n394_), .O(new_n403_));
  aoi21  g247(.a(new_n403_), .b(new_n393_), .c(x048), .O(new_n404_));
  nand2  g248(.a(new_n373_), .b(x000), .O(new_n405_));
  nand3  g249(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n406_));
  aoi21  g250(.a(new_n406_), .b(new_n405_), .c(x064), .O(new_n407_));
  and2   g251(.a(new_n388_), .b(new_n172_), .O(new_n408_));
  oai21  g252(.a(new_n408_), .b(new_n407_), .c(x032), .O(new_n409_));
  nand2  g253(.a(x080), .b(x000), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(new_n401_), .O(new_n411_));
  aoi21  g255(.a(new_n170_), .b(x032), .c(new_n401_), .O(new_n412_));
  oai21  g256(.a(new_n412_), .b(new_n157_), .c(new_n411_), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n409_), .O(new_n414_));
  nand2  g258(.a(new_n414_), .b(new_n369_), .O(new_n415_));
  oai21  g259(.a(new_n410_), .b(x032), .c(new_n157_), .O(new_n416_));
  aoi22  g260(.a(new_n416_), .b(x072), .c(x048), .d(x032), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n415_), .O(new_n418_));
  oai21  g262(.a(new_n418_), .b(new_n404_), .c(new_n368_), .O(new_n419_));
  nand2  g263(.a(new_n419_), .b(new_n179_), .O(z08));
  ...
  oai21  g287(.a(new_n441_), .b(new_n437_), .c(new_n210_), .O(new_n444_));
  aoi21  g288(.a(x050), .b(x034), .c(new_n207_), .O(new_n445_));
  ...
  aoi22  g308(.a(new_n464_), .b(x012), .c(x052), .d(new_n236_), .O(new_n465_));
  ...
  oai21  g313(.a(new_n467_), .b(new_n463_), .c(new_n248_), .O(new_n470_));
  aoi21  g314(.a(x052), .b(x036), .c(new_n245_), .O(new_n471_));
  ...
  inv1   g318(.a(x053), .O(new_n475_));
  nand2  g319(.a(x069), .b(new_n276_), .O(new_n476_));
  aoi21  g320(.a(new_n476_), .b(new_n300_), .c(new_n275_), .O(new_n477_));
  nand3  g321(.a(new_n268_), .b(new_n253_), .c(x029), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n264_), .c(x085), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n477_), .c(new_n282_), .O(new_n480_));
  aoi21  g324(.a(x029), .b(new_n264_), .c(new_n261_), .O(new_n481_));
  oai21  g325(.a(x069), .b(x013), .c(x021), .O(new_n482_));
  nand2  g326(.a(new_n281_), .b(new_n284_), .O(new_n483_));
  nand4  g327(.a(new_n483_), .b(new_n482_), .c(new_n268_), .d(x029), .O(new_n484_));
  oai21  g328(.a(new_n481_), .b(new_n253_), .c(new_n484_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n257_), .O(new_n486_));
  oai21  g330(.a(x037), .b(x013), .c(x021), .O(new_n487_));
  oai21  g331(.a(new_n261_), .b(x029), .c(new_n487_), .O(new_n488_));
  oai21  g332(.a(new_n268_), .b(new_n264_), .c(new_n483_), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n488_), .c(x069), .O(new_n490_));
  nand3  g334(.a(x101), .b(x069), .c(new_n276_), .O(new_n491_));
  nand3  g335(.a(new_n252_), .b(x125), .c(new_n264_), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n491_), .c(new_n257_), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n490_), .c(x005), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n486_), .c(new_n480_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n178_), .O(new_n496_));
  inv1   g340(.a(new_n255_), .O(new_n497_));
  aoi22  g341(.a(new_n297_), .b(new_n282_), .c(new_n497_), .d(x077), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n496_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n475_), .O(new_n500_));
  nand2  g344(.a(new_n483_), .b(x005), .O(new_n501_));
  nand3  g345(.a(new_n257_), .b(x029), .c(new_n263_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n501_), .c(x069), .O(new_n503_));
  nor2   g347(.a(new_n481_), .b(x085), .O(new_n504_));
  ...
  oai21  g352(.a(new_n508_), .b(new_n277_), .c(new_n505_), .O(new_n509_));
  oai21  g353(.a(new_n506_), .b(x037), .c(new_n263_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(x077), .O(new_n511_));
  oai21  g355(.a(new_n475_), .b(new_n276_), .c(new_n511_), .O(new_n512_));
  aoi21  g356(.a(new_n509_), .b(new_n178_), .c(new_n512_), .O(new_n513_));
  aoi21  g357(.a(new_n513_), .b(new_n500_), .c(x045), .O(z13));
  inv1   g358(.a(x046), .O(new_n515_));
  oai21  g359(.a(new_n308_), .b(x022), .c(new_n316_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(x070), .O(new_n517_));
  nand2  g361(.a(x094), .b(x062), .O(new_n518_));
  oai21  g362(.a(x070), .b(x014), .c(x022), .O(new_n519_));
  nand2  g363(.a(new_n330_), .b(new_n326_), .O(new_n520_));
  nand4  g364(.a(new_n520_), .b(new_n519_), .c(new_n518_), .d(x030), .O(new_n521_));
  aoi21  g365(.a(new_n521_), .b(new_n517_), .c(x086), .O(new_n522_));
  oai21  g366(.a(x038), .b(x014), .c(x022), .O(new_n523_));
  inv1   g367(.a(x062), .O(new_n524_));
  inv1   g368(.a(x094), .O(new_n525_));
  nand3  g369(.a(new_n525_), .b(new_n524_), .c(new_n308_), .O(new_n526_));
  nand2  g370(.a(new_n526_), .b(new_n523_), .O(new_n527_));
  oai22  g371(.a(new_n518_), .b(new_n313_), .c(x126), .d(x102), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n527_), .O(new_n529_));
  nand2  g373(.a(new_n529_), .b(new_n307_), .O(new_n530_));
  nand3  g374(.a(x102), .b(x070), .c(new_n360_), .O(new_n531_));
  nand3  g375(.a(new_n336_), .b(x126), .c(new_n313_), .O(new_n532_));
  nand3  g376(.a(new_n532_), .b(new_n531_), .c(new_n306_), .O(new_n533_));
  inv1   g377(.a(new_n533_), .O(new_n534_));
  aoi21  g378(.a(new_n534_), .b(new_n530_), .c(new_n349_), .O(new_n535_));
  oai21  g379(.a(new_n535_), .b(new_n522_), .c(new_n337_), .O(new_n536_));
  inv1   g380(.a(new_n329_), .O(new_n537_));
  inv1   g381(.a(new_n338_), .O(new_n538_));
  nand2  g382(.a(x070), .b(new_n360_), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n345_), .c(new_n349_), .O(new_n540_));
  nand3  g384(.a(new_n518_), .b(new_n307_), .c(x030), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n313_), .c(x086), .O(new_n542_));
  oai21  g386(.a(new_n542_), .b(new_n540_), .c(new_n337_), .O(new_n543_));
  nand2  g387(.a(new_n543_), .b(new_n356_), .O(new_n544_));
  aoi22  g388(.a(new_n544_), .b(new_n537_), .c(new_n538_), .d(x078), .O(new_n545_));
  aoi21  g389(.a(new_n545_), .b(new_n536_), .c(x054), .O(new_n546_));
  nand2  g390(.a(new_n520_), .b(x006), .O(new_n547_));
  nand3  g391(.a(new_n306_), .b(x030), .c(new_n312_), .O(new_n548_));
  nand2  g392(.a(new_n548_), .b(new_n547_), .O(new_n549_));
  nand2  g393(.a(new_n549_), .b(new_n307_), .O(new_n550_));
  nand2  g394(.a(new_n516_), .b(new_n306_), .O(new_n551_));
  aoi21  g395(.a(new_n551_), .b(new_n550_), .c(new_n360_), .O(new_n552_));
  nand3  g396(.a(x086), .b(new_n312_), .c(x006), .O(new_n553_));
  aoi22  g397(.a(new_n553_), .b(new_n338_), .c(x038), .d(x014), .O(new_n554_));
  oai21  g398(.a(new_n554_), .b(new_n552_), .c(new_n337_), .O(new_n555_));
  nand2  g399(.a(x086), .b(x006), .O(new_n556_));
  oai21  g400(.a(new_n556_), .b(x038), .c(new_n312_), .O(new_n557_));
  aoi22  g401(.a(new_n557_), .b(x078), .c(x054), .d(x038), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n555_), .O(new_n559_));
  oai21  g403(.a(new_n559_), .b(new_n546_), .c(new_n515_), .O(new_n560_));
  nand2  g404(.a(new_n560_), .b(new_n179_), .O(z14));
  zero   g405(.O(z15));
  zero   g406(.O(z16));
  zero   g407(.O(z18));
  zero   g408(.O(z19));
  ...
  zero   g410(.O(z22));
  zero   g411(.O(z23));
  inv1   g412(.a(new_n179_), .O(z17));
  inv1   g413(.a(new_n179_), .O(z21));
  inv1   g414(.a(new_n179_), .O(z24));
  inv1   g415(.a(new_n179_), .O(z25));
  inv1   g416(.a(new_n179_), .O(z26));
  inv1   g417(.a(new_n179_), .O(z27));
endmodule
