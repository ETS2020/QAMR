...
module FAU ( 
  ...
  aoi22  g293(.a(new_n449_), .b(x010), .c(x050), .d(new_n215_), .O(new_n450_));
  ...
  oai21  g310(.a(new_n464_), .b(new_n460_), .c(new_n237_), .O(new_n467_));
  aoi21  g311(.a(x051), .b(x035), .c(new_n234_), .O(new_n468_));
  ...
  nand3  g320(.a(new_n476_), .b(new_n474_), .c(new_n250_), .O(new_n477_));
  nand2  g321(.a(new_n475_), .b(new_n472_), .O(new_n478_));
  nand2  g322(.a(new_n473_), .b(x012), .O(new_n479_));
  nand3  g323(.a(new_n479_), .b(new_n478_), .c(new_n249_), .O(new_n480_));
  ...
  zero   g384(.O(z22));
  zero   g385(.O(z27));
  inv1   g386(.a(new_n179_), .O(z17));
  inv1   g387(.a(new_n179_), .O(z19));
  inv1   g388(.a(new_n179_), .O(z20));
  inv1   g389(.a(new_n179_), .O(z23));
