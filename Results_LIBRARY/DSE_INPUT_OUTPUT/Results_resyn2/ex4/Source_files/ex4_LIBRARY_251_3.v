// Benchmark "FAU" written by ABC on Wed Aug 12 10:10:20 2020
...
module FAU ( 
  ...
  nand2  g271(.a(new_n427_), .b(new_n181_), .O(z11));
  ...
  oai21  g315(.a(new_n471_), .b(new_n465_), .c(new_n179_), .O(new_n472_));
  ...
  oai21  g326(.a(new_n482_), .b(new_n478_), .c(new_n179_), .O(new_n483_));
  nand2  g327(.a(x053), .b(x037), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  oai21  g329(.a(new_n485_), .b(new_n473_), .c(new_n178_), .O(new_n486_));
  nor3   g330(.a(new_n258_), .b(x053), .c(new_n257_), .O(new_n487_));
  nand3  g331(.a(x085), .b(new_n264_), .c(x005), .O(new_n488_));
  nand4  g332(.a(new_n488_), .b(new_n484_), .c(new_n178_), .d(new_n262_), .O(new_n489_));
  ...
  nand2  g376(.a(new_n181_), .b(new_n532_), .O(new_n533_));
  aoi21  g377(.a(new_n531_), .b(new_n518_), .c(new_n533_), .O(z14));
  zero   g378(.O(z15));
  zero   g379(.O(z20));
  zero   g380(.O(z22));
  nor2   g381(.a(new_n179_), .b(new_n178_), .O(z16));
  ...
  nor2   g386(.a(new_n179_), .b(new_n178_), .O(z23));
