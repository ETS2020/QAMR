// Benchmark "FAU" written by ABC on Wed Aug 12 10:07:22 2020
...
module FAU ( 
  ...
  aoi22  g220(.a(new_n376_), .b(new_n363_), .c(new_n374_), .d(new_n343_), .O(new_n377_));
  aoi21  g221(.a(new_n377_), .b(new_n372_), .c(new_n361_), .O(new_n378_));
  ...
  aoi21  g235(.a(new_n169_), .b(new_n170_), .c(new_n158_), .O(new_n393_));
  ...
  nand3  g244(.a(new_n401_), .b(new_n400_), .c(new_n173_), .O(new_n402_));
  inv1   g245(.a(new_n402_), .O(new_n403_));
  aoi21  g246(.a(new_n403_), .b(new_n398_), .c(new_n172_), .O(new_n404_));
  ...
  oai21  g252(.a(new_n409_), .b(new_n404_), .c(new_n387_), .O(new_n410_));
  ...
  nand3  g257(.a(new_n391_), .b(new_n159_), .c(x024), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n158_), .c(x080), .O(new_n416_));
  oai21  g259(.a(new_n416_), .b(new_n414_), .c(new_n387_), .O(new_n417_));
  ...
  aoi21  g263(.a(new_n418_), .b(new_n411_), .c(new_n420_), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n410_), .c(x048), .O(new_n422_));
  nand2  g265(.a(new_n390_), .b(x000), .O(new_n423_));
  nand3  g266(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n424_));
  aoi21  g267(.a(new_n424_), .b(new_n423_), .c(x064), .O(new_n425_));
  and2   g268(.a(new_n405_), .b(new_n173_), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(new_n425_), .c(x032), .O(new_n427_));
  nand2  g270(.a(x064), .b(x016), .O(new_n428_));
  nand2  g271(.a(x080), .b(x000), .O(new_n429_));
  nand2  g272(.a(new_n429_), .b(new_n428_), .O(new_n430_));
  aoi21  g273(.a(new_n157_), .b(x032), .c(new_n428_), .O(new_n431_));
  oai21  g274(.a(new_n431_), .b(new_n170_), .c(new_n430_), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n427_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n387_), .O(new_n434_));
  ...
  oai21  g280(.a(new_n437_), .b(new_n422_), .c(new_n386_), .O(new_n438_));
  ...
  aoi22  g285(.a(new_n442_), .b(x009), .c(x049), .d(new_n185_), .O(new_n443_));
  ...
  oai21  g290(.a(new_n445_), .b(new_n441_), .c(new_n197_), .O(new_n448_));
  aoi21  g291(.a(x049), .b(x033), .c(new_n194_), .O(new_n449_));
  nand4  g292(.a(new_n449_), .b(new_n448_), .c(new_n447_), .d(new_n444_), .O(new_n450_));
  inv1   g293(.a(new_n450_), .O(new_n451_));
  oai21  g294(.a(new_n451_), .b(x041), .c(new_n179_), .O(z09));
  nand2  g295(.a(x066), .b(x018), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  nand2  g297(.a(x082), .b(x002), .O(new_n455_));
  aoi22  g298(.a(new_n455_), .b(x010), .c(x050), .d(new_n204_), .O(new_n456_));
  ...
  oai21  g329(.a(new_n484_), .b(new_n480_), .c(new_n255_), .O(new_n487_));
  aoi21  g330(.a(x052), .b(x036), .c(new_n252_), .O(new_n488_));
  nand4  g331(.a(new_n488_), .b(new_n487_), .c(new_n486_), .d(new_n483_), .O(new_n489_));
  inv1   g332(.a(new_n489_), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(x044), .c(new_n179_), .O(z12));
  nor2   g334(.a(x093), .b(x061), .O(new_n492_));
  oai21  g335(.a(new_n277_), .b(x021), .c(new_n492_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(x069), .O(new_n494_));
  nand2  g337(.a(x093), .b(x061), .O(new_n495_));
  oai21  g338(.a(x069), .b(x013), .c(x021), .O(new_n496_));
  nand2  g339(.a(new_n301_), .b(new_n304_), .O(new_n497_));
  nand4  g340(.a(new_n497_), .b(new_n496_), .c(new_n495_), .d(x029), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n494_), .c(x085), .O(new_n499_));
  oai21  g342(.a(x037), .b(x013), .c(x021), .O(new_n500_));
  nand3  g343(.a(new_n279_), .b(new_n278_), .c(new_n277_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  oai22  g345(.a(new_n495_), .b(new_n282_), .c(x125), .d(x101), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n272_), .O(new_n505_));
  nand3  g348(.a(x101), .b(x069), .c(new_n295_), .O(new_n506_));
  nand3  g349(.a(new_n271_), .b(x125), .c(new_n282_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n506_), .c(new_n276_), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n505_), .c(new_n294_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n499_), .c(new_n260_), .O(new_n511_));
  nand2  g354(.a(x069), .b(new_n295_), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(new_n263_), .c(new_n294_), .O(new_n513_));
  nand3  g356(.a(new_n495_), .b(new_n272_), .c(x029), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(new_n282_), .c(x085), .O(new_n515_));
  oai21  g358(.a(new_n515_), .b(new_n513_), .c(new_n260_), .O(new_n516_));
  nand2  g359(.a(new_n276_), .b(x013), .O(new_n517_));
  ...
  aoi21  g363(.a(new_n518_), .b(new_n302_), .c(new_n520_), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n511_), .c(x053), .O(new_n522_));
  nand2  g365(.a(new_n497_), .b(x005), .O(new_n523_));
  nand3  g366(.a(new_n276_), .b(x029), .c(new_n264_), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n523_), .O(new_n525_));
  nand2  g368(.a(new_n525_), .b(new_n272_), .O(new_n526_));
  nand2  g369(.a(new_n493_), .b(new_n276_), .O(new_n527_));
  aoi21  g370(.a(new_n527_), .b(new_n526_), .c(new_n295_), .O(new_n528_));
  nand3  g371(.a(x085), .b(new_n264_), .c(x005), .O(new_n529_));
  aoi22  g372(.a(new_n529_), .b(new_n274_), .c(x037), .d(x013), .O(new_n530_));
  oai21  g373(.a(new_n530_), .b(new_n528_), .c(new_n260_), .O(new_n531_));
  nand2  g374(.a(x085), .b(x005), .O(new_n532_));
  oai21  g375(.a(new_n532_), .b(x037), .c(new_n264_), .O(new_n533_));
  aoi22  g376(.a(new_n533_), .b(x077), .c(x053), .d(x037), .O(new_n534_));
  nand2  g377(.a(new_n534_), .b(new_n531_), .O(new_n535_));
  oai21  g378(.a(new_n535_), .b(new_n522_), .c(new_n259_), .O(new_n536_));
  nand2  g379(.a(new_n536_), .b(new_n179_), .O(z13));
  inv1   g380(.a(new_n383_), .O(new_n538_));
  inv1   g381(.a(x054), .O(new_n539_));
  aoi21  g382(.a(x030), .b(new_n345_), .c(new_n332_), .O(new_n540_));
  oai21  g383(.a(x070), .b(x014), .c(x022), .O(new_n541_));
  nand2  g384(.a(new_n354_), .b(new_n352_), .O(new_n542_));
  nand4  g385(.a(new_n542_), .b(new_n541_), .c(new_n336_), .d(x030), .O(new_n543_));
  oai21  g386(.a(new_n540_), .b(new_n324_), .c(new_n543_), .O(new_n544_));
  nand2  g387(.a(new_n544_), .b(new_n328_), .O(new_n545_));
  oai22  g388(.a(new_n375_), .b(new_n345_), .c(new_n332_), .d(x030), .O(new_n546_));
  oai21  g389(.a(new_n336_), .b(new_n345_), .c(new_n542_), .O(new_n547_));
  aoi21  g390(.a(new_n547_), .b(new_n546_), .c(x070), .O(new_n548_));
  nand3  g391(.a(x102), .b(x070), .c(new_n346_), .O(new_n549_));
  nand3  g392(.a(new_n323_), .b(x126), .c(new_n345_), .O(new_n550_));
  nand3  g393(.a(new_n550_), .b(new_n549_), .c(new_n328_), .O(new_n551_));
  oai21  g394(.a(new_n551_), .b(new_n548_), .c(x006), .O(new_n552_));
  aoi21  g395(.a(new_n552_), .b(new_n545_), .c(x078), .O(new_n553_));
  nand2  g396(.a(x070), .b(new_n346_), .O(new_n554_));
  aoi21  g397(.a(new_n554_), .b(new_n362_), .c(new_n343_), .O(new_n555_));
  nand3  g398(.a(new_n336_), .b(new_n324_), .c(x030), .O(new_n556_));
  aoi21  g399(.a(new_n556_), .b(new_n345_), .c(x086), .O(new_n557_));
  oai21  g400(.a(new_n557_), .b(new_n555_), .c(new_n361_), .O(new_n558_));
  nand2  g401(.a(new_n558_), .b(new_n373_), .O(new_n559_));
  nand2  g402(.a(new_n559_), .b(new_n355_), .O(new_n560_));
  oai21  g403(.a(new_n326_), .b(new_n361_), .c(new_n560_), .O(new_n561_));
  oai21  g404(.a(new_n561_), .b(new_n553_), .c(new_n539_), .O(new_n562_));
  nand2  g405(.a(new_n542_), .b(x006), .O(new_n563_));
  nand3  g406(.a(new_n328_), .b(x030), .c(new_n344_), .O(new_n564_));
  aoi21  g407(.a(new_n564_), .b(new_n563_), .c(x070), .O(new_n565_));
  nor2   g408(.a(new_n540_), .b(x086), .O(new_n566_));
  ...
  aoi21  g412(.a(new_n539_), .b(x038), .c(new_n326_), .O(new_n570_));
  oai21  g413(.a(new_n570_), .b(new_n344_), .c(new_n569_), .O(new_n571_));
  nand2  g414(.a(new_n571_), .b(new_n567_), .O(new_n572_));
  oai21  g415(.a(new_n568_), .b(x038), .c(new_n344_), .O(new_n573_));
  nand2  g416(.a(new_n573_), .b(x078), .O(new_n574_));
  nand2  g417(.a(x054), .b(x038), .O(new_n575_));
  nand3  g418(.a(new_n575_), .b(new_n574_), .c(new_n179_), .O(new_n576_));
  aoi21  g419(.a(new_n572_), .b(new_n361_), .c(new_n576_), .O(new_n577_));
  aoi21  g420(.a(new_n577_), .b(new_n562_), .c(new_n538_), .O(z14));
  zero   g421(.O(z07));
  zero   g422(.O(z16));
  zero   g423(.O(z17));
  zero   g424(.O(z19));
  ...
  nor2   g432(.a(new_n177_), .b(x077), .O(z26));
