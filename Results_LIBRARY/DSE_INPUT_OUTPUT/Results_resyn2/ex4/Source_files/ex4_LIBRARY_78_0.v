// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:18 2020
...
module FAU ( 
  ...
  aoi22  g301(.a(new_n457_), .b(x011), .c(x051), .d(new_n217_), .O(new_n458_));
  ...
  oai21  g306(.a(new_n460_), .b(new_n456_), .c(new_n229_), .O(new_n463_));
  ...
  nor2   g388(.a(x077), .b(x045), .O(z21));
  nor2   g389(.a(x077), .b(x045), .O(z22));
endmodule
