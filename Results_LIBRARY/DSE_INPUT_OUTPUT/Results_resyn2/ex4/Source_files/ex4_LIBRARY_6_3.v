...
module FAU ( 
  ...
  nand2  g020(.a(x092), .b(x077), .O(new_n177_));
  ...
  oai21  g314(.a(new_n468_), .b(new_n463_), .c(new_n233_), .O(new_n471_));
  aoi21  g315(.a(x051), .b(x035), .c(new_n231_), .O(new_n472_));
  nand4  g316(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n467_), .O(new_n473_));
  and2   g317(.a(new_n473_), .b(new_n220_), .O(z11));
  ...
  oai21  g330(.a(new_n486_), .b(x044), .c(new_n177_), .O(z12));
  ...
  zero   g423(.O(z24));
  zero   g424(.O(z25));
  inv1   g425(.a(new_n177_), .O(z15));
  inv1   g426(.a(new_n177_), .O(z18));
  inv1   g427(.a(new_n177_), .O(z20));
  inv1   g428(.a(new_n177_), .O(z21));
  inv1   g429(.a(new_n177_), .O(z26));
