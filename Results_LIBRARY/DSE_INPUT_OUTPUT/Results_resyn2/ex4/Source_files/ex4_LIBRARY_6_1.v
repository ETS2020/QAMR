// Benchmark "FAU" written by ABC on Wed Aug 12 10:03:11 2020
...
module FAU ( 
  ...
  nand2  g021(.a(x092), .b(new_n177_), .O(new_n178_));
  ...
  oai21  g326(.a(new_n480_), .b(new_n476_), .c(new_n256_), .O(new_n483_));
  aoi21  g327(.a(x052), .b(x036), .c(new_n253_), .O(new_n484_));
  nand4  g328(.a(new_n484_), .b(new_n483_), .c(new_n482_), .d(new_n479_), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(x044), .c(new_n178_), .O(z12));
  ...
  zero   g423(.O(z24));
  zero   g424(.O(z25));
  inv1   g425(.a(new_n178_), .O(z15));
  inv1   g426(.a(new_n178_), .O(z18));
  inv1   g427(.a(new_n178_), .O(z20));
  inv1   g428(.a(new_n178_), .O(z21));
  inv1   g429(.a(new_n178_), .O(z26));
