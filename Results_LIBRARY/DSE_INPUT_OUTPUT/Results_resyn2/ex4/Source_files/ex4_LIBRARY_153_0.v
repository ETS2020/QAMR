...
module FAU ( 
  ...
  aoi22  g144(.a(new_n300_), .b(new_n261_), .c(new_n299_), .d(new_n178_), .O(new_n301_));
  ...
  aoi21  g160(.a(new_n316_), .b(new_n303_), .c(new_n177_), .O(z05));
  ...
  aoi22  g295(.a(new_n451_), .b(x010), .c(x050), .d(new_n216_), .O(new_n452_));
  ...
  and2   g303(.a(new_n459_), .b(new_n203_), .O(z10));
  ...
  oai21  g316(.a(new_n472_), .b(x043), .c(new_n179_), .O(z11));
  ...
  nand2  g378(.a(new_n179_), .b(new_n534_), .O(new_n535_));
  ...
  zero   g386(.O(z23));
  zero   g387(.O(z25));
  inv1   g388(.a(new_n179_), .O(z16));
  inv1   g389(.a(new_n179_), .O(z20));
  inv1   g390(.a(new_n179_), .O(z24));
  inv1   g391(.a(new_n179_), .O(z26));
