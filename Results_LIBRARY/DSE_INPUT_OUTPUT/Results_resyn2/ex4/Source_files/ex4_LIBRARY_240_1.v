...
module FAU ( 
  ...
  nor2   g021(.a(new_n177_), .b(x060), .O(z07));
  ...
  nand3  g415(.a(new_n571_), .b(new_n570_), .c(new_n179_), .O(new_n572_));
  aoi21  g416(.a(new_n568_), .b(new_n359_), .c(new_n572_), .O(new_n573_));
  aoi22  g417(.a(new_n573_), .b(new_n558_), .c(new_n179_), .d(x046), .O(z14));
  zero   g418(.O(z15));
  zero   g419(.O(z16));
  zero   g420(.O(z20));
  zero   g421(.O(z23));
  zero   g422(.O(z24));
  zero   g423(.O(z26));
  nor2   g424(.a(new_n177_), .b(x060), .O(z17));
  nor2   g425(.a(new_n177_), .b(x060), .O(z18));
  nor2   g426(.a(new_n177_), .b(x060), .O(z19));
  nor2   g427(.a(new_n177_), .b(x060), .O(z21));
  nor2   g428(.a(new_n177_), .b(x060), .O(z22));
  nor2   g429(.a(new_n177_), .b(x060), .O(z25));
  nor2   g430(.a(new_n177_), .b(x060), .O(z27));
endmodule
