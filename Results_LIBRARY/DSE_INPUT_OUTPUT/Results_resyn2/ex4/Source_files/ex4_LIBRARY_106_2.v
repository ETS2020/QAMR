...
module FAU ( 
  ...
  aoi22  g088(.a(new_n244_), .b(new_n241_), .c(new_n243_), .d(x036), .O(new_n245_));
  ...
  nand2  g094(.a(new_n244_), .b(new_n248_), .O(new_n251_));
  nor2   g095(.a(new_n158_), .b(new_n241_), .O(new_n252_));
  ...
  nand3  g312(.a(x068), .b(x020), .c(new_n241_), .O(new_n469_));
  oai22  g313(.a(new_n469_), .b(x052), .c(new_n158_), .d(new_n241_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(x077), .O(new_n471_));
  nand2  g315(.a(x068), .b(x020), .O(new_n472_));
  nand2  g316(.a(x077), .b(new_n241_), .O(new_n473_));
  aoi21  g317(.a(new_n472_), .b(new_n243_), .c(new_n473_), .O(new_n474_));
  nand2  g318(.a(x084), .b(x004), .O(new_n475_));
  aoi21  g319(.a(new_n475_), .b(new_n243_), .c(x076), .O(new_n476_));
  ...
  oai21  g323(.a(new_n243_), .b(new_n241_), .c(new_n158_), .O(new_n480_));
  ...
  oai21  g350(.a(new_n506_), .b(new_n493_), .c(new_n290_), .O(new_n507_));
  ...
  oai21  g357(.a(new_n513_), .b(new_n511_), .c(new_n290_), .O(new_n514_));
  ...
  oai21  g369(.a(new_n525_), .b(new_n523_), .c(new_n290_), .O(new_n526_));
  ...
  nand2  g375(.a(new_n531_), .b(new_n160_), .O(z13));
  ...
  zero   g425(.O(z26));
  zero   g426(.O(z27));
  nor2   g427(.a(x077), .b(new_n158_), .O(z18));
  nor2   g428(.a(x077), .b(new_n158_), .O(z19));
