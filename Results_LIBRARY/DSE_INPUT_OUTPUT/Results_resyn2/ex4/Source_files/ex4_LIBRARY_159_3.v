...
module FAU ( 
  ...
  aoi22  g157(.a(new_n313_), .b(new_n177_), .c(new_n256_), .d(new_n312_), .O(new_n314_));
  ...
  nand4  g235(.a(new_n392_), .b(new_n385_), .c(new_n384_), .d(new_n391_), .O(new_n393_));
  nand3  g236(.a(new_n393_), .b(new_n390_), .c(new_n159_), .O(new_n394_));
  ...
  oai21  g243(.a(new_n391_), .b(x016), .c(new_n392_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(x064), .O(new_n402_));
  oai21  g245(.a(x064), .b(x008), .c(x016), .O(new_n403_));
  nand4  g246(.a(new_n403_), .b(new_n387_), .c(new_n386_), .d(x024), .O(new_n404_));
  aoi21  g247(.a(new_n404_), .b(new_n402_), .c(x080), .O(new_n405_));
  oai21  g248(.a(new_n405_), .b(new_n400_), .c(new_n383_), .O(new_n406_));
  ...
  nand3  g253(.a(new_n387_), .b(new_n159_), .c(x024), .O(new_n411_));
  ...
  aoi21  g268(.a(new_n157_), .b(x032), .c(new_n415_), .O(new_n426_));
  ...
  nand3  g282(.a(new_n439_), .b(new_n437_), .c(new_n192_), .O(new_n440_));
  nand2  g283(.a(new_n438_), .b(new_n435_), .O(new_n441_));
  nand2  g284(.a(new_n436_), .b(x009), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n441_), .c(new_n191_), .O(new_n443_));
  nand2  g286(.a(new_n438_), .b(new_n436_), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n184_), .O(new_n445_));
  ...
  nand2  g291(.a(new_n448_), .b(new_n180_), .O(z09));
  ...
  oai21  g301(.a(new_n456_), .b(new_n451_), .c(new_n210_), .O(new_n459_));
  aoi21  g302(.a(x050), .b(x034), .c(new_n208_), .O(new_n460_));
  nand4  g303(.a(new_n460_), .b(new_n459_), .c(new_n458_), .d(new_n455_), .O(new_n461_));
  and2   g304(.a(new_n461_), .b(new_n197_), .O(z10));
  ...
  oai21  g314(.a(new_n469_), .b(new_n464_), .c(new_n230_), .O(new_n472_));
  aoi21  g315(.a(x051), .b(x035), .c(new_n228_), .O(new_n473_));
  nand4  g316(.a(new_n473_), .b(new_n472_), .c(new_n471_), .d(new_n468_), .O(new_n474_));
  and2   g317(.a(new_n474_), .b(new_n217_), .O(z11));
  ...
  oai22  g335(.a(new_n492_), .b(new_n177_), .c(new_n256_), .d(new_n312_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n178_), .O(new_n494_));
