// Benchmark "FAU" written by ABC on Wed Aug 12 10:07:29 2020
...
module FAU ( 
  ...
  nor2   g021(.a(new_n177_), .b(x100), .O(z16));
  ...
  oai21  g120(.a(new_n266_), .b(new_n259_), .c(new_n276_), .O(new_n277_));
  oai21  g121(.a(new_n262_), .b(x021), .c(new_n269_), .O(new_n278_));
  aoi21  g122(.a(new_n278_), .b(new_n277_), .c(new_n254_), .O(new_n279_));
  inv1   g123(.a(x101), .O(new_n280_));
  nand3  g124(.a(new_n280_), .b(new_n254_), .c(x037), .O(new_n281_));
  ...
  oai21  g129(.a(new_n285_), .b(new_n279_), .c(new_n273_), .O(new_n286_));
  nand3  g130(.a(new_n286_), .b(new_n272_), .c(new_n265_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(x077), .O(new_n288_));
  inv1   g132(.a(x077), .O(new_n289_));
  nand2  g133(.a(new_n254_), .b(new_n274_), .O(new_n290_));
  inv1   g134(.a(new_n290_), .O(new_n291_));
  nor2   g135(.a(new_n258_), .b(x013), .O(new_n292_));
  aoi22  g136(.a(new_n292_), .b(new_n253_), .c(new_n291_), .d(new_n289_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(new_n288_), .O(new_n294_));
  nand2  g138(.a(new_n294_), .b(x053), .O(new_n295_));
  inv1   g139(.a(x037), .O(new_n296_));
  nand2  g140(.a(new_n269_), .b(new_n273_), .O(new_n297_));
  ...
  nor2   g146(.a(x085), .b(new_n302_), .O(new_n303_));
  nand2  g147(.a(new_n296_), .b(new_n302_), .O(new_n304_));
  aoi22  g148(.a(new_n304_), .b(new_n291_), .c(new_n303_), .d(new_n273_), .O(new_n305_));
  aoi21  g149(.a(new_n305_), .b(new_n301_), .c(new_n289_), .O(new_n306_));
  nor2   g150(.a(x053), .b(x037), .O(new_n307_));
  nand3  g151(.a(new_n258_), .b(x037), .c(new_n273_), .O(new_n308_));
  aoi21  g152(.a(new_n308_), .b(x013), .c(x077), .O(new_n309_));
  nor3   g153(.a(new_n309_), .b(new_n307_), .c(new_n306_), .O(new_n310_));
  nand2  g154(.a(new_n179_), .b(x045), .O(new_n311_));
  aoi21  g155(.a(new_n310_), .b(new_n295_), .c(new_n311_), .O(z05));
  ...
  nand4  g170(.a(new_n326_), .b(new_n323_), .c(new_n322_), .d(new_n316_), .O(new_n327_));
  aoi21  g171(.a(new_n327_), .b(new_n319_), .c(new_n314_), .O(new_n328_));
  ...
  nand2  g180(.a(new_n315_), .b(x038), .O(new_n337_));
  ...
  nand2  g193(.a(x070), .b(new_n316_), .O(new_n350_));
  oai21  g194(.a(new_n350_), .b(new_n333_), .c(x022), .O(new_n351_));
  aoi21  g195(.a(new_n351_), .b(x086), .c(new_n349_), .O(new_n352_));
  nand2  g196(.a(x086), .b(new_n320_), .O(new_n353_));
  oai21  g197(.a(new_n352_), .b(new_n347_), .c(new_n353_), .O(new_n354_));
  nand2  g198(.a(new_n315_), .b(new_n321_), .O(new_n355_));
  nor2   g199(.a(new_n355_), .b(x078), .O(new_n356_));
  aoi21  g200(.a(new_n354_), .b(new_n346_), .c(new_n356_), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n345_), .c(new_n313_), .O(new_n358_));
  inv1   g202(.a(x006), .O(new_n359_));
  nand2  g203(.a(new_n323_), .b(new_n359_), .O(new_n360_));
  ...
  nand2  g207(.a(new_n318_), .b(x086), .O(new_n364_));
  aoi21  g208(.a(new_n364_), .b(new_n363_), .c(x038), .O(new_n365_));
  nand2  g209(.a(new_n314_), .b(x014), .O(new_n366_));
  ...
  nand3  g214(.a(new_n314_), .b(x038), .c(new_n359_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(x014), .O(new_n372_));
  aoi22  g216(.a(new_n372_), .b(new_n347_), .c(new_n313_), .d(new_n370_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n369_), .O(new_n374_));
  oai21  g218(.a(new_n374_), .b(new_n358_), .c(x046), .O(new_n375_));
  nand2  g219(.a(new_n375_), .b(new_n179_), .O(z06));
  ...
  nand2  g267(.a(new_n179_), .b(new_n424_), .O(new_n425_));
  ...
  nor3   g281(.a(new_n438_), .b(z16), .c(x041), .O(z09));
  ...
  nor3   g309(.a(new_n466_), .b(z16), .c(x043), .O(z11));
  ...
  nand2  g324(.a(x069), .b(new_n296_), .O(new_n482_));
  aoi21  g325(.a(new_n482_), .b(new_n290_), .c(new_n273_), .O(new_n483_));
  nand3  g326(.a(new_n266_), .b(new_n254_), .c(x029), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n274_), .c(x085), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n483_), .c(new_n283_), .O(new_n486_));
  aoi21  g329(.a(x029), .b(new_n274_), .c(new_n262_), .O(new_n487_));
  oai21  g330(.a(x069), .b(x013), .c(x021), .O(new_n488_));
  nand2  g331(.a(new_n282_), .b(new_n280_), .O(new_n489_));
  nand4  g332(.a(new_n489_), .b(new_n488_), .c(new_n266_), .d(x029), .O(new_n490_));
  oai21  g333(.a(new_n487_), .b(new_n254_), .c(new_n490_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n258_), .O(new_n492_));
  oai21  g335(.a(x037), .b(x013), .c(x021), .O(new_n493_));
  oai21  g336(.a(new_n262_), .b(x029), .c(new_n493_), .O(new_n494_));
  oai21  g337(.a(new_n266_), .b(new_n274_), .c(new_n489_), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n494_), .c(x069), .O(new_n496_));
  nand3  g339(.a(x101), .b(x069), .c(new_n296_), .O(new_n497_));
  nand3  g340(.a(new_n253_), .b(x125), .c(new_n274_), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n497_), .c(new_n258_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n496_), .c(x005), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n492_), .c(new_n486_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n289_), .O(new_n502_));
  inv1   g345(.a(new_n256_), .O(new_n503_));
  aoi22  g346(.a(new_n303_), .b(new_n283_), .c(new_n503_), .d(x077), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n502_), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n481_), .O(new_n506_));
  nand2  g349(.a(new_n489_), .b(x005), .O(new_n507_));
  nand3  g350(.a(new_n258_), .b(x029), .c(new_n302_), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n507_), .c(x069), .O(new_n509_));
  nor2   g352(.a(new_n487_), .b(x085), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n509_), .c(x037), .O(new_n511_));
  nand2  g354(.a(x085), .b(x005), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(x013), .c(new_n256_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n275_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n511_), .O(new_n515_));
  oai21  g358(.a(new_n512_), .b(x037), .c(new_n302_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(x077), .O(new_n517_));
  oai21  g360(.a(new_n481_), .b(new_n296_), .c(new_n517_), .O(new_n518_));
  aoi21  g361(.a(new_n515_), .b(new_n289_), .c(new_n518_), .O(new_n519_));
  inv1   g362(.a(x045), .O(new_n520_));
  nand2  g363(.a(new_n179_), .b(new_n520_), .O(new_n521_));
  aoi21  g364(.a(new_n519_), .b(new_n506_), .c(new_n521_), .O(z13));
  inv1   g365(.a(new_n339_), .O(new_n523_));
  nand2  g366(.a(x070), .b(new_n370_), .O(new_n524_));
  aoi21  g367(.a(new_n524_), .b(new_n355_), .c(new_n359_), .O(new_n525_));
  nand2  g368(.a(x094), .b(x062), .O(new_n526_));
  nand3  g369(.a(new_n526_), .b(new_n315_), .c(x030), .O(new_n527_));
  aoi21  g370(.a(new_n527_), .b(new_n321_), .c(x086), .O(new_n528_));
  oai21  g371(.a(new_n528_), .b(new_n525_), .c(new_n523_), .O(new_n529_));
  aoi21  g372(.a(x030), .b(new_n321_), .c(new_n326_), .O(new_n530_));
  oai21  g373(.a(x070), .b(x014), .c(x022), .O(new_n531_));
  nand2  g374(.a(new_n340_), .b(new_n336_), .O(new_n532_));
  nand4  g375(.a(new_n532_), .b(new_n531_), .c(new_n526_), .d(x030), .O(new_n533_));
  oai21  g376(.a(new_n530_), .b(new_n315_), .c(new_n533_), .O(new_n534_));
  ...
  oai21  g380(.a(new_n526_), .b(new_n321_), .c(new_n532_), .O(new_n538_));
  aoi21  g381(.a(new_n538_), .b(new_n537_), .c(x070), .O(new_n539_));
  nand3  g382(.a(x102), .b(x070), .c(new_n370_), .O(new_n540_));
  nand3  g383(.a(new_n346_), .b(x126), .c(new_n321_), .O(new_n541_));
  nand3  g384(.a(new_n541_), .b(new_n540_), .c(new_n314_), .O(new_n542_));
  oai21  g385(.a(new_n542_), .b(new_n539_), .c(x006), .O(new_n543_));
  nand3  g386(.a(new_n543_), .b(new_n535_), .c(new_n529_), .O(new_n544_));
  nand2  g387(.a(new_n544_), .b(new_n347_), .O(new_n545_));
  inv1   g388(.a(new_n348_), .O(new_n546_));
  inv1   g389(.a(new_n366_), .O(new_n547_));
  aoi22  g390(.a(new_n547_), .b(new_n523_), .c(new_n546_), .d(x078), .O(new_n548_));
  nand2  g391(.a(new_n548_), .b(new_n545_), .O(new_n549_));
  nand2  g392(.a(new_n549_), .b(new_n313_), .O(new_n550_));
  nand2  g393(.a(new_n532_), .b(x006), .O(new_n551_));
  nand3  g394(.a(new_n314_), .b(x030), .c(new_n320_), .O(new_n552_));
  aoi21  g395(.a(new_n552_), .b(new_n551_), .c(x070), .O(new_n553_));
  nor2   g396(.a(new_n530_), .b(x086), .O(new_n554_));
  oai21  g397(.a(new_n554_), .b(new_n553_), .c(x038), .O(new_n555_));
  nand2  g398(.a(x086), .b(x006), .O(new_n556_));
  oai21  g399(.a(new_n556_), .b(x014), .c(new_n348_), .O(new_n557_));
  oai21  g400(.a(new_n370_), .b(new_n320_), .c(new_n557_), .O(new_n558_));
  nand2  g401(.a(new_n558_), .b(new_n555_), .O(new_n559_));
  oai21  g402(.a(new_n556_), .b(x038), .c(new_n320_), .O(new_n560_));
  nand2  g403(.a(new_n560_), .b(x078), .O(new_n561_));
  oai21  g404(.a(new_n313_), .b(new_n370_), .c(new_n561_), .O(new_n562_));
  aoi21  g405(.a(new_n559_), .b(new_n347_), .c(new_n562_), .O(new_n563_));
  ...
  zero   g413(.O(z26));
  zero   g414(.O(z27));
  nor2   g415(.a(new_n177_), .b(x100), .O(z17));
  nor2   g416(.a(new_n177_), .b(x100), .O(z18));
  nor2   g417(.a(new_n177_), .b(x100), .O(z19));
  nor2   g418(.a(new_n177_), .b(x100), .O(z20));
  nor2   g419(.a(new_n177_), .b(x100), .O(z22));
  nor2   g420(.a(new_n177_), .b(x100), .O(z23));
  nor2   g421(.a(new_n177_), .b(x100), .O(z25));
endmodule
