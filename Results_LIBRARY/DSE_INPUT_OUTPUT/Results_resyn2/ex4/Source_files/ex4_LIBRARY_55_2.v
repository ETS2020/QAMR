// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:25 2020
...
module FAU ( 
  ...
  nor2   g324(.a(new_n277_), .b(x053), .O(new_n481_));
  nand2  g325(.a(x085), .b(x005), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(x037), .c(new_n257_), .O(new_n483_));
  oai21  g327(.a(new_n483_), .b(new_n481_), .c(x077), .O(new_n484_));
  oai21  g328(.a(new_n302_), .b(new_n259_), .c(new_n484_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n177_), .O(new_n486_));
  oai21  g330(.a(x037), .b(x013), .c(x021), .O(new_n487_));
  oai21  g331(.a(new_n265_), .b(x029), .c(new_n487_), .O(new_n488_));
  nand2  g332(.a(new_n268_), .b(new_n271_), .O(new_n489_));
  oai21  g333(.a(new_n261_), .b(new_n258_), .c(new_n489_), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n488_), .c(x069), .O(new_n491_));
  nand3  g335(.a(new_n275_), .b(x125), .c(new_n258_), .O(new_n492_));
  nand3  g336(.a(x101), .b(x069), .c(new_n259_), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n492_), .c(new_n279_), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n491_), .c(x005), .O(new_n495_));
  nand2  g339(.a(x069), .b(new_n259_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n298_), .c(new_n254_), .O(new_n497_));
  nand3  g341(.a(new_n261_), .b(new_n255_), .c(x029), .O(new_n498_));
  nor2   g342(.a(x021), .b(x013), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(x085), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n497_), .c(new_n269_), .O(new_n501_));
  oai21  g345(.a(new_n256_), .b(x021), .c(new_n264_), .O(new_n502_));
  and2   g346(.a(new_n502_), .b(x069), .O(new_n503_));
  oai21  g347(.a(x069), .b(x013), .c(x021), .O(new_n504_));
  nand4  g348(.a(new_n504_), .b(new_n489_), .c(new_n261_), .d(x029), .O(new_n505_));
  inv1   g349(.a(new_n505_), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n503_), .c(new_n279_), .O(new_n507_));
  ...
  nand2  g355(.a(new_n502_), .b(new_n279_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n302_), .O(new_n513_));
  oai21  g357(.a(new_n513_), .b(new_n511_), .c(x037), .O(new_n514_));
  oai21  g358(.a(new_n482_), .b(x013), .c(new_n277_), .O(new_n515_));
  nand3  g359(.a(new_n302_), .b(x037), .c(x013), .O(new_n516_));
  aoi21  g360(.a(new_n516_), .b(new_n515_), .c(x045), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n514_), .O(new_n518_));
  aoi21  g362(.a(new_n508_), .b(new_n302_), .c(new_n518_), .O(new_n519_));
  ...
  nand3  g403(.a(new_n559_), .b(new_n558_), .c(new_n179_), .O(new_n560_));
  ...
  zero   g411(.O(z25));
  zero   g412(.O(z27));
  nor2   g413(.a(x077), .b(new_n177_), .O(z18));
  nor2   g414(.a(x077), .b(new_n177_), .O(z19));
