// Benchmark "FAU" written by ABC on Wed Aug 12 10:07:57 2020
...
module FAU ( 
  ...
  nand2  g072(.a(new_n160_), .b(x043), .O(new_n229_));
  ...
  nor2   g088(.a(new_n244_), .b(z07), .O(new_n245_));
  oai21  g089(.a(x052), .b(x036), .c(new_n245_), .O(new_n246_));
  inv1   g090(.a(new_n246_), .O(new_n247_));
  nand4  g091(.a(new_n247_), .b(new_n243_), .c(new_n241_), .d(new_n238_), .O(new_n248_));
  inv1   g092(.a(new_n248_), .O(new_n249_));
  nor2   g093(.a(new_n249_), .b(new_n231_), .O(z04));
  ...
  nand2  g100(.a(x093), .b(x061), .O(new_n257_));
  oai22  g101(.a(new_n257_), .b(new_n253_), .c(new_n256_), .d(x021), .O(new_n258_));
  ...
  oai21  g106(.a(new_n262_), .b(x021), .c(new_n259_), .O(new_n263_));
  aoi21  g107(.a(new_n263_), .b(new_n258_), .c(new_n252_), .O(new_n264_));
  inv1   g108(.a(x125), .O(new_n265_));
  or2    g109(.a(x117), .b(x109), .O(new_n266_));
  nand3  g110(.a(new_n266_), .b(new_n265_), .c(x021), .O(new_n267_));
  inv1   g111(.a(x101), .O(new_n268_));
  nand3  g112(.a(new_n268_), .b(new_n252_), .c(x037), .O(new_n269_));
  nand3  g113(.a(new_n269_), .b(new_n267_), .c(x085), .O(new_n270_));
  oai21  g114(.a(new_n270_), .b(new_n264_), .c(new_n251_), .O(new_n271_));
  nand2  g115(.a(x117), .b(x109), .O(new_n272_));
  nand2  g116(.a(new_n252_), .b(x037), .O(new_n273_));
  nand2  g117(.a(x069), .b(x021), .O(new_n274_));
  aoi21  g118(.a(new_n274_), .b(new_n273_), .c(x005), .O(new_n275_));
  inv1   g119(.a(x085), .O(new_n276_));
  nand3  g120(.a(new_n262_), .b(x069), .c(new_n253_), .O(new_n277_));
  inv1   g121(.a(x021), .O(new_n278_));
  nor2   g122(.a(new_n278_), .b(new_n254_), .O(new_n279_));
  aoi21  g123(.a(new_n279_), .b(new_n277_), .c(new_n276_), .O(new_n280_));
  oai21  g124(.a(new_n280_), .b(new_n275_), .c(new_n272_), .O(new_n281_));
  aoi21  g125(.a(new_n253_), .b(x021), .c(new_n257_), .O(new_n282_));
  aoi21  g126(.a(x069), .b(x013), .c(x021), .O(new_n283_));
  nand3  g127(.a(new_n262_), .b(new_n259_), .c(new_n253_), .O(new_n284_));
  oai22  g128(.a(new_n284_), .b(new_n283_), .c(new_n282_), .d(x069), .O(new_n285_));
  nand2  g129(.a(new_n285_), .b(x085), .O(new_n286_));
  nand3  g130(.a(new_n286_), .b(new_n281_), .c(new_n271_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(x053), .O(new_n288_));
  nand2  g132(.a(new_n259_), .b(new_n251_), .O(new_n289_));
  nand3  g133(.a(x085), .b(new_n253_), .c(x013), .O(new_n290_));
  nand2  g134(.a(new_n290_), .b(new_n289_), .O(new_n291_));
  nand2  g135(.a(new_n291_), .b(x069), .O(new_n292_));
  inv1   g136(.a(new_n282_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(x085), .O(new_n294_));
  nand3  g138(.a(new_n294_), .b(new_n292_), .c(x053), .O(new_n295_));
  nand2  g139(.a(new_n252_), .b(new_n278_), .O(new_n296_));
  inv1   g140(.a(new_n296_), .O(new_n297_));
  nor2   g141(.a(x085), .b(x005), .O(new_n298_));
  oai21  g142(.a(new_n298_), .b(new_n297_), .c(x013), .O(new_n299_));
  inv1   g143(.a(x053), .O(new_n300_));
  oai21  g144(.a(new_n300_), .b(x037), .c(new_n297_), .O(new_n301_));
  nand3  g145(.a(new_n301_), .b(new_n299_), .c(x077), .O(new_n302_));
  aoi21  g146(.a(new_n295_), .b(new_n255_), .c(new_n302_), .O(new_n303_));
  aoi21  g147(.a(new_n303_), .b(new_n288_), .c(new_n158_), .O(z05));
  ...
  nand2  g209(.a(new_n365_), .b(new_n160_), .O(z06));
  nand2  g210(.a(new_n160_), .b(new_n157_), .O(new_n367_));
  nand2  g211(.a(x064), .b(new_n170_), .O(new_n368_));
  aoi21  g212(.a(new_n368_), .b(new_n165_), .c(new_n172_), .O(new_n369_));
  nand2  g213(.a(x088), .b(x056), .O(new_n370_));
  nand3  g214(.a(new_n370_), .b(new_n164_), .c(x024), .O(new_n371_));
  aoi21  g215(.a(new_n371_), .b(new_n163_), .c(x080), .O(new_n372_));
  oai22  g216(.a(new_n372_), .b(new_n369_), .c(x112), .d(x104), .O(new_n373_));
  ...
  oai21  g228(.a(new_n384_), .b(new_n379_), .c(new_n164_), .O(new_n385_));
  nand3  g229(.a(x096), .b(x064), .c(new_n170_), .O(new_n386_));
  nand2  g230(.a(x112), .b(x104), .O(new_n387_));
  nand3  g231(.a(new_n387_), .b(x120), .c(new_n163_), .O(new_n388_));
  nand3  g232(.a(new_n388_), .b(new_n386_), .c(new_n173_), .O(new_n389_));
  ...
  nor2   g238(.a(x112), .b(x104), .O(new_n395_));
  nand2  g239(.a(x064), .b(x016), .O(new_n396_));
  oai22  g240(.a(new_n396_), .b(new_n179_), .c(new_n395_), .d(new_n394_), .O(new_n397_));
  oai21  g241(.a(new_n397_), .b(new_n393_), .c(new_n167_), .O(new_n398_));
  nand2  g242(.a(new_n379_), .b(x000), .O(new_n399_));
  nand3  g243(.a(new_n173_), .b(x024), .c(new_n161_), .O(new_n400_));
  aoi21  g244(.a(new_n400_), .b(new_n399_), .c(x064), .O(new_n401_));
  and2   g245(.a(new_n376_), .b(new_n173_), .O(new_n402_));
  oai21  g246(.a(new_n402_), .b(new_n401_), .c(x032), .O(new_n403_));
  nand2  g247(.a(x080), .b(x000), .O(new_n404_));
  nand2  g248(.a(new_n404_), .b(new_n396_), .O(new_n405_));
  aoi21  g249(.a(new_n167_), .b(x032), .c(new_n396_), .O(new_n406_));
  oai21  g250(.a(new_n406_), .b(new_n161_), .c(new_n405_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(new_n403_), .O(new_n408_));
  oai21  g252(.a(new_n404_), .b(x032), .c(new_n161_), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(x072), .O(new_n410_));
  oai21  g254(.a(new_n167_), .b(new_n170_), .c(new_n410_), .O(new_n411_));
  aoi21  g255(.a(new_n408_), .b(new_n179_), .c(new_n411_), .O(new_n412_));
  aoi21  g256(.a(new_n412_), .b(new_n398_), .c(new_n367_), .O(z08));
  ...
  nand3  g262(.a(new_n418_), .b(new_n416_), .c(new_n193_), .O(new_n419_));
  nand2  g263(.a(new_n417_), .b(new_n414_), .O(new_n420_));
  nand2  g264(.a(new_n415_), .b(x009), .O(new_n421_));
  nand3  g265(.a(new_n421_), .b(new_n420_), .c(new_n192_), .O(new_n422_));
  nand2  g266(.a(new_n417_), .b(new_n415_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n185_), .O(new_n424_));
  aoi22  g268(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n425_));
  nand4  g269(.a(new_n425_), .b(new_n424_), .c(new_n422_), .d(new_n419_), .O(new_n426_));
  nand2  g270(.a(new_n426_), .b(new_n184_), .O(new_n427_));
  nand2  g271(.a(new_n427_), .b(new_n160_), .O(z09));
  inv1   g272(.a(x010), .O(new_n429_));
  nand2  g273(.a(x066), .b(x018), .O(new_n430_));
  nand2  g274(.a(new_n430_), .b(new_n429_), .O(new_n431_));
  nand2  g275(.a(x082), .b(x002), .O(new_n432_));
  nand2  g276(.a(new_n432_), .b(x010), .O(new_n433_));
  nand3  g277(.a(new_n433_), .b(new_n431_), .c(new_n207_), .O(new_n434_));
  nand2  g278(.a(new_n432_), .b(new_n429_), .O(new_n435_));
  nand2  g279(.a(new_n430_), .b(x010), .O(new_n436_));
  nand3  g280(.a(new_n436_), .b(new_n435_), .c(new_n206_), .O(new_n437_));
  nand2  g281(.a(new_n432_), .b(new_n430_), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(new_n199_), .O(new_n439_));
  aoi22  g283(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n440_));
  nand4  g284(.a(new_n440_), .b(new_n439_), .c(new_n437_), .d(new_n434_), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n198_), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n160_), .O(z10));
  nand2  g287(.a(x067), .b(x019), .O(new_n444_));
  inv1   g288(.a(new_n444_), .O(new_n445_));
  nand2  g289(.a(x083), .b(x003), .O(new_n446_));
  aoi22  g290(.a(new_n446_), .b(x011), .c(x051), .d(new_n215_), .O(new_n447_));
  oai21  g291(.a(new_n445_), .b(x011), .c(new_n447_), .O(new_n448_));
  inv1   g292(.a(new_n446_), .O(new_n449_));
  aoi21  g293(.a(new_n444_), .b(x011), .c(x035), .O(new_n450_));
  oai21  g294(.a(new_n449_), .b(x011), .c(new_n450_), .O(new_n451_));
  oai21  g295(.a(new_n449_), .b(new_n445_), .c(new_n227_), .O(new_n452_));
  aoi21  g296(.a(x051), .b(x035), .c(new_n224_), .O(new_n453_));
  nand4  g297(.a(new_n453_), .b(new_n452_), .c(new_n451_), .d(new_n448_), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  nor3   g299(.a(new_n455_), .b(z07), .c(x043), .O(z11));
  ...
  oai21  g309(.a(new_n463_), .b(new_n458_), .c(new_n244_), .O(new_n466_));
  aoi21  g310(.a(x052), .b(x036), .c(new_n242_), .O(new_n467_));
  nand4  g311(.a(new_n467_), .b(new_n466_), .c(new_n465_), .d(new_n462_), .O(new_n468_));
  and2   g312(.a(new_n468_), .b(new_n231_), .O(z12));
  inv1   g313(.a(x077), .O(new_n470_));
  nand2  g314(.a(x069), .b(new_n255_), .O(new_n471_));
  aoi21  g315(.a(new_n471_), .b(new_n296_), .c(new_n251_), .O(new_n472_));
  nand3  g316(.a(new_n257_), .b(new_n252_), .c(x029), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n278_), .c(x085), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(new_n472_), .c(new_n266_), .O(new_n475_));
  aoi21  g319(.a(x029), .b(new_n278_), .c(new_n262_), .O(new_n476_));
  oai21  g320(.a(x069), .b(x013), .c(x021), .O(new_n477_));
  nand2  g321(.a(new_n265_), .b(new_n268_), .O(new_n478_));
  nand4  g322(.a(new_n478_), .b(new_n477_), .c(new_n257_), .d(x029), .O(new_n479_));
  oai21  g323(.a(new_n476_), .b(new_n252_), .c(new_n479_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n276_), .O(new_n481_));
  oai21  g325(.a(x037), .b(x013), .c(x021), .O(new_n482_));
  oai21  g326(.a(new_n262_), .b(x029), .c(new_n482_), .O(new_n483_));
  oai21  g327(.a(new_n257_), .b(new_n278_), .c(new_n478_), .O(new_n484_));
  aoi21  g328(.a(new_n484_), .b(new_n483_), .c(x069), .O(new_n485_));
  nand3  g329(.a(x101), .b(x069), .c(new_n255_), .O(new_n486_));
  nand3  g330(.a(new_n272_), .b(x125), .c(new_n278_), .O(new_n487_));
  nand3  g331(.a(new_n487_), .b(new_n486_), .c(new_n276_), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n485_), .c(x005), .O(new_n489_));
  nand3  g333(.a(new_n489_), .b(new_n481_), .c(new_n475_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n470_), .O(new_n491_));
  inv1   g335(.a(new_n274_), .O(new_n492_));
  nor2   g336(.a(x085), .b(new_n254_), .O(new_n493_));
  aoi22  g337(.a(new_n493_), .b(new_n266_), .c(new_n492_), .d(x077), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n491_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n300_), .O(new_n496_));
  nand2  g340(.a(new_n478_), .b(x005), .O(new_n497_));
  nand3  g341(.a(new_n276_), .b(x029), .c(new_n254_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n497_), .c(x069), .O(new_n499_));
  nor2   g343(.a(new_n476_), .b(x085), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n499_), .c(x037), .O(new_n501_));
  nand2  g345(.a(x085), .b(x005), .O(new_n502_));
  nor2   g346(.a(new_n502_), .b(x013), .O(new_n503_));
  nor2   g347(.a(new_n503_), .b(new_n492_), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(new_n256_), .c(new_n501_), .O(new_n505_));
  oai21  g349(.a(new_n502_), .b(x037), .c(new_n254_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(x077), .O(new_n507_));
  oai21  g351(.a(new_n300_), .b(new_n255_), .c(new_n507_), .O(new_n508_));
  aoi21  g352(.a(new_n505_), .b(new_n470_), .c(new_n508_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n496_), .c(x045), .O(z13));
  inv1   g354(.a(x046), .O(new_n511_));
  oai21  g355(.a(new_n308_), .b(x022), .c(new_n316_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(x070), .O(new_n513_));
  nand2  g357(.a(x094), .b(x062), .O(new_n514_));
  oai21  g358(.a(x070), .b(x014), .c(x022), .O(new_n515_));
  nand2  g359(.a(new_n330_), .b(new_n326_), .O(new_n516_));
  nand4  g360(.a(new_n516_), .b(new_n515_), .c(new_n514_), .d(x030), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n513_), .c(x086), .O(new_n518_));
  oai21  g362(.a(x038), .b(x014), .c(x022), .O(new_n519_));
  inv1   g363(.a(x062), .O(new_n520_));
  inv1   g364(.a(x094), .O(new_n521_));
  nand3  g365(.a(new_n521_), .b(new_n520_), .c(new_n308_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n519_), .O(new_n523_));
  oai22  g367(.a(new_n514_), .b(new_n313_), .c(x126), .d(x102), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n523_), .O(new_n525_));
  nand2  g369(.a(new_n525_), .b(new_n307_), .O(new_n526_));
  nand3  g370(.a(x102), .b(x070), .c(new_n360_), .O(new_n527_));
  nand3  g371(.a(new_n336_), .b(x126), .c(new_n313_), .O(new_n528_));
  nand3  g372(.a(new_n528_), .b(new_n527_), .c(new_n306_), .O(new_n529_));
  inv1   g373(.a(new_n529_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n526_), .c(new_n349_), .O(new_n531_));
  oai21  g375(.a(new_n531_), .b(new_n518_), .c(new_n337_), .O(new_n532_));
  inv1   g376(.a(new_n329_), .O(new_n533_));
  inv1   g377(.a(new_n338_), .O(new_n534_));
  nand2  g378(.a(x070), .b(new_n360_), .O(new_n535_));
  aoi21  g379(.a(new_n535_), .b(new_n345_), .c(new_n349_), .O(new_n536_));
  nand3  g380(.a(new_n514_), .b(new_n307_), .c(x030), .O(new_n537_));
  aoi21  g381(.a(new_n537_), .b(new_n313_), .c(x086), .O(new_n538_));
  oai21  g382(.a(new_n538_), .b(new_n536_), .c(new_n337_), .O(new_n539_));
  nand2  g383(.a(new_n539_), .b(new_n356_), .O(new_n540_));
  aoi22  g384(.a(new_n540_), .b(new_n533_), .c(new_n534_), .d(x078), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n532_), .c(x054), .O(new_n542_));
  nand2  g386(.a(new_n516_), .b(x006), .O(new_n543_));
  nand3  g387(.a(new_n306_), .b(x030), .c(new_n312_), .O(new_n544_));
  nand2  g388(.a(new_n544_), .b(new_n543_), .O(new_n545_));
  nand2  g389(.a(new_n545_), .b(new_n307_), .O(new_n546_));
  nand2  g390(.a(new_n512_), .b(new_n306_), .O(new_n547_));
  aoi21  g391(.a(new_n547_), .b(new_n546_), .c(new_n360_), .O(new_n548_));
  nand3  g392(.a(x086), .b(new_n312_), .c(x006), .O(new_n549_));
  aoi22  g393(.a(new_n549_), .b(new_n338_), .c(x038), .d(x014), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(new_n548_), .c(new_n337_), .O(new_n551_));
  nand2  g395(.a(x086), .b(x006), .O(new_n552_));
  oai21  g396(.a(new_n552_), .b(x038), .c(new_n312_), .O(new_n553_));
  aoi22  g397(.a(new_n553_), .b(x078), .c(x054), .d(x038), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n551_), .O(new_n555_));
  oai21  g399(.a(new_n555_), .b(new_n542_), .c(new_n511_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n160_), .O(z14));
  zero   g401(.O(z15));
  zero   g402(.O(z17));
  zero   g403(.O(z21));
  zero   g404(.O(z23));
  zero   g405(.O(z24));
  zero   g406(.O(z27));
  nor2   g407(.a(x077), .b(new_n158_), .O(z16));
  nor2   g408(.a(x077), .b(new_n158_), .O(z18));
  nor2   g409(.a(x077), .b(new_n158_), .O(z19));
  nor2   g410(.a(x077), .b(new_n158_), .O(z20));
  nor2   g411(.a(x077), .b(new_n158_), .O(z22));
  nor2   g412(.a(x077), .b(new_n158_), .O(z25));
  nor2   g413(.a(x077), .b(new_n158_), .O(z26));
endmodule
