// Benchmark "FAU" written by ABC on Wed Aug 12 10:03:17 2020
...
module FAU ( 
  ...
  nand3  g132(.a(new_n288_), .b(new_n260_), .c(x037), .O(new_n289_));
  ...
  nor2   g141(.a(new_n264_), .b(x013), .O(new_n298_));
  aoi22  g142(.a(new_n298_), .b(new_n259_), .c(new_n297_), .d(new_n178_), .O(new_n299_));
  nand2  g143(.a(new_n299_), .b(new_n296_), .O(new_n300_));
  nand2  g144(.a(new_n300_), .b(x053), .O(new_n301_));
  inv1   g145(.a(x037), .O(new_n302_));
  nand2  g146(.a(new_n275_), .b(new_n279_), .O(new_n303_));
  nand3  g147(.a(x085), .b(new_n265_), .c(x013), .O(new_n304_));
  aoi21  g148(.a(new_n304_), .b(new_n303_), .c(new_n260_), .O(new_n305_));
  nor2   g149(.a(new_n273_), .b(new_n264_), .O(new_n306_));
  oai21  g150(.a(new_n306_), .b(new_n305_), .c(new_n302_), .O(new_n307_));
  nor2   g151(.a(x037), .b(x013), .O(new_n308_));
  inv1   g152(.a(new_n308_), .O(new_n309_));
  nor2   g153(.a(x085), .b(x005), .O(new_n310_));
  aoi22  g154(.a(new_n310_), .b(x013), .c(new_n309_), .d(new_n297_), .O(new_n311_));
  nand2  g155(.a(new_n311_), .b(new_n307_), .O(new_n312_));
  inv1   g156(.a(x013), .O(new_n313_));
  aoi21  g157(.a(new_n310_), .b(x037), .c(new_n313_), .O(new_n314_));
  oai22  g158(.a(new_n314_), .b(x077), .c(x053), .d(x037), .O(new_n315_));
  aoi21  g159(.a(new_n312_), .b(x077), .c(new_n315_), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n301_), .c(new_n258_), .O(z05));
  ...
  nand3  g240(.a(new_n397_), .b(new_n396_), .c(new_n172_), .O(new_n398_));
  inv1   g241(.a(new_n398_), .O(new_n399_));
  aoi21  g242(.a(new_n399_), .b(new_n394_), .c(new_n384_), .O(new_n400_));
  ...
  oai21  g250(.a(new_n407_), .b(new_n400_), .c(new_n383_), .O(new_n408_));
  or2    g251(.a(x112), .b(x104), .O(new_n409_));
  nand2  g252(.a(x064), .b(new_n169_), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(new_n160_), .c(new_n384_), .O(new_n411_));
  nand3  g254(.a(new_n385_), .b(new_n159_), .c(x024), .O(new_n412_));
  aoi21  g255(.a(new_n412_), .b(new_n158_), .c(x080), .O(new_n413_));
  oai21  g256(.a(new_n413_), .b(new_n411_), .c(new_n383_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n173_), .O(new_n415_));
  nor2   g258(.a(new_n159_), .b(new_n158_), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(x072), .O(new_n417_));
  inv1   g260(.a(new_n417_), .O(new_n418_));
  aoi21  g261(.a(new_n415_), .b(new_n409_), .c(new_n418_), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(new_n408_), .c(x048), .O(new_n420_));
  nand2  g263(.a(new_n404_), .b(x000), .O(new_n421_));
  nand3  g264(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(new_n421_), .c(x064), .O(new_n423_));
  inv1   g266(.a(new_n402_), .O(new_n424_));
  aoi21  g267(.a(new_n424_), .b(new_n392_), .c(x080), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(new_n423_), .c(x032), .O(new_n426_));
  inv1   g269(.a(new_n416_), .O(new_n427_));
  ...
  nand2  g275(.a(new_n432_), .b(new_n383_), .O(new_n433_));
  ...
  oai21  g279(.a(new_n436_), .b(new_n420_), .c(new_n382_), .O(new_n437_));
  ...
  oai21  g319(.a(new_n476_), .b(x043), .c(new_n180_), .O(z11));
  nand2  g320(.a(x068), .b(x020), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(new_n479_));
  nand2  g322(.a(x084), .b(x004), .O(new_n480_));
  aoi22  g323(.a(new_n480_), .b(x012), .c(x052), .d(new_n242_), .O(new_n481_));
  ...
  oai21  g328(.a(new_n483_), .b(new_n479_), .c(new_n254_), .O(new_n486_));
  ...
  nor3   g332(.a(new_n489_), .b(z17), .c(x044), .O(z12));
  inv1   g333(.a(x053), .O(new_n491_));
  oai22  g334(.a(new_n308_), .b(new_n280_), .c(new_n268_), .d(x029), .O(new_n492_));
  nand2  g335(.a(new_n290_), .b(new_n288_), .O(new_n493_));
  oai21  g336(.a(new_n272_), .b(new_n280_), .c(new_n493_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n492_), .c(x069), .O(new_n495_));
  nand3  g338(.a(x101), .b(x069), .c(new_n302_), .O(new_n496_));
  nand3  g339(.a(new_n259_), .b(x125), .c(new_n280_), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n496_), .c(new_n264_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n495_), .c(x005), .O(new_n499_));
  aoi21  g342(.a(x069), .b(new_n302_), .c(new_n297_), .O(new_n500_));
  nor2   g343(.a(new_n500_), .b(new_n279_), .O(new_n501_));
  nand3  g344(.a(new_n272_), .b(new_n260_), .c(x029), .O(new_n502_));
  nor2   g345(.a(x021), .b(x013), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n502_), .c(x085), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(new_n501_), .c(new_n291_), .O(new_n505_));
  inv1   g348(.a(new_n268_), .O(new_n506_));
  oai21  g349(.a(new_n265_), .b(x021), .c(new_n506_), .O(new_n507_));
  and2   g350(.a(new_n507_), .b(x069), .O(new_n508_));
  oai21  g351(.a(x069), .b(x013), .c(x021), .O(new_n509_));
  nand4  g352(.a(new_n509_), .b(new_n493_), .c(new_n272_), .d(x029), .O(new_n510_));
  inv1   g353(.a(new_n510_), .O(new_n511_));
  oai21  g354(.a(new_n511_), .b(new_n508_), .c(new_n264_), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n505_), .c(new_n499_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n491_), .O(new_n514_));
  nand2  g357(.a(new_n493_), .b(x005), .O(new_n515_));
  nand3  g358(.a(new_n264_), .b(x029), .c(new_n313_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n260_), .O(new_n518_));
  aoi21  g361(.a(new_n507_), .b(new_n264_), .c(x053), .O(new_n519_));
  aoi21  g362(.a(new_n519_), .b(new_n518_), .c(new_n302_), .O(new_n520_));
  nand3  g363(.a(x085), .b(new_n313_), .c(x005), .O(new_n521_));
  nor2   g364(.a(new_n281_), .b(x053), .O(new_n522_));
  aoi21  g365(.a(new_n521_), .b(new_n262_), .c(new_n522_), .O(new_n523_));
  nor3   g366(.a(new_n523_), .b(new_n520_), .c(x077), .O(new_n524_));
  aoi21  g367(.a(new_n524_), .b(new_n514_), .c(x045), .O(z13));
  inv1   g368(.a(new_n379_), .O(new_n526_));
  inv1   g369(.a(x054), .O(new_n527_));
  aoi21  g370(.a(x030), .b(new_n339_), .c(new_n327_), .O(new_n528_));
  oai21  g371(.a(x070), .b(x014), .c(x022), .O(new_n529_));
  nand2  g372(.a(new_n349_), .b(new_n347_), .O(new_n530_));
  nand4  g373(.a(new_n530_), .b(new_n529_), .c(new_n331_), .d(x030), .O(new_n531_));
  oai21  g374(.a(new_n528_), .b(new_n319_), .c(new_n531_), .O(new_n532_));
  nand2  g375(.a(new_n532_), .b(new_n323_), .O(new_n533_));
  oai22  g376(.a(new_n371_), .b(new_n339_), .c(new_n327_), .d(x030), .O(new_n534_));
  oai21  g377(.a(new_n331_), .b(new_n339_), .c(new_n530_), .O(new_n535_));
  aoi21  g378(.a(new_n535_), .b(new_n534_), .c(x070), .O(new_n536_));
  nand3  g379(.a(x102), .b(x070), .c(new_n363_), .O(new_n537_));
  nand3  g380(.a(new_n318_), .b(x126), .c(new_n339_), .O(new_n538_));
  nand3  g381(.a(new_n538_), .b(new_n537_), .c(new_n323_), .O(new_n539_));
  oai21  g382(.a(new_n539_), .b(new_n536_), .c(x006), .O(new_n540_));
  aoi21  g383(.a(new_n540_), .b(new_n533_), .c(x078), .O(new_n541_));
  nand2  g384(.a(x070), .b(new_n363_), .O(new_n542_));
  aoi21  g385(.a(new_n542_), .b(new_n357_), .c(new_n338_), .O(new_n543_));
  nand3  g386(.a(new_n331_), .b(new_n319_), .c(x030), .O(new_n544_));
  aoi21  g387(.a(new_n544_), .b(new_n339_), .c(x086), .O(new_n545_));
  oai21  g388(.a(new_n545_), .b(new_n543_), .c(new_n356_), .O(new_n546_));
  nand2  g389(.a(new_n546_), .b(new_n369_), .O(new_n547_));
  nand2  g390(.a(new_n547_), .b(new_n350_), .O(new_n548_));
  oai21  g391(.a(new_n321_), .b(new_n356_), .c(new_n548_), .O(new_n549_));
  oai21  g392(.a(new_n549_), .b(new_n541_), .c(new_n527_), .O(new_n550_));
  nand2  g393(.a(new_n530_), .b(x006), .O(new_n551_));
  inv1   g394(.a(x014), .O(new_n552_));
  nand3  g395(.a(new_n323_), .b(x030), .c(new_n552_), .O(new_n553_));
  aoi21  g396(.a(new_n553_), .b(new_n551_), .c(x070), .O(new_n554_));
  nor2   g397(.a(new_n528_), .b(x086), .O(new_n555_));
  oai21  g398(.a(new_n555_), .b(new_n554_), .c(x038), .O(new_n556_));
  nand2  g399(.a(x086), .b(x006), .O(new_n557_));
  nand2  g400(.a(new_n557_), .b(new_n321_), .O(new_n558_));
  aoi21  g401(.a(new_n527_), .b(x038), .c(new_n321_), .O(new_n559_));
  oai21  g402(.a(new_n559_), .b(new_n552_), .c(new_n558_), .O(new_n560_));
  nand2  g403(.a(new_n560_), .b(new_n556_), .O(new_n561_));
  oai21  g404(.a(new_n557_), .b(x038), .c(new_n552_), .O(new_n562_));
  nand2  g405(.a(new_n562_), .b(x078), .O(new_n563_));
  nand2  g406(.a(x054), .b(x038), .O(new_n564_));
  nand3  g407(.a(new_n564_), .b(new_n563_), .c(new_n180_), .O(new_n565_));
  aoi21  g408(.a(new_n561_), .b(new_n356_), .c(new_n565_), .O(new_n566_));
  aoi21  g409(.a(new_n566_), .b(new_n550_), .c(new_n526_), .O(z14));
  zero   g410(.O(z07));
  zero   g411(.O(z15));
  zero   g412(.O(z16));
  zero   g413(.O(z18));
  ...
  zero   g419(.O(z25));
  zero   g420(.O(z26));
  nor2   g421(.a(new_n178_), .b(x045), .O(z21));
  nor2   g422(.a(new_n178_), .b(x045), .O(z27));
endmodule
