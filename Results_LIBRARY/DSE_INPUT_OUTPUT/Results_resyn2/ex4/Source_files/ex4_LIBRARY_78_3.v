...
module FAU ( 
  ...
  oai21  g262(.a(new_n416_), .b(new_n412_), .c(new_n232_), .O(new_n419_));
  aoi21  g263(.a(x051), .b(x035), .c(new_n229_), .O(new_n420_));
  nand4  g264(.a(new_n420_), .b(new_n419_), .c(new_n418_), .d(new_n415_), .O(new_n421_));
  inv1   g265(.a(new_n421_), .O(new_n422_));
  oai21  g266(.a(new_n422_), .b(x043), .c(new_n181_), .O(z11));
  ...
  nor2   g388(.a(new_n179_), .b(new_n178_), .O(z18));
  nor2   g389(.a(new_n179_), .b(new_n178_), .O(z19));
  nor2   g390(.a(new_n179_), .b(new_n178_), .O(z21));
