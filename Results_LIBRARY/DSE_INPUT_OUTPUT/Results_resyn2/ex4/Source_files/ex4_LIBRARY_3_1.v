...
module FAU ( 
  ...
  nand3  g319(.a(new_n475_), .b(new_n473_), .c(new_n248_), .O(new_n476_));
  nand2  g320(.a(new_n474_), .b(new_n471_), .O(new_n477_));
  nand2  g321(.a(new_n472_), .b(x012), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n477_), .c(new_n247_), .O(new_n479_));
  ...
  nand2  g328(.a(new_n484_), .b(new_n179_), .O(z12));
  ...
  nand2  g364(.a(new_n177_), .b(new_n253_), .O(new_n521_));
  ...
  nor2   g418(.a(new_n177_), .b(x045), .O(z20));
  nor2   g419(.a(new_n177_), .b(x045), .O(z22));
  nor2   g420(.a(new_n177_), .b(x045), .O(z24));
  nor2   g421(.a(new_n177_), .b(x045), .O(z25));
endmodule
