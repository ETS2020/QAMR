...
module FAU ( 
  ...
  nand2  g156(.a(new_n180_), .b(x046), .O(new_n313_));
  ...
  nor2   g420(.a(new_n178_), .b(new_n177_), .O(z17));
  nor2   g421(.a(new_n178_), .b(new_n177_), .O(z21));
