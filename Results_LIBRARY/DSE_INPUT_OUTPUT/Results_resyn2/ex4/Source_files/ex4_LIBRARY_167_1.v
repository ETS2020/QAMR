...
module FAU ( 
  ...
  nor2   g002(.a(new_n158_), .b(x057), .O(z15));
  ...
  nand2  g159(.a(new_n315_), .b(new_n160_), .O(z05));
  ...
  nand2  g284(.a(new_n441_), .b(new_n160_), .O(z09));
  ...
  oai21  g323(.a(new_n480_), .b(x044), .c(new_n160_), .O(z12));
  ...
  zero   g416(.O(z23));
  zero   g417(.O(z26));
  nor2   g418(.a(new_n158_), .b(x057), .O(z16));
  nor2   g419(.a(new_n158_), .b(x057), .O(z18));
  nor2   g420(.a(new_n158_), .b(x057), .O(z19));
  nor2   g421(.a(new_n158_), .b(x057), .O(z20));
  nor2   g422(.a(new_n158_), .b(x057), .O(z22));
  nor2   g423(.a(new_n158_), .b(x057), .O(z24));
  nor2   g424(.a(new_n158_), .b(x057), .O(z25));
  nor2   g425(.a(new_n158_), .b(x057), .O(z27));
endmodule
