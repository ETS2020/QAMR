...
module FAU ( 
  ...
  aoi22  g301(.a(new_n457_), .b(x011), .c(x051), .d(new_n224_), .O(new_n458_));
  ...
  oai21  g306(.a(new_n460_), .b(new_n456_), .c(new_n236_), .O(new_n463_));
  aoi21  g307(.a(x051), .b(x035), .c(new_n233_), .O(new_n464_));
  ...
  zero   g414(.O(z22));
  zero   g415(.O(z27));
  inv1   g416(.a(new_n178_), .O(z17));
  inv1   g417(.a(new_n178_), .O(z19));
  inv1   g418(.a(new_n178_), .O(z20));
  inv1   g419(.a(new_n178_), .O(z23));
  inv1   g420(.a(new_n178_), .O(z24));
