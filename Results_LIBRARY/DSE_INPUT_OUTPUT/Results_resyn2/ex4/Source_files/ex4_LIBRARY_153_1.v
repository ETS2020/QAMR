...
module FAU ( 
  ...
  oai21  g304(.a(new_n458_), .b(new_n453_), .c(new_n215_), .O(new_n461_));
  aoi21  g305(.a(x050), .b(x034), .c(new_n213_), .O(new_n462_));
  nand4  g306(.a(new_n462_), .b(new_n461_), .c(new_n460_), .d(new_n457_), .O(new_n463_));
  and2   g307(.a(new_n463_), .b(new_n202_), .O(z10));
  nand2  g308(.a(x067), .b(x019), .O(new_n465_));
  inv1   g309(.a(new_n465_), .O(new_n466_));
  nand2  g310(.a(x083), .b(x003), .O(new_n467_));
  aoi22  g311(.a(new_n467_), .b(x011), .c(x051), .d(new_n225_), .O(new_n468_));
  ...
  oai21  g316(.a(new_n470_), .b(new_n466_), .c(new_n237_), .O(new_n473_));
  aoi21  g317(.a(x051), .b(x035), .c(new_n234_), .O(new_n474_));
  ...
  nand2  g369(.a(new_n177_), .b(new_n260_), .O(new_n526_));
  ...
  nand2  g412(.a(new_n179_), .b(new_n568_), .O(new_n569_));
  ...
  zero   g420(.O(z23));
  zero   g421(.O(z25));
  nor2   g422(.a(new_n177_), .b(x045), .O(z16));
  nor2   g423(.a(new_n177_), .b(x045), .O(z20));
  nor2   g424(.a(new_n177_), .b(x045), .O(z24));
