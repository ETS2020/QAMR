// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:31 2020
...
module FAU ( 
  ...
  aoi21  g256(.a(new_n413_), .b(new_n402_), .c(x048), .O(new_n414_));
  nand2  g257(.a(new_n382_), .b(x000), .O(new_n415_));
  nand3  g258(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n416_));
  aoi21  g259(.a(new_n416_), .b(new_n415_), .c(x064), .O(new_n417_));
  and2   g260(.a(new_n397_), .b(new_n173_), .O(new_n418_));
  ...
  aoi21  g264(.a(new_n157_), .b(x032), .c(new_n411_), .O(new_n422_));
  ...
  oai21  g268(.a(new_n420_), .b(x032), .c(new_n170_), .O(new_n426_));
  ...
  aoi22  g276(.a(new_n433_), .b(x009), .c(x049), .d(new_n186_), .O(new_n434_));
  ...
  oai21  g281(.a(new_n436_), .b(new_n432_), .c(new_n198_), .O(new_n439_));
  aoi21  g282(.a(x049), .b(x033), .c(new_n195_), .O(new_n440_));
  ...
  inv1   g299(.a(x051), .O(new_n457_));
  nand2  g300(.a(x067), .b(x019), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(new_n177_), .O(new_n459_));
  nand3  g302(.a(new_n232_), .b(x035), .c(x011), .O(new_n460_));
  aoi22  g303(.a(new_n460_), .b(new_n459_), .c(x083), .d(x003), .O(new_n461_));
  nand4  g304(.a(new_n458_), .b(x075), .c(x035), .d(new_n177_), .O(new_n462_));
  inv1   g305(.a(new_n462_), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n461_), .c(new_n457_), .O(new_n464_));
  nor2   g307(.a(new_n458_), .b(x075), .O(new_n465_));
  nand2  g308(.a(x083), .b(x003), .O(new_n466_));
  oai21  g309(.a(new_n457_), .b(x011), .c(x075), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n466_), .O(new_n468_));
  nand4  g311(.a(new_n458_), .b(new_n232_), .c(x051), .d(x011), .O(new_n469_));
  oai21  g312(.a(new_n468_), .b(new_n465_), .c(new_n469_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n227_), .O(new_n471_));
  nand3  g314(.a(new_n471_), .b(new_n464_), .c(new_n221_), .O(new_n472_));
  ...
  aoi22  g319(.a(new_n476_), .b(x012), .c(x052), .d(new_n238_), .O(new_n477_));
  ...
  oai21  g324(.a(new_n479_), .b(new_n475_), .c(new_n250_), .O(new_n482_));
  aoi21  g325(.a(x052), .b(x036), .c(new_n247_), .O(new_n483_));
  ...
  nand3  g340(.a(new_n497_), .b(new_n496_), .c(new_n257_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n495_), .O(new_n499_));
  oai22  g342(.a(new_n490_), .b(new_n262_), .c(x125), .d(x101), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n256_), .O(new_n502_));
  nand3  g345(.a(x101), .b(x069), .c(new_n308_), .O(new_n503_));
  nand3  g346(.a(new_n285_), .b(x125), .c(new_n262_), .O(new_n504_));
  nand3  g347(.a(new_n504_), .b(new_n503_), .c(new_n255_), .O(new_n505_));
  inv1   g348(.a(new_n505_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n502_), .c(new_n297_), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(new_n494_), .c(new_n178_), .O(new_n508_));
  inv1   g351(.a(new_n278_), .O(new_n509_));
  inv1   g352(.a(new_n286_), .O(new_n510_));
  nand2  g353(.a(x069), .b(new_n308_), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n293_), .c(new_n297_), .O(new_n512_));
  nand3  g355(.a(new_n490_), .b(new_n256_), .c(x029), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n262_), .c(x085), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n512_), .c(new_n178_), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n304_), .O(new_n516_));
  aoi22  g359(.a(new_n516_), .b(new_n509_), .c(new_n510_), .d(x077), .O(new_n517_));
  aoi21  g360(.a(new_n517_), .b(new_n508_), .c(x053), .O(new_n518_));
  nand2  g361(.a(new_n492_), .b(x005), .O(new_n519_));
  nand3  g362(.a(new_n255_), .b(x029), .c(new_n261_), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n519_), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(new_n256_), .O(new_n522_));
  nand2  g365(.a(new_n488_), .b(new_n255_), .O(new_n523_));
  aoi21  g366(.a(new_n523_), .b(new_n522_), .c(new_n308_), .O(new_n524_));
  nand3  g367(.a(x085), .b(new_n261_), .c(x005), .O(new_n525_));
  aoi22  g368(.a(new_n525_), .b(new_n286_), .c(x037), .d(x013), .O(new_n526_));
  oai21  g369(.a(new_n526_), .b(new_n524_), .c(new_n178_), .O(new_n527_));
  nand2  g370(.a(x085), .b(x005), .O(new_n528_));
  oai21  g371(.a(new_n528_), .b(x037), .c(new_n261_), .O(new_n529_));
  aoi22  g372(.a(new_n529_), .b(x077), .c(x053), .d(x037), .O(new_n530_));
  nand2  g373(.a(new_n530_), .b(new_n527_), .O(new_n531_));
  oai21  g374(.a(new_n531_), .b(new_n518_), .c(new_n487_), .O(new_n532_));
  nand2  g375(.a(new_n532_), .b(new_n180_), .O(z13));
  inv1   g376(.a(x046), .O(new_n534_));
  oai21  g377(.a(new_n318_), .b(x022), .c(new_n326_), .O(new_n535_));
  nand2  g378(.a(new_n535_), .b(x070), .O(new_n536_));
  nand2  g379(.a(x094), .b(x062), .O(new_n537_));
  oai21  g380(.a(x070), .b(x014), .c(x022), .O(new_n538_));
  nand2  g381(.a(new_n340_), .b(new_n336_), .O(new_n539_));
  ...
  nand3  g387(.a(new_n544_), .b(new_n543_), .c(new_n318_), .O(new_n545_));
  nand2  g388(.a(new_n545_), .b(new_n542_), .O(new_n546_));
  oai22  g389(.a(new_n537_), .b(new_n323_), .c(x126), .d(x102), .O(new_n547_));
  nand2  g390(.a(new_n547_), .b(new_n546_), .O(new_n548_));
  nand2  g391(.a(new_n548_), .b(new_n317_), .O(new_n549_));
  nand3  g392(.a(x102), .b(x070), .c(new_n370_), .O(new_n550_));
  nand3  g393(.a(new_n346_), .b(x126), .c(new_n323_), .O(new_n551_));
  nand3  g394(.a(new_n551_), .b(new_n550_), .c(new_n316_), .O(new_n552_));
  inv1   g395(.a(new_n552_), .O(new_n553_));
  aoi21  g396(.a(new_n553_), .b(new_n549_), .c(new_n359_), .O(new_n554_));
  oai21  g397(.a(new_n554_), .b(new_n541_), .c(new_n347_), .O(new_n555_));
  inv1   g398(.a(new_n339_), .O(new_n556_));
  inv1   g399(.a(new_n348_), .O(new_n557_));
  nand2  g400(.a(x070), .b(new_n370_), .O(new_n558_));
  aoi21  g401(.a(new_n558_), .b(new_n355_), .c(new_n359_), .O(new_n559_));
  nand3  g402(.a(new_n537_), .b(new_n317_), .c(x030), .O(new_n560_));
  aoi21  g403(.a(new_n560_), .b(new_n323_), .c(x086), .O(new_n561_));
  oai21  g404(.a(new_n561_), .b(new_n559_), .c(new_n347_), .O(new_n562_));
  ...
  nand3  g409(.a(new_n316_), .b(x030), .c(new_n322_), .O(new_n567_));
  nand2  g410(.a(new_n567_), .b(new_n566_), .O(new_n568_));
  nand2  g411(.a(new_n568_), .b(new_n317_), .O(new_n569_));
  nand2  g412(.a(new_n535_), .b(new_n316_), .O(new_n570_));
  aoi21  g413(.a(new_n570_), .b(new_n569_), .c(new_n370_), .O(new_n571_));
  nand3  g414(.a(x086), .b(new_n322_), .c(x006), .O(new_n572_));
  aoi22  g415(.a(new_n572_), .b(new_n348_), .c(x038), .d(x014), .O(new_n573_));
  oai21  g416(.a(new_n573_), .b(new_n571_), .c(new_n347_), .O(new_n574_));
  nand2  g417(.a(x086), .b(x006), .O(new_n575_));
  oai21  g418(.a(new_n575_), .b(x038), .c(new_n322_), .O(new_n576_));
  ...
  nand2  g422(.a(new_n579_), .b(new_n180_), .O(z14));
  zero   g423(.O(z07));
  zero   g424(.O(z15));
  zero   g425(.O(z17));
  zero   g426(.O(z21));
  ...
  zero   g429(.O(z26));
  zero   g430(.O(z27));
  nor2   g431(.a(new_n178_), .b(new_n177_), .O(z18));
  nor2   g432(.a(new_n178_), .b(new_n177_), .O(z19));
  nor2   g433(.a(new_n178_), .b(new_n177_), .O(z20));
  nor2   g434(.a(new_n178_), .b(new_n177_), .O(z23));
  nor2   g435(.a(new_n178_), .b(new_n177_), .O(z25));
endmodule
