...
module FAU ( 
  ...
  nand2  g101(.a(new_n257_), .b(x098), .O(new_n258_));
  ...
  aoi22  g289(.a(new_n445_), .b(x010), .c(x050), .d(new_n198_), .O(new_n446_));
  ...
  oai21  g294(.a(new_n448_), .b(new_n444_), .c(new_n210_), .O(new_n451_));
  ...
  oai21  g322(.a(new_n476_), .b(new_n472_), .c(new_n243_), .O(new_n479_));
  aoi21  g323(.a(x052), .b(x036), .c(new_n240_), .O(new_n480_));
  ...
  nand2  g364(.a(new_n520_), .b(x098), .O(new_n521_));
  ...
  zero   g417(.O(z25));
  zero   g418(.O(z26));
  nor2   g419(.a(x098), .b(x077), .O(z15));
  nor2   g420(.a(x098), .b(x077), .O(z16));
  nor2   g421(.a(x098), .b(x077), .O(z17));
  nor2   g422(.a(x098), .b(x077), .O(z21));
  nor2   g423(.a(x098), .b(x077), .O(z27));
endmodule
