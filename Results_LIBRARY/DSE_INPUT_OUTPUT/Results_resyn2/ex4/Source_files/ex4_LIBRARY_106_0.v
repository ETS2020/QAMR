// Benchmark "FAU" written by ABC on Wed Aug 12 10:06:57 2020
...
module FAU ( 
  ...
  oai21  g088(.a(x052), .b(new_n243_), .c(new_n244_), .O(new_n245_));
  nand3  g089(.a(new_n245_), .b(new_n242_), .c(x012), .O(new_n246_));
  nand2  g090(.a(new_n246_), .b(new_n240_), .O(new_n247_));
  inv1   g091(.a(x052), .O(new_n248_));
  nand2  g092(.a(new_n248_), .b(new_n243_), .O(new_n249_));
  oai21  g093(.a(new_n244_), .b(new_n241_), .c(x012), .O(new_n250_));
  nand2  g094(.a(new_n244_), .b(x036), .O(new_n251_));
  nand2  g095(.a(new_n241_), .b(x052), .O(new_n252_));
  nand3  g096(.a(new_n252_), .b(new_n251_), .c(new_n250_), .O(new_n253_));
  nand2  g097(.a(new_n253_), .b(x076), .O(new_n254_));
  nand3  g098(.a(new_n254_), .b(new_n249_), .c(new_n247_), .O(new_n255_));
  ...
  nor2   g113(.a(new_n269_), .b(x029), .O(new_n270_));
  nand3  g114(.a(new_n270_), .b(new_n268_), .c(new_n267_), .O(new_n271_));
  ...
  nor2   g119(.a(new_n275_), .b(new_n273_), .O(new_n276_));
  aoi22  g120(.a(new_n269_), .b(new_n266_), .c(x125), .d(x101), .O(new_n277_));
  oai21  g121(.a(new_n277_), .b(new_n276_), .c(x069), .O(new_n278_));
  ...
  oai21  g131(.a(new_n287_), .b(new_n272_), .c(x077), .O(new_n288_));
  nand2  g132(.a(x117), .b(x109), .O(new_n289_));
  inv1   g133(.a(x077), .O(new_n290_));
  nand2  g134(.a(x069), .b(x021), .O(new_n291_));
  aoi21  g135(.a(new_n291_), .b(new_n280_), .c(x005), .O(new_n292_));
  nand2  g136(.a(x069), .b(new_n261_), .O(new_n293_));
  oai21  g137(.a(new_n293_), .b(new_n269_), .c(x021), .O(new_n294_));
  aoi21  g138(.a(new_n294_), .b(x085), .c(new_n292_), .O(new_n295_));
  nand2  g139(.a(x085), .b(new_n265_), .O(new_n296_));
  oai21  g140(.a(new_n295_), .b(new_n290_), .c(new_n296_), .O(new_n297_));
  nand2  g141(.a(new_n260_), .b(new_n266_), .O(new_n298_));
  nor2   g142(.a(new_n298_), .b(x077), .O(new_n299_));
  aoi21  g143(.a(new_n297_), .b(new_n289_), .c(new_n299_), .O(new_n300_));
  aoi21  g144(.a(new_n300_), .b(new_n288_), .c(new_n258_), .O(new_n301_));
  inv1   g145(.a(x005), .O(new_n302_));
  nand2  g146(.a(new_n268_), .b(new_n302_), .O(new_n303_));
  nand3  g147(.a(x085), .b(new_n261_), .c(x013), .O(new_n304_));
  nand2  g148(.a(new_n304_), .b(new_n303_), .O(new_n305_));
  nand2  g149(.a(new_n305_), .b(x069), .O(new_n306_));
  nand2  g150(.a(new_n263_), .b(x085), .O(new_n307_));
  aoi21  g151(.a(new_n307_), .b(new_n306_), .c(x037), .O(new_n308_));
  nand2  g152(.a(new_n259_), .b(x013), .O(new_n309_));
  ...
  nand3  g157(.a(new_n259_), .b(x037), .c(new_n302_), .O(new_n314_));
  nand2  g158(.a(new_n314_), .b(x013), .O(new_n315_));
  aoi22  g159(.a(new_n315_), .b(new_n290_), .c(new_n258_), .d(new_n313_), .O(new_n316_));
  nand2  g160(.a(new_n316_), .b(new_n312_), .O(new_n317_));
  oai21  g161(.a(new_n317_), .b(new_n301_), .c(x045), .O(new_n318_));
  nand2  g162(.a(new_n318_), .b(new_n159_), .O(z05));
  nor2   g163(.a(z07), .b(x046), .O(new_n320_));
  ...
  or2    g168(.a(new_n324_), .b(x070), .O(new_n325_));
  ...
  nand4  g177(.a(new_n333_), .b(new_n332_), .c(new_n329_), .d(new_n322_), .O(new_n334_));
  aoi21  g178(.a(new_n334_), .b(new_n325_), .c(new_n321_), .O(new_n335_));
  inv1   g179(.a(new_n323_), .O(new_n336_));
  aoi21  g180(.a(x038), .b(x014), .c(x022), .O(new_n337_));
  aoi21  g181(.a(new_n336_), .b(x030), .c(new_n337_), .O(new_n338_));
  nor2   g182(.a(x094), .b(x062), .O(new_n339_));
  aoi22  g183(.a(new_n339_), .b(new_n327_), .c(x126), .d(x102), .O(new_n340_));
  oai21  g184(.a(new_n340_), .b(new_n338_), .c(x070), .O(new_n341_));
  inv1   g185(.a(x102), .O(new_n342_));
  nand2  g186(.a(new_n328_), .b(x038), .O(new_n343_));
  ...
  nand3  g198(.a(new_n332_), .b(x070), .c(new_n322_), .O(new_n355_));
  aoi21  g199(.a(new_n355_), .b(x022), .c(new_n321_), .O(new_n356_));
  oai21  g200(.a(new_n356_), .b(new_n354_), .c(x078), .O(new_n357_));
  oai21  g201(.a(new_n321_), .b(x014), .c(new_n357_), .O(new_n358_));
  nand2  g202(.a(new_n358_), .b(new_n352_), .O(new_n359_));
  inv1   g203(.a(x078), .O(new_n360_));
  nand3  g204(.a(new_n360_), .b(new_n328_), .c(new_n327_), .O(new_n361_));
  nand3  g205(.a(new_n361_), .b(new_n359_), .c(new_n351_), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(x054), .O(new_n363_));
  inv1   g207(.a(x038), .O(new_n364_));
  inv1   g208(.a(x006), .O(new_n365_));
  nand2  g209(.a(new_n333_), .b(new_n365_), .O(new_n366_));
  nand3  g210(.a(x086), .b(new_n322_), .c(x014), .O(new_n367_));
  aoi21  g211(.a(new_n367_), .b(new_n366_), .c(new_n328_), .O(new_n368_));
  nor2   g212(.a(new_n324_), .b(new_n321_), .O(new_n369_));
  oai21  g213(.a(new_n369_), .b(new_n368_), .c(new_n364_), .O(new_n370_));
  nand2  g214(.a(new_n328_), .b(new_n327_), .O(new_n371_));
  ...
  nor2   g219(.a(x086), .b(x006), .O(new_n376_));
  aoi21  g220(.a(new_n376_), .b(x038), .c(new_n326_), .O(new_n377_));
  inv1   g221(.a(x054), .O(new_n378_));
  aoi21  g222(.a(new_n378_), .b(new_n364_), .c(z07), .O(new_n379_));
  oai21  g223(.a(new_n377_), .b(x078), .c(new_n379_), .O(new_n380_));
  aoi21  g224(.a(new_n375_), .b(x078), .c(new_n380_), .O(new_n381_));
  aoi21  g225(.a(new_n381_), .b(new_n363_), .c(new_n320_), .O(z06));
  ...
  aoi22  g289(.a(new_n445_), .b(x010), .c(x050), .d(new_n205_), .O(new_n446_));
  ...
  oai21  g294(.a(new_n448_), .b(new_n444_), .c(new_n217_), .O(new_n451_));
  aoi21  g295(.a(x050), .b(x034), .c(new_n214_), .O(new_n452_));
  ...
  oai21  g314(.a(new_n290_), .b(x012), .c(new_n240_), .O(new_n471_));
  and2   g315(.a(new_n471_), .b(new_n470_), .O(new_n472_));
  nand4  g316(.a(x084), .b(x077), .c(x012), .d(x004), .O(new_n473_));
  oai21  g317(.a(z07), .b(new_n248_), .c(new_n473_), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(new_n472_), .c(x036), .O(new_n475_));
  nand2  g319(.a(x084), .b(x004), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(x036), .c(x076), .O(new_n477_));
  nand2  g321(.a(new_n476_), .b(new_n469_), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n477_), .c(new_n471_), .O(new_n479_));
  oai21  g323(.a(new_n469_), .b(new_n240_), .c(new_n473_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n248_), .O(new_n481_));
  nand2  g325(.a(x077), .b(new_n243_), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(new_n469_), .c(new_n240_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x012), .O(new_n484_));
  nand3  g328(.a(new_n484_), .b(new_n481_), .c(new_n479_), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n475_), .c(x044), .O(z12));
  inv1   g331(.a(x045), .O(new_n488_));
  oai21  g332(.a(new_n261_), .b(x021), .c(new_n269_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x069), .O(new_n490_));
  nand2  g334(.a(x093), .b(x061), .O(new_n491_));
  oai21  g335(.a(x069), .b(x013), .c(x021), .O(new_n492_));
  nand2  g336(.a(new_n283_), .b(new_n279_), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n492_), .c(new_n491_), .d(x029), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n490_), .c(x085), .O(new_n495_));
  oai21  g339(.a(x037), .b(x013), .c(x021), .O(new_n496_));
  inv1   g340(.a(x061), .O(new_n497_));
  inv1   g341(.a(x093), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n497_), .c(new_n261_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n496_), .O(new_n500_));
  oai22  g344(.a(new_n491_), .b(new_n266_), .c(x125), .d(x101), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n260_), .O(new_n503_));
  nand3  g347(.a(x101), .b(x069), .c(new_n313_), .O(new_n504_));
  nand3  g348(.a(new_n289_), .b(x125), .c(new_n266_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n259_), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n503_), .c(new_n302_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n495_), .c(new_n290_), .O(new_n509_));
  inv1   g353(.a(new_n282_), .O(new_n510_));
  inv1   g354(.a(new_n291_), .O(new_n511_));
  nand2  g355(.a(x069), .b(new_n313_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n298_), .c(new_n302_), .O(new_n513_));
  nand3  g357(.a(new_n491_), .b(new_n260_), .c(x029), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n266_), .c(x085), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n513_), .c(new_n290_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n309_), .O(new_n517_));
  aoi22  g361(.a(new_n517_), .b(new_n510_), .c(new_n511_), .d(x077), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n509_), .c(x053), .O(new_n519_));
  nand2  g363(.a(new_n493_), .b(x005), .O(new_n520_));
  nand3  g364(.a(new_n259_), .b(x029), .c(new_n265_), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n520_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n260_), .O(new_n523_));
  nand2  g367(.a(new_n489_), .b(new_n259_), .O(new_n524_));
  aoi21  g368(.a(new_n524_), .b(new_n523_), .c(new_n313_), .O(new_n525_));
  nand3  g369(.a(x085), .b(new_n265_), .c(x005), .O(new_n526_));
  aoi22  g370(.a(new_n526_), .b(new_n291_), .c(x037), .d(x013), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n525_), .c(new_n290_), .O(new_n528_));
  nand2  g372(.a(x085), .b(x005), .O(new_n529_));
  oai21  g373(.a(new_n529_), .b(x037), .c(new_n265_), .O(new_n530_));
  ...
  nand2  g377(.a(new_n533_), .b(new_n159_), .O(z13));
  inv1   g378(.a(new_n320_), .O(new_n535_));
  inv1   g379(.a(new_n345_), .O(new_n536_));
  nand2  g380(.a(x070), .b(new_n364_), .O(new_n537_));
  aoi21  g381(.a(new_n537_), .b(new_n371_), .c(new_n365_), .O(new_n538_));
  nand3  g382(.a(new_n323_), .b(new_n328_), .c(x030), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n327_), .c(x086), .O(new_n540_));
  oai21  g384(.a(new_n540_), .b(new_n538_), .c(new_n536_), .O(new_n541_));
  aoi21  g385(.a(x030), .b(new_n327_), .c(new_n332_), .O(new_n542_));
  oai21  g386(.a(x070), .b(x014), .c(x022), .O(new_n543_));
  nand2  g387(.a(new_n346_), .b(new_n342_), .O(new_n544_));
  nand4  g388(.a(new_n544_), .b(new_n543_), .c(new_n323_), .d(x030), .O(new_n545_));
  oai21  g389(.a(new_n542_), .b(new_n328_), .c(new_n545_), .O(new_n546_));
  nand2  g390(.a(new_n546_), .b(new_n321_), .O(new_n547_));
  oai21  g391(.a(x038), .b(x014), .c(x022), .O(new_n548_));
  oai21  g392(.a(new_n332_), .b(x030), .c(new_n548_), .O(new_n549_));
  oai21  g393(.a(new_n323_), .b(new_n327_), .c(new_n544_), .O(new_n550_));
  aoi21  g394(.a(new_n550_), .b(new_n549_), .c(x070), .O(new_n551_));
  nand3  g395(.a(x102), .b(x070), .c(new_n364_), .O(new_n552_));
  nand3  g396(.a(new_n352_), .b(x126), .c(new_n327_), .O(new_n553_));
  nand3  g397(.a(new_n553_), .b(new_n552_), .c(new_n321_), .O(new_n554_));
  oai21  g398(.a(new_n554_), .b(new_n551_), .c(x006), .O(new_n555_));
  nand3  g399(.a(new_n555_), .b(new_n547_), .c(new_n541_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n360_), .O(new_n557_));
  inv1   g401(.a(new_n353_), .O(new_n558_));
  nor2   g402(.a(x086), .b(new_n326_), .O(new_n559_));
  aoi22  g403(.a(new_n559_), .b(new_n536_), .c(new_n558_), .d(x078), .O(new_n560_));
  nand2  g404(.a(new_n560_), .b(new_n557_), .O(new_n561_));
  nand2  g405(.a(new_n561_), .b(new_n378_), .O(new_n562_));
  nand2  g406(.a(new_n544_), .b(x006), .O(new_n563_));
  nand3  g407(.a(new_n321_), .b(x030), .c(new_n326_), .O(new_n564_));
  aoi21  g408(.a(new_n564_), .b(new_n563_), .c(x070), .O(new_n565_));
  nor2   g409(.a(new_n542_), .b(x086), .O(new_n566_));
  oai21  g410(.a(new_n566_), .b(new_n565_), .c(x038), .O(new_n567_));
  nand2  g411(.a(x086), .b(x006), .O(new_n568_));
  oai21  g412(.a(new_n568_), .b(x014), .c(new_n353_), .O(new_n569_));
  oai21  g413(.a(new_n364_), .b(new_n326_), .c(new_n569_), .O(new_n570_));
  nand2  g414(.a(new_n570_), .b(new_n567_), .O(new_n571_));
  oai21  g415(.a(new_n568_), .b(x038), .c(new_n326_), .O(new_n572_));
  nand2  g416(.a(new_n572_), .b(x078), .O(new_n573_));
  oai21  g417(.a(new_n378_), .b(new_n364_), .c(new_n573_), .O(new_n574_));
  aoi21  g418(.a(new_n571_), .b(new_n360_), .c(new_n574_), .O(new_n575_));
  aoi21  g419(.a(new_n575_), .b(new_n562_), .c(new_n535_), .O(z14));
  zero   g420(.O(z15));
  zero   g421(.O(z16));
  zero   g422(.O(z17));
  zero   g423(.O(z20));
  ...
  zero   g427(.O(z26));
  zero   g428(.O(z27));
  nor2   g429(.a(x077), .b(x076), .O(z18));
  nor2   g430(.a(x077), .b(x076), .O(z19));
  nor2   g431(.a(x077), .b(x076), .O(z24));
  nor2   g432(.a(x077), .b(x076), .O(z25));
endmodule
