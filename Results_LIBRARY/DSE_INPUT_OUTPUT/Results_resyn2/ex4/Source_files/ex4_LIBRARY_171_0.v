...
module FAU ( 
  ...
  oai21  g348(.a(new_n505_), .b(new_n492_), .c(new_n289_), .O(new_n506_));
  ...
  oai21  g355(.a(new_n512_), .b(new_n510_), .c(new_n289_), .O(new_n513_));
  ...
  oai21  g367(.a(new_n524_), .b(new_n522_), .c(new_n289_), .O(new_n525_));
  ...
  zero   g420(.O(z23));
  zero   g421(.O(z25));
  nor2   g422(.a(x077), .b(x028), .O(z16));
  nor2   g423(.a(x077), .b(x028), .O(z17));
  nor2   g424(.a(x077), .b(x028), .O(z18));
  nor2   g425(.a(x077), .b(x028), .O(z21));
  nor2   g426(.a(x077), .b(x028), .O(z24));
  nor2   g427(.a(x077), .b(x028), .O(z26));
  nor2   g428(.a(x077), .b(x028), .O(z27));
endmodule
