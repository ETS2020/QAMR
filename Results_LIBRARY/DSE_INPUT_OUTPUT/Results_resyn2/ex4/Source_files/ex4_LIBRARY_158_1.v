...
module FAU ( 
  ...
  nand2  g022(.a(x107), .b(new_n178_), .O(new_n179_));
  ...
  nand2  g267(.a(new_n424_), .b(new_n179_), .O(z08));
  ...
  nand3  g273(.a(new_n430_), .b(new_n428_), .c(new_n190_), .O(new_n431_));
  nand2  g274(.a(new_n429_), .b(new_n426_), .O(new_n432_));
  nand2  g275(.a(new_n427_), .b(x009), .O(new_n433_));
  nand3  g276(.a(new_n433_), .b(new_n432_), .c(new_n189_), .O(new_n434_));
  ...
  nand2  g282(.a(new_n439_), .b(new_n179_), .O(z09));
  ...
  oai21  g306(.a(new_n461_), .b(new_n457_), .c(new_n224_), .O(new_n464_));
  aoi21  g307(.a(x051), .b(x035), .c(new_n221_), .O(new_n465_));
