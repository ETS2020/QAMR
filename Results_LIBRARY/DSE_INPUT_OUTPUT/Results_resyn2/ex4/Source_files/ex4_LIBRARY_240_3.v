// Benchmark "FAU" written by ABC on Wed Aug 12 10:10:07 2020
...
module FAU ( 
  ...
  nand2  g020(.a(x077), .b(x060), .O(new_n177_));
  ...
  nand2  g163(.a(new_n319_), .b(new_n177_), .O(z05));
  ...
  aoi22  g218(.a(new_n374_), .b(new_n361_), .c(new_n372_), .d(new_n341_), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n370_), .c(new_n359_), .O(new_n376_));
  nor2   g220(.a(x054), .b(x038), .O(new_n377_));
  nand3  g221(.a(new_n326_), .b(x038), .c(new_n341_), .O(new_n378_));
  aoi21  g222(.a(new_n378_), .b(x014), .c(x078), .O(new_n379_));
  nor3   g223(.a(new_n379_), .b(new_n377_), .c(new_n376_), .O(new_n380_));
  nand2  g224(.a(new_n177_), .b(x046), .O(new_n381_));
  ...
  oai21  g287(.a(new_n441_), .b(new_n437_), .c(new_n195_), .O(new_n444_));
  aoi21  g288(.a(x049), .b(x033), .c(new_n192_), .O(new_n445_));
  nand4  g289(.a(new_n445_), .b(new_n444_), .c(new_n443_), .d(new_n440_), .O(new_n446_));
  inv1   g290(.a(new_n446_), .O(new_n447_));
  oai21  g291(.a(new_n447_), .b(x041), .c(new_n177_), .O(z09));
  ...
  oai21  g301(.a(new_n455_), .b(new_n450_), .c(new_n213_), .O(new_n458_));
  aoi21  g302(.a(x050), .b(x034), .c(new_n211_), .O(new_n459_));
  nand4  g303(.a(new_n459_), .b(new_n458_), .c(new_n457_), .d(new_n454_), .O(new_n460_));
  and2   g304(.a(new_n460_), .b(new_n200_), .O(z10));
  nand2  g305(.a(x067), .b(x019), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  nand2  g307(.a(x083), .b(x003), .O(new_n464_));
  aoi22  g308(.a(new_n464_), .b(x011), .c(x051), .d(new_n223_), .O(new_n465_));
  ...
  oai21  g313(.a(new_n467_), .b(new_n463_), .c(new_n235_), .O(new_n470_));
  aoi21  g314(.a(x051), .b(x035), .c(new_n232_), .O(new_n471_));
  nand4  g315(.a(new_n471_), .b(new_n470_), .c(new_n469_), .d(new_n466_), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(new_n473_));
  nor3   g317(.a(new_n473_), .b(z07), .c(x043), .O(z11));
  ...
  oai21  g327(.a(new_n481_), .b(new_n476_), .c(new_n252_), .O(new_n484_));
  aoi21  g328(.a(x052), .b(x036), .c(new_n250_), .O(new_n485_));
  nand4  g329(.a(new_n485_), .b(new_n484_), .c(new_n483_), .d(new_n480_), .O(new_n486_));
  and2   g330(.a(new_n486_), .b(new_n239_), .O(z12));
  inv1   g331(.a(x045), .O(new_n488_));
  oai21  g332(.a(new_n262_), .b(x021), .c(new_n270_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x069), .O(new_n490_));
  nand2  g334(.a(x093), .b(x061), .O(new_n491_));
  oai21  g335(.a(x069), .b(x013), .c(x021), .O(new_n492_));
  nand2  g336(.a(new_n284_), .b(new_n280_), .O(new_n493_));
  ...
  nand3  g342(.a(new_n498_), .b(new_n497_), .c(new_n262_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n496_), .O(new_n500_));
  oai22  g344(.a(new_n491_), .b(new_n267_), .c(x125), .d(x101), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n261_), .O(new_n503_));
  nand3  g347(.a(x101), .b(x069), .c(new_n314_), .O(new_n504_));
  nand3  g348(.a(new_n290_), .b(x125), .c(new_n267_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n260_), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n503_), .c(new_n303_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n495_), .c(new_n291_), .O(new_n509_));
  inv1   g353(.a(new_n283_), .O(new_n510_));
  inv1   g354(.a(new_n292_), .O(new_n511_));
  nand2  g355(.a(x069), .b(new_n314_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n299_), .c(new_n303_), .O(new_n513_));
  nand3  g357(.a(new_n491_), .b(new_n261_), .c(x029), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n267_), .c(x085), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n513_), .c(new_n291_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n310_), .O(new_n517_));
  ...
  nand3  g364(.a(new_n260_), .b(x029), .c(new_n266_), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n520_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n261_), .O(new_n523_));
  nand2  g367(.a(new_n489_), .b(new_n260_), .O(new_n524_));
  aoi21  g368(.a(new_n524_), .b(new_n523_), .c(new_n314_), .O(new_n525_));
  nand3  g369(.a(x085), .b(new_n266_), .c(x005), .O(new_n526_));
  aoi22  g370(.a(new_n526_), .b(new_n292_), .c(x037), .d(x013), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n525_), .c(new_n291_), .O(new_n528_));
  nand2  g372(.a(x085), .b(x005), .O(new_n529_));
  oai21  g373(.a(new_n529_), .b(x037), .c(new_n266_), .O(new_n530_));
  ...
  nand2  g377(.a(new_n533_), .b(new_n177_), .O(z13));
  inv1   g378(.a(x054), .O(new_n535_));
  aoi21  g379(.a(x030), .b(new_n343_), .c(new_n330_), .O(new_n536_));
  oai21  g380(.a(x070), .b(x014), .c(x022), .O(new_n537_));
  nand2  g381(.a(new_n352_), .b(new_n350_), .O(new_n538_));
  nand4  g382(.a(new_n538_), .b(new_n537_), .c(new_n334_), .d(x030), .O(new_n539_));
  oai21  g383(.a(new_n536_), .b(new_n322_), .c(new_n539_), .O(new_n540_));
  nand2  g384(.a(new_n540_), .b(new_n326_), .O(new_n541_));
  oai22  g385(.a(new_n373_), .b(new_n343_), .c(new_n330_), .d(x030), .O(new_n542_));
  oai21  g386(.a(new_n334_), .b(new_n343_), .c(new_n538_), .O(new_n543_));
  aoi21  g387(.a(new_n543_), .b(new_n542_), .c(x070), .O(new_n544_));
  nand3  g388(.a(x102), .b(x070), .c(new_n344_), .O(new_n545_));
  nand3  g389(.a(new_n321_), .b(x126), .c(new_n343_), .O(new_n546_));
  nand3  g390(.a(new_n546_), .b(new_n545_), .c(new_n326_), .O(new_n547_));
  oai21  g391(.a(new_n547_), .b(new_n544_), .c(x006), .O(new_n548_));
  aoi21  g392(.a(new_n548_), .b(new_n541_), .c(x078), .O(new_n549_));
  nand2  g393(.a(x070), .b(new_n344_), .O(new_n550_));
  aoi21  g394(.a(new_n550_), .b(new_n360_), .c(new_n341_), .O(new_n551_));
  nand3  g395(.a(new_n334_), .b(new_n322_), .c(x030), .O(new_n552_));
  aoi21  g396(.a(new_n552_), .b(new_n343_), .c(x086), .O(new_n553_));
  oai21  g397(.a(new_n553_), .b(new_n551_), .c(new_n359_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n371_), .O(new_n555_));
  nand2  g399(.a(new_n555_), .b(new_n353_), .O(new_n556_));
  oai21  g400(.a(new_n324_), .b(new_n359_), .c(new_n556_), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n549_), .c(new_n535_), .O(new_n558_));
  nand2  g402(.a(new_n538_), .b(x006), .O(new_n559_));
  nand3  g403(.a(new_n326_), .b(x030), .c(new_n342_), .O(new_n560_));
  aoi21  g404(.a(new_n560_), .b(new_n559_), .c(x070), .O(new_n561_));
  nor2   g405(.a(new_n536_), .b(x086), .O(new_n562_));
  ...
  aoi21  g409(.a(new_n535_), .b(x038), .c(new_n324_), .O(new_n566_));
  oai21  g410(.a(new_n566_), .b(new_n342_), .c(new_n565_), .O(new_n567_));
  nand2  g411(.a(new_n567_), .b(new_n563_), .O(new_n568_));
  oai21  g412(.a(new_n564_), .b(x038), .c(new_n342_), .O(new_n569_));
  ...
  aoi21  g416(.a(new_n568_), .b(new_n359_), .c(new_n572_), .O(new_n573_));
  aoi22  g417(.a(new_n573_), .b(new_n558_), .c(new_n177_), .d(x046), .O(z14));
  zero   g418(.O(z15));
  zero   g419(.O(z16));
  zero   g420(.O(z20));
  zero   g421(.O(z23));
  zero   g422(.O(z24));
  zero   g423(.O(z26));
  inv1   g424(.a(new_n177_), .O(z17));
  inv1   g425(.a(new_n177_), .O(z18));
  inv1   g426(.a(new_n177_), .O(z19));
  inv1   g427(.a(new_n177_), .O(z21));
  inv1   g428(.a(new_n177_), .O(z22));
  inv1   g429(.a(new_n177_), .O(z25));
  inv1   g430(.a(new_n177_), .O(z27));
endmodule
