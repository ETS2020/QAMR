...
module FAU ( 
  ...
  nand2  g332(.a(new_n488_), .b(new_n179_), .O(z12));
  ...
  zero   g417(.O(z22));
  zero   g418(.O(z27));
  nor2   g419(.a(new_n177_), .b(x045), .O(z17));
  nor2   g420(.a(new_n177_), .b(x045), .O(z19));
  nor2   g421(.a(new_n177_), .b(x045), .O(z20));
  nor2   g422(.a(new_n177_), .b(x045), .O(z23));
