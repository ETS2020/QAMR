// Benchmark "FAU" written by ABC on Wed Aug 12 10:09:59 2020
...
module FAU ( 
  ...
  oai21  g090(.a(new_n246_), .b(new_n234_), .c(new_n179_), .O(z04));
  ...
  nor2   g145(.a(z07), .b(x046), .O(new_n302_));
  ...
  aoi21  g206(.a(new_n362_), .b(new_n348_), .c(z07), .O(new_n363_));
  ...
  inv1   g210(.a(x040), .O(new_n367_));
  inv1   g211(.a(x072), .O(new_n368_));
  nand2  g212(.a(x088), .b(x056), .O(new_n369_));
  oai21  g213(.a(x120), .b(x096), .c(new_n369_), .O(new_n370_));
  ...
  nand4  g220(.a(new_n376_), .b(new_n375_), .c(new_n374_), .d(new_n373_), .O(new_n377_));
  nand3  g221(.a(new_n377_), .b(new_n372_), .c(new_n159_), .O(new_n378_));
  nand2  g222(.a(x112), .b(x104), .O(new_n379_));
  nand3  g223(.a(new_n379_), .b(x120), .c(new_n158_), .O(new_n380_));
  nand3  g224(.a(x096), .b(x064), .c(new_n169_), .O(new_n381_));
  nand3  g225(.a(new_n381_), .b(new_n380_), .c(new_n173_), .O(new_n382_));
  inv1   g226(.a(new_n382_), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n378_), .c(new_n172_), .O(new_n384_));
  inv1   g228(.a(new_n376_), .O(new_n385_));
  nor2   g229(.a(new_n373_), .b(x016), .O(new_n386_));
  oai21  g230(.a(new_n386_), .b(new_n385_), .c(x064), .O(new_n387_));
  nand2  g231(.a(new_n375_), .b(new_n374_), .O(new_n388_));
  oai21  g232(.a(x064), .b(x008), .c(x016), .O(new_n389_));
  nand4  g233(.a(new_n389_), .b(new_n369_), .c(new_n388_), .d(x024), .O(new_n390_));
  aoi21  g234(.a(new_n390_), .b(new_n387_), .c(x080), .O(new_n391_));
  oai21  g235(.a(new_n391_), .b(new_n384_), .c(new_n368_), .O(new_n392_));
  or2    g236(.a(x112), .b(x104), .O(new_n393_));
  nand2  g237(.a(new_n173_), .b(x008), .O(new_n394_));
  nand2  g238(.a(x064), .b(new_n169_), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n160_), .c(new_n172_), .O(new_n396_));
  nand3  g240(.a(new_n369_), .b(new_n159_), .c(x024), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n158_), .c(x080), .O(new_n398_));
  oai21  g242(.a(new_n398_), .b(new_n396_), .c(new_n368_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(new_n394_), .O(new_n400_));
  nor2   g244(.a(new_n159_), .b(new_n158_), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(x072), .O(new_n402_));
  inv1   g246(.a(new_n402_), .O(new_n403_));
  aoi21  g247(.a(new_n400_), .b(new_n393_), .c(new_n403_), .O(new_n404_));
  aoi21  g248(.a(new_n404_), .b(new_n392_), .c(x048), .O(new_n405_));
  ...
  inv1   g252(.a(new_n386_), .O(new_n409_));
  aoi21  g253(.a(new_n409_), .b(new_n376_), .c(x080), .O(new_n410_));
  oai21  g254(.a(new_n410_), .b(new_n408_), .c(x032), .O(new_n411_));
  inv1   g255(.a(new_n401_), .O(new_n412_));
  nand2  g256(.a(x080), .b(x000), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n412_), .O(new_n414_));
  aoi21  g258(.a(new_n157_), .b(x032), .c(new_n412_), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(new_n170_), .c(new_n414_), .O(new_n416_));
  nand2  g260(.a(new_n416_), .b(new_n411_), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n368_), .O(new_n418_));
  oai21  g262(.a(new_n413_), .b(x032), .c(new_n170_), .O(new_n419_));
  aoi22  g263(.a(new_n419_), .b(x072), .c(x048), .d(x032), .O(new_n420_));
  nand2  g264(.a(new_n420_), .b(new_n418_), .O(new_n421_));
  oai21  g265(.a(new_n421_), .b(new_n405_), .c(new_n367_), .O(new_n422_));
  nand2  g266(.a(new_n422_), .b(new_n179_), .O(z08));
  nand2  g267(.a(x065), .b(x017), .O(new_n424_));
  inv1   g268(.a(new_n424_), .O(new_n425_));
  nand2  g269(.a(x081), .b(x001), .O(new_n426_));
  aoi22  g270(.a(new_n426_), .b(x009), .c(x049), .d(new_n185_), .O(new_n427_));
  ...
  oai21  g275(.a(new_n429_), .b(new_n425_), .c(new_n197_), .O(new_n432_));
  aoi21  g276(.a(x049), .b(x033), .c(new_n194_), .O(new_n433_));
  nand4  g277(.a(new_n433_), .b(new_n432_), .c(new_n431_), .d(new_n428_), .O(new_n434_));
  inv1   g278(.a(new_n434_), .O(new_n435_));
  oai21  g279(.a(new_n435_), .b(x041), .c(new_n179_), .O(z09));
  ...
  oai21  g303(.a(new_n457_), .b(new_n453_), .c(new_n230_), .O(new_n460_));
  aoi21  g304(.a(x051), .b(x035), .c(new_n227_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n460_), .c(new_n459_), .d(new_n456_), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  nor3   g307(.a(new_n463_), .b(z07), .c(x043), .O(z11));
  ...
  nand3  g313(.a(new_n469_), .b(new_n467_), .c(new_n243_), .O(new_n470_));
  nand2  g314(.a(new_n468_), .b(new_n465_), .O(new_n471_));
  nand2  g315(.a(new_n466_), .b(x012), .O(new_n472_));
  nand3  g316(.a(new_n472_), .b(new_n471_), .c(new_n242_), .O(new_n473_));
  nand2  g317(.a(new_n468_), .b(new_n466_), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n235_), .O(new_n475_));
  aoi22  g319(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n476_));
  nand4  g320(.a(new_n476_), .b(new_n475_), .c(new_n473_), .d(new_n470_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n234_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n179_), .O(z12));
  nand2  g323(.a(x069), .b(new_n249_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n252_), .c(new_n258_), .O(new_n481_));
  nand3  g325(.a(new_n263_), .b(new_n259_), .c(x029), .O(new_n482_));
  nor2   g326(.a(x021), .b(x013), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(new_n482_), .c(x085), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n481_), .c(new_n271_), .O(new_n485_));
  oai21  g329(.a(new_n260_), .b(x021), .c(new_n266_), .O(new_n486_));
  and2   g330(.a(new_n486_), .b(x069), .O(new_n487_));
  nand2  g331(.a(new_n270_), .b(new_n273_), .O(new_n488_));
  oai21  g332(.a(x069), .b(x013), .c(x021), .O(new_n489_));
  nand4  g333(.a(new_n489_), .b(new_n488_), .c(new_n263_), .d(x029), .O(new_n490_));
  inv1   g334(.a(new_n490_), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n487_), .c(new_n281_), .O(new_n492_));
  oai21  g336(.a(x037), .b(x013), .c(x021), .O(new_n493_));
  oai21  g337(.a(new_n267_), .b(x029), .c(new_n493_), .O(new_n494_));
  oai21  g338(.a(new_n263_), .b(new_n261_), .c(new_n488_), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n494_), .c(x069), .O(new_n496_));
  nand3  g340(.a(new_n277_), .b(x125), .c(new_n261_), .O(new_n497_));
  nand3  g341(.a(x101), .b(x069), .c(new_n249_), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n497_), .c(new_n281_), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n496_), .c(x005), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n492_), .c(new_n485_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n250_), .O(new_n502_));
  inv1   g346(.a(new_n279_), .O(new_n503_));
  aoi21  g347(.a(x085), .b(x005), .c(new_n503_), .O(new_n504_));
  oai21  g348(.a(x053), .b(new_n249_), .c(new_n503_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(x013), .c(new_n504_), .O(new_n506_));
  nand2  g350(.a(new_n488_), .b(x005), .O(new_n507_));
  nand3  g351(.a(new_n281_), .b(x029), .c(new_n253_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n259_), .O(new_n510_));
  aoi21  g354(.a(new_n486_), .b(new_n281_), .c(x053), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n510_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(x037), .c(new_n506_), .O(new_n513_));
  nand2  g357(.a(new_n177_), .b(new_n248_), .O(new_n514_));
  aoi21  g358(.a(new_n513_), .b(new_n502_), .c(new_n514_), .O(z13));
  inv1   g359(.a(new_n302_), .O(new_n516_));
  inv1   g360(.a(new_n328_), .O(new_n517_));
  nand2  g361(.a(x070), .b(new_n348_), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n355_), .c(new_n349_), .O(new_n519_));
  nand3  g363(.a(new_n305_), .b(new_n310_), .c(x030), .O(new_n520_));
  aoi21  g364(.a(new_n520_), .b(new_n309_), .c(x086), .O(new_n521_));
  oai21  g365(.a(new_n521_), .b(new_n519_), .c(new_n517_), .O(new_n522_));
  aoi21  g366(.a(x030), .b(new_n309_), .c(new_n314_), .O(new_n523_));
  oai21  g367(.a(x070), .b(x014), .c(x022), .O(new_n524_));
  nand2  g368(.a(new_n329_), .b(new_n325_), .O(new_n525_));
  nand4  g369(.a(new_n525_), .b(new_n524_), .c(new_n305_), .d(x030), .O(new_n526_));
  oai21  g370(.a(new_n523_), .b(new_n310_), .c(new_n526_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n303_), .O(new_n528_));
  oai21  g372(.a(x038), .b(x014), .c(x022), .O(new_n529_));
  nand3  g373(.a(new_n313_), .b(new_n312_), .c(new_n304_), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n529_), .O(new_n531_));
  oai22  g375(.a(new_n305_), .b(new_n309_), .c(x126), .d(x102), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n531_), .c(x070), .O(new_n533_));
  nand3  g377(.a(x102), .b(x070), .c(new_n348_), .O(new_n534_));
  nand3  g378(.a(new_n335_), .b(x126), .c(new_n309_), .O(new_n535_));
  nand3  g379(.a(new_n535_), .b(new_n534_), .c(new_n303_), .O(new_n536_));
  oai21  g380(.a(new_n536_), .b(new_n533_), .c(x006), .O(new_n537_));
  nand3  g381(.a(new_n537_), .b(new_n528_), .c(new_n522_), .O(new_n538_));
  nand2  g382(.a(new_n538_), .b(new_n344_), .O(new_n539_));
  inv1   g383(.a(new_n336_), .O(new_n540_));
  nor2   g384(.a(x086), .b(new_n308_), .O(new_n541_));
  aoi22  g385(.a(new_n541_), .b(new_n517_), .c(new_n540_), .d(x078), .O(new_n542_));
  nand2  g386(.a(new_n542_), .b(new_n539_), .O(new_n543_));
  nand2  g387(.a(new_n543_), .b(new_n362_), .O(new_n544_));
  nand2  g388(.a(new_n525_), .b(x006), .O(new_n545_));
  nand3  g389(.a(new_n303_), .b(x030), .c(new_n308_), .O(new_n546_));
  aoi21  g390(.a(new_n546_), .b(new_n545_), .c(x070), .O(new_n547_));
  nor2   g391(.a(new_n523_), .b(x086), .O(new_n548_));
  oai21  g392(.a(new_n548_), .b(new_n547_), .c(x038), .O(new_n549_));
  nand2  g393(.a(x086), .b(x006), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(x014), .c(new_n336_), .O(new_n551_));
  nand2  g395(.a(new_n551_), .b(new_n318_), .O(new_n552_));
  nand2  g396(.a(new_n552_), .b(new_n549_), .O(new_n553_));
  oai21  g397(.a(new_n550_), .b(x038), .c(new_n308_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(x078), .O(new_n555_));
  oai21  g399(.a(new_n362_), .b(new_n348_), .c(new_n555_), .O(new_n556_));
  aoi21  g400(.a(new_n553_), .b(new_n344_), .c(new_n556_), .O(new_n557_));
  aoi21  g401(.a(new_n557_), .b(new_n544_), .c(new_n516_), .O(z14));
  zero   g402(.O(z15));
  zero   g403(.O(z16));
  zero   g404(.O(z19));
  zero   g405(.O(z21));
  ...
  zero   g407(.O(z26));
  zero   g408(.O(z27));
  nor2   g409(.a(new_n177_), .b(x045), .O(z17));
  nor2   g410(.a(new_n177_), .b(x045), .O(z18));
  nor2   g411(.a(new_n177_), .b(x045), .O(z20));
  nor2   g412(.a(new_n177_), .b(x045), .O(z22));
  nor2   g413(.a(new_n177_), .b(x045), .O(z23));
  nor2   g414(.a(new_n177_), .b(x045), .O(z24));
endmodule
