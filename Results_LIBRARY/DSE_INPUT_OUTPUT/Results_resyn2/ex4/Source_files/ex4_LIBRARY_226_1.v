// Benchmark "FAU" written by ABC on Wed Aug 12 10:09:51 2020
...
module FAU ( 
  ...
  oai21  g104(.a(new_n260_), .b(new_n259_), .c(x021), .O(new_n261_));
  ...
  oai22  g111(.a(new_n267_), .b(new_n266_), .c(x021), .d(x013), .O(new_n268_));
  nand3  g112(.a(new_n268_), .b(new_n265_), .c(new_n261_), .O(new_n269_));
  ...
  aoi21  g117(.a(new_n269_), .b(x069), .c(new_n273_), .O(new_n274_));
  inv1   g118(.a(x101), .O(new_n275_));
  inv1   g119(.a(x037), .O(new_n276_));
  nor2   g120(.a(x069), .b(new_n276_), .O(new_n277_));
  oai21  g121(.a(new_n260_), .b(new_n275_), .c(new_n277_), .O(new_n278_));
  oai21  g122(.a(new_n274_), .b(new_n258_), .c(new_n278_), .O(new_n279_));
  nand2  g123(.a(new_n279_), .b(x053), .O(new_n280_));
  inv1   g124(.a(x013), .O(new_n281_));
  oai21  g125(.a(x085), .b(new_n281_), .c(x077), .O(new_n282_));
  nand3  g126(.a(new_n258_), .b(x053), .c(new_n276_), .O(new_n283_));
  nand2  g127(.a(new_n283_), .b(new_n282_), .O(new_n284_));
  aoi21  g128(.a(new_n284_), .b(new_n280_), .c(x005), .O(new_n285_));
  and2   g129(.a(x125), .b(x101), .O(new_n286_));
  and2   g130(.a(x117), .b(x109), .O(new_n287_));
  aoi21  g131(.a(x069), .b(x013), .c(x021), .O(new_n288_));
  oai21  g132(.a(new_n288_), .b(new_n286_), .c(new_n287_), .O(new_n289_));
  inv1   g133(.a(x021), .O(new_n290_));
  nor2   g134(.a(x069), .b(new_n290_), .O(new_n291_));
  aoi21  g135(.a(new_n289_), .b(new_n264_), .c(new_n291_), .O(new_n292_));
  inv1   g136(.a(x069), .O(new_n293_));
  nand2  g137(.a(x021), .b(x013), .O(new_n294_));
  aoi22  g138(.a(new_n294_), .b(new_n260_), .c(new_n267_), .d(new_n293_), .O(new_n295_));
  oai21  g139(.a(new_n292_), .b(x029), .c(new_n295_), .O(new_n296_));
  inv1   g140(.a(new_n267_), .O(new_n297_));
  or2    g141(.a(new_n288_), .b(x029), .O(new_n298_));
  aoi21  g142(.a(new_n298_), .b(new_n297_), .c(x037), .O(new_n299_));
  aoi21  g143(.a(new_n296_), .b(x053), .c(new_n299_), .O(new_n300_));
  nand3  g144(.a(x053), .b(new_n276_), .c(new_n281_), .O(new_n301_));
  inv1   g145(.a(x053), .O(new_n302_));
  nand2  g146(.a(new_n293_), .b(new_n290_), .O(new_n303_));
  aoi21  g147(.a(new_n258_), .b(new_n302_), .c(new_n303_), .O(new_n304_));
  oai22  g148(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n305_));
  aoi21  g149(.a(new_n304_), .b(new_n301_), .c(new_n305_), .O(new_n306_));
  oai21  g150(.a(new_n300_), .b(new_n177_), .c(new_n306_), .O(new_n307_));
  oai21  g151(.a(new_n307_), .b(new_n285_), .c(x045), .O(new_n308_));
  ...
  nand2  g219(.a(x024), .b(new_n158_), .O(new_n376_));
  and2   g220(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  ...
  nand4  g226(.a(new_n382_), .b(new_n379_), .c(new_n378_), .d(x024), .O(new_n383_));
  oai21  g227(.a(new_n377_), .b(new_n159_), .c(new_n383_), .O(new_n384_));
  nand2  g228(.a(new_n384_), .b(new_n173_), .O(new_n385_));
  oai21  g229(.a(x032), .b(x008), .c(x016), .O(new_n386_));
  aoi21  g230(.a(new_n382_), .b(new_n378_), .c(new_n386_), .O(new_n387_));
  inv1   g231(.a(x024), .O(new_n388_));
  nand2  g232(.a(new_n375_), .b(new_n388_), .O(new_n389_));
  oai21  g233(.a(new_n389_), .b(new_n382_), .c(new_n159_), .O(new_n390_));
  nand2  g234(.a(x112), .b(x104), .O(new_n391_));
  nand3  g235(.a(new_n391_), .b(x120), .c(new_n158_), .O(new_n392_));
  aoi21  g236(.a(new_n392_), .b(new_n390_), .c(new_n387_), .O(new_n393_));
  nand2  g237(.a(x064), .b(new_n169_), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n380_), .c(new_n173_), .O(new_n395_));
  oai21  g239(.a(new_n395_), .b(new_n393_), .c(x000), .O(new_n396_));
  aoi21  g240(.a(new_n396_), .b(new_n385_), .c(x072), .O(new_n397_));
  ...
  aoi21  g245(.a(new_n394_), .b(new_n160_), .c(new_n172_), .O(new_n402_));
  nand3  g246(.a(new_n378_), .b(new_n159_), .c(x024), .O(new_n403_));
  aoi21  g247(.a(new_n403_), .b(new_n158_), .c(x080), .O(new_n404_));
  oai21  g248(.a(new_n404_), .b(new_n402_), .c(new_n398_), .O(new_n405_));
  and2   g249(.a(new_n405_), .b(new_n401_), .O(new_n406_));
  oai22  g250(.a(new_n406_), .b(new_n400_), .c(new_n399_), .d(new_n398_), .O(new_n407_));
  oai21  g251(.a(new_n407_), .b(new_n397_), .c(new_n157_), .O(new_n408_));
  nand2  g252(.a(new_n382_), .b(x000), .O(new_n409_));
  nand3  g253(.a(new_n173_), .b(x024), .c(new_n170_), .O(new_n410_));
  aoi21  g254(.a(new_n410_), .b(new_n409_), .c(x064), .O(new_n411_));
  nor2   g255(.a(new_n377_), .b(x080), .O(new_n412_));
  ...
  aoi21  g259(.a(new_n157_), .b(x032), .c(new_n399_), .O(new_n416_));
  ...
  aoi21  g265(.a(new_n418_), .b(new_n398_), .c(new_n421_), .O(new_n422_));
  inv1   g266(.a(x040), .O(new_n423_));
  nand2  g267(.a(new_n179_), .b(new_n423_), .O(new_n424_));
  ...
  aoi22  g272(.a(new_n428_), .b(x009), .c(x049), .d(new_n185_), .O(new_n429_));
  ...
  oai21  g277(.a(new_n431_), .b(new_n427_), .c(new_n197_), .O(new_n434_));
  aoi21  g278(.a(x049), .b(x033), .c(new_n194_), .O(new_n435_));
  ...
  aoi22  g285(.a(new_n441_), .b(x010), .c(x050), .d(new_n204_), .O(new_n442_));
  oai21  g286(.a(new_n440_), .b(x010), .c(new_n442_), .O(new_n443_));
  inv1   g287(.a(new_n441_), .O(new_n444_));
  aoi21  g288(.a(new_n439_), .b(x010), .c(x034), .O(new_n445_));
  oai21  g289(.a(new_n444_), .b(x010), .c(new_n445_), .O(new_n446_));
  oai21  g290(.a(new_n444_), .b(new_n440_), .c(new_n216_), .O(new_n447_));
  ...
  oai21  g294(.a(new_n450_), .b(x042), .c(new_n179_), .O(z10));
  nand2  g295(.a(x067), .b(x019), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  nand2  g297(.a(x083), .b(x003), .O(new_n454_));
  aoi22  g298(.a(new_n454_), .b(x011), .c(x051), .d(new_n223_), .O(new_n455_));
  ...
  oai21  g303(.a(new_n457_), .b(new_n453_), .c(new_n235_), .O(new_n460_));
  aoi21  g304(.a(x051), .b(x035), .c(new_n232_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n460_), .c(new_n459_), .d(new_n456_), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(x043), .c(new_n179_), .O(z11));
  nand2  g308(.a(x068), .b(x020), .O(new_n465_));
  inv1   g309(.a(new_n465_), .O(new_n466_));
  nand2  g310(.a(x084), .b(x004), .O(new_n467_));
  aoi22  g311(.a(new_n467_), .b(x012), .c(x052), .d(new_n242_), .O(new_n468_));
  oai21  g312(.a(new_n466_), .b(x012), .c(new_n468_), .O(new_n469_));
  inv1   g313(.a(new_n467_), .O(new_n470_));
  aoi21  g314(.a(new_n465_), .b(x012), .c(x036), .O(new_n471_));
  oai21  g315(.a(new_n470_), .b(x012), .c(new_n471_), .O(new_n472_));
  oai21  g316(.a(new_n470_), .b(new_n466_), .c(new_n254_), .O(new_n473_));
  aoi21  g317(.a(x052), .b(x036), .c(new_n251_), .O(new_n474_));
  nand4  g318(.a(new_n474_), .b(new_n473_), .c(new_n472_), .d(new_n469_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(new_n476_));
  nor3   g320(.a(new_n476_), .b(z07), .c(x044), .O(z12));
  inv1   g321(.a(new_n264_), .O(new_n478_));
  nor2   g322(.a(new_n478_), .b(new_n276_), .O(new_n479_));
  nor2   g323(.a(new_n266_), .b(x013), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(x005), .O(new_n481_));
  inv1   g325(.a(x005), .O(new_n482_));
  nor2   g326(.a(x021), .b(new_n482_), .O(new_n483_));
  oai22  g327(.a(new_n483_), .b(new_n267_), .c(x125), .d(x101), .O(new_n484_));
  oai21  g328(.a(new_n480_), .b(x005), .c(new_n302_), .O(new_n485_));
  aoi21  g329(.a(new_n484_), .b(new_n481_), .c(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n479_), .c(new_n293_), .O(new_n487_));
  nand2  g331(.a(new_n260_), .b(x125), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n266_), .c(new_n482_), .O(new_n489_));
  nand2  g333(.a(new_n267_), .b(x029), .O(new_n490_));
  aoi21  g334(.a(new_n271_), .b(new_n275_), .c(new_n490_), .O(new_n491_));
  nor2   g335(.a(x053), .b(x021), .O(new_n492_));
  oai21  g336(.a(new_n491_), .b(new_n489_), .c(new_n492_), .O(new_n493_));
  nand3  g337(.a(new_n293_), .b(x037), .c(x029), .O(new_n494_));
  nand3  g338(.a(new_n264_), .b(new_n302_), .c(x005), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n494_), .O(new_n496_));
  oai21  g340(.a(new_n264_), .b(new_n281_), .c(x021), .O(new_n497_));
  nand3  g341(.a(x101), .b(new_n276_), .c(x005), .O(new_n498_));
  nand2  g342(.a(x029), .b(new_n290_), .O(new_n499_));
  nand3  g343(.a(new_n499_), .b(new_n498_), .c(new_n478_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n302_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n497_), .O(new_n502_));
  aoi22  g346(.a(new_n502_), .b(x069), .c(new_n496_), .d(new_n294_), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n493_), .c(new_n487_), .O(new_n504_));
  inv1   g348(.a(new_n270_), .O(new_n505_));
  nand3  g349(.a(new_n267_), .b(new_n293_), .c(x029), .O(new_n506_));
  oai21  g350(.a(new_n293_), .b(new_n276_), .c(x005), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n506_), .c(new_n290_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n258_), .c(x013), .O(new_n509_));
  nand3  g353(.a(new_n258_), .b(x069), .c(x021), .O(new_n510_));
  oai21  g354(.a(new_n509_), .b(x053), .c(new_n510_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n505_), .O(new_n512_));
  nand2  g356(.a(x069), .b(x021), .O(new_n513_));
  oai21  g357(.a(new_n513_), .b(x053), .c(new_n281_), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(x077), .O(new_n515_));
  nand2  g359(.a(x053), .b(x037), .O(new_n516_));
  oai21  g360(.a(new_n177_), .b(new_n482_), .c(new_n510_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n276_), .O(new_n518_));
  nand4  g362(.a(new_n518_), .b(new_n516_), .c(new_n515_), .d(new_n512_), .O(new_n519_));
  aoi21  g363(.a(new_n504_), .b(new_n258_), .c(new_n519_), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(x045), .c(new_n179_), .O(z13));
  ...
  nand3  g369(.a(new_n525_), .b(new_n312_), .c(x030), .O(new_n526_));
  aoi21  g370(.a(new_n526_), .b(new_n328_), .c(x086), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n524_), .c(new_n346_), .O(new_n528_));
  inv1   g372(.a(new_n320_), .O(new_n529_));
  nand2  g373(.a(x030), .b(new_n328_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n529_), .c(new_n312_), .O(new_n531_));
  oai21  g375(.a(x070), .b(x014), .c(x022), .O(new_n532_));
  nand2  g376(.a(new_n344_), .b(new_n342_), .O(new_n533_));
  nand4  g377(.a(new_n533_), .b(new_n532_), .c(new_n525_), .d(x030), .O(new_n534_));
  inv1   g378(.a(new_n534_), .O(new_n535_));
  oai21  g379(.a(new_n535_), .b(new_n531_), .c(new_n316_), .O(new_n536_));
  oai21  g380(.a(x038), .b(x014), .c(x022), .O(new_n537_));
  nand3  g381(.a(new_n319_), .b(new_n318_), .c(new_n317_), .O(new_n538_));
  nand2  g382(.a(new_n538_), .b(new_n537_), .O(new_n539_));
  oai22  g383(.a(new_n525_), .b(new_n328_), .c(x126), .d(x102), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n539_), .c(x070), .O(new_n541_));
  nand3  g385(.a(x102), .b(x070), .c(new_n368_), .O(new_n542_));
  ...
  nand3  g389(.a(new_n545_), .b(new_n536_), .c(new_n528_), .O(new_n546_));
  oai22  g390(.a(new_n364_), .b(new_n345_), .c(new_n314_), .d(new_n352_), .O(new_n547_));
  aoi21  g391(.a(new_n546_), .b(new_n352_), .c(new_n547_), .O(new_n548_));
  nand2  g392(.a(new_n533_), .b(x006), .O(new_n549_));
  nand3  g393(.a(new_n316_), .b(x030), .c(new_n327_), .O(new_n550_));
  aoi21  g394(.a(new_n550_), .b(new_n549_), .c(x070), .O(new_n551_));
  aoi21  g395(.a(new_n530_), .b(new_n529_), .c(x086), .O(new_n552_));
  oai21  g396(.a(new_n552_), .b(new_n551_), .c(x038), .O(new_n553_));
  nand2  g397(.a(x086), .b(x006), .O(new_n554_));
  oai21  g398(.a(new_n554_), .b(x014), .c(new_n314_), .O(new_n555_));
  ...
  oai21  g403(.a(new_n310_), .b(new_n368_), .c(new_n559_), .O(new_n560_));
  aoi21  g404(.a(new_n557_), .b(new_n352_), .c(new_n560_), .O(new_n561_));
  oai21  g405(.a(new_n548_), .b(x054), .c(new_n561_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n522_), .O(new_n563_));
  nand2  g407(.a(new_n563_), .b(new_n179_), .O(z14));
  zero   g408(.O(z16));
  zero   g409(.O(z18));
  zero   g410(.O(z19));
  zero   g411(.O(z22));
  ...
  nor2   g417(.a(new_n177_), .b(x077), .O(z20));
  nor2   g418(.a(new_n177_), .b(x077), .O(z21));
  nor2   g419(.a(new_n177_), .b(x077), .O(z24));
  nor2   g420(.a(new_n177_), .b(x077), .O(z26));
endmodule
