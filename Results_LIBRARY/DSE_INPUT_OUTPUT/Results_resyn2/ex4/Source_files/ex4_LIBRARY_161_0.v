...
module FAU ( 
  ...
  inv1   g218(.a(x000), .O(new_n375_));
  nand2  g219(.a(x088), .b(x056), .O(new_n376_));
  oai21  g220(.a(x120), .b(x096), .c(new_n376_), .O(new_n377_));
  ...
  nand4  g227(.a(new_n383_), .b(new_n382_), .c(new_n381_), .d(new_n380_), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(new_n379_), .c(new_n159_), .O(new_n385_));
  nand2  g229(.a(x112), .b(x104), .O(new_n386_));
  nand3  g230(.a(new_n386_), .b(x120), .c(new_n158_), .O(new_n387_));
  nand3  g231(.a(x096), .b(x064), .c(new_n169_), .O(new_n388_));
  nand3  g232(.a(new_n388_), .b(new_n387_), .c(new_n172_), .O(new_n389_));
  inv1   g233(.a(new_n389_), .O(new_n390_));
  aoi21  g234(.a(new_n390_), .b(new_n385_), .c(new_n375_), .O(new_n391_));
  inv1   g235(.a(new_n383_), .O(new_n392_));
  nor2   g236(.a(new_n380_), .b(x016), .O(new_n393_));
  oai21  g237(.a(new_n393_), .b(new_n392_), .c(x064), .O(new_n394_));
  nand2  g238(.a(new_n382_), .b(new_n381_), .O(new_n395_));
  oai21  g239(.a(x064), .b(x008), .c(x016), .O(new_n396_));
  nand4  g240(.a(new_n396_), .b(new_n376_), .c(new_n395_), .d(x024), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n394_), .c(x080), .O(new_n398_));
  oai21  g242(.a(new_n398_), .b(new_n391_), .c(new_n374_), .O(new_n399_));
  or2    g243(.a(x112), .b(x104), .O(new_n400_));
  nand2  g244(.a(x064), .b(new_n169_), .O(new_n401_));
  aoi21  g245(.a(new_n401_), .b(new_n160_), .c(new_n375_), .O(new_n402_));
  nand3  g246(.a(new_n376_), .b(new_n159_), .c(x024), .O(new_n403_));
  ...
  aoi21  g253(.a(new_n406_), .b(new_n400_), .c(new_n409_), .O(new_n410_));
  aoi21  g254(.a(new_n410_), .b(new_n399_), .c(x048), .O(new_n411_));
  nand2  g255(.a(new_n395_), .b(x000), .O(new_n412_));
  nand3  g256(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n413_));
  aoi21  g257(.a(new_n413_), .b(new_n412_), .c(x064), .O(new_n414_));
  inv1   g258(.a(new_n393_), .O(new_n415_));
  aoi21  g259(.a(new_n415_), .b(new_n383_), .c(x080), .O(new_n416_));
  ...
  aoi21  g264(.a(new_n170_), .b(x032), .c(new_n418_), .O(new_n421_));
  ...
  nand2  g313(.a(new_n469_), .b(new_n179_), .O(z11));
