// Benchmark "FAU" written by ABC on Wed Aug 12 10:07:58 2020
...
module FAU ( 
  ...
  aoi21  g126(.a(new_n282_), .b(new_n271_), .c(x005), .O(new_n283_));
  nand2  g127(.a(x069), .b(new_n252_), .O(new_n284_));
  oai21  g128(.a(new_n284_), .b(new_n260_), .c(x021), .O(new_n285_));
  aoi21  g129(.a(new_n285_), .b(x085), .c(new_n283_), .O(new_n286_));
  nand2  g130(.a(x085), .b(new_n256_), .O(new_n287_));
  oai21  g131(.a(new_n286_), .b(new_n281_), .c(new_n287_), .O(new_n288_));
  nand2  g132(.a(new_n251_), .b(new_n257_), .O(new_n289_));
  nor2   g133(.a(new_n289_), .b(x077), .O(new_n290_));
  aoi21  g134(.a(new_n288_), .b(new_n280_), .c(new_n290_), .O(new_n291_));
  aoi21  g135(.a(new_n291_), .b(new_n279_), .c(new_n249_), .O(new_n292_));
  inv1   g136(.a(x005), .O(new_n293_));
  nand2  g137(.a(new_n259_), .b(new_n293_), .O(new_n294_));
  nand3  g138(.a(x085), .b(new_n252_), .c(x013), .O(new_n295_));
  nand2  g139(.a(new_n295_), .b(new_n294_), .O(new_n296_));
  nand2  g140(.a(new_n296_), .b(x069), .O(new_n297_));
  nand2  g141(.a(new_n254_), .b(x085), .O(new_n298_));
  aoi21  g142(.a(new_n298_), .b(new_n297_), .c(x037), .O(new_n299_));
  nand2  g143(.a(new_n250_), .b(x013), .O(new_n300_));
  nor2   g144(.a(x037), .b(x013), .O(new_n301_));
  oai22  g145(.a(new_n301_), .b(new_n289_), .c(new_n300_), .d(x005), .O(new_n302_));
  oai21  g146(.a(new_n302_), .b(new_n299_), .c(x077), .O(new_n303_));
  inv1   g147(.a(x037), .O(new_n304_));
  nand3  g148(.a(new_n250_), .b(x037), .c(new_n293_), .O(new_n305_));
  nand2  g149(.a(new_n305_), .b(x013), .O(new_n306_));
  aoi22  g150(.a(new_n306_), .b(new_n281_), .c(new_n249_), .d(new_n304_), .O(new_n307_));
  ...
  nor3   g278(.a(new_n434_), .b(z07), .c(x041), .O(z09));
  ...
  nand3  g312(.a(new_n468_), .b(new_n466_), .c(new_n244_), .O(new_n469_));
  nand2  g313(.a(new_n467_), .b(new_n464_), .O(new_n470_));
  nand2  g314(.a(new_n465_), .b(x012), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n470_), .c(new_n243_), .O(new_n472_));
  nand2  g316(.a(new_n467_), .b(new_n465_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n236_), .O(new_n474_));
  aoi22  g318(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n475_));
  nand4  g319(.a(new_n475_), .b(new_n474_), .c(new_n472_), .d(new_n469_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n235_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n179_), .O(z12));
  inv1   g322(.a(x045), .O(new_n479_));
  oai21  g323(.a(new_n252_), .b(x021), .c(new_n260_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(x069), .O(new_n481_));
  nand2  g325(.a(x093), .b(x061), .O(new_n482_));
  oai21  g326(.a(x069), .b(x013), .c(x021), .O(new_n483_));
  nand2  g327(.a(new_n274_), .b(new_n270_), .O(new_n484_));
  nand4  g328(.a(new_n484_), .b(new_n483_), .c(new_n482_), .d(x029), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n481_), .c(x085), .O(new_n486_));
  oai21  g330(.a(x037), .b(x013), .c(x021), .O(new_n487_));
  inv1   g331(.a(x061), .O(new_n488_));
  inv1   g332(.a(x093), .O(new_n489_));
  nand3  g333(.a(new_n489_), .b(new_n488_), .c(new_n252_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n487_), .O(new_n491_));
  oai22  g335(.a(new_n482_), .b(new_n257_), .c(x125), .d(x101), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n491_), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n251_), .O(new_n494_));
  nand3  g338(.a(x101), .b(x069), .c(new_n304_), .O(new_n495_));
  nand3  g339(.a(new_n280_), .b(x125), .c(new_n257_), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n495_), .c(new_n250_), .O(new_n497_));
  inv1   g341(.a(new_n497_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n494_), .c(new_n293_), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n486_), .c(new_n281_), .O(new_n500_));
  inv1   g344(.a(new_n273_), .O(new_n501_));
  inv1   g345(.a(new_n282_), .O(new_n502_));
  nand2  g346(.a(x069), .b(new_n304_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n289_), .c(new_n293_), .O(new_n504_));
  nand3  g348(.a(new_n482_), .b(new_n251_), .c(x029), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n257_), .c(x085), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n504_), .c(new_n281_), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n300_), .O(new_n508_));
  aoi22  g352(.a(new_n508_), .b(new_n501_), .c(new_n502_), .d(x077), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n500_), .c(x053), .O(new_n510_));
  nand2  g354(.a(new_n484_), .b(x005), .O(new_n511_));
  nand3  g355(.a(new_n250_), .b(x029), .c(new_n256_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n251_), .O(new_n514_));
  nand2  g358(.a(new_n480_), .b(new_n250_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n514_), .c(new_n304_), .O(new_n516_));
  nand3  g360(.a(x085), .b(new_n256_), .c(x005), .O(new_n517_));
  aoi22  g361(.a(new_n517_), .b(new_n282_), .c(x037), .d(x013), .O(new_n518_));
  oai21  g362(.a(new_n518_), .b(new_n516_), .c(new_n281_), .O(new_n519_));
  nand2  g363(.a(x085), .b(x005), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(x037), .c(new_n256_), .O(new_n521_));
  aoi22  g365(.a(new_n521_), .b(x077), .c(x053), .d(x037), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n519_), .O(new_n523_));
  oai21  g367(.a(new_n523_), .b(new_n510_), .c(new_n479_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n179_), .O(z13));
  inv1   g369(.a(new_n311_), .O(new_n526_));
  inv1   g370(.a(new_n336_), .O(new_n527_));
  nand2  g371(.a(x070), .b(new_n355_), .O(new_n528_));
  aoi21  g372(.a(new_n528_), .b(new_n362_), .c(new_n356_), .O(new_n529_));
  nand3  g373(.a(new_n314_), .b(new_n319_), .c(x030), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n318_), .c(x086), .O(new_n531_));
  oai21  g375(.a(new_n531_), .b(new_n529_), .c(new_n527_), .O(new_n532_));
  aoi21  g376(.a(x030), .b(new_n318_), .c(new_n323_), .O(new_n533_));
  oai21  g377(.a(x070), .b(x014), .c(x022), .O(new_n534_));
  nand2  g378(.a(new_n337_), .b(new_n333_), .O(new_n535_));
  nand4  g379(.a(new_n535_), .b(new_n534_), .c(new_n314_), .d(x030), .O(new_n536_));
  oai21  g380(.a(new_n533_), .b(new_n319_), .c(new_n536_), .O(new_n537_));
  nand2  g381(.a(new_n537_), .b(new_n312_), .O(new_n538_));
  oai21  g382(.a(x038), .b(x014), .c(x022), .O(new_n539_));
  oai21  g383(.a(new_n323_), .b(x030), .c(new_n539_), .O(new_n540_));
  oai21  g384(.a(new_n314_), .b(new_n318_), .c(new_n535_), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n540_), .c(x070), .O(new_n542_));
  nand3  g386(.a(x102), .b(x070), .c(new_n355_), .O(new_n543_));
  nand3  g387(.a(new_n343_), .b(x126), .c(new_n318_), .O(new_n544_));
  ...
  inv1   g392(.a(new_n344_), .O(new_n549_));
  nor2   g393(.a(x086), .b(new_n317_), .O(new_n550_));
  aoi22  g394(.a(new_n550_), .b(new_n527_), .c(new_n549_), .d(x078), .O(new_n551_));
  nand2  g395(.a(new_n551_), .b(new_n548_), .O(new_n552_));
  nand2  g396(.a(new_n552_), .b(new_n369_), .O(new_n553_));
  nand2  g397(.a(new_n535_), .b(x006), .O(new_n554_));
  nand3  g398(.a(new_n312_), .b(x030), .c(new_n317_), .O(new_n555_));
  aoi21  g399(.a(new_n555_), .b(new_n554_), .c(x070), .O(new_n556_));
  nor2   g400(.a(new_n533_), .b(x086), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n556_), .c(x038), .O(new_n558_));
  nand2  g402(.a(x086), .b(x006), .O(new_n559_));
  oai21  g403(.a(new_n559_), .b(x014), .c(new_n344_), .O(new_n560_));
  oai21  g404(.a(new_n355_), .b(new_n317_), .c(new_n560_), .O(new_n561_));
  ...
  oai21  g408(.a(new_n369_), .b(new_n355_), .c(new_n564_), .O(new_n565_));
  aoi21  g409(.a(new_n562_), .b(new_n351_), .c(new_n565_), .O(new_n566_));
  aoi21  g410(.a(new_n566_), .b(new_n553_), .c(new_n526_), .O(z14));
  zero   g411(.O(z15));
  zero   g412(.O(z17));
  zero   g413(.O(z27));
  nor2   g414(.a(x077), .b(new_n177_), .O(z16));
  nor2   g415(.a(x077), .b(new_n177_), .O(z18));
  nor2   g416(.a(x077), .b(new_n177_), .O(z19));
  nor2   g417(.a(x077), .b(new_n177_), .O(z20));
  nor2   g418(.a(x077), .b(new_n177_), .O(z21));
  nor2   g419(.a(x077), .b(new_n177_), .O(z22));
  nor2   g420(.a(x077), .b(new_n177_), .O(z23));
  nor2   g421(.a(x077), .b(new_n177_), .O(z24));
  nor2   g422(.a(x077), .b(new_n177_), .O(z25));
  nor2   g423(.a(x077), .b(new_n177_), .O(z26));
endmodule
