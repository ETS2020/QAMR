...
module FAU ( 
  ...
  nor3   g055(.a(new_n211_), .b(new_n210_), .c(z15), .O(new_n212_));
  ...
  nand2  g283(.a(new_n440_), .b(new_n159_), .O(z09));
  ...
  aoi22  g313(.a(new_n470_), .b(x012), .c(x052), .d(new_n238_), .O(new_n471_));
  ...
  oai21  g318(.a(new_n473_), .b(new_n469_), .c(new_n250_), .O(new_n476_));
  aoi21  g319(.a(x052), .b(x036), .c(new_n247_), .O(new_n477_));
  ...
  zero   g415(.O(z23));
  zero   g416(.O(z26));
  nor2   g417(.a(x077), .b(x057), .O(z16));
  nor2   g418(.a(x077), .b(x057), .O(z18));
  nor2   g419(.a(x077), .b(x057), .O(z19));
  nor2   g420(.a(x077), .b(x057), .O(z20));
  nor2   g421(.a(x077), .b(x057), .O(z22));
  nor2   g422(.a(x077), .b(x057), .O(z24));
  nor2   g423(.a(x077), .b(x057), .O(z25));
  nor2   g424(.a(x077), .b(x057), .O(z27));
endmodule
