...
module FAU ( 
  ...
  zero   g403(.O(z24));
  zero   g404(.O(z26));
  nor2   g405(.a(new_n177_), .b(x045), .O(z16));
  nor2   g406(.a(new_n177_), .b(x045), .O(z17));
  nor2   g407(.a(new_n177_), .b(x045), .O(z18));
  nor2   g408(.a(new_n177_), .b(x045), .O(z19));
  nor2   g409(.a(new_n177_), .b(x045), .O(z22));
  nor2   g410(.a(new_n177_), .b(x045), .O(z23));
  nor2   g411(.a(new_n177_), .b(x045), .O(z25));
