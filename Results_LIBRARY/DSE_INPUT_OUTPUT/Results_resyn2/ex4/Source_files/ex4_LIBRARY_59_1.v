...
module FAU ( 
  ...
  nand2  g002(.a(x106), .b(new_n158_), .O(new_n159_));
  ...
  nand2  g102(.a(new_n159_), .b(x044), .O(new_n259_));
  ...
  nand2  g372(.a(new_n528_), .b(new_n159_), .O(z13));
  ...
  zero   g426(.O(z26));
  zero   g427(.O(z27));
  inv1   g428(.a(new_n159_), .O(z16));
  inv1   g429(.a(new_n159_), .O(z17));
  inv1   g430(.a(new_n159_), .O(z20));
  inv1   g431(.a(new_n159_), .O(z23));
  inv1   g432(.a(new_n159_), .O(z25));
endmodule
