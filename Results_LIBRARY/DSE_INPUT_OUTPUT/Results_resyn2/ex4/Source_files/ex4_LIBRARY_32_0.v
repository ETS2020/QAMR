// Benchmark "FAU" written by ABC on Wed Aug 12 10:04:58 2020
...
module FAU ( 
  ...
  nand2  g101(.a(new_n257_), .b(x057), .O(new_n258_));
  ...
  nand2  g269(.a(new_n425_), .b(new_n373_), .O(new_n426_));
  nand2  g270(.a(new_n426_), .b(new_n178_), .O(z08));
  ...
  nand3  g276(.a(new_n432_), .b(new_n430_), .c(new_n190_), .O(new_n433_));
  nand2  g277(.a(new_n431_), .b(new_n428_), .O(new_n434_));
  nand2  g278(.a(new_n429_), .b(x009), .O(new_n435_));
  nand3  g279(.a(new_n435_), .b(new_n434_), .c(new_n189_), .O(new_n436_));
  ...
  nand2  g284(.a(new_n440_), .b(new_n181_), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n178_), .O(z09));
  ...
  oai21  g295(.a(new_n449_), .b(new_n444_), .c(new_n209_), .O(new_n452_));
  aoi21  g296(.a(x050), .b(x034), .c(new_n206_), .O(new_n453_));
  nand4  g297(.a(new_n453_), .b(new_n452_), .c(new_n451_), .d(new_n448_), .O(new_n454_));
  and2   g298(.a(new_n454_), .b(new_n195_), .O(z10));
  ...
  oai21  g308(.a(new_n462_), .b(new_n457_), .c(new_n228_), .O(new_n465_));
  aoi21  g309(.a(x051), .b(x035), .c(new_n225_), .O(new_n466_));
  nand4  g310(.a(new_n466_), .b(new_n465_), .c(new_n464_), .d(new_n461_), .O(new_n467_));
  and2   g311(.a(new_n467_), .b(new_n214_), .O(z11));
  ...
  nand3  g317(.a(new_n473_), .b(new_n471_), .c(new_n242_), .O(new_n474_));
  nand2  g318(.a(new_n472_), .b(new_n469_), .O(new_n475_));
  nand2  g319(.a(new_n470_), .b(x012), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n475_), .c(new_n241_), .O(new_n477_));
  nand2  g321(.a(new_n472_), .b(new_n470_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n234_), .O(new_n479_));
  aoi22  g323(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n480_));
  nand4  g324(.a(new_n480_), .b(new_n479_), .c(new_n477_), .d(new_n474_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n233_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n178_), .O(z12));
  inv1   g327(.a(new_n290_), .O(new_n484_));
  nand2  g328(.a(x069), .b(new_n284_), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n251_), .c(new_n282_), .O(new_n486_));
  nand3  g330(.a(new_n283_), .b(new_n260_), .c(x029), .O(new_n487_));
  aoi21  g331(.a(new_n487_), .b(new_n270_), .c(x085), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n486_), .c(new_n248_), .O(new_n489_));
  nand2  g333(.a(new_n264_), .b(x013), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n489_), .c(new_n484_), .O(new_n491_));
  aoi21  g335(.a(x029), .b(new_n270_), .c(new_n268_), .O(new_n492_));
  oai21  g336(.a(x069), .b(x013), .c(x021), .O(new_n493_));
  nand2  g337(.a(new_n289_), .b(new_n292_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n493_), .c(new_n283_), .d(x029), .O(new_n495_));
  ...
  oai22  g344(.a(new_n283_), .b(new_n270_), .c(x125), .d(x101), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n500_), .c(x069), .O(new_n502_));
  nand3  g346(.a(x101), .b(x069), .c(new_n284_), .O(new_n503_));
  nand3  g347(.a(new_n259_), .b(x125), .c(new_n270_), .O(new_n504_));
  ...
  oai21  g351(.a(new_n507_), .b(new_n491_), .c(new_n249_), .O(new_n508_));
  nand2  g352(.a(new_n494_), .b(x005), .O(new_n509_));
  nand3  g353(.a(new_n264_), .b(x029), .c(new_n252_), .O(new_n510_));
  ...
  oai21  g357(.a(new_n264_), .b(new_n282_), .c(new_n262_), .O(new_n514_));
  aoi21  g358(.a(new_n249_), .b(x037), .c(new_n262_), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n252_), .c(new_n514_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n513_), .O(new_n517_));
  nor2   g361(.a(new_n249_), .b(new_n284_), .O(new_n518_));
  aoi21  g362(.a(new_n517_), .b(new_n248_), .c(new_n518_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n508_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(x057), .O(new_n521_));
  nor3   g365(.a(new_n264_), .b(x037), .c(new_n282_), .O(new_n522_));
  nor2   g366(.a(new_n518_), .b(x013), .O(new_n523_));
  oai21  g367(.a(new_n262_), .b(x053), .c(new_n523_), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(new_n522_), .c(x077), .O(new_n525_));
  aoi21  g369(.a(new_n525_), .b(new_n521_), .c(x045), .O(z13));
  inv1   g370(.a(x046), .O(new_n527_));
  nand2  g371(.a(x070), .b(new_n336_), .O(new_n528_));
  aoi21  g372(.a(new_n528_), .b(new_n352_), .c(new_n335_), .O(new_n529_));
  nand3  g373(.a(new_n326_), .b(new_n314_), .c(x030), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n330_), .c(x086), .O(new_n531_));
  oai21  g375(.a(new_n531_), .b(new_n529_), .c(new_n344_), .O(new_n532_));
  aoi21  g376(.a(x030), .b(new_n330_), .c(new_n322_), .O(new_n533_));
  oai21  g377(.a(x070), .b(x014), .c(x022), .O(new_n534_));
  nand2  g378(.a(new_n343_), .b(new_n341_), .O(new_n535_));
  nand4  g379(.a(new_n535_), .b(new_n534_), .c(new_n326_), .d(x030), .O(new_n536_));
  oai21  g380(.a(new_n533_), .b(new_n314_), .c(new_n536_), .O(new_n537_));
  nand2  g381(.a(new_n537_), .b(new_n318_), .O(new_n538_));
  oai21  g382(.a(x038), .b(x014), .c(x022), .O(new_n539_));
  oai21  g383(.a(new_n322_), .b(x030), .c(new_n539_), .O(new_n540_));
  oai21  g384(.a(new_n326_), .b(new_n330_), .c(new_n535_), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n540_), .c(x070), .O(new_n542_));
  nand3  g386(.a(x102), .b(x070), .c(new_n336_), .O(new_n543_));
  nand3  g387(.a(new_n313_), .b(x126), .c(new_n330_), .O(new_n544_));
  nand3  g388(.a(new_n544_), .b(new_n543_), .c(new_n318_), .O(new_n545_));
  oai21  g389(.a(new_n545_), .b(new_n542_), .c(x006), .O(new_n546_));
  nand3  g390(.a(new_n546_), .b(new_n538_), .c(new_n532_), .O(new_n547_));
  nand3  g391(.a(new_n344_), .b(new_n318_), .c(x014), .O(new_n548_));
  oai21  g392(.a(new_n316_), .b(new_n351_), .c(new_n548_), .O(new_n549_));
  aoi21  g393(.a(new_n547_), .b(new_n351_), .c(new_n549_), .O(new_n550_));
  nand2  g394(.a(new_n535_), .b(x006), .O(new_n551_));
  nand3  g395(.a(new_n318_), .b(x030), .c(new_n329_), .O(new_n552_));
  aoi21  g396(.a(new_n552_), .b(new_n551_), .c(x070), .O(new_n553_));
  nor2   g397(.a(new_n533_), .b(x086), .O(new_n554_));
  oai21  g398(.a(new_n554_), .b(new_n553_), .c(x038), .O(new_n555_));
  nand2  g399(.a(x086), .b(x006), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n316_), .O(new_n557_));
  aoi21  g401(.a(new_n311_), .b(x038), .c(new_n316_), .O(new_n558_));
  oai21  g402(.a(new_n558_), .b(new_n329_), .c(new_n557_), .O(new_n559_));
  nand2  g403(.a(new_n559_), .b(new_n555_), .O(new_n560_));
  oai21  g404(.a(new_n556_), .b(x038), .c(new_n329_), .O(new_n561_));
  nand2  g405(.a(new_n561_), .b(x078), .O(new_n562_));
  oai21  g406(.a(new_n311_), .b(new_n336_), .c(new_n562_), .O(new_n563_));
  aoi21  g407(.a(new_n560_), .b(new_n351_), .c(new_n563_), .O(new_n564_));
  oai21  g408(.a(new_n550_), .b(x054), .c(new_n564_), .O(new_n565_));
  nand2  g409(.a(new_n565_), .b(new_n527_), .O(new_n566_));
  ...
  zero   g417(.O(z24));
  zero   g418(.O(z25));
  nor2   g419(.a(x077), .b(x057), .O(z15));
  nor2   g420(.a(x077), .b(x057), .O(z20));
  nor2   g421(.a(x077), .b(x057), .O(z21));
  nor2   g422(.a(x077), .b(x057), .O(z26));
  nor2   g423(.a(x077), .b(x057), .O(z27));
endmodule
