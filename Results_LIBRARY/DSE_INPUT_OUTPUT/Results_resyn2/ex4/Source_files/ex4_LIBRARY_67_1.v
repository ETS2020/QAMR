...
module FAU ( 
  ...
  nand2  g021(.a(x113), .b(new_n177_), .O(new_n178_));
  ...
  nand2  g257(.a(new_n178_), .b(new_n414_), .O(new_n415_));
  ...
  nand3  g294(.a(new_n451_), .b(new_n449_), .c(new_n218_), .O(new_n452_));
  nand2  g295(.a(new_n450_), .b(new_n447_), .O(new_n453_));
  nand2  g296(.a(new_n448_), .b(x011), .O(new_n454_));
  nand3  g297(.a(new_n454_), .b(new_n453_), .c(new_n217_), .O(new_n455_));
  ...
  nand2  g303(.a(new_n460_), .b(new_n178_), .O(z11));
  ...
  nand2  g363(.a(new_n520_), .b(new_n178_), .O(z13));
