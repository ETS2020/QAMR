// Benchmark "FAU" written by ABC on Wed Aug 12 10:09:50 2020
...
module FAU ( 
  ...
  oai21  g076(.a(new_n232_), .b(new_n220_), .c(new_n179_), .O(z03));
  ...
  nor2   g098(.a(new_n254_), .b(x037), .O(new_n255_));
  inv1   g099(.a(x053), .O(new_n256_));
  inv1   g100(.a(x005), .O(new_n257_));
  inv1   g101(.a(x029), .O(new_n258_));
  nand3  g102(.a(new_n258_), .b(x013), .c(new_n257_), .O(new_n259_));
  ...
  nand2  g107(.a(new_n258_), .b(x013), .O(new_n264_));
  nor2   g108(.a(new_n262_), .b(new_n264_), .O(new_n265_));
  oai21  g109(.a(new_n265_), .b(new_n263_), .c(new_n260_), .O(new_n266_));
  aoi21  g110(.a(new_n266_), .b(new_n259_), .c(new_n256_), .O(new_n267_));
  oai21  g111(.a(new_n267_), .b(new_n255_), .c(x069), .O(new_n268_));
  oai21  g112(.a(x093), .b(x061), .c(new_n260_), .O(new_n269_));
  aoi21  g113(.a(new_n269_), .b(x005), .c(x029), .O(new_n270_));
  nor2   g114(.a(x117), .b(x109), .O(new_n271_));
  nor3   g115(.a(new_n271_), .b(x125), .c(x005), .O(new_n272_));
  nor2   g116(.a(new_n256_), .b(new_n261_), .O(new_n273_));
  oai21  g117(.a(new_n272_), .b(new_n270_), .c(new_n273_), .O(new_n274_));
  inv1   g118(.a(x037), .O(new_n275_));
  nand2  g119(.a(x069), .b(new_n275_), .O(new_n276_));
  nand3  g120(.a(new_n253_), .b(x053), .c(new_n257_), .O(new_n277_));
  oai21  g121(.a(new_n276_), .b(x029), .c(new_n277_), .O(new_n278_));
  oai21  g122(.a(x021), .b(x013), .c(new_n278_), .O(new_n279_));
  inv1   g123(.a(x069), .O(new_n280_));
  inv1   g124(.a(x013), .O(new_n281_));
  aoi21  g125(.a(new_n254_), .b(new_n281_), .c(x021), .O(new_n282_));
  inv1   g126(.a(x101), .O(new_n283_));
  nand3  g127(.a(new_n283_), .b(x037), .c(new_n257_), .O(new_n284_));
  aoi21  g128(.a(new_n258_), .b(x021), .c(new_n253_), .O(new_n285_));
  aoi21  g129(.a(new_n285_), .b(new_n284_), .c(new_n256_), .O(new_n286_));
  oai21  g130(.a(new_n286_), .b(new_n282_), .c(new_n280_), .O(new_n287_));
  nand3  g131(.a(new_n287_), .b(new_n279_), .c(new_n274_), .O(new_n288_));
  inv1   g132(.a(new_n288_), .O(new_n289_));
  aoi21  g133(.a(new_n289_), .b(new_n268_), .c(new_n177_), .O(new_n290_));
  nand2  g134(.a(x117), .b(x109), .O(new_n291_));
  nor3   g135(.a(new_n262_), .b(new_n280_), .c(x029), .O(new_n292_));
  nor2   g136(.a(x069), .b(x037), .O(new_n293_));
  oai21  g137(.a(new_n293_), .b(x005), .c(x021), .O(new_n294_));
  oai21  g138(.a(new_n294_), .b(new_n292_), .c(x077), .O(new_n295_));
  aoi21  g139(.a(new_n295_), .b(x013), .c(new_n256_), .O(new_n296_));
  nor2   g140(.a(x069), .b(x021), .O(new_n297_));
  nand2  g141(.a(new_n297_), .b(x077), .O(new_n298_));
  inv1   g142(.a(new_n298_), .O(new_n299_));
  oai21  g143(.a(new_n299_), .b(new_n296_), .c(new_n291_), .O(new_n300_));
  inv1   g144(.a(x085), .O(new_n301_));
  nand2  g145(.a(new_n301_), .b(new_n257_), .O(new_n302_));
  aoi21  g146(.a(new_n302_), .b(new_n298_), .c(new_n275_), .O(new_n303_));
  aoi21  g147(.a(new_n297_), .b(x053), .c(new_n281_), .O(new_n304_));
  oai22  g148(.a(new_n304_), .b(x077), .c(x053), .d(x037), .O(new_n305_));
  nor2   g149(.a(new_n305_), .b(new_n303_), .O(new_n306_));
  nand2  g150(.a(new_n306_), .b(new_n300_), .O(new_n307_));
  oai21  g151(.a(new_n307_), .b(new_n290_), .c(x045), .O(new_n308_));
  ...
  aoi22  g268(.a(new_n424_), .b(x009), .c(x049), .d(new_n185_), .O(new_n425_));
  oai21  g269(.a(new_n423_), .b(x009), .c(new_n425_), .O(new_n426_));
  inv1   g270(.a(new_n424_), .O(new_n427_));
  aoi21  g271(.a(new_n422_), .b(x009), .c(x033), .O(new_n428_));
  oai21  g272(.a(new_n427_), .b(x009), .c(new_n428_), .O(new_n429_));
  oai21  g273(.a(new_n427_), .b(new_n423_), .c(new_n197_), .O(new_n430_));
  aoi21  g274(.a(x049), .b(x033), .c(new_n194_), .O(new_n431_));
  nand4  g275(.a(new_n431_), .b(new_n430_), .c(new_n429_), .d(new_n426_), .O(new_n432_));
  inv1   g276(.a(new_n432_), .O(new_n433_));
  nor3   g277(.a(new_n433_), .b(z07), .c(x041), .O(z09));
  nand2  g278(.a(x066), .b(x018), .O(new_n435_));
  inv1   g279(.a(new_n435_), .O(new_n436_));
  nand2  g280(.a(x082), .b(x002), .O(new_n437_));
  aoi22  g281(.a(new_n437_), .b(x010), .c(x050), .d(new_n204_), .O(new_n438_));
  oai21  g282(.a(new_n436_), .b(x010), .c(new_n438_), .O(new_n439_));
  inv1   g283(.a(new_n437_), .O(new_n440_));
  aoi21  g284(.a(new_n435_), .b(x010), .c(x034), .O(new_n441_));
  oai21  g285(.a(new_n440_), .b(x010), .c(new_n441_), .O(new_n442_));
  oai21  g286(.a(new_n440_), .b(new_n436_), .c(new_n216_), .O(new_n443_));
  aoi21  g287(.a(x050), .b(x034), .c(new_n213_), .O(new_n444_));
  nand4  g288(.a(new_n444_), .b(new_n443_), .c(new_n442_), .d(new_n439_), .O(new_n445_));
  inv1   g289(.a(new_n445_), .O(new_n446_));
  nor3   g290(.a(new_n446_), .b(z07), .c(x042), .O(z10));
  inv1   g291(.a(x011), .O(new_n448_));
  nand2  g292(.a(x067), .b(x019), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  nand2  g294(.a(x083), .b(x003), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(x011), .O(new_n452_));
  nand3  g296(.a(new_n452_), .b(new_n450_), .c(new_n229_), .O(new_n453_));
  nand2  g297(.a(new_n451_), .b(new_n448_), .O(new_n454_));
  nand2  g298(.a(new_n449_), .b(x011), .O(new_n455_));
  nand3  g299(.a(new_n455_), .b(new_n454_), .c(new_n228_), .O(new_n456_));
  nand2  g300(.a(new_n451_), .b(new_n449_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n221_), .O(new_n458_));
  aoi22  g302(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n459_));
  nand4  g303(.a(new_n459_), .b(new_n458_), .c(new_n456_), .d(new_n453_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n220_), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n179_), .O(z11));
  nand2  g306(.a(x068), .b(x020), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  nand2  g308(.a(x084), .b(x004), .O(new_n465_));
  aoi22  g309(.a(new_n465_), .b(x012), .c(x052), .d(new_n237_), .O(new_n466_));
  ...
  oai21  g314(.a(new_n468_), .b(new_n464_), .c(new_n249_), .O(new_n471_));
  aoi21  g315(.a(x052), .b(x036), .c(new_n246_), .O(new_n472_));
  nand4  g316(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n467_), .O(new_n473_));
  inv1   g317(.a(new_n473_), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(x044), .c(new_n179_), .O(z12));
  nor2   g319(.a(new_n256_), .b(new_n275_), .O(new_n476_));
  nor2   g320(.a(new_n280_), .b(new_n261_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n256_), .O(new_n478_));
  aoi21  g322(.a(new_n275_), .b(x005), .c(x013), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n478_), .c(new_n177_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n476_), .c(x085), .O(new_n481_));
  inv1   g325(.a(new_n297_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n276_), .c(new_n257_), .O(new_n483_));
  nor2   g327(.a(x021), .b(x013), .O(new_n484_));
  nand3  g328(.a(new_n253_), .b(new_n280_), .c(x029), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n484_), .c(x085), .O(new_n486_));
  oai22  g330(.a(new_n486_), .b(new_n483_), .c(x117), .d(x109), .O(new_n487_));
  oai21  g331(.a(new_n258_), .b(x021), .c(new_n262_), .O(new_n488_));
  and2   g332(.a(new_n488_), .b(x069), .O(new_n489_));
  inv1   g333(.a(x125), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n283_), .O(new_n491_));
  oai21  g335(.a(x069), .b(x013), .c(x021), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n491_), .c(new_n253_), .d(x029), .O(new_n493_));
  inv1   g337(.a(new_n493_), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n489_), .c(new_n301_), .O(new_n495_));
  oai21  g339(.a(x037), .b(x013), .c(x021), .O(new_n496_));
  nand2  g340(.a(new_n262_), .b(new_n258_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n496_), .O(new_n498_));
  oai22  g342(.a(new_n253_), .b(new_n261_), .c(x125), .d(x101), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(x069), .O(new_n500_));
  nand3  g344(.a(new_n291_), .b(x125), .c(new_n261_), .O(new_n501_));
  nand3  g345(.a(x101), .b(x069), .c(new_n275_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n501_), .c(new_n301_), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n500_), .c(x005), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n495_), .c(new_n487_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n256_), .O(new_n506_));
  aoi21  g350(.a(x085), .b(x005), .c(new_n477_), .O(new_n507_));
  oai21  g351(.a(x053), .b(new_n275_), .c(new_n477_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(x013), .c(new_n507_), .O(new_n509_));
  nand2  g353(.a(new_n491_), .b(x005), .O(new_n510_));
  nand3  g354(.a(new_n301_), .b(x029), .c(new_n281_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n510_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n280_), .O(new_n513_));
  aoi21  g357(.a(new_n488_), .b(new_n301_), .c(x053), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(x037), .c(new_n509_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n506_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n177_), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n481_), .c(x045), .O(z13));
  inv1   g363(.a(new_n371_), .O(new_n520_));
  inv1   g364(.a(x054), .O(new_n521_));
  aoi21  g365(.a(x030), .b(new_n331_), .c(new_n319_), .O(new_n522_));
  oai21  g366(.a(x070), .b(x014), .c(x022), .O(new_n523_));
  nand2  g367(.a(new_n341_), .b(new_n339_), .O(new_n524_));
  nand4  g368(.a(new_n524_), .b(new_n523_), .c(new_n323_), .d(x030), .O(new_n525_));
  oai21  g369(.a(new_n522_), .b(new_n311_), .c(new_n525_), .O(new_n526_));
  nand2  g370(.a(new_n526_), .b(new_n315_), .O(new_n527_));
  oai22  g371(.a(new_n363_), .b(new_n331_), .c(new_n319_), .d(x030), .O(new_n528_));
  oai21  g372(.a(new_n323_), .b(new_n331_), .c(new_n524_), .O(new_n529_));
  aoi21  g373(.a(new_n529_), .b(new_n528_), .c(x070), .O(new_n530_));
  nand3  g374(.a(x102), .b(x070), .c(new_n355_), .O(new_n531_));
  nand3  g375(.a(new_n310_), .b(x126), .c(new_n331_), .O(new_n532_));
  nand3  g376(.a(new_n532_), .b(new_n531_), .c(new_n315_), .O(new_n533_));
  oai21  g377(.a(new_n533_), .b(new_n530_), .c(x006), .O(new_n534_));
  aoi21  g378(.a(new_n534_), .b(new_n527_), .c(x078), .O(new_n535_));
  nand2  g379(.a(x070), .b(new_n355_), .O(new_n536_));
  aoi21  g380(.a(new_n536_), .b(new_n349_), .c(new_n330_), .O(new_n537_));
  nand3  g381(.a(new_n323_), .b(new_n311_), .c(x030), .O(new_n538_));
  aoi21  g382(.a(new_n538_), .b(new_n331_), .c(x086), .O(new_n539_));
  oai21  g383(.a(new_n539_), .b(new_n537_), .c(new_n348_), .O(new_n540_));
  nand2  g384(.a(new_n540_), .b(new_n361_), .O(new_n541_));
  nand2  g385(.a(new_n541_), .b(new_n342_), .O(new_n542_));
  oai21  g386(.a(new_n313_), .b(new_n348_), .c(new_n542_), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n535_), .c(new_n521_), .O(new_n544_));
  nand2  g388(.a(new_n524_), .b(x006), .O(new_n545_));
  inv1   g389(.a(x014), .O(new_n546_));
  nand3  g390(.a(new_n315_), .b(x030), .c(new_n546_), .O(new_n547_));
  aoi21  g391(.a(new_n547_), .b(new_n545_), .c(x070), .O(new_n548_));
  nor2   g392(.a(new_n522_), .b(x086), .O(new_n549_));
  oai21  g393(.a(new_n549_), .b(new_n548_), .c(x038), .O(new_n550_));
  nand2  g394(.a(x086), .b(x006), .O(new_n551_));
  nand2  g395(.a(new_n551_), .b(new_n313_), .O(new_n552_));
  aoi21  g396(.a(new_n521_), .b(x038), .c(new_n313_), .O(new_n553_));
  oai21  g397(.a(new_n553_), .b(new_n546_), .c(new_n552_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n550_), .O(new_n555_));
  oai21  g399(.a(new_n551_), .b(x038), .c(new_n546_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(x078), .O(new_n557_));
  nand2  g401(.a(x054), .b(x038), .O(new_n558_));
  nand3  g402(.a(new_n558_), .b(new_n557_), .c(new_n179_), .O(new_n559_));
  aoi21  g403(.a(new_n555_), .b(new_n348_), .c(new_n559_), .O(new_n560_));
  aoi21  g404(.a(new_n560_), .b(new_n544_), .c(new_n520_), .O(z14));
  zero   g405(.O(z15));
  zero   g406(.O(z16));
  zero   g407(.O(z18));
  zero   g408(.O(z19));
  ...
  nor2   g415(.a(x085), .b(new_n177_), .O(z23));
  nor2   g416(.a(x085), .b(new_n177_), .O(z26));
  nor2   g417(.a(x085), .b(new_n177_), .O(z27));
endmodule
