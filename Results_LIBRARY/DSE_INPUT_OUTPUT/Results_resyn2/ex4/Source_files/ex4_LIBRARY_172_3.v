...
module FAU ( 
  ...
  nand2  g020(.a(x100), .b(x077), .O(new_n177_));
  ...
  nand2  g099(.a(new_n177_), .b(x044), .O(new_n256_));
  ...
  oai21  g309(.a(new_n463_), .b(new_n458_), .c(new_n232_), .O(new_n466_));
  aoi21  g310(.a(x051), .b(x035), .c(new_n230_), .O(new_n467_));
  nand4  g311(.a(new_n467_), .b(new_n466_), .c(new_n465_), .d(new_n462_), .O(new_n468_));
  and2   g312(.a(new_n468_), .b(new_n219_), .O(z11));
  nand2  g313(.a(x068), .b(x020), .O(new_n470_));
  inv1   g314(.a(new_n470_), .O(new_n471_));
  nand2  g315(.a(x084), .b(x004), .O(new_n472_));
  aoi22  g316(.a(new_n472_), .b(x012), .c(x052), .d(new_n242_), .O(new_n473_));
  ...
  oai21  g321(.a(new_n475_), .b(new_n471_), .c(new_n254_), .O(new_n478_));
  aoi21  g322(.a(x052), .b(x036), .c(new_n251_), .O(new_n479_));
  ...
  inv1   g421(.a(new_n177_), .O(z20));
  inv1   g422(.a(new_n177_), .O(z22));
  inv1   g423(.a(new_n177_), .O(z23));
  inv1   g424(.a(new_n177_), .O(z24));
  inv1   g425(.a(new_n177_), .O(z26));
endmodule
