// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:22 2020
...
module FAU ( 
  ...
  nand2  g060(.a(new_n206_), .b(new_n216_), .O(new_n217_));
  nor2   g061(.a(x074), .b(x010), .O(new_n218_));
  nor2   g062(.a(new_n218_), .b(z07), .O(new_n219_));
  nand4  g063(.a(new_n219_), .b(new_n217_), .c(new_n215_), .d(new_n213_), .O(new_n220_));
  inv1   g064(.a(new_n220_), .O(new_n221_));
  aoi21  g065(.a(new_n221_), .b(new_n210_), .c(new_n203_), .O(z02));
  ...
  nand2  g083(.a(new_n179_), .b(x043), .O(new_n240_));
  ...
  oai21  g098(.a(new_n254_), .b(new_n242_), .c(new_n179_), .O(z04));
  ...
  aoi21  g114(.a(new_n264_), .b(new_n263_), .c(x029), .O(new_n271_));
  inv1   g115(.a(x013), .O(new_n272_));
  inv1   g116(.a(x021), .O(new_n273_));
  oai21  g117(.a(new_n257_), .b(new_n272_), .c(new_n273_), .O(new_n274_));
  nand2  g118(.a(x125), .b(x101), .O(new_n275_));
  nand3  g119(.a(new_n275_), .b(new_n274_), .c(new_n271_), .O(new_n276_));
  oai21  g120(.a(new_n270_), .b(x069), .c(new_n276_), .O(new_n277_));
  nand2  g121(.a(new_n277_), .b(x085), .O(new_n278_));
  inv1   g122(.a(x005), .O(new_n279_));
  nand2  g123(.a(new_n275_), .b(new_n265_), .O(new_n280_));
  aoi21  g124(.a(x037), .b(x013), .c(x021), .O(new_n281_));
  nand3  g125(.a(x093), .b(x061), .c(x029), .O(new_n282_));
  oai21  g126(.a(new_n282_), .b(new_n275_), .c(x069), .O(new_n283_));
  aoi21  g127(.a(new_n281_), .b(new_n280_), .c(new_n283_), .O(new_n284_));
  inv1   g128(.a(x101), .O(new_n285_));
  nand3  g129(.a(new_n285_), .b(new_n257_), .c(x037), .O(new_n286_));
  or2    g130(.a(x117), .b(x109), .O(new_n287_));
  nor2   g131(.a(x125), .b(new_n273_), .O(new_n288_));
  ...
  nand3  g135(.a(new_n291_), .b(new_n278_), .c(new_n268_), .O(new_n292_));
  ...
  nand2  g143(.a(new_n275_), .b(new_n279_), .O(new_n300_));
  ...
  nor2   g148(.a(x085), .b(x005), .O(new_n305_));
  nand3  g149(.a(x053), .b(new_n299_), .c(new_n272_), .O(new_n306_));
  aoi22  g150(.a(new_n306_), .b(new_n294_), .c(new_n305_), .d(x013), .O(new_n307_));
  nand2  g151(.a(new_n307_), .b(new_n304_), .O(new_n308_));
  aoi21  g152(.a(new_n305_), .b(x037), .c(new_n272_), .O(new_n309_));
  oai22  g153(.a(new_n309_), .b(x077), .c(x053), .d(x037), .O(new_n310_));
  aoi21  g154(.a(new_n308_), .b(x077), .c(new_n310_), .O(new_n311_));
  aoi21  g155(.a(new_n311_), .b(new_n298_), .c(new_n177_), .O(z05));
  ...
  aoi22  g278(.a(new_n434_), .b(x009), .c(x049), .d(new_n196_), .O(new_n435_));
  ...
  oai21  g283(.a(new_n437_), .b(new_n433_), .c(new_n198_), .O(new_n440_));
  ...
  aoi22  g290(.a(new_n446_), .b(x010), .c(x050), .d(new_n216_), .O(new_n447_));
  ...
  and2   g298(.a(new_n454_), .b(new_n203_), .O(z10));
  ...
  oai21  g311(.a(new_n467_), .b(x043), .c(new_n179_), .O(z11));
  ...
  nand3  g317(.a(new_n473_), .b(new_n471_), .c(new_n251_), .O(new_n474_));
  nand2  g318(.a(new_n472_), .b(new_n469_), .O(new_n475_));
  nand2  g319(.a(new_n470_), .b(x012), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n475_), .c(new_n250_), .O(new_n477_));
  ...
  nand2  g325(.a(new_n481_), .b(new_n242_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n179_), .O(z12));
  inv1   g327(.a(new_n259_), .O(new_n484_));
  nand2  g328(.a(x053), .b(new_n299_), .O(new_n485_));
  oai21  g329(.a(new_n484_), .b(x053), .c(new_n485_), .O(new_n486_));
  nor2   g330(.a(x037), .b(new_n279_), .O(new_n487_));
  nand2  g331(.a(x077), .b(new_n272_), .O(new_n488_));
  aoi21  g332(.a(new_n487_), .b(x085), .c(new_n488_), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n486_), .c(x045), .O(z13));
  inv1   g334(.a(x054), .O(new_n491_));
  nand2  g335(.a(x070), .b(new_n358_), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n352_), .c(new_n333_), .O(new_n493_));
  nand3  g337(.a(new_n326_), .b(new_n314_), .c(x030), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n334_), .c(x086), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n493_), .c(new_n345_), .O(new_n496_));
  aoi21  g340(.a(x030), .b(new_n334_), .c(new_n322_), .O(new_n497_));
  oai21  g341(.a(x070), .b(x014), .c(x022), .O(new_n498_));
  nand2  g342(.a(new_n344_), .b(new_n342_), .O(new_n499_));
  nand4  g343(.a(new_n499_), .b(new_n498_), .c(new_n326_), .d(x030), .O(new_n500_));
  oai21  g344(.a(new_n497_), .b(new_n314_), .c(new_n500_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n318_), .O(new_n502_));
  oai21  g346(.a(x038), .b(x014), .c(x022), .O(new_n503_));
  nand3  g347(.a(new_n321_), .b(new_n320_), .c(new_n319_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n503_), .O(new_n505_));
  oai22  g349(.a(new_n326_), .b(new_n334_), .c(x126), .d(x102), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n505_), .c(x070), .O(new_n507_));
  nand3  g351(.a(x102), .b(x070), .c(new_n358_), .O(new_n508_));
  nand3  g352(.a(new_n313_), .b(x126), .c(new_n334_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n508_), .c(new_n318_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n507_), .c(x006), .O(new_n511_));
  nand3  g355(.a(new_n511_), .b(new_n502_), .c(new_n496_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n351_), .O(new_n513_));
  inv1   g357(.a(new_n316_), .O(new_n514_));
  aoi22  g358(.a(new_n365_), .b(new_n345_), .c(new_n514_), .d(x078), .O(new_n515_));
  ...
  nand3  g362(.a(new_n318_), .b(x030), .c(new_n364_), .O(new_n519_));
  ...
  oai21  g367(.a(new_n523_), .b(x014), .c(new_n316_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n335_), .O(new_n525_));
  nand2  g369(.a(new_n525_), .b(new_n522_), .O(new_n526_));
  oai21  g370(.a(new_n523_), .b(x038), .c(new_n364_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(x078), .O(new_n528_));
  oai21  g372(.a(new_n491_), .b(new_n358_), .c(new_n528_), .O(new_n529_));
  aoi21  g373(.a(new_n526_), .b(new_n351_), .c(new_n529_), .O(new_n530_));
  ...
  zero   g382(.O(z23));
  zero   g383(.O(z24));
  inv1   g384(.a(new_n179_), .O(z15));
  inv1   g385(.a(new_n179_), .O(z17));
  inv1   g386(.a(new_n179_), .O(z22));
  inv1   g387(.a(new_n179_), .O(z25));
  inv1   g388(.a(new_n179_), .O(z26));
  inv1   g389(.a(new_n179_), .O(z27));
endmodule
