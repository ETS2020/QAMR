...
module FAU ( 
  ...
  nand2  g021(.a(new_n177_), .b(x023), .O(new_n178_));
  ...
  oai21  g091(.a(new_n247_), .b(new_n235_), .c(new_n178_), .O(z04));
  ...
  oai21  g271(.a(new_n425_), .b(new_n420_), .c(new_n195_), .O(new_n428_));
  aoi21  g272(.a(x049), .b(x033), .c(new_n193_), .O(new_n429_));
  nand4  g273(.a(new_n429_), .b(new_n428_), .c(new_n427_), .d(new_n424_), .O(new_n430_));
  and2   g274(.a(new_n430_), .b(new_n182_), .O(z09));
  nand2  g275(.a(x066), .b(x018), .O(new_n432_));
  inv1   g276(.a(new_n432_), .O(new_n433_));
  nand2  g277(.a(x082), .b(x002), .O(new_n434_));
  aoi22  g278(.a(new_n434_), .b(x010), .c(x050), .d(new_n205_), .O(new_n435_));
  ...
  oai21  g283(.a(new_n437_), .b(new_n433_), .c(new_n217_), .O(new_n440_));
  aoi21  g284(.a(x050), .b(x034), .c(new_n214_), .O(new_n441_));
  ...
  nand3  g293(.a(new_n449_), .b(new_n447_), .c(new_n230_), .O(new_n450_));
  nand2  g294(.a(new_n448_), .b(new_n445_), .O(new_n451_));
  nand2  g295(.a(new_n446_), .b(x011), .O(new_n452_));
  nand3  g296(.a(new_n452_), .b(new_n451_), .c(new_n229_), .O(new_n453_));
  nand2  g297(.a(new_n448_), .b(new_n446_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n222_), .O(new_n455_));
  ...
  oai21  g339(.a(new_n495_), .b(new_n482_), .c(new_n177_), .O(new_n496_));
  ...
  oai21  g346(.a(new_n502_), .b(new_n500_), .c(new_n177_), .O(new_n503_));
  ...
  oai21  g358(.a(new_n514_), .b(new_n512_), .c(new_n177_), .O(new_n515_));
  ...
  zero   g410(.O(z24));
  zero   g411(.O(z26));
  inv1   g412(.a(new_n178_), .O(z15));
  inv1   g413(.a(new_n178_), .O(z16));
  inv1   g414(.a(new_n178_), .O(z17));
  inv1   g415(.a(new_n178_), .O(z18));
  inv1   g416(.a(new_n178_), .O(z20));
  inv1   g417(.a(new_n178_), .O(z21));
  inv1   g418(.a(new_n178_), .O(z25));
  inv1   g419(.a(new_n178_), .O(z27));
endmodule
