// Benchmark "FAU" written by ABC on Wed Aug 12 10:05:01 2020
...
module FAU ( 
  ...
  inv1   g021(.a(x007), .O(new_n178_));
  nor2   g022(.a(x045), .b(new_n178_), .O(z16));
  ...
  nand3  g160(.a(new_n260_), .b(x037), .c(new_n305_), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(x013), .O(new_n318_));
  aoi22  g162(.a(new_n318_), .b(new_n293_), .c(new_n259_), .d(new_n316_), .O(new_n319_));
  ...
  aoi21  g236(.a(new_n169_), .b(new_n157_), .c(new_n158_), .O(new_n394_));
  ...
  aoi21  g247(.a(new_n404_), .b(new_n399_), .c(new_n388_), .O(new_n405_));
  ...
  oai21  g253(.a(new_n410_), .b(new_n405_), .c(new_n387_), .O(new_n411_));
  or2    g254(.a(x112), .b(x104), .O(new_n412_));
  nand2  g255(.a(x064), .b(new_n169_), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n160_), .c(new_n388_), .O(new_n414_));
  ...
  aoi22  g263(.a(new_n420_), .b(x072), .c(new_n418_), .d(new_n412_), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n411_), .c(x048), .O(new_n422_));
  nand2  g265(.a(new_n391_), .b(x000), .O(new_n423_));
  nand3  g266(.a(new_n172_), .b(x024), .c(new_n157_), .O(new_n424_));
  aoi21  g267(.a(new_n424_), .b(new_n423_), .c(x064), .O(new_n425_));
  and2   g268(.a(new_n406_), .b(new_n172_), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(new_n425_), .c(x032), .O(new_n427_));
  nand2  g270(.a(x080), .b(x000), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n419_), .O(new_n429_));
  aoi21  g272(.a(new_n170_), .b(x032), .c(new_n419_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n157_), .c(new_n429_), .O(new_n431_));
  nand2  g274(.a(new_n431_), .b(new_n427_), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n387_), .O(new_n433_));
  ...
  oai21  g279(.a(new_n436_), .b(new_n422_), .c(new_n386_), .O(new_n437_));
  ...
  oai21  g328(.a(new_n483_), .b(new_n479_), .c(new_n255_), .O(new_n486_));
  ...
  inv1   g333(.a(new_n285_), .O(new_n491_));
  nand2  g334(.a(x069), .b(new_n316_), .O(new_n492_));
  aoi21  g335(.a(new_n492_), .b(new_n301_), .c(new_n305_), .O(new_n493_));
  nand2  g336(.a(x093), .b(x061), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n261_), .c(x029), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n267_), .c(x085), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(new_n493_), .c(new_n491_), .O(new_n497_));
  aoi21  g340(.a(x029), .b(new_n267_), .c(new_n272_), .O(new_n498_));
  oai21  g341(.a(x069), .b(x013), .c(x021), .O(new_n499_));
  nand2  g342(.a(new_n286_), .b(new_n282_), .O(new_n500_));
  nand4  g343(.a(new_n500_), .b(new_n499_), .c(new_n494_), .d(x029), .O(new_n501_));
  oai21  g344(.a(new_n498_), .b(new_n261_), .c(new_n501_), .O(new_n502_));
  nand2  g345(.a(new_n502_), .b(new_n260_), .O(new_n503_));
  oai21  g346(.a(x037), .b(x013), .c(x021), .O(new_n504_));
  oai21  g347(.a(new_n272_), .b(x029), .c(new_n504_), .O(new_n505_));
  oai21  g348(.a(new_n494_), .b(new_n267_), .c(new_n500_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n505_), .c(x069), .O(new_n507_));
  nand3  g350(.a(x101), .b(x069), .c(new_n316_), .O(new_n508_));
  nand3  g351(.a(new_n292_), .b(x125), .c(new_n267_), .O(new_n509_));
  ...
  nand2  g355(.a(new_n512_), .b(new_n293_), .O(new_n513_));
  inv1   g356(.a(new_n294_), .O(new_n514_));
  inv1   g357(.a(new_n312_), .O(new_n515_));
  aoi22  g358(.a(new_n515_), .b(new_n491_), .c(new_n514_), .d(x077), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n513_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n259_), .O(new_n518_));
  nand2  g361(.a(new_n500_), .b(x005), .O(new_n519_));
  nand3  g362(.a(new_n260_), .b(x029), .c(new_n266_), .O(new_n520_));
  aoi21  g363(.a(new_n520_), .b(new_n519_), .c(x069), .O(new_n521_));
  nor2   g364(.a(new_n498_), .b(x085), .O(new_n522_));
  oai21  g365(.a(new_n522_), .b(new_n521_), .c(x037), .O(new_n523_));
  nand2  g366(.a(x085), .b(x005), .O(new_n524_));
  oai21  g367(.a(new_n524_), .b(x013), .c(new_n294_), .O(new_n525_));
  oai21  g368(.a(new_n316_), .b(new_n266_), .c(new_n525_), .O(new_n526_));
  nand2  g369(.a(new_n526_), .b(new_n523_), .O(new_n527_));
  oai21  g370(.a(new_n524_), .b(x037), .c(new_n266_), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(x077), .O(new_n529_));
  oai21  g372(.a(new_n259_), .b(new_n316_), .c(new_n529_), .O(new_n530_));
  aoi21  g373(.a(new_n527_), .b(new_n293_), .c(new_n530_), .O(new_n531_));
  inv1   g374(.a(x045), .O(new_n532_));
  nand2  g375(.a(new_n532_), .b(new_n178_), .O(new_n533_));
  aoi21  g376(.a(new_n531_), .b(new_n518_), .c(new_n533_), .O(z13));
  inv1   g377(.a(x054), .O(new_n535_));
  aoi21  g378(.a(x030), .b(new_n345_), .c(new_n332_), .O(new_n536_));
  oai21  g379(.a(x070), .b(x014), .c(x022), .O(new_n537_));
  nand2  g380(.a(new_n354_), .b(new_n352_), .O(new_n538_));
  nand4  g381(.a(new_n538_), .b(new_n537_), .c(new_n336_), .d(x030), .O(new_n539_));
  oai21  g382(.a(new_n536_), .b(new_n324_), .c(new_n539_), .O(new_n540_));
  nand2  g383(.a(new_n540_), .b(new_n328_), .O(new_n541_));
  oai22  g384(.a(new_n375_), .b(new_n345_), .c(new_n332_), .d(x030), .O(new_n542_));
  oai21  g385(.a(new_n336_), .b(new_n345_), .c(new_n538_), .O(new_n543_));
  aoi21  g386(.a(new_n543_), .b(new_n542_), .c(x070), .O(new_n544_));
  nand3  g387(.a(x102), .b(x070), .c(new_n346_), .O(new_n545_));
  nand3  g388(.a(new_n323_), .b(x126), .c(new_n345_), .O(new_n546_));
  ...
  nand2  g392(.a(x070), .b(new_n346_), .O(new_n550_));
  aoi21  g393(.a(new_n550_), .b(new_n362_), .c(new_n343_), .O(new_n551_));
  nand3  g394(.a(new_n336_), .b(new_n324_), .c(x030), .O(new_n552_));
  aoi21  g395(.a(new_n552_), .b(new_n345_), .c(x086), .O(new_n553_));
  oai21  g396(.a(new_n553_), .b(new_n551_), .c(new_n361_), .O(new_n554_));
  nand2  g397(.a(new_n554_), .b(new_n373_), .O(new_n555_));
  nand2  g398(.a(new_n555_), .b(new_n355_), .O(new_n556_));
  oai21  g399(.a(new_n326_), .b(new_n361_), .c(new_n556_), .O(new_n557_));
  oai21  g400(.a(new_n557_), .b(new_n549_), .c(new_n535_), .O(new_n558_));
  nand2  g401(.a(new_n538_), .b(x006), .O(new_n559_));
  nand3  g402(.a(new_n328_), .b(x030), .c(new_n344_), .O(new_n560_));
  ...
  nand2  g407(.a(new_n564_), .b(new_n326_), .O(new_n565_));
  aoi21  g408(.a(new_n535_), .b(x038), .c(new_n326_), .O(new_n566_));
  oai21  g409(.a(new_n566_), .b(new_n344_), .c(new_n565_), .O(new_n567_));
  nand2  g410(.a(new_n567_), .b(new_n563_), .O(new_n568_));
  oai21  g411(.a(new_n564_), .b(x038), .c(new_n344_), .O(new_n569_));
  nand2  g412(.a(new_n569_), .b(x078), .O(new_n570_));
  nand2  g413(.a(x054), .b(x038), .O(new_n571_));
  nand3  g414(.a(new_n571_), .b(new_n570_), .c(new_n180_), .O(new_n572_));
  aoi21  g415(.a(new_n568_), .b(new_n361_), .c(new_n572_), .O(new_n573_));
  aoi22  g416(.a(new_n573_), .b(new_n558_), .c(new_n180_), .d(x046), .O(z14));
  zero   g417(.O(z07));
  zero   g418(.O(z15));
  zero   g419(.O(z18));
  zero   g420(.O(z19));
  ...
  zero   g424(.O(z23));
  zero   g425(.O(z26));
  nor2   g426(.a(x045), .b(new_n178_), .O(z17));
  nor2   g427(.a(x045), .b(new_n178_), .O(z24));
  nor2   g428(.a(x045), .b(new_n178_), .O(z25));
  nor2   g429(.a(x045), .b(new_n178_), .O(z27));
endmodule
