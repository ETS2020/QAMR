...
module FAU ( 
  ...
  nand2  g040(.a(x077), .b(x040), .O(new_n197_));
  nand2  g041(.a(new_n197_), .b(x041), .O(new_n198_));
  aoi21  g042(.a(new_n196_), .b(new_n186_), .c(new_n198_), .O(z01));
  ...
  oai21  g347(.a(new_n504_), .b(new_n491_), .c(new_n177_), .O(new_n505_));
  ...
  oai21  g354(.a(new_n511_), .b(new_n509_), .c(new_n177_), .O(new_n512_));
  ...
  oai21  g366(.a(new_n523_), .b(new_n521_), .c(new_n177_), .O(new_n524_));
