...
module FAU ( 
  ...
  aoi21  g24(.a(new_n45_), .b(x1), .c(x0), .O(z08));
  nand4  g25(.a(new_n29_), .b(x2), .c(x1), .d(new_n26_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n22_), .O(z09));
  aoi21  g27(.a(new_n33_), .b(x1), .c(x0), .O(z10));
  nand3  g28(.a(x4), .b(new_n29_), .c(new_n32_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x1), .c(x0), .O(z11));
  inv1   g30(.a(new_n28_), .O(z12));
  zero   g31(.O(z14));
  zero   g32(.O(z15));
  inv1   g33(.a(new_n28_), .O(z13));
endmodule
