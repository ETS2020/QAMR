...
module FAU ( 
  ...
  nand3  g13(.a(x3), .b(x1), .c(new_n34_), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(x2), .c(new_n22_), .O(z08));
  nand4  g15(.a(new_n25_), .b(x2), .c(x1), .d(new_n34_), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n22_), .O(z09));
  nand4  g17(.a(x3), .b(x2), .c(new_n29_), .d(new_n34_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n22_), .O(z12));
  nand4  g19(.a(new_n25_), .b(x2), .c(new_n29_), .d(new_n34_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n22_), .O(z13));
  zero   g21(.O(z10));
  nor2   g22(.a(new_n22_), .b(x2), .O(z03));
  nor2   g23(.a(new_n22_), .b(x2), .O(z06));
  nor2   g24(.a(new_n22_), .b(x2), .O(z07));
