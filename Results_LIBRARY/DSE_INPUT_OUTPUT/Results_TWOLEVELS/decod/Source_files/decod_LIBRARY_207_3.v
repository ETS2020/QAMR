...
module FAU ( 
  ...
  nand3  g26(.a(x4), .b(new_n32_), .c(x2), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n25_), .O(z13));
  nand4  g28(.a(x3), .b(new_n35_), .c(new_n28_), .d(new_n27_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n31_), .O(z14));
  oai21  g30(.a(new_n50_), .b(new_n38_), .c(new_n25_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z01));
  zero   g33(.O(z02));
endmodule
