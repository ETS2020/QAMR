...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n38_, new_n42_, new_n43_, new_n45_, new_n47_,
  ...
  nand4  g14(.a(new_n28_), .b(new_n25_), .c(new_n24_), .d(x0), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n37_), .O(z07));
  inv1   g16(.a(x0), .O(new_n42_));
  nand3  g17(.a(x4), .b(x3), .c(new_n42_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n25_), .c(new_n24_), .O(z10));
  nand4  g19(.a(new_n28_), .b(new_n25_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n37_), .O(z11));
  nand4  g21(.a(x3), .b(x2), .c(new_n24_), .d(new_n42_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n37_), .O(z12));
  nand4  g23(.a(new_n28_), .b(x2), .c(new_n24_), .d(new_n42_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n37_), .O(z13));
  nand4  g25(.a(x3), .b(new_n25_), .c(new_n24_), .d(new_n42_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n37_), .O(z14));
  nand4  g27(.a(new_n28_), .b(new_n25_), .c(new_n24_), .d(new_n42_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n37_), .O(z15));
  zero   g29(.O(z00));
  zero   g30(.O(z01));
  zero   g31(.O(z08));
  zero   g32(.O(z09));
