...
module FAU ( 
  ...
  nand4  g10(.a(x3), .b(new_n31_), .c(new_n25_), .d(x0), .O(new_n32_));
  nor2   g11(.a(new_n32_), .b(new_n24_), .O(z06));
  nand4  g12(.a(new_n28_), .b(new_n31_), .c(new_n25_), .d(x0), .O(new_n34_));
  ...
  nand4  g17(.a(new_n28_), .b(x2), .c(x1), .d(new_n36_), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n24_), .O(z09));
  nand3  g19(.a(x4), .b(x3), .c(new_n31_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n36_), .c(new_n25_), .O(z10));
  nand4  g21(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n36_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n24_), .O(z11));
  nand2  g23(.a(new_n25_), .b(new_n36_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n37_), .c(new_n22_), .O(z12));
  nand4  g25(.a(new_n28_), .b(x2), .c(new_n25_), .d(new_n36_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n24_), .O(z13));
  oai21  g27(.a(new_n45_), .b(new_n41_), .c(new_n22_), .O(z14));
  nand4  g28(.a(new_n28_), .b(new_n31_), .c(new_n25_), .d(new_n36_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n24_), .O(z15));
