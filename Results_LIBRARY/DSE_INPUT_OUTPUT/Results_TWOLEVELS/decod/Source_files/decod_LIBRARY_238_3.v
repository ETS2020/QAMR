...
module FAU ( 
  ...
  aoi21  g07(.a(new_n30_), .b(new_n23_), .c(new_n24_), .O(z05));
  ...
  nand4  g14(.a(x3), .b(x2), .c(new_n23_), .d(new_n39_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n24_), .O(z12));
  nand4  g16(.a(new_n29_), .b(x2), .c(new_n23_), .d(new_n39_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n24_), .O(z13));
  nand3  g18(.a(x3), .b(new_n32_), .c(new_n39_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n23_), .c(new_n24_), .O(z14));
  nand3  g20(.a(new_n29_), .b(new_n32_), .c(new_n39_), .O(new_n46_));
