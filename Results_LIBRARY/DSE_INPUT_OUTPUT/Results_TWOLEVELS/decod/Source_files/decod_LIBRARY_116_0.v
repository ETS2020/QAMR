...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n36_, new_n41_, new_n42_, new_n44_,
  ...
  nor2   g24(.a(new_n46_), .b(new_n28_), .O(z10));
  nand4  g25(.a(new_n23_), .b(new_n31_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n28_), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n28_), .O(z12));
  nand4  g29(.a(x3), .b(new_n31_), .c(new_n22_), .d(new_n41_), .O(new_n53_));
