...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    ...
    new_n44_, new_n46_, new_n48_, new_n49_, new_n52_, new_n54_, new_n56_,
    new_n58_;
  ...
  nand4  g15(.a(new_n22_), .b(x2), .c(new_n31_), .d(x0), .O(new_n37_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(new_n32_), .O(z10));
  oai21  g29(.a(new_n48_), .b(new_n33_), .c(new_n32_), .O(z11));
  ...
  nand4  g34(.a(x3), .b(new_n27_), .c(new_n31_), .d(new_n43_), .O(new_n56_));
