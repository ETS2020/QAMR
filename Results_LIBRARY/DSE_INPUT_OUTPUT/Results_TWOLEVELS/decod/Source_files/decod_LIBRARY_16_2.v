...
module FAU ( 
  ...
  nand3  g09(.a(new_n22_), .b(new_n27_), .c(x1), .O(new_n31_));
  ...
  nand4  g18(.a(new_n22_), .b(new_n27_), .c(new_n33_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n23_), .O(z07));
  nand4  g20(.a(x3), .b(x2), .c(x1), .d(new_n30_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n23_), .O(z08));
  nand4  g22(.a(new_n22_), .b(x2), .c(x1), .d(new_n30_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(z09));
  nand4  g24(.a(x3), .b(new_n27_), .c(x1), .d(new_n30_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z10));
  nand4  g26(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n30_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z11));
  nand4  g28(.a(x3), .b(x2), .c(new_n33_), .d(new_n30_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z12));
  nand4  g30(.a(new_n22_), .b(x2), .c(new_n33_), .d(new_n30_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z13));
  nand4  g32(.a(x3), .b(new_n27_), .c(new_n33_), .d(new_n30_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z14));
  nand2  g34(.a(new_n33_), .b(new_n30_), .O(new_n56_));
  nand2  g35(.a(new_n23_), .b(x0), .O(new_n57_));
  nand3  g36(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(new_n57_), .O(z15));
endmodule
