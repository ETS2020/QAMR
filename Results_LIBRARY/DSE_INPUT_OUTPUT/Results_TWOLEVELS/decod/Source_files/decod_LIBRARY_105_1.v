...
module FAU ( 
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(new_n34_), .O(z09));
  nand3  g23(.a(x4), .b(new_n28_), .c(new_n39_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(x1), .c(new_n22_), .O(z10));
  nand4  g25(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n39_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n25_), .O(z11));
  aoi21  g27(.a(new_n40_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g28(.a(new_n22_), .b(new_n28_), .c(new_n33_), .d(new_n39_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n25_), .O(z15));
  inv1   g30(.a(new_n34_), .O(z06));
  inv1   g31(.a(new_n34_), .O(z12));
  inv1   g32(.a(new_n34_), .O(z14));
endmodule
