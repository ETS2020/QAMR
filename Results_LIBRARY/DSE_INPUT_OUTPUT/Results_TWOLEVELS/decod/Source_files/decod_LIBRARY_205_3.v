...
module FAU ( 
  ...
  nand4  g03(.a(x3), .b(x2), .c(new_n25_), .d(x0), .O(new_n28_));
  nor2   g04(.a(new_n28_), .b(new_n26_), .O(z04));
  ...
  nand4  g18(.a(x3), .b(new_n33_), .c(new_n25_), .d(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n26_), .O(z14));
  ...
  nor2   g27(.a(new_n26_), .b(new_n25_), .O(z09));
