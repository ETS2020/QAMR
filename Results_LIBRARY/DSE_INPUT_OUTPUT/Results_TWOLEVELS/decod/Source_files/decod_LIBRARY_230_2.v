...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n31_,
    ...
    new_n44_, new_n45_, new_n47_, new_n49_, new_n50_, new_n52_, new_n54_,
  ...
  nand3  g14(.a(new_n30_), .b(new_n33_), .c(x0), .O(new_n36_));
  ...
  nand2  g18(.a(new_n33_), .b(x0), .O(new_n40_));
  nand2  g19(.a(new_n25_), .b(x2), .O(new_n41_));
  nand3  g20(.a(x4), .b(new_n30_), .c(new_n22_), .O(new_n42_));
  ...
  nand3  g25(.a(new_n30_), .b(x1), .c(new_n44_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(new_n22_), .O(z09));
  nand2  g27(.a(x1), .b(new_n44_), .O(new_n49_));
  nand3  g28(.a(x4), .b(x3), .c(new_n22_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n49_), .c(new_n41_), .O(z10));
  nand4  g30(.a(new_n30_), .b(new_n22_), .c(x1), .d(new_n44_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n25_), .O(z11));
  nand3  g32(.a(x3), .b(new_n33_), .c(new_n44_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(new_n22_), .O(z12));
  nand4  g34(.a(new_n30_), .b(x2), .c(new_n33_), .d(new_n44_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n25_), .O(z13));
  nand2  g36(.a(new_n33_), .b(new_n44_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n50_), .c(new_n41_), .O(z14));
  nand4  g38(.a(new_n30_), .b(new_n22_), .c(new_n33_), .d(new_n44_), .O(new_n60_));
