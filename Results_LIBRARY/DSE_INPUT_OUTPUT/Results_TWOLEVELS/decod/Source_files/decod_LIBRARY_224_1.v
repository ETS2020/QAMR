...
module FAU ( 
  ...
  nand3  g16(.a(x3), .b(new_n29_), .c(new_n35_), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(x2), .c(new_n23_), .O(z12));
  nand3  g18(.a(new_n22_), .b(new_n29_), .c(new_n35_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(x2), .c(new_n23_), .O(z13));
  zero   g20(.O(z02));
  zero   g21(.O(z07));
  zero   g22(.O(z10));
  nor2   g23(.a(new_n23_), .b(x2), .O(z06));
  nor2   g24(.a(new_n23_), .b(x2), .O(z11));
