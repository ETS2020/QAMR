...
module FAU ( 
  ...
  nand4  g23(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n46_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n25_), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n28_), .O(new_n49_));
  aoi21  g26(.a(new_n49_), .b(new_n22_), .c(x0), .O(z14));
  nand4  g27(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n46_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n25_), .O(z15));
  zero   g29(.O(z10));
  zero   g30(.O(z11));
  nor2   g31(.a(new_n22_), .b(x0), .O(z09));
endmodule
