...
module FAU ( 
  ...
  nand4  g21(.a(new_n31_), .b(new_n35_), .c(x1), .d(new_n34_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n27_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n28_), .d(new_n34_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n27_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n28_), .d(new_n34_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n27_), .O(z13));
  nand2  g27(.a(new_n28_), .b(new_n34_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n36_), .c(new_n22_), .O(z14));
  oai21  g29(.a(new_n52_), .b(new_n38_), .c(new_n22_), .O(z15));
  zero   g30(.O(z01));
  zero   g31(.O(z02));
  zero   g32(.O(z03));
endmodule
