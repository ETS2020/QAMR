...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n33_,
  ...
  nand4  g15(.a(x3), .b(new_n27_), .c(new_n33_), .d(x0), .O(new_n37_));
  ...
  nand4  g21(.a(new_n34_), .b(x2), .c(x1), .d(new_n40_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n22_), .O(z09));
  nand3  g23(.a(x4), .b(x3), .c(new_n27_), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n41_), .c(new_n35_), .O(z10));
  nand4  g25(.a(new_n34_), .b(new_n27_), .c(x1), .d(new_n40_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n22_), .O(z11));
  nand3  g27(.a(x4), .b(x2), .c(new_n40_), .O(new_n50_));
  aoi21  g28(.a(new_n50_), .b(x3), .c(x1), .O(z12));
  nand4  g29(.a(x3), .b(new_n27_), .c(new_n33_), .d(new_n40_), .O(new_n52_));
