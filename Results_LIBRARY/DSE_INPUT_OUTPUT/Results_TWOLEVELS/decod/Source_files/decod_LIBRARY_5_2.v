...
module FAU ( 
  ...
  nand4  g12(.a(new_n25_), .b(x2), .c(new_n22_), .d(x0), .O(new_n36_));
  nor2   g13(.a(new_n36_), .b(new_n35_), .O(z05));
  aoi21  g14(.a(new_n23_), .b(new_n22_), .c(x2), .O(z06));
  nand4  g15(.a(new_n25_), .b(new_n30_), .c(new_n22_), .d(x0), .O(new_n39_));
  ...
  nor2   g21(.a(new_n44_), .b(new_n35_), .O(z09));
  inv1   g22(.a(new_n31_), .O(z11));
  nand2  g23(.a(new_n22_), .b(new_n41_), .O(new_n48_));
  oai21  g24(.a(new_n48_), .b(new_n33_), .c(new_n31_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n35_), .O(z13));
  aoi21  g27(.a(new_n42_), .b(new_n22_), .c(x2), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n30_), .c(new_n22_), .d(new_n41_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n35_), .O(z15));
  zero   g30(.O(z02));
  zero   g31(.O(z03));
  zero   g32(.O(z10));
endmodule
