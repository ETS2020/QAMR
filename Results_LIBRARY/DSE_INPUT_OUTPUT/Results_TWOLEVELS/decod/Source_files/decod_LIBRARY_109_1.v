...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n22_, new_n23_, new_n24_, new_n28_, new_n29_, new_n31_, new_n34_,
    new_n35_, new_n37_, new_n40_, new_n42_;
  ...
  nand3  g12(.a(x3), .b(x1), .c(new_n34_), .O(new_n35_));
  aoi21  g13(.a(new_n35_), .b(x2), .c(new_n23_), .O(z08));
  nand4  g14(.a(new_n22_), .b(x2), .c(x1), .d(new_n34_), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n23_), .O(z09));
  nand4  g16(.a(x3), .b(x2), .c(new_n28_), .d(new_n34_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n23_), .O(z12));
  nand4  g18(.a(new_n22_), .b(x2), .c(new_n28_), .d(new_n34_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z13));
  zero   g20(.O(z06));
  zero   g21(.O(z11));
  nor2   g22(.a(new_n23_), .b(x2), .O(z03));
  nor2   g23(.a(new_n23_), .b(x2), .O(z07));
  nor2   g24(.a(new_n23_), .b(x2), .O(z10));
  nor2   g25(.a(new_n23_), .b(x2), .O(z14));
