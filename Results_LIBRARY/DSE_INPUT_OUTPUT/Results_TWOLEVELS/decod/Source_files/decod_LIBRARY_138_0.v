...
module FAU ( 
  ...
  nand4  g14(.a(new_n23_), .b(x2), .c(new_n34_), .d(x0), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n28_), .O(z05));
  nand3  g16(.a(x4), .b(new_n34_), .c(x0), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(x3), .c(x2), .O(z06));
  ...
  nand2  g26(.a(new_n34_), .b(new_n42_), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n26_), .c(new_n24_), .O(z12));
  nand4  g28(.a(new_n23_), .b(x2), .c(new_n34_), .d(new_n42_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n28_), .O(z13));
  nand3  g30(.a(x4), .b(new_n34_), .c(new_n42_), .O(new_n54_));
  aoi21  g31(.a(new_n54_), .b(x3), .c(x2), .O(z14));
  zero   g32(.O(z03));
  zero   g33(.O(z11));
  zero   g34(.O(z15));
endmodule
