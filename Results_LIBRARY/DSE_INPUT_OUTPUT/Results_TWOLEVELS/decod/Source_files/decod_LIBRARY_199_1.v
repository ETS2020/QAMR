...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    ...
    new_n43_, new_n48_, new_n51_, new_n54_;
  ...
  nand4  g24(.a(new_n22_), .b(new_n31_), .c(x1), .d(new_n25_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n30_), .O(z11));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n30_), .O(z13));
  inv1   g28(.a(new_n26_), .O(z14));
  nand4  g29(.a(new_n22_), .b(new_n31_), .c(new_n36_), .d(new_n25_), .O(new_n54_));
  nor2   g30(.a(new_n54_), .b(new_n30_), .O(z15));
  zero   g31(.O(z08));
  zero   g32(.O(z10));
  zero   g33(.O(z12));
endmodule
