...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n39_, new_n40_, new_n44_, new_n46_;
  ...
  oai21  g20(.a(new_n39_), .b(new_n31_), .c(new_n34_), .O(z11));
  nand3  g21(.a(x4), .b(x3), .c(x2), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(new_n27_), .c(x1), .O(z12));
  ...
  zero   g27(.O(z06));
  inv1   g28(.a(new_n34_), .O(z05));
  inv1   g29(.a(new_n34_), .O(z07));
endmodule
