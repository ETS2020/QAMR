...
module FAU ( 
  ...
  aoi21  g25(.a(new_n47_), .b(x1), .c(new_n28_), .O(z10));
  nand4  g26(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z11));
  aoi21  g28(.a(new_n43_), .b(new_n28_), .c(x1), .O(z13));
  aoi21  g29(.a(new_n47_), .b(new_n28_), .c(x1), .O(z15));
  zero   g30(.O(z06));
  zero   g31(.O(z14));
