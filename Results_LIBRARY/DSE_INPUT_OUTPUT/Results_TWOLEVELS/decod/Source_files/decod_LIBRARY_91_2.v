...
module FAU ( 
  ...
  nand4  g17(.a(new_n25_), .b(new_n29_), .c(new_n28_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n22_), .O(z07));
  inv1   g19(.a(x0), .O(new_n41_));
  nand3  g20(.a(x4), .b(x2), .c(new_n41_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x3), .c(new_n28_), .O(z08));
  nand3  g22(.a(x4), .b(new_n29_), .c(new_n41_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x3), .c(new_n28_), .O(z10));
  nand4  g24(.a(x3), .b(x2), .c(new_n28_), .d(new_n41_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n22_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n28_), .d(new_n41_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z13));
  nand2  g28(.a(new_n28_), .b(new_n41_), .O(new_n51_));
  oai21  g29(.a(new_n51_), .b(new_n37_), .c(new_n26_), .O(z14));
  aoi21  g30(.a(new_n44_), .b(new_n28_), .c(x3), .O(z15));
  zero   g31(.O(z11));
