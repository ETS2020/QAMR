...
module FAU ( 
  ...
  wire new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n40_, new_n42_, new_n44_, new_n46_,
  ...
  nand4  g18(.a(x3), .b(new_n34_), .c(x1), .d(new_n26_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n33_), .O(z10));
  nand4  g20(.a(new_n30_), .b(new_n34_), .c(x1), .d(new_n26_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n33_), .O(z11));
  nand2  g22(.a(new_n27_), .b(new_n26_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n28_), .c(new_n24_), .O(z12));
  ...
  nand4  g28(.a(new_n30_), .b(new_n34_), .c(new_n27_), .d(new_n26_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n33_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
