...
module FAU ( 
  ...
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n39_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n33_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n39_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n33_), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n39_), .O(new_n53_));
