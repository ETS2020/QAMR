...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(x1), .c(x0), .O(z08));
  aoi21  g23(.a(new_n30_), .b(x1), .c(x0), .O(z09));
  nand4  g24(.a(x3), .b(new_n32_), .c(x1), .d(new_n26_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n22_), .O(z10));
  nand3  g26(.a(x4), .b(new_n29_), .c(new_n32_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x1), .c(x0), .O(z11));
