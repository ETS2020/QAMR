...
module FAU ( 
  ...
  aoi21  g13(.a(new_n36_), .b(new_n27_), .c(new_n26_), .O(z05));
  aoi21  g14(.a(new_n36_), .b(new_n26_), .c(new_n27_), .O(z06));
  ...
  nand4  g21(.a(x3), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z10));
  nand4  g23(.a(new_n27_), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n23_), .O(z11));
  nand3  g25(.a(x4), .b(new_n35_), .c(new_n42_), .O(new_n49_));
  aoi21  g26(.a(new_n49_), .b(new_n27_), .c(new_n26_), .O(z13));
  aoi21  g27(.a(new_n49_), .b(new_n26_), .c(new_n27_), .O(z14));
  nand4  g28(.a(new_n27_), .b(new_n26_), .c(new_n35_), .d(new_n42_), .O(new_n52_));
