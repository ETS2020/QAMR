...
module FAU ( 
  ...
  oai21  g20(.a(new_n41_), .b(new_n36_), .c(new_n35_), .O(z06));
  nand3  g21(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n36_), .c(new_n35_), .O(z07));
  inv1   g23(.a(new_n35_), .O(z08));
  aoi21  g24(.a(new_n37_), .b(new_n25_), .c(x0), .O(z12));
  aoi21  g25(.a(new_n27_), .b(new_n25_), .c(x0), .O(z13));
  aoi21  g26(.a(new_n41_), .b(new_n25_), .c(x0), .O(z14));
  aoi21  g27(.a(new_n43_), .b(new_n25_), .c(x0), .O(z15));
  zero   g28(.O(z09));
  zero   g29(.O(z10));
  inv1   g30(.a(new_n35_), .O(z11));
endmodule
