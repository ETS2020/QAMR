...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n34_), .c(new_n31_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x0), .c(x1), .O(z07));
  aoi21  g22(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  aoi21  g23(.a(new_n38_), .b(x1), .c(x0), .O(z09));
  aoi21  g24(.a(new_n32_), .b(x1), .c(x0), .O(z10));
  nand4  g25(.a(new_n34_), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n28_), .O(z11));
