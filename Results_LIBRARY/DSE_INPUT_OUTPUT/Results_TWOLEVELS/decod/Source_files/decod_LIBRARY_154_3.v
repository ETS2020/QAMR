...
module FAU ( 
  ...
  wire new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    ...
    new_n47_, new_n48_, new_n50_, new_n53_;
  ...
  nand3  g19(.a(x4), .b(x3), .c(new_n33_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(new_n38_), .c(new_n27_), .O(z10));
  ...
  oai21  g25(.a(new_n48_), .b(new_n47_), .c(new_n23_), .O(z12));
  nand3  g26(.a(x4), .b(new_n30_), .c(x2), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n47_), .c(new_n23_), .O(z13));
  oai21  g28(.a(new_n47_), .b(new_n43_), .c(new_n23_), .O(z14));
  nand3  g29(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n53_));
  oai21  g30(.a(new_n53_), .b(new_n47_), .c(new_n23_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z03));
  inv1   g33(.a(new_n23_), .O(z02));
endmodule
