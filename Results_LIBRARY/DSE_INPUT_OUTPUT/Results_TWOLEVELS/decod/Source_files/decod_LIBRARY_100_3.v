...
module FAU ( 
  ...
  wire new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n41_, new_n42_, new_n44_;
  ...
  nand4  g18(.a(new_n30_), .b(new_n33_), .c(x1), .d(new_n26_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n41_), .O(z11));
  nand2  g20(.a(new_n27_), .b(new_n26_), .O(new_n44_));
  oai21  g21(.a(new_n44_), .b(new_n28_), .c(new_n23_), .O(z12));
  oai21  g22(.a(new_n44_), .b(new_n31_), .c(new_n23_), .O(z13));
  oai21  g23(.a(new_n44_), .b(new_n34_), .c(new_n23_), .O(z14));
  oai21  g24(.a(new_n44_), .b(new_n36_), .c(new_n23_), .O(z15));
  zero   g25(.O(z00));
  zero   g26(.O(z03));
  inv1   g27(.a(new_n23_), .O(z02));
endmodule
