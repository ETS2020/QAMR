...
module FAU ( 
  ...
  nand4  g21(.a(x3), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n22_), .O(z10));
  inv1   g23(.a(new_n31_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n42_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n22_), .O(z12));
  aoi21  g26(.a(new_n43_), .b(new_n32_), .c(x3), .O(z13));
  nand4  g27(.a(x3), .b(new_n26_), .c(new_n32_), .d(new_n42_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n22_), .O(z14));
  nand3  g29(.a(x4), .b(new_n26_), .c(new_n42_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n32_), .c(x3), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z03));
  zero   g33(.O(z09));
endmodule
