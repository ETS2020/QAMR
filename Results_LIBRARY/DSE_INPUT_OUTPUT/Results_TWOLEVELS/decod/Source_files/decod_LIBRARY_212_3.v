...
module FAU ( 
  ...
  nand4  g12(.a(new_n29_), .b(new_n32_), .c(new_n26_), .d(x0), .O(new_n35_));
  nor2   g13(.a(new_n35_), .b(new_n25_), .O(z07));
  inv1   g14(.a(x0), .O(new_n37_));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n37_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n25_), .O(z08));
  nand4  g17(.a(new_n29_), .b(x2), .c(x1), .d(new_n37_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n25_), .O(z09));
  nand4  g19(.a(x3), .b(new_n32_), .c(x1), .d(new_n37_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n25_), .O(z10));
  nand4  g21(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n37_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n25_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n26_), .d(new_n37_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n37_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n32_), .c(new_n26_), .d(new_n37_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n25_), .O(z14));
  nand2  g29(.a(new_n26_), .b(new_n37_), .O(new_n52_));
  nand3  g30(.a(x4), .b(new_n29_), .c(new_n32_), .O(new_n53_));
  oai21  g31(.a(new_n53_), .b(new_n52_), .c(new_n23_), .O(z15));
  zero   g32(.O(z00));
  inv1   g33(.a(new_n23_), .O(z02));
  inv1   g34(.a(new_n23_), .O(z03));
endmodule
