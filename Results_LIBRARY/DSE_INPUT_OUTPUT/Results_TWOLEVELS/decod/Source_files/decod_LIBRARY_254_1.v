...
module FAU ( 
  ...
  nand4  g16(.a(x3), .b(new_n29_), .c(new_n22_), .d(x0), .O(new_n38_));
  ...
  oai21  g21(.a(new_n40_), .b(new_n32_), .c(new_n42_), .O(z07));
  inv1   g22(.a(new_n42_), .O(z11));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  aoi21  g24(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g25(.a(x3), .b(new_n29_), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n28_), .O(z14));
  nand4  g27(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(new_n41_), .O(new_n52_));
