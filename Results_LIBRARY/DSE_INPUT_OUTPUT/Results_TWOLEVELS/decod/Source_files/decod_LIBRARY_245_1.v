...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n37_, new_n38_, new_n41_, new_n45_,
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n31_), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n31_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n31_), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n51_));
