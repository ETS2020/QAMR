...
module FAU ( 
  ...
  nand4  g06(.a(new_n22_), .b(new_n27_), .c(x1), .d(x0), .O(new_n28_));
  ...
  nand4  g11(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n35_));
  ...
  nand4  g20(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(new_n37_), .O(new_n47_));
