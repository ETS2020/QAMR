...
module FAU ( 
  ...
  nand4  g18(.a(x3), .b(new_n32_), .c(new_n23_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n31_), .O(z06));
  aoi21  g20(.a(new_n35_), .b(x0), .c(x1), .O(z07));
  nand4  g21(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n31_), .O(z08));
  aoi21  g23(.a(new_n29_), .b(x1), .c(x0), .O(z09));
  nand3  g24(.a(x4), .b(x3), .c(new_n32_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x1), .c(x0), .O(z10));
  nand4  g26(.a(new_n28_), .b(new_n32_), .c(x1), .d(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n31_), .O(z11));
  inv1   g28(.a(new_n24_), .O(z13));
  zero   g29(.O(z12));
  zero   g30(.O(z14));
