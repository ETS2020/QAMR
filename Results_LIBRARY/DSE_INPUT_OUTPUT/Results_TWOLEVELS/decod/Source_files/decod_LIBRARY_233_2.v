...
module FAU ( 
  ...
  oai21  g17(.a(new_n40_), .b(new_n26_), .c(new_n42_), .O(z09));
  nand4  g18(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n37_), .O(z10));
  nand4  g20(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n37_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n41_), .d(new_n22_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n37_), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n41_), .d(new_n22_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n37_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n41_), .d(new_n22_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n37_), .O(z14));
  aoi21  g28(.a(new_n31_), .b(new_n22_), .c(x1), .O(z15));
  zero   g29(.O(z04));
  zero   g30(.O(z05));
  zero   g31(.O(z06));
  zero   g32(.O(z07));
