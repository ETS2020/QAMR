...
module FAU ( 
  ...
  nand2  g14(.a(x1), .b(new_n27_), .O(new_n38_));
  nand3  g15(.a(x4), .b(x3), .c(x2), .O(new_n39_));
  oai21  g16(.a(new_n39_), .b(new_n38_), .c(new_n34_), .O(z08));
  nand4  g17(.a(new_n22_), .b(x2), .c(x1), .d(new_n27_), .O(new_n41_));
  ...
  aoi21  g23(.a(new_n39_), .b(new_n27_), .c(x1), .O(z12));
  nand4  g24(.a(new_n22_), .b(x2), .c(new_n33_), .d(new_n27_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z14));
  nand4  g28(.a(new_n22_), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n23_), .O(z15));
  zero   g30(.O(z06));
  zero   g31(.O(z07));
  inv1   g32(.a(new_n34_), .O(z05));
endmodule
