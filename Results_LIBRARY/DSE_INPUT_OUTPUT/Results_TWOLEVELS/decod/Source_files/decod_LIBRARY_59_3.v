...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n44_;
  ...
  aoi21  g12(.a(new_n34_), .b(new_n23_), .c(new_n24_), .O(z07));
  inv1   g13(.a(x0), .O(new_n36_));
  nand3  g14(.a(x2), .b(x1), .c(new_n36_), .O(new_n37_));
  aoi21  g15(.a(new_n37_), .b(new_n23_), .c(new_n24_), .O(z09));
  nand3  g16(.a(new_n28_), .b(x1), .c(new_n36_), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(new_n23_), .c(new_n24_), .O(z11));
  nand3  g18(.a(x2), .b(new_n31_), .c(new_n36_), .O(new_n41_));
  aoi21  g19(.a(new_n41_), .b(new_n23_), .c(new_n24_), .O(z13));
  nand3  g20(.a(new_n28_), .b(new_n31_), .c(new_n36_), .O(new_n44_));
  aoi21  g21(.a(new_n44_), .b(new_n23_), .c(new_n24_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z14));
  nor2   g24(.a(new_n24_), .b(new_n23_), .O(z04));
  nor2   g25(.a(new_n24_), .b(new_n23_), .O(z06));
