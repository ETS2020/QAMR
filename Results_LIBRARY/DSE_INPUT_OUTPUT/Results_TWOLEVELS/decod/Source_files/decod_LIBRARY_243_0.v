...
module FAU ( 
  ...
  nand4  g16(.a(x3), .b(new_n31_), .c(new_n22_), .d(x0), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n30_), .O(z06));
  ...
  nand3  g25(.a(x4), .b(new_n31_), .c(new_n42_), .O(new_n49_));
  aoi21  g26(.a(new_n49_), .b(x1), .c(x3), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n30_), .O(z12));
  aoi21  g29(.a(new_n49_), .b(x3), .c(x1), .O(z14));
  zero   g30(.O(z05));
  zero   g31(.O(z07));
  zero   g32(.O(z13));
  zero   g33(.O(z15));
