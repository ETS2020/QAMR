...
module FAU ( 
  ...
  nand4  g23(.a(new_n31_), .b(x2), .c(new_n27_), .d(new_n30_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n26_), .O(z13));
  nand2  g25(.a(new_n27_), .b(new_n30_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n35_), .c(new_n22_), .O(z14));
  nand4  g27(.a(new_n31_), .b(new_n34_), .c(new_n27_), .d(new_n30_), .O(new_n51_));
