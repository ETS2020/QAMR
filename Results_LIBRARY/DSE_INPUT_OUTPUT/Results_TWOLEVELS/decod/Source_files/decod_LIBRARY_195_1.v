...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n46_, new_n48_,
    new_n50_;
  ...
  aoi21  g23(.a(new_n46_), .b(new_n22_), .c(x0), .O(z13));
  nand3  g24(.a(x4), .b(x3), .c(new_n28_), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(new_n22_), .c(x0), .O(z14));
  nand3  g26(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n22_), .c(x0), .O(z15));
  zero   g28(.O(z09));
  zero   g29(.O(z10));
  nor2   g30(.a(new_n22_), .b(x0), .O(z11));
endmodule
