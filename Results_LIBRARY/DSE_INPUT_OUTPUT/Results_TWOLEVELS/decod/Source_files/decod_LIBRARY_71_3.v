...
module FAU ( 
  ...
  aoi21  g16(.a(new_n38_), .b(new_n35_), .c(new_n26_), .O(z08));
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n26_), .d(new_n35_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n25_), .O(z12));
  nand4  g24(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n35_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n32_), .c(new_n26_), .d(new_n35_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n25_), .O(z14));
  nand2  g28(.a(new_n26_), .b(new_n35_), .O(new_n51_));
  oai21  g29(.a(new_n51_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g30(.O(z03));
