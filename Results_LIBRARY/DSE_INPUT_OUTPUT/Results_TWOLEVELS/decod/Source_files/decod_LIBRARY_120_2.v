...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n44_, new_n45_, new_n47_, new_n48_, new_n50_, new_n53_, new_n55_,
    new_n57_, new_n59_;
  ...
  nand4  g20(.a(new_n22_), .b(new_n28_), .c(new_n35_), .d(x0), .O(new_n42_));
  ...
  nand3  g26(.a(x4), .b(new_n22_), .c(x2), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n47_), .c(new_n32_), .O(z09));
  nand4  g28(.a(x3), .b(new_n28_), .c(x1), .d(new_n44_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n25_), .O(z10));
  oai21  g30(.a(new_n47_), .b(new_n33_), .c(new_n32_), .O(z11));
  ...
  oai21  g34(.a(new_n55_), .b(new_n48_), .c(new_n32_), .O(z13));
  nand4  g35(.a(x3), .b(new_n28_), .c(new_n35_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n25_), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n28_), .c(new_n35_), .d(new_n44_), .O(new_n59_));
