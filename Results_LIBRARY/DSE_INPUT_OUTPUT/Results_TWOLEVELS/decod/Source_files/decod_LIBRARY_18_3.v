...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n36_, new_n37_, new_n40_, new_n42_, new_n45_;
  ...
  nand4  g11(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n36_));
  nand4  g14(.a(new_n22_), .b(x2), .c(x1), .d(new_n36_), .O(new_n37_));
  ...
  nand4  g18(.a(new_n22_), .b(x2), .c(new_n30_), .d(new_n36_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z13));
  nand4  g20(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n36_), .O(new_n45_));
