...
module FAU ( 
  ...
  nand3  g06(.a(x3), .b(new_n27_), .c(x1), .O(new_n28_));
  aoi21  g07(.a(new_n28_), .b(x0), .c(new_n23_), .O(z02));
  ...
  nand3  g15(.a(x3), .b(new_n27_), .c(new_n32_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x0), .c(new_n23_), .O(z06));
  nand3  g17(.a(new_n22_), .b(new_n27_), .c(new_n32_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x0), .c(new_n23_), .O(z07));
  nor2   g19(.a(new_n23_), .b(x0), .O(z10));
  zero   g20(.O(z08));
  zero   g21(.O(z09));
  zero   g22(.O(z11));
  zero   g23(.O(z12));
