...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    ...
    new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n54_, new_n56_,
    new_n58_;
  ...
  aoi21  g17(.a(new_n38_), .b(x4), .c(new_n27_), .O(z06));
  nand3  g18(.a(new_n22_), .b(new_n28_), .c(new_n33_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(x4), .c(new_n27_), .O(z07));
  nand4  g20(.a(x3), .b(x2), .c(x1), .d(new_n27_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n23_), .O(z08));
  nand4  g22(.a(new_n22_), .b(x2), .c(x1), .d(new_n27_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(z09));
  nand2  g24(.a(x1), .b(new_n27_), .O(new_n46_));
  nand2  g25(.a(new_n23_), .b(x0), .O(new_n47_));
  nand3  g26(.a(x4), .b(x3), .c(new_n28_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n46_), .c(new_n47_), .O(z10));
  nand4  g28(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n27_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n33_), .d(new_n27_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n33_), .d(new_n27_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z13));
  nand4  g34(.a(x3), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n58_));
