...
module FAU ( 
  ...
  nand4  g16(.a(new_n25_), .b(new_n30_), .c(new_n22_), .d(x0), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n35_), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand3  g19(.a(x4), .b(x3), .c(new_n42_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(x2), .c(new_n22_), .O(z08));
  nand3  g21(.a(x4), .b(new_n25_), .c(new_n42_), .O(new_n45_));
  aoi21  g22(.a(new_n45_), .b(x2), .c(new_n22_), .O(z09));
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n35_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n35_), .O(z13));
  aoi21  g27(.a(new_n43_), .b(new_n22_), .c(x2), .O(z14));
  aoi21  g28(.a(new_n45_), .b(new_n22_), .c(x2), .O(z15));
  zero   g29(.O(z02));
  zero   g30(.O(z03));
  zero   g31(.O(z10));
  zero   g32(.O(z11));
