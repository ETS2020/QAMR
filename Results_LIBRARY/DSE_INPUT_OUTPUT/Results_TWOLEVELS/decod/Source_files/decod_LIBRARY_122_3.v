...
module FAU ( 
  ...
  nand4  g16(.a(new_n29_), .b(x2), .c(new_n22_), .d(new_n39_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n23_), .O(z13));
  nand4  g18(.a(x3), .b(new_n32_), .c(new_n22_), .d(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n23_), .O(z14));
  nand4  g20(.a(new_n29_), .b(new_n32_), .c(new_n22_), .d(new_n39_), .O(new_n46_));
