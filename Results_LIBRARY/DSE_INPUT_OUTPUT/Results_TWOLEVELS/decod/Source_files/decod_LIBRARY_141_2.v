...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
  ...
  nand4  g21(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n27_), .O(new_n44_));
  ...
  nand3  g25(.a(x4), .b(new_n22_), .c(x2), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n27_), .c(x1), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n23_), .O(z14));
  nand3  g29(.a(x4), .b(new_n22_), .c(new_n28_), .O(new_n52_));
  aoi21  g30(.a(new_n52_), .b(new_n27_), .c(x1), .O(z15));
  zero   g31(.O(z05));
  inv1   g32(.a(new_n34_), .O(z06));
