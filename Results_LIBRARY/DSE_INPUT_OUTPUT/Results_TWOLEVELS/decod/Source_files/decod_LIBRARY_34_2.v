...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    ...
    new_n48_, new_n49_, new_n51_, new_n53_, new_n55_;
  ...
  nand4  g21(.a(x3), .b(new_n26_), .c(x1), .d(new_n41_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n22_), .O(z10));
  nand2  g23(.a(new_n32_), .b(new_n41_), .O(new_n48_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n30_), .O(z12));
  nand4  g26(.a(new_n29_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n22_), .O(z13));
  nand3  g28(.a(x4), .b(x3), .c(new_n26_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n48_), .c(new_n30_), .O(z14));
  nand3  g30(.a(x4), .b(new_n26_), .c(new_n41_), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n32_), .c(x3), .O(z15));
  zero   g32(.O(z01));
  zero   g33(.O(z09));
  zero   g34(.O(z11));
endmodule
