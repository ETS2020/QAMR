...
module FAU ( 
  ...
  nand4  g19(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n25_), .O(z07));
  inv1   g21(.a(new_n35_), .O(z09));
  nand4  g22(.a(x3), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n47_));
  ...
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n25_), .O(z14));
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n53_));
