...
module FAU ( 
  ...
  nor2   g15(.a(new_n36_), .b(new_n31_), .O(z04));
  ...
  nand4  g22(.a(new_n28_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n31_), .O(z09));
  nand4  g24(.a(x3), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n31_), .O(z10));
  nand3  g26(.a(x4), .b(new_n28_), .c(new_n42_), .O(new_n49_));
  aoi21  g27(.a(new_n49_), .b(x1), .c(x2), .O(z11));
  nand4  g28(.a(x3), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n31_), .O(z12));
  aoi21  g30(.a(new_n49_), .b(x2), .c(x1), .O(z13));
  zero   g31(.O(z07));
  zero   g32(.O(z15));
