...
module FAU ( 
  ...
  aoi21  g20(.a(new_n43_), .b(new_n36_), .c(new_n27_), .O(z10));
  aoi21  g21(.a(new_n37_), .b(new_n36_), .c(new_n27_), .O(z11));
  nand2  g22(.a(new_n27_), .b(new_n36_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n39_), .c(new_n24_), .O(z12));
  oai21  g24(.a(new_n46_), .b(new_n41_), .c(new_n24_), .O(z13));
  oai21  g25(.a(new_n46_), .b(new_n43_), .c(new_n24_), .O(z14));
  nand4  g26(.a(new_n30_), .b(new_n33_), .c(new_n27_), .d(new_n36_), .O(new_n50_));
