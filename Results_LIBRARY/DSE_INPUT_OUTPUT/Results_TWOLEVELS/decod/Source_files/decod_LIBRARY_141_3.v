...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n24_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_,
  ...
  nand3  g25(.a(x4), .b(new_n32_), .c(x2), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n49_), .c(new_n24_), .O(z13));
  nand4  g27(.a(x3), .b(new_n35_), .c(new_n28_), .d(new_n27_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n31_), .O(z14));
  oai21  g29(.a(new_n49_), .b(new_n38_), .c(new_n24_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
  zero   g32(.O(z03));
endmodule
