...
module FAU ( 
  ...
  nand4  g27(.a(x3), .b(new_n31_), .c(x1), .d(new_n43_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z10));
  nand4  g29(.a(new_n22_), .b(new_n31_), .c(x1), .d(new_n43_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n23_), .O(z11));
  nand4  g31(.a(x3), .b(x2), .c(new_n33_), .d(new_n43_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n23_), .O(z12));
  nand2  g33(.a(new_n33_), .b(new_n43_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n47_), .c(new_n32_), .O(z13));
  nand4  g35(.a(x3), .b(new_n31_), .c(new_n33_), .d(new_n43_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n23_), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n31_), .c(new_n33_), .d(new_n43_), .O(new_n59_));
