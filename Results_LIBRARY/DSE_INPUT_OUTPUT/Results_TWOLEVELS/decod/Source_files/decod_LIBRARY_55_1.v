...
module FAU ( 
  ...
  aoi21  g24(.a(new_n43_), .b(new_n28_), .c(x2), .O(z11));
  nand4  g25(.a(x3), .b(x2), .c(new_n34_), .d(new_n42_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n22_), .O(z12));
  nand4  g27(.a(new_n28_), .b(x2), .c(new_n34_), .d(new_n42_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n22_), .O(z13));
  nand4  g29(.a(new_n28_), .b(new_n26_), .c(new_n34_), .d(new_n42_), .O(new_n53_));
