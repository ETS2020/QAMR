...
module FAU ( 
  ...
  nand4  g14(.a(new_n28_), .b(x2), .c(new_n34_), .d(x0), .O(new_n37_));
  ...
  nand4  g24(.a(new_n28_), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n47_));
  ...
  nand4  g28(.a(new_n28_), .b(x2), .c(new_n34_), .d(new_n42_), .O(new_n51_));
