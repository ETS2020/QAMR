...
module FAU ( 
  ...
  nand3  g18(.a(new_n27_), .b(new_n33_), .c(x0), .O(new_n40_));
  ...
  nand2  g29(.a(new_n22_), .b(new_n30_), .O(new_n51_));
  nand2  g30(.a(new_n33_), .b(new_n42_), .O(new_n52_));
  nand3  g31(.a(x4), .b(x3), .c(x2), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(z12));
  nand3  g33(.a(x2), .b(new_n33_), .c(new_n42_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x3), .O(z13));
  nand3  g35(.a(x4), .b(x3), .c(new_n27_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n52_), .c(new_n51_), .O(z14));
  nand4  g37(.a(new_n30_), .b(new_n27_), .c(new_n33_), .d(new_n42_), .O(new_n59_));
