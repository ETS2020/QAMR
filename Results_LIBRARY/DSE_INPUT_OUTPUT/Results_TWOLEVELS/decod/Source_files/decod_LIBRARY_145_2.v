...
module FAU ( 
  ...
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n22_), .O(z08));
  nand4  g26(.a(new_n22_), .b(x2), .c(x1), .d(new_n45_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n25_), .O(z09));
  nand3  g28(.a(new_n30_), .b(x1), .c(new_n45_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(new_n22_), .O(z10));
  nand4  g30(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n45_), .O(new_n52_));
  ...
  nand4  g36(.a(x3), .b(new_n30_), .c(new_n35_), .d(new_n45_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n25_), .O(z14));
  nand2  g38(.a(new_n35_), .b(new_n45_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n43_), .c(new_n26_), .O(z15));
endmodule
