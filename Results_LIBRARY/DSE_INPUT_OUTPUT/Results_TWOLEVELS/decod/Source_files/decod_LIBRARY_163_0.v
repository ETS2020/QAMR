...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n44_, new_n45_, new_n46_, new_n48_, new_n51_, new_n53_, new_n55_,
    new_n57_, new_n59_;
  ...
  oai21  g28(.a(new_n45_), .b(new_n32_), .c(new_n27_), .O(z10));
  nand3  g29(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n45_), .c(new_n27_), .O(z11));
