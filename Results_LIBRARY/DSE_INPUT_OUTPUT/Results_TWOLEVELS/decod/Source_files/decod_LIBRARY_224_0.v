...
module FAU ( 
  ...
  nand3  g15(.a(x3), .b(new_n32_), .c(x0), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x4), .c(x2), .O(z06));
  ...
  nand3  g26(.a(new_n22_), .b(x1), .c(new_n41_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(x2), .O(z11));
  nand2  g28(.a(new_n23_), .b(new_n27_), .O(new_n50_));
  nand2  g29(.a(new_n32_), .b(new_n41_), .O(new_n51_));
  nand3  g30(.a(x4), .b(x3), .c(x2), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(z12));
  nand3  g32(.a(x4), .b(new_n22_), .c(x2), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n51_), .c(new_n50_), .O(z13));
  nand3  g34(.a(x3), .b(new_n32_), .c(new_n41_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x4), .c(x2), .O(z14));
  nand3  g36(.a(new_n22_), .b(new_n32_), .c(new_n41_), .O(new_n58_));
