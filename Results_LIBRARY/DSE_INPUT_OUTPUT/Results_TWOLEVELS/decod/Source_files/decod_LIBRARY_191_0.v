...
module FAU ( 
  ...
  nand2  g11(.a(new_n27_), .b(new_n32_), .O(new_n33_));
  ...
  nand3  g20(.a(x4), .b(new_n22_), .c(new_n34_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x0), .c(x2), .O(z07));
  nand3  g22(.a(x4), .b(x3), .c(x1), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x2), .c(x0), .O(z08));
  nand4  g24(.a(new_n22_), .b(x2), .c(x1), .d(new_n32_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z09));
  inv1   g26(.a(new_n33_), .O(z10));
  nand4  g27(.a(x3), .b(x2), .c(new_n34_), .d(new_n32_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z12));
  aoi21  g29(.a(new_n42_), .b(x2), .c(x0), .O(z13));
  zero   g30(.O(z14));
  zero   g31(.O(z15));
  inv1   g32(.a(new_n33_), .O(z11));
endmodule
