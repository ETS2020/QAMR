...
module FAU ( 
  ...
  oai21  g16(.a(new_n40_), .b(new_n23_), .c(new_n37_), .O(z08));
  nand3  g17(.a(x4), .b(new_n31_), .c(x2), .O(new_n42_));
  oai21  g18(.a(new_n42_), .b(new_n40_), .c(new_n37_), .O(z09));
  nand4  g19(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n25_), .O(z10));
  nand3  g21(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n46_));
  oai21  g22(.a(new_n46_), .b(new_n40_), .c(new_n37_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n25_), .O(z14));
  nand4  g29(.a(new_n31_), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n54_));
