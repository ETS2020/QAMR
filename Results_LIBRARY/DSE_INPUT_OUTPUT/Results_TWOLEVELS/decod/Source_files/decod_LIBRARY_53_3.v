...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n39_, new_n41_, new_n43_, new_n45_,
  ...
  nand4  g16(.a(new_n30_), .b(x2), .c(x1), .d(new_n25_), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n29_), .O(z09));
  nand3  g18(.a(x4), .b(x3), .c(new_n33_), .O(new_n41_));
  aoi21  g19(.a(new_n41_), .b(new_n25_), .c(new_n26_), .O(z10));
  nand3  g20(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n43_));
  aoi21  g21(.a(new_n43_), .b(new_n25_), .c(new_n26_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n29_), .O(z12));
  nand2  g24(.a(new_n26_), .b(new_n25_), .O(new_n47_));
  nand3  g25(.a(x4), .b(new_n30_), .c(x2), .O(new_n48_));
  oai21  g26(.a(new_n48_), .b(new_n47_), .c(new_n22_), .O(z13));
  oai21  g27(.a(new_n47_), .b(new_n41_), .c(new_n22_), .O(z14));
  nand4  g28(.a(new_n30_), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n51_));
