...
module FAU ( 
  ...
  nand2  g15(.a(new_n22_), .b(x1), .O(new_n37_));
  ...
  nand3  g29(.a(new_n26_), .b(new_n29_), .c(new_n44_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(new_n25_), .O(z11));
  nand2  g31(.a(new_n25_), .b(new_n44_), .O(new_n53_));
  nand3  g32(.a(x4), .b(x3), .c(x2), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(new_n37_), .O(z12));
  oai21  g34(.a(new_n53_), .b(new_n38_), .c(new_n37_), .O(z13));
  oai21  g35(.a(new_n53_), .b(new_n40_), .c(new_n37_), .O(z14));
  nand3  g36(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n53_), .c(new_n37_), .O(z15));
endmodule
