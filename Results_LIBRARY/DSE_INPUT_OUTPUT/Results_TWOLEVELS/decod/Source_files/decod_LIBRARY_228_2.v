...
module FAU ( 
  ...
  nand4  g25(.a(new_n31_), .b(x2), .c(x1), .d(new_n22_), .O(new_n47_));
  ...
  oai21  g35(.a(new_n53_), .b(new_n49_), .c(new_n43_), .O(z14));
  nand4  g36(.a(new_n31_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n58_));
