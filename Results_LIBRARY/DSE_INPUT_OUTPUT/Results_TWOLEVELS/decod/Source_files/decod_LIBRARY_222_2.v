...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(new_n28_), .c(new_n22_), .d(x0), .O(new_n36_));
  ...
  nand3  g21(.a(x4), .b(new_n28_), .c(new_n40_), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(x3), .c(new_n22_), .O(z10));
  nand2  g23(.a(new_n22_), .b(new_n40_), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n44_), .b(new_n22_), .c(x3), .O(z15));
  zero   g31(.O(z09));
  zero   g32(.O(z11));
