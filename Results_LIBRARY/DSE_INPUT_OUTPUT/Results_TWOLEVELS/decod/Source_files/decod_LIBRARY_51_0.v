...
module FAU ( 
  ...
  nand3  g22(.a(x4), .b(new_n33_), .c(x2), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n43_), .c(new_n24_), .O(z09));
  nand3  g24(.a(x4), .b(x3), .c(new_n42_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(x1), .c(x2), .O(z10));
  nand4  g26(.a(new_n33_), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n49_));
  ...
  nand3  g30(.a(x4), .b(new_n33_), .c(new_n42_), .O(new_n53_));
