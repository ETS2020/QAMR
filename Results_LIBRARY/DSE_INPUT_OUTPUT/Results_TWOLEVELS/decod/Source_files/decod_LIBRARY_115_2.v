...
module FAU ( 
  ...
  oai21  g33(.a(new_n54_), .b(new_n52_), .c(new_n33_), .O(z13));
  nand4  g34(.a(x3), .b(new_n27_), .c(new_n30_), .d(new_n43_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n43_), .O(new_n58_));
