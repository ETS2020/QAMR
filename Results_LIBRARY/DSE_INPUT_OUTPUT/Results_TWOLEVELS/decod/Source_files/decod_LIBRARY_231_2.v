...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n31_, new_n33_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n41_, new_n42_, new_n45_,
  ...
  nand4  g25(.a(new_n36_), .b(x2), .c(new_n26_), .d(new_n41_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n22_), .O(z13));
  nand4  g27(.a(x3), .b(new_n27_), .c(new_n26_), .d(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z14));
  nand4  g29(.a(new_n36_), .b(new_n27_), .c(new_n26_), .d(new_n41_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n22_), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z03));
  inv1   g33(.a(new_n37_), .O(z11));
endmodule
