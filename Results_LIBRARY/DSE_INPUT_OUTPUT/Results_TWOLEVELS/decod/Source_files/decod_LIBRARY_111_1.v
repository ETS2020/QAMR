...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(x1), .c(new_n36_), .O(new_n39_));
  aoi21  g16(.a(new_n39_), .b(x2), .c(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n29_), .c(new_n36_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(x2), .c(new_n22_), .O(z12));
  nand4  g19(.a(new_n32_), .b(x2), .c(new_n29_), .d(new_n36_), .O(new_n44_));
