...
module FAU ( 
  ...
  nand2  g09(.a(new_n25_), .b(x2), .O(new_n31_));
  inv1   g10(.a(x3), .O(new_n32_));
  nand3  g11(.a(x4), .b(new_n32_), .c(new_n22_), .O(new_n33_));
  oai21  g12(.a(new_n33_), .b(new_n30_), .c(new_n31_), .O(z03));
  ...
  oai21  g21(.a(new_n42_), .b(new_n33_), .c(new_n31_), .O(z07));
  ...
  oai21  g30(.a(new_n51_), .b(new_n33_), .c(new_n31_), .O(z11));
  ...
  nand3  g36(.a(x4), .b(x3), .c(new_n22_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n31_), .O(z14));
  oai21  g38(.a(new_n57_), .b(new_n33_), .c(new_n31_), .O(z15));
endmodule
