...
module FAU ( 
  ...
  nand4  g21(.a(new_n28_), .b(new_n32_), .c(new_n23_), .d(x0), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n31_), .O(z07));
  nand4  g23(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n31_), .O(z08));
  nand4  g25(.a(new_n28_), .b(x2), .c(x1), .d(new_n22_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n31_), .O(z09));
  nand4  g27(.a(x3), .b(new_n32_), .c(x1), .d(new_n22_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n31_), .O(z10));
  nand3  g29(.a(x4), .b(new_n28_), .c(new_n32_), .O(new_n51_));
