...
module FAU ( 
  ...
  nand3  g30(.a(x4), .b(new_n22_), .c(new_n30_), .O(new_n52_));
  ...
  nand4  g34(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n44_), .O(new_n56_));
  ...
  nand4  g38(.a(new_n22_), .b(new_n30_), .c(new_n35_), .d(new_n44_), .O(new_n60_));
