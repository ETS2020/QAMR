...
module FAU ( 
  ...
  oai21  g19(.a(new_n39_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand3  g20(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n44_));
  oai21  g21(.a(new_n44_), .b(new_n39_), .c(new_n35_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n25_), .O(z12));
  nand3  g24(.a(x4), .b(new_n31_), .c(x2), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(new_n22_), .c(x1), .O(z13));
