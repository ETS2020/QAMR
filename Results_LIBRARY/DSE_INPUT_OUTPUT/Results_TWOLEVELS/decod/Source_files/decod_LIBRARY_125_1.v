...
module FAU ( 
  ...
  nand3  g14(.a(new_n22_), .b(x2), .c(new_n33_), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(x1), .c(new_n23_), .O(z09));
  nand3  g16(.a(x3), .b(new_n27_), .c(new_n33_), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(x1), .c(new_n23_), .O(z10));
  nand3  g18(.a(new_n22_), .b(new_n27_), .c(new_n33_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(x1), .c(new_n23_), .O(z11));
  zero   g20(.O(z12));
  zero   g21(.O(z13));
  zero   g22(.O(z15));
