...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n37_, new_n38_, new_n40_, new_n43_, new_n45_;
  ...
  nand3  g18(.a(x3), .b(new_n30_), .c(new_n37_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n22_), .c(new_n23_), .O(z14));
  nand3  g20(.a(new_n27_), .b(new_n30_), .c(new_n37_), .O(new_n45_));
