...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    ...
    new_n43_, new_n49_, new_n52_, new_n54_;
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n25_), .d(new_n39_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n22_), .O(z12));
  aoi21  g26(.a(new_n27_), .b(new_n25_), .c(x0), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n25_), .d(new_n39_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n22_), .O(z14));
  nand4  g29(.a(new_n26_), .b(new_n29_), .c(new_n25_), .d(new_n39_), .O(new_n54_));
