...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n25_), .O(z13));
  aoi21  g27(.a(new_n40_), .b(new_n22_), .c(x0), .O(z14));
