...
module FAU ( 
  ...
  aoi21  g15(.a(new_n40_), .b(new_n22_), .c(new_n23_), .O(z10));
  nand4  g16(.a(new_n28_), .b(new_n22_), .c(x1), .d(new_n39_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n23_), .O(z11));
  nand4  g18(.a(x3), .b(new_n22_), .c(new_n32_), .d(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n23_), .O(z14));
  nand3  g20(.a(new_n28_), .b(new_n32_), .c(new_n39_), .O(new_n46_));
