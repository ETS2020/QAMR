...
module FAU ( 
  ...
  nand4  g28(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n28_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n35_), .d(new_n28_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n28_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z13));
  nand4  g34(.a(x3), .b(new_n30_), .c(new_n35_), .d(new_n28_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n30_), .c(new_n35_), .d(new_n28_), .O(new_n58_));
