...
module FAU ( 
  ...
  nand4  g15(.a(new_n25_), .b(x2), .c(new_n34_), .d(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n31_), .O(z05));
  nand3  g17(.a(x3), .b(new_n28_), .c(new_n34_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x4), .c(new_n22_), .O(z06));
  nand3  g19(.a(new_n25_), .b(new_n28_), .c(new_n34_), .O(new_n41_));
  ...
  nand2  g24(.a(new_n31_), .b(x0), .O(new_n46_));
  nand3  g25(.a(x4), .b(new_n25_), .c(x2), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n45_), .c(new_n46_), .O(z09));
  nand3  g27(.a(x4), .b(x3), .c(new_n28_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n45_), .c(new_n46_), .O(z10));
  nand3  g29(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n51_));
  ...
  nand4  g35(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n31_), .O(z14));
  nand4  g37(.a(new_n25_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n59_));
