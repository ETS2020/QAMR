...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    ...
    new_n46_, new_n49_, new_n51_, new_n54_;
  ...
  nand4  g13(.a(new_n29_), .b(x2), .c(new_n22_), .d(x0), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n35_), .O(z05));
  nand3  g15(.a(x4), .b(x3), .c(new_n26_), .O(new_n38_));
  oai21  g16(.a(new_n38_), .b(new_n32_), .c(new_n30_), .O(z06));
  nand4  g17(.a(new_n29_), .b(new_n26_), .c(new_n22_), .d(x0), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n35_), .O(z07));
  inv1   g19(.a(x0), .O(new_n42_));
  nand4  g20(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n35_), .O(z08));
  nand4  g22(.a(x3), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n35_), .O(z10));
  nand2  g24(.a(new_n22_), .b(new_n42_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n33_), .c(new_n30_), .O(z12));
  nand4  g26(.a(new_n29_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n35_), .O(z13));
  oai21  g28(.a(new_n49_), .b(new_n38_), .c(new_n30_), .O(z14));
  nand4  g29(.a(new_n29_), .b(new_n26_), .c(new_n22_), .d(new_n42_), .O(new_n54_));
  nor2   g30(.a(new_n54_), .b(new_n35_), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z09));
  zero   g33(.O(z11));
endmodule
