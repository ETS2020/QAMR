...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n35_, new_n36_, new_n39_, new_n41_, new_n44_, new_n47_;
  ...
  oai21  g18(.a(new_n41_), .b(new_n39_), .c(new_n36_), .O(z09));
  oai21  g19(.a(new_n39_), .b(new_n29_), .c(new_n36_), .O(z10));
  nand4  g20(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n25_), .O(z11));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g23(.a(new_n31_), .b(x2), .c(new_n35_), .d(new_n22_), .O(new_n47_));
