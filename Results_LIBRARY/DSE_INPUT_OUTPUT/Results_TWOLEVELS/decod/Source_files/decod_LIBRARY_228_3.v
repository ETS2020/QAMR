...
module FAU ( 
  ...
  nand3  g03(.a(x3), .b(x2), .c(x1), .O(new_n27_));
  aoi21  g04(.a(new_n27_), .b(new_n22_), .c(new_n23_), .O(z08));
  inv1   g05(.a(x3), .O(new_n29_));
  nand4  g06(.a(new_n29_), .b(x2), .c(x1), .d(new_n22_), .O(new_n30_));
  nor2   g07(.a(new_n30_), .b(new_n23_), .O(z09));
  inv1   g08(.a(x2), .O(new_n32_));
  nand3  g09(.a(x3), .b(new_n32_), .c(x1), .O(new_n33_));
  aoi21  g10(.a(new_n33_), .b(new_n22_), .c(new_n23_), .O(z10));
  nand4  g11(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n22_), .O(new_n35_));
  nor2   g12(.a(new_n35_), .b(new_n23_), .O(z11));
  inv1   g13(.a(x1), .O(new_n37_));
  nand3  g14(.a(x3), .b(x2), .c(new_n37_), .O(new_n38_));
  aoi21  g15(.a(new_n38_), .b(new_n22_), .c(new_n23_), .O(z12));
  nand4  g16(.a(new_n29_), .b(x2), .c(new_n37_), .d(new_n22_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n23_), .O(z13));
  nand3  g18(.a(x3), .b(new_n32_), .c(new_n37_), .O(new_n42_));
  ...
  zero   g22(.O(z01));
  zero   g23(.O(z02));
  nor2   g24(.a(new_n23_), .b(new_n22_), .O(z03));
