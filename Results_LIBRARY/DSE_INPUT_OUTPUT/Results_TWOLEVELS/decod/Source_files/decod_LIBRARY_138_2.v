...
module FAU ( 
  ...
  nand2  g14(.a(new_n34_), .b(x0), .O(new_n38_));
  oai21  g15(.a(new_n38_), .b(new_n29_), .c(new_n27_), .O(z06));
  nand3  g16(.a(x4), .b(new_n34_), .c(x0), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n22_), .c(x3), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n31_), .O(z08));
  inv1   g21(.a(new_n27_), .O(z09));
  nand4  g22(.a(x3), .b(new_n22_), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n31_), .O(z10));
  nand4  g24(.a(new_n26_), .b(new_n22_), .c(x1), .d(new_n42_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n31_), .O(z11));
  nand3  g26(.a(x4), .b(new_n34_), .c(new_n42_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(x3), .c(new_n22_), .O(z12));
  nand2  g28(.a(new_n34_), .b(new_n42_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n29_), .c(new_n27_), .O(z14));
  nand4  g30(.a(new_n26_), .b(new_n22_), .c(new_n34_), .d(new_n42_), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n31_), .O(z15));
  zero   g32(.O(z01));
  zero   g33(.O(z05));
  zero   g34(.O(z13));
endmodule
