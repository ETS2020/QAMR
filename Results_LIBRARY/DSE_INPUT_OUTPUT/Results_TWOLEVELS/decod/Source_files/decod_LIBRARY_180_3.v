...
module FAU ( 
  ...
  aoi21  g04(.a(new_n28_), .b(new_n22_), .c(new_n23_), .O(z04));
  inv1   g05(.a(x3), .O(new_n30_));
  nand4  g06(.a(new_n30_), .b(x2), .c(new_n22_), .d(x0), .O(new_n31_));
  nor2   g07(.a(new_n31_), .b(new_n23_), .O(z05));
  inv1   g08(.a(x2), .O(new_n33_));
  nand4  g09(.a(x3), .b(new_n33_), .c(new_n22_), .d(x0), .O(new_n34_));
  ...
  aoi21  g17(.a(new_n43_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand3  g18(.a(x3), .b(new_n33_), .c(new_n40_), .O(new_n45_));
  aoi21  g19(.a(new_n45_), .b(new_n22_), .c(new_n23_), .O(z14));
  nand4  g20(.a(new_n30_), .b(new_n33_), .c(new_n22_), .d(new_n40_), .O(new_n47_));
