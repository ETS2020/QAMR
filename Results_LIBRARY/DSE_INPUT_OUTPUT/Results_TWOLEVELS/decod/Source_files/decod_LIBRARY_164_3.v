...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n40_, new_n43_, new_n45_,
  ...
  nand3  g17(.a(x4), .b(new_n30_), .c(x2), .O(new_n40_));
  aoi21  g18(.a(new_n40_), .b(new_n25_), .c(new_n26_), .O(z09));
  aoi21  g19(.a(new_n34_), .b(new_n25_), .c(new_n26_), .O(z10));
  nand4  g20(.a(new_n30_), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n43_));
  ...
  nand3  g29(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n52_));
  oai21  g30(.a(new_n52_), .b(new_n51_), .c(new_n23_), .O(z15));
  zero   g31(.O(z00));
  inv1   g32(.a(new_n23_), .O(z02));
