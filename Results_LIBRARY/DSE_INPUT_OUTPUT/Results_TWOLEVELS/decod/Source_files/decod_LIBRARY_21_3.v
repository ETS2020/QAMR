...
module FAU ( 
  ...
  nand3  g17(.a(x4), .b(new_n32_), .c(x2), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(new_n27_), .c(new_n28_), .O(z09));
  ...
  oai21  g27(.a(new_n50_), .b(new_n36_), .c(new_n23_), .O(z14));
  nand3  g28(.a(x4), .b(new_n32_), .c(new_n35_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n50_), .c(new_n23_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z02));
  zero   g32(.O(z03));
endmodule
