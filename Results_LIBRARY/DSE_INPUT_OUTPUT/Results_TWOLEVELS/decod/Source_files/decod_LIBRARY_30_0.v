...
module FAU ( 
  ...
  nand3  g19(.a(new_n27_), .b(new_n33_), .c(x0), .O(new_n41_));
  ...
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n43_), .O(new_n50_));
  ...
  nand2  g34(.a(new_n33_), .b(new_n43_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n39_), .c(new_n32_), .O(z14));
