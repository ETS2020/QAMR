...
module FAU ( 
  ...
  nand2  g22(.a(new_n31_), .b(new_n40_), .O(new_n46_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n46_), .c(new_n28_), .O(z12));
  nand4  g25(.a(new_n22_), .b(x2), .c(new_n31_), .d(new_n40_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n23_), .O(z13));
  nand4  g27(.a(x3), .b(new_n27_), .c(new_n31_), .d(new_n40_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z14));
  nand4  g29(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(new_n40_), .O(new_n53_));
