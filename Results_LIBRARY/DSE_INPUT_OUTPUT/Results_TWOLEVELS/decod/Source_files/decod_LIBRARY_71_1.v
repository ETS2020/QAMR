...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n43_, new_n48_, new_n50_, new_n52_;
  ...
  nand3  g21(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n40_), .c(new_n42_), .O(z07));
  inv1   g23(.a(new_n42_), .O(z08));
  nand4  g24(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n31_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n31_), .O(z13));
  nand4  g28(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n41_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n31_), .O(z14));
  aoi21  g30(.a(new_n43_), .b(new_n22_), .c(x0), .O(z15));
  zero   g31(.O(z09));
  zero   g32(.O(z10));
  inv1   g33(.a(new_n42_), .O(z11));
endmodule
