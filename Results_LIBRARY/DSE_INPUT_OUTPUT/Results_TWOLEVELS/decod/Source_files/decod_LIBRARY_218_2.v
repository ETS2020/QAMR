...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n36_, new_n37_, new_n40_, new_n42_, new_n43_, new_n45_,
    new_n47_, new_n51_;
  ...
  nand3  g18(.a(x4), .b(new_n31_), .c(x2), .O(new_n43_));
  oai21  g19(.a(new_n43_), .b(new_n42_), .c(new_n37_), .O(z09));
  nand4  g20(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n25_), .O(z10));
  nand3  g22(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(new_n42_), .c(new_n37_), .O(z11));
  aoi21  g24(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g25(.a(new_n43_), .b(new_n22_), .c(x1), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n28_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n22_), .c(x1), .O(z14));
