...
module FAU ( 
  ...
  wire new_n22_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n46_,
    new_n48_, new_n50_;
  ...
  nand4  g17(.a(new_n31_), .b(x2), .c(x1), .d(new_n30_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n26_), .O(z09));
  nand4  g19(.a(x3), .b(new_n34_), .c(x1), .d(new_n30_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n26_), .O(z10));
  aoi21  g21(.a(new_n37_), .b(new_n30_), .c(new_n27_), .O(z11));
  ...
  oai21  g28(.a(new_n48_), .b(new_n37_), .c(new_n22_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z03));
