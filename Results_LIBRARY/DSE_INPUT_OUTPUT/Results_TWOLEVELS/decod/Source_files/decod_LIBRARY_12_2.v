...
module FAU ( 
  ...
  aoi21  g15(.a(new_n36_), .b(new_n25_), .c(x2), .O(z06));
  ...
  oai21  g25(.a(new_n47_), .b(new_n46_), .c(new_n30_), .O(z12));
  nand4  g26(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z13));
  aoi21  g28(.a(new_n41_), .b(new_n25_), .c(x2), .O(z14));
  aoi21  g29(.a(new_n43_), .b(new_n25_), .c(x2), .O(z15));
  zero   g30(.O(z11));
