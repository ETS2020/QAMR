...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n35_, new_n37_, new_n38_, new_n41_, new_n44_, new_n46_,
    new_n49_;
  ...
  aoi21  g20(.a(new_n35_), .b(new_n25_), .c(new_n26_), .O(z11));
  ...
  nor2   g24(.a(new_n46_), .b(new_n37_), .O(z13));
  oai21  g25(.a(new_n44_), .b(new_n33_), .c(new_n22_), .O(z14));
  nand4  g26(.a(new_n29_), .b(new_n32_), .c(new_n26_), .d(new_n25_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n37_), .O(z15));
  zero   g28(.O(z02));
