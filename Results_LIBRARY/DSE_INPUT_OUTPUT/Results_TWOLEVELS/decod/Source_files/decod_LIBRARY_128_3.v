...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n42_, new_n44_, new_n46_,
    new_n49_;
  ...
  nand4  g19(.a(new_n30_), .b(new_n33_), .c(x1), .d(new_n29_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n25_), .O(z11));
  nand2  g21(.a(new_n26_), .b(new_n29_), .O(new_n44_));
  oai21  g22(.a(new_n44_), .b(new_n38_), .c(new_n22_), .O(z12));
  nand4  g23(.a(new_n30_), .b(x2), .c(new_n26_), .d(new_n29_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z13));
  oai21  g25(.a(new_n44_), .b(new_n34_), .c(new_n22_), .O(z14));
  nand3  g26(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n44_), .c(new_n22_), .O(z15));
  zero   g28(.O(z01));
