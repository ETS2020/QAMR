...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n45_,
    new_n47_, new_n49_;
  ...
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n28_), .O(z08));
  nand2  g17(.a(x1), .b(new_n22_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n26_), .c(new_n35_), .O(z09));
  nand4  g19(.a(x3), .b(new_n29_), .c(x1), .d(new_n22_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n28_), .O(z10));
  oai21  g21(.a(new_n39_), .b(new_n32_), .c(new_n35_), .O(z11));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g23(.a(new_n25_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n28_), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n29_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g27(.a(new_n25_), .b(new_n29_), .c(new_n34_), .d(new_n22_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n28_), .O(z15));
  inv1   g29(.a(new_n35_), .O(z05));
