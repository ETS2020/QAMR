...
module FAU ( 
  ...
  nand3  g15(.a(x2), .b(new_n33_), .c(x0), .O(new_n37_));
  ...
  nand3  g24(.a(x2), .b(x1), .c(new_n43_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(x3), .O(z09));
  nand3  g26(.a(x4), .b(x3), .c(new_n27_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n44_), .c(new_n32_), .O(z10));
