...
module FAU ( 
  ...
  nand4  g28(.a(x3), .b(new_n25_), .c(new_n30_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n22_), .O(z14));
  nand3  g30(.a(x4), .b(new_n26_), .c(new_n42_), .O(new_n53_));
  aoi21  g31(.a(new_n53_), .b(new_n25_), .c(x1), .O(z15));
  zero   g32(.O(z05));
  inv1   g33(.a(new_n31_), .O(z12));
  inv1   g34(.a(new_n31_), .O(z13));
endmodule
