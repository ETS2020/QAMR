...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n45_, new_n48_, new_n51_, new_n53_;
  ...
  nand3  g17(.a(x4), .b(new_n33_), .c(x0), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n28_), .c(x3), .O(z07));
  ...
  oai21  g23(.a(new_n45_), .b(new_n37_), .c(new_n26_), .O(z10));
  aoi21  g24(.a(new_n42_), .b(new_n28_), .c(x3), .O(z11));
  nand4  g25(.a(x3), .b(x2), .c(new_n33_), .d(new_n41_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n22_), .O(z12));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n33_), .d(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n28_), .c(new_n33_), .d(new_n41_), .O(new_n53_));
