...
module FAU ( 
  ...
  nor2   g24(.a(new_n46_), .b(new_n28_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n28_), .O(z13));
  aoi21  g27(.a(new_n40_), .b(new_n22_), .c(x0), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(new_n37_), .O(new_n51_));
