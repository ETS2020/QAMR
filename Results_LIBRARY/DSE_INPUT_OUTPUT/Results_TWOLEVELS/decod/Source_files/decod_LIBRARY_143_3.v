...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n34_, new_n37_, new_n38_, new_n40_, new_n43_, new_n45_;
  inv1   g00(.a(x2), .O(new_n22_));
  inv1   g01(.a(x4), .O(new_n23_));
  nor2   g02(.a(new_n23_), .b(new_n22_), .O(z00));
  nand4  g03(.a(x3), .b(new_n22_), .c(x1), .d(x0), .O(new_n25_));
  nor2   g04(.a(new_n25_), .b(new_n23_), .O(z02));
  ...
  nand3  g14(.a(x3), .b(x1), .c(new_n37_), .O(new_n38_));
  aoi21  g15(.a(new_n38_), .b(new_n22_), .c(new_n23_), .O(z10));
  nand4  g16(.a(new_n27_), .b(new_n22_), .c(x1), .d(new_n37_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n23_), .O(z11));
  nand3  g18(.a(x3), .b(new_n31_), .c(new_n37_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n22_), .c(new_n23_), .O(z14));
  nand4  g20(.a(new_n27_), .b(new_n22_), .c(new_n31_), .d(new_n37_), .O(new_n45_));
