...
module FAU ( 
  ...
  nand2  g24(.a(new_n27_), .b(new_n26_), .O(new_n48_));
  oai21  g25(.a(new_n48_), .b(new_n31_), .c(new_n23_), .O(z13));
  nand4  g26(.a(x3), .b(new_n33_), .c(new_n27_), .d(new_n26_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n36_), .O(z14));
  nand4  g28(.a(new_n30_), .b(new_n33_), .c(new_n27_), .d(new_n26_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n36_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z02));
