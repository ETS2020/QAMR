...
module FAU ( 
  ...
  nand2  g11(.a(new_n22_), .b(new_n30_), .O(new_n33_));
  ...
  nand4  g16(.a(new_n30_), .b(x2), .c(new_n34_), .d(x0), .O(new_n38_));
  ...
  nand4  g20(.a(new_n30_), .b(new_n27_), .c(new_n34_), .d(x0), .O(new_n42_));
  ...
  nand4  g33(.a(new_n30_), .b(x2), .c(new_n34_), .d(new_n44_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n22_), .O(z13));
  nand4  g35(.a(x3), .b(new_n27_), .c(new_n34_), .d(new_n44_), .O(new_n57_));
