...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    ...
    new_n43_, new_n44_, new_n47_, new_n50_, new_n52_, new_n55_;
  ...
  nand3  g22(.a(x4), .b(new_n22_), .c(new_n31_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(new_n26_), .O(z07));
  nand4  g24(.a(new_n22_), .b(x2), .c(x1), .d(new_n25_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n30_), .O(z09));
  inv1   g26(.a(new_n26_), .O(z10));
  nand4  g27(.a(new_n22_), .b(new_n31_), .c(x1), .d(new_n25_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n30_), .O(z11));
  nand4  g29(.a(new_n22_), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n52_));
  nor2   g30(.a(new_n52_), .b(new_n30_), .O(z13));
  nand3  g31(.a(x4), .b(new_n31_), .c(new_n36_), .O(new_n55_));
  aoi21  g32(.a(new_n55_), .b(new_n22_), .c(x0), .O(z15));
  zero   g33(.O(z08));
  zero   g34(.O(z14));
