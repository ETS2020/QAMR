...
module FAU ( 
  ...
  nand4  g11(.a(new_n24_), .b(x2), .c(new_n23_), .d(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n31_), .O(z05));
  nand4  g13(.a(x3), .b(new_n28_), .c(new_n23_), .d(x0), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n31_), .O(z06));
  nand4  g15(.a(new_n24_), .b(new_n28_), .c(new_n23_), .d(x0), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n31_), .O(z07));
  inv1   g17(.a(x0), .O(new_n40_));
  nand4  g18(.a(new_n24_), .b(x2), .c(x1), .d(new_n40_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n31_), .O(z09));
  nand4  g20(.a(new_n24_), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n31_), .O(z11));
  nand3  g22(.a(x4), .b(x2), .c(new_n40_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(new_n23_), .c(new_n24_), .O(z12));
  nand4  g24(.a(new_n24_), .b(x2), .c(new_n23_), .d(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n31_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n23_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n31_), .O(z14));
  nand4  g28(.a(new_n24_), .b(new_n28_), .c(new_n23_), .d(new_n40_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n31_), .O(z15));
  zero   g30(.O(z00));
  nor2   g31(.a(new_n24_), .b(new_n23_), .O(z08));
  nor2   g32(.a(new_n24_), .b(new_n23_), .O(z10));
endmodule
