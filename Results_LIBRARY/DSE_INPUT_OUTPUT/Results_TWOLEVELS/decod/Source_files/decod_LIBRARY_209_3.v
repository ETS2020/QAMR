...
module FAU ( 
  ...
  nand4  g17(.a(new_n30_), .b(x2), .c(x1), .d(new_n29_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n25_), .O(z09));
  nand4  g19(.a(x3), .b(new_n33_), .c(x1), .d(new_n29_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n25_), .O(z10));
  nand4  g21(.a(new_n30_), .b(new_n33_), .c(x1), .d(new_n29_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n25_), .O(z11));
  nand2  g23(.a(new_n26_), .b(new_n29_), .O(new_n46_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  oai21  g25(.a(new_n47_), .b(new_n46_), .c(new_n22_), .O(z12));
  oai21  g26(.a(new_n46_), .b(new_n31_), .c(new_n22_), .O(z13));
  oai21  g27(.a(new_n46_), .b(new_n34_), .c(new_n22_), .O(z14));
