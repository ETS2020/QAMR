...
module FAU ( 
  ...
  nand4  g20(.a(new_n22_), .b(new_n30_), .c(new_n35_), .d(x0), .O(new_n42_));
  ...
  nand3  g29(.a(new_n30_), .b(x1), .c(new_n44_), .O(new_n51_));
  ...
  nand4  g33(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n44_), .O(new_n55_));
  ...
  nand4  g37(.a(new_n22_), .b(new_n30_), .c(new_n35_), .d(new_n44_), .O(new_n59_));
