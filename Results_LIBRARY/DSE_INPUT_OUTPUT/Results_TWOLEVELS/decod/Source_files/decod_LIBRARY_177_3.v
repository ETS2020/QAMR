...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n33_, new_n34_,
    new_n36_, new_n39_, new_n40_, new_n42_, new_n46_, new_n48_;
  ...
  aoi21  g15(.a(new_n40_), .b(new_n23_), .c(new_n24_), .O(z10));
  nand4  g16(.a(new_n28_), .b(new_n23_), .c(x1), .d(new_n39_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n24_), .O(z11));
  nand3  g18(.a(x3), .b(new_n33_), .c(new_n39_), .O(new_n46_));
  aoi21  g19(.a(new_n46_), .b(new_n23_), .c(new_n24_), .O(z14));
  nand4  g20(.a(new_n28_), .b(new_n23_), .c(new_n33_), .d(new_n39_), .O(new_n48_));
