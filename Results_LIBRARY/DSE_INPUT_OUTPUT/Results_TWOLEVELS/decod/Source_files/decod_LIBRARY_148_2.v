...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    ...
    new_n45_, new_n49_, new_n50_, new_n52_, new_n54_, new_n56_;
  ...
  oai21  g14(.a(new_n36_), .b(new_n34_), .c(new_n29_), .O(z05));
  ...
  nand3  g22(.a(x4), .b(new_n35_), .c(new_n42_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(x2), .c(new_n22_), .O(z09));
  nand2  g24(.a(new_n22_), .b(new_n42_), .O(new_n49_));
  nand3  g25(.a(x4), .b(x3), .c(x2), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n49_), .c(new_n29_), .O(z12));
  nand4  g27(.a(new_n35_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n25_), .O(z13));
  nand3  g29(.a(x4), .b(x3), .c(new_n42_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n22_), .c(x2), .O(z14));
  nand4  g31(.a(new_n35_), .b(new_n28_), .c(new_n22_), .d(new_n42_), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n25_), .O(z15));
  zero   g33(.O(z03));
  zero   g34(.O(z10));
  zero   g35(.O(z11));
endmodule
