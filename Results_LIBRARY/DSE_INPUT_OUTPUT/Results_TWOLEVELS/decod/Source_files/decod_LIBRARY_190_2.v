...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n46_, new_n48_, new_n50_, new_n51_, new_n53_;
  ...
  aoi21  g17(.a(new_n38_), .b(new_n28_), .c(x3), .O(z07));
  ...
  nand4  g23(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n22_), .O(z11));
  nand3  g25(.a(x4), .b(new_n33_), .c(new_n40_), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(x3), .c(new_n28_), .O(z12));
  nand2  g27(.a(new_n33_), .b(new_n40_), .O(new_n50_));
  nand3  g28(.a(x4), .b(x3), .c(new_n28_), .O(new_n51_));
  oai21  g29(.a(new_n51_), .b(new_n50_), .c(new_n26_), .O(z14));
  nand4  g30(.a(new_n25_), .b(new_n28_), .c(new_n33_), .d(new_n40_), .O(new_n53_));
