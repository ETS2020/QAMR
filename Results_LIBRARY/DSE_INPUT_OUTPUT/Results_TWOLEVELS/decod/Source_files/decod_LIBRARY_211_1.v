...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n25_), .O(z13));
  nand4  g28(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n41_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n25_), .O(z14));
  nand4  g30(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n41_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n25_), .O(z15));
  zero   g32(.O(z09));
  inv1   g33(.a(new_n42_), .O(z10));
  inv1   g34(.a(new_n42_), .O(z11));
endmodule
