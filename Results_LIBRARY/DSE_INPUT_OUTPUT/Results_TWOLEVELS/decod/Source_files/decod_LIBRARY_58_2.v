...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n42_, new_n44_, new_n47_,
    new_n50_;
  ...
  oai21  g16(.a(new_n40_), .b(new_n39_), .c(new_n34_), .O(z08));
  nand3  g17(.a(x4), .b(new_n22_), .c(x2), .O(new_n42_));
  oai21  g18(.a(new_n42_), .b(new_n39_), .c(new_n34_), .O(z09));
  nand4  g19(.a(x3), .b(new_n27_), .c(x1), .d(new_n30_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n23_), .O(z10));
  oai21  g21(.a(new_n39_), .b(new_n31_), .c(new_n34_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n33_), .d(new_n30_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n23_), .O(z12));
  aoi21  g24(.a(new_n42_), .b(new_n30_), .c(x1), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n27_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n30_), .c(x1), .O(z14));
  aoi21  g27(.a(new_n31_), .b(new_n30_), .c(x1), .O(z15));
  zero   g28(.O(z05));
  zero   g29(.O(z06));
  zero   g30(.O(z07));
endmodule
