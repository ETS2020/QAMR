...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n35_, new_n38_, new_n40_, new_n44_,
    new_n46_, new_n48_;
  ...
  nand3  g22(.a(x4), .b(new_n34_), .c(x2), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x1), .c(x0), .O(z09));
  nand4  g24(.a(x3), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n28_), .O(z10));
  nand4  g26(.a(new_n34_), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n28_), .O(z11));
  inv1   g28(.a(new_n24_), .O(z12));
