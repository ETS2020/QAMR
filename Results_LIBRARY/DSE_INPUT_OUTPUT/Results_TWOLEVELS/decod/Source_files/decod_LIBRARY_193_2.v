...
module FAU ( 
  ...
  oai21  g20(.a(new_n43_), .b(new_n39_), .c(new_n35_), .O(z10));
  ...
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n48_));
  ...
  nand4  g28(.a(new_n25_), .b(new_n29_), .c(new_n34_), .d(new_n22_), .O(new_n52_));
