...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
  ...
  oai21  g16(.a(new_n38_), .b(new_n37_), .c(new_n33_), .O(z08));
  nand4  g17(.a(new_n22_), .b(x2), .c(x1), .d(new_n36_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n23_), .O(z09));
  nand3  g19(.a(x4), .b(x3), .c(new_n27_), .O(new_n42_));
  oai21  g20(.a(new_n42_), .b(new_n37_), .c(new_n33_), .O(z10));
  nand4  g21(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n36_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n23_), .O(z11));
  aoi21  g23(.a(new_n38_), .b(new_n36_), .c(x1), .O(z12));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(new_n36_), .c(x1), .O(z13));
  nand4  g26(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n36_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n23_), .O(z14));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n36_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z15));
  zero   g30(.O(z06));
  inv1   g31(.a(new_n33_), .O(z05));
