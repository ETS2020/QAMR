...
module FAU ( 
  ...
  nand4  g22(.a(new_n22_), .b(x2), .c(x1), .d(new_n31_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z09));
  nand4  g24(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n31_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z11));
  nand3  g26(.a(x4), .b(x2), .c(new_n35_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g28(.a(new_n41_), .b(new_n22_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z10));
  zero   g31(.O(z12));
  zero   g32(.O(z14));
