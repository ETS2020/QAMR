...
module FAU ( 
  ...
  nand4  g19(.a(new_n30_), .b(new_n33_), .c(x1), .d(new_n26_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n40_), .O(z11));
  nand4  g21(.a(x3), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n40_), .O(z12));
  nand4  g23(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n40_), .O(z13));
  nand4  g25(.a(x3), .b(new_n33_), .c(new_n27_), .d(new_n26_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n40_), .O(z14));
  nand2  g27(.a(new_n27_), .b(new_n26_), .O(new_n51_));
  oai21  g28(.a(new_n51_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z03));
