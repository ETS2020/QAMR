...
module FAU ( 
  ...
  nand3  g32(.a(new_n26_), .b(new_n35_), .c(new_n44_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(new_n25_), .O(z13));
  nand4  g34(.a(x3), .b(new_n25_), .c(new_n35_), .d(new_n44_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n22_), .O(z14));
  nand2  g36(.a(new_n35_), .b(new_n44_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n33_), .c(new_n30_), .O(z15));
endmodule
