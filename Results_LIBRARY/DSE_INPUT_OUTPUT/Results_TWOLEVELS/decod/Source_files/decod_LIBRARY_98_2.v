...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n39_, new_n40_, new_n43_, new_n45_,
    new_n50_;
  ...
  oai21  g17(.a(new_n40_), .b(new_n39_), .c(new_n35_), .O(z08));
  oai21  g18(.a(new_n39_), .b(new_n27_), .c(new_n35_), .O(z09));
  nand4  g19(.a(x3), .b(new_n29_), .c(x1), .d(new_n25_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n22_), .O(z10));
  nand3  g21(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n39_), .c(new_n35_), .O(z11));
  aoi21  g23(.a(new_n40_), .b(new_n25_), .c(x1), .O(z12));
  aoi21  g24(.a(new_n27_), .b(new_n25_), .c(x1), .O(z13));
  aoi21  g25(.a(new_n30_), .b(new_n25_), .c(x1), .O(z14));
  nand4  g26(.a(new_n26_), .b(new_n29_), .c(new_n34_), .d(new_n25_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n22_), .O(z15));
  zero   g28(.O(z06));
  zero   g29(.O(z07));
