...
module FAU ( 
  ...
  nand4  g21(.a(new_n28_), .b(new_n31_), .c(new_n23_), .d(x0), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n36_), .O(z07));
  aoi21  g23(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  nand4  g24(.a(new_n28_), .b(x2), .c(x1), .d(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n36_), .O(z09));
  aoi21  g26(.a(new_n32_), .b(x1), .c(x0), .O(z10));
