...
module FAU ( 
  ...
  nand3  g14(.a(new_n22_), .b(x2), .c(new_n34_), .O(new_n37_));
  aoi21  g15(.a(new_n37_), .b(x1), .c(new_n23_), .O(z09));
  nand4  g16(.a(x3), .b(new_n27_), .c(x1), .d(new_n34_), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n23_), .O(z10));
  nand4  g18(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n34_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n23_), .O(z11));
  zero   g20(.O(z06));
  zero   g21(.O(z12));
  zero   g22(.O(z13));
  zero   g23(.O(z15));
  nor2   g24(.a(new_n23_), .b(x1), .O(z05));
  nor2   g25(.a(new_n23_), .b(x1), .O(z07));
  nor2   g26(.a(new_n23_), .b(x1), .O(z14));
endmodule
