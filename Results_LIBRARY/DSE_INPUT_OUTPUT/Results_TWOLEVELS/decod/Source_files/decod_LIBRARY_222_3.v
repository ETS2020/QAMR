...
module FAU ( 
  ...
  nand4  g12(.a(new_n25_), .b(x2), .c(new_n24_), .d(x0), .O(new_n34_));
  nor2   g13(.a(new_n34_), .b(new_n31_), .O(z05));
  nand4  g14(.a(x3), .b(new_n28_), .c(new_n24_), .d(x0), .O(new_n36_));
  ...
  nand2  g25(.a(new_n24_), .b(new_n41_), .O(new_n48_));
  nand3  g26(.a(x4), .b(new_n25_), .c(x2), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n48_), .c(new_n22_), .O(z13));
  nand3  g28(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(new_n24_), .c(new_n25_), .O(z14));
