...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    ...
    new_n45_, new_n48_, new_n50_, new_n53_;
  ...
  nand4  g20(.a(new_n22_), .b(new_n27_), .c(new_n35_), .d(x0), .O(new_n42_));
  ...
  nand4  g25(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n31_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n23_), .O(z11));
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n31_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n23_), .O(z13));
  nand3  g29(.a(x4), .b(new_n27_), .c(new_n35_), .O(new_n53_));
  aoi21  g30(.a(new_n53_), .b(new_n22_), .c(x0), .O(z15));
  zero   g31(.O(z10));
  zero   g32(.O(z14));
