...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n43_, new_n45_, new_n48_, new_n50_;
  ...
  aoi21  g25(.a(new_n30_), .b(x1), .c(x0), .O(z09));
  nand4  g26(.a(x3), .b(new_n32_), .c(x1), .d(new_n26_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n22_), .O(z10));
