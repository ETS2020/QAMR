...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    ...
    new_n45_, new_n48_, new_n49_, new_n51_;
  ...
  nand4  g21(.a(new_n30_), .b(x2), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n22_), .O(z09));
  nand4  g23(.a(x3), .b(new_n27_), .c(x1), .d(new_n40_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n22_), .O(z10));
  nand2  g25(.a(new_n33_), .b(new_n40_), .O(new_n48_));
  nand3  g26(.a(x4), .b(x3), .c(x2), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n48_), .c(new_n31_), .O(z12));
  nand3  g28(.a(x4), .b(new_n33_), .c(new_n40_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(x2), .c(x3), .O(z13));
  aoi21  g30(.a(new_n51_), .b(x3), .c(x2), .O(z14));
  zero   g31(.O(z11));
  zero   g32(.O(z15));
