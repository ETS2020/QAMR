...
module FAU ( 
  ...
  nand4  g16(.a(x3), .b(new_n30_), .c(new_n22_), .d(x0), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n35_), .O(z06));
  inv1   g18(.a(x0), .O(new_n42_));
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n35_), .O(z08));
  nand4  g21(.a(new_n23_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n35_), .O(z09));
  nand2  g23(.a(x1), .b(new_n42_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n31_), .c(new_n24_), .O(z10));
  nand4  g25(.a(new_n23_), .b(new_n30_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n35_), .O(z11));
  nand3  g27(.a(x4), .b(x2), .c(new_n42_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(x3), .c(x1), .O(z12));
  inv1   g29(.a(new_n24_), .O(z13));
  nand3  g30(.a(x4), .b(new_n30_), .c(new_n42_), .O(new_n54_));
  aoi21  g31(.a(new_n54_), .b(x3), .c(x1), .O(z14));
  zero   g32(.O(z05));
  zero   g33(.O(z07));
