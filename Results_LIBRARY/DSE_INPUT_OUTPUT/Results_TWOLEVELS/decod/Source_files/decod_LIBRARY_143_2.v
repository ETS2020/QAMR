...
module FAU ( 
  ...
  nand2  g17(.a(new_n28_), .b(x2), .O(new_n39_));
  ...
  nand4  g33(.a(new_n25_), .b(x2), .c(new_n33_), .d(new_n44_), .O(new_n55_));
  ...
  nand4  g37(.a(new_n25_), .b(new_n22_), .c(new_n33_), .d(new_n44_), .O(new_n59_));
