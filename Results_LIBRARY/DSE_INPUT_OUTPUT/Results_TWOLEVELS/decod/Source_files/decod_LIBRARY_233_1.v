...
module FAU ( 
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n22_), .d(new_n46_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n33_), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n46_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n33_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n46_), .O(new_n51_));
