...
module FAU ( 
  ...
  nand2  g23(.a(new_n26_), .b(new_n41_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n34_), .c(new_n32_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n26_), .d(new_n41_), .O(new_n49_));
  ...
  aoi21  g29(.a(new_n45_), .b(new_n26_), .c(x3), .O(z15));
  zero   g30(.O(z01));
  zero   g31(.O(z03));
  inv1   g32(.a(new_n32_), .O(z11));
endmodule
