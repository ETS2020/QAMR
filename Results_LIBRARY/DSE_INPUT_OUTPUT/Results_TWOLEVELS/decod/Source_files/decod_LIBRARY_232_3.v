...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n43_, new_n44_, new_n46_,
  ...
  nand4  g11(.a(new_n29_), .b(x2), .c(new_n25_), .d(x0), .O(new_n34_));
  ...
  aoi21  g20(.a(new_n44_), .b(new_n26_), .c(new_n25_), .O(z10));
  nand4  g21(.a(new_n29_), .b(new_n26_), .c(x1), .d(new_n43_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n33_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n25_), .d(new_n43_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n33_), .O(z12));
  nand4  g25(.a(new_n29_), .b(x2), .c(new_n25_), .d(new_n43_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n33_), .O(z13));
  nand2  g27(.a(new_n25_), .b(new_n43_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n37_), .c(new_n23_), .O(z14));
  oai21  g29(.a(new_n52_), .b(new_n39_), .c(new_n23_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z08));
  zero   g32(.O(z09));
endmodule
