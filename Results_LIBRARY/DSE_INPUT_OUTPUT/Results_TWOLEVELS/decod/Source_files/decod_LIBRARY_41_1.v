...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n33_,
    new_n35_, new_n36_, new_n38_, new_n42_, new_n44_;
  ...
  nand3  g13(.a(x3), .b(x1), .c(new_n35_), .O(new_n36_));
  aoi21  g14(.a(new_n36_), .b(x2), .c(new_n22_), .O(z08));
  nand3  g15(.a(new_n25_), .b(x1), .c(new_n35_), .O(new_n38_));
  aoi21  g16(.a(new_n38_), .b(x2), .c(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n30_), .c(new_n35_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(x2), .c(new_n22_), .O(z12));
  nand4  g19(.a(new_n25_), .b(x2), .c(new_n30_), .d(new_n35_), .O(new_n44_));
