...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n38_, new_n40_, new_n41_, new_n43_, new_n47_,
    new_n50_;
  ...
  oai21  g21(.a(new_n38_), .b(new_n31_), .c(new_n34_), .O(z11));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g23(.a(new_n25_), .b(x2), .c(new_n33_), .d(new_n22_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n40_), .O(z13));
  aoi21  g25(.a(new_n29_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g26(.a(new_n25_), .b(new_n28_), .c(new_n33_), .d(new_n22_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n40_), .O(z15));
  zero   g28(.O(z06));
  zero   g29(.O(z07));
