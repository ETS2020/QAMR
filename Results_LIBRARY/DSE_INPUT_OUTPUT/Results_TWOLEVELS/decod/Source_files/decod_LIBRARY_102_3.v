...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n35_, new_n36_, new_n38_, new_n41_, new_n43_;
  ...
  nand4  g11(.a(new_n27_), .b(new_n22_), .c(new_n30_), .d(x0), .O(new_n33_));
  nor2   g12(.a(new_n33_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n35_));
  nand4  g14(.a(x3), .b(new_n22_), .c(x1), .d(new_n35_), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n23_), .O(z10));
  nand4  g16(.a(new_n27_), .b(new_n22_), .c(x1), .d(new_n35_), .O(new_n38_));
  nor2   g17(.a(new_n38_), .b(new_n23_), .O(z11));
  nand3  g18(.a(x3), .b(new_n30_), .c(new_n35_), .O(new_n41_));
  aoi21  g19(.a(new_n41_), .b(new_n22_), .c(new_n23_), .O(z14));
  nand4  g20(.a(new_n27_), .b(new_n22_), .c(new_n30_), .d(new_n35_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n23_), .O(z15));
  zero   g22(.O(z13));
  nor2   g23(.a(new_n23_), .b(new_n22_), .O(z01));
  nor2   g24(.a(new_n23_), .b(new_n22_), .O(z04));
