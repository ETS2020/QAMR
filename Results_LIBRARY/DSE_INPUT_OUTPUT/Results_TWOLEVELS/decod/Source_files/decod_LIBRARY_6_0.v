...
module FAU ( 
  ...
  aoi21  g23(.a(new_n44_), .b(x2), .c(x3), .O(z09));
  aoi21  g24(.a(new_n44_), .b(x3), .c(x2), .O(z10));
  nand2  g25(.a(new_n34_), .b(new_n41_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n26_), .c(new_n24_), .O(z12));
  nand4  g27(.a(new_n23_), .b(x2), .c(new_n34_), .d(new_n41_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n28_), .O(z13));
  nand4  g29(.a(x3), .b(new_n22_), .c(new_n34_), .d(new_n41_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n28_), .O(z14));
  inv1   g31(.a(new_n24_), .O(z07));
  inv1   g32(.a(new_n24_), .O(z11));
