...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n46_, new_n50_;
  ...
  nor2   g20(.a(new_n25_), .b(x0), .O(z10));
  nand3  g21(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n25_), .c(x0), .O(z12));
  aoi21  g23(.a(new_n27_), .b(new_n25_), .c(x0), .O(z13));
  aoi21  g24(.a(new_n30_), .b(new_n25_), .c(x0), .O(z14));
  nand3  g25(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n25_), .c(x0), .O(z15));
  zero   g27(.O(z08));
  zero   g28(.O(z09));
  zero   g29(.O(z11));
endmodule
