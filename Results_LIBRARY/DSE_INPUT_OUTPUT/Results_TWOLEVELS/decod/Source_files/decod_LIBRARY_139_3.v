...
module FAU ( 
  ...
  nor2   g12(.a(new_n34_), .b(new_n29_), .O(z05));
  nand3  g13(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n37_));
  aoi21  g14(.a(new_n37_), .b(new_n25_), .c(new_n24_), .O(z07));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n24_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n29_), .O(z08));
  nand4  g17(.a(new_n25_), .b(x2), .c(x1), .d(new_n24_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n29_), .O(z09));
  nand3  g19(.a(x4), .b(new_n30_), .c(x1), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(new_n24_), .c(new_n25_), .O(z10));
  nand4  g21(.a(new_n25_), .b(new_n30_), .c(x1), .d(new_n24_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n29_), .O(z11));
  nand3  g23(.a(x4), .b(x2), .c(new_n33_), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n33_), .d(new_n24_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n29_), .O(z13));
  nand4  g27(.a(x3), .b(new_n30_), .c(new_n33_), .d(new_n24_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n29_), .O(z14));
  nand2  g29(.a(new_n33_), .b(new_n24_), .O(new_n53_));
  nand3  g30(.a(x4), .b(new_n25_), .c(new_n30_), .O(new_n54_));
  oai21  g31(.a(new_n54_), .b(new_n53_), .c(new_n22_), .O(z15));
  zero   g32(.O(z02));
  zero   g33(.O(z06));
