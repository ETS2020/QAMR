...
module FAU ( 
  ...
  oai21  g24(.a(new_n45_), .b(new_n33_), .c(new_n30_), .O(z12));
  nand4  g25(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n40_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n22_), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n25_), .d(new_n40_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n22_), .O(z14));
  nand3  g29(.a(x4), .b(new_n26_), .c(new_n40_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n25_), .c(x2), .O(z15));
  inv1   g31(.a(new_n30_), .O(z03));
  inv1   g32(.a(new_n30_), .O(z10));
