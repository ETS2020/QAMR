...
module FAU ( 
  ...
  nand3  g25(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n48_));
  oai21  g26(.a(new_n48_), .b(new_n44_), .c(new_n27_), .O(z11));
  aoi21  g27(.a(new_n42_), .b(new_n28_), .c(x1), .O(z13));
  nand4  g28(.a(new_n28_), .b(new_n31_), .c(new_n26_), .d(new_n41_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n22_), .O(z15));
  zero   g30(.O(z06));
  zero   g31(.O(z12));
  inv1   g32(.a(new_n27_), .O(z14));
endmodule
