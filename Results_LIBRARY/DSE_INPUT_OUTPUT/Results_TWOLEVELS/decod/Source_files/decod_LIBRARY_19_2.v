...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n37_, new_n39_, new_n41_, new_n43_, new_n46_, new_n48_,
    new_n49_, new_n51_;
  ...
  inv1   g24(.a(x1), .O(new_n48_));
  nand4  g25(.a(x3), .b(new_n28_), .c(new_n48_), .d(new_n22_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n25_), .O(z14));
  nand4  g27(.a(new_n31_), .b(new_n28_), .c(new_n48_), .d(new_n22_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n25_), .O(z15));
  zero   g29(.O(z06));
  zero   g30(.O(z07));
  nor2   g31(.a(x1), .b(new_n22_), .O(z05));
endmodule
