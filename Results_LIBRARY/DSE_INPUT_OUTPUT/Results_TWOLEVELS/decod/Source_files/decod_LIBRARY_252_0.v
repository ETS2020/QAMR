...
module FAU ( 
  ...
  nand3  g20(.a(new_n28_), .b(new_n35_), .c(x0), .O(new_n42_));
  ...
  nand4  g28(.a(x3), .b(new_n26_), .c(x1), .d(new_n44_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n22_), .O(z10));
  nand3  g30(.a(new_n28_), .b(x1), .c(new_n44_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x2), .O(z11));
  ...
  nand3  g36(.a(x3), .b(new_n35_), .c(new_n44_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(x4), .c(x2), .O(z14));
  nand3  g38(.a(new_n28_), .b(new_n35_), .c(new_n44_), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(x4), .c(x2), .O(z15));
endmodule
