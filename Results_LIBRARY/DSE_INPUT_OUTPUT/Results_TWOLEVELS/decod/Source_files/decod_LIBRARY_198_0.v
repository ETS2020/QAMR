...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n31_), .c(new_n36_), .O(new_n42_));
  ...
  nand3  g27(.a(x4), .b(x2), .c(new_n36_), .O(new_n50_));
  aoi21  g28(.a(new_n50_), .b(x3), .c(x0), .O(z12));
  nand4  g29(.a(x3), .b(new_n31_), .c(new_n36_), .d(new_n22_), .O(new_n52_));
