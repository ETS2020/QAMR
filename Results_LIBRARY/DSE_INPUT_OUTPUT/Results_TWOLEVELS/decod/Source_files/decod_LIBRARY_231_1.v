...
module FAU ( 
  ...
  aoi21  g11(.a(new_n33_), .b(new_n22_), .c(x1), .O(z05));
  ...
  oai21  g21(.a(new_n43_), .b(new_n42_), .c(new_n36_), .O(z09));
  nand3  g22(.a(x4), .b(new_n27_), .c(new_n39_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(x1), .c(new_n22_), .O(z10));
  nand3  g24(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n47_));
  oai21  g25(.a(new_n47_), .b(new_n42_), .c(new_n36_), .O(z11));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n39_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z13));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(new_n35_), .d(new_n39_), .O(new_n53_));
