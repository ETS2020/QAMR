...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n35_, new_n37_, new_n39_, new_n41_,
    new_n43_, new_n45_, new_n47_;
  ...
  nand4  g13(.a(new_n34_), .b(new_n31_), .c(x1), .d(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n28_), .O(z03));
  nand4  g15(.a(x3), .b(x2), .c(new_n23_), .d(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n28_), .O(z04));
  nand4  g17(.a(new_n34_), .b(x2), .c(new_n23_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n28_), .O(z05));
  nand3  g19(.a(x4), .b(x3), .c(new_n31_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x0), .c(x1), .O(z06));
  nand3  g21(.a(x4), .b(new_n34_), .c(new_n31_), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(x0), .c(x1), .O(z07));
  nand4  g23(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n28_), .O(z08));
  nand3  g25(.a(x4), .b(new_n34_), .c(x2), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x1), .c(x0), .O(z09));
  aoi21  g27(.a(new_n41_), .b(x1), .c(x0), .O(z10));
  aoi21  g28(.a(new_n43_), .b(x1), .c(x0), .O(z11));
  inv1   g29(.a(new_n24_), .O(z12));
  zero   g30(.O(z14));
  inv1   g31(.a(new_n24_), .O(z13));
