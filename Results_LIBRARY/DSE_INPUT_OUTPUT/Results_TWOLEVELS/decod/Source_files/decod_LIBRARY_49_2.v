...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n36_, new_n37_, new_n39_, new_n40_, new_n42_, new_n49_;
  ...
  aoi21  g22(.a(new_n42_), .b(new_n27_), .c(x1), .O(z13));
  aoi21  g23(.a(new_n29_), .b(new_n27_), .c(x1), .O(z14));
  nand4  g24(.a(new_n22_), .b(new_n28_), .c(new_n36_), .d(new_n27_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n23_), .O(z15));
  zero   g26(.O(z04));
  zero   g27(.O(z05));
  zero   g28(.O(z06));
endmodule
