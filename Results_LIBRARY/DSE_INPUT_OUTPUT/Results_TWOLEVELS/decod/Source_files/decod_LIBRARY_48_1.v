...
module FAU ( 
  ...
  nand4  g23(.a(new_n22_), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n23_), .O(z13));
  aoi21  g25(.a(new_n29_), .b(new_n27_), .c(x0), .O(z14));
  aoi21  g26(.a(new_n31_), .b(new_n27_), .c(x0), .O(z15));
  zero   g27(.O(z08));
  inv1   g28(.a(new_n34_), .O(z10));
  inv1   g29(.a(new_n34_), .O(z11));
endmodule
