...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n40_, new_n42_, new_n45_, new_n47_,
  ...
  nand3  g20(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(new_n40_), .c(new_n35_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n25_), .O(z12));
  ...
  nor2   g27(.a(new_n51_), .b(new_n25_), .O(z14));
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n53_));
