...
module FAU ( 
  ...
  aoi21  g20(.a(new_n43_), .b(new_n30_), .c(new_n27_), .O(z10));
  ...
  nand2  g26(.a(new_n27_), .b(new_n30_), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n43_), .c(new_n23_), .O(z14));
  oai21  g28(.a(new_n50_), .b(new_n37_), .c(new_n23_), .O(z15));
  zero   g29(.O(z00));
  zero   g30(.O(z02));
