...
module FAU ( 
  ...
  nand4  g24(.a(new_n25_), .b(new_n29_), .c(x1), .d(new_n42_), .O(new_n48_));
  ...
  oai21  g29(.a(new_n52_), .b(new_n30_), .c(new_n26_), .O(z14));
  nand4  g30(.a(new_n25_), .b(new_n29_), .c(new_n34_), .d(new_n42_), .O(new_n54_));
