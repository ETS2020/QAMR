...
module FAU ( 
  ...
  nand4  g03(.a(x3), .b(new_n22_), .c(x1), .d(x0), .O(new_n26_));
  ...
  aoi21  g15(.a(new_n39_), .b(new_n22_), .c(new_n23_), .O(z10));
  nand4  g16(.a(new_n28_), .b(new_n22_), .c(x1), .d(new_n38_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n23_), .O(z11));
  nand4  g18(.a(x3), .b(new_n22_), .c(new_n32_), .d(new_n38_), .O(new_n44_));
