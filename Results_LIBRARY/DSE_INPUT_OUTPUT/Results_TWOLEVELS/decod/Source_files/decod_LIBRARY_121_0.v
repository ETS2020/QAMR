...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n43_, new_n45_, new_n48_, new_n51_, new_n53_;
  ...
  aoi21  g24(.a(new_n45_), .b(x3), .c(x0), .O(z08));
  nand4  g25(.a(x3), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n28_), .O(z10));
  inv1   g27(.a(new_n24_), .O(z11));
  nand4  g28(.a(x3), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n28_), .O(z12));
  nand3  g30(.a(x4), .b(new_n31_), .c(new_n36_), .O(new_n53_));
  aoi21  g31(.a(new_n53_), .b(x3), .c(x0), .O(z14));
  zero   g32(.O(z09));
