...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n38_, new_n41_, new_n42_, new_n45_, new_n47_;
  ...
  oai21  g15(.a(new_n38_), .b(new_n23_), .c(new_n34_), .O(z08));
  oai21  g16(.a(new_n38_), .b(new_n26_), .c(new_n34_), .O(z09));
  inv1   g17(.a(x4), .O(new_n41_));
  nand4  g18(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n41_), .O(z10));
  oai21  g20(.a(new_n38_), .b(new_n31_), .c(new_n34_), .O(z11));
  nand4  g21(.a(x3), .b(x2), .c(new_n33_), .d(new_n22_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n41_), .O(z12));
  nand4  g23(.a(new_n25_), .b(x2), .c(new_n33_), .d(new_n22_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n41_), .O(z13));
