...
module FAU ( 
  ...
  nand2  g12(.a(new_n25_), .b(x1), .O(new_n34_));
  ...
  nand4  g25(.a(new_n31_), .b(x2), .c(x1), .d(new_n44_), .O(new_n47_));
  ...
  nand4  g29(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n44_), .O(new_n51_));
  ...
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n34_), .O(z13));
  nand3  g36(.a(x4), .b(x3), .c(new_n28_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n55_), .c(new_n34_), .O(z14));
