...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(new_n22_), .c(new_n41_), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(x1), .c(new_n30_), .O(z09));
  ...
  aoi21  g27(.a(new_n42_), .b(new_n30_), .c(x1), .O(z14));
  aoi21  g28(.a(new_n44_), .b(new_n30_), .c(x1), .O(z15));
  zero   g29(.O(z04));
  zero   g30(.O(z13));
