...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n31_), .c(new_n33_), .d(x0), .O(new_n39_));
  ...
  oai21  g23(.a(new_n44_), .b(new_n35_), .c(new_n32_), .O(z08));
  ...
  nand4  g28(.a(new_n22_), .b(new_n31_), .c(x1), .d(new_n43_), .O(new_n50_));
  ...
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n33_), .d(new_n43_), .O(new_n54_));
