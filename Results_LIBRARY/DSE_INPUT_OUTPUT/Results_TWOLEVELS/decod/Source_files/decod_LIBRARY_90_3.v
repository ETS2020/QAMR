...
module FAU ( 
  ...
  nand2  g16(.a(new_n24_), .b(x0), .O(new_n38_));
  nand3  g17(.a(x4), .b(new_n29_), .c(new_n25_), .O(new_n39_));
  ...
  nor2   g21(.a(new_n43_), .b(new_n28_), .O(z10));
  nand4  g22(.a(new_n29_), .b(new_n25_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n28_), .O(z11));
  nand3  g24(.a(x4), .b(x3), .c(new_n42_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g26(.a(new_n29_), .b(x2), .c(new_n24_), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z13));
  nand4  g28(.a(x3), .b(new_n25_), .c(new_n24_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n28_), .O(z14));
  nand2  g30(.a(new_n24_), .b(new_n42_), .O(new_n53_));
  oai21  g31(.a(new_n53_), .b(new_n39_), .c(new_n22_), .O(z15));
  zero   g32(.O(z09));
