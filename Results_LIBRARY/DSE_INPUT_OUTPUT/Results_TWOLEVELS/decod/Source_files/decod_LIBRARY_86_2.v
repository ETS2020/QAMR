...
module FAU ( 
  ...
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n32_), .O(z10));
  ...
  oai21  g36(.a(new_n57_), .b(new_n56_), .c(new_n36_), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n43_), .O(new_n59_));
