...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n30_), .d(new_n33_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g25(.a(x4), .b(new_n22_), .c(x2), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n30_), .c(x0), .O(z13));
  nand3  g27(.a(x4), .b(x3), .c(new_n27_), .O(new_n50_));
  aoi21  g28(.a(new_n50_), .b(new_n30_), .c(x0), .O(z14));
  aoi21  g29(.a(new_n31_), .b(new_n30_), .c(x0), .O(z15));
  zero   g30(.O(z10));
  inv1   g31(.a(new_n34_), .O(z09));
  inv1   g32(.a(new_n34_), .O(z11));
endmodule
