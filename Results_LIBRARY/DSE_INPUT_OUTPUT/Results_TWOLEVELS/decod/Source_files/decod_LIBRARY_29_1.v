...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n22_, new_n23_, new_n24_, new_n29_, new_n30_, new_n32_, new_n34_,
  ...
  nand3  g09(.a(new_n22_), .b(new_n29_), .c(x0), .O(new_n32_));
  aoi21  g10(.a(new_n32_), .b(x2), .c(new_n23_), .O(z05));
  ...
  nand4  g16(.a(x3), .b(x2), .c(new_n29_), .d(new_n34_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n23_), .O(z12));
  nand3  g18(.a(new_n22_), .b(new_n29_), .c(new_n34_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(x2), .c(new_n23_), .O(z13));
  zero   g20(.O(z03));
  zero   g21(.O(z10));
  zero   g22(.O(z14));
  nor2   g23(.a(new_n23_), .b(x2), .O(z06));
  nor2   g24(.a(new_n23_), .b(x2), .O(z07));
