...
module FAU ( 
  ...
  nand4  g25(.a(x3), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n28_), .O(z10));
  nand4  g27(.a(new_n33_), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n28_), .O(z11));
  nand3  g29(.a(x4), .b(x3), .c(new_n42_), .O(new_n52_));
  aoi21  g30(.a(new_n52_), .b(x2), .c(x1), .O(z12));
