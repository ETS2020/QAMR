...
module FAU ( 
  ...
  nand3  g28(.a(x4), .b(x3), .c(new_n31_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n49_), .c(new_n27_), .O(z10));
  nand4  g30(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n44_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n22_), .O(z11));
  nand3  g32(.a(x3), .b(x2), .c(new_n44_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x1), .O(z12));
  nand4  g34(.a(new_n28_), .b(x2), .c(new_n26_), .d(new_n44_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n22_), .O(z13));
  nand3  g36(.a(x3), .b(new_n31_), .c(new_n44_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(x4), .c(x1), .O(z14));
  nand3  g38(.a(new_n28_), .b(new_n31_), .c(new_n44_), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(x4), .c(x1), .O(z15));
endmodule
