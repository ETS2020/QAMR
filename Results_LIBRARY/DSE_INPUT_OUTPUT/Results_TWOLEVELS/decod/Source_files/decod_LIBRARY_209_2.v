...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n37_, new_n39_, new_n41_, new_n43_, new_n46_, new_n49_,
    new_n50_;
  ...
  nand4  g15(.a(new_n31_), .b(x2), .c(x1), .d(new_n22_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n25_), .O(z09));
  nand4  g17(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n25_), .O(z10));
  nand4  g19(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n25_), .O(z11));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand3  g22(.a(x4), .b(new_n31_), .c(x2), .O(new_n46_));
  aoi21  g23(.a(new_n46_), .b(new_n22_), .c(x1), .O(z13));
  aoi21  g24(.a(new_n29_), .b(new_n22_), .c(x1), .O(z14));
  inv1   g25(.a(x1), .O(new_n49_));
  nand4  g26(.a(new_n31_), .b(new_n28_), .c(new_n49_), .d(new_n22_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n25_), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z07));
  nor2   g30(.a(x1), .b(new_n22_), .O(z06));
endmodule
