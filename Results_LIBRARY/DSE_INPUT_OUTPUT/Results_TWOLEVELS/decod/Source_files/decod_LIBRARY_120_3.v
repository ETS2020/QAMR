...
module FAU ( 
  ...
  nand4  g09(.a(new_n22_), .b(x2), .c(new_n32_), .d(x0), .O(new_n33_));
  ...
  aoi21  g15(.a(new_n39_), .b(new_n22_), .c(new_n23_), .O(z09));
  ...
  nand4  g20(.a(new_n22_), .b(new_n28_), .c(new_n32_), .d(new_n38_), .O(new_n48_));
