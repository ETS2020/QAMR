...
module FAU ( 
  ...
  nand4  g09(.a(x3), .b(new_n22_), .c(new_n31_), .d(x0), .O(new_n32_));
  ...
  nand3  g16(.a(new_n28_), .b(x1), .c(new_n37_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n22_), .c(new_n23_), .O(z11));
  nand4  g18(.a(x3), .b(new_n22_), .c(new_n31_), .d(new_n37_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n23_), .O(z14));
  nand4  g20(.a(new_n28_), .b(new_n22_), .c(new_n31_), .d(new_n37_), .O(new_n45_));
