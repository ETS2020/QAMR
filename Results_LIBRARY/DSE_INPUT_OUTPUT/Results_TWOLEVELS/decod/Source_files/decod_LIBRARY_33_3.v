...
module FAU ( 
  ...
  aoi21  g22(.a(new_n45_), .b(new_n30_), .c(new_n27_), .O(z11));
  ...
  nand4  g26(.a(new_n31_), .b(x2), .c(new_n27_), .d(new_n30_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n26_), .O(z13));
  oai21  g28(.a(new_n47_), .b(new_n35_), .c(new_n22_), .O(z14));
