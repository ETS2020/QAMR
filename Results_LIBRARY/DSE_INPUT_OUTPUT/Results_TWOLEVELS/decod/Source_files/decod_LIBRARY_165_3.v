...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(x2), .c(new_n25_), .d(new_n40_), .O(new_n41_));
  nor2   g15(.a(new_n41_), .b(new_n26_), .O(z12));
  ...
  aoi21  g21(.a(new_n47_), .b(new_n25_), .c(new_n26_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z02));
  zero   g25(.O(z09));
  ...
  nor2   g28(.a(new_n26_), .b(new_n25_), .O(z10));
endmodule
