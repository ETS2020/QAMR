...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_,
    ...
    new_n45_, new_n48_, new_n50_, new_n51_, new_n53_, new_n55_;
  ...
  nand2  g26(.a(new_n22_), .b(new_n42_), .O(new_n50_));
  nand3  g27(.a(x4), .b(new_n35_), .c(x2), .O(new_n51_));
  oai21  g28(.a(new_n51_), .b(new_n50_), .c(new_n30_), .O(z13));
  nand4  g29(.a(x3), .b(new_n29_), .c(new_n22_), .d(new_n42_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n25_), .O(z14));
  nand4  g31(.a(new_n35_), .b(new_n29_), .c(new_n22_), .d(new_n42_), .O(new_n55_));
