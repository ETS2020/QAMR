...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n43_,
  ...
  nand4  g14(.a(x3), .b(new_n26_), .c(new_n29_), .d(x0), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n25_), .O(z06));
  nand2  g16(.a(new_n29_), .b(x0), .O(new_n39_));
  ...
  aoi21  g21(.a(new_n43_), .b(new_n26_), .c(new_n29_), .O(z10));
  nand4  g22(.a(new_n30_), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n25_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n29_), .d(new_n42_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z12));
  nand3  g26(.a(x4), .b(new_n30_), .c(new_n42_), .O(new_n49_));
  aoi21  g27(.a(new_n49_), .b(new_n29_), .c(new_n26_), .O(z13));
  nand4  g28(.a(x3), .b(new_n26_), .c(new_n29_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n25_), .O(z14));
  nand4  g30(.a(new_n30_), .b(new_n26_), .c(new_n29_), .d(new_n42_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n25_), .O(z15));
  zero   g32(.O(z01));
  inv1   g33(.a(new_n22_), .O(z08));
  inv1   g34(.a(new_n22_), .O(z09));
endmodule
