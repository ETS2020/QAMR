...
module FAU ( 
  ...
  inv1   g22(.a(new_n35_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n25_), .d(new_n34_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n22_), .O(z12));
  nand4  g25(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n34_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n22_), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n25_), .d(new_n34_), .O(new_n52_));
