...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(new_n30_), .c(new_n28_), .d(x0), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n23_), .O(z06));
  nand2  g16(.a(new_n28_), .b(x0), .O(new_n39_));
  nand3  g17(.a(x4), .b(new_n29_), .c(new_n30_), .O(new_n40_));
  oai21  g18(.a(new_n40_), .b(new_n39_), .c(new_n26_), .O(z07));
  inv1   g19(.a(x0), .O(new_n43_));
  nand4  g20(.a(new_n29_), .b(x2), .c(x1), .d(new_n43_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n23_), .O(z09));
  nand3  g22(.a(x4), .b(new_n30_), .c(new_n43_), .O(new_n46_));
  aoi21  g23(.a(new_n46_), .b(new_n29_), .c(new_n28_), .O(z11));
  nand3  g24(.a(x4), .b(x2), .c(new_n43_), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(new_n28_), .c(new_n29_), .O(z12));
  nand2  g26(.a(new_n28_), .b(new_n43_), .O(new_n50_));
  nand3  g27(.a(x4), .b(new_n29_), .c(x2), .O(new_n51_));
  oai21  g28(.a(new_n51_), .b(new_n50_), .c(new_n26_), .O(z13));
  aoi21  g29(.a(new_n46_), .b(new_n28_), .c(new_n29_), .O(z14));
  oai21  g30(.a(new_n50_), .b(new_n40_), .c(new_n26_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z08));
