...
module FAU ( 
  ...
  oai21  g20(.a(new_n41_), .b(new_n26_), .c(new_n24_), .O(z08));
  ...
  nor2   g24(.a(new_n45_), .b(new_n33_), .O(z10));
  nand3  g25(.a(x4), .b(new_n30_), .c(new_n40_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x1), .c(x3), .O(z11));
  aoi21  g27(.a(new_n43_), .b(x3), .c(x1), .O(z12));
  nand4  g28(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n40_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n33_), .O(z14));
