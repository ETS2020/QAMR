...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n33_, new_n35_, new_n38_, new_n40_, new_n42_, new_n43_,
  ...
  nor2   g12(.a(new_n33_), .b(new_n28_), .O(z04));
  nand3  g13(.a(x4), .b(new_n29_), .c(new_n32_), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(x3), .c(new_n22_), .O(z06));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n28_), .O(z08));
  nand4  g17(.a(new_n25_), .b(x2), .c(x1), .d(new_n22_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n28_), .O(z09));
  nand2  g19(.a(x1), .b(new_n22_), .O(new_n42_));
  nand3  g20(.a(x4), .b(x3), .c(new_n29_), .O(new_n43_));
  oai21  g21(.a(new_n43_), .b(new_n42_), .c(new_n26_), .O(z10));
  nand4  g22(.a(new_n25_), .b(new_n29_), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n28_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n22_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n28_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n32_), .d(new_n22_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z13));
  nand4  g28(.a(x3), .b(new_n29_), .c(new_n32_), .d(new_n22_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n28_), .O(z14));
  nand4  g30(.a(new_n25_), .b(new_n29_), .c(new_n32_), .d(new_n22_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n28_), .O(z15));
  zero   g32(.O(z07));
  inv1   g33(.a(new_n26_), .O(z03));
  inv1   g34(.a(new_n26_), .O(z05));
endmodule
