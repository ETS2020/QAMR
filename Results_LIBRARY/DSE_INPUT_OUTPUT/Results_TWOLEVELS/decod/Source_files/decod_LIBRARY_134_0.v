...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n34_, new_n35_, new_n39_, new_n40_, new_n41_, new_n43_, new_n45_,
  ...
  oai21  g23(.a(new_n45_), .b(new_n40_), .c(new_n35_), .O(z10));
  nand4  g24(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n39_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z11));
  nand3  g26(.a(x4), .b(x2), .c(new_n39_), .O(new_n49_));
  aoi21  g27(.a(new_n49_), .b(x3), .c(x1), .O(z12));
  nand4  g28(.a(x3), .b(new_n27_), .c(new_n34_), .d(new_n39_), .O(new_n51_));
