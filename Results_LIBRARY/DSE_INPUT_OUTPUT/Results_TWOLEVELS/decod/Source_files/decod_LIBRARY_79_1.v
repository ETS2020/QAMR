...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n47_, new_n48_,
    new_n50_, new_n52_;
  ...
  nand4  g18(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(x0), .O(new_n40_));
  ...
  nand4  g23(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n47_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n28_), .O(z13));
  nand4  g25(.a(x3), .b(new_n29_), .c(new_n22_), .d(new_n47_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n28_), .O(z14));
  nand3  g27(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n22_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
  zero   g31(.O(z10));
endmodule
