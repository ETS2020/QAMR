...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n34_, new_n36_, new_n39_, new_n42_, new_n43_,
  ...
  nand3  g17(.a(x4), .b(new_n30_), .c(x0), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x3), .c(x1), .O(z06));
  inv1   g19(.a(x0), .O(new_n42_));
  nand4  g20(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n33_), .O(z08));
  nand3  g22(.a(x4), .b(x2), .c(new_n42_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(x1), .c(x3), .O(z09));
  nand2  g24(.a(x1), .b(new_n42_), .O(new_n47_));
  oai21  g25(.a(new_n47_), .b(new_n31_), .c(new_n24_), .O(z10));
  nand4  g26(.a(new_n23_), .b(new_n30_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n33_), .O(z11));
  nand4  g28(.a(x3), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n33_), .O(z12));
  nand4  g30(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n42_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n33_), .O(z14));
  zero   g32(.O(z07));
  zero   g33(.O(z15));
