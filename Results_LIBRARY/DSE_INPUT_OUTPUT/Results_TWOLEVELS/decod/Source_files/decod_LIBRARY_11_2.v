...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n44_));
  oai21  g22(.a(new_n44_), .b(new_n40_), .c(new_n35_), .O(z11));
  ...
  aoi21  g28(.a(new_n50_), .b(new_n25_), .c(x1), .O(z14));
  aoi21  g29(.a(new_n44_), .b(new_n25_), .c(x1), .O(z15));
  zero   g30(.O(z07));
