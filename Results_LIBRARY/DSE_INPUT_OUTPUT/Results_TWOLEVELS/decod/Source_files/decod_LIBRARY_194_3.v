...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n34_), .c(x1), .d(new_n26_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n30_), .O(z10));
  nand4  g21(.a(new_n31_), .b(new_n34_), .c(x1), .d(new_n26_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n30_), .O(z11));
  nand2  g23(.a(new_n27_), .b(new_n26_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n28_), .c(new_n22_), .O(z12));
  nand3  g25(.a(x4), .b(new_n31_), .c(x2), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n47_), .c(new_n22_), .O(z13));
  nand4  g27(.a(x3), .b(new_n34_), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n30_), .O(z14));
  nand4  g29(.a(new_n31_), .b(new_n34_), .c(new_n27_), .d(new_n26_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n30_), .O(z15));
  zero   g31(.O(z02));
  zero   g32(.O(z03));
