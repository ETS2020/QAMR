...
module FAU ( 
  ...
  nand4  g15(.a(x3), .b(new_n25_), .c(new_n32_), .d(x0), .O(new_n37_));
  ...
  oai21  g26(.a(new_n45_), .b(new_n34_), .c(new_n33_), .O(z11));
  nand4  g27(.a(x3), .b(new_n25_), .c(new_n32_), .d(new_n40_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n22_), .O(z14));
  aoi21  g29(.a(new_n43_), .b(new_n25_), .c(x1), .O(z15));
  zero   g30(.O(z12));
