...
module FAU ( 
  ...
  wire new_n22_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n43_, new_n45_;
  ...
  oai21  g23(.a(new_n45_), .b(new_n32_), .c(new_n22_), .O(z13));
  oai21  g24(.a(new_n45_), .b(new_n35_), .c(new_n22_), .O(z14));
  oai21  g25(.a(new_n45_), .b(new_n37_), .c(new_n22_), .O(z15));
  zero   g26(.O(z02));
  zero   g27(.O(z03));
