...
module FAU ( 
  ...
  nor2   g22(.a(new_n44_), .b(new_n32_), .O(z10));
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n32_), .O(z12));
  nand4  g25(.a(new_n29_), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n32_), .O(z13));
  nand4  g27(.a(x3), .b(new_n26_), .c(new_n22_), .d(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n32_), .O(z14));
  nand4  g29(.a(new_n29_), .b(new_n26_), .c(new_n22_), .d(new_n41_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n32_), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z11));
