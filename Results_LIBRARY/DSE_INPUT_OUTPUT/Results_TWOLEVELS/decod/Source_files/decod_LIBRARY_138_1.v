...
module FAU ( 
  ...
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(new_n29_), .O(z09));
  nand4  g24(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z11));
  nand3  g26(.a(x4), .b(new_n33_), .c(new_n40_), .O(new_n49_));
  ...
  nand4  g30(.a(new_n22_), .b(new_n28_), .c(new_n33_), .d(new_n40_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n25_), .O(z15));
  zero   g32(.O(z10));
  inv1   g33(.a(new_n29_), .O(z06));
  inv1   g34(.a(new_n29_), .O(z14));
endmodule
