...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n44_,
    new_n46_, new_n49_;
  ...
  aoi21  g23(.a(new_n44_), .b(new_n27_), .c(x0), .O(z12));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n27_), .c(x0), .O(z13));
  aoi21  g26(.a(new_n29_), .b(new_n27_), .c(x0), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n28_), .c(new_n27_), .d(new_n40_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z15));
