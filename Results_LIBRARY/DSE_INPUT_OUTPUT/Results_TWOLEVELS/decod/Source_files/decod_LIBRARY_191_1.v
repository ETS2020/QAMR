...
module FAU ( 
  ...
  aoi21  g12(.a(new_n33_), .b(x0), .c(new_n27_), .O(z04));
  nand3  g13(.a(x4), .b(new_n22_), .c(new_n32_), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(x0), .c(new_n27_), .O(z05));
  ...
  nand3  g23(.a(x4), .b(x3), .c(x1), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(new_n27_), .c(x0), .O(z10));
  nand3  g25(.a(x4), .b(new_n22_), .c(x1), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n27_), .c(x0), .O(z11));
  nand4  g27(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n40_), .O(new_n51_));
