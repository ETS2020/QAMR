...
module FAU ( 
  ...
  aoi21  g14(.a(new_n40_), .b(new_n23_), .c(new_n24_), .O(z09));
  nand4  g15(.a(new_n23_), .b(new_n28_), .c(x1), .d(new_n39_), .O(new_n43_));
  nor2   g16(.a(new_n43_), .b(new_n24_), .O(z11));
  nor2   g17(.a(new_n24_), .b(new_n23_), .O(z12));
  nand3  g18(.a(x2), .b(new_n32_), .c(new_n39_), .O(new_n46_));
  aoi21  g19(.a(new_n46_), .b(new_n23_), .c(new_n24_), .O(z13));
