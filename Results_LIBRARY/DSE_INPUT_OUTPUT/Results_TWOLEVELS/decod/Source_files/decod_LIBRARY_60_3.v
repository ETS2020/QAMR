...
module FAU ( 
  ...
  nand4  g11(.a(new_n29_), .b(new_n32_), .c(new_n24_), .d(x0), .O(new_n35_));
  nor2   g12(.a(new_n35_), .b(new_n25_), .O(z07));
  inv1   g13(.a(x0), .O(new_n37_));
  nand3  g14(.a(x3), .b(x2), .c(new_n37_), .O(new_n38_));
  aoi21  g15(.a(new_n38_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g16(.a(new_n29_), .b(x2), .c(new_n24_), .d(new_n37_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n25_), .O(z13));
  nand3  g18(.a(x3), .b(new_n32_), .c(new_n37_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(new_n24_), .c(new_n25_), .O(z14));
  nand3  g20(.a(new_n29_), .b(new_n32_), .c(new_n37_), .O(new_n44_));
  aoi21  g21(.a(new_n44_), .b(new_n24_), .c(new_n25_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  nor2   g24(.a(new_n25_), .b(new_n24_), .O(z03));
  nor2   g25(.a(new_n25_), .b(new_n24_), .O(z08));
