...
module FAU ( 
  ...
  nor2   g15(.a(new_n37_), .b(new_n33_), .O(z05));
  inv1   g16(.a(new_n26_), .O(z06));
  nand4  g17(.a(new_n22_), .b(new_n30_), .c(new_n25_), .d(x0), .O(new_n40_));
  ...
  oai21  g23(.a(new_n45_), .b(new_n28_), .c(new_n26_), .O(z09));
  nand4  g24(.a(x3), .b(new_n30_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n33_), .O(z10));
  nand3  g26(.a(x4), .b(new_n22_), .c(new_n30_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n45_), .c(new_n26_), .O(z11));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n25_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n33_), .O(z13));
  nand4  g30(.a(new_n22_), .b(new_n30_), .c(new_n25_), .d(new_n42_), .O(new_n53_));
