...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n29_, new_n30_,
    new_n31_, new_n32_, new_n34_, new_n40_, new_n41_, new_n42_, new_n44_,
  ...
  oai21  g20(.a(new_n42_), .b(new_n41_), .c(new_n30_), .O(z08));
  nand3  g21(.a(x4), .b(x2), .c(new_n40_), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(x1), .c(x3), .O(z09));
  oai21  g23(.a(new_n41_), .b(new_n32_), .c(new_n30_), .O(z10));
  nand4  g24(.a(new_n29_), .b(new_n31_), .c(x1), .d(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n22_), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n28_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z12));
  nand3  g28(.a(x4), .b(new_n31_), .c(new_n40_), .O(new_n52_));
  aoi21  g29(.a(new_n52_), .b(x3), .c(x1), .O(z14));
  zero   g30(.O(z07));
  zero   g31(.O(z13));
