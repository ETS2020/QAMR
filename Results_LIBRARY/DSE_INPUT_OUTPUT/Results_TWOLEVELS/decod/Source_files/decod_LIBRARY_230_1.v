...
module FAU ( 
  ...
  nand3  g06(.a(x3), .b(new_n29_), .c(x0), .O(new_n30_));
  aoi21  g07(.a(new_n30_), .b(x2), .c(new_n22_), .O(z04));
  inv1   g08(.a(x3), .O(new_n32_));
  nand3  g09(.a(new_n32_), .b(new_n29_), .c(x0), .O(new_n33_));
  aoi21  g10(.a(new_n33_), .b(x2), .c(new_n22_), .O(z05));
  nor2   g11(.a(new_n22_), .b(x2), .O(z07));
