...
module FAU ( 
  ...
  nand4  g25(.a(new_n28_), .b(x2), .c(x1), .d(new_n26_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n22_), .O(z09));
  nand4  g27(.a(x3), .b(new_n31_), .c(x1), .d(new_n26_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n22_), .O(z10));
  nand4  g29(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n26_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n22_), .O(z11));
  nand4  g31(.a(x3), .b(x2), .c(new_n36_), .d(new_n26_), .O(new_n53_));
  ...
  nand4  g35(.a(x3), .b(new_n31_), .c(new_n36_), .d(new_n26_), .O(new_n57_));
