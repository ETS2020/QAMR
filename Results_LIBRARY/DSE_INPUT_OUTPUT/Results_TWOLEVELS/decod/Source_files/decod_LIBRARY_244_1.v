// Benchmark "FAU" written by ABC on Wed Aug 19 17:05:56 2020
...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n28_), .c(new_n22_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n25_), .O(z06));
  nand3  g21(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n36_), .c(new_n38_), .O(z07));
  inv1   g23(.a(new_n38_), .O(z08));
  nand4  g24(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z12));
  aoi21  g26(.a(new_n39_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n25_), .O(z14));
  aoi21  g29(.a(new_n43_), .b(new_n22_), .c(x0), .O(z15));
  zero   g30(.O(z09));
  zero   g31(.O(z10));
