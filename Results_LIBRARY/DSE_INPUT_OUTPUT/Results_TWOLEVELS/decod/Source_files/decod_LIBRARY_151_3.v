...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n43_,
  ...
  aoi21  g13(.a(new_n35_), .b(new_n29_), .c(new_n26_), .O(z05));
  nand4  g14(.a(x3), .b(new_n26_), .c(new_n34_), .d(x0), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n23_), .O(z06));
  nand2  g16(.a(new_n34_), .b(x0), .O(new_n39_));
  nand3  g17(.a(x4), .b(new_n29_), .c(new_n26_), .O(new_n40_));
  oai21  g18(.a(new_n40_), .b(new_n39_), .c(new_n32_), .O(z07));
  inv1   g19(.a(x0), .O(new_n42_));
  nand4  g20(.a(new_n29_), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n23_), .O(z09));
  nand4  g22(.a(x3), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z10));
  nand4  g24(.a(new_n29_), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n47_));
  ...
  nand4  g28(.a(x3), .b(new_n26_), .c(new_n34_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z14));
  nand2  g30(.a(new_n34_), .b(new_n42_), .O(new_n53_));
  oai21  g31(.a(new_n53_), .b(new_n40_), .c(new_n32_), .O(z15));
  zero   g32(.O(z00));
  inv1   g33(.a(new_n32_), .O(z08));
  inv1   g34(.a(new_n32_), .O(z12));
endmodule
