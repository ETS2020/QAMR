...
module FAU ( 
  ...
  aoi21  g10(.a(new_n27_), .b(new_n25_), .c(new_n26_), .O(z04));
  nand4  g11(.a(new_n30_), .b(x2), .c(new_n25_), .d(x0), .O(new_n34_));
  ...
  aoi21  g24(.a(new_n47_), .b(new_n25_), .c(new_n26_), .O(z12));
