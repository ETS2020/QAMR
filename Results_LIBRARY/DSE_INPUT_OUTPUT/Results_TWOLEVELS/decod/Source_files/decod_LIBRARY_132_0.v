...
module FAU ( 
  ...
  oai21  g19(.a(new_n37_), .b(new_n32_), .c(new_n24_), .O(z06));
  nand4  g20(.a(new_n28_), .b(new_n31_), .c(new_n36_), .d(x0), .O(new_n42_));
  ...
  nand4  g34(.a(x3), .b(new_n31_), .c(new_n36_), .d(new_n22_), .O(new_n56_));
