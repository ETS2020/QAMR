...
module FAU ( 
  ...
  nand2  g11(.a(new_n24_), .b(x0), .O(new_n33_));
  nand3  g12(.a(x4), .b(new_n25_), .c(x2), .O(new_n34_));
  oai21  g13(.a(new_n34_), .b(new_n33_), .c(new_n22_), .O(z05));
  nand3  g14(.a(x4), .b(new_n29_), .c(x0), .O(new_n36_));
  aoi21  g15(.a(new_n36_), .b(new_n24_), .c(new_n25_), .O(z06));
  nand3  g16(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n33_), .c(new_n22_), .O(z07));
  inv1   g18(.a(x0), .O(new_n40_));
  nand3  g19(.a(x4), .b(x2), .c(new_n40_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n25_), .c(new_n24_), .O(z09));
  nand3  g21(.a(x4), .b(new_n29_), .c(new_n40_), .O(new_n44_));
  aoi21  g22(.a(new_n44_), .b(new_n25_), .c(new_n24_), .O(z11));
  aoi21  g23(.a(new_n41_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand2  g24(.a(new_n24_), .b(new_n40_), .O(new_n47_));
  oai21  g25(.a(new_n47_), .b(new_n34_), .c(new_n22_), .O(z13));
  nand4  g26(.a(x3), .b(new_n29_), .c(new_n24_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z14));
  oai21  g28(.a(new_n47_), .b(new_n38_), .c(new_n22_), .O(z15));
  zero   g29(.O(z10));
