...
module FAU ( 
  ...
  oai21  g21(.a(new_n43_), .b(new_n42_), .c(new_n35_), .O(z10));
  ...
  nand4  g26(.a(x3), .b(new_n29_), .c(new_n34_), .d(new_n22_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z14));
  nand3  g28(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(new_n22_), .c(x1), .O(z15));
  zero   g30(.O(z05));
