...
module FAU ( 
  ...
  nand3  g31(.a(x3), .b(new_n34_), .c(new_n44_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(new_n27_), .O(z12));
  nand3  g33(.a(new_n22_), .b(new_n34_), .c(new_n44_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(new_n27_), .O(z13));
  nand2  g35(.a(new_n34_), .b(new_n44_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n40_), .c(new_n31_), .O(z14));
  oai21  g37(.a(new_n57_), .b(new_n32_), .c(new_n31_), .O(z15));
endmodule
