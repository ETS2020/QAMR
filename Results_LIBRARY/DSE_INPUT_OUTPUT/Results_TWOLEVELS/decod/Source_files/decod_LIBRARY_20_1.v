...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n45_, new_n46_,
  ...
  nand4  g18(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n25_), .O(z07));
  nor2   g20(.a(new_n22_), .b(x0), .O(z09));
  inv1   g21(.a(x0), .O(new_n45_));
  nand4  g22(.a(x3), .b(x2), .c(new_n22_), .d(new_n45_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n25_), .O(z12));
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n45_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n45_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n25_), .O(z14));
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n45_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n25_), .O(z15));
  zero   g30(.O(z08));
  zero   g31(.O(z10));
  nor2   g32(.a(new_n22_), .b(x0), .O(z11));
endmodule
