...
module FAU ( 
  ...
  nand3  g19(.a(x4), .b(new_n22_), .c(new_n29_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n39_), .c(new_n28_), .O(z07));
  ...
  oai21  g29(.a(new_n50_), .b(new_n41_), .c(new_n28_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n34_), .d(new_n43_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand3  g32(.a(new_n22_), .b(new_n34_), .c(new_n43_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(new_n29_), .O(z13));
  ...
  oai21  g37(.a(new_n58_), .b(new_n41_), .c(new_n28_), .O(z15));
endmodule
