...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n39_, new_n40_, new_n42_, new_n45_,
  ...
  aoi21  g13(.a(new_n34_), .b(new_n28_), .c(x3), .O(z05));
  nand4  g14(.a(x3), .b(new_n29_), .c(new_n28_), .d(x0), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n22_), .O(z06));
  aoi21  g16(.a(new_n30_), .b(new_n28_), .c(x3), .O(z07));
  inv1   g17(.a(x0), .O(new_n39_));
  nand4  g18(.a(x3), .b(x2), .c(x1), .d(new_n39_), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n22_), .O(z08));
  nand4  g20(.a(x3), .b(new_n29_), .c(x1), .d(new_n39_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n22_), .O(z10));
  nand2  g22(.a(new_n28_), .b(new_n39_), .O(new_n45_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n45_), .c(new_n26_), .O(z12));
  nand3  g25(.a(x4), .b(x2), .c(new_n39_), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n28_), .c(x3), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n28_), .d(new_n39_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n22_), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n29_), .c(new_n28_), .d(new_n39_), .O(new_n52_));
