...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n42_, new_n44_;
  ...
  aoi21  g10(.a(new_n31_), .b(new_n22_), .c(new_n23_), .O(z05));
  ...
  nand3  g18(.a(x2), .b(new_n30_), .c(new_n36_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand3  g20(.a(new_n27_), .b(new_n30_), .c(new_n36_), .O(new_n44_));
