...
module FAU ( 
  ...
  aoi21  g14(.a(new_n35_), .b(x1), .c(new_n22_), .O(z08));
  nand4  g15(.a(new_n25_), .b(x2), .c(x1), .d(new_n34_), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n22_), .O(z09));
  nand4  g17(.a(x3), .b(new_n28_), .c(x1), .d(new_n34_), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n22_), .O(z10));
  nand3  g19(.a(new_n25_), .b(new_n28_), .c(new_n34_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x1), .c(new_n22_), .O(z11));
  zero   g21(.O(z12));
  zero   g22(.O(z13));
  nor2   g23(.a(new_n22_), .b(x1), .O(z05));
