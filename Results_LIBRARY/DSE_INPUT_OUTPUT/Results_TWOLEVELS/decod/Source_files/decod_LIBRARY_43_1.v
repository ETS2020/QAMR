...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n36_, new_n37_, new_n38_, new_n40_, new_n45_,
    new_n47_, new_n49_;
  ...
  aoi21  g23(.a(new_n45_), .b(new_n25_), .c(x0), .O(z12));
  nand4  g24(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n37_), .O(new_n47_));
