...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n50_;
  ...
  nand4  g16(.a(new_n22_), .b(x2), .c(x1), .d(new_n27_), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n23_), .O(z09));
  nand2  g18(.a(x1), .b(new_n27_), .O(new_n41_));
  oai21  g19(.a(new_n41_), .b(new_n29_), .c(new_n34_), .O(z10));
  ...
  aoi21  g26(.a(new_n29_), .b(new_n27_), .c(x1), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n23_), .O(z15));
  zero   g29(.O(z06));
  inv1   g30(.a(new_n34_), .O(z05));
  inv1   g31(.a(new_n34_), .O(z07));
endmodule
