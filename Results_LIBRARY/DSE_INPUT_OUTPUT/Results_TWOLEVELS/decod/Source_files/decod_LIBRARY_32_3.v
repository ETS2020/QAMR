...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n35_, new_n38_, new_n39_, new_n42_, new_n44_, new_n47_;
  ...
  nand4  g09(.a(new_n27_), .b(x2), .c(new_n32_), .d(x0), .O(new_n33_));
  nor2   g10(.a(new_n33_), .b(new_n23_), .O(z05));
  nand4  g11(.a(new_n27_), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n35_));
  nor2   g12(.a(new_n35_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n38_));
  nand4  g14(.a(new_n27_), .b(x2), .c(x1), .d(new_n38_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n23_), .O(z09));
  nand3  g16(.a(new_n28_), .b(x1), .c(new_n38_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n27_), .c(new_n23_), .O(z11));
  ...
  aoi21  g21(.a(new_n47_), .b(new_n27_), .c(new_n23_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z02));
  zero   g24(.O(z08));
  zero   g25(.O(z10));
  zero   g26(.O(z14));
  nor2   g27(.a(new_n23_), .b(new_n27_), .O(z06));
  nor2   g28(.a(new_n23_), .b(new_n27_), .O(z12));
endmodule
