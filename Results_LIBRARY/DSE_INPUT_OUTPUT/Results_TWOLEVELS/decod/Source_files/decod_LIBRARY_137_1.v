...
module FAU ( 
  ...
  inv1   g23(.a(new_n40_), .O(z09));
  aoi21  g24(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand3  g25(.a(x4), .b(new_n31_), .c(x2), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(new_n22_), .c(x0), .O(z13));
