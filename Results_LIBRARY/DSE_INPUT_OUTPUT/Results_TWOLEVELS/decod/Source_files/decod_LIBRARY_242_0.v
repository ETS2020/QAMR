...
module FAU ( 
  ...
  nand3  g16(.a(x2), .b(new_n34_), .c(x0), .O(new_n38_));
  ...
  nand4  g35(.a(x3), .b(new_n29_), .c(new_n34_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n23_), .O(z14));
  nand3  g37(.a(new_n29_), .b(new_n34_), .c(new_n44_), .O(new_n59_));
