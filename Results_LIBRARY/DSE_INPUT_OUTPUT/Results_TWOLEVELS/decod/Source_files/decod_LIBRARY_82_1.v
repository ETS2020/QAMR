...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n48_, new_n49_;
  ...
  nor2   g19(.a(new_n40_), .b(new_n31_), .O(z07));
  ...
  inv1   g24(.a(x0), .O(new_n48_));
  nand4  g25(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n48_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n31_), .O(z15));
  zero   g27(.O(z10));
  zero   g28(.O(z11));
  nor2   g29(.a(new_n22_), .b(x0), .O(z09));
endmodule
