...
module FAU ( 
  ...
  nand4  g14(.a(new_n25_), .b(x2), .c(x1), .d(new_n37_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n22_), .O(z09));
  nand3  g16(.a(x3), .b(new_n28_), .c(new_n37_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x1), .c(new_n22_), .O(z10));
  nand3  g18(.a(new_n25_), .b(new_n28_), .c(new_n37_), .O(new_n44_));
