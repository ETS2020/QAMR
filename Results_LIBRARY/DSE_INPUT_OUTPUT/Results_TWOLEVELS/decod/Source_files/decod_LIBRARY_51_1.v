...
module FAU ( 
  ...
  nand4  g29(.a(x3), .b(new_n22_), .c(new_n31_), .d(new_n42_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n25_), .O(z14));
  nand4  g31(.a(new_n33_), .b(new_n22_), .c(new_n31_), .d(new_n42_), .O(new_n55_));
  nor2   g32(.a(new_n55_), .b(new_n25_), .O(z15));
  zero   g33(.O(z05));
  zero   g34(.O(z12));
  inv1   g35(.a(new_n32_), .O(z13));
endmodule
