...
module FAU ( 
  ...
  nand4  g13(.a(new_n29_), .b(new_n33_), .c(new_n26_), .d(x0), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n32_), .O(z07));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n25_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n32_), .O(z08));
  nand4  g17(.a(new_n29_), .b(x2), .c(x1), .d(new_n25_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n32_), .O(z09));
  nand4  g19(.a(x3), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n32_), .O(z10));
  nand4  g21(.a(new_n29_), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n32_), .O(z11));
  nand2  g23(.a(new_n26_), .b(new_n25_), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n27_), .c(new_n22_), .O(z12));
  oai21  g25(.a(new_n46_), .b(new_n30_), .c(new_n22_), .O(z13));
  nand4  g26(.a(x3), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n32_), .O(z14));
  nand4  g28(.a(new_n29_), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n51_));
