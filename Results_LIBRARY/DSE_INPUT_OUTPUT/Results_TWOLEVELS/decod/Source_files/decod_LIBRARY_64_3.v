...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n25_), .c(x1), .d(new_n40_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n24_), .O(z10));
  nand4  g21(.a(new_n28_), .b(new_n25_), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n24_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n31_), .d(new_n40_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n24_), .O(z12));
  nand4  g25(.a(new_n28_), .b(x2), .c(new_n31_), .d(new_n40_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n24_), .O(z13));
  nand2  g27(.a(new_n31_), .b(new_n40_), .O(new_n49_));
  nand3  g28(.a(x4), .b(x3), .c(new_n25_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n49_), .c(new_n22_), .O(z14));
  nand3  g30(.a(x4), .b(new_n28_), .c(new_n25_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n49_), .c(new_n22_), .O(z15));
