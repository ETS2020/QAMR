...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n31_), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n25_), .O(z13));
  nand3  g28(.a(x4), .b(x3), .c(new_n28_), .O(new_n52_));
  aoi21  g29(.a(new_n52_), .b(new_n22_), .c(x1), .O(z14));
  nand3  g30(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n54_));
  aoi21  g31(.a(new_n54_), .b(new_n22_), .c(x1), .O(z15));
  zero   g32(.O(z04));
  zero   g33(.O(z05));
