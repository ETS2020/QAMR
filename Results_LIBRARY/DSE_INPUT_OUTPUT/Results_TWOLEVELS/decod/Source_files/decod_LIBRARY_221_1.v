...
module FAU ( 
  ...
  nand4  g16(.a(new_n22_), .b(new_n30_), .c(new_n28_), .d(x0), .O(new_n38_));
  ...
  nand4  g27(.a(x3), .b(new_n30_), .c(new_n28_), .d(new_n40_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z14));
  nand4  g29(.a(new_n22_), .b(new_n30_), .c(new_n28_), .d(new_n40_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n23_), .O(z15));
  zero   g31(.O(z12));
  zero   g32(.O(z13));
  inv1   g33(.a(new_n29_), .O(z05));
endmodule
