...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(new_n33_), .c(x2), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n43_), .c(new_n24_), .O(z09));
  nand3  g23(.a(x4), .b(x3), .c(new_n42_), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(x1), .c(x2), .O(z10));
  nand4  g25(.a(new_n33_), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n28_), .O(z11));
  aoi21  g27(.a(new_n47_), .b(x2), .c(x1), .O(z12));
  nand4  g28(.a(new_n33_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n52_));
