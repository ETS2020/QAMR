...
module FAU ( 
  ...
  nand4  g11(.a(new_n28_), .b(new_n31_), .c(new_n22_), .d(x0), .O(new_n34_));
  ...
  nand4  g16(.a(new_n28_), .b(x2), .c(new_n22_), .d(new_n38_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n23_), .O(z13));
  nand4  g18(.a(x3), .b(new_n31_), .c(new_n22_), .d(new_n38_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n23_), .O(z14));
  nand4  g20(.a(new_n28_), .b(new_n31_), .c(new_n22_), .d(new_n38_), .O(new_n45_));
