...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n37_), .c(new_n24_), .O(z07));
  nand4  g22(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(z08));
  nand3  g24(.a(new_n28_), .b(x2), .c(x1), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(x0), .O(z09));
  ...
  nand4  g36(.a(new_n28_), .b(new_n31_), .c(new_n36_), .d(new_n22_), .O(new_n58_));
