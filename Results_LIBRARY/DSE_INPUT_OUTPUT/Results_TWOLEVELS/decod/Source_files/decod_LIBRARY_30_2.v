...
module FAU ( 
  ...
  nand3  g17(.a(new_n27_), .b(new_n34_), .c(x0), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x4), .c(new_n22_), .O(z06));
  nand2  g19(.a(new_n34_), .b(x0), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n32_), .c(new_n31_), .O(z07));
  ...
  nand2  g32(.a(new_n34_), .b(new_n43_), .O(new_n54_));
  nand3  g33(.a(x4), .b(new_n22_), .c(x2), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n31_), .O(z13));
  nand3  g35(.a(new_n27_), .b(new_n34_), .c(new_n43_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(x4), .c(new_n22_), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n27_), .c(new_n34_), .d(new_n43_), .O(new_n59_));
