...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n45_,
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n32_), .d(new_n37_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n23_), .O(z12));
  nand4  g25(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n37_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n23_), .O(z13));
  nand3  g27(.a(x4), .b(x3), .c(new_n27_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(new_n37_), .c(x1), .O(z14));
  nand4  g29(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n37_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n23_), .O(z15));
  zero   g31(.O(z06));
  zero   g32(.O(z07));
  inv1   g33(.a(new_n33_), .O(z05));
endmodule
