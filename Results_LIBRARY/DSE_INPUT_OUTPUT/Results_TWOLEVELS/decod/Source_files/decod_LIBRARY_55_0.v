...
module FAU ( 
  ...
  aoi21  g16(.a(new_n36_), .b(x3), .c(x2), .O(z06));
  inv1   g17(.a(x0), .O(new_n39_));
  nand2  g18(.a(x1), .b(new_n39_), .O(new_n40_));
  nand3  g19(.a(x4), .b(x3), .c(x2), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(new_n31_), .O(z08));
  nand4  g21(.a(new_n30_), .b(x2), .c(x1), .d(new_n39_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n22_), .O(z09));
  nand3  g23(.a(x4), .b(x1), .c(new_n39_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(x3), .c(x2), .O(z10));
  nand4  g25(.a(x3), .b(x2), .c(new_n33_), .d(new_n39_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n22_), .O(z12));
  nand4  g27(.a(new_n30_), .b(x2), .c(new_n33_), .d(new_n39_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n22_), .O(z13));
  nand4  g29(.a(x3), .b(new_n27_), .c(new_n33_), .d(new_n39_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n22_), .O(z14));
  zero   g31(.O(z15));
  inv1   g32(.a(new_n31_), .O(z07));
