...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n39_, new_n41_, new_n43_, new_n47_, new_n48_,
    new_n50_;
  ...
  nor2   g14(.a(new_n37_), .b(new_n28_), .O(z08));
  nand4  g15(.a(new_n25_), .b(x2), .c(x1), .d(new_n22_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n28_), .O(z09));
  nand4  g17(.a(x3), .b(new_n29_), .c(x1), .d(new_n22_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n28_), .O(z10));
  nand4  g19(.a(new_n25_), .b(new_n29_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n28_), .O(z11));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g22(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  inv1   g23(.a(x1), .O(new_n47_));
  nand4  g24(.a(x3), .b(new_n29_), .c(new_n47_), .d(new_n22_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n28_), .O(z14));
  nand4  g26(.a(new_n25_), .b(new_n29_), .c(new_n47_), .d(new_n22_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n28_), .O(z15));
  zero   g28(.O(z05));
  zero   g29(.O(z06));
  nor2   g30(.a(x1), .b(new_n22_), .O(z07));
endmodule
