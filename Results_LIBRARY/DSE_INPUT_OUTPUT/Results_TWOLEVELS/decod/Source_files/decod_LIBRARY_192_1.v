...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    ...
    new_n47_, new_n48_, new_n51_, new_n53_;
  ...
  nand3  g22(.a(x4), .b(new_n27_), .c(new_n40_), .O(new_n45_));
  ...
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n40_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z13));
  nand4  g29(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n40_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n23_), .O(z15));
  zero   g31(.O(z06));
  zero   g32(.O(z12));
  inv1   g33(.a(new_n33_), .O(z14));
endmodule
