...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(new_n22_), .c(new_n35_), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(x0), .c(new_n30_), .O(z05));
  ...
  inv1   g22(.a(new_n29_), .O(z08));
  nand4  g23(.a(x3), .b(new_n30_), .c(x1), .d(new_n28_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(z10));
  nand4  g25(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n28_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z11));
  nand3  g27(.a(x4), .b(x3), .c(new_n35_), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n30_), .c(x0), .O(z14));
  aoi21  g29(.a(new_n38_), .b(new_n30_), .c(x0), .O(z15));
  inv1   g30(.a(new_n29_), .O(z09));
