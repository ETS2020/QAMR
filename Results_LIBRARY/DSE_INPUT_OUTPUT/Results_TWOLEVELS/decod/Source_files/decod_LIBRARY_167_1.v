...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n50_;
  ...
  aoi21  g22(.a(new_n36_), .b(new_n30_), .c(x0), .O(z12));
  aoi21  g23(.a(new_n38_), .b(new_n30_), .c(x0), .O(z13));
  aoi21  g24(.a(new_n40_), .b(new_n30_), .c(x0), .O(z14));
  nand4  g25(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n33_), .O(new_n50_));
