...
module FAU ( 
  ...
  nand4  g20(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(x0), .O(new_n42_));
  ...
  nand4  g25(.a(x3), .b(new_n27_), .c(x1), .d(new_n31_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z10));
  aoi21  g27(.a(new_n34_), .b(x1), .c(x0), .O(z11));
  inv1   g28(.a(new_n33_), .O(z13));
  zero   g29(.O(z12));
  inv1   g30(.a(new_n33_), .O(z14));
  inv1   g31(.a(new_n33_), .O(z15));
endmodule
