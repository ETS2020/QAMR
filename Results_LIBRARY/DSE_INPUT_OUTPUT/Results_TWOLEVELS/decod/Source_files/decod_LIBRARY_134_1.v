...
module FAU ( 
  ...
  nand4  g25(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n40_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z11));
  aoi21  g27(.a(new_n41_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(new_n40_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z15));
  zero   g30(.O(z14));
  inv1   g31(.a(new_n32_), .O(z06));
