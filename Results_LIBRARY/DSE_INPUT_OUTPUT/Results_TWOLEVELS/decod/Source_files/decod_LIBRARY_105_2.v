...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n30_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n36_, new_n38_, new_n41_, new_n42_, new_n45_,
    new_n48_, new_n52_;
  ...
  nand4  g12(.a(new_n30_), .b(x2), .c(new_n22_), .d(x0), .O(new_n36_));
  nor2   g13(.a(new_n36_), .b(new_n35_), .O(z05));
  nand3  g14(.a(x4), .b(x3), .c(new_n26_), .O(new_n38_));
  oai21  g15(.a(new_n38_), .b(new_n32_), .c(new_n31_), .O(z06));
  ...
  inv1   g20(.a(new_n31_), .O(z09));
  nand3  g21(.a(x4), .b(new_n26_), .c(new_n41_), .O(new_n45_));
  ...
  aoi21  g25(.a(new_n42_), .b(new_n22_), .c(x3), .O(z13));
  oai21  g26(.a(new_n48_), .b(new_n38_), .c(new_n31_), .O(z14));
  nand4  g27(.a(new_n30_), .b(new_n26_), .c(new_n22_), .d(new_n41_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n35_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z03));
  zero   g31(.O(z11));
endmodule
