...
module FAU ( 
  ...
  nand4  g17(.a(new_n28_), .b(x2), .c(new_n23_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n34_), .O(z05));
  nand4  g19(.a(x3), .b(new_n31_), .c(new_n23_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n34_), .O(z06));
  nand3  g21(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(x0), .c(x1), .O(z07));
  aoi21  g23(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  nand4  g24(.a(new_n28_), .b(x2), .c(x1), .d(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n34_), .O(z09));
  nand4  g26(.a(x3), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n34_), .O(z10));
