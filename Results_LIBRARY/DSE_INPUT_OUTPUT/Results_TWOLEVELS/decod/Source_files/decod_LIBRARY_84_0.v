...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n39_, new_n42_,
  ...
  nand4  g20(.a(new_n28_), .b(new_n31_), .c(new_n23_), .d(x0), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n36_), .O(z07));
  aoi21  g22(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  nand4  g23(.a(new_n28_), .b(x2), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n36_), .O(z09));
  nand4  g25(.a(x3), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n36_), .O(z10));
  nand4  g27(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n36_), .O(z11));
