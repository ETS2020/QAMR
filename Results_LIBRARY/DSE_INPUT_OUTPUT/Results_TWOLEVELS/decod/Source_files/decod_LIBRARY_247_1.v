...
module FAU ( 
  ...
  inv1   g22(.a(new_n42_), .O(z08));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(new_n25_), .c(x0), .O(z12));
  nand4  g25(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n41_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n22_), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n25_), .d(new_n41_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n22_), .O(z14));
  aoi21  g29(.a(new_n32_), .b(new_n25_), .c(x0), .O(z15));
  zero   g30(.O(z10));
  inv1   g31(.a(new_n42_), .O(z09));
  inv1   g32(.a(new_n42_), .O(z11));
endmodule
