...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n22_, new_n23_, new_n25_, new_n29_, new_n30_, new_n32_, new_n34_,
  ...
  nand3  g09(.a(x4), .b(new_n29_), .c(x0), .O(new_n32_));
  aoi21  g10(.a(new_n32_), .b(x2), .c(x3), .O(z05));
  inv1   g11(.a(x2), .O(new_n34_));
  nand4  g12(.a(x3), .b(new_n34_), .c(new_n29_), .d(x0), .O(new_n35_));
  ...
  nand4  g23(.a(x3), .b(new_n34_), .c(x1), .d(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n22_), .O(z10));
  nand2  g25(.a(new_n29_), .b(new_n40_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n42_), .c(new_n38_), .O(z12));
  nand4  g27(.a(new_n37_), .b(x2), .c(new_n29_), .d(new_n40_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z13));
  nand4  g29(.a(x3), .b(new_n34_), .c(new_n29_), .d(new_n40_), .O(new_n53_));
