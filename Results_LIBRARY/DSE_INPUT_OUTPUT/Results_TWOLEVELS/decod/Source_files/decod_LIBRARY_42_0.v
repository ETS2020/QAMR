...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    new_n30_, new_n32_, new_n33_, new_n35_, new_n37_, new_n40_, new_n43_,
    new_n45_, new_n47_;
  ...
  nand4  g21(.a(x3), .b(x2), .c(x1), .d(new_n26_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n22_), .O(z08));
  nand4  g23(.a(new_n29_), .b(x2), .c(x1), .d(new_n26_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n22_), .O(z09));
  nand3  g25(.a(x4), .b(x3), .c(new_n32_), .O(new_n47_));
