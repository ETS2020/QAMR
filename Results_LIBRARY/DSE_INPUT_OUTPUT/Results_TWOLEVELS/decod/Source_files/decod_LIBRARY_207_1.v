...
module FAU ( 
  ...
  nand4  g18(.a(x3), .b(new_n27_), .c(new_n30_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n23_), .O(z06));
  oai21  g20(.a(new_n35_), .b(new_n31_), .c(new_n34_), .O(z07));
  inv1   g21(.a(new_n34_), .O(z10));
  nand4  g22(.a(x3), .b(x2), .c(new_n30_), .d(new_n33_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n23_), .O(z12));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n30_), .c(x0), .O(z13));
  nand4  g26(.a(x3), .b(new_n27_), .c(new_n30_), .d(new_n33_), .O(new_n51_));
