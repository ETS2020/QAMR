...
module FAU ( 
  ...
  aoi21  g21(.a(new_n45_), .b(new_n26_), .c(new_n29_), .O(z10));
  nand4  g22(.a(new_n30_), .b(new_n26_), .c(x1), .d(new_n44_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n25_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n29_), .d(new_n44_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n30_), .b(x2), .c(new_n29_), .d(new_n44_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n25_), .O(z13));
  nand4  g28(.a(x3), .b(new_n26_), .c(new_n29_), .d(new_n44_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n25_), .O(z14));
  nand4  g30(.a(new_n30_), .b(new_n26_), .c(new_n29_), .d(new_n44_), .O(new_n55_));
