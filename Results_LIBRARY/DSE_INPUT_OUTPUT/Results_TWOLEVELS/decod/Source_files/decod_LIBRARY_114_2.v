...
module FAU ( 
  ...
  oai21  g18(.a(new_n40_), .b(new_n38_), .c(new_n35_), .O(z09));
  oai21  g19(.a(new_n38_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand4  g20(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n43_));
  ...
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z13));
  aoi21  g26(.a(new_n29_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g27(.a(new_n31_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n50_));
