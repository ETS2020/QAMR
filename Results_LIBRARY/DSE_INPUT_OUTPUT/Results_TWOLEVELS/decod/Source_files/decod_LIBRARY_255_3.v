...
module FAU ( 
  ...
  wire new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
  ...
  nor2   g16(.a(new_n39_), .b(new_n36_), .O(z08));
  nand4  g17(.a(new_n30_), .b(x2), .c(x1), .d(new_n26_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n36_), .O(z09));
  nand4  g19(.a(x3), .b(new_n33_), .c(x1), .d(new_n26_), .O(new_n43_));
  ...
  nor2   g24(.a(new_n47_), .b(new_n36_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n36_), .O(z13));
  nand4  g27(.a(x3), .b(new_n33_), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n36_), .O(z14));
  nand2  g29(.a(new_n27_), .b(new_n26_), .O(new_n53_));
  oai21  g30(.a(new_n53_), .b(new_n45_), .c(new_n23_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z02));
