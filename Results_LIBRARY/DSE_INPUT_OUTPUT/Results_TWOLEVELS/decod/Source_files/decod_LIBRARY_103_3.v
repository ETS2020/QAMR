...
module FAU ( 
  ...
  aoi21  g18(.a(new_n41_), .b(new_n26_), .c(new_n27_), .O(z09));
  ...
  oai21  g28(.a(new_n51_), .b(new_n35_), .c(new_n22_), .O(z14));
  nand3  g29(.a(x4), .b(new_n31_), .c(new_n34_), .O(new_n53_));
  oai21  g30(.a(new_n53_), .b(new_n51_), .c(new_n22_), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z02));
