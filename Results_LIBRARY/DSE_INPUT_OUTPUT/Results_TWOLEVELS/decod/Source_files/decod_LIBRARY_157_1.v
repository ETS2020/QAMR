...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n22_), .d(new_n39_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z12));
  nand3  g26(.a(x4), .b(new_n31_), .c(x2), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g28(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n39_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n25_), .O(z14));
  aoi21  g30(.a(new_n32_), .b(new_n22_), .c(x0), .O(z15));
  zero   g31(.O(z08));
  zero   g32(.O(z11));
  inv1   g33(.a(new_n40_), .O(z10));
endmodule
