...
module FAU ( 
  ...
  nand4  g15(.a(new_n31_), .b(x2), .c(x1), .d(new_n36_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n28_), .c(new_n36_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(x2), .c(new_n22_), .O(z12));
  nand4  g19(.a(new_n31_), .b(x2), .c(new_n28_), .d(new_n36_), .O(new_n44_));
  ...
  nor2   g26(.a(new_n22_), .b(x2), .O(z11));
