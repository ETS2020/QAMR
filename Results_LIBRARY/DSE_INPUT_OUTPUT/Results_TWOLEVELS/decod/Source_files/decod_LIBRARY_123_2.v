...
module FAU ( 
  ...
  nand4  g21(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n25_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n25_), .O(z14));
  nand3  g29(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n22_), .c(x1), .O(z15));
