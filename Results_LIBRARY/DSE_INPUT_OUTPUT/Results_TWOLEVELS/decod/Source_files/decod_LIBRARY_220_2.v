...
module FAU ( 
  ...
  aoi21  g11(.a(new_n32_), .b(new_n29_), .c(x3), .O(z03));
  ...
  oai21  g16(.a(new_n38_), .b(new_n30_), .c(new_n26_), .O(z06));
  nand4  g17(.a(new_n25_), .b(new_n29_), .c(new_n34_), .d(x0), .O(new_n40_));
  ...
  oai21  g29(.a(new_n51_), .b(new_n30_), .c(new_n26_), .O(z14));
