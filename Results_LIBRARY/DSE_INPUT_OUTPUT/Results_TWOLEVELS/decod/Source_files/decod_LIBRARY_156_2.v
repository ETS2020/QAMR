...
module FAU ( 
  ...
  oai21  g18(.a(new_n41_), .b(new_n27_), .c(new_n37_), .O(z09));
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n22_), .O(z12));
  aoi21  g25(.a(new_n27_), .b(new_n25_), .c(x1), .O(z13));
  nand4  g26(.a(x3), .b(new_n29_), .c(new_n36_), .d(new_n25_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n22_), .O(z14));
  nand4  g28(.a(new_n26_), .b(new_n29_), .c(new_n36_), .d(new_n25_), .O(new_n52_));
