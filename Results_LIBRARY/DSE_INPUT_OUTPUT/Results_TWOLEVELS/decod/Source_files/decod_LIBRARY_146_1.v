...
module FAU ( 
  ...
  nand2  g27(.a(new_n31_), .b(new_n41_), .O(new_n50_));
  oai21  g28(.a(new_n50_), .b(new_n36_), .c(new_n34_), .O(z13));
  nand3  g29(.a(x4), .b(new_n31_), .c(new_n41_), .O(new_n52_));
  aoi21  g30(.a(new_n52_), .b(new_n22_), .c(x2), .O(z15));
  zero   g31(.O(z02));
  inv1   g32(.a(new_n34_), .O(z10));
  inv1   g33(.a(new_n34_), .O(z14));
endmodule
