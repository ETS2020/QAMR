...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n34_,
    new_n35_, new_n37_, new_n41_, new_n42_, new_n43_, new_n45_, new_n47_,
    new_n50_;
  ...
  oai21  g13(.a(new_n35_), .b(new_n34_), .c(new_n22_), .O(z06));
  nand3  g14(.a(x4), .b(new_n29_), .c(new_n26_), .O(new_n37_));
  oai21  g15(.a(new_n37_), .b(new_n34_), .c(new_n22_), .O(z07));
  inv1   g16(.a(x4), .O(new_n41_));
  inv1   g17(.a(x0), .O(new_n42_));
  nand4  g18(.a(x3), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n41_), .O(z10));
  nand3  g20(.a(x4), .b(new_n29_), .c(new_n42_), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n26_), .c(new_n25_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n25_), .d(new_n42_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n41_), .O(z12));
  aoi21  g24(.a(new_n45_), .b(new_n25_), .c(new_n26_), .O(z13));
  nand2  g25(.a(new_n25_), .b(new_n42_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n35_), .c(new_n22_), .O(z14));
  oai21  g27(.a(new_n50_), .b(new_n37_), .c(new_n22_), .O(z15));
  zero   g28(.O(z01));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
endmodule
