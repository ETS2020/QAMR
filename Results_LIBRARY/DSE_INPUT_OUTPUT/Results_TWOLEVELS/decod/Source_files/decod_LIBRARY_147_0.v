...
module FAU ( 
  ...
  oai21  g21(.a(new_n44_), .b(new_n43_), .c(new_n28_), .O(z08));
  nand4  g22(.a(new_n29_), .b(x2), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n22_), .O(z09));
  nand3  g24(.a(x4), .b(x3), .c(new_n42_), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(x1), .c(x2), .O(z10));
  nand3  g26(.a(x4), .b(new_n29_), .c(new_n42_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(x1), .c(x2), .O(z11));
  aoi21  g28(.a(new_n48_), .b(x2), .c(x1), .O(z12));
  aoi21  g29(.a(new_n50_), .b(x2), .c(x1), .O(z13));
  zero   g30(.O(z06));
  zero   g31(.O(z07));
  zero   g32(.O(z14));
  zero   g33(.O(z15));
