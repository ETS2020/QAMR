...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n28_), .d(new_n39_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n27_), .O(z12));
  nand2  g25(.a(new_n28_), .b(new_n39_), .O(new_n50_));
  nand3  g26(.a(x4), .b(new_n31_), .c(x2), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n25_), .O(z13));
  nand3  g28(.a(x4), .b(x3), .c(new_n34_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n50_), .c(new_n25_), .O(z14));
  oai21  g30(.a(new_n50_), .b(new_n46_), .c(new_n25_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z01));
  zero   g33(.O(z02));
endmodule
