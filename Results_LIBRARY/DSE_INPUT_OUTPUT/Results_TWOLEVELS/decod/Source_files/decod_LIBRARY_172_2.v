...
module FAU ( 
  ...
  aoi21  g17(.a(new_n38_), .b(new_n30_), .c(x2), .O(z07));
  ...
  aoi21  g27(.a(new_n41_), .b(new_n30_), .c(x2), .O(z14));
  aoi21  g28(.a(new_n43_), .b(new_n30_), .c(x2), .O(z15));
  zero   g29(.O(z10));
  inv1   g30(.a(new_n28_), .O(z03));
  inv1   g31(.a(new_n28_), .O(z11));
endmodule
