...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n34_, new_n37_, new_n38_, new_n40_, new_n42_, new_n45_;
  ...
  nand4  g11(.a(new_n22_), .b(new_n28_), .c(new_n31_), .d(x0), .O(new_n34_));
  ...
  nand3  g18(.a(x2), .b(new_n31_), .c(new_n37_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand4  g20(.a(new_n22_), .b(new_n28_), .c(new_n31_), .d(new_n37_), .O(new_n45_));
