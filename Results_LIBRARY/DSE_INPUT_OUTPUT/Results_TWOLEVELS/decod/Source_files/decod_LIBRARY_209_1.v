...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n37_, new_n38_, new_n39_, new_n42_,
    new_n51_;
  ...
  oai21  g19(.a(new_n36_), .b(new_n29_), .c(new_n38_), .O(z06));
  ...
  aoi21  g23(.a(new_n39_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g24(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  nand4  g25(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n25_), .O(z15));
  zero   g27(.O(z08));
  zero   g28(.O(z09));
  zero   g29(.O(z10));
  zero   g30(.O(z11));
