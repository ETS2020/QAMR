...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(x2), .c(new_n35_), .O(new_n38_));
  aoi21  g16(.a(new_n38_), .b(x1), .c(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n27_), .c(new_n35_), .O(new_n40_));
  aoi21  g18(.a(new_n40_), .b(x1), .c(new_n22_), .O(z10));
  nand4  g19(.a(new_n30_), .b(new_n27_), .c(x1), .d(new_n35_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n22_), .O(z11));
  zero   g21(.O(z04));
  zero   g22(.O(z12));
  zero   g23(.O(z13));
  zero   g24(.O(z15));
