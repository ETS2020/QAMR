...
module FAU ( 
  ...
  nor2   g23(.a(new_n45_), .b(new_n33_), .O(z09));
  nand4  g24(.a(x3), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n33_), .O(z10));
  nand4  g26(.a(new_n28_), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n33_), .O(z11));
  nand3  g28(.a(x4), .b(x3), .c(new_n42_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(x2), .c(x1), .O(z12));
  nand4  g30(.a(new_n28_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n33_), .O(z13));
  zero   g32(.O(z06));
  zero   g33(.O(z14));
