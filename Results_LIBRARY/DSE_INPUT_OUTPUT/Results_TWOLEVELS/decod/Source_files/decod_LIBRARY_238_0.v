...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n44_, new_n45_, new_n46_, new_n48_, new_n50_, new_n53_, new_n55_,
    new_n57_, new_n59_;
  ...
  nand4  g28(.a(x3), .b(new_n31_), .c(x1), .d(new_n44_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n22_), .O(z10));
  oai21  g30(.a(new_n45_), .b(new_n34_), .c(new_n27_), .O(z11));
