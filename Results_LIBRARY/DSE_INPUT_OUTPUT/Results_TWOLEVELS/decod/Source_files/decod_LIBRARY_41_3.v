...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n35_, new_n37_, new_n38_, new_n40_, new_n43_, new_n45_;
  ...
  nand4  g06(.a(new_n28_), .b(new_n23_), .c(x1), .d(x0), .O(new_n29_));
  ...
  nand4  g18(.a(x3), .b(new_n23_), .c(new_n32_), .d(new_n37_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n24_), .O(z14));
  nand3  g20(.a(new_n28_), .b(new_n32_), .c(new_n37_), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n23_), .c(new_n24_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z04));
  zero   g24(.O(z13));
  nor2   g25(.a(new_n24_), .b(new_n23_), .O(z05));
