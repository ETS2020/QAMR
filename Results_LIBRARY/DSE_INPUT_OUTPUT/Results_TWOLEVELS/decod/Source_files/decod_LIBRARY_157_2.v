...
module FAU ( 
  ...
  oai21  g21(.a(new_n45_), .b(new_n42_), .c(new_n37_), .O(z10));
  nand4  g22(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n25_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n25_), .O(z12));
  aoi21  g26(.a(new_n43_), .b(new_n22_), .c(x1), .O(z13));
