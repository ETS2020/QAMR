...
module FAU ( 
  ...
  nand4  g22(.a(new_n29_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  ...
  nand4  g28(.a(x3), .b(x2), .c(new_n26_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n22_), .O(z12));
  nand4  g30(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n42_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n22_), .O(z13));
  zero   g32(.O(z07));
  zero   g33(.O(z14));
  zero   g34(.O(z15));
endmodule
