...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n35_, new_n39_, new_n40_, new_n42_, new_n45_, new_n47_;
  ...
  nand4  g05(.a(new_n28_), .b(new_n24_), .c(x1), .d(x0), .O(new_n29_));
  ...
  aoi21  g17(.a(new_n42_), .b(new_n24_), .c(new_n25_), .O(z11));
  nand4  g18(.a(x3), .b(new_n24_), .c(new_n32_), .d(new_n39_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n25_), .O(z14));
  nand3  g20(.a(new_n28_), .b(new_n32_), .c(new_n39_), .O(new_n47_));
