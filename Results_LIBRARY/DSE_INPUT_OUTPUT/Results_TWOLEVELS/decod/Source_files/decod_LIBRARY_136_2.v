...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(new_n31_), .c(x2), .O(new_n42_));
  oai21  g17(.a(new_n42_), .b(new_n40_), .c(new_n39_), .O(z09));
  ...
  nand4  g23(.a(new_n31_), .b(x2), .c(new_n38_), .d(new_n22_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n25_), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n28_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g27(.a(new_n31_), .b(new_n28_), .c(new_n38_), .d(new_n22_), .O(new_n53_));
