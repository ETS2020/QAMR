...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n35_, new_n36_, new_n39_, new_n41_, new_n43_, new_n45_,
  ...
  nand4  g17(.a(new_n31_), .b(x2), .c(x1), .d(new_n22_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n25_), .O(z09));
  nand4  g19(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n25_), .O(z10));
  nand2  g21(.a(x1), .b(new_n22_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n32_), .c(new_n36_), .O(z11));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n35_), .d(new_n22_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n28_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n35_), .d(new_n22_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n25_), .O(z15));
  zero   g30(.O(z04));
  zero   g31(.O(z07));
  inv1   g32(.a(new_n36_), .O(z06));
endmodule
