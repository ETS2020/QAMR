...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n38_, new_n39_, new_n40_, new_n42_, new_n44_, new_n46_,
    new_n49_, new_n51_;
  ...
  nand4  g16(.a(new_n31_), .b(x2), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n25_), .O(z09));
  nand4  g18(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n25_), .O(z10));
  nand3  g20(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n40_), .c(new_n39_), .O(z11));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand3  g23(.a(x4), .b(new_n31_), .c(x2), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n22_), .c(x1), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n28_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n22_), .c(x1), .O(z14));
