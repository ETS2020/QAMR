...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(new_n30_), .c(x1), .d(new_n28_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z10));
  nand4  g26(.a(x3), .b(x2), .c(new_n35_), .d(new_n28_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z12));
  inv1   g28(.a(new_n29_), .O(z13));
  nand4  g29(.a(x3), .b(new_n30_), .c(new_n35_), .d(new_n28_), .O(new_n53_));
