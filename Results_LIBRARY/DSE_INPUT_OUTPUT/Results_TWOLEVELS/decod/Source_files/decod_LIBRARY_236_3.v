...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n34_, new_n36_, new_n39_, new_n41_, new_n44_, new_n46_,
    new_n48_, new_n50_;
  ...
  nand4  g16(.a(new_n29_), .b(x2), .c(x1), .d(new_n25_), .O(new_n39_));
  ...
  aoi21  g20(.a(new_n36_), .b(new_n25_), .c(new_n26_), .O(z11));
  ...
  oai21  g26(.a(new_n48_), .b(new_n41_), .c(new_n22_), .O(z14));
  nand4  g27(.a(new_n29_), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n50_));
