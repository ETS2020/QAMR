...
module FAU ( 
  ...
  aoi21  g17(.a(new_n33_), .b(x3), .c(x1), .O(z06));
  ...
  oai21  g24(.a(new_n46_), .b(new_n31_), .c(new_n24_), .O(z10));
  nand4  g25(.a(new_n23_), .b(new_n30_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n35_), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n35_), .O(z12));
  nand3  g29(.a(x4), .b(new_n30_), .c(new_n41_), .O(new_n53_));
