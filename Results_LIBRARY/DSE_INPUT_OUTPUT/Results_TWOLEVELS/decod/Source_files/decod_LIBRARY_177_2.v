...
module FAU ( 
  ...
  nand4  g18(.a(x3), .b(new_n25_), .c(new_n35_), .d(x0), .O(new_n40_));
  ...
  oai21  g29(.a(new_n50_), .b(new_n49_), .c(new_n32_), .O(z10));
  nand4  g30(.a(new_n26_), .b(new_n25_), .c(x1), .d(new_n44_), .O(new_n52_));
  ...
  nand4  g34(.a(new_n26_), .b(x2), .c(new_n35_), .d(new_n44_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n22_), .O(z13));
  nand2  g36(.a(new_n35_), .b(new_n44_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n50_), .c(new_n32_), .O(z14));
  nand4  g38(.a(new_n26_), .b(new_n25_), .c(new_n35_), .d(new_n44_), .O(new_n60_));
