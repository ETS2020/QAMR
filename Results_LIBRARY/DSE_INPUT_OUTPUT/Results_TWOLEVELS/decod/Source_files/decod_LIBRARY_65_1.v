...
module FAU ( 
  ...
  nand4  g17(.a(new_n25_), .b(new_n22_), .c(new_n28_), .d(x0), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n33_), .O(z07));
  ...
  oai21  g25(.a(new_n47_), .b(new_n31_), .c(new_n29_), .O(z10));
  nand4  g26(.a(new_n25_), .b(new_n22_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n33_), .O(z11));
  nand4  g28(.a(x3), .b(new_n22_), .c(new_n28_), .d(new_n42_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n33_), .O(z14));
