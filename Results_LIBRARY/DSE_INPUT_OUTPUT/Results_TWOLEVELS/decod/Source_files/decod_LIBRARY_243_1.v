...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    ...
    new_n45_, new_n47_, new_n49_, new_n50_, new_n53_, new_n56_;
  ...
  nand4  g16(.a(new_n22_), .b(new_n31_), .c(new_n25_), .d(x0), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n30_), .O(z07));
  ...
  nand4  g23(.a(x3), .b(new_n31_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n30_), .O(z10));
  nand2  g25(.a(x1), .b(new_n42_), .O(new_n49_));
  nand3  g26(.a(x4), .b(new_n22_), .c(new_n31_), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n49_), .c(new_n26_), .O(z11));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n25_), .d(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n30_), .O(z13));
  inv1   g30(.a(new_n26_), .O(z14));
  nand4  g31(.a(new_n22_), .b(new_n31_), .c(new_n25_), .d(new_n42_), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n30_), .O(z15));
  zero   g33(.O(z04));
  zero   g34(.O(z06));
  zero   g35(.O(z12));
endmodule
