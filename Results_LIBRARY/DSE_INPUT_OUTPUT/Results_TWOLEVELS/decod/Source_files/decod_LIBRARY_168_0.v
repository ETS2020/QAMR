...
module FAU ( 
  ...
  nand4  g20(.a(x3), .b(new_n30_), .c(new_n36_), .d(x0), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n23_), .O(z06));
  nand4  g22(.a(new_n33_), .b(new_n30_), .c(new_n36_), .d(x0), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n23_), .O(z07));
  nand3  g24(.a(x3), .b(x2), .c(x1), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(x0), .O(z08));
  nand3  g26(.a(new_n33_), .b(x2), .c(x1), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(x0), .O(z09));
  nand4  g28(.a(x3), .b(new_n30_), .c(x1), .d(new_n22_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z10));
  nand3  g30(.a(new_n33_), .b(new_n30_), .c(x1), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x0), .O(z11));
  nand3  g32(.a(x3), .b(x2), .c(new_n36_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x0), .O(z12));
  nand4  g34(.a(new_n33_), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z13));
  nand3  g36(.a(x3), .b(new_n30_), .c(new_n36_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(x4), .c(x0), .O(z14));
  nand4  g38(.a(new_n33_), .b(new_n30_), .c(new_n36_), .d(new_n22_), .O(new_n60_));
