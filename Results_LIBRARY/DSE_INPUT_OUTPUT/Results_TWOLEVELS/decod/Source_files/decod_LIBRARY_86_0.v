...
module FAU ( 
  ...
  nand3  g13(.a(new_n22_), .b(x2), .c(x0), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(x4), .c(x1), .O(z05));
  ...
  nand2  g25(.a(new_n23_), .b(new_n32_), .O(new_n47_));
  ...
  oai21  g29(.a(new_n50_), .b(new_n46_), .c(new_n47_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z13));
  nand3  g34(.a(x3), .b(new_n27_), .c(new_n41_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x4), .c(x1), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n58_));
