...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n39_, new_n41_, new_n43_, new_n44_,
    new_n46_, new_n50_;
  ...
  oai21  g21(.a(new_n44_), .b(new_n43_), .c(new_n35_), .O(z10));
  nand3  g22(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n43_), .c(new_n35_), .O(z11));
  aoi21  g24(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g25(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g26(.a(x3), .b(new_n29_), .c(new_n34_), .d(new_n22_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n28_), .O(z14));
