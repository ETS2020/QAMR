...
module FAU ( 
  ...
  oai21  g18(.a(new_n41_), .b(new_n39_), .c(new_n37_), .O(z09));
  nand4  g19(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n25_), .O(z10));
  nand3  g21(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n39_), .c(new_n37_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n47_));
  ...
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n52_));
