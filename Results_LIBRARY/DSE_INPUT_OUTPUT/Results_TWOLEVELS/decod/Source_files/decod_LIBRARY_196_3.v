...
module FAU ( 
  ...
  nand4  g07(.a(new_n29_), .b(x2), .c(new_n23_), .d(x0), .O(new_n30_));
  ...
  nand3  g16(.a(x4), .b(new_n29_), .c(x2), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(new_n22_), .c(new_n23_), .O(z09));
  nand4  g18(.a(x3), .b(new_n32_), .c(x1), .d(new_n22_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n28_), .O(z10));
  nand4  g20(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n28_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n23_), .d(new_n22_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n28_), .O(z12));
  nand4  g24(.a(new_n29_), .b(x2), .c(new_n23_), .d(new_n22_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n28_), .O(z13));
  nand4  g26(.a(x3), .b(new_n32_), .c(new_n23_), .d(new_n22_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z14));
  nand4  g28(.a(new_n29_), .b(new_n32_), .c(new_n23_), .d(new_n22_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n28_), .O(z15));
  zero   g30(.O(z01));
  nor2   g31(.a(new_n23_), .b(new_n22_), .O(z02));
  nor2   g32(.a(new_n23_), .b(new_n22_), .O(z03));
endmodule
