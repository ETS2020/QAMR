...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n34_, new_n36_, new_n38_, new_n40_, new_n42_, new_n43_, new_n46_,
  ...
  nand2  g16(.a(x3), .b(x1), .O(new_n40_));
  ...
  nand3  g21(.a(x4), .b(new_n27_), .c(new_n42_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n28_), .c(new_n31_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n31_), .d(new_n42_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n23_), .O(z12));
  nand2  g25(.a(new_n31_), .b(new_n42_), .O(new_n50_));
  nand3  g26(.a(x4), .b(new_n28_), .c(x2), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n40_), .O(z13));
  nand4  g28(.a(x3), .b(new_n27_), .c(new_n31_), .d(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n23_), .O(z14));
  nand3  g30(.a(x4), .b(new_n28_), .c(new_n27_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n50_), .c(new_n40_), .O(z15));
  zero   g32(.O(z00));
  zero   g33(.O(z02));
  zero   g34(.O(z10));
endmodule
