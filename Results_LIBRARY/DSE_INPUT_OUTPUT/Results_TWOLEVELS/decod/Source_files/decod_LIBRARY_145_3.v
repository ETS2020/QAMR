...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n35_, new_n37_, new_n38_, new_n40_, new_n43_, new_n46_;
  ...
  nand4  g16(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n37_), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n23_), .O(z11));
  nand4  g18(.a(new_n22_), .b(x2), .c(new_n31_), .d(new_n37_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n23_), .O(z13));
  nand3  g20(.a(new_n28_), .b(new_n31_), .c(new_n37_), .O(new_n46_));
