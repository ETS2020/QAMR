...
module FAU ( 
  ...
  nand3  g16(.a(new_n33_), .b(x2), .c(x0), .O(new_n38_));
  ...
  nand4  g29(.a(new_n33_), .b(new_n30_), .c(x1), .d(new_n44_), .O(new_n51_));
  ...
  nand4  g33(.a(new_n33_), .b(x2), .c(new_n22_), .d(new_n44_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n23_), .O(z13));
  nand4  g35(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n23_), .O(z14));
  nand4  g37(.a(new_n33_), .b(new_n30_), .c(new_n22_), .d(new_n44_), .O(new_n59_));
