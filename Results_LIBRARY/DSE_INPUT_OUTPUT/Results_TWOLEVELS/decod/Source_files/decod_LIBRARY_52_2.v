...
module FAU ( 
  ...
  oai21  g25(.a(new_n48_), .b(new_n34_), .c(new_n30_), .O(z12));
  aoi21  g26(.a(new_n43_), .b(new_n32_), .c(x3), .O(z13));
  nand4  g27(.a(x3), .b(new_n26_), .c(new_n32_), .d(new_n42_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z14));
  nand4  g29(.a(new_n29_), .b(new_n26_), .c(new_n32_), .d(new_n42_), .O(new_n53_));
