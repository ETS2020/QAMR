...
module FAU ( 
  ...
  nand2  g15(.a(new_n25_), .b(x1), .O(new_n37_));
  ...
  nand2  g35(.a(new_n22_), .b(new_n44_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n40_), .c(new_n37_), .O(z14));
  nand4  g37(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n44_), .O(new_n59_));
