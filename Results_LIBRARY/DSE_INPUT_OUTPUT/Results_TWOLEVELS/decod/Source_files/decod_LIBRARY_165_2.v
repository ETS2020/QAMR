...
module FAU ( 
  ...
  nand3  g09(.a(new_n22_), .b(new_n27_), .c(x0), .O(new_n31_));
  aoi21  g10(.a(new_n31_), .b(x4), .c(new_n30_), .O(z03));
  nand2  g11(.a(new_n23_), .b(x1), .O(new_n33_));
  nand2  g12(.a(new_n30_), .b(x0), .O(new_n34_));
  nand3  g13(.a(x4), .b(x3), .c(x2), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(z04));
  nand4  g15(.a(new_n22_), .b(x2), .c(new_n30_), .d(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n23_), .O(z05));
  nand3  g17(.a(x4), .b(x3), .c(new_n27_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n34_), .c(new_n33_), .O(z06));
  nand4  g19(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n23_), .O(z07));
  inv1   g21(.a(x0), .O(new_n43_));
  nand3  g22(.a(x3), .b(x2), .c(new_n43_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x4), .c(new_n30_), .O(z08));
  nand4  g24(.a(new_n22_), .b(x2), .c(x1), .d(new_n43_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z09));
  nand3  g26(.a(x3), .b(new_n27_), .c(new_n43_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n30_), .O(z10));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n43_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n30_), .d(new_n43_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand2  g32(.a(new_n30_), .b(new_n43_), .O(new_n54_));
  nand3  g33(.a(x4), .b(new_n22_), .c(x2), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n33_), .O(z13));
  nand4  g35(.a(x3), .b(new_n27_), .c(new_n30_), .d(new_n43_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n23_), .O(z14));
  nand3  g37(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n54_), .c(new_n33_), .O(z15));
endmodule
