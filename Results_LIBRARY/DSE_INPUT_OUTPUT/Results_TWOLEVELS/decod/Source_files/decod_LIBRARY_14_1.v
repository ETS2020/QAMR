...
module FAU ( 
  ...
  nand3  g22(.a(x4), .b(x2), .c(x1), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(new_n22_), .c(x0), .O(z09));
  inv1   g24(.a(new_n32_), .O(z10));
  aoi21  g25(.a(new_n28_), .b(new_n22_), .c(x0), .O(z11));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n31_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n23_), .O(z13));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(new_n35_), .d(new_n31_), .O(new_n52_));
