...
module FAU ( 
  ...
  nand2  g08(.a(new_n22_), .b(new_n27_), .O(new_n30_));
  ...
  aoi21  g24(.a(new_n46_), .b(x3), .c(x2), .O(z10));
  nand2  g25(.a(new_n32_), .b(new_n41_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n34_), .c(new_n30_), .O(z12));
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z13));
  nand3  g29(.a(x4), .b(new_n32_), .c(new_n41_), .O(new_n53_));
  aoi21  g30(.a(new_n53_), .b(x3), .c(x2), .O(z14));
  zero   g31(.O(z07));
  zero   g32(.O(z11));
  zero   g33(.O(z15));
endmodule
