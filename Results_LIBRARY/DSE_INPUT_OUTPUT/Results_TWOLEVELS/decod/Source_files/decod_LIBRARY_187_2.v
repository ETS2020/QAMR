...
module FAU ( 
  ...
  nand4  g24(.a(new_n25_), .b(new_n29_), .c(x1), .d(new_n42_), .O(new_n47_));
  ...
  nand4  g28(.a(x3), .b(new_n29_), .c(new_n34_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n22_), .O(z14));
  nand4  g30(.a(new_n25_), .b(new_n29_), .c(new_n34_), .d(new_n42_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n22_), .O(z15));
  zero   g32(.O(z05));
  inv1   g33(.a(new_n26_), .O(z09));
  inv1   g34(.a(new_n26_), .O(z13));
endmodule
