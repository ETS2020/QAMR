...
module FAU ( 
  ...
  wire new_n22_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n41_, new_n43_, new_n45_, new_n47_,
    new_n49_, new_n51_;
  ...
  aoi21  g16(.a(new_n31_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand3  g17(.a(x4), .b(x3), .c(new_n34_), .O(new_n41_));
  aoi21  g18(.a(new_n41_), .b(new_n26_), .c(new_n27_), .O(z10));
  nand4  g19(.a(new_n30_), .b(new_n34_), .c(x1), .d(new_n26_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n33_), .O(z11));
  nand4  g21(.a(x3), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n33_), .O(z12));
  nand4  g23(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n33_), .O(z13));
  nand2  g25(.a(new_n27_), .b(new_n26_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n41_), .c(new_n22_), .O(z14));
  nand4  g27(.a(new_n30_), .b(new_n34_), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n33_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z03));
