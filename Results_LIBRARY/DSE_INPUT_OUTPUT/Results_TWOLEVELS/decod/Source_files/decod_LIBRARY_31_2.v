...
module FAU ( 
  ...
  oai21  g13(.a(new_n34_), .b(new_n33_), .c(new_n28_), .O(z05));
  ...
  aoi21  g22(.a(new_n43_), .b(x2), .c(new_n30_), .O(z09));
  nand2  g23(.a(new_n30_), .b(new_n40_), .O(new_n47_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n48_));
  oai21  g25(.a(new_n48_), .b(new_n47_), .c(new_n28_), .O(z12));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n30_), .d(new_n40_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z13));
  aoi21  g28(.a(new_n41_), .b(new_n30_), .c(x2), .O(z14));
  aoi21  g29(.a(new_n43_), .b(new_n30_), .c(x2), .O(z15));
  zero   g30(.O(z10));
  zero   g31(.O(z11));
