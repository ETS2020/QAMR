...
module FAU ( 
  ...
  nand4  g25(.a(x3), .b(new_n22_), .c(x1), .d(new_n43_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z10));
  nand4  g27(.a(new_n28_), .b(new_n22_), .c(x1), .d(new_n43_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z11));
  nand2  g29(.a(new_n35_), .b(new_n43_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n26_), .c(new_n24_), .O(z12));
  nand4  g31(.a(new_n28_), .b(x2), .c(new_n35_), .d(new_n43_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n23_), .O(z13));
  nand3  g33(.a(x3), .b(new_n35_), .c(new_n43_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x2), .O(z14));
  nand4  g35(.a(new_n28_), .b(new_n22_), .c(new_n35_), .d(new_n43_), .O(new_n57_));
