...
module FAU ( 
  ...
  nand3  g22(.a(x4), .b(x2), .c(new_n41_), .O(new_n44_));
  ...
  nand4  g26(.a(new_n29_), .b(new_n31_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n22_), .O(z11));
  aoi21  g28(.a(new_n44_), .b(x3), .c(x1), .O(z12));
  nand4  g29(.a(x3), .b(new_n31_), .c(new_n28_), .d(new_n41_), .O(new_n51_));
