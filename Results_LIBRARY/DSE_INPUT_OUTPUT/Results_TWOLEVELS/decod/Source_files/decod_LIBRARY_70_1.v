...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n33_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n49_));
  ...
  nand4  g29(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n33_), .O(z15));
  zero   g31(.O(z10));
  zero   g32(.O(z11));
  inv1   g33(.a(new_n38_), .O(z09));
endmodule
