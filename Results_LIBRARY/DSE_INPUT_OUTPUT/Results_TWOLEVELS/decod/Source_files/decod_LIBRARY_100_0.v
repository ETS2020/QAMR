...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    new_n30_, new_n32_, new_n33_, new_n35_, new_n37_, new_n41_, new_n46_;
  ...
  aoi21  g16(.a(new_n37_), .b(x0), .c(x1), .O(z04));
  aoi21  g17(.a(new_n30_), .b(x0), .c(x1), .O(z05));
  aoi21  g18(.a(new_n33_), .b(x0), .c(x1), .O(z06));
  nand3  g19(.a(x4), .b(new_n29_), .c(new_n32_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x0), .c(x1), .O(z07));
  aoi21  g21(.a(new_n37_), .b(x1), .c(x0), .O(z08));
  aoi21  g22(.a(new_n30_), .b(x1), .c(x0), .O(z09));
  aoi21  g23(.a(new_n33_), .b(x1), .c(x0), .O(z10));
  nand4  g24(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n26_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n22_), .O(z11));
  inv1   g26(.a(new_n28_), .O(z12));
  inv1   g27(.a(new_n28_), .O(z13));
  inv1   g28(.a(new_n28_), .O(z14));
  inv1   g29(.a(new_n28_), .O(z15));
endmodule
