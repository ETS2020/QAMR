...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(new_n29_), .c(new_n22_), .d(new_n34_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n28_), .O(z14));
  nand4  g26(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(new_n34_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n28_), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z09));
  zero   g30(.O(z10));
  zero   g31(.O(z11));
