...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_,
  ...
  nand4  g16(.a(new_n32_), .b(x2), .c(x1), .d(new_n27_), .O(new_n41_));
  ...
  oai21  g22(.a(new_n46_), .b(new_n29_), .c(new_n23_), .O(z12));
  nand3  g23(.a(x4), .b(new_n32_), .c(x2), .O(new_n48_));
  oai21  g24(.a(new_n48_), .b(new_n46_), .c(new_n23_), .O(z13));
  oai21  g25(.a(new_n46_), .b(new_n36_), .c(new_n23_), .O(z14));
  oai21  g26(.a(new_n46_), .b(new_n38_), .c(new_n23_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z02));
  zero   g29(.O(z03));
endmodule
