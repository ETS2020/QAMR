...
module FAU ( 
  ...
  aoi21  g10(.a(new_n32_), .b(new_n26_), .c(new_n23_), .O(z05));
  nand3  g11(.a(new_n28_), .b(new_n31_), .c(x0), .O(new_n35_));
  aoi21  g12(.a(new_n35_), .b(new_n26_), .c(new_n23_), .O(z07));
  ...
  aoi21  g17(.a(new_n42_), .b(new_n26_), .c(new_n23_), .O(z11));
  nand4  g18(.a(new_n26_), .b(x2), .c(new_n31_), .d(new_n38_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n23_), .O(z13));
  nand3  g20(.a(new_n28_), .b(new_n31_), .c(new_n38_), .O(new_n47_));
  aoi21  g21(.a(new_n47_), .b(new_n26_), .c(new_n23_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z06));
  zero   g24(.O(z08));
  zero   g25(.O(z10));
  zero   g26(.O(z12));
  nor2   g27(.a(new_n23_), .b(new_n26_), .O(z04));
