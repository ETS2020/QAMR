...
module FAU ( 
  ...
  nand4  g29(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n44_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n25_), .O(z11));
  nand3  g31(.a(x2), .b(new_n33_), .c(new_n44_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(new_n22_), .O(z12));
  nand2  g33(.a(new_n33_), .b(new_n44_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n38_), .c(new_n36_), .O(z13));
  nand4  g35(.a(x3), .b(new_n28_), .c(new_n33_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n25_), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n28_), .c(new_n33_), .d(new_n44_), .O(new_n59_));
