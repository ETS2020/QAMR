...
module FAU ( 
  ...
  nand3  g22(.a(x4), .b(new_n29_), .c(new_n44_), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n26_), .c(new_n32_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n44_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n29_), .b(x2), .c(new_n32_), .d(new_n44_), .O(new_n51_));
  ...
  oai21  g30(.a(new_n53_), .b(new_n40_), .c(new_n22_), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z08));
  zero   g33(.O(z09));
endmodule
