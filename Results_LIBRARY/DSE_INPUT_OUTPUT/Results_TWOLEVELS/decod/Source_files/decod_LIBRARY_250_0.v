...
module FAU ( 
  ...
  nand3  g15(.a(x4), .b(x3), .c(new_n32_), .O(new_n37_));
  ...
  nor2   g24(.a(x2), .b(x0), .O(z10));
  nand4  g25(.a(x3), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z12));
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z13));
  nor2   g29(.a(x2), .b(x0), .O(z11));
  nor2   g30(.a(x2), .b(x0), .O(z14));
  nor2   g31(.a(x2), .b(x0), .O(z15));
endmodule
