...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n29_), .O(z10));
  aoi21  g21(.a(new_n36_), .b(new_n25_), .c(new_n26_), .O(z11));
  nand2  g22(.a(new_n26_), .b(new_n25_), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n27_), .c(new_n22_), .O(z12));
  nand3  g24(.a(x4), .b(new_n30_), .c(x2), .O(new_n47_));
  oai21  g25(.a(new_n47_), .b(new_n45_), .c(new_n22_), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n33_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n45_), .c(new_n22_), .O(z14));
  oai21  g28(.a(new_n45_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g29(.O(z01));
