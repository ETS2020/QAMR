...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n42_, new_n46_, new_n49_, new_n52_;
  ...
  nand3  g18(.a(x4), .b(new_n22_), .c(x2), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n39_), .c(new_n33_), .O(z05));
  nand3  g20(.a(x4), .b(new_n28_), .c(new_n36_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x0), .c(new_n22_), .O(z06));
  oai21  g22(.a(new_n39_), .b(new_n34_), .c(new_n33_), .O(z07));
  nand4  g23(.a(new_n22_), .b(x2), .c(x1), .d(new_n32_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z09));
  nand4  g25(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n32_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n25_), .O(z11));
  nand3  g27(.a(x4), .b(x2), .c(new_n36_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g29(.a(new_n42_), .b(new_n22_), .c(x0), .O(z15));
  zero   g30(.O(z08));
  zero   g31(.O(z10));
  zero   g32(.O(z12));
  zero   g33(.O(z14));
