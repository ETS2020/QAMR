...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n36_, new_n37_, new_n40_, new_n42_, new_n43_,
  ...
  nor2   g15(.a(new_n37_), .b(new_n36_), .O(z05));
  nand4  g16(.a(new_n22_), .b(new_n30_), .c(new_n25_), .d(x0), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n36_), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n36_), .O(z08));
  nand4  g21(.a(new_n22_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n36_), .O(z09));
  nand3  g23(.a(x4), .b(new_n30_), .c(new_n42_), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(x1), .c(new_n22_), .O(z10));
  nand4  g25(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n36_), .O(z11));
  inv1   g27(.a(new_n26_), .O(z12));
  nand3  g28(.a(x4), .b(x2), .c(new_n42_), .O(new_n52_));
  aoi21  g29(.a(new_n52_), .b(new_n22_), .c(x1), .O(z13));
