...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n30_, new_n32_,
    new_n34_, new_n35_, new_n36_, new_n39_, new_n42_, new_n43_, new_n45_,
  ...
  nand2  g11(.a(new_n27_), .b(x0), .O(new_n35_));
  nand3  g12(.a(x4), .b(new_n28_), .c(x2), .O(new_n36_));
  oai21  g13(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(z05));
  aoi21  g14(.a(new_n30_), .b(new_n27_), .c(new_n28_), .O(z06));
  nand4  g15(.a(new_n28_), .b(new_n29_), .c(new_n27_), .d(x0), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n23_), .O(z07));
  inv1   g17(.a(new_n34_), .O(z08));
  inv1   g18(.a(x0), .O(new_n42_));
  nand4  g19(.a(new_n28_), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n23_), .O(z09));
  nand4  g21(.a(new_n28_), .b(new_n29_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z11));
  nand3  g23(.a(x4), .b(x2), .c(new_n42_), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(new_n27_), .c(new_n28_), .O(z12));
  nand2  g25(.a(new_n27_), .b(new_n42_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n36_), .c(new_n34_), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n27_), .d(new_n42_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z14));
  nand4  g29(.a(new_n28_), .b(new_n29_), .c(new_n27_), .d(new_n42_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n23_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z02));
  inv1   g33(.a(new_n34_), .O(z10));
endmodule
