...
module FAU ( 
  ...
  nand4  g24(.a(new_n22_), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n27_), .d(new_n33_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z14));
  aoi21  g28(.a(new_n31_), .b(new_n27_), .c(x0), .O(z15));
  zero   g29(.O(z09));
  zero   g30(.O(z10));
