...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(new_n31_), .c(x2), .O(new_n38_));
  ...
  aoi21  g23(.a(new_n38_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g24(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n25_), .O(z14));
  nand4  g26(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n25_), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z09));
  zero   g30(.O(z10));
  zero   g31(.O(z11));
