// Benchmark "FAU" written by ABC on Wed Aug 19 17:05:41 2020
...
module FAU ( 
  ...
  nand4  g26(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n25_), .O(z11));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n25_), .O(z13));
  nand4  g30(.a(new_n22_), .b(new_n28_), .c(new_n32_), .d(new_n41_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n25_), .O(z15));
  inv1   g32(.a(new_n33_), .O(z06));
  inv1   g33(.a(new_n33_), .O(z12));
  inv1   g34(.a(new_n33_), .O(z14));
endmodule
