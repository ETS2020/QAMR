...
module FAU ( 
  ...
  aoi21  g22(.a(new_n46_), .b(new_n28_), .c(new_n27_), .O(z11));
  nand3  g23(.a(x4), .b(x2), .c(new_n42_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n27_), .c(new_n28_), .O(z12));
  nand2  g25(.a(new_n27_), .b(new_n42_), .O(new_n50_));
  nand3  g26(.a(x4), .b(new_n28_), .c(x2), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n40_), .O(z13));
  nand4  g28(.a(x3), .b(new_n29_), .c(new_n27_), .d(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n23_), .O(z14));
  nand4  g30(.a(new_n28_), .b(new_n29_), .c(new_n27_), .d(new_n42_), .O(new_n55_));
