...
module FAU ( 
  ...
  inv1   g22(.a(new_n33_), .O(z08));
  aoi21  g23(.a(new_n36_), .b(new_n34_), .c(x0), .O(z12));
  aoi21  g24(.a(new_n38_), .b(new_n34_), .c(x0), .O(z13));
  nand4  g25(.a(x3), .b(new_n27_), .c(new_n34_), .d(new_n32_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n23_), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n27_), .c(new_n34_), .d(new_n32_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z15));
  zero   g29(.O(z09));
  zero   g30(.O(z11));
  inv1   g31(.a(new_n33_), .O(z10));
endmodule
