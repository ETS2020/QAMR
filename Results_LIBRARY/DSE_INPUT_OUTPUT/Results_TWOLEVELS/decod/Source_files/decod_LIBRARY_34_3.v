...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n30_, new_n32_,
    ...
    new_n49_, new_n51_, new_n53_, new_n54_, new_n55_;
  ...
  nand4  g12(.a(x3), .b(new_n29_), .c(new_n27_), .d(x0), .O(new_n36_));
  nor2   g13(.a(new_n36_), .b(new_n23_), .O(z06));
  nand4  g14(.a(new_n28_), .b(new_n29_), .c(new_n27_), .d(x0), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n23_), .O(z07));
  inv1   g16(.a(x0), .O(new_n41_));
  nand4  g17(.a(new_n28_), .b(x2), .c(x1), .d(new_n41_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n23_), .O(z09));
  nand4  g19(.a(new_n28_), .b(new_n29_), .c(x1), .d(new_n41_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n23_), .O(z11));
  nand3  g21(.a(x4), .b(x2), .c(new_n41_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n27_), .c(new_n28_), .O(z12));
  nand4  g23(.a(new_n28_), .b(x2), .c(new_n27_), .d(new_n41_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n23_), .O(z13));
  nand3  g25(.a(x4), .b(new_n29_), .c(new_n41_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n27_), .c(new_n28_), .O(z14));
  nand2  g27(.a(new_n27_), .b(new_n41_), .O(new_n53_));
  nand2  g28(.a(x3), .b(x1), .O(new_n54_));
  nand3  g29(.a(x4), .b(new_n28_), .c(new_n29_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n54_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z02));
  zero   g33(.O(z08));
  zero   g34(.O(z10));
