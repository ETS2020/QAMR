...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n41_, new_n43_, new_n44_, new_n46_,
  ...
  nand4  g14(.a(x3), .b(x2), .c(x1), .d(new_n38_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n23_), .O(z08));
  nand4  g16(.a(new_n22_), .b(x2), .c(x1), .d(new_n38_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n23_), .O(z09));
  nand2  g18(.a(x1), .b(new_n38_), .O(new_n43_));
  nand3  g19(.a(x4), .b(x3), .c(new_n27_), .O(new_n44_));
  oai21  g20(.a(new_n44_), .b(new_n43_), .c(new_n33_), .O(z10));
  nand4  g21(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n38_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n23_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n32_), .d(new_n38_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n23_), .O(z12));
  nand3  g25(.a(x4), .b(new_n22_), .c(x2), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n38_), .c(x1), .O(z13));
  nand4  g27(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n38_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n23_), .O(z14));
  nand4  g29(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n38_), .O(new_n54_));
