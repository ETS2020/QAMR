...
module FAU ( 
  ...
  aoi21  g12(.a(new_n33_), .b(x4), .c(new_n22_), .O(z04));
  nand2  g13(.a(new_n23_), .b(x3), .O(new_n35_));
  nand2  g14(.a(new_n32_), .b(x0), .O(new_n36_));
  nand3  g15(.a(x4), .b(new_n22_), .c(x2), .O(new_n37_));
  oai21  g16(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(z05));
  nand4  g17(.a(x3), .b(new_n27_), .c(new_n32_), .d(x0), .O(new_n39_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n37_), .c(new_n35_), .O(z09));
  ...
  oai21  g29(.a(new_n50_), .b(new_n46_), .c(new_n35_), .O(z11));
  ...
  oai21  g37(.a(new_n58_), .b(new_n50_), .c(new_n35_), .O(z15));
endmodule
