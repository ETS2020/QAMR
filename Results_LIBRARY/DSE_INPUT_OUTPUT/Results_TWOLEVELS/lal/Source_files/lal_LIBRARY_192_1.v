...
module FAU ( 
  ...
  nand4  g022(.a(new_n67_), .b(new_n63_), .c(new_n49_), .d(new_n51_), .O(z01));
  inv1   g023(.a(x16), .O(new_n69_));
  nor2   g024(.a(new_n48_), .b(new_n69_), .O(z02));
  nand2  g025(.a(new_n63_), .b(new_n49_), .O(z03));
  aoi21  g026(.a(x12), .b(new_n46_), .c(x15), .O(new_n72_));
  ...
  oai21  g041(.a(new_n72_), .b(x03), .c(new_n86_), .O(z04));
  ...
  oai21  g048(.a(new_n93_), .b(new_n57_), .c(new_n53_), .O(new_n94_));
  ...
  nand3  g053(.a(new_n59_), .b(x19), .c(x18), .O(new_n99_));
  ...
  nand4  g060(.a(new_n105_), .b(new_n100_), .c(new_n52_), .d(new_n60_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(x25), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n95_), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  inv1   g064(.a(x23), .O(new_n110_));
  nand3  g065(.a(new_n58_), .b(x22), .c(x21), .O(new_n111_));
  aoi21  g066(.a(new_n111_), .b(new_n110_), .c(new_n52_), .O(new_n112_));
  oai21  g067(.a(new_n112_), .b(x25), .c(x03), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n109_), .O(z08));
  nand3  g069(.a(new_n66_), .b(new_n47_), .c(new_n51_), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(new_n49_), .O(z09));
  nand4  g071(.a(new_n67_), .b(new_n92_), .c(new_n47_), .d(new_n51_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(z10));
  xor2a  g073(.a(x18), .b(x17), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n67_), .c(new_n47_), .d(new_n51_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n49_), .O(z11));
  nand3  g076(.a(new_n56_), .b(x18), .c(x17), .O(new_n122_));
  oai21  g077(.a(new_n101_), .b(new_n56_), .c(new_n122_), .O(new_n123_));
  nand4  g078(.a(new_n123_), .b(new_n67_), .c(new_n47_), .d(new_n51_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n49_), .O(z12));
  nand2  g080(.a(new_n102_), .b(new_n101_), .O(new_n126_));
  nand3  g081(.a(x19), .b(x18), .c(x17), .O(new_n127_));
  nand2  g082(.a(new_n127_), .b(x20), .O(new_n128_));
  nand3  g083(.a(new_n51_), .b(x05), .c(x04), .O(new_n129_));
  nand4  g084(.a(new_n129_), .b(new_n128_), .c(new_n126_), .d(new_n51_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g086(.a(x15), .b(x03), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n131_), .O(z13));
  nand2  g088(.a(new_n129_), .b(new_n51_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n126_), .b(x21), .O(new_n136_));
  nor2   g091(.a(x21), .b(x20), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n101_), .c(x19), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n136_), .c(new_n135_), .d(new_n47_), .O(z14));
  nand2  g094(.a(new_n138_), .b(x22), .O(new_n140_));
  inv1   g095(.a(new_n127_), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n103_), .c(new_n54_), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(new_n140_), .c(new_n135_), .d(new_n47_), .O(z15));
  nand2  g098(.a(new_n142_), .b(x23), .O(new_n144_));
  nand4  g099(.a(new_n137_), .b(new_n141_), .c(new_n110_), .d(new_n60_), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n135_), .d(new_n47_), .O(z16));
  nand3  g101(.a(new_n104_), .b(new_n60_), .c(new_n59_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(x20), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(x19), .c(x18), .d(x17), .O(new_n149_));
  aoi21  g104(.a(new_n145_), .b(x24), .c(new_n134_), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n47_), .O(new_n152_));
  nand2  g107(.a(new_n152_), .b(new_n132_), .O(z17));
  nand2  g108(.a(new_n105_), .b(x25), .O(new_n154_));
  nor3   g109(.a(x25), .b(x24), .c(x23), .O(new_n155_));
  nand4  g110(.a(new_n155_), .b(new_n103_), .c(new_n102_), .d(new_n101_), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n154_), .c(new_n129_), .d(new_n51_), .O(new_n157_));
  nand2  g112(.a(new_n157_), .b(new_n47_), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(new_n132_), .O(z18));
endmodule
