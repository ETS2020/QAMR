...
module FAU ( 
  ...
  oai21  g070(.a(new_n94_), .b(new_n57_), .c(new_n115_), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n109_), .c(new_n50_), .d(new_n47_), .O(new_n117_));
  ...
  nand4  g080(.a(new_n94_), .b(new_n91_), .c(new_n55_), .d(x19), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  aoi21  g082(.a(new_n119_), .b(x21), .c(new_n127_), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(x07), .c(new_n50_), .O(z14));
  inv1   g084(.a(new_n120_), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n96_), .c(new_n55_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n122_), .O(new_n132_));
  aoi21  g087(.a(new_n126_), .b(x22), .c(new_n132_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(x07), .c(new_n50_), .O(z15));
  and2   g089(.a(new_n131_), .b(x23), .O(new_n135_));
  nand4  g090(.a(new_n54_), .b(new_n89_), .c(new_n91_), .d(new_n55_), .O(new_n136_));
  ...
  oai21  g105(.a(new_n150_), .b(x07), .c(new_n50_), .O(z18));
endmodule
