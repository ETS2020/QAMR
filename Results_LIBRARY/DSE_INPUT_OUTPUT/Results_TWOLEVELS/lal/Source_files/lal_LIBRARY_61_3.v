...
module FAU ( 
  ...
  oai21  g003(.a(x15), .b(x07), .c(x08), .O(new_n49_));
  nand3  g004(.a(new_n49_), .b(x05), .c(x04), .O(new_n50_));
  nor2   g005(.a(new_n47_), .b(new_n46_), .O(new_n51_));
  ...
  nand4  g050(.a(new_n95_), .b(new_n90_), .c(new_n87_), .d(new_n86_), .O(new_n96_));
  aoi21  g051(.a(new_n96_), .b(x25), .c(new_n51_), .O(new_n97_));
  nand4  g052(.a(new_n97_), .b(new_n85_), .c(new_n84_), .d(new_n82_), .O(z08));
  inv1   g053(.a(x07), .O(new_n99_));
  nand4  g054(.a(new_n47_), .b(new_n99_), .c(x05), .d(x04), .O(new_n100_));
  inv1   g055(.a(new_n100_), .O(z09));
  nand2  g056(.a(x05), .b(x04), .O(new_n102_));
  nand4  g057(.a(new_n102_), .b(new_n54_), .c(new_n47_), .d(new_n99_), .O(new_n103_));
  inv1   g058(.a(new_n103_), .O(z10));
  xor2a  g059(.a(x18), .b(x17), .O(new_n105_));
  nand4  g060(.a(new_n105_), .b(new_n102_), .c(new_n47_), .d(new_n99_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z11));
  nand3  g062(.a(new_n56_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g063(.a(new_n91_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n102_), .c(new_n47_), .d(new_n99_), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z12));
  nand2  g066(.a(new_n92_), .b(new_n91_), .O(new_n112_));
  nand3  g067(.a(new_n99_), .b(x05), .c(x04), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n99_), .O(new_n114_));
  ...
  nand4  g072(.a(new_n117_), .b(new_n115_), .c(new_n112_), .d(new_n47_), .O(z13));
  inv1   g073(.a(new_n112_), .O(new_n119_));
  nor2   g074(.a(new_n119_), .b(new_n88_), .O(new_n120_));
  nor2   g075(.a(x21), .b(x20), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n91_), .c(x19), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n113_), .c(new_n99_), .O(new_n123_));
  oai21  g078(.a(new_n123_), .b(new_n120_), .c(new_n47_), .O(new_n124_));
  nand2  g079(.a(x15), .b(new_n46_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n124_), .O(z14));
  inv1   g081(.a(new_n116_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n93_), .c(new_n53_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n113_), .c(new_n99_), .O(new_n129_));
  ...
  nand3  g088(.a(new_n133_), .b(new_n121_), .c(new_n127_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n113_), .c(new_n99_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n132_), .c(new_n47_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n125_), .O(z16));
  nand3  g092(.a(new_n94_), .b(new_n86_), .c(new_n88_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n115_), .d(new_n47_), .O(z17));
  ...
  nand4  g100(.a(new_n145_), .b(new_n143_), .c(new_n115_), .d(new_n47_), .O(z18));
endmodule
