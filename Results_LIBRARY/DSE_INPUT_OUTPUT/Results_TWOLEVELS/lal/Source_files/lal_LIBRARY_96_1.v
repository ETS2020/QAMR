...
module FAU ( 
  ...
  nand4  g47(.a(new_n92_), .b(new_n89_), .c(new_n47_), .d(new_n51_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z11));
  aoi21  g49(.a(new_n55_), .b(new_n47_), .c(new_n54_), .O(new_n95_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n87_), .d(new_n51_), .O(z14));
  inv1   g62(.a(z09), .O(new_n108_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n61_), .O(new_n127_));
  ...
  nand3  g86(.a(new_n131_), .b(new_n110_), .c(new_n124_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n108_), .d(new_n51_), .O(z18));
endmodule
