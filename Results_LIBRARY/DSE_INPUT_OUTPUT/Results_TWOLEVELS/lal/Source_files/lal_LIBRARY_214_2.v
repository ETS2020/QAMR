...
module FAU ( 
  ...
  nand4  g42(.a(new_n62_), .b(new_n54_), .c(new_n85_), .d(new_n47_), .O(new_n88_));
  ...
  nand2  g51(.a(new_n96_), .b(new_n62_), .O(new_n97_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n99_), .d(new_n85_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n99_), .d(new_n85_), .O(z14));
  nand2  g62(.a(new_n106_), .b(x22), .O(new_n108_));
  nand3  g63(.a(new_n85_), .b(x05), .c(x04), .O(new_n109_));
  inv1   g64(.a(new_n100_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n85_), .O(z15));
  inv1   g70(.a(x23), .O(new_n116_));
  aoi21  g71(.a(new_n111_), .b(new_n110_), .c(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n105_), .b(new_n116_), .c(new_n80_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n100_), .c(new_n109_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n117_), .c(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n85_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n100_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x20), .b(new_n56_), .O(new_n123_));
  nor2   g78(.a(x22), .b(x21), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n94_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n122_), .c(new_n109_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n85_), .O(z17));
  nand2  g84(.a(new_n125_), .b(new_n124_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n102_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n124_), .c(new_n123_), .d(new_n94_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n131_), .c(new_n109_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n85_), .O(z18));
endmodule
