...
module FAU ( 
  ...
  aoi21  g023(.a(new_n46_), .b(x01), .c(x15), .O(new_n69_));
  ...
  nand4  g061(.a(new_n106_), .b(new_n55_), .c(new_n47_), .d(new_n103_), .O(new_n107_));
  nand2  g062(.a(new_n107_), .b(new_n66_), .O(z10));
  ...
  nand2  g069(.a(new_n114_), .b(new_n66_), .O(z12));
  ...
  nand2  g076(.a(x15), .b(x10), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n121_), .O(z13));
  inv1   g078(.a(new_n116_), .O(new_n124_));
  nor2   g079(.a(new_n124_), .b(new_n92_), .O(new_n125_));
  nor2   g080(.a(x21), .b(x20), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n95_), .c(x19), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n119_), .c(new_n103_), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(new_n125_), .c(new_n47_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n122_), .O(z14));
  inv1   g085(.a(new_n117_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n97_), .c(new_n54_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n119_), .c(new_n103_), .O(new_n133_));
  aoi21  g088(.a(new_n127_), .b(x22), .c(new_n133_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(x15), .c(new_n122_), .O(z15));
  nand2  g090(.a(new_n119_), .b(new_n103_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g092(.a(new_n132_), .b(x23), .O(new_n138_));
  nor2   g093(.a(x23), .b(x22), .O(new_n139_));
  nand3  g094(.a(new_n139_), .b(new_n126_), .c(new_n131_), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n138_), .c(new_n137_), .d(new_n47_), .O(z16));
  nand3  g096(.a(new_n98_), .b(new_n90_), .c(new_n92_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(x20), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(x19), .c(x18), .d(x17), .O(new_n144_));
  nand2  g099(.a(new_n140_), .b(x24), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n137_), .d(new_n47_), .O(z17));
  nand2  g101(.a(new_n99_), .b(x25), .O(new_n147_));
  nor3   g102(.a(x25), .b(x24), .c(x23), .O(new_n148_));
  nand3  g103(.a(new_n148_), .b(new_n97_), .c(new_n124_), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n147_), .c(new_n137_), .d(new_n47_), .O(z18));
endmodule
