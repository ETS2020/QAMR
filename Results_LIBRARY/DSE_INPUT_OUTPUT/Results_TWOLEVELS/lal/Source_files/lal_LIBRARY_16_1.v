...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n88_), .c(new_n47_), .d(new_n50_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n88_), .c(new_n47_), .d(new_n50_), .O(new_n97_));
  ...
  nand2  g59(.a(new_n104_), .b(new_n50_), .O(z13));
  inv1   g60(.a(z09), .O(new_n106_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n50_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n106_), .d(new_n50_), .O(z15));
  ...
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .d(new_n50_), .O(z16));
  ...
  oai21  g78(.a(new_n123_), .b(x15), .c(new_n50_), .O(z17));
  ...
  oai21  g83(.a(new_n128_), .b(x15), .c(new_n50_), .O(z18));
endmodule
