...
module FAU ( 
  ...
  oai21  g006(.a(x16), .b(x07), .c(new_n51_), .O(new_n52_));
  ...
  nor2   g019(.a(new_n47_), .b(new_n51_), .O(z02));
  nand3  g020(.a(new_n62_), .b(new_n49_), .c(new_n54_), .O(new_n66_));
  ...
  nand2  g033(.a(new_n58_), .b(new_n57_), .O(new_n79_));
  nand3  g034(.a(x24), .b(x22), .c(x21), .O(new_n80_));
  oai21  g035(.a(new_n80_), .b(new_n79_), .c(new_n54_), .O(new_n81_));
  nand2  g036(.a(new_n81_), .b(new_n56_), .O(new_n82_));
  nand2  g037(.a(new_n80_), .b(new_n54_), .O(new_n83_));
  nand2  g038(.a(new_n83_), .b(x20), .O(new_n84_));
  inv1   g039(.a(x24), .O(new_n85_));
  nand2  g040(.a(new_n54_), .b(new_n85_), .O(new_n86_));
  ...
  nor2   g046(.a(new_n57_), .b(new_n56_), .O(new_n92_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n91_), .c(new_n85_), .d(new_n88_), .O(new_n97_));
  aoi21  g052(.a(new_n97_), .b(x25), .c(new_n48_), .O(new_n98_));
  nand4  g053(.a(new_n98_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(z08));
  nand2  g054(.a(x05), .b(x04), .O(new_n100_));
  nor4   g055(.a(new_n100_), .b(x16), .c(x15), .d(x07), .O(z09));
  nand4  g056(.a(new_n100_), .b(new_n56_), .c(new_n47_), .d(new_n51_), .O(new_n102_));
  nor2   g057(.a(new_n102_), .b(x07), .O(z10));
  inv1   g058(.a(x07), .O(new_n104_));
  xor2a  g059(.a(x18), .b(x17), .O(new_n105_));
  nand3  g060(.a(new_n105_), .b(new_n100_), .c(new_n104_), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g062(.a(new_n58_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g063(.a(new_n92_), .b(new_n58_), .c(new_n108_), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n100_), .c(new_n47_), .d(new_n51_), .O(new_n110_));
  nor2   g065(.a(new_n110_), .b(x07), .O(z12));
  nand2  g066(.a(new_n93_), .b(new_n92_), .O(new_n112_));
  nand3  g067(.a(x19), .b(x18), .c(x17), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(x20), .O(new_n114_));
  nand4  g069(.a(new_n51_), .b(new_n104_), .c(x05), .d(x04), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n114_), .c(new_n112_), .d(new_n104_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand2  g072(.a(new_n117_), .b(new_n51_), .O(z13));
  oai21  g073(.a(new_n100_), .b(x07), .c(new_n47_), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(new_n51_), .O(new_n120_));
  nand2  g075(.a(new_n47_), .b(x07), .O(new_n121_));
  nor2   g076(.a(x21), .b(x20), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n92_), .c(x19), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n121_), .c(new_n51_), .O(new_n124_));
  aoi21  g079(.a(new_n112_), .b(x21), .c(new_n124_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n120_), .O(z14));
  inv1   g081(.a(new_n113_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n94_), .c(new_n55_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n115_), .c(new_n104_), .O(new_n129_));
  aoi21  g084(.a(new_n123_), .b(x22), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x16), .c(new_n51_), .O(z15));
  nor2   g086(.a(x23), .b(x22), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n122_), .c(new_n127_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n121_), .c(new_n51_), .O(new_n134_));
  aoi21  g089(.a(new_n128_), .b(x23), .c(new_n134_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n120_), .O(z16));
  nand3  g091(.a(new_n95_), .b(new_n88_), .c(new_n89_), .O(new_n137_));
  nor2   g092(.a(new_n137_), .b(x20), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  nand2  g094(.a(new_n121_), .b(new_n51_), .O(new_n140_));
  aoi21  g095(.a(new_n133_), .b(x24), .c(new_n140_), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n139_), .c(new_n120_), .O(z17));
  nand2  g097(.a(new_n96_), .b(x25), .O(new_n143_));
  inv1   g098(.a(new_n112_), .O(new_n144_));
  inv1   g099(.a(new_n94_), .O(new_n145_));
  nor3   g100(.a(new_n145_), .b(new_n86_), .c(x23), .O(new_n146_));
  aoi22  g101(.a(new_n146_), .b(new_n144_), .c(new_n47_), .d(x07), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n143_), .c(new_n120_), .d(new_n51_), .O(z18));
endmodule
