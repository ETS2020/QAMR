...
module FAU ( 
  ...
  aoi21  g42(.a(new_n85_), .b(new_n56_), .c(new_n61_), .O(new_n88_));
  oai22  g43(.a(new_n56_), .b(x20), .c(new_n55_), .d(new_n62_), .O(new_n89_));
  ...
  nand4  g49(.a(new_n92_), .b(x19), .c(new_n94_), .d(new_n50_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z10));
  inv1   g51(.a(x18), .O(new_n97_));
  nand3  g52(.a(x19), .b(new_n97_), .c(x17), .O(new_n98_));
  oai21  g53(.a(new_n97_), .b(x17), .c(new_n98_), .O(new_n99_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n92_), .c(x19), .d(new_n50_), .O(new_n103_));
  nor2   g58(.a(new_n103_), .b(x07), .O(z12));
  oai21  g59(.a(new_n92_), .b(x07), .c(x19), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n50_), .O(new_n106_));
  oai21  g61(.a(new_n97_), .b(new_n94_), .c(x20), .O(new_n107_));
  nor2   g62(.a(new_n51_), .b(new_n54_), .O(new_n108_));
  nor2   g63(.a(x20), .b(new_n97_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(x17), .c(new_n108_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n50_), .O(z13));
  nand3  g66(.a(new_n61_), .b(x18), .c(x17), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(x21), .O(new_n113_));
  inv1   g68(.a(x21), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n61_), .c(x18), .d(x17), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(new_n108_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n106_), .d(new_n50_), .O(z14));
  and2   g73(.a(new_n115_), .b(x22), .O(new_n119_));
  nand4  g74(.a(new_n50_), .b(new_n54_), .c(x05), .d(x04), .O(new_n120_));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n61_), .c(x18), .d(x17), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n54_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n119_), .c(x19), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n50_), .O(z15));
  nand2  g80(.a(new_n122_), .b(x23), .O(new_n126_));
  inv1   g81(.a(x22), .O(new_n127_));
  nand3  g82(.a(new_n62_), .b(new_n127_), .c(new_n114_), .O(new_n128_));
  nor2   g83(.a(new_n128_), .b(new_n112_), .O(new_n129_));
  nor2   g84(.a(new_n129_), .b(new_n108_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n126_), .c(new_n106_), .d(new_n50_), .O(z16));
  oai21  g86(.a(new_n128_), .b(new_n112_), .c(x24), .O(new_n132_));
  nor2   g87(.a(x24), .b(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n121_), .c(new_n109_), .d(x17), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n120_), .d(new_n54_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(x19), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n50_), .O(z17));
  nand2  g92(.a(new_n134_), .b(x25), .O(new_n138_));
  nand4  g93(.a(new_n56_), .b(new_n55_), .c(new_n62_), .d(new_n127_), .O(new_n139_));
  inv1   g94(.a(new_n139_), .O(new_n140_));
  aoi21  g95(.a(new_n140_), .b(new_n116_), .c(new_n108_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n138_), .c(new_n106_), .d(new_n50_), .O(z18));
endmodule
