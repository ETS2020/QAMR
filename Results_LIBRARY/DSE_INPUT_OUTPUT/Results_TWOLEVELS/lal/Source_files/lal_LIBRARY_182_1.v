...
module FAU ( 
  ...
  nor2   g035(.a(x11), .b(new_n51_), .O(new_n81_));
  inv1   g036(.a(x11), .O(new_n82_));
  nor2   g037(.a(x15), .b(new_n82_), .O(new_n83_));
  aoi21  g038(.a(new_n83_), .b(new_n51_), .c(new_n81_), .O(new_n84_));
  ...
  nand4  g051(.a(new_n47_), .b(new_n96_), .c(x05), .d(x04), .O(new_n97_));
  inv1   g052(.a(new_n97_), .O(z09));
  nand2  g053(.a(x05), .b(x04), .O(new_n99_));
  nand4  g054(.a(new_n99_), .b(new_n56_), .c(new_n47_), .d(new_n96_), .O(new_n100_));
  nand2  g055(.a(new_n100_), .b(new_n49_), .O(z10));
  xor2a  g056(.a(x18), .b(x17), .O(new_n102_));
  nand4  g057(.a(new_n102_), .b(new_n99_), .c(new_n47_), .d(new_n96_), .O(new_n103_));
  ...
  nor2   g081(.a(new_n126_), .b(new_n110_), .O(new_n127_));
  aoi21  g082(.a(new_n121_), .b(x22), .c(new_n127_), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n112_), .c(new_n47_), .d(new_n96_), .O(z15));
  inv1   g084(.a(x23), .O(new_n130_));
  nor2   g085(.a(new_n127_), .b(new_n130_), .O(new_n131_));
  inv1   g086(.a(new_n110_), .O(new_n132_));
  nand4  g087(.a(new_n120_), .b(new_n132_), .c(new_n130_), .d(new_n91_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n112_), .c(new_n96_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n131_), .c(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n117_), .O(z16));
  nand2  g091(.a(new_n133_), .b(x24), .O(new_n137_));
  nand3  g092(.a(new_n125_), .b(new_n90_), .c(new_n130_), .O(new_n138_));
  inv1   g093(.a(new_n138_), .O(new_n139_));
  nand3  g094(.a(new_n139_), .b(new_n113_), .c(new_n105_), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n137_), .c(new_n112_), .d(new_n96_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n47_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n117_), .O(z17));
  oai21  g098(.a(new_n138_), .b(new_n114_), .c(x25), .O(new_n144_));
  nor3   g099(.a(x25), .b(x24), .c(x23), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n125_), .c(new_n113_), .d(new_n105_), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n144_), .c(new_n112_), .d(new_n96_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n117_), .O(z18));
endmodule
