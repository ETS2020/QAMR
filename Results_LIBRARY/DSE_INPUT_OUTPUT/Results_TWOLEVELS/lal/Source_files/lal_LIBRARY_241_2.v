...
module FAU ( 
  ...
  nand2  g021(.a(new_n66_), .b(new_n50_), .O(new_n67_));
  nand4  g022(.a(new_n67_), .b(new_n62_), .c(new_n55_), .d(new_n61_), .O(new_n68_));
  nand3  g023(.a(new_n68_), .b(new_n60_), .c(new_n52_), .O(z01));
  ...
  nand3  g034(.a(new_n79_), .b(new_n53_), .c(new_n46_), .O(new_n80_));
  inv1   g035(.a(new_n80_), .O(z04));
  oai21  g036(.a(x13), .b(x08), .c(new_n53_), .O(z05));
  inv1   g037(.a(x14), .O(new_n83_));
  nor3   g038(.a(new_n48_), .b(new_n83_), .c(x08), .O(z06));
  nand3  g039(.a(new_n53_), .b(new_n46_), .c(x06), .O(z07));
  ...
  aoi21  g044(.a(new_n87_), .b(new_n50_), .c(new_n89_), .O(new_n90_));
  oai21  g045(.a(new_n89_), .b(x25), .c(x19), .O(new_n91_));
  ...
  nand2  g052(.a(new_n97_), .b(new_n53_), .O(z10));
  ...
  nand3  g058(.a(new_n50_), .b(x18), .c(x17), .O(new_n104_));
  oai21  g059(.a(new_n103_), .b(new_n50_), .c(new_n104_), .O(new_n105_));
  nand4  g060(.a(new_n105_), .b(new_n95_), .c(new_n47_), .d(new_n54_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z12));
  nand3  g062(.a(new_n54_), .b(x05), .c(x04), .O(new_n108_));
  nand2  g063(.a(x20), .b(new_n50_), .O(new_n109_));
  nand3  g064(.a(new_n109_), .b(new_n108_), .c(new_n54_), .O(new_n110_));
  ...
  nand2  g104(.a(x25), .b(new_n50_), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n108_), .c(new_n54_), .O(new_n151_));
  inv1   g106(.a(new_n151_), .O(new_n152_));
  oai21  g107(.a(new_n145_), .b(new_n113_), .c(x25), .O(new_n153_));
  nor2   g108(.a(x20), .b(new_n50_), .O(new_n154_));
  nor3   g109(.a(x25), .b(x24), .c(x23), .O(new_n155_));
  nand4  g110(.a(new_n155_), .b(new_n154_), .c(new_n131_), .d(new_n103_), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n153_), .c(new_n152_), .d(new_n47_), .O(z18));
endmodule
