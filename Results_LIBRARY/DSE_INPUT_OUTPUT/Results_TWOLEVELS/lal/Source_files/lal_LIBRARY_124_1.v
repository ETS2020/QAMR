...
module FAU ( 
  ...
  aoi21  g08(.a(x05), .b(x04), .c(x15), .O(new_n54_));
  nor2   g09(.a(new_n54_), .b(x07), .O(z09));
  inv1   g10(.a(z09), .O(new_n56_));
  ...
  oai21  g19(.a(new_n64_), .b(x23), .c(x24), .O(new_n65_));
  nand3  g20(.a(new_n65_), .b(new_n57_), .c(new_n48_), .O(new_n66_));
  nand3  g21(.a(new_n66_), .b(new_n56_), .c(new_n53_), .O(z01));
  nand3  g22(.a(new_n65_), .b(new_n50_), .c(new_n57_), .O(new_n68_));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n58_), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g42(.a(new_n87_), .b(new_n59_), .c(new_n48_), .d(new_n53_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n87_), .c(new_n48_), .d(new_n53_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z11));
  nor2   g47(.a(new_n60_), .b(new_n59_), .O(new_n93_));
  nand3  g48(.a(new_n61_), .b(x18), .c(x17), .O(new_n94_));
  oai21  g49(.a(new_n93_), .b(new_n61_), .c(new_n94_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n87_), .c(new_n48_), .d(new_n53_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n53_), .b(x05), .c(x04), .O(new_n100_));
  nand4  g55(.a(new_n58_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n48_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n53_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n54_), .d(new_n53_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n98_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(x07), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n56_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n111_), .b(new_n110_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n106_), .b(new_n114_), .c(new_n82_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n98_), .c(new_n100_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n48_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n53_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n98_), .c(x24), .O(new_n120_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n100_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n53_), .O(z17));
  oai21  g84(.a(new_n124_), .b(new_n101_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n122_), .c(new_n121_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n100_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n53_), .O(z18));
endmodule
