...
module FAU ( 
  ...
  oai21  g041(.a(new_n86_), .b(new_n57_), .c(new_n54_), .O(new_n87_));
  ...
  oai21  g067(.a(new_n94_), .b(new_n95_), .c(new_n112_), .O(new_n113_));
  ...
  nand3  g071(.a(new_n54_), .b(new_n65_), .c(x07), .O(new_n117_));
  aoi21  g072(.a(new_n117_), .b(new_n116_), .c(new_n85_), .O(new_n118_));
  nand4  g073(.a(new_n57_), .b(new_n54_), .c(new_n65_), .d(x07), .O(new_n119_));
  inv1   g074(.a(new_n119_), .O(new_n120_));
  oai21  g075(.a(new_n120_), .b(new_n118_), .c(new_n55_), .O(new_n121_));
  nand3  g076(.a(new_n89_), .b(new_n56_), .c(x07), .O(new_n122_));
  oai21  g077(.a(new_n55_), .b(x15), .c(new_n122_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n85_), .O(new_n124_));
  inv1   g079(.a(new_n61_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n65_), .O(new_n126_));
  aoi21  g081(.a(new_n61_), .b(x20), .c(x23), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n126_), .c(new_n54_), .d(x24), .O(new_n128_));
  oai21  g083(.a(new_n95_), .b(new_n93_), .c(x20), .O(new_n129_));
  nand3  g084(.a(new_n105_), .b(x05), .c(x04), .O(new_n130_));
  aoi21  g085(.a(new_n130_), .b(new_n129_), .c(x15), .O(new_n131_));
  aoi21  g086(.a(new_n128_), .b(x07), .c(new_n131_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n124_), .c(new_n121_), .O(z13));
  nand4  g088(.a(new_n59_), .b(x19), .c(x18), .d(new_n47_), .O(new_n134_));
  aoi21  g089(.a(new_n134_), .b(new_n117_), .c(new_n85_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n120_), .c(new_n55_), .O(new_n136_));
  ...
  inv1   g096(.a(new_n106_), .O(new_n142_));
  nand4  g097(.a(new_n61_), .b(new_n54_), .c(x24), .d(new_n65_), .O(new_n143_));
  ...
  oai21  g103(.a(new_n148_), .b(new_n147_), .c(new_n117_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n59_), .O(new_n150_));
  nand4  g105(.a(new_n54_), .b(x24), .c(new_n65_), .d(x22), .O(new_n151_));
  ...
  nand3  g123(.a(new_n54_), .b(x24), .c(new_n65_), .O(new_n169_));
  ...
  nand3  g128(.a(new_n173_), .b(new_n164_), .c(new_n53_), .O(z16));
  ...
  oai21  g134(.a(new_n127_), .b(new_n105_), .c(new_n179_), .O(new_n180_));
