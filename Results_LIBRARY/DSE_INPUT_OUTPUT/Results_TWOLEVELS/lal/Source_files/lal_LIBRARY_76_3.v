...
module FAU ( 
  ...
  inv1   g53(.a(new_n62_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n48_), .c(new_n47_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n50_), .O(z09));
  nand4  g56(.a(new_n62_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z10));
  xor2a  g58(.a(x18), .b(x17), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n50_), .O(z11));
  nand3  g61(.a(new_n56_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g62(.a(new_n91_), .b(new_n56_), .c(new_n107_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n109_));
  ...
  nand4  g92(.a(new_n137_), .b(new_n136_), .c(new_n112_), .d(new_n47_), .O(z17));
  ...
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n112_), .d(new_n47_), .O(z18));
endmodule
