...
module FAU ( 
  ...
  aoi21  g62(.a(new_n55_), .b(new_n47_), .c(new_n54_), .O(new_n108_));
  nand3  g63(.a(new_n56_), .b(x18), .c(x17), .O(new_n109_));
  oai21  g64(.a(new_n108_), .b(new_n56_), .c(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n102_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n47_), .c(x07), .O(z12));
  nand2  g67(.a(new_n93_), .b(new_n92_), .O(new_n113_));
  aoi21  g68(.a(x05), .b(x04), .c(x15), .O(new_n114_));
  ...
  or2    g72(.a(new_n114_), .b(x07), .O(new_n118_));
  nand2  g73(.a(new_n113_), .b(x21), .O(new_n119_));
  nor2   g74(.a(x21), .b(x20), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n92_), .c(x19), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n51_), .O(z14));
  nand2  g77(.a(new_n121_), .b(x22), .O(new_n123_));
  nand2  g78(.a(new_n94_), .b(new_n53_), .O(new_n124_));
  nor2   g79(.a(new_n124_), .b(new_n115_), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(new_n62_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n51_), .O(z15));
  inv1   g84(.a(x23), .O(new_n130_));
  nor2   g85(.a(new_n125_), .b(new_n130_), .O(new_n131_));
  inv1   g86(.a(new_n115_), .O(new_n132_));
  nand4  g87(.a(new_n120_), .b(new_n132_), .c(new_n130_), .d(new_n87_), .O(new_n133_));
  ...
  nand3  g95(.a(new_n140_), .b(new_n139_), .c(new_n118_), .O(z17));
  ...
  nand4  g99(.a(new_n144_), .b(new_n142_), .c(new_n118_), .d(new_n51_), .O(z18));
endmodule
