...
module FAU ( 
  ...
  aoi21  g52(.a(new_n97_), .b(x25), .c(new_n49_), .O(new_n98_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n48_), .c(new_n47_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n50_), .O(z09));
  nand4  g58(.a(new_n100_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n50_), .O(z10));
  xor2a  g60(.a(x18), .b(x17), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n100_), .c(new_n48_), .d(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n50_), .O(z11));
  nand3  g63(.a(new_n56_), .b(x18), .c(x17), .O(new_n109_));
  oai21  g64(.a(new_n92_), .b(new_n56_), .c(new_n109_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n100_), .c(new_n48_), .d(new_n47_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(z12));
  nand2  g67(.a(new_n93_), .b(new_n92_), .O(new_n113_));
  oai21  g68(.a(new_n101_), .b(x15), .c(new_n47_), .O(new_n114_));
  nand3  g69(.a(x19), .b(x18), .c(x17), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x20), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n47_), .O(z13));
  ...
  oai21  g76(.a(new_n121_), .b(x15), .c(new_n114_), .O(z14));
  nand2  g77(.a(new_n119_), .b(x22), .O(new_n123_));
  inv1   g78(.a(new_n115_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n94_), .c(new_n53_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n114_), .d(new_n47_), .O(z15));
  nand2  g81(.a(new_n125_), .b(x23), .O(new_n127_));
  nor2   g82(.a(x23), .b(x22), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n118_), .c(new_n124_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n114_), .d(new_n47_), .O(z16));
  nand3  g85(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n131_));
  nor2   g86(.a(new_n131_), .b(x20), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(x19), .c(x18), .d(x17), .O(new_n133_));
  nand2  g88(.a(new_n129_), .b(x24), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n133_), .c(new_n114_), .d(new_n47_), .O(z17));
  nand2  g90(.a(new_n96_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n114_), .d(new_n47_), .O(z18));
endmodule
