...
module FAU ( 
  ...
  nand4  g047(.a(new_n92_), .b(new_n87_), .c(new_n52_), .d(new_n60_), .O(new_n93_));
  ...
  nand3  g052(.a(new_n58_), .b(x22), .c(x21), .O(new_n98_));
  aoi21  g053(.a(new_n98_), .b(new_n97_), .c(new_n52_), .O(new_n99_));
  oai21  g054(.a(new_n99_), .b(x25), .c(x15), .O(new_n100_));
  nand2  g055(.a(new_n100_), .b(new_n96_), .O(z08));
  inv1   g056(.a(x15), .O(new_n102_));
  oai21  g057(.a(new_n64_), .b(x07), .c(new_n47_), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  inv1   g059(.a(new_n104_), .O(z09));
  nand4  g060(.a(new_n64_), .b(new_n79_), .c(new_n102_), .d(new_n47_), .O(new_n106_));
  nor2   g061(.a(new_n106_), .b(x07), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand3  g063(.a(new_n108_), .b(new_n64_), .c(new_n50_), .O(new_n109_));
  aoi21  g064(.a(new_n109_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g065(.a(new_n56_), .b(x18), .c(x17), .O(new_n111_));
  oai21  g066(.a(new_n88_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand3  g067(.a(new_n112_), .b(new_n64_), .c(new_n50_), .O(new_n113_));
  ...
  nand4  g074(.a(new_n119_), .b(new_n116_), .c(new_n104_), .d(new_n50_), .O(z13));
  nor2   g075(.a(x21), .b(x20), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n88_), .c(x19), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n102_), .c(new_n50_), .O(new_n123_));
  aoi21  g078(.a(new_n117_), .b(x21), .c(new_n123_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n104_), .O(z14));
  nand4  g080(.a(new_n102_), .b(new_n50_), .c(x05), .d(x04), .O(new_n126_));
  inv1   g081(.a(new_n115_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n90_), .c(new_n54_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n126_), .c(new_n50_), .O(new_n129_));
  aoi21  g084(.a(new_n122_), .b(x22), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x14), .c(new_n102_), .O(z15));
  and2   g086(.a(new_n128_), .b(x23), .O(new_n132_));
  nand4  g087(.a(new_n121_), .b(new_n127_), .c(new_n97_), .d(new_n60_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n126_), .c(new_n50_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n132_), .c(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n102_), .O(z16));
  nand3  g091(.a(new_n91_), .b(new_n60_), .c(new_n59_), .O(new_n137_));
  ...
  nand4  g095(.a(new_n140_), .b(new_n139_), .c(new_n126_), .d(new_n50_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n47_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n102_), .O(z17));
  nand2  g098(.a(new_n92_), .b(x25), .O(new_n144_));
  nor3   g099(.a(x25), .b(x24), .c(x23), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n90_), .c(new_n118_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n104_), .c(new_n102_), .d(new_n50_), .O(z18));
endmodule
