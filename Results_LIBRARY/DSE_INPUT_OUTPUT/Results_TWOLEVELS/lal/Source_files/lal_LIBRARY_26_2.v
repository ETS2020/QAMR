...
module FAU ( 
  ...
  nand2  g034(.a(new_n58_), .b(new_n57_), .O(new_n80_));
  nand3  g035(.a(x24), .b(x22), .c(x21), .O(new_n81_));
  oai21  g036(.a(new_n81_), .b(new_n80_), .c(new_n51_), .O(new_n82_));
  nand2  g037(.a(new_n82_), .b(new_n56_), .O(new_n83_));
  nand2  g038(.a(new_n81_), .b(new_n51_), .O(new_n84_));
  nand2  g039(.a(new_n84_), .b(x20), .O(new_n85_));
  inv1   g040(.a(x24), .O(new_n86_));
  oai21  g041(.a(new_n86_), .b(x15), .c(new_n51_), .O(new_n87_));
  ...
  aoi21  g069(.a(x05), .b(x04), .c(x07), .O(new_n115_));
  nand3  g070(.a(x19), .b(x18), .c(x17), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(x20), .O(new_n117_));
  nand4  g072(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n47_), .O(z13));
  nand2  g073(.a(new_n114_), .b(x21), .O(new_n119_));
  nor2   g074(.a(x21), .b(x20), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(new_n93_), .c(x19), .O(new_n121_));
  nand4  g076(.a(new_n121_), .b(new_n119_), .c(new_n115_), .d(new_n47_), .O(z14));
  nand3  g077(.a(new_n101_), .b(x05), .c(x04), .O(new_n123_));
  inv1   g078(.a(new_n116_), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n95_), .c(new_n55_), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n123_), .c(new_n101_), .O(new_n126_));
  aoi21  g081(.a(new_n121_), .b(x22), .c(new_n126_), .O(new_n127_));
  nand2  g082(.a(x25), .b(x15), .O(new_n128_));
  oai21  g083(.a(new_n127_), .b(x15), .c(new_n128_), .O(z15));
  nand2  g084(.a(new_n125_), .b(x23), .O(new_n130_));
  inv1   g085(.a(x23), .O(new_n131_));
  nand4  g086(.a(new_n120_), .b(new_n124_), .c(new_n131_), .d(new_n89_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n130_), .c(new_n115_), .d(new_n47_), .O(z16));
  aoi21  g088(.a(new_n51_), .b(x15), .c(x24), .O(new_n134_));
  nand4  g089(.a(new_n134_), .b(new_n131_), .c(new_n89_), .d(new_n90_), .O(new_n135_));
  nor2   g090(.a(new_n135_), .b(x20), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(x19), .c(x18), .d(x17), .O(new_n137_));
  nand2  g092(.a(new_n132_), .b(x24), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n115_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n137_), .c(new_n128_), .O(z17));
  nand4  g096(.a(new_n95_), .b(new_n51_), .c(new_n86_), .d(new_n131_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n114_), .c(new_n123_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(x07), .c(new_n47_), .O(new_n144_));
  nand4  g099(.a(x19), .b(x18), .c(x17), .d(new_n47_), .O(new_n145_));
  nand3  g100(.a(new_n120_), .b(new_n96_), .c(new_n89_), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n145_), .c(x25), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n144_), .O(z18));
endmodule
