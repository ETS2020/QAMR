...
module FAU ( 
  ...
  nor2   g001(.a(x15), .b(x06), .O(new_n47_));
  nor3   g002(.a(new_n47_), .b(x16), .c(new_n46_), .O(z00));
  inv1   g003(.a(x06), .O(new_n49_));
  ...
  nor2   g074(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  ...
  nand3  g078(.a(new_n123_), .b(new_n50_), .c(x06), .O(new_n124_));
  ...
  oai21  g085(.a(new_n130_), .b(new_n49_), .c(new_n50_), .O(z15));
  ...
  oai21  g090(.a(new_n135_), .b(new_n132_), .c(x06), .O(new_n136_));
  ...
  nand2  g095(.a(new_n50_), .b(x06), .O(new_n141_));
  ...
  aoi21  g101(.a(new_n146_), .b(new_n119_), .c(new_n47_), .O(new_n147_));
