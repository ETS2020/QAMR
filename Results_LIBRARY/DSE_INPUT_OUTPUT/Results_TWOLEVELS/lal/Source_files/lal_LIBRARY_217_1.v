...
module FAU ( 
  ...
  nand4  g54(.a(new_n47_), .b(new_n51_), .c(x05), .d(x04), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z09));
  nand2  g56(.a(x05), .b(x04), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n102_), .c(new_n47_), .d(new_n51_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(z11));
  nand3  g62(.a(new_n56_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g63(.a(new_n92_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n102_), .O(new_n110_));
  aoi21  g65(.a(new_n110_), .b(new_n47_), .c(x07), .O(z12));
  nand2  g66(.a(new_n93_), .b(new_n92_), .O(new_n112_));
  aoi21  g67(.a(x05), .b(x04), .c(x15), .O(new_n113_));
  nand3  g68(.a(x19), .b(x18), .c(x17), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x20), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n51_), .O(z13));
  or2    g71(.a(new_n113_), .b(x07), .O(new_n117_));
  nand2  g72(.a(new_n112_), .b(x21), .O(new_n118_));
  nor2   g73(.a(x21), .b(x20), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n92_), .c(x19), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .d(new_n51_), .O(z14));
  nand2  g76(.a(new_n120_), .b(x22), .O(new_n122_));
  inv1   g77(.a(new_n114_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n94_), .c(new_n53_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n117_), .d(new_n51_), .O(z15));
  nand2  g80(.a(new_n124_), .b(x23), .O(new_n126_));
  nor2   g81(.a(x23), .b(x22), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n119_), .c(new_n123_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n117_), .d(new_n51_), .O(z16));
  nand3  g84(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(x20), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(x19), .c(x18), .d(x17), .O(new_n132_));
  aoi21  g87(.a(new_n128_), .b(x24), .c(x07), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n117_), .O(z17));
  nand2  g89(.a(new_n96_), .b(x25), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n135_), .c(new_n117_), .d(new_n51_), .O(z18));
endmodule
