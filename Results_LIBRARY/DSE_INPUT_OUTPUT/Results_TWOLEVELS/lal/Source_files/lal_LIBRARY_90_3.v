...
module FAU ( 
  ...
  nand2  g070(.a(new_n97_), .b(new_n96_), .O(new_n116_));
  oai21  g071(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(new_n117_));
  ...
  nand4  g075(.a(new_n120_), .b(new_n118_), .c(new_n116_), .d(new_n47_), .O(z13));
  nand2  g076(.a(new_n116_), .b(x21), .O(new_n122_));
  nor2   g077(.a(x21), .b(x20), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n96_), .c(x19), .O(new_n124_));
  nand4  g079(.a(new_n124_), .b(new_n122_), .c(new_n118_), .d(new_n47_), .O(z14));
  nand2  g080(.a(new_n124_), .b(x22), .O(new_n126_));
  nand2  g081(.a(new_n98_), .b(new_n53_), .O(new_n127_));
  nor2   g082(.a(new_n127_), .b(new_n119_), .O(new_n128_));
  ...
  nand2  g086(.a(new_n131_), .b(new_n118_), .O(z15));
  inv1   g087(.a(x23), .O(new_n133_));
  nor2   g088(.a(new_n128_), .b(new_n133_), .O(new_n134_));
  inv1   g089(.a(new_n119_), .O(new_n135_));
  nand4  g090(.a(new_n123_), .b(new_n135_), .c(new_n133_), .d(new_n91_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n134_), .c(new_n48_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n118_), .O(z16));
  nand3  g094(.a(new_n99_), .b(new_n91_), .c(new_n93_), .O(new_n140_));
  ...
  nand4  g098(.a(new_n143_), .b(new_n142_), .c(new_n118_), .d(new_n47_), .O(z17));
  nand2  g099(.a(new_n100_), .b(x25), .O(new_n145_));
  nor3   g100(.a(x25), .b(x24), .c(x23), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n98_), .c(new_n97_), .d(new_n96_), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n145_), .c(new_n118_), .d(new_n47_), .O(z18));
endmodule
