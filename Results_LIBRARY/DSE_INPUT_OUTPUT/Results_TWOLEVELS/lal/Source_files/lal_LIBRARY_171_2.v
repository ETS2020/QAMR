...
module FAU ( 
  ...
  nor2   g049(.a(x20), .b(new_n58_), .O(new_n95_));
  ...
  aoi21  g058(.a(new_n103_), .b(new_n55_), .c(new_n90_), .O(new_n104_));
  ...
  nor2   g062(.a(new_n107_), .b(x15), .O(z09));
  nand2  g063(.a(x05), .b(x04), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n82_), .O(new_n110_));
  aoi21  g065(.a(new_n110_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g066(.a(x18), .b(x17), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n109_), .c(new_n51_), .d(new_n47_), .O(new_n113_));
  inv1   g068(.a(new_n113_), .O(z11));
  nand3  g069(.a(new_n58_), .b(x18), .c(x17), .O(new_n115_));
  oai21  g070(.a(new_n94_), .b(new_n58_), .c(new_n115_), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n109_), .c(new_n51_), .d(new_n47_), .O(new_n117_));
  ...
  nand4  g076(.a(new_n121_), .b(new_n107_), .c(new_n119_), .d(new_n51_), .O(z13));
  nand2  g077(.a(new_n119_), .b(x21), .O(new_n123_));
  nor2   g078(.a(x21), .b(x20), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n94_), .c(x19), .O(new_n125_));
  nand4  g080(.a(new_n125_), .b(new_n123_), .c(new_n107_), .d(new_n51_), .O(z14));
  nand2  g081(.a(new_n125_), .b(x22), .O(new_n127_));
  nand2  g082(.a(new_n96_), .b(new_n56_), .O(new_n128_));
  nor2   g083(.a(new_n128_), .b(new_n120_), .O(new_n129_));
  inv1   g084(.a(new_n129_), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n127_), .c(new_n107_), .d(new_n51_), .O(z15));
  nor2   g086(.a(new_n129_), .b(new_n55_), .O(new_n132_));
  nand3  g087(.a(new_n51_), .b(x05), .c(x04), .O(new_n133_));
  inv1   g088(.a(new_n120_), .O(new_n134_));
  nand4  g089(.a(new_n124_), .b(new_n134_), .c(new_n55_), .d(new_n89_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n132_), .c(new_n47_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n51_), .O(z16));
  nand3  g093(.a(new_n97_), .b(new_n89_), .c(new_n91_), .O(new_n139_));
  ...
  nand3  g097(.a(new_n142_), .b(new_n141_), .c(new_n133_), .O(new_n143_));
  ...
  oai21  g102(.a(new_n147_), .b(new_n119_), .c(new_n133_), .O(new_n148_));
  aoi21  g103(.a(new_n98_), .b(x25), .c(new_n148_), .O(new_n149_));
  oai21  g104(.a(new_n149_), .b(x07), .c(new_n51_), .O(z18));
endmodule
