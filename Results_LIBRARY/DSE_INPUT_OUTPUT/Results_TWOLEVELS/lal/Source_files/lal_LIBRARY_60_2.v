...
module FAU ( 
  ...
  nand4  g52(.a(new_n97_), .b(new_n47_), .c(x05), .d(x04), .O(new_n98_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n60_), .c(new_n97_), .d(new_n47_), .O(new_n107_));
  ...
  or2    g71(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g72(.a(new_n109_), .b(x21), .O(new_n118_));
  nor2   g73(.a(x21), .b(x20), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n89_), .c(x19), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .d(new_n97_), .O(z14));
  ...
  aoi21  g80(.a(new_n120_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x07), .c(new_n97_), .O(z15));
  inv1   g82(.a(x23), .O(new_n128_));
  aoi21  g83(.a(new_n123_), .b(new_n122_), .c(new_n128_), .O(new_n129_));
  nand4  g84(.a(new_n119_), .b(new_n122_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n112_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n129_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n97_), .O(z16));
  nand3  g88(.a(new_n92_), .b(new_n84_), .c(new_n86_), .O(new_n134_));
  nor2   g89(.a(new_n134_), .b(x20), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(x19), .c(x18), .d(x17), .O(new_n136_));
  aoi21  g91(.a(new_n130_), .b(x24), .c(x15), .O(new_n137_));
  ...
  nand4  g95(.a(new_n140_), .b(new_n91_), .c(new_n90_), .d(new_n89_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n117_), .d(new_n97_), .O(z18));
endmodule
