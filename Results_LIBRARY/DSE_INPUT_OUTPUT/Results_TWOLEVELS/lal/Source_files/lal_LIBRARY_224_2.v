...
module FAU ( 
  ...
  nor4   g38(.a(new_n61_), .b(x15), .c(x14), .d(x07), .O(z09));
  inv1   g39(.a(x07), .O(new_n85_));
  nand3  g40(.a(new_n61_), .b(new_n53_), .c(new_n85_), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g42(.a(x15), .O(new_n88_));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n61_), .c(new_n88_), .d(new_n47_), .O(new_n90_));
  ...
  oai21  g58(.a(new_n61_), .b(x07), .c(new_n47_), .O(new_n104_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n79_), .c(new_n118_), .d(new_n52_), .O(new_n120_));
