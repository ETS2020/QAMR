...
module FAU ( 
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n51_), .d(new_n50_), .O(z13));
  nand2  g56(.a(new_n100_), .b(x21), .O(new_n102_));
  nand3  g57(.a(new_n50_), .b(x05), .c(x04), .O(new_n103_));
  ...
  nand2  g62(.a(new_n107_), .b(new_n50_), .O(z14));
  ...
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n103_), .O(new_n130_));
