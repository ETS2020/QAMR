...
module FAU ( 
  ...
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n83_));
  nand3  g38(.a(x22), .b(x21), .c(new_n55_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(x24), .O(new_n86_));
  aoi21  g41(.a(x25), .b(new_n52_), .c(new_n48_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n86_), .c(new_n81_), .O(z08));
  inv1   g43(.a(x15), .O(new_n89_));
  nand3  g44(.a(new_n62_), .b(new_n89_), .c(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand4  g46(.a(new_n61_), .b(new_n53_), .c(new_n89_), .d(new_n47_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n61_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n61_), .c(new_n89_), .d(new_n47_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n102_), .d(new_n89_), .O(z13));
  or2    g62(.a(new_n102_), .b(x15), .O(new_n108_));
  ...
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n89_), .O(z14));
  nand2  g67(.a(new_n111_), .b(x22), .O(new_n113_));
  inv1   g68(.a(new_n103_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n52_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n108_), .d(new_n89_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x22), .O(new_n119_));
  nand3  g74(.a(new_n110_), .b(new_n82_), .c(new_n119_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n108_), .d(new_n89_), .O(z16));
  oai21  g78(.a(new_n120_), .b(new_n103_), .c(x24), .O(new_n124_));
  nand3  g79(.a(new_n89_), .b(x05), .c(x04), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n115_), .c(new_n105_), .d(new_n97_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n124_), .O(new_n128_));
  ...
  nand4  g87(.a(new_n132_), .b(new_n115_), .c(new_n105_), .d(new_n97_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n108_), .d(new_n89_), .O(z18));
endmodule
