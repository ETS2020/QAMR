...
module FAU ( 
  ...
  nand4  g50(.a(new_n92_), .b(x21), .c(new_n61_), .d(new_n54_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x21), .c(x15), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n92_), .c(x21), .d(new_n50_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n92_), .c(x21), .d(new_n50_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(x07), .O(z12));
  nand3  g60(.a(x19), .b(x18), .c(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nor2   g62(.a(x20), .b(new_n63_), .O(new_n108_));
  nor2   g63(.a(new_n51_), .b(new_n54_), .O(new_n109_));
  aoi21  g64(.a(new_n108_), .b(new_n101_), .c(new_n109_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n94_), .d(new_n50_), .O(z13));
  nand4  g66(.a(new_n92_), .b(x19), .c(x18), .d(x17), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n50_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n59_), .c(new_n54_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x21), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n50_), .O(z14));
  inv1   g71(.a(new_n109_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n94_), .c(new_n60_), .d(new_n50_), .O(z15));
  nand4  g73(.a(new_n50_), .b(new_n54_), .c(x05), .d(x04), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n57_), .c(new_n54_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x21), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n50_), .O(z16));
  nand4  g77(.a(new_n117_), .b(new_n94_), .c(new_n88_), .d(new_n50_), .O(z17));
  nand4  g78(.a(new_n117_), .b(new_n94_), .c(new_n58_), .d(new_n50_), .O(z18));
endmodule
