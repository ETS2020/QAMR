...
module FAU ( 
  ...
  nor2   g49(.a(new_n94_), .b(x15), .O(z09));
  nand3  g50(.a(new_n92_), .b(new_n61_), .c(new_n54_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x21), .c(x15), .O(z10));
  ...
  aoi21  g71(.a(new_n116_), .b(new_n54_), .c(new_n51_), .O(new_n117_));
  nand2  g72(.a(x21), .b(x07), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n117_), .c(new_n59_), .d(new_n50_), .O(z14));
  nand3  g74(.a(new_n108_), .b(new_n60_), .c(new_n54_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x21), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n50_), .O(z15));
  nand4  g77(.a(new_n118_), .b(new_n94_), .c(new_n57_), .d(new_n50_), .O(z16));
  inv1   g78(.a(x24), .O(new_n124_));
  nand3  g79(.a(new_n108_), .b(new_n124_), .c(new_n54_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(x21), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n50_), .O(z17));
  nand3  g82(.a(new_n108_), .b(new_n58_), .c(new_n54_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(x21), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n50_), .O(z18));
endmodule
