...
module FAU ( 
  ...
  nand2  g21(.a(new_n62_), .b(new_n50_), .O(z03));
  ...
  nand3  g27(.a(new_n72_), .b(new_n50_), .c(new_n46_), .O(new_n73_));
  ...
  oai21  g37(.a(new_n81_), .b(new_n52_), .c(new_n82_), .O(z08));
  nand4  g38(.a(new_n48_), .b(new_n47_), .c(x05), .d(x04), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z09));
  nand4  g40(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z11));
  nor2   g45(.a(new_n56_), .b(new_n55_), .O(new_n91_));
  nand3  g46(.a(new_n57_), .b(x18), .c(x17), .O(new_n92_));
  oai21  g47(.a(new_n91_), .b(new_n57_), .c(new_n92_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z12));
  aoi21  g50(.a(x05), .b(x04), .c(x15), .O(new_n96_));
  or2    g51(.a(new_n96_), .b(x07), .O(new_n97_));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nor2   g54(.a(x20), .b(new_n57_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n91_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n47_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n48_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n97_), .O(z13));
  nand2  g59(.a(new_n101_), .b(x21), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n91_), .c(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n97_), .d(new_n47_), .O(z14));
  inv1   g63(.a(new_n98_), .O(new_n109_));
  nor2   g64(.a(x22), .b(x21), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n54_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(x22), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(x15), .c(new_n97_), .O(z15));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand3  g71(.a(new_n106_), .b(new_n116_), .c(new_n79_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n109_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n97_), .d(new_n47_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n98_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n110_), .c(new_n100_), .d(new_n91_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n97_), .O(z17));
  nand2  g81(.a(new_n123_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n110_), .c(new_n100_), .d(new_n91_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n97_), .d(new_n47_), .O(z18));
endmodule
