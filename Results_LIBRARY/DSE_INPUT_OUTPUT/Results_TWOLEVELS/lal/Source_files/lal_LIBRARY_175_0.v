...
module FAU ( 
  ...
  nand3  g39(.a(new_n87_), .b(new_n82_), .c(new_n50_), .O(z13));
  aoi21  g40(.a(new_n87_), .b(new_n82_), .c(z09), .O(z14));
  zero   g41(.O(z10));
  zero   g42(.O(z11));
  zero   g43(.O(z12));
  nand3  g44(.a(new_n87_), .b(new_n82_), .c(new_n50_), .O(z15));
  aoi21  g45(.a(new_n87_), .b(new_n82_), .c(z09), .O(z16));
  aoi21  g46(.a(new_n87_), .b(new_n82_), .c(z09), .O(z17));
  nand3  g47(.a(new_n87_), .b(new_n82_), .c(new_n50_), .O(z18));
endmodule
