...
module FAU ( 
  ...
  nand3  g18(.a(new_n63_), .b(new_n62_), .c(new_n49_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nand2  g20(.a(new_n47_), .b(new_n65_), .O(z02));
  nand2  g21(.a(new_n62_), .b(new_n47_), .O(z03));
  ...
  aoi21  g35(.a(new_n56_), .b(new_n52_), .c(new_n59_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(x21), .c(x23), .O(new_n82_));
  aoi21  g37(.a(x15), .b(x07), .c(x25), .O(new_n83_));
  oai21  g38(.a(new_n82_), .b(new_n50_), .c(new_n83_), .O(z08));
  inv1   g39(.a(x15), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n49_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n63_), .c(new_n47_), .O(z09));
  nand4  g42(.a(new_n63_), .b(new_n53_), .c(new_n85_), .d(new_n49_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n63_), .c(new_n85_), .d(new_n49_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n63_), .c(new_n85_), .d(new_n49_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(new_n85_), .b(x05), .c(x04), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n85_), .O(new_n99_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n100_), .d(new_n49_), .O(z13));
  nand2  g59(.a(new_n103_), .b(x21), .O(new_n105_));
  nand4  g60(.a(new_n93_), .b(new_n58_), .c(new_n52_), .d(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n49_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n85_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n100_), .O(z14));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n100_), .d(new_n49_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n112_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  nand4  g71(.a(new_n115_), .b(new_n59_), .c(new_n58_), .d(new_n52_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n101_), .c(new_n49_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(new_n85_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n100_), .O(z16));
  nand2  g75(.a(x24), .b(x23), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n98_), .c(new_n85_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n49_), .O(new_n123_));
  aoi21  g78(.a(new_n112_), .b(new_n111_), .c(new_n50_), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n50_), .c(new_n115_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n103_), .c(new_n49_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n124_), .c(new_n85_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n123_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n103_), .c(x25), .O(new_n130_));
  nor2   g85(.a(x20), .b(new_n55_), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n125_), .c(new_n131_), .d(new_n93_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n130_), .c(new_n49_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n85_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n100_), .O(z18));
endmodule
