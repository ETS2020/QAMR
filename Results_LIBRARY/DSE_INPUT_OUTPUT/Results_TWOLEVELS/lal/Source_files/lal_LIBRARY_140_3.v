...
module FAU ( 
  ...
  oai21  g38(.a(new_n83_), .b(new_n82_), .c(new_n53_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n55_), .O(new_n85_));
  nand2  g40(.a(new_n83_), .b(new_n53_), .O(new_n86_));
  ...
  nor2   g49(.a(x20), .b(new_n57_), .O(new_n95_));
  ...
  aoi21  g54(.a(new_n99_), .b(x25), .c(new_n49_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n88_), .c(new_n87_), .d(new_n85_), .O(z08));
  inv1   g56(.a(new_n63_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n48_), .c(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n50_), .O(z09));
  nand4  g59(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n50_), .O(z10));
  xor2a  g61(.a(x18), .b(x17), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n50_), .O(z11));
  nand3  g64(.a(new_n57_), .b(x18), .c(x17), .O(new_n110_));
  oai21  g65(.a(new_n94_), .b(new_n57_), .c(new_n110_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(z12));
  nand2  g68(.a(new_n95_), .b(new_n94_), .O(new_n114_));
  oai21  g69(.a(new_n102_), .b(x15), .c(new_n47_), .O(new_n115_));
  ...
  nand3  g75(.a(new_n120_), .b(new_n94_), .c(x19), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n115_), .d(new_n47_), .O(z14));
  inv1   g77(.a(new_n116_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n96_), .c(new_n54_), .O(new_n124_));
  ...
  nand3  g86(.a(new_n97_), .b(new_n89_), .c(new_n91_), .O(new_n132_));
  ...
  nand2  g91(.a(new_n98_), .b(x25), .O(new_n137_));
  nor3   g92(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n139_));
