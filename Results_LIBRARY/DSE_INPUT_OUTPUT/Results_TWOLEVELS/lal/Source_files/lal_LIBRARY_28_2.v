...
module FAU ( 
  ...
  nand2  g41(.a(new_n59_), .b(new_n52_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n47_), .c(x15), .O(z10));
  ...
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n92_), .d(new_n47_), .O(new_n96_));
  ...
  nand2  g58(.a(new_n103_), .b(new_n92_), .O(z13));
  ...
  oai21  g63(.a(new_n108_), .b(x07), .c(new_n92_), .O(z14));
  nand2  g64(.a(new_n106_), .b(x22), .O(new_n110_));
  inv1   g65(.a(x05), .O(new_n111_));
  nor2   g66(.a(x07), .b(new_n111_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(x04), .c(x15), .O(new_n113_));
  inv1   g68(.a(new_n98_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n51_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n110_), .d(new_n66_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x23), .O(new_n119_));
  nand4  g74(.a(new_n105_), .b(new_n114_), .c(new_n119_), .d(new_n81_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n113_), .d(new_n66_), .O(z16));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n115_), .c(new_n100_), .d(new_n93_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n59_), .O(new_n124_));
  aoi21  g79(.a(new_n120_), .b(x24), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x07), .c(new_n92_), .O(z17));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n115_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n101_), .c(new_n59_), .O(new_n129_));
  aoi21  g84(.a(new_n123_), .b(x25), .c(new_n129_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(x07), .c(new_n92_), .O(z18));
endmodule
