...
module FAU ( 
  ...
  nand3  g022(.a(new_n60_), .b(new_n50_), .c(new_n53_), .O(new_n68_));
  ...
  inv1   g038(.a(new_n56_), .O(new_n84_));
  ...
  nand4  g056(.a(new_n101_), .b(new_n95_), .c(new_n92_), .d(new_n91_), .O(new_n102_));
  ...
  inv1   g060(.a(x23), .O(new_n106_));
  nand2  g061(.a(new_n57_), .b(new_n54_), .O(new_n107_));
  nand3  g062(.a(new_n107_), .b(x22), .c(x21), .O(new_n108_));
  aoi21  g063(.a(new_n108_), .b(new_n106_), .c(new_n92_), .O(new_n109_));
  oai21  g064(.a(new_n109_), .b(x25), .c(new_n47_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n105_), .O(z08));
  nand3  g066(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n112_));
  inv1   g067(.a(new_n112_), .O(z09));
  inv1   g068(.a(new_n63_), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n115_));
  inv1   g070(.a(new_n115_), .O(z10));
  xor2a  g071(.a(x18), .b(x17), .O(new_n117_));
  nand4  g072(.a(new_n117_), .b(new_n114_), .c(new_n48_), .d(new_n47_), .O(new_n118_));
  ...
  nand4  g076(.a(new_n121_), .b(new_n114_), .c(new_n48_), .d(new_n47_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n50_), .O(z12));
  nand2  g078(.a(new_n98_), .b(new_n96_), .O(new_n124_));
  oai21  g079(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(new_n125_));
  ...
  nand4  g083(.a(new_n128_), .b(new_n126_), .c(new_n124_), .d(new_n47_), .O(z13));
  ...
  oai21  g088(.a(new_n133_), .b(x15), .c(new_n126_), .O(z14));
  inv1   g089(.a(new_n127_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n99_), .c(new_n54_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  aoi21  g092(.a(new_n131_), .b(x22), .c(new_n137_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(x15), .c(new_n126_), .O(z15));
  nand2  g094(.a(new_n136_), .b(x23), .O(new_n140_));
  nand4  g095(.a(new_n130_), .b(new_n135_), .c(new_n106_), .d(new_n91_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n126_), .d(new_n47_), .O(z16));
  nand3  g097(.a(new_n100_), .b(new_n91_), .c(new_n93_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x20), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(x19), .c(x18), .d(x17), .O(new_n145_));
  oai21  g100(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(new_n146_));
  ...
  nand2  g107(.a(new_n152_), .b(new_n99_), .O(new_n153_));
  oai21  g108(.a(new_n153_), .b(new_n124_), .c(new_n47_), .O(new_n154_));
  aoi21  g109(.a(new_n101_), .b(x25), .c(new_n154_), .O(new_n155_));
  oai21  g110(.a(new_n155_), .b(x15), .c(new_n126_), .O(z18));
endmodule
