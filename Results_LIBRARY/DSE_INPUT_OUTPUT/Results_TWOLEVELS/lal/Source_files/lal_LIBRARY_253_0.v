...
module FAU ( 
  ...
  nor2   g001(.a(x15), .b(x10), .O(new_n47_));
  ...
  aoi22  g024(.a(x11), .b(new_n69_), .c(new_n68_), .d(x00), .O(new_n70_));
  ...
  nor2   g035(.a(new_n80_), .b(x01), .O(new_n81_));
  inv1   g036(.a(x15), .O(new_n82_));
  nor2   g037(.a(new_n82_), .b(x10), .O(new_n83_));
  aoi21  g038(.a(new_n83_), .b(x01), .c(new_n81_), .O(new_n84_));
  ...
  nand2  g061(.a(new_n106_), .b(x10), .O(new_n107_));
  ...
  oai21  g067(.a(new_n63_), .b(x07), .c(x10), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n82_), .O(new_n114_));
  inv1   g069(.a(new_n114_), .O(z09));
  nand4  g070(.a(new_n63_), .b(new_n90_), .c(new_n82_), .d(x10), .O(new_n116_));
  nor2   g071(.a(new_n116_), .b(x07), .O(z10));
  xor2a  g072(.a(x18), .b(x17), .O(new_n118_));
  nand4  g073(.a(new_n118_), .b(new_n63_), .c(new_n82_), .d(x10), .O(new_n119_));
  nor2   g074(.a(new_n119_), .b(x07), .O(z11));
  aoi21  g075(.a(new_n54_), .b(x10), .c(new_n90_), .O(new_n121_));
  nand3  g076(.a(new_n55_), .b(x18), .c(x17), .O(new_n122_));
  oai21  g077(.a(new_n121_), .b(new_n55_), .c(new_n122_), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n63_), .c(new_n50_), .O(new_n124_));
  aoi21  g079(.a(new_n124_), .b(x10), .c(x15), .O(z12));
  nand3  g080(.a(x19), .b(x18), .c(x17), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(x20), .O(new_n127_));
  aoi21  g082(.a(new_n100_), .b(new_n99_), .c(x15), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n127_), .c(new_n114_), .d(new_n50_), .O(z13));
  nand2  g084(.a(new_n100_), .b(new_n99_), .O(new_n130_));
  nor2   g085(.a(x21), .b(x20), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n99_), .c(x19), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n82_), .c(new_n50_), .O(new_n133_));
  aoi21  g088(.a(new_n130_), .b(x21), .c(new_n133_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n114_), .O(z14));
  nand4  g090(.a(new_n82_), .b(new_n50_), .c(x05), .d(x04), .O(new_n136_));
  inv1   g091(.a(new_n126_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n101_), .c(new_n53_), .O(new_n138_));
  nand3  g093(.a(new_n138_), .b(new_n136_), .c(new_n50_), .O(new_n139_));
  aoi21  g094(.a(new_n132_), .b(x22), .c(new_n139_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n80_), .c(new_n82_), .O(z15));
  and2   g096(.a(new_n138_), .b(x23), .O(new_n142_));
  nand4  g097(.a(new_n131_), .b(new_n137_), .c(new_n108_), .d(new_n59_), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n136_), .c(new_n50_), .O(new_n144_));
  oai21  g099(.a(new_n144_), .b(new_n142_), .c(x10), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n82_), .O(z16));
  nand4  g101(.a(new_n101_), .b(x25), .c(new_n51_), .d(new_n108_), .O(new_n147_));
  oai22  g102(.a(new_n147_), .b(new_n130_), .c(new_n51_), .d(new_n108_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(x10), .O(new_n149_));
  nand2  g104(.a(new_n138_), .b(x24), .O(new_n150_));
  nand4  g105(.a(new_n101_), .b(new_n52_), .c(new_n51_), .d(new_n108_), .O(new_n151_));
  oai21  g106(.a(new_n151_), .b(new_n130_), .c(new_n82_), .O(new_n152_));
  nor2   g107(.a(new_n152_), .b(x07), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n150_), .c(new_n149_), .d(new_n114_), .O(z17));
  nand3  g109(.a(new_n103_), .b(x25), .c(x10), .O(new_n155_));
  nand3  g110(.a(new_n155_), .b(new_n153_), .c(new_n114_), .O(z18));
endmodule
