...
module FAU ( 
  ...
  oai21  g34(.a(x15), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand4  g55(.a(new_n48_), .b(new_n52_), .c(x05), .d(x04), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z09));
  nand4  g57(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n52_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n63_), .c(new_n48_), .d(new_n52_), .O(new_n106_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n63_), .c(new_n48_), .d(new_n52_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n50_), .O(z12));
  nand2  g66(.a(new_n94_), .b(new_n93_), .O(new_n112_));
  nand3  g67(.a(new_n52_), .b(x05), .c(x04), .O(new_n113_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n112_), .d(new_n48_), .O(z13));
  ...
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n115_), .d(new_n48_), .O(z14));
  inv1   g77(.a(new_n116_), .O(new_n123_));
  nor3   g78(.a(x22), .b(x21), .c(x20), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n113_), .c(new_n52_), .O(new_n126_));
  aoi21  g81(.a(new_n121_), .b(x22), .c(new_n126_), .O(new_n127_));
  nand2  g82(.a(x15), .b(new_n47_), .O(new_n128_));
  oai21  g83(.a(new_n127_), .b(x15), .c(new_n128_), .O(z15));
  inv1   g84(.a(x23), .O(new_n130_));
  aoi21  g85(.a(new_n124_), .b(new_n123_), .c(new_n130_), .O(new_n131_));
  nand4  g86(.a(new_n120_), .b(new_n123_), .c(new_n130_), .d(new_n88_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n113_), .c(new_n52_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n131_), .c(new_n48_), .O(new_n134_));
  ...
  nand4  g94(.a(new_n139_), .b(new_n138_), .c(new_n115_), .d(new_n48_), .O(z17));
  ...
  nand4  g98(.a(new_n143_), .b(new_n141_), .c(new_n115_), .d(new_n48_), .O(z18));
endmodule
