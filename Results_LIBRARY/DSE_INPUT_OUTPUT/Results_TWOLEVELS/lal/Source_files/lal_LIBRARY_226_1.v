...
module FAU ( 
  ...
  nand3  g16(.a(new_n61_), .b(new_n56_), .c(x15), .O(new_n62_));
  ...
  oai21  g39(.a(new_n84_), .b(new_n47_), .c(new_n55_), .O(z08));
  nand2  g40(.a(x05), .b(x04), .O(new_n86_));
  nor4   g41(.a(new_n86_), .b(x24), .c(x15), .d(x07), .O(z09));
  ...
  nand3  g47(.a(new_n92_), .b(new_n86_), .c(new_n88_), .O(new_n93_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n86_), .c(new_n88_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n47_), .c(x15), .O(z12));
  oai21  g55(.a(new_n86_), .b(x07), .c(new_n47_), .O(new_n101_));
  ...
  nor2   g59(.a(x20), .b(new_n95_), .O(new_n105_));
  aoi22  g60(.a(new_n105_), .b(new_n96_), .c(new_n47_), .d(x07), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n102_), .d(new_n51_), .O(z13));
  aoi21  g62(.a(new_n105_), .b(new_n96_), .c(new_n58_), .O(new_n108_));
  nand4  g63(.a(new_n51_), .b(new_n88_), .c(x05), .d(x04), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n96_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n88_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n108_), .c(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n51_), .O(z14));
  inv1   g69(.a(new_n103_), .O(new_n115_));
  nor3   g70(.a(x22), .b(x21), .c(x20), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n109_), .c(new_n88_), .O(new_n118_));
  ...
  nand4  g76(.a(new_n110_), .b(new_n115_), .c(new_n56_), .d(new_n59_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n109_), .c(new_n88_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n121_), .c(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n51_), .O(z16));
  nand2  g80(.a(new_n122_), .b(new_n88_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n102_), .c(new_n51_), .O(z17));
  nor2   g83(.a(x22), .b(x21), .O(new_n129_));
  nor2   g84(.a(x25), .b(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n129_), .c(new_n105_), .d(new_n96_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n109_), .c(new_n88_), .O(new_n132_));
