...
module FAU ( 
  ...
  nand4  g43(.a(new_n88_), .b(new_n56_), .c(new_n47_), .d(new_n51_), .O(new_n89_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n55_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n53_), .d(new_n51_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  inv1   g67(.a(x23), .O(new_n113_));
  nand3  g68(.a(new_n104_), .b(new_n113_), .c(new_n81_), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n108_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n53_), .d(new_n51_), .O(z16));
  oai21  g72(.a(new_n114_), .b(new_n99_), .c(x24), .O(new_n118_));
  nand3  g73(.a(new_n51_), .b(x05), .c(x04), .O(new_n119_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n119_), .c(new_n118_), .O(new_n125_));
  ...
  nand3  g84(.a(new_n129_), .b(new_n109_), .c(new_n120_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n119_), .O(new_n131_));
