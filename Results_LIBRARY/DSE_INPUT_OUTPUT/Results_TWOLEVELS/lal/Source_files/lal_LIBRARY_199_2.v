...
module FAU ( 
  ...
  nand3  g018(.a(new_n63_), .b(new_n50_), .c(new_n54_), .O(new_n64_));
  nand2  g019(.a(x05), .b(x04), .O(new_n65_));
  nand4  g020(.a(new_n65_), .b(new_n64_), .c(new_n50_), .d(new_n53_), .O(z01));
  inv1   g021(.a(new_n64_), .O(z03));
  ...
  nor2   g043(.a(new_n56_), .b(new_n78_), .O(new_n89_));
  ...
  nor4   g057(.a(new_n65_), .b(x15), .c(x14), .d(x07), .O(z09));
  inv1   g058(.a(x15), .O(new_n104_));
  nand4  g059(.a(new_n65_), .b(new_n78_), .c(new_n104_), .d(new_n48_), .O(new_n105_));
  nor2   g060(.a(new_n105_), .b(x07), .O(z10));
  xor2a  g061(.a(x18), .b(x17), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n65_), .c(new_n104_), .d(new_n48_), .O(new_n108_));
  ...
  nand4  g066(.a(new_n111_), .b(new_n65_), .c(new_n104_), .d(new_n48_), .O(new_n112_));
  nor2   g067(.a(new_n112_), .b(x07), .O(z12));
  nand3  g068(.a(x19), .b(x18), .c(new_n48_), .O(new_n114_));
  nand3  g069(.a(new_n54_), .b(new_n98_), .c(x15), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n114_), .c(new_n78_), .O(new_n116_));
  nand4  g071(.a(new_n58_), .b(new_n54_), .c(new_n98_), .d(x15), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(new_n118_));
  oai21  g073(.a(new_n118_), .b(new_n116_), .c(new_n55_), .O(new_n119_));
  nor2   g074(.a(new_n55_), .b(x14), .O(new_n120_));
  nor3   g075(.a(new_n79_), .b(new_n58_), .c(new_n104_), .O(new_n121_));
  oai21  g076(.a(new_n121_), .b(new_n120_), .c(new_n78_), .O(new_n122_));
  nand2  g077(.a(new_n60_), .b(new_n98_), .O(new_n123_));
  aoi21  g078(.a(new_n61_), .b(x20), .c(x23), .O(new_n124_));
  nand4  g079(.a(new_n124_), .b(new_n123_), .c(new_n54_), .d(x24), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(x15), .O(new_n126_));
  nor2   g081(.a(new_n57_), .b(new_n56_), .O(new_n127_));
  nor2   g082(.a(new_n127_), .b(new_n55_), .O(new_n128_));
  oai21  g083(.a(new_n65_), .b(x15), .c(new_n53_), .O(new_n129_));
  oai21  g084(.a(new_n129_), .b(new_n128_), .c(new_n48_), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n126_), .c(new_n122_), .d(new_n119_), .O(z13));
  nand4  g086(.a(new_n85_), .b(x19), .c(x18), .d(new_n48_), .O(new_n132_));
  aoi21  g087(.a(new_n132_), .b(new_n115_), .c(new_n78_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n118_), .c(new_n55_), .O(new_n134_));
  nand4  g089(.a(new_n59_), .b(x24), .c(x22), .d(x15), .O(new_n135_));
  inv1   g090(.a(new_n135_), .O(new_n136_));
  aoi21  g091(.a(new_n90_), .b(new_n89_), .c(x14), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n136_), .c(x21), .O(new_n138_));
  nand4  g093(.a(new_n61_), .b(new_n54_), .c(x24), .d(new_n98_), .O(new_n139_));
  aoi22  g094(.a(new_n139_), .b(x15), .c(new_n129_), .d(new_n48_), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n138_), .c(new_n134_), .O(z14));
  nand4  g096(.a(new_n91_), .b(x19), .c(x18), .d(new_n48_), .O(new_n142_));
  aoi21  g097(.a(new_n142_), .b(new_n115_), .c(new_n78_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(new_n118_), .c(new_n55_), .O(new_n144_));
  nand3  g099(.a(new_n59_), .b(x24), .c(x15), .O(new_n145_));
  aoi21  g100(.a(new_n145_), .b(x14), .c(new_n85_), .O(new_n146_));
  ...
  nand3  g115(.a(new_n54_), .b(x24), .c(new_n98_), .O(new_n161_));
  nand2  g116(.a(new_n161_), .b(x15), .O(new_n162_));
  aoi21  g117(.a(new_n127_), .b(new_n91_), .c(new_n98_), .O(new_n163_));
  oai21  g118(.a(new_n163_), .b(new_n129_), .c(new_n48_), .O(new_n164_));
  ...
  oai21  g122(.a(new_n65_), .b(x07), .c(new_n48_), .O(new_n168_));
  ...
  nand4  g129(.a(new_n54_), .b(x24), .c(new_n98_), .d(x22), .O(new_n175_));
  nand2  g130(.a(new_n175_), .b(x15), .O(new_n176_));
  nand2  g131(.a(new_n127_), .b(x17), .O(new_n177_));
  nand2  g132(.a(new_n91_), .b(new_n55_), .O(new_n178_));
  oai21  g133(.a(new_n178_), .b(new_n177_), .c(x24), .O(new_n179_));
  nand3  g134(.a(new_n179_), .b(new_n176_), .c(new_n53_), .O(new_n180_));
  aoi21  g135(.a(new_n174_), .b(new_n48_), .c(new_n180_), .O(new_n181_));
  ...
  aoi21  g139(.a(new_n57_), .b(new_n56_), .c(new_n104_), .O(new_n185_));
  aoi21  g140(.a(new_n184_), .b(x17), .c(new_n185_), .O(new_n186_));
  nand2  g141(.a(new_n60_), .b(x15), .O(new_n187_));
