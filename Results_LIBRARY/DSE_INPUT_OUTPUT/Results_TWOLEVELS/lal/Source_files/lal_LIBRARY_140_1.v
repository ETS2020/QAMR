...
module FAU ( 
  ...
  oai21  g62(.a(new_n93_), .b(new_n58_), .c(new_n107_), .O(new_n108_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n51_), .d(new_n50_), .O(z13));
  ...
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n53_), .d(new_n50_), .O(z16));
  nand3  g83(.a(new_n96_), .b(new_n88_), .c(new_n90_), .O(new_n129_));
  nor2   g84(.a(new_n129_), .b(x20), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(x19), .c(x18), .d(x17), .O(new_n131_));
  aoi21  g86(.a(new_n127_), .b(x24), .c(x07), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n131_), .c(new_n53_), .O(z17));
  nand2  g88(.a(new_n97_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n53_), .d(new_n50_), .O(z18));
endmodule
