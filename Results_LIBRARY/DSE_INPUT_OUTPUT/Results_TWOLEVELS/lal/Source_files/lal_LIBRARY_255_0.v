...
module FAU ( 
  ...
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n82_), .c(z09), .O(z13));
  nand3  g40(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(z15));
  nor2   g41(.a(x15), .b(x07), .O(z10));
  nor2   g42(.a(x15), .b(x07), .O(z11));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  aoi21  g44(.a(new_n84_), .b(new_n82_), .c(z09), .O(z14));
  aoi21  g45(.a(new_n84_), .b(new_n82_), .c(z09), .O(z16));
  nand3  g46(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(z17));
  nand3  g47(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(z18));
endmodule
