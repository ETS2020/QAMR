...
module FAU ( 
  ...
  aoi21  g22(.a(x05), .b(x04), .c(z09), .O(new_n68_));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n52_), .c(z09), .O(z08));
  nor2   g38(.a(new_n60_), .b(x25), .O(new_n86_));
  nand3  g39(.a(new_n86_), .b(new_n82_), .c(new_n49_), .O(z13));
  aoi21  g40(.a(new_n86_), .b(new_n82_), .c(z09), .O(z15));
  zero   g41(.O(z11));
  zero   g42(.O(z12));
  nor2   g43(.a(x15), .b(x07), .O(z10));
  nand3  g44(.a(new_n86_), .b(new_n82_), .c(new_n49_), .O(z14));
