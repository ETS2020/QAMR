...
module FAU ( 
  ...
  nand3  g72(.a(new_n51_), .b(x05), .c(x04), .O(new_n118_));
  ...
  oai21  g77(.a(new_n122_), .b(x07), .c(new_n51_), .O(z14));
  ...
  or2    g83(.a(new_n114_), .b(x15), .O(new_n129_));
  nand2  g84(.a(new_n125_), .b(x23), .O(new_n130_));
  nor2   g85(.a(x23), .b(x22), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n119_), .c(new_n124_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n129_), .d(new_n51_), .O(z16));
  nand3  g88(.a(new_n96_), .b(new_n88_), .c(new_n90_), .O(new_n134_));
  nor2   g89(.a(new_n134_), .b(x20), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(x19), .c(x18), .d(x17), .O(new_n136_));
  aoi21  g91(.a(new_n132_), .b(x24), .c(x15), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n136_), .c(new_n129_), .O(z17));
  nand2  g93(.a(new_n97_), .b(x25), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n139_), .c(new_n129_), .d(new_n51_), .O(z18));
endmodule
