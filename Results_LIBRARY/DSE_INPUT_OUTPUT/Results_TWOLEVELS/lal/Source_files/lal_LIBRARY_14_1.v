...
module FAU ( 
  ...
  and2   g23(.a(new_n48_), .b(x16), .O(z02));
  nand2  g24(.a(new_n60_), .b(new_n53_), .O(new_n70_));
  oai21  g25(.a(new_n70_), .b(x20), .c(x15), .O(new_n71_));
  nand2  g26(.a(new_n71_), .b(x19), .O(new_n72_));
  nand2  g27(.a(new_n55_), .b(new_n48_), .O(new_n73_));
  nand3  g28(.a(new_n64_), .b(new_n59_), .c(new_n61_), .O(new_n74_));
  aoi21  g29(.a(new_n74_), .b(new_n73_), .c(x23), .O(new_n75_));
  inv1   g30(.a(new_n48_), .O(new_n76_));
  nor2   g31(.a(new_n76_), .b(x24), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(new_n75_), .c(new_n60_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n72_), .O(z03));
  ...
  nand3  g39(.a(new_n84_), .b(new_n48_), .c(new_n46_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z04));
  nor3   g41(.a(new_n76_), .b(x13), .c(x08), .O(z05));
  nand2  g42(.a(x14), .b(new_n46_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n48_), .O(z06));
  aoi21  g44(.a(new_n46_), .b(x06), .c(new_n76_), .O(z07));
  nand3  g45(.a(x22), .b(x21), .c(x20), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n53_), .c(new_n54_), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(x25), .c(new_n48_), .O(new_n93_));
  nor3   g48(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(x24), .c(x22), .d(x21), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n93_), .O(z08));
  nand2  g51(.a(x05), .b(x04), .O(new_n97_));
  nor4   g52(.a(new_n97_), .b(x19), .c(x15), .d(x07), .O(z09));
  nand4  g53(.a(new_n97_), .b(new_n61_), .c(new_n62_), .d(new_n47_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(x07), .O(z10));
  xor2a  g55(.a(x18), .b(x17), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n97_), .c(new_n52_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n61_), .c(x15), .O(z11));
  nand4  g58(.a(new_n97_), .b(x18), .c(x17), .d(new_n52_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n61_), .c(x15), .O(z12));
  oai21  g60(.a(new_n97_), .b(x07), .c(new_n61_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n61_), .b(x07), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n59_), .d(new_n47_), .O(z13));
  inv1   g64(.a(x21), .O(new_n110_));
  nand4  g65(.a(new_n47_), .b(new_n52_), .c(x05), .d(x04), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n52_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n61_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(z14));
  nor2   g69(.a(x22), .b(x15), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n108_), .c(new_n107_), .O(z15));
  nand3  g71(.a(new_n111_), .b(new_n53_), .c(new_n52_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n61_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(z16));
  nand3  g74(.a(new_n111_), .b(new_n54_), .c(new_n52_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n61_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n47_), .O(z17));
  oai21  g77(.a(x25), .b(x07), .c(new_n61_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n107_), .c(new_n47_), .O(z18));
endmodule
