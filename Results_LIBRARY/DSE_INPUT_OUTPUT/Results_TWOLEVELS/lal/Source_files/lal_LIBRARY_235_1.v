...
module FAU ( 
  ...
  nor2   g066(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g067(.a(new_n112_), .b(new_n48_), .c(new_n109_), .O(new_n113_));
  inv1   g068(.a(new_n113_), .O(z09));
  inv1   g069(.a(new_n112_), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n58_), .c(new_n48_), .d(new_n109_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n50_), .O(z10));
  xor2a  g072(.a(x18), .b(x17), .O(new_n118_));
  nand4  g073(.a(new_n118_), .b(new_n115_), .c(new_n48_), .d(new_n109_), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(new_n50_), .O(z11));
  nand3  g075(.a(new_n60_), .b(x18), .c(x17), .O(new_n121_));
  oai21  g076(.a(new_n101_), .b(new_n60_), .c(new_n121_), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n115_), .c(new_n48_), .d(new_n109_), .O(new_n123_));
  inv1   g078(.a(new_n123_), .O(z12));
  nand2  g079(.a(new_n102_), .b(new_n101_), .O(new_n125_));
  oai21  g080(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n126_));
  ...
  nand4  g084(.a(new_n129_), .b(new_n127_), .c(new_n125_), .d(new_n48_), .O(z13));
  ...
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n127_), .d(new_n48_), .O(z14));
  nand2  g089(.a(new_n133_), .b(x22), .O(new_n135_));
  inv1   g090(.a(new_n128_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n103_), .c(new_n57_), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n135_), .c(new_n127_), .d(new_n48_), .O(z15));
  nand2  g093(.a(new_n137_), .b(x23), .O(new_n139_));
  nor2   g094(.a(x23), .b(x22), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n132_), .c(new_n136_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n139_), .c(new_n127_), .d(new_n48_), .O(z16));
  ...
  aoi21  g100(.a(new_n141_), .b(x24), .c(x15), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n145_), .c(new_n127_), .O(z17));
  ...
  nand4  g105(.a(new_n150_), .b(new_n148_), .c(new_n127_), .d(new_n48_), .O(z18));
endmodule
