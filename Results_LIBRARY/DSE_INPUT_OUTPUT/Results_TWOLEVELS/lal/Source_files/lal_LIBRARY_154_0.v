...
module FAU ( 
  ...
  nor3   g32(.a(z12), .b(x13), .c(x08), .O(z05));
  inv1   g33(.a(x14), .O(new_n79_));
  nor3   g34(.a(z12), .b(new_n79_), .c(x08), .O(z06));
  aoi21  g35(.a(new_n46_), .b(x06), .c(z12), .O(z07));
  inv1   g36(.a(new_n64_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(z12), .O(z08));
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n87_));
  aoi21  g39(.a(new_n87_), .b(new_n82_), .c(z12), .O(z13));
  nand3  g40(.a(new_n87_), .b(new_n82_), .c(new_n48_), .O(z16));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  aoi21  g44(.a(new_n87_), .b(new_n82_), .c(z12), .O(z14));
  aoi21  g45(.a(new_n87_), .b(new_n82_), .c(z12), .O(z15));
  aoi21  g46(.a(new_n87_), .b(new_n82_), .c(z12), .O(z17));
  nand3  g47(.a(new_n87_), .b(new_n82_), .c(new_n48_), .O(z18));
endmodule
