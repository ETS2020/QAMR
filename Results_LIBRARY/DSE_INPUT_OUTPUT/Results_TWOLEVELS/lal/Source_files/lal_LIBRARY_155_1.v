...
module FAU ( 
  ...
  inv1   g055(.a(new_n55_), .O(new_n101_));
  nand3  g056(.a(new_n101_), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g057(.a(new_n102_), .b(new_n52_), .c(new_n87_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n108_), .b(new_n47_), .c(new_n50_), .O(new_n109_));
  ...
  nand3  g078(.a(new_n123_), .b(new_n121_), .c(new_n59_), .O(new_n124_));
  ...
  nand2  g082(.a(new_n127_), .b(new_n50_), .O(new_n128_));
  nand2  g083(.a(new_n121_), .b(x21), .O(new_n129_));
  inv1   g084(.a(x20), .O(new_n130_));
  nand4  g085(.a(new_n91_), .b(new_n88_), .c(new_n130_), .d(x19), .O(new_n131_));
  nand4  g086(.a(new_n131_), .b(new_n129_), .c(new_n128_), .d(new_n50_), .O(z14));
  nand2  g087(.a(new_n131_), .b(x22), .O(new_n133_));
  inv1   g088(.a(new_n122_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n94_), .c(new_n130_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n133_), .c(new_n128_), .d(new_n50_), .O(z15));
  and2   g091(.a(new_n135_), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n52_), .b(new_n86_), .c(new_n88_), .d(new_n130_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n122_), .c(new_n59_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n137_), .c(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n50_), .O(z16));
  nand4  g096(.a(new_n94_), .b(x25), .c(new_n87_), .d(new_n52_), .O(new_n142_));
  oai22  g097(.a(new_n142_), .b(new_n121_), .c(new_n87_), .d(new_n52_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n47_), .O(new_n144_));
  nand2  g099(.a(new_n135_), .b(x24), .O(new_n145_));
  nand4  g100(.a(new_n94_), .b(new_n51_), .c(new_n87_), .d(new_n52_), .O(new_n146_));
  nor2   g101(.a(new_n146_), .b(new_n121_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(x07), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n145_), .c(new_n144_), .d(new_n128_), .O(z17));
  nand3  g104(.a(new_n96_), .b(x25), .c(new_n47_), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n148_), .c(new_n128_), .O(z18));
endmodule
