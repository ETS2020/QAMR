...
module FAU ( 
  ...
  or2    g55(.a(new_n100_), .b(x07), .O(new_n101_));
  ...
  nand3  g73(.a(new_n109_), .b(new_n117_), .c(new_n83_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n102_), .c(new_n47_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n101_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n102_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n57_), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n95_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n123_), .c(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n101_), .O(z17));
  nand2  g85(.a(new_n126_), .b(new_n125_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n104_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n125_), .c(new_n124_), .d(new_n95_), .O(new_n134_));
