...
module FAU ( 
  ...
  oai21  g030(.a(x13), .b(x08), .c(new_n51_), .O(z05));
  ...
  oai21  g058(.a(new_n64_), .b(x07), .c(new_n47_), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  inv1   g060(.a(new_n105_), .O(z09));
  nand3  g061(.a(new_n64_), .b(new_n80_), .c(new_n50_), .O(new_n107_));
  aoi21  g062(.a(new_n107_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g063(.a(x18), .b(x17), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n64_), .c(new_n103_), .d(new_n47_), .O(new_n110_));
  nor2   g065(.a(new_n110_), .b(x07), .O(z11));
  nand3  g066(.a(new_n56_), .b(x18), .c(x17), .O(new_n112_));
  oai21  g067(.a(new_n89_), .b(new_n56_), .c(new_n112_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n64_), .c(new_n103_), .d(new_n47_), .O(new_n114_));
  nor2   g069(.a(new_n114_), .b(x07), .O(z12));
  nand3  g070(.a(x19), .b(x18), .c(x17), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(x20), .O(new_n117_));
  nand2  g072(.a(new_n90_), .b(new_n89_), .O(new_n118_));
  inv1   g073(.a(new_n118_), .O(new_n119_));
  nor2   g074(.a(new_n119_), .b(x15), .O(new_n120_));
  nand4  g075(.a(new_n120_), .b(new_n117_), .c(new_n105_), .d(new_n50_), .O(z13));
  nor2   g076(.a(x21), .b(x20), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n89_), .c(x19), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n103_), .c(new_n50_), .O(new_n124_));
  aoi21  g079(.a(new_n118_), .b(x21), .c(new_n124_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n105_), .O(z14));
  nand2  g081(.a(new_n123_), .b(x22), .O(new_n127_));
  nand2  g082(.a(new_n91_), .b(new_n54_), .O(new_n128_));
  nor2   g083(.a(new_n128_), .b(new_n116_), .O(new_n129_));
  nor2   g084(.a(new_n129_), .b(x15), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n127_), .c(new_n105_), .d(new_n50_), .O(z15));
  nor2   g086(.a(new_n129_), .b(new_n98_), .O(new_n132_));
  nand2  g087(.a(new_n103_), .b(new_n50_), .O(new_n133_));
  or2    g088(.a(new_n133_), .b(new_n64_), .O(new_n134_));
  inv1   g089(.a(new_n116_), .O(new_n135_));
  nand4  g090(.a(new_n122_), .b(new_n135_), .c(new_n98_), .d(new_n60_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n134_), .c(new_n50_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n132_), .c(new_n47_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n103_), .O(z16));
  nand3  g094(.a(new_n92_), .b(new_n60_), .c(new_n59_), .O(new_n140_));
  nor2   g095(.a(new_n140_), .b(x20), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(x19), .c(x18), .d(x17), .O(new_n142_));
  oai21  g097(.a(new_n52_), .b(new_n98_), .c(new_n142_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n47_), .O(new_n144_));
  nor2   g099(.a(new_n129_), .b(new_n52_), .O(new_n145_));
  nor2   g100(.a(new_n145_), .b(new_n133_), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n144_), .c(new_n105_), .O(z17));
  nand2  g102(.a(new_n93_), .b(x25), .O(new_n148_));
  nor3   g103(.a(x25), .b(x24), .c(x23), .O(new_n149_));
  nand3  g104(.a(new_n149_), .b(new_n91_), .c(new_n119_), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n148_), .c(new_n134_), .d(new_n50_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n47_), .O(new_n152_));
  nand2  g107(.a(new_n152_), .b(new_n103_), .O(z18));
endmodule
