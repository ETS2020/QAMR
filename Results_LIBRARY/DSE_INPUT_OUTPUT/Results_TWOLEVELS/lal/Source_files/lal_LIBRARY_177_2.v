...
module FAU ( 
  ...
  oai21  g08(.a(x07), .b(x00), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g23(.a(x09), .b(x08), .c(x15), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(x00), .O(new_n70_));
  nand2  g25(.a(x09), .b(new_n48_), .O(new_n71_));
  ...
  nand2  g31(.a(new_n76_), .b(new_n70_), .O(z04));
  ...
  nand4  g43(.a(new_n88_), .b(x05), .c(x04), .d(new_n48_), .O(new_n89_));
  ...
  nor2   g48(.a(new_n93_), .b(x00), .O(z10));
  ...
  nand3  g69(.a(new_n114_), .b(new_n53_), .c(new_n48_), .O(new_n115_));
  ...
  oai21  g77(.a(new_n122_), .b(x00), .c(new_n53_), .O(z15));
  nor2   g78(.a(x23), .b(x22), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n113_), .c(new_n118_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n53_), .c(new_n48_), .O(new_n126_));
  ...
  oai21  g87(.a(new_n132_), .b(x00), .c(new_n53_), .O(z17));
  ...
  aoi21  g92(.a(new_n137_), .b(new_n135_), .c(new_n49_), .O(new_n138_));
