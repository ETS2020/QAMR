...
module FAU ( 
  ...
  nand3  g022(.a(new_n59_), .b(new_n50_), .c(new_n52_), .O(new_n68_));
  ...
  nand2  g058(.a(new_n56_), .b(new_n53_), .O(new_n104_));
  ...
  nand2  g075(.a(new_n95_), .b(new_n93_), .O(new_n121_));
  oai21  g076(.a(new_n61_), .b(new_n60_), .c(new_n48_), .O(new_n122_));
  ...
  nand4  g080(.a(new_n125_), .b(new_n123_), .c(new_n121_), .d(new_n47_), .O(z13));
  nand2  g081(.a(new_n121_), .b(x21), .O(new_n127_));
  nand4  g082(.a(new_n93_), .b(new_n90_), .c(new_n53_), .d(x19), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n127_), .c(new_n123_), .d(new_n47_), .O(z14));
  nand2  g084(.a(new_n128_), .b(x22), .O(new_n130_));
  inv1   g085(.a(new_n124_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n96_), .c(new_n53_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n130_), .c(new_n123_), .d(new_n47_), .O(z15));
  and2   g088(.a(new_n132_), .b(x23), .O(new_n134_));
  nand4  g089(.a(new_n103_), .b(new_n88_), .c(new_n90_), .d(new_n53_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n124_), .c(new_n47_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n134_), .c(new_n48_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n123_), .O(z16));
  nand3  g093(.a(new_n97_), .b(new_n88_), .c(new_n90_), .O(new_n139_));
  ...
  nand2  g097(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n48_), .O(new_n144_));
  aoi21  g099(.a(x24), .b(x23), .c(x15), .O(new_n145_));
  nand2  g100(.a(new_n132_), .b(x24), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n47_), .O(z17));
  nor3   g102(.a(x25), .b(x24), .c(x23), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n96_), .O(new_n149_));
  oai21  g104(.a(new_n149_), .b(new_n121_), .c(new_n47_), .O(new_n150_));
  aoi21  g105(.a(new_n98_), .b(x25), .c(new_n150_), .O(new_n151_));
  oai21  g106(.a(new_n151_), .b(x15), .c(new_n123_), .O(z18));
endmodule
