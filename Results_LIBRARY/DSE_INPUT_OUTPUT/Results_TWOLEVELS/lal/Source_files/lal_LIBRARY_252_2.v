...
module FAU ( 
  ...
  nand3  g014(.a(new_n59_), .b(new_n58_), .c(new_n47_), .O(z01));
  inv1   g015(.a(x16), .O(new_n61_));
  nor2   g016(.a(new_n48_), .b(new_n61_), .O(z02));
  inv1   g017(.a(new_n48_), .O(new_n63_));
  nand3  g018(.a(new_n57_), .b(new_n63_), .c(new_n50_), .O(new_n64_));
  ...
  nand3  g025(.a(new_n70_), .b(new_n63_), .c(new_n46_), .O(new_n71_));
  inv1   g026(.a(new_n71_), .O(z04));
  nor3   g027(.a(new_n48_), .b(x13), .c(x08), .O(z05));
  nand2  g028(.a(x14), .b(new_n46_), .O(new_n74_));
  nand2  g029(.a(new_n74_), .b(new_n63_), .O(z06));
  nand3  g030(.a(new_n63_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g031(.a(new_n53_), .O(new_n77_));
  nand3  g032(.a(x24), .b(x22), .c(x21), .O(new_n78_));
  oai21  g033(.a(new_n78_), .b(new_n77_), .c(new_n50_), .O(new_n79_));
  nand2  g034(.a(new_n79_), .b(new_n52_), .O(new_n80_));
  ...
  nor2   g043(.a(new_n88_), .b(new_n52_), .O(new_n89_));
  ...
  nand2  g054(.a(new_n54_), .b(new_n51_), .O(new_n100_));
  ...
  nand2  g061(.a(new_n59_), .b(new_n52_), .O(new_n107_));
  aoi21  g062(.a(new_n107_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g063(.a(x18), .b(x17), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n59_), .O(new_n110_));
  aoi21  g065(.a(new_n110_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g066(.a(new_n90_), .b(x18), .c(x17), .O(new_n112_));
  oai21  g067(.a(new_n89_), .b(new_n90_), .c(new_n112_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n59_), .O(new_n114_));
  aoi21  g069(.a(new_n114_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g070(.a(x19), .b(x18), .c(new_n47_), .O(new_n116_));
  nand3  g071(.a(new_n50_), .b(new_n99_), .c(x15), .O(new_n117_));
  aoi21  g072(.a(new_n117_), .b(new_n116_), .c(new_n52_), .O(new_n118_));
  nand4  g073(.a(new_n77_), .b(new_n50_), .c(new_n99_), .d(x15), .O(new_n119_));
  inv1   g074(.a(new_n119_), .O(new_n120_));
  oai21  g075(.a(new_n120_), .b(new_n118_), .c(new_n51_), .O(new_n121_));
  nand3  g076(.a(new_n81_), .b(new_n53_), .c(x15), .O(new_n122_));
  oai21  g077(.a(new_n51_), .b(x07), .c(new_n122_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n52_), .O(new_n124_));
  aoi21  g079(.a(new_n55_), .b(new_n99_), .c(new_n87_), .O(new_n125_));
  oai21  g080(.a(new_n55_), .b(new_n51_), .c(new_n99_), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(x24), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n125_), .c(new_n50_), .O(new_n128_));
  oai21  g083(.a(new_n90_), .b(new_n88_), .c(x20), .O(new_n129_));
  inv1   g084(.a(x15), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(x05), .c(x04), .O(new_n131_));
  aoi21  g086(.a(new_n131_), .b(new_n129_), .c(x07), .O(new_n132_));
  aoi21  g087(.a(new_n128_), .b(x15), .c(new_n132_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n124_), .c(new_n121_), .O(z13));
  nand4  g089(.a(new_n84_), .b(x19), .c(x18), .d(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n117_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n51_), .c(x17), .O(new_n137_));
  oai21  g092(.a(x23), .b(x21), .c(x24), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n50_), .O(new_n139_));
  oai21  g094(.a(new_n87_), .b(new_n99_), .c(new_n50_), .O(new_n140_));
  ...
  nand3  g104(.a(new_n86_), .b(new_n51_), .c(x19), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n149_), .c(new_n117_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n84_), .O(new_n152_));
  nand4  g107(.a(new_n50_), .b(x24), .c(new_n99_), .d(x22), .O(new_n153_));
  ...
  nand2  g114(.a(new_n50_), .b(x15), .O(new_n160_));
  aoi21  g115(.a(new_n160_), .b(new_n159_), .c(new_n52_), .O(new_n161_));
  nor3   g116(.a(new_n53_), .b(x25), .c(new_n130_), .O(new_n162_));
  oai21  g117(.a(new_n162_), .b(new_n161_), .c(new_n51_), .O(new_n163_));
  nand3  g118(.a(new_n55_), .b(new_n50_), .c(x15), .O(new_n164_));
  nand2  g119(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand2  g120(.a(new_n165_), .b(new_n99_), .O(new_n166_));
  aoi21  g121(.a(new_n122_), .b(new_n99_), .c(x17), .O(new_n167_));
  ...
  nand3  g125(.a(new_n50_), .b(x24), .c(new_n99_), .O(new_n171_));
  ...
  oai21  g140(.a(new_n185_), .b(new_n130_), .c(new_n184_), .O(z17));
  nand3  g141(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(new_n187_));
  oai21  g142(.a(new_n187_), .b(new_n116_), .c(new_n130_), .O(new_n188_));
  nor2   g143(.a(new_n53_), .b(new_n130_), .O(new_n189_));
  aoi21  g144(.a(new_n188_), .b(x17), .c(new_n189_), .O(new_n190_));
  nand2  g145(.a(new_n55_), .b(x15), .O(new_n191_));
  oai21  g146(.a(new_n190_), .b(x20), .c(new_n191_), .O(new_n192_));
  nor2   g147(.a(x24), .b(new_n130_), .O(new_n193_));
  aoi21  g148(.a(new_n192_), .b(new_n99_), .c(new_n193_), .O(new_n194_));
  oai21  g149(.a(new_n50_), .b(x07), .c(new_n122_), .O(new_n195_));
  nand2  g150(.a(new_n195_), .b(new_n52_), .O(new_n196_));
  nor2   g151(.a(new_n50_), .b(x07), .O(new_n197_));
