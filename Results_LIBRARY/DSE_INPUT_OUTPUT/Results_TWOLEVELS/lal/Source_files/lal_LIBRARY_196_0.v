...
module FAU ( 
  ...
  nor3   g34(.a(z10), .b(new_n79_), .c(x08), .O(z06));
  ...
  nand3  g40(.a(new_n86_), .b(new_n82_), .c(new_n49_), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z12));
  nor2   g43(.a(x15), .b(x07), .O(z11));
  aoi21  g44(.a(new_n86_), .b(new_n82_), .c(z10), .O(z15));
  aoi21  g45(.a(new_n86_), .b(new_n82_), .c(z10), .O(z16));
  aoi21  g46(.a(new_n86_), .b(new_n82_), .c(z10), .O(z17));
