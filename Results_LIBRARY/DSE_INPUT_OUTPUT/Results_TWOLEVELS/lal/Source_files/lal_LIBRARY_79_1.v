...
module FAU ( 
  ...
  nor3   g030(.a(x15), .b(x13), .c(x08), .O(z05));
  ...
  inv1   g057(.a(new_n64_), .O(new_n103_));
  nand3  g058(.a(new_n103_), .b(new_n47_), .c(new_n51_), .O(new_n104_));
  inv1   g059(.a(new_n104_), .O(z09));
  nand4  g060(.a(new_n64_), .b(new_n80_), .c(new_n47_), .d(new_n51_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n49_), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n109_));
  inv1   g064(.a(new_n109_), .O(z11));
  nand3  g065(.a(new_n56_), .b(x18), .c(x17), .O(new_n111_));
  oai21  g066(.a(new_n89_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n113_));
  ...
  nand3  g073(.a(new_n103_), .b(new_n47_), .c(new_n51_), .O(new_n119_));
  inv1   g074(.a(new_n119_), .O(new_n120_));
  nor2   g075(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand4  g076(.a(new_n121_), .b(new_n116_), .c(new_n47_), .d(new_n51_), .O(z13));
  nor2   g077(.a(new_n118_), .b(new_n59_), .O(new_n123_));
  nand3  g078(.a(new_n51_), .b(x05), .c(x04), .O(new_n124_));
  nor2   g079(.a(x21), .b(x20), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n89_), .c(x19), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n124_), .c(new_n51_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(new_n123_), .c(new_n47_), .O(new_n128_));
  nand2  g083(.a(x15), .b(x13), .O(new_n129_));
  ...
  nand4  g089(.a(new_n134_), .b(new_n131_), .c(new_n47_), .d(new_n51_), .O(z15));
  nor2   g090(.a(new_n133_), .b(new_n98_), .O(new_n136_));
  inv1   g091(.a(new_n115_), .O(new_n137_));
  nand4  g092(.a(new_n125_), .b(new_n137_), .c(new_n98_), .d(new_n60_), .O(new_n138_));
  nand3  g093(.a(new_n138_), .b(new_n124_), .c(new_n51_), .O(new_n139_));
  ...
  nand4  g103(.a(new_n148_), .b(new_n146_), .c(new_n144_), .d(new_n47_), .O(z17));
  nand2  g104(.a(new_n93_), .b(x25), .O(new_n150_));
  nor3   g105(.a(x25), .b(x24), .c(x23), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n91_), .c(new_n118_), .O(new_n152_));
  nand4  g107(.a(new_n152_), .b(new_n150_), .c(new_n124_), .d(new_n51_), .O(new_n153_));
