...
module FAU ( 
  ...
  nand2  g58(.a(new_n103_), .b(new_n56_), .O(new_n104_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n103_), .c(new_n51_), .d(new_n47_), .O(new_n111_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n101_), .c(new_n113_), .d(new_n51_), .O(z13));
  inv1   g71(.a(z09), .O(new_n117_));
  nand2  g72(.a(new_n113_), .b(x21), .O(new_n118_));
  ...
  nand3  g76(.a(new_n51_), .b(x05), .c(x04), .O(new_n122_));
  ...
  oai21  g82(.a(new_n127_), .b(x07), .c(new_n51_), .O(z15));
  inv1   g83(.a(x23), .O(new_n129_));
  aoi21  g84(.a(new_n124_), .b(new_n123_), .c(new_n129_), .O(new_n130_));
  nand4  g85(.a(new_n119_), .b(new_n123_), .c(new_n129_), .d(new_n88_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n122_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n130_), .c(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n51_), .O(z16));
  nand3  g89(.a(new_n96_), .b(new_n88_), .c(new_n90_), .O(new_n135_));
  nor2   g90(.a(new_n135_), .b(x20), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(x19), .c(x18), .d(x17), .O(new_n137_));
  aoi21  g92(.a(new_n131_), .b(x24), .c(x15), .O(new_n138_));
  nand3  g93(.a(new_n138_), .b(new_n137_), .c(new_n117_), .O(z17));
  ...
  nand4  g97(.a(new_n142_), .b(new_n140_), .c(new_n117_), .d(new_n51_), .O(z18));
endmodule
