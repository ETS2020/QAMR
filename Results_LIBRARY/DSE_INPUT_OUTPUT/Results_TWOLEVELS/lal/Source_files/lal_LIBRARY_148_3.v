...
module FAU ( 
  ...
  nand2  g42(.a(new_n48_), .b(new_n47_), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(new_n63_), .c(new_n50_), .O(z09));
  nand4  g44(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n100_), .d(new_n47_), .O(z13));
  ...
  nand2  g65(.a(new_n110_), .b(new_n105_), .O(z14));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n105_), .d(new_n47_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  aoi21  g72(.a(new_n114_), .b(new_n113_), .c(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n113_), .c(new_n117_), .d(new_n83_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n105_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nor2   g78(.a(x22), .b(x21), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n82_), .c(new_n117_), .O(new_n125_));
  or2    g80(.a(new_n125_), .b(new_n103_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n105_), .d(new_n47_), .O(z17));
  oai21  g82(.a(new_n125_), .b(new_n103_), .c(x25), .O(new_n128_));
  nor2   g83(.a(x20), .b(new_n57_), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n124_), .c(new_n129_), .d(new_n95_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n128_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n48_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n105_), .O(z18));
endmodule
