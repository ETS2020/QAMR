...
module FAU ( 
  ...
  nor2   g034(.a(new_n50_), .b(x02), .O(new_n80_));
  nor2   g035(.a(new_n51_), .b(x11), .O(new_n81_));
  ...
  nand2  g063(.a(new_n108_), .b(x11), .O(new_n109_));
  ...
  oai21  g071(.a(new_n116_), .b(x07), .c(x11), .O(new_n117_));
  nand2  g072(.a(new_n117_), .b(new_n51_), .O(new_n118_));
  inv1   g073(.a(new_n118_), .O(z09));
  nand4  g074(.a(new_n116_), .b(new_n56_), .c(new_n51_), .d(x11), .O(new_n120_));
  nor2   g075(.a(new_n120_), .b(x07), .O(z10));
  xor2a  g076(.a(x18), .b(x17), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n116_), .c(new_n51_), .d(x11), .O(new_n123_));
  nor2   g078(.a(new_n123_), .b(x07), .O(z11));
  nand3  g079(.a(new_n101_), .b(x18), .c(x17), .O(new_n125_));
  oai21  g080(.a(new_n100_), .b(new_n101_), .c(new_n125_), .O(new_n126_));
  nand4  g081(.a(new_n126_), .b(new_n116_), .c(new_n51_), .d(x11), .O(new_n127_));
  nor2   g082(.a(new_n127_), .b(x07), .O(z12));
  nand3  g083(.a(x19), .b(x18), .c(x11), .O(new_n129_));
  ...
  inv1   g099(.a(x07), .O(new_n145_));
  oai21  g100(.a(new_n116_), .b(x15), .c(new_n145_), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n144_), .c(x11), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n142_), .c(new_n137_), .d(new_n134_), .O(z13));
  inv1   g103(.a(new_n146_), .O(new_n149_));
  nor2   g104(.a(new_n149_), .b(new_n50_), .O(new_n150_));
  inv1   g105(.a(new_n150_), .O(new_n151_));
  nand2  g106(.a(new_n130_), .b(new_n96_), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n55_), .c(x17), .O(new_n153_));
  nand4  g108(.a(new_n54_), .b(x24), .c(new_n110_), .d(x21), .O(new_n154_));
  nand2  g109(.a(new_n154_), .b(x15), .O(new_n155_));
  nand2  g110(.a(new_n102_), .b(new_n100_), .O(new_n156_));
  aoi21  g111(.a(new_n156_), .b(x21), .c(new_n47_), .O(new_n157_));
  nand4  g112(.a(new_n157_), .b(new_n155_), .c(new_n153_), .d(new_n151_), .O(z14));
  nand4  g113(.a(new_n103_), .b(x19), .c(x18), .d(x11), .O(new_n159_));
  aoi21  g114(.a(new_n159_), .b(new_n130_), .c(new_n56_), .O(new_n160_));
  oai21  g115(.a(new_n160_), .b(new_n133_), .c(new_n55_), .O(new_n161_));
  nand3  g116(.a(new_n111_), .b(x24), .c(x15), .O(new_n162_));
  aoi21  g117(.a(new_n162_), .b(new_n50_), .c(new_n95_), .O(new_n163_));
  aoi21  g118(.a(new_n102_), .b(new_n100_), .c(new_n50_), .O(new_n164_));
  oai21  g119(.a(new_n164_), .b(new_n163_), .c(x22), .O(new_n165_));
  nand4  g120(.a(new_n139_), .b(new_n54_), .c(x24), .d(new_n110_), .O(new_n166_));
  aoi21  g121(.a(new_n166_), .b(x15), .c(new_n150_), .O(new_n167_));
  nand3  g122(.a(new_n167_), .b(new_n165_), .c(new_n161_), .O(z15));
  nand2  g123(.a(new_n143_), .b(new_n103_), .O(new_n169_));
  nand2  g124(.a(new_n54_), .b(x15), .O(new_n170_));
  aoi21  g125(.a(new_n170_), .b(new_n169_), .c(new_n56_), .O(new_n171_));
  nor3   g126(.a(new_n57_), .b(x25), .c(new_n51_), .O(new_n172_));
  oai21  g127(.a(new_n172_), .b(new_n171_), .c(new_n55_), .O(new_n173_));
  nand3  g128(.a(new_n59_), .b(new_n54_), .c(x15), .O(new_n174_));
  nand2  g129(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g130(.a(new_n175_), .b(new_n110_), .O(new_n176_));
  aoi21  g131(.a(new_n135_), .b(new_n110_), .c(x17), .O(new_n177_));
  ...
  nand4  g138(.a(new_n183_), .b(new_n182_), .c(new_n180_), .d(new_n48_), .O(new_n184_));
  nor2   g139(.a(new_n184_), .b(new_n177_), .O(new_n185_));
  nand3  g140(.a(new_n185_), .b(new_n176_), .c(new_n151_), .O(z16));
  ...
  nand3  g145(.a(new_n190_), .b(new_n187_), .c(new_n145_), .O(new_n191_));
  nand2  g146(.a(new_n191_), .b(x11), .O(new_n192_));
  nand4  g147(.a(new_n143_), .b(new_n103_), .c(new_n55_), .d(x17), .O(new_n193_));
  nand2  g148(.a(new_n193_), .b(x24), .O(new_n194_));
  nand4  g149(.a(new_n194_), .b(new_n192_), .c(new_n155_), .d(new_n118_), .O(z17));
  nand3  g150(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(new_n196_));
  oai21  g151(.a(new_n196_), .b(new_n129_), .c(new_n51_), .O(new_n197_));
  nor2   g152(.a(new_n57_), .b(new_n51_), .O(new_n198_));
  aoi21  g153(.a(new_n197_), .b(x17), .c(new_n198_), .O(new_n199_));
  nand2  g154(.a(new_n59_), .b(x15), .O(new_n200_));
  oai21  g155(.a(new_n199_), .b(x20), .c(new_n200_), .O(new_n201_));
  nor2   g156(.a(x24), .b(new_n51_), .O(new_n202_));
  aoi21  g157(.a(new_n201_), .b(new_n110_), .c(new_n202_), .O(new_n203_));
  oai21  g158(.a(new_n54_), .b(new_n50_), .c(new_n135_), .O(new_n204_));
  nand2  g159(.a(new_n204_), .b(new_n56_), .O(new_n205_));
  nor2   g160(.a(new_n54_), .b(new_n50_), .O(new_n206_));
  oai21  g161(.a(new_n206_), .b(new_n179_), .c(x20), .O(new_n207_));
  nand2  g162(.a(new_n187_), .b(new_n54_), .O(new_n208_));
  nand2  g163(.a(new_n208_), .b(x15), .O(new_n209_));
  oai21  g164(.a(new_n188_), .b(new_n96_), .c(x25), .O(new_n210_));
  nand2  g165(.a(new_n210_), .b(new_n149_), .O(new_n211_));
  nand2  g166(.a(new_n211_), .b(x11), .O(new_n212_));
  nand4  g167(.a(new_n212_), .b(new_n209_), .c(new_n207_), .d(new_n205_), .O(new_n213_));
