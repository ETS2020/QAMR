...
module FAU ( 
  ...
  nor3   g32(.a(z11), .b(x13), .c(x08), .O(z05));
  inv1   g33(.a(x14), .O(new_n79_));
  nor3   g34(.a(z11), .b(new_n79_), .c(x08), .O(z06));
  nand3  g35(.a(new_n49_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g36(.a(new_n66_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n52_), .c(z11), .O(z08));
  nor2   g38(.a(new_n60_), .b(x25), .O(new_n87_));
  nand3  g39(.a(new_n87_), .b(new_n82_), .c(new_n49_), .O(z13));
  aoi21  g40(.a(new_n87_), .b(new_n82_), .c(z11), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z12));
  nand3  g44(.a(new_n87_), .b(new_n82_), .c(new_n49_), .O(z15));
  aoi21  g45(.a(new_n87_), .b(new_n82_), .c(z11), .O(z16));
  aoi21  g46(.a(new_n87_), .b(new_n82_), .c(z11), .O(z17));
  aoi21  g47(.a(new_n87_), .b(new_n82_), .c(z11), .O(z18));
endmodule
