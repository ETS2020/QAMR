...
module FAU ( 
  ...
  nand2  g50(.a(new_n95_), .b(new_n59_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n93_), .b(new_n51_), .c(x19), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n59_), .O(new_n101_));
  ...
  inv1   g59(.a(x05), .O(new_n105_));
  nor2   g60(.a(x07), .b(new_n105_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(x04), .c(x15), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n93_), .c(x19), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n104_), .d(new_n66_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n107_), .d(new_n66_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n108_), .b(new_n112_), .c(new_n117_), .d(new_n81_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n107_), .d(new_n66_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n100_), .O(new_n121_));
  nand3  g76(.a(new_n113_), .b(new_n80_), .c(new_n117_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n59_), .O(new_n125_));
  ...
  nand3  g84(.a(new_n129_), .b(new_n113_), .c(new_n121_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n107_), .d(new_n66_), .O(z18));
endmodule
