...
module FAU ( 
  ...
  nand2  g050(.a(new_n95_), .b(x14), .O(new_n96_));
  ...
  oai21  g057(.a(new_n63_), .b(x07), .c(x14), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  inv1   g059(.a(new_n104_), .O(z09));
  nand4  g060(.a(new_n63_), .b(new_n79_), .c(new_n102_), .d(x14), .O(new_n106_));
  nor2   g061(.a(new_n106_), .b(x07), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand3  g063(.a(new_n108_), .b(new_n63_), .c(new_n49_), .O(new_n109_));
  aoi21  g064(.a(new_n109_), .b(x14), .c(x15), .O(z11));
  nand3  g065(.a(new_n55_), .b(x18), .c(x17), .O(new_n111_));
  oai21  g066(.a(new_n88_), .b(new_n55_), .c(new_n111_), .O(new_n112_));
  nand3  g067(.a(new_n112_), .b(new_n63_), .c(new_n49_), .O(new_n113_));
  aoi21  g068(.a(new_n113_), .b(x14), .c(x15), .O(z12));
  ...
  nand4  g081(.a(new_n102_), .b(new_n49_), .c(x05), .d(x04), .O(new_n127_));
  inv1   g082(.a(new_n115_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n90_), .c(new_n53_), .O(new_n129_));
  nand4  g084(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(new_n49_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(x14), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n102_), .O(z15));
  and2   g087(.a(new_n129_), .b(x23), .O(new_n133_));
  nand4  g088(.a(new_n121_), .b(new_n128_), .c(new_n97_), .d(new_n59_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n127_), .c(new_n49_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n133_), .c(x14), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n102_), .O(z16));
  nand3  g092(.a(new_n91_), .b(new_n59_), .c(new_n58_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n127_), .d(new_n49_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(x14), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n102_), .O(z17));
  nand2  g099(.a(new_n92_), .b(x25), .O(new_n145_));
  nor3   g100(.a(x25), .b(x24), .c(x23), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n90_), .c(new_n118_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(x14), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n104_), .c(new_n102_), .d(new_n49_), .O(z18));
endmodule
