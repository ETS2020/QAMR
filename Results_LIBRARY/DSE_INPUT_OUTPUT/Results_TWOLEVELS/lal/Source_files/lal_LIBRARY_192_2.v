...
module FAU ( 
  ...
  oai21  g024(.a(x12), .b(x08), .c(x15), .O(new_n70_));
  ...
  nand4  g067(.a(new_n51_), .b(x05), .c(x04), .d(new_n47_), .O(new_n113_));
  aoi21  g068(.a(new_n113_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g069(.a(x15), .O(new_n115_));
  nand4  g070(.a(new_n65_), .b(new_n90_), .c(new_n115_), .d(new_n51_), .O(new_n116_));
  nor2   g071(.a(new_n116_), .b(x03), .O(z10));
  xor2a  g072(.a(x18), .b(x17), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n65_), .c(new_n51_), .O(new_n119_));
  aoi21  g074(.a(new_n119_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g075(.a(new_n56_), .b(x18), .c(x17), .O(new_n121_));
  oai21  g076(.a(new_n99_), .b(new_n56_), .c(new_n121_), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n65_), .c(new_n51_), .O(new_n123_));
  aoi21  g078(.a(new_n123_), .b(new_n47_), .c(x15), .O(z12));
  nand2  g079(.a(new_n100_), .b(new_n99_), .O(new_n125_));
  nand3  g080(.a(x19), .b(x18), .c(x17), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(x20), .O(new_n127_));
  nand3  g082(.a(new_n64_), .b(new_n115_), .c(new_n51_), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n127_), .c(new_n125_), .d(new_n51_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n115_), .O(z13));
  nand2  g086(.a(new_n128_), .b(new_n51_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nor2   g088(.a(x21), .b(x20), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n99_), .c(x19), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n115_), .c(new_n47_), .O(new_n136_));
  aoi21  g091(.a(new_n125_), .b(x21), .c(new_n136_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n133_), .O(z14));
  nand2  g093(.a(new_n135_), .b(x22), .O(new_n139_));
  inv1   g094(.a(new_n126_), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n101_), .c(new_n54_), .O(new_n141_));
  and2   g096(.a(new_n141_), .b(new_n49_), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(new_n139_), .c(new_n133_), .d(new_n115_), .O(z15));
  nand4  g098(.a(new_n134_), .b(new_n140_), .c(new_n108_), .d(new_n60_), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n115_), .c(new_n47_), .O(new_n145_));
  aoi21  g100(.a(new_n141_), .b(x23), .c(new_n145_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n133_), .O(z16));
  nand3  g102(.a(new_n102_), .b(new_n60_), .c(new_n59_), .O(new_n148_));
  nor2   g103(.a(new_n148_), .b(x20), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(x19), .c(x18), .d(x17), .O(new_n150_));
  aoi21  g105(.a(new_n144_), .b(x24), .c(new_n132_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g107(.a(new_n152_), .b(new_n47_), .O(new_n153_));
  nand2  g108(.a(new_n153_), .b(new_n115_), .O(z17));
  nand2  g109(.a(new_n103_), .b(x25), .O(new_n155_));
  nor3   g110(.a(x25), .b(x24), .c(x23), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n101_), .c(new_n100_), .d(new_n99_), .O(new_n157_));
  nand4  g112(.a(new_n157_), .b(new_n155_), .c(new_n128_), .d(new_n51_), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(new_n47_), .O(new_n159_));
  nand2  g114(.a(new_n159_), .b(new_n115_), .O(z18));
endmodule
