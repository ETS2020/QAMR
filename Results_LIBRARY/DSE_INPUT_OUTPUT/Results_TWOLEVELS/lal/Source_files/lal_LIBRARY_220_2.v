...
module FAU ( 
  ...
  inv1   g032(.a(new_n49_), .O(new_n78_));
  nor3   g033(.a(new_n78_), .b(x13), .c(x08), .O(z05));
  nand2  g034(.a(new_n49_), .b(x14), .O(new_n80_));
  ...
  oai21  g039(.a(new_n84_), .b(x25), .c(new_n58_), .O(new_n85_));
  inv1   g040(.a(new_n83_), .O(new_n86_));
  oai21  g041(.a(new_n86_), .b(x25), .c(x20), .O(new_n87_));
  ...
  nand2  g054(.a(new_n99_), .b(new_n56_), .O(new_n100_));
  oai21  g055(.a(x25), .b(x24), .c(x23), .O(new_n101_));
  nand2  g056(.a(new_n101_), .b(new_n100_), .O(z08));
  inv1   g057(.a(x07), .O(new_n103_));
  nand4  g058(.a(new_n56_), .b(new_n103_), .c(x05), .d(x04), .O(new_n104_));
  inv1   g059(.a(new_n104_), .O(z09));
  nand2  g060(.a(x05), .b(x04), .O(new_n106_));
  nand4  g061(.a(new_n106_), .b(new_n58_), .c(new_n56_), .d(new_n103_), .O(new_n107_));
  nand2  g062(.a(new_n107_), .b(new_n49_), .O(z10));
  xor2a  g063(.a(x18), .b(x17), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n106_), .c(new_n56_), .d(new_n103_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n49_), .O(z11));
  nand3  g066(.a(new_n60_), .b(x18), .c(x17), .O(new_n112_));
  oai21  g067(.a(new_n92_), .b(new_n60_), .c(new_n112_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n106_), .c(new_n56_), .d(new_n103_), .O(new_n114_));
  ...
  nand2  g075(.a(new_n120_), .b(new_n56_), .O(new_n121_));
  oai21  g076(.a(new_n48_), .b(new_n56_), .c(new_n121_), .O(z13));
  aoi21  g077(.a(x05), .b(x04), .c(x07), .O(new_n123_));
  nand2  g078(.a(new_n116_), .b(x21), .O(new_n124_));
  nor2   g079(.a(x21), .b(x20), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n92_), .c(x19), .O(new_n126_));
  nand4  g081(.a(new_n126_), .b(new_n124_), .c(new_n123_), .d(new_n56_), .O(z14));
  ...
  nand4  g085(.a(new_n130_), .b(new_n128_), .c(new_n123_), .d(new_n56_), .O(z15));
  nand4  g086(.a(new_n125_), .b(new_n129_), .c(new_n48_), .d(new_n88_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n119_), .c(new_n103_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n56_), .O(new_n134_));
  nand2  g089(.a(new_n92_), .b(new_n56_), .O(new_n135_));
  nand2  g090(.a(new_n94_), .b(new_n93_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n135_), .c(x23), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n134_), .O(z16));
  nand3  g093(.a(new_n95_), .b(new_n88_), .c(new_n89_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n142_), .b(new_n141_), .c(new_n123_), .d(new_n56_), .O(z17));
  oai21  g098(.a(x25), .b(x15), .c(x23), .O(new_n144_));
  nand3  g099(.a(new_n125_), .b(new_n67_), .c(new_n88_), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n117_), .c(x25), .O(new_n146_));
  inv1   g101(.a(new_n116_), .O(new_n147_));
  nand4  g102(.a(new_n94_), .b(new_n147_), .c(new_n54_), .d(new_n48_), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n146_), .c(new_n119_), .d(new_n103_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n56_), .O(new_n150_));
