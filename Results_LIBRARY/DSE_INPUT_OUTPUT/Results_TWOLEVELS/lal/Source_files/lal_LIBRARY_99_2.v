...
module FAU ( 
  ...
  nand3  g30(.a(x15), .b(x14), .c(new_n46_), .O(new_n76_));
  ...
  aoi21  g40(.a(new_n62_), .b(new_n85_), .c(x14), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x15), .O(z09));
  inv1   g42(.a(x15), .O(new_n88_));
  nand4  g43(.a(new_n61_), .b(new_n53_), .c(new_n88_), .d(new_n47_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n61_), .c(new_n88_), .d(new_n47_), .O(new_n92_));
  ...
  nand2  g61(.a(new_n101_), .b(new_n85_), .O(new_n107_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n88_), .c(new_n47_), .O(new_n111_));
  ...
  and2   g72(.a(new_n117_), .b(new_n51_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n108_), .d(new_n88_), .O(z15));
  nand2  g74(.a(new_n117_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x21), .O(new_n121_));
  inv1   g76(.a(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n80_), .c(new_n121_), .d(new_n52_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  aoi21  g79(.a(new_n124_), .b(new_n115_), .c(new_n48_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n108_), .d(new_n88_), .O(z16));
  oai21  g81(.a(new_n123_), .b(new_n99_), .c(x24), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n116_), .c(new_n102_), .d(new_n94_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n101_), .d(new_n85_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n88_), .O(z17));
  ...
  aoi21  g91(.a(new_n136_), .b(new_n134_), .c(new_n48_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n133_), .c(new_n108_), .d(new_n88_), .O(z18));
endmodule
