...
module FAU ( 
  ...
  nand2  g067(.a(new_n112_), .b(new_n82_), .O(new_n113_));
  ...
  oai21  g077(.a(new_n108_), .b(new_n107_), .c(new_n47_), .O(new_n123_));
  ...
  nand4  g081(.a(new_n126_), .b(new_n124_), .c(new_n122_), .d(new_n51_), .O(z13));
  nand3  g082(.a(new_n51_), .b(x05), .c(x04), .O(new_n128_));
  nor2   g083(.a(x21), .b(x20), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n94_), .c(x19), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  aoi21  g086(.a(new_n122_), .b(x21), .c(new_n131_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(x07), .c(new_n51_), .O(z14));
  inv1   g088(.a(new_n125_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n96_), .c(new_n56_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n128_), .O(new_n136_));
  aoi21  g091(.a(new_n130_), .b(x22), .c(new_n136_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(x07), .c(new_n51_), .O(z15));
  nand2  g093(.a(new_n135_), .b(x23), .O(new_n139_));
  nand4  g094(.a(new_n129_), .b(new_n134_), .c(new_n55_), .d(new_n89_), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n139_), .c(new_n124_), .d(new_n51_), .O(z16));
  nand4  g096(.a(new_n96_), .b(x25), .c(new_n90_), .d(new_n55_), .O(new_n142_));
  oai22  g097(.a(new_n142_), .b(new_n122_), .c(new_n90_), .d(new_n55_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n47_), .O(new_n144_));
  nand2  g099(.a(new_n135_), .b(x24), .O(new_n145_));
  nand4  g100(.a(new_n96_), .b(new_n54_), .c(new_n90_), .d(new_n55_), .O(new_n146_));
  nor2   g101(.a(new_n146_), .b(new_n122_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(x15), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n145_), .c(new_n144_), .d(new_n124_), .O(z17));
  nand3  g104(.a(new_n98_), .b(x25), .c(new_n47_), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n148_), .c(new_n124_), .O(z18));
endmodule
