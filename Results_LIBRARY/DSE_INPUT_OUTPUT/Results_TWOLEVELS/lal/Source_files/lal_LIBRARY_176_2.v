...
module FAU ( 
  ...
  nand2  g19(.a(new_n59_), .b(new_n64_), .O(z03));
  ...
  nand3  g25(.a(new_n70_), .b(new_n64_), .c(new_n46_), .O(new_n71_));
  inv1   g26(.a(new_n71_), .O(z04));
  oai21  g27(.a(x13), .b(x08), .c(new_n64_), .O(z05));
  nand2  g28(.a(x14), .b(new_n46_), .O(new_n74_));
  nand2  g29(.a(new_n74_), .b(new_n64_), .O(z06));
  nand3  g30(.a(new_n64_), .b(new_n46_), .c(x06), .O(z07));
  nand2  g31(.a(new_n54_), .b(new_n53_), .O(new_n77_));
  nand3  g32(.a(x24), .b(x22), .c(x21), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n77_), .c(new_n50_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n52_), .O(new_n80_));
  ...
  nor2   g44(.a(x20), .b(new_n54_), .O(new_n90_));
  ...
  aoi21  g49(.a(new_n94_), .b(x25), .c(new_n48_), .O(new_n95_));
  ...
  nand2  g53(.a(new_n60_), .b(new_n52_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g55(.a(x15), .O(new_n101_));
  xor2a  g56(.a(x18), .b(x17), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n60_), .c(new_n101_), .d(new_n47_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z11));
  nand3  g59(.a(new_n54_), .b(x18), .c(x17), .O(new_n105_));
  oai21  g60(.a(new_n89_), .b(new_n54_), .c(new_n105_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n60_), .c(new_n101_), .d(new_n47_), .O(new_n107_));
  ...
  nand4  g66(.a(new_n111_), .b(new_n97_), .c(new_n109_), .d(new_n101_), .O(z13));
  inv1   g67(.a(z09), .O(new_n113_));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n101_), .O(z14));
  ...
  nand3  g76(.a(new_n121_), .b(new_n118_), .c(new_n113_), .O(z15));
  inv1   g77(.a(x23), .O(new_n123_));
  aoi21  g78(.a(new_n120_), .b(new_n119_), .c(new_n123_), .O(new_n124_));
  nand3  g79(.a(new_n101_), .b(x05), .c(x04), .O(new_n125_));
  nand4  g80(.a(new_n115_), .b(new_n119_), .c(new_n123_), .d(new_n84_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n124_), .c(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n101_), .O(z16));
  nand3  g84(.a(new_n92_), .b(new_n84_), .c(new_n86_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(x20), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(x19), .c(x18), .d(x17), .O(new_n132_));
  aoi21  g87(.a(new_n126_), .b(x24), .c(x15), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n113_), .O(z17));
  nand2  g89(.a(new_n93_), .b(x25), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n91_), .c(new_n90_), .d(new_n89_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n135_), .c(new_n113_), .d(new_n101_), .O(z18));
endmodule
