...
module FAU ( 
  ...
  aoi21  g061(.a(new_n106_), .b(x25), .c(new_n48_), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n95_), .c(new_n94_), .d(new_n92_), .O(z08));
  inv1   g063(.a(x07), .O(new_n109_));
  nand4  g064(.a(new_n47_), .b(new_n109_), .c(x05), .d(x04), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z09));
  nand2  g066(.a(x05), .b(x04), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n56_), .c(new_n47_), .d(new_n109_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n49_), .O(z10));
  xor2a  g069(.a(x18), .b(x17), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n112_), .c(new_n47_), .d(new_n109_), .O(new_n116_));
  ...
  nand4  g074(.a(new_n119_), .b(new_n112_), .c(new_n47_), .d(new_n109_), .O(new_n120_));
  ...
  nand4  g082(.a(new_n127_), .b(new_n125_), .c(new_n122_), .d(new_n47_), .O(z13));
  ...
  nand4  g086(.a(new_n131_), .b(new_n129_), .c(new_n125_), .d(new_n47_), .O(z14));
  ...
  nand2  g091(.a(x15), .b(x03), .O(new_n137_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n139_), .c(new_n125_), .d(new_n47_), .O(z16));
  ...
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n125_), .d(new_n47_), .O(z17));
  ...
  nand4  g105(.a(new_n150_), .b(new_n148_), .c(new_n125_), .d(new_n47_), .O(z18));
endmodule
