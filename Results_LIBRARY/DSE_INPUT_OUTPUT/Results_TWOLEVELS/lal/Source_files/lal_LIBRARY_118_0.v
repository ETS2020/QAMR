...
module FAU ( 
  ...
  inv1   g03(.a(z10), .O(z17));
  nand2  g04(.a(z17), .b(new_n47_), .O(z02));
  ...
  nand3  g20(.a(new_n62_), .b(z17), .c(new_n54_), .O(new_n66_));
  ...
  nand2  g28(.a(new_n73_), .b(z17), .O(z04));
  nor3   g29(.a(z10), .b(x13), .c(x08), .O(z05));
  nand2  g30(.a(x14), .b(new_n46_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(z17), .O(z06));
  nand3  g32(.a(z17), .b(new_n46_), .c(x06), .O(z07));
  ...
  nor2   g39(.a(new_n53_), .b(x07), .O(new_n87_));
  nand2  g40(.a(new_n87_), .b(new_n53_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z12));
  nor2   g43(.a(x15), .b(x07), .O(z11));
  nand2  g44(.a(new_n87_), .b(new_n53_), .O(z14));
  nand2  g45(.a(new_n87_), .b(new_n53_), .O(z15));
  nand2  g46(.a(new_n87_), .b(new_n53_), .O(z16));
  nand2  g47(.a(new_n87_), .b(new_n53_), .O(z18));
endmodule
