...
module FAU ( 
  ...
  oai21  g027(.a(x13), .b(x08), .c(new_n63_), .O(z05));
  ...
  nand2  g035(.a(new_n78_), .b(new_n50_), .O(new_n81_));
  ...
  nand4  g062(.a(new_n59_), .b(new_n52_), .c(new_n107_), .d(new_n47_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z10));
  xor2a  g064(.a(x18), .b(x17), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n59_), .c(new_n107_), .d(new_n47_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n114_), .b(new_n59_), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n47_), .c(x15), .O(z12));
  inv1   g071(.a(z09), .O(new_n117_));
  nand2  g072(.a(x19), .b(x18), .O(new_n118_));
  nand3  g073(.a(new_n50_), .b(new_n99_), .c(x15), .O(new_n119_));
  aoi21  g074(.a(new_n119_), .b(new_n118_), .c(new_n52_), .O(new_n120_));
  nand4  g075(.a(new_n77_), .b(new_n50_), .c(new_n99_), .d(x15), .O(new_n121_));
  inv1   g076(.a(new_n121_), .O(new_n122_));
  oai21  g077(.a(new_n122_), .b(new_n120_), .c(new_n51_), .O(new_n123_));
  nor3   g078(.a(new_n78_), .b(new_n77_), .c(new_n107_), .O(new_n124_));
  oai21  g079(.a(new_n124_), .b(x20), .c(new_n52_), .O(new_n125_));
  aoi21  g080(.a(new_n55_), .b(new_n99_), .c(new_n85_), .O(new_n126_));
  oai21  g081(.a(new_n55_), .b(new_n51_), .c(new_n99_), .O(new_n127_));
  nand2  g082(.a(new_n127_), .b(x24), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n126_), .c(new_n50_), .O(new_n129_));
  ...
  nand3  g087(.a(new_n132_), .b(new_n51_), .c(x17), .O(new_n133_));
  nand2  g088(.a(new_n91_), .b(new_n89_), .O(new_n134_));
  nand4  g089(.a(new_n50_), .b(x24), .c(new_n99_), .d(x21), .O(new_n135_));
  aoi22  g090(.a(new_n135_), .b(x15), .c(new_n134_), .d(x21), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n133_), .c(new_n117_), .O(z14));
  nand2  g092(.a(new_n89_), .b(new_n47_), .O(new_n138_));
  nand3  g093(.a(new_n84_), .b(new_n51_), .c(x19), .O(new_n139_));
  ...
  nand4  g098(.a(new_n143_), .b(new_n142_), .c(new_n50_), .d(new_n47_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(x15), .O(new_n145_));
  nand3  g100(.a(new_n86_), .b(new_n51_), .c(x19), .O(new_n146_));
  inv1   g101(.a(new_n146_), .O(new_n147_));
  aoi21  g102(.a(new_n147_), .b(new_n89_), .c(new_n84_), .O(new_n148_));
  nand3  g103(.a(new_n107_), .b(x05), .c(x04), .O(new_n149_));
  inv1   g104(.a(new_n149_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n148_), .c(new_n47_), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n145_), .c(new_n141_), .O(z15));
  nand3  g107(.a(new_n92_), .b(x19), .c(x18), .O(new_n153_));
  nand2  g108(.a(new_n50_), .b(x15), .O(new_n154_));
  aoi21  g109(.a(new_n154_), .b(new_n153_), .c(new_n52_), .O(new_n155_));
  nor3   g110(.a(new_n53_), .b(x25), .c(new_n107_), .O(new_n156_));
  oai21  g111(.a(new_n156_), .b(new_n155_), .c(new_n51_), .O(new_n157_));
  nand3  g112(.a(new_n55_), .b(new_n50_), .c(x15), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g114(.a(new_n159_), .b(new_n99_), .O(new_n160_));
  oai21  g115(.a(new_n124_), .b(x23), .c(new_n52_), .O(new_n161_));
  ...
  nand4  g127(.a(new_n172_), .b(new_n85_), .c(new_n84_), .d(new_n51_), .O(new_n173_));
  ...
  nand2  g133(.a(new_n92_), .b(new_n51_), .O(new_n179_));
  nor3   g134(.a(new_n179_), .b(new_n118_), .c(new_n52_), .O(new_n180_));
  oai22  g135(.a(new_n180_), .b(new_n85_), .c(new_n165_), .d(new_n107_), .O(new_n181_));
  nor2   g136(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  nand3  g137(.a(new_n182_), .b(new_n177_), .c(new_n47_), .O(z17));
  nor2   g138(.a(x24), .b(x22), .O(new_n184_));
  nand4  g139(.a(new_n184_), .b(new_n86_), .c(x19), .d(x18), .O(new_n185_));
  aoi21  g140(.a(new_n185_), .b(new_n107_), .c(new_n52_), .O(new_n186_));
  nor2   g141(.a(new_n53_), .b(new_n107_), .O(new_n187_));
  oai21  g142(.a(new_n187_), .b(new_n186_), .c(new_n51_), .O(new_n188_));
  nand2  g143(.a(new_n55_), .b(x15), .O(new_n189_));
  aoi21  g144(.a(new_n189_), .b(new_n188_), .c(x23), .O(new_n190_));
  nor2   g145(.a(x24), .b(new_n107_), .O(new_n191_));
  oai21  g146(.a(new_n191_), .b(new_n190_), .c(new_n50_), .O(new_n192_));
  nor2   g147(.a(new_n50_), .b(x07), .O(new_n193_));
  oai21  g148(.a(new_n193_), .b(new_n124_), .c(new_n52_), .O(new_n194_));
  oai21  g149(.a(new_n193_), .b(new_n163_), .c(x20), .O(new_n195_));
  nand2  g150(.a(new_n142_), .b(new_n50_), .O(new_n196_));
  nand2  g151(.a(new_n196_), .b(x15), .O(new_n197_));
  nand3  g152(.a(new_n93_), .b(new_n88_), .c(new_n84_), .O(new_n198_));
  nand3  g153(.a(new_n198_), .b(x25), .c(new_n47_), .O(new_n199_));
