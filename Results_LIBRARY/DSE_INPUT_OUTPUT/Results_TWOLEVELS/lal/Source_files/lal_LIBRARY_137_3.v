...
module FAU ( 
  ...
  nand2  g043(.a(new_n52_), .b(new_n88_), .O(new_n89_));
  ...
  inv1   g059(.a(new_n56_), .O(new_n105_));
  nand3  g060(.a(new_n105_), .b(x22), .c(x21), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(new_n53_), .c(new_n88_), .O(new_n107_));
  oai21  g062(.a(new_n107_), .b(x25), .c(new_n47_), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n104_), .O(z08));
  nand3  g064(.a(new_n61_), .b(new_n48_), .c(new_n47_), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z09));
  nand4  g066(.a(new_n60_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n50_), .O(z10));
  xor2a  g068(.a(x18), .b(x17), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n60_), .c(new_n48_), .d(new_n47_), .O(new_n115_));
  ...
  inv1   g087(.a(new_n98_), .O(new_n133_));
  nor3   g088(.a(new_n124_), .b(new_n133_), .c(x20), .O(new_n134_));
  ...
  nand2  g092(.a(new_n137_), .b(new_n123_), .O(z15));
  nor2   g093(.a(new_n134_), .b(new_n53_), .O(new_n139_));
  inv1   g094(.a(new_n124_), .O(new_n140_));
  nand4  g095(.a(new_n127_), .b(new_n140_), .c(new_n53_), .d(new_n91_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n47_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n139_), .c(new_n48_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n123_), .O(z16));
  nand3  g099(.a(new_n99_), .b(new_n91_), .c(new_n92_), .O(new_n145_));
  nor2   g100(.a(new_n145_), .b(x20), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(x19), .c(x18), .d(x17), .O(new_n147_));
  aoi21  g102(.a(new_n141_), .b(x24), .c(x07), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n48_), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n123_), .O(z17));
  nor4   g106(.a(new_n133_), .b(new_n122_), .c(new_n89_), .d(x23), .O(new_n152_));
  aoi21  g107(.a(new_n100_), .b(x25), .c(new_n152_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n60_), .c(new_n48_), .d(new_n47_), .O(z18));
endmodule
