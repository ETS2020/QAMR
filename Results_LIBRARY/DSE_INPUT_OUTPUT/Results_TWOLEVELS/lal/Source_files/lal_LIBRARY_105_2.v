...
module FAU ( 
  ...
  nand3  g064(.a(new_n109_), .b(new_n51_), .c(new_n47_), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z09));
  inv1   g066(.a(new_n109_), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n82_), .c(new_n51_), .d(new_n47_), .O(new_n113_));
  ...
  oai21  g073(.a(new_n94_), .b(new_n58_), .c(new_n118_), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n112_), .c(new_n51_), .d(new_n47_), .O(new_n120_));
  ...
  nand2  g084(.a(new_n129_), .b(new_n51_), .O(new_n130_));
  nand2  g085(.a(new_n122_), .b(x21), .O(new_n131_));
  nand4  g086(.a(new_n94_), .b(new_n91_), .c(new_n56_), .d(x19), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n51_), .O(z14));
  inv1   g088(.a(new_n123_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n96_), .c(new_n56_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n125_), .O(new_n136_));
  aoi21  g091(.a(new_n132_), .b(x22), .c(new_n136_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(x07), .c(new_n51_), .O(z15));
  and2   g093(.a(new_n135_), .b(x23), .O(new_n139_));
  nand4  g094(.a(new_n55_), .b(new_n89_), .c(new_n91_), .d(new_n56_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n123_), .c(new_n125_), .O(new_n141_));
  oai21  g096(.a(new_n141_), .b(new_n139_), .c(new_n47_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n51_), .O(z16));
  nand4  g098(.a(new_n96_), .b(x25), .c(new_n90_), .d(new_n55_), .O(new_n144_));
  oai22  g099(.a(new_n144_), .b(new_n122_), .c(new_n90_), .d(new_n55_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n47_), .O(new_n146_));
  nand2  g101(.a(new_n135_), .b(x24), .O(new_n147_));
  nand4  g102(.a(new_n96_), .b(new_n54_), .c(new_n90_), .d(new_n55_), .O(new_n148_));
  nor2   g103(.a(new_n148_), .b(new_n122_), .O(new_n149_));
  nor2   g104(.a(new_n149_), .b(x15), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n147_), .c(new_n146_), .d(new_n130_), .O(z17));
  nand3  g106(.a(new_n98_), .b(x25), .c(new_n47_), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n150_), .c(new_n130_), .O(z18));
endmodule
