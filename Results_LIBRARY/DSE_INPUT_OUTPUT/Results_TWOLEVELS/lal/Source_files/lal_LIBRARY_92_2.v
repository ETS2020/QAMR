...
module FAU ( 
  ...
  nand2  g22(.a(new_n64_), .b(new_n56_), .O(new_n68_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n101_), .d(new_n53_), .O(z14));
  nand2  g64(.a(new_n108_), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n53_), .b(x05), .c(x04), .O(new_n111_));
  inv1   g66(.a(new_n102_), .O(new_n112_));
  nor3   g67(.a(x22), .b(x21), .c(x20), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n110_), .O(new_n115_));
  ...
  nand4  g74(.a(new_n107_), .b(new_n112_), .c(new_n118_), .d(new_n82_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n119_), .c(new_n48_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n53_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n104_), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n81_), .c(new_n118_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n101_), .d(new_n53_), .O(z17));
  oai21  g85(.a(new_n127_), .b(new_n104_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n126_), .c(new_n125_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n131_), .c(new_n111_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n53_), .O(z18));
endmodule
