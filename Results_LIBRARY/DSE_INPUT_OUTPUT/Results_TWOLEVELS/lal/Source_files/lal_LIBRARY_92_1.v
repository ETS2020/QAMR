...
module FAU ( 
  ...
  nand4  g40(.a(new_n48_), .b(new_n53_), .c(x05), .d(x04), .O(new_n86_));
  ...
  aoi21  g47(.a(new_n92_), .b(new_n48_), .c(x07), .O(z11));
  nor2   g48(.a(new_n57_), .b(new_n56_), .O(new_n94_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .d(new_n53_), .O(z13));
  or2    g59(.a(new_n99_), .b(x07), .O(new_n105_));
  ...
  nor2   g67(.a(new_n112_), .b(new_n100_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n64_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n48_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n53_), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  nor2   g73(.a(new_n113_), .b(new_n118_), .O(new_n119_));
  inv1   g74(.a(new_n100_), .O(new_n120_));
  nand4  g75(.a(new_n107_), .b(new_n120_), .c(new_n118_), .d(new_n81_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n63_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n119_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n53_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nand3  g80(.a(new_n111_), .b(new_n80_), .c(new_n118_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n103_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n105_), .d(new_n53_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n103_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n111_), .c(new_n102_), .d(new_n94_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n63_), .O(new_n132_));
