...
module FAU ( 
  ...
  nor2   g005(.a(x15), .b(new_n46_), .O(new_n51_));
  ...
  oai21  g016(.a(new_n61_), .b(new_n51_), .c(new_n50_), .O(z01));
  inv1   g017(.a(x16), .O(new_n63_));
  aoi21  g018(.a(new_n48_), .b(x08), .c(new_n63_), .O(z02));
  inv1   g019(.a(new_n51_), .O(new_n65_));
  nand3  g020(.a(new_n60_), .b(new_n65_), .c(new_n52_), .O(new_n66_));
  ...
  nor2   g047(.a(x20), .b(new_n56_), .O(new_n93_));
  ...
  aoi21  g052(.a(new_n97_), .b(x25), .c(new_n51_), .O(new_n98_));
  nand4  g053(.a(new_n98_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(z08));
  nand2  g054(.a(x05), .b(x04), .O(new_n100_));
  nor4   g055(.a(new_n100_), .b(x15), .c(x08), .d(x07), .O(z09));
  nand4  g056(.a(new_n100_), .b(new_n54_), .c(new_n48_), .d(new_n46_), .O(new_n102_));
  nor2   g057(.a(new_n102_), .b(x07), .O(z10));
  xor2a  g058(.a(x18), .b(x17), .O(new_n104_));
  nand4  g059(.a(new_n104_), .b(new_n100_), .c(new_n48_), .d(new_n46_), .O(new_n105_));
  nor2   g060(.a(new_n105_), .b(x07), .O(z11));
  nand3  g061(.a(new_n56_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g062(.a(new_n92_), .b(new_n56_), .c(new_n107_), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n100_), .c(new_n48_), .d(new_n46_), .O(new_n109_));
  nor2   g064(.a(new_n109_), .b(x07), .O(z12));
  inv1   g065(.a(x07), .O(new_n111_));
  nand4  g066(.a(new_n48_), .b(new_n111_), .c(x05), .d(x04), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n46_), .O(new_n114_));
  nand3  g069(.a(x19), .b(x18), .c(x17), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(x20), .O(new_n116_));
  nand2  g071(.a(new_n93_), .b(new_n92_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(new_n118_));
  nor2   g073(.a(new_n118_), .b(new_n51_), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n116_), .c(new_n114_), .d(new_n48_), .O(z13));
  nor2   g075(.a(new_n118_), .b(new_n89_), .O(new_n121_));
  nor2   g076(.a(x21), .b(x20), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n92_), .c(x19), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n112_), .c(new_n111_), .O(new_n124_));
  oai21  g079(.a(new_n124_), .b(new_n121_), .c(new_n46_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n48_), .O(z14));
  inv1   g081(.a(new_n115_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n94_), .c(new_n53_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n112_), .c(new_n111_), .O(new_n129_));
  aoi21  g084(.a(new_n123_), .b(x22), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x08), .c(new_n48_), .O(z15));
  ...
  nand3  g089(.a(new_n134_), .b(new_n112_), .c(new_n111_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n132_), .c(new_n46_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n48_), .O(z16));
  nand3  g092(.a(new_n95_), .b(new_n88_), .c(new_n89_), .O(new_n138_));
  nor2   g093(.a(new_n138_), .b(x20), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(x19), .c(x18), .d(x17), .O(new_n140_));
  nand2  g095(.a(new_n48_), .b(new_n46_), .O(new_n141_));
  aoi21  g096(.a(new_n134_), .b(x24), .c(new_n141_), .O(new_n142_));
  nand3  g097(.a(new_n142_), .b(new_n140_), .c(new_n114_), .O(z17));
  nand2  g098(.a(new_n96_), .b(x25), .O(new_n144_));
  inv1   g099(.a(new_n94_), .O(new_n145_));
  nor3   g100(.a(new_n145_), .b(new_n86_), .c(x23), .O(new_n146_));
  aoi21  g101(.a(new_n146_), .b(new_n118_), .c(new_n51_), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n144_), .c(new_n114_), .d(new_n48_), .O(z18));
endmodule
