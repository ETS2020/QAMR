...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n60_), .c(new_n89_), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n60_), .c(new_n89_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n99_), .d(new_n49_), .O(z13));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n102_), .d(new_n49_), .O(z14));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n102_), .d(new_n49_), .O(z15));
  ...
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n102_), .d(new_n49_), .O(z16));
  nor2   g73(.a(x24), .b(x23), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n112_), .c(new_n103_), .d(new_n93_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n60_), .O(new_n121_));
  aoi21  g76(.a(new_n117_), .b(x24), .c(new_n121_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(x07), .c(new_n89_), .O(z17));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n104_), .c(new_n60_), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x25), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x07), .c(new_n89_), .O(z18));
endmodule
