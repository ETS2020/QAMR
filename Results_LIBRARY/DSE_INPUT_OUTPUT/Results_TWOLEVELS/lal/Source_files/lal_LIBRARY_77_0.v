...
module FAU ( 
  ...
  nand2  g40(.a(new_n63_), .b(new_n62_), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  inv1   g45(.a(new_n47_), .O(z15));
  nand2  g46(.a(new_n63_), .b(new_n62_), .O(z16));
  inv1   g47(.a(new_n47_), .O(z17));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z18));
endmodule
