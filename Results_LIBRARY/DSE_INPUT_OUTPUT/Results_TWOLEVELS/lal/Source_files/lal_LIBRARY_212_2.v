...
module FAU ( 
  ...
  nand4  g54(.a(new_n61_), .b(new_n53_), .c(new_n97_), .d(new_n47_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z10));
  xor2a  g56(.a(x18), .b(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n61_), .O(new_n103_));
  ...
  aoi21  g62(.a(new_n107_), .b(new_n47_), .c(x15), .O(z12));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n97_), .O(z13));
  or2    g68(.a(new_n110_), .b(x15), .O(new_n114_));
  nand2  g69(.a(new_n109_), .b(x21), .O(new_n115_));
  nor2   g70(.a(x21), .b(x20), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n89_), .c(x19), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n97_), .O(z14));
  ...
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n114_), .O(z15));
  inv1   g78(.a(x23), .O(new_n124_));
  aoi21  g79(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(new_n125_));
  nand3  g80(.a(new_n97_), .b(x05), .c(x04), .O(new_n126_));
  nand4  g81(.a(new_n116_), .b(new_n120_), .c(new_n124_), .d(new_n84_), .O(new_n127_));
  ...
  nand3  g85(.a(new_n92_), .b(new_n84_), .c(new_n86_), .O(new_n131_));
  nor2   g86(.a(new_n131_), .b(x20), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(x19), .c(x18), .d(x17), .O(new_n133_));
  aoi21  g88(.a(new_n127_), .b(x24), .c(x15), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n133_), .c(new_n114_), .O(z17));
  nand2  g90(.a(new_n93_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n91_), .c(new_n90_), .d(new_n89_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n114_), .d(new_n97_), .O(z18));
endmodule
