...
module FAU ( 
  ...
  nand2  g76(.a(new_n95_), .b(new_n53_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(new_n114_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(x07), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n113_), .O(z15));
  inv1   g82(.a(x23), .O(new_n128_));
  nor2   g83(.a(new_n123_), .b(new_n128_), .O(new_n129_));
  inv1   g84(.a(new_n114_), .O(new_n130_));
  nand4  g85(.a(new_n118_), .b(new_n130_), .c(new_n128_), .d(new_n88_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n129_), .c(new_n48_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n113_), .O(z16));
  ...
  nand4  g93(.a(new_n138_), .b(new_n137_), .c(new_n113_), .d(new_n47_), .O(z17));
  ...
  nand4  g97(.a(new_n142_), .b(new_n140_), .c(new_n113_), .d(new_n47_), .O(z18));
endmodule
