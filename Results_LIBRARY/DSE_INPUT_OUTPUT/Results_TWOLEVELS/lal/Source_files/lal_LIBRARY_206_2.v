...
module FAU ( 
  ...
  nor2   g068(.a(new_n113_), .b(x15), .O(z09));
  ...
  nand4  g073(.a(new_n118_), .b(new_n65_), .c(new_n115_), .d(new_n51_), .O(new_n119_));
  nor2   g074(.a(new_n119_), .b(x03), .O(z11));
  nand3  g075(.a(new_n56_), .b(x18), .c(x17), .O(new_n121_));
  oai21  g076(.a(new_n99_), .b(new_n56_), .c(new_n121_), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n65_), .c(new_n115_), .d(new_n51_), .O(new_n123_));
  nor2   g078(.a(new_n123_), .b(x03), .O(z12));
  nand3  g079(.a(new_n64_), .b(new_n115_), .c(new_n51_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n51_), .O(new_n126_));
  ...
  nand4  g087(.a(new_n132_), .b(new_n129_), .c(new_n127_), .d(new_n115_), .O(z13));
  ...
  nand3  g091(.a(new_n136_), .b(new_n125_), .c(new_n51_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n134_), .c(new_n47_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n115_), .O(z14));
  nand2  g094(.a(new_n136_), .b(x22), .O(new_n140_));
  nand2  g095(.a(new_n101_), .b(new_n54_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(new_n128_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(new_n48_), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n140_), .c(new_n127_), .d(new_n115_), .O(z15));
  nor2   g099(.a(new_n142_), .b(new_n108_), .O(new_n145_));
  inv1   g100(.a(new_n128_), .O(new_n146_));
  nand4  g101(.a(new_n135_), .b(new_n146_), .c(new_n108_), .d(new_n60_), .O(new_n147_));
  nand3  g102(.a(new_n147_), .b(new_n125_), .c(new_n51_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n145_), .c(new_n47_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n115_), .O(z16));
  nand3  g105(.a(new_n102_), .b(new_n60_), .c(new_n59_), .O(new_n151_));
  ...
  nand2  g111(.a(new_n156_), .b(new_n115_), .O(z17));
  nand4  g112(.a(new_n51_), .b(x05), .c(x04), .d(new_n47_), .O(new_n158_));
  nand4  g113(.a(new_n101_), .b(new_n53_), .c(new_n52_), .d(new_n108_), .O(new_n159_));
  oai21  g114(.a(new_n159_), .b(new_n130_), .c(new_n51_), .O(new_n160_));
  aoi21  g115(.a(new_n103_), .b(x25), .c(new_n160_), .O(new_n161_));
  nand4  g116(.a(new_n161_), .b(new_n158_), .c(new_n115_), .d(new_n47_), .O(z18));
endmodule
