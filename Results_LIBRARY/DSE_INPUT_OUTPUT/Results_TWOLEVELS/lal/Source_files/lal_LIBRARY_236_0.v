...
module FAU ( 
  ...
  nor2   g39(.a(new_n51_), .b(x07), .O(new_n88_));
  nand2  g40(.a(new_n88_), .b(new_n51_), .O(z15));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  inv1   g44(.a(z12), .O(z14));
  inv1   g45(.a(z12), .O(z16));
  nand2  g46(.a(new_n88_), .b(new_n51_), .O(z17));
  nand2  g47(.a(new_n88_), .b(new_n51_), .O(z18));
endmodule
