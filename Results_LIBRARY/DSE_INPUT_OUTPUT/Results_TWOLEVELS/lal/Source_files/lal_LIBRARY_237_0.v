...
module FAU ( 
  ...
  nand2  g21(.a(new_n62_), .b(z15), .O(z03));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n53_), .c(z10), .O(z08));
  nand2  g38(.a(new_n65_), .b(new_n64_), .O(z13));
  zero   g39(.O(z09));
  zero   g40(.O(z11));
  zero   g41(.O(z12));
  nand2  g42(.a(new_n65_), .b(new_n64_), .O(z14));
  inv1   g43(.a(z10), .O(z16));
  inv1   g44(.a(z10), .O(z17));
  nand2  g45(.a(new_n65_), .b(new_n64_), .O(z18));
endmodule
