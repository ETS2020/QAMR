...
module FAU ( 
  ...
  nor2   g08(.a(new_n49_), .b(x24), .O(new_n54_));
  ...
  aoi21  g17(.a(x24), .b(new_n61_), .c(new_n62_), .O(new_n63_));
  aoi21  g18(.a(new_n63_), .b(new_n60_), .c(x23), .O(new_n64_));
  oai21  g19(.a(new_n64_), .b(new_n54_), .c(new_n53_), .O(new_n65_));
  ...
  aoi21  g37(.a(new_n59_), .b(new_n55_), .c(new_n62_), .O(new_n83_));
  ...
  nor4   g41(.a(new_n66_), .b(x23), .c(x15), .d(x07), .O(z09));
  inv1   g42(.a(x15), .O(new_n88_));
  nand4  g43(.a(new_n66_), .b(new_n48_), .c(new_n56_), .d(new_n88_), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n66_), .c(new_n48_), .d(new_n88_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n66_), .c(new_n48_), .d(new_n88_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z12));
  inv1   g53(.a(x07), .O(new_n99_));
  oai21  g54(.a(new_n66_), .b(x07), .c(new_n48_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n88_), .O(new_n101_));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand4  g58(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nor2   g60(.a(new_n105_), .b(x15), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n103_), .c(new_n101_), .d(new_n99_), .O(z13));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n94_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n88_), .c(new_n99_), .O(new_n110_));
  ...
  nand3  g69(.a(new_n108_), .b(new_n48_), .c(new_n62_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n114_), .c(x15), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n101_), .d(new_n99_), .O(z15));
  nand3  g73(.a(new_n67_), .b(new_n88_), .c(new_n99_), .O(new_n119_));
  nor3   g74(.a(x22), .b(x21), .c(x20), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n114_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n99_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n88_), .O(z16));
  aoi21  g79(.a(new_n120_), .b(new_n114_), .c(new_n82_), .O(new_n125_));
  nand4  g80(.a(new_n108_), .b(new_n114_), .c(new_n82_), .d(new_n62_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n119_), .c(new_n99_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n125_), .c(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n88_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  nand4  g85(.a(new_n53_), .b(new_n82_), .c(new_n62_), .d(new_n61_), .O(new_n131_));
  inv1   g86(.a(new_n131_), .O(new_n132_));
  aoi21  g87(.a(new_n132_), .b(new_n105_), .c(x15), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n101_), .d(new_n99_), .O(z18));
endmodule
