...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n88_), .c(new_n47_), .d(new_n51_), .O(new_n92_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n86_), .d(new_n51_), .O(z13));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n104_), .d(new_n51_), .O(z15));
  ...
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n104_), .d(new_n51_), .O(z16));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n111_), .c(new_n101_), .d(new_n94_), .O(new_n119_));
