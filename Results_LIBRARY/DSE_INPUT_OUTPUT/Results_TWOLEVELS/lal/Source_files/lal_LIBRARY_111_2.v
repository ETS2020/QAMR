...
module FAU ( 
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n49_), .O(z13));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n94_), .c(x19), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n85_), .O(new_n106_));
  ...
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n85_), .O(new_n113_));
  ...
  nand3  g72(.a(new_n104_), .b(new_n116_), .c(new_n80_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n99_), .c(new_n85_), .O(new_n119_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n122_), .c(new_n85_), .O(new_n127_));
  ...
  nand4  g86(.a(new_n131_), .b(new_n124_), .c(new_n123_), .d(new_n94_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n101_), .d(new_n49_), .O(z18));
endmodule
