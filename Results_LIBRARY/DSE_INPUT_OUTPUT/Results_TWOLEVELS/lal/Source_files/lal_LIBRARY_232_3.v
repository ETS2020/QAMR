...
module FAU ( 
  ...
  nand2  g37(.a(new_n56_), .b(new_n55_), .O(new_n83_));
  nand3  g38(.a(x24), .b(x22), .c(x21), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  nand2  g41(.a(new_n84_), .b(new_n52_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(x20), .O(new_n88_));
  oai21  g43(.a(x25), .b(x24), .c(x23), .O(new_n89_));
  inv1   g44(.a(x22), .O(new_n90_));
  inv1   g45(.a(x24), .O(new_n91_));
  inv1   g46(.a(x21), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(x19), .c(x18), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  nor2   g49(.a(new_n55_), .b(new_n54_), .O(new_n95_));
  nor2   g50(.a(x20), .b(new_n56_), .O(new_n96_));
  nor2   g51(.a(x22), .b(x21), .O(new_n97_));
  nor2   g52(.a(x24), .b(x23), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n94_), .c(new_n91_), .d(new_n90_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(x25), .c(new_n49_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n89_), .c(new_n88_), .d(new_n86_), .O(z08));
  nand3  g57(.a(new_n62_), .b(new_n48_), .c(new_n47_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z09));
  nand4  g59(.a(new_n61_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(z10));
  xor2a  g61(.a(x18), .b(x17), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(z11));
  nand3  g64(.a(new_n56_), .b(x18), .c(x17), .O(new_n110_));
  oai21  g65(.a(new_n95_), .b(new_n56_), .c(new_n110_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(z12));
  nand2  g68(.a(new_n96_), .b(new_n95_), .O(new_n114_));
  oai21  g69(.a(new_n62_), .b(x15), .c(new_n47_), .O(new_n115_));
  nand3  g70(.a(x19), .b(x18), .c(x17), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(x20), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n47_), .O(z13));
  nand2  g73(.a(new_n114_), .b(x21), .O(new_n119_));
  nor2   g74(.a(x21), .b(x20), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n95_), .c(x19), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n115_), .d(new_n47_), .O(z14));
  inv1   g77(.a(new_n116_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n97_), .c(new_n53_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  aoi21  g80(.a(new_n121_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n115_), .O(z15));
  nand2  g82(.a(new_n124_), .b(x23), .O(new_n128_));
  nor2   g83(.a(x23), .b(x22), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n120_), .c(new_n123_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n115_), .d(new_n47_), .O(z16));
  nand3  g86(.a(new_n98_), .b(new_n90_), .c(new_n92_), .O(new_n132_));
  ...
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n115_), .d(new_n47_), .O(z17));
  nand2  g91(.a(new_n99_), .b(x25), .O(new_n137_));
  nor3   g92(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n115_), .d(new_n47_), .O(z18));
endmodule
