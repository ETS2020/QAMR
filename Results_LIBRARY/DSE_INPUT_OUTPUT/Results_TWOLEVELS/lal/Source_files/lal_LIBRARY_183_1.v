...
module FAU ( 
  ...
  nand3  g016(.a(new_n53_), .b(x05), .c(x04), .O(new_n62_));
  inv1   g017(.a(new_n62_), .O(new_n63_));
  aoi21  g018(.a(new_n61_), .b(new_n54_), .c(new_n63_), .O(new_n64_));
  oai21  g019(.a(new_n64_), .b(x15), .c(new_n53_), .O(z01));
  nand2  g020(.a(new_n61_), .b(new_n54_), .O(new_n66_));
  nand2  g021(.a(new_n66_), .b(new_n50_), .O(z03));
  ...
  oai21  g029(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  inv1   g030(.a(x14), .O(new_n76_));
  nor3   g031(.a(new_n49_), .b(new_n76_), .c(x08), .O(z06));
  aoi21  g032(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  inv1   g033(.a(new_n57_), .O(new_n79_));
  ...
  inv1   g055(.a(new_n58_), .O(new_n101_));
  nand3  g056(.a(new_n101_), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g057(.a(new_n102_), .b(new_n55_), .c(new_n87_), .O(new_n103_));
  ...
  nand2  g063(.a(new_n108_), .b(new_n56_), .O(new_n109_));
  ...
  aoi21  g067(.a(new_n112_), .b(new_n48_), .c(x07), .O(z11));
  nand3  g068(.a(new_n92_), .b(x18), .c(x17), .O(new_n114_));
  oai21  g069(.a(new_n91_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n108_), .c(new_n48_), .d(new_n53_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n120_), .b(new_n118_), .c(new_n62_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n48_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n53_), .O(z13));
  ...
  nand4  g082(.a(new_n127_), .b(new_n125_), .c(new_n124_), .d(new_n53_), .O(z14));
  nand2  g083(.a(new_n127_), .b(x22), .O(new_n129_));
  inv1   g084(.a(x20), .O(new_n130_));
  inv1   g085(.a(new_n119_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n94_), .c(new_n130_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n129_), .c(new_n124_), .d(new_n53_), .O(z15));
  nand2  g088(.a(new_n132_), .b(x23), .O(new_n134_));
  nand4  g089(.a(new_n126_), .b(new_n131_), .c(new_n55_), .d(new_n86_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n134_), .c(new_n124_), .d(new_n53_), .O(z16));
  nand4  g091(.a(new_n94_), .b(x25), .c(new_n87_), .d(new_n55_), .O(new_n137_));
  oai22  g092(.a(new_n137_), .b(new_n118_), .c(new_n87_), .d(new_n55_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n48_), .O(new_n139_));
  nand2  g094(.a(new_n132_), .b(x24), .O(new_n140_));
  nand4  g095(.a(new_n94_), .b(new_n54_), .c(new_n87_), .d(new_n55_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(new_n118_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(x07), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n140_), .c(new_n139_), .d(new_n124_), .O(z17));
  nand3  g099(.a(new_n96_), .b(x25), .c(new_n48_), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n143_), .c(new_n124_), .O(z18));
endmodule
