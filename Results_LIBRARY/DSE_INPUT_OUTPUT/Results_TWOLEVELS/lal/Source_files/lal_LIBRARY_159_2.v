...
module FAU ( 
  ...
  aoi21  g36(.a(new_n47_), .b(x07), .c(x25), .O(new_n82_));
  oai21  g37(.a(new_n81_), .b(new_n78_), .c(new_n82_), .O(z08));
  aoi21  g38(.a(new_n61_), .b(new_n50_), .c(x15), .O(z09));
  nand4  g39(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n50_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z10));
  xor2a  g41(.a(x18), .b(x17), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n50_), .c(x15), .O(z11));
  nor2   g44(.a(new_n54_), .b(new_n53_), .O(new_n90_));
  nand3  g45(.a(new_n55_), .b(x18), .c(x17), .O(new_n91_));
  oai21  g46(.a(new_n90_), .b(new_n55_), .c(new_n91_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n61_), .c(new_n47_), .d(new_n50_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z12));
  nand3  g49(.a(x19), .b(x18), .c(x17), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(x20), .O(new_n96_));
  nor2   g51(.a(x20), .b(new_n55_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n90_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(new_n99_));
  ...
  nor2   g58(.a(x07), .b(new_n103_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(x04), .c(x15), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n90_), .c(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n102_), .d(new_n48_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n95_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n105_), .d(new_n48_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n111_), .b(new_n110_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n106_), .b(new_n114_), .c(new_n79_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n95_), .c(new_n61_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n50_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n95_), .c(x24), .O(new_n120_));
  nor2   g75(.a(x22), .b(x21), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n121_), .c(new_n97_), .d(new_n90_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n61_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n50_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(z17));
  nand2  g81(.a(new_n123_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n121_), .c(new_n97_), .d(new_n90_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n105_), .d(new_n48_), .O(z18));
endmodule
