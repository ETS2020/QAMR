...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x07), .O(z12));
  inv1   g03(.a(z12), .O(z16));
  nand2  g04(.a(z16), .b(new_n47_), .O(z02));
  ...
  nand3  g20(.a(new_n62_), .b(z16), .c(new_n54_), .O(new_n66_));
  ...
  nand3  g27(.a(new_n72_), .b(z16), .c(new_n46_), .O(new_n73_));
  ...
  nor2   g39(.a(new_n53_), .b(x07), .O(new_n88_));
  nand2  g40(.a(new_n88_), .b(new_n53_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  nand2  g44(.a(new_n88_), .b(new_n53_), .O(z14));
  nand2  g45(.a(new_n88_), .b(new_n53_), .O(z15));
  nand2  g46(.a(new_n88_), .b(new_n53_), .O(z17));
  inv1   g47(.a(z12), .O(z18));
endmodule
