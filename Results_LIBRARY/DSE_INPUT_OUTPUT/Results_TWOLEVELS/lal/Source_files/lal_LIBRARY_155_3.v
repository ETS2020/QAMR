...
module FAU ( 
  ...
  nand4  g086(.a(new_n95_), .b(new_n92_), .c(new_n131_), .d(x19), .O(new_n132_));
  ...
  nand3  g090(.a(new_n135_), .b(new_n98_), .c(new_n131_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n134_), .c(new_n123_), .d(new_n47_), .O(z15));
  and2   g092(.a(new_n136_), .b(x23), .O(new_n138_));
  nand4  g093(.a(new_n54_), .b(new_n91_), .c(new_n92_), .d(new_n131_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n125_), .c(new_n47_), .O(new_n140_));
  ...
  nand4  g098(.a(new_n98_), .b(x25), .c(new_n88_), .d(new_n54_), .O(new_n144_));
  oai21  g099(.a(new_n144_), .b(new_n124_), .c(new_n143_), .O(new_n145_));
  ...
  nor2   g103(.a(new_n89_), .b(x23), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n98_), .c(new_n97_), .d(new_n95_), .O(new_n150_));
  and2   g105(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n147_), .c(new_n146_), .d(new_n47_), .O(z17));
  nand3  g107(.a(new_n100_), .b(x25), .c(new_n48_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n150_), .c(new_n123_), .d(new_n47_), .O(z18));
endmodule
