...
module FAU ( 
  ...
  nand2  g040(.a(new_n85_), .b(new_n51_), .O(z06));
  nand3  g041(.a(new_n51_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g089(.a(new_n122_), .b(new_n95_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n52_), .c(x17), .O(new_n136_));
  nand2  g091(.a(new_n97_), .b(new_n96_), .O(new_n137_));
  nand4  g092(.a(new_n50_), .b(x24), .c(new_n63_), .d(x21), .O(new_n138_));
  aoi22  g093(.a(new_n138_), .b(x07), .c(new_n137_), .d(x21), .O(new_n139_));
  nand3  g094(.a(new_n139_), .b(new_n136_), .c(new_n119_), .O(z14));
  nand4  g095(.a(new_n98_), .b(x19), .c(x18), .d(new_n47_), .O(new_n141_));
  aoi21  g096(.a(new_n141_), .b(new_n122_), .c(new_n88_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n125_), .c(new_n52_), .O(new_n143_));
  nand3  g098(.a(new_n56_), .b(x24), .c(x07), .O(new_n144_));
  aoi21  g099(.a(new_n144_), .b(x15), .c(new_n57_), .O(new_n145_));
  aoi21  g100(.a(new_n97_), .b(new_n96_), .c(x15), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n145_), .c(x22), .O(new_n147_));
  nand4  g102(.a(new_n59_), .b(new_n50_), .c(x24), .d(new_n63_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(x07), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n147_), .c(new_n143_), .d(new_n72_), .O(z15));
  oai21  g105(.a(x25), .b(new_n68_), .c(new_n141_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(x17), .O(new_n152_));
  nand3  g107(.a(new_n55_), .b(new_n50_), .c(x07), .O(new_n153_));
  aoi21  g108(.a(new_n153_), .b(new_n152_), .c(x20), .O(new_n154_));
  nand3  g109(.a(new_n129_), .b(new_n50_), .c(x07), .O(new_n155_));
  inv1   g110(.a(new_n155_), .O(new_n156_));
  oai21  g111(.a(new_n156_), .b(new_n154_), .c(new_n63_), .O(new_n157_));
  nor2   g112(.a(new_n63_), .b(x15), .O(new_n158_));
  oai21  g113(.a(new_n158_), .b(new_n127_), .c(new_n88_), .O(new_n159_));
  nand4  g114(.a(x24), .b(x22), .c(x21), .d(x07), .O(new_n160_));
  inv1   g115(.a(new_n160_), .O(new_n161_));
  oai21  g116(.a(new_n161_), .b(new_n158_), .c(x20), .O(new_n162_));
  nand3  g117(.a(new_n50_), .b(x24), .c(new_n63_), .O(new_n163_));
  nand2  g118(.a(new_n163_), .b(x07), .O(new_n164_));
  aoi21  g119(.a(new_n120_), .b(new_n98_), .c(new_n63_), .O(new_n165_));
  nand3  g120(.a(new_n68_), .b(x05), .c(x04), .O(new_n166_));
  inv1   g121(.a(new_n166_), .O(new_n167_));
  oai21  g122(.a(new_n167_), .b(new_n165_), .c(new_n47_), .O(new_n168_));
  nand4  g123(.a(new_n168_), .b(new_n164_), .c(new_n162_), .d(new_n159_), .O(new_n169_));
  inv1   g124(.a(new_n169_), .O(new_n170_));
  nand2  g125(.a(new_n170_), .b(new_n157_), .O(z16));
  ...
  nand4  g137(.a(new_n98_), .b(new_n50_), .c(new_n64_), .d(new_n63_), .O(new_n183_));
  oai21  g138(.a(new_n183_), .b(new_n137_), .c(new_n166_), .O(new_n184_));
  nand2  g139(.a(new_n184_), .b(new_n47_), .O(new_n185_));
  nand3  g140(.a(new_n61_), .b(new_n50_), .c(x07), .O(new_n186_));
  nand4  g141(.a(new_n186_), .b(new_n185_), .c(new_n182_), .d(new_n178_), .O(z17));
  nand3  g142(.a(x19), .b(x18), .c(new_n47_), .O(new_n188_));
  nand3  g143(.a(new_n64_), .b(new_n58_), .c(new_n57_), .O(new_n189_));
  oai21  g144(.a(new_n189_), .b(new_n188_), .c(new_n68_), .O(new_n190_));
  aoi21  g145(.a(new_n54_), .b(new_n53_), .c(new_n68_), .O(new_n191_));
  aoi21  g146(.a(new_n190_), .b(x17), .c(new_n191_), .O(new_n192_));
  nand2  g147(.a(new_n129_), .b(x07), .O(new_n193_));
  oai21  g148(.a(new_n192_), .b(x20), .c(new_n193_), .O(new_n194_));
  nor2   g149(.a(x24), .b(new_n68_), .O(new_n195_));
  aoi21  g150(.a(new_n194_), .b(new_n63_), .c(new_n195_), .O(new_n196_));
  nor2   g151(.a(new_n50_), .b(x15), .O(new_n197_));
  oai21  g152(.a(new_n197_), .b(new_n127_), .c(new_n88_), .O(new_n198_));
  oai21  g153(.a(new_n197_), .b(new_n161_), .c(x20), .O(new_n199_));
  oai21  g154(.a(new_n64_), .b(new_n63_), .c(new_n50_), .O(new_n200_));
  nand2  g155(.a(new_n200_), .b(x07), .O(new_n201_));
  nand2  g156(.a(new_n99_), .b(new_n58_), .O(new_n202_));
  oai21  g157(.a(new_n202_), .b(new_n95_), .c(x25), .O(new_n203_));
  nand2  g158(.a(new_n203_), .b(new_n166_), .O(new_n204_));
  nand2  g159(.a(new_n204_), .b(new_n47_), .O(new_n205_));
  nand4  g160(.a(new_n205_), .b(new_n201_), .c(new_n199_), .d(new_n198_), .O(new_n206_));
  inv1   g161(.a(new_n206_), .O(new_n207_));
  oai21  g162(.a(new_n196_), .b(x25), .c(new_n207_), .O(z18));
endmodule
