...
module FAU ( 
  ...
  nand2  g008(.a(new_n53_), .b(x19), .O(new_n54_));
  ...
  inv1   g024(.a(new_n59_), .O(new_n70_));
  nand2  g025(.a(new_n70_), .b(new_n50_), .O(new_n71_));
  nand3  g026(.a(new_n65_), .b(new_n56_), .c(new_n62_), .O(new_n72_));
  aoi21  g027(.a(new_n72_), .b(new_n71_), .c(x25), .O(z03));
  ...
  nand2  g034(.a(new_n79_), .b(new_n50_), .O(z04));
  ...
  oai21  g065(.a(new_n110_), .b(new_n53_), .c(new_n50_), .O(z09));
  nand4  g066(.a(new_n110_), .b(new_n85_), .c(new_n47_), .d(new_n52_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n50_), .O(z10));
  xor2a  g068(.a(x18), .b(x17), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n110_), .c(new_n47_), .d(new_n52_), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(new_n50_), .O(z11));
  nand4  g071(.a(new_n48_), .b(x18), .c(x17), .d(new_n47_), .O(new_n117_));
  oai21  g072(.a(new_n100_), .b(new_n48_), .c(new_n117_), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n110_), .c(new_n52_), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(new_n50_), .O(z12));
  oai21  g075(.a(x20), .b(x15), .c(new_n48_), .O(new_n121_));
  nor2   g076(.a(new_n100_), .b(new_n62_), .O(new_n122_));
  nand2  g077(.a(new_n101_), .b(new_n100_), .O(new_n123_));
  nand3  g078(.a(new_n52_), .b(x05), .c(x04), .O(new_n124_));
  ...
  nand3  g083(.a(new_n62_), .b(x18), .c(x17), .O(new_n129_));
  nand3  g084(.a(new_n100_), .b(new_n97_), .c(x19), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n124_), .c(new_n52_), .O(new_n131_));
  aoi21  g086(.a(new_n129_), .b(x21), .c(new_n131_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(x15), .c(new_n128_), .O(z14));
  oai21  g088(.a(x22), .b(x15), .c(new_n48_), .O(new_n134_));
  aoi21  g089(.a(new_n100_), .b(new_n97_), .c(new_n96_), .O(new_n135_));
  nand3  g090(.a(x19), .b(x18), .c(x17), .O(new_n136_));
  inv1   g091(.a(new_n136_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n102_), .c(new_n62_), .O(new_n138_));
  nand3  g093(.a(new_n138_), .b(new_n124_), .c(new_n52_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n135_), .c(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n134_), .O(z15));
  aoi21  g096(.a(x05), .b(x04), .c(x07), .O(new_n142_));
  nand2  g097(.a(new_n138_), .b(x23), .O(new_n143_));
  nand4  g098(.a(new_n137_), .b(new_n97_), .c(new_n56_), .d(new_n96_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n47_), .O(z16));
  nand2  g100(.a(new_n103_), .b(new_n96_), .O(new_n146_));
  nor3   g101(.a(new_n146_), .b(x21), .c(x20), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(x19), .c(x18), .d(x17), .O(new_n148_));
  nand2  g103(.a(x24), .b(x23), .O(new_n149_));
  nand3  g104(.a(new_n149_), .b(new_n124_), .c(new_n52_), .O(new_n150_));
  inv1   g105(.a(new_n150_), .O(new_n151_));
  nand2  g106(.a(new_n138_), .b(x24), .O(new_n152_));
  nand4  g107(.a(new_n152_), .b(new_n151_), .c(new_n148_), .d(new_n47_), .O(z17));
  oai21  g108(.a(x25), .b(x15), .c(new_n48_), .O(new_n154_));
  nand2  g109(.a(new_n103_), .b(new_n102_), .O(new_n155_));
  oai21  g110(.a(new_n129_), .b(new_n155_), .c(x25), .O(new_n156_));
  nor3   g111(.a(x25), .b(x24), .c(x23), .O(new_n157_));
  nand4  g112(.a(new_n157_), .b(new_n102_), .c(new_n101_), .d(new_n100_), .O(new_n158_));
  nand4  g113(.a(new_n158_), .b(new_n156_), .c(new_n124_), .d(new_n52_), .O(new_n159_));
