...
module FAU ( 
  ...
  nand2  g47(.a(new_n92_), .b(new_n50_), .O(z11));
  ...
  oai21  g53(.a(new_n62_), .b(x15), .c(new_n47_), .O(new_n99_));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n94_), .b(new_n53_), .c(x19), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n47_), .O(new_n103_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n99_), .d(new_n47_), .O(z14));
  nand2  g64(.a(new_n108_), .b(x22), .O(new_n110_));
  inv1   g65(.a(new_n100_), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n53_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n99_), .d(new_n47_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand4  g71(.a(new_n107_), .b(new_n111_), .c(new_n116_), .d(new_n82_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n99_), .d(new_n47_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n102_), .O(new_n120_));
  nand3  g75(.a(new_n112_), .b(new_n81_), .c(new_n116_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n99_), .O(z17));
  nand2  g81(.a(new_n123_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n112_), .c(new_n120_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n99_), .d(new_n47_), .O(z18));
endmodule
