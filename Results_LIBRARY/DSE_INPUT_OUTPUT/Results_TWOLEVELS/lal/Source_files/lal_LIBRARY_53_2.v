...
module FAU ( 
  ...
  nand3  g18(.a(new_n48_), .b(x05), .c(x04), .O(new_n64_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n48_), .c(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n85_), .b(new_n56_), .c(new_n87_), .d(new_n48_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n85_), .c(new_n87_), .d(new_n48_), .O(new_n91_));
  ...
  nand2  g51(.a(new_n96_), .b(new_n85_), .O(new_n97_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n85_), .O(new_n102_));
  ...
  nor2   g60(.a(new_n65_), .b(x15), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n94_), .c(x19), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n50_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n85_), .O(new_n114_));
  ...
  nand3  g73(.a(new_n107_), .b(new_n117_), .c(new_n80_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n99_), .c(new_n85_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n87_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n99_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n58_), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n94_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n123_), .c(new_n85_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n87_), .O(z17));
  nand2  g85(.a(new_n126_), .b(new_n125_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n101_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n125_), .c(new_n124_), .d(new_n94_), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n132_), .c(new_n85_), .O(new_n135_));
