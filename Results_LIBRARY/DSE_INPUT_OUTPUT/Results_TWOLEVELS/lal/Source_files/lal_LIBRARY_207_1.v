...
module FAU ( 
  ...
  or2    g06(.a(new_n51_), .b(x07), .O(new_n52_));
  ...
  oai21  g38(.a(new_n82_), .b(new_n53_), .c(new_n83_), .O(z08));
  nand4  g39(.a(new_n47_), .b(new_n50_), .c(x05), .d(x04), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z09));
  nand2  g41(.a(x05), .b(x04), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n56_), .c(new_n47_), .d(new_n50_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n87_), .c(new_n47_), .d(new_n50_), .O(new_n91_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n51_), .d(new_n50_), .O(z14));
  inv1   g63(.a(new_n98_), .O(new_n109_));
  nor2   g64(.a(x22), .b(x21), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n55_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n100_), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(x22), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(x15), .c(new_n50_), .O(z15));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand3  g71(.a(new_n106_), .b(new_n116_), .c(new_n80_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n109_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n52_), .d(new_n50_), .O(z16));
  oai21  g75(.a(new_n117_), .b(new_n98_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n58_), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n110_), .c(new_n122_), .d(new_n93_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n100_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n50_), .O(z17));
  nand2  g82(.a(new_n123_), .b(new_n110_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n101_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n110_), .c(new_n122_), .d(new_n93_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n100_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n50_), .O(z18));
endmodule
