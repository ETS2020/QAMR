...
module FAU ( 
  ...
  oai21  g083(.a(new_n108_), .b(new_n107_), .c(new_n47_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n50_), .O(new_n130_));
  nand2  g085(.a(new_n122_), .b(x21), .O(new_n131_));
  nand4  g086(.a(new_n94_), .b(new_n91_), .c(new_n55_), .d(x19), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n50_), .O(z14));
  nand2  g088(.a(new_n132_), .b(x22), .O(new_n134_));
  inv1   g089(.a(new_n123_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n96_), .c(new_n55_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n134_), .c(new_n130_), .d(new_n50_), .O(z15));
  ...
  nand4  g097(.a(new_n96_), .b(x25), .c(new_n90_), .d(new_n54_), .O(new_n143_));
  oai22  g098(.a(new_n143_), .b(new_n122_), .c(new_n90_), .d(new_n54_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n47_), .O(new_n145_));
  nand2  g100(.a(new_n136_), .b(x24), .O(new_n146_));
  nand4  g101(.a(new_n96_), .b(new_n53_), .c(new_n90_), .d(new_n54_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(new_n122_), .O(new_n148_));
  nor2   g103(.a(new_n148_), .b(x15), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n146_), .c(new_n145_), .d(new_n130_), .O(z17));
  nand3  g105(.a(new_n98_), .b(x25), .c(new_n47_), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n149_), .c(new_n130_), .O(z18));
endmodule
