...
module FAU ( 
  ...
  nand2  g34(.a(new_n59_), .b(new_n58_), .O(new_n80_));
  nand3  g35(.a(x24), .b(x22), .c(x21), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(new_n80_), .c(new_n55_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n57_), .O(new_n83_));
  nand2  g38(.a(new_n81_), .b(new_n55_), .O(new_n84_));
  ...
  nor2   g47(.a(x20), .b(new_n59_), .O(new_n93_));
  ...
  aoi21  g56(.a(new_n101_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g57(.a(x18), .b(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n47_), .c(x07), .O(z11));
  nand3  g60(.a(new_n59_), .b(x18), .c(x17), .O(new_n106_));
  oai21  g61(.a(new_n92_), .b(new_n59_), .c(new_n106_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n100_), .c(new_n47_), .d(new_n51_), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(z12));
  nand2  g64(.a(new_n93_), .b(new_n92_), .O(new_n110_));
  nand3  g65(.a(x19), .b(x18), .c(x17), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x20), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n52_), .d(new_n51_), .O(z13));
  nand3  g68(.a(new_n51_), .b(x05), .c(x04), .O(new_n114_));
  nor2   g69(.a(x21), .b(x20), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n92_), .c(x19), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  aoi21  g72(.a(new_n110_), .b(x21), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n51_), .O(z14));
  nand2  g74(.a(new_n116_), .b(x22), .O(new_n120_));
  inv1   g75(.a(new_n111_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n94_), .c(new_n56_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n54_), .d(new_n51_), .O(z15));
  nand2  g78(.a(new_n122_), .b(x23), .O(new_n124_));
  nor2   g79(.a(x23), .b(x22), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n115_), .c(new_n121_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n54_), .d(new_n51_), .O(z16));
  nand3  g82(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n128_));
  nor2   g83(.a(new_n128_), .b(x20), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(x19), .c(x18), .d(x17), .O(new_n130_));
  aoi21  g85(.a(new_n126_), .b(x24), .c(x07), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n130_), .c(new_n54_), .O(z17));
  nand2  g87(.a(new_n96_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n135_));
