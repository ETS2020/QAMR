...
module FAU ( 
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .d(new_n47_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n99_), .d(new_n47_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n99_), .d(new_n47_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x23), .O(new_n115_));
  nand4  g70(.a(new_n106_), .b(new_n110_), .c(new_n115_), .d(new_n82_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n99_), .d(new_n47_), .O(z16));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n111_), .c(new_n102_), .d(new_n94_), .O(new_n119_));
  ...
  oai21  g79(.a(new_n124_), .b(new_n103_), .c(new_n47_), .O(new_n125_));
  aoi21  g80(.a(new_n119_), .b(x25), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n99_), .O(z18));
endmodule
