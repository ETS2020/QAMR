...
module FAU ( 
  ...
  aoi21  g38(.a(new_n63_), .b(new_n48_), .c(x15), .O(z09));
  inv1   g39(.a(x15), .O(new_n85_));
  nand4  g40(.a(new_n63_), .b(new_n55_), .c(new_n85_), .d(new_n48_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n63_), .c(new_n85_), .d(new_n48_), .O(new_n89_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n102_), .d(new_n50_), .O(z14));
  nand2  g63(.a(new_n107_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n96_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n49_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n105_), .O(z15));
  ...
  oai21  g71(.a(new_n116_), .b(new_n96_), .c(new_n63_), .O(new_n117_));
  ...
  nor2   g75(.a(x20), .b(new_n57_), .O(new_n121_));
  nor2   g76(.a(x22), .b(x21), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n91_), .O(new_n124_));
  ...
  oai21  g83(.a(new_n128_), .b(new_n98_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n122_), .c(new_n121_), .d(new_n91_), .O(new_n131_));
