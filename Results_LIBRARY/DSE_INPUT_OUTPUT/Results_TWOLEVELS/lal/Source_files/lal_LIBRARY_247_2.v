...
module FAU ( 
  ...
  nand2  g062(.a(new_n66_), .b(new_n82_), .O(new_n108_));
  ...
  oai21  g083(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n105_), .O(new_n130_));
  nand2  g085(.a(new_n125_), .b(x22), .O(new_n131_));
  inv1   g086(.a(new_n118_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n93_), .c(new_n53_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n130_), .d(new_n105_), .O(z15));
  nand2  g089(.a(new_n133_), .b(x23), .O(new_n135_));
  nand4  g090(.a(new_n124_), .b(new_n132_), .c(new_n100_), .d(new_n59_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n130_), .d(new_n105_), .O(z16));
  nand4  g092(.a(new_n93_), .b(x25), .c(new_n51_), .d(new_n100_), .O(new_n138_));
  oai22  g093(.a(new_n138_), .b(new_n117_), .c(new_n51_), .d(new_n100_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n133_), .b(x24), .O(new_n141_));
  nand4  g096(.a(new_n93_), .b(new_n52_), .c(new_n51_), .d(new_n100_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(new_n117_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x15), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n141_), .c(new_n140_), .d(new_n130_), .O(z17));
  nand3  g100(.a(new_n95_), .b(x25), .c(new_n47_), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n144_), .c(new_n130_), .O(z18));
endmodule
