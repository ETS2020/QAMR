...
module FAU ( 
  ...
  nand4  g51(.a(new_n96_), .b(new_n62_), .c(new_n85_), .d(new_n47_), .O(new_n97_));
  ...
  nand2  g60(.a(new_n105_), .b(new_n85_), .O(z13));
  aoi21  g61(.a(x05), .b(x04), .c(x07), .O(new_n107_));
  or2    g62(.a(new_n107_), .b(x15), .O(new_n108_));
  ...
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n85_), .O(z14));
  ...
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n101_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n85_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand3  g76(.a(new_n110_), .b(new_n121_), .c(new_n80_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n114_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n108_), .d(new_n85_), .O(z16));
  oai21  g80(.a(new_n122_), .b(new_n99_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n115_), .c(new_n102_), .d(new_n94_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n126_), .c(new_n101_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n85_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n115_), .c(new_n102_), .d(new_n94_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n108_), .d(new_n85_), .O(z18));
endmodule
