...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(new_n82_), .c(z09), .O(z13));
  nand3  g40(.a(new_n84_), .b(new_n82_), .c(new_n49_), .O(z14));
  nor2   g41(.a(x15), .b(x07), .O(z10));
  nor2   g42(.a(x15), .b(x07), .O(z11));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand3  g44(.a(new_n84_), .b(new_n82_), .c(new_n49_), .O(z15));
  nand3  g45(.a(new_n84_), .b(new_n82_), .c(new_n49_), .O(z16));
  aoi21  g46(.a(new_n84_), .b(new_n82_), .c(z09), .O(z17));
  aoi21  g47(.a(new_n84_), .b(new_n82_), .c(z09), .O(z18));
endmodule
