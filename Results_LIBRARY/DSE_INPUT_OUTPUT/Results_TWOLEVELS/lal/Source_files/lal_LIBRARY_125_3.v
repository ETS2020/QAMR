...
module FAU ( 
  ...
  nand4  g084(.a(new_n129_), .b(new_n127_), .c(new_n123_), .d(new_n47_), .O(z14));
  nand2  g085(.a(new_n129_), .b(x22), .O(new_n131_));
  inv1   g086(.a(new_n124_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n96_), .c(new_n53_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n123_), .d(new_n47_), .O(z15));
  nand2  g089(.a(new_n133_), .b(x23), .O(new_n135_));
  nand4  g090(.a(new_n128_), .b(new_n132_), .c(new_n103_), .d(new_n88_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n123_), .d(new_n47_), .O(z16));
  nand3  g092(.a(new_n97_), .b(new_n88_), .c(new_n90_), .O(new_n138_));
  nor2   g093(.a(new_n138_), .b(x20), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(x19), .c(x18), .d(x17), .O(new_n140_));
  nand3  g095(.a(new_n47_), .b(x05), .c(x04), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n48_), .O(new_n143_));
  aoi21  g098(.a(x24), .b(x23), .c(x15), .O(new_n144_));
  nand2  g099(.a(new_n133_), .b(x24), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n47_), .O(z17));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n121_), .c(new_n47_), .O(new_n149_));
  aoi21  g104(.a(new_n98_), .b(x25), .c(new_n149_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(x15), .c(new_n123_), .O(z18));
endmodule
