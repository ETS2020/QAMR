...
module FAU ( 
  ...
  nand3  g32(.a(z15), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g40(.a(new_n89_), .b(new_n51_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  nand2  g45(.a(new_n89_), .b(new_n51_), .O(z14));
  nand2  g46(.a(new_n89_), .b(new_n51_), .O(z16));
  nand2  g47(.a(new_n89_), .b(new_n51_), .O(z17));
  nand2  g48(.a(new_n89_), .b(new_n51_), .O(z18));
endmodule
