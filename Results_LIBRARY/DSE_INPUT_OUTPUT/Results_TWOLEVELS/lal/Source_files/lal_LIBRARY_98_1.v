...
module FAU ( 
  ...
  nand2  g43(.a(new_n88_), .b(new_n58_), .O(new_n89_));
  ...
  aoi21  g48(.a(new_n59_), .b(new_n48_), .c(new_n58_), .O(new_n94_));
  ...
  nand3  g55(.a(new_n53_), .b(x05), .c(x04), .O(new_n101_));
  ...
  oai21  g64(.a(new_n109_), .b(x15), .c(new_n53_), .O(z14));
  nand2  g65(.a(new_n107_), .b(x22), .O(new_n111_));
  inv1   g66(.a(new_n99_), .O(new_n112_));
  nor3   g67(.a(x22), .b(x21), .c(x20), .O(new_n113_));
  aoi21  g68(.a(new_n113_), .b(new_n112_), .c(x07), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n55_), .O(z15));
  ...
  oai21  g73(.a(new_n118_), .b(new_n99_), .c(new_n101_), .O(new_n119_));
  ...
  nand3  g83(.a(new_n128_), .b(new_n122_), .c(new_n101_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n53_), .O(z17));
  oai21  g86(.a(new_n126_), .b(new_n102_), .c(x25), .O(new_n132_));
  ...
  nand2  g91(.a(new_n136_), .b(new_n53_), .O(z18));
endmodule
