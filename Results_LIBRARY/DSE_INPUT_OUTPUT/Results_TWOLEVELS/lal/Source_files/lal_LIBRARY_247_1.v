...
module FAU ( 
  ...
  nand2  g064(.a(new_n109_), .b(new_n83_), .O(new_n110_));
  ...
  nand2  g082(.a(new_n127_), .b(new_n122_), .O(new_n128_));
  aoi21  g083(.a(new_n119_), .b(x21), .c(new_n128_), .O(new_n129_));
  oai21  g084(.a(new_n129_), .b(x15), .c(new_n51_), .O(z14));
  nand2  g085(.a(new_n127_), .b(x22), .O(new_n131_));
  inv1   g086(.a(new_n120_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n94_), .c(new_n58_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n55_), .d(new_n51_), .O(z15));
  nand2  g089(.a(new_n133_), .b(x23), .O(new_n135_));
  nand4  g090(.a(new_n126_), .b(new_n132_), .c(new_n101_), .d(new_n64_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n55_), .d(new_n51_), .O(z16));
  nand4  g092(.a(new_n94_), .b(x25), .c(new_n56_), .d(new_n101_), .O(new_n138_));
  oai22  g093(.a(new_n138_), .b(new_n119_), .c(new_n56_), .d(new_n101_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n133_), .b(x24), .O(new_n141_));
  nand4  g096(.a(new_n94_), .b(new_n57_), .c(new_n56_), .d(new_n101_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(new_n119_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x07), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n141_), .c(new_n140_), .d(new_n55_), .O(z17));
  nand3  g100(.a(new_n96_), .b(x25), .c(new_n47_), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n144_), .c(new_n55_), .O(z18));
endmodule
