...
module FAU ( 
  ...
  nand2  g68(.a(new_n113_), .b(x20), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n61_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n51_), .O(z13));
  nor2   g72(.a(x21), .b(x20), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n92_), .c(x19), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n61_), .O(new_n120_));
  aoi21  g75(.a(new_n112_), .b(x21), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x15), .c(new_n51_), .O(z14));
  aoi21  g77(.a(x05), .b(x04), .c(x15), .O(new_n123_));
  or2    g78(.a(new_n123_), .b(x07), .O(new_n124_));
  nand2  g79(.a(new_n119_), .b(x22), .O(new_n125_));
  nand2  g80(.a(new_n94_), .b(new_n53_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n113_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(x07), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(z15));
  inv1   g84(.a(x23), .O(new_n130_));
  nor2   g85(.a(new_n127_), .b(new_n130_), .O(new_n131_));
  inv1   g86(.a(new_n113_), .O(new_n132_));
  nand4  g87(.a(new_n118_), .b(new_n132_), .c(new_n130_), .d(new_n87_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n61_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(new_n131_), .c(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n51_), .O(z16));
  nand3  g91(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n137_));
  nor2   g92(.a(new_n137_), .b(x20), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  aoi21  g94(.a(new_n133_), .b(x24), .c(x07), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n139_), .c(new_n124_), .O(z17));
  nand2  g96(.a(new_n96_), .b(x25), .O(new_n142_));
  nor3   g97(.a(x25), .b(x24), .c(x23), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n144_));
  nand4  g99(.a(new_n144_), .b(new_n142_), .c(new_n124_), .d(new_n51_), .O(z18));
endmodule
