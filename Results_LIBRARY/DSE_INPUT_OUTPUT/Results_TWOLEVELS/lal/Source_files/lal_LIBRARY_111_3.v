...
module FAU ( 
  ...
  nand3  g29(.a(new_n50_), .b(new_n74_), .c(new_n46_), .O(new_n75_));
  ...
  nand2  g38(.a(new_n55_), .b(new_n54_), .O(new_n84_));
  nand3  g39(.a(x22), .b(x21), .c(new_n56_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x24), .O(new_n87_));
  aoi21  g42(.a(x25), .b(new_n53_), .c(new_n49_), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n87_), .c(new_n82_), .O(z08));
  nand2  g44(.a(new_n48_), .b(new_n47_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(new_n62_), .c(new_n50_), .O(z09));
  nand4  g46(.a(new_n62_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  ...
  oai21  g77(.a(new_n122_), .b(new_n118_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n104_), .O(z15));
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n83_), .O(new_n125_));
  nand4  g80(.a(new_n83_), .b(new_n117_), .c(new_n110_), .d(new_n53_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n105_), .c(new_n47_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n125_), .c(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n104_), .O(z16));
  nand2  g84(.a(x24), .b(x23), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n102_), .c(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  inv1   g87(.a(x24), .O(new_n133_));
  aoi21  g88(.a(new_n120_), .b(new_n119_), .c(new_n133_), .O(new_n134_));
  nor2   g89(.a(x22), .b(x21), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n133_), .c(new_n83_), .O(new_n136_));
  oai21  g91(.a(new_n136_), .b(new_n107_), .c(new_n47_), .O(new_n137_));
  oai21  g92(.a(new_n137_), .b(new_n134_), .c(new_n48_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n132_), .O(z17));
  oai21  g94(.a(new_n136_), .b(new_n107_), .c(x25), .O(new_n140_));
  inv1   g95(.a(new_n107_), .O(new_n141_));
  nor3   g96(.a(x25), .b(x24), .c(x23), .O(new_n142_));
  nand3  g97(.a(new_n142_), .b(new_n135_), .c(new_n141_), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n140_), .c(new_n104_), .d(new_n47_), .O(z18));
endmodule
