...
module FAU ( 
  ...
  nor2   g22(.a(z09), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n60_), .b(z14), .O(z03));
  ...
  nand2  g30(.a(new_n75_), .b(z14), .O(z04));
  oai21  g31(.a(x13), .b(x08), .c(z14), .O(z05));
  nand2  g32(.a(x14), .b(new_n46_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(z14), .O(z06));
  nand3  g34(.a(z14), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g44(.a(new_n63_), .b(new_n62_), .O(z15));
  nand2  g45(.a(new_n63_), .b(new_n62_), .O(z16));
