...
module FAU ( 
  ...
  nand3  g30(.a(new_n50_), .b(new_n75_), .c(new_n67_), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z05));
  nand2  g32(.a(x14), .b(new_n67_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n50_), .O(z06));
  aoi21  g34(.a(new_n67_), .b(x06), .c(new_n49_), .O(z07));
  ...
  nand4  g55(.a(new_n48_), .b(new_n47_), .c(x05), .d(x04), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z09));
  nand4  g57(.a(new_n63_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n50_), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n106_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(z12));
  aoi21  g66(.a(x05), .b(x04), .c(x15), .O(new_n112_));
  or2    g67(.a(new_n112_), .b(x07), .O(new_n113_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n48_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n113_), .O(z13));
  ...
  nand2  g90(.a(new_n135_), .b(new_n113_), .O(z16));
  ...
  nand2  g94(.a(new_n133_), .b(x24), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n139_), .c(new_n113_), .d(new_n47_), .O(z17));
  ...
  nand4  g99(.a(new_n144_), .b(new_n142_), .c(new_n113_), .d(new_n47_), .O(z18));
endmodule
