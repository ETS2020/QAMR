...
module FAU ( 
  ...
  nand3  g20(.a(x15), .b(x05), .c(x04), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(z11), .O(z08));
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n86_));
  aoi21  g39(.a(new_n86_), .b(new_n82_), .c(z11), .O(z13));
  nand3  g40(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z16));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  aoi21  g44(.a(new_n86_), .b(new_n82_), .c(z11), .O(z14));
  aoi21  g45(.a(new_n86_), .b(new_n82_), .c(z11), .O(z15));
  nand3  g46(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z17));
  aoi21  g47(.a(new_n86_), .b(new_n82_), .c(z11), .O(z18));
endmodule
