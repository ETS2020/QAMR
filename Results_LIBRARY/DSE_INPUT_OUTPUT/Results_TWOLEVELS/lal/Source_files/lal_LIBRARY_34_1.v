...
module FAU ( 
  ...
  aoi21  g12(.a(new_n57_), .b(x15), .c(new_n47_), .O(new_n58_));
  ...
  nor2   g19(.a(new_n58_), .b(x25), .O(z03));
  ...
  nand2  g36(.a(new_n81_), .b(x15), .O(new_n82_));
  aoi21  g37(.a(new_n80_), .b(x21), .c(new_n82_), .O(new_n83_));
  oai21  g38(.a(new_n83_), .b(new_n47_), .c(new_n78_), .O(z08));
  nor4   g39(.a(new_n59_), .b(x24), .c(x15), .d(x07), .O(z09));
  inv1   g40(.a(x15), .O(new_n86_));
  nand4  g41(.a(new_n59_), .b(new_n47_), .c(new_n51_), .d(new_n86_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  inv1   g43(.a(x07), .O(new_n89_));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n59_), .c(new_n89_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n47_), .d(new_n86_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x07), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n60_), .b(new_n86_), .c(new_n89_), .O(new_n100_));
  nor2   g55(.a(x20), .b(new_n53_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n89_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n86_), .O(z13));
  aoi21  g60(.a(new_n60_), .b(new_n89_), .c(x24), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n93_), .c(x19), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n86_), .c(new_n89_), .O(new_n109_));
  aoi21  g64(.a(new_n102_), .b(x21), .c(new_n109_), .O(new_n110_));
  oai21  g65(.a(new_n106_), .b(x15), .c(new_n110_), .O(z14));
  inv1   g66(.a(new_n98_), .O(new_n112_));
  nor3   g67(.a(x22), .b(x21), .c(x20), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n100_), .c(new_n89_), .O(new_n115_));
  aoi21  g70(.a(new_n108_), .b(x22), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(x24), .c(new_n86_), .O(z15));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n81_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n112_), .c(new_n81_), .d(new_n79_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n100_), .c(new_n89_), .O(new_n120_));
  ...
  nand2  g78(.a(new_n123_), .b(new_n86_), .O(z17));
  nand2  g79(.a(new_n119_), .b(x25), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nor2   g81(.a(x25), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n101_), .d(new_n93_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n100_), .d(new_n89_), .O(new_n129_));
