...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n87_), .c(new_n47_), .d(new_n51_), .O(new_n96_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n53_), .d(new_n51_), .O(z14));
  inv1   g64(.a(new_n98_), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n56_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n100_), .O(new_n113_));
  aoi21  g68(.a(new_n108_), .b(x22), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n51_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand3  g72(.a(new_n107_), .b(new_n117_), .c(new_n80_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n110_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n53_), .d(new_n51_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n98_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n111_), .c(new_n101_), .d(new_n93_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n122_), .c(new_n100_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n51_), .O(z17));
  nand2  g82(.a(new_n124_), .b(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n111_), .c(new_n101_), .d(new_n93_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n53_), .d(new_n51_), .O(z18));
endmodule
