...
module FAU ( 
  ...
  nor3   g02(.a(z12), .b(x16), .c(new_n46_), .O(z00));
  ...
  nand3  g17(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z01));
  inv1   g18(.a(x16), .O(new_n64_));
  nor2   g19(.a(z12), .b(new_n64_), .O(z02));
  inv1   g20(.a(z12), .O(z14));
  ...
  nand2  g31(.a(new_n76_), .b(z14), .O(z06));
  nand3  g32(.a(z14), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(z13));
  zero   g39(.O(z09));
  zero   g40(.O(z10));
  zero   g41(.O(z11));
  nand2  g42(.a(new_n62_), .b(new_n61_), .O(z15));
  inv1   g43(.a(z12), .O(z16));
  nand2  g44(.a(new_n62_), .b(new_n61_), .O(z17));
  inv1   g45(.a(z12), .O(z18));
endmodule
