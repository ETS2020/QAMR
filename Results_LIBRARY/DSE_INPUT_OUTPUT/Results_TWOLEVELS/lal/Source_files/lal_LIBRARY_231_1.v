...
module FAU ( 
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n86_), .d(new_n51_), .O(z15));
  and2   g70(.a(new_n114_), .b(x23), .O(new_n116_));
  ...
  nand4  g77(.a(new_n122_), .b(new_n113_), .c(new_n101_), .d(new_n94_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n61_), .O(new_n124_));
  aoi21  g79(.a(new_n118_), .b(x24), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x15), .c(new_n51_), .O(z17));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n113_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n102_), .c(new_n61_), .O(new_n129_));
  aoi21  g84(.a(new_n123_), .b(x25), .c(new_n129_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(x15), .c(new_n51_), .O(z18));
endmodule
