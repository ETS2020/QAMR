...
module FAU ( 
  ...
  aoi22  g27(.a(new_n69_), .b(x01), .c(new_n72_), .d(x00), .O(new_n73_));
  oai21  g28(.a(new_n72_), .b(x00), .c(new_n73_), .O(new_n74_));
  xnor2a g29(.a(x11), .b(x02), .O(new_n75_));
  xnor2a g30(.a(x12), .b(x03), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(new_n74_), .c(new_n46_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n71_), .O(z04));
  oai21  g34(.a(x13), .b(x08), .c(new_n51_), .O(z05));
  nand2  g35(.a(x14), .b(new_n46_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n51_), .O(z06));
  ...
  nand3  g45(.a(new_n62_), .b(new_n47_), .c(new_n90_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand4  g47(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n90_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n61_), .c(new_n47_), .d(new_n90_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n51_), .O(z11));
  ...
  nand4  g56(.a(new_n101_), .b(new_n61_), .c(new_n47_), .d(new_n90_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n51_), .O(z12));
  nand3  g58(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n62_), .b(new_n47_), .c(new_n90_), .O(new_n106_));
  nand4  g61(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n107_));
  and2   g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n105_), .c(new_n47_), .d(new_n90_), .O(z13));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n99_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n106_), .c(new_n90_), .O(new_n112_));
  aoi21  g67(.a(new_n107_), .b(x21), .c(new_n112_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n47_), .O(z14));
  inv1   g69(.a(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n52_), .c(x19), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n98_), .c(x22), .O(new_n117_));
  nand3  g72(.a(new_n90_), .b(x05), .c(x04), .O(new_n118_));
  inv1   g73(.a(new_n104_), .O(new_n119_));
  nor3   g74(.a(x22), .b(x21), .c(x20), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n117_), .d(new_n90_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(x15), .b(x01), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n123_), .O(z15));
  inv1   g80(.a(x23), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(new_n119_), .c(new_n126_), .O(new_n127_));
  nand4  g82(.a(new_n110_), .b(new_n119_), .c(new_n126_), .d(new_n85_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n118_), .c(new_n90_), .O(new_n129_));
  ...
  nand4  g88(.a(new_n84_), .b(new_n126_), .c(new_n85_), .d(new_n115_), .O(new_n134_));
  nor2   g89(.a(new_n134_), .b(new_n107_), .O(new_n135_));
  nor2   g90(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n132_), .c(new_n47_), .d(new_n90_), .O(z17));
  oai21  g92(.a(new_n134_), .b(new_n107_), .c(x25), .O(new_n138_));
  nor2   g93(.a(x20), .b(new_n55_), .O(new_n139_));
  ...
  nand4  g97(.a(new_n142_), .b(new_n138_), .c(new_n118_), .d(new_n90_), .O(new_n143_));
  nand2  g98(.a(new_n143_), .b(new_n47_), .O(new_n144_));
  nand2  g99(.a(new_n144_), .b(new_n124_), .O(z18));
endmodule
