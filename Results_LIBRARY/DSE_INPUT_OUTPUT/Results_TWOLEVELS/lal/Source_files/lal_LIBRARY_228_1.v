...
module FAU ( 
  ...
  nor2   g07(.a(new_n49_), .b(x08), .O(new_n53_));
  ...
  oai21  g18(.a(new_n63_), .b(new_n53_), .c(new_n52_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nor2   g20(.a(new_n53_), .b(new_n65_), .O(z02));
  ...
  nor3   g31(.a(x15), .b(x13), .c(x08), .O(z05));
  nand3  g32(.a(new_n49_), .b(x14), .c(new_n46_), .O(new_n78_));
  ...
  aoi21  g53(.a(new_n98_), .b(x25), .c(new_n53_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n87_), .c(new_n86_), .d(new_n84_), .O(z08));
  nand2  g55(.a(x05), .b(x04), .O(new_n101_));
  oai21  g56(.a(new_n101_), .b(new_n50_), .c(new_n67_), .O(z09));
  nand4  g57(.a(new_n101_), .b(new_n56_), .c(new_n49_), .d(new_n48_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n101_), .c(new_n49_), .d(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n67_), .O(z11));
  nand3  g62(.a(new_n58_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g63(.a(new_n93_), .b(new_n58_), .c(new_n108_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n101_), .c(new_n49_), .d(new_n48_), .O(new_n110_));
  ...
  nand3  g69(.a(new_n48_), .b(x05), .c(x04), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n112_), .d(new_n48_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n49_), .O(new_n117_));
  oai21  g72(.a(new_n49_), .b(new_n46_), .c(new_n117_), .O(z13));
  nand2  g73(.a(new_n115_), .b(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n49_), .O(new_n120_));
  nand2  g75(.a(new_n112_), .b(x21), .O(new_n121_));
  nor2   g76(.a(x21), .b(x20), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n93_), .c(x19), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n120_), .d(new_n49_), .O(z14));
  nand2  g79(.a(new_n123_), .b(x22), .O(new_n125_));
  inv1   g80(.a(new_n113_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n95_), .c(new_n55_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n120_), .d(new_n49_), .O(z15));
  nand2  g83(.a(new_n127_), .b(x23), .O(new_n129_));
  nor2   g84(.a(x23), .b(x22), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n122_), .c(new_n126_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n120_), .d(new_n49_), .O(z16));
  ...
  nand4  g91(.a(new_n136_), .b(new_n135_), .c(new_n120_), .d(new_n49_), .O(z17));
  ...
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n120_), .d(new_n49_), .O(z18));
endmodule
