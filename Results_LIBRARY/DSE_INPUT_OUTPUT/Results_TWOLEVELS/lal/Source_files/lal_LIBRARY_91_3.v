...
module FAU ( 
  ...
  nand3  g19(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(z01));
  ...
  nand4  g41(.a(new_n48_), .b(new_n47_), .c(x05), .d(x04), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n64_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n64_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n64_), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n50_), .O(z12));
  nand3  g54(.a(new_n48_), .b(x05), .c(x04), .O(new_n100_));
  ...
  nand3  g59(.a(new_n95_), .b(new_n55_), .c(x19), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n102_), .O(z13));
  ...
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n102_), .O(z14));
  ...
  nand3  g72(.a(new_n117_), .b(new_n114_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n102_), .O(z15));
  nand2  g75(.a(new_n117_), .b(x23), .O(new_n121_));
  inv1   g76(.a(x23), .O(new_n122_));
  nand4  g77(.a(new_n109_), .b(new_n115_), .c(new_n122_), .d(new_n82_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n102_), .d(new_n47_), .O(z16));
  nand2  g79(.a(x24), .b(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n100_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  aoi21  g82(.a(new_n116_), .b(new_n115_), .c(new_n53_), .O(new_n128_));
  nor2   g83(.a(x22), .b(x21), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n53_), .c(new_n122_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n105_), .c(new_n47_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n128_), .c(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n127_), .O(z17));
  oai21  g88(.a(new_n130_), .b(new_n105_), .c(x25), .O(new_n134_));
  inv1   g89(.a(new_n105_), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand3  g91(.a(new_n136_), .b(new_n129_), .c(new_n135_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n134_), .c(new_n102_), .d(new_n47_), .O(z18));
endmodule
