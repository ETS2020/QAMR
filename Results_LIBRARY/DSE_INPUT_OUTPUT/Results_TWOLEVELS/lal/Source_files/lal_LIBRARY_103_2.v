...
module FAU ( 
  ...
  nand2  g03(.a(new_n48_), .b(x07), .O(new_n49_));
  nand2  g04(.a(new_n49_), .b(new_n47_), .O(z02));
  nor2   g05(.a(z02), .b(new_n46_), .O(z00));
  nand2  g06(.a(new_n48_), .b(x07), .O(new_n52_));
  ...
  nand3  g18(.a(new_n63_), .b(new_n55_), .c(new_n54_), .O(new_n64_));
  nand2  g19(.a(x15), .b(x07), .O(new_n65_));
  nand3  g20(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(z01));
  nand3  g21(.a(new_n63_), .b(new_n49_), .c(new_n55_), .O(new_n67_));
  ...
  nand2  g31(.a(new_n49_), .b(x14), .O(new_n77_));
  ...
  aoi21  g36(.a(new_n60_), .b(new_n56_), .c(new_n81_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(x21), .c(x23), .O(new_n83_));
  aoi21  g38(.a(new_n48_), .b(x07), .c(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n80_), .c(new_n84_), .O(z08));
  nand4  g40(.a(new_n48_), .b(new_n54_), .c(x05), .d(x04), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(x05), .b(x04), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n57_), .c(new_n48_), .d(new_n54_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n88_), .c(new_n48_), .d(new_n54_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z11));
  nor2   g48(.a(new_n58_), .b(new_n57_), .O(new_n94_));
  nand3  g49(.a(new_n59_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(new_n59_), .c(new_n95_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n88_), .c(new_n48_), .d(new_n54_), .O(new_n97_));
  ...
  nor2   g56(.a(x20), .b(new_n59_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .d(new_n48_), .O(z13));
  or2    g59(.a(new_n99_), .b(x15), .O(new_n105_));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n48_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n105_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n112_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n48_), .b(x05), .c(x04), .O(new_n117_));
  nand3  g72(.a(new_n107_), .b(new_n115_), .c(new_n81_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n100_), .c(new_n117_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n54_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n48_), .O(z16));
  oai21  g76(.a(new_n118_), .b(new_n100_), .c(x24), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n102_), .d(new_n94_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n117_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n123_), .c(new_n102_), .d(new_n94_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n105_), .d(new_n48_), .O(z18));
endmodule
