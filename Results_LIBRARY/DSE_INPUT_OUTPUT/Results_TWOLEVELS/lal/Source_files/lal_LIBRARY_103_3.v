...
module FAU ( 
  ...
  nand3  g35(.a(new_n50_), .b(new_n70_), .c(x06), .O(z07));
  nand3  g36(.a(x24), .b(x22), .c(x21), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n53_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(x20), .O(new_n84_));
  nor4   g39(.a(new_n59_), .b(x19), .c(x18), .d(x17), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(x23), .c(x24), .O(new_n86_));
  aoi21  g41(.a(x25), .b(new_n54_), .c(new_n49_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z08));
  nand3  g43(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n62_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z12));
  nand3  g55(.a(new_n48_), .b(x05), .c(x04), .O(new_n101_));
  ...
  nand3  g60(.a(new_n96_), .b(new_n54_), .c(x19), .O(new_n106_));
  ...
  nand4  g64(.a(new_n96_), .b(new_n109_), .c(new_n54_), .d(x19), .O(new_n110_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n103_), .c(new_n47_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  nor2   g72(.a(new_n114_), .b(new_n117_), .O(new_n118_));
  inv1   g73(.a(x22), .O(new_n119_));
  nand4  g74(.a(new_n117_), .b(new_n119_), .c(new_n109_), .d(new_n54_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n104_), .c(new_n47_), .O(new_n121_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n101_), .c(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  inv1   g81(.a(x24), .O(new_n127_));
  nor2   g82(.a(new_n114_), .b(new_n127_), .O(new_n128_));
  nand3  g83(.a(new_n112_), .b(new_n127_), .c(new_n117_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n106_), .c(new_n47_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n128_), .c(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n126_), .O(z17));
  oai21  g87(.a(new_n129_), .b(new_n106_), .c(x25), .O(new_n133_));
  inv1   g88(.a(new_n106_), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n112_), .c(new_n134_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n103_), .d(new_n47_), .O(z18));
endmodule
