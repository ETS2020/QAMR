...
module FAU ( 
  ...
  nand4  g55(.a(new_n51_), .b(new_n47_), .c(x05), .d(x04), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z09));
  nand2  g57(.a(x05), .b(x04), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n56_), .c(new_n51_), .d(new_n47_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(z10));
  xor2a  g60(.a(x18), .b(x17), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n103_), .c(new_n51_), .d(new_n47_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(z11));
  aoi21  g63(.a(new_n57_), .b(new_n47_), .c(new_n56_), .O(new_n109_));
  nand3  g64(.a(new_n58_), .b(x18), .c(x17), .O(new_n110_));
  oai21  g65(.a(new_n109_), .b(new_n58_), .c(new_n110_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n103_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n47_), .c(x15), .O(z12));
  nand2  g68(.a(new_n94_), .b(new_n93_), .O(new_n114_));
  aoi21  g69(.a(x05), .b(x04), .c(x07), .O(new_n115_));
  nand3  g70(.a(x19), .b(x18), .c(x17), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(x20), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n51_), .O(z13));
  or2    g73(.a(new_n115_), .b(x15), .O(new_n119_));
  nand2  g74(.a(new_n114_), .b(x21), .O(new_n120_));
  nor2   g75(.a(x21), .b(x20), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n93_), .c(x19), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n119_), .d(new_n51_), .O(z14));
  nand3  g78(.a(new_n51_), .b(x05), .c(x04), .O(new_n124_));
  inv1   g79(.a(new_n116_), .O(new_n125_));
  nor3   g80(.a(x22), .b(x21), .c(x20), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  aoi21  g83(.a(new_n122_), .b(x22), .c(new_n128_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x07), .c(new_n51_), .O(z15));
  inv1   g85(.a(x23), .O(new_n131_));
  aoi21  g86(.a(new_n126_), .b(new_n125_), .c(new_n131_), .O(new_n132_));
  nand4  g87(.a(new_n121_), .b(new_n125_), .c(new_n131_), .d(new_n88_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n124_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(new_n132_), .c(new_n47_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n51_), .O(z16));
  nand3  g91(.a(new_n96_), .b(new_n88_), .c(new_n90_), .O(new_n137_));
  nor2   g92(.a(new_n137_), .b(x20), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  aoi21  g94(.a(new_n133_), .b(x24), .c(x15), .O(new_n140_));
  nand3  g95(.a(new_n140_), .b(new_n139_), .c(new_n119_), .O(z17));
  nand2  g96(.a(new_n97_), .b(x25), .O(new_n142_));
  nor3   g97(.a(x25), .b(x24), .c(x23), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n144_));
  nand4  g99(.a(new_n144_), .b(new_n142_), .c(new_n119_), .d(new_n51_), .O(z18));
endmodule
