...
module FAU ( 
  ...
  nand3  g30(.a(new_n50_), .b(new_n75_), .c(new_n46_), .O(new_n76_));
  ...
  nand3  g42(.a(new_n87_), .b(new_n48_), .c(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z09));
  nand4  g44(.a(new_n86_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n86_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n86_), .c(new_n48_), .d(new_n47_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z12));
  oai21  g55(.a(new_n87_), .b(x15), .c(new_n47_), .O(new_n101_));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n96_), .b(new_n54_), .c(x19), .O(new_n104_));
  ...
  aoi21  g70(.a(new_n115_), .b(new_n114_), .c(x07), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n48_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n101_), .O(z15));
  inv1   g74(.a(x23), .O(new_n120_));
  aoi21  g75(.a(new_n115_), .b(new_n114_), .c(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n108_), .b(new_n120_), .c(new_n81_), .O(new_n122_));
  ...
  oai21  g80(.a(new_n122_), .b(new_n102_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x20), .b(new_n57_), .O(new_n127_));
  nor2   g82(.a(x22), .b(x21), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n96_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n126_), .c(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n101_), .O(z17));
  nand2  g88(.a(new_n130_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n128_), .c(new_n127_), .d(new_n96_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n101_), .d(new_n47_), .O(z18));
endmodule
