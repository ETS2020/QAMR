...
module FAU ( 
  ...
  nor2   g051(.a(new_n53_), .b(new_n88_), .O(new_n97_));
  ...
  nand4  g056(.a(new_n101_), .b(new_n96_), .c(new_n64_), .d(new_n58_), .O(new_n102_));
  ...
  nand2  g060(.a(new_n105_), .b(new_n67_), .O(z08));
  aoi21  g061(.a(x05), .b(x04), .c(x15), .O(new_n107_));
  nor2   g062(.a(new_n107_), .b(x07), .O(z09));
  inv1   g063(.a(new_n71_), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n88_), .c(new_n47_), .d(new_n68_), .O(new_n110_));
  ...
  nand3  g075(.a(new_n50_), .b(new_n63_), .c(x07), .O(new_n121_));
  aoi21  g076(.a(new_n121_), .b(new_n120_), .c(new_n88_), .O(new_n122_));
  nand4  g077(.a(new_n55_), .b(new_n50_), .c(new_n63_), .d(x07), .O(new_n123_));
  ...
  nand2  g093(.a(new_n121_), .b(new_n95_), .O(new_n139_));
  nand3  g094(.a(new_n139_), .b(new_n52_), .c(x17), .O(new_n140_));
  nand2  g095(.a(new_n98_), .b(new_n97_), .O(new_n141_));
  nand4  g096(.a(new_n50_), .b(x24), .c(new_n63_), .d(x21), .O(new_n142_));
  ...
  nand3  g100(.a(new_n58_), .b(new_n52_), .c(x19), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n145_), .c(new_n121_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n57_), .O(new_n148_));
  nand4  g103(.a(new_n50_), .b(x24), .c(new_n63_), .d(x22), .O(new_n149_));
  ...
  oai22  g110(.a(new_n155_), .b(new_n154_), .c(x25), .d(new_n68_), .O(new_n156_));
  nand2  g111(.a(new_n156_), .b(x17), .O(new_n157_));
  nand3  g112(.a(new_n55_), .b(new_n50_), .c(x07), .O(new_n158_));
  aoi21  g113(.a(new_n158_), .b(new_n157_), .c(x20), .O(new_n159_));
  nand3  g114(.a(new_n129_), .b(new_n50_), .c(x07), .O(new_n160_));
  inv1   g115(.a(new_n160_), .O(new_n161_));
  oai21  g116(.a(new_n161_), .b(new_n159_), .c(new_n63_), .O(new_n162_));
  nor2   g117(.a(new_n63_), .b(x15), .O(new_n163_));
  oai21  g118(.a(new_n163_), .b(new_n127_), .c(new_n88_), .O(new_n164_));
  ...
  nand3  g122(.a(new_n50_), .b(x24), .c(new_n63_), .O(new_n168_));
  nand2  g123(.a(new_n168_), .b(x07), .O(new_n169_));
  inv1   g124(.a(new_n134_), .O(new_n170_));
  aoi21  g125(.a(new_n119_), .b(new_n99_), .c(new_n63_), .O(new_n171_));
  ...
  nand4  g130(.a(new_n59_), .b(new_n54_), .c(new_n53_), .d(x07), .O(new_n176_));
  aoi21  g131(.a(new_n176_), .b(x15), .c(x17), .O(new_n177_));
  nand2  g132(.a(new_n98_), .b(x18), .O(new_n178_));
  nand3  g133(.a(new_n63_), .b(new_n58_), .c(new_n57_), .O(new_n179_));
  oai21  g134(.a(new_n179_), .b(new_n178_), .c(new_n47_), .O(new_n180_));
  oai21  g135(.a(new_n131_), .b(new_n68_), .c(new_n180_), .O(new_n181_));
  oai21  g136(.a(new_n181_), .b(new_n177_), .c(x24), .O(new_n182_));
  nand3  g137(.a(new_n119_), .b(x17), .c(new_n47_), .O(new_n183_));
  nor3   g138(.a(x24), .b(x23), .c(x22), .O(new_n184_));
  nand2  g139(.a(new_n184_), .b(new_n150_), .O(new_n185_));
  oai21  g140(.a(new_n185_), .b(new_n183_), .c(new_n68_), .O(new_n186_));
  nand2  g141(.a(new_n186_), .b(x25), .O(new_n187_));
  nand4  g142(.a(new_n99_), .b(new_n50_), .c(new_n64_), .d(new_n63_), .O(new_n188_));
  oai21  g143(.a(new_n188_), .b(new_n141_), .c(new_n134_), .O(new_n189_));
  nand2  g144(.a(new_n189_), .b(new_n47_), .O(new_n190_));
  nand3  g145(.a(new_n61_), .b(new_n50_), .c(x07), .O(new_n191_));
  nand4  g146(.a(new_n191_), .b(new_n190_), .c(new_n187_), .d(new_n182_), .O(z17));
  nor2   g147(.a(x24), .b(x22), .O(new_n193_));
  nand4  g148(.a(new_n193_), .b(new_n119_), .c(new_n57_), .d(new_n47_), .O(new_n194_));
  aoi21  g149(.a(new_n194_), .b(new_n68_), .c(new_n88_), .O(new_n195_));
  aoi21  g150(.a(new_n54_), .b(new_n53_), .c(new_n68_), .O(new_n196_));
  oai21  g151(.a(new_n196_), .b(new_n195_), .c(new_n52_), .O(new_n197_));
  nand2  g152(.a(new_n129_), .b(x07), .O(new_n198_));
  aoi21  g153(.a(new_n198_), .b(new_n197_), .c(x23), .O(new_n199_));
  nor2   g154(.a(x24), .b(new_n68_), .O(new_n200_));
  oai21  g155(.a(new_n200_), .b(new_n199_), .c(new_n50_), .O(new_n201_));
  nor2   g156(.a(new_n50_), .b(x15), .O(new_n202_));
  oai21  g157(.a(new_n202_), .b(new_n127_), .c(new_n88_), .O(new_n203_));
  oai21  g158(.a(new_n202_), .b(new_n166_), .c(x20), .O(new_n204_));
  oai21  g159(.a(new_n64_), .b(new_n63_), .c(new_n50_), .O(new_n205_));
  ...
  nand3  g165(.a(new_n210_), .b(new_n201_), .c(new_n138_), .O(z18));
endmodule
