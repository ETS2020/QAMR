...
module FAU ( 
  ...
  nor2   g003(.a(new_n48_), .b(x05), .O(new_n49_));
  ...
  nand3  g017(.a(new_n62_), .b(new_n50_), .c(new_n54_), .O(new_n63_));
  ...
  nor3   g028(.a(new_n49_), .b(x13), .c(x08), .O(z05));
  nand2  g029(.a(x14), .b(new_n46_), .O(new_n75_));
  nand2  g030(.a(new_n75_), .b(new_n50_), .O(z06));
  nand3  g031(.a(new_n50_), .b(new_n46_), .c(x06), .O(z07));
  nand2  g032(.a(new_n58_), .b(new_n57_), .O(new_n78_));
  nand3  g033(.a(x24), .b(x22), .c(x21), .O(new_n79_));
  oai21  g034(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(new_n80_));
  nand2  g035(.a(new_n80_), .b(new_n56_), .O(new_n81_));
  nand2  g036(.a(new_n79_), .b(new_n54_), .O(new_n82_));
  nand2  g037(.a(new_n82_), .b(x20), .O(new_n83_));
  inv1   g038(.a(x24), .O(new_n84_));
  nand2  g039(.a(new_n54_), .b(new_n84_), .O(new_n85_));
  nand2  g040(.a(new_n85_), .b(x23), .O(new_n86_));
  ...
  nand4  g050(.a(new_n95_), .b(new_n90_), .c(new_n84_), .d(new_n87_), .O(new_n96_));
  aoi21  g051(.a(new_n96_), .b(x25), .c(new_n49_), .O(new_n97_));
  nand4  g052(.a(new_n97_), .b(new_n86_), .c(new_n83_), .d(new_n81_), .O(z08));
  nand2  g053(.a(new_n48_), .b(new_n53_), .O(new_n99_));
  oai21  g054(.a(new_n99_), .b(new_n64_), .c(new_n50_), .O(z09));
  nor2   g055(.a(x17), .b(x07), .O(new_n101_));
  nor2   g056(.a(new_n101_), .b(x15), .O(new_n102_));
  inv1   g057(.a(x04), .O(new_n103_));
  nand4  g058(.a(new_n56_), .b(new_n48_), .c(new_n53_), .d(new_n103_), .O(new_n104_));
  oai21  g059(.a(new_n102_), .b(x05), .c(new_n104_), .O(z10));
  xor2a  g060(.a(x18), .b(x17), .O(new_n106_));
  nand4  g061(.a(new_n106_), .b(new_n64_), .c(new_n48_), .d(new_n53_), .O(new_n107_));
  inv1   g062(.a(new_n107_), .O(z11));
  nand3  g063(.a(new_n58_), .b(x18), .c(x17), .O(new_n109_));
  oai21  g064(.a(new_n91_), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n64_), .c(new_n48_), .d(new_n53_), .O(new_n111_));
  inv1   g066(.a(new_n111_), .O(z12));
  oai21  g067(.a(x07), .b(new_n103_), .c(new_n48_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(x05), .O(new_n114_));
  ...
  nor2   g073(.a(x15), .b(new_n53_), .O(new_n119_));
  nor2   g074(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g075(.a(new_n120_), .b(new_n116_), .c(new_n114_), .d(new_n50_), .O(z13));
  nor2   g076(.a(x21), .b(x20), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n91_), .c(x19), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n53_), .O(new_n124_));
  aoi21  g079(.a(new_n117_), .b(x21), .c(new_n124_), .O(new_n125_));
  oai21  g080(.a(new_n125_), .b(x15), .c(new_n114_), .O(z14));
  nand2  g081(.a(new_n123_), .b(x22), .O(new_n127_));
  inv1   g082(.a(new_n115_), .O(new_n128_));
  inv1   g083(.a(new_n93_), .O(new_n129_));
  nor2   g084(.a(new_n129_), .b(x20), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n127_), .c(new_n53_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n48_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n114_), .O(z15));
  inv1   g089(.a(x23), .O(new_n135_));
  aoi21  g090(.a(new_n130_), .b(new_n128_), .c(new_n135_), .O(new_n136_));
  nand4  g091(.a(new_n122_), .b(new_n128_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n53_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n136_), .c(new_n48_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n114_), .O(z16));
  nand3  g095(.a(new_n94_), .b(new_n87_), .c(new_n88_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(x20), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(x19), .c(x18), .d(x17), .O(new_n143_));
  nand2  g098(.a(new_n137_), .b(x24), .O(new_n144_));
  nor2   g099(.a(new_n119_), .b(new_n49_), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n114_), .O(z17));
  nand2  g101(.a(new_n95_), .b(x25), .O(new_n147_));
  nor3   g102(.a(new_n129_), .b(new_n85_), .c(x23), .O(new_n148_));
  aoi21  g103(.a(new_n148_), .b(new_n118_), .c(new_n119_), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n147_), .c(new_n114_), .d(new_n50_), .O(z18));
endmodule
