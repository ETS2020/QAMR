...
module FAU ( 
  ...
  nand3  g40(.a(new_n63_), .b(new_n47_), .c(new_n85_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n85_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  oai21  g45(.a(x15), .b(x05), .c(x04), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n85_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n49_), .O(z11));
  ...
  nand4  g51(.a(new_n96_), .b(new_n62_), .c(new_n47_), .d(new_n85_), .O(new_n97_));
  ...
  aoi21  g56(.a(new_n101_), .b(new_n94_), .c(new_n48_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n91_), .d(new_n85_), .O(z13));
  inv1   g58(.a(x05), .O(new_n104_));
  oai21  g59(.a(x07), .b(new_n104_), .c(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x04), .O(new_n106_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n85_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n91_), .d(new_n85_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n109_), .b(new_n119_), .c(new_n80_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n99_), .c(new_n85_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n106_), .O(z16));
  oai21  g79(.a(new_n121_), .b(new_n99_), .c(x24), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n101_), .d(new_n94_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n125_), .c(new_n85_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n106_), .O(z17));
  nand2  g86(.a(new_n127_), .b(new_n126_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n107_), .c(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n126_), .c(new_n101_), .d(new_n94_), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n133_), .c(new_n85_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n106_), .O(z18));
endmodule
