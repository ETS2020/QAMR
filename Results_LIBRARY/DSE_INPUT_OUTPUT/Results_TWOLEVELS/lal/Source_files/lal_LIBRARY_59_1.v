...
module FAU ( 
  ...
  nand4  g40(.a(new_n47_), .b(new_n51_), .c(x05), .d(x04), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand2  g42(.a(x05), .b(x04), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n47_), .c(x07), .O(z11));
  ...
  nand4  g51(.a(new_n96_), .b(new_n88_), .c(new_n47_), .d(new_n51_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  aoi21  g53(.a(x05), .b(x04), .c(x15), .O(new_n99_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n99_), .d(new_n51_), .O(z13));
  or2    g58(.a(new_n99_), .b(x07), .O(new_n104_));
  ...
  nand4  g72(.a(new_n106_), .b(new_n117_), .c(new_n115_), .d(new_n81_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n61_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n47_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n51_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  inv1   g77(.a(new_n102_), .O(new_n123_));
  nand3  g78(.a(new_n110_), .b(new_n80_), .c(new_n115_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n122_), .c(new_n61_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n51_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n104_), .d(new_n51_), .O(z18));
endmodule
