...
module FAU ( 
  ...
  nand3  g16(.a(new_n61_), .b(new_n50_), .c(new_n53_), .O(new_n62_));
  ...
  nand3  g35(.a(new_n48_), .b(x14), .c(new_n70_), .O(new_n81_));
  ...
  nand2  g44(.a(new_n48_), .b(new_n63_), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(new_n64_), .c(new_n50_), .O(z09));
  nand4  g46(.a(new_n64_), .b(new_n55_), .c(new_n48_), .d(new_n63_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n64_), .c(new_n48_), .d(new_n63_), .O(new_n95_));
  ...
  nand4  g75(.a(new_n120_), .b(new_n117_), .c(new_n112_), .d(new_n48_), .O(z15));
  nand2  g76(.a(new_n120_), .b(x23), .O(new_n122_));
  inv1   g77(.a(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n85_), .c(new_n114_), .d(new_n54_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n118_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n122_), .c(new_n112_), .d(new_n48_), .O(z16));
  oai21  g82(.a(new_n124_), .b(new_n102_), .c(x24), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n119_), .c(new_n105_), .d(new_n97_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n104_), .d(new_n63_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n109_), .O(z17));
  nand2  g88(.a(new_n130_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n119_), .c(new_n105_), .d(new_n97_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n112_), .d(new_n48_), .O(z18));
endmodule
