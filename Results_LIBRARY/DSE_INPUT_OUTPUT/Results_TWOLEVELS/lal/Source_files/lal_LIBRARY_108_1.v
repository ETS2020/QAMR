...
module FAU ( 
  ...
  aoi21  g36(.a(new_n59_), .b(new_n55_), .c(new_n62_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(x21), .c(x23), .O(new_n83_));
  nor2   g38(.a(new_n49_), .b(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n53_), .c(new_n84_), .O(z08));
  inv1   g40(.a(x07), .O(new_n86_));
  nand3  g41(.a(new_n67_), .b(new_n48_), .c(new_n86_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n86_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n66_), .c(new_n48_), .d(new_n86_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n66_), .c(new_n48_), .d(new_n86_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nand3  g55(.a(new_n86_), .b(x05), .c(x04), .O(new_n101_));
  ...
  nand2  g59(.a(x15), .b(x14), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(z13));
  nand3  g61(.a(new_n67_), .b(new_n48_), .c(new_n86_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n94_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n86_), .O(new_n110_));
  ...
  aoi21  g71(.a(new_n116_), .b(new_n114_), .c(new_n115_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n48_), .d(new_n86_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n114_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n108_), .b(new_n114_), .c(new_n119_), .d(new_n62_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n101_), .c(new_n86_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n105_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nand4  g80(.a(new_n53_), .b(new_n119_), .c(new_n62_), .d(new_n61_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(new_n115_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n48_), .d(new_n86_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n102_), .c(x25), .O(new_n130_));
  nor2   g85(.a(x20), .b(new_n58_), .O(new_n131_));
  nor2   g86(.a(x22), .b(x21), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n94_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n130_), .c(new_n101_), .d(new_n86_), .O(new_n135_));
