...
module FAU ( 
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n97_), .d(new_n84_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n97_), .d(new_n84_), .O(z14));
  or2    g60(.a(new_n97_), .b(x15), .O(new_n106_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n84_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  inv1   g67(.a(x23), .O(new_n113_));
  nand3  g68(.a(new_n103_), .b(new_n113_), .c(new_n79_), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n108_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n106_), .d(new_n84_), .O(z16));
  oai21  g72(.a(new_n114_), .b(new_n98_), .c(x24), .O(new_n118_));
  nand3  g73(.a(new_n84_), .b(x05), .c(x04), .O(new_n119_));
  nor2   g74(.a(x20), .b(new_n55_), .O(new_n120_));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n109_), .c(new_n120_), .d(new_n92_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n84_), .O(z17));
  nand2  g80(.a(new_n121_), .b(new_n109_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n100_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n109_), .c(new_n120_), .d(new_n92_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n119_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n84_), .O(z18));
endmodule
