...
module FAU ( 
  ...
  aoi21  g41(.a(new_n86_), .b(x04), .c(new_n64_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x15), .O(z09));
  nand3  g43(.a(new_n53_), .b(new_n86_), .c(new_n63_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(x05), .c(x15), .O(z10));
  inv1   g45(.a(x15), .O(new_n91_));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n91_), .c(new_n86_), .d(x05), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x04), .O(z11));
  ...
  nand3  g52(.a(new_n97_), .b(new_n86_), .c(new_n63_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(x05), .c(x15), .O(z12));
  nand3  g54(.a(new_n91_), .b(new_n86_), .c(x04), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x05), .O(new_n102_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nand4  g59(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nor2   g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n104_), .c(new_n102_), .d(new_n91_), .O(z13));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n95_), .c(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n91_), .c(x05), .O(new_n111_));
  ...
  and2   g72(.a(new_n117_), .b(new_n48_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n102_), .d(new_n91_), .O(z15));
  inv1   g74(.a(x23), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n115_), .c(new_n120_), .d(new_n59_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n91_), .c(x05), .O(new_n122_));
  aoi21  g77(.a(new_n117_), .b(x23), .c(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n102_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nand4  g80(.a(new_n50_), .b(new_n120_), .c(new_n59_), .d(new_n58_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n106_), .c(new_n47_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n102_), .d(new_n91_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n105_), .c(x25), .O(new_n130_));
  nor2   g85(.a(x20), .b(new_n55_), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n116_), .c(new_n131_), .d(new_n95_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n100_), .d(new_n86_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x05), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n91_), .O(z18));
endmodule
