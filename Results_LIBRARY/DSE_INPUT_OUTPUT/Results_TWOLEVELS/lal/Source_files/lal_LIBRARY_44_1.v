...
module FAU ( 
  ...
  aoi21  g081(.a(x05), .b(x04), .c(x15), .O(new_n127_));
  nand2  g082(.a(new_n121_), .b(x21), .O(new_n128_));
  inv1   g083(.a(x20), .O(new_n129_));
  nand4  g084(.a(new_n91_), .b(new_n88_), .c(new_n129_), .d(x19), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n128_), .c(new_n127_), .d(new_n50_), .O(z14));
  inv1   g086(.a(new_n122_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n94_), .c(new_n129_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n59_), .O(new_n134_));
  aoi21  g089(.a(new_n130_), .b(x22), .c(new_n134_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(x15), .c(new_n50_), .O(z15));
  and2   g091(.a(new_n133_), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n52_), .b(new_n86_), .c(new_n88_), .d(new_n129_), .O(new_n138_));
  ...
  nand3  g096(.a(new_n95_), .b(new_n86_), .c(new_n88_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(x20), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(x19), .c(x18), .d(x17), .O(new_n144_));
  oai21  g099(.a(new_n87_), .b(new_n52_), .c(new_n144_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n47_), .O(new_n146_));
  nand2  g101(.a(new_n133_), .b(x24), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n146_), .c(new_n127_), .d(new_n50_), .O(z17));
  nor3   g103(.a(x25), .b(x24), .c(x23), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n94_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n121_), .c(new_n59_), .O(new_n151_));
  aoi21  g106(.a(new_n96_), .b(x25), .c(new_n151_), .O(new_n152_));
  oai21  g107(.a(new_n152_), .b(x15), .c(new_n50_), .O(z18));
endmodule
