...
module FAU ( 
  ...
  nor2   g003(.a(new_n48_), .b(x02), .O(new_n49_));
  ...
  inv1   g040(.a(x02), .O(new_n86_));
  nor2   g041(.a(x11), .b(new_n86_), .O(new_n87_));
  inv1   g042(.a(x11), .O(new_n88_));
  nor2   g043(.a(x15), .b(new_n88_), .O(new_n89_));
  aoi21  g044(.a(new_n89_), .b(new_n86_), .c(new_n87_), .O(new_n90_));
  ...
  nand3  g055(.a(new_n67_), .b(new_n48_), .c(new_n100_), .O(new_n101_));
  ...
  nand2  g061(.a(new_n106_), .b(new_n50_), .O(z11));
  ...
  nand4  g066(.a(new_n111_), .b(new_n66_), .c(new_n48_), .d(new_n100_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n50_), .O(z12));
  nand3  g068(.a(x19), .b(x18), .c(x17), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(x20), .O(new_n115_));
  nand3  g070(.a(new_n67_), .b(new_n48_), .c(new_n100_), .O(new_n116_));
  inv1   g071(.a(new_n116_), .O(new_n117_));
  nand4  g072(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n118_));
  inv1   g073(.a(new_n118_), .O(new_n119_));
  nor2   g074(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand4  g075(.a(new_n120_), .b(new_n115_), .c(new_n48_), .d(new_n100_), .O(z13));
  nor2   g076(.a(new_n119_), .b(new_n61_), .O(new_n122_));
  nand3  g077(.a(new_n100_), .b(x05), .c(x04), .O(new_n123_));
  nor2   g078(.a(x21), .b(x20), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n109_), .c(x19), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n123_), .c(new_n100_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(new_n122_), .c(new_n48_), .O(new_n127_));
  nand2  g082(.a(x15), .b(x02), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n127_), .O(z14));
  ...
  nand4  g089(.a(new_n134_), .b(new_n131_), .c(new_n123_), .d(new_n100_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n48_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n128_), .O(z15));
  inv1   g092(.a(x23), .O(new_n138_));
  nand4  g093(.a(new_n124_), .b(new_n132_), .c(new_n138_), .d(new_n62_), .O(new_n139_));
  nand3  g094(.a(new_n139_), .b(new_n116_), .c(new_n100_), .O(new_n140_));
  aoi21  g095(.a(new_n134_), .b(x23), .c(new_n140_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n48_), .O(z16));
  nand2  g097(.a(new_n139_), .b(x24), .O(new_n143_));
  nand4  g098(.a(new_n53_), .b(new_n138_), .c(new_n62_), .d(new_n61_), .O(new_n144_));
  nor2   g099(.a(new_n144_), .b(new_n118_), .O(new_n145_));
  nor2   g100(.a(new_n145_), .b(new_n117_), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n143_), .c(new_n48_), .d(new_n100_), .O(z17));
  oai21  g102(.a(new_n144_), .b(new_n118_), .c(x25), .O(new_n148_));
  ...
  nand4  g106(.a(new_n151_), .b(new_n148_), .c(new_n123_), .d(new_n100_), .O(new_n152_));
  nand2  g107(.a(new_n152_), .b(new_n48_), .O(new_n153_));
  nand2  g108(.a(new_n153_), .b(new_n128_), .O(z18));
endmodule
