...
module FAU ( 
  ...
  aoi21  g38(.a(new_n60_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g39(.a(x15), .O(new_n85_));
  nand4  g40(.a(new_n60_), .b(new_n52_), .c(new_n85_), .d(new_n47_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n60_), .c(new_n85_), .d(new_n47_), .O(new_n89_));
  ...
  nand4  g48(.a(new_n93_), .b(new_n60_), .c(new_n85_), .d(new_n47_), .O(new_n94_));
  ...
  nor2   g53(.a(x07), .b(new_n98_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(x04), .c(x15), .O(new_n100_));
  nand4  g55(.a(new_n51_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n97_), .d(new_n64_), .O(z13));
  ...
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n60_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n85_), .O(z14));
  nand2  g63(.a(new_n105_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n96_), .O(new_n110_));
  ...
  nand4  g70(.a(new_n104_), .b(new_n110_), .c(new_n114_), .d(new_n79_), .O(new_n116_));
  ...
  nand3  g76(.a(new_n121_), .b(new_n78_), .c(new_n114_), .O(new_n122_));
  or2    g77(.a(new_n122_), .b(new_n101_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n120_), .c(new_n100_), .d(new_n64_), .O(z17));
  oai21  g79(.a(new_n122_), .b(new_n101_), .c(x25), .O(new_n125_));
  nor2   g80(.a(x20), .b(new_n54_), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n121_), .c(new_n126_), .d(new_n91_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n125_), .c(new_n60_), .O(new_n129_));
