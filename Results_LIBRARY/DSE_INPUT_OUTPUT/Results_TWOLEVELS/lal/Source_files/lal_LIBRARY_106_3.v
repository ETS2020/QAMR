...
module FAU ( 
  ...
  nand3  g60(.a(new_n96_), .b(new_n53_), .c(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n103_), .O(z13));
  inv1   g64(.a(x21), .O(new_n110_));
  nand4  g65(.a(new_n96_), .b(new_n110_), .c(new_n53_), .d(x19), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  aoi21  g67(.a(new_n106_), .b(x21), .c(new_n112_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(x15), .c(new_n103_), .O(z14));
  nand2  g69(.a(new_n111_), .b(x22), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n53_), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(new_n104_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(x07), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n103_), .O(z15));
  inv1   g77(.a(x23), .O(new_n123_));
  nor2   g78(.a(new_n118_), .b(new_n123_), .O(new_n124_));
  nand4  g79(.a(new_n123_), .b(new_n84_), .c(new_n110_), .d(new_n53_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n104_), .c(new_n47_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(new_n124_), .c(new_n48_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n103_), .O(z16));
  nand2  g83(.a(x24), .b(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n101_), .c(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nor2   g86(.a(new_n118_), .b(new_n83_), .O(new_n132_));
  nand3  g87(.a(new_n116_), .b(new_n83_), .c(new_n123_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n106_), .c(new_n47_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(new_n132_), .c(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n131_), .O(z17));
  oai21  g91(.a(new_n133_), .b(new_n106_), .c(x25), .O(new_n137_));
  inv1   g92(.a(new_n106_), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand3  g94(.a(new_n139_), .b(new_n116_), .c(new_n138_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n137_), .c(new_n103_), .d(new_n47_), .O(z18));
endmodule
