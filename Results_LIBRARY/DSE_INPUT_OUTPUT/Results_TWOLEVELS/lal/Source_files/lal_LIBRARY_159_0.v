...
module FAU ( 
  ...
  nand2  g21(.a(z13), .b(new_n66_), .O(z02));
  nand3  g22(.a(new_n58_), .b(z13), .c(new_n50_), .O(new_n68_));
  ...
  nand3  g34(.a(z13), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g41(.a(new_n62_), .b(new_n61_), .O(z14));
  zero   g42(.O(z10));
  zero   g43(.O(z12));
  nor2   g44(.a(x15), .b(x07), .O(z11));
  nand2  g45(.a(new_n62_), .b(new_n61_), .O(z15));
  inv1   g46(.a(z09), .O(z16));
  inv1   g47(.a(z09), .O(z17));
  nand2  g48(.a(new_n62_), .b(new_n61_), .O(z18));
endmodule
