...
module FAU ( 
  ...
  nor2   g19(.a(z11), .b(new_n64_), .O(z02));
  ...
  nor3   g29(.a(z11), .b(x13), .c(x08), .O(z05));
  ...
  nand2  g40(.a(new_n88_), .b(new_n51_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z12));
  nand2  g44(.a(new_n88_), .b(new_n51_), .O(z14));
  nand2  g45(.a(new_n88_), .b(new_n51_), .O(z15));
