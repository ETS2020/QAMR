...
module FAU ( 
  ...
  nand3  g43(.a(new_n88_), .b(new_n47_), .c(new_n51_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  inv1   g45(.a(new_n88_), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n91_), .c(new_n47_), .d(new_n51_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n91_), .c(new_n47_), .d(new_n51_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n97_), .b(new_n53_), .c(x19), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n61_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n51_), .O(z13));
  oai21  g62(.a(new_n87_), .b(new_n86_), .c(new_n47_), .O(new_n108_));
  ...
  inv1   g68(.a(new_n102_), .O(new_n114_));
  ...
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n51_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n111_), .b(new_n114_), .c(new_n121_), .d(new_n81_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n109_), .d(new_n51_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  inv1   g79(.a(new_n104_), .O(new_n125_));
  nand3  g80(.a(new_n115_), .b(new_n80_), .c(new_n121_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n124_), .c(new_n61_), .O(new_n129_));
  ...
  nand3  g88(.a(new_n133_), .b(new_n115_), .c(new_n125_), .O(new_n134_));
