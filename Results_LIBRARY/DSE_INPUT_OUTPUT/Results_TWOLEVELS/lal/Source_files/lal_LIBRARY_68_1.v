...
module FAU ( 
  ...
  aoi21  g15(.a(new_n60_), .b(x15), .c(new_n47_), .O(new_n61_));
  ...
  aoi21  g38(.a(new_n81_), .b(x21), .c(new_n83_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n47_), .c(new_n80_), .O(z08));
  nor4   g40(.a(new_n62_), .b(x24), .c(x15), .d(x07), .O(z09));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n62_), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n62_), .c(new_n87_), .O(new_n91_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n62_), .c(new_n87_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n47_), .c(x15), .O(z12));
  inv1   g52(.a(x15), .O(new_n98_));
  oai21  g53(.a(new_n62_), .b(x07), .c(new_n47_), .O(new_n99_));
  ...
  nor2   g57(.a(x20), .b(new_n54_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n93_), .c(x15), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n100_), .d(new_n87_), .O(z13));
  aoi21  g60(.a(new_n103_), .b(new_n93_), .c(new_n57_), .O(new_n106_));
  nand3  g61(.a(new_n63_), .b(new_n98_), .c(new_n87_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n110_), .b(new_n106_), .c(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n98_), .O(z14));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n100_), .d(new_n87_), .O(z15));
  aoi21  g72(.a(new_n115_), .b(new_n114_), .c(new_n82_), .O(new_n118_));
  nand4  g73(.a(new_n108_), .b(new_n114_), .c(new_n82_), .d(new_n58_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n107_), .c(new_n87_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n98_), .O(z16));
  nand2  g77(.a(new_n120_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n98_), .O(z17));
  nand2  g79(.a(new_n119_), .b(x25), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nor2   g81(.a(x25), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n126_), .c(new_n103_), .d(new_n93_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n107_), .d(new_n87_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n98_), .O(z18));
endmodule
