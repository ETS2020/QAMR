...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n46_, new_n47_, new_n48_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  nor2   g02(.a(x15), .b(x07), .O(new_n48_));
  inv1   g03(.a(new_n48_), .O(z14));
  nand2  g04(.a(z14), .b(new_n47_), .O(z02));
  ...
  nand3  g20(.a(new_n62_), .b(z14), .c(new_n54_), .O(new_n66_));
  ...
  nor2   g39(.a(new_n53_), .b(x07), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n53_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  inv1   g45(.a(new_n48_), .O(z15));
  nand2  g46(.a(new_n89_), .b(new_n53_), .O(z16));
  nand2  g47(.a(new_n89_), .b(new_n53_), .O(z17));
  inv1   g48(.a(new_n48_), .O(z18));
endmodule
