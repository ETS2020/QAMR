...
module FAU ( 
  ...
  nand4  g066(.a(new_n111_), .b(new_n54_), .c(new_n47_), .d(new_n51_), .O(new_n112_));
  ...
  nand3  g088(.a(new_n133_), .b(new_n94_), .c(new_n130_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n60_), .O(new_n135_));
  aoi21  g090(.a(new_n131_), .b(x22), .c(new_n135_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(x15), .c(new_n51_), .O(z15));
  and2   g092(.a(new_n134_), .b(x23), .O(new_n138_));
  nand4  g093(.a(new_n53_), .b(new_n86_), .c(new_n88_), .d(new_n130_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n122_), .c(new_n60_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n138_), .c(new_n47_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n51_), .O(z16));
  nand4  g097(.a(new_n94_), .b(x25), .c(new_n87_), .d(new_n53_), .O(new_n143_));
  oai22  g098(.a(new_n143_), .b(new_n121_), .c(new_n87_), .d(new_n53_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n47_), .O(new_n145_));
  nand2  g100(.a(new_n134_), .b(x24), .O(new_n146_));
  nand4  g101(.a(new_n94_), .b(new_n52_), .c(new_n87_), .d(new_n53_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(new_n121_), .O(new_n148_));
  nor2   g103(.a(new_n148_), .b(x07), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n146_), .c(new_n145_), .d(new_n128_), .O(z17));
  nand3  g105(.a(new_n96_), .b(x25), .c(new_n47_), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n149_), .c(new_n128_), .O(z18));
endmodule
