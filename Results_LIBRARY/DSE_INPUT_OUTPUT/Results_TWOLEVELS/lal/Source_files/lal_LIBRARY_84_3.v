...
module FAU ( 
  ...
  nand3  g035(.a(new_n48_), .b(x14), .c(new_n70_), .O(new_n81_));
  ...
  oai21  g040(.a(new_n85_), .b(new_n59_), .c(new_n55_), .O(new_n86_));
  nand2  g041(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g042(.a(new_n85_), .b(new_n55_), .O(new_n88_));
  nand2  g043(.a(new_n88_), .b(x20), .O(new_n89_));
  oai21  g044(.a(x25), .b(x24), .c(x23), .O(new_n90_));
  nand3  g045(.a(new_n61_), .b(x19), .c(x18), .O(new_n91_));
  ...
  nand4  g052(.a(new_n97_), .b(new_n92_), .c(new_n54_), .d(new_n62_), .O(new_n98_));
  ...
  nand3  g057(.a(new_n60_), .b(x22), .c(x21), .O(new_n103_));
  aoi21  g058(.a(new_n103_), .b(new_n102_), .c(new_n54_), .O(new_n104_));
  oai21  g059(.a(new_n104_), .b(x25), .c(new_n47_), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(new_n101_), .O(z08));
  nand4  g061(.a(new_n48_), .b(new_n53_), .c(x05), .d(x04), .O(new_n107_));
  inv1   g062(.a(new_n107_), .O(z09));
  nand4  g063(.a(new_n66_), .b(new_n84_), .c(new_n48_), .d(new_n53_), .O(new_n109_));
  inv1   g064(.a(new_n109_), .O(z10));
  xor2a  g065(.a(x18), .b(x17), .O(new_n111_));
  nand4  g066(.a(new_n111_), .b(new_n66_), .c(new_n48_), .d(new_n53_), .O(new_n112_));
  ...
  nand4  g070(.a(new_n115_), .b(new_n66_), .c(new_n48_), .d(new_n53_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n53_), .b(x05), .c(x04), .O(new_n121_));
  nand4  g076(.a(new_n121_), .b(new_n120_), .c(new_n118_), .d(new_n53_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n48_), .O(new_n123_));
  nand2  g078(.a(x15), .b(new_n47_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n123_), .O(z13));
  inv1   g080(.a(new_n118_), .O(new_n126_));
  nor2   g081(.a(new_n126_), .b(new_n61_), .O(new_n127_));
  nor2   g082(.a(x21), .b(x20), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n93_), .c(x19), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n121_), .c(new_n53_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(new_n127_), .c(new_n48_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n124_), .O(z14));
  aoi21  g087(.a(x05), .b(x04), .c(x07), .O(new_n133_));
  nand2  g088(.a(new_n129_), .b(x22), .O(new_n134_));
  inv1   g089(.a(new_n119_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n95_), .c(new_n56_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n134_), .c(new_n133_), .d(new_n48_), .O(z15));
  nand2  g092(.a(new_n136_), .b(x23), .O(new_n138_));
  nand4  g093(.a(new_n128_), .b(new_n135_), .c(new_n102_), .d(new_n62_), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n138_), .c(new_n133_), .d(new_n48_), .O(z16));
  aoi21  g095(.a(x25), .b(x15), .c(x24), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n102_), .c(new_n62_), .d(new_n61_), .O(new_n142_));
  ...
  nand3  g100(.a(new_n145_), .b(new_n121_), .c(new_n53_), .O(new_n146_));
  aoi22  g101(.a(new_n146_), .b(new_n48_), .c(new_n136_), .d(x24), .O(new_n147_));
  nand3  g102(.a(new_n147_), .b(new_n144_), .c(new_n48_), .O(z17));
  nand2  g103(.a(new_n97_), .b(x25), .O(new_n149_));
  nor3   g104(.a(x25), .b(x24), .c(x23), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n95_), .c(new_n126_), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n149_), .c(new_n133_), .d(new_n48_), .O(z18));
endmodule
