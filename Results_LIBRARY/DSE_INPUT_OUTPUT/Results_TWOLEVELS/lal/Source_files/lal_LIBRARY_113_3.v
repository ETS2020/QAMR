...
module FAU ( 
  ...
  nand4  g086(.a(new_n131_), .b(new_n130_), .c(new_n123_), .d(new_n47_), .O(z14));
  nand2  g087(.a(new_n131_), .b(x22), .O(new_n133_));
  inv1   g088(.a(new_n125_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n98_), .c(new_n53_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n133_), .c(new_n123_), .d(new_n47_), .O(z15));
  and2   g091(.a(new_n135_), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n105_), .b(new_n59_), .c(new_n58_), .d(new_n53_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n125_), .c(new_n47_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n137_), .c(new_n48_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n123_), .O(z16));
  nand3  g096(.a(new_n99_), .b(new_n59_), .c(new_n58_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(x20), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(x19), .c(x18), .d(x17), .O(new_n144_));
  oai21  g099(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n98_), .b(new_n52_), .c(new_n93_), .d(new_n105_), .O(new_n151_));
  nor2   g106(.a(new_n151_), .b(new_n124_), .O(new_n152_));
  aoi21  g107(.a(new_n100_), .b(x25), .c(new_n152_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n121_), .c(new_n48_), .d(new_n47_), .O(z18));
endmodule
