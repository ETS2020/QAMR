...
module FAU ( 
  ...
  nor2   g23(.a(z11), .b(new_n68_), .O(z02));
  ...
  aoi21  g35(.a(new_n46_), .b(x06), .c(z11), .O(z07));
  inv1   g36(.a(new_n64_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n49_), .c(z11), .O(z08));
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n86_));
  nand3  g39(.a(new_n86_), .b(new_n82_), .c(new_n50_), .O(z13));
  aoi21  g40(.a(new_n86_), .b(new_n82_), .c(z11), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  aoi21  g44(.a(new_n86_), .b(new_n82_), .c(z11), .O(z15));
  nand3  g45(.a(new_n86_), .b(new_n82_), .c(new_n50_), .O(z16));
  aoi21  g46(.a(new_n86_), .b(new_n82_), .c(z11), .O(z17));
