...
module FAU ( 
  ...
  nand3  g016(.a(new_n49_), .b(x05), .c(x04), .O(new_n62_));
  ...
  oai21  g036(.a(new_n81_), .b(new_n55_), .c(new_n51_), .O(new_n82_));
  ...
  nor2   g044(.a(x20), .b(new_n54_), .O(new_n90_));
  ...
  nand4  g048(.a(new_n93_), .b(new_n88_), .c(new_n50_), .d(new_n58_), .O(new_n94_));
  ...
  nand3  g054(.a(new_n56_), .b(x22), .c(x21), .O(new_n100_));
  aoi21  g055(.a(new_n100_), .b(new_n99_), .c(new_n50_), .O(new_n101_));
  ...
  nand2  g059(.a(new_n98_), .b(new_n49_), .O(new_n105_));
  oai21  g060(.a(new_n105_), .b(new_n104_), .c(new_n47_), .O(z09));
  nand4  g061(.a(new_n104_), .b(new_n80_), .c(new_n98_), .d(new_n49_), .O(new_n107_));
  nand2  g062(.a(new_n107_), .b(new_n47_), .O(z10));
  xor2a  g063(.a(x18), .b(x17), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n104_), .c(new_n98_), .d(new_n49_), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z11));
  nand3  g066(.a(new_n54_), .b(x18), .c(x17), .O(new_n112_));
  oai21  g067(.a(new_n89_), .b(new_n54_), .c(new_n112_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n104_), .c(new_n98_), .d(new_n49_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n47_), .O(z12));
  nand2  g070(.a(new_n104_), .b(new_n98_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n120_), .b(new_n118_), .c(new_n49_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n98_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n117_), .O(z13));
  nor2   g078(.a(x21), .b(x20), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n89_), .c(x19), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n49_), .O(new_n126_));
  aoi21  g081(.a(new_n118_), .b(x21), .c(new_n126_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(x15), .c(new_n117_), .O(z14));
  nand2  g083(.a(new_n91_), .b(new_n52_), .O(new_n129_));
  nor2   g084(.a(new_n129_), .b(new_n119_), .O(new_n130_));
  aoi21  g085(.a(new_n125_), .b(x22), .c(new_n130_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n117_), .c(new_n49_), .O(z15));
  nor2   g087(.a(new_n130_), .b(new_n99_), .O(new_n133_));
  nand3  g088(.a(new_n124_), .b(new_n99_), .c(new_n58_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n119_), .c(new_n49_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n133_), .c(new_n98_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n117_), .O(z16));
  nand2  g092(.a(x25), .b(new_n49_), .O(new_n138_));
  nand2  g093(.a(new_n51_), .b(new_n98_), .O(new_n139_));
  aoi21  g094(.a(new_n139_), .b(new_n138_), .c(x24), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n99_), .c(new_n58_), .d(new_n57_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(x20), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(x19), .c(x18), .d(x17), .O(new_n143_));
  oai21  g098(.a(new_n134_), .b(new_n119_), .c(x24), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n49_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n98_), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n143_), .c(new_n117_), .O(z17));
  nand4  g102(.a(new_n91_), .b(new_n51_), .c(new_n50_), .d(new_n99_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n118_), .c(new_n49_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n98_), .O(new_n150_));
  aoi21  g105(.a(new_n93_), .b(x25), .c(new_n116_), .O(new_n151_));
