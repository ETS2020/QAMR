...
module FAU ( 
  ...
  nand3  g55(.a(new_n94_), .b(new_n53_), .c(x19), .O(new_n101_));
  ...
  nor2   g68(.a(new_n113_), .b(new_n62_), .O(new_n114_));
  ...
  nand4  g75(.a(new_n105_), .b(new_n120_), .c(new_n118_), .d(new_n81_), .O(new_n121_));
  ...
  inv1   g80(.a(new_n101_), .O(new_n126_));
  nand3  g81(.a(new_n111_), .b(new_n80_), .c(new_n118_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n125_), .c(new_n61_), .O(new_n130_));
  ...
  nand3  g89(.a(new_n134_), .b(new_n111_), .c(new_n126_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n86_), .d(new_n51_), .O(z18));
endmodule
