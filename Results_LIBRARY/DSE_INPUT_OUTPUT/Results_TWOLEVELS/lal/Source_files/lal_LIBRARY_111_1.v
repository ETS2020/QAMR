...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n57_), .c(new_n47_), .d(new_n51_), .O(new_n91_));
  ...
  aoi21  g50(.a(new_n58_), .b(new_n47_), .c(new_n57_), .O(new_n96_));
  ...
  nor2   g57(.a(new_n58_), .b(new_n57_), .O(new_n103_));
  nor2   g58(.a(x20), .b(new_n59_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n102_), .c(new_n52_), .d(new_n51_), .O(z13));
  nand3  g61(.a(new_n51_), .b(x05), .c(x04), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(x19), .c(x18), .d(x17), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  aoi21  g65(.a(new_n105_), .b(x21), .c(new_n110_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(x15), .c(new_n51_), .O(z14));
  ...
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n107_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n51_), .O(z15));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n83_), .O(new_n120_));
  nor2   g75(.a(x23), .b(x22), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n108_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n101_), .c(new_n107_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n120_), .c(new_n47_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n51_), .O(z16));
  oai21  g80(.a(new_n122_), .b(new_n101_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x22), .b(x21), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n127_), .c(new_n104_), .d(new_n103_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n126_), .c(new_n107_), .O(new_n130_));
  ...
  nand4  g89(.a(new_n134_), .b(new_n127_), .c(new_n104_), .d(new_n103_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n54_), .d(new_n51_), .O(z18));
endmodule
