...
module FAU ( 
  ...
  oai21  g66(.a(new_n100_), .b(x15), .c(new_n47_), .O(new_n112_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n47_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n48_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n112_), .O(z13));
  nor2   g73(.a(x21), .b(x20), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n91_), .c(x19), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  aoi21  g76(.a(new_n113_), .b(x21), .c(new_n121_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(x15), .c(new_n112_), .O(z14));
  inv1   g78(.a(new_n114_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n93_), .c(new_n54_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x22), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x15), .c(new_n112_), .O(z15));
  nand2  g83(.a(new_n125_), .b(x23), .O(new_n129_));
  nor2   g84(.a(x23), .b(x22), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n119_), .c(new_n124_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n112_), .d(new_n47_), .O(z16));
  nand3  g87(.a(new_n94_), .b(new_n86_), .c(new_n88_), .O(new_n133_));
  ...
  nand4  g91(.a(new_n136_), .b(new_n135_), .c(new_n112_), .d(new_n47_), .O(z17));
  nand2  g92(.a(new_n95_), .b(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n112_), .d(new_n47_), .O(z18));
endmodule
