...
module FAU ( 
  ...
  oai21  g64(.a(new_n109_), .b(x15), .c(new_n50_), .O(z14));
  inv1   g65(.a(z09), .O(new_n111_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n111_), .d(new_n50_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n106_), .b(new_n113_), .c(new_n118_), .d(new_n81_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n111_), .d(new_n50_), .O(z16));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n114_), .c(new_n101_), .d(new_n94_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n60_), .O(new_n123_));
  aoi21  g78(.a(new_n119_), .b(x24), .c(new_n123_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x15), .c(new_n50_), .O(z17));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n114_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n102_), .c(new_n60_), .O(new_n128_));
  aoi21  g83(.a(new_n122_), .b(x25), .c(new_n128_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x15), .c(new_n50_), .O(z18));
endmodule
