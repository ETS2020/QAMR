...
module FAU ( 
  ...
  nor2   g20(.a(new_n49_), .b(x07), .O(new_n66_));
  nand3  g21(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(z01));
  inv1   g22(.a(x16), .O(new_n68_));
  nand2  g23(.a(new_n50_), .b(new_n68_), .O(z02));
  nand2  g24(.a(new_n64_), .b(new_n50_), .O(z03));
  nor2   g25(.a(x10), .b(x08), .O(new_n71_));
  oai21  g26(.a(new_n71_), .b(x15), .c(x01), .O(new_n72_));
  inv1   g27(.a(x09), .O(new_n73_));
  aoi22  g28(.a(x10), .b(new_n47_), .c(new_n73_), .d(x00), .O(new_n74_));
  ...
  aoi21  g39(.a(new_n58_), .b(new_n54_), .c(new_n61_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x21), .c(x23), .O(new_n86_));
  nor2   g41(.a(new_n49_), .b(x25), .O(new_n87_));
  oai21  g42(.a(new_n86_), .b(new_n52_), .c(new_n87_), .O(z08));
  inv1   g43(.a(x07), .O(new_n89_));
  inv1   g44(.a(new_n65_), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n48_), .c(new_n89_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand4  g47(.a(new_n65_), .b(new_n55_), .c(new_n48_), .d(new_n89_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n65_), .c(new_n48_), .d(new_n89_), .O(new_n96_));
  ...
  and2   g76(.a(new_n121_), .b(new_n112_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n48_), .d(new_n89_), .O(z15));
  nand2  g78(.a(new_n121_), .b(x23), .O(new_n124_));
  inv1   g79(.a(new_n112_), .O(new_n125_));
  inv1   g80(.a(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n61_), .c(new_n60_), .d(new_n54_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n119_), .c(new_n125_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n124_), .c(new_n48_), .d(new_n89_), .O(z16));
  oai21  g85(.a(new_n127_), .b(new_n103_), .c(x24), .O(new_n131_));
  nor2   g86(.a(x24), .b(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n120_), .c(new_n106_), .d(new_n98_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n105_), .d(new_n89_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n110_), .O(z17));
  nand2  g91(.a(new_n133_), .b(x25), .O(new_n137_));
  inv1   g92(.a(new_n107_), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  and2   g94(.a(new_n139_), .b(new_n120_), .O(new_n140_));
  aoi21  g95(.a(new_n140_), .b(new_n138_), .c(new_n125_), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n137_), .c(new_n48_), .d(new_n89_), .O(z18));
endmodule
