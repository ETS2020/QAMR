...
module FAU ( 
  ...
  nand3  g33(.a(new_n50_), .b(x14), .c(new_n70_), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z06));
  aoi21  g35(.a(new_n70_), .b(x06), .c(new_n49_), .O(z07));
  ...
  nand3  g42(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n50_), .O(z09));
  nand4  g44(.a(new_n62_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z12));
  oai21  g54(.a(new_n63_), .b(x15), .c(new_n47_), .O(new_n100_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n100_), .O(z13));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n100_), .d(new_n47_), .O(z14));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n100_), .d(new_n47_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n109_), .b(new_n113_), .c(new_n118_), .d(new_n83_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n100_), .d(new_n47_), .O(z16));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n114_), .c(new_n103_), .d(new_n95_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  aoi21  g78(.a(new_n119_), .b(x24), .c(new_n123_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x15), .c(new_n100_), .O(z17));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n114_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n104_), .c(new_n47_), .O(new_n128_));
  aoi21  g83(.a(new_n122_), .b(x25), .c(new_n128_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x15), .c(new_n100_), .O(z18));
endmodule
