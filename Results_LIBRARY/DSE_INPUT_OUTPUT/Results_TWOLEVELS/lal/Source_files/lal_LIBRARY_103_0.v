...
module FAU ( 
  ...
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  nand2  g45(.a(new_n89_), .b(new_n53_), .O(z14));
  nand2  g46(.a(new_n89_), .b(new_n53_), .O(z15));
  inv1   g47(.a(new_n48_), .O(z17));
  nand2  g48(.a(new_n89_), .b(new_n53_), .O(z18));
endmodule
