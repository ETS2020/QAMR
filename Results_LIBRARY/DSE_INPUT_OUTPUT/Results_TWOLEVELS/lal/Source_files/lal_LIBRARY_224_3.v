...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n71_, new_n72_, new_n74_, new_n75_, new_n77_, new_n78_, new_n81_,
  ...
  aoi21  g33(.a(new_n78_), .b(x08), .c(new_n77_), .O(z06));
  ...
  aoi21  g39(.a(x15), .b(x14), .c(x25), .O(new_n85_));
  oai21  g40(.a(new_n84_), .b(new_n81_), .c(new_n85_), .O(z08));
  nand4  g41(.a(new_n78_), .b(new_n59_), .c(x05), .d(x04), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand4  g43(.a(new_n60_), .b(new_n51_), .c(new_n78_), .d(new_n59_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n47_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n60_), .c(new_n78_), .d(new_n59_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n60_), .c(new_n78_), .d(new_n59_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n47_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nand3  g55(.a(new_n59_), .b(x05), .c(x04), .O(new_n101_));
  nand4  g56(.a(new_n50_), .b(x19), .c(x18), .d(x17), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n59_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n78_), .O(new_n104_));
  nand2  g59(.a(x15), .b(new_n77_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(z13));
  nand2  g61(.a(new_n101_), .b(new_n59_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  nand2  g63(.a(new_n102_), .b(x21), .O(new_n109_));
  inv1   g64(.a(x21), .O(new_n110_));
  nand4  g65(.a(new_n94_), .b(new_n110_), .c(new_n50_), .d(x19), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n78_), .O(z14));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n108_), .d(new_n78_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x23), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n82_), .c(new_n110_), .d(new_n50_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n108_), .d(new_n78_), .O(z16));
  oai21  g78(.a(new_n120_), .b(new_n99_), .c(x24), .O(new_n124_));
  nor2   g79(.a(x20), .b(new_n53_), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n115_), .c(new_n125_), .d(new_n94_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n101_), .d(new_n59_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n78_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n105_), .O(z17));
  nand4  g85(.a(new_n81_), .b(new_n119_), .c(new_n82_), .d(new_n110_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n102_), .c(x25), .O(new_n132_));
  nor3   g87(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n115_), .c(new_n125_), .d(new_n94_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n101_), .d(new_n59_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n78_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n105_), .O(z18));
endmodule
