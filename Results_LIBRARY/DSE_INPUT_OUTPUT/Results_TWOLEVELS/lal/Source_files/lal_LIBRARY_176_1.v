...
module FAU ( 
  ...
  oai21  g36(.a(new_n81_), .b(new_n80_), .c(new_n54_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n56_), .O(new_n83_));
  nand2  g38(.a(new_n81_), .b(new_n54_), .O(new_n84_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n100_), .c(new_n47_), .d(new_n50_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(z11));
  nand3  g60(.a(new_n58_), .b(x18), .c(x17), .O(new_n106_));
  oai21  g61(.a(new_n92_), .b(new_n58_), .c(new_n106_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n100_), .c(new_n47_), .d(new_n50_), .O(new_n108_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n51_), .d(new_n50_), .O(z13));
  ...
  aoi21  g87(.a(new_n126_), .b(x24), .c(x07), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n53_), .O(z17));
  ...
  nand4  g92(.a(new_n137_), .b(new_n135_), .c(new_n53_), .d(new_n50_), .O(z18));
endmodule
