...
module FAU ( 
  ...
  aoi21  g37(.a(new_n82_), .b(new_n81_), .c(new_n53_), .O(new_n83_));
  ...
  aoi21  g43(.a(new_n63_), .b(new_n88_), .c(x18), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(x15), .O(z09));
  nand2  g45(.a(new_n62_), .b(new_n47_), .O(new_n91_));
  nor4   g46(.a(new_n91_), .b(x17), .c(x15), .d(x07), .O(z10));
  inv1   g47(.a(x17), .O(new_n93_));
  nor4   g48(.a(new_n91_), .b(new_n93_), .c(x15), .d(x07), .O(z11));
  nand4  g49(.a(new_n62_), .b(x19), .c(new_n47_), .d(new_n50_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z12));
  nand3  g51(.a(new_n63_), .b(new_n50_), .c(new_n88_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n55_), .c(new_n88_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n47_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n50_), .O(z13));
  nand3  g55(.a(new_n97_), .b(new_n57_), .c(new_n88_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n50_), .O(z14));
  nand3  g58(.a(new_n97_), .b(new_n58_), .c(new_n88_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n50_), .O(z15));
  nand3  g61(.a(new_n97_), .b(new_n81_), .c(new_n88_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n50_), .O(z16));
  nand3  g64(.a(new_n97_), .b(new_n53_), .c(new_n88_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n50_), .O(z17));
  nand2  g67(.a(x25), .b(new_n47_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n89_), .c(new_n50_), .d(new_n88_), .O(z18));
endmodule
