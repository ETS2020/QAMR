...
module FAU ( 
  ...
  nor2   g21(.a(new_n49_), .b(x07), .O(new_n67_));
  nand3  g22(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z01));
  nand2  g23(.a(new_n50_), .b(new_n46_), .O(z02));
  ...
  aoi21  g36(.a(new_n48_), .b(x08), .c(new_n47_), .O(z06));
  aoi21  g37(.a(new_n71_), .b(x06), .c(new_n49_), .O(z07));
  ...
  inv1   g43(.a(new_n66_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n48_), .c(new_n88_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  nand4  g46(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n88_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n66_), .c(new_n48_), .d(new_n88_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n66_), .c(new_n48_), .d(new_n88_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n88_), .b(x05), .c(x04), .O(new_n104_));
  nand4  g59(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n88_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(x15), .b(new_n47_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(z13));
  nand3  g64(.a(new_n89_), .b(new_n48_), .c(new_n88_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n97_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n88_), .O(new_n113_));
  aoi21  g68(.a(new_n105_), .b(x21), .c(new_n113_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n48_), .O(z14));
  nand2  g70(.a(new_n112_), .b(x22), .O(new_n116_));
  inv1   g71(.a(new_n102_), .O(new_n117_));
  inv1   g72(.a(new_n110_), .O(new_n118_));
  nor3   g73(.a(x22), .b(x21), .c(x20), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n117_), .c(new_n118_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n116_), .c(new_n48_), .d(new_n88_), .O(z15));
  inv1   g76(.a(x23), .O(new_n122_));
  aoi21  g77(.a(new_n119_), .b(new_n117_), .c(new_n122_), .O(new_n123_));
  nand4  g78(.a(new_n111_), .b(new_n117_), .c(new_n122_), .d(new_n62_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n104_), .c(new_n88_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n123_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n108_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n53_), .b(new_n122_), .c(new_n62_), .d(new_n61_), .O(new_n129_));
  nor2   g84(.a(new_n129_), .b(new_n105_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(new_n118_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n48_), .d(new_n88_), .O(z17));
  oai21  g87(.a(new_n129_), .b(new_n105_), .c(x25), .O(new_n133_));
  nor2   g88(.a(x20), .b(new_n58_), .O(new_n134_));
  nor2   g89(.a(x22), .b(x21), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n97_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n133_), .c(new_n104_), .d(new_n88_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n48_), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n108_), .O(z18));
endmodule
