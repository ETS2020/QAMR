...
module FAU ( 
  ...
  nand4  g51(.a(new_n96_), .b(new_n61_), .c(new_n47_), .d(new_n85_), .O(new_n97_));
  ...
  nand4  g78(.a(new_n108_), .b(new_n116_), .c(new_n122_), .d(new_n80_), .O(new_n124_));
  ...
  nand4  g84(.a(new_n79_), .b(new_n122_), .c(new_n80_), .d(new_n113_), .O(new_n130_));
  nor2   g85(.a(new_n130_), .b(new_n102_), .O(new_n131_));
  nor2   g86(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n128_), .c(new_n47_), .d(new_n85_), .O(z17));
  oai21  g88(.a(new_n130_), .b(new_n102_), .c(x25), .O(new_n134_));
  nor2   g89(.a(x20), .b(new_n55_), .O(new_n135_));
  nor2   g90(.a(x22), .b(x21), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n94_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n134_), .c(new_n101_), .d(new_n85_), .O(new_n139_));
