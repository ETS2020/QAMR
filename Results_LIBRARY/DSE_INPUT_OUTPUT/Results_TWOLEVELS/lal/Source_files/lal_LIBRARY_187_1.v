...
module FAU ( 
  ...
  aoi21  g65(.a(x05), .b(x04), .c(x15), .O(new_n111_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n111_), .d(new_n51_), .O(z15));
  and2   g71(.a(new_n115_), .b(x23), .O(new_n117_));
  ...
  nand4  g78(.a(new_n123_), .b(new_n114_), .c(new_n101_), .d(new_n94_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n61_), .O(new_n125_));
  aoi21  g80(.a(new_n119_), .b(x24), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n51_), .O(z17));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n114_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n102_), .c(new_n61_), .O(new_n130_));
  aoi21  g85(.a(new_n124_), .b(x25), .c(new_n130_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(x15), .c(new_n51_), .O(z18));
endmodule
