...
module FAU ( 
  ...
  aoi21  g39(.a(new_n87_), .b(new_n82_), .c(z09), .O(z13));
  nand3  g40(.a(new_n87_), .b(new_n82_), .c(new_n50_), .O(z15));
  zero   g41(.O(z10));
  zero   g42(.O(z11));
  zero   g43(.O(z12));
  aoi21  g44(.a(new_n87_), .b(new_n82_), .c(z09), .O(z14));
  aoi21  g45(.a(new_n87_), .b(new_n82_), .c(z09), .O(z16));
  nand3  g46(.a(new_n87_), .b(new_n82_), .c(new_n50_), .O(z17));
  aoi21  g47(.a(new_n87_), .b(new_n82_), .c(z09), .O(z18));
endmodule
