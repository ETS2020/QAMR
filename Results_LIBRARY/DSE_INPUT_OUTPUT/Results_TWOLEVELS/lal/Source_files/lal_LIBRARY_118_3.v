...
module FAU ( 
  ...
  nor4   g41(.a(new_n59_), .b(x19), .c(x18), .d(x17), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(x23), .c(x24), .O(new_n88_));
  aoi21  g43(.a(x25), .b(new_n54_), .c(new_n49_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n86_), .O(z08));
  nand3  g45(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand4  g47(.a(new_n62_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n50_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z12));
  nand3  g57(.a(new_n48_), .b(x05), .c(x04), .O(new_n103_));
  ...
  nand3  g62(.a(new_n98_), .b(new_n54_), .c(x19), .O(new_n108_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n105_), .d(new_n47_), .O(z14));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n105_), .d(new_n47_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n111_), .c(new_n115_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n105_), .d(new_n47_), .O(z16));
  nand2  g77(.a(x24), .b(x23), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n103_), .c(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  and2   g80(.a(new_n117_), .b(x24), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n116_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n108_), .c(new_n47_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n126_), .c(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n125_), .O(z17));
  oai21  g86(.a(new_n128_), .b(new_n108_), .c(x25), .O(new_n132_));
  inv1   g87(.a(new_n108_), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n116_), .c(new_n133_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n132_), .c(new_n105_), .d(new_n47_), .O(z18));
endmodule
