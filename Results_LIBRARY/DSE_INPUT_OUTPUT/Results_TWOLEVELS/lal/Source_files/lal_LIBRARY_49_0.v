...
module FAU ( 
  ...
  nor3   g34(.a(z09), .b(new_n79_), .c(x08), .O(z06));
  ...
  nand3  g39(.a(new_n86_), .b(new_n82_), .c(new_n50_), .O(z13));
  aoi21  g40(.a(new_n86_), .b(new_n82_), .c(z09), .O(z15));
  zero   g41(.O(z10));
  zero   g42(.O(z11));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand3  g44(.a(new_n86_), .b(new_n82_), .c(new_n50_), .O(z14));
  nand3  g45(.a(new_n86_), .b(new_n82_), .c(new_n50_), .O(z16));
