...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x14), .O(new_n48_));
  ...
  nor4   g39(.a(new_n65_), .b(x15), .c(new_n78_), .d(x07), .O(z09));
  inv1   g40(.a(x15), .O(new_n86_));
  nand4  g41(.a(new_n65_), .b(new_n55_), .c(new_n86_), .d(x14), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n65_), .c(new_n86_), .d(x14), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n65_), .c(new_n86_), .d(x14), .O(new_n95_));
  ...
  nand3  g54(.a(new_n66_), .b(new_n86_), .c(new_n97_), .O(new_n100_));
  nand4  g55(.a(new_n54_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n97_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x14), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n86_), .O(z13));
  oai21  g59(.a(new_n65_), .b(x07), .c(x14), .O(new_n105_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n86_), .c(new_n97_), .O(new_n109_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n106_), .d(new_n97_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  aoi21  g72(.a(new_n114_), .b(new_n113_), .c(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n113_), .c(new_n117_), .d(new_n61_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n100_), .c(new_n97_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(x14), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n86_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nand4  g78(.a(new_n52_), .b(new_n117_), .c(new_n61_), .d(new_n60_), .O(new_n124_));
  nor2   g79(.a(new_n124_), .b(new_n101_), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(x15), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n106_), .d(new_n97_), .O(z17));
