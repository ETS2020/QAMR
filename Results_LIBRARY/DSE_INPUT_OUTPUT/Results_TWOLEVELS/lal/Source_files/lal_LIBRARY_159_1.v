...
module FAU ( 
  ...
  aoi21  g04(.a(x05), .b(x04), .c(x15), .O(new_n50_));
  nor2   g05(.a(new_n50_), .b(x07), .O(z09));
  ...
  nand3  g18(.a(new_n63_), .b(new_n52_), .c(new_n47_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nand2  g20(.a(new_n48_), .b(new_n65_), .O(z02));
  nand3  g21(.a(new_n62_), .b(new_n48_), .c(new_n54_), .O(new_n67_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n86_), .c(new_n53_), .d(new_n47_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z12));
  nand3  g51(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n47_), .b(x05), .c(x04), .O(new_n99_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n52_), .d(new_n47_), .O(z14));
  ...
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n52_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n111_), .b(new_n110_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n106_), .b(new_n114_), .c(new_n81_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n97_), .c(new_n99_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n53_), .O(new_n118_));
  ...
  nand4  g77(.a(new_n122_), .b(new_n121_), .c(new_n100_), .d(new_n92_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n120_), .c(new_n99_), .O(new_n124_));
  ...
  nand4  g83(.a(new_n128_), .b(new_n121_), .c(new_n100_), .d(new_n92_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n52_), .d(new_n47_), .O(z18));
endmodule
