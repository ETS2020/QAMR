...
module FAU ( 
  ...
  nand2  g77(.a(new_n122_), .b(new_n85_), .O(z16));
  ...
  aoi21  g86(.a(x05), .b(x04), .c(x07), .O(new_n132_));
  nand2  g87(.a(new_n128_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n126_), .c(new_n125_), .d(new_n94_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n132_), .d(new_n85_), .O(z18));
endmodule
