...
module FAU ( 
  ...
  nand3  g021(.a(new_n66_), .b(new_n62_), .c(new_n47_), .O(z01));
  inv1   g022(.a(x16), .O(new_n68_));
  nand2  g023(.a(new_n49_), .b(new_n68_), .O(z02));
  nand2  g024(.a(new_n62_), .b(new_n49_), .O(z03));
  ...
  oai21  g038(.a(new_n83_), .b(new_n56_), .c(new_n52_), .O(new_n84_));
  ...
  nand4  g050(.a(new_n95_), .b(new_n90_), .c(new_n51_), .d(new_n59_), .O(new_n96_));
  ...
  nand3  g055(.a(new_n57_), .b(x22), .c(x21), .O(new_n101_));
  aoi21  g056(.a(new_n101_), .b(new_n100_), .c(new_n51_), .O(new_n102_));
  oai21  g057(.a(new_n102_), .b(x25), .c(x15), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(new_n99_), .O(z08));
  inv1   g059(.a(x15), .O(new_n105_));
  nand3  g060(.a(new_n65_), .b(new_n105_), .c(new_n47_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z09));
  nand4  g062(.a(new_n66_), .b(new_n82_), .c(new_n105_), .d(new_n47_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z10));
  xor2a  g064(.a(x18), .b(x17), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n66_), .O(new_n111_));
  aoi21  g066(.a(new_n111_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g067(.a(new_n55_), .b(x18), .c(x17), .O(new_n113_));
  oai21  g068(.a(new_n91_), .b(new_n55_), .c(new_n113_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n66_), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n47_), .c(x15), .O(z12));
  nand2  g071(.a(new_n92_), .b(new_n91_), .O(new_n117_));
  oai21  g072(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(new_n118_));
  ...
  oai21  g082(.a(new_n127_), .b(x07), .c(new_n105_), .O(z14));
  nand2  g083(.a(new_n125_), .b(x22), .O(new_n129_));
  inv1   g084(.a(new_n120_), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n93_), .c(new_n53_), .O(new_n131_));
  nand4  g086(.a(new_n131_), .b(new_n129_), .c(new_n119_), .d(new_n105_), .O(z15));
  nand2  g087(.a(new_n131_), .b(x23), .O(new_n133_));
  nand4  g088(.a(new_n124_), .b(new_n130_), .c(new_n100_), .d(new_n59_), .O(new_n134_));
  nand4  g089(.a(new_n134_), .b(new_n133_), .c(new_n119_), .d(new_n105_), .O(z16));
  nand3  g090(.a(new_n94_), .b(new_n59_), .c(new_n58_), .O(new_n136_));
  ...
  nand2  g096(.a(new_n141_), .b(new_n105_), .O(z17));
  nor3   g097(.a(x25), .b(x24), .c(x23), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n93_), .O(new_n144_));
  oai21  g099(.a(new_n144_), .b(new_n117_), .c(new_n123_), .O(new_n145_));
  aoi21  g100(.a(new_n95_), .b(x25), .c(new_n145_), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(x07), .c(new_n105_), .O(z18));
endmodule
