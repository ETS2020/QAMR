...
module FAU ( 
  ...
  nand2  g033(.a(x14), .b(new_n70_), .O(new_n79_));
  ...
  inv1   g058(.a(new_n57_), .O(new_n104_));
  nand3  g059(.a(new_n104_), .b(x22), .c(x21), .O(new_n105_));
  aoi21  g060(.a(new_n105_), .b(new_n54_), .c(new_n90_), .O(new_n106_));
  oai21  g061(.a(new_n106_), .b(x25), .c(new_n47_), .O(new_n107_));
  nand2  g062(.a(new_n107_), .b(new_n103_), .O(z08));
  nand3  g063(.a(new_n63_), .b(new_n48_), .c(new_n47_), .O(new_n109_));
  inv1   g064(.a(new_n109_), .O(z09));
  inv1   g065(.a(new_n63_), .O(new_n111_));
  nand4  g066(.a(new_n111_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n112_));
  ...
  oai21  g075(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(new_n121_));
  ...
  nand2  g083(.a(new_n123_), .b(x21), .O(new_n129_));
  inv1   g084(.a(x20), .O(new_n130_));
  nand4  g085(.a(new_n94_), .b(new_n91_), .c(new_n130_), .d(x19), .O(new_n131_));
  nand4  g086(.a(new_n131_), .b(new_n129_), .c(new_n122_), .d(new_n47_), .O(z14));
  inv1   g087(.a(new_n124_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n97_), .c(new_n130_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  aoi21  g090(.a(new_n131_), .b(x22), .c(new_n135_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(x15), .c(new_n122_), .O(z15));
  and2   g092(.a(new_n134_), .b(x23), .O(new_n138_));
  nand4  g093(.a(new_n54_), .b(new_n89_), .c(new_n91_), .d(new_n130_), .O(new_n139_));
  ...
  nand3  g097(.a(new_n98_), .b(new_n89_), .c(new_n91_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x20), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(x19), .c(x18), .d(x17), .O(new_n145_));
  nand3  g100(.a(new_n47_), .b(x05), .c(x04), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n48_), .O(new_n148_));
  aoi21  g103(.a(x24), .b(x23), .c(x15), .O(new_n149_));
  nand2  g104(.a(new_n134_), .b(x24), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n47_), .O(z17));
  nor3   g106(.a(x25), .b(x24), .c(x23), .O(new_n152_));
  nand2  g107(.a(new_n152_), .b(new_n97_), .O(new_n153_));
  oai21  g108(.a(new_n153_), .b(new_n123_), .c(new_n47_), .O(new_n154_));
  aoi21  g109(.a(new_n99_), .b(x25), .c(new_n154_), .O(new_n155_));
  oai21  g110(.a(new_n155_), .b(x15), .c(new_n122_), .O(z18));
endmodule
