...
module FAU ( 
  ...
  aoi21  g34(.a(new_n47_), .b(x13), .c(x08), .O(z05));
  inv1   g35(.a(x14), .O(new_n81_));
  aoi21  g36(.a(new_n47_), .b(new_n81_), .c(x08), .O(z06));
  nand3  g37(.a(new_n47_), .b(new_n46_), .c(x06), .O(z07));
  aoi21  g38(.a(new_n57_), .b(new_n53_), .c(new_n60_), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x21), .c(x23), .O(new_n85_));
  nor2   g40(.a(new_n48_), .b(x25), .O(new_n86_));
  oai21  g41(.a(new_n85_), .b(new_n51_), .c(new_n86_), .O(z08));
  inv1   g42(.a(x07), .O(new_n88_));
  nand3  g43(.a(new_n65_), .b(new_n47_), .c(new_n88_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  nand4  g45(.a(new_n64_), .b(new_n54_), .c(new_n47_), .d(new_n88_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n49_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n64_), .c(new_n47_), .d(new_n88_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n49_), .O(z11));
  ...
  nand4  g53(.a(new_n98_), .b(new_n64_), .c(new_n47_), .d(new_n88_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n49_), .O(z12));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n88_), .b(x05), .c(x04), .O(new_n103_));
  nor2   g58(.a(x20), .b(new_n56_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n96_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n88_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(x15), .b(x08), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(z13));
  aoi21  g64(.a(new_n104_), .b(new_n96_), .c(new_n59_), .O(new_n110_));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n96_), .c(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n103_), .c(new_n88_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n110_), .c(new_n47_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n108_), .O(z14));
  nand2  g70(.a(new_n103_), .b(new_n88_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand2  g72(.a(new_n112_), .b(x22), .O(new_n118_));
  inv1   g73(.a(new_n101_), .O(new_n119_));
  nor2   g74(.a(x22), .b(x21), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n53_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n117_), .d(new_n47_), .O(z15));
  nand2  g77(.a(new_n121_), .b(x23), .O(new_n123_));
  inv1   g78(.a(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n60_), .c(new_n59_), .d(new_n53_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n119_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n117_), .d(new_n47_), .O(z16));
  oai21  g83(.a(new_n125_), .b(new_n101_), .c(x24), .O(new_n129_));
  nor2   g84(.a(x24), .b(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n120_), .c(new_n104_), .d(new_n96_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n103_), .d(new_n88_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n108_), .O(z17));
  nand2  g89(.a(new_n131_), .b(x25), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n120_), .c(new_n104_), .d(new_n96_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n135_), .c(new_n117_), .d(new_n47_), .O(z18));
endmodule
