...
module FAU ( 
  ...
  aoi21  g42(.a(new_n64_), .b(new_n60_), .c(new_n67_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(x21), .c(x23), .O(new_n89_));
  nor2   g44(.a(new_n48_), .b(x25), .O(new_n90_));
  oai21  g45(.a(new_n89_), .b(new_n87_), .c(new_n90_), .O(z08));
  nand2  g46(.a(x05), .b(x04), .O(new_n92_));
  nor4   g47(.a(new_n92_), .b(new_n53_), .c(x15), .d(x07), .O(z09));
  nand3  g48(.a(new_n92_), .b(new_n61_), .c(new_n56_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(x23), .c(x15), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n92_), .c(x23), .d(new_n52_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z11));
  nor2   g53(.a(new_n62_), .b(new_n61_), .O(new_n99_));
  nand2  g54(.a(new_n63_), .b(x18), .O(new_n100_));
  oai22  g55(.a(new_n100_), .b(new_n61_), .c(new_n99_), .d(new_n63_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n92_), .c(new_n56_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(x23), .c(x15), .O(z12));
  nand4  g58(.a(new_n60_), .b(x19), .c(x18), .d(x17), .O(new_n104_));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nand4  g61(.a(new_n52_), .b(new_n56_), .c(x05), .d(x04), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n104_), .d(new_n56_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x23), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n52_), .O(z13));
  oai21  g65(.a(new_n92_), .b(x07), .c(x23), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n52_), .O(new_n112_));
  nand3  g67(.a(new_n66_), .b(new_n60_), .c(x19), .O(new_n113_));
  nor3   g68(.a(new_n113_), .b(new_n62_), .c(new_n61_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x07), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n99_), .b(new_n60_), .c(x19), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(x21), .c(x15), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n115_), .c(new_n112_), .O(z14));
  inv1   g73(.a(new_n113_), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n99_), .c(new_n67_), .O(new_n120_));
  inv1   g75(.a(new_n105_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n67_), .c(new_n66_), .d(new_n60_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n107_), .c(new_n56_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n120_), .c(x23), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n52_), .O(z15));
  nand2  g80(.a(x23), .b(new_n62_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n100_), .c(x17), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n92_), .O(new_n128_));
  nand3  g83(.a(x23), .b(x05), .c(x04), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g85(.a(new_n130_), .b(new_n56_), .c(new_n53_), .O(new_n131_));
  aoi21  g86(.a(new_n67_), .b(new_n66_), .c(x20), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(x19), .c(x18), .d(x17), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n56_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n131_), .c(new_n60_), .d(new_n52_), .O(z16));
  nand3  g91(.a(new_n107_), .b(new_n87_), .c(new_n56_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(x23), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n52_), .O(z17));
  nand2  g94(.a(x23), .b(x07), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n112_), .c(new_n59_), .d(new_n52_), .O(z18));
endmodule
