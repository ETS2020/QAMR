...
module FAU ( 
  ...
  nor2   g038(.a(new_n83_), .b(x02), .O(new_n84_));
  nor2   g039(.a(x15), .b(x11), .O(new_n85_));
  aoi21  g040(.a(new_n85_), .b(x02), .c(new_n84_), .O(new_n86_));
  ...
  nand2  g047(.a(new_n92_), .b(new_n51_), .O(new_n93_));
  nand2  g048(.a(new_n93_), .b(x20), .O(new_n94_));
  inv1   g049(.a(x23), .O(new_n95_));
  nand2  g050(.a(new_n54_), .b(new_n53_), .O(new_n96_));
  nand3  g051(.a(x22), .b(x21), .c(new_n55_), .O(new_n97_));
  oai21  g052(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand2  g053(.a(new_n98_), .b(x24), .O(new_n99_));
  aoi21  g054(.a(x25), .b(new_n52_), .c(new_n48_), .O(new_n100_));
  nand3  g055(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z08));
  inv1   g056(.a(x07), .O(new_n102_));
  nand3  g057(.a(new_n62_), .b(new_n47_), .c(new_n102_), .O(new_n103_));
  inv1   g058(.a(new_n103_), .O(z09));
  nand4  g059(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n102_), .O(new_n105_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n55_), .c(new_n112_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n61_), .c(new_n47_), .d(new_n102_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n49_), .O(z12));
  nand3  g070(.a(x19), .b(x18), .c(x17), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(x20), .O(new_n117_));
  nand3  g072(.a(new_n62_), .b(new_n47_), .c(new_n102_), .O(new_n118_));
  inv1   g073(.a(new_n118_), .O(new_n119_));
  nor2   g074(.a(x20), .b(new_n55_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  inv1   g076(.a(new_n121_), .O(new_n122_));
  nor2   g077(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g078(.a(new_n123_), .b(new_n117_), .c(new_n47_), .d(new_n102_), .O(z13));
  inv1   g079(.a(x21), .O(new_n125_));
  aoi21  g080(.a(new_n120_), .b(new_n111_), .c(new_n125_), .O(new_n126_));
  nand3  g081(.a(new_n102_), .b(x05), .c(x04), .O(new_n127_));
  nor2   g082(.a(x21), .b(x20), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n111_), .c(x19), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n127_), .c(new_n102_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(new_n126_), .c(new_n47_), .O(new_n131_));
  nand2  g086(.a(x15), .b(x11), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n131_), .O(z14));
  nand3  g088(.a(new_n125_), .b(new_n52_), .c(x19), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n110_), .c(x22), .O(new_n135_));
  inv1   g090(.a(new_n116_), .O(new_n136_));
  nor3   g091(.a(x22), .b(x21), .c(x20), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n135_), .c(new_n127_), .d(new_n102_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n132_), .O(z15));
  aoi21  g096(.a(new_n137_), .b(new_n136_), .c(new_n95_), .O(new_n142_));
  inv1   g097(.a(x22), .O(new_n143_));
  nand4  g098(.a(new_n128_), .b(new_n136_), .c(new_n95_), .d(new_n143_), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n127_), .c(new_n102_), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n142_), .c(new_n47_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n132_), .O(z16));
  nand4  g102(.a(new_n95_), .b(new_n143_), .c(new_n125_), .d(new_n52_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n116_), .c(x24), .O(new_n149_));
  nor2   g104(.a(x22), .b(x21), .O(new_n150_));
  nor2   g105(.a(x24), .b(x23), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n150_), .c(new_n120_), .d(new_n111_), .O(new_n152_));
  nand4  g107(.a(new_n152_), .b(new_n149_), .c(new_n127_), .d(new_n102_), .O(new_n153_));
  nand2  g108(.a(new_n153_), .b(new_n47_), .O(new_n154_));
  nand2  g109(.a(new_n154_), .b(new_n132_), .O(z17));
  nand2  g110(.a(new_n152_), .b(x25), .O(new_n156_));
  nor3   g111(.a(x25), .b(x24), .c(x23), .O(new_n157_));
  and2   g112(.a(new_n157_), .b(new_n150_), .O(new_n158_));
  aoi21  g113(.a(new_n158_), .b(new_n122_), .c(new_n119_), .O(new_n159_));
  nand4  g114(.a(new_n159_), .b(new_n156_), .c(new_n47_), .d(new_n102_), .O(z18));
endmodule
