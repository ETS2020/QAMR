...
module FAU ( 
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n109_), .d(new_n51_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  inv1   g74(.a(x23), .O(new_n120_));
  nand3  g75(.a(new_n111_), .b(new_n120_), .c(new_n82_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n115_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n109_), .d(new_n51_), .O(z16));
  oai21  g79(.a(new_n121_), .b(new_n100_), .c(x24), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n116_), .c(new_n103_), .d(new_n95_), .O(new_n127_));
  ...
  nand4  g87(.a(new_n132_), .b(new_n116_), .c(new_n103_), .d(new_n95_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n109_), .d(new_n51_), .O(z18));
endmodule
