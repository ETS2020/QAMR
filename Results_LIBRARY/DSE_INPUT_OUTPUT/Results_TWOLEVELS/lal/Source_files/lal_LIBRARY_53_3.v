...
module FAU ( 
  ...
  nand3  g21(.a(new_n66_), .b(new_n65_), .c(new_n47_), .O(z01));
  ...
  oai21  g41(.a(new_n86_), .b(new_n66_), .c(new_n50_), .O(z09));
  nand4  g42(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n66_), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n66_), .c(new_n48_), .d(new_n47_), .O(new_n96_));
  ...
  nand3  g62(.a(new_n61_), .b(new_n55_), .c(x19), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n93_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n100_), .d(new_n47_), .O(z14));
  aoi21  g66(.a(new_n109_), .b(new_n93_), .c(new_n62_), .O(new_n112_));
  ...
  oai21  g71(.a(new_n116_), .b(new_n112_), .c(new_n48_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n100_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n114_), .b(new_n113_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n119_), .b(new_n62_), .c(new_n61_), .d(new_n55_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n101_), .c(new_n47_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n100_), .O(z16));
  nand2  g79(.a(x24), .b(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n98_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  aoi21  g82(.a(new_n114_), .b(new_n113_), .c(new_n53_), .O(new_n128_));
  nor2   g83(.a(x22), .b(x21), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n53_), .c(new_n119_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n103_), .c(new_n47_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n128_), .c(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n127_), .O(z17));
  oai21  g88(.a(new_n130_), .b(new_n103_), .c(x25), .O(new_n134_));
  nor2   g89(.a(x20), .b(new_n58_), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n129_), .c(new_n135_), .d(new_n93_), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n134_), .c(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n48_), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n100_), .O(z18));
endmodule
