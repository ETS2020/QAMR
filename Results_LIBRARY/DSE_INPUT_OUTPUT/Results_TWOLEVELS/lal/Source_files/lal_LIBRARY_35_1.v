...
module FAU ( 
  ...
  or2    g09(.a(new_n54_), .b(x07), .O(new_n55_));
  ...
  nand4  g53(.a(new_n48_), .b(new_n53_), .c(x05), .d(x04), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z09));
  nand2  g55(.a(x05), .b(x04), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n58_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n48_), .c(x07), .O(z10));
  xor2a  g58(.a(x18), .b(x17), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n101_), .c(new_n48_), .d(new_n53_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(z11));
  nand3  g61(.a(new_n60_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g62(.a(new_n91_), .b(new_n60_), .c(new_n107_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n101_), .c(new_n48_), .d(new_n53_), .O(new_n109_));
  ...
  nand3  g68(.a(new_n53_), .b(x05), .c(x04), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n111_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n48_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n53_), .O(z13));
  nor2   g72(.a(x21), .b(x20), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n91_), .c(x19), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n114_), .O(new_n120_));
  aoi21  g75(.a(new_n111_), .b(x21), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x15), .c(new_n53_), .O(z14));
  inv1   g77(.a(new_n112_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n93_), .c(new_n57_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n114_), .O(new_n125_));
  aoi21  g80(.a(new_n119_), .b(x22), .c(new_n125_), .O(new_n126_));
  oai21  g81(.a(new_n126_), .b(x15), .c(new_n53_), .O(z15));
  nand2  g82(.a(new_n124_), .b(x23), .O(new_n128_));
  nor2   g83(.a(x23), .b(x22), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n118_), .c(new_n123_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n55_), .d(new_n53_), .O(z16));
  ...
  nand3  g90(.a(new_n135_), .b(new_n134_), .c(new_n55_), .O(z17));
  ...
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n55_), .d(new_n53_), .O(z18));
endmodule
