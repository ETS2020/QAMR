...
module FAU ( 
  ...
  nand2  g24(.a(new_n61_), .b(new_n49_), .O(z03));
  ...
  nor2   g38(.a(new_n60_), .b(x25), .O(new_n85_));
  aoi21  g39(.a(new_n85_), .b(new_n82_), .c(z09), .O(z13));
  nand3  g40(.a(new_n85_), .b(new_n82_), .c(new_n49_), .O(z14));
  zero   g41(.O(z12));
  nor2   g42(.a(x15), .b(x07), .O(z10));
  nor2   g43(.a(x15), .b(x07), .O(z11));
  nand3  g44(.a(new_n85_), .b(new_n82_), .c(new_n49_), .O(z15));
  nand3  g45(.a(new_n85_), .b(new_n82_), .c(new_n49_), .O(z16));
  nand3  g46(.a(new_n85_), .b(new_n82_), .c(new_n49_), .O(z17));
  nand3  g47(.a(new_n85_), .b(new_n82_), .c(new_n49_), .O(z18));
endmodule
