...
module FAU ( 
  ...
  aoi21  g39(.a(new_n87_), .b(new_n82_), .c(z10), .O(z13));
  nand3  g40(.a(new_n87_), .b(new_n82_), .c(new_n48_), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z11));
  zero   g43(.O(z12));
  aoi21  g44(.a(new_n87_), .b(new_n82_), .c(z10), .O(z15));
  aoi21  g45(.a(new_n87_), .b(new_n82_), .c(z10), .O(z16));
  aoi21  g46(.a(new_n87_), .b(new_n82_), .c(z10), .O(z17));
