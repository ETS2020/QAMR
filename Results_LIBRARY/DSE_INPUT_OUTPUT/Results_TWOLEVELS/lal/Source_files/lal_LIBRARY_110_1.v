...
module FAU ( 
  ...
  nand4  g43(.a(new_n88_), .b(new_n56_), .c(new_n48_), .d(new_n53_), .O(new_n89_));
  ...
  nor2   g68(.a(new_n113_), .b(x07), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n110_), .c(new_n105_), .O(z15));
  inv1   g70(.a(x23), .O(new_n116_));
  nor2   g71(.a(new_n113_), .b(new_n116_), .O(new_n117_));
  inv1   g72(.a(new_n100_), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n118_), .c(new_n116_), .d(new_n81_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n63_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n117_), .c(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n53_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nand3  g78(.a(new_n111_), .b(new_n80_), .c(new_n116_), .O(new_n124_));
  or2    g79(.a(new_n124_), .b(new_n103_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n105_), .d(new_n53_), .O(z17));
  oai21  g81(.a(new_n124_), .b(new_n103_), .c(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n111_), .c(new_n102_), .d(new_n94_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n127_), .c(new_n63_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n53_), .O(z18));
endmodule
