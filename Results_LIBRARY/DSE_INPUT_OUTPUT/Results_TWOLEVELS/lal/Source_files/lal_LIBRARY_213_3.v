...
module FAU ( 
  ...
  nand2  g074(.a(new_n60_), .b(new_n48_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g076(.a(new_n96_), .b(new_n94_), .O(new_n122_));
  ...
  nand3  g089(.a(new_n134_), .b(new_n97_), .c(new_n133_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n132_), .c(new_n121_), .d(new_n47_), .O(z15));
  nand2  g091(.a(new_n135_), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n129_), .b(new_n134_), .c(new_n53_), .d(new_n89_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n137_), .c(new_n121_), .d(new_n47_), .O(z16));
  nand2  g094(.a(x25), .b(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n52_), .b(new_n48_), .O(new_n141_));
  aoi21  g096(.a(new_n141_), .b(new_n140_), .c(x24), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(new_n53_), .c(new_n89_), .d(new_n91_), .O(new_n143_));
  ...
  nand3  g103(.a(new_n148_), .b(new_n145_), .c(new_n121_), .O(z17));
  nand4  g104(.a(new_n97_), .b(new_n52_), .c(new_n90_), .d(new_n53_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n122_), .c(new_n47_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n48_), .O(new_n152_));
  aoi21  g107(.a(new_n99_), .b(x25), .c(new_n120_), .O(new_n153_));
