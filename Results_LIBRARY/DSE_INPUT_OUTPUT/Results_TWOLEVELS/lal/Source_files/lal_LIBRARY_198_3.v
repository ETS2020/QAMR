...
module FAU ( 
  ...
  nand3  g27(.a(new_n47_), .b(new_n72_), .c(new_n46_), .O(new_n73_));
  ...
  aoi21  g36(.a(x15), .b(x07), .c(x25), .O(new_n82_));
  ...
  nand4  g41(.a(new_n60_), .b(new_n52_), .c(new_n84_), .d(new_n49_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n47_), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n60_), .c(new_n84_), .d(new_n49_), .O(new_n90_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n60_), .c(new_n84_), .d(new_n49_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n47_), .O(z12));
  aoi21  g51(.a(x05), .b(x04), .c(x15), .O(new_n97_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n97_), .d(new_n49_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n97_), .d(new_n49_), .O(z14));
  or2    g60(.a(new_n97_), .b(x07), .O(new_n106_));
  ...
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n49_), .O(z15));
  inv1   g66(.a(x23), .O(new_n112_));
  aoi21  g67(.a(new_n109_), .b(new_n108_), .c(new_n112_), .O(new_n113_));
  nand4  g68(.a(new_n103_), .b(new_n108_), .c(new_n112_), .d(new_n79_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n49_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n113_), .c(new_n84_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n106_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  nor2   g73(.a(x22), .b(x21), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n78_), .c(new_n112_), .O(new_n120_));
  or2    g75(.a(new_n120_), .b(new_n100_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n106_), .d(new_n49_), .O(z17));
  oai21  g77(.a(new_n120_), .b(new_n100_), .c(x25), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n54_), .O(new_n124_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n119_), .c(new_n124_), .d(new_n92_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n49_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n106_), .O(z18));
endmodule
