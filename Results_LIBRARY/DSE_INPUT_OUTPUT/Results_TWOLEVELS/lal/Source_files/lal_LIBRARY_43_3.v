...
module FAU ( 
  ...
  oai21  g41(.a(new_n86_), .b(new_n63_), .c(new_n50_), .O(z09));
  ...
  nand4  g51(.a(new_n96_), .b(new_n63_), .c(new_n48_), .d(new_n47_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  aoi21  g53(.a(x05), .b(x04), .c(x15), .O(new_n99_));
  or2    g54(.a(new_n99_), .b(x07), .O(new_n100_));
  ...
  nand4  g75(.a(new_n107_), .b(new_n113_), .c(new_n119_), .d(new_n81_), .O(new_n121_));
  ...
  nand3  g81(.a(new_n126_), .b(new_n52_), .c(new_n119_), .O(new_n127_));
  or2    g82(.a(new_n127_), .b(new_n103_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n100_), .d(new_n47_), .O(z17));
  oai21  g84(.a(new_n127_), .b(new_n103_), .c(x25), .O(new_n130_));
  nor2   g85(.a(x20), .b(new_n57_), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n126_), .c(new_n131_), .d(new_n94_), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n130_), .c(new_n47_), .O(new_n134_));
