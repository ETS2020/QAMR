...
module FAU ( 
  ...
  nor2   g035(.a(new_n51_), .b(x03), .O(new_n81_));
  nor2   g036(.a(x15), .b(x12), .O(new_n82_));
  aoi21  g037(.a(new_n82_), .b(x03), .c(new_n81_), .O(new_n83_));
  ...
  aoi21  g045(.a(new_n59_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  aoi21  g046(.a(new_n91_), .b(x21), .c(x23), .O(new_n92_));
  nor2   g047(.a(new_n48_), .b(x25), .O(new_n93_));
  oai21  g048(.a(new_n92_), .b(new_n89_), .c(new_n93_), .O(z08));
  inv1   g049(.a(x07), .O(new_n95_));
  nand4  g050(.a(new_n47_), .b(new_n95_), .c(x05), .d(x04), .O(new_n96_));
  inv1   g051(.a(new_n96_), .O(z09));
  nand2  g052(.a(x05), .b(x04), .O(new_n98_));
  nand4  g053(.a(new_n98_), .b(new_n56_), .c(new_n47_), .d(new_n95_), .O(new_n99_));
  inv1   g054(.a(new_n99_), .O(z10));
  xor2a  g055(.a(x18), .b(x17), .O(new_n101_));
  nand4  g056(.a(new_n101_), .b(new_n98_), .c(new_n47_), .d(new_n95_), .O(new_n102_));
  inv1   g057(.a(new_n102_), .O(z11));
  nor2   g058(.a(new_n57_), .b(new_n56_), .O(new_n104_));
  nand3  g059(.a(new_n58_), .b(x18), .c(x17), .O(new_n105_));
  oai21  g060(.a(new_n104_), .b(new_n58_), .c(new_n105_), .O(new_n106_));
  nand4  g061(.a(new_n106_), .b(new_n98_), .c(new_n47_), .d(new_n95_), .O(new_n107_));
  inv1   g062(.a(new_n107_), .O(z12));
  nand3  g063(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(x20), .O(new_n110_));
  nand3  g065(.a(new_n95_), .b(x05), .c(x04), .O(new_n111_));
  nor2   g066(.a(x20), .b(new_n58_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n104_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n111_), .c(new_n110_), .d(new_n95_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g070(.a(x15), .b(x12), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n115_), .O(z13));
  and2   g072(.a(new_n113_), .b(x21), .O(new_n118_));
  nor2   g073(.a(x21), .b(x20), .O(new_n119_));
  nand3  g074(.a(new_n119_), .b(new_n104_), .c(x19), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(new_n111_), .c(new_n95_), .O(new_n121_));
  oai21  g076(.a(new_n121_), .b(new_n118_), .c(new_n47_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n116_), .O(z14));
  nand2  g078(.a(new_n120_), .b(x22), .O(new_n124_));
  inv1   g079(.a(new_n111_), .O(new_n125_));
  nor2   g080(.a(x22), .b(x21), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n55_), .O(new_n127_));
  nor2   g082(.a(new_n127_), .b(new_n109_), .O(new_n128_));
  nor2   g083(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n124_), .c(new_n95_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n116_), .O(z15));
  inv1   g087(.a(x23), .O(new_n133_));
  nor2   g088(.a(new_n128_), .b(new_n133_), .O(new_n134_));
  inv1   g089(.a(new_n109_), .O(new_n135_));
  nand4  g090(.a(new_n119_), .b(new_n135_), .c(new_n133_), .d(new_n90_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n111_), .c(new_n95_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n134_), .c(new_n47_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n116_), .O(z16));
  nor2   g094(.a(x24), .b(x23), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n126_), .c(new_n112_), .d(new_n104_), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n111_), .c(new_n95_), .O(new_n142_));
  aoi21  g097(.a(new_n136_), .b(x24), .c(new_n142_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(x15), .c(new_n116_), .O(z17));
  nor2   g099(.a(new_n125_), .b(x07), .O(new_n145_));
  nand2  g100(.a(new_n141_), .b(x25), .O(new_n146_));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n126_), .c(new_n112_), .d(new_n104_), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n146_), .c(new_n145_), .d(new_n47_), .O(z18));
endmodule
