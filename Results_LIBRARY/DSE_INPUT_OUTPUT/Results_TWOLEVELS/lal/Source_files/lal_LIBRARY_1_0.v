...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x07), .O(new_n47_));
  inv1   g02(.a(new_n47_), .O(z13));
  ...
  nand2  g22(.a(z13), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n60_), .b(z13), .O(z03));
  ...
  nand2  g40(.a(new_n63_), .b(new_n62_), .O(z18));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  inv1   g45(.a(new_n47_), .O(z14));
  inv1   g46(.a(new_n47_), .O(z15));
  inv1   g47(.a(new_n47_), .O(z16));
  inv1   g48(.a(new_n47_), .O(z17));
endmodule
