...
module FAU ( 
  ...
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n50_), .O(z14));
  ...
  oai21  g70(.a(new_n115_), .b(x15), .c(new_n50_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand3  g73(.a(new_n106_), .b(new_n118_), .c(new_n80_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n52_), .d(new_n50_), .O(z16));
  oai21  g77(.a(new_n119_), .b(new_n98_), .c(x24), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n58_), .O(new_n124_));
  nor2   g79(.a(x24), .b(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n112_), .c(new_n124_), .d(new_n93_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n100_), .O(new_n127_));
  ...
  nand4  g86(.a(new_n131_), .b(new_n112_), .c(new_n124_), .d(new_n93_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n52_), .d(new_n50_), .O(z18));
endmodule
