...
module FAU ( 
  ...
  oai21  g018(.a(new_n63_), .b(new_n47_), .c(new_n53_), .O(z01));
  inv1   g019(.a(x16), .O(new_n65_));
  nand2  g020(.a(new_n48_), .b(new_n65_), .O(z02));
  nand3  g021(.a(new_n62_), .b(new_n48_), .c(new_n54_), .O(new_n67_));
  inv1   g022(.a(new_n67_), .O(z03));
  aoi21  g023(.a(x12), .b(new_n46_), .c(new_n51_), .O(new_n69_));
  ...
  aoi21  g062(.a(new_n107_), .b(x25), .c(new_n47_), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n97_), .c(new_n94_), .d(new_n92_), .O(z08));
  nand3  g064(.a(x05), .b(x04), .c(x03), .O(new_n110_));
  nor3   g065(.a(new_n110_), .b(x15), .c(x07), .O(z09));
  inv1   g066(.a(x07), .O(new_n112_));
  and2   g067(.a(x05), .b(x04), .O(new_n113_));
  inv1   g068(.a(new_n113_), .O(new_n114_));
  nand3  g069(.a(new_n114_), .b(new_n56_), .c(new_n112_), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(x03), .c(x15), .O(z10));
  xor2a  g071(.a(x18), .b(x17), .O(new_n117_));
  nand3  g072(.a(new_n117_), .b(new_n114_), .c(new_n112_), .O(new_n118_));
  ...
  nand3  g076(.a(new_n121_), .b(new_n114_), .c(new_n112_), .O(new_n122_));
  aoi21  g077(.a(new_n122_), .b(x03), .c(x15), .O(z12));
  nand3  g078(.a(new_n113_), .b(new_n51_), .c(new_n112_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(x03), .O(new_n126_));
  ...
  nand3  g089(.a(new_n134_), .b(new_n51_), .c(x03), .O(new_n135_));
  ...
  nand3  g094(.a(new_n139_), .b(new_n124_), .c(new_n112_), .O(new_n140_));
  aoi21  g095(.a(new_n134_), .b(x22), .c(new_n140_), .O(new_n141_));
  oai21  g096(.a(new_n141_), .b(new_n50_), .c(new_n51_), .O(z15));
  nor2   g097(.a(x23), .b(x22), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n133_), .c(new_n138_), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n51_), .c(x03), .O(new_n145_));
  ...
  nand2  g105(.a(new_n51_), .b(x03), .O(new_n151_));
  ...
  aoi21  g111(.a(new_n156_), .b(new_n130_), .c(new_n47_), .O(new_n157_));
