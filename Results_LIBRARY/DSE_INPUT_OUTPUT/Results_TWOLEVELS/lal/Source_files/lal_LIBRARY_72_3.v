...
module FAU ( 
  ...
  nand2  g038(.a(new_n57_), .b(new_n56_), .O(new_n84_));
  ...
  nand4  g060(.a(new_n62_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n50_), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n50_), .O(z11));
  nand3  g065(.a(new_n57_), .b(x18), .c(x17), .O(new_n111_));
  oai21  g066(.a(new_n96_), .b(new_n57_), .c(new_n111_), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n62_), .c(new_n48_), .d(new_n47_), .O(new_n113_));
  inv1   g068(.a(new_n113_), .O(z12));
  nand2  g069(.a(new_n97_), .b(new_n96_), .O(new_n115_));
  oai21  g070(.a(new_n63_), .b(x15), .c(new_n47_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n120_), .b(new_n96_), .c(x19), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  aoi21  g077(.a(new_n115_), .b(x21), .c(new_n122_), .O(new_n123_));
  oai21  g078(.a(new_n123_), .b(x15), .c(new_n116_), .O(z14));
  nand2  g079(.a(new_n121_), .b(x22), .O(new_n125_));
  nand2  g080(.a(new_n98_), .b(new_n54_), .O(new_n126_));
  nor2   g081(.a(new_n126_), .b(new_n117_), .O(new_n127_));
  ...
  nand2  g085(.a(new_n130_), .b(new_n116_), .O(z15));
  inv1   g086(.a(x23), .O(new_n132_));
  nor2   g087(.a(new_n127_), .b(new_n132_), .O(new_n133_));
  inv1   g088(.a(new_n117_), .O(new_n134_));
  nand4  g089(.a(new_n120_), .b(new_n134_), .c(new_n132_), .d(new_n91_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n133_), .c(new_n48_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n116_), .O(z16));
  nand3  g093(.a(new_n99_), .b(new_n91_), .c(new_n93_), .O(new_n139_));
  ...
  nand2  g098(.a(new_n100_), .b(x25), .O(new_n144_));
  nor3   g099(.a(x25), .b(x24), .c(x23), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n98_), .c(new_n97_), .d(new_n96_), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n144_), .c(new_n116_), .d(new_n47_), .O(z18));
endmodule
