...
module FAU ( 
  ...
  aoi21  g031(.a(new_n47_), .b(x08), .c(x13), .O(z05));
  ...
  oai21  g056(.a(new_n101_), .b(x25), .c(x13), .O(new_n102_));
  nand2  g057(.a(new_n102_), .b(new_n98_), .O(z08));
  nand3  g058(.a(new_n64_), .b(new_n47_), .c(new_n51_), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n49_), .O(z09));
  nand4  g060(.a(new_n65_), .b(new_n81_), .c(new_n47_), .d(new_n51_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n49_), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n65_), .c(new_n47_), .d(new_n51_), .O(new_n109_));
  ...
  nand4  g067(.a(new_n112_), .b(new_n65_), .c(new_n47_), .d(new_n51_), .O(new_n113_));
  ...
  nand4  g073(.a(new_n118_), .b(new_n117_), .c(new_n115_), .d(new_n51_), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  nand2  g075(.a(x15), .b(x13), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n120_), .O(z13));
  inv1   g077(.a(new_n115_), .O(new_n123_));
  nor2   g078(.a(new_n123_), .b(new_n59_), .O(new_n124_));
  nand4  g079(.a(new_n90_), .b(new_n59_), .c(new_n54_), .d(x19), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n118_), .c(new_n51_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(new_n124_), .c(new_n47_), .O(new_n127_));
  nand2  g082(.a(new_n127_), .b(new_n121_), .O(z14));
  inv1   g083(.a(new_n116_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n92_), .c(new_n54_), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n118_), .c(new_n51_), .O(new_n131_));
  aoi21  g086(.a(new_n125_), .b(x22), .c(new_n131_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(x15), .c(new_n121_), .O(z15));
  nand2  g088(.a(new_n130_), .b(x23), .O(new_n134_));
  inv1   g089(.a(new_n104_), .O(new_n135_));
  nand4  g090(.a(new_n99_), .b(new_n60_), .c(new_n59_), .d(new_n54_), .O(new_n136_));
  nor2   g091(.a(new_n136_), .b(new_n116_), .O(new_n137_));
  nor2   g092(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n134_), .c(new_n47_), .d(new_n51_), .O(z16));
  aoi21  g094(.a(x25), .b(x15), .c(x24), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n99_), .c(new_n60_), .d(new_n59_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(x20), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(x19), .c(x18), .d(x17), .O(new_n143_));
  inv1   g098(.a(new_n118_), .O(new_n144_));
  aoi21  g099(.a(x24), .b(x23), .c(new_n144_), .O(new_n145_));
  aoi21  g100(.a(new_n130_), .b(x24), .c(x07), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n143_), .d(new_n47_), .O(z17));
  aoi21  g102(.a(new_n94_), .b(x25), .c(new_n144_), .O(new_n148_));
  nor3   g103(.a(x25), .b(x24), .c(x23), .O(new_n149_));
  nand3  g104(.a(new_n149_), .b(new_n92_), .c(new_n123_), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n148_), .c(new_n47_), .d(new_n51_), .O(z18));
endmodule
