...
module FAU ( 
  ...
  aoi21  g59(.a(x05), .b(x04), .c(x15), .O(new_n105_));
  or2    g60(.a(new_n105_), .b(x07), .O(new_n106_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n51_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n106_), .d(new_n51_), .O(z15));
  ...
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .d(new_n51_), .O(z16));
  ...
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n61_), .O(new_n125_));
  ...
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n106_), .d(new_n51_), .O(z18));
endmodule
