...
module FAU ( 
  ...
  nand2  g41(.a(new_n85_), .b(new_n54_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g43(.a(x15), .O(new_n89_));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n85_), .c(new_n89_), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n85_), .c(new_n89_), .d(new_n47_), .O(new_n97_));
  ...
  nand2  g70(.a(new_n115_), .b(new_n89_), .O(z15));
  ...
  nand2  g74(.a(new_n119_), .b(new_n85_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n118_), .c(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n89_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  nor2   g78(.a(new_n63_), .b(x15), .O(new_n124_));
  nor2   g79(.a(x22), .b(x21), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n51_), .c(new_n117_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n101_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n124_), .c(new_n123_), .d(new_n49_), .O(z17));
  oai21  g83(.a(new_n126_), .b(new_n101_), .c(x25), .O(new_n129_));
  nor2   g84(.a(x20), .b(new_n56_), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n125_), .c(new_n130_), .d(new_n94_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n129_), .c(new_n85_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n89_), .O(z18));
endmodule
