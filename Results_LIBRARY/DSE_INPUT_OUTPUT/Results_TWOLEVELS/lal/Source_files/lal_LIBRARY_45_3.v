...
module FAU ( 
  ...
  aoi21  g34(.a(new_n48_), .b(x08), .c(new_n47_), .O(z06));
  aoi21  g35(.a(new_n71_), .b(x06), .c(new_n49_), .O(z07));
  ...
  oai21  g42(.a(new_n87_), .b(new_n66_), .c(new_n50_), .O(z09));
  ...
  nand4  g52(.a(new_n97_), .b(new_n66_), .c(new_n48_), .d(new_n86_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n86_), .O(new_n104_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n102_), .d(new_n86_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n48_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n106_), .O(z15));
  inv1   g77(.a(x23), .O(new_n123_));
  aoi21  g78(.a(new_n118_), .b(new_n117_), .c(new_n123_), .O(new_n124_));
  nand4  g79(.a(new_n110_), .b(new_n117_), .c(new_n123_), .d(new_n62_), .O(new_n125_));
  ...
  nand4  g83(.a(new_n123_), .b(new_n62_), .c(new_n61_), .d(new_n55_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n100_), .c(x24), .O(new_n130_));
  nor2   g85(.a(x22), .b(x21), .O(new_n131_));
  nor2   g86(.a(x24), .b(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n131_), .c(new_n108_), .d(new_n95_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n102_), .d(new_n86_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n48_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n106_), .O(z17));
  nand4  g91(.a(new_n53_), .b(new_n123_), .c(new_n62_), .d(new_n61_), .O(new_n137_));
  oai21  g92(.a(new_n137_), .b(new_n103_), .c(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n131_), .c(new_n108_), .d(new_n95_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n102_), .d(new_n86_), .O(new_n141_));
  nand2  g96(.a(new_n141_), .b(new_n48_), .O(new_n142_));
  nand2  g97(.a(new_n142_), .b(new_n106_), .O(z18));
endmodule
