...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n115_, new_n116_, new_n117_, new_n120_, new_n121_;
  ...
  nor4   g53(.a(new_n98_), .b(x19), .c(x15), .d(x07), .O(z09));
  inv1   g54(.a(new_n98_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(x19), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n62_), .c(new_n47_), .O(new_n102_));
  nor2   g57(.a(new_n102_), .b(x07), .O(z10));
  ...
  nand4  g61(.a(new_n101_), .b(x18), .c(x17), .d(new_n47_), .O(new_n107_));
  nor2   g62(.a(new_n107_), .b(x07), .O(z12));
  oai21  g63(.a(new_n98_), .b(x07), .c(new_n61_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n47_), .O(new_n110_));
  nand2  g65(.a(new_n61_), .b(x07), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n59_), .d(new_n47_), .O(z13));
  nor2   g67(.a(x21), .b(x15), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(z14));
  nand3  g69(.a(new_n100_), .b(new_n47_), .c(new_n52_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n92_), .c(new_n52_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n61_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n47_), .O(z15));
  nand4  g73(.a(new_n111_), .b(new_n110_), .c(new_n53_), .d(new_n47_), .O(z16));
  nand3  g74(.a(new_n115_), .b(new_n54_), .c(new_n52_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n61_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n47_), .O(z17));
  nand4  g77(.a(new_n111_), .b(new_n110_), .c(new_n60_), .d(new_n47_), .O(z18));
endmodule
