...
module FAU ( 
  ...
  nor2   g025(.a(x08), .b(x03), .O(new_n71_));
  oai21  g026(.a(new_n71_), .b(x15), .c(x12), .O(new_n72_));
  ...
  nand2  g037(.a(new_n47_), .b(x03), .O(new_n83_));
  ...
  oai21  g073(.a(new_n118_), .b(new_n53_), .c(new_n50_), .O(z09));
  nand4  g074(.a(new_n118_), .b(new_n60_), .c(new_n48_), .d(new_n52_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n50_), .O(z10));
  xor2a  g076(.a(x18), .b(x17), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n118_), .c(new_n48_), .d(new_n52_), .O(new_n123_));
  ...
  nand4  g081(.a(new_n126_), .b(new_n118_), .c(new_n48_), .d(new_n52_), .O(new_n127_));
  ...
  nand4  g099(.a(new_n144_), .b(new_n142_), .c(new_n57_), .d(new_n47_), .O(new_n145_));
  ...
  nand4  g102(.a(new_n98_), .b(x19), .c(x18), .d(new_n48_), .O(new_n148_));
  ...
  nor2   g107(.a(new_n152_), .b(x12), .O(new_n153_));
  ...
  nand3  g112(.a(new_n157_), .b(x15), .c(new_n47_), .O(new_n158_));
  ...
  oai21  g118(.a(new_n163_), .b(x12), .c(x15), .O(new_n164_));
  ...
  nand4  g137(.a(new_n57_), .b(x24), .c(new_n59_), .d(new_n47_), .O(new_n183_));
  aoi22  g138(.a(new_n183_), .b(x15), .c(new_n170_), .d(x23), .O(new_n184_));
  and2   g139(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  nand4  g140(.a(new_n185_), .b(new_n179_), .c(new_n178_), .d(new_n130_), .O(z16));
  nand2  g141(.a(x25), .b(x15), .O(new_n187_));
  nand4  g142(.a(new_n187_), .b(new_n101_), .c(new_n98_), .d(new_n131_), .O(new_n188_));
  inv1   g143(.a(new_n188_), .O(new_n189_));
  nand4  g144(.a(new_n189_), .b(x19), .c(x18), .d(x17), .O(new_n190_));
  nand2  g145(.a(new_n190_), .b(new_n171_), .O(new_n191_));
  nand3  g146(.a(new_n191_), .b(new_n59_), .c(new_n100_), .O(new_n192_));
  nand2  g147(.a(new_n58_), .b(x23), .O(new_n193_));
  nor3   g148(.a(x22), .b(x21), .c(x20), .O(new_n194_));
  nand4  g149(.a(new_n194_), .b(new_n193_), .c(new_n169_), .d(x17), .O(new_n195_));
  nand2  g150(.a(new_n195_), .b(x24), .O(new_n196_));
  nand3  g151(.a(new_n57_), .b(x24), .c(new_n47_), .O(new_n197_));
  nand2  g152(.a(new_n197_), .b(x15), .O(new_n198_));
  nand4  g153(.a(new_n198_), .b(new_n196_), .c(new_n192_), .d(new_n130_), .O(z17));
  nand3  g154(.a(new_n101_), .b(new_n100_), .c(new_n98_), .O(new_n200_));
  oai21  g155(.a(new_n200_), .b(new_n132_), .c(new_n180_), .O(new_n201_));
  oai21  g156(.a(x19), .b(x18), .c(x15), .O(new_n202_));
  nor2   g157(.a(new_n202_), .b(x12), .O(new_n203_));
  aoi21  g158(.a(new_n201_), .b(x17), .c(new_n203_), .O(new_n204_));
  nand3  g159(.a(new_n63_), .b(x15), .c(new_n47_), .O(new_n205_));
  oai21  g160(.a(new_n204_), .b(x20), .c(new_n205_), .O(new_n206_));
  nand3  g161(.a(new_n101_), .b(x15), .c(new_n47_), .O(new_n207_));
  inv1   g162(.a(new_n207_), .O(new_n208_));
  aoi21  g163(.a(new_n206_), .b(new_n59_), .c(new_n208_), .O(new_n209_));
  nor2   g164(.a(new_n57_), .b(x15), .O(new_n210_));
  oai21  g165(.a(new_n210_), .b(new_n140_), .c(new_n60_), .O(new_n211_));
  oai21  g166(.a(new_n210_), .b(new_n181_), .c(x20), .O(new_n212_));
  oai21  g167(.a(new_n101_), .b(new_n59_), .c(new_n57_), .O(new_n213_));
  oai21  g168(.a(new_n213_), .b(x12), .c(x15), .O(new_n214_));
  nand2  g169(.a(new_n107_), .b(new_n100_), .O(new_n215_));
  oai21  g170(.a(new_n215_), .b(new_n99_), .c(x25), .O(new_n216_));
  nand2  g171(.a(new_n216_), .b(new_n129_), .O(new_n217_));
  nand2  g172(.a(new_n217_), .b(new_n48_), .O(new_n218_));
  nand4  g173(.a(new_n218_), .b(new_n214_), .c(new_n212_), .d(new_n211_), .O(new_n219_));
  inv1   g174(.a(new_n219_), .O(new_n220_));
  oai21  g175(.a(new_n209_), .b(x25), .c(new_n220_), .O(z18));
endmodule
