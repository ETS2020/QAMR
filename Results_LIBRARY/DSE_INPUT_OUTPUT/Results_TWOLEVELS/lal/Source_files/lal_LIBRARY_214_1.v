...
module FAU ( 
  ...
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x07), .O(z12));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n52_), .d(new_n51_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n52_), .d(new_n51_), .O(z14));
  nand2  g61(.a(new_n105_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n51_), .b(x05), .c(x04), .O(new_n108_));
  inv1   g63(.a(new_n99_), .O(new_n109_));
  nor3   g64(.a(x22), .b(x21), .c(x20), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n51_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  aoi21  g70(.a(new_n110_), .b(new_n109_), .c(new_n115_), .O(new_n116_));
  nand3  g71(.a(new_n104_), .b(new_n115_), .c(new_n80_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n99_), .c(new_n108_), .O(new_n118_));
  ...
  nor2   g76(.a(x20), .b(new_n59_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n94_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n121_), .c(new_n108_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n51_), .O(z17));
  nand2  g83(.a(new_n124_), .b(new_n123_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n101_), .c(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n123_), .c(new_n122_), .d(new_n94_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n108_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n51_), .O(z18));
endmodule
