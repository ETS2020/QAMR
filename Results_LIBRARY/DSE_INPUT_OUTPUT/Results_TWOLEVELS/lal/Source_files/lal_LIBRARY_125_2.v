...
module FAU ( 
  ...
  oai21  g038(.a(new_n83_), .b(new_n82_), .c(new_n54_), .O(new_n84_));
  ...
  nor2   g047(.a(new_n80_), .b(new_n56_), .O(new_n93_));
  ...
  nand2  g057(.a(new_n58_), .b(new_n55_), .O(new_n103_));
  ...
  nand3  g065(.a(new_n110_), .b(new_n51_), .c(new_n47_), .O(new_n111_));
  inv1   g066(.a(new_n111_), .O(z09));
  inv1   g067(.a(new_n110_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n56_), .O(new_n114_));
  aoi21  g069(.a(new_n114_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g070(.a(x18), .b(x17), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n113_), .c(new_n51_), .d(new_n47_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(z11));
  aoi21  g073(.a(new_n80_), .b(new_n47_), .c(new_n56_), .O(new_n119_));
  nand3  g074(.a(new_n81_), .b(x18), .c(x17), .O(new_n120_));
  oai21  g075(.a(new_n119_), .b(new_n81_), .c(new_n120_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n113_), .O(new_n122_));
  aoi21  g077(.a(new_n122_), .b(new_n47_), .c(x15), .O(z12));
  oai21  g078(.a(new_n109_), .b(new_n108_), .c(new_n47_), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n51_), .O(new_n125_));
  nor2   g080(.a(new_n81_), .b(new_n80_), .O(new_n126_));
  inv1   g081(.a(new_n126_), .O(new_n127_));
  nand3  g082(.a(new_n54_), .b(new_n102_), .c(x15), .O(new_n128_));
  aoi21  g083(.a(new_n128_), .b(new_n127_), .c(new_n56_), .O(new_n129_));
  nand4  g084(.a(new_n82_), .b(new_n54_), .c(new_n102_), .d(x15), .O(new_n130_));
  inv1   g085(.a(new_n130_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(new_n129_), .c(new_n55_), .O(new_n132_));
  nor3   g087(.a(new_n83_), .b(new_n82_), .c(new_n51_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(x20), .c(new_n56_), .O(new_n134_));
  aoi21  g089(.a(new_n59_), .b(new_n102_), .c(new_n92_), .O(new_n135_));
  oai21  g090(.a(new_n59_), .b(new_n55_), .c(new_n102_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(x24), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n135_), .c(new_n54_), .O(new_n138_));
  aoi22  g093(.a(new_n138_), .b(x15), .c(new_n127_), .d(x20), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n134_), .c(new_n132_), .d(new_n125_), .O(z13));
  nand2  g095(.a(new_n128_), .b(new_n90_), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n55_), .c(x17), .O(new_n142_));
  nand2  g097(.a(new_n94_), .b(new_n93_), .O(new_n143_));
  nand4  g098(.a(new_n54_), .b(x24), .c(new_n102_), .d(x21), .O(new_n144_));
  aoi22  g099(.a(new_n144_), .b(x15), .c(new_n143_), .d(x21), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n142_), .c(new_n125_), .O(z14));
  inv1   g101(.a(new_n93_), .O(new_n147_));
  nand3  g102(.a(new_n91_), .b(new_n55_), .c(x19), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n147_), .c(new_n128_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n89_), .O(new_n150_));
  nand4  g105(.a(new_n54_), .b(x24), .c(new_n102_), .d(x22), .O(new_n151_));
  nand4  g106(.a(new_n93_), .b(new_n89_), .c(new_n55_), .d(x19), .O(new_n152_));
  aoi22  g107(.a(new_n152_), .b(x22), .c(new_n151_), .d(x15), .O(new_n153_));
  nand3  g108(.a(new_n153_), .b(new_n150_), .c(new_n125_), .O(z15));
  nand2  g109(.a(new_n126_), .b(new_n95_), .O(new_n155_));
  nand2  g110(.a(new_n54_), .b(x15), .O(new_n156_));
  aoi21  g111(.a(new_n156_), .b(new_n155_), .c(new_n56_), .O(new_n157_));
  nor3   g112(.a(new_n57_), .b(x25), .c(new_n51_), .O(new_n158_));
  oai21  g113(.a(new_n158_), .b(new_n157_), .c(new_n55_), .O(new_n159_));
  nand3  g114(.a(new_n59_), .b(new_n54_), .c(x15), .O(new_n160_));
  nand2  g115(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g116(.a(new_n161_), .b(new_n102_), .O(new_n162_));
  oai21  g117(.a(new_n133_), .b(x23), .c(new_n56_), .O(new_n163_));
  ...
  nand3  g121(.a(new_n54_), .b(x24), .c(new_n102_), .O(new_n167_));
  ...
  nand4  g126(.a(new_n171_), .b(new_n163_), .c(new_n162_), .d(new_n125_), .O(z16));
  nand2  g127(.a(new_n96_), .b(new_n91_), .O(new_n173_));
  nor3   g128(.a(new_n173_), .b(x21), .c(x20), .O(new_n174_));
  ...
  and2   g132(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g133(.a(new_n102_), .b(new_n89_), .O(new_n179_));
  nand3  g134(.a(new_n179_), .b(new_n54_), .c(x24), .O(new_n180_));
  nand4  g135(.a(new_n126_), .b(new_n95_), .c(new_n55_), .d(x17), .O(new_n181_));
  aoi22  g136(.a(new_n181_), .b(x24), .c(new_n180_), .d(x15), .O(new_n182_));
  nand4  g137(.a(new_n182_), .b(new_n178_), .c(new_n175_), .d(new_n47_), .O(z17));
  nand3  g138(.a(x19), .b(x18), .c(new_n47_), .O(new_n184_));
  nand3  g139(.a(new_n92_), .b(new_n91_), .c(new_n89_), .O(new_n185_));
  oai21  g140(.a(new_n185_), .b(new_n184_), .c(new_n51_), .O(new_n186_));
  nor2   g141(.a(new_n57_), .b(new_n51_), .O(new_n187_));
  aoi21  g142(.a(new_n186_), .b(x17), .c(new_n187_), .O(new_n188_));
  nand2  g143(.a(new_n59_), .b(x15), .O(new_n189_));
  oai21  g144(.a(new_n188_), .b(x20), .c(new_n189_), .O(new_n190_));
  nor2   g145(.a(x24), .b(new_n51_), .O(new_n191_));
  aoi21  g146(.a(new_n190_), .b(new_n102_), .c(new_n191_), .O(new_n192_));
  nor2   g147(.a(new_n54_), .b(x07), .O(new_n193_));
  oai21  g148(.a(new_n193_), .b(new_n133_), .c(new_n56_), .O(new_n194_));
  oai21  g149(.a(new_n193_), .b(new_n165_), .c(x20), .O(new_n195_));
  nand2  g150(.a(new_n176_), .b(new_n54_), .O(new_n196_));
  nand2  g151(.a(new_n196_), .b(x15), .O(new_n197_));
  oai21  g152(.a(new_n173_), .b(new_n90_), .c(x25), .O(new_n198_));
  nand2  g153(.a(new_n198_), .b(new_n177_), .O(new_n199_));
