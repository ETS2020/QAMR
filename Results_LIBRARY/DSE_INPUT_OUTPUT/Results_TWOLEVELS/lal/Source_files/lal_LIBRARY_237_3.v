...
module FAU ( 
  ...
  nand3  g021(.a(new_n66_), .b(new_n62_), .c(new_n50_), .O(z01));
  nand2  g022(.a(new_n47_), .b(new_n46_), .O(z02));
  nand2  g023(.a(new_n62_), .b(new_n47_), .O(z03));
  ...
  nand4  g053(.a(new_n98_), .b(new_n93_), .c(new_n51_), .d(new_n59_), .O(new_n99_));
  nand2  g054(.a(new_n99_), .b(x25), .O(new_n100_));
  nand4  g055(.a(new_n100_), .b(new_n91_), .c(new_n90_), .d(new_n88_), .O(new_n101_));
  nand2  g056(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  inv1   g057(.a(x23), .O(new_n103_));
  nand3  g058(.a(new_n57_), .b(x22), .c(x21), .O(new_n104_));
  aoi21  g059(.a(new_n104_), .b(new_n103_), .c(new_n51_), .O(new_n105_));
  oai21  g060(.a(new_n105_), .b(x25), .c(new_n50_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n102_), .O(z08));
  nand3  g062(.a(new_n65_), .b(new_n84_), .c(new_n50_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z09));
  nand4  g064(.a(new_n66_), .b(new_n85_), .c(new_n84_), .d(new_n50_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n47_), .O(z10));
  xor2a  g066(.a(x18), .b(x17), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n66_), .c(new_n84_), .d(new_n50_), .O(new_n113_));
  ...
  nand4  g071(.a(new_n116_), .b(new_n66_), .c(new_n84_), .d(new_n50_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(z12));
  nand2  g073(.a(new_n95_), .b(new_n94_), .O(new_n119_));
  nand3  g074(.a(new_n84_), .b(x05), .c(x04), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n84_), .O(new_n121_));
  ...
  nand4  g079(.a(new_n124_), .b(new_n122_), .c(new_n119_), .d(new_n50_), .O(z13));
  nand2  g080(.a(new_n119_), .b(x21), .O(new_n126_));
  nand4  g081(.a(new_n94_), .b(new_n58_), .c(new_n53_), .d(x19), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n126_), .c(new_n122_), .d(new_n50_), .O(z14));
  inv1   g083(.a(new_n123_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n96_), .c(new_n53_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n50_), .O(new_n131_));
  aoi21  g086(.a(new_n127_), .b(x22), .c(new_n131_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(x15), .c(new_n122_), .O(z15));
  and2   g088(.a(new_n130_), .b(x23), .O(new_n134_));
  nand4  g089(.a(new_n103_), .b(new_n59_), .c(new_n58_), .d(new_n53_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n123_), .c(new_n50_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n134_), .c(new_n84_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n122_), .O(z16));
  nand3  g093(.a(new_n97_), .b(new_n59_), .c(new_n58_), .O(new_n139_));
  nor2   g094(.a(new_n139_), .b(x20), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(x19), .c(x18), .d(x17), .O(new_n141_));
  oai21  g096(.a(new_n64_), .b(new_n63_), .c(new_n50_), .O(new_n142_));
  aoi21  g097(.a(new_n130_), .b(x24), .c(new_n142_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n84_), .O(new_n145_));
  aoi21  g100(.a(x24), .b(x23), .c(x15), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(x07), .c(new_n145_), .O(z17));
  nand4  g102(.a(new_n96_), .b(new_n52_), .c(new_n51_), .d(new_n103_), .O(new_n148_));
  nor2   g103(.a(new_n148_), .b(new_n119_), .O(new_n149_));
  aoi21  g104(.a(new_n98_), .b(x25), .c(new_n149_), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n120_), .c(new_n84_), .d(new_n50_), .O(z18));
endmodule
