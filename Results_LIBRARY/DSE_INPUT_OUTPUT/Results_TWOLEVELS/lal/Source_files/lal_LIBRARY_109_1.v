...
module FAU ( 
  ...
  oai21  g05(.a(x19), .b(x07), .c(new_n50_), .O(new_n51_));
  ...
  oai21  g17(.a(x18), .b(x17), .c(new_n47_), .O(new_n63_));
  oai21  g18(.a(new_n47_), .b(new_n50_), .c(new_n63_), .O(new_n64_));
  nand4  g19(.a(new_n64_), .b(new_n62_), .c(new_n55_), .d(new_n61_), .O(new_n65_));
  nand3  g20(.a(new_n65_), .b(new_n60_), .c(new_n52_), .O(z01));
  ...
  nand3  g31(.a(new_n76_), .b(new_n53_), .c(new_n46_), .O(new_n77_));
  inv1   g32(.a(new_n77_), .O(z04));
  oai21  g33(.a(x13), .b(x08), .c(new_n53_), .O(z05));
  nand2  g34(.a(x14), .b(new_n46_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n53_), .O(z06));
  ...
  oai21  g46(.a(new_n91_), .b(x07), .c(new_n47_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n50_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  inv1   g49(.a(new_n91_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x19), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n84_), .c(new_n50_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n91_), .c(new_n54_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n47_), .c(x15), .O(z11));
  nand4  g56(.a(new_n96_), .b(x18), .c(x17), .d(new_n50_), .O(new_n102_));
  nor2   g57(.a(new_n102_), .b(x07), .O(z12));
  nand3  g58(.a(new_n95_), .b(new_n50_), .c(new_n54_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n61_), .c(new_n54_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n50_), .O(z13));
  nand2  g62(.a(new_n47_), .b(x07), .O(new_n108_));
  nor2   g63(.a(x21), .b(x15), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n93_), .O(z14));
  nand4  g65(.a(new_n108_), .b(new_n93_), .c(new_n83_), .d(new_n50_), .O(z15));
  nand3  g66(.a(new_n104_), .b(new_n55_), .c(new_n54_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n50_), .O(z16));
  nand4  g69(.a(new_n108_), .b(new_n93_), .c(new_n56_), .d(new_n50_), .O(z17));
  nand4  g70(.a(new_n108_), .b(new_n93_), .c(new_n62_), .d(new_n50_), .O(z18));
endmodule
