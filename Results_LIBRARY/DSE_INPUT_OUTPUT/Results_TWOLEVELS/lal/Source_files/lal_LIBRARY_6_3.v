...
module FAU ( 
  ...
  nand2  g19(.a(x07), .b(new_n47_), .O(new_n65_));
  ...
  aoi21  g45(.a(new_n90_), .b(new_n48_), .c(new_n47_), .O(z09));
  nand4  g46(.a(new_n62_), .b(new_n55_), .c(new_n89_), .d(new_n48_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n62_), .c(new_n89_), .d(new_n48_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n62_), .c(new_n89_), .d(new_n48_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n50_), .O(z12));
  oai21  g56(.a(x07), .b(x05), .c(x04), .O(new_n102_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nor2   g59(.a(new_n89_), .b(x07), .O(new_n105_));
  nor2   g60(.a(x20), .b(new_n57_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n97_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nor2   g63(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n104_), .c(new_n102_), .d(new_n65_), .O(z13));
  inv1   g65(.a(new_n105_), .O(new_n111_));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n97_), .c(x19), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n65_), .O(new_n114_));
  aoi21  g69(.a(new_n107_), .b(x21), .c(new_n114_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n102_), .O(z14));
  inv1   g71(.a(new_n103_), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n54_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n62_), .c(new_n89_), .O(new_n120_));
  aoi21  g75(.a(new_n113_), .b(x22), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x07), .c(new_n65_), .O(z15));
  nor2   g77(.a(x23), .b(x22), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n112_), .c(new_n117_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n111_), .c(new_n65_), .O(new_n125_));
  ...
  nand4  g83(.a(new_n128_), .b(new_n118_), .c(new_n106_), .d(new_n97_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n62_), .c(new_n89_), .O(new_n130_));
  aoi21  g85(.a(new_n124_), .b(x24), .c(new_n130_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(x07), .c(new_n65_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  and2   g89(.a(new_n134_), .b(new_n118_), .O(new_n135_));
  aoi21  g90(.a(new_n135_), .b(new_n108_), .c(new_n105_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n102_), .d(new_n65_), .O(z18));
endmodule
