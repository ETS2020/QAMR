...
module FAU ( 
  ...
  nand3  g16(.a(new_n47_), .b(x05), .c(x04), .O(new_n62_));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n85_), .b(new_n54_), .c(new_n87_), .d(new_n47_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n85_), .c(new_n87_), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n85_), .c(new_n87_), .d(new_n47_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nor2   g54(.a(new_n63_), .b(x15), .O(new_n100_));
  nand4  g55(.a(new_n53_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n49_), .O(z13));
  ...
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n85_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n47_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n87_), .O(z14));
  nand2  g63(.a(new_n105_), .b(x22), .O(new_n109_));
  inv1   g64(.a(new_n98_), .O(new_n110_));
  nor3   g65(.a(x22), .b(x21), .c(x20), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n48_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n100_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n111_), .b(new_n110_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n104_), .b(new_n114_), .c(new_n80_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n98_), .c(new_n85_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n47_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n87_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n98_), .c(x24), .O(new_n120_));
  nor2   g75(.a(x20), .b(new_n56_), .O(new_n121_));
  nor2   g76(.a(x22), .b(x21), .O(new_n122_));
  nor2   g77(.a(x24), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n93_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n85_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n87_), .O(z17));
  nand2  g82(.a(new_n123_), .b(new_n122_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n101_), .c(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n122_), .c(new_n121_), .d(new_n93_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n129_), .c(new_n85_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n87_), .O(z18));
endmodule
