...
module FAU ( 
  ...
  nand2  g027(.a(new_n72_), .b(new_n50_), .O(z04));
  inv1   g028(.a(x13), .O(new_n74_));
  nand3  g029(.a(new_n50_), .b(new_n74_), .c(new_n46_), .O(new_n75_));
  ...
  nand3  g038(.a(x24), .b(x22), .c(x20), .O(new_n84_));
  nand2  g039(.a(new_n84_), .b(new_n53_), .O(new_n85_));
  nand2  g040(.a(new_n85_), .b(x21), .O(new_n86_));
  oai21  g041(.a(x25), .b(x15), .c(x20), .O(new_n87_));
  inv1   g042(.a(x23), .O(new_n88_));
  nor2   g043(.a(x25), .b(x24), .O(new_n89_));
  nor2   g044(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  ...
  nand4  g055(.a(new_n100_), .b(new_n87_), .c(new_n86_), .d(new_n83_), .O(z08));
  nand4  g056(.a(new_n47_), .b(new_n52_), .c(x05), .d(x04), .O(new_n102_));
  inv1   g057(.a(new_n102_), .O(z09));
  nand4  g058(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n52_), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n50_), .O(z10));
  xor2a  g060(.a(x18), .b(x17), .O(new_n106_));
  nand4  g061(.a(new_n106_), .b(new_n62_), .c(new_n47_), .d(new_n52_), .O(new_n107_));
  ...
  nand4  g065(.a(new_n110_), .b(new_n62_), .c(new_n47_), .d(new_n52_), .O(new_n111_));
  inv1   g066(.a(new_n111_), .O(z12));
  nand2  g067(.a(new_n93_), .b(x17), .O(new_n113_));
  inv1   g068(.a(new_n113_), .O(new_n114_));
  oai21  g069(.a(new_n114_), .b(x15), .c(new_n48_), .O(new_n115_));
  aoi21  g070(.a(x05), .b(x04), .c(x07), .O(new_n116_));
  inv1   g071(.a(new_n116_), .O(new_n117_));
  aoi21  g072(.a(new_n113_), .b(x20), .c(new_n117_), .O(new_n118_));
  oai21  g073(.a(new_n118_), .b(x15), .c(new_n115_), .O(z13));
  nand2  g074(.a(new_n117_), .b(new_n47_), .O(new_n120_));
  ...
  nand4  g079(.a(new_n124_), .b(new_n122_), .c(new_n120_), .d(new_n47_), .O(z14));
  nand3  g080(.a(new_n52_), .b(x05), .c(x04), .O(new_n126_));
  nand2  g081(.a(x22), .b(x20), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n126_), .c(new_n52_), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  inv1   g084(.a(x21), .O(new_n130_));
  nand3  g085(.a(new_n94_), .b(new_n130_), .c(x19), .O(new_n131_));
  nand3  g086(.a(new_n96_), .b(new_n94_), .c(x19), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  aoi21  g088(.a(new_n131_), .b(x22), .c(new_n133_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(x20), .c(new_n129_), .O(z15));
  nand2  g090(.a(new_n96_), .b(new_n48_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n113_), .c(x23), .O(new_n137_));
  nand4  g092(.a(new_n123_), .b(new_n114_), .c(new_n88_), .d(new_n91_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n137_), .c(new_n120_), .d(new_n47_), .O(z16));
  nand3  g094(.a(new_n97_), .b(new_n91_), .c(new_n130_), .O(new_n140_));
  nor2   g095(.a(new_n140_), .b(x20), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(x19), .c(x18), .d(x17), .O(new_n142_));
  nand2  g097(.a(new_n138_), .b(x24), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n142_), .c(new_n120_), .d(new_n47_), .O(z17));
  nand2  g099(.a(new_n98_), .b(x25), .O(new_n145_));
  inv1   g100(.a(new_n121_), .O(new_n146_));
  nand4  g101(.a(new_n96_), .b(new_n146_), .c(new_n89_), .d(new_n88_), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n145_), .c(new_n120_), .d(new_n47_), .O(z18));
endmodule
