...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n101_, new_n103_, new_n107_, new_n108_, new_n109_;
  ...
  oai21  g05(.a(x18), .b(x07), .c(new_n50_), .O(new_n51_));
  ...
  nand3  g36(.a(new_n53_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand4  g49(.a(new_n91_), .b(new_n47_), .c(new_n84_), .d(new_n50_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z10));
  nand3  g51(.a(new_n91_), .b(x17), .c(new_n54_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g53(.a(new_n91_), .b(x19), .c(new_n54_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n47_), .c(x15), .O(z12));
  nand2  g55(.a(new_n47_), .b(x07), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n93_), .c(new_n61_), .d(new_n50_), .O(z13));
  nor2   g57(.a(x21), .b(x15), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n93_), .O(z14));
  nand4  g59(.a(new_n101_), .b(new_n93_), .c(new_n83_), .d(new_n50_), .O(z15));
  nand4  g60(.a(new_n101_), .b(new_n93_), .c(new_n55_), .d(new_n50_), .O(z16));
  nand4  g61(.a(new_n50_), .b(new_n54_), .c(x05), .d(x04), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n56_), .c(new_n54_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n50_), .O(z17));
  nand4  g65(.a(new_n101_), .b(new_n93_), .c(new_n62_), .d(new_n50_), .O(z18));
endmodule
