...
module FAU ( 
  ...
  nand3  g008(.a(new_n48_), .b(x05), .c(x04), .O(new_n54_));
  ...
  oai21  g022(.a(new_n67_), .b(new_n57_), .c(new_n58_), .O(new_n68_));
  nand3  g023(.a(new_n68_), .b(new_n56_), .c(new_n53_), .O(z01));
  nand2  g024(.a(new_n68_), .b(new_n50_), .O(z03));
  ...
  oai21  g038(.a(new_n83_), .b(new_n62_), .c(new_n58_), .O(new_n84_));
  nand2  g039(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g040(.a(new_n83_), .b(new_n58_), .O(new_n86_));
  nand2  g041(.a(new_n86_), .b(x20), .O(new_n87_));
  nand2  g042(.a(new_n58_), .b(new_n57_), .O(new_n88_));
  nand2  g043(.a(new_n88_), .b(x23), .O(new_n89_));
  nand3  g044(.a(new_n64_), .b(x19), .c(x18), .O(new_n90_));
  inv1   g045(.a(new_n90_), .O(new_n91_));
  and2   g046(.a(x18), .b(x17), .O(new_n92_));
  nor2   g047(.a(x20), .b(new_n61_), .O(new_n93_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n91_), .c(new_n57_), .d(new_n65_), .O(new_n97_));
  nand2  g052(.a(new_n97_), .b(x25), .O(new_n98_));
  nand4  g053(.a(new_n98_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n99_));
  nand2  g054(.a(new_n99_), .b(new_n48_), .O(new_n100_));
  inv1   g055(.a(x23), .O(new_n101_));
  nand3  g056(.a(new_n63_), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g057(.a(new_n102_), .b(new_n101_), .c(new_n57_), .O(new_n103_));
  oai21  g058(.a(new_n103_), .b(x25), .c(x07), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n100_), .O(z08));
  nand4  g060(.a(new_n48_), .b(new_n53_), .c(x05), .d(x04), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z09));
  nand2  g062(.a(x05), .b(x04), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n82_), .O(new_n109_));
  aoi21  g064(.a(new_n109_), .b(new_n48_), .c(x07), .O(z10));
  xor2a  g065(.a(x18), .b(x17), .O(new_n111_));
  nand4  g066(.a(new_n111_), .b(new_n108_), .c(new_n48_), .d(new_n53_), .O(new_n112_));
  inv1   g067(.a(new_n112_), .O(z11));
  nand3  g068(.a(new_n61_), .b(x18), .c(x17), .O(new_n114_));
  oai21  g069(.a(new_n92_), .b(new_n61_), .c(new_n114_), .O(new_n115_));
  ...
  nand4  g075(.a(new_n120_), .b(new_n118_), .c(new_n56_), .d(new_n53_), .O(z13));
  ...
  nand4  g079(.a(new_n124_), .b(new_n122_), .c(new_n56_), .d(new_n53_), .O(z14));
  nand2  g080(.a(new_n124_), .b(x22), .O(new_n126_));
  nand3  g081(.a(new_n53_), .b(x05), .c(x04), .O(new_n127_));
  inv1   g082(.a(new_n127_), .O(new_n128_));
  inv1   g083(.a(new_n94_), .O(new_n129_));
  nor3   g084(.a(new_n119_), .b(new_n129_), .c(x20), .O(new_n130_));
  nor2   g085(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n126_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n48_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n53_), .O(z15));
  nor2   g089(.a(new_n130_), .b(new_n101_), .O(new_n135_));
  inv1   g090(.a(new_n119_), .O(new_n136_));
  nand4  g091(.a(new_n123_), .b(new_n136_), .c(new_n101_), .d(new_n65_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n127_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n135_), .c(new_n48_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n53_), .O(z16));
  nand3  g095(.a(new_n95_), .b(new_n65_), .c(new_n64_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(x20), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(x19), .c(x18), .d(x17), .O(new_n143_));
  aoi21  g098(.a(new_n137_), .b(x24), .c(new_n128_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n48_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n53_), .O(z17));
  nor4   g102(.a(new_n129_), .b(new_n118_), .c(new_n88_), .d(x23), .O(new_n148_));
  aoi21  g103(.a(new_n96_), .b(x25), .c(new_n148_), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n54_), .c(new_n48_), .d(new_n53_), .O(z18));
endmodule
