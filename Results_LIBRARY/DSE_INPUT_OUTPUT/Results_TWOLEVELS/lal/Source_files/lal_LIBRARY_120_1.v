...
module FAU ( 
  ...
  nand2  g34(.a(new_n57_), .b(new_n56_), .O(new_n80_));
  nand3  g35(.a(x24), .b(x22), .c(x21), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(new_n80_), .c(new_n53_), .O(new_n82_));
  ...
  nor2   g47(.a(x20), .b(new_n57_), .O(new_n93_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n55_), .c(new_n47_), .d(new_n100_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n66_), .O(z10));
  xor2a  g60(.a(x18), .b(x17), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n103_), .c(new_n47_), .d(new_n100_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n66_), .O(z11));
  nand3  g63(.a(new_n57_), .b(x18), .c(x17), .O(new_n109_));
  oai21  g64(.a(new_n92_), .b(new_n57_), .c(new_n109_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n103_), .c(new_n47_), .d(new_n100_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n66_), .O(z12));
  ...
  nand3  g79(.a(new_n124_), .b(new_n94_), .c(new_n54_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n114_), .c(new_n100_), .O(new_n126_));
  aoi21  g81(.a(new_n122_), .b(x22), .c(new_n126_), .O(new_n127_));
  nand2  g82(.a(x15), .b(x06), .O(new_n128_));
  oai21  g83(.a(new_n127_), .b(x15), .c(new_n128_), .O(z15));
  and2   g84(.a(new_n125_), .b(x23), .O(new_n130_));
  nor2   g85(.a(x23), .b(x22), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n121_), .c(new_n124_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n114_), .c(new_n100_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n130_), .c(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n128_), .O(z16));
  nand3  g90(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n136_));
  nor2   g91(.a(new_n136_), .b(x20), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(x19), .c(x18), .d(x17), .O(new_n138_));
  nand2  g93(.a(new_n132_), .b(x24), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n138_), .c(new_n116_), .d(new_n47_), .O(z17));
  nand2  g95(.a(new_n96_), .b(x25), .O(new_n141_));
  nor3   g96(.a(x25), .b(x24), .c(x23), .O(new_n142_));
  nand4  g97(.a(new_n142_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n143_));
  nand4  g98(.a(new_n143_), .b(new_n141_), .c(new_n116_), .d(new_n47_), .O(z18));
endmodule
