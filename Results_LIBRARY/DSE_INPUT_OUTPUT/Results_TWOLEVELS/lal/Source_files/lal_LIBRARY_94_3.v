...
module FAU ( 
  ...
  nand2  g017(.a(new_n62_), .b(new_n54_), .O(new_n63_));
  nand2  g018(.a(x05), .b(x04), .O(new_n64_));
  nand4  g019(.a(new_n64_), .b(new_n63_), .c(new_n50_), .d(new_n53_), .O(z01));
  ...
  nand3  g028(.a(new_n73_), .b(new_n50_), .c(new_n68_), .O(new_n74_));
  inv1   g029(.a(new_n74_), .O(z04));
  inv1   g030(.a(x13), .O(new_n76_));
  nand3  g031(.a(new_n50_), .b(new_n76_), .c(new_n68_), .O(new_n77_));
  inv1   g032(.a(new_n77_), .O(z05));
  nand3  g033(.a(new_n50_), .b(x14), .c(new_n68_), .O(new_n79_));
  inv1   g034(.a(new_n79_), .O(z06));
  aoi21  g035(.a(new_n68_), .b(x06), .c(new_n49_), .O(z07));
  nor2   g036(.a(x25), .b(x24), .O(new_n82_));
  inv1   g037(.a(new_n82_), .O(new_n83_));
  nand3  g038(.a(new_n83_), .b(x23), .c(new_n47_), .O(new_n84_));
  nand2  g039(.a(new_n58_), .b(new_n57_), .O(new_n85_));
  nand3  g040(.a(x24), .b(x22), .c(x21), .O(new_n86_));
  oai21  g041(.a(new_n86_), .b(new_n85_), .c(new_n54_), .O(new_n87_));
  ...
  nand2  g060(.a(new_n47_), .b(new_n53_), .O(new_n106_));
  oai21  g061(.a(new_n106_), .b(new_n64_), .c(new_n50_), .O(z09));
  nand4  g062(.a(new_n64_), .b(new_n56_), .c(new_n47_), .d(new_n53_), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n50_), .O(z10));
  xor2a  g064(.a(x18), .b(x17), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n64_), .c(new_n47_), .d(new_n53_), .O(new_n111_));
  ...
  oai21  g069(.a(new_n113_), .b(new_n58_), .c(new_n114_), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n64_), .c(new_n47_), .d(new_n53_), .O(new_n116_));
  inv1   g071(.a(new_n116_), .O(z12));
  nand3  g072(.a(new_n53_), .b(x05), .c(x04), .O(new_n118_));
  nand2  g073(.a(new_n118_), .b(new_n53_), .O(new_n119_));
  inv1   g074(.a(new_n119_), .O(new_n120_));
  nand2  g075(.a(new_n96_), .b(x20), .O(new_n121_));
  nand3  g076(.a(new_n113_), .b(new_n55_), .c(x19), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n47_), .O(z13));
  inv1   g078(.a(new_n122_), .O(new_n124_));
  nor2   g079(.a(new_n124_), .b(new_n93_), .O(new_n125_));
  nand3  g080(.a(new_n113_), .b(new_n98_), .c(x19), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n118_), .c(new_n53_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(new_n125_), .c(new_n47_), .O(new_n128_));
  nand2  g083(.a(new_n48_), .b(x15), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n128_), .O(z14));
  nand2  g085(.a(new_n126_), .b(x22), .O(new_n131_));
  nor2   g086(.a(x22), .b(x21), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n97_), .c(new_n55_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n120_), .d(new_n47_), .O(z15));
  nand2  g089(.a(new_n133_), .b(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n48_), .O(new_n136_));
  aoi21  g091(.a(new_n133_), .b(x23), .c(new_n119_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(x15), .c(new_n136_), .O(z16));
  nand4  g093(.a(new_n92_), .b(new_n48_), .c(new_n91_), .d(new_n93_), .O(new_n139_));
  ...
  nand3  g097(.a(new_n142_), .b(new_n118_), .c(new_n53_), .O(new_n143_));
  aoi22  g098(.a(new_n143_), .b(new_n47_), .c(new_n133_), .d(x24), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n141_), .c(new_n47_), .O(z17));
  nand2  g100(.a(x25), .b(x23), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n118_), .c(new_n53_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  nand2  g103(.a(new_n100_), .b(x25), .O(new_n149_));
  nand3  g104(.a(new_n132_), .b(new_n124_), .c(new_n82_), .O(new_n150_));
  nand3  g105(.a(new_n150_), .b(new_n149_), .c(new_n47_), .O(new_n151_));
