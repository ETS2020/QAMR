...
module FAU ( 
  ...
  nand3  g035(.a(new_n50_), .b(x14), .c(new_n70_), .O(new_n81_));
  ...
  nand4  g062(.a(new_n48_), .b(new_n47_), .c(x05), .d(x04), .O(new_n108_));
  ...
  inv1   g086(.a(new_n122_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n96_), .c(new_n54_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  aoi21  g089(.a(new_n128_), .b(x22), .c(new_n134_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(x15), .c(new_n120_), .O(z15));
  nand2  g091(.a(new_n133_), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n127_), .b(new_n132_), .c(new_n103_), .d(new_n60_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n137_), .c(new_n120_), .d(new_n47_), .O(z16));
  nand2  g094(.a(x25), .b(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n53_), .b(new_n48_), .O(new_n141_));
  aoi21  g096(.a(new_n141_), .b(new_n140_), .c(x24), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(new_n103_), .c(new_n60_), .d(new_n59_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x20), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(x19), .c(x18), .d(x17), .O(new_n145_));
  nand2  g100(.a(new_n138_), .b(x24), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n47_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n48_), .O(new_n148_));
  nand3  g103(.a(new_n148_), .b(new_n145_), .c(new_n120_), .O(z17));
  nand4  g104(.a(new_n96_), .b(new_n53_), .c(new_n91_), .d(new_n103_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n121_), .c(new_n47_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n48_), .O(new_n152_));
  aoi21  g107(.a(new_n98_), .b(x25), .c(new_n119_), .O(new_n153_));
  oai21  g108(.a(new_n153_), .b(x07), .c(new_n152_), .O(z18));
endmodule
