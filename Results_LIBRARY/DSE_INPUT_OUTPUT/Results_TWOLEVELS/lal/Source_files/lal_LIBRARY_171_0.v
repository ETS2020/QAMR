...
module FAU ( 
  ...
  nand2  g24(.a(new_n59_), .b(new_n48_), .O(z03));
  ...
  aoi21  g35(.a(new_n46_), .b(x06), .c(z09), .O(z07));
  inv1   g36(.a(new_n64_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(z09), .O(z08));
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n86_));
  nand3  g39(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z13));
  aoi21  g40(.a(new_n86_), .b(new_n82_), .c(z09), .O(z16));
  zero   g41(.O(z11));
  zero   g42(.O(z12));
  nor2   g43(.a(x15), .b(x07), .O(z10));
  nand3  g44(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z14));
  nand3  g45(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z15));
  aoi21  g46(.a(new_n86_), .b(new_n82_), .c(z09), .O(z17));
  aoi21  g47(.a(new_n86_), .b(new_n82_), .c(z09), .O(z18));
endmodule
