...
module FAU ( 
  ...
  nand3  g080(.a(new_n125_), .b(new_n94_), .c(x19), .O(new_n126_));
  ...
  nand3  g085(.a(new_n130_), .b(new_n96_), .c(new_n53_), .O(new_n131_));
  ...
  nand4  g090(.a(new_n125_), .b(new_n130_), .c(new_n103_), .d(new_n59_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n121_), .d(new_n47_), .O(z16));
  nand3  g092(.a(new_n97_), .b(new_n59_), .c(new_n58_), .O(new_n138_));
  ...
  oai21  g103(.a(new_n148_), .b(new_n119_), .c(new_n47_), .O(new_n149_));
  aoi21  g104(.a(new_n98_), .b(x25), .c(new_n149_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(x15), .c(new_n121_), .O(z18));
endmodule
