...
module FAU ( 
  ...
  nand2  g19(.a(new_n64_), .b(new_n48_), .O(z03));
  ...
  nand2  g38(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x05), .c(x15), .O(z09));
  inv1   g40(.a(x04), .O(new_n86_));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n83_), .c(x05), .d(new_n86_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x17), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n83_), .c(new_n86_), .O(new_n91_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n83_), .c(new_n86_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x05), .c(x15), .O(z12));
  oai21  g52(.a(x07), .b(x04), .c(x05), .O(new_n98_));
  ...
  nor2   g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n100_), .c(new_n98_), .d(new_n87_), .O(z13));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n93_), .c(x19), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n87_), .c(x05), .O(new_n108_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n83_), .c(new_n86_), .O(new_n115_));
  aoi21  g70(.a(new_n107_), .b(x22), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n111_), .c(new_n87_), .O(z15));
  and2   g72(.a(new_n114_), .b(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n106_), .c(new_n112_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n83_), .c(new_n86_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n118_), .c(x05), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n87_), .O(z16));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n113_), .c(new_n101_), .d(new_n93_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n83_), .c(new_n86_), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x24), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n111_), .c(new_n87_), .O(z17));
  nand2  g83(.a(new_n125_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  and2   g85(.a(new_n130_), .b(new_n113_), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(new_n103_), .c(new_n47_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n98_), .d(new_n87_), .O(z18));
endmodule
