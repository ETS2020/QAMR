...
module FAU ( 
  ...
  nand3  g23(.a(new_n61_), .b(new_n50_), .c(new_n53_), .O(new_n69_));
  ...
  nand3  g43(.a(new_n64_), .b(new_n48_), .c(new_n47_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  inv1   g45(.a(new_n64_), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n91_), .c(new_n48_), .d(new_n47_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n91_), .c(new_n48_), .d(new_n47_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  oai21  g56(.a(new_n63_), .b(new_n62_), .c(new_n48_), .O(new_n102_));
  ...
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n103_), .O(z14));
  ...
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n103_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n109_), .b(new_n114_), .c(new_n121_), .d(new_n84_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n103_), .d(new_n47_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  nand3  g79(.a(new_n115_), .b(new_n83_), .c(new_n121_), .O(new_n125_));
