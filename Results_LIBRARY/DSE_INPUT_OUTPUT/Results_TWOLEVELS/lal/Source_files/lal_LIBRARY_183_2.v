...
module FAU ( 
  ...
  nand3  g020(.a(new_n65_), .b(new_n56_), .c(new_n48_), .O(new_n66_));
  nand2  g021(.a(x15), .b(x07), .O(new_n67_));
  nand3  g022(.a(new_n67_), .b(new_n66_), .c(new_n55_), .O(z01));
  nand2  g023(.a(new_n65_), .b(new_n56_), .O(new_n69_));
  ...
  oai21  g038(.a(new_n83_), .b(new_n61_), .c(new_n56_), .O(new_n84_));
  ...
  nor2   g049(.a(x20), .b(new_n60_), .O(new_n95_));
  ...
  nand3  g057(.a(new_n62_), .b(x22), .c(x21), .O(new_n103_));
  aoi21  g058(.a(new_n103_), .b(new_n57_), .c(new_n90_), .O(new_n104_));
  ...
  aoi21  g065(.a(new_n110_), .b(new_n48_), .c(x15), .O(z10));
  xor2a  g066(.a(x18), .b(x17), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  aoi21  g068(.a(new_n113_), .b(new_n48_), .c(x15), .O(z11));
  nand3  g069(.a(new_n60_), .b(x18), .c(x17), .O(new_n115_));
  oai21  g070(.a(new_n94_), .b(new_n60_), .c(new_n115_), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n109_), .c(new_n53_), .d(new_n48_), .O(new_n117_));
  ...
  inv1   g080(.a(z09), .O(new_n126_));
  nand2  g081(.a(new_n119_), .b(x21), .O(new_n127_));
  nor2   g082(.a(x21), .b(x20), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n94_), .c(x19), .O(new_n129_));
  nand4  g084(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(new_n53_), .O(z14));
  nand2  g085(.a(new_n129_), .b(x22), .O(new_n131_));
  inv1   g086(.a(new_n120_), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n96_), .c(new_n58_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n126_), .d(new_n53_), .O(z15));
  nand2  g089(.a(new_n133_), .b(x23), .O(new_n135_));
  nand4  g090(.a(new_n128_), .b(new_n132_), .c(new_n57_), .d(new_n89_), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n126_), .d(new_n53_), .O(z16));
  nand4  g092(.a(new_n96_), .b(x25), .c(new_n90_), .d(new_n57_), .O(new_n138_));
  oai22  g093(.a(new_n138_), .b(new_n119_), .c(new_n90_), .d(new_n57_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n48_), .O(new_n140_));
  nand2  g095(.a(new_n133_), .b(x24), .O(new_n141_));
  nand4  g096(.a(new_n96_), .b(new_n56_), .c(new_n90_), .d(new_n57_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(new_n119_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x15), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n141_), .c(new_n140_), .d(new_n126_), .O(z17));
  nand3  g100(.a(new_n98_), .b(x25), .c(new_n48_), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n144_), .c(new_n126_), .O(z18));
endmodule
