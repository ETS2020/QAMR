...
module FAU ( 
  ...
  nand3  g021(.a(new_n66_), .b(new_n54_), .c(new_n50_), .O(z01));
  inv1   g022(.a(x16), .O(new_n68_));
  nor2   g023(.a(new_n48_), .b(new_n68_), .O(z02));
  inv1   g024(.a(new_n48_), .O(new_n70_));
  nand2  g025(.a(new_n66_), .b(new_n70_), .O(z03));
  ...
  nand2  g035(.a(new_n80_), .b(new_n70_), .O(z06));
  nand3  g036(.a(new_n70_), .b(new_n46_), .c(x06), .O(z07));
  inv1   g037(.a(x17), .O(new_n83_));
  nand3  g038(.a(x24), .b(x22), .c(x21), .O(new_n84_));
  oai21  g039(.a(new_n84_), .b(new_n60_), .c(new_n56_), .O(new_n85_));
  nand2  g040(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g041(.a(new_n84_), .b(new_n56_), .O(new_n87_));
  nand2  g042(.a(new_n87_), .b(x20), .O(new_n88_));
  oai21  g043(.a(x25), .b(x24), .c(x23), .O(new_n89_));
  nand3  g044(.a(new_n62_), .b(x19), .c(x18), .O(new_n90_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n91_), .c(new_n55_), .d(new_n63_), .O(new_n97_));
  ...
  nand3  g056(.a(new_n61_), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g057(.a(new_n102_), .b(new_n101_), .c(new_n55_), .O(new_n103_));
  oai21  g058(.a(new_n103_), .b(x25), .c(x07), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n100_), .O(z08));
  nor2   g060(.a(new_n52_), .b(new_n51_), .O(new_n106_));
  nand3  g061(.a(new_n106_), .b(new_n47_), .c(new_n50_), .O(new_n107_));
  inv1   g062(.a(new_n107_), .O(z09));
  inv1   g063(.a(new_n106_), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n83_), .c(new_n47_), .d(new_n50_), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z10));
  xor2a  g066(.a(x18), .b(x17), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n109_), .c(new_n47_), .d(new_n50_), .O(new_n113_));
  inv1   g068(.a(new_n113_), .O(z11));
  nand3  g069(.a(new_n59_), .b(x18), .c(x17), .O(new_n115_));
  oai21  g070(.a(new_n92_), .b(new_n59_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g076(.a(new_n121_), .b(new_n119_), .c(new_n54_), .d(new_n50_), .O(z13));
  nand3  g077(.a(new_n50_), .b(x05), .c(x04), .O(new_n123_));
  nand4  g078(.a(new_n92_), .b(new_n62_), .c(new_n57_), .d(x19), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  aoi21  g080(.a(new_n119_), .b(x21), .c(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(x15), .c(new_n50_), .O(z14));
  nand2  g082(.a(new_n124_), .b(x22), .O(new_n128_));
  inv1   g083(.a(new_n120_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n94_), .c(new_n57_), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n128_), .c(new_n54_), .d(new_n50_), .O(z15));
  and2   g086(.a(new_n130_), .b(x23), .O(new_n132_));
  nand4  g087(.a(new_n101_), .b(new_n63_), .c(new_n62_), .d(new_n57_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n120_), .c(new_n123_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n132_), .c(new_n47_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n50_), .O(z16));
  nand3  g091(.a(new_n95_), .b(new_n63_), .c(new_n62_), .O(new_n137_));
  nor2   g092(.a(new_n137_), .b(x20), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  oai21  g094(.a(new_n55_), .b(new_n101_), .c(new_n139_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n47_), .O(new_n141_));
  aoi21  g096(.a(new_n130_), .b(x24), .c(x07), .O(new_n142_));
  nand3  g097(.a(new_n142_), .b(new_n141_), .c(new_n54_), .O(z17));
  nor3   g098(.a(x25), .b(x24), .c(x23), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n94_), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n119_), .c(new_n123_), .O(new_n146_));
  aoi21  g101(.a(new_n96_), .b(x25), .c(new_n146_), .O(new_n147_));
  oai21  g102(.a(new_n147_), .b(x15), .c(new_n50_), .O(z18));
endmodule
