...
module FAU ( 
  ...
  nand2  g032(.a(new_n77_), .b(new_n51_), .O(z06));
  ...
  oai21  g055(.a(new_n100_), .b(x25), .c(x14), .O(new_n101_));
  nand2  g056(.a(new_n101_), .b(new_n97_), .O(z08));
  nand4  g057(.a(new_n47_), .b(new_n50_), .c(x05), .d(x04), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(new_n51_), .O(z09));
  ...
  nand2  g063(.a(new_n108_), .b(new_n51_), .O(z11));
  ...
  nand2  g070(.a(new_n90_), .b(new_n89_), .O(new_n116_));
  nand3  g071(.a(new_n103_), .b(new_n116_), .c(new_n50_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(new_n118_));
  nand3  g073(.a(new_n118_), .b(new_n115_), .c(new_n47_), .O(z13));
  nor2   g074(.a(x21), .b(x20), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(new_n89_), .c(x19), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n103_), .c(new_n50_), .O(new_n122_));
  aoi21  g077(.a(new_n116_), .b(x21), .c(new_n122_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n47_), .O(z14));
  nand2  g079(.a(new_n121_), .b(x22), .O(new_n125_));
  nand3  g080(.a(new_n50_), .b(x05), .c(x04), .O(new_n126_));
  inv1   g081(.a(new_n126_), .O(new_n127_));
  inv1   g082(.a(new_n91_), .O(new_n128_));
  nor3   g083(.a(new_n114_), .b(new_n128_), .c(x20), .O(new_n129_));
  nor2   g084(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n125_), .c(new_n50_), .O(new_n131_));
  nand2  g086(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g087(.a(x15), .b(x14), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n132_), .O(z15));
  nor2   g089(.a(new_n129_), .b(new_n98_), .O(new_n135_));
  inv1   g090(.a(new_n114_), .O(new_n136_));
  nand4  g091(.a(new_n120_), .b(new_n136_), .c(new_n98_), .d(new_n60_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n126_), .c(new_n50_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n135_), .c(new_n47_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n133_), .O(z16));
  nand3  g095(.a(new_n92_), .b(new_n60_), .c(new_n59_), .O(new_n141_));
  ...
  nand4  g099(.a(new_n144_), .b(new_n143_), .c(new_n126_), .d(new_n50_), .O(new_n145_));
