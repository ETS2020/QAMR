...
module FAU ( 
  ...
  oai21  g64(.a(new_n93_), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  ...
  aoi21  g68(.a(x05), .b(x04), .c(x07), .O(new_n114_));
  nand3  g69(.a(x19), .b(x18), .c(x17), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x20), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n51_), .O(z13));
  or2    g72(.a(new_n114_), .b(x15), .O(new_n118_));
  nand2  g73(.a(new_n113_), .b(x21), .O(new_n119_));
  nor2   g74(.a(x21), .b(x20), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n93_), .c(x19), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n51_), .O(z14));
  nand2  g77(.a(new_n121_), .b(x22), .O(new_n123_));
  inv1   g78(.a(new_n115_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n95_), .c(new_n55_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n118_), .d(new_n51_), .O(z15));
  nand2  g81(.a(new_n125_), .b(x23), .O(new_n127_));
  nor2   g82(.a(x23), .b(x22), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n120_), .c(new_n124_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n118_), .d(new_n51_), .O(z16));
  nand3  g85(.a(new_n96_), .b(new_n88_), .c(new_n90_), .O(new_n131_));
  nor2   g86(.a(new_n131_), .b(x20), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(x19), .c(x18), .d(x17), .O(new_n133_));
  aoi21  g88(.a(new_n129_), .b(x24), .c(x15), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n133_), .c(new_n118_), .O(z17));
  nand2  g90(.a(new_n97_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n118_), .d(new_n51_), .O(z18));
endmodule
