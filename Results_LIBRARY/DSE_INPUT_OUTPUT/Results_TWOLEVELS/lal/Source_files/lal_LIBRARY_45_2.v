...
module FAU ( 
  ...
  aoi21  g33(.a(x15), .b(x08), .c(new_n47_), .O(z06));
  ...
  aoi21  g40(.a(new_n64_), .b(new_n85_), .c(x14), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x15), .O(z09));
  nand3  g42(.a(new_n63_), .b(new_n53_), .c(new_n85_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n63_), .c(new_n85_), .O(new_n91_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n63_), .c(new_n93_), .d(new_n47_), .O(new_n98_));
  nor2   g53(.a(new_n98_), .b(x07), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n64_), .b(new_n93_), .c(new_n85_), .O(new_n102_));
  ...
  aoi21  g62(.a(new_n107_), .b(new_n95_), .c(new_n58_), .O(new_n108_));
