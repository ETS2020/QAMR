...
module FAU ( 
  ...
  nor2   g54(.a(x20), .b(new_n59_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n99_), .c(new_n52_), .d(new_n51_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n53_), .d(new_n51_), .O(z14));
  nand2  g61(.a(new_n105_), .b(x22), .O(new_n107_));
  inv1   g62(.a(new_n98_), .O(new_n108_));
  nor2   g63(.a(x22), .b(x21), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n56_), .O(new_n110_));
  ...
  nand4  g75(.a(new_n120_), .b(new_n109_), .c(new_n100_), .d(new_n93_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n51_), .O(z17));
  nand2  g79(.a(new_n121_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n109_), .c(new_n100_), .d(new_n93_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n53_), .d(new_n51_), .O(z18));
endmodule
