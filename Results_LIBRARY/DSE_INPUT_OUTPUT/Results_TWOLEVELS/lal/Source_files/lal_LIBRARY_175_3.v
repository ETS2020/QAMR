...
module FAU ( 
  ...
  nand3  g076(.a(new_n48_), .b(x05), .c(x04), .O(new_n122_));
  ...
  nand4  g083(.a(new_n94_), .b(new_n91_), .c(new_n128_), .d(x19), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  aoi21  g085(.a(new_n121_), .b(x21), .c(new_n130_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(x15), .c(new_n124_), .O(z14));
  nand2  g087(.a(new_n129_), .b(x22), .O(new_n133_));
  inv1   g088(.a(new_n125_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n97_), .c(new_n128_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n133_), .c(new_n124_), .d(new_n47_), .O(z15));
  and2   g091(.a(new_n135_), .b(x23), .O(new_n137_));
  nand4  g092(.a(new_n54_), .b(new_n89_), .c(new_n91_), .d(new_n128_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n125_), .c(new_n47_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n137_), .c(new_n48_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n124_), .O(z16));
  nand3  g096(.a(new_n98_), .b(new_n89_), .c(new_n91_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(x20), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(x19), .c(x18), .d(x17), .O(new_n144_));
  oai21  g099(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(new_n145_));
  aoi21  g100(.a(new_n135_), .b(x24), .c(new_n145_), .O(new_n146_));
  ...
  oai21  g104(.a(new_n149_), .b(x07), .c(new_n148_), .O(z17));
  nand4  g105(.a(new_n97_), .b(new_n53_), .c(new_n90_), .d(new_n54_), .O(new_n151_));
  nor2   g106(.a(new_n151_), .b(new_n121_), .O(new_n152_));
  aoi21  g107(.a(new_n99_), .b(x25), .c(new_n152_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n122_), .c(new_n48_), .d(new_n47_), .O(z18));
endmodule
