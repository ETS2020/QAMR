...
module FAU ( 
  ...
  nor2   g22(.a(z12), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n60_), .b(z15), .O(z03));
  ...
  nand3  g29(.a(new_n74_), .b(z15), .c(new_n46_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z04));
  oai21  g31(.a(x13), .b(x08), .c(z15), .O(z05));
  ...
  nor2   g38(.a(z12), .b(x25), .O(new_n84_));
