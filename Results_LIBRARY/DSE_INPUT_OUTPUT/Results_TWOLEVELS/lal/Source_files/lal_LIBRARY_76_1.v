...
module FAU ( 
  ...
  nand2  g35(.a(new_n59_), .b(new_n58_), .O(new_n81_));
  nand3  g36(.a(x24), .b(x22), .c(x21), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(new_n81_), .c(new_n55_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n57_), .O(new_n84_));
  nand2  g39(.a(new_n82_), .b(new_n55_), .O(new_n85_));
  ...
  nor2   g48(.a(x20), .b(new_n59_), .O(new_n94_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n57_), .c(new_n47_), .d(new_n51_), .O(new_n102_));
  ...
  nand3  g61(.a(new_n59_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g62(.a(new_n93_), .b(new_n59_), .c(new_n107_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n101_), .c(new_n47_), .d(new_n51_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(z12));
  nand2  g65(.a(new_n94_), .b(new_n93_), .O(new_n111_));
  ...
  nand4  g83(.a(new_n116_), .b(new_n121_), .c(new_n127_), .d(new_n88_), .O(new_n129_));
  ...
  nand3  g91(.a(new_n136_), .b(new_n135_), .c(new_n54_), .O(z17));
  ...
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n54_), .d(new_n51_), .O(z18));
endmodule
