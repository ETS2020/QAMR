...
module FAU ( 
  ...
  nand2  g19(.a(z16), .b(new_n64_), .O(z02));
  nand3  g20(.a(new_n60_), .b(z16), .c(new_n52_), .O(new_n66_));
  ...
  oai21  g29(.a(x13), .b(x08), .c(z16), .O(z05));
  nand2  g30(.a(x14), .b(new_n46_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(z16), .O(z06));
  nand3  g32(.a(z16), .b(new_n46_), .c(x06), .O(z07));
  ...
  nor2   g39(.a(new_n51_), .b(x07), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n51_), .O(z13));
  zero   g41(.O(z10));
  nor2   g42(.a(x15), .b(x07), .O(z11));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand2  g44(.a(new_n86_), .b(new_n51_), .O(z14));
  nand2  g45(.a(new_n86_), .b(new_n51_), .O(z15));
  nand2  g46(.a(new_n86_), .b(new_n51_), .O(z17));
  nand2  g47(.a(new_n86_), .b(new_n51_), .O(z18));
endmodule
