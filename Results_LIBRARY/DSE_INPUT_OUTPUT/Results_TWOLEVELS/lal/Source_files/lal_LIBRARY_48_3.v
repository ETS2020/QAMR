...
module FAU ( 
  ...
  oai21  g018(.a(new_n63_), .b(new_n49_), .c(new_n53_), .O(z01));
  inv1   g019(.a(x16), .O(new_n65_));
  nand2  g020(.a(new_n50_), .b(new_n65_), .O(z02));
  nand3  g021(.a(new_n62_), .b(new_n50_), .c(new_n54_), .O(new_n67_));
  inv1   g022(.a(new_n67_), .O(z03));
  nor2   g023(.a(x12), .b(x08), .O(new_n69_));
  oai21  g024(.a(new_n69_), .b(x15), .c(x03), .O(new_n70_));
  ...
  aoi21  g042(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  ...
  nor2   g056(.a(x20), .b(new_n58_), .O(new_n102_));
  ...
  nand4  g060(.a(new_n105_), .b(new_n100_), .c(new_n97_), .d(new_n96_), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(x25), .c(new_n49_), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n95_), .c(new_n94_), .d(new_n92_), .O(z08));
  inv1   g063(.a(x07), .O(new_n109_));
  nand4  g064(.a(new_n48_), .b(new_n109_), .c(x05), .d(x04), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(z09));
  nand2  g066(.a(x05), .b(x04), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n56_), .c(new_n48_), .d(new_n109_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n50_), .O(z10));
  xor2a  g069(.a(x18), .b(x17), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n112_), .c(new_n48_), .d(new_n109_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n50_), .O(z11));
  nand3  g072(.a(new_n58_), .b(x18), .c(x17), .O(new_n118_));
  oai21  g073(.a(new_n101_), .b(new_n58_), .c(new_n118_), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n112_), .c(new_n48_), .d(new_n109_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n50_), .O(z12));
  nand2  g076(.a(new_n102_), .b(new_n101_), .O(new_n122_));
  nand3  g077(.a(new_n109_), .b(x05), .c(x04), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n109_), .O(new_n124_));
  ...
  nand4  g082(.a(new_n127_), .b(new_n125_), .c(new_n122_), .d(new_n48_), .O(z13));
  nand2  g083(.a(new_n122_), .b(x21), .O(new_n129_));
  nor2   g084(.a(x21), .b(x20), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n101_), .c(x19), .O(new_n131_));
  nand4  g086(.a(new_n131_), .b(new_n129_), .c(new_n125_), .d(new_n48_), .O(z14));
  inv1   g087(.a(new_n126_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n103_), .c(new_n55_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n123_), .c(new_n109_), .O(new_n135_));
  aoi21  g090(.a(new_n131_), .b(x22), .c(new_n135_), .O(new_n136_));
  nand2  g091(.a(x15), .b(new_n47_), .O(new_n137_));
  oai21  g092(.a(new_n136_), .b(x15), .c(new_n137_), .O(z15));
  nand2  g093(.a(new_n134_), .b(x23), .O(new_n139_));
  nor2   g094(.a(x23), .b(x22), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n130_), .c(new_n133_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n139_), .c(new_n125_), .d(new_n48_), .O(z16));
  nand3  g097(.a(new_n104_), .b(new_n96_), .c(new_n98_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x20), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(x19), .c(x18), .d(x17), .O(new_n145_));
  nand2  g100(.a(new_n141_), .b(x24), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n125_), .d(new_n48_), .O(z17));
  nand2  g102(.a(new_n105_), .b(x25), .O(new_n148_));
  nor3   g103(.a(x25), .b(x24), .c(x23), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n103_), .c(new_n102_), .d(new_n101_), .O(new_n150_));
  nand4  g105(.a(new_n150_), .b(new_n148_), .c(new_n125_), .d(new_n48_), .O(z18));
endmodule
