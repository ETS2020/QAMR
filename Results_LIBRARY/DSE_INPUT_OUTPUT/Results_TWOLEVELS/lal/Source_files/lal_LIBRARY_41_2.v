...
module FAU ( 
  ...
  nand3  g061(.a(new_n64_), .b(new_n80_), .c(new_n51_), .O(new_n107_));
  ...
  nand4  g073(.a(new_n103_), .b(new_n51_), .c(x05), .d(x04), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n118_), .c(new_n116_), .d(new_n51_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n103_), .O(z13));
  aoi21  g077(.a(new_n90_), .b(new_n89_), .c(new_n59_), .O(new_n123_));
  nand4  g078(.a(new_n89_), .b(new_n59_), .c(new_n54_), .d(x19), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n119_), .c(new_n51_), .O(new_n125_));
  oai21  g080(.a(new_n125_), .b(new_n123_), .c(new_n47_), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n103_), .O(z14));
  inv1   g082(.a(new_n117_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n91_), .c(new_n54_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n119_), .c(new_n51_), .O(new_n130_));
  aoi21  g085(.a(new_n124_), .b(x22), .c(new_n130_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(x13), .c(new_n103_), .O(z15));
  nand2  g087(.a(new_n129_), .b(x23), .O(new_n133_));
  nand4  g088(.a(new_n98_), .b(new_n60_), .c(new_n59_), .d(new_n54_), .O(new_n134_));
  inv1   g089(.a(new_n134_), .O(new_n135_));
  aoi21  g090(.a(new_n135_), .b(new_n128_), .c(x15), .O(new_n136_));
  nand4  g091(.a(new_n136_), .b(new_n133_), .c(new_n105_), .d(new_n51_), .O(z16));
  nand4  g092(.a(new_n91_), .b(x25), .c(new_n52_), .d(new_n98_), .O(new_n138_));
  oai22  g093(.a(new_n138_), .b(new_n116_), .c(new_n52_), .d(new_n98_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n129_), .b(x24), .O(new_n141_));
  nand4  g096(.a(new_n91_), .b(new_n53_), .c(new_n52_), .d(new_n98_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n116_), .c(new_n103_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x07), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n141_), .c(new_n140_), .d(new_n105_), .O(z17));
  nand3  g100(.a(new_n93_), .b(x25), .c(new_n47_), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n144_), .c(new_n105_), .O(z18));
endmodule
