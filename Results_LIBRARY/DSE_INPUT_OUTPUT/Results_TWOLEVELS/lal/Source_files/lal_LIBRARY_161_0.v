...
module FAU ( 
  ...
  aoi21  g37(.a(new_n82_), .b(new_n49_), .c(z10), .O(z08));
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(new_n82_), .c(new_n50_), .O(z13));
  aoi21  g40(.a(new_n85_), .b(new_n82_), .c(z10), .O(z15));
  zero   g41(.O(z09));
  nor2   g42(.a(x15), .b(x07), .O(z11));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand3  g44(.a(new_n85_), .b(new_n82_), .c(new_n50_), .O(z14));
  aoi21  g45(.a(new_n85_), .b(new_n82_), .c(z10), .O(z16));
  aoi21  g46(.a(new_n85_), .b(new_n82_), .c(z10), .O(z17));
  aoi21  g47(.a(new_n85_), .b(new_n82_), .c(z10), .O(z18));
endmodule
