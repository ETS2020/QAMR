...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n59_), .c(new_n87_), .d(new_n47_), .O(new_n91_));
  ...
  inv1   g60(.a(x05), .O(new_n106_));
  nor2   g61(.a(x07), .b(new_n106_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(x04), .c(x15), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n93_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n105_), .d(new_n66_), .O(z14));
  nand2  g66(.a(new_n110_), .b(x22), .O(new_n112_));
  inv1   g67(.a(new_n98_), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n51_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n112_), .c(new_n108_), .d(new_n66_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n109_), .b(new_n113_), .c(new_n118_), .d(new_n81_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n108_), .d(new_n66_), .O(z16));
  nor2   g75(.a(x24), .b(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n114_), .c(new_n100_), .d(new_n93_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n59_), .O(new_n123_));
  aoi21  g78(.a(new_n119_), .b(x24), .c(new_n123_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(x07), .c(new_n87_), .O(z17));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n114_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n101_), .c(new_n59_), .O(new_n128_));
  aoi21  g83(.a(new_n122_), .b(x25), .c(new_n128_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x07), .c(new_n87_), .O(z18));
endmodule
