...
module FAU ( 
  ...
  nand4  g41(.a(new_n50_), .b(new_n47_), .c(x05), .d(x04), .O(new_n87_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n100_), .d(new_n50_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n100_), .d(new_n50_), .O(z14));
  ...
  nand4  g82(.a(new_n127_), .b(new_n122_), .c(new_n109_), .d(new_n50_), .O(z17));
