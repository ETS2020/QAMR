...
module FAU ( 
  ...
  inv1   g19(.a(z10), .O(z16));
  nand2  g20(.a(new_n59_), .b(new_n51_), .O(new_n66_));
  nand2  g21(.a(new_n66_), .b(z16), .O(z03));
  ...
  nand2  g28(.a(new_n73_), .b(z16), .O(z04));
  nor3   g29(.a(z10), .b(x13), .c(x08), .O(z05));
  nand2  g30(.a(x14), .b(new_n46_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(z16), .O(z06));
  aoi21  g32(.a(new_n46_), .b(x06), .c(z10), .O(z07));
  ...
  nor2   g39(.a(new_n50_), .b(x07), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n50_), .O(z13));
  zero   g41(.O(z09));
  nor2   g42(.a(x15), .b(x07), .O(z11));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand2  g44(.a(new_n86_), .b(new_n50_), .O(z14));
  nand2  g45(.a(new_n86_), .b(new_n50_), .O(z15));
  nand2  g46(.a(new_n86_), .b(new_n50_), .O(z17));
  inv1   g47(.a(z10), .O(z18));
endmodule
