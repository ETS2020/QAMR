...
module FAU ( 
  ...
  nand3  g20(.a(new_n60_), .b(z17), .c(new_n52_), .O(new_n66_));
  ...
  oai21  g29(.a(x13), .b(x08), .c(z17), .O(z05));
  ...
  nand2  g45(.a(new_n87_), .b(new_n51_), .O(z15));
  nand2  g46(.a(new_n87_), .b(new_n51_), .O(z16));
