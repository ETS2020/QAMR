...
module FAU ( 
  ...
  nor2   g006(.a(x19), .b(x18), .O(new_n52_));
  nand2  g007(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g008(.a(x22), .b(x21), .O(new_n54_));
  aoi21  g009(.a(new_n53_), .b(new_n50_), .c(new_n54_), .O(new_n55_));
  oai21  g010(.a(new_n55_), .b(x23), .c(x24), .O(new_n56_));
  inv1   g011(.a(x04), .O(new_n57_));
  inv1   g012(.a(x05), .O(new_n58_));
  nor2   g013(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  aoi21  g014(.a(new_n56_), .b(new_n49_), .c(new_n59_), .O(new_n60_));
  inv1   g015(.a(x15), .O(new_n61_));
  nand2  g016(.a(new_n61_), .b(x07), .O(new_n62_));
  oai21  g017(.a(new_n60_), .b(x07), .c(new_n62_), .O(z01));
  inv1   g018(.a(x16), .O(new_n64_));
  nand2  g019(.a(new_n47_), .b(new_n64_), .O(z02));
  nand3  g020(.a(new_n56_), .b(new_n47_), .c(new_n49_), .O(new_n66_));
  ...
  inv1   g033(.a(new_n52_), .O(new_n79_));
  nand3  g034(.a(x24), .b(x22), .c(x21), .O(new_n80_));
  oai21  g035(.a(new_n80_), .b(new_n79_), .c(new_n49_), .O(new_n81_));
  nand2  g036(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  nand2  g037(.a(new_n80_), .b(new_n49_), .O(new_n83_));
  ...
  nand2  g054(.a(new_n99_), .b(new_n61_), .O(new_n100_));
  inv1   g055(.a(x07), .O(new_n101_));
  inv1   g056(.a(x23), .O(new_n102_));
  nand2  g057(.a(new_n53_), .b(new_n50_), .O(new_n103_));
  nand3  g058(.a(new_n103_), .b(x22), .c(x21), .O(new_n104_));
  aoi21  g059(.a(new_n104_), .b(new_n102_), .c(new_n87_), .O(new_n105_));
  oai21  g060(.a(new_n105_), .b(x25), .c(new_n101_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n100_), .O(z08));
  nand3  g062(.a(new_n59_), .b(new_n61_), .c(new_n101_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z09));
  inv1   g064(.a(new_n59_), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n51_), .c(new_n61_), .d(new_n101_), .O(new_n111_));
  inv1   g066(.a(new_n111_), .O(z10));
  xor2a  g067(.a(x18), .b(x17), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n110_), .c(new_n61_), .d(new_n101_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n47_), .O(z11));
  nand3  g070(.a(new_n92_), .b(x18), .c(x17), .O(new_n116_));
  oai21  g071(.a(new_n91_), .b(new_n92_), .c(new_n116_), .O(new_n117_));
  nand4  g072(.a(new_n117_), .b(new_n110_), .c(new_n61_), .d(new_n101_), .O(new_n118_));
  nand2  g073(.a(new_n118_), .b(new_n47_), .O(z12));
  oai21  g074(.a(new_n58_), .b(new_n57_), .c(new_n61_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n101_), .O(new_n121_));
  nand2  g076(.a(new_n93_), .b(new_n91_), .O(new_n122_));
  ...
  nand2  g080(.a(new_n125_), .b(new_n61_), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n121_), .O(z13));
  nor2   g082(.a(x21), .b(x20), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n91_), .c(x19), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n101_), .O(new_n130_));
  aoi21  g085(.a(new_n122_), .b(x21), .c(new_n130_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(x15), .c(new_n121_), .O(z14));
  inv1   g087(.a(new_n123_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n94_), .c(new_n50_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n101_), .O(new_n135_));
  aoi21  g090(.a(new_n129_), .b(x22), .c(new_n135_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(x15), .c(new_n121_), .O(z15));
  nand2  g092(.a(new_n134_), .b(x23), .O(new_n138_));
  nand4  g093(.a(new_n128_), .b(new_n133_), .c(new_n102_), .d(new_n86_), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n138_), .c(new_n121_), .d(new_n101_), .O(z16));
  ...
  nand3  g098(.a(new_n101_), .b(x05), .c(x04), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n61_), .O(new_n146_));
  aoi21  g101(.a(x24), .b(x23), .c(x15), .O(new_n147_));
  nand2  g102(.a(new_n134_), .b(x24), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n101_), .O(z17));
  nor3   g104(.a(x25), .b(x24), .c(x23), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n94_), .O(new_n151_));
  oai21  g106(.a(new_n151_), .b(new_n122_), .c(new_n101_), .O(new_n152_));
  aoi21  g107(.a(new_n96_), .b(x25), .c(new_n152_), .O(new_n153_));
  oai21  g108(.a(new_n153_), .b(x15), .c(new_n121_), .O(z18));
endmodule
