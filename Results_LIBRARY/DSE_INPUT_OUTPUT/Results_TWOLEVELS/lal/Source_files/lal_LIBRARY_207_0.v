...
module FAU ( 
  ...
  inv1   g22(.a(new_n47_), .O(z13));
  nand2  g23(.a(new_n59_), .b(z13), .O(z03));
  ...
  nand2  g30(.a(new_n75_), .b(z13), .O(z04));
  ...
  nand2  g40(.a(new_n62_), .b(new_n61_), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  inv1   g45(.a(new_n47_), .O(z15));
  nand2  g46(.a(new_n62_), .b(new_n61_), .O(z16));
