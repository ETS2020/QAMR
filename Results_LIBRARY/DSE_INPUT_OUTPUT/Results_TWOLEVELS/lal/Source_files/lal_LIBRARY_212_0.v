...
module FAU ( 
  ...
  nand2  g22(.a(z16), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n60_), .b(z16), .O(z03));
  ...
  nand3  g29(.a(new_n74_), .b(z16), .c(new_n46_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z04));
  oai21  g31(.a(x13), .b(x08), .c(z16), .O(z05));
  inv1   g32(.a(x14), .O(new_n78_));
  nor3   g33(.a(z11), .b(new_n78_), .c(x08), .O(z06));
  nand3  g34(.a(z16), .b(new_n46_), .c(x06), .O(z07));
  ...
  nor2   g38(.a(z11), .b(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n50_), .c(new_n84_), .O(z08));
  nand2  g40(.a(new_n63_), .b(new_n62_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand2  g44(.a(new_n63_), .b(new_n62_), .O(z14));
  nand2  g45(.a(new_n63_), .b(new_n62_), .O(z15));
  nand2  g46(.a(new_n63_), .b(new_n62_), .O(z17));
  nand2  g47(.a(new_n63_), .b(new_n62_), .O(z18));
endmodule
