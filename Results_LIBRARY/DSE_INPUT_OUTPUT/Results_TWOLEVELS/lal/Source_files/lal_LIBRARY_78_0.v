...
module FAU ( 
  ...
  oai21  g37(.a(new_n55_), .b(new_n50_), .c(new_n82_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(x24), .c(x25), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n81_), .O(z08));
  nor4   g40(.a(new_n59_), .b(new_n52_), .c(x15), .d(x07), .O(z09));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n59_), .b(x18), .c(new_n51_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(x18), .c(x15), .O(z10));
  nor3   g46(.a(new_n88_), .b(x15), .c(x07), .O(z11));
  xor2a  g47(.a(x19), .b(x17), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n59_), .c(new_n87_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(x18), .c(x15), .O(z12));
  oai21  g50(.a(new_n59_), .b(x07), .c(x18), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n78_), .O(new_n97_));
  nand2  g52(.a(x19), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n50_), .b(x19), .c(x17), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x15), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n97_), .d(new_n87_), .O(z13));
  nand2  g58(.a(new_n100_), .b(x21), .O(new_n104_));
  inv1   g59(.a(new_n98_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(x15), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n104_), .c(new_n97_), .d(new_n87_), .O(z14));
  inv1   g63(.a(x22), .O(new_n109_));
  aoi21  g64(.a(new_n106_), .b(new_n105_), .c(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n60_), .b(new_n78_), .c(new_n87_), .O(new_n111_));
  inv1   g66(.a(x21), .O(new_n112_));
  nand4  g67(.a(new_n105_), .b(new_n109_), .c(new_n112_), .d(new_n50_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n87_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n110_), .c(x18), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n78_), .O(z15));
  nand3  g71(.a(new_n109_), .b(new_n112_), .c(new_n50_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n98_), .c(x23), .O(new_n118_));
  nor3   g73(.a(x23), .b(x22), .c(x21), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n101_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n111_), .d(new_n87_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(x18), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n78_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  inv1   g79(.a(x24), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n82_), .c(new_n109_), .d(new_n112_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n101_), .c(x15), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n97_), .d(new_n87_), .O(z17));
  oai21  g84(.a(new_n126_), .b(new_n100_), .c(x25), .O(new_n130_));
  nor2   g85(.a(x23), .b(x22), .O(new_n131_));
  nor2   g86(.a(x25), .b(x24), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n131_), .c(new_n106_), .d(new_n105_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n111_), .d(new_n87_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(x18), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n78_), .O(z18));
endmodule
