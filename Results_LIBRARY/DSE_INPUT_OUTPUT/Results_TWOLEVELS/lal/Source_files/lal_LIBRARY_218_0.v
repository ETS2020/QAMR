...
module FAU ( 
  ...
  nand3  g060(.a(new_n63_), .b(new_n79_), .c(new_n49_), .O(new_n106_));
  ...
  nand4  g074(.a(new_n119_), .b(new_n116_), .c(new_n104_), .d(new_n49_), .O(z13));
  nor2   g075(.a(x21), .b(x20), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n88_), .c(x19), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n102_), .c(new_n49_), .O(new_n123_));
  ...
  nand2  g081(.a(new_n90_), .b(new_n53_), .O(new_n127_));
  nor2   g082(.a(new_n127_), .b(new_n115_), .O(new_n128_));
  nor2   g083(.a(new_n128_), .b(x15), .O(new_n129_));
  nand4  g084(.a(new_n129_), .b(new_n126_), .c(new_n104_), .d(new_n49_), .O(z15));
  nor2   g085(.a(new_n128_), .b(new_n97_), .O(new_n131_));
  nand2  g086(.a(new_n102_), .b(new_n49_), .O(new_n132_));
  or2    g087(.a(new_n132_), .b(new_n63_), .O(new_n133_));
  inv1   g088(.a(new_n115_), .O(new_n134_));
  nand4  g089(.a(new_n121_), .b(new_n134_), .c(new_n97_), .d(new_n59_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n133_), .c(new_n49_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n131_), .c(x13), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n102_), .O(z16));
  nand3  g093(.a(new_n91_), .b(new_n59_), .c(new_n58_), .O(new_n139_));
  nor2   g094(.a(new_n139_), .b(x20), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(x19), .c(x18), .d(x17), .O(new_n141_));
  oai21  g096(.a(new_n51_), .b(new_n97_), .c(new_n141_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(x13), .O(new_n143_));
  nor2   g098(.a(new_n128_), .b(new_n51_), .O(new_n144_));
  nor2   g099(.a(new_n144_), .b(new_n132_), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n143_), .c(new_n104_), .O(z17));
  nand2  g101(.a(new_n92_), .b(x25), .O(new_n147_));
  nor3   g102(.a(x25), .b(x24), .c(x23), .O(new_n148_));
  nand3  g103(.a(new_n148_), .b(new_n90_), .c(new_n118_), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n147_), .c(new_n133_), .d(new_n49_), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(x13), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n102_), .O(z18));
endmodule
