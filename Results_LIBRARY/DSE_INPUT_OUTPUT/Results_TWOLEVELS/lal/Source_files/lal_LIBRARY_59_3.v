...
module FAU ( 
  ...
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n101_), .d(new_n47_), .O(z13));
  ...
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n101_), .d(new_n47_), .O(z14));
  nor2   g64(.a(x22), .b(x21), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n53_), .O(new_n111_));
  nor2   g66(.a(new_n111_), .b(new_n102_), .O(new_n112_));
  aoi21  g67(.a(new_n108_), .b(x22), .c(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n101_), .c(new_n47_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  nor2   g70(.a(new_n112_), .b(new_n115_), .O(new_n116_));
  inv1   g71(.a(new_n102_), .O(new_n117_));
  nand4  g72(.a(new_n107_), .b(new_n117_), .c(new_n115_), .d(new_n84_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n48_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n101_), .O(z16));
  nand2  g76(.a(new_n118_), .b(x24), .O(new_n122_));
  inv1   g77(.a(new_n104_), .O(new_n123_));
  nand3  g78(.a(new_n110_), .b(new_n83_), .c(new_n115_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n122_), .c(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n101_), .O(z17));
  nand2  g84(.a(new_n126_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n110_), .c(new_n123_), .O(new_n132_));
