...
module FAU ( 
  ...
  nand2  g21(.a(new_n50_), .b(new_n66_), .O(z02));
  ...
  nand2  g35(.a(new_n56_), .b(new_n55_), .O(new_n81_));
  nand3  g36(.a(x24), .b(x22), .c(x21), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(new_n81_), .c(new_n52_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n54_), .O(new_n84_));
  nand2  g39(.a(new_n82_), .b(new_n52_), .O(new_n85_));
  ...
  nor2   g48(.a(x20), .b(new_n56_), .O(new_n94_));
  ...
  aoi21  g53(.a(new_n98_), .b(x25), .c(new_n49_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n87_), .c(new_n86_), .d(new_n84_), .O(z08));
  nand3  g55(.a(new_n62_), .b(new_n48_), .c(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n50_), .O(z09));
  nand4  g57(.a(new_n61_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n50_), .O(z11));
  nand3  g62(.a(new_n56_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g63(.a(new_n93_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n50_), .O(z12));
  nand2  g66(.a(new_n94_), .b(new_n93_), .O(new_n112_));
  oai21  g67(.a(new_n62_), .b(x15), .c(new_n47_), .O(new_n113_));
  ...
  nand2  g75(.a(new_n95_), .b(new_n53_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  aoi21  g77(.a(new_n119_), .b(x22), .c(new_n122_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n113_), .c(new_n47_), .O(z15));
  inv1   g79(.a(x23), .O(new_n125_));
  nor2   g80(.a(new_n122_), .b(new_n125_), .O(new_n126_));
  inv1   g81(.a(new_n114_), .O(new_n127_));
  nand4  g82(.a(new_n118_), .b(new_n127_), .c(new_n125_), .d(new_n88_), .O(new_n128_));
