...
module FAU ( 
  ...
  nor2   g04(.a(x15), .b(new_n46_), .O(new_n50_));
  ...
  nand2  g20(.a(new_n51_), .b(new_n65_), .O(z02));
  ...
  nand2  g28(.a(new_n73_), .b(new_n51_), .O(z04));
  ...
  aoi21  g40(.a(new_n62_), .b(new_n85_), .c(x08), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x15), .O(z09));
  nand3  g42(.a(new_n61_), .b(new_n53_), .c(new_n85_), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n46_), .c(x15), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n61_), .c(new_n47_), .d(new_n46_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z11));
  aoi21  g47(.a(new_n54_), .b(new_n46_), .c(new_n53_), .O(new_n93_));
  nand3  g48(.a(new_n55_), .b(x18), .c(x17), .O(new_n94_));
  oai21  g49(.a(new_n93_), .b(new_n55_), .c(new_n94_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n61_), .c(new_n85_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n46_), .c(x15), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n62_), .b(new_n47_), .c(new_n85_), .O(new_n100_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n85_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n46_), .O(new_n106_));
  nor2   g61(.a(new_n54_), .b(new_n53_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n47_), .c(new_n46_), .O(new_n110_));
  aoi21  g65(.a(new_n101_), .b(x21), .c(new_n110_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n106_), .O(z14));
  ...
  and2   g71(.a(new_n116_), .b(new_n51_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n106_), .d(new_n47_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  nand4  g74(.a(new_n108_), .b(new_n114_), .c(new_n119_), .d(new_n80_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n47_), .c(new_n46_), .O(new_n121_));
  ...
  nand4  g80(.a(new_n79_), .b(new_n119_), .c(new_n80_), .d(new_n125_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n101_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(new_n50_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n106_), .d(new_n47_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n115_), .c(new_n131_), .d(new_n107_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n100_), .d(new_n85_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n46_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n47_), .O(z18));
endmodule
