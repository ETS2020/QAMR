...
module FAU ( 
  ...
  nor2   g78(.a(new_n123_), .b(new_n62_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n51_), .O(z15));
  inv1   g82(.a(x23), .O(new_n128_));
  nor2   g83(.a(new_n123_), .b(new_n128_), .O(new_n129_));
  inv1   g84(.a(new_n113_), .O(new_n130_));
  nand4  g85(.a(new_n118_), .b(new_n130_), .c(new_n128_), .d(new_n87_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n61_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n129_), .c(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n51_), .O(z16));
  nand3  g89(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n135_));
  nor2   g90(.a(new_n135_), .b(x20), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(x19), .c(x18), .d(x17), .O(new_n137_));
  aoi21  g92(.a(new_n131_), .b(x24), .c(x07), .O(new_n138_));
  nand3  g93(.a(new_n138_), .b(new_n137_), .c(new_n116_), .O(z17));
  nand2  g94(.a(new_n96_), .b(x25), .O(new_n140_));
  nor3   g95(.a(x25), .b(x24), .c(x23), .O(new_n141_));
  nand4  g96(.a(new_n141_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n142_));
  nand4  g97(.a(new_n142_), .b(new_n140_), .c(new_n116_), .d(new_n51_), .O(z18));
endmodule
