...
module FAU ( 
  ...
  nand4  g070(.a(new_n115_), .b(new_n108_), .c(new_n47_), .d(new_n51_), .O(new_n116_));
  ...
  nand4  g075(.a(new_n120_), .b(new_n106_), .c(new_n118_), .d(new_n51_), .O(z13));
  nand2  g076(.a(new_n118_), .b(x21), .O(new_n122_));
  nor2   g077(.a(x21), .b(x20), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n91_), .c(x19), .O(new_n124_));
  nand4  g079(.a(new_n124_), .b(new_n122_), .c(new_n106_), .d(new_n51_), .O(z14));
  nand2  g080(.a(new_n124_), .b(x22), .O(new_n126_));
  inv1   g081(.a(x20), .O(new_n127_));
  nand2  g082(.a(new_n94_), .b(new_n127_), .O(new_n128_));
  nor2   g083(.a(new_n128_), .b(new_n119_), .O(new_n129_));
  inv1   g084(.a(new_n129_), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n126_), .c(new_n106_), .d(new_n51_), .O(z15));
  nor2   g086(.a(new_n129_), .b(new_n53_), .O(new_n132_));
  inv1   g087(.a(new_n119_), .O(new_n133_));
  nand4  g088(.a(new_n123_), .b(new_n133_), .c(new_n53_), .d(new_n86_), .O(new_n134_));
  ...
  nand3  g092(.a(new_n95_), .b(new_n86_), .c(new_n88_), .O(new_n138_));
  nor2   g093(.a(new_n138_), .b(x20), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(x19), .c(x18), .d(x17), .O(new_n140_));
  aoi21  g095(.a(new_n134_), .b(x24), .c(new_n61_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n47_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n51_), .O(z17));
  nor3   g099(.a(x25), .b(x24), .c(x23), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n94_), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n118_), .c(new_n60_), .O(new_n147_));
  aoi21  g102(.a(new_n96_), .b(x25), .c(new_n147_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(x15), .c(new_n51_), .O(z18));
endmodule
