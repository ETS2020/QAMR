...
module FAU ( 
  ...
  nor2   g047(.a(new_n92_), .b(new_n55_), .O(new_n93_));
  ...
  nor2   g064(.a(new_n109_), .b(x15), .O(z09));
  nand2  g065(.a(x05), .b(x04), .O(new_n111_));
  nand4  g066(.a(new_n111_), .b(new_n55_), .c(new_n50_), .d(new_n47_), .O(new_n112_));
  inv1   g067(.a(new_n112_), .O(z10));
  xor2a  g068(.a(x18), .b(x17), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g071(.a(new_n94_), .b(x18), .c(x17), .O(new_n117_));
  oai21  g072(.a(new_n93_), .b(new_n94_), .c(new_n117_), .O(new_n118_));
  ...
  nand3  g077(.a(new_n53_), .b(new_n103_), .c(x15), .O(new_n123_));
  aoi21  g078(.a(new_n123_), .b(new_n122_), .c(new_n55_), .O(new_n124_));
  nand4  g079(.a(new_n80_), .b(new_n53_), .c(new_n103_), .d(x15), .O(new_n125_));
  inv1   g080(.a(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(new_n124_), .c(new_n54_), .O(new_n127_));
  nor2   g082(.a(new_n54_), .b(x07), .O(new_n128_));
  nor3   g083(.a(new_n81_), .b(new_n80_), .c(new_n50_), .O(new_n129_));
  oai21  g084(.a(new_n129_), .b(new_n128_), .c(new_n55_), .O(new_n130_));
  aoi21  g085(.a(new_n58_), .b(new_n103_), .c(new_n88_), .O(new_n131_));
  oai21  g086(.a(new_n58_), .b(new_n54_), .c(new_n103_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(x24), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n131_), .c(new_n53_), .O(new_n134_));
  oai21  g089(.a(new_n94_), .b(new_n92_), .c(x20), .O(new_n135_));
  nand3  g090(.a(new_n50_), .b(x05), .c(x04), .O(new_n136_));
  ...
  inv1   g094(.a(z09), .O(new_n140_));
  nand2  g095(.a(new_n123_), .b(new_n90_), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n54_), .c(x17), .O(new_n142_));
  nand2  g097(.a(new_n95_), .b(new_n93_), .O(new_n143_));
  nand4  g098(.a(new_n53_), .b(x24), .c(new_n103_), .d(x21), .O(new_n144_));
  aoi22  g099(.a(new_n144_), .b(x15), .c(new_n143_), .d(x21), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n142_), .c(new_n140_), .O(z14));
  inv1   g101(.a(new_n93_), .O(new_n147_));
  nand3  g102(.a(new_n87_), .b(new_n54_), .c(x19), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n147_), .c(new_n123_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n89_), .O(new_n150_));
  nand4  g105(.a(new_n53_), .b(x24), .c(new_n103_), .d(x22), .O(new_n151_));
  nor2   g106(.a(x21), .b(x20), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n93_), .c(x19), .O(new_n153_));
  aoi22  g108(.a(new_n153_), .b(x22), .c(new_n151_), .d(x15), .O(new_n154_));
  nand3  g109(.a(new_n154_), .b(new_n150_), .c(new_n140_), .O(z15));
  nand2  g110(.a(x18), .b(new_n47_), .O(new_n156_));
  nand2  g111(.a(new_n96_), .b(x19), .O(new_n157_));
  oai22  g112(.a(new_n157_), .b(new_n156_), .c(x25), .d(new_n50_), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(x17), .O(new_n159_));
  nand3  g114(.a(new_n80_), .b(new_n53_), .c(x15), .O(new_n160_));
  aoi21  g115(.a(new_n160_), .b(new_n159_), .c(x20), .O(new_n161_));
  nand3  g116(.a(new_n58_), .b(new_n53_), .c(x15), .O(new_n162_));
  inv1   g117(.a(new_n162_), .O(new_n163_));
  oai21  g118(.a(new_n163_), .b(new_n161_), .c(new_n103_), .O(new_n164_));
  nor2   g119(.a(new_n103_), .b(x07), .O(new_n165_));
  oai21  g120(.a(new_n165_), .b(new_n129_), .c(new_n55_), .O(new_n166_));
  ...
  nand3  g124(.a(new_n53_), .b(x24), .c(new_n103_), .O(new_n170_));
  nand2  g125(.a(new_n170_), .b(x15), .O(new_n171_));
  inv1   g126(.a(new_n136_), .O(new_n172_));
  aoi21  g127(.a(new_n121_), .b(new_n96_), .c(new_n103_), .O(new_n173_));
  ...
  nor3   g132(.a(x24), .b(x23), .c(x22), .O(new_n178_));
  nand2  g133(.a(new_n178_), .b(new_n89_), .O(new_n179_));
  nor2   g134(.a(new_n179_), .b(x20), .O(new_n180_));
  nand4  g135(.a(new_n180_), .b(x19), .c(x18), .d(x17), .O(new_n181_));
  nor2   g136(.a(x23), .b(x22), .O(new_n182_));
  nand4  g137(.a(new_n152_), .b(new_n182_), .c(new_n121_), .d(x17), .O(new_n183_));
  aoi21  g138(.a(new_n183_), .b(x24), .c(new_n172_), .O(new_n184_));
  nand2  g139(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand2  g140(.a(new_n185_), .b(new_n47_), .O(new_n186_));
  nand2  g141(.a(new_n103_), .b(new_n89_), .O(new_n187_));
  nand4  g142(.a(new_n187_), .b(new_n53_), .c(x24), .d(new_n47_), .O(new_n188_));
  nand2  g143(.a(new_n188_), .b(x15), .O(new_n189_));
  nand2  g144(.a(new_n189_), .b(new_n186_), .O(z17));
  nor2   g145(.a(x24), .b(x22), .O(new_n191_));
  nand4  g146(.a(new_n191_), .b(new_n121_), .c(new_n89_), .d(new_n47_), .O(new_n192_));
  aoi21  g147(.a(new_n192_), .b(new_n50_), .c(new_n55_), .O(new_n193_));
  nor2   g148(.a(new_n56_), .b(new_n50_), .O(new_n194_));
  oai21  g149(.a(new_n194_), .b(new_n193_), .c(new_n54_), .O(new_n195_));
  nand2  g150(.a(new_n58_), .b(x15), .O(new_n196_));
  aoi21  g151(.a(new_n196_), .b(new_n195_), .c(x23), .O(new_n197_));
  nor2   g152(.a(x24), .b(new_n50_), .O(new_n198_));
  oai21  g153(.a(new_n198_), .b(new_n197_), .c(new_n53_), .O(new_n199_));
  nor2   g154(.a(new_n53_), .b(x07), .O(new_n200_));
  oai21  g155(.a(new_n200_), .b(new_n129_), .c(new_n55_), .O(new_n201_));
  oai21  g156(.a(new_n200_), .b(new_n168_), .c(x20), .O(new_n202_));
  oai21  g157(.a(new_n88_), .b(new_n103_), .c(new_n53_), .O(new_n203_));
  nand2  g158(.a(new_n203_), .b(x15), .O(new_n204_));
  nand2  g159(.a(new_n178_), .b(new_n91_), .O(new_n205_));
  nand3  g160(.a(new_n205_), .b(x25), .c(new_n47_), .O(new_n206_));
  nand4  g161(.a(new_n206_), .b(new_n204_), .c(new_n202_), .d(new_n201_), .O(new_n207_));
  inv1   g162(.a(new_n207_), .O(new_n208_));
  nand3  g163(.a(new_n208_), .b(new_n199_), .c(new_n140_), .O(z18));
endmodule
