...
module FAU ( 
  ...
  nand3  g22(.a(new_n60_), .b(new_n50_), .c(new_n52_), .O(new_n68_));
  ...
  nor2   g58(.a(x20), .b(new_n56_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n96_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n47_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n101_), .O(z13));
  ...
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n101_), .O(z14));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n53_), .O(new_n115_));
  nor2   g70(.a(new_n115_), .b(new_n102_), .O(new_n116_));
  aoi21  g71(.a(new_n110_), .b(x22), .c(new_n116_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n101_), .c(new_n47_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  nor2   g74(.a(new_n116_), .b(new_n119_), .O(new_n120_));
  inv1   g75(.a(new_n102_), .O(new_n121_));
  nand4  g76(.a(new_n109_), .b(new_n121_), .c(new_n119_), .d(new_n84_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n120_), .c(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n101_), .O(z16));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n114_), .c(new_n104_), .d(new_n96_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  aoi21  g83(.a(new_n122_), .b(x24), .c(new_n128_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(x15), .c(new_n101_), .O(z17));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n114_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n105_), .c(new_n47_), .O(new_n133_));
  aoi21  g88(.a(new_n127_), .b(x25), .c(new_n133_), .O(new_n134_));
  oai21  g89(.a(new_n134_), .b(x15), .c(new_n101_), .O(z18));
endmodule
