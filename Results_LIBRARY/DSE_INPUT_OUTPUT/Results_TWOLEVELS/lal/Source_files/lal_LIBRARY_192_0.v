...
module FAU ( 
  ...
  nand4  g067(.a(new_n50_), .b(x05), .c(x04), .d(x03), .O(new_n113_));
  aoi21  g068(.a(new_n113_), .b(x03), .c(x15), .O(z09));
  ...
  nand3  g073(.a(new_n118_), .b(new_n64_), .c(new_n50_), .O(new_n119_));
  aoi21  g074(.a(new_n119_), .b(x03), .c(x15), .O(z11));
  nand3  g075(.a(new_n55_), .b(x18), .c(x17), .O(new_n121_));
  oai21  g076(.a(new_n99_), .b(new_n55_), .c(new_n121_), .O(new_n122_));
  nand3  g077(.a(new_n122_), .b(new_n64_), .c(new_n50_), .O(new_n123_));
  aoi21  g078(.a(new_n123_), .b(x03), .c(x15), .O(z12));
  ...
  nand3  g082(.a(new_n63_), .b(new_n69_), .c(new_n50_), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n127_), .c(new_n125_), .d(new_n50_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(x03), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n69_), .O(z13));
  nand2  g086(.a(new_n128_), .b(new_n50_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(x03), .O(new_n133_));
  nor2   g088(.a(x21), .b(x20), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n99_), .c(x19), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n69_), .c(x03), .O(new_n136_));
  ...
  nand3  g095(.a(new_n140_), .b(new_n101_), .c(new_n53_), .O(new_n141_));
  and2   g096(.a(new_n141_), .b(new_n48_), .O(new_n142_));
  nand4  g097(.a(new_n142_), .b(new_n139_), .c(new_n133_), .d(new_n69_), .O(z15));
  nand4  g098(.a(new_n134_), .b(new_n140_), .c(new_n108_), .d(new_n59_), .O(new_n144_));
  nand3  g099(.a(new_n144_), .b(new_n69_), .c(x03), .O(new_n145_));
  aoi21  g100(.a(new_n141_), .b(x23), .c(new_n145_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n133_), .O(z16));
  nand3  g102(.a(new_n102_), .b(new_n59_), .c(new_n58_), .O(new_n148_));
  ...
  nand2  g107(.a(new_n152_), .b(x03), .O(new_n153_));
  nand2  g108(.a(new_n153_), .b(new_n69_), .O(z17));
  ...
  nand4  g112(.a(new_n157_), .b(new_n155_), .c(new_n128_), .d(new_n50_), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(x03), .O(new_n159_));
  nand2  g114(.a(new_n159_), .b(new_n69_), .O(z18));
endmodule
