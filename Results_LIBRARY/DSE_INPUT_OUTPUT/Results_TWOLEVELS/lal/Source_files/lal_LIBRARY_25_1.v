...
module FAU ( 
  ...
  aoi21  g58(.a(new_n103_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n47_), .c(x07), .O(z11));
  nand3  g62(.a(new_n56_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g63(.a(new_n92_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n102_), .c(new_n47_), .d(new_n51_), .O(new_n110_));
  ...
  nand3  g72(.a(new_n117_), .b(new_n92_), .c(x19), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n61_), .O(new_n119_));
  aoi21  g74(.a(new_n112_), .b(x21), .c(new_n119_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(x15), .c(new_n51_), .O(z14));
  inv1   g76(.a(new_n114_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n94_), .c(new_n53_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n61_), .O(new_n124_));
  aoi21  g79(.a(new_n118_), .b(x22), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(x15), .c(new_n51_), .O(z15));
  or2    g81(.a(new_n113_), .b(x07), .O(new_n127_));
  nand2  g82(.a(new_n123_), .b(x23), .O(new_n128_));
  nor2   g83(.a(x23), .b(x22), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n117_), .c(new_n122_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n127_), .d(new_n51_), .O(z16));
  nand3  g86(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n132_));
  ...
  nand2  g91(.a(new_n96_), .b(x25), .O(new_n137_));
  nor3   g92(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n127_), .d(new_n51_), .O(z18));
endmodule
