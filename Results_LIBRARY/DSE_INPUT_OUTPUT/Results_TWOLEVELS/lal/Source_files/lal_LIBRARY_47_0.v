...
module FAU ( 
  ...
  inv1   g03(.a(x15), .O(new_n49_));
  inv1   g04(.a(x21), .O(new_n50_));
  oai21  g05(.a(new_n50_), .b(x07), .c(new_n49_), .O(new_n51_));
  nand3  g06(.a(new_n51_), .b(x05), .c(x04), .O(new_n52_));
  inv1   g07(.a(new_n47_), .O(new_n53_));
  inv1   g08(.a(x07), .O(new_n54_));
  oai21  g09(.a(x25), .b(x24), .c(new_n54_), .O(new_n55_));
  nand2  g10(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  ...
  oai21  g21(.a(new_n65_), .b(new_n50_), .c(new_n66_), .O(new_n67_));
  nand3  g22(.a(new_n67_), .b(new_n58_), .c(new_n57_), .O(new_n68_));
  nand3  g23(.a(new_n68_), .b(new_n56_), .c(new_n52_), .O(z01));
  inv1   g24(.a(x16), .O(new_n70_));
  nor2   g25(.a(new_n47_), .b(new_n70_), .O(z02));
  nand2  g26(.a(new_n57_), .b(new_n50_), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(x24), .c(new_n49_), .O(new_n73_));
  oai21  g28(.a(new_n65_), .b(x23), .c(x24), .O(new_n74_));
  aoi21  g29(.a(new_n74_), .b(x21), .c(new_n73_), .O(new_n75_));
  oai21  g30(.a(new_n75_), .b(x25), .c(new_n53_), .O(z03));
  ...
  nand2  g37(.a(new_n82_), .b(new_n53_), .O(z04));
  nor3   g38(.a(new_n47_), .b(x13), .c(x08), .O(z05));
  nand2  g39(.a(x14), .b(new_n46_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n53_), .O(z06));
  ...
  nor4   g47(.a(new_n92_), .b(new_n50_), .c(x15), .d(x07), .O(z09));
  nand3  g48(.a(new_n92_), .b(new_n61_), .c(new_n54_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(x21), .c(x15), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n92_), .c(x21), .d(new_n49_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z11));
  oai21  g53(.a(new_n62_), .b(new_n61_), .c(x19), .O(new_n99_));
  nand2  g54(.a(new_n63_), .b(x18), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n61_), .c(new_n99_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n92_), .c(new_n54_), .O(new_n102_));
  ...
  nand3  g61(.a(new_n106_), .b(new_n49_), .c(new_n54_), .O(new_n107_));
  nand4  g62(.a(new_n59_), .b(x19), .c(x18), .d(x17), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n105_), .d(new_n54_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x21), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n49_), .O(z13));
  nand2  g66(.a(x21), .b(new_n62_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n100_), .c(x17), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n92_), .O(new_n114_));
  nand3  g69(.a(x21), .b(x05), .c(x04), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n54_), .c(new_n50_), .O(new_n117_));
  nand2  g72(.a(x21), .b(x07), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n117_), .c(new_n59_), .d(new_n49_), .O(z14));
  nand3  g74(.a(new_n107_), .b(new_n60_), .c(new_n54_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x21), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n49_), .O(z15));
  nand3  g77(.a(new_n107_), .b(new_n57_), .c(new_n54_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(x21), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n49_), .O(z16));
  nand3  g80(.a(new_n107_), .b(new_n88_), .c(new_n54_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(x21), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n49_), .O(z17));
  aoi21  g83(.a(new_n106_), .b(new_n54_), .c(new_n50_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n118_), .c(new_n58_), .d(new_n49_), .O(z18));
endmodule
