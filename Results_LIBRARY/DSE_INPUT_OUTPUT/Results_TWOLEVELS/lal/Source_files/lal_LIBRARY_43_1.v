...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n86_), .c(new_n47_), .d(new_n51_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n51_), .b(x05), .c(x04), .O(new_n100_));
  nand4  g55(.a(new_n57_), .b(x19), .c(x18), .d(x17), .O(new_n101_));
  ...
  oai21  g63(.a(new_n108_), .b(x15), .c(new_n51_), .O(z14));
  ...
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n100_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n51_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  aoi21  g72(.a(new_n112_), .b(new_n111_), .c(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n105_), .b(new_n111_), .c(new_n117_), .d(new_n81_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n100_), .O(new_n120_));
  ...
  nand3  g79(.a(new_n124_), .b(new_n55_), .c(new_n117_), .O(new_n125_));
  or2    g80(.a(new_n125_), .b(new_n101_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n54_), .d(new_n51_), .O(z17));
  oai21  g82(.a(new_n125_), .b(new_n101_), .c(x25), .O(new_n128_));
  nor2   g83(.a(x20), .b(new_n60_), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n124_), .c(new_n129_), .d(new_n93_), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n128_), .c(new_n100_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n51_), .O(z18));
endmodule
