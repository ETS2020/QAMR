...
module FAU ( 
  ...
  nand3  g015(.a(new_n51_), .b(x05), .c(x04), .O(new_n61_));
  inv1   g016(.a(new_n61_), .O(new_n62_));
  aoi21  g017(.a(new_n60_), .b(new_n52_), .c(new_n62_), .O(new_n63_));
  oai21  g018(.a(new_n63_), .b(x15), .c(new_n51_), .O(z01));
  inv1   g019(.a(x16), .O(new_n65_));
  nand2  g020(.a(new_n49_), .b(new_n65_), .O(z02));
  nand2  g021(.a(new_n60_), .b(new_n52_), .O(new_n67_));
  ...
  nand4  g053(.a(new_n98_), .b(new_n86_), .c(new_n85_), .d(new_n83_), .O(z08));
  nand4  g054(.a(new_n47_), .b(new_n51_), .c(x05), .d(x04), .O(new_n100_));
  inv1   g055(.a(new_n100_), .O(z09));
  nand2  g056(.a(x05), .b(x04), .O(new_n102_));
  nand2  g057(.a(new_n102_), .b(new_n54_), .O(new_n103_));
  aoi21  g058(.a(new_n103_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g059(.a(x18), .b(x17), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(new_n47_), .c(x07), .O(z11));
  nand3  g062(.a(new_n56_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g063(.a(new_n92_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n102_), .c(new_n47_), .d(new_n51_), .O(new_n110_));
  ...
  nand3  g069(.a(new_n114_), .b(new_n112_), .c(new_n61_), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n51_), .O(z13));
  aoi21  g072(.a(x05), .b(x04), .c(x15), .O(new_n118_));
  or2    g073(.a(new_n118_), .b(x07), .O(new_n119_));
  nand2  g074(.a(new_n112_), .b(x21), .O(new_n120_));
  nor2   g075(.a(x21), .b(x20), .O(new_n121_));
  nand3  g076(.a(new_n121_), .b(new_n92_), .c(x19), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n120_), .c(new_n119_), .d(new_n51_), .O(z14));
  nand2  g078(.a(new_n122_), .b(x22), .O(new_n124_));
  nand2  g079(.a(new_n94_), .b(new_n53_), .O(new_n125_));
  nor2   g080(.a(new_n125_), .b(new_n113_), .O(new_n126_));
  nor2   g081(.a(new_n126_), .b(new_n62_), .O(new_n127_));
  nand2  g082(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n51_), .O(z15));
  inv1   g085(.a(x23), .O(new_n131_));
  nor2   g086(.a(new_n126_), .b(new_n131_), .O(new_n132_));
  inv1   g087(.a(new_n113_), .O(new_n133_));
  nand4  g088(.a(new_n121_), .b(new_n133_), .c(new_n131_), .d(new_n87_), .O(new_n134_));
  ...
  nand3  g092(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n138_));
  nor2   g093(.a(new_n138_), .b(x20), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(x19), .c(x18), .d(x17), .O(new_n140_));
  aoi21  g095(.a(new_n134_), .b(x24), .c(x07), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n140_), .c(new_n119_), .O(z17));
  nand2  g097(.a(new_n96_), .b(x25), .O(new_n143_));
  nor3   g098(.a(x25), .b(x24), .c(x23), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n143_), .c(new_n119_), .d(new_n51_), .O(z18));
endmodule
