...
module FAU ( 
  ...
  nand3  g35(.a(new_n50_), .b(x14), .c(new_n70_), .O(new_n81_));
  ...
  aoi21  g75(.a(new_n113_), .b(x22), .c(new_n120_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(x15), .c(new_n104_), .O(z15));
  nand2  g77(.a(new_n119_), .b(x23), .O(new_n123_));
  inv1   g78(.a(x23), .O(new_n124_));
  nand4  g79(.a(new_n112_), .b(new_n117_), .c(new_n124_), .d(new_n85_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n104_), .d(new_n47_), .O(z16));
  nand2  g81(.a(x24), .b(x23), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n102_), .c(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  and2   g84(.a(new_n119_), .b(x24), .O(new_n130_));
  nand3  g85(.a(new_n118_), .b(new_n84_), .c(new_n124_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n108_), .c(new_n47_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n130_), .c(new_n48_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n129_), .O(z17));
  oai21  g89(.a(new_n131_), .b(new_n108_), .c(x25), .O(new_n135_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n118_), .c(new_n107_), .d(new_n97_), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n135_), .c(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n48_), .O(new_n139_));
  nand2  g94(.a(new_n139_), .b(new_n104_), .O(z18));
endmodule
