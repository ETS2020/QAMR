...
module FAU ( 
  ...
  nand4  g020(.a(new_n65_), .b(new_n63_), .c(new_n49_), .d(new_n51_), .O(z01));
  inv1   g021(.a(x16), .O(new_n67_));
  nor2   g022(.a(new_n48_), .b(new_n67_), .O(z02));
  nand2  g023(.a(new_n63_), .b(new_n49_), .O(z03));
  ...
  nand4  g055(.a(new_n100_), .b(new_n95_), .c(new_n52_), .d(new_n60_), .O(new_n101_));
  ...
  nand3  g060(.a(new_n58_), .b(x22), .c(x21), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(new_n105_), .c(new_n52_), .O(new_n107_));
  oai21  g062(.a(new_n107_), .b(x25), .c(x15), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n104_), .O(z08));
  nand4  g064(.a(new_n51_), .b(x05), .c(x04), .d(new_n47_), .O(new_n110_));
  aoi21  g065(.a(new_n110_), .b(new_n47_), .c(x15), .O(z09));
  inv1   g066(.a(x15), .O(new_n112_));
  nand4  g067(.a(new_n65_), .b(new_n87_), .c(new_n112_), .d(new_n51_), .O(new_n113_));
  nor2   g068(.a(new_n113_), .b(x02), .O(z10));
  xor2a  g069(.a(x18), .b(x17), .O(new_n115_));
  nand3  g070(.a(new_n115_), .b(new_n65_), .c(new_n51_), .O(new_n116_));
  aoi21  g071(.a(new_n116_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g072(.a(new_n56_), .b(x18), .c(x17), .O(new_n118_));
  oai21  g073(.a(new_n96_), .b(new_n56_), .c(new_n118_), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n65_), .c(new_n112_), .d(new_n51_), .O(new_n120_));
  nor2   g075(.a(new_n120_), .b(x02), .O(z12));
  nand3  g076(.a(new_n64_), .b(new_n112_), .c(new_n51_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n51_), .O(new_n123_));
  ...
  nand2  g081(.a(new_n97_), .b(new_n96_), .O(new_n127_));
  inv1   g082(.a(new_n127_), .O(new_n128_));
  nor2   g083(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand4  g084(.a(new_n129_), .b(new_n126_), .c(new_n124_), .d(new_n112_), .O(z13));
  nor2   g085(.a(new_n128_), .b(new_n59_), .O(new_n131_));
  nand4  g086(.a(new_n96_), .b(new_n59_), .c(new_n54_), .d(x19), .O(new_n132_));
  nand3  g087(.a(new_n132_), .b(new_n122_), .c(new_n51_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n131_), .c(new_n47_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n112_), .O(z14));
  inv1   g090(.a(new_n125_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n98_), .c(new_n54_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n122_), .c(new_n51_), .O(new_n138_));
  aoi21  g093(.a(new_n132_), .b(x22), .c(new_n138_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(x02), .c(new_n112_), .O(z15));
  nand2  g095(.a(new_n137_), .b(x23), .O(new_n141_));
  nand4  g096(.a(new_n105_), .b(new_n60_), .c(new_n59_), .d(new_n54_), .O(new_n142_));
  inv1   g097(.a(new_n142_), .O(new_n143_));
  aoi21  g098(.a(new_n143_), .b(new_n136_), .c(new_n48_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n141_), .c(new_n124_), .d(new_n112_), .O(z16));
  inv1   g100(.a(z09), .O(new_n146_));
  nand3  g101(.a(new_n99_), .b(new_n60_), .c(new_n59_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(x20), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(x19), .c(x18), .d(x17), .O(new_n149_));
  aoi21  g104(.a(x24), .b(x23), .c(x07), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n47_), .O(new_n152_));
  aoi21  g107(.a(new_n137_), .b(x24), .c(x15), .O(new_n153_));
  nand3  g108(.a(new_n153_), .b(new_n152_), .c(new_n146_), .O(z17));
  nand2  g109(.a(new_n100_), .b(x25), .O(new_n155_));
  nor3   g110(.a(x25), .b(x24), .c(x23), .O(new_n156_));
  nand3  g111(.a(new_n156_), .b(new_n98_), .c(new_n128_), .O(new_n157_));
  nand4  g112(.a(new_n157_), .b(new_n155_), .c(new_n122_), .d(new_n51_), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(new_n47_), .O(new_n159_));
  nand2  g114(.a(new_n159_), .b(new_n112_), .O(z18));
endmodule
