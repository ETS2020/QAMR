...
module FAU ( 
  ...
  aoi21  g79(.a(new_n124_), .b(new_n123_), .c(x15), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n117_), .O(z15));
  inv1   g81(.a(x23), .O(new_n127_));
  aoi21  g82(.a(new_n124_), .b(new_n123_), .c(new_n127_), .O(new_n128_));
  nand3  g83(.a(new_n51_), .b(x05), .c(x04), .O(new_n129_));
  nand4  g84(.a(new_n119_), .b(new_n123_), .c(new_n127_), .d(new_n88_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  oai21  g86(.a(new_n131_), .b(new_n128_), .c(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n51_), .O(z16));
