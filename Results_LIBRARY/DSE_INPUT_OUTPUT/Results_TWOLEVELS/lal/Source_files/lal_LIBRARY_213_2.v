...
module FAU ( 
  ...
  nand3  g087(.a(new_n132_), .b(new_n94_), .c(x19), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n131_), .c(new_n130_), .d(new_n51_), .O(z14));
  nand2  g089(.a(new_n133_), .b(x22), .O(new_n135_));
  inv1   g090(.a(new_n123_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n96_), .c(new_n56_), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n135_), .c(new_n130_), .d(new_n51_), .O(z15));
  nand2  g093(.a(new_n137_), .b(x23), .O(new_n139_));
  nand4  g094(.a(new_n132_), .b(new_n136_), .c(new_n55_), .d(new_n89_), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n139_), .c(new_n130_), .d(new_n51_), .O(z16));
  nand3  g096(.a(new_n97_), .b(new_n89_), .c(new_n91_), .O(new_n142_));
  ...
  nand3  g100(.a(new_n145_), .b(new_n144_), .c(new_n125_), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n47_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n51_), .O(z17));
  nor3   g103(.a(x25), .b(x24), .c(x23), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n96_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n122_), .c(new_n125_), .O(new_n151_));
  aoi21  g106(.a(new_n98_), .b(x25), .c(new_n151_), .O(new_n152_));
  oai21  g107(.a(new_n152_), .b(x07), .c(new_n51_), .O(z18));
endmodule
