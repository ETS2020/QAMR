...
module FAU ( 
  ...
  nand4  g082(.a(new_n93_), .b(new_n90_), .c(new_n54_), .d(x19), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  aoi21  g084(.a(new_n122_), .b(x21), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x15), .c(new_n121_), .O(z14));
  ...
  and2   g090(.a(new_n134_), .b(x23), .O(new_n136_));
  nand4  g091(.a(new_n103_), .b(new_n88_), .c(new_n90_), .d(new_n54_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n123_), .c(new_n47_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n136_), .c(new_n48_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n121_), .O(z16));
  nor2   g095(.a(new_n89_), .b(new_n103_), .O(new_n141_));
  nand4  g096(.a(new_n96_), .b(new_n53_), .c(new_n89_), .d(new_n103_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(new_n122_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(new_n141_), .c(new_n48_), .O(new_n144_));
  nand4  g099(.a(new_n96_), .b(x25), .c(new_n89_), .d(new_n103_), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n122_), .c(new_n48_), .O(new_n146_));
  nor2   g101(.a(new_n146_), .b(new_n62_), .O(new_n147_));
  nand2  g102(.a(new_n134_), .b(x24), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(new_n147_), .c(new_n144_), .d(new_n47_), .O(z17));
  oai21  g104(.a(new_n143_), .b(x07), .c(new_n48_), .O(new_n150_));
  aoi21  g105(.a(new_n98_), .b(x25), .c(new_n120_), .O(new_n151_));
