...
module FAU ( 
  ...
  inv1   g21(.a(z09), .O(z15));
  nand3  g22(.a(new_n57_), .b(z15), .c(new_n49_), .O(new_n68_));
  ...
  nand2  g45(.a(new_n61_), .b(new_n60_), .O(z14));
  nand2  g46(.a(new_n61_), .b(new_n60_), .O(z16));
  nand2  g47(.a(new_n61_), .b(new_n60_), .O(z17));
  nand2  g48(.a(new_n61_), .b(new_n60_), .O(z18));
endmodule
