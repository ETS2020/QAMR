...
module FAU ( 
  ...
  nand3  g20(.a(new_n60_), .b(z14), .c(new_n52_), .O(new_n66_));
  ...
  nand2  g40(.a(new_n87_), .b(new_n51_), .O(z13));
  zero   g41(.O(z09));
  zero   g42(.O(z12));
  nor2   g43(.a(x15), .b(x07), .O(z11));
  inv1   g44(.a(z10), .O(z15));
  nand2  g45(.a(new_n87_), .b(new_n51_), .O(z16));
  nand2  g46(.a(new_n87_), .b(new_n51_), .O(z17));
  nand2  g47(.a(new_n87_), .b(new_n51_), .O(z18));
endmodule
