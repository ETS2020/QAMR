...
module FAU ( 
  ...
  oai21  g027(.a(x23), .b(x21), .c(x24), .O(new_n73_));
  nand2  g028(.a(new_n73_), .b(new_n47_), .O(new_n74_));
  oai21  g029(.a(new_n66_), .b(x23), .c(x24), .O(new_n75_));
  nand2  g030(.a(new_n75_), .b(x21), .O(new_n76_));
  aoi21  g031(.a(new_n76_), .b(new_n74_), .c(x25), .O(z03));
  ...
  nand3  g075(.a(new_n112_), .b(new_n60_), .c(x19), .O(new_n121_));
  nand4  g076(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n47_), .O(z13));
  nor2   g077(.a(x21), .b(x20), .O(new_n123_));
  nand3  g078(.a(new_n123_), .b(new_n112_), .c(x19), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n117_), .c(new_n52_), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g081(.a(x17), .b(new_n47_), .O(new_n127_));
  nand3  g082(.a(new_n60_), .b(x19), .c(x18), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(new_n127_), .c(x21), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n126_), .O(z14));
  nand2  g085(.a(new_n124_), .b(x22), .O(new_n131_));
  nand3  g086(.a(new_n97_), .b(new_n96_), .c(new_n60_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n131_), .c(new_n119_), .d(new_n47_), .O(z15));
  oai21  g088(.a(x23), .b(x15), .c(x21), .O(new_n134_));
  nand3  g089(.a(new_n61_), .b(new_n60_), .c(x19), .O(new_n135_));
  inv1   g090(.a(new_n135_), .O(new_n136_));
  aoi21  g091(.a(new_n136_), .b(new_n112_), .c(new_n58_), .O(new_n137_));
  nand4  g092(.a(new_n123_), .b(new_n96_), .c(new_n58_), .d(new_n61_), .O(new_n138_));
  nand3  g093(.a(new_n138_), .b(new_n117_), .c(new_n52_), .O(new_n139_));
  oai21  g094(.a(new_n139_), .b(new_n137_), .c(new_n47_), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n134_), .O(z16));
  nand3  g096(.a(new_n98_), .b(new_n61_), .c(new_n51_), .O(new_n142_));
  ...
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n119_), .d(new_n47_), .O(z17));
  nand2  g101(.a(x25), .b(x21), .O(new_n147_));
  nand3  g102(.a(new_n112_), .b(new_n51_), .c(x19), .O(new_n148_));
  inv1   g103(.a(x24), .O(new_n149_));
  nand4  g104(.a(new_n59_), .b(new_n149_), .c(new_n58_), .d(new_n61_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(new_n148_), .c(new_n147_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n60_), .O(new_n152_));
  nand3  g107(.a(new_n98_), .b(new_n61_), .c(new_n60_), .O(new_n153_));
  oai21  g108(.a(new_n153_), .b(new_n95_), .c(x25), .O(new_n154_));
  nand4  g109(.a(new_n154_), .b(new_n152_), .c(new_n119_), .d(new_n47_), .O(z18));
endmodule
