...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n60_), .c(new_n87_), .d(new_n47_), .O(new_n91_));
  ...
  nand2  g50(.a(new_n95_), .b(new_n60_), .O(new_n96_));
  ...
  nor2   g55(.a(x07), .b(new_n100_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(x04), .c(x15), .O(new_n102_));
  nand3  g57(.a(new_n93_), .b(new_n52_), .c(x19), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n99_), .d(new_n49_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n102_), .d(new_n49_), .O(z14));
  ...
  nor2   g67(.a(new_n112_), .b(new_n48_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n109_), .c(new_n102_), .O(z15));
  inv1   g69(.a(x23), .O(new_n115_));
  nor2   g70(.a(new_n112_), .b(new_n115_), .O(new_n116_));
  inv1   g71(.a(new_n98_), .O(new_n117_));
  ...
  nand2  g75(.a(new_n120_), .b(new_n87_), .O(z16));
  ...
  nand3  g81(.a(new_n126_), .b(new_n122_), .c(new_n60_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n87_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n102_), .d(new_n49_), .O(z18));
endmodule
