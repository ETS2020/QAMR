...
module FAU ( 
  ...
  nand4  g51(.a(new_n96_), .b(new_n64_), .c(new_n48_), .d(new_n47_), .O(new_n97_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n99_), .d(new_n47_), .O(z14));
  ...
  oai21  g70(.a(new_n115_), .b(x15), .c(new_n100_), .O(z15));
  nand2  g71(.a(new_n113_), .b(x23), .O(new_n117_));
  inv1   g72(.a(x23), .O(new_n118_));
  nand3  g73(.a(new_n108_), .b(new_n118_), .c(new_n82_), .O(new_n119_));
  ...
  nand4  g80(.a(new_n125_), .b(new_n112_), .c(new_n124_), .d(new_n94_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n47_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n100_), .O(z17));
  nand2  g84(.a(new_n125_), .b(new_n112_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n103_), .c(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n112_), .c(new_n124_), .d(new_n94_), .O(new_n133_));
