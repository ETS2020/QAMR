...
module FAU ( 
  ...
  nand3  g17(.a(new_n47_), .b(x05), .c(x04), .O(new_n63_));
  ...
  nand3  g27(.a(new_n72_), .b(new_n50_), .c(new_n67_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(z04));
  oai21  g29(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  nand2  g30(.a(x14), .b(new_n67_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n50_), .O(z06));
  nand3  g32(.a(new_n50_), .b(new_n67_), .c(x06), .O(z07));
  nand2  g33(.a(new_n57_), .b(new_n56_), .O(new_n79_));
  nand3  g34(.a(x24), .b(x22), .c(x21), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(new_n79_), .c(new_n53_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n55_), .O(new_n82_));
  nand2  g37(.a(new_n80_), .b(new_n53_), .O(new_n83_));
  ...
  aoi21  g51(.a(new_n96_), .b(x25), .c(new_n49_), .O(new_n97_));
  ...
  nand3  g55(.a(new_n100_), .b(new_n48_), .c(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n50_), .O(z09));
  nand4  g57(.a(new_n99_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n50_), .O(z10));
  xor2a  g59(.a(x18), .b(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n99_), .c(new_n48_), .d(new_n47_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(z11));
  nand3  g62(.a(new_n57_), .b(x18), .c(x17), .O(new_n108_));
  oai21  g63(.a(new_n91_), .b(new_n57_), .c(new_n108_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n99_), .c(new_n48_), .d(new_n47_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(z12));
  nand2  g66(.a(new_n92_), .b(new_n91_), .O(new_n112_));
  oai21  g67(.a(new_n100_), .b(x15), .c(new_n47_), .O(new_n113_));
  nand3  g68(.a(x19), .b(x18), .c(x17), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x20), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n47_), .O(z13));
  ...
  inv1   g76(.a(new_n114_), .O(new_n122_));
  nor3   g77(.a(x22), .b(x21), .c(x20), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n113_), .d(new_n47_), .O(z15));
  inv1   g80(.a(x23), .O(new_n126_));
  aoi21  g81(.a(new_n123_), .b(new_n122_), .c(new_n126_), .O(new_n127_));
  nand4  g82(.a(new_n118_), .b(new_n122_), .c(new_n126_), .d(new_n86_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n127_), .c(new_n48_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n113_), .O(z16));
  nand3  g86(.a(new_n94_), .b(new_n86_), .c(new_n88_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(x20), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(x19), .c(x18), .d(x17), .O(new_n134_));
  nand2  g89(.a(new_n128_), .b(x24), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n113_), .d(new_n47_), .O(z17));
  nand2  g91(.a(new_n95_), .b(x25), .O(new_n137_));
  nor3   g92(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n137_), .c(new_n113_), .d(new_n47_), .O(z18));
endmodule
