...
module FAU ( 
  ...
  nand4  g063(.a(new_n108_), .b(new_n88_), .c(new_n48_), .d(new_n70_), .O(new_n109_));
  ...
  nand4  g070(.a(new_n115_), .b(new_n108_), .c(new_n48_), .d(new_n70_), .O(new_n116_));
  inv1   g071(.a(new_n116_), .O(z12));
  oai21  g072(.a(new_n72_), .b(new_n71_), .c(new_n48_), .O(new_n118_));
  ...
  nand3  g076(.a(new_n53_), .b(new_n65_), .c(x07), .O(new_n122_));
  aoi21  g077(.a(new_n122_), .b(new_n121_), .c(new_n88_), .O(new_n123_));
  nand4  g078(.a(new_n57_), .b(new_n53_), .c(new_n65_), .d(x07), .O(new_n124_));
  ...
  nand4  g089(.a(new_n59_), .b(x19), .c(x18), .d(new_n48_), .O(new_n135_));
  aoi21  g090(.a(new_n135_), .b(new_n122_), .c(new_n88_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n125_), .c(new_n54_), .O(new_n137_));
  nand4  g092(.a(new_n58_), .b(x24), .c(x22), .d(x07), .O(new_n138_));
  nand2  g093(.a(new_n97_), .b(new_n96_), .O(new_n139_));
  ...
  nand4  g099(.a(new_n144_), .b(new_n142_), .c(new_n137_), .d(new_n74_), .O(z14));
  inv1   g100(.a(new_n96_), .O(new_n146_));
  nand3  g101(.a(new_n60_), .b(new_n54_), .c(x19), .O(new_n147_));
  oai21  g102(.a(new_n147_), .b(new_n146_), .c(new_n122_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n59_), .O(new_n149_));
  nand4  g104(.a(new_n53_), .b(x24), .c(new_n65_), .d(x22), .O(new_n150_));
  nor2   g105(.a(x21), .b(x20), .O(new_n151_));
  nand3  g106(.a(new_n151_), .b(new_n96_), .c(x19), .O(new_n152_));
  aoi22  g107(.a(new_n152_), .b(x22), .c(new_n150_), .d(x07), .O(new_n153_));
  nand3  g108(.a(new_n153_), .b(new_n149_), .c(new_n119_), .O(z15));
  nand2  g109(.a(x18), .b(new_n48_), .O(new_n155_));
  nand2  g110(.a(new_n98_), .b(x19), .O(new_n156_));
  oai22  g111(.a(new_n156_), .b(new_n155_), .c(x25), .d(new_n70_), .O(new_n157_));
  nand2  g112(.a(new_n157_), .b(x17), .O(new_n158_));
  nand3  g113(.a(new_n57_), .b(new_n53_), .c(x07), .O(new_n159_));
  aoi21  g114(.a(new_n159_), .b(new_n158_), .c(x20), .O(new_n160_));
  nand3  g115(.a(new_n129_), .b(new_n53_), .c(x07), .O(new_n161_));
  inv1   g116(.a(new_n161_), .O(new_n162_));
  oai21  g117(.a(new_n162_), .b(new_n160_), .c(new_n65_), .O(new_n163_));
  nor2   g118(.a(new_n65_), .b(x15), .O(new_n164_));
  oai21  g119(.a(new_n164_), .b(new_n127_), .c(new_n88_), .O(new_n165_));
  ...
  aoi21  g125(.a(new_n120_), .b(new_n98_), .c(new_n65_), .O(new_n171_));
  nand3  g126(.a(new_n70_), .b(x05), .c(x04), .O(new_n172_));
  inv1   g127(.a(new_n172_), .O(new_n173_));
  oai21  g128(.a(new_n173_), .b(new_n171_), .c(new_n48_), .O(new_n174_));
  ...
  nand4  g132(.a(new_n61_), .b(new_n56_), .c(new_n55_), .d(x07), .O(new_n178_));
  aoi21  g133(.a(new_n178_), .b(x15), .c(x17), .O(new_n179_));
  nand2  g134(.a(new_n97_), .b(x18), .O(new_n180_));
  nand3  g135(.a(new_n65_), .b(new_n60_), .c(new_n59_), .O(new_n181_));
  oai21  g136(.a(new_n181_), .b(new_n180_), .c(new_n48_), .O(new_n182_));
  oai21  g137(.a(new_n131_), .b(new_n70_), .c(new_n182_), .O(new_n183_));
  oai21  g138(.a(new_n183_), .b(new_n179_), .c(x24), .O(new_n184_));
  nand3  g139(.a(new_n120_), .b(x17), .c(new_n48_), .O(new_n185_));
  nand3  g140(.a(new_n151_), .b(new_n99_), .c(new_n60_), .O(new_n186_));
  oai21  g141(.a(new_n186_), .b(new_n185_), .c(new_n70_), .O(new_n187_));
  nand2  g142(.a(new_n187_), .b(x25), .O(new_n188_));
  nand4  g143(.a(new_n98_), .b(new_n53_), .c(new_n66_), .d(new_n65_), .O(new_n189_));
  oai21  g144(.a(new_n189_), .b(new_n139_), .c(new_n172_), .O(new_n190_));
  nand2  g145(.a(new_n190_), .b(new_n48_), .O(new_n191_));
  nand3  g146(.a(new_n63_), .b(new_n53_), .c(x07), .O(new_n192_));
  nand4  g147(.a(new_n192_), .b(new_n191_), .c(new_n188_), .d(new_n184_), .O(z17));
  nand3  g148(.a(x19), .b(x18), .c(new_n48_), .O(new_n194_));
  nand3  g149(.a(new_n66_), .b(new_n60_), .c(new_n59_), .O(new_n195_));
  oai21  g150(.a(new_n195_), .b(new_n194_), .c(new_n70_), .O(new_n196_));
  aoi21  g151(.a(new_n56_), .b(new_n55_), .c(new_n70_), .O(new_n197_));
  aoi21  g152(.a(new_n196_), .b(x17), .c(new_n197_), .O(new_n198_));
  nand2  g153(.a(new_n129_), .b(x07), .O(new_n199_));
  oai21  g154(.a(new_n198_), .b(x20), .c(new_n199_), .O(new_n200_));
  nor2   g155(.a(x24), .b(new_n70_), .O(new_n201_));
  aoi21  g156(.a(new_n200_), .b(new_n65_), .c(new_n201_), .O(new_n202_));
  nor2   g157(.a(new_n53_), .b(x15), .O(new_n203_));
  oai21  g158(.a(new_n203_), .b(new_n127_), .c(new_n88_), .O(new_n204_));
  oai21  g159(.a(new_n203_), .b(new_n167_), .c(x20), .O(new_n205_));
  oai21  g160(.a(new_n66_), .b(new_n65_), .c(new_n53_), .O(new_n206_));
  nand2  g161(.a(new_n206_), .b(x07), .O(new_n207_));
  nand2  g162(.a(new_n99_), .b(new_n60_), .O(new_n208_));
  oai21  g163(.a(new_n208_), .b(new_n95_), .c(x25), .O(new_n209_));
  nand2  g164(.a(new_n209_), .b(new_n172_), .O(new_n210_));
