...
module FAU ( 
  ...
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n99_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n107_), .b(new_n110_), .c(new_n117_), .d(new_n82_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n99_), .d(new_n47_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n102_), .O(new_n121_));
  nand3  g76(.a(new_n111_), .b(new_n81_), .c(new_n117_), .O(new_n122_));
  ...
  nand2  g81(.a(new_n126_), .b(new_n99_), .O(z17));
