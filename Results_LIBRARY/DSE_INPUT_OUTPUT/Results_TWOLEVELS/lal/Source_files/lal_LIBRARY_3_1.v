...
module FAU ( 
  ...
  nor2   g03(.a(new_n48_), .b(x04), .O(new_n49_));
  ...
  nor3   g20(.a(new_n65_), .b(new_n49_), .c(x07), .O(new_n66_));
  ...
  nand3  g40(.a(new_n65_), .b(new_n48_), .c(new_n85_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n64_), .b(new_n56_), .c(new_n48_), .d(new_n85_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n64_), .c(new_n48_), .d(new_n85_), .O(new_n91_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n64_), .c(new_n48_), .d(new_n85_), .O(new_n96_));
  ...
  nor2   g57(.a(new_n102_), .b(new_n49_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n100_), .c(new_n98_), .d(new_n85_), .O(z13));
  inv1   g59(.a(x05), .O(new_n105_));
  oai21  g60(.a(x07), .b(new_n105_), .c(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x04), .O(new_n107_));
  ...
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(new_n49_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n98_), .d(new_n85_), .O(z15));
  inv1   g73(.a(x23), .O(new_n119_));
  aoi21  g74(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n109_), .b(new_n115_), .c(new_n119_), .d(new_n80_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n85_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n107_), .O(z16));
  nand2  g79(.a(new_n121_), .b(x24), .O(new_n125_));
  nor2   g80(.a(x22), .b(x21), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n53_), .c(new_n119_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  aoi21  g83(.a(new_n128_), .b(new_n102_), .c(new_n49_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n125_), .c(new_n98_), .d(new_n85_), .O(z17));
  ...
  nand4  g88(.a(new_n133_), .b(new_n126_), .c(new_n132_), .d(new_n93_), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n131_), .c(new_n85_), .O(new_n135_));
