...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_,
    ...
    new_n62_, new_n63_, new_n64_, new_n66_, new_n70_, new_n71_, new_n72_,
  ...
  nor3   g31(.a(z10), .b(x13), .c(x08), .O(z05));
  ...
  nor2   g38(.a(z10), .b(x25), .O(new_n84_));
  ...
  nand2  g46(.a(new_n62_), .b(new_n61_), .O(z17));
  nand2  g47(.a(new_n62_), .b(new_n61_), .O(z18));
endmodule
