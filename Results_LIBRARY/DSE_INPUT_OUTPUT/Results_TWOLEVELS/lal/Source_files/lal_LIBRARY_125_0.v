...
module FAU ( 
  ...
  nor2   g23(.a(z10), .b(new_n68_), .O(z02));
  ...
  aoi21  g35(.a(new_n46_), .b(x06), .c(z10), .O(z07));
  ...
  aoi21  g40(.a(new_n86_), .b(new_n82_), .c(z10), .O(z18));
  zero   g41(.O(z09));
  zero   g42(.O(z11));
  ...
  nand3  g46(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z16));
  nand3  g47(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(z17));
endmodule
