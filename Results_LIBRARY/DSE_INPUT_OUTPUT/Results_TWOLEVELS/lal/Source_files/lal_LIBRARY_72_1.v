...
module FAU ( 
  ...
  oai21  g63(.a(new_n92_), .b(new_n55_), .c(new_n108_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n102_), .c(new_n47_), .d(new_n50_), .O(new_n110_));
  ...
  aoi21  g93(.a(new_n131_), .b(x24), .c(x07), .O(new_n139_));
