...
module FAU ( 
  ...
  oai21  g39(.a(new_n61_), .b(x07), .c(new_n47_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n65_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  nand4  g42(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(new_n65_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x07), .O(z10));
  inv1   g44(.a(x07), .O(new_n90_));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n61_), .c(new_n90_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n47_), .c(x15), .O(z11));
  ...
  nand4  g52(.a(new_n97_), .b(new_n61_), .c(new_n47_), .d(new_n65_), .O(new_n98_));
  nor2   g53(.a(new_n98_), .b(x07), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n62_), .b(new_n65_), .c(new_n90_), .O(new_n102_));
  nand4  g57(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n90_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n65_), .O(z13));
  ...
  nand2  g68(.a(new_n113_), .b(new_n65_), .O(z14));
  nand3  g69(.a(new_n107_), .b(new_n52_), .c(x19), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n94_), .c(x22), .O(new_n116_));
  inv1   g71(.a(new_n100_), .O(new_n117_));
  nor2   g72(.a(x22), .b(x21), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n52_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n102_), .d(new_n90_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n65_), .O(z15));
  inv1   g77(.a(x23), .O(new_n123_));
  nand4  g78(.a(new_n110_), .b(new_n117_), .c(new_n123_), .d(new_n80_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n65_), .c(new_n90_), .O(new_n125_));
  aoi21  g80(.a(new_n119_), .b(x23), .c(new_n125_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n86_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  nand4  g83(.a(new_n79_), .b(new_n123_), .c(new_n80_), .d(new_n107_), .O(new_n129_));
  inv1   g84(.a(new_n129_), .O(new_n130_));
  aoi21  g85(.a(new_n130_), .b(new_n108_), .c(x15), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n86_), .d(new_n90_), .O(z17));
  oai21  g87(.a(new_n129_), .b(new_n103_), .c(x25), .O(new_n133_));
  nor2   g88(.a(x20), .b(new_n55_), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n118_), .c(new_n134_), .d(new_n95_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n102_), .d(new_n90_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n47_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n65_), .O(z18));
endmodule
