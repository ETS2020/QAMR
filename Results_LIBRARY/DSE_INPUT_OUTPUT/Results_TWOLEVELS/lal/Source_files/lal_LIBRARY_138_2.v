...
module FAU ( 
  ...
  nand2  g021(.a(new_n62_), .b(new_n49_), .O(z03));
  ...
  nand2  g058(.a(new_n63_), .b(new_n79_), .O(new_n104_));
  aoi21  g059(.a(new_n104_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g060(.a(x15), .O(new_n106_));
  xor2a  g061(.a(x18), .b(x17), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n63_), .c(new_n106_), .d(new_n47_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z11));
  nand3  g064(.a(new_n55_), .b(x18), .c(x17), .O(new_n110_));
  oai21  g065(.a(new_n55_), .b(x17), .c(new_n110_), .O(new_n111_));
  nand2  g066(.a(new_n111_), .b(new_n63_), .O(new_n112_));
  oai21  g067(.a(x07), .b(x05), .c(x04), .O(new_n113_));
  nand3  g068(.a(new_n113_), .b(x19), .c(new_n54_), .O(new_n114_));
  and2   g069(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  aoi21  g070(.a(new_n115_), .b(new_n112_), .c(x15), .O(z12));
  ...
  nand3  g074(.a(new_n106_), .b(x05), .c(x04), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(new_n119_), .c(new_n117_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n106_), .O(z13));
  nor2   g078(.a(x21), .b(x20), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n88_), .c(x19), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n120_), .O(new_n126_));
  aoi21  g081(.a(new_n117_), .b(x21), .c(new_n126_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(x07), .c(new_n106_), .O(z14));
  nand2  g083(.a(new_n125_), .b(x22), .O(new_n129_));
  nand2  g084(.a(new_n90_), .b(new_n53_), .O(new_n130_));
  nor2   g085(.a(new_n130_), .b(new_n118_), .O(new_n131_));
  inv1   g086(.a(new_n131_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n129_), .c(new_n102_), .d(new_n106_), .O(z15));
  nor2   g088(.a(new_n131_), .b(new_n97_), .O(new_n134_));
  inv1   g089(.a(new_n118_), .O(new_n135_));
  nand4  g090(.a(new_n124_), .b(new_n135_), .c(new_n97_), .d(new_n59_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n120_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n134_), .c(new_n47_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n106_), .O(z16));
  nand3  g094(.a(new_n91_), .b(new_n59_), .c(new_n58_), .O(new_n140_));
  ...
  nand3  g098(.a(new_n143_), .b(new_n142_), .c(new_n120_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n47_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n106_), .O(z17));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n90_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n117_), .c(new_n120_), .O(new_n149_));
  aoi21  g104(.a(new_n92_), .b(x25), .c(new_n149_), .O(new_n150_));
  oai21  g105(.a(new_n150_), .b(x07), .c(new_n106_), .O(z18));
endmodule
