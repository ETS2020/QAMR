...
module FAU ( 
  ...
  nand3  g14(.a(new_n59_), .b(x21), .c(new_n55_), .O(new_n60_));
  ...
  nand3  g20(.a(new_n65_), .b(new_n62_), .c(new_n52_), .O(z01));
  inv1   g21(.a(x16), .O(new_n67_));
  nand2  g22(.a(new_n48_), .b(new_n67_), .O(z02));
  nand2  g23(.a(new_n62_), .b(new_n52_), .O(z03));
  ...
  nand4  g42(.a(new_n63_), .b(x21), .c(new_n56_), .d(new_n87_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n63_), .c(x21), .d(new_n87_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z11));
  oai21  g47(.a(new_n57_), .b(new_n56_), .c(x19), .O(new_n93_));
  nand3  g48(.a(new_n58_), .b(x18), .c(x17), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n63_), .c(x21), .d(new_n87_), .O(new_n96_));
  ...
  nand3  g55(.a(new_n64_), .b(new_n87_), .c(new_n98_), .O(new_n101_));
  nand4  g56(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n98_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x21), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n87_), .O(z13));
  nand4  g60(.a(new_n63_), .b(x19), .c(x18), .d(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n87_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n55_), .c(new_n98_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x21), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n87_), .O(z14));
  nand3  g65(.a(new_n101_), .b(new_n81_), .c(new_n98_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x21), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n87_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n64_), .b(new_n98_), .c(new_n50_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n87_), .d(new_n98_), .O(z16));
  nand3  g71(.a(new_n101_), .b(new_n53_), .c(new_n98_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(x21), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n87_), .O(z17));
  nand3  g74(.a(new_n101_), .b(new_n54_), .c(new_n98_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(x21), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n87_), .O(z18));
endmodule
