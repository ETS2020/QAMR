...
module FAU ( 
  ...
  nand2  g002(.a(new_n47_), .b(x00), .O(new_n48_));
  inv1   g003(.a(new_n48_), .O(new_n49_));
  nor3   g004(.a(new_n49_), .b(x16), .c(new_n46_), .O(z00));
  oai21  g005(.a(x07), .b(x00), .c(new_n47_), .O(new_n51_));
  ...
  oai21  g019(.a(new_n64_), .b(new_n49_), .c(new_n52_), .O(z01));
  and2   g020(.a(new_n48_), .b(x16), .O(z02));
  nand3  g021(.a(new_n63_), .b(new_n48_), .c(new_n53_), .O(new_n67_));
  ...
  nor2   g037(.a(new_n47_), .b(x09), .O(new_n83_));
  aoi21  g038(.a(new_n83_), .b(x00), .c(new_n82_), .O(new_n84_));
  aoi21  g039(.a(new_n84_), .b(new_n80_), .c(x08), .O(z04));
  nor3   g040(.a(new_n49_), .b(x13), .c(x08), .O(z05));
  nand2  g041(.a(new_n48_), .b(x14), .O(new_n87_));
  nor2   g042(.a(new_n87_), .b(x08), .O(z06));
  aoi21  g043(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  inv1   g044(.a(x00), .O(new_n90_));
  ...
  nand2  g065(.a(new_n110_), .b(new_n90_), .O(new_n111_));
  ...
  nand4  g071(.a(new_n116_), .b(x05), .c(x04), .d(new_n90_), .O(new_n117_));
  aoi21  g072(.a(new_n117_), .b(new_n90_), .c(x15), .O(z09));
  nand2  g073(.a(x05), .b(x04), .O(new_n119_));
  nand3  g074(.a(new_n119_), .b(new_n91_), .c(new_n116_), .O(new_n120_));
  aoi21  g075(.a(new_n120_), .b(new_n90_), .c(x15), .O(z10));
  xor2a  g076(.a(x18), .b(x17), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n119_), .c(new_n47_), .d(new_n116_), .O(new_n123_));
  nor2   g078(.a(new_n123_), .b(x00), .O(z11));
  ...
  aoi21  g085(.a(new_n130_), .b(new_n90_), .c(x15), .O(z12));
  ...
  nor3   g095(.a(new_n92_), .b(new_n57_), .c(new_n47_), .O(new_n141_));
  ...
  aoi21  g117(.a(new_n162_), .b(x00), .c(new_n100_), .O(new_n163_));
  ...
  nor3   g123(.a(new_n56_), .b(x25), .c(new_n47_), .O(new_n169_));
  ...
  nand2  g139(.a(x25), .b(x00), .O(new_n185_));
  ...
  nand2  g147(.a(new_n192_), .b(new_n90_), .O(new_n193_));
  ...
  aoi21  g156(.a(new_n201_), .b(new_n47_), .c(new_n91_), .O(new_n202_));
  nor2   g157(.a(new_n56_), .b(new_n47_), .O(new_n203_));
  ...
  nor2   g161(.a(x24), .b(new_n47_), .O(new_n207_));
  oai21  g162(.a(new_n207_), .b(new_n206_), .c(new_n53_), .O(new_n208_));
  nor2   g163(.a(new_n53_), .b(x00), .O(new_n209_));
  ...
  nand2  g171(.a(new_n216_), .b(new_n90_), .O(new_n217_));
