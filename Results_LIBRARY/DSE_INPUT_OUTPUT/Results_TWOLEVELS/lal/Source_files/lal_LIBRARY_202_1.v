...
module FAU ( 
  ...
  oai21  g04(.a(x17), .b(x07), .c(new_n47_), .O(new_n50_));
  ...
  nand2  g16(.a(x17), .b(x15), .O(new_n62_));
  oai21  g17(.a(new_n61_), .b(x17), .c(new_n62_), .O(new_n63_));
  nand4  g18(.a(new_n63_), .b(new_n60_), .c(new_n53_), .d(new_n59_), .O(new_n64_));
  nand3  g19(.a(new_n64_), .b(new_n58_), .c(new_n51_), .O(z01));
  and2   g20(.a(new_n48_), .b(x16), .O(z02));
  nand2  g21(.a(new_n60_), .b(new_n53_), .O(new_n67_));
  oai21  g22(.a(new_n67_), .b(x20), .c(x15), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(x17), .O(new_n69_));
  nand2  g24(.a(new_n55_), .b(new_n48_), .O(new_n70_));
  inv1   g25(.a(x17), .O(new_n71_));
  inv1   g26(.a(x18), .O(new_n72_));
  inv1   g27(.a(x19), .O(new_n73_));
  nand2  g28(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g29(.a(new_n74_), .b(new_n59_), .c(new_n71_), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(new_n70_), .c(x23), .O(new_n76_));
  inv1   g31(.a(new_n48_), .O(new_n77_));
  nor2   g32(.a(new_n77_), .b(x24), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n76_), .c(new_n60_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n69_), .O(z03));
  ...
  nand2  g47(.a(new_n61_), .b(new_n71_), .O(new_n93_));
  ...
  oai21  g53(.a(new_n98_), .b(x07), .c(new_n71_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z09));
  nand4  g56(.a(new_n98_), .b(new_n71_), .c(new_n47_), .d(new_n52_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z10));
  nand4  g58(.a(new_n98_), .b(x18), .c(new_n71_), .d(new_n47_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(x07), .O(z11));
  nand3  g60(.a(new_n98_), .b(x19), .c(new_n52_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n71_), .c(x15), .O(z12));
  nand4  g62(.a(new_n47_), .b(new_n52_), .c(x05), .d(x04), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n59_), .c(new_n52_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n71_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(z13));
  nand2  g66(.a(new_n71_), .b(x07), .O(new_n112_));
  nor2   g67(.a(x21), .b(x15), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n100_), .O(z14));
  nand4  g69(.a(new_n112_), .b(new_n100_), .c(new_n92_), .d(new_n47_), .O(z15));
  nand4  g70(.a(new_n112_), .b(new_n100_), .c(new_n53_), .d(new_n47_), .O(z16));
  nand3  g71(.a(new_n108_), .b(new_n54_), .c(new_n52_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n71_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n47_), .O(z17));
  nand4  g74(.a(new_n112_), .b(new_n100_), .c(new_n60_), .d(new_n47_), .O(z18));
endmodule
