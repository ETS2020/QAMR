...
module FAU ( 
  ...
  nand3  g53(.a(new_n48_), .b(x05), .c(x04), .O(new_n99_));
  ...
  nand4  g64(.a(new_n94_), .b(new_n109_), .c(new_n53_), .d(x19), .O(new_n110_));
  ...
  nand4  g75(.a(new_n119_), .b(new_n82_), .c(new_n109_), .d(new_n53_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n102_), .c(new_n47_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n120_), .c(new_n48_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n101_), .O(z16));
  nand2  g79(.a(x24), .b(x23), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n99_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n47_), .O(new_n127_));
  nor2   g82(.a(new_n116_), .b(new_n81_), .O(new_n128_));
  nand3  g83(.a(new_n114_), .b(new_n81_), .c(new_n119_), .O(new_n129_));
  ...
  nand4  g89(.a(new_n134_), .b(new_n114_), .c(new_n104_), .d(new_n94_), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n133_), .c(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n48_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n101_), .O(z18));
endmodule
