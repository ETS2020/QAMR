...
module FAU ( 
  ...
  nand2  g18(.a(new_n48_), .b(x07), .O(new_n64_));
  oai21  g19(.a(new_n63_), .b(x07), .c(new_n64_), .O(z01));
  inv1   g20(.a(x16), .O(new_n66_));
  nor2   g21(.a(new_n49_), .b(new_n66_), .O(z02));
  nand2  g22(.a(new_n60_), .b(new_n52_), .O(new_n68_));
  ...
  nand3  g34(.a(new_n50_), .b(x14), .c(new_n46_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z06));
  aoi21  g36(.a(new_n46_), .b(x06), .c(new_n49_), .O(z07));
  inv1   g37(.a(x24), .O(new_n83_));
  inv1   g38(.a(x22), .O(new_n84_));
  aoi21  g39(.a(new_n57_), .b(new_n53_), .c(new_n84_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x21), .c(x23), .O(new_n86_));
  nor2   g41(.a(new_n49_), .b(x25), .O(new_n87_));
  oai21  g42(.a(new_n86_), .b(new_n83_), .c(new_n87_), .O(z08));
  nand3  g43(.a(new_n62_), .b(new_n48_), .c(new_n47_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n50_), .O(z09));
  nand4  g45(.a(new_n61_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n98_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z12));
  oai21  g55(.a(new_n62_), .b(x15), .c(new_n47_), .O(new_n101_));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n96_), .b(new_n53_), .c(x19), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n47_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n101_), .O(z13));
  ...
  oai21  g66(.a(new_n111_), .b(x15), .c(new_n101_), .O(z14));
  nand2  g67(.a(new_n109_), .b(x22), .O(new_n113_));
  nor2   g68(.a(x22), .b(x21), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n53_), .O(new_n115_));
  nor2   g70(.a(new_n115_), .b(new_n102_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(x07), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n113_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n48_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n101_), .O(z15));
  inv1   g75(.a(x23), .O(new_n121_));
  nor2   g76(.a(new_n116_), .b(new_n121_), .O(new_n122_));
  inv1   g77(.a(new_n102_), .O(new_n123_));
  nand4  g78(.a(new_n108_), .b(new_n123_), .c(new_n121_), .d(new_n84_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n122_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n101_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  inv1   g83(.a(new_n104_), .O(new_n129_));
  nand3  g84(.a(new_n114_), .b(new_n83_), .c(new_n121_), .O(new_n130_));
  inv1   g85(.a(new_n130_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n128_), .c(new_n47_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n101_), .O(z17));
  nand2  g90(.a(new_n132_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand3  g92(.a(new_n137_), .b(new_n114_), .c(new_n129_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n101_), .d(new_n47_), .O(z18));
endmodule
