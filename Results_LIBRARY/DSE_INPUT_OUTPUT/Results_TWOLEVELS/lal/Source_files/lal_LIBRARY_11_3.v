...
module FAU ( 
  ...
  nor2   g042(.a(x15), .b(x11), .O(new_n88_));
  aoi21  g043(.a(new_n88_), .b(x02), .c(new_n87_), .O(new_n89_));
  aoi21  g044(.a(new_n89_), .b(new_n85_), .c(x08), .O(z04));
  oai21  g045(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  inv1   g046(.a(x08), .O(new_n92_));
  nand3  g047(.a(new_n50_), .b(x14), .c(new_n92_), .O(new_n93_));
  inv1   g048(.a(new_n93_), .O(z06));
  aoi21  g049(.a(new_n92_), .b(x06), .c(new_n49_), .O(z07));
  ...
  inv1   g055(.a(new_n66_), .O(new_n101_));
  nand3  g056(.a(new_n101_), .b(new_n48_), .c(new_n100_), .O(new_n102_));
  inv1   g057(.a(new_n102_), .O(z09));
  nand4  g058(.a(new_n66_), .b(new_n56_), .c(new_n48_), .d(new_n100_), .O(new_n104_));
  inv1   g059(.a(new_n104_), .O(z10));
  xor2a  g060(.a(x18), .b(x17), .O(new_n106_));
  nand4  g061(.a(new_n106_), .b(new_n66_), .c(new_n48_), .d(new_n100_), .O(new_n107_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n58_), .c(new_n111_), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n66_), .c(new_n48_), .d(new_n100_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n50_), .O(z12));
  nand3  g069(.a(x19), .b(x18), .c(x17), .O(new_n115_));
  nand2  g070(.a(new_n115_), .b(x20), .O(new_n116_));
  nand3  g071(.a(new_n101_), .b(new_n48_), .c(new_n100_), .O(new_n117_));
  ...
  nand4  g076(.a(new_n121_), .b(new_n116_), .c(new_n48_), .d(new_n100_), .O(z13));
  nor2   g077(.a(new_n120_), .b(new_n61_), .O(new_n123_));
  nand3  g078(.a(new_n100_), .b(x05), .c(x04), .O(new_n124_));
  nor2   g079(.a(x21), .b(x20), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n110_), .c(x19), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n124_), .c(new_n100_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(new_n123_), .c(new_n48_), .O(new_n128_));
  nand2  g083(.a(x15), .b(new_n47_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n128_), .O(z14));
  nand3  g085(.a(new_n61_), .b(new_n55_), .c(x19), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(new_n109_), .c(x22), .O(new_n132_));
  inv1   g087(.a(new_n115_), .O(new_n133_));
  nor2   g088(.a(x22), .b(x21), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n133_), .c(new_n55_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n132_), .c(new_n124_), .d(new_n100_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n48_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n129_), .O(z15));
  inv1   g093(.a(x23), .O(new_n139_));
  nand4  g094(.a(new_n125_), .b(new_n133_), .c(new_n139_), .d(new_n62_), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n117_), .c(new_n100_), .O(new_n141_));
  aoi21  g096(.a(new_n135_), .b(x23), .c(new_n141_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n48_), .O(z16));
  nand2  g098(.a(new_n140_), .b(x24), .O(new_n144_));
  nand4  g099(.a(new_n53_), .b(new_n139_), .c(new_n62_), .d(new_n61_), .O(new_n145_));
  nor2   g100(.a(new_n145_), .b(new_n119_), .O(new_n146_));
  nor2   g101(.a(new_n146_), .b(new_n118_), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n144_), .c(new_n48_), .d(new_n100_), .O(z17));
  oai21  g103(.a(new_n145_), .b(new_n119_), .c(x25), .O(new_n149_));
  nor2   g104(.a(x20), .b(new_n58_), .O(new_n150_));
  nor3   g105(.a(x25), .b(x24), .c(x23), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n134_), .c(new_n150_), .d(new_n110_), .O(new_n152_));
  nand4  g107(.a(new_n152_), .b(new_n149_), .c(new_n124_), .d(new_n100_), .O(new_n153_));
