...
module FAU ( 
  ...
  nor3   g005(.a(new_n50_), .b(x16), .c(new_n46_), .O(z00));
  nand2  g006(.a(x05), .b(x04), .O(new_n52_));
  inv1   g007(.a(new_n52_), .O(new_n53_));
  nor2   g008(.a(new_n53_), .b(x07), .O(new_n54_));
  ...
  aoi21  g018(.a(new_n63_), .b(new_n60_), .c(new_n48_), .O(new_n64_));
  aoi22  g019(.a(new_n64_), .b(new_n55_), .c(new_n48_), .d(x03), .O(new_n65_));
  oai22  g020(.a(new_n65_), .b(x25), .c(new_n54_), .d(new_n50_), .O(z01));
  and2   g021(.a(new_n49_), .b(x16), .O(z02));
  inv1   g022(.a(x25), .O(new_n68_));
  oai21  g023(.a(new_n68_), .b(new_n47_), .c(new_n48_), .O(new_n69_));
  ...
  aoi21  g027(.a(x12), .b(new_n46_), .c(new_n48_), .O(new_n73_));
  ...
  oai21  g042(.a(new_n73_), .b(x03), .c(new_n87_), .O(z04));
  ...
  nand2  g049(.a(x25), .b(x03), .O(new_n95_));
  ...
  nand2  g054(.a(new_n95_), .b(new_n48_), .O(new_n100_));
  ...
  nand4  g071(.a(new_n52_), .b(new_n49_), .c(new_n93_), .d(new_n116_), .O(new_n117_));
  nor2   g072(.a(new_n117_), .b(x07), .O(z10));
  xor2a  g073(.a(x18), .b(x17), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n52_), .c(new_n49_), .d(new_n116_), .O(new_n120_));
  ...
  nand3  g078(.a(new_n123_), .b(new_n52_), .c(new_n116_), .O(new_n124_));
  oai21  g079(.a(new_n124_), .b(x07), .c(new_n49_), .O(z12));
  ...
  aoi21  g084(.a(new_n104_), .b(new_n103_), .c(new_n50_), .O(new_n130_));
  ...
  nor2   g098(.a(new_n143_), .b(new_n50_), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n141_), .c(new_n127_), .d(new_n114_), .O(z16));
  nand2  g100(.a(x18), .b(x17), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n52_), .c(new_n116_), .O(new_n147_));
  ...
  aoi21  g109(.a(new_n154_), .b(x03), .c(z09), .O(new_n155_));
  oai21  g110(.a(new_n150_), .b(new_n48_), .c(new_n155_), .O(z17));
  oai21  g111(.a(new_n126_), .b(new_n53_), .c(new_n49_), .O(new_n157_));
  nand4  g112(.a(new_n105_), .b(new_n68_), .c(new_n48_), .d(new_n55_), .O(new_n158_));
  oai22  g113(.a(new_n158_), .b(new_n132_), .c(new_n143_), .d(new_n68_), .O(new_n159_));
  nand2  g114(.a(new_n159_), .b(x03), .O(new_n160_));
