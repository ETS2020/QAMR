...
module FAU ( 
  ...
  oai21  g076(.a(new_n107_), .b(new_n106_), .c(new_n47_), .O(new_n122_));
  ...
  nand4  g080(.a(new_n125_), .b(new_n123_), .c(new_n121_), .d(new_n51_), .O(z13));
  nor2   g081(.a(x21), .b(x20), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n91_), .c(x19), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n60_), .O(new_n129_));
  aoi21  g084(.a(new_n121_), .b(x21), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x15), .c(new_n51_), .O(z14));
  inv1   g086(.a(x20), .O(new_n132_));
  inv1   g087(.a(new_n124_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n94_), .c(new_n132_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n60_), .O(new_n135_));
  aoi21  g090(.a(new_n128_), .b(x22), .c(new_n135_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(x15), .c(new_n51_), .O(z15));
  nand2  g092(.a(new_n134_), .b(x23), .O(new_n138_));
  nand4  g093(.a(new_n127_), .b(new_n133_), .c(new_n53_), .d(new_n86_), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n138_), .c(new_n123_), .d(new_n51_), .O(z16));
  nand4  g095(.a(new_n94_), .b(x25), .c(new_n87_), .d(new_n53_), .O(new_n141_));
  oai22  g096(.a(new_n141_), .b(new_n121_), .c(new_n87_), .d(new_n53_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n47_), .O(new_n143_));
  nand2  g098(.a(new_n134_), .b(x24), .O(new_n144_));
  nand4  g099(.a(new_n94_), .b(new_n52_), .c(new_n87_), .d(new_n53_), .O(new_n145_));
  nor2   g100(.a(new_n145_), .b(new_n121_), .O(new_n146_));
  nor2   g101(.a(new_n146_), .b(x07), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n144_), .c(new_n143_), .d(new_n123_), .O(z17));
  nand3  g103(.a(new_n96_), .b(x25), .c(new_n47_), .O(new_n149_));
  nand3  g104(.a(new_n149_), .b(new_n147_), .c(new_n123_), .O(z18));
endmodule
