...
module FAU ( 
  ...
  oai21  g16(.a(new_n61_), .b(new_n47_), .c(new_n51_), .O(new_n62_));
  ...
  oai21  g39(.a(new_n84_), .b(new_n47_), .c(new_n51_), .O(z08));
  nor4   g40(.a(new_n63_), .b(x24), .c(x15), .d(x07), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n63_), .b(new_n47_), .c(new_n53_), .d(new_n87_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n63_), .c(new_n47_), .d(new_n87_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n63_), .c(new_n47_), .d(new_n87_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z12));
  inv1   g53(.a(x07), .O(new_n99_));
  oai21  g54(.a(new_n63_), .b(x07), .c(new_n47_), .O(new_n100_));
  ...
  nor2   g62(.a(new_n105_), .b(new_n58_), .O(new_n108_));
  nand3  g63(.a(new_n64_), .b(new_n87_), .c(new_n99_), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n94_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n99_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n108_), .c(new_n47_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n87_), .O(z14));
  nand3  g69(.a(new_n58_), .b(new_n52_), .c(x19), .O(new_n115_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n109_), .d(new_n99_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n87_), .O(z15));
  nand2  g77(.a(new_n119_), .b(x23), .O(new_n123_));
  nand3  g78(.a(new_n118_), .b(new_n47_), .c(new_n82_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(new_n105_), .c(x15), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n101_), .d(new_n99_), .O(z16));
  nand4  g82(.a(new_n110_), .b(new_n117_), .c(new_n82_), .d(new_n59_), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n109_), .c(new_n99_), .O(new_n129_));
  ...
  nand3  g87(.a(new_n118_), .b(new_n51_), .c(new_n82_), .O(new_n133_));
  inv1   g88(.a(new_n133_), .O(new_n134_));
  aoi21  g89(.a(new_n134_), .b(new_n105_), .c(x15), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n132_), .c(new_n101_), .d(new_n99_), .O(z18));
endmodule
