...
module FAU ( 
  ...
  oai21  g024(.a(x08), .b(x02), .c(x15), .O(new_n70_));
  nand2  g025(.a(new_n70_), .b(x11), .O(new_n71_));
  ...
  nand2  g032(.a(new_n47_), .b(x02), .O(new_n78_));
  ...
  nor4   g064(.a(new_n65_), .b(x15), .c(x11), .d(x07), .O(z09));
  nand3  g065(.a(new_n65_), .b(new_n87_), .c(new_n50_), .O(new_n111_));
  aoi21  g066(.a(new_n111_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g067(.a(x15), .O(new_n113_));
  xor2a  g068(.a(x18), .b(x17), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n65_), .c(new_n113_), .d(new_n47_), .O(new_n115_));
  nor2   g070(.a(new_n115_), .b(x07), .O(z11));
  nand2  g071(.a(x19), .b(new_n87_), .O(new_n117_));
  nand3  g072(.a(new_n56_), .b(x18), .c(x17), .O(new_n118_));
  aoi21  g073(.a(new_n118_), .b(new_n117_), .c(new_n64_), .O(new_n119_));
  oai21  g074(.a(x11), .b(x05), .c(x04), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(x19), .c(new_n55_), .O(new_n121_));
  inv1   g076(.a(new_n121_), .O(new_n122_));
  oai21  g077(.a(new_n122_), .b(new_n119_), .c(new_n50_), .O(new_n123_));
  aoi21  g078(.a(new_n123_), .b(new_n47_), .c(x15), .O(z12));
  nand3  g079(.a(new_n64_), .b(new_n113_), .c(new_n50_), .O(new_n125_));
  ...
  nand2  g084(.a(new_n97_), .b(new_n96_), .O(new_n130_));
  inv1   g085(.a(new_n130_), .O(new_n131_));
  nor2   g086(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n129_), .c(new_n127_), .d(new_n113_), .O(z13));
  nor2   g088(.a(new_n131_), .b(new_n59_), .O(new_n134_));
  nor2   g089(.a(x21), .b(x20), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n96_), .c(x19), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n125_), .c(new_n50_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n134_), .c(new_n47_), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n113_), .O(z14));
  nand2  g094(.a(new_n136_), .b(x22), .O(new_n140_));
  nand2  g095(.a(new_n98_), .b(new_n54_), .O(new_n141_));
  nor2   g096(.a(new_n141_), .b(new_n128_), .O(new_n142_));
  nor2   g097(.a(new_n142_), .b(new_n48_), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n140_), .c(new_n127_), .d(new_n113_), .O(z15));
  nor2   g099(.a(new_n142_), .b(new_n105_), .O(new_n145_));
  inv1   g100(.a(new_n128_), .O(new_n146_));
  nand4  g101(.a(new_n135_), .b(new_n146_), .c(new_n105_), .d(new_n60_), .O(new_n147_));
  nand3  g102(.a(new_n147_), .b(new_n125_), .c(new_n50_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n145_), .c(new_n47_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n113_), .O(z16));
  aoi21  g105(.a(new_n64_), .b(new_n50_), .c(x11), .O(new_n151_));
  nand3  g106(.a(new_n99_), .b(new_n60_), .c(new_n59_), .O(new_n152_));
  ...
  oai21  g112(.a(new_n141_), .b(new_n128_), .c(x24), .O(new_n158_));
  nand4  g113(.a(new_n158_), .b(new_n157_), .c(new_n151_), .d(new_n113_), .O(z17));
  nand2  g114(.a(new_n100_), .b(x25), .O(new_n160_));
  nor3   g115(.a(x25), .b(x24), .c(x23), .O(new_n161_));
  nand3  g116(.a(new_n161_), .b(new_n98_), .c(new_n131_), .O(new_n162_));
  nand4  g117(.a(new_n162_), .b(new_n160_), .c(new_n125_), .d(new_n50_), .O(new_n163_));
  nand2  g118(.a(new_n163_), .b(new_n47_), .O(new_n164_));
  nand2  g119(.a(new_n164_), .b(new_n113_), .O(z18));
endmodule
