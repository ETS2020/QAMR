...
module FAU ( 
  ...
  oai21  g040(.a(new_n85_), .b(new_n56_), .c(new_n52_), .O(new_n86_));
  ...
  nand3  g046(.a(new_n58_), .b(x19), .c(x18), .O(new_n92_));
  ...
  nand4  g053(.a(new_n98_), .b(new_n93_), .c(new_n91_), .d(new_n59_), .O(new_n99_));
  ...
  nand3  g058(.a(new_n57_), .b(x22), .c(x21), .O(new_n104_));
  aoi21  g059(.a(new_n104_), .b(new_n103_), .c(new_n91_), .O(new_n105_));
  oai21  g060(.a(new_n105_), .b(x25), .c(new_n47_), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n102_), .O(z08));
  nand3  g062(.a(new_n66_), .b(new_n48_), .c(new_n47_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z09));
  nand4  g064(.a(new_n67_), .b(new_n84_), .c(new_n48_), .d(new_n47_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n50_), .O(z10));
  xor2a  g066(.a(x18), .b(x17), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n67_), .c(new_n48_), .d(new_n47_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n50_), .O(z11));
  nand3  g069(.a(new_n55_), .b(x18), .c(x17), .O(new_n115_));
  oai21  g070(.a(new_n94_), .b(new_n55_), .c(new_n115_), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n67_), .c(new_n48_), .d(new_n47_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(z12));
  nand2  g073(.a(new_n95_), .b(new_n94_), .O(new_n119_));
  oai21  g074(.a(new_n65_), .b(new_n64_), .c(new_n48_), .O(new_n120_));
  ...
  nand4  g080(.a(new_n94_), .b(new_n58_), .c(new_n53_), .d(x19), .O(new_n126_));
  nand4  g081(.a(new_n126_), .b(new_n125_), .c(new_n121_), .d(new_n47_), .O(z14));
  nand2  g082(.a(new_n126_), .b(x22), .O(new_n128_));
  inv1   g083(.a(new_n122_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n96_), .c(new_n53_), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n128_), .c(new_n121_), .d(new_n47_), .O(z15));
  and2   g086(.a(new_n130_), .b(x23), .O(new_n132_));
  nand4  g087(.a(new_n103_), .b(new_n59_), .c(new_n58_), .d(new_n53_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(new_n122_), .c(new_n47_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n132_), .c(new_n48_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n121_), .O(z16));
  nand3  g091(.a(new_n97_), .b(new_n59_), .c(new_n58_), .O(new_n137_));
  nor2   g092(.a(new_n137_), .b(x20), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  nand3  g094(.a(new_n47_), .b(x05), .c(x04), .O(new_n140_));
  ...
  nand2  g098(.a(new_n130_), .b(x24), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n47_), .O(z17));
  nor3   g100(.a(x25), .b(x24), .c(x23), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n96_), .O(new_n147_));
  oai21  g102(.a(new_n147_), .b(new_n119_), .c(new_n47_), .O(new_n148_));
  aoi21  g103(.a(new_n98_), .b(x25), .c(new_n148_), .O(new_n149_));
  oai21  g104(.a(new_n149_), .b(x15), .c(new_n121_), .O(z18));
endmodule
