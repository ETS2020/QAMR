...
module FAU ( 
  ...
  aoi21  g006(.a(x05), .b(x04), .c(x15), .O(new_n52_));
  nor2   g007(.a(new_n52_), .b(x07), .O(z09));
  inv1   g008(.a(z09), .O(new_n54_));
  ...
  nand3  g021(.a(new_n66_), .b(new_n54_), .c(new_n51_), .O(z01));
  ...
  nand3  g043(.a(new_n62_), .b(x19), .c(x18), .O(new_n89_));
  inv1   g044(.a(new_n89_), .O(new_n90_));
  and2   g045(.a(x18), .b(x17), .O(new_n91_));
  nor2   g046(.a(x20), .b(new_n59_), .O(new_n92_));
  ...
  nand4  g050(.a(new_n95_), .b(new_n90_), .c(new_n55_), .d(new_n63_), .O(new_n96_));
  ...
  nand3  g055(.a(new_n61_), .b(x22), .c(x21), .O(new_n101_));
  aoi21  g056(.a(new_n101_), .b(new_n100_), .c(new_n55_), .O(new_n102_));
  oai21  g057(.a(new_n102_), .b(x25), .c(x07), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(new_n99_), .O(z08));
  nand2  g059(.a(x05), .b(x04), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(new_n82_), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(new_n47_), .c(x07), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n105_), .c(new_n47_), .d(new_n51_), .O(new_n109_));
  inv1   g064(.a(new_n109_), .O(z11));
  nand3  g065(.a(new_n59_), .b(x18), .c(x17), .O(new_n111_));
  oai21  g066(.a(new_n59_), .b(x17), .c(new_n111_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n105_), .O(new_n113_));
  oai21  g068(.a(x15), .b(x05), .c(x04), .O(new_n114_));
  nand3  g069(.a(new_n114_), .b(x19), .c(new_n58_), .O(new_n115_));
  and2   g070(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  aoi21  g071(.a(new_n116_), .b(new_n113_), .c(x07), .O(z12));
  ...
  nand3  g076(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n51_), .O(z13));
  nor2   g079(.a(x21), .b(x20), .O(new_n125_));
  nand3  g080(.a(new_n125_), .b(new_n91_), .c(x19), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  aoi21  g082(.a(new_n118_), .b(x21), .c(new_n127_), .O(new_n128_));
  oai21  g083(.a(new_n128_), .b(x15), .c(new_n51_), .O(z14));
  nand2  g084(.a(new_n126_), .b(x22), .O(new_n130_));
  nand2  g085(.a(new_n93_), .b(new_n57_), .O(new_n131_));
  nor2   g086(.a(new_n131_), .b(new_n119_), .O(new_n132_));
  inv1   g087(.a(new_n132_), .O(new_n133_));
  nand4  g088(.a(new_n133_), .b(new_n130_), .c(new_n54_), .d(new_n51_), .O(z15));
  nor2   g089(.a(new_n132_), .b(new_n100_), .O(new_n135_));
  inv1   g090(.a(new_n119_), .O(new_n136_));
  nand4  g091(.a(new_n125_), .b(new_n136_), .c(new_n100_), .d(new_n63_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n121_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(new_n135_), .c(new_n47_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n51_), .O(z16));
  nand3  g095(.a(new_n94_), .b(new_n63_), .c(new_n62_), .O(new_n141_));
  ...
  nand3  g099(.a(new_n144_), .b(new_n143_), .c(new_n121_), .O(new_n145_));
  ...
  nand2  g103(.a(new_n148_), .b(new_n93_), .O(new_n149_));
  oai21  g104(.a(new_n149_), .b(new_n118_), .c(new_n121_), .O(new_n150_));
  aoi21  g105(.a(new_n95_), .b(x25), .c(new_n150_), .O(new_n151_));
