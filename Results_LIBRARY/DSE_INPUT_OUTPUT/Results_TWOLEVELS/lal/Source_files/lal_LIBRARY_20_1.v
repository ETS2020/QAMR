...
module FAU ( 
  ...
  nor2   g55(.a(new_n100_), .b(x07), .O(z09));
  ...
  nand4  g69(.a(new_n114_), .b(new_n100_), .c(new_n112_), .d(new_n51_), .O(z13));
  inv1   g70(.a(z09), .O(new_n116_));
  ...
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n116_), .d(new_n51_), .O(z14));
  nand2  g75(.a(new_n119_), .b(x22), .O(new_n121_));
  nand2  g76(.a(new_n94_), .b(new_n53_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(new_n113_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(x07), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n121_), .c(new_n116_), .O(z15));
  inv1   g80(.a(x23), .O(new_n126_));
  nor2   g81(.a(new_n123_), .b(new_n126_), .O(new_n127_));
  inv1   g82(.a(new_n113_), .O(new_n128_));
  nand4  g83(.a(new_n118_), .b(new_n128_), .c(new_n126_), .d(new_n87_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n61_), .O(new_n130_));
  oai21  g85(.a(new_n130_), .b(new_n127_), .c(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n51_), .O(z16));
  nand3  g87(.a(new_n95_), .b(new_n87_), .c(new_n89_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(x20), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(x19), .c(x18), .d(x17), .O(new_n135_));
  aoi21  g90(.a(new_n129_), .b(x24), .c(x07), .O(new_n136_));
  nand3  g91(.a(new_n136_), .b(new_n135_), .c(new_n116_), .O(z17));
  nand2  g92(.a(new_n96_), .b(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n116_), .d(new_n51_), .O(z18));
endmodule
