...
module FAU ( 
  ...
  nand2  g05(.a(x15), .b(x08), .O(new_n51_));
  ...
  nand3  g17(.a(new_n62_), .b(new_n51_), .c(new_n61_), .O(new_n63_));
  inv1   g18(.a(new_n63_), .O(new_n64_));
  nand2  g19(.a(new_n64_), .b(new_n60_), .O(z01));
  nand2  g20(.a(new_n51_), .b(new_n47_), .O(z02));
  ...
  nand2  g29(.a(new_n74_), .b(new_n51_), .O(z04));
  oai21  g30(.a(x13), .b(x08), .c(new_n51_), .O(z05));
  inv1   g31(.a(x14), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(x08), .c(new_n51_), .O(z06));
  nand2  g33(.a(new_n68_), .b(x06), .O(z07));
  ...
  aoi21  g38(.a(x15), .b(x08), .c(x25), .O(new_n84_));
  oai21  g39(.a(new_n83_), .b(new_n80_), .c(new_n84_), .O(z08));
  inv1   g40(.a(new_n62_), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n46_), .c(new_n61_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n51_), .O(z09));
  nand4  g43(.a(new_n62_), .b(new_n53_), .c(new_n46_), .d(new_n61_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n51_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n62_), .c(new_n46_), .d(new_n61_), .O(new_n92_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n62_), .c(new_n46_), .d(new_n61_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n51_), .O(z12));
  nand3  g53(.a(x19), .b(x18), .c(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x20), .O(new_n100_));
  nand3  g55(.a(new_n61_), .b(x05), .c(x04), .O(new_n101_));
  nand4  g56(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n61_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n46_), .O(new_n104_));
  nand2  g59(.a(x15), .b(new_n68_), .O(new_n105_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n87_), .c(new_n61_), .O(new_n109_));
  aoi21  g64(.a(new_n102_), .b(x21), .c(new_n109_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n46_), .O(z14));
  ...
  and2   g70(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n46_), .d(new_n61_), .O(z15));
  inv1   g72(.a(x23), .O(new_n118_));
  nand4  g73(.a(new_n107_), .b(new_n113_), .c(new_n118_), .d(new_n81_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n87_), .c(new_n61_), .O(new_n120_));
  aoi21  g75(.a(new_n115_), .b(x23), .c(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n46_), .O(z16));
  nand2  g77(.a(new_n119_), .b(x24), .O(new_n123_));
  inv1   g78(.a(new_n87_), .O(new_n124_));
  inv1   g79(.a(x21), .O(new_n125_));
  nand4  g80(.a(new_n80_), .b(new_n118_), .c(new_n81_), .d(new_n125_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n123_), .c(new_n46_), .d(new_n61_), .O(z17));
  ...
  nand4  g87(.a(new_n132_), .b(new_n114_), .c(new_n131_), .d(new_n94_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n101_), .d(new_n61_), .O(new_n134_));
