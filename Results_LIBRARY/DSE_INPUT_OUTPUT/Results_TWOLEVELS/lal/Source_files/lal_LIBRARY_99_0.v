...
module FAU ( 
  ...
  aoi21  g39(.a(new_n61_), .b(new_n84_), .c(new_n75_), .O(new_n85_));
  nor2   g40(.a(new_n85_), .b(x15), .O(z09));
  inv1   g41(.a(x15), .O(new_n87_));
  nand4  g42(.a(new_n60_), .b(new_n52_), .c(new_n87_), .d(x14), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x07), .O(z10));
  xor2a  g44(.a(x18), .b(x17), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n60_), .c(new_n87_), .d(x14), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(x07), .O(z11));
  aoi21  g47(.a(new_n53_), .b(x14), .c(new_n52_), .O(new_n93_));
  nand3  g48(.a(new_n54_), .b(x18), .c(x17), .O(new_n94_));
  oai21  g49(.a(new_n93_), .b(new_n54_), .c(new_n94_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n60_), .c(new_n84_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(x14), .c(x15), .O(z12));
  nand3  g52(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand3  g54(.a(new_n61_), .b(new_n87_), .c(new_n84_), .O(new_n100_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n100_), .c(new_n99_), .d(new_n84_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x14), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n87_), .O(z13));
  nand2  g61(.a(new_n100_), .b(new_n84_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(x14), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n101_), .c(x19), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n87_), .c(x14), .O(new_n111_));
  ...
  and2   g72(.a(new_n117_), .b(new_n50_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n114_), .c(new_n108_), .d(new_n87_), .O(z15));
  nand2  g74(.a(new_n117_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x21), .O(new_n121_));
  inv1   g76(.a(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n79_), .c(new_n121_), .d(new_n51_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  aoi21  g79(.a(new_n124_), .b(new_n115_), .c(new_n47_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n120_), .c(new_n108_), .d(new_n87_), .O(z16));
  oai21  g81(.a(new_n123_), .b(new_n98_), .c(x24), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n116_), .c(new_n102_), .d(new_n101_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n100_), .d(new_n84_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x14), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n87_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  inv1   g88(.a(new_n103_), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  and2   g90(.a(new_n135_), .b(new_n116_), .O(new_n136_));
  aoi21  g91(.a(new_n136_), .b(new_n134_), .c(new_n47_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n133_), .c(new_n108_), .d(new_n87_), .O(z18));
endmodule
