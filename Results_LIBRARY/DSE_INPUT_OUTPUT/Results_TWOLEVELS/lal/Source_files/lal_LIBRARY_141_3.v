...
module FAU ( 
  ...
  inv1   g54(.a(new_n63_), .O(new_n100_));
  ...
  oai21  g63(.a(new_n92_), .b(new_n57_), .c(new_n108_), .O(new_n109_));
  ...
  oai21  g75(.a(new_n120_), .b(x15), .c(new_n113_), .O(z14));
  nand2  g76(.a(new_n118_), .b(x22), .O(new_n122_));
  inv1   g77(.a(new_n114_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n94_), .c(new_n54_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n113_), .d(new_n47_), .O(z15));
  nand2  g80(.a(new_n124_), .b(x23), .O(new_n126_));
  nor2   g81(.a(x23), .b(x22), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n117_), .c(new_n123_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n113_), .d(new_n47_), .O(z16));
  ...
  nand4  g88(.a(new_n133_), .b(new_n132_), .c(new_n113_), .d(new_n47_), .O(z17));
  ...
  nand4  g92(.a(new_n137_), .b(new_n135_), .c(new_n113_), .d(new_n47_), .O(z18));
endmodule
