...
module FAU ( 
  ...
  nand2  g074(.a(new_n61_), .b(new_n48_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  nand2  g076(.a(new_n95_), .b(new_n93_), .O(new_n122_));
  nand3  g077(.a(x19), .b(x18), .c(x17), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(x20), .O(new_n124_));
  nand3  g079(.a(new_n124_), .b(new_n122_), .c(new_n47_), .O(new_n125_));
  ...
  nand3  g084(.a(new_n129_), .b(new_n93_), .c(x19), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n128_), .c(new_n121_), .d(new_n47_), .O(z14));
  ...
  nand4  g089(.a(new_n134_), .b(new_n132_), .c(new_n121_), .d(new_n47_), .O(z15));
  nand2  g090(.a(new_n134_), .b(x23), .O(new_n136_));
  nand4  g091(.a(new_n129_), .b(new_n133_), .c(new_n103_), .d(new_n88_), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n136_), .c(new_n121_), .d(new_n47_), .O(z16));
  ...
  nand4  g096(.a(new_n141_), .b(new_n103_), .c(new_n88_), .d(new_n90_), .O(new_n142_));
  ...
  nand3  g102(.a(new_n147_), .b(new_n144_), .c(new_n121_), .O(z17));
  nand4  g103(.a(new_n96_), .b(new_n53_), .c(new_n89_), .d(new_n103_), .O(new_n149_));
  oai21  g104(.a(new_n149_), .b(new_n122_), .c(new_n47_), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n48_), .O(new_n151_));
  aoi21  g106(.a(new_n98_), .b(x25), .c(new_n120_), .O(new_n152_));
