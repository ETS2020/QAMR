...
module FAU ( 
  ...
  nand3  g15(.a(new_n47_), .b(x05), .c(x04), .O(new_n61_));
  ...
  nand2  g45(.a(new_n89_), .b(new_n53_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g47(.a(x15), .O(new_n93_));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n89_), .c(new_n93_), .d(new_n47_), .O(new_n95_));
  ...
  nor2   g58(.a(new_n62_), .b(x15), .O(new_n104_));
  nand4  g59(.a(new_n52_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n49_), .O(z13));
  ...
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n89_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n93_), .O(z14));
  ...
  nand4  g71(.a(new_n116_), .b(new_n113_), .c(new_n104_), .d(new_n49_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  inv1   g73(.a(x22), .O(new_n119_));
  nand3  g74(.a(new_n108_), .b(new_n82_), .c(new_n119_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n114_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n104_), .d(new_n49_), .O(z16));
  oai21  g78(.a(new_n120_), .b(new_n102_), .c(x24), .O(new_n124_));
  nor2   g79(.a(x20), .b(new_n55_), .O(new_n125_));
  nor2   g80(.a(x24), .b(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n115_), .c(new_n125_), .d(new_n97_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n124_), .c(new_n89_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n93_), .O(z17));
  nand2  g85(.a(new_n127_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n115_), .c(new_n125_), .d(new_n97_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n104_), .d(new_n49_), .O(z18));
endmodule
