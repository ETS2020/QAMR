...
module FAU ( 
  ...
  nand2  g010(.a(x15), .b(new_n51_), .O(new_n56_));
  ...
  nor2   g038(.a(x12), .b(new_n51_), .O(new_n84_));
  inv1   g039(.a(x12), .O(new_n85_));
  nor2   g040(.a(x15), .b(new_n85_), .O(new_n86_));
  aoi21  g041(.a(new_n86_), .b(new_n51_), .c(new_n84_), .O(new_n87_));
  aoi21  g042(.a(new_n87_), .b(new_n83_), .c(x08), .O(z04));
  oai21  g043(.a(x13), .b(x08), .c(new_n49_), .O(z05));
  nand2  g044(.a(x14), .b(new_n46_), .O(new_n90_));
  nand2  g045(.a(new_n90_), .b(new_n49_), .O(z06));
  nand3  g046(.a(new_n49_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand3  g076(.a(new_n121_), .b(new_n47_), .c(new_n118_), .O(new_n122_));
  inv1   g077(.a(new_n122_), .O(z09));
  inv1   g078(.a(new_n121_), .O(new_n124_));
  nand4  g079(.a(new_n124_), .b(new_n58_), .c(new_n47_), .d(new_n118_), .O(new_n125_));
  inv1   g080(.a(new_n125_), .O(z10));
  xor2a  g081(.a(x18), .b(x17), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n124_), .c(new_n47_), .d(new_n118_), .O(new_n128_));
  ...
  nand4  g086(.a(new_n131_), .b(new_n124_), .c(new_n47_), .d(new_n118_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n49_), .O(z12));
  ...
  nand4  g106(.a(new_n151_), .b(new_n149_), .c(new_n55_), .d(x03), .O(new_n152_));
  ...
  nand4  g109(.a(new_n61_), .b(x19), .c(x18), .d(new_n47_), .O(new_n155_));
  ...
  nor2   g114(.a(new_n159_), .b(new_n51_), .O(new_n160_));
  ...
  nand3  g118(.a(new_n163_), .b(x15), .c(x03), .O(new_n164_));
  ...
  oai21  g124(.a(new_n169_), .b(new_n51_), .c(x15), .O(new_n170_));
  ...
  nand2  g129(.a(x18), .b(new_n47_), .O(new_n175_));
  nand2  g130(.a(new_n106_), .b(x19), .O(new_n176_));
  nand3  g131(.a(new_n55_), .b(x15), .c(x03), .O(new_n177_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n177_), .O(new_n178_));
  nand2  g133(.a(new_n178_), .b(x17), .O(new_n179_));
  nand4  g134(.a(new_n93_), .b(new_n55_), .c(x15), .d(x03), .O(new_n180_));
  aoi21  g135(.a(new_n180_), .b(new_n179_), .c(x20), .O(new_n181_));
  nand4  g136(.a(new_n64_), .b(new_n55_), .c(x15), .d(x03), .O(new_n182_));
  ...
  nand2  g141(.a(x15), .b(x03), .O(new_n187_));
  ...
  nand3  g145(.a(new_n190_), .b(x15), .c(x03), .O(new_n191_));
  aoi21  g146(.a(new_n138_), .b(new_n106_), .c(new_n57_), .O(new_n192_));
  oai21  g147(.a(new_n192_), .b(new_n135_), .c(new_n47_), .O(new_n193_));
  ...
  nand4  g165(.a(new_n210_), .b(new_n138_), .c(new_n61_), .d(new_n47_), .O(new_n211_));
  aoi21  g166(.a(new_n211_), .b(new_n187_), .c(new_n58_), .O(new_n212_));
  nor3   g167(.a(new_n59_), .b(new_n47_), .c(new_n51_), .O(new_n213_));
  oai21  g168(.a(new_n213_), .b(new_n212_), .c(new_n137_), .O(new_n214_));
  nand3  g169(.a(new_n64_), .b(x15), .c(x03), .O(new_n215_));
  aoi21  g170(.a(new_n215_), .b(new_n214_), .c(x23), .O(new_n216_));
  nand3  g171(.a(new_n101_), .b(x15), .c(x03), .O(new_n217_));
  ...
  nand3  g179(.a(new_n224_), .b(x15), .c(x03), .O(new_n225_));
  ...
  nand2  g183(.a(new_n228_), .b(new_n47_), .O(new_n229_));
