...
module FAU ( 
  ...
  oai21  g64(.a(new_n109_), .b(x07), .c(new_n85_), .O(z14));
  ...
  aoi21  g72(.a(x05), .b(x04), .c(x07), .O(new_n118_));
  or2    g73(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g74(.a(new_n114_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand3  g76(.a(new_n106_), .b(new_n121_), .c(new_n80_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n112_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n120_), .c(new_n119_), .d(new_n85_), .O(z16));
  oai21  g80(.a(new_n122_), .b(new_n99_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x20), .b(new_n55_), .O(new_n127_));
  nor2   g82(.a(x24), .b(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n113_), .c(new_n127_), .d(new_n94_), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n126_), .c(new_n101_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n85_), .O(z17));
  nand2  g87(.a(new_n129_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n113_), .c(new_n127_), .d(new_n94_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n119_), .d(new_n85_), .O(z18));
endmodule
