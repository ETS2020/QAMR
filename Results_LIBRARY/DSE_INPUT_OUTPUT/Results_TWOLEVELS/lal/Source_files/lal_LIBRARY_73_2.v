...
module FAU ( 
  ...
  oai21  g08(.a(x13), .b(x07), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g20(.a(new_n65_), .b(new_n49_), .c(new_n55_), .O(z01));
  nand3  g21(.a(new_n64_), .b(new_n50_), .c(new_n56_), .O(new_n67_));
  ...
  and2   g41(.a(x05), .b(x04), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n86_), .c(x13), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(x15), .O(z09));
  inv1   g44(.a(new_n87_), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n58_), .c(new_n86_), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n48_), .c(x15), .O(z10));
  xor2a  g47(.a(x18), .b(x17), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n90_), .c(new_n53_), .d(new_n48_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(x07), .O(z11));
  aoi21  g50(.a(new_n59_), .b(new_n48_), .c(new_n58_), .O(new_n96_));
  nand3  g51(.a(new_n60_), .b(x18), .c(x17), .O(new_n97_));
  oai21  g52(.a(new_n96_), .b(new_n60_), .c(new_n97_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n90_), .c(new_n86_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n48_), .c(x15), .O(z12));
  nand3  g55(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nand3  g57(.a(new_n87_), .b(new_n53_), .c(new_n86_), .O(new_n103_));
  nand4  g58(.a(new_n57_), .b(x19), .c(x18), .d(x17), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n86_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n53_), .O(z13));
  nand2  g62(.a(new_n103_), .b(new_n86_), .O(new_n108_));
  ...
  nand3  g66(.a(new_n111_), .b(new_n53_), .c(new_n48_), .O(new_n112_));
  aoi21  g67(.a(new_n104_), .b(x21), .c(new_n112_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n109_), .O(z14));
  ...
  nor2   g73(.a(new_n118_), .b(new_n49_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n115_), .c(new_n109_), .d(new_n53_), .O(z15));
  inv1   g75(.a(x23), .O(new_n121_));
  nor2   g76(.a(new_n118_), .b(new_n121_), .O(new_n122_));
  inv1   g77(.a(new_n101_), .O(new_n123_));
  nand4  g78(.a(new_n110_), .b(new_n123_), .c(new_n121_), .d(new_n81_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n103_), .c(new_n86_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n122_), .c(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n53_), .O(z16));
  nand2  g82(.a(new_n124_), .b(x24), .O(new_n128_));
  inv1   g83(.a(new_n104_), .O(new_n129_));
  nand3  g84(.a(new_n116_), .b(new_n80_), .c(new_n121_), .O(new_n130_));
  inv1   g85(.a(new_n130_), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(new_n129_), .c(new_n49_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n128_), .c(new_n109_), .d(new_n53_), .O(z17));
  oai21  g88(.a(new_n130_), .b(new_n104_), .c(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand3  g90(.a(new_n135_), .b(new_n116_), .c(new_n129_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n103_), .d(new_n86_), .O(new_n137_));
  nand2  g92(.a(new_n137_), .b(new_n48_), .O(new_n138_));
  nand2  g93(.a(new_n138_), .b(new_n53_), .O(z18));
endmodule
