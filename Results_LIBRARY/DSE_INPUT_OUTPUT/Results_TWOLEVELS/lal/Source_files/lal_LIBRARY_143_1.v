...
module FAU ( 
  ...
  nor2   g036(.a(x11), .b(new_n81_), .O(new_n82_));
  inv1   g037(.a(x11), .O(new_n83_));
  nor2   g038(.a(x15), .b(new_n83_), .O(new_n84_));
  ...
  oai21  g066(.a(new_n111_), .b(x25), .c(x02), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n108_), .O(z08));
  nand4  g068(.a(new_n47_), .b(new_n51_), .c(x05), .d(x04), .O(new_n114_));
  inv1   g069(.a(new_n114_), .O(z09));
  nand4  g070(.a(new_n64_), .b(new_n91_), .c(new_n47_), .d(new_n51_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n49_), .O(z10));
  xor2a  g072(.a(x18), .b(x17), .O(new_n118_));
  nand4  g073(.a(new_n118_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n119_));
  inv1   g074(.a(new_n119_), .O(z11));
  nand3  g075(.a(new_n56_), .b(x18), .c(x17), .O(new_n121_));
  oai21  g076(.a(new_n100_), .b(new_n56_), .c(new_n121_), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n49_), .O(z12));
  nand2  g079(.a(new_n101_), .b(new_n100_), .O(new_n125_));
  aoi21  g080(.a(x05), .b(x04), .c(x07), .O(new_n126_));
  nand3  g081(.a(x19), .b(x18), .c(x17), .O(new_n127_));
  nand2  g082(.a(new_n127_), .b(x20), .O(new_n128_));
  nand4  g083(.a(new_n128_), .b(new_n126_), .c(new_n125_), .d(new_n47_), .O(z13));
  inv1   g084(.a(new_n125_), .O(new_n130_));
  nor2   g085(.a(new_n130_), .b(new_n59_), .O(new_n131_));
  nand3  g086(.a(new_n51_), .b(x05), .c(x04), .O(new_n132_));
  nor2   g087(.a(x21), .b(x20), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n100_), .c(x19), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n132_), .c(new_n51_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n131_), .c(new_n47_), .O(new_n136_));
  nand2  g091(.a(x15), .b(x02), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n136_), .O(z14));
  inv1   g093(.a(new_n127_), .O(new_n139_));
  nand3  g094(.a(new_n139_), .b(new_n102_), .c(new_n54_), .O(new_n140_));
  nand3  g095(.a(new_n140_), .b(new_n132_), .c(new_n51_), .O(new_n141_));
  aoi21  g096(.a(new_n134_), .b(x22), .c(new_n141_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(x15), .c(new_n137_), .O(z15));
  and2   g098(.a(new_n140_), .b(x23), .O(new_n144_));
  nand4  g099(.a(new_n133_), .b(new_n139_), .c(new_n109_), .d(new_n60_), .O(new_n145_));
  nand3  g100(.a(new_n145_), .b(new_n132_), .c(new_n51_), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n144_), .c(new_n47_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n137_), .O(z16));
  aoi21  g103(.a(x25), .b(x15), .c(x24), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n109_), .c(new_n60_), .d(new_n59_), .O(new_n150_));
  nor2   g105(.a(new_n150_), .b(x20), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(x19), .c(x18), .d(x17), .O(new_n152_));
  nand2  g107(.a(x24), .b(x23), .O(new_n153_));
  nand3  g108(.a(new_n153_), .b(new_n132_), .c(new_n51_), .O(new_n154_));
  aoi22  g109(.a(new_n154_), .b(new_n47_), .c(new_n140_), .d(x24), .O(new_n155_));
  nand3  g110(.a(new_n155_), .b(new_n152_), .c(new_n47_), .O(z17));
  nand2  g111(.a(new_n104_), .b(x25), .O(new_n157_));
  nor3   g112(.a(x25), .b(x24), .c(x23), .O(new_n158_));
  nand3  g113(.a(new_n158_), .b(new_n102_), .c(new_n130_), .O(new_n159_));
  nand4  g114(.a(new_n159_), .b(new_n157_), .c(new_n126_), .d(new_n47_), .O(z18));
endmodule
