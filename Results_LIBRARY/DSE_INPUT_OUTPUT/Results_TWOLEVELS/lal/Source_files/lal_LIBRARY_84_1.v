...
module FAU ( 
  ...
  oai21  g036(.a(new_n81_), .b(new_n59_), .c(new_n55_), .O(new_n82_));
  ...
  nand3  g041(.a(new_n61_), .b(x19), .c(x18), .O(new_n87_));
  inv1   g042(.a(new_n87_), .O(new_n88_));
  and2   g043(.a(x18), .b(x17), .O(new_n89_));
  nor2   g044(.a(x20), .b(new_n58_), .O(new_n90_));
  ...
  nand4  g048(.a(new_n93_), .b(new_n88_), .c(new_n54_), .d(new_n62_), .O(new_n94_));
  ...
  nand3  g053(.a(new_n60_), .b(x22), .c(x21), .O(new_n99_));
  aoi21  g054(.a(new_n99_), .b(new_n98_), .c(new_n54_), .O(new_n100_));
  oai21  g055(.a(new_n100_), .b(x25), .c(x14), .O(new_n101_));
  nand2  g056(.a(new_n101_), .b(new_n97_), .O(z08));
  nand4  g057(.a(new_n48_), .b(new_n53_), .c(x05), .d(x04), .O(new_n103_));
  inv1   g058(.a(new_n103_), .O(z09));
  nand4  g059(.a(new_n66_), .b(new_n80_), .c(new_n48_), .d(new_n53_), .O(new_n105_));
  inv1   g060(.a(new_n105_), .O(z10));
  xor2a  g061(.a(x18), .b(x17), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n66_), .c(new_n48_), .d(new_n53_), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n50_), .O(z11));
  nand3  g064(.a(new_n58_), .b(x18), .c(x17), .O(new_n110_));
  oai21  g065(.a(new_n89_), .b(new_n58_), .c(new_n110_), .O(new_n111_));
  ...
  nand4  g072(.a(new_n117_), .b(new_n116_), .c(new_n114_), .d(new_n53_), .O(new_n118_));
  nand2  g073(.a(new_n118_), .b(new_n48_), .O(new_n119_));
  nand2  g074(.a(x15), .b(x14), .O(new_n120_));
  ...
  nand3  g080(.a(new_n125_), .b(new_n117_), .c(new_n53_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(new_n123_), .c(new_n48_), .O(new_n127_));
  ...
  nand3  g086(.a(new_n131_), .b(new_n91_), .c(new_n56_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n130_), .c(new_n129_), .d(new_n48_), .O(z15));
  nand2  g088(.a(new_n132_), .b(x23), .O(new_n134_));
  nand4  g089(.a(new_n124_), .b(new_n131_), .c(new_n98_), .d(new_n62_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n134_), .c(new_n129_), .d(new_n48_), .O(z16));
  aoi21  g091(.a(x25), .b(x15), .c(x24), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n98_), .c(new_n62_), .d(new_n61_), .O(new_n138_));
  nor2   g093(.a(new_n138_), .b(x20), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(x19), .c(x18), .d(x17), .O(new_n140_));
  nand2  g095(.a(x24), .b(x23), .O(new_n141_));
  nand3  g096(.a(new_n141_), .b(new_n117_), .c(new_n53_), .O(new_n142_));
  aoi22  g097(.a(new_n142_), .b(new_n48_), .c(new_n132_), .d(x24), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n140_), .c(new_n48_), .O(z17));
  nand2  g099(.a(new_n93_), .b(x25), .O(new_n145_));
  nor3   g100(.a(x25), .b(x24), .c(x23), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n91_), .c(new_n122_), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n145_), .c(new_n129_), .d(new_n48_), .O(z18));
endmodule
