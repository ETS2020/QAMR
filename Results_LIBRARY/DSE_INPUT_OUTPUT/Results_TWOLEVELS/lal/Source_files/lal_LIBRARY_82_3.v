...
module FAU ( 
  ...
  nand3  g017(.a(new_n50_), .b(x05), .c(x04), .O(new_n63_));
  nand3  g018(.a(new_n63_), .b(new_n62_), .c(new_n50_), .O(z01));
  nand2  g019(.a(new_n47_), .b(new_n46_), .O(z02));
  nand2  g020(.a(new_n62_), .b(new_n47_), .O(z03));
  ...
  nand3  g032(.a(new_n47_), .b(new_n67_), .c(x06), .O(z07));
  ...
  nand3  g053(.a(new_n57_), .b(x22), .c(x21), .O(new_n99_));
  aoi21  g054(.a(new_n99_), .b(new_n98_), .c(new_n51_), .O(new_n100_));
  ...
  nand3  g059(.a(new_n104_), .b(new_n97_), .c(new_n50_), .O(new_n105_));
  inv1   g060(.a(new_n105_), .O(z09));
  nand4  g061(.a(new_n103_), .b(new_n79_), .c(new_n97_), .d(new_n50_), .O(new_n107_));
  inv1   g062(.a(new_n107_), .O(z10));
  xor2a  g063(.a(x18), .b(x17), .O(new_n109_));
  nand4  g064(.a(new_n109_), .b(new_n103_), .c(new_n97_), .d(new_n50_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n47_), .O(z11));
  nand3  g066(.a(new_n55_), .b(x18), .c(x17), .O(new_n112_));
  oai21  g067(.a(new_n88_), .b(new_n55_), .c(new_n112_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n103_), .c(new_n97_), .d(new_n50_), .O(new_n114_));
  inv1   g069(.a(new_n114_), .O(z12));
  nand2  g070(.a(new_n103_), .b(new_n97_), .O(new_n116_));
  nand2  g071(.a(new_n116_), .b(new_n50_), .O(new_n117_));
  nand2  g072(.a(new_n89_), .b(new_n88_), .O(new_n118_));
  ...
  nand2  g076(.a(new_n121_), .b(new_n97_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n117_), .O(z13));
  nand4  g078(.a(new_n88_), .b(new_n58_), .c(new_n53_), .d(x19), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(new_n50_), .O(new_n125_));
  aoi21  g080(.a(new_n118_), .b(x21), .c(new_n125_), .O(new_n126_));
  oai21  g081(.a(new_n126_), .b(x15), .c(new_n117_), .O(z14));
  inv1   g082(.a(new_n119_), .O(new_n128_));
  ...
  oai21  g086(.a(new_n131_), .b(x15), .c(new_n117_), .O(z15));
  and2   g087(.a(new_n129_), .b(x23), .O(new_n133_));
  nand4  g088(.a(new_n98_), .b(new_n59_), .c(new_n58_), .d(new_n53_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n119_), .c(new_n50_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n133_), .c(new_n97_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n117_), .O(z16));
  nor2   g092(.a(new_n51_), .b(new_n98_), .O(new_n138_));
  nand4  g093(.a(new_n90_), .b(new_n52_), .c(new_n51_), .d(new_n98_), .O(new_n139_));
  nor2   g094(.a(new_n139_), .b(new_n118_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n138_), .c(new_n97_), .O(new_n141_));
  nand4  g096(.a(new_n90_), .b(x25), .c(new_n51_), .d(new_n98_), .O(new_n142_));
  oai21  g097(.a(new_n142_), .b(new_n118_), .c(new_n97_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(new_n104_), .O(new_n144_));
  nand2  g099(.a(new_n129_), .b(x24), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n141_), .d(new_n50_), .O(z17));
  oai21  g101(.a(new_n140_), .b(x07), .c(new_n97_), .O(new_n147_));
  aoi21  g102(.a(new_n92_), .b(x25), .c(new_n116_), .O(new_n148_));
