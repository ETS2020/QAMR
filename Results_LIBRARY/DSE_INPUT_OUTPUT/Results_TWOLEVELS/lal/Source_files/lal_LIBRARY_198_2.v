...
module FAU ( 
  ...
  aoi21  g38(.a(new_n61_), .b(new_n47_), .c(x15), .O(z09));
  nand2  g39(.a(new_n61_), .b(new_n53_), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n47_), .c(x15), .O(z10));
  inv1   g41(.a(x15), .O(new_n87_));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n61_), .c(new_n87_), .d(new_n47_), .O(new_n89_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n97_), .d(new_n49_), .O(z13));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n100_), .d(new_n49_), .O(z14));
  nand2  g61(.a(new_n105_), .b(x22), .O(new_n107_));
  inv1   g62(.a(new_n96_), .O(new_n108_));
  nor3   g63(.a(x22), .b(x21), .c(x20), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n108_), .c(new_n48_), .O(new_n110_));
  ...
  nand4  g68(.a(new_n104_), .b(new_n108_), .c(new_n112_), .d(new_n79_), .O(new_n114_));
  ...
  or2    g75(.a(new_n120_), .b(new_n101_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n118_), .c(new_n100_), .d(new_n49_), .O(z17));
  oai21  g77(.a(new_n120_), .b(new_n101_), .c(x25), .O(new_n123_));
  nor2   g78(.a(x20), .b(new_n55_), .O(new_n124_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n119_), .c(new_n124_), .d(new_n91_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n61_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n87_), .O(z18));
endmodule
