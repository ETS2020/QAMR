...
module FAU ( 
  ...
  nand2  g21(.a(new_n50_), .b(new_n46_), .O(z02));
  ...
  oai21  g56(.a(new_n63_), .b(x15), .c(new_n47_), .O(new_n102_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nor2   g59(.a(x20), .b(new_n57_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n97_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n102_), .d(new_n47_), .O(z13));
  ...
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n102_), .d(new_n47_), .O(z14));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n103_), .O(new_n114_));
  aoi21  g69(.a(new_n110_), .b(x22), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n102_), .c(new_n47_), .O(z15));
  inv1   g71(.a(x23), .O(new_n117_));
  nor2   g72(.a(new_n114_), .b(new_n117_), .O(new_n118_));
  inv1   g73(.a(new_n103_), .O(new_n119_));
  nand4  g74(.a(new_n109_), .b(new_n119_), .c(new_n117_), .d(new_n85_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n118_), .c(new_n48_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n102_), .O(z16));
  nand2  g78(.a(new_n120_), .b(x24), .O(new_n124_));
  nand3  g79(.a(new_n112_), .b(new_n84_), .c(new_n117_), .O(new_n125_));
  or2    g80(.a(new_n125_), .b(new_n106_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n102_), .d(new_n47_), .O(z17));
  oai21  g82(.a(new_n125_), .b(new_n106_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n112_), .c(new_n105_), .d(new_n97_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n47_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n102_), .O(z18));
endmodule
