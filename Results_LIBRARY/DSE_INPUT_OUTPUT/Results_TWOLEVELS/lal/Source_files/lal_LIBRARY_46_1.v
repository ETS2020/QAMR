...
module FAU ( 
  ...
  nand3  g032(.a(new_n65_), .b(new_n46_), .c(x06), .O(z07));
  ...
  nand2  g063(.a(new_n108_), .b(new_n53_), .O(new_n109_));
  ...
  nand4  g070(.a(new_n115_), .b(new_n108_), .c(new_n47_), .d(new_n50_), .O(new_n116_));
  inv1   g071(.a(new_n116_), .O(z12));
  nand2  g072(.a(new_n93_), .b(new_n91_), .O(new_n118_));
  nand3  g073(.a(x19), .b(x18), .c(x17), .O(new_n119_));
  nand2  g074(.a(new_n119_), .b(x20), .O(new_n120_));
  nand3  g075(.a(new_n120_), .b(new_n118_), .c(new_n59_), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n50_), .O(z13));
  inv1   g078(.a(x20), .O(new_n124_));
  nand4  g079(.a(new_n91_), .b(new_n88_), .c(new_n124_), .d(x19), .O(new_n125_));
  nand2  g080(.a(new_n125_), .b(new_n59_), .O(new_n126_));
  aoi21  g081(.a(new_n118_), .b(x21), .c(new_n126_), .O(new_n127_));
  oai21  g082(.a(new_n127_), .b(x15), .c(new_n50_), .O(z14));
  inv1   g083(.a(new_n119_), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n94_), .c(new_n124_), .O(new_n130_));
  nand2  g085(.a(new_n130_), .b(new_n59_), .O(new_n131_));
  aoi21  g086(.a(new_n125_), .b(x22), .c(new_n131_), .O(new_n132_));
  oai21  g087(.a(new_n132_), .b(x15), .c(new_n50_), .O(z15));
  and2   g088(.a(new_n130_), .b(x23), .O(new_n134_));
  nand4  g089(.a(new_n52_), .b(new_n86_), .c(new_n88_), .d(new_n124_), .O(new_n135_));
  oai21  g090(.a(new_n135_), .b(new_n119_), .c(new_n59_), .O(new_n136_));
  oai21  g091(.a(new_n136_), .b(new_n134_), .c(new_n47_), .O(new_n137_));
  nand2  g092(.a(new_n137_), .b(new_n50_), .O(z16));
  nand3  g093(.a(new_n95_), .b(new_n86_), .c(new_n88_), .O(new_n139_));
  nor2   g094(.a(new_n139_), .b(x20), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(x19), .c(x18), .d(x17), .O(new_n141_));
  oai21  g096(.a(new_n87_), .b(new_n52_), .c(new_n141_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n47_), .O(new_n143_));
  nand2  g098(.a(new_n130_), .b(x24), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n50_), .O(z17));
  nor3   g100(.a(x25), .b(x24), .c(x23), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n94_), .O(new_n147_));
  oai21  g102(.a(new_n147_), .b(new_n118_), .c(new_n59_), .O(new_n148_));
  aoi21  g103(.a(new_n96_), .b(x25), .c(new_n148_), .O(new_n149_));
  oai21  g104(.a(new_n149_), .b(x15), .c(new_n50_), .O(z18));
endmodule
