...
module FAU ( 
  ...
  oai21  g66(.a(new_n62_), .b(x15), .c(new_n47_), .O(new_n112_));
  ...
  nand4  g93(.a(new_n138_), .b(new_n137_), .c(new_n112_), .d(new_n47_), .O(z17));
  ...
  nand4  g97(.a(new_n142_), .b(new_n140_), .c(new_n112_), .d(new_n47_), .O(z18));
endmodule
