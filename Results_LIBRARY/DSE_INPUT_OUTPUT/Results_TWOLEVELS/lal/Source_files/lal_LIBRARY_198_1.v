...
module FAU ( 
  ...
  nand3  g22(.a(new_n63_), .b(new_n49_), .c(new_n55_), .O(new_n68_));
  ...
  aoi21  g37(.a(new_n60_), .b(new_n56_), .c(new_n82_), .O(new_n83_));
  ...
  nor2   g47(.a(new_n58_), .b(new_n57_), .O(new_n93_));
  nand3  g48(.a(new_n59_), .b(x18), .c(x17), .O(new_n94_));
  oai21  g49(.a(new_n93_), .b(new_n59_), .c(new_n94_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n52_), .d(new_n51_), .O(z13));
  ...
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n52_), .d(new_n51_), .O(z14));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n106_));
  inv1   g61(.a(new_n98_), .O(new_n107_));
  nor3   g62(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  aoi21  g63(.a(new_n108_), .b(new_n107_), .c(x07), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n106_), .c(new_n54_), .O(z15));
  inv1   g65(.a(x23), .O(new_n111_));
  aoi21  g66(.a(new_n108_), .b(new_n107_), .c(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n51_), .b(x05), .c(x04), .O(new_n113_));
  nand4  g68(.a(new_n103_), .b(new_n107_), .c(new_n111_), .d(new_n82_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n120_), .b(new_n81_), .c(new_n111_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n118_), .c(new_n54_), .d(new_n51_), .O(z17));
  oai21  g79(.a(new_n121_), .b(new_n100_), .c(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n120_), .c(new_n119_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n113_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n51_), .O(z18));
endmodule
