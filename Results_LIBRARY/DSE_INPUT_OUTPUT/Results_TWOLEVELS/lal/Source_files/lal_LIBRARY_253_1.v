...
module FAU ( 
  ...
  nor2   g036(.a(new_n81_), .b(x01), .O(new_n82_));
  nor2   g037(.a(x15), .b(x10), .O(new_n83_));
  aoi21  g038(.a(new_n83_), .b(x01), .c(new_n82_), .O(new_n84_));
  ...
  oai21  g046(.a(new_n91_), .b(new_n57_), .c(new_n53_), .O(new_n92_));
  ...
  nand3  g051(.a(new_n59_), .b(x19), .c(x18), .O(new_n97_));
  inv1   g052(.a(new_n97_), .O(new_n98_));
  and2   g053(.a(x18), .b(x17), .O(new_n99_));
  nor2   g054(.a(x20), .b(new_n56_), .O(new_n100_));
  ...
  nand4  g058(.a(new_n103_), .b(new_n98_), .c(new_n52_), .d(new_n60_), .O(new_n104_));
  ...
  nand3  g063(.a(new_n58_), .b(x22), .c(x21), .O(new_n109_));
  aoi21  g064(.a(new_n109_), .b(new_n108_), .c(new_n52_), .O(new_n110_));
  oai21  g065(.a(new_n110_), .b(x25), .c(x10), .O(new_n111_));
  nand2  g066(.a(new_n111_), .b(new_n107_), .O(z08));
  nand4  g067(.a(new_n47_), .b(new_n51_), .c(x05), .d(x04), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n49_), .O(z09));
  nand4  g069(.a(new_n64_), .b(new_n90_), .c(new_n47_), .d(new_n51_), .O(new_n115_));
  inv1   g070(.a(new_n115_), .O(z10));
  xor2a  g071(.a(x18), .b(x17), .O(new_n117_));
  nand4  g072(.a(new_n117_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n118_));
  inv1   g073(.a(new_n118_), .O(z11));
  nand3  g074(.a(new_n56_), .b(x18), .c(x17), .O(new_n120_));
  oai21  g075(.a(new_n99_), .b(new_n56_), .c(new_n120_), .O(new_n121_));
  nand4  g076(.a(new_n121_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(new_n49_), .O(z12));
  nand3  g078(.a(x19), .b(x18), .c(x17), .O(new_n124_));
  nand2  g079(.a(new_n124_), .b(x20), .O(new_n125_));
  nand2  g080(.a(new_n100_), .b(new_n99_), .O(new_n126_));
  nand3  g081(.a(new_n113_), .b(new_n126_), .c(new_n51_), .O(new_n127_));
  inv1   g082(.a(new_n127_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n125_), .c(new_n47_), .O(z13));
  nor2   g084(.a(x21), .b(x20), .O(new_n130_));
  nand3  g085(.a(new_n130_), .b(new_n99_), .c(x19), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n113_), .c(new_n51_), .O(new_n132_));
  aoi21  g087(.a(new_n126_), .b(x21), .c(new_n132_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n47_), .O(z14));
  nand3  g089(.a(new_n51_), .b(x05), .c(x04), .O(new_n135_));
  inv1   g090(.a(new_n124_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n101_), .c(new_n54_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n135_), .c(new_n51_), .O(new_n138_));
  aoi21  g093(.a(new_n131_), .b(x22), .c(new_n138_), .O(new_n139_));
  nand2  g094(.a(x15), .b(x10), .O(new_n140_));
  oai21  g095(.a(new_n139_), .b(x15), .c(new_n140_), .O(z15));
  and2   g096(.a(new_n137_), .b(x23), .O(new_n142_));
  nand4  g097(.a(new_n130_), .b(new_n136_), .c(new_n108_), .d(new_n60_), .O(new_n143_));
  nand3  g098(.a(new_n143_), .b(new_n135_), .c(new_n51_), .O(new_n144_));
  oai21  g099(.a(new_n144_), .b(new_n142_), .c(new_n47_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n140_), .O(z16));
  aoi21  g101(.a(x25), .b(x15), .c(x24), .O(new_n147_));
  nand4  g102(.a(new_n147_), .b(new_n108_), .c(new_n60_), .d(new_n59_), .O(new_n148_));
  nor2   g103(.a(new_n148_), .b(x20), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(x19), .c(x18), .d(x17), .O(new_n150_));
  inv1   g105(.a(new_n135_), .O(new_n151_));
  aoi21  g106(.a(x24), .b(x23), .c(new_n151_), .O(new_n152_));
  aoi21  g107(.a(new_n137_), .b(x24), .c(x07), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n152_), .c(new_n150_), .d(new_n47_), .O(z17));
  aoi21  g109(.a(new_n103_), .b(x25), .c(new_n151_), .O(new_n155_));
  nor3   g110(.a(x25), .b(x24), .c(x23), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n101_), .c(new_n100_), .d(new_n99_), .O(new_n157_));
  nand4  g112(.a(new_n157_), .b(new_n155_), .c(new_n47_), .d(new_n51_), .O(z18));
endmodule
