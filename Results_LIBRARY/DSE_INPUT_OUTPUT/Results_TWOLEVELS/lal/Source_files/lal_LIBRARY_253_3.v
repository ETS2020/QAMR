...
module FAU ( 
  ...
  aoi22  g026(.a(x11), .b(new_n71_), .c(new_n70_), .d(x00), .O(new_n72_));
  ...
  nor2   g037(.a(x10), .b(new_n82_), .O(new_n83_));
  nor2   g038(.a(x15), .b(new_n47_), .O(new_n84_));
  aoi21  g039(.a(new_n84_), .b(new_n82_), .c(new_n83_), .O(new_n85_));
  aoi21  g040(.a(new_n85_), .b(new_n81_), .c(x08), .O(z04));
  oai21  g041(.a(x13), .b(x08), .c(new_n50_), .O(z05));
  ...
  nand3  g052(.a(new_n60_), .b(x19), .c(x18), .O(new_n98_));
  inv1   g053(.a(new_n98_), .O(new_n99_));
  and2   g054(.a(x18), .b(x17), .O(new_n100_));
  nor2   g055(.a(x20), .b(new_n57_), .O(new_n101_));
  ...
  nand4  g059(.a(new_n104_), .b(new_n99_), .c(new_n53_), .d(new_n61_), .O(new_n105_));
  ...
  nand3  g064(.a(new_n59_), .b(x22), .c(x21), .O(new_n110_));
  aoi21  g065(.a(new_n110_), .b(new_n109_), .c(new_n53_), .O(new_n111_));
  oai21  g066(.a(new_n111_), .b(x25), .c(new_n47_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n108_), .O(z08));
  nand2  g068(.a(new_n48_), .b(new_n52_), .O(new_n114_));
  oai21  g069(.a(new_n114_), .b(new_n65_), .c(new_n50_), .O(z09));
  nand4  g070(.a(new_n65_), .b(new_n91_), .c(new_n48_), .d(new_n52_), .O(new_n116_));
  ...
  nand3  g075(.a(new_n57_), .b(x18), .c(x17), .O(new_n121_));
  oai21  g076(.a(new_n100_), .b(new_n57_), .c(new_n121_), .O(new_n122_));
  nand4  g077(.a(new_n122_), .b(new_n65_), .c(new_n48_), .d(new_n52_), .O(new_n123_));
  ...
  nand4  g083(.a(new_n128_), .b(new_n126_), .c(new_n125_), .d(new_n48_), .O(z13));
  nand2  g084(.a(new_n125_), .b(x21), .O(new_n130_));
  nor2   g085(.a(x21), .b(x20), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n100_), .c(x19), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n130_), .c(new_n126_), .d(new_n48_), .O(z14));
  nand3  g088(.a(new_n52_), .b(x05), .c(x04), .O(new_n134_));
  inv1   g089(.a(new_n127_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n102_), .c(new_n55_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n134_), .c(new_n52_), .O(new_n137_));
  aoi21  g092(.a(new_n132_), .b(x22), .c(new_n137_), .O(new_n138_));
  nand2  g093(.a(x15), .b(new_n47_), .O(new_n139_));
  oai21  g094(.a(new_n138_), .b(x15), .c(new_n139_), .O(z15));
  and2   g095(.a(new_n136_), .b(x23), .O(new_n141_));
  nand4  g096(.a(new_n131_), .b(new_n135_), .c(new_n109_), .d(new_n61_), .O(new_n142_));
  nand3  g097(.a(new_n142_), .b(new_n134_), .c(new_n52_), .O(new_n143_));
  oai21  g098(.a(new_n143_), .b(new_n141_), .c(new_n48_), .O(new_n144_));
  nand2  g099(.a(new_n144_), .b(new_n139_), .O(z16));
  aoi21  g100(.a(x25), .b(x15), .c(x24), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n109_), .c(new_n61_), .d(new_n60_), .O(new_n147_));
  ...
  aoi22  g106(.a(new_n151_), .b(new_n48_), .c(new_n136_), .d(x24), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n149_), .c(new_n48_), .O(z17));
  nand2  g108(.a(new_n104_), .b(x25), .O(new_n154_));
  nor3   g109(.a(x25), .b(x24), .c(x23), .O(new_n155_));
  nand4  g110(.a(new_n155_), .b(new_n102_), .c(new_n101_), .d(new_n100_), .O(new_n156_));
  nand4  g111(.a(new_n156_), .b(new_n154_), .c(new_n126_), .d(new_n48_), .O(z18));
endmodule
