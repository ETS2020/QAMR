...
module FAU ( 
  ...
  inv1   g42(.a(x05), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n48_), .c(new_n53_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z09));
  inv1   g46(.a(new_n89_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n56_), .c(new_n48_), .d(new_n53_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n92_), .c(new_n48_), .d(new_n53_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n92_), .c(new_n48_), .d(new_n53_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z12));
  oai21  g57(.a(new_n88_), .b(new_n87_), .c(new_n48_), .O(new_n103_));
  ...
  nand3  g61(.a(new_n98_), .b(new_n55_), .c(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n104_), .d(new_n53_), .O(z13));
  ...
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n104_), .d(new_n53_), .O(z14));
  ...
  nand3  g72(.a(new_n117_), .b(new_n113_), .c(new_n104_), .O(z15));
