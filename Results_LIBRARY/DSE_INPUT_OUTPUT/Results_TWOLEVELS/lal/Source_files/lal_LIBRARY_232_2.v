...
module FAU ( 
  ...
  nand3  g77(.a(new_n51_), .b(x05), .c(x04), .O(new_n123_));
  ...
  aoi21  g81(.a(new_n121_), .b(x22), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(x07), .c(new_n51_), .O(z15));
  nand2  g83(.a(new_n125_), .b(x23), .O(new_n129_));
  nor2   g84(.a(x23), .b(x22), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n120_), .c(new_n124_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n118_), .d(new_n51_), .O(z16));
  nand3  g87(.a(new_n96_), .b(new_n88_), .c(new_n90_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(x20), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(x19), .c(x18), .d(x17), .O(new_n135_));
  aoi21  g90(.a(new_n131_), .b(x24), .c(x15), .O(new_n136_));
  nand3  g91(.a(new_n136_), .b(new_n135_), .c(new_n118_), .O(z17));
  nand2  g92(.a(new_n97_), .b(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n118_), .d(new_n51_), .O(z18));
endmodule
