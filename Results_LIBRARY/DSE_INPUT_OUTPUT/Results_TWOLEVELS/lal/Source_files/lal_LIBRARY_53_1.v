...
module FAU ( 
  ...
  nand2  g21(.a(new_n65_), .b(new_n50_), .O(z03));
  ...
  aoi21  g34(.a(new_n61_), .b(new_n57_), .c(new_n79_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(x21), .c(x23), .O(new_n81_));
  nor2   g36(.a(new_n49_), .b(x25), .O(new_n82_));
  oai21  g37(.a(new_n81_), .b(new_n55_), .c(new_n82_), .O(z08));
  nor2   g38(.a(new_n54_), .b(x07), .O(z09));
  nand2  g39(.a(x05), .b(x04), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(new_n58_), .c(new_n48_), .d(new_n53_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n85_), .c(new_n48_), .d(new_n53_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z11));
  aoi21  g45(.a(new_n59_), .b(new_n48_), .c(new_n58_), .O(new_n91_));
  nand3  g46(.a(new_n60_), .b(x18), .c(x17), .O(new_n92_));
  oai21  g47(.a(new_n91_), .b(new_n60_), .c(new_n92_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n85_), .O(new_n94_));
  aoi21  g49(.a(new_n94_), .b(new_n48_), .c(x07), .O(z12));
  nand3  g50(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n53_), .b(x05), .c(x04), .O(new_n98_));
  ...
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n54_), .d(new_n53_), .O(z14));
  nand2  g61(.a(new_n105_), .b(x22), .O(new_n107_));
  inv1   g62(.a(new_n96_), .O(new_n108_));
  nor3   g63(.a(x22), .b(x21), .c(x20), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n98_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n48_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n53_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(new_n108_), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n104_), .b(new_n114_), .c(new_n79_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n96_), .c(new_n98_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n115_), .c(new_n48_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n53_), .O(z16));
  oai21  g74(.a(new_n116_), .b(new_n96_), .c(x24), .O(new_n120_));
  nor2   g75(.a(new_n59_), .b(new_n58_), .O(new_n121_));
  nor2   g76(.a(x20), .b(new_n60_), .O(new_n122_));
  nor2   g77(.a(x22), .b(x21), .O(new_n123_));
  nor2   g78(.a(x24), .b(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n120_), .c(new_n98_), .O(new_n126_));
  ...
  nand4  g86(.a(new_n131_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n130_), .c(new_n98_), .O(new_n133_));
