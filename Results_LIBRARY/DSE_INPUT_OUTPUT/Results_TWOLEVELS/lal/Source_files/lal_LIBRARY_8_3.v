...
module FAU ( 
  ...
  nand2  g044(.a(new_n52_), .b(new_n89_), .O(new_n90_));
  ...
  nand4  g056(.a(new_n101_), .b(new_n95_), .c(new_n89_), .d(new_n92_), .O(new_n102_));
  nand2  g057(.a(new_n102_), .b(x25), .O(new_n103_));
  nand4  g058(.a(new_n103_), .b(new_n91_), .c(new_n88_), .d(new_n86_), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  inv1   g060(.a(new_n56_), .O(new_n106_));
  nand3  g061(.a(new_n106_), .b(x22), .c(x21), .O(new_n107_));
  aoi21  g062(.a(new_n107_), .b(new_n53_), .c(new_n89_), .O(new_n108_));
  oai21  g063(.a(new_n108_), .b(x25), .c(new_n47_), .O(new_n109_));
  ...
  inv1   g067(.a(new_n62_), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n54_), .c(new_n48_), .d(new_n47_), .O(new_n114_));
  nand2  g069(.a(new_n114_), .b(new_n50_), .O(z10));
  xor2a  g070(.a(x18), .b(x17), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n113_), .c(new_n48_), .d(new_n47_), .O(new_n117_));
  ...
  nand4  g075(.a(new_n120_), .b(new_n113_), .c(new_n48_), .d(new_n47_), .O(new_n121_));
  inv1   g076(.a(new_n121_), .O(z12));
  nand2  g077(.a(new_n98_), .b(new_n96_), .O(new_n123_));
  oai21  g078(.a(new_n61_), .b(new_n60_), .c(new_n48_), .O(new_n124_));
  ...
  nand4  g082(.a(new_n127_), .b(new_n125_), .c(new_n123_), .d(new_n47_), .O(z13));
  ...
  oai21  g087(.a(new_n132_), .b(x15), .c(new_n125_), .O(z14));
  inv1   g088(.a(x20), .O(new_n134_));
  inv1   g089(.a(new_n126_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n99_), .c(new_n134_), .O(new_n136_));
  nand2  g091(.a(new_n136_), .b(new_n47_), .O(new_n137_));
  aoi21  g092(.a(new_n130_), .b(x22), .c(new_n137_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(x15), .c(new_n125_), .O(z15));
  nand2  g094(.a(new_n136_), .b(x23), .O(new_n140_));
  nand4  g095(.a(new_n129_), .b(new_n135_), .c(new_n53_), .d(new_n92_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n125_), .d(new_n47_), .O(z16));
  nand3  g097(.a(new_n47_), .b(x05), .c(x04), .O(new_n143_));
  nand4  g098(.a(new_n99_), .b(x25), .c(new_n89_), .d(new_n53_), .O(new_n144_));
  ...
  nor2   g103(.a(new_n90_), .b(x23), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n99_), .c(new_n98_), .d(new_n96_), .O(new_n150_));
  and2   g105(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n147_), .c(new_n146_), .d(new_n47_), .O(z17));
  nand3  g107(.a(new_n101_), .b(x25), .c(new_n48_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n150_), .c(new_n125_), .d(new_n47_), .O(z18));
endmodule
