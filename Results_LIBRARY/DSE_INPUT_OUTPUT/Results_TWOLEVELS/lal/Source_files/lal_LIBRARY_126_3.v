...
module FAU ( 
  ...
  nand3  g57(.a(new_n95_), .b(new_n54_), .c(x19), .O(new_n103_));
  ...
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n100_), .d(new_n47_), .O(z14));
  ...
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n100_), .d(new_n47_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n108_), .b(new_n112_), .c(new_n117_), .d(new_n83_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n100_), .d(new_n47_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n103_), .O(new_n121_));
  nand3  g76(.a(new_n113_), .b(new_n82_), .c(new_n117_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n100_), .O(z17));
