...
module FAU ( 
  ...
  nand3  g14(.a(new_n59_), .b(new_n51_), .c(new_n48_), .O(new_n60_));
  ...
  aoi21  g27(.a(new_n72_), .b(x03), .c(x15), .O(new_n73_));
  oai21  g28(.a(new_n72_), .b(x03), .c(new_n73_), .O(new_n74_));
  nor2   g29(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(new_n70_), .c(x08), .O(z04));
  aoi21  g31(.a(new_n49_), .b(x13), .c(x08), .O(z05));
  inv1   g32(.a(x14), .O(new_n78_));
  aoi21  g33(.a(new_n49_), .b(new_n78_), .c(x08), .O(z06));
  ...
  nor2   g39(.a(new_n50_), .b(x25), .O(new_n85_));
  oai21  g40(.a(new_n84_), .b(new_n81_), .c(new_n85_), .O(z08));
  inv1   g41(.a(x07), .O(new_n87_));
  nand3  g42(.a(new_n62_), .b(new_n49_), .c(new_n87_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n51_), .O(z09));
  nand4  g44(.a(new_n61_), .b(new_n53_), .c(new_n49_), .d(new_n87_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n51_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n61_), .c(new_n49_), .d(new_n87_), .O(new_n93_));
  ...
  nand2  g60(.a(x15), .b(x08), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(z13));
  nand2  g62(.a(new_n102_), .b(new_n87_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n49_), .O(new_n109_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n49_), .O(z14));
  ...
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n109_), .d(new_n49_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  inv1   g74(.a(x23), .O(new_n120_));
  nand4  g75(.a(new_n111_), .b(new_n115_), .c(new_n120_), .d(new_n82_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n109_), .d(new_n49_), .O(z16));
  nand2  g77(.a(new_n121_), .b(x24), .O(new_n123_));
  inv1   g78(.a(x21), .O(new_n124_));
  nand4  g79(.a(new_n81_), .b(new_n120_), .c(new_n82_), .d(new_n124_), .O(new_n125_));
  or2    g80(.a(new_n125_), .b(new_n103_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n123_), .c(new_n109_), .d(new_n49_), .O(z17));
  ...
  nand4  g85(.a(new_n130_), .b(new_n116_), .c(new_n129_), .d(new_n95_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n128_), .c(new_n102_), .d(new_n87_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n49_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n106_), .O(z18));
endmodule
