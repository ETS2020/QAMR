...
module FAU ( 
  ...
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(new_n82_), .c(new_n48_), .O(z13));
  aoi21  g40(.a(new_n85_), .b(new_n82_), .c(z09), .O(z14));
  zero   g41(.O(z11));
  nor2   g42(.a(x15), .b(x07), .O(z10));
  nor2   g43(.a(x15), .b(x07), .O(z12));
  nand3  g44(.a(new_n85_), .b(new_n82_), .c(new_n48_), .O(z15));
  aoi21  g45(.a(new_n85_), .b(new_n82_), .c(z09), .O(z16));
  aoi21  g46(.a(new_n85_), .b(new_n82_), .c(z09), .O(z17));
  nand3  g47(.a(new_n85_), .b(new_n82_), .c(new_n48_), .O(z18));
endmodule
