...
module FAU ( 
  ...
  nand2  g021(.a(new_n60_), .b(new_n53_), .O(new_n67_));
  ...
  aoi21  g061(.a(new_n106_), .b(new_n54_), .c(new_n91_), .O(new_n107_));
  oai21  g062(.a(new_n107_), .b(x25), .c(new_n48_), .O(new_n108_));
  nand2  g063(.a(new_n108_), .b(new_n104_), .O(z08));
  nand3  g064(.a(new_n62_), .b(new_n48_), .c(new_n47_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n50_), .O(z09));
  nand4  g066(.a(new_n61_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n50_), .O(z10));
  xor2a  g068(.a(x18), .b(x17), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n115_));
  ...
  nand4  g084(.a(new_n95_), .b(new_n92_), .c(new_n129_), .d(x19), .O(new_n130_));
  ...
  inv1   g088(.a(new_n124_), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n98_), .c(new_n129_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  aoi21  g091(.a(new_n130_), .b(x22), .c(new_n136_), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(x15), .c(new_n122_), .O(z15));
  and2   g093(.a(new_n135_), .b(x23), .O(new_n139_));
  nand4  g094(.a(new_n54_), .b(new_n90_), .c(new_n92_), .d(new_n129_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n124_), .c(new_n47_), .O(new_n141_));
  oai21  g096(.a(new_n141_), .b(new_n139_), .c(new_n48_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n122_), .O(z16));
  nor2   g098(.a(new_n91_), .b(new_n54_), .O(new_n144_));
  nand4  g099(.a(new_n98_), .b(new_n53_), .c(new_n91_), .d(new_n54_), .O(new_n145_));
  nor2   g100(.a(new_n145_), .b(new_n123_), .O(new_n146_));
  oai21  g101(.a(new_n146_), .b(new_n144_), .c(new_n48_), .O(new_n147_));
  nand4  g102(.a(new_n98_), .b(x25), .c(new_n91_), .d(new_n54_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n123_), .c(new_n48_), .O(new_n149_));
  nor2   g104(.a(new_n149_), .b(new_n62_), .O(new_n150_));
  nand2  g105(.a(new_n135_), .b(x24), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n150_), .c(new_n147_), .d(new_n47_), .O(z17));
  oai21  g107(.a(new_n146_), .b(x07), .c(new_n48_), .O(new_n153_));
  aoi21  g108(.a(new_n100_), .b(x25), .c(new_n121_), .O(new_n154_));
  oai21  g109(.a(new_n154_), .b(x07), .c(new_n153_), .O(z18));
endmodule
