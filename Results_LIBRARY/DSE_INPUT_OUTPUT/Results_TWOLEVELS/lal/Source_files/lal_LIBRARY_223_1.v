...
module FAU ( 
  ...
  nand4  g40(.a(new_n47_), .b(new_n50_), .c(x05), .d(x04), .O(new_n86_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .d(new_n50_), .O(z13));
  ...
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n105_), .d(new_n50_), .O(z17));
