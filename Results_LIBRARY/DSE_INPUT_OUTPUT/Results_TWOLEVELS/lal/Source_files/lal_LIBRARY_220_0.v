...
module FAU ( 
  ...
  nand3  g35(.a(new_n80_), .b(new_n49_), .c(new_n46_), .O(new_n81_));
  ...
  nor2   g54(.a(new_n62_), .b(new_n61_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(x23), .c(new_n63_), .O(new_n101_));
  oai21  g56(.a(new_n100_), .b(new_n63_), .c(new_n101_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n92_), .c(new_n56_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(x23), .c(x15), .O(z12));
  nand4  g59(.a(new_n60_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  nand3  g60(.a(x19), .b(x18), .c(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nand4  g62(.a(new_n52_), .b(new_n56_), .c(x05), .d(x04), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n105_), .d(new_n56_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x23), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n52_), .O(z13));
  oai21  g66(.a(new_n92_), .b(x07), .c(x23), .O(new_n112_));
  ...
  oai21  g70(.a(new_n115_), .b(x07), .c(x23), .O(new_n116_));
  nand3  g71(.a(new_n100_), .b(new_n60_), .c(x19), .O(new_n117_));
  aoi21  g72(.a(new_n117_), .b(x21), .c(x15), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n113_), .O(z14));
  nand3  g74(.a(new_n67_), .b(new_n66_), .c(new_n60_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n106_), .c(new_n56_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(x23), .O(new_n122_));
  inv1   g77(.a(new_n100_), .O(new_n123_));
  oai21  g78(.a(new_n114_), .b(new_n123_), .c(x22), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n122_), .c(new_n113_), .d(new_n52_), .O(z15));
  nand4  g80(.a(new_n92_), .b(x19), .c(x18), .d(x17), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n52_), .O(new_n127_));
  aoi21  g82(.a(new_n67_), .b(new_n66_), .c(x20), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(x19), .c(x18), .d(x17), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n60_), .d(new_n56_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(x23), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n52_), .O(z16));
  oai21  g87(.a(x24), .b(x07), .c(x23), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n113_), .c(new_n52_), .O(z17));
  nand3  g89(.a(new_n108_), .b(new_n59_), .c(new_n56_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(x23), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n52_), .O(z18));
endmodule
