...
module FAU ( 
  ...
  nand2  g033(.a(x08), .b(x06), .O(new_n79_));
  oai21  g034(.a(x15), .b(x06), .c(new_n79_), .O(z07));
  inv1   g035(.a(x17), .O(new_n81_));
  nand3  g036(.a(x24), .b(x22), .c(x21), .O(new_n82_));
  oai21  g037(.a(new_n82_), .b(new_n57_), .c(new_n53_), .O(new_n83_));
  ...
  nand3  g042(.a(new_n59_), .b(x19), .c(x18), .O(new_n88_));
  inv1   g043(.a(new_n88_), .O(new_n89_));
  and2   g044(.a(x18), .b(x17), .O(new_n90_));
  nor2   g045(.a(x20), .b(new_n56_), .O(new_n91_));
  ...
  nand4  g049(.a(new_n94_), .b(new_n89_), .c(new_n52_), .d(new_n60_), .O(new_n95_));
  ...
  nand3  g054(.a(new_n58_), .b(x22), .c(x21), .O(new_n100_));
  aoi21  g055(.a(new_n100_), .b(new_n99_), .c(new_n52_), .O(new_n101_));
  oai21  g056(.a(new_n101_), .b(x25), .c(x06), .O(new_n102_));
  nand2  g057(.a(new_n102_), .b(new_n98_), .O(z08));
  nand4  g058(.a(new_n47_), .b(new_n50_), .c(x05), .d(x04), .O(new_n104_));
  nand2  g059(.a(new_n104_), .b(new_n51_), .O(z09));
  nand4  g060(.a(new_n64_), .b(new_n81_), .c(new_n47_), .d(new_n50_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z10));
  xor2a  g062(.a(x18), .b(x17), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n64_), .c(new_n47_), .d(new_n50_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n51_), .O(z11));
  nand3  g065(.a(new_n56_), .b(x18), .c(x17), .O(new_n111_));
  oai21  g066(.a(new_n90_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand4  g067(.a(new_n112_), .b(new_n64_), .c(new_n47_), .d(new_n50_), .O(new_n113_));
  ...
  nand3  g079(.a(new_n124_), .b(new_n104_), .c(new_n50_), .O(new_n125_));
  aoi21  g080(.a(new_n115_), .b(x21), .c(new_n125_), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(new_n47_), .O(z14));
  inv1   g082(.a(new_n116_), .O(new_n128_));
  nand3  g083(.a(new_n128_), .b(new_n92_), .c(new_n54_), .O(new_n129_));
  ...
  nand4  g087(.a(new_n123_), .b(new_n128_), .c(new_n99_), .d(new_n60_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n104_), .c(new_n50_), .O(new_n134_));
  aoi21  g089(.a(new_n129_), .b(x23), .c(new_n134_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(new_n47_), .O(z16));
  nand3  g091(.a(new_n93_), .b(new_n60_), .c(new_n59_), .O(new_n137_));
  nor2   g092(.a(new_n137_), .b(x20), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(x19), .c(x18), .d(x17), .O(new_n139_));
  nand2  g094(.a(new_n133_), .b(x24), .O(new_n140_));
  nand4  g095(.a(new_n140_), .b(new_n139_), .c(new_n118_), .d(new_n50_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n47_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n121_), .O(z17));
  nand2  g098(.a(new_n94_), .b(x25), .O(new_n144_));
  nor3   g099(.a(x25), .b(x24), .c(x23), .O(new_n145_));
  nand4  g100(.a(new_n145_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n144_), .c(new_n118_), .d(new_n50_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n121_), .O(z18));
endmodule
