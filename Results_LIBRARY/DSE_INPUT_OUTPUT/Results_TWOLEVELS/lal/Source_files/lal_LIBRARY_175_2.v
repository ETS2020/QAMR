...
module FAU ( 
  ...
  nand2  g031(.a(new_n76_), .b(new_n68_), .O(z04));
  ...
  nand3  g058(.a(new_n59_), .b(x22), .c(x21), .O(new_n104_));
  aoi21  g059(.a(new_n104_), .b(new_n54_), .c(new_n88_), .O(new_n105_));
  oai21  g060(.a(new_n105_), .b(x25), .c(x15), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n103_), .O(z08));
  nand3  g062(.a(new_n47_), .b(x05), .c(x04), .O(new_n108_));
  ...
  nand4  g070(.a(new_n115_), .b(new_n112_), .c(new_n50_), .d(new_n47_), .O(new_n116_));
  inv1   g071(.a(new_n116_), .O(z11));
  nand3  g072(.a(new_n57_), .b(x18), .c(x17), .O(new_n118_));
  oai21  g073(.a(new_n95_), .b(new_n57_), .c(new_n118_), .O(new_n119_));
  nand4  g074(.a(new_n119_), .b(new_n112_), .c(new_n50_), .d(new_n47_), .O(new_n120_));
  inv1   g075(.a(new_n120_), .O(z12));
  nand4  g076(.a(new_n55_), .b(x19), .c(x18), .d(x17), .O(new_n122_));
  nand3  g077(.a(x19), .b(x18), .c(x17), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(x20), .O(new_n124_));
  nand4  g079(.a(new_n124_), .b(new_n110_), .c(new_n122_), .d(new_n50_), .O(z13));
  nand3  g080(.a(new_n50_), .b(x05), .c(x04), .O(new_n126_));
  nor2   g081(.a(x21), .b(x20), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n95_), .c(x19), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  aoi21  g084(.a(new_n122_), .b(x21), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x07), .c(new_n50_), .O(z14));
  nand2  g086(.a(new_n128_), .b(x22), .O(new_n132_));
  inv1   g087(.a(new_n97_), .O(new_n133_));
  nor3   g088(.a(new_n123_), .b(new_n133_), .c(x20), .O(new_n134_));
  inv1   g089(.a(new_n134_), .O(new_n135_));
  nand4  g090(.a(new_n135_), .b(new_n132_), .c(new_n110_), .d(new_n50_), .O(z15));
  nor2   g091(.a(new_n134_), .b(new_n54_), .O(new_n137_));
  inv1   g092(.a(new_n123_), .O(new_n138_));
  nand4  g093(.a(new_n127_), .b(new_n138_), .c(new_n54_), .d(new_n91_), .O(new_n139_));
  nand2  g094(.a(new_n139_), .b(new_n126_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n137_), .c(new_n47_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n50_), .O(z16));
  nand3  g097(.a(new_n98_), .b(new_n91_), .c(new_n92_), .O(new_n143_));
  nor2   g098(.a(new_n143_), .b(x20), .O(new_n144_));
  nand4  g099(.a(new_n144_), .b(x19), .c(x18), .d(x17), .O(new_n145_));
  nand2  g100(.a(new_n139_), .b(x24), .O(new_n146_));
  nand3  g101(.a(new_n146_), .b(new_n145_), .c(new_n126_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  nand2  g103(.a(new_n148_), .b(new_n50_), .O(z17));
  nor4   g104(.a(new_n133_), .b(new_n122_), .c(new_n89_), .d(x23), .O(new_n150_));
  aoi21  g105(.a(new_n99_), .b(x25), .c(new_n150_), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n108_), .c(new_n50_), .d(new_n47_), .O(z18));
endmodule
