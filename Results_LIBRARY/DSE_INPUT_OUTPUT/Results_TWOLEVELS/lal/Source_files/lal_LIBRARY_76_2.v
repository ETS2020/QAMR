...
module FAU ( 
  ...
  nand3  g16(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z01));
  inv1   g17(.a(x16), .O(new_n63_));
  nor2   g18(.a(new_n48_), .b(new_n63_), .O(z02));
  ...
  nand2  g32(.a(new_n55_), .b(new_n54_), .O(new_n78_));
  nand3  g33(.a(x24), .b(x22), .c(x21), .O(new_n79_));
  oai21  g34(.a(new_n79_), .b(new_n78_), .c(new_n51_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n53_), .O(new_n81_));
  nand2  g36(.a(new_n79_), .b(new_n51_), .O(new_n82_));
  ...
  nor2   g45(.a(x20), .b(new_n55_), .O(new_n91_));
  nor2   g46(.a(x22), .b(x21), .O(new_n92_));
  nor2   g47(.a(x24), .b(x23), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n89_), .c(new_n86_), .d(new_n85_), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(x25), .c(new_n48_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n84_), .c(new_n83_), .d(new_n81_), .O(z08));
  aoi21  g52(.a(x05), .b(x04), .c(x07), .O(new_n98_));
  nor2   g53(.a(new_n98_), .b(x15), .O(z09));
  inv1   g54(.a(x15), .O(new_n100_));
  nand4  g55(.a(new_n61_), .b(new_n53_), .c(new_n100_), .d(new_n47_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z10));
  xor2a  g57(.a(x18), .b(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n61_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n47_), .c(x15), .O(z11));
  nand3  g60(.a(new_n55_), .b(x18), .c(x17), .O(new_n106_));
  oai21  g61(.a(new_n90_), .b(new_n55_), .c(new_n106_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n61_), .c(new_n100_), .d(new_n47_), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(z12));
  nand2  g64(.a(new_n91_), .b(new_n90_), .O(new_n110_));
  nand3  g65(.a(x19), .b(x18), .c(x17), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x20), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n98_), .c(new_n110_), .d(new_n100_), .O(z13));
  nand3  g68(.a(new_n100_), .b(x05), .c(x04), .O(new_n114_));
  nor2   g69(.a(x21), .b(x20), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n90_), .c(x19), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  aoi21  g72(.a(new_n110_), .b(x21), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x07), .c(new_n100_), .O(z14));
  inv1   g74(.a(new_n111_), .O(new_n120_));
  ...
  oai21  g79(.a(new_n124_), .b(x07), .c(new_n100_), .O(z15));
  inv1   g80(.a(x23), .O(new_n126_));
  aoi21  g81(.a(new_n121_), .b(new_n120_), .c(new_n126_), .O(new_n127_));
  nand4  g82(.a(new_n115_), .b(new_n120_), .c(new_n126_), .d(new_n85_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n114_), .O(new_n129_));
  oai21  g84(.a(new_n129_), .b(new_n127_), .c(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n100_), .O(z16));
  inv1   g86(.a(z09), .O(new_n132_));
  nand3  g87(.a(new_n93_), .b(new_n85_), .c(new_n87_), .O(new_n133_));
  nor2   g88(.a(new_n133_), .b(x20), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(x19), .c(x18), .d(x17), .O(new_n135_));
  aoi21  g90(.a(new_n128_), .b(x24), .c(x15), .O(new_n136_));
  nand3  g91(.a(new_n136_), .b(new_n135_), .c(new_n132_), .O(z17));
  nand2  g92(.a(new_n94_), .b(x25), .O(new_n138_));
  nor3   g93(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nand4  g94(.a(new_n139_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n138_), .c(new_n132_), .d(new_n100_), .O(z18));
endmodule
