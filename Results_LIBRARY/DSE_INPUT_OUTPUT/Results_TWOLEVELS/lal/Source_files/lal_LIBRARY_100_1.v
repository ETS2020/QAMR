...
module FAU ( 
  ...
  aoi21  g023(.a(x11), .b(new_n46_), .c(x15), .O(new_n69_));
  ...
  oai21  g035(.a(new_n69_), .b(x02), .c(new_n80_), .O(z04));
  ...
  oai21  g061(.a(new_n106_), .b(x25), .c(x02), .O(new_n107_));
  nand2  g062(.a(new_n107_), .b(new_n103_), .O(z08));
  nand2  g063(.a(new_n47_), .b(new_n51_), .O(new_n109_));
  oai21  g064(.a(new_n109_), .b(new_n64_), .c(new_n49_), .O(z09));
  nand4  g065(.a(new_n64_), .b(new_n86_), .c(new_n47_), .d(new_n51_), .O(new_n111_));
  inv1   g066(.a(new_n111_), .O(z10));
  xor2a  g067(.a(x18), .b(x17), .O(new_n113_));
  nand4  g068(.a(new_n113_), .b(new_n64_), .c(new_n47_), .d(new_n51_), .O(new_n114_));
  ...
  nand3  g075(.a(new_n51_), .b(x05), .c(x04), .O(new_n121_));
  nand2  g076(.a(new_n121_), .b(new_n51_), .O(new_n122_));
  ...
  nand3  g085(.a(new_n130_), .b(new_n121_), .c(new_n51_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(new_n128_), .c(new_n47_), .O(new_n132_));
  nand2  g087(.a(x15), .b(x02), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n132_), .O(z14));
  inv1   g089(.a(new_n124_), .O(new_n135_));
  nand3  g090(.a(new_n135_), .b(new_n97_), .c(new_n54_), .O(new_n136_));
  nand3  g091(.a(new_n136_), .b(new_n121_), .c(new_n51_), .O(new_n137_));
  aoi21  g092(.a(new_n130_), .b(x22), .c(new_n137_), .O(new_n138_));
  oai21  g093(.a(new_n138_), .b(x15), .c(new_n133_), .O(z15));
  nand2  g094(.a(new_n136_), .b(x23), .O(new_n140_));
  nand4  g095(.a(new_n129_), .b(new_n135_), .c(new_n104_), .d(new_n60_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n123_), .d(new_n47_), .O(z16));
  nand3  g097(.a(new_n98_), .b(new_n60_), .c(new_n59_), .O(new_n143_));
  ...
  nand3  g101(.a(new_n146_), .b(new_n121_), .c(new_n51_), .O(new_n147_));
  inv1   g102(.a(new_n147_), .O(new_n148_));
  nand2  g103(.a(new_n136_), .b(x24), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n148_), .c(new_n145_), .d(new_n47_), .O(z17));
  nand2  g105(.a(new_n99_), .b(x25), .O(new_n151_));
  nor3   g106(.a(x25), .b(x24), .c(x23), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n97_), .c(new_n127_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n151_), .c(new_n121_), .d(new_n51_), .O(new_n154_));
  nand2  g109(.a(new_n154_), .b(new_n47_), .O(new_n155_));
  nand2  g110(.a(new_n155_), .b(new_n133_), .O(z18));
endmodule
