...
module FAU ( 
  ...
  nand2  g21(.a(new_n62_), .b(new_n54_), .O(new_n67_));
  ...
  aoi21  g36(.a(new_n59_), .b(new_n55_), .c(new_n81_), .O(new_n82_));
  ...
  nor2   g41(.a(new_n86_), .b(x07), .O(z09));
  nand2  g42(.a(x05), .b(x04), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n56_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n48_), .c(x07), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n88_), .c(new_n48_), .d(new_n53_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z11));
  aoi21  g48(.a(new_n57_), .b(new_n48_), .c(new_n56_), .O(new_n94_));
  nand3  g49(.a(new_n58_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(new_n58_), .c(new_n95_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n48_), .c(x07), .O(z12));
  ...
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n63_), .O(new_n102_));
  ...
  nand2  g61(.a(new_n106_), .b(new_n63_), .O(new_n107_));
  aoi21  g62(.a(new_n101_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(x15), .c(new_n53_), .O(z14));
  inv1   g64(.a(new_n99_), .O(new_n110_));
  nor2   g65(.a(x22), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n55_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n63_), .O(new_n113_));
  aoi21  g68(.a(new_n106_), .b(x22), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(x15), .c(new_n53_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n105_), .b(new_n110_), .c(new_n117_), .d(new_n81_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n86_), .d(new_n53_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  inv1   g75(.a(new_n101_), .O(new_n121_));
  nand3  g76(.a(new_n111_), .b(new_n80_), .c(new_n117_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n120_), .c(new_n63_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n53_), .O(z17));
  oai21  g82(.a(new_n122_), .b(new_n101_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n111_), .c(new_n121_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n128_), .c(new_n63_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n53_), .O(z18));
endmodule
