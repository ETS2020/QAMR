...
module FAU ( 
  ...
  nor2   g003(.a(x24), .b(new_n48_), .O(new_n49_));
  ...
  nand3  g018(.a(new_n63_), .b(x24), .c(new_n57_), .O(new_n64_));
  nand2  g019(.a(new_n53_), .b(new_n48_), .O(new_n65_));
  aoi21  g020(.a(new_n65_), .b(new_n64_), .c(x25), .O(z03));
  inv1   g021(.a(z03), .O(new_n67_));
  ...
  nand2  g036(.a(x25), .b(new_n48_), .O(new_n82_));
  oai21  g037(.a(new_n81_), .b(new_n61_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g041(.a(new_n82_), .b(new_n53_), .O(new_n87_));
  nand2  g042(.a(new_n87_), .b(x23), .O(new_n88_));
  inv1   g043(.a(x21), .O(new_n89_));
  inv1   g044(.a(x22), .O(new_n90_));
  nor2   g045(.a(new_n60_), .b(new_n59_), .O(new_n91_));
  nor2   g046(.a(new_n59_), .b(new_n80_), .O(new_n92_));
  ...
  nand2  g053(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  ...
  nand3  g060(.a(new_n105_), .b(new_n48_), .c(new_n102_), .O(new_n106_));
  inv1   g061(.a(new_n106_), .O(z09));
  inv1   g062(.a(new_n105_), .O(new_n108_));
  nand4  g063(.a(new_n108_), .b(new_n80_), .c(new_n48_), .d(new_n102_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n50_), .O(z10));
  xor2a  g065(.a(x18), .b(x17), .O(new_n111_));
  nand4  g066(.a(new_n111_), .b(new_n108_), .c(new_n48_), .d(new_n102_), .O(new_n112_));
  inv1   g067(.a(new_n112_), .O(z11));
  nand3  g068(.a(new_n60_), .b(x18), .c(x17), .O(new_n114_));
  oai21  g069(.a(new_n92_), .b(new_n60_), .c(new_n114_), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n108_), .c(new_n48_), .d(new_n102_), .O(new_n116_));
  ...
  nand2  g076(.a(new_n91_), .b(x17), .O(new_n122_));
  nand2  g077(.a(new_n122_), .b(x20), .O(new_n123_));
  nand4  g078(.a(new_n123_), .b(new_n121_), .c(new_n118_), .d(new_n48_), .O(z13));
  ...
  nand4  g082(.a(new_n127_), .b(new_n125_), .c(new_n121_), .d(new_n48_), .O(z14));
  nand3  g083(.a(new_n102_), .b(x05), .c(x04), .O(new_n129_));
  nand2  g084(.a(new_n127_), .b(x22), .O(new_n130_));
  inv1   g085(.a(new_n122_), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n94_), .c(new_n58_), .O(new_n132_));
  nand4  g087(.a(new_n132_), .b(new_n130_), .c(new_n129_), .d(new_n102_), .O(new_n133_));
  nand2  g088(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  oai21  g089(.a(new_n53_), .b(new_n48_), .c(new_n134_), .O(z15));
  nand2  g090(.a(new_n132_), .b(x23), .O(new_n136_));
  nand4  g091(.a(new_n126_), .b(new_n131_), .c(new_n57_), .d(new_n90_), .O(new_n137_));
  nand4  g092(.a(new_n137_), .b(new_n136_), .c(new_n121_), .d(new_n48_), .O(z16));
  aoi21  g093(.a(x25), .b(x15), .c(x24), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n57_), .c(new_n90_), .d(new_n89_), .O(new_n140_));
  nor2   g095(.a(new_n140_), .b(x20), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(x19), .c(x18), .d(x17), .O(new_n142_));
  nand2  g097(.a(new_n137_), .b(x24), .O(new_n143_));
  nand4  g098(.a(new_n143_), .b(new_n142_), .c(new_n119_), .d(new_n48_), .O(z17));
  nand2  g099(.a(new_n137_), .b(x25), .O(new_n145_));
  inv1   g100(.a(new_n118_), .O(new_n146_));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n147_));
  and2   g102(.a(new_n147_), .b(new_n94_), .O(new_n148_));
  aoi22  g103(.a(new_n148_), .b(new_n146_), .c(x25), .d(x24), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n145_), .c(new_n119_), .d(new_n48_), .O(z18));
endmodule
