...
module FAU ( 
  ...
  oai21  g042(.a(new_n87_), .b(new_n86_), .c(new_n62_), .O(new_n88_));
  nand2  g043(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  oai21  g044(.a(x25), .b(x15), .c(new_n51_), .O(new_n90_));
  nand2  g045(.a(new_n87_), .b(new_n62_), .O(new_n91_));
  nand2  g046(.a(new_n91_), .b(x20), .O(new_n92_));
  nor2   g047(.a(x25), .b(x24), .O(new_n93_));
  nor2   g048(.a(new_n93_), .b(new_n55_), .O(new_n94_));
  ...
  nand4  g056(.a(new_n101_), .b(new_n96_), .c(new_n56_), .d(new_n95_), .O(new_n102_));
  aoi21  g057(.a(new_n102_), .b(x25), .c(new_n94_), .O(new_n103_));
  nand4  g058(.a(new_n103_), .b(new_n92_), .c(new_n90_), .d(new_n89_), .O(z08));
  nand4  g059(.a(new_n47_), .b(new_n54_), .c(x05), .d(x04), .O(new_n105_));
  inv1   g060(.a(new_n105_), .O(z09));
  nand2  g061(.a(x05), .b(x04), .O(new_n107_));
  nand4  g062(.a(new_n107_), .b(new_n84_), .c(new_n47_), .d(new_n54_), .O(new_n108_));
  inv1   g063(.a(new_n108_), .O(z10));
  xor2a  g064(.a(x18), .b(x17), .O(new_n110_));
  nand4  g065(.a(new_n110_), .b(new_n107_), .c(new_n47_), .d(new_n54_), .O(new_n111_));
  nand2  g066(.a(new_n111_), .b(new_n49_), .O(z11));
  nand3  g067(.a(new_n51_), .b(x18), .c(x17), .O(new_n113_));
  oai21  g068(.a(new_n97_), .b(new_n51_), .c(new_n113_), .O(new_n114_));
  nand4  g069(.a(new_n114_), .b(new_n107_), .c(new_n47_), .d(new_n54_), .O(new_n115_));
  inv1   g070(.a(new_n115_), .O(z12));
  nand2  g071(.a(new_n98_), .b(new_n97_), .O(new_n117_));
  inv1   g072(.a(x04), .O(new_n118_));
  inv1   g073(.a(x05), .O(new_n119_));
  oai21  g074(.a(new_n119_), .b(new_n118_), .c(new_n54_), .O(new_n120_));
  ...
  nand4  g078(.a(new_n123_), .b(new_n121_), .c(new_n117_), .d(new_n47_), .O(z13));
  nand2  g079(.a(new_n117_), .b(x21), .O(new_n125_));
  nor2   g080(.a(x21), .b(x20), .O(new_n126_));
  nand3  g081(.a(new_n126_), .b(new_n97_), .c(x19), .O(new_n127_));
  nand4  g082(.a(new_n127_), .b(new_n125_), .c(new_n121_), .d(new_n47_), .O(z14));
  nor2   g083(.a(new_n98_), .b(x15), .O(new_n129_));
  aoi21  g084(.a(new_n96_), .b(x17), .c(new_n51_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(new_n129_), .c(x22), .O(new_n131_));
  nand2  g086(.a(new_n99_), .b(new_n61_), .O(new_n132_));
  nor3   g087(.a(new_n132_), .b(new_n85_), .c(new_n84_), .O(new_n133_));
  oai21  g088(.a(new_n133_), .b(x15), .c(x19), .O(new_n134_));
  nand3  g089(.a(new_n134_), .b(new_n131_), .c(new_n121_), .O(z15));
  oai21  g090(.a(new_n132_), .b(new_n122_), .c(x23), .O(new_n136_));
  inv1   g091(.a(new_n122_), .O(new_n137_));
  nand4  g092(.a(new_n126_), .b(new_n137_), .c(new_n55_), .d(new_n95_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n136_), .c(new_n121_), .d(new_n47_), .O(z16));
  inv1   g094(.a(x21), .O(new_n140_));
  nor3   g095(.a(x24), .b(x23), .c(x22), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n61_), .d(x18), .O(new_n142_));
  nand2  g097(.a(new_n99_), .b(new_n97_), .O(new_n143_));
  aoi21  g098(.a(new_n143_), .b(x24), .c(x15), .O(new_n144_));
  oai21  g099(.a(new_n142_), .b(new_n84_), .c(new_n144_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(x19), .O(new_n146_));
  nor2   g101(.a(x23), .b(x20), .O(new_n147_));
  aoi21  g102(.a(new_n147_), .b(x19), .c(new_n56_), .O(new_n148_));
  oai21  g103(.a(new_n148_), .b(new_n120_), .c(new_n47_), .O(new_n149_));
  nand2  g104(.a(new_n149_), .b(new_n146_), .O(z17));
  nand2  g105(.a(new_n101_), .b(x25), .O(new_n151_));
  inv1   g106(.a(new_n117_), .O(new_n152_));
  nand4  g107(.a(new_n99_), .b(new_n152_), .c(new_n93_), .d(new_n55_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n151_), .c(new_n121_), .d(new_n47_), .O(z18));
endmodule
