...
module FAU ( 
  ...
  aoi22  g30(.a(new_n72_), .b(x01), .c(new_n75_), .d(x00), .O(new_n76_));
  ...
  aoi21  g41(.a(new_n57_), .b(new_n53_), .c(new_n60_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x21), .c(x23), .O(new_n88_));
  nor2   g43(.a(new_n48_), .b(x25), .O(new_n89_));
  oai21  g44(.a(new_n88_), .b(new_n51_), .c(new_n89_), .O(z08));
  inv1   g45(.a(x07), .O(new_n91_));
  nand3  g46(.a(new_n65_), .b(new_n47_), .c(new_n91_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z09));
  nand4  g48(.a(new_n64_), .b(new_n54_), .c(new_n47_), .d(new_n91_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n64_), .c(new_n47_), .d(new_n91_), .O(new_n97_));
  ...
  and2   g77(.a(new_n122_), .b(new_n113_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n119_), .c(new_n47_), .d(new_n91_), .O(z15));
  nand2  g79(.a(new_n122_), .b(x23), .O(new_n125_));
  inv1   g80(.a(new_n113_), .O(new_n126_));
  inv1   g81(.a(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n60_), .c(new_n59_), .d(new_n53_), .O(new_n128_));
  inv1   g83(.a(new_n128_), .O(new_n129_));
  aoi21  g84(.a(new_n129_), .b(new_n120_), .c(new_n126_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n125_), .c(new_n47_), .d(new_n91_), .O(z16));
  oai21  g86(.a(new_n128_), .b(new_n104_), .c(x24), .O(new_n132_));
  nor2   g87(.a(x24), .b(x23), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n121_), .c(new_n107_), .d(new_n99_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n106_), .d(new_n91_), .O(new_n135_));
  nand2  g90(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  nand2  g91(.a(new_n136_), .b(new_n111_), .O(z17));
  nand2  g92(.a(new_n134_), .b(x25), .O(new_n138_));
  inv1   g93(.a(new_n108_), .O(new_n139_));
  nor3   g94(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  and2   g95(.a(new_n140_), .b(new_n121_), .O(new_n141_));
  aoi21  g96(.a(new_n141_), .b(new_n139_), .c(new_n126_), .O(new_n142_));
  nand4  g97(.a(new_n142_), .b(new_n138_), .c(new_n47_), .d(new_n91_), .O(z18));
endmodule
