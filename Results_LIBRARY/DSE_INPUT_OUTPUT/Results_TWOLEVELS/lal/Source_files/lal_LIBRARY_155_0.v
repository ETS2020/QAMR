...
module FAU ( 
  ...
  nand2  g24(.a(new_n59_), .b(new_n50_), .O(z03));
  ...
  aoi21  g37(.a(new_n82_), .b(new_n49_), .c(new_n47_), .O(z08));
  nor2   g38(.a(new_n58_), .b(x25), .O(new_n88_));
  aoi21  g39(.a(new_n88_), .b(new_n82_), .c(new_n47_), .O(z13));
  nand3  g40(.a(new_n88_), .b(new_n82_), .c(new_n50_), .O(z14));
  zero   g41(.O(z09));
  zero   g42(.O(z10));
  zero   g43(.O(z11));
  zero   g44(.O(z12));
  nand3  g45(.a(new_n88_), .b(new_n82_), .c(new_n50_), .O(z15));
  aoi21  g46(.a(new_n88_), .b(new_n82_), .c(new_n47_), .O(z16));
  nand3  g47(.a(new_n88_), .b(new_n82_), .c(new_n50_), .O(z17));
  nand3  g48(.a(new_n88_), .b(new_n82_), .c(new_n50_), .O(z18));
endmodule
