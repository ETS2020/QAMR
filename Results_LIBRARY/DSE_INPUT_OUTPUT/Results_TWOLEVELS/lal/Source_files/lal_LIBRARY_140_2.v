...
module FAU ( 
  ...
  oai21  g34(.a(new_n79_), .b(new_n78_), .c(new_n50_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  nand2  g36(.a(new_n79_), .b(new_n50_), .O(new_n82_));
  ...
  nor2   g45(.a(x20), .b(new_n54_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n60_), .b(new_n52_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g56(.a(x18), .b(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n60_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n47_), .c(x15), .O(z11));
  inv1   g59(.a(x15), .O(new_n105_));
  nand3  g60(.a(new_n54_), .b(x18), .c(x17), .O(new_n106_));
  oai21  g61(.a(new_n90_), .b(new_n54_), .c(new_n106_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n60_), .c(new_n105_), .d(new_n47_), .O(new_n108_));
  ...
  nand4  g67(.a(new_n112_), .b(new_n98_), .c(new_n110_), .d(new_n105_), .O(z13));
  inv1   g68(.a(z09), .O(new_n114_));
  nand2  g69(.a(new_n110_), .b(x21), .O(new_n115_));
  nor2   g70(.a(x21), .b(x20), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n90_), .c(x19), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n105_), .O(z14));
  nand3  g73(.a(new_n105_), .b(x05), .c(x04), .O(new_n119_));
  inv1   g74(.a(new_n111_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n92_), .c(new_n51_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  aoi21  g77(.a(new_n117_), .b(x22), .c(new_n122_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(x07), .c(new_n105_), .O(z15));
  nand2  g79(.a(new_n121_), .b(x23), .O(new_n125_));
  nor2   g80(.a(x23), .b(x22), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n116_), .c(new_n120_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n114_), .d(new_n105_), .O(z16));
  nand3  g83(.a(new_n93_), .b(new_n85_), .c(new_n87_), .O(new_n129_));
  nor2   g84(.a(new_n129_), .b(x20), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(x19), .c(x18), .d(x17), .O(new_n131_));
  aoi21  g86(.a(new_n127_), .b(x24), .c(x15), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n131_), .c(new_n114_), .O(z17));
  nand2  g88(.a(new_n94_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n114_), .d(new_n105_), .O(z18));
endmodule
