...
module FAU ( 
  ...
  inv1   g037(.a(new_n56_), .O(new_n83_));
  ...
  nand4  g055(.a(new_n100_), .b(new_n94_), .c(new_n91_), .d(new_n90_), .O(new_n101_));
  ...
  nand2  g060(.a(new_n57_), .b(new_n54_), .O(new_n106_));
  nand3  g061(.a(new_n106_), .b(x22), .c(x21), .O(new_n107_));
  aoi21  g062(.a(new_n107_), .b(new_n105_), .c(new_n91_), .O(new_n108_));
  oai21  g063(.a(new_n108_), .b(x25), .c(new_n48_), .O(new_n109_));
  nand2  g064(.a(new_n109_), .b(new_n104_), .O(z08));
  nand3  g065(.a(new_n62_), .b(new_n48_), .c(new_n47_), .O(new_n111_));
  inv1   g066(.a(new_n111_), .O(z09));
  nand4  g067(.a(new_n61_), .b(new_n55_), .c(new_n48_), .d(new_n47_), .O(new_n113_));
  nand2  g068(.a(new_n113_), .b(new_n50_), .O(z10));
  xor2a  g069(.a(x18), .b(x17), .O(new_n115_));
  nand4  g070(.a(new_n115_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n116_));
  ...
  nand4  g074(.a(new_n119_), .b(new_n61_), .c(new_n48_), .d(new_n47_), .O(new_n120_));
  nand2  g075(.a(new_n120_), .b(new_n50_), .O(z12));
  nand2  g076(.a(new_n97_), .b(new_n95_), .O(new_n122_));
  nand2  g077(.a(new_n61_), .b(new_n48_), .O(new_n123_));
  ...
  nand4  g081(.a(new_n126_), .b(new_n124_), .c(new_n122_), .d(new_n47_), .O(z13));
  nand2  g082(.a(new_n122_), .b(x21), .O(new_n128_));
  nor2   g083(.a(x21), .b(x20), .O(new_n129_));
  nand3  g084(.a(new_n129_), .b(new_n95_), .c(x19), .O(new_n130_));
  nand4  g085(.a(new_n130_), .b(new_n128_), .c(new_n124_), .d(new_n47_), .O(z14));
  nand2  g086(.a(new_n130_), .b(x22), .O(new_n132_));
  nand2  g087(.a(new_n98_), .b(new_n54_), .O(new_n133_));
  nor2   g088(.a(new_n133_), .b(new_n125_), .O(new_n134_));
  ...
  nand2  g092(.a(new_n137_), .b(new_n124_), .O(z15));
  nor2   g093(.a(new_n134_), .b(new_n105_), .O(new_n139_));
  nand3  g094(.a(new_n129_), .b(new_n105_), .c(new_n90_), .O(new_n140_));
  oai21  g095(.a(new_n140_), .b(new_n125_), .c(new_n47_), .O(new_n141_));
  oai21  g096(.a(new_n141_), .b(new_n139_), .c(new_n48_), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n124_), .O(z16));
  nand2  g098(.a(x25), .b(new_n47_), .O(new_n144_));
  nand2  g099(.a(new_n53_), .b(new_n48_), .O(new_n145_));
  aoi21  g100(.a(new_n145_), .b(new_n144_), .c(x24), .O(new_n146_));
  nand4  g101(.a(new_n146_), .b(new_n105_), .c(new_n90_), .d(new_n92_), .O(new_n147_));
  nor2   g102(.a(new_n147_), .b(x20), .O(new_n148_));
  nand4  g103(.a(new_n148_), .b(x19), .c(x18), .d(x17), .O(new_n149_));
  oai21  g104(.a(new_n140_), .b(new_n125_), .c(x24), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(new_n47_), .O(new_n151_));
  nand2  g106(.a(new_n151_), .b(new_n48_), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n149_), .c(new_n124_), .O(z17));
  nand4  g108(.a(new_n98_), .b(new_n53_), .c(new_n91_), .d(new_n105_), .O(new_n154_));
  oai21  g109(.a(new_n154_), .b(new_n122_), .c(new_n47_), .O(new_n155_));
  nand2  g110(.a(new_n155_), .b(new_n48_), .O(new_n156_));
  aoi21  g111(.a(new_n100_), .b(x25), .c(new_n123_), .O(new_n157_));
  oai21  g112(.a(new_n157_), .b(x07), .c(new_n156_), .O(z18));
endmodule
