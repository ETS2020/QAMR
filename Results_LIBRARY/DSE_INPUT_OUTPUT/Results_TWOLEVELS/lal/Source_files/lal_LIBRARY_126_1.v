...
module FAU ( 
  ...
  nand3  g14(.a(new_n50_), .b(x05), .c(x04), .O(new_n60_));
  ...
  nand4  g43(.a(new_n88_), .b(new_n53_), .c(new_n47_), .d(new_n50_), .O(new_n89_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n110_), .c(new_n105_), .d(new_n50_), .O(z15));
  nand2  g69(.a(new_n113_), .b(x23), .O(new_n115_));
  inv1   g70(.a(x23), .O(new_n116_));
  nand4  g71(.a(new_n107_), .b(new_n111_), .c(new_n116_), .d(new_n81_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n105_), .d(new_n50_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n101_), .O(new_n120_));
  nand3  g75(.a(new_n112_), .b(new_n80_), .c(new_n116_), .O(new_n121_));
  inv1   g76(.a(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n60_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n50_), .O(z17));
  ...
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n105_), .d(new_n50_), .O(z18));
endmodule
