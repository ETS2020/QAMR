...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n68_, new_n71_, new_n73_, new_n74_, new_n75_, new_n76_, new_n77_,
  ...
  nand3  g023(.a(new_n68_), .b(new_n64_), .c(new_n47_), .O(z01));
  nor2   g024(.a(new_n49_), .b(new_n46_), .O(z02));
  nand3  g025(.a(new_n63_), .b(new_n50_), .c(new_n53_), .O(new_n71_));
  ...
  nand3  g036(.a(new_n50_), .b(new_n81_), .c(new_n73_), .O(new_n82_));
  inv1   g037(.a(new_n82_), .O(z05));
  nand3  g038(.a(new_n50_), .b(x14), .c(new_n73_), .O(new_n84_));
  inv1   g039(.a(new_n84_), .O(z06));
  aoi21  g040(.a(new_n73_), .b(x06), .c(new_n49_), .O(z07));
  ...
  nand2  g048(.a(new_n53_), .b(new_n93_), .O(new_n94_));
  ...
  nand4  g057(.a(new_n102_), .b(new_n97_), .c(new_n93_), .d(new_n60_), .O(new_n103_));
  nand2  g058(.a(new_n103_), .b(x25), .O(new_n104_));
  nand4  g059(.a(new_n104_), .b(new_n95_), .c(new_n92_), .d(new_n90_), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(new_n48_), .O(new_n106_));
  inv1   g061(.a(x23), .O(new_n107_));
  nand3  g062(.a(new_n58_), .b(x22), .c(x21), .O(new_n108_));
  aoi21  g063(.a(new_n108_), .b(new_n107_), .c(new_n93_), .O(new_n109_));
  oai21  g064(.a(new_n109_), .b(x25), .c(new_n47_), .O(new_n110_));
  nand2  g065(.a(new_n110_), .b(new_n106_), .O(z08));
  nand3  g066(.a(new_n67_), .b(new_n48_), .c(new_n47_), .O(new_n112_));
  nand2  g067(.a(new_n112_), .b(new_n50_), .O(z09));
  nand4  g068(.a(new_n68_), .b(new_n87_), .c(new_n48_), .d(new_n47_), .O(new_n114_));
  inv1   g069(.a(new_n114_), .O(z10));
  xor2a  g070(.a(x18), .b(x17), .O(new_n116_));
  nand4  g071(.a(new_n116_), .b(new_n68_), .c(new_n48_), .d(new_n47_), .O(new_n117_));
  inv1   g072(.a(new_n117_), .O(z11));
  nand3  g073(.a(new_n56_), .b(x18), .c(x17), .O(new_n119_));
  oai21  g074(.a(new_n98_), .b(new_n56_), .c(new_n119_), .O(new_n120_));
  nand4  g075(.a(new_n120_), .b(new_n68_), .c(new_n48_), .d(new_n47_), .O(new_n121_));
  inv1   g076(.a(new_n121_), .O(z12));
  oai21  g077(.a(new_n66_), .b(new_n65_), .c(new_n48_), .O(new_n123_));
  nand2  g078(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand2  g079(.a(new_n99_), .b(new_n98_), .O(new_n125_));
  nand3  g080(.a(x19), .b(x18), .c(x17), .O(new_n126_));
  nand2  g081(.a(new_n126_), .b(x20), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n125_), .c(new_n47_), .O(new_n128_));
  nand2  g083(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n124_), .O(z13));
  nor2   g085(.a(x21), .b(x20), .O(new_n131_));
  nand3  g086(.a(new_n131_), .b(new_n98_), .c(x19), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  aoi21  g088(.a(new_n125_), .b(x21), .c(new_n133_), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(x15), .c(new_n124_), .O(z14));
  nand2  g090(.a(new_n132_), .b(x22), .O(new_n136_));
  inv1   g091(.a(new_n126_), .O(new_n137_));
  nand3  g092(.a(new_n137_), .b(new_n100_), .c(new_n54_), .O(new_n138_));
  nand4  g093(.a(new_n138_), .b(new_n136_), .c(new_n124_), .d(new_n47_), .O(z15));
  nand2  g094(.a(new_n138_), .b(x23), .O(new_n140_));
  nand4  g095(.a(new_n131_), .b(new_n137_), .c(new_n107_), .d(new_n60_), .O(new_n141_));
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n124_), .d(new_n47_), .O(z16));
  nand3  g097(.a(new_n47_), .b(x05), .c(x04), .O(new_n143_));
  nand4  g098(.a(new_n100_), .b(x25), .c(new_n93_), .d(new_n107_), .O(new_n144_));
  oai21  g099(.a(new_n144_), .b(new_n125_), .c(new_n143_), .O(new_n145_));
  nand2  g100(.a(new_n145_), .b(new_n48_), .O(new_n146_));
  aoi21  g101(.a(x24), .b(x23), .c(x15), .O(new_n147_));
  nand2  g102(.a(new_n138_), .b(x24), .O(new_n148_));
  nor2   g103(.a(new_n94_), .b(x23), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(new_n150_));
  and2   g105(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand4  g106(.a(new_n151_), .b(new_n147_), .c(new_n146_), .d(new_n47_), .O(z17));
  nand3  g107(.a(new_n102_), .b(x25), .c(new_n48_), .O(new_n153_));
  nand4  g108(.a(new_n153_), .b(new_n150_), .c(new_n124_), .d(new_n47_), .O(z18));
endmodule
