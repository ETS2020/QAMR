...
module FAU ( 
  ...
  nand3  g43(.a(new_n88_), .b(new_n48_), .c(new_n53_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z09));
  inv1   g45(.a(new_n88_), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n56_), .c(new_n48_), .d(new_n53_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  xor2a  g48(.a(x18), .b(x17), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n91_), .c(new_n48_), .d(new_n53_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n91_), .c(new_n48_), .d(new_n53_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  oai21  g56(.a(new_n87_), .b(new_n86_), .c(new_n48_), .O(new_n102_));
  ...
  nor2   g60(.a(x20), .b(new_n58_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n97_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n53_), .O(z13));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n97_), .c(x19), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n63_), .O(new_n111_));
  aoi21  g66(.a(new_n107_), .b(x21), .c(new_n111_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(x15), .c(new_n53_), .O(z14));
  inv1   g68(.a(new_n104_), .O(new_n114_));
  nor2   g69(.a(x22), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n55_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n63_), .O(new_n117_));
  aoi21  g72(.a(new_n110_), .b(x22), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(x15), .c(new_n53_), .O(z15));
  nand2  g74(.a(new_n116_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n109_), .b(new_n114_), .c(new_n121_), .d(new_n81_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n103_), .d(new_n53_), .O(z16));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n124_));
  nand3  g79(.a(new_n115_), .b(new_n80_), .c(new_n121_), .O(new_n125_));
  or2    g80(.a(new_n125_), .b(new_n107_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n103_), .d(new_n53_), .O(z17));
  oai21  g82(.a(new_n125_), .b(new_n107_), .c(x25), .O(new_n128_));
  nor3   g83(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n115_), .c(new_n106_), .d(new_n97_), .O(new_n130_));
