...
module FAU ( 
  ...
  nand4  g57(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n85_), .O(new_n103_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n86_), .c(new_n85_), .O(new_n109_));
  ...
  and2   g70(.a(new_n115_), .b(new_n86_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n112_), .c(new_n47_), .d(new_n85_), .O(z15));
  nand2  g72(.a(new_n115_), .b(x23), .O(new_n118_));
  inv1   g73(.a(new_n86_), .O(new_n119_));
  inv1   g74(.a(x21), .O(new_n120_));
  inv1   g75(.a(x23), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n80_), .c(new_n120_), .d(new_n52_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(new_n113_), .c(new_n119_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n118_), .c(new_n47_), .d(new_n85_), .O(z16));
  oai21  g80(.a(new_n122_), .b(new_n98_), .c(x24), .O(new_n126_));
  nor2   g81(.a(x24), .b(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n114_), .c(new_n101_), .d(new_n93_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n100_), .d(new_n85_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n47_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n105_), .O(z17));
  nand2  g86(.a(new_n128_), .b(x25), .O(new_n132_));
  inv1   g87(.a(new_n102_), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  and2   g89(.a(new_n134_), .b(new_n114_), .O(new_n135_));
  aoi21  g90(.a(new_n135_), .b(new_n133_), .c(new_n119_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n132_), .c(new_n47_), .d(new_n85_), .O(z18));
endmodule
