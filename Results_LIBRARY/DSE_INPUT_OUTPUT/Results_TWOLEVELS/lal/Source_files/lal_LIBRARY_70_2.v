...
module FAU ( 
  ...
  nand2  g058(.a(new_n103_), .b(new_n56_), .O(new_n104_));
  aoi21  g059(.a(new_n104_), .b(new_n47_), .c(x15), .O(z10));
  xor2a  g060(.a(x18), .b(x17), .O(new_n106_));
  nand2  g061(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  ...
  nand4  g065(.a(new_n110_), .b(new_n103_), .c(new_n51_), .d(new_n47_), .O(new_n111_));
  ...
  or2    g075(.a(new_n120_), .b(x15), .O(new_n121_));
  ...
  nand4  g079(.a(new_n124_), .b(new_n122_), .c(new_n121_), .d(new_n51_), .O(z14));
  ...
  aoi21  g084(.a(new_n124_), .b(x22), .c(new_n129_), .O(new_n130_));
  oai21  g085(.a(new_n130_), .b(x07), .c(new_n51_), .O(z15));
  inv1   g086(.a(x23), .O(new_n132_));
  aoi21  g087(.a(new_n127_), .b(new_n126_), .c(new_n132_), .O(new_n133_));
  nand4  g088(.a(new_n123_), .b(new_n126_), .c(new_n132_), .d(new_n88_), .O(new_n134_));
  ...
  nand3  g096(.a(new_n141_), .b(new_n140_), .c(new_n121_), .O(z17));
  ...
  nand4  g100(.a(new_n145_), .b(new_n143_), .c(new_n121_), .d(new_n51_), .O(z18));
endmodule
