...
module FAU ( 
  ...
  nand2  g39(.a(new_n57_), .b(new_n56_), .O(new_n85_));
  nand3  g40(.a(x22), .b(x21), .c(new_n58_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(x24), .O(new_n88_));
  aoi21  g43(.a(x25), .b(new_n55_), .c(new_n48_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n83_), .O(z08));
  nand4  g45(.a(new_n51_), .b(new_n47_), .c(x05), .d(x04), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand2  g47(.a(x05), .b(x04), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n56_), .c(new_n51_), .d(new_n47_), .O(new_n94_));
  ...
  nor2   g53(.a(new_n57_), .b(new_n56_), .O(new_n99_));
  nand3  g54(.a(new_n58_), .b(x18), .c(x17), .O(new_n100_));
  oai21  g55(.a(new_n99_), .b(new_n58_), .c(new_n100_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n93_), .c(new_n51_), .d(new_n47_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z12));
  aoi21  g58(.a(x05), .b(x04), .c(x07), .O(new_n104_));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nor2   g61(.a(x20), .b(new_n58_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n99_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n106_), .c(new_n104_), .d(new_n51_), .O(z13));
  or2    g64(.a(new_n104_), .b(x15), .O(new_n110_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n110_), .d(new_n51_), .O(z14));
  ...
  nand3  g73(.a(new_n118_), .b(new_n115_), .c(new_n110_), .O(z15));
  aoi21  g74(.a(new_n117_), .b(new_n116_), .c(new_n84_), .O(new_n120_));
  nand3  g75(.a(new_n51_), .b(x05), .c(x04), .O(new_n121_));
  nor2   g76(.a(x23), .b(x22), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n112_), .O(new_n123_));
  oai21  g78(.a(new_n123_), .b(new_n105_), .c(new_n121_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n120_), .c(new_n47_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n51_), .O(z16));
  oai21  g81(.a(new_n123_), .b(new_n105_), .c(x24), .O(new_n127_));
  nor2   g82(.a(x22), .b(x21), .O(new_n128_));
  nor2   g83(.a(x24), .b(x23), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n128_), .c(new_n107_), .d(new_n99_), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n127_), .c(new_n121_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n47_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n51_), .O(z17));
  nand2  g88(.a(new_n130_), .b(x25), .O(new_n134_));
  nor3   g89(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n128_), .c(new_n107_), .d(new_n99_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n134_), .c(new_n110_), .d(new_n51_), .O(z18));
endmodule
