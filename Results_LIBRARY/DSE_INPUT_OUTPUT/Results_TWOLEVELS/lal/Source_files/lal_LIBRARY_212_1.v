...
module FAU ( 
  ...
  nand3  g18(.a(new_n63_), .b(new_n53_), .c(new_n51_), .O(z01));
  inv1   g19(.a(x16), .O(new_n65_));
  nand2  g20(.a(new_n49_), .b(new_n65_), .O(z02));
  nand2  g21(.a(new_n63_), .b(new_n49_), .O(z03));
  ...
  nand2  g33(.a(new_n58_), .b(new_n57_), .O(new_n79_));
  nand3  g34(.a(x24), .b(x22), .c(x21), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(new_n79_), .c(new_n54_), .O(new_n81_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n56_), .c(new_n47_), .d(new_n51_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z10));
  xor2a  g58(.a(x18), .b(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n47_), .c(x07), .O(z11));
  nand3  g61(.a(new_n58_), .b(x18), .c(x17), .O(new_n107_));
  oai21  g62(.a(new_n91_), .b(new_n58_), .c(new_n107_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n101_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n47_), .c(x07), .O(z12));
  nand2  g65(.a(new_n92_), .b(new_n91_), .O(new_n111_));
  nand3  g66(.a(x19), .b(x18), .c(x17), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(x20), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n52_), .d(new_n51_), .O(z13));
  nand2  g69(.a(new_n111_), .b(x21), .O(new_n115_));
  nor2   g70(.a(x21), .b(x20), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n91_), .c(x19), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n53_), .d(new_n51_), .O(z14));
  nand2  g73(.a(new_n117_), .b(x22), .O(new_n119_));
  inv1   g74(.a(new_n112_), .O(new_n120_));
  nor3   g75(.a(x22), .b(x21), .c(x20), .O(new_n121_));
  aoi21  g76(.a(new_n121_), .b(new_n120_), .c(x07), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n119_), .c(new_n53_), .O(z15));
  inv1   g78(.a(x23), .O(new_n124_));
  aoi21  g79(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(new_n125_));
  nand3  g80(.a(new_n51_), .b(x05), .c(x04), .O(new_n126_));
  nand4  g81(.a(new_n116_), .b(new_n120_), .c(new_n124_), .d(new_n86_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  oai21  g83(.a(new_n128_), .b(new_n125_), .c(new_n47_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n51_), .O(z16));
  ...
  aoi21  g88(.a(new_n127_), .b(x24), .c(x07), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n133_), .c(new_n53_), .O(z17));
  nand2  g90(.a(new_n95_), .b(x25), .O(new_n136_));
  nor3   g91(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n138_));
  nand4  g93(.a(new_n138_), .b(new_n136_), .c(new_n53_), .d(new_n51_), .O(z18));
endmodule
