...
module FAU ( 
  ...
  oai21  g25(.a(x10), .b(x08), .c(x15), .O(new_n71_));
  ...
  nand4  g44(.a(new_n89_), .b(x05), .c(x04), .d(new_n47_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(x15), .O(z09));
  inv1   g46(.a(x15), .O(new_n92_));
  nand4  g47(.a(new_n64_), .b(new_n54_), .c(new_n92_), .d(new_n89_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(x01), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n64_), .c(new_n92_), .d(new_n89_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(x01), .O(z11));
  ...
  nand4  g55(.a(new_n100_), .b(new_n64_), .c(new_n92_), .d(new_n89_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(x01), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nand3  g59(.a(new_n65_), .b(new_n92_), .c(new_n89_), .O(new_n105_));
  nor2   g60(.a(x20), .b(new_n56_), .O(new_n106_));
  ...
  nand2  g64(.a(new_n109_), .b(new_n92_), .O(z13));
  nand2  g65(.a(new_n105_), .b(new_n89_), .O(new_n111_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n92_), .c(new_n47_), .O(new_n115_));
  ...
  and2   g76(.a(new_n121_), .b(new_n49_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n118_), .c(new_n112_), .d(new_n92_), .O(z15));
  nand2  g78(.a(new_n121_), .b(x23), .O(new_n124_));
  inv1   g79(.a(x23), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n60_), .c(new_n59_), .d(new_n53_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  aoi21  g82(.a(new_n127_), .b(new_n119_), .c(new_n48_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n124_), .c(new_n112_), .d(new_n92_), .O(z16));
  oai21  g84(.a(new_n126_), .b(new_n103_), .c(x24), .O(new_n130_));
  nor2   g85(.a(x24), .b(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n120_), .c(new_n106_), .d(new_n98_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n105_), .d(new_n89_), .O(new_n133_));
  nand2  g88(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g89(.a(new_n134_), .b(new_n92_), .O(z17));
  nand2  g90(.a(new_n132_), .b(x25), .O(new_n136_));
  inv1   g91(.a(new_n107_), .O(new_n137_));
  nor3   g92(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  and2   g93(.a(new_n138_), .b(new_n120_), .O(new_n139_));
  aoi21  g94(.a(new_n139_), .b(new_n137_), .c(new_n48_), .O(new_n140_));
  nand4  g95(.a(new_n140_), .b(new_n136_), .c(new_n112_), .d(new_n92_), .O(z18));
endmodule
