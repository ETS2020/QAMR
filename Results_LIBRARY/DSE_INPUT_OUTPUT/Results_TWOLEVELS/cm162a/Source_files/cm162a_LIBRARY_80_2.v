...
module FAU ( 
  ...
  nand2  g21(.a(new_n20_), .b(x06), .O(new_n41_));
  ...
  nand3  g27(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n20_), .b(new_n40_), .c(new_n26_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x03), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n46_), .O(new_n50_));
  nand4  g31(.a(new_n40_), .b(new_n26_), .c(x04), .d(x02), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(x11), .c(x03), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n50_), .c(new_n25_), .O(z2));
  inv1   g34(.a(x05), .O(new_n54_));
  oai22  g35(.a(new_n23_), .b(new_n22_), .c(x07), .d(x03), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(new_n21_), .O(new_n56_));
  nand2  g37(.a(new_n51_), .b(x12), .O(new_n57_));
  ...
  aoi21  g42(.a(new_n61_), .b(new_n57_), .c(x06), .O(new_n62_));
