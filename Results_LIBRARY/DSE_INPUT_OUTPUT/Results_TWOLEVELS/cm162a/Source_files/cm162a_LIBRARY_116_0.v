...
module FAU ( 
  ...
  aoi21  g27(.a(new_n46_), .b(x11), .c(new_n38_), .O(new_n47_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n42_), .c(new_n41_), .d(new_n24_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n20_), .c(new_n53_), .O(new_n56_));
  ...
  aoi21  g41(.a(new_n60_), .b(new_n28_), .c(new_n38_), .O(new_n61_));
  oai21  g42(.a(new_n59_), .b(new_n28_), .c(new_n61_), .O(z3));
  inv1   g43(.a(x09), .O(new_n63_));
  oai21  g44(.a(x05), .b(x03), .c(x13), .O(new_n64_));
  nor3   g45(.a(new_n64_), .b(new_n63_), .c(new_n53_), .O(z4));
endmodule
