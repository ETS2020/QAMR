...
module FAU ( 
  ...
  nand4  g22(.a(new_n41_), .b(new_n39_), .c(x09), .d(x05), .O(z1));
  ...
  oai21  g34(.a(new_n53_), .b(new_n32_), .c(new_n33_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  nand2  g36(.a(new_n43_), .b(new_n31_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x09), .c(new_n36_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n52_), .c(new_n55_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  inv1   g40(.a(x05), .O(new_n60_));
  oai21  g41(.a(x07), .b(x03), .c(x09), .O(new_n61_));
