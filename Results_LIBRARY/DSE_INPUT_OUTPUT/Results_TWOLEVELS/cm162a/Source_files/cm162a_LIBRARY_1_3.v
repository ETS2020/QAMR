...
module FAU ( 
  ...
  aoi21  g06(.a(new_n22_), .b(x02), .c(new_n25_), .O(new_n26_));
  oai21  g07(.a(new_n26_), .b(x00), .c(x05), .O(z0));
  ...
  oai21  g20(.a(new_n39_), .b(new_n38_), .c(new_n28_), .O(new_n40_));
  ...
  oai21  g26(.a(new_n33_), .b(new_n23_), .c(x11), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n45_), .c(new_n29_), .O(new_n47_));
  nor2   g28(.a(x06), .b(x03), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(new_n28_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x05), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n42_), .O(new_n52_));
  oai22  g33(.a(new_n52_), .b(new_n33_), .c(new_n30_), .d(x00), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  aoi21  g35(.a(new_n42_), .b(new_n32_), .c(x00), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n36_), .c(x12), .O(new_n56_));
  ...
  oai22  g43(.a(new_n30_), .b(new_n20_), .c(new_n59_), .d(new_n28_), .O(z4));
endmodule
