...
module FAU ( 
  ...
  aoi21  g27(.a(new_n46_), .b(new_n45_), .c(x11), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n44_), .c(new_n26_), .d(x04), .O(new_n48_));
  nand3  g29(.a(new_n27_), .b(new_n44_), .c(new_n26_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x11), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n43_), .c(new_n50_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x03), .O(new_n52_));
  nor2   g33(.a(x06), .b(x03), .O(new_n53_));
  nor2   g34(.a(new_n53_), .b(new_n20_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n52_), .c(new_n25_), .O(z2));
  nand2  g36(.a(x12), .b(x11), .O(new_n56_));
  inv1   g37(.a(x11), .O(new_n57_));
  nand3  g38(.a(new_n46_), .b(new_n57_), .c(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(x10), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n26_), .c(x04), .d(x02), .O(new_n60_));
  nand2  g41(.a(new_n49_), .b(x12), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  nand3  g44(.a(x12), .b(new_n45_), .c(new_n34_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n63_), .c(new_n25_), .O(z3));
  nand2  g46(.a(new_n23_), .b(new_n21_), .O(z4));
endmodule
