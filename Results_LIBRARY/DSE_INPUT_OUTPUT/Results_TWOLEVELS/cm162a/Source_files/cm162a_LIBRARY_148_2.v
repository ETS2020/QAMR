...
module FAU ( 
  ...
  nand2  g09(.a(new_n24_), .b(x07), .O(new_n29_));
  ...
  nand3  g35(.a(new_n46_), .b(new_n54_), .c(new_n43_), .O(new_n55_));
  oai21  g36(.a(new_n22_), .b(new_n20_), .c(new_n55_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nor2   g38(.a(x11), .b(x10), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n25_), .c(new_n54_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(x07), .c(new_n24_), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n20_), .O(new_n62_));
  nand3  g43(.a(x12), .b(x08), .c(x03), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n62_), .c(x05), .O(new_n64_));
  inv1   g45(.a(new_n64_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n60_), .c(new_n57_), .O(z3));
  oai21  g47(.a(new_n22_), .b(new_n21_), .c(new_n29_), .O(z4));
endmodule
