...
module FAU ( 
  ...
  nand3  g28(.a(new_n47_), .b(new_n36_), .c(new_n22_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n24_), .c(new_n21_), .O(new_n49_));
  ...
  aoi21  g34(.a(new_n53_), .b(new_n20_), .c(new_n30_), .O(new_n54_));
  oai21  g35(.a(new_n52_), .b(new_n20_), .c(new_n54_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n47_), .c(new_n36_), .d(new_n22_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  aoi21  g40(.a(new_n47_), .b(new_n36_), .c(new_n30_), .O(new_n60_));
