...
module FAU ( 
  ...
  nand2  g19(.a(x10), .b(new_n38_), .O(new_n39_));
  oai21  g20(.a(new_n39_), .b(new_n25_), .c(x03), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n37_), .c(new_n33_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand4  g23(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n42_), .c(new_n21_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n20_), .c(x10), .O(new_n45_));
  ...
  aoi21  g30(.a(new_n43_), .b(new_n49_), .c(new_n21_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n20_), .c(x10), .O(new_n51_));
  nand2  g32(.a(x07), .b(x05), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n21_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z3));
  oai21  g35(.a(x10), .b(new_n21_), .c(new_n35_), .O(z4));
endmodule
