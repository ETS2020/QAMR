...
module FAU ( 
  ...
  oai21  g13(.a(new_n32_), .b(new_n28_), .c(new_n31_), .O(new_n33_));
  ...
  nand3  g20(.a(new_n32_), .b(new_n20_), .c(new_n28_), .O(new_n40_));
  ...
  nand3  g43(.a(new_n29_), .b(new_n50_), .c(new_n20_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n59_), .c(x08), .O(new_n64_));
  nand3  g45(.a(x13), .b(new_n20_), .c(x09), .O(new_n65_));
  inv1   g46(.a(new_n65_), .O(new_n66_));
  oai21  g47(.a(new_n66_), .b(new_n64_), .c(x04), .O(new_n67_));
  nand2  g48(.a(new_n51_), .b(x12), .O(new_n68_));
  oai21  g49(.a(new_n67_), .b(new_n62_), .c(new_n68_), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(x03), .O(new_n70_));
  nand3  g51(.a(new_n70_), .b(new_n61_), .c(new_n57_), .O(z3));
  nand2  g52(.a(new_n23_), .b(new_n22_), .O(z4));
endmodule
