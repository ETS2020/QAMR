...
module FAU ( 
  ...
  aoi21  g40(.a(new_n51_), .b(new_n53_), .c(x07), .O(new_n60_));
  nand3  g41(.a(new_n43_), .b(new_n40_), .c(new_n20_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n60_), .c(x12), .O(new_n62_));
  nand2  g43(.a(new_n20_), .b(new_n31_), .O(new_n63_));
  nand3  g44(.a(x04), .b(x03), .c(x02), .O(new_n64_));
  inv1   g45(.a(new_n64_), .O(new_n65_));
  nand4  g46(.a(new_n65_), .b(new_n44_), .c(new_n21_), .d(new_n51_), .O(new_n66_));
  nand4  g47(.a(new_n66_), .b(new_n63_), .c(new_n62_), .d(new_n39_), .O(z3));
  nand4  g48(.a(new_n35_), .b(x13), .c(x09), .d(x04), .O(new_n68_));
