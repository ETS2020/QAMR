...
module FAU ( 
  ...
  nand4  g24(.a(new_n39_), .b(new_n32_), .c(x04), .d(x02), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(x11), .c(new_n24_), .O(new_n45_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n40_), .c(new_n39_), .d(new_n32_), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n56_), .b(x12), .c(new_n24_), .O(new_n57_));
