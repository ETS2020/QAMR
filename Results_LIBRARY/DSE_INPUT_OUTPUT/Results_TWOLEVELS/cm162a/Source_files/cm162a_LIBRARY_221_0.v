...
module FAU ( 
  ...
  oai21  g15(.a(new_n21_), .b(new_n29_), .c(new_n34_), .O(new_n35_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n33_), .c(new_n32_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n21_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  oai21  g26(.a(new_n34_), .b(new_n24_), .c(x11), .O(new_n46_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n42_), .c(new_n33_), .d(new_n32_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n21_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  oai21  g35(.a(new_n43_), .b(new_n24_), .c(x12), .O(new_n55_));
  ...
  nand2  g39(.a(new_n58_), .b(new_n30_), .O(z3));
  inv1   g40(.a(x04), .O(new_n60_));
  oai22  g41(.a(new_n21_), .b(new_n60_), .c(x05), .d(x00), .O(z4));
endmodule
