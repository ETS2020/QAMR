...
module FAU ( 
  ...
  nand3  g24(.a(new_n43_), .b(new_n42_), .c(new_n35_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n32_), .c(new_n41_), .O(new_n45_));
  inv1   g26(.a(new_n24_), .O(new_n46_));
  aoi21  g27(.a(x10), .b(x05), .c(x08), .O(new_n47_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n43_), .c(new_n42_), .d(new_n35_), .O(new_n54_));
  ...
  nand2  g41(.a(new_n60_), .b(new_n30_), .O(z3));
  inv1   g42(.a(x09), .O(new_n62_));
  oai21  g43(.a(x07), .b(x05), .c(x13), .O(new_n63_));
  nor3   g44(.a(new_n63_), .b(new_n62_), .c(new_n41_), .O(z4));
endmodule
