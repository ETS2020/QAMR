...
module FAU ( 
  ...
  nand2  g07(.a(x11), .b(x05), .O(new_n27_));
  ...
  nor3   g26(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n42_), .O(z2));
  nand2  g28(.a(new_n44_), .b(x05), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n51_), .c(new_n48_), .d(x05), .O(z3));
  oai21  g35(.a(new_n23_), .b(new_n22_), .c(new_n48_), .O(z4));
endmodule
