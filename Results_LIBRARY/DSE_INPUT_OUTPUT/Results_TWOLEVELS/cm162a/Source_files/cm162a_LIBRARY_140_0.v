...
module FAU ( 
  ...
  nand2  g19(.a(new_n38_), .b(x09), .O(new_n39_));
  ...
  nand2  g31(.a(x09), .b(x06), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(new_n50_), .c(x09), .d(new_n23_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n49_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n42_), .c(new_n41_), .d(new_n33_), .O(new_n55_));
  ...
  nand2  g43(.a(x09), .b(x07), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(new_n50_), .c(x09), .d(new_n23_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai22  g47(.a(new_n20_), .b(new_n66_), .c(x09), .d(x03), .O(z4));
endmodule
