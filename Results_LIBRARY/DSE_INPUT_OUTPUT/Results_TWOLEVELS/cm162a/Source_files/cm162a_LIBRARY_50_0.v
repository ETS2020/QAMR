...
module FAU ( 
  ...
  oai21  g26(.a(new_n21_), .b(new_n34_), .c(new_n20_), .O(new_n46_));
  inv1   g27(.a(x10), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n28_), .c(x04), .d(x02), .O(new_n48_));
  and2   g29(.a(new_n48_), .b(x11), .O(new_n49_));
  nand3  g30(.a(x06), .b(x04), .c(x02), .O(new_n50_));
  nor4   g31(.a(new_n50_), .b(x11), .c(x10), .d(x08), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n49_), .c(x03), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n46_), .c(new_n27_), .O(z2));
