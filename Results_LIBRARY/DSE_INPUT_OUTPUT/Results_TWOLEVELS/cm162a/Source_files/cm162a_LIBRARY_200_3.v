...
module FAU ( 
  ...
  nor2   g08(.a(new_n27_), .b(x00), .O(new_n28_));
  nand3  g09(.a(new_n28_), .b(new_n26_), .c(new_n23_), .O(z0));
  ...
  nor2   g17(.a(new_n36_), .b(x00), .O(new_n37_));
  ...
  nor2   g28(.a(new_n47_), .b(x00), .O(new_n48_));
  ...
  aoi21  g32(.a(new_n51_), .b(new_n21_), .c(new_n39_), .O(new_n52_));
  ...
  nor2   g37(.a(new_n56_), .b(x00), .O(new_n57_));
