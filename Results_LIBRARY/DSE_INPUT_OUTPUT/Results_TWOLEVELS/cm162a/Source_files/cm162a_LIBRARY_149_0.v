...
module FAU ( 
  ...
  nand2  g29(.a(new_n24_), .b(x05), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n40_), .c(new_n39_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n49_), .c(new_n22_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand4  g34(.a(new_n25_), .b(new_n40_), .c(new_n39_), .d(new_n24_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x12), .c(x05), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x03), .O(new_n57_));
  nor2   g38(.a(x07), .b(new_n29_), .O(new_n58_));
  aoi22  g39(.a(new_n58_), .b(new_n20_), .c(x13), .d(new_n29_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(z3));
  oai22  g41(.a(new_n22_), .b(new_n21_), .c(x13), .d(x05), .O(z4));
endmodule
