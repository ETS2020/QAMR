...
module FAU ( 
  ...
  aoi21  g31(.a(new_n50_), .b(new_n27_), .c(new_n20_), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n20_), .c(new_n40_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n20_), .b(new_n40_), .c(new_n26_), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n62_), .b(new_n32_), .c(new_n61_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n52_), .O(new_n65_));
  aoi21  g46(.a(x07), .b(new_n32_), .c(new_n52_), .O(new_n66_));
  oai21  g47(.a(new_n66_), .b(new_n61_), .c(x11), .O(new_n67_));
