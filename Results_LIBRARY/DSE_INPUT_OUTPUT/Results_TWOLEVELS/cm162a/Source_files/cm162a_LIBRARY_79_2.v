...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n57_, new_n59_, new_n60_, new_n61_, new_n62_, new_n63_;
  ...
  oai21  g40(.a(new_n54_), .b(x07), .c(new_n59_), .O(new_n60_));
  nand4  g41(.a(new_n42_), .b(new_n50_), .c(new_n52_), .d(new_n39_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x12), .c(x03), .O(new_n62_));
  nand2  g43(.a(new_n20_), .b(new_n30_), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n62_), .c(new_n60_), .d(new_n38_), .O(z3));
  nand2  g45(.a(new_n36_), .b(new_n34_), .O(z4));
endmodule
