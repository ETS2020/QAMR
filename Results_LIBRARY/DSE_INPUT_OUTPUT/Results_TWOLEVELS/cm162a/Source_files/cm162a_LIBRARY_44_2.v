...
module FAU ( 
  ...
  nand4  g23(.a(new_n42_), .b(new_n40_), .c(new_n22_), .d(x05), .O(z1));
  oai21  g24(.a(x11), .b(x10), .c(new_n33_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  inv1   g26(.a(x10), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(x11), .c(x08), .O(new_n48_));
  ...
  nand3  g35(.a(new_n54_), .b(new_n21_), .c(new_n46_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n33_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  oai21  g38(.a(new_n46_), .b(x08), .c(new_n21_), .O(new_n58_));
