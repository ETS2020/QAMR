...
module FAU ( 
  ...
  nand2  g32(.a(new_n51_), .b(new_n46_), .O(new_n52_));
  nand3  g33(.a(new_n27_), .b(new_n40_), .c(new_n26_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x11), .c(x03), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n52_), .c(new_n25_), .d(new_n21_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n40_), .c(new_n26_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n47_), .c(new_n46_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n20_), .O(new_n59_));
  nand2  g40(.a(new_n49_), .b(new_n27_), .O(new_n60_));
