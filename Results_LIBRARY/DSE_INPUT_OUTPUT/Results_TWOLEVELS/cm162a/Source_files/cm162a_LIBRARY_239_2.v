...
module FAU ( 
  ...
  oai21  g10(.a(new_n29_), .b(new_n23_), .c(x11), .O(new_n30_));
  nand2  g11(.a(new_n30_), .b(new_n22_), .O(z0));
  oai21  g12(.a(x10), .b(x08), .c(new_n26_), .O(new_n32_));
  nand4  g13(.a(new_n32_), .b(x11), .c(x04), .d(x02), .O(new_n33_));
  ...
  aoi22  g21(.a(new_n40_), .b(new_n20_), .c(x11), .d(new_n23_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n39_), .O(z1));
  aoi22  g23(.a(x13), .b(x09), .c(x10), .d(new_n35_), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(new_n35_), .c(x04), .d(x02), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(x03), .c(new_n23_), .O(new_n45_));
  nand2  g26(.a(x06), .b(x05), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  oai21  g28(.a(new_n45_), .b(new_n34_), .c(new_n47_), .O(z2));
  ...
  oai21  g32(.a(new_n51_), .b(new_n23_), .c(x11), .O(new_n52_));
  nand2  g33(.a(x07), .b(x05), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n20_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z3));
  inv1   g36(.a(x04), .O(new_n56_));
  oai22  g37(.a(new_n26_), .b(new_n56_), .c(x11), .d(new_n20_), .O(z4));
endmodule
