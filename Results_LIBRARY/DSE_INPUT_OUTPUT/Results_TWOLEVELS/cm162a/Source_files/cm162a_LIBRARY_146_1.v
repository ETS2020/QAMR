...
module FAU ( 
  ...
  nor2   g09(.a(x10), .b(x05), .O(new_n29_));
  ...
  nand2  g29(.a(new_n36_), .b(new_n45_), .O(new_n49_));
  nand2  g30(.a(x10), .b(x05), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(x11), .c(new_n48_), .d(x02), .O(new_n52_));
  nor2   g33(.a(x06), .b(new_n41_), .O(new_n53_));
  ...
  nand4  g37(.a(new_n56_), .b(new_n46_), .c(new_n45_), .d(new_n35_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n32_), .c(new_n44_), .O(new_n58_));
  oai21  g39(.a(x11), .b(x10), .c(x05), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n49_), .O(new_n60_));
  aoi22  g41(.a(new_n60_), .b(x12), .c(new_n58_), .d(x02), .O(new_n61_));
  nor2   g42(.a(x07), .b(new_n41_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n29_), .O(new_n63_));
  oai21  g44(.a(new_n61_), .b(new_n20_), .c(new_n63_), .O(z3));
  oai22  g45(.a(new_n21_), .b(new_n44_), .c(new_n45_), .d(x05), .O(z4));
endmodule
