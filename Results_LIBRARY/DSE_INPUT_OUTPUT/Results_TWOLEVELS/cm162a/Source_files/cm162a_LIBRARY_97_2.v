...
module FAU ( 
  ...
  nor2   g11(.a(new_n20_), .b(x03), .O(new_n31_));
  nor2   g12(.a(x05), .b(x04), .O(new_n32_));
  ...
  nand3  g18(.a(x13), .b(x09), .c(x05), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand3  g20(.a(new_n39_), .b(x04), .c(x02), .O(new_n40_));
  nand3  g21(.a(new_n27_), .b(x04), .c(x02), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(x10), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n40_), .c(new_n35_), .O(new_n43_));
  oai21  g24(.a(x03), .b(x01), .c(x05), .O(new_n44_));
  or2    g25(.a(new_n44_), .b(new_n43_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n36_), .c(new_n27_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n21_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x04), .c(x02), .O(new_n49_));
  oai21  g30(.a(new_n37_), .b(new_n24_), .c(x11), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n49_), .c(new_n20_), .O(new_n51_));
  nor2   g32(.a(new_n46_), .b(x04), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x03), .O(new_n53_));
  nor2   g34(.a(x06), .b(new_n20_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n35_), .c(new_n32_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n46_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n37_), .c(new_n38_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x04), .c(x02), .O(new_n60_));
  nand2  g41(.a(new_n46_), .b(new_n36_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(x05), .c(new_n41_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n57_), .c(new_n60_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x03), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n35_), .c(new_n20_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  inv1   g48(.a(x04), .O(new_n68_));
  aoi21  g49(.a(new_n21_), .b(x05), .c(new_n68_), .O(z4));
endmodule
