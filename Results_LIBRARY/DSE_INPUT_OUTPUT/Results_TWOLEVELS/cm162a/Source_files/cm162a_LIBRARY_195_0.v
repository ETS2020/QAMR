...
module FAU ( 
  ...
  nand2  g41(.a(x09), .b(x03), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n29_), .c(new_n51_), .O(new_n62_));
  oai21  g43(.a(new_n60_), .b(new_n20_), .c(new_n62_), .O(z3));
  oai21  g44(.a(new_n22_), .b(new_n21_), .c(new_n31_), .O(z4));
endmodule
