...
module FAU ( 
  ...
  nand4  g35(.a(new_n30_), .b(new_n45_), .c(new_n44_), .d(new_n24_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n22_), .c(new_n21_), .O(new_n56_));
  nor3   g37(.a(x11), .b(x10), .c(x08), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n25_), .c(new_n30_), .O(new_n58_));
  aoi21  g39(.a(new_n56_), .b(x02), .c(new_n58_), .O(new_n59_));
  oai21  g40(.a(x07), .b(x03), .c(new_n31_), .O(new_n60_));
