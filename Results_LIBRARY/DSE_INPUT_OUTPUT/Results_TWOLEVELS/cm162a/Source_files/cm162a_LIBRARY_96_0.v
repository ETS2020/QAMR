...
module FAU ( 
  ...
  nand3  g13(.a(new_n32_), .b(new_n24_), .c(x05), .O(new_n33_));
  ...
  aoi22  g22(.a(new_n41_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n39_), .O(z1));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n32_), .c(new_n24_), .O(new_n45_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n32_), .d(new_n24_), .O(new_n54_));
