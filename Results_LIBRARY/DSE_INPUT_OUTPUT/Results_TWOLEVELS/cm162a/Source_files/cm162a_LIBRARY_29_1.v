...
module FAU ( 
  ...
  nand4  g29(.a(new_n24_), .b(new_n38_), .c(new_n37_), .d(new_n23_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x12), .c(new_n26_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n48_), .O(z3));
  inv1   g32(.a(x05), .O(new_n52_));
  oai22  g33(.a(new_n36_), .b(new_n35_), .c(new_n52_), .d(x03), .O(z4));
endmodule
