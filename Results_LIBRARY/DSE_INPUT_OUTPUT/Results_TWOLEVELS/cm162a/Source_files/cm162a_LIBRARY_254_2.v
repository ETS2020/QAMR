...
module FAU ( 
  ...
  oai22  g24(.a(new_n24_), .b(new_n23_), .c(x06), .d(x03), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(new_n22_), .O(new_n45_));
  inv1   g26(.a(x11), .O(new_n46_));
  aoi21  g27(.a(new_n36_), .b(new_n28_), .c(new_n46_), .O(new_n47_));
  ...
  nor2   g31(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n47_), .c(x03), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n45_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  aoi21  g35(.a(new_n36_), .b(new_n28_), .c(new_n54_), .O(new_n55_));
  nand3  g36(.a(new_n54_), .b(new_n46_), .c(new_n49_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n29_), .c(x03), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n55_), .c(new_n20_), .O(new_n58_));
  nand3  g39(.a(x12), .b(x11), .c(x03), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n58_), .c(new_n26_), .O(z3));
