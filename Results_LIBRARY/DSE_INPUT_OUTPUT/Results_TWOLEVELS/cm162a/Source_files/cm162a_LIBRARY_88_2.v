...
module FAU ( 
  ...
  nand4  g17(.a(new_n36_), .b(new_n27_), .c(x04), .d(x02), .O(new_n37_));
  ...
  aoi21  g26(.a(new_n37_), .b(x11), .c(new_n45_), .O(new_n46_));
  inv1   g27(.a(x05), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n43_), .c(new_n47_), .O(new_n49_));
  oai21  g30(.a(new_n46_), .b(new_n43_), .c(new_n49_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  inv1   g32(.a(x11), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x07), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n52_), .c(new_n36_), .d(new_n27_), .O(new_n55_));
  ...
  nand4  g40(.a(new_n53_), .b(new_n52_), .c(new_n36_), .d(new_n27_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(x03), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n20_), .O(new_n62_));
  nand4  g43(.a(new_n28_), .b(new_n52_), .c(new_n36_), .d(new_n27_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(x12), .c(x03), .O(new_n64_));
  nand4  g45(.a(new_n64_), .b(new_n62_), .c(new_n26_), .d(new_n22_), .O(z3));
  nand2  g46(.a(new_n24_), .b(new_n22_), .O(z4));
endmodule
