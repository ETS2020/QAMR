...
module FAU ( 
  ...
  aoi21  g20(.a(new_n20_), .b(new_n39_), .c(new_n28_), .O(new_n40_));
  ...
  nand2  g28(.a(x08), .b(x05), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  aoi22  g30(.a(new_n49_), .b(x11), .c(new_n44_), .d(x02), .O(new_n50_));
  ...
  nand3  g35(.a(new_n54_), .b(new_n45_), .c(new_n24_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n22_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nor2   g38(.a(new_n42_), .b(x08), .O(new_n58_));
  ...
  nand2  g45(.a(x08), .b(new_n28_), .O(new_n65_));
