...
module FAU ( 
  ...
  nand3  g24(.a(new_n29_), .b(new_n43_), .c(new_n35_), .O(new_n44_));
  nand3  g25(.a(x13), .b(x09), .c(x05), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n44_), .c(new_n42_), .O(new_n46_));
  nand4  g27(.a(new_n43_), .b(new_n35_), .c(x04), .d(x02), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(x11), .c(new_n46_), .d(x02), .O(new_n48_));
  inv1   g29(.a(x05), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n49_), .O(new_n51_));
  oai21  g32(.a(new_n48_), .b(new_n20_), .c(new_n51_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n29_), .c(new_n43_), .d(new_n35_), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n56_), .c(new_n49_), .O(new_n58_));
  nor2   g39(.a(new_n53_), .b(new_n29_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n58_), .c(x03), .O(new_n60_));
  nor2   g41(.a(x07), .b(new_n49_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n20_), .c(new_n30_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  oai22  g44(.a(new_n21_), .b(new_n42_), .c(x11), .d(x05), .O(z4));
endmodule
