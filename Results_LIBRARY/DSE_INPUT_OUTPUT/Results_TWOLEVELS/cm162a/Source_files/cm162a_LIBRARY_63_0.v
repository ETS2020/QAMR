...
module FAU ( 
  ...
  aoi22  g10(.a(new_n29_), .b(new_n27_), .c(x08), .d(new_n28_), .O(new_n30_));
  ...
  aoi21  g27(.a(new_n46_), .b(new_n32_), .c(new_n43_), .O(new_n47_));
  ...
  aoi21  g32(.a(new_n51_), .b(new_n40_), .c(new_n28_), .O(new_n52_));
  oai21  g33(.a(new_n50_), .b(new_n40_), .c(new_n52_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n45_), .c(new_n44_), .d(new_n20_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n32_), .c(new_n43_), .O(new_n56_));
  nor3   g37(.a(x11), .b(x10), .c(x08), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n24_), .c(new_n54_), .O(new_n58_));
  aoi21  g39(.a(new_n56_), .b(x02), .c(new_n58_), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n40_), .c(new_n28_), .O(new_n61_));
  oai21  g42(.a(new_n59_), .b(new_n40_), .c(new_n61_), .O(z3));
  oai22  g43(.a(new_n21_), .b(new_n43_), .c(x08), .d(x05), .O(z4));
endmodule
