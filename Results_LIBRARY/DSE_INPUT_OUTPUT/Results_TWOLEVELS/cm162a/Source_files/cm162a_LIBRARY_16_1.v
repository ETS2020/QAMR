...
module FAU ( 
  ...
  nand3  g24(.a(new_n40_), .b(new_n43_), .c(new_n24_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n22_), .c(new_n21_), .O(new_n45_));
  nor2   g26(.a(x10), .b(x08), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n25_), .c(new_n40_), .O(new_n47_));
  ...
  nand3  g33(.a(new_n46_), .b(new_n52_), .c(new_n40_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n21_), .O(new_n54_));
  inv1   g35(.a(new_n44_), .O(new_n55_));
  ...
  nand2  g41(.a(x11), .b(new_n29_), .O(new_n61_));
