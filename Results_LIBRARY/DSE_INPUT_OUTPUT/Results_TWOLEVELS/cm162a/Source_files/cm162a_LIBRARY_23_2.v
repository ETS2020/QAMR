...
module FAU ( 
  ...
  nand4  g21(.a(new_n21_), .b(new_n40_), .c(new_n26_), .d(x04), .O(new_n41_));
  inv1   g22(.a(new_n41_), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(x03), .c(x02), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n39_), .O(z1));
  nand4  g25(.a(new_n40_), .b(new_n26_), .c(x04), .d(x02), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x11), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n36_), .c(new_n32_), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(x05), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(new_n21_), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand2  g31(.a(new_n20_), .b(x07), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n50_), .c(new_n40_), .d(new_n26_), .O(new_n52_));
