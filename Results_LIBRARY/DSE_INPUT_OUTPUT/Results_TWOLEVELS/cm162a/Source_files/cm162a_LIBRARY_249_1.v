...
module FAU ( 
  ...
  aoi21  g18(.a(new_n37_), .b(new_n25_), .c(new_n20_), .O(new_n38_));
  aoi21  g19(.a(new_n27_), .b(x02), .c(new_n30_), .O(new_n39_));
  aoi21  g20(.a(new_n38_), .b(x02), .c(new_n39_), .O(new_n40_));
  inv1   g21(.a(x01), .O(new_n41_));
  nand2  g22(.a(new_n35_), .b(new_n41_), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n21_), .c(x05), .O(new_n43_));
  inv1   g24(.a(new_n43_), .O(new_n44_));
  oai21  g25(.a(new_n40_), .b(new_n35_), .c(new_n44_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n30_), .c(new_n27_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n25_), .c(new_n20_), .O(new_n48_));
  nor2   g29(.a(new_n20_), .b(new_n24_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n36_), .c(new_n46_), .O(new_n50_));
  ...
  oai21  g36(.a(new_n51_), .b(new_n35_), .c(new_n55_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n46_), .c(new_n30_), .d(new_n27_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n25_), .c(new_n20_), .O(new_n59_));
  nor3   g40(.a(x11), .b(x10), .c(x08), .O(new_n60_));
  aoi21  g41(.a(new_n49_), .b(new_n60_), .c(new_n57_), .O(new_n61_));
  aoi21  g42(.a(new_n59_), .b(x02), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n35_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n21_), .c(x05), .O(new_n65_));
  inv1   g46(.a(new_n65_), .O(new_n66_));
  oai21  g47(.a(new_n62_), .b(new_n35_), .c(new_n66_), .O(z3));
  oai21  g48(.a(new_n25_), .b(new_n20_), .c(new_n21_), .O(z4));
endmodule
