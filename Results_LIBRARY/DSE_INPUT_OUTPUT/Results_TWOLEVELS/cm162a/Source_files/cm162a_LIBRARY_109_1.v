...
module FAU ( 
  ...
  nand3  g37(.a(new_n50_), .b(new_n56_), .c(new_n46_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n33_), .c(new_n44_), .O(new_n58_));
  nor3   g39(.a(x11), .b(x10), .c(x08), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n49_), .c(new_n56_), .O(new_n60_));
  ...
  nand4  g45(.a(x13), .b(x09), .c(x05), .d(x04), .O(new_n65_));
