...
module FAU ( 
  ...
  nand2  g09(.a(x11), .b(x00), .O(new_n29_));
  ...
  nand2  g18(.a(x11), .b(x01), .O(new_n38_));
  ...
  nand2  g27(.a(x11), .b(x06), .O(new_n47_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n48_), .c(new_n46_), .d(x05), .O(z2));
  ...
  nand2  g37(.a(x11), .b(x07), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n20_), .O(new_n58_));
  aoi21  g39(.a(new_n49_), .b(new_n25_), .c(x11), .O(new_n59_));
  nor2   g40(.a(new_n42_), .b(new_n20_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(x12), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n58_), .c(new_n56_), .d(x05), .O(z3));
  oai22  g43(.a(new_n22_), .b(new_n21_), .c(x11), .d(x03), .O(z4));
endmodule
