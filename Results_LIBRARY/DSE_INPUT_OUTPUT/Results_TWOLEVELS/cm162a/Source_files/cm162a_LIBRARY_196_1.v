...
module FAU ( 
  ...
  nand4  g37(.a(new_n56_), .b(new_n46_), .c(new_n45_), .d(new_n36_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n21_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  oai21  g40(.a(new_n47_), .b(new_n24_), .c(x12), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x05), .c(x03), .O(new_n62_));
  oai21  g43(.a(new_n29_), .b(new_n20_), .c(new_n30_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n62_), .O(z3));
  nand2  g45(.a(x07), .b(new_n29_), .O(new_n65_));
