...
module FAU ( 
  ...
  aoi21  g30(.a(new_n39_), .b(new_n20_), .c(new_n27_), .O(new_n50_));
  oai21  g31(.a(new_n49_), .b(new_n20_), .c(new_n50_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n43_), .c(new_n42_), .d(new_n33_), .O(new_n53_));
  ...
  nand2  g40(.a(new_n59_), .b(new_n40_), .O(z3));
  oai22  g41(.a(new_n30_), .b(new_n21_), .c(new_n39_), .d(x05), .O(z4));
endmodule
