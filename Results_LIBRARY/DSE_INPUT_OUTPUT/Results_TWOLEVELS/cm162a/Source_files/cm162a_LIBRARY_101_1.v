...
module FAU ( 
  ...
  nand3  g02(.a(x13), .b(x09), .c(x08), .O(new_n22_));
  ...
  nand2  g07(.a(x13), .b(new_n26_), .O(new_n27_));
  ...
  nand3  g17(.a(new_n36_), .b(new_n35_), .c(new_n26_), .O(new_n37_));
  aoi21  g18(.a(new_n37_), .b(new_n22_), .c(new_n21_), .O(new_n38_));
  nand2  g19(.a(new_n24_), .b(new_n36_), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(new_n26_), .c(new_n35_), .O(new_n40_));
  aoi21  g21(.a(new_n38_), .b(x02), .c(new_n40_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n20_), .c(new_n34_), .O(z1));
  inv1   g23(.a(x11), .O(new_n43_));
  nand4  g24(.a(new_n36_), .b(new_n43_), .c(new_n35_), .d(new_n26_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n22_), .c(new_n21_), .O(new_n45_));
  nand3  g26(.a(new_n35_), .b(x04), .c(x02), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n36_), .O(new_n47_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n43_), .c(new_n35_), .d(new_n26_), .O(new_n54_));
  ...
  nand4  g45(.a(x13), .b(x09), .c(x08), .d(x04), .O(new_n65_));
