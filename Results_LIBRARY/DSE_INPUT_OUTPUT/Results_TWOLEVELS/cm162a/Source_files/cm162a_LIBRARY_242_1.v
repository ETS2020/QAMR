...
module FAU ( 
  ...
  nor2   g19(.a(x11), .b(x05), .O(new_n39_));
  ...
  nand4  g27(.a(new_n42_), .b(new_n24_), .c(x04), .d(x02), .O(new_n47_));
  ...
  nand2  g37(.a(new_n47_), .b(new_n43_), .O(new_n57_));
  nand2  g38(.a(x11), .b(x05), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  aoi22  g40(.a(new_n59_), .b(x12), .c(new_n56_), .d(x02), .O(new_n60_));
  ...
  oai22  g44(.a(new_n31_), .b(new_n21_), .c(new_n43_), .d(x05), .O(z4));
endmodule
