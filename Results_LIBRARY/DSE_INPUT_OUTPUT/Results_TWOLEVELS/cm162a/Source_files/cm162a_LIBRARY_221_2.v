...
module FAU ( 
  ...
  oai21  g15(.a(new_n24_), .b(new_n22_), .c(new_n34_), .O(new_n35_));
  ...
  oai21  g26(.a(new_n34_), .b(new_n27_), .c(x11), .O(new_n46_));
  ...
  nand2  g30(.a(new_n22_), .b(new_n20_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n49_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n42_), .c(new_n33_), .d(new_n32_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n24_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  oai21  g36(.a(new_n43_), .b(new_n27_), .c(x12), .O(new_n56_));
  ...
  oai22  g42(.a(new_n24_), .b(new_n61_), .c(x05), .d(new_n20_), .O(z4));
endmodule
