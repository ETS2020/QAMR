...
module FAU ( 
  ...
  aoi21  g05(.a(new_n24_), .b(x08), .c(x07), .O(new_n25_));
  ...
  aoi21  g13(.a(new_n32_), .b(x10), .c(x07), .O(new_n33_));
  ...
  aoi21  g26(.a(new_n45_), .b(x11), .c(x07), .O(new_n46_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n41_), .c(new_n40_), .d(new_n31_), .O(new_n54_));
  ...
  oai21  g39(.a(new_n42_), .b(new_n24_), .c(x12), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n52_), .c(new_n37_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n58_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n21_), .b(new_n63_), .c(new_n52_), .d(new_n20_), .O(z4));
endmodule
