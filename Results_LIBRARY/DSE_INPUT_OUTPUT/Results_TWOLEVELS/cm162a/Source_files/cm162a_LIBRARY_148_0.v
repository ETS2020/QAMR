...
module FAU ( 
  ...
  nand2  g40(.a(x08), .b(x03), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n29_), .c(new_n50_), .O(new_n61_));
  oai21  g42(.a(new_n59_), .b(new_n20_), .c(new_n61_), .O(z3));
  oai21  g43(.a(new_n22_), .b(new_n21_), .c(new_n30_), .O(z4));
endmodule
