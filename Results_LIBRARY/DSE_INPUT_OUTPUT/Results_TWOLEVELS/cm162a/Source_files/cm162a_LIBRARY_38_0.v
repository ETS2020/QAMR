...
module FAU ( 
  ...
  inv1   g19(.a(new_n22_), .O(new_n39_));
  nor3   g20(.a(x11), .b(x10), .c(x08), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(x02), .O(new_n41_));
  nand2  g22(.a(x11), .b(x10), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n41_), .c(new_n21_), .O(new_n43_));
  nand3  g24(.a(new_n34_), .b(x11), .c(x05), .O(new_n44_));
  inv1   g25(.a(new_n44_), .O(new_n45_));
  oai21  g26(.a(new_n45_), .b(new_n43_), .c(x03), .O(new_n46_));
  nor2   g27(.a(x06), .b(new_n29_), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n20_), .c(new_n29_), .d(x04), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(z2));
  inv1   g30(.a(x10), .O(new_n50_));
  inv1   g31(.a(x11), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n51_), .c(new_n50_), .d(new_n24_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n21_), .O(new_n54_));
  aoi21  g35(.a(new_n40_), .b(new_n25_), .c(new_n52_), .O(new_n55_));
  ...
  nand2  g40(.a(new_n29_), .b(new_n21_), .O(new_n60_));
  oai21  g41(.a(new_n22_), .b(new_n21_), .c(new_n60_), .O(z4));
endmodule
