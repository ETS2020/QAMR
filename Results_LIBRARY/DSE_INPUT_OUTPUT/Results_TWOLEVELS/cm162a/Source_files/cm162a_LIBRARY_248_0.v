...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(x05), .c(x04), .d(x02), .O(new_n46_));
  ...
  aoi22  g31(.a(new_n50_), .b(new_n20_), .c(x11), .d(new_n27_), .O(new_n51_));
  ...
  oai22  g43(.a(new_n42_), .b(new_n21_), .c(x11), .d(x05), .O(z4));
endmodule
