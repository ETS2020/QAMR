...
module FAU ( 
  ...
  nand3  g04(.a(new_n21_), .b(x04), .c(x02), .O(new_n24_));
  oai21  g05(.a(new_n23_), .b(new_n21_), .c(new_n24_), .O(new_n25_));
  ...
  nand3  g13(.a(new_n23_), .b(new_n32_), .c(new_n21_), .O(new_n33_));
  aoi21  g14(.a(new_n33_), .b(new_n31_), .c(new_n28_), .O(new_n34_));
  ...
  nand3  g19(.a(new_n38_), .b(new_n32_), .c(new_n21_), .O(new_n39_));
  nor2   g20(.a(new_n39_), .b(new_n22_), .O(new_n40_));
  aoi21  g21(.a(new_n33_), .b(x11), .c(new_n40_), .O(new_n41_));
  inv1   g22(.a(x05), .O(new_n42_));
  nor2   g23(.a(x06), .b(x03), .O(new_n43_));
  nor3   g24(.a(new_n43_), .b(x09), .c(new_n42_), .O(new_n44_));
  oai21  g25(.a(new_n41_), .b(new_n28_), .c(new_n44_), .O(z2));
  oai21  g26(.a(new_n39_), .b(new_n22_), .c(x12), .O(new_n46_));
