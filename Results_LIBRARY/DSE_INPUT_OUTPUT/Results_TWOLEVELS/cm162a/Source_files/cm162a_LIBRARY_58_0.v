...
module FAU ( 
  ...
  nand2  g16(.a(new_n23_), .b(x10), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n35_), .c(new_n28_), .O(new_n37_));
  inv1   g18(.a(x10), .O(new_n38_));
  nor2   g19(.a(new_n38_), .b(new_n30_), .O(new_n39_));
  ...
  nand4  g38(.a(new_n57_), .b(new_n44_), .c(new_n38_), .d(new_n30_), .O(new_n58_));
  oai21  g39(.a(new_n20_), .b(new_n28_), .c(new_n58_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x04), .c(x02), .O(new_n60_));
  oai21  g41(.a(x11), .b(x10), .c(x05), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n30_), .c(x04), .d(x02), .O(new_n62_));
  ...
  aoi21  g47(.a(new_n66_), .b(new_n53_), .c(new_n28_), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n65_), .O(z3));
  inv1   g49(.a(x04), .O(new_n69_));
  oai22  g50(.a(new_n20_), .b(new_n69_), .c(x08), .d(x05), .O(z4));
endmodule
