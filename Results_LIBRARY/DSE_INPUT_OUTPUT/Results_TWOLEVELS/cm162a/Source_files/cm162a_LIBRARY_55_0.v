...
module FAU ( 
  ...
  oai21  g07(.a(new_n26_), .b(new_n23_), .c(x03), .O(new_n27_));
  ...
  or2    g18(.a(new_n29_), .b(x01), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n37_), .O(z1));
  inv1   g20(.a(x04), .O(new_n40_));
  inv1   g21(.a(x10), .O(new_n41_));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n24_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n20_), .c(new_n40_), .O(new_n44_));
  ...
  aoi21  g29(.a(new_n48_), .b(new_n28_), .c(new_n33_), .O(new_n49_));
  oai21  g30(.a(new_n47_), .b(new_n28_), .c(new_n49_), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n42_), .c(new_n41_), .d(new_n24_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n20_), .c(new_n40_), .O(new_n53_));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n28_), .c(new_n33_), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n28_), .c(new_n58_), .O(z3));
  inv1   g40(.a(x09), .O(new_n60_));
  oai21  g41(.a(x05), .b(x03), .c(x13), .O(new_n61_));
  nor3   g42(.a(new_n61_), .b(new_n60_), .c(new_n40_), .O(z4));
endmodule
