...
module FAU ( 
  ...
  nand3  g02(.a(x13), .b(x09), .c(x07), .O(new_n22_));
  ...
  oai21  g29(.a(x06), .b(x03), .c(x07), .O(new_n49_));
  nor2   g30(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  oai21  g31(.a(new_n47_), .b(new_n20_), .c(new_n50_), .O(z2));
  nand2  g32(.a(x13), .b(x09), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n41_), .c(new_n40_), .d(new_n32_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  oai21  g37(.a(new_n42_), .b(new_n24_), .c(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x07), .c(x03), .O(new_n59_));
