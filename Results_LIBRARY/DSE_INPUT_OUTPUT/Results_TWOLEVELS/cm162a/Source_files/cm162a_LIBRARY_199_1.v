...
module FAU ( 
  ...
  oai21  g16(.a(new_n21_), .b(new_n29_), .c(new_n35_), .O(new_n36_));
  ...
  oai21  g36(.a(new_n55_), .b(new_n35_), .c(new_n21_), .O(new_n56_));
  ...
  oai21  g41(.a(new_n29_), .b(new_n20_), .c(new_n30_), .O(new_n61_));
