...
module FAU ( 
  ...
  nand3  g18(.a(new_n37_), .b(x05), .c(x03), .O(new_n38_));
  ...
  nand4  g27(.a(new_n42_), .b(new_n34_), .c(x04), .d(x02), .O(new_n47_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n43_), .c(new_n42_), .d(new_n34_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n31_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  oai21  g38(.a(new_n44_), .b(new_n24_), .c(x12), .O(new_n58_));
