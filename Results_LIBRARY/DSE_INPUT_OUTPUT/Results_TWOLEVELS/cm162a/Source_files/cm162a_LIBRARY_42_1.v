...
module FAU ( 
  ...
  oai21  g16(.a(new_n35_), .b(new_n24_), .c(new_n21_), .O(new_n36_));
  nor3   g17(.a(x11), .b(x10), .c(x08), .O(new_n37_));
  aoi22  g18(.a(new_n37_), .b(new_n27_), .c(new_n28_), .d(x10), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n32_), .c(new_n36_), .O(z1));
  inv1   g20(.a(x11), .O(new_n40_));
  nand2  g21(.a(x13), .b(x09), .O(new_n41_));
  oai21  g22(.a(x10), .b(x08), .c(new_n41_), .O(new_n42_));
  nand4  g23(.a(new_n42_), .b(x04), .c(x03), .d(x02), .O(new_n43_));
  inv1   g24(.a(x05), .O(new_n44_));
  inv1   g25(.a(x06), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n32_), .c(new_n44_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n43_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n40_), .O(new_n48_));
  aoi21  g29(.a(x06), .b(new_n32_), .c(new_n40_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n44_), .c(x10), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n48_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n26_), .c(x04), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n22_), .c(new_n40_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n20_), .O(new_n55_));
  nand3  g36(.a(new_n27_), .b(new_n20_), .c(new_n26_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x12), .c(x03), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n32_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n57_), .c(new_n55_), .d(new_n25_), .O(z3));
  nand2  g41(.a(new_n23_), .b(new_n21_), .O(z4));
endmodule
