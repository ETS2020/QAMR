...
module FAU ( 
  ...
  nand3  g17(.a(new_n29_), .b(new_n20_), .c(new_n28_), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(x03), .O(new_n39_));
  nor2   g20(.a(x03), .b(x01), .O(new_n40_));
  nor2   g21(.a(new_n40_), .b(new_n22_), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n39_), .c(new_n27_), .O(z1));
  inv1   g23(.a(x05), .O(new_n43_));
  oai22  g24(.a(new_n25_), .b(new_n24_), .c(x06), .d(x03), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(new_n23_), .O(new_n45_));
  nand2  g26(.a(new_n30_), .b(x11), .O(new_n46_));
  inv1   g27(.a(x11), .O(new_n47_));
  nand3  g28(.a(new_n29_), .b(new_n47_), .c(new_n28_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n46_), .c(x10), .O(new_n49_));
  nand3  g30(.a(new_n21_), .b(x11), .c(x10), .O(new_n50_));
  inv1   g31(.a(new_n50_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n49_), .c(x03), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n45_), .O(z2));
  oai22  g34(.a(new_n25_), .b(new_n24_), .c(x07), .d(x03), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n43_), .c(new_n23_), .O(new_n55_));
  nand2  g36(.a(new_n48_), .b(x12), .O(new_n56_));
  nand4  g37(.a(new_n29_), .b(new_n21_), .c(new_n47_), .d(new_n28_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n20_), .c(x03), .O(new_n59_));
