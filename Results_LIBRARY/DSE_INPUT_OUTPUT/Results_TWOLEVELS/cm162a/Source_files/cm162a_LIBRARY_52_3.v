...
module FAU ( 
  ...
  nand3  g05(.a(x13), .b(x09), .c(new_n20_), .O(new_n25_));
  ...
  oai21  g17(.a(x11), .b(x10), .c(new_n36_), .O(new_n37_));
  ...
  aoi21  g22(.a(new_n41_), .b(new_n38_), .c(new_n33_), .O(new_n42_));
  ...
  aoi21  g31(.a(new_n46_), .b(new_n39_), .c(x08), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n28_), .c(x12), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x03), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n33_), .c(x08), .O(new_n56_));
