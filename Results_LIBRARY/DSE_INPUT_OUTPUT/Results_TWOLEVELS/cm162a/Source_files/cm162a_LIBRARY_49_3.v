...
module FAU ( 
  ...
  oai21  g23(.a(new_n22_), .b(x07), .c(new_n42_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(x04), .c(x02), .O(new_n44_));
  oai21  g25(.a(new_n40_), .b(x07), .c(new_n33_), .O(new_n45_));
  oai21  g26(.a(new_n45_), .b(new_n25_), .c(x11), .O(new_n46_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n41_), .c(new_n40_), .d(new_n33_), .O(new_n54_));
  ...
  oai21  g38(.a(new_n42_), .b(new_n25_), .c(x12), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n57_), .c(x03), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x05), .O(z3));
  inv1   g42(.a(x04), .O(new_n62_));
  oai22  g43(.a(new_n22_), .b(new_n62_), .c(new_n20_), .d(new_n49_), .O(z4));
endmodule
