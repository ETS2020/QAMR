...
module FAU ( 
  ...
  nand4  g23(.a(new_n35_), .b(x04), .c(x03), .d(x02), .O(new_n43_));
  oai21  g24(.a(x06), .b(x03), .c(new_n43_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n22_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(x05), .O(z2));
  inv1   g27(.a(x12), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n32_), .c(new_n31_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n34_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x04), .c(x02), .O(new_n50_));
  oai21  g31(.a(new_n33_), .b(new_n25_), .c(x12), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n50_), .c(new_n20_), .O(new_n52_));
  nor2   g33(.a(x07), .b(x03), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n52_), .c(new_n22_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x05), .O(z3));
  oai22  g36(.a(new_n34_), .b(new_n21_), .c(new_n22_), .d(new_n27_), .O(z4));
endmodule
