...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n36_), .c(x06), .O(new_n38_));
  ...
  oai21  g29(.a(new_n48_), .b(new_n20_), .c(new_n40_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n42_), .c(new_n41_), .d(new_n33_), .O(new_n51_));
