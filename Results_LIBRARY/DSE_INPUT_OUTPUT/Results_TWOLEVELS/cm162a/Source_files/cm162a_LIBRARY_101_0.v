...
module FAU ( 
  ...
  nor2   g10(.a(x13), .b(x08), .O(new_n30_));
  ...
  oai21  g15(.a(x13), .b(x08), .c(new_n34_), .O(new_n35_));
  inv1   g16(.a(x10), .O(new_n36_));
  nor2   g17(.a(x10), .b(x08), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(x09), .c(x04), .O(new_n38_));
  oai22  g19(.a(new_n38_), .b(new_n25_), .c(new_n26_), .d(new_n36_), .O(new_n39_));
  nor2   g20(.a(new_n36_), .b(new_n24_), .O(new_n40_));
  aoi21  g21(.a(new_n39_), .b(x13), .c(new_n40_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n20_), .c(new_n35_), .O(z1));
  inv1   g23(.a(x09), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(new_n36_), .c(new_n24_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand3  g28(.a(new_n36_), .b(x04), .c(x02), .O(new_n48_));
  ...
  oai21  g34(.a(new_n53_), .b(new_n50_), .c(x13), .O(new_n54_));
  ...
  nand3  g40(.a(new_n37_), .b(new_n59_), .c(new_n44_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n22_), .c(new_n21_), .O(new_n61_));
  inv1   g42(.a(new_n45_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n26_), .c(new_n59_), .O(new_n63_));
  aoi21  g44(.a(new_n61_), .b(x02), .c(new_n63_), .O(new_n64_));
  nor2   g45(.a(x07), .b(x03), .O(new_n65_));
  nor3   g46(.a(new_n65_), .b(new_n30_), .c(new_n29_), .O(new_n66_));
