...
module FAU ( 
  ...
  oai21  g07(.a(new_n26_), .b(x08), .c(x10), .O(new_n27_));
  ...
  aoi21  g24(.a(new_n43_), .b(new_n41_), .c(new_n22_), .O(new_n44_));
  ...
  oai21  g32(.a(new_n39_), .b(new_n29_), .c(x12), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n51_), .c(new_n22_), .O(new_n53_));
  ...
  oai22  g38(.a(new_n26_), .b(new_n57_), .c(new_n20_), .d(new_n33_), .O(z4));
endmodule
