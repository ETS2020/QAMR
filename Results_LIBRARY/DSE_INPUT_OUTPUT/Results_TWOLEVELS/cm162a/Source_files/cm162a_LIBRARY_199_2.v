...
module FAU ( 
  ...
  nor3   g22(.a(new_n41_), .b(new_n30_), .c(new_n40_), .O(new_n42_));
  ...
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(x07), .O(new_n51_));
  ...
  oai22  g42(.a(new_n21_), .b(new_n61_), .c(x07), .d(new_n40_), .O(z4));
endmodule
