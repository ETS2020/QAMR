...
module FAU ( 
  ...
  nand2  g07(.a(x12), .b(x04), .O(new_n27_));
  ...
  oai21  g19(.a(x08), .b(new_n38_), .c(x10), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(new_n37_), .c(x12), .O(new_n40_));
  ...
  nand3  g27(.a(new_n46_), .b(new_n41_), .c(new_n45_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n35_), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n22_), .c(x04), .d(x02), .O(new_n49_));
  nand2  g30(.a(new_n41_), .b(new_n45_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n25_), .c(x11), .O(new_n51_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n53_), .c(new_n27_), .d(x05), .O(z2));
  nand4  g37(.a(new_n48_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  inv1   g38(.a(x05), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n20_), .c(new_n58_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n22_), .O(new_n62_));
  aoi21  g43(.a(x07), .b(new_n20_), .c(new_n22_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n58_), .c(new_n21_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  aoi21  g46(.a(new_n35_), .b(new_n22_), .c(new_n21_), .O(z4));
endmodule
