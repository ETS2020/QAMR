...
module FAU ( 
  ...
  oai21  g09(.a(x12), .b(new_n28_), .c(new_n27_), .O(new_n29_));
  ...
  nand3  g15(.a(new_n34_), .b(new_n29_), .c(new_n26_), .O(z0));
  inv1   g16(.a(x10), .O(new_n36_));
  inv1   g17(.a(new_n32_), .O(new_n37_));
  nand3  g18(.a(new_n31_), .b(new_n36_), .c(new_n30_), .O(new_n38_));
  ...
  nor2   g22(.a(new_n41_), .b(new_n24_), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n40_), .c(new_n26_), .O(z1));
  nand2  g24(.a(x13), .b(x09), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n36_), .c(new_n30_), .O(new_n46_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n51_), .c(new_n24_), .O(z2));
  oai22  g36(.a(new_n21_), .b(new_n20_), .c(x07), .d(x03), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n52_), .c(new_n25_), .O(new_n57_));
  nand4  g38(.a(new_n31_), .b(new_n45_), .c(new_n36_), .d(new_n30_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x12), .c(x00), .O(new_n59_));
  nand4  g40(.a(new_n37_), .b(new_n23_), .c(new_n45_), .d(new_n36_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n57_), .O(z3));
  nand4  g44(.a(new_n25_), .b(x13), .c(x09), .d(x04), .O(new_n64_));
