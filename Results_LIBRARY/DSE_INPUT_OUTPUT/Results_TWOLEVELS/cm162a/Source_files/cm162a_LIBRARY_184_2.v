...
module FAU ( 
  ...
  aoi21  g40(.a(new_n59_), .b(x12), .c(new_n26_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  nand2  g43(.a(x07), .b(new_n20_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n49_), .c(new_n51_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai22  g47(.a(new_n23_), .b(new_n66_), .c(x03), .d(new_n20_), .O(z4));
endmodule
