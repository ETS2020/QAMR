...
module FAU ( 
  ...
  nand4  g20(.a(new_n39_), .b(new_n37_), .c(x13), .d(x05), .O(z1));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n30_), .c(new_n41_), .O(new_n45_));
  ...
  oai21  g31(.a(x06), .b(x03), .c(x13), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  oai21  g33(.a(new_n49_), .b(new_n20_), .c(new_n52_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n43_), .c(new_n42_), .d(new_n33_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n30_), .c(new_n41_), .O(new_n56_));
  nor3   g37(.a(x11), .b(x10), .c(x08), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n46_), .c(new_n54_), .O(new_n58_));
  aoi21  g39(.a(new_n56_), .b(x02), .c(new_n58_), .O(new_n59_));
  oai21  g40(.a(x07), .b(x03), .c(x13), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n50_), .O(new_n61_));
