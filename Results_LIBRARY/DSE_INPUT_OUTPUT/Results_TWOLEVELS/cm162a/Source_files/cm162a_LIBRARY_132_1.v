...
module FAU ( 
  ...
  nand4  g19(.a(new_n38_), .b(new_n29_), .c(x04), .d(x02), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x03), .O(new_n41_));
  nor2   g22(.a(x03), .b(x01), .O(new_n42_));
  nor2   g23(.a(new_n42_), .b(new_n33_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n41_), .c(new_n26_), .O(z1));
  inv1   g25(.a(x03), .O(new_n45_));
  oai21  g26(.a(x11), .b(new_n45_), .c(new_n20_), .O(new_n46_));
  and2   g27(.a(new_n39_), .b(x11), .O(new_n47_));
  nor4   g28(.a(new_n27_), .b(x11), .c(x10), .d(x08), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x03), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(new_n46_), .c(new_n26_), .O(z2));
  inv1   g31(.a(x05), .O(new_n51_));
  oai21  g32(.a(x07), .b(x03), .c(new_n24_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(new_n21_), .O(new_n53_));
  nand2  g34(.a(new_n39_), .b(x12), .O(new_n54_));
  nor2   g35(.a(x12), .b(x10), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n29_), .c(x04), .d(x02), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n54_), .c(x11), .O(new_n57_));
  nand3  g38(.a(x12), .b(x11), .c(x06), .O(new_n58_));
