...
module FAU ( 
  ...
  aoi21  g16(.a(new_n35_), .b(x10), .c(new_n31_), .O(new_n36_));
  ...
  nand2  g27(.a(new_n42_), .b(new_n34_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n23_), .c(x11), .O(new_n48_));
  ...
  oai21  g38(.a(new_n44_), .b(new_n23_), .c(x12), .O(new_n58_));
  ...
  oai22  g45(.a(new_n20_), .b(new_n64_), .c(x05), .d(new_n27_), .O(z4));
endmodule
