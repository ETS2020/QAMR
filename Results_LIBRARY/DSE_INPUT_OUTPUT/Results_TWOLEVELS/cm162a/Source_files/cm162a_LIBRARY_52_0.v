...
module FAU ( 
  ...
  nor2   g10(.a(new_n24_), .b(x05), .O(new_n30_));
  ...
  nor2   g30(.a(new_n43_), .b(new_n24_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(x03), .O(new_n51_));
  nor2   g32(.a(x06), .b(new_n28_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n33_), .c(new_n30_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n51_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n43_), .c(new_n42_), .d(new_n24_), .O(new_n56_));
  ...
  aoi21  g40(.a(new_n59_), .b(x05), .c(new_n37_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n55_), .c(new_n58_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n33_), .c(new_n28_), .O(new_n64_));
