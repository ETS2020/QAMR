...
module FAU ( 
  ...
  aoi21  g11(.a(new_n30_), .b(new_n20_), .c(new_n28_), .O(new_n31_));
  ...
  nand3  g28(.a(new_n44_), .b(x12), .c(new_n47_), .O(new_n48_));
  oai21  g29(.a(new_n46_), .b(new_n20_), .c(new_n48_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x04), .c(x02), .O(new_n50_));
  aoi21  g31(.a(new_n44_), .b(new_n25_), .c(new_n47_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(x03), .c(new_n28_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n50_), .c(new_n43_), .O(z2));
  nor2   g34(.a(new_n46_), .b(new_n21_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x03), .c(x02), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  oai21  g37(.a(x12), .b(new_n56_), .c(new_n20_), .O(new_n57_));
  nor2   g38(.a(x11), .b(x10), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n25_), .c(new_n24_), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(x12), .c(new_n28_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n57_), .c(new_n55_), .O(z3));
  nand2  g42(.a(x12), .b(new_n20_), .O(new_n62_));
