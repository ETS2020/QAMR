...
module FAU ( 
  ...
  nand2  g17(.a(new_n27_), .b(x10), .O(new_n37_));
  ...
  aoi21  g24(.a(new_n43_), .b(new_n39_), .c(new_n30_), .O(z1));
  ...
  oai21  g29(.a(new_n48_), .b(new_n41_), .c(new_n45_), .O(new_n49_));
  nor3   g30(.a(x11), .b(x10), .c(x08), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(x04), .c(x03), .d(x02), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n49_), .c(new_n24_), .O(z2));
  oai22  g33(.a(new_n22_), .b(new_n21_), .c(x07), .d(x03), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n42_), .c(new_n20_), .O(new_n54_));
  nand2  g35(.a(new_n47_), .b(x12), .O(new_n55_));
  nor2   g36(.a(x12), .b(x10), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n26_), .c(new_n25_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n55_), .c(x11), .O(new_n58_));
  nand2  g39(.a(x12), .b(x11), .O(new_n59_));
  nor2   g40(.a(new_n59_), .b(x06), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n58_), .c(x03), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n54_), .O(z3));
  nand4  g43(.a(new_n20_), .b(x13), .c(x09), .d(x04), .O(new_n63_));
