...
module FAU ( 
  ...
  nand4  g35(.a(new_n54_), .b(new_n45_), .c(new_n35_), .d(new_n34_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  oai21  g38(.a(new_n46_), .b(new_n24_), .c(x12), .O(new_n58_));
  ...
  nand2  g42(.a(new_n61_), .b(new_n31_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai21  g44(.a(new_n21_), .b(new_n63_), .c(new_n43_), .O(z4));
endmodule
