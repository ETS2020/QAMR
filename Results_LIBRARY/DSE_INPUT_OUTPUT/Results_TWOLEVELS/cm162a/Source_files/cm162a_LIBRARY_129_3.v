...
module FAU ( 
  ...
  oai21  g30(.a(new_n49_), .b(new_n42_), .c(new_n46_), .O(new_n50_));
  nor3   g31(.a(x11), .b(x10), .c(x08), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n50_), .c(new_n25_), .O(z2));
  oai21  g34(.a(x07), .b(x03), .c(new_n23_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n43_), .c(new_n20_), .O(new_n55_));
  nand2  g36(.a(new_n48_), .b(x12), .O(new_n56_));
  nor2   g37(.a(x12), .b(x10), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n27_), .c(new_n26_), .O(new_n58_));
