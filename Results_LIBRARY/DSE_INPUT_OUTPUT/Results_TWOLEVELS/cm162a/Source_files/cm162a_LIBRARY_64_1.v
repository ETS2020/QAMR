...
module FAU ( 
  ...
  aoi21  g21(.a(new_n40_), .b(x11), .c(new_n32_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n38_), .O(z2));
  inv1   g23(.a(new_n32_), .O(new_n43_));
  nor2   g24(.a(x12), .b(x11), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n39_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n28_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand2  g28(.a(x04), .b(x02), .O(new_n48_));
  oai21  g29(.a(new_n36_), .b(new_n48_), .c(x12), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(new_n47_), .c(new_n43_), .O(z3));
  inv1   g31(.a(x05), .O(new_n51_));
  oai22  g32(.a(new_n22_), .b(new_n21_), .c(new_n51_), .d(x03), .O(z4));
endmodule
