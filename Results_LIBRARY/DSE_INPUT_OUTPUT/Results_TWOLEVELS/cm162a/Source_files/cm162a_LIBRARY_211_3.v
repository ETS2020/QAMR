...
module FAU ( 
  ...
  oai21  g23(.a(x03), .b(x01), .c(new_n20_), .O(new_n43_));
  ...
  nand3  g28(.a(new_n47_), .b(x03), .c(x02), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x05), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand3  g31(.a(x11), .b(x10), .c(new_n28_), .O(new_n51_));
  ...
  oai21  g36(.a(new_n41_), .b(new_n52_), .c(x03), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n28_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(new_n50_), .O(z2));
  inv1   g39(.a(x05), .O(new_n59_));
  oai21  g40(.a(x07), .b(x03), .c(new_n48_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(new_n20_), .O(new_n61_));
  nand4  g42(.a(new_n29_), .b(new_n39_), .c(x04), .d(x02), .O(new_n62_));
  ...
  nor2   g48(.a(new_n67_), .b(x06), .O(new_n68_));
  oai21  g49(.a(new_n68_), .b(new_n66_), .c(x03), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n61_), .O(z3));
  nand2  g51(.a(new_n46_), .b(new_n20_), .O(z4));
endmodule
