...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n50_, new_n51_, new_n53_, new_n54_, new_n55_, new_n56_;
  ...
  nand4  g16(.a(x12), .b(new_n35_), .c(new_n26_), .d(x04), .O(new_n36_));
  nor2   g17(.a(new_n36_), .b(new_n34_), .O(new_n37_));
  and2   g18(.a(new_n28_), .b(x10), .O(new_n38_));
  ...
  oai22  g24(.a(new_n23_), .b(new_n22_), .c(x06), .d(x03), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(new_n21_), .O(new_n45_));
  inv1   g26(.a(x11), .O(new_n46_));
  nand2  g27(.a(new_n28_), .b(x12), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n35_), .c(new_n46_), .O(new_n48_));
  nand3  g29(.a(x12), .b(new_n46_), .c(new_n35_), .O(new_n49_));
  nor2   g30(.a(new_n49_), .b(new_n28_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n48_), .c(x03), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n45_), .O(z2));
  oai22  g33(.a(new_n23_), .b(new_n22_), .c(x07), .d(x03), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n43_), .c(new_n21_), .O(new_n54_));
  nand4  g35(.a(new_n27_), .b(new_n46_), .c(new_n35_), .d(new_n26_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x12), .c(x03), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n54_), .O(z3));
  nand2  g38(.a(new_n23_), .b(new_n21_), .O(z4));
endmodule
