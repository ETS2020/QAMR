...
module FAU ( 
  ...
  oai21  g13(.a(new_n32_), .b(x13), .c(x04), .O(new_n33_));
  ...
  oai21  g20(.a(new_n39_), .b(new_n27_), .c(x05), .O(z1));
  ...
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(x09), .O(new_n59_));
