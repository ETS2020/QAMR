...
module FAU ( 
  ...
  nand3  g25(.a(new_n37_), .b(new_n28_), .c(x04), .O(new_n45_));
  oai22  g26(.a(new_n45_), .b(new_n44_), .c(x06), .d(x03), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  nand4  g28(.a(new_n38_), .b(x11), .c(x06), .d(x03), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n47_), .c(new_n27_), .O(z2));
  inv1   g30(.a(x05), .O(new_n50_));
  oai21  g31(.a(x07), .b(x03), .c(new_n25_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(new_n22_), .O(new_n52_));
  nand2  g33(.a(new_n38_), .b(x12), .O(new_n53_));
  nor2   g34(.a(x12), .b(x10), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n29_), .c(new_n28_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n53_), .c(x11), .O(new_n56_));
  nand3  g37(.a(x12), .b(x11), .c(x06), .O(new_n57_));
  inv1   g38(.a(new_n57_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n56_), .c(x03), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n52_), .O(z3));
  nand2  g41(.a(new_n23_), .b(new_n22_), .O(z4));
endmodule
