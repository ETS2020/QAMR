...
module FAU ( 
  ...
  nor2   g33(.a(new_n23_), .b(new_n20_), .O(new_n53_));
  nor2   g34(.a(x10), .b(x08), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n31_), .O(new_n55_));
  oai21  g36(.a(x06), .b(x03), .c(new_n21_), .O(new_n56_));
  aoi21  g37(.a(new_n55_), .b(x03), .c(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n52_), .O(z2));
  inv1   g39(.a(x05), .O(new_n59_));
  nor4   g40(.a(new_n47_), .b(new_n23_), .c(new_n22_), .d(new_n20_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(new_n21_), .O(new_n61_));
  nand2  g42(.a(new_n31_), .b(new_n30_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(x12), .c(new_n42_), .O(new_n63_));
  inv1   g44(.a(x12), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n31_), .c(new_n30_), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n63_), .c(x08), .O(new_n66_));
  nand4  g47(.a(new_n66_), .b(x04), .c(x03), .d(x02), .O(new_n67_));
  nand2  g48(.a(new_n37_), .b(x12), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(x03), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n42_), .O(new_n70_));
  nand3  g51(.a(new_n70_), .b(new_n67_), .c(new_n61_), .O(z3));
