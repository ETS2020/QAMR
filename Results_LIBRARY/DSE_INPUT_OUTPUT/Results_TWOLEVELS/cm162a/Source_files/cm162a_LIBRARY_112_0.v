...
module FAU ( 
  ...
  nor2   g09(.a(x05), .b(new_n28_), .O(new_n29_));
  or2    g10(.a(new_n29_), .b(new_n27_), .O(z0));
  ...
  aoi21  g15(.a(new_n34_), .b(x10), .c(new_n24_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n32_), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(x03), .O(new_n37_));
  nand2  g18(.a(x01), .b(x00), .O(new_n38_));
  aoi21  g19(.a(new_n38_), .b(new_n20_), .c(new_n29_), .O(new_n39_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(new_n33_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  nand4  g28(.a(new_n43_), .b(new_n33_), .c(x04), .d(x02), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(x11), .c(new_n24_), .O(new_n49_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n43_), .d(new_n33_), .O(new_n54_));
  ...
  aoi21  g39(.a(new_n58_), .b(x12), .c(new_n24_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  aoi21  g42(.a(x07), .b(x00), .c(x03), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n29_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai22  g46(.a(new_n21_), .b(new_n65_), .c(x03), .d(x00), .O(z4));
endmodule
