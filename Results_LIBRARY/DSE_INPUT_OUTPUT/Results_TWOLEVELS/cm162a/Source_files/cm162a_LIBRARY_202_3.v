...
module FAU ( 
  ...
  aoi21  g25(.a(new_n37_), .b(new_n29_), .c(new_n21_), .O(new_n45_));
  ...
  nand3  g29(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n44_), .c(new_n20_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x11), .O(new_n52_));
  aoi21  g33(.a(new_n37_), .b(new_n29_), .c(new_n50_), .O(new_n53_));
  inv1   g34(.a(x10), .O(new_n54_));
  nand3  g35(.a(new_n50_), .b(new_n21_), .c(new_n54_), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n30_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n53_), .c(x03), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n44_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n57_), .c(new_n52_), .d(new_n27_), .O(z3));
  nand2  g41(.a(new_n25_), .b(new_n23_), .O(z4));
endmodule
