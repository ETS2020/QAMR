...
module FAU ( 
  ...
  nand3  g08(.a(new_n27_), .b(new_n25_), .c(new_n23_), .O(new_n28_));
  nand2  g09(.a(new_n28_), .b(x03), .O(new_n29_));
  inv1   g10(.a(x05), .O(new_n30_));
  nand2  g11(.a(new_n23_), .b(new_n30_), .O(new_n31_));
  nand3  g12(.a(new_n31_), .b(new_n29_), .c(new_n22_), .O(z0));
  ...
  oai21  g19(.a(new_n38_), .b(new_n30_), .c(new_n23_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n34_), .O(z1));
  nand2  g21(.a(x06), .b(x05), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n20_), .O(new_n42_));
  nand2  g23(.a(new_n37_), .b(x11), .O(new_n43_));
  ...
  oai21  g27(.a(new_n46_), .b(new_n30_), .c(new_n23_), .O(new_n47_));
  ...
  nand3  g32(.a(new_n51_), .b(new_n36_), .c(new_n26_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n24_), .c(x12), .O(new_n53_));
  inv1   g34(.a(x04), .O(new_n54_));
  nor2   g35(.a(x08), .b(new_n54_), .O(new_n55_));
  nor3   g36(.a(x12), .b(x11), .c(x10), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(x02), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n53_), .c(new_n20_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n30_), .c(new_n23_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n50_), .O(z3));
  nand2  g41(.a(x09), .b(x04), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n20_), .c(new_n23_), .O(z4));
endmodule
