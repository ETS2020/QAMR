...
module FAU ( 
  ...
  nand3  g28(.a(new_n47_), .b(new_n40_), .c(new_n39_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n28_), .c(x03), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand3  g31(.a(new_n41_), .b(x11), .c(x03), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n50_), .c(new_n27_), .O(z2));
  ...
  nand2  g36(.a(new_n41_), .b(x12), .O(new_n56_));
