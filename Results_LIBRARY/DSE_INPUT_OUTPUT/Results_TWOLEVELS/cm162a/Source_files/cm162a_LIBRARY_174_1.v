...
module FAU ( 
  ...
  oai21  g34(.a(x11), .b(x10), .c(x05), .O(new_n54_));
  nand2  g35(.a(new_n34_), .b(new_n41_), .O(new_n55_));
  ...
  aoi22  g39(.a(new_n58_), .b(new_n20_), .c(new_n41_), .d(new_n29_), .O(new_n59_));
  oai21  g40(.a(new_n57_), .b(new_n20_), .c(new_n59_), .O(z3));
  nand3  g41(.a(x13), .b(x09), .c(x04), .O(new_n61_));
  oai21  g42(.a(new_n41_), .b(x05), .c(new_n61_), .O(z4));
endmodule
