...
module FAU ( 
  ...
  nand3  g17(.a(new_n28_), .b(new_n36_), .c(new_n27_), .O(new_n37_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n28_), .c(new_n27_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(x03), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n20_), .O(new_n46_));
  nand3  g27(.a(new_n37_), .b(x11), .c(x03), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n46_), .c(new_n26_), .O(z2));
  inv1   g29(.a(x11), .O(new_n49_));
  nand3  g30(.a(x04), .b(x03), .c(x02), .O(new_n50_));
  inv1   g31(.a(x12), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n36_), .c(new_n27_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n50_), .c(new_n20_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  nand3  g35(.a(new_n44_), .b(x12), .c(x03), .O(new_n55_));
  or2    g36(.a(x07), .b(x03), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n55_), .c(new_n54_), .d(new_n26_), .O(z3));
  nand4  g38(.a(new_n22_), .b(x13), .c(x09), .d(x04), .O(new_n58_));
