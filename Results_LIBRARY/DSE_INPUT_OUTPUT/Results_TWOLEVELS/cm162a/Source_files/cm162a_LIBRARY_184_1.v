...
module FAU ( 
  ...
  oai21  g08(.a(new_n27_), .b(new_n20_), .c(x01), .O(new_n28_));
  ...
  oai21  g18(.a(new_n37_), .b(new_n20_), .c(x01), .O(new_n38_));
  ...
  nand2  g25(.a(new_n35_), .b(x11), .O(new_n45_));
  inv1   g26(.a(x10), .O(new_n46_));
  inv1   g27(.a(x11), .O(new_n47_));
  nand4  g28(.a(new_n43_), .b(new_n47_), .c(new_n46_), .d(new_n34_), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n45_), .c(new_n44_), .d(x01), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x03), .O(new_n50_));
  nand2  g31(.a(x06), .b(x05), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(new_n21_), .c(new_n20_), .d(x01), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n47_), .c(new_n46_), .d(new_n34_), .O(new_n55_));
  nand3  g36(.a(x13), .b(x09), .c(x01), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  aoi21  g39(.a(new_n47_), .b(new_n46_), .c(new_n39_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n35_), .c(x12), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n58_), .c(x01), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  nand2  g43(.a(x07), .b(x05), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(new_n21_), .c(new_n20_), .d(x01), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai22  g47(.a(new_n22_), .b(new_n66_), .c(new_n21_), .d(x01), .O(z4));
endmodule
