...
module FAU ( 
  ...
  oai21  g35(.a(new_n51_), .b(new_n20_), .c(new_n54_), .O(z2));
  nand4  g36(.a(new_n29_), .b(new_n44_), .c(new_n43_), .d(new_n35_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n21_), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(x05), .c(x04), .d(x02), .O(new_n58_));
  ...
  nor2   g42(.a(x07), .b(new_n52_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n30_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  oai22  g45(.a(new_n21_), .b(new_n42_), .c(x12), .d(x05), .O(z4));
endmodule
