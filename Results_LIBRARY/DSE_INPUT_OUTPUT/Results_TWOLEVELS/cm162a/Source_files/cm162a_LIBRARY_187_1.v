...
module FAU ( 
  ...
  nand4  g33(.a(new_n41_), .b(new_n44_), .c(new_n32_), .d(new_n31_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n21_), .O(new_n54_));
  nor2   g35(.a(new_n45_), .b(new_n24_), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n41_), .O(new_n56_));
  ...
  oai22  g41(.a(new_n30_), .b(new_n21_), .c(new_n41_), .d(x05), .O(z4));
endmodule
