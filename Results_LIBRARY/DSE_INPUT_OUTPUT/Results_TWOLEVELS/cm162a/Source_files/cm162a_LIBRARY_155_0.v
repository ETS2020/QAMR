...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n32_), .c(new_n27_), .O(new_n34_));
  ...
  nor2   g21(.a(new_n35_), .b(x05), .O(new_n41_));
  ...
  nor2   g31(.a(new_n44_), .b(new_n35_), .O(new_n51_));
  ...
  nand4  g37(.a(new_n56_), .b(new_n44_), .c(new_n36_), .d(new_n35_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n22_), .c(new_n21_), .O(new_n58_));
  nor2   g39(.a(new_n45_), .b(new_n24_), .O(new_n59_));
  nor2   g40(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  ...
  oai21  g46(.a(x08), .b(x05), .c(x13), .O(new_n66_));
  nor3   g47(.a(new_n66_), .b(new_n65_), .c(new_n21_), .O(z4));
endmodule
