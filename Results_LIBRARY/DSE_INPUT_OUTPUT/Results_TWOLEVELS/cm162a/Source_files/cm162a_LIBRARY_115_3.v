...
module FAU ( 
  ...
  nand3  g15(.a(x13), .b(new_n20_), .c(x09), .O(new_n35_));
  ...
  nand3  g24(.a(new_n36_), .b(x03), .c(x02), .O(new_n44_));
  inv1   g25(.a(x06), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand4  g27(.a(new_n46_), .b(new_n44_), .c(new_n20_), .d(x05), .O(z2));
  inv1   g28(.a(x12), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n33_), .c(new_n32_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x04), .c(x02), .O(new_n51_));
  oai21  g32(.a(new_n34_), .b(new_n25_), .c(x12), .O(new_n52_));
  ...
  oai21  g38(.a(new_n22_), .b(new_n31_), .c(new_n57_), .O(z4));
endmodule
