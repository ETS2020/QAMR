...
module FAU ( 
  ...
  nand3  g31(.a(new_n39_), .b(new_n50_), .c(x06), .O(new_n51_));
  ...
  nand3  g37(.a(x11), .b(new_n38_), .c(new_n22_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n56_), .c(new_n36_), .O(z2));
  nand3  g39(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  inv1   g40(.a(x12), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n50_), .c(new_n37_), .O(new_n61_));
  ...
  nand3  g45(.a(new_n64_), .b(new_n25_), .c(new_n37_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(x12), .c(x03), .O(new_n66_));
  inv1   g47(.a(x07), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n22_), .O(new_n68_));
  nand4  g49(.a(new_n68_), .b(new_n66_), .c(new_n63_), .d(new_n36_), .O(z3));
