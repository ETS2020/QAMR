...
module FAU ( 
  ...
  aoi22  g06(.a(new_n25_), .b(x08), .c(new_n24_), .d(x02), .O(new_n26_));
  nor2   g07(.a(x03), .b(x00), .O(new_n27_));
  nand2  g08(.a(new_n22_), .b(x05), .O(new_n28_));
  ...
  nand4  g16(.a(new_n35_), .b(new_n22_), .c(x04), .d(x02), .O(new_n36_));
  nand3  g17(.a(new_n31_), .b(x04), .c(x02), .O(new_n37_));
  ...
  nor2   g22(.a(new_n41_), .b(new_n28_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n40_), .O(z1));
  nand4  g24(.a(new_n35_), .b(x04), .c(x03), .d(x02), .O(new_n44_));
  oai21  g25(.a(x06), .b(x03), .c(new_n44_), .O(new_n45_));
