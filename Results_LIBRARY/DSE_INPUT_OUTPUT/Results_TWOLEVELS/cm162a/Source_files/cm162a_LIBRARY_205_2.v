...
module FAU ( 
  ...
  nand2  g28(.a(x10), .b(x05), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n35_), .c(x04), .d(x02), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x11), .c(new_n34_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n47_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x03), .O(new_n52_));
  nand2  g33(.a(x06), .b(x05), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n44_), .c(new_n43_), .d(new_n35_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n20_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  oai21  g40(.a(new_n45_), .b(new_n23_), .c(x12), .O(new_n60_));
