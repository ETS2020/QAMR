...
module FAU ( 
  ...
  nand2  g07(.a(new_n24_), .b(x06), .O(new_n27_));
  ...
  nand2  g25(.a(new_n20_), .b(new_n44_), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n43_), .c(new_n41_), .d(new_n36_), .O(z1));
  nand3  g27(.a(new_n38_), .b(x04), .c(x02), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x11), .O(new_n48_));
  nor2   g29(.a(x11), .b(x10), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(new_n24_), .c(x04), .d(x02), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(x03), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n37_), .O(new_n52_));
  nand3  g33(.a(x11), .b(x08), .c(x03), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n52_), .c(new_n36_), .O(z2));
  nand3  g35(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  inv1   g36(.a(x11), .O(new_n56_));
  inv1   g37(.a(x12), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n56_), .c(new_n38_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n55_), .c(new_n37_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  nand3  g41(.a(new_n50_), .b(x12), .c(x03), .O(new_n61_));
  inv1   g42(.a(x07), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n20_), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n61_), .c(new_n60_), .d(new_n36_), .O(z3));
  nand4  g45(.a(new_n27_), .b(x13), .c(x09), .d(x04), .O(new_n65_));
