...
module FAU ( 
  ...
  nand2  g04(.a(x05), .b(x03), .O(new_n24_));
  ...
  aoi21  g11(.a(new_n30_), .b(x10), .c(new_n24_), .O(new_n31_));
  ...
  aoi21  g27(.a(new_n46_), .b(x12), .c(new_n24_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n44_), .O(z3));
  inv1   g29(.a(x04), .O(new_n49_));
  inv1   g30(.a(x05), .O(new_n50_));
  oai22  g31(.a(new_n20_), .b(new_n49_), .c(new_n50_), .d(x03), .O(z4));
endmodule
