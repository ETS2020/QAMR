...
module FAU ( 
  ...
  nand2  g09(.a(x12), .b(x00), .O(new_n29_));
  aoi21  g10(.a(new_n29_), .b(new_n20_), .c(new_n28_), .O(new_n30_));
  ...
  aoi21  g19(.a(new_n38_), .b(new_n20_), .c(new_n28_), .O(new_n39_));
  ...
  nand2  g28(.a(x12), .b(x06), .O(new_n48_));
  ...
  nand2  g35(.a(x12), .b(x07), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand4  g37(.a(new_n25_), .b(new_n42_), .c(new_n41_), .d(new_n24_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x12), .c(x03), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(new_n54_), .d(x05), .O(z3));
  inv1   g40(.a(x09), .O(new_n60_));
  oai21  g41(.a(x12), .b(x03), .c(x13), .O(new_n61_));
