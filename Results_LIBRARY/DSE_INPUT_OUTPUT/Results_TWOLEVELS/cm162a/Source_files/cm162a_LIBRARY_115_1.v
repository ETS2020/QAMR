...
module FAU ( 
  ...
  nand4  g35(.a(new_n54_), .b(new_n43_), .c(new_n42_), .d(new_n35_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n32_), .c(new_n41_), .O(new_n56_));
  nand4  g37(.a(new_n42_), .b(new_n35_), .c(x04), .d(x02), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n43_), .O(new_n58_));
  nand2  g39(.a(x11), .b(x05), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  aoi22  g41(.a(new_n60_), .b(x12), .c(new_n56_), .d(x02), .O(new_n61_));
  nor2   g42(.a(x07), .b(new_n50_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n29_), .O(new_n63_));
  oai21  g44(.a(new_n61_), .b(new_n20_), .c(new_n63_), .O(z3));
  oai22  g45(.a(new_n21_), .b(new_n41_), .c(new_n43_), .d(x05), .O(z4));
endmodule
