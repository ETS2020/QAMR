...
module FAU ( 
  ...
  nand3  g24(.a(new_n43_), .b(new_n29_), .c(new_n36_), .O(new_n44_));
  ...
  nor2   g29(.a(new_n43_), .b(new_n29_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x03), .O(new_n50_));
  nor2   g31(.a(x06), .b(new_n42_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n20_), .c(new_n30_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n43_), .c(new_n29_), .d(new_n36_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n33_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nand2  g38(.a(x11), .b(x05), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n29_), .c(new_n36_), .O(new_n59_));
  ...
  oai22  g47(.a(new_n21_), .b(new_n66_), .c(x10), .d(x05), .O(z4));
endmodule
