...
module FAU ( 
  ...
  aoi21  g26(.a(new_n22_), .b(new_n44_), .c(new_n45_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n43_), .c(new_n36_), .O(z1));
  nand2  g28(.a(x03), .b(x02), .O(new_n48_));
  nand2  g29(.a(new_n26_), .b(x04), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n48_), .c(x05), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n21_), .O(new_n51_));
  nand3  g32(.a(x11), .b(x10), .c(x06), .O(new_n52_));
  oai21  g33(.a(x11), .b(x10), .c(new_n52_), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n39_), .c(x04), .d(x02), .O(new_n54_));
  nand2  g35(.a(new_n40_), .b(x11), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x03), .O(new_n57_));
  oai21  g38(.a(x11), .b(new_n22_), .c(new_n20_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n57_), .c(new_n51_), .O(z2));
  inv1   g40(.a(x12), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n22_), .c(x06), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x11), .O(new_n62_));
  nand2  g43(.a(x12), .b(x10), .O(new_n63_));
  nor2   g44(.a(x12), .b(x10), .O(new_n64_));
  nand4  g45(.a(new_n64_), .b(new_n39_), .c(x04), .d(x02), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n63_), .c(x11), .O(new_n66_));
  and2   g47(.a(new_n40_), .b(x12), .O(new_n67_));
  oai21  g48(.a(new_n67_), .b(new_n66_), .c(x03), .O(new_n68_));
  inv1   g49(.a(x07), .O(new_n69_));
  nand2  g50(.a(new_n69_), .b(new_n22_), .O(new_n70_));
  nand4  g51(.a(new_n70_), .b(new_n68_), .c(new_n62_), .d(new_n51_), .O(z3));
