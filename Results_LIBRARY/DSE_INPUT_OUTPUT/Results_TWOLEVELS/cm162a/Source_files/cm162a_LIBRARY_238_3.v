...
module FAU ( 
  ...
  nand4  g30(.a(new_n49_), .b(new_n40_), .c(new_n32_), .d(new_n31_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(x04), .c(x02), .O(new_n52_));
  oai21  g33(.a(new_n41_), .b(new_n25_), .c(x12), .O(new_n53_));
  ...
  oai21  g40(.a(new_n22_), .b(new_n58_), .c(new_n59_), .O(z4));
endmodule
