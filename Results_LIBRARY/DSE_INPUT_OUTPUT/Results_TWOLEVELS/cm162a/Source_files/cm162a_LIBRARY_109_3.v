...
module FAU ( 
  ...
  nor3   g16(.a(new_n35_), .b(x13), .c(new_n34_), .O(new_n36_));
  oai21  g17(.a(new_n33_), .b(new_n21_), .c(new_n36_), .O(z1));
  inv1   g18(.a(new_n22_), .O(new_n38_));
  nor3   g19(.a(x11), .b(x10), .c(x08), .O(new_n39_));
  aoi22  g20(.a(new_n39_), .b(new_n38_), .c(new_n31_), .d(x11), .O(new_n40_));
  nor2   g21(.a(x06), .b(x03), .O(new_n41_));
  nor3   g22(.a(new_n41_), .b(x13), .c(new_n34_), .O(new_n42_));
  oai21  g23(.a(new_n40_), .b(new_n21_), .c(new_n42_), .O(z2));
  inv1   g24(.a(new_n25_), .O(new_n44_));
  nor2   g25(.a(x11), .b(x10), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n24_), .c(x04), .d(x02), .O(new_n46_));
  nor3   g27(.a(x12), .b(x11), .c(x10), .O(new_n47_));
  aoi22  g28(.a(new_n47_), .b(new_n44_), .c(new_n46_), .d(x12), .O(new_n48_));
  nor2   g29(.a(x07), .b(x03), .O(new_n49_));
  nor3   g30(.a(new_n49_), .b(x13), .c(new_n34_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n21_), .c(new_n50_), .O(z3));
  nand4  g32(.a(x13), .b(x09), .c(new_n34_), .d(x04), .O(new_n52_));
