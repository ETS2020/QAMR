...
module FAU ( 
  ...
  nor2   g09(.a(new_n24_), .b(new_n22_), .O(new_n29_));
  ...
  aoi21  g34(.a(new_n53_), .b(new_n23_), .c(new_n20_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n52_), .c(new_n33_), .O(z2));
  inv1   g36(.a(x07), .O(new_n56_));
  inv1   g37(.a(x12), .O(new_n57_));
  inv1   g38(.a(new_n47_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n29_), .c(new_n57_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n23_), .c(new_n56_), .O(new_n60_));
  nand3  g41(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  inv1   g42(.a(new_n61_), .O(new_n62_));
  nand4  g43(.a(new_n62_), .b(new_n38_), .c(new_n57_), .d(new_n46_), .O(new_n63_));
  nand3  g44(.a(new_n63_), .b(new_n60_), .c(new_n27_), .O(z3));
