...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(new_n29_), .O(new_n30_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n45_), .c(new_n44_), .d(new_n35_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n32_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  nand2  g39(.a(x11), .b(x05), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n44_), .c(new_n35_), .O(new_n60_));
  ...
  oai21  g48(.a(x10), .b(x05), .c(x13), .O(new_n68_));
  nor3   g49(.a(new_n68_), .b(new_n67_), .c(new_n43_), .O(z4));
endmodule
