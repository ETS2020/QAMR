...
module FAU ( 
  ...
  nand3  g13(.a(new_n23_), .b(x03), .c(x02), .O(new_n33_));
  ...
  nor3   g25(.a(new_n44_), .b(x10), .c(new_n43_), .O(new_n45_));
  ...
  nor2   g31(.a(x11), .b(x08), .O(new_n51_));
  ...
  nor3   g35(.a(new_n54_), .b(x10), .c(new_n43_), .O(new_n55_));
  oai21  g36(.a(new_n53_), .b(new_n20_), .c(new_n55_), .O(z3));
  nand2  g37(.a(x10), .b(x05), .O(new_n57_));
