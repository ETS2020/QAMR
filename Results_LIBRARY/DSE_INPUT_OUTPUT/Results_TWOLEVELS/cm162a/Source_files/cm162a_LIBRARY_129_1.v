...
module FAU ( 
  ...
  aoi21  g25(.a(new_n44_), .b(new_n41_), .c(new_n21_), .O(z1));
  nand2  g26(.a(x03), .b(x02), .O(new_n46_));
  inv1   g27(.a(x10), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n28_), .c(x04), .O(new_n48_));
  oai22  g29(.a(new_n48_), .b(new_n46_), .c(x06), .d(x03), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand4  g31(.a(new_n47_), .b(new_n28_), .c(x04), .d(x02), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(x11), .c(x06), .d(x03), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n50_), .c(new_n27_), .O(z2));
  oai21  g34(.a(x07), .b(x03), .c(new_n25_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n42_), .c(new_n22_), .O(new_n55_));
  nand2  g36(.a(new_n51_), .b(x12), .O(new_n56_));
  nor2   g37(.a(x12), .b(x10), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n29_), .c(new_n28_), .O(new_n58_));
  ...
  nand2  g44(.a(new_n23_), .b(new_n22_), .O(z4));
endmodule
