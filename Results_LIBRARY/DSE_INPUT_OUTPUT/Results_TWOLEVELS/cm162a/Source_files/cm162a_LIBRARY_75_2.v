...
module FAU ( 
  ...
  oai21  g31(.a(new_n50_), .b(x08), .c(new_n23_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n30_), .c(x04), .d(x02), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x03), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  inv1   g36(.a(x12), .O(new_n56_));
  aoi21  g37(.a(new_n55_), .b(new_n20_), .c(new_n56_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n54_), .c(x05), .O(z3));
  nand2  g39(.a(new_n56_), .b(x05), .O(new_n59_));
