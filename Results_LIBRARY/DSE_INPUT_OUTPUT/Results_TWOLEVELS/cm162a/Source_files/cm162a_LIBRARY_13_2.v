...
module FAU ( 
  ...
  nand3  g14(.a(new_n20_), .b(x04), .c(x02), .O(new_n34_));
  ...
  aoi21  g20(.a(new_n27_), .b(new_n38_), .c(new_n39_), .O(new_n40_));
  ...
  aoi21  g26(.a(new_n45_), .b(new_n31_), .c(new_n42_), .O(new_n46_));
  ...
  aoi21  g31(.a(new_n50_), .b(new_n27_), .c(new_n39_), .O(new_n51_));
  oai21  g32(.a(new_n49_), .b(new_n27_), .c(new_n51_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n43_), .d(new_n20_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  aoi21  g37(.a(new_n44_), .b(new_n43_), .c(new_n39_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n34_), .c(x12), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n27_), .c(new_n39_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  nand2  g44(.a(new_n39_), .b(x03), .O(new_n64_));
