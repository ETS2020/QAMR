...
module FAU ( 
  ...
  nand2  g21(.a(new_n40_), .b(new_n29_), .O(z1));
  ...
  nand4  g32(.a(new_n51_), .b(new_n42_), .c(new_n32_), .d(new_n31_), .O(new_n52_));
  ...
  nand2  g39(.a(new_n58_), .b(new_n29_), .O(z3));
  nand4  g40(.a(x13), .b(x09), .c(x05), .d(x04), .O(new_n60_));
