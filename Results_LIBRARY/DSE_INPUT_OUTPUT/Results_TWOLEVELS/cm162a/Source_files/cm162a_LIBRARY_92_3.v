...
module FAU ( 
  ...
  aoi21  g05(.a(new_n24_), .b(x08), .c(x12), .O(new_n25_));
  ...
  aoi21  g13(.a(new_n32_), .b(x10), .c(x12), .O(new_n33_));
  ...
  nand4  g25(.a(new_n40_), .b(new_n31_), .c(x04), .d(x02), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(x11), .c(x12), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x03), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n20_), .c(new_n37_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n48_), .O(z2));
  inv1   g32(.a(x04), .O(new_n52_));
  aoi21  g33(.a(new_n42_), .b(new_n21_), .c(new_n52_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(x02), .c(x12), .O(new_n54_));
  ...
  nand2  g38(.a(x12), .b(x03), .O(new_n58_));
