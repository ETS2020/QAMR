...
module FAU ( 
  ...
  oai21  g19(.a(new_n22_), .b(new_n20_), .c(new_n38_), .O(new_n39_));
  nand3  g20(.a(new_n39_), .b(x04), .c(x02), .O(new_n40_));
  aoi21  g21(.a(x10), .b(x03), .c(x08), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n25_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x11), .O(new_n43_));
  nand4  g24(.a(new_n43_), .b(new_n40_), .c(x05), .d(x03), .O(z2));
  inv1   g25(.a(x12), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n37_), .c(new_n36_), .d(new_n24_), .O(new_n46_));
  ...
  oai21  g31(.a(new_n50_), .b(new_n20_), .c(x05), .O(z3));
  inv1   g32(.a(x05), .O(new_n52_));
  oai22  g33(.a(new_n22_), .b(new_n21_), .c(new_n52_), .d(x03), .O(z4));
endmodule
