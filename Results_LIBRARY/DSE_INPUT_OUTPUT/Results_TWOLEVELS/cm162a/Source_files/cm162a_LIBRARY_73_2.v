...
module FAU ( 
  ...
  nand3  g27(.a(new_n43_), .b(new_n46_), .c(new_n27_), .O(new_n47_));
  nor2   g28(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n44_), .c(x03), .O(new_n49_));
  nor2   g30(.a(x06), .b(x03), .O(new_n50_));
  nor2   g31(.a(new_n50_), .b(new_n21_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n49_), .c(new_n26_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n43_), .c(new_n46_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n29_), .c(x03), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand4  g37(.a(new_n28_), .b(new_n43_), .c(new_n46_), .d(new_n27_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x12), .c(x03), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n56_), .c(new_n26_), .O(z3));
  nand2  g40(.a(new_n24_), .b(new_n22_), .O(z4));
endmodule
