...
module FAU ( 
  ...
  nand3  g28(.a(new_n47_), .b(new_n46_), .c(new_n38_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n23_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x04), .c(x02), .O(new_n50_));
  nand4  g31(.a(new_n46_), .b(new_n38_), .c(x04), .d(x02), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(x11), .c(new_n27_), .O(new_n52_));
  ...
  oai21  g38(.a(x12), .b(new_n21_), .c(new_n20_), .O(new_n58_));
  inv1   g39(.a(x12), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n47_), .c(new_n46_), .d(new_n38_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n23_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x04), .c(x02), .O(new_n62_));
  nand4  g43(.a(new_n47_), .b(new_n46_), .c(new_n38_), .d(x04), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(x12), .c(new_n27_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(x03), .O(new_n66_));
  nor2   g47(.a(x07), .b(x03), .O(new_n67_));
  nor2   g48(.a(new_n67_), .b(new_n32_), .O(new_n68_));
  nand3  g49(.a(new_n68_), .b(new_n66_), .c(new_n58_), .O(z3));
  inv1   g50(.a(x09), .O(new_n70_));
  oai21  g51(.a(x03), .b(x02), .c(x13), .O(new_n71_));
  nor3   g52(.a(new_n71_), .b(new_n70_), .c(new_n26_), .O(z4));
endmodule
