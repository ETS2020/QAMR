...
module FAU ( 
  ...
  aoi21  g23(.a(new_n35_), .b(new_n27_), .c(new_n42_), .O(new_n43_));
  nand3  g24(.a(x06), .b(x04), .c(x02), .O(new_n44_));
  inv1   g25(.a(x10), .O(new_n45_));
  nand3  g26(.a(new_n42_), .b(new_n45_), .c(new_n26_), .O(new_n46_));
  nor2   g27(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n43_), .c(x03), .O(new_n48_));
  inv1   g29(.a(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  nand3  g31(.a(x11), .b(new_n50_), .c(new_n49_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n48_), .c(new_n25_), .O(z2));
  nand3  g33(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  inv1   g34(.a(x12), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n45_), .c(new_n26_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n53_), .c(x06), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n42_), .O(new_n57_));
  nand4  g38(.a(new_n27_), .b(new_n42_), .c(new_n45_), .d(new_n26_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x12), .c(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n49_), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n59_), .c(new_n57_), .d(new_n25_), .O(z3));
  nand2  g43(.a(new_n23_), .b(new_n21_), .O(z4));
endmodule
