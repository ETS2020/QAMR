...
module FAU ( 
  ...
  nand3  g08(.a(x13), .b(x09), .c(x03), .O(new_n28_));
  oai21  g09(.a(x10), .b(x08), .c(new_n28_), .O(new_n29_));
  nand3  g10(.a(new_n29_), .b(x04), .c(x02), .O(new_n30_));
  nand3  g11(.a(new_n24_), .b(x04), .c(x02), .O(new_n31_));
  nand2  g12(.a(x05), .b(x03), .O(new_n32_));
  aoi21  g13(.a(new_n31_), .b(x10), .c(new_n32_), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n30_), .O(z1));
  ...
  aoi21  g22(.a(new_n41_), .b(x11), .c(new_n32_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n39_), .O(z2));
  inv1   g24(.a(new_n32_), .O(new_n44_));
  inv1   g25(.a(x12), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n36_), .c(new_n35_), .d(new_n24_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n28_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  aoi21  g29(.a(new_n36_), .b(new_n35_), .c(new_n20_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n31_), .c(x12), .O(new_n50_));
