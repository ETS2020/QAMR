...
module FAU ( 
  ...
  nand2  g33(.a(new_n20_), .b(x03), .O(new_n53_));
  oai22  g34(.a(new_n53_), .b(new_n22_), .c(new_n52_), .d(new_n33_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  aoi21  g36(.a(new_n42_), .b(new_n32_), .c(x07), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n36_), .c(x12), .O(new_n57_));
  nand3  g38(.a(new_n20_), .b(x05), .c(x03), .O(new_n58_));
