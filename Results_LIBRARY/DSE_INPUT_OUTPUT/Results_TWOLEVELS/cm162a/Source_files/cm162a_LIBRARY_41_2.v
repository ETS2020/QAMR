...
module FAU ( 
  ...
  oai21  g20(.a(new_n39_), .b(x08), .c(new_n23_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x11), .O(new_n41_));
  nand4  g22(.a(new_n41_), .b(new_n32_), .c(x04), .d(x02), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x03), .O(new_n43_));
  inv1   g24(.a(x06), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n20_), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n43_), .c(x11), .d(x05), .O(z2));
  inv1   g27(.a(x12), .O(new_n47_));
  or2    g28(.a(new_n23_), .b(new_n21_), .O(new_n48_));
  ...
  oai22  g35(.a(new_n23_), .b(new_n53_), .c(x11), .d(new_n54_), .O(z4));
endmodule
