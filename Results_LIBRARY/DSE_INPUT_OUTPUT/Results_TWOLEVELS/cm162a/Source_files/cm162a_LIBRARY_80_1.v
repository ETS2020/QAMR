...
module FAU ( 
  ...
  nand3  g26(.a(new_n45_), .b(new_n27_), .c(x04), .O(new_n46_));
  oai22  g27(.a(new_n46_), .b(new_n23_), .c(x06), .d(x03), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n20_), .O(new_n48_));
  nand4  g29(.a(new_n45_), .b(new_n27_), .c(x04), .d(x02), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(x11), .c(x06), .d(x03), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(new_n26_), .O(z2));
  oai22  g32(.a(new_n24_), .b(new_n23_), .c(x07), .d(x03), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n41_), .c(new_n22_), .O(new_n53_));
  nand2  g34(.a(new_n49_), .b(x12), .O(new_n54_));
  nor2   g35(.a(x12), .b(x10), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n28_), .c(new_n27_), .O(new_n56_));
  ...
  nand4  g42(.a(new_n22_), .b(x13), .c(x09), .d(x04), .O(new_n62_));
