...
module FAU ( 
  ...
  nand2  g07(.a(x13), .b(x05), .O(new_n27_));
  ...
  inv1   g29(.a(x13), .O(new_n49_));
  nor2   g30(.a(x06), .b(x03), .O(new_n50_));
  nor3   g31(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n51_));
  oai21  g32(.a(new_n47_), .b(new_n20_), .c(new_n51_), .O(z2));
  inv1   g33(.a(x09), .O(new_n53_));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n41_), .c(new_n40_), .d(new_n32_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  oai21  g38(.a(new_n42_), .b(new_n24_), .c(x12), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n57_), .c(new_n20_), .O(new_n59_));
  nor2   g40(.a(x07), .b(x03), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(x13), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x05), .O(z3));
  oai22  g43(.a(new_n22_), .b(new_n21_), .c(x13), .d(new_n48_), .O(z4));
endmodule
