...
module FAU ( 
  ...
  nand3  g26(.a(new_n45_), .b(new_n30_), .c(new_n36_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n33_), .c(new_n44_), .O(new_n47_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n45_), .c(new_n30_), .d(new_n36_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n33_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  aoi21  g39(.a(new_n45_), .b(new_n30_), .c(new_n29_), .O(new_n59_));
  ...
  nand2  g46(.a(x10), .b(new_n29_), .O(new_n66_));
