...
module FAU ( 
  ...
  nand2  g31(.a(new_n50_), .b(x04), .O(new_n51_));
  ...
  nand4  g37(.a(new_n42_), .b(new_n41_), .c(new_n33_), .d(x02), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(x12), .c(new_n23_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x03), .O(new_n61_));
  nand2  g42(.a(x07), .b(x04), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g44(.a(new_n23_), .b(x04), .O(new_n64_));
  inv1   g45(.a(x04), .O(new_n65_));
  nand2  g46(.a(x12), .b(new_n65_), .O(new_n66_));
  nand3  g47(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
