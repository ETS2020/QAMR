...
module FAU ( 
  ...
  nand2  g20(.a(new_n28_), .b(x01), .O(new_n40_));
  aoi22  g21(.a(new_n40_), .b(new_n39_), .c(new_n28_), .d(new_n23_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n38_), .O(z1));
  inv1   g23(.a(x10), .O(new_n43_));
  nand3  g24(.a(new_n28_), .b(new_n43_), .c(new_n34_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n20_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  nand4  g27(.a(new_n43_), .b(new_n34_), .c(x04), .d(x02), .O(new_n47_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n28_), .c(new_n43_), .d(new_n34_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nor2   g38(.a(x11), .b(x10), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n34_), .c(x04), .d(x02), .O(new_n59_));
  ...
  nand2  g46(.a(x11), .b(new_n39_), .O(new_n66_));
