...
module FAU ( 
  ...
  nand2  g18(.a(new_n29_), .b(x10), .O(new_n38_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n40_), .c(new_n21_), .O(z1));
  inv1   g26(.a(x06), .O(new_n46_));
  oai21  g27(.a(x11), .b(new_n42_), .c(new_n46_), .O(new_n47_));
  nor2   g28(.a(x10), .b(x08), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n28_), .c(new_n20_), .O(new_n49_));
  nor3   g30(.a(x11), .b(x10), .c(x08), .O(new_n50_));
  and2   g31(.a(new_n50_), .b(new_n28_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n49_), .c(x03), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n47_), .c(new_n26_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n42_), .c(x06), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(x11), .O(new_n56_));
  aoi21  g37(.a(new_n48_), .b(new_n28_), .c(new_n54_), .O(new_n57_));
  inv1   g38(.a(x10), .O(new_n58_));
  nand3  g39(.a(new_n54_), .b(new_n20_), .c(new_n58_), .O(new_n59_));
  ...
  nand4  g44(.a(new_n63_), .b(new_n61_), .c(new_n56_), .d(new_n26_), .O(z3));
  nand4  g45(.a(new_n22_), .b(x13), .c(x09), .d(x04), .O(new_n65_));
