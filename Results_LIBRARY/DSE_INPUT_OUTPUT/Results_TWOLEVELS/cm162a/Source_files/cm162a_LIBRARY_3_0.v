...
module FAU ( 
  ...
  nand4  g34(.a(new_n53_), .b(new_n43_), .c(new_n33_), .d(new_n32_), .O(new_n54_));
  nand3  g35(.a(x13), .b(x09), .c(x05), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(new_n56_));
  nor2   g37(.a(new_n44_), .b(new_n24_), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(new_n53_), .O(new_n58_));
  ...
  oai22  g43(.a(new_n21_), .b(new_n52_), .c(x12), .d(x05), .O(z4));
endmodule
