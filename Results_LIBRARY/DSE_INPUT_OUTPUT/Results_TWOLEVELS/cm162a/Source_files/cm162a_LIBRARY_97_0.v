...
module FAU ( 
  ...
  aoi21  g20(.a(new_n39_), .b(new_n36_), .c(new_n34_), .O(new_n40_));
  ...
  nand3  g25(.a(new_n44_), .b(new_n43_), .c(new_n37_), .O(new_n45_));
  ...
  nor2   g33(.a(x06), .b(new_n28_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n34_), .c(new_n31_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  inv1   g36(.a(x02), .O(new_n56_));
  nor2   g37(.a(x12), .b(x11), .O(new_n57_));
  aoi22  g38(.a(new_n57_), .b(new_n48_), .c(x13), .d(x09), .O(new_n58_));
  oai21  g39(.a(x11), .b(x10), .c(x12), .O(new_n59_));
  oai21  g40(.a(new_n58_), .b(new_n56_), .c(new_n59_), .O(new_n60_));
  and2   g41(.a(new_n38_), .b(x12), .O(new_n61_));
  aoi21  g42(.a(new_n60_), .b(x04), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n34_), .c(new_n28_), .O(new_n64_));
  oai21  g45(.a(new_n62_), .b(new_n34_), .c(new_n64_), .O(z3));
  nand2  g46(.a(new_n28_), .b(new_n30_), .O(new_n66_));
  oai21  g47(.a(new_n20_), .b(new_n30_), .c(new_n66_), .O(z4));
endmodule
