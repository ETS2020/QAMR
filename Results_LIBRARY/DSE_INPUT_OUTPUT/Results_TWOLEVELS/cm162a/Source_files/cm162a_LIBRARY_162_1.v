...
module FAU ( 
  ...
  oai21  g31(.a(new_n29_), .b(new_n20_), .c(new_n30_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n50_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n34_), .d(new_n33_), .O(new_n54_));
  ...
  nand2  g41(.a(new_n60_), .b(new_n31_), .O(z3));
  nand2  g42(.a(x06), .b(new_n29_), .O(new_n62_));
