...
module FAU ( 
  ...
  nand4  g12(.a(new_n31_), .b(new_n28_), .c(new_n20_), .d(x05), .O(z0));
  ...
  oai21  g24(.a(new_n22_), .b(new_n30_), .c(new_n43_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  nand3  g26(.a(new_n26_), .b(new_n41_), .c(new_n21_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(x11), .c(new_n30_), .O(new_n47_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n42_), .c(new_n41_), .d(new_n21_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  oai21  g35(.a(new_n43_), .b(new_n25_), .c(x12), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n54_), .c(new_n30_), .O(new_n56_));
  nor2   g37(.a(x07), .b(x03), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n56_), .c(new_n20_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x05), .O(z3));
  inv1   g40(.a(x04), .O(new_n60_));
  nand2  g41(.a(x06), .b(x05), .O(new_n61_));
  oai21  g42(.a(new_n22_), .b(new_n60_), .c(new_n61_), .O(z4));
endmodule
