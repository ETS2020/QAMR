...
module FAU ( 
  ...
  nand2  g32(.a(new_n28_), .b(x06), .O(new_n52_));
  nor2   g33(.a(x09), .b(x05), .O(new_n53_));
  aoi21  g34(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n50_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n43_), .c(new_n42_), .d(new_n34_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n20_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  nor2   g40(.a(x11), .b(x10), .O(new_n60_));
  nand4  g41(.a(new_n60_), .b(new_n34_), .c(x04), .d(x02), .O(new_n61_));
  ...
  nand2  g45(.a(new_n28_), .b(x07), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n51_), .c(new_n53_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  nand2  g48(.a(x13), .b(x04), .O(new_n68_));
  aoi21  g49(.a(new_n68_), .b(x03), .c(new_n28_), .O(z4));
endmodule
