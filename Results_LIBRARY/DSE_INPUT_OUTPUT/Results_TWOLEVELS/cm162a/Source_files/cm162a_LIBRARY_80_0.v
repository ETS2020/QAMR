...
module FAU ( 
  ...
  and2   g26(.a(new_n45_), .b(x11), .O(new_n46_));
  nand3  g27(.a(x06), .b(x04), .c(x02), .O(new_n47_));
  nor4   g28(.a(new_n47_), .b(x11), .c(x10), .d(x08), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n46_), .c(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  nand3  g31(.a(x11), .b(new_n50_), .c(new_n34_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n49_), .c(new_n25_), .O(z2));
  ...
  nand2  g36(.a(new_n45_), .b(x12), .O(new_n56_));
  inv1   g37(.a(x04), .O(new_n57_));
  nor2   g38(.a(x08), .b(new_n57_), .O(new_n58_));
  nor3   g39(.a(x12), .b(x11), .c(x10), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n58_), .c(x02), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n56_), .c(new_n50_), .O(new_n61_));
  ...
  nor2   g46(.a(new_n65_), .b(new_n57_), .O(z4));
endmodule
