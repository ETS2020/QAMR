...
module FAU ( 
  ...
  nand2  g02(.a(x13), .b(new_n21_), .O(new_n22_));
  oai21  g03(.a(x03), .b(x00), .c(x05), .O(new_n23_));
  nand2  g04(.a(new_n23_), .b(new_n22_), .O(new_n24_));
  inv1   g05(.a(x04), .O(new_n25_));
  nand3  g06(.a(x13), .b(x09), .c(x08), .O(new_n26_));
  inv1   g07(.a(x13), .O(new_n27_));
  nand2  g08(.a(new_n27_), .b(new_n21_), .O(new_n28_));
  aoi21  g09(.a(new_n28_), .b(new_n26_), .c(new_n25_), .O(new_n29_));
  and2   g10(.a(x04), .b(x02), .O(new_n30_));
  nor2   g11(.a(new_n30_), .b(new_n21_), .O(new_n31_));
  aoi21  g12(.a(new_n29_), .b(x02), .c(new_n31_), .O(new_n32_));
  oai21  g13(.a(new_n32_), .b(new_n20_), .c(new_n24_), .O(z0));
  ...
  nand4  g22(.a(new_n41_), .b(new_n39_), .c(new_n22_), .d(x05), .O(z1));
  ...
  nand2  g28(.a(new_n27_), .b(x10), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n30_), .c(new_n21_), .O(new_n49_));
  ...
  nor2   g37(.a(x13), .b(x12), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n56_), .c(new_n44_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n26_), .c(new_n25_), .O(new_n59_));
  nand4  g40(.a(new_n44_), .b(new_n43_), .c(x04), .d(x02), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n27_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n21_), .O(new_n62_));
  aoi22  g43(.a(new_n62_), .b(x12), .c(new_n59_), .d(x02), .O(new_n63_));
  ...
  aoi21  g48(.a(new_n67_), .b(x08), .c(new_n27_), .O(z4));
endmodule
