...
module FAU ( 
  ...
  oai21  g09(.a(new_n28_), .b(new_n27_), .c(x09), .O(new_n29_));
  ...
  oai21  g17(.a(new_n33_), .b(new_n24_), .c(new_n36_), .O(new_n37_));
  nor2   g18(.a(x03), .b(x01), .O(new_n38_));
  aoi21  g19(.a(new_n37_), .b(x03), .c(new_n38_), .O(new_n39_));
  oai21  g20(.a(new_n39_), .b(new_n31_), .c(x05), .O(z1));
  inv1   g21(.a(x10), .O(new_n41_));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n34_), .O(new_n43_));
  nand2  g24(.a(x13), .b(x09), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n43_), .c(new_n25_), .O(new_n45_));
  nor2   g26(.a(new_n25_), .b(new_n24_), .O(new_n46_));
  aoi21  g27(.a(x10), .b(x09), .c(x08), .O(new_n47_));
  ...
  oai21  g31(.a(x06), .b(x03), .c(x09), .O(new_n51_));
  ...
  aoi21  g38(.a(new_n42_), .b(new_n41_), .c(new_n31_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n35_), .c(x12), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x03), .O(new_n61_));
  oai21  g42(.a(x07), .b(x03), .c(x09), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n50_), .O(new_n63_));
