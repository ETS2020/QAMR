...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n20_), .c(x06), .O(new_n38_));
  ...
  nand3  g28(.a(new_n37_), .b(x04), .c(x02), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x11), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n37_), .c(x04), .d(x02), .O(new_n51_));
  ...
  nand3  g36(.a(new_n41_), .b(new_n26_), .c(new_n20_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n36_), .O(z2));
  inv1   g38(.a(x12), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n20_), .c(x06), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x08), .O(new_n60_));
  and2   g41(.a(new_n51_), .b(x12), .O(new_n61_));
  nand3  g42(.a(new_n41_), .b(x04), .c(x02), .O(new_n62_));
  nand3  g43(.a(new_n58_), .b(new_n50_), .c(new_n37_), .O(new_n63_));
  ...
  nand4  g48(.a(new_n67_), .b(new_n65_), .c(new_n60_), .d(new_n36_), .O(z3));
  nand4  g49(.a(new_n27_), .b(x13), .c(x09), .d(x04), .O(new_n69_));
