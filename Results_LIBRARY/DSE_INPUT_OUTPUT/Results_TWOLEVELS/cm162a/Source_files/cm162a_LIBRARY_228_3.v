...
module FAU ( 
  ...
  oai21  g25(.a(x11), .b(x10), .c(new_n20_), .O(new_n45_));
  ...
  nor3   g31(.a(new_n50_), .b(x09), .c(new_n49_), .O(new_n51_));
  oai21  g32(.a(new_n48_), .b(new_n21_), .c(new_n51_), .O(z3));
  nand2  g33(.a(x13), .b(x04), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n49_), .c(new_n20_), .O(z4));
endmodule
