...
module FAU ( 
  ...
  nand2  g00(.a(x12), .b(x00), .O(new_n20_));
  ...
  nand3  g14(.a(new_n33_), .b(new_n29_), .c(new_n24_), .O(z0));
  inv1   g15(.a(x10), .O(new_n35_));
  inv1   g16(.a(new_n27_), .O(new_n36_));
  nand3  g17(.a(new_n26_), .b(new_n35_), .c(new_n25_), .O(new_n37_));
  ...
  nand3  g22(.a(new_n41_), .b(new_n39_), .c(new_n24_), .O(z1));
  ...
  aoi21  g33(.a(new_n52_), .b(new_n31_), .c(new_n51_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n50_), .c(new_n32_), .O(z2));
  oai22  g35(.a(new_n22_), .b(new_n21_), .c(x07), .d(x03), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n51_), .c(new_n20_), .O(new_n56_));
  nand4  g37(.a(new_n26_), .b(new_n44_), .c(new_n35_), .d(new_n25_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x12), .c(new_n30_), .O(new_n58_));
  nor3   g39(.a(x12), .b(x11), .c(x10), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n36_), .O(new_n60_));
