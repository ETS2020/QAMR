...
module FAU ( 
  ...
  oai22  g34(.a(new_n53_), .b(new_n34_), .c(new_n21_), .d(new_n29_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  aoi21  g36(.a(new_n43_), .b(new_n33_), .c(new_n29_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n37_), .c(x12), .O(new_n57_));
  ...
  oai21  g45(.a(x07), .b(x05), .c(x13), .O(new_n65_));
  nor3   g46(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(z4));
endmodule
