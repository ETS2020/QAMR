...
module FAU ( 
  ...
  oai21  g13(.a(x10), .b(new_n32_), .c(new_n31_), .O(new_n33_));
  oai21  g14(.a(x10), .b(x08), .c(new_n20_), .O(new_n34_));
  nand3  g15(.a(new_n34_), .b(x04), .c(x02), .O(new_n35_));
  inv1   g16(.a(x08), .O(new_n36_));
  nand2  g17(.a(new_n36_), .b(x04), .O(new_n37_));
  aoi21  g18(.a(new_n37_), .b(x10), .c(new_n23_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n35_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x03), .O(new_n40_));
  inv1   g21(.a(x01), .O(new_n41_));
  aoi22  g22(.a(new_n23_), .b(x02), .c(new_n32_), .d(new_n41_), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n40_), .c(new_n33_), .O(z1));
  ...
  nand4  g29(.a(new_n44_), .b(new_n36_), .c(x04), .d(x02), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x11), .c(new_n23_), .O(new_n50_));
  ...
  nand4  g37(.a(new_n56_), .b(new_n45_), .c(new_n44_), .d(new_n36_), .O(new_n57_));
