...
module FAU ( 
  ...
  aoi21  g26(.a(new_n45_), .b(new_n41_), .c(new_n21_), .O(z1));
  inv1   g27(.a(x11), .O(new_n47_));
  nor2   g28(.a(x10), .b(x08), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n29_), .c(new_n47_), .O(new_n49_));
  inv1   g30(.a(x10), .O(new_n50_));
  nand3  g31(.a(new_n47_), .b(new_n50_), .c(new_n27_), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(new_n28_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n49_), .c(x03), .O(new_n53_));
  nor2   g34(.a(x06), .b(x03), .O(new_n54_));
  nor2   g35(.a(new_n54_), .b(new_n21_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n53_), .c(new_n26_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  oai21  g38(.a(new_n52_), .b(x07), .c(new_n57_), .O(new_n58_));
  nor2   g39(.a(new_n52_), .b(new_n57_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  nand2  g41(.a(new_n20_), .b(new_n43_), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n60_), .c(new_n58_), .d(new_n26_), .O(z3));
