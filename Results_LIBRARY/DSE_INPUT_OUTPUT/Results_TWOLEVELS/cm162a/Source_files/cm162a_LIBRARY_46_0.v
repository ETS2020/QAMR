...
module FAU ( 
  ...
  nand4  g26(.a(new_n41_), .b(new_n24_), .c(x04), .d(x02), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(x11), .c(new_n29_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x05), .c(new_n20_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n49_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n42_), .c(new_n41_), .d(new_n24_), .O(new_n54_));
