...
module FAU ( 
  ...
  nand2  g27(.a(x10), .b(x05), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n33_), .c(x04), .d(x02), .O(new_n48_));
  ...
  nand4  g36(.a(new_n55_), .b(new_n42_), .c(new_n41_), .d(new_n33_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n20_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  oai21  g39(.a(new_n43_), .b(new_n23_), .c(x12), .O(new_n59_));
  ...
  oai22  g46(.a(new_n20_), .b(new_n65_), .c(x05), .d(new_n27_), .O(z4));
endmodule
