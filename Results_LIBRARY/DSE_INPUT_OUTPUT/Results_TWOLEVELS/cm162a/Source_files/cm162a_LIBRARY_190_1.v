...
module FAU ( 
  ...
  nand2  g11(.a(new_n23_), .b(x04), .O(new_n31_));
  aoi22  g12(.a(new_n31_), .b(x10), .c(new_n30_), .d(x04), .O(new_n32_));
  inv1   g13(.a(x02), .O(new_n33_));
  oai21  g14(.a(x03), .b(x01), .c(x05), .O(new_n34_));
  nor2   g15(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  oai21  g16(.a(new_n32_), .b(new_n27_), .c(new_n35_), .O(z1));
  ...
  nand2  g37(.a(x05), .b(new_n33_), .O(new_n57_));
