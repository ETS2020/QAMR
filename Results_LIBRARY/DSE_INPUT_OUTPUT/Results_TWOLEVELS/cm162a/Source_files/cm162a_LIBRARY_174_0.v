...
module FAU ( 
  ...
  nand4  g31(.a(new_n50_), .b(new_n40_), .c(new_n39_), .d(new_n24_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand3  g34(.a(new_n25_), .b(new_n40_), .c(new_n24_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x12), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n53_), .c(new_n29_), .O(new_n56_));
  nor2   g37(.a(new_n50_), .b(new_n39_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n56_), .c(x03), .O(new_n58_));
  nor2   g39(.a(x07), .b(new_n29_), .O(new_n59_));
  aoi22  g40(.a(new_n59_), .b(new_n20_), .c(x10), .d(new_n29_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(z3));
  oai22  g42(.a(new_n49_), .b(new_n21_), .c(x10), .d(x05), .O(z4));
endmodule
