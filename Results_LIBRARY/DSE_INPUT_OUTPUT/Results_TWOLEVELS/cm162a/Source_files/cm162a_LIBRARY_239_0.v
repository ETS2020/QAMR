...
module FAU ( 
  ...
  nand2  g09(.a(new_n28_), .b(x11), .O(new_n29_));
  ...
  aoi21  g18(.a(x11), .b(x01), .c(x03), .O(new_n38_));
  aoi21  g19(.a(x11), .b(new_n23_), .c(new_n38_), .O(new_n39_));
  ...
  oai22  g46(.a(new_n20_), .b(new_n65_), .c(x11), .d(x03), .O(z4));
endmodule
