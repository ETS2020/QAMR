...
module FAU ( 
  ...
  oai21  g06(.a(new_n25_), .b(new_n24_), .c(x07), .O(new_n26_));
  ...
  nand4  g28(.a(new_n43_), .b(new_n24_), .c(x04), .d(x02), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(x11), .c(new_n35_), .O(new_n49_));
  ...
  nand4  g37(.a(new_n56_), .b(new_n44_), .c(new_n43_), .d(new_n24_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n20_), .c(new_n55_), .O(new_n58_));
  ...
  nor2   g42(.a(new_n35_), .b(new_n30_), .O(new_n62_));
  oai21  g43(.a(new_n61_), .b(new_n29_), .c(new_n62_), .O(z3));
  oai22  g44(.a(new_n20_), .b(new_n55_), .c(x07), .d(new_n29_), .O(z4));
endmodule
