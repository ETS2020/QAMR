...
module FAU ( 
  ...
  aoi21  g23(.a(new_n20_), .b(new_n29_), .c(new_n30_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n42_), .O(z1));
  inv1   g25(.a(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n34_), .c(new_n33_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n21_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  oai21  g29(.a(new_n35_), .b(new_n24_), .c(x11), .O(new_n49_));
  ...
  nand2  g35(.a(new_n54_), .b(new_n45_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n35_), .c(new_n36_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nand2  g38(.a(new_n45_), .b(new_n34_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x05), .c(new_n39_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n54_), .c(new_n57_), .O(new_n60_));
  ...
  nand2  g45(.a(new_n30_), .b(x01), .O(new_n65_));
