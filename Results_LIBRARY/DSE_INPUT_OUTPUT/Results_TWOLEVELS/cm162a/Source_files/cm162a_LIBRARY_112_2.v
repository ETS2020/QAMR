...
module FAU ( 
  ...
  oai21  g08(.a(x03), .b(x00), .c(new_n27_), .O(z0));
  ...
  aoi21  g13(.a(new_n32_), .b(x10), .c(new_n23_), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n30_), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(x03), .O(new_n35_));
  inv1   g16(.a(x03), .O(new_n36_));
  inv1   g17(.a(x00), .O(new_n37_));
  nand2  g18(.a(x01), .b(new_n37_), .O(new_n38_));
  nor2   g19(.a(x05), .b(x00), .O(new_n39_));
  aoi21  g20(.a(new_n38_), .b(new_n36_), .c(new_n39_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n35_), .O(z1));
  oai21  g22(.a(x06), .b(x03), .c(x05), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n37_), .O(new_n43_));
  inv1   g24(.a(x10), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(new_n44_), .c(new_n31_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand4  g29(.a(new_n44_), .b(new_n31_), .c(x04), .d(x02), .O(new_n49_));
  ...
  nand2  g33(.a(new_n52_), .b(new_n43_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n45_), .c(new_n44_), .d(new_n31_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nor2   g38(.a(x11), .b(x10), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n31_), .c(x04), .d(x02), .O(new_n59_));
  ...
  nand2  g43(.a(x07), .b(new_n37_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n36_), .c(new_n39_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  inv1   g46(.a(x04), .O(new_n66_));
  oai22  g47(.a(new_n20_), .b(new_n66_), .c(x03), .d(new_n37_), .O(z4));
endmodule
