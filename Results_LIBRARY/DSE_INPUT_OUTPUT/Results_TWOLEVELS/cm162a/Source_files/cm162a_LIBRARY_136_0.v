...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(x10), .c(new_n28_), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(new_n32_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(x03), .O(new_n36_));
  nand2  g17(.a(x05), .b(new_n20_), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(x01), .c(new_n36_), .O(z1));
  ...
  nand4  g24(.a(new_n39_), .b(new_n24_), .c(x04), .d(x02), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(x11), .c(new_n28_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(x03), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x05), .c(new_n20_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n47_), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n40_), .c(new_n39_), .d(new_n24_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  nor2   g35(.a(x11), .b(x10), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n24_), .c(x04), .d(x02), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x12), .c(new_n28_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x05), .c(new_n20_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x09), .O(new_n63_));
  oai21  g44(.a(x05), .b(x03), .c(x13), .O(new_n64_));
  nor3   g45(.a(new_n64_), .b(new_n63_), .c(new_n21_), .O(z4));
endmodule
