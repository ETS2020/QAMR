...
module FAU ( 
  ...
  nand2  g21(.a(x06), .b(new_n27_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(z1));
  ...
  nand4  g33(.a(new_n52_), .b(new_n43_), .c(new_n32_), .d(new_n31_), .O(new_n53_));
  ...
  nand2  g40(.a(new_n59_), .b(new_n41_), .O(z3));
  oai22  g41(.a(new_n30_), .b(new_n21_), .c(x06), .d(x05), .O(z4));
endmodule
