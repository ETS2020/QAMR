...
module FAU ( 
  ...
  aoi21  g15(.a(new_n31_), .b(x02), .c(new_n34_), .O(new_n35_));
  ...
  aoi21  g22(.a(new_n41_), .b(new_n39_), .c(new_n20_), .O(new_n42_));
  nor2   g23(.a(x10), .b(x08), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(x02), .c(new_n40_), .O(new_n44_));
  ...
  nand3  g32(.a(new_n43_), .b(new_n51_), .c(new_n40_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n21_), .c(new_n20_), .O(new_n53_));
  aoi21  g34(.a(x11), .b(new_n23_), .c(x10), .O(new_n54_));
  ...
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(x05), .d(x04), .O(z3));
  inv1   g40(.a(x05), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(x04), .c(new_n21_), .O(z4));
endmodule
