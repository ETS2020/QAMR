...
module FAU ( 
  ...
  inv1   g14(.a(new_n20_), .O(new_n34_));
  nor3   g15(.a(x11), .b(x10), .c(x08), .O(new_n35_));
  or2    g16(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(x04), .c(x02), .O(new_n37_));
  inv1   g18(.a(x10), .O(new_n38_));
  nand3  g19(.a(new_n24_), .b(new_n38_), .c(new_n23_), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(x11), .c(new_n26_), .O(new_n40_));
  ...
  nand4  g27(.a(new_n46_), .b(new_n45_), .c(new_n38_), .d(new_n23_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n44_), .c(new_n43_), .O(new_n48_));
  aoi21  g29(.a(new_n35_), .b(new_n24_), .c(new_n46_), .O(new_n49_));
  aoi21  g30(.a(new_n48_), .b(x02), .c(new_n49_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n42_), .c(x05), .O(z3));
  inv1   g32(.a(x05), .O(new_n52_));
  oai22  g33(.a(new_n44_), .b(new_n43_), .c(new_n52_), .d(x03), .O(z4));
endmodule
