...
module FAU ( 
  ...
  nand3  g32(.a(new_n40_), .b(x11), .c(x06), .O(new_n52_));
  ...
  oai21  g39(.a(new_n58_), .b(new_n22_), .c(x06), .O(new_n59_));
  ...
  and2   g45(.a(new_n40_), .b(x12), .O(new_n65_));
  ...
  nand2  g50(.a(new_n46_), .b(new_n21_), .O(z4));
endmodule
