...
module FAU ( 
  ...
  nor2   g11(.a(x12), .b(x04), .O(new_n31_));
  nor2   g12(.a(x03), .b(x00), .O(new_n32_));
  nor3   g13(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n33_));
  oai21  g14(.a(new_n29_), .b(new_n20_), .c(new_n33_), .O(z0));
  inv1   g15(.a(new_n31_), .O(new_n35_));
  ...
  nor3   g24(.a(new_n43_), .b(new_n42_), .c(x04), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n41_), .c(x03), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n37_), .O(z1));
  inv1   g27(.a(x11), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n42_), .c(new_n25_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n23_), .c(new_n21_), .O(new_n49_));
  aoi21  g30(.a(new_n38_), .b(new_n27_), .c(new_n47_), .O(new_n50_));
  aoi21  g31(.a(new_n49_), .b(x02), .c(new_n50_), .O(new_n51_));
  nor2   g32(.a(x06), .b(x03), .O(new_n52_));
  nor3   g33(.a(new_n52_), .b(new_n31_), .c(new_n30_), .O(new_n53_));
  oai21  g34(.a(new_n51_), .b(new_n20_), .c(new_n53_), .O(z2));
  nand3  g35(.a(new_n38_), .b(new_n43_), .c(new_n47_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n23_), .c(new_n21_), .O(new_n56_));
  nor3   g37(.a(x11), .b(x10), .c(x08), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n27_), .c(new_n43_), .O(new_n58_));
  aoi21  g39(.a(new_n56_), .b(x02), .c(new_n58_), .O(new_n59_));
  oai21  g40(.a(x07), .b(x03), .c(x05), .O(new_n60_));
  oai21  g41(.a(x07), .b(x04), .c(x05), .O(new_n61_));
  aoi22  g42(.a(new_n61_), .b(x12), .c(new_n60_), .d(x04), .O(new_n62_));
  oai21  g43(.a(new_n59_), .b(new_n20_), .c(new_n62_), .O(z3));
  oai21  g44(.a(new_n23_), .b(new_n21_), .c(new_n35_), .O(z4));
endmodule
