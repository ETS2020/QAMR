...
module FAU ( 
  ...
  oai21  g26(.a(x11), .b(x10), .c(new_n20_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nor3   g28(.a(x12), .b(x11), .c(x10), .O(new_n48_));
  aoi22  g29(.a(new_n48_), .b(new_n45_), .c(new_n47_), .d(x12), .O(new_n49_));
  nor2   g30(.a(x07), .b(x03), .O(new_n50_));
  nor3   g31(.a(new_n50_), .b(x09), .c(new_n34_), .O(new_n51_));
  oai21  g32(.a(new_n49_), .b(new_n21_), .c(new_n51_), .O(z3));
  nand4  g33(.a(x13), .b(x09), .c(new_n34_), .d(x04), .O(new_n53_));
