...
module FAU ( 
  ...
  nand2  g22(.a(new_n41_), .b(new_n27_), .O(new_n42_));
  ...
  oai21  g28(.a(new_n33_), .b(new_n24_), .c(x11), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x05), .c(x03), .O(new_n50_));
  oai21  g31(.a(new_n27_), .b(new_n20_), .c(new_n41_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n50_), .O(z2));
  ...
  nand2  g41(.a(new_n60_), .b(new_n42_), .O(z3));
  oai22  g42(.a(new_n30_), .b(new_n21_), .c(new_n41_), .d(x05), .O(z4));
endmodule
