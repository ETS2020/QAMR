...
module FAU ( 
  ...
  nand4  g33(.a(new_n52_), .b(new_n44_), .c(new_n51_), .d(new_n24_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n22_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  nand4  g36(.a(new_n41_), .b(new_n24_), .c(x04), .d(x02), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x12), .c(new_n29_), .O(new_n57_));
