...
module FAU ( 
  ...
  oai22  g33(.a(new_n52_), .b(new_n33_), .c(new_n22_), .d(new_n21_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  nor2   g35(.a(x11), .b(x10), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n31_), .c(x04), .d(x02), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x12), .c(new_n21_), .O(new_n57_));
