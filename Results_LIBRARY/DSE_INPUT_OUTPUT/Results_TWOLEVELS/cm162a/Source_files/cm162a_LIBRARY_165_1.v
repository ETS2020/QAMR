...
module FAU ( 
  ...
  aoi22  g32(.a(new_n51_), .b(new_n42_), .c(x13), .d(x09), .O(new_n52_));
  nand4  g33(.a(new_n39_), .b(new_n32_), .c(new_n23_), .d(x02), .O(new_n53_));
