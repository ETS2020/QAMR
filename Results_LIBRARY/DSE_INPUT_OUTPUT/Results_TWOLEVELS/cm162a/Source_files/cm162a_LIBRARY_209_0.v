...
module FAU ( 
  ...
  aoi21  g08(.a(x13), .b(x00), .c(x03), .O(new_n28_));
  aoi21  g09(.a(x13), .b(new_n23_), .c(new_n28_), .O(new_n29_));
  ...
  nand2  g19(.a(new_n38_), .b(x13), .O(new_n39_));
  ...
  nand2  g31(.a(new_n50_), .b(x13), .O(new_n51_));
  ...
  nand2  g43(.a(new_n62_), .b(x13), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai22  g46(.a(new_n20_), .b(new_n65_), .c(x13), .d(x03), .O(z4));
endmodule
