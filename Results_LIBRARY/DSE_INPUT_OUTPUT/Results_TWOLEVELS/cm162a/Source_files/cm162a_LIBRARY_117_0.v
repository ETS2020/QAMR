...
module FAU ( 
  ...
  nand4  g23(.a(new_n42_), .b(x05), .c(x04), .d(x02), .O(new_n43_));
  ...
  nor2   g29(.a(new_n40_), .b(x05), .O(new_n49_));
  aoi21  g30(.a(new_n48_), .b(new_n20_), .c(new_n49_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n47_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n40_), .c(new_n39_), .d(new_n24_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n38_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  nand2  g36(.a(new_n44_), .b(x12), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n55_), .c(new_n28_), .O(new_n57_));
  nor2   g38(.a(new_n52_), .b(new_n40_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(x03), .O(new_n59_));
  nor2   g40(.a(x07), .b(new_n28_), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n20_), .c(new_n49_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x09), .O(new_n63_));
  oai21  g44(.a(x11), .b(x05), .c(x13), .O(new_n64_));
