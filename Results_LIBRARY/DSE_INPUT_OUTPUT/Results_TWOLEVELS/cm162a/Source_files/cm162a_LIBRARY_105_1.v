...
module FAU ( 
  ...
  nand2  g10(.a(x09), .b(new_n29_), .O(new_n30_));
  ...
  nand3  g32(.a(new_n51_), .b(new_n30_), .c(x05), .O(new_n52_));
  inv1   g33(.a(new_n52_), .O(new_n53_));
  oai21  g34(.a(new_n49_), .b(new_n20_), .c(new_n53_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n44_), .c(new_n43_), .d(new_n24_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n22_), .c(new_n21_), .O(new_n57_));
  nor3   g38(.a(x11), .b(x10), .c(x08), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n25_), .c(new_n55_), .O(new_n59_));
  ...
  aoi21  g44(.a(new_n63_), .b(new_n29_), .c(new_n61_), .O(new_n64_));
  oai21  g45(.a(new_n60_), .b(new_n20_), .c(new_n64_), .O(z3));
  nand4  g46(.a(x13), .b(x09), .c(x07), .d(x04), .O(new_n66_));
