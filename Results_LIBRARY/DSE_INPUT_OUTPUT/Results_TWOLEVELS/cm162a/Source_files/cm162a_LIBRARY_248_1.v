...
module FAU ( 
  ...
  nand3  g26(.a(new_n25_), .b(new_n41_), .c(new_n24_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x11), .c(x05), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(x03), .O(new_n49_));
  nor2   g30(.a(x06), .b(new_n29_), .O(new_n50_));
  aoi22  g31(.a(new_n50_), .b(new_n20_), .c(new_n42_), .d(new_n29_), .O(new_n51_));
  ...
  oai21  g43(.a(new_n42_), .b(x05), .c(new_n62_), .O(z4));
endmodule
