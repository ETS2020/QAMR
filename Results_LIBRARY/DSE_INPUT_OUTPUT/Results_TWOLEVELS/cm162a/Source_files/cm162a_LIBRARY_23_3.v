...
module FAU ( 
  ...
  oai21  g08(.a(new_n24_), .b(new_n22_), .c(x08), .O(new_n28_));
  ...
  nand3  g16(.a(new_n35_), .b(new_n32_), .c(new_n27_), .O(z0));
  ...
  oai21  g24(.a(x12), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(x12), .c(x10), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n29_), .c(x04), .d(x03), .O(new_n46_));
  oai22  g27(.a(new_n46_), .b(new_n22_), .c(new_n41_), .d(new_n33_), .O(z1));
  inv1   g28(.a(x10), .O(new_n48_));
  nand3  g29(.a(new_n43_), .b(new_n48_), .c(new_n29_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n25_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x04), .c(x02), .O(new_n51_));
  nand4  g32(.a(new_n48_), .b(new_n29_), .c(x04), .d(x02), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n56_), .b(new_n23_), .c(new_n20_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n55_), .c(new_n33_), .O(z2));
  nand3  g39(.a(x12), .b(x11), .c(new_n42_), .O(new_n59_));
  inv1   g40(.a(x12), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n43_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand4  g43(.a(new_n62_), .b(new_n48_), .c(new_n29_), .d(x04), .O(new_n63_));
  inv1   g44(.a(new_n63_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(x03), .c(x02), .O(new_n65_));
  and2   g46(.a(new_n52_), .b(x12), .O(new_n66_));
  oai21  g47(.a(new_n66_), .b(new_n23_), .c(new_n42_), .O(new_n67_));
  nand3  g48(.a(new_n67_), .b(new_n65_), .c(new_n27_), .O(z3));
