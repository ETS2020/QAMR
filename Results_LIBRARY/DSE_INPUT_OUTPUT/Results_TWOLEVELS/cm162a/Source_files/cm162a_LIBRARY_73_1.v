...
module FAU ( 
  ...
  oai22  g34(.a(new_n53_), .b(new_n47_), .c(x07), .d(x03), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n20_), .O(new_n55_));
  nand4  g36(.a(new_n28_), .b(new_n43_), .c(new_n46_), .d(new_n27_), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(x12), .c(x07), .d(x03), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(new_n26_), .O(z3));
  nand2  g39(.a(new_n24_), .b(new_n22_), .O(z4));
endmodule
