...
module FAU ( 
  ...
  nand3  g09(.a(new_n26_), .b(x04), .c(x02), .O(new_n29_));
  oai21  g10(.a(new_n28_), .b(new_n26_), .c(new_n29_), .O(new_n30_));
  nand2  g11(.a(new_n30_), .b(x03), .O(new_n31_));
  nor2   g12(.a(x03), .b(x00), .O(new_n32_));
  nor2   g13(.a(new_n32_), .b(new_n20_), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(new_n31_), .c(new_n25_), .O(z0));
  ...
  aoi21  g24(.a(new_n36_), .b(new_n28_), .c(new_n43_), .O(new_n44_));
  inv1   g25(.a(x10), .O(new_n45_));
  nand3  g26(.a(new_n43_), .b(new_n45_), .c(new_n26_), .O(new_n46_));
  nor2   g27(.a(new_n46_), .b(new_n27_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n44_), .c(x03), .O(new_n48_));
  nor2   g29(.a(x06), .b(x03), .O(new_n49_));
  nor2   g30(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(new_n25_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nor3   g33(.a(x11), .b(x10), .c(x08), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n28_), .c(new_n52_), .O(new_n54_));
  nand3  g35(.a(x07), .b(x04), .c(x02), .O(new_n55_));
  nand3  g36(.a(new_n36_), .b(new_n52_), .c(new_n43_), .O(new_n56_));
  ...
  nand3  g41(.a(x12), .b(new_n60_), .c(new_n59_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n58_), .c(new_n25_), .O(z3));
