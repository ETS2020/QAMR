...
module FAU ( 
  ...
  oai21  g06(.a(new_n25_), .b(new_n21_), .c(x03), .O(new_n26_));
  ...
  inv1   g34(.a(new_n22_), .O(new_n54_));
  nand2  g35(.a(new_n43_), .b(new_n42_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n20_), .c(new_n54_), .O(new_n56_));
  nor2   g37(.a(new_n34_), .b(x08), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n56_), .c(x04), .d(x02), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n28_), .c(new_n29_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  nand2  g43(.a(new_n34_), .b(x03), .O(new_n63_));
