...
module FAU ( 
  ...
  nand2  g38(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  nand2  g40(.a(x11), .b(new_n45_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n50_), .c(new_n35_), .O(new_n61_));
  ...
  aoi21  g46(.a(new_n65_), .b(new_n20_), .c(new_n41_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  oai22  g48(.a(new_n21_), .b(new_n44_), .c(new_n45_), .d(x05), .O(z4));
endmodule
