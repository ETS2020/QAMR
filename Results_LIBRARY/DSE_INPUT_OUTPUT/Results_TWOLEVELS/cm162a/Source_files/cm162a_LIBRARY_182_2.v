...
module FAU ( 
  ...
  nand3  g21(.a(new_n40_), .b(new_n39_), .c(new_n32_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n23_), .O(new_n42_));
  nand4  g23(.a(new_n42_), .b(x12), .c(x04), .d(x02), .O(new_n43_));
  nand2  g24(.a(new_n39_), .b(new_n32_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n21_), .c(x11), .O(new_n45_));
  ...
  nand2  g34(.a(new_n40_), .b(new_n39_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n32_), .c(new_n53_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n32_), .c(x04), .d(x02), .O(new_n56_));
  nor2   g37(.a(x07), .b(x03), .O(new_n57_));
  aoi21  g38(.a(new_n56_), .b(x03), .c(new_n57_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n49_), .c(x05), .O(z3));
  inv1   g40(.a(x04), .O(new_n60_));
  oai22  g41(.a(new_n23_), .b(new_n60_), .c(x12), .d(new_n48_), .O(z4));
endmodule
