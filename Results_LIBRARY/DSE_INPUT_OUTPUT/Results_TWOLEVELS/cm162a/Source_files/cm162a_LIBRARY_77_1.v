...
module FAU ( 
  ...
  aoi21  g00(.a(x08), .b(x03), .c(x12), .O(new_n20_));
  ...
  nand2  g17(.a(x12), .b(new_n36_), .O(new_n37_));
  ...
  oai21  g23(.a(x08), .b(new_n28_), .c(x10), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n42_), .c(new_n36_), .O(new_n44_));
  nand3  g25(.a(new_n31_), .b(x10), .c(new_n36_), .O(new_n45_));
  ...
  oai21  g30(.a(new_n49_), .b(new_n26_), .c(new_n31_), .O(new_n50_));
  ...
  nand2  g37(.a(new_n41_), .b(x04), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x11), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  nor2   g41(.a(x06), .b(x03), .O(new_n61_));
  aoi21  g42(.a(new_n37_), .b(new_n30_), .c(new_n61_), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(z2));
  oai21  g44(.a(x07), .b(x03), .c(x05), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n37_), .O(new_n65_));
  nand3  g46(.a(new_n41_), .b(new_n31_), .c(new_n49_), .O(new_n66_));
  aoi21  g47(.a(new_n66_), .b(new_n21_), .c(new_n28_), .O(new_n67_));
  nor2   g48(.a(x08), .b(new_n28_), .O(new_n68_));
  aoi21  g49(.a(new_n53_), .b(new_n68_), .c(new_n31_), .O(new_n69_));
  oai21  g50(.a(new_n69_), .b(new_n67_), .c(x03), .O(new_n70_));
  oai21  g51(.a(new_n70_), .b(new_n36_), .c(new_n65_), .O(z3));
  nand4  g52(.a(new_n37_), .b(x13), .c(x09), .d(x04), .O(new_n72_));
