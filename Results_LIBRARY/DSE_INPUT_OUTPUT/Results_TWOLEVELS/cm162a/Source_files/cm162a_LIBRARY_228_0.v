...
module FAU ( 
  ...
  aoi21  g06(.a(x04), .b(x02), .c(new_n22_), .O(new_n26_));
  aoi22  g07(.a(new_n26_), .b(x05), .c(new_n25_), .d(x02), .O(new_n27_));
  ...
  aoi21  g13(.a(new_n30_), .b(new_n28_), .c(new_n32_), .O(new_n33_));
  oai21  g14(.a(new_n27_), .b(new_n20_), .c(new_n33_), .O(z0));
  inv1   g15(.a(x10), .O(new_n35_));
  nand3  g16(.a(new_n35_), .b(new_n22_), .c(x05), .O(new_n36_));
  ...
  nor2   g34(.a(x06), .b(new_n29_), .O(new_n54_));
  ...
  aoi21  g41(.a(new_n46_), .b(new_n35_), .c(new_n29_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n39_), .c(x12), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x03), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  aoi21  g46(.a(new_n65_), .b(new_n20_), .c(new_n29_), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n64_), .O(z3));
  oai22  g48(.a(new_n24_), .b(new_n21_), .c(x09), .d(x05), .O(z4));
endmodule
