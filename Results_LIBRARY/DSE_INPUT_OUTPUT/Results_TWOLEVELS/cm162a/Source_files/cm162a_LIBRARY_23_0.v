...
module FAU ( 
  ...
  nand4  g24(.a(new_n43_), .b(new_n26_), .c(x04), .d(x02), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(x11), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n36_), .c(new_n34_), .O(new_n46_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n49_), .c(new_n43_), .d(new_n26_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n51_), .b(new_n49_), .c(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n57_), .c(x10), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n26_), .c(x04), .d(x02), .O(new_n60_));
  nand2  g41(.a(new_n44_), .b(x12), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x03), .O(new_n63_));
  nand3  g44(.a(x12), .b(new_n50_), .c(new_n34_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n63_), .c(new_n25_), .O(z3));
