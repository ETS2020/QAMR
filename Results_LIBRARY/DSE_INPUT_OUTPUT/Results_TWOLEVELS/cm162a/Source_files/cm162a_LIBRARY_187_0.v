...
module FAU ( 
  ...
  nand2  g21(.a(x12), .b(new_n27_), .O(new_n41_));
  ...
  nor2   g35(.a(new_n44_), .b(new_n24_), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  ...
  oai22  g41(.a(new_n30_), .b(new_n21_), .c(x12), .d(x05), .O(z4));
endmodule
