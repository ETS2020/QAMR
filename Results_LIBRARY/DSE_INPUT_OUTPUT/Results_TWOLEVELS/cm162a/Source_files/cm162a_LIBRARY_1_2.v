...
module FAU ( 
  ...
  aoi21  g19(.a(new_n38_), .b(new_n36_), .c(new_n21_), .O(new_n39_));
  nor2   g20(.a(x03), .b(x01), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n39_), .c(x05), .O(new_n41_));
  nand2  g22(.a(new_n22_), .b(new_n20_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n41_), .O(z1));
  ...
  oai21  g28(.a(new_n34_), .b(new_n27_), .c(x11), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n47_), .c(new_n21_), .O(new_n49_));
  nor2   g30(.a(x06), .b(x03), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(x05), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n42_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n44_), .O(new_n54_));
  oai22  g35(.a(new_n54_), .b(new_n34_), .c(new_n24_), .d(new_n22_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  aoi21  g37(.a(new_n44_), .b(new_n33_), .c(new_n22_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n37_), .c(x12), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(x03), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n21_), .c(new_n22_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  inv1   g44(.a(x04), .O(new_n64_));
  oai22  g45(.a(new_n24_), .b(new_n64_), .c(x05), .d(new_n20_), .O(z4));
endmodule
