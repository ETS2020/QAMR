...
module FAU ( 
  ...
  aoi22  g12(.a(new_n31_), .b(new_n29_), .c(x13), .d(new_n30_), .O(new_n32_));
  ...
  aoi21  g28(.a(new_n47_), .b(new_n26_), .c(new_n44_), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n43_), .d(new_n22_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n24_), .c(new_n21_), .O(new_n55_));
  nor3   g36(.a(x11), .b(x10), .c(x08), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n26_), .c(new_n53_), .O(new_n57_));
