...
module FAU ( 
  ...
  oai21  g23(.a(new_n22_), .b(new_n21_), .c(new_n42_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(x04), .c(x02), .O(new_n44_));
  nand4  g25(.a(new_n40_), .b(new_n33_), .c(x04), .d(x02), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(x11), .c(new_n21_), .O(new_n46_));
  ...
  nand4  g31(.a(new_n50_), .b(new_n41_), .c(new_n40_), .d(new_n33_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  oai21  g34(.a(new_n42_), .b(new_n25_), .c(x12), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n21_), .O(new_n55_));
  nor2   g36(.a(x07), .b(x03), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n55_), .c(new_n20_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x05), .O(z3));
  nand2  g39(.a(x06), .b(x05), .O(new_n59_));
