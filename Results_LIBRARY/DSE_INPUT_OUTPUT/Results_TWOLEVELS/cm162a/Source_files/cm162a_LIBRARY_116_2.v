...
module FAU ( 
  ...
  aoi21  g23(.a(new_n27_), .b(new_n41_), .c(new_n42_), .O(new_n43_));
  ...
  aoi21  g39(.a(new_n45_), .b(new_n32_), .c(new_n42_), .O(new_n59_));
  ...
  aoi21  g44(.a(new_n63_), .b(new_n27_), .c(new_n42_), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n62_), .O(z3));
  nand2  g46(.a(new_n42_), .b(x03), .O(new_n66_));
