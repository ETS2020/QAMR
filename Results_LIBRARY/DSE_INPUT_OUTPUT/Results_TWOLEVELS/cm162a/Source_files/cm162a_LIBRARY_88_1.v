...
module FAU ( 
  ...
  nand3  g25(.a(new_n44_), .b(new_n36_), .c(new_n27_), .O(new_n45_));
  ...
  aoi21  g35(.a(new_n54_), .b(new_n50_), .c(new_n21_), .O(z2));
  inv1   g36(.a(x07), .O(new_n56_));
  oai21  g37(.a(x12), .b(new_n51_), .c(new_n56_), .O(new_n57_));
  inv1   g38(.a(new_n45_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n28_), .c(new_n20_), .O(new_n59_));
  nand3  g40(.a(new_n20_), .b(new_n44_), .c(new_n36_), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n29_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n59_), .c(x03), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n57_), .c(new_n26_), .O(z3));
  nand2  g44(.a(new_n24_), .b(new_n22_), .O(z4));
endmodule
