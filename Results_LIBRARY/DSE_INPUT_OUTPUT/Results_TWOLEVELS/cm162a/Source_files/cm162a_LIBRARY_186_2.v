...
module FAU ( 
  ...
  nand2  g07(.a(x06), .b(x05), .O(new_n27_));
  ...
  nand3  g29(.a(new_n48_), .b(x06), .c(x03), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x05), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand4  g32(.a(new_n51_), .b(new_n43_), .c(new_n31_), .d(new_n30_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n22_), .c(new_n21_), .O(new_n53_));
  inv1   g34(.a(new_n24_), .O(new_n54_));
  nor3   g35(.a(x11), .b(x10), .c(x08), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n54_), .c(new_n51_), .O(new_n56_));
  aoi21  g37(.a(new_n53_), .b(x02), .c(new_n56_), .O(new_n57_));
  inv1   g38(.a(x05), .O(new_n58_));
  inv1   g39(.a(x06), .O(new_n59_));
  nor2   g40(.a(x07), .b(x03), .O(new_n60_));
  nor3   g41(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  oai21  g42(.a(new_n57_), .b(new_n20_), .c(new_n61_), .O(z3));
  oai22  g43(.a(new_n42_), .b(new_n21_), .c(x06), .d(new_n58_), .O(z4));
endmodule
