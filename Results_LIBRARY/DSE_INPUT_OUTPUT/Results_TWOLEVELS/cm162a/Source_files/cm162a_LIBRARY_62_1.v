...
module FAU ( 
  ...
  nand3  g14(.a(new_n28_), .b(x04), .c(x02), .O(new_n34_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n28_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n20_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  nand4  g26(.a(new_n41_), .b(new_n28_), .c(x04), .d(x02), .O(new_n46_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n42_), .c(new_n41_), .d(new_n28_), .O(new_n54_));
  ...
  nand2  g46(.a(x08), .b(new_n65_), .O(new_n66_));
