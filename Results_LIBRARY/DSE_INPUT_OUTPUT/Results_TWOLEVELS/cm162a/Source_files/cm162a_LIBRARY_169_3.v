...
module FAU ( 
  ...
  nand2  g01(.a(x07), .b(x00), .O(new_n21_));
  inv1   g02(.a(x02), .O(new_n22_));
  inv1   g03(.a(x03), .O(new_n23_));
  inv1   g04(.a(x04), .O(new_n24_));
  nand2  g05(.a(x13), .b(x09), .O(new_n25_));
  nor4   g06(.a(new_n25_), .b(new_n24_), .c(new_n23_), .d(new_n22_), .O(new_n26_));
  oai21  g07(.a(new_n26_), .b(new_n20_), .c(new_n21_), .O(new_n27_));
  ...
  nand3  g17(.a(new_n36_), .b(new_n33_), .c(new_n27_), .O(z0));
  ...
  nand2  g22(.a(new_n31_), .b(x10), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(x03), .O(new_n44_));
  inv1   g25(.a(x01), .O(new_n45_));
  aoi21  g26(.a(new_n23_), .b(new_n45_), .c(new_n20_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n44_), .c(new_n34_), .O(z1));
  inv1   g28(.a(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n38_), .c(new_n30_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n25_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x04), .c(x02), .O(new_n51_));
  oai21  g32(.a(new_n39_), .b(new_n28_), .c(x11), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x03), .O(new_n54_));
  inv1   g35(.a(x06), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n23_), .c(new_n20_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n54_), .c(new_n34_), .O(z2));
  inv1   g38(.a(x12), .O(new_n58_));
  nor2   g39(.a(new_n49_), .b(new_n28_), .O(new_n59_));
  nor2   g40(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g41(.a(new_n58_), .b(new_n48_), .c(new_n38_), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n31_), .O(new_n62_));
  oai21  g43(.a(new_n62_), .b(new_n60_), .c(x03), .O(new_n63_));
  nor2   g44(.a(x07), .b(x03), .O(new_n64_));
  nor2   g45(.a(new_n64_), .b(new_n34_), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n63_), .c(new_n27_), .O(z3));
