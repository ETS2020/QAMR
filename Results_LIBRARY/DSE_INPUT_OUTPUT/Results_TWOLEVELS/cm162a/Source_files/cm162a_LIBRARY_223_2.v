...
module FAU ( 
  ...
  nand3  g18(.a(new_n37_), .b(new_n35_), .c(x05), .O(new_n38_));
  ...
  nand4  g35(.a(new_n54_), .b(new_n44_), .c(new_n32_), .d(new_n31_), .O(new_n55_));
  ...
  oai22  g44(.a(new_n43_), .b(new_n21_), .c(x05), .d(new_n20_), .O(z4));
endmodule
