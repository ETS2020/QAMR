...
module FAU ( 
  ...
  aoi22  g12(.a(new_n27_), .b(x02), .c(new_n21_), .d(new_n31_), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(new_n30_), .c(new_n22_), .O(z0));
  oai21  g14(.a(x10), .b(new_n21_), .c(new_n20_), .O(new_n34_));
  ...
  aoi21  g19(.a(new_n38_), .b(x10), .c(new_n27_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n36_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x03), .O(new_n41_));
  inv1   g22(.a(x01), .O(new_n42_));
  aoi22  g23(.a(new_n27_), .b(x02), .c(new_n21_), .d(new_n42_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n41_), .c(new_n34_), .O(z1));
  ...
  nand4  g30(.a(new_n45_), .b(new_n37_), .c(x04), .d(x02), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(x11), .c(new_n27_), .O(new_n51_));
