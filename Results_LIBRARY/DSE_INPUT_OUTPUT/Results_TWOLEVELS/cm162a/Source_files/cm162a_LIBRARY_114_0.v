...
module FAU ( 
  ...
  aoi22  g10(.a(new_n29_), .b(new_n27_), .c(new_n28_), .d(x04), .O(new_n30_));
  ...
  aoi21  g27(.a(new_n46_), .b(new_n20_), .c(new_n43_), .O(new_n47_));
  ...
  aoi21  g33(.a(new_n52_), .b(new_n40_), .c(new_n28_), .O(new_n53_));
  oai21  g34(.a(new_n51_), .b(new_n40_), .c(new_n53_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n45_), .c(new_n44_), .d(new_n34_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n20_), .c(new_n43_), .O(new_n57_));
  nor3   g38(.a(x11), .b(x10), .c(x08), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n48_), .c(new_n55_), .O(new_n59_));
  aoi21  g40(.a(new_n57_), .b(x02), .c(new_n59_), .O(new_n60_));
  inv1   g41(.a(x07), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n40_), .c(new_n28_), .O(new_n62_));
  oai21  g43(.a(new_n60_), .b(new_n40_), .c(new_n62_), .O(z3));
  nand2  g44(.a(new_n28_), .b(new_n43_), .O(new_n64_));
  oai21  g45(.a(new_n20_), .b(new_n43_), .c(new_n64_), .O(z4));
endmodule
