...
module FAU ( 
  ...
  nor3   g11(.a(new_n30_), .b(x12), .c(new_n29_), .O(new_n31_));
  ...
  nand3  g16(.a(new_n25_), .b(x04), .c(x02), .O(new_n36_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n23_), .c(new_n21_), .O(new_n45_));
  ...
  nor3   g30(.a(new_n49_), .b(x12), .c(new_n29_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n20_), .c(new_n50_), .O(z2));
  nand3  g32(.a(new_n45_), .b(x03), .c(x02), .O(new_n52_));
  nor2   g33(.a(x07), .b(x03), .O(new_n53_));
  nor3   g34(.a(new_n53_), .b(x12), .c(new_n29_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z3));
  oai22  g36(.a(new_n33_), .b(new_n21_), .c(new_n22_), .d(new_n29_), .O(z4));
endmodule
