...
module FAU ( 
  ...
  nand2  g10(.a(x11), .b(new_n21_), .O(new_n30_));
  inv1   g11(.a(x00), .O(new_n31_));
  nand2  g12(.a(new_n20_), .b(new_n31_), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(new_n30_), .c(x05), .O(new_n33_));
  ...
  oai21  g19(.a(new_n38_), .b(new_n22_), .c(x02), .O(new_n39_));
  oai21  g20(.a(x08), .b(new_n26_), .c(x10), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(new_n39_), .c(new_n21_), .O(new_n41_));
  inv1   g22(.a(x11), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(x10), .c(new_n21_), .O(new_n43_));
  ...
  nand3  g28(.a(new_n42_), .b(new_n47_), .c(new_n25_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n23_), .c(new_n21_), .O(new_n49_));
  aoi21  g30(.a(new_n38_), .b(x02), .c(new_n42_), .O(new_n50_));
  aoi21  g31(.a(new_n49_), .b(x02), .c(new_n50_), .O(new_n51_));
  inv1   g32(.a(x06), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n20_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n30_), .c(x05), .O(new_n54_));
  inv1   g35(.a(new_n54_), .O(new_n55_));
  oai21  g36(.a(new_n51_), .b(new_n20_), .c(new_n55_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  nand3  g38(.a(new_n38_), .b(new_n57_), .c(new_n42_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n23_), .c(new_n21_), .O(new_n59_));
  nor3   g40(.a(x11), .b(x10), .c(x08), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n27_), .c(new_n57_), .O(new_n61_));
  aoi21  g42(.a(new_n59_), .b(x02), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n20_), .O(new_n64_));
  nand3  g45(.a(new_n64_), .b(new_n30_), .c(x05), .O(new_n65_));
