...
module FAU ( 
  ...
  nand2  g07(.a(new_n26_), .b(x06), .O(new_n27_));
  ...
  oai21  g20(.a(new_n39_), .b(new_n33_), .c(new_n37_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n26_), .O(new_n41_));
  nor2   g22(.a(x08), .b(new_n21_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x02), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(x10), .c(x03), .O(new_n44_));
  inv1   g25(.a(x01), .O(new_n45_));
  nand2  g26(.a(new_n20_), .b(new_n45_), .O(new_n46_));
  nand4  g27(.a(new_n46_), .b(new_n44_), .c(new_n41_), .d(new_n36_), .O(z1));
  inv1   g28(.a(x02), .O(new_n48_));
  oai21  g29(.a(new_n39_), .b(new_n48_), .c(x11), .O(new_n49_));
  inv1   g30(.a(x11), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n38_), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(x08), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x04), .c(x02), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n49_), .c(x03), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n37_), .O(new_n55_));
  nand3  g36(.a(x11), .b(x08), .c(x03), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n55_), .c(new_n36_), .O(z2));
  inv1   g38(.a(x05), .O(new_n58_));
  oai22  g39(.a(new_n34_), .b(new_n33_), .c(x07), .d(x03), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n58_), .c(new_n27_), .O(new_n60_));
  oai21  g41(.a(new_n51_), .b(new_n24_), .c(x12), .O(new_n61_));
  nor3   g42(.a(x12), .b(x11), .c(x10), .O(new_n62_));
  nand3  g43(.a(new_n62_), .b(new_n42_), .c(x02), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n61_), .c(x06), .O(new_n64_));
  and2   g45(.a(x12), .b(x08), .O(new_n65_));
  oai21  g46(.a(new_n65_), .b(new_n64_), .c(x03), .O(new_n66_));
  nand2  g47(.a(new_n66_), .b(new_n60_), .O(z3));
