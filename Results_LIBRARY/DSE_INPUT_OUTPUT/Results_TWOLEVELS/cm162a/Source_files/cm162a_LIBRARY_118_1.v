...
module FAU ( 
  ...
  aoi21  g10(.a(x12), .b(new_n20_), .c(x08), .O(new_n30_));
  ...
  aoi21  g41(.a(new_n60_), .b(new_n22_), .c(new_n59_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n44_), .O(new_n63_));
  aoi21  g44(.a(x07), .b(new_n22_), .c(new_n44_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n59_), .c(x10), .O(new_n65_));
