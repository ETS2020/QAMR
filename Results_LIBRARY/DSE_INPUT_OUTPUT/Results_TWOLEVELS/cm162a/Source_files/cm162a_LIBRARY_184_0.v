...
module FAU ( 
  ...
  nand2  g10(.a(new_n29_), .b(new_n21_), .O(z0));
  ...
  aoi21  g28(.a(new_n47_), .b(x11), .c(new_n25_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x03), .O(new_n50_));
  aoi21  g31(.a(x06), .b(x01), .c(x03), .O(new_n51_));
  aoi21  g32(.a(new_n25_), .b(x01), .c(new_n51_), .O(new_n52_));
