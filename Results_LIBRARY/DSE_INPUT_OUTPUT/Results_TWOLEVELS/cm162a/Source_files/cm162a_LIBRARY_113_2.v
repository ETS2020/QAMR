...
module FAU ( 
  ...
  aoi21  g12(.a(new_n31_), .b(x10), .c(x08), .O(new_n32_));
  ...
  nand3  g19(.a(new_n24_), .b(x04), .c(x02), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(x10), .O(new_n40_));
  nand3  g21(.a(new_n25_), .b(new_n20_), .c(new_n24_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(x03), .O(new_n43_));
  inv1   g24(.a(x01), .O(new_n44_));
  nand2  g25(.a(new_n23_), .b(new_n44_), .O(new_n45_));
  nand4  g26(.a(new_n45_), .b(new_n43_), .c(new_n38_), .d(new_n22_), .O(z1));
  inv1   g27(.a(x05), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(new_n37_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(new_n22_), .O(new_n49_));
  nand2  g30(.a(new_n39_), .b(x11), .O(new_n50_));
  inv1   g31(.a(x11), .O(new_n51_));
  nand3  g32(.a(new_n25_), .b(new_n51_), .c(new_n24_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n50_), .c(x10), .O(new_n53_));
  nand3  g34(.a(x12), .b(x11), .c(x10), .O(new_n54_));
  inv1   g35(.a(new_n54_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n53_), .c(x03), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n49_), .O(z2));
  nand2  g38(.a(new_n22_), .b(new_n47_), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  nand2  g40(.a(x12), .b(x10), .O(new_n60_));
  oai21  g41(.a(x10), .b(x03), .c(new_n60_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  inv1   g43(.a(x02), .O(new_n63_));
  nand3  g44(.a(new_n31_), .b(new_n51_), .c(new_n20_), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n60_), .c(x08), .O(new_n65_));
  nand3  g46(.a(x13), .b(new_n20_), .c(x09), .O(new_n66_));
  inv1   g47(.a(new_n66_), .O(new_n67_));
  oai21  g48(.a(new_n67_), .b(new_n65_), .c(x04), .O(new_n68_));
  nand2  g49(.a(new_n52_), .b(x12), .O(new_n69_));
  oai21  g50(.a(new_n68_), .b(new_n63_), .c(new_n69_), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(x03), .O(new_n71_));
  nand3  g52(.a(new_n71_), .b(new_n62_), .c(new_n58_), .O(z3));
  nand2  g53(.a(new_n35_), .b(new_n22_), .O(z4));
endmodule
