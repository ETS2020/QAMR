...
module FAU ( 
  ...
  nor2   g29(.a(new_n26_), .b(new_n48_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(x12), .c(x03), .O(new_n50_));
  inv1   g31(.a(x05), .O(new_n51_));
  nor2   g32(.a(x07), .b(x03), .O(new_n52_));
  nor3   g33(.a(new_n52_), .b(new_n42_), .c(new_n51_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n50_), .O(z3));
  nand3  g35(.a(x13), .b(x09), .c(x04), .O(new_n55_));
  oai21  g36(.a(x11), .b(new_n51_), .c(new_n55_), .O(z4));
endmodule
