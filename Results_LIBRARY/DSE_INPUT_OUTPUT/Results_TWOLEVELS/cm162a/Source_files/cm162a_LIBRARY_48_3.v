...
module FAU ( 
  ...
  nand3  g28(.a(new_n47_), .b(new_n29_), .c(new_n20_), .O(new_n48_));
  ...
  aoi22  g33(.a(new_n52_), .b(new_n51_), .c(new_n20_), .d(new_n43_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n49_), .c(new_n27_), .O(z2));
  inv1   g35(.a(x12), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n43_), .c(new_n20_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x11), .O(new_n57_));
  aoi21  g38(.a(new_n47_), .b(new_n29_), .c(new_n55_), .O(new_n58_));
  inv1   g39(.a(x10), .O(new_n59_));
  nand3  g40(.a(new_n55_), .b(new_n21_), .c(new_n59_), .O(new_n60_));
  nor2   g41(.a(new_n60_), .b(new_n30_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n58_), .c(x03), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n43_), .O(new_n64_));
  nand4  g45(.a(new_n64_), .b(new_n62_), .c(new_n57_), .d(new_n27_), .O(z3));
  nand4  g46(.a(new_n23_), .b(x13), .c(x09), .d(x04), .O(new_n66_));
