...
module FAU ( 
  ...
  oai21  g13(.a(new_n29_), .b(new_n20_), .c(new_n32_), .O(new_n33_));
  inv1   g14(.a(x08), .O(new_n34_));
  inv1   g15(.a(x10), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  oai21  g17(.a(new_n21_), .b(new_n29_), .c(new_n36_), .O(new_n37_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n33_), .c(new_n30_), .O(z1));
  ...
  oai21  g28(.a(new_n36_), .b(new_n24_), .c(x11), .O(new_n48_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n44_), .c(new_n35_), .d(new_n34_), .O(new_n54_));
  ...
  oai22  g43(.a(new_n21_), .b(new_n62_), .c(x05), .d(x01), .O(z4));
endmodule
