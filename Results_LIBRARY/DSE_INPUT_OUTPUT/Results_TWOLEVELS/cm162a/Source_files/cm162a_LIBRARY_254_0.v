...
module FAU ( 
  ...
  nand3  g26(.a(x07), .b(x04), .c(x02), .O(new_n46_));
  inv1   g27(.a(new_n46_), .O(new_n47_));
  nor3   g28(.a(x11), .b(x10), .c(x08), .O(new_n48_));
  aoi22  g29(.a(new_n48_), .b(new_n47_), .c(new_n36_), .d(x11), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n42_), .c(new_n45_), .O(z2));
  nor2   g31(.a(x07), .b(x03), .O(new_n51_));
  and2   g32(.a(x12), .b(x03), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x11), .O(new_n53_));
  nand2  g34(.a(new_n36_), .b(x12), .O(new_n54_));
  ...
  nand3  g41(.a(new_n60_), .b(new_n53_), .c(new_n25_), .O(z3));
  nand3  g42(.a(new_n21_), .b(x13), .c(x09), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n55_), .O(z4));
endmodule
