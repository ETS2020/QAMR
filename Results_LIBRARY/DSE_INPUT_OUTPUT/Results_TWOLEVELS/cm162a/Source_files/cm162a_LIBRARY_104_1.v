...
module FAU ( 
  ...
  nand4  g11(.a(new_n30_), .b(new_n27_), .c(x05), .d(x02), .O(z0));
  nor2   g12(.a(x10), .b(x08), .O(new_n32_));
  oai21  g13(.a(new_n32_), .b(new_n22_), .c(x04), .O(new_n33_));
  ...
  oai21  g17(.a(new_n36_), .b(new_n35_), .c(x02), .O(new_n37_));
  ...
  aoi21  g23(.a(new_n32_), .b(x04), .c(new_n40_), .O(new_n43_));
  ...
  nand3  g31(.a(new_n32_), .b(new_n50_), .c(new_n40_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n23_), .c(new_n20_), .O(new_n52_));
  nor2   g33(.a(x08), .b(new_n20_), .O(new_n53_));
  aoi21  g34(.a(x11), .b(new_n25_), .c(x10), .O(new_n54_));
  ...
  nand2  g38(.a(new_n57_), .b(new_n29_), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(x05), .d(x02), .O(z3));
  inv1   g40(.a(x05), .O(new_n60_));
  oai22  g41(.a(new_n21_), .b(new_n20_), .c(new_n60_), .d(x02), .O(z4));
endmodule
