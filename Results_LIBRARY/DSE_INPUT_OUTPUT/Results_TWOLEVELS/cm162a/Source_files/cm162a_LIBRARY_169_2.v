...
module FAU ( 
  ...
  nor2   g02(.a(x07), .b(new_n21_), .O(new_n22_));
  ...
  aoi21  g16(.a(new_n25_), .b(new_n21_), .c(new_n22_), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n35_), .c(new_n29_), .O(z0));
  ...
  nand2  g22(.a(new_n33_), .b(x10), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(x03), .O(new_n44_));
  inv1   g25(.a(x01), .O(new_n45_));
  aoi21  g26(.a(new_n25_), .b(new_n45_), .c(new_n20_), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n44_), .c(new_n22_), .O(z1));
  inv1   g28(.a(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n38_), .c(new_n32_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n27_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x04), .c(x02), .O(new_n51_));
  oai21  g32(.a(new_n39_), .b(new_n30_), .c(x11), .O(new_n52_));
  ...
  oai21  g39(.a(new_n25_), .b(x00), .c(new_n58_), .O(new_n59_));
  inv1   g40(.a(x12), .O(new_n60_));
  nor2   g41(.a(new_n49_), .b(new_n30_), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g43(.a(new_n60_), .b(new_n48_), .c(new_n38_), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(new_n33_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n62_), .c(x03), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n59_), .c(new_n29_), .O(z3));
  nand4  g47(.a(new_n23_), .b(x13), .c(x09), .d(x04), .O(new_n67_));
