...
module FAU ( 
  ...
  nor2   g10(.a(x12), .b(x01), .O(new_n30_));
  ...
  oai21  g15(.a(new_n34_), .b(new_n20_), .c(new_n33_), .O(new_n35_));
  oai21  g16(.a(x10), .b(x08), .c(new_n22_), .O(new_n36_));
  ...
  nand3  g22(.a(new_n41_), .b(new_n35_), .c(x05), .O(z1));
