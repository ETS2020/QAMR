...
module FAU ( 
  ...
  oai21  g19(.a(new_n38_), .b(new_n37_), .c(x12), .O(new_n39_));
  ...
  oai21  g25(.a(new_n32_), .b(new_n21_), .c(x11), .O(new_n45_));
  ...
  inv1   g31(.a(new_n23_), .O(new_n51_));
  nand2  g32(.a(new_n41_), .b(new_n31_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n30_), .c(new_n51_), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n30_), .c(x04), .d(x02), .O(new_n54_));
  nor2   g35(.a(x07), .b(x03), .O(new_n55_));
  aoi21  g36(.a(new_n54_), .b(x03), .c(new_n55_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n50_), .c(x05), .O(z3));
  inv1   g38(.a(x04), .O(new_n58_));
  inv1   g39(.a(x05), .O(new_n59_));
  oai22  g40(.a(new_n23_), .b(new_n58_), .c(x12), .d(new_n59_), .O(z4));
endmodule
