...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n50_, new_n52_, new_n53_, new_n54_, new_n55_;
  ...
  nor3   g09(.a(new_n28_), .b(x12), .c(new_n27_), .O(new_n29_));
  ...
  nand2  g25(.a(new_n44_), .b(new_n34_), .O(new_n45_));
  nand3  g26(.a(new_n45_), .b(x04), .c(x02), .O(new_n46_));
  oai21  g27(.a(new_n33_), .b(new_n25_), .c(x11), .O(new_n47_));
  ...
  nand4  g33(.a(new_n45_), .b(new_n22_), .c(x04), .d(x03), .O(new_n53_));
  nor2   g34(.a(x07), .b(x03), .O(new_n54_));
  nor3   g35(.a(new_n54_), .b(x12), .c(new_n27_), .O(new_n55_));
  oai21  g36(.a(new_n53_), .b(new_n52_), .c(new_n55_), .O(z3));
  oai22  g37(.a(new_n34_), .b(new_n21_), .c(new_n22_), .d(new_n27_), .O(z4));
endmodule
