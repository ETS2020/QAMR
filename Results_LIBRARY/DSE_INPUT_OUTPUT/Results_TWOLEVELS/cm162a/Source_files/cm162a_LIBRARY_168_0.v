...
module FAU ( 
  ...
  nand3  g37(.a(new_n56_), .b(new_n47_), .c(new_n36_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n23_), .c(new_n24_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  nand4  g40(.a(new_n26_), .b(new_n47_), .c(new_n36_), .d(new_n22_), .O(new_n60_));
  ...
  nor2   g44(.a(x07), .b(new_n30_), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(new_n20_), .c(new_n33_), .O(new_n65_));
