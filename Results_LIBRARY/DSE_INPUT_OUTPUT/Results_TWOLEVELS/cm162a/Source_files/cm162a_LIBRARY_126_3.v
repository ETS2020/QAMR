...
module FAU ( 
  ...
  nand4  g13(.a(new_n24_), .b(new_n21_), .c(x04), .d(x02), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(new_n21_), .O(new_n34_));
  nand2  g15(.a(new_n34_), .b(x03), .O(new_n35_));
  nand2  g16(.a(x05), .b(x01), .O(new_n36_));
  aoi22  g17(.a(new_n36_), .b(new_n22_), .c(new_n21_), .d(new_n20_), .O(new_n37_));
  ...
  nand3  g24(.a(new_n39_), .b(x04), .c(x02), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(x11), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n43_), .c(new_n22_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n20_), .c(new_n21_), .O(new_n47_));
  ...
  oai21  g35(.a(new_n41_), .b(new_n26_), .c(x12), .O(new_n55_));
