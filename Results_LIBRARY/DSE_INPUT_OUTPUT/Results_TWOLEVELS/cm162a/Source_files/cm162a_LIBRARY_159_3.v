...
module FAU ( 
  ...
  nand3  g08(.a(new_n27_), .b(x13), .c(x09), .O(new_n28_));
  aoi21  g09(.a(new_n28_), .b(new_n26_), .c(new_n24_), .O(new_n29_));
  oai21  g10(.a(x03), .b(x00), .c(x05), .O(new_n30_));
  oai21  g11(.a(new_n30_), .b(new_n29_), .c(new_n23_), .O(new_n31_));
  inv1   g12(.a(x10), .O(new_n32_));
  oai21  g13(.a(x12), .b(new_n32_), .c(new_n20_), .O(new_n33_));
  aoi21  g14(.a(new_n33_), .b(x12), .c(x08), .O(new_n34_));
  nand4  g15(.a(new_n34_), .b(x04), .c(x03), .d(x02), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(new_n31_), .O(z0));
  ...
  aoi21  g27(.a(new_n24_), .b(new_n45_), .c(new_n46_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n44_), .c(new_n22_), .O(z1));
  nand3  g29(.a(x13), .b(x09), .c(x04), .O(new_n49_));
  inv1   g30(.a(new_n49_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(x03), .c(x02), .O(new_n51_));
  and2   g32(.a(new_n51_), .b(x05), .O(new_n52_));
  aoi21  g33(.a(new_n21_), .b(x10), .c(x08), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n27_), .c(new_n20_), .O(new_n54_));
  nand3  g35(.a(new_n20_), .b(new_n32_), .c(new_n40_), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n25_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n54_), .c(x03), .O(new_n57_));
  inv1   g38(.a(x06), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n24_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n57_), .c(new_n52_), .d(new_n23_), .O(z2));
  oai21  g41(.a(x07), .b(x03), .c(new_n51_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n46_), .c(new_n23_), .O(new_n62_));
  xnor2a g43(.a(x12), .b(x10), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n40_), .c(x04), .d(x02), .O(new_n64_));
  nand2  g45(.a(new_n41_), .b(x12), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g47(.a(new_n66_), .b(new_n20_), .c(x03), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n62_), .O(z3));
  nand2  g49(.a(new_n49_), .b(new_n23_), .O(z4));
endmodule
