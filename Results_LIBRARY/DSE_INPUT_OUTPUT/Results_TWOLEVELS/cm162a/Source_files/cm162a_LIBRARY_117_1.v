...
module FAU ( 
  ...
  nand4  g23(.a(new_n38_), .b(new_n24_), .c(x04), .d(x02), .O(new_n43_));
  ...
  nor2   g27(.a(x11), .b(x05), .O(new_n47_));
  ...
  nand2  g34(.a(new_n43_), .b(new_n39_), .O(new_n54_));
  nand2  g35(.a(x11), .b(x05), .O(new_n55_));
  ...
  nand2  g41(.a(x11), .b(new_n28_), .O(new_n61_));
