...
module FAU ( 
  ...
  nand2  g17(.a(new_n28_), .b(x10), .O(new_n37_));
  ...
  aoi21  g24(.a(new_n43_), .b(new_n39_), .c(new_n20_), .O(z1));
  inv1   g25(.a(x11), .O(new_n45_));
  nor2   g26(.a(x10), .b(x08), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n27_), .c(new_n45_), .O(new_n47_));
  nor3   g28(.a(x11), .b(x10), .c(x08), .O(new_n48_));
  and2   g29(.a(new_n48_), .b(new_n27_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n47_), .c(x03), .O(new_n50_));
  nor2   g31(.a(x06), .b(x03), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n50_), .c(new_n25_), .O(z2));
  inv1   g34(.a(x07), .O(new_n54_));
  inv1   g35(.a(x12), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n41_), .c(new_n54_), .O(new_n56_));
  aoi21  g37(.a(new_n48_), .b(new_n27_), .c(new_n55_), .O(new_n57_));
  nand2  g38(.a(new_n55_), .b(new_n45_), .O(new_n58_));
  nor3   g39(.a(new_n58_), .b(new_n28_), .c(x10), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n57_), .c(x03), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n56_), .c(new_n25_), .O(z3));
  nand2  g42(.a(new_n23_), .b(new_n21_), .O(z4));
endmodule
