...
module FAU ( 
  ...
  nand3  g36(.a(new_n49_), .b(new_n55_), .c(new_n45_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n32_), .c(new_n43_), .O(new_n57_));
  ...
  oai22  g44(.a(new_n21_), .b(new_n43_), .c(x06), .d(x05), .O(z4));
endmodule
