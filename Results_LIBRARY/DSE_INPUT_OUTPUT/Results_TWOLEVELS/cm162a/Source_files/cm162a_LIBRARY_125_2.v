...
module FAU ( 
  ...
  nand4  g29(.a(new_n33_), .b(new_n22_), .c(x04), .d(x02), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(x11), .c(new_n40_), .O(new_n50_));
  ...
  nand4  g37(.a(new_n56_), .b(new_n45_), .c(new_n33_), .d(new_n22_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n44_), .O(new_n58_));
  ...
  aoi21  g42(.a(new_n61_), .b(x12), .c(new_n40_), .O(new_n62_));
  ...
  oai22  g49(.a(new_n44_), .b(new_n68_), .c(x03), .d(new_n20_), .O(z4));
endmodule
