...
module FAU ( 
  ...
  oai22  g35(.a(new_n54_), .b(new_n35_), .c(new_n21_), .d(new_n29_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  aoi21  g37(.a(new_n44_), .b(new_n34_), .c(new_n29_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n38_), .c(x12), .O(new_n58_));
  ...
  nand2  g44(.a(x13), .b(x04), .O(new_n64_));
  aoi21  g45(.a(new_n64_), .b(x05), .c(new_n30_), .O(z4));
endmodule
