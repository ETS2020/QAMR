...
module FAU ( 
  ...
  oai21  g18(.a(new_n37_), .b(new_n20_), .c(new_n22_), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(x08), .O(new_n39_));
  nand2  g20(.a(new_n25_), .b(x10), .O(new_n40_));
  inv1   g21(.a(x08), .O(new_n41_));
  nand2  g22(.a(new_n37_), .b(new_n41_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n25_), .c(new_n40_), .O(new_n43_));
  ...
  nand3  g36(.a(new_n22_), .b(x11), .c(x08), .O(new_n56_));
  inv1   g37(.a(new_n56_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n55_), .c(x03), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n50_), .O(z2));
  and2   g40(.a(new_n54_), .b(x12), .O(new_n60_));
  nand3  g41(.a(new_n41_), .b(x04), .c(x02), .O(new_n61_));
  nand3  g42(.a(new_n22_), .b(new_n53_), .c(new_n37_), .O(new_n62_));
  nor2   g43(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  oai21  g44(.a(new_n63_), .b(new_n60_), .c(x03), .O(new_n64_));
  inv1   g45(.a(x07), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n20_), .O(new_n66_));
  nand4  g47(.a(new_n66_), .b(new_n64_), .c(new_n36_), .d(new_n27_), .O(z3));
  nand4  g48(.a(new_n27_), .b(x13), .c(x09), .d(x04), .O(new_n68_));
