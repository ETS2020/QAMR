...
module FAU ( 
  ...
  oai21  g35(.a(new_n54_), .b(new_n35_), .c(new_n21_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  oai21  g37(.a(new_n45_), .b(new_n24_), .c(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x05), .c(x03), .O(new_n59_));
  oai21  g40(.a(new_n29_), .b(new_n20_), .c(new_n30_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n59_), .O(z3));
  nand2  g42(.a(x07), .b(new_n29_), .O(new_n62_));
