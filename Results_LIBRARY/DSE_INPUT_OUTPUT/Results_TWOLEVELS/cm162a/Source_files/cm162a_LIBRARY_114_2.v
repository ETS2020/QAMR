...
module FAU ( 
  ...
  aoi21  g29(.a(new_n48_), .b(new_n35_), .c(new_n31_), .O(new_n49_));
  nor2   g30(.a(x10), .b(x08), .O(new_n50_));
  nor2   g31(.a(new_n31_), .b(new_n24_), .O(new_n51_));
  ...
  nand3  g38(.a(new_n50_), .b(new_n57_), .c(new_n47_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n35_), .c(new_n31_), .O(new_n59_));
  nor3   g40(.a(x11), .b(x10), .c(x08), .O(new_n60_));
  aoi21  g41(.a(new_n51_), .b(new_n60_), .c(new_n57_), .O(new_n61_));
  aoi21  g42(.a(new_n59_), .b(x02), .c(new_n61_), .O(new_n62_));
  inv1   g43(.a(x07), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n43_), .c(new_n20_), .O(new_n64_));
  oai21  g45(.a(new_n62_), .b(new_n43_), .c(new_n64_), .O(z3));
  aoi21  g46(.a(new_n21_), .b(x05), .c(new_n31_), .O(z4));
endmodule
