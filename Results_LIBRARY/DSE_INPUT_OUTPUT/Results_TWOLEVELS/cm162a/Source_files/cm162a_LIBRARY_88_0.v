...
module FAU ( 
  ...
  oai21  g39(.a(new_n53_), .b(new_n42_), .c(new_n52_), .O(new_n59_));
  nor3   g40(.a(x11), .b(x10), .c(x08), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n27_), .c(new_n53_), .O(new_n61_));
  nand3  g42(.a(x07), .b(x04), .c(x02), .O(new_n62_));
  nand4  g43(.a(new_n53_), .b(new_n51_), .c(new_n35_), .d(new_n26_), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n61_), .c(x03), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n59_), .c(new_n25_), .O(z3));
  nand2  g47(.a(new_n23_), .b(new_n21_), .O(z4));
endmodule
