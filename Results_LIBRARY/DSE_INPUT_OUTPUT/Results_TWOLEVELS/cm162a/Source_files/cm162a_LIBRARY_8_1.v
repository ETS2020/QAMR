...
module FAU ( 
  ...
  nand3  g34(.a(new_n47_), .b(new_n53_), .c(new_n44_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n22_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  nand4  g37(.a(new_n25_), .b(new_n44_), .c(new_n43_), .d(new_n24_), .O(new_n57_));
  ...
  nor2   g41(.a(x07), .b(new_n29_), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n20_), .c(new_n40_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n60_), .O(z3));
  oai22  g44(.a(new_n32_), .b(new_n21_), .c(new_n53_), .d(x05), .O(z4));
endmodule
