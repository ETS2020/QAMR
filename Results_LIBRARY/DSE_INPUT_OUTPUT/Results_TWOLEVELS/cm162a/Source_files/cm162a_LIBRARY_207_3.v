...
module FAU ( 
  ...
  nand4  g28(.a(new_n47_), .b(new_n28_), .c(x04), .d(x02), .O(new_n48_));
  ...
  and2   g34(.a(new_n48_), .b(x12), .O(new_n54_));
  nand3  g35(.a(new_n21_), .b(new_n47_), .c(new_n20_), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n30_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n54_), .c(x03), .O(new_n57_));
  nor2   g38(.a(x07), .b(x03), .O(new_n58_));
  nor2   g39(.a(new_n58_), .b(new_n22_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n57_), .c(new_n27_), .O(z3));
