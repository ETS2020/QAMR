...
module FAU ( 
  ...
  oai21  g09(.a(x09), .b(x07), .c(x05), .O(new_n29_));
  ...
  oai22  g29(.a(x09), .b(x07), .c(x06), .d(x03), .O(new_n49_));
  ...
  aoi21  g38(.a(x09), .b(x03), .c(x07), .O(new_n58_));
  nor2   g39(.a(new_n58_), .b(new_n48_), .O(new_n59_));
