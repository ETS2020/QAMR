...
module FAU ( 
  ...
  aoi21  g26(.a(new_n45_), .b(x11), .c(new_n33_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x03), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x05), .c(new_n28_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n48_), .O(z2));
  inv1   g32(.a(x04), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n41_), .c(new_n40_), .d(new_n24_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n20_), .c(new_n52_), .O(new_n55_));
  nor3   g36(.a(x11), .b(x10), .c(x08), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n25_), .c(new_n53_), .O(new_n57_));
  aoi21  g38(.a(new_n55_), .b(x02), .c(new_n57_), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n28_), .c(new_n33_), .O(new_n60_));
  oai21  g41(.a(new_n58_), .b(new_n28_), .c(new_n60_), .O(z3));
  inv1   g42(.a(x09), .O(new_n62_));
  oai21  g43(.a(x05), .b(x03), .c(x13), .O(new_n63_));
  nor3   g44(.a(new_n63_), .b(new_n62_), .c(new_n52_), .O(z4));
endmodule
