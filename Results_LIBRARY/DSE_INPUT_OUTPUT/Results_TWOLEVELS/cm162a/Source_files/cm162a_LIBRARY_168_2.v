...
module FAU ( 
  ...
  aoi21  g28(.a(x13), .b(x10), .c(x08), .O(new_n48_));
  ...
  oai21  g32(.a(x06), .b(x03), .c(x13), .O(new_n52_));
  ...
  oai21  g39(.a(new_n44_), .b(new_n24_), .c(x12), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n58_), .c(new_n20_), .O(new_n60_));
  nor2   g41(.a(x07), .b(x03), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n60_), .c(x13), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(x05), .O(z3));
