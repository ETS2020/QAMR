...
module FAU ( 
  ...
  nand3  g27(.a(new_n46_), .b(x05), .c(x03), .O(new_n47_));
  inv1   g28(.a(x06), .O(new_n48_));
  oai21  g29(.a(new_n27_), .b(new_n20_), .c(new_n48_), .O(new_n49_));
  ...
  nand2  g39(.a(new_n48_), .b(new_n27_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n58_), .O(z3));
  nand2  g41(.a(x06), .b(new_n27_), .O(new_n61_));
