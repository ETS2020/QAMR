...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(new_n44_), .c(new_n22_), .d(x05), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n24_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(x04), .c(x02), .O(new_n48_));
  nand4  g29(.a(new_n44_), .b(new_n22_), .c(x04), .d(x02), .O(new_n49_));
  ...
  nor2   g33(.a(x06), .b(new_n29_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n20_), .c(new_n32_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  inv1   g36(.a(x12), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n45_), .c(new_n44_), .d(new_n22_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x04), .c(x02), .O(new_n59_));
  aoi21  g40(.a(new_n45_), .b(new_n44_), .c(new_n29_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n37_), .c(x12), .O(new_n61_));
