...
module FAU ( 
  ...
  aoi21  g19(.a(new_n28_), .b(x01), .c(x03), .O(new_n39_));
  aoi21  g20(.a(new_n28_), .b(new_n23_), .c(new_n39_), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n38_), .O(z1));
  inv1   g22(.a(x10), .O(new_n42_));
  nand3  g23(.a(new_n28_), .b(new_n42_), .c(new_n34_), .O(new_n43_));
  nand2  g24(.a(new_n43_), .b(new_n20_), .O(new_n44_));
  nand3  g25(.a(new_n44_), .b(x04), .c(x02), .O(new_n45_));
  nand4  g26(.a(new_n42_), .b(new_n34_), .c(x04), .d(x02), .O(new_n46_));
  ...
  nand4  g34(.a(new_n53_), .b(new_n28_), .c(new_n42_), .d(new_n34_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n20_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  nor2   g37(.a(x11), .b(x10), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n34_), .c(x04), .d(x02), .O(new_n58_));
  ...
  oai22  g46(.a(new_n20_), .b(new_n65_), .c(new_n28_), .d(x03), .O(z4));
endmodule
