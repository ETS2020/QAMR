...
module FAU ( 
  ...
  inv1   g21(.a(new_n24_), .O(new_n41_));
  ...
  aoi21  g30(.a(new_n42_), .b(new_n41_), .c(new_n49_), .O(new_n50_));
  inv1   g31(.a(x10), .O(new_n51_));
  nand3  g32(.a(new_n49_), .b(new_n51_), .c(new_n38_), .O(new_n52_));
  nor2   g33(.a(new_n52_), .b(new_n24_), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n50_), .c(x03), .O(new_n54_));
  nor2   g35(.a(x06), .b(x03), .O(new_n55_));
  nor2   g36(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n54_), .c(new_n37_), .O(z2));
  inv1   g38(.a(x07), .O(new_n58_));
  inv1   g39(.a(x12), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n29_), .c(new_n58_), .O(new_n60_));
  nor3   g41(.a(x11), .b(x10), .c(x08), .O(new_n61_));
  aoi21  g42(.a(new_n61_), .b(new_n41_), .c(new_n59_), .O(new_n62_));
  nand3  g43(.a(new_n59_), .b(new_n49_), .c(new_n51_), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(new_n39_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n62_), .c(x03), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n60_), .c(new_n37_), .O(z3));
  nand2  g47(.a(new_n35_), .b(new_n33_), .O(z4));
endmodule
