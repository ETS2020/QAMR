...
module FAU ( 
  ...
  aoi22  g08(.a(new_n27_), .b(x05), .c(new_n25_), .d(x02), .O(new_n28_));
  inv1   g09(.a(x00), .O(new_n29_));
  inv1   g10(.a(x05), .O(new_n30_));
  nor2   g11(.a(new_n30_), .b(x03), .O(new_n31_));
  inv1   g12(.a(x09), .O(new_n32_));
  nor2   g13(.a(new_n32_), .b(x05), .O(new_n33_));
  aoi21  g14(.a(new_n31_), .b(new_n29_), .c(new_n33_), .O(new_n34_));
  oai21  g15(.a(new_n28_), .b(new_n20_), .c(new_n34_), .O(z0));
  inv1   g16(.a(x10), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(new_n22_), .c(x05), .O(new_n37_));
  ...
  aoi21  g25(.a(new_n31_), .b(new_n44_), .c(new_n33_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z1));
  nor2   g27(.a(x11), .b(x10), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n22_), .c(x05), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n24_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(x04), .c(x02), .O(new_n50_));
  nand3  g31(.a(new_n26_), .b(new_n36_), .c(new_n22_), .O(new_n51_));
  ...
  nor2   g35(.a(x06), .b(new_n30_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n20_), .c(new_n33_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n54_), .O(z2));
  inv1   g38(.a(x11), .O(new_n58_));
  inv1   g39(.a(x12), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n58_), .c(new_n36_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n23_), .c(new_n24_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x04), .c(x02), .O(new_n62_));
  nand3  g43(.a(new_n47_), .b(new_n26_), .c(new_n22_), .O(new_n63_));
  ...
  nor2   g47(.a(x07), .b(new_n30_), .O(new_n67_));
  aoi21  g48(.a(new_n67_), .b(new_n20_), .c(new_n33_), .O(new_n68_));
