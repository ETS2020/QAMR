...
module FAU ( 
  ...
  aoi21  g19(.a(new_n28_), .b(new_n38_), .c(new_n23_), .O(new_n39_));
  ...
  nand3  g43(.a(new_n62_), .b(x05), .c(new_n28_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  inv1   g46(.a(x09), .O(new_n66_));
  oai21  g47(.a(x05), .b(x03), .c(x13), .O(new_n67_));
  nor3   g48(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z4));
endmodule
