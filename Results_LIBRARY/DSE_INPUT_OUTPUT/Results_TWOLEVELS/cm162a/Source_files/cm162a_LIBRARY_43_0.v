...
module FAU ( 
  ...
  nand2  g09(.a(new_n28_), .b(x12), .O(new_n29_));
  ...
  aoi22  g20(.a(new_n39_), .b(new_n38_), .c(x12), .d(new_n23_), .O(new_n40_));
  ...
  nand4  g27(.a(new_n42_), .b(new_n33_), .c(x04), .d(x02), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(x11), .c(new_n23_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x03), .O(new_n50_));
  nand2  g31(.a(x12), .b(x06), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(new_n38_), .c(x12), .d(new_n23_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n50_), .O(z2));
  inv1   g34(.a(x12), .O(new_n54_));
  nand4  g35(.a(new_n54_), .b(new_n43_), .c(new_n42_), .d(new_n33_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  nor2   g38(.a(x11), .b(x10), .O(new_n58_));
  nand4  g39(.a(new_n58_), .b(new_n33_), .c(x04), .d(x02), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(x12), .c(new_n23_), .O(new_n60_));
  ...
  oai22  g47(.a(new_n20_), .b(new_n66_), .c(x12), .d(x03), .O(z4));
endmodule
