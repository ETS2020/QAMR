...
module FAU ( 
  ...
  aoi21  g28(.a(new_n21_), .b(new_n46_), .c(new_n47_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n45_), .c(new_n37_), .O(z1));
  nand4  g30(.a(new_n26_), .b(x04), .c(x03), .d(x02), .O(new_n50_));
  ...
  nand3  g38(.a(new_n25_), .b(new_n41_), .c(new_n31_), .O(new_n58_));
  aoi22  g39(.a(new_n58_), .b(x11), .c(new_n31_), .d(new_n21_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n57_), .c(new_n52_), .O(z2));
  oai21  g41(.a(x07), .b(x03), .c(new_n50_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n47_), .c(new_n20_), .O(new_n62_));
  nand4  g43(.a(new_n32_), .b(new_n41_), .c(x04), .d(x02), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(x12), .O(new_n64_));
  nor2   g45(.a(x12), .b(x10), .O(new_n65_));
  nand4  g46(.a(new_n65_), .b(new_n41_), .c(x04), .d(x02), .O(new_n66_));
  aoi21  g47(.a(new_n66_), .b(new_n64_), .c(x11), .O(new_n67_));
  nand2  g48(.a(x12), .b(x11), .O(new_n68_));
  nor2   g49(.a(new_n68_), .b(x06), .O(new_n69_));
  oai21  g50(.a(new_n69_), .b(new_n67_), .c(x03), .O(new_n70_));
  nand2  g51(.a(new_n70_), .b(new_n62_), .O(z3));
