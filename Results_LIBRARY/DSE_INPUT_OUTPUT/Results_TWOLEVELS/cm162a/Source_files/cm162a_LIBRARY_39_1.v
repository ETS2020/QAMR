...
module FAU ( 
  ...
  nand2  g26(.a(new_n26_), .b(x04), .O(new_n46_));
  ...
  nand4  g31(.a(new_n50_), .b(new_n39_), .c(x04), .d(x02), .O(new_n51_));
  nand2  g32(.a(new_n40_), .b(x11), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x03), .O(new_n54_));
  oai21  g35(.a(x11), .b(new_n22_), .c(new_n20_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n54_), .c(new_n48_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n22_), .c(x06), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x11), .O(new_n59_));
