...
module FAU ( 
  ...
  aoi21  g19(.a(new_n28_), .b(new_n37_), .c(new_n38_), .O(new_n39_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n28_), .c(new_n38_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n28_), .c(new_n50_), .O(z2));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n43_), .c(new_n42_), .d(new_n24_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n20_), .c(new_n41_), .O(new_n54_));
  ...
  aoi21  g39(.a(new_n58_), .b(new_n28_), .c(new_n38_), .O(new_n59_));
  oai21  g40(.a(new_n57_), .b(new_n28_), .c(new_n59_), .O(z3));
  inv1   g41(.a(x09), .O(new_n61_));
  oai21  g42(.a(x05), .b(x03), .c(x13), .O(new_n62_));
