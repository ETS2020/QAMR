...
module FAU ( 
  ...
  and2   g25(.a(new_n37_), .b(x11), .O(new_n45_));
  oai21  g26(.a(new_n45_), .b(new_n43_), .c(new_n44_), .O(new_n46_));
  nor3   g27(.a(x11), .b(x10), .c(x08), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(x04), .c(x03), .d(x02), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n46_), .c(new_n25_), .O(z2));
  inv1   g30(.a(x05), .O(new_n50_));
  oai21  g31(.a(x07), .b(x03), .c(new_n23_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(new_n20_), .O(new_n52_));
  nand2  g33(.a(new_n37_), .b(x12), .O(new_n53_));
  nor2   g34(.a(x12), .b(x10), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n27_), .c(new_n26_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n53_), .c(x11), .O(new_n56_));
  nand2  g37(.a(x12), .b(x11), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(x06), .O(new_n58_));
