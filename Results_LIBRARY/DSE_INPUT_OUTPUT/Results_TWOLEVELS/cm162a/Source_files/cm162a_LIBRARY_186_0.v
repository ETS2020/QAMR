...
module FAU ( 
  ...
  nor2   g34(.a(new_n42_), .b(new_n24_), .O(new_n54_));
  nor2   g35(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  aoi21  g36(.a(new_n53_), .b(x02), .c(new_n55_), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n20_), .c(new_n27_), .O(new_n58_));
  oai21  g39(.a(new_n56_), .b(new_n20_), .c(new_n58_), .O(z3));
  oai22  g40(.a(new_n40_), .b(new_n21_), .c(x06), .d(x05), .O(z4));
endmodule
