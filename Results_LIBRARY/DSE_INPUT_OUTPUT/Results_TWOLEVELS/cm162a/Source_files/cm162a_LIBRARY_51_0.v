...
module FAU ( 
  ...
  nor2   g20(.a(x05), .b(new_n21_), .O(new_n40_));
  ...
  nand3  g28(.a(new_n25_), .b(new_n43_), .c(new_n24_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x11), .c(x05), .O(new_n49_));
  ...
  nand4  g39(.a(new_n25_), .b(new_n44_), .c(new_n43_), .d(new_n24_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x12), .c(x05), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x03), .O(new_n62_));
  nor2   g43(.a(x07), .b(new_n29_), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(new_n20_), .c(new_n40_), .O(new_n64_));
