...
module FAU ( 
  ...
  oai22  g14(.a(new_n21_), .b(new_n33_), .c(x10), .d(x08), .O(new_n34_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n29_), .c(new_n36_), .O(new_n43_));
  ...
  aoi21  g27(.a(new_n46_), .b(new_n45_), .c(new_n33_), .O(new_n47_));
  nor2   g28(.a(new_n42_), .b(new_n29_), .O(new_n48_));
  oai21  g29(.a(new_n48_), .b(new_n47_), .c(x03), .O(new_n49_));
  nor2   g30(.a(x06), .b(new_n33_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n30_), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n49_), .O(z2));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n42_), .c(new_n29_), .d(new_n36_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n21_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  nand2  g37(.a(new_n42_), .b(new_n36_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n24_), .c(x12), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(new_n33_), .O(new_n59_));
  nor2   g40(.a(new_n53_), .b(new_n29_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(x03), .O(new_n61_));
  nor2   g42(.a(x07), .b(new_n33_), .O(new_n62_));
  aoi21  g43(.a(new_n62_), .b(new_n20_), .c(new_n30_), .O(new_n63_));
  nand2  g44(.a(new_n63_), .b(new_n61_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  oai22  g46(.a(new_n21_), .b(new_n65_), .c(x10), .d(x05), .O(z4));
endmodule
