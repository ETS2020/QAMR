...
module FAU ( 
  ...
  nand3  g27(.a(new_n46_), .b(new_n39_), .c(new_n33_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n29_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x04), .c(x02), .O(new_n49_));
  nand2  g30(.a(new_n39_), .b(new_n33_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n22_), .c(x11), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(x03), .O(new_n53_));
  inv1   g34(.a(x06), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n25_), .c(new_n20_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n53_), .c(new_n45_), .O(z2));
  xnor2a g37(.a(x12), .b(x11), .O(new_n57_));
  and2   g38(.a(x12), .b(x10), .O(new_n58_));
  aoi21  g39(.a(new_n57_), .b(new_n39_), .c(new_n58_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(x08), .c(new_n29_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x04), .c(x02), .O(new_n61_));
  nand2  g42(.a(new_n34_), .b(x12), .O(new_n62_));
  ...
  nand3  g47(.a(new_n66_), .b(new_n64_), .c(new_n45_), .O(z3));
