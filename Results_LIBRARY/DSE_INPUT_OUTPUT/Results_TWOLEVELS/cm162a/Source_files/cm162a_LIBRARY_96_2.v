...
module FAU ( 
  ...
  oai21  g18(.a(new_n35_), .b(new_n25_), .c(new_n37_), .O(new_n38_));
  nor2   g19(.a(x03), .b(x01), .O(new_n39_));
  aoi21  g20(.a(new_n38_), .b(x03), .c(new_n39_), .O(new_n40_));
  oai21  g21(.a(new_n40_), .b(new_n30_), .c(x05), .O(z1));
  ...
  aoi21  g26(.a(new_n34_), .b(new_n26_), .c(new_n43_), .O(new_n46_));
  aoi21  g27(.a(new_n45_), .b(x02), .c(new_n46_), .O(new_n47_));
  oai21  g28(.a(x06), .b(x03), .c(x09), .O(new_n48_));
  nor2   g29(.a(new_n48_), .b(new_n29_), .O(new_n49_));
  oai21  g30(.a(new_n47_), .b(new_n20_), .c(new_n49_), .O(z2));
  inv1   g31(.a(x12), .O(new_n51_));
  nand3  g32(.a(new_n34_), .b(new_n51_), .c(new_n43_), .O(new_n52_));
  ...
  oai21  g37(.a(x07), .b(x03), .c(x09), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(new_n29_), .O(new_n58_));
