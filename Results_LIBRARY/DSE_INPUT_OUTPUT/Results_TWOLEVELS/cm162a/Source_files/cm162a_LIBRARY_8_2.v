...
module FAU ( 
  ...
  nand4  g04(.a(new_n23_), .b(x12), .c(x04), .d(x02), .O(new_n24_));
  ...
  nand4  g10(.a(new_n29_), .b(new_n26_), .c(x12), .d(x05), .O(z0));
  ...
  nand4  g25(.a(new_n44_), .b(x12), .c(x04), .d(x02), .O(new_n45_));
  nand3  g26(.a(new_n21_), .b(new_n41_), .c(new_n20_), .O(new_n46_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n49_), .c(new_n40_), .d(x05), .O(z2));
  and2   g33(.a(x13), .b(x09), .O(new_n53_));
  nand2  g34(.a(new_n42_), .b(new_n41_), .O(new_n54_));
  ...
  oai21  g39(.a(new_n58_), .b(new_n39_), .c(x05), .O(z3));
  inv1   g40(.a(x04), .O(new_n60_));
  oai21  g41(.a(new_n22_), .b(new_n60_), .c(new_n40_), .O(z4));
endmodule
