...
module FAU ( 
  ...
  oai21  g25(.a(new_n44_), .b(new_n21_), .c(x05), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n20_), .O(new_n46_));
  inv1   g27(.a(x06), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(x02), .c(new_n21_), .O(new_n48_));
  inv1   g29(.a(x04), .O(new_n49_));
  nor2   g30(.a(x11), .b(x10), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n27_), .c(new_n49_), .O(new_n52_));
  nor2   g33(.a(new_n44_), .b(new_n33_), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n52_), .c(x02), .O(new_n54_));
  aoi21  g35(.a(new_n22_), .b(x04), .c(new_n44_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n40_), .c(x03), .O(new_n56_));
  nand4  g37(.a(new_n56_), .b(new_n54_), .c(new_n48_), .d(new_n46_), .O(z2));
  nand2  g38(.a(x13), .b(x09), .O(new_n58_));
  inv1   g39(.a(x12), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n44_), .c(new_n33_), .d(new_n22_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(x04), .c(x02), .O(new_n62_));
  nand4  g43(.a(new_n50_), .b(new_n22_), .c(x04), .d(x02), .O(new_n63_));
  aoi21  g44(.a(new_n63_), .b(x12), .c(new_n40_), .O(new_n64_));
  ...
  nand2  g50(.a(new_n21_), .b(x02), .O(new_n70_));
