...
module FAU ( 
  ...
  nand3  g16(.a(new_n35_), .b(new_n33_), .c(new_n27_), .O(z0));
  ...
  nor2   g23(.a(new_n42_), .b(new_n22_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n41_), .c(new_n27_), .O(z1));
  inv1   g25(.a(x11), .O(new_n45_));
  aoi21  g26(.a(new_n38_), .b(new_n30_), .c(new_n45_), .O(new_n46_));
  inv1   g27(.a(x10), .O(new_n47_));
  nand3  g28(.a(new_n45_), .b(new_n47_), .c(new_n28_), .O(new_n48_));
  nor2   g29(.a(new_n48_), .b(new_n29_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n46_), .c(x03), .O(new_n50_));
  nor2   g31(.a(x06), .b(x03), .O(new_n51_));
  nor2   g32(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n50_), .c(new_n27_), .O(z2));
  inv1   g34(.a(x03), .O(new_n54_));
  nor3   g35(.a(x11), .b(x10), .c(x08), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n30_), .c(new_n21_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n54_), .c(new_n20_), .O(new_n57_));
  nand3  g38(.a(x04), .b(x03), .c(x02), .O(new_n58_));
  inv1   g39(.a(new_n58_), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n38_), .c(new_n21_), .d(new_n45_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n57_), .c(new_n27_), .O(z3));
  nand2  g42(.a(new_n25_), .b(new_n23_), .O(z4));
endmodule
