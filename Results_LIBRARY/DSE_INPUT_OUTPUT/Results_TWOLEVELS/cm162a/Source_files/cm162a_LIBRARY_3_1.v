...
module FAU ( 
  ...
  aoi21  g20(.a(new_n39_), .b(new_n37_), .c(new_n20_), .O(new_n40_));
  nor2   g21(.a(x03), .b(x01), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n40_), .c(x05), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n31_), .O(z1));
  ...
  oai21  g28(.a(new_n35_), .b(new_n24_), .c(x11), .O(new_n48_));
  ...
  nand2  g33(.a(new_n30_), .b(new_n44_), .O(new_n53_));
  oai22  g34(.a(new_n53_), .b(new_n35_), .c(new_n21_), .d(new_n29_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  aoi21  g36(.a(new_n44_), .b(new_n34_), .c(new_n29_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n38_), .c(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x03), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n20_), .c(new_n29_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(z3));
  inv1   g43(.a(x04), .O(new_n63_));
  oai22  g44(.a(new_n21_), .b(new_n63_), .c(new_n30_), .d(x05), .O(z4));
endmodule
