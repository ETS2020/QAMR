...
module FAU ( 
  ...
  oai21  g06(.a(new_n25_), .b(new_n24_), .c(x08), .O(new_n26_));
  nand4  g07(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n27_));
  ...
  nand2  g22(.a(x12), .b(new_n41_), .O(new_n42_));
  ...
  nor4   g29(.a(new_n48_), .b(new_n25_), .c(new_n23_), .d(new_n24_), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n47_), .c(new_n22_), .O(new_n50_));
  nand2  g31(.a(x11), .b(x10), .O(new_n51_));
  nand3  g32(.a(new_n20_), .b(new_n41_), .c(new_n40_), .O(new_n52_));
  ...
  nand3  g41(.a(new_n41_), .b(new_n40_), .c(new_n34_), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n48_), .O(new_n62_));
  ...
  nand2  g47(.a(new_n66_), .b(new_n23_), .O(new_n67_));
  nand3  g48(.a(new_n67_), .b(new_n22_), .c(x05), .O(new_n68_));
