...
module FAU ( 
  ...
  nor2   g06(.a(x07), .b(x00), .O(new_n26_));
  inv1   g07(.a(new_n26_), .O(new_n27_));
  oai21  g08(.a(new_n25_), .b(new_n20_), .c(new_n27_), .O(new_n28_));
  inv1   g09(.a(x00), .O(new_n29_));
  inv1   g10(.a(x07), .O(new_n30_));
  oai21  g11(.a(new_n30_), .b(new_n22_), .c(new_n29_), .O(new_n31_));
  ...
  nand3  g18(.a(new_n37_), .b(new_n31_), .c(new_n28_), .O(z0));
  ...
  aoi21  g28(.a(new_n47_), .b(new_n45_), .c(new_n26_), .O(z1));
  ...
  aoi21  g38(.a(new_n57_), .b(new_n55_), .c(new_n26_), .O(z2));
  oai21  g39(.a(new_n22_), .b(new_n29_), .c(new_n30_), .O(new_n59_));
  inv1   g40(.a(x12), .O(new_n60_));
  nor2   g41(.a(new_n50_), .b(new_n32_), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g43(.a(new_n60_), .b(new_n49_), .c(new_n39_), .O(new_n63_));
  nor2   g44(.a(new_n63_), .b(new_n35_), .O(new_n64_));
  oai21  g45(.a(new_n64_), .b(new_n62_), .c(x03), .O(new_n65_));
  nand3  g46(.a(new_n65_), .b(new_n59_), .c(new_n28_), .O(z3));
  nand3  g47(.a(new_n27_), .b(x13), .c(x09), .O(new_n67_));
  nor2   g48(.a(new_n67_), .b(new_n23_), .O(z4));
endmodule
