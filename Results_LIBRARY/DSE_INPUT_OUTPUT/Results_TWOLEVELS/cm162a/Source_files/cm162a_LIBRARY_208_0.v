...
module FAU ( 
  ...
  oai21  g05(.a(new_n24_), .b(new_n23_), .c(x08), .O(new_n25_));
  nor2   g06(.a(new_n24_), .b(new_n23_), .O(new_n26_));
  ...
  nor2   g11(.a(new_n20_), .b(x08), .O(new_n31_));
  ...
  aoi21  g17(.a(new_n36_), .b(new_n27_), .c(new_n22_), .O(new_n37_));
  oai21  g18(.a(x03), .b(x01), .c(x05), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n37_), .c(new_n21_), .O(new_n39_));
  nor3   g20(.a(new_n20_), .b(x10), .c(x08), .O(new_n40_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n48_), .c(x11), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n47_), .c(new_n34_), .d(x04), .O(new_n51_));
  nand3  g32(.a(new_n26_), .b(new_n47_), .c(new_n34_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(x11), .O(new_n53_));
  oai21  g34(.a(new_n51_), .b(new_n23_), .c(new_n53_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x03), .O(new_n55_));
  nor2   g36(.a(x06), .b(x03), .O(new_n56_));
  nor2   g37(.a(new_n56_), .b(new_n20_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(new_n46_), .O(z2));
  nand2  g39(.a(x12), .b(x11), .O(new_n59_));
  inv1   g40(.a(x11), .O(new_n60_));
  nand3  g41(.a(new_n49_), .b(new_n60_), .c(x07), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n47_), .O(new_n63_));
  nand2  g44(.a(x12), .b(x10), .O(new_n64_));
  nand2  g45(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand4  g46(.a(new_n65_), .b(new_n34_), .c(x04), .d(x02), .O(new_n66_));
  nand2  g47(.a(new_n35_), .b(x12), .O(new_n67_));
  nand2  g48(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(x03), .O(new_n69_));
  nand3  g50(.a(x12), .b(new_n48_), .c(new_n22_), .O(new_n70_));
  nand3  g51(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z3));
  nand3  g52(.a(new_n21_), .b(x13), .c(x09), .O(new_n72_));
  nor2   g53(.a(new_n72_), .b(new_n24_), .O(z4));
endmodule
