...
module FAU ( 
  ...
  nand2  g25(.a(x11), .b(x03), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  inv1   g27(.a(x10), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n26_), .c(x04), .d(x02), .O(new_n48_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n46_), .c(new_n25_), .O(z2));
  ...
  aoi21  g42(.a(new_n61_), .b(new_n57_), .c(new_n44_), .O(new_n62_));
  ...
  nor2   g47(.a(new_n66_), .b(new_n58_), .O(z4));
endmodule
