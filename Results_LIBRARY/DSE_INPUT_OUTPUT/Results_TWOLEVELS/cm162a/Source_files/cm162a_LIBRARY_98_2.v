...
module FAU ( 
  ...
  nand4  g35(.a(new_n54_), .b(new_n41_), .c(new_n40_), .d(new_n20_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n43_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(x04), .c(x02), .O(new_n57_));
  inv1   g38(.a(x05), .O(new_n58_));
  aoi21  g39(.a(new_n41_), .b(new_n40_), .c(new_n58_), .O(new_n59_));
  oai21  g40(.a(new_n59_), .b(new_n33_), .c(x12), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n57_), .c(x05), .O(new_n61_));
