...
module FAU ( 
  ...
  nand2  g21(.a(new_n20_), .b(x07), .O(new_n41_));
  ...
  oai21  g30(.a(new_n49_), .b(new_n47_), .c(new_n46_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n20_), .O(new_n51_));
  nand2  g32(.a(new_n48_), .b(new_n27_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x11), .c(x03), .O(new_n53_));
  inv1   g34(.a(x06), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n32_), .O(new_n55_));
  nand4  g36(.a(new_n55_), .b(new_n53_), .c(new_n51_), .d(new_n25_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  aoi21  g38(.a(new_n48_), .b(new_n27_), .c(new_n57_), .O(new_n58_));
  nand2  g39(.a(x04), .b(x02), .O(new_n59_));
  nand3  g40(.a(new_n57_), .b(new_n40_), .c(new_n26_), .O(new_n60_));
  oai21  g41(.a(new_n60_), .b(new_n59_), .c(new_n46_), .O(new_n61_));
  oai21  g42(.a(new_n61_), .b(new_n58_), .c(new_n20_), .O(new_n62_));
  nand2  g43(.a(new_n46_), .b(new_n32_), .O(new_n63_));
  nand3  g44(.a(x12), .b(x11), .c(x03), .O(new_n64_));
  nand4  g45(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(new_n25_), .O(z3));
