...
module FAU ( 
  ...
  nor2   g20(.a(x11), .b(x06), .O(new_n40_));
  ...
  oai21  g26(.a(new_n45_), .b(new_n34_), .c(new_n44_), .O(new_n46_));
  nor2   g27(.a(x10), .b(x08), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n27_), .c(new_n45_), .O(new_n48_));
  nand3  g29(.a(x06), .b(x04), .c(x02), .O(new_n49_));
  inv1   g30(.a(new_n49_), .O(new_n50_));
  nor3   g31(.a(x11), .b(x10), .c(x08), .O(new_n51_));
  and2   g32(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n48_), .c(x03), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n46_), .c(new_n25_), .O(z2));
  ...
  nand2  g39(.a(new_n58_), .b(new_n45_), .O(new_n59_));
  nand2  g40(.a(new_n51_), .b(new_n27_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x12), .c(x03), .O(new_n61_));
  inv1   g42(.a(x07), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n34_), .O(new_n63_));
  nand4  g44(.a(new_n63_), .b(new_n61_), .c(new_n59_), .d(new_n25_), .O(z3));
  inv1   g45(.a(x04), .O(new_n65_));
  nand3  g46(.a(new_n21_), .b(x13), .c(x09), .O(new_n66_));
