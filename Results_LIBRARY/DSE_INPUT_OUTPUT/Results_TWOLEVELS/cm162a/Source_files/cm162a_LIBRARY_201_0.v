...
module FAU ( 
  ...
  aoi21  g15(.a(new_n34_), .b(x10), .c(new_n29_), .O(new_n35_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n25_), .c(new_n43_), .O(new_n45_));
  aoi21  g26(.a(new_n42_), .b(x02), .c(new_n45_), .O(new_n46_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n43_), .c(new_n50_), .d(new_n24_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  nand4  g35(.a(new_n40_), .b(new_n24_), .c(x04), .d(x02), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(x12), .c(new_n29_), .O(new_n56_));
  ...
  nor3   g44(.a(new_n63_), .b(new_n62_), .c(new_n21_), .O(z4));
endmodule
