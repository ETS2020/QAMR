...
module FAU ( 
  ...
  or2    g22(.a(new_n41_), .b(new_n40_), .O(z1));
  ...
  oai21  g34(.a(new_n53_), .b(new_n34_), .c(new_n35_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  nand2  g36(.a(new_n43_), .b(new_n33_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(x05), .c(new_n38_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n52_), .c(new_n55_), .O(new_n58_));
