...
module FAU ( 
  ...
  nand3  g33(.a(new_n47_), .b(new_n40_), .c(new_n44_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n21_), .O(new_n54_));
  inv1   g35(.a(new_n45_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n25_), .c(new_n40_), .O(new_n56_));
  ...
  oai22  g41(.a(new_n32_), .b(new_n21_), .c(new_n40_), .d(x05), .O(z4));
endmodule
