...
module FAU ( 
  ...
  nor2   g21(.a(x12), .b(x05), .O(new_n41_));
  ...
  nand4  g29(.a(new_n44_), .b(new_n34_), .c(x04), .d(x02), .O(new_n49_));
  ...
  nand2  g33(.a(new_n28_), .b(x06), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n39_), .c(new_n41_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n52_), .O(z2));
  nand4  g36(.a(new_n28_), .b(new_n45_), .c(new_n44_), .d(new_n34_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n20_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(x04), .c(x02), .O(new_n58_));
  nor2   g39(.a(x11), .b(x10), .O(new_n59_));
  nand4  g40(.a(new_n59_), .b(new_n34_), .c(x04), .d(x02), .O(new_n60_));
  ...
  oai22  g48(.a(new_n20_), .b(new_n67_), .c(new_n28_), .d(x03), .O(z4));
endmodule
