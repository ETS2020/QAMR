...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x09), .O(new_n20_));
  ...
  nand3  g09(.a(x04), .b(x03), .c(x02), .O(new_n29_));
  inv1   g10(.a(x10), .O(new_n30_));
  nand3  g11(.a(x13), .b(new_n30_), .c(x09), .O(new_n31_));
  oai21  g12(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(z0));
  nand2  g13(.a(x13), .b(x09), .O(new_n33_));
  nand2  g14(.a(new_n33_), .b(x08), .O(new_n34_));
  nand4  g15(.a(new_n34_), .b(new_n30_), .c(x04), .d(x02), .O(new_n35_));
  nand2  g16(.a(new_n25_), .b(x10), .O(new_n36_));
  ...
  nand4  g21(.a(new_n40_), .b(new_n38_), .c(new_n20_), .d(x05), .O(z1));
  oai21  g22(.a(x11), .b(x08), .c(new_n33_), .O(new_n42_));
  nand4  g23(.a(new_n42_), .b(new_n30_), .c(x04), .d(x02), .O(new_n43_));
  nand2  g24(.a(new_n30_), .b(new_n24_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n22_), .c(x11), .O(new_n45_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n47_), .c(new_n20_), .d(x05), .O(z2));
  ...
  nand4  g35(.a(new_n54_), .b(new_n30_), .c(x04), .d(x02), .O(new_n55_));
  nand3  g36(.a(new_n51_), .b(new_n30_), .c(new_n24_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n22_), .c(x12), .O(new_n57_));
  ...
  nand4  g45(.a(x13), .b(new_n30_), .c(x09), .d(x04), .O(new_n65_));
