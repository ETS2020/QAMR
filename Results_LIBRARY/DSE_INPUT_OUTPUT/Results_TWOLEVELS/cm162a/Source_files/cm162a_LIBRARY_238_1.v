...
module FAU ( 
  ...
  oai21  g14(.a(new_n21_), .b(new_n30_), .c(new_n33_), .O(new_n34_));
  ...
  oai21  g25(.a(new_n33_), .b(new_n24_), .c(x11), .O(new_n45_));
  ...
  nand4  g31(.a(new_n50_), .b(new_n41_), .c(new_n32_), .d(new_n31_), .O(new_n51_));
  ...
  oai22  g41(.a(new_n21_), .b(new_n59_), .c(new_n60_), .d(x01), .O(z4));
endmodule
