...
module FAU ( 
  ...
  oai21  g36(.a(x11), .b(x10), .c(x05), .O(new_n56_));
  nand2  g37(.a(new_n34_), .b(new_n43_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  aoi22  g39(.a(new_n58_), .b(x12), .c(new_n55_), .d(x02), .O(new_n59_));
  nor2   g40(.a(x07), .b(new_n29_), .O(new_n60_));
  ...
  oai21  g44(.a(new_n43_), .b(x05), .c(new_n63_), .O(z4));
endmodule
