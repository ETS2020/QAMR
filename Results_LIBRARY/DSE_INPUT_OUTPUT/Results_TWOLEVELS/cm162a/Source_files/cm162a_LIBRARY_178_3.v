...
module FAU ( 
  ...
  oai21  g19(.a(new_n38_), .b(new_n34_), .c(new_n20_), .O(new_n39_));
  inv1   g20(.a(x11), .O(new_n40_));
  inv1   g21(.a(x08), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(x04), .c(x02), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n40_), .c(x10), .O(new_n43_));
  inv1   g24(.a(x10), .O(new_n44_));
  nand4  g25(.a(new_n44_), .b(new_n41_), .c(x04), .d(x02), .O(new_n45_));
  ...
  nand2  g30(.a(new_n49_), .b(new_n30_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n37_), .c(x05), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  nand2  g33(.a(new_n42_), .b(x11), .O(new_n53_));
  nand2  g34(.a(new_n40_), .b(new_n41_), .O(new_n54_));
  oai21  g35(.a(new_n54_), .b(new_n25_), .c(new_n53_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(new_n44_), .c(x03), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n52_), .O(z2));
  inv1   g38(.a(x07), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n30_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(new_n37_), .c(x05), .O(new_n60_));
  ...
  nand3  g46(.a(new_n45_), .b(x12), .c(new_n40_), .O(new_n66_));
  inv1   g47(.a(new_n66_), .O(new_n67_));
  oai21  g48(.a(new_n67_), .b(new_n65_), .c(x03), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n61_), .O(z3));
