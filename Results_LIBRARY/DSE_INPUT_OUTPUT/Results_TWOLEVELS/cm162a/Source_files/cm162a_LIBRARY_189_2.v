...
module FAU ( 
  ...
  oai21  g29(.a(new_n33_), .b(new_n24_), .c(x11), .O(new_n49_));
  ...
  nand4  g40(.a(new_n59_), .b(new_n31_), .c(x04), .d(x02), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(x12), .c(new_n36_), .O(new_n61_));
  ...
  oai22  g47(.a(new_n44_), .b(new_n21_), .c(x05), .d(new_n20_), .O(z4));
endmodule
