...
module FAU ( 
  ...
  or2    g23(.a(new_n42_), .b(new_n41_), .O(z1));
  ...
  oai21  g35(.a(new_n54_), .b(new_n35_), .c(new_n36_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  nand2  g37(.a(new_n44_), .b(new_n34_), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(x05), .c(new_n39_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n53_), .c(new_n56_), .O(new_n59_));
  ...
  nand4  g44(.a(x13), .b(x09), .c(x05), .d(x04), .O(new_n64_));
