...
module FAU ( 
  ...
  nand2  g32(.a(new_n51_), .b(new_n41_), .O(new_n52_));
  oai22  g33(.a(new_n52_), .b(new_n32_), .c(new_n21_), .d(new_n50_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  aoi21  g35(.a(new_n41_), .b(new_n31_), .c(new_n50_), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n35_), .c(x12), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x03), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(x07), .c(x05), .O(z3));
  nand2  g40(.a(new_n50_), .b(x05), .O(new_n60_));
