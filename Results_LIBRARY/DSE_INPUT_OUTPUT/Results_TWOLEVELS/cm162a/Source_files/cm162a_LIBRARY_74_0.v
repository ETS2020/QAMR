...
module FAU ( 
  ...
  oai21  g24(.a(x11), .b(new_n32_), .c(new_n31_), .O(new_n44_));
  ...
  nand3  g30(.a(new_n45_), .b(new_n36_), .c(x04), .O(new_n50_));
  ...
  aoi22  g35(.a(new_n54_), .b(new_n32_), .c(new_n23_), .d(x02), .O(new_n55_));
