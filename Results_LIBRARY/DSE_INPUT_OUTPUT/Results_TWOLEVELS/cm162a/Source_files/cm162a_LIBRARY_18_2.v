...
module FAU ( 
  ...
  oai21  g19(.a(x08), .b(new_n24_), .c(x10), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(new_n38_), .c(new_n20_), .O(new_n40_));
  nor2   g21(.a(new_n35_), .b(x04), .O(new_n41_));
  ...
  oai21  g30(.a(new_n36_), .b(new_n24_), .c(x11), .O(new_n50_));
  ...
  nor2   g35(.a(x06), .b(new_n20_), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n54_), .c(new_n32_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n53_), .O(z2));
  inv1   g38(.a(x12), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n46_), .O(new_n59_));
  oai22  g40(.a(new_n59_), .b(new_n36_), .c(new_n21_), .d(new_n20_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(x04), .c(x02), .O(new_n61_));
  oai21  g42(.a(x11), .b(x10), .c(x05), .O(new_n62_));
  ...
  aoi21  g48(.a(new_n67_), .b(new_n54_), .c(new_n20_), .O(new_n68_));
  nand2  g49(.a(new_n68_), .b(new_n66_), .O(z3));
  inv1   g50(.a(x04), .O(new_n70_));
  aoi21  g51(.a(new_n21_), .b(x05), .c(new_n70_), .O(z4));
endmodule
