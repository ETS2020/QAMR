...
module FAU ( 
  ...
  aoi21  g16(.a(new_n35_), .b(new_n20_), .c(new_n33_), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(x02), .c(new_n23_), .O(new_n37_));
  inv1   g18(.a(x01), .O(new_n38_));
  oai21  g19(.a(x10), .b(new_n38_), .c(new_n32_), .O(new_n39_));
  nand3  g20(.a(new_n34_), .b(x04), .c(x02), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(x10), .O(new_n41_));
  nand2  g22(.a(new_n28_), .b(new_n23_), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n39_), .O(new_n43_));
  inv1   g24(.a(new_n43_), .O(new_n44_));
  oai21  g25(.a(new_n37_), .b(new_n32_), .c(new_n44_), .O(z1));
  inv1   g26(.a(x11), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n28_), .c(new_n34_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n20_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x04), .c(x02), .O(new_n49_));
  nand4  g30(.a(new_n28_), .b(new_n34_), .c(x04), .d(x02), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(x11), .c(new_n23_), .O(new_n51_));
  ...
  nand4  g38(.a(new_n57_), .b(new_n46_), .c(new_n28_), .d(new_n34_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n20_), .O(new_n59_));
  nand3  g40(.a(new_n59_), .b(x04), .c(x02), .O(new_n60_));
  nor2   g41(.a(x11), .b(x10), .O(new_n61_));
  nand4  g42(.a(new_n61_), .b(new_n34_), .c(x04), .d(x02), .O(new_n62_));
  ...
  oai22  g49(.a(new_n20_), .b(new_n33_), .c(new_n28_), .d(x03), .O(z4));
endmodule
