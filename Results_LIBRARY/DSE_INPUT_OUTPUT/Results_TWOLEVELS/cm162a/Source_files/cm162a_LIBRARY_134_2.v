...
module FAU ( 
  ...
  nor2   g08(.a(new_n27_), .b(new_n20_), .O(new_n28_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n27_), .c(new_n46_), .O(new_n50_));
  aoi21  g31(.a(new_n48_), .b(x02), .c(new_n50_), .O(new_n51_));
  inv1   g32(.a(x06), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n41_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(new_n21_), .c(x05), .O(new_n54_));
  inv1   g35(.a(new_n54_), .O(new_n55_));
  oai21  g36(.a(new_n51_), .b(new_n41_), .c(new_n55_), .O(z2));
  inv1   g37(.a(x12), .O(new_n57_));
  nand4  g38(.a(new_n57_), .b(new_n46_), .c(new_n45_), .d(new_n35_), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n24_), .c(new_n44_), .O(new_n59_));
  nand4  g40(.a(new_n46_), .b(new_n45_), .c(x04), .d(x02), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n35_), .O(new_n61_));
  nand2  g42(.a(x13), .b(x08), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  aoi22  g44(.a(new_n63_), .b(x12), .c(new_n59_), .d(x02), .O(new_n64_));
  oai21  g45(.a(x07), .b(x03), .c(x05), .O(new_n65_));
  nand2  g46(.a(new_n65_), .b(new_n21_), .O(new_n66_));
  oai21  g47(.a(new_n64_), .b(new_n41_), .c(new_n66_), .O(z3));
  oai21  g48(.a(new_n24_), .b(new_n44_), .c(new_n21_), .O(z4));
endmodule
