...
module FAU ( 
  ...
  nand3  g07(.a(new_n26_), .b(x05), .c(x03), .O(new_n27_));
  ...
  aoi21  g28(.a(new_n47_), .b(new_n25_), .c(new_n43_), .O(new_n48_));
  aoi21  g29(.a(new_n46_), .b(x02), .c(new_n48_), .O(new_n49_));
  inv1   g30(.a(x05), .O(new_n50_));
  inv1   g31(.a(x06), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n28_), .c(new_n50_), .O(new_n52_));
  oai21  g33(.a(new_n49_), .b(new_n28_), .c(new_n52_), .O(z2));
  ...
  nand2  g44(.a(new_n50_), .b(x03), .O(new_n64_));
