...
module FAU ( 
  ...
  inv1   g11(.a(new_n27_), .O(new_n31_));
  ...
  nand4  g16(.a(new_n35_), .b(new_n32_), .c(x04), .d(x02), .O(new_n36_));
  aoi21  g17(.a(new_n36_), .b(new_n34_), .c(new_n20_), .O(new_n37_));
  oai21  g18(.a(x03), .b(x01), .c(x05), .O(new_n38_));
  oai21  g19(.a(new_n38_), .b(new_n37_), .c(new_n31_), .O(new_n39_));
  ...
  nand3  g24(.a(new_n43_), .b(new_n35_), .c(new_n32_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n22_), .c(new_n21_), .O(new_n45_));
  aoi22  g26(.a(new_n45_), .b(x02), .c(new_n36_), .d(x11), .O(new_n46_));
  aoi21  g27(.a(x09), .b(x03), .c(x06), .O(new_n47_));
  aoi21  g28(.a(new_n31_), .b(new_n26_), .c(new_n47_), .O(new_n48_));
  oai21  g29(.a(new_n46_), .b(new_n20_), .c(new_n48_), .O(z2));
  oai21  g30(.a(new_n44_), .b(new_n24_), .c(x12), .O(new_n50_));
  nor2   g31(.a(x08), .b(new_n21_), .O(new_n51_));
  nor3   g32(.a(x12), .b(x11), .c(x10), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n51_), .c(x02), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n50_), .c(new_n20_), .O(new_n54_));
  oai21  g35(.a(x07), .b(x03), .c(x05), .O(new_n55_));
  oai21  g36(.a(new_n55_), .b(new_n54_), .c(new_n31_), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(new_n41_), .O(z3));
