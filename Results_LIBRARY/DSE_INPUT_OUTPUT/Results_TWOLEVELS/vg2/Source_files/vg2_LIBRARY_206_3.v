...
module FAU ( 
  ...
  nand2  g103(.a(new_n50_), .b(new_n47_), .O(new_n137_));
  ...
  and2   g116(.a(new_n50_), .b(new_n43_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n45_), .c(new_n149_), .d(new_n37_), .O(z5));
  ...
  oai22  g121(.a(new_n154_), .b(new_n42_), .c(new_n153_), .d(x03), .O(new_n155_));
  nand2  g122(.a(new_n74_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n35_), .O(new_n157_));
  nand3  g124(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n107_), .c(new_n157_), .d(new_n104_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n155_), .c(new_n37_), .O(z6));
endmodule
