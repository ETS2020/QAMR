...
module FAU ( 
  ...
  nand4  g130(.a(new_n163_), .b(new_n54_), .c(new_n48_), .d(new_n162_), .O(z5));
  aoi21  g131(.a(x20), .b(new_n92_), .c(x06), .O(new_n165_));
  ...
  and2   g139(.a(new_n112_), .b(new_n111_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n110_), .c(new_n172_), .d(new_n54_), .O(z7));
endmodule
