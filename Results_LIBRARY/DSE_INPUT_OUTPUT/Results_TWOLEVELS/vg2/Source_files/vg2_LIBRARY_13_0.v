...
module FAU ( 
  ...
  nand4  g16(.a(new_n49_), .b(x08), .c(new_n35_), .d(new_n34_), .O(new_n50_));
  ...
  nand2  g36(.a(new_n53_), .b(new_n34_), .O(new_n70_));
  oai21  g37(.a(new_n69_), .b(new_n52_), .c(new_n70_), .O(z1));
  inv1   g38(.a(x20), .O(new_n72_));
  nor2   g39(.a(new_n62_), .b(new_n58_), .O(new_n73_));
  nor2   g40(.a(new_n53_), .b(x03), .O(new_n74_));
  nor3   g41(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand4  g42(.a(new_n75_), .b(x14), .c(x11), .d(x06), .O(new_n76_));
  oai21  g43(.a(new_n76_), .b(new_n52_), .c(new_n70_), .O(z2));
  inv1   g44(.a(new_n73_), .O(new_n78_));
  ...
  nand2  g48(.a(new_n81_), .b(new_n70_), .O(z3));
  inv1   g49(.a(new_n48_), .O(new_n83_));
  inv1   g50(.a(x04), .O(new_n84_));
  inv1   g51(.a(x17), .O(new_n85_));
  oai21  g52(.a(x23), .b(new_n84_), .c(new_n85_), .O(new_n86_));
  aoi21  g53(.a(new_n86_), .b(new_n55_), .c(x09), .O(new_n87_));
  ...
  nand2  g62(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand3  g63(.a(new_n96_), .b(new_n89_), .c(new_n70_), .O(z4));
  nand2  g64(.a(new_n70_), .b(new_n48_), .O(z5));
  nand2  g65(.a(x20), .b(new_n54_), .O(new_n99_));
  aoi21  g66(.a(new_n99_), .b(new_n35_), .c(x11), .O(new_n100_));
  aoi21  g67(.a(new_n100_), .b(x08), .c(x03), .O(new_n101_));
  inv1   g68(.a(x11), .O(new_n102_));
  nand2  g69(.a(new_n72_), .b(x14), .O(new_n103_));
  aoi21  g70(.a(new_n103_), .b(x06), .c(new_n102_), .O(new_n104_));
  nor2   g71(.a(new_n53_), .b(x03), .O(new_n105_));
  aoi21  g72(.a(new_n104_), .b(x03), .c(new_n105_), .O(new_n106_));
  oai22  g73(.a(new_n106_), .b(new_n73_), .c(new_n101_), .d(new_n48_), .O(z6));
  inv1   g74(.a(new_n58_), .O(new_n108_));
  and2   g75(.a(new_n61_), .b(new_n60_), .O(new_n109_));
  nand4  g76(.a(new_n70_), .b(new_n109_), .c(new_n59_), .d(new_n108_), .O(z7));
endmodule
