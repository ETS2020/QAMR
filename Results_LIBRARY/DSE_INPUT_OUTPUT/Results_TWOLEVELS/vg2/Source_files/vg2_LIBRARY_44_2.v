...
module FAU ( 
  ...
  nand4  g038(.a(new_n71_), .b(new_n70_), .c(new_n36_), .d(new_n66_), .O(new_n72_));
  ...
  nand4  g054(.a(new_n87_), .b(new_n85_), .c(new_n64_), .d(new_n58_), .O(new_n88_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n85_), .c(new_n64_), .d(new_n58_), .O(new_n98_));
  ...
  nand3  g070(.a(new_n103_), .b(new_n96_), .c(new_n83_), .O(z1));
  ...
  nand2  g086(.a(new_n99_), .b(new_n71_), .O(new_n120_));
  nand3  g087(.a(new_n76_), .b(new_n105_), .c(new_n36_), .O(new_n121_));
  ...
  nand4  g096(.a(new_n35_), .b(new_n34_), .c(new_n67_), .d(x00), .O(new_n130_));
  ...
  oai21  g106(.a(x22), .b(new_n61_), .c(new_n66_), .O(new_n140_));
  nand3  g107(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n141_));
  ...
  oai21  g112(.a(x10), .b(new_n145_), .c(new_n142_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n53_), .c(new_n63_), .d(x04), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n139_), .O(new_n149_));
  nand3  g116(.a(x15), .b(x13), .c(x05), .O(new_n150_));
  nand3  g117(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  oai21  g119(.a(new_n53_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n66_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n139_), .c(x08), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n143_), .b(x08), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n156_), .c(new_n149_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n40_), .O(new_n159_));
  inv1   g126(.a(x07), .O(new_n160_));
  aoi21  g127(.a(x23), .b(new_n68_), .c(new_n61_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n63_), .c(x09), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x16), .c(new_n126_), .O(new_n163_));
  aoi21  g130(.a(new_n53_), .b(x04), .c(x17), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x22), .c(new_n66_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n139_), .c(x08), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n160_), .c(new_n163_), .d(new_n86_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n80_), .c(x24), .O(new_n168_));
  inv1   g135(.a(x15), .O(new_n169_));
  oai22  g136(.a(new_n166_), .b(new_n75_), .c(new_n163_), .d(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n47_), .c(new_n38_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n168_), .c(new_n159_), .d(new_n54_), .O(z4));
  inv1   g139(.a(new_n42_), .O(new_n173_));
  and2   g140(.a(new_n54_), .b(new_n48_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n46_), .c(new_n43_), .d(new_n173_), .O(z5));
  nand2  g142(.a(x20), .b(new_n105_), .O(new_n176_));
  ...
  oai22  g147(.a(new_n180_), .b(new_n34_), .c(new_n112_), .d(new_n108_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n178_), .c(new_n54_), .O(z6));
  nand2  g149(.a(new_n110_), .b(new_n109_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n108_), .c(new_n54_), .O(new_n184_));
