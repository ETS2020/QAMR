...
module FAU ( 
  ...
  nand3  g084(.a(new_n55_), .b(x03), .c(x01), .O(new_n118_));
  nor2   g085(.a(new_n97_), .b(new_n36_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(x20), .c(x15), .O(new_n120_));
  nand4  g087(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n105_), .O(new_n121_));
  nand4  g088(.a(new_n82_), .b(new_n97_), .c(new_n36_), .d(new_n54_), .O(new_n122_));
  ...
  nand4  g093(.a(new_n126_), .b(new_n36_), .c(new_n54_), .d(x07), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n121_), .c(new_n125_), .d(new_n118_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n86_), .c(x24), .O(new_n129_));
  nor2   g096(.a(x02), .b(new_n105_), .O(new_n130_));
  nand2  g097(.a(new_n119_), .b(new_n111_), .O(new_n131_));
  inv1   g098(.a(x21), .O(new_n132_));
  nor2   g099(.a(x24), .b(new_n132_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(x20), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n130_), .c(new_n55_), .d(x03), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n129_), .c(new_n124_), .O(z3));
  inv1   g104(.a(x22), .O(new_n138_));
  oai21  g105(.a(x23), .b(new_n52_), .c(new_n96_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n138_), .c(x09), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n54_), .O(new_n141_));
  nand2  g108(.a(new_n51_), .b(new_n105_), .O(new_n142_));
  oai21  g109(.a(new_n46_), .b(new_n42_), .c(new_n142_), .O(new_n143_));
  nor2   g110(.a(x24), .b(x10), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n51_), .c(x01), .d(x00), .O(new_n145_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n98_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n110_), .b(new_n109_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n108_), .c(new_n142_), .O(new_n152_));
  nand3  g119(.a(new_n130_), .b(new_n133_), .c(new_n111_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(z7));
  nand2  g121(.a(z7), .b(new_n150_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n147_), .O(z4));
  nand2  g123(.a(x20), .b(new_n97_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n35_), .c(x11), .O(new_n158_));
  nand3  g125(.a(new_n144_), .b(new_n51_), .c(x00), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n45_), .c(new_n43_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n42_), .c(new_n158_), .d(x03), .O(new_n161_));
  nand2  g128(.a(new_n37_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n36_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n34_), .c(new_n113_), .d(new_n108_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n142_), .O(z6));
endmodule
