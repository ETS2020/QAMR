...
module FAU ( 
  ...
  nand3  g068(.a(new_n101_), .b(new_n65_), .c(new_n85_), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(x06), .c(x04), .O(new_n103_));
  nand3  g070(.a(new_n40_), .b(new_n62_), .c(new_n61_), .O(new_n104_));
  ...
  nand2  g092(.a(new_n125_), .b(new_n67_), .O(new_n126_));
  nand3  g093(.a(new_n72_), .b(new_n90_), .c(new_n36_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n124_), .c(new_n78_), .O(new_n129_));
  inv1   g096(.a(new_n122_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n83_), .c(x14), .O(new_n131_));
  nor2   g098(.a(x11), .b(x08), .O(new_n132_));
  nor2   g099(.a(x20), .b(x14), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n132_), .c(new_n125_), .d(new_n87_), .O(new_n134_));
  oai21  g101(.a(new_n131_), .b(new_n121_), .c(new_n134_), .O(new_n135_));
  ...
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n98_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n136_), .c(new_n129_), .O(z3));
  or2    g108(.a(new_n49_), .b(new_n42_), .O(new_n142_));
  ...
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n85_), .O(new_n146_));
  ...
  nand3  g119(.a(new_n152_), .b(new_n101_), .c(new_n44_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nor2   g122(.a(new_n35_), .b(x02), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n155_), .c(new_n147_), .O(z4));
  nand2  g125(.a(new_n48_), .b(new_n43_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n42_), .c(new_n157_), .O(new_n160_));
  nand4  g127(.a(new_n45_), .b(new_n35_), .c(new_n44_), .d(x00), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(z5));
  nand3  g129(.a(x20), .b(new_n90_), .c(new_n36_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n142_), .O(new_n165_));
  oai21  g132(.a(x20), .b(new_n90_), .c(x06), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x11), .c(new_n34_), .O(new_n167_));
  nand3  g134(.a(new_n36_), .b(x07), .c(x06), .O(new_n168_));
  oai21  g135(.a(new_n167_), .b(new_n82_), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n76_), .c(x24), .O(new_n170_));
  inv1   g137(.a(x15), .O(new_n171_));
  nand3  g138(.a(x19), .b(new_n36_), .c(x06), .O(new_n172_));
  oai21  g139(.a(new_n167_), .b(new_n171_), .c(new_n172_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n78_), .O(new_n174_));
  nand2  g141(.a(new_n36_), .b(x03), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n40_), .c(x21), .d(new_n101_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n35_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n44_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n174_), .c(new_n170_), .d(new_n165_), .O(z6));
  nand2  g146(.a(new_n157_), .b(new_n116_), .O(new_n180_));
  nand4  g147(.a(new_n152_), .b(new_n101_), .c(new_n35_), .d(new_n44_), .O(new_n181_));
