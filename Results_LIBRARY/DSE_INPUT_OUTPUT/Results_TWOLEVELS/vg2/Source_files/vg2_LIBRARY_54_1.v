...
module FAU ( 
  ...
  nor2   g055(.a(new_n52_), .b(new_n88_), .O(new_n89_));
  nor2   g056(.a(new_n58_), .b(new_n72_), .O(new_n90_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(new_n71_), .d(new_n57_), .O(new_n97_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n92_), .c(new_n69_), .d(new_n35_), .O(new_n105_));
  nor3   g072(.a(x16), .b(x14), .c(x12), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n96_), .c(x19), .d(new_n71_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n105_), .c(new_n103_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n46_), .c(new_n37_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n99_), .c(new_n54_), .O(new_n110_));
  inv1   g077(.a(new_n110_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n82_), .O(z1));
  nor2   g079(.a(new_n39_), .b(new_n88_), .O(new_n113_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n56_), .c(new_n36_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x06), .c(x03), .d(x01), .O(new_n123_));
  aoi21  g090(.a(new_n123_), .b(x08), .c(new_n52_), .O(z2));
  nand2  g091(.a(new_n60_), .b(new_n59_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x20), .c(x14), .d(x11), .O(new_n126_));
  nor4   g093(.a(new_n126_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n127_));
  nand2  g094(.a(new_n74_), .b(new_n73_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n56_), .c(new_n36_), .d(new_n69_), .O(new_n129_));
  nor4   g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n127_), .c(new_n39_), .O(new_n131_));
  nand3  g098(.a(new_n35_), .b(new_n34_), .c(new_n67_), .O(new_n132_));
  nand4  g099(.a(new_n56_), .b(new_n36_), .c(new_n69_), .d(x07), .O(new_n133_));
  ...
  nand4  g104(.a(x19), .b(new_n56_), .c(new_n36_), .d(new_n69_), .O(new_n138_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n137_), .c(new_n131_), .d(new_n54_), .O(z3));
  inv1   g109(.a(new_n49_), .O(new_n143_));
  aoi21  g110(.a(new_n58_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n70_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n52_), .c(new_n57_), .O(new_n146_));
  ...
  aoi21  g116(.a(x23), .b(new_n68_), .c(new_n71_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n72_), .c(x09), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(x16), .c(x08), .O(new_n152_));
  oai21  g119(.a(x20), .b(x08), .c(new_n152_), .O(new_n153_));
  ...
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n143_), .O(new_n159_));
  ...
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n54_), .O(z6));
  inv1   g130(.a(new_n116_), .O(new_n164_));
  and2   g131(.a(new_n118_), .b(new_n117_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n119_), .c(new_n164_), .d(new_n54_), .O(z7));
endmodule
