...
module FAU ( 
  ...
  nand4  g033(.a(new_n57_), .b(new_n34_), .c(new_n44_), .d(new_n56_), .O(new_n67_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n62_), .d(new_n59_), .O(new_n86_));
  ...
  nand3  g061(.a(new_n62_), .b(x21), .c(x20), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n94_), .c(new_n82_), .O(z1));
  ...
  oai21  g076(.a(new_n109_), .b(new_n106_), .c(new_n54_), .O(new_n110_));
  ...
  nor3   g080(.a(new_n113_), .b(new_n34_), .c(new_n56_), .O(z2));
  ...
  nand4  g094(.a(new_n127_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n128_));
  ...
  nand3  g099(.a(new_n98_), .b(x07), .c(new_n35_), .O(new_n133_));
  ...
  nand2  g104(.a(new_n98_), .b(new_n69_), .O(new_n138_));
  nand3  g105(.a(new_n74_), .b(new_n122_), .c(new_n36_), .O(new_n139_));
  ...
  oai21  g109(.a(x16), .b(new_n66_), .c(new_n115_), .O(new_n143_));
  oai21  g110(.a(new_n49_), .b(new_n42_), .c(new_n143_), .O(new_n144_));
  nor2   g111(.a(x23), .b(new_n57_), .O(new_n145_));
  nand3  g112(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n48_), .c(new_n43_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n42_), .c(new_n145_), .d(x17), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n44_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n53_), .O(new_n150_));
  inv1   g117(.a(x16), .O(new_n151_));
  oai21  g118(.a(new_n61_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n66_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n151_), .c(x08), .O(new_n154_));
  nand3  g121(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n106_), .c(new_n154_), .O(new_n156_));
