...
module FAU ( 
  ...
  nand2  g115(.a(x02), .b(new_n92_), .O(new_n149_));
  nand2  g116(.a(new_n48_), .b(new_n44_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n43_), .c(new_n149_), .O(new_n151_));
  ...
  oai21  g125(.a(new_n158_), .b(new_n113_), .c(new_n149_), .O(new_n159_));
  ...
  nand4  g131(.a(new_n164_), .b(new_n149_), .c(new_n44_), .d(new_n163_), .O(z5));
  nand2  g132(.a(x20), .b(new_n67_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n36_), .c(x11), .O(new_n167_));
  nand3  g134(.a(new_n164_), .b(new_n44_), .c(new_n163_), .O(new_n168_));
  oai21  g135(.a(new_n167_), .b(x03), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n38_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x06), .c(new_n37_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n35_), .c(new_n117_), .d(new_n113_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n149_), .O(z6));
endmodule
