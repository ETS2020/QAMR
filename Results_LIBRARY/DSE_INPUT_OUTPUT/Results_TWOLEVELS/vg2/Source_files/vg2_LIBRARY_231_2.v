...
module FAU ( 
  ...
  oai21  g119(.a(new_n152_), .b(new_n93_), .c(x08), .O(new_n153_));
  oai21  g120(.a(new_n113_), .b(new_n109_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n150_), .c(new_n54_), .O(z4));
  nand2  g122(.a(new_n48_), .b(new_n43_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n42_), .c(new_n54_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n46_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n92_), .c(x06), .O(new_n159_));
  ...
  oai21  g131(.a(new_n164_), .b(new_n109_), .c(new_n54_), .O(new_n165_));
