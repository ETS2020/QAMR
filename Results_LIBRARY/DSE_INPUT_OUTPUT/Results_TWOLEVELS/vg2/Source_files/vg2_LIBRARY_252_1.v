...
module FAU ( 
  ...
  aoi21  g054(.a(new_n87_), .b(new_n67_), .c(x24), .O(new_n88_));
  nand2  g055(.a(new_n47_), .b(new_n40_), .O(new_n89_));
  ...
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n75_), .d(new_n74_), .O(new_n103_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n97_), .c(new_n35_), .d(new_n72_), .O(new_n111_));
  ...
  nand3  g084(.a(new_n117_), .b(new_n47_), .c(new_n40_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n105_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n88_), .c(new_n37_), .O(new_n120_));
  nand3  g087(.a(new_n42_), .b(x13), .c(x05), .O(new_n121_));
  ...
  nand4  g093(.a(x11), .b(x06), .c(x03), .d(x01), .O(new_n127_));
  nor2   g094(.a(x24), .b(new_n58_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(x20), .c(x14), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n127_), .c(new_n37_), .O(new_n130_));
  ...
  aoi21  g100(.a(new_n133_), .b(new_n132_), .c(new_n40_), .O(new_n134_));
  nand3  g101(.a(x24), .b(x18), .c(x13), .O(new_n135_));
  nand3  g102(.a(x15), .b(new_n47_), .c(new_n40_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nor3   g105(.a(new_n138_), .b(new_n75_), .c(new_n36_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(x11), .c(x06), .d(x03), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n68_), .c(new_n131_), .O(z2));
  nand4  g108(.a(new_n60_), .b(x20), .c(x14), .d(x11), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(new_n71_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(x06), .c(x03), .d(x01), .O(new_n144_));
  nand4  g111(.a(new_n80_), .b(new_n75_), .c(new_n36_), .d(new_n35_), .O(new_n145_));
  nor2   g112(.a(new_n145_), .b(x08), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n34_), .c(new_n69_), .d(new_n68_), .O(new_n147_));
  ...
  nand4  g117(.a(x07), .b(new_n34_), .c(new_n69_), .d(new_n68_), .O(new_n151_));
  nand4  g118(.a(new_n75_), .b(new_n36_), .c(new_n35_), .d(new_n71_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n89_), .c(x24), .O(new_n154_));
  nand4  g121(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n155_));
  nand3  g122(.a(new_n110_), .b(new_n69_), .c(new_n68_), .O(new_n156_));
  nand3  g123(.a(new_n115_), .b(new_n36_), .c(new_n35_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n149_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n47_), .c(new_n40_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n154_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n148_), .c(new_n37_), .O(new_n161_));
  ...
  nand3  g135(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n48_), .c(new_n46_), .d(new_n45_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  oai21  g138(.a(new_n77_), .b(x04), .c(x17), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x22), .c(new_n72_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n73_), .c(x08), .O(new_n174_));
  nand2  g141(.a(new_n128_), .b(new_n50_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n136_), .c(new_n135_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n134_), .c(new_n174_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n171_), .c(new_n39_), .O(z4));
  inv1   g145(.a(new_n49_), .O(new_n179_));
  aoi21  g146(.a(new_n42_), .b(x00), .c(x10), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x02), .c(new_n179_), .O(z5));
  oai21  g148(.a(new_n75_), .b(x14), .c(new_n34_), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n35_), .c(x03), .O(new_n183_));
  aoi21  g150(.a(new_n75_), .b(x14), .c(new_n34_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n35_), .c(x03), .O(new_n185_));
  nand3  g152(.a(new_n128_), .b(new_n37_), .c(new_n50_), .O(new_n186_));
  oai21  g153(.a(new_n138_), .b(new_n38_), .c(new_n186_), .O(z7));
  nand2  g154(.a(z7), .b(new_n185_), .O(new_n188_));
  oai21  g155(.a(new_n183_), .b(new_n53_), .c(new_n188_), .O(z6));
endmodule
