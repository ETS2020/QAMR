...
module FAU ( 
  ...
  nand3  g068(.a(new_n101_), .b(new_n40_), .c(new_n93_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n92_), .c(new_n80_), .d(new_n53_), .O(z1));
  ...
  nand3  g076(.a(new_n40_), .b(x21), .c(new_n93_), .O(new_n110_));
  ...
  oai21  g081(.a(new_n114_), .b(new_n97_), .c(new_n53_), .O(z2));
  ...
  nand3  g085(.a(new_n68_), .b(new_n34_), .c(new_n97_), .O(new_n119_));
  nand3  g086(.a(new_n73_), .b(new_n104_), .c(new_n36_), .O(new_n120_));
  ...
  nand4  g090(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n97_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nor2   g092(.a(x20), .b(x14), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n36_), .c(new_n125_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n124_), .c(new_n123_), .d(new_n116_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n77_), .c(x24), .O(new_n129_));
  nand3  g096(.a(new_n126_), .b(new_n68_), .c(new_n36_), .O(new_n130_));
  nand2  g097(.a(new_n117_), .b(new_n94_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n116_), .c(new_n130_), .d(new_n98_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n40_), .c(new_n93_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n129_), .c(new_n122_), .d(new_n53_), .O(z3));
  oai21  g101(.a(x23), .b(new_n96_), .c(new_n60_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n62_), .c(x09), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x16), .c(new_n125_), .O(new_n137_));
  nand2  g104(.a(new_n48_), .b(new_n43_), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(new_n42_), .c(new_n53_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n46_), .O(z5));
  nand2  g107(.a(z5), .b(new_n137_), .O(new_n141_));
  ...
  nand2  g112(.a(new_n109_), .b(new_n108_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n107_), .c(new_n53_), .O(new_n147_));
  nand4  g114(.a(new_n40_), .b(x21), .c(new_n93_), .d(new_n44_), .O(new_n148_));
  ...
  nand2  g118(.a(x20), .b(new_n104_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n35_), .c(x11), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n154_));
  nand2  g121(.a(new_n37_), .b(x14), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x06), .c(new_n36_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n34_), .c(new_n111_), .d(new_n107_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n154_), .c(new_n53_), .O(z6));
  oai21  g125(.a(new_n45_), .b(x02), .c(x21), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n109_), .c(new_n108_), .O(new_n160_));
  or2    g127(.a(new_n160_), .b(new_n107_), .O(z7));
endmodule
