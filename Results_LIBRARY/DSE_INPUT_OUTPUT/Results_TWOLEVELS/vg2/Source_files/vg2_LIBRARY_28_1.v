...
module FAU ( 
  ...
  inv1   g107(.a(new_n44_), .O(new_n141_));
  ...
  nand3  g113(.a(new_n146_), .b(new_n50_), .c(new_n45_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n141_), .c(new_n145_), .O(new_n148_));
  ...
  nand3  g122(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n146_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n38_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n35_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(z5), .O(new_n161_));
  aoi21  g128(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n37_), .c(x03), .O(new_n163_));
  nand2  g130(.a(new_n111_), .b(new_n110_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n109_), .c(new_n154_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n112_), .O(z7));
  nand2  g133(.a(z7), .b(new_n163_), .O(new_n167_));
