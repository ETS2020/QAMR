...
module FAU ( 
  ...
  oai21  g116(.a(new_n49_), .b(new_n42_), .c(new_n149_), .O(new_n150_));
  ...
  oai21  g120(.a(new_n114_), .b(new_n110_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n150_), .c(new_n53_), .O(z4));
  ...
  oai21  g131(.a(new_n164_), .b(new_n110_), .c(new_n53_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n113_), .O(z7));
