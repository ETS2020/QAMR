...
module FAU ( 
  ...
  nand4  g049(.a(new_n82_), .b(new_n36_), .c(new_n69_), .d(new_n52_), .O(new_n83_));
  ...
  nand3  g079(.a(new_n112_), .b(new_n75_), .c(new_n74_), .O(new_n113_));
  ...
  oai21  g093(.a(x23), .b(new_n52_), .c(new_n126_), .O(new_n127_));
  nor3   g094(.a(new_n127_), .b(new_n73_), .c(new_n70_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x11), .c(x06), .d(x03), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n67_), .O(z2));
  aoi21  g097(.a(new_n58_), .b(new_n57_), .c(new_n75_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x20), .c(x14), .d(x11), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n52_), .O(new_n133_));
  ...
  nor2   g112(.a(new_n70_), .b(new_n36_), .O(new_n146_));
  nor2   g113(.a(new_n75_), .b(new_n73_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(x18), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n143_), .c(new_n88_), .O(new_n149_));
  ...
  nand3  g125(.a(new_n158_), .b(new_n71_), .c(new_n52_), .O(new_n159_));
  oai21  g126(.a(new_n75_), .b(new_n52_), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  oai21  g128(.a(new_n72_), .b(new_n68_), .c(x22), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x09), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(x23), .c(x16), .O(new_n164_));
  ...
  and2   g135(.a(new_n45_), .b(new_n42_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n54_), .c(new_n47_), .d(new_n168_), .O(z5));
  nand2  g137(.a(x20), .b(new_n70_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n35_), .c(x11), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x03), .c(new_n156_), .O(new_n173_));
  nand2  g140(.a(new_n73_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n36_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n34_), .c(new_n126_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n54_), .O(z6));
  and2   g144(.a(new_n126_), .b(new_n54_), .O(z7));
endmodule
