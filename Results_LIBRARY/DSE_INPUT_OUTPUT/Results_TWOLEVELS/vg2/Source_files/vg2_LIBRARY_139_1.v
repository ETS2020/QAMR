...
module FAU ( 
  ...
  nor2   g093(.a(new_n72_), .b(x14), .O(new_n127_));
  ...
  nand4  g099(.a(new_n76_), .b(new_n72_), .c(new_n71_), .d(new_n68_), .O(new_n133_));
  ...
  nor2   g109(.a(x22), .b(x20), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n142_), .c(new_n141_), .d(new_n139_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n138_), .c(x24), .O(new_n146_));
  nand3  g113(.a(new_n140_), .b(x20), .c(x15), .O(new_n147_));
  nand4  g114(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n148_));
  nor2   g115(.a(x14), .b(x11), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n143_), .c(x19), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n148_), .c(new_n147_), .d(new_n139_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n46_), .c(new_n37_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n146_), .c(new_n137_), .O(z3));
  oai21  g120(.a(x16), .b(new_n67_), .c(new_n66_), .O(new_n154_));
  oai21  g121(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n72_), .c(new_n69_), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  aoi21  g124(.a(new_n154_), .b(new_n128_), .c(new_n157_), .O(new_n158_));
  oai21  g125(.a(new_n69_), .b(x09), .c(x08), .O(new_n159_));
  oai21  g126(.a(new_n73_), .b(x04), .c(x17), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(x22), .c(x16), .d(x14), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  aoi21  g129(.a(new_n159_), .b(new_n128_), .c(new_n162_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n124_), .c(new_n158_), .d(new_n49_), .O(z4));
  nor2   g131(.a(new_n127_), .b(new_n49_), .O(z5));
  aoi21  g132(.a(new_n36_), .b(x06), .c(x03), .O(new_n166_));
  aoi21  g133(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n124_), .c(new_n166_), .d(new_n49_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n128_), .O(new_n169_));
  nand3  g136(.a(new_n140_), .b(x21), .c(new_n71_), .O(new_n170_));
  nand2  g137(.a(new_n36_), .b(x00), .O(new_n171_));
  nand3  g138(.a(new_n72_), .b(x20), .c(new_n68_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n171_), .c(new_n170_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n44_), .c(new_n43_), .O(new_n174_));
  nand3  g141(.a(new_n140_), .b(new_n71_), .c(x15), .O(new_n175_));
  nand4  g142(.a(new_n149_), .b(new_n72_), .c(x20), .d(x19), .O(new_n176_));
  ...
  nand3  g147(.a(new_n140_), .b(new_n71_), .c(x18), .O(new_n181_));
  nand2  g148(.a(new_n36_), .b(x07), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n172_), .c(new_n181_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n138_), .c(x24), .O(new_n184_));
  nand3  g151(.a(new_n177_), .b(new_n46_), .c(new_n37_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n184_), .c(new_n180_), .d(new_n169_), .O(z6));
  inv1   g153(.a(new_n119_), .O(new_n187_));
  and2   g154(.a(new_n121_), .b(new_n120_), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(new_n128_), .c(new_n122_), .d(new_n187_), .O(z7));
endmodule
