...
module FAU ( 
  ...
  nor2   g18(.a(x12), .b(x04), .O(new_n52_));
  ...
  nor2   g40(.a(new_n65_), .b(new_n61_), .O(new_n74_));
  nor2   g41(.a(new_n74_), .b(new_n52_), .O(z7));
  nand2  g42(.a(z7), .b(x20), .O(new_n76_));
  nor2   g43(.a(new_n76_), .b(new_n57_), .O(new_n77_));
  nand4  g44(.a(new_n77_), .b(x11), .c(x06), .d(x03), .O(new_n78_));
  nor2   g45(.a(new_n78_), .b(new_n55_), .O(z2));
  nand3  g46(.a(x15), .b(x13), .c(x05), .O(new_n80_));
  nand3  g47(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n81_));
  nand2  g48(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g49(.a(new_n82_), .b(x20), .c(x14), .d(x11), .O(new_n83_));
  nor2   g50(.a(new_n83_), .b(new_n56_), .O(new_n84_));
  nand4  g51(.a(new_n84_), .b(x06), .c(x03), .d(x01), .O(new_n85_));
  inv1   g52(.a(x20), .O(new_n86_));
  nand3  g53(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n87_));
  nand3  g54(.a(x19), .b(x13), .c(x05), .O(new_n88_));
  nand2  g55(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g56(.a(new_n89_), .b(new_n86_), .c(new_n57_), .d(new_n36_), .O(new_n90_));
  nor2   g57(.a(new_n90_), .b(x08), .O(new_n91_));
  nand4  g58(.a(new_n91_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n92_));
  nand2  g59(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  nand2  g60(.a(new_n93_), .b(new_n39_), .O(new_n94_));
  nand2  g61(.a(new_n46_), .b(new_n37_), .O(new_n95_));
  nand4  g62(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n96_));
  nand4  g63(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n97_));
  nand4  g64(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n98_));
  nand4  g65(.a(new_n86_), .b(new_n57_), .c(new_n36_), .d(new_n56_), .O(new_n99_));
  ...
  nand4  g70(.a(new_n86_), .b(x19), .c(new_n57_), .d(new_n36_), .O(new_n104_));
  ...
  aoi21  g74(.a(new_n107_), .b(new_n94_), .c(new_n52_), .O(z3));
  inv1   g75(.a(x16), .O(new_n109_));
  inv1   g76(.a(x09), .O(new_n110_));
  inv1   g77(.a(x17), .O(new_n111_));
  aoi21  g78(.a(x22), .b(new_n111_), .c(new_n110_), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(new_n109_), .c(x08), .O(new_n113_));
  inv1   g80(.a(x12), .O(new_n114_));
  nand3  g81(.a(x23), .b(x22), .c(x16), .O(new_n115_));
  nor3   g82(.a(new_n115_), .b(new_n114_), .c(x04), .O(new_n116_));
  aoi21  g83(.a(new_n113_), .b(new_n53_), .c(new_n116_), .O(new_n117_));
  aoi21  g84(.a(new_n58_), .b(x17), .c(x09), .O(new_n118_));
  oai21  g85(.a(new_n118_), .b(x16), .c(new_n56_), .O(new_n119_));
  inv1   g86(.a(x23), .O(new_n120_));
  nand4  g87(.a(new_n120_), .b(new_n58_), .c(new_n109_), .d(x04), .O(new_n121_));
  inv1   g88(.a(new_n121_), .O(new_n122_));
  aoi21  g89(.a(new_n119_), .b(new_n53_), .c(new_n122_), .O(new_n123_));
  oai22  g90(.a(new_n123_), .b(new_n49_), .c(new_n117_), .d(new_n74_), .O(z4));
  nor2   g91(.a(new_n52_), .b(new_n49_), .O(z5));
  nand2  g92(.a(x20), .b(new_n57_), .O(new_n126_));
  aoi21  g93(.a(new_n126_), .b(new_n35_), .c(x11), .O(new_n127_));
  oai22  g94(.a(new_n127_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n128_));
  nand2  g95(.a(new_n86_), .b(x14), .O(new_n129_));
  aoi21  g96(.a(new_n129_), .b(x06), .c(new_n36_), .O(new_n130_));
  oai22  g97(.a(new_n130_), .b(new_n34_), .c(new_n65_), .d(new_n61_), .O(new_n131_));
  nand3  g98(.a(new_n131_), .b(new_n128_), .c(new_n53_), .O(z6));
endmodule
