...
module FAU ( 
  ...
  nand4  g078(.a(new_n40_), .b(x21), .c(new_n111_), .d(new_n51_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n108_), .c(x20), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n97_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n105_), .O(z2));
  nand4  g084(.a(new_n111_), .b(x08), .c(x06), .d(x03), .O(new_n118_));
  inv1   g085(.a(x21), .O(new_n119_));
  nor2   g086(.a(x24), .b(new_n119_), .O(new_n120_));
  nor2   g087(.a(new_n97_), .b(new_n36_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n120_), .c(x20), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n118_), .c(x01), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n51_), .O(new_n124_));
  nand3  g091(.a(new_n55_), .b(x03), .c(x01), .O(new_n125_));
  nand3  g092(.a(new_n121_), .b(x20), .c(x15), .O(new_n126_));
  nand3  g093(.a(new_n77_), .b(new_n34_), .c(new_n105_), .O(new_n127_));
  nand3  g094(.a(new_n82_), .b(new_n97_), .c(new_n36_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n88_), .O(new_n130_));
  nand3  g097(.a(new_n121_), .b(x20), .c(x18), .O(new_n131_));
  nand4  g098(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n105_), .O(new_n132_));
  nand4  g099(.a(new_n37_), .b(new_n97_), .c(new_n36_), .d(new_n54_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n125_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n86_), .c(x24), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n130_), .c(new_n124_), .O(z3));
  inv1   g103(.a(x22), .O(new_n137_));
  oai21  g104(.a(x23), .b(new_n52_), .c(new_n96_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n137_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n54_), .O(new_n140_));
  nor2   g107(.a(x24), .b(x10), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n51_), .c(x00), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n45_), .c(new_n43_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n42_), .c(new_n140_), .O(new_n144_));
  oai21  g111(.a(new_n63_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n56_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n98_), .c(x08), .O(new_n147_));
  oai21  g114(.a(new_n113_), .b(new_n108_), .c(new_n147_), .O(new_n148_));
  nor2   g115(.a(x02), .b(x01), .O(new_n149_));
  inv1   g116(.a(new_n149_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n148_), .c(new_n144_), .O(z4));
  oai21  g118(.a(new_n46_), .b(new_n42_), .c(new_n150_), .O(new_n152_));
  nand4  g119(.a(new_n141_), .b(new_n51_), .c(x01), .d(x00), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(z5));
  aoi21  g121(.a(x20), .b(new_n97_), .c(x06), .O(new_n155_));
  ...
  nand2  g126(.a(new_n110_), .b(new_n109_), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(new_n108_), .O(new_n161_));
  nand2  g128(.a(new_n120_), .b(new_n111_), .O(new_n162_));
  inv1   g129(.a(new_n162_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n51_), .c(x01), .O(new_n164_));
  oai21  g131(.a(new_n161_), .b(new_n149_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n159_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n157_), .O(z6));
  oai21  g134(.a(new_n163_), .b(new_n105_), .c(new_n51_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n161_), .O(z7));
endmodule
