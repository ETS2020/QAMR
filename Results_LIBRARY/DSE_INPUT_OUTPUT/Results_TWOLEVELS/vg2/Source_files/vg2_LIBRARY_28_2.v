...
module FAU ( 
  ...
  nand3  g110(.a(new_n143_), .b(new_n98_), .c(new_n44_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g113(.a(new_n44_), .b(x01), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n146_), .c(new_n138_), .O(z4));
  nand2  g115(.a(new_n48_), .b(new_n43_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n42_), .c(new_n147_), .O(new_n150_));
  nand4  g117(.a(new_n45_), .b(new_n44_), .c(new_n94_), .d(x00), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n150_), .O(z5));
  aoi21  g119(.a(x20), .b(new_n87_), .c(x06), .O(new_n153_));
  ...
  nand2  g124(.a(new_n147_), .b(new_n112_), .O(new_n158_));
  nand4  g125(.a(new_n143_), .b(new_n98_), .c(new_n44_), .d(new_n94_), .O(new_n159_));
