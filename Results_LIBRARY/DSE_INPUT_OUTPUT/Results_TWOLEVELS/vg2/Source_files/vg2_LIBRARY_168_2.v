...
module FAU ( 
  ...
  nand4  g042(.a(new_n75_), .b(new_n53_), .c(new_n67_), .d(new_n66_), .O(new_n76_));
  ...
  nor3   g057(.a(x16), .b(x14), .c(x12), .O(new_n91_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n53_), .d(new_n67_), .O(new_n101_));
  nor3   g068(.a(x17), .b(x16), .c(x14), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n92_), .c(new_n69_), .d(x19), .O(new_n103_));
  oai21  g070(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n46_), .c(new_n37_), .O(new_n105_));
  nor2   g072(.a(x20), .b(new_n36_), .O(new_n106_));
  ...
  nor3   g085(.a(new_n118_), .b(new_n69_), .c(new_n54_), .O(new_n119_));
  ...
  nor2   g090(.a(new_n123_), .b(new_n66_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand2  g092(.a(new_n72_), .b(new_n71_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n69_), .c(new_n54_), .d(new_n36_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n129_));
  ...
  nand4  g101(.a(new_n69_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n135_));
  ...
  nand3  g105(.a(new_n100_), .b(new_n34_), .c(new_n64_), .O(new_n139_));
  nand4  g106(.a(new_n69_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n140_));
  ...
  oai21  g111(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n70_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n66_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  inv1   g115(.a(new_n118_), .O(new_n149_));
  oai21  g116(.a(new_n55_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n67_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n84_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n148_), .c(new_n106_), .O(z4));
  nor2   g121(.a(new_n106_), .b(new_n49_), .O(z5));
  ...
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n144_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n107_), .O(z6));
  nor2   g128(.a(new_n118_), .b(new_n106_), .O(z7));
endmodule
