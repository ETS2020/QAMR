...
module FAU ( 
  ...
  nand4  g115(.a(new_n148_), .b(new_n54_), .c(x01), .d(x00), .O(new_n149_));
  ...
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n59_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n100_), .c(x08), .O(new_n154_));
  inv1   g121(.a(new_n147_), .O(new_n155_));
  oai21  g122(.a(new_n120_), .b(new_n117_), .c(new_n155_), .O(new_n156_));
  nand4  g123(.a(new_n111_), .b(new_n108_), .c(new_n54_), .d(x01), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(z7));
  nand2  g125(.a(z7), .b(new_n154_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n151_), .O(z4));
  aoi21  g127(.a(new_n148_), .b(x00), .c(new_n107_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x02), .c(new_n146_), .O(z5));
  nand2  g129(.a(x20), .b(new_n37_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  nand3  g131(.a(new_n148_), .b(new_n54_), .c(x00), .O(new_n165_));
  ...
  oai22  g138(.a(new_n171_), .b(new_n117_), .c(new_n169_), .d(new_n34_), .O(new_n172_));
