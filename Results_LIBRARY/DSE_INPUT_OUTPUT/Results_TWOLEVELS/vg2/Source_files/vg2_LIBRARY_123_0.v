...
module FAU ( 
  ...
  aoi21  g083(.a(new_n116_), .b(new_n115_), .c(new_n45_), .O(new_n117_));
  nand3  g084(.a(x24), .b(x18), .c(x13), .O(new_n118_));
  nand3  g085(.a(x15), .b(new_n46_), .c(new_n45_), .O(new_n119_));
  ...
  oai21  g090(.a(new_n123_), .b(new_n107_), .c(new_n114_), .O(z2));
  nand4  g091(.a(new_n108_), .b(x08), .c(x06), .d(x03), .O(new_n125_));
  nor2   g092(.a(new_n37_), .b(new_n36_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n111_), .c(x20), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n125_), .c(x01), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n54_), .O(new_n129_));
  nand3  g096(.a(new_n58_), .b(x03), .c(x01), .O(new_n130_));
  nand3  g097(.a(new_n126_), .b(x20), .c(x15), .O(new_n131_));
  nand3  g098(.a(new_n80_), .b(new_n34_), .c(new_n107_), .O(new_n132_));
  nand3  g099(.a(new_n85_), .b(new_n37_), .c(new_n36_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n91_), .O(new_n135_));
  nand3  g102(.a(new_n126_), .b(x20), .c(x18), .O(new_n136_));
  nand4  g103(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n107_), .O(new_n137_));
  nand4  g104(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n130_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n89_), .c(x24), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n135_), .c(new_n129_), .O(z3));
  inv1   g108(.a(x22), .O(new_n142_));
  oai21  g109(.a(x23), .b(new_n55_), .c(new_n99_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n142_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n57_), .O(new_n145_));
  nor2   g112(.a(x24), .b(x10), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n54_), .c(x00), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n148_));
  ...
  nand3  g119(.a(new_n111_), .b(new_n108_), .c(new_n54_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n119_), .c(new_n118_), .O(new_n154_));
  or2    g121(.a(new_n154_), .b(new_n117_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nor2   g123(.a(x02), .b(x01), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n156_), .c(new_n149_), .O(z4));
  nand2  g126(.a(new_n158_), .b(new_n49_), .O(new_n160_));
  nand4  g127(.a(new_n146_), .b(new_n54_), .c(x01), .d(x00), .O(new_n161_));
  ...
  oai21  g134(.a(new_n167_), .b(new_n34_), .c(new_n155_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n158_), .O(z6));
  oai21  g136(.a(new_n120_), .b(new_n117_), .c(new_n158_), .O(new_n170_));
  nand4  g137(.a(new_n111_), .b(new_n108_), .c(new_n54_), .d(x01), .O(new_n171_));
