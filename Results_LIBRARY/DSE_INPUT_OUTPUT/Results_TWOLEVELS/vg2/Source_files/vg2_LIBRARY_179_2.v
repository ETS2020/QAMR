...
module FAU ( 
  ...
  aoi21  g093(.a(new_n126_), .b(x14), .c(new_n36_), .O(z2));
  ...
  nor2   g115(.a(x14), .b(new_n36_), .O(new_n149_));
  ...
  oai21  g144(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n50_), .c(new_n36_), .O(new_n179_));
  nand2  g146(.a(x20), .b(x06), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n154_), .c(x14), .d(x11), .O(new_n181_));
