...
module FAU ( 
  ...
  nand4  g114(.a(new_n147_), .b(new_n51_), .c(x01), .d(x00), .O(new_n148_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n98_), .c(x08), .O(new_n153_));
  nor2   g120(.a(new_n118_), .b(new_n115_), .O(new_n154_));
  nand2  g121(.a(new_n109_), .b(new_n106_), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n135_), .O(new_n157_));
  oai21  g124(.a(new_n146_), .b(new_n154_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n150_), .O(z4));
  aoi21  g127(.a(new_n147_), .b(x00), .c(new_n105_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x02), .c(new_n145_), .O(z5));
  inv1   g129(.a(new_n146_), .O(new_n163_));
  nand2  g130(.a(x20), .b(new_n97_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  nand3  g132(.a(new_n147_), .b(new_n51_), .c(x00), .O(new_n166_));
  ...
  nand3  g137(.a(new_n109_), .b(new_n106_), .c(new_n51_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n117_), .c(new_n116_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n115_), .c(new_n170_), .d(new_n34_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n168_), .c(new_n163_), .O(z6));
  oai21  g141(.a(new_n156_), .b(new_n105_), .c(new_n51_), .O(new_n175_));
