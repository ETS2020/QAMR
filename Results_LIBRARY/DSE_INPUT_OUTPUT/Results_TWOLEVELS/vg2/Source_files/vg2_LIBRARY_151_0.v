...
module FAU ( 
  ...
  nand4  g077(.a(new_n40_), .b(x21), .c(new_n97_), .d(new_n110_), .O(new_n111_));
  ...
  nor2   g082(.a(new_n115_), .b(new_n64_), .O(z2));
  nand3  g083(.a(new_n57_), .b(x03), .c(x01), .O(new_n117_));
  nor2   g084(.a(new_n37_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand4  g086(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n64_), .O(new_n120_));
  nand4  g087(.a(new_n73_), .b(new_n37_), .c(new_n36_), .d(new_n56_), .O(new_n121_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n36_), .c(new_n56_), .d(x07), .O(new_n126_));
  ...
  nand2  g095(.a(new_n118_), .b(new_n97_), .O(new_n129_));
  ...
  nand4  g099(.a(new_n132_), .b(new_n94_), .c(new_n57_), .d(x03), .O(new_n133_));
  ...
  nand4  g109(.a(new_n142_), .b(new_n110_), .c(x01), .d(x00), .O(new_n143_));
  oai21  g110(.a(new_n141_), .b(new_n140_), .c(new_n143_), .O(new_n144_));
  ...
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n147_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n146_), .c(x08), .O(new_n151_));
  inv1   g118(.a(new_n94_), .O(new_n152_));
  nand2  g119(.a(new_n109_), .b(new_n108_), .O(new_n153_));
  nor2   g120(.a(new_n153_), .b(new_n107_), .O(new_n154_));
  nand2  g121(.a(new_n130_), .b(new_n97_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n152_), .c(new_n154_), .d(new_n141_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n145_), .O(z4));
  aoi21  g125(.a(new_n142_), .b(x00), .c(new_n64_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x02), .c(new_n140_), .O(z5));
  inv1   g127(.a(new_n141_), .O(new_n161_));
  nand2  g128(.a(x20), .b(new_n37_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  nand3  g130(.a(new_n142_), .b(new_n110_), .c(x00), .O(new_n164_));
  ...
  oai22  g135(.a(new_n168_), .b(new_n34_), .c(new_n112_), .d(new_n107_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n161_), .O(z6));
  nand2  g137(.a(new_n155_), .b(x01), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n110_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n154_), .O(z7));
endmodule
