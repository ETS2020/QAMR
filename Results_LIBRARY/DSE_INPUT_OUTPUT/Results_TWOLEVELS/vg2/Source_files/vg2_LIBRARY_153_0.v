...
module FAU ( 
  ...
  nand3  g118(.a(new_n151_), .b(new_n149_), .c(new_n145_), .O(z4));
  oai21  g119(.a(new_n46_), .b(new_n42_), .c(new_n151_), .O(new_n153_));
  nand4  g120(.a(new_n142_), .b(new_n51_), .c(x01), .d(x00), .O(new_n154_));
  ...
  nor2   g128(.a(new_n161_), .b(new_n108_), .O(new_n162_));
  nand2  g129(.a(new_n133_), .b(new_n111_), .O(new_n163_));
  inv1   g130(.a(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n130_), .O(new_n165_));
  oai21  g132(.a(new_n162_), .b(new_n150_), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n160_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n158_), .O(z6));
  oai21  g135(.a(new_n164_), .b(new_n105_), .c(new_n51_), .O(new_n169_));
