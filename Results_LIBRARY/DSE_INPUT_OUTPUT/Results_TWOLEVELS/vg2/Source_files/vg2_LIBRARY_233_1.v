...
module FAU ( 
  ...
  nor2   g080(.a(x04), .b(x02), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(new_n41_), .c(x21), .d(new_n101_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n113_), .c(new_n61_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x14), .c(x11), .d(x06), .O(new_n117_));
  nor3   g084(.a(new_n117_), .b(new_n97_), .c(new_n96_), .O(z2));
  ...
  nand3  g088(.a(new_n69_), .b(new_n97_), .c(new_n96_), .O(new_n122_));
  nand3  g089(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n123_));
  ...
  nand4  g093(.a(x07), .b(new_n34_), .c(new_n97_), .d(new_n96_), .O(new_n127_));
  nand4  g094(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n100_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n119_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n78_), .c(x24), .O(new_n130_));
  nand4  g097(.a(new_n34_), .b(new_n97_), .c(new_n96_), .d(x00), .O(new_n131_));
  nand3  g098(.a(new_n120_), .b(x21), .c(x20), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n119_), .c(new_n131_), .d(new_n128_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n41_), .c(new_n101_), .O(new_n134_));
  ...
  nand2  g104(.a(new_n63_), .b(x17), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n67_), .c(x16), .O(new_n139_));
  nand3  g106(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n46_), .c(new_n44_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n43_), .c(new_n139_), .d(x08), .O(new_n142_));
  aoi21  g109(.a(x23), .b(new_n49_), .c(new_n60_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n63_), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n100_), .O(new_n145_));
  nand4  g112(.a(new_n75_), .b(new_n90_), .c(x07), .d(x04), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n84_), .c(new_n146_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n78_), .c(x24), .O(new_n148_));
  inv1   g115(.a(x15), .O(new_n149_));
  nand4  g116(.a(new_n75_), .b(x19), .c(new_n90_), .d(x04), .O(new_n150_));
  oai21  g117(.a(new_n145_), .b(new_n149_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n80_), .O(new_n152_));
  aoi21  g119(.a(new_n64_), .b(x17), .c(new_n63_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n67_), .c(x16), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x08), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n41_), .c(x21), .d(new_n101_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n49_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n37_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n152_), .c(new_n148_), .d(new_n142_), .O(z4));
  nor2   g126(.a(new_n47_), .b(new_n43_), .O(new_n160_));
  aoi21  g127(.a(new_n50_), .b(x00), .c(x04), .O(new_n161_));
  ...
  oai21  g131(.a(new_n164_), .b(x11), .c(new_n97_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand2  g133(.a(new_n115_), .b(new_n113_), .O(z7));
