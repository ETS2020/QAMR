...
module FAU ( 
  ...
  nand2  g090(.a(x02), .b(new_n94_), .O(new_n124_));
  oai21  g091(.a(new_n123_), .b(new_n94_), .c(new_n124_), .O(z2));
  nand3  g092(.a(new_n61_), .b(x03), .c(x01), .O(new_n126_));
  nor2   g093(.a(new_n38_), .b(new_n37_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(x20), .c(x15), .O(new_n128_));
  nand4  g095(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n129_));
  nor2   g096(.a(x11), .b(x08), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n39_), .c(x19), .d(new_n38_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n129_), .c(new_n128_), .d(new_n126_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n81_), .O(new_n133_));
  nand3  g100(.a(new_n127_), .b(x20), .c(x18), .O(new_n134_));
  nor2   g101(.a(x20), .b(x14), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n37_), .c(new_n60_), .d(x07), .O(new_n136_));
  ...
  nand4  g105(.a(new_n36_), .b(new_n35_), .c(new_n94_), .d(x00), .O(new_n139_));
  ...
  nand4  g109(.a(new_n142_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n138_), .c(new_n133_), .O(z3));
  oai21  g111(.a(x23), .b(new_n95_), .c(new_n73_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n99_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n60_), .O(new_n147_));
  nand4  g114(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n149_));
  ...
  oai21  g121(.a(new_n109_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n154_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n72_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n150_), .c(new_n124_), .O(z4));
  nand3  g126(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n124_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n148_), .O(z5));
  nand2  g129(.a(x20), .b(new_n38_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n36_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n149_), .O(new_n165_));
  nand2  g132(.a(new_n39_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n37_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n35_), .c(new_n153_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n124_), .O(z6));
  and2   g136(.a(new_n124_), .b(new_n117_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n119_), .c(new_n118_), .d(new_n151_), .O(z7));
endmodule
