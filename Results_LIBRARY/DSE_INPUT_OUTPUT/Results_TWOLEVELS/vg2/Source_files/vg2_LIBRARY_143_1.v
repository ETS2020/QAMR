...
module FAU ( 
  ...
  nand3  g087(.a(new_n69_), .b(new_n96_), .c(new_n95_), .O(new_n121_));
  ...
  nand4  g092(.a(x07), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(new_n126_));
  nand4  g093(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n99_), .O(new_n127_));
  ...
  nand4  g096(.a(new_n34_), .b(new_n96_), .c(new_n95_), .d(x00), .O(new_n130_));
  ...
  nand2  g109(.a(new_n114_), .b(new_n112_), .O(z7));
  oai21  g110(.a(new_n64_), .b(x04), .c(x17), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x22), .c(new_n67_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n89_), .c(x08), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(z7), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n142_), .O(z4));
  nand2  g115(.a(x20), .b(new_n36_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n34_), .c(x11), .O(new_n150_));
  nand4  g117(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n46_), .c(new_n44_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n43_), .c(new_n150_), .d(x03), .O(new_n153_));
  nand2  g120(.a(new_n61_), .b(x14), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x06), .c(new_n35_), .O(new_n155_));
  nand3  g122(.a(new_n113_), .b(new_n41_), .c(x21), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n110_), .c(new_n109_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n108_), .c(new_n155_), .d(new_n96_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n38_), .O(z6));
endmodule
