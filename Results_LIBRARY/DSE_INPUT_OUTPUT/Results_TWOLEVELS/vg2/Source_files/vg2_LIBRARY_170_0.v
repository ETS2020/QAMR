...
module FAU ( 
  ...
  nor2   g018(.a(x18), .b(x16), .O(new_n52_));
  ...
  oai21  g094(.a(x24), .b(new_n71_), .c(new_n94_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(x15), .c(x13), .O(new_n129_));
  nor2   g096(.a(new_n39_), .b(new_n94_), .O(new_n130_));
  ...
  nand3  g101(.a(new_n134_), .b(new_n133_), .c(new_n127_), .O(new_n135_));
  ...
  inv1   g105(.a(new_n138_), .O(z2));
  nand4  g106(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(new_n68_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(x06), .c(x03), .d(x01), .O(new_n142_));
  nand4  g109(.a(new_n78_), .b(new_n73_), .c(new_n70_), .d(new_n36_), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(x08), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n145_));
  ...
  nand3  g115(.a(new_n95_), .b(x14), .c(x11), .O(new_n149_));
  nand3  g116(.a(new_n100_), .b(new_n34_), .c(new_n66_), .O(new_n150_));
  nand4  g117(.a(new_n73_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n148_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n89_), .c(x24), .O(new_n153_));
  nand4  g120(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n154_));
  nand3  g121(.a(new_n112_), .b(new_n34_), .c(new_n66_), .O(new_n155_));
  nand3  g122(.a(new_n117_), .b(new_n70_), .c(new_n36_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n148_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n46_), .c(new_n37_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n153_), .c(new_n147_), .d(new_n53_), .O(z3));
  nand3  g126(.a(new_n39_), .b(x13), .c(x05), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n89_), .O(new_n161_));
  nand2  g128(.a(new_n53_), .b(x08), .O(new_n162_));
  aoi21  g129(.a(new_n75_), .b(x04), .c(x17), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x22), .c(new_n69_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(x18), .c(new_n71_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n162_), .c(new_n116_), .O(new_n166_));
  nand2  g133(.a(x23), .b(new_n67_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x17), .c(new_n74_), .O(new_n168_));
  inv1   g135(.a(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(x09), .c(x08), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(x16), .c(x15), .O(new_n171_));
  inv1   g138(.a(new_n171_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n166_), .c(new_n161_), .O(new_n173_));
  oai21  g140(.a(new_n168_), .b(new_n69_), .c(x16), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(x08), .c(new_n99_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n89_), .c(x24), .O(new_n176_));
  nor2   g143(.a(new_n46_), .b(new_n37_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n88_), .c(x15), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n125_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n68_), .O(new_n180_));
  nand2  g147(.a(new_n164_), .b(new_n71_), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n68_), .c(x24), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n180_), .c(new_n176_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(x18), .O(new_n185_));
  inv1   g152(.a(new_n45_), .O(new_n186_));
  nor3   g153(.a(new_n88_), .b(new_n39_), .c(new_n99_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(new_n186_), .c(x08), .O(new_n188_));
  nand4  g155(.a(new_n170_), .b(new_n39_), .c(x21), .d(new_n44_), .O(new_n189_));
  oai21  g156(.a(new_n189_), .b(x02), .c(new_n188_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(x16), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n185_), .c(new_n173_), .O(z4));
  nor2   g159(.a(new_n52_), .b(new_n49_), .O(z5));
  nand2  g160(.a(x20), .b(new_n70_), .O(new_n194_));
  aoi21  g161(.a(new_n194_), .b(new_n35_), .c(x11), .O(new_n195_));
  oai22  g162(.a(new_n195_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n196_));
  nand2  g163(.a(new_n73_), .b(x14), .O(new_n197_));
  aoi21  g164(.a(new_n197_), .b(x06), .c(new_n36_), .O(new_n198_));
  nand3  g165(.a(new_n39_), .b(x15), .c(x13), .O(new_n199_));
  aoi21  g166(.a(new_n199_), .b(new_n131_), .c(new_n37_), .O(new_n200_));
  nand3  g167(.a(new_n134_), .b(new_n125_), .c(new_n124_), .O(new_n201_));
  oai22  g168(.a(new_n201_), .b(new_n200_), .c(new_n198_), .d(new_n34_), .O(new_n202_));
  nand3  g169(.a(new_n202_), .b(new_n196_), .c(new_n53_), .O(z6));
  inv1   g170(.a(new_n200_), .O(new_n204_));
  and2   g171(.a(new_n134_), .b(new_n124_), .O(new_n205_));
  nand4  g172(.a(new_n205_), .b(new_n204_), .c(new_n125_), .d(new_n53_), .O(z7));
endmodule
