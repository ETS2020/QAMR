...
module FAU ( 
  ...
  nand3  g108(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n142_));
  ...
  nand3  g114(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(new_n148_));
  or2    g115(.a(new_n148_), .b(new_n108_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n144_), .c(new_n38_), .O(z4));
  ...
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n143_), .O(new_n155_));
  nand2  g122(.a(new_n61_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n35_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n69_), .c(new_n149_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n38_), .O(z6));
  nand2  g126(.a(new_n113_), .b(new_n112_), .O(z7));
endmodule
