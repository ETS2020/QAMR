...
module FAU ( 
  ...
  oai21  g097(.a(new_n130_), .b(new_n67_), .c(new_n54_), .O(z2));
  ...
  nand4  g101(.a(new_n78_), .b(new_n37_), .c(new_n71_), .d(new_n36_), .O(new_n135_));
  ...
  nand3  g113(.a(new_n109_), .b(new_n34_), .c(new_n67_), .O(new_n147_));
  nand3  g114(.a(new_n114_), .b(new_n71_), .c(new_n36_), .O(new_n148_));
  ...
  oai21  g118(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n74_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n69_), .O(new_n154_));
  nand2  g121(.a(new_n48_), .b(new_n43_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n42_), .c(new_n54_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n46_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  oai21  g125(.a(new_n75_), .b(x04), .c(x17), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x22), .c(new_n70_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n72_), .c(x08), .O(new_n161_));
  nand2  g128(.a(new_n125_), .b(new_n124_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n123_), .c(new_n54_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n126_), .O(z7));
  ...
  nand4  g135(.a(new_n168_), .b(new_n54_), .c(new_n48_), .d(new_n167_), .O(z5));
  aoi21  g136(.a(x20), .b(new_n71_), .c(x06), .O(new_n170_));
