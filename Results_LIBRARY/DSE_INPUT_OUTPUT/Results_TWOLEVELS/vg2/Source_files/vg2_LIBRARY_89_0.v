...
module FAU ( 
  ...
  nand4  g082(.a(new_n95_), .b(x08), .c(x06), .d(x03), .O(new_n116_));
  nor2   g083(.a(x24), .b(new_n98_), .O(new_n117_));
  nor2   g084(.a(new_n103_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n117_), .c(x20), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n116_), .c(x01), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n109_), .O(new_n121_));
  nand3  g088(.a(new_n54_), .b(x03), .c(x01), .O(new_n122_));
  nand3  g089(.a(new_n118_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n66_), .b(new_n34_), .c(new_n62_), .O(new_n124_));
  nand3  g091(.a(new_n71_), .b(new_n103_), .c(new_n36_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n77_), .O(new_n127_));
  nand3  g094(.a(new_n118_), .b(x20), .c(x18), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n62_), .O(new_n129_));
  nand4  g096(.a(new_n37_), .b(new_n103_), .c(new_n36_), .d(new_n53_), .O(new_n130_));
  ...
  oai21  g102(.a(x23), .b(new_n63_), .c(new_n135_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n139_), .b(new_n109_), .c(x00), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n45_), .c(new_n43_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n42_), .c(new_n138_), .O(new_n142_));
  inv1   g109(.a(x16), .O(new_n143_));
  inv1   g110(.a(x23), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n61_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n143_), .c(x08), .O(new_n147_));
  oai21  g114(.a(new_n111_), .b(new_n106_), .c(new_n147_), .O(new_n148_));
  nand2  g115(.a(new_n109_), .b(new_n62_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n148_), .c(new_n142_), .O(z4));
  oai21  g117(.a(new_n46_), .b(new_n42_), .c(new_n149_), .O(new_n151_));
  nand4  g118(.a(new_n139_), .b(new_n109_), .c(x01), .d(x00), .O(new_n152_));
  ...
  oai21  g126(.a(new_n159_), .b(new_n106_), .c(new_n149_), .O(new_n160_));
  nand3  g127(.a(new_n117_), .b(new_n92_), .c(new_n95_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(z7));
  nand2  g129(.a(z7), .b(new_n158_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n156_), .O(z6));
endmodule
