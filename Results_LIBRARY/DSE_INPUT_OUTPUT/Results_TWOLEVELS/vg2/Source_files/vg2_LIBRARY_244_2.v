// Benchmark "FAU" written by ABC on Wed Aug 19 21:58:19 2020
...
module FAU ( 
  ...
  nand2  g045(.a(new_n45_), .b(new_n39_), .O(new_n79_));
  ...
  nand3  g050(.a(new_n64_), .b(x20), .c(x18), .O(new_n84_));
  nor2   g051(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g052(.a(new_n85_), .b(new_n60_), .O(new_n86_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n36_), .c(new_n37_), .d(new_n35_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n76_), .c(new_n90_), .d(new_n89_), .O(new_n94_));
  oai21  g061(.a(new_n94_), .b(new_n88_), .c(new_n86_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n79_), .c(x24), .O(new_n96_));
  inv1   g063(.a(new_n59_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n57_), .c(new_n49_), .d(x01), .O(new_n98_));
  inv1   g065(.a(new_n83_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n64_), .c(x21), .d(x20), .O(new_n100_));
  nor2   g067(.a(x03), .b(x01), .O(new_n101_));
  nor2   g068(.a(x06), .b(x04), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n87_), .d(x00), .O(new_n103_));
  oai22  g070(.a(new_n103_), .b(new_n94_), .c(new_n100_), .d(new_n98_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n41_), .c(new_n50_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n96_), .c(new_n82_), .d(new_n38_), .O(z1));
  ...
  nand4  g081(.a(new_n41_), .b(x21), .c(new_n50_), .d(new_n49_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n114_), .c(new_n90_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x14), .c(x11), .d(x06), .O(new_n117_));
  nor3   g084(.a(new_n117_), .b(new_n55_), .c(new_n107_), .O(z2));
  inv1   g085(.a(x08), .O(new_n119_));
  nand3  g086(.a(x15), .b(x13), .c(x05), .O(new_n120_));
  nand3  g087(.a(x21), .b(new_n50_), .c(new_n49_), .O(new_n121_));
  ...
  nand4  g097(.a(new_n130_), .b(new_n34_), .c(new_n55_), .d(new_n107_), .O(new_n131_));
  ...
  nand3  g102(.a(new_n101_), .b(x07), .c(new_n34_), .O(new_n136_));
  nand4  g103(.a(new_n90_), .b(new_n36_), .c(new_n35_), .d(new_n119_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n79_), .c(x24), .O(new_n139_));
  nand4  g106(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n140_));
  nand2  g107(.a(new_n101_), .b(new_n70_), .O(new_n141_));
  nand3  g108(.a(new_n75_), .b(new_n36_), .c(new_n35_), .O(new_n142_));
  ...
  nand2  g112(.a(new_n51_), .b(new_n48_), .O(z5));
  oai21  g113(.a(x23), .b(new_n56_), .c(new_n89_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n62_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n119_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(z5), .O(new_n150_));
  nand2  g117(.a(new_n115_), .b(new_n114_), .O(z7));
  oai21  g118(.a(new_n63_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n68_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n91_), .c(x08), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(z7), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n150_), .O(z4));
  nand2  g123(.a(x20), .b(new_n36_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n34_), .c(x11), .O(new_n158_));
  nand3  g125(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n43_), .c(new_n158_), .d(x03), .O(new_n160_));
  nand2  g127(.a(new_n90_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n35_), .O(new_n162_));
  nand3  g129(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n110_), .c(new_n162_), .d(new_n55_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n160_), .c(new_n38_), .O(z6));
endmodule
