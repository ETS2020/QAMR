...
module FAU ( 
  ...
  oai21  g106(.a(x23), .b(new_n56_), .c(new_n89_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n62_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n127_), .O(new_n142_));
  inv1   g109(.a(new_n43_), .O(new_n143_));
  nand4  g110(.a(new_n51_), .b(new_n46_), .c(new_n44_), .d(new_n143_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  inv1   g112(.a(new_n109_), .O(new_n146_));
  inv1   g113(.a(new_n113_), .O(new_n147_));
  ...
  nand3  g119(.a(new_n152_), .b(new_n145_), .c(new_n38_), .O(z4));
  and2   g120(.a(new_n46_), .b(new_n38_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n51_), .c(new_n44_), .d(new_n143_), .O(z5));
  ...
  nand2  g125(.a(new_n90_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n35_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n55_), .c(new_n148_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n38_), .O(z6));
  and2   g129(.a(new_n110_), .b(new_n38_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n112_), .c(new_n111_), .d(new_n146_), .O(z7));
endmodule
