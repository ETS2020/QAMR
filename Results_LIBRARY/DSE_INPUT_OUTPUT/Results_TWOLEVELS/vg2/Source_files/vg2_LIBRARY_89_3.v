...
module FAU ( 
  ...
  nand3  g120(.a(new_n135_), .b(new_n45_), .c(new_n44_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n112_), .c(new_n111_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n150_), .c(new_n153_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n149_), .c(new_n53_), .O(z4));
  nand2  g124(.a(new_n48_), .b(new_n43_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n42_), .c(new_n53_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n46_), .O(z5));
  aoi21  g127(.a(x20), .b(new_n72_), .c(x06), .O(new_n161_));
  ...
  nand3  g132(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n53_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n154_), .O(z7));
