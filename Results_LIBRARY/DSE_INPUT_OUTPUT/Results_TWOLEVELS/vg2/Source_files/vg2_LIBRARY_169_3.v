...
module FAU ( 
  ...
  nor2   g033(.a(new_n54_), .b(new_n34_), .O(new_n67_));
  ...
  nor4   g047(.a(new_n80_), .b(new_n58_), .c(new_n71_), .d(new_n36_), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(new_n54_), .c(x06), .d(x03), .O(new_n82_));
  ...
  aoi21  g053(.a(new_n86_), .b(new_n85_), .c(new_n58_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(x14), .c(x11), .d(new_n54_), .O(new_n88_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n58_), .c(new_n71_), .d(new_n36_), .O(new_n94_));
  nor2   g061(.a(new_n94_), .b(x08), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n96_));
  ...
  nand4  g072(.a(new_n58_), .b(new_n71_), .c(new_n36_), .d(new_n84_), .O(new_n106_));
  ...
  nand4  g079(.a(new_n58_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n113_));
  ...
  nand2  g085(.a(new_n56_), .b(x09), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n84_), .c(x03), .O(new_n120_));
  inv1   g087(.a(x22), .O(new_n121_));
  oai21  g088(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n121_), .c(new_n56_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(new_n54_), .c(new_n120_), .O(new_n125_));
  oai21  g092(.a(new_n59_), .b(x04), .c(x17), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(x22), .c(new_n34_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(x09), .O(new_n128_));
  aoi22  g095(.a(new_n128_), .b(x16), .c(new_n68_), .d(new_n84_), .O(new_n129_));
  ...
  nand4  g099(.a(new_n68_), .b(new_n132_), .c(new_n42_), .d(new_n131_), .O(z5));
  nand2  g100(.a(x20), .b(new_n71_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n35_), .c(x11), .O(new_n135_));
  nor2   g102(.a(x09), .b(new_n34_), .O(new_n136_));
  aoi21  g103(.a(new_n135_), .b(new_n34_), .c(new_n136_), .O(new_n137_));
  nand2  g104(.a(new_n58_), .b(x14), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(x06), .c(new_n36_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n54_), .c(new_n34_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n80_), .c(new_n137_), .d(new_n49_), .O(z6));
  inv1   g108(.a(new_n74_), .O(new_n142_));
  nand4  g109(.a(new_n78_), .b(new_n75_), .c(new_n142_), .d(new_n68_), .O(z7));
endmodule
