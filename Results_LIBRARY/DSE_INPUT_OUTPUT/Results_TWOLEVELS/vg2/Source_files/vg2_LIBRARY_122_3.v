...
module FAU ( 
  ...
  nand3  g084(.a(new_n68_), .b(new_n34_), .c(new_n96_), .O(new_n118_));
  nand3  g085(.a(new_n73_), .b(new_n103_), .c(new_n36_), .O(new_n119_));
  oai22  g086(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n115_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n79_), .O(new_n121_));
  nand2  g088(.a(new_n116_), .b(new_n83_), .O(new_n122_));
  nand4  g089(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n96_), .O(new_n123_));
  ...
  nand3  g094(.a(new_n127_), .b(new_n77_), .c(x24), .O(new_n128_));
  nand3  g095(.a(new_n125_), .b(new_n68_), .c(new_n36_), .O(new_n129_));
  nand2  g096(.a(new_n116_), .b(new_n93_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n115_), .c(new_n129_), .d(new_n97_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n40_), .c(new_n45_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n128_), .c(new_n121_), .d(new_n53_), .O(z3));
  or2    g100(.a(new_n49_), .b(new_n42_), .O(new_n134_));
  oai21  g101(.a(x23), .b(new_n95_), .c(new_n60_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n62_), .c(x09), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x16), .c(new_n124_), .O(new_n137_));
  ...
  nand4  g111(.a(new_n144_), .b(new_n108_), .c(new_n107_), .d(new_n143_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n138_), .c(new_n53_), .O(z4));
  nand2  g114(.a(new_n48_), .b(new_n43_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n42_), .c(new_n53_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n46_), .O(z5));
  nand2  g117(.a(x20), .b(new_n103_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n35_), .c(x11), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x03), .c(new_n134_), .O(new_n153_));
  oai21  g120(.a(new_n36_), .b(x06), .c(x03), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n145_), .O(new_n155_));
  oai21  g122(.a(new_n110_), .b(new_n106_), .c(new_n37_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n36_), .c(new_n44_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x14), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n153_), .O(z6));
  and2   g126(.a(new_n108_), .b(new_n107_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n144_), .c(new_n143_), .d(new_n53_), .O(z7));
endmodule
