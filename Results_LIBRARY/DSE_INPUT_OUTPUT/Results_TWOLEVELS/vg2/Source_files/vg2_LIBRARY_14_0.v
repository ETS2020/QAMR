...
module FAU ( 
  ...
  oai21  g087(.a(new_n117_), .b(new_n52_), .c(new_n120_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n119_), .c(x20), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n39_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x11), .c(x06), .d(x03), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n35_), .c(new_n116_), .O(z2));
  nand3  g092(.a(new_n62_), .b(x03), .c(x01), .O(new_n126_));
  ...
  oai22  g104(.a(new_n137_), .b(new_n126_), .c(new_n134_), .d(new_n38_), .O(new_n138_));
  ...
  oai21  g110(.a(x23), .b(new_n70_), .c(new_n92_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n143_), .c(x09), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n61_), .O(new_n146_));
  nor2   g113(.a(new_n54_), .b(new_n50_), .O(new_n147_));
  nor2   g114(.a(x12), .b(x02), .O(new_n148_));
  nor2   g115(.a(x24), .b(new_n93_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n103_), .c(new_n34_), .d(x00), .O(new_n150_));
  ...
  nor2   g123(.a(new_n121_), .b(new_n119_), .O(new_n157_));
  nand4  g124(.a(new_n113_), .b(x12), .c(new_n103_), .d(new_n34_), .O(new_n158_));
  oai21  g125(.a(new_n148_), .b(new_n157_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n152_), .O(z4));
  nand3  g128(.a(new_n41_), .b(new_n103_), .c(x00), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x12), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n147_), .O(z5));
  aoi21  g132(.a(x20), .b(new_n39_), .c(x06), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x11), .c(new_n36_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n151_), .O(new_n168_));
  aoi21  g135(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n46_), .c(x03), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n159_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n168_), .O(z6));
  aoi21  g139(.a(new_n113_), .b(new_n103_), .c(new_n93_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x02), .c(new_n157_), .O(z7));
endmodule
