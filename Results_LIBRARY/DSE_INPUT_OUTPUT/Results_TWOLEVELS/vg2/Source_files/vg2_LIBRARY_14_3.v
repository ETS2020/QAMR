...
module FAU ( 
  ...
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n67_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n101_), .b(new_n67_), .c(new_n35_), .O(new_n140_));
  nand4  g107(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n141_));
  ...
  nand3  g110(.a(new_n143_), .b(new_n138_), .c(new_n53_), .O(new_n144_));
  inv1   g111(.a(new_n144_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n132_), .O(z3));
  oai21  g113(.a(x23), .b(new_n55_), .c(new_n74_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n62_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n67_), .O(new_n149_));
  nand2  g116(.a(new_n48_), .b(new_n43_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n42_), .c(new_n53_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n46_), .O(new_n152_));
  ...
  nand2  g123(.a(new_n112_), .b(new_n111_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n110_), .c(new_n53_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n113_), .O(new_n159_));
  ...
  nand4  g130(.a(new_n163_), .b(new_n53_), .c(new_n48_), .d(new_n162_), .O(z5));
  ...
  inv1   g138(.a(new_n110_), .O(new_n172_));
  and2   g139(.a(new_n113_), .b(new_n112_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n111_), .c(new_n172_), .d(new_n53_), .O(z7));
endmodule
