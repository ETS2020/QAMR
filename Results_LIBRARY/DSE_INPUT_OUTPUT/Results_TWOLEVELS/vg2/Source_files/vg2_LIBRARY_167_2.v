...
module FAU ( 
  ...
  nand3  g107(.a(new_n140_), .b(new_n56_), .c(new_n54_), .O(new_n141_));
  or2    g108(.a(new_n141_), .b(new_n53_), .O(new_n142_));
  ...
  nor2   g115(.a(x24), .b(new_n148_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n37_), .c(new_n34_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nor2   g119(.a(x02), .b(new_n35_), .O(new_n153_));
  inv1   g120(.a(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n152_), .c(new_n143_), .O(z4));
  oai21  g122(.a(new_n57_), .b(new_n53_), .c(new_n154_), .O(new_n156_));
  nand4  g123(.a(new_n139_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(z5));
  nand2  g125(.a(x20), .b(new_n42_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n36_), .c(x11), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x03), .c(new_n142_), .O(new_n161_));
  nand2  g128(.a(new_n48_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n41_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n47_), .c(new_n151_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n154_), .O(z6));
  nand2  g132(.a(new_n154_), .b(new_n113_), .O(new_n166_));
  nand4  g133(.a(new_n149_), .b(new_n37_), .c(new_n34_), .d(new_n35_), .O(new_n167_));
