...
module FAU ( 
  ...
  nand4  g095(.a(new_n76_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n129_));
  ...
  nand3  g099(.a(new_n35_), .b(new_n34_), .c(new_n64_), .O(new_n133_));
  nand4  g100(.a(new_n68_), .b(new_n36_), .c(new_n66_), .d(x07), .O(new_n134_));
  nand3  g101(.a(x06), .b(x03), .c(x01), .O(new_n135_));
  nand3  g102(.a(new_n91_), .b(x11), .c(x08), .O(new_n136_));
  ...
  nand4  g105(.a(x19), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n139_));
  nand4  g106(.a(x20), .b(x15), .c(x11), .d(x08), .O(new_n140_));
  ...
  nor2   g109(.a(new_n71_), .b(x14), .O(new_n143_));
  ...
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n144_), .O(z6));
  nor2   g132(.a(new_n143_), .b(new_n123_), .O(z7));
endmodule
