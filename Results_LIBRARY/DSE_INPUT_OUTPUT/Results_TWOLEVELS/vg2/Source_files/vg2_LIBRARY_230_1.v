...
module FAU ( 
  ...
  nand4  g116(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n48_), .c(new_n44_), .O(new_n151_));
  or2    g118(.a(new_n151_), .b(new_n43_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  or2    g120(.a(new_n117_), .b(new_n113_), .O(new_n154_));
  ...
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n121_), .O(z4));
  nand2  g126(.a(new_n48_), .b(new_n44_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n43_), .c(new_n121_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n150_), .O(z5));
  nand2  g129(.a(x20), .b(new_n67_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n36_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n152_), .O(new_n165_));
  nand2  g132(.a(new_n38_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n37_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n35_), .c(new_n154_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n121_), .O(z6));
  nand2  g136(.a(new_n115_), .b(new_n114_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n113_), .c(new_n121_), .O(new_n171_));
