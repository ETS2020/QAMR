...
module FAU ( 
  ...
  and2   g121(.a(new_n142_), .b(new_n50_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n139_), .c(new_n45_), .d(new_n44_), .O(z5));
  nand2  g123(.a(x20), .b(new_n38_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n36_), .c(x11), .O(new_n158_));
  nand3  g125(.a(new_n155_), .b(new_n45_), .c(new_n44_), .O(new_n159_));
  oai21  g126(.a(new_n158_), .b(x03), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n39_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n37_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n35_), .c(new_n113_), .d(new_n109_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n139_), .O(z6));
  nand4  g131(.a(new_n139_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n165_));
