...
module FAU ( 
  ...
  nand2  g077(.a(new_n41_), .b(x21), .O(new_n111_));
  ...
  oai21  g124(.a(x23), .b(new_n71_), .c(new_n100_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n75_), .c(x09), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x16), .c(new_n126_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  oai21  g128(.a(new_n76_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n81_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n102_), .c(x08), .O(new_n164_));
  inv1   g131(.a(new_n38_), .O(new_n165_));
  nor2   g132(.a(x10), .b(x02), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n112_), .c(new_n55_), .O(new_n167_));
  oai21  g134(.a(new_n122_), .b(new_n165_), .c(new_n167_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n164_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n161_), .O(z4));
  nor2   g137(.a(new_n47_), .b(new_n43_), .O(new_n171_));
  ...
  nand4  g144(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n46_), .c(new_n44_), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(new_n43_), .c(new_n177_), .d(x03), .O(new_n180_));
  nand2  g147(.a(new_n101_), .b(x14), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(x06), .c(new_n35_), .O(new_n182_));
  nand2  g149(.a(new_n166_), .b(new_n112_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n120_), .c(new_n119_), .O(new_n184_));
  oai22  g151(.a(new_n184_), .b(new_n118_), .c(new_n182_), .d(new_n70_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n180_), .c(new_n38_), .O(z6));
  aoi21  g153(.a(new_n112_), .b(new_n49_), .c(x12), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(x02), .c(new_n122_), .O(z7));
endmodule
