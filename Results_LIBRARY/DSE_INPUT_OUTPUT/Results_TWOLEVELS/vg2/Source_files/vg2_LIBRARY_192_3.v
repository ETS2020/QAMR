...
module FAU ( 
  ...
  nor2   g033(.a(new_n55_), .b(new_n35_), .O(new_n67_));
  ...
  nor3   g045(.a(new_n78_), .b(new_n58_), .c(new_n70_), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(x11), .c(x03), .d(x01), .O(new_n80_));
  aoi21  g047(.a(new_n80_), .b(new_n55_), .c(new_n35_), .O(z2));
  inv1   g048(.a(x08), .O(new_n82_));
  nand3  g049(.a(x15), .b(x13), .c(x05), .O(new_n83_));
  nand3  g050(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n84_));
  aoi21  g051(.a(new_n84_), .b(new_n83_), .c(new_n58_), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(x14), .c(new_n55_), .d(x11), .O(new_n86_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n58_), .c(new_n70_), .d(new_n36_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n82_), .c(new_n35_), .d(new_n34_), .O(new_n94_));
  oai21  g061(.a(new_n94_), .b(x01), .c(new_n88_), .O(new_n95_));
  nand2  g062(.a(new_n95_), .b(new_n39_), .O(new_n96_));
  nand4  g063(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nor2   g065(.a(x12), .b(new_n36_), .O(new_n99_));
  nand3  g066(.a(x20), .b(x18), .c(x14), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n99_), .c(new_n98_), .O(new_n102_));
  nor2   g069(.a(x03), .b(x01), .O(new_n103_));
  nand4  g070(.a(new_n58_), .b(new_n70_), .c(new_n36_), .d(new_n82_), .O(new_n104_));
  ...
  nand3  g076(.a(new_n109_), .b(new_n99_), .c(new_n98_), .O(new_n110_));
  nand4  g077(.a(new_n58_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n111_));
  inv1   g078(.a(new_n111_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n103_), .c(new_n82_), .d(new_n35_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n110_), .c(x13), .O(new_n114_));
  aoi22  g081(.a(new_n114_), .b(new_n37_), .c(new_n107_), .d(x24), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n96_), .O(z3));
  inv1   g083(.a(new_n49_), .O(new_n117_));
  inv1   g084(.a(x22), .O(new_n118_));
  oai21  g085(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n118_), .c(x09), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(x16), .c(new_n82_), .O(new_n121_));
  ...
  aoi21  g094(.a(new_n127_), .b(new_n122_), .c(new_n67_), .O(z4));
  inv1   g095(.a(new_n41_), .O(new_n129_));
  and2   g096(.a(new_n45_), .b(new_n42_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n68_), .c(new_n47_), .d(new_n129_), .O(z5));
  nand2  g098(.a(x20), .b(new_n70_), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n35_), .c(x11), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x03), .c(new_n117_), .O(new_n134_));
  nand2  g101(.a(new_n58_), .b(x14), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x06), .c(new_n36_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n34_), .c(new_n123_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n134_), .c(new_n68_), .O(z6));
  nor2   g105(.a(new_n78_), .b(new_n67_), .O(z7));
endmodule
