...
module FAU ( 
  ...
  nand2  g076(.a(x23), .b(new_n34_), .O(new_n110_));
  nand2  g077(.a(x24), .b(x18), .O(new_n111_));
  nand3  g078(.a(new_n42_), .b(x15), .c(x13), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n111_), .c(new_n48_), .O(new_n113_));
  nand3  g080(.a(x24), .b(x18), .c(x13), .O(new_n114_));
  nand3  g081(.a(x15), .b(new_n53_), .c(new_n48_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n113_), .c(new_n110_), .O(new_n117_));
  nand4  g084(.a(new_n105_), .b(x21), .c(new_n102_), .d(new_n34_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n117_), .c(new_n41_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x14), .c(x11), .d(x06), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n37_), .c(new_n36_), .O(z2));
  nand4  g088(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  nor2   g089(.a(new_n40_), .b(new_n47_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(x20), .c(x15), .O(new_n124_));
  nand3  g091(.a(new_n72_), .b(new_n37_), .c(new_n36_), .O(new_n125_));
  nand3  g092(.a(new_n77_), .b(new_n40_), .c(new_n47_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n122_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n83_), .O(new_n128_));
  nand2  g095(.a(new_n123_), .b(new_n87_), .O(new_n129_));
  nand3  g096(.a(new_n91_), .b(new_n37_), .c(new_n36_), .O(new_n130_));
  nand4  g097(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n89_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n122_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n81_), .c(x24), .O(new_n133_));
  nand3  g100(.a(new_n123_), .b(x21), .c(x20), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n122_), .c(new_n131_), .d(new_n39_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n42_), .c(new_n102_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n35_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n34_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n133_), .c(new_n128_), .O(z3));
  nand2  g106(.a(x22), .b(new_n65_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x09), .c(new_n94_), .O(new_n141_));
  nand4  g108(.a(new_n42_), .b(x21), .c(new_n102_), .d(new_n34_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n115_), .c(new_n114_), .O(new_n143_));
  or2    g110(.a(new_n143_), .b(new_n113_), .O(new_n144_));
  oai21  g111(.a(new_n141_), .b(new_n89_), .c(new_n144_), .O(new_n145_));
  aoi21  g112(.a(new_n35_), .b(x04), .c(x17), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x22), .c(new_n70_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n94_), .c(x08), .O(new_n148_));
  inv1   g115(.a(x04), .O(new_n149_));
  nand4  g116(.a(new_n68_), .b(x16), .c(x15), .d(new_n149_), .O(new_n150_));
  oai21  g117(.a(new_n148_), .b(new_n76_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n83_), .O(new_n152_));
  nand4  g119(.a(new_n68_), .b(x18), .c(x16), .d(new_n149_), .O(new_n153_));
  oai21  g120(.a(new_n148_), .b(new_n90_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n81_), .c(x24), .O(new_n155_));
  nor2   g122(.a(x17), .b(x04), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n70_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n94_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n89_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n42_), .c(new_n102_), .d(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n35_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n34_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n155_), .c(new_n152_), .d(new_n145_), .O(z4));
  nand3  g130(.a(new_n42_), .b(new_n102_), .c(x00), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n35_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n34_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n56_), .O(z5));
  nand2  g134(.a(x20), .b(new_n40_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n38_), .c(x11), .O(new_n169_));
  nand4  g136(.a(new_n42_), .b(new_n102_), .c(new_n34_), .d(x00), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n54_), .c(new_n52_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n51_), .c(new_n169_), .d(x03), .O(new_n172_));
  nand2  g139(.a(new_n41_), .b(x14), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x06), .c(new_n47_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n37_), .c(new_n144_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n110_), .O(z6));
  nor2   g143(.a(new_n116_), .b(new_n113_), .O(new_n177_));
  nand3  g144(.a(new_n42_), .b(x21), .c(new_n102_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n35_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n34_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n177_), .O(z7));
endmodule
