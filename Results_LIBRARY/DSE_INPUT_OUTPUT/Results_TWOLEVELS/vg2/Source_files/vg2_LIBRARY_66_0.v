...
module FAU ( 
  ...
  nor2   g18(.a(x23), .b(x22), .O(new_n52_));
  ...
  oai21  g39(.a(new_n72_), .b(new_n55_), .c(new_n53_), .O(z1));
  ...
  aoi21  g72(.a(new_n105_), .b(new_n92_), .c(new_n52_), .O(z3));
  inv1   g73(.a(new_n49_), .O(new_n107_));
  ...
  aoi21  g84(.a(new_n117_), .b(new_n112_), .c(new_n52_), .O(new_n118_));
  nand2  g85(.a(new_n118_), .b(new_n111_), .O(z4));
  nor2   g86(.a(new_n52_), .b(new_n49_), .O(z5));
  nand2  g87(.a(x20), .b(new_n57_), .O(new_n121_));
  aoi21  g88(.a(new_n121_), .b(new_n35_), .c(x11), .O(new_n122_));
  oai21  g89(.a(new_n122_), .b(x03), .c(new_n107_), .O(new_n123_));
  nand2  g90(.a(new_n74_), .b(x14), .O(new_n124_));
  aoi21  g91(.a(new_n124_), .b(x06), .c(new_n36_), .O(new_n125_));
  oai21  g92(.a(new_n125_), .b(new_n34_), .c(new_n112_), .O(new_n126_));
  nand3  g93(.a(new_n126_), .b(new_n123_), .c(new_n53_), .O(z6));
  inv1   g94(.a(new_n61_), .O(new_n128_));
  and2   g95(.a(new_n63_), .b(new_n62_), .O(new_n129_));
  nand4  g96(.a(new_n129_), .b(new_n64_), .c(new_n128_), .d(new_n53_), .O(z7));
endmodule
