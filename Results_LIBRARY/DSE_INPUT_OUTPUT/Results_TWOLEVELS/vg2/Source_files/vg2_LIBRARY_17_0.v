...
module FAU ( 
  ...
  nand3  g112(.a(new_n145_), .b(new_n45_), .c(new_n43_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n42_), .c(new_n143_), .O(new_n147_));
  ...
  nand3  g117(.a(new_n109_), .b(new_n106_), .c(new_n51_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n117_), .c(new_n116_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n115_), .c(new_n150_), .O(new_n153_));
  nor2   g120(.a(x02), .b(x01), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n153_), .c(new_n147_), .O(z4));
  nor2   g123(.a(new_n46_), .b(new_n42_), .O(new_n157_));
  aoi21  g124(.a(new_n144_), .b(x00), .c(new_n105_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(new_n157_), .O(z5));
  aoi21  g126(.a(x20), .b(new_n97_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  nand4  g128(.a(new_n144_), .b(new_n51_), .c(x01), .d(x00), .O(new_n162_));
  oai21  g129(.a(new_n154_), .b(new_n157_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g133(.a(new_n118_), .b(new_n115_), .c(new_n155_), .O(new_n167_));
  nand4  g134(.a(new_n109_), .b(new_n106_), .c(new_n51_), .d(x01), .O(new_n168_));
