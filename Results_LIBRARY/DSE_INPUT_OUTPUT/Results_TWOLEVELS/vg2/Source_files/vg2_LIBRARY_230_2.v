...
module FAU ( 
  ...
  or2    g106(.a(new_n139_), .b(new_n53_), .O(new_n140_));
  ...
  nand3  g114(.a(new_n147_), .b(new_n37_), .c(new_n34_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n110_), .c(new_n109_), .O(new_n149_));
  or2    g116(.a(new_n149_), .b(new_n108_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  nor2   g118(.a(x02), .b(new_n35_), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n141_), .O(z4));
  oai21  g121(.a(new_n57_), .b(new_n53_), .c(new_n153_), .O(new_n155_));
  nand4  g122(.a(new_n137_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n156_));
  ...
  nand2  g127(.a(new_n48_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n41_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n47_), .c(new_n150_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n153_), .O(z6));
  oai21  g131(.a(new_n111_), .b(new_n108_), .c(new_n153_), .O(new_n165_));
  nand4  g132(.a(new_n147_), .b(new_n37_), .c(new_n34_), .d(new_n35_), .O(new_n166_));
