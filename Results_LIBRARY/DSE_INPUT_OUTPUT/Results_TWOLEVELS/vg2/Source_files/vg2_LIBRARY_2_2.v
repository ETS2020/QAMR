...
module FAU ( 
  ...
  nand3  g064(.a(new_n45_), .b(new_n65_), .c(new_n97_), .O(new_n98_));
  nor3   g065(.a(new_n98_), .b(x06), .c(x04), .O(new_n99_));
  nand3  g066(.a(new_n40_), .b(new_n62_), .c(new_n61_), .O(new_n100_));
  nor3   g067(.a(new_n100_), .b(x20), .c(x17), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n99_), .c(new_n96_), .d(new_n90_), .O(new_n102_));
  ...
  nand4  g080(.a(new_n113_), .b(x06), .c(x03), .d(x02), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n94_), .O(z2));
  nand3  g082(.a(new_n67_), .b(new_n34_), .c(x00), .O(new_n116_));
  nor2   g083(.a(x11), .b(x10), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(new_n40_), .c(new_n37_), .d(new_n87_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n116_), .c(new_n94_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n67_), .b(new_n34_), .c(new_n94_), .O(new_n123_));
  ...
  nand4  g094(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n128_));
  ...
  nand4  g111(.a(new_n144_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n145_));
  ...
  nand3  g115(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n94_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n44_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n48_), .c(new_n43_), .d(new_n133_), .O(z5));
  nand2  g119(.a(x20), .b(new_n87_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n35_), .c(x11), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n135_), .O(new_n155_));
  nand2  g122(.a(new_n37_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n36_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n34_), .c(new_n145_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n147_), .O(z6));
  nand3  g126(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n94_), .c(x02), .O(new_n161_));
  or2    g128(.a(new_n161_), .b(new_n111_), .O(z7));
endmodule
