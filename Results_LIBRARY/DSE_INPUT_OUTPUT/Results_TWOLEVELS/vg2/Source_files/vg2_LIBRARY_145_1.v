...
module FAU ( 
  ...
  nor4   g088(.a(new_n121_), .b(new_n71_), .c(new_n68_), .d(new_n53_), .O(new_n122_));
  ...
  nor2   g111(.a(new_n71_), .b(x12), .O(new_n145_));
  inv1   g112(.a(new_n145_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n144_), .c(new_n139_), .d(new_n132_), .O(z3));
  inv1   g114(.a(new_n49_), .O(new_n148_));
  oai21  g115(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n72_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n66_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  inv1   g119(.a(new_n121_), .O(new_n153_));
  ...
  aoi21  g124(.a(new_n157_), .b(new_n152_), .c(new_n145_), .O(z4));
  nor2   g125(.a(new_n145_), .b(new_n49_), .O(z5));
  nand2  g126(.a(x20), .b(new_n68_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x03), .c(new_n148_), .O(new_n162_));
  nand2  g129(.a(new_n71_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n34_), .c(new_n153_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n146_), .O(z6));
  nor2   g133(.a(new_n145_), .b(new_n121_), .O(z7));
endmodule
