...
module FAU ( 
  ...
  nand4  g070(.a(new_n103_), .b(new_n91_), .c(new_n66_), .d(new_n90_), .O(new_n104_));
  ...
  nor2   g077(.a(x12), .b(new_n35_), .O(new_n111_));
  ...
  nor3   g091(.a(new_n124_), .b(new_n69_), .c(new_n53_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x03), .d(x01), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x12), .c(new_n35_), .O(z2));
  nand2  g094(.a(new_n57_), .b(new_n56_), .O(new_n128_));
  ...
  nand4  g099(.a(new_n132_), .b(new_n69_), .c(new_n53_), .d(new_n36_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n135_));
  oai21  g102(.a(new_n131_), .b(new_n64_), .c(new_n135_), .O(new_n136_));
  ...
  nand4  g107(.a(new_n140_), .b(new_n139_), .c(new_n87_), .d(x14), .O(new_n141_));
  nor2   g108(.a(x03), .b(x01), .O(new_n142_));
  nand4  g109(.a(new_n69_), .b(new_n53_), .c(new_n36_), .d(new_n90_), .O(new_n143_));
  inv1   g110(.a(new_n143_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n142_), .c(x07), .d(new_n35_), .O(new_n145_));
  aoi22  g112(.a(new_n145_), .b(new_n141_), .c(new_n46_), .d(new_n37_), .O(new_n146_));
  ...
  nor2   g116(.a(x08), .b(x06), .O(new_n150_));
  nor2   g117(.a(x14), .b(x11), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n150_), .c(new_n142_), .d(new_n107_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n149_), .c(x13), .O(new_n153_));
  aoi22  g120(.a(new_n153_), .b(new_n37_), .c(new_n146_), .d(x24), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n137_), .O(z3));
  inv1   g122(.a(new_n49_), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n70_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n90_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  inv1   g127(.a(new_n124_), .O(new_n161_));
  oai21  g128(.a(new_n55_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n66_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n54_), .c(x08), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n160_), .c(new_n111_), .O(z4));
  inv1   g133(.a(new_n41_), .O(new_n167_));
  and2   g134(.a(new_n45_), .b(new_n42_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n112_), .c(new_n47_), .d(new_n167_), .O(z5));
  nand2  g136(.a(x20), .b(new_n53_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n35_), .c(x11), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x03), .c(new_n156_), .O(new_n172_));
  nand2  g139(.a(new_n69_), .b(x14), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x06), .c(new_n36_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n34_), .c(new_n161_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n112_), .O(z6));
  nor2   g143(.a(new_n124_), .b(new_n111_), .O(z7));
endmodule
