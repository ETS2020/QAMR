...
module FAU ( 
  ...
  oai21  g122(.a(new_n49_), .b(new_n42_), .c(new_n155_), .O(new_n156_));
  oai21  g123(.a(new_n102_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n67_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n91_), .c(x08), .O(new_n159_));
  nand3  g126(.a(new_n144_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n123_), .c(new_n122_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n121_), .c(new_n159_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n156_), .c(new_n53_), .O(z4));
  nand4  g130(.a(new_n53_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n164_));
  or2    g131(.a(new_n164_), .b(new_n42_), .O(z5));
  ...
  oai21  g135(.a(new_n168_), .b(new_n42_), .c(new_n53_), .O(new_n169_));
  ...
  nand2  g140(.a(new_n123_), .b(new_n122_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n121_), .c(new_n53_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n160_), .O(z7));
  nand2  g143(.a(z7), .b(new_n173_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n171_), .O(z6));
endmodule
