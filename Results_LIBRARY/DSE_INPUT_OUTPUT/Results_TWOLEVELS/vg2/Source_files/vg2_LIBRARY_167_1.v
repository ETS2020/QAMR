...
module FAU ( 
  ...
  nor2   g087(.a(new_n120_), .b(new_n92_), .O(z2));
  nor2   g088(.a(new_n104_), .b(new_n36_), .O(new_n122_));
  ...
  nand3  g092(.a(new_n64_), .b(new_n35_), .c(new_n92_), .O(new_n126_));
  ...
  nand4  g097(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n92_), .O(new_n131_));
  nand4  g098(.a(new_n38_), .b(new_n67_), .c(new_n37_), .d(new_n104_), .O(new_n132_));
  ...
  nand2  g101(.a(new_n94_), .b(new_n64_), .O(new_n135_));
  nand4  g102(.a(new_n96_), .b(new_n41_), .c(new_n38_), .d(new_n67_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n135_), .c(new_n34_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n92_), .O(new_n138_));
  nor2   g105(.a(x02), .b(new_n92_), .O(new_n139_));
  ...
  aoi21  g113(.a(new_n146_), .b(new_n79_), .c(x09), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n104_), .O(new_n148_));
  nand4  g115(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n48_), .c(new_n44_), .O(new_n150_));
  or2    g117(.a(new_n150_), .b(new_n43_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  or2    g119(.a(new_n117_), .b(new_n113_), .O(new_n153_));
  oai21  g120(.a(new_n80_), .b(x04), .c(x17), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x22), .c(new_n62_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n68_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g124(.a(x02), .b(new_n92_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n157_), .c(new_n152_), .O(z4));
  nand2  g126(.a(new_n48_), .b(new_n44_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n43_), .c(new_n158_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n149_), .O(z5));
  nand2  g129(.a(x20), .b(new_n67_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n36_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n151_), .O(new_n165_));
  ...
  nand2  g136(.a(new_n115_), .b(new_n114_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n113_), .c(new_n158_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n116_), .O(z7));
endmodule
