...
module FAU ( 
  ...
  nand4  g043(.a(new_n76_), .b(new_n73_), .c(new_n72_), .d(new_n58_), .O(new_n77_));
  ...
  nand4  g047(.a(new_n80_), .b(new_n68_), .c(new_n36_), .d(new_n35_), .O(new_n81_));
  ...
  nor4   g052(.a(new_n85_), .b(new_n68_), .c(new_n36_), .d(new_n35_), .O(new_n86_));
  nand3  g053(.a(x17), .b(x16), .c(x12), .O(new_n87_));
  inv1   g054(.a(new_n87_), .O(new_n88_));
  inv1   g055(.a(x18), .O(new_n89_));
  nor2   g056(.a(new_n34_), .b(new_n89_), .O(new_n90_));
  nor2   g057(.a(new_n59_), .b(new_n73_), .O(new_n91_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n93_), .c(new_n69_), .d(new_n37_), .O(new_n106_));
  nor3   g073(.a(x16), .b(x14), .c(x12), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n97_), .c(x19), .d(new_n72_), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n48_), .c(new_n47_), .O(new_n110_));
  nor2   g077(.a(new_n34_), .b(x14), .O(new_n111_));
  inv1   g078(.a(new_n111_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n110_), .c(new_n100_), .O(new_n113_));
  inv1   g080(.a(new_n113_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n83_), .O(z1));
  nor2   g082(.a(new_n39_), .b(new_n89_), .O(new_n116_));
  ...
  nor2   g091(.a(new_n124_), .b(new_n71_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x14), .c(new_n34_), .O(z2));
  nand2  g094(.a(new_n61_), .b(new_n60_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x20), .c(x11), .d(x08), .O(new_n129_));
  nor4   g096(.a(new_n129_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n130_));
  inv1   g097(.a(x14), .O(new_n131_));
  nand2  g098(.a(new_n75_), .b(new_n74_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n131_), .c(new_n71_), .d(new_n69_), .O(new_n133_));
  nor4   g100(.a(new_n133_), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n130_), .c(new_n39_), .O(new_n135_));
  nand3  g102(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n136_));
  nand4  g103(.a(new_n131_), .b(new_n71_), .c(new_n69_), .d(x07), .O(new_n137_));
  nand3  g104(.a(x06), .b(x03), .c(x01), .O(new_n138_));
  nand3  g105(.a(new_n90_), .b(x11), .c(x08), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n84_), .c(x24), .O(new_n141_));
  nand4  g108(.a(x19), .b(new_n131_), .c(new_n71_), .d(new_n69_), .O(new_n142_));
  nand4  g109(.a(x20), .b(x15), .c(x11), .d(x08), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n138_), .c(new_n142_), .d(new_n136_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n48_), .c(new_n47_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n141_), .c(new_n135_), .d(new_n112_), .O(z3));
  oai21  g113(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n73_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n69_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n52_), .O(new_n150_));
  inv1   g117(.a(new_n124_), .O(new_n151_));
  oai21  g118(.a(new_n59_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n70_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n58_), .c(x08), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n150_), .c(new_n111_), .O(z4));
  nor2   g123(.a(new_n111_), .b(new_n53_), .O(z5));
  oai21  g124(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n158_));
  oai21  g125(.a(new_n71_), .b(x06), .c(x03), .O(new_n159_));
  aoi22  g126(.a(new_n159_), .b(new_n151_), .c(new_n158_), .d(new_n52_), .O(new_n160_));
  nand4  g127(.a(new_n151_), .b(new_n34_), .c(x14), .d(x11), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(new_n111_), .c(new_n161_), .O(z6));
  inv1   g129(.a(new_n119_), .O(new_n163_));
  and2   g130(.a(new_n121_), .b(new_n120_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n122_), .c(new_n163_), .d(new_n112_), .O(z7));
endmodule
