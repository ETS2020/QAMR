...
module FAU ( 
  ...
  nand4  g032(.a(new_n57_), .b(new_n56_), .c(new_n49_), .d(new_n55_), .O(new_n66_));
  inv1   g033(.a(new_n66_), .O(new_n67_));
  nor2   g034(.a(x11), .b(x09), .O(new_n68_));
  nand4  g035(.a(new_n68_), .b(new_n67_), .c(new_n65_), .d(new_n34_), .O(new_n69_));
  ...
  oai21  g042(.a(new_n75_), .b(new_n69_), .c(new_n64_), .O(new_n76_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n82_), .c(new_n61_), .d(new_n59_), .O(new_n86_));
  ...
  nand3  g061(.a(new_n61_), .b(x21), .c(x20), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n59_), .O(new_n97_));
  ...
  nand4  g075(.a(new_n41_), .b(x21), .c(new_n50_), .d(new_n49_), .O(new_n109_));
  ...
  oai21  g080(.a(new_n113_), .b(new_n55_), .c(new_n38_), .O(z2));
  nand3  g081(.a(x15), .b(x13), .c(x05), .O(new_n115_));
  nand3  g082(.a(x21), .b(new_n50_), .c(new_n49_), .O(new_n116_));
  ...
  nand3  g087(.a(new_n50_), .b(new_n49_), .c(x00), .O(new_n121_));
  nand3  g088(.a(x19), .b(x13), .c(x05), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n84_), .c(new_n36_), .d(new_n35_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(x08), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n34_), .c(new_n56_), .d(new_n55_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n120_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n41_), .O(new_n128_));
  nand4  g095(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n129_));
  nand3  g096(.a(new_n85_), .b(x14), .c(x11), .O(new_n130_));
  nand3  g097(.a(new_n98_), .b(x07), .c(new_n34_), .O(new_n131_));
  nand4  g098(.a(new_n84_), .b(new_n36_), .c(new_n35_), .d(new_n65_), .O(new_n132_));
  ...
  nand3  g102(.a(new_n98_), .b(new_n65_), .c(new_n34_), .O(new_n136_));
  nand3  g103(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n129_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n45_), .c(new_n39_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n134_), .c(new_n128_), .d(new_n38_), .O(z3));
  ...
  nand3  g112(.a(new_n41_), .b(new_n50_), .c(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n46_), .c(new_n44_), .O(new_n147_));
  inv1   g114(.a(new_n147_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n141_), .c(new_n145_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x02), .c(new_n37_), .O(new_n150_));
  aoi21  g117(.a(x23), .b(new_n57_), .c(new_n143_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n142_), .c(x09), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x16), .c(new_n65_), .O(new_n153_));
  nand2  g120(.a(x08), .b(x07), .O(new_n154_));
  oai21  g121(.a(new_n153_), .b(new_n83_), .c(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n77_), .c(x24), .O(new_n156_));
  inv1   g123(.a(x15), .O(new_n157_));
  oai22  g124(.a(new_n153_), .b(new_n157_), .c(new_n72_), .d(new_n65_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n79_), .O(new_n159_));
  inv1   g126(.a(x21), .O(new_n160_));
  nand2  g127(.a(x08), .b(x00), .O(new_n161_));
  oai21  g128(.a(new_n153_), .b(new_n160_), .c(new_n161_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n41_), .c(new_n50_), .d(new_n49_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n159_), .c(new_n156_), .d(new_n150_), .O(z4));
  and2   g131(.a(new_n46_), .b(new_n38_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n51_), .c(new_n44_), .d(new_n141_), .O(z5));
  nand2  g133(.a(new_n51_), .b(new_n48_), .O(new_n167_));
  ...
  inv1   g137(.a(new_n109_), .O(new_n171_));
  aoi21  g138(.a(new_n84_), .b(x14), .c(new_n34_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n35_), .c(x03), .O(new_n173_));
  inv1   g140(.a(new_n38_), .O(new_n174_));
  inv1   g141(.a(new_n106_), .O(new_n175_));
  and2   g142(.a(new_n108_), .b(new_n107_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n175_), .c(new_n174_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n171_), .c(new_n173_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n170_), .O(z6));
  nand4  g146(.a(new_n176_), .b(new_n109_), .c(new_n175_), .d(new_n38_), .O(z7));
endmodule
