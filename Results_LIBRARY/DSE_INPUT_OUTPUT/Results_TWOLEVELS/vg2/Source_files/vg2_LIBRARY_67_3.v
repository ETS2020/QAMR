...
module FAU ( 
  ...
  nand2  g136(.a(x20), .b(new_n91_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n35_), .c(x11), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n172_));
  inv1   g139(.a(new_n121_), .O(new_n173_));
  nand2  g140(.a(new_n37_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n36_), .O(new_n175_));
  nand3  g142(.a(new_n166_), .b(new_n123_), .c(new_n122_), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n34_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n172_), .c(new_n156_), .O(z6));
endmodule
