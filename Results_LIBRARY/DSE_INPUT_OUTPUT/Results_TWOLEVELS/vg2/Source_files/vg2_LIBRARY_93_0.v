...
module FAU ( 
  ...
  nand3  g044(.a(new_n43_), .b(new_n58_), .c(x00), .O(new_n78_));
  ...
  nand2  g056(.a(new_n47_), .b(new_n37_), .O(new_n90_));
  ...
  nand4  g067(.a(new_n73_), .b(new_n72_), .c(new_n56_), .d(new_n36_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nor2   g069(.a(x23), .b(x22), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n75_), .d(new_n74_), .O(new_n104_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n98_), .c(new_n36_), .d(new_n71_), .O(new_n112_));
  ...
  nand3  g085(.a(new_n118_), .b(new_n47_), .c(new_n37_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n106_), .c(new_n54_), .O(new_n120_));
  ...
  nand3  g093(.a(x15), .b(new_n47_), .c(new_n37_), .O(new_n127_));
  inv1   g094(.a(x21), .O(new_n128_));
  nor2   g095(.a(x24), .b(new_n128_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n43_), .c(new_n58_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n127_), .c(new_n126_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n125_), .c(x20), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n72_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x11), .c(x06), .d(x03), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n68_), .c(new_n54_), .O(z2));
  nand4  g102(.a(new_n60_), .b(x20), .c(x14), .d(x11), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n70_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(x06), .c(x03), .d(x01), .O(new_n138_));
  nand4  g105(.a(new_n80_), .b(new_n75_), .c(new_n72_), .d(new_n36_), .O(new_n139_));
  nor2   g106(.a(new_n139_), .b(x08), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n141_));
  ...
  nand3  g111(.a(new_n95_), .b(x14), .c(x11), .O(new_n145_));
  nand4  g112(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n146_));
  nand4  g113(.a(new_n75_), .b(new_n72_), .c(new_n36_), .d(new_n70_), .O(new_n147_));
  ...
  nand3  g117(.a(new_n111_), .b(new_n34_), .c(new_n68_), .O(new_n151_));
  nand3  g118(.a(new_n116_), .b(new_n72_), .c(new_n36_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n144_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n47_), .c(new_n37_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n149_), .c(new_n143_), .d(new_n54_), .O(z3));
  oai21  g122(.a(x23), .b(new_n69_), .c(new_n74_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n76_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n70_), .O(new_n158_));
  nand2  g125(.a(new_n48_), .b(new_n42_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n41_), .c(new_n54_), .O(new_n160_));
  nand4  g127(.a(new_n45_), .b(new_n39_), .c(x12), .d(new_n43_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  oai21  g130(.a(new_n77_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n71_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n73_), .c(x08), .O(new_n166_));
  nand2  g133(.a(new_n127_), .b(new_n126_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n125_), .c(new_n54_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n130_), .O(z7));
  nand2  g136(.a(z7), .b(new_n166_), .O(new_n170_));
  nand3  g137(.a(new_n129_), .b(new_n45_), .c(new_n43_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n170_), .c(new_n163_), .O(z4));
  nor2   g139(.a(new_n53_), .b(new_n50_), .O(z5));
  aoi21  g140(.a(x20), .b(new_n72_), .c(x06), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x11), .c(new_n34_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n162_), .O(new_n176_));
  aoi21  g143(.a(new_n75_), .b(x14), .c(new_n35_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n36_), .c(x03), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(z7), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n176_), .c(new_n171_), .O(z6));
endmodule
