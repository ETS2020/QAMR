...
module FAU ( 
  ...
  nand3  g117(.a(new_n49_), .b(x21), .c(new_n38_), .O(new_n151_));
  inv1   g118(.a(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n34_), .c(new_n35_), .O(new_n153_));
  oai21  g120(.a(new_n140_), .b(new_n150_), .c(new_n153_), .O(new_n154_));
  ...
  nand3  g125(.a(new_n143_), .b(new_n34_), .c(x00), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n54_), .c(new_n52_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n51_), .c(new_n158_), .d(x03), .O(new_n161_));
  nand2  g128(.a(new_n46_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n40_), .O(new_n163_));
  nand4  g130(.a(new_n49_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n165_));
  oai21  g132(.a(new_n163_), .b(new_n36_), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n161_), .c(new_n141_), .O(z6));
  oai21  g134(.a(new_n152_), .b(x01), .c(new_n34_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n150_), .O(z7));
endmodule
