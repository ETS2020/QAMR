...
module FAU ( 
  ...
  nand4  g025(.a(x15), .b(x13), .c(x12), .d(x05), .O(new_n59_));
  ...
  nand4  g063(.a(new_n57_), .b(new_n56_), .c(new_n70_), .d(new_n36_), .O(new_n97_));
  ...
  nand3  g081(.a(new_n114_), .b(new_n49_), .c(new_n39_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n102_), .c(new_n84_), .O(new_n116_));
  ...
  oai21  g091(.a(new_n124_), .b(new_n121_), .c(new_n84_), .O(new_n125_));
  nor2   g092(.a(x10), .b(x02), .O(new_n126_));
  nand3  g093(.a(new_n41_), .b(x21), .c(x12), .O(new_n127_));
  inv1   g094(.a(new_n127_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n125_), .c(new_n72_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x14), .c(x11), .d(x06), .O(new_n131_));
  nor3   g098(.a(new_n131_), .b(new_n34_), .c(new_n86_), .O(z2));
  ...
  nand2  g105(.a(new_n75_), .b(new_n74_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n72_), .c(new_n56_), .d(new_n36_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(x08), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n35_), .c(new_n34_), .d(new_n86_), .O(new_n142_));
  ...
  nand3  g112(.a(new_n91_), .b(x14), .c(x11), .O(new_n146_));
  nand4  g113(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n86_), .O(new_n147_));
  nand4  g114(.a(new_n72_), .b(new_n56_), .c(new_n36_), .d(new_n133_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n145_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n85_), .c(x24), .O(new_n150_));
  nand4  g117(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n151_));
  nand3  g118(.a(new_n107_), .b(new_n34_), .c(new_n86_), .O(new_n152_));
  nand3  g119(.a(new_n112_), .b(new_n56_), .c(new_n36_), .O(new_n153_));
  ...
  nand4  g122(.a(new_n155_), .b(new_n150_), .c(new_n144_), .d(new_n84_), .O(z3));
  oai21  g123(.a(x23), .b(new_n68_), .c(new_n71_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n73_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n69_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n57_), .c(x08), .O(new_n160_));
  oai21  g127(.a(new_n58_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n69_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n57_), .c(x08), .O(new_n163_));
  inv1   g130(.a(new_n121_), .O(new_n164_));
  nand3  g131(.a(new_n126_), .b(new_n41_), .c(x21), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n123_), .c(new_n122_), .d(new_n164_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n163_), .c(new_n38_), .O(new_n167_));
  oai21  g134(.a(new_n160_), .b(new_n52_), .c(new_n167_), .O(z4));
  inv1   g135(.a(new_n43_), .O(new_n169_));
  inv1   g136(.a(new_n50_), .O(new_n170_));
  nor2   g137(.a(new_n170_), .b(new_n38_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n48_), .c(new_n44_), .d(new_n169_), .O(z5));
  aoi21  g139(.a(x20), .b(new_n56_), .c(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n34_), .O(new_n174_));
  nand2  g141(.a(new_n50_), .b(new_n44_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n43_), .c(new_n84_), .O(new_n176_));
  nand4  g143(.a(new_n47_), .b(new_n41_), .c(new_n37_), .d(new_n45_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand2  g146(.a(new_n129_), .b(new_n125_), .O(new_n180_));
  aoi21  g147(.a(new_n72_), .b(x14), .c(new_n35_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n36_), .c(x03), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n180_), .O(new_n183_));
  inv1   g150(.a(new_n74_), .O(new_n184_));
  nand2  g151(.a(new_n128_), .b(new_n184_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n183_), .c(new_n179_), .O(z6));
  inv1   g153(.a(new_n124_), .O(new_n187_));
  nor3   g154(.a(x24), .b(x10), .c(x02), .O(new_n188_));
  oai21  g155(.a(new_n188_), .b(new_n70_), .c(x21), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n187_), .c(new_n164_), .O(z7));
endmodule
