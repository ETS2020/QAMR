...
module FAU ( 
  ...
  oai21  g115(.a(new_n148_), .b(new_n50_), .c(new_n146_), .O(new_n149_));
  oai21  g116(.a(new_n67_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n70_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n94_), .c(x08), .O(new_n152_));
  nand4  g119(.a(new_n43_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n154_));
  nor2   g121(.a(x02), .b(new_n35_), .O(new_n155_));
  aoi21  g122(.a(new_n154_), .b(new_n152_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n149_), .O(z4));
  nor2   g124(.a(new_n54_), .b(new_n50_), .O(new_n158_));
  nand4  g125(.a(new_n101_), .b(new_n43_), .c(new_n38_), .d(new_n34_), .O(new_n159_));
  oai21  g126(.a(new_n155_), .b(new_n158_), .c(new_n159_), .O(z5));
  aoi21  g127(.a(x20), .b(new_n41_), .c(x06), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x11), .c(new_n36_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(z5), .O(new_n163_));
  aoi21  g130(.a(new_n42_), .b(x14), .c(new_n37_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n40_), .c(x03), .O(new_n165_));
  inv1   g132(.a(new_n117_), .O(new_n166_));
  nand3  g133(.a(new_n43_), .b(x21), .c(new_n38_), .O(new_n167_));
  inv1   g134(.a(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n34_), .c(new_n35_), .O(new_n169_));
  oai21  g136(.a(new_n155_), .b(new_n166_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n165_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n163_), .O(z6));
  oai21  g139(.a(new_n168_), .b(x01), .c(new_n34_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n166_), .O(z7));
endmodule
