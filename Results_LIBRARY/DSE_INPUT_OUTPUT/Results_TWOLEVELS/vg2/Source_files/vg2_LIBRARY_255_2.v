...
module FAU ( 
  ...
  nor2   g058(.a(new_n74_), .b(new_n73_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n88_), .O(new_n93_));
  nor3   g060(.a(x04), .b(x03), .c(x01), .O(new_n94_));
  nand4  g061(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n35_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand4  g063(.a(new_n70_), .b(new_n69_), .c(new_n37_), .d(new_n36_), .O(new_n97_));
  nand4  g064(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n96_), .c(new_n94_), .O(new_n100_));
  aoi22  g067(.a(new_n100_), .b(new_n93_), .c(new_n48_), .d(new_n39_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n36_), .b(new_n68_), .c(new_n67_), .d(new_n35_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n37_), .O(new_n108_));
  nand4  g075(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(x19), .O(new_n109_));
  ...
  aoi22  g079(.a(new_n112_), .b(new_n39_), .c(new_n101_), .d(x24), .O(new_n113_));
  ...
  nand3  g085(.a(x15), .b(new_n48_), .c(new_n39_), .O(new_n119_));
  nand4  g086(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n38_), .O(z7));
  ...
  nor2   g095(.a(new_n128_), .b(new_n67_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  nand4  g097(.a(new_n77_), .b(new_n72_), .c(new_n69_), .d(new_n36_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(x08), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n41_), .O(new_n135_));
  nand2  g102(.a(new_n48_), .b(new_n39_), .O(new_n136_));
  nand4  g103(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand3  g104(.a(new_n91_), .b(x14), .c(x11), .O(new_n138_));
  nand4  g105(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n139_));
  nand4  g106(.a(new_n72_), .b(new_n69_), .c(new_n36_), .d(new_n67_), .O(new_n140_));
  ...
  nand4  g110(.a(new_n67_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n144_));
  nand4  g111(.a(new_n72_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n137_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n48_), .c(new_n39_), .O(new_n147_));
  and2   g114(.a(new_n147_), .b(new_n142_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n135_), .c(new_n38_), .O(z3));
  inv1   g116(.a(new_n38_), .O(new_n150_));
  inv1   g117(.a(new_n51_), .O(new_n151_));
  oai21  g118(.a(x23), .b(new_n66_), .c(new_n71_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n73_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n67_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  inv1   g122(.a(new_n122_), .O(new_n156_));
  oai21  g123(.a(new_n74_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n68_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n70_), .c(x08), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n155_), .c(new_n150_), .O(z4));
  inv1   g128(.a(new_n43_), .O(new_n162_));
  and2   g129(.a(new_n47_), .b(new_n44_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n49_), .c(new_n162_), .d(new_n150_), .O(z5));
  ...
  aoi21  g137(.a(new_n170_), .b(new_n167_), .c(new_n38_), .O(z6));
endmodule
