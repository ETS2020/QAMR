...
module FAU ( 
  ...
  nor2   g095(.a(new_n128_), .b(new_n61_), .O(new_n129_));
  ...
  nand3  g104(.a(new_n62_), .b(x03), .c(x01), .O(new_n138_));
  nand3  g105(.a(new_n110_), .b(x20), .c(x18), .O(new_n139_));
  ...
  nand3  g110(.a(new_n110_), .b(x20), .c(x15), .O(new_n144_));
  nand3  g111(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n145_));
  nand3  g112(.a(new_n78_), .b(new_n39_), .c(new_n46_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n52_), .c(new_n47_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(x12), .O(new_n150_));
  ...
  oai21  g123(.a(x23), .b(new_n70_), .c(new_n156_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n155_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n61_), .O(new_n159_));
  inv1   g126(.a(x00), .O(new_n160_));
  nor2   g127(.a(x02), .b(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n41_), .c(new_n101_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n53_), .c(new_n51_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n50_), .c(new_n159_), .O(new_n164_));
  ...
  oai21  g135(.a(new_n168_), .b(new_n165_), .c(x08), .O(new_n169_));
  nor2   g136(.a(x10), .b(x02), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n111_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n119_), .c(new_n118_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n117_), .c(new_n169_), .O(new_n173_));
  nor2   g140(.a(x12), .b(x02), .O(new_n174_));
  inv1   g141(.a(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n173_), .c(new_n164_), .O(z4));
  nand3  g143(.a(new_n41_), .b(new_n101_), .c(x00), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(x12), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n34_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n55_), .O(z5));
  aoi21  g147(.a(x20), .b(new_n39_), .c(x06), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(x11), .c(new_n36_), .O(new_n182_));
  nand4  g149(.a(new_n161_), .b(new_n41_), .c(x12), .d(new_n101_), .O(new_n183_));
  oai21  g150(.a(new_n174_), .b(new_n55_), .c(new_n183_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  aoi21  g152(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n46_), .c(x03), .O(new_n187_));
  nand3  g154(.a(new_n170_), .b(new_n111_), .c(x12), .O(new_n188_));
  oai21  g155(.a(new_n174_), .b(new_n121_), .c(new_n188_), .O(z7));
  nand2  g156(.a(z7), .b(new_n187_), .O(new_n190_));
