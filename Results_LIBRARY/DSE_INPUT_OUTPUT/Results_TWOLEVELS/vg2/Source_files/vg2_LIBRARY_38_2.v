...
module FAU ( 
  ...
  nand2  g101(.a(new_n44_), .b(x01), .O(new_n135_));
  nand2  g102(.a(new_n48_), .b(new_n43_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n42_), .c(new_n135_), .O(new_n137_));
  nand4  g104(.a(new_n45_), .b(new_n44_), .c(new_n54_), .d(x00), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n137_), .O(z5));
  ...
  oai21  g110(.a(new_n143_), .b(new_n64_), .c(x08), .O(new_n144_));
  nand2  g111(.a(new_n135_), .b(new_n109_), .O(new_n145_));
  inv1   g112(.a(x10), .O(new_n146_));
  nand3  g113(.a(new_n40_), .b(x21), .c(new_n146_), .O(new_n147_));
  inv1   g114(.a(new_n147_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n44_), .c(new_n54_), .O(new_n149_));
  ...
  nand4  g124(.a(new_n40_), .b(x21), .c(new_n146_), .d(new_n44_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n107_), .c(new_n106_), .d(new_n105_), .O(new_n159_));
  oai21  g126(.a(new_n157_), .b(new_n34_), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n155_), .c(new_n135_), .O(z6));
  oai21  g128(.a(new_n148_), .b(x01), .c(new_n44_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n108_), .c(new_n105_), .O(z7));
endmodule
