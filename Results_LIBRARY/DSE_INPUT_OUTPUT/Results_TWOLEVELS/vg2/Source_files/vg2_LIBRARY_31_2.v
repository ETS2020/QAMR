...
module FAU ( 
  ...
  nor2   g055(.a(new_n69_), .b(new_n35_), .O(new_n89_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n96_), .c(new_n36_), .d(new_n70_), .O(new_n111_));
  ...
  nand2  g093(.a(new_n40_), .b(x21), .O(new_n127_));
  ...
  oai21  g100(.a(new_n133_), .b(new_n67_), .c(new_n54_), .O(z2));
  nor2   g101(.a(new_n34_), .b(new_n67_), .O(new_n135_));
  nor2   g102(.a(new_n71_), .b(new_n36_), .O(new_n136_));
  inv1   g103(.a(x15), .O(new_n137_));
  nor2   g104(.a(new_n37_), .b(new_n137_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n136_), .c(new_n135_), .d(new_n89_), .O(new_n139_));
  nand3  g106(.a(new_n110_), .b(new_n34_), .c(new_n67_), .O(new_n140_));
  ...
  nand2  g111(.a(new_n144_), .b(new_n88_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g113(.a(new_n88_), .b(x24), .O(new_n147_));
  nand3  g114(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n148_));
  oai21  g115(.a(new_n147_), .b(new_n97_), .c(new_n148_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n37_), .c(new_n71_), .d(new_n36_), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(x08), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n152_));
  nand3  g119(.a(new_n45_), .b(x08), .c(x06), .O(new_n153_));
  nor3   g120(.a(new_n153_), .b(new_n34_), .c(new_n67_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n136_), .c(new_n128_), .d(x20), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n152_), .c(new_n146_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n44_), .O(new_n157_));
  nand3  g124(.a(new_n143_), .b(new_n47_), .c(new_n38_), .O(new_n158_));
  nand3  g125(.a(x06), .b(x03), .c(x01), .O(new_n159_));
  nand4  g126(.a(x20), .b(x14), .c(x11), .d(x08), .O(new_n160_));
  nand3  g127(.a(new_n98_), .b(new_n34_), .c(new_n67_), .O(new_n161_));
  nand4  g128(.a(new_n37_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(new_n159_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n88_), .c(x24), .O(new_n164_));
  nand4  g131(.a(new_n141_), .b(new_n40_), .c(new_n37_), .d(x19), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n140_), .c(new_n139_), .O(new_n166_));
  ...
  nand2  g136(.a(new_n169_), .b(new_n157_), .O(z3));
  oai21  g137(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n74_), .c(x09), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x16), .c(new_n69_), .O(new_n173_));
  nand3  g140(.a(new_n145_), .b(new_n54_), .c(x19), .O(new_n174_));
  nand2  g141(.a(new_n149_), .b(new_n44_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  aoi21  g144(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n74_), .c(x09), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(x16), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(x08), .c(new_n97_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n88_), .c(x24), .O(new_n182_));
  nand2  g149(.a(x13), .b(x05), .O(new_n183_));
  and2   g150(.a(new_n183_), .b(new_n88_), .O(new_n184_));
  inv1   g151(.a(new_n184_), .O(new_n185_));
  nand2  g152(.a(new_n180_), .b(x08), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n185_), .c(x15), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n182_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(x18), .O(new_n189_));
  inv1   g156(.a(new_n145_), .O(new_n190_));
  oai22  g157(.a(new_n190_), .b(new_n137_), .c(new_n127_), .d(x10), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n186_), .c(new_n44_), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(new_n189_), .c(new_n177_), .O(z4));
  inv1   g160(.a(new_n42_), .O(new_n194_));
  and2   g161(.a(new_n46_), .b(new_n43_), .O(new_n195_));
  nand4  g162(.a(new_n195_), .b(new_n54_), .c(new_n48_), .d(new_n194_), .O(z5));
  nand2  g163(.a(x20), .b(new_n71_), .O(new_n197_));
  aoi21  g164(.a(new_n197_), .b(new_n35_), .c(x11), .O(new_n198_));
  oai22  g165(.a(new_n198_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n199_));
  nand2  g166(.a(new_n37_), .b(x14), .O(new_n200_));
  aoi21  g167(.a(new_n200_), .b(x06), .c(new_n36_), .O(new_n201_));
  oai22  g168(.a(new_n201_), .b(new_n34_), .c(new_n130_), .d(new_n124_), .O(new_n202_));
  nand3  g169(.a(new_n202_), .b(new_n199_), .c(new_n54_), .O(z6));
  nor2   g170(.a(new_n190_), .b(x02), .O(new_n204_));
  nor2   g171(.a(new_n184_), .b(new_n53_), .O(new_n205_));
  oai21  g172(.a(new_n205_), .b(new_n204_), .c(x15), .O(new_n206_));
  nand3  g173(.a(new_n88_), .b(x24), .c(x18), .O(new_n207_));
  nand3  g174(.a(new_n207_), .b(new_n206_), .c(new_n129_), .O(z7));
endmodule
