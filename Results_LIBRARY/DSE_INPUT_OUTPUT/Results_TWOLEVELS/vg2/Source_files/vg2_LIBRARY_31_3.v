...
module FAU ( 
  ...
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n37_), .d(new_n72_), .O(new_n104_));
  ...
  nand3  g093(.a(x15), .b(new_n47_), .c(new_n38_), .O(new_n127_));
  ...
  oai21  g099(.a(new_n132_), .b(new_n66_), .c(new_n53_), .O(z2));
  nand4  g100(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nor2   g101(.a(new_n70_), .b(new_n36_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(x20), .c(x15), .O(new_n136_));
  nand3  g103(.a(new_n111_), .b(new_n34_), .c(new_n66_), .O(new_n137_));
  nand3  g104(.a(new_n116_), .b(new_n70_), .c(new_n36_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n134_), .O(new_n139_));
  nor2   g106(.a(x24), .b(new_n47_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x05), .c(new_n87_), .O(new_n141_));
  inv1   g108(.a(new_n141_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g110(.a(new_n135_), .b(new_n94_), .O(new_n144_));
  nand3  g111(.a(new_n99_), .b(new_n34_), .c(new_n66_), .O(new_n145_));
  nand4  g112(.a(new_n37_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n134_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n88_), .c(x24), .O(new_n148_));
  nand4  g115(.a(new_n35_), .b(new_n34_), .c(new_n66_), .d(x00), .O(new_n149_));
  nand3  g116(.a(new_n135_), .b(x21), .c(x20), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n134_), .c(new_n149_), .d(new_n146_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n40_), .c(new_n45_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n148_), .c(new_n143_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n44_), .O(new_n154_));
  nand2  g121(.a(new_n88_), .b(x24), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(x20), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n157_));
  nor2   g124(.a(new_n157_), .b(new_n98_), .O(new_n158_));
  ...
  nand2  g128(.a(new_n161_), .b(new_n154_), .O(z3));
  oai21  g129(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n73_), .c(x09), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x16), .c(new_n68_), .O(new_n165_));
  nand3  g132(.a(new_n142_), .b(new_n53_), .c(x19), .O(new_n166_));
  nand4  g133(.a(new_n88_), .b(x24), .c(new_n93_), .d(x07), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n166_), .c(new_n46_), .O(new_n168_));
  ...
  nand3  g139(.a(new_n172_), .b(x08), .c(new_n98_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n88_), .c(x24), .d(x18), .O(new_n174_));
  inv1   g141(.a(x15), .O(new_n175_));
  nand3  g142(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n176_));
  oai21  g143(.a(new_n141_), .b(new_n175_), .c(new_n176_), .O(new_n177_));
  nand2  g144(.a(new_n172_), .b(x08), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n174_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n44_), .O(new_n181_));
  nand4  g148(.a(new_n178_), .b(new_n142_), .c(new_n93_), .d(x15), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n181_), .c(new_n169_), .O(z4));
  inv1   g150(.a(new_n42_), .O(new_n184_));
  and2   g151(.a(new_n46_), .b(new_n43_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n53_), .c(new_n48_), .d(new_n184_), .O(z5));
  nand2  g153(.a(x20), .b(new_n70_), .O(new_n187_));
  aoi21  g154(.a(new_n187_), .b(new_n35_), .c(x11), .O(new_n188_));
  oai22  g155(.a(new_n188_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n189_));
  nand2  g156(.a(new_n37_), .b(x14), .O(new_n190_));
  aoi21  g157(.a(new_n190_), .b(x06), .c(new_n36_), .O(new_n191_));
  oai22  g158(.a(new_n191_), .b(new_n34_), .c(new_n129_), .d(new_n125_), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(new_n189_), .c(new_n53_), .O(z6));
  nand3  g160(.a(new_n142_), .b(new_n53_), .c(x15), .O(new_n194_));
  oai21  g161(.a(new_n155_), .b(new_n93_), .c(new_n176_), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n44_), .O(new_n196_));
  nand2  g163(.a(new_n196_), .b(new_n194_), .O(z7));
endmodule
