...
module FAU ( 
  ...
  nand4  g032(.a(new_n55_), .b(new_n50_), .c(new_n65_), .d(new_n64_), .O(new_n66_));
  nor2   g033(.a(new_n66_), .b(x20), .O(new_n67_));
  nand4  g034(.a(new_n67_), .b(new_n63_), .c(new_n62_), .d(new_n61_), .O(new_n68_));
  nor2   g035(.a(new_n68_), .b(x12), .O(new_n69_));
  nand4  g036(.a(new_n69_), .b(new_n36_), .c(new_n60_), .d(new_n59_), .O(new_n70_));
  nor2   g037(.a(new_n70_), .b(x06), .O(new_n71_));
  nand4  g038(.a(new_n71_), .b(new_n58_), .c(new_n34_), .d(new_n57_), .O(new_n72_));
  inv1   g039(.a(x12), .O(new_n73_));
  nand2  g040(.a(x24), .b(x18), .O(new_n74_));
  nand2  g041(.a(x15), .b(x13), .O(new_n75_));
  nand2  g042(.a(new_n39_), .b(x21), .O(new_n76_));
  oai22  g043(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(x15), .O(new_n77_));
  nand2  g044(.a(new_n77_), .b(x05), .O(new_n78_));
  inv1   g045(.a(x15), .O(new_n79_));
  nand2  g046(.a(new_n48_), .b(new_n47_), .O(new_n80_));
  aoi21  g047(.a(new_n80_), .b(new_n74_), .c(new_n79_), .O(new_n81_));
  nor3   g048(.a(x24), .b(x10), .c(x02), .O(new_n82_));
  oai21  g049(.a(new_n82_), .b(new_n81_), .c(x21), .O(new_n83_));
  inv1   g050(.a(new_n74_), .O(new_n84_));
  nand3  g051(.a(new_n84_), .b(new_n79_), .c(x13), .O(new_n85_));
  nand3  g052(.a(new_n85_), .b(new_n83_), .c(new_n78_), .O(new_n86_));
  ...
  nor2   g056(.a(new_n89_), .b(new_n73_), .O(new_n90_));
  ...
  oai21  g066(.a(new_n75_), .b(new_n47_), .c(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(x20), .c(x14), .d(x11), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n59_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(x06), .c(x03), .d(x01), .O(new_n103_));
  nand3  g070(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n104_));
  nand3  g071(.a(x19), .b(x13), .c(x05), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n37_), .c(new_n61_), .d(new_n36_), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(x08), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(new_n35_), .c(new_n34_), .d(new_n57_), .O(new_n109_));
  ...
  nand4  g080(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n57_), .O(new_n114_));
  nand4  g081(.a(new_n37_), .b(new_n61_), .c(new_n36_), .d(new_n59_), .O(new_n115_));
  oai22  g082(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n80_), .c(x24), .O(new_n117_));
  nand4  g084(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n118_));
  nand4  g085(.a(new_n59_), .b(new_n35_), .c(new_n34_), .d(new_n57_), .O(new_n119_));
  nand4  g086(.a(new_n37_), .b(x19), .c(new_n61_), .d(new_n36_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n112_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n48_), .c(new_n47_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n117_), .c(new_n111_), .d(new_n55_), .O(z3));
  oai21  g090(.a(x23), .b(new_n58_), .c(new_n63_), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(new_n64_), .c(x09), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(x16), .c(new_n59_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n50_), .O(new_n127_));
  oai21  g094(.a(new_n65_), .b(x04), .c(x17), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x22), .c(new_n60_), .O(new_n129_));
  ...
  nand2  g100(.a(new_n84_), .b(x13), .O(new_n134_));
  ...
  nand3  g105(.a(new_n138_), .b(new_n127_), .c(new_n55_), .O(z4));
  and2   g106(.a(new_n55_), .b(new_n49_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n46_), .c(new_n43_), .d(new_n42_), .O(z5));
  nand2  g108(.a(x20), .b(new_n61_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n35_), .c(x11), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x03), .c(new_n50_), .O(new_n144_));
  ...
  nand3  g114(.a(new_n147_), .b(new_n144_), .c(new_n55_), .O(z6));
  nand2  g115(.a(new_n80_), .b(x21), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x15), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n136_), .c(new_n134_), .d(new_n133_), .O(z7));
endmodule
