...
module FAU ( 
  ...
  nand2  g076(.a(new_n105_), .b(new_n34_), .O(new_n110_));
  ...
  nand4  g085(.a(new_n118_), .b(new_n41_), .c(x23), .d(x21), .O(new_n119_));
  ...
  nand2  g104(.a(new_n137_), .b(x23), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n34_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n134_), .c(new_n129_), .O(z3));
  nand2  g107(.a(new_n104_), .b(x17), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n69_), .c(x16), .O(new_n142_));
  nand4  g109(.a(new_n41_), .b(new_n101_), .c(new_n34_), .d(x00), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n53_), .c(new_n51_), .O(new_n144_));
  or2    g111(.a(new_n144_), .b(new_n50_), .O(new_n145_));
  oai21  g112(.a(new_n142_), .b(x08), .c(new_n145_), .O(new_n146_));
  inv1   g113(.a(x18), .O(new_n147_));
  inv1   g114(.a(x17), .O(new_n148_));
  aoi21  g115(.a(x23), .b(new_n70_), .c(new_n148_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n104_), .c(x09), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x16), .c(new_n61_), .O(new_n151_));
  inv1   g118(.a(x16), .O(new_n152_));
  nand4  g119(.a(new_n79_), .b(new_n152_), .c(x07), .d(x04), .O(new_n153_));
  oai21  g120(.a(new_n151_), .b(new_n147_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n82_), .c(x24), .O(new_n155_));
  inv1   g122(.a(x15), .O(new_n156_));
  nand4  g123(.a(new_n79_), .b(x19), .c(new_n152_), .d(x04), .O(new_n157_));
  oai21  g124(.a(new_n151_), .b(new_n156_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n84_), .O(new_n159_));
  nand2  g126(.a(x17), .b(x04), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n69_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n152_), .c(x08), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n41_), .c(x21), .d(new_n101_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(x23), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n34_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n159_), .c(new_n155_), .d(new_n146_), .O(z4));
  nand3  g133(.a(new_n41_), .b(new_n101_), .c(x00), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x23), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n34_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n55_), .O(z5));
  nand2  g137(.a(x20), .b(new_n39_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n37_), .c(x11), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x03), .c(new_n145_), .O(new_n173_));
  nand2  g140(.a(new_n40_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n46_), .O(new_n175_));
  nand3  g142(.a(new_n118_), .b(new_n41_), .c(x21), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n115_), .c(new_n114_), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n113_), .c(new_n175_), .d(new_n36_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n173_), .c(new_n110_), .O(z6));
  nor2   g146(.a(new_n116_), .b(new_n113_), .O(new_n180_));
  nand3  g147(.a(new_n41_), .b(x21), .c(new_n101_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(x23), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n34_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n180_), .O(z7));
endmodule
