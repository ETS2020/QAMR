...
module FAU ( 
  ...
  aoi21  g068(.a(new_n101_), .b(new_n93_), .c(new_n86_), .O(new_n102_));
  ...
  nor3   g090(.a(new_n123_), .b(new_n72_), .c(new_n69_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x11), .c(x06), .d(x03), .O(new_n125_));
  nor2   g092(.a(new_n34_), .b(x20), .O(new_n126_));
  inv1   g093(.a(new_n126_), .O(new_n127_));
  oai21  g094(.a(new_n125_), .b(new_n35_), .c(new_n127_), .O(z2));
  ...
  nand4  g098(.a(new_n76_), .b(new_n72_), .c(new_n69_), .d(new_n68_), .O(new_n132_));
  ...
  nor2   g105(.a(new_n69_), .b(new_n68_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n91_), .O(new_n140_));
  nand4  g107(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n72_), .b(new_n69_), .c(new_n68_), .d(new_n66_), .O(new_n142_));
  ...
  nand4  g112(.a(new_n66_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n146_));
  nand4  g113(.a(new_n72_), .b(x19), .c(new_n69_), .d(new_n68_), .O(new_n147_));
  ...
  nand4  g116(.a(new_n149_), .b(new_n144_), .c(new_n136_), .d(new_n127_), .O(z3));
  aoi21  g117(.a(new_n73_), .b(x17), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n66_), .O(new_n152_));
  nor2   g119(.a(x16), .b(new_n65_), .O(new_n153_));
  aoi22  g120(.a(new_n153_), .b(new_n98_), .c(new_n152_), .d(new_n127_), .O(new_n154_));
  aoi21  g121(.a(x22), .b(new_n71_), .c(new_n67_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n70_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n92_), .b(x20), .O(new_n157_));
  nor3   g124(.a(new_n157_), .b(new_n70_), .c(x04), .O(new_n158_));
  aoi21  g125(.a(new_n156_), .b(new_n127_), .c(new_n158_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n123_), .c(new_n154_), .d(new_n50_), .O(z4));
  inv1   g127(.a(new_n42_), .O(new_n161_));
  and2   g128(.a(new_n46_), .b(new_n43_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n127_), .c(new_n48_), .d(new_n161_), .O(z5));
  aoi21  g130(.a(new_n68_), .b(x06), .c(x03), .O(new_n164_));
  aoi21  g131(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n123_), .c(new_n164_), .d(new_n50_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n127_), .O(new_n167_));
  inv1   g134(.a(new_n139_), .O(new_n168_));
  nand4  g135(.a(x20), .b(new_n69_), .c(new_n68_), .d(x00), .O(new_n169_));
  nand3  g136(.a(new_n34_), .b(x21), .c(new_n72_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n168_), .c(new_n169_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n45_), .c(new_n44_), .O(new_n172_));
  nand4  g139(.a(x20), .b(x19), .c(new_n69_), .d(new_n68_), .O(new_n173_));
  nor2   g140(.a(x23), .b(x20), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n139_), .c(x15), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(x13), .c(x05), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n172_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n40_), .O(new_n179_));
  nand4  g146(.a(x20), .b(new_n69_), .c(new_n68_), .d(x07), .O(new_n180_));
  nand3  g147(.a(new_n174_), .b(new_n139_), .c(x18), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n180_), .c(new_n86_), .O(new_n182_));
  aoi21  g149(.a(new_n175_), .b(new_n173_), .c(x13), .O(new_n183_));
  aoi22  g150(.a(new_n183_), .b(new_n38_), .c(new_n182_), .d(x24), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n179_), .c(new_n167_), .O(z6));
  nor2   g152(.a(new_n126_), .b(new_n123_), .O(z7));
endmodule
