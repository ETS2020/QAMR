...
module FAU ( 
  ...
  nand2  g019(.a(x13), .b(x02), .O(new_n53_));
  ...
  nand4  g045(.a(new_n40_), .b(x13), .c(x05), .d(new_n44_), .O(new_n79_));
  nand2  g046(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g047(.a(new_n80_), .b(new_n76_), .O(new_n81_));
  nand2  g048(.a(x13), .b(new_n44_), .O(new_n82_));
  oai21  g049(.a(x13), .b(new_n38_), .c(new_n82_), .O(new_n83_));
  ...
  nand3  g061(.a(new_n94_), .b(new_n83_), .c(x24), .O(new_n95_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n95_), .c(new_n81_), .O(z1));
  ...
  oai21  g082(.a(new_n115_), .b(new_n104_), .c(new_n53_), .O(z2));
  ...
  nand3  g099(.a(new_n86_), .b(x14), .c(x11), .O(new_n133_));
  ...
  nand2  g105(.a(new_n98_), .b(new_n68_), .O(new_n139_));
  nand3  g106(.a(new_n73_), .b(new_n105_), .c(new_n36_), .O(new_n140_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n137_), .c(new_n53_), .O(new_n143_));
  ...
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n117_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  or2    g120(.a(new_n112_), .b(new_n108_), .O(new_n154_));
  ...
  nand3  g126(.a(new_n159_), .b(new_n153_), .c(new_n53_), .O(z4));
  nand2  g127(.a(new_n39_), .b(new_n44_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x13), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n48_), .c(new_n46_), .d(new_n146_), .O(z5));
  nand2  g130(.a(x20), .b(new_n105_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n148_), .O(new_n166_));
  nand2  g133(.a(new_n37_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n36_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n34_), .c(new_n154_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n53_), .O(z6));
  nand2  g137(.a(new_n40_), .b(x15), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n82_), .c(new_n106_), .d(x13), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x05), .O(new_n173_));
  nand3  g140(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n109_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n44_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n110_), .O(z7));
endmodule
