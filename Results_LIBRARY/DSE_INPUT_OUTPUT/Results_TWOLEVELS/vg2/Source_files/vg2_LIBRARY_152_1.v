...
module FAU ( 
  ...
  nand4  g072(.a(new_n105_), .b(new_n93_), .c(new_n71_), .d(new_n70_), .O(new_n106_));
  ...
  nor2   g083(.a(new_n39_), .b(new_n89_), .O(new_n117_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n34_), .c(new_n116_), .O(new_n126_));
  ...
  nand2  g099(.a(new_n75_), .b(new_n74_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n34_), .c(new_n116_), .d(new_n71_), .O(new_n134_));
  ...
  nand3  g107(.a(new_n94_), .b(new_n36_), .c(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n34_), .b(new_n116_), .c(new_n71_), .d(new_n69_), .O(new_n142_));
  ...
  nand3  g112(.a(new_n105_), .b(new_n36_), .c(new_n35_), .O(new_n146_));
  nand4  g113(.a(new_n34_), .b(x19), .c(new_n116_), .d(new_n71_), .O(new_n147_));
  ...
  nand3  g116(.a(new_n149_), .b(new_n144_), .c(new_n138_), .O(z3));
  ...
  oai21  g122(.a(new_n59_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n70_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n58_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n154_), .c(new_n112_), .O(z4));
  nor2   g127(.a(new_n111_), .b(new_n53_), .O(z5));
  oai21  g128(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n52_), .O(new_n163_));
  nand2  g130(.a(new_n34_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n71_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n36_), .c(new_n155_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n112_), .O(z6));
  nor2   g134(.a(new_n125_), .b(new_n111_), .O(z7));
endmodule
