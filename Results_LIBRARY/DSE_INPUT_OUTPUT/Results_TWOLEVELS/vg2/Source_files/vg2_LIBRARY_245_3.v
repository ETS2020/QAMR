...
module FAU ( 
  ...
  nand2  g121(.a(x20), .b(new_n70_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n35_), .c(x11), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n157_));
  nand2  g124(.a(new_n37_), .b(x14), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x06), .c(new_n36_), .O(new_n159_));
  nand3  g126(.a(new_n151_), .b(new_n105_), .c(new_n104_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n103_), .c(new_n159_), .d(new_n34_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n157_), .c(new_n140_), .O(z6));
endmodule
