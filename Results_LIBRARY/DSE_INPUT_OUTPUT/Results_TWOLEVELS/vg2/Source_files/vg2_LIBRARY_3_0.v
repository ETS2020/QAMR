...
module FAU ( 
  ...
  nand4  g035(.a(new_n68_), .b(new_n67_), .c(x02), .d(new_n66_), .O(new_n69_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n70_), .c(x07), .d(new_n34_), .O(new_n90_));
  ...
  oai21  g078(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  ...
  oai21  g089(.a(new_n122_), .b(new_n66_), .c(new_n113_), .O(z2));
  nand3  g090(.a(new_n59_), .b(x03), .c(x01), .O(new_n124_));
  nand3  g091(.a(new_n109_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n71_), .b(new_n67_), .c(new_n66_), .O(new_n126_));
  ...
  nand3  g096(.a(new_n109_), .b(x20), .c(x18), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n131_));
  nand4  g098(.a(new_n102_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n132_));
  ...
  nand4  g101(.a(new_n34_), .b(new_n67_), .c(new_n66_), .d(x00), .O(new_n135_));
  nand3  g102(.a(new_n109_), .b(x21), .c(x20), .O(new_n136_));
  ...
  oai21  g110(.a(x23), .b(new_n68_), .c(new_n143_), .O(new_n144_));
  ...
  aoi21  g114(.a(x23), .b(new_n68_), .c(new_n143_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n142_), .c(x09), .O(new_n149_));
  nand3  g116(.a(new_n110_), .b(new_n50_), .c(new_n37_), .O(new_n150_));
  oai21  g117(.a(new_n120_), .b(new_n38_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g119(.a(new_n116_), .b(x05), .O(new_n153_));
  nand4  g120(.a(new_n150_), .b(new_n118_), .c(new_n117_), .d(new_n153_), .O(new_n154_));
  nand4  g121(.a(new_n42_), .b(new_n50_), .c(x08), .d(x00), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x16), .c(x02), .O(new_n156_));
  aoi21  g123(.a(new_n154_), .b(new_n58_), .c(new_n156_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n152_), .c(new_n147_), .O(z4));
  nor2   g125(.a(new_n48_), .b(new_n44_), .O(new_n159_));
  ...
  nand2  g130(.a(new_n52_), .b(new_n49_), .O(new_n164_));
  ...
  nand4  g137(.a(new_n110_), .b(x16), .c(new_n50_), .d(new_n37_), .O(new_n171_));
  oai21  g138(.a(new_n120_), .b(new_n170_), .c(new_n171_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n167_), .O(z6));
  aoi21  g141(.a(new_n110_), .b(new_n50_), .c(new_n38_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(x02), .c(new_n120_), .O(z7));
endmodule
