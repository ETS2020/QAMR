...
module FAU ( 
  ...
  oai21  g112(.a(new_n145_), .b(new_n143_), .c(new_n139_), .O(new_n146_));
  nor2   g113(.a(x10), .b(x02), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n41_), .c(x21), .d(x19), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n146_), .c(new_n40_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(x14), .c(x11), .d(x06), .O(new_n150_));
  nor3   g117(.a(new_n150_), .b(new_n36_), .c(new_n35_), .O(z2));
  nand4  g118(.a(new_n63_), .b(x20), .c(x14), .d(x11), .O(new_n152_));
  nor2   g119(.a(new_n152_), .b(new_n72_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(x06), .c(x03), .d(x01), .O(new_n154_));
  nand4  g121(.a(new_n80_), .b(new_n40_), .c(new_n39_), .d(new_n46_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(x08), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n154_), .c(x24), .O(new_n158_));
  nand4  g125(.a(new_n90_), .b(new_n40_), .c(new_n39_), .d(new_n46_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(x08), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n161_));
  nand4  g128(.a(new_n101_), .b(x20), .c(x14), .d(x11), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n72_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(x06), .c(x03), .d(x01), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n158_), .c(x19), .O(new_n166_));
  nand4  g133(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n167_));
  nand4  g134(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n168_));
  nand4  g135(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n169_));
  nand4  g136(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n72_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n167_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n89_), .c(x24), .O(new_n172_));
  nand4  g139(.a(new_n127_), .b(x20), .c(x15), .d(x14), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n46_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(x08), .c(x06), .d(x03), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n35_), .c(new_n172_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x02), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n166_), .O(z3));
  oai21  g145(.a(x23), .b(new_n71_), .c(new_n75_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n76_), .c(x09), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x16), .c(new_n72_), .O(new_n181_));
  inv1   g148(.a(new_n50_), .O(new_n182_));
  nand4  g149(.a(new_n41_), .b(new_n61_), .c(new_n34_), .d(x00), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n53_), .c(new_n51_), .d(new_n182_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  oai21  g152(.a(new_n77_), .b(x04), .c(x17), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(x22), .c(new_n73_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(new_n74_), .c(x08), .O(new_n188_));
  inv1   g155(.a(new_n143_), .O(new_n189_));
  nand3  g156(.a(new_n147_), .b(new_n41_), .c(x21), .O(new_n190_));
  nand4  g157(.a(new_n190_), .b(new_n144_), .c(new_n189_), .d(new_n100_), .O(new_n191_));
  nand2  g158(.a(new_n191_), .b(new_n188_), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(new_n185_), .c(new_n139_), .O(z4));
  nand3  g160(.a(new_n41_), .b(new_n61_), .c(x00), .O(new_n194_));
  nand2  g161(.a(new_n194_), .b(x19), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n34_), .O(new_n196_));
  nand2  g163(.a(new_n196_), .b(new_n55_), .O(z5));
  nand2  g164(.a(x20), .b(new_n39_), .O(new_n198_));
  aoi21  g165(.a(new_n198_), .b(new_n37_), .c(x11), .O(new_n199_));
  oai21  g166(.a(new_n199_), .b(x03), .c(new_n184_), .O(new_n200_));
  nand2  g167(.a(new_n40_), .b(x14), .O(new_n201_));
  aoi21  g168(.a(new_n201_), .b(x06), .c(new_n46_), .O(new_n202_));
  oai21  g169(.a(new_n202_), .b(new_n36_), .c(new_n191_), .O(new_n203_));
  nand3  g170(.a(new_n203_), .b(new_n200_), .c(new_n139_), .O(z6));
  nand2  g171(.a(new_n148_), .b(new_n146_), .O(z7));
endmodule
