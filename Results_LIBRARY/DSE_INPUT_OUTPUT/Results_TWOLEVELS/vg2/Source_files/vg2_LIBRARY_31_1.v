...
module FAU ( 
  ...
  nand3  g050(.a(new_n42_), .b(x13), .c(x05), .O(new_n84_));
  ...
  nor2   g055(.a(new_n41_), .b(new_n35_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n69_), .d(new_n62_), .O(new_n90_));
  ...
  oai21  g072(.a(new_n105_), .b(new_n96_), .c(new_n102_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n42_), .c(new_n99_), .O(new_n107_));
  ...
  nor2   g078(.a(new_n40_), .b(new_n47_), .O(new_n112_));
  nor2   g079(.a(x24), .b(new_n100_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n112_), .c(x20), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(new_n111_), .c(new_n35_), .O(new_n115_));
  ...
  nor2   g090(.a(new_n123_), .b(new_n40_), .O(new_n124_));
  ...
  nand3  g095(.a(x21), .b(new_n99_), .c(new_n34_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x20), .c(x14), .d(x11), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n127_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x06), .c(x03), .d(x01), .O(new_n133_));
  nand3  g100(.a(new_n99_), .b(new_n34_), .c(x00), .O(new_n134_));
  nand3  g101(.a(x19), .b(x13), .c(x05), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n41_), .c(new_n40_), .d(new_n47_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(x08), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n133_), .c(x24), .O(new_n140_));
  nand4  g107(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n141_));
  nand3  g108(.a(new_n112_), .b(x20), .c(x15), .O(new_n142_));
  nand2  g109(.a(new_n103_), .b(new_n73_), .O(new_n143_));
  nand3  g110(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n53_), .c(new_n48_), .O(new_n146_));
  inv1   g113(.a(x07), .O(new_n147_));
  oai21  g114(.a(x13), .b(x05), .c(x24), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(x20), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n40_), .c(new_n47_), .d(new_n127_), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n146_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n140_), .c(new_n35_), .O(new_n154_));
  nand2  g121(.a(new_n145_), .b(new_n85_), .O(new_n155_));
  nand2  g122(.a(new_n112_), .b(new_n89_), .O(new_n156_));
  nand3  g123(.a(new_n103_), .b(x07), .c(new_n38_), .O(new_n157_));
  nand4  g124(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n127_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n141_), .O(new_n159_));
  ...
  nand2  g129(.a(new_n162_), .b(new_n154_), .O(z3));
  inv1   g130(.a(x04), .O(new_n164_));
  oai21  g131(.a(x23), .b(new_n164_), .c(new_n65_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n67_), .c(x09), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x16), .c(new_n127_), .O(new_n167_));
  nand2  g134(.a(x18), .b(new_n34_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n85_), .c(x19), .O(new_n169_));
  nand4  g136(.a(new_n42_), .b(new_n99_), .c(new_n34_), .d(x00), .O(new_n170_));
  oai21  g137(.a(new_n148_), .b(new_n147_), .c(new_n170_), .O(new_n171_));
  ...
  oai21  g142(.a(new_n68_), .b(x04), .c(x17), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(x22), .c(new_n71_), .O(new_n177_));
  nor2   g144(.a(new_n127_), .b(x07), .O(new_n178_));
  oai21  g145(.a(new_n177_), .b(new_n175_), .c(new_n178_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n83_), .c(x24), .d(x18), .O(new_n180_));
  oai21  g147(.a(new_n177_), .b(new_n175_), .c(x08), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n85_), .c(x15), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n180_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(x02), .O(new_n184_));
  nand2  g151(.a(new_n85_), .b(x15), .O(new_n185_));
  nor2   g152(.a(x10), .b(x02), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n113_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n185_), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n181_), .c(new_n35_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n184_), .c(new_n174_), .O(z4));
  nand3  g157(.a(new_n42_), .b(new_n99_), .c(x00), .O(new_n191_));
  nand2  g158(.a(new_n191_), .b(new_n35_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n34_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n56_), .O(z5));
  nand2  g161(.a(x20), .b(new_n40_), .O(new_n195_));
  aoi21  g162(.a(new_n195_), .b(new_n38_), .c(x11), .O(new_n196_));
  nand3  g163(.a(new_n170_), .b(new_n54_), .c(new_n52_), .O(new_n197_));
  oai22  g164(.a(new_n197_), .b(new_n51_), .c(new_n196_), .d(x03), .O(new_n198_));
  nand2  g165(.a(new_n41_), .b(x14), .O(new_n199_));
  aoi21  g166(.a(new_n199_), .b(x06), .c(new_n47_), .O(new_n200_));
  nand3  g167(.a(new_n187_), .b(new_n121_), .c(new_n120_), .O(new_n201_));
  oai22  g168(.a(new_n201_), .b(new_n119_), .c(new_n200_), .d(new_n37_), .O(new_n202_));
  nand3  g169(.a(new_n202_), .b(new_n198_), .c(new_n168_), .O(z6));
  nand3  g170(.a(new_n168_), .b(new_n85_), .c(x15), .O(new_n204_));
  inv1   g171(.a(new_n148_), .O(new_n205_));
  nand3  g172(.a(new_n205_), .b(x18), .c(x02), .O(new_n206_));
  nand3  g173(.a(new_n186_), .b(new_n113_), .c(new_n35_), .O(new_n207_));
  nand3  g174(.a(new_n207_), .b(new_n206_), .c(new_n204_), .O(z7));
endmodule
