...
module FAU ( 
  ...
  inv1   g114(.a(new_n106_), .O(new_n148_));
  nand2  g115(.a(new_n108_), .b(new_n107_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n148_), .c(new_n53_), .O(new_n150_));
  ...
  and2   g122(.a(new_n53_), .b(new_n48_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n46_), .c(new_n43_), .d(new_n155_), .O(z5));
  nand2  g124(.a(x20), .b(new_n118_), .O(new_n158_));
  ...
  nand3  g128(.a(new_n151_), .b(new_n108_), .c(new_n107_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n148_), .c(new_n161_), .O(new_n163_));
  ...
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n160_), .O(z6));
  inv1   g134(.a(new_n149_), .O(new_n168_));
  nand4  g135(.a(new_n151_), .b(new_n168_), .c(new_n106_), .d(new_n53_), .O(z7));
endmodule
