...
module FAU ( 
  ...
  nand4  g067(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n71_), .O(new_n101_));
  nand4  g068(.a(new_n61_), .b(new_n53_), .c(new_n36_), .d(new_n83_), .O(new_n102_));
  ...
  nand4  g072(.a(new_n83_), .b(new_n35_), .c(new_n34_), .d(new_n71_), .O(new_n106_));
  nand4  g073(.a(new_n61_), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n107_));
  ...
  oai21  g079(.a(x23), .b(new_n57_), .c(new_n60_), .O(new_n113_));
  ...
  aoi21  g088(.a(new_n121_), .b(new_n116_), .c(new_n54_), .O(z4));
  ...
  oai22  g094(.a(new_n127_), .b(new_n79_), .c(new_n126_), .d(new_n49_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n55_), .O(new_n129_));
  nand4  g096(.a(x20), .b(new_n53_), .c(new_n36_), .d(x00), .O(new_n130_));
  nand2  g097(.a(new_n52_), .b(x11), .O(new_n131_));
  nand3  g098(.a(x21), .b(new_n61_), .c(x14), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n44_), .c(new_n43_), .O(new_n134_));
  nand4  g101(.a(x20), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n135_));
  nand3  g102(.a(new_n61_), .b(x15), .c(x14), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n131_), .c(new_n135_), .O(new_n137_));
  ...
  nand4  g107(.a(x20), .b(new_n53_), .c(new_n36_), .d(x07), .O(new_n141_));
  nand3  g108(.a(new_n61_), .b(x18), .c(x14), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n131_), .c(new_n141_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n98_), .c(x24), .O(new_n144_));
  nand3  g111(.a(new_n137_), .b(new_n46_), .c(new_n37_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n144_), .c(new_n140_), .d(new_n129_), .O(z6));
  nor2   g113(.a(new_n79_), .b(new_n54_), .O(z7));
endmodule
