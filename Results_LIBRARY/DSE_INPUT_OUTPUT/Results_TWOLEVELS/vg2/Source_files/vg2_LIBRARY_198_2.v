...
module FAU ( 
  ...
  nand4  g063(.a(new_n52_), .b(new_n69_), .c(x07), .d(new_n35_), .O(new_n97_));
  ...
  nand4  g074(.a(new_n36_), .b(new_n52_), .c(new_n69_), .d(new_n35_), .O(new_n108_));
  ...
  nand4  g107(.a(new_n73_), .b(new_n70_), .c(new_n36_), .d(new_n69_), .O(new_n141_));
  ...
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n52_), .O(new_n157_));
