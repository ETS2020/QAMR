...
module FAU ( 
  ...
  nand4  g092(.a(new_n125_), .b(new_n37_), .c(new_n104_), .d(new_n36_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n37_), .b(new_n104_), .c(new_n36_), .d(new_n116_), .O(new_n134_));
  ...
  nand3  g105(.a(new_n73_), .b(new_n104_), .c(new_n36_), .O(new_n139_));
  ...
  oai21  g111(.a(x23), .b(new_n96_), .c(new_n60_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n62_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n116_), .O(new_n147_));
  ...
  oai21  g119(.a(new_n111_), .b(new_n107_), .c(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n148_), .c(new_n53_), .O(z4));
  nand2  g121(.a(new_n48_), .b(new_n43_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n42_), .c(new_n53_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n46_), .O(z5));
  aoi21  g124(.a(x20), .b(new_n104_), .c(x06), .O(new_n158_));
  ...
  oai21  g130(.a(new_n163_), .b(new_n107_), .c(new_n53_), .O(new_n164_));
  ...
  nand4  g134(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n53_), .O(new_n168_));
