...
module FAU ( 
  ...
  nand4  g057(.a(new_n90_), .b(new_n88_), .c(new_n67_), .d(new_n60_), .O(new_n91_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n80_), .O(new_n97_));
  ...
  nand4  g068(.a(new_n101_), .b(new_n88_), .c(new_n67_), .d(new_n60_), .O(new_n102_));
  ...
  nand4  g073(.a(new_n106_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n107_));
  ...
  nand3  g079(.a(x15), .b(new_n49_), .c(new_n48_), .O(new_n113_));
  nand4  g080(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n34_), .O(new_n114_));
  ...
  nand2  g093(.a(new_n121_), .b(new_n90_), .O(new_n127_));
  ...
  nand2  g100(.a(new_n121_), .b(new_n101_), .O(new_n134_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n142_));
  ...
  oai21  g115(.a(new_n115_), .b(new_n111_), .c(new_n148_), .O(new_n149_));
  nand2  g116(.a(new_n37_), .b(x02), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n143_), .O(z4));
  and2   g118(.a(new_n150_), .b(new_n50_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n141_), .c(new_n45_), .d(new_n44_), .O(z5));
  aoi21  g120(.a(x20), .b(new_n38_), .c(x06), .O(new_n154_));
  aoi21  g121(.a(new_n52_), .b(new_n44_), .c(new_n154_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x02), .c(new_n37_), .O(new_n156_));
  oai21  g123(.a(x20), .b(new_n38_), .c(x06), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x11), .c(new_n35_), .O(new_n158_));
  nand2  g125(.a(x07), .b(x03), .O(new_n159_));
  oai21  g126(.a(new_n158_), .b(new_n89_), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n83_), .c(x24), .O(new_n161_));
  inv1   g128(.a(x15), .O(new_n162_));
  oai22  g129(.a(new_n158_), .b(new_n162_), .c(new_n78_), .d(new_n35_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n85_), .O(new_n164_));
  nand2  g131(.a(x03), .b(x00), .O(new_n165_));
  oai21  g132(.a(new_n158_), .b(new_n100_), .c(new_n165_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n164_), .c(new_n161_), .d(new_n156_), .O(z6));
  nand4  g135(.a(new_n150_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n169_));
  or2    g136(.a(new_n169_), .b(new_n111_), .O(z7));
endmodule
