...
module FAU ( 
  ...
  oai21  g75(.a(new_n107_), .b(x08), .c(new_n108_), .O(new_n109_));
  inv1   g76(.a(new_n75_), .O(new_n110_));
  inv1   g77(.a(x09), .O(new_n111_));
  inv1   g78(.a(x23), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(x04), .c(x17), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(x22), .c(new_n111_), .O(new_n114_));
  oai21  g81(.a(new_n114_), .b(new_n107_), .c(x08), .O(new_n115_));
  aoi21  g82(.a(new_n115_), .b(new_n110_), .c(new_n52_), .O(new_n116_));
  nand2  g83(.a(new_n116_), .b(new_n109_), .O(z4));
  inv1   g84(.a(new_n41_), .O(new_n118_));
  and2   g85(.a(new_n45_), .b(new_n42_), .O(new_n119_));
  nand4  g86(.a(new_n119_), .b(new_n53_), .c(new_n47_), .d(new_n118_), .O(z5));
  nand2  g87(.a(x20), .b(new_n57_), .O(new_n121_));
  aoi21  g88(.a(new_n121_), .b(new_n35_), .c(x11), .O(new_n122_));
  oai21  g89(.a(new_n122_), .b(x03), .c(new_n108_), .O(new_n123_));
  ...
  aoi21  g93(.a(new_n126_), .b(new_n123_), .c(new_n52_), .O(z6));
  aoi21  g94(.a(new_n107_), .b(new_n111_), .c(new_n75_), .O(z7));
endmodule
