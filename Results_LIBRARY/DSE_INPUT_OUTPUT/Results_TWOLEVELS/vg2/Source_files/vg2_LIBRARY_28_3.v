...
module FAU ( 
  ...
  oai21  g114(.a(new_n49_), .b(new_n42_), .c(new_n147_), .O(new_n148_));
  ...
  nand3  g119(.a(new_n134_), .b(new_n45_), .c(new_n44_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n111_), .c(new_n110_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n149_), .c(new_n152_), .O(new_n155_));
  ...
  oai21  g125(.a(new_n158_), .b(new_n42_), .c(new_n156_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n46_), .O(z5));
  aoi21  g127(.a(x20), .b(new_n71_), .c(x06), .O(new_n161_));
  ...
  nand3  g132(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n156_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n153_), .O(z7));
