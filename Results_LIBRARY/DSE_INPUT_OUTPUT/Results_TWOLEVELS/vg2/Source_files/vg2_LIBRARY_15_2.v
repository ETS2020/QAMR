...
module FAU ( 
  ...
  nand2  g087(.a(new_n100_), .b(new_n70_), .O(new_n121_));
  nand3  g088(.a(new_n75_), .b(new_n36_), .c(new_n35_), .O(new_n122_));
  ...
  nand4  g094(.a(new_n90_), .b(new_n36_), .c(new_n35_), .d(new_n127_), .O(new_n128_));
  ...
  nand4  g097(.a(new_n34_), .b(new_n55_), .c(new_n106_), .d(x00), .O(new_n131_));
  nand3  g098(.a(new_n119_), .b(x21), .c(x20), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n118_), .c(new_n131_), .d(new_n128_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n41_), .c(new_n50_), .O(new_n134_));
  ...
  nand2  g106(.a(new_n51_), .b(new_n48_), .O(new_n140_));
  oai21  g107(.a(x23), .b(new_n56_), .c(new_n89_), .O(new_n141_));
  ...
  nand2  g114(.a(new_n111_), .b(new_n110_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n109_), .c(new_n38_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n112_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n144_), .O(z4));
  inv1   g119(.a(new_n43_), .O(new_n153_));
  and2   g120(.a(new_n51_), .b(new_n44_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n46_), .c(new_n153_), .d(new_n38_), .O(z5));
  ...
  nand2  g126(.a(new_n90_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x06), .c(new_n35_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n55_), .c(new_n113_), .d(new_n109_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n38_), .O(z6));
  nand4  g130(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n38_), .O(new_n164_));
  or2    g131(.a(new_n164_), .b(new_n109_), .O(z7));
endmodule
