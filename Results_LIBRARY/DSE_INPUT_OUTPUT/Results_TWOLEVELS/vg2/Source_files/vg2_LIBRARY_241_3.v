...
module FAU ( 
  ...
  oai21  g082(.a(new_n115_), .b(x16), .c(new_n80_), .O(new_n116_));
  ...
  nand2  g089(.a(x23), .b(x20), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n122_), .c(new_n117_), .O(z4));
  inv1   g091(.a(new_n41_), .O(new_n125_));
  and2   g092(.a(new_n45_), .b(new_n42_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n123_), .c(new_n47_), .d(new_n125_), .O(z5));
  nand2  g094(.a(x20), .b(new_n68_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n35_), .c(x11), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(x03), .c(new_n112_), .O(new_n130_));
  nand2  g097(.a(new_n58_), .b(x14), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(x06), .c(new_n36_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n34_), .c(new_n118_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n130_), .c(new_n123_), .O(z6));
  inv1   g101(.a(new_n71_), .O(new_n135_));
  and2   g102(.a(new_n73_), .b(new_n72_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n123_), .c(new_n74_), .d(new_n135_), .O(z7));
endmodule
