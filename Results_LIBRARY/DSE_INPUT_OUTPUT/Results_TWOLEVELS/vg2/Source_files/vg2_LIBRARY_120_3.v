...
module FAU ( 
  ...
  nand4  g052(.a(new_n85_), .b(new_n82_), .c(new_n62_), .d(new_n58_), .O(new_n86_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n74_), .c(new_n84_), .d(new_n89_), .O(new_n94_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n82_), .c(new_n62_), .d(new_n58_), .O(new_n98_));
  ...
  nand2  g071(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  inv1   g072(.a(x08), .O(new_n106_));
  aoi21  g073(.a(new_n44_), .b(new_n38_), .c(new_n40_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n61_), .c(new_n60_), .d(new_n84_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(x17), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n91_), .c(new_n36_), .d(new_n90_), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(x11), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n66_), .c(new_n106_), .d(x07), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(x06), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n56_), .c(new_n55_), .d(new_n54_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n80_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n83_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n105_), .O(z1));
  nand3  g084(.a(new_n79_), .b(new_n37_), .c(x15), .O(new_n118_));
  inv1   g085(.a(new_n107_), .O(new_n119_));
  nand3  g086(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n120_));
  oai21  g087(.a(new_n119_), .b(new_n83_), .c(new_n120_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n48_), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(new_n118_), .c(new_n84_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x14), .c(x11), .d(x06), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n55_), .c(new_n54_), .O(z2));
  ...
  nand2  g095(.a(new_n99_), .b(new_n68_), .O(new_n129_));
  nand3  g096(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n126_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n79_), .O(new_n132_));
  nand2  g099(.a(new_n127_), .b(new_n85_), .O(new_n133_));
  nand3  g100(.a(new_n99_), .b(x07), .c(new_n34_), .O(new_n134_));
  nand4  g101(.a(new_n84_), .b(new_n36_), .c(new_n35_), .d(new_n106_), .O(new_n135_));
  ...
  nand4  g104(.a(new_n34_), .b(new_n55_), .c(new_n54_), .d(x00), .O(new_n138_));
  nand2  g105(.a(new_n127_), .b(new_n97_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n126_), .c(new_n138_), .d(new_n135_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n40_), .c(new_n49_), .O(new_n141_));
  ...
  nor2   g111(.a(new_n119_), .b(x20), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n36_), .c(new_n35_), .d(new_n106_), .O(new_n146_));
  nor2   g113(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n34_), .c(new_n55_), .d(new_n54_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n132_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n83_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n143_), .O(z3));
  oai21  g118(.a(x23), .b(new_n56_), .c(new_n89_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n60_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n106_), .O(new_n154_));
  ...
  oai21  g128(.a(new_n40_), .b(new_n83_), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x05), .O(new_n163_));
  nand3  g130(.a(x24), .b(x18), .c(x13), .O(new_n164_));
  nand3  g131(.a(x15), .b(new_n44_), .c(new_n38_), .O(new_n165_));
  nand4  g132(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n163_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n160_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n157_), .c(new_n37_), .O(z4));
  ...
  oai21  g142(.a(new_n175_), .b(new_n55_), .c(new_n167_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n37_), .O(z6));
  nand2  g144(.a(new_n122_), .b(new_n118_), .O(z7));
endmodule
