...
module FAU ( 
  ...
  nand3  g024(.a(x21), .b(new_n36_), .c(new_n47_), .O(new_n58_));
  ...
  nand4  g046(.a(new_n79_), .b(new_n72_), .c(new_n71_), .d(new_n38_), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(x12), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(new_n37_), .c(new_n70_), .d(new_n69_), .O(new_n82_));
  ...
  nand2  g053(.a(new_n49_), .b(new_n40_), .O(new_n87_));
  ...
  nand4  g063(.a(new_n71_), .b(new_n38_), .c(new_n56_), .d(new_n37_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nor2   g065(.a(x23), .b(x22), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n39_), .d(new_n72_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n96_), .c(new_n93_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n87_), .c(x24), .O(new_n102_));
  nand4  g069(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n103_));
  nand4  g070(.a(x23), .b(x22), .c(x20), .d(x17), .O(new_n104_));
  ...
  nand4  g074(.a(new_n107_), .b(new_n94_), .c(new_n69_), .d(new_n35_), .O(new_n108_));
  nand4  g075(.a(new_n72_), .b(new_n71_), .c(new_n38_), .d(new_n56_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n99_), .c(new_n39_), .d(x19), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n108_), .c(new_n106_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n49_), .c(new_n40_), .O(new_n113_));
  nor2   g080(.a(x20), .b(new_n36_), .O(new_n114_));
  inv1   g081(.a(new_n114_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n113_), .c(new_n102_), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n86_), .O(z1));
  nand2  g085(.a(x24), .b(x18), .O(new_n119_));
  nand3  g086(.a(new_n42_), .b(x15), .c(x13), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n119_), .c(new_n40_), .O(new_n121_));
  nand3  g088(.a(x24), .b(x18), .c(x13), .O(new_n122_));
  nand3  g089(.a(x15), .b(new_n49_), .c(new_n40_), .O(new_n123_));
  nand4  g090(.a(new_n42_), .b(x21), .c(new_n36_), .d(new_n47_), .O(new_n124_));
  ...
  nand4  g096(.a(new_n77_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n132_));
  nor2   g099(.a(new_n35_), .b(new_n34_), .O(new_n133_));
  nand3  g100(.a(x21), .b(x20), .c(x14), .O(new_n134_));
  nor3   g101(.a(new_n134_), .b(new_n37_), .c(new_n69_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n133_), .c(new_n47_), .d(x01), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n132_), .c(x24), .O(new_n137_));
  nand3  g104(.a(new_n87_), .b(x24), .c(x07), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n50_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n140_));
  inv1   g107(.a(new_n140_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n69_), .c(new_n35_), .d(new_n34_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(x01), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n137_), .c(new_n36_), .O(new_n144_));
  nand2  g111(.a(new_n123_), .b(new_n122_), .O(new_n145_));
  nor2   g112(.a(new_n145_), .b(new_n121_), .O(new_n146_));
  inv1   g113(.a(new_n146_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(x20), .c(x14), .d(x11), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n69_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(x06), .c(x03), .d(x01), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n144_), .O(z3));
  oai21  g118(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n73_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n69_), .O(new_n154_));
  nand2  g121(.a(new_n50_), .b(new_n46_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n44_), .c(new_n115_), .O(new_n156_));
  nand4  g123(.a(new_n42_), .b(new_n36_), .c(new_n47_), .d(x00), .O(new_n157_));
  ...
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n70_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n71_), .c(x08), .O(new_n162_));
  oai21  g129(.a(new_n146_), .b(new_n114_), .c(new_n124_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n159_), .O(z4));
  and2   g132(.a(new_n157_), .b(new_n46_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n115_), .c(new_n50_), .d(new_n45_), .O(z5));
  nand2  g134(.a(x20), .b(new_n38_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n35_), .c(x11), .O(new_n169_));
  nand3  g136(.a(new_n157_), .b(new_n50_), .c(new_n46_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n44_), .c(new_n169_), .d(x03), .O(new_n171_));
  oai21  g138(.a(new_n37_), .b(x06), .c(x03), .O(new_n172_));
  oai21  g139(.a(new_n125_), .b(new_n121_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n42_), .b(x21), .c(new_n47_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n123_), .c(new_n122_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n121_), .c(x14), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n37_), .c(new_n36_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n39_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n173_), .c(new_n171_), .O(z6));
  inv1   g146(.a(new_n121_), .O(new_n180_));
  inv1   g147(.a(new_n145_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n124_), .c(new_n180_), .d(new_n115_), .O(z7));
endmodule
