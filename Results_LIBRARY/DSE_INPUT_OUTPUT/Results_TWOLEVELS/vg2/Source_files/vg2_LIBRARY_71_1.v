...
module FAU ( 
  ...
  oai21  g114(.a(new_n145_), .b(new_n57_), .c(new_n147_), .O(new_n148_));
  ...
  nor2   g133(.a(new_n116_), .b(new_n114_), .O(new_n167_));
  nand3  g134(.a(new_n43_), .b(x21), .c(new_n135_), .O(new_n168_));
