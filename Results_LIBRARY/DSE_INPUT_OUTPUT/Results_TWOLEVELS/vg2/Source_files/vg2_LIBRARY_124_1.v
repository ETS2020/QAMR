...
module FAU ( 
  ...
  nand2  g022(.a(x02), .b(new_n55_), .O(new_n56_));
  ...
  nand4  g067(.a(new_n74_), .b(new_n73_), .c(new_n58_), .d(new_n36_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nor2   g069(.a(x23), .b(x22), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n37_), .d(new_n75_), .O(new_n104_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n98_), .c(new_n36_), .d(new_n72_), .O(new_n112_));
  ...
  nand3  g086(.a(new_n119_), .b(new_n106_), .c(new_n56_), .O(new_n120_));
  ...
  oai21  g095(.a(new_n128_), .b(new_n125_), .c(new_n56_), .O(new_n129_));
  nand4  g096(.a(new_n40_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n129_), .c(new_n37_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x14), .c(x11), .d(x06), .O(new_n132_));
  nor3   g099(.a(new_n132_), .b(new_n34_), .c(new_n69_), .O(z2));
  ...
  nand4  g103(.a(new_n80_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n137_));
  ...
  nand4  g110(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n144_));
  ...
  nand3  g113(.a(new_n146_), .b(new_n90_), .c(x24), .O(new_n147_));
  nand4  g114(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n148_));
  nand3  g115(.a(new_n111_), .b(new_n34_), .c(new_n69_), .O(new_n149_));
  nand3  g116(.a(new_n116_), .b(new_n73_), .c(new_n36_), .O(new_n150_));
  ...
  nand4  g119(.a(new_n152_), .b(new_n147_), .c(new_n141_), .d(new_n56_), .O(z3));
  nand2  g120(.a(new_n130_), .b(new_n129_), .O(new_n154_));
  oai21  g121(.a(new_n77_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n72_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n74_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  oai21  g125(.a(x23), .b(new_n70_), .c(new_n75_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n76_), .c(x09), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x16), .c(new_n71_), .O(new_n161_));
  nand2  g128(.a(new_n49_), .b(new_n44_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n42_), .c(new_n56_), .O(new_n163_));
  ...
  inv1   g139(.a(new_n125_), .O(new_n173_));
  and2   g140(.a(new_n130_), .b(new_n127_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n126_), .c(new_n173_), .O(new_n175_));
  oai21  g142(.a(new_n172_), .b(new_n34_), .c(new_n175_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n170_), .c(new_n56_), .O(z6));
  nand4  g144(.a(new_n174_), .b(new_n126_), .c(new_n173_), .d(new_n56_), .O(z7));
endmodule
