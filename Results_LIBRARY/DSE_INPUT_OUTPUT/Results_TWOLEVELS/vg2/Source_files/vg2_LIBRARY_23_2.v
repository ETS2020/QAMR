...
module FAU ( 
  ...
  or2    g115(.a(new_n148_), .b(new_n52_), .O(new_n149_));
  oai21  g116(.a(new_n145_), .b(x08), .c(new_n149_), .O(new_n150_));
  inv1   g117(.a(x23), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n83_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n67_), .c(x08), .O(new_n154_));
  nand4  g121(.a(new_n44_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n156_));
  nor2   g123(.a(x02), .b(new_n35_), .O(new_n157_));
  aoi21  g124(.a(new_n156_), .b(new_n154_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n150_), .O(z4));
  inv1   g126(.a(new_n157_), .O(new_n160_));
  oai21  g127(.a(new_n56_), .b(new_n52_), .c(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n146_), .b(new_n136_), .c(new_n34_), .O(new_n162_));
  ...
  nand2  g133(.a(new_n43_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n41_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n48_), .c(new_n156_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n160_), .O(z6));
  nand3  g137(.a(new_n44_), .b(x21), .c(new_n37_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n35_), .c(x02), .O(new_n172_));
  or2    g139(.a(new_n172_), .b(new_n115_), .O(z7));
endmodule
