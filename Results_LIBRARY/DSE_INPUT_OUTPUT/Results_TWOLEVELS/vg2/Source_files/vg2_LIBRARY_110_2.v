...
module FAU ( 
  ...
  nand2  g122(.a(new_n147_), .b(new_n115_), .O(new_n156_));
  nor2   g123(.a(x02), .b(x01), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n44_), .c(x21), .d(new_n37_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n156_), .O(z7));
  nand2  g126(.a(z7), .b(new_n155_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n151_), .O(z4));
  nand2  g128(.a(x20), .b(new_n42_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n36_), .c(x11), .O(new_n163_));
  nand4  g130(.a(new_n44_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n55_), .c(new_n53_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n52_), .c(new_n163_), .d(x03), .O(new_n166_));
  nand2  g133(.a(new_n43_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n41_), .O(new_n168_));
  nand4  g135(.a(new_n44_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n170_));
  oai21  g137(.a(new_n168_), .b(new_n48_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n166_), .c(new_n147_), .O(z6));
endmodule
