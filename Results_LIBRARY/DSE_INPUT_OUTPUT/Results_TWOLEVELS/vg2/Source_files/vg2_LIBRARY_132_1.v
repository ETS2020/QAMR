...
module FAU ( 
  ...
  nand2  g111(.a(x02), .b(new_n69_), .O(new_n145_));
  ...
  oai21  g122(.a(new_n155_), .b(new_n109_), .c(new_n145_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n112_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n150_), .O(z4));
  and2   g126(.a(new_n145_), .b(new_n45_), .O(new_n160_));
  ...
  nand2  g133(.a(new_n166_), .b(new_n157_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n164_), .O(z6));
  inv1   g135(.a(new_n109_), .O(new_n169_));
  and2   g136(.a(new_n112_), .b(new_n111_), .O(new_n170_));
  nand4  g137(.a(new_n145_), .b(new_n170_), .c(new_n110_), .d(new_n169_), .O(z7));
endmodule
