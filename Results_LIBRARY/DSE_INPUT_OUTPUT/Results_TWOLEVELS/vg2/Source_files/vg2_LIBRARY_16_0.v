...
module FAU ( 
  ...
  nor2   g003(.a(x18), .b(x09), .O(new_n37_));
  ...
  nand2  g055(.a(new_n49_), .b(new_n48_), .O(new_n89_));
  ...
  nand4  g076(.a(new_n109_), .b(new_n96_), .c(new_n69_), .d(new_n35_), .O(new_n110_));
  ...
  nand3  g081(.a(new_n114_), .b(new_n49_), .c(new_n48_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n104_), .c(new_n38_), .O(new_n116_));
  ...
  oai21  g096(.a(new_n129_), .b(new_n123_), .c(x20), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n71_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x11), .c(x06), .d(x03), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n67_), .c(new_n38_), .O(z2));
  nand4  g100(.a(new_n127_), .b(x20), .c(x14), .d(x11), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n69_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nand4  g103(.a(new_n51_), .b(new_n74_), .c(new_n71_), .d(new_n36_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(x08), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n38_), .O(new_n141_));
  oai21  g108(.a(x24), .b(new_n70_), .c(new_n119_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(x15), .c(x13), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n121_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x05), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n124_), .O(new_n146_));
  ...
  nand2  g116(.a(new_n149_), .b(new_n141_), .O(z3));
  nand3  g117(.a(new_n40_), .b(x13), .c(x05), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n89_), .O(new_n152_));
  inv1   g119(.a(x19), .O(new_n153_));
  oai21  g120(.a(new_n76_), .b(x04), .c(x17), .O(new_n154_));
  ...
  aoi21  g124(.a(new_n76_), .b(x04), .c(x17), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x22), .c(new_n70_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n72_), .c(x08), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n153_), .c(new_n157_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n152_), .O(new_n162_));
  nand2  g129(.a(x15), .b(x13), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n40_), .c(new_n48_), .O(new_n164_));
  oai21  g131(.a(new_n40_), .b(new_n49_), .c(new_n128_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n164_), .c(new_n70_), .O(new_n166_));
  nand3  g133(.a(new_n89_), .b(x24), .c(x18), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n126_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n154_), .c(x22), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x16), .O(new_n171_));
  oai21  g138(.a(new_n72_), .b(x08), .c(x07), .O(new_n172_));
  oai21  g139(.a(new_n119_), .b(x08), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n89_), .c(x24), .O(new_n174_));
  inv1   g141(.a(x00), .O(new_n175_));
  nand2  g142(.a(x21), .b(new_n69_), .O(new_n176_));
  oai21  g143(.a(new_n160_), .b(new_n175_), .c(new_n176_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n40_), .c(new_n46_), .d(new_n45_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n174_), .c(new_n38_), .O(new_n179_));
  inv1   g146(.a(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n171_), .c(new_n162_), .O(z4));
  inv1   g148(.a(new_n52_), .O(z5));
  nand2  g149(.a(new_n74_), .b(x14), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(x06), .c(new_n36_), .O(new_n184_));
  nor2   g151(.a(new_n184_), .b(new_n34_), .O(new_n185_));
  nor2   g152(.a(new_n185_), .b(new_n128_), .O(new_n186_));
  aoi21  g153(.a(x20), .b(new_n71_), .c(x06), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(x11), .c(new_n34_), .O(new_n188_));
  inv1   g155(.a(new_n188_), .O(new_n189_));
  nand2  g156(.a(new_n152_), .b(x19), .O(new_n190_));
  aoi21  g157(.a(new_n190_), .b(new_n47_), .c(new_n189_), .O(new_n191_));
  oai21  g158(.a(new_n191_), .b(new_n186_), .c(new_n38_), .O(new_n192_));
  nand2  g159(.a(new_n39_), .b(x03), .O(new_n193_));
  oai21  g160(.a(new_n193_), .b(new_n184_), .c(x18), .O(new_n194_));
  nand3  g161(.a(new_n188_), .b(x09), .c(x07), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n89_), .c(x24), .O(new_n197_));
  inv1   g164(.a(new_n142_), .O(new_n198_));
  nor2   g165(.a(new_n185_), .b(new_n198_), .O(new_n199_));
  nand4  g166(.a(new_n199_), .b(x15), .c(x13), .d(x05), .O(new_n200_));
  nand3  g167(.a(new_n200_), .b(new_n197_), .c(new_n192_), .O(z6));
  inv1   g168(.a(new_n146_), .O(new_n202_));
  oai21  g169(.a(new_n128_), .b(new_n37_), .c(new_n202_), .O(z7));
endmodule
