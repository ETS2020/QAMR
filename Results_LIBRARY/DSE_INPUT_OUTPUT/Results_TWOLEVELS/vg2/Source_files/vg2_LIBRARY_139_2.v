...
module FAU ( 
  ...
  nor3   g091(.a(new_n124_), .b(new_n71_), .c(new_n36_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x22), .c(new_n68_), .O(z2));
  ...
  nor2   g118(.a(x22), .b(new_n68_), .O(new_n152_));
  ...
  nand4  g122(.a(new_n155_), .b(new_n72_), .c(new_n69_), .d(new_n68_), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  aoi21  g124(.a(new_n154_), .b(new_n153_), .c(new_n157_), .O(new_n158_));
  ...
  aoi21  g129(.a(new_n159_), .b(new_n153_), .c(new_n162_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n124_), .c(new_n158_), .d(new_n49_), .O(z4));
  nor2   g131(.a(new_n152_), .b(new_n49_), .O(z5));
  ...
  nand2  g135(.a(new_n168_), .b(new_n153_), .O(new_n169_));
  inv1   g136(.a(new_n142_), .O(new_n170_));
  nand4  g137(.a(x20), .b(new_n68_), .c(new_n36_), .d(x00), .O(new_n171_));
  nand3  g138(.a(x22), .b(x21), .c(new_n71_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n170_), .c(new_n171_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n44_), .c(new_n43_), .O(new_n174_));
  nand3  g141(.a(new_n146_), .b(x20), .c(x19), .O(new_n175_));
  nand3  g142(.a(x22), .b(new_n71_), .c(x15), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n170_), .c(new_n175_), .O(new_n177_));
  ...
  inv1   g147(.a(new_n86_), .O(new_n181_));
  nand4  g148(.a(x20), .b(new_n68_), .c(new_n36_), .d(x07), .O(new_n182_));
  nand3  g149(.a(x22), .b(new_n71_), .c(x18), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n170_), .c(new_n182_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n181_), .c(x24), .O(new_n185_));
  nand3  g152(.a(new_n177_), .b(new_n46_), .c(new_n37_), .O(new_n186_));
  nand4  g153(.a(new_n186_), .b(new_n185_), .c(new_n180_), .d(new_n169_), .O(z6));
  inv1   g154(.a(new_n119_), .O(new_n188_));
  and2   g155(.a(new_n121_), .b(new_n120_), .O(new_n189_));
  nand4  g156(.a(new_n189_), .b(new_n153_), .c(new_n122_), .d(new_n188_), .O(z7));
endmodule
