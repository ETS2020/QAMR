...
module FAU ( 
  ...
  nand4  g041(.a(new_n74_), .b(new_n53_), .c(new_n67_), .d(new_n66_), .O(new_n75_));
  ...
  nand4  g050(.a(x22), .b(x20), .c(x18), .d(x17), .O(new_n84_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n87_), .c(new_n67_), .d(new_n66_), .O(new_n90_));
  ...
  nor2   g074(.a(x23), .b(new_n36_), .O(new_n108_));
  ...
  nor4   g088(.a(new_n121_), .b(new_n113_), .c(new_n69_), .d(new_n54_), .O(new_n122_));
  ...
  nand4  g092(.a(new_n125_), .b(x23), .c(x20), .d(x14), .O(new_n126_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n69_), .c(new_n54_), .d(new_n36_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n132_));
  oai21  g099(.a(new_n128_), .b(new_n64_), .c(new_n132_), .O(new_n133_));
  ...
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n89_), .O(new_n138_));
  nand4  g105(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  inv1   g106(.a(new_n139_), .O(new_n140_));
  nor2   g107(.a(new_n54_), .b(new_n36_), .O(new_n141_));
  nor2   g108(.a(new_n113_), .b(new_n69_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(x18), .O(new_n143_));
  aoi22  g110(.a(new_n143_), .b(new_n138_), .c(new_n46_), .d(new_n37_), .O(new_n144_));
  nor2   g111(.a(x14), .b(x11), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n135_), .c(new_n104_), .d(new_n100_), .O(new_n146_));
  nand4  g113(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(x15), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n146_), .c(x13), .O(new_n148_));
  aoi22  g115(.a(new_n148_), .b(new_n37_), .c(new_n144_), .d(x24), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n134_), .O(z3));
  aoi21  g117(.a(new_n55_), .b(x17), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n66_), .O(new_n152_));
  nand2  g119(.a(new_n92_), .b(new_n83_), .O(new_n153_));
  nor3   g120(.a(new_n153_), .b(x11), .c(new_n65_), .O(new_n154_));
  aoi21  g121(.a(new_n152_), .b(new_n109_), .c(new_n154_), .O(new_n155_));
  aoi21  g122(.a(x22), .b(new_n68_), .c(new_n67_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n83_), .c(x08), .O(new_n157_));
  nand4  g124(.a(x23), .b(x22), .c(x16), .d(new_n65_), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n157_), .b(new_n109_), .c(new_n159_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n121_), .c(new_n155_), .d(new_n49_), .O(z4));
  inv1   g128(.a(new_n41_), .O(new_n162_));
  and2   g129(.a(new_n45_), .b(new_n42_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n109_), .c(new_n47_), .d(new_n162_), .O(z5));
  ...
  oai22  g136(.a(new_n169_), .b(new_n34_), .c(new_n120_), .d(new_n116_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n109_), .O(z6));
  nor2   g138(.a(new_n121_), .b(new_n108_), .O(z7));
endmodule
