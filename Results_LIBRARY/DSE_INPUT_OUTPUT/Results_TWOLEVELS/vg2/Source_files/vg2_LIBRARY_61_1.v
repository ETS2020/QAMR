...
module FAU ( 
  ...
  nor2   g087(.a(new_n120_), .b(new_n90_), .O(z2));
  nor2   g088(.a(new_n103_), .b(new_n36_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x03), .c(x01), .O(new_n123_));
  nor2   g090(.a(new_n67_), .b(new_n37_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n64_), .b(new_n35_), .c(new_n90_), .O(new_n126_));
  nand4  g093(.a(new_n38_), .b(x19), .c(new_n67_), .d(new_n37_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n123_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n77_), .O(new_n129_));
  nand2  g096(.a(new_n124_), .b(new_n81_), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n90_), .O(new_n131_));
  nand4  g098(.a(new_n38_), .b(new_n67_), .c(new_n37_), .d(new_n103_), .O(new_n132_));
  ...
  nand2  g101(.a(new_n92_), .b(new_n64_), .O(new_n135_));
  nand4  g102(.a(new_n94_), .b(new_n41_), .c(new_n38_), .d(new_n67_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n135_), .c(new_n34_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n90_), .O(new_n138_));
  nor2   g105(.a(x02), .b(new_n90_), .O(new_n139_));
  nand2  g106(.a(new_n124_), .b(new_n45_), .O(new_n140_));
  nand3  g107(.a(new_n41_), .b(x21), .c(x20), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n139_), .c(new_n122_), .d(x03), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n138_), .c(new_n134_), .d(new_n129_), .O(z3));
  inv1   g111(.a(x04), .O(new_n145_));
  oai21  g112(.a(x23), .b(new_n145_), .c(new_n69_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n96_), .c(x09), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n103_), .O(new_n148_));
  nand4  g115(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n48_), .c(new_n44_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n43_), .c(new_n148_), .O(new_n151_));
  oai21  g118(.a(new_n106_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n62_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n68_), .c(x08), .O(new_n154_));
  oai21  g121(.a(new_n117_), .b(new_n113_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(x02), .b(new_n90_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n155_), .c(new_n151_), .O(z4));
  nand2  g124(.a(new_n48_), .b(new_n44_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n43_), .c(new_n156_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n149_), .O(z5));
  ...
  aoi21  g130(.a(new_n38_), .b(x14), .c(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n37_), .c(x03), .O(new_n165_));
  nand2  g132(.a(new_n115_), .b(new_n114_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n113_), .c(new_n156_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n116_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n163_), .O(z6));
  nand4  g137(.a(new_n156_), .b(new_n116_), .c(new_n115_), .d(new_n114_), .O(new_n171_));
  or2    g138(.a(new_n171_), .b(new_n113_), .O(z7));
endmodule
