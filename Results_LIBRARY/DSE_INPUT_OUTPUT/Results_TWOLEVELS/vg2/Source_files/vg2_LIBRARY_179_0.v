...
module FAU ( 
  ...
  inv1   g25(.a(new_n43_), .O(new_n60_));
  inv1   g26(.a(new_n50_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(x20), .c(x14), .O(new_n63_));
  nor2   g29(.a(new_n63_), .b(new_n59_), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(x06), .c(x03), .O(new_n65_));
  nor2   g31(.a(x14), .b(x11), .O(new_n66_));
  inv1   g32(.a(new_n66_), .O(new_n67_));
  oai21  g33(.a(new_n65_), .b(new_n35_), .c(new_n67_), .O(z2));
  nand4  g34(.a(new_n64_), .b(x08), .c(x06), .d(x03), .O(new_n69_));
  ...
  nand2  g56(.a(new_n90_), .b(new_n62_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n84_), .c(new_n66_), .O(z4));
  and2   g58(.a(new_n81_), .b(new_n80_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n82_), .c(new_n79_), .d(new_n67_), .O(z5));
  inv1   g60(.a(x21), .O(new_n95_));
  nand2  g61(.a(x03), .b(x00), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(x03), .c(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n48_), .c(new_n47_), .O(new_n98_));
  inv1   g64(.a(x15), .O(new_n99_));
  nand2  g65(.a(x19), .b(x03), .O(new_n100_));
  oai21  g66(.a(new_n99_), .b(x03), .c(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x13), .c(x05), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n98_), .c(x24), .O(new_n103_));
  nor2   g69(.a(x13), .b(x05), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  inv1   g71(.a(x18), .O(new_n106_));
  nand2  g72(.a(x07), .b(x03), .O(new_n107_));
  oai21  g73(.a(new_n106_), .b(x03), .c(new_n107_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n105_), .c(x24), .O(new_n109_));
  nand3  g75(.a(new_n101_), .b(new_n45_), .c(new_n39_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n103_), .c(new_n67_), .O(new_n112_));
  oai21  g78(.a(x20), .b(new_n37_), .c(x06), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(x18), .c(x11), .O(new_n114_));
  nand4  g80(.a(x14), .b(new_n59_), .c(x07), .d(x06), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n105_), .c(x24), .O(new_n117_));
  nand3  g83(.a(new_n41_), .b(x13), .c(x05), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n105_), .O(new_n119_));
  nand3  g85(.a(new_n113_), .b(x15), .c(x11), .O(new_n120_));
  nand4  g86(.a(x19), .b(x14), .c(new_n59_), .d(x06), .O(new_n121_));
  nand2  g87(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g88(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand3  g89(.a(new_n113_), .b(x21), .c(x11), .O(new_n124_));
  nand4  g90(.a(x14), .b(new_n59_), .c(x06), .d(x00), .O(new_n125_));
  nand2  g91(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand4  g92(.a(new_n126_), .b(new_n41_), .c(new_n48_), .d(new_n47_), .O(new_n127_));
  nand4  g93(.a(new_n127_), .b(new_n123_), .c(new_n117_), .d(new_n112_), .O(z6));
  and2   g94(.a(new_n46_), .b(new_n44_), .O(new_n129_));
  nand4  g95(.a(new_n129_), .b(new_n67_), .c(new_n49_), .d(new_n60_), .O(z7));
  zero   g96(.O(z0));
endmodule
