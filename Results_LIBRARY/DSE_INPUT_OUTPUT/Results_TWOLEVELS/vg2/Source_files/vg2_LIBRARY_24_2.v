...
module FAU ( 
  ...
  nand2  g111(.a(new_n51_), .b(new_n48_), .O(new_n145_));
  ...
  oai21  g116(.a(new_n62_), .b(x04), .c(x17), .O(new_n150_));
  ...
  oai21  g120(.a(new_n153_), .b(new_n109_), .c(new_n38_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n112_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n149_), .O(z4));
  inv1   g124(.a(new_n43_), .O(new_n158_));
  and2   g125(.a(new_n51_), .b(new_n44_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n46_), .c(new_n158_), .d(new_n38_), .O(z5));
  nand2  g127(.a(x20), .b(new_n36_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n34_), .c(x11), .O(new_n162_));
  nand3  g129(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n43_), .c(new_n162_), .d(x03), .O(new_n164_));
  nand2  g131(.a(new_n91_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n35_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n56_), .c(new_n113_), .d(new_n109_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n38_), .O(z6));
  nand4  g135(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n38_), .O(new_n169_));
  or2    g136(.a(new_n169_), .b(new_n109_), .O(z7));
endmodule
