...
module FAU ( 
  ...
  nand3  g091(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n125_));
  nand3  g092(.a(new_n77_), .b(new_n36_), .c(new_n35_), .O(new_n126_));
  ...
  nand4  g096(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n130_));
  nand4  g097(.a(new_n92_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n131_));
  ...
  nand4  g100(.a(new_n34_), .b(new_n68_), .c(new_n67_), .d(x00), .O(new_n134_));
  nand3  g101(.a(new_n123_), .b(x21), .c(x20), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n122_), .c(new_n134_), .d(new_n131_), .O(new_n136_));
  ...
  nand2  g107(.a(new_n52_), .b(new_n49_), .O(z5));
  oai21  g108(.a(x23), .b(new_n69_), .c(new_n91_), .O(new_n142_));
  ...
  nand2  g112(.a(new_n118_), .b(new_n116_), .O(z7));
  oai21  g113(.a(new_n105_), .b(x04), .c(x17), .O(new_n147_));
  ...
  oai22  g122(.a(new_n155_), .b(new_n44_), .c(new_n153_), .d(x03), .O(new_n156_));
  nand2  g123(.a(new_n92_), .b(x14), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x06), .c(new_n35_), .O(new_n158_));
  nand3  g125(.a(new_n117_), .b(new_n42_), .c(x21), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n114_), .c(new_n113_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n112_), .c(new_n158_), .d(new_n68_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n39_), .O(z6));
endmodule
