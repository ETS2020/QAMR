...
module FAU ( 
  ...
  and2   g115(.a(new_n148_), .b(new_n50_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n45_), .c(new_n44_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  inv1   g118(.a(new_n116_), .O(new_n152_));
  inv1   g119(.a(new_n120_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  inv1   g121(.a(x09), .O(new_n155_));
  oai21  g122(.a(new_n109_), .b(x04), .c(x17), .O(new_n156_));
  ...
  nand3  g126(.a(new_n159_), .b(new_n151_), .c(new_n124_), .O(z4));
  nand4  g127(.a(new_n149_), .b(new_n124_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  nand2  g131(.a(new_n39_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n37_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n35_), .c(new_n154_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n124_), .O(z6));
  and2   g135(.a(new_n124_), .b(new_n117_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n119_), .c(new_n118_), .d(new_n152_), .O(z7));
endmodule
