...
module FAU ( 
  ...
  nand2  g019(.a(x12), .b(x07), .O(new_n53_));
  ...
  nor3   g067(.a(x16), .b(x14), .c(x11), .O(new_n101_));
  nor2   g068(.a(x23), .b(x22), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n37_), .d(new_n72_), .O(new_n103_));
  ...
  nand3  g085(.a(new_n118_), .b(new_n105_), .c(new_n53_), .O(new_n119_));
  ...
  nand4  g099(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n68_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(x06), .c(x03), .d(x01), .O(new_n135_));
  nand4  g102(.a(new_n77_), .b(new_n37_), .c(new_n70_), .d(new_n36_), .O(new_n136_));
  ...
  nand3  g109(.a(new_n99_), .b(new_n34_), .c(new_n66_), .O(new_n143_));
  nand4  g110(.a(new_n37_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n88_), .c(x24), .O(new_n146_));
  nand4  g113(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n147_));
  nand3  g114(.a(new_n110_), .b(new_n34_), .c(new_n66_), .O(new_n148_));
  nand3  g115(.a(new_n115_), .b(new_n70_), .c(new_n36_), .O(new_n149_));
  ...
  nand3  g119(.a(new_n40_), .b(x13), .c(x05), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n88_), .O(new_n154_));
  inv1   g121(.a(x15), .O(new_n155_));
  aoi21  g122(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n73_), .c(x09), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x16), .c(new_n68_), .O(new_n158_));
  nor2   g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  aoi21  g126(.a(new_n74_), .b(x04), .c(x17), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x22), .c(new_n69_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n71_), .c(x08), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n114_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n159_), .c(new_n154_), .O(new_n164_));
  inv1   g131(.a(x00), .O(new_n165_));
  inv1   g132(.a(x21), .O(new_n166_));
  oai22  g133(.a(new_n162_), .b(new_n165_), .c(new_n158_), .d(new_n166_), .O(new_n167_));
  ...
  nor2   g137(.a(new_n158_), .b(x07), .O(new_n171_));
  aoi21  g138(.a(new_n55_), .b(x07), .c(new_n171_), .O(new_n172_));
  inv1   g139(.a(new_n162_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n55_), .c(x07), .O(new_n174_));
  oai21  g141(.a(new_n172_), .b(new_n93_), .c(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n88_), .c(x24), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n170_), .O(z4));
  inv1   g144(.a(new_n154_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n114_), .c(new_n46_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n53_), .O(new_n180_));
  nand4  g147(.a(new_n88_), .b(x24), .c(new_n55_), .d(x07), .O(new_n181_));
  ...
  oai22  g154(.a(new_n187_), .b(new_n34_), .c(new_n128_), .d(new_n124_), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n185_), .c(new_n53_), .O(z6));
  oai21  g156(.a(new_n178_), .b(new_n155_), .c(new_n127_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n53_), .O(new_n191_));
  nand2  g158(.a(x12), .b(x07), .O(new_n192_));
  nand4  g159(.a(new_n192_), .b(new_n88_), .c(x24), .d(x18), .O(new_n193_));
