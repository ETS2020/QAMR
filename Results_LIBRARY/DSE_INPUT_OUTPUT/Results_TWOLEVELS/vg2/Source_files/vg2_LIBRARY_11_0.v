...
module FAU ( 
  ...
  nand4  g118(.a(new_n138_), .b(new_n92_), .c(x01), .d(x00), .O(new_n152_));
  ...
  nand2  g125(.a(new_n108_), .b(new_n107_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(new_n106_), .O(new_n160_));
  nand2  g127(.a(new_n116_), .b(new_n95_), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n92_), .c(x01), .O(new_n163_));
  oai21  g130(.a(new_n160_), .b(new_n148_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n158_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n156_), .O(z6));
  oai21  g133(.a(new_n162_), .b(new_n62_), .c(new_n92_), .O(new_n167_));
