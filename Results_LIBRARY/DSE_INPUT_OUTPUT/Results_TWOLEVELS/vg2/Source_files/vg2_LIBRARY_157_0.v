...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(x06), .c(x03), .O(new_n66_));
  nor2   g32(.a(new_n66_), .b(new_n35_), .O(z2));
  nand4  g33(.a(new_n65_), .b(x08), .c(x06), .d(x03), .O(new_n68_));
  nor2   g34(.a(new_n68_), .b(new_n35_), .O(z3));
  ...
  nand2  g55(.a(new_n89_), .b(new_n63_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n83_), .c(new_n58_), .O(z4));
  and2   g57(.a(new_n80_), .b(new_n79_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n81_), .c(new_n78_), .d(new_n59_), .O(z5));
  inv1   g59(.a(x21), .O(new_n94_));
  nand2  g60(.a(x03), .b(x00), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(x03), .c(new_n95_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n48_), .c(new_n47_), .O(new_n97_));
  inv1   g63(.a(x15), .O(new_n98_));
  nand2  g64(.a(x19), .b(x03), .O(new_n99_));
  oai21  g65(.a(new_n98_), .b(x03), .c(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x13), .c(x05), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n97_), .c(x24), .O(new_n102_));
  nand2  g68(.a(new_n45_), .b(new_n39_), .O(new_n103_));
  inv1   g69(.a(x18), .O(new_n104_));
  nand2  g70(.a(x07), .b(x03), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(x03), .c(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n103_), .c(x24), .O(new_n107_));
  nand3  g73(.a(new_n100_), .b(new_n45_), .c(new_n39_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n102_), .c(new_n59_), .O(new_n110_));
  inv1   g76(.a(x11), .O(new_n111_));
  inv1   g77(.a(x06), .O(new_n112_));
  nand2  g78(.a(x14), .b(new_n112_), .O(new_n113_));
  nand4  g79(.a(new_n113_), .b(new_n82_), .c(x20), .d(new_n111_), .O(new_n114_));
  oai21  g80(.a(x20), .b(new_n37_), .c(x06), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n63_), .c(x11), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n114_), .c(new_n110_), .O(z6));
  and2   g83(.a(new_n46_), .b(new_n44_), .O(new_n118_));
  nand4  g84(.a(new_n118_), .b(new_n59_), .c(new_n49_), .d(new_n61_), .O(z7));
  zero   g85(.O(z0));
endmodule
