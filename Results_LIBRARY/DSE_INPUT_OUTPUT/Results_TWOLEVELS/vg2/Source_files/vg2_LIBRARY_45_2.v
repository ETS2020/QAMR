...
module FAU ( 
  ...
  nand4  g045(.a(new_n78_), .b(new_n75_), .c(new_n52_), .d(new_n74_), .O(new_n79_));
  ...
  nor2   g059(.a(new_n75_), .b(new_n52_), .O(new_n93_));
  ...
  nand4  g065(.a(new_n75_), .b(new_n52_), .c(new_n74_), .d(new_n73_), .O(new_n99_));
  ...
  nand4  g076(.a(new_n75_), .b(new_n52_), .c(new_n74_), .d(x19), .O(new_n110_));
  ...
  oai21  g116(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n52_), .c(new_n72_), .O(new_n151_));
