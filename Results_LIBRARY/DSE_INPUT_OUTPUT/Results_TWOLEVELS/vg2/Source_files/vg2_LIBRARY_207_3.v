...
module FAU ( 
  ...
  nor2   g047(.a(x24), .b(new_n47_), .O(new_n81_));
  aoi21  g048(.a(new_n81_), .b(x05), .c(new_n80_), .O(new_n82_));
  aoi21  g049(.a(new_n79_), .b(new_n66_), .c(new_n82_), .O(new_n83_));
  ...
  aoi21  g063(.a(new_n96_), .b(x24), .c(new_n83_), .O(new_n97_));
  ...
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n35_), .c(new_n34_), .d(new_n107_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n124_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n40_), .O(new_n132_));
  inv1   g099(.a(new_n80_), .O(new_n133_));
  nand4  g100(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nand3  g101(.a(new_n86_), .b(x14), .c(x11), .O(new_n135_));
  nand3  g102(.a(new_n101_), .b(x07), .c(new_n35_), .O(new_n136_));
  nand4  g103(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n68_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n101_), .b(new_n68_), .c(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n37_), .b(x19), .c(new_n73_), .d(new_n36_), .O(new_n142_));
  ...
  nand3  g111(.a(new_n144_), .b(new_n139_), .c(new_n53_), .O(new_n145_));
  inv1   g112(.a(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n132_), .O(z3));
  inv1   g114(.a(x04), .O(new_n148_));
  oai21  g115(.a(x23), .b(new_n148_), .c(new_n61_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n63_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n68_), .O(new_n151_));
  ...
  nand2  g121(.a(z5), .b(new_n151_), .O(new_n155_));
  oai21  g122(.a(new_n64_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n69_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n74_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n112_), .b(new_n111_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n110_), .c(new_n53_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n113_), .O(z7));
  nand2  g128(.a(z7), .b(new_n158_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n155_), .O(z4));
  ...
  oai22  g135(.a(new_n168_), .b(new_n34_), .c(new_n114_), .d(new_n110_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n53_), .O(z6));
endmodule
