...
module FAU ( 
  ...
  inv1   g03(.a(x17), .O(new_n37_));
  inv1   g04(.a(x23), .O(new_n38_));
  ...
  oai21  g28(.a(new_n51_), .b(new_n44_), .c(new_n38_), .O(new_n62_));
  nor2   g29(.a(new_n62_), .b(x22), .O(new_n63_));
  nand4  g30(.a(new_n63_), .b(new_n61_), .c(new_n37_), .d(new_n60_), .O(new_n64_));
  nor2   g31(.a(new_n64_), .b(x14), .O(new_n65_));
  nand4  g32(.a(new_n65_), .b(new_n59_), .c(new_n36_), .d(new_n58_), .O(new_n66_));
  nor2   g33(.a(new_n66_), .b(x08), .O(new_n67_));
  nand4  g34(.a(new_n67_), .b(new_n35_), .c(new_n57_), .d(new_n34_), .O(new_n68_));
  oai21  g35(.a(new_n68_), .b(x01), .c(new_n56_), .O(z1));
  inv1   g36(.a(x01), .O(new_n70_));
  inv1   g37(.a(x14), .O(new_n71_));
  nand2  g38(.a(x24), .b(x18), .O(new_n72_));
  nand3  g39(.a(new_n42_), .b(x15), .c(x13), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n40_), .O(new_n74_));
  nand3  g41(.a(x24), .b(x18), .c(x13), .O(new_n75_));
  nand3  g42(.a(x15), .b(new_n49_), .c(new_n40_), .O(new_n76_));
  nand4  g43(.a(new_n42_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  nor2   g45(.a(new_n78_), .b(new_n74_), .O(new_n79_));
  nor3   g46(.a(new_n79_), .b(new_n61_), .c(new_n71_), .O(new_n80_));
  nand4  g47(.a(new_n80_), .b(x11), .c(x06), .d(x03), .O(new_n81_));
  oai21  g48(.a(new_n81_), .b(new_n70_), .c(new_n56_), .O(z2));
  ...
  nand4  g59(.a(new_n92_), .b(new_n61_), .c(new_n71_), .d(new_n36_), .O(new_n93_));
  ...
  nand4  g68(.a(new_n61_), .b(new_n71_), .c(new_n36_), .d(new_n83_), .O(new_n102_));
  ...
  nand4  g73(.a(new_n61_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n107_));
  ...
  aoi21  g77(.a(new_n110_), .b(new_n97_), .c(new_n39_), .O(z3));
  inv1   g78(.a(new_n79_), .O(new_n112_));
  nand2  g79(.a(x22), .b(new_n37_), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(x09), .c(new_n60_), .O(new_n114_));
  oai21  g81(.a(new_n114_), .b(new_n83_), .c(new_n112_), .O(new_n115_));
  inv1   g82(.a(new_n52_), .O(new_n116_));
  inv1   g83(.a(x22), .O(new_n117_));
  oai21  g84(.a(x23), .b(new_n57_), .c(new_n37_), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(new_n117_), .c(x09), .O(new_n119_));
  oai21  g86(.a(new_n119_), .b(x16), .c(new_n83_), .O(new_n120_));
  aoi21  g87(.a(new_n120_), .b(new_n116_), .c(new_n39_), .O(new_n121_));
  nand2  g88(.a(new_n121_), .b(new_n115_), .O(z4));
  inv1   g89(.a(new_n44_), .O(new_n123_));
  and2   g90(.a(new_n48_), .b(new_n45_), .O(new_n124_));
  nand4  g91(.a(new_n124_), .b(new_n50_), .c(new_n123_), .d(new_n56_), .O(z5));
  nand2  g92(.a(x20), .b(new_n71_), .O(new_n126_));
  aoi21  g93(.a(new_n126_), .b(new_n35_), .c(x11), .O(new_n127_));
  oai21  g94(.a(new_n127_), .b(x03), .c(new_n116_), .O(new_n128_));
  nand2  g95(.a(new_n61_), .b(x14), .O(new_n129_));
  aoi21  g96(.a(new_n129_), .b(x06), .c(new_n36_), .O(new_n130_));
  oai21  g97(.a(new_n130_), .b(new_n34_), .c(new_n112_), .O(new_n131_));
  nand3  g98(.a(new_n131_), .b(new_n128_), .c(new_n56_), .O(z6));
  nor2   g99(.a(new_n79_), .b(new_n39_), .O(z7));
endmodule
