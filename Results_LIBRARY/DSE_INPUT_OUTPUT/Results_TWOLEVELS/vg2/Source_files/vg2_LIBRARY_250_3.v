...
module FAU ( 
  ...
  nor2   g033(.a(new_n55_), .b(new_n34_), .O(new_n67_));
  ...
  nor4   g047(.a(new_n80_), .b(new_n58_), .c(new_n71_), .d(x12), .O(new_n81_));
  ...
  nand3  g069(.a(new_n102_), .b(x07), .c(new_n35_), .O(new_n103_));
  nand4  g070(.a(new_n58_), .b(new_n71_), .c(new_n36_), .d(new_n84_), .O(new_n104_));
  oai22  g071(.a(new_n104_), .b(new_n103_), .c(new_n101_), .d(new_n100_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n99_), .c(x24), .O(new_n106_));
  nand4  g073(.a(x08), .b(x06), .c(new_n37_), .d(x01), .O(new_n107_));
  nor2   g074(.a(x13), .b(new_n36_), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(x20), .c(x15), .d(x14), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(new_n55_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(x03), .O(new_n111_));
  nor3   g078(.a(x08), .b(x06), .c(x05), .O(new_n112_));
  nand3  g079(.a(new_n58_), .b(x19), .c(new_n71_), .O(new_n113_));
  nor3   g080(.a(new_n113_), .b(x13), .c(x11), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n112_), .c(new_n102_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n111_), .c(new_n106_), .d(new_n98_), .O(z3));
  ...
  oai21  g087(.a(new_n120_), .b(x16), .c(new_n84_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  inv1   g089(.a(new_n80_), .O(new_n123_));
