...
module FAU ( 
  ...
  nand2  g003(.a(x23), .b(x02), .O(new_n37_));
  ...
  nand4  g053(.a(new_n86_), .b(new_n83_), .c(new_n62_), .d(new_n58_), .O(new_n87_));
  nor2   g054(.a(x09), .b(x08), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n67_), .c(x07), .d(new_n34_), .O(new_n89_));
  ...
  nand3  g062(.a(new_n62_), .b(x21), .c(x20), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  nand2  g064(.a(new_n97_), .b(new_n58_), .O(new_n98_));
  nand4  g065(.a(new_n55_), .b(new_n48_), .c(new_n54_), .d(x00), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n34_), .d(new_n56_), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n93_), .c(new_n98_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n40_), .c(new_n49_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n95_), .c(new_n81_), .d(new_n37_), .O(z1));
  ...
  oai21  g081(.a(new_n114_), .b(new_n54_), .c(new_n37_), .O(z2));
  ...
  nand4  g092(.a(new_n125_), .b(new_n85_), .c(new_n36_), .d(new_n35_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n34_), .c(new_n55_), .d(new_n54_), .O(new_n128_));
  ...
  nand4  g099(.a(x07), .b(new_n34_), .c(new_n55_), .d(new_n54_), .O(new_n133_));
  nand4  g100(.a(new_n85_), .b(new_n36_), .c(new_n35_), .d(new_n116_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n68_), .b(new_n55_), .c(new_n54_), .O(new_n138_));
  ...
  aoi21  g110(.a(x21), .b(new_n49_), .c(new_n143_), .O(new_n144_));
  inv1   g111(.a(x17), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n56_), .c(new_n145_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n60_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n116_), .O(new_n148_));
  inv1   g115(.a(x00), .O(new_n149_));
  oai21  g116(.a(x10), .b(new_n149_), .c(new_n124_), .O(new_n150_));
  aoi21  g117(.a(new_n60_), .b(x17), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n116_), .O(new_n152_));
  nand3  g119(.a(new_n49_), .b(x04), .c(x00), .O(new_n153_));
  inv1   g120(.a(x16), .O(new_n154_));
  nand2  g121(.a(new_n74_), .b(new_n154_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  aoi21  g123(.a(new_n152_), .b(new_n150_), .c(new_n156_), .O(new_n157_));
  oai21  g124(.a(new_n148_), .b(new_n144_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n40_), .O(new_n159_));
  nand2  g126(.a(new_n152_), .b(x07), .O(new_n160_));
  oai21  g127(.a(new_n148_), .b(new_n84_), .c(new_n160_), .O(new_n161_));
  ...
  aoi21  g138(.a(new_n171_), .b(new_n154_), .c(x08), .O(new_n172_));
  nor2   g139(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  inv1   g140(.a(new_n107_), .O(new_n174_));
  oai21  g141(.a(new_n60_), .b(x17), .c(x09), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(x16), .c(new_n116_), .O(new_n176_));
  and2   g143(.a(new_n109_), .b(new_n108_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n174_), .c(new_n176_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n173_), .c(new_n61_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n168_), .O(z4));
  inv1   g147(.a(new_n42_), .O(new_n181_));
  and2   g148(.a(new_n50_), .b(new_n43_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n45_), .c(new_n181_), .d(new_n37_), .O(z5));
  nand2  g150(.a(x20), .b(new_n36_), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(new_n34_), .c(x11), .O(new_n185_));
  nand3  g152(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n186_));
  oai22  g153(.a(new_n186_), .b(new_n42_), .c(new_n185_), .d(x03), .O(new_n187_));
  nand2  g154(.a(new_n85_), .b(x14), .O(new_n188_));
  aoi21  g155(.a(new_n188_), .b(x06), .c(new_n35_), .O(new_n189_));
  oai22  g156(.a(new_n189_), .b(new_n55_), .c(new_n111_), .d(new_n107_), .O(new_n190_));
  nand3  g157(.a(new_n190_), .b(new_n187_), .c(new_n37_), .O(z6));
  nand4  g158(.a(new_n177_), .b(new_n110_), .c(new_n174_), .d(new_n37_), .O(z7));
endmodule
