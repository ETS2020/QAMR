...
module FAU ( 
  ...
  nand2  g115(.a(new_n113_), .b(new_n112_), .O(z7));
  ...
  nand2  g125(.a(new_n74_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n35_), .O(new_n160_));
  nand3  g127(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n108_), .c(new_n160_), .d(new_n105_), .O(new_n162_));
