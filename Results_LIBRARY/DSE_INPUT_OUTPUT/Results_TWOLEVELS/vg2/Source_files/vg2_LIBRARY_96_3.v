...
module FAU ( 
  ...
  nand2  g019(.a(x05), .b(x02), .O(new_n53_));
  oai21  g020(.a(new_n52_), .b(x01), .c(new_n53_), .O(z0));
  nand2  g021(.a(x05), .b(new_n44_), .O(new_n55_));
  oai21  g022(.a(new_n47_), .b(x05), .c(new_n55_), .O(new_n56_));
  ...
  oai21  g041(.a(new_n74_), .b(new_n69_), .c(new_n66_), .O(new_n75_));
  nand3  g042(.a(new_n75_), .b(new_n56_), .c(x24), .O(new_n76_));
  nand4  g043(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n77_));
  inv1   g044(.a(new_n77_), .O(new_n78_));
  inv1   g045(.a(x17), .O(new_n79_));
  nor2   g046(.a(new_n37_), .b(new_n79_), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(new_n78_), .c(new_n65_), .d(new_n59_), .O(new_n81_));
  inv1   g048(.a(x09), .O(new_n82_));
  nor2   g049(.a(x08), .b(x06), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n67_), .c(new_n36_), .d(new_n82_), .O(new_n84_));
  ...
  oai21  g056(.a(new_n89_), .b(new_n84_), .c(new_n81_), .O(new_n90_));
  nor2   g057(.a(x13), .b(x05), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand2  g059(.a(new_n40_), .b(x13), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n55_), .c(new_n92_), .O(new_n94_));
  nand2  g061(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  and2   g062(.a(x21), .b(x20), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n65_), .c(new_n61_), .d(new_n59_), .O(new_n97_));
  nor2   g064(.a(x03), .b(x01), .O(new_n98_));
  nor2   g065(.a(x06), .b(x04), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n68_), .d(x00), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n74_), .c(new_n97_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n95_), .c(new_n76_), .O(z1));
  ...
  nand2  g100(.a(new_n98_), .b(new_n83_), .O(new_n134_));
  nand3  g101(.a(new_n88_), .b(new_n105_), .c(new_n36_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n132_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n47_), .c(new_n38_), .O(new_n137_));
  nand3  g104(.a(new_n62_), .b(x14), .c(x11), .O(new_n138_));
  nand3  g105(.a(new_n98_), .b(x07), .c(new_n35_), .O(new_n139_));
  nand4  g106(.a(new_n37_), .b(new_n105_), .c(new_n36_), .d(new_n117_), .O(new_n140_));
  ...
  oai21  g113(.a(x23), .b(new_n146_), .c(new_n79_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n63_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n117_), .O(new_n149_));
  nand3  g116(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n42_), .c(new_n44_), .O(new_n152_));
  oai21  g119(.a(new_n87_), .b(x13), .c(new_n43_), .O(new_n153_));
  ...
  nand3  g127(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n108_), .c(new_n44_), .O(new_n163_));
  inv1   g130(.a(new_n109_), .O(new_n164_));
  aoi21  g131(.a(x15), .b(new_n47_), .c(new_n164_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x05), .c(new_n163_), .O(z7));
  nand2  g133(.a(z7), .b(new_n160_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n156_), .O(z4));
  nand3  g135(.a(new_n92_), .b(x24), .c(x07), .O(new_n169_));
  nand2  g136(.a(new_n41_), .b(new_n44_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x05), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n169_), .c(new_n48_), .d(new_n46_), .O(z5));
  nand2  g139(.a(x20), .b(new_n105_), .O(new_n173_));
  ...
  oai22  g144(.a(new_n177_), .b(new_n34_), .c(new_n112_), .d(new_n108_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n175_), .c(new_n53_), .O(z6));
endmodule
