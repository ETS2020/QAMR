...
module FAU ( 
  ...
  nand2  g108(.a(x02), .b(new_n92_), .O(new_n142_));
  ...
  nand3  g125(.a(new_n145_), .b(new_n48_), .c(new_n44_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n43_), .c(new_n158_), .d(x03), .O(new_n160_));
  nand2  g127(.a(new_n38_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n37_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n35_), .c(new_n115_), .d(new_n111_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n142_), .O(z6));
endmodule
