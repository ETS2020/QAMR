...
module FAU ( 
  ...
  aoi21  g118(.a(new_n52_), .b(new_n44_), .c(new_n151_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x02), .c(new_n37_), .O(new_n153_));
  inv1   g120(.a(x18), .O(new_n154_));
  oai21  g121(.a(x20), .b(new_n38_), .c(x06), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x11), .c(new_n35_), .O(new_n156_));
  nand2  g123(.a(x07), .b(x03), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(new_n154_), .c(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n78_), .c(x24), .O(new_n159_));
  inv1   g126(.a(x15), .O(new_n160_));
  oai22  g127(.a(new_n156_), .b(new_n160_), .c(new_n73_), .d(new_n35_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n80_), .O(new_n162_));
  nand2  g129(.a(x03), .b(x00), .O(new_n163_));
  oai21  g130(.a(new_n156_), .b(new_n96_), .c(new_n163_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n162_), .c(new_n159_), .d(new_n153_), .O(z6));
  nand4  g133(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n104_), .O(new_n167_));
  or2    g134(.a(new_n167_), .b(new_n108_), .O(z7));
endmodule
