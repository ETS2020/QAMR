...
module FAU ( 
  ...
  nor2   g108(.a(x24), .b(new_n141_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n140_), .c(new_n44_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n107_), .c(new_n106_), .d(new_n105_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  nand2  g112(.a(new_n44_), .b(x01), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n145_), .c(new_n135_), .O(z4));
  nand2  g114(.a(new_n48_), .b(new_n43_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n42_), .c(new_n146_), .O(new_n149_));
  nand4  g116(.a(new_n45_), .b(new_n44_), .c(new_n54_), .d(x00), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n149_), .O(z5));
  aoi21  g118(.a(x20), .b(new_n63_), .c(x06), .O(new_n152_));
  ...
  nand2  g123(.a(new_n146_), .b(new_n109_), .O(new_n157_));
  nand4  g124(.a(new_n142_), .b(new_n140_), .c(new_n44_), .d(new_n54_), .O(new_n158_));
