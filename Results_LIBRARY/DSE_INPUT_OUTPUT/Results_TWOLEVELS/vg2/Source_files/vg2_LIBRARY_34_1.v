...
module FAU ( 
  ...
  nor2   g057(.a(new_n34_), .b(new_n90_), .O(new_n91_));
  ...
  nand4  g064(.a(new_n73_), .b(new_n72_), .c(new_n34_), .d(new_n71_), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n96_), .c(new_n94_), .O(new_n100_));
  aoi22  g067(.a(new_n100_), .b(new_n93_), .c(new_n47_), .d(new_n38_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n37_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n54_), .O(new_n108_));
  nand4  g075(.a(new_n73_), .b(new_n72_), .c(new_n34_), .d(x19), .O(new_n109_));
  ...
  aoi22  g079(.a(new_n112_), .b(new_n38_), .c(new_n101_), .d(x24), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n85_), .O(z1));
  nand3  g081(.a(new_n40_), .b(x15), .c(x13), .O(new_n115_));
  oai21  g082(.a(new_n40_), .b(new_n90_), .c(new_n115_), .O(new_n116_));
  ...
  aoi21  g093(.a(new_n126_), .b(x11), .c(new_n34_), .O(z2));
  nand4  g094(.a(new_n57_), .b(x20), .c(x14), .d(x08), .O(new_n128_));
  nor4   g095(.a(new_n128_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n129_));
  nand4  g096(.a(new_n76_), .b(new_n69_), .c(new_n68_), .d(new_n66_), .O(new_n130_));
  nor4   g097(.a(new_n130_), .b(x06), .c(x03), .d(x01), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n129_), .c(new_n40_), .O(new_n132_));
  nand2  g099(.a(new_n47_), .b(new_n38_), .O(new_n133_));
  nand3  g100(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n134_));
  nand4  g101(.a(new_n69_), .b(new_n68_), .c(new_n66_), .d(x07), .O(new_n135_));
  nand3  g102(.a(x06), .b(x03), .c(x01), .O(new_n136_));
  nand3  g103(.a(new_n91_), .b(x14), .c(x08), .O(new_n137_));
  ...
  nand4  g106(.a(x19), .b(new_n69_), .c(new_n68_), .d(new_n66_), .O(new_n140_));
  nand4  g107(.a(x20), .b(x15), .c(x14), .d(x08), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n136_), .c(new_n140_), .d(new_n134_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n47_), .c(new_n38_), .O(new_n143_));
  nor2   g110(.a(new_n34_), .b(x11), .O(new_n144_));
  inv1   g111(.a(new_n144_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n143_), .c(new_n139_), .d(new_n132_), .O(z3));
  inv1   g113(.a(new_n50_), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n65_), .c(new_n71_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n72_), .c(x09), .O(new_n149_));
  ...
  nand2  g121(.a(new_n154_), .b(new_n123_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n151_), .c(new_n145_), .O(z4));
  inv1   g123(.a(new_n42_), .O(new_n157_));
  and2   g124(.a(new_n46_), .b(new_n43_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n145_), .c(new_n48_), .d(new_n157_), .O(z5));
  oai21  g126(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n147_), .O(new_n161_));
  nand2  g128(.a(new_n34_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n68_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n36_), .c(new_n123_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n145_), .O(z6));
  nor2   g132(.a(new_n144_), .b(new_n124_), .O(z7));
endmodule
