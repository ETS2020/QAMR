...
module FAU ( 
  ...
  nand4  g065(.a(new_n71_), .b(new_n70_), .c(new_n52_), .d(new_n36_), .O(new_n99_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n73_), .c(new_n70_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n66_), .c(new_n54_), .O(z2));
  ...
  oai21  g117(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n74_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n68_), .O(new_n153_));
  ...
  nand2  g128(.a(x20), .b(new_n70_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x03), .c(new_n150_), .O(new_n164_));
  nand2  g131(.a(new_n73_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n36_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n34_), .c(new_n155_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n54_), .O(z6));
  nor2   g135(.a(new_n125_), .b(new_n53_), .O(z7));
endmodule
