...
module FAU ( 
  ...
  nand4  g066(.a(new_n99_), .b(new_n96_), .c(new_n95_), .d(new_n93_), .O(new_n100_));
  aoi21  g067(.a(new_n100_), .b(new_n92_), .c(new_n86_), .O(new_n101_));
  ...
  nand3  g077(.a(new_n110_), .b(new_n73_), .c(new_n72_), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n107_), .c(new_n106_), .d(new_n93_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n105_), .c(x13), .O(new_n114_));
  aoi22  g081(.a(new_n114_), .b(new_n37_), .c(new_n101_), .d(x24), .O(new_n115_));
  ...
  nor3   g091(.a(new_n124_), .b(new_n68_), .c(new_n36_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x23), .c(new_n71_), .O(z2));
  aoi21  g094(.a(new_n55_), .b(new_n54_), .c(new_n73_), .O(new_n128_));
  ...
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n95_), .O(new_n140_));
  nand4  g107(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n141_));
  inv1   g108(.a(new_n141_), .O(new_n142_));
  nor2   g109(.a(new_n68_), .b(new_n36_), .O(new_n143_));
  nor2   g110(.a(new_n73_), .b(new_n71_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(x18), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n140_), .c(new_n86_), .O(new_n146_));
  nor2   g113(.a(x14), .b(x11), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n137_), .c(new_n110_), .d(new_n106_), .O(new_n148_));
  nand4  g115(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(x15), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n148_), .c(x13), .O(new_n150_));
  aoi22  g117(.a(new_n150_), .b(new_n37_), .c(new_n146_), .d(x24), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n136_), .O(z3));
  ...
  inv1   g124(.a(new_n124_), .O(new_n158_));
  ...
  nand2  g129(.a(new_n73_), .b(x20), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n162_), .c(new_n157_), .O(z4));
  inv1   g131(.a(new_n41_), .O(new_n165_));
  and2   g132(.a(new_n45_), .b(new_n42_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n163_), .c(new_n47_), .d(new_n165_), .O(z5));
  ...
  inv1   g141(.a(new_n119_), .O(new_n175_));
  and2   g142(.a(new_n121_), .b(new_n120_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n163_), .c(new_n122_), .d(new_n175_), .O(z7));
endmodule
