...
module FAU ( 
  ...
  nand2  g003(.a(x21), .b(x12), .O(new_n37_));
  ...
  nand3  g059(.a(new_n92_), .b(new_n91_), .c(new_n73_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n86_), .c(new_n84_), .O(new_n94_));
  nand3  g061(.a(new_n94_), .b(new_n77_), .c(x24), .O(new_n95_));
  inv1   g062(.a(new_n37_), .O(new_n96_));
  nand4  g063(.a(new_n34_), .b(new_n44_), .c(new_n54_), .d(x00), .O(new_n97_));
  inv1   g064(.a(x08), .O(new_n98_));
  nand3  g065(.a(new_n45_), .b(new_n65_), .c(new_n98_), .O(new_n99_));
  nor4   g066(.a(new_n99_), .b(new_n97_), .c(x06), .d(x04), .O(new_n100_));
  nand4  g067(.a(new_n92_), .b(new_n40_), .c(new_n60_), .d(new_n59_), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n90_), .O(new_n102_));
  aoi21  g069(.a(new_n102_), .b(new_n100_), .c(new_n96_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n95_), .c(new_n80_), .O(z1));
  ...
  nand3  g080(.a(new_n40_), .b(x21), .c(new_n87_), .O(new_n114_));
  inv1   g081(.a(new_n114_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n112_), .c(new_n105_), .O(new_n117_));
  ...
  nand3  g101(.a(new_n83_), .b(x14), .c(x11), .O(new_n135_));
  nand4  g102(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n54_), .O(new_n136_));
  nand4  g103(.a(new_n105_), .b(new_n88_), .c(new_n36_), .d(new_n98_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n77_), .c(x24), .O(new_n139_));
  nand4  g106(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n140_));
  nand3  g107(.a(new_n67_), .b(new_n34_), .c(new_n54_), .O(new_n141_));
  nand3  g108(.a(new_n72_), .b(new_n88_), .c(new_n36_), .O(new_n142_));
  ...
  nand3  g111(.a(new_n144_), .b(new_n139_), .c(new_n37_), .O(new_n145_));
  inv1   g112(.a(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n133_), .O(z3));
  inv1   g114(.a(x17), .O(new_n148_));
  oai21  g115(.a(x23), .b(new_n55_), .c(new_n148_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n59_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n98_), .O(new_n151_));
  oai21  g118(.a(new_n49_), .b(new_n42_), .c(new_n151_), .O(new_n152_));
  oai21  g119(.a(new_n60_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n65_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n89_), .c(x08), .O(new_n155_));
  inv1   g122(.a(new_n108_), .O(new_n156_));
  nand3  g123(.a(new_n113_), .b(new_n40_), .c(x21), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n110_), .c(new_n109_), .d(new_n156_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n152_), .c(new_n37_), .O(z4));
  inv1   g127(.a(new_n42_), .O(new_n161_));
  and2   g128(.a(new_n46_), .b(new_n43_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n48_), .c(new_n161_), .d(new_n37_), .O(z5));
  aoi21  g130(.a(x20), .b(new_n88_), .c(x06), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x11), .c(new_n34_), .O(new_n165_));
  nand2  g132(.a(new_n48_), .b(new_n43_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n42_), .c(new_n37_), .O(new_n167_));
  nor2   g134(.a(x24), .b(x21), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n165_), .O(new_n171_));
  nand2  g138(.a(new_n116_), .b(new_n112_), .O(new_n172_));
  aoi21  g139(.a(new_n105_), .b(x14), .c(new_n35_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n36_), .c(x03), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand3  g142(.a(new_n115_), .b(new_n113_), .c(x00), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n175_), .c(new_n171_), .O(z6));
  inv1   g144(.a(new_n111_), .O(new_n178_));
  nor3   g145(.a(x24), .b(x10), .c(x02), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(x12), .c(x21), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n178_), .c(new_n156_), .O(z7));
endmodule
