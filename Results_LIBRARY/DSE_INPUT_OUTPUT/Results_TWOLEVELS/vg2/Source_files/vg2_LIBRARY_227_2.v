...
module FAU ( 
  ...
  nor2   g111(.a(new_n54_), .b(new_n50_), .O(new_n145_));
  nor2   g112(.a(x02), .b(new_n35_), .O(new_n146_));
  nor2   g113(.a(x24), .b(x10), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n101_), .c(new_n34_), .O(new_n148_));
  ...
  nand3  g121(.a(new_n43_), .b(x21), .c(new_n38_), .O(new_n155_));
  ...
  aoi21  g127(.a(new_n147_), .b(x00), .c(x01), .O(new_n161_));
  ...
  nand3  g132(.a(new_n147_), .b(new_n34_), .c(x00), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n53_), .c(new_n51_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n50_), .c(new_n165_), .d(x03), .O(new_n168_));
  nand2  g135(.a(new_n42_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n40_), .O(new_n170_));
  nand4  g137(.a(new_n43_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n114_), .c(new_n113_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n112_), .c(new_n170_), .d(new_n36_), .O(new_n173_));
