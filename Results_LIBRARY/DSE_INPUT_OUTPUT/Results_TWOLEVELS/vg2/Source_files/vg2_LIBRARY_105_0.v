...
module FAU ( 
  ...
  inv1   g119(.a(new_n145_), .O(new_n153_));
  nand2  g120(.a(new_n112_), .b(new_n111_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n110_), .c(new_n153_), .O(new_n155_));
  nand3  g122(.a(new_n132_), .b(new_n135_), .c(new_n113_), .O(new_n156_));
  ...
  nand3  g130(.a(new_n146_), .b(new_n54_), .c(x00), .O(new_n164_));
  ...
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n153_), .O(z6));
endmodule
