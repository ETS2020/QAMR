...
module FAU ( 
  ...
  nand2  g120(.a(new_n110_), .b(new_n109_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n108_), .c(new_n52_), .O(new_n155_));
  nand4  g122(.a(new_n40_), .b(x21), .c(new_n44_), .d(new_n54_), .O(new_n156_));
  ...
  oai22  g128(.a(new_n161_), .b(x03), .c(new_n48_), .d(new_n42_), .O(new_n162_));
  nand2  g129(.a(new_n37_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n34_), .c(new_n112_), .d(new_n108_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n52_), .O(z6));
endmodule
