...
module FAU ( 
  ...
  nand4  g030(.a(new_n63_), .b(new_n60_), .c(new_n59_), .d(new_n53_), .O(new_n64_));
  ...
  nor2   g046(.a(new_n79_), .b(new_n54_), .O(z7));
  ...
  nand3  g053(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n87_));
  ...
  nand2  g066(.a(new_n46_), .b(new_n37_), .O(new_n100_));
  ...
  aoi21  g079(.a(new_n112_), .b(new_n99_), .c(new_n54_), .O(z3));
  inv1   g080(.a(new_n49_), .O(new_n114_));
  inv1   g081(.a(x22), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(x17), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n57_), .c(x16), .O(new_n117_));
  nand3  g084(.a(new_n61_), .b(new_n115_), .c(x04), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n85_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n117_), .c(new_n114_), .O(new_n120_));
  inv1   g087(.a(new_n79_), .O(new_n121_));
  oai21  g088(.a(x23), .b(new_n59_), .c(x22), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(x09), .c(new_n53_), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n85_), .c(new_n121_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n120_), .c(new_n55_), .O(z4));
  inv1   g092(.a(new_n41_), .O(new_n126_));
  and2   g093(.a(new_n45_), .b(new_n42_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n55_), .c(new_n47_), .d(new_n126_), .O(z5));
  nand2  g095(.a(x20), .b(new_n71_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n35_), .c(x11), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(x03), .c(new_n114_), .O(new_n131_));
  nand2  g098(.a(new_n60_), .b(x14), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(x06), .c(new_n36_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n34_), .c(new_n121_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n131_), .c(new_n55_), .O(z6));
endmodule
