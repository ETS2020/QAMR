...
module FAU ( 
  ...
  nor4   g047(.a(new_n80_), .b(new_n54_), .c(new_n62_), .d(new_n72_), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(x11), .c(x06), .d(x03), .O(new_n82_));
  nor2   g049(.a(new_n82_), .b(new_n71_), .O(z2));
  ...
  nand4  g069(.a(new_n62_), .b(new_n72_), .c(new_n36_), .d(new_n84_), .O(new_n103_));
  ...
  nand4  g073(.a(new_n84_), .b(new_n35_), .c(new_n34_), .d(new_n71_), .O(new_n107_));
  nand4  g074(.a(new_n62_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n108_));
  ...
  aoi21  g079(.a(new_n60_), .b(x09), .c(x08), .O(new_n113_));
  oai21  g080(.a(x23), .b(new_n57_), .c(new_n61_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n52_), .c(new_n60_), .O(new_n115_));
  oai21  g082(.a(new_n113_), .b(new_n54_), .c(new_n115_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n112_), .O(new_n117_));
  inv1   g084(.a(new_n80_), .O(new_n118_));
  oai21  g085(.a(new_n60_), .b(x09), .c(x08), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n118_), .c(new_n55_), .O(new_n120_));
  nor2   g087(.a(new_n80_), .b(x23), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x22), .c(new_n61_), .d(x16), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n120_), .c(new_n117_), .O(z4));
  nor2   g090(.a(new_n54_), .b(new_n49_), .O(z5));
  nand2  g091(.a(x20), .b(new_n72_), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n35_), .c(x11), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x03), .c(new_n112_), .O(new_n127_));
  nand2  g094(.a(new_n62_), .b(x14), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x06), .c(new_n36_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n34_), .c(new_n118_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n127_), .c(new_n54_), .O(z6));
  inv1   g098(.a(new_n75_), .O(new_n132_));
  and2   g099(.a(new_n77_), .b(new_n76_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n78_), .c(new_n132_), .d(new_n55_), .O(z7));
endmodule
