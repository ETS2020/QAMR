...
module FAU ( 
  ...
  nand4  g070(.a(new_n103_), .b(new_n83_), .c(new_n82_), .d(new_n101_), .O(new_n104_));
  nand4  g071(.a(new_n61_), .b(new_n36_), .c(new_n58_), .d(new_n35_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n90_), .c(new_n64_), .d(new_n63_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n104_), .c(new_n100_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n93_), .c(x24), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n96_), .c(new_n73_), .O(z1));
  nand4  g077(.a(new_n55_), .b(x06), .c(x03), .d(x01), .O(new_n111_));
  nor2   g078(.a(new_n36_), .b(new_n35_), .O(new_n112_));
  nor2   g079(.a(x24), .b(new_n66_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n112_), .c(x20), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(new_n111_), .c(x04), .O(new_n115_));
  ...
  nor3   g090(.a(new_n123_), .b(new_n64_), .c(new_n36_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x11), .c(x06), .d(x03), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n74_), .c(new_n116_), .O(z2));
  nand3  g093(.a(new_n112_), .b(x20), .c(x15), .O(new_n127_));
  nand3  g094(.a(new_n84_), .b(new_n75_), .c(new_n74_), .O(new_n128_));
  nand3  g095(.a(new_n89_), .b(new_n36_), .c(new_n35_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n56_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n95_), .O(new_n131_));
  nand3  g098(.a(new_n112_), .b(new_n99_), .c(new_n57_), .O(new_n132_));
  nand3  g099(.a(new_n103_), .b(new_n75_), .c(new_n74_), .O(new_n133_));
  nand4  g100(.a(new_n64_), .b(new_n36_), .c(new_n35_), .d(new_n101_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n93_), .c(x24), .O(new_n136_));
  nand4  g103(.a(new_n34_), .b(new_n75_), .c(new_n74_), .d(x00), .O(new_n137_));
  nand3  g104(.a(new_n112_), .b(x21), .c(x20), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n56_), .c(new_n137_), .d(new_n134_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n42_), .c(new_n55_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(x04), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n37_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n136_), .c(new_n131_), .O(z3));
  nand2  g110(.a(x22), .b(new_n63_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x09), .c(new_n61_), .O(new_n145_));
  nand3  g112(.a(new_n113_), .b(new_n55_), .c(new_n37_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n121_), .c(new_n120_), .O(new_n147_));
  or2    g114(.a(new_n147_), .b(new_n119_), .O(new_n148_));
  oai21  g115(.a(new_n145_), .b(new_n101_), .c(new_n148_), .O(new_n149_));
  aoi21  g116(.a(new_n69_), .b(x04), .c(x17), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x22), .c(new_n82_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n61_), .c(x08), .O(new_n152_));
  nand4  g119(.a(new_n80_), .b(x16), .c(x15), .d(new_n38_), .O(new_n153_));
  oai21  g120(.a(new_n152_), .b(new_n88_), .c(new_n153_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n95_), .O(new_n155_));
  nand4  g122(.a(new_n80_), .b(x18), .c(x16), .d(new_n38_), .O(new_n156_));
  oai21  g123(.a(new_n152_), .b(new_n102_), .c(new_n156_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n93_), .c(x24), .O(new_n158_));
  aoi21  g125(.a(x23), .b(new_n63_), .c(x22), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x09), .c(new_n61_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n101_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n42_), .c(new_n55_), .d(x00), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x04), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n37_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n158_), .c(new_n155_), .d(new_n149_), .O(z4));
  nor2   g132(.a(new_n48_), .b(new_n44_), .O(new_n166_));
  aoi21  g133(.a(new_n50_), .b(x00), .c(new_n38_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x02), .c(new_n166_), .O(z5));
  nand2  g135(.a(x20), .b(new_n36_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n34_), .c(x11), .O(new_n170_));
  nand3  g137(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n47_), .c(new_n45_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n44_), .c(new_n170_), .d(x03), .O(new_n173_));
  nand2  g140(.a(new_n64_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n35_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n75_), .c(new_n148_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n39_), .O(z6));
  inv1   g144(.a(new_n39_), .O(new_n178_));
  nand4  g145(.a(new_n113_), .b(new_n55_), .c(x04), .d(new_n37_), .O(new_n179_));
  oai21  g146(.a(new_n123_), .b(new_n178_), .c(new_n179_), .O(z7));
endmodule
