...
module FAU ( 
  ...
  nor2   g080(.a(new_n113_), .b(new_n89_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x11), .c(x06), .d(x03), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(x02), .c(new_n106_), .O(z2));
  ...
  nand3  g089(.a(new_n72_), .b(new_n89_), .c(new_n36_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n126_), .b(new_n82_), .c(x14), .O(new_n127_));
  ...
  nand4  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n97_), .O(new_n136_));
  ...
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n84_), .O(new_n141_));
  ...
  oai21  g111(.a(new_n144_), .b(new_n90_), .c(x08), .O(new_n145_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n109_), .c(new_n145_), .O(new_n150_));
  ...
  nand4  g121(.a(new_n97_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n154_), .O(z5));
  aoi21  g123(.a(x20), .b(new_n89_), .c(x06), .O(new_n157_));
  ...
  oai21  g128(.a(new_n112_), .b(new_n109_), .c(new_n151_), .O(new_n162_));
  nand4  g129(.a(new_n147_), .b(new_n45_), .c(new_n44_), .d(new_n106_), .O(new_n163_));
