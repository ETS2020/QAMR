...
module FAU ( 
  ...
  oai22  g042(.a(new_n75_), .b(new_n69_), .c(new_n65_), .d(new_n60_), .O(new_n76_));
  ...
  nand4  g050(.a(new_n83_), .b(new_n82_), .c(x23), .d(x22), .O(new_n84_));
  ...
  nand4  g059(.a(new_n64_), .b(x16), .c(x14), .d(x12), .O(new_n93_));
  nor2   g060(.a(x03), .b(x01), .O(new_n94_));
  nor2   g061(.a(x06), .b(x04), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n85_), .d(x00), .O(new_n96_));
  oai22  g063(.a(new_n96_), .b(new_n90_), .c(new_n93_), .d(new_n60_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n42_), .c(new_n50_), .O(new_n98_));
  ...
  nand4  g069(.a(new_n50_), .b(x06), .c(x03), .d(x01), .O(new_n103_));
  nor2   g070(.a(new_n36_), .b(new_n35_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n42_), .c(x20), .O(new_n105_));
  oai21  g072(.a(new_n105_), .b(new_n103_), .c(x21), .O(new_n106_));
  ...
  nand3  g079(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nor3   g082(.a(new_n115_), .b(new_n108_), .c(new_n36_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x03), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n102_), .c(new_n107_), .O(z2));
  nand3  g085(.a(x15), .b(x13), .c(x05), .O(new_n119_));
  oai21  g086(.a(x10), .b(x02), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g091(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n125_));
  nand3  g092(.a(x19), .b(x13), .c(x05), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n108_), .c(new_n36_), .d(new_n35_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n34_), .c(new_n124_), .d(new_n102_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n123_), .c(x24), .O(new_n131_));
  nand3  g098(.a(new_n59_), .b(x03), .c(x01), .O(new_n132_));
  nand2  g099(.a(new_n104_), .b(new_n83_), .O(new_n133_));
  nand3  g100(.a(new_n94_), .b(x07), .c(new_n34_), .O(new_n134_));
  nand4  g101(.a(new_n108_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n135_));
  ...
  nand3  g104(.a(new_n104_), .b(x20), .c(x15), .O(new_n138_));
  nand2  g105(.a(new_n94_), .b(new_n68_), .O(new_n139_));
  nand3  g106(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  ...
  oai21  g110(.a(new_n143_), .b(new_n131_), .c(x21), .O(new_n144_));
  ...
  inv1   g115(.a(x22), .O(new_n149_));
  inv1   g116(.a(x04), .O(new_n150_));
  inv1   g117(.a(x17), .O(new_n151_));
  oai21  g118(.a(x23), .b(new_n150_), .c(new_n151_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n149_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n58_), .O(new_n154_));
  oai21  g121(.a(new_n48_), .b(new_n44_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g128(.a(new_n161_), .b(new_n37_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n113_), .c(new_n112_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n111_), .c(new_n160_), .O(new_n164_));
  nand2  g131(.a(new_n50_), .b(x00), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x24), .c(x21), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n37_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n155_), .O(z4));
  nand2  g135(.a(new_n52_), .b(new_n49_), .O(z5));
  aoi21  g136(.a(new_n108_), .b(x14), .c(new_n34_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n35_), .c(x03), .O(new_n171_));
  inv1   g138(.a(new_n39_), .O(new_n172_));
  nand3  g139(.a(new_n51_), .b(new_n50_), .c(new_n37_), .O(new_n173_));
  oai21  g140(.a(new_n115_), .b(new_n172_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nor2   g142(.a(new_n48_), .b(new_n44_), .O(new_n176_));
  oai21  g143(.a(new_n108_), .b(x14), .c(new_n34_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n35_), .c(x03), .O(new_n178_));
  nor2   g145(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n39_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n175_), .c(new_n52_), .O(z6));
  oai21  g148(.a(new_n161_), .b(new_n38_), .c(new_n37_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n115_), .O(z7));
endmodule
