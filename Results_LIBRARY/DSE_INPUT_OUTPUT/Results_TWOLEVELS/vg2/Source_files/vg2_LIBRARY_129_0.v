...
module FAU ( 
  ...
  nand4  g038(.a(new_n71_), .b(new_n70_), .c(new_n46_), .d(new_n69_), .O(new_n72_));
  ...
  oai22  g045(.a(new_n78_), .b(new_n72_), .c(new_n68_), .d(new_n63_), .O(new_n79_));
  nand2  g046(.a(new_n52_), .b(new_n47_), .O(new_n80_));
  ...
  nand3  g056(.a(new_n89_), .b(new_n88_), .c(new_n86_), .O(new_n90_));
  nor2   g057(.a(x09), .b(x08), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n70_), .c(x07), .d(new_n37_), .O(new_n92_));
  ...
  oai22  g063(.a(new_n96_), .b(new_n92_), .c(new_n90_), .d(new_n63_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n80_), .c(x24), .O(new_n98_));
  inv1   g065(.a(x10), .O(new_n99_));
  inv1   g066(.a(x16), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n39_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n67_), .c(x12), .O(new_n102_));
  nor2   g069(.a(x03), .b(x01), .O(new_n103_));
  nor2   g070(.a(x06), .b(x04), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n103_), .c(new_n91_), .d(x00), .O(new_n105_));
  oai22  g072(.a(new_n105_), .b(new_n96_), .c(new_n102_), .d(new_n63_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n41_), .c(new_n99_), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(x21), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n34_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n98_), .c(new_n83_), .O(z1));
  nand4  g077(.a(new_n99_), .b(x06), .c(x03), .d(x01), .O(new_n111_));
  nor2   g078(.a(new_n39_), .b(new_n46_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n41_), .c(x20), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n111_), .c(x21), .O(new_n114_));
  ...
  nand3  g085(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n119_));
  oai21  g086(.a(new_n116_), .b(new_n52_), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g090(.a(new_n123_), .b(new_n35_), .c(new_n115_), .O(z2));
  nand4  g091(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand3  g092(.a(new_n112_), .b(x20), .c(x15), .O(new_n126_));
  nand2  g093(.a(new_n103_), .b(new_n71_), .O(new_n127_));
  nand3  g094(.a(new_n76_), .b(new_n39_), .c(new_n46_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n82_), .O(new_n130_));
  nand2  g097(.a(new_n112_), .b(new_n89_), .O(new_n131_));
  nand3  g098(.a(new_n103_), .b(x07), .c(new_n37_), .O(new_n132_));
  inv1   g099(.a(x08), .O(new_n133_));
  nand4  g100(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n133_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n132_), .c(new_n131_), .d(new_n125_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n80_), .c(x24), .O(new_n136_));
  nand3  g103(.a(x06), .b(x03), .c(x01), .O(new_n137_));
  nand4  g104(.a(x20), .b(x14), .c(x11), .d(x08), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n134_), .d(new_n38_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n41_), .c(new_n99_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(x21), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n34_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n136_), .c(new_n130_), .O(z3));
  oai21  g110(.a(new_n85_), .b(x04), .c(x17), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x22), .c(new_n69_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n100_), .c(x08), .O(new_n146_));
  nor2   g113(.a(x21), .b(x02), .O(new_n147_));
  inv1   g114(.a(new_n147_), .O(new_n148_));
  oai21  g115(.a(new_n120_), .b(new_n118_), .c(new_n148_), .O(new_n149_));
  inv1   g116(.a(x21), .O(new_n150_));
  nor2   g117(.a(x24), .b(new_n150_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n99_), .c(new_n34_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(z7));
  nand2  g120(.a(z7), .b(new_n146_), .O(new_n154_));
  or2    g121(.a(new_n54_), .b(new_n50_), .O(new_n155_));
  inv1   g122(.a(x04), .O(new_n156_));
  inv1   g123(.a(x17), .O(new_n157_));
  oai21  g124(.a(x23), .b(new_n156_), .c(new_n157_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n84_), .c(x09), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x16), .c(new_n133_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n148_), .c(new_n155_), .O(new_n161_));
  nand4  g128(.a(new_n151_), .b(new_n99_), .c(new_n34_), .d(x00), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n161_), .c(new_n154_), .O(z4));
  nand3  g130(.a(new_n151_), .b(new_n99_), .c(x00), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x21), .c(x02), .O(new_n165_));
  or2    g132(.a(new_n165_), .b(new_n155_), .O(z5));
  aoi21  g133(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n46_), .c(x03), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(z7), .O(new_n169_));
  aoi21  g136(.a(x20), .b(new_n39_), .c(x06), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x11), .c(new_n36_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n148_), .c(new_n155_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n162_), .O(z6));
endmodule
