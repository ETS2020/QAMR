...
module FAU ( 
  ...
  nand4  g043(.a(new_n76_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n77_));
  nor2   g044(.a(new_n77_), .b(x06), .O(new_n78_));
  nand4  g045(.a(new_n78_), .b(new_n65_), .c(new_n36_), .d(new_n35_), .O(new_n79_));
  ...
  nand4  g049(.a(x12), .b(x09), .c(x08), .d(x06), .O(new_n83_));
  nor4   g050(.a(new_n83_), .b(new_n65_), .c(new_n36_), .d(new_n35_), .O(new_n84_));
  nand3  g051(.a(x17), .b(x16), .c(x14), .O(new_n85_));
  inv1   g052(.a(new_n85_), .O(new_n86_));
  inv1   g053(.a(x18), .O(new_n87_));
  nor2   g054(.a(new_n70_), .b(new_n87_), .O(new_n88_));
  nor2   g055(.a(new_n56_), .b(new_n71_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n90_));
  ...
  nor3   g060(.a(x16), .b(x14), .c(x11), .O(new_n94_));
  nor2   g061(.a(x23), .b(x22), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n70_), .d(new_n69_), .O(new_n96_));
  ...
  nand2  g068(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  nor2   g069(.a(x08), .b(x06), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n91_), .c(new_n68_), .d(new_n67_), .O(new_n104_));
  nor3   g071(.a(x17), .b(x16), .c(x14), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n95_), .c(new_n70_), .d(x19), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n47_), .c(new_n38_), .O(new_n108_));
  nor2   g075(.a(new_n34_), .b(x11), .O(new_n109_));
  ...
  nand2  g079(.a(new_n112_), .b(new_n81_), .O(z1));
  nor2   g080(.a(new_n40_), .b(new_n87_), .O(new_n114_));
  ...
  nand4  g086(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n120_));
  and2   g087(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n117_), .O(new_n123_));
  nor3   g090(.a(new_n123_), .b(new_n70_), .c(new_n54_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x11), .c(x06), .d(x03), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n35_), .c(new_n110_), .O(z2));
  nand2  g093(.a(new_n58_), .b(new_n57_), .O(new_n127_));
  ...
  nand2  g097(.a(new_n73_), .b(new_n72_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n70_), .c(new_n54_), .d(new_n68_), .O(new_n132_));
  ...
  nand3  g104(.a(new_n88_), .b(x14), .c(x11), .O(new_n138_));
  nand4  g105(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n139_));
  nand4  g106(.a(new_n70_), .b(new_n54_), .c(new_n68_), .d(new_n66_), .O(new_n140_));
  ...
  nand3  g110(.a(new_n103_), .b(new_n36_), .c(new_n35_), .O(new_n144_));
  nand4  g111(.a(new_n70_), .b(x19), .c(new_n54_), .d(new_n68_), .O(new_n145_));
  ...
  nand4  g114(.a(new_n147_), .b(new_n142_), .c(new_n136_), .d(new_n110_), .O(z3));
  inv1   g115(.a(new_n50_), .O(new_n149_));
  oai21  g116(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n71_), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n66_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  inv1   g120(.a(new_n123_), .O(new_n154_));
  oai21  g121(.a(new_n56_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n67_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n55_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n110_), .O(z4));
  nor2   g126(.a(new_n109_), .b(new_n50_), .O(z5));
  nand2  g127(.a(x20), .b(new_n54_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n37_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n149_), .O(new_n163_));
  nand2  g130(.a(new_n70_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n68_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n36_), .c(new_n154_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n110_), .O(z6));
  inv1   g134(.a(new_n117_), .O(new_n168_));
  nand4  g135(.a(new_n121_), .b(new_n118_), .c(new_n168_), .d(new_n110_), .O(z7));
endmodule
