...
module FAU ( 
  ...
  nand4  g112(.a(new_n145_), .b(new_n51_), .c(x01), .d(x00), .O(new_n146_));
  ...
  nor2   g119(.a(new_n152_), .b(new_n108_), .O(new_n153_));
  nand2  g120(.a(new_n133_), .b(new_n111_), .O(new_n154_));
  ...
  nand3  g128(.a(new_n145_), .b(new_n51_), .c(x00), .O(new_n162_));
  ...
  oai22  g133(.a(new_n166_), .b(new_n34_), .c(new_n113_), .d(new_n108_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n143_), .O(z6));
  oai21  g135(.a(new_n155_), .b(new_n105_), .c(new_n51_), .O(new_n169_));
