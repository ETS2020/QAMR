...
module FAU ( 
  ...
  oai21  g123(.a(new_n156_), .b(x11), .c(new_n55_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n140_), .O(new_n158_));
  aoi21  g125(.a(new_n90_), .b(x14), .c(new_n34_), .O(new_n159_));
  ...
  and2   g130(.a(new_n112_), .b(new_n111_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n110_), .c(new_n163_), .d(new_n38_), .O(z7));
endmodule
