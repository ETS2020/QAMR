...
module FAU ( 
  ...
  nand3  g097(.a(new_n130_), .b(x20), .c(new_n55_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n74_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x11), .c(x06), .d(x03), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n70_), .O(z2));
  ...
  oai21  g127(.a(new_n39_), .b(new_n102_), .c(new_n40_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x05), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n50_), .c(new_n46_), .d(new_n43_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  oai21  g131(.a(new_n78_), .b(x04), .c(x17), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x22), .c(new_n73_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n75_), .c(x08), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n130_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n164_), .c(new_n57_), .O(z4));
  inv1   g136(.a(new_n47_), .O(new_n170_));
  oai21  g137(.a(new_n91_), .b(x20), .c(x19), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n162_), .c(new_n170_), .O(z5));
  aoi21  g139(.a(x20), .b(new_n74_), .c(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n34_), .O(new_n174_));
  oai21  g141(.a(x13), .b(x05), .c(x24), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n102_), .c(new_n46_), .O(new_n176_));
  ...
  aoi21  g149(.a(new_n36_), .b(x06), .c(x03), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n55_), .c(new_n182_), .O(new_n184_));
  oai21  g151(.a(new_n179_), .b(new_n91_), .c(new_n184_), .O(new_n185_));
  oai21  g152(.a(new_n175_), .b(new_n123_), .c(new_n129_), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(new_n181_), .c(new_n56_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n185_), .c(new_n177_), .O(z6));
  and2   g155(.a(new_n130_), .b(new_n57_), .O(z7));
endmodule
