...
module FAU ( 
  ...
  nand2  g081(.a(new_n114_), .b(new_n112_), .O(z7));
  nand4  g082(.a(z7), .b(x20), .c(x14), .d(x11), .O(new_n116_));
  nor4   g083(.a(new_n116_), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(z2));
  ...
  nand2  g114(.a(new_n51_), .b(new_n48_), .O(new_n148_));
  ...
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n99_), .O(new_n152_));
  ...
  oai21  g122(.a(new_n155_), .b(new_n89_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(z7), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n153_), .O(z4));
  nor2   g125(.a(new_n47_), .b(new_n43_), .O(new_n159_));
  nand3  g126(.a(new_n41_), .b(new_n49_), .c(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n88_), .O(new_n161_));
  ...
  nand4  g132(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n46_), .c(new_n44_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n43_), .c(new_n165_), .d(x03), .O(new_n168_));
  nand2  g135(.a(new_n61_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n35_), .O(new_n170_));
  nand3  g137(.a(new_n113_), .b(new_n41_), .c(x21), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n110_), .c(new_n109_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n108_), .c(new_n170_), .d(new_n96_), .O(new_n173_));
