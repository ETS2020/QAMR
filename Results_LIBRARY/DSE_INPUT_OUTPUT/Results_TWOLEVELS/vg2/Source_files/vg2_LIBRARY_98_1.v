...
module FAU ( 
  ...
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n85_), .O(new_n144_));
  ...
  nand4  g115(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g118(.a(x11), .b(new_n44_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n151_), .c(new_n145_), .O(z4));
  nand3  g120(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n36_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n44_), .O(new_n156_));
  nand2  g123(.a(new_n48_), .b(new_n43_), .O(new_n157_));
  nor2   g124(.a(new_n157_), .b(new_n42_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n156_), .O(z5));
  nand3  g126(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n160_));
  nand3  g127(.a(x19), .b(x13), .c(x05), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n160_), .c(new_n34_), .O(new_n162_));
  oai21  g129(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n163_));
  nand4  g130(.a(x19), .b(x13), .c(new_n36_), .d(x05), .O(new_n164_));
  ...
  nand3  g134(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n34_), .O(new_n170_));
  oai21  g137(.a(x20), .b(new_n90_), .c(x06), .O(new_n171_));
  and2   g138(.a(new_n171_), .b(x15), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(x13), .c(x11), .d(x05), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n170_), .c(new_n166_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n162_), .c(new_n40_), .O(new_n175_));
  aoi21  g142(.a(new_n171_), .b(x11), .c(new_n34_), .O(new_n176_));
  aoi21  g143(.a(new_n163_), .b(new_n36_), .c(x03), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n86_), .c(new_n176_), .d(new_n82_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n76_), .c(x24), .O(new_n179_));
  inv1   g146(.a(x15), .O(new_n180_));
  oai22  g147(.a(new_n177_), .b(new_n71_), .c(new_n176_), .d(new_n180_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n47_), .c(new_n38_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n179_), .c(new_n175_), .d(new_n152_), .O(z6));
  nand3  g150(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(new_n36_), .c(x02), .O(new_n185_));
  or2    g152(.a(new_n185_), .b(new_n115_), .O(z7));
endmodule
