...
module FAU ( 
  ...
  nor2   g092(.a(new_n35_), .b(x02), .O(new_n126_));
  inv1   g093(.a(new_n126_), .O(new_n127_));
  nand2  g094(.a(x24), .b(x18), .O(new_n128_));
  nand3  g095(.a(new_n43_), .b(x15), .c(x13), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n128_), .c(new_n47_), .O(new_n130_));
  ...
  nor2   g102(.a(x24), .b(new_n60_), .O(new_n136_));
  aoi22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n127_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n42_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(x14), .c(x11), .d(x06), .O(new_n139_));
  nor3   g106(.a(new_n139_), .b(new_n37_), .c(new_n36_), .O(z2));
  ...
  nand2  g140(.a(new_n136_), .b(new_n34_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n170_), .c(new_n127_), .O(z4));
  nand4  g144(.a(new_n43_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n178_));
  oai21  g145(.a(new_n126_), .b(new_n55_), .c(new_n178_), .O(z5));
  aoi21  g146(.a(x20), .b(new_n41_), .c(x06), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x11), .c(new_n37_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(z5), .O(new_n182_));
  oai21  g149(.a(x20), .b(new_n41_), .c(x06), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(x11), .c(new_n37_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n137_), .c(new_n182_), .O(z6));
  inv1   g152(.a(new_n134_), .O(new_n186_));
  oai21  g153(.a(new_n136_), .b(x10), .c(new_n34_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n186_), .O(z7));
endmodule
