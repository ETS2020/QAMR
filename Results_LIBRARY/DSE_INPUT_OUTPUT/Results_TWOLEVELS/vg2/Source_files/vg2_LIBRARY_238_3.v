...
module FAU ( 
  ...
  aoi21  g123(.a(x20), .b(new_n122_), .c(x06), .O(new_n157_));
  ...
  inv1   g130(.a(new_n106_), .O(new_n164_));
  and2   g131(.a(new_n111_), .b(new_n108_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n107_), .c(new_n164_), .d(new_n53_), .O(z7));
endmodule
