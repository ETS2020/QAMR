...
module FAU ( 
  ...
  nand2  g067(.a(x11), .b(x02), .O(new_n101_));
  ...
  aoi21  g080(.a(new_n113_), .b(new_n44_), .c(new_n36_), .O(z2));
  ...
  inv1   g100(.a(new_n42_), .O(new_n134_));
  inv1   g101(.a(new_n49_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  oai21  g103(.a(x23), .b(new_n94_), .c(new_n59_), .O(new_n137_));
  ...
  nand3  g114(.a(new_n147_), .b(new_n107_), .c(new_n145_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n140_), .c(new_n101_), .O(z4));
  and2   g117(.a(new_n101_), .b(new_n48_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n46_), .c(new_n43_), .d(new_n134_), .O(z5));
  nand2  g119(.a(x20), .b(new_n103_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n35_), .c(x11), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n136_), .O(new_n155_));
  inv1   g122(.a(new_n110_), .O(new_n156_));
  aoi21  g123(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n157_));
  aoi21  g124(.a(new_n156_), .b(new_n145_), .c(new_n157_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(x11), .O(new_n159_));
  nand2  g126(.a(new_n148_), .b(new_n34_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n159_), .c(new_n155_), .O(z6));
  nand4  g128(.a(new_n147_), .b(new_n107_), .c(new_n145_), .d(new_n101_), .O(z7));
endmodule
