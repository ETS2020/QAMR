...
module FAU ( 
  ...
  oai21  g114(.a(x23), .b(new_n54_), .c(new_n73_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n61_), .c(x09), .O(new_n149_));
  ...
  inv1   g121(.a(new_n111_), .O(new_n155_));
  nor2   g122(.a(x10), .b(x02), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n134_), .c(new_n155_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n110_), .c(new_n109_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand2  g126(.a(x02), .b(x01), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n159_), .c(new_n151_), .O(z4));
  and2   g128(.a(new_n160_), .b(new_n43_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n48_), .c(new_n46_), .d(new_n145_), .O(z5));
  ...
  oai21  g135(.a(new_n168_), .b(new_n34_), .c(new_n158_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n160_), .O(z6));
  nand4  g137(.a(new_n160_), .b(new_n157_), .c(new_n110_), .d(new_n109_), .O(z7));
endmodule
