...
module FAU ( 
  ...
  nor2   g129(.a(new_n162_), .b(new_n110_), .O(new_n163_));
  nand2  g130(.a(new_n122_), .b(new_n113_), .O(new_n164_));
  inv1   g131(.a(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n54_), .c(x01), .O(new_n166_));
  oai21  g133(.a(new_n163_), .b(new_n151_), .c(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n161_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n159_), .O(z6));
  oai21  g136(.a(new_n165_), .b(new_n107_), .c(new_n54_), .O(new_n170_));
