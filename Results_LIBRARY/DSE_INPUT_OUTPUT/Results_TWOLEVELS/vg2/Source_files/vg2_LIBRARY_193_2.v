...
module FAU ( 
  ...
  nor2   g014(.a(new_n42_), .b(new_n47_), .O(new_n48_));
  inv1   g015(.a(x19), .O(new_n49_));
  nor2   g016(.a(new_n49_), .b(x13), .O(new_n50_));
  aoi22  g017(.a(new_n50_), .b(new_n46_), .c(new_n48_), .d(x07), .O(new_n51_));
  ...
  nor2   g026(.a(new_n36_), .b(x10), .O(new_n60_));
  nand4  g027(.a(new_n60_), .b(new_n59_), .c(x09), .d(x08), .O(new_n61_));
  nand4  g028(.a(x17), .b(x16), .c(x14), .d(x12), .O(new_n62_));
  inv1   g029(.a(new_n62_), .O(new_n63_));
  inv1   g030(.a(x21), .O(new_n64_));
  nor2   g031(.a(new_n64_), .b(new_n38_), .O(new_n65_));
  inv1   g032(.a(x23), .O(new_n66_));
  nor2   g033(.a(x24), .b(new_n66_), .O(new_n67_));
  nand4  g034(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(x22), .O(new_n68_));
  oai21  g035(.a(new_n68_), .b(new_n61_), .c(new_n57_), .O(new_n69_));
  nand2  g036(.a(new_n69_), .b(new_n39_), .O(new_n70_));
  ...
  nand3  g041(.a(new_n74_), .b(x11), .c(x09), .O(new_n75_));
  ...
  nor2   g053(.a(x20), .b(new_n49_), .O(new_n87_));
  nor2   g054(.a(x23), .b(x22), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n89_));
  oai21  g056(.a(new_n89_), .b(new_n84_), .c(new_n80_), .O(new_n90_));
  nand2  g057(.a(new_n47_), .b(new_n46_), .O(new_n91_));
  ...
  nand3  g063(.a(new_n96_), .b(new_n76_), .c(new_n72_), .O(new_n97_));
  nor2   g064(.a(x09), .b(x08), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n82_), .c(x07), .d(new_n35_), .O(new_n99_));
  nor2   g066(.a(x12), .b(x11), .O(new_n100_));
  nor2   g067(.a(x16), .b(x14), .O(new_n101_));
  nor2   g068(.a(x20), .b(x17), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n88_), .O(new_n103_));
  ...
  nand3  g078(.a(x15), .b(new_n47_), .c(new_n46_), .O(new_n112_));
  ...
  nor2   g082(.a(x24), .b(new_n64_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n115_), .c(new_n39_), .d(new_n57_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n114_), .c(new_n38_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x14), .c(x11), .d(x06), .O(new_n119_));
  nor3   g086(.a(new_n119_), .b(new_n34_), .c(new_n107_), .O(z2));
  nand3  g087(.a(new_n74_), .b(x03), .c(x01), .O(new_n121_));
  nor2   g088(.a(new_n37_), .b(new_n36_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n83_), .b(new_n34_), .c(new_n107_), .O(new_n124_));
  nand3  g091(.a(new_n87_), .b(new_n37_), .c(new_n36_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n93_), .c(new_n40_), .O(new_n127_));
  nand3  g094(.a(new_n122_), .b(x20), .c(x18), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n107_), .O(new_n129_));
  nand4  g096(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n73_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n121_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n91_), .c(new_n40_), .d(x24), .O(new_n132_));
  nand2  g099(.a(new_n74_), .b(x03), .O(new_n133_));
  nor4   g100(.a(new_n133_), .b(x02), .c(new_n107_), .d(x00), .O(new_n134_));
  nand2  g101(.a(new_n116_), .b(x20), .O(new_n135_));
  inv1   g102(.a(new_n135_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n134_), .c(new_n122_), .d(new_n115_), .O(new_n137_));
  ...
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n73_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n52_), .O(new_n145_));
  inv1   g112(.a(x16), .O(new_n146_));
  oai21  g113(.a(new_n66_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n81_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n146_), .c(x08), .O(new_n149_));
  nand3  g116(.a(new_n116_), .b(new_n115_), .c(new_n39_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n112_), .c(new_n111_), .O(new_n151_));
  or2    g118(.a(new_n151_), .b(new_n110_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n145_), .c(new_n40_), .O(z4));
  and2   g121(.a(new_n52_), .b(new_n40_), .O(z5));
  nand2  g122(.a(new_n38_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n36_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n34_), .c(new_n152_), .O(new_n158_));
  nand2  g125(.a(x20), .b(new_n37_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x11), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x03), .c(new_n52_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n40_), .O(z6));
  nand2  g129(.a(new_n117_), .b(new_n114_), .O(z7));
endmodule
