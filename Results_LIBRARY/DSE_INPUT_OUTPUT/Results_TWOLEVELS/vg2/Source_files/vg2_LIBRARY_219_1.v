...
module FAU ( 
  ...
  nand3  g108(.a(new_n141_), .b(new_n50_), .c(new_n45_), .O(new_n142_));
  ...
  nand3  g117(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n117_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n141_), .O(z5));
  aoi21  g120(.a(x20), .b(new_n38_), .c(x06), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x11), .c(new_n35_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(z5), .O(new_n156_));
  aoi21  g123(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n37_), .c(x03), .O(new_n158_));
  nand2  g125(.a(new_n111_), .b(new_n110_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n109_), .c(new_n117_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n112_), .O(z7));
