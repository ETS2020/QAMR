...
module FAU ( 
  ...
  inv1   g120(.a(new_n151_), .O(new_n154_));
  oai21  g121(.a(new_n55_), .b(new_n51_), .c(new_n154_), .O(new_n155_));
  nand4  g122(.a(new_n140_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(z5));
  aoi21  g124(.a(x20), .b(new_n41_), .c(x06), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x11), .c(new_n36_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(z5), .O(new_n160_));
  aoi21  g127(.a(new_n46_), .b(x14), .c(new_n37_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n40_), .c(x03), .O(new_n162_));
  nand2  g129(.a(new_n154_), .b(new_n115_), .O(new_n163_));
  nand4  g130(.a(new_n148_), .b(new_n38_), .c(new_n34_), .d(new_n35_), .O(new_n164_));
