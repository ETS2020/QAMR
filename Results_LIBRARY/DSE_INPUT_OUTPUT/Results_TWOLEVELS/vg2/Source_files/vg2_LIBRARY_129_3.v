...
module FAU ( 
  ...
  oai21  g080(.a(new_n113_), .b(new_n96_), .c(new_n53_), .O(z2));
  ...
  oai21  g100(.a(x23), .b(new_n95_), .c(new_n60_), .O(new_n134_));
  ...
  oai21  g112(.a(new_n145_), .b(new_n106_), .c(new_n53_), .O(new_n146_));
  ...
  nand4  g119(.a(new_n152_), .b(new_n53_), .c(new_n48_), .d(new_n151_), .O(z5));
