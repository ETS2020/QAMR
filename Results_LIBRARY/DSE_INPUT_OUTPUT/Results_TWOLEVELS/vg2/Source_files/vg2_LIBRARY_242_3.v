...
module FAU ( 
  ...
  oai21  g115(.a(new_n49_), .b(new_n42_), .c(new_n148_), .O(new_n149_));
  ...
  nand3  g119(.a(new_n135_), .b(new_n45_), .c(new_n44_), .O(new_n153_));
  and2   g120(.a(new_n153_), .b(new_n112_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n111_), .c(new_n110_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n149_), .c(new_n53_), .O(z4));
  nand4  g124(.a(new_n53_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n158_));
  or2    g125(.a(new_n158_), .b(new_n42_), .O(z5));
  ...
  oai21  g129(.a(new_n162_), .b(new_n42_), .c(new_n53_), .O(new_n163_));
  ...
  nand3  g134(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n53_), .O(new_n169_));
  ...
  nand4  g139(.a(new_n154_), .b(new_n111_), .c(new_n110_), .d(new_n53_), .O(z7));
endmodule
