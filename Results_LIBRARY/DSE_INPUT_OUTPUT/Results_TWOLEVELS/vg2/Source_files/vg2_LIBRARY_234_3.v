...
module FAU ( 
  ...
  nand4  g068(.a(new_n101_), .b(new_n92_), .c(new_n80_), .d(new_n37_), .O(z1));
  ...
  nand4  g085(.a(new_n66_), .b(new_n34_), .c(new_n104_), .d(new_n103_), .O(new_n119_));
  nand3  g086(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n120_));
  ...
  nand4  g090(.a(x07), .b(new_n34_), .c(new_n104_), .d(new_n103_), .O(new_n124_));
  nand4  g091(.a(new_n60_), .b(new_n36_), .c(new_n35_), .d(new_n66_), .O(new_n125_));
  ...
  nand3  g094(.a(new_n96_), .b(new_n34_), .c(new_n104_), .O(new_n128_));
  ...
  nand2  g101(.a(new_n134_), .b(new_n62_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n133_), .O(z3));
  inv1   g103(.a(x04), .O(new_n137_));
  oai21  g104(.a(x23), .b(new_n137_), .c(new_n59_), .O(new_n138_));
  ...
  oai21  g111(.a(new_n144_), .b(x09), .c(x08), .O(new_n145_));
  nand3  g112(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n146_));
  or2    g113(.a(new_n146_), .b(new_n107_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  oai21  g115(.a(new_n63_), .b(x04), .c(x17), .O(new_n149_));
  nand3  g116(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n109_), .c(new_n108_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n107_), .c(new_n149_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n144_), .c(new_n48_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x22), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n148_), .c(new_n143_), .O(z4));
  and2   g122(.a(new_n45_), .b(new_n37_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n50_), .c(new_n43_), .d(new_n141_), .O(z5));
  ...
  nand2  g127(.a(new_n60_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n35_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n104_), .c(new_n147_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n37_), .O(z6));
  nand2  g131(.a(new_n112_), .b(new_n111_), .O(z7));
endmodule
