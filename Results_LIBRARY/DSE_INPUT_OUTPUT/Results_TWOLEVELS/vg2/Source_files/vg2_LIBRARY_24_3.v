...
module FAU ( 
  ...
  nand2  g109(.a(new_n50_), .b(new_n47_), .O(new_n143_));
  inv1   g110(.a(x04), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n144_), .c(new_n72_), .O(new_n145_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n107_), .c(new_n37_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n110_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n148_), .O(z4));
  inv1   g123(.a(new_n42_), .O(new_n157_));
  and2   g124(.a(new_n50_), .b(new_n43_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n45_), .c(new_n157_), .d(new_n37_), .O(z5));
  nand2  g126(.a(x20), .b(new_n36_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n34_), .c(x11), .O(new_n161_));
  nand3  g128(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n42_), .c(new_n161_), .d(x03), .O(new_n163_));
  nand2  g130(.a(new_n74_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n35_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n122_), .c(new_n111_), .d(new_n107_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n37_), .O(z6));
  nand4  g134(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n37_), .O(new_n168_));
