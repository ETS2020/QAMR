...
module FAU ( 
  ...
  nor4   g049(.a(new_n82_), .b(new_n66_), .c(new_n34_), .d(new_n65_), .O(new_n83_));
  ...
  nor3   g091(.a(new_n124_), .b(new_n69_), .c(new_n54_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x03), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n65_), .c(new_n112_), .O(z2));
  ...
  nand4  g099(.a(new_n132_), .b(new_n69_), .c(new_n54_), .d(new_n110_), .O(new_n133_));
  ...
  nand3  g105(.a(new_n87_), .b(x14), .c(x11), .O(new_n139_));
  nand4  g106(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n140_));
  nor2   g107(.a(x11), .b(x08), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n69_), .c(new_n54_), .d(new_n110_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n81_), .c(x24), .O(new_n144_));
  nand4  g111(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n145_));
  nand3  g112(.a(new_n102_), .b(new_n34_), .c(new_n65_), .O(new_n146_));
  nand4  g113(.a(new_n106_), .b(new_n54_), .c(new_n110_), .d(new_n36_), .O(new_n147_));
  ...
  oai21  g118(.a(x23), .b(new_n66_), .c(new_n68_), .O(new_n152_));
  ...
  aoi21  g127(.a(new_n160_), .b(new_n155_), .c(new_n111_), .O(z4));
  ...
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n112_), .O(z6));
  nor2   g138(.a(new_n124_), .b(new_n111_), .O(z7));
endmodule
