...
module FAU ( 
  ...
  nor2   g125(.a(new_n35_), .b(x02), .O(new_n159_));
  nor2   g126(.a(x24), .b(x12), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n101_), .c(new_n34_), .d(x00), .O(new_n161_));
  oai21  g128(.a(new_n159_), .b(new_n56_), .c(new_n161_), .O(z5));
  ...
  nand3  g134(.a(new_n167_), .b(new_n111_), .c(new_n35_), .O(new_n168_));
  oai21  g135(.a(new_n159_), .b(new_n121_), .c(new_n168_), .O(z7));
  nand2  g136(.a(z7), .b(new_n166_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n163_), .O(z4));
  inv1   g138(.a(new_n159_), .O(new_n172_));
  nand2  g139(.a(x20), .b(new_n40_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n38_), .c(x11), .O(new_n174_));
  nand4  g141(.a(new_n42_), .b(new_n101_), .c(new_n34_), .d(x00), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n54_), .c(new_n52_), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n51_), .c(new_n174_), .d(x03), .O(new_n177_));
  nand2  g144(.a(new_n41_), .b(x14), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x06), .c(new_n47_), .O(new_n179_));
  nand2  g146(.a(new_n167_), .b(new_n111_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n119_), .c(new_n118_), .O(new_n181_));
  oai22  g148(.a(new_n181_), .b(new_n117_), .c(new_n179_), .d(new_n37_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n177_), .c(new_n172_), .O(z6));
endmodule
