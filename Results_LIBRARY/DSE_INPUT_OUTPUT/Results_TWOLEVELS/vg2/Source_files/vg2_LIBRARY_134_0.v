...
module FAU ( 
  ...
  aoi21  g18(.a(new_n51_), .b(x12), .c(x11), .O(z0));
  ...
  nor3   g41(.a(new_n74_), .b(new_n73_), .c(new_n54_), .O(new_n75_));
  nand4  g42(.a(new_n75_), .b(x11), .c(x06), .d(x03), .O(new_n76_));
  oai21  g43(.a(new_n76_), .b(new_n34_), .c(new_n71_), .O(z2));
  ...
  nand4  g54(.a(new_n87_), .b(new_n73_), .c(new_n54_), .d(new_n84_), .O(new_n88_));
  nor2   g55(.a(new_n88_), .b(x08), .O(new_n89_));
  nand4  g56(.a(new_n89_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n90_));
  ...
  nand4  g62(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n96_));
  nand4  g63(.a(new_n73_), .b(new_n54_), .c(new_n84_), .d(new_n53_), .O(new_n97_));
  ...
  nand4  g67(.a(new_n53_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n101_));
  nand4  g68(.a(new_n73_), .b(x19), .c(new_n54_), .d(new_n84_), .O(new_n102_));
  ...
  nand4  g71(.a(new_n104_), .b(new_n99_), .c(new_n92_), .d(new_n71_), .O(z3));
  ...
  aoi21  g76(.a(new_n109_), .b(new_n55_), .c(x09), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(x16), .c(new_n53_), .O(new_n111_));
  nand2  g78(.a(new_n111_), .b(new_n106_), .O(new_n112_));
  inv1   g79(.a(new_n74_), .O(new_n113_));
  ...
  nand3  g87(.a(new_n120_), .b(new_n112_), .c(new_n71_), .O(z4));
  nor2   g88(.a(new_n70_), .b(new_n49_), .O(z5));
  nand2  g89(.a(x20), .b(new_n54_), .O(new_n123_));
  aoi21  g90(.a(new_n123_), .b(new_n36_), .c(x11), .O(new_n124_));
  oai21  g91(.a(new_n124_), .b(x03), .c(new_n106_), .O(new_n125_));
  nand2  g92(.a(new_n73_), .b(x14), .O(new_n126_));
  aoi21  g93(.a(new_n126_), .b(x06), .c(new_n84_), .O(new_n127_));
  oai21  g94(.a(new_n127_), .b(new_n35_), .c(new_n113_), .O(new_n128_));
  nand3  g95(.a(new_n128_), .b(new_n125_), .c(new_n71_), .O(z6));
  inv1   g96(.a(new_n58_), .O(new_n130_));
  and2   g97(.a(new_n61_), .b(new_n60_), .O(new_n131_));
  nand4  g98(.a(new_n71_), .b(new_n131_), .c(new_n59_), .d(new_n130_), .O(z7));
endmodule
