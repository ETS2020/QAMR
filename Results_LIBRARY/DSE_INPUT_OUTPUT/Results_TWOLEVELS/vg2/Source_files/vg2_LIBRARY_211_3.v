...
module FAU ( 
  ...
  nand4  g030(.a(new_n63_), .b(new_n53_), .c(new_n60_), .d(new_n52_), .O(new_n64_));
  ...
  nor4   g046(.a(new_n79_), .b(new_n53_), .c(x16), .d(new_n71_), .O(new_n80_));
  ...
  aoi21  g052(.a(new_n85_), .b(new_n84_), .c(new_n53_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n52_), .c(x14), .d(x11), .O(new_n87_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n53_), .c(new_n71_), .d(new_n36_), .O(new_n93_));
  ...
  nor2   g066(.a(new_n71_), .b(new_n36_), .O(new_n100_));
  nand2  g067(.a(x20), .b(x18), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(x16), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  nor2   g070(.a(x03), .b(x01), .O(new_n104_));
  nand4  g071(.a(new_n53_), .b(new_n71_), .c(new_n36_), .d(new_n83_), .O(new_n105_));
  ...
  nor2   g075(.a(new_n53_), .b(x16), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n100_), .c(new_n99_), .d(x15), .O(new_n110_));
  nand4  g077(.a(new_n53_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n111_));
  inv1   g078(.a(new_n111_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n104_), .c(new_n83_), .d(new_n35_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n110_), .c(x13), .O(new_n114_));
  aoi22  g081(.a(new_n114_), .b(new_n37_), .c(new_n108_), .d(x24), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n97_), .O(z3));
  inv1   g083(.a(new_n49_), .O(new_n117_));
  inv1   g084(.a(x22), .O(new_n118_));
  oai21  g085(.a(x23), .b(new_n57_), .c(new_n60_), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n118_), .c(x09), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(x16), .c(new_n83_), .O(new_n121_));
  ...
  aoi21  g091(.a(new_n124_), .b(x22), .c(new_n58_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n52_), .c(x08), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n122_), .c(new_n55_), .O(z4));
  inv1   g095(.a(new_n41_), .O(new_n129_));
  and2   g096(.a(new_n45_), .b(new_n42_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n55_), .c(new_n47_), .d(new_n129_), .O(z5));
  nand2  g098(.a(x20), .b(new_n71_), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n35_), .c(x11), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x03), .c(new_n117_), .O(new_n134_));
  nand2  g101(.a(new_n53_), .b(x14), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x06), .c(new_n36_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n34_), .c(new_n123_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n134_), .c(new_n55_), .O(z6));
  nor2   g105(.a(new_n79_), .b(new_n54_), .O(z7));
endmodule
