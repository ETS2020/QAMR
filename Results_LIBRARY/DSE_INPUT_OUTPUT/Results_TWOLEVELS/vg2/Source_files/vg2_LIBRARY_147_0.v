...
module FAU ( 
  ...
  nor2   g104(.a(x02), .b(x01), .O(new_n138_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n92_), .c(x01), .d(x00), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n140_), .O(z5));
  nand2  g110(.a(z5), .b(new_n137_), .O(new_n144_));
  ...
  nor2   g117(.a(new_n150_), .b(new_n106_), .O(new_n151_));
  nand2  g118(.a(new_n116_), .b(new_n95_), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n92_), .c(x01), .O(new_n154_));
  oai21  g121(.a(new_n151_), .b(new_n138_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n149_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n144_), .O(z4));
  nand2  g124(.a(x20), .b(new_n103_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n35_), .c(x11), .O(new_n159_));
  nand3  g126(.a(new_n141_), .b(new_n92_), .c(x00), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n45_), .c(new_n43_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n42_), .c(new_n159_), .d(x03), .O(new_n162_));
  nand2  g129(.a(new_n37_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n34_), .c(new_n110_), .d(new_n106_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n139_), .O(z6));
  oai21  g133(.a(new_n153_), .b(new_n62_), .c(new_n92_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n151_), .O(z7));
endmodule
