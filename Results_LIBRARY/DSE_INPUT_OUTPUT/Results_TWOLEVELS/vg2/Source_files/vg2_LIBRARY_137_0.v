...
module FAU ( 
  ...
  aoi21  g084(.a(new_n117_), .b(new_n116_), .c(new_n45_), .O(new_n118_));
  ...
  nand3  g117(.a(new_n112_), .b(new_n109_), .c(new_n54_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n120_), .c(new_n119_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n118_), .c(new_n150_), .O(new_n153_));
  nand2  g120(.a(new_n36_), .b(new_n54_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n153_), .c(new_n147_), .O(z4));
  nand3  g122(.a(new_n40_), .b(new_n109_), .c(x00), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x11), .c(x02), .O(new_n157_));
  or2    g124(.a(new_n157_), .b(new_n49_), .O(z5));
  nand3  g125(.a(new_n109_), .b(new_n54_), .c(x00), .O(new_n159_));
  nand3  g126(.a(x19), .b(x13), .c(x05), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n159_), .c(new_n34_), .O(new_n161_));
  nand3  g128(.a(x15), .b(x13), .c(x05), .O(new_n162_));
  nand3  g129(.a(x21), .b(new_n109_), .c(new_n54_), .O(new_n163_));
  ...
  nand4  g133(.a(x15), .b(x13), .c(x11), .d(x05), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  oai21  g136(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n170_));
  and2   g137(.a(new_n170_), .b(x19), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(x13), .c(new_n36_), .d(x05), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n165_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n161_), .c(new_n40_), .O(new_n174_));
  inv1   g141(.a(x18), .O(new_n175_));
  aoi21  g142(.a(new_n166_), .b(x11), .c(new_n34_), .O(new_n176_));
  aoi21  g143(.a(new_n170_), .b(new_n36_), .c(x03), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n98_), .c(new_n176_), .d(new_n175_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n90_), .c(x24), .O(new_n179_));
  inv1   g146(.a(x15), .O(new_n180_));
  oai22  g147(.a(new_n177_), .b(new_n85_), .c(new_n176_), .d(new_n180_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n46_), .c(new_n45_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n179_), .c(new_n174_), .d(new_n154_), .O(z6));
  nor2   g150(.a(new_n121_), .b(new_n118_), .O(new_n184_));
  aoi21  g151(.a(new_n112_), .b(new_n109_), .c(new_n36_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(x02), .c(new_n184_), .O(z7));
endmodule
