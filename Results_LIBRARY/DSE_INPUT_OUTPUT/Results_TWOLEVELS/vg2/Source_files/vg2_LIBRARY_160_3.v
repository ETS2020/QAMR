...
module FAU ( 
  ...
  nand3  g113(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n147_));
  or2    g114(.a(new_n147_), .b(new_n107_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n143_), .c(new_n37_), .O(z4));
  nand2  g117(.a(new_n50_), .b(new_n47_), .O(z5));
  nand2  g118(.a(x20), .b(new_n36_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n34_), .c(x11), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x03), .c(new_n142_), .O(new_n154_));
  nand2  g121(.a(new_n74_), .b(x14), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x06), .c(new_n35_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n104_), .c(new_n148_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n154_), .c(new_n37_), .O(z6));
  nand2  g125(.a(new_n112_), .b(new_n111_), .O(z7));
endmodule
