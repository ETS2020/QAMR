...
module FAU ( 
  ...
  nand3  g070(.a(new_n103_), .b(new_n41_), .c(new_n50_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n96_), .c(new_n82_), .d(new_n38_), .O(z1));
  ...
  aoi21  g081(.a(new_n114_), .b(new_n113_), .c(new_n90_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n55_), .c(new_n106_), .O(z2));
  ...
  nand4  g094(.a(new_n127_), .b(new_n90_), .c(new_n36_), .d(new_n35_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n34_), .c(new_n55_), .d(new_n106_), .O(new_n130_));
  ...
  nand3  g101(.a(new_n100_), .b(x07), .c(new_n34_), .O(new_n135_));
  nand4  g102(.a(new_n90_), .b(new_n36_), .c(new_n35_), .d(new_n118_), .O(new_n136_));
  ...
  nand4  g115(.a(new_n51_), .b(new_n46_), .c(new_n44_), .d(new_n148_), .O(new_n149_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n91_), .c(x08), .O(new_n153_));
  inv1   g120(.a(new_n109_), .O(new_n154_));
  and2   g121(.a(new_n114_), .b(new_n111_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n110_), .c(new_n154_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n150_), .c(new_n38_), .O(z4));
  and2   g125(.a(new_n46_), .b(new_n38_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n51_), .c(new_n44_), .d(new_n148_), .O(z5));
  ...
  nand2  g130(.a(new_n90_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n35_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n55_), .c(new_n156_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n38_), .O(z6));
  nand4  g134(.a(new_n155_), .b(new_n110_), .c(new_n154_), .d(new_n38_), .O(z7));
endmodule
