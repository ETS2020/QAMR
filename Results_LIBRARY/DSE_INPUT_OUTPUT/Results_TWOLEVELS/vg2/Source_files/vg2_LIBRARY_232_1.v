...
module FAU ( 
  ...
  oai21  g087(.a(new_n120_), .b(new_n96_), .c(new_n112_), .O(z2));
  nand4  g088(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  nand3  g089(.a(new_n109_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n69_), .b(new_n97_), .c(new_n96_), .O(new_n124_));
  nand3  g091(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n80_), .O(new_n127_));
  nand2  g094(.a(new_n109_), .b(new_n85_), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n34_), .c(new_n97_), .d(new_n96_), .O(new_n129_));
  nand4  g096(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n100_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n122_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n78_), .c(x24), .O(new_n132_));
  nand4  g099(.a(new_n34_), .b(new_n97_), .c(new_n96_), .d(x00), .O(new_n133_));
  nand3  g100(.a(new_n109_), .b(x21), .c(x20), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n122_), .c(new_n133_), .d(new_n130_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n41_), .c(new_n101_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n49_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n37_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n132_), .c(new_n127_), .O(z3));
  nand2  g106(.a(new_n51_), .b(new_n48_), .O(z5));
  aoi21  g107(.a(new_n63_), .b(x17), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n100_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(z5), .O(new_n143_));
  aoi21  g110(.a(x22), .b(new_n60_), .c(new_n67_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n90_), .c(x08), .O(new_n145_));
  nor2   g112(.a(new_n90_), .b(x04), .O(new_n146_));
  aoi22  g113(.a(new_n146_), .b(new_n65_), .c(new_n145_), .d(new_n38_), .O(new_n147_));
  nand3  g114(.a(x07), .b(x04), .c(x02), .O(new_n148_));
  nand2  g115(.a(new_n75_), .b(new_n90_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n84_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n78_), .c(x24), .O(new_n151_));
  inv1   g118(.a(x15), .O(new_n152_));
  nor2   g119(.a(x16), .b(new_n49_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n75_), .c(x19), .d(x02), .O(new_n154_));
  oai21  g121(.a(new_n147_), .b(new_n152_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n80_), .O(new_n156_));
  aoi21  g123(.a(new_n64_), .b(x17), .c(new_n63_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n67_), .c(x16), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x08), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n41_), .c(x21), .d(new_n101_), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n49_), .c(new_n37_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n156_), .c(new_n151_), .d(new_n143_), .O(z4));
  ...
  inv1   g135(.a(new_n38_), .O(new_n169_));
  nand3  g136(.a(new_n41_), .b(x21), .c(new_n101_), .O(new_n170_));
  inv1   g137(.a(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n49_), .c(new_n37_), .O(new_n172_));
  oai21  g139(.a(new_n118_), .b(new_n169_), .c(new_n172_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n168_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n166_), .O(z6));
  oai21  g142(.a(new_n171_), .b(x04), .c(new_n37_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n118_), .O(z7));
endmodule
