...
module FAU ( 
  ...
  aoi21  g018(.a(new_n51_), .b(x16), .c(x20), .O(z0));
  ...
  nor2   g036(.a(x20), .b(x16), .O(new_n70_));
  ...
  nand4  g054(.a(new_n87_), .b(x16), .c(new_n54_), .d(new_n84_), .O(new_n88_));
  ...
  nor2   g063(.a(x11), .b(x08), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n73_), .c(x16), .d(new_n54_), .O(new_n98_));
  oai22  g065(.a(new_n98_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n99_));
  ...
  nor2   g069(.a(x14), .b(x11), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n73_), .c(x19), .d(x16), .O(new_n104_));
  oai22  g071(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n94_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n46_), .c(new_n37_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n100_), .c(new_n92_), .O(z3));
  inv1   g074(.a(new_n49_), .O(new_n108_));
  inv1   g075(.a(x04), .O(new_n109_));
  inv1   g076(.a(x17), .O(new_n110_));
  oai21  g077(.a(x23), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n55_), .c(x09), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(x16), .c(new_n53_), .O(new_n113_));
  ...
  aoi21  g086(.a(new_n119_), .b(x22), .c(new_n117_), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n116_), .c(x08), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n115_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n114_), .c(new_n71_), .O(z4));
  inv1   g090(.a(new_n41_), .O(new_n124_));
  and2   g091(.a(new_n45_), .b(new_n42_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n71_), .c(new_n47_), .d(new_n124_), .O(z5));
  nand2  g093(.a(x20), .b(new_n54_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n36_), .c(x11), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(x03), .c(new_n108_), .O(new_n129_));
  nand2  g096(.a(new_n73_), .b(x14), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x06), .c(new_n84_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n35_), .c(new_n115_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n129_), .c(new_n71_), .O(z6));
  nor2   g100(.a(new_n70_), .b(new_n74_), .O(z7));
endmodule
