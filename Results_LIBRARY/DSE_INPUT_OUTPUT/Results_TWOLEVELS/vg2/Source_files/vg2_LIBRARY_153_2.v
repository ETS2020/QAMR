...
module FAU ( 
  ...
  nand3  g113(.a(new_n146_), .b(new_n34_), .c(x00), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n55_), .c(new_n53_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n52_), .c(new_n145_), .d(x08), .O(new_n149_));
  ...
  nand4  g121(.a(new_n154_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n155_));
  ...
  nor2   g125(.a(new_n56_), .b(new_n52_), .O(new_n159_));
  nand3  g126(.a(new_n146_), .b(new_n136_), .c(new_n34_), .O(new_n160_));
  oai21  g127(.a(new_n156_), .b(new_n159_), .c(new_n160_), .O(z5));
  ...
  nand3  g134(.a(new_n44_), .b(x21), .c(new_n37_), .O(new_n168_));
  inv1   g135(.a(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n34_), .c(new_n35_), .O(new_n170_));
  oai21  g137(.a(new_n156_), .b(new_n167_), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n166_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n164_), .O(z6));
  oai21  g140(.a(new_n169_), .b(x01), .c(new_n34_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n167_), .O(z7));
endmodule
