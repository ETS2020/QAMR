...
module FAU ( 
  ...
  aoi21  g018(.a(new_n51_), .b(x21), .c(x20), .O(z0));
  ...
  nand4  g049(.a(new_n82_), .b(new_n64_), .c(new_n35_), .d(new_n34_), .O(new_n83_));
  ...
  nor4   g055(.a(new_n88_), .b(new_n64_), .c(new_n35_), .d(new_n34_), .O(new_n89_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n66_), .d(new_n65_), .O(new_n98_));
  nand4  g065(.a(new_n69_), .b(new_n68_), .c(new_n53_), .d(new_n67_), .O(new_n99_));
  ...
  nor2   g084(.a(x21), .b(x20), .O(new_n118_));
  inv1   g085(.a(new_n118_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n117_), .c(new_n104_), .O(new_n120_));
  inv1   g087(.a(new_n120_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n85_), .O(z1));
  nor2   g089(.a(new_n38_), .b(new_n92_), .O(new_n123_));
  inv1   g090(.a(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n38_), .b(x15), .c(x13), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n124_), .c(new_n45_), .O(new_n126_));
  nand2  g093(.a(new_n123_), .b(x13), .O(new_n127_));
  nand3  g094(.a(x15), .b(new_n46_), .c(new_n45_), .O(new_n128_));
  nand4  g095(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nor3   g098(.a(new_n131_), .b(new_n71_), .c(new_n68_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x11), .c(x06), .d(x03), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n34_), .c(new_n119_), .O(z2));
  nand4  g101(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(new_n65_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand4  g104(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n67_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n140_));
  ...
  nor2   g110(.a(new_n68_), .b(new_n67_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n93_), .O(new_n145_));
  nand3  g112(.a(new_n97_), .b(new_n35_), .c(new_n34_), .O(new_n146_));
  nand4  g113(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n65_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n143_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n87_), .c(x24), .O(new_n149_));
  nand3  g116(.a(new_n144_), .b(x20), .c(x15), .O(new_n150_));
  nand3  g117(.a(new_n109_), .b(new_n35_), .c(new_n34_), .O(new_n151_));
  nand3  g118(.a(new_n114_), .b(new_n68_), .c(new_n67_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n143_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n46_), .c(new_n45_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n149_), .c(new_n142_), .d(new_n119_), .O(z3));
  oai21  g122(.a(x23), .b(new_n64_), .c(new_n70_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n72_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n66_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n69_), .c(x08), .O(new_n159_));
  ...
  aoi21  g130(.a(new_n163_), .b(new_n160_), .c(new_n118_), .O(new_n164_));
  oai21  g131(.a(new_n159_), .b(new_n49_), .c(new_n164_), .O(z4));
  nor2   g132(.a(new_n118_), .b(new_n49_), .O(z5));
  ...
  nand2  g136(.a(new_n169_), .b(new_n87_), .O(new_n170_));
  oai21  g137(.a(new_n71_), .b(x14), .c(new_n36_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n67_), .c(x03), .O(new_n172_));
  nand3  g139(.a(new_n144_), .b(new_n71_), .c(x15), .O(new_n173_));
  oai21  g140(.a(new_n172_), .b(new_n113_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand3  g142(.a(new_n144_), .b(new_n71_), .c(x18), .O(new_n176_));
  oai21  g143(.a(new_n172_), .b(new_n37_), .c(new_n176_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n87_), .c(x24), .O(new_n178_));
  aoi21  g145(.a(x14), .b(new_n36_), .c(x11), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(x03), .c(x00), .O(new_n180_));
  nand3  g147(.a(new_n71_), .b(x14), .c(x11), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n38_), .c(new_n43_), .d(new_n42_), .O(new_n183_));
  and2   g150(.a(new_n183_), .b(new_n119_), .O(new_n184_));
  nand4  g151(.a(new_n184_), .b(new_n178_), .c(new_n175_), .d(new_n168_), .O(z6));
  inv1   g152(.a(new_n126_), .O(new_n186_));
  and2   g153(.a(new_n128_), .b(new_n127_), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n129_), .c(new_n186_), .d(new_n119_), .O(z7));
endmodule
