...
module FAU ( 
  ...
  nand4  g069(.a(new_n102_), .b(new_n90_), .c(new_n66_), .d(new_n37_), .O(new_n103_));
  ...
  nand2  g074(.a(x20), .b(new_n68_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n107_), .c(new_n97_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n80_), .O(z1));
  nor2   g078(.a(new_n40_), .b(new_n86_), .O(new_n112_));
  ...
  aoi21  g089(.a(new_n122_), .b(x11), .c(new_n34_), .O(z2));
  nand2  g090(.a(new_n58_), .b(new_n57_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x20), .c(x14), .d(x08), .O(new_n125_));
  nor4   g092(.a(new_n125_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n126_));
  nand2  g093(.a(new_n72_), .b(new_n71_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n54_), .c(new_n68_), .d(new_n66_), .O(new_n128_));
  nor4   g095(.a(new_n128_), .b(x06), .c(x03), .d(x01), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n126_), .c(new_n40_), .O(new_n130_));
  nand3  g097(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n131_));
  nand4  g098(.a(new_n54_), .b(new_n68_), .c(new_n66_), .d(x07), .O(new_n132_));
  nand3  g099(.a(x06), .b(x03), .c(x01), .O(new_n133_));
  nand3  g100(.a(new_n87_), .b(x14), .c(x08), .O(new_n134_));
  ...
  nand4  g103(.a(x19), .b(new_n54_), .c(new_n68_), .d(new_n66_), .O(new_n137_));
  nand4  g104(.a(x20), .b(x15), .c(x14), .d(x08), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n133_), .c(new_n137_), .d(new_n131_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n47_), .c(new_n38_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n136_), .c(new_n130_), .d(new_n108_), .O(z3));
  inv1   g108(.a(new_n50_), .O(new_n142_));
  oai21  g109(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n70_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n66_), .O(new_n145_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n55_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n146_), .c(new_n108_), .O(z4));
  inv1   g119(.a(new_n42_), .O(new_n153_));
  and2   g120(.a(new_n46_), .b(new_n43_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n108_), .c(new_n48_), .d(new_n153_), .O(z5));
  oai21  g122(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n142_), .O(new_n157_));
  nand2  g124(.a(new_n34_), .b(x14), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x06), .c(new_n68_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n36_), .c(new_n147_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n108_), .O(z6));
  inv1   g128(.a(new_n115_), .O(new_n162_));
  and2   g129(.a(new_n117_), .b(new_n116_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n118_), .c(new_n162_), .d(new_n108_), .O(z7));
endmodule
