...
module FAU ( 
  ...
  oai21  g104(.a(x23), .b(new_n137_), .c(new_n72_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n61_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n66_), .O(new_n140_));
  nand3  g107(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n141_));
  or2    g108(.a(new_n141_), .b(new_n42_), .O(new_n142_));
  ...
  inv1   g113(.a(new_n107_), .O(new_n147_));
  and2   g114(.a(new_n112_), .b(new_n109_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n108_), .c(new_n147_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n143_), .c(new_n37_), .O(z4));
  nand2  g118(.a(new_n50_), .b(new_n47_), .O(z5));
  nand2  g119(.a(x20), .b(new_n36_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n34_), .c(x11), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n142_), .O(new_n155_));
  nand2  g122(.a(new_n74_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n35_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n104_), .c(new_n149_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n37_), .O(z6));
  nand4  g126(.a(new_n148_), .b(new_n108_), .c(new_n147_), .d(new_n37_), .O(z7));
endmodule
