...
module FAU ( 
  ...
  nand4  g051(.a(new_n84_), .b(new_n83_), .c(new_n63_), .d(new_n60_), .O(new_n85_));
  ...
  nand4  g062(.a(new_n83_), .b(new_n63_), .c(x21), .d(x20), .O(new_n96_));
  ...
  oai22  g066(.a(new_n99_), .b(new_n91_), .c(new_n96_), .d(new_n95_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n41_), .c(new_n50_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n93_), .c(new_n81_), .d(new_n38_), .O(z1));
  ...
  aoi21  g079(.a(new_n112_), .b(new_n111_), .c(new_n104_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x14), .c(x11), .d(x06), .O(new_n114_));
  nor3   g081(.a(new_n114_), .b(new_n55_), .c(new_n103_), .O(z2));
  ...
  nand2  g085(.a(new_n97_), .b(new_n69_), .O(new_n119_));
  nand3  g086(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n80_), .O(new_n122_));
  nand2  g089(.a(new_n117_), .b(new_n84_), .O(new_n123_));
  nand3  g090(.a(new_n97_), .b(x07), .c(new_n34_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nand4  g092(.a(new_n104_), .b(new_n36_), .c(new_n35_), .d(new_n125_), .O(new_n126_));
  ...
  nand4  g095(.a(new_n34_), .b(new_n55_), .c(new_n103_), .d(x00), .O(new_n129_));
  nand3  g096(.a(new_n117_), .b(x21), .c(x20), .O(new_n130_));
  ...
  oai21  g106(.a(x10), .b(new_n138_), .c(new_n139_), .O(new_n140_));
  inv1   g107(.a(x17), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n56_), .c(new_n141_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n37_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n125_), .O(new_n144_));
  inv1   g111(.a(x16), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x09), .c(x08), .O(new_n146_));
  inv1   g113(.a(x21), .O(new_n147_));
  nand3  g114(.a(x15), .b(x13), .c(x05), .O(new_n148_));
  oai21  g115(.a(new_n147_), .b(x10), .c(new_n148_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  oai21  g117(.a(new_n62_), .b(x04), .c(x17), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(x22), .c(x21), .d(x16), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x10), .c(new_n150_), .O(new_n153_));
  aoi21  g120(.a(new_n144_), .b(new_n140_), .c(new_n153_), .O(new_n154_));
  inv1   g121(.a(new_n146_), .O(new_n155_));
  nand3  g122(.a(new_n78_), .b(x24), .c(x18), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n109_), .c(new_n155_), .O(new_n157_));
  nand3  g124(.a(new_n78_), .b(x24), .c(x07), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n46_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n144_), .c(new_n157_), .O(new_n160_));
  oai21  g127(.a(new_n154_), .b(x24), .c(new_n160_), .O(new_n161_));
  ...
  or2    g131(.a(new_n151_), .b(new_n67_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x16), .c(new_n125_), .O(new_n166_));
  aoi21  g133(.a(new_n145_), .b(x09), .c(x08), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n163_), .c(new_n166_), .d(new_n164_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x22), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n162_), .O(z4));
  inv1   g137(.a(new_n43_), .O(new_n171_));
  and2   g138(.a(new_n51_), .b(new_n44_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n46_), .c(new_n171_), .d(new_n38_), .O(z5));
  ...
  nand2  g144(.a(new_n104_), .b(x14), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x06), .c(new_n35_), .O(new_n179_));
  nand3  g146(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(new_n107_), .c(new_n179_), .d(new_n55_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n177_), .c(new_n38_), .O(z6));
  inv1   g149(.a(new_n107_), .O(new_n183_));
  inv1   g150(.a(new_n110_), .O(new_n184_));
  nand4  g151(.a(new_n112_), .b(new_n184_), .c(new_n183_), .d(new_n38_), .O(z7));
endmodule
