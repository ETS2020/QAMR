...
module FAU ( 
  ...
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n67_), .d(new_n35_), .O(new_n95_));
  nand4  g062(.a(new_n70_), .b(new_n69_), .c(new_n38_), .d(new_n54_), .O(new_n96_));
  ...
  oai21  g067(.a(new_n100_), .b(new_n95_), .c(new_n92_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n86_), .c(new_n85_), .O(new_n102_));
  inv1   g069(.a(x18), .O(new_n103_));
  aoi21  g070(.a(new_n86_), .b(new_n85_), .c(new_n42_), .O(new_n104_));
  ...
  nor2   g078(.a(x14), .b(new_n36_), .O(new_n112_));
  inv1   g079(.a(new_n112_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n111_), .c(new_n102_), .O(new_n114_));
  inv1   g081(.a(new_n114_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n84_), .O(z1));
  nand3  g083(.a(new_n42_), .b(x15), .c(x13), .O(new_n117_));
  oai21  g084(.a(new_n42_), .b(new_n103_), .c(new_n117_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(x05), .O(new_n119_));
  nand3  g086(.a(x24), .b(x18), .c(x13), .O(new_n120_));
  nand3  g087(.a(x15), .b(new_n86_), .c(new_n85_), .O(new_n121_));
  nand4  g088(.a(new_n42_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  ...
  oai21  g093(.a(new_n126_), .b(new_n65_), .c(new_n113_), .O(z2));
  ...
  nand4  g097(.a(new_n75_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n131_));
  ...
  nand4  g105(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n139_));
  nand4  g106(.a(new_n99_), .b(new_n38_), .c(new_n37_), .d(new_n67_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n136_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n86_), .c(new_n85_), .O(new_n142_));
  nand3  g109(.a(new_n104_), .b(x20), .c(x18), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(new_n38_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(x11), .c(x08), .O(new_n145_));
  nor2   g112(.a(new_n145_), .b(new_n35_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(x03), .c(x01), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n142_), .c(new_n135_), .O(z3));
  oai21  g115(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n71_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n67_), .O(new_n151_));
  nand3  g118(.a(new_n42_), .b(x19), .c(x13), .O(new_n152_));
  oai21  g119(.a(new_n42_), .b(new_n36_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x05), .O(new_n154_));
  nand3  g121(.a(x24), .b(x13), .c(x07), .O(new_n155_));
  nand3  g122(.a(x19), .b(new_n86_), .c(new_n85_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n48_), .O(new_n157_));
  ...
  nand3  g129(.a(new_n162_), .b(new_n158_), .c(new_n113_), .O(z4));
  nand2  g130(.a(new_n113_), .b(new_n49_), .O(new_n164_));
  nand3  g131(.a(new_n104_), .b(x14), .c(x07), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n164_), .O(z5));
  oai21  g133(.a(new_n37_), .b(x06), .c(x03), .O(new_n167_));
  ...
  aoi21  g137(.a(new_n170_), .b(new_n168_), .c(new_n112_), .O(new_n171_));
  nor2   g138(.a(x11), .b(x07), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(x20), .c(x19), .d(new_n38_), .O(new_n173_));
  nand3  g140(.a(new_n137_), .b(new_n39_), .c(x15), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n171_), .c(new_n44_), .O(new_n176_));
  oai21  g143(.a(x20), .b(new_n37_), .c(new_n36_), .O(new_n177_));
  aoi22  g144(.a(new_n177_), .b(x14), .c(new_n167_), .d(new_n36_), .O(new_n178_));
  nand3  g145(.a(new_n169_), .b(x14), .c(x07), .O(new_n179_));
  oai21  g146(.a(new_n178_), .b(new_n103_), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n41_), .c(x24), .O(new_n181_));
  aoi22  g148(.a(new_n169_), .b(x00), .c(new_n167_), .d(x21), .O(new_n182_));
  nand2  g149(.a(new_n36_), .b(x00), .O(new_n183_));
  nor4   g150(.a(new_n183_), .b(new_n39_), .c(x14), .d(x11), .O(new_n184_));
  nand3  g151(.a(new_n137_), .b(x21), .c(new_n39_), .O(new_n185_));
  inv1   g152(.a(new_n185_), .O(new_n186_));
  nor2   g153(.a(new_n186_), .b(new_n184_), .O(new_n187_));
  oai21  g154(.a(new_n182_), .b(new_n112_), .c(new_n187_), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(new_n42_), .c(new_n47_), .d(new_n46_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n181_), .c(new_n176_), .O(z6));
  inv1   g157(.a(new_n122_), .O(new_n191_));
  and2   g158(.a(new_n44_), .b(x15), .O(new_n192_));
  oai21  g159(.a(new_n192_), .b(new_n191_), .c(new_n113_), .O(new_n193_));
  nand2  g160(.a(new_n38_), .b(x07), .O(new_n194_));
  nand4  g161(.a(new_n194_), .b(new_n41_), .c(x24), .d(x18), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n193_), .O(z7));
endmodule
