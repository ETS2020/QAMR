...
module FAU ( 
  ...
  aoi21  g118(.a(x20), .b(new_n72_), .c(x06), .O(new_n152_));
  ...
  oai21  g124(.a(new_n157_), .b(new_n109_), .c(new_n147_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n144_), .O(z7));
  nand2  g126(.a(z7), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n154_), .O(z6));
endmodule
