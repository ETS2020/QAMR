...
module FAU ( 
  ...
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n115_), .d(new_n110_), .O(new_n138_));
  oai21  g105(.a(new_n135_), .b(new_n133_), .c(new_n138_), .O(new_n139_));
  nand3  g106(.a(new_n40_), .b(x13), .c(x05), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n88_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand4  g109(.a(new_n35_), .b(new_n34_), .c(new_n67_), .d(x00), .O(new_n143_));
  nand4  g110(.a(new_n37_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n144_));
  nand3  g111(.a(new_n134_), .b(x21), .c(x20), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n133_), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n40_), .c(new_n45_), .O(new_n147_));
  nand2  g114(.a(new_n88_), .b(x24), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n37_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(x18), .c(x14), .d(x11), .O(new_n150_));
  ...
  nand3  g121(.a(new_n139_), .b(new_n47_), .c(new_n38_), .O(new_n155_));
  inv1   g122(.a(new_n133_), .O(new_n156_));
  nand3  g123(.a(new_n134_), .b(new_n156_), .c(new_n94_), .O(new_n157_));
  nand3  g124(.a(new_n35_), .b(new_n34_), .c(new_n67_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n144_), .c(new_n157_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n88_), .c(x24), .O(new_n160_));
  nor2   g127(.a(x24), .b(new_n37_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n134_), .c(new_n156_), .d(x15), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n138_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(x13), .c(x05), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n160_), .c(new_n155_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x07), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n154_), .O(z3));
  oai21  g134(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n74_), .c(x09), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x16), .c(new_n69_), .O(new_n170_));
  aoi21  g137(.a(new_n140_), .b(new_n88_), .c(x02), .O(new_n171_));
  nand2  g138(.a(x13), .b(x05), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n88_), .c(new_n53_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n171_), .c(x19), .O(new_n174_));
  nand3  g141(.a(new_n88_), .b(x24), .c(x07), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n174_), .c(new_n46_), .O(z5));
  nand2  g143(.a(z5), .b(new_n170_), .O(new_n177_));
  oai21  g144(.a(new_n75_), .b(x04), .c(x17), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x22), .c(new_n70_), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(new_n72_), .c(x08), .O(new_n180_));
  nand3  g147(.a(new_n141_), .b(new_n54_), .c(x15), .O(new_n181_));
  nand3  g148(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n182_));
  oai21  g149(.a(new_n148_), .b(new_n93_), .c(new_n182_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n44_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nor3   g152(.a(new_n148_), .b(new_n93_), .c(new_n53_), .O(new_n186_));
  aoi21  g153(.a(new_n185_), .b(new_n180_), .c(new_n186_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n177_), .O(z4));
  aoi21  g155(.a(x20), .b(new_n71_), .c(x06), .O(new_n189_));
  ...
  aoi21  g160(.a(new_n193_), .b(new_n185_), .c(new_n186_), .O(new_n194_));
  nand2  g161(.a(new_n194_), .b(new_n191_), .O(z6));
  nand2  g162(.a(new_n126_), .b(new_n125_), .O(new_n196_));
  oai21  g163(.a(new_n196_), .b(new_n124_), .c(new_n54_), .O(new_n197_));
  nand2  g164(.a(new_n197_), .b(new_n127_), .O(z7));
endmodule
