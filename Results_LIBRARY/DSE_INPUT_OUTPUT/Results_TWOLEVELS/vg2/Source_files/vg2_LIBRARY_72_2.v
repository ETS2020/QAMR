...
module FAU ( 
  ...
  nand3  g123(.a(new_n40_), .b(x21), .c(new_n100_), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n44_), .c(new_n107_), .O(new_n159_));
  oai21  g126(.a(new_n147_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g130(.a(new_n163_), .b(x02), .c(new_n149_), .O(z5));
  aoi21  g131(.a(x20), .b(new_n89_), .c(x06), .O(new_n165_));
  ...
  nand2  g136(.a(new_n169_), .b(new_n160_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n167_), .O(z6));
  oai21  g138(.a(new_n158_), .b(x01), .c(new_n44_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n156_), .O(z7));
endmodule
