...
module FAU ( 
  ...
  nand2  g092(.a(x23), .b(new_n71_), .O(new_n126_));
  oai21  g093(.a(new_n125_), .b(new_n64_), .c(new_n126_), .O(z2));
  ...
  aoi21  g097(.a(new_n75_), .b(new_n74_), .c(x23), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n132_));
  ...
  nand2  g103(.a(new_n46_), .b(new_n37_), .O(new_n137_));
  nand4  g104(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n138_));
  nand3  g105(.a(new_n91_), .b(x14), .c(x11), .O(new_n139_));
  nand4  g106(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n140_));
  nor2   g107(.a(x23), .b(x20), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n137_), .c(x24), .O(new_n144_));
  nand4  g111(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n145_));
  nand4  g112(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n146_));
  nand4  g113(.a(new_n141_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n147_));
  ...
  oai21  g118(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n72_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n66_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  inv1   g122(.a(new_n123_), .O(new_n156_));
  oai21  g123(.a(new_n73_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n67_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n69_), .c(x08), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n155_), .c(new_n126_), .O(z4));
  inv1   g128(.a(new_n41_), .O(new_n162_));
  and2   g129(.a(new_n45_), .b(new_n42_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n126_), .c(new_n47_), .d(new_n162_), .O(z5));
  nand2  g131(.a(x20), .b(new_n68_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x03), .c(new_n151_), .O(new_n167_));
  nand2  g134(.a(new_n71_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n36_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n34_), .c(new_n156_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n126_), .O(z6));
  inv1   g138(.a(new_n118_), .O(new_n172_));
  and2   g139(.a(new_n120_), .b(new_n119_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n126_), .c(new_n121_), .d(new_n172_), .O(z7));
endmodule
