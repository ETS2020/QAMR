...
module FAU ( 
  ...
  nand3  g065(.a(new_n98_), .b(new_n41_), .c(new_n37_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n92_), .c(new_n80_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n49_), .O(new_n101_));
  nand2  g068(.a(new_n92_), .b(new_n80_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(x10), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n101_), .O(z1));
  ...
  nand3  g077(.a(new_n41_), .b(x21), .c(new_n37_), .O(new_n111_));
  ...
  oai21  g082(.a(new_n115_), .b(new_n105_), .c(new_n38_), .O(z2));
  ...
  nand2  g086(.a(new_n95_), .b(new_n68_), .O(new_n120_));
  ...
  nand2  g090(.a(new_n118_), .b(new_n83_), .O(new_n124_));
  nand3  g091(.a(new_n95_), .b(x07), .c(new_n34_), .O(new_n125_));
  ...
  nand4  g097(.a(new_n34_), .b(new_n130_), .c(new_n105_), .d(x00), .O(new_n131_));
  nand2  g098(.a(new_n118_), .b(new_n93_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n117_), .c(new_n131_), .d(new_n127_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n41_), .c(new_n37_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n129_), .c(new_n123_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n49_), .O(new_n136_));
  nand2  g103(.a(new_n129_), .b(new_n123_), .O(new_n137_));
  ...
  nand3  g111(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n46_), .c(new_n44_), .d(new_n144_), .O(new_n146_));
  ...
  oai21  g118(.a(new_n112_), .b(new_n108_), .c(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n147_), .c(new_n38_), .O(z4));
  inv1   g120(.a(x00), .O(new_n154_));
  oai21  g121(.a(x24), .b(new_n154_), .c(new_n49_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n37_), .c(new_n47_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n144_), .O(z5));
  nand2  g124(.a(new_n50_), .b(new_n48_), .O(new_n158_));
  aoi21  g125(.a(x20), .b(new_n36_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n130_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  aoi21  g128(.a(new_n60_), .b(x14), .c(new_n34_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n35_), .c(x03), .O(new_n163_));
  nand2  g130(.a(new_n110_), .b(new_n109_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n108_), .c(new_n38_), .O(new_n165_));
  nand4  g132(.a(new_n41_), .b(x21), .c(new_n37_), .d(new_n49_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(z7));
  nand2  g134(.a(z7), .b(new_n163_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n161_), .O(z6));
endmodule
