...
module FAU ( 
  ...
  nor2   g114(.a(x24), .b(new_n147_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n38_), .c(new_n34_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n150_));
  nor2   g117(.a(x02), .b(new_n35_), .O(new_n151_));
  aoi21  g118(.a(new_n150_), .b(new_n146_), .c(new_n151_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n143_), .O(z4));
  nor2   g120(.a(new_n55_), .b(new_n51_), .O(new_n154_));
  aoi21  g121(.a(new_n140_), .b(x00), .c(x01), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x02), .c(new_n154_), .O(z5));
  aoi21  g123(.a(x20), .b(new_n41_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n36_), .O(new_n158_));
  nand4  g125(.a(new_n140_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n159_));
  oai21  g126(.a(new_n151_), .b(new_n154_), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  aoi21  g128(.a(new_n46_), .b(x14), .c(new_n37_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n40_), .c(x03), .O(new_n163_));
  inv1   g130(.a(new_n151_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n115_), .O(new_n165_));
  nand4  g132(.a(new_n148_), .b(new_n38_), .c(new_n34_), .d(new_n35_), .O(new_n166_));
