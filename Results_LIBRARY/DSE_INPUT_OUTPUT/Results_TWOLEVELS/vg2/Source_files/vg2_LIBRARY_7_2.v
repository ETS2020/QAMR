...
module FAU ( 
  ...
  nor2   g061(.a(new_n53_), .b(new_n37_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n83_), .c(new_n65_), .d(new_n58_), .O(new_n96_));
  ...
  nand3  g068(.a(new_n101_), .b(new_n94_), .c(new_n81_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n44_), .O(new_n103_));
  nand2  g070(.a(new_n94_), .b(new_n81_), .O(new_n104_));
  ...
  oai21  g079(.a(new_n112_), .b(new_n110_), .c(new_n54_), .O(new_n113_));
  ...
  nand2  g088(.a(new_n97_), .b(new_n69_), .O(new_n122_));
  nand3  g089(.a(new_n74_), .b(new_n119_), .c(new_n36_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n118_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n80_), .O(new_n125_));
  nand2  g092(.a(new_n120_), .b(new_n85_), .O(new_n126_));
  nand3  g093(.a(new_n97_), .b(x07), .c(new_n35_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n119_), .c(new_n36_), .d(new_n128_), .O(new_n129_));
  ...
  nand2  g099(.a(new_n120_), .b(new_n95_), .O(new_n133_));
  ...
  aoi21  g108(.a(new_n64_), .b(x04), .c(x17), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n67_), .O(new_n143_));
  inv1   g110(.a(new_n42_), .O(new_n144_));
  nand4  g111(.a(new_n40_), .b(new_n53_), .c(new_n45_), .d(x00), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n48_), .c(new_n43_), .d(new_n144_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n143_), .c(new_n141_), .O(new_n147_));
  inv1   g114(.a(x07), .O(new_n148_));
  inv1   g115(.a(x04), .O(new_n149_));
  aoi21  g116(.a(x23), .b(new_n149_), .c(new_n61_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n63_), .c(x09), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x16), .c(new_n128_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n84_), .c(new_n128_), .d(new_n148_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n78_), .c(x24), .O(new_n154_));
  inv1   g121(.a(x15), .O(new_n155_));
  oai22  g122(.a(new_n152_), .b(new_n155_), .c(new_n73_), .d(new_n128_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n80_), .O(new_n157_));
  nand2  g124(.a(x08), .b(x00), .O(new_n158_));
  oai21  g125(.a(new_n152_), .b(new_n53_), .c(new_n158_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n54_), .O(new_n161_));
  ...
  nand4  g131(.a(new_n164_), .b(new_n54_), .c(new_n48_), .d(new_n144_), .O(z5));
  oai21  g132(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n146_), .c(new_n36_), .O(new_n167_));
  oai21  g134(.a(x20), .b(new_n119_), .c(x06), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x11), .c(new_n34_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n84_), .c(new_n148_), .d(new_n34_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n78_), .c(x24), .O(new_n171_));
  oai22  g138(.a(new_n169_), .b(new_n155_), .c(new_n73_), .d(new_n34_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n80_), .O(new_n173_));
  nand2  g140(.a(x03), .b(x00), .O(new_n174_));
  oai21  g141(.a(new_n169_), .b(new_n53_), .c(new_n174_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n54_), .O(new_n177_));
  inv1   g144(.a(new_n177_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n171_), .c(new_n167_), .O(z6));
  nand2  g146(.a(new_n114_), .b(new_n113_), .O(z7));
endmodule
