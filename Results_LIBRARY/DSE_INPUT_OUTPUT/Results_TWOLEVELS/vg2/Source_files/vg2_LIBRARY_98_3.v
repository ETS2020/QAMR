...
module FAU ( 
  ...
  inv1   g108(.a(new_n49_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  inv1   g110(.a(x04), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n144_), .c(new_n75_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n63_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n123_), .O(new_n147_));
  ...
  and2   g120(.a(new_n153_), .b(new_n113_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n112_), .c(new_n111_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(x11), .b(x02), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n156_), .c(new_n148_), .O(z4));
  and2   g125(.a(new_n157_), .b(new_n48_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n46_), .c(new_n43_), .d(new_n141_), .O(z5));
  nand2  g127(.a(x20), .b(new_n73_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n143_), .O(new_n163_));
  aoi21  g130(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n164_));
  aoi21  g131(.a(new_n116_), .b(new_n111_), .c(new_n164_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x02), .c(x11), .O(new_n166_));
  nand2  g133(.a(new_n155_), .b(new_n34_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n166_), .c(new_n163_), .O(z6));
  nand4  g135(.a(new_n157_), .b(new_n154_), .c(new_n112_), .d(new_n111_), .O(z7));
endmodule
