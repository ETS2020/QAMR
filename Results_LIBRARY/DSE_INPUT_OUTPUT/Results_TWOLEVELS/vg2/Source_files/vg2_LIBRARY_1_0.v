...
module FAU ( 
  ...
  nor2   g072(.a(new_n34_), .b(new_n65_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(x11), .c(new_n98_), .O(new_n107_));
  nor2   g074(.a(x24), .b(new_n101_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(x20), .c(x14), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(x06), .O(new_n110_));
  ...
  nand3  g088(.a(new_n106_), .b(new_n98_), .c(x08), .O(new_n122_));
  nor2   g089(.a(new_n37_), .b(new_n36_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n108_), .c(x20), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n122_), .c(x06), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n95_), .O(new_n126_));
  nand2  g093(.a(new_n106_), .b(new_n57_), .O(new_n127_));
  ...
  nor2   g111(.a(x06), .b(x02), .O(new_n145_));
  nor2   g112(.a(x24), .b(x10), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(x06), .c(new_n95_), .d(x00), .O(new_n147_));
  ...
  nor2   g121(.a(new_n117_), .b(new_n114_), .O(new_n155_));
  nand4  g122(.a(new_n108_), .b(new_n98_), .c(x06), .d(new_n95_), .O(new_n156_));
  oai21  g123(.a(new_n145_), .b(new_n155_), .c(new_n156_), .O(z7));
  nand2  g124(.a(z7), .b(new_n154_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n149_), .O(z4));
  nand3  g126(.a(new_n146_), .b(new_n95_), .c(x00), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n47_), .c(new_n44_), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  aoi22  g129(.a(new_n162_), .b(new_n43_), .c(x11), .d(new_n34_), .O(new_n163_));
  nand3  g130(.a(new_n38_), .b(x14), .c(x11), .O(new_n164_));
  nand3  g131(.a(new_n108_), .b(new_n98_), .c(new_n95_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n116_), .c(new_n115_), .O(new_n166_));
  nor2   g133(.a(new_n166_), .b(new_n114_), .O(new_n167_));
  aoi21  g134(.a(new_n164_), .b(x03), .c(new_n167_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n163_), .c(x06), .O(new_n169_));
  nor2   g136(.a(new_n38_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n36_), .c(x03), .O(new_n171_));
  aoi21  g138(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n155_), .c(new_n171_), .d(new_n144_), .O(new_n173_));
