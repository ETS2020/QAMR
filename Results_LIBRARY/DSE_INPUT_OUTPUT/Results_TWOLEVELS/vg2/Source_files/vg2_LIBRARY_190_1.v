...
module FAU ( 
  ...
  or2    g114(.a(new_n115_), .b(new_n111_), .O(new_n148_));
  inv1   g115(.a(x09), .O(new_n149_));
  oai21  g116(.a(new_n80_), .b(x04), .c(x17), .O(new_n150_));
  ...
  nand3  g120(.a(new_n153_), .b(new_n147_), .c(new_n119_), .O(z4));
  nand4  g121(.a(new_n145_), .b(new_n119_), .c(new_n44_), .d(new_n143_), .O(z5));
  nand2  g122(.a(x20), .b(new_n67_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n36_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n146_), .O(new_n158_));
  nand2  g125(.a(new_n38_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n37_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n35_), .c(new_n148_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n119_), .O(z6));
  nand2  g129(.a(new_n113_), .b(new_n112_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n111_), .c(new_n119_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n114_), .O(z7));
endmodule
