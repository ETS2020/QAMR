...
module FAU ( 
  ...
  nand4  g052(.a(new_n85_), .b(new_n82_), .c(new_n60_), .d(new_n58_), .O(new_n86_));
  nor2   g053(.a(x09), .b(x08), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n66_), .c(x07), .d(new_n34_), .O(new_n88_));
  nor2   g055(.a(x12), .b(x11), .O(new_n89_));
  nor2   g056(.a(x16), .b(x14), .O(new_n90_));
  nor2   g057(.a(x20), .b(x17), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n73_), .O(new_n92_));
  oai21  g059(.a(new_n92_), .b(new_n88_), .c(new_n86_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(new_n77_), .c(x24), .O(new_n94_));
  nand3  g061(.a(new_n60_), .b(x21), .c(x20), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n58_), .O(new_n97_));
  ...
  nand4  g068(.a(new_n101_), .b(new_n41_), .c(new_n50_), .d(new_n49_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n94_), .c(new_n80_), .O(z1));
  ...
  nand3  g078(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(x20), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n36_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x11), .c(x06), .d(x03), .O(new_n115_));
  oai21  g082(.a(new_n115_), .b(new_n55_), .c(new_n38_), .O(z2));
  ...
  nor2   g087(.a(new_n120_), .b(new_n64_), .O(new_n121_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n84_), .c(new_n36_), .d(new_n35_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n34_), .c(new_n56_), .d(new_n55_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n84_), .b(new_n36_), .c(new_n35_), .d(new_n64_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n77_), .c(x24), .O(new_n136_));
  nand4  g103(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n137_));
  nand3  g104(.a(new_n98_), .b(new_n64_), .c(new_n34_), .O(new_n138_));
  nand3  g105(.a(new_n72_), .b(new_n36_), .c(new_n35_), .O(new_n139_));
  ...
  inv1   g109(.a(new_n117_), .O(new_n143_));
  aoi21  g110(.a(x21), .b(new_n50_), .c(new_n143_), .O(new_n144_));
  inv1   g111(.a(x22), .O(new_n145_));
  inv1   g112(.a(x17), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n37_), .c(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n145_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n64_), .O(new_n149_));
  inv1   g116(.a(x00), .O(new_n150_));
  oai21  g117(.a(x10), .b(new_n150_), .c(new_n124_), .O(new_n151_));
  aoi21  g118(.a(new_n145_), .b(x17), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n64_), .O(new_n153_));
  nand3  g120(.a(new_n50_), .b(x04), .c(x00), .O(new_n154_));
  inv1   g121(.a(x16), .O(new_n155_));
  nand2  g122(.a(new_n73_), .b(new_n155_), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  aoi21  g124(.a(new_n153_), .b(new_n151_), .c(new_n157_), .O(new_n158_));
  oai21  g125(.a(new_n149_), .b(new_n144_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n41_), .O(new_n160_));
  nand2  g127(.a(new_n153_), .b(x07), .O(new_n161_));
  oai21  g128(.a(new_n149_), .b(new_n83_), .c(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n77_), .c(x24), .O(new_n163_));
  inv1   g130(.a(x15), .O(new_n164_));
  nand2  g131(.a(new_n153_), .b(x19), .O(new_n165_));
  oai21  g132(.a(new_n149_), .b(new_n164_), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n45_), .c(new_n39_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n163_), .c(new_n160_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n49_), .O(new_n169_));
  nor2   g136(.a(new_n47_), .b(new_n43_), .O(new_n170_));
  aoi21  g137(.a(x23), .b(new_n146_), .c(x22), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x09), .c(new_n155_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n64_), .c(new_n170_), .O(new_n173_));
  oai21  g140(.a(new_n145_), .b(x17), .c(x09), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x16), .c(new_n64_), .O(new_n175_));
  nand2  g142(.a(new_n109_), .b(new_n108_), .O(new_n176_));
  nor2   g143(.a(new_n176_), .b(new_n106_), .O(new_n177_));
  nor2   g144(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n173_), .c(x04), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n169_), .O(z4));
  nand2  g147(.a(new_n51_), .b(new_n48_), .O(z5));
  aoi21  g148(.a(x20), .b(new_n36_), .c(x06), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x11), .c(new_n56_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(z5), .O(new_n184_));
  aoi21  g151(.a(new_n84_), .b(x14), .c(new_n34_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n35_), .c(x03), .O(new_n186_));
  inv1   g153(.a(new_n38_), .O(new_n187_));
  oai21  g154(.a(new_n177_), .b(new_n187_), .c(new_n110_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n186_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n184_), .O(z6));
  nand4  g157(.a(new_n111_), .b(new_n108_), .c(new_n107_), .d(new_n38_), .O(z7));
endmodule
