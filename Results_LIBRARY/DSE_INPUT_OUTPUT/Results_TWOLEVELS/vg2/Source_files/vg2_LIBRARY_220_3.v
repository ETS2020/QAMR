...
module FAU ( 
  ...
  oai21  g104(.a(x23), .b(new_n95_), .c(new_n60_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n62_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n127_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  inv1   g108(.a(x16), .O(new_n142_));
  oai21  g109(.a(new_n63_), .b(x04), .c(x17), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x22), .c(new_n66_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n142_), .c(x08), .O(new_n145_));
  nand4  g112(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n146_));
  and2   g113(.a(new_n146_), .b(new_n108_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n107_), .c(new_n106_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n141_), .c(new_n53_), .O(z4));
  nand2  g117(.a(new_n48_), .b(new_n43_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n42_), .c(new_n53_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n46_), .O(z5));
  nand2  g120(.a(x20), .b(new_n118_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n35_), .c(x11), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x03), .c(new_n137_), .O(new_n156_));
  aoi21  g123(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n157_));
  aoi21  g124(.a(new_n111_), .b(new_n106_), .c(new_n157_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(x11), .O(new_n159_));
  nand2  g126(.a(new_n148_), .b(new_n34_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n159_), .c(new_n156_), .O(z6));
  nand4  g128(.a(new_n147_), .b(new_n107_), .c(new_n106_), .d(new_n53_), .O(z7));
endmodule
