// Benchmark "FAU" written by ABC on Wed Aug 19 21:57:48 2020
...
module FAU ( 
  ...
  nand2  g120(.a(new_n152_), .b(new_n49_), .O(new_n154_));
  nand4  g121(.a(new_n143_), .b(new_n54_), .c(x01), .d(x00), .O(new_n155_));
  ...
  aoi21  g126(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n36_), .c(x03), .O(new_n161_));
  nand2  g128(.a(new_n112_), .b(new_n111_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n110_), .c(new_n152_), .O(new_n163_));
  nand4  g130(.a(new_n122_), .b(new_n113_), .c(new_n54_), .d(x01), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(z7));
  nand2  g132(.a(z7), .b(new_n161_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n159_), .O(z6));
endmodule
