...
module FAU ( 
  ...
  nor2   g018(.a(new_n35_), .b(x04), .O(new_n52_));
  ...
  nand4  g066(.a(new_n71_), .b(new_n70_), .c(new_n55_), .d(new_n36_), .O(new_n100_));
  nor2   g067(.a(x23), .b(x22), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n73_), .c(new_n72_), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n99_), .c(new_n98_), .d(new_n96_), .O(new_n104_));
  ...
  nand4  g078(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n55_), .O(new_n112_));
  ...
  nand4  g083(.a(new_n116_), .b(new_n111_), .c(new_n110_), .d(new_n96_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n109_), .c(x13), .O(new_n118_));
  aoi22  g085(.a(new_n118_), .b(new_n37_), .c(new_n105_), .d(x24), .O(new_n119_));
  ...
  nor3   g095(.a(new_n128_), .b(new_n73_), .c(new_n70_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x11), .c(x03), .d(x01), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x04), .c(new_n35_), .O(z2));
  nand4  g098(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n68_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x06), .c(x04), .d(x03), .O(new_n134_));
  nand4  g101(.a(new_n78_), .b(new_n73_), .c(new_n70_), .d(new_n36_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(x08), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n137_));
  oai21  g104(.a(new_n134_), .b(new_n66_), .c(new_n137_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n39_), .O(new_n139_));
  nand4  g106(.a(x06), .b(x04), .c(x03), .d(x01), .O(new_n140_));
  inv1   g107(.a(new_n140_), .O(new_n141_));
  nor2   g108(.a(new_n36_), .b(new_n68_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n93_), .d(x14), .O(new_n143_));
  nor2   g110(.a(x03), .b(x01), .O(new_n144_));
  nor2   g111(.a(x11), .b(x08), .O(new_n145_));
  nor2   g112(.a(x20), .b(x14), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n98_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n143_), .c(new_n88_), .O(new_n148_));
  nand3  g115(.a(x20), .b(x15), .c(x14), .O(new_n149_));
  inv1   g116(.a(new_n149_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n142_), .c(new_n141_), .O(new_n151_));
  nor2   g118(.a(x14), .b(x11), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n144_), .c(new_n114_), .d(new_n110_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n151_), .c(x13), .O(new_n154_));
  aoi22  g121(.a(new_n154_), .b(new_n37_), .c(new_n148_), .d(x24), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n139_), .O(z3));
  aoi21  g123(.a(x22), .b(new_n72_), .c(new_n69_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n71_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n94_), .b(x16), .O(new_n159_));
  nor3   g126(.a(new_n159_), .b(x06), .c(x04), .O(new_n160_));
  aoi21  g127(.a(new_n158_), .b(new_n53_), .c(new_n160_), .O(new_n161_));
  aoi21  g128(.a(new_n74_), .b(x17), .c(x09), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x16), .c(new_n68_), .O(new_n163_));
  nor2   g130(.a(x16), .b(new_n67_), .O(new_n164_));
  aoi22  g131(.a(new_n164_), .b(new_n101_), .c(new_n163_), .d(new_n53_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n49_), .c(new_n161_), .d(new_n128_), .O(z4));
  nor2   g133(.a(new_n52_), .b(new_n49_), .O(z5));
  nand2  g134(.a(x20), .b(new_n70_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n35_), .c(x11), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n170_));
  nand2  g137(.a(new_n73_), .b(x14), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x06), .c(new_n36_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n34_), .c(new_n127_), .d(new_n123_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n170_), .c(new_n53_), .O(z6));
  nor2   g141(.a(new_n128_), .b(new_n52_), .O(z7));
endmodule
