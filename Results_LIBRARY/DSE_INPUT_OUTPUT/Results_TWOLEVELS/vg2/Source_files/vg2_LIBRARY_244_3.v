...
module FAU ( 
  ...
  oai21  g110(.a(x23), .b(new_n96_), .c(new_n59_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n62_), .c(x09), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n116_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(z5), .O(new_n147_));
  nand2  g114(.a(new_n112_), .b(new_n111_), .O(z7));
  ...
  nand2  g120(.a(new_n153_), .b(new_n147_), .O(z4));
  nand2  g121(.a(x20), .b(new_n36_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n34_), .c(x11), .O(new_n156_));
  nand3  g123(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n42_), .c(new_n156_), .d(x03), .O(new_n158_));
  nand2  g125(.a(new_n60_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n35_), .O(new_n160_));
  nand3  g127(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n107_), .c(new_n160_), .d(new_n98_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n158_), .c(new_n37_), .O(z6));
endmodule
