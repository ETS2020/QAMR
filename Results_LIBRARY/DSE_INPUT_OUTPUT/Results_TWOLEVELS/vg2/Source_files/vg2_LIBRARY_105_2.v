...
module FAU ( 
  ...
  nor2   g082(.a(new_n115_), .b(new_n54_), .O(z2));
  ...
  nand4  g089(.a(new_n37_), .b(x19), .c(new_n63_), .d(new_n36_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n120_), .c(new_n89_), .O(new_n125_));
  inv1   g092(.a(new_n118_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n92_), .c(x14), .O(new_n127_));
  nor2   g094(.a(x11), .b(x08), .O(new_n128_));
  nor2   g095(.a(x20), .b(x14), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n121_), .d(new_n97_), .O(new_n130_));
  oai21  g097(.a(new_n127_), .b(new_n117_), .c(new_n130_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n87_), .c(x24), .O(new_n132_));
  nor2   g099(.a(x01), .b(new_n55_), .O(new_n133_));
  ...
  aoi21  g108(.a(new_n141_), .b(new_n80_), .c(x16), .O(new_n142_));
  ...
  nand3  g112(.a(new_n133_), .b(new_n45_), .c(new_n44_), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n143_), .c(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n142_), .b(x08), .c(new_n147_), .O(new_n148_));
  inv1   g115(.a(x23), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n80_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n64_), .c(x08), .O(new_n152_));
  inv1   g119(.a(new_n143_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n112_), .O(new_n154_));
  inv1   g121(.a(x10), .O(new_n155_));
  nor2   g122(.a(x02), .b(x01), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n40_), .c(x21), .d(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(z7));
  nand2  g125(.a(z7), .b(new_n152_), .O(new_n159_));
  ...
  nand2  g129(.a(x20), .b(new_n63_), .O(new_n163_));
  ...
  nand4  g134(.a(new_n40_), .b(x21), .c(new_n155_), .d(new_n44_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n169_));
  oai21  g136(.a(new_n167_), .b(new_n34_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(new_n153_), .O(z6));
endmodule
