...
module FAU ( 
  ...
  nand2  g054(.a(new_n45_), .b(new_n39_), .O(new_n88_));
  nand4  g055(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n89_));
  nor4   g056(.a(new_n89_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n90_));
  ...
  nand3  g083(.a(new_n116_), .b(new_n45_), .c(new_n39_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n104_), .c(new_n38_), .O(new_n118_));
  inv1   g085(.a(new_n118_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n87_), .O(z1));
  nand2  g087(.a(x24), .b(x18), .O(new_n121_));
  nand3  g088(.a(new_n41_), .b(x15), .c(x13), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(new_n121_), .c(new_n39_), .O(new_n123_));
  nand3  g090(.a(x24), .b(x18), .c(x13), .O(new_n124_));
  nand3  g091(.a(x15), .b(new_n45_), .c(new_n39_), .O(new_n125_));
  nand4  g092(.a(new_n41_), .b(x21), .c(new_n50_), .d(new_n49_), .O(new_n126_));
  ...
  oai21  g097(.a(new_n130_), .b(new_n66_), .c(new_n38_), .O(z2));
  nand4  g098(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n69_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nand4  g101(.a(new_n78_), .b(new_n73_), .c(new_n36_), .d(new_n35_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(x08), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n93_), .b(x14), .c(x11), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n142_));
  nand4  g109(.a(new_n73_), .b(new_n36_), .c(new_n35_), .d(new_n69_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n88_), .c(x24), .O(new_n145_));
  nand4  g112(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n146_));
  nand3  g113(.a(new_n109_), .b(new_n67_), .c(new_n66_), .O(new_n147_));
  nand3  g114(.a(new_n114_), .b(new_n36_), .c(new_n35_), .O(new_n148_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n145_), .c(new_n139_), .d(new_n38_), .O(z3));
  nand2  g118(.a(new_n51_), .b(new_n48_), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n153_));
  ...
  oai21  g125(.a(new_n158_), .b(new_n71_), .c(x08), .O(new_n159_));
  nand2  g126(.a(new_n125_), .b(new_n124_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n123_), .c(new_n38_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n126_), .O(z7));
  nand2  g129(.a(z7), .b(new_n159_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n156_), .O(z4));
  inv1   g131(.a(new_n43_), .O(new_n165_));
  and2   g132(.a(new_n51_), .b(new_n44_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n46_), .c(new_n165_), .d(new_n38_), .O(z5));
  aoi21  g134(.a(x20), .b(new_n36_), .c(x06), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x11), .c(new_n67_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n152_), .O(new_n170_));
  aoi21  g137(.a(new_n73_), .b(x14), .c(new_n34_), .O(new_n171_));
