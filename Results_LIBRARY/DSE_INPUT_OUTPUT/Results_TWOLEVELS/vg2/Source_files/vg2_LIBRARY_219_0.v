...
module FAU ( 
  ...
  nand4  g035(.a(new_n68_), .b(new_n67_), .c(new_n56_), .d(new_n35_), .O(new_n69_));
  ...
  oai21  g042(.a(new_n75_), .b(new_n69_), .c(new_n63_), .O(new_n76_));
  ...
  nand3  g050(.a(new_n83_), .b(new_n59_), .c(new_n55_), .O(new_n84_));
  ...
  nor3   g065(.a(new_n98_), .b(new_n56_), .c(new_n35_), .O(new_n99_));
  ...
  aoi21  g083(.a(new_n113_), .b(x05), .c(new_n116_), .O(new_n117_));
  nor3   g084(.a(new_n117_), .b(new_n38_), .c(new_n37_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x11), .c(x06), .d(x03), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n64_), .c(new_n110_), .O(z2));
  nand3  g087(.a(new_n57_), .b(x03), .c(x01), .O(new_n121_));
  nor2   g088(.a(new_n37_), .b(new_n36_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand4  g090(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n64_), .O(new_n124_));
  nand4  g091(.a(new_n73_), .b(new_n37_), .c(new_n36_), .d(new_n56_), .O(new_n125_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n36_), .c(new_n56_), .d(x07), .O(new_n130_));
  ...
  nand2  g099(.a(new_n122_), .b(new_n97_), .O(new_n133_));
  nand2  g100(.a(new_n107_), .b(x20), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n94_), .c(new_n57_), .d(x03), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n132_), .c(new_n127_), .O(z3));
  inv1   g104(.a(x22), .O(new_n138_));
  inv1   g105(.a(x17), .O(new_n139_));
  oai21  g106(.a(x23), .b(new_n65_), .c(new_n139_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n138_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n56_), .O(new_n142_));
  ...
  nand2  g119(.a(new_n113_), .b(x05), .O(new_n153_));
  nand3  g120(.a(new_n107_), .b(new_n97_), .c(new_n105_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n115_), .c(new_n114_), .d(new_n153_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nor2   g123(.a(x02), .b(x01), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n156_), .c(new_n146_), .O(z4));
  nand2  g126(.a(new_n158_), .b(new_n49_), .O(new_n160_));
  nand4  g127(.a(new_n143_), .b(new_n105_), .c(x01), .d(x00), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(z5));
  aoi21  g129(.a(x20), .b(new_n37_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  aoi21  g132(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n36_), .c(x03), .O(new_n167_));
  nand3  g134(.a(new_n107_), .b(new_n94_), .c(new_n97_), .O(new_n168_));
  oai21  g135(.a(new_n157_), .b(new_n117_), .c(new_n168_), .O(z7));
  nand2  g136(.a(z7), .b(new_n167_), .O(new_n170_));
