...
module FAU ( 
  ...
  nor2   g085(.a(new_n118_), .b(new_n90_), .O(z2));
  ...
  nand4  g089(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n90_), .O(new_n123_));
  ...
  nand2  g094(.a(new_n121_), .b(new_n81_), .O(new_n128_));
  ...
  nand4  g099(.a(new_n36_), .b(new_n35_), .c(new_n90_), .d(x00), .O(new_n133_));
  ...
  oai21  g105(.a(x23), .b(new_n91_), .c(new_n69_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n95_), .c(x09), .O(new_n140_));
  ...
  inv1   g112(.a(new_n111_), .O(new_n146_));
  inv1   g113(.a(new_n115_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  inv1   g115(.a(x09), .O(new_n149_));
  oai21  g116(.a(new_n104_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n149_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n68_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  nand2  g120(.a(x02), .b(new_n90_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n153_), .c(new_n145_), .O(z4));
  nand2  g122(.a(new_n48_), .b(new_n44_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n43_), .c(new_n154_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n142_), .O(z5));
  nand2  g125(.a(x20), .b(new_n67_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n36_), .c(x11), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x03), .c(new_n144_), .O(new_n161_));
  nand2  g128(.a(new_n38_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n37_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n35_), .c(new_n148_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n154_), .O(z6));
  and2   g132(.a(new_n154_), .b(new_n112_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n114_), .c(new_n113_), .d(new_n146_), .O(z7));
endmodule
