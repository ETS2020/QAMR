...
module FAU ( 
  ...
  oai21  g084(.a(new_n117_), .b(new_n107_), .c(new_n37_), .O(z2));
  ...
  nand3  g088(.a(new_n101_), .b(new_n68_), .c(new_n34_), .O(new_n122_));
  nand4  g089(.a(new_n61_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n123_));
  ...
  nand4  g094(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n68_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n34_), .b(new_n133_), .c(new_n107_), .d(x00), .O(new_n134_));
  nand2  g101(.a(new_n120_), .b(new_n99_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n119_), .c(new_n134_), .d(new_n128_), .O(new_n136_));
  ...
  oai21  g116(.a(new_n114_), .b(new_n110_), .c(new_n149_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n146_), .c(new_n37_), .O(z4));
  nand4  g118(.a(new_n144_), .b(new_n43_), .c(new_n143_), .d(new_n37_), .O(z5));
  nand2  g119(.a(new_n50_), .b(new_n47_), .O(new_n153_));
  aoi21  g120(.a(x20), .b(new_n36_), .c(x06), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x11), .c(new_n133_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  aoi21  g123(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n35_), .c(x03), .O(new_n158_));
  nand2  g125(.a(new_n112_), .b(new_n111_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n110_), .c(new_n37_), .O(new_n160_));
