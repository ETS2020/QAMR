...
module FAU ( 
  ...
  nand4  g114(.a(new_n147_), .b(new_n106_), .c(x01), .d(x00), .O(new_n148_));
  ...
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n64_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n151_), .c(x08), .O(new_n155_));
  oai21  g122(.a(new_n117_), .b(new_n114_), .c(new_n145_), .O(new_n156_));
  nand3  g123(.a(new_n108_), .b(new_n95_), .c(new_n98_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(z7));
  nand2  g125(.a(z7), .b(new_n155_), .O(new_n159_));
  ...
  nand3  g129(.a(new_n147_), .b(new_n106_), .c(x00), .O(new_n163_));
  ...
  nand3  g134(.a(new_n108_), .b(new_n98_), .c(new_n106_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n116_), .c(new_n115_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n114_), .c(new_n167_), .d(new_n34_), .O(new_n170_));
