...
module FAU ( 
  ...
  nand3  g066(.a(new_n89_), .b(x20), .c(x16), .O(new_n100_));
  ...
  nand4  g102(.a(new_n71_), .b(new_n56_), .c(new_n36_), .d(new_n68_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n103_), .b(new_n34_), .c(new_n66_), .O(new_n140_));
  ...
  oai21  g112(.a(x23), .b(new_n67_), .c(new_n70_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n72_), .c(x09), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n68_), .O(new_n148_));
  ...
  nand3  g122(.a(new_n155_), .b(new_n149_), .c(new_n54_), .O(z4));
  inv1   g123(.a(new_n41_), .O(new_n157_));
  and2   g124(.a(new_n45_), .b(new_n42_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n54_), .c(new_n47_), .d(new_n157_), .O(z5));
  nand2  g126(.a(x20), .b(new_n56_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x03), .c(new_n145_), .O(new_n162_));
  nand2  g129(.a(new_n71_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n34_), .c(new_n150_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n162_), .c(new_n53_), .O(z6));
  inv1   g133(.a(new_n114_), .O(new_n167_));
  and2   g134(.a(new_n116_), .b(new_n115_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n117_), .c(new_n167_), .d(new_n54_), .O(z7));
endmodule
