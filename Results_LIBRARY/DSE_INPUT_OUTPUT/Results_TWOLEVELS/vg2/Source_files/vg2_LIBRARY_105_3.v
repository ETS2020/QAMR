...
module FAU ( 
  ...
  and2   g137(.a(new_n156_), .b(new_n43_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n48_), .c(new_n46_), .d(new_n170_), .O(z5));
  nand2  g139(.a(x20), .b(new_n91_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n35_), .c(x11), .O(new_n174_));
  oai22  g141(.a(new_n174_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n175_));
  inv1   g142(.a(new_n121_), .O(new_n176_));
  nand2  g143(.a(new_n37_), .b(x14), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(x06), .c(new_n36_), .O(new_n178_));
  nand3  g145(.a(new_n166_), .b(new_n123_), .c(new_n122_), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n34_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n175_), .c(new_n156_), .O(z6));
endmodule
