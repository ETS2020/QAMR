...
module FAU ( 
  ...
  nand2  g127(.a(x20), .b(new_n38_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n36_), .c(x11), .O(new_n162_));
  nand3  g129(.a(new_n148_), .b(new_n50_), .c(new_n45_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(x03), .O(new_n164_));
  nand2  g131(.a(new_n39_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n37_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n35_), .c(new_n113_), .d(new_n109_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n117_), .O(z6));
endmodule
