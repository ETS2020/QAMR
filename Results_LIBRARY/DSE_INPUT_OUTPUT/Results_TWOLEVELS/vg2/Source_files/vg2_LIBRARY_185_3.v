...
module FAU ( 
  ...
  nand4  g030(.a(new_n63_), .b(new_n60_), .c(new_n53_), .d(new_n59_), .O(new_n64_));
  nor2   g031(.a(new_n64_), .b(x14), .O(new_n65_));
  nand4  g032(.a(new_n65_), .b(new_n52_), .c(new_n36_), .d(new_n58_), .O(new_n66_));
  nor2   g033(.a(new_n66_), .b(x08), .O(new_n67_));
  nand4  g034(.a(new_n67_), .b(new_n35_), .c(new_n57_), .d(new_n34_), .O(new_n68_));
  oai21  g035(.a(new_n68_), .b(x01), .c(new_n55_), .O(z1));
  ...
  nor4   g046(.a(new_n79_), .b(new_n54_), .c(new_n60_), .d(new_n71_), .O(new_n80_));
  ...
  oai21  g079(.a(x23), .b(new_n57_), .c(new_n53_), .O(new_n113_));
  ...
  nand3  g088(.a(new_n121_), .b(new_n116_), .c(new_n55_), .O(z4));
  inv1   g089(.a(new_n41_), .O(new_n123_));
  and2   g090(.a(new_n45_), .b(new_n42_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n55_), .c(new_n47_), .d(new_n123_), .O(z5));
  ...
  nand2  g095(.a(new_n60_), .b(x14), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(x06), .c(new_n36_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n34_), .c(new_n117_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n128_), .c(new_n54_), .O(z6));
