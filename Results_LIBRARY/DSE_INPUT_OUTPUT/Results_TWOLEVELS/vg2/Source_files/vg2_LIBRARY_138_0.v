...
module FAU ( 
  ...
  nand2  g107(.a(new_n51_), .b(new_n105_), .O(new_n141_));
  oai21  g108(.a(new_n46_), .b(new_n42_), .c(new_n141_), .O(new_n142_));
  nor2   g109(.a(x24), .b(x10), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n51_), .c(x01), .d(x00), .O(new_n144_));
  ...
  nand2  g116(.a(new_n110_), .b(new_n109_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n108_), .c(new_n141_), .O(new_n151_));
  nand4  g118(.a(new_n120_), .b(new_n111_), .c(new_n51_), .d(x01), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n151_), .O(z7));
  nand2  g120(.a(z7), .b(new_n149_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n146_), .O(z4));
  aoi21  g122(.a(x20), .b(new_n97_), .c(x06), .O(new_n156_));
