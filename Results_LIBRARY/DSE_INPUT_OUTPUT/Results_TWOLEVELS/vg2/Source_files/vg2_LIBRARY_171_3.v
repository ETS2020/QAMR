...
module FAU ( 
  ...
  nand4  g061(.a(new_n94_), .b(new_n81_), .c(new_n63_), .d(new_n56_), .O(new_n95_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n85_), .c(new_n35_), .d(new_n96_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n90_), .c(new_n95_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n40_), .c(new_n45_), .O(new_n102_));
  nand2  g069(.a(x11), .b(x02), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n92_), .d(new_n79_), .O(z1));
  ...
  nand3  g086(.a(new_n67_), .b(new_n34_), .c(new_n97_), .O(new_n120_));
  nand3  g087(.a(new_n72_), .b(new_n105_), .c(new_n36_), .O(new_n121_));
  ...
  nand4  g091(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n97_), .O(new_n125_));
  inv1   g092(.a(x08), .O(new_n126_));
  nor2   g093(.a(x20), .b(x14), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n36_), .c(new_n126_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n125_), .c(new_n124_), .d(new_n117_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n76_), .c(x24), .O(new_n130_));
  nand3  g097(.a(new_n127_), .b(new_n67_), .c(new_n36_), .O(new_n131_));
  nand2  g098(.a(new_n118_), .b(new_n94_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n117_), .c(new_n131_), .d(new_n98_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n40_), .c(new_n45_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n130_), .c(new_n123_), .d(new_n103_), .O(z3));
  inv1   g102(.a(new_n42_), .O(new_n136_));
  inv1   g103(.a(new_n49_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  oai21  g105(.a(x23), .b(new_n96_), .c(new_n59_), .O(new_n139_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n108_), .c(new_n146_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n142_), .c(new_n103_), .O(z4));
  and2   g117(.a(new_n103_), .b(new_n48_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n46_), .c(new_n43_), .d(new_n136_), .O(z5));
  oai21  g119(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n138_), .O(new_n154_));
  ...
  oai21  g126(.a(new_n82_), .b(x03), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n76_), .c(x24), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n154_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n36_), .O(new_n163_));
  oai21  g130(.a(x20), .b(new_n105_), .c(x06), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x11), .c(new_n34_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n82_), .c(new_n159_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n76_), .c(x24), .O(new_n167_));
  oai21  g134(.a(new_n165_), .b(new_n155_), .c(new_n156_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n78_), .O(new_n169_));
  nand2  g136(.a(x03), .b(x00), .O(new_n170_));
  oai21  g137(.a(new_n165_), .b(new_n93_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n40_), .c(new_n45_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n167_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n44_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n163_), .O(z6));
  nand2  g142(.a(new_n110_), .b(new_n109_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n108_), .c(new_n103_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n147_), .O(z7));
endmodule
