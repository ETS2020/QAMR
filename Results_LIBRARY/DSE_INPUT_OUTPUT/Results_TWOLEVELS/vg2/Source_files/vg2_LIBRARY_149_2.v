...
module FAU ( 
  ...
  nand4  g091(.a(new_n37_), .b(x19), .c(new_n63_), .d(new_n36_), .O(new_n125_));
  ...
  aoi21  g129(.a(x20), .b(new_n63_), .c(x06), .O(new_n163_));
  ...
  oai21  g136(.a(new_n158_), .b(x01), .c(new_n44_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n113_), .c(new_n108_), .O(z7));
endmodule
