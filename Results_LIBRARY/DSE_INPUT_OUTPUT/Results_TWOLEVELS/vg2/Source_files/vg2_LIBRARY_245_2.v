...
module FAU ( 
  ...
  oai21  g111(.a(new_n110_), .b(new_n107_), .c(new_n136_), .O(new_n145_));
  nor2   g112(.a(x02), .b(x01), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n40_), .c(x21), .d(new_n98_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(z7));
  nand2  g115(.a(z7), .b(new_n144_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n141_), .O(z4));
  nand2  g117(.a(x20), .b(new_n87_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n35_), .c(x11), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n153_));
  nand2  g120(.a(new_n37_), .b(x14), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x06), .c(new_n36_), .O(new_n155_));
  nand4  g122(.a(new_n40_), .b(x21), .c(new_n98_), .d(new_n44_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n109_), .c(new_n108_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n107_), .c(new_n155_), .d(new_n34_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n136_), .O(z6));
endmodule
