...
module FAU ( 
  ...
  nor2   g065(.a(new_n53_), .b(x06), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n70_), .d(new_n69_), .O(new_n100_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n98_), .c(new_n36_), .d(new_n70_), .O(new_n112_));
  ...
  oai21  g099(.a(new_n132_), .b(new_n67_), .c(new_n54_), .O(z2));
  ...
  nand4  g103(.a(new_n78_), .b(new_n37_), .c(new_n71_), .d(new_n36_), .O(new_n137_));
  ...
  nand3  g110(.a(new_n99_), .b(new_n34_), .c(new_n67_), .O(new_n144_));
  ...
  nand3  g113(.a(new_n146_), .b(new_n89_), .c(x24), .O(new_n147_));
  nand4  g114(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n148_));
  nand3  g115(.a(new_n111_), .b(new_n34_), .c(new_n67_), .O(new_n149_));
  nand3  g116(.a(new_n116_), .b(new_n71_), .c(new_n36_), .O(new_n150_));
  ...
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n69_), .O(new_n156_));
  nand3  g123(.a(new_n40_), .b(x13), .c(x05), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n89_), .c(x02), .O(new_n158_));
  nand2  g125(.a(x13), .b(x05), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n89_), .c(new_n53_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n158_), .c(x19), .O(new_n161_));
  nand3  g128(.a(new_n89_), .b(x24), .c(x07), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n161_), .c(new_n46_), .O(z5));
  nand2  g130(.a(z5), .b(new_n156_), .O(new_n164_));
  oai21  g131(.a(new_n75_), .b(x04), .c(x17), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x22), .c(new_n70_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n72_), .c(x08), .O(new_n167_));
  nor3   g134(.a(new_n88_), .b(new_n40_), .c(new_n94_), .O(new_n168_));
  nand2  g135(.a(new_n157_), .b(new_n89_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n54_), .c(x15), .O(new_n170_));
  nand3  g137(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n171_));
  inv1   g138(.a(new_n171_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n168_), .c(new_n44_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  aoi22  g141(.a(new_n174_), .b(new_n167_), .c(new_n168_), .d(x07), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n164_), .O(z4));
  nand2  g143(.a(x20), .b(new_n71_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n35_), .c(x11), .O(new_n178_));
  oai22  g145(.a(new_n178_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n179_));
  nand2  g146(.a(new_n37_), .b(x14), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(x06), .c(new_n36_), .O(new_n181_));
  oai22  g148(.a(new_n181_), .b(new_n34_), .c(new_n129_), .d(new_n125_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n179_), .c(new_n54_), .O(z6));
  nand2  g150(.a(new_n127_), .b(new_n126_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n125_), .c(new_n54_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n128_), .O(z7));
endmodule
