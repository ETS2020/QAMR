...
module FAU ( 
  ...
  nand2  g105(.a(x02), .b(new_n70_), .O(new_n139_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n109_), .c(new_n139_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n112_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n144_), .O(z4));
  and2   g121(.a(new_n139_), .b(new_n45_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n142_), .c(new_n50_), .d(new_n44_), .O(z5));
  ...
  aoi21  g126(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n160_));
  ...
  and2   g131(.a(new_n112_), .b(new_n111_), .O(new_n165_));
  nand4  g132(.a(new_n139_), .b(new_n165_), .c(new_n110_), .d(new_n164_), .O(z7));
endmodule
