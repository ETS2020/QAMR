...
module FAU ( 
  ...
  aoi21  g082(.a(new_n115_), .b(new_n38_), .c(new_n113_), .O(new_n116_));
  ...
  nor2   g087(.a(new_n120_), .b(new_n107_), .O(z2));
  ...
  nand3  g094(.a(new_n72_), .b(new_n89_), .c(new_n36_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n125_), .c(new_n78_), .O(new_n130_));
  inv1   g097(.a(new_n123_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n82_), .c(x14), .O(new_n132_));
  nor2   g099(.a(x11), .b(x08), .O(new_n133_));
  nor2   g100(.a(x20), .b(x14), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n133_), .c(new_n126_), .d(new_n86_), .O(new_n135_));
  ...
  nand4  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n97_), .O(new_n141_));
  ...
  nor2   g113(.a(x02), .b(new_n107_), .O(new_n147_));
  nand2  g114(.a(new_n48_), .b(new_n43_), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n42_), .O(new_n149_));
  nand3  g116(.a(new_n97_), .b(new_n45_), .c(new_n44_), .O(new_n150_));
  oai21  g117(.a(new_n149_), .b(new_n147_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  oai21  g119(.a(new_n62_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n65_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n90_), .c(x08), .O(new_n155_));
  oai21  g122(.a(x02), .b(new_n107_), .c(new_n117_), .O(new_n156_));
  nor2   g123(.a(x02), .b(x01), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n40_), .c(x21), .d(new_n100_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n156_), .O(z7));
  nand2  g126(.a(z7), .b(new_n155_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n152_), .O(z4));
  aoi21  g128(.a(new_n45_), .b(x00), .c(x01), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x02), .c(new_n149_), .O(z5));
  aoi21  g130(.a(x20), .b(new_n89_), .c(x06), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x11), .c(new_n34_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n151_), .O(new_n166_));
