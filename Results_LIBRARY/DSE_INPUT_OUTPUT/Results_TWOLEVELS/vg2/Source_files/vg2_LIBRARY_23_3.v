...
module FAU ( 
  ...
  nand3  g132(.a(new_n165_), .b(new_n158_), .c(new_n53_), .O(z4));
  nand2  g133(.a(new_n48_), .b(new_n43_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n42_), .c(new_n53_), .O(new_n168_));
  ...
  oai21  g138(.a(new_n171_), .b(x03), .c(new_n154_), .O(new_n172_));
  nand2  g139(.a(new_n37_), .b(x14), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x06), .c(new_n36_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n34_), .c(new_n164_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n53_), .O(z6));
  nand4  g143(.a(new_n163_), .b(new_n123_), .c(new_n122_), .d(new_n53_), .O(z7));
endmodule
