...
module FAU ( 
  ...
  or2    g110(.a(new_n143_), .b(new_n42_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  or2    g112(.a(new_n113_), .b(new_n108_), .O(new_n146_));
  oai21  g113(.a(new_n63_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n56_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n98_), .c(x08), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nor2   g117(.a(x02), .b(x01), .O(new_n151_));
  inv1   g118(.a(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n150_), .c(new_n145_), .O(z4));
  oai21  g120(.a(new_n46_), .b(new_n42_), .c(new_n152_), .O(new_n154_));
  nand4  g121(.a(new_n141_), .b(new_n51_), .c(x01), .d(x00), .O(new_n155_));
  ...
  oai21  g128(.a(new_n161_), .b(new_n34_), .c(new_n146_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n152_), .O(z6));
  nand2  g130(.a(new_n110_), .b(new_n109_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n108_), .c(new_n152_), .O(new_n165_));
  nand4  g132(.a(new_n120_), .b(new_n111_), .c(new_n51_), .d(x01), .O(new_n166_));
