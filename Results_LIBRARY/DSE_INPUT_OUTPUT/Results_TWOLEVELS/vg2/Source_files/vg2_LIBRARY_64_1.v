...
module FAU ( 
  ...
  nor2   g090(.a(new_n35_), .b(new_n42_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n62_), .b(new_n36_), .c(new_n107_), .O(new_n126_));
  nand3  g093(.a(new_n85_), .b(new_n35_), .c(new_n42_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n123_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n91_), .O(new_n129_));
  nand3  g096(.a(new_n124_), .b(x20), .c(x18), .O(new_n130_));
  nand3  g097(.a(new_n99_), .b(new_n36_), .c(new_n107_), .O(new_n131_));
  nand4  g098(.a(new_n47_), .b(new_n35_), .c(new_n42_), .d(new_n97_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n123_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n89_), .c(x24), .O(new_n134_));
  ...
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n97_), .O(new_n141_));
  nor2   g108(.a(new_n56_), .b(new_n52_), .O(new_n142_));
  ...
  inv1   g119(.a(new_n115_), .O(new_n153_));
  inv1   g120(.a(x21), .O(new_n154_));
  nor2   g121(.a(x24), .b(new_n154_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n35_), .c(new_n41_), .d(new_n34_), .O(new_n156_));
  ...
  nand3  g126(.a(new_n50_), .b(new_n41_), .c(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n35_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n34_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n142_), .O(z5));
  oai21  g130(.a(new_n42_), .b(x06), .c(x03), .O(new_n164_));
  nand3  g131(.a(new_n155_), .b(new_n41_), .c(new_n34_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  oai21  g134(.a(new_n47_), .b(x14), .c(new_n37_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n42_), .c(x03), .O(new_n169_));
  nand3  g136(.a(new_n124_), .b(new_n47_), .c(x15), .O(new_n170_));
  oai21  g137(.a(new_n169_), .b(new_n84_), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n91_), .O(new_n172_));
  nand3  g139(.a(new_n124_), .b(new_n47_), .c(x18), .O(new_n173_));
  oai21  g140(.a(new_n169_), .b(new_n98_), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n89_), .c(x24), .O(new_n175_));
  nor2   g142(.a(x20), .b(x06), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(x11), .c(new_n36_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n50_), .c(new_n41_), .d(x00), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n35_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n34_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n175_), .c(new_n172_), .d(new_n167_), .O(z6));
  aoi21  g148(.a(new_n155_), .b(new_n41_), .c(x14), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x02), .c(new_n153_), .O(z7));
endmodule
