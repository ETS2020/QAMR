...
module FAU ( 
  ...
  nand2  g114(.a(new_n147_), .b(new_n146_), .O(z7));
  ...
  oai21  g126(.a(new_n110_), .b(new_n106_), .c(new_n37_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n36_), .c(new_n44_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x14), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n156_), .O(z6));
endmodule
