...
module FAU ( 
  ...
  nand4  g110(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n144_));
  ...
  nand3  g115(.a(new_n110_), .b(new_n34_), .c(new_n67_), .O(new_n149_));
  nand3  g116(.a(new_n115_), .b(new_n71_), .c(new_n36_), .O(new_n150_));
  ...
  oai21  g124(.a(new_n157_), .b(new_n42_), .c(new_n54_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n46_), .O(z5));
  nand2  g126(.a(z5), .b(new_n156_), .O(new_n160_));
  oai21  g127(.a(new_n75_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n70_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n72_), .c(x08), .O(new_n163_));
  nand2  g130(.a(new_n127_), .b(new_n126_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n125_), .c(new_n54_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n128_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n160_), .O(z4));
  nand2  g135(.a(x20), .b(new_n71_), .O(new_n169_));
  ...
  oai22  g140(.a(new_n173_), .b(new_n34_), .c(new_n129_), .d(new_n125_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n54_), .O(z6));
  inv1   g142(.a(new_n125_), .O(new_n176_));
  inv1   g143(.a(new_n164_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n128_), .c(new_n176_), .d(new_n54_), .O(z7));
endmodule
