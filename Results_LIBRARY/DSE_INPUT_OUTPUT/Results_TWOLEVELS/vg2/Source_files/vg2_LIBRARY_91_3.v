...
module FAU ( 
  ...
  nand3  g053(.a(new_n86_), .b(new_n85_), .c(new_n66_), .O(new_n87_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n81_), .c(new_n63_), .d(new_n56_), .O(new_n96_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n86_), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n91_), .c(new_n96_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n40_), .c(new_n45_), .O(new_n103_));
  nor2   g070(.a(new_n37_), .b(new_n44_), .O(new_n104_));
  inv1   g071(.a(new_n104_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n103_), .c(new_n93_), .d(new_n79_), .O(z1));
  ...
  oai21  g080(.a(new_n113_), .b(new_n109_), .c(x14), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n36_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x06), .c(x03), .d(x01), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n44_), .c(new_n37_), .O(z2));
  nand4  g084(.a(x06), .b(x03), .c(new_n44_), .d(x01), .O(new_n118_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n124_), .c(new_n72_), .d(new_n67_), .O(new_n126_));
  oai21  g093(.a(new_n123_), .b(new_n118_), .c(new_n126_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n78_), .O(new_n128_));
  nand3  g095(.a(new_n120_), .b(new_n82_), .c(x14), .O(new_n129_));
  nand2  g096(.a(new_n124_), .b(new_n85_), .O(new_n130_));
  inv1   g097(.a(x14), .O(new_n131_));
  nand4  g098(.a(new_n37_), .b(new_n131_), .c(new_n36_), .d(new_n119_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n130_), .c(new_n129_), .d(new_n118_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n76_), .c(x24), .O(new_n134_));
  nand3  g101(.a(new_n98_), .b(new_n35_), .c(new_n34_), .O(new_n135_));
  nand4  g102(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nor2   g103(.a(new_n131_), .b(new_n36_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n95_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n136_), .c(new_n135_), .d(new_n132_), .O(new_n139_));
  ...
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n119_), .O(new_n145_));
  ...
  nor2   g117(.a(x24), .b(new_n94_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n45_), .c(new_n44_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n111_), .c(new_n110_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n109_), .c(new_n150_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n146_), .c(new_n105_), .O(z4));
  nand2  g122(.a(new_n48_), .b(new_n43_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n42_), .c(new_n105_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n46_), .O(z5));
  nand2  g125(.a(x20), .b(new_n131_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x11), .O(new_n160_));
  nand3  g127(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n48_), .c(new_n43_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n42_), .c(new_n160_), .d(x03), .O(new_n163_));
  oai21  g130(.a(new_n36_), .b(x06), .c(x03), .O(new_n164_));
  oai21  g131(.a(new_n113_), .b(new_n109_), .c(new_n164_), .O(new_n165_));
  nand4  g132(.a(new_n137_), .b(new_n151_), .c(new_n37_), .d(new_n45_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n44_), .O(new_n168_));
  oai21  g135(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n169_));
  oai21  g136(.a(new_n156_), .b(new_n42_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n131_), .b(x06), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x11), .c(new_n34_), .O(new_n172_));
  nand2  g139(.a(new_n111_), .b(new_n110_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n109_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n172_), .c(new_n170_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n37_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n168_), .O(z6));
  oai21  g144(.a(new_n174_), .b(new_n104_), .c(new_n152_), .O(z7));
endmodule
