...
module FAU ( 
  ...
  nand2  g074(.a(x12), .b(new_n34_), .O(new_n108_));
  nand2  g075(.a(x24), .b(x18), .O(new_n109_));
  nand3  g076(.a(new_n42_), .b(x15), .c(x13), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n109_), .c(new_n52_), .O(new_n111_));
  nand3  g078(.a(x24), .b(x18), .c(x13), .O(new_n112_));
  nand3  g079(.a(x15), .b(new_n53_), .c(new_n52_), .O(new_n113_));
  ...
  nand4  g084(.a(new_n117_), .b(new_n35_), .c(new_n101_), .d(new_n34_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n115_), .c(new_n41_), .O(new_n119_));
  ...
  nand3  g091(.a(new_n73_), .b(new_n37_), .c(new_n36_), .O(new_n125_));
  nand3  g092(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n122_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  nand2  g095(.a(new_n123_), .b(new_n88_), .O(new_n129_));
  nand4  g096(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n130_));
  nand4  g097(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n100_), .O(new_n131_));
  ...
  nand3  g102(.a(new_n135_), .b(new_n42_), .c(new_n101_), .O(new_n136_));
  ...
  nand2  g110(.a(new_n50_), .b(x05), .O(new_n144_));
  inv1   g111(.a(x00), .O(new_n145_));
  nor2   g112(.a(x02), .b(new_n145_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n42_), .c(new_n101_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n54_), .c(new_n51_), .d(new_n144_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n68_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n71_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n92_), .c(x08), .O(new_n152_));
  nand3  g119(.a(new_n117_), .b(new_n101_), .c(new_n34_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n113_), .c(new_n112_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n111_), .c(new_n152_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n149_), .c(new_n108_), .O(z4));
  inv1   g123(.a(new_n108_), .O(new_n157_));
  nand4  g124(.a(new_n146_), .b(new_n42_), .c(new_n35_), .d(new_n101_), .O(new_n158_));
  oai21  g125(.a(new_n157_), .b(new_n56_), .c(new_n158_), .O(z5));
  aoi21  g126(.a(x20), .b(new_n40_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n37_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(z5), .O(new_n162_));
  nand2  g129(.a(new_n118_), .b(new_n115_), .O(new_n163_));
  aoi21  g130(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n47_), .c(x03), .O(new_n165_));
  ...
  aoi21  g135(.a(new_n117_), .b(new_n101_), .c(x12), .O(new_n169_));
