...
module FAU ( 
  ...
  aoi21  g080(.a(new_n113_), .b(new_n49_), .c(new_n111_), .O(new_n114_));
  ...
  nand2  g086(.a(new_n86_), .b(new_n39_), .O(new_n120_));
  nand3  g087(.a(new_n64_), .b(new_n43_), .c(new_n42_), .O(new_n121_));
  ...
  nand3  g092(.a(new_n86_), .b(new_n47_), .c(new_n35_), .O(new_n126_));
  nand4  g093(.a(new_n48_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n93_), .O(new_n129_));
  nand4  g096(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n36_), .c(new_n47_), .d(new_n35_), .O(new_n131_));
  inv1   g098(.a(x08), .O(new_n132_));
  nand4  g099(.a(new_n48_), .b(new_n42_), .c(new_n41_), .d(new_n132_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n131_), .c(new_n130_), .d(new_n124_), .O(new_n134_));
  ...
  oai21  g104(.a(x23), .b(new_n137_), .c(new_n69_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n66_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n132_), .O(new_n140_));
  nor2   g107(.a(new_n57_), .b(new_n53_), .O(new_n141_));
  nor2   g108(.a(x02), .b(new_n35_), .O(new_n142_));
  nor2   g109(.a(x24), .b(x10), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n144_));
  oai21  g111(.a(new_n142_), .b(new_n141_), .c(new_n144_), .O(z5));
  nand2  g112(.a(z5), .b(new_n140_), .O(new_n146_));
  inv1   g113(.a(x23), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n84_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n68_), .c(x08), .O(new_n150_));
  oai21  g117(.a(x02), .b(new_n35_), .c(new_n115_), .O(new_n151_));
  nor2   g118(.a(x02), .b(x01), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n51_), .c(x21), .d(new_n37_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(z7));
  nand2  g121(.a(z7), .b(new_n150_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n146_), .O(z4));
  aoi21  g123(.a(x20), .b(new_n42_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n47_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(z5), .O(new_n159_));
  aoi21  g126(.a(new_n48_), .b(x14), .c(new_n36_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n41_), .c(x03), .O(new_n161_));
