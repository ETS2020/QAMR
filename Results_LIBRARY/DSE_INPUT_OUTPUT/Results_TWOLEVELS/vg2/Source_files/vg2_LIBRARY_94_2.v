...
module FAU ( 
  ...
  nand4  g066(.a(new_n75_), .b(new_n74_), .c(new_n37_), .d(new_n73_), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n98_), .c(new_n96_), .O(new_n102_));
  aoi22  g069(.a(new_n102_), .b(new_n95_), .c(new_n48_), .d(new_n38_), .O(new_n103_));
  ...
  nand4  g076(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n56_), .O(new_n110_));
  nand4  g077(.a(new_n75_), .b(new_n74_), .c(new_n37_), .d(x19), .O(new_n111_));
  ...
  nor2   g083(.a(new_n40_), .b(new_n92_), .O(new_n117_));
  ...
  nand4  g089(.a(new_n40_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n123_));
  ...
  nor3   g093(.a(new_n126_), .b(new_n37_), .c(new_n71_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x11), .c(x06), .d(x03), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x08), .c(new_n67_), .O(z2));
  nand4  g096(.a(new_n59_), .b(x20), .c(x14), .d(x11), .O(new_n130_));
  nor4   g097(.a(new_n130_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n131_));
  nand4  g098(.a(new_n78_), .b(new_n37_), .c(new_n71_), .d(new_n36_), .O(new_n132_));
  nor4   g099(.a(new_n132_), .b(x08), .c(x06), .d(x03), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n131_), .c(new_n40_), .O(new_n134_));
  nand2  g101(.a(new_n48_), .b(new_n38_), .O(new_n135_));
  nand3  g102(.a(x06), .b(x03), .c(x01), .O(new_n136_));
  nand3  g103(.a(new_n93_), .b(x14), .c(x11), .O(new_n137_));
  nand3  g104(.a(x07), .b(new_n35_), .c(new_n34_), .O(new_n138_));
  nand4  g105(.a(new_n37_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n139_));
  ...
  nand4  g108(.a(x11), .b(x06), .c(new_n38_), .d(x03), .O(new_n142_));
  nand4  g109(.a(x20), .b(x15), .c(x14), .d(new_n48_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n142_), .c(x08), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x01), .O(new_n145_));
  nor2   g112(.a(x05), .b(x03), .O(new_n146_));
  nand3  g113(.a(new_n37_), .b(x19), .c(new_n71_), .O(new_n147_));
  nor3   g114(.a(new_n147_), .b(x13), .c(x11), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n146_), .c(new_n69_), .d(new_n35_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n145_), .c(new_n141_), .d(new_n134_), .O(z3));
  aoi21  g117(.a(new_n75_), .b(x04), .c(x17), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x22), .c(new_n70_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n72_), .c(new_n67_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n69_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n51_), .O(new_n155_));
  aoi21  g122(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n74_), .c(x09), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(x16), .c(x08), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n69_), .b(new_n67_), .c(new_n159_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n126_), .c(new_n155_), .O(z4));
  nor2   g128(.a(x08), .b(new_n67_), .O(new_n162_));
  inv1   g129(.a(new_n162_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(z5));
  nand2  g131(.a(x20), .b(new_n71_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x03), .c(new_n51_), .O(new_n167_));
  nand2  g134(.a(new_n37_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n36_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n34_), .c(new_n125_), .d(new_n120_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n167_), .c(new_n162_), .O(z6));
  inv1   g138(.a(new_n120_), .O(new_n172_));
  nand4  g139(.a(new_n163_), .b(new_n124_), .c(new_n121_), .d(new_n172_), .O(z7));
endmodule
