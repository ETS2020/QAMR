...
module FAU ( 
  ...
  nor2   g18(.a(x16), .b(x04), .O(new_n52_));
  ...
  oai21  g78(.a(new_n111_), .b(x17), .c(new_n58_), .O(new_n112_));
  aoi21  g79(.a(new_n112_), .b(new_n110_), .c(x16), .O(new_n113_));
  oai21  g80(.a(new_n113_), .b(x08), .c(new_n109_), .O(new_n114_));
  inv1   g81(.a(new_n74_), .O(new_n115_));
  inv1   g82(.a(x16), .O(new_n116_));
  inv1   g83(.a(x17), .O(new_n117_));
  nand2  g84(.a(x22), .b(new_n117_), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(x09), .c(new_n116_), .O(new_n119_));
  nand2  g86(.a(x23), .b(x22), .O(new_n120_));
  oai21  g87(.a(new_n120_), .b(x04), .c(x08), .O(new_n121_));
  oai21  g88(.a(new_n121_), .b(new_n119_), .c(new_n115_), .O(new_n122_));
  nand3  g89(.a(new_n122_), .b(new_n114_), .c(new_n53_), .O(z4));
  inv1   g90(.a(new_n41_), .O(new_n124_));
  and2   g91(.a(new_n45_), .b(new_n42_), .O(new_n125_));
  nand4  g92(.a(new_n125_), .b(new_n53_), .c(new_n47_), .d(new_n124_), .O(z5));
  nand2  g93(.a(x20), .b(new_n57_), .O(new_n127_));
  aoi21  g94(.a(new_n127_), .b(new_n35_), .c(x11), .O(new_n128_));
  oai21  g95(.a(new_n128_), .b(x03), .c(new_n109_), .O(new_n129_));
  nand2  g96(.a(new_n86_), .b(x14), .O(new_n130_));
  aoi21  g97(.a(new_n130_), .b(x06), .c(new_n36_), .O(new_n131_));
  oai21  g98(.a(new_n131_), .b(new_n34_), .c(new_n115_), .O(new_n132_));
  nand3  g99(.a(new_n132_), .b(new_n129_), .c(new_n53_), .O(z6));
endmodule
