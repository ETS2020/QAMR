...
module FAU ( 
  ...
  nand4  g058(.a(new_n91_), .b(new_n71_), .c(x07), .d(new_n38_), .O(new_n92_));
  ...
  nand3  g086(.a(x15), .b(new_n53_), .c(new_n48_), .O(new_n120_));
  oai21  g087(.a(new_n117_), .b(new_n53_), .c(new_n120_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n119_), .c(x20), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n40_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x11), .c(x06), .d(x03), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n36_), .c(new_n116_), .O(z2));
  inv1   g092(.a(x08), .O(new_n126_));
  nand3  g093(.a(x15), .b(x13), .c(x05), .O(new_n127_));
  nand3  g094(.a(x21), .b(new_n99_), .c(new_n34_), .O(new_n128_));
  ...
  nand3  g099(.a(new_n99_), .b(new_n34_), .c(x00), .O(new_n133_));
  ...
  nand3  g107(.a(new_n112_), .b(x20), .c(x15), .O(new_n141_));
  nand2  g108(.a(new_n103_), .b(new_n72_), .O(new_n142_));
  nand3  g109(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n53_), .c(new_n48_), .O(new_n145_));
  oai21  g112(.a(x13), .b(x05), .c(x24), .O(new_n146_));
  nor2   g113(.a(new_n146_), .b(new_n41_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(x18), .c(x14), .d(x11), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n126_), .O(new_n149_));
  ...
  nand2  g119(.a(new_n144_), .b(new_n85_), .O(new_n153_));
  nand2  g120(.a(new_n112_), .b(new_n89_), .O(new_n154_));
  nand3  g121(.a(new_n103_), .b(x07), .c(new_n38_), .O(new_n155_));
  nand4  g122(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n126_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n140_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n83_), .c(x24), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x02), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n152_), .O(z3));
  inv1   g128(.a(x04), .O(new_n162_));
  oai21  g129(.a(x23), .b(new_n162_), .c(new_n65_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n67_), .c(x09), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x16), .c(new_n126_), .O(new_n165_));
  aoi22  g132(.a(new_n84_), .b(new_n83_), .c(x07), .d(new_n34_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x19), .O(new_n167_));
  nand4  g134(.a(new_n83_), .b(x24), .c(x07), .d(x02), .O(new_n168_));
  nor2   g135(.a(x24), .b(x10), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n168_), .c(new_n167_), .O(z5));
  nand2  g138(.a(z5), .b(new_n165_), .O(new_n172_));
  aoi21  g139(.a(x23), .b(new_n162_), .c(new_n65_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n67_), .c(x09), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x16), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x08), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n35_), .O(new_n177_));
  nand2  g144(.a(x07), .b(x02), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n83_), .c(x24), .d(x18), .O(new_n180_));
  nand2  g147(.a(new_n166_), .b(x15), .O(new_n181_));
  nand4  g148(.a(new_n113_), .b(new_n99_), .c(new_n35_), .d(new_n34_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n176_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n180_), .c(new_n172_), .O(z4));
  ...
  oai21  g155(.a(x20), .b(new_n40_), .c(x06), .O(new_n189_));
  aoi21  g156(.a(new_n189_), .b(x11), .c(new_n37_), .O(new_n190_));
  oai21  g157(.a(new_n190_), .b(x07), .c(new_n178_), .O(new_n191_));
  nand4  g158(.a(new_n191_), .b(new_n83_), .c(x24), .d(x18), .O(new_n192_));
  inv1   g159(.a(new_n190_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n183_), .O(new_n194_));
  nand3  g161(.a(new_n194_), .b(new_n192_), .c(new_n188_), .O(z6));
  nand2  g162(.a(x07), .b(new_n34_), .O(new_n196_));
  nand4  g163(.a(new_n196_), .b(new_n83_), .c(x24), .d(x18), .O(new_n197_));
  nand3  g164(.a(new_n197_), .b(new_n182_), .c(new_n181_), .O(z7));
endmodule
