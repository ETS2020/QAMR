...
module FAU ( 
  ...
  oai21  g117(.a(x23), .b(new_n68_), .c(new_n74_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n75_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n69_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n52_), .O(new_n154_));
  inv1   g121(.a(new_n126_), .O(new_n155_));
  oai21  g122(.a(new_n76_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n70_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n73_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nor2   g126(.a(new_n34_), .b(x14), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n159_), .c(new_n154_), .O(z4));
  nor2   g129(.a(new_n160_), .b(new_n53_), .O(z5));
  ...
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n71_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n36_), .c(new_n155_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n161_), .O(z6));
  nor2   g136(.a(new_n160_), .b(new_n126_), .O(z7));
endmodule
