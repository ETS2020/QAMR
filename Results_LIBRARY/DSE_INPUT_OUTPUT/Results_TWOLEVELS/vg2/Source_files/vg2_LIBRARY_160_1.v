...
module FAU ( 
  ...
  nand4  g080(.a(new_n113_), .b(new_n41_), .c(x21), .d(new_n88_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n112_), .c(new_n61_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n96_), .c(new_n95_), .O(z2));
  nand3  g084(.a(x15), .b(x13), .c(x05), .O(new_n118_));
  nand3  g085(.a(x21), .b(new_n49_), .c(new_n37_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x20), .c(x14), .d(x11), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n99_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x06), .c(x03), .d(x01), .O(new_n123_));
  nand3  g090(.a(new_n49_), .b(new_n37_), .c(x00), .O(new_n124_));
  nand3  g091(.a(x19), .b(x13), .c(x05), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n61_), .c(new_n36_), .d(new_n35_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(new_n129_));
  ...
  nand4  g099(.a(x07), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(new_n133_));
  nand4  g100(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n99_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n69_), .b(new_n96_), .c(new_n95_), .O(new_n138_));
  nand3  g105(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n139_));
  ...
  oai21  g109(.a(new_n142_), .b(new_n130_), .c(new_n88_), .O(new_n143_));
  nand2  g110(.a(new_n140_), .b(new_n80_), .O(new_n144_));
  ...
  oai21  g115(.a(x23), .b(new_n148_), .c(new_n60_), .O(new_n149_));
  ...
  nand4  g119(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n46_), .c(new_n44_), .d(new_n152_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  oai21  g122(.a(new_n64_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n67_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n89_), .c(x08), .O(new_n158_));
  inv1   g125(.a(new_n108_), .O(new_n159_));
  nand3  g126(.a(new_n113_), .b(new_n41_), .c(x21), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n110_), .c(new_n109_), .d(new_n159_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n155_), .c(new_n38_), .O(z4));
  nand2  g130(.a(new_n51_), .b(new_n48_), .O(z5));
  nand2  g131(.a(x20), .b(new_n36_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n34_), .c(x11), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x03), .c(new_n154_), .O(new_n167_));
  nand2  g134(.a(new_n61_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n35_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n96_), .c(new_n161_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n38_), .O(z6));
