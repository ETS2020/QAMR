...
module FAU ( 
  ...
  nand4  g062(.a(new_n36_), .b(new_n70_), .c(new_n69_), .d(x07), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g064(.a(new_n72_), .b(new_n52_), .c(new_n71_), .d(new_n56_), .O(new_n98_));
  inv1   g065(.a(x17), .O(new_n99_));
  nand4  g066(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n99_), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n97_), .O(new_n102_));
  aoi21  g069(.a(new_n102_), .b(new_n94_), .c(new_n88_), .O(new_n103_));
  ...
  nand4  g074(.a(new_n56_), .b(new_n36_), .c(new_n70_), .d(new_n69_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(new_n95_), .O(new_n109_));
  nand4  g076(.a(new_n99_), .b(new_n72_), .c(new_n52_), .d(new_n71_), .O(new_n110_));
  ...
  aoi22  g081(.a(new_n114_), .b(new_n45_), .c(new_n103_), .d(x24), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n87_), .O(z1));
  inv1   g083(.a(x18), .O(new_n117_));
  nor2   g084(.a(new_n38_), .b(new_n117_), .O(new_n118_));
  ...
  nand4  g090(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(x20), .O(new_n126_));
  ...
  nand4  g096(.a(new_n78_), .b(new_n73_), .c(new_n71_), .d(new_n36_), .O(new_n130_));
  ...
  nor3   g100(.a(new_n133_), .b(x02), .c(new_n67_), .O(new_n134_));
  nand3  g101(.a(x21), .b(x20), .c(x14), .O(new_n135_));
  nor3   g102(.a(new_n135_), .b(new_n36_), .c(x10), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n132_), .c(x24), .O(new_n138_));
  inv1   g105(.a(new_n88_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(x24), .c(x07), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n47_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n73_), .c(new_n71_), .d(new_n36_), .O(new_n142_));
  inv1   g109(.a(new_n142_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n69_), .c(new_n35_), .d(new_n34_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(x01), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n138_), .c(new_n54_), .O(new_n146_));
  inv1   g113(.a(new_n118_), .O(new_n147_));
  nand4  g114(.a(new_n38_), .b(x15), .c(x13), .d(x12), .O(new_n148_));
  oai21  g115(.a(new_n147_), .b(x15), .c(new_n148_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x05), .O(new_n150_));
  nand2  g117(.a(new_n147_), .b(new_n139_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(x15), .c(x12), .O(new_n152_));
  nand3  g119(.a(new_n118_), .b(new_n52_), .c(x13), .O(new_n153_));
  ...
  nand2  g124(.a(new_n157_), .b(new_n146_), .O(z3));
  oai21  g125(.a(x23), .b(new_n68_), .c(new_n99_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n74_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n70_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n72_), .c(x08), .O(new_n162_));
  ...
  aoi21  g132(.a(new_n165_), .b(new_n125_), .c(new_n53_), .O(new_n166_));
  oai21  g133(.a(new_n162_), .b(new_n49_), .c(new_n166_), .O(z4));
  and2   g134(.a(new_n140_), .b(new_n44_), .O(new_n168_));
  nand2  g135(.a(x15), .b(new_n56_), .O(new_n169_));
  nand3  g136(.a(new_n38_), .b(x13), .c(x05), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n139_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n169_), .c(x19), .O(new_n172_));
  oai21  g139(.a(new_n168_), .b(new_n53_), .c(new_n172_), .O(z5));
  ...
  nand4  g148(.a(new_n181_), .b(new_n38_), .c(new_n43_), .d(new_n42_), .O(new_n182_));
  oai21  g149(.a(new_n168_), .b(new_n34_), .c(new_n182_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n54_), .O(new_n184_));
  nor2   g151(.a(x19), .b(new_n34_), .O(new_n185_));
  oai21  g152(.a(new_n178_), .b(new_n36_), .c(new_n185_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(x15), .c(x12), .O(new_n187_));
  inv1   g154(.a(new_n176_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n34_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(x19), .c(new_n52_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n187_), .O(new_n191_));
  nand2  g158(.a(new_n191_), .b(new_n171_), .O(new_n192_));
  nand2  g159(.a(new_n176_), .b(x07), .O(new_n193_));
  oai21  g160(.a(new_n180_), .b(new_n117_), .c(new_n193_), .O(new_n194_));
  nand3  g161(.a(new_n194_), .b(new_n139_), .c(new_n52_), .O(new_n195_));
  aoi21  g162(.a(new_n193_), .b(new_n117_), .c(x03), .O(new_n196_));
  nand3  g163(.a(new_n179_), .b(x18), .c(x11), .O(new_n197_));
  inv1   g164(.a(new_n197_), .O(new_n198_));
  oai21  g165(.a(new_n198_), .b(new_n196_), .c(x15), .O(new_n199_));
  oai21  g166(.a(new_n199_), .b(new_n56_), .c(new_n195_), .O(new_n200_));
  nand2  g167(.a(new_n200_), .b(x24), .O(new_n201_));
  nand3  g168(.a(new_n201_), .b(new_n192_), .c(new_n184_), .O(z6));
  oai21  g169(.a(new_n88_), .b(new_n56_), .c(x15), .O(new_n203_));
  nand4  g170(.a(new_n203_), .b(new_n124_), .c(new_n122_), .d(new_n121_), .O(z7));
endmodule
