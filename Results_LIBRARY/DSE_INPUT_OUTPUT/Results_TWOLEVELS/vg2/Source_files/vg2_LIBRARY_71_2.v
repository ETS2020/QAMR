...
module FAU ( 
  ...
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n53_), .d(new_n36_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n76_), .c(new_n37_), .d(new_n89_), .O(new_n94_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n57_), .c(new_n44_), .d(x01), .O(new_n98_));
  nand4  g065(.a(new_n84_), .b(new_n64_), .c(x21), .d(x20), .O(new_n99_));
  nor2   g066(.a(x03), .b(x01), .O(new_n100_));
  nor2   g067(.a(x06), .b(x04), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n87_), .d(x00), .O(new_n102_));
  oai22  g069(.a(new_n102_), .b(new_n94_), .c(new_n99_), .d(new_n98_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n40_), .c(new_n45_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n96_), .c(new_n82_), .d(new_n54_), .O(z1));
  ...
  oai21  g079(.a(new_n112_), .b(new_n109_), .c(new_n54_), .O(new_n113_));
  ...
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n90_), .d(new_n36_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n35_), .c(new_n34_), .d(new_n106_), .O(new_n130_));
  ...
  nand3  g101(.a(new_n100_), .b(x07), .c(new_n35_), .O(new_n135_));
  nand4  g102(.a(new_n37_), .b(new_n90_), .c(new_n36_), .d(new_n118_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n79_), .c(x24), .O(new_n138_));
  nand4  g105(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n139_));
  nand2  g106(.a(new_n100_), .b(new_n70_), .O(new_n140_));
  nand3  g107(.a(new_n75_), .b(new_n90_), .c(new_n36_), .O(new_n141_));
  ...
  oai21  g111(.a(x23), .b(new_n56_), .c(new_n89_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n62_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n118_), .O(new_n147_));
  nand2  g114(.a(new_n48_), .b(new_n43_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n42_), .c(new_n54_), .O(new_n149_));
  ...
  oai21  g119(.a(new_n63_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n68_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n91_), .c(x08), .O(new_n155_));
  ...
  nand4  g126(.a(new_n159_), .b(new_n54_), .c(new_n48_), .d(new_n158_), .O(z5));
  aoi21  g127(.a(x20), .b(new_n90_), .c(x06), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x11), .c(new_n34_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n150_), .O(new_n163_));
  aoi21  g130(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n36_), .c(x03), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n152_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n163_), .O(z6));
  inv1   g134(.a(new_n109_), .O(new_n168_));
  and2   g135(.a(new_n114_), .b(new_n111_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n110_), .c(new_n168_), .d(new_n54_), .O(z7));
endmodule
