...
module FAU ( 
  ...
  nor2   g084(.a(new_n117_), .b(new_n94_), .O(z2));
  nand3  g085(.a(new_n67_), .b(new_n34_), .c(x00), .O(new_n119_));
  nor2   g086(.a(x11), .b(x10), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n40_), .c(new_n37_), .d(new_n87_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n119_), .c(new_n94_), .O(new_n122_));
  ...
  nand3  g092(.a(new_n67_), .b(new_n34_), .c(new_n94_), .O(new_n126_));
  nand3  g093(.a(new_n72_), .b(new_n87_), .c(new_n36_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n78_), .O(new_n129_));
  nand3  g096(.a(new_n82_), .b(x14), .c(x11), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n131_));
  nand4  g098(.a(new_n37_), .b(new_n87_), .c(new_n36_), .d(new_n97_), .O(new_n132_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n88_), .c(x08), .O(new_n148_));
  inv1   g115(.a(new_n114_), .O(new_n149_));
  nand3  g116(.a(new_n40_), .b(x21), .c(new_n98_), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n44_), .c(new_n94_), .O(new_n152_));
  oai21  g119(.a(new_n140_), .b(new_n149_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n145_), .O(z4));
  aoi21  g122(.a(new_n45_), .b(x00), .c(x01), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x02), .c(new_n142_), .O(z5));
  aoi21  g124(.a(x20), .b(new_n87_), .c(x06), .O(new_n158_));
  ...
  oai21  g131(.a(new_n151_), .b(x01), .c(new_n44_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n149_), .O(z7));
endmodule
