...
module FAU ( 
  ...
  nand4  g044(.a(new_n77_), .b(new_n74_), .c(new_n73_), .d(new_n56_), .O(new_n78_));
  ...
  nand4  g057(.a(x18), .b(x17), .c(x16), .d(x14), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nor2   g059(.a(new_n52_), .b(new_n56_), .O(new_n93_));
  ...
  nand4  g068(.a(new_n74_), .b(new_n73_), .c(new_n56_), .d(new_n72_), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n100_), .c(new_n99_), .d(new_n97_), .O(new_n104_));
  aoi21  g071(.a(new_n104_), .b(new_n96_), .c(new_n87_), .O(new_n105_));
  nand4  g072(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n95_), .c(new_n90_), .O(new_n108_));
  nor2   g075(.a(x08), .b(x06), .O(new_n109_));
  nor2   g076(.a(x11), .b(x09), .O(new_n110_));
  nand4  g077(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n55_), .O(new_n111_));
  inv1   g078(.a(x19), .O(new_n112_));
  nor2   g079(.a(x20), .b(new_n112_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n74_), .c(new_n73_), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n110_), .c(new_n109_), .d(new_n97_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n108_), .c(x13), .O(new_n117_));
  aoi22  g084(.a(new_n117_), .b(new_n37_), .c(new_n105_), .d(x24), .O(new_n118_));
  ...
  nand4  g102(.a(new_n77_), .b(new_n56_), .c(new_n70_), .d(new_n36_), .O(new_n136_));
  ...
  nand4  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n99_), .O(new_n144_));
  ...
  nand4  g114(.a(new_n147_), .b(new_n146_), .c(new_n93_), .d(x18), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n144_), .c(new_n87_), .O(new_n149_));
  nor2   g116(.a(x14), .b(x11), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n141_), .c(new_n113_), .d(new_n109_), .O(new_n151_));
  nand4  g118(.a(new_n147_), .b(new_n146_), .c(new_n93_), .d(x15), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n151_), .c(x13), .O(new_n153_));
  aoi22  g120(.a(new_n153_), .b(new_n37_), .c(new_n149_), .d(x24), .O(new_n154_));
  ...
  oai21  g129(.a(new_n162_), .b(new_n71_), .c(x08), .O(new_n163_));
  nand4  g130(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n126_), .c(new_n124_), .O(new_n165_));
  nor2   g132(.a(new_n165_), .b(new_n122_), .O(new_n166_));
  inv1   g133(.a(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n160_), .c(new_n53_), .O(z4));
  nand4  g136(.a(new_n53_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n170_));
  nand2  g137(.a(new_n52_), .b(x03), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(x19), .c(x13), .d(x05), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n39_), .O(new_n174_));
  inv1   g141(.a(new_n87_), .O(new_n175_));
  ...
  oai21  g146(.a(new_n56_), .b(x14), .c(new_n35_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n156_), .c(new_n36_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n166_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n34_), .O(new_n183_));
  aoi21  g150(.a(new_n56_), .b(x14), .c(new_n35_), .O(new_n184_));
  inv1   g151(.a(new_n184_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(x18), .c(x11), .O(new_n186_));
  oai21  g153(.a(new_n98_), .b(new_n34_), .c(new_n186_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n175_), .c(x24), .O(new_n188_));
  nand3  g155(.a(new_n39_), .b(x13), .c(x05), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n175_), .O(new_n190_));
  nand3  g157(.a(new_n185_), .b(x15), .c(x11), .O(new_n191_));
  oai21  g158(.a(new_n112_), .b(new_n34_), .c(new_n191_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  inv1   g160(.a(x00), .O(new_n194_));
  oai21  g161(.a(new_n184_), .b(new_n36_), .c(new_n194_), .O(new_n195_));
  nand4  g162(.a(new_n195_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n193_), .c(new_n188_), .O(new_n197_));
  nand2  g164(.a(new_n197_), .b(x21), .O(new_n198_));
  nand2  g165(.a(new_n198_), .b(new_n183_), .O(z6));
  and2   g166(.a(new_n126_), .b(new_n124_), .O(new_n200_));
  nand4  g167(.a(new_n200_), .b(new_n164_), .c(new_n123_), .d(new_n53_), .O(z7));
endmodule
