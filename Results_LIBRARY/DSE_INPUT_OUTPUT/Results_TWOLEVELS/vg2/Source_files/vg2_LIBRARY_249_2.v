...
module FAU ( 
  ...
  oai21  g019(.a(new_n49_), .b(x01), .c(new_n52_), .O(z0));
  ...
  nand3  g042(.a(new_n75_), .b(new_n72_), .c(new_n52_), .O(new_n76_));
  ...
  nand4  g057(.a(new_n90_), .b(new_n73_), .c(new_n52_), .d(x24), .O(new_n91_));
  inv1   g058(.a(x02), .O(new_n92_));
  nand4  g059(.a(x03), .b(new_n92_), .c(x01), .d(new_n50_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  inv1   g061(.a(x04), .O(new_n95_));
  inv1   g062(.a(x10), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(x09), .c(x08), .O(new_n97_));
  nor3   g064(.a(new_n97_), .b(new_n35_), .c(new_n95_), .O(new_n98_));
  nand3  g065(.a(x17), .b(x16), .c(x14), .O(new_n99_));
  nor3   g066(.a(new_n99_), .b(new_n84_), .c(new_n36_), .O(new_n100_));
  inv1   g067(.a(x21), .O(new_n101_));
  nand3  g068(.a(new_n40_), .b(x23), .c(x22), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(new_n101_), .c(new_n37_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n100_), .c(new_n98_), .d(new_n94_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n91_), .c(new_n76_), .O(z1));
  inv1   g072(.a(x01), .O(new_n106_));
  nor2   g073(.a(new_n34_), .b(new_n106_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n96_), .c(x06), .O(new_n108_));
  nor2   g075(.a(new_n85_), .b(new_n36_), .O(new_n109_));
  nor2   g076(.a(x24), .b(new_n101_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n109_), .c(x20), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n108_), .c(new_n50_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n92_), .O(new_n113_));
  ...
  nand3  g084(.a(x15), .b(new_n44_), .c(new_n38_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n116_), .c(x20), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n85_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x11), .c(x06), .d(x03), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n106_), .c(new_n113_), .O(z2));
  nand4  g090(.a(new_n107_), .b(new_n96_), .c(x08), .d(x06), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n111_), .c(new_n50_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n92_), .O(new_n126_));
  nand3  g093(.a(new_n107_), .b(x08), .c(x06), .O(new_n127_));
  nand3  g094(.a(new_n109_), .b(x20), .c(x15), .O(new_n128_));
  nand3  g095(.a(new_n64_), .b(new_n34_), .c(new_n106_), .O(new_n129_));
  nand3  g096(.a(new_n69_), .b(new_n85_), .c(new_n36_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n75_), .O(new_n132_));
  nand3  g099(.a(new_n109_), .b(x20), .c(x18), .O(new_n133_));
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n106_), .O(new_n134_));
  inv1   g101(.a(x08), .O(new_n135_));
  nand4  g102(.a(new_n37_), .b(new_n85_), .c(new_n36_), .d(new_n135_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n134_), .c(new_n133_), .d(new_n127_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n73_), .c(x24), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n132_), .c(new_n126_), .O(z3));
  ...
  oai21  g110(.a(x23), .b(new_n95_), .c(new_n83_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n143_), .c(x09), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n135_), .O(new_n146_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n86_), .c(x08), .O(new_n151_));
  nand3  g118(.a(new_n110_), .b(new_n96_), .c(new_n92_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n118_), .c(new_n117_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n116_), .c(new_n151_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n147_), .c(new_n52_), .O(z4));
  aoi21  g122(.a(new_n141_), .b(new_n140_), .c(new_n51_), .O(z5));
  oai21  g123(.a(x20), .b(new_n85_), .c(x06), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x11), .c(new_n34_), .O(new_n158_));
  nor2   g125(.a(new_n119_), .b(new_n116_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(new_n51_), .O(new_n160_));
  nand2  g127(.a(new_n110_), .b(new_n96_), .O(new_n161_));
  nor3   g128(.a(new_n161_), .b(x02), .c(x00), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  aoi21  g130(.a(x20), .b(new_n85_), .c(x06), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x11), .c(new_n34_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n52_), .c(new_n142_), .O(new_n166_));
  oai21  g133(.a(new_n163_), .b(new_n158_), .c(new_n166_), .O(z6));
  nand2  g134(.a(new_n161_), .b(new_n50_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n92_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n159_), .O(z7));
endmodule
