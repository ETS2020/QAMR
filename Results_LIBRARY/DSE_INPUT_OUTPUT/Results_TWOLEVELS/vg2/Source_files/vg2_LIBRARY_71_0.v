...
module FAU ( 
  ...
  oai21  g113(.a(new_n144_), .b(new_n55_), .c(new_n146_), .O(new_n147_));
  ...
  nand3  g121(.a(new_n41_), .b(new_n134_), .c(x00), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x12), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n34_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n55_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n39_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n36_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n147_), .O(new_n161_));
  aoi21  g128(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n46_), .c(x03), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n149_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(z6));
  nor2   g132(.a(new_n115_), .b(new_n113_), .O(new_n166_));
  nand3  g133(.a(new_n41_), .b(x21), .c(new_n134_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x12), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n34_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(z7));
endmodule
