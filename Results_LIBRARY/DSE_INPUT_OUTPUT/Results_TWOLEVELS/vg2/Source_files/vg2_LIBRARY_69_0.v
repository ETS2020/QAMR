...
module FAU ( 
  ...
  nand3  g091(.a(new_n58_), .b(x03), .c(x01), .O(new_n125_));
  nor2   g092(.a(new_n37_), .b(new_n36_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(x20), .c(x15), .O(new_n127_));
  nand4  g094(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n107_), .O(new_n128_));
  nand4  g095(.a(new_n85_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n133_), .b(new_n36_), .c(new_n57_), .d(x07), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n128_), .c(new_n132_), .d(new_n125_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n89_), .c(x24), .O(new_n136_));
  nor2   g103(.a(x02), .b(new_n107_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n58_), .c(x03), .O(new_n138_));
  nand4  g105(.a(new_n126_), .b(new_n111_), .c(x20), .d(new_n108_), .O(new_n139_));
  or2    g106(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n136_), .c(new_n131_), .O(z3));
  ...
  nand4  g112(.a(new_n40_), .b(new_n108_), .c(new_n54_), .d(x00), .O(new_n146_));
  ...
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n59_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n100_), .c(x08), .O(new_n151_));
  nand3  g118(.a(new_n111_), .b(new_n108_), .c(new_n54_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n119_), .c(new_n118_), .O(new_n153_));
  or2    g120(.a(new_n153_), .b(new_n117_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n54_), .b(new_n107_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n155_), .c(new_n148_), .O(z4));
  nand3  g124(.a(new_n40_), .b(new_n108_), .c(x00), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x01), .c(x02), .O(new_n159_));
  ...
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n156_), .O(z6));
  nor2   g134(.a(new_n120_), .b(new_n117_), .O(new_n168_));
  aoi21  g135(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n169_));
