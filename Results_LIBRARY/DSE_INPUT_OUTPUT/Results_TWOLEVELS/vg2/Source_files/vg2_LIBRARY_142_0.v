...
module FAU ( 
  ...
  oai21  g043(.a(new_n76_), .b(new_n65_), .c(x12), .O(new_n77_));
  ...
  nor2   g049(.a(new_n74_), .b(new_n72_), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n82_), .c(new_n80_), .d(new_n70_), .O(new_n84_));
  nor3   g051(.a(x04), .b(x03), .c(x01), .O(new_n85_));
  nor2   g052(.a(x08), .b(x06), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n85_), .c(new_n35_), .d(new_n62_), .O(new_n87_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n89_), .d(new_n88_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n87_), .c(new_n84_), .O(new_n94_));
  nand2  g061(.a(new_n46_), .b(new_n40_), .O(new_n95_));
  ...
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n83_), .d(new_n80_), .O(new_n102_));
  nor2   g069(.a(x09), .b(x08), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n85_), .c(x07), .d(new_n34_), .O(new_n104_));
  nand4  g071(.a(new_n66_), .b(new_n36_), .c(new_n38_), .d(new_n35_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n92_), .c(new_n69_), .d(new_n68_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n104_), .c(new_n102_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n95_), .c(x24), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n98_), .c(new_n78_), .O(z1));
  nand3  g077(.a(new_n58_), .b(new_n50_), .c(x06), .O(new_n111_));
  nor2   g078(.a(new_n36_), .b(new_n35_), .O(new_n112_));
  nor2   g079(.a(x24), .b(new_n71_), .O(new_n113_));
  ...
  nand3  g087(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nor3   g090(.a(new_n123_), .b(new_n69_), .c(new_n36_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x11), .c(x06), .d(x03), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n56_), .c(new_n116_), .O(z2));
  nand3  g093(.a(x15), .b(x13), .c(x05), .O(new_n127_));
  nand3  g094(.a(x21), .b(new_n50_), .c(new_n37_), .O(new_n128_));
  ...
  nand3  g099(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n133_));
  nand3  g100(.a(x19), .b(x13), .c(x05), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n69_), .c(new_n36_), .d(new_n35_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(x08), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n34_), .c(new_n57_), .d(new_n56_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n132_), .c(x24), .O(new_n139_));
  nand3  g106(.a(new_n58_), .b(x08), .c(x06), .O(new_n140_));
  nand2  g107(.a(new_n112_), .b(new_n101_), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n34_), .c(new_n57_), .d(new_n56_), .O(new_n142_));
  nand4  g109(.a(new_n69_), .b(new_n36_), .c(new_n35_), .d(new_n61_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n95_), .c(x24), .O(new_n145_));
  nand3  g112(.a(new_n112_), .b(x20), .c(x15), .O(new_n146_));
  nand3  g113(.a(new_n86_), .b(new_n57_), .c(new_n56_), .O(new_n147_));
  nand3  g114(.a(new_n91_), .b(new_n36_), .c(new_n35_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n140_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n46_), .c(new_n40_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n139_), .c(x12), .O(new_n152_));
  nand2  g119(.a(new_n149_), .b(new_n97_), .O(new_n153_));
  ...
  oai21  g123(.a(x23), .b(new_n59_), .c(new_n68_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n72_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n61_), .O(new_n159_));
  inv1   g126(.a(new_n44_), .O(new_n160_));
  nand4  g127(.a(new_n42_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n47_), .c(new_n45_), .d(new_n160_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  oai21  g130(.a(new_n74_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n62_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n66_), .c(x08), .O(new_n166_));
  inv1   g133(.a(new_n119_), .O(new_n167_));
  nand3  g134(.a(new_n113_), .b(new_n50_), .c(new_n37_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n121_), .c(new_n120_), .d(new_n167_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n163_), .c(new_n39_), .O(z4));
  nand3  g138(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x12), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n37_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n47_), .c(new_n45_), .d(new_n160_), .O(z5));
  ...
  nand2  g145(.a(new_n69_), .b(x14), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x06), .c(new_n35_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n57_), .c(new_n169_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n178_), .c(new_n39_), .O(z6));
  aoi21  g149(.a(new_n113_), .b(new_n50_), .c(new_n38_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(x02), .c(new_n123_), .O(z7));
endmodule
