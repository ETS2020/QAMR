...
module FAU ( 
  ...
  nand4  g047(.a(new_n80_), .b(new_n37_), .c(new_n67_), .d(new_n66_), .O(new_n81_));
  nor2   g048(.a(new_n81_), .b(x06), .O(new_n82_));
  nand4  g049(.a(new_n82_), .b(new_n34_), .c(new_n36_), .d(new_n35_), .O(new_n83_));
  ...
  nor4   g053(.a(new_n86_), .b(new_n34_), .c(new_n36_), .d(new_n35_), .O(new_n87_));
  ...
  nand4  g060(.a(new_n67_), .b(new_n66_), .c(x07), .d(new_n54_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n69_), .b(new_n68_), .c(new_n55_), .d(new_n37_), .O(new_n96_));
  nor2   g063(.a(x23), .b(x22), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n71_), .c(new_n70_), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n95_), .c(new_n93_), .O(new_n100_));
  aoi22  g067(.a(new_n100_), .b(new_n92_), .c(new_n47_), .d(new_n38_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n37_), .b(new_n67_), .c(new_n66_), .d(new_n54_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n55_), .O(new_n108_));
  ...
  nand3  g079(.a(new_n112_), .b(new_n107_), .c(new_n93_), .O(new_n113_));
  ...
  nor2   g093(.a(x06), .b(new_n34_), .O(new_n127_));
  inv1   g094(.a(new_n127_), .O(new_n128_));
  oai21  g095(.a(new_n126_), .b(new_n35_), .c(new_n128_), .O(z2));
  ...
  nand4  g099(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n37_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n54_), .c(new_n34_), .d(new_n36_), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x01), .c(new_n132_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n40_), .O(new_n137_));
  nand2  g104(.a(new_n47_), .b(new_n38_), .O(new_n138_));
  nand4  g105(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  nand3  g106(.a(new_n90_), .b(x14), .c(x11), .O(new_n140_));
  nand4  g107(.a(new_n54_), .b(new_n34_), .c(new_n36_), .d(new_n35_), .O(new_n141_));
  nor2   g108(.a(x20), .b(x14), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n37_), .c(new_n66_), .d(x07), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n141_), .c(new_n140_), .d(new_n139_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n138_), .c(x24), .O(new_n145_));
  nand4  g112(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n146_));
  nand4  g113(.a(new_n110_), .b(new_n68_), .c(new_n37_), .d(new_n66_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n141_), .c(new_n146_), .d(new_n139_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n47_), .c(new_n38_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n145_), .c(new_n137_), .O(z3));
  aoi21  g117(.a(new_n72_), .b(x17), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n66_), .O(new_n152_));
  nand2  g119(.a(new_n97_), .b(new_n69_), .O(new_n153_));
  nor3   g120(.a(new_n153_), .b(new_n54_), .c(new_n34_), .O(new_n154_));
  aoi21  g121(.a(new_n152_), .b(new_n128_), .c(new_n154_), .O(new_n155_));
  aoi21  g122(.a(x22), .b(new_n70_), .c(new_n67_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n69_), .c(x08), .O(new_n157_));
  nor2   g124(.a(new_n69_), .b(x04), .O(new_n158_));
  aoi22  g125(.a(new_n158_), .b(new_n91_), .c(new_n157_), .d(new_n128_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n124_), .c(new_n155_), .d(new_n50_), .O(z4));
  nor2   g127(.a(new_n127_), .b(new_n50_), .O(z5));
  nand2  g128(.a(x20), .b(new_n68_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n54_), .c(x11), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n164_));
  nand2  g131(.a(new_n71_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n37_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n36_), .c(new_n123_), .d(new_n119_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n128_), .O(z6));
  nor2   g135(.a(new_n127_), .b(new_n124_), .O(z7));
endmodule
