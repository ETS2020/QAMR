...
module FAU ( 
  ...
  inv1   g116(.a(new_n42_), .O(new_n150_));
  ...
  oai21  g123(.a(new_n103_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n66_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n92_), .c(x08), .O(new_n159_));
  inv1   g126(.a(new_n120_), .O(new_n160_));
  nand4  g127(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n161_));
  and2   g128(.a(new_n161_), .b(new_n122_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n121_), .c(new_n160_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  nand2  g131(.a(x02), .b(x01), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n164_), .c(new_n156_), .O(z4));
  and2   g133(.a(new_n165_), .b(new_n43_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n48_), .c(new_n46_), .d(new_n150_), .O(z5));
  nand2  g135(.a(x20), .b(new_n91_), .O(new_n169_));
  ...
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n165_), .O(z6));
  nand4  g142(.a(new_n165_), .b(new_n162_), .c(new_n121_), .d(new_n160_), .O(z7));
endmodule
