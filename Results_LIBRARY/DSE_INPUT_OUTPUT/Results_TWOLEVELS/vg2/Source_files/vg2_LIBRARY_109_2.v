...
module FAU ( 
  ...
  nor2   g063(.a(new_n96_), .b(new_n84_), .O(new_n97_));
  nand2  g064(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  ...
  aoi21  g080(.a(new_n113_), .b(new_n112_), .c(new_n105_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x14), .c(x11), .d(x06), .O(new_n115_));
  nor3   g082(.a(new_n115_), .b(new_n56_), .c(new_n55_), .O(z2));
  ...
  nand4  g093(.a(new_n126_), .b(new_n105_), .c(new_n36_), .d(new_n35_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n34_), .c(new_n56_), .d(new_n55_), .O(new_n129_));
  ...
  nand3  g100(.a(new_n99_), .b(x07), .c(new_n34_), .O(new_n134_));
  nand4  g101(.a(new_n105_), .b(new_n36_), .c(new_n35_), .d(new_n117_), .O(new_n135_));
  ...
  nand2  g105(.a(new_n99_), .b(new_n70_), .O(new_n139_));
  nand3  g106(.a(new_n75_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  ...
  oai21  g111(.a(x10), .b(new_n144_), .c(new_n125_), .O(new_n145_));
  nand3  g112(.a(new_n62_), .b(new_n61_), .c(x04), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n67_), .c(x16), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x08), .c(new_n145_), .O(new_n148_));
  inv1   g115(.a(x21), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x10), .c(new_n118_), .O(new_n150_));
  inv1   g117(.a(x16), .O(new_n151_));
  aoi21  g118(.a(x22), .b(new_n37_), .c(new_n67_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n151_), .c(x08), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand4  g121(.a(new_n61_), .b(x17), .c(new_n151_), .d(x00), .O(new_n155_));
  nand2  g122(.a(x16), .b(new_n57_), .O(new_n156_));
  nand3  g123(.a(x23), .b(x22), .c(x21), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n156_), .c(new_n155_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n50_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n154_), .c(new_n148_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n41_), .O(new_n161_));
  nand2  g128(.a(new_n153_), .b(x18), .O(new_n162_));
  oai21  g129(.a(new_n147_), .b(x08), .c(x07), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n80_), .c(x24), .O(new_n165_));
  nand2  g132(.a(new_n153_), .b(x15), .O(new_n166_));
  oai21  g133(.a(new_n147_), .b(x08), .c(x19), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n45_), .c(new_n39_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n165_), .c(new_n161_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n49_), .O(new_n171_));
  nor2   g138(.a(new_n111_), .b(new_n108_), .O(new_n172_));
  nor3   g139(.a(new_n62_), .b(new_n61_), .c(x04), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n67_), .c(x16), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x08), .c(new_n172_), .O(new_n175_));
  nor2   g142(.a(new_n47_), .b(new_n43_), .O(new_n176_));
  nand2  g143(.a(x22), .b(new_n67_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n151_), .c(x08), .O(new_n178_));
  nor2   g145(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(new_n175_), .c(x17), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n171_), .O(z4));
  ...
  nand2  g155(.a(new_n105_), .b(x14), .O(new_n189_));
  aoi21  g156(.a(new_n189_), .b(x06), .c(new_n35_), .O(new_n190_));
  nand3  g157(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(new_n191_));
  oai22  g158(.a(new_n191_), .b(new_n108_), .c(new_n190_), .d(new_n56_), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(new_n188_), .c(new_n38_), .O(z6));
  nand2  g160(.a(new_n113_), .b(new_n112_), .O(z7));
endmodule
