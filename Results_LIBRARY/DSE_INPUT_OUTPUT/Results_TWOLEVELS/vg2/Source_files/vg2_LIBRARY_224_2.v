...
module FAU ( 
  ...
  nand3  g026(.a(new_n59_), .b(new_n57_), .c(x01), .O(new_n60_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n68_), .c(x07), .d(new_n35_), .O(new_n86_));
  inv1   g053(.a(x17), .O(new_n87_));
  inv1   g054(.a(x14), .O(new_n88_));
  inv1   g055(.a(x16), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n53_), .d(new_n36_), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n75_), .c(new_n37_), .d(new_n87_), .O(new_n92_));
  oai22  g059(.a(new_n92_), .b(new_n86_), .c(new_n84_), .d(new_n60_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(new_n78_), .c(x24), .O(new_n94_));
  nand4  g061(.a(new_n59_), .b(new_n57_), .c(new_n44_), .d(x01), .O(new_n95_));
  ...
  nand4  g068(.a(new_n101_), .b(new_n94_), .c(new_n81_), .d(new_n54_), .O(z1));
  ...
  nand4  g075(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(new_n110_));
  oai21  g077(.a(new_n110_), .b(new_n106_), .c(x20), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n88_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(x11), .c(x06), .d(x03), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n103_), .c(new_n54_), .O(z2));
  nand4  g081(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n115_));
  nor2   g082(.a(new_n88_), .b(new_n36_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(x20), .c(x15), .O(new_n117_));
  nand2  g084(.a(new_n97_), .b(new_n69_), .O(new_n118_));
  nand3  g085(.a(new_n74_), .b(new_n88_), .c(new_n36_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n97_), .b(x07), .c(new_n35_), .O(new_n123_));
  inv1   g090(.a(x08), .O(new_n124_));
  nand4  g091(.a(new_n37_), .b(new_n88_), .c(new_n36_), .d(new_n124_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n123_), .c(new_n122_), .d(new_n115_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n78_), .c(x24), .O(new_n127_));
  nand4  g094(.a(new_n35_), .b(new_n34_), .c(new_n103_), .d(x00), .O(new_n128_));
  nand3  g095(.a(new_n116_), .b(x21), .c(x20), .O(new_n129_));
  ...
  nand2  g100(.a(new_n127_), .b(new_n121_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(x12), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n133_), .O(z3));
  or2    g103(.a(new_n49_), .b(new_n42_), .O(new_n137_));
  oai21  g104(.a(x23), .b(new_n56_), .c(new_n87_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n63_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n124_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  inv1   g108(.a(new_n106_), .O(new_n142_));
  inv1   g109(.a(new_n110_), .O(new_n143_));
  ...
  oai21  g113(.a(new_n146_), .b(new_n89_), .c(x08), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n141_), .c(new_n54_), .O(z4));
  nand2  g116(.a(new_n48_), .b(new_n43_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n42_), .c(new_n54_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n46_), .O(z5));
  nand2  g119(.a(x20), .b(new_n88_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n35_), .c(x11), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n137_), .O(new_n155_));
  ...
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n54_), .O(z6));
  and2   g126(.a(new_n107_), .b(new_n54_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n109_), .c(new_n108_), .d(new_n142_), .O(z7));
endmodule
