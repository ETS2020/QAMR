...
module FAU ( 
  ...
  aoi21  g026(.a(new_n59_), .b(new_n58_), .c(new_n52_), .O(new_n60_));
  nand4  g027(.a(new_n60_), .b(x20), .c(x17), .d(x16), .O(new_n61_));
  nor3   g028(.a(new_n61_), .b(new_n57_), .c(new_n56_), .O(new_n62_));
  ...
  aoi21  g041(.a(new_n74_), .b(new_n73_), .c(x22), .O(new_n75_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n71_), .d(new_n70_), .O(new_n89_));
  nand4  g056(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n90_));
  nor4   g057(.a(new_n90_), .b(new_n67_), .c(new_n34_), .d(new_n66_), .O(new_n91_));
  nand4  g058(.a(x23), .b(x20), .c(x18), .d(x17), .O(new_n92_));
  nor4   g059(.a(new_n92_), .b(new_n70_), .c(new_n57_), .d(new_n56_), .O(new_n93_));
  nand2  g060(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  oai21  g061(.a(new_n89_), .b(new_n86_), .c(new_n94_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n83_), .c(x24), .O(new_n96_));
  nor2   g063(.a(x08), .b(x06), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n84_), .c(new_n36_), .d(new_n69_), .O(new_n98_));
  nor3   g065(.a(x16), .b(x14), .c(x12), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n88_), .c(x19), .d(new_n71_), .O(new_n100_));
  ...
  nand3  g073(.a(new_n106_), .b(new_n96_), .c(new_n54_), .O(new_n107_));
  inv1   g074(.a(new_n107_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n82_), .O(z1));
  ...
  nor4   g084(.a(new_n117_), .b(new_n53_), .c(new_n72_), .d(new_n57_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x11), .c(x06), .d(x03), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n66_), .O(z2));
  ...
  nand2  g091(.a(new_n74_), .b(new_n73_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n72_), .c(new_n57_), .d(new_n36_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n72_), .b(new_n57_), .c(new_n36_), .d(new_n68_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n97_), .b(new_n34_), .c(new_n66_), .O(new_n138_));
  nand4  g105(.a(new_n72_), .b(x19), .c(new_n57_), .d(new_n36_), .O(new_n139_));
  ...
  aoi21  g109(.a(new_n142_), .b(new_n130_), .c(new_n53_), .O(z3));
  inv1   g110(.a(new_n49_), .O(new_n144_));
  inv1   g111(.a(x22), .O(new_n145_));
  oai21  g112(.a(x17), .b(x04), .c(new_n145_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n69_), .c(x16), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x08), .c(new_n144_), .O(new_n148_));
  inv1   g115(.a(new_n117_), .O(new_n149_));
  nand2  g116(.a(x22), .b(new_n71_), .O(new_n150_));
  nand2  g117(.a(x23), .b(new_n67_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n150_), .c(x09), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x08), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n149_), .c(new_n53_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n148_), .O(z4));
  nor2   g123(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g124(.a(x20), .b(new_n57_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n35_), .c(x11), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n144_), .O(new_n160_));
  nand2  g127(.a(new_n72_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n36_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n34_), .c(new_n149_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n54_), .O(z6));
  inv1   g131(.a(new_n112_), .O(new_n165_));
  and2   g132(.a(new_n114_), .b(new_n113_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n115_), .c(new_n165_), .d(new_n54_), .O(z7));
endmodule
