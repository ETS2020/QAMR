...
module FAU ( 
  ...
  nand2  g124(.a(x02), .b(x01), .O(new_n158_));
  nand2  g125(.a(new_n48_), .b(new_n43_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n42_), .c(new_n158_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n46_), .O(z5));
  nand2  g128(.a(z5), .b(new_n157_), .O(new_n162_));
  oai21  g129(.a(new_n101_), .b(x04), .c(x17), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x22), .c(new_n66_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n90_), .c(x08), .O(new_n165_));
  nand3  g132(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n158_), .O(new_n167_));
  nand3  g134(.a(new_n146_), .b(new_n45_), .c(new_n44_), .O(new_n168_));
  ...
  and2   g143(.a(new_n168_), .b(new_n123_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n122_), .c(new_n121_), .O(new_n178_));
  oai21  g145(.a(new_n176_), .b(new_n34_), .c(new_n178_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n174_), .c(new_n158_), .O(z6));
  nand4  g147(.a(new_n177_), .b(new_n158_), .c(new_n122_), .d(new_n121_), .O(z7));
endmodule
