...
module FAU ( 
  ...
  aoi21  g118(.a(new_n139_), .b(x00), .c(new_n62_), .O(new_n152_));
  ...
  nand4  g123(.a(new_n139_), .b(new_n109_), .c(x01), .d(x00), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(new_n151_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g129(.a(new_n162_), .b(new_n106_), .c(new_n149_), .O(new_n163_));
  nand3  g130(.a(new_n117_), .b(new_n92_), .c(new_n95_), .O(new_n164_));
