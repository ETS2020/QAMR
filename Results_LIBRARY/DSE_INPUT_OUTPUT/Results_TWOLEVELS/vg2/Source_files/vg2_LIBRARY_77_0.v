...
module FAU ( 
  ...
  nand2  g077(.a(new_n93_), .b(new_n34_), .O(new_n111_));
  nand2  g078(.a(x24), .b(x18), .O(new_n112_));
  nand3  g079(.a(new_n41_), .b(x15), .c(x13), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n112_), .c(new_n51_), .O(new_n114_));
  nand3  g081(.a(x24), .b(x18), .c(x13), .O(new_n115_));
  nand3  g082(.a(x15), .b(new_n52_), .c(new_n51_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n114_), .c(new_n111_), .O(new_n118_));
  nor2   g085(.a(x24), .b(new_n106_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x12), .c(new_n103_), .d(new_n34_), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n118_), .c(new_n40_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x14), .c(x11), .d(x06), .O(new_n122_));
  nor3   g089(.a(new_n122_), .b(new_n36_), .c(new_n35_), .O(z2));
  nand3  g090(.a(new_n62_), .b(x03), .c(x01), .O(new_n124_));
  nor2   g091(.a(new_n39_), .b(new_n46_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(x20), .c(x15), .O(new_n126_));
  nand3  g093(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n127_));
  nand3  g094(.a(new_n78_), .b(new_n39_), .c(new_n46_), .O(new_n128_));
  ...
  nand4  g098(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n132_));
  nand4  g099(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n61_), .O(new_n133_));
  ...
  nand3  g102(.a(new_n125_), .b(x21), .c(x20), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n124_), .c(new_n133_), .d(new_n38_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n41_), .c(new_n103_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(x12), .O(new_n139_));
  ...
  aoi21  g110(.a(new_n143_), .b(new_n142_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n61_), .O(new_n145_));
  nand2  g112(.a(new_n49_), .b(x05), .O(new_n146_));
  inv1   g113(.a(x00), .O(new_n147_));
  nor2   g114(.a(x02), .b(new_n147_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n41_), .c(new_n103_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n53_), .c(new_n50_), .d(new_n146_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  inv1   g118(.a(x23), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n69_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n94_), .c(x08), .O(new_n155_));
  nand3  g122(.a(new_n119_), .b(new_n103_), .c(new_n34_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n116_), .c(new_n115_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n114_), .c(new_n155_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n151_), .c(new_n111_), .O(z4));
  inv1   g126(.a(new_n111_), .O(new_n160_));
  nand4  g127(.a(new_n148_), .b(new_n41_), .c(x12), .d(new_n103_), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(new_n55_), .c(new_n161_), .O(z5));
  aoi21  g129(.a(x20), .b(new_n39_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n36_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  nand2  g132(.a(new_n120_), .b(new_n118_), .O(new_n166_));
  ...
  nor2   g137(.a(new_n117_), .b(new_n114_), .O(new_n171_));
  aoi21  g138(.a(new_n119_), .b(new_n103_), .c(new_n93_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x02), .c(new_n171_), .O(z7));
endmodule
