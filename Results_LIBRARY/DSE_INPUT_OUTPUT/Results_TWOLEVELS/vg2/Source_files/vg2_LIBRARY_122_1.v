...
module FAU ( 
  ...
  oai21  g023(.a(new_n56_), .b(new_n52_), .c(new_n47_), .O(new_n57_));
  nor2   g024(.a(new_n57_), .b(x14), .O(new_n58_));
  nand4  g025(.a(new_n58_), .b(new_n42_), .c(new_n37_), .d(new_n36_), .O(new_n59_));
  ...
  nand4  g048(.a(new_n81_), .b(new_n62_), .c(new_n42_), .d(new_n80_), .O(new_n82_));
  ...
  nand2  g055(.a(new_n54_), .b(new_n48_), .O(new_n89_));
  nand3  g056(.a(new_n50_), .b(x13), .c(x05), .O(new_n90_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n81_), .c(new_n80_), .d(new_n97_), .O(new_n100_));
  nor2   g067(.a(x16), .b(x14), .O(new_n101_));
  nor2   g068(.a(x20), .b(x17), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n86_), .d(new_n65_), .O(new_n103_));
  ...
  nand3  g074(.a(new_n50_), .b(x15), .c(x13), .O(new_n108_));
  aoi21  g075(.a(new_n108_), .b(new_n107_), .c(new_n48_), .O(new_n109_));
  nand3  g076(.a(x24), .b(x18), .c(x13), .O(new_n110_));
  nand3  g077(.a(x15), .b(new_n54_), .c(new_n48_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n109_), .c(x20), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n42_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x06), .c(x03), .d(x01), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(x02), .c(new_n35_), .O(z2));
  nand4  g083(.a(new_n43_), .b(new_n42_), .c(new_n41_), .d(new_n97_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n40_), .c(new_n35_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n34_), .O(new_n119_));
  nand4  g086(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n120_));
  nor2   g087(.a(new_n35_), .b(new_n42_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(x20), .c(x15), .O(new_n122_));
  inv1   g089(.a(x01), .O(new_n123_));
  nand3  g090(.a(new_n62_), .b(new_n36_), .c(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n85_), .b(new_n35_), .c(new_n42_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n122_), .d(new_n120_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n91_), .O(new_n127_));
  nand3  g094(.a(new_n121_), .b(x20), .c(x18), .O(new_n128_));
  nand3  g095(.a(new_n99_), .b(new_n36_), .c(new_n123_), .O(new_n129_));
  nand4  g096(.a(new_n47_), .b(new_n35_), .c(new_n42_), .d(new_n97_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n120_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n89_), .c(x24), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n127_), .c(new_n119_), .O(z3));
  ...
  oai21  g105(.a(new_n138_), .b(x16), .c(new_n97_), .O(new_n139_));
  nor2   g106(.a(x02), .b(new_n38_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n50_), .c(new_n41_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n55_), .c(new_n53_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n52_), .c(new_n139_), .O(new_n143_));
  inv1   g110(.a(x16), .O(new_n144_));
  inv1   g111(.a(x23), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x04), .c(x17), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x22), .c(new_n80_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n144_), .c(x08), .O(new_n148_));
  nand4  g115(.a(new_n50_), .b(x21), .c(new_n41_), .d(new_n34_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n111_), .c(new_n110_), .O(new_n150_));
  or2    g117(.a(new_n150_), .b(new_n109_), .O(new_n151_));
  nor2   g118(.a(new_n35_), .b(x02), .O(new_n152_));
  aoi21  g119(.a(new_n151_), .b(new_n148_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n143_), .O(z4));
  nor2   g121(.a(new_n56_), .b(new_n52_), .O(new_n155_));
  nand4  g122(.a(new_n140_), .b(new_n50_), .c(new_n35_), .d(new_n41_), .O(new_n156_));
  oai21  g123(.a(new_n152_), .b(new_n155_), .c(new_n156_), .O(z5));
  oai21  g124(.a(new_n42_), .b(x06), .c(x03), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n151_), .O(new_n159_));
  oai21  g126(.a(new_n47_), .b(x14), .c(new_n37_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n42_), .c(x03), .O(new_n161_));
  nand3  g128(.a(new_n121_), .b(new_n47_), .c(x15), .O(new_n162_));
  oai21  g129(.a(new_n161_), .b(new_n84_), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n91_), .O(new_n164_));
  nand3  g131(.a(new_n121_), .b(new_n47_), .c(x18), .O(new_n165_));
  oai21  g132(.a(new_n161_), .b(new_n98_), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n89_), .c(x24), .O(new_n167_));
  nor2   g134(.a(x20), .b(x06), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x11), .c(new_n36_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n50_), .c(new_n41_), .d(x00), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n35_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n34_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n167_), .c(new_n164_), .d(new_n159_), .O(z6));
  nor2   g140(.a(new_n112_), .b(new_n109_), .O(new_n174_));
  nand3  g141(.a(new_n50_), .b(x21), .c(new_n41_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n35_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n34_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n174_), .O(z7));
endmodule
