...
module FAU ( 
  ...
  nor2   g113(.a(x20), .b(new_n53_), .O(new_n147_));
  inv1   g114(.a(new_n147_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n146_), .c(new_n141_), .d(new_n134_), .O(z3));
  inv1   g116(.a(new_n49_), .O(new_n150_));
  oai21  g117(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n72_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n66_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  inv1   g121(.a(new_n123_), .O(new_n155_));
  oai21  g122(.a(new_n73_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n67_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n69_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n154_), .c(new_n147_), .O(z4));
  nor2   g127(.a(new_n147_), .b(new_n49_), .O(z5));
  ...
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n148_), .O(z6));
  nor2   g135(.a(new_n147_), .b(new_n123_), .O(z7));
endmodule
