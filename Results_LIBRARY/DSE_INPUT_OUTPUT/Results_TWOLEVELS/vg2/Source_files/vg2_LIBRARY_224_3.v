...
module FAU ( 
  ...
  nand4  g058(.a(new_n91_), .b(new_n74_), .c(new_n37_), .d(new_n60_), .O(new_n92_));
  ...
  oai21  g082(.a(new_n115_), .b(new_n105_), .c(new_n53_), .O(z2));
  nand4  g083(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n117_));
  nor2   g084(.a(new_n88_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand3  g086(.a(new_n68_), .b(new_n34_), .c(new_n105_), .O(new_n120_));
  nand3  g087(.a(new_n73_), .b(new_n88_), .c(new_n36_), .O(new_n121_));
  ...
  nand4  g091(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n105_), .O(new_n125_));
  inv1   g092(.a(x08), .O(new_n126_));
  nand4  g093(.a(new_n37_), .b(new_n88_), .c(new_n36_), .d(new_n126_), .O(new_n127_));
  ...
  nand3  g096(.a(new_n98_), .b(new_n35_), .c(new_n34_), .O(new_n130_));
  nand2  g097(.a(new_n118_), .b(new_n95_), .O(new_n131_));
  ...
  or2    g105(.a(new_n49_), .b(new_n42_), .O(new_n139_));
  inv1   g106(.a(x04), .O(new_n140_));
  oai21  g107(.a(x23), .b(new_n140_), .c(new_n60_), .O(new_n141_));
  ...
  inv1   g111(.a(new_n108_), .O(new_n145_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n89_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n144_), .c(new_n53_), .O(z4));
  nand2  g119(.a(new_n48_), .b(new_n43_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n42_), .c(new_n53_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n46_), .O(z5));
  nand2  g122(.a(x20), .b(new_n88_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n35_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n139_), .O(new_n158_));
  nand2  g125(.a(new_n37_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n36_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n34_), .c(new_n147_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n53_), .O(z6));
  and2   g129(.a(new_n109_), .b(new_n53_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n111_), .c(new_n110_), .d(new_n145_), .O(z7));
endmodule
