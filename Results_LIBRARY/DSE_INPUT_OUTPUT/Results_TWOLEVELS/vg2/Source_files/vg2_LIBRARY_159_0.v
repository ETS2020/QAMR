...
module FAU ( 
  ...
  nand2  g094(.a(new_n103_), .b(new_n71_), .O(new_n128_));
  nand3  g095(.a(new_n76_), .b(new_n39_), .c(new_n46_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n82_), .O(new_n131_));
  nand2  g098(.a(new_n112_), .b(new_n89_), .O(new_n132_));
  nand3  g099(.a(new_n103_), .b(x07), .c(new_n37_), .O(new_n133_));
  ...
  nand4  g105(.a(x20), .b(x14), .c(x11), .d(x08), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n135_), .d(new_n38_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n41_), .c(new_n99_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(x21), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n34_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n137_), .c(new_n131_), .O(z3));
  oai21  g111(.a(new_n85_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n69_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n100_), .c(x08), .O(new_n147_));
  nor2   g114(.a(new_n121_), .b(new_n118_), .O(new_n148_));
  nor2   g115(.a(x21), .b(x02), .O(new_n149_));
  ...
  oai21  g125(.a(x23), .b(new_n157_), .c(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n84_), .c(x09), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x16), .c(new_n134_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g129(.a(new_n151_), .b(new_n99_), .c(new_n34_), .d(x00), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n162_), .c(new_n154_), .O(z4));
  nand2  g131(.a(new_n156_), .b(new_n155_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n163_), .O(z5));
  nand2  g133(.a(x20), .b(new_n39_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n37_), .c(x11), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x03), .c(new_n155_), .O(new_n169_));
  nand2  g136(.a(new_n40_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x06), .c(new_n46_), .O(new_n171_));
  ...
  oai22  g141(.a(new_n174_), .b(new_n118_), .c(new_n171_), .d(new_n36_), .O(new_n175_));
  nand2  g142(.a(new_n99_), .b(x00), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(x24), .c(x21), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n34_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n175_), .c(new_n169_), .O(z6));
  oai21  g146(.a(new_n172_), .b(new_n150_), .c(new_n34_), .O(new_n180_));
