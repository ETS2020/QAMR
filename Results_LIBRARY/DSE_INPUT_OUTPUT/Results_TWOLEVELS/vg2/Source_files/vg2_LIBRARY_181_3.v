...
module FAU ( 
  ...
  nand2  g019(.a(x22), .b(x02), .O(new_n53_));
  ...
  oai21  g049(.a(new_n78_), .b(new_n66_), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g054(.a(new_n87_), .b(new_n67_), .c(x07), .d(new_n35_), .O(new_n88_));
  nand4  g055(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n36_), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n76_), .c(new_n37_), .d(new_n74_), .O(new_n91_));
  oai22  g058(.a(new_n91_), .b(new_n88_), .c(new_n86_), .d(new_n59_), .O(new_n92_));
  nand3  g059(.a(new_n92_), .b(new_n80_), .c(x24), .O(new_n93_));
  nand3  g060(.a(new_n64_), .b(x21), .c(x20), .O(new_n94_));
  nor2   g061(.a(new_n94_), .b(new_n84_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n58_), .c(new_n56_), .d(x01), .O(new_n96_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n101_));
  ...
  nor3   g080(.a(new_n113_), .b(new_n34_), .c(new_n103_), .O(z2));
  ...
  nand4  g091(.a(new_n124_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(x08), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n35_), .c(new_n34_), .d(new_n103_), .O(new_n127_));
  ...
  nand3  g098(.a(new_n97_), .b(x07), .c(new_n35_), .O(new_n132_));
  nand4  g099(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n115_), .O(new_n133_));
  ...
  nand2  g103(.a(new_n97_), .b(new_n68_), .O(new_n137_));
  nand4  g104(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n130_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n47_), .c(new_n38_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n135_), .c(new_n129_), .d(new_n53_), .O(z3));
  inv1   g108(.a(x04), .O(new_n142_));
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n74_), .O(new_n143_));
  ...
  oai21  g113(.a(new_n73_), .b(x09), .c(x08), .O(new_n147_));
  nand3  g114(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n106_), .c(new_n147_), .O(new_n149_));
  oai21  g116(.a(new_n63_), .b(x04), .c(x17), .O(new_n150_));
  nand3  g117(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n108_), .c(new_n107_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n106_), .c(new_n150_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n73_), .c(new_n44_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x22), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n149_), .c(new_n146_), .O(z4));
