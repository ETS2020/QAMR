...
module FAU ( 
  ...
  nor2   g005(.a(x15), .b(new_n38_), .O(new_n39_));
  ...
  nand4  g030(.a(new_n63_), .b(x16), .c(x15), .d(x14), .O(new_n64_));
  ...
  nand4  g048(.a(new_n81_), .b(new_n58_), .c(new_n74_), .d(new_n73_), .O(new_n82_));
  ...
  nand2  g055(.a(new_n49_), .b(new_n40_), .O(new_n89_));
  ...
  nand4  g060(.a(new_n93_), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  ...
  oai21  g067(.a(new_n100_), .b(new_n99_), .c(new_n50_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n76_), .c(new_n75_), .d(new_n37_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n58_), .c(new_n74_), .d(new_n73_), .O(new_n104_));
  nor2   g071(.a(new_n104_), .b(x12), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n36_), .c(new_n72_), .d(new_n71_), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(x06), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n70_), .c(new_n34_), .d(new_n69_), .O(new_n108_));
  and2   g075(.a(new_n108_), .b(new_n98_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n88_), .O(z1));
  inv1   g077(.a(new_n39_), .O(new_n111_));
  nand3  g078(.a(new_n42_), .b(x15), .c(x13), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n90_), .c(new_n40_), .O(new_n113_));
  nand3  g080(.a(x24), .b(x18), .c(x13), .O(new_n114_));
  nand3  g081(.a(x15), .b(new_n49_), .c(new_n40_), .O(new_n115_));
  nand4  g082(.a(new_n42_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  nor2   g084(.a(new_n117_), .b(new_n113_), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n37_), .c(new_n73_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x11), .c(x06), .d(x03), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n69_), .c(new_n111_), .O(z2));
  ...
  nand4  g093(.a(new_n79_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n129_));
  ...
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n134_));
  nand4  g101(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n71_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n71_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n139_));
  nand4  g106(.a(new_n37_), .b(x19), .c(new_n73_), .d(new_n36_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n132_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n49_), .c(new_n40_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n137_), .c(new_n131_), .d(new_n111_), .O(z3));
  inv1   g110(.a(new_n52_), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n70_), .c(new_n58_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n75_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n71_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  inv1   g115(.a(new_n118_), .O(new_n149_));
  oai21  g116(.a(new_n76_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n72_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n74_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n148_), .c(new_n111_), .O(z4));
  nand2  g121(.a(x20), .b(new_n73_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n35_), .c(x11), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x03), .c(new_n144_), .O(new_n157_));
  nand2  g124(.a(new_n37_), .b(x14), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x06), .c(new_n36_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n34_), .c(new_n149_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n111_), .O(z6));
  nand4  g128(.a(new_n111_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n122_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n42_), .O(new_n164_));
  inv1   g131(.a(x15), .O(new_n165_));
  nand2  g132(.a(new_n89_), .b(new_n38_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(x24), .c(x18), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n164_), .c(new_n115_), .O(z7));
endmodule
