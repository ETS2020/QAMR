...
module FAU ( 
  ...
  aoi21  g121(.a(x20), .b(new_n71_), .c(x06), .O(new_n155_));
  ...
  inv1   g128(.a(new_n104_), .O(new_n162_));
  and2   g129(.a(new_n105_), .b(new_n53_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n151_), .c(new_n106_), .d(new_n162_), .O(z7));
endmodule
