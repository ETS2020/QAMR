...
module FAU ( 
  ...
  oai21  g111(.a(new_n144_), .b(new_n92_), .c(x08), .O(new_n145_));
  oai21  g112(.a(new_n112_), .b(new_n108_), .c(new_n145_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n142_), .c(new_n54_), .O(z4));
  nand4  g114(.a(new_n54_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n148_));
  or2    g115(.a(new_n148_), .b(new_n42_), .O(z5));
  aoi21  g116(.a(x20), .b(new_n91_), .c(x06), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x11), .c(new_n34_), .O(new_n151_));
  nand2  g118(.a(new_n48_), .b(new_n43_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n42_), .c(new_n54_), .O(new_n153_));
  ...
  oai21  g125(.a(new_n158_), .b(new_n108_), .c(new_n54_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n111_), .O(z7));
