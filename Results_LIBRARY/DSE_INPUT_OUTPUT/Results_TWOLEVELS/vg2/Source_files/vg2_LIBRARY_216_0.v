...
module FAU ( 
  ...
  nor2   g29(.a(x20), .b(x11), .O(new_n64_));
  ...
  oai21  g75(.a(new_n109_), .b(new_n102_), .c(new_n65_), .O(new_n110_));
  inv1   g76(.a(x11), .O(new_n111_));
  inv1   g77(.a(x06), .O(new_n112_));
  nand2  g78(.a(x14), .b(new_n112_), .O(new_n113_));
  nand4  g79(.a(new_n113_), .b(new_n83_), .c(x20), .d(new_n111_), .O(new_n114_));
  oai21  g80(.a(x20), .b(new_n37_), .c(x06), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n60_), .c(x11), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n114_), .c(new_n110_), .O(z6));
  nor2   g83(.a(new_n64_), .b(new_n59_), .O(z7));
  zero   g84(.O(z0));
endmodule
