...
module FAU ( 
  ...
  nor2   g048(.a(new_n65_), .b(new_n34_), .O(new_n82_));
  inv1   g049(.a(x08), .O(new_n83_));
  nor2   g050(.a(new_n83_), .b(new_n35_), .O(new_n84_));
  nand3  g051(.a(new_n84_), .b(x11), .c(x09), .O(new_n85_));
  inv1   g052(.a(new_n85_), .O(new_n86_));
  nand4  g053(.a(x23), .b(x22), .c(x20), .d(x18), .O(new_n87_));
  nor4   g054(.a(new_n87_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n86_), .c(new_n82_), .d(x01), .O(new_n89_));
  nor3   g056(.a(x06), .b(x04), .c(x01), .O(new_n90_));
  nor2   g057(.a(x11), .b(x09), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n83_), .d(x07), .O(new_n92_));
  ...
  nand4  g064(.a(new_n86_), .b(new_n37_), .c(x04), .d(x01), .O(new_n98_));
  nor2   g065(.a(new_n53_), .b(x13), .O(new_n99_));
  nand4  g066(.a(x23), .b(x22), .c(x20), .d(x17), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n99_), .c(x16), .d(x15), .O(new_n102_));
  oai21  g069(.a(new_n102_), .b(new_n98_), .c(x12), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(x03), .O(new_n104_));
  nand4  g071(.a(new_n35_), .b(new_n37_), .c(new_n65_), .d(new_n64_), .O(new_n105_));
  nand4  g072(.a(new_n67_), .b(new_n36_), .c(new_n66_), .d(new_n83_), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g074(.a(new_n68_), .b(new_n54_), .c(new_n53_), .d(new_n46_), .O(new_n108_));
  nand3  g075(.a(new_n94_), .b(new_n69_), .c(x19), .O(new_n109_));
  nor2   g076(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n104_), .c(new_n97_), .O(new_n112_));
  ...
  nor4   g090(.a(new_n123_), .b(new_n69_), .c(new_n53_), .d(new_n67_), .O(new_n124_));
  ...
  nor2   g095(.a(new_n128_), .b(new_n83_), .O(new_n129_));
  ...
  nand3  g103(.a(new_n84_), .b(x03), .c(x01), .O(new_n137_));
  nand4  g104(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n138_));
  nor2   g105(.a(x03), .b(x01), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(x07), .c(new_n35_), .O(new_n140_));
  nand4  g107(.a(new_n69_), .b(new_n53_), .c(new_n36_), .d(new_n83_), .O(new_n141_));
  ...
  nand3  g110(.a(new_n84_), .b(new_n37_), .c(x01), .O(new_n144_));
  nor2   g111(.a(x13), .b(new_n36_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(x20), .c(x15), .d(x14), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n144_), .c(x12), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x03), .O(new_n148_));
  nor3   g115(.a(x08), .b(x06), .c(x05), .O(new_n149_));
  nand3  g116(.a(new_n69_), .b(x19), .c(new_n53_), .O(new_n150_));
  nor3   g117(.a(new_n150_), .b(x13), .c(x11), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n149_), .c(new_n139_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n148_), .c(new_n143_), .d(new_n136_), .O(z3));
  nor2   g120(.a(x12), .b(new_n34_), .O(new_n154_));
  inv1   g121(.a(new_n49_), .O(new_n155_));
  oai21  g122(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n70_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n83_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  inv1   g126(.a(new_n123_), .O(new_n160_));
  oai21  g127(.a(new_n55_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n66_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n54_), .c(x08), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n159_), .c(new_n154_), .O(z4));
  aoi21  g132(.a(new_n67_), .b(x03), .c(new_n49_), .O(z5));
  inv1   g133(.a(new_n154_), .O(new_n167_));
  nor2   g134(.a(new_n67_), .b(new_n34_), .O(new_n168_));
  nand2  g135(.a(x20), .b(new_n53_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x11), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n168_), .c(new_n155_), .O(new_n171_));
  nand2  g138(.a(new_n69_), .b(x14), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n36_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n34_), .c(new_n160_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n167_), .O(z6));
  inv1   g142(.a(new_n117_), .O(new_n176_));
  nand4  g143(.a(new_n167_), .b(new_n121_), .c(new_n118_), .d(new_n176_), .O(z7));
endmodule
