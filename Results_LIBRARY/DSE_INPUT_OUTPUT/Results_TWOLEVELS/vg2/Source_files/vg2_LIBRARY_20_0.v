...
module FAU ( 
  ...
  inv1   g26(.a(new_n44_), .O(new_n60_));
  inv1   g27(.a(new_n51_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand4  g29(.a(new_n62_), .b(x20), .c(x14), .d(x11), .O(new_n63_));
  inv1   g30(.a(new_n63_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(x06), .c(x03), .O(new_n65_));
  nor2   g32(.a(new_n65_), .b(new_n35_), .O(z2));
  nand4  g33(.a(new_n64_), .b(x08), .c(x06), .d(x03), .O(new_n67_));
  nor2   g34(.a(new_n67_), .b(new_n35_), .O(z3));
  ...
  nand2  g55(.a(new_n88_), .b(new_n62_), .O(new_n89_));
  aoi21  g56(.a(new_n89_), .b(new_n82_), .c(z0), .O(z4));
  ...
  oai21  g65(.a(new_n98_), .b(new_n93_), .c(new_n62_), .O(new_n99_));
  nand3  g66(.a(new_n99_), .b(new_n97_), .c(new_n36_), .O(z6));
  and2   g67(.a(new_n47_), .b(new_n45_), .O(new_n101_));
  nand4  g68(.a(new_n101_), .b(new_n50_), .c(new_n60_), .d(new_n36_), .O(z7));
endmodule
