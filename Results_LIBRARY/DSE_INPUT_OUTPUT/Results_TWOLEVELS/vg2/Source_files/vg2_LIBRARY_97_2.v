...
module FAU ( 
  ...
  nor2   g061(.a(new_n75_), .b(new_n94_), .O(new_n95_));
  ...
  nor2   g065(.a(new_n44_), .b(x06), .O(new_n99_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n98_), .c(new_n35_), .d(new_n72_), .O(new_n112_));
  ...
  nand2  g086(.a(new_n44_), .b(x02), .O(new_n120_));
  ...
  nand3  g095(.a(x15), .b(new_n38_), .c(new_n37_), .O(new_n129_));
  nand4  g096(.a(new_n40_), .b(x21), .c(new_n50_), .d(new_n49_), .O(new_n130_));
  and2   g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n127_), .c(x20), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n36_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(x11), .c(x06), .d(x03), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(new_n68_), .c(new_n120_), .O(z2));
  nand4  g103(.a(new_n60_), .b(x20), .c(x14), .d(x11), .O(new_n137_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n34_), .c(new_n69_), .d(new_n68_), .O(new_n142_));
  ...
  nand3  g112(.a(new_n95_), .b(x14), .c(x11), .O(new_n146_));
  nand3  g113(.a(new_n99_), .b(new_n69_), .c(new_n68_), .O(new_n147_));
  nand4  g114(.a(new_n75_), .b(new_n36_), .c(new_n35_), .d(new_n71_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n145_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n39_), .c(x24), .O(new_n150_));
  nand4  g117(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n151_));
  nand3  g118(.a(new_n111_), .b(new_n69_), .c(new_n68_), .O(new_n152_));
  nand3  g119(.a(new_n116_), .b(new_n36_), .c(new_n35_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n145_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n38_), .c(new_n37_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n150_), .c(new_n144_), .d(new_n120_), .O(z3));
  ...
  aoi21  g126(.a(new_n159_), .b(new_n73_), .c(x08), .O(new_n160_));
  oai21  g127(.a(new_n77_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n72_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n73_), .c(x08), .O(new_n163_));
  nor2   g130(.a(new_n48_), .b(new_n94_), .O(new_n164_));
  inv1   g131(.a(new_n42_), .O(new_n165_));
  nand3  g132(.a(new_n120_), .b(new_n165_), .c(x15), .O(new_n166_));
  nand3  g133(.a(new_n40_), .b(x21), .c(new_n50_), .O(new_n167_));
  inv1   g134(.a(new_n167_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n164_), .c(new_n49_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  aoi22  g137(.a(new_n170_), .b(new_n163_), .c(new_n164_), .d(x07), .O(new_n171_));
  oai21  g138(.a(new_n160_), .b(new_n53_), .c(new_n171_), .O(z4));
  nand2  g139(.a(x24), .b(x07), .O(new_n173_));
  nand3  g140(.a(new_n40_), .b(x19), .c(x13), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n173_), .c(new_n37_), .O(new_n175_));
  inv1   g142(.a(new_n175_), .O(new_n176_));
  nand3  g143(.a(x24), .b(x13), .c(x07), .O(new_n177_));
  inv1   g144(.a(new_n51_), .O(new_n178_));
  nor2   g145(.a(new_n115_), .b(x13), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n37_), .c(new_n178_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n177_), .c(new_n176_), .d(new_n120_), .O(z5));
  nand2  g148(.a(x20), .b(new_n36_), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n34_), .c(x11), .O(new_n183_));
  nand3  g150(.a(new_n180_), .b(new_n177_), .c(new_n176_), .O(new_n184_));
  oai21  g151(.a(new_n183_), .b(x03), .c(new_n184_), .O(new_n185_));
  nand2  g152(.a(new_n75_), .b(x14), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(x06), .c(new_n35_), .O(new_n187_));
  oai22  g154(.a(new_n187_), .b(new_n69_), .c(new_n132_), .d(new_n127_), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n185_), .c(new_n120_), .O(z6));
  inv1   g156(.a(new_n127_), .O(new_n190_));
  nand4  g157(.a(new_n131_), .b(new_n128_), .c(new_n190_), .d(new_n120_), .O(z7));
endmodule
