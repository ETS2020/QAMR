...
module FAU ( 
  ...
  nand4  g054(.a(new_n87_), .b(x17), .c(new_n56_), .d(new_n36_), .O(new_n88_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n72_), .c(x17), .d(new_n56_), .O(new_n99_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n72_), .c(x19), .d(x17), .O(new_n105_));
  ...
  oai21  g077(.a(x23), .b(new_n110_), .c(new_n37_), .O(new_n111_));
  ...
  nand3  g089(.a(new_n122_), .b(new_n114_), .c(new_n73_), .O(z4));
  inv1   g090(.a(new_n42_), .O(new_n124_));
  and2   g091(.a(new_n46_), .b(new_n43_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n73_), .c(new_n48_), .d(new_n124_), .O(z5));
  aoi21  g093(.a(new_n36_), .b(x06), .c(x03), .O(new_n127_));
  aoi21  g094(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n75_), .c(new_n127_), .d(new_n50_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n73_), .O(new_n130_));
  inv1   g097(.a(new_n95_), .O(new_n131_));
  nand4  g098(.a(x20), .b(new_n56_), .c(new_n36_), .d(x00), .O(new_n132_));
  nand3  g099(.a(x21), .b(new_n72_), .c(x17), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n131_), .c(new_n132_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n45_), .c(new_n44_), .O(new_n135_));
  nand3  g102(.a(new_n104_), .b(x20), .c(x19), .O(new_n136_));
  nand3  g103(.a(new_n72_), .b(x17), .c(x15), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n131_), .c(new_n136_), .O(new_n138_));
  ...
  nand4  g108(.a(x20), .b(new_n56_), .c(new_n36_), .d(x07), .O(new_n142_));
  nand3  g109(.a(new_n72_), .b(x18), .c(x17), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n131_), .c(new_n142_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n93_), .c(x24), .O(new_n145_));
  nand3  g112(.a(new_n138_), .b(new_n47_), .c(new_n38_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n145_), .c(new_n141_), .d(new_n130_), .O(z6));
  inv1   g114(.a(new_n60_), .O(new_n148_));
  and2   g115(.a(new_n62_), .b(new_n61_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n73_), .c(new_n63_), .d(new_n148_), .O(z7));
endmodule
