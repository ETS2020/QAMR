...
module FAU ( 
  ...
  nand4  g047(.a(x12), .b(x09), .c(x08), .d(x06), .O(new_n81_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n68_), .d(new_n54_), .O(new_n95_));
  ...
  nor2   g079(.a(new_n39_), .b(new_n85_), .O(new_n113_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n86_), .c(new_n53_), .O(new_n122_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n86_), .c(new_n53_), .d(new_n36_), .O(new_n130_));
  ...
  nand4  g104(.a(new_n86_), .b(new_n53_), .c(new_n36_), .d(new_n66_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n102_), .b(new_n34_), .c(new_n64_), .O(new_n142_));
  nand4  g109(.a(new_n86_), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n143_));
  ...
  oai21  g114(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n69_), .c(x09), .O(new_n149_));
  ...
  oai21  g119(.a(new_n55_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n67_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n54_), .c(x08), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n151_), .c(new_n108_), .O(z4));
  nor2   g124(.a(new_n108_), .b(new_n49_), .O(z5));
  oai21  g125(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n147_), .O(new_n160_));
  nand2  g127(.a(new_n86_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n36_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n34_), .c(new_n152_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n109_), .O(z6));
  nor2   g131(.a(new_n121_), .b(new_n108_), .O(z7));
endmodule
