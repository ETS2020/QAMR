...
module FAU ( 
  ...
  nand2  g039(.a(new_n37_), .b(new_n72_), .O(new_n73_));
  oai21  g040(.a(new_n71_), .b(new_n54_), .c(new_n73_), .O(z1));
  nor2   g041(.a(new_n64_), .b(new_n60_), .O(new_n75_));
  nor3   g042(.a(new_n75_), .b(new_n72_), .c(new_n56_), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(x11), .c(x06), .d(x03), .O(new_n77_));
  oai21  g044(.a(new_n77_), .b(new_n54_), .c(new_n73_), .O(z2));
  ...
  nand4  g072(.a(new_n105_), .b(new_n100_), .c(new_n92_), .d(new_n73_), .O(z3));
  ...
  oai21  g078(.a(new_n111_), .b(x16), .c(new_n55_), .O(new_n112_));
  ...
  oai21  g083(.a(new_n37_), .b(x04), .c(x17), .O(new_n117_));
  ...
  nand3  g087(.a(new_n120_), .b(new_n113_), .c(new_n73_), .O(z4));
  inv1   g088(.a(new_n42_), .O(new_n122_));
  and2   g089(.a(new_n46_), .b(new_n43_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n73_), .c(new_n48_), .d(new_n122_), .O(z5));
  aoi21  g091(.a(new_n36_), .b(x06), .c(x03), .O(new_n125_));
  aoi21  g092(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n75_), .c(new_n125_), .d(new_n50_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n73_), .O(new_n128_));
  inv1   g095(.a(new_n95_), .O(new_n129_));
  nand4  g096(.a(x20), .b(new_n56_), .c(new_n36_), .d(x00), .O(new_n130_));
  nand3  g097(.a(x23), .b(x21), .c(new_n72_), .O(new_n131_));
  ...
  nand3  g101(.a(x23), .b(new_n72_), .c(x15), .O(new_n135_));
  ...
  nand3  g107(.a(x23), .b(new_n72_), .c(x18), .O(new_n141_));
  ...
  inv1   g112(.a(new_n60_), .O(new_n146_));
  and2   g113(.a(new_n62_), .b(new_n61_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n73_), .c(new_n63_), .d(new_n146_), .O(z7));
endmodule
