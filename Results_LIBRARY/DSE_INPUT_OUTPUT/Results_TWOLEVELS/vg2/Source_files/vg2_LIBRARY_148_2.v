...
module FAU ( 
  ...
  nand2  g136(.a(new_n42_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x06), .c(new_n40_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n36_), .c(new_n157_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n160_), .O(z6));
  nand2  g140(.a(new_n160_), .b(new_n117_), .O(new_n174_));
  nand4  g141(.a(new_n155_), .b(new_n38_), .c(new_n34_), .d(new_n35_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n174_), .O(z7));
endmodule
