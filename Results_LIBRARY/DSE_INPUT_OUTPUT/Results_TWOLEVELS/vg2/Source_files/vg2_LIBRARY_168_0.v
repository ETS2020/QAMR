...
module FAU ( 
  ...
  aoi21  g46(.a(new_n76_), .b(x05), .c(new_n80_), .O(new_n81_));
  ...
  nor2   g57(.a(new_n81_), .b(new_n58_), .O(z5));
  inv1   g58(.a(x03), .O(new_n93_));
  inv1   g59(.a(x11), .O(new_n94_));
  oai21  g60(.a(new_n37_), .b(x06), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  oai22  g63(.a(x20), .b(new_n37_), .c(new_n94_), .d(x06), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n93_), .c(new_n62_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n59_), .O(z6));
  nor2   g66(.a(new_n58_), .b(new_n61_), .O(z7));
  zero   g67(.O(z0));
endmodule
