...
module FAU ( 
  ...
  oai21  g080(.a(new_n113_), .b(new_n110_), .c(new_n54_), .O(new_n114_));
  ...
  nor3   g084(.a(new_n117_), .b(new_n34_), .c(new_n107_), .O(z2));
  ...
  nand4  g096(.a(new_n129_), .b(new_n37_), .c(new_n126_), .d(new_n36_), .O(new_n130_));
  ...
  nand4  g104(.a(new_n37_), .b(new_n126_), .c(new_n36_), .d(new_n119_), .O(new_n138_));
  ...
  nand3  g109(.a(new_n74_), .b(new_n126_), .c(new_n36_), .O(new_n143_));
  ...
  nand4  g112(.a(new_n145_), .b(new_n140_), .c(new_n134_), .d(new_n54_), .O(z3));
  inv1   g113(.a(x04), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n147_), .c(new_n61_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n63_), .c(x09), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n119_), .O(new_n150_));
  oai21  g117(.a(new_n49_), .b(new_n42_), .c(new_n150_), .O(new_n151_));
  ...
  nand3  g122(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n110_), .c(new_n155_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n151_), .c(new_n54_), .O(z4));
  nand2  g125(.a(new_n48_), .b(new_n43_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n42_), .c(new_n54_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n46_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n126_), .c(x06), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x11), .c(new_n34_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(z5), .O(new_n164_));
  nand2  g131(.a(new_n115_), .b(new_n114_), .O(z7));
