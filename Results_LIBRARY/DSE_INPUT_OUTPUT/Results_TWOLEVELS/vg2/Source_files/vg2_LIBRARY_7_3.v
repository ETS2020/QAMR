...
module FAU ( 
  ...
  nand2  g018(.a(x21), .b(x02), .O(new_n52_));
  ...
  nor2   g060(.a(new_n93_), .b(new_n60_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n82_), .c(new_n64_), .d(new_n56_), .O(new_n95_));
  ...
  nand3  g066(.a(new_n99_), .b(new_n38_), .c(new_n43_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n92_), .c(new_n80_), .O(new_n101_));
  ...
  nand3  g077(.a(x15), .b(new_n46_), .c(new_n45_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n109_), .c(new_n52_), .O(new_n113_));
  nand4  g080(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n113_), .c(new_n60_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n34_), .c(new_n106_), .O(z2));
  nand4  g084(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n118_));
  inv1   g085(.a(x14), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n36_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(x20), .c(x15), .O(new_n121_));
  nand2  g088(.a(new_n96_), .b(new_n68_), .O(new_n122_));
  nand3  g089(.a(new_n73_), .b(new_n119_), .c(new_n36_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n118_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n79_), .O(new_n125_));
  nand2  g092(.a(new_n120_), .b(new_n83_), .O(new_n126_));
  nand3  g093(.a(new_n96_), .b(x07), .c(new_n35_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n60_), .b(new_n119_), .c(new_n36_), .d(new_n128_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(new_n118_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n77_), .c(x24), .O(new_n131_));
  nand4  g098(.a(new_n35_), .b(new_n34_), .c(new_n106_), .d(x00), .O(new_n132_));
  nand2  g099(.a(new_n120_), .b(new_n94_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n118_), .c(new_n132_), .d(new_n129_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n38_), .c(new_n43_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n131_), .c(new_n125_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n42_), .O(new_n137_));
  nand2  g104(.a(new_n131_), .b(new_n125_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n93_), .O(new_n139_));
  ...
  nand3  g117(.a(new_n38_), .b(x21), .c(new_n43_), .O(new_n151_));
  ...
  nand3  g121(.a(new_n154_), .b(new_n146_), .c(new_n52_), .O(z4));
  nand2  g122(.a(new_n40_), .b(x05), .O(new_n156_));
  and2   g123(.a(new_n52_), .b(new_n47_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n44_), .c(new_n41_), .d(new_n156_), .O(z5));
  nand2  g125(.a(x20), .b(new_n119_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x11), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x03), .c(new_n141_), .O(new_n161_));
  nand2  g128(.a(new_n60_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n36_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n34_), .c(new_n153_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n52_), .O(z6));
  nand2  g132(.a(new_n114_), .b(new_n113_), .O(z7));
endmodule
