...
module FAU ( 
  ...
  nand2  g097(.a(new_n109_), .b(new_n88_), .O(new_n131_));
  nand4  g098(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n132_));
  nand4  g099(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n100_), .O(new_n133_));
  ...
  oai22  g103(.a(new_n136_), .b(new_n125_), .c(new_n133_), .d(new_n39_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n42_), .c(new_n101_), .O(new_n138_));
  ...
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n65_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n67_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n100_), .O(new_n145_));
  inv1   g112(.a(x00), .O(new_n146_));
  nor2   g113(.a(x02), .b(new_n146_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n42_), .c(new_n101_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n54_), .c(new_n52_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n51_), .c(new_n145_), .O(new_n150_));
  ...
  nand3  g120(.a(new_n111_), .b(new_n101_), .c(new_n34_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n119_), .c(new_n118_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n117_), .c(new_n153_), .O(new_n156_));
  nor2   g123(.a(new_n35_), .b(x02), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n156_), .c(new_n150_), .O(z4));
  oai21  g126(.a(new_n55_), .b(new_n51_), .c(new_n158_), .O(new_n160_));
  nand4  g127(.a(new_n147_), .b(new_n42_), .c(new_n35_), .d(new_n101_), .O(new_n161_));
  ...
  oai21  g134(.a(new_n120_), .b(new_n117_), .c(new_n158_), .O(new_n168_));
  nand4  g135(.a(new_n111_), .b(new_n35_), .c(new_n101_), .d(new_n34_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n168_), .O(z7));
