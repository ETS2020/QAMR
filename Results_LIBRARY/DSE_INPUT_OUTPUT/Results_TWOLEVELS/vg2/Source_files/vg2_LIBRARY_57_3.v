...
module FAU ( 
  ...
  oai21  g104(.a(new_n137_), .b(new_n42_), .c(new_n53_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n46_), .O(z5));
  nand2  g106(.a(z5), .b(new_n136_), .O(new_n140_));
  ...
  oai21  g112(.a(new_n145_), .b(new_n104_), .c(new_n53_), .O(new_n146_));
  ...
  oai22  g118(.a(new_n151_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n152_));
  nand2  g119(.a(new_n37_), .b(x14), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x06), .c(new_n36_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n34_), .c(new_n108_), .d(new_n104_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n152_), .c(new_n53_), .O(z6));
endmodule
