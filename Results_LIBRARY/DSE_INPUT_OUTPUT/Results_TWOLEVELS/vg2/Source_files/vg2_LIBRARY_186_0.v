...
module FAU ( 
  ...
  nand4  g073(.a(x11), .b(new_n98_), .c(x06), .d(x03), .O(new_n107_));
  nor2   g074(.a(x24), .b(new_n101_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(x20), .c(x14), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(x01), .O(new_n110_));
  ...
  oai21  g087(.a(new_n120_), .b(new_n65_), .c(new_n111_), .O(z2));
  nand4  g088(.a(new_n98_), .b(x08), .c(x06), .d(x03), .O(new_n122_));
  nor2   g089(.a(new_n37_), .b(new_n36_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n108_), .c(x20), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n122_), .c(x01), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n106_), .O(new_n126_));
  nand3  g093(.a(new_n57_), .b(x03), .c(x01), .O(new_n127_));
  nand3  g094(.a(new_n123_), .b(x20), .c(x15), .O(new_n128_));
  nand3  g095(.a(new_n69_), .b(new_n34_), .c(new_n65_), .O(new_n129_));
  ...
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n134_));
  nand4  g101(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n56_), .O(new_n135_));
  ...
  oai21  g107(.a(x23), .b(new_n66_), .c(new_n140_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n139_), .c(x09), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n56_), .O(new_n143_));
  inv1   g110(.a(new_n49_), .O(new_n144_));
  nor2   g111(.a(x02), .b(x01), .O(new_n145_));
  nor2   g112(.a(x24), .b(x10), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n106_), .c(x01), .d(x00), .O(new_n147_));
  ...
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n64_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n150_), .c(x08), .O(new_n154_));
  inv1   g121(.a(new_n145_), .O(new_n155_));
  oai21  g122(.a(new_n117_), .b(new_n114_), .c(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n108_), .b(new_n95_), .c(new_n98_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(z7));
  nand2  g125(.a(z7), .b(new_n154_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n149_), .O(z4));
  aoi21  g127(.a(new_n146_), .b(x00), .c(new_n65_), .O(new_n161_));
  ...
  nand3  g131(.a(new_n146_), .b(new_n106_), .c(x00), .O(new_n165_));
  ...
  nand3  g136(.a(new_n108_), .b(new_n98_), .c(new_n106_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n116_), .c(new_n115_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n114_), .c(new_n169_), .d(new_n34_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n167_), .c(new_n155_), .O(z6));
endmodule
