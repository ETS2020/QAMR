...
module FAU ( 
  ...
  nand4  g083(.a(new_n98_), .b(x08), .c(x06), .d(x03), .O(new_n117_));
  nor2   g084(.a(x24), .b(new_n101_), .O(new_n118_));
  ...
  nand2  g088(.a(new_n121_), .b(new_n95_), .O(new_n122_));
  nand3  g089(.a(new_n57_), .b(x03), .c(x01), .O(new_n123_));
  nand3  g090(.a(new_n119_), .b(x20), .c(x15), .O(new_n124_));
  nand3  g091(.a(new_n69_), .b(new_n34_), .c(new_n65_), .O(new_n125_));
  nand3  g092(.a(new_n74_), .b(new_n37_), .c(new_n36_), .O(new_n126_));
  ...
  nand4  g096(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n130_));
  nand4  g097(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n56_), .O(new_n131_));
  ...
  oai21  g103(.a(x23), .b(new_n66_), .c(new_n136_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n135_), .c(x09), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x16), .c(new_n56_), .O(new_n139_));
  nand4  g106(.a(new_n40_), .b(new_n98_), .c(new_n95_), .d(x00), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  or2    g109(.a(new_n112_), .b(new_n108_), .O(new_n143_));
  inv1   g110(.a(x16), .O(new_n144_));
  inv1   g111(.a(x23), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x04), .c(x17), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x22), .c(new_n64_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n144_), .c(x08), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  nand2  g116(.a(new_n95_), .b(new_n65_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n142_), .O(z4));
  nand3  g118(.a(new_n40_), .b(new_n98_), .c(x00), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x01), .c(x02), .O(new_n153_));
  or2    g120(.a(new_n153_), .b(new_n49_), .O(z5));
  nand2  g121(.a(x20), .b(new_n37_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n35_), .c(x11), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x03), .c(new_n141_), .O(new_n157_));
  nand2  g124(.a(new_n38_), .b(x14), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x06), .c(new_n36_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n34_), .c(new_n143_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n150_), .O(z6));
  aoi21  g128(.a(new_n118_), .b(new_n98_), .c(new_n65_), .O(new_n162_));
  nand2  g129(.a(new_n110_), .b(new_n109_), .O(new_n163_));
  nor2   g130(.a(new_n163_), .b(new_n108_), .O(new_n164_));
  oai21  g131(.a(new_n162_), .b(x02), .c(new_n164_), .O(z7));
endmodule
