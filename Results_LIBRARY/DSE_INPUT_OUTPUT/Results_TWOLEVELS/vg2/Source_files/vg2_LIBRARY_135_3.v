...
module FAU ( 
  ...
  or2    g116(.a(new_n49_), .b(new_n42_), .O(new_n150_));
  oai21  g117(.a(x23), .b(new_n54_), .c(new_n89_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n113_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n58_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  oai21  g121(.a(new_n103_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n66_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n92_), .c(x08), .O(new_n157_));
  inv1   g124(.a(new_n120_), .O(new_n158_));
  nand4  g125(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n159_));
  and2   g126(.a(new_n159_), .b(new_n122_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n121_), .c(new_n158_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g129(.a(x02), .b(x01), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n162_), .c(new_n154_), .O(z4));
  nand2  g131(.a(new_n48_), .b(new_n43_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n42_), .c(new_n163_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n46_), .O(z5));
  nand2  g134(.a(x20), .b(new_n91_), .O(new_n168_));
  ...
  nand3  g140(.a(new_n173_), .b(new_n170_), .c(new_n163_), .O(z6));
  nand4  g141(.a(new_n163_), .b(new_n160_), .c(new_n121_), .d(new_n158_), .O(z7));
endmodule
