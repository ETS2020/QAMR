...
module FAU ( 
  ...
  nor2   g109(.a(x02), .b(x01), .O(new_n143_));
  ...
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(z5));
  nand2  g115(.a(z5), .b(new_n142_), .O(new_n149_));
  ...
  nand2  g119(.a(new_n112_), .b(new_n111_), .O(new_n153_));
  nor2   g120(.a(new_n153_), .b(new_n110_), .O(new_n154_));
  nand2  g121(.a(new_n122_), .b(new_n113_), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n54_), .c(x01), .O(new_n157_));
  oai21  g124(.a(new_n154_), .b(new_n143_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n152_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n149_), .O(z4));
  nand2  g127(.a(x20), .b(new_n37_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  nand3  g129(.a(new_n146_), .b(new_n54_), .c(x00), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n164_));
  oai21  g131(.a(new_n162_), .b(x03), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n38_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n36_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n34_), .c(new_n115_), .d(new_n110_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n144_), .O(z6));
  oai21  g136(.a(new_n156_), .b(new_n107_), .c(new_n54_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n154_), .O(z7));
endmodule
