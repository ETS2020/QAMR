...
module FAU ( 
  ...
  nand4  g069(.a(x11), .b(new_n95_), .c(x06), .d(x03), .O(new_n103_));
  nor2   g070(.a(x24), .b(new_n98_), .O(new_n104_));
  ...
  nand3  g078(.a(x15), .b(new_n44_), .c(new_n38_), .O(new_n112_));
  oai21  g079(.a(new_n109_), .b(new_n44_), .c(new_n112_), .O(new_n113_));
  ...
  oai21  g083(.a(new_n116_), .b(new_n62_), .c(new_n107_), .O(z2));
  nand4  g084(.a(new_n95_), .b(x08), .c(x06), .d(x03), .O(new_n118_));
  nor2   g085(.a(new_n108_), .b(new_n36_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n104_), .c(x20), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n118_), .c(x01), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n92_), .O(new_n122_));
  nand3  g089(.a(new_n54_), .b(x03), .c(x01), .O(new_n123_));
  nand3  g090(.a(new_n119_), .b(x20), .c(x15), .O(new_n124_));
  nand3  g091(.a(new_n66_), .b(new_n34_), .c(new_n62_), .O(new_n125_));
  nand3  g092(.a(new_n71_), .b(new_n108_), .c(new_n36_), .O(new_n126_));
  ...
  nand4  g097(.a(new_n37_), .b(new_n108_), .c(new_n36_), .d(new_n53_), .O(new_n131_));
  ...
  nor2   g107(.a(x02), .b(x01), .O(new_n141_));
  nor2   g108(.a(x24), .b(x10), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n92_), .c(x01), .d(x00), .O(new_n143_));
  ...
  nor2   g117(.a(new_n113_), .b(new_n111_), .O(new_n151_));
  nand2  g118(.a(new_n104_), .b(new_n95_), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n92_), .c(x01), .O(new_n154_));
  oai21  g121(.a(new_n141_), .b(new_n151_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n150_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n145_), .O(z4));
  aoi21  g124(.a(x20), .b(new_n108_), .c(x06), .O(new_n158_));
  ...
  oai21  g131(.a(new_n153_), .b(new_n62_), .c(new_n92_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n151_), .O(z7));
endmodule
