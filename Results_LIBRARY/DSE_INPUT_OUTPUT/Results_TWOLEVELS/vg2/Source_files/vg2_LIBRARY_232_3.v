...
module FAU ( 
  ...
  nand3  g119(.a(new_n152_), .b(new_n109_), .c(new_n108_), .O(new_n153_));
  nor2   g120(.a(new_n153_), .b(new_n107_), .O(new_n154_));
  ...
  aoi21  g130(.a(new_n62_), .b(x17), .c(new_n61_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n67_), .c(x16), .O(new_n165_));
  nand2  g132(.a(new_n109_), .b(new_n108_), .O(new_n166_));
  nor2   g133(.a(new_n166_), .b(new_n107_), .O(new_n167_));
  aoi21  g134(.a(new_n165_), .b(x08), .c(new_n167_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n163_), .c(new_n155_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n159_), .O(z4));
  nand2  g137(.a(new_n50_), .b(new_n47_), .O(z5));
  aoi21  g138(.a(x20), .b(new_n36_), .c(x06), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x11), .c(new_n122_), .O(new_n173_));
  ...
  inv1   g143(.a(new_n37_), .O(new_n177_));
  oai21  g144(.a(new_n167_), .b(new_n177_), .c(new_n110_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n174_), .O(z6));
  inv1   g147(.a(new_n107_), .O(new_n181_));
  and2   g148(.a(new_n110_), .b(new_n109_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n108_), .c(new_n181_), .d(new_n37_), .O(z7));
endmodule
