...
module FAU ( 
  ...
  nor2   g30(.a(new_n63_), .b(new_n36_), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(x06), .c(x03), .d(x01), .O(new_n66_));
  nor2   g32(.a(x20), .b(x14), .O(new_n67_));
  inv1   g33(.a(new_n67_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(new_n66_), .O(z3));
  ...
  nand3  g56(.a(new_n90_), .b(new_n83_), .c(new_n68_), .O(z4));
  and2   g57(.a(new_n80_), .b(new_n79_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n81_), .c(new_n78_), .d(new_n68_), .O(z5));
  aoi21  g59(.a(x14), .b(new_n60_), .c(x11), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(x03), .c(new_n82_), .O(new_n95_));
  nand2  g61(.a(x20), .b(x06), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x11), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x03), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n62_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n95_), .c(new_n68_), .O(z6));
  nor2   g66(.a(new_n67_), .b(new_n61_), .O(z7));
  zero   g67(.O(z0));
endmodule
