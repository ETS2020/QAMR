...
module FAU ( 
  ...
  nand4  g32(.a(new_n65_), .b(new_n53_), .c(new_n36_), .d(new_n57_), .O(new_n66_));
  nor2   g33(.a(new_n66_), .b(x08), .O(new_n67_));
  nand4  g34(.a(new_n67_), .b(new_n35_), .c(new_n52_), .d(new_n34_), .O(new_n68_));
  ...
  nor2   g46(.a(new_n79_), .b(new_n54_), .O(z7));
  nand2  g47(.a(z7), .b(x20), .O(new_n81_));
  nor2   g48(.a(new_n81_), .b(new_n71_), .O(new_n82_));
  nand4  g49(.a(new_n82_), .b(x11), .c(x06), .d(x03), .O(new_n83_));
  nor2   g50(.a(new_n83_), .b(new_n70_), .O(z2));
  inv1   g51(.a(x08), .O(new_n85_));
  nand3  g52(.a(x15), .b(x13), .c(x05), .O(new_n86_));
  nand3  g53(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n87_));
  nand2  g54(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g55(.a(new_n88_), .b(x20), .c(x14), .d(x11), .O(new_n89_));
  nor2   g56(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  ...
  nand4  g61(.a(new_n94_), .b(new_n60_), .c(new_n71_), .d(new_n36_), .O(new_n95_));
  nor2   g62(.a(new_n95_), .b(x08), .O(new_n96_));
  nand4  g63(.a(new_n96_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n97_));
  nand2  g64(.a(new_n97_), .b(new_n91_), .O(new_n98_));
  ...
  nand4  g69(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n103_));
  nand4  g70(.a(new_n60_), .b(new_n71_), .c(new_n36_), .d(new_n85_), .O(new_n104_));
  ...
  nand4  g74(.a(new_n85_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n108_));
  nand4  g75(.a(new_n60_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n109_));
  ...
  and2   g78(.a(new_n111_), .b(new_n106_), .O(new_n112_));
  aoi21  g79(.a(new_n112_), .b(new_n99_), .c(new_n54_), .O(z3));
  inv1   g80(.a(x22), .O(new_n114_));
  aoi21  g81(.a(new_n114_), .b(x17), .c(x09), .O(new_n115_));
  oai21  g82(.a(new_n115_), .b(x16), .c(new_n85_), .O(new_n116_));
  nand3  g83(.a(new_n61_), .b(new_n114_), .c(new_n58_), .O(new_n117_));
  nor3   g84(.a(new_n117_), .b(x12), .c(new_n52_), .O(new_n118_));
  aoi21  g85(.a(new_n116_), .b(new_n55_), .c(new_n118_), .O(new_n119_));
  aoi21  g86(.a(x22), .b(new_n59_), .c(new_n57_), .O(new_n120_));
  oai21  g87(.a(new_n120_), .b(new_n58_), .c(x08), .O(new_n121_));
  nand4  g88(.a(x23), .b(x22), .c(x16), .d(new_n52_), .O(new_n122_));
  inv1   g89(.a(new_n122_), .O(new_n123_));
  aoi21  g90(.a(new_n121_), .b(new_n55_), .c(new_n123_), .O(new_n124_));
  oai22  g91(.a(new_n124_), .b(new_n79_), .c(new_n119_), .d(new_n49_), .O(z4));
  nor2   g92(.a(new_n54_), .b(new_n49_), .O(z5));
  nand2  g93(.a(x20), .b(new_n71_), .O(new_n127_));
  aoi21  g94(.a(new_n127_), .b(new_n35_), .c(x11), .O(new_n128_));
  oai22  g95(.a(new_n128_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n129_));
  nand2  g96(.a(new_n60_), .b(x14), .O(new_n130_));
  aoi21  g97(.a(new_n130_), .b(x06), .c(new_n36_), .O(new_n131_));
  oai22  g98(.a(new_n131_), .b(new_n34_), .c(new_n78_), .d(new_n74_), .O(new_n132_));
  nand3  g99(.a(new_n132_), .b(new_n129_), .c(new_n55_), .O(z6));
endmodule
