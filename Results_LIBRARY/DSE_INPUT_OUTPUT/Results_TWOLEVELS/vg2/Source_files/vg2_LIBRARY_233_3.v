...
module FAU ( 
  ...
  oai21  g076(.a(new_n106_), .b(new_n44_), .c(new_n109_), .O(new_n110_));
  oai21  g077(.a(new_n110_), .b(new_n108_), .c(new_n37_), .O(new_n111_));
  ...
  nor3   g081(.a(new_n114_), .b(new_n105_), .c(new_n104_), .O(z2));
  ...
  nand4  g091(.a(new_n124_), .b(new_n74_), .c(new_n36_), .d(new_n35_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(x08), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n34_), .c(new_n105_), .d(new_n104_), .O(new_n127_));
  ...
  nand3  g098(.a(new_n98_), .b(x07), .c(new_n34_), .O(new_n132_));
  nand4  g099(.a(new_n74_), .b(new_n36_), .c(new_n35_), .d(new_n66_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n81_), .c(x24), .O(new_n135_));
  nand4  g102(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n136_));
  nand3  g103(.a(new_n98_), .b(new_n66_), .c(new_n34_), .O(new_n137_));
  nand4  g104(.a(new_n74_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n138_));
  ...
  inv1   g108(.a(new_n124_), .O(new_n142_));
  aoi21  g109(.a(new_n61_), .b(x17), .c(x09), .O(new_n143_));
  inv1   g110(.a(x00), .O(new_n144_));
  oai21  g111(.a(x10), .b(new_n144_), .c(new_n123_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n62_), .c(new_n61_), .d(x04), .O(new_n146_));
  oai21  g113(.a(new_n143_), .b(new_n142_), .c(new_n146_), .O(new_n147_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n71_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n118_), .O(new_n152_));
  nand2  g119(.a(new_n124_), .b(x08), .O(new_n153_));
  ...
  nand2  g124(.a(new_n149_), .b(x22), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x09), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x16), .c(new_n66_), .O(new_n160_));
  aoi21  g127(.a(new_n62_), .b(x04), .c(x17), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x22), .c(new_n67_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n71_), .c(x08), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n156_), .c(new_n160_), .d(new_n157_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n81_), .c(x24), .O(new_n165_));
  nand3  g132(.a(new_n71_), .b(new_n44_), .c(new_n38_), .O(new_n166_));
  nand2  g133(.a(new_n75_), .b(x19), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n166_), .c(new_n48_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x04), .O(new_n169_));
  oai21  g136(.a(new_n143_), .b(x16), .c(new_n66_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x19), .O(new_n171_));
  nand2  g138(.a(new_n151_), .b(x15), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n44_), .c(new_n38_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n169_), .c(new_n165_), .d(new_n155_), .O(z4));
  inv1   g142(.a(new_n42_), .O(new_n176_));
  and2   g143(.a(new_n50_), .b(new_n45_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n43_), .c(new_n176_), .d(new_n37_), .O(z5));
  nand2  g145(.a(new_n50_), .b(new_n47_), .O(new_n179_));
  aoi21  g146(.a(x20), .b(new_n36_), .c(x06), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x11), .c(new_n105_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand2  g149(.a(new_n112_), .b(new_n111_), .O(z7));
  aoi21  g150(.a(new_n74_), .b(x14), .c(new_n34_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n35_), .c(x03), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(z7), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n182_), .O(z6));
endmodule
