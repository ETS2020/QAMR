...
module FAU ( 
  ...
  nand4  g074(.a(new_n107_), .b(new_n94_), .c(new_n36_), .d(new_n69_), .O(new_n108_));
  ...
  nand3  g081(.a(new_n114_), .b(new_n47_), .c(new_n38_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n102_), .c(new_n53_), .O(new_n116_));
  ...
  oai21  g095(.a(new_n128_), .b(new_n66_), .c(new_n53_), .O(z2));
  nand4  g096(.a(new_n53_), .b(x20), .c(x18), .d(x14), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n36_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x08), .c(x06), .d(x03), .O(new_n132_));
  nor2   g099(.a(x02), .b(x01), .O(new_n133_));
  nor2   g100(.a(x06), .b(x03), .O(new_n134_));
  inv1   g101(.a(x07), .O(new_n135_));
  nor2   g102(.a(x08), .b(new_n135_), .O(new_n136_));
  nor3   g103(.a(x20), .b(x14), .c(x11), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n134_), .d(new_n133_), .O(new_n138_));
  oai21  g105(.a(new_n132_), .b(new_n66_), .c(new_n138_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n87_), .c(x24), .O(new_n140_));
  nand4  g107(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n141_));
  nand4  g108(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n142_));
  nand3  g109(.a(new_n107_), .b(new_n34_), .c(new_n66_), .O(new_n143_));
  nand3  g110(.a(new_n112_), .b(new_n70_), .c(new_n36_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  nand3  g112(.a(new_n40_), .b(x13), .c(x05), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n87_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g115(.a(new_n134_), .b(new_n66_), .c(x00), .O(new_n149_));
  nand4  g116(.a(new_n37_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n150_));
  nand4  g117(.a(x21), .b(x20), .c(x14), .d(x11), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n141_), .c(new_n150_), .d(new_n149_), .O(new_n152_));
  ...
  nand3  g122(.a(new_n147_), .b(new_n145_), .c(new_n135_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n155_), .c(new_n140_), .O(z3));
  oai21  g124(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n73_), .c(x09), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x16), .c(new_n68_), .O(new_n160_));
  nand3  g127(.a(new_n147_), .b(new_n53_), .c(x19), .O(new_n161_));
  nand3  g128(.a(new_n87_), .b(x24), .c(x07), .O(new_n162_));
  nand3  g129(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n44_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n161_), .O(z5));
  nand2  g133(.a(z5), .b(new_n160_), .O(new_n167_));
  aoi21  g134(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n73_), .c(x09), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x16), .c(new_n68_), .O(new_n170_));
  nand2  g137(.a(x07), .b(new_n44_), .O(new_n171_));
  oai21  g138(.a(new_n170_), .b(x07), .c(new_n171_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n87_), .c(x24), .d(x18), .O(new_n173_));
  inv1   g140(.a(new_n170_), .O(new_n174_));
  nand3  g141(.a(new_n147_), .b(new_n53_), .c(x15), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n124_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n173_), .c(new_n167_), .O(z4));
  aoi21  g145(.a(x20), .b(new_n70_), .c(x06), .O(new_n179_));
  ...
  nand2  g150(.a(new_n183_), .b(new_n135_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n171_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n87_), .c(x24), .d(x18), .O(new_n186_));
  nand2  g153(.a(new_n183_), .b(new_n176_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n186_), .c(new_n181_), .O(z6));
  nand2  g155(.a(x07), .b(x02), .O(new_n189_));
  nand4  g156(.a(new_n189_), .b(new_n87_), .c(x24), .d(x18), .O(new_n190_));
  nand3  g157(.a(new_n190_), .b(new_n175_), .c(new_n124_), .O(z7));
endmodule
