...
module FAU ( 
  ...
  aoi21  g066(.a(new_n99_), .b(new_n92_), .c(new_n86_), .O(new_n100_));
  nand4  g067(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n101_));
  nand4  g068(.a(x23), .b(x22), .c(x20), .d(x17), .O(new_n102_));
  ...
  aoi22  g078(.a(new_n111_), .b(new_n45_), .c(new_n100_), .d(x24), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n85_), .O(z1));
  inv1   g080(.a(x18), .O(new_n114_));
  nand3  g081(.a(new_n38_), .b(x15), .c(x13), .O(new_n115_));
  oai21  g082(.a(new_n38_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g086(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n120_));
  ...
  aoi21  g093(.a(new_n126_), .b(x20), .c(new_n36_), .O(z2));
  nand4  g094(.a(new_n56_), .b(x14), .c(x11), .d(x08), .O(new_n128_));
  nor4   g095(.a(new_n128_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n129_));
  nand4  g096(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n66_), .O(new_n130_));
  nor4   g097(.a(new_n130_), .b(x06), .c(x03), .d(x01), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n129_), .c(new_n38_), .O(new_n132_));
  inv1   g099(.a(new_n86_), .O(new_n133_));
  nand3  g100(.a(x06), .b(x03), .c(x01), .O(new_n134_));
  nand4  g101(.a(x18), .b(x14), .c(x11), .d(x08), .O(new_n135_));
  nand3  g102(.a(new_n35_), .b(new_n34_), .c(new_n64_), .O(new_n136_));
  nand4  g103(.a(new_n71_), .b(new_n68_), .c(new_n66_), .d(x07), .O(new_n137_));
  ...
  nand4  g106(.a(x15), .b(x14), .c(x11), .d(x08), .O(new_n140_));
  nand4  g107(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n66_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n136_), .c(new_n140_), .d(new_n134_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n46_), .c(new_n45_), .O(new_n143_));
  nor2   g110(.a(x20), .b(new_n36_), .O(new_n144_));
  ...
  nand3  g127(.a(new_n160_), .b(new_n43_), .c(new_n42_), .O(new_n161_));
  ...
  oai21  g134(.a(new_n114_), .b(x03), .c(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n133_), .c(x24), .O(new_n169_));
  nand3  g136(.a(new_n164_), .b(new_n46_), .c(new_n45_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n166_), .c(new_n145_), .O(new_n172_));
  oai21  g139(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n147_), .c(new_n36_), .O(new_n174_));
  nand4  g141(.a(new_n123_), .b(x20), .c(x11), .d(new_n35_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n174_), .c(new_n172_), .O(z6));
  nor2   g143(.a(new_n144_), .b(new_n124_), .O(z7));
endmodule
