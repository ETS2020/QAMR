...
module FAU ( 
  ...
  nand4  g083(.a(new_n116_), .b(new_n41_), .c(x21), .d(new_n55_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n115_), .c(new_n101_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x14), .c(x11), .d(x06), .O(new_n119_));
  nor3   g086(.a(new_n119_), .b(new_n70_), .c(new_n69_), .O(z2));
  ...
  nand3  g090(.a(new_n59_), .b(new_n70_), .c(new_n69_), .O(new_n124_));
  nand2  g091(.a(new_n86_), .b(new_n62_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n92_), .O(new_n127_));
  nand2  g094(.a(new_n122_), .b(new_n96_), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n34_), .c(new_n70_), .d(new_n69_), .O(new_n129_));
  inv1   g096(.a(x08), .O(new_n130_));
  nand4  g097(.a(new_n101_), .b(new_n36_), .c(new_n35_), .d(new_n130_), .O(new_n131_));
  ...
  nand3  g100(.a(new_n57_), .b(new_n34_), .c(new_n70_), .O(new_n134_));
  ...
  nand2  g107(.a(new_n51_), .b(new_n48_), .O(z5));
  oai21  g108(.a(x23), .b(new_n71_), .c(new_n100_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n75_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n130_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(z5), .O(new_n145_));
  nand2  g112(.a(new_n117_), .b(new_n115_), .O(z7));
  oai21  g113(.a(new_n76_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n81_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n102_), .c(x08), .O(new_n149_));
  ...
  nand4  g120(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n46_), .c(new_n44_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n43_), .c(new_n153_), .d(x03), .O(new_n156_));
  nand2  g123(.a(new_n101_), .b(x14), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x06), .c(new_n35_), .O(new_n158_));
  nand3  g125(.a(new_n116_), .b(new_n41_), .c(x21), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n113_), .c(new_n112_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n111_), .c(new_n158_), .d(new_n70_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n38_), .O(z6));
endmodule
