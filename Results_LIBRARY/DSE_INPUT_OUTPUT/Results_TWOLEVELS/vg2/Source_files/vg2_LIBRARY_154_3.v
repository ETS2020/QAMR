...
module FAU ( 
  ...
  inv1   g125(.a(new_n121_), .O(new_n159_));
  ...
  nand3  g129(.a(new_n146_), .b(new_n45_), .c(new_n44_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n123_), .c(new_n122_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n159_), .c(new_n162_), .O(new_n165_));
  nand2  g132(.a(x02), .b(x01), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n165_), .c(new_n158_), .O(z4));
  nand4  g134(.a(new_n166_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n168_));
  or2    g135(.a(new_n168_), .b(new_n42_), .O(z5));
  aoi21  g136(.a(x20), .b(new_n89_), .c(x06), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x11), .c(new_n34_), .O(new_n171_));
  nand2  g138(.a(new_n48_), .b(new_n43_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n42_), .c(new_n166_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n46_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  aoi21  g142(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n36_), .c(x03), .O(new_n177_));
  nand3  g144(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n166_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n163_), .O(z7));
  nand2  g147(.a(z7), .b(new_n177_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n175_), .O(z6));
endmodule
