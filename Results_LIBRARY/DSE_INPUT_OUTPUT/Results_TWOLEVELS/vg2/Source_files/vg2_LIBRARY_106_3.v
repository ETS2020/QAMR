...
module FAU ( 
  ...
  nand4  g041(.a(new_n74_), .b(new_n73_), .c(new_n56_), .d(new_n36_), .O(new_n75_));
  ...
  nor4   g051(.a(new_n84_), .b(new_n83_), .c(new_n34_), .d(new_n65_), .O(new_n85_));
  ...
  nand2  g123(.a(new_n100_), .b(new_n53_), .O(new_n157_));
  nand3  g124(.a(new_n55_), .b(x24), .c(x07), .O(new_n158_));
  nand3  g125(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n44_), .O(new_n161_));
  oai21  g128(.a(new_n157_), .b(new_n95_), .c(new_n161_), .O(z5));
  nand2  g129(.a(z5), .b(new_n156_), .O(new_n163_));
  aoi21  g130(.a(x23), .b(new_n83_), .c(new_n72_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n153_), .c(x09), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x16), .c(new_n126_), .O(new_n166_));
  nand2  g133(.a(x07), .b(new_n44_), .O(new_n167_));
  oai21  g134(.a(new_n166_), .b(x07), .c(new_n167_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n55_), .c(x24), .d(x18), .O(new_n169_));
  inv1   g136(.a(new_n166_), .O(new_n170_));
  inv1   g137(.a(x15), .O(new_n171_));
  oai21  g138(.a(new_n157_), .b(new_n171_), .c(new_n122_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n169_), .c(new_n163_), .O(z4));
  aoi21  g141(.a(x20), .b(new_n73_), .c(x06), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(x11), .c(new_n34_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(z5), .O(new_n177_));
  aoi21  g144(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n36_), .c(x03), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n69_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n167_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n55_), .c(x24), .d(x18), .O(new_n182_));
  nand2  g149(.a(new_n179_), .b(new_n172_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n182_), .c(new_n177_), .O(z6));
  inv1   g151(.a(new_n117_), .O(new_n185_));
  and2   g152(.a(new_n122_), .b(new_n119_), .O(new_n186_));
  nand4  g153(.a(new_n186_), .b(new_n118_), .c(new_n185_), .d(new_n53_), .O(z7));
endmodule
