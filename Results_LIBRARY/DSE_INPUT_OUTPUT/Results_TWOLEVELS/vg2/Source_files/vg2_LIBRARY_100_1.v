...
module FAU ( 
  ...
  oai21  g118(.a(new_n115_), .b(new_n111_), .c(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n147_), .c(new_n119_), .O(z4));
  nand4  g120(.a(new_n145_), .b(new_n119_), .c(new_n44_), .d(new_n143_), .O(z5));
  ...
  oai21  g124(.a(new_n157_), .b(new_n43_), .c(new_n119_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n144_), .O(new_n159_));
  ...
  nand2  g131(.a(new_n164_), .b(new_n114_), .O(new_n165_));
