...
module FAU ( 
  ...
  nand3  g109(.a(new_n142_), .b(new_n51_), .c(x00), .O(new_n143_));
  ...
  or2    g113(.a(new_n113_), .b(new_n108_), .O(new_n147_));
  ...
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n146_), .O(z4));
  oai21  g121(.a(new_n46_), .b(new_n42_), .c(new_n153_), .O(new_n155_));
  nand4  g122(.a(new_n142_), .b(new_n51_), .c(x01), .d(x00), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(z5));
  nand2  g124(.a(x20), .b(new_n97_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n35_), .c(x11), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n145_), .O(new_n160_));
  nand2  g127(.a(new_n37_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n36_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n34_), .c(new_n147_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n153_), .O(z6));
  nand2  g131(.a(new_n110_), .b(new_n109_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n108_), .c(new_n153_), .O(new_n166_));
  nand3  g133(.a(new_n130_), .b(new_n133_), .c(new_n111_), .O(new_n167_));
