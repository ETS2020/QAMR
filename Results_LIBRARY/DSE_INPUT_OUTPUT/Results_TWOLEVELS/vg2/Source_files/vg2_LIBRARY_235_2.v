...
module FAU ( 
  ...
  nor2   g122(.a(x24), .b(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n37_), .c(new_n34_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n158_));
  nor2   g125(.a(x02), .b(new_n35_), .O(new_n159_));
  aoi21  g126(.a(new_n158_), .b(new_n154_), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n150_), .O(z4));
  inv1   g128(.a(new_n159_), .O(new_n162_));
  oai21  g129(.a(new_n56_), .b(new_n52_), .c(new_n162_), .O(new_n163_));
  nand3  g130(.a(new_n146_), .b(new_n136_), .c(new_n34_), .O(new_n164_));
  ...
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n149_), .O(new_n168_));
  nand2  g135(.a(new_n43_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n41_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n48_), .c(new_n158_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n162_), .O(z6));
  nand2  g139(.a(new_n162_), .b(new_n115_), .O(new_n173_));
  nand4  g140(.a(new_n156_), .b(new_n37_), .c(new_n34_), .d(new_n35_), .O(new_n174_));
