...
module FAU ( 
  ...
  aoi21  g075(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(new_n109_));
  nand3  g076(.a(x24), .b(x18), .c(x13), .O(new_n110_));
  nand3  g077(.a(x15), .b(new_n78_), .c(new_n44_), .O(new_n111_));
  nand4  g078(.a(new_n40_), .b(x21), .c(new_n99_), .d(new_n96_), .O(new_n112_));
  ...
  nand4  g084(.a(new_n99_), .b(x08), .c(x06), .d(x03), .O(new_n118_));
  nor2   g085(.a(x24), .b(new_n102_), .O(new_n119_));
  ...
  nand3  g090(.a(new_n58_), .b(x03), .c(x01), .O(new_n124_));
  nand3  g091(.a(new_n120_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n70_), .b(new_n34_), .c(new_n66_), .O(new_n126_));
  ...
  nand2  g095(.a(new_n128_), .b(new_n81_), .O(new_n129_));
  nand3  g096(.a(new_n120_), .b(x20), .c(x18), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n131_));
  nand4  g098(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n132_));
  ...
  oai21  g104(.a(x23), .b(new_n67_), .c(new_n137_), .O(new_n138_));
  ...
  nand4  g110(.a(new_n143_), .b(new_n96_), .c(x01), .d(x00), .O(new_n144_));
  ...
  nand2  g118(.a(new_n111_), .b(new_n110_), .O(new_n152_));
  nor2   g119(.a(new_n152_), .b(new_n109_), .O(new_n153_));
  nand2  g120(.a(new_n119_), .b(new_n99_), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n96_), .c(x01), .O(new_n156_));
  oai21  g123(.a(new_n153_), .b(new_n142_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n151_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n146_), .O(z4));
  aoi21  g126(.a(new_n143_), .b(x00), .c(new_n66_), .O(new_n160_));
  ...
  nand2  g130(.a(new_n163_), .b(new_n145_), .O(new_n164_));
  ...
  oai21  g135(.a(new_n155_), .b(new_n66_), .c(new_n96_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n153_), .O(z7));
endmodule
