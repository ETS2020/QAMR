...
module FAU ( 
  ...
  nand2  g004(.a(new_n37_), .b(x15), .O(new_n38_));
  ...
  nand2  g065(.a(x24), .b(x13), .O(new_n99_));
  inv1   g066(.a(x15), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(x24), .c(x05), .O(new_n102_));
  nand3  g069(.a(x15), .b(new_n48_), .c(new_n39_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n102_), .c(new_n99_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(x23), .c(x22), .d(x20), .O(new_n105_));
  nor2   g072(.a(new_n105_), .b(new_n37_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(x17), .c(x16), .d(x14), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  ...
  nor2   g079(.a(new_n41_), .b(new_n37_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n101_), .c(x05), .O(new_n114_));
  nand2  g081(.a(new_n113_), .b(x13), .O(new_n115_));
  nand4  g082(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n116_));
  ...
  nand4  g088(.a(new_n67_), .b(new_n62_), .c(new_n59_), .d(new_n36_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(x08), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n124_));
  nand3  g091(.a(x21), .b(x20), .c(x14), .O(new_n125_));
  nor3   g092(.a(new_n125_), .b(new_n36_), .c(x10), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n77_), .c(new_n75_), .d(x03), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n124_), .c(x24), .O(new_n128_));
  nand4  g095(.a(new_n89_), .b(new_n62_), .c(new_n59_), .d(new_n36_), .O(new_n129_));
  inv1   g096(.a(new_n129_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n57_), .c(new_n35_), .d(new_n34_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(x01), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n128_), .c(new_n38_), .O(new_n133_));
  nand4  g100(.a(new_n104_), .b(x20), .c(x18), .d(x14), .O(new_n134_));
  nor3   g101(.a(new_n134_), .b(new_n36_), .c(new_n57_), .O(new_n135_));
  ...
  aoi21  g108(.a(new_n141_), .b(x09), .c(new_n60_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(new_n57_), .O(new_n143_));
  aoi21  g110(.a(new_n64_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n58_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n60_), .c(x08), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n138_), .c(new_n143_), .d(new_n139_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n38_), .c(new_n46_), .d(new_n45_), .O(new_n148_));
  or2    g115(.a(new_n146_), .b(x15), .O(new_n149_));
  nand2  g116(.a(x18), .b(x15), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(x19), .c(x13), .d(x05), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n41_), .O(new_n154_));
  nor2   g121(.a(x13), .b(x05), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  nand2  g123(.a(x08), .b(new_n87_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n142_), .c(x18), .O(new_n158_));
  oai21  g125(.a(new_n149_), .b(new_n87_), .c(new_n158_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n156_), .c(x24), .O(new_n160_));
  nor2   g127(.a(new_n48_), .b(new_n39_), .O(new_n161_));
  nor2   g128(.a(new_n161_), .b(new_n155_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n143_), .c(new_n49_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(x18), .c(x15), .O(new_n164_));
  inv1   g131(.a(x19), .O(new_n165_));
  nor2   g132(.a(new_n146_), .b(new_n165_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n100_), .c(new_n48_), .d(new_n39_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n164_), .c(new_n160_), .d(new_n154_), .O(z4));
  inv1   g135(.a(new_n43_), .O(new_n169_));
  and2   g136(.a(new_n47_), .b(new_n44_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n49_), .c(new_n169_), .d(new_n38_), .O(z5));
  nand2  g138(.a(new_n62_), .b(x14), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n36_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n34_), .O(new_n174_));
  ...
  oai22  g144(.a(new_n177_), .b(new_n138_), .c(new_n174_), .d(new_n139_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n38_), .c(new_n46_), .d(new_n45_), .O(new_n179_));
  nand2  g146(.a(new_n176_), .b(new_n100_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n150_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(x19), .c(x13), .d(x05), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n179_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n41_), .O(new_n184_));
  nand2  g151(.a(new_n87_), .b(x03), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n173_), .c(x18), .O(new_n186_));
  oai21  g153(.a(new_n180_), .b(new_n87_), .c(new_n186_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n156_), .c(x24), .O(new_n188_));
  oai21  g155(.a(new_n174_), .b(new_n162_), .c(new_n49_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(x18), .c(x15), .O(new_n190_));
  nor2   g157(.a(new_n177_), .b(new_n165_), .O(new_n191_));
  nand4  g158(.a(new_n191_), .b(new_n100_), .c(new_n48_), .d(new_n39_), .O(new_n192_));
  nand4  g159(.a(new_n192_), .b(new_n190_), .c(new_n188_), .d(new_n184_), .O(z6));
  oai21  g160(.a(new_n155_), .b(new_n37_), .c(x15), .O(new_n194_));
  nand4  g161(.a(new_n194_), .b(new_n116_), .c(new_n115_), .d(new_n114_), .O(z7));
endmodule
