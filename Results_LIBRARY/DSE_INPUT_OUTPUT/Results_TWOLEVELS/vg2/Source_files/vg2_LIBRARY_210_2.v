...
module FAU ( 
  ...
  nor2   g060(.a(new_n37_), .b(new_n53_), .O(new_n94_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n97_), .c(new_n70_), .d(new_n69_), .O(new_n100_));
  nand4  g067(.a(new_n72_), .b(new_n71_), .c(new_n56_), .d(new_n36_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nor2   g069(.a(x23), .b(x22), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n37_), .d(new_n73_), .O(new_n104_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n97_), .c(new_n36_), .d(new_n70_), .O(new_n112_));
  ...
  nand3  g089(.a(new_n40_), .b(x13), .c(x05), .O(new_n123_));
  and2   g090(.a(new_n123_), .b(new_n89_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(x02), .O(new_n125_));
  nand2  g092(.a(x13), .b(x05), .O(new_n126_));
  and2   g093(.a(new_n126_), .b(new_n89_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n125_), .c(x15), .O(new_n129_));
  nor2   g096(.a(new_n88_), .b(new_n40_), .O(new_n130_));
  nand4  g097(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n131_));
  inv1   g098(.a(new_n131_), .O(new_n132_));
  aoi21  g099(.a(new_n130_), .b(x18), .c(new_n132_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n129_), .c(new_n37_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(x14), .c(x11), .d(x06), .O(new_n135_));
  nor3   g102(.a(new_n135_), .b(new_n34_), .c(new_n67_), .O(z2));
  nand4  g103(.a(new_n59_), .b(x20), .c(x14), .d(x11), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n69_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  nand4  g106(.a(new_n78_), .b(new_n37_), .c(new_n71_), .d(new_n36_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(x08), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n142_));
  ...
  nand3  g113(.a(new_n99_), .b(new_n34_), .c(new_n67_), .O(new_n147_));
  nand4  g114(.a(new_n37_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n148_));
  ...
  nand3  g118(.a(new_n111_), .b(new_n34_), .c(new_n67_), .O(new_n152_));
  nand3  g119(.a(new_n116_), .b(new_n71_), .c(new_n36_), .O(new_n153_));
  ...
  oai21  g123(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n74_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n69_), .O(new_n159_));
  inv1   g126(.a(new_n124_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n54_), .c(x19), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n130_), .b(x07), .O(new_n163_));
  nand3  g130(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n163_), .c(x02), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n162_), .c(new_n159_), .O(new_n166_));
  aoi21  g133(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n74_), .c(x09), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x16), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(x08), .c(new_n98_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n89_), .c(x24), .O(new_n171_));
  inv1   g138(.a(new_n127_), .O(new_n172_));
  nand2  g139(.a(new_n169_), .b(x08), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n172_), .c(x15), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x18), .O(new_n176_));
  inv1   g143(.a(x15), .O(new_n177_));
  nand3  g144(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n178_));
  oai21  g145(.a(new_n124_), .b(new_n177_), .c(new_n178_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n173_), .c(new_n44_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n176_), .c(new_n166_), .O(z4));
  nand2  g148(.a(new_n48_), .b(new_n43_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n42_), .c(new_n54_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n46_), .O(z5));
  nand2  g151(.a(x20), .b(new_n71_), .O(new_n185_));
  aoi21  g152(.a(new_n185_), .b(new_n35_), .c(x11), .O(new_n186_));
  oai22  g153(.a(new_n186_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n187_));
  nand2  g154(.a(new_n37_), .b(x14), .O(new_n188_));
  aoi21  g155(.a(new_n188_), .b(x06), .c(new_n36_), .O(new_n189_));
  nor2   g156(.a(new_n40_), .b(new_n53_), .O(new_n190_));
  inv1   g157(.a(new_n190_), .O(new_n191_));
  nand3  g158(.a(new_n40_), .b(x15), .c(x13), .O(new_n192_));
  aoi21  g159(.a(new_n192_), .b(new_n191_), .c(new_n38_), .O(new_n193_));
  nand2  g160(.a(new_n190_), .b(x13), .O(new_n194_));
  nand3  g161(.a(x15), .b(new_n47_), .c(new_n38_), .O(new_n195_));
  nand3  g162(.a(new_n195_), .b(new_n194_), .c(new_n131_), .O(new_n196_));
  oai22  g163(.a(new_n196_), .b(new_n193_), .c(new_n189_), .d(new_n34_), .O(new_n197_));
  nand3  g164(.a(new_n197_), .b(new_n187_), .c(new_n54_), .O(z6));
  inv1   g165(.a(new_n193_), .O(new_n199_));
  and2   g166(.a(new_n195_), .b(new_n194_), .O(new_n200_));
  nand4  g167(.a(new_n200_), .b(new_n199_), .c(new_n131_), .d(new_n54_), .O(z7));
endmodule
