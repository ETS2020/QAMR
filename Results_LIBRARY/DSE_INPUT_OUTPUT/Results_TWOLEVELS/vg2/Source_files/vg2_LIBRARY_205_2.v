...
module FAU ( 
  ...
  nor2   g019(.a(x16), .b(new_n52_), .O(new_n53_));
  ...
  nand4  g051(.a(new_n84_), .b(new_n52_), .c(new_n34_), .d(new_n67_), .O(new_n85_));
  ...
  nor4   g055(.a(new_n88_), .b(new_n52_), .c(new_n34_), .d(new_n67_), .O(new_n89_));
  ...
  nand4  g064(.a(new_n71_), .b(new_n70_), .c(new_n56_), .d(new_n36_), .O(new_n98_));
  nand4  g065(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n72_), .O(new_n99_));
  ...
  nand4  g073(.a(new_n36_), .b(new_n69_), .c(new_n68_), .d(new_n35_), .O(new_n107_));
  inv1   g074(.a(new_n107_), .O(new_n108_));
  nand4  g075(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n56_), .O(new_n109_));
  nand4  g076(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(x19), .O(new_n110_));
  ...
  nor2   g090(.a(new_n123_), .b(new_n53_), .O(z7));
  nand2  g091(.a(z7), .b(x20), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n70_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n67_), .O(z2));
  ...
  nand4  g098(.a(new_n78_), .b(new_n73_), .c(new_n70_), .d(new_n36_), .O(new_n132_));
  ...
  nand4  g111(.a(new_n68_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n145_));
  nand4  g112(.a(new_n73_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n146_));
  ...
  and2   g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n136_), .c(new_n53_), .O(z3));
  inv1   g117(.a(new_n49_), .O(new_n151_));
  nand2  g118(.a(new_n74_), .b(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n69_), .c(x16), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x08), .c(new_n151_), .O(new_n154_));
  inv1   g121(.a(new_n123_), .O(new_n155_));
  oai21  g122(.a(new_n75_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n69_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n71_), .c(x08), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n155_), .c(new_n53_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n154_), .O(z4));
  ...
  nand2  g130(.a(x20), .b(new_n70_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n151_), .O(new_n166_));
  nand2  g133(.a(new_n73_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n36_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n34_), .c(new_n155_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n54_), .O(z6));
endmodule
