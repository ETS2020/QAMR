...
module FAU ( 
  ...
  nand3  g078(.a(new_n111_), .b(new_n73_), .c(new_n72_), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n108_), .c(new_n95_), .O(new_n114_));
  ...
  nor2   g084(.a(new_n39_), .b(new_n91_), .O(new_n118_));
  ...
  nor2   g105(.a(new_n34_), .b(new_n64_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n71_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n143_));
  ...
  nand4  g112(.a(new_n66_), .b(new_n35_), .c(new_n37_), .d(new_n64_), .O(new_n146_));
  nand4  g113(.a(new_n111_), .b(new_n68_), .c(new_n46_), .d(new_n36_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n146_), .c(new_n53_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n34_), .O(new_n149_));
  nand3  g116(.a(x20), .b(x15), .c(x14), .O(new_n150_));
  nor3   g117(.a(new_n150_), .b(x13), .c(new_n36_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n139_), .c(new_n86_), .d(new_n37_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n149_), .c(new_n145_), .d(new_n137_), .O(z3));
  nor2   g120(.a(new_n53_), .b(x03), .O(new_n154_));
  inv1   g121(.a(new_n49_), .O(new_n155_));
  oai21  g122(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n156_));
  ...
  inv1   g126(.a(new_n126_), .O(new_n160_));
  oai21  g127(.a(new_n73_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n67_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n69_), .c(x08), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n159_), .c(new_n154_), .O(z4));
  inv1   g132(.a(new_n41_), .O(new_n166_));
  inv1   g133(.a(new_n154_), .O(new_n167_));
  and2   g134(.a(new_n45_), .b(new_n42_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n167_), .c(new_n47_), .d(new_n166_), .O(z5));
  nand2  g136(.a(x20), .b(new_n68_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n35_), .c(x11), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x03), .c(new_n155_), .O(new_n172_));
  nand2  g139(.a(new_n71_), .b(x14), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x06), .c(new_n36_), .O(new_n174_));
  nor2   g141(.a(x12), .b(x03), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n174_), .c(new_n160_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n172_), .c(new_n167_), .O(z6));
  aoi21  g144(.a(x12), .b(new_n34_), .c(new_n126_), .O(z7));
endmodule
