...
module FAU ( 
  ...
  inv1   g114(.a(new_n108_), .O(new_n148_));
  and2   g115(.a(new_n113_), .b(new_n110_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n109_), .c(new_n148_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n144_), .c(new_n38_), .O(z4));
  nand2  g119(.a(new_n51_), .b(new_n48_), .O(z5));
  nand2  g120(.a(x20), .b(new_n36_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n34_), .c(x11), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x03), .c(new_n143_), .O(new_n156_));
  nand2  g123(.a(new_n61_), .b(x14), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x06), .c(new_n35_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n69_), .c(new_n150_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n156_), .c(new_n38_), .O(z6));
  nand4  g127(.a(new_n149_), .b(new_n109_), .c(new_n148_), .d(new_n38_), .O(z7));
endmodule
