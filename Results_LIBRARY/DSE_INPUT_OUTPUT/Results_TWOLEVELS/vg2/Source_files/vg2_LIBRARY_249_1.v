...
module FAU ( 
  ...
  nand2  g020(.a(x02), .b(new_n53_), .O(new_n54_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n65_), .d(new_n58_), .O(new_n86_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n84_), .c(new_n65_), .d(new_n58_), .O(new_n96_));
  ...
  nand3  g068(.a(new_n101_), .b(new_n94_), .c(new_n82_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n44_), .O(new_n103_));
  nand2  g070(.a(new_n94_), .b(new_n82_), .O(new_n104_));
  nand2  g071(.a(new_n104_), .b(x00), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n103_), .O(z1));
  ...
  nor2   g083(.a(new_n116_), .b(new_n108_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x11), .c(x06), .d(x03), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n107_), .c(new_n54_), .O(z2));
  inv1   g086(.a(x08), .O(new_n120_));
  nand3  g087(.a(x15), .b(x13), .c(x05), .O(new_n121_));
  nand3  g088(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n122_));
  ...
  nand3  g093(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n127_));
  nand3  g094(.a(x19), .b(x13), .c(x05), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n37_), .c(new_n108_), .d(new_n36_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n107_), .O(new_n132_));
  ...
  nand3  g102(.a(new_n85_), .b(x14), .c(x11), .O(new_n136_));
  nand3  g103(.a(new_n97_), .b(x07), .c(new_n35_), .O(new_n137_));
  nand4  g104(.a(new_n37_), .b(new_n108_), .c(new_n36_), .d(new_n120_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n79_), .c(x24), .O(new_n140_));
  nand4  g107(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n141_));
  nand2  g108(.a(new_n97_), .b(new_n69_), .O(new_n142_));
  nand3  g109(.a(new_n74_), .b(new_n108_), .c(new_n36_), .O(new_n143_));
  ...
  nand3  g112(.a(new_n145_), .b(new_n140_), .c(new_n54_), .O(new_n146_));
  inv1   g113(.a(new_n146_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n134_), .O(z3));
  inv1   g115(.a(x04), .O(new_n149_));
  oai21  g116(.a(x23), .b(new_n149_), .c(new_n61_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n63_), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n120_), .O(new_n152_));
  oai21  g119(.a(new_n49_), .b(new_n42_), .c(new_n152_), .O(new_n153_));
  inv1   g120(.a(x16), .O(new_n154_));
  oai21  g121(.a(new_n64_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n67_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n154_), .c(x08), .O(new_n157_));
  oai21  g124(.a(new_n115_), .b(new_n111_), .c(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n54_), .O(z4));
  nand2  g126(.a(new_n48_), .b(new_n43_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n42_), .c(new_n54_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n46_), .O(z5));
  aoi21  g129(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n36_), .c(x03), .O(new_n164_));
  nand2  g131(.a(new_n113_), .b(new_n112_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n111_), .c(new_n54_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n114_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  aoi21  g135(.a(x20), .b(new_n108_), .c(x06), .O(new_n169_));
  ...
  nand4  g139(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n54_), .O(new_n173_));
  or2    g140(.a(new_n173_), .b(new_n111_), .O(z7));
endmodule
