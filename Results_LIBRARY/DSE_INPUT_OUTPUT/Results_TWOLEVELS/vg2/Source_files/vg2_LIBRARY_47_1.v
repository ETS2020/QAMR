...
module FAU ( 
  ...
  nor2   g031(.a(new_n43_), .b(new_n64_), .O(new_n65_));
  ...
  nand3  g049(.a(new_n35_), .b(x13), .c(x05), .O(new_n83_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n68_), .d(new_n61_), .O(new_n89_));
  nor2   g056(.a(x09), .b(x08), .O(new_n90_));
  nand3  g057(.a(new_n90_), .b(x07), .c(new_n38_), .O(new_n91_));
  ...
  nand3  g063(.a(new_n78_), .b(new_n43_), .c(new_n64_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n96_), .c(new_n92_), .d(new_n71_), .O(new_n99_));
  aoi21  g066(.a(new_n99_), .b(new_n89_), .c(new_n81_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n34_), .c(x24), .O(new_n101_));
  nand2  g068(.a(new_n98_), .b(new_n96_), .O(new_n102_));
  inv1   g069(.a(x21), .O(new_n103_));
  nor2   g070(.a(new_n103_), .b(new_n43_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n87_), .c(new_n68_), .d(new_n61_), .O(new_n105_));
  nor2   g072(.a(x03), .b(x01), .O(new_n106_));
  nor2   g073(.a(x06), .b(x04), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n106_), .c(new_n90_), .d(x00), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n102_), .c(new_n105_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n40_), .c(new_n34_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n101_), .c(new_n85_), .O(z1));
  nand3  g078(.a(x24), .b(x18), .c(x02), .O(new_n112_));
  ...
  nand2  g085(.a(new_n118_), .b(x02), .O(new_n119_));
  nand3  g086(.a(x21), .b(new_n40_), .c(new_n34_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n35_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n119_), .c(new_n115_), .O(new_n123_));
  ...
  inv1   g093(.a(new_n126_), .O(z2));
  nand4  g094(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n128_));
  nor2   g095(.a(new_n42_), .b(new_n41_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(x20), .c(x15), .O(new_n130_));
  nand2  g097(.a(new_n106_), .b(new_n72_), .O(new_n131_));
  nand3  g098(.a(new_n77_), .b(new_n42_), .c(new_n41_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n128_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n84_), .O(new_n134_));
  inv1   g101(.a(new_n128_), .O(new_n135_));
  nand3  g102(.a(new_n129_), .b(new_n135_), .c(new_n88_), .O(new_n136_));
  inv1   g103(.a(x08), .O(new_n137_));
  nand4  g104(.a(new_n43_), .b(new_n42_), .c(new_n41_), .d(new_n137_), .O(new_n138_));
  inv1   g105(.a(new_n138_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n106_), .c(x07), .d(new_n38_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n136_), .c(new_n81_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n34_), .c(x24), .O(new_n142_));
  nand3  g109(.a(new_n129_), .b(new_n135_), .c(new_n104_), .O(new_n143_));
  oai21  g110(.a(new_n138_), .b(new_n39_), .c(new_n143_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n40_), .c(new_n34_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n142_), .c(new_n134_), .O(z3));
  inv1   g113(.a(x04), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n147_), .c(new_n64_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n66_), .c(x09), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n137_), .O(new_n150_));
  oai21  g117(.a(new_n48_), .b(new_n34_), .c(new_n49_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x05), .O(new_n152_));
  nand2  g119(.a(new_n54_), .b(x02), .O(new_n153_));
  nand3  g120(.a(new_n40_), .b(new_n34_), .c(x00), .O(new_n154_));
  and2   g121(.a(new_n154_), .b(new_n53_), .O(new_n155_));
  or2    g122(.a(new_n155_), .b(x24), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n153_), .c(new_n152_), .O(z5));
  nand2  g124(.a(z5), .b(new_n150_), .O(new_n158_));
  oai21  g125(.a(new_n67_), .b(x04), .c(x17), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x22), .c(new_n70_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n94_), .c(x08), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n123_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n158_), .O(z4));
  nand2  g130(.a(x20), .b(new_n42_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n38_), .c(x11), .O(new_n165_));
  nand2  g132(.a(new_n155_), .b(new_n51_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n50_), .c(new_n165_), .d(x03), .O(new_n167_));
  nand2  g134(.a(new_n43_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n41_), .O(new_n169_));
  nand2  g136(.a(x24), .b(x18), .O(new_n170_));
  aoi21  g137(.a(new_n113_), .b(new_n170_), .c(new_n47_), .O(new_n171_));
  nand3  g138(.a(new_n120_), .b(new_n117_), .c(new_n116_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n171_), .c(new_n169_), .d(new_n37_), .O(new_n173_));
  nand2  g140(.a(x24), .b(new_n34_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n173_), .c(new_n167_), .O(z6));
  aoi21  g142(.a(x21), .b(new_n40_), .c(x24), .O(new_n176_));
  nor2   g143(.a(new_n171_), .b(new_n118_), .O(new_n177_));
  oai21  g144(.a(new_n176_), .b(x02), .c(new_n177_), .O(z7));
endmodule
