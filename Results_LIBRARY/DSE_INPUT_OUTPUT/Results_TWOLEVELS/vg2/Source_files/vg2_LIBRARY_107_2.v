...
module FAU ( 
  ...
  nand4  g050(.a(new_n83_), .b(new_n37_), .c(new_n70_), .d(new_n69_), .O(new_n84_));
  ...
  nand4  g064(.a(new_n70_), .b(new_n69_), .c(x07), .d(new_n34_), .O(new_n98_));
  ...
  nand4  g075(.a(new_n37_), .b(new_n70_), .c(new_n69_), .d(new_n34_), .O(new_n109_));
  ...
  aoi21  g095(.a(new_n128_), .b(x20), .c(new_n34_), .O(z2));
  ...
  nand4  g099(.a(new_n79_), .b(new_n74_), .c(new_n71_), .d(new_n37_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n34_), .c(new_n36_), .d(new_n35_), .O(new_n135_));
  ...
  nand4  g107(.a(x07), .b(new_n34_), .c(new_n36_), .d(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n74_), .b(new_n71_), .c(new_n37_), .d(new_n69_), .O(new_n142_));
  ...
  nand4  g112(.a(new_n69_), .b(new_n34_), .c(new_n36_), .d(new_n35_), .O(new_n146_));
  nand4  g113(.a(new_n74_), .b(x19), .c(new_n71_), .d(new_n37_), .O(new_n147_));
  ...
  nor2   g117(.a(x20), .b(new_n34_), .O(new_n151_));
  ...
  oai21  g130(.a(new_n37_), .b(x06), .c(x03), .O(new_n164_));
