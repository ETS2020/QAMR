...
module FAU ( 
  ...
  nand3  g107(.a(new_n140_), .b(new_n107_), .c(new_n106_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n105_), .c(new_n139_), .O(new_n142_));
  nand2  g109(.a(x11), .b(new_n44_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n142_), .c(new_n135_), .O(z4));
  nand3  g111(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n36_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n44_), .O(new_n147_));
  ...
  nand4  g122(.a(x19), .b(x13), .c(new_n36_), .d(x05), .O(new_n156_));
  ...
  nand3  g126(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n34_), .O(new_n162_));
  oai21  g129(.a(x20), .b(new_n62_), .c(x06), .O(new_n163_));
  and2   g130(.a(new_n163_), .b(x15), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(x13), .c(x11), .d(x05), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n162_), .c(new_n158_), .d(new_n154_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n40_), .O(new_n167_));
  inv1   g134(.a(x18), .O(new_n168_));
  aoi21  g135(.a(new_n163_), .b(x11), .c(new_n34_), .O(new_n169_));
  aoi21  g136(.a(new_n155_), .b(new_n36_), .c(x03), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n94_), .c(new_n169_), .d(new_n168_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n85_), .c(x24), .O(new_n172_));
  inv1   g139(.a(x15), .O(new_n173_));
  inv1   g140(.a(x19), .O(new_n174_));
  oai22  g141(.a(new_n170_), .b(new_n174_), .c(new_n169_), .d(new_n173_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n47_), .c(new_n38_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n172_), .c(new_n167_), .d(new_n143_), .O(z6));
  nor2   g144(.a(new_n108_), .b(new_n105_), .O(new_n178_));
  nand3  g145(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n36_), .O(new_n180_));
