...
module FAU ( 
  ...
  nand2  g123(.a(new_n52_), .b(new_n49_), .O(new_n157_));
  oai21  g124(.a(x23), .b(new_n59_), .c(new_n68_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n72_), .c(x09), .O(new_n159_));
  ...
  oai21  g130(.a(new_n163_), .b(new_n66_), .c(x08), .O(new_n164_));
  inv1   g131(.a(new_n39_), .O(new_n165_));
  nor2   g132(.a(x10), .b(x02), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n113_), .c(x12), .O(new_n167_));
  oai21  g134(.a(new_n123_), .b(new_n165_), .c(new_n167_), .O(new_n168_));
  ...
  nand2  g147(.a(new_n69_), .b(x14), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(x06), .c(new_n35_), .O(new_n182_));
  nand2  g149(.a(new_n166_), .b(new_n113_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n121_), .c(new_n120_), .O(new_n184_));
  oai22  g151(.a(new_n184_), .b(new_n119_), .c(new_n182_), .d(new_n57_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n180_), .c(new_n39_), .O(z6));
  aoi21  g153(.a(new_n113_), .b(new_n50_), .c(new_n38_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(x02), .c(new_n123_), .O(z7));
endmodule
