...
module FAU ( 
  ...
  nand4  g059(.a(new_n92_), .b(new_n40_), .c(new_n35_), .d(new_n47_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n79_), .c(new_n41_), .d(new_n65_), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(new_n91_), .c(new_n89_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n82_), .c(x24), .O(new_n97_));
  nand4  g064(.a(new_n37_), .b(new_n34_), .c(new_n36_), .d(x00), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  inv1   g066(.a(x08), .O(new_n100_));
  inv1   g067(.a(x10), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n71_), .c(new_n100_), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(x06), .c(x04), .O(new_n103_));
  nand3  g070(.a(new_n42_), .b(new_n68_), .c(new_n67_), .O(new_n104_));
  nor3   g071(.a(new_n104_), .b(x20), .c(x17), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n103_), .c(new_n99_), .d(new_n94_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n97_), .c(new_n85_), .O(z1));
  nand4  g074(.a(new_n101_), .b(x06), .c(x03), .d(x01), .O(new_n108_));
  nor2   g075(.a(new_n40_), .b(new_n47_), .O(new_n109_));
  inv1   g076(.a(x21), .O(new_n110_));
  nor2   g077(.a(x24), .b(new_n110_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n109_), .c(x20), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n108_), .c(new_n35_), .O(new_n113_));
  ...
  nand2  g105(.a(new_n109_), .b(new_n88_), .O(new_n139_));
  nand4  g106(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n140_));
  nand4  g107(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n100_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n82_), .c(x24), .O(new_n143_));
  nand3  g110(.a(new_n109_), .b(x20), .c(x15), .O(new_n144_));
  nand3  g111(.a(new_n73_), .b(new_n37_), .c(new_n36_), .O(new_n145_));
  nand3  g112(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n146_));
  ...
  nand2  g117(.a(new_n147_), .b(new_n84_), .O(new_n151_));
  ...
  oai21  g122(.a(x23), .b(new_n155_), .c(new_n65_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n67_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n100_), .O(new_n158_));
  inv1   g125(.a(x00), .O(new_n159_));
  nor2   g126(.a(x02), .b(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n42_), .c(new_n101_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n54_), .c(new_n52_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n51_), .c(new_n158_), .O(new_n163_));
  oai21  g130(.a(new_n68_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n71_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n92_), .c(x08), .O(new_n166_));
  nor2   g133(.a(x10), .b(x02), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n111_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n119_), .c(new_n118_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n117_), .c(new_n166_), .O(new_n170_));
  nor2   g137(.a(new_n35_), .b(x02), .O(new_n171_));
  inv1   g138(.a(new_n171_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n170_), .c(new_n163_), .O(z4));
  nand3  g140(.a(new_n42_), .b(new_n101_), .c(x00), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n35_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n34_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n56_), .O(z5));
  aoi21  g144(.a(x20), .b(new_n40_), .c(x06), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x11), .c(new_n37_), .O(new_n179_));
  nand4  g146(.a(new_n160_), .b(new_n42_), .c(new_n35_), .d(new_n101_), .O(new_n180_));
  oai21  g147(.a(new_n171_), .b(new_n56_), .c(new_n180_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  aoi21  g149(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n47_), .c(x03), .O(new_n184_));
  nand3  g151(.a(new_n167_), .b(new_n111_), .c(new_n35_), .O(new_n185_));
  oai21  g152(.a(new_n171_), .b(new_n121_), .c(new_n185_), .O(z7));
  nand2  g153(.a(z7), .b(new_n184_), .O(new_n187_));
