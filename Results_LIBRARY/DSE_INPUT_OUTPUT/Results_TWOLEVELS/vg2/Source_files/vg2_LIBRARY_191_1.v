...
module FAU ( 
  ...
  nand2  g067(.a(new_n100_), .b(new_n62_), .O(new_n101_));
  ...
  nand2  g095(.a(new_n102_), .b(new_n73_), .O(new_n129_));
  nand3  g096(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n84_), .O(new_n132_));
  nand2  g099(.a(new_n111_), .b(new_n88_), .O(new_n133_));
  nand3  g100(.a(new_n102_), .b(x07), .c(new_n38_), .O(new_n134_));
  inv1   g101(.a(x08), .O(new_n135_));
  nand4  g102(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n135_), .O(new_n136_));
  ...
  oai22  g106(.a(new_n139_), .b(new_n127_), .c(new_n136_), .d(new_n39_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n42_), .c(new_n98_), .O(new_n141_));
  ...
  oai21  g112(.a(x23), .b(new_n145_), .c(new_n65_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n67_), .c(x09), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n135_), .O(new_n148_));
  nand4  g115(.a(new_n42_), .b(new_n98_), .c(new_n34_), .d(x00), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n54_), .c(new_n52_), .O(new_n150_));
  or2    g117(.a(new_n150_), .b(new_n51_), .O(new_n151_));
  ...
  nand3  g123(.a(new_n113_), .b(new_n98_), .c(new_n34_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n121_), .c(new_n120_), .O(new_n158_));
  or2    g125(.a(new_n158_), .b(new_n119_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(x07), .b(new_n34_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n160_), .c(new_n152_), .O(z4));
  nor2   g129(.a(new_n55_), .b(new_n51_), .O(new_n163_));
  nand3  g130(.a(new_n42_), .b(new_n98_), .c(x00), .O(new_n164_));
  ...
  nand2  g137(.a(new_n41_), .b(x14), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x06), .c(new_n47_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n37_), .c(new_n159_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n170_), .c(new_n161_), .O(z6));
  nor2   g141(.a(new_n122_), .b(new_n119_), .O(new_n175_));
  aoi21  g142(.a(new_n113_), .b(new_n98_), .c(x07), .O(new_n176_));
