...
module FAU ( 
  ...
  nand3  g090(.a(x21), .b(new_n46_), .c(new_n98_), .O(new_n124_));
  ...
  nand3  g099(.a(new_n132_), .b(new_n128_), .c(new_n73_), .O(new_n133_));
  ...
  nand3  g103(.a(new_n89_), .b(x07), .c(new_n35_), .O(new_n137_));
  nand4  g104(.a(new_n37_), .b(new_n74_), .c(new_n36_), .d(new_n69_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n89_), .b(new_n69_), .c(new_n35_), .O(new_n142_));
  nand4  g109(.a(new_n37_), .b(x19), .c(new_n74_), .d(new_n36_), .O(new_n143_));
  ...
  oai21  g113(.a(x23), .b(new_n59_), .c(new_n76_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n63_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n69_), .O(new_n149_));
  nand4  g116(.a(new_n40_), .b(x19), .c(x13), .d(new_n73_), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n41_), .c(x05), .O(new_n152_));
  nand4  g119(.a(new_n56_), .b(x19), .c(new_n50_), .d(new_n38_), .O(new_n153_));
  nand4  g120(.a(new_n48_), .b(new_n40_), .c(new_n73_), .d(new_n46_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n45_), .O(z5));
  nand2  g122(.a(z5), .b(new_n149_), .O(new_n156_));
  oai21  g123(.a(new_n64_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n97_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n75_), .c(x08), .O(new_n159_));
  nand4  g126(.a(new_n40_), .b(x15), .c(x13), .d(new_n73_), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n110_), .c(x05), .O(new_n162_));
  nand4  g129(.a(new_n56_), .b(x15), .c(new_n50_), .d(new_n38_), .O(new_n163_));
  nand4  g130(.a(new_n116_), .b(new_n40_), .c(x21), .d(new_n73_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n114_), .O(z7));
  nand2  g132(.a(z7), .b(new_n159_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n156_), .O(z4));
