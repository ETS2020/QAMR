...
module FAU ( 
  ...
  aoi21  g075(.a(new_n108_), .b(new_n107_), .c(new_n49_), .O(new_n109_));
  nand3  g076(.a(x15), .b(new_n54_), .c(new_n49_), .O(new_n110_));
  oai21  g077(.a(new_n107_), .b(new_n54_), .c(new_n110_), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n109_), .c(x20), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n41_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x11), .c(x06), .d(x03), .O(new_n114_));
  nor2   g081(.a(new_n35_), .b(x02), .O(new_n115_));
  inv1   g082(.a(new_n115_), .O(new_n116_));
  oai21  g083(.a(new_n114_), .b(new_n106_), .c(new_n116_), .O(z2));
  nand3  g084(.a(new_n62_), .b(new_n39_), .c(new_n36_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n45_), .c(new_n35_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n62_), .b(new_n36_), .c(new_n106_), .O(new_n123_));
  nand3  g090(.a(new_n88_), .b(new_n41_), .c(new_n48_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n94_), .O(new_n126_));
  nand4  g093(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n127_));
  nand4  g094(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n106_), .O(new_n128_));
  inv1   g095(.a(x08), .O(new_n129_));
  nand4  g096(.a(new_n42_), .b(new_n41_), .c(new_n48_), .d(new_n129_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n128_), .c(new_n127_), .d(new_n121_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n92_), .c(x24), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n126_), .c(new_n120_), .O(z3));
  ...
  nand2  g105(.a(new_n138_), .b(new_n82_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n66_), .c(x08), .O(new_n140_));
  nor2   g107(.a(new_n56_), .b(new_n52_), .O(new_n141_));
  nor2   g108(.a(new_n115_), .b(new_n141_), .O(new_n142_));
  inv1   g109(.a(x10), .O(new_n143_));
  nand3  g110(.a(new_n43_), .b(new_n35_), .c(new_n143_), .O(new_n144_));
  nor3   g111(.a(new_n144_), .b(x02), .c(new_n38_), .O(new_n145_));
  nor2   g112(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  inv1   g113(.a(new_n109_), .O(new_n147_));
  inv1   g114(.a(new_n111_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  inv1   g116(.a(x23), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n82_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n66_), .c(x08), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n116_), .c(new_n149_), .O(new_n154_));
  oai21  g121(.a(new_n146_), .b(new_n140_), .c(new_n154_), .O(z4));
  nand3  g122(.a(new_n43_), .b(new_n143_), .c(x00), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n35_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n34_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n141_), .O(z5));
  oai21  g126(.a(new_n42_), .b(x14), .c(new_n37_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n48_), .c(x03), .O(new_n161_));
  aoi21  g128(.a(new_n42_), .b(x14), .c(new_n37_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n48_), .c(x03), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n116_), .c(new_n149_), .O(new_n164_));
  oai21  g131(.a(new_n161_), .b(new_n146_), .c(new_n164_), .O(z6));
  aoi21  g132(.a(new_n148_), .b(new_n147_), .c(new_n115_), .O(z7));
endmodule
