...
module FAU ( 
  ...
  nand4  g048(.a(new_n81_), .b(new_n73_), .c(new_n72_), .d(new_n34_), .O(new_n82_));
  ...
  nor2   g060(.a(new_n74_), .b(new_n93_), .O(new_n94_));
  ...
  nand4  g066(.a(new_n72_), .b(new_n34_), .c(new_n57_), .d(new_n71_), .O(new_n100_));
  nand4  g067(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n73_), .O(new_n101_));
  ...
  nand4  g077(.a(new_n73_), .b(new_n72_), .c(new_n34_), .d(new_n57_), .O(new_n111_));
  nand4  g078(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(x19), .O(new_n112_));
  ...
  nor3   g093(.a(new_n126_), .b(new_n74_), .c(new_n34_), .O(new_n127_));
  ...
  nand4  g099(.a(new_n79_), .b(new_n74_), .c(new_n34_), .d(new_n71_), .O(new_n133_));
  ...
  nand4  g108(.a(new_n74_), .b(new_n34_), .c(new_n71_), .d(new_n69_), .O(new_n142_));
  ...
  nand4  g113(.a(new_n74_), .b(x19), .c(new_n34_), .d(new_n71_), .O(new_n147_));
  ...
  oai21  g117(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n151_));
  ...
  nor2   g126(.a(x20), .b(new_n34_), .O(new_n160_));
  ...
  oai21  g130(.a(new_n71_), .b(x06), .c(x03), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n155_), .O(new_n165_));
  nand2  g132(.a(x20), .b(new_n34_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n37_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n52_), .O(new_n168_));
