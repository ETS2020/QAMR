...
module FAU ( 
  ...
  nand4  g067(.a(new_n71_), .b(x19), .c(new_n54_), .d(new_n82_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n103_), .c(new_n98_), .d(new_n90_), .O(z3));
  ...
  oai21  g078(.a(new_n111_), .b(x16), .c(new_n53_), .O(new_n112_));
  ...
  aoi21  g088(.a(new_n121_), .b(new_n113_), .c(new_n104_), .O(z4));
  inv1   g089(.a(new_n41_), .O(new_n123_));
  and2   g090(.a(new_n45_), .b(new_n42_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n105_), .c(new_n47_), .d(new_n123_), .O(z5));
  aoi21  g092(.a(new_n82_), .b(x06), .c(x03), .O(new_n126_));
  aoi21  g093(.a(x11), .b(new_n36_), .c(new_n35_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n72_), .c(new_n126_), .d(new_n49_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n105_), .O(new_n129_));
  nand2  g096(.a(new_n82_), .b(x00), .O(new_n130_));
  nand3  g097(.a(x20), .b(new_n54_), .c(x12), .O(new_n131_));
  nand3  g098(.a(new_n93_), .b(x21), .c(new_n71_), .O(new_n132_));
  oai21  g099(.a(new_n131_), .b(new_n130_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n44_), .c(new_n43_), .O(new_n134_));
  nand2  g101(.a(x12), .b(new_n82_), .O(new_n135_));
  nand3  g102(.a(x20), .b(x19), .c(new_n54_), .O(new_n136_));
  nand3  g103(.a(new_n93_), .b(new_n71_), .c(x15), .O(new_n137_));
  ...
  nand2  g108(.a(new_n82_), .b(x07), .O(new_n142_));
  nand3  g109(.a(new_n93_), .b(new_n71_), .c(x18), .O(new_n143_));
  oai21  g110(.a(new_n142_), .b(new_n131_), .c(new_n143_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n91_), .c(x24), .O(new_n145_));
  nand3  g112(.a(new_n138_), .b(new_n46_), .c(new_n37_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n145_), .c(new_n141_), .d(new_n129_), .O(z6));
  nor2   g114(.a(new_n104_), .b(new_n72_), .O(z7));
endmodule
