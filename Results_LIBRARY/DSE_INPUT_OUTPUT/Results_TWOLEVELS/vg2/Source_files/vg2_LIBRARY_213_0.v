...
module FAU ( 
  ...
  aoi21  g111(.a(new_n144_), .b(new_n90_), .c(new_n44_), .O(new_n145_));
  nand3  g112(.a(x15), .b(new_n45_), .c(new_n44_), .O(new_n146_));
  oai21  g113(.a(new_n90_), .b(new_n45_), .c(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n145_), .c(x20), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n36_), .O(new_n149_));
  ...
  oai21  g177(.a(new_n210_), .b(new_n51_), .c(new_n209_), .O(z7));
  nand2  g178(.a(z7), .b(new_n207_), .O(new_n212_));
