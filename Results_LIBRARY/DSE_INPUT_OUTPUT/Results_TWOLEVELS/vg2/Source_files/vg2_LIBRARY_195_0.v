...
module FAU ( 
  ...
  nor2   g18(.a(x23), .b(x08), .O(new_n52_));
  ...
  nor4   g42(.a(new_n75_), .b(new_n52_), .c(new_n74_), .d(new_n57_), .O(new_n76_));
  nand4  g43(.a(new_n76_), .b(x11), .c(x06), .d(x03), .O(new_n77_));
  nor2   g44(.a(new_n77_), .b(new_n55_), .O(z2));
  ...
  nand3  g52(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n86_));
  nand3  g53(.a(x19), .b(x13), .c(x05), .O(new_n87_));
  aoi21  g54(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nand4  g55(.a(new_n88_), .b(new_n74_), .c(new_n57_), .d(new_n36_), .O(new_n89_));
  nor2   g56(.a(new_n89_), .b(x08), .O(new_n90_));
  nand4  g57(.a(new_n90_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n91_));
  nand2  g58(.a(new_n91_), .b(new_n84_), .O(new_n92_));
  nand2  g59(.a(new_n92_), .b(new_n39_), .O(new_n93_));
  nand2  g60(.a(new_n46_), .b(new_n37_), .O(new_n94_));
  nand4  g61(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n95_));
  nand4  g62(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n96_));
  nand4  g63(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n97_));
  nor2   g64(.a(new_n85_), .b(x20), .O(new_n98_));
  nand4  g65(.a(new_n98_), .b(new_n57_), .c(new_n36_), .d(new_n56_), .O(new_n99_));
  oai22  g66(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n100_));
  nand3  g67(.a(new_n100_), .b(new_n94_), .c(x24), .O(new_n101_));
  nand4  g68(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n102_));
  nand4  g69(.a(new_n56_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n103_));
  nand4  g70(.a(new_n98_), .b(x19), .c(new_n57_), .d(new_n36_), .O(new_n104_));
  oai22  g71(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n95_), .O(new_n105_));
  nand3  g72(.a(new_n105_), .b(new_n46_), .c(new_n37_), .O(new_n106_));
  nand3  g73(.a(new_n106_), .b(new_n101_), .c(new_n93_), .O(z3));
  inv1   g74(.a(x16), .O(new_n108_));
  inv1   g75(.a(x09), .O(new_n109_));
  nand2  g76(.a(new_n58_), .b(x17), .O(new_n110_));
  aoi21  g77(.a(new_n110_), .b(new_n109_), .c(new_n85_), .O(new_n111_));
  aoi21  g78(.a(new_n111_), .b(new_n108_), .c(x08), .O(new_n112_));
  inv1   g79(.a(x17), .O(new_n113_));
  aoi21  g80(.a(x22), .b(new_n113_), .c(new_n109_), .O(new_n114_));
  nand2  g81(.a(x23), .b(x22), .O(new_n115_));
  oai22  g82(.a(new_n115_), .b(x04), .c(new_n114_), .d(new_n56_), .O(new_n116_));
  aoi22  g83(.a(new_n116_), .b(x16), .c(x23), .d(new_n56_), .O(new_n117_));
  oai22  g84(.a(new_n117_), .b(new_n75_), .c(new_n112_), .d(new_n49_), .O(z4));
  inv1   g85(.a(new_n41_), .O(new_n119_));
  and2   g86(.a(new_n45_), .b(new_n42_), .O(new_n120_));
  nand4  g87(.a(new_n120_), .b(new_n53_), .c(new_n47_), .d(new_n119_), .O(z5));
  nand2  g88(.a(x20), .b(new_n57_), .O(new_n122_));
  aoi21  g89(.a(new_n122_), .b(new_n35_), .c(x11), .O(new_n123_));
  oai22  g90(.a(new_n123_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n124_));
  nand2  g91(.a(new_n74_), .b(x14), .O(new_n125_));
  aoi21  g92(.a(new_n125_), .b(x06), .c(new_n36_), .O(new_n126_));
  oai22  g93(.a(new_n126_), .b(new_n34_), .c(new_n65_), .d(new_n61_), .O(new_n127_));
  nand3  g94(.a(new_n127_), .b(new_n124_), .c(new_n53_), .O(z6));
  aoi21  g95(.a(new_n85_), .b(new_n56_), .c(new_n75_), .O(z7));
endmodule
