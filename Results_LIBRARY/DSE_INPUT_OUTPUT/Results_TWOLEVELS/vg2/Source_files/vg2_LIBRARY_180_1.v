...
module FAU ( 
  ...
  nor2   g059(.a(new_n34_), .b(new_n73_), .O(new_n93_));
  ...
  nand4  g065(.a(new_n34_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n99_));
  ...
  nand4  g076(.a(new_n34_), .b(new_n73_), .c(new_n72_), .d(x19), .O(new_n110_));
  ...
  nand4  g107(.a(new_n72_), .b(new_n69_), .c(new_n68_), .d(new_n66_), .O(new_n141_));
  ...
  nand3  g113(.a(new_n146_), .b(new_n72_), .c(x19), .O(new_n147_));
  ...
  nand2  g116(.a(x23), .b(new_n69_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n149_), .c(new_n143_), .d(new_n135_), .O(z3));
  ...
  oai21  g123(.a(new_n34_), .b(x04), .c(x17), .O(new_n157_));
  ...
  nand3  g127(.a(new_n160_), .b(new_n156_), .c(new_n150_), .O(z4));
  inv1   g128(.a(new_n42_), .O(new_n162_));
  and2   g129(.a(new_n46_), .b(new_n43_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n150_), .c(new_n48_), .d(new_n162_), .O(z5));
  aoi21  g131(.a(new_n68_), .b(x06), .c(x03), .O(new_n165_));
  aoi21  g132(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n124_), .c(new_n165_), .d(new_n50_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n150_), .O(new_n168_));
  nand3  g135(.a(new_n138_), .b(x21), .c(new_n72_), .O(new_n169_));
  nand2  g136(.a(new_n68_), .b(x00), .O(new_n170_));
  nand3  g137(.a(new_n34_), .b(x20), .c(new_n69_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n170_), .c(new_n169_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n45_), .c(new_n44_), .O(new_n173_));
  nand3  g140(.a(new_n138_), .b(new_n72_), .c(x15), .O(new_n174_));
  nand4  g141(.a(new_n146_), .b(new_n34_), .c(x20), .d(x19), .O(new_n175_));
  ...
  nand3  g146(.a(new_n138_), .b(new_n72_), .c(x18), .O(new_n180_));
  nand2  g147(.a(new_n68_), .b(x07), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n171_), .c(new_n180_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n136_), .c(x24), .O(new_n183_));
  nand3  g150(.a(new_n176_), .b(new_n47_), .c(new_n38_), .O(new_n184_));
  ...
  nand4  g154(.a(new_n187_), .b(new_n150_), .c(new_n122_), .d(new_n186_), .O(z7));
endmodule
