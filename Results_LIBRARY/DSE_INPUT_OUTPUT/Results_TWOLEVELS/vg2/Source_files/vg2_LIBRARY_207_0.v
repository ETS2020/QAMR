...
module FAU ( 
  ...
  oai21  g061(.a(new_n91_), .b(new_n44_), .c(new_n94_), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(new_n93_), .c(x20), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n90_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(x11), .c(x06), .d(x03), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n89_), .c(new_n51_), .O(z2));
  nand4  g066(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n100_));
  nand4  g067(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n101_));
  nand3  g068(.a(new_n63_), .b(new_n34_), .c(new_n89_), .O(new_n102_));
  nand3  g069(.a(new_n68_), .b(new_n90_), .c(new_n36_), .O(new_n103_));
  ...
  nand4  g073(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n89_), .O(new_n107_));
  inv1   g074(.a(x08), .O(new_n108_));
  nand4  g075(.a(new_n37_), .b(new_n90_), .c(new_n36_), .d(new_n108_), .O(new_n109_));
  oai22  g076(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n100_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n72_), .c(x24), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n105_), .c(new_n51_), .O(z3));
  or2    g079(.a(new_n46_), .b(new_n42_), .O(new_n113_));
  ...
  or2    g087(.a(new_n95_), .b(new_n93_), .O(new_n121_));
  inv1   g088(.a(x16), .O(new_n122_));
  inv1   g089(.a(x23), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(x04), .c(x17), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(x22), .c(new_n61_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n122_), .c(x08), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n120_), .c(new_n50_), .O(z4));
  and2   g095(.a(new_n51_), .b(new_n113_), .O(z5));
  nand2  g096(.a(x20), .b(new_n90_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n35_), .c(x11), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(x03), .c(new_n113_), .O(new_n132_));
  nand2  g099(.a(new_n37_), .b(x14), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x06), .c(new_n36_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n34_), .c(new_n121_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n132_), .c(new_n51_), .O(z6));
  and2   g103(.a(new_n121_), .b(new_n51_), .O(z7));
endmodule
