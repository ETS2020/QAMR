...
module FAU ( 
  ...
  nor2   g018(.a(x21), .b(x08), .O(new_n52_));
  ...
  nand4  g041(.a(x04), .b(x03), .c(new_n43_), .d(x01), .O(new_n75_));
  nand4  g042(.a(new_n44_), .b(x09), .c(x08), .d(x06), .O(new_n76_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n61_), .c(new_n60_), .d(new_n59_), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n83_), .c(new_n36_), .d(new_n58_), .O(new_n91_));
  nor2   g058(.a(new_n91_), .b(x08), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n35_), .c(new_n56_), .d(new_n34_), .O(new_n93_));
  nor2   g060(.a(new_n93_), .b(x01), .O(new_n94_));
  oai21  g061(.a(new_n94_), .b(new_n82_), .c(x21), .O(new_n95_));
  ...
  nand3  g067(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n101_));
  ...
  aoi21  g079(.a(new_n98_), .b(x05), .c(new_n112_), .O(new_n113_));
  nor3   g080(.a(new_n113_), .b(new_n62_), .c(new_n59_), .O(new_n114_));
  ...
  nor2   g087(.a(new_n120_), .b(new_n57_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  nand4  g089(.a(new_n67_), .b(new_n62_), .c(new_n59_), .d(new_n36_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(x08), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n125_));
  ...
  nand4  g097(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n131_));
  nand4  g098(.a(new_n62_), .b(new_n59_), .c(new_n36_), .d(new_n57_), .O(new_n132_));
  ...
  nand4  g102(.a(new_n57_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n136_));
  nand4  g103(.a(new_n62_), .b(x19), .c(new_n59_), .d(new_n36_), .O(new_n137_));
  ...
  nand4  g106(.a(new_n139_), .b(new_n134_), .c(new_n127_), .d(new_n53_), .O(z3));
  nand2  g107(.a(new_n47_), .b(new_n42_), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n56_), .c(new_n61_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n63_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n57_), .O(new_n144_));
  oai21  g111(.a(new_n141_), .b(new_n41_), .c(new_n144_), .O(new_n145_));
  inv1   g112(.a(new_n113_), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n56_), .c(new_n61_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n63_), .c(x09), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n146_), .c(x16), .O(new_n149_));
  inv1   g116(.a(x00), .O(new_n150_));
  nand2  g117(.a(x08), .b(new_n150_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n44_), .c(new_n43_), .O(new_n152_));
  nand2  g119(.a(new_n57_), .b(x05), .O(new_n153_));
  nand3  g120(.a(x21), .b(x15), .c(x13), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  nand3  g122(.a(new_n128_), .b(x24), .c(x18), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n101_), .c(x21), .O(new_n157_));
  aoi22  g124(.a(new_n157_), .b(new_n57_), .c(new_n155_), .d(new_n39_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n149_), .c(new_n145_), .O(z4));
  nor2   g126(.a(new_n52_), .b(new_n49_), .O(z5));
  nand2  g127(.a(x20), .b(new_n59_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n163_));
  nand2  g130(.a(new_n62_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n36_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n34_), .c(new_n146_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n53_), .O(z6));
  oai21  g134(.a(x21), .b(x08), .c(new_n102_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n111_), .O(z7));
endmodule
