...
module FAU ( 
  ...
  nor2   g003(.a(x21), .b(x12), .O(new_n37_));
  ...
  inv1   g055(.a(new_n37_), .O(new_n89_));
  ...
  nand4  g067(.a(new_n72_), .b(new_n71_), .c(new_n55_), .d(new_n36_), .O(new_n101_));
  ...
  nand3  g085(.a(new_n118_), .b(new_n48_), .c(new_n38_), .O(new_n119_));
  ...
  nand3  g093(.a(x15), .b(new_n48_), .c(new_n38_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n125_), .c(new_n89_), .O(new_n129_));
  inv1   g096(.a(x21), .O(new_n130_));
  nor2   g097(.a(x24), .b(new_n130_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n44_), .c(new_n57_), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n129_), .c(new_n74_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x14), .c(x11), .d(x06), .O(new_n134_));
  nor3   g101(.a(new_n134_), .b(new_n34_), .c(new_n67_), .O(z2));
  nand4  g102(.a(new_n59_), .b(x20), .c(x14), .d(x11), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n69_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(x06), .c(x03), .d(x01), .O(new_n138_));
  nand4  g105(.a(new_n79_), .b(new_n74_), .c(new_n71_), .d(new_n36_), .O(new_n139_));
  nor2   g106(.a(new_n139_), .b(x08), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n141_));
  ...
  nand4  g112(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n146_));
  nand4  g113(.a(new_n74_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n147_));
  ...
  nand3  g117(.a(new_n111_), .b(new_n34_), .c(new_n67_), .O(new_n151_));
  nand3  g118(.a(new_n116_), .b(new_n71_), .c(new_n36_), .O(new_n152_));
  ...
  oai21  g122(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n156_));
  ...
  oai21  g126(.a(new_n76_), .b(x04), .c(x17), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n70_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n72_), .c(x08), .O(new_n162_));
  inv1   g129(.a(new_n125_), .O(new_n163_));
  nand4  g130(.a(new_n132_), .b(new_n127_), .c(new_n126_), .d(new_n163_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n162_), .c(new_n37_), .O(new_n165_));
  oai21  g132(.a(new_n159_), .b(new_n51_), .c(new_n165_), .O(z4));
  inv1   g133(.a(new_n42_), .O(new_n167_));
  and2   g134(.a(new_n49_), .b(new_n89_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n47_), .c(new_n43_), .d(new_n167_), .O(z5));
  ...
  oai21  g139(.a(new_n172_), .b(new_n42_), .c(new_n89_), .O(new_n173_));
  nand4  g140(.a(new_n46_), .b(new_n40_), .c(x12), .d(new_n44_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g143(.a(new_n132_), .b(new_n129_), .O(new_n177_));
  aoi21  g144(.a(new_n74_), .b(x14), .c(new_n35_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n36_), .c(x03), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n177_), .O(new_n180_));
  nand3  g147(.a(new_n131_), .b(new_n46_), .c(new_n44_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n180_), .c(new_n176_), .O(z6));
  inv1   g149(.a(new_n128_), .O(new_n183_));
  nand4  g150(.a(new_n132_), .b(new_n183_), .c(new_n163_), .d(new_n89_), .O(z7));
endmodule
