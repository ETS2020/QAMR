...
module FAU ( 
  ...
  nand3  g071(.a(new_n42_), .b(x23), .c(x22), .O(new_n105_));
  nor3   g072(.a(new_n105_), .b(new_n104_), .c(new_n92_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n103_), .c(new_n101_), .d(new_n99_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n98_), .c(new_n84_), .O(z1));
  ...
  nand3  g084(.a(new_n117_), .b(new_n116_), .c(x12), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n115_), .c(new_n92_), .O(new_n119_));
  ...
  oai21  g119(.a(x23), .b(new_n69_), .c(new_n91_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n152_), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n58_), .O(new_n155_));
  inv1   g122(.a(new_n44_), .O(new_n156_));
  nand4  g123(.a(new_n42_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n47_), .c(new_n45_), .d(new_n156_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  inv1   g126(.a(x23), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x04), .c(x17), .O(new_n161_));
  ...
  nand2  g131(.a(new_n117_), .b(new_n116_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n113_), .c(new_n112_), .d(new_n164_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n159_), .c(new_n39_), .O(z4));
  ...
  oai21  g138(.a(new_n171_), .b(x03), .c(new_n158_), .O(new_n172_));
  nand2  g139(.a(new_n92_), .b(x14), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x06), .c(new_n35_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n68_), .c(new_n166_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n39_), .O(z6));
  nor2   g143(.a(new_n114_), .b(new_n111_), .O(new_n177_));
  aoi21  g144(.a(new_n117_), .b(new_n50_), .c(new_n38_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x02), .c(new_n177_), .O(z7));
endmodule
