...
module FAU ( 
  ...
  nand4  g110(.a(new_n44_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n55_), .c(new_n53_), .O(new_n145_));
  or2    g112(.a(new_n145_), .b(new_n52_), .O(new_n146_));
  oai21  g113(.a(new_n143_), .b(x08), .c(new_n146_), .O(new_n147_));
  ...
  nor2   g119(.a(x24), .b(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n37_), .c(new_n34_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n112_), .c(new_n111_), .O(new_n155_));
  or2    g122(.a(new_n155_), .b(new_n110_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  nor2   g124(.a(x02), .b(new_n35_), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n157_), .c(new_n147_), .O(z4));
  nor2   g127(.a(new_n56_), .b(new_n52_), .O(new_n161_));
  nand3  g128(.a(new_n44_), .b(new_n37_), .c(x00), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n35_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(z5));
  nand2  g132(.a(x20), .b(new_n42_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n36_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n146_), .O(new_n168_));
  nand2  g135(.a(new_n43_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n41_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n48_), .c(new_n156_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n159_), .O(z6));
  oai21  g139(.a(new_n113_), .b(new_n110_), .c(new_n159_), .O(new_n173_));
  nand4  g140(.a(new_n153_), .b(new_n37_), .c(new_n34_), .d(new_n35_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n173_), .O(z7));
endmodule
