...
module FAU ( 
  ...
  nand4  g084(.a(new_n98_), .b(x08), .c(x06), .d(x03), .O(new_n118_));
  ...
  nand2  g089(.a(new_n122_), .b(new_n111_), .O(new_n123_));
  nand3  g090(.a(new_n57_), .b(x03), .c(x01), .O(new_n124_));
  ...
  nand3  g108(.a(new_n141_), .b(new_n111_), .c(x00), .O(new_n142_));
  ...
  oai21  g116(.a(new_n113_), .b(new_n108_), .c(new_n149_), .O(new_n150_));
  ...
  nand4  g121(.a(new_n141_), .b(new_n111_), .c(x01), .d(x00), .O(new_n155_));
  ...
  nand2  g128(.a(new_n110_), .b(new_n109_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n108_), .c(new_n152_), .O(new_n163_));
  nand3  g130(.a(new_n119_), .b(new_n95_), .c(new_n98_), .O(new_n164_));
