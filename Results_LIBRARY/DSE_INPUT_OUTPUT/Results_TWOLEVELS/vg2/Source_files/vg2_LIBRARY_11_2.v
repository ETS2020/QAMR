...
module FAU ( 
  ...
  nand4  g119(.a(new_n140_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n153_));
  oai21  g120(.a(new_n149_), .b(new_n152_), .c(new_n153_), .O(z5));
  ...
  aoi21  g124(.a(new_n46_), .b(x14), .c(new_n37_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n40_), .c(x03), .O(new_n159_));
  inv1   g126(.a(new_n115_), .O(new_n160_));
  nand3  g127(.a(new_n49_), .b(x21), .c(new_n38_), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n34_), .c(new_n35_), .O(new_n163_));
  oai21  g130(.a(new_n149_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n159_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n157_), .O(z6));
  oai21  g133(.a(new_n162_), .b(x01), .c(new_n34_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n160_), .O(z7));
endmodule
