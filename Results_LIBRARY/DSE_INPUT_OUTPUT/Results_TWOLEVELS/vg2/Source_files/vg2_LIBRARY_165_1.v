...
module FAU ( 
  ...
  nand4  g043(.a(new_n76_), .b(new_n73_), .c(new_n72_), .d(new_n34_), .O(new_n77_));
  nor2   g044(.a(new_n77_), .b(x20), .O(new_n78_));
  ...
  nand4  g049(.a(new_n82_), .b(new_n66_), .c(new_n65_), .d(new_n35_), .O(new_n83_));
  ...
  nor4   g054(.a(new_n87_), .b(new_n66_), .c(new_n65_), .d(new_n35_), .O(new_n88_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n90_), .d(new_n88_), .O(new_n95_));
  nor2   g062(.a(x03), .b(x01), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n36_), .c(new_n66_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n37_), .b(new_n68_), .c(new_n67_), .d(x07), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n54_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nor2   g069(.a(x21), .b(x20), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n73_), .c(new_n72_), .O(new_n104_));
  inv1   g071(.a(new_n104_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n102_), .c(new_n100_), .d(new_n98_), .O(new_n106_));
  aoi21  g073(.a(new_n106_), .b(new_n95_), .c(new_n86_), .O(new_n107_));
  ...
  nand4  g078(.a(new_n54_), .b(new_n37_), .c(new_n68_), .d(new_n67_), .O(new_n112_));
  inv1   g079(.a(new_n112_), .O(new_n113_));
  nand4  g080(.a(x19), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n114_));
  inv1   g081(.a(new_n114_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n113_), .c(new_n105_), .d(new_n98_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n111_), .c(x13), .O(new_n117_));
  aoi22  g084(.a(new_n117_), .b(new_n38_), .c(new_n107_), .d(x24), .O(new_n118_));
  ...
  nor2   g097(.a(new_n130_), .b(new_n35_), .O(z2));
  ...
  nand4  g101(.a(new_n76_), .b(new_n34_), .c(new_n92_), .d(new_n69_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(x11), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n67_), .c(new_n36_), .d(new_n65_), .O(new_n137_));
  ...
  nand3  g108(.a(new_n93_), .b(x14), .c(x11), .O(new_n142_));
  nand3  g109(.a(new_n96_), .b(x07), .c(new_n36_), .O(new_n143_));
  nand4  g110(.a(new_n103_), .b(new_n69_), .c(new_n37_), .d(new_n67_), .O(new_n144_));
  ...
  nand3  g114(.a(new_n96_), .b(new_n67_), .c(new_n36_), .O(new_n148_));
  nand4  g115(.a(new_n103_), .b(x19), .c(new_n69_), .d(new_n37_), .O(new_n149_));
  ...
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n67_), .O(new_n156_));
  ...
  oai21  g127(.a(new_n127_), .b(new_n123_), .c(new_n160_), .O(new_n161_));
  nand2  g128(.a(x21), .b(new_n65_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n161_), .c(new_n157_), .O(z4));
  aoi21  g130(.a(x21), .b(new_n65_), .c(new_n50_), .O(z5));
  inv1   g131(.a(x07), .O(new_n165_));
  oai21  g132(.a(x20), .b(new_n69_), .c(x06), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(x18), .c(x11), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n140_), .c(x24), .O(new_n169_));
  nand3  g136(.a(new_n40_), .b(x13), .c(x05), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n140_), .O(new_n171_));
  nand3  g138(.a(new_n166_), .b(x15), .c(x11), .O(new_n172_));
  inv1   g139(.a(new_n172_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x19), .c(new_n171_), .O(new_n174_));
  inv1   g141(.a(x00), .O(new_n175_));
  nand3  g142(.a(new_n166_), .b(x21), .c(x11), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n174_), .c(new_n169_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(x03), .O(new_n180_));
  oai21  g147(.a(new_n92_), .b(x14), .c(new_n36_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n153_), .c(new_n37_), .O(new_n182_));
  nand2  g149(.a(new_n125_), .b(new_n124_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n123_), .c(new_n65_), .O(new_n184_));
  ...
  inv1   g154(.a(new_n123_), .O(new_n188_));
  inv1   g155(.a(new_n183_), .O(new_n189_));
  nor3   g156(.a(x24), .b(x10), .c(x02), .O(new_n190_));
  oai21  g157(.a(new_n190_), .b(new_n65_), .c(x21), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n189_), .c(new_n188_), .O(z7));
endmodule
