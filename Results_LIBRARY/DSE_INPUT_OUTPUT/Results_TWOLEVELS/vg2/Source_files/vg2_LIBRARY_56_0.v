...
module FAU ( 
  ...
  nor2   g23(.a(x20), .b(x03), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n69_), .c(x08), .O(new_n76_));
  nand2  g42(.a(x24), .b(x07), .O(new_n77_));
  nand3  g43(.a(new_n41_), .b(x19), .c(x13), .O(new_n78_));
  ...
  aoi21  g49(.a(new_n79_), .b(x05), .c(new_n83_), .O(new_n84_));
  inv1   g50(.a(x23), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(x04), .c(x17), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(x22), .c(new_n70_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n69_), .c(x08), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n62_), .c(new_n58_), .O(new_n89_));
  oai21  g55(.a(new_n84_), .b(new_n76_), .c(new_n89_), .O(z4));
  nor2   g56(.a(new_n84_), .b(new_n58_), .O(z5));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(x06), .O(new_n93_));
  inv1   g59(.a(x20), .O(new_n94_));
  aoi21  g60(.a(x14), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n92_), .c(x03), .O(new_n96_));
  nand2  g62(.a(new_n94_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x06), .c(new_n92_), .O(new_n98_));
  nor2   g64(.a(new_n94_), .b(x03), .O(new_n99_));
  aoi21  g65(.a(new_n98_), .b(x03), .c(new_n99_), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n61_), .c(new_n96_), .d(new_n84_), .O(z6));
  inv1   g67(.a(new_n43_), .O(new_n102_));
  and2   g68(.a(new_n46_), .b(new_n44_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n59_), .c(new_n49_), .d(new_n102_), .O(z7));
  zero   g70(.O(z0));
endmodule
