...
module FAU ( 
  ...
  aoi21  g038(.a(new_n71_), .b(new_n70_), .c(x22), .O(new_n72_));
  ...
  nand4  g049(.a(new_n82_), .b(new_n81_), .c(x07), .d(new_n35_), .O(new_n83_));
  nor3   g050(.a(x14), .b(x12), .c(x11), .O(new_n84_));
  nor2   g051(.a(x22), .b(x20), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n68_), .d(new_n54_), .O(new_n86_));
  nand4  g053(.a(x12), .b(x09), .c(x08), .d(x06), .O(new_n87_));
  ...
  nor2   g059(.a(new_n55_), .b(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n91_), .c(new_n90_), .d(new_n88_), .O(new_n94_));
  oai21  g061(.a(new_n86_), .b(new_n83_), .c(new_n94_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n80_), .c(x24), .O(new_n96_));
  nor2   g063(.a(x08), .b(x06), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n81_), .c(new_n36_), .d(new_n67_), .O(new_n98_));
  nor3   g065(.a(x16), .b(x14), .c(x12), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n85_), .c(x19), .d(new_n68_), .O(new_n100_));
  nand3  g067(.a(x16), .b(x15), .c(x14), .O(new_n101_));
  nand3  g068(.a(new_n93_), .b(x20), .c(x17), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  oai21  g071(.a(new_n100_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n46_), .c(new_n37_), .O(new_n106_));
  nor2   g073(.a(new_n55_), .b(x11), .O(new_n107_));
  ...
  nand2  g077(.a(new_n110_), .b(new_n79_), .O(z1));
  ...
  nor3   g086(.a(new_n119_), .b(new_n69_), .c(new_n53_), .O(new_n120_));
  ...
  nand2  g093(.a(new_n71_), .b(new_n70_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n55_), .c(new_n69_), .d(new_n53_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x11), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(x01), .c(new_n126_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n39_), .O(new_n132_));
  nand4  g099(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n133_));
  nand3  g100(.a(new_n91_), .b(x14), .c(x11), .O(new_n134_));
  nand4  g101(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n135_));
  nor2   g102(.a(x23), .b(x20), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n53_), .c(new_n36_), .d(new_n66_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n80_), .c(x24), .O(new_n139_));
  nand4  g106(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n140_));
  nand3  g107(.a(new_n97_), .b(new_n34_), .c(new_n64_), .O(new_n141_));
  nand4  g108(.a(new_n136_), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n142_));
  ...
  aoi21  g112(.a(new_n92_), .b(x17), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n66_), .O(new_n147_));
  nand4  g114(.a(new_n55_), .b(new_n92_), .c(new_n54_), .d(x04), .O(new_n148_));
  inv1   g115(.a(new_n148_), .O(new_n149_));
  aoi21  g116(.a(new_n147_), .b(new_n108_), .c(new_n149_), .O(new_n150_));
  aoi21  g117(.a(x22), .b(new_n68_), .c(new_n67_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n54_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n93_), .b(x16), .O(new_n153_));
  nor3   g120(.a(new_n153_), .b(new_n36_), .c(x04), .O(new_n154_));
  aoi21  g121(.a(new_n152_), .b(new_n108_), .c(new_n154_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n119_), .c(new_n150_), .d(new_n49_), .O(z4));
  inv1   g123(.a(new_n41_), .O(new_n157_));
  and2   g124(.a(new_n45_), .b(new_n42_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n108_), .c(new_n47_), .d(new_n157_), .O(z5));
  nand2  g126(.a(x20), .b(new_n53_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n162_));
  nand2  g129(.a(new_n69_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n34_), .c(new_n118_), .d(new_n114_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n108_), .O(z6));
  nor2   g133(.a(new_n119_), .b(new_n107_), .O(z7));
endmodule
