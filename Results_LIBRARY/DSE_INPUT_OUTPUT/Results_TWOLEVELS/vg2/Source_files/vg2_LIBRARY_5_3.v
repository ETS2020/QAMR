...
module FAU ( 
  ...
  nand4  g032(.a(new_n65_), .b(new_n57_), .c(new_n36_), .d(new_n53_), .O(new_n66_));
  ...
  oai21  g081(.a(x23), .b(new_n52_), .c(new_n59_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n114_), .c(x09), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(x16), .c(new_n84_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n113_), .O(new_n118_));
  inv1   g085(.a(new_n80_), .O(new_n119_));
  oai21  g086(.a(x23), .b(new_n59_), .c(x22), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(x09), .c(new_n58_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n84_), .c(new_n119_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n118_), .c(new_n55_), .O(z4));
  inv1   g090(.a(new_n41_), .O(new_n124_));
  and2   g091(.a(new_n47_), .b(new_n45_), .O(new_n125_));
  nand4  g092(.a(new_n55_), .b(new_n125_), .c(new_n42_), .d(new_n124_), .O(z5));
  nand2  g093(.a(x20), .b(new_n71_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n35_), .c(x11), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(x03), .c(new_n113_), .O(new_n129_));
  nand2  g096(.a(new_n60_), .b(x14), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x06), .c(new_n36_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n34_), .c(new_n119_), .O(new_n132_));
