...
module FAU ( 
  ...
  nor2   g068(.a(x12), .b(new_n36_), .O(new_n102_));
  nor2   g069(.a(new_n60_), .b(new_n71_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(x14), .O(new_n104_));
  nor2   g071(.a(x03), .b(x01), .O(new_n105_));
  nand4  g072(.a(new_n60_), .b(new_n91_), .c(new_n36_), .d(new_n84_), .O(new_n106_));
  ...
  nor2   g077(.a(new_n60_), .b(new_n110_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n102_), .c(new_n101_), .d(x14), .O(new_n112_));
  nand4  g079(.a(new_n60_), .b(x19), .c(new_n91_), .d(new_n36_), .O(new_n113_));
  ...
  nand2  g084(.a(new_n117_), .b(new_n99_), .O(z3));
  inv1   g085(.a(new_n49_), .O(new_n119_));
  inv1   g086(.a(x22), .O(new_n120_));
  oai21  g087(.a(x23), .b(new_n56_), .c(new_n59_), .O(new_n121_));
  aoi21  g088(.a(new_n121_), .b(new_n120_), .c(x09), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(x16), .c(new_n84_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n119_), .O(new_n124_));
  oai21  g091(.a(new_n61_), .b(x04), .c(x17), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x22), .c(new_n57_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n58_), .c(x08), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n79_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n124_), .c(new_n53_), .O(z4));
  inv1   g096(.a(new_n41_), .O(new_n130_));
  and2   g097(.a(new_n45_), .b(new_n42_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n54_), .c(new_n47_), .d(new_n130_), .O(z5));
  inv1   g099(.a(x21), .O(new_n133_));
  nand2  g100(.a(x03), .b(x00), .O(new_n134_));
  oai21  g101(.a(new_n133_), .b(x03), .c(new_n134_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n44_), .c(new_n43_), .O(new_n136_));
  nand2  g103(.a(x19), .b(x03), .O(new_n137_));
  oai21  g104(.a(new_n110_), .b(x03), .c(new_n137_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(x13), .c(x05), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n136_), .c(x24), .O(new_n140_));
  nand2  g107(.a(new_n46_), .b(new_n37_), .O(new_n141_));
  nand2  g108(.a(x07), .b(x03), .O(new_n142_));
  oai21  g109(.a(new_n71_), .b(x03), .c(new_n142_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n141_), .c(x24), .O(new_n144_));
  nand3  g111(.a(new_n138_), .b(new_n46_), .c(new_n37_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n140_), .c(new_n54_), .O(new_n147_));
  nand3  g114(.a(x20), .b(new_n91_), .c(new_n35_), .O(new_n148_));
  oai21  g115(.a(x12), .b(new_n35_), .c(new_n148_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n119_), .c(new_n36_), .O(new_n150_));
  nand3  g117(.a(new_n60_), .b(x14), .c(new_n52_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x06), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n79_), .c(x11), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n150_), .c(new_n147_), .O(z6));
  nand4  g121(.a(new_n78_), .b(new_n75_), .c(new_n74_), .d(new_n54_), .O(z7));
endmodule
