...
module FAU ( 
  ...
  or2    g118(.a(new_n49_), .b(new_n42_), .O(new_n152_));
  ...
  oai21  g123(.a(new_n101_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n66_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n90_), .c(x08), .O(new_n159_));
  nand3  g126(.a(new_n143_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n122_), .c(new_n121_), .O(new_n161_));
  or2    g128(.a(new_n161_), .b(new_n120_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g130(.a(x02), .b(x01), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n163_), .c(new_n156_), .O(z4));
  nand2  g132(.a(new_n48_), .b(new_n43_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n42_), .c(new_n164_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n46_), .O(z5));
  nand2  g135(.a(x20), .b(new_n89_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x11), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x03), .c(new_n152_), .O(new_n171_));
  ...
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n164_), .O(z6));
  nand2  g142(.a(new_n122_), .b(new_n121_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n120_), .c(new_n164_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n160_), .O(z7));
endmodule
