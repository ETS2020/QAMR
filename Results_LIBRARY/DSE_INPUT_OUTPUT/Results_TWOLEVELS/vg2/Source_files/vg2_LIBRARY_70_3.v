...
module FAU ( 
  ...
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n87_), .d(new_n65_), .O(new_n102_));
  ...
  or2    g110(.a(new_n49_), .b(new_n42_), .O(new_n144_));
  ...
  inv1   g116(.a(new_n112_), .O(new_n150_));
  ...
  oai21  g123(.a(new_n156_), .b(new_n150_), .c(new_n154_), .O(new_n157_));
  nand2  g124(.a(x06), .b(x02), .O(new_n158_));
  ...
  nand4  g144(.a(new_n168_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n178_));
  inv1   g145(.a(new_n178_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n44_), .c(new_n177_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n175_), .c(new_n172_), .d(new_n165_), .O(z6));
  nand3  g148(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n158_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n155_), .O(z7));
endmodule
