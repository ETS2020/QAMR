...
module FAU ( 
  ...
  nand2  g072(.a(new_n69_), .b(x11), .O(new_n106_));
  ...
  aoi21  g086(.a(new_n119_), .b(x20), .c(new_n34_), .O(z2));
  ...
  nand4  g091(.a(new_n124_), .b(new_n69_), .c(new_n55_), .d(new_n66_), .O(new_n125_));
  ...
  nand4  g097(.a(new_n69_), .b(new_n55_), .c(new_n66_), .d(x07), .O(new_n131_));
  ...
  nand4  g101(.a(new_n69_), .b(x19), .c(new_n55_), .d(new_n66_), .O(new_n135_));
  ...
  oai21  g106(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n70_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n66_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  inv1   g110(.a(new_n117_), .O(new_n144_));
  ...
  nand3  g115(.a(new_n148_), .b(new_n143_), .c(new_n106_), .O(z4));
  inv1   g116(.a(new_n42_), .O(new_n150_));
  and2   g117(.a(new_n46_), .b(new_n43_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n106_), .c(new_n48_), .d(new_n150_), .O(z5));
  oai21  g119(.a(new_n34_), .b(x06), .c(x03), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n144_), .O(new_n154_));
  nand2  g121(.a(x20), .b(new_n55_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n37_), .c(x11), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x03), .c(new_n139_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n154_), .c(new_n106_), .O(z6));
  inv1   g125(.a(new_n112_), .O(new_n159_));
  and2   g126(.a(new_n114_), .b(new_n113_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n115_), .c(new_n159_), .d(new_n106_), .O(z7));
endmodule
