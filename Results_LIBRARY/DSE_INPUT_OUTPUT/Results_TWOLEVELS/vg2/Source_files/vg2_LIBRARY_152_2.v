...
module FAU ( 
  ...
  nand4  g070(.a(new_n103_), .b(new_n91_), .c(new_n70_), .d(new_n69_), .O(new_n104_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n72_), .c(new_n34_), .O(new_n122_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n72_), .c(new_n34_), .d(new_n70_), .O(new_n130_));
  ...
  nand3  g103(.a(new_n92_), .b(new_n36_), .c(new_n35_), .O(new_n137_));
  nand4  g104(.a(new_n72_), .b(new_n34_), .c(new_n70_), .d(new_n68_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n103_), .b(new_n36_), .c(new_n35_), .O(new_n142_));
  nand4  g109(.a(new_n72_), .b(x19), .c(new_n34_), .d(new_n70_), .O(new_n143_));
  ...
  oai21  g113(.a(x23), .b(new_n67_), .c(new_n71_), .O(new_n147_));
  ...
  oai21  g118(.a(new_n58_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n69_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n87_), .c(x08), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n150_), .c(new_n110_), .O(z4));
  nor2   g123(.a(new_n109_), .b(new_n53_), .O(z5));
  oai21  g124(.a(new_n70_), .b(x06), .c(x03), .O(new_n158_));
  ...
  oai21  g128(.a(new_n161_), .b(x03), .c(new_n52_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n110_), .O(z6));
  nor2   g130(.a(new_n121_), .b(new_n109_), .O(z7));
endmodule
