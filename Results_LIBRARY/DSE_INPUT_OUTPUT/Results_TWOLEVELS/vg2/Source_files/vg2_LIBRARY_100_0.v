...
module FAU ( 
  ...
  nand4  g044(.a(new_n77_), .b(new_n76_), .c(new_n54_), .d(new_n35_), .O(new_n78_));
  ...
  nand3  g089(.a(new_n55_), .b(x03), .c(x01), .O(new_n123_));
  nor2   g090(.a(new_n97_), .b(new_n36_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(x20), .c(x15), .O(new_n125_));
  nand4  g092(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n105_), .O(new_n126_));
  nand4  g093(.a(new_n82_), .b(new_n97_), .c(new_n36_), .d(new_n54_), .O(new_n127_));
  ...
  nand4  g098(.a(new_n131_), .b(new_n36_), .c(new_n54_), .d(x07), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n126_), .c(new_n130_), .d(new_n123_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n86_), .c(x24), .O(new_n134_));
  nor2   g101(.a(x02), .b(new_n105_), .O(new_n135_));
  nand2  g102(.a(new_n124_), .b(new_n106_), .O(new_n136_));
  nand2  g103(.a(new_n109_), .b(x20), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n135_), .c(new_n55_), .d(x03), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n134_), .c(new_n129_), .O(z3));
  inv1   g107(.a(x22), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n52_), .c(new_n96_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n141_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n54_), .O(new_n144_));
  nor2   g111(.a(x24), .b(x10), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n51_), .c(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n45_), .c(new_n43_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n42_), .c(new_n144_), .O(new_n148_));
  oai21  g115(.a(new_n63_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n56_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n98_), .c(x08), .O(new_n151_));
  nand3  g118(.a(new_n109_), .b(new_n106_), .c(new_n51_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n117_), .c(new_n116_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n115_), .c(new_n151_), .O(new_n154_));
  nor2   g121(.a(x02), .b(x01), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n154_), .c(new_n148_), .O(z4));
  nor2   g124(.a(new_n46_), .b(new_n42_), .O(new_n158_));
  aoi21  g125(.a(new_n145_), .b(x00), .c(new_n105_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x02), .c(new_n158_), .O(z5));
  aoi21  g127(.a(x20), .b(new_n97_), .c(x06), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x11), .c(new_n34_), .O(new_n162_));
  nand4  g129(.a(new_n145_), .b(new_n51_), .c(x01), .d(x00), .O(new_n163_));
  oai21  g130(.a(new_n155_), .b(new_n158_), .c(new_n163_), .O(new_n164_));
  ...
  nor2   g134(.a(new_n118_), .b(new_n115_), .O(new_n168_));
  nand2  g135(.a(new_n109_), .b(new_n106_), .O(new_n169_));
  inv1   g136(.a(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n135_), .O(new_n171_));
  oai21  g138(.a(new_n155_), .b(new_n168_), .c(new_n171_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n167_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n165_), .O(z6));
  oai21  g141(.a(new_n170_), .b(new_n105_), .c(new_n51_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n168_), .O(z7));
endmodule
