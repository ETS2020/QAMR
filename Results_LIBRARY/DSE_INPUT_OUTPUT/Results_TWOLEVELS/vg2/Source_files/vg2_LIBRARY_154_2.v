...
module FAU ( 
  ...
  aoi21  g112(.a(new_n144_), .b(new_n139_), .c(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n135_), .O(z4));
  ...
  nand4  g120(.a(new_n45_), .b(new_n44_), .c(new_n54_), .d(x00), .O(new_n154_));
  ...
  nand4  g127(.a(new_n142_), .b(new_n140_), .c(new_n44_), .d(new_n54_), .O(new_n161_));
