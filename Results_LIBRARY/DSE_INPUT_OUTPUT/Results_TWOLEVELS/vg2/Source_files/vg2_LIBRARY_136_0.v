...
module FAU ( 
  ...
  nand3  g044(.a(new_n77_), .b(new_n50_), .c(new_n38_), .O(new_n78_));
  nand2  g045(.a(new_n50_), .b(new_n38_), .O(new_n79_));
  inv1   g046(.a(x08), .O(new_n80_));
  nor2   g047(.a(new_n39_), .b(x06), .O(new_n81_));
  ...
  nand3  g067(.a(x21), .b(new_n46_), .c(new_n100_), .O(new_n101_));
  ...
  nand2  g082(.a(new_n46_), .b(new_n100_), .O(new_n116_));
  ...
  oai21  g095(.a(new_n116_), .b(new_n47_), .c(new_n128_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n37_), .c(new_n84_), .d(new_n36_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n59_), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n127_), .c(x24), .O(new_n133_));
  nand4  g100(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nand4  g101(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n135_));
  nand3  g102(.a(new_n69_), .b(new_n34_), .c(new_n59_), .O(new_n136_));
  nand3  g103(.a(new_n74_), .b(new_n84_), .c(new_n36_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n50_), .c(new_n38_), .O(new_n139_));
  inv1   g106(.a(new_n139_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n133_), .c(x12), .O(new_n141_));
  nand4  g108(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n142_));
  nand3  g109(.a(new_n81_), .b(new_n34_), .c(new_n59_), .O(new_n143_));
  nand4  g110(.a(new_n37_), .b(new_n84_), .c(new_n36_), .d(new_n80_), .O(new_n144_));
  ...
  oai21  g117(.a(x23), .b(new_n60_), .c(new_n83_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n150_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n80_), .O(new_n153_));
  nand4  g120(.a(new_n40_), .b(x19), .c(x13), .d(x12), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n41_), .c(x05), .O(new_n156_));
  nand4  g123(.a(new_n57_), .b(x19), .c(new_n50_), .d(new_n38_), .O(new_n157_));
  nand4  g124(.a(new_n48_), .b(new_n40_), .c(x12), .d(new_n46_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n45_), .O(z5));
  nand2  g126(.a(z5), .b(new_n153_), .O(new_n160_));
  oai21  g127(.a(new_n98_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n67_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n85_), .c(x08), .O(new_n163_));
  nand4  g130(.a(new_n40_), .b(x15), .c(x13), .d(x12), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n111_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x05), .O(new_n166_));
  nand4  g133(.a(new_n57_), .b(x15), .c(new_n50_), .d(new_n38_), .O(new_n167_));
  nand4  g134(.a(new_n117_), .b(new_n40_), .c(x21), .d(x12), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n114_), .O(z7));
  nand2  g136(.a(z7), .b(new_n163_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n160_), .O(z4));
  aoi21  g138(.a(x20), .b(new_n84_), .c(x06), .O(new_n172_));
