...
module FAU ( 
  ...
  nor2   g003(.a(x22), .b(x12), .O(new_n37_));
  ...
  nor2   g038(.a(new_n71_), .b(new_n54_), .O(z1));
  nor2   g039(.a(new_n64_), .b(new_n60_), .O(new_n73_));
  nor2   g040(.a(new_n73_), .b(new_n37_), .O(z7));
  nand2  g041(.a(z7), .b(x20), .O(new_n75_));
  nor2   g042(.a(new_n75_), .b(new_n56_), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(x11), .c(x06), .d(x03), .O(new_n77_));
  nor2   g044(.a(new_n77_), .b(new_n54_), .O(z2));
  ...
  nand4  g055(.a(new_n88_), .b(new_n85_), .c(new_n56_), .d(new_n36_), .O(new_n89_));
  ...
  nand4  g064(.a(new_n85_), .b(new_n56_), .c(new_n36_), .d(new_n55_), .O(new_n98_));
  ...
  nand4  g069(.a(new_n85_), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n103_));
  ...
  and2   g072(.a(new_n105_), .b(new_n100_), .O(new_n106_));
  aoi21  g073(.a(new_n106_), .b(new_n93_), .c(new_n37_), .O(z3));
  inv1   g074(.a(new_n37_), .O(new_n108_));
  inv1   g075(.a(new_n50_), .O(new_n109_));
  inv1   g076(.a(x04), .O(new_n110_));
  inv1   g077(.a(x17), .O(new_n111_));
  oai21  g078(.a(x23), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n57_), .c(x09), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(x16), .c(new_n55_), .O(new_n114_));
  ...
  oai21  g088(.a(new_n121_), .b(new_n117_), .c(x08), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n116_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n115_), .c(new_n108_), .O(z4));
  inv1   g091(.a(new_n42_), .O(new_n125_));
  and2   g092(.a(new_n46_), .b(new_n43_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n48_), .c(new_n125_), .d(new_n108_), .O(z5));
  nand2  g094(.a(x20), .b(new_n56_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n35_), .c(x11), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(x03), .c(new_n109_), .O(new_n130_));
  nand2  g097(.a(new_n85_), .b(x14), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(x06), .c(new_n36_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n34_), .c(new_n116_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n130_), .c(new_n37_), .O(z6));
endmodule
