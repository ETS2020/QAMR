...
module FAU ( 
  ...
  nor4   g044(.a(new_n77_), .b(new_n58_), .c(new_n69_), .d(x12), .O(new_n78_));
  ...
  nand2  g062(.a(new_n46_), .b(new_n37_), .O(new_n96_));
  nand4  g063(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n97_));
  nand4  g064(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n98_));
  nor2   g065(.a(x03), .b(x01), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(x07), .c(new_n35_), .O(new_n100_));
  nand4  g067(.a(new_n58_), .b(new_n69_), .c(new_n36_), .d(new_n81_), .O(new_n101_));
  oai22  g068(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(new_n97_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n96_), .c(x24), .O(new_n103_));
  nand4  g070(.a(x08), .b(x06), .c(new_n37_), .d(x01), .O(new_n104_));
  nor2   g071(.a(x13), .b(new_n36_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(x20), .c(x15), .d(x14), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n104_), .c(new_n55_), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(x03), .O(new_n108_));
  nor3   g075(.a(x08), .b(x06), .c(x05), .O(new_n109_));
  nand3  g076(.a(new_n58_), .b(x19), .c(new_n69_), .O(new_n110_));
  nor3   g077(.a(new_n110_), .b(x13), .c(x11), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n109_), .c(new_n99_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n108_), .c(new_n103_), .d(new_n95_), .O(z3));
  nor2   g080(.a(new_n55_), .b(new_n34_), .O(new_n114_));
  inv1   g081(.a(new_n49_), .O(new_n115_));
  inv1   g082(.a(x22), .O(new_n116_));
  oai21  g083(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n116_), .c(x09), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(x16), .c(new_n81_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  inv1   g087(.a(new_n77_), .O(new_n121_));
  ...
  aoi21  g092(.a(new_n125_), .b(new_n120_), .c(new_n114_), .O(z4));
  inv1   g093(.a(new_n41_), .O(new_n127_));
  inv1   g094(.a(new_n114_), .O(new_n128_));
  and2   g095(.a(new_n45_), .b(new_n42_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n47_), .d(new_n127_), .O(z5));
  nand2  g097(.a(x20), .b(new_n69_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n35_), .c(x11), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x03), .c(new_n115_), .O(new_n133_));
  nand2  g100(.a(new_n58_), .b(x14), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(x06), .c(new_n36_), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(new_n34_), .c(new_n121_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n133_), .c(new_n128_), .O(z6));
  nor2   g104(.a(new_n114_), .b(new_n77_), .O(z7));
endmodule
