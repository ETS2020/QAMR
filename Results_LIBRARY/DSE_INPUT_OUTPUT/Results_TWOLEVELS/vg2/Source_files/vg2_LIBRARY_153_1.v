...
module FAU ( 
  ...
  oai21  g110(.a(new_n143_), .b(new_n43_), .c(new_n141_), .O(new_n144_));
  inv1   g111(.a(x09), .O(new_n145_));
  oai21  g112(.a(new_n104_), .b(x04), .c(x17), .O(new_n146_));
  ...
  nand2  g116(.a(x02), .b(new_n90_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z4));
  nand2  g118(.a(new_n48_), .b(new_n44_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n43_), .c(new_n150_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n142_), .O(z5));
  aoi21  g121(.a(x20), .b(new_n67_), .c(x06), .O(new_n155_));
  ...
  oai21  g127(.a(new_n160_), .b(new_n111_), .c(new_n150_), .O(new_n161_));
  ...
  nand4  g131(.a(new_n150_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n165_));
  or2    g132(.a(new_n165_), .b(new_n111_), .O(z7));
endmodule
