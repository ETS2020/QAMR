...
module FAU ( 
  ...
  nand3  g041(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n75_));
  ...
  nor4   g056(.a(new_n89_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n90_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n97_), .c(x07), .d(new_n34_), .O(new_n99_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n97_), .c(new_n35_), .d(new_n69_), .O(new_n111_));
  ...
  nand3  g084(.a(new_n117_), .b(new_n44_), .c(new_n38_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n105_), .c(new_n37_), .O(new_n119_));
  inv1   g086(.a(new_n119_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n86_), .O(z1));
  nor2   g088(.a(new_n40_), .b(new_n93_), .O(new_n122_));
  inv1   g089(.a(new_n122_), .O(new_n123_));
  nand3  g090(.a(new_n40_), .b(x15), .c(x13), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(new_n123_), .c(new_n38_), .O(new_n125_));
  inv1   g092(.a(new_n125_), .O(new_n126_));
  nand2  g093(.a(new_n122_), .b(x13), .O(new_n127_));
  nand3  g094(.a(x15), .b(new_n44_), .c(new_n38_), .O(new_n128_));
  nand4  g095(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n129_));
  ...
  oai21  g101(.a(new_n134_), .b(new_n65_), .c(new_n37_), .O(z2));
  nand4  g102(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nor2   g103(.a(new_n36_), .b(new_n35_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(x20), .c(x15), .O(new_n138_));
  nand3  g105(.a(new_n110_), .b(new_n66_), .c(new_n65_), .O(new_n139_));
  nand3  g106(.a(new_n115_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n136_), .O(new_n141_));
  nand3  g108(.a(new_n40_), .b(x13), .c(x05), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n88_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g111(.a(new_n137_), .b(new_n94_), .O(new_n145_));
  nand4  g112(.a(x07), .b(new_n34_), .c(new_n66_), .d(new_n65_), .O(new_n146_));
  nand4  g113(.a(new_n72_), .b(new_n36_), .c(new_n35_), .d(new_n68_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n136_), .O(new_n148_));
  ...
  nand4  g118(.a(new_n34_), .b(new_n66_), .c(new_n65_), .d(x00), .O(new_n152_));
  nand3  g119(.a(new_n137_), .b(x21), .c(x20), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n136_), .c(new_n152_), .d(new_n147_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n40_), .c(new_n49_), .d(new_n48_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n151_), .O(z3));
  oai21  g123(.a(x23), .b(new_n67_), .c(new_n71_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n73_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n68_), .O(new_n159_));
  nand3  g126(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n42_), .c(new_n159_), .O(new_n161_));
  oai21  g128(.a(new_n74_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n69_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n70_), .c(x08), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n131_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n161_), .c(new_n37_), .O(z4));
  nand2  g133(.a(new_n50_), .b(new_n47_), .O(z5));
  aoi21  g134(.a(x20), .b(new_n36_), .c(x06), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x11), .c(new_n66_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(z5), .O(new_n170_));
  aoi21  g137(.a(new_n72_), .b(x14), .c(new_n34_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n35_), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n128_), .b(new_n127_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n125_), .c(new_n37_), .O(new_n174_));
  ...
  nand4  g144(.a(new_n130_), .b(new_n127_), .c(new_n126_), .d(new_n37_), .O(z7));
endmodule
