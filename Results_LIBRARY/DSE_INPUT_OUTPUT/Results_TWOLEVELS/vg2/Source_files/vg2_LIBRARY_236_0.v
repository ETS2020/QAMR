...
module FAU ( 
  ...
  nor2   g003(.a(x12), .b(x08), .O(new_n37_));
  ...
  oai21  g045(.a(new_n76_), .b(new_n54_), .c(new_n78_), .O(z2));
  ...
  nand4  g065(.a(new_n98_), .b(new_n73_), .c(new_n56_), .d(x12), .O(new_n99_));
  ...
  nor2   g071(.a(new_n104_), .b(x11), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n73_), .c(x19), .d(new_n56_), .O(new_n106_));
  oai22  g073(.a(new_n106_), .b(new_n103_), .c(new_n102_), .d(new_n95_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n47_), .c(new_n38_), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(new_n101_), .c(new_n93_), .d(new_n78_), .O(z3));
  inv1   g076(.a(new_n50_), .O(new_n110_));
  ...
  oai22  g089(.a(new_n122_), .b(new_n118_), .c(new_n104_), .d(x08), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n117_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n116_), .c(new_n78_), .O(z4));
  nor2   g092(.a(new_n77_), .b(new_n50_), .O(z5));
  nand2  g093(.a(x20), .b(new_n56_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n35_), .c(x11), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(x03), .c(new_n110_), .O(new_n129_));
  nand2  g096(.a(new_n73_), .b(x14), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x06), .c(new_n36_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n34_), .c(new_n117_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n129_), .c(new_n78_), .O(z6));
  nor2   g100(.a(new_n74_), .b(new_n37_), .O(z7));
endmodule
