...
module FAU ( 
  ...
  nor2   g004(.a(x15), .b(x12), .O(new_n38_));
  ...
  nor2   g018(.a(new_n51_), .b(new_n38_), .O(z5));
  ...
  nand2  g054(.a(new_n48_), .b(new_n39_), .O(new_n88_));
  ...
  nor2   g065(.a(x08), .b(new_n98_), .O(new_n99_));
  ...
  nor2   g070(.a(x16), .b(new_n103_), .O(new_n104_));
  nor2   g071(.a(x20), .b(x17), .O(new_n105_));
  nor2   g072(.a(x23), .b(x22), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n102_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n101_), .c(new_n95_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n88_), .c(x24), .O(new_n109_));
  nand3  g076(.a(new_n94_), .b(x20), .c(x17), .O(new_n110_));
  nor4   g077(.a(new_n110_), .b(new_n73_), .c(new_n72_), .d(new_n57_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n90_), .O(new_n112_));
  nor3   g079(.a(x04), .b(x03), .c(x01), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n100_), .c(new_n70_), .d(new_n35_), .O(new_n114_));
  nor2   g081(.a(x17), .b(x16), .O(new_n115_));
  inv1   g082(.a(x19), .O(new_n116_));
  nor2   g083(.a(x20), .b(new_n116_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(new_n115_), .c(new_n106_), .d(new_n102_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n114_), .c(new_n112_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x15), .c(new_n48_), .d(new_n39_), .O(new_n120_));
  and2   g087(.a(new_n120_), .b(new_n109_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n87_), .O(z1));
  inv1   g089(.a(new_n38_), .O(new_n123_));
  ...
  nand3  g094(.a(x15), .b(new_n48_), .c(new_n39_), .O(new_n128_));
  nand4  g095(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nor3   g098(.a(new_n131_), .b(new_n37_), .c(new_n72_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x11), .c(x06), .d(x03), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n68_), .c(new_n123_), .O(z2));
  nand4  g101(.a(new_n60_), .b(x20), .c(x14), .d(x11), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(new_n70_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand4  g104(.a(new_n78_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n140_));
  ...
  nand3  g110(.a(new_n93_), .b(x14), .c(x11), .O(new_n144_));
  nand3  g111(.a(new_n96_), .b(x07), .c(new_n35_), .O(new_n145_));
  nand4  g112(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n70_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n143_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n88_), .c(x24), .O(new_n148_));
  nand4  g115(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n149_));
  nand3  g116(.a(new_n96_), .b(new_n70_), .c(new_n35_), .O(new_n150_));
  nand3  g117(.a(new_n117_), .b(new_n72_), .c(new_n36_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n143_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n48_), .c(new_n39_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n148_), .c(new_n142_), .d(new_n123_), .O(z3));
  inv1   g121(.a(new_n51_), .O(new_n155_));
  inv1   g122(.a(x17), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n69_), .c(new_n156_), .O(new_n157_));
  ...
  inv1   g127(.a(new_n131_), .O(new_n161_));
  oai21  g128(.a(new_n75_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n71_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n73_), .c(x08), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n160_), .c(new_n123_), .O(z4));
  nand2  g133(.a(x20), .b(new_n72_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n35_), .c(x11), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x03), .c(new_n155_), .O(new_n169_));
  nand2  g136(.a(new_n37_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x06), .c(new_n36_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n34_), .c(new_n161_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n123_), .O(z6));
  nand4  g140(.a(new_n123_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n58_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n41_), .O(new_n176_));
  nand2  g143(.a(new_n88_), .b(x12), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n103_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(x24), .c(x18), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n176_), .c(new_n128_), .O(z7));
endmodule
