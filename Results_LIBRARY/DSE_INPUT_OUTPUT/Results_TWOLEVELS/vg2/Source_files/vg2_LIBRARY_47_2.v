...
module FAU ( 
  ...
  nand2  g042(.a(new_n46_), .b(new_n38_), .O(new_n76_));
  ...
  nand3  g057(.a(new_n73_), .b(new_n37_), .c(new_n59_), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand2  g059(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n85_), .c(new_n83_), .O(new_n94_));
  nand3  g061(.a(new_n94_), .b(new_n76_), .c(x24), .O(new_n95_));
  inv1   g062(.a(x21), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n37_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n81_), .c(new_n63_), .d(new_n56_), .O(new_n98_));
  nor2   g065(.a(x03), .b(x01), .O(new_n99_));
  nand2  g066(.a(new_n99_), .b(x00), .O(new_n100_));
  inv1   g067(.a(x04), .O(new_n101_));
  nand3  g068(.a(new_n84_), .b(new_n35_), .c(new_n101_), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n92_), .c(new_n90_), .O(new_n104_));
  aoi21  g071(.a(new_n104_), .b(new_n98_), .c(x10), .O(new_n105_));
  oai21  g072(.a(new_n105_), .b(x02), .c(new_n40_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n95_), .c(new_n79_), .O(z1));
  nand2  g074(.a(x24), .b(x18), .O(new_n108_));
  inv1   g075(.a(x02), .O(new_n109_));
  nand4  g076(.a(new_n40_), .b(x15), .c(x13), .d(new_n109_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(x05), .O(new_n112_));
  nand3  g079(.a(x15), .b(new_n46_), .c(new_n38_), .O(new_n113_));
  nand3  g080(.a(new_n40_), .b(x21), .c(new_n44_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n109_), .O(new_n116_));
  nand2  g083(.a(x18), .b(x13), .O(new_n117_));
  ...
  nor2   g092(.a(new_n87_), .b(new_n36_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(x20), .c(x15), .O(new_n127_));
  nand2  g094(.a(new_n99_), .b(new_n67_), .O(new_n128_));
  nand3  g095(.a(new_n72_), .b(new_n87_), .c(new_n36_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n125_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n78_), .O(new_n131_));
  inv1   g098(.a(new_n125_), .O(new_n132_));
  nand3  g099(.a(new_n126_), .b(new_n132_), .c(new_n82_), .O(new_n133_));
  nand3  g100(.a(new_n99_), .b(x07), .c(new_n35_), .O(new_n134_));
  inv1   g101(.a(x08), .O(new_n135_));
  nand4  g102(.a(new_n37_), .b(new_n87_), .c(new_n36_), .d(new_n135_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n134_), .c(new_n133_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n76_), .c(x24), .O(new_n138_));
  inv1   g105(.a(x01), .O(new_n139_));
  inv1   g106(.a(new_n136_), .O(new_n140_));
  nor2   g107(.a(x06), .b(x03), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(x00), .O(new_n142_));
  nand3  g109(.a(new_n126_), .b(new_n132_), .c(new_n97_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n142_), .c(x10), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x02), .c(new_n40_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n138_), .c(new_n131_), .O(z3));
  oai21  g113(.a(x23), .b(new_n101_), .c(new_n59_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n61_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n135_), .O(new_n149_));
  nand4  g116(.a(new_n40_), .b(x19), .c(x13), .d(new_n109_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n39_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x05), .O(new_n152_));
  nand2  g119(.a(new_n47_), .b(new_n45_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n109_), .O(new_n154_));
  nand2  g121(.a(x13), .b(x07), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n47_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x24), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n154_), .c(new_n152_), .O(z5));
  nand2  g125(.a(z5), .b(new_n149_), .O(new_n159_));
  oai21  g126(.a(new_n62_), .b(x04), .c(x17), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n65_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n88_), .c(x08), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n120_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n159_), .O(z4));
  nand2  g131(.a(x20), .b(new_n87_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(x03), .c(new_n48_), .d(new_n42_), .O(new_n167_));
  nand2  g134(.a(new_n37_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n36_), .O(new_n169_));
  nand3  g136(.a(new_n40_), .b(x15), .c(x13), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n108_), .c(new_n38_), .O(new_n171_));
  nand3  g138(.a(x24), .b(x18), .c(x13), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n114_), .c(new_n113_), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(new_n171_), .c(new_n169_), .d(new_n34_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n167_), .c(new_n52_), .O(z6));
  inv1   g142(.a(new_n171_), .O(new_n176_));
  oai21  g143(.a(new_n96_), .b(x10), .c(new_n109_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n40_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n172_), .c(new_n176_), .d(new_n113_), .O(z7));
endmodule
