...
module FAU ( 
  ...
  nand4  g103(.a(new_n136_), .b(new_n135_), .c(new_n115_), .d(new_n110_), .O(new_n137_));
  oai21  g104(.a(new_n134_), .b(new_n132_), .c(new_n137_), .O(new_n138_));
  nand3  g105(.a(new_n40_), .b(x13), .c(x05), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n88_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand4  g108(.a(new_n35_), .b(new_n34_), .c(new_n67_), .d(x00), .O(new_n142_));
  nand4  g109(.a(new_n37_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n143_));
  nand3  g110(.a(new_n133_), .b(x21), .c(x20), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n132_), .c(new_n143_), .d(new_n142_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n40_), .c(new_n45_), .O(new_n146_));
  nand2  g113(.a(new_n88_), .b(x24), .O(new_n147_));
  nor2   g114(.a(new_n147_), .b(new_n37_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(x18), .c(x14), .d(x11), .O(new_n149_));
  nor2   g116(.a(new_n149_), .b(new_n69_), .O(new_n150_));
  ...
  nand3  g120(.a(new_n138_), .b(new_n47_), .c(new_n38_), .O(new_n154_));
  inv1   g121(.a(new_n132_), .O(new_n155_));
  nand3  g122(.a(new_n133_), .b(new_n155_), .c(new_n94_), .O(new_n156_));
  nand3  g123(.a(new_n35_), .b(new_n34_), .c(new_n67_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n143_), .c(new_n156_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n88_), .c(x24), .O(new_n159_));
  nor2   g126(.a(x24), .b(new_n37_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n133_), .c(new_n155_), .d(x15), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n137_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x13), .c(x05), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n159_), .c(new_n154_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x07), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n153_), .O(z3));
  oai21  g133(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n74_), .c(x09), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x16), .c(new_n69_), .O(new_n169_));
  aoi21  g136(.a(new_n139_), .b(new_n88_), .c(x02), .O(new_n170_));
  nand2  g137(.a(x13), .b(x05), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n88_), .c(new_n53_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n170_), .c(x19), .O(new_n173_));
  nand3  g140(.a(new_n88_), .b(x24), .c(x07), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n173_), .c(new_n46_), .O(z5));
  nand2  g142(.a(z5), .b(new_n169_), .O(new_n176_));
  oai21  g143(.a(new_n75_), .b(x04), .c(x17), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(x22), .c(new_n70_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n72_), .c(x08), .O(new_n179_));
  nand3  g146(.a(new_n140_), .b(new_n54_), .c(x15), .O(new_n180_));
  nand3  g147(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n181_));
  oai21  g148(.a(new_n147_), .b(new_n93_), .c(new_n181_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n44_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nor3   g151(.a(new_n147_), .b(new_n93_), .c(new_n53_), .O(new_n185_));
  aoi21  g152(.a(new_n184_), .b(new_n179_), .c(new_n185_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n176_), .O(z4));
  aoi21  g154(.a(x20), .b(new_n71_), .c(x06), .O(new_n188_));
  ...
  aoi21  g159(.a(new_n192_), .b(new_n184_), .c(new_n185_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n190_), .O(z6));
  nand2  g161(.a(new_n128_), .b(new_n127_), .O(z7));
endmodule
