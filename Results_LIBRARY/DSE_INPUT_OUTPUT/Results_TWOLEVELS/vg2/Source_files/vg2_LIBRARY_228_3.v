...
module FAU ( 
  ...
  nand2  g021(.a(x05), .b(x02), .O(new_n55_));
  ...
  nor2   g059(.a(new_n76_), .b(new_n75_), .O(new_n93_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n97_), .c(new_n36_), .d(new_n71_), .O(new_n99_));
  nor2   g066(.a(x14), .b(x12), .O(new_n100_));
  nor2   g067(.a(x17), .b(x16), .O(new_n101_));
  nor2   g068(.a(x20), .b(new_n48_), .O(new_n102_));
  ...
  nand3  g072(.a(new_n105_), .b(new_n89_), .c(new_n38_), .O(new_n106_));
  ...
  nor2   g078(.a(new_n37_), .b(new_n111_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n110_), .c(new_n93_), .d(new_n91_), .O(new_n113_));
  nor2   g080(.a(x09), .b(x08), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(new_n97_), .c(x07), .d(new_n35_), .O(new_n115_));
  nand4  g082(.a(new_n73_), .b(new_n72_), .c(new_n57_), .d(new_n36_), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(new_n103_), .c(new_n37_), .d(new_n74_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n115_), .c(new_n113_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n108_), .c(x24), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(new_n106_), .c(new_n55_), .O(new_n121_));
  inv1   g088(.a(new_n121_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n88_), .O(z1));
  nor2   g090(.a(new_n40_), .b(new_n111_), .O(new_n124_));
  ...
  nand2  g095(.a(x15), .b(new_n89_), .O(new_n129_));
  ...
  aoi21  g099(.a(new_n130_), .b(new_n38_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n128_), .c(new_n127_), .O(new_n134_));
  ...
  oai21  g104(.a(new_n137_), .b(new_n68_), .c(new_n55_), .O(z2));
  nand2  g105(.a(x05), .b(new_n45_), .O(new_n139_));
  oai21  g106(.a(new_n89_), .b(x05), .c(new_n139_), .O(new_n140_));
  nand4  g107(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n141_));
  nor2   g108(.a(new_n72_), .b(new_n36_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n112_), .O(new_n143_));
  nand4  g110(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n144_));
  nand4  g111(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n70_), .O(new_n145_));
  ...
  nand3  g115(.a(new_n98_), .b(new_n34_), .c(new_n68_), .O(new_n149_));
  nand3  g116(.a(new_n102_), .b(new_n72_), .c(new_n36_), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n141_), .O(new_n151_));
  nand2  g118(.a(new_n40_), .b(x13), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n139_), .c(new_n108_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand4  g121(.a(new_n35_), .b(new_n34_), .c(new_n68_), .d(x00), .O(new_n155_));
  nand3  g122(.a(new_n142_), .b(x21), .c(x20), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n141_), .c(new_n155_), .d(new_n145_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n40_), .c(new_n46_), .d(new_n45_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n154_), .c(new_n147_), .O(z3));
  oai21  g126(.a(x23), .b(new_n69_), .c(new_n74_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n75_), .c(x09), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x16), .c(new_n70_), .O(new_n162_));
  ...
  nand3  g134(.a(new_n167_), .b(new_n163_), .c(new_n55_), .O(z4));
  nand3  g135(.a(new_n40_), .b(new_n46_), .c(x00), .O(new_n169_));
  inv1   g136(.a(new_n169_), .O(new_n170_));
  nor2   g137(.a(new_n170_), .b(new_n42_), .O(new_n171_));
  inv1   g138(.a(new_n44_), .O(new_n172_));
  nor2   g139(.a(new_n49_), .b(new_n172_), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(x05), .c(new_n171_), .d(x02), .O(z5));
  aoi21  g141(.a(x20), .b(new_n72_), .c(x06), .O(new_n175_));
  ...
  nand3  g146(.a(new_n40_), .b(x21), .c(new_n46_), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n127_), .c(x02), .O(new_n181_));
  aoi21  g148(.a(new_n129_), .b(new_n128_), .c(x05), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n181_), .c(new_n179_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n177_), .O(z6));
  nand3  g151(.a(new_n40_), .b(x15), .c(x05), .O(new_n185_));
  inv1   g152(.a(new_n185_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n124_), .c(x13), .O(new_n187_));
  oai21  g154(.a(new_n124_), .b(x02), .c(x05), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n187_), .c(new_n133_), .O(z7));
endmodule
