...
module FAU ( 
  ...
  and2   g126(.a(new_n148_), .b(new_n50_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n117_), .c(new_n45_), .d(new_n44_), .O(z5));
  nand2  g128(.a(x20), .b(new_n38_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n36_), .c(x11), .O(new_n163_));
  nand3  g130(.a(new_n160_), .b(new_n45_), .c(new_n44_), .O(new_n164_));
  ...
  oai22  g134(.a(new_n167_), .b(new_n35_), .c(new_n113_), .d(new_n109_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n117_), .O(z6));
endmodule
