...
module FAU ( 
  ...
  nor4   g052(.a(new_n85_), .b(new_n34_), .c(new_n55_), .d(new_n54_), .O(new_n86_));
  nand2  g053(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nor3   g054(.a(x04), .b(x03), .c(x01), .O(new_n88_));
  nor2   g055(.a(x09), .b(x08), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(x07), .d(new_n37_), .O(new_n90_));
  nor3   g057(.a(x14), .b(x12), .c(x11), .O(new_n91_));
  nor2   g058(.a(x23), .b(x22), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n70_), .d(new_n69_), .O(new_n93_));
  ...
  nand2  g065(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  nor2   g066(.a(x08), .b(x06), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n68_), .d(new_n67_), .O(new_n101_));
  nor3   g068(.a(x17), .b(x14), .c(x12), .O(new_n102_));
  inv1   g069(.a(x19), .O(new_n103_));
  nor2   g070(.a(x20), .b(new_n103_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n102_), .c(new_n92_), .O(new_n105_));
  oai21  g072(.a(new_n105_), .b(new_n101_), .c(new_n99_), .O(new_n106_));
  ...
  nand2  g078(.a(new_n111_), .b(new_n81_), .O(z1));
  ...
  nand3  g083(.a(x15), .b(new_n47_), .c(new_n38_), .O(new_n117_));
  nand4  g084(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n70_), .c(new_n55_), .O(new_n121_));
  ...
  nand2  g094(.a(new_n73_), .b(new_n72_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n70_), .c(new_n34_), .d(new_n55_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(x11), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n66_), .c(new_n37_), .d(new_n36_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(x01), .c(new_n127_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n40_), .O(new_n133_));
  ...
  nor2   g103(.a(x11), .b(x08), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n70_), .c(new_n34_), .d(new_n55_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n82_), .c(x24), .O(new_n140_));
  nand4  g107(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n141_));
  nand3  g108(.a(new_n100_), .b(new_n36_), .c(new_n35_), .O(new_n142_));
  nand4  g109(.a(new_n104_), .b(new_n34_), .c(new_n55_), .d(new_n68_), .O(new_n143_));
  ...
  nand2  g127(.a(x20), .b(new_n55_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n37_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n147_), .O(new_n163_));
  nand2  g130(.a(new_n70_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n68_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n36_), .c(new_n152_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n109_), .O(z6));
  nor2   g134(.a(new_n120_), .b(new_n108_), .O(z7));
endmodule
