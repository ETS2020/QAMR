...
module FAU ( 
  ...
  nand3  g074(.a(x15), .b(new_n75_), .c(new_n44_), .O(new_n108_));
  inv1   g075(.a(x02), .O(new_n109_));
  nand4  g076(.a(new_n40_), .b(x21), .c(new_n93_), .d(new_n109_), .O(new_n110_));
  ...
  nor2   g081(.a(new_n114_), .b(new_n94_), .O(z2));
  ...
  aoi21  g106(.a(new_n139_), .b(new_n136_), .c(x09), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n57_), .O(new_n141_));
  oai21  g108(.a(x20), .b(x10), .c(new_n50_), .O(new_n142_));
  nor2   g109(.a(x24), .b(new_n38_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n93_), .c(new_n109_), .d(x00), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  inv1   g113(.a(x16), .O(new_n147_));
  oai21  g114(.a(new_n98_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n65_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n147_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n93_), .b(new_n109_), .O(new_n151_));
  nand2  g118(.a(new_n108_), .b(new_n107_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n106_), .c(x20), .d(x10), .O(new_n153_));
  oai21  g120(.a(new_n132_), .b(new_n151_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g125(.a(new_n158_), .b(new_n93_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n49_), .c(new_n43_), .O(z5));
  oai21  g127(.a(new_n36_), .b(x06), .c(x03), .O(new_n161_));
  oai21  g128(.a(new_n111_), .b(new_n106_), .c(new_n161_), .O(new_n162_));
  oai21  g129(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n36_), .c(x03), .O(new_n164_));
  nand3  g131(.a(new_n117_), .b(new_n38_), .c(x15), .O(new_n165_));
  oai21  g132(.a(new_n164_), .b(new_n47_), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n78_), .O(new_n167_));
  nand3  g134(.a(new_n117_), .b(new_n38_), .c(x18), .O(new_n168_));
  oai21  g135(.a(new_n164_), .b(new_n84_), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n76_), .c(x24), .O(new_n170_));
  oai21  g137(.a(new_n37_), .b(x06), .c(new_n36_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n34_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n40_), .c(new_n109_), .d(x00), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x20), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n93_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n170_), .c(new_n167_), .d(new_n162_), .O(z6));
  inv1   g143(.a(new_n152_), .O(new_n177_));
  aoi21  g144(.a(new_n131_), .b(new_n109_), .c(new_n38_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x10), .c(new_n177_), .O(new_n179_));
  or2    g146(.a(new_n179_), .b(new_n106_), .O(z7));
endmodule
