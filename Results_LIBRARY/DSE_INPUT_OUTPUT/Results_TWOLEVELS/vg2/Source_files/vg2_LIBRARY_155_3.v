...
module FAU ( 
  ...
  nand2  g033(.a(x17), .b(x11), .O(new_n67_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n95_));
  ...
  nand4  g068(.a(new_n58_), .b(new_n70_), .c(new_n36_), .d(new_n83_), .O(new_n102_));
  ...
  nand4  g072(.a(new_n83_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n106_));
  nand4  g073(.a(new_n58_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n107_));
  ...
  nand4  g076(.a(new_n109_), .b(new_n104_), .c(new_n97_), .d(new_n67_), .O(z3));
  inv1   g077(.a(new_n49_), .O(new_n111_));
  inv1   g078(.a(x22), .O(new_n112_));
  oai21  g079(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n113_));
  ...
  nand3  g087(.a(new_n120_), .b(new_n116_), .c(new_n67_), .O(z4));
  ...
  nand3  g094(.a(new_n127_), .b(new_n44_), .c(new_n43_), .O(new_n128_));
  ...
  nand2  g100(.a(x07), .b(x03), .O(new_n134_));
  oai21  g101(.a(new_n71_), .b(x03), .c(new_n134_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n98_), .c(x24), .O(new_n136_));
  nand3  g103(.a(new_n131_), .b(new_n46_), .c(new_n37_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(new_n133_), .c(new_n67_), .O(new_n139_));
  oai21  g106(.a(new_n58_), .b(x14), .c(new_n35_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n111_), .c(new_n36_), .O(new_n141_));
  oai21  g108(.a(x20), .b(new_n70_), .c(x06), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n78_), .c(new_n57_), .d(x11), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n141_), .c(new_n139_), .O(z6));
  and2   g111(.a(new_n76_), .b(new_n75_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n77_), .c(new_n74_), .d(new_n67_), .O(z7));
endmodule
