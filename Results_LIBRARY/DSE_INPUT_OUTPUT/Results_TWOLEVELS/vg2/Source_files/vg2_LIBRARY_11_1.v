...
module FAU ( 
  ...
  oai21  g112(.a(new_n63_), .b(x04), .c(x17), .O(new_n146_));
  ...
  nand2  g116(.a(x02), .b(new_n67_), .O(new_n150_));
  ...
  nand2  g126(.a(new_n109_), .b(new_n108_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n107_), .c(new_n150_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n110_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n157_), .O(z6));
  nand4  g131(.a(new_n150_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n165_));
