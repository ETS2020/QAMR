...
module FAU ( 
  ...
  nand3  g062(.a(new_n64_), .b(x21), .c(x20), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n86_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n58_), .c(new_n56_), .d(x01), .O(new_n98_));
  ...
  oai21  g078(.a(new_n111_), .b(new_n108_), .c(new_n53_), .O(new_n112_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n34_), .c(new_n105_), .O(z2));
  ...
  nor2   g087(.a(new_n120_), .b(new_n67_), .O(new_n121_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n35_), .c(new_n34_), .d(new_n105_), .O(new_n128_));
  ...
  nand3  g099(.a(new_n99_), .b(x07), .c(new_n35_), .O(new_n133_));
  nand4  g100(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n67_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n99_), .b(new_n67_), .c(new_n35_), .O(new_n138_));
  nand4  g105(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n139_));
  ...
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n67_), .O(new_n146_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n73_), .c(x08), .O(new_n150_));
  inv1   g117(.a(new_n108_), .O(new_n151_));
  and2   g118(.a(new_n113_), .b(new_n110_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n109_), .c(new_n151_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n147_), .c(new_n53_), .O(z4));
  ...
  aoi21  g125(.a(x20), .b(new_n72_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n34_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(z5), .O(new_n161_));
  nand2  g128(.a(new_n113_), .b(new_n112_), .O(new_n162_));
  ...
  nand4  g133(.a(new_n152_), .b(new_n109_), .c(new_n151_), .d(new_n53_), .O(z7));
endmodule
