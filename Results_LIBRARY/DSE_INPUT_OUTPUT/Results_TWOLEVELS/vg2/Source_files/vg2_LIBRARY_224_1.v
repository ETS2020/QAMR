...
module FAU ( 
  ...
  nor2   g023(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  ...
  nor4   g041(.a(new_n74_), .b(new_n73_), .c(new_n36_), .d(new_n72_), .O(new_n75_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n66_), .O(new_n90_));
  oai21  g057(.a(new_n90_), .b(new_n85_), .c(new_n82_), .O(new_n91_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n84_), .c(x07), .d(new_n37_), .O(new_n101_));
  inv1   g068(.a(x17), .O(new_n102_));
  inv1   g069(.a(x16), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n41_), .c(new_n35_), .d(new_n48_), .O(new_n104_));
  inv1   g071(.a(new_n104_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n89_), .c(new_n42_), .d(new_n102_), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n101_), .c(new_n99_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n92_), .c(x24), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n95_), .c(new_n71_), .O(z1));
  ...
  nor2   g080(.a(x24), .b(new_n113_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n112_), .c(x20), .O(new_n115_));
  oai21  g082(.a(new_n115_), .b(new_n111_), .c(new_n35_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n34_), .O(new_n117_));
  nand2  g084(.a(x24), .b(x18), .O(new_n118_));
  nand3  g085(.a(new_n43_), .b(x15), .c(x13), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n118_), .c(new_n49_), .O(new_n120_));
  nand3  g087(.a(x24), .b(x18), .c(x13), .O(new_n121_));
  nand3  g088(.a(x15), .b(new_n54_), .c(new_n49_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n42_), .c(new_n41_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x03), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n72_), .c(new_n117_), .O(z2));
  inv1   g094(.a(x08), .O(new_n128_));
  nand3  g095(.a(x15), .b(x13), .c(x05), .O(new_n129_));
  nand3  g096(.a(x21), .b(new_n110_), .c(new_n34_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x20), .c(x14), .d(x11), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nand3  g101(.a(new_n110_), .b(new_n34_), .c(x00), .O(new_n135_));
  nand3  g102(.a(x19), .b(x13), .c(x05), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n42_), .c(new_n41_), .d(new_n48_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n37_), .c(new_n36_), .d(new_n72_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n134_), .c(x24), .O(new_n141_));
  nand4  g108(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n142_));
  nand2  g109(.a(new_n112_), .b(new_n98_), .O(new_n143_));
  nand4  g110(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n72_), .O(new_n144_));
  nand4  g111(.a(new_n42_), .b(new_n41_), .c(new_n48_), .d(new_n128_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n92_), .c(x24), .O(new_n147_));
  nand3  g114(.a(new_n112_), .b(x20), .c(x15), .O(new_n148_));
  nand3  g115(.a(new_n62_), .b(new_n36_), .c(new_n72_), .O(new_n149_));
  nand2  g116(.a(new_n88_), .b(new_n65_), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n142_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n54_), .c(new_n49_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n147_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n141_), .c(new_n35_), .O(new_n154_));
  nand2  g121(.a(new_n151_), .b(new_n94_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x02), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(z3));
  oai21  g125(.a(x23), .b(new_n73_), .c(new_n102_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n77_), .c(x09), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x16), .c(new_n128_), .O(new_n161_));
  inv1   g128(.a(new_n52_), .O(new_n162_));
  nor2   g129(.a(x02), .b(new_n38_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n43_), .c(new_n110_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n55_), .c(new_n53_), .d(new_n162_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  oai21  g133(.a(new_n78_), .b(x04), .c(x17), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x22), .c(new_n83_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n103_), .c(x08), .O(new_n169_));
  inv1   g136(.a(new_n120_), .O(new_n170_));
  nand3  g137(.a(new_n114_), .b(new_n110_), .c(new_n34_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n122_), .c(new_n121_), .d(new_n170_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nor2   g140(.a(new_n35_), .b(x02), .O(new_n174_));
  inv1   g141(.a(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n173_), .c(new_n166_), .O(z4));
  nand4  g143(.a(new_n163_), .b(new_n43_), .c(new_n35_), .d(new_n110_), .O(new_n177_));
  oai21  g144(.a(new_n174_), .b(new_n57_), .c(new_n177_), .O(z5));
  nand2  g145(.a(x20), .b(new_n41_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n37_), .c(x11), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x03), .c(new_n165_), .O(new_n181_));
  nand2  g148(.a(new_n42_), .b(x14), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(x06), .c(new_n48_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n36_), .c(new_n172_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n181_), .c(new_n175_), .O(z6));
  aoi21  g152(.a(new_n114_), .b(new_n110_), .c(x12), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(x02), .c(new_n124_), .O(z7));
endmodule
