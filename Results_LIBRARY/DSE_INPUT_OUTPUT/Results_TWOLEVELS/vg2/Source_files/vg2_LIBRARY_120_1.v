...
module FAU ( 
  ...
  nand3  g024(.a(x21), .b(new_n49_), .c(new_n37_), .O(new_n58_));
  ...
  nand3  g043(.a(new_n49_), .b(new_n37_), .c(x00), .O(new_n77_));
  ...
  nor2   g057(.a(new_n76_), .b(new_n75_), .O(new_n91_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(new_n35_), .d(new_n71_), .O(new_n97_));
  ...
  nand3  g071(.a(new_n104_), .b(new_n45_), .c(new_n39_), .O(new_n105_));
  nor2   g072(.a(x13), .b(x05), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n41_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(x17), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n72_), .c(new_n36_), .d(new_n56_), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(x11), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n71_), .c(new_n70_), .d(x07), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(x06), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n105_), .O(new_n115_));
  oai21  g082(.a(new_n115_), .b(new_n87_), .c(new_n55_), .O(new_n116_));
  inv1   g083(.a(new_n106_), .O(new_n117_));
  nand3  g084(.a(new_n41_), .b(x13), .c(x05), .O(new_n118_));
  ...
  nor2   g089(.a(new_n74_), .b(new_n55_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n122_), .c(new_n91_), .d(new_n89_), .O(new_n124_));
  inv1   g091(.a(x07), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(x06), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n95_), .c(new_n71_), .d(new_n70_), .O(new_n127_));
  nand4  g094(.a(new_n72_), .b(new_n36_), .c(new_n56_), .d(new_n35_), .O(new_n128_));
  inv1   g095(.a(new_n128_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n102_), .c(new_n74_), .d(new_n73_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n127_), .c(new_n124_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n117_), .c(x24), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n120_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(x02), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n116_), .O(z1));
  nand3  g102(.a(new_n119_), .b(new_n38_), .c(x15), .O(new_n136_));
  nand3  g103(.a(new_n107_), .b(x18), .c(x02), .O(new_n137_));
  nor2   g104(.a(x10), .b(x02), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n41_), .c(x21), .d(new_n55_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n137_), .c(new_n136_), .O(z7));
  nand4  g107(.a(z7), .b(x20), .c(x14), .d(x11), .O(new_n141_));
  inv1   g108(.a(new_n141_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(x06), .c(x03), .d(x01), .O(new_n143_));
  inv1   g110(.a(new_n143_), .O(z2));
  nand4  g111(.a(new_n59_), .b(x20), .c(x14), .d(x11), .O(new_n145_));
  nor2   g112(.a(new_n145_), .b(new_n70_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(x06), .c(x03), .d(x01), .O(new_n147_));
  nand4  g114(.a(new_n79_), .b(new_n74_), .c(new_n36_), .d(new_n35_), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(x08), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n147_), .c(x24), .O(new_n151_));
  nand4  g118(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n152_));
  nand4  g119(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n153_));
  nand3  g120(.a(new_n96_), .b(new_n68_), .c(new_n67_), .O(new_n154_));
  nand3  g121(.a(new_n101_), .b(new_n36_), .c(new_n35_), .O(new_n155_));
  ...
  nor3   g124(.a(new_n106_), .b(new_n41_), .c(x20), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n36_), .c(new_n35_), .d(new_n70_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(new_n125_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n151_), .c(new_n55_), .O(new_n163_));
  nand2  g130(.a(new_n156_), .b(new_n119_), .O(new_n164_));
  nand3  g131(.a(new_n123_), .b(x14), .c(x11), .O(new_n165_));
  nand3  g132(.a(new_n126_), .b(new_n68_), .c(new_n67_), .O(new_n166_));
  nand4  g133(.a(new_n74_), .b(new_n36_), .c(new_n35_), .d(new_n70_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(new_n152_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n117_), .c(x24), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n164_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x02), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n163_), .O(z3));
  oai21  g139(.a(x23), .b(new_n69_), .c(new_n73_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n75_), .c(x09), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x16), .c(new_n70_), .O(new_n175_));
  inv1   g142(.a(new_n43_), .O(new_n176_));
  nand4  g143(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n46_), .c(new_n44_), .d(new_n176_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  oai21  g146(.a(new_n76_), .b(x04), .c(x17), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(x22), .c(new_n71_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n72_), .c(x08), .O(new_n182_));
  nand3  g149(.a(new_n41_), .b(x15), .c(x13), .O(new_n183_));
  oai21  g150(.a(new_n41_), .b(new_n55_), .c(new_n183_), .O(new_n184_));
  ...
  nand3  g154(.a(new_n138_), .b(new_n41_), .c(x21), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n185_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n182_), .O(new_n190_));
  nand3  g157(.a(new_n190_), .b(new_n179_), .c(new_n38_), .O(z4));
  nand2  g158(.a(new_n51_), .b(new_n48_), .O(z5));
  nand2  g159(.a(x20), .b(new_n36_), .O(new_n193_));
  aoi21  g160(.a(new_n193_), .b(new_n34_), .c(x11), .O(new_n194_));
  oai21  g161(.a(new_n194_), .b(x03), .c(new_n178_), .O(new_n195_));
  nand2  g162(.a(new_n74_), .b(x14), .O(new_n196_));
  aoi21  g163(.a(new_n196_), .b(x06), .c(new_n35_), .O(new_n197_));
  oai21  g164(.a(new_n197_), .b(new_n68_), .c(new_n189_), .O(new_n198_));
