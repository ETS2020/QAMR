...
module FAU ( 
  ...
  oai21  g35(.a(x23), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n38_), .c(x09), .O(new_n70_));
  oai21  g37(.a(new_n70_), .b(x16), .c(new_n36_), .O(new_n71_));
  nand2  g38(.a(x24), .b(x07), .O(new_n72_));
  nand3  g39(.a(new_n41_), .b(x19), .c(x13), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g41(.a(x24), .b(x13), .c(x07), .O(new_n75_));
  nand4  g42(.a(new_n41_), .b(new_n48_), .c(new_n47_), .d(x00), .O(new_n76_));
  nand3  g43(.a(x19), .b(new_n45_), .c(new_n39_), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  aoi21  g45(.a(new_n74_), .b(x05), .c(new_n78_), .O(new_n79_));
  inv1   g46(.a(new_n79_), .O(new_n80_));
  nand2  g47(.a(new_n80_), .b(new_n71_), .O(new_n81_));
  inv1   g48(.a(x16), .O(new_n82_));
  inv1   g49(.a(x09), .O(new_n83_));
  inv1   g50(.a(x23), .O(new_n84_));
  oai21  g51(.a(new_n84_), .b(x04), .c(x17), .O(new_n85_));
  aoi21  g52(.a(new_n85_), .b(x22), .c(new_n83_), .O(new_n86_));
  oai21  g53(.a(new_n86_), .b(new_n82_), .c(x08), .O(new_n87_));
  aoi21  g54(.a(new_n87_), .b(new_n60_), .c(z0), .O(new_n88_));
  nand2  g55(.a(new_n88_), .b(new_n81_), .O(z4));
  nor2   g56(.a(new_n79_), .b(z0), .O(z5));
  inv1   g57(.a(x06), .O(new_n91_));
  aoi21  g58(.a(x14), .b(new_n91_), .c(x11), .O(new_n92_));
  oai21  g59(.a(new_n92_), .b(x03), .c(new_n80_), .O(new_n93_));
  nand2  g60(.a(x20), .b(x06), .O(new_n94_));
  nand2  g61(.a(new_n94_), .b(x11), .O(new_n95_));
  nand2  g62(.a(new_n95_), .b(x03), .O(new_n96_));
  aoi21  g63(.a(new_n96_), .b(new_n60_), .c(z0), .O(new_n97_));
  nand2  g64(.a(new_n97_), .b(new_n93_), .O(z6));
  nor2   g65(.a(new_n59_), .b(z0), .O(z7));
endmodule
