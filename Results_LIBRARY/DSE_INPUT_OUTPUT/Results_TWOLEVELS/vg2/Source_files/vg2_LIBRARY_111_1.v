...
module FAU ( 
  ...
  nand2  g129(.a(new_n39_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n37_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n35_), .c(new_n151_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n157_), .O(z6));
  and2   g133(.a(new_n157_), .b(new_n110_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n112_), .c(new_n111_), .d(new_n149_), .O(z7));
endmodule
