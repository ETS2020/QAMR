...
module FAU ( 
  ...
  nand4  g137(.a(new_n170_), .b(new_n48_), .c(new_n46_), .d(new_n169_), .O(z5));
  nand2  g138(.a(x20), .b(new_n90_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n35_), .c(x11), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n174_));
  nand2  g141(.a(new_n37_), .b(x14), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(x06), .c(new_n36_), .O(new_n176_));
  inv1   g143(.a(new_n121_), .O(new_n177_));
  and2   g144(.a(new_n165_), .b(new_n123_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n122_), .c(new_n177_), .O(new_n179_));
  oai21  g146(.a(new_n176_), .b(new_n34_), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n174_), .c(new_n53_), .O(z6));
  nand4  g148(.a(new_n178_), .b(new_n122_), .c(new_n177_), .d(new_n53_), .O(z7));
endmodule
