...
module FAU ( 
  ...
  and2   g141(.a(new_n166_), .b(new_n124_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n123_), .c(new_n122_), .O(new_n176_));
  oai21  g143(.a(new_n174_), .b(new_n34_), .c(new_n176_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n172_), .c(new_n53_), .O(z6));
  nand4  g145(.a(new_n175_), .b(new_n123_), .c(new_n122_), .d(new_n53_), .O(z7));
endmodule
