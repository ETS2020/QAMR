...
module FAU ( 
  ...
  nand3  g066(.a(new_n99_), .b(new_n38_), .c(new_n47_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n42_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n46_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n93_), .c(new_n81_), .O(z1));
  inv1   g070(.a(x01), .O(new_n104_));
  inv1   g071(.a(x03), .O(new_n105_));
  nand2  g072(.a(x24), .b(x18), .O(new_n106_));
  nand3  g073(.a(new_n38_), .b(x15), .c(x13), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(x05), .c(x02), .O(new_n109_));
  nand2  g076(.a(x15), .b(new_n43_), .O(new_n110_));
  nand3  g077(.a(x24), .b(x18), .c(x13), .O(new_n111_));
  nand4  g078(.a(new_n38_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n42_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n109_), .c(new_n60_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n105_), .c(new_n104_), .O(z2));
  nand4  g084(.a(new_n34_), .b(new_n105_), .c(new_n104_), .d(x00), .O(new_n118_));
  nand4  g085(.a(new_n60_), .b(new_n36_), .c(new_n35_), .d(new_n66_), .O(new_n119_));
  nand4  g086(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n120_));
  nand3  g087(.a(new_n94_), .b(x14), .c(x11), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n38_), .c(new_n47_), .d(new_n46_), .O(new_n123_));
  nand2  g090(.a(new_n111_), .b(new_n110_), .O(new_n124_));
  ...
  nand2  g094(.a(new_n45_), .b(new_n44_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n60_), .c(new_n36_), .d(new_n35_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(x08), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n34_), .c(new_n105_), .d(new_n104_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n127_), .c(new_n123_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n42_), .O(new_n133_));
  nand4  g100(.a(new_n108_), .b(x20), .c(x14), .d(x11), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n66_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nand4  g103(.a(new_n40_), .b(new_n60_), .c(new_n36_), .d(new_n35_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(x08), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n34_), .c(new_n105_), .d(new_n104_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(x05), .c(x02), .O(new_n141_));
  ...
  nand2  g113(.a(new_n40_), .b(x05), .O(new_n147_));
  nand3  g114(.a(x19), .b(new_n43_), .c(new_n42_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n48_), .c(new_n45_), .d(new_n147_), .O(new_n149_));
  ...
  nand2  g121(.a(new_n108_), .b(x05), .O(new_n155_));
  nand3  g122(.a(x15), .b(new_n43_), .c(new_n42_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n112_), .c(new_n111_), .d(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g125(.a(x05), .b(new_n46_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n158_), .c(new_n150_), .O(z4));
  nand2  g127(.a(new_n50_), .b(new_n41_), .O(z5));
  ...
  aoi21  g132(.a(new_n60_), .b(x14), .c(new_n34_), .O(new_n166_));
  ...
  nand3  g136(.a(new_n38_), .b(x21), .c(new_n47_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n42_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n46_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n156_), .c(new_n111_), .d(new_n155_), .O(z7));
endmodule
