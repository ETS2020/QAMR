...
module FAU ( 
  ...
  oai21  g010(.a(new_n43_), .b(new_n38_), .c(x22), .O(new_n44_));
  ...
  nand4  g074(.a(new_n107_), .b(new_n103_), .c(new_n100_), .d(new_n98_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n97_), .c(new_n85_), .O(z1));
  nand2  g076(.a(new_n104_), .b(new_n34_), .O(new_n110_));
  ...
  nor2   g084(.a(x24), .b(new_n104_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x21), .c(new_n101_), .d(new_n34_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n62_), .b(x03), .c(x01), .O(new_n123_));
  ...
  oai21  g107(.a(x16), .b(new_n69_), .c(new_n61_), .O(new_n141_));
  inv1   g108(.a(x00), .O(new_n142_));
  nor2   g109(.a(x02), .b(new_n142_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n41_), .c(new_n101_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n53_), .c(new_n51_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n50_), .c(new_n141_), .O(new_n146_));
  aoi21  g113(.a(new_n105_), .b(x04), .c(x17), .O(new_n147_));
  nor3   g114(.a(new_n147_), .b(new_n55_), .c(x16), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n34_), .c(new_n104_), .O(new_n149_));
  nand3  g116(.a(x21), .b(new_n101_), .c(new_n34_), .O(new_n150_));
  nand4  g117(.a(x22), .b(x15), .c(x13), .d(x05), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  oai21  g119(.a(new_n105_), .b(x04), .c(x17), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand3  g121(.a(x15), .b(x13), .c(x05), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n150_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n69_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n154_), .c(x24), .O(new_n158_));
  nand3  g125(.a(new_n82_), .b(x24), .c(x18), .O(new_n159_));
  nand2  g126(.a(new_n153_), .b(x22), .O(new_n160_));
  aoi22  g127(.a(new_n160_), .b(x09), .c(new_n159_), .d(new_n115_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n158_), .c(x16), .O(new_n162_));
  nand4  g129(.a(new_n41_), .b(x21), .c(new_n101_), .d(new_n34_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n115_), .c(new_n114_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n113_), .c(new_n61_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n162_), .c(new_n149_), .d(new_n146_), .O(z4));
  inv1   g133(.a(new_n110_), .O(new_n167_));
  nand3  g134(.a(new_n143_), .b(new_n118_), .c(new_n101_), .O(new_n168_));
  ...
  nand2  g139(.a(new_n119_), .b(new_n117_), .O(z7));
  aoi21  g140(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n46_), .c(x03), .O(new_n175_));
