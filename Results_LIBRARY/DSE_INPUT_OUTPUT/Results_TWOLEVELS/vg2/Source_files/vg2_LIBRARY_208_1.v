...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n65_), .d(new_n42_), .O(new_n71_));
  ...
  nand2  g045(.a(x20), .b(x17), .O(new_n79_));
  nand2  g046(.a(x23), .b(x22), .O(new_n80_));
  ...
  nand2  g064(.a(x20), .b(x18), .O(new_n98_));
  nor3   g065(.a(new_n98_), .b(new_n97_), .c(new_n80_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n77_), .c(new_n75_), .O(new_n100_));
  nor2   g067(.a(x09), .b(x08), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n84_), .c(x07), .d(new_n37_), .O(new_n102_));
  nand4  g069(.a(new_n90_), .b(new_n69_), .c(new_n42_), .d(new_n35_), .O(new_n103_));
  oai21  g070(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n93_), .c(x24), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n96_), .c(new_n73_), .O(z1));
  ...
  aoi21  g110(.a(new_n90_), .b(x04), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n134_), .O(new_n145_));
  nand2  g112(.a(new_n51_), .b(new_n50_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x05), .O(new_n147_));
  nand4  g114(.a(new_n43_), .b(new_n108_), .c(new_n34_), .d(x00), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n55_), .c(new_n53_), .d(new_n147_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  aoi21  g117(.a(new_n65_), .b(x09), .c(new_n67_), .O(new_n151_));
  nand3  g118(.a(new_n112_), .b(new_n108_), .c(new_n34_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n120_), .c(new_n119_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n118_), .c(new_n151_), .d(new_n134_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n35_), .O(new_n156_));
  nor2   g123(.a(new_n121_), .b(new_n118_), .O(new_n157_));
  oai21  g124(.a(new_n80_), .b(x04), .c(x09), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x16), .c(new_n134_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nor2   g127(.a(new_n56_), .b(new_n52_), .O(new_n161_));
  oai21  g128(.a(x22), .b(new_n35_), .c(new_n83_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n67_), .c(x08), .O(new_n163_));
  nor2   g130(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n160_), .c(x02), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n156_), .O(z4));
  nand3  g133(.a(new_n43_), .b(new_n108_), .c(x00), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n35_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n34_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n161_), .O(z5));
  nand2  g137(.a(x20), .b(new_n41_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n37_), .c(x11), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x03), .c(new_n149_), .O(new_n173_));
  nand2  g140(.a(new_n42_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n48_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n36_), .c(new_n153_), .d(new_n118_), .O(new_n176_));
  nand2  g143(.a(x17), .b(new_n34_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n176_), .c(new_n173_), .O(z6));
  aoi21  g145(.a(new_n112_), .b(new_n108_), .c(x17), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(x02), .c(new_n157_), .O(z7));
endmodule
