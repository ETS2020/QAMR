...
module FAU ( 
  ...
  oai21  g125(.a(new_n49_), .b(new_n42_), .c(new_n158_), .O(new_n159_));
  ...
  nand3  g129(.a(new_n147_), .b(new_n45_), .c(new_n44_), .O(new_n163_));
  and2   g130(.a(new_n163_), .b(new_n124_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n123_), .c(new_n122_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n159_), .c(new_n53_), .O(z4));
  ...
  aoi21  g137(.a(x20), .b(new_n90_), .c(x06), .O(new_n171_));
  ...
  nand2  g144(.a(new_n177_), .b(new_n163_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n173_), .O(z6));
  nand4  g147(.a(new_n164_), .b(new_n123_), .c(new_n122_), .d(new_n53_), .O(z7));
endmodule
