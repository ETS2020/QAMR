...
module FAU ( 
  ...
  nor2   g034(.a(new_n35_), .b(new_n67_), .O(new_n68_));
  nand4  g035(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n62_), .O(new_n69_));
  ...
  nand2  g047(.a(new_n53_), .b(new_n48_), .O(new_n81_));
  ...
  nand4  g054(.a(new_n87_), .b(new_n86_), .c(new_n68_), .d(new_n62_), .O(new_n88_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n78_), .c(new_n41_), .d(new_n65_), .O(new_n97_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n70_), .c(new_n89_), .O(new_n103_));
  nor3   g070(.a(new_n103_), .b(x06), .c(x04), .O(new_n104_));
  nor2   g071(.a(x24), .b(x23), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n67_), .O(new_n106_));
  nor3   g073(.a(new_n106_), .b(x20), .c(x17), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n104_), .c(new_n101_), .d(new_n96_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n99_), .c(new_n84_), .O(z1));
  nand4  g076(.a(new_n102_), .b(x06), .c(x03), .d(x01), .O(new_n110_));
  nor2   g077(.a(new_n40_), .b(new_n47_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n42_), .c(x21), .d(x20), .O(new_n112_));
  ...
  nand3  g082(.a(new_n42_), .b(x15), .c(x13), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n115_), .c(new_n48_), .O(new_n117_));
  nand3  g084(.a(x24), .b(x18), .c(x13), .O(new_n118_));
  nand3  g085(.a(x15), .b(new_n53_), .c(new_n48_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nor3   g088(.a(new_n121_), .b(new_n41_), .c(new_n40_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x11), .c(x06), .d(x03), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n36_), .c(new_n114_), .O(z2));
  nand3  g091(.a(x15), .b(x13), .c(x05), .O(new_n125_));
  nand3  g092(.a(x21), .b(new_n102_), .c(new_n34_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x20), .c(x14), .d(x11), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n89_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  nand3  g097(.a(new_n102_), .b(new_n34_), .c(x00), .O(new_n131_));
  nand3  g098(.a(x19), .b(x13), .c(x05), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n41_), .c(new_n40_), .d(new_n47_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n130_), .c(x24), .O(new_n137_));
  nand4  g104(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n138_));
  nand2  g105(.a(new_n111_), .b(new_n87_), .O(new_n139_));
  nand3  g106(.a(new_n91_), .b(new_n37_), .c(new_n36_), .O(new_n140_));
  nand4  g107(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n89_), .O(new_n141_));
  ...
  nand3  g110(.a(new_n111_), .b(x20), .c(x15), .O(new_n144_));
  nand3  g111(.a(new_n72_), .b(new_n37_), .c(new_n36_), .O(new_n145_));
  nand3  g112(.a(new_n77_), .b(new_n40_), .c(new_n47_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n53_), .c(new_n48_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(new_n35_), .O(new_n150_));
  nand2  g117(.a(new_n147_), .b(new_n83_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n143_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x02), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(z3));
  nand2  g121(.a(x22), .b(new_n65_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x09), .c(new_n94_), .O(new_n156_));
  nor2   g123(.a(x10), .b(x02), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n42_), .c(x21), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n119_), .c(new_n118_), .O(new_n159_));
  or2    g126(.a(new_n159_), .b(new_n117_), .O(new_n160_));
  oai21  g127(.a(new_n156_), .b(new_n89_), .c(new_n160_), .O(new_n161_));
  aoi21  g128(.a(new_n35_), .b(x04), .c(x17), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x22), .c(new_n70_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n94_), .c(x08), .O(new_n164_));
  inv1   g131(.a(x04), .O(new_n165_));
  nand4  g132(.a(new_n68_), .b(x16), .c(x15), .d(new_n165_), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(new_n76_), .c(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n83_), .O(new_n168_));
  nand4  g135(.a(new_n68_), .b(x18), .c(x16), .d(new_n165_), .O(new_n169_));
  oai21  g136(.a(new_n164_), .b(new_n90_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n81_), .c(x24), .O(new_n171_));
  nor2   g138(.a(x17), .b(x04), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x22), .c(new_n70_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n94_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n89_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n42_), .c(new_n102_), .d(x00), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n35_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n34_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n171_), .c(new_n168_), .d(new_n161_), .O(z4));
  nand3  g146(.a(new_n42_), .b(new_n102_), .c(x00), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n35_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n34_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n56_), .O(z5));
  nand2  g150(.a(x20), .b(new_n40_), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(new_n38_), .c(x11), .O(new_n185_));
  nand4  g152(.a(new_n42_), .b(new_n102_), .c(new_n34_), .d(x00), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n54_), .c(new_n52_), .O(new_n187_));
  oai22  g154(.a(new_n187_), .b(new_n51_), .c(new_n185_), .d(x03), .O(new_n188_));
  nand2  g155(.a(new_n41_), .b(x14), .O(new_n189_));
  aoi21  g156(.a(new_n189_), .b(x06), .c(new_n47_), .O(new_n190_));
  oai21  g157(.a(new_n190_), .b(new_n37_), .c(new_n160_), .O(new_n191_));
  nor2   g158(.a(new_n35_), .b(x02), .O(new_n192_));
  inv1   g159(.a(new_n192_), .O(new_n193_));
  nand3  g160(.a(new_n193_), .b(new_n191_), .c(new_n188_), .O(z6));
  nand3  g161(.a(new_n157_), .b(new_n105_), .c(x21), .O(new_n195_));
  oai21  g162(.a(new_n192_), .b(new_n121_), .c(new_n195_), .O(z7));
endmodule
