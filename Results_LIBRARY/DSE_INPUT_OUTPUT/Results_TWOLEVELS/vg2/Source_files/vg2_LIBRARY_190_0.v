...
module FAU ( 
  ...
  nand4  g111(.a(new_n40_), .b(new_n106_), .c(new_n51_), .d(x00), .O(new_n145_));
  ...
  nor2   g125(.a(new_n46_), .b(new_n42_), .O(new_n159_));
  nand3  g126(.a(new_n40_), .b(new_n106_), .c(x00), .O(new_n160_));
  ...
  oai21  g137(.a(new_n118_), .b(new_n115_), .c(new_n157_), .O(new_n171_));
  nand3  g138(.a(new_n135_), .b(new_n109_), .c(new_n106_), .O(new_n172_));
