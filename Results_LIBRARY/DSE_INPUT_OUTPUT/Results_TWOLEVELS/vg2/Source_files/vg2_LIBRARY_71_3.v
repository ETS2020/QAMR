...
module FAU ( 
  ...
  nand4  g064(.a(new_n34_), .b(new_n44_), .c(new_n97_), .d(x00), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n86_), .c(new_n35_), .d(new_n96_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n91_), .c(new_n95_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n40_), .c(new_n45_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n93_), .c(new_n81_), .d(new_n53_), .O(z1));
  ...
  oai21  g076(.a(new_n109_), .b(new_n106_), .c(new_n53_), .O(new_n110_));
  ...
  nor3   g080(.a(new_n113_), .b(new_n34_), .c(new_n97_), .O(z2));
  ...
  nand4  g092(.a(new_n125_), .b(new_n37_), .c(new_n122_), .d(new_n36_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n35_), .c(new_n34_), .d(new_n97_), .O(new_n128_));
  ...
  nand4  g099(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n97_), .O(new_n133_));
  nand4  g100(.a(new_n37_), .b(new_n122_), .c(new_n36_), .d(new_n115_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n68_), .b(new_n34_), .c(new_n97_), .O(new_n138_));
  nand3  g105(.a(new_n73_), .b(new_n122_), .c(new_n36_), .O(new_n139_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n136_), .c(new_n130_), .d(new_n53_), .O(z3));
  oai21  g109(.a(x23), .b(new_n96_), .c(new_n60_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n62_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n115_), .O(new_n145_));
  ...
  nand2  g116(.a(new_n111_), .b(new_n110_), .O(new_n150_));
  ...
  nand4  g125(.a(new_n158_), .b(new_n53_), .c(new_n48_), .d(new_n157_), .O(z5));
  aoi21  g126(.a(x20), .b(new_n122_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n148_), .O(new_n162_));
  ...
  inv1   g133(.a(new_n106_), .O(new_n167_));
  and2   g134(.a(new_n111_), .b(new_n108_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n107_), .c(new_n167_), .d(new_n53_), .O(z7));
endmodule
