...
module FAU ( 
  ...
  aoi21  g096(.a(new_n77_), .b(new_n76_), .c(x23), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n74_), .c(new_n71_), .d(new_n36_), .O(new_n131_));
  ...
  nand4  g105(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n139_));
  nor2   g106(.a(x23), .b(x20), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n141_));
  ...
  nand4  g112(.a(new_n140_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n146_));
  ...
  nor2   g117(.a(x17), .b(x04), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x22), .c(new_n70_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n52_), .c(new_n72_), .O(new_n153_));
  ...
  nand3  g125(.a(new_n158_), .b(x16), .c(x08), .O(new_n159_));
  oai21  g126(.a(x23), .b(x08), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g131(.a(new_n164_), .b(new_n54_), .c(new_n47_), .d(new_n163_), .O(z5));
  nand2  g132(.a(x20), .b(new_n71_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n35_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n150_), .O(new_n168_));
  nand2  g135(.a(new_n74_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n36_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n34_), .c(new_n156_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n54_), .O(z6));
  aoi21  g139(.a(x23), .b(new_n69_), .c(new_n123_), .O(z7));
endmodule
