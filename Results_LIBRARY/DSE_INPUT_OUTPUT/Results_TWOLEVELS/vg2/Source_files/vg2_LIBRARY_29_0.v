...
module FAU ( 
  ...
  nand2  g104(.a(new_n100_), .b(new_n51_), .O(new_n138_));
  inv1   g105(.a(new_n138_), .O(new_n139_));
  nor2   g106(.a(x24), .b(new_n100_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n106_), .c(new_n51_), .d(x00), .O(new_n141_));
  ...
  oai21  g111(.a(new_n59_), .b(x04), .c(x17), .O(new_n145_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n103_), .c(new_n138_), .O(new_n149_));
  nand4  g116(.a(new_n115_), .b(x14), .c(new_n106_), .d(new_n51_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n149_), .O(z7));
  nand2  g118(.a(z7), .b(new_n147_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n143_), .O(z4));
  nand3  g120(.a(new_n40_), .b(new_n106_), .c(x00), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x14), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n51_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n137_), .O(z5));
  oai21  g124(.a(x11), .b(new_n36_), .c(new_n35_), .O(new_n158_));
  nand4  g125(.a(new_n40_), .b(new_n106_), .c(new_n51_), .d(x00), .O(new_n159_));
  ...
  oai21  g129(.a(x20), .b(new_n100_), .c(x06), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x11), .c(new_n35_), .O(new_n164_));
  nand4  g131(.a(x20), .b(new_n100_), .c(new_n54_), .d(x07), .O(new_n165_));
  ...
  nand4  g135(.a(x20), .b(x19), .c(new_n100_), .d(new_n54_), .O(new_n169_));
  ...
  nand4  g140(.a(new_n173_), .b(new_n40_), .c(x21), .d(new_n106_), .O(new_n174_));
