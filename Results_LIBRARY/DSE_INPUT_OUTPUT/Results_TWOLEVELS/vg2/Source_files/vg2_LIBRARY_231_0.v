...
module FAU ( 
  ...
  nand3  g097(.a(new_n110_), .b(x20), .c(x18), .O(new_n131_));
  ...
  nand3  g102(.a(new_n110_), .b(x21), .c(x20), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n125_), .c(new_n133_), .d(new_n38_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n41_), .c(new_n101_), .O(new_n138_));
  ...
  oai21  g110(.a(x23), .b(new_n70_), .c(new_n143_), .O(new_n144_));
  ...
  nand3  g115(.a(new_n148_), .b(new_n41_), .c(new_n101_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n53_), .c(new_n51_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n50_), .c(new_n146_), .O(new_n151_));
  ...
  nand3  g123(.a(new_n111_), .b(new_n101_), .c(new_n34_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n119_), .c(new_n118_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n117_), .c(new_n156_), .O(new_n159_));
  nor2   g126(.a(x12), .b(x02), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n159_), .c(new_n151_), .O(z4));
  oai21  g129(.a(new_n54_), .b(new_n50_), .c(new_n161_), .O(new_n163_));
  nand4  g130(.a(new_n148_), .b(new_n41_), .c(x12), .d(new_n101_), .O(new_n164_));
  ...
  oai21  g137(.a(new_n120_), .b(new_n117_), .c(new_n161_), .O(new_n171_));
  nand4  g138(.a(new_n111_), .b(x12), .c(new_n101_), .d(new_n34_), .O(new_n172_));
