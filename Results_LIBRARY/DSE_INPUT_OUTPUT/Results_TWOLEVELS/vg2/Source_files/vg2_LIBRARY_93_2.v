...
module FAU ( 
  ...
  nor2   g020(.a(x21), .b(new_n53_), .O(new_n54_));
  ...
  nand3  g043(.a(new_n43_), .b(new_n76_), .c(x00), .O(new_n77_));
  ...
  nand4  g048(.a(new_n81_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n82_));
  nor2   g049(.a(new_n82_), .b(x12), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n36_), .c(new_n69_), .d(new_n68_), .O(new_n84_));
  nor2   g051(.a(new_n84_), .b(x06), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(new_n67_), .c(new_n34_), .d(new_n66_), .O(new_n86_));
  nand2  g053(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  nand2  g054(.a(new_n87_), .b(new_n39_), .O(new_n88_));
  nand2  g055(.a(new_n47_), .b(new_n37_), .O(new_n89_));
  ...
  nand4  g066(.a(new_n71_), .b(new_n70_), .c(new_n53_), .d(new_n36_), .O(new_n100_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n97_), .c(new_n36_), .d(new_n69_), .O(new_n111_));
  ...
  nand3  g084(.a(new_n117_), .b(new_n47_), .c(new_n37_), .O(new_n118_));
  ...
  aoi21  g090(.a(new_n123_), .b(new_n122_), .c(new_n37_), .O(new_n124_));
  nand3  g091(.a(x24), .b(x18), .c(x13), .O(new_n125_));
  nand3  g092(.a(x15), .b(new_n47_), .c(new_n37_), .O(new_n126_));
  inv1   g093(.a(x21), .O(new_n127_));
  nor2   g094(.a(x24), .b(new_n127_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n43_), .c(new_n76_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n126_), .c(new_n125_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n124_), .c(x20), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n70_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x11), .c(x06), .d(x03), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n66_), .c(new_n55_), .O(z2));
  nand3  g101(.a(x21), .b(new_n43_), .c(new_n76_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n57_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(x20), .c(x14), .d(x11), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n68_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  nand4  g106(.a(new_n79_), .b(new_n73_), .c(new_n70_), .d(new_n36_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(x08), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n142_));
  ...
  nand3  g112(.a(new_n94_), .b(x14), .c(x11), .O(new_n146_));
  nand4  g113(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n147_));
  nand4  g114(.a(new_n73_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n148_));
  ...
  nand3  g118(.a(new_n110_), .b(new_n34_), .c(new_n66_), .O(new_n152_));
  nand3  g119(.a(new_n115_), .b(new_n70_), .c(new_n36_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n145_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n47_), .c(new_n37_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n150_), .c(new_n144_), .d(new_n55_), .O(z3));
  oai21  g123(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n74_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n68_), .O(new_n159_));
  nand2  g126(.a(new_n48_), .b(new_n42_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n41_), .c(new_n55_), .O(new_n161_));
  nand4  g128(.a(new_n45_), .b(new_n39_), .c(new_n53_), .d(new_n43_), .O(new_n162_));
  ...
  aoi21  g132(.a(new_n165_), .b(x22), .c(new_n69_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n71_), .c(x08), .O(new_n167_));
  nand2  g134(.a(new_n126_), .b(new_n125_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n124_), .c(new_n55_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n129_), .O(z7));
  nand2  g137(.a(z7), .b(new_n167_), .O(new_n171_));
  nand3  g138(.a(new_n128_), .b(new_n45_), .c(new_n43_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n171_), .c(new_n164_), .O(z4));
  nor2   g140(.a(new_n54_), .b(new_n50_), .O(z5));
  aoi21  g141(.a(x20), .b(new_n70_), .c(x06), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(x11), .c(new_n34_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n163_), .O(new_n177_));
  aoi21  g144(.a(new_n73_), .b(x14), .c(new_n35_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n36_), .c(x03), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(z7), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n177_), .c(new_n172_), .O(z6));
endmodule
