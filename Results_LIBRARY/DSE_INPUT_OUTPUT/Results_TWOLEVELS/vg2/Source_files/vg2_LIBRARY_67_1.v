...
module FAU ( 
  ...
  nand3  g131(.a(new_n150_), .b(new_n50_), .c(new_n45_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(x03), .O(new_n166_));
  nand2  g133(.a(new_n39_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n37_), .O(new_n168_));
  oai22  g135(.a(new_n168_), .b(new_n35_), .c(new_n120_), .d(new_n116_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n147_), .O(z6));
endmodule
