...
module FAU ( 
  ...
  nor4   g046(.a(new_n79_), .b(new_n61_), .c(x17), .d(new_n52_), .O(new_n80_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n61_), .c(new_n52_), .d(new_n36_), .O(new_n93_));
  ...
  nor2   g066(.a(new_n52_), .b(new_n36_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(x20), .c(x18), .O(new_n101_));
  nand4  g068(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n71_), .O(new_n102_));
  nand4  g069(.a(new_n61_), .b(new_n52_), .c(new_n36_), .d(new_n83_), .O(new_n103_));
  ...
  nand4  g073(.a(new_n83_), .b(new_n35_), .c(new_n34_), .d(new_n71_), .O(new_n107_));
  nand4  g074(.a(new_n61_), .b(x19), .c(new_n52_), .d(new_n36_), .O(new_n108_));
  oai22  g075(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n99_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n46_), .c(new_n37_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n105_), .c(new_n97_), .d(new_n55_), .O(z3));
  ...
  nand2  g081(.a(new_n114_), .b(new_n58_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n60_), .c(x08), .O(new_n116_));
  inv1   g083(.a(new_n79_), .O(new_n117_));
  oai21  g084(.a(new_n62_), .b(x04), .c(x17), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(x22), .c(new_n58_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n60_), .c(x08), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n117_), .c(new_n54_), .O(new_n121_));
  oai21  g088(.a(new_n116_), .b(new_n49_), .c(new_n121_), .O(z4));
  nor2   g089(.a(new_n54_), .b(new_n49_), .O(z5));
  aoi21  g090(.a(new_n36_), .b(x06), .c(x03), .O(new_n124_));
  aoi21  g091(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n79_), .c(new_n124_), .d(new_n49_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n55_), .O(new_n127_));
  inv1   g094(.a(new_n100_), .O(new_n128_));
  nand4  g095(.a(x20), .b(new_n52_), .c(new_n36_), .d(x00), .O(new_n129_));
  nand3  g096(.a(x21), .b(new_n61_), .c(new_n53_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n128_), .c(new_n129_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n44_), .c(new_n43_), .O(new_n132_));
  nand4  g099(.a(x20), .b(x19), .c(new_n52_), .d(new_n36_), .O(new_n133_));
  nand4  g100(.a(new_n100_), .b(new_n61_), .c(new_n53_), .d(x15), .O(new_n134_));
  ...
  nand4  g105(.a(x20), .b(new_n52_), .c(new_n36_), .d(x07), .O(new_n139_));
  nand3  g106(.a(new_n61_), .b(x18), .c(new_n53_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n128_), .c(new_n139_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n98_), .c(x24), .O(new_n142_));
  nand3  g109(.a(new_n135_), .b(new_n46_), .c(new_n37_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n142_), .c(new_n138_), .d(new_n127_), .O(z6));
  inv1   g111(.a(new_n74_), .O(new_n145_));
  and2   g112(.a(new_n76_), .b(new_n75_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n77_), .c(new_n145_), .d(new_n55_), .O(z7));
endmodule
