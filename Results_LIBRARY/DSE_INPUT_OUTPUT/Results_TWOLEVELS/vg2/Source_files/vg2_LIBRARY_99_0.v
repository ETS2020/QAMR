...
module FAU ( 
  ...
  nand3  g109(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n136_), .O(new_n145_));
  nand3  g112(.a(new_n41_), .b(x21), .c(new_n64_), .O(new_n146_));
  inv1   g113(.a(new_n146_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(x07), .c(new_n34_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n145_), .c(new_n40_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(x14), .c(x11), .d(x06), .O(new_n150_));
  nor3   g117(.a(new_n150_), .b(new_n36_), .c(new_n35_), .O(z2));
  nand4  g118(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n152_));
  nor2   g119(.a(new_n39_), .b(new_n46_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(x20), .c(x15), .O(new_n154_));
  nand3  g121(.a(new_n112_), .b(new_n60_), .c(new_n37_), .O(new_n155_));
  nand3  g122(.a(new_n96_), .b(new_n39_), .c(new_n46_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n152_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n123_), .O(new_n158_));
  nand2  g125(.a(new_n153_), .b(new_n105_), .O(new_n159_));
  nand3  g126(.a(new_n112_), .b(x07), .c(new_n37_), .O(new_n160_));
  nand4  g127(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n60_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n160_), .c(new_n159_), .d(new_n152_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n101_), .c(x24), .O(new_n163_));
  nand3  g130(.a(new_n153_), .b(x21), .c(x20), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n152_), .c(new_n161_), .d(new_n38_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n41_), .c(new_n64_), .O(new_n166_));
  ...
  oai21  g136(.a(x23), .b(new_n73_), .c(new_n107_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n86_), .c(x09), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x16), .c(new_n60_), .O(new_n172_));
  nand4  g139(.a(new_n41_), .b(new_n64_), .c(new_n34_), .d(x00), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n53_), .c(new_n51_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n50_), .c(new_n172_), .O(new_n175_));
  oai21  g142(.a(new_n62_), .b(x04), .c(x17), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(x22), .c(new_n74_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n61_), .c(x08), .O(new_n178_));
  nand4  g145(.a(new_n41_), .b(x21), .c(new_n64_), .d(new_n34_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n143_), .c(new_n142_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n140_), .c(new_n178_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n175_), .c(new_n136_), .O(z4));
  nand2  g149(.a(new_n123_), .b(x02), .O(new_n183_));
  nor2   g150(.a(new_n52_), .b(new_n47_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n100_), .c(x07), .O(new_n185_));
  aoi21  g152(.a(new_n185_), .b(new_n183_), .c(new_n95_), .O(new_n186_));
  inv1   g153(.a(new_n125_), .O(new_n187_));
  aoi21  g154(.a(new_n173_), .b(new_n187_), .c(new_n59_), .O(new_n188_));
  or2    g155(.a(new_n188_), .b(new_n186_), .O(z5));
  ...
  nor2   g161(.a(new_n187_), .b(new_n104_), .O(new_n195_));
  nand3  g162(.a(new_n136_), .b(new_n123_), .c(x15), .O(new_n196_));
  nand2  g163(.a(new_n195_), .b(x02), .O(new_n197_));
  nand3  g164(.a(new_n197_), .b(new_n196_), .c(new_n148_), .O(new_n198_));
  aoi22  g165(.a(new_n198_), .b(new_n194_), .c(new_n195_), .d(x07), .O(new_n199_));
  nand2  g166(.a(new_n199_), .b(new_n192_), .O(z6));
  inv1   g167(.a(new_n144_), .O(new_n201_));
  oai21  g168(.a(new_n147_), .b(new_n59_), .c(new_n34_), .O(new_n202_));
  nand2  g169(.a(new_n202_), .b(new_n201_), .O(z7));
endmodule
