...
module FAU ( 
  ...
  and2   g127(.a(new_n145_), .b(new_n43_), .O(new_n161_));
  ...
  and2   g134(.a(new_n156_), .b(new_n113_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n112_), .c(new_n111_), .O(new_n169_));
  oai21  g136(.a(new_n167_), .b(new_n34_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(new_n145_), .O(z6));
  nand4  g138(.a(new_n168_), .b(new_n145_), .c(new_n112_), .d(new_n111_), .O(z7));
endmodule
