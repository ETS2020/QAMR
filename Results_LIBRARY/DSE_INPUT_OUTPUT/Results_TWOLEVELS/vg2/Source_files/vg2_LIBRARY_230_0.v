...
module FAU ( 
  ...
  or2    g113(.a(new_n146_), .b(new_n42_), .O(new_n147_));
  ...
  or2    g120(.a(new_n153_), .b(new_n115_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nor2   g122(.a(x02), .b(x01), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n155_), .c(new_n148_), .O(z4));
  oai21  g125(.a(new_n46_), .b(new_n42_), .c(new_n157_), .O(new_n159_));
  nand4  g126(.a(new_n144_), .b(new_n51_), .c(x01), .d(x00), .O(new_n160_));
  ...
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n157_), .O(z6));
  oai21  g135(.a(new_n118_), .b(new_n115_), .c(new_n157_), .O(new_n169_));
  nand4  g136(.a(new_n109_), .b(new_n106_), .c(new_n51_), .d(x01), .O(new_n170_));
