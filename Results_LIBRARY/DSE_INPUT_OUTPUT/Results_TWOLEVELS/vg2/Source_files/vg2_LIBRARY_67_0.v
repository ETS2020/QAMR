...
module FAU ( 
  ...
  oai21  g121(.a(new_n154_), .b(new_n110_), .c(new_n145_), .O(new_n155_));
  ...
  nand3  g128(.a(new_n147_), .b(new_n54_), .c(x00), .O(new_n162_));
  ...
  oai22  g133(.a(new_n166_), .b(new_n34_), .c(new_n115_), .d(new_n110_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n145_), .O(z6));
endmodule
