...
module FAU ( 
  ...
  nand4  g048(.a(new_n81_), .b(new_n68_), .c(new_n67_), .d(new_n36_), .O(new_n82_));
  ...
  nor2   g053(.a(new_n36_), .b(new_n35_), .O(new_n87_));
  ...
  nand4  g063(.a(new_n67_), .b(new_n36_), .c(x07), .d(new_n35_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n70_), .b(new_n69_), .c(new_n54_), .d(new_n68_), .O(new_n99_));
  ...
  nand4  g074(.a(new_n68_), .b(new_n67_), .c(new_n36_), .d(new_n35_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand4  g076(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n54_), .O(new_n110_));
  inv1   g077(.a(x19), .O(new_n111_));
  nor2   g078(.a(x20), .b(new_n111_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n74_), .c(new_n73_), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n109_), .c(new_n96_), .O(new_n115_));
  ...
  nor2   g085(.a(new_n39_), .b(new_n92_), .O(new_n119_));
  ...
  nor3   g095(.a(new_n128_), .b(new_n72_), .c(new_n69_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x11), .c(x06), .d(x03), .O(new_n130_));
  nor2   g097(.a(new_n36_), .b(x01), .O(new_n131_));
  inv1   g098(.a(new_n131_), .O(new_n132_));
  oai21  g099(.a(new_n130_), .b(new_n65_), .c(new_n132_), .O(z2));
  nand4  g100(.a(new_n77_), .b(new_n72_), .c(new_n69_), .d(new_n68_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n57_), .b(x20), .c(x14), .d(x11), .O(new_n138_));
  nor4   g105(.a(new_n138_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n137_), .c(new_n39_), .O(new_n140_));
  nand2  g107(.a(new_n46_), .b(new_n37_), .O(new_n141_));
  nand2  g108(.a(new_n87_), .b(x03), .O(new_n142_));
  nand3  g109(.a(new_n93_), .b(x14), .c(x11), .O(new_n143_));
  nand4  g110(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n144_));
  nand4  g111(.a(new_n72_), .b(new_n69_), .c(new_n68_), .d(new_n36_), .O(new_n145_));
  ...
  nand4  g114(.a(new_n36_), .b(new_n35_), .c(new_n37_), .d(new_n34_), .O(new_n148_));
  nand4  g115(.a(new_n112_), .b(new_n69_), .c(new_n46_), .d(new_n68_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n148_), .c(new_n36_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n65_), .O(new_n151_));
  nand3  g118(.a(x20), .b(x15), .c(x14), .O(new_n152_));
  nor3   g119(.a(new_n152_), .b(x13), .c(new_n68_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n87_), .c(new_n37_), .d(x03), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n151_), .c(new_n147_), .d(new_n140_), .O(z3));
  inv1   g122(.a(new_n50_), .O(new_n156_));
  aoi21  g123(.a(new_n74_), .b(x04), .c(x17), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x22), .c(new_n67_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n70_), .c(new_n36_), .O(new_n159_));
  oai21  g126(.a(new_n36_), .b(new_n65_), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  inv1   g128(.a(new_n128_), .O(new_n162_));
  aoi21  g129(.a(x23), .b(new_n66_), .c(new_n71_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n73_), .c(x09), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(x16), .c(x01), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x08), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n161_), .O(z4));
  inv1   g135(.a(new_n41_), .O(new_n169_));
  nand4  g136(.a(new_n132_), .b(new_n48_), .c(new_n42_), .d(new_n169_), .O(z5));
  ...
  nand2  g140(.a(new_n72_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n68_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n34_), .c(new_n162_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n173_), .c(new_n131_), .O(z6));
  inv1   g144(.a(new_n122_), .O(new_n178_));
  nand4  g145(.a(new_n132_), .b(new_n126_), .c(new_n123_), .d(new_n178_), .O(z7));
endmodule
