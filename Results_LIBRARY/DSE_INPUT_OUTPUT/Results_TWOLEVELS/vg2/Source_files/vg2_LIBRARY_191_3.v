...
module FAU ( 
  ...
  nand2  g055(.a(new_n42_), .b(new_n37_), .O(new_n89_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n103_), .c(new_n74_), .d(new_n73_), .O(new_n105_));
  ...
  nand3  g086(.a(new_n119_), .b(new_n42_), .c(new_n37_), .O(new_n120_));
  ...
  nand3  g095(.a(x15), .b(new_n42_), .c(new_n37_), .O(new_n129_));
  ...
  nand3  g113(.a(new_n100_), .b(new_n34_), .c(new_n67_), .O(new_n147_));
  ...
  nand3  g118(.a(new_n112_), .b(new_n34_), .c(new_n67_), .O(new_n152_));
  nand3  g119(.a(new_n117_), .b(new_n71_), .c(new_n36_), .O(new_n153_));
  ...
  oai21  g135(.a(new_n43_), .b(x02), .c(x07), .O(new_n169_));
  ...
  nand4  g145(.a(new_n131_), .b(new_n128_), .c(new_n178_), .d(new_n54_), .O(z7));
endmodule
