...
module FAU ( 
  ...
  oai22  g132(.a(new_n165_), .b(new_n34_), .c(new_n113_), .d(new_n108_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n142_), .O(z6));
endmodule
