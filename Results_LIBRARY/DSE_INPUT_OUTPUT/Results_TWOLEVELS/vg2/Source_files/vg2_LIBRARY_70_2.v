...
module FAU ( 
  ...
  inv1   g108(.a(new_n109_), .O(new_n142_));
  inv1   g109(.a(new_n113_), .O(new_n143_));
  ...
  nand2  g117(.a(new_n36_), .b(x02), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n150_), .c(new_n141_), .O(z4));
  nand3  g119(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n139_), .O(z5));
  nand2  g122(.a(x20), .b(new_n38_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n36_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n140_), .O(new_n158_));
  nand3  g125(.a(new_n39_), .b(x14), .c(x11), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x03), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n144_), .O(new_n161_));
  nand3  g128(.a(new_n41_), .b(x21), .c(new_n46_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n111_), .c(new_n110_), .O(new_n163_));
  inv1   g130(.a(new_n163_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n142_), .c(new_n37_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x02), .c(new_n36_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n161_), .c(new_n158_), .O(z6));
  nand2  g134(.a(new_n111_), .b(new_n110_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n109_), .c(new_n151_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n112_), .O(z7));
endmodule
