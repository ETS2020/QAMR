...
module FAU ( 
  ...
  and2   g136(.a(new_n155_), .b(new_n43_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n48_), .c(new_n46_), .d(new_n169_), .O(z5));
  nand2  g138(.a(x20), .b(new_n89_), .O(new_n172_));
  ...
  nand3  g143(.a(new_n165_), .b(new_n122_), .c(new_n121_), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n120_), .c(new_n176_), .d(new_n34_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n174_), .c(new_n155_), .O(z6));
endmodule
