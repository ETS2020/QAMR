...
module FAU ( 
  ...
  nand3  g079(.a(x15), .b(new_n54_), .c(new_n49_), .O(new_n113_));
  ...
  nand4  g092(.a(new_n43_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n123_), .c(new_n92_), .O(new_n128_));
  inv1   g095(.a(new_n121_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n95_), .c(x14), .O(new_n130_));
  ...
  nand3  g101(.a(new_n134_), .b(new_n90_), .c(x24), .O(new_n135_));
  nor2   g102(.a(x01), .b(new_n38_), .O(new_n136_));
  nor3   g103(.a(x06), .b(x03), .c(x02), .O(new_n137_));
  nor3   g104(.a(x11), .b(x10), .c(x08), .O(new_n138_));
  nor3   g105(.a(x24), .b(x20), .c(x14), .O(new_n139_));
  ...
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n68_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n65_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n83_), .c(x16), .O(new_n145_));
  nor2   g112(.a(x02), .b(new_n35_), .O(new_n146_));
  inv1   g113(.a(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n56_), .b(new_n52_), .c(new_n147_), .O(new_n148_));
  nand4  g115(.a(new_n136_), .b(new_n44_), .c(new_n37_), .d(new_n34_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n148_), .O(z5));
  oai21  g117(.a(new_n145_), .b(x08), .c(z5), .O(new_n151_));
  inv1   g118(.a(x23), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n83_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n67_), .c(x08), .O(new_n155_));
  inv1   g122(.a(new_n115_), .O(new_n156_));
  nand3  g123(.a(new_n44_), .b(x21), .c(new_n37_), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n34_), .c(new_n35_), .O(new_n159_));
  oai21  g126(.a(new_n146_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n155_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n151_), .O(z4));
  nand2  g129(.a(x20), .b(new_n42_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n36_), .c(x11), .O(new_n164_));
  nand4  g131(.a(new_n44_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n55_), .c(new_n53_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n52_), .c(new_n164_), .d(x03), .O(new_n167_));
  nand2  g134(.a(new_n43_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n41_), .O(new_n169_));
  nand4  g136(.a(new_n44_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n171_));
  oai21  g138(.a(new_n169_), .b(new_n48_), .c(new_n171_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n167_), .c(new_n147_), .O(z6));
  oai21  g140(.a(new_n158_), .b(x01), .c(new_n34_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n156_), .O(z7));
endmodule
