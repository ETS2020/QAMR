...
module FAU ( 
  ...
  nand2  g018(.a(x23), .b(x14), .O(new_n52_));
  ...
  nor4   g045(.a(new_n78_), .b(x23), .c(new_n59_), .d(new_n70_), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(x11), .c(x06), .d(x03), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(new_n69_), .O(z2));
  ...
  nand4  g058(.a(new_n91_), .b(new_n59_), .c(new_n70_), .d(new_n36_), .O(new_n92_));
  nor2   g059(.a(new_n92_), .b(x08), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n94_));
  ...
  nor2   g065(.a(new_n70_), .b(new_n36_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(x20), .c(x18), .O(new_n100_));
  nand4  g067(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n101_));
  nand4  g068(.a(new_n59_), .b(new_n70_), .c(new_n36_), .d(new_n82_), .O(new_n102_));
  ...
  nand4  g072(.a(new_n82_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n106_));
  nand4  g073(.a(new_n59_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n107_));
  oai22  g074(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n98_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n46_), .c(new_n37_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n104_), .c(new_n96_), .d(new_n52_), .O(z3));
  inv1   g077(.a(new_n49_), .O(new_n111_));
  inv1   g078(.a(x22), .O(new_n112_));
  oai21  g079(.a(x23), .b(new_n54_), .c(new_n58_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n112_), .c(x09), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(x16), .c(new_n82_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n111_), .O(new_n116_));
  inv1   g083(.a(new_n78_), .O(new_n117_));
  oai21  g084(.a(new_n60_), .b(x04), .c(x17), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(x22), .c(new_n55_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n57_), .c(x08), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n116_), .c(new_n52_), .O(z4));
  inv1   g089(.a(new_n41_), .O(new_n123_));
  and2   g090(.a(new_n45_), .b(new_n42_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n52_), .c(new_n47_), .d(new_n123_), .O(z5));
  aoi21  g092(.a(new_n36_), .b(x06), .c(x03), .O(new_n126_));
  aoi21  g093(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n78_), .c(new_n126_), .d(new_n49_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n52_), .O(new_n129_));
  inv1   g096(.a(new_n99_), .O(new_n130_));
  nand4  g097(.a(x20), .b(new_n70_), .c(new_n36_), .d(x00), .O(new_n131_));
  nand3  g098(.a(new_n60_), .b(x21), .c(new_n59_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n130_), .c(new_n131_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n44_), .c(new_n43_), .O(new_n134_));
  nand4  g101(.a(x20), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n135_));
  nor2   g102(.a(x23), .b(x20), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n99_), .c(x15), .O(new_n137_));
  ...
  nand4  g108(.a(x20), .b(new_n70_), .c(new_n36_), .d(x07), .O(new_n142_));
  nand3  g109(.a(new_n136_), .b(new_n99_), .c(x18), .O(new_n143_));
  aoi22  g110(.a(new_n143_), .b(new_n142_), .c(new_n46_), .d(new_n37_), .O(new_n144_));
  aoi21  g111(.a(new_n137_), .b(new_n135_), .c(x13), .O(new_n145_));
  aoi22  g112(.a(new_n145_), .b(new_n37_), .c(new_n144_), .d(x24), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n141_), .c(new_n129_), .O(z6));
  inv1   g114(.a(new_n73_), .O(new_n148_));
  and2   g115(.a(new_n75_), .b(new_n74_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n76_), .c(new_n148_), .d(new_n52_), .O(z7));
endmodule
