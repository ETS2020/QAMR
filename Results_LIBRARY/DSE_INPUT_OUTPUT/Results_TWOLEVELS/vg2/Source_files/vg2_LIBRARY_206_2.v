...
module FAU ( 
  ...
  nand2  g105(.a(new_n51_), .b(new_n48_), .O(new_n139_));
  ...
  nand2  g110(.a(new_n113_), .b(new_n112_), .O(z7));
  ...
  and2   g117(.a(new_n51_), .b(new_n44_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n46_), .c(new_n150_), .d(new_n38_), .O(z5));
  nand2  g119(.a(x20), .b(new_n36_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n34_), .c(x11), .O(new_n154_));
  nand3  g121(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n43_), .c(new_n154_), .d(x03), .O(new_n156_));
  nand2  g123(.a(new_n61_), .b(x14), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x06), .c(new_n35_), .O(new_n158_));
  nand3  g125(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n108_), .c(new_n158_), .d(new_n69_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n156_), .c(new_n38_), .O(z6));
endmodule
