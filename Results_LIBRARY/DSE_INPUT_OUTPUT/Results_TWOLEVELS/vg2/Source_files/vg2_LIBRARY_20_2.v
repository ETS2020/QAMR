...
module FAU ( 
  ...
  nand4  g042(.a(new_n75_), .b(new_n54_), .c(new_n67_), .d(new_n66_), .O(new_n76_));
  ...
  nor4   g052(.a(new_n85_), .b(new_n84_), .c(new_n55_), .d(new_n54_), .O(new_n86_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n54_), .d(new_n67_), .O(new_n101_));
  ...
  nor2   g072(.a(x20), .b(new_n34_), .O(new_n106_));
  ...
  nor3   g085(.a(new_n118_), .b(new_n69_), .c(new_n55_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x11), .c(x06), .d(x03), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n35_), .O(z2));
  nand2  g088(.a(new_n58_), .b(new_n57_), .O(new_n122_));
  ...
  nand4  g093(.a(new_n126_), .b(new_n69_), .c(new_n55_), .d(new_n34_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n129_));
  ...
  nand4  g100(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n134_));
  nand4  g101(.a(new_n69_), .b(new_n55_), .c(new_n34_), .d(new_n66_), .O(new_n135_));
  ...
  nand3  g105(.a(new_n100_), .b(new_n36_), .c(new_n35_), .O(new_n139_));
  nand4  g106(.a(new_n69_), .b(x19), .c(new_n55_), .d(new_n34_), .O(new_n140_));
  ...
  oai21  g116(.a(new_n56_), .b(x04), .c(x17), .O(new_n150_));
  ...
  nand4  g123(.a(new_n156_), .b(new_n107_), .c(new_n48_), .d(new_n155_), .O(z5));
  oai21  g124(.a(new_n34_), .b(x06), .c(x03), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n149_), .O(new_n159_));
  nand2  g126(.a(x20), .b(new_n55_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n37_), .c(x11), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x03), .c(new_n144_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n107_), .O(z6));
  inv1   g130(.a(new_n113_), .O(new_n164_));
  and2   g131(.a(new_n115_), .b(new_n114_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n116_), .c(new_n164_), .d(new_n107_), .O(z7));
endmodule
