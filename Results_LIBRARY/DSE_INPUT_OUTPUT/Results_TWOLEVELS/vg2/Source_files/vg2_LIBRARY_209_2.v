...
module FAU ( 
  ...
  nand3  g023(.a(x21), .b(new_n50_), .c(new_n37_), .O(new_n57_));
  ...
  nand3  g042(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n76_));
  ...
  nand3  g085(.a(new_n118_), .b(new_n46_), .c(new_n40_), .O(new_n119_));
  ...
  oai21  g090(.a(new_n42_), .b(new_n94_), .c(new_n123_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(x05), .O(new_n125_));
  nand3  g092(.a(x24), .b(x18), .c(x13), .O(new_n126_));
  nand3  g093(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n127_));
  nand4  g094(.a(new_n42_), .b(x21), .c(new_n50_), .d(new_n37_), .O(new_n128_));
  ...
  oai21  g099(.a(new_n132_), .b(new_n66_), .c(new_n39_), .O(z2));
  ...
  nand3  g103(.a(new_n111_), .b(new_n67_), .c(new_n66_), .O(new_n137_));
  nand3  g104(.a(new_n116_), .b(new_n36_), .c(new_n35_), .O(new_n138_));
  ...
  nand2  g109(.a(new_n135_), .b(new_n95_), .O(new_n143_));
  nand4  g110(.a(x07), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n144_));
  nand4  g111(.a(new_n73_), .b(new_n36_), .c(new_n35_), .d(new_n69_), .O(new_n145_));
  ...
  nand4  g114(.a(new_n34_), .b(new_n67_), .c(new_n66_), .d(x00), .O(new_n148_));
  nand3  g115(.a(new_n135_), .b(x21), .c(x20), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n134_), .c(new_n148_), .d(new_n145_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n42_), .c(new_n50_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n147_), .c(new_n142_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n37_), .O(new_n153_));
  nand2  g120(.a(new_n147_), .b(new_n142_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x21), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(z3));
  oai21  g123(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n74_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n69_), .O(new_n159_));
  nand3  g126(.a(new_n51_), .b(new_n47_), .c(new_n45_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n44_), .c(new_n159_), .O(new_n161_));
  oai21  g128(.a(new_n75_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n70_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n71_), .c(x08), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n129_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n161_), .c(new_n39_), .O(z4));
  ...
  inv1   g137(.a(new_n128_), .O(new_n171_));
  aoi21  g138(.a(new_n73_), .b(x14), .c(new_n34_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n35_), .c(x03), .O(new_n173_));
  and2   g140(.a(new_n127_), .b(new_n126_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n125_), .c(new_n38_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n171_), .c(new_n173_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n170_), .O(z6));
  nand4  g144(.a(new_n174_), .b(new_n128_), .c(new_n125_), .d(new_n39_), .O(z7));
endmodule
