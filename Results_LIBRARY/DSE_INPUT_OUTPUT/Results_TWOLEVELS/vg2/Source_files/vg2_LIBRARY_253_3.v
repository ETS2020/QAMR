...
module FAU ( 
  ...
  aoi21  g047(.a(new_n80_), .b(new_n53_), .c(new_n52_), .O(z2));
  ...
  nand4  g059(.a(new_n92_), .b(new_n52_), .c(new_n70_), .d(new_n36_), .O(new_n93_));
  ...
  nand4  g069(.a(new_n52_), .b(new_n70_), .c(new_n36_), .d(new_n82_), .O(new_n103_));
  ...
  nand3  g075(.a(new_n108_), .b(new_n52_), .c(x19), .O(new_n109_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n105_), .c(new_n97_), .d(new_n55_), .O(z3));
  inv1   g079(.a(x22), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(x17), .c(x09), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(x16), .c(new_n82_), .O(new_n115_));
  nand4  g082(.a(new_n53_), .b(new_n113_), .c(new_n60_), .d(x04), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  aoi21  g084(.a(new_n115_), .b(new_n55_), .c(new_n117_), .O(new_n118_));
  aoi21  g085(.a(x22), .b(new_n61_), .c(new_n58_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n60_), .c(x08), .O(new_n120_));
  nand3  g087(.a(x23), .b(x22), .c(new_n52_), .O(new_n121_));
  nor3   g088(.a(new_n121_), .b(new_n60_), .c(x04), .O(new_n122_));
  aoi21  g089(.a(new_n120_), .b(new_n55_), .c(new_n122_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n78_), .c(new_n118_), .d(new_n49_), .O(z4));
  inv1   g091(.a(new_n41_), .O(new_n125_));
  and2   g092(.a(new_n45_), .b(new_n42_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n55_), .c(new_n47_), .d(new_n125_), .O(z5));
  aoi21  g094(.a(new_n36_), .b(x06), .c(x03), .O(new_n128_));
  aoi21  g095(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n78_), .c(new_n128_), .d(new_n49_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n55_), .O(new_n131_));
  nand3  g098(.a(new_n100_), .b(x21), .c(new_n52_), .O(new_n132_));
  nand2  g099(.a(new_n36_), .b(x00), .O(new_n133_));
  nand3  g100(.a(new_n53_), .b(x20), .c(new_n70_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n44_), .c(new_n43_), .O(new_n136_));
  nand3  g103(.a(new_n100_), .b(new_n52_), .c(x15), .O(new_n137_));
  nand4  g104(.a(new_n108_), .b(new_n53_), .c(x20), .d(x19), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(x13), .c(x05), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n39_), .O(new_n142_));
  nand3  g109(.a(new_n100_), .b(new_n52_), .c(x18), .O(new_n143_));
  nand2  g110(.a(new_n36_), .b(x07), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n134_), .c(new_n143_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n98_), .c(x24), .O(new_n146_));
  nand3  g113(.a(new_n139_), .b(new_n46_), .c(new_n37_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n146_), .c(new_n142_), .d(new_n131_), .O(z6));
  nor2   g115(.a(new_n78_), .b(new_n54_), .O(z7));
endmodule
