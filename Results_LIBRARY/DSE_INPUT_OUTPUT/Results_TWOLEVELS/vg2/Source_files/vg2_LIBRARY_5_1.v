...
module FAU ( 
  ...
  nor2   g022(.a(new_n55_), .b(x04), .O(new_n56_));
  ...
  nand4  g051(.a(new_n84_), .b(new_n36_), .c(new_n55_), .d(new_n72_), .O(new_n85_));
  ...
  nor4   g057(.a(new_n90_), .b(new_n71_), .c(new_n34_), .d(new_n70_), .O(new_n91_));
  ...
  nand4  g064(.a(new_n55_), .b(new_n72_), .c(x07), .d(new_n35_), .O(new_n98_));
  ...
  nand4  g075(.a(new_n36_), .b(new_n55_), .c(new_n72_), .d(new_n35_), .O(new_n109_));
  ...
  nand4  g108(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n72_), .O(new_n142_));
  ...
  nand4  g112(.a(new_n72_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n146_));
  ...
  nand2  g118(.a(x22), .b(new_n75_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x09), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x16), .c(new_n72_), .O(new_n154_));
  oai21  g121(.a(x23), .b(new_n71_), .c(new_n75_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n76_), .c(x09), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x16), .c(new_n72_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n51_), .c(new_n56_), .O(new_n158_));
  oai21  g125(.a(new_n154_), .b(new_n126_), .c(new_n158_), .O(z4));
  nand4  g126(.a(new_n57_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(z5));
  nand2  g127(.a(x20), .b(new_n73_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n51_), .O(new_n163_));
  nand2  g130(.a(new_n37_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n36_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n34_), .c(new_n125_), .d(new_n120_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n57_), .O(z6));
  inv1   g134(.a(new_n120_), .O(new_n168_));
  nand4  g135(.a(new_n124_), .b(new_n121_), .c(new_n168_), .d(new_n57_), .O(z7));
endmodule
