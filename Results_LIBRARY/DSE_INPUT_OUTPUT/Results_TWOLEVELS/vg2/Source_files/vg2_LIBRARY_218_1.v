...
module FAU ( 
  ...
  nand2  g022(.a(x23), .b(new_n55_), .O(new_n56_));
  ...
  nand4  g078(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n58_), .O(new_n112_));
  ...
  nand3  g082(.a(new_n115_), .b(new_n49_), .c(new_n38_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n105_), .c(new_n56_), .O(new_n117_));
  ...
  nor2   g096(.a(new_n129_), .b(new_n73_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x11), .c(x06), .d(x03), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n69_), .c(new_n56_), .O(z2));
  ...
  nand2  g109(.a(new_n90_), .b(x24), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n120_), .c(new_n126_), .O(new_n144_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n142_), .c(new_n56_), .O(new_n149_));
  nand3  g116(.a(x24), .b(new_n77_), .c(x07), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n43_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x05), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n49_), .c(new_n55_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(x24), .c(x07), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n152_), .c(new_n50_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(x08), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n149_), .O(z3));
  nand3  g126(.a(new_n40_), .b(x13), .c(x05), .O(new_n160_));
  aoi21  g127(.a(new_n77_), .b(x04), .c(x17), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x22), .c(new_n72_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n74_), .O(new_n163_));
  nor2   g130(.a(x15), .b(x08), .O(new_n164_));
  aoi22  g131(.a(new_n164_), .b(new_n163_), .c(new_n160_), .d(new_n90_), .O(new_n165_));
  oai21  g132(.a(new_n122_), .b(new_n71_), .c(new_n127_), .O(new_n166_));
  aoi21  g133(.a(x23), .b(new_n70_), .c(new_n75_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n76_), .c(x09), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n166_), .c(x16), .O(new_n169_));
  nand2  g136(.a(new_n48_), .b(new_n42_), .O(new_n170_));
  aoi21  g137(.a(new_n76_), .b(x17), .c(x09), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x16), .c(new_n71_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  oai21  g140(.a(new_n143_), .b(new_n120_), .c(new_n127_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n71_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n173_), .c(new_n169_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n165_), .c(x19), .O(new_n177_));
  aoi21  g144(.a(x22), .b(new_n75_), .c(new_n72_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n74_), .c(x08), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(x18), .O(new_n180_));
  nor2   g147(.a(x17), .b(x04), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(x22), .c(new_n72_), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n74_), .c(x08), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n39_), .c(new_n180_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n90_), .c(x24), .O(new_n185_));
  nand2  g152(.a(new_n179_), .b(new_n61_), .O(new_n186_));
  inv1   g153(.a(new_n183_), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n47_), .c(new_n46_), .d(x00), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n186_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n40_), .O(new_n190_));
  nand4  g157(.a(new_n179_), .b(x15), .c(new_n49_), .d(new_n38_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n190_), .c(new_n185_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n77_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n177_), .O(z4));
  nand4  g161(.a(new_n56_), .b(new_n47_), .c(new_n46_), .d(x00), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n79_), .O(new_n196_));
  nand2  g163(.a(new_n196_), .b(new_n40_), .O(new_n197_));
  nand2  g164(.a(new_n90_), .b(new_n42_), .O(new_n198_));
  nor2   g165(.a(new_n143_), .b(x23), .O(new_n199_));
  ...
  oai22  g170(.a(new_n203_), .b(x03), .c(new_n51_), .d(new_n44_), .O(new_n204_));
  nand2  g171(.a(new_n37_), .b(x14), .O(new_n205_));
  aoi21  g172(.a(new_n205_), .b(x06), .c(new_n36_), .O(new_n206_));
  oai22  g173(.a(new_n206_), .b(new_n34_), .c(new_n128_), .d(new_n124_), .O(new_n207_));
  nand3  g174(.a(new_n207_), .b(new_n204_), .c(new_n56_), .O(z6));
  inv1   g175(.a(new_n124_), .O(new_n209_));
  and2   g176(.a(new_n126_), .b(new_n125_), .O(new_n210_));
  nand4  g177(.a(new_n210_), .b(new_n127_), .c(new_n209_), .d(new_n56_), .O(z7));
endmodule
