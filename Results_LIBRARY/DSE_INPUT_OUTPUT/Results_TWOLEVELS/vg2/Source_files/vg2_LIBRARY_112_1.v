...
module FAU ( 
  ...
  oai21  g104(.a(new_n137_), .b(new_n43_), .c(new_n114_), .O(new_n138_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n106_), .c(new_n114_), .O(new_n148_));
  ...
  nand4  g120(.a(new_n153_), .b(new_n114_), .c(new_n44_), .d(new_n152_), .O(z5));
  ...
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n114_), .O(z6));
