...
module FAU ( 
  ...
  nor2   g103(.a(new_n57_), .b(new_n53_), .O(new_n137_));
  nor2   g104(.a(x02), .b(new_n35_), .O(new_n138_));
  nor2   g105(.a(x24), .b(x10), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n140_));
  ...
  nor2   g113(.a(new_n111_), .b(new_n108_), .O(new_n147_));
  nand3  g114(.a(new_n51_), .b(x21), .c(new_n37_), .O(new_n148_));
  inv1   g115(.a(new_n148_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n34_), .c(new_n35_), .O(new_n150_));
  oai21  g117(.a(new_n138_), .b(new_n147_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n142_), .O(z4));
  aoi21  g120(.a(new_n139_), .b(x00), .c(x01), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x02), .c(new_n137_), .O(z5));
  inv1   g122(.a(new_n138_), .O(new_n156_));
  nand2  g123(.a(x20), .b(new_n42_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n36_), .c(x11), .O(new_n158_));
  nand3  g125(.a(new_n139_), .b(new_n34_), .c(x00), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n56_), .c(new_n54_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n53_), .c(new_n158_), .d(x03), .O(new_n161_));
  ...
  oai22  g132(.a(new_n165_), .b(new_n108_), .c(new_n163_), .d(new_n47_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n161_), .c(new_n156_), .O(z6));
  oai21  g134(.a(new_n149_), .b(x01), .c(new_n34_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n147_), .O(z7));
endmodule
