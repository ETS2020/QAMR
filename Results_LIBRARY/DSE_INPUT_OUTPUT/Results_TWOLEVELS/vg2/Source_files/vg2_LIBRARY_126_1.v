...
module FAU ( 
  ...
  nor3   g028(.a(new_n61_), .b(new_n52_), .c(new_n56_), .O(new_n62_));
  ...
  nand4  g050(.a(x12), .b(x11), .c(x08), .d(x06), .O(new_n84_));
  ...
  nor2   g055(.a(new_n57_), .b(new_n72_), .O(new_n89_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n91_), .c(new_n36_), .d(new_n69_), .O(new_n104_));
  nor3   g071(.a(x17), .b(x14), .c(x12), .O(new_n105_));
  ...
  nor2   g086(.a(new_n119_), .b(new_n53_), .O(z7));
  nand2  g087(.a(z7), .b(x20), .O(new_n121_));
  ...
  nand2  g095(.a(new_n74_), .b(new_n73_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n71_), .c(new_n56_), .d(new_n36_), .O(new_n130_));
  ...
  nand4  g103(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n137_));
  nand4  g104(.a(new_n71_), .b(new_n56_), .c(new_n36_), .d(new_n68_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n103_), .b(new_n34_), .c(new_n66_), .O(new_n142_));
  nand4  g109(.a(new_n71_), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n143_));
  ...
  inv1   g114(.a(new_n119_), .O(new_n148_));
  oai21  g115(.a(new_n57_), .b(x04), .c(x17), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(x22), .c(x16), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x08), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  inv1   g119(.a(new_n49_), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n67_), .c(new_n70_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n72_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n68_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n152_), .c(new_n54_), .O(z4));
  inv1   g125(.a(new_n41_), .O(new_n159_));
  and2   g126(.a(new_n45_), .b(new_n42_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n54_), .c(new_n47_), .d(new_n159_), .O(z5));
  nand2  g128(.a(x20), .b(new_n56_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x03), .c(new_n153_), .O(new_n164_));
  nand2  g131(.a(new_n71_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n36_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n34_), .c(new_n148_), .O(new_n167_));
