...
module FAU ( 
  ...
  nor3   g033(.a(new_n66_), .b(new_n62_), .c(new_n61_), .O(new_n67_));
  ...
  nand3  g059(.a(new_n92_), .b(new_n91_), .c(new_n69_), .O(new_n93_));
  ...
  oai22  g063(.a(new_n96_), .b(new_n93_), .c(new_n89_), .d(new_n61_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n82_), .c(x24), .O(new_n98_));
  nand4  g065(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n86_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n60_), .c(new_n58_), .d(x01), .O(new_n101_));
  ...
  aoi21  g084(.a(new_n117_), .b(new_n44_), .c(new_n55_), .O(z2));
  nand3  g085(.a(new_n56_), .b(x06), .c(x03), .O(new_n119_));
  inv1   g086(.a(x08), .O(new_n120_));
  nor2   g087(.a(new_n36_), .b(new_n120_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x20), .c(x15), .d(x14), .O(new_n122_));
  nor2   g089(.a(x14), .b(x11), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n102_), .c(new_n78_), .d(new_n70_), .O(new_n124_));
  oai21  g091(.a(new_n122_), .b(new_n119_), .c(new_n124_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  nand3  g093(.a(new_n121_), .b(new_n88_), .c(x14), .O(new_n127_));
  nand2  g094(.a(new_n102_), .b(new_n91_), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n120_), .O(new_n129_));
  ...
  nand4  g098(.a(new_n35_), .b(new_n34_), .c(new_n55_), .d(x00), .O(new_n132_));
  nand4  g099(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n133_));
  nand4  g100(.a(x21), .b(x20), .c(x14), .d(x11), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n129_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n131_), .c(new_n126_), .O(z3));
  oai21  g104(.a(x23), .b(new_n57_), .c(new_n75_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n63_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n120_), .O(new_n140_));
  ...
  oai21  g113(.a(new_n146_), .b(new_n74_), .c(x08), .O(new_n147_));
  nand2  g114(.a(new_n112_), .b(new_n111_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n110_), .c(new_n53_), .O(new_n149_));
  ...
  inv1   g128(.a(new_n110_), .O(new_n162_));
  and2   g129(.a(new_n150_), .b(new_n112_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n111_), .c(new_n162_), .O(new_n164_));
  oai21  g131(.a(new_n161_), .b(new_n34_), .c(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n159_), .c(new_n53_), .O(z6));
  nand4  g133(.a(new_n163_), .b(new_n111_), .c(new_n162_), .d(new_n53_), .O(z7));
endmodule
