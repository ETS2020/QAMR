...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n80_));
  ...
  nor2   g050(.a(new_n52_), .b(new_n34_), .O(new_n84_));
  ...
  nor4   g054(.a(new_n87_), .b(new_n70_), .c(new_n57_), .d(new_n56_), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n86_), .c(new_n84_), .d(x01), .O(new_n89_));
  inv1   g056(.a(x08), .O(new_n90_));
  nor3   g057(.a(x06), .b(x03), .c(x01), .O(new_n91_));
  ...
  nand4  g065(.a(new_n86_), .b(new_n37_), .c(x03), .d(x01), .O(new_n99_));
  nor2   g066(.a(new_n56_), .b(x13), .O(new_n100_));
  ...
  oai21  g070(.a(new_n103_), .b(new_n99_), .c(x12), .O(new_n104_));
  nand2  g071(.a(new_n104_), .b(x04), .O(new_n105_));
  nor2   g072(.a(x03), .b(x01), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n35_), .c(new_n37_), .O(new_n107_));
  nand4  g074(.a(new_n69_), .b(new_n36_), .c(new_n68_), .d(new_n90_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g076(.a(new_n70_), .b(new_n57_), .c(new_n56_), .d(new_n46_), .O(new_n110_));
  nand3  g077(.a(new_n95_), .b(new_n71_), .c(x19), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n105_), .c(new_n98_), .O(new_n114_));
  ...
  nor4   g092(.a(new_n125_), .b(new_n53_), .c(new_n71_), .d(new_n56_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n67_), .O(z2));
  nand2  g095(.a(new_n60_), .b(new_n59_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x20), .c(x14), .d(x11), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n90_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x06), .c(x03), .d(x01), .O(new_n132_));
  nand2  g099(.a(new_n74_), .b(new_n73_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n71_), .c(new_n56_), .d(new_n36_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n136_));
  ...
  nand3  g107(.a(new_n106_), .b(x07), .c(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n71_), .b(new_n56_), .c(new_n36_), .d(new_n90_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n139_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n83_), .c(x24), .O(new_n144_));
  nand4  g111(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n145_));
  nand3  g112(.a(new_n106_), .b(new_n90_), .c(new_n35_), .O(new_n146_));
  nand4  g113(.a(new_n71_), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n147_));
  ...
  nand4  g116(.a(new_n149_), .b(new_n144_), .c(new_n138_), .d(new_n54_), .O(z3));
  inv1   g117(.a(new_n49_), .O(new_n151_));
  oai21  g118(.a(x23), .b(new_n52_), .c(new_n70_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n72_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n90_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  inv1   g122(.a(new_n125_), .O(new_n156_));
  oai21  g123(.a(new_n58_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n68_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n57_), .c(x08), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n155_), .c(new_n54_), .O(z4));
  ...
  nand2  g131(.a(x20), .b(new_n56_), .O(new_n165_));
  ...
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n54_), .O(z6));
  inv1   g138(.a(new_n119_), .O(new_n172_));
  nand4  g139(.a(new_n123_), .b(new_n120_), .c(new_n172_), .d(new_n54_), .O(z7));
endmodule
