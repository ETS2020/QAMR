...
module FAU ( 
  ...
  nand4  g061(.a(new_n94_), .b(new_n76_), .c(new_n37_), .d(new_n90_), .O(new_n95_));
  ...
  nor3   g083(.a(new_n116_), .b(new_n34_), .c(new_n56_), .O(z2));
  ...
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n91_), .d(new_n36_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n37_), .b(new_n91_), .c(new_n36_), .d(new_n118_), .O(new_n136_));
  ...
  nand3  g107(.a(new_n75_), .b(new_n91_), .c(new_n36_), .O(new_n141_));
  ...
  oai21  g111(.a(x23), .b(new_n57_), .c(new_n90_), .O(new_n145_));
  ...
  aoi21  g126(.a(x20), .b(new_n91_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(z5), .O(new_n162_));
  nand2  g129(.a(new_n114_), .b(new_n113_), .O(new_n163_));
  ...
  nand4  g134(.a(new_n153_), .b(new_n110_), .c(new_n152_), .d(new_n54_), .O(z7));
endmodule
