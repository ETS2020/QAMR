...
module FAU ( 
  ...
  nand2  g109(.a(new_n44_), .b(x01), .O(new_n143_));
  ...
  oai21  g114(.a(new_n142_), .b(x08), .c(z5), .O(new_n148_));
  ...
  nand2  g119(.a(new_n143_), .b(new_n112_), .O(new_n153_));
  ...
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(z7));
  nand2  g124(.a(z7), .b(new_n152_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n148_), .O(z4));
  nand2  g126(.a(x20), .b(new_n63_), .O(new_n160_));
  ...
  nand4  g131(.a(new_n40_), .b(x21), .c(new_n154_), .d(new_n44_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(new_n34_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n162_), .c(new_n143_), .O(z6));
endmodule
