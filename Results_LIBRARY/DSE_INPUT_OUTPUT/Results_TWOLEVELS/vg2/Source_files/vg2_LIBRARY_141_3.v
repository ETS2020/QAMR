...
module FAU ( 
  ...
  nor2   g098(.a(new_n131_), .b(new_n118_), .O(z2));
  nand3  g099(.a(new_n60_), .b(x03), .c(x01), .O(new_n133_));
  nor2   g100(.a(new_n90_), .b(new_n36_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(x20), .c(x15), .O(new_n135_));
  nand3  g102(.a(new_n69_), .b(new_n34_), .c(new_n118_), .O(new_n136_));
  nand3  g103(.a(new_n74_), .b(new_n90_), .c(new_n36_), .O(new_n137_));
  ...
  nand4  g107(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n118_), .O(new_n141_));
  nand4  g108(.a(new_n37_), .b(new_n90_), .c(new_n36_), .d(new_n59_), .O(new_n142_));
  ...
  nand3  g114(.a(new_n134_), .b(new_n147_), .c(x20), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n145_), .c(new_n44_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x01), .O(new_n150_));
  nor3   g117(.a(x06), .b(x03), .c(x02), .O(new_n151_));
  nor3   g118(.a(x11), .b(x10), .c(x08), .O(new_n152_));
  nor3   g119(.a(x24), .b(x20), .c(x14), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n108_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n150_), .c(new_n144_), .d(new_n139_), .O(z3));
  ...
  nand2  g125(.a(new_n48_), .b(new_n43_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n42_), .c(new_n53_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n46_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  oai21  g129(.a(new_n102_), .b(x04), .c(x17), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x22), .c(new_n67_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n91_), .c(x08), .O(new_n165_));
  nand3  g132(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n53_), .O(new_n167_));
  nand3  g134(.a(new_n147_), .b(new_n45_), .c(new_n44_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n167_), .O(z7));
  nand2  g136(.a(z7), .b(new_n165_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n162_), .O(z4));
  inv1   g138(.a(new_n42_), .O(new_n172_));
  and2   g139(.a(new_n53_), .b(new_n43_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n48_), .c(new_n46_), .d(new_n172_), .O(z5));
  nand2  g141(.a(x20), .b(new_n90_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n35_), .c(x11), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n177_));
  ...
  nand3  g147(.a(new_n168_), .b(new_n124_), .c(new_n123_), .O(new_n181_));
  oai22  g148(.a(new_n181_), .b(new_n178_), .c(new_n180_), .d(new_n34_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n177_), .c(new_n53_), .O(z6));
endmodule
