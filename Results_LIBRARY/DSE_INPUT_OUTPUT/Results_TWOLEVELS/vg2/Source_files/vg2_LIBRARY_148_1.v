...
module FAU ( 
  ...
  or2    g107(.a(new_n110_), .b(new_n106_), .O(new_n141_));
  ...
  nand2  g114(.a(x02), .b(new_n66_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n147_), .c(new_n140_), .O(z4));
  nand4  g116(.a(new_n148_), .b(new_n138_), .c(new_n44_), .d(new_n136_), .O(z5));
  nand2  g117(.a(x20), .b(new_n103_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n36_), .c(x11), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x03), .c(new_n139_), .O(new_n153_));
  nand2  g120(.a(new_n38_), .b(x14), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x06), .c(new_n37_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n35_), .c(new_n141_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n153_), .c(new_n148_), .O(z6));
  nand2  g124(.a(new_n108_), .b(new_n107_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n106_), .c(new_n148_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n109_), .O(z7));
endmodule
