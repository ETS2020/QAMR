...
module FAU ( 
  ...
  oai21  g023(.a(x10), .b(x02), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g042(.a(new_n45_), .b(new_n75_), .c(x00), .O(new_n76_));
  nand3  g043(.a(x19), .b(x13), .c(x05), .O(new_n77_));
  nand2  g044(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand4  g045(.a(new_n78_), .b(new_n74_), .c(new_n73_), .d(new_n72_), .O(new_n79_));
  inv1   g046(.a(new_n79_), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n81_));
  nor2   g048(.a(new_n81_), .b(x12), .O(new_n82_));
  nand4  g049(.a(new_n82_), .b(new_n36_), .c(new_n68_), .d(new_n67_), .O(new_n83_));
  nor2   g050(.a(new_n83_), .b(x06), .O(new_n84_));
  nand4  g051(.a(new_n84_), .b(new_n66_), .c(new_n34_), .d(new_n65_), .O(new_n85_));
  nand2  g052(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  nand2  g053(.a(new_n86_), .b(new_n41_), .O(new_n87_));
  inv1   g054(.a(new_n38_), .O(new_n88_));
  nand2  g055(.a(new_n49_), .b(new_n39_), .O(new_n89_));
  nand4  g056(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n90_));
  nor4   g057(.a(new_n90_), .b(new_n66_), .c(new_n34_), .d(new_n65_), .O(new_n91_));
  ...
  nand4  g066(.a(new_n70_), .b(new_n69_), .c(new_n37_), .d(new_n36_), .O(new_n100_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n97_), .c(new_n36_), .d(new_n68_), .O(new_n111_));
  ...
  nand3  g084(.a(new_n117_), .b(new_n49_), .c(new_n39_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n105_), .c(new_n88_), .O(new_n119_));
  ...
  aoi21  g090(.a(new_n123_), .b(new_n122_), .c(new_n39_), .O(new_n124_));
  nand3  g091(.a(x24), .b(x18), .c(x13), .O(new_n125_));
  nand3  g092(.a(x15), .b(new_n49_), .c(new_n39_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n124_), .c(new_n88_), .O(new_n128_));
  inv1   g095(.a(x21), .O(new_n129_));
  nor2   g096(.a(x24), .b(new_n129_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n45_), .c(new_n75_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n128_), .c(new_n72_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x14), .c(x11), .d(x06), .O(new_n133_));
  nor3   g100(.a(new_n133_), .b(new_n34_), .c(new_n65_), .O(z2));
  nand3  g101(.a(x21), .b(new_n45_), .c(new_n75_), .O(new_n135_));
  ...
  nand4  g106(.a(new_n78_), .b(new_n72_), .c(new_n69_), .d(new_n36_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(x08), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n142_));
  ...
  nand4  g113(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n147_));
  nand4  g114(.a(new_n72_), .b(new_n69_), .c(new_n36_), .d(new_n67_), .O(new_n148_));
  ...
  nand3  g118(.a(new_n110_), .b(new_n34_), .c(new_n65_), .O(new_n152_));
  nand3  g119(.a(new_n115_), .b(new_n69_), .c(new_n36_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n145_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n49_), .c(new_n39_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n150_), .c(new_n144_), .d(new_n88_), .O(z3));
  oai21  g123(.a(x23), .b(new_n66_), .c(new_n71_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n73_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n68_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n70_), .c(x08), .O(new_n160_));
  oai21  g127(.a(new_n74_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n68_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n70_), .c(x08), .O(new_n163_));
  inv1   g130(.a(new_n124_), .O(new_n164_));
  nand4  g131(.a(new_n131_), .b(new_n126_), .c(new_n125_), .d(new_n164_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n163_), .c(new_n38_), .O(new_n166_));
  oai21  g133(.a(new_n160_), .b(new_n52_), .c(new_n166_), .O(z4));
  inv1   g134(.a(new_n43_), .O(new_n168_));
  inv1   g135(.a(new_n50_), .O(new_n169_));
  nor2   g136(.a(new_n169_), .b(new_n38_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n48_), .c(new_n44_), .d(new_n168_), .O(z5));
  aoi21  g138(.a(x20), .b(new_n69_), .c(x06), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x11), .c(new_n34_), .O(new_n173_));
  nand2  g140(.a(new_n50_), .b(new_n44_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n43_), .c(new_n88_), .O(new_n175_));
  nand4  g142(.a(new_n47_), .b(new_n41_), .c(new_n37_), .d(new_n45_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g145(.a(new_n131_), .b(new_n128_), .O(new_n179_));
  aoi21  g146(.a(new_n72_), .b(x14), .c(new_n35_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n36_), .c(x03), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand3  g149(.a(new_n130_), .b(new_n47_), .c(new_n45_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n182_), .c(new_n178_), .O(z6));
  inv1   g151(.a(new_n127_), .O(new_n185_));
  nand4  g152(.a(new_n131_), .b(new_n185_), .c(new_n164_), .d(new_n88_), .O(z7));
endmodule
