...
module FAU ( 
  ...
  nor2   g058(.a(new_n74_), .b(new_n37_), .O(new_n92_));
  ...
  nand4  g064(.a(new_n74_), .b(new_n37_), .c(new_n73_), .d(new_n72_), .O(new_n98_));
  ...
  nand4  g072(.a(new_n36_), .b(new_n69_), .c(new_n68_), .d(new_n35_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n55_), .O(new_n108_));
  nand4  g075(.a(new_n74_), .b(new_n37_), .c(new_n73_), .d(x19), .O(new_n109_));
  ...
  nor2   g091(.a(new_n124_), .b(new_n70_), .O(new_n125_));
  ...
  nand4  g097(.a(new_n77_), .b(new_n73_), .c(new_n70_), .d(new_n36_), .O(new_n131_));
  ...
  nand4  g106(.a(new_n73_), .b(new_n70_), .c(new_n36_), .d(new_n68_), .O(new_n140_));
  ...
  nand4  g111(.a(new_n73_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n145_));
  ...
  oai21  g118(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n37_), .c(x09), .O(new_n153_));
  ...
  nand2  g131(.a(x20), .b(new_n70_), .O(new_n165_));
