...
module FAU ( 
  ...
  nor4   g050(.a(new_n83_), .b(new_n65_), .c(new_n34_), .d(new_n64_), .O(new_n84_));
  ...
  nor2   g056(.a(new_n55_), .b(new_n70_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n89_), .c(new_n86_), .d(new_n84_), .O(new_n91_));
  nor3   g058(.a(x04), .b(x03), .c(x01), .O(new_n92_));
  inv1   g059(.a(x07), .O(new_n93_));
  nor2   g060(.a(new_n93_), .b(x06), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n67_), .d(new_n66_), .O(new_n95_));
  nor3   g062(.a(x14), .b(x12), .c(x11), .O(new_n96_));
  nor2   g063(.a(x23), .b(x22), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n69_), .d(new_n68_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n95_), .c(new_n91_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n82_), .c(x24), .O(new_n100_));
  nand3  g067(.a(x15), .b(x14), .c(x12), .O(new_n101_));
  nand3  g068(.a(new_n90_), .b(x20), .c(x16), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  nor2   g071(.a(x08), .b(x06), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n92_), .c(new_n36_), .d(new_n67_), .O(new_n106_));
  nor3   g073(.a(x16), .b(x14), .c(x12), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n97_), .c(x19), .d(new_n69_), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n46_), .c(new_n37_), .O(new_n110_));
  nand2  g077(.a(x20), .b(new_n69_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n110_), .c(new_n100_), .O(new_n112_));
  inv1   g079(.a(new_n112_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n80_), .O(z1));
  nor2   g081(.a(new_n39_), .b(new_n87_), .O(new_n115_));
  ...
  nor3   g090(.a(new_n123_), .b(new_n54_), .c(new_n36_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x17), .c(new_n88_), .O(z2));
  nand2  g093(.a(new_n57_), .b(new_n56_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x20), .c(x17), .d(x14), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n36_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x08), .c(x06), .d(x03), .O(new_n130_));
  nand2  g097(.a(new_n72_), .b(new_n71_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n88_), .c(new_n54_), .d(new_n36_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(x08), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n134_));
  oai21  g101(.a(new_n130_), .b(new_n64_), .c(new_n134_), .O(new_n135_));
  ...
  nor2   g105(.a(new_n54_), .b(new_n36_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n89_), .d(x17), .O(new_n140_));
  nor2   g107(.a(x03), .b(x01), .O(new_n141_));
  nor2   g108(.a(x11), .b(x08), .O(new_n142_));
  nor2   g109(.a(x20), .b(x14), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n94_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n140_), .c(new_n81_), .O(new_n145_));
  nor2   g112(.a(new_n88_), .b(new_n69_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n139_), .c(new_n138_), .d(x15), .O(new_n147_));
  nor2   g114(.a(x14), .b(x11), .O(new_n148_));
  inv1   g115(.a(x19), .O(new_n149_));
  nor2   g116(.a(x20), .b(new_n149_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n148_), .c(new_n141_), .d(new_n105_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n147_), .c(x13), .O(new_n152_));
  aoi22  g119(.a(new_n152_), .b(new_n37_), .c(new_n145_), .d(x24), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n136_), .O(z3));
  inv1   g121(.a(new_n49_), .O(new_n155_));
  oai21  g122(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n70_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n66_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  oai21  g126(.a(new_n55_), .b(x04), .c(x17), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n67_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n68_), .c(x08), .O(new_n162_));
  oai21  g129(.a(new_n122_), .b(new_n118_), .c(new_n162_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n159_), .c(new_n111_), .O(z4));
  inv1   g131(.a(new_n41_), .O(new_n165_));
  and2   g132(.a(new_n45_), .b(new_n42_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n111_), .c(new_n47_), .d(new_n165_), .O(z5));
  aoi21  g134(.a(new_n36_), .b(x06), .c(x03), .O(new_n168_));
  aoi21  g135(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n123_), .c(new_n168_), .d(new_n49_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n111_), .O(new_n171_));
  nand2  g138(.a(new_n36_), .b(x00), .O(new_n172_));
  nand2  g139(.a(new_n146_), .b(new_n54_), .O(new_n173_));
  nand3  g140(.a(new_n139_), .b(x21), .c(new_n88_), .O(new_n174_));
  oai21  g141(.a(new_n173_), .b(new_n172_), .c(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n44_), .c(new_n43_), .O(new_n176_));
  nand4  g143(.a(new_n148_), .b(x20), .c(x19), .d(x17), .O(new_n177_));
  nand3  g144(.a(new_n139_), .b(new_n88_), .c(x15), .O(new_n178_));
  ...
  nand2  g148(.a(new_n181_), .b(new_n39_), .O(new_n182_));
  nand2  g149(.a(new_n36_), .b(x07), .O(new_n183_));
  nand3  g150(.a(new_n139_), .b(new_n88_), .c(x18), .O(new_n184_));
  oai21  g151(.a(new_n183_), .b(new_n173_), .c(new_n184_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n82_), .c(x24), .O(new_n186_));
  nand3  g153(.a(new_n179_), .b(new_n46_), .c(new_n37_), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n186_), .c(new_n182_), .d(new_n171_), .O(z6));
  inv1   g155(.a(new_n118_), .O(new_n189_));
  and2   g156(.a(new_n120_), .b(new_n119_), .O(new_n190_));
  nand4  g157(.a(new_n190_), .b(new_n121_), .c(new_n189_), .d(new_n111_), .O(z7));
endmodule
