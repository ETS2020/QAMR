...
module FAU ( 
  ...
  nand3  g017(.a(new_n44_), .b(x19), .c(x13), .O(new_n51_));
  ...
  oai21  g023(.a(new_n56_), .b(new_n52_), .c(new_n43_), .O(new_n57_));
  nor2   g024(.a(new_n57_), .b(x14), .O(new_n58_));
  nand4  g025(.a(new_n58_), .b(new_n41_), .c(new_n36_), .d(new_n48_), .O(new_n59_));
  oai21  g026(.a(new_n59_), .b(x01), .c(new_n47_), .O(z0));
  nor2   g027(.a(x06), .b(x04), .O(new_n61_));
  nor2   g028(.a(x09), .b(x08), .O(new_n62_));
  nor2   g029(.a(x11), .b(x10), .O(new_n63_));
  ...
  nand4  g035(.a(new_n68_), .b(new_n67_), .c(new_n42_), .d(new_n66_), .O(new_n69_));
  inv1   g036(.a(new_n69_), .O(new_n70_));
  nor2   g037(.a(x24), .b(x23), .O(new_n71_));
  nand4  g038(.a(new_n71_), .b(new_n70_), .c(new_n65_), .d(new_n43_), .O(new_n72_));
  oai21  g039(.a(new_n72_), .b(new_n64_), .c(new_n35_), .O(new_n73_));
  nand2  g040(.a(new_n73_), .b(new_n34_), .O(new_n74_));
  nand3  g041(.a(x04), .b(x03), .c(x01), .O(new_n75_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n41_), .d(new_n83_), .O(new_n86_));
  nor2   g053(.a(x23), .b(x22), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n70_), .c(new_n43_), .d(x19), .O(new_n88_));
  oai21  g055(.a(new_n88_), .b(new_n86_), .c(new_n82_), .O(new_n89_));
  nand2  g056(.a(new_n54_), .b(new_n49_), .O(new_n90_));
  nand3  g057(.a(new_n44_), .b(x13), .c(x05), .O(new_n91_));
  ...
  nand3  g064(.a(new_n97_), .b(new_n78_), .c(new_n76_), .O(new_n98_));
  inv1   g065(.a(x07), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n84_), .c(new_n62_), .O(new_n101_));
  nand4  g068(.a(new_n67_), .b(new_n42_), .c(new_n66_), .d(new_n41_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n87_), .c(new_n43_), .d(new_n68_), .O(new_n104_));
  oai21  g071(.a(new_n104_), .b(new_n101_), .c(new_n98_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n90_), .c(x24), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n93_), .c(new_n74_), .O(z1));
  nand2  g074(.a(x24), .b(x18), .O(new_n108_));
  nand3  g075(.a(new_n44_), .b(x15), .c(x13), .O(new_n109_));
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(new_n49_), .O(new_n110_));
  nand3  g077(.a(x24), .b(x18), .c(x13), .O(new_n111_));
  nand3  g078(.a(x15), .b(new_n54_), .c(new_n49_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n110_), .c(x20), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n42_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(x02), .c(new_n35_), .O(z2));
  ...
  nand4  g090(.a(new_n43_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n121_), .c(new_n92_), .O(new_n126_));
  inv1   g093(.a(new_n119_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n95_), .c(x14), .O(new_n128_));
  ...
  nand3  g099(.a(new_n132_), .b(new_n90_), .c(x24), .O(new_n133_));
  nor2   g100(.a(x01), .b(new_n38_), .O(new_n134_));
  ...
  nand3  g105(.a(new_n138_), .b(new_n133_), .c(new_n126_), .O(z3));
  inv1   g106(.a(x04), .O(new_n140_));
  oai21  g107(.a(x23), .b(new_n140_), .c(new_n68_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n65_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n83_), .c(x16), .O(new_n143_));
  nor2   g110(.a(new_n56_), .b(new_n52_), .O(new_n144_));
  nor2   g111(.a(x02), .b(new_n35_), .O(new_n145_));
  nor2   g112(.a(x24), .b(x10), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n134_), .c(new_n34_), .O(new_n147_));
  ...
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n83_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n67_), .c(x08), .O(new_n153_));
  nor2   g120(.a(new_n113_), .b(new_n110_), .O(new_n154_));
  nand3  g121(.a(new_n44_), .b(x21), .c(new_n37_), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n34_), .c(new_n35_), .O(new_n157_));
  ...
  aoi21  g127(.a(new_n146_), .b(x00), .c(x01), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x02), .c(new_n144_), .O(z5));
  inv1   g129(.a(new_n145_), .O(new_n163_));
  nand2  g130(.a(x20), .b(new_n42_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n36_), .c(x11), .O(new_n165_));
  nand3  g132(.a(new_n146_), .b(new_n34_), .c(x00), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n55_), .c(new_n53_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n52_), .c(new_n165_), .d(x03), .O(new_n168_));
  nand2  g135(.a(new_n43_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n41_), .O(new_n170_));
  nand4  g137(.a(new_n44_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n112_), .c(new_n111_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n110_), .c(new_n170_), .d(new_n48_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n168_), .c(new_n163_), .O(z6));
  oai21  g141(.a(new_n156_), .b(x01), .c(new_n34_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n154_), .O(z7));
endmodule
