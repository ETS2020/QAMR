...
module FAU ( 
  ...
  nor4   g053(.a(new_n86_), .b(new_n70_), .c(new_n57_), .d(new_n56_), .O(new_n87_));
  ...
  nor2   g059(.a(x23), .b(x20), .O(new_n93_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n93_), .c(x19), .d(new_n71_), .O(new_n104_));
  ...
  nand2  g111(.a(new_n52_), .b(x17), .O(new_n145_));
  inv1   g112(.a(x23), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x04), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n145_), .c(new_n69_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n70_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n68_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  inv1   g118(.a(new_n117_), .O(new_n152_));
  oai21  g119(.a(new_n71_), .b(new_n67_), .c(x22), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x09), .c(new_n70_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n68_), .c(new_n152_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n151_), .c(new_n54_), .O(z4));
