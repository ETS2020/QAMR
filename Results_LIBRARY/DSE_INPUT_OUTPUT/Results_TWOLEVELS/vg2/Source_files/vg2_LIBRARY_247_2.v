...
module FAU ( 
  ...
  nor4   g016(.a(new_n49_), .b(x20), .c(x17), .d(x14), .O(new_n50_));
  ...
  nor4   g051(.a(new_n84_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n85_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n69_), .d(new_n68_), .O(new_n92_));
  ...
  nand2  g064(.a(new_n97_), .b(new_n83_), .O(new_n98_));
  nor2   g065(.a(x08), .b(x06), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n87_), .c(new_n36_), .d(new_n67_), .O(new_n100_));
  nor3   g067(.a(x16), .b(x14), .c(x12), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n91_), .c(new_n69_), .d(x19), .O(new_n102_));
  oai21  g069(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n46_), .c(new_n37_), .O(new_n104_));
  nand2  g071(.a(new_n69_), .b(x17), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n104_), .c(new_n94_), .O(new_n106_));
  ...
  oai21  g085(.a(new_n118_), .b(new_n64_), .c(new_n105_), .O(z2));
  ...
  nand4  g092(.a(new_n125_), .b(new_n69_), .c(new_n124_), .d(new_n54_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(x11), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(x01), .c(new_n123_), .O(new_n129_));
  ...
  nor2   g101(.a(x20), .b(x17), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n134_), .c(new_n133_), .d(new_n131_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n81_), .c(x24), .O(new_n138_));
  nand3  g105(.a(new_n132_), .b(x20), .c(x15), .O(new_n139_));
  nand3  g106(.a(new_n99_), .b(new_n34_), .c(new_n64_), .O(new_n140_));
  nor2   g107(.a(x14), .b(x11), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n69_), .c(x19), .d(new_n124_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n140_), .c(new_n139_), .d(new_n131_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n46_), .c(new_n37_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n138_), .c(new_n130_), .O(z3));
  inv1   g112(.a(new_n49_), .O(new_n146_));
  oai21  g113(.a(x23), .b(new_n65_), .c(new_n124_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n70_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n66_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  inv1   g117(.a(new_n116_), .O(new_n151_));
  oai21  g118(.a(new_n55_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n67_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n68_), .c(x08), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n150_), .c(new_n105_), .O(z4));
  inv1   g123(.a(new_n41_), .O(new_n157_));
  and2   g124(.a(new_n45_), .b(new_n42_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n105_), .c(new_n47_), .d(new_n157_), .O(z5));
  aoi21  g126(.a(new_n36_), .b(x06), .c(x03), .O(new_n160_));
  aoi21  g127(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n116_), .c(new_n160_), .d(new_n49_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n105_), .O(new_n163_));
  inv1   g130(.a(new_n132_), .O(new_n164_));
  nand4  g131(.a(x20), .b(new_n54_), .c(new_n36_), .d(x00), .O(new_n165_));
  nand3  g132(.a(x21), .b(new_n69_), .c(new_n124_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n164_), .c(new_n165_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n44_), .c(new_n43_), .O(new_n168_));
  nand3  g135(.a(new_n141_), .b(x20), .c(x19), .O(new_n169_));
  nand3  g136(.a(new_n135_), .b(new_n132_), .c(x15), .O(new_n170_));
  ...
  nand3  g142(.a(new_n69_), .b(x18), .c(new_n124_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n164_), .c(new_n175_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n81_), .c(x24), .O(new_n178_));
  nand3  g145(.a(new_n171_), .b(new_n46_), .c(new_n37_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n178_), .c(new_n174_), .d(new_n163_), .O(z6));
  inv1   g147(.a(new_n111_), .O(new_n181_));
  and2   g148(.a(new_n113_), .b(new_n112_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n114_), .c(new_n181_), .d(new_n105_), .O(z7));
endmodule
