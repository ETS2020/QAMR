...
module FAU ( 
  ...
  aoi21  g080(.a(new_n113_), .b(x02), .c(new_n94_), .O(z2));
  ...
  oai21  g084(.a(new_n117_), .b(new_n115_), .c(new_n94_), .O(new_n118_));
  ...
  nor2   g102(.a(x02), .b(new_n94_), .O(new_n136_));
  nand2  g103(.a(new_n48_), .b(new_n43_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n42_), .O(new_n138_));
  nand4  g105(.a(new_n45_), .b(new_n44_), .c(new_n94_), .d(x00), .O(new_n139_));
  ...
  inv1   g111(.a(new_n136_), .O(new_n145_));
  oai21  g112(.a(new_n110_), .b(new_n107_), .c(new_n145_), .O(new_n146_));
  nor2   g113(.a(x02), .b(x01), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n40_), .c(x21), .d(new_n98_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n146_), .O(z7));
  nand2  g116(.a(z7), .b(new_n144_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n141_), .O(z4));
  aoi21  g118(.a(new_n45_), .b(x00), .c(x01), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x02), .c(new_n138_), .O(z5));
  nand2  g120(.a(x20), .b(new_n87_), .O(new_n154_));
  ...
  nand4  g125(.a(new_n40_), .b(x21), .c(new_n98_), .d(new_n44_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n109_), .c(new_n108_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n107_), .c(new_n158_), .d(new_n34_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n145_), .O(z6));
endmodule
