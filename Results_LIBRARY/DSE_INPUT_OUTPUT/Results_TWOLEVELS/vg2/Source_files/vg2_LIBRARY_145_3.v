...
module FAU ( 
  ...
  nor4   g44(.a(new_n77_), .b(new_n58_), .c(new_n69_), .d(x12), .O(new_n78_));
  ...
  nor2   g74(.a(new_n58_), .b(new_n55_), .O(new_n108_));
  inv1   g75(.a(new_n108_), .O(new_n109_));
  nand4  g76(.a(new_n109_), .b(new_n107_), .c(new_n102_), .d(new_n95_), .O(z3));
  inv1   g77(.a(new_n49_), .O(new_n111_));
  inv1   g78(.a(x22), .O(new_n112_));
  oai21  g79(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(new_n112_), .c(x09), .O(new_n114_));
  oai21  g81(.a(new_n114_), .b(x16), .c(new_n81_), .O(new_n115_));
  nand2  g82(.a(new_n115_), .b(new_n111_), .O(new_n116_));
  inv1   g83(.a(new_n77_), .O(new_n117_));
  oai21  g84(.a(new_n59_), .b(x04), .c(x17), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(x22), .c(new_n54_), .O(new_n119_));
  oai21  g86(.a(new_n119_), .b(new_n56_), .c(x08), .O(new_n120_));
  nand2  g87(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  aoi21  g88(.a(new_n121_), .b(new_n116_), .c(new_n108_), .O(z4));
  nor2   g89(.a(new_n108_), .b(new_n49_), .O(z5));
  nand2  g90(.a(x20), .b(new_n69_), .O(new_n124_));
  aoi21  g91(.a(new_n124_), .b(new_n35_), .c(x11), .O(new_n125_));
  oai21  g92(.a(new_n125_), .b(x03), .c(new_n111_), .O(new_n126_));
  nand2  g93(.a(new_n58_), .b(x14), .O(new_n127_));
  aoi21  g94(.a(new_n127_), .b(x06), .c(new_n36_), .O(new_n128_));
  oai21  g95(.a(new_n128_), .b(new_n34_), .c(new_n117_), .O(new_n129_));
  nand3  g96(.a(new_n129_), .b(new_n126_), .c(new_n109_), .O(z6));
  nor2   g97(.a(new_n108_), .b(new_n77_), .O(z7));
endmodule
