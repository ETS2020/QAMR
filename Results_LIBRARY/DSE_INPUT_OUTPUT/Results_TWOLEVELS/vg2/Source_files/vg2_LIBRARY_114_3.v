...
module FAU ( 
  ...
  nand2  g019(.a(x21), .b(x02), .O(new_n53_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n82_), .c(new_n64_), .d(new_n57_), .O(new_n95_));
  ...
  oai21  g079(.a(new_n112_), .b(new_n109_), .c(new_n53_), .O(new_n113_));
  ...
  nand3  g096(.a(new_n129_), .b(new_n36_), .c(new_n128_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n127_), .c(new_n126_), .d(new_n118_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n77_), .c(x24), .O(new_n132_));
  nand4  g099(.a(new_n34_), .b(new_n44_), .c(new_n106_), .d(x00), .O(new_n133_));
  nand3  g100(.a(new_n129_), .b(new_n68_), .c(new_n36_), .O(new_n134_));
  nand2  g101(.a(new_n120_), .b(new_n94_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n118_), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n40_), .c(new_n45_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n132_), .c(new_n125_), .d(new_n53_), .O(z3));
  ...
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n128_), .O(new_n142_));
  ...
  nand3  g114(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n111_), .c(new_n110_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n109_), .c(new_n147_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n143_), .c(new_n53_), .O(z4));
  nand2  g118(.a(new_n48_), .b(new_n43_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n42_), .c(new_n53_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n46_), .O(z5));
  aoi21  g121(.a(x20), .b(new_n119_), .c(x06), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x11), .c(new_n34_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(z5), .O(new_n157_));
  nand2  g124(.a(new_n114_), .b(new_n113_), .O(z7));
