...
module FAU ( 
  ...
  nand4  g113(.a(new_n51_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n148_));
  ...
  nor2   g118(.a(new_n57_), .b(new_n53_), .O(new_n152_));
  nand4  g119(.a(new_n139_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n153_));
  oai21  g120(.a(new_n149_), .b(new_n152_), .c(new_n153_), .O(z5));
  aoi21  g121(.a(x20), .b(new_n42_), .c(x06), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x11), .c(new_n47_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(z5), .O(new_n157_));
  aoi21  g124(.a(new_n48_), .b(x14), .c(new_n36_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n41_), .c(x03), .O(new_n159_));
  inv1   g126(.a(new_n113_), .O(new_n160_));
  nand3  g127(.a(new_n51_), .b(x21), .c(new_n37_), .O(new_n161_));
