...
module FAU ( 
  ...
  nor2   g080(.a(new_n113_), .b(new_n41_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x11), .c(x06), .d(x03), .O(new_n115_));
  nor2   g082(.a(new_n35_), .b(x02), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  oai21  g084(.a(new_n115_), .b(new_n106_), .c(new_n117_), .O(z2));
  nand3  g085(.a(new_n62_), .b(new_n39_), .c(new_n36_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n45_), .c(new_n35_), .O(new_n120_));
  ...
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n130_), .O(new_n140_));
  oai21  g107(.a(new_n56_), .b(new_n52_), .c(new_n117_), .O(new_n141_));
  inv1   g108(.a(x10), .O(new_n142_));
  nor2   g109(.a(x24), .b(x21), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n142_), .c(new_n34_), .d(x00), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n141_), .O(z5));
  nand2  g112(.a(z5), .b(new_n140_), .O(new_n146_));
  inv1   g113(.a(new_n109_), .O(new_n147_));
  nand3  g114(.a(new_n111_), .b(new_n110_), .c(new_n147_), .O(new_n148_));
  inv1   g115(.a(x23), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n82_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n66_), .c(x08), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n117_), .c(new_n148_), .O(new_n153_));
  ...
  nand4  g123(.a(new_n43_), .b(new_n142_), .c(new_n34_), .d(x00), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n55_), .c(new_n53_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n52_), .c(new_n156_), .d(x03), .O(new_n159_));
  nand2  g126(.a(new_n42_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x06), .c(new_n48_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n36_), .c(new_n148_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n117_), .O(z6));
  nand4  g130(.a(new_n117_), .b(new_n111_), .c(new_n110_), .d(new_n147_), .O(z7));
endmodule
