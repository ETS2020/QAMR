...
module FAU ( 
  ...
  nand4  g036(.a(new_n69_), .b(new_n36_), .c(x02), .d(new_n35_), .O(new_n70_));
  inv1   g037(.a(new_n70_), .O(new_n71_));
  nor2   g038(.a(x11), .b(x09), .O(new_n72_));
  nand4  g039(.a(new_n72_), .b(new_n71_), .c(new_n61_), .d(new_n37_), .O(new_n73_));
  ...
  nand2  g047(.a(new_n52_), .b(new_n51_), .O(new_n81_));
  ...
  nor3   g071(.a(new_n104_), .b(new_n103_), .c(new_n40_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n102_), .c(new_n99_), .d(new_n97_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n96_), .c(new_n84_), .O(z1));
  nand2  g074(.a(new_n61_), .b(new_n34_), .O(new_n108_));
  ...
  oai21  g080(.a(new_n113_), .b(new_n111_), .c(new_n108_), .O(new_n114_));
  nor2   g081(.a(x24), .b(new_n103_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n100_), .c(x08), .d(new_n34_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n114_), .c(new_n40_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x14), .c(x11), .d(x06), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n36_), .c(new_n35_), .O(z2));
  nand3  g086(.a(new_n62_), .b(x03), .c(x01), .O(new_n120_));
  nor2   g087(.a(new_n39_), .b(new_n46_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(x20), .c(x15), .O(new_n122_));
  nand4  g089(.a(new_n37_), .b(new_n36_), .c(x02), .d(new_n35_), .O(new_n123_));
  nand4  g090(.a(new_n77_), .b(new_n39_), .c(new_n46_), .d(new_n61_), .O(new_n124_));
  ...
  nand4  g095(.a(new_n128_), .b(new_n46_), .c(new_n61_), .d(x07), .O(new_n129_));
  ...
  nand2  g100(.a(new_n115_), .b(x20), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n132_), .c(new_n62_), .d(x03), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n131_), .c(new_n126_), .O(z3));
  inv1   g104(.a(x22), .O(new_n138_));
  inv1   g105(.a(x17), .O(new_n139_));
  aoi21  g106(.a(x23), .b(new_n69_), .c(new_n139_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n138_), .c(x09), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(x18), .c(x16), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n47_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n81_), .c(x24), .O(new_n144_));
  nand3  g111(.a(new_n141_), .b(x16), .c(x15), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n76_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n83_), .O(new_n147_));
  inv1   g114(.a(x00), .O(new_n148_));
  nand3  g115(.a(new_n141_), .b(x21), .c(x16), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n41_), .c(new_n100_), .d(new_n34_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n147_), .c(new_n144_), .O(new_n152_));
  ...
  nand3  g125(.a(new_n158_), .b(x19), .c(new_n154_), .O(new_n159_));
  inv1   g126(.a(new_n159_), .O(new_n160_));
  inv1   g127(.a(x15), .O(new_n161_));
  nor2   g128(.a(new_n161_), .b(x08), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n160_), .c(new_n83_), .O(new_n163_));
  nand3  g130(.a(new_n158_), .b(new_n154_), .c(x07), .O(new_n164_));
  nand2  g131(.a(x18), .b(new_n61_), .O(new_n165_));
  ...
  inv1   g137(.a(new_n108_), .O(new_n171_));
  nor2   g138(.a(x24), .b(x10), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(x08), .c(new_n34_), .d(x00), .O(new_n173_));
  oai21  g140(.a(new_n171_), .b(new_n55_), .c(new_n173_), .O(z5));
  aoi21  g141(.a(x20), .b(new_n39_), .c(x06), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(x11), .c(new_n36_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(z5), .O(new_n177_));
  nand2  g144(.a(new_n116_), .b(new_n114_), .O(new_n178_));
  ...
  nor2   g149(.a(new_n113_), .b(new_n111_), .O(new_n183_));
  nor2   g150(.a(x08), .b(x02), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n183_), .c(new_n116_), .O(z7));
endmodule
