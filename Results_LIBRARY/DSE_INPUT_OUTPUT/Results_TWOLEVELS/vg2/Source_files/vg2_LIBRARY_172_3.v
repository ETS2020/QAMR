...
module FAU ( 
  ...
  aoi21  g125(.a(x20), .b(new_n74_), .c(x06), .O(new_n159_));
  ...
  nand3  g130(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n164_));
  ...
  nand2  g134(.a(new_n167_), .b(new_n161_), .O(z6));
  nand4  g135(.a(new_n152_), .b(new_n113_), .c(new_n112_), .d(new_n53_), .O(z7));
endmodule
