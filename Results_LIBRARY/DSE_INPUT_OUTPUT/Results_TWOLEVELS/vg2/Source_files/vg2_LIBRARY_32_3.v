...
module FAU ( 
  ...
  nor3   g078(.a(new_n111_), .b(new_n74_), .c(new_n36_), .O(new_n112_));
  ...
  nand3  g105(.a(new_n138_), .b(new_n61_), .c(new_n71_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n66_), .O(new_n140_));
  inv1   g107(.a(new_n42_), .O(new_n141_));
  and2   g108(.a(new_n50_), .b(new_n45_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n43_), .c(new_n141_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  inv1   g111(.a(new_n111_), .O(new_n145_));
  oai21  g112(.a(new_n71_), .b(x09), .c(x08), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  oai21  g114(.a(new_n62_), .b(x04), .c(x17), .O(new_n148_));
  and2   g115(.a(new_n148_), .b(x22), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(x18), .c(x16), .O(new_n150_));
  nand3  g117(.a(new_n71_), .b(x09), .c(x07), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n80_), .c(x24), .O(new_n153_));
  nand3  g120(.a(new_n149_), .b(x16), .c(x15), .O(new_n154_));
  nand3  g121(.a(x19), .b(new_n71_), .c(x09), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand4  g123(.a(new_n148_), .b(x22), .c(x21), .d(x16), .O(new_n157_));
  nand2  g124(.a(new_n71_), .b(x00), .O(new_n158_));
  ...
  aoi22  g128(.a(new_n161_), .b(x09), .c(new_n156_), .d(new_n82_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n153_), .c(new_n147_), .d(new_n144_), .O(z4));
  nand4  g130(.a(new_n142_), .b(new_n43_), .c(new_n141_), .d(new_n37_), .O(z5));
  ...
  nand2  g134(.a(new_n74_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n35_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n127_), .c(new_n145_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n37_), .O(z6));
  inv1   g138(.a(new_n106_), .O(new_n172_));
  and2   g139(.a(new_n109_), .b(new_n108_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n107_), .c(new_n172_), .d(new_n37_), .O(z7));
endmodule
