...
module FAU ( 
  ...
  nor2   g26(.a(new_n50_), .b(new_n43_), .O(new_n60_));
  ...
  oai21  g31(.a(new_n64_), .b(new_n35_), .c(new_n59_), .O(z2));
  nor2   g32(.a(new_n62_), .b(new_n36_), .O(new_n66_));
  nand4  g33(.a(new_n66_), .b(x06), .c(x03), .d(x01), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n59_), .O(z3));
  inv1   g35(.a(x04), .O(new_n69_));
  inv1   g36(.a(x17), .O(new_n70_));
  oai21  g37(.a(x23), .b(new_n69_), .c(new_n70_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n38_), .c(x09), .O(new_n72_));
  oai21  g39(.a(new_n72_), .b(x16), .c(new_n36_), .O(new_n73_));
  nand2  g40(.a(x24), .b(x07), .O(new_n74_));
  nand3  g41(.a(new_n41_), .b(x19), .c(x13), .O(new_n75_));
  ...
  nand3  g56(.a(new_n89_), .b(new_n82_), .c(new_n59_), .O(z4));
  and2   g57(.a(new_n79_), .b(new_n78_), .O(new_n91_));
  nand4  g58(.a(new_n91_), .b(new_n80_), .c(new_n77_), .d(new_n59_), .O(z5));
  inv1   g59(.a(x03), .O(new_n93_));
  inv1   g60(.a(x11), .O(new_n94_));
  oai21  g61(.a(new_n37_), .b(x06), .c(new_n94_), .O(new_n95_));
  nand2  g62(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g63(.a(new_n96_), .b(new_n81_), .O(new_n97_));
  oai22  g64(.a(x20), .b(new_n37_), .c(new_n94_), .d(x06), .O(new_n98_));
  oai21  g65(.a(new_n98_), .b(new_n93_), .c(new_n61_), .O(new_n99_));
  nand3  g66(.a(new_n99_), .b(new_n97_), .c(new_n59_), .O(z6));
  nor2   g67(.a(new_n60_), .b(z0), .O(z7));
endmodule
