...
module FAU ( 
  ...
  nor2   g019(.a(new_n52_), .b(x04), .O(new_n53_));
  ...
  nor4   g055(.a(new_n88_), .b(new_n67_), .c(new_n34_), .d(new_n66_), .O(new_n89_));
  ...
  nand4  g062(.a(new_n69_), .b(new_n68_), .c(x07), .d(new_n35_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nand4  g064(.a(new_n71_), .b(new_n70_), .c(new_n52_), .d(new_n36_), .O(new_n98_));
  nor2   g065(.a(x23), .b(x22), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n73_), .c(new_n72_), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n97_), .c(new_n95_), .O(new_n102_));
  aoi22  g069(.a(new_n102_), .b(new_n94_), .c(new_n46_), .d(new_n37_), .O(new_n103_));
  ...
  nand4  g074(.a(new_n36_), .b(new_n69_), .c(new_n68_), .d(new_n35_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand4  g076(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n52_), .O(new_n110_));
  nand3  g077(.a(new_n99_), .b(new_n73_), .c(x19), .O(new_n111_));
  ...
  nand2  g082(.a(new_n115_), .b(new_n87_), .O(z1));
  ...
  nor2   g091(.a(new_n124_), .b(new_n53_), .O(z7));
  nand2  g092(.a(z7), .b(x20), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n70_), .O(new_n127_));
  ...
  nand2  g104(.a(new_n46_), .b(new_n37_), .O(new_n138_));
  nand4  g105(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  nand3  g106(.a(new_n92_), .b(x14), .c(x11), .O(new_n140_));
  ...
  aoi21  g118(.a(x22), .b(new_n72_), .c(new_n69_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n71_), .c(x08), .O(new_n153_));
  nand2  g120(.a(new_n93_), .b(x16), .O(new_n154_));
  nor3   g121(.a(new_n154_), .b(x12), .c(x04), .O(new_n155_));
  aoi21  g122(.a(new_n153_), .b(new_n54_), .c(new_n155_), .O(new_n156_));
  aoi21  g123(.a(new_n74_), .b(x17), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n68_), .O(new_n158_));
  nor2   g125(.a(x16), .b(new_n67_), .O(new_n159_));
  aoi22  g126(.a(new_n159_), .b(new_n99_), .c(new_n158_), .d(new_n54_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n49_), .c(new_n156_), .d(new_n124_), .O(z4));
  nor2   g128(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g129(.a(x20), .b(new_n70_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n165_));
  nand2  g132(.a(new_n73_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n36_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n34_), .c(new_n123_), .d(new_n119_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n54_), .O(z6));
endmodule
