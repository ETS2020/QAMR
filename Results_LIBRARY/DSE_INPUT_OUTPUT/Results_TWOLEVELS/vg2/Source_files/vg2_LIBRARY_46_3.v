...
module FAU ( 
  ...
  nand4  g110(.a(new_n50_), .b(new_n45_), .c(new_n43_), .d(new_n143_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  inv1   g112(.a(new_n107_), .O(new_n146_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n88_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n145_), .c(new_n37_), .O(z4));
  and2   g120(.a(new_n45_), .b(new_n37_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n50_), .c(new_n43_), .d(new_n143_), .O(z5));
  nand2  g122(.a(x20), .b(new_n36_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n34_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n144_), .O(new_n158_));
  nand2  g125(.a(new_n60_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n35_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n119_), .c(new_n148_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n37_), .O(z6));
  and2   g129(.a(new_n108_), .b(new_n37_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n110_), .c(new_n109_), .d(new_n146_), .O(z7));
endmodule
