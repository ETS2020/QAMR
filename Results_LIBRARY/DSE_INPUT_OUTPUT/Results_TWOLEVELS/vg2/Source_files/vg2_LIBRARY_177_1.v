...
module FAU ( 
  ...
  nand4  g058(.a(new_n36_), .b(new_n91_), .c(new_n35_), .d(x00), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n83_), .c(new_n37_), .d(new_n45_), .O(new_n94_));
  inv1   g061(.a(x22), .O(new_n95_));
  nor2   g062(.a(x24), .b(x23), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n71_), .c(new_n95_), .d(new_n38_), .O(new_n97_));
  oai21  g064(.a(new_n97_), .b(new_n94_), .c(new_n34_), .O(new_n98_));
  ...
  nand3  g068(.a(x11), .b(new_n45_), .c(x09), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(new_n62_), .c(new_n36_), .O(new_n103_));
  inv1   g070(.a(x23), .O(new_n104_));
  nand2  g071(.a(x21), .b(x20), .O(new_n105_));
  nor4   g072(.a(new_n105_), .b(x24), .c(new_n104_), .d(new_n95_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n103_), .c(new_n101_), .d(new_n80_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n99_), .c(new_n89_), .d(new_n78_), .O(z1));
  ...
  nand2  g085(.a(x02), .b(new_n90_), .O(new_n119_));
  oai21  g086(.a(new_n118_), .b(new_n90_), .c(new_n119_), .O(z2));
  nand4  g087(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n121_));
  nor2   g088(.a(new_n67_), .b(new_n37_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand4  g090(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n90_), .O(new_n124_));
  nor2   g091(.a(x11), .b(x08), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n38_), .c(x19), .d(new_n67_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n77_), .O(new_n128_));
  nand2  g095(.a(new_n122_), .b(new_n81_), .O(new_n129_));
  nor2   g096(.a(x20), .b(x14), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n37_), .c(new_n62_), .d(x07), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n124_), .c(new_n129_), .d(new_n121_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n75_), .c(x24), .O(new_n133_));
  nand4  g100(.a(new_n36_), .b(new_n35_), .c(new_n90_), .d(x00), .O(new_n134_));
  nand2  g101(.a(new_n130_), .b(new_n125_), .O(new_n135_));
  nand3  g102(.a(new_n122_), .b(x21), .c(x20), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n121_), .c(new_n135_), .d(new_n134_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n41_), .c(new_n45_), .d(new_n34_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n133_), .c(new_n128_), .O(z3));
  oai21  g106(.a(x23), .b(new_n91_), .c(new_n69_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n95_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n62_), .O(new_n142_));
  nand2  g109(.a(new_n48_), .b(new_n44_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n43_), .c(new_n119_), .O(new_n144_));
  ...
  oai21  g115(.a(new_n104_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n148_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n68_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n113_), .b(new_n112_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n111_), .c(new_n119_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n114_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n147_), .O(z4));
  inv1   g123(.a(new_n43_), .O(new_n157_));
  and2   g124(.a(new_n145_), .b(new_n48_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n119_), .c(new_n44_), .d(new_n157_), .O(z5));
  nand2  g126(.a(x20), .b(new_n67_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n36_), .c(x11), .O(new_n161_));
  nand3  g128(.a(new_n158_), .b(new_n44_), .c(new_n157_), .O(new_n162_));
  oai21  g129(.a(new_n161_), .b(x03), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n38_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n37_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n35_), .c(new_n115_), .d(new_n111_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n119_), .O(z6));
  nand4  g134(.a(new_n119_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n168_));
  or2    g135(.a(new_n168_), .b(new_n111_), .O(z7));
endmodule
