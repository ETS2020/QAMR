...
module FAU ( 
  ...
  nand4  g102(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n48_), .c(new_n44_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n43_), .c(new_n135_), .O(new_n138_));
  ...
  oai21  g109(.a(new_n142_), .b(new_n139_), .c(x08), .O(new_n143_));
  oai21  g110(.a(new_n110_), .b(new_n106_), .c(new_n143_), .O(new_n144_));
  nand2  g111(.a(x02), .b(new_n66_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n144_), .c(new_n138_), .O(z4));
  nand2  g113(.a(new_n48_), .b(new_n44_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n43_), .c(new_n145_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n136_), .O(z5));
  aoi21  g116(.a(x20), .b(new_n103_), .c(x06), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x11), .c(new_n35_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(z5), .O(new_n152_));
  aoi21  g119(.a(new_n38_), .b(x14), .c(new_n36_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n37_), .c(x03), .O(new_n154_));
  nand2  g121(.a(new_n108_), .b(new_n107_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n106_), .c(new_n145_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n109_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n152_), .O(z6));
  nand4  g126(.a(new_n145_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n160_));
  or2    g127(.a(new_n160_), .b(new_n106_), .O(z7));
endmodule
