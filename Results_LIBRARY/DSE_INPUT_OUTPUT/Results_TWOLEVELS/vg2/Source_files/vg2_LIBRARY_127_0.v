...
module FAU ( 
  ...
  nand3  g119(.a(new_n107_), .b(new_n97_), .c(new_n105_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n115_), .c(new_n114_), .O(new_n154_));
  or2    g121(.a(new_n154_), .b(new_n113_), .O(new_n155_));
  ...
  oai21  g136(.a(new_n116_), .b(new_n113_), .c(new_n158_), .O(new_n170_));
