...
module FAU ( 
  ...
  nand4  g104(.a(new_n40_), .b(new_n94_), .c(new_n108_), .d(x00), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n45_), .c(new_n43_), .O(new_n139_));
  or2    g106(.a(new_n139_), .b(new_n42_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  or2    g108(.a(new_n110_), .b(new_n105_), .O(new_n142_));
  ...
  nand2  g116(.a(new_n108_), .b(new_n61_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n141_), .O(z4));
  nor2   g118(.a(new_n46_), .b(new_n42_), .O(new_n152_));
  nand3  g119(.a(new_n40_), .b(new_n94_), .c(x00), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x01), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n108_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(z5));
  nand2  g123(.a(x20), .b(new_n102_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n35_), .c(x11), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n140_), .O(new_n159_));
  nand2  g126(.a(new_n37_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x06), .c(new_n36_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n34_), .c(new_n142_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n150_), .O(z6));
  nand2  g130(.a(new_n107_), .b(new_n106_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n105_), .c(new_n150_), .O(new_n165_));
  nand3  g132(.a(new_n128_), .b(new_n91_), .c(new_n94_), .O(new_n166_));
