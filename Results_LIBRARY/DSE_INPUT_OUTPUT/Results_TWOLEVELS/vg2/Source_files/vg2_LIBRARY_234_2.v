...
module FAU ( 
  ...
  oai21  g104(.a(x16), .b(new_n67_), .c(new_n125_), .O(new_n138_));
  inv1   g105(.a(new_n43_), .O(new_n139_));
  nand4  g106(.a(new_n51_), .b(new_n46_), .c(new_n44_), .d(new_n139_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nor2   g108(.a(x23), .b(new_n56_), .O(new_n142_));
  nand3  g109(.a(new_n41_), .b(new_n50_), .c(x00), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n46_), .c(new_n44_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n43_), .c(new_n142_), .d(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n49_), .O(new_n146_));
  ...
  nand3  g118(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n152_));
  or2    g119(.a(new_n152_), .b(new_n107_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n147_), .c(new_n141_), .O(z4));
  and2   g122(.a(new_n46_), .b(new_n38_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n51_), .c(new_n44_), .d(new_n139_), .O(z5));
  ...
  nand2  g127(.a(new_n104_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n35_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n55_), .c(new_n153_), .O(new_n163_));
