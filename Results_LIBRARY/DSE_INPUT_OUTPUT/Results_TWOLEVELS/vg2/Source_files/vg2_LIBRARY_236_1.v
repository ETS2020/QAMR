...
module FAU ( 
  ...
  nand4  g062(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n35_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nor2   g064(.a(x12), .b(x11), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n70_), .c(new_n69_), .O(new_n99_));
  ...
  aoi22  g069(.a(new_n102_), .b(new_n94_), .c(new_n48_), .d(new_n39_), .O(new_n103_));
  ...
  nand4  g076(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n37_), .O(new_n110_));
  ...
  aoi22  g081(.a(new_n114_), .b(new_n39_), .c(new_n103_), .d(x24), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n86_), .O(z1));
  nor2   g083(.a(new_n41_), .b(new_n91_), .O(new_n117_));
  ...
  oai21  g096(.a(new_n127_), .b(new_n65_), .c(new_n129_), .O(z2));
  nand4  g097(.a(new_n57_), .b(x20), .c(x14), .d(x11), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n67_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x06), .c(x03), .d(x01), .O(new_n133_));
  nand4  g100(.a(new_n77_), .b(new_n72_), .c(new_n69_), .d(new_n37_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x11), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n67_), .c(new_n35_), .d(new_n34_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x01), .c(new_n133_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n41_), .O(new_n138_));
  nand2  g105(.a(new_n48_), .b(new_n39_), .O(new_n139_));
  ...
  nand4  g110(.a(new_n143_), .b(new_n72_), .c(new_n69_), .d(new_n37_), .O(new_n144_));
  ...
  nand4  g114(.a(new_n67_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n148_));
  nand4  g115(.a(new_n98_), .b(new_n72_), .c(x19), .d(new_n69_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n140_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n48_), .c(new_n39_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n146_), .c(new_n138_), .d(new_n129_), .O(z3));
  inv1   g119(.a(new_n51_), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n66_), .c(new_n71_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n73_), .c(x09), .O(new_n155_));
  ...
  oai22  g127(.a(new_n160_), .b(new_n70_), .c(x12), .d(x08), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n157_), .c(new_n129_), .O(z4));
  nor2   g130(.a(new_n128_), .b(new_n51_), .O(z5));
  nand2  g131(.a(x20), .b(new_n69_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x03), .c(new_n153_), .O(new_n167_));
  nand2  g134(.a(new_n72_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n36_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n34_), .c(new_n158_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n129_), .O(z6));
  nor2   g138(.a(new_n125_), .b(new_n38_), .O(z7));
endmodule
