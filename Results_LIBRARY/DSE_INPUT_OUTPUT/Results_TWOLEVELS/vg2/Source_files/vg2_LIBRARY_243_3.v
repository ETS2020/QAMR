...
module FAU ( 
  ...
  oai21  g123(.a(new_n156_), .b(x11), .c(new_n119_), .O(new_n157_));
  ...
  inv1   g129(.a(new_n107_), .O(new_n163_));
  and2   g130(.a(new_n110_), .b(new_n109_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n108_), .c(new_n163_), .d(new_n37_), .O(z7));
endmodule
