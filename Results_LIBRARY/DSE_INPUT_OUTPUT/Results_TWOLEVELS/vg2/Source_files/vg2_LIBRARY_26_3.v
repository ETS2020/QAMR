...
module FAU ( 
  ...
  nand3  g075(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n109_));
  ...
  oai21  g080(.a(new_n113_), .b(new_n96_), .c(new_n37_), .O(z2));
  ...
  nand3  g084(.a(new_n68_), .b(new_n97_), .c(new_n96_), .O(new_n118_));
  nand3  g085(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n119_));
  ...
  nand4  g089(.a(x07), .b(new_n34_), .c(new_n97_), .d(new_n96_), .O(new_n123_));
  inv1   g090(.a(x08), .O(new_n124_));
  nor2   g091(.a(x20), .b(x14), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n35_), .c(new_n124_), .O(new_n126_));
  ...
  nand3  g095(.a(new_n125_), .b(new_n68_), .c(new_n35_), .O(new_n129_));
  nand2  g096(.a(new_n116_), .b(new_n93_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n115_), .c(new_n129_), .d(new_n98_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n40_), .c(new_n49_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n128_), .c(new_n121_), .d(new_n37_), .O(z3));
  nand2  g100(.a(new_n50_), .b(new_n47_), .O(new_n134_));
  oai21  g101(.a(x23), .b(new_n95_), .c(new_n59_), .O(new_n135_));
  ...
  nand2  g109(.a(new_n108_), .b(new_n107_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n106_), .c(new_n37_), .O(new_n144_));
  nand4  g111(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n144_), .O(z7));
  nand2  g113(.a(z7), .b(new_n142_), .O(new_n147_));
  ...
  oai21  g119(.a(new_n152_), .b(x11), .c(new_n97_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n134_), .O(new_n154_));
  aoi21  g121(.a(new_n60_), .b(x14), .c(new_n34_), .O(new_n155_));
