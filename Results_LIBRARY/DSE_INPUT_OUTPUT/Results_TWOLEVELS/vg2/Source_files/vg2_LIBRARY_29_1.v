...
module FAU ( 
  ...
  oai21  g119(.a(new_n35_), .b(x02), .c(new_n115_), .O(new_n153_));
  nor2   g120(.a(x10), .b(x02), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n50_), .c(x21), .d(new_n35_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(z7));
  nand2  g123(.a(z7), .b(new_n152_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n147_), .O(z4));
  nand3  g125(.a(new_n50_), .b(new_n41_), .c(x00), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n142_), .O(z5));
  oai21  g129(.a(new_n42_), .b(x06), .c(x03), .O(new_n163_));
  nand3  g130(.a(new_n154_), .b(new_n50_), .c(x21), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  oai21  g133(.a(new_n47_), .b(x14), .c(new_n37_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n42_), .c(x03), .O(new_n168_));
  nand3  g135(.a(new_n124_), .b(new_n47_), .c(x15), .O(new_n169_));
  oai21  g136(.a(new_n168_), .b(new_n84_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n91_), .O(new_n171_));
  nand3  g138(.a(new_n124_), .b(new_n47_), .c(x18), .O(new_n172_));
  oai21  g139(.a(new_n168_), .b(new_n98_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n89_), .c(x24), .O(new_n174_));
  nor2   g141(.a(x20), .b(x06), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(x11), .c(new_n36_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n50_), .c(new_n41_), .d(x00), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n35_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n34_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n174_), .c(new_n171_), .d(new_n166_), .O(z6));
endmodule
