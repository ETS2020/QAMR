...
module FAU ( 
  ...
  nand2  g032(.a(new_n65_), .b(new_n60_), .O(new_n66_));
  ...
  nand3  g049(.a(new_n63_), .b(x20), .c(x18), .O(new_n83_));
  ...
  inv1   g060(.a(new_n59_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n57_), .c(new_n49_), .d(x01), .O(new_n95_));
  inv1   g062(.a(new_n82_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n63_), .c(x21), .d(x20), .O(new_n97_));
  ...
  oai22  g067(.a(new_n100_), .b(new_n91_), .c(new_n97_), .d(new_n95_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n41_), .c(new_n50_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n93_), .c(new_n81_), .d(new_n38_), .O(z1));
  ...
  oai21  g081(.a(new_n114_), .b(new_n104_), .c(new_n38_), .O(z2));
  ...
  nand3  g090(.a(new_n50_), .b(new_n49_), .c(x00), .O(new_n124_));
  nand3  g091(.a(x19), .b(x13), .c(x05), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n123_), .c(new_n36_), .d(new_n35_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n34_), .c(new_n55_), .d(new_n104_), .O(new_n129_));
  ...
  nand3  g100(.a(new_n98_), .b(x07), .c(new_n34_), .O(new_n134_));
  nand4  g101(.a(new_n123_), .b(new_n36_), .c(new_n35_), .d(new_n116_), .O(new_n135_));
  ...
  nand2  g105(.a(new_n98_), .b(new_n69_), .O(new_n139_));
  nand3  g106(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n132_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n45_), .c(new_n39_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n137_), .c(new_n131_), .d(new_n38_), .O(z3));
  inv1   g110(.a(x16), .O(new_n144_));
  aoi21  g111(.a(new_n37_), .b(x04), .c(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x22), .c(new_n67_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g114(.a(new_n41_), .b(new_n50_), .c(x00), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n46_), .c(new_n44_), .O(new_n149_));
  nor2   g116(.a(new_n149_), .b(new_n43_), .O(new_n150_));
  aoi21  g117(.a(new_n147_), .b(new_n116_), .c(new_n150_), .O(new_n151_));
  oai21  g118(.a(new_n62_), .b(x17), .c(x09), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x16), .c(new_n116_), .O(new_n153_));
  nand3  g120(.a(new_n41_), .b(x21), .c(new_n50_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n109_), .c(new_n108_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(new_n107_), .O(new_n156_));
  nand3  g123(.a(x16), .b(new_n50_), .c(new_n56_), .O(new_n157_));
  nand4  g124(.a(new_n41_), .b(x23), .c(x22), .d(x21), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n153_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n151_), .c(new_n49_), .O(new_n160_));
  nand2  g127(.a(new_n109_), .b(new_n108_), .O(new_n161_));
  nand2  g128(.a(x17), .b(x04), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x22), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x09), .c(new_n144_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n116_), .c(new_n161_), .d(new_n107_), .O(new_n165_));
  nand2  g132(.a(new_n62_), .b(x17), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n67_), .c(x16), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(x08), .c(new_n47_), .d(new_n43_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x23), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n160_), .O(z4));
  nand4  g138(.a(new_n51_), .b(new_n46_), .c(new_n44_), .d(new_n38_), .O(new_n172_));
  or2    g139(.a(new_n172_), .b(new_n43_), .O(z5));
  nand2  g140(.a(x20), .b(new_n36_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n34_), .c(x11), .O(new_n175_));
  nand3  g142(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n43_), .c(new_n175_), .d(x03), .O(new_n177_));
  nand2  g144(.a(new_n123_), .b(x14), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x06), .c(new_n35_), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(new_n55_), .c(new_n111_), .d(new_n107_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n177_), .c(new_n38_), .O(z6));
  nand4  g148(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n38_), .O(new_n182_));
  or2    g149(.a(new_n182_), .b(new_n107_), .O(z7));
endmodule
