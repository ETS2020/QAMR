...
module FAU ( 
  ...
  or2    g109(.a(new_n113_), .b(new_n109_), .O(new_n143_));
  ...
  nand3  g116(.a(new_n149_), .b(new_n142_), .c(new_n117_), .O(z4));
  nand3  g117(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n117_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n140_), .O(z5));
  nand2  g120(.a(x20), .b(new_n38_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n36_), .c(x11), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x03), .c(new_n141_), .O(new_n156_));
  nand2  g123(.a(new_n39_), .b(x14), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x06), .c(new_n37_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n35_), .c(new_n143_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n156_), .c(new_n117_), .O(z6));
  nand2  g127(.a(new_n111_), .b(new_n110_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n109_), .c(new_n117_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n112_), .O(z7));
endmodule
