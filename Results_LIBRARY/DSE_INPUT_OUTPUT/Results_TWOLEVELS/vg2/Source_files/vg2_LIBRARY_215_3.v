...
module FAU ( 
  ...
  oai21  g100(.a(x23), .b(new_n55_), .c(new_n73_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n61_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n66_), .O(new_n136_));
  ...
  oai21  g108(.a(new_n108_), .b(new_n104_), .c(new_n141_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n137_), .c(new_n53_), .O(z4));
  nand4  g110(.a(new_n53_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n144_));
  or2    g111(.a(new_n144_), .b(new_n42_), .O(z5));
  aoi21  g112(.a(x20), .b(new_n71_), .c(x06), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x11), .c(new_n34_), .O(new_n147_));
  ...
  aoi21  g118(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n36_), .c(x03), .O(new_n153_));
  nand2  g120(.a(new_n106_), .b(new_n105_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n104_), .c(new_n53_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n107_), .O(z7));
  nand2  g123(.a(z7), .b(new_n153_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n151_), .O(z6));
endmodule
