...
module FAU ( 
  ...
  nor2   g004(.a(x18), .b(x12), .O(new_n38_));
  ...
  nand2  g054(.a(new_n87_), .b(new_n41_), .O(new_n88_));
  inv1   g055(.a(new_n38_), .O(new_n89_));
  nand2  g056(.a(new_n48_), .b(new_n39_), .O(new_n90_));
  ...
  nand3  g082(.a(new_n115_), .b(new_n48_), .c(new_n39_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n105_), .c(new_n89_), .O(new_n117_));
  ...
  aoi21  g088(.a(new_n121_), .b(new_n120_), .c(new_n39_), .O(new_n122_));
  nand3  g089(.a(x24), .b(x18), .c(x13), .O(new_n123_));
  nand3  g090(.a(x15), .b(new_n48_), .c(new_n39_), .O(new_n124_));
  nand4  g091(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n125_));
  ...
  oai21  g098(.a(new_n131_), .b(new_n68_), .c(new_n89_), .O(z2));
  nand4  g099(.a(new_n126_), .b(x20), .c(x14), .d(x11), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n70_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(x06), .c(x03), .d(x01), .O(new_n135_));
  inv1   g102(.a(new_n51_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(x08), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n89_), .O(new_n141_));
  inv1   g108(.a(x18), .O(new_n142_));
  oai21  g109(.a(x24), .b(new_n57_), .c(new_n142_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(x15), .c(x13), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n120_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(x05), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n123_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(x20), .c(x14), .d(x11), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n70_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(x06), .c(x03), .d(x01), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n141_), .O(z3));
  oai21  g118(.a(new_n76_), .b(x04), .c(x17), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x22), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x09), .c(new_n73_), .O(new_n154_));
  nor2   g121(.a(new_n154_), .b(new_n70_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(new_n127_), .O(new_n156_));
  nand3  g123(.a(new_n41_), .b(x13), .c(x05), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n90_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x19), .O(new_n159_));
  aoi21  g126(.a(new_n76_), .b(x04), .c(x17), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x22), .c(new_n71_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n73_), .c(x08), .O(new_n162_));
  aoi21  g129(.a(new_n159_), .b(new_n47_), .c(new_n162_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n156_), .c(new_n89_), .O(new_n164_));
  inv1   g131(.a(x07), .O(new_n165_));
  nand2  g132(.a(x08), .b(new_n165_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n154_), .c(x18), .O(new_n167_));
  inv1   g134(.a(new_n162_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x12), .c(x07), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n90_), .c(x24), .O(new_n171_));
  inv1   g138(.a(new_n143_), .O(new_n172_));
  nor2   g139(.a(new_n155_), .b(new_n172_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(x15), .c(x13), .d(x05), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n164_), .O(z4));
  nand2  g142(.a(x20), .b(new_n72_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n35_), .c(x11), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x03), .c(new_n136_), .O(new_n178_));
  nand2  g145(.a(new_n37_), .b(x14), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x06), .c(new_n36_), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(new_n34_), .c(new_n128_), .d(new_n122_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n178_), .c(new_n89_), .O(z6));
  inv1   g149(.a(new_n147_), .O(new_n183_));
  oai21  g150(.a(new_n127_), .b(new_n38_), .c(new_n183_), .O(z7));
endmodule
