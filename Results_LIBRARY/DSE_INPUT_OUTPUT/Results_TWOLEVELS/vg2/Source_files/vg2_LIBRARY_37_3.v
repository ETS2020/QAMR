...
module FAU ( 
  ...
  nand2  g019(.a(x11), .b(x02), .O(new_n53_));
  ...
  nand3  g054(.a(new_n87_), .b(new_n86_), .c(new_n67_), .O(new_n88_));
  ...
  oai21  g059(.a(new_n92_), .b(new_n88_), .c(new_n84_), .O(new_n93_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n87_), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n92_), .c(new_n96_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n40_), .c(new_n45_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n94_), .c(new_n80_), .d(new_n53_), .O(z1));
  ...
  nand3  g077(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n111_));
  ...
  aoi21  g082(.a(new_n115_), .b(new_n44_), .c(new_n36_), .O(z2));
  nand4  g083(.a(x06), .b(x03), .c(new_n44_), .d(x01), .O(new_n117_));
  inv1   g084(.a(x08), .O(new_n118_));
  nor2   g085(.a(new_n36_), .b(new_n118_), .O(new_n119_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n123_), .c(new_n73_), .d(new_n68_), .O(new_n125_));
  oai21  g092(.a(new_n122_), .b(new_n117_), .c(new_n125_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n79_), .O(new_n127_));
  nand3  g094(.a(new_n119_), .b(new_n83_), .c(x14), .O(new_n128_));
  nand2  g095(.a(new_n123_), .b(new_n86_), .O(new_n129_));
  nand4  g096(.a(new_n37_), .b(new_n105_), .c(new_n36_), .d(new_n118_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n117_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n77_), .c(x24), .O(new_n132_));
  nand3  g099(.a(new_n98_), .b(new_n35_), .c(new_n34_), .O(new_n133_));
  nand4  g100(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nand3  g101(.a(new_n95_), .b(x14), .c(x11), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n130_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n137_));
  ...
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n118_), .O(new_n142_));
  nand2  g109(.a(new_n48_), .b(new_n43_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n42_), .c(new_n53_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n46_), .O(new_n145_));
  ...
  nand2  g117(.a(new_n110_), .b(new_n109_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n108_), .c(new_n53_), .O(new_n152_));
  nand4  g119(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(z7));
  nand2  g121(.a(z7), .b(new_n150_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n146_), .O(z4));
  inv1   g123(.a(new_n42_), .O(new_n157_));
  and2   g124(.a(new_n53_), .b(new_n48_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n46_), .c(new_n43_), .d(new_n157_), .O(z5));
  nand2  g126(.a(x20), .b(new_n105_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n162_));
  nor2   g129(.a(new_n112_), .b(new_n108_), .O(new_n163_));
  aoi21  g130(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n163_), .c(new_n44_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x11), .O(new_n166_));
  nand3  g133(.a(new_n153_), .b(new_n110_), .c(new_n109_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n108_), .c(new_n34_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n166_), .c(new_n162_), .O(z6));
endmodule
