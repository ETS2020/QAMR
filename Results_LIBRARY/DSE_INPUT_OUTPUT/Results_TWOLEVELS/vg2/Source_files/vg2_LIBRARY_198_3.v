...
module FAU ( 
  ...
  nand4  g32(.a(new_n65_), .b(new_n53_), .c(new_n36_), .d(new_n52_), .O(new_n66_));
  ...
  nor3   g46(.a(new_n79_), .b(new_n60_), .c(new_n71_), .O(new_n80_));
  nand4  g47(.a(new_n80_), .b(x11), .c(x06), .d(x03), .O(new_n81_));
  oai21  g48(.a(new_n81_), .b(new_n70_), .c(new_n55_), .O(z2));
  ...
  nand4  g76(.a(new_n109_), .b(new_n104_), .c(new_n97_), .d(new_n55_), .O(z3));
  inv1   g77(.a(new_n49_), .O(new_n111_));
  inv1   g78(.a(x22), .O(new_n112_));
  oai21  g79(.a(x23), .b(new_n57_), .c(new_n59_), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(new_n112_), .c(x09), .O(new_n114_));
  oai21  g81(.a(new_n114_), .b(x16), .c(new_n83_), .O(new_n115_));
  nand2  g82(.a(new_n115_), .b(new_n111_), .O(new_n116_));
  inv1   g83(.a(new_n79_), .O(new_n117_));
  oai21  g84(.a(new_n61_), .b(x04), .c(x17), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(x22), .c(new_n52_), .O(new_n119_));
  oai21  g86(.a(new_n119_), .b(new_n58_), .c(x08), .O(new_n120_));
  nand2  g87(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand3  g88(.a(new_n121_), .b(new_n116_), .c(new_n55_), .O(z4));
  nor2   g89(.a(new_n54_), .b(new_n49_), .O(z5));
  nand2  g90(.a(x20), .b(new_n71_), .O(new_n124_));
  ...
  nor2   g97(.a(new_n79_), .b(new_n54_), .O(z7));
endmodule
