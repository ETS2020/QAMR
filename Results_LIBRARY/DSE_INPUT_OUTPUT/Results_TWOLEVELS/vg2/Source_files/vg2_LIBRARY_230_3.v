...
module FAU ( 
  ...
  or2    g119(.a(new_n49_), .b(new_n42_), .O(new_n153_));
  ...
  oai21  g124(.a(new_n102_), .b(x04), .c(x17), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n67_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n91_), .c(x08), .O(new_n160_));
  nand3  g127(.a(new_n144_), .b(new_n45_), .c(new_n44_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n123_), .c(new_n122_), .O(new_n162_));
  or2    g129(.a(new_n162_), .b(new_n121_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n157_), .c(new_n53_), .O(z4));
  ...
  nand2  g135(.a(x20), .b(new_n90_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x11), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x03), .c(new_n153_), .O(new_n171_));
  ...
  nand2  g142(.a(new_n123_), .b(new_n122_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n121_), .c(new_n53_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n161_), .O(z7));
endmodule
