...
module FAU ( 
  ...
  or2    g122(.a(new_n49_), .b(new_n42_), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n55_), .c(new_n88_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n113_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n59_), .O(new_n159_));
  ...
  nand3  g130(.a(new_n147_), .b(new_n45_), .c(new_n44_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n160_), .c(new_n53_), .O(z4));
  ...
  oai21  g139(.a(new_n172_), .b(x03), .c(new_n156_), .O(new_n173_));
  nand2  g140(.a(new_n37_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n36_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n34_), .c(new_n165_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n53_), .O(z6));
  nand3  g144(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n53_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n164_), .O(z7));
endmodule
