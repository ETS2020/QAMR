...
module FAU ( 
  ...
  nand3  g115(.a(new_n148_), .b(new_n45_), .c(new_n44_), .O(new_n149_));
  ...
  nor2   g119(.a(x02), .b(new_n106_), .O(new_n153_));
  ...
  oai21  g123(.a(new_n156_), .b(new_n42_), .c(new_n154_), .O(new_n157_));
  nand4  g124(.a(new_n97_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n158_));
  ...
  oai21  g128(.a(new_n161_), .b(x03), .c(new_n138_), .O(new_n162_));
  nand2  g129(.a(new_n37_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n34_), .c(new_n151_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n154_), .O(z6));
  oai21  g133(.a(new_n112_), .b(new_n109_), .c(new_n154_), .O(new_n167_));
  nand4  g134(.a(new_n148_), .b(new_n45_), .c(new_n44_), .d(new_n106_), .O(new_n168_));
