...
module FAU ( 
  ...
  nand4  g112(.a(new_n68_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n146_));
  ...
  nand2  g120(.a(new_n99_), .b(new_n71_), .O(new_n154_));
  nor3   g121(.a(new_n154_), .b(new_n56_), .c(new_n52_), .O(new_n155_));
  ...
  nor2   g125(.a(new_n71_), .b(x04), .O(new_n159_));
  aoi22  g126(.a(new_n159_), .b(new_n93_), .c(new_n158_), .d(new_n54_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n124_), .c(new_n156_), .d(new_n49_), .O(z4));
