...
module FAU ( 
  ...
  nor2   g35(.a(new_n36_), .b(new_n34_), .O(z2));
  ...
  inv1   g48(.a(x18), .O(new_n82_));
  nand3  g49(.a(new_n39_), .b(x15), .c(x13), .O(new_n83_));
  oai21  g50(.a(new_n39_), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  nand2  g51(.a(new_n84_), .b(x05), .O(new_n85_));
  nand3  g52(.a(x24), .b(x18), .c(x13), .O(new_n86_));
  nand3  g53(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n87_));
  nand4  g54(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n88_));
  nand3  g55(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  inv1   g56(.a(new_n89_), .O(new_n90_));
  nand2  g57(.a(new_n90_), .b(new_n85_), .O(new_n91_));
  nand2  g58(.a(new_n91_), .b(new_n81_), .O(new_n92_));
  aoi21  g59(.a(new_n92_), .b(new_n78_), .c(z2), .O(z4));
  nor2   g60(.a(z2), .b(new_n49_), .O(z5));
  inv1   g61(.a(x21), .O(new_n95_));
  nand2  g62(.a(x03), .b(x00), .O(new_n96_));
  oai21  g63(.a(new_n95_), .b(x03), .c(new_n96_), .O(new_n97_));
  nand3  g64(.a(new_n97_), .b(new_n44_), .c(new_n43_), .O(new_n98_));
  ...
  nand2  g70(.a(new_n46_), .b(new_n37_), .O(new_n104_));
  nand2  g71(.a(x07), .b(x03), .O(new_n105_));
  oai21  g72(.a(new_n82_), .b(x03), .c(new_n105_), .O(new_n106_));
  nand3  g73(.a(new_n106_), .b(new_n104_), .c(x24), .O(new_n107_));
  nand3  g74(.a(new_n101_), .b(new_n46_), .c(new_n37_), .O(new_n108_));
  nand2  g75(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  oai21  g76(.a(new_n109_), .b(new_n103_), .c(new_n70_), .O(new_n110_));
  oai21  g77(.a(new_n36_), .b(x14), .c(new_n55_), .O(new_n111_));
  nand3  g78(.a(new_n111_), .b(new_n50_), .c(new_n34_), .O(new_n112_));
  nand2  g79(.a(new_n35_), .b(x06), .O(new_n113_));
  nand4  g80(.a(new_n113_), .b(new_n91_), .c(new_n36_), .d(x11), .O(new_n114_));
  nand3  g81(.a(new_n114_), .b(new_n112_), .c(new_n110_), .O(z6));
  aoi21  g82(.a(new_n90_), .b(new_n85_), .c(z2), .O(z7));
endmodule
