...
module FAU ( 
  ...
  nand3  g093(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n127_));
  nand3  g094(.a(new_n77_), .b(new_n36_), .c(new_n35_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n83_), .O(new_n130_));
  nand3  g097(.a(new_n110_), .b(x20), .c(x18), .O(new_n131_));
  nand4  g098(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n132_));
  nand4  g099(.a(new_n92_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n133_));
  ...
  nand4  g102(.a(new_n34_), .b(new_n68_), .c(new_n67_), .d(x00), .O(new_n136_));
  ...
  oai21  g111(.a(x23), .b(new_n69_), .c(new_n91_), .O(new_n145_));
  ...
  oai21  g118(.a(new_n151_), .b(new_n93_), .c(x08), .O(new_n152_));
  inv1   g119(.a(new_n39_), .O(new_n153_));
  nand4  g120(.a(new_n111_), .b(x12), .c(new_n50_), .d(new_n37_), .O(new_n154_));
  oai21  g121(.a(new_n121_), .b(new_n153_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n148_), .O(z4));
  nor2   g124(.a(new_n48_), .b(new_n44_), .O(new_n158_));
  nand3  g125(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x12), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n37_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(z5));
  nand2  g129(.a(x20), .b(new_n36_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n34_), .c(x11), .O(new_n164_));
  nand4  g131(.a(new_n42_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n47_), .c(new_n45_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n44_), .c(new_n164_), .d(x03), .O(new_n167_));
  nand2  g134(.a(new_n92_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n35_), .O(new_n169_));
  nand3  g136(.a(new_n111_), .b(new_n50_), .c(new_n37_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n119_), .c(new_n118_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n117_), .c(new_n169_), .d(new_n68_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n167_), .c(new_n39_), .O(z6));
  aoi21  g140(.a(new_n111_), .b(new_n50_), .c(new_n38_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x02), .c(new_n121_), .O(z7));
endmodule
