...
module FAU ( 
  ...
  nand4  g119(.a(new_n138_), .b(new_n108_), .c(x01), .d(x00), .O(new_n153_));
  ...
  nand2  g126(.a(new_n107_), .b(new_n106_), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(new_n105_), .O(new_n161_));
  nand2  g128(.a(new_n128_), .b(new_n94_), .O(new_n162_));
  ...
  oai21  g134(.a(new_n163_), .b(new_n61_), .c(new_n108_), .O(new_n168_));
