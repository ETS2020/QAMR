...
module FAU ( 
  ...
  nand2  g019(.a(new_n47_), .b(x02), .O(new_n53_));
  ...
  oai21  g047(.a(new_n38_), .b(x02), .c(new_n47_), .O(new_n81_));
  ...
  aoi21  g109(.a(new_n142_), .b(new_n47_), .c(new_n136_), .O(new_n143_));
  ...
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n115_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  or2    g119(.a(new_n110_), .b(new_n106_), .O(new_n153_));
  ...
  nand3  g125(.a(new_n158_), .b(new_n152_), .c(new_n53_), .O(z4));
  oai21  g126(.a(new_n72_), .b(x05), .c(new_n44_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n47_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n46_), .c(new_n43_), .d(new_n145_), .O(z5));
  nand2  g129(.a(x20), .b(new_n103_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n147_), .O(new_n165_));
  ...
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n53_), .O(z6));
  oai21  g136(.a(new_n104_), .b(x02), .c(new_n105_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x05), .O(new_n171_));
  nand3  g138(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n108_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n44_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n107_), .O(z7));
endmodule
