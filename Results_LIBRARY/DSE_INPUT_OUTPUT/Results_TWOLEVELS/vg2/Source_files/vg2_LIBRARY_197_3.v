...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(x11), .c(x06), .d(x01), .O(new_n80_));
  aoi21  g047(.a(new_n80_), .b(new_n52_), .c(new_n34_), .O(z2));
  ...
  nand3  g060(.a(new_n93_), .b(new_n35_), .c(new_n34_), .O(new_n94_));
  ...
  nand3  g067(.a(new_n100_), .b(x07), .c(new_n35_), .O(new_n101_));
  nand4  g068(.a(new_n60_), .b(new_n70_), .c(new_n36_), .d(new_n82_), .O(new_n102_));
  oai22  g069(.a(new_n102_), .b(new_n101_), .c(new_n99_), .d(new_n98_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n97_), .c(x24), .O(new_n104_));
  nand4  g071(.a(x08), .b(x06), .c(new_n37_), .d(x01), .O(new_n105_));
  nor2   g072(.a(x13), .b(new_n36_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(x20), .c(x15), .d(x14), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n105_), .c(new_n52_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(x03), .O(new_n109_));
  nor3   g076(.a(x08), .b(x06), .c(x05), .O(new_n110_));
  nand3  g077(.a(new_n60_), .b(x19), .c(new_n70_), .O(new_n111_));
  nor3   g078(.a(new_n111_), .b(x13), .c(x11), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n110_), .c(new_n100_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n109_), .c(new_n104_), .d(new_n96_), .O(z3));
  inv1   g081(.a(new_n49_), .O(new_n115_));
  inv1   g082(.a(x22), .O(new_n116_));
  oai21  g083(.a(x23), .b(new_n52_), .c(new_n59_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n116_), .c(x09), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(x16), .c(new_n82_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  inv1   g087(.a(new_n78_), .O(new_n121_));
  ...
  nand3  g092(.a(new_n125_), .b(new_n120_), .c(new_n54_), .O(z4));
  inv1   g093(.a(new_n41_), .O(new_n127_));
  and2   g094(.a(new_n47_), .b(new_n45_), .O(new_n128_));
  nand4  g095(.a(new_n54_), .b(new_n128_), .c(new_n42_), .d(new_n127_), .O(z5));
  nand2  g096(.a(x20), .b(new_n70_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n35_), .c(x11), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(x03), .c(new_n115_), .O(new_n132_));
  nand2  g099(.a(new_n60_), .b(x14), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x06), .c(new_n36_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n34_), .c(new_n121_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n132_), .c(new_n54_), .O(z6));
  nor2   g103(.a(new_n78_), .b(new_n53_), .O(z7));
endmodule
