...
module FAU ( 
  ...
  aoi21  g092(.a(new_n125_), .b(x11), .c(new_n68_), .O(z2));
  nand4  g093(.a(new_n56_), .b(x20), .c(x14), .d(x08), .O(new_n127_));
  nor4   g094(.a(new_n127_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n128_));
  nand4  g095(.a(new_n76_), .b(new_n71_), .c(new_n36_), .d(new_n66_), .O(new_n129_));
  ...
  nand3  g100(.a(new_n91_), .b(x14), .c(x08), .O(new_n134_));
  nand3  g101(.a(new_n35_), .b(new_n34_), .c(new_n64_), .O(new_n135_));
  nand4  g102(.a(new_n71_), .b(new_n36_), .c(new_n66_), .d(x07), .O(new_n136_));
  ...
  nand4  g106(.a(new_n71_), .b(x19), .c(new_n36_), .d(new_n66_), .O(new_n140_));
  ...
  nor2   g109(.a(new_n68_), .b(x11), .O(new_n143_));
  ...
  nor2   g126(.a(x20), .b(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n146_), .O(new_n162_));
  oai22  g129(.a(x20), .b(new_n68_), .c(new_n36_), .d(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n34_), .c(new_n151_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n162_), .c(new_n144_), .O(z6));
  inv1   g132(.a(new_n118_), .O(new_n166_));
  and2   g133(.a(new_n120_), .b(new_n119_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n144_), .c(new_n121_), .d(new_n166_), .O(z7));
endmodule
