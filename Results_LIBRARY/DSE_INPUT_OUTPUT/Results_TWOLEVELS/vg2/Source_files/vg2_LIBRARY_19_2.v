...
module FAU ( 
  ...
  oai21  g108(.a(new_n55_), .b(new_n51_), .c(new_n141_), .O(new_n142_));
  nor2   g109(.a(x24), .b(x10), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n142_), .O(z5));
  nand2  g112(.a(z5), .b(new_n139_), .O(new_n146_));
  oai21  g113(.a(new_n68_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n71_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n93_), .c(x08), .O(new_n149_));
  nand2  g116(.a(new_n141_), .b(new_n115_), .O(new_n150_));
  nor2   g117(.a(x02), .b(x01), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n49_), .c(x21), .d(new_n38_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n150_), .O(z7));
  nand2  g120(.a(z7), .b(new_n149_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n146_), .O(z4));
  nand2  g122(.a(x20), .b(new_n41_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n37_), .c(x11), .O(new_n157_));
  nand3  g124(.a(new_n143_), .b(new_n34_), .c(x00), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n54_), .c(new_n52_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n51_), .c(new_n157_), .d(x03), .O(new_n160_));
  nand2  g127(.a(new_n46_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n40_), .O(new_n162_));
  nand4  g129(.a(new_n49_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n164_));
  oai21  g131(.a(new_n162_), .b(new_n36_), .c(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n160_), .c(new_n141_), .O(z6));
endmodule
