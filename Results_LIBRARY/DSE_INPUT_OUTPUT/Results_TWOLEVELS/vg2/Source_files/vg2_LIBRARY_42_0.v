...
module FAU ( 
  ...
  nor2   g018(.a(x12), .b(x04), .O(new_n52_));
  ...
  nand3  g097(.a(new_n130_), .b(new_n127_), .c(new_n53_), .O(z6));
  inv1   g098(.a(new_n61_), .O(new_n132_));
  and2   g099(.a(new_n64_), .b(new_n63_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n62_), .c(new_n132_), .d(new_n53_), .O(z7));
endmodule
