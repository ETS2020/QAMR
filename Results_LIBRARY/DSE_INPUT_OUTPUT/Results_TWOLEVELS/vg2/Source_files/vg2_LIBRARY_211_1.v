...
module FAU ( 
  ...
  nor2   g056(.a(new_n58_), .b(new_n73_), .O(new_n90_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n70_), .d(new_n69_), .O(new_n95_));
  ...
  nor4   g088(.a(new_n121_), .b(new_n52_), .c(new_n71_), .d(new_n57_), .O(new_n122_));
  ...
  nand4  g092(.a(new_n125_), .b(x20), .c(x16), .d(x14), .O(new_n126_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n52_), .c(new_n57_), .d(new_n36_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n132_));
  oai21  g099(.a(new_n128_), .b(new_n67_), .c(new_n132_), .O(new_n133_));
  ...
  nor2   g103(.a(new_n57_), .b(new_n36_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n89_), .d(x16), .O(new_n138_));
  nor2   g105(.a(x03), .b(x01), .O(new_n139_));
  nor2   g106(.a(x11), .b(x08), .O(new_n140_));
  nor2   g107(.a(x20), .b(x14), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n94_), .O(new_n142_));
  aoi22  g109(.a(new_n142_), .b(new_n138_), .c(new_n46_), .d(new_n37_), .O(new_n143_));
  nor2   g110(.a(new_n52_), .b(new_n71_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n137_), .c(new_n136_), .d(x15), .O(new_n145_));
  nor2   g112(.a(x14), .b(x11), .O(new_n146_));
  inv1   g113(.a(x19), .O(new_n147_));
  nor2   g114(.a(x20), .b(new_n147_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n146_), .c(new_n139_), .d(new_n105_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n145_), .c(x13), .O(new_n150_));
  aoi22  g117(.a(new_n150_), .b(new_n37_), .c(new_n143_), .d(x24), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n134_), .O(z3));
  inv1   g119(.a(new_n49_), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n154_));
  ...
  oai21  g125(.a(new_n58_), .b(x04), .c(x17), .O(new_n159_));
  ...
  nand3  g129(.a(new_n162_), .b(new_n157_), .c(new_n54_), .O(z4));
