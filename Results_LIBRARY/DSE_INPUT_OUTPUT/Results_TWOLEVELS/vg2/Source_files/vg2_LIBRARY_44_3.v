...
module FAU ( 
  ...
  nand2  g107(.a(new_n103_), .b(new_n102_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(x05), .O(new_n142_));
  inv1   g109(.a(new_n108_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g111(.a(x22), .b(new_n73_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x09), .c(new_n72_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n66_), .c(new_n144_), .O(new_n147_));
  nand3  g114(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n106_), .c(new_n105_), .O(new_n149_));
  inv1   g116(.a(new_n149_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n142_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(x22), .c(x16), .d(new_n55_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n44_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x23), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n147_), .c(new_n140_), .O(z4));
  and2   g122(.a(new_n53_), .b(new_n48_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n46_), .c(new_n43_), .d(new_n134_), .O(z5));
  nand2  g124(.a(x20), .b(new_n71_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n35_), .c(x11), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n136_), .O(new_n160_));
  nand2  g127(.a(new_n37_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n36_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n34_), .c(new_n144_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n53_), .O(z6));
  nand2  g131(.a(new_n106_), .b(new_n105_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n104_), .c(new_n53_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n107_), .O(z7));
endmodule
