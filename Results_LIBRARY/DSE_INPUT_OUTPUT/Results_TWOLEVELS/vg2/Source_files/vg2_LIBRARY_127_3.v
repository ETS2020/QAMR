...
module FAU ( 
  ...
  oai21  g104(.a(x23), .b(new_n56_), .c(new_n74_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n62_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n119_), .O(new_n140_));
  ...
  oai21  g110(.a(new_n143_), .b(new_n73_), .c(x08), .O(new_n144_));
  nand4  g111(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n111_), .c(new_n110_), .O(new_n146_));
  or2    g113(.a(new_n146_), .b(new_n109_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g115(.a(x02), .b(x01), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n148_), .c(new_n141_), .O(z4));
  nand2  g117(.a(new_n48_), .b(new_n43_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n42_), .c(new_n149_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n46_), .O(z5));
  nand2  g120(.a(x20), .b(new_n72_), .O(new_n154_));
  ...
  oai21  g125(.a(new_n158_), .b(new_n34_), .c(new_n147_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n156_), .c(new_n149_), .O(z6));
  nand2  g127(.a(new_n111_), .b(new_n110_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n109_), .c(new_n149_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n145_), .O(z7));
endmodule
