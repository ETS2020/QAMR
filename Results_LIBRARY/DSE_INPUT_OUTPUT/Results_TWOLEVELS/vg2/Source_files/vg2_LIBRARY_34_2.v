...
module FAU ( 
  ...
  nand4  g047(.a(new_n80_), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n81_));
  ...
  nand4  g059(.a(new_n67_), .b(new_n66_), .c(x07), .d(new_n37_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n69_), .b(new_n68_), .c(new_n54_), .d(new_n34_), .O(new_n95_));
  ...
  aoi22  g065(.a(new_n98_), .b(new_n91_), .c(new_n47_), .d(new_n38_), .O(new_n99_));
  ...
  nand4  g070(.a(new_n34_), .b(new_n67_), .c(new_n66_), .d(new_n37_), .O(new_n104_));
  inv1   g071(.a(new_n104_), .O(new_n105_));
  nand4  g072(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n54_), .O(new_n106_));
  ...
  aoi22  g077(.a(new_n110_), .b(new_n38_), .c(new_n99_), .d(x24), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n85_), .O(z1));
  and2   g079(.a(x24), .b(x18), .O(new_n113_));
  ...
  aoi21  g092(.a(new_n125_), .b(x20), .c(new_n34_), .O(z2));
  nand4  g093(.a(new_n57_), .b(x14), .c(x11), .d(x08), .O(new_n127_));
  nor4   g094(.a(new_n127_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n128_));
  nand4  g095(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n66_), .O(new_n129_));
  nor4   g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n128_), .c(new_n40_), .O(new_n131_));
  nand2  g098(.a(new_n47_), .b(new_n38_), .O(new_n132_));
  nand3  g099(.a(x06), .b(x03), .c(x01), .O(new_n133_));
  nand4  g100(.a(x18), .b(x14), .c(x11), .d(x08), .O(new_n134_));
  nand3  g101(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n135_));
  ...
  nand4  g105(.a(x15), .b(x14), .c(x11), .d(x08), .O(new_n139_));
  ...
  oai21  g117(.a(new_n73_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n67_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n69_), .c(x08), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n122_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n150_), .c(new_n144_), .O(z4));
  inv1   g122(.a(new_n42_), .O(new_n156_));
  and2   g123(.a(new_n46_), .b(new_n43_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n144_), .c(new_n48_), .d(new_n156_), .O(z5));
  oai21  g125(.a(new_n34_), .b(x06), .c(x03), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n122_), .O(new_n160_));
  nand2  g127(.a(x20), .b(new_n68_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n37_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n146_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n144_), .O(z6));
  nor2   g131(.a(new_n143_), .b(new_n123_), .O(z7));
endmodule
