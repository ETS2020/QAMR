...
module FAU ( 
  ...
  oai21  g118(.a(new_n150_), .b(new_n149_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g132(.a(new_n165_), .b(new_n149_), .O(z5));
  aoi21  g133(.a(x20), .b(new_n41_), .c(x06), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x11), .c(new_n36_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n152_), .O(new_n169_));
  aoi21  g136(.a(new_n42_), .b(x14), .c(new_n37_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n40_), .c(x03), .O(new_n171_));
