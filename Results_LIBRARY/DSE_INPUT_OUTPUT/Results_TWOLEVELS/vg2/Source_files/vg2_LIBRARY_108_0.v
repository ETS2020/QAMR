...
module FAU ( 
  ...
  inv1   g018(.a(new_n50_), .O(new_n52_));
  ...
  aoi21  g054(.a(new_n87_), .b(new_n75_), .c(new_n52_), .O(z1));
  inv1   g055(.a(x01), .O(new_n89_));
  nand2  g056(.a(x24), .b(x18), .O(new_n90_));
  nand3  g057(.a(new_n40_), .b(x15), .c(x13), .O(new_n91_));
  ...
  nand3  g080(.a(new_n113_), .b(new_n72_), .c(x24), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n108_), .c(new_n52_), .O(z3));
  ...
  aoi21  g093(.a(new_n126_), .b(x22), .c(new_n61_), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n124_), .c(x08), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n97_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n123_), .c(new_n50_), .O(z4));
  ...
  oai21  g103(.a(new_n136_), .b(new_n34_), .c(new_n97_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n134_), .c(new_n52_), .O(z6));
  nand4  g105(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n50_), .O(z7));
endmodule
