...
module FAU ( 
  ...
  nand4  g066(.a(new_n99_), .b(new_n85_), .c(new_n34_), .d(new_n95_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n90_), .c(new_n94_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n40_), .c(new_n49_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n92_), .c(new_n80_), .d(new_n37_), .O(z1));
  ...
  oai21  g074(.a(new_n104_), .b(new_n44_), .c(new_n107_), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n106_), .c(new_n37_), .O(new_n109_));
  nand4  g076(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n109_), .c(new_n60_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(x14), .c(x11), .d(x06), .O(new_n112_));
  nor3   g079(.a(new_n112_), .b(new_n97_), .c(new_n96_), .O(z2));
  ...
  nand3  g083(.a(new_n68_), .b(new_n97_), .c(new_n96_), .O(new_n117_));
  nand3  g084(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n118_));
  oai22  g085(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n114_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n79_), .O(new_n120_));
  nand2  g087(.a(new_n115_), .b(new_n83_), .O(new_n121_));
  nand4  g088(.a(x07), .b(new_n34_), .c(new_n97_), .d(new_n96_), .O(new_n122_));
  inv1   g089(.a(x08), .O(new_n123_));
  nor2   g090(.a(x20), .b(x14), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n35_), .c(new_n123_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n122_), .c(new_n121_), .d(new_n114_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n77_), .c(x24), .O(new_n127_));
  nand3  g094(.a(new_n124_), .b(new_n68_), .c(new_n35_), .O(new_n128_));
  nand2  g095(.a(new_n115_), .b(new_n93_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n114_), .c(new_n128_), .d(new_n98_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n40_), .c(new_n49_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n127_), .c(new_n120_), .d(new_n37_), .O(z3));
  nand2  g099(.a(new_n50_), .b(new_n47_), .O(new_n133_));
  oai21  g100(.a(x23), .b(new_n95_), .c(new_n59_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n62_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n123_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g104(.a(new_n110_), .b(new_n109_), .O(z7));
  inv1   g105(.a(x16), .O(new_n139_));
  oai21  g106(.a(new_n63_), .b(x04), .c(x17), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x22), .c(new_n66_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n139_), .c(x08), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(z7), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n137_), .O(z4));
  inv1   g111(.a(new_n42_), .O(new_n145_));
  and2   g112(.a(new_n50_), .b(new_n43_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n45_), .c(new_n145_), .d(new_n37_), .O(z5));
  aoi21  g114(.a(x20), .b(new_n36_), .c(x06), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x11), .c(new_n97_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n133_), .O(new_n150_));
  aoi21  g117(.a(new_n60_), .b(x14), .c(new_n34_), .O(new_n151_));
