...
module FAU ( 
  ...
  nand4  g066(.a(new_n74_), .b(new_n73_), .c(new_n59_), .d(new_n36_), .O(new_n100_));
  nand4  g067(.a(new_n77_), .b(new_n76_), .c(new_n37_), .d(new_n75_), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n99_), .c(new_n97_), .O(new_n103_));
  aoi22  g070(.a(new_n103_), .b(new_n96_), .c(new_n48_), .d(new_n38_), .O(new_n104_));
  ...
  nand4  g077(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n59_), .O(new_n111_));
  nand4  g078(.a(new_n77_), .b(new_n76_), .c(new_n37_), .d(x19), .O(new_n112_));
  ...
  nor4   g093(.a(new_n126_), .b(new_n56_), .c(new_n37_), .d(new_n73_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x11), .c(x06), .d(x03), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n70_), .O(z2));
  ...
  nand4  g099(.a(new_n80_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n40_), .O(new_n137_));
  nand2  g104(.a(new_n48_), .b(new_n38_), .O(new_n138_));
  nand4  g105(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  nand3  g106(.a(new_n94_), .b(x14), .c(x11), .O(new_n140_));
  nand4  g107(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n141_));
  nand4  g108(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n71_), .O(new_n142_));
  ...
  nand4  g112(.a(new_n71_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n146_));
  nand4  g113(.a(new_n37_), .b(x19), .c(new_n73_), .d(new_n36_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n139_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n48_), .c(new_n38_), .O(new_n149_));
  and2   g116(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n137_), .c(new_n56_), .O(z3));
  nand2  g118(.a(new_n76_), .b(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n72_), .c(x16), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x08), .c(new_n51_), .O(new_n154_));
  inv1   g121(.a(new_n126_), .O(new_n155_));
  oai21  g122(.a(new_n77_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n72_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n74_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n154_), .c(new_n57_), .O(z4));
  nand4  g127(.a(new_n57_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(z5));
  nand2  g128(.a(x20), .b(new_n73_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x03), .c(new_n51_), .O(new_n164_));
  ...
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n57_), .O(z6));
  inv1   g135(.a(new_n120_), .O(new_n169_));
  nand4  g136(.a(new_n124_), .b(new_n121_), .c(new_n169_), .d(new_n57_), .O(z7));
endmodule
