...
module FAU ( 
  ...
  nor2   g063(.a(new_n96_), .b(new_n39_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n83_), .c(new_n65_), .O(new_n98_));
  nor2   g065(.a(x03), .b(x01), .O(new_n99_));
  nor2   g066(.a(x06), .b(x04), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n85_), .d(x00), .O(new_n101_));
  oai22  g068(.a(new_n101_), .b(new_n90_), .c(new_n98_), .d(new_n95_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n41_), .c(new_n46_), .O(new_n103_));
  nand2  g070(.a(new_n37_), .b(x02), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n103_), .c(new_n92_), .d(new_n81_), .O(z1));
  ...
  oai21  g082(.a(new_n115_), .b(new_n93_), .c(new_n104_), .O(z2));
  nand4  g083(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n117_));
  nand4  g084(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n118_));
  nand2  g085(.a(new_n99_), .b(new_n69_), .O(new_n119_));
  ...
  nand2  g088(.a(new_n121_), .b(new_n80_), .O(new_n122_));
  nand4  g089(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n123_));
  nand3  g090(.a(new_n99_), .b(x07), .c(new_n36_), .O(new_n124_));
  ...
  nand4  g095(.a(new_n36_), .b(new_n35_), .c(new_n93_), .d(x00), .O(new_n129_));
  nand3  g096(.a(new_n94_), .b(x06), .c(x03), .O(new_n130_));
  nand4  g097(.a(new_n97_), .b(x14), .c(x11), .d(x08), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n126_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n41_), .c(new_n46_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n128_), .c(new_n122_), .d(new_n104_), .O(z3));
  ...
  oai21  g105(.a(new_n138_), .b(x16), .c(new_n125_), .O(new_n139_));
  nand4  g106(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n141_));
  ...
  nand3  g114(.a(new_n147_), .b(new_n142_), .c(new_n104_), .O(z4));
  and2   g115(.a(new_n104_), .b(new_n50_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n140_), .c(new_n45_), .d(new_n44_), .O(z5));
  nand3  g117(.a(x19), .b(x13), .c(x05), .O(new_n151_));
  inv1   g118(.a(new_n151_), .O(new_n152_));
  aoi21  g119(.a(new_n46_), .b(x00), .c(new_n152_), .O(new_n153_));
  oai21  g120(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n37_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n35_), .c(new_n153_), .O(new_n156_));
  nand3  g123(.a(x15), .b(x13), .c(x05), .O(new_n157_));
  oai21  g124(.a(new_n96_), .b(x10), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n35_), .O(new_n159_));
  oai21  g126(.a(x20), .b(new_n38_), .c(x06), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(x21), .c(x11), .d(new_n46_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n156_), .c(new_n41_), .O(new_n163_));
  inv1   g130(.a(x07), .O(new_n164_));
  aoi21  g131(.a(new_n154_), .b(new_n37_), .c(x03), .O(new_n165_));
  nand2  g132(.a(x18), .b(new_n35_), .O(new_n166_));
  ...
  oai21  g136(.a(new_n165_), .b(new_n73_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n49_), .c(new_n48_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n163_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n34_), .O(new_n173_));
  inv1   g140(.a(x18), .O(new_n174_));
  nor2   g141(.a(new_n160_), .b(new_n35_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n174_), .c(new_n164_), .d(new_n35_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n78_), .c(x24), .O(new_n177_));
  inv1   g144(.a(x15), .O(new_n178_));
  nor2   g145(.a(new_n175_), .b(new_n178_), .O(new_n179_));
  nor2   g146(.a(new_n73_), .b(new_n35_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n179_), .c(new_n80_), .O(new_n181_));
  ...
  nand2  g151(.a(new_n110_), .b(new_n109_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n108_), .c(new_n104_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n111_), .O(z7));
endmodule
