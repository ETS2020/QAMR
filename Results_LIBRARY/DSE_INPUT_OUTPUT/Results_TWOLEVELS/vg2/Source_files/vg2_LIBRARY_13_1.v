...
module FAU ( 
  ...
  nor2   g050(.a(new_n35_), .b(new_n66_), .O(new_n84_));
  ...
  nor4   g054(.a(new_n87_), .b(new_n70_), .c(new_n55_), .d(new_n54_), .O(new_n88_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n67_), .d(new_n35_), .O(new_n100_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n71_), .c(new_n54_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  nand2  g094(.a(x08), .b(new_n34_), .O(new_n128_));
  oai21  g095(.a(new_n127_), .b(new_n65_), .c(new_n128_), .O(z2));
  nand2  g096(.a(new_n58_), .b(new_n57_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x20), .c(x14), .d(x11), .O(new_n131_));
  nor4   g098(.a(new_n131_), .b(new_n36_), .c(new_n35_), .d(new_n65_), .O(new_n132_));
  nand2  g099(.a(new_n74_), .b(new_n73_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n71_), .c(new_n54_), .d(new_n68_), .O(new_n134_));
  ...
  oai21  g104(.a(new_n137_), .b(new_n132_), .c(new_n39_), .O(new_n138_));
  nor2   g105(.a(new_n36_), .b(new_n35_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(x01), .O(new_n140_));
  nand4  g107(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n142_));
  nand4  g109(.a(new_n71_), .b(new_n54_), .c(new_n68_), .d(new_n36_), .O(new_n143_));
  ...
  nand4  g112(.a(new_n36_), .b(new_n35_), .c(new_n37_), .d(new_n65_), .O(new_n146_));
  nand4  g113(.a(new_n104_), .b(new_n54_), .c(new_n46_), .d(new_n68_), .O(new_n147_));
  ...
  nor3   g117(.a(new_n150_), .b(x13), .c(new_n68_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n139_), .c(new_n37_), .d(x01), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n149_), .c(new_n145_), .d(new_n138_), .O(z3));
  oai21  g120(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n72_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n36_), .O(new_n156_));
  oai21  g123(.a(new_n49_), .b(new_n41_), .c(new_n156_), .O(new_n157_));
  oai21  g124(.a(new_n56_), .b(x04), .c(x17), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n67_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n55_), .c(x08), .O(new_n160_));
  oai21  g127(.a(new_n124_), .b(new_n119_), .c(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n157_), .c(new_n128_), .O(z4));
  inv1   g129(.a(new_n41_), .O(new_n163_));
  nand4  g130(.a(new_n128_), .b(new_n48_), .c(new_n42_), .d(new_n163_), .O(z5));
  ...
  nor2   g136(.a(x08), .b(x03), .O(new_n170_));
  aoi21  g137(.a(new_n169_), .b(x03), .c(new_n170_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n125_), .c(new_n167_), .d(new_n50_), .O(z6));
  inv1   g139(.a(new_n119_), .O(new_n173_));
  nand4  g140(.a(new_n128_), .b(new_n123_), .c(new_n120_), .d(new_n173_), .O(z7));
endmodule
