...
module FAU ( 
  ...
  nand4  g032(.a(new_n65_), .b(new_n53_), .c(new_n36_), .d(new_n57_), .O(new_n66_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n105_), .c(new_n98_), .d(new_n55_), .O(z3));
  inv1   g078(.a(new_n49_), .O(new_n112_));
  inv1   g079(.a(x22), .O(new_n113_));
  oai21  g080(.a(x23), .b(new_n52_), .c(new_n59_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n113_), .c(x09), .O(new_n115_));
  oai21  g082(.a(new_n115_), .b(x16), .c(new_n84_), .O(new_n116_));
  ...
  nand3  g089(.a(new_n122_), .b(new_n117_), .c(new_n55_), .O(z4));
  inv1   g090(.a(new_n41_), .O(new_n124_));
  and2   g091(.a(new_n45_), .b(new_n42_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n55_), .c(new_n47_), .d(new_n124_), .O(z5));
  nand2  g093(.a(x20), .b(new_n71_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n35_), .c(x11), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(x03), .c(new_n112_), .O(new_n129_));
  nand2  g096(.a(new_n60_), .b(x14), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x06), .c(new_n36_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n34_), .c(new_n118_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n129_), .c(new_n55_), .O(z6));
  inv1   g100(.a(new_n74_), .O(new_n134_));
  nand4  g101(.a(new_n78_), .b(new_n75_), .c(new_n134_), .d(new_n55_), .O(z7));
endmodule
