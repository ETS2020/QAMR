...
module FAU ( 
  ...
  aoi21  g123(.a(x20), .b(new_n104_), .c(x06), .O(new_n157_));
  ...
  inv1   g130(.a(new_n107_), .O(new_n164_));
  and2   g131(.a(new_n110_), .b(new_n109_), .O(new_n165_));
  nand4  g132(.a(new_n115_), .b(new_n165_), .c(new_n108_), .d(new_n164_), .O(z7));
endmodule
