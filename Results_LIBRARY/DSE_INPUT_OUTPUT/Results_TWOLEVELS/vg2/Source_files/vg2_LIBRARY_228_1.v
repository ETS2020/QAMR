...
module FAU ( 
  ...
  oai21  g021(.a(new_n54_), .b(new_n50_), .c(new_n41_), .O(new_n55_));
  ...
  nor2   g031(.a(new_n41_), .b(new_n64_), .O(new_n65_));
  ...
  nand4  g039(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n38_), .O(new_n73_));
  inv1   g040(.a(x12), .O(new_n74_));
  inv1   g041(.a(x16), .O(new_n75_));
  nand4  g042(.a(new_n64_), .b(new_n75_), .c(new_n40_), .d(new_n74_), .O(new_n76_));
  inv1   g043(.a(new_n76_), .O(new_n77_));
  nor2   g044(.a(x23), .b(x22), .O(new_n78_));
  nand4  g045(.a(new_n78_), .b(new_n77_), .c(new_n41_), .d(x19), .O(new_n79_));
  ...
  nand3  g086(.a(x15), .b(new_n52_), .c(new_n35_), .O(new_n120_));
  ...
  oai21  g091(.a(new_n124_), .b(new_n36_), .c(new_n114_), .O(z2));
  nand4  g092(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n70_), .O(new_n126_));
  nand4  g093(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n127_));
  nand3  g094(.a(new_n100_), .b(x14), .c(x11), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n39_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n42_), .c(new_n98_), .d(new_n34_), .O(new_n130_));
  nand2  g097(.a(x15), .b(new_n52_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n119_), .O(new_n132_));
  ...
  nand2  g102(.a(x19), .b(new_n52_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n51_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n41_), .c(new_n40_), .d(new_n47_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n135_), .c(new_n130_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n35_), .O(new_n142_));
  nand4  g109(.a(new_n117_), .b(x20), .c(x14), .d(x11), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(new_n70_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(x06), .c(x03), .d(x01), .O(new_n145_));
  nand2  g112(.a(new_n49_), .b(new_n48_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n41_), .c(new_n40_), .d(new_n47_), .O(new_n147_));
  nor2   g114(.a(new_n147_), .b(x08), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(x05), .c(x02), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n142_), .O(z3));
  inv1   g119(.a(x04), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n153_), .c(new_n64_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n66_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n70_), .O(new_n156_));
  inv1   g123(.a(new_n50_), .O(new_n157_));
  nand4  g124(.a(new_n42_), .b(new_n98_), .c(new_n34_), .d(x00), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n53_), .c(new_n51_), .d(new_n157_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  inv1   g127(.a(x09), .O(new_n161_));
  oai21  g128(.a(new_n67_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n161_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n75_), .c(x08), .O(new_n164_));
  nand3  g131(.a(new_n111_), .b(new_n98_), .c(new_n34_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand2  g134(.a(x05), .b(new_n34_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n167_), .c(new_n160_), .O(z4));
  nand3  g136(.a(new_n158_), .b(new_n136_), .c(new_n51_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n35_), .O(new_n171_));
  oai21  g138(.a(new_n157_), .b(new_n34_), .c(new_n171_), .O(z5));
  aoi21  g139(.a(x20), .b(new_n40_), .c(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n37_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(z5), .O(new_n175_));
  aoi21  g142(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n47_), .c(x03), .O(new_n177_));
  nand3  g144(.a(new_n165_), .b(new_n131_), .c(new_n119_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n35_), .O(new_n179_));
  oai21  g146(.a(new_n118_), .b(new_n34_), .c(new_n179_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n175_), .O(z6));
  inv1   g149(.a(new_n121_), .O(new_n183_));
  aoi21  g150(.a(new_n111_), .b(new_n98_), .c(x05), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(x02), .c(new_n183_), .O(z7));
endmodule
