...
module FAU ( 
  ...
  nand2  g021(.a(new_n54_), .b(x12), .O(new_n55_));
  ...
  nor4   g058(.a(new_n91_), .b(new_n69_), .c(new_n34_), .d(new_n68_), .O(new_n92_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n97_), .c(new_n70_), .d(new_n35_), .O(new_n111_));
  nand4  g078(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n57_), .O(new_n112_));
  ...
  nand3  g083(.a(new_n116_), .b(new_n105_), .c(new_n55_), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n88_), .O(z1));
  and2   g086(.a(x24), .b(x18), .O(new_n120_));
  ...
  nand3  g091(.a(x15), .b(new_n48_), .c(new_n47_), .O(new_n125_));
  ...
  nor2   g095(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x11), .c(x06), .d(x03), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n68_), .c(new_n55_), .O(z2));
  ...
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n134_), .c(x24), .O(new_n141_));
  nand3  g108(.a(new_n90_), .b(x24), .c(x18), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n125_), .O(new_n143_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n141_), .c(new_n55_), .O(new_n148_));
  nand3  g115(.a(x24), .b(new_n57_), .c(x07), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n40_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x05), .O(new_n151_));
  oai21  g118(.a(new_n48_), .b(x12), .c(new_n54_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(x24), .c(x07), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n49_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(x08), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n148_), .O(z3));
  oai21  g125(.a(x23), .b(new_n69_), .c(new_n74_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n75_), .c(x09), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x16), .c(new_n70_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n50_), .O(new_n162_));
  oai21  g129(.a(new_n76_), .b(x04), .c(x17), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x22), .c(new_n71_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n73_), .c(x08), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n127_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n162_), .c(new_n55_), .O(z4));
  and2   g134(.a(new_n46_), .b(new_n43_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n55_), .c(new_n49_), .d(new_n42_), .O(z5));
  ...
  nand2  g140(.a(x20), .b(new_n72_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n35_), .c(x11), .O(new_n175_));
  nor2   g142(.a(new_n175_), .b(x03), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n135_), .c(new_n173_), .d(new_n170_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n39_), .c(new_n45_), .d(new_n44_), .O(new_n178_));
  oai21  g145(.a(new_n142_), .b(x03), .c(new_n178_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n55_), .O(new_n180_));
  nand3  g147(.a(new_n39_), .b(x13), .c(x05), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n90_), .O(new_n182_));
  inv1   g149(.a(x15), .O(new_n183_));
  inv1   g150(.a(new_n173_), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(new_n57_), .c(x19), .O(new_n185_));
  oai22  g152(.a(new_n185_), .b(new_n183_), .c(new_n176_), .d(new_n54_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand3  g154(.a(new_n172_), .b(x18), .c(x11), .O(new_n188_));
  oai21  g155(.a(new_n176_), .b(new_n38_), .c(new_n188_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n90_), .c(new_n57_), .O(new_n190_));
  aoi21  g157(.a(new_n188_), .b(new_n38_), .c(new_n34_), .O(new_n191_));
  nand2  g158(.a(new_n175_), .b(x07), .O(new_n192_));
  inv1   g159(.a(new_n192_), .O(new_n193_));
  oai21  g160(.a(new_n193_), .b(new_n191_), .c(x19), .O(new_n194_));
  nand2  g161(.a(new_n194_), .b(new_n190_), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(x24), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n187_), .c(new_n180_), .O(z6));
  and2   g164(.a(new_n126_), .b(new_n55_), .O(new_n198_));
  nand4  g165(.a(new_n198_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(z7));
endmodule
