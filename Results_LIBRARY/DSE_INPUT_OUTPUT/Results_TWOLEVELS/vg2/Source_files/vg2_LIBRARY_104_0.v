...
module FAU ( 
  ...
  nand2  g105(.a(new_n108_), .b(new_n61_), .O(new_n139_));
  inv1   g106(.a(new_n139_), .O(new_n140_));
  nor2   g107(.a(x24), .b(x10), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n108_), .c(x01), .d(x00), .O(new_n142_));
  ...
  nand2  g117(.a(new_n107_), .b(new_n106_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n105_), .c(new_n139_), .O(new_n152_));
  nand3  g119(.a(new_n128_), .b(new_n91_), .c(new_n94_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(z7));
  nand2  g121(.a(z7), .b(new_n150_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n144_), .O(z4));
  aoi21  g123(.a(new_n141_), .b(x00), .c(new_n61_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x02), .c(new_n138_), .O(z5));
