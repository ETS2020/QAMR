...
module FAU ( 
  ...
  nand3  g083(.a(new_n116_), .b(new_n40_), .c(x21), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n113_), .c(x20), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n84_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x11), .c(x06), .d(x03), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n59_), .c(new_n57_), .O(z2));
  nand2  g089(.a(new_n101_), .b(new_n99_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x20), .c(x14), .d(x11), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(new_n80_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  nand2  g093(.a(new_n116_), .b(x00), .O(new_n127_));
  ...
  nand3  g099(.a(new_n132_), .b(new_n126_), .c(x12), .O(new_n133_));
  ...
  nand3  g103(.a(new_n81_), .b(new_n34_), .c(new_n59_), .O(new_n137_));
  nand4  g104(.a(new_n37_), .b(new_n84_), .c(new_n36_), .d(new_n80_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n69_), .b(new_n34_), .c(new_n59_), .O(new_n142_));
  nand3  g109(.a(new_n74_), .b(new_n84_), .c(new_n36_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n135_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n50_), .c(new_n38_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n140_), .c(new_n134_), .O(z3));
  inv1   g113(.a(x22), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n60_), .c(new_n83_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n147_), .c(x09), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n80_), .O(new_n150_));
  nand4  g117(.a(new_n40_), .b(x19), .c(x13), .d(x12), .O(new_n151_));
  inv1   g118(.a(new_n151_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n41_), .c(x05), .O(new_n153_));
  nand4  g120(.a(new_n57_), .b(x19), .c(new_n50_), .d(new_n38_), .O(new_n154_));
  nand4  g121(.a(new_n48_), .b(new_n40_), .c(x12), .d(new_n46_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n45_), .O(z5));
  nand2  g123(.a(z5), .b(new_n150_), .O(new_n157_));
  oai21  g124(.a(new_n98_), .b(x04), .c(x17), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n67_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n85_), .c(x08), .O(new_n160_));
  nand4  g127(.a(new_n40_), .b(x15), .c(x13), .d(x12), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n111_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x05), .O(new_n163_));
  nand4  g130(.a(new_n57_), .b(x15), .c(new_n50_), .d(new_n38_), .O(new_n164_));
  nand4  g131(.a(new_n116_), .b(new_n40_), .c(x21), .d(x12), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n114_), .O(z7));
  nand2  g133(.a(z7), .b(new_n160_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n157_), .O(z4));
  aoi21  g135(.a(x20), .b(new_n84_), .c(x06), .O(new_n169_));
