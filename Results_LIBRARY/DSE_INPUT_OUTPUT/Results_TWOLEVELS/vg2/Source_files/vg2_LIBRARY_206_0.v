...
module FAU ( 
  ...
  nor4   g087(.a(new_n120_), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(z2));
  ...
  nand2  g127(.a(new_n160_), .b(new_n156_), .O(z4));
  nor2   g128(.a(new_n48_), .b(new_n44_), .O(new_n162_));
  nand3  g129(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n163_));
  ...
  nand4  g135(.a(new_n42_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n47_), .c(new_n45_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n44_), .c(new_n168_), .d(x03), .O(new_n171_));
  nand2  g138(.a(new_n92_), .b(x14), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n35_), .O(new_n173_));
  nand3  g140(.a(new_n117_), .b(new_n42_), .c(x21), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n114_), .c(new_n113_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n112_), .c(new_n173_), .d(new_n68_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n171_), .c(new_n39_), .O(z6));
endmodule
