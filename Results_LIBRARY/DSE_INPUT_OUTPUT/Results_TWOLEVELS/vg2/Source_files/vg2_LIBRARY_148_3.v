...
module FAU ( 
  ...
  nand4  g121(.a(new_n154_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n149_), .c(new_n53_), .O(z4));
  and2   g124(.a(new_n53_), .b(new_n43_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n48_), .c(new_n46_), .d(new_n142_), .O(z5));
  nand2  g126(.a(x20), .b(new_n74_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x03), .c(new_n144_), .O(new_n162_));
  nand2  g129(.a(new_n37_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n34_), .c(new_n155_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n53_), .O(z6));
  nand3  g133(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n53_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n154_), .O(z7));
endmodule
