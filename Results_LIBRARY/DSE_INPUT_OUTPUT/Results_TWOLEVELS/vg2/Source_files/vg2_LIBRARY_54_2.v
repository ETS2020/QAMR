...
module FAU ( 
  ...
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n66_), .d(new_n37_), .O(new_n101_));
  ...
  nand2  g072(.a(new_n69_), .b(x08), .O(new_n106_));
  ...
  nor3   g084(.a(new_n117_), .b(new_n69_), .c(new_n55_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x11), .c(x06), .d(x03), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n35_), .c(new_n106_), .O(z2));
  nand2  g087(.a(new_n58_), .b(new_n57_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x14), .c(x11), .d(x08), .O(new_n122_));
  nor4   g089(.a(new_n122_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n123_));
  nand2  g090(.a(new_n72_), .b(new_n71_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n69_), .c(new_n55_), .d(new_n67_), .O(new_n125_));
  ...
  nand3  g096(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n130_));
  nand4  g097(.a(new_n69_), .b(new_n55_), .c(new_n67_), .d(x07), .O(new_n131_));
  ...
  nand3  g100(.a(new_n96_), .b(x11), .c(x08), .O(new_n134_));
  nand4  g101(.a(new_n69_), .b(x19), .c(new_n55_), .d(new_n67_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n130_), .c(new_n134_), .d(new_n128_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n47_), .c(new_n38_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n133_), .c(new_n127_), .d(new_n106_), .O(z3));
  inv1   g105(.a(new_n50_), .O(new_n139_));
  aoi21  g106(.a(new_n56_), .b(x04), .c(x17), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n66_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n84_), .c(new_n34_), .O(new_n142_));
  oai21  g109(.a(new_n69_), .b(new_n34_), .c(new_n142_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  inv1   g111(.a(new_n117_), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n70_), .c(x09), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(x20), .c(x16), .O(new_n148_));
  ...
  aoi21  g118(.a(new_n69_), .b(x08), .c(new_n50_), .O(z5));
  nand2  g119(.a(x20), .b(new_n55_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n37_), .c(x11), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n139_), .O(new_n155_));
  nand2  g122(.a(new_n69_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n67_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n36_), .c(new_n145_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n106_), .O(z6));
  inv1   g126(.a(new_n112_), .O(new_n160_));
  and2   g127(.a(new_n114_), .b(new_n113_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n115_), .c(new_n160_), .d(new_n106_), .O(z7));
endmodule
