...
module FAU ( 
  ...
  nor2   g121(.a(new_n154_), .b(new_n108_), .O(new_n155_));
  nand2  g122(.a(new_n131_), .b(new_n98_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n153_), .c(new_n155_), .d(new_n142_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n146_), .O(z4));
  aoi21  g126(.a(new_n143_), .b(x00), .c(new_n65_), .O(new_n160_));
  ...
  nand2  g135(.a(new_n156_), .b(x01), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n111_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n155_), .O(z7));
endmodule
