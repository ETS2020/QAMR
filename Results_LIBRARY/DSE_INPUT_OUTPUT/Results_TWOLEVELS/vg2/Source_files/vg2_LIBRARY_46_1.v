...
module FAU ( 
  ...
  nand4  g075(.a(new_n49_), .b(x06), .c(x03), .d(x01), .O(new_n109_));
  nor2   g076(.a(new_n36_), .b(new_n35_), .O(new_n110_));
  inv1   g077(.a(x21), .O(new_n111_));
  nor2   g078(.a(x24), .b(new_n111_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n110_), .c(x20), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n109_), .c(new_n55_), .O(new_n114_));
  ...
  aoi21  g084(.a(new_n117_), .b(new_n116_), .c(new_n39_), .O(new_n118_));
  nand3  g085(.a(x24), .b(x18), .c(x13), .O(new_n119_));
  nand3  g086(.a(x15), .b(new_n45_), .c(new_n39_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nor3   g089(.a(new_n122_), .b(new_n101_), .c(new_n36_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x11), .c(x06), .d(x03), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n69_), .c(new_n115_), .O(z2));
  inv1   g092(.a(x08), .O(new_n126_));
  nand3  g093(.a(x15), .b(x13), .c(x05), .O(new_n127_));
  nand3  g094(.a(x21), .b(new_n49_), .c(new_n37_), .O(new_n128_));
  ...
  nand3  g099(.a(new_n49_), .b(new_n37_), .c(x00), .O(new_n133_));
  nand3  g100(.a(x19), .b(x13), .c(x05), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n101_), .c(new_n36_), .d(new_n35_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(x08), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n34_), .c(new_n70_), .d(new_n69_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n132_), .c(x24), .O(new_n139_));
  nand4  g106(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n140_));
  nand2  g107(.a(new_n110_), .b(new_n96_), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n34_), .c(new_n70_), .d(new_n69_), .O(new_n142_));
  nand4  g109(.a(new_n101_), .b(new_n36_), .c(new_n35_), .d(new_n126_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n90_), .c(x24), .O(new_n145_));
  nand3  g112(.a(new_n110_), .b(x20), .c(x15), .O(new_n146_));
  nand3  g113(.a(new_n59_), .b(new_n70_), .c(new_n69_), .O(new_n147_));
  nand2  g114(.a(new_n86_), .b(new_n62_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n140_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n45_), .c(new_n39_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n139_), .c(new_n55_), .O(new_n152_));
  nand2  g119(.a(new_n149_), .b(new_n92_), .O(new_n153_));
  ...
  oai21  g123(.a(x23), .b(new_n71_), .c(new_n100_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n75_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n126_), .O(new_n159_));
  inv1   g126(.a(new_n43_), .O(new_n160_));
  nand4  g127(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n46_), .c(new_n44_), .d(new_n160_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  oai21  g130(.a(new_n76_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n81_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n102_), .c(x08), .O(new_n166_));
  inv1   g133(.a(new_n118_), .O(new_n167_));
  nand3  g134(.a(new_n112_), .b(new_n49_), .c(new_n37_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n120_), .c(new_n119_), .d(new_n167_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n163_), .c(new_n38_), .O(z4));
  nand3  g138(.a(new_n41_), .b(new_n49_), .c(x00), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n55_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n37_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n46_), .c(new_n44_), .d(new_n160_), .O(z5));
  nand2  g142(.a(x20), .b(new_n36_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n34_), .c(x11), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x03), .c(new_n162_), .O(new_n178_));
  nand2  g145(.a(new_n101_), .b(x14), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x06), .c(new_n35_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n70_), .c(new_n169_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n178_), .c(new_n38_), .O(z6));
  aoi21  g149(.a(new_n112_), .b(new_n49_), .c(x12), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(x02), .c(new_n122_), .O(z7));
endmodule
