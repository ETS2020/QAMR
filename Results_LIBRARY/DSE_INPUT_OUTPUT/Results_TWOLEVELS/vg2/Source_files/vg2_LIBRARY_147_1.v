...
module FAU ( 
  ...
  nand2  g108(.a(x02), .b(new_n67_), .O(new_n142_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n107_), .c(new_n142_), .O(new_n153_));
  ...
  nand2  g123(.a(x20), .b(new_n104_), .O(new_n157_));
  ...
  oai22  g129(.a(new_n162_), .b(new_n35_), .c(new_n111_), .d(new_n107_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n142_), .O(z6));
  nand4  g131(.a(new_n142_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n165_));
  or2    g132(.a(new_n165_), .b(new_n107_), .O(z7));
endmodule
