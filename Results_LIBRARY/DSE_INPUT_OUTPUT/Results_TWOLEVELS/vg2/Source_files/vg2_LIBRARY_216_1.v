// Benchmark "FAU" written by ABC on Wed Aug 19 21:58:13 2020
...
module FAU ( 
  ...
  nand3  g021(.a(x21), .b(new_n43_), .c(new_n42_), .O(new_n55_));
  ...
  nand3  g040(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n74_));
  ...
  nand4  g065(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n97_), .c(new_n95_), .O(new_n101_));
  aoi21  g068(.a(new_n101_), .b(new_n94_), .c(new_n86_), .O(new_n102_));
  nand4  g069(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n103_));
  nand3  g070(.a(new_n93_), .b(x20), .c(x17), .O(new_n104_));
  nor2   g071(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n88_), .O(new_n106_));
  ...
  nand4  g076(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(x19), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n108_), .c(new_n95_), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n106_), .c(x13), .O(new_n113_));
  aoi22  g080(.a(new_n113_), .b(new_n45_), .c(new_n102_), .d(x24), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n85_), .O(z1));
  nand3  g082(.a(new_n38_), .b(x15), .c(x13), .O(new_n116_));
  oai21  g083(.a(new_n38_), .b(new_n91_), .c(new_n116_), .O(new_n117_));
  ...
  nand4  g087(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  and2   g089(.a(new_n122_), .b(x14), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x06), .c(x03), .d(x01), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(x11), .c(new_n71_), .O(z2));
  nand4  g092(.a(new_n56_), .b(x20), .c(x14), .d(x08), .O(new_n126_));
  nor4   g093(.a(new_n126_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n127_));
  nand4  g094(.a(new_n76_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n128_));
  nor4   g095(.a(new_n128_), .b(x06), .c(x03), .d(x01), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n127_), .c(new_n38_), .O(new_n130_));
  inv1   g097(.a(new_n86_), .O(new_n131_));
  nand3  g098(.a(new_n35_), .b(new_n34_), .c(new_n64_), .O(new_n132_));
  nand4  g099(.a(new_n68_), .b(new_n36_), .c(new_n66_), .d(x07), .O(new_n133_));
  nand3  g100(.a(x06), .b(x03), .c(x01), .O(new_n134_));
  nand3  g101(.a(new_n92_), .b(x14), .c(x08), .O(new_n135_));
  ...
  nand4  g104(.a(x19), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n138_));
  nand4  g105(.a(x20), .b(x15), .c(x14), .d(x08), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n134_), .c(new_n138_), .d(new_n132_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n46_), .c(new_n45_), .O(new_n141_));
  nor2   g108(.a(new_n71_), .b(x11), .O(new_n142_));
  inv1   g109(.a(new_n142_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n141_), .c(new_n137_), .d(new_n130_), .O(z3));
  inv1   g111(.a(new_n49_), .O(new_n145_));
  oai21  g112(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n72_), .c(x09), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n66_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  oai21  g116(.a(new_n73_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n67_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n69_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n122_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n149_), .c(new_n142_), .O(z4));
  nor2   g121(.a(new_n142_), .b(new_n49_), .O(z5));
  inv1   g122(.a(x21), .O(new_n156_));
  nand2  g123(.a(x03), .b(x00), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(x03), .c(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n43_), .c(new_n42_), .O(new_n159_));
  inv1   g126(.a(x15), .O(new_n160_));
  nand2  g127(.a(x19), .b(x03), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(x03), .c(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x13), .c(x05), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n159_), .c(x24), .O(new_n164_));
  nand2  g131(.a(x07), .b(x03), .O(new_n165_));
  oai21  g132(.a(new_n91_), .b(x03), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n131_), .c(x24), .O(new_n167_));
  nand3  g134(.a(new_n162_), .b(new_n46_), .c(new_n45_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n164_), .c(new_n143_), .O(new_n170_));
  oai21  g137(.a(x20), .b(new_n68_), .c(x06), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(x18), .c(x11), .O(new_n172_));
  nand4  g139(.a(new_n71_), .b(new_n36_), .c(x07), .d(x06), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n131_), .c(x24), .O(new_n175_));
  nand3  g142(.a(new_n38_), .b(x13), .c(x05), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n131_), .O(new_n177_));
  nand3  g144(.a(new_n171_), .b(x15), .c(x11), .O(new_n178_));
  nand4  g145(.a(new_n71_), .b(x19), .c(new_n36_), .d(x06), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  nand3  g148(.a(new_n171_), .b(x21), .c(x11), .O(new_n182_));
  nand4  g149(.a(new_n71_), .b(new_n36_), .c(x06), .d(x00), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand4  g151(.a(new_n184_), .b(new_n38_), .c(new_n43_), .d(new_n42_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n181_), .c(new_n175_), .d(new_n170_), .O(z6));
  and2   g153(.a(new_n143_), .b(new_n122_), .O(z7));
endmodule
