...
module FAU ( 
  ...
  nand2  g117(.a(z5), .b(new_n147_), .O(new_n151_));
  ...
  aoi21  g124(.a(x20), .b(new_n90_), .c(x06), .O(new_n158_));
  ...
  inv1   g131(.a(new_n109_), .O(new_n165_));
  and2   g132(.a(new_n114_), .b(new_n111_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n110_), .c(new_n165_), .d(new_n54_), .O(z7));
endmodule
