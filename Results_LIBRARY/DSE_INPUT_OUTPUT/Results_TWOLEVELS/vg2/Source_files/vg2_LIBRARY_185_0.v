...
module FAU ( 
  ...
  nor2   g018(.a(x17), .b(x12), .O(new_n52_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n99_), .c(new_n92_), .d(new_n53_), .O(z3));
  ...
  oai21  g077(.a(new_n110_), .b(x16), .c(new_n56_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n106_), .O(new_n112_));
  inv1   g079(.a(new_n75_), .O(new_n113_));
  ...
  nand3  g087(.a(new_n120_), .b(new_n112_), .c(new_n53_), .O(z4));
  inv1   g088(.a(new_n41_), .O(new_n122_));
  and2   g089(.a(new_n45_), .b(new_n42_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n53_), .c(new_n47_), .d(new_n122_), .O(z5));
  nand2  g091(.a(x20), .b(new_n57_), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n35_), .c(x11), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x03), .c(new_n106_), .O(new_n127_));
  nand2  g094(.a(new_n74_), .b(x14), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x06), .c(new_n36_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n34_), .c(new_n113_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n127_), .c(new_n52_), .O(z6));
  inv1   g098(.a(new_n61_), .O(new_n132_));
  and2   g099(.a(new_n63_), .b(new_n62_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n64_), .c(new_n132_), .d(new_n53_), .O(z7));
endmodule
