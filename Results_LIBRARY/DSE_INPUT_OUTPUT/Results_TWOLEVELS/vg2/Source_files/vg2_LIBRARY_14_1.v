...
module FAU ( 
  ...
  oai21  g115(.a(new_n146_), .b(new_n145_), .c(new_n148_), .O(new_n149_));
  ...
  oai21  g122(.a(new_n146_), .b(new_n154_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n150_), .O(z4));
  nand3  g125(.a(new_n42_), .b(new_n101_), .c(x00), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n145_), .O(z5));
  aoi21  g129(.a(x20), .b(new_n40_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n37_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n149_), .O(new_n165_));
  aoi21  g132(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n47_), .c(x03), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n156_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n165_), .O(z6));
  aoi21  g136(.a(new_n111_), .b(new_n101_), .c(x12), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x02), .c(new_n154_), .O(z7));
endmodule
