...
module FAU ( 
  ...
  nor2   g078(.a(new_n111_), .b(new_n87_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(x11), .c(x03), .d(x01), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(x02), .c(new_n35_), .O(z2));
  nand4  g081(.a(new_n97_), .b(new_n34_), .c(new_n94_), .d(x00), .O(new_n115_));
  nor2   g082(.a(x11), .b(x10), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n40_), .c(new_n37_), .d(new_n87_), .O(new_n117_));
  ...
  nand3  g088(.a(new_n67_), .b(new_n34_), .c(new_n94_), .O(new_n122_));
  nand3  g089(.a(new_n72_), .b(new_n87_), .c(new_n36_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n78_), .O(new_n125_));
  nand3  g092(.a(new_n82_), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n127_));
  nand4  g094(.a(new_n37_), .b(new_n87_), .c(new_n36_), .d(new_n97_), .O(new_n128_));
  ...
  oai21  g099(.a(x23), .b(new_n132_), .c(new_n59_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n61_), .c(x09), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x16), .c(new_n97_), .O(new_n135_));
  nor2   g102(.a(new_n35_), .b(x02), .O(new_n136_));
  nand2  g103(.a(new_n48_), .b(new_n43_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n42_), .O(new_n138_));
  nand4  g105(.a(new_n45_), .b(new_n35_), .c(new_n44_), .d(x00), .O(new_n139_));
  oai21  g106(.a(new_n138_), .b(new_n136_), .c(new_n139_), .O(z5));
  ...
  oai21  g110(.a(new_n143_), .b(new_n88_), .c(x08), .O(new_n144_));
  nor2   g111(.a(new_n110_), .b(new_n107_), .O(new_n145_));
  nor2   g112(.a(x06), .b(x02), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n40_), .c(x21), .d(new_n98_), .O(new_n147_));
  oai21  g114(.a(new_n136_), .b(new_n145_), .c(new_n147_), .O(z7));
  nand2  g115(.a(z7), .b(new_n144_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n141_), .O(z4));
  nor2   g117(.a(new_n49_), .b(new_n42_), .O(new_n151_));
  nor2   g118(.a(new_n37_), .b(x14), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n36_), .c(x03), .O(new_n153_));
  nand4  g120(.a(new_n40_), .b(x21), .c(new_n98_), .d(new_n44_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n109_), .c(new_n108_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n107_), .c(x11), .d(new_n34_), .O(new_n156_));
  oai21  g123(.a(new_n153_), .b(new_n151_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n35_), .O(new_n158_));
  aoi21  g125(.a(new_n36_), .b(x06), .c(x03), .O(new_n159_));
  nor2   g126(.a(x20), .b(new_n87_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n145_), .c(new_n159_), .d(new_n138_), .O(new_n162_));
