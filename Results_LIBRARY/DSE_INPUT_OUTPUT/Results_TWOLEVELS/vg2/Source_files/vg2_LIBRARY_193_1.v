...
module FAU ( 
  ...
  nand2  g004(.a(x02), .b(new_n37_), .O(new_n38_));
  ...
  nand4  g067(.a(new_n71_), .b(new_n36_), .c(new_n55_), .d(new_n35_), .O(new_n101_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n98_), .c(new_n35_), .d(new_n70_), .O(new_n112_));
  ...
  nand3  g085(.a(new_n118_), .b(new_n45_), .c(new_n39_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n106_), .c(new_n38_), .O(new_n120_));
  inv1   g087(.a(new_n120_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n87_), .O(z1));
  nor2   g089(.a(new_n41_), .b(new_n94_), .O(new_n123_));
  inv1   g090(.a(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n41_), .b(x15), .c(x13), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n124_), .c(new_n39_), .O(new_n126_));
  nand2  g093(.a(new_n123_), .b(x13), .O(new_n127_));
  nand3  g094(.a(x15), .b(new_n45_), .c(new_n39_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n126_), .c(new_n38_), .O(new_n130_));
  nand4  g097(.a(new_n41_), .b(x21), .c(new_n50_), .d(new_n49_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n130_), .c(new_n73_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x14), .c(x11), .d(x06), .O(new_n133_));
  nor3   g100(.a(new_n133_), .b(new_n67_), .c(new_n66_), .O(z2));
  nand4  g101(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n135_));
  nor2   g102(.a(new_n36_), .b(new_n35_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(x20), .c(x15), .O(new_n137_));
  nand3  g104(.a(new_n111_), .b(new_n67_), .c(new_n66_), .O(new_n138_));
  nand3  g105(.a(new_n116_), .b(new_n36_), .c(new_n35_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n135_), .O(new_n140_));
  nand3  g107(.a(new_n41_), .b(x13), .c(x05), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n89_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g110(.a(new_n136_), .b(new_n95_), .O(new_n144_));
  nand4  g111(.a(x07), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n145_));
  nand4  g112(.a(new_n73_), .b(new_n36_), .c(new_n35_), .d(new_n69_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n135_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n89_), .c(x24), .O(new_n148_));
  nand4  g115(.a(new_n34_), .b(new_n67_), .c(new_n66_), .d(x00), .O(new_n149_));
  nand3  g116(.a(new_n136_), .b(x21), .c(x20), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n135_), .c(new_n149_), .d(new_n146_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n41_), .c(new_n50_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n148_), .c(new_n143_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n49_), .O(new_n154_));
  nand2  g121(.a(new_n148_), .b(new_n143_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x00), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n154_), .O(z3));
  oai21  g124(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n74_), .c(x09), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x16), .c(new_n69_), .O(new_n160_));
  inv1   g127(.a(new_n43_), .O(new_n161_));
  nand4  g128(.a(new_n51_), .b(new_n46_), .c(new_n44_), .d(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  oai21  g130(.a(new_n75_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n70_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n71_), .c(x08), .O(new_n166_));
  inv1   g133(.a(new_n126_), .O(new_n167_));
  nand4  g134(.a(new_n131_), .b(new_n128_), .c(new_n127_), .d(new_n167_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n163_), .c(new_n38_), .O(z4));
  nand2  g137(.a(new_n51_), .b(new_n48_), .O(z5));
  nand2  g138(.a(x20), .b(new_n36_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n34_), .c(x11), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x03), .c(new_n162_), .O(new_n174_));
  nand2  g141(.a(new_n73_), .b(x14), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(x06), .c(new_n35_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n67_), .c(new_n168_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n174_), .c(new_n38_), .O(z6));
  nand2  g145(.a(new_n131_), .b(new_n130_), .O(z7));
endmodule
