...
module FAU ( 
  ...
  nor2   g108(.a(new_n41_), .b(new_n40_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(x20), .c(x15), .O(new_n143_));
  nand3  g110(.a(new_n109_), .b(new_n37_), .c(new_n36_), .O(new_n144_));
  nand3  g111(.a(new_n114_), .b(new_n41_), .c(new_n40_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n141_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n121_), .O(new_n147_));
  inv1   g114(.a(new_n141_), .O(new_n148_));
  nand3  g115(.a(new_n142_), .b(new_n148_), .c(new_n93_), .O(new_n149_));
  ...
  or2    g120(.a(new_n151_), .b(new_n39_), .O(new_n154_));
  nand4  g121(.a(new_n142_), .b(new_n148_), .c(x21), .d(x20), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n154_), .c(x24), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x10), .c(new_n34_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n153_), .c(new_n147_), .O(z3));
  ...
  nor2   g128(.a(new_n35_), .b(x02), .O(new_n162_));
  nand4  g129(.a(new_n43_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n163_));
  oai21  g130(.a(new_n162_), .b(new_n55_), .c(new_n163_), .O(z5));
  nand2  g131(.a(z5), .b(new_n161_), .O(new_n165_));
  ...
  nand3  g135(.a(new_n127_), .b(new_n35_), .c(new_n34_), .O(new_n169_));
  oai21  g136(.a(new_n162_), .b(new_n137_), .c(new_n169_), .O(z7));
  nand2  g137(.a(z7), .b(new_n168_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n165_), .O(z4));
  inv1   g139(.a(new_n162_), .O(new_n173_));
  nand2  g140(.a(x20), .b(new_n41_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n38_), .c(x11), .O(new_n175_));
  nand3  g142(.a(new_n43_), .b(new_n34_), .c(x00), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n53_), .c(new_n51_), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n50_), .c(new_n175_), .d(x03), .O(new_n178_));
  nand2  g145(.a(new_n42_), .b(x14), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x06), .c(new_n40_), .O(new_n180_));
  nand2  g147(.a(new_n127_), .b(new_n34_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n135_), .c(new_n134_), .O(new_n182_));
  oai22  g149(.a(new_n182_), .b(new_n133_), .c(new_n180_), .d(new_n37_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n178_), .c(new_n173_), .O(z6));
endmodule
