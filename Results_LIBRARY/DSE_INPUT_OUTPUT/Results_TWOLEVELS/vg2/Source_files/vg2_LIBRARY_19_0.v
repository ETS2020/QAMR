...
module FAU ( 
  ...
  nand2  g105(.a(new_n109_), .b(new_n62_), .O(new_n139_));
  oai21  g106(.a(new_n46_), .b(new_n42_), .c(new_n139_), .O(new_n140_));
  nor2   g107(.a(x24), .b(x10), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n109_), .c(x01), .d(x00), .O(new_n142_));
  ...
  nand3  g118(.a(new_n117_), .b(new_n92_), .c(new_n95_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n151_), .O(z7));
  nand2  g120(.a(z7), .b(new_n149_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n144_), .O(z4));
  nand2  g122(.a(x20), .b(new_n103_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n35_), .c(x11), .O(new_n157_));
  nand3  g124(.a(new_n141_), .b(new_n109_), .c(x00), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n45_), .c(new_n43_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n42_), .c(new_n157_), .d(x03), .O(new_n160_));
  nand2  g127(.a(new_n37_), .b(x14), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x06), .c(new_n36_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n34_), .c(new_n111_), .d(new_n106_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n139_), .O(z6));
endmodule
