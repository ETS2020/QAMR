...
module FAU ( 
  ...
  nor2   g040(.a(new_n64_), .b(new_n60_), .O(new_n74_));
  nor3   g041(.a(new_n74_), .b(new_n73_), .c(new_n56_), .O(new_n75_));
  nand4  g042(.a(new_n75_), .b(x11), .c(x06), .d(x03), .O(new_n76_));
  nand2  g043(.a(new_n37_), .b(new_n73_), .O(new_n77_));
  oai21  g044(.a(new_n76_), .b(new_n54_), .c(new_n77_), .O(z2));
  ...
  nand4  g054(.a(new_n87_), .b(new_n73_), .c(new_n56_), .d(new_n36_), .O(new_n88_));
  ...
  nor2   g063(.a(new_n37_), .b(x20), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n56_), .c(new_n36_), .d(new_n55_), .O(new_n98_));
  ...
  nand4  g069(.a(new_n97_), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n103_));
  ...
  nand3  g072(.a(new_n105_), .b(new_n100_), .c(new_n92_), .O(z3));
  ...
  inv1   g080(.a(new_n74_), .O(new_n114_));
  ...
  nand3  g087(.a(new_n120_), .b(new_n113_), .c(new_n77_), .O(z4));
  inv1   g088(.a(new_n42_), .O(new_n122_));
  and2   g089(.a(new_n46_), .b(new_n43_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n77_), .c(new_n48_), .d(new_n122_), .O(z5));
  nand2  g091(.a(x20), .b(new_n56_), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n35_), .c(x11), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x03), .c(new_n107_), .O(new_n127_));
  nand2  g094(.a(new_n73_), .b(x14), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x06), .c(new_n36_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n34_), .c(new_n114_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n127_), .c(new_n77_), .O(z6));
  inv1   g098(.a(new_n60_), .O(new_n132_));
  and2   g099(.a(new_n62_), .b(new_n61_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n77_), .c(new_n63_), .d(new_n132_), .O(z7));
endmodule
