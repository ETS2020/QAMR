...
module FAU ( 
  ...
  nand4  g048(.a(new_n81_), .b(new_n74_), .c(new_n38_), .d(new_n73_), .O(new_n82_));
  ...
  nor4   g057(.a(new_n90_), .b(new_n70_), .c(new_n34_), .d(new_n69_), .O(new_n91_));
  ...
  nand4  g069(.a(new_n74_), .b(new_n38_), .c(new_n73_), .d(new_n58_), .O(new_n103_));
  inv1   g070(.a(x17), .O(new_n104_));
  nand4  g071(.a(new_n76_), .b(new_n75_), .c(new_n37_), .d(new_n104_), .O(new_n105_));
  nor2   g072(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n102_), .c(new_n100_), .O(new_n107_));
  aoi21  g074(.a(new_n107_), .b(new_n97_), .c(new_n89_), .O(new_n108_));
  ...
  nand4  g079(.a(new_n58_), .b(new_n36_), .c(new_n72_), .d(new_n71_), .O(new_n113_));
  inv1   g080(.a(new_n113_), .O(new_n114_));
  nand4  g081(.a(new_n104_), .b(new_n74_), .c(new_n38_), .d(new_n73_), .O(new_n115_));
  nand4  g082(.a(new_n76_), .b(new_n75_), .c(new_n37_), .d(x19), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n114_), .c(new_n100_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n112_), .c(x13), .O(new_n119_));
  aoi22  g086(.a(new_n119_), .b(new_n40_), .c(new_n108_), .d(x24), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n88_), .O(z1));
  inv1   g088(.a(new_n39_), .O(new_n122_));
  nor2   g089(.a(new_n42_), .b(new_n94_), .O(new_n123_));
  ...
  nor3   g098(.a(new_n131_), .b(new_n37_), .c(new_n73_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x11), .c(x06), .d(x03), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n69_), .c(new_n122_), .O(z2));
  nand4  g101(.a(new_n61_), .b(x20), .c(x14), .d(x11), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(new_n71_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand4  g104(.a(new_n79_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n42_), .O(new_n142_));
  inv1   g109(.a(new_n89_), .O(new_n143_));
  nand4  g110(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n144_));
  nand3  g111(.a(new_n95_), .b(x14), .c(x11), .O(new_n145_));
  nand3  g112(.a(new_n98_), .b(x07), .c(new_n35_), .O(new_n146_));
  ...
  nand3  g115(.a(new_n148_), .b(new_n143_), .c(x24), .O(new_n149_));
  nand4  g116(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n150_));
  nand3  g117(.a(new_n98_), .b(new_n71_), .c(new_n35_), .O(new_n151_));
  nand4  g118(.a(new_n37_), .b(x19), .c(new_n73_), .d(new_n36_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n144_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n49_), .c(new_n40_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n149_), .c(new_n142_), .d(new_n122_), .O(z3));
  inv1   g122(.a(new_n52_), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n70_), .c(new_n104_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n75_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n71_), .O(new_n159_));
  ...
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n72_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n74_), .c(x08), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n160_), .c(new_n122_), .O(z4));
  nand2  g133(.a(x20), .b(new_n73_), .O(new_n167_));
  ...
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n122_), .O(z6));
  nand4  g140(.a(new_n122_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n174_));
  nand4  g141(.a(x15), .b(x13), .c(x12), .d(x05), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n42_), .O(new_n177_));
  nand2  g144(.a(new_n124_), .b(new_n143_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(x15), .c(x12), .O(new_n179_));
  nand4  g146(.a(new_n143_), .b(x24), .c(x18), .d(new_n38_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n179_), .c(new_n177_), .O(z7));
endmodule
