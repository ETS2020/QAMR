...
module FAU ( 
  ...
  nand2  g097(.a(new_n40_), .b(x21), .O(new_n131_));
  nand2  g098(.a(new_n119_), .b(new_n111_), .O(new_n132_));
  nor3   g099(.a(new_n132_), .b(new_n131_), .c(new_n37_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n130_), .c(new_n55_), .d(x03), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n129_), .c(new_n124_), .O(z3));
  inv1   g102(.a(x22), .O(new_n136_));
  oai21  g103(.a(x23), .b(new_n52_), .c(new_n96_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n140_), .b(new_n51_), .c(x00), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n45_), .c(new_n43_), .O(new_n142_));
  or2    g109(.a(new_n142_), .b(new_n42_), .O(new_n143_));
  ...
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n144_), .O(z4));
  oai21  g121(.a(new_n46_), .b(new_n42_), .c(new_n153_), .O(new_n155_));
  nand4  g122(.a(new_n140_), .b(new_n51_), .c(x01), .d(x00), .O(new_n156_));
  ...
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n143_), .O(new_n160_));
  ...
  oai21  g131(.a(new_n131_), .b(x10), .c(x01), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n51_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n110_), .c(new_n109_), .d(new_n145_), .O(z7));
endmodule
