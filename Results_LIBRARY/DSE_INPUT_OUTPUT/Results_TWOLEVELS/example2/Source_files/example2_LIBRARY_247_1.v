...
module FAU ( 
  ...
  aoi21  g025(.a(new_n176_), .b(new_n175_), .c(z02), .O(z06));
  ...
  nand3  g061(.a(new_n212_), .b(new_n211_), .c(new_n158_), .O(z18));
  ...
  nand3  g077(.a(new_n228_), .b(x05), .c(new_n164_), .O(new_n229_));
  aoi21  g078(.a(new_n229_), .b(new_n156_), .c(x01), .O(z24));
  inv1   g079(.a(x77), .O(new_n237_));
  nand2  g080(.a(x52), .b(x15), .O(new_n238_));
  nand2  g081(.a(new_n153_), .b(x07), .O(new_n239_));
  aoi21  g082(.a(new_n239_), .b(new_n238_), .c(x79), .O(new_n240_));
  nand4  g083(.a(new_n240_), .b(x78), .c(new_n237_), .d(x04), .O(new_n241_));
  nor2   g084(.a(new_n241_), .b(x01), .O(z47));
  nand2  g085(.a(x52), .b(x16), .O(new_n243_));
  nand2  g086(.a(new_n153_), .b(x08), .O(new_n244_));
  aoi21  g087(.a(new_n244_), .b(new_n243_), .c(x79), .O(new_n245_));
  nand4  g088(.a(new_n245_), .b(x78), .c(new_n237_), .d(x04), .O(new_n246_));
  nor2   g089(.a(new_n246_), .b(x01), .O(z48));
  nand2  g090(.a(x52), .b(x17), .O(new_n248_));
  nand2  g091(.a(new_n153_), .b(x09), .O(new_n249_));
  aoi21  g092(.a(new_n249_), .b(new_n248_), .c(x79), .O(new_n250_));
  nand4  g093(.a(new_n250_), .b(x78), .c(new_n237_), .d(x04), .O(new_n251_));
  nor2   g094(.a(new_n251_), .b(x01), .O(z49));
  inv1   g095(.a(x10), .O(new_n253_));
  nand2  g096(.a(x52), .b(x18), .O(new_n254_));
  oai21  g097(.a(x52), .b(new_n253_), .c(new_n254_), .O(new_n255_));
  nand4  g098(.a(new_n255_), .b(x78), .c(new_n237_), .d(x04), .O(new_n256_));
  aoi21  g099(.a(new_n256_), .b(new_n156_), .c(x01), .O(z50));
  nand2  g100(.a(x52), .b(x19), .O(new_n258_));
  nand2  g101(.a(new_n153_), .b(x11), .O(new_n259_));
  aoi21  g102(.a(new_n259_), .b(new_n258_), .c(x79), .O(new_n260_));
  nand4  g103(.a(new_n260_), .b(x78), .c(new_n237_), .d(x04), .O(new_n261_));
  nor2   g104(.a(new_n261_), .b(x01), .O(z51));
  nand2  g105(.a(x52), .b(x20), .O(new_n263_));
  nand2  g106(.a(new_n153_), .b(x12), .O(new_n264_));
  aoi21  g107(.a(new_n264_), .b(new_n263_), .c(x79), .O(new_n265_));
  nand4  g108(.a(new_n265_), .b(x78), .c(new_n237_), .d(x04), .O(new_n266_));
  nor2   g109(.a(new_n266_), .b(x01), .O(z52));
  inv1   g110(.a(x13), .O(new_n268_));
  nand2  g111(.a(x52), .b(x21), .O(new_n269_));
  oai21  g112(.a(x52), .b(new_n268_), .c(new_n269_), .O(new_n270_));
  nand4  g113(.a(new_n270_), .b(x78), .c(new_n237_), .d(x04), .O(new_n271_));
  aoi21  g114(.a(new_n271_), .b(new_n156_), .c(x01), .O(z53));
  inv1   g115(.a(x14), .O(new_n273_));
  nand2  g116(.a(x52), .b(x22), .O(new_n274_));
  oai21  g117(.a(x52), .b(new_n273_), .c(new_n274_), .O(new_n275_));
  nand4  g118(.a(new_n275_), .b(x78), .c(new_n237_), .d(x04), .O(new_n276_));
  aoi21  g119(.a(new_n276_), .b(new_n156_), .c(x01), .O(z54));
  aoi21  g120(.a(new_n166_), .b(new_n237_), .c(new_n225_), .O(new_n279_));
  oai21  g121(.a(new_n279_), .b(x79), .c(new_n160_), .O(z56));
  inv1   g122(.a(x02), .O(new_n281_));
  nand3  g123(.a(x03), .b(new_n281_), .c(x00), .O(new_n282_));
  aoi21  g124(.a(new_n282_), .b(new_n156_), .c(x01), .O(z57));
  nand2  g125(.a(x78), .b(new_n237_), .O(new_n284_));
  inv1   g126(.a(x42), .O(new_n285_));
  nand4  g127(.a(new_n166_), .b(x77), .c(new_n285_), .d(x40), .O(new_n286_));
  nand3  g128(.a(new_n286_), .b(new_n284_), .c(x04), .O(new_n287_));
  nand3  g129(.a(new_n287_), .b(new_n156_), .c(new_n160_), .O(new_n288_));
  inv1   g130(.a(new_n288_), .O(z58));
  nand2  g131(.a(x78), .b(x04), .O(new_n290_));
  oai21  g132(.a(x78), .b(new_n152_), .c(new_n290_), .O(new_n291_));
  aoi21  g133(.a(new_n291_), .b(x77), .c(new_n164_), .O(new_n292_));
  aoi21  g134(.a(new_n292_), .b(new_n156_), .c(x01), .O(z59));
  nor2   g135(.a(new_n165_), .b(x01), .O(z60));
  nand4  g136(.a(x78), .b(new_n237_), .c(x04), .d(new_n160_), .O(new_n297_));
  nor2   g137(.a(new_n297_), .b(x79), .O(z64));
  zero   g138(.O(z26));
  zero   g139(.O(z27));
  zero   g140(.O(z31));
  zero   g141(.O(z35));
  ...
  nor2   g152(.a(new_n156_), .b(x01), .O(z33));
  nor2   g153(.a(new_n156_), .b(x01), .O(z34));
  nor2   g154(.a(new_n156_), .b(x01), .O(z36));
