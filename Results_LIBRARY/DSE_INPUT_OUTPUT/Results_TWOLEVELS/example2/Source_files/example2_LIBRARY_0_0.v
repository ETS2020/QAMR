...
module FAU ( 
  ...
  nand2  g027(.a(new_n172_), .b(x25), .O(new_n179_));
  ...
  nand2  g036(.a(new_n172_), .b(x28), .O(new_n188_));
  ...
  nand4  g110(.a(new_n253_), .b(x46), .c(new_n230_), .d(new_n239_), .O(new_n262_));
  aoi21  g111(.a(new_n262_), .b(x77), .c(x01), .O(z28));
  nand4  g112(.a(new_n259_), .b(x47), .c(new_n230_), .d(new_n239_), .O(new_n264_));
  ...
  nand4  g116(.a(new_n253_), .b(x49), .c(new_n230_), .d(new_n239_), .O(new_n268_));
  aoi21  g117(.a(new_n268_), .b(x77), .c(x01), .O(z31));
  nand4  g118(.a(new_n253_), .b(x50), .c(new_n230_), .d(new_n239_), .O(new_n270_));
  ...
  aoi21  g130(.a(new_n281_), .b(new_n276_), .c(new_n159_), .O(new_n282_));
  ...
  nand4  g147(.a(new_n294_), .b(x78), .c(x54), .d(new_n239_), .O(new_n299_));
  ...
  nor3   g180(.a(new_n327_), .b(new_n331_), .c(x01), .O(z51));
  inv1   g181(.a(x72), .O(new_n333_));
  nor3   g182(.a(new_n327_), .b(new_n333_), .c(x01), .O(z52));
  inv1   g183(.a(x73), .O(new_n335_));
  nor3   g184(.a(new_n327_), .b(new_n335_), .c(x01), .O(z53));
  nand2  g185(.a(x78), .b(new_n239_), .O(new_n337_));
  ...
  nor2   g190(.a(new_n341_), .b(new_n233_), .O(new_n342_));
  nand4  g191(.a(new_n342_), .b(new_n340_), .c(new_n339_), .d(new_n338_), .O(new_n343_));
  aoi21  g192(.a(new_n343_), .b(x77), .c(x01), .O(z55));
  inv1   g193(.a(x00), .O(new_n345_));
  xor2a  g194(.a(x84), .b(x81), .O(new_n346_));
  aoi21  g195(.a(new_n346_), .b(new_n158_), .c(x76), .O(new_n347_));
  nor2   g196(.a(new_n347_), .b(new_n159_), .O(new_n348_));
  aoi21  g197(.a(new_n348_), .b(new_n165_), .c(new_n345_), .O(new_n349_));
  oai21  g198(.a(new_n349_), .b(new_n229_), .c(new_n158_), .O(z56));
  inv1   g199(.a(x02), .O(new_n351_));
  nand4  g200(.a(x03), .b(new_n351_), .c(new_n158_), .d(x00), .O(new_n352_));
  nor2   g201(.a(new_n352_), .b(new_n229_), .O(z57));
  nand4  g202(.a(x80), .b(new_n231_), .c(x43), .d(new_n230_), .O(new_n354_));
  oai22  g203(.a(new_n354_), .b(new_n234_), .c(new_n230_), .d(x40), .O(new_n355_));
  nand4  g204(.a(new_n355_), .b(x79), .c(x78), .d(x04), .O(new_n356_));
  nand3  g205(.a(new_n165_), .b(new_n230_), .c(x40), .O(new_n357_));
  nand2  g206(.a(new_n357_), .b(x04), .O(new_n358_));
  nand2  g207(.a(new_n358_), .b(new_n159_), .O(new_n359_));
  nand2  g208(.a(new_n359_), .b(new_n356_), .O(new_n360_));
  nand3  g209(.a(new_n360_), .b(x77), .c(new_n158_), .O(new_n361_));
  inv1   g210(.a(new_n361_), .O(z58));
  oai21  g211(.a(new_n165_), .b(new_n239_), .c(x79), .O(new_n363_));
  nand2  g212(.a(new_n363_), .b(x40), .O(new_n364_));
  oai21  g213(.a(x78), .b(new_n239_), .c(new_n159_), .O(new_n365_));
  or2    g214(.a(new_n234_), .b(new_n232_), .O(new_n366_));
  nand4  g215(.a(new_n366_), .b(x78), .c(new_n230_), .d(x04), .O(new_n367_));
  nand4  g216(.a(new_n367_), .b(new_n365_), .c(new_n364_), .d(x77), .O(new_n368_));
  and2   g217(.a(new_n368_), .b(new_n158_), .O(z59));
  nand3  g218(.a(new_n346_), .b(x79), .c(new_n165_), .O(new_n370_));
  nand4  g219(.a(new_n370_), .b(new_n367_), .c(new_n365_), .d(x77), .O(new_n371_));
  and2   g220(.a(new_n371_), .b(new_n158_), .O(z60));
  nand2  g221(.a(new_n225_), .b(new_n165_), .O(new_n373_));
  nand2  g222(.a(new_n373_), .b(new_n337_), .O(new_n374_));
  nand4  g223(.a(new_n374_), .b(x80), .c(x79), .d(x77), .O(new_n375_));
  nor2   g224(.a(new_n375_), .b(x01), .O(z61));
  oai21  g225(.a(new_n341_), .b(x78), .c(new_n337_), .O(new_n377_));
  nand3  g226(.a(new_n377_), .b(x81), .c(x79), .O(new_n378_));
  nand2  g227(.a(new_n236_), .b(x04), .O(new_n379_));
  nand2  g228(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  nand3  g229(.a(new_n380_), .b(x77), .c(new_n158_), .O(new_n381_));
  inv1   g230(.a(new_n381_), .O(z62));
  nand4  g231(.a(new_n374_), .b(x82), .c(x79), .d(x77), .O(new_n383_));
  nor2   g232(.a(new_n383_), .b(x01), .O(z63));
  nand4  g233(.a(new_n374_), .b(x83), .c(x79), .d(x77), .O(new_n385_));
  nor2   g234(.a(new_n385_), .b(x01), .O(z64));
  nand3  g235(.a(x81), .b(new_n165_), .c(x77), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n337_), .O(new_n388_));
  nand3  g237(.a(new_n388_), .b(x84), .c(x79), .O(new_n389_));
  aoi21  g238(.a(new_n389_), .b(x77), .c(x01), .O(z65));
endmodule
