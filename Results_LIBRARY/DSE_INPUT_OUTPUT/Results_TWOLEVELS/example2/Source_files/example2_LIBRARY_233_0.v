...
module FAU ( 
  ...
  oai21  g005(.a(new_n156_), .b(new_n154_), .c(x47), .O(new_n157_));
  ...
  aoi21  g027(.a(new_n178_), .b(x47), .c(x79), .O(z03));
  nand2  g028(.a(new_n152_), .b(new_n155_), .O(new_n180_));
  inv1   g029(.a(new_n180_), .O(new_n181_));
  oai21  g030(.a(new_n181_), .b(new_n167_), .c(x47), .O(new_n182_));
  aoi21  g031(.a(new_n182_), .b(new_n152_), .c(x01), .O(z04));
  nor2   g032(.a(x79), .b(x47), .O(new_n184_));
  ...
  nand3  g060(.a(new_n211_), .b(new_n210_), .c(new_n185_), .O(z13));
  ...
  aoi21  g074(.a(x79), .b(new_n161_), .c(x47), .O(new_n226_));
  oai22  g075(.a(new_n226_), .b(new_n225_), .c(new_n164_), .d(new_n161_), .O(z18));
  ...
  aoi21  g097(.a(new_n248_), .b(new_n240_), .c(new_n152_), .O(new_n249_));
  nand2  g098(.a(new_n165_), .b(x04), .O(new_n250_));
  inv1   g099(.a(new_n250_), .O(new_n251_));
  oai21  g100(.a(new_n251_), .b(new_n249_), .c(x78), .O(new_n252_));
  nor2   g101(.a(new_n238_), .b(new_n152_), .O(new_n253_));
  nand3  g102(.a(new_n253_), .b(new_n155_), .c(x77), .O(new_n254_));
  ...
  nand2  g107(.a(new_n258_), .b(new_n185_), .O(z22));
  ...
  oai21  g112(.a(new_n261_), .b(new_n184_), .c(new_n263_), .O(z23));
  inv1   g113(.a(x43), .O(new_n265_));
  nand2  g114(.a(x79), .b(x78), .O(new_n266_));
  oai21  g115(.a(new_n266_), .b(new_n167_), .c(new_n166_), .O(new_n267_));
  ...
  nand4  g126(.a(new_n277_), .b(x05), .c(new_n262_), .d(new_n153_), .O(new_n278_));
  nand2  g127(.a(new_n278_), .b(new_n185_), .O(z25));
  inv1   g128(.a(new_n276_), .O(new_n280_));
  nand4  g129(.a(new_n280_), .b(x44), .c(new_n241_), .d(new_n262_), .O(new_n281_));
  nor2   g130(.a(new_n281_), .b(x01), .O(z26));
  inv1   g131(.a(x45), .O(new_n283_));
  nor2   g132(.a(new_n276_), .b(new_n283_), .O(new_n284_));
  nand4  g133(.a(new_n284_), .b(new_n241_), .c(new_n262_), .d(new_n153_), .O(new_n285_));
  nand2  g134(.a(new_n285_), .b(new_n185_), .O(z27));
  nand4  g135(.a(new_n280_), .b(x46), .c(new_n241_), .d(new_n262_), .O(new_n287_));
  nor2   g136(.a(new_n287_), .b(x01), .O(z28));
  nand4  g137(.a(new_n280_), .b(x47), .c(new_n241_), .d(new_n262_), .O(new_n289_));
  nor2   g138(.a(new_n289_), .b(x01), .O(z29));
  nand4  g139(.a(new_n280_), .b(x48), .c(new_n241_), .d(new_n262_), .O(new_n291_));
  nor2   g140(.a(new_n291_), .b(x01), .O(z30));
  inv1   g141(.a(x49), .O(new_n293_));
  nor2   g142(.a(new_n276_), .b(new_n293_), .O(new_n294_));
  nand4  g143(.a(new_n294_), .b(new_n241_), .c(new_n262_), .d(new_n153_), .O(new_n295_));
  nand2  g144(.a(new_n295_), .b(new_n185_), .O(z31));
  nand4  g145(.a(new_n280_), .b(x50), .c(new_n241_), .d(new_n262_), .O(new_n297_));
  nor2   g146(.a(new_n297_), .b(x01), .O(z32));
  nand2  g147(.a(x83), .b(new_n272_), .O(new_n299_));
  ...
  nand3  g157(.a(new_n272_), .b(x51), .c(new_n241_), .O(new_n309_));
  nand2  g158(.a(new_n309_), .b(new_n308_), .O(new_n310_));
  nand2  g159(.a(new_n310_), .b(new_n273_), .O(new_n311_));
  aoi21  g160(.a(new_n311_), .b(new_n306_), .c(new_n152_), .O(new_n312_));
  nand4  g161(.a(new_n312_), .b(x78), .c(x77), .d(new_n262_), .O(new_n313_));
  nor2   g162(.a(new_n313_), .b(x01), .O(z33));
  nor2   g163(.a(new_n300_), .b(new_n241_), .O(new_n315_));
  nand3  g164(.a(x83), .b(x81), .c(x42), .O(new_n316_));
  oai21  g165(.a(new_n315_), .b(x81), .c(new_n316_), .O(new_n317_));
  nand2  g166(.a(new_n317_), .b(new_n273_), .O(new_n318_));
  oai22  g167(.a(new_n315_), .b(new_n272_), .c(new_n299_), .d(new_n241_), .O(new_n319_));
  nand2  g168(.a(new_n319_), .b(new_n270_), .O(new_n320_));
  aoi21  g169(.a(new_n320_), .b(new_n318_), .c(new_n152_), .O(new_n321_));
  nand4  g170(.a(new_n321_), .b(x78), .c(x77), .d(x52), .O(new_n322_));
  nor3   g171(.a(new_n322_), .b(x04), .c(x01), .O(z34));
  nand3  g172(.a(new_n321_), .b(x78), .c(x77), .O(new_n324_));
  inv1   g173(.a(new_n324_), .O(new_n325_));
  nand4  g174(.a(new_n325_), .b(x53), .c(new_n262_), .d(new_n153_), .O(new_n326_));
  nand2  g175(.a(new_n326_), .b(new_n185_), .O(z35));
  nand4  g176(.a(new_n321_), .b(x78), .c(x77), .d(x54), .O(new_n328_));
  nor3   g177(.a(new_n328_), .b(x04), .c(x01), .O(z36));
  nand4  g178(.a(new_n325_), .b(x55), .c(new_n262_), .d(new_n153_), .O(new_n330_));
  nand2  g179(.a(new_n330_), .b(new_n185_), .O(z37));
  nand4  g180(.a(new_n321_), .b(x78), .c(x77), .d(x56), .O(new_n332_));
  nor3   g181(.a(new_n332_), .b(x04), .c(x01), .O(z38));
  nand4  g182(.a(new_n325_), .b(x57), .c(new_n262_), .d(new_n153_), .O(new_n334_));
  nand2  g183(.a(new_n334_), .b(new_n185_), .O(z39));
  nand4  g184(.a(new_n325_), .b(x58), .c(new_n262_), .d(new_n153_), .O(new_n336_));
  nand2  g185(.a(new_n336_), .b(new_n185_), .O(z40));
  nand4  g186(.a(new_n321_), .b(x78), .c(x77), .d(x59), .O(new_n338_));
  nor3   g187(.a(new_n338_), .b(x04), .c(x01), .O(z41));
  nand4  g188(.a(new_n325_), .b(x60), .c(new_n262_), .d(new_n153_), .O(new_n340_));
  nand2  g189(.a(new_n340_), .b(new_n185_), .O(z42));
  nand4  g190(.a(new_n325_), .b(x61), .c(new_n262_), .d(new_n153_), .O(new_n342_));
  nand2  g191(.a(new_n342_), .b(new_n185_), .O(z43));
  nand4  g192(.a(new_n321_), .b(x78), .c(x77), .d(x62), .O(new_n344_));
  nor3   g193(.a(new_n344_), .b(x04), .c(x01), .O(z44));
  nand4  g194(.a(new_n325_), .b(x63), .c(new_n262_), .d(new_n153_), .O(new_n346_));
  nand2  g195(.a(new_n346_), .b(new_n185_), .O(z45));
  ...
  nand4  g244(.a(new_n395_), .b(new_n152_), .c(x78), .d(new_n167_), .O(new_n396_));
  inv1   g245(.a(new_n396_), .O(new_n397_));
  nand3  g246(.a(new_n397_), .b(x47), .c(x04), .O(new_n398_));
  nand2  g247(.a(new_n255_), .b(x72), .O(new_n399_));
  ...
  oai21  g254(.a(new_n254_), .b(new_n401_), .c(new_n405_), .O(new_n406_));
  nand2  g255(.a(new_n406_), .b(new_n153_), .O(new_n407_));
  nand2  g256(.a(new_n407_), .b(new_n185_), .O(z53));
  inv1   g257(.a(x14), .O(new_n409_));
  nand2  g258(.a(x52), .b(x22), .O(new_n410_));
  oai21  g259(.a(x52), .b(new_n409_), .c(new_n410_), .O(new_n411_));
  nand4  g260(.a(new_n411_), .b(new_n152_), .c(x78), .d(new_n167_), .O(new_n412_));
  inv1   g261(.a(new_n412_), .O(new_n413_));
  nand4  g262(.a(new_n413_), .b(x47), .c(x04), .d(new_n153_), .O(new_n414_));
  ...
  nand4  g267(.a(new_n418_), .b(new_n272_), .c(new_n242_), .d(x79), .O(new_n419_));
  nor4   g268(.a(new_n419_), .b(new_n245_), .c(new_n300_), .d(x82), .O(z55));
  inv1   g269(.a(new_n169_), .O(new_n421_));
  inv1   g270(.a(new_n168_), .O(new_n422_));
  nand2  g271(.a(new_n422_), .b(x76), .O(new_n423_));
  xor2a  g272(.a(x84), .b(x81), .O(new_n424_));
  nand2  g273(.a(new_n174_), .b(new_n156_), .O(new_n425_));
  ...
  nand4  g277(.a(new_n428_), .b(new_n261_), .c(new_n185_), .d(new_n421_), .O(z56));
  inv1   g278(.a(x02), .O(new_n430_));
  nand2  g279(.a(x03), .b(new_n430_), .O(new_n431_));
  oai21  g280(.a(new_n431_), .b(new_n260_), .c(new_n185_), .O(z57));
  ...
  nand3  g285(.a(new_n181_), .b(new_n241_), .c(x40), .O(new_n437_));
  aoi21  g286(.a(new_n437_), .b(new_n436_), .c(new_n167_), .O(new_n438_));
  nand2  g287(.a(new_n174_), .b(x04), .O(new_n439_));
  nand3  g288(.a(new_n439_), .b(new_n152_), .c(x47), .O(new_n440_));
  inv1   g289(.a(new_n440_), .O(new_n441_));
  oai21  g290(.a(new_n441_), .b(new_n438_), .c(new_n153_), .O(new_n442_));
  nand2  g291(.a(new_n442_), .b(new_n185_), .O(z58));
  oai22  g292(.a(new_n266_), .b(new_n262_), .c(new_n180_), .d(new_n164_), .O(new_n444_));
  nand2  g293(.a(new_n444_), .b(x40), .O(new_n445_));
  nand3  g294(.a(new_n247_), .b(x79), .c(new_n241_), .O(new_n446_));
  ...
  nand2  g299(.a(new_n165_), .b(new_n262_), .O(new_n451_));
  aoi21  g300(.a(new_n451_), .b(new_n450_), .c(x01), .O(z59));
  nand4  g301(.a(new_n247_), .b(x78), .c(x77), .d(new_n241_), .O(new_n453_));
  oai21  g302(.a(new_n453_), .b(new_n262_), .c(new_n426_), .O(new_n454_));
  nand2  g303(.a(new_n454_), .b(x79), .O(new_n455_));
  nand2  g304(.a(new_n155_), .b(x04), .O(new_n456_));
  nand3  g305(.a(new_n456_), .b(new_n152_), .c(x47), .O(new_n457_));
  aoi21  g306(.a(new_n457_), .b(new_n455_), .c(x01), .O(z60));
  inv1   g307(.a(new_n425_), .O(new_n459_));
  oai22  g308(.a(new_n459_), .b(new_n238_), .c(new_n422_), .d(x04), .O(new_n460_));
  nand4  g309(.a(new_n460_), .b(x80), .c(x79), .d(new_n153_), .O(new_n461_));
  inv1   g310(.a(new_n461_), .O(z61));
  nand4  g311(.a(new_n247_), .b(x79), .c(x77), .d(new_n241_), .O(new_n463_));
  nand2  g312(.a(new_n463_), .b(new_n166_), .O(new_n464_));
  nand2  g313(.a(new_n464_), .b(x04), .O(new_n465_));
  nand2  g314(.a(x77), .b(new_n262_), .O(new_n466_));
  oai21  g315(.a(new_n245_), .b(x77), .c(new_n466_), .O(new_n467_));
  nand3  g316(.a(new_n467_), .b(x81), .c(x79), .O(new_n468_));
  aoi21  g317(.a(new_n468_), .b(new_n465_), .c(new_n155_), .O(new_n469_));
  nor4   g318(.a(new_n156_), .b(new_n245_), .c(new_n272_), .d(new_n152_), .O(new_n470_));
  oai21  g319(.a(new_n470_), .b(new_n469_), .c(new_n153_), .O(new_n471_));
  nand2  g320(.a(new_n471_), .b(new_n185_), .O(z62));
  nand4  g321(.a(new_n460_), .b(x82), .c(x79), .d(new_n153_), .O(new_n473_));
  nand2  g322(.a(new_n473_), .b(new_n185_), .O(z63));
  nand3  g323(.a(new_n460_), .b(x83), .c(x79), .O(new_n475_));
  nor2   g324(.a(new_n164_), .b(new_n262_), .O(new_n476_));
  nand4  g325(.a(new_n476_), .b(new_n152_), .c(x78), .d(new_n167_), .O(new_n477_));
  aoi21  g326(.a(new_n477_), .b(new_n475_), .c(x01), .O(z64));
  nor2   g327(.a(new_n155_), .b(x04), .O(new_n479_));
  nor2   g328(.a(new_n272_), .b(x78), .O(new_n480_));
