...
module FAU ( 
  ...
  aoi21  g047(.a(new_n198_), .b(new_n197_), .c(z54), .O(z13));
  ...
  nand2  g058(.a(new_n173_), .b(x35), .O(new_n210_));
  ...
  nand2  g064(.a(new_n173_), .b(x37), .O(new_n216_));
  nand3  g065(.a(new_n216_), .b(new_n215_), .c(new_n156_), .O(z19));
  nand2  g066(.a(new_n173_), .b(x38), .O(new_n218_));
  ...
  aoi21  g084(.a(new_n235_), .b(x79), .c(new_n165_), .O(new_n236_));
  aoi21  g085(.a(new_n236_), .b(x04), .c(new_n229_), .O(new_n237_));
  ...
  aoi21  g091(.a(x79), .b(new_n165_), .c(new_n229_), .O(new_n243_));
  nand4  g092(.a(new_n243_), .b(new_n242_), .c(x05), .d(new_n239_), .O(new_n244_));
  ...
  nand4  g102(.a(new_n253_), .b(new_n230_), .c(x05), .d(new_n239_), .O(new_n254_));
  aoi21  g103(.a(new_n254_), .b(x77), .c(x01), .O(z25));
  nand4  g104(.a(new_n253_), .b(x44), .c(new_n230_), .d(new_n239_), .O(new_n256_));
  aoi21  g105(.a(new_n256_), .b(x77), .c(x01), .O(z26));
  nand4  g106(.a(new_n251_), .b(x79), .c(x78), .d(x77), .O(new_n258_));
  inv1   g107(.a(new_n258_), .O(new_n259_));
  nand4  g108(.a(new_n259_), .b(x45), .c(new_n230_), .d(new_n239_), .O(new_n260_));
  nor2   g109(.a(new_n260_), .b(x01), .O(z27));
  nand4  g110(.a(new_n259_), .b(x46), .c(new_n230_), .d(new_n239_), .O(new_n262_));
  nor2   g111(.a(new_n262_), .b(x01), .O(z28));
  nand4  g112(.a(new_n253_), .b(x47), .c(new_n230_), .d(new_n239_), .O(new_n264_));
  aoi21  g113(.a(new_n264_), .b(x77), .c(x01), .O(z29));
  nand4  g114(.a(new_n259_), .b(x48), .c(new_n230_), .d(new_n239_), .O(new_n266_));
  nor2   g115(.a(new_n266_), .b(x01), .O(z30));
  nand4  g116(.a(new_n259_), .b(x49), .c(new_n230_), .d(new_n239_), .O(new_n268_));
  nor2   g117(.a(new_n268_), .b(x01), .O(z31));
  nand4  g118(.a(new_n259_), .b(x50), .c(new_n230_), .d(new_n239_), .O(new_n270_));
  nor2   g119(.a(new_n270_), .b(x01), .O(z32));
  xor2a  g120(.a(x83), .b(x81), .O(new_n272_));
  nand3  g121(.a(new_n272_), .b(x42), .c(x05), .O(new_n273_));
  nand3  g122(.a(x81), .b(x51), .c(new_n230_), .O(new_n274_));
  ...
  nand3  g127(.a(new_n248_), .b(x51), .c(new_n230_), .O(new_n279_));
  ...
  nand4  g131(.a(new_n282_), .b(x79), .c(x78), .d(new_n239_), .O(new_n283_));
  ...
  nand4  g145(.a(new_n294_), .b(x78), .c(x53), .d(new_n239_), .O(new_n297_));
  aoi21  g146(.a(new_n297_), .b(x77), .c(x01), .O(z35));
  nand4  g147(.a(new_n294_), .b(x78), .c(x77), .d(x54), .O(new_n299_));
  nor3   g148(.a(new_n299_), .b(x04), .c(x01), .O(z36));
  nand4  g149(.a(new_n294_), .b(x78), .c(x55), .d(new_n239_), .O(new_n301_));
  ...
  nand4  g153(.a(new_n294_), .b(x78), .c(x57), .d(new_n239_), .O(new_n305_));
  aoi21  g154(.a(new_n305_), .b(x77), .c(x01), .O(z39));
  nand4  g155(.a(new_n294_), .b(x78), .c(x58), .d(new_n239_), .O(new_n307_));
  aoi21  g156(.a(new_n307_), .b(x77), .c(x01), .O(z40));
  nand4  g157(.a(new_n294_), .b(x78), .c(x59), .d(new_n239_), .O(new_n309_));
  aoi21  g158(.a(new_n309_), .b(x77), .c(x01), .O(z41));
  nand4  g159(.a(new_n294_), .b(x78), .c(x60), .d(new_n239_), .O(new_n311_));
  ...
  nand4  g165(.a(new_n294_), .b(x78), .c(x63), .d(new_n239_), .O(new_n317_));
  ...
  nand4  g170(.a(new_n321_), .b(new_n225_), .c(x79), .d(new_n165_), .O(new_n322_));
  nor3   g171(.a(new_n322_), .b(new_n229_), .c(x01), .O(z47));
  nand2  g172(.a(new_n227_), .b(x68), .O(new_n324_));
  aoi21  g173(.a(new_n324_), .b(x77), .c(x01), .O(z48));
  inv1   g174(.a(x69), .O(new_n326_));
  nand2  g175(.a(new_n227_), .b(x77), .O(new_n327_));
  nor3   g176(.a(new_n327_), .b(new_n326_), .c(x01), .O(z49));
  nand2  g177(.a(new_n227_), .b(x70), .O(new_n329_));
  aoi21  g178(.a(new_n329_), .b(x77), .c(x01), .O(z50));
  nand2  g179(.a(new_n227_), .b(x71), .O(new_n331_));
  aoi21  g180(.a(new_n331_), .b(x77), .c(x01), .O(z51));
  nand2  g181(.a(new_n227_), .b(x72), .O(new_n333_));
  aoi21  g182(.a(new_n333_), .b(x77), .c(x01), .O(z52));
  inv1   g183(.a(x73), .O(new_n335_));
  nor3   g184(.a(new_n327_), .b(new_n335_), .c(x01), .O(z53));
  inv1   g185(.a(x84), .O(new_n337_));
  nor2   g186(.a(x04), .b(x01), .O(new_n338_));
  nand4  g187(.a(new_n338_), .b(x79), .c(x78), .d(x77), .O(new_n339_));
  nor2   g188(.a(new_n339_), .b(x80), .O(new_n340_));
  nand2  g189(.a(new_n340_), .b(new_n248_), .O(new_n341_));
  nor4   g190(.a(new_n341_), .b(new_n337_), .c(new_n233_), .d(x82), .O(z55));
  inv1   g191(.a(x00), .O(new_n343_));
  xor2a  g192(.a(x84), .b(x81), .O(new_n344_));
  aoi21  g193(.a(new_n344_), .b(new_n158_), .c(x76), .O(new_n345_));
  nor2   g194(.a(new_n345_), .b(new_n159_), .O(new_n346_));
  aoi21  g195(.a(new_n346_), .b(new_n165_), .c(new_n343_), .O(new_n347_));
  oai21  g196(.a(new_n347_), .b(new_n229_), .c(new_n158_), .O(z56));
  inv1   g197(.a(x02), .O(new_n349_));
  nand4  g198(.a(x03), .b(new_n349_), .c(new_n158_), .d(x00), .O(new_n350_));
  nor2   g199(.a(new_n350_), .b(new_n229_), .O(z57));
  nand4  g200(.a(x80), .b(new_n231_), .c(x43), .d(new_n230_), .O(new_n352_));
  oai22  g201(.a(new_n352_), .b(new_n234_), .c(new_n230_), .d(x40), .O(new_n353_));
  nand4  g202(.a(new_n353_), .b(x79), .c(x78), .d(x04), .O(new_n354_));
  nand3  g203(.a(new_n165_), .b(new_n230_), .c(x40), .O(new_n355_));
  nand2  g204(.a(new_n355_), .b(x04), .O(new_n356_));
  aoi21  g205(.a(new_n356_), .b(new_n159_), .c(new_n229_), .O(new_n357_));
  aoi21  g206(.a(new_n357_), .b(new_n354_), .c(x01), .O(z58));
  oai21  g207(.a(new_n165_), .b(new_n239_), .c(x79), .O(new_n359_));
  nand2  g208(.a(new_n359_), .b(x40), .O(new_n360_));
  oai21  g209(.a(new_n165_), .b(new_n229_), .c(x04), .O(new_n361_));
  nand2  g210(.a(new_n361_), .b(new_n159_), .O(new_n362_));
  inv1   g211(.a(new_n232_), .O(new_n363_));
  inv1   g212(.a(new_n234_), .O(new_n364_));
  aoi21  g213(.a(new_n364_), .b(new_n363_), .c(new_n165_), .O(new_n365_));
  nand4  g214(.a(new_n365_), .b(x77), .c(new_n230_), .d(x04), .O(new_n366_));
  nand4  g215(.a(new_n366_), .b(new_n362_), .c(new_n360_), .d(x77), .O(new_n367_));
  and2   g216(.a(new_n367_), .b(new_n158_), .O(z59));
  nand3  g217(.a(new_n344_), .b(x79), .c(new_n165_), .O(new_n369_));
  nand2  g218(.a(new_n235_), .b(x79), .O(new_n370_));
  nand3  g219(.a(new_n370_), .b(x78), .c(x04), .O(new_n371_));
  nand2  g220(.a(new_n159_), .b(new_n239_), .O(new_n372_));
  nand4  g221(.a(new_n372_), .b(new_n371_), .c(new_n369_), .d(x77), .O(new_n373_));
  and2   g222(.a(new_n373_), .b(new_n158_), .O(z60));
  nand2  g223(.a(new_n225_), .b(new_n165_), .O(new_n375_));
  nand2  g224(.a(x78), .b(new_n239_), .O(new_n376_));
  nand2  g225(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand4  g226(.a(new_n377_), .b(x80), .c(x79), .d(x77), .O(new_n378_));
  nor2   g227(.a(new_n378_), .b(x01), .O(z61));
  oai21  g228(.a(new_n337_), .b(x78), .c(new_n376_), .O(new_n380_));
  nand3  g229(.a(new_n380_), .b(x81), .c(x79), .O(new_n381_));
  nand2  g230(.a(new_n381_), .b(new_n371_), .O(new_n382_));
  nand3  g231(.a(new_n382_), .b(x77), .c(new_n158_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z62));
  nand3  g233(.a(new_n377_), .b(x82), .c(x79), .O(new_n385_));
  aoi21  g234(.a(new_n385_), .b(x77), .c(x01), .O(z63));
  nand3  g235(.a(new_n377_), .b(x83), .c(x79), .O(new_n387_));
  aoi21  g236(.a(new_n387_), .b(x77), .c(x01), .O(z64));
  nand3  g237(.a(x81), .b(new_n165_), .c(x77), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n376_), .O(new_n390_));
