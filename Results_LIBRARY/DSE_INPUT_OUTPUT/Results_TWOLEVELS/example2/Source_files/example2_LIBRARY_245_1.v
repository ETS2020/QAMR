...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n223_, new_n224_, new_n226_, new_n236_, new_n237_, new_n238_,
  ...
  inv1   g076(.a(x77), .O(new_n236_));
  inv1   g077(.a(x07), .O(new_n237_));
  nand2  g078(.a(x52), .b(x15), .O(new_n238_));
  oai21  g079(.a(x52), .b(new_n237_), .c(new_n238_), .O(new_n239_));
  nand4  g080(.a(new_n239_), .b(x78), .c(new_n236_), .d(x04), .O(new_n240_));
  aoi21  g081(.a(new_n240_), .b(new_n156_), .c(x01), .O(z47));
  nand2  g082(.a(x52), .b(x16), .O(new_n242_));
  nand2  g083(.a(new_n153_), .b(x08), .O(new_n243_));
  aoi21  g084(.a(new_n243_), .b(new_n242_), .c(x79), .O(new_n244_));
  nand4  g085(.a(new_n244_), .b(x78), .c(new_n236_), .d(x04), .O(new_n245_));
  nor2   g086(.a(new_n245_), .b(x01), .O(z48));
  inv1   g087(.a(x09), .O(new_n247_));
  nand2  g088(.a(x52), .b(x17), .O(new_n248_));
  oai21  g089(.a(x52), .b(new_n247_), .c(new_n248_), .O(new_n249_));
  nand4  g090(.a(new_n249_), .b(x78), .c(new_n236_), .d(x04), .O(new_n250_));
  aoi21  g091(.a(new_n250_), .b(new_n156_), .c(x01), .O(z49));
  inv1   g092(.a(x10), .O(new_n252_));
  nand2  g093(.a(x52), .b(x18), .O(new_n253_));
  oai21  g094(.a(x52), .b(new_n252_), .c(new_n253_), .O(new_n254_));
  nand4  g095(.a(new_n254_), .b(x78), .c(new_n236_), .d(x04), .O(new_n255_));
  aoi21  g096(.a(new_n255_), .b(new_n156_), .c(x01), .O(z50));
  inv1   g097(.a(x11), .O(new_n257_));
  nand2  g098(.a(x52), .b(x19), .O(new_n258_));
  oai21  g099(.a(x52), .b(new_n257_), .c(new_n258_), .O(new_n259_));
  nand4  g100(.a(new_n259_), .b(x78), .c(new_n236_), .d(x04), .O(new_n260_));
  aoi21  g101(.a(new_n260_), .b(new_n156_), .c(x01), .O(z51));
  nand2  g102(.a(x52), .b(x20), .O(new_n262_));
  nand2  g103(.a(new_n153_), .b(x12), .O(new_n263_));
  aoi21  g104(.a(new_n263_), .b(new_n262_), .c(x79), .O(new_n264_));
  nand4  g105(.a(new_n264_), .b(x78), .c(new_n236_), .d(x04), .O(new_n265_));
  nor2   g106(.a(new_n265_), .b(x01), .O(z52));
  inv1   g107(.a(x13), .O(new_n267_));
  nand2  g108(.a(x52), .b(x21), .O(new_n268_));
  oai21  g109(.a(x52), .b(new_n267_), .c(new_n268_), .O(new_n269_));
  nand4  g110(.a(new_n269_), .b(x78), .c(new_n236_), .d(x04), .O(new_n270_));
  aoi21  g111(.a(new_n270_), .b(new_n156_), .c(x01), .O(z53));
  nand2  g112(.a(x52), .b(x22), .O(new_n272_));
  nand2  g113(.a(new_n153_), .b(x14), .O(new_n273_));
  aoi21  g114(.a(new_n273_), .b(new_n272_), .c(x79), .O(new_n274_));
  nand4  g115(.a(new_n274_), .b(x78), .c(new_n236_), .d(x04), .O(new_n275_));
  nor2   g116(.a(new_n275_), .b(x01), .O(z54));
  inv1   g117(.a(x78), .O(new_n278_));
  nand2  g118(.a(new_n278_), .b(new_n236_), .O(new_n279_));
  nand4  g119(.a(new_n279_), .b(new_n156_), .c(new_n160_), .d(x00), .O(z56));
  inv1   g120(.a(x02), .O(new_n281_));
  nand4  g121(.a(x03), .b(new_n281_), .c(new_n160_), .d(x00), .O(new_n282_));
  nor2   g122(.a(new_n282_), .b(x79), .O(z57));
  nand2  g123(.a(x78), .b(new_n236_), .O(new_n284_));
  inv1   g124(.a(x42), .O(new_n285_));
  nand4  g125(.a(new_n278_), .b(x77), .c(new_n285_), .d(x40), .O(new_n286_));
  nand3  g126(.a(new_n286_), .b(new_n284_), .c(x04), .O(new_n287_));
  nand3  g127(.a(new_n287_), .b(new_n156_), .c(new_n160_), .O(new_n288_));
  inv1   g128(.a(new_n288_), .O(z58));
  nand2  g129(.a(x78), .b(x04), .O(new_n290_));
  oai21  g130(.a(x78), .b(new_n152_), .c(new_n290_), .O(new_n291_));
  aoi21  g131(.a(new_n291_), .b(x77), .c(new_n223_), .O(new_n292_));
  aoi21  g132(.a(new_n292_), .b(new_n156_), .c(x01), .O(z59));
  nor2   g133(.a(x78), .b(new_n223_), .O(new_n294_));
  aoi21  g134(.a(new_n294_), .b(new_n156_), .c(x01), .O(z60));
  aoi21  g135(.a(x78), .b(x04), .c(x79), .O(new_n297_));
  nor2   g136(.a(new_n297_), .b(x01), .O(z62));
  nand4  g137(.a(new_n156_), .b(x78), .c(new_n236_), .d(x04), .O(new_n300_));
  aoi21  g138(.a(new_n300_), .b(new_n156_), .c(x01), .O(z64));
  zero   g139(.O(z29));
  zero   g140(.O(z30));
  zero   g141(.O(z31));
  zero   g142(.O(z35));
  ...
  zero   g149(.O(z63));
  zero   g150(.O(z65));
  nor2   g151(.a(new_n156_), .b(x01), .O(z25));
  ...
  nor2   g158(.a(new_n156_), .b(x01), .O(z36));
  nor2   g159(.a(new_n156_), .b(x01), .O(z38));
  nor2   g160(.a(new_n156_), .b(x01), .O(z40));
  nor2   g161(.a(new_n156_), .b(x01), .O(z41));
  nor2   g162(.a(new_n156_), .b(x01), .O(z42));
  nor2   g163(.a(new_n156_), .b(x01), .O(z44));
  nor2   g164(.a(new_n156_), .b(x01), .O(z45));
endmodule
