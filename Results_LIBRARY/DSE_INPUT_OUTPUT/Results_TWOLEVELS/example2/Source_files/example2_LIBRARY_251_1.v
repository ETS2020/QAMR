...
module FAU ( 
  ...
  inv1   g067(.a(x01), .O(new_n219_));
  nand4  g068(.a(new_n160_), .b(x78), .c(x04), .d(new_n219_), .O(new_n220_));
  inv1   g069(.a(new_n220_), .O(z22));
  inv1   g070(.a(x04), .O(new_n222_));
  nand2  g071(.a(x05), .b(new_n222_), .O(new_n223_));
  nand4  g072(.a(new_n223_), .b(new_n160_), .c(new_n219_), .d(x00), .O(z23));
  ...
  inv1   g077(.a(x07), .O(new_n239_));
  nand2  g078(.a(x52), .b(x15), .O(new_n240_));
  oai21  g079(.a(x52), .b(new_n239_), .c(new_n240_), .O(new_n241_));
  nand4  g080(.a(new_n241_), .b(x78), .c(new_n238_), .d(x04), .O(new_n242_));
  aoi21  g081(.a(new_n242_), .b(new_n160_), .c(x01), .O(z47));
  ...
  aoi21  g106(.a(new_n267_), .b(new_n160_), .c(x01), .O(z52));
  nand2  g107(.a(x52), .b(x21), .O(new_n269_));
  nand2  g108(.a(new_n155_), .b(x13), .O(new_n270_));
  ...
  nand2  g117(.a(new_n164_), .b(new_n238_), .O(new_n280_));
  nand4  g118(.a(new_n280_), .b(new_n160_), .c(new_n219_), .d(x00), .O(z56));
  inv1   g119(.a(x02), .O(new_n282_));
  nand3  g120(.a(x03), .b(new_n282_), .c(x00), .O(new_n283_));
  aoi21  g121(.a(new_n283_), .b(new_n160_), .c(x01), .O(z57));
  nand2  g122(.a(x78), .b(new_n238_), .O(new_n285_));
  inv1   g123(.a(x42), .O(new_n286_));
  nand4  g124(.a(new_n164_), .b(x77), .c(new_n286_), .d(x40), .O(new_n287_));
  nand3  g125(.a(new_n287_), .b(new_n285_), .c(x04), .O(new_n288_));
  nand3  g126(.a(new_n288_), .b(new_n160_), .c(new_n219_), .O(new_n289_));
  inv1   g127(.a(new_n289_), .O(z58));
  nand2  g128(.a(x78), .b(x04), .O(new_n291_));
  nand2  g129(.a(new_n164_), .b(x40), .O(new_n292_));
  aoi21  g130(.a(new_n292_), .b(new_n291_), .c(new_n238_), .O(new_n293_));
  oai21  g131(.a(new_n293_), .b(new_n222_), .c(new_n160_), .O(new_n294_));
  nor2   g132(.a(new_n294_), .b(x01), .O(z59));
  nor2   g133(.a(x78), .b(new_n222_), .O(new_n296_));
  aoi21  g134(.a(new_n296_), .b(new_n160_), .c(x01), .O(z60));
  aoi21  g135(.a(x78), .b(x04), .c(x79), .O(new_n299_));
  nor2   g136(.a(new_n299_), .b(x01), .O(z62));
  nand4  g137(.a(x78), .b(new_n238_), .c(x04), .d(new_n219_), .O(new_n301_));
  nor2   g138(.a(new_n301_), .b(x79), .O(z64));
  zero   g139(.O(z25));
  zero   g140(.O(z26));
  zero   g141(.O(z31));
  zero   g142(.O(z32));
  ...
  zero   g149(.O(z55));
  zero   g150(.O(z61));
  nor2   g151(.a(new_n160_), .b(x01), .O(z27));
  nor2   g152(.a(new_n160_), .b(x01), .O(z28));
  nor2   g153(.a(new_n160_), .b(x01), .O(z29));
  nor2   g154(.a(new_n160_), .b(x01), .O(z30));
  nor2   g155(.a(new_n160_), .b(x01), .O(z34));
  nor2   g156(.a(new_n160_), .b(x01), .O(z35));
  nor2   g157(.a(new_n160_), .b(x01), .O(z37));
  nor2   g158(.a(new_n160_), .b(x01), .O(z38));
  nor2   g159(.a(new_n160_), .b(x01), .O(z39));
  nor2   g160(.a(new_n160_), .b(x01), .O(z42));
  nor2   g161(.a(new_n160_), .b(x01), .O(z44));
  nor2   g162(.a(new_n160_), .b(x01), .O(z46));
  nor2   g163(.a(new_n160_), .b(x01), .O(z63));
  nor2   g164(.a(new_n160_), .b(x01), .O(z65));
endmodule
