// Benchmark "FAU" written by ABC on Thu Aug 20 02:47:27 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n223_, new_n224_, new_n225_, new_n227_, new_n240_, new_n241_,
    ...
    new_n279_, new_n282_, new_n283_, new_n285_, new_n286_, new_n288_,
    new_n289_, new_n290_, new_n291_, new_n292_, new_n294_, new_n295_,
    new_n296_, new_n298_, new_n301_, new_n303_;
  ...
  inv1   g077(.a(x77), .O(new_n240_));
  inv1   g078(.a(x07), .O(new_n241_));
  nand2  g079(.a(x52), .b(x15), .O(new_n242_));
  oai21  g080(.a(x52), .b(new_n241_), .c(new_n242_), .O(new_n243_));
  nand4  g081(.a(new_n243_), .b(x78), .c(new_n240_), .d(x04), .O(new_n244_));
  aoi21  g082(.a(new_n244_), .b(new_n156_), .c(x01), .O(z47));
  nand2  g083(.a(x52), .b(x16), .O(new_n246_));
  nand2  g084(.a(new_n153_), .b(x08), .O(new_n247_));
  aoi21  g085(.a(new_n247_), .b(new_n246_), .c(x79), .O(new_n248_));
  nand4  g086(.a(new_n248_), .b(x78), .c(new_n240_), .d(x04), .O(new_n249_));
  nor2   g087(.a(new_n249_), .b(x01), .O(z48));
  inv1   g088(.a(x09), .O(new_n251_));
  nand2  g089(.a(x52), .b(x17), .O(new_n252_));
  oai21  g090(.a(x52), .b(new_n251_), .c(new_n252_), .O(new_n253_));
  nand4  g091(.a(new_n253_), .b(x78), .c(new_n240_), .d(x04), .O(new_n254_));
  aoi21  g092(.a(new_n254_), .b(new_n156_), .c(x01), .O(z49));
  inv1   g093(.a(x10), .O(new_n256_));
  nand2  g094(.a(x52), .b(x18), .O(new_n257_));
  oai21  g095(.a(x52), .b(new_n256_), .c(new_n257_), .O(new_n258_));
  nand4  g096(.a(new_n258_), .b(x78), .c(new_n240_), .d(x04), .O(new_n259_));
  aoi21  g097(.a(new_n259_), .b(new_n156_), .c(x01), .O(z50));
  nand2  g098(.a(x52), .b(x19), .O(new_n261_));
  nand2  g099(.a(new_n153_), .b(x11), .O(new_n262_));
  aoi21  g100(.a(new_n262_), .b(new_n261_), .c(x79), .O(new_n263_));
  nand4  g101(.a(new_n263_), .b(x78), .c(new_n240_), .d(x04), .O(new_n264_));
  nor2   g102(.a(new_n264_), .b(x01), .O(z51));
  nand2  g103(.a(x52), .b(x20), .O(new_n266_));
  nand2  g104(.a(new_n153_), .b(x12), .O(new_n267_));
  aoi21  g105(.a(new_n267_), .b(new_n266_), .c(x79), .O(new_n268_));
  nand4  g106(.a(new_n268_), .b(x78), .c(new_n240_), .d(x04), .O(new_n269_));
  nor2   g107(.a(new_n269_), .b(x01), .O(z52));
  inv1   g108(.a(x13), .O(new_n271_));
  nand2  g109(.a(x52), .b(x21), .O(new_n272_));
  oai21  g110(.a(x52), .b(new_n271_), .c(new_n272_), .O(new_n273_));
  nand4  g111(.a(new_n273_), .b(x78), .c(new_n240_), .d(x04), .O(new_n274_));
  aoi21  g112(.a(new_n274_), .b(new_n156_), .c(x01), .O(z53));
  nand2  g113(.a(x52), .b(x22), .O(new_n276_));
  nand2  g114(.a(new_n153_), .b(x14), .O(new_n277_));
  aoi21  g115(.a(new_n277_), .b(new_n276_), .c(x79), .O(new_n278_));
  nand4  g116(.a(new_n278_), .b(x78), .c(new_n240_), .d(x04), .O(new_n279_));
  nor2   g117(.a(new_n279_), .b(x01), .O(z54));
  inv1   g118(.a(x78), .O(new_n282_));
  nand2  g119(.a(new_n282_), .b(new_n240_), .O(new_n283_));
  nand4  g120(.a(new_n283_), .b(new_n156_), .c(new_n160_), .d(x00), .O(z56));
  inv1   g121(.a(x02), .O(new_n285_));
  nand3  g122(.a(x03), .b(new_n285_), .c(x00), .O(new_n286_));
  aoi21  g123(.a(new_n286_), .b(new_n156_), .c(x01), .O(z57));
  nand2  g124(.a(x78), .b(new_n240_), .O(new_n288_));
  inv1   g125(.a(x42), .O(new_n289_));
  nand4  g126(.a(new_n282_), .b(x77), .c(new_n289_), .d(x40), .O(new_n290_));
  nand3  g127(.a(new_n290_), .b(new_n288_), .c(x04), .O(new_n291_));
  nand3  g128(.a(new_n291_), .b(new_n156_), .c(new_n160_), .O(new_n292_));
  inv1   g129(.a(new_n292_), .O(z58));
  nand2  g130(.a(x78), .b(x04), .O(new_n294_));
  oai21  g131(.a(x78), .b(new_n152_), .c(new_n294_), .O(new_n295_));
  aoi21  g132(.a(new_n295_), .b(x77), .c(new_n224_), .O(new_n296_));
  aoi21  g133(.a(new_n296_), .b(new_n156_), .c(x01), .O(z59));
  nor2   g134(.a(x78), .b(new_n224_), .O(new_n298_));
  aoi21  g135(.a(new_n298_), .b(new_n156_), .c(x01), .O(z60));
  nand4  g136(.a(new_n156_), .b(x78), .c(x04), .d(new_n160_), .O(new_n301_));
  inv1   g137(.a(new_n301_), .O(z62));
  nand4  g138(.a(new_n156_), .b(x78), .c(new_n240_), .d(x04), .O(new_n303_));
  aoi21  g139(.a(new_n303_), .b(new_n156_), .c(x01), .O(z64));
  zero   g140(.O(z25));
  zero   g141(.O(z28));
  zero   g142(.O(z29));
  zero   g143(.O(z30));
  ...
  zero   g152(.O(z61));
  zero   g153(.O(z65));
  nor2   g154(.a(new_n156_), .b(x01), .O(z26));
  nor2   g155(.a(new_n156_), .b(x01), .O(z27));
  nor2   g156(.a(new_n156_), .b(x01), .O(z32));
  nor2   g157(.a(new_n156_), .b(x01), .O(z34));
  nor2   g158(.a(new_n156_), .b(x01), .O(z37));
  ...
  nor2   g163(.a(new_n156_), .b(x01), .O(z45));
  nor2   g164(.a(new_n156_), .b(x01), .O(z46));
  nor2   g165(.a(new_n156_), .b(x01), .O(z63));
endmodule
