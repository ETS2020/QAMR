...
module FAU ( 
  ...
  nand3  g034(.a(new_n185_), .b(new_n184_), .c(new_n158_), .O(z10));
  ...
  aoi21  g055(.a(new_n206_), .b(new_n205_), .c(z02), .O(z17));
  ...
  nand3  g068(.a(new_n167_), .b(x04), .c(z01), .O(new_n220_));
  ...
  nand2  g103(.a(new_n153_), .b(x12), .O(new_n266_));
  ...
  aoi21  g116(.a(new_n278_), .b(new_n156_), .c(x01), .O(z54));
  aoi21  g117(.a(new_n166_), .b(new_n239_), .c(new_n222_), .O(new_n280_));
  oai21  g118(.a(new_n280_), .b(x79), .c(z01), .O(z56));
  inv1   g119(.a(x02), .O(new_n282_));
  nand4  g120(.a(x03), .b(new_n282_), .c(z01), .d(x00), .O(new_n283_));
  nor2   g121(.a(new_n283_), .b(x79), .O(z57));
  nor2   g122(.a(x78), .b(new_n239_), .O(new_n285_));
  nor2   g123(.a(x42), .b(new_n152_), .O(new_n286_));
  aoi21  g124(.a(new_n286_), .b(new_n285_), .c(new_n223_), .O(new_n287_));
  nor2   g125(.a(x77), .b(new_n223_), .O(new_n288_));
  aoi21  g126(.a(new_n288_), .b(x78), .c(x79), .O(new_n289_));
  aoi21  g127(.a(new_n289_), .b(new_n287_), .c(x01), .O(z58));
  nand2  g128(.a(x78), .b(x04), .O(new_n291_));
  oai21  g129(.a(x78), .b(new_n152_), .c(new_n291_), .O(new_n292_));
  nand3  g130(.a(new_n292_), .b(new_n156_), .c(x77), .O(new_n293_));
  nor2   g131(.a(x79), .b(new_n223_), .O(new_n294_));
  aoi21  g132(.a(new_n294_), .b(new_n293_), .c(x01), .O(z59));
  nand2  g133(.a(new_n167_), .b(x04), .O(new_n296_));
  aoi21  g134(.a(new_n294_), .b(new_n296_), .c(x01), .O(z60));
  aoi21  g135(.a(new_n296_), .b(new_n156_), .c(x01), .O(z62));
  nand4  g136(.a(x78), .b(new_n239_), .c(x04), .d(z01), .O(new_n299_));
  nor2   g137(.a(new_n299_), .b(x79), .O(z64));
  zero   g138(.O(z26));
  zero   g139(.O(z27));
  zero   g140(.O(z29));
  zero   g141(.O(z32));
  ...
  nor2   g151(.a(new_n156_), .b(x01), .O(z28));
  nor2   g152(.a(new_n156_), .b(x01), .O(z30));
  nor2   g153(.a(new_n156_), .b(x01), .O(z31));
  nor2   g154(.a(new_n156_), .b(x01), .O(z33));
  nor2   g155(.a(new_n156_), .b(x01), .O(z38));
  nor2   g156(.a(new_n156_), .b(x01), .O(z39));
