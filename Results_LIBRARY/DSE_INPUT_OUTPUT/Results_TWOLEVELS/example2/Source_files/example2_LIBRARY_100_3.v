...
module FAU ( 
  ...
  nand2  g005(.a(x74), .b(x02), .O(new_n157_));
  ...
  nand3  g025(.a(new_n157_), .b(new_n155_), .c(new_n153_), .O(new_n177_));
  ...
  nand3  g038(.a(new_n189_), .b(new_n188_), .c(new_n157_), .O(z08));
  ...
  nand3  g053(.a(new_n204_), .b(new_n203_), .c(new_n157_), .O(z13));
  ...
  nand3  g074(.a(new_n225_), .b(new_n224_), .c(new_n157_), .O(z20));
  nand2  g075(.a(x44), .b(x40), .O(new_n227_));
  nand2  g076(.a(new_n152_), .b(x39), .O(new_n228_));
  nand3  g077(.a(new_n228_), .b(new_n227_), .c(new_n157_), .O(z21));
  xor2a  g078(.a(x84), .b(x81), .O(new_n230_));
  inv1   g079(.a(new_n230_), .O(new_n231_));
  nand3  g080(.a(new_n231_), .b(new_n172_), .c(x79), .O(new_n232_));
  ...
  oai21  g085(.a(new_n236_), .b(new_n234_), .c(x77), .O(new_n237_));
  oai21  g086(.a(new_n237_), .b(x42), .c(x79), .O(new_n238_));
  nand3  g087(.a(new_n238_), .b(x78), .c(x04), .O(new_n239_));
  oai21  g088(.a(new_n232_), .b(x41), .c(new_n239_), .O(new_n240_));
  nand2  g089(.a(new_n240_), .b(new_n153_), .O(new_n241_));
  nand2  g090(.a(new_n241_), .b(new_n157_), .O(z22));
  ...
  nand3  g095(.a(new_n246_), .b(new_n244_), .c(new_n157_), .O(z23));
  inv1   g096(.a(x43), .O(new_n248_));
  nand2  g097(.a(new_n161_), .b(x79), .O(new_n249_));
  nand4  g098(.a(new_n249_), .b(new_n157_), .c(new_n248_), .d(x05), .O(new_n250_));
  nor3   g099(.a(new_n250_), .b(x04), .c(x01), .O(z24));
  ...
  nand4  g108(.a(new_n259_), .b(x05), .c(new_n245_), .d(new_n153_), .O(new_n260_));
  nand2  g109(.a(new_n260_), .b(new_n157_), .O(z25));
  inv1   g110(.a(x42), .O(new_n262_));
  inv1   g111(.a(x44), .O(new_n263_));
  nor2   g112(.a(new_n258_), .b(new_n263_), .O(new_n264_));
  nand4  g113(.a(new_n264_), .b(new_n262_), .c(new_n245_), .d(new_n153_), .O(new_n265_));
  nand2  g114(.a(new_n265_), .b(new_n157_), .O(z26));
  nand4  g115(.a(new_n257_), .b(new_n157_), .c(x79), .d(x78), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(new_n162_), .O(new_n268_));
  nand4  g117(.a(new_n268_), .b(x45), .c(new_n262_), .d(new_n245_), .O(new_n269_));
  nor2   g118(.a(new_n269_), .b(x01), .O(z27));
  inv1   g119(.a(x46), .O(new_n271_));
  nor2   g120(.a(new_n258_), .b(new_n271_), .O(new_n272_));
  nand4  g121(.a(new_n272_), .b(new_n262_), .c(new_n245_), .d(new_n153_), .O(new_n273_));
  nand2  g122(.a(new_n273_), .b(new_n157_), .O(z28));
  inv1   g123(.a(x47), .O(new_n275_));
  nor2   g124(.a(new_n258_), .b(new_n275_), .O(new_n276_));
  nand4  g125(.a(new_n276_), .b(new_n262_), .c(new_n245_), .d(new_n153_), .O(new_n277_));
  nand2  g126(.a(new_n277_), .b(new_n157_), .O(z29));
  nand4  g127(.a(new_n268_), .b(x48), .c(new_n262_), .d(new_n245_), .O(new_n279_));
  nor2   g128(.a(new_n279_), .b(x01), .O(z30));
  nand4  g129(.a(new_n268_), .b(x49), .c(new_n262_), .d(new_n245_), .O(new_n281_));
  nor2   g130(.a(new_n281_), .b(x01), .O(z31));
  inv1   g131(.a(x50), .O(new_n283_));
  nor2   g132(.a(new_n258_), .b(new_n283_), .O(new_n284_));
  nand4  g133(.a(new_n284_), .b(new_n262_), .c(new_n245_), .d(new_n153_), .O(new_n285_));
  nand2  g134(.a(new_n285_), .b(new_n157_), .O(z32));
  xor2a  g135(.a(x83), .b(x81), .O(new_n287_));
  nand3  g136(.a(new_n287_), .b(x42), .c(x05), .O(new_n288_));
  nand3  g137(.a(x81), .b(x51), .c(new_n262_), .O(new_n289_));
  nand2  g138(.a(new_n289_), .b(new_n288_), .O(new_n290_));
  nand3  g139(.a(new_n290_), .b(new_n252_), .c(new_n157_), .O(new_n291_));
  xnor2a g140(.a(x83), .b(x81), .O(new_n292_));
  nand3  g141(.a(new_n292_), .b(x42), .c(x05), .O(new_n293_));
  nand3  g142(.a(new_n254_), .b(x51), .c(new_n262_), .O(new_n294_));
  nand2  g143(.a(new_n294_), .b(new_n293_), .O(new_n295_));
  nand3  g144(.a(new_n295_), .b(new_n255_), .c(new_n157_), .O(new_n296_));
  ...
  nand3  g152(.a(new_n303_), .b(new_n255_), .c(new_n157_), .O(new_n304_));
  ...
  nand3  g156(.a(new_n307_), .b(new_n252_), .c(new_n157_), .O(new_n308_));
  aoi21  g157(.a(new_n308_), .b(new_n304_), .c(new_n154_), .O(new_n309_));
  nand4  g158(.a(new_n309_), .b(x78), .c(x77), .d(x52), .O(new_n310_));
  nor3   g159(.a(new_n310_), .b(x04), .c(x01), .O(z34));
  nand2  g160(.a(new_n303_), .b(new_n255_), .O(new_n312_));
  nand2  g161(.a(new_n307_), .b(new_n252_), .O(new_n313_));
  ...
  nand4  g165(.a(new_n316_), .b(x53), .c(new_n245_), .d(new_n153_), .O(new_n317_));
  nand2  g166(.a(new_n317_), .b(new_n157_), .O(z35));
  nand4  g167(.a(new_n309_), .b(x78), .c(x77), .d(x54), .O(new_n319_));
  nor3   g168(.a(new_n319_), .b(x04), .c(x01), .O(z36));
  nand4  g169(.a(new_n316_), .b(x55), .c(new_n245_), .d(new_n153_), .O(new_n321_));
  nand2  g170(.a(new_n321_), .b(new_n157_), .O(z37));
  nand4  g171(.a(new_n316_), .b(x56), .c(new_n245_), .d(new_n153_), .O(new_n323_));
  nand2  g172(.a(new_n323_), .b(new_n157_), .O(z38));
  nand4  g173(.a(new_n316_), .b(x57), .c(new_n245_), .d(new_n153_), .O(new_n325_));
  nand2  g174(.a(new_n325_), .b(new_n157_), .O(z39));
  nand4  g175(.a(new_n309_), .b(x78), .c(x77), .d(x58), .O(new_n327_));
  nor3   g176(.a(new_n327_), .b(x04), .c(x01), .O(z40));
  nand4  g177(.a(new_n309_), .b(x78), .c(x77), .d(x59), .O(new_n329_));
  nor3   g178(.a(new_n329_), .b(x04), .c(x01), .O(z41));
  nand4  g179(.a(new_n309_), .b(x78), .c(x77), .d(x60), .O(new_n331_));
  nor3   g180(.a(new_n331_), .b(x04), .c(x01), .O(z42));
  nand4  g181(.a(new_n316_), .b(x61), .c(new_n245_), .d(new_n153_), .O(new_n333_));
  nand2  g182(.a(new_n333_), .b(new_n157_), .O(z43));
  nand4  g183(.a(new_n316_), .b(x62), .c(new_n245_), .d(new_n153_), .O(new_n335_));
  nand2  g184(.a(new_n335_), .b(new_n157_), .O(z44));
  nand4  g185(.a(new_n309_), .b(x78), .c(x77), .d(x63), .O(new_n337_));
  nor3   g186(.a(new_n337_), .b(x04), .c(x01), .O(z45));
  nand4  g187(.a(new_n316_), .b(x64), .c(new_n245_), .d(new_n153_), .O(new_n339_));
  nand2  g188(.a(new_n339_), .b(new_n157_), .O(z46));
  ...
  nor2   g195(.a(new_n346_), .b(new_n230_), .O(new_n347_));
  ...
  nand2  g199(.a(new_n350_), .b(new_n157_), .O(z47));
  ...
  nand4  g205(.a(new_n231_), .b(x79), .c(new_n163_), .d(x77), .O(new_n357_));
  ...
  oai21  g253(.a(new_n404_), .b(x01), .c(new_n157_), .O(z54));
  inv1   g254(.a(x82), .O(new_n406_));
  nand4  g255(.a(new_n157_), .b(x84), .c(x83), .d(new_n406_), .O(new_n407_));
  nor3   g256(.a(new_n407_), .b(x81), .c(x80), .O(new_n408_));
  nand2  g257(.a(new_n408_), .b(x79), .O(new_n409_));
  inv1   g258(.a(new_n409_), .O(new_n410_));
  nand4  g259(.a(new_n410_), .b(x78), .c(x77), .d(new_n245_), .O(new_n411_));
  nor2   g260(.a(new_n411_), .b(x01), .O(z55));
  nand2  g261(.a(new_n161_), .b(x76), .O(new_n413_));
  xnor2a g262(.a(x84), .b(x81), .O(new_n414_));
  aoi21  g263(.a(new_n171_), .b(new_n170_), .c(new_n414_), .O(new_n415_));
  nand2  g264(.a(new_n415_), .b(new_n153_), .O(new_n416_));
  aoi21  g265(.a(new_n416_), .b(new_n413_), .c(new_n154_), .O(new_n417_));
  nand4  g266(.a(new_n164_), .b(new_n157_), .c(new_n153_), .d(x00), .O(new_n418_));
  or2    g267(.a(new_n418_), .b(new_n417_), .O(z56));
  inv1   g268(.a(x02), .O(new_n420_));
  nand3  g269(.a(new_n244_), .b(x03), .c(new_n420_), .O(new_n421_));
  nand2  g270(.a(new_n421_), .b(new_n157_), .O(z57));
  nand4  g271(.a(x80), .b(new_n233_), .c(x43), .d(new_n262_), .O(new_n423_));
  oai22  g272(.a(new_n423_), .b(new_n236_), .c(new_n262_), .d(x40), .O(new_n424_));
  nand4  g273(.a(new_n424_), .b(x79), .c(x78), .d(x04), .O(new_n425_));
  nand4  g274(.a(new_n154_), .b(new_n163_), .c(new_n262_), .d(x40), .O(new_n426_));
  aoi21  g275(.a(new_n426_), .b(new_n425_), .c(new_n162_), .O(new_n427_));
  aoi21  g276(.a(new_n170_), .b(x04), .c(x79), .O(new_n428_));
  oai21  g277(.a(new_n428_), .b(new_n427_), .c(new_n153_), .O(new_n429_));
  nand2  g278(.a(new_n429_), .b(new_n157_), .O(z58));
  oai21  g279(.a(new_n163_), .b(new_n245_), .c(x79), .O(new_n431_));
  nand2  g280(.a(new_n431_), .b(x40), .O(new_n432_));
  oai21  g281(.a(new_n236_), .b(new_n234_), .c(new_n262_), .O(new_n433_));
  nand2  g282(.a(new_n433_), .b(x79), .O(new_n434_));
  nand3  g283(.a(new_n434_), .b(x78), .c(x04), .O(new_n435_));
  aoi21  g284(.a(new_n435_), .b(new_n432_), .c(new_n162_), .O(new_n436_));
  nor2   g285(.a(x79), .b(x04), .O(new_n437_));
  oai21  g286(.a(new_n437_), .b(new_n436_), .c(new_n153_), .O(new_n438_));
  nand2  g287(.a(new_n438_), .b(new_n157_), .O(z59));
  nor4   g288(.a(new_n161_), .b(x42), .c(new_n245_), .d(x01), .O(new_n440_));
  oai21  g289(.a(new_n440_), .b(x02), .c(x74), .O(new_n441_));
  inv1   g290(.a(new_n437_), .O(new_n442_));
  nand2  g291(.a(new_n415_), .b(x79), .O(new_n443_));
  nand3  g292(.a(x81), .b(x80), .c(x43), .O(new_n444_));
  nand3  g293(.a(x84), .b(new_n235_), .c(x82), .O(new_n445_));
  oai21  g294(.a(new_n445_), .b(new_n444_), .c(x77), .O(new_n446_));
  oai21  g295(.a(new_n446_), .b(x42), .c(x79), .O(new_n447_));
  nand3  g296(.a(new_n447_), .b(x78), .c(x04), .O(new_n448_));
  nand3  g297(.a(new_n448_), .b(new_n443_), .c(new_n442_), .O(new_n449_));
  nand2  g298(.a(new_n449_), .b(new_n153_), .O(new_n450_));
  nand2  g299(.a(new_n450_), .b(new_n441_), .O(z60));
  nand2  g300(.a(new_n171_), .b(new_n170_), .O(new_n452_));
  nand2  g301(.a(new_n452_), .b(new_n231_), .O(new_n453_));
  nand3  g302(.a(x78), .b(x77), .c(new_n245_), .O(new_n454_));
  ...
  nand4  g324(.a(new_n475_), .b(new_n157_), .c(x84), .d(x79), .O(new_n476_));
