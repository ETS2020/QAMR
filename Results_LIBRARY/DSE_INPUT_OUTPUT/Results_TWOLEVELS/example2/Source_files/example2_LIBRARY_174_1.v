...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n223_, new_n224_, new_n226_, new_n237_, new_n238_, new_n239_,
  ...
  nand2  g077(.a(x52), .b(x15), .O(new_n238_));
  nand2  g078(.a(new_n153_), .b(x07), .O(new_n239_));
  aoi21  g079(.a(new_n239_), .b(new_n238_), .c(x79), .O(new_n240_));
  nand4  g080(.a(new_n240_), .b(x78), .c(new_n237_), .d(x04), .O(new_n241_));
  nor2   g081(.a(new_n241_), .b(x01), .O(z47));
  inv1   g082(.a(x08), .O(new_n243_));
  nand2  g083(.a(x52), .b(x16), .O(new_n244_));
  oai21  g084(.a(x52), .b(new_n243_), .c(new_n244_), .O(new_n245_));
  nand4  g085(.a(new_n245_), .b(x78), .c(new_n237_), .d(x04), .O(new_n246_));
  aoi21  g086(.a(new_n246_), .b(new_n156_), .c(x01), .O(z48));
  ...
  nand2  g102(.a(x52), .b(x20), .O(new_n263_));
  nand2  g103(.a(new_n153_), .b(x12), .O(new_n264_));
  aoi21  g104(.a(new_n264_), .b(new_n263_), .c(x79), .O(new_n265_));
  nand4  g105(.a(new_n265_), .b(x78), .c(new_n237_), .d(x04), .O(new_n266_));
  nor2   g106(.a(new_n266_), .b(x01), .O(z52));
  nand2  g107(.a(x52), .b(x21), .O(new_n268_));
  nand2  g108(.a(new_n153_), .b(x13), .O(new_n269_));
  aoi21  g109(.a(new_n269_), .b(new_n268_), .c(x79), .O(new_n270_));
  nand4  g110(.a(new_n270_), .b(x78), .c(new_n237_), .d(x04), .O(new_n271_));
  nor2   g111(.a(new_n271_), .b(x01), .O(z53));
  inv1   g112(.a(x14), .O(new_n273_));
  ...
  aoi21  g116(.a(new_n276_), .b(new_n156_), .c(x01), .O(z54));
  oai21  g117(.a(x78), .b(x77), .c(x00), .O(new_n279_));
  nand2  g118(.a(new_n279_), .b(new_n156_), .O(new_n280_));
  nand2  g119(.a(new_n280_), .b(new_n160_), .O(z56));
  inv1   g120(.a(x02), .O(new_n282_));
  nand4  g121(.a(x03), .b(new_n282_), .c(new_n160_), .d(x00), .O(new_n283_));
  nor2   g122(.a(new_n283_), .b(x79), .O(z57));
  aoi21  g123(.a(x78), .b(new_n237_), .c(new_n223_), .O(new_n285_));
  ...
  nand4  g134(.a(x78), .b(new_n237_), .c(x04), .d(new_n160_), .O(new_n298_));
  nor2   g135(.a(new_n298_), .b(x79), .O(z64));
  zero   g136(.O(z25));
  zero   g137(.O(z27));
  zero   g138(.O(z34));
  zero   g139(.O(z35));
  ...
  nor2   g150(.a(new_n156_), .b(x01), .O(z28));
  ...
  nor2   g159(.a(new_n156_), .b(x01), .O(z40));
  nor2   g160(.a(new_n156_), .b(x01), .O(z42));
  nor2   g161(.a(new_n156_), .b(x01), .O(z46));
  nor2   g162(.a(new_n221_), .b(x01), .O(z62));
endmodule
