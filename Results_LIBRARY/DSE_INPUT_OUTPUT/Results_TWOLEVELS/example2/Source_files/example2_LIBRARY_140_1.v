...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n292_, new_n294_, new_n295_, new_n297_, new_n299_, new_n301_,
    new_n303_, new_n305_, new_n306_, new_n307_, new_n308_, new_n310_,
    new_n312_, new_n313_, new_n314_, new_n316_, new_n317_;
  ...
  aoi21  g052(.a(new_n203_), .b(new_n202_), .c(z25), .O(z15));
  ...
  nand3  g074(.a(new_n159_), .b(new_n158_), .c(x04), .O(new_n226_));
  ...
  nand3  g079(.a(new_n159_), .b(x05), .c(new_n230_), .O(new_n231_));
  nand2  g080(.a(new_n231_), .b(x00), .O(new_n232_));
  nand2  g081(.a(new_n232_), .b(new_n158_), .O(new_n233_));
  nand2  g082(.a(new_n233_), .b(new_n152_), .O(z23));
  inv1   g083(.a(x43), .O(new_n235_));
  nand4  g084(.a(new_n159_), .b(new_n235_), .c(x05), .d(new_n230_), .O(new_n236_));
  aoi21  g085(.a(new_n236_), .b(new_n158_), .c(x01), .O(z24));
  nand2  g086(.a(x52), .b(x15), .O(new_n248_));
  inv1   g087(.a(x52), .O(new_n249_));
  nand2  g088(.a(new_n249_), .b(x07), .O(new_n250_));
  aoi21  g089(.a(new_n250_), .b(new_n248_), .c(x79), .O(new_n251_));
  nand4  g090(.a(new_n251_), .b(x78), .c(new_n158_), .d(x04), .O(new_n252_));
  nor2   g091(.a(new_n252_), .b(x01), .O(z47));
  nand2  g092(.a(x52), .b(x16), .O(new_n254_));
  nand2  g093(.a(new_n249_), .b(x08), .O(new_n255_));
  aoi21  g094(.a(new_n255_), .b(new_n254_), .c(x79), .O(new_n256_));
  nand4  g095(.a(new_n256_), .b(x78), .c(new_n158_), .d(x04), .O(new_n257_));
  nor2   g096(.a(new_n257_), .b(x01), .O(z48));
  nand2  g097(.a(x52), .b(x17), .O(new_n259_));
  nand2  g098(.a(new_n249_), .b(x09), .O(new_n260_));
  aoi21  g099(.a(new_n260_), .b(new_n259_), .c(x79), .O(new_n261_));
  nand4  g100(.a(new_n261_), .b(x78), .c(new_n158_), .d(x04), .O(new_n262_));
  nor2   g101(.a(new_n262_), .b(x01), .O(z49));
  nand2  g102(.a(x52), .b(x18), .O(new_n264_));
  nand2  g103(.a(new_n249_), .b(x10), .O(new_n265_));
  aoi21  g104(.a(new_n265_), .b(new_n264_), .c(x79), .O(new_n266_));
  nand4  g105(.a(new_n266_), .b(x78), .c(new_n158_), .d(x04), .O(new_n267_));
  nor2   g106(.a(new_n267_), .b(x01), .O(z50));
  inv1   g107(.a(x11), .O(new_n269_));
  nand2  g108(.a(x52), .b(x19), .O(new_n270_));
  oai21  g109(.a(x52), .b(new_n269_), .c(new_n270_), .O(new_n271_));
  nand4  g110(.a(new_n271_), .b(new_n159_), .c(x78), .d(x04), .O(new_n272_));
  aoi21  g111(.a(new_n272_), .b(new_n158_), .c(x01), .O(z51));
  nand2  g112(.a(x52), .b(x20), .O(new_n274_));
  nand2  g113(.a(new_n249_), .b(x12), .O(new_n275_));
  aoi21  g114(.a(new_n275_), .b(new_n274_), .c(x79), .O(new_n276_));
  nand4  g115(.a(new_n276_), .b(x78), .c(new_n158_), .d(x04), .O(new_n277_));
  nor2   g116(.a(new_n277_), .b(x01), .O(z52));
  nand2  g117(.a(x52), .b(x21), .O(new_n279_));
  nand2  g118(.a(new_n249_), .b(x13), .O(new_n280_));
  aoi21  g119(.a(new_n280_), .b(new_n279_), .c(x79), .O(new_n281_));
  nand4  g120(.a(new_n281_), .b(x78), .c(new_n158_), .d(x04), .O(new_n282_));
  nor2   g121(.a(new_n282_), .b(x01), .O(z53));
  nand2  g122(.a(x52), .b(x22), .O(new_n284_));
  nand2  g123(.a(new_n249_), .b(x14), .O(new_n285_));
  aoi21  g124(.a(new_n285_), .b(new_n284_), .c(x79), .O(new_n286_));
  nand4  g125(.a(new_n286_), .b(x78), .c(new_n158_), .d(x04), .O(new_n287_));
  nor2   g126(.a(new_n287_), .b(x01), .O(z54));
  xor2a  g127(.a(x84), .b(x81), .O(new_n289_));
  nand3  g128(.a(new_n289_), .b(x79), .c(x78), .O(new_n290_));
  inv1   g129(.a(x00), .O(new_n291_));
  aoi22  g130(.a(x79), .b(x76), .c(new_n158_), .d(new_n291_), .O(new_n292_));
  nand4  g131(.a(new_n292_), .b(new_n290_), .c(new_n163_), .d(new_n152_), .O(z56));
  inv1   g132(.a(x02), .O(new_n294_));
  nand4  g133(.a(x03), .b(new_n294_), .c(new_n152_), .d(x00), .O(new_n295_));
  nor2   g134(.a(new_n295_), .b(x77), .O(z57));
  or2    g135(.a(new_n162_), .b(x01), .O(new_n297_));
  inv1   g136(.a(new_n297_), .O(z58));
  nand4  g137(.a(new_n159_), .b(new_n158_), .c(new_n230_), .d(new_n152_), .O(new_n299_));
  inv1   g138(.a(new_n299_), .O(z59));
  nand3  g139(.a(new_n290_), .b(new_n162_), .c(new_n158_), .O(new_n301_));
  and2   g140(.a(new_n301_), .b(new_n152_), .O(z60));
  nand4  g141(.a(new_n224_), .b(x80), .c(x79), .d(x78), .O(new_n303_));
  aoi21  g142(.a(new_n303_), .b(new_n158_), .c(x01), .O(z61));
  nand2  g143(.a(new_n159_), .b(x04), .O(new_n305_));
  nand3  g144(.a(x84), .b(x81), .c(x79), .O(new_n306_));
  nand2  g145(.a(new_n306_), .b(new_n305_), .O(new_n307_));
  nand2  g146(.a(new_n307_), .b(x78), .O(new_n308_));
  aoi21  g147(.a(new_n308_), .b(new_n158_), .c(x01), .O(z62));
  nand4  g148(.a(new_n224_), .b(x82), .c(x79), .d(x78), .O(new_n310_));
  aoi21  g149(.a(new_n310_), .b(new_n158_), .c(x01), .O(z63));
  nand3  g150(.a(new_n224_), .b(x83), .c(x79), .O(new_n312_));
  nand2  g151(.a(new_n312_), .b(new_n305_), .O(new_n313_));
  nand4  g152(.a(new_n313_), .b(x78), .c(new_n158_), .d(new_n152_), .O(new_n314_));
  inv1   g153(.a(new_n314_), .O(z64));
  inv1   g154(.a(x84), .O(new_n316_));
  nand4  g155(.a(z04), .b(x81), .c(x79), .d(x78), .O(new_n317_));
  nor2   g156(.a(new_n317_), .b(new_n316_), .O(z65));
  zero   g157(.O(z29));
  zero   g158(.O(z30));
  zero   g159(.O(z32));
  zero   g160(.O(z33));
  ...
  zero   g165(.O(z40));
  zero   g166(.O(z43));
  nor2   g167(.a(new_n158_), .b(x01), .O(z26));
  nor2   g168(.a(new_n158_), .b(x01), .O(z27));
  nor2   g169(.a(new_n158_), .b(x01), .O(z28));
  nor2   g170(.a(new_n158_), .b(x01), .O(z31));
  nor2   g171(.a(new_n158_), .b(x01), .O(z34));
  nor2   g172(.a(new_n158_), .b(x01), .O(z36));
  ...
  nor2   g178(.a(new_n158_), .b(x01), .O(z55));
endmodule
