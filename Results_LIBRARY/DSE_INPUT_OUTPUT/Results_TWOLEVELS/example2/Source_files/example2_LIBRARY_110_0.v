...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n257_, new_n259_, new_n261_, new_n263_, new_n264_, new_n265_,
  ...
  nand3  g027(.a(new_n178_), .b(new_n177_), .c(new_n173_), .O(z06));
  ...
  nand2  g076(.a(new_n168_), .b(x66), .O(new_n228_));
  nand2  g077(.a(new_n228_), .b(new_n167_), .O(new_n229_));
  nand3  g078(.a(new_n229_), .b(new_n227_), .c(new_n226_), .O(new_n230_));
  ...
  nand4  g085(.a(new_n236_), .b(x78), .c(x77), .d(new_n231_), .O(new_n237_));
  oai21  g086(.a(new_n237_), .b(new_n225_), .c(new_n230_), .O(new_n238_));
  ...
  nand3  g091(.a(new_n242_), .b(x05), .c(new_n225_), .O(new_n243_));
  ...
  nand4  g101(.a(new_n252_), .b(new_n231_), .c(x05), .d(new_n225_), .O(new_n253_));
  nor2   g102(.a(new_n253_), .b(x01), .O(z25));
  nand4  g103(.a(new_n252_), .b(x44), .c(new_n231_), .d(new_n225_), .O(new_n255_));
  nor2   g104(.a(new_n255_), .b(x01), .O(z26));
  nand4  g105(.a(new_n252_), .b(x45), .c(new_n231_), .d(new_n225_), .O(new_n257_));
  nor2   g106(.a(new_n257_), .b(x01), .O(z27));
  nand4  g107(.a(new_n252_), .b(x46), .c(new_n231_), .d(new_n225_), .O(new_n259_));
  nor2   g108(.a(new_n259_), .b(x01), .O(z28));
  nand4  g109(.a(new_n252_), .b(x47), .c(new_n231_), .d(new_n225_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(x01), .O(z29));
  nand3  g111(.a(new_n250_), .b(x78), .c(x77), .O(new_n263_));
  inv1   g112(.a(new_n263_), .O(new_n264_));
  nand4  g113(.a(new_n264_), .b(x48), .c(new_n231_), .d(new_n225_), .O(new_n265_));
  aoi21  g114(.a(new_n265_), .b(x79), .c(x01), .O(z30));
  nand4  g115(.a(new_n264_), .b(x49), .c(new_n231_), .d(new_n225_), .O(new_n267_));
  aoi21  g116(.a(new_n267_), .b(x79), .c(x01), .O(z31));
  nand4  g117(.a(new_n252_), .b(x50), .c(new_n231_), .d(new_n225_), .O(new_n269_));
  nor2   g118(.a(new_n269_), .b(x01), .O(z32));
  xor2a  g119(.a(x83), .b(x81), .O(new_n271_));
  nand3  g120(.a(new_n271_), .b(x42), .c(x05), .O(new_n272_));
  nand3  g121(.a(x81), .b(x51), .c(new_n231_), .O(new_n273_));
  ...
  nand3  g126(.a(new_n247_), .b(x51), .c(new_n231_), .O(new_n278_));
  nand2  g127(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  nand2  g128(.a(new_n279_), .b(new_n248_), .O(new_n280_));
  nand2  g129(.a(new_n280_), .b(new_n275_), .O(new_n281_));
  nand4  g130(.a(new_n281_), .b(x78), .c(x77), .d(new_n225_), .O(new_n282_));
  ...
  aoi21  g141(.a(new_n292_), .b(new_n287_), .c(new_n161_), .O(new_n293_));
  nand4  g142(.a(new_n293_), .b(x77), .c(x52), .d(new_n225_), .O(new_n294_));
  aoi21  g143(.a(new_n294_), .b(x79), .c(x01), .O(z34));
  nand4  g144(.a(new_n293_), .b(x77), .c(x53), .d(new_n225_), .O(new_n296_));
  aoi21  g145(.a(new_n296_), .b(x79), .c(x01), .O(z35));
  nand4  g146(.a(new_n293_), .b(x77), .c(x54), .d(new_n225_), .O(new_n298_));
  aoi21  g147(.a(new_n298_), .b(x79), .c(x01), .O(z36));
  aoi21  g148(.a(new_n292_), .b(new_n287_), .c(new_n153_), .O(new_n300_));
  nand4  g149(.a(new_n300_), .b(x78), .c(x77), .d(x55), .O(new_n301_));
  nor3   g150(.a(new_n301_), .b(x04), .c(x01), .O(z37));
  nand4  g151(.a(new_n300_), .b(x78), .c(x77), .d(x56), .O(new_n303_));
  nor3   g152(.a(new_n303_), .b(x04), .c(x01), .O(z38));
  nand4  g153(.a(new_n300_), .b(x78), .c(x77), .d(x57), .O(new_n305_));
  nor3   g154(.a(new_n305_), .b(x04), .c(x01), .O(z39));
  nand4  g155(.a(new_n300_), .b(x78), .c(x77), .d(x58), .O(new_n307_));
  nor3   g156(.a(new_n307_), .b(x04), .c(x01), .O(z40));
  nand4  g157(.a(new_n293_), .b(x77), .c(x59), .d(new_n225_), .O(new_n309_));
  aoi21  g158(.a(new_n309_), .b(x79), .c(x01), .O(z41));
  nand4  g159(.a(new_n300_), .b(x78), .c(x77), .d(x60), .O(new_n311_));
  nor3   g160(.a(new_n311_), .b(x04), .c(x01), .O(z42));
  nand4  g161(.a(new_n300_), .b(x78), .c(x77), .d(x61), .O(new_n313_));
  nor3   g162(.a(new_n313_), .b(x04), .c(x01), .O(z43));
  nand4  g163(.a(new_n293_), .b(x77), .c(x62), .d(new_n225_), .O(new_n315_));
  aoi21  g164(.a(new_n315_), .b(x79), .c(x01), .O(z44));
  nand4  g165(.a(new_n293_), .b(x77), .c(x63), .d(new_n225_), .O(new_n317_));
  aoi21  g166(.a(new_n317_), .b(x79), .c(x01), .O(z45));
  nand4  g167(.a(new_n300_), .b(x78), .c(x77), .d(x64), .O(new_n319_));
  nor3   g168(.a(new_n319_), .b(x04), .c(x01), .O(z46));
  or2    g169(.a(x75), .b(x67), .O(new_n321_));
  nand4  g170(.a(new_n321_), .b(new_n227_), .c(new_n161_), .d(x77), .O(new_n322_));
  aoi21  g171(.a(new_n322_), .b(x79), .c(x01), .O(z47));
  nand3  g172(.a(new_n227_), .b(new_n161_), .c(x77), .O(new_n324_));
  inv1   g173(.a(new_n324_), .O(new_n325_));
  nand2  g174(.a(new_n325_), .b(x68), .O(new_n326_));
  aoi21  g175(.a(new_n326_), .b(x79), .c(x01), .O(z48));
  ...
  nand2  g179(.a(new_n325_), .b(x70), .O(new_n331_));
  aoi21  g180(.a(new_n331_), .b(x79), .c(x01), .O(z50));
  nand2  g181(.a(new_n325_), .b(x71), .O(new_n333_));
  aoi21  g182(.a(new_n333_), .b(x79), .c(x01), .O(z51));
  nand2  g183(.a(new_n325_), .b(x72), .O(new_n335_));
  aoi21  g184(.a(new_n335_), .b(x79), .c(x01), .O(z52));
  nand2  g185(.a(new_n325_), .b(x73), .O(new_n337_));
  ...
  nand2  g191(.a(new_n343_), .b(new_n247_), .O(new_n344_));
  nor4   g192(.a(new_n344_), .b(new_n340_), .c(new_n234_), .d(x82), .O(z55));
  nand2  g193(.a(new_n159_), .b(x76), .O(new_n346_));
  xor2a  g194(.a(x84), .b(x81), .O(new_n347_));
  oai21  g195(.a(new_n168_), .b(new_n166_), .c(new_n347_), .O(new_n348_));
  aoi21  g196(.a(new_n161_), .b(new_n160_), .c(new_n153_), .O(new_n349_));
  and2   g197(.a(new_n349_), .b(new_n348_), .O(new_n350_));
  nand4  g198(.a(new_n350_), .b(new_n346_), .c(new_n152_), .d(x00), .O(z56));
  inv1   g199(.a(x02), .O(new_n352_));
  nand3  g200(.a(x03), .b(new_n352_), .c(x00), .O(new_n353_));
  aoi21  g201(.a(new_n353_), .b(x79), .c(x01), .O(z57));
  nand4  g202(.a(x80), .b(new_n232_), .c(x43), .d(new_n231_), .O(new_n355_));
  oai22  g203(.a(new_n355_), .b(new_n235_), .c(new_n231_), .d(x40), .O(new_n356_));
  nand4  g204(.a(new_n356_), .b(x79), .c(x78), .d(x77), .O(new_n357_));
  nor3   g205(.a(new_n357_), .b(new_n225_), .c(x01), .O(z58));
  oai21  g206(.a(new_n235_), .b(new_n233_), .c(new_n231_), .O(new_n359_));
  aoi21  g207(.a(new_n359_), .b(new_n155_), .c(new_n153_), .O(new_n360_));
  nand4  g208(.a(new_n360_), .b(x78), .c(x77), .d(x04), .O(new_n361_));
  nor2   g209(.a(new_n361_), .b(x01), .O(z59));
  oai21  g210(.a(new_n235_), .b(new_n233_), .c(x79), .O(new_n363_));
  nor2   g211(.a(new_n363_), .b(new_n161_), .O(new_n364_));
  nand4  g212(.a(new_n364_), .b(x77), .c(new_n231_), .d(x04), .O(new_n365_));
  nand3  g213(.a(new_n365_), .b(new_n348_), .c(x79), .O(new_n366_));
  and2   g214(.a(new_n366_), .b(new_n152_), .O(z60));
  oai21  g215(.a(new_n168_), .b(new_n166_), .c(new_n227_), .O(new_n368_));
  oai21  g216(.a(new_n159_), .b(x04), .c(new_n368_), .O(new_n369_));
  nand2  g217(.a(new_n369_), .b(x80), .O(new_n370_));
  aoi21  g218(.a(new_n370_), .b(x79), .c(x01), .O(z61));
  nand2  g219(.a(x78), .b(new_n225_), .O(new_n372_));
  nand2  g220(.a(x84), .b(new_n161_), .O(new_n373_));
  aoi21  g221(.a(new_n373_), .b(new_n372_), .c(new_n160_), .O(new_n374_));
  nor3   g222(.a(new_n340_), .b(new_n161_), .c(x77), .O(new_n375_));
  oai21  g223(.a(new_n375_), .b(new_n374_), .c(x81), .O(new_n376_));
  nand3  g224(.a(new_n376_), .b(new_n365_), .c(x79), .O(new_n377_));
  and2   g225(.a(new_n377_), .b(new_n152_), .O(z62));
  nand4  g226(.a(new_n369_), .b(x82), .c(x79), .d(new_n152_), .O(new_n379_));
