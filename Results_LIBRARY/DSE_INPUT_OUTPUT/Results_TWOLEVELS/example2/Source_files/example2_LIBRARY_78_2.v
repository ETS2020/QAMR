...
module FAU ( 
  ...
  nor2   g011(.a(x77), .b(x33), .O(new_n163_));
  ...
  nand4  g031(.a(new_n154_), .b(new_n168_), .c(x78), .d(x52), .O(new_n183_));
  ...
  nand4  g035(.a(new_n171_), .b(new_n168_), .c(new_n170_), .d(new_n152_), .O(new_n187_));
  ...
  oai21  g070(.a(new_n170_), .b(new_n155_), .c(x33), .O(new_n222_));
  oai21  g071(.a(new_n221_), .b(new_n155_), .c(new_n222_), .O(z15));
  ...
  nand2  g095(.a(new_n170_), .b(x33), .O(new_n247_));
  ...
  nand4  g112(.a(new_n263_), .b(new_n261_), .c(new_n154_), .d(new_n160_), .O(z23));
  inv1   g113(.a(x43), .O(new_n265_));
  oai21  g114(.a(new_n168_), .b(x78), .c(x77), .O(new_n266_));
  oai21  g115(.a(x79), .b(x33), .c(new_n266_), .O(new_n267_));
  ...
  nand4  g138(.a(new_n289_), .b(new_n249_), .c(new_n262_), .d(new_n160_), .O(new_n290_));
  nand2  g139(.a(new_n290_), .b(new_n154_), .O(z30));
  inv1   g140(.a(x49), .O(new_n292_));
  nor2   g141(.a(new_n276_), .b(new_n292_), .O(new_n293_));
  nand4  g142(.a(new_n293_), .b(new_n249_), .c(new_n262_), .d(new_n160_), .O(new_n294_));
  nand2  g143(.a(new_n294_), .b(new_n154_), .O(z31));
  nor2   g144(.a(new_n276_), .b(new_n221_), .O(new_n296_));
  nand4  g145(.a(new_n296_), .b(new_n249_), .c(new_n262_), .d(new_n160_), .O(new_n297_));
  nand2  g146(.a(new_n297_), .b(new_n154_), .O(z32));
  nand2  g147(.a(x83), .b(new_n272_), .O(new_n299_));
  nand2  g148(.a(new_n252_), .b(x81), .O(new_n300_));
  ...
  nand3  g156(.a(new_n272_), .b(x51), .c(new_n249_), .O(new_n308_));
  ...
  nand4  g160(.a(new_n311_), .b(x78), .c(x77), .d(new_n262_), .O(new_n312_));
  ...
  oai21  g168(.a(new_n299_), .b(new_n249_), .c(new_n319_), .O(new_n320_));
  ...
  nand3  g173(.a(new_n324_), .b(x52), .c(new_n262_), .O(new_n325_));
  nor2   g174(.a(new_n325_), .b(x01), .O(z34));
  nand4  g175(.a(new_n324_), .b(x53), .c(new_n262_), .d(new_n160_), .O(new_n327_));
  nand2  g176(.a(new_n327_), .b(new_n154_), .O(z35));
  nand3  g177(.a(new_n324_), .b(x54), .c(new_n262_), .O(new_n329_));
  nor2   g178(.a(new_n329_), .b(x01), .O(z36));
  nand4  g179(.a(new_n324_), .b(x55), .c(new_n262_), .d(new_n160_), .O(new_n331_));
  nand2  g180(.a(new_n331_), .b(new_n154_), .O(z37));
  nand4  g181(.a(new_n324_), .b(x56), .c(new_n262_), .d(new_n160_), .O(new_n333_));
  nand2  g182(.a(new_n333_), .b(new_n154_), .O(z38));
  nand4  g183(.a(new_n324_), .b(x57), .c(new_n262_), .d(new_n160_), .O(new_n335_));
  nand2  g184(.a(new_n335_), .b(new_n154_), .O(z39));
  nand3  g185(.a(new_n324_), .b(x58), .c(new_n262_), .O(new_n337_));
  nor2   g186(.a(new_n337_), .b(x01), .O(z40));
  nand4  g187(.a(new_n324_), .b(x59), .c(new_n262_), .d(new_n160_), .O(new_n339_));
  nand2  g188(.a(new_n339_), .b(new_n154_), .O(z41));
  nand4  g189(.a(new_n324_), .b(x60), .c(new_n262_), .d(new_n160_), .O(new_n341_));
  nand2  g190(.a(new_n341_), .b(new_n154_), .O(z42));
  nand4  g191(.a(new_n324_), .b(x61), .c(new_n262_), .d(new_n160_), .O(new_n343_));
  nand2  g192(.a(new_n343_), .b(new_n154_), .O(z43));
  nand3  g193(.a(new_n324_), .b(x62), .c(new_n262_), .O(new_n345_));
  nor2   g194(.a(new_n345_), .b(x01), .O(z44));
  nand4  g195(.a(new_n324_), .b(x63), .c(new_n262_), .d(new_n160_), .O(new_n347_));
  nand2  g196(.a(new_n347_), .b(new_n154_), .O(z45));
  nand3  g197(.a(new_n324_), .b(x64), .c(new_n262_), .O(new_n349_));
  ...
  nand4  g202(.a(new_n353_), .b(new_n168_), .c(x78), .d(new_n170_), .O(new_n354_));
  ...
  nand4  g207(.a(new_n358_), .b(x79), .c(new_n161_), .d(x77), .O(new_n359_));
  ...
  nand4  g212(.a(new_n363_), .b(new_n168_), .c(x78), .d(new_n170_), .O(new_n364_));
  inv1   g213(.a(new_n364_), .O(new_n365_));
  nand3  g214(.a(new_n365_), .b(new_n152_), .c(x04), .O(new_n366_));
  nor2   g215(.a(new_n243_), .b(new_n168_), .O(new_n367_));
  nand3  g216(.a(new_n367_), .b(new_n161_), .c(x77), .O(new_n368_));
  ...
  nand4  g263(.a(new_n414_), .b(new_n168_), .c(x78), .d(new_n170_), .O(new_n415_));
  ...
  nand2  g271(.a(new_n422_), .b(new_n272_), .O(new_n423_));
  nor4   g272(.a(new_n423_), .b(new_n419_), .c(new_n252_), .d(x82), .O(z55));
  nand2  g273(.a(new_n154_), .b(x01), .O(new_n425_));
  inv1   g274(.a(new_n179_), .O(new_n426_));
  oai21  g275(.a(new_n426_), .b(new_n163_), .c(x76), .O(new_n427_));
  xor2a  g276(.a(x84), .b(x81), .O(new_n428_));
  oai21  g277(.a(new_n178_), .b(x33), .c(new_n179_), .O(new_n429_));
  ...
  nand3  g282(.a(new_n260_), .b(new_n161_), .c(new_n170_), .O(new_n434_));
  nand4  g283(.a(new_n434_), .b(new_n433_), .c(new_n425_), .d(new_n261_), .O(z56));
  inv1   g284(.a(x02), .O(new_n436_));
  nand4  g285(.a(x03), .b(new_n436_), .c(new_n160_), .d(x00), .O(new_n437_));
  nand2  g286(.a(new_n437_), .b(new_n154_), .O(z57));
  nand2  g287(.a(new_n247_), .b(new_n262_), .O(new_n439_));
  inv1   g288(.a(new_n178_), .O(new_n440_));
  nor2   g289(.a(x33), .b(new_n262_), .O(new_n441_));
  nand2  g290(.a(new_n441_), .b(new_n440_), .O(new_n442_));
  nand3  g291(.a(new_n426_), .b(new_n249_), .c(x40), .O(new_n443_));
  nand3  g292(.a(new_n443_), .b(new_n442_), .c(new_n439_), .O(new_n444_));
  nand4  g293(.a(x80), .b(new_n250_), .c(x43), .d(new_n249_), .O(new_n445_));
  oai22  g294(.a(new_n445_), .b(new_n253_), .c(new_n249_), .d(x40), .O(new_n446_));
  nand4  g295(.a(new_n446_), .b(x79), .c(x78), .d(x77), .O(new_n447_));
  inv1   g296(.a(new_n447_), .O(new_n448_));
  aoi22  g297(.a(new_n448_), .b(x04), .c(new_n444_), .d(new_n168_), .O(new_n449_));
  oai21  g298(.a(new_n449_), .b(x01), .c(new_n154_), .O(z58));
  inv1   g299(.a(new_n439_), .O(new_n451_));
  nand2  g300(.a(x78), .b(x04), .O(new_n452_));
  nand2  g301(.a(new_n161_), .b(x40), .O(new_n453_));
  aoi21  g302(.a(new_n453_), .b(new_n452_), .c(new_n170_), .O(new_n454_));
  oai21  g303(.a(new_n454_), .b(new_n451_), .c(new_n168_), .O(new_n455_));
  oai21  g304(.a(new_n253_), .b(new_n251_), .c(new_n249_), .O(new_n456_));
  nand2  g305(.a(new_n456_), .b(new_n155_), .O(new_n457_));
  ...
  nand3  g310(.a(new_n247_), .b(new_n171_), .c(new_n168_), .O(new_n462_));
  nand4  g311(.a(new_n254_), .b(x78), .c(x77), .d(new_n249_), .O(new_n463_));
  inv1   g312(.a(new_n463_), .O(new_n464_));
  aoi22  g313(.a(new_n464_), .b(x04), .c(new_n430_), .d(x79), .O(new_n465_));
  aoi21  g314(.a(new_n465_), .b(new_n462_), .c(x01), .O(z60));
  nand2  g315(.a(new_n429_), .b(new_n244_), .O(new_n467_));
  nand3  g316(.a(x78), .b(x77), .c(new_n262_), .O(new_n468_));
  ...
  oai21  g321(.a(x79), .b(new_n262_), .c(new_n472_), .O(new_n473_));
  nand3  g322(.a(new_n473_), .b(new_n170_), .c(new_n152_), .O(new_n474_));
  inv1   g323(.a(new_n474_), .O(new_n475_));
  nand2  g324(.a(new_n456_), .b(x79), .O(new_n476_));
  nand2  g325(.a(new_n476_), .b(x04), .O(new_n477_));
  nand3  g326(.a(x81), .b(x79), .c(new_n262_), .O(new_n478_));
  aoi21  g327(.a(new_n478_), .b(new_n477_), .c(new_n170_), .O(new_n479_));
  oai21  g328(.a(new_n479_), .b(new_n475_), .c(x78), .O(new_n480_));
  inv1   g329(.a(new_n472_), .O(new_n481_));
  nand2  g330(.a(new_n481_), .b(new_n426_), .O(new_n482_));
  aoi21  g331(.a(new_n482_), .b(new_n480_), .c(x01), .O(z62));
  oai21  g332(.a(new_n426_), .b(new_n440_), .c(new_n244_), .O(new_n484_));
  nand2  g333(.a(new_n484_), .b(new_n468_), .O(new_n485_));
  nand4  g334(.a(new_n485_), .b(x82), .c(x79), .d(new_n160_), .O(new_n486_));
  nand2  g335(.a(new_n486_), .b(new_n154_), .O(z63));
  nand3  g336(.a(new_n469_), .b(x83), .c(x79), .O(new_n488_));
  nand4  g337(.a(new_n441_), .b(new_n168_), .c(x78), .d(new_n170_), .O(new_n489_));
  aoi21  g338(.a(new_n489_), .b(new_n488_), .c(x01), .O(z64));
  nor2   g339(.a(new_n161_), .b(x04), .O(new_n491_));
  nor2   g340(.a(new_n272_), .b(x78), .O(new_n492_));
  oai21  g341(.a(new_n492_), .b(new_n491_), .c(x77), .O(new_n493_));
  nand3  g342(.a(new_n163_), .b(x81), .c(x78), .O(new_n494_));
  nand2  g343(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand4  g344(.a(new_n495_), .b(x84), .c(x79), .d(new_n160_), .O(new_n496_));
