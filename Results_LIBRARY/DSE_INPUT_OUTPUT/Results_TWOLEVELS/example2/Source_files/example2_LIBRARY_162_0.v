...
module FAU ( 
  ...
  nand3  g077(.a(new_n228_), .b(new_n168_), .c(new_n226_), .O(new_n229_));
  ...
  oai21  g085(.a(new_n236_), .b(new_n225_), .c(new_n229_), .O(new_n237_));
  nand3  g086(.a(new_n237_), .b(x79), .c(new_n152_), .O(new_n238_));
  ...
  nand4  g091(.a(new_n242_), .b(x77), .c(new_n241_), .d(x05), .O(new_n243_));
  nor3   g092(.a(new_n243_), .b(new_n153_), .c(new_n161_), .O(z24));
  ...
  nand4  g101(.a(new_n252_), .b(new_n230_), .c(x05), .d(new_n225_), .O(new_n253_));
  nor2   g102(.a(new_n253_), .b(x01), .O(z25));
  nand3  g103(.a(new_n250_), .b(x78), .c(x77), .O(new_n255_));
  inv1   g104(.a(new_n255_), .O(new_n256_));
  nand4  g105(.a(new_n256_), .b(x44), .c(new_n230_), .d(new_n225_), .O(new_n257_));
  aoi21  g106(.a(new_n257_), .b(x79), .c(x01), .O(z26));
  nand4  g107(.a(new_n252_), .b(x45), .c(new_n230_), .d(new_n225_), .O(new_n259_));
  nor2   g108(.a(new_n259_), .b(x01), .O(z27));
  nand4  g109(.a(new_n252_), .b(x46), .c(new_n230_), .d(new_n225_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(x01), .O(z28));
  nand4  g111(.a(new_n256_), .b(x47), .c(new_n230_), .d(new_n225_), .O(new_n263_));
  aoi21  g112(.a(new_n263_), .b(x79), .c(x01), .O(z29));
  nand4  g113(.a(new_n252_), .b(x48), .c(new_n230_), .d(new_n225_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(x01), .O(z30));
  nand4  g115(.a(new_n252_), .b(x49), .c(new_n230_), .d(new_n225_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(x01), .O(z31));
  nand4  g117(.a(new_n252_), .b(x50), .c(new_n230_), .d(new_n225_), .O(new_n269_));
  ...
  nand3  g126(.a(new_n247_), .b(x51), .c(new_n230_), .O(new_n278_));
  ...
  nand4  g145(.a(new_n296_), .b(x77), .c(x53), .d(new_n225_), .O(new_n297_));
  aoi21  g146(.a(new_n297_), .b(x79), .c(x01), .O(z35));
  nand4  g147(.a(new_n296_), .b(x77), .c(x54), .d(new_n225_), .O(new_n299_));
  aoi21  g148(.a(new_n299_), .b(x79), .c(x01), .O(z36));
  nand4  g149(.a(new_n296_), .b(x77), .c(x55), .d(new_n225_), .O(new_n301_));
  aoi21  g150(.a(new_n301_), .b(x79), .c(x01), .O(z37));
  nand4  g151(.a(new_n296_), .b(x77), .c(x56), .d(new_n225_), .O(new_n303_));
  aoi21  g152(.a(new_n303_), .b(x79), .c(x01), .O(z38));
  nand4  g153(.a(new_n293_), .b(x78), .c(x77), .d(x57), .O(new_n305_));
  nor3   g154(.a(new_n305_), .b(x04), .c(x01), .O(z39));
  nand4  g155(.a(new_n296_), .b(x77), .c(x58), .d(new_n225_), .O(new_n307_));
  aoi21  g156(.a(new_n307_), .b(x79), .c(x01), .O(z40));
  nand4  g157(.a(new_n293_), .b(x78), .c(x77), .d(x59), .O(new_n309_));
  nor3   g158(.a(new_n309_), .b(x04), .c(x01), .O(z41));
  nand4  g159(.a(new_n296_), .b(x77), .c(x60), .d(new_n225_), .O(new_n311_));
  aoi21  g160(.a(new_n311_), .b(x79), .c(x01), .O(z42));
  nand4  g161(.a(new_n293_), .b(x78), .c(x77), .d(x61), .O(new_n313_));
  ...
  nand4  g165(.a(new_n296_), .b(x77), .c(x63), .d(new_n225_), .O(new_n317_));
  aoi21  g166(.a(new_n317_), .b(x79), .c(x01), .O(z45));
  nand4  g167(.a(new_n296_), .b(x77), .c(x64), .d(new_n225_), .O(new_n319_));
  aoi21  g168(.a(new_n319_), .b(x79), .c(x01), .O(z46));
  inv1   g169(.a(x67), .O(new_n321_));
  nand2  g170(.a(new_n165_), .b(new_n321_), .O(new_n322_));
  nand4  g171(.a(new_n322_), .b(new_n228_), .c(x79), .d(new_n161_), .O(new_n323_));
  nor3   g172(.a(new_n323_), .b(new_n160_), .c(x01), .O(z47));
  inv1   g173(.a(x68), .O(new_n325_));
  nand4  g174(.a(new_n228_), .b(x79), .c(new_n161_), .d(x77), .O(new_n326_));
  nor3   g175(.a(new_n326_), .b(new_n325_), .c(x01), .O(z48));
  nand3  g176(.a(new_n228_), .b(new_n161_), .c(x77), .O(new_n328_));
  inv1   g177(.a(new_n328_), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(x69), .O(new_n330_));
  aoi21  g179(.a(new_n330_), .b(x79), .c(x01), .O(z49));
  nand2  g180(.a(new_n329_), .b(x70), .O(new_n332_));
  aoi21  g181(.a(new_n332_), .b(x79), .c(x01), .O(z50));
  inv1   g182(.a(x71), .O(new_n334_));
  nor3   g183(.a(new_n326_), .b(new_n334_), .c(x01), .O(z51));
  inv1   g184(.a(x72), .O(new_n336_));
  nor3   g185(.a(new_n326_), .b(new_n336_), .c(x01), .O(z52));
  inv1   g186(.a(x73), .O(new_n338_));
  nor3   g187(.a(new_n326_), .b(new_n338_), .c(x01), .O(z53));
  ...
  nor2   g192(.a(new_n344_), .b(new_n233_), .O(new_n345_));
  nand4  g193(.a(new_n345_), .b(new_n343_), .c(new_n342_), .d(new_n341_), .O(new_n346_));
  aoi21  g194(.a(new_n346_), .b(x79), .c(x01), .O(z55));
  nand2  g195(.a(new_n159_), .b(x76), .O(new_n348_));
  xnor2a g196(.a(x84), .b(x81), .O(new_n349_));
  and2   g197(.a(new_n167_), .b(new_n166_), .O(new_n350_));
  or2    g198(.a(new_n350_), .b(new_n349_), .O(new_n351_));
  and2   g199(.a(new_n351_), .b(new_n162_), .O(new_n352_));
  nand4  g200(.a(new_n352_), .b(new_n348_), .c(new_n152_), .d(x00), .O(z56));
  inv1   g201(.a(x02), .O(new_n354_));
  nand4  g202(.a(x03), .b(new_n354_), .c(new_n152_), .d(x00), .O(new_n355_));
  nor2   g203(.a(new_n355_), .b(new_n153_), .O(z57));
  nand4  g204(.a(x80), .b(new_n231_), .c(x43), .d(new_n230_), .O(new_n357_));
  oai22  g205(.a(new_n357_), .b(new_n234_), .c(new_n230_), .d(x40), .O(new_n358_));
  nand4  g206(.a(new_n358_), .b(x79), .c(x78), .d(x77), .O(new_n359_));
  nor3   g207(.a(new_n359_), .b(new_n225_), .c(x01), .O(z58));
  oai21  g208(.a(new_n234_), .b(new_n232_), .c(x79), .O(new_n361_));
  ...
  nor2   g212(.a(new_n361_), .b(new_n161_), .O(new_n365_));
  nand4  g213(.a(new_n365_), .b(x77), .c(new_n230_), .d(x04), .O(new_n366_));
  nand3  g214(.a(new_n366_), .b(new_n351_), .c(x79), .O(new_n367_));
  and2   g215(.a(new_n367_), .b(new_n152_), .O(z60));
  oai22  g216(.a(new_n350_), .b(new_n227_), .c(new_n159_), .d(x04), .O(new_n369_));
  ...
  oai21  g224(.a(new_n236_), .b(new_n225_), .c(new_n376_), .O(new_n377_));
  nand3  g225(.a(new_n377_), .b(x79), .c(new_n152_), .O(new_n378_));
  inv1   g226(.a(new_n378_), .O(z62));
  nand2  g227(.a(new_n369_), .b(x82), .O(new_n380_));
  aoi21  g228(.a(new_n380_), .b(x79), .c(x01), .O(z63));
  nand4  g229(.a(new_n369_), .b(x83), .c(x79), .d(new_n152_), .O(new_n382_));
  inv1   g230(.a(new_n382_), .O(z64));
  oai21  g231(.a(new_n247_), .b(x78), .c(new_n372_), .O(new_n384_));
  ...
  nand4  g235(.a(new_n387_), .b(x84), .c(x79), .d(new_n152_), .O(new_n388_));
