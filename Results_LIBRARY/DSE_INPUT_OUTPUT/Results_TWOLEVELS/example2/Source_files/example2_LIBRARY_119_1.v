...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n314_, new_n315_, new_n316_, new_n318_;
  ...
  nand4  g081(.a(new_n159_), .b(new_n232_), .c(x05), .d(new_n229_), .O(new_n233_));
  ...
  nand2  g095(.a(new_n253_), .b(x09), .O(new_n259_));
  ...
  inv1   g104(.a(x11), .O(new_n268_));
  nand2  g105(.a(x52), .b(x19), .O(new_n269_));
  oai21  g106(.a(x52), .b(new_n268_), .c(new_n269_), .O(new_n270_));
  nand4  g107(.a(new_n270_), .b(new_n159_), .c(x78), .d(x04), .O(new_n271_));
  aoi21  g108(.a(new_n271_), .b(new_n158_), .c(x01), .O(z51));
  nand2  g109(.a(x52), .b(x20), .O(new_n273_));
  nand2  g110(.a(new_n253_), .b(x12), .O(new_n274_));
  aoi21  g111(.a(new_n274_), .b(new_n273_), .c(x79), .O(new_n275_));
  nand4  g112(.a(new_n275_), .b(x78), .c(new_n158_), .d(x04), .O(new_n276_));
  nor2   g113(.a(new_n276_), .b(x01), .O(z52));
  inv1   g114(.a(x13), .O(new_n278_));
  nand2  g115(.a(x52), .b(x21), .O(new_n279_));
  oai21  g116(.a(x52), .b(new_n278_), .c(new_n279_), .O(new_n280_));
  nand4  g117(.a(new_n280_), .b(new_n159_), .c(x78), .d(x04), .O(new_n281_));
  aoi21  g118(.a(new_n281_), .b(new_n158_), .c(x01), .O(z53));
  ...
  xor2a  g124(.a(x84), .b(x81), .O(new_n288_));
  nand2  g125(.a(new_n288_), .b(x79), .O(new_n289_));
  nand3  g126(.a(new_n289_), .b(x78), .c(new_n158_), .O(new_n290_));
  inv1   g127(.a(new_n290_), .O(new_n291_));
  nand2  g128(.a(x79), .b(x76), .O(new_n292_));
  nand4  g129(.a(new_n292_), .b(new_n291_), .c(new_n152_), .d(x00), .O(z56));
  inv1   g130(.a(x02), .O(new_n294_));
  nand4  g131(.a(x03), .b(new_n294_), .c(new_n152_), .d(x00), .O(new_n295_));
  nor2   g132(.a(new_n295_), .b(x77), .O(z57));
  or2    g133(.a(new_n162_), .b(x01), .O(new_n297_));
  inv1   g134(.a(new_n297_), .O(z58));
  nand4  g135(.a(new_n159_), .b(new_n158_), .c(new_n229_), .d(new_n152_), .O(new_n299_));
  inv1   g136(.a(new_n299_), .O(z59));
  aoi21  g137(.a(new_n289_), .b(new_n225_), .c(new_n160_), .O(new_n301_));
  ...
  nand4  g141(.a(new_n223_), .b(x80), .c(x79), .d(x78), .O(new_n305_));
  nor3   g142(.a(new_n305_), .b(x77), .c(x01), .O(z61));
  nand3  g143(.a(new_n159_), .b(new_n158_), .c(x04), .O(new_n307_));
  ...
  nand4  g148(.a(new_n223_), .b(x82), .c(x79), .d(x78), .O(new_n312_));
  nor3   g149(.a(new_n312_), .b(x77), .c(x01), .O(z63));
  nand3  g150(.a(new_n223_), .b(x83), .c(x79), .O(new_n314_));
  nand2  g151(.a(new_n314_), .b(new_n225_), .O(new_n315_));
  nand4  g152(.a(new_n315_), .b(x78), .c(new_n158_), .d(new_n152_), .O(new_n316_));
  inv1   g153(.a(new_n316_), .O(z64));
  nand4  g154(.a(x84), .b(x81), .c(x79), .d(x78), .O(new_n318_));
  aoi21  g155(.a(new_n318_), .b(new_n158_), .c(x01), .O(z65));
  zero   g156(.O(z26));
  zero   g157(.O(z27));
  zero   g158(.O(z28));
  zero   g159(.O(z29));
  ...
  zero   g166(.O(z45));
  zero   g167(.O(z46));
  nor2   g168(.a(new_n158_), .b(x01), .O(z30));
  ...
  nor2   g173(.a(new_n158_), .b(x01), .O(z38));
  nor2   g174(.a(new_n158_), .b(x01), .O(z40));
  nor2   g175(.a(new_n158_), .b(x01), .O(z41));
