// Benchmark "FAU" written by ABC on Thu Aug 20 02:46:39 2020
...
module FAU ( 
  ...
  nor2   g019(.a(new_n155_), .b(new_n165_), .O(new_n171_));
  aoi21  g020(.a(new_n171_), .b(x75), .c(x01), .O(new_n172_));
  inv1   g021(.a(x66), .O(new_n173_));
  nor2   g022(.a(new_n173_), .b(x01), .O(new_n174_));
  nand4  g023(.a(new_n174_), .b(x79), .c(new_n165_), .d(x77), .O(new_n175_));
  oai21  g024(.a(new_n172_), .b(x77), .c(new_n175_), .O(z02));
  nand4  g025(.a(new_n155_), .b(x78), .c(x52), .d(new_n153_), .O(new_n177_));
  inv1   g026(.a(new_n177_), .O(z03));
  nor2   g027(.a(x79), .b(new_n165_), .O(new_n179_));
  ...
  aoi21  g035(.a(new_n186_), .b(new_n185_), .c(new_n160_), .O(z06));
  ...
  aoi21  g062(.a(new_n213_), .b(new_n212_), .c(new_n160_), .O(z15));
  ...
  aoi21  g074(.a(new_n225_), .b(new_n224_), .c(new_n160_), .O(z19));
  nand2  g075(.a(new_n152_), .b(x38), .O(new_n227_));
  nand2  g076(.a(x45), .b(x40), .O(new_n228_));
  aoi21  g077(.a(new_n228_), .b(new_n227_), .c(new_n160_), .O(z20));
  ...
  oai22  g087(.a(new_n238_), .b(new_n173_), .c(new_n237_), .d(new_n236_), .O(new_n239_));
  nand4  g088(.a(new_n239_), .b(new_n235_), .c(x79), .d(new_n233_), .O(new_n240_));
  ...
  nand3  g097(.a(new_n155_), .b(x05), .c(new_n163_), .O(new_n249_));
  ...
  nand2  g102(.a(new_n253_), .b(new_n181_), .O(z24));
  ...
  nand4  g111(.a(new_n262_), .b(x05), .c(new_n163_), .d(new_n153_), .O(new_n263_));
  nand2  g112(.a(new_n263_), .b(new_n181_), .O(z25));
  inv1   g113(.a(x42), .O(new_n265_));
  inv1   g114(.a(new_n261_), .O(new_n266_));
  nand4  g115(.a(new_n266_), .b(x44), .c(new_n265_), .d(new_n163_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(x01), .O(z26));
  nand4  g117(.a(new_n266_), .b(x45), .c(new_n265_), .d(new_n163_), .O(new_n269_));
  nor2   g118(.a(new_n269_), .b(x01), .O(z27));
  nand4  g119(.a(new_n266_), .b(x46), .c(new_n265_), .d(new_n163_), .O(new_n271_));
  nor2   g120(.a(new_n271_), .b(x01), .O(z28));
  nand4  g121(.a(new_n266_), .b(x47), .c(new_n265_), .d(new_n163_), .O(new_n273_));
  nor2   g122(.a(new_n273_), .b(x01), .O(z29));
  inv1   g123(.a(x48), .O(new_n275_));
  nor2   g124(.a(new_n261_), .b(new_n275_), .O(new_n276_));
  nand4  g125(.a(new_n276_), .b(new_n265_), .c(new_n163_), .d(new_n153_), .O(new_n277_));
  nand2  g126(.a(new_n277_), .b(new_n181_), .O(z30));
  inv1   g127(.a(x49), .O(new_n279_));
  nor2   g128(.a(new_n261_), .b(new_n279_), .O(new_n280_));
  nand4  g129(.a(new_n280_), .b(new_n265_), .c(new_n163_), .d(new_n153_), .O(new_n281_));
  nand2  g130(.a(new_n281_), .b(new_n181_), .O(z31));
  inv1   g131(.a(x50), .O(new_n283_));
  nor2   g132(.a(new_n261_), .b(new_n283_), .O(new_n284_));
  nand4  g133(.a(new_n284_), .b(new_n265_), .c(new_n163_), .d(new_n153_), .O(new_n285_));
  nand2  g134(.a(new_n285_), .b(new_n181_), .O(z32));
  xor2a  g135(.a(x83), .b(x81), .O(new_n287_));
  nand3  g136(.a(new_n287_), .b(x42), .c(x05), .O(new_n288_));
  nand3  g137(.a(x81), .b(x51), .c(new_n265_), .O(new_n289_));
  ...
  nand3  g142(.a(new_n257_), .b(x51), .c(new_n265_), .O(new_n294_));
  ...
  nand4  g146(.a(new_n297_), .b(x78), .c(x77), .d(new_n163_), .O(new_n298_));
  oai21  g147(.a(new_n298_), .b(x01), .c(new_n181_), .O(z33));
  ...
  nor4   g159(.a(new_n310_), .b(new_n157_), .c(x04), .d(x01), .O(z34));
  inv1   g160(.a(new_n310_), .O(new_n312_));
  nand3  g161(.a(new_n312_), .b(x53), .c(new_n163_), .O(new_n313_));
  nor2   g162(.a(new_n313_), .b(x01), .O(z35));
  nand4  g163(.a(new_n312_), .b(x54), .c(new_n163_), .d(new_n153_), .O(new_n315_));
  nand2  g164(.a(new_n315_), .b(new_n181_), .O(z36));
  nand3  g165(.a(new_n312_), .b(x55), .c(new_n163_), .O(new_n317_));
  nor2   g166(.a(new_n317_), .b(x01), .O(z37));
  nand4  g167(.a(new_n312_), .b(x56), .c(new_n163_), .d(new_n153_), .O(new_n319_));
  nand2  g168(.a(new_n319_), .b(new_n181_), .O(z38));
  nand3  g169(.a(new_n312_), .b(x57), .c(new_n163_), .O(new_n321_));
  nor2   g170(.a(new_n321_), .b(x01), .O(z39));
  nand4  g171(.a(new_n312_), .b(x58), .c(new_n163_), .d(new_n153_), .O(new_n323_));
  nand2  g172(.a(new_n323_), .b(new_n181_), .O(z40));
  nand4  g173(.a(new_n312_), .b(x59), .c(new_n163_), .d(new_n153_), .O(new_n325_));
  nand2  g174(.a(new_n325_), .b(new_n181_), .O(z41));
  nand3  g175(.a(new_n312_), .b(x60), .c(new_n163_), .O(new_n327_));
  nor2   g176(.a(new_n327_), .b(x01), .O(z42));
  nand3  g177(.a(new_n312_), .b(x61), .c(new_n163_), .O(new_n329_));
  nor2   g178(.a(new_n329_), .b(x01), .O(z43));
  nand4  g179(.a(new_n312_), .b(x62), .c(new_n163_), .d(new_n153_), .O(new_n331_));
  nand2  g180(.a(new_n331_), .b(new_n181_), .O(z44));
  nand3  g181(.a(new_n312_), .b(x63), .c(new_n163_), .O(new_n333_));
  nor2   g182(.a(new_n333_), .b(x01), .O(z45));
  nand3  g183(.a(new_n312_), .b(x64), .c(new_n163_), .O(new_n335_));
  ...
  nand4  g188(.a(new_n339_), .b(new_n155_), .c(x78), .d(x04), .O(new_n340_));
  aoi21  g189(.a(new_n340_), .b(new_n153_), .c(x77), .O(new_n341_));
  inv1   g190(.a(x67), .O(new_n342_));
  nand2  g191(.a(new_n236_), .b(new_n342_), .O(new_n343_));
  nand4  g192(.a(new_n343_), .b(new_n235_), .c(x79), .d(new_n165_), .O(new_n344_));
  nor3   g193(.a(new_n344_), .b(new_n154_), .c(x01), .O(new_n345_));
  ...
  nand4  g198(.a(new_n349_), .b(x78), .c(new_n154_), .d(x04), .O(new_n350_));
  nand4  g199(.a(new_n235_), .b(x79), .c(new_n165_), .d(x77), .O(new_n351_));
  ...
  nand4  g242(.a(new_n393_), .b(new_n155_), .c(x78), .d(x04), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(new_n153_), .c(x77), .O(z54));
  nand4  g244(.a(new_n171_), .b(x77), .c(new_n163_), .d(new_n153_), .O(new_n396_));
  inv1   g245(.a(x82), .O(new_n397_));
  nor2   g246(.a(x81), .b(x80), .O(new_n398_));
  nand4  g247(.a(new_n398_), .b(x84), .c(x83), .d(new_n397_), .O(new_n399_));
  oai21  g248(.a(new_n399_), .b(new_n396_), .c(new_n181_), .O(z55));
  nand2  g249(.a(new_n251_), .b(x76), .O(new_n401_));
  xnor2a g250(.a(x84), .b(x81), .O(new_n402_));
  aoi21  g251(.a(new_n238_), .b(new_n237_), .c(new_n402_), .O(new_n403_));
  ...
  nand2  g255(.a(new_n165_), .b(new_n154_), .O(new_n407_));
  nand4  g256(.a(new_n407_), .b(new_n406_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g257(.a(x02), .O(new_n409_));
  nand4  g258(.a(x03), .b(new_n409_), .c(new_n153_), .d(x00), .O(new_n410_));
  inv1   g259(.a(new_n410_), .O(z57));
  nand4  g260(.a(x80), .b(new_n241_), .c(x43), .d(new_n265_), .O(new_n412_));
  oai22  g261(.a(new_n412_), .b(new_n244_), .c(new_n265_), .d(x40), .O(new_n413_));
  nand4  g262(.a(new_n413_), .b(x79), .c(x78), .d(x04), .O(new_n414_));
  nor2   g263(.a(x79), .b(x78), .O(new_n415_));
  nand3  g264(.a(new_n415_), .b(new_n265_), .c(x40), .O(new_n416_));
  nand2  g265(.a(new_n416_), .b(new_n414_), .O(new_n417_));
  nand2  g266(.a(new_n417_), .b(x77), .O(new_n418_));
  nand2  g267(.a(new_n237_), .b(x04), .O(new_n419_));
  nand2  g268(.a(new_n419_), .b(new_n155_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n418_), .c(x01), .O(z58));
  oai21  g270(.a(new_n166_), .b(new_n415_), .c(x40), .O(new_n422_));
  oai21  g271(.a(new_n244_), .b(new_n242_), .c(new_n265_), .O(new_n423_));
  ...
  nand2  g276(.a(new_n155_), .b(new_n163_), .O(new_n428_));
  aoi21  g277(.a(new_n428_), .b(new_n427_), .c(x01), .O(z59));
  nand2  g278(.a(new_n403_), .b(x79), .O(new_n430_));
  nand3  g279(.a(new_n430_), .b(new_n428_), .c(new_n247_), .O(new_n431_));
  ...
  oai21  g283(.a(new_n251_), .b(x04), .c(new_n434_), .O(new_n435_));
  nand4  g284(.a(new_n435_), .b(x80), .c(x79), .d(new_n153_), .O(new_n436_));
  inv1   g285(.a(new_n436_), .O(z61));
  nand2  g286(.a(x78), .b(new_n163_), .O(new_n438_));
  nand2  g287(.a(x84), .b(new_n165_), .O(new_n439_));
  nand2  g288(.a(new_n439_), .b(new_n438_), .O(new_n440_));
  nand3  g289(.a(new_n440_), .b(x81), .c(x79), .O(new_n441_));
  aoi21  g290(.a(new_n441_), .b(new_n425_), .c(new_n154_), .O(new_n442_));
  nand4  g291(.a(new_n155_), .b(x78), .c(new_n154_), .d(x04), .O(new_n443_));
  inv1   g292(.a(new_n443_), .O(new_n444_));
  oai21  g293(.a(new_n444_), .b(new_n442_), .c(new_n153_), .O(new_n445_));
  nand3  g294(.a(new_n171_), .b(x84), .c(x81), .O(new_n446_));
  nand2  g295(.a(new_n446_), .b(new_n153_), .O(new_n447_));
  nand2  g296(.a(new_n447_), .b(new_n154_), .O(new_n448_));
  nand2  g297(.a(new_n448_), .b(new_n445_), .O(z62));
  nand4  g298(.a(new_n435_), .b(x82), .c(x79), .d(new_n153_), .O(new_n450_));
  inv1   g299(.a(new_n450_), .O(z63));
  nand3  g300(.a(new_n435_), .b(x83), .c(x79), .O(new_n452_));
  aoi21  g301(.a(new_n452_), .b(new_n443_), .c(x01), .O(z64));
  oai21  g302(.a(new_n257_), .b(x78), .c(new_n438_), .O(new_n454_));
  nand3  g303(.a(new_n454_), .b(x77), .c(new_n153_), .O(new_n455_));
  nand3  g304(.a(x81), .b(x78), .c(new_n154_), .O(new_n456_));
  nand2  g305(.a(new_n456_), .b(new_n455_), .O(new_n457_));
  nand3  g306(.a(new_n457_), .b(x84), .c(x79), .O(new_n458_));
  nand2  g307(.a(new_n458_), .b(new_n181_), .O(z65));
endmodule
