...
module FAU ( 
  ...
  nand3  g053(.a(new_n42_), .b(x6), .c(new_n23_), .O(new_n68_));
  oai21  g054(.a(x6), .b(new_n23_), .c(new_n68_), .O(new_n69_));
  nand3  g055(.a(new_n69_), .b(x4), .c(x1), .O(new_n70_));
  nand3  g056(.a(new_n70_), .b(new_n67_), .c(new_n62_), .O(new_n71_));
  nand2  g057(.a(new_n71_), .b(x7), .O(new_n72_));
  inv1   g058(.a(x7), .O(new_n73_));
  inv1   g059(.a(x0), .O(new_n74_));
  nand3  g060(.a(new_n41_), .b(x5), .c(new_n74_), .O(new_n75_));
  oai22  g061(.a(new_n63_), .b(new_n16_), .c(new_n19_), .d(new_n18_), .O(new_n76_));
  nand4  g062(.a(new_n76_), .b(new_n75_), .c(new_n73_), .d(x6), .O(new_n77_));
  nand2  g063(.a(new_n77_), .b(new_n72_), .O(z1));
  nand2  g064(.a(x6), .b(new_n27_), .O(new_n79_));
  aoi22  g065(.a(new_n79_), .b(new_n74_), .c(x7), .d(new_n18_), .O(new_n80_));
  nand3  g066(.a(new_n80_), .b(x8), .c(x1), .O(new_n81_));
  oai21  g067(.a(new_n27_), .b(x0), .c(x7), .O(new_n82_));
  nand2  g068(.a(new_n82_), .b(x6), .O(new_n83_));
  nand3  g069(.a(new_n83_), .b(new_n24_), .c(new_n18_), .O(new_n84_));
  aoi21  g070(.a(new_n84_), .b(new_n81_), .c(new_n15_), .O(new_n85_));
  nand3  g071(.a(new_n80_), .b(new_n24_), .c(x1), .O(new_n86_));
  nand3  g072(.a(x8), .b(x7), .c(new_n18_), .O(new_n87_));
  aoi21  g073(.a(new_n87_), .b(new_n86_), .c(x3), .O(new_n88_));
  oai21  g074(.a(new_n88_), .b(new_n85_), .c(new_n23_), .O(new_n89_));
  nand2  g075(.a(x8), .b(x3), .O(new_n90_));
  nand2  g076(.a(new_n90_), .b(new_n28_), .O(new_n91_));
  oai21  g077(.a(new_n27_), .b(x0), .c(new_n73_), .O(new_n92_));
  aoi21  g078(.a(new_n92_), .b(x6), .c(new_n18_), .O(new_n93_));
  nand3  g079(.a(new_n33_), .b(x2), .c(x1), .O(new_n94_));
  inv1   g080(.a(new_n94_), .O(new_n95_));
  oai21  g081(.a(new_n95_), .b(new_n93_), .c(new_n91_), .O(new_n96_));
  nand2  g082(.a(x5), .b(new_n74_), .O(new_n97_));
  nand3  g083(.a(new_n97_), .b(new_n24_), .c(x3), .O(new_n98_));
  nand2  g084(.a(new_n98_), .b(new_n41_), .O(new_n99_));
  nand3  g085(.a(new_n99_), .b(new_n40_), .c(x6), .O(new_n100_));
  inv1   g086(.a(new_n100_), .O(new_n101_));
  nand2  g087(.a(new_n63_), .b(new_n28_), .O(new_n102_));
  nand2  g088(.a(new_n90_), .b(new_n102_), .O(new_n103_));
  nand3  g089(.a(new_n103_), .b(new_n27_), .c(x0), .O(new_n104_));
  nand4  g090(.a(new_n24_), .b(new_n18_), .c(x3), .d(new_n16_), .O(new_n105_));
  aoi21  g091(.a(new_n105_), .b(new_n104_), .c(x6), .O(new_n106_));
  oai21  g092(.a(new_n106_), .b(new_n101_), .c(x7), .O(new_n107_));
  nand2  g093(.a(new_n56_), .b(x0), .O(new_n108_));
  oai21  g094(.a(x7), .b(new_n23_), .c(x1), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(new_n27_), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g097(.a(new_n111_), .b(new_n24_), .c(x3), .O(new_n112_));
  nand3  g098(.a(new_n109_), .b(x8), .c(new_n15_), .O(new_n113_));
  nand2  g099(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nor2   g100(.a(x7), .b(x6), .O(new_n115_));
  aoi21  g101(.a(new_n114_), .b(new_n18_), .c(new_n115_), .O(new_n116_));
  nand4  g102(.a(new_n116_), .b(new_n107_), .c(new_n96_), .d(new_n89_), .O(z2));
  ...
  inv1   g109(.a(new_n91_), .O(new_n124_));
  ...
  oai21  g126(.a(new_n140_), .b(new_n74_), .c(new_n139_), .O(new_n141_));
  ...
  nand4  g143(.a(new_n128_), .b(x6), .c(new_n27_), .d(new_n74_), .O(new_n158_));
