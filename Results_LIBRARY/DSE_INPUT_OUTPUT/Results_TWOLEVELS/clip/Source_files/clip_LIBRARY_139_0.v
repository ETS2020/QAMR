...
module FAU ( 
  ...
  nand3  g036(.a(new_n24_), .b(x5), .c(new_n16_), .O(new_n51_));
  nand2  g037(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g038(.a(new_n52_), .b(x0), .O(new_n53_));
  oai21  g039(.a(new_n27_), .b(x1), .c(new_n50_), .O(new_n54_));
  nand2  g040(.a(new_n54_), .b(new_n15_), .O(new_n55_));
  nand2  g041(.a(new_n50_), .b(x1), .O(new_n56_));
  ...
  nand4  g046(.a(new_n60_), .b(new_n57_), .c(new_n55_), .d(new_n53_), .O(new_n61_));
  nand2  g047(.a(new_n61_), .b(new_n18_), .O(new_n62_));
  nor2   g048(.a(x4), .b(x2), .O(new_n63_));
  inv1   g049(.a(new_n63_), .O(new_n64_));
  nand4  g050(.a(new_n64_), .b(new_n28_), .c(new_n33_), .d(new_n27_), .O(new_n65_));
  nand3  g051(.a(new_n19_), .b(x6), .c(x4), .O(new_n66_));
  nand2  g052(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g053(.a(new_n67_), .b(x0), .O(new_n68_));
  nand3  g054(.a(new_n42_), .b(x6), .c(new_n23_), .O(new_n69_));
  nand2  g055(.a(new_n33_), .b(x2), .O(new_n70_));
  nand2  g056(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g057(.a(new_n71_), .b(x4), .c(x1), .O(new_n72_));
  nand3  g058(.a(new_n72_), .b(new_n68_), .c(new_n62_), .O(new_n73_));
  nand2  g059(.a(new_n73_), .b(x7), .O(new_n74_));
  inv1   g060(.a(x7), .O(new_n75_));
  inv1   g061(.a(x0), .O(new_n76_));
  nand3  g062(.a(new_n41_), .b(x5), .c(new_n76_), .O(new_n77_));
  oai22  g063(.a(new_n64_), .b(new_n16_), .c(new_n19_), .d(new_n18_), .O(new_n78_));
  nand4  g064(.a(new_n78_), .b(new_n77_), .c(new_n75_), .d(x6), .O(new_n79_));
  nand2  g065(.a(new_n79_), .b(new_n74_), .O(z1));
  nand3  g066(.a(x4), .b(new_n23_), .c(x0), .O(new_n81_));
  nand2  g067(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  nand2  g068(.a(new_n82_), .b(x1), .O(new_n83_));
  nand2  g069(.a(new_n33_), .b(x4), .O(new_n84_));
  aoi21  g070(.a(new_n84_), .b(new_n83_), .c(new_n75_), .O(new_n85_));
  nand2  g071(.a(new_n40_), .b(new_n18_), .O(new_n86_));
  nand2  g072(.a(x5), .b(new_n76_), .O(new_n87_));
  nand3  g073(.a(new_n87_), .b(new_n86_), .c(new_n75_), .O(new_n88_));
  ...
  nor2   g080(.a(x8), .b(x3), .O(new_n95_));
  oai21  g081(.a(new_n63_), .b(new_n95_), .c(new_n92_), .O(new_n96_));
  ...
  aoi21  g086(.a(new_n100_), .b(new_n97_), .c(new_n76_), .O(new_n101_));
  nand3  g087(.a(new_n24_), .b(new_n27_), .c(x3), .O(new_n102_));
  nand2  g088(.a(new_n102_), .b(new_n41_), .O(new_n103_));
  oai21  g089(.a(new_n19_), .b(new_n33_), .c(new_n64_), .O(new_n104_));
  ...
  nand2  g098(.a(x5), .b(new_n76_), .O(new_n113_));
  ...
  nand3  g114(.a(new_n128_), .b(new_n27_), .c(new_n76_), .O(new_n129_));
  nand2  g115(.a(new_n129_), .b(new_n123_), .O(new_n130_));
  nand2  g116(.a(new_n130_), .b(x6), .O(new_n131_));
  nand3  g117(.a(new_n64_), .b(new_n27_), .c(x0), .O(new_n132_));
  aoi21  g118(.a(x2), .b(x1), .c(x4), .O(new_n133_));
  inv1   g119(.a(new_n133_), .O(new_n134_));
  nand2  g120(.a(new_n134_), .b(new_n76_), .O(new_n135_));
  aoi21  g121(.a(new_n135_), .b(new_n132_), .c(new_n95_), .O(new_n136_));
  nand2  g122(.a(x5), .b(x0), .O(new_n137_));
  nand3  g123(.a(new_n137_), .b(x8), .c(x3), .O(new_n138_));
  oai21  g124(.a(new_n133_), .b(new_n15_), .c(new_n24_), .O(new_n139_));
  oai21  g125(.a(new_n139_), .b(new_n76_), .c(new_n138_), .O(new_n140_));
  oai21  g126(.a(new_n140_), .b(new_n136_), .c(new_n33_), .O(new_n141_));
  nand2  g127(.a(new_n35_), .b(new_n16_), .O(new_n142_));
  nand2  g128(.a(new_n24_), .b(x2), .O(new_n143_));
  nand3  g129(.a(new_n143_), .b(new_n142_), .c(new_n64_), .O(new_n144_));
  ...
  nand2  g133(.a(new_n147_), .b(new_n131_), .O(z3));
  oai21  g134(.a(new_n15_), .b(x2), .c(x1), .O(new_n149_));
  nand3  g135(.a(new_n149_), .b(new_n24_), .c(x0), .O(new_n150_));
  oai21  g136(.a(new_n23_), .b(new_n16_), .c(new_n15_), .O(new_n151_));
  aoi21  g137(.a(new_n151_), .b(new_n150_), .c(x4), .O(new_n152_));
  nand2  g138(.a(new_n28_), .b(x0), .O(new_n153_));
  oai21  g139(.a(new_n153_), .b(new_n152_), .c(x7), .O(new_n154_));
  nand2  g140(.a(new_n154_), .b(new_n33_), .O(new_n155_));
  nand2  g141(.a(new_n155_), .b(x5), .O(new_n156_));
  nand4  g142(.a(new_n128_), .b(x6), .c(new_n27_), .d(new_n76_), .O(new_n157_));
