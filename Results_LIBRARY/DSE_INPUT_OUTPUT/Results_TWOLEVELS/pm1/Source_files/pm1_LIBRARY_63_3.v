...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n47_, new_n52_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
  ...
  nand2  g19(.a(new_n36_), .b(x14), .O(z04));
  inv1   g20(.a(x15), .O(z07));
  nand2  g21(.a(z07), .b(x13), .O(z05));
  ...
  nand2  g25(.a(new_n54_), .b(new_n36_), .O(z06));
  ...
  aoi21  g33(.a(new_n62_), .b(new_n57_), .c(new_n39_), .O(z08));
  ...
  nand2  g37(.a(new_n38_), .b(new_n34_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n36_), .c(new_n59_), .d(x00), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z09));
  nand4  g41(.a(new_n64_), .b(new_n36_), .c(x12), .d(x11), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n59_), .c(x09), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z10));
  nand4  g45(.a(new_n64_), .b(x12), .c(x09), .d(x01), .O(new_n75_));
  oai21  g46(.a(x12), .b(x01), .c(new_n75_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(x11), .c(new_n59_), .d(x00), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n36_), .O(z11));
  nand3  g49(.a(new_n40_), .b(x11), .c(new_n59_), .O(new_n79_));
  nor3   g50(.a(new_n79_), .b(x09), .c(new_n56_), .O(z12));
endmodule
