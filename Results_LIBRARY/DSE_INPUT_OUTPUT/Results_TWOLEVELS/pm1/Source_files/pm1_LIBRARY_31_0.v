...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n37_,
    new_n39_, new_n40_, new_n41_, new_n43_, new_n44_, new_n47_, new_n48_,
  ...
  nor3   g11(.a(new_n40_), .b(new_n31_), .c(new_n39_), .O(new_n41_));
  ...
  nor2   g16(.a(x14), .b(new_n32_), .O(z04));
  ...
  nor3   g42(.a(new_n71_), .b(new_n39_), .c(new_n63_), .O(z10));
  ...
  nand2  g49(.a(new_n39_), .b(x00), .O(new_n79_));
  nand3  g50(.a(x12), .b(x11), .c(new_n57_), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(new_n48_), .O(z12));
endmodule
