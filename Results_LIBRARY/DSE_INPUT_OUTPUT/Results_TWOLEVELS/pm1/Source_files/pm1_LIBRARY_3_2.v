...
module FAU ( 
  ...
  oai21  g21(.a(x13), .b(new_n32_), .c(x14), .O(z04));
  nor2   g22(.a(x13), .b(x12), .O(z05));
  nor2   g23(.a(x13), .b(new_n32_), .O(new_n53_));
  ...
  nand4  g52(.a(x11), .b(new_n61_), .c(new_n40_), .d(x00), .O(new_n82_));
  nor3   g53(.a(new_n82_), .b(new_n45_), .c(new_n32_), .O(z12));
endmodule
