...
module FAU ( 
  ...
  nand4  g19(.a(new_n48_), .b(new_n44_), .c(x09), .d(x01), .O(new_n49_));
  ...
  nand4  g26(.a(x12), .b(new_n53_), .c(x09), .d(x04), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(new_n55_), .c(new_n53_), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n52_), .c(x11), .O(new_n58_));
  inv1   g29(.a(x12), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n43_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n58_), .O(z08));
  nand4  g32(.a(new_n54_), .b(new_n48_), .c(x09), .d(x04), .O(new_n62_));
