...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(z05), .O(new_n37_));
  ...
  nand2  g12(.a(new_n41_), .b(new_n33_), .O(z01));
  nand2  g13(.a(x08), .b(x07), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(new_n31_), .c(x11), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n41_), .c(new_n35_), .d(x09), .O(z02));
  inv1   g16(.a(x09), .O(new_n46_));
  nor2   g17(.a(new_n39_), .b(new_n46_), .O(new_n47_));
  nand3  g18(.a(x11), .b(x08), .c(x07), .O(new_n48_));
  or2    g19(.a(new_n48_), .b(new_n31_), .O(new_n49_));
  nand4  g20(.a(new_n49_), .b(new_n47_), .c(new_n37_), .d(new_n35_), .O(z03));
  nand2  g21(.a(new_n37_), .b(x14), .O(z04));
  ...
  aoi21  g34(.a(new_n63_), .b(new_n58_), .c(new_n40_), .O(z08));
  ...
  nand4  g50(.a(new_n41_), .b(x11), .c(new_n60_), .d(new_n46_), .O(new_n80_));
