...
module FAU ( 
  ...
  nor2   g24(.a(x15), .b(new_n32_), .O(z07));
  ...
  nand2  g42(.a(new_n71_), .b(new_n47_), .O(z10));
  nand4  g43(.a(new_n56_), .b(x12), .c(x09), .d(x01), .O(new_n73_));
  nand3  g44(.a(x15), .b(new_n32_), .c(new_n30_), .O(new_n74_));
  ...
  nand4  g49(.a(x11), .b(new_n55_), .c(new_n78_), .d(x00), .O(new_n79_));
