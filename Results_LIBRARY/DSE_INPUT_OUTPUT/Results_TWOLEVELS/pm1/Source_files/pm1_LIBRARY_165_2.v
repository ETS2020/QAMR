...
module FAU ( 
  ...
  nor2   g29(.a(new_n37_), .b(x10), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n58_), .c(new_n52_), .d(x00), .O(new_n60_));
  ...
  nand4  g41(.a(new_n65_), .b(x12), .c(x11), .d(new_n64_), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n40_), .c(new_n61_), .O(z10));
  nand3  g43(.a(new_n65_), .b(new_n64_), .c(x09), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(x01), .c(x00), .O(new_n75_));
  aoi21  g46(.a(new_n75_), .b(x12), .c(new_n30_), .O(z11));
  nand4  g47(.a(x11), .b(new_n64_), .c(new_n40_), .d(x00), .O(new_n77_));
  nor2   g48(.a(new_n77_), .b(new_n37_), .O(z12));
endmodule
