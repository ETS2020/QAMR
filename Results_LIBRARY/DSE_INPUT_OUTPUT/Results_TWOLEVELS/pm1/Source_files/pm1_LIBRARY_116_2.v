...
module FAU ( 
  ...
  aoi21  g35(.a(new_n64_), .b(x09), .c(new_n38_), .O(new_n65_));
  nand3  g36(.a(x04), .b(x03), .c(x02), .O(new_n66_));
  and2   g37(.a(new_n66_), .b(x09), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n65_), .c(x11), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(x12), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n58_), .c(x00), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n48_), .O(z09));
  nand4  g42(.a(new_n66_), .b(new_n58_), .c(x09), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x12), .c(new_n30_), .O(z10));
  nand4  g44(.a(new_n66_), .b(x12), .c(x11), .d(new_n58_), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x09), .c(x01), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand4  g48(.a(x11), .b(new_n58_), .c(new_n39_), .d(x00), .O(new_n78_));
