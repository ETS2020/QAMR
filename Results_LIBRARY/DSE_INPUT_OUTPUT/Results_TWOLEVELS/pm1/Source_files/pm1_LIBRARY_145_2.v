...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n35_, new_n37_, new_n38_, new_n39_,
    new_n40_, new_n41_, new_n43_, new_n47_, new_n48_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    new_n60_, new_n61_, new_n62_, new_n63_, new_n64_, new_n65_, new_n66_,
    new_n68_, new_n69_, new_n70_, new_n72_, new_n73_, new_n74_, new_n75_,
    new_n77_;
  inv1   g00(.a(x15), .O(z07));
  nand2  g01(.a(z07), .b(x13), .O(new_n31_));
  ...
  nand2  g21(.a(new_n38_), .b(new_n35_), .O(new_n51_));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  nand3  g24(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  nand2  g25(.a(new_n37_), .b(new_n35_), .O(new_n55_));
  ...
  nand4  g38(.a(new_n53_), .b(new_n31_), .c(x12), .d(x11), .O(new_n68_));
  ...
  nand4  g43(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n73_));
  oai21  g44(.a(x12), .b(x01), .c(new_n73_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(new_n31_), .c(x11), .d(new_n52_), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n72_), .O(z11));
  nand3  g47(.a(new_n38_), .b(x11), .c(new_n52_), .O(new_n77_));
  nor3   g48(.a(new_n77_), .b(x09), .c(new_n72_), .O(z12));
endmodule
