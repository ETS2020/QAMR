...
module FAU ( 
  ...
  nand4  g24(.a(x12), .b(new_n51_), .c(x09), .d(x04), .O(new_n54_));
  oai21  g25(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(new_n55_));
  oai21  g26(.a(new_n55_), .b(new_n50_), .c(x11), .O(new_n56_));
  inv1   g27(.a(x11), .O(new_n57_));
  nand2  g28(.a(new_n33_), .b(new_n57_), .O(new_n58_));
  ...
  nand3  g35(.a(new_n46_), .b(x11), .c(new_n51_), .O(new_n65_));
