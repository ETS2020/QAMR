...
module FAU ( 
  ...
  aoi21  g15(.a(new_n38_), .b(new_n44_), .c(x14), .O(z04));
  nand2  g16(.a(new_n38_), .b(new_n44_), .O(new_n46_));
  ...
  nand4  g29(.a(new_n58_), .b(new_n54_), .c(new_n46_), .d(x00), .O(z08));
  ...
  nand4  g39(.a(new_n64_), .b(x12), .c(x11), .d(new_n55_), .O(new_n69_));
  ...
  nand2  g43(.a(new_n72_), .b(new_n46_), .O(z11));
