...
module FAU ( 
  ...
  nor2   g17(.a(x14), .b(new_n30_), .O(z04));
  inv1   g18(.a(x14), .O(new_n48_));
  aoi21  g19(.a(new_n48_), .b(new_n30_), .c(x13), .O(z05));
  nand2  g20(.a(new_n48_), .b(new_n30_), .O(new_n50_));
  ...
  nand3  g30(.a(x14), .b(new_n30_), .c(new_n32_), .O(new_n60_));
  ...
  oai21  g46(.a(new_n42_), .b(x01), .c(new_n75_), .O(new_n76_));
