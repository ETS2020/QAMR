...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n40_, new_n41_, new_n42_, new_n43_,
  ...
  oai21  g07(.a(z01), .b(new_n32_), .c(x13), .O(z05));
  nand3  g08(.a(x04), .b(x03), .c(x02), .O(new_n40_));
  nand2  g09(.a(new_n40_), .b(z01), .O(new_n41_));
  nand2  g10(.a(new_n41_), .b(new_n33_), .O(new_n42_));
  ...
  nand4  g16(.a(z01), .b(new_n32_), .c(new_n46_), .d(x00), .O(new_n48_));
  inv1   g17(.a(new_n48_), .O(z09));
  inv1   g18(.a(x01), .O(new_n50_));
  nand3  g19(.a(new_n46_), .b(new_n50_), .c(x00), .O(new_n51_));
  aoi21  g20(.a(new_n51_), .b(z01), .c(new_n32_), .O(z11));
  one    g21(.O(z02));
  one    g22(.O(z03));
  nor2   g23(.a(z01), .b(new_n32_), .O(z12));
endmodule
