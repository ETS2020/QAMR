...
module FAU ( 
  ...
  nand2  g07(.a(x13), .b(new_n32_), .O(new_n37_));
  ...
  oai21  g16(.a(x13), .b(x12), .c(x14), .O(z04));
  nor2   g17(.a(x13), .b(new_n32_), .O(z05));
  nor2   g18(.a(x13), .b(x12), .O(new_n48_));
  nand2  g19(.a(x12), .b(new_n31_), .O(new_n49_));
  nand3  g20(.a(x04), .b(x03), .c(x02), .O(new_n50_));
  inv1   g21(.a(new_n50_), .O(new_n51_));
  oai21  g22(.a(new_n51_), .b(new_n48_), .c(new_n49_), .O(new_n52_));
  ...
  nor3   g41(.a(new_n70_), .b(new_n39_), .c(new_n69_), .O(z10));
  nand4  g42(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  oai21  g43(.a(new_n37_), .b(x01), .c(new_n72_), .O(new_n73_));
