...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n49_, new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n58_,
  ...
  nor3   g12(.a(new_n41_), .b(new_n33_), .c(new_n40_), .O(new_n42_));
  nand2  g13(.a(z07), .b(new_n30_), .O(new_n43_));
  ...
  nor2   g19(.a(z07), .b(x12), .O(new_n49_));
  nor2   g20(.a(new_n49_), .b(x14), .O(z04));
  nor2   g21(.a(new_n49_), .b(x13), .O(z05));
  inv1   g22(.a(new_n49_), .O(new_n52_));
  and2   g23(.a(x03), .b(x02), .O(new_n53_));
  nand2  g24(.a(x12), .b(new_n33_), .O(new_n54_));
  ...
  oai22  g31(.a(new_n60_), .b(new_n59_), .c(new_n43_), .d(x11), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n58_), .c(x00), .O(new_n62_));
  nand2  g33(.a(new_n58_), .b(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n62_), .c(new_n54_), .O(z08));
  inv1   g36(.a(x00), .O(new_n66_));
  oai21  g37(.a(new_n63_), .b(x11), .c(z07), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nand4  g39(.a(new_n59_), .b(new_n53_), .c(x09), .d(x04), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x12), .c(x11), .d(new_n58_), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n66_), .c(new_n68_), .O(z09));
  nand4  g42(.a(new_n59_), .b(x12), .c(x11), .d(new_n58_), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(new_n40_), .c(new_n66_), .O(z10));
  nand4  g44(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  inv1   g45(.a(x01), .O(new_n75_));
  nand3  g46(.a(z07), .b(new_n30_), .c(new_n75_), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x11), .c(new_n58_), .d(x00), .O(new_n78_));
  inv1   g49(.a(new_n78_), .O(z11));
  nand2  g50(.a(new_n40_), .b(x00), .O(new_n80_));
  nand3  g51(.a(x12), .b(x11), .c(new_n58_), .O(new_n81_));
  oai21  g52(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(z12));
endmodule
