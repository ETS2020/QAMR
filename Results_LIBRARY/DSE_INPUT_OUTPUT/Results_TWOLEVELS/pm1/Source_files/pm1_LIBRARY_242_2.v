...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    new_n38_, new_n40_, new_n41_, new_n42_, new_n44_, new_n46_, new_n48_,
  ...
  nand4  g40(.a(new_n63_), .b(x12), .c(x11), .d(new_n57_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n69_), .c(new_n56_), .O(z10));
  inv1   g42(.a(new_n70_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(x09), .c(x01), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z11));
  nand4  g45(.a(x12), .b(new_n57_), .c(new_n69_), .d(x00), .O(new_n75_));
