...
module FAU ( 
  ...
  nand3  g13(.a(new_n42_), .b(x12), .c(x09), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x11), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(new_n40_), .O(z03));
  nor2   g16(.a(x12), .b(x11), .O(new_n46_));
  ...
  nand2  g21(.a(new_n50_), .b(new_n40_), .O(new_n51_));
  ...
  nand4  g31(.a(new_n60_), .b(new_n58_), .c(new_n56_), .d(x09), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x11), .c(new_n56_), .d(x00), .O(z08));
  inv1   g33(.a(x00), .O(new_n63_));
  and2   g34(.a(x03), .b(x02), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n49_), .c(x09), .d(x04), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(x11), .d(new_n56_), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n63_), .c(new_n54_), .O(z09));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(new_n49_), .b(x12), .c(x11), .d(new_n56_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n68_), .c(new_n63_), .O(z10));
  nand4  g41(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n71_));
  inv1   g42(.a(x01), .O(new_n72_));
  nand2  g43(.a(new_n59_), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g47(.a(x11), .b(new_n56_), .c(new_n68_), .d(x00), .O(new_n77_));
  nor2   g48(.a(new_n77_), .b(new_n59_), .O(z12));
endmodule
