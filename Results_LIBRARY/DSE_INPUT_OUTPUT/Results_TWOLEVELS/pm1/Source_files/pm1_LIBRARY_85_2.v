...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    ...
    new_n48_, new_n52_, new_n53_, new_n55_, new_n56_, new_n57_, new_n58_,
  ...
  nand2  g21(.a(new_n37_), .b(x13), .O(z05));
  nand4  g22(.a(new_n35_), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  nand3  g23(.a(new_n52_), .b(x09), .c(x01), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n37_), .O(z06));
  inv1   g25(.a(x10), .O(new_n55_));
  nand4  g26(.a(new_n37_), .b(new_n39_), .c(new_n55_), .d(x00), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n39_), .O(new_n57_));
  ...
  oai21  g32(.a(new_n61_), .b(new_n60_), .c(new_n37_), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n58_), .O(z08));
  xnor2a g35(.a(x12), .b(x11), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(new_n37_), .c(new_n55_), .d(x00), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(z09));
  nand3  g38(.a(x04), .b(x03), .c(x02), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n37_), .c(x12), .d(x11), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n55_), .c(x09), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z10));
  inv1   g43(.a(x00), .O(new_n73_));
  nand4  g44(.a(new_n68_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  nand2  g45(.a(new_n39_), .b(new_n30_), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(new_n37_), .c(x11), .d(new_n55_), .O(new_n77_));
  nor2   g48(.a(new_n77_), .b(new_n73_), .O(z11));
  nand4  g49(.a(new_n40_), .b(x11), .c(new_n55_), .d(new_n45_), .O(new_n79_));
  nor2   g50(.a(new_n79_), .b(new_n73_), .O(z12));
endmodule
