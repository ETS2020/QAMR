...
module FAU ( 
  ...
  nand2  g15(.a(new_n37_), .b(x11), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(x14), .O(z04));
  aoi21  g17(.a(new_n37_), .b(x11), .c(x13), .O(z05));
  nand3  g18(.a(x04), .b(x03), .c(x02), .O(new_n48_));
  oai21  g19(.a(x12), .b(new_n30_), .c(new_n48_), .O(new_n49_));
  ...
  nor2   g26(.a(x10), .b(new_n38_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n55_), .c(x04), .d(x00), .O(new_n57_));
  ...
  nand4  g33(.a(new_n55_), .b(new_n48_), .c(x09), .d(x04), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(x11), .c(new_n62_), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n61_), .O(z09));
  nand4  g36(.a(new_n48_), .b(new_n62_), .c(x09), .d(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n30_), .O(z10));
  nand4  g38(.a(new_n48_), .b(x12), .c(x11), .d(new_n62_), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x09), .c(x01), .d(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z11));
  nand3  g42(.a(new_n62_), .b(new_n38_), .c(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x12), .c(new_n30_), .O(z12));
endmodule
