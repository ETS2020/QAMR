...
module FAU ( 
  ...
  nor2   g22(.a(new_n51_), .b(new_n45_), .O(new_n52_));
  aoi21  g23(.a(new_n50_), .b(new_n41_), .c(new_n52_), .O(new_n53_));
  nand4  g24(.a(new_n53_), .b(new_n42_), .c(new_n49_), .d(x00), .O(z08));
  nand2  g25(.a(new_n50_), .b(new_n41_), .O(new_n55_));
  and2   g26(.a(x03), .b(x02), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n45_), .c(x09), .d(x04), .O(new_n57_));
  ...
  nand3  g32(.a(new_n45_), .b(x11), .c(new_n49_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x09), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x11), .c(new_n50_), .O(z10));
  nand4  g36(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  nand3  g37(.a(new_n50_), .b(x11), .c(new_n30_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(new_n49_), .c(x00), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n42_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(x11), .b(new_n49_), .c(new_n71_), .d(x00), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n50_), .O(z12));
endmodule
