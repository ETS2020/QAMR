...
module FAU ( 
  ...
  nand3  g11(.a(new_n40_), .b(x12), .c(x11), .O(z02));
  ...
  nand2  g29(.a(new_n34_), .b(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n57_), .O(z08));
  oai21  g31(.a(x10), .b(new_n52_), .c(new_n34_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  and2   g33(.a(x03), .b(x02), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n48_), .c(x09), .d(x04), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(x12), .c(x11), .d(new_n53_), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n52_), .c(new_n62_), .O(z09));
  inv1   g37(.a(x09), .O(new_n67_));
  nand4  g38(.a(new_n48_), .b(x12), .c(x11), .d(new_n53_), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n67_), .c(new_n52_), .O(z10));
  nand4  g40(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n70_));
  nand3  g41(.a(new_n34_), .b(x11), .c(new_n30_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(new_n53_), .c(x00), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n36_), .O(z11));
  nand4  g45(.a(x11), .b(new_n53_), .c(new_n67_), .d(x00), .O(new_n75_));
