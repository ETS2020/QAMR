...
module FAU ( 
  ...
  aoi21  g14(.a(new_n43_), .b(new_n38_), .c(new_n36_), .O(z03));
  ...
  nand2  g19(.a(new_n33_), .b(x13), .O(z05));
  ...
  nand2  g24(.a(new_n53_), .b(new_n33_), .O(z06));
  ...
  aoi21  g30(.a(new_n59_), .b(new_n50_), .c(new_n31_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n57_), .c(new_n36_), .O(z08));
  inv1   g32(.a(x10), .O(new_n62_));
  xnor2a g33(.a(x12), .b(x11), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n33_), .c(new_n62_), .d(x00), .O(new_n64_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n33_), .O(z10));
  ...
  nand4  g44(.a(new_n73_), .b(new_n33_), .c(x11), .d(new_n62_), .O(new_n74_));
  nor2   g45(.a(new_n74_), .b(new_n56_), .O(z11));
  inv1   g46(.a(x09), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(x00), .O(new_n77_));
  nand2  g48(.a(new_n38_), .b(new_n62_), .O(new_n78_));
  oai21  g49(.a(new_n78_), .b(new_n77_), .c(new_n33_), .O(z12));
endmodule
