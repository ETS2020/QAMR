...
module FAU ( 
  ...
  aoi21  g17(.a(x12), .b(new_n44_), .c(x13), .O(z05));
  ...
  nand2  g29(.a(new_n33_), .b(new_n44_), .O(new_n59_));
  ...
  nand4  g37(.a(new_n48_), .b(x12), .c(x11), .d(new_n53_), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n66_), .c(new_n52_), .O(z10));
