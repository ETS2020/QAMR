...
module FAU ( 
  ...
  oai21  g11(.a(new_n40_), .b(new_n31_), .c(x09), .O(new_n41_));
  ...
  nand4  g19(.a(new_n48_), .b(new_n45_), .c(x09), .d(x01), .O(new_n49_));
  ...
  nand4  g25(.a(x12), .b(new_n53_), .c(x09), .d(x04), .O(new_n55_));
  oai21  g26(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(new_n52_), .c(x11), .O(new_n57_));
  oai21  g28(.a(x12), .b(x11), .c(new_n57_), .O(z08));
  inv1   g29(.a(x12), .O(new_n59_));
  oai21  g30(.a(x10), .b(new_n52_), .c(new_n59_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n44_), .O(new_n61_));
  nand2  g32(.a(x03), .b(x02), .O(new_n62_));
  nand2  g33(.a(new_n48_), .b(x04), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n62_), .c(x11), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(x09), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(new_n53_), .d(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n61_), .O(z09));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(new_n48_), .b(x12), .c(x11), .d(new_n53_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z10));
  nand4  g41(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n71_));
  nand3  g42(.a(new_n59_), .b(x11), .c(new_n30_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(new_n53_), .c(x00), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n45_), .O(z11));
  nand3  g46(.a(new_n53_), .b(new_n68_), .c(x00), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(x11), .c(new_n59_), .O(z12));
endmodule
