...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(x04), .c(x03), .d(x02), .O(new_n48_));
  ...
  nand4  g27(.a(new_n56_), .b(new_n37_), .c(new_n54_), .d(x09), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n53_), .c(new_n33_), .d(x11), .O(z08));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(x15), .c(x14), .d(x09), .O(new_n60_));
  ...
  nand2  g35(.a(new_n64_), .b(new_n33_), .O(z09));
  nand4  g36(.a(new_n59_), .b(new_n33_), .c(x12), .d(x11), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n54_), .c(x09), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z10));
  nand4  g40(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n70_));
  ...
  nand2  g46(.a(new_n37_), .b(new_n54_), .O(new_n76_));
