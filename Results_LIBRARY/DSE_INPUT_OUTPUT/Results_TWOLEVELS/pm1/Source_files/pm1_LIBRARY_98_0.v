...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(new_n32_), .O(new_n37_));
  ...
  oai22  g21(.a(new_n50_), .b(new_n45_), .c(new_n32_), .d(x11), .O(new_n51_));
  ...
  nand4  g42(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  nand3  g43(.a(x15), .b(new_n32_), .c(new_n30_), .O(new_n73_));
  ...
  nand4  g47(.a(x11), .b(new_n55_), .c(new_n69_), .d(x00), .O(new_n77_));
