...
module FAU ( 
  ...
  nand2  g04(.a(z07), .b(x14), .O(new_n34_));
  ...
  aoi21  g26(.a(new_n55_), .b(new_n48_), .c(new_n31_), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n53_), .c(new_n38_), .O(z08));
  inv1   g28(.a(x10), .O(new_n58_));
  xnor2a g29(.a(x12), .b(x11), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n34_), .c(new_n58_), .d(x00), .O(new_n60_));
  ...
  nand4  g40(.a(new_n69_), .b(new_n34_), .c(x11), .d(new_n58_), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n52_), .O(z11));
  nand4  g42(.a(new_n34_), .b(x12), .c(x11), .d(new_n58_), .O(new_n72_));
