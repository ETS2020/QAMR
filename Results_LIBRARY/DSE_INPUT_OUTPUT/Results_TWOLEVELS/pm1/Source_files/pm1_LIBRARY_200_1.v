...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n45_, new_n46_, new_n48_, new_n49_, new_n50_, new_n53_, new_n56_,
  ...
  nand3  g26(.a(new_n32_), .b(x09), .c(x01), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n53_), .O(z06));
  ...
  oai21  g34(.a(x12), .b(x11), .c(new_n63_), .O(z08));
  aoi21  g35(.a(new_n39_), .b(x00), .c(x12), .O(new_n65_));
  nand2  g36(.a(new_n33_), .b(x11), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(x09), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x12), .c(new_n39_), .d(x00), .O(new_n68_));
  oai21  g39(.a(new_n65_), .b(x11), .c(new_n68_), .O(z09));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(new_n32_), .b(x12), .c(x11), .d(new_n39_), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n70_), .c(new_n59_), .O(z10));
  ...
  nand2  g47(.a(new_n76_), .b(new_n53_), .O(z11));
  nand3  g48(.a(new_n39_), .b(new_n70_), .c(x00), .O(new_n78_));
