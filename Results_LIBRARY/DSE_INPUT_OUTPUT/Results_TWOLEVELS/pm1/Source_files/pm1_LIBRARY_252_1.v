...
module FAU ( 
  ...
  nand2  g29(.a(new_n43_), .b(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n57_), .O(z08));
  oai21  g31(.a(x10), .b(new_n52_), .c(new_n43_), .O(new_n61_));
  ...
  nand3  g41(.a(new_n43_), .b(x11), .c(new_n30_), .O(new_n71_));
  ...
  nor2   g46(.a(new_n75_), .b(new_n43_), .O(z12));
endmodule
