...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n45_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n56_,
  ...
  oai21  g16(.a(new_n33_), .b(new_n37_), .c(new_n45_), .O(z01));
  inv1   g17(.a(x09), .O(new_n47_));
  nand2  g18(.a(x08), .b(x07), .O(new_n48_));
  nor4   g19(.a(new_n48_), .b(new_n31_), .c(new_n37_), .d(new_n47_), .O(new_n49_));
  oai21  g20(.a(new_n49_), .b(new_n44_), .c(new_n45_), .O(z02));
  nand3  g21(.a(x11), .b(x08), .c(x07), .O(new_n51_));
  or2    g22(.a(new_n51_), .b(new_n31_), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(x12), .c(x11), .d(x09), .O(z03));
  nor2   g24(.a(new_n39_), .b(x14), .O(z04));
  ...
  nor2   g30(.a(new_n39_), .b(x15), .O(z07));
  ...
  nor2   g34(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n38_), .c(new_n30_), .d(x00), .O(z08));
  inv1   g36(.a(x00), .O(new_n66_));
  nand3  g37(.a(x04), .b(x03), .c(x02), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n56_), .c(x09), .d(x04), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x12), .c(x11), .d(new_n30_), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n66_), .O(z09));
  nand3  g41(.a(new_n67_), .b(x12), .c(x11), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(x09), .c(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x12), .c(x10), .O(z10));
  nand3  g45(.a(new_n67_), .b(x11), .c(x09), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(x01), .c(x00), .O(new_n77_));
  aoi21  g48(.a(new_n77_), .b(x12), .c(x10), .O(z11));
  nand4  g49(.a(x12), .b(x11), .c(new_n47_), .d(x00), .O(new_n79_));
  aoi21  g50(.a(new_n79_), .b(x12), .c(x10), .O(z12));
endmodule
