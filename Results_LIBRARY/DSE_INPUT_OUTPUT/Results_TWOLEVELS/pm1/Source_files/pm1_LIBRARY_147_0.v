...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    new_n39_, new_n40_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_,
  ...
  oai21  g17(.a(z04), .b(x12), .c(new_n46_), .O(z03));
  nand2  g18(.a(z04), .b(new_n30_), .O(new_n48_));
  ...
  aoi21  g25(.a(z04), .b(new_n30_), .c(x15), .O(z07));
  ...
  aoi21  g31(.a(z04), .b(new_n30_), .c(x10), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n51_), .d(x00), .O(z08));
  inv1   g33(.a(x00), .O(new_n63_));
  nand3  g34(.a(new_n32_), .b(new_n56_), .c(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(x14), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  nand4  g37(.a(new_n57_), .b(new_n50_), .c(x09), .d(x04), .O(new_n67_));
