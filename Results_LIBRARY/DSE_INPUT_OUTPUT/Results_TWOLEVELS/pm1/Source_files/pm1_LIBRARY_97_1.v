...
module FAU ( 
  ...
  aoi21  g01(.a(x11), .b(new_n30_), .c(x01), .O(new_n31_));
  ...
  oai21  g09(.a(new_n31_), .b(x12), .c(new_n38_), .O(z00));
  nand3  g10(.a(new_n34_), .b(x12), .c(x00), .O(z01));
  inv1   g11(.a(x09), .O(new_n41_));
  nand4  g12(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n42_));
  aoi21  g13(.a(new_n42_), .b(x11), .c(new_n41_), .O(new_n43_));
  nand4  g14(.a(new_n43_), .b(x12), .c(x11), .d(x00), .O(z02));
  nand3  g15(.a(x11), .b(x08), .c(x07), .O(new_n45_));
  oai21  g16(.a(new_n45_), .b(new_n32_), .c(new_n36_), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(new_n41_), .c(x00), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(x12), .O(z03));
  inv1   g19(.a(x12), .O(new_n49_));
  nor2   g20(.a(new_n49_), .b(x00), .O(new_n50_));
  ...
  oai22  g26(.a(new_n55_), .b(new_n50_), .c(new_n36_), .d(new_n30_), .O(new_n56_));
  ...
  oai21  g31(.a(x12), .b(x11), .c(new_n30_), .O(new_n61_));
  nand2  g32(.a(x12), .b(x11), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n55_), .c(new_n60_), .d(x09), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n61_), .c(x11), .d(new_n60_), .O(z08));
  nor2   g36(.a(new_n62_), .b(x09), .O(new_n66_));
  nor2   g37(.a(x12), .b(x11), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n66_), .c(x00), .O(new_n68_));
  and2   g39(.a(x03), .b(x02), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n54_), .c(x04), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(x12), .c(x11), .d(x09), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n68_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n60_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n52_), .O(z09));
  nand4  g45(.a(new_n54_), .b(x11), .c(new_n60_), .d(x09), .O(new_n75_));
  aoi21  g46(.a(new_n75_), .b(x00), .c(new_n49_), .O(z10));
  nand4  g47(.a(new_n54_), .b(x12), .c(x09), .d(x01), .O(new_n77_));
  inv1   g48(.a(x01), .O(new_n78_));
  nand3  g49(.a(new_n49_), .b(new_n78_), .c(x00), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand3  g51(.a(new_n80_), .b(x11), .c(new_n60_), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n52_), .O(z11));
  nand4  g53(.a(x11), .b(new_n60_), .c(new_n41_), .d(x00), .O(new_n83_));
  nor2   g54(.a(new_n83_), .b(new_n49_), .O(z12));
endmodule
