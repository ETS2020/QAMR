...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n58_, new_n61_;
  ...
  oai21  g11(.a(x10), .b(new_n38_), .c(new_n32_), .O(new_n41_));
  nand3  g12(.a(new_n41_), .b(new_n40_), .c(new_n31_), .O(z02));
  nand3  g13(.a(new_n31_), .b(new_n34_), .c(x00), .O(new_n43_));
  ...
  nor2   g26(.a(new_n46_), .b(x15), .O(z07));
  nand3  g27(.a(new_n48_), .b(new_n41_), .c(new_n40_), .O(z08));
