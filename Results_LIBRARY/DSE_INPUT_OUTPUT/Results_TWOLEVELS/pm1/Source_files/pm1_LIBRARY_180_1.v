...
module FAU ( 
  ...
  nand2  g08(.a(new_n33_), .b(new_n32_), .O(new_n38_));
  ...
  nand2  g18(.a(x14), .b(x12), .O(z04));
  nor2   g19(.a(new_n33_), .b(x12), .O(new_n49_));
  ...
  oai22  g31(.a(new_n60_), .b(new_n59_), .c(new_n38_), .d(x11), .O(new_n61_));
  ...
  oai21  g37(.a(new_n63_), .b(x11), .c(new_n33_), .O(new_n67_));
  ...
  nor3   g43(.a(new_n72_), .b(new_n43_), .c(new_n66_), .O(z10));
  nand4  g44(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  nand3  g45(.a(new_n33_), .b(new_n32_), .c(new_n30_), .O(new_n75_));
  ...
  nand3  g50(.a(x12), .b(x11), .c(new_n58_), .O(new_n80_));
