...
module FAU ( 
  ...
  nand4  g17(.a(new_n46_), .b(new_n43_), .c(x09), .d(x01), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(z06));
  aoi21  g19(.a(x12), .b(new_n42_), .c(x15), .O(z07));
  ...
  oai21  g28(.a(x10), .b(new_n50_), .c(new_n57_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n42_), .O(new_n59_));
  ...
  nand3  g40(.a(new_n57_), .b(x11), .c(new_n30_), .O(new_n70_));
  ...
  aoi21  g45(.a(new_n74_), .b(x11), .c(new_n57_), .O(z12));
endmodule
