...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n37_,
    new_n39_, new_n40_, new_n45_, new_n46_, new_n47_, new_n51_, new_n54_;
  ...
  nor2   g12(.a(new_n32_), .b(new_n31_), .O(z12));
  ...
  nand4  g21(.a(new_n32_), .b(new_n31_), .c(new_n36_), .d(x00), .O(new_n51_));
  inv1   g22(.a(new_n51_), .O(z09));
  nand4  g23(.a(x11), .b(new_n36_), .c(new_n30_), .d(x00), .O(new_n54_));
  nor2   g24(.a(new_n54_), .b(x12), .O(z11));
  zero   g25(.O(z10));
  nand3  g26(.a(new_n40_), .b(new_n39_), .c(new_n31_), .O(z03));
endmodule
