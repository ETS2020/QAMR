...
module FAU ( 
  ...
  nor2   g29(.a(new_n58_), .b(new_n40_), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n57_), .c(new_n55_), .d(x09), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(x11), .c(new_n55_), .d(x00), .O(z08));
  ...
  nand2  g40(.a(new_n69_), .b(new_n35_), .O(z10));
  nand4  g41(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n71_));
  inv1   g42(.a(x01), .O(new_n72_));
  nand2  g43(.a(new_n58_), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g48(.a(x11), .b(new_n55_), .c(new_n77_), .d(x00), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n58_), .O(z12));
endmodule
