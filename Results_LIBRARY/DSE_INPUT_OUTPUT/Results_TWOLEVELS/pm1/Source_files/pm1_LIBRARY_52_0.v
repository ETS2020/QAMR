...
module FAU ( 
  ...
  nand3  g03(.a(new_n31_), .b(x08), .c(x07), .O(new_n33_));
  ...
  nand3  g10(.a(new_n35_), .b(x12), .c(x11), .O(new_n40_));
  nand2  g11(.a(new_n40_), .b(new_n38_), .O(z01));
  nand3  g12(.a(new_n32_), .b(x08), .c(x07), .O(new_n42_));
  inv1   g13(.a(new_n42_), .O(new_n43_));
  nand4  g14(.a(new_n43_), .b(x12), .c(x11), .d(x09), .O(z02));
  nand4  g15(.a(new_n32_), .b(x11), .c(x08), .d(x07), .O(new_n45_));
  nand4  g16(.a(new_n45_), .b(x12), .c(x11), .d(x09), .O(z03));
  inv1   g17(.a(x01), .O(new_n47_));
  nand2  g18(.a(new_n37_), .b(new_n47_), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x14), .O(z04));
  aoi21  g20(.a(new_n37_), .b(new_n47_), .c(x13), .O(z05));
  ...
  nand3  g30(.a(new_n37_), .b(new_n30_), .c(x01), .O(new_n60_));
  ...
  nand3  g35(.a(new_n64_), .b(new_n62_), .c(new_n52_), .O(z08));
  ...
  nand4  g42(.a(new_n58_), .b(x12), .c(x11), .d(new_n57_), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  and2   g44(.a(new_n73_), .b(x00), .O(z10));
  nand3  g45(.a(new_n73_), .b(x01), .c(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z11));
  nand4  g47(.a(x11), .b(new_n57_), .c(new_n71_), .d(x00), .O(new_n77_));
