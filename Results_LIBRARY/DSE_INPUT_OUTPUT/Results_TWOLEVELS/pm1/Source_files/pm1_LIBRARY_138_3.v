...
module FAU ( 
  ...
  oai21  g14(.a(new_n43_), .b(new_n35_), .c(x11), .O(new_n44_));
  oai21  g15(.a(new_n44_), .b(new_n39_), .c(new_n34_), .O(new_n45_));
  ...
  nand4  g31(.a(new_n34_), .b(x12), .c(x11), .d(x09), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n55_), .c(new_n60_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand2  g34(.a(new_n34_), .b(new_n31_), .O(new_n64_));
  nor2   g35(.a(new_n49_), .b(x10), .O(new_n65_));
  ...
  nand4  g39(.a(new_n68_), .b(new_n34_), .c(x12), .d(x11), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n60_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(new_n59_), .c(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z09));
  nand4  g43(.a(new_n55_), .b(new_n34_), .c(x12), .d(x11), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(new_n59_), .c(x09), .d(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z10));
  nand4  g47(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n77_));
  oai21  g48(.a(x12), .b(x01), .c(new_n77_), .O(new_n78_));
  nand4  g49(.a(new_n78_), .b(x11), .c(new_n59_), .d(x00), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n50_), .O(z11));
  nor2   g51(.a(x14), .b(new_n31_), .O(new_n81_));
  nand4  g52(.a(new_n81_), .b(new_n59_), .c(new_n39_), .d(x00), .O(new_n82_));
  aoi21  g53(.a(new_n82_), .b(new_n34_), .c(new_n32_), .O(z12));
endmodule
