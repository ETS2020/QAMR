...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n38_, new_n39_, new_n41_, new_n42_, new_n43_, new_n45_, new_n48_,
  ...
  nand2  g09(.a(new_n31_), .b(new_n30_), .O(new_n39_));
  ...
  aoi21  g17(.a(x15), .b(new_n30_), .c(x14), .O(z04));
  ...
  oai22  g29(.a(new_n58_), .b(new_n50_), .c(new_n39_), .d(x11), .O(new_n59_));
  ...
  nand3  g33(.a(new_n62_), .b(new_n60_), .c(new_n52_), .O(z08));
  ...
  oai21  g40(.a(new_n69_), .b(new_n64_), .c(new_n66_), .O(z09));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(new_n50_), .b(x12), .c(x11), .d(new_n57_), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(new_n71_), .c(new_n64_), .O(z10));
  inv1   g44(.a(x01), .O(new_n74_));
  nand4  g45(.a(x11), .b(new_n57_), .c(new_n74_), .d(x00), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n31_), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n30_), .O(new_n77_));
  inv1   g48(.a(new_n72_), .O(new_n78_));
