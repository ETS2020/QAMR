...
module FAU ( 
  ...
  nand3  g14(.a(new_n43_), .b(new_n41_), .c(new_n39_), .O(z01));
  inv1   g15(.a(x12), .O(new_n45_));
  nand2  g16(.a(x11), .b(x09), .O(new_n46_));
  aoi21  g17(.a(new_n42_), .b(x11), .c(new_n46_), .O(new_n47_));
  oai21  g18(.a(new_n47_), .b(new_n45_), .c(new_n41_), .O(z02));
  nor2   g19(.a(x12), .b(x08), .O(new_n49_));
  aoi21  g20(.a(new_n46_), .b(x12), .c(new_n49_), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(new_n39_), .O(z03));
  nand2  g22(.a(new_n45_), .b(x08), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(x14), .O(z04));
  nand2  g24(.a(new_n52_), .b(x13), .O(z05));
  and2   g25(.a(x03), .b(x02), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(new_n40_), .c(x04), .O(new_n56_));
  nand3  g27(.a(new_n56_), .b(x09), .c(x01), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n52_), .O(z06));
  nand2  g29(.a(new_n52_), .b(x15), .O(z07));
  ...
  aoi21  g35(.a(new_n45_), .b(x08), .c(x10), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(new_n64_), .c(new_n40_), .d(x00), .O(z08));
  inv1   g37(.a(x00), .O(new_n67_));
  nand3  g38(.a(new_n32_), .b(new_n60_), .c(x00), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n30_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n45_), .O(new_n70_));
  ...
  nand2  g48(.a(new_n77_), .b(new_n52_), .O(z10));
  ...
  nand2  g52(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  ...
  nor2   g56(.a(new_n85_), .b(new_n45_), .O(z12));
endmodule
