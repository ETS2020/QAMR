...
module FAU ( 
  ...
  nand2  g09(.a(new_n32_), .b(x12), .O(z01));
  ...
  nand3  g19(.a(new_n48_), .b(x11), .c(x04), .O(new_n49_));
  nand4  g20(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n50_));
  ...
  oai22  g26(.a(new_n55_), .b(new_n54_), .c(x12), .d(x11), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n53_), .O(new_n57_));
  nor2   g28(.a(new_n36_), .b(x10), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n57_), .c(new_n34_), .d(x00), .O(z08));
  inv1   g30(.a(x00), .O(new_n60_));
  inv1   g31(.a(x12), .O(new_n61_));
  nand3  g32(.a(new_n33_), .b(new_n53_), .c(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n35_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand4  g35(.a(new_n54_), .b(new_n48_), .c(x09), .d(x04), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(x11), .d(new_n53_), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n60_), .c(new_n64_), .O(z09));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(new_n54_), .b(x12), .c(x11), .d(new_n53_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n68_), .c(new_n60_), .O(z10));
  nand3  g41(.a(x11), .b(new_n53_), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n35_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n61_), .O(new_n73_));
  nand4  g44(.a(new_n54_), .b(x11), .c(new_n53_), .d(x09), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(x01), .c(x00), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n73_), .O(z11));
  nand4  g48(.a(x11), .b(new_n53_), .c(new_n68_), .d(x00), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n61_), .O(z12));
endmodule
