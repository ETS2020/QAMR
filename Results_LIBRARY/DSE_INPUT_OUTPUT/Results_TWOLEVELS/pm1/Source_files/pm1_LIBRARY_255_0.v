...
module FAU ( 
  ...
  nor2   g25(.a(new_n54_), .b(z04), .O(z07));
  ...
  oai21  g31(.a(new_n58_), .b(new_n57_), .c(new_n60_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  nand3  g33(.a(new_n36_), .b(x12), .c(new_n37_), .O(new_n63_));
  nor2   g34(.a(new_n49_), .b(x10), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(x00), .O(z08));
  ...
  nand3  g42(.a(new_n71_), .b(new_n56_), .c(x00), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n35_), .O(z09));
  nand4  g44(.a(new_n57_), .b(new_n35_), .c(x12), .d(x11), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(new_n56_), .c(x09), .d(x00), .O(new_n76_));
  ...
  nand4  g51(.a(new_n80_), .b(new_n35_), .c(x11), .d(new_n56_), .O(new_n81_));
  nor2   g52(.a(new_n81_), .b(new_n78_), .O(z11));
  nand4  g53(.a(new_n35_), .b(x12), .c(x11), .d(new_n56_), .O(new_n83_));
  nor3   g54(.a(new_n83_), .b(x09), .c(new_n78_), .O(z12));
endmodule
