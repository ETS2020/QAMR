...
module FAU ( 
  ...
  nor2   g20(.a(new_n40_), .b(x15), .O(z07));
  ...
  nor2   g33(.a(new_n45_), .b(new_n35_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n51_), .c(x09), .d(x00), .O(new_n64_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n42_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(x11), .b(new_n51_), .c(new_n70_), .d(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(new_n30_), .c(new_n32_), .O(z12));
endmodule
