...
module FAU ( 
  ...
  nand4  g38(.a(new_n49_), .b(x12), .c(x11), .d(new_n56_), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n67_), .c(new_n60_), .O(z10));
  inv1   g40(.a(x01), .O(new_n70_));
  nand3  g41(.a(new_n56_), .b(new_n70_), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(x11), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  inv1   g44(.a(new_n68_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x09), .c(x01), .d(x00), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n73_), .O(z11));
  nand2  g47(.a(new_n67_), .b(x00), .O(new_n77_));
