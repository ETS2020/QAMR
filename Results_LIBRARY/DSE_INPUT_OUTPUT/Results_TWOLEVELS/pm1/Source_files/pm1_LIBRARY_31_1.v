...
module FAU ( 
  ...
  nand2  g17(.a(x14), .b(new_n32_), .O(new_n47_));
  ...
  nor2   g26(.a(new_n55_), .b(x15), .O(z07));
  inv1   g27(.a(x10), .O(new_n57_));
  nand3  g28(.a(x12), .b(x11), .c(x09), .O(new_n58_));
  oai22  g29(.a(new_n58_), .b(new_n50_), .c(x12), .d(x11), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nor2   g31(.a(new_n55_), .b(x10), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n49_), .d(x00), .O(z08));
  inv1   g33(.a(x00), .O(new_n63_));
  nand3  g34(.a(new_n31_), .b(new_n57_), .c(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(z04), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n32_), .O(new_n66_));
  and2   g37(.a(x03), .b(x02), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n50_), .c(x09), .d(x04), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x12), .c(x11), .d(new_n57_), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n63_), .c(new_n66_), .O(z09));
  nand4  g41(.a(new_n50_), .b(x12), .c(x11), .d(new_n57_), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n40_), .c(new_n63_), .O(z10));
  nand4  g43(.a(x11), .b(new_n57_), .c(new_n30_), .d(x00), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(z04), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  inv1   g46(.a(new_n71_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(x09), .c(x01), .d(x00), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n75_), .O(z11));
  nand2  g49(.a(new_n40_), .b(x00), .O(new_n79_));
  nand3  g50(.a(x12), .b(x11), .c(new_n57_), .O(new_n80_));
