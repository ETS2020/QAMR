...
module FAU ( 
  ...
  oai21  g10(.a(new_n32_), .b(z05), .c(new_n39_), .O(z00));
  ...
  nor2   g26(.a(z05), .b(x12), .O(new_n56_));
  ...
  oai21  g30(.a(new_n49_), .b(z05), .c(new_n31_), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n59_), .c(new_n51_), .d(x09), .O(z03));
  nor2   g32(.a(x13), .b(x12), .O(new_n62_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n64_), .O(z06));
  nand2  g40(.a(new_n64_), .b(x15), .O(z07));
  nand3  g41(.a(x04), .b(x03), .c(x02), .O(new_n71_));
  nand3  g42(.a(x12), .b(x11), .c(x09), .O(new_n72_));
  nand2  g43(.a(new_n56_), .b(new_n33_), .O(new_n73_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(new_n43_), .c(x00), .O(new_n75_));
  oai21  g46(.a(new_n56_), .b(x12), .c(new_n49_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n75_), .c(new_n66_), .O(z08));
  nand4  g48(.a(new_n71_), .b(new_n65_), .c(x09), .d(x04), .O(new_n78_));
  nand3  g49(.a(new_n78_), .b(x12), .c(x11), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n73_), .O(new_n80_));
  nand3  g51(.a(new_n80_), .b(new_n43_), .c(x00), .O(new_n81_));
  inv1   g52(.a(new_n81_), .O(z09));
  inv1   g53(.a(x09), .O(new_n83_));
  nand4  g54(.a(new_n71_), .b(x12), .c(x11), .d(new_n43_), .O(new_n84_));
  nor3   g55(.a(new_n84_), .b(new_n83_), .c(new_n41_), .O(z10));
  inv1   g56(.a(x01), .O(new_n86_));
  nand4  g57(.a(x11), .b(new_n43_), .c(new_n86_), .d(x00), .O(new_n87_));
  nand2  g58(.a(new_n87_), .b(x13), .O(new_n88_));
  nand2  g59(.a(new_n88_), .b(new_n31_), .O(new_n89_));
  inv1   g60(.a(new_n84_), .O(new_n90_));
  nand4  g61(.a(new_n90_), .b(x09), .c(x01), .d(x00), .O(new_n91_));
  nand2  g62(.a(new_n91_), .b(new_n89_), .O(z11));
  nand2  g63(.a(new_n83_), .b(x00), .O(new_n93_));
  nand3  g64(.a(x12), .b(x11), .c(new_n43_), .O(new_n94_));
  oai21  g65(.a(new_n94_), .b(new_n93_), .c(new_n64_), .O(z12));
endmodule
