...
module FAU ( 
  ...
  nand4  g29(.a(new_n58_), .b(new_n51_), .c(x04), .d(x00), .O(new_n59_));
  inv1   g30(.a(x00), .O(new_n60_));
  nor2   g31(.a(x10), .b(new_n60_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n59_), .c(x12), .d(x11), .O(z08));
  oai21  g33(.a(new_n61_), .b(x11), .c(new_n37_), .O(new_n63_));
  inv1   g34(.a(x10), .O(new_n64_));
  nand2  g35(.a(x12), .b(new_n57_), .O(new_n65_));
  nand3  g36(.a(x04), .b(x03), .c(x02), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(x04), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n50_), .c(x09), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x11), .c(new_n64_), .d(x00), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n63_), .O(z09));
  nand4  g42(.a(new_n66_), .b(new_n64_), .c(x09), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x12), .c(new_n30_), .O(z10));
  nand4  g44(.a(new_n66_), .b(x12), .c(x11), .d(new_n64_), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x09), .c(x01), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand4  g48(.a(x11), .b(new_n64_), .c(new_n57_), .d(x00), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n37_), .O(z12));
endmodule
