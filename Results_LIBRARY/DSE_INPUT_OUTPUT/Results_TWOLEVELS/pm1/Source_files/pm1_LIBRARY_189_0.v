...
module FAU ( 
  ...
  nor2   g18(.a(new_n34_), .b(x13), .O(z05));
  inv1   g19(.a(x12), .O(new_n49_));
  aoi21  g20(.a(x09), .b(x01), .c(new_n49_), .O(new_n50_));
  ...
  nand4  g27(.a(x11), .b(new_n56_), .c(x09), .d(x04), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n55_), .c(x11), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(x12), .O(new_n59_));
  inv1   g30(.a(x00), .O(new_n60_));
  oai21  g31(.a(x10), .b(new_n60_), .c(x11), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n59_), .O(z08));
  ...
  nor2   g36(.a(new_n65_), .b(new_n60_), .O(z09));
  inv1   g37(.a(x09), .O(new_n67_));
  nand4  g38(.a(new_n51_), .b(x12), .c(x11), .d(new_n56_), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(x00), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n35_), .O(z10));
  inv1   g42(.a(x01), .O(new_n72_));
  nand3  g43(.a(new_n56_), .b(new_n72_), .c(x00), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(x11), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n49_), .O(new_n75_));
  nand3  g46(.a(new_n69_), .b(x01), .c(x00), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n75_), .O(z11));
  nand4  g48(.a(x11), .b(new_n56_), .c(new_n67_), .d(x00), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n49_), .O(z12));
endmodule
