...
module FAU ( 
  ...
  nand2  g16(.a(new_n30_), .b(x12), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(z01));
  nand3  g18(.a(new_n31_), .b(new_n39_), .c(x00), .O(new_n48_));
  inv1   g19(.a(new_n48_), .O(new_n49_));
  nor2   g20(.a(new_n30_), .b(new_n31_), .O(new_n50_));
  oai21  g21(.a(new_n50_), .b(new_n49_), .c(new_n41_), .O(new_n51_));
  nand2  g22(.a(new_n42_), .b(new_n31_), .O(new_n52_));
  nand2  g23(.a(x08), .b(x07), .O(new_n53_));
  oai21  g24(.a(new_n53_), .b(new_n33_), .c(x11), .O(new_n54_));
  ...
  nand3  g28(.a(x15), .b(x08), .c(x07), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n33_), .c(x12), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(x11), .O(new_n60_));
  inv1   g31(.a(x09), .O(new_n61_));
  aoi22  g32(.a(new_n40_), .b(new_n31_), .c(x15), .d(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(z03));
  inv1   g34(.a(new_n46_), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(x14), .O(z04));
  nor2   g36(.a(new_n64_), .b(x13), .O(z05));
  nand3  g37(.a(new_n41_), .b(x09), .c(x01), .O(new_n67_));
  ...
  nand2  g42(.a(new_n71_), .b(new_n69_), .O(z06));
  nor2   g43(.a(x15), .b(x12), .O(z07));
  nand2  g44(.a(new_n31_), .b(new_n41_), .O(new_n74_));
  nand3  g45(.a(new_n50_), .b(x11), .c(x09), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n70_), .c(new_n74_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n39_), .c(x00), .O(new_n77_));
  aoi22  g48(.a(new_n50_), .b(new_n41_), .c(new_n46_), .d(new_n40_), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n77_), .O(z08));
  and2   g50(.a(x03), .b(x02), .O(new_n80_));
  nand4  g51(.a(new_n80_), .b(new_n70_), .c(x09), .d(x04), .O(new_n81_));
