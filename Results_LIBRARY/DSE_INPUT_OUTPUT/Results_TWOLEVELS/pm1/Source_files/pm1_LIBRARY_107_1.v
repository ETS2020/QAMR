...
module FAU ( 
  ...
  nand2  g22(.a(new_n48_), .b(x15), .O(z07));
  ...
  nand4  g28(.a(new_n57_), .b(new_n48_), .c(new_n53_), .d(x00), .O(z08));
  ...
  nand3  g36(.a(new_n49_), .b(x11), .c(new_n53_), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x09), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x11), .c(new_n33_), .O(z10));
