...
module FAU ( 
  ...
  nand4  g09(.a(new_n38_), .b(new_n36_), .c(new_n34_), .d(new_n30_), .O(z00));
  inv1   g10(.a(x07), .O(new_n40_));
  nand2  g11(.a(new_n38_), .b(new_n40_), .O(new_n41_));
  nand3  g12(.a(x08), .b(x06), .c(x05), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(x11), .O(new_n43_));
  inv1   g14(.a(x12), .O(new_n44_));
  nand2  g15(.a(x15), .b(new_n44_), .O(new_n45_));
  nand4  g16(.a(new_n45_), .b(new_n43_), .c(new_n41_), .d(new_n34_), .O(z01));
  inv1   g17(.a(x09), .O(new_n47_));
  oai21  g18(.a(new_n44_), .b(new_n47_), .c(x15), .O(new_n48_));
  inv1   g19(.a(x15), .O(new_n49_));
  nand2  g20(.a(new_n49_), .b(x07), .O(new_n50_));
  and2   g21(.a(new_n50_), .b(new_n38_), .O(new_n51_));
  nand4  g22(.a(new_n51_), .b(new_n48_), .c(new_n43_), .d(x07), .O(z02));
  nor2   g23(.a(x15), .b(new_n40_), .O(new_n53_));
  nand3  g24(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(new_n55_));
  nand3  g26(.a(x07), .b(x06), .c(x05), .O(new_n56_));
  oai22  g27(.a(new_n56_), .b(new_n32_), .c(new_n55_), .d(new_n53_), .O(z03));
  ...
  nand4  g32(.a(new_n61_), .b(new_n50_), .c(x09), .d(x01), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z06));
  nor2   g34(.a(x15), .b(x07), .O(z07));
  inv1   g35(.a(x00), .O(new_n65_));
  nor2   g36(.a(x10), .b(new_n65_), .O(new_n66_));
  nand4  g37(.a(new_n60_), .b(x12), .c(x09), .d(x04), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n66_), .c(new_n50_), .d(x11), .O(z08));
  inv1   g39(.a(x10), .O(new_n69_));
  xnor2a g40(.a(x12), .b(x11), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n50_), .c(new_n69_), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z09));
  nand3  g43(.a(x04), .b(x03), .c(x02), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(new_n50_), .c(x12), .d(x11), .O(new_n74_));
  ...
  nand4  g50(.a(new_n79_), .b(x11), .c(new_n69_), .d(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n50_), .O(z11));
  nor2   g52(.a(new_n53_), .b(new_n44_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(x11), .c(new_n69_), .d(new_n47_), .O(new_n83_));
  nor2   g54(.a(new_n83_), .b(new_n65_), .O(z12));
endmodule
