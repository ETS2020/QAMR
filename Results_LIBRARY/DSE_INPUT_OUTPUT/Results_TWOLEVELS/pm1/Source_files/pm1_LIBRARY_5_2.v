...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n37_, new_n40_, new_n41_, new_n43_, new_n45_, new_n47_, new_n49_,
  ...
  nand4  g13(.a(new_n33_), .b(x11), .c(x08), .d(x07), .O(new_n43_));
  ...
  nor2   g27(.a(new_n56_), .b(x10), .O(new_n57_));
  and2   g28(.a(x09), .b(x04), .O(new_n58_));
  nor2   g29(.a(new_n30_), .b(x10), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n58_), .c(new_n50_), .d(x00), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n57_), .c(new_n51_), .d(x00), .O(z08));
  inv1   g32(.a(x00), .O(new_n62_));
  oai21  g33(.a(x10), .b(new_n62_), .c(new_n30_), .O(new_n63_));
  ...
  oai21  g38(.a(new_n67_), .b(new_n49_), .c(x09), .O(new_n68_));
  inv1   g39(.a(x09), .O(new_n69_));
  nand2  g40(.a(x12), .b(new_n69_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(x11), .c(new_n65_), .d(x00), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n64_), .O(z09));
  nand3  g44(.a(new_n66_), .b(new_n65_), .c(x09), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(x00), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(x12), .c(new_n30_), .O(z10));
  nand3  g48(.a(new_n75_), .b(x01), .c(x00), .O(new_n78_));
  aoi21  g49(.a(new_n78_), .b(x12), .c(new_n30_), .O(z11));
  nand4  g50(.a(x11), .b(new_n65_), .c(new_n69_), .d(x00), .O(new_n80_));
  nor2   g51(.a(new_n80_), .b(new_n56_), .O(z12));
endmodule
