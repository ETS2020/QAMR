...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n40_, new_n41_, new_n42_, new_n44_, new_n45_, new_n48_, new_n50_,
  ...
  nand2  g08(.a(z07), .b(new_n32_), .O(new_n38_));
  ...
  aoi21  g17(.a(x15), .b(new_n32_), .c(x14), .O(z04));
  nand2  g18(.a(x15), .b(new_n32_), .O(new_n48_));
  ...
  oai22  g28(.a(new_n57_), .b(new_n56_), .c(new_n38_), .d(x11), .O(new_n58_));
  ...
  nand3  g32(.a(new_n61_), .b(new_n59_), .c(new_n50_), .O(z08));
  inv1   g33(.a(x00), .O(new_n63_));
  oai21  g34(.a(new_n60_), .b(x11), .c(z07), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n32_), .O(new_n65_));
  nand4  g36(.a(new_n56_), .b(new_n51_), .c(x09), .d(x04), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(x12), .c(x11), .d(new_n55_), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n63_), .c(new_n65_), .O(z09));
  nand4  g39(.a(new_n56_), .b(x12), .c(x11), .d(new_n55_), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(x09), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n48_), .O(z10));
  nand4  g43(.a(new_n56_), .b(x12), .c(x09), .d(x01), .O(new_n73_));
  nand3  g44(.a(z07), .b(new_n32_), .c(new_n30_), .O(new_n74_));
  ...
  oai21  g50(.a(new_n79_), .b(new_n78_), .c(new_n48_), .O(z12));
endmodule
