...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n37_, new_n40_, new_n41_, new_n42_, new_n43_, new_n45_, new_n47_,
  ...
  nand2  g09(.a(new_n37_), .b(x12), .O(z01));
  ...
  oai21  g14(.a(new_n43_), .b(new_n40_), .c(x11), .O(z02));
  ...
  oai21  g38(.a(new_n67_), .b(new_n65_), .c(x12), .O(new_n68_));
  ...
  nand4  g42(.a(new_n66_), .b(x12), .c(x11), .d(new_n57_), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(new_n41_), .c(new_n56_), .O(z10));
  nand3  g44(.a(new_n66_), .b(new_n57_), .c(x09), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(x01), .c(x00), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(x12), .c(new_n30_), .O(z11));
  nand3  g48(.a(new_n57_), .b(new_n41_), .c(x00), .O(new_n78_));
