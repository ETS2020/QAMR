...
module FAU ( 
  ...
  oai21  g00(.a(x11), .b(x01), .c(x06), .O(new_n30_));
  nand2  g01(.a(x11), .b(x06), .O(new_n31_));
  nand2  g02(.a(new_n31_), .b(x12), .O(new_n32_));
  nand2  g03(.a(new_n32_), .b(new_n30_), .O(z00));
  nand4  g04(.a(x11), .b(x08), .c(x07), .d(x05), .O(new_n34_));
  nand2  g05(.a(new_n34_), .b(x12), .O(new_n35_));
  nand2  g06(.a(new_n35_), .b(x06), .O(new_n36_));
  ...
  nand2  g14(.a(new_n40_), .b(x06), .O(new_n44_));
  ...
  nor2   g18(.a(x12), .b(x06), .O(new_n48_));
  ...
  nand2  g23(.a(x12), .b(new_n42_), .O(new_n53_));
  ...
  nand3  g31(.a(new_n40_), .b(new_n42_), .c(x06), .O(new_n61_));
  ...
  nor3   g43(.a(new_n72_), .b(new_n41_), .c(new_n71_), .O(z10));
  nand4  g44(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  oai21  g45(.a(new_n44_), .b(x01), .c(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n58_), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand2  g48(.a(new_n41_), .b(x00), .O(new_n78_));
  nand3  g49(.a(x12), .b(x11), .c(new_n58_), .O(new_n79_));
