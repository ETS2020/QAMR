...
module FAU ( 
  ...
  nand2  g15(.a(new_n37_), .b(x14), .O(z04));
  aoi21  g16(.a(new_n36_), .b(new_n33_), .c(x13), .O(z05));
  ...
  nand4  g31(.a(new_n60_), .b(new_n47_), .c(x09), .d(x04), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x12), .c(x11), .d(new_n53_), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n59_), .c(new_n37_), .O(z09));
  nand4  g34(.a(new_n47_), .b(x12), .c(x11), .d(new_n53_), .O(new_n64_));
  ...
  nand2  g40(.a(new_n36_), .b(new_n69_), .O(new_n70_));
  ...
  nand2  g46(.a(new_n56_), .b(new_n53_), .O(new_n76_));
  oai21  g47(.a(new_n76_), .b(new_n75_), .c(new_n37_), .O(z12));
endmodule
