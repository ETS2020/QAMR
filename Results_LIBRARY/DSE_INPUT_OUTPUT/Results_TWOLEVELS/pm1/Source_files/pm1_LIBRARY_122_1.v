...
module FAU ( 
  ...
  or2    g24(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(x11), .c(new_n51_), .d(x00), .O(z08));
  inv1   g26(.a(x00), .O(new_n56_));
  oai21  g27(.a(x10), .b(new_n56_), .c(new_n33_), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  nand2  g29(.a(new_n47_), .b(x04), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n52_), .c(x09), .O(new_n60_));
  ...
  nand4  g36(.a(new_n47_), .b(new_n51_), .c(x09), .d(x00), .O(new_n66_));
  ...
  nand4  g42(.a(x11), .b(new_n51_), .c(new_n61_), .d(x00), .O(new_n72_));
