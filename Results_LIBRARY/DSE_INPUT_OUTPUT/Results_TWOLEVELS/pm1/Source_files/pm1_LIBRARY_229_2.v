...
module FAU ( 
  ...
  oai21  g11(.a(x12), .b(x10), .c(new_n40_), .O(z03));
  ...
  aoi21  g24(.a(new_n33_), .b(new_n32_), .c(new_n53_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(z01), .c(new_n31_), .d(x00), .O(z08));
  nand2  g26(.a(new_n33_), .b(new_n32_), .O(new_n56_));
  nand4  g27(.a(new_n51_), .b(new_n46_), .c(x09), .d(x04), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(x12), .c(x11), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n31_), .c(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  inv1   g32(.a(x00), .O(new_n62_));
  inv1   g33(.a(x09), .O(new_n63_));
  nand4  g34(.a(new_n51_), .b(x12), .c(x11), .d(new_n31_), .O(new_n64_));
  ...
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n31_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  nand4  g40(.a(x11), .b(new_n31_), .c(new_n63_), .d(x00), .O(new_n70_));
