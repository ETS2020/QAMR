...
module FAU ( 
  ...
  nand2  g13(.a(new_n31_), .b(new_n30_), .O(new_n43_));
  ...
  nand3  g19(.a(new_n48_), .b(new_n46_), .c(x04), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(x09), .c(x01), .O(new_n50_));
  inv1   g21(.a(new_n50_), .O(z06));
  nand2  g22(.a(new_n43_), .b(x15), .O(z07));
  nor2   g23(.a(new_n47_), .b(x10), .O(new_n53_));
  inv1   g24(.a(x10), .O(new_n54_));
  nand4  g25(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(new_n56_));
  nor2   g27(.a(new_n31_), .b(new_n47_), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n56_), .c(new_n54_), .d(x09), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n53_), .c(new_n43_), .d(x00), .O(z08));
  inv1   g30(.a(x00), .O(new_n60_));
  nand3  g31(.a(new_n47_), .b(new_n54_), .c(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(x01), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n31_), .O(new_n63_));
  nand3  g34(.a(x04), .b(x03), .c(x02), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n46_), .c(x09), .d(x04), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(x11), .d(new_n54_), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n60_), .c(new_n63_), .O(z09));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(new_n64_), .b(x12), .c(x11), .d(new_n54_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n68_), .c(new_n60_), .O(z10));
  inv1   g41(.a(new_n69_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(x09), .c(x01), .d(x00), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n43_), .O(z11));
  nand4  g44(.a(x11), .b(new_n54_), .c(new_n68_), .d(x00), .O(new_n74_));
  nor2   g45(.a(new_n74_), .b(new_n31_), .O(z12));
endmodule
