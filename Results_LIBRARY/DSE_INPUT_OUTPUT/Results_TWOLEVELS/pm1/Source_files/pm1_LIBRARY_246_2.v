...
module FAU ( 
  ...
  nand2  g43(.a(new_n54_), .b(new_n72_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(new_n31_), .c(x11), .d(new_n57_), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n53_), .O(z11));
  nand4  g47(.a(new_n31_), .b(x12), .c(x11), .d(new_n57_), .O(new_n77_));
  nor3   g48(.a(new_n77_), .b(x09), .c(new_n53_), .O(z12));
endmodule
