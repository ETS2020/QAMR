...
module FAU ( 
  ...
  nand4  g27(.a(new_n56_), .b(new_n50_), .c(x09), .d(x04), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(x12), .c(x11), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n40_), .c(new_n55_), .d(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n31_), .O(z07));
  inv1   g32(.a(x00), .O(new_n62_));
  nor2   g33(.a(x10), .b(new_n62_), .O(new_n63_));
  nand4  g34(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n64_));
  nand3  g35(.a(new_n40_), .b(new_n55_), .c(x09), .O(new_n65_));
  nor2   g36(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g37(.a(new_n66_), .b(new_n33_), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n63_), .c(new_n32_), .O(z08));
  nand4  g39(.a(new_n57_), .b(new_n31_), .c(x12), .d(x11), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n35_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(new_n55_), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n31_), .O(z09));
  nand4  g43(.a(new_n56_), .b(new_n31_), .c(x12), .d(x11), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(new_n55_), .c(x09), .d(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z10));
  nand4  g47(.a(new_n56_), .b(x12), .c(x09), .d(x01), .O(new_n77_));
  oai21  g48(.a(x12), .b(x01), .c(new_n77_), .O(new_n78_));
  nand4  g49(.a(new_n78_), .b(x11), .c(new_n55_), .d(x00), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n31_), .O(z11));
  nand4  g51(.a(new_n31_), .b(x12), .c(x11), .d(new_n55_), .O(new_n81_));
  nor3   g52(.a(new_n81_), .b(x09), .c(new_n62_), .O(z12));
endmodule
