...
module FAU ( 
  ...
  nor2   g18(.a(x12), .b(x11), .O(new_n48_));
  ...
  nand2  g27(.a(new_n56_), .b(x15), .O(z07));
  ...
  oai21  g34(.a(x10), .b(new_n63_), .c(x11), .O(new_n64_));
  ...
  nand4  g38(.a(new_n67_), .b(x12), .c(x11), .d(new_n59_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n63_), .c(new_n56_), .O(z09));
  nand4  g40(.a(new_n51_), .b(x12), .c(x11), .d(new_n59_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n39_), .c(new_n63_), .O(z10));
  inv1   g42(.a(x01), .O(new_n72_));
  nand3  g43(.a(new_n59_), .b(new_n72_), .c(x00), .O(new_n73_));
  ...
  nand4  g49(.a(x11), .b(new_n59_), .c(new_n39_), .d(x00), .O(new_n79_));
