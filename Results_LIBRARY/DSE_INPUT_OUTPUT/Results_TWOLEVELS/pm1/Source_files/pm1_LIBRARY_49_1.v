...
module FAU ( 
  ...
  oai21  g02(.a(x11), .b(x01), .c(z04), .O(new_n32_));
  ...
  nand2  g17(.a(z04), .b(new_n30_), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(new_n46_), .O(z03));
  nand2  g19(.a(x14), .b(new_n30_), .O(new_n49_));
  ...
  oai21  g41(.a(new_n70_), .b(new_n65_), .c(new_n67_), .O(z09));
  ...
  nand2  g45(.a(new_n74_), .b(new_n49_), .O(z10));
  nand4  g46(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  inv1   g47(.a(x01), .O(new_n77_));
  nand3  g48(.a(z04), .b(new_n30_), .c(new_n77_), .O(new_n78_));
  ...
  nand2  g52(.a(new_n43_), .b(x00), .O(new_n82_));
