...
module FAU ( 
  ...
  nand3  g06(.a(x12), .b(x08), .c(x07), .O(new_n36_));
  inv1   g07(.a(new_n36_), .O(new_n37_));
  inv1   g08(.a(x09), .O(new_n38_));
  nor2   g09(.a(new_n32_), .b(x11), .O(new_n39_));
  aoi21  g10(.a(x11), .b(new_n38_), .c(new_n39_), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(new_n37_), .c(x06), .d(x05), .O(z02));
  ...
  inv1   g17(.a(new_n39_), .O(new_n47_));
  ...
  nor2   g22(.a(new_n39_), .b(x15), .O(z07));
  inv1   g23(.a(x10), .O(new_n53_));
  nand3  g24(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  nor2   g25(.a(new_n54_), .b(new_n49_), .O(new_n55_));
  aoi21  g26(.a(new_n32_), .b(new_n31_), .c(new_n55_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n47_), .c(new_n53_), .d(x00), .O(z08));
  nand2  g28(.a(new_n32_), .b(new_n31_), .O(new_n58_));
  and2   g29(.a(x03), .b(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n49_), .c(x09), .d(x04), .O(new_n60_));
  ...
  nand3  g35(.a(new_n49_), .b(x11), .c(new_n53_), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x09), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x11), .c(new_n32_), .O(z10));
  ...
  nand4  g43(.a(x11), .b(new_n53_), .c(new_n38_), .d(x00), .O(new_n73_));
