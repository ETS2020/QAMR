...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n40_, new_n41_, new_n43_, new_n45_, new_n46_, new_n49_, new_n50_,
  ...
  nor2   g15(.a(x15), .b(x12), .O(new_n45_));
  ...
  oai22  g27(.a(new_n56_), .b(new_n55_), .c(x12), .d(x11), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  nor2   g29(.a(new_n45_), .b(x10), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n58_), .c(new_n49_), .d(x00), .O(z08));
  inv1   g31(.a(x00), .O(new_n61_));
  nand3  g32(.a(new_n31_), .b(new_n54_), .c(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(x15), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n32_), .O(new_n64_));
  nand4  g35(.a(new_n55_), .b(new_n50_), .c(x09), .d(x04), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(x11), .d(new_n54_), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n61_), .c(new_n64_), .O(z09));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(new_n55_), .b(x12), .c(x11), .d(new_n54_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n68_), .c(new_n61_), .O(z10));
  nand4  g41(.a(x11), .b(new_n54_), .c(new_n30_), .d(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(x15), .O(new_n72_));
  ...
  nand2  g47(.a(new_n68_), .b(x00), .O(new_n77_));
  nand3  g48(.a(x12), .b(x11), .c(new_n54_), .O(new_n78_));
  oai21  g49(.a(new_n78_), .b(new_n77_), .c(new_n46_), .O(z12));
endmodule
