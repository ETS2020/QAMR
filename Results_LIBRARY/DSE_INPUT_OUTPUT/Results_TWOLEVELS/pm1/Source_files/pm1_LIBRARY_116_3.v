...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n50_, new_n53_, new_n55_, new_n57_, new_n58_;
  ...
  nor2   g14(.a(new_n30_), .b(new_n33_), .O(z10));
  ...
  nand4  g28(.a(x11), .b(new_n34_), .c(new_n57_), .d(x00), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(x12), .O(z11));
  zero   g30(.O(z12));
  nand2  g31(.a(new_n42_), .b(new_n40_), .O(z03));
endmodule
