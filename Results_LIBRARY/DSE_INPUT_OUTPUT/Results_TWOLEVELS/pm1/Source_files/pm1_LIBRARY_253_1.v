...
module FAU ( 
  ...
  nand4  g20(.a(new_n49_), .b(new_n45_), .c(x09), .d(x01), .O(new_n50_));
  ...
  aoi21  g26(.a(new_n33_), .b(new_n44_), .c(new_n55_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n45_), .c(new_n53_), .d(x00), .O(z08));
  nand2  g28(.a(new_n33_), .b(new_n44_), .O(new_n58_));
