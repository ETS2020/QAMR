...
module FAU ( 
  ...
  nor2   g15(.a(x14), .b(x13), .O(z04));
  nand2  g16(.a(x14), .b(x13), .O(z05));
  ...
  nand4  g39(.a(new_n54_), .b(new_n31_), .c(x12), .d(x11), .O(new_n69_));
  ...
  nand3  g48(.a(new_n38_), .b(x11), .c(new_n53_), .O(new_n78_));
