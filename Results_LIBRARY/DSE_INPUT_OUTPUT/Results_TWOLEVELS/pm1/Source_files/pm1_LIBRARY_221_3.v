...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x04), .O(new_n31_));
  ...
  nand3  g22(.a(new_n51_), .b(x03), .c(x02), .O(new_n52_));
  ...
  nand3  g36(.a(new_n50_), .b(x03), .c(x02), .O(new_n66_));
  ...
  nand2  g45(.a(x03), .b(x02), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n45_), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(x04), .c(new_n74_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x11), .c(new_n56_), .d(x09), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n73_), .O(z10));
  nand3  g50(.a(new_n31_), .b(new_n74_), .c(new_n30_), .O(new_n80_));
