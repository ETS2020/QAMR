...
module FAU ( 
  ...
  nor2   g15(.a(new_n33_), .b(x11), .O(new_n45_));
  ...
  aoi21  g27(.a(new_n33_), .b(new_n54_), .c(new_n56_), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n46_), .c(new_n53_), .d(x00), .O(z08));
  nand2  g29(.a(new_n33_), .b(new_n54_), .O(new_n59_));
  ...
  nand4  g38(.a(new_n49_), .b(x12), .c(x11), .d(new_n53_), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z10));
  nand4  g40(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n70_));
  ...
  nand4  g44(.a(x11), .b(new_n53_), .c(new_n67_), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x11), .c(new_n33_), .O(z12));
endmodule
