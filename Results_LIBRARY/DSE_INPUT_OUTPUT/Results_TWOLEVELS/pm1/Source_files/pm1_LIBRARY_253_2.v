...
module FAU ( 
  ...
  nor2   g30(.a(new_n37_), .b(x10), .O(new_n60_));
  ...
  nand3  g39(.a(new_n68_), .b(new_n65_), .c(x00), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z09));
  nor2   g41(.a(new_n52_), .b(new_n37_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(new_n65_), .c(x09), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x12), .c(new_n30_), .O(z10));
  nand4  g44(.a(new_n51_), .b(x12), .c(x11), .d(new_n65_), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x09), .c(x01), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand4  g48(.a(x11), .b(new_n65_), .c(new_n40_), .d(x00), .O(new_n78_));
