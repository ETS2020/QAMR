...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n45_, new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n55_,
  ...
  nor2   g12(.a(x15), .b(new_n33_), .O(new_n42_));
  ...
  nand3  g29(.a(new_n58_), .b(new_n34_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(x11), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n49_), .c(x13), .O(z05));
  nand2  g32(.a(x12), .b(new_n48_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n55_), .c(x04), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n43_), .c(x09), .d(x01), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z06));
  nor2   g36(.a(x15), .b(x13), .O(z07));
  ...
  oai21  g41(.a(x13), .b(new_n48_), .c(new_n32_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n35_), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n70_), .O(z08));
  nand3  g44(.a(new_n57_), .b(x12), .c(x11), .O(new_n74_));
