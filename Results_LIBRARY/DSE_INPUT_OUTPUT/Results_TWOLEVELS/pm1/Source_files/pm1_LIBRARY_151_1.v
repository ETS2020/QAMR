...
module FAU ( 
  ...
  oai21  g14(.a(new_n43_), .b(new_n31_), .c(x09), .O(new_n44_));
  ...
  aoi21  g27(.a(new_n34_), .b(new_n54_), .c(new_n56_), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n36_), .c(new_n53_), .d(x00), .O(z08));
  nand2  g29(.a(new_n34_), .b(new_n54_), .O(new_n59_));
