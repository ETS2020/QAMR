...
module FAU ( 
  ...
  aoi21  g18(.a(new_n38_), .b(new_n35_), .c(x14), .O(z04));
  nor2   g19(.a(new_n32_), .b(x13), .O(z05));
  nand2  g20(.a(x12), .b(new_n35_), .O(new_n50_));
  nand4  g21(.a(new_n50_), .b(x04), .c(x03), .d(x02), .O(new_n51_));
  nand4  g22(.a(new_n51_), .b(new_n31_), .c(x09), .d(x01), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(z06));
  aoi21  g24(.a(new_n38_), .b(new_n35_), .c(x15), .O(z07));
  ...
  nor2   g32(.a(new_n61_), .b(new_n55_), .O(new_n62_));
  ...
  nand2  g43(.a(new_n37_), .b(new_n30_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(new_n31_), .c(x11), .d(new_n58_), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n55_), .O(z11));
