...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n45_, new_n47_, new_n48_, new_n51_,
  ...
  nand2  g07(.a(new_n32_), .b(x12), .O(z01));
  ...
  nand2  g29(.a(new_n33_), .b(new_n58_), .O(new_n59_));
  ...
  nand4  g37(.a(new_n47_), .b(x12), .c(x11), .d(new_n52_), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n66_), .c(new_n51_), .O(z10));
  nand4  g39(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n69_));
  ...
  nand4  g43(.a(x11), .b(new_n52_), .c(new_n66_), .d(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x11), .c(new_n33_), .O(z12));
endmodule
