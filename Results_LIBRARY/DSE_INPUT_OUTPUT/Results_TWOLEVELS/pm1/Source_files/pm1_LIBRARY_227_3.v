...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n43_, new_n44_, new_n45_, new_n50_,
  ...
  oai21  g19(.a(new_n32_), .b(new_n31_), .c(x13), .O(z05));
  ...
  nand4  g25(.a(new_n32_), .b(x11), .c(new_n34_), .d(x00), .O(z08));
  nand4  g26(.a(new_n32_), .b(new_n31_), .c(new_n34_), .d(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(z09));
  nand4  g28(.a(x11), .b(new_n34_), .c(new_n30_), .d(x00), .O(new_n58_));
