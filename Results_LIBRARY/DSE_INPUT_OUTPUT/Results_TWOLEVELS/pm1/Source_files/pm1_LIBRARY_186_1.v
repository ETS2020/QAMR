...
module FAU ( 
  ...
  oai22  g08(.a(new_n37_), .b(new_n31_), .c(x13), .d(x12), .O(z01));
  ...
  oai21  g22(.a(new_n51_), .b(new_n45_), .c(new_n49_), .O(new_n52_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n50_), .c(new_n58_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  nor2   g31(.a(new_n45_), .b(x10), .O(new_n61_));
  ...
  nand4  g48(.a(x11), .b(new_n56_), .c(new_n69_), .d(x00), .O(new_n78_));
