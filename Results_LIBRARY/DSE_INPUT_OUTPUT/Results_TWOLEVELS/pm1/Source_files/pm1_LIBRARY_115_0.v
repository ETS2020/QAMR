...
module FAU ( 
  ...
  nor2   g19(.a(x15), .b(x14), .O(new_n49_));
  ...
  nor2   g24(.a(new_n44_), .b(x11), .O(new_n54_));
  aoi21  g25(.a(new_n54_), .b(x14), .c(x15), .O(z07));
  ...
  nand3  g36(.a(new_n57_), .b(new_n49_), .c(x09), .O(new_n66_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n35_), .O(z09));
  nand4  g41(.a(new_n57_), .b(new_n35_), .c(x12), .d(x11), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n56_), .c(x09), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z10));
  inv1   g45(.a(x00), .O(new_n75_));
  nand4  g46(.a(new_n57_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  nand2  g47(.a(new_n59_), .b(new_n30_), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand4  g49(.a(new_n78_), .b(new_n35_), .c(x11), .d(new_n56_), .O(new_n79_));
  nor2   g50(.a(new_n79_), .b(new_n75_), .O(z11));
  inv1   g51(.a(x09), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(x00), .O(new_n82_));
  nand3  g53(.a(x12), .b(x11), .c(new_n56_), .O(new_n83_));
