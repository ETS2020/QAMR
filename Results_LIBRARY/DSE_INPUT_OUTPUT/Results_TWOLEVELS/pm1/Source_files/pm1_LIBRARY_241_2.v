...
module FAU ( 
  ...
  oai21  g12(.a(z07), .b(x12), .c(new_n30_), .O(new_n42_));
  ...
  oai21  g16(.a(new_n45_), .b(z07), .c(new_n42_), .O(z02));
  ...
  nand2  g20(.a(new_n44_), .b(x15), .O(new_n50_));
  nand3  g21(.a(new_n50_), .b(new_n49_), .c(new_n42_), .O(z03));
  aoi21  g22(.a(z07), .b(x11), .c(x14), .O(z04));
  nand2  g23(.a(z07), .b(x11), .O(new_n53_));
  ...
  aoi21  g35(.a(z07), .b(x11), .c(x10), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(new_n64_), .c(new_n55_), .d(x00), .O(z08));
  nand3  g37(.a(new_n60_), .b(z07), .c(x09), .O(new_n67_));
  ...
  nand2  g41(.a(new_n70_), .b(new_n53_), .O(z09));
  nand4  g42(.a(new_n60_), .b(x15), .c(x12), .d(x11), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(new_n59_), .c(x09), .d(x00), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(z10));
  nand4  g46(.a(new_n60_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n33_), .O(new_n77_));
  nand3  g48(.a(new_n77_), .b(new_n59_), .c(x00), .O(new_n78_));
  aoi21  g49(.a(new_n78_), .b(x15), .c(new_n30_), .O(z11));
  inv1   g50(.a(x09), .O(new_n80_));
  nand4  g51(.a(x12), .b(new_n59_), .c(new_n80_), .d(x00), .O(new_n81_));
  aoi21  g52(.a(new_n81_), .b(x15), .c(new_n30_), .O(z12));
endmodule
