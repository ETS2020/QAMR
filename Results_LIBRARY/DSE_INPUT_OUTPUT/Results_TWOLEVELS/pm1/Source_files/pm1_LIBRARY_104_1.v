...
module FAU ( 
  ...
  aoi21  g37(.a(new_n66_), .b(x11), .c(new_n43_), .O(z10));
  nand4  g38(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  nand3  g39(.a(new_n43_), .b(x11), .c(new_n30_), .O(new_n69_));
  ...
  nand4  g43(.a(x11), .b(new_n52_), .c(new_n61_), .d(x00), .O(new_n73_));
  nor2   g44(.a(new_n73_), .b(new_n43_), .O(z12));
endmodule
