...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n51_, new_n54_, new_n56_, new_n57_;
  ...
  nor2   g14(.a(new_n30_), .b(new_n38_), .O(z10));
  ...
  inv1   g21(.a(z10), .O(new_n51_));
  nand2  g22(.a(new_n51_), .b(x15), .O(z07));
  nand4  g23(.a(new_n30_), .b(x11), .c(new_n35_), .d(x00), .O(z08));
  nand3  g24(.a(new_n34_), .b(new_n30_), .c(new_n38_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n51_), .O(z09));
  inv1   g26(.a(x01), .O(new_n56_));
  nand3  g27(.a(new_n35_), .b(new_n56_), .c(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n30_), .c(new_n38_), .O(z11));
  zero   g29(.O(z12));
  nand2  g30(.a(new_n42_), .b(new_n40_), .O(z03));
endmodule
