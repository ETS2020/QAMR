...
module FAU ( 
  ...
  oai21  g17(.a(x14), .b(x12), .c(new_n46_), .O(z03));
  ...
  aoi21  g26(.a(x14), .b(new_n30_), .c(x15), .O(z07));
  ...
  aoi21  g32(.a(x14), .b(new_n30_), .c(x10), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n61_), .c(new_n52_), .d(x00), .O(z08));
  inv1   g34(.a(x00), .O(new_n64_));
  nand3  g35(.a(new_n33_), .b(new_n57_), .c(x00), .O(new_n65_));
  ...
  nand4  g44(.a(x11), .b(new_n57_), .c(new_n73_), .d(x00), .O(new_n74_));
  ...
  nand4  g50(.a(x11), .b(new_n57_), .c(new_n43_), .d(x00), .O(new_n80_));
