...
module FAU ( 
  ...
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n58_), .d(x00), .O(z08));
  ...
  nand3  g39(.a(new_n68_), .b(new_n53_), .c(x00), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n31_), .O(z09));
  nand4  g41(.a(new_n54_), .b(new_n31_), .c(x12), .d(x11), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n53_), .c(x09), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z10));
  inv1   g45(.a(x00), .O(new_n75_));
  nand4  g46(.a(new_n54_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  oai21  g47(.a(x12), .b(x01), .c(new_n76_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(new_n31_), .c(x11), .d(new_n53_), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n75_), .O(z11));
  nand3  g50(.a(new_n59_), .b(x11), .c(new_n53_), .O(new_n80_));
  nor3   g51(.a(new_n80_), .b(x09), .c(new_n75_), .O(z12));
endmodule
