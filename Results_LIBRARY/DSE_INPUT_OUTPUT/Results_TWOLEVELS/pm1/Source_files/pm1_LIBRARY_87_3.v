...
module FAU ( 
  ...
  nand3  g26(.a(new_n47_), .b(new_n45_), .c(new_n41_), .O(z08));
  nand3  g27(.a(new_n36_), .b(new_n30_), .c(new_n32_), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(z09));
  inv1   g29(.a(new_n47_), .O(z10));
  inv1   g30(.a(x01), .O(new_n60_));
  nand3  g31(.a(new_n37_), .b(new_n60_), .c(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n30_), .c(new_n32_), .O(z11));
  zero   g33(.O(z12));
endmodule
