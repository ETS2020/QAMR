...
module FAU ( 
  ...
  oai21  g08(.a(new_n35_), .b(x08), .c(x12), .O(new_n38_));
  nand3  g09(.a(new_n38_), .b(x12), .c(x09), .O(z03));
  nor2   g10(.a(new_n32_), .b(new_n30_), .O(new_n40_));
  ...
  nand3  g16(.a(x12), .b(new_n35_), .c(new_n30_), .O(new_n46_));
  oai21  g17(.a(new_n45_), .b(new_n40_), .c(new_n46_), .O(new_n47_));
  ...
  aoi22  g24(.a(new_n53_), .b(new_n45_), .c(new_n32_), .d(new_n35_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n38_), .c(new_n51_), .d(x00), .O(z08));
  nand2  g26(.a(new_n32_), .b(new_n35_), .O(new_n56_));
  and2   g27(.a(x03), .b(x02), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n44_), .c(x09), .d(x04), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x12), .c(x11), .d(new_n30_), .O(new_n59_));
