...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n38_,
    new_n39_, new_n40_, new_n41_, new_n42_, new_n44_, new_n45_, new_n48_,
    new_n51_, new_n52_, new_n53_, new_n57_, new_n59_, new_n60_;
  ...
  nor2   g17(.a(new_n30_), .b(new_n33_), .O(z10));
  ...
  oai21  g24(.a(new_n51_), .b(new_n30_), .c(new_n53_), .O(z06));
  nor2   g25(.a(z10), .b(x15), .O(z07));
  nand2  g26(.a(new_n45_), .b(new_n40_), .O(z08));
  ...
  nand4  g30(.a(x11), .b(new_n34_), .c(new_n59_), .d(x00), .O(new_n60_));
  nor2   g31(.a(new_n60_), .b(x12), .O(z11));
  nor2   g32(.a(new_n30_), .b(new_n33_), .O(z12));
endmodule
