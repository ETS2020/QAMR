...
module FAU ( 
  ...
  nand2  g05(.a(x15), .b(z04), .O(new_n35_));
  ...
  nor2   g21(.a(new_n31_), .b(x13), .O(z05));
  ...
  oai21  g26(.a(new_n42_), .b(x11), .c(new_n30_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n35_), .O(z07));
  ...
  aoi21  g34(.a(new_n63_), .b(new_n52_), .c(new_n59_), .O(new_n64_));
