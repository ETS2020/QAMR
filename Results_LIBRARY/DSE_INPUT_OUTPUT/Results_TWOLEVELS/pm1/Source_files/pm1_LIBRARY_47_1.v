...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n36_, new_n37_,
    ...
    new_n49_, new_n52_, new_n53_, new_n54_, new_n57_, new_n58_, new_n59_,
  ...
  aoi21  g12(.a(new_n39_), .b(x11), .c(new_n41_), .O(new_n42_));
  oai21  g13(.a(new_n42_), .b(new_n32_), .c(x12), .O(z02));
  nand3  g14(.a(x11), .b(x08), .c(x07), .O(new_n44_));
  nor2   g15(.a(new_n44_), .b(new_n35_), .O(new_n45_));
  oai21  g16(.a(new_n45_), .b(new_n41_), .c(x09), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x12), .O(z03));
  nor2   g18(.a(new_n40_), .b(x09), .O(z12));
  inv1   g19(.a(z12), .O(new_n49_));
  nand2  g20(.a(new_n49_), .b(x14), .O(z04));
  nor2   g21(.a(z12), .b(x13), .O(z05));
  aoi21  g22(.a(new_n31_), .b(x01), .c(new_n32_), .O(new_n52_));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(x09), .c(x01), .O(new_n54_));
  oai21  g25(.a(new_n52_), .b(new_n40_), .c(new_n54_), .O(z06));
  ...
  aoi22  g31(.a(new_n60_), .b(new_n58_), .c(new_n40_), .d(new_n31_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n33_), .c(new_n57_), .d(x00), .O(z08));
  nand2  g33(.a(new_n40_), .b(new_n31_), .O(new_n63_));
  nand2  g34(.a(new_n53_), .b(new_n32_), .O(new_n64_));
  ...
  nand4  g40(.a(new_n53_), .b(x12), .c(x11), .d(new_n57_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n32_), .c(new_n69_), .O(z10));
