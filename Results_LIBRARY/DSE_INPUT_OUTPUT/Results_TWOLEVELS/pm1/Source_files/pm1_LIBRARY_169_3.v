...
module FAU ( 
  ...
  nand2  g12(.a(new_n38_), .b(x13), .O(z05));
  ...
  nand3  g23(.a(x12), .b(x11), .c(new_n30_), .O(new_n53_));
  nand2  g24(.a(new_n32_), .b(new_n35_), .O(new_n54_));
  ...
  nand4  g29(.a(x11), .b(new_n49_), .c(new_n59_), .d(x00), .O(new_n60_));
  nor2   g30(.a(new_n60_), .b(x12), .O(z11));
  nand4  g31(.a(x11), .b(new_n49_), .c(new_n30_), .d(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(new_n30_), .c(new_n32_), .O(z12));
  zero   g33(.O(z10));
endmodule
