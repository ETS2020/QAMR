...
module FAU ( 
  ...
  nand2  g12(.a(x15), .b(new_n30_), .O(new_n42_));
  ...
  nor2   g17(.a(x15), .b(x12), .O(new_n47_));
  ...
  nand2  g23(.a(x12), .b(new_n32_), .O(new_n53_));
  ...
  nor2   g27(.a(x15), .b(new_n30_), .O(z07));
  inv1   g28(.a(x10), .O(new_n58_));
  nand3  g29(.a(x12), .b(x11), .c(x09), .O(new_n59_));
  oai22  g30(.a(new_n59_), .b(new_n51_), .c(x12), .d(x11), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nor2   g32(.a(new_n47_), .b(x10), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n61_), .c(new_n53_), .d(x00), .O(z08));
  inv1   g34(.a(x00), .O(new_n64_));
  nand3  g35(.a(new_n32_), .b(new_n58_), .c(x00), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(x15), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n30_), .O(new_n67_));
  and2   g38(.a(x03), .b(x02), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n51_), .c(x09), .d(x04), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x12), .c(x11), .d(new_n58_), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n64_), .c(new_n67_), .O(z09));
  nand4  g42(.a(new_n51_), .b(x12), .c(x11), .d(new_n58_), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(x09), .c(x00), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n48_), .O(z10));
  nand4  g46(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  inv1   g47(.a(x01), .O(new_n77_));
  nand3  g48(.a(x15), .b(new_n30_), .c(new_n77_), .O(new_n78_));
