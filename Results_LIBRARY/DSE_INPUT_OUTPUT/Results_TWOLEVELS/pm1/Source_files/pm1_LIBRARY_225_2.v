...
module FAU ( 
  ...
  oai21  g24(.a(new_n52_), .b(new_n48_), .c(new_n53_), .O(new_n54_));
  ...
  nand4  g41(.a(new_n51_), .b(x12), .c(x11), .d(new_n59_), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n40_), .c(new_n58_), .O(z10));
  nor2   g43(.a(new_n52_), .b(x10), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(x09), .c(x01), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x12), .c(new_n30_), .O(z11));
  nand4  g46(.a(x12), .b(new_n59_), .c(new_n40_), .d(x00), .O(new_n76_));
