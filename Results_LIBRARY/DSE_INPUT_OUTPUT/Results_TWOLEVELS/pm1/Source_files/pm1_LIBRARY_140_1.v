...
module FAU ( 
  ...
  nor2   g25(.a(x15), .b(x14), .O(z04));
  aoi21  g26(.a(x15), .b(new_n30_), .c(x13), .O(z05));
  ...
  nand2  g31(.a(new_n36_), .b(new_n48_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n41_), .O(z07));
  ...
  aoi22  g39(.a(new_n68_), .b(x11), .c(x15), .d(new_n30_), .O(z08));
