...
module FAU ( 
  ...
  nand2  g26(.a(new_n49_), .b(x00), .O(new_n56_));
  ...
  nand4  g38(.a(new_n61_), .b(x12), .c(x11), .d(new_n55_), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n67_), .c(new_n54_), .O(z10));
  nand3  g40(.a(new_n61_), .b(new_n55_), .c(x09), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(x01), .c(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x12), .c(new_n34_), .O(z11));
  nand4  g44(.a(x11), .b(new_n55_), .c(new_n67_), .d(x00), .O(new_n74_));
  nor2   g45(.a(new_n74_), .b(new_n37_), .O(z12));
endmodule
