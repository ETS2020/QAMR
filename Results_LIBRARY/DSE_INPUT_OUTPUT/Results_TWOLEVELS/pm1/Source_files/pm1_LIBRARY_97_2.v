...
module FAU ( 
  ...
  nand3  g30(.a(x11), .b(new_n59_), .c(x09), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n53_), .c(new_n30_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n54_), .c(new_n59_), .d(x00), .O(z08));
  nand2  g34(.a(x03), .b(x02), .O(new_n64_));
  nand2  g35(.a(new_n52_), .b(x04), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n64_), .c(x09), .O(new_n66_));
  nand2  g37(.a(x12), .b(new_n43_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(x11), .c(new_n59_), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(x12), .c(new_n31_), .O(z09));
  nand4  g41(.a(new_n52_), .b(x11), .c(new_n59_), .d(x09), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x12), .c(new_n31_), .O(z10));
  inv1   g43(.a(new_n71_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(x01), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x12), .c(new_n31_), .O(z11));
  nand4  g46(.a(x11), .b(new_n59_), .c(new_n43_), .d(x00), .O(new_n76_));
