...
module FAU ( 
  ...
  nor2   g06(.a(new_n30_), .b(x11), .O(new_n36_));
  inv1   g07(.a(new_n36_), .O(new_n37_));
  nand3  g08(.a(new_n37_), .b(new_n34_), .c(x12), .O(z01));
  ...
  nand2  g15(.a(x14), .b(x11), .O(z04));
  nor2   g16(.a(new_n36_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  inv1   g19(.a(x11), .O(new_n49_));
  nand3  g20(.a(new_n30_), .b(x12), .c(new_n49_), .O(new_n50_));
  oai21  g21(.a(new_n48_), .b(new_n36_), .c(new_n50_), .O(new_n51_));
  ...
  nand4  g28(.a(x12), .b(new_n56_), .c(x09), .d(x04), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n55_), .c(x11), .O(new_n60_));
  oai21  g31(.a(x14), .b(x11), .c(new_n60_), .O(z08));
  and2   g32(.a(x03), .b(x02), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n47_), .c(x09), .d(x04), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x12), .c(x11), .O(new_n64_));
  inv1   g35(.a(x12), .O(new_n65_));
  nand3  g36(.a(new_n30_), .b(new_n65_), .c(new_n49_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(new_n56_), .c(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z09));
  nand4  g40(.a(new_n47_), .b(x12), .c(x11), .d(new_n56_), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(x09), .c(x00), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n37_), .O(z10));
  ...
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(new_n37_), .O(z12));
endmodule
