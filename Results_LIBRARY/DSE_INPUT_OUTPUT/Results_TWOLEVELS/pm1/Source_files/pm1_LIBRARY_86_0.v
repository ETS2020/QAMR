...
module FAU ( 
  ...
  nor2   g17(.a(x13), .b(new_n30_), .O(z05));
  ...
  nand3  g28(.a(x13), .b(new_n30_), .c(new_n32_), .O(new_n58_));
  ...
  nand4  g33(.a(new_n56_), .b(new_n49_), .c(x09), .d(x04), .O(new_n63_));
  ...
  nand2  g44(.a(new_n73_), .b(x13), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n30_), .O(new_n75_));
  nand3  g46(.a(new_n70_), .b(x01), .c(x00), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n75_), .O(z11));
  nand4  g48(.a(x11), .b(new_n55_), .c(new_n68_), .d(x00), .O(new_n78_));
