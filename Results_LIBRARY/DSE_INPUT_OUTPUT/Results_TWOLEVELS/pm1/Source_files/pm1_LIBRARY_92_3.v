...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_, new_n37_,
    new_n38_, new_n41_, new_n42_, new_n43_, new_n44_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    new_n60_, new_n61_, new_n62_, new_n63_, new_n65_, new_n66_, new_n67_,
    new_n69_, new_n70_, new_n71_, new_n73_, new_n74_, new_n75_;
  inv1   g00(.a(x01), .O(new_n30_));
  inv1   g01(.a(x15), .O(z07));
  nand4  g02(.a(x11), .b(x07), .c(x06), .d(x05), .O(new_n32_));
  nand2  g03(.a(new_n32_), .b(z07), .O(new_n33_));
  ...
  nand3  g10(.a(new_n36_), .b(new_n34_), .c(x12), .O(z01));
  inv1   g11(.a(x12), .O(new_n41_));
  nand2  g12(.a(x15), .b(x08), .O(new_n42_));
  inv1   g13(.a(new_n42_), .O(new_n43_));
  nor2   g14(.a(new_n43_), .b(new_n41_), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n38_), .c(new_n36_), .d(x09), .O(z02));
  nand4  g16(.a(new_n34_), .b(x12), .c(x11), .d(x09), .O(z03));
  nand2  g17(.a(new_n42_), .b(x14), .O(z04));
  nand2  g18(.a(new_n42_), .b(x13), .O(z05));
  nand4  g19(.a(new_n38_), .b(x04), .c(x03), .d(x02), .O(new_n49_));
  nand4  g20(.a(new_n49_), .b(new_n42_), .c(x09), .d(x01), .O(new_n50_));
  inv1   g21(.a(new_n50_), .O(z06));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  nand3  g24(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  nand2  g25(.a(new_n41_), .b(new_n37_), .O(new_n55_));
  oai21  g26(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  nor2   g28(.a(new_n43_), .b(x10), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n57_), .c(new_n38_), .d(x00), .O(z08));
  nand4  g30(.a(new_n53_), .b(x15), .c(x09), .d(x08), .O(new_n60_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n42_), .O(z09));
  nand4  g35(.a(new_n53_), .b(new_n42_), .c(x12), .d(x11), .O(new_n65_));
