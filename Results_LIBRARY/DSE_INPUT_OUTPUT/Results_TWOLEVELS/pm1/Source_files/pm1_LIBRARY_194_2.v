...
module FAU ( 
  ...
  nand2  g13(.a(z04), .b(x13), .O(new_n43_));
  ...
  oai21  g24(.a(z04), .b(new_n53_), .c(x13), .O(new_n54_));
  ...
  oai21  g33(.a(new_n38_), .b(new_n37_), .c(new_n30_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n43_), .O(z05));
  ...
  aoi21  g39(.a(z04), .b(x13), .c(x15), .O(z07));
  inv1   g40(.a(x00), .O(new_n70_));
  oai21  g41(.a(x13), .b(new_n53_), .c(z04), .O(new_n71_));
