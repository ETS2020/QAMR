...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n53_, new_n54_, new_n56_, new_n60_, new_n61_, new_n64_, new_n65_,
  ...
  oai21  g07(.a(new_n36_), .b(new_n34_), .c(x07), .O(new_n37_));
  ...
  nand3  g12(.a(new_n41_), .b(new_n38_), .c(new_n33_), .O(z00));
  ...
  nand4  g27(.a(new_n56_), .b(new_n44_), .c(new_n33_), .d(x09), .O(z03));
  ...
  nor2   g40(.a(new_n53_), .b(x10), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n69_), .c(new_n44_), .d(x00), .O(z08));
  nand4  g42(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n52_), .O(new_n73_));
  ...
  nand3  g48(.a(new_n77_), .b(new_n64_), .c(x00), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n52_), .O(z09));
  nand4  g50(.a(new_n65_), .b(new_n52_), .c(x12), .d(x11), .O(new_n80_));
  inv1   g51(.a(new_n80_), .O(new_n81_));
  nand4  g52(.a(new_n81_), .b(new_n64_), .c(x09), .d(x00), .O(new_n82_));
  inv1   g53(.a(new_n82_), .O(z10));
  nand4  g54(.a(new_n65_), .b(x12), .c(x09), .d(x01), .O(new_n84_));
  oai21  g55(.a(x12), .b(x01), .c(new_n84_), .O(new_n85_));
  nand4  g56(.a(new_n85_), .b(x11), .c(new_n64_), .d(x00), .O(new_n86_));
  nand2  g57(.a(new_n86_), .b(new_n52_), .O(z11));
  inv1   g58(.a(x00), .O(new_n88_));
  nand4  g59(.a(new_n52_), .b(x12), .c(x11), .d(new_n64_), .O(new_n89_));
