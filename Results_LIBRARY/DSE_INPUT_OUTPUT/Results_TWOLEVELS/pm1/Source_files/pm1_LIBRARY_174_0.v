...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n54_, new_n58_, new_n59_, new_n61_, new_n62_, new_n64_, new_n65_,
  ...
  nor2   g04(.a(x15), .b(x13), .O(new_n34_));
  ...
  aoi21  g14(.a(new_n38_), .b(x12), .c(new_n34_), .O(z01));
  inv1   g15(.a(x12), .O(new_n45_));
  nand2  g16(.a(x08), .b(x07), .O(new_n46_));
  nor4   g17(.a(new_n46_), .b(new_n36_), .c(new_n45_), .d(new_n39_), .O(new_n47_));
  inv1   g18(.a(x09), .O(new_n48_));
  nand2  g19(.a(new_n32_), .b(new_n48_), .O(new_n49_));
  oai21  g20(.a(new_n47_), .b(new_n34_), .c(new_n49_), .O(z02));
  nor2   g21(.a(new_n45_), .b(new_n39_), .O(new_n51_));
  nand3  g22(.a(x11), .b(x08), .c(x07), .O(new_n52_));
  oai21  g23(.a(new_n52_), .b(new_n36_), .c(new_n51_), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n35_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n49_), .O(z03));
  nand2  g26(.a(new_n32_), .b(x14), .O(z04));
  ...
  nand2  g31(.a(new_n51_), .b(new_n38_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n31_), .c(x13), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z07));
  inv1   g34(.a(x10), .O(new_n64_));
  nand4  g35(.a(new_n32_), .b(new_n45_), .c(new_n64_), .d(x00), .O(new_n65_));
