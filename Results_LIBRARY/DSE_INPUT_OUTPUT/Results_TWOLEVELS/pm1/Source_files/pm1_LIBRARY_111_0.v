...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n47_, new_n49_, new_n52_, new_n53_, new_n54_, new_n55_, new_n58_,
    new_n59_, new_n60_, new_n61_, new_n62_, new_n63_, new_n64_, new_n66_,
    new_n68_, new_n69_, new_n70_, new_n71_, new_n72_, new_n74_, new_n75_,
    new_n77_, new_n78_, new_n79_;
  oai21  g00(.a(x11), .b(x01), .c(x09), .O(new_n30_));
  ...
  nand2  g31(.a(new_n40_), .b(new_n31_), .O(new_n61_));
  ...
  nand3  g36(.a(x11), .b(new_n58_), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(x09), .O(z12));
  inv1   g38(.a(z12), .O(new_n68_));
  nand3  g39(.a(new_n59_), .b(new_n52_), .c(x04), .O(new_n69_));
  ...
  nand4  g45(.a(new_n59_), .b(x12), .c(x11), .d(new_n58_), .O(new_n75_));
  nor3   g46(.a(new_n75_), .b(new_n43_), .c(new_n74_), .O(z10));
  nand3  g47(.a(new_n59_), .b(x12), .c(x01), .O(new_n77_));
  oai21  g48(.a(x12), .b(x01), .c(new_n77_), .O(new_n78_));
  nand4  g49(.a(new_n78_), .b(x11), .c(new_n58_), .d(x09), .O(new_n79_));
  nor2   g50(.a(new_n79_), .b(new_n74_), .O(z11));
endmodule
