...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n38_,
    new_n39_, new_n41_, new_n43_, new_n46_, new_n47_, new_n50_, new_n51_,
  ...
  aoi21  g24(.a(new_n51_), .b(new_n34_), .c(new_n53_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n35_), .c(new_n50_), .d(x00), .O(z08));
  nand2  g26(.a(new_n51_), .b(new_n34_), .O(new_n56_));
  ...
  nand4  g35(.a(new_n46_), .b(x12), .c(x11), .d(new_n50_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(z10));
  nand4  g37(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  nand3  g38(.a(new_n51_), .b(x11), .c(new_n30_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n50_), .c(x00), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n35_), .O(z11));
  nand4  g42(.a(x11), .b(new_n50_), .c(new_n64_), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x11), .c(new_n51_), .O(z12));
endmodule
