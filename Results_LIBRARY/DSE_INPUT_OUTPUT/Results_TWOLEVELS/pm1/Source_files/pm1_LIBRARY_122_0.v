...
module FAU ( 
  ...
  nor2   g27(.a(new_n56_), .b(new_n33_), .O(new_n57_));
  ...
  oai21  g34(.a(new_n63_), .b(new_n60_), .c(new_n37_), .O(z09));
  ...
  nand2  g41(.a(new_n56_), .b(new_n70_), .O(new_n71_));
  ...
  nand4  g46(.a(x11), .b(new_n53_), .c(new_n75_), .d(x00), .O(new_n76_));
  nor2   g47(.a(new_n76_), .b(new_n56_), .O(z12));
endmodule
