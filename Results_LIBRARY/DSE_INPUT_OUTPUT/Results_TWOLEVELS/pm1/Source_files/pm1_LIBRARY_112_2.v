...
module FAU ( 
  ...
  nor2   g21(.a(x12), .b(new_n30_), .O(new_n51_));
  ...
  oai21  g27(.a(new_n56_), .b(new_n51_), .c(new_n36_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(x09), .c(x01), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z06));
  nand2  g30(.a(new_n52_), .b(x15), .O(z07));
  inv1   g31(.a(x10), .O(new_n61_));
  nand3  g32(.a(x12), .b(x11), .c(x09), .O(new_n62_));
  nand3  g33(.a(new_n40_), .b(new_n32_), .c(new_n30_), .O(new_n63_));
  oai21  g34(.a(new_n62_), .b(new_n55_), .c(new_n63_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  nor2   g36(.a(new_n51_), .b(x10), .O(new_n66_));
  ...
  nand4  g45(.a(new_n55_), .b(x12), .c(x11), .d(new_n61_), .O(new_n75_));
  nor3   g46(.a(new_n75_), .b(new_n41_), .c(new_n74_), .O(z10));
  nand4  g47(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n77_));
  oai21  g48(.a(new_n49_), .b(x01), .c(new_n77_), .O(new_n78_));
  nand4  g49(.a(new_n78_), .b(x11), .c(new_n61_), .d(x00), .O(new_n79_));
  inv1   g50(.a(new_n79_), .O(z11));
  nand4  g51(.a(x11), .b(new_n61_), .c(new_n41_), .d(x00), .O(new_n81_));
  nor2   g52(.a(new_n81_), .b(new_n40_), .O(z12));
endmodule
