...
module FAU ( 
  ...
  nor2   g26(.a(new_n47_), .b(new_n33_), .O(new_n56_));
  ...
  nand4  g35(.a(new_n49_), .b(x12), .c(x11), .d(new_n53_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n59_), .O(z10));
  nand4  g37(.a(new_n49_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  inv1   g38(.a(x01), .O(new_n68_));
  nand2  g39(.a(new_n47_), .b(new_n68_), .O(new_n69_));
  ...
  nand2  g44(.a(new_n56_), .b(new_n53_), .O(new_n74_));
