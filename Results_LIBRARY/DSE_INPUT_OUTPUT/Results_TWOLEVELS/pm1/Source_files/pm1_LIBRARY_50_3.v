...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n36_, new_n37_,
    ...
    new_n49_, new_n53_, new_n56_, new_n57_;
  ...
  nand3  g10(.a(new_n32_), .b(new_n35_), .c(x00), .O(new_n40_));
  ...
  inv1   g25(.a(new_n43_), .O(z10));
  inv1   g26(.a(x01), .O(new_n56_));
  nand3  g27(.a(new_n35_), .b(new_n56_), .c(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n30_), .c(new_n32_), .O(z11));
  zero   g29(.O(z12));
  oai21  g30(.a(new_n39_), .b(x11), .c(new_n41_), .O(z03));
endmodule
