...
module FAU ( 
  ...
  nand4  g38(.a(new_n67_), .b(new_n31_), .c(x12), .d(x11), .O(new_n68_));
  ...
  nand4  g47(.a(new_n31_), .b(x12), .c(x11), .d(new_n55_), .O(new_n77_));
  nor3   g48(.a(new_n77_), .b(x09), .c(new_n56_), .O(z12));
endmodule
