...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n36_, new_n37_,
    ...
    new_n45_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_,
  ...
  oai21  g10(.a(new_n39_), .b(new_n36_), .c(x12), .O(new_n40_));
  nand2  g11(.a(new_n40_), .b(x08), .O(new_n41_));
  nand2  g12(.a(x12), .b(new_n32_), .O(new_n42_));
  ...
  nand3  g16(.a(new_n45_), .b(new_n43_), .c(new_n41_), .O(z01));
  inv1   g17(.a(x12), .O(new_n47_));
  nand2  g18(.a(x11), .b(x09), .O(new_n48_));
  aoi21  g19(.a(new_n44_), .b(x11), .c(new_n48_), .O(new_n49_));
  oai21  g20(.a(new_n49_), .b(new_n47_), .c(new_n43_), .O(z02));
  nor2   g21(.a(x12), .b(x08), .O(new_n51_));
  aoi21  g22(.a(new_n48_), .b(x12), .c(new_n51_), .O(new_n52_));
  nand2  g23(.a(new_n52_), .b(new_n41_), .O(z03));
  ...
  oai21  g30(.a(new_n59_), .b(new_n54_), .c(new_n42_), .O(new_n60_));
  ...
  nor3   g36(.a(new_n58_), .b(new_n37_), .c(new_n65_), .O(new_n66_));
  ...
  nand4  g40(.a(new_n69_), .b(new_n68_), .c(new_n42_), .d(x00), .O(z08));
  ...
  nand2  g59(.a(new_n38_), .b(new_n64_), .O(new_n89_));
