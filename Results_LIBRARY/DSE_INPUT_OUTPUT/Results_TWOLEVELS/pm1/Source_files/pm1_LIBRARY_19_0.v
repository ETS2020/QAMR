...
module FAU ( 
  ...
  nand2  g02(.a(z07), .b(new_n30_), .O(new_n32_));
  inv1   g03(.a(new_n32_), .O(new_n33_));
  inv1   g04(.a(x11), .O(new_n34_));
  aoi21  g05(.a(x12), .b(new_n34_), .c(x01), .O(new_n35_));
  oai21  g06(.a(x15), .b(x14), .c(x11), .O(new_n36_));
  oai21  g07(.a(new_n35_), .b(new_n33_), .c(new_n36_), .O(z00));
  inv1   g08(.a(x12), .O(new_n38_));
  nor2   g09(.a(new_n33_), .b(new_n38_), .O(new_n39_));
  nand2  g10(.a(new_n39_), .b(new_n36_), .O(z01));
  nand3  g11(.a(x07), .b(x06), .c(x05), .O(new_n41_));
  inv1   g12(.a(new_n41_), .O(new_n42_));
  and2   g13(.a(x09), .b(x08), .O(new_n43_));
  nand4  g14(.a(new_n43_), .b(new_n42_), .c(new_n39_), .d(x11), .O(z02));
  nand4  g15(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n45_));
  nand4  g16(.a(new_n45_), .b(new_n39_), .c(x11), .d(x09), .O(z03));
  nor2   g17(.a(z07), .b(x14), .O(z04));
  ...
  nand2  g22(.a(new_n51_), .b(new_n32_), .O(z06));
  inv1   g23(.a(x00), .O(new_n53_));
  inv1   g24(.a(x10), .O(new_n54_));
  nand4  g25(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n55_));
  nand4  g26(.a(x12), .b(x11), .c(new_n54_), .d(x09), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(new_n57_));
  nor2   g28(.a(new_n57_), .b(new_n53_), .O(new_n58_));
  aoi22  g29(.a(new_n58_), .b(x11), .c(z07), .d(new_n30_), .O(z08));
  nand2  g30(.a(x03), .b(x02), .O(new_n60_));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(x04), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n60_), .c(new_n32_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(x09), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(x12), .c(x11), .O(new_n65_));
  nand2  g36(.a(new_n38_), .b(new_n34_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(new_n54_), .c(x00), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n32_), .O(z09));
  nand4  g40(.a(new_n61_), .b(new_n32_), .c(x12), .d(x11), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(new_n54_), .c(x09), .d(x00), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(z10));
  nand4  g44(.a(new_n61_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  oai21  g45(.a(x12), .b(x01), .c(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n54_), .d(x00), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n32_), .O(z11));
  inv1   g48(.a(x09), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(x00), .O(new_n79_));
  nand3  g50(.a(x12), .b(x11), .c(new_n54_), .O(new_n80_));
