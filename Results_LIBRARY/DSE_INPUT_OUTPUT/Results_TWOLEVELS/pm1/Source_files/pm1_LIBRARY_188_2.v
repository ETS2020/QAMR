...
module FAU ( 
  ...
  nand2  g16(.a(new_n36_), .b(new_n34_), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(x15), .c(x11), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(new_n45_), .O(z01));
  nand3  g19(.a(new_n30_), .b(new_n41_), .c(x00), .O(new_n49_));
  inv1   g20(.a(new_n49_), .O(new_n50_));
  inv1   g21(.a(x15), .O(new_n51_));
  nor2   g22(.a(new_n51_), .b(new_n30_), .O(new_n52_));
  oai21  g23(.a(new_n52_), .b(new_n50_), .c(new_n32_), .O(new_n53_));
  nand2  g24(.a(new_n43_), .b(new_n30_), .O(new_n54_));
  ...
  nor2   g46(.a(x15), .b(x12), .O(z07));
  nand2  g47(.a(new_n30_), .b(new_n32_), .O(new_n77_));
  nand3  g48(.a(new_n52_), .b(x11), .c(x09), .O(new_n78_));
  oai21  g49(.a(new_n78_), .b(new_n72_), .c(new_n77_), .O(new_n79_));
  nand3  g50(.a(new_n79_), .b(new_n41_), .c(x00), .O(new_n80_));
  aoi22  g51(.a(new_n59_), .b(new_n42_), .c(new_n52_), .d(new_n32_), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n80_), .O(z08));
  nand4  g53(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n83_));
  aoi21  g54(.a(new_n83_), .b(x09), .c(new_n51_), .O(new_n84_));
  oai21  g55(.a(new_n84_), .b(new_n73_), .c(x12), .O(new_n85_));
  oai21  g56(.a(new_n85_), .b(new_n32_), .c(new_n77_), .O(new_n86_));
  nand3  g57(.a(new_n86_), .b(new_n41_), .c(x00), .O(new_n87_));
  nand2  g58(.a(new_n87_), .b(new_n59_), .O(z09));
  nand3  g59(.a(new_n72_), .b(x11), .c(new_n41_), .O(new_n89_));
  inv1   g60(.a(new_n89_), .O(new_n90_));
  nand3  g61(.a(new_n90_), .b(x09), .c(x00), .O(new_n91_));
  aoi21  g62(.a(new_n91_), .b(x15), .c(new_n30_), .O(z10));
  inv1   g63(.a(x01), .O(new_n93_));
  nand4  g64(.a(new_n72_), .b(x15), .c(x12), .d(x09), .O(new_n94_));
  nand2  g65(.a(new_n30_), .b(new_n93_), .O(new_n95_));
  oai21  g66(.a(new_n94_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  nand4  g67(.a(new_n96_), .b(x11), .c(new_n41_), .d(x00), .O(new_n97_));
  inv1   g68(.a(new_n97_), .O(z11));
  nand4  g69(.a(x11), .b(new_n41_), .c(new_n64_), .d(x00), .O(new_n99_));
  nor3   g70(.a(new_n99_), .b(new_n51_), .c(new_n30_), .O(z12));
endmodule
