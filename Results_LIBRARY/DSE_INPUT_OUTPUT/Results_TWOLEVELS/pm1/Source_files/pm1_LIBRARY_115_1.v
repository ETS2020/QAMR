...
module FAU ( 
  ...
  nand2  g16(.a(x12), .b(new_n35_), .O(new_n46_));
  ...
  and2   g20(.a(new_n39_), .b(new_n35_), .O(new_n50_));
  oai21  g21(.a(new_n50_), .b(x15), .c(new_n31_), .O(z07));
  ...
  nand4  g31(.a(new_n53_), .b(x15), .c(z04), .d(x09), .O(new_n61_));
