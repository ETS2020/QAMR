...
module FAU ( 
  ...
  nand2  g28(.a(new_n33_), .b(new_n42_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n57_), .O(z08));
  nand4  g30(.a(new_n53_), .b(new_n47_), .c(x09), .d(x04), .O(new_n60_));
  ...
  nand4  g36(.a(new_n47_), .b(x12), .c(x11), .d(new_n52_), .O(new_n66_));
  nor3   g37(.a(new_n66_), .b(new_n65_), .c(new_n51_), .O(z10));
  ...
  nand4  g42(.a(x11), .b(new_n52_), .c(new_n65_), .d(x00), .O(new_n72_));
