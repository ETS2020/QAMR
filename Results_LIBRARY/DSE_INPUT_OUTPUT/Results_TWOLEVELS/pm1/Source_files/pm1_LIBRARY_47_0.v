...
module FAU ( 
  ...
  nand2  g07(.a(new_n32_), .b(x09), .O(new_n37_));
  ...
  aoi21  g36(.a(new_n65_), .b(x12), .c(x09), .O(z12));
  inv1   g37(.a(z12), .O(new_n67_));
  nand3  g38(.a(new_n58_), .b(new_n52_), .c(x04), .O(new_n68_));
  ...
  nand4  g44(.a(new_n58_), .b(x12), .c(x11), .d(new_n57_), .O(new_n74_));
  nor3   g45(.a(new_n74_), .b(new_n39_), .c(new_n73_), .O(z10));
  nand3  g46(.a(new_n58_), .b(x12), .c(x01), .O(new_n76_));
  oai21  g47(.a(x12), .b(x01), .c(new_n76_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x11), .c(new_n57_), .d(x09), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n73_), .O(z11));
endmodule
