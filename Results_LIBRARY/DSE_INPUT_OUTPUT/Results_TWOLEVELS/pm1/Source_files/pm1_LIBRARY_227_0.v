...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n43_, new_n44_, new_n45_, new_n49_,
  ...
  nor2   g17(.a(new_n34_), .b(x14), .O(z04));
  nand2  g18(.a(new_n35_), .b(x13), .O(z05));
  aoi21  g19(.a(x09), .b(x01), .c(new_n42_), .O(new_n49_));
  ...
  nand4  g29(.a(new_n58_), .b(new_n56_), .c(x12), .d(x11), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(x11), .c(new_n54_), .d(x00), .O(z08));
  inv1   g31(.a(x00), .O(new_n61_));
  and2   g32(.a(x03), .b(x02), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n50_), .c(x09), .d(x04), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(x12), .c(x11), .d(new_n54_), .O(new_n64_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n35_), .O(z10));
  nand4  g40(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n70_));
  inv1   g41(.a(x01), .O(new_n71_));
  nand2  g42(.a(new_n42_), .b(new_n71_), .O(new_n72_));
  ...
  nand4  g46(.a(x11), .b(new_n54_), .c(new_n57_), .d(x00), .O(new_n76_));
