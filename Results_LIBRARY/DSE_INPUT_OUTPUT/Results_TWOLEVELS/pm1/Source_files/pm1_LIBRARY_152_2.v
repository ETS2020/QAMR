...
module FAU ( 
  ...
  nand3  g24(.a(new_n53_), .b(new_n51_), .c(x04), .O(new_n54_));
  nand3  g25(.a(new_n54_), .b(x09), .c(x01), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n48_), .O(z06));
  nand2  g27(.a(new_n48_), .b(x15), .O(z07));
  nor2   g28(.a(x10), .b(new_n39_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n53_), .c(x04), .d(x00), .O(new_n59_));
  ...
  oai21  g37(.a(new_n66_), .b(new_n52_), .c(x09), .O(new_n67_));
  nand2  g38(.a(x12), .b(new_n39_), .O(new_n68_));
  ...
  nand4  g42(.a(new_n65_), .b(new_n64_), .c(x09), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(x12), .c(new_n30_), .O(z10));
  nand4  g44(.a(new_n65_), .b(x12), .c(x11), .d(new_n64_), .O(new_n74_));
