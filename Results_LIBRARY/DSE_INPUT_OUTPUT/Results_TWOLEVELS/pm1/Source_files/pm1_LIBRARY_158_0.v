...
module FAU ( 
  ...
  nand2  g26(.a(new_n55_), .b(new_n50_), .O(z06));
  ...
  nand3  g33(.a(new_n62_), .b(new_n58_), .c(x00), .O(new_n63_));
  inv1   g34(.a(x00), .O(new_n64_));
  oai21  g35(.a(x10), .b(new_n64_), .c(new_n50_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(new_n63_), .c(new_n53_), .O(z08));
  ...
  nor3   g43(.a(new_n72_), .b(new_n42_), .c(new_n64_), .O(z10));
  nand4  g44(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  oai21  g45(.a(new_n46_), .b(x01), .c(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n58_), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand4  g48(.a(x11), .b(new_n58_), .c(new_n42_), .d(x00), .O(new_n78_));
