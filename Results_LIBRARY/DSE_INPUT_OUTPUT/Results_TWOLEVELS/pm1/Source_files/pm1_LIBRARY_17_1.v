...
module FAU ( 
  ...
  nand4  g19(.a(new_n48_), .b(new_n35_), .c(x09), .d(x01), .O(new_n49_));
  ...
  aoi21  g26(.a(new_n53_), .b(new_n34_), .c(new_n55_), .O(new_n56_));
  ...
  nand3  g35(.a(new_n48_), .b(x11), .c(new_n52_), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x09), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x11), .c(new_n53_), .O(z10));
  ...
  nand4  g44(.a(x11), .b(new_n52_), .c(new_n73_), .d(x00), .O(new_n74_));
