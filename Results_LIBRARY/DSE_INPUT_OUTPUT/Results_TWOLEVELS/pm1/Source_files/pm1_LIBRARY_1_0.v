...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    ...
    new_n49_, new_n51_, new_n52_, new_n53_, new_n54_, new_n55_, new_n58_,
  ...
  nor2   g19(.a(x14), .b(x12), .O(new_n49_));
  nor2   g20(.a(new_n49_), .b(x13), .O(z05));
  inv1   g21(.a(new_n49_), .O(new_n51_));
  ...
  nand2  g26(.a(new_n55_), .b(new_n51_), .O(z06));
  ...
  nand3  g31(.a(x14), .b(new_n30_), .c(new_n32_), .O(new_n61_));
  ...
  nand4  g35(.a(new_n64_), .b(new_n63_), .c(new_n53_), .d(x00), .O(z08));
  nand4  g36(.a(new_n59_), .b(new_n52_), .c(x09), .d(x04), .O(new_n66_));
  ...
  nand2  g44(.a(new_n73_), .b(new_n51_), .O(z10));
  nand4  g45(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n75_));
  oai21  g46(.a(new_n46_), .b(x01), .c(new_n75_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(x11), .c(new_n58_), .d(x00), .O(new_n77_));
  inv1   g48(.a(new_n77_), .O(z11));
  nand4  g49(.a(x11), .b(new_n58_), .c(new_n42_), .d(x00), .O(new_n79_));
  nor2   g50(.a(new_n79_), .b(new_n30_), .O(z12));
endmodule
