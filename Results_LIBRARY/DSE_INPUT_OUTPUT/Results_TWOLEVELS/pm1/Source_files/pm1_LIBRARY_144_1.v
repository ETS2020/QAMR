...
module FAU ( 
  ...
  nand3  g08(.a(new_n34_), .b(x12), .c(x09), .O(z01));
  inv1   g09(.a(x09), .O(new_n39_));
  inv1   g10(.a(new_n32_), .O(new_n40_));
  nand3  g11(.a(new_n40_), .b(x08), .c(x07), .O(new_n41_));
  nor2   g12(.a(new_n30_), .b(x11), .O(new_n42_));
  aoi21  g13(.a(new_n41_), .b(x11), .c(new_n42_), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(new_n39_), .c(x12), .O(z02));
  nand4  g15(.a(new_n40_), .b(x11), .c(x08), .d(x07), .O(new_n45_));
  nand4  g16(.a(new_n45_), .b(x12), .c(x11), .d(x09), .O(z03));
  nor2   g17(.a(new_n30_), .b(x09), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x14), .O(z04));
  nand2  g20(.a(new_n48_), .b(x13), .O(z05));
  inv1   g21(.a(x11), .O(new_n51_));
  aoi21  g22(.a(new_n51_), .b(x01), .c(new_n39_), .O(new_n52_));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(x09), .c(x01), .O(new_n54_));
  oai21  g25(.a(new_n52_), .b(new_n30_), .c(new_n54_), .O(z06));
  nor2   g26(.a(new_n47_), .b(x15), .O(z07));
  inv1   g27(.a(x10), .O(new_n57_));
  nand3  g28(.a(x12), .b(x11), .c(x09), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n53_), .O(new_n59_));
  aoi21  g30(.a(new_n30_), .b(new_n51_), .c(new_n59_), .O(new_n60_));
  oai21  g31(.a(new_n51_), .b(new_n39_), .c(x12), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n57_), .d(x00), .O(z08));
  nand2  g33(.a(new_n30_), .b(new_n51_), .O(new_n63_));
  and2   g34(.a(x03), .b(x02), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n53_), .c(x04), .O(new_n65_));
  ...
  nand4  g41(.a(new_n53_), .b(x12), .c(x11), .d(new_n57_), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n39_), .c(new_n70_), .O(z10));
  nand3  g43(.a(new_n53_), .b(x12), .c(x01), .O(new_n73_));
