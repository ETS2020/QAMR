...
module FAU ( 
  ...
  nand2  g01(.a(z07), .b(x10), .O(new_n31_));
  ...
  aoi21  g26(.a(new_n39_), .b(new_n35_), .c(new_n55_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n36_), .c(new_n52_), .d(x00), .O(z08));
  nand2  g28(.a(new_n39_), .b(new_n35_), .O(new_n58_));
  nand4  g29(.a(new_n53_), .b(new_n48_), .c(x09), .d(x04), .O(new_n59_));
  ...
  nand2  g42(.a(new_n65_), .b(x00), .O(new_n72_));
  nand3  g43(.a(x12), .b(x11), .c(new_n52_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(new_n31_), .O(z12));
endmodule
