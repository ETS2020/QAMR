...
module FAU ( 
  ...
  aoi21  g05(.a(x15), .b(new_n30_), .c(new_n34_), .O(new_n35_));
  ...
  oai21  g11(.a(new_n40_), .b(new_n39_), .c(x14), .O(new_n41_));
  ...
  oai21  g15(.a(new_n37_), .b(x14), .c(new_n34_), .O(new_n45_));
  oai21  g16(.a(x15), .b(x11), .c(new_n30_), .O(new_n46_));
  or2    g17(.a(new_n40_), .b(new_n39_), .O(new_n47_));
  nand3  g18(.a(new_n47_), .b(x14), .c(x11), .O(new_n48_));
  nand3  g19(.a(new_n48_), .b(new_n46_), .c(new_n45_), .O(z01));
  nand2  g20(.a(x08), .b(x07), .O(new_n50_));
  oai21  g21(.a(new_n30_), .b(new_n33_), .c(x15), .O(new_n51_));
  oai21  g22(.a(new_n50_), .b(new_n39_), .c(new_n51_), .O(new_n52_));
  inv1   g23(.a(x09), .O(new_n53_));
  nand2  g24(.a(x12), .b(x11), .O(new_n54_));
  oai22  g25(.a(new_n54_), .b(new_n53_), .c(new_n37_), .d(x14), .O(new_n55_));
  ...
  nor2   g30(.a(new_n54_), .b(x11), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n37_), .c(x14), .O(z04));
  ...
  nand2  g37(.a(new_n47_), .b(new_n37_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n31_), .O(z07));
