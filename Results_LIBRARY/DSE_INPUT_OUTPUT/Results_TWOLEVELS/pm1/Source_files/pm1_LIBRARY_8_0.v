...
module FAU ( 
  ...
  nor2   g28(.a(new_n49_), .b(new_n40_), .O(new_n58_));
  ...
  oai21  g35(.a(new_n64_), .b(new_n61_), .c(new_n35_), .O(z09));
  ...
  nand2  g41(.a(new_n49_), .b(new_n70_), .O(new_n71_));
  ...
  nand4  g45(.a(x11), .b(new_n55_), .c(new_n66_), .d(x00), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n49_), .O(z12));
endmodule
