...
module FAU ( 
  ...
  nor2   g28(.a(new_n57_), .b(new_n30_), .O(new_n58_));
  ...
  inv1   g36(.a(new_n45_), .O(new_n66_));
  nand4  g37(.a(new_n48_), .b(x12), .c(x11), .d(new_n54_), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(x09), .c(x00), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n66_), .O(z10));
  nand4  g41(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n71_));
  inv1   g42(.a(x01), .O(new_n72_));
  nand2  g43(.a(new_n57_), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g48(.a(x11), .b(new_n54_), .c(new_n77_), .d(x00), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n57_), .O(z12));
endmodule
