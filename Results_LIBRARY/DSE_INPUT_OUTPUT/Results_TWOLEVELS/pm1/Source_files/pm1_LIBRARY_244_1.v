...
module FAU ( 
  ...
  aoi21  g32(.a(new_n61_), .b(new_n53_), .c(new_n34_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n59_), .c(new_n50_), .O(z08));
  inv1   g34(.a(x10), .O(new_n64_));
  xnor2a g35(.a(x12), .b(x11), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(new_n37_), .c(new_n64_), .d(x00), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(z09));
  nand3  g38(.a(x04), .b(x03), .c(x02), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x12), .c(x11), .d(new_n64_), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(x09), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n37_), .O(z10));
  nand4  g43(.a(new_n68_), .b(x12), .c(x09), .d(x01), .O(new_n73_));
  nand2  g44(.a(new_n39_), .b(new_n30_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(new_n37_), .c(x11), .d(new_n64_), .O(new_n76_));
  nor2   g47(.a(new_n76_), .b(new_n58_), .O(z11));
  nand4  g48(.a(new_n40_), .b(x11), .c(new_n64_), .d(new_n45_), .O(new_n78_));
