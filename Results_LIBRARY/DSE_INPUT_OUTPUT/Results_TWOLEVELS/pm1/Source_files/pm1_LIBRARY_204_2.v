...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n37_, new_n38_,
    ...
    new_n67_, new_n69_, new_n71_, new_n72_, new_n73_, new_n75_;
  ...
  aoi21  g10(.a(new_n39_), .b(x11), .c(new_n38_), .O(new_n40_));
  oai21  g11(.a(new_n40_), .b(new_n37_), .c(x11), .O(z02));
  nand3  g12(.a(x11), .b(x08), .c(x07), .O(new_n42_));
  oai21  g13(.a(new_n42_), .b(new_n32_), .c(x09), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x12), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x11), .O(z03));
  nor2   g16(.a(x12), .b(new_n30_), .O(new_n46_));
  ...
  nand4  g29(.a(x11), .b(new_n57_), .c(x09), .d(x04), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n56_), .c(x12), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(x11), .O(z08));
  oai21  g33(.a(x10), .b(new_n56_), .c(new_n30_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n37_), .O(new_n64_));
  ...
  oai21  g38(.a(new_n67_), .b(new_n56_), .c(new_n64_), .O(z09));
  nand4  g39(.a(new_n65_), .b(x12), .c(x11), .d(new_n57_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n38_), .c(new_n56_), .O(z10));
  nand3  g41(.a(new_n65_), .b(new_n57_), .c(x09), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(x01), .c(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x12), .c(new_n30_), .O(z11));
  nand4  g45(.a(x11), .b(new_n57_), .c(new_n38_), .d(x00), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n37_), .O(z12));
endmodule
