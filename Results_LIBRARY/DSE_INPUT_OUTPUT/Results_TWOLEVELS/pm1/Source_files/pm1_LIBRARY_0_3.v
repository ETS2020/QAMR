...
module FAU ( 
  ...
  nor2   g14(.a(new_n38_), .b(new_n43_), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n42_), .c(z05), .d(x11), .O(z02));
  nand3  g16(.a(x11), .b(x08), .c(x07), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(new_n31_), .c(x12), .O(new_n47_));
  oai21  g18(.a(new_n47_), .b(new_n43_), .c(z05), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x11), .O(z03));
  nor2   g20(.a(z05), .b(new_n30_), .O(new_n50_));
  ...
  oai21  g34(.a(new_n63_), .b(new_n59_), .c(z05), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(x11), .O(z08));
  nand3  g36(.a(x04), .b(x03), .c(x02), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(new_n54_), .c(x09), .d(x04), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(z05), .c(x12), .d(x11), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n39_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n60_), .c(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z09));
  nand4  g42(.a(new_n66_), .b(z05), .c(x12), .d(x11), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(new_n60_), .c(x09), .d(x00), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(z10));
  nand4  g46(.a(new_n66_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  oai21  g47(.a(x12), .b(x01), .c(new_n76_), .O(new_n77_));
  nand3  g48(.a(new_n77_), .b(new_n60_), .c(x00), .O(new_n78_));
  aoi21  g49(.a(new_n78_), .b(z05), .c(new_n30_), .O(z11));
  nand4  g50(.a(x11), .b(new_n60_), .c(new_n43_), .d(x00), .O(new_n80_));
  nor3   g51(.a(new_n80_), .b(x13), .c(new_n38_), .O(z12));
endmodule
