...
module FAU ( 
  ...
  nand3  g04(.a(new_n33_), .b(new_n32_), .c(x07), .O(new_n34_));
  nand3  g05(.a(new_n34_), .b(x11), .c(x08), .O(new_n35_));
  ...
  aoi21  g14(.a(new_n32_), .b(x07), .c(new_n37_), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(x12), .c(x11), .d(x09), .O(z03));
  nor2   g16(.a(new_n30_), .b(x08), .O(new_n46_));
  ...
  oai21  g31(.a(new_n60_), .b(new_n56_), .c(x08), .O(new_n61_));
  ...
  nand4  g35(.a(new_n64_), .b(x12), .c(x11), .d(x08), .O(new_n65_));
  ...
  nand4  g41(.a(new_n63_), .b(x12), .c(new_n57_), .d(x09), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n56_), .c(x08), .O(new_n72_));
  and2   g43(.a(new_n72_), .b(x11), .O(z10));
  nand4  g44(.a(new_n63_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  oai21  g45(.a(x12), .b(x01), .c(new_n74_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(new_n57_), .c(x00), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(x08), .c(new_n30_), .O(z11));
  inv1   g48(.a(x09), .O(new_n78_));
  nand4  g49(.a(new_n57_), .b(new_n78_), .c(x08), .d(x00), .O(new_n79_));
  nor3   g50(.a(new_n79_), .b(new_n66_), .c(new_n30_), .O(z12));
endmodule
