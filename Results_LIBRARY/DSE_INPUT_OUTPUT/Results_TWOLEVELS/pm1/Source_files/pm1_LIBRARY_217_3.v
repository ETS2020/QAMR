...
module FAU ( 
  ...
  nand2  g03(.a(x14), .b(x07), .O(new_n33_));
  ...
  oai21  g11(.a(new_n40_), .b(new_n38_), .c(z04), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x07), .O(z02));
  nand2  g13(.a(new_n40_), .b(new_n33_), .O(new_n43_));
  nand2  g14(.a(x06), .b(x05), .O(new_n44_));
  nand3  g15(.a(z04), .b(x08), .c(x07), .O(new_n45_));
  ...
  nand4  g21(.a(new_n50_), .b(new_n33_), .c(x09), .d(x01), .O(new_n51_));
  ...
  nand4  g27(.a(new_n56_), .b(new_n55_), .c(new_n33_), .d(x11), .O(z08));
  ...
  nand2  g44(.a(new_n39_), .b(new_n58_), .O(new_n74_));
