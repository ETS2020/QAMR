...
module FAU ( 
  ...
  nand4  g32(.a(new_n55_), .b(x12), .c(new_n49_), .d(x09), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n48_), .c(new_n37_), .O(new_n63_));
  and2   g34(.a(new_n63_), .b(x11), .O(z10));
  nand4  g35(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  oai21  g36(.a(x12), .b(x01), .c(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(new_n49_), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n37_), .c(new_n30_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand4  g40(.a(new_n49_), .b(new_n69_), .c(new_n37_), .d(x00), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n34_), .c(new_n30_), .O(z12));
endmodule
