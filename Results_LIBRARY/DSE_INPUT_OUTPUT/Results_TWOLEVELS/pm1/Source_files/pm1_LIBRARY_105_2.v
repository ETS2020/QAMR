...
module FAU ( 
  ...
  oai21  g23(.a(new_n31_), .b(x11), .c(new_n52_), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(x09), .c(x01), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(z06));
  nand2  g26(.a(new_n47_), .b(x15), .O(z07));
