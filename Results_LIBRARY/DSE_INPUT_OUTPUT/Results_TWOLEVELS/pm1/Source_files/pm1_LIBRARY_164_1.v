...
module FAU ( 
  ...
  oai22  g08(.a(new_n37_), .b(new_n31_), .c(x15), .d(x12), .O(z01));
  ...
  nand4  g31(.a(new_n60_), .b(new_n59_), .c(new_n49_), .d(x00), .O(z08));
  inv1   g32(.a(x00), .O(new_n62_));
  nand3  g33(.a(new_n31_), .b(new_n55_), .c(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n33_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n32_), .O(new_n65_));
  nand4  g36(.a(new_n56_), .b(new_n50_), .c(x09), .d(x04), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(x12), .c(x11), .d(new_n55_), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n62_), .c(new_n65_), .O(z09));
  inv1   g39(.a(x09), .O(new_n69_));
  nand4  g40(.a(new_n56_), .b(x12), .c(x11), .d(new_n55_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n69_), .c(new_n62_), .O(z10));
  ...
  oai21  g50(.a(new_n79_), .b(new_n78_), .c(new_n46_), .O(z12));
endmodule
