...
module FAU ( 
  ...
  nor2   g17(.a(new_n38_), .b(new_n35_), .O(new_n47_));
  aoi21  g18(.a(new_n47_), .b(new_n35_), .c(x14), .O(z04));
  nor2   g19(.a(x14), .b(x13), .O(z05));
  ...
  nand4  g33(.a(new_n55_), .b(x14), .c(new_n30_), .d(x09), .O(new_n63_));
