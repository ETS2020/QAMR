...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n36_, new_n37_,
    ...
    new_n48_, new_n51_, new_n52_, new_n53_, new_n54_, new_n58_, new_n61_,
    new_n62_;
  ...
  nor2   g17(.a(new_n30_), .b(new_n32_), .O(new_n47_));
  ...
  nand3  g31(.a(new_n35_), .b(new_n61_), .c(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(new_n30_), .c(new_n32_), .O(z11));
  zero   g33(.O(z10));
  zero   g34(.O(z12));
endmodule
