...
module FAU ( 
  ...
  nand3  g09(.a(new_n35_), .b(x13), .c(x11), .O(new_n39_));
  nor2   g10(.a(x13), .b(new_n31_), .O(new_n40_));
  inv1   g11(.a(new_n40_), .O(new_n41_));
  nand3  g12(.a(new_n41_), .b(new_n39_), .c(x12), .O(z01));
  inv1   g13(.a(x11), .O(new_n43_));
  oai21  g14(.a(new_n30_), .b(new_n43_), .c(x12), .O(new_n44_));
  nand4  g15(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n45_));
  nand3  g16(.a(new_n45_), .b(x13), .c(x11), .O(new_n46_));
  nand4  g17(.a(new_n46_), .b(new_n44_), .c(x12), .d(x09), .O(z02));
  nand3  g18(.a(x07), .b(x06), .c(x05), .O(new_n48_));
  inv1   g19(.a(new_n48_), .O(new_n49_));
  nand4  g20(.a(new_n49_), .b(x13), .c(x11), .d(x08), .O(new_n50_));
  nand4  g21(.a(new_n50_), .b(new_n44_), .c(x12), .d(x09), .O(z03));
  nor2   g22(.a(new_n40_), .b(x14), .O(z04));
  nor2   g23(.a(x13), .b(x12), .O(z05));
  nand3  g24(.a(new_n43_), .b(x09), .c(x01), .O(new_n54_));
  ...
  nand2  g30(.a(new_n41_), .b(x15), .O(z07));
  inv1   g31(.a(x10), .O(new_n61_));
  nand4  g32(.a(x13), .b(x12), .c(x11), .d(x09), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  aoi21  g34(.a(new_n31_), .b(new_n43_), .c(new_n63_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n44_), .c(new_n61_), .d(x00), .O(z08));
  nand2  g36(.a(new_n31_), .b(new_n43_), .O(new_n66_));
  and2   g37(.a(x03), .b(x02), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n57_), .c(x09), .d(x04), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x13), .c(x12), .d(x11), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n66_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(new_n61_), .c(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z09));
  nand4  g43(.a(new_n57_), .b(x13), .c(x12), .d(x11), .O(new_n73_));
  ...
  nand2  g50(.a(new_n79_), .b(new_n41_), .O(z11));
  inv1   g51(.a(x09), .O(new_n81_));
  nand4  g52(.a(x11), .b(new_n61_), .c(new_n81_), .d(x00), .O(new_n82_));
  nor3   g53(.a(new_n82_), .b(new_n30_), .c(new_n31_), .O(z12));
endmodule
