...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n44_, new_n46_,
    new_n47_, new_n48_, new_n49_, new_n53_, new_n54_, new_n57_, new_n58_,
  ...
  nor2   g07(.a(x15), .b(new_n36_), .O(new_n37_));
  ...
  nor2   g26(.a(x15), .b(x03), .O(z07));
  inv1   g27(.a(x10), .O(new_n57_));
  nand4  g28(.a(x09), .b(x04), .c(x02), .d(x00), .O(new_n58_));
  nand4  g29(.a(x15), .b(x12), .c(x11), .d(new_n57_), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(x15), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(x03), .O(new_n61_));
  nand4  g32(.a(new_n38_), .b(new_n40_), .c(new_n57_), .d(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n40_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n34_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n61_), .c(new_n57_), .d(x00), .O(z08));
  nand3  g36(.a(x12), .b(x11), .c(new_n46_), .O(new_n66_));
  ...
  nand2  g48(.a(new_n77_), .b(x15), .O(new_n78_));
  aoi21  g49(.a(new_n78_), .b(x03), .c(new_n40_), .O(new_n79_));
  ...
  nand2  g56(.a(new_n85_), .b(new_n38_), .O(z11));
  nand4  g57(.a(new_n41_), .b(x11), .c(new_n57_), .d(new_n46_), .O(new_n87_));
  oai21  g58(.a(new_n87_), .b(new_n76_), .c(new_n38_), .O(z12));
endmodule
