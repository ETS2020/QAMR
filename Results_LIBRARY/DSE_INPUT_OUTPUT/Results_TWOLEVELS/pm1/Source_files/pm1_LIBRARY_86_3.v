...
module FAU ( 
  ...
  oai21  g02(.a(x13), .b(new_n30_), .c(new_n31_), .O(z00));
  ...
  nand3  g07(.a(new_n36_), .b(z05), .c(x12), .O(z01));
  nand3  g08(.a(x12), .b(x08), .c(x07), .O(new_n38_));
  oai21  g09(.a(new_n38_), .b(new_n34_), .c(x11), .O(new_n39_));
  nand2  g10(.a(x13), .b(x12), .O(new_n40_));
  ...
  aoi21  g18(.a(x13), .b(x12), .c(x14), .O(z04));
  inv1   g19(.a(x11), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(x09), .c(x01), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(z05), .O(new_n51_));
  ...
  nand2  g26(.a(new_n40_), .b(x15), .O(z07));
  inv1   g27(.a(x10), .O(new_n57_));
  nand4  g28(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n58_));
  nand4  g29(.a(z05), .b(x11), .c(new_n57_), .d(x09), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(z05), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(x12), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x11), .c(new_n57_), .d(x00), .O(z08));
  and2   g33(.a(x03), .b(x02), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n53_), .c(x09), .d(x04), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(z05), .c(x12), .d(x11), .O(new_n65_));
  nand2  g36(.a(new_n30_), .b(new_n49_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(new_n57_), .c(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z09));
  nand4  g40(.a(new_n53_), .b(z05), .c(x12), .d(x11), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(new_n57_), .c(x09), .d(x00), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(z10));
  nand4  g44(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  oai21  g45(.a(x12), .b(x01), .c(new_n74_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n57_), .d(x00), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n40_), .O(z11));
  inv1   g48(.a(x09), .O(new_n78_));
  nand4  g49(.a(x11), .b(new_n57_), .c(new_n78_), .d(x00), .O(new_n79_));
  nor3   g50(.a(new_n79_), .b(x13), .c(new_n30_), .O(z12));
endmodule
