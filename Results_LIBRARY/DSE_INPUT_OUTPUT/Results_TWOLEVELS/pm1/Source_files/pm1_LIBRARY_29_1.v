...
module FAU ( 
  ...
  nand2  g30(.a(new_n53_), .b(x15), .O(z07));
  inv1   g31(.a(x10), .O(new_n61_));
  nand4  g32(.a(x12), .b(x11), .c(x09), .d(x08), .O(new_n62_));
  ...
  nand4  g39(.a(new_n68_), .b(x12), .c(x11), .d(x08), .O(new_n69_));
  ...
  nand4  g44(.a(new_n55_), .b(x11), .c(new_n61_), .d(x09), .O(new_n74_));
  oai21  g45(.a(new_n74_), .b(new_n73_), .c(x08), .O(new_n75_));
  and2   g46(.a(new_n75_), .b(x12), .O(z10));
  ...
  nand2  g50(.a(new_n79_), .b(new_n53_), .O(z11));
  inv1   g51(.a(x09), .O(new_n81_));
  nor2   g52(.a(new_n30_), .b(new_n73_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(x11), .c(new_n61_), .d(new_n81_), .O(new_n83_));
  aoi21  g54(.a(new_n83_), .b(x08), .c(new_n31_), .O(z12));
endmodule
