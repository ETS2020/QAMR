...
module FAU ( 
  ...
  nand2  g29(.a(new_n49_), .b(x15), .O(z07));
  inv1   g30(.a(x10), .O(new_n60_));
  nand4  g31(.a(x12), .b(x11), .c(x09), .d(x07), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  aoi21  g33(.a(new_n31_), .b(new_n52_), .c(new_n62_), .O(new_n63_));
  oai21  g34(.a(new_n52_), .b(new_n30_), .c(x12), .O(new_n64_));
  ...
  nand4  g43(.a(new_n56_), .b(x12), .c(x11), .d(new_n60_), .O(new_n73_));
  ...
  nor2   g54(.a(new_n52_), .b(x10), .O(new_n84_));
  nand4  g55(.a(new_n84_), .b(new_n83_), .c(x07), .d(x00), .O(new_n85_));
  aoi21  g56(.a(new_n85_), .b(x07), .c(new_n31_), .O(z12));
endmodule
