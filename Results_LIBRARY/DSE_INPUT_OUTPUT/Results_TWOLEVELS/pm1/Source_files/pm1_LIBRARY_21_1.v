...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n40_, new_n41_, new_n43_, new_n45_, new_n47_, new_n49_, new_n50_,
  ...
  nand2  g33(.a(new_n62_), .b(z07), .O(new_n63_));
  ...
  nand4  g38(.a(new_n55_), .b(x12), .c(x11), .d(new_n54_), .O(new_n68_));
  ...
  nand3  g43(.a(z07), .b(new_n32_), .c(new_n30_), .O(new_n73_));
