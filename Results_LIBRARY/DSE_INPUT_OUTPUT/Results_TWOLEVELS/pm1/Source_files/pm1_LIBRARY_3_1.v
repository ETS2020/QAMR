...
module FAU ( 
  ...
  nand2  g08(.a(z05), .b(new_n32_), .O(new_n38_));
  ...
  oai21  g17(.a(z05), .b(x12), .c(x14), .O(z04));
  nor2   g18(.a(z05), .b(x12), .O(new_n48_));
  ...
  nand3  g28(.a(z05), .b(new_n32_), .c(new_n31_), .O(new_n58_));
  ...
  nor3   g41(.a(new_n70_), .b(new_n40_), .c(new_n69_), .O(z10));
  nand4  g42(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  oai21  g43(.a(new_n38_), .b(x01), .c(new_n72_), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(x11), .c(new_n56_), .d(x00), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(z11));
  nand4  g46(.a(x11), .b(new_n56_), .c(new_n40_), .d(x00), .O(new_n76_));
