...
module FAU ( 
  ...
  nand3  g06(.a(new_n33_), .b(new_n34_), .c(x00), .O(new_n36_));
  nand2  g07(.a(new_n36_), .b(new_n33_), .O(new_n37_));
  oai21  g08(.a(new_n37_), .b(new_n35_), .c(new_n30_), .O(new_n38_));
  ...
  oai21  g13(.a(new_n42_), .b(new_n33_), .c(new_n38_), .O(z01));
  nand3  g14(.a(new_n30_), .b(new_n34_), .c(x00), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n33_), .O(new_n46_));
  nand2  g17(.a(new_n36_), .b(new_n30_), .O(new_n47_));
  ...
  nand2  g26(.a(x13), .b(x12), .O(new_n56_));
  oai21  g27(.a(x13), .b(x09), .c(new_n56_), .O(new_n57_));
  aoi21  g28(.a(new_n35_), .b(new_n30_), .c(new_n57_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n55_), .c(new_n46_), .O(z03));
  nand2  g30(.a(new_n56_), .b(x14), .O(z04));
  nor2   g31(.a(new_n41_), .b(new_n40_), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x11), .c(x13), .O(z05));
  nand3  g33(.a(new_n33_), .b(x09), .c(x01), .O(new_n63_));
  ...
  aoi21  g39(.a(x13), .b(x12), .c(x15), .O(z07));
  nand2  g40(.a(new_n30_), .b(new_n33_), .O(new_n70_));
  nand4  g41(.a(new_n39_), .b(x12), .c(x11), .d(x09), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n66_), .c(new_n70_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(new_n34_), .c(x00), .O(new_n73_));
  aoi22  g44(.a(new_n56_), .b(new_n35_), .c(new_n39_), .d(new_n33_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n73_), .O(z08));
  inv1   g46(.a(x09), .O(new_n76_));
  nand4  g47(.a(x13), .b(x04), .c(x03), .d(x02), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n76_), .c(x12), .O(new_n78_));
  oai21  g49(.a(new_n78_), .b(new_n33_), .c(new_n70_), .O(new_n79_));
  nand3  g50(.a(new_n79_), .b(new_n34_), .c(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n56_), .O(z09));
  nand3  g52(.a(new_n66_), .b(x11), .c(new_n34_), .O(new_n82_));
  inv1   g53(.a(new_n82_), .O(new_n83_));
  nand3  g54(.a(new_n83_), .b(x09), .c(x00), .O(new_n84_));
  aoi21  g55(.a(new_n84_), .b(new_n39_), .c(new_n30_), .O(z10));
  inv1   g56(.a(x01), .O(new_n86_));
  nand4  g57(.a(new_n66_), .b(new_n39_), .c(x12), .d(x09), .O(new_n87_));
  nand2  g58(.a(new_n30_), .b(new_n86_), .O(new_n88_));
  oai21  g59(.a(new_n87_), .b(new_n86_), .c(new_n88_), .O(new_n89_));
  nand4  g60(.a(new_n89_), .b(x11), .c(new_n34_), .d(x00), .O(new_n90_));
  inv1   g61(.a(new_n90_), .O(z11));
  nand4  g62(.a(x11), .b(new_n34_), .c(new_n76_), .d(x00), .O(new_n92_));
  aoi21  g63(.a(new_n92_), .b(new_n39_), .c(new_n30_), .O(z12));
endmodule
