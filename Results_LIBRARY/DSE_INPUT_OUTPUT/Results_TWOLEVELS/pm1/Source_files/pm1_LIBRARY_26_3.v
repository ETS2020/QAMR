...
module FAU ( 
  ...
  nand2  g03(.a(x15), .b(x14), .O(new_n33_));
  ...
  nor2   g10(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nor2   g11(.a(new_n40_), .b(new_n35_), .O(z02));
  nand4  g12(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n42_));
  nand4  g13(.a(new_n42_), .b(new_n38_), .c(new_n33_), .d(x09), .O(z03));
  ...
  aoi21  g26(.a(new_n55_), .b(new_n47_), .c(new_n31_), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n53_), .c(new_n35_), .O(z08));
  inv1   g28(.a(x10), .O(new_n58_));
  xnor2a g29(.a(x12), .b(x11), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n33_), .c(new_n58_), .d(x00), .O(new_n60_));
  ...
  nand2  g36(.a(new_n65_), .b(new_n33_), .O(z10));
  ...
  nand4  g40(.a(new_n69_), .b(new_n33_), .c(x11), .d(new_n58_), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n52_), .O(z11));
  nand4  g42(.a(new_n33_), .b(x12), .c(x11), .d(new_n58_), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(x09), .c(new_n52_), .O(z12));
endmodule
