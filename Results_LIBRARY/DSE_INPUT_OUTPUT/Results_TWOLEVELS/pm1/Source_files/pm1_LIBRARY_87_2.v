...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n37_, new_n39_, new_n40_, new_n42_, new_n43_, new_n44_, new_n46_,
  ...
  nand3  g13(.a(new_n33_), .b(x08), .c(x07), .O(new_n43_));
  aoi21  g14(.a(new_n43_), .b(x11), .c(new_n42_), .O(new_n44_));
  oai21  g15(.a(new_n44_), .b(new_n39_), .c(x11), .O(z02));
  nand4  g16(.a(new_n33_), .b(x12), .c(x08), .d(x07), .O(new_n46_));
  ...
  nor2   g31(.a(new_n39_), .b(x10), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(x00), .O(new_n62_));
  inv1   g33(.a(x00), .O(new_n63_));
  nor2   g34(.a(x10), .b(new_n63_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n62_), .c(x12), .d(x11), .O(z08));
  inv1   g36(.a(x10), .O(new_n66_));
  nand4  g37(.a(new_n59_), .b(new_n52_), .c(x09), .d(x04), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x12), .c(x11), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n40_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(new_n66_), .c(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z09));
  nor2   g42(.a(new_n53_), .b(new_n39_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n66_), .c(x09), .d(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x12), .c(new_n30_), .O(z10));
  nor2   g45(.a(new_n53_), .b(x10), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x09), .c(x01), .d(x00), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(x12), .c(new_n30_), .O(z11));
  nand4  g48(.a(x11), .b(new_n66_), .c(new_n42_), .d(x00), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n39_), .O(z12));
endmodule
