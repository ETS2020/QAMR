...
module FAU ( 
  ...
  nor2   g37(.a(new_n66_), .b(new_n63_), .O(z09));
  nand3  g38(.a(new_n64_), .b(x12), .c(x11), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(x09), .c(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(x12), .c(x10), .O(z10));
  nand3  g42(.a(new_n64_), .b(x11), .c(x09), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(x01), .c(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x12), .c(x10), .O(z11));
  nand4  g46(.a(x12), .b(x11), .c(new_n39_), .d(x00), .O(new_n76_));
