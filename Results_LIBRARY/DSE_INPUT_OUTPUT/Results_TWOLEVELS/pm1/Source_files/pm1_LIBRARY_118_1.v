...
module FAU ( 
  ...
  nand3  g09(.a(new_n35_), .b(x11), .c(x06), .O(new_n39_));
  ...
  nand4  g31(.a(x12), .b(x11), .c(x09), .d(x06), .O(new_n61_));
  ...
  nand4  g39(.a(new_n68_), .b(x12), .c(x11), .d(x06), .O(new_n69_));
  ...
  nand4  g45(.a(new_n74_), .b(x09), .c(x06), .d(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z10));
  inv1   g47(.a(x01), .O(new_n77_));
  nand4  g48(.a(new_n56_), .b(x12), .c(x09), .d(x06), .O(new_n78_));
  ...
  nand4  g55(.a(new_n84_), .b(new_n83_), .c(x06), .d(x00), .O(new_n85_));
  aoi21  g56(.a(new_n85_), .b(x06), .c(new_n31_), .O(z12));
endmodule
