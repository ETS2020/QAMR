...
module FAU ( 
  ...
  nand2  g02(.a(x15), .b(x13), .O(new_n32_));
  ...
  nand2  g11(.a(new_n37_), .b(x11), .O(new_n41_));
  aoi21  g12(.a(new_n41_), .b(x12), .c(new_n40_), .O(z01));
  ...
  aoi21  g19(.a(new_n48_), .b(new_n44_), .c(new_n40_), .O(z02));
  ...
  aoi21  g24(.a(new_n53_), .b(new_n46_), .c(new_n40_), .O(z03));
  nand2  g25(.a(new_n32_), .b(x14), .O(z04));
  inv1   g26(.a(new_n37_), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(x11), .c(x13), .O(z05));
  ...
  aoi21  g32(.a(new_n56_), .b(x11), .c(x15), .O(z07));
  ...
  nand4  g41(.a(new_n70_), .b(x15), .c(x13), .d(x09), .O(new_n71_));
