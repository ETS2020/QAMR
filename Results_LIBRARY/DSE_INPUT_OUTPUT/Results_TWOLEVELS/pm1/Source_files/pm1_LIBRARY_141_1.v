...
module FAU ( 
  ...
  oai21  g02(.a(x11), .b(x01), .c(z05), .O(new_n32_));
  ...
  nor3   g13(.a(new_n42_), .b(new_n33_), .c(new_n41_), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(new_n30_), .c(new_n39_), .O(z02));
  ...
  nand2  g18(.a(x13), .b(new_n30_), .O(new_n48_));
  ...
  aoi21  g25(.a(x13), .b(new_n30_), .c(x15), .O(z07));
  inv1   g26(.a(x10), .O(new_n56_));
  nand3  g27(.a(x04), .b(x03), .c(x02), .O(new_n57_));
  nand3  g28(.a(x12), .b(x11), .c(x09), .O(new_n58_));
  oai22  g29(.a(new_n58_), .b(new_n57_), .c(new_n39_), .d(x11), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n56_), .c(x00), .O(new_n60_));
  nand2  g31(.a(new_n56_), .b(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n48_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(z08));
  inv1   g34(.a(x00), .O(new_n64_));
  oai21  g35(.a(new_n61_), .b(x11), .c(z05), .O(new_n65_));
  ...
  nand2  g43(.a(new_n72_), .b(new_n48_), .O(z10));
  nand4  g44(.a(new_n57_), .b(x12), .c(x09), .d(x01), .O(new_n74_));
  inv1   g45(.a(x01), .O(new_n75_));
  nand3  g46(.a(z05), .b(new_n30_), .c(new_n75_), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x11), .c(new_n56_), .d(x00), .O(new_n78_));
  inv1   g49(.a(new_n78_), .O(z11));
  nand2  g50(.a(new_n41_), .b(x00), .O(new_n80_));
  nand3  g51(.a(x12), .b(x11), .c(new_n56_), .O(new_n81_));
  oai21  g52(.a(new_n81_), .b(new_n80_), .c(new_n48_), .O(z12));
endmodule
