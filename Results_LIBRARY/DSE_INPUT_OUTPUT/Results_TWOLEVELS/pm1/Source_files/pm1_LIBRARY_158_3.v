...
module FAU ( 
  ...
  nand4  g25(.a(new_n54_), .b(new_n49_), .c(new_n48_), .d(new_n44_), .O(z02));
  ...
  aoi22  g30(.a(new_n34_), .b(new_n30_), .c(new_n50_), .d(new_n59_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n58_), .c(new_n48_), .O(z03));
  aoi21  g32(.a(new_n41_), .b(x11), .c(x14), .O(z04));
  nand2  g33(.a(new_n44_), .b(x13), .O(z05));
  ...
  nand4  g53(.a(new_n67_), .b(new_n50_), .c(x12), .d(x11), .O(new_n83_));
  inv1   g54(.a(new_n83_), .O(new_n84_));
  nand4  g55(.a(new_n84_), .b(new_n33_), .c(x09), .d(x00), .O(new_n85_));
  ...
  nand4  g63(.a(x11), .b(new_n33_), .c(new_n59_), .d(x00), .O(new_n93_));
  nor3   g64(.a(new_n93_), .b(x14), .c(new_n30_), .O(z12));
endmodule
