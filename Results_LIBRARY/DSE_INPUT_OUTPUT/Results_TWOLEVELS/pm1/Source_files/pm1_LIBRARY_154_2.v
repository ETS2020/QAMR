...
module FAU ( 
  ...
  nand4  g14(.a(new_n40_), .b(x12), .c(x08), .d(x07), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(x12), .c(x11), .d(x09), .O(z03));
  nand2  g16(.a(new_n31_), .b(x11), .O(new_n46_));
  ...
  oai21  g21(.a(new_n31_), .b(x11), .c(new_n50_), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(x09), .c(x01), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(z06));
  aoi21  g24(.a(new_n31_), .b(x11), .c(x15), .O(z07));
  ...
  oai21  g32(.a(x10), .b(new_n55_), .c(new_n30_), .O(new_n62_));
  ...
  oai21  g37(.a(new_n66_), .b(new_n55_), .c(new_n63_), .O(z09));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(new_n49_), .b(x12), .c(x11), .d(new_n56_), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z10));
  nand3  g41(.a(new_n49_), .b(new_n56_), .c(x09), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(x01), .c(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x12), .c(new_n30_), .O(z11));
  nand4  g45(.a(x11), .b(new_n56_), .c(new_n68_), .d(x00), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n31_), .O(z12));
endmodule
