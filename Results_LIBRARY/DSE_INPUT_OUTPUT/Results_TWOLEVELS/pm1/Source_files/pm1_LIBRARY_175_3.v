...
module FAU ( 
  ...
  oai21  g06(.a(new_n35_), .b(x07), .c(x12), .O(z01));
  nand2  g07(.a(new_n31_), .b(x12), .O(z02));
  inv1   g08(.a(x09), .O(new_n38_));
  aoi21  g09(.a(x12), .b(new_n35_), .c(new_n38_), .O(new_n39_));
  oai21  g10(.a(new_n39_), .b(x07), .c(x12), .O(z03));
  nand2  g11(.a(x12), .b(x07), .O(new_n41_));
  ...
  oai21  g25(.a(new_n35_), .b(x07), .c(x12), .O(new_n55_));
