...
module FAU ( 
  ...
  nand4  g07(.a(new_n36_), .b(new_n32_), .c(x08), .d(x07), .O(new_n37_));
  ...
  aoi21  g32(.a(x13), .b(new_n32_), .c(x10), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n61_), .c(new_n51_), .d(x00), .O(z08));
  inv1   g34(.a(x00), .O(new_n64_));
  nand3  g35(.a(new_n31_), .b(new_n57_), .c(x00), .O(new_n65_));
  ...
  oai21  g40(.a(new_n69_), .b(new_n64_), .c(new_n67_), .O(z09));
  nand4  g41(.a(new_n58_), .b(x12), .c(x11), .d(new_n57_), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n43_), .c(new_n64_), .O(z10));
