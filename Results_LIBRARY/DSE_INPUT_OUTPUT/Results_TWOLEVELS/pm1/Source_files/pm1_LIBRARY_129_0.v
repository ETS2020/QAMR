...
module FAU ( 
  ...
  aoi21  g41(.a(new_n70_), .b(new_n65_), .c(new_n31_), .O(z08));
  nand3  g42(.a(x04), .b(x03), .c(x02), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n59_), .c(x09), .d(x04), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(new_n32_), .c(x12), .d(x11), .O(new_n74_));
  ...
  nand4  g49(.a(new_n72_), .b(new_n32_), .c(x12), .d(x11), .O(new_n79_));
  ...
  nand2  g54(.a(new_n83_), .b(new_n35_), .O(new_n84_));
  nand4  g55(.a(new_n84_), .b(new_n32_), .c(x11), .d(new_n67_), .O(new_n85_));
  nor2   g56(.a(new_n85_), .b(new_n64_), .O(z11));
  nand4  g57(.a(new_n32_), .b(x12), .c(x11), .d(new_n67_), .O(new_n87_));
  nor3   g58(.a(new_n87_), .b(x09), .c(new_n64_), .O(z12));
endmodule
