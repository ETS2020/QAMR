...
module FAU ( 
  ...
  nand2  g08(.a(new_n33_), .b(x12), .O(z01));
  ...
  oai21  g13(.a(new_n42_), .b(new_n31_), .c(x09), .O(new_n43_));
  ...
  nand4  g19(.a(new_n48_), .b(new_n36_), .c(x09), .d(x01), .O(new_n49_));
  inv1   g20(.a(new_n49_), .O(z06));
  nand2  g21(.a(new_n36_), .b(x15), .O(z07));
  inv1   g22(.a(x10), .O(new_n52_));
  inv1   g23(.a(x09), .O(new_n53_));
  nor2   g24(.a(new_n34_), .b(new_n53_), .O(new_n54_));
  ...
  oai21  g29(.a(new_n48_), .b(new_n53_), .c(new_n58_), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(x12), .c(new_n52_), .d(x00), .O(new_n60_));
  oai21  g31(.a(new_n57_), .b(x11), .c(new_n60_), .O(z09));
  inv1   g32(.a(x00), .O(new_n62_));
  nand4  g33(.a(new_n48_), .b(x12), .c(x11), .d(new_n52_), .O(new_n63_));
  nor3   g34(.a(new_n63_), .b(new_n53_), .c(new_n62_), .O(z10));
  nand4  g35(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand2  g36(.a(new_n34_), .b(new_n30_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n52_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  nand4  g40(.a(x11), .b(new_n52_), .c(new_n53_), .d(x00), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n34_), .O(z12));
endmodule
