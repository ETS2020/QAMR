...
module FAU ( 
  ...
  or2    g16(.a(new_n45_), .b(new_n34_), .O(new_n46_));
  ...
  oai22  g29(.a(new_n58_), .b(new_n51_), .c(x12), .d(x11), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  aoi21  g31(.a(x15), .b(new_n30_), .c(x10), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n53_), .d(x00), .O(z08));
  inv1   g33(.a(x00), .O(new_n63_));
  nand3  g34(.a(new_n33_), .b(new_n57_), .c(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(z07), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  and2   g37(.a(x03), .b(x02), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n51_), .c(x09), .d(x04), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x12), .c(x11), .d(new_n57_), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n63_), .c(new_n66_), .O(z09));
  nand4  g41(.a(new_n51_), .b(x12), .c(x11), .d(new_n57_), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(x09), .c(x00), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n48_), .O(z10));
  nand4  g45(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n75_));
  ...
  nand2  g51(.a(new_n40_), .b(x00), .O(new_n81_));
