...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x13), .O(new_n31_));
  nor2   g02(.a(x15), .b(x13), .O(new_n32_));
  nor2   g03(.a(x12), .b(x11), .O(new_n33_));
  oai22  g04(.a(new_n33_), .b(new_n32_), .c(new_n31_), .d(new_n30_), .O(z00));
  ...
  oai21  g18(.a(new_n38_), .b(x11), .c(x15), .O(new_n48_));
  ...
  nand3  g34(.a(new_n37_), .b(x12), .c(new_n35_), .O(new_n64_));
  nor2   g35(.a(new_n31_), .b(x10), .O(new_n65_));
  ...
  nand2  g41(.a(new_n70_), .b(new_n50_), .O(z09));
