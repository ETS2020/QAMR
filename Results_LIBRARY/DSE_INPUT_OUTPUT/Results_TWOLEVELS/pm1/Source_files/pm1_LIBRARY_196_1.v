...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    new_n37_, new_n38_, new_n39_, new_n41_, new_n43_, new_n44_, new_n46_,
  ...
  aoi21  g09(.a(new_n35_), .b(x11), .c(new_n38_), .O(new_n39_));
  oai21  g10(.a(new_n39_), .b(new_n30_), .c(new_n32_), .O(z00));
  nand3  g11(.a(new_n35_), .b(x11), .c(x08), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x12), .O(z01));
  inv1   g13(.a(x09), .O(new_n43_));
  aoi21  g14(.a(new_n34_), .b(x11), .c(new_n43_), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(x12), .c(x11), .d(x08), .O(z02));
  nand3  g16(.a(new_n33_), .b(x11), .c(x07), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(new_n37_), .c(x09), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(x08), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x12), .O(z03));
  nor2   g20(.a(new_n31_), .b(x08), .O(new_n50_));
  ...
  oai22  g25(.a(new_n54_), .b(new_n50_), .c(new_n37_), .d(new_n30_), .O(new_n55_));
  ...
  oai21  g31(.a(new_n36_), .b(new_n30_), .c(x12), .O(new_n61_));
  nand3  g32(.a(x12), .b(x11), .c(x09), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  aoi22  g34(.a(new_n63_), .b(new_n54_), .c(new_n31_), .d(new_n36_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n61_), .c(new_n60_), .d(x00), .O(z08));
  nand2  g36(.a(new_n31_), .b(new_n36_), .O(new_n66_));
  nand3  g37(.a(new_n53_), .b(x09), .c(new_n30_), .O(new_n67_));
  ...
  nand2  g41(.a(new_n70_), .b(new_n58_), .O(z09));
  nand4  g42(.a(new_n53_), .b(x12), .c(x11), .d(new_n60_), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(x09), .c(x08), .d(x00), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(z10));
  nand4  g46(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  inv1   g47(.a(x01), .O(new_n77_));
  nand2  g48(.a(new_n31_), .b(new_n77_), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand4  g50(.a(new_n79_), .b(x11), .c(new_n60_), .d(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n58_), .O(z11));
  nand4  g52(.a(x11), .b(new_n60_), .c(new_n43_), .d(x00), .O(new_n82_));
  aoi21  g53(.a(new_n82_), .b(x08), .c(new_n31_), .O(z12));
endmodule
