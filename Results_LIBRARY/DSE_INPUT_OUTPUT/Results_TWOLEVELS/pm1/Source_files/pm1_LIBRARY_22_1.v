...
module FAU ( 
  ...
  oai21  g16(.a(new_n30_), .b(new_n45_), .c(x15), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  inv1   g18(.a(x15), .O(new_n48_));
  nand2  g19(.a(x12), .b(x09), .O(new_n49_));
  oai22  g20(.a(new_n49_), .b(new_n45_), .c(new_n48_), .d(x14), .O(new_n50_));
  ...
  nor2   g25(.a(x15), .b(new_n45_), .O(new_n55_));
  aoi21  g26(.a(new_n55_), .b(new_n45_), .c(x14), .O(z04));
  aoi21  g27(.a(x15), .b(new_n30_), .c(x13), .O(z05));
  nand2  g28(.a(x12), .b(new_n45_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x04), .c(x03), .d(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n41_), .c(x09), .d(x01), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z06));
  aoi21  g32(.a(new_n35_), .b(new_n33_), .c(x15), .O(z07));
  oai21  g33(.a(new_n48_), .b(x14), .c(new_n45_), .O(new_n63_));
  ...
  nor2   g39(.a(new_n40_), .b(new_n45_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(new_n68_), .c(new_n66_), .d(x09), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n65_), .c(new_n63_), .d(new_n41_), .O(z08));
  nand3  g42(.a(x04), .b(x03), .c(x02), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(x15), .c(new_n30_), .d(x09), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(x12), .c(x11), .O(new_n74_));
  nand2  g45(.a(new_n40_), .b(new_n45_), .O(new_n75_));
  ...
  nand4  g49(.a(new_n72_), .b(new_n41_), .c(x12), .d(x11), .O(new_n79_));
  inv1   g50(.a(new_n79_), .O(new_n80_));
  nand4  g51(.a(new_n80_), .b(new_n66_), .c(x09), .d(x00), .O(new_n81_));
  ...
  nand2  g59(.a(new_n69_), .b(new_n66_), .O(new_n89_));
