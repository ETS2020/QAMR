...
module FAU ( 
  ...
  oai21  g07(.a(x15), .b(x12), .c(new_n35_), .O(z01));
  ...
  nand3  g15(.a(new_n39_), .b(x12), .c(new_n31_), .O(new_n45_));
  ...
  nand3  g20(.a(new_n49_), .b(new_n42_), .c(new_n32_), .O(z03));
  ...
  nand2  g28(.a(x15), .b(x11), .O(z07));
  inv1   g29(.a(x10), .O(new_n59_));
  nand4  g30(.a(new_n54_), .b(x12), .c(x11), .d(x09), .O(new_n60_));
  nand3  g31(.a(new_n39_), .b(new_n38_), .c(new_n31_), .O(new_n61_));
  and2   g32(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n32_), .c(new_n59_), .d(x00), .O(z08));
  and2   g34(.a(x03), .b(x02), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n53_), .c(x09), .d(x04), .O(new_n65_));
  ...
  nand4  g40(.a(new_n53_), .b(x12), .c(x11), .d(new_n59_), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(x09), .c(x00), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n41_), .O(z10));
  ...
  nor2   g50(.a(new_n79_), .b(new_n38_), .O(z12));
endmodule
