...
module FAU ( 
  ...
  nor2   g18(.a(x12), .b(x09), .O(new_n48_));
  ...
  nand2  g31(.a(new_n30_), .b(new_n32_), .O(new_n61_));
  oai21  g32(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n58_), .c(x09), .O(new_n63_));
  ...
  nand3  g38(.a(new_n67_), .b(new_n52_), .c(x04), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(x12), .c(x11), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(new_n61_), .c(new_n39_), .O(new_n70_));
  nor3   g41(.a(new_n30_), .b(new_n32_), .c(x09), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n66_), .O(z09));
  nand4  g44(.a(new_n67_), .b(x12), .c(x11), .d(new_n58_), .O(new_n74_));
  nor3   g45(.a(new_n74_), .b(new_n39_), .c(new_n66_), .O(z10));
  inv1   g46(.a(x01), .O(new_n76_));
  nand4  g47(.a(x11), .b(new_n58_), .c(new_n76_), .d(x00), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(x09), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n30_), .O(new_n79_));
  inv1   g50(.a(new_n74_), .O(new_n80_));
  nand4  g51(.a(new_n80_), .b(x09), .c(x01), .d(x00), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n79_), .O(z11));
  nand4  g53(.a(x11), .b(new_n58_), .c(new_n39_), .d(x00), .O(new_n83_));
