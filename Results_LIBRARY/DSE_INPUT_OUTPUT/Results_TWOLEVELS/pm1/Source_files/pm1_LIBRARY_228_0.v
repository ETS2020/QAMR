...
module FAU ( 
  ...
  nor2   g13(.a(x12), .b(x11), .O(new_n43_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n45_), .O(z10));
  inv1   g40(.a(x01), .O(new_n70_));
  nand3  g41(.a(new_n53_), .b(new_n70_), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(x11), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n56_), .O(new_n73_));
  nand3  g44(.a(new_n67_), .b(x01), .c(x00), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n73_), .O(z11));
  nand2  g46(.a(new_n65_), .b(x00), .O(new_n76_));
  nand2  g47(.a(new_n57_), .b(new_n53_), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n76_), .c(new_n45_), .O(z12));
endmodule
