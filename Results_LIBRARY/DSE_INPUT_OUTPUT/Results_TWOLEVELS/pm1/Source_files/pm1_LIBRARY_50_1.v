...
module FAU ( 
  ...
  aoi21  g25(.a(new_n52_), .b(new_n43_), .c(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n44_), .c(new_n51_), .d(x00), .O(z08));
  nand2  g27(.a(new_n52_), .b(new_n43_), .O(new_n57_));
  ...
  nor2   g45(.a(new_n74_), .b(new_n52_), .O(z12));
endmodule
