...
module FAU ( 
  ...
  nand4  g14(.a(new_n43_), .b(new_n41_), .c(z04), .d(new_n32_), .O(new_n44_));
  ...
  oai21  g19(.a(new_n48_), .b(x14), .c(new_n30_), .O(new_n49_));
  nand2  g20(.a(new_n49_), .b(new_n32_), .O(new_n50_));
  oai21  g21(.a(new_n43_), .b(x14), .c(new_n30_), .O(new_n51_));
  ...
  nor2   g27(.a(x14), .b(x12), .O(new_n57_));
  ...
  nand3  g31(.a(new_n48_), .b(z04), .c(new_n30_), .O(new_n61_));
  ...
  nand2  g36(.a(new_n65_), .b(x13), .O(z05));
  and2   g37(.a(x03), .b(x02), .O(new_n67_));
  nand2  g38(.a(x12), .b(new_n32_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(new_n67_), .c(x04), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(x09), .c(x01), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n65_), .O(z06));
  nand2  g42(.a(new_n65_), .b(x15), .O(z07));
  nand3  g43(.a(x04), .b(x03), .c(x02), .O(new_n73_));
  nand3  g44(.a(x12), .b(x11), .c(x09), .O(new_n74_));
  nand2  g45(.a(new_n57_), .b(new_n32_), .O(new_n75_));
  oai21  g46(.a(new_n74_), .b(new_n73_), .c(new_n75_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n42_), .c(x00), .O(new_n77_));
  oai21  g48(.a(new_n57_), .b(x12), .c(new_n48_), .O(new_n78_));
  nand3  g49(.a(new_n78_), .b(new_n77_), .c(new_n68_), .O(z08));
  nand4  g50(.a(new_n73_), .b(new_n67_), .c(x09), .d(x04), .O(new_n80_));
  nand3  g51(.a(new_n80_), .b(x12), .c(x11), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n75_), .O(new_n82_));
  nand3  g53(.a(new_n82_), .b(new_n42_), .c(x00), .O(new_n83_));
  inv1   g54(.a(new_n83_), .O(z09));
  nand4  g55(.a(new_n73_), .b(x12), .c(x11), .d(new_n42_), .O(new_n85_));
  nor3   g56(.a(new_n85_), .b(new_n62_), .c(new_n40_), .O(z10));
  nand4  g57(.a(new_n73_), .b(x12), .c(x09), .d(x01), .O(new_n87_));
  inv1   g58(.a(x01), .O(new_n88_));
  nand2  g59(.a(new_n57_), .b(new_n88_), .O(new_n89_));
  nand2  g60(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand4  g61(.a(new_n90_), .b(x11), .c(new_n42_), .d(x00), .O(new_n91_));
  inv1   g62(.a(new_n91_), .O(z11));
  nand4  g63(.a(x11), .b(new_n42_), .c(new_n62_), .d(x00), .O(new_n93_));
  nor2   g64(.a(new_n93_), .b(new_n30_), .O(z12));
endmodule
