...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_, new_n37_,
    ...
    new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n54_, new_n57_,
  ...
  nand4  g08(.a(x08), .b(new_n37_), .c(x06), .d(x05), .O(new_n38_));
  aoi21  g09(.a(new_n38_), .b(x15), .c(new_n37_), .O(new_n39_));
  oai21  g10(.a(new_n39_), .b(new_n30_), .c(new_n36_), .O(z00));
  nand2  g11(.a(x12), .b(new_n30_), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(new_n37_), .O(new_n42_));
  aoi21  g13(.a(new_n38_), .b(x11), .c(new_n34_), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(z07), .c(new_n42_), .O(z01));
  oai21  g15(.a(z07), .b(x11), .c(new_n37_), .O(new_n45_));
  ...
  oai21  g19(.a(new_n48_), .b(z07), .c(new_n45_), .O(z02));
  nand2  g20(.a(new_n47_), .b(new_n32_), .O(new_n50_));
  nand3  g21(.a(x07), .b(x06), .c(x05), .O(new_n51_));
  nand3  g22(.a(x15), .b(x11), .c(x08), .O(new_n52_));
  ...
  nand4  g27(.a(new_n41_), .b(x04), .c(x03), .d(x02), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n32_), .c(x09), .d(x01), .O(new_n58_));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n61_), .c(new_n54_), .O(z08));
  ...
  nand2  g45(.a(new_n34_), .b(new_n30_), .O(new_n75_));
