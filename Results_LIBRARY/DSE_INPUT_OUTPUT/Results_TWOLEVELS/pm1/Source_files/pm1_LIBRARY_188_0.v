...
module FAU ( 
  ...
  nand2  g34(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n62_), .c(new_n53_), .O(z08));
  inv1   g36(.a(x00), .O(new_n66_));
  oai21  g37(.a(new_n63_), .b(x11), .c(x15), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nand4  g39(.a(new_n59_), .b(new_n52_), .c(x09), .d(x04), .O(new_n69_));
