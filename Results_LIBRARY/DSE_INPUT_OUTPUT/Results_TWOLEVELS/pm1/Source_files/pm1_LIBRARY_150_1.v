...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n54_, new_n55_, new_n59_, new_n60_, new_n61_, new_n64_, new_n65_,
  ...
  oai21  g10(.a(x15), .b(x07), .c(new_n39_), .O(new_n40_));
  ...
  nand3  g21(.a(new_n50_), .b(x11), .c(new_n30_), .O(new_n51_));
  ...
  nor2   g27(.a(new_n43_), .b(x14), .O(z04));
  nor2   g28(.a(new_n43_), .b(x13), .O(z05));
  ...
  nor2   g40(.a(new_n69_), .b(new_n45_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n65_), .c(new_n43_), .O(z08));
  nand4  g42(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(x09), .O(new_n73_));
  ...
  nand2  g49(.a(new_n33_), .b(new_n45_), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g51(.a(new_n80_), .b(new_n67_), .c(x00), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n31_), .O(z09));
  and2   g53(.a(new_n75_), .b(x12), .O(new_n83_));
  nand3  g54(.a(new_n83_), .b(x11), .c(new_n67_), .O(new_n84_));
  inv1   g55(.a(new_n84_), .O(new_n85_));
  nand3  g56(.a(new_n85_), .b(x09), .c(x00), .O(new_n86_));
  nand2  g57(.a(new_n86_), .b(new_n31_), .O(z10));
  nand3  g58(.a(new_n83_), .b(x09), .c(x01), .O(new_n88_));
  nand2  g59(.a(new_n88_), .b(new_n34_), .O(new_n89_));
  nand4  g60(.a(new_n89_), .b(new_n31_), .c(x11), .d(new_n67_), .O(new_n90_));
  nor2   g61(.a(new_n90_), .b(new_n64_), .O(z11));
  nand4  g62(.a(new_n31_), .b(x12), .c(x11), .d(new_n67_), .O(new_n92_));
  nor3   g63(.a(new_n92_), .b(x09), .c(new_n64_), .O(z12));
endmodule
