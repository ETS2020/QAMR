...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n61_, new_n62_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_,
  ...
  nor2   g35(.a(new_n36_), .b(x13), .O(z05));
  and2   g36(.a(x03), .b(x02), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(new_n38_), .c(x04), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x09), .c(x01), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n37_), .O(z06));
  nor2   g40(.a(new_n36_), .b(x15), .O(z07));
  nand3  g41(.a(x04), .b(x03), .c(x02), .O(new_n71_));
  nand3  g42(.a(x12), .b(x11), .c(x09), .O(new_n72_));
  nand3  g43(.a(new_n43_), .b(new_n30_), .c(x06), .O(new_n73_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(new_n47_), .c(x00), .O(new_n75_));
  inv1   g46(.a(x00), .O(new_n76_));
  oai22  g47(.a(x12), .b(x06), .c(x10), .d(new_n76_), .O(new_n77_));
  nand3  g48(.a(new_n77_), .b(new_n75_), .c(new_n38_), .O(z08));
  nand2  g49(.a(new_n30_), .b(new_n47_), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(new_n76_), .c(x06), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n43_), .O(new_n81_));
  nand4  g52(.a(new_n71_), .b(new_n66_), .c(x09), .d(x04), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(x12), .c(x11), .d(new_n47_), .O(new_n83_));
  oai21  g54(.a(new_n83_), .b(new_n76_), .c(new_n81_), .O(z09));
  nand4  g55(.a(new_n71_), .b(x12), .c(x11), .d(new_n47_), .O(new_n85_));
  inv1   g56(.a(new_n85_), .O(new_n86_));
  nand3  g57(.a(new_n86_), .b(x09), .c(x00), .O(new_n87_));
  nand2  g58(.a(new_n87_), .b(new_n37_), .O(z10));
  nand4  g59(.a(new_n71_), .b(x12), .c(x09), .d(x01), .O(new_n89_));
  nand3  g60(.a(new_n43_), .b(x06), .c(new_n35_), .O(new_n90_));
  nand2  g61(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g62(.a(new_n91_), .b(x11), .c(new_n47_), .d(x00), .O(new_n92_));
  inv1   g63(.a(new_n92_), .O(z11));
  inv1   g64(.a(x09), .O(new_n94_));
  nand4  g65(.a(x11), .b(new_n47_), .c(new_n94_), .d(x00), .O(new_n95_));
  nor2   g66(.a(new_n95_), .b(new_n43_), .O(z12));
endmodule
