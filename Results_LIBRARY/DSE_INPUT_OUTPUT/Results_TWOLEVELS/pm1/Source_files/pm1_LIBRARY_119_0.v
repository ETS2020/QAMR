...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    new_n39_, new_n40_, new_n41_, new_n43_, new_n46_, new_n48_, new_n49_,
  ...
  nand2  g16(.a(z05), .b(new_n30_), .O(new_n46_));
  ...
  aoi21  g23(.a(z05), .b(new_n30_), .c(x15), .O(z07));
  inv1   g24(.a(x10), .O(new_n54_));
  nand3  g25(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  nand3  g26(.a(x12), .b(x11), .c(x09), .O(new_n56_));
  nand3  g27(.a(x13), .b(new_n30_), .c(new_n32_), .O(new_n57_));
  ...
  nand2  g42(.a(new_n71_), .b(new_n46_), .O(z10));
  nand4  g43(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n73_));
  inv1   g44(.a(x01), .O(new_n74_));
  nand3  g45(.a(x13), .b(new_n30_), .c(new_n74_), .O(new_n75_));
