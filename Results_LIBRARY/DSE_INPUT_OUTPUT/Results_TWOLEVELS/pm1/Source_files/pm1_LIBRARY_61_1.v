...
module FAU ( 
  ...
  nand2  g04(.a(x15), .b(z04), .O(new_n34_));
  ...
  nand4  g16(.a(new_n36_), .b(x04), .c(x03), .d(x02), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(x09), .c(x01), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(new_n34_), .O(z06));
  ...
  oai21  g24(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n50_), .O(new_n55_));
  aoi21  g26(.a(x15), .b(z04), .c(x10), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n55_), .c(new_n36_), .d(x00), .O(z08));
  nand4  g28(.a(new_n51_), .b(x15), .c(z04), .d(x09), .O(new_n58_));
  ...
  nand4  g35(.a(new_n64_), .b(new_n50_), .c(x09), .d(x00), .O(new_n65_));
