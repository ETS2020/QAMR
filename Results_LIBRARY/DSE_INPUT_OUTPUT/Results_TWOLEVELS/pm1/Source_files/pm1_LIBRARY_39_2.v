...
module FAU ( 
  ...
  aoi21  g21(.a(new_n50_), .b(x14), .c(new_n30_), .O(new_n51_));
  ...
  nand4  g29(.a(new_n58_), .b(x14), .c(x12), .d(x11), .O(new_n59_));
  oai22  g30(.a(new_n59_), .b(new_n57_), .c(new_n56_), .d(new_n31_), .O(z08));
  nand3  g31(.a(x12), .b(x11), .c(new_n48_), .O(new_n61_));
  oai21  g32(.a(x12), .b(x11), .c(new_n61_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n42_), .O(new_n63_));
  nand3  g34(.a(x04), .b(new_n30_), .c(x02), .O(new_n64_));
  ...
  nand3  g39(.a(new_n68_), .b(new_n54_), .c(x00), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z09));
  inv1   g41(.a(x00), .O(new_n71_));
  nand2  g42(.a(x04), .b(x02), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(x14), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x03), .c(new_n37_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x11), .c(new_n54_), .d(x09), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n71_), .c(new_n42_), .O(z10));
  nand3  g47(.a(x04), .b(x03), .c(x02), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x12), .c(x09), .d(x01), .O(new_n78_));
  oai21  g49(.a(x12), .b(x01), .c(new_n78_), .O(new_n79_));
  nand4  g50(.a(new_n79_), .b(x11), .c(new_n54_), .d(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n42_), .O(z11));
  nor2   g52(.a(new_n31_), .b(new_n37_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(x11), .c(new_n54_), .d(new_n48_), .O(new_n83_));
  oai21  g54(.a(new_n83_), .b(new_n71_), .c(new_n42_), .O(z12));
endmodule
