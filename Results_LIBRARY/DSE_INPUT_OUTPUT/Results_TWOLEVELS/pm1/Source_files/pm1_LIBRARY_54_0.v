...
module FAU ( 
  ...
  oai21  g00(.a(x12), .b(x01), .c(x14), .O(new_n30_));
  ...
  nor2   g05(.a(x14), .b(x11), .O(new_n35_));
  inv1   g06(.a(new_n35_), .O(new_n36_));
  nand3  g07(.a(new_n36_), .b(new_n33_), .c(x12), .O(z01));
  ...
  nand3  g19(.a(x14), .b(x12), .c(new_n48_), .O(new_n49_));
  oai21  g20(.a(new_n47_), .b(new_n35_), .c(new_n49_), .O(new_n50_));
  ...
  nand4  g27(.a(x12), .b(new_n55_), .c(x09), .d(x04), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n54_), .c(x11), .O(new_n59_));
  oai21  g30(.a(z04), .b(x11), .c(new_n59_), .O(z08));
