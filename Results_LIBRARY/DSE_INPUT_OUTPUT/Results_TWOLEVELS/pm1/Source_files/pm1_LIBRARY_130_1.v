...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n53_, new_n54_,
  ...
  nand3  g08(.a(new_n37_), .b(new_n36_), .c(x08), .O(new_n38_));
  nand2  g09(.a(new_n38_), .b(x07), .O(new_n39_));
  oai21  g10(.a(x14), .b(x07), .c(new_n39_), .O(new_n40_));
  nand2  g11(.a(new_n40_), .b(x11), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(new_n35_), .O(z00));
  inv1   g13(.a(new_n31_), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(x12), .c(new_n41_), .O(z01));
  inv1   g15(.a(x11), .O(new_n45_));
  nand2  g16(.a(new_n31_), .b(new_n45_), .O(new_n46_));
  nand2  g17(.a(new_n37_), .b(x11), .O(new_n47_));
  nand3  g18(.a(new_n47_), .b(x12), .c(x09), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x07), .O(new_n49_));
  inv1   g20(.a(x14), .O(z04));
  nand3  g21(.a(z04), .b(x11), .c(new_n30_), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(new_n49_), .c(new_n46_), .O(z02));
  nand3  g23(.a(x12), .b(x11), .c(x09), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n31_), .O(new_n54_));
  nand4  g25(.a(new_n36_), .b(x11), .c(x08), .d(x07), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n54_), .O(z03));
  nor2   g27(.a(new_n43_), .b(x13), .O(z05));
  ...
  nand2  g32(.a(new_n31_), .b(x15), .O(z07));
  ...
  nand4  g37(.a(x12), .b(x11), .c(new_n66_), .d(x09), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n45_), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(new_n64_), .c(new_n43_), .O(z08));
  ...
  nand2  g48(.a(new_n33_), .b(new_n45_), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g50(.a(new_n79_), .b(new_n66_), .c(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n31_), .O(z09));
  and2   g52(.a(new_n74_), .b(x12), .O(new_n82_));
  nand3  g53(.a(new_n82_), .b(x11), .c(new_n66_), .O(new_n83_));
  inv1   g54(.a(new_n83_), .O(new_n84_));
  nand3  g55(.a(new_n84_), .b(x09), .c(x00), .O(new_n85_));
  nand2  g56(.a(new_n85_), .b(new_n31_), .O(z10));
  nand3  g57(.a(new_n82_), .b(x09), .c(x01), .O(new_n87_));
  nand2  g58(.a(new_n87_), .b(new_n34_), .O(new_n88_));
  nand4  g59(.a(new_n88_), .b(x11), .c(new_n66_), .d(x00), .O(new_n89_));
  nand2  g60(.a(new_n89_), .b(new_n31_), .O(z11));
  nand4  g61(.a(new_n31_), .b(x12), .c(x11), .d(new_n66_), .O(new_n91_));
  nor3   g62(.a(new_n91_), .b(x09), .c(new_n63_), .O(z12));
endmodule
