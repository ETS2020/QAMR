...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n45_, new_n46_, new_n47_, new_n51_,
    new_n54_;
  ...
  oai21  g20(.a(new_n38_), .b(x11), .c(new_n40_), .O(z08));
  nand4  g21(.a(new_n32_), .b(new_n31_), .c(new_n34_), .d(x00), .O(new_n51_));
  inv1   g22(.a(new_n51_), .O(z09));
  nand3  g23(.a(new_n34_), .b(new_n30_), .c(x00), .O(new_n54_));
  aoi21  g24(.a(new_n54_), .b(new_n32_), .c(new_n31_), .O(z11));
  zero   g25(.O(z10));
  zero   g26(.O(z12));
  nand3  g27(.a(new_n40_), .b(new_n38_), .c(new_n31_), .O(z03));
endmodule
