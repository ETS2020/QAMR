...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n59_, new_n61_, new_n62_, new_n63_, new_n64_, new_n65_, new_n68_,
    new_n69_;
  ...
  nand3  g21(.a(new_n41_), .b(x09), .c(x01), .O(new_n51_));
  ...
  nand2  g29(.a(new_n41_), .b(new_n58_), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n30_), .c(new_n33_), .O(z09));
  inv1   g31(.a(z09), .O(new_n61_));
  inv1   g32(.a(new_n34_), .O(new_n62_));
  inv1   g33(.a(new_n35_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(new_n62_), .c(x11), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n33_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(new_n61_), .c(new_n58_), .O(z08));
  inv1   g37(.a(x01), .O(new_n68_));
  nand3  g38(.a(x11), .b(new_n58_), .c(new_n68_), .O(new_n69_));
  aoi21  g39(.a(new_n69_), .b(new_n30_), .c(new_n33_), .O(z11));
  zero   g40(.O(z10));
  zero   g41(.O(z12));
endmodule
