...
module FAU ( 
  ...
  nand3  g26(.a(new_n34_), .b(new_n30_), .c(x00), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(new_n32_), .c(new_n31_), .O(z11));
  nand2  g28(.a(new_n42_), .b(new_n40_), .O(z03));
  nor2   g29(.a(new_n32_), .b(new_n31_), .O(z12));
endmodule
