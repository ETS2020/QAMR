...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n46_, new_n48_, new_n49_, new_n50_, new_n53_, new_n55_, new_n56_,
  ...
  nor3   g10(.a(new_n37_), .b(new_n36_), .c(x14), .O(new_n40_));
  ...
  oai21  g14(.a(new_n43_), .b(x14), .c(x11), .O(new_n44_));
  nand3  g15(.a(x12), .b(x11), .c(x09), .O(new_n45_));
  inv1   g16(.a(new_n45_), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(new_n44_), .O(z02));
  nand3  g18(.a(new_n35_), .b(x08), .c(x07), .O(new_n48_));
  oai21  g19(.a(new_n48_), .b(new_n36_), .c(new_n35_), .O(new_n49_));
  nand2  g20(.a(new_n49_), .b(x11), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(new_n46_), .O(z03));
  nand2  g22(.a(x14), .b(new_n30_), .O(z04));
  ...
  oai22  g27(.a(new_n56_), .b(new_n53_), .c(new_n32_), .d(x11), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(x09), .c(x01), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z06));
  oai21  g30(.a(new_n35_), .b(new_n30_), .c(x15), .O(z07));
  inv1   g31(.a(x00), .O(new_n61_));
  inv1   g32(.a(x10), .O(new_n62_));
  nand4  g33(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n63_));
  nand4  g34(.a(x12), .b(x11), .c(new_n62_), .d(x09), .O(new_n64_));
  oai21  g35(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n61_), .c(new_n35_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(x11), .O(z08));
  ...
  nand2  g41(.a(new_n70_), .b(new_n41_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(new_n62_), .c(x00), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(z09));
  nand4  g44(.a(new_n55_), .b(new_n35_), .c(x12), .d(new_n62_), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(x09), .c(x00), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(new_n35_), .c(new_n30_), .O(z10));
  nand4  g48(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n33_), .O(new_n79_));
  nand3  g50(.a(new_n79_), .b(new_n62_), .c(x00), .O(new_n80_));
  aoi21  g51(.a(new_n80_), .b(new_n35_), .c(new_n30_), .O(z11));
  nor2   g52(.a(x09), .b(new_n61_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(new_n35_), .c(x12), .d(new_n62_), .O(new_n83_));
  aoi21  g54(.a(new_n83_), .b(new_n35_), .c(new_n30_), .O(z12));
endmodule
