...
module FAU ( 
  ...
  nand4  g02(.a(new_n31_), .b(x15), .c(new_n30_), .d(x07), .O(new_n32_));
  nand2  g03(.a(new_n32_), .b(x11), .O(new_n33_));
  inv1   g04(.a(x15), .O(new_n34_));
  nor2   g05(.a(new_n34_), .b(x08), .O(new_n35_));
  nor3   g06(.a(new_n35_), .b(x12), .c(x01), .O(new_n36_));
  nand2  g07(.a(new_n36_), .b(new_n33_), .O(z00));
  inv1   g08(.a(x12), .O(new_n38_));
  nor2   g09(.a(new_n35_), .b(new_n38_), .O(new_n39_));
  nand2  g10(.a(new_n39_), .b(new_n33_), .O(z01));
  nand3  g11(.a(x07), .b(x06), .c(x05), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x11), .O(new_n42_));
  nand4  g13(.a(x12), .b(x11), .c(x09), .d(x08), .O(new_n43_));
  inv1   g14(.a(new_n43_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(new_n42_), .O(z02));
  inv1   g16(.a(x11), .O(new_n46_));
  aoi21  g17(.a(new_n31_), .b(x07), .c(new_n46_), .O(new_n47_));
  or2    g18(.a(new_n47_), .b(new_n30_), .O(new_n48_));
  aoi21  g19(.a(new_n34_), .b(new_n46_), .c(new_n35_), .O(new_n49_));
  nand4  g20(.a(new_n49_), .b(new_n48_), .c(x12), .d(x09), .O(z03));
  nor2   g21(.a(new_n35_), .b(x14), .O(z04));
  nor2   g22(.a(new_n35_), .b(x13), .O(z05));
  nand2  g23(.a(x15), .b(new_n30_), .O(new_n53_));
  and2   g24(.a(x03), .b(x02), .O(new_n54_));
  nand2  g25(.a(x12), .b(new_n46_), .O(new_n55_));
  ...
  nor2   g36(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n61_), .c(new_n35_), .O(z08));
  nand3  g38(.a(x04), .b(x03), .c(x02), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n54_), .c(x09), .d(x04), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(x12), .c(x11), .O(new_n70_));
  nand2  g41(.a(new_n38_), .b(new_n46_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n53_), .c(new_n63_), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z09));
  nand4  g45(.a(new_n68_), .b(new_n53_), .c(x12), .d(x11), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(new_n63_), .c(x09), .d(x00), .O(new_n77_));
  inv1   g48(.a(new_n77_), .O(z10));
  nand4  g49(.a(new_n68_), .b(x12), .c(x09), .d(x01), .O(new_n79_));
  oai21  g50(.a(x12), .b(x01), .c(new_n79_), .O(new_n80_));
  nand4  g51(.a(new_n80_), .b(x11), .c(new_n63_), .d(x00), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n53_), .O(z11));
  nand3  g53(.a(new_n39_), .b(x11), .c(new_n63_), .O(new_n83_));
  nor3   g54(.a(new_n83_), .b(x09), .c(new_n60_), .O(z12));
endmodule
