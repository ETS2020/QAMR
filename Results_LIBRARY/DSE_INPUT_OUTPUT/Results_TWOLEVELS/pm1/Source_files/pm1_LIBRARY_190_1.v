...
module FAU ( 
  ...
  nor2   g12(.a(new_n41_), .b(x06), .O(new_n42_));
  inv1   g13(.a(new_n42_), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(new_n40_), .O(new_n44_));
  nor2   g15(.a(x15), .b(x06), .O(new_n45_));
  aoi21  g16(.a(new_n35_), .b(x06), .c(new_n45_), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(new_n37_), .c(new_n44_), .O(z01));
  oai21  g18(.a(new_n41_), .b(x12), .c(new_n37_), .O(new_n48_));
  nand2  g19(.a(new_n34_), .b(x11), .O(new_n49_));
  nand2  g20(.a(new_n49_), .b(x12), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(x06), .O(new_n51_));
  nand4  g22(.a(new_n51_), .b(new_n48_), .c(new_n32_), .d(x09), .O(z02));
  nand4  g23(.a(x11), .b(x08), .c(x07), .d(x05), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(x12), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(x06), .O(new_n55_));
  aoi21  g26(.a(new_n41_), .b(new_n40_), .c(new_n42_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n55_), .c(new_n38_), .d(x09), .O(z03));
  ...
  aoi21  g43(.a(new_n72_), .b(new_n66_), .c(new_n42_), .O(z08));
  xnor2a g44(.a(x12), .b(x11), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(new_n43_), .c(new_n64_), .d(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z09));
  nand3  g47(.a(x04), .b(x03), .c(x02), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x12), .c(x11), .d(new_n64_), .O(new_n78_));
  inv1   g49(.a(new_n78_), .O(new_n79_));
  nand3  g50(.a(new_n79_), .b(x09), .c(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n43_), .O(z10));
  ...
  nand4  g56(.a(new_n85_), .b(new_n43_), .c(x11), .d(new_n64_), .O(new_n86_));
  ...
  oai21  g61(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z12));
endmodule
