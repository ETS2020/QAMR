...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n34_, new_n36_, new_n38_, new_n39_, new_n40_,
  ...
  nand2  g02(.a(z04), .b(z05), .O(new_n32_));
  ...
  nand4  g18(.a(new_n47_), .b(new_n32_), .c(x09), .d(x01), .O(new_n48_));
  inv1   g19(.a(new_n48_), .O(z06));
  nor2   g20(.a(new_n33_), .b(x15), .O(z07));
  nand2  g21(.a(new_n39_), .b(new_n36_), .O(new_n51_));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n53_));
  nand3  g24(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  nand2  g25(.a(new_n38_), .b(new_n36_), .O(new_n55_));
  oai21  g26(.a(new_n54_), .b(new_n53_), .c(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  nor2   g28(.a(new_n33_), .b(x10), .O(new_n58_));
  ...
  nand2  g37(.a(new_n66_), .b(new_n32_), .O(z09));
  nand4  g38(.a(new_n53_), .b(new_n32_), .c(x12), .d(x11), .O(new_n68_));
  ...
  nand2  g45(.a(new_n74_), .b(new_n32_), .O(z11));
  inv1   g46(.a(x00), .O(new_n76_));
  nand3  g47(.a(new_n39_), .b(x11), .c(new_n52_), .O(new_n77_));
