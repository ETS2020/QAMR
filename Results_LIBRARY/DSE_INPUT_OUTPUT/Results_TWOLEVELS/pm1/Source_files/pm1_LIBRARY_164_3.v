...
module FAU ( 
  ...
  nor3   g28(.a(new_n36_), .b(new_n35_), .c(new_n31_), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(x15), .c(new_n49_), .O(z07));
  ...
  aoi21  g34(.a(new_n34_), .b(new_n31_), .c(new_n48_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n63_), .c(new_n60_), .d(x00), .O(z08));
  nand2  g36(.a(new_n32_), .b(new_n31_), .O(new_n66_));
  nand3  g37(.a(new_n55_), .b(x15), .c(x09), .O(new_n67_));
  ...
  nand4  g42(.a(new_n55_), .b(new_n34_), .c(x12), .d(x11), .O(new_n72_));
  ...
  nand2  g50(.a(new_n79_), .b(new_n49_), .O(z11));
  inv1   g51(.a(x09), .O(new_n81_));
  nand4  g52(.a(x11), .b(new_n60_), .c(new_n81_), .d(x00), .O(new_n82_));
