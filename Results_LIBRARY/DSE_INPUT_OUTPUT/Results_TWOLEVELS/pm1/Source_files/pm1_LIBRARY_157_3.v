...
module FAU ( 
  ...
  aoi21  g16(.a(new_n45_), .b(new_n40_), .c(new_n32_), .O(z03));
  and2   g17(.a(new_n40_), .b(new_n35_), .O(new_n47_));
  oai21  g18(.a(new_n47_), .b(x14), .c(new_n31_), .O(z04));
  ...
  oai21  g25(.a(new_n47_), .b(x15), .c(new_n31_), .O(z07));
  inv1   g26(.a(x10), .O(new_n56_));
  inv1   g27(.a(x00), .O(new_n57_));
  oai21  g28(.a(x10), .b(new_n57_), .c(new_n39_), .O(new_n58_));
  ...
  aoi21  g32(.a(new_n61_), .b(new_n51_), .c(new_n57_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n59_), .c(new_n31_), .d(new_n56_), .O(z08));
  xnor2a g34(.a(x12), .b(x11), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n31_), .c(new_n56_), .d(x00), .O(new_n65_));
