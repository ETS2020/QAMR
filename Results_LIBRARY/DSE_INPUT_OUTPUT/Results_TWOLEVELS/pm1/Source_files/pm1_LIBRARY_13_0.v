...
module FAU ( 
  ...
  aoi21  g15(.a(new_n44_), .b(new_n33_), .c(x14), .O(z04));
  nand2  g16(.a(new_n44_), .b(new_n33_), .O(new_n46_));
  ...
  oai21  g33(.a(new_n62_), .b(new_n59_), .c(new_n46_), .O(z09));
  ...
  nand2  g39(.a(new_n44_), .b(new_n68_), .O(new_n69_));
