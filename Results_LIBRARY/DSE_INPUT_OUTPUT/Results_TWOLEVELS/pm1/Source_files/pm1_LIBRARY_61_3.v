...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n47_, new_n48_, new_n49_, new_n51_,
  ...
  nand2  g07(.a(new_n33_), .b(new_n32_), .O(new_n37_));
  nand3  g08(.a(x07), .b(x06), .c(x05), .O(new_n38_));
  inv1   g09(.a(new_n38_), .O(new_n39_));
  and2   g10(.a(x09), .b(x08), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(new_n39_), .c(new_n37_), .d(z01), .O(z02));
  nand4  g12(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n42_));
  nand4  g13(.a(new_n42_), .b(new_n37_), .c(z01), .d(x09), .O(z03));
  inv1   g14(.a(x15), .O(z07));
  nand2  g15(.a(z07), .b(x14), .O(z04));
  ...
  nor2   g27(.a(new_n35_), .b(x10), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n56_), .c(new_n47_), .d(x00), .O(z08));
  nand4  g29(.a(new_n52_), .b(x15), .c(x14), .d(x09), .O(new_n59_));
  ...
  nand4  g34(.a(new_n52_), .b(new_n33_), .c(x12), .d(x11), .O(new_n64_));
