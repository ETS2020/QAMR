...
module FAU ( 
  ...
  nand3  g10(.a(x12), .b(x09), .c(x08), .O(new_n40_));
  ...
  nand2  g17(.a(new_n37_), .b(x14), .O(z04));
  ...
  nor2   g28(.a(new_n36_), .b(new_n33_), .O(new_n58_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n37_), .O(z10));
  ...
  nand4  g47(.a(x11), .b(new_n55_), .c(new_n66_), .d(x00), .O(new_n77_));
  nor2   g48(.a(new_n77_), .b(new_n36_), .O(z12));
endmodule
