...
module FAU ( 
  ...
  nand3  g21(.a(x03), .b(x02), .c(x00), .O(new_n51_));
  inv1   g22(.a(x10), .O(new_n52_));
  nand4  g23(.a(x11), .b(new_n52_), .c(x09), .d(x04), .O(new_n53_));
  oai21  g24(.a(new_n53_), .b(new_n51_), .c(x11), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(x12), .O(new_n55_));
  inv1   g26(.a(x00), .O(new_n56_));
  oai21  g27(.a(x10), .b(new_n56_), .c(x11), .O(new_n57_));
  ...
  nor2   g32(.a(new_n61_), .b(new_n56_), .O(z09));
  inv1   g33(.a(x09), .O(new_n63_));
  nand4  g34(.a(new_n47_), .b(x12), .c(x11), .d(new_n52_), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(x00), .O(new_n66_));
  ...
  nand3  g42(.a(new_n65_), .b(x01), .c(x00), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n71_), .O(z11));
  nand4  g44(.a(x11), .b(new_n52_), .c(new_n63_), .d(x00), .O(new_n74_));
