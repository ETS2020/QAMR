...
module FAU ( 
  ...
  oai21  g19(.a(x12), .b(new_n30_), .c(x13), .O(z05));
  ...
  nor2   g29(.a(new_n39_), .b(x10), .O(new_n59_));
  ...
  nand4  g35(.a(new_n57_), .b(new_n50_), .c(x09), .d(x04), .O(new_n65_));
  ...
  nor2   g40(.a(new_n51_), .b(new_n39_), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n64_), .c(x09), .d(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x12), .c(new_n30_), .O(z10));
  nor2   g43(.a(new_n51_), .b(x10), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(x09), .c(x01), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x12), .c(new_n30_), .O(z11));
  nor2   g46(.a(x09), .b(new_n61_), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  aoi21  g48(.a(new_n77_), .b(x12), .c(new_n30_), .O(z12));
endmodule
