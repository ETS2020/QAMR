...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n38_,
    ...
    new_n51_, new_n52_, new_n56_, new_n58_, new_n59_;
  ...
  nand4  g29(.a(x11), .b(new_n35_), .c(new_n58_), .d(x00), .O(new_n59_));
  nor2   g30(.a(new_n59_), .b(x12), .O(z11));
  zero   g31(.O(z12));
endmodule
