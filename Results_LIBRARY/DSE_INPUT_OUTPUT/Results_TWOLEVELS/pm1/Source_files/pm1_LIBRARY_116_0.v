...
module FAU ( 
  ...
  aoi21  g19(.a(x09), .b(x01), .c(new_n36_), .O(new_n49_));
  ...
  aoi21  g23(.a(new_n36_), .b(new_n33_), .c(x15), .O(z07));
  ...
  oai21  g35(.a(new_n64_), .b(new_n59_), .c(new_n37_), .O(z09));
  nand4  g36(.a(new_n50_), .b(x12), .c(x11), .d(new_n55_), .O(new_n66_));
