...
module FAU ( 
  ...
  nand3  g14(.a(new_n43_), .b(new_n42_), .c(new_n32_), .O(new_n44_));
  nand3  g15(.a(new_n44_), .b(new_n39_), .c(new_n30_), .O(new_n45_));
  ...
  nand3  g20(.a(new_n43_), .b(new_n39_), .c(new_n30_), .O(new_n50_));
  ...
  nor2   g56(.a(new_n85_), .b(new_n61_), .O(new_n86_));
  nand2  g57(.a(new_n86_), .b(x00), .O(new_n87_));
  nand2  g58(.a(new_n87_), .b(new_n64_), .O(z10));
  inv1   g59(.a(x01), .O(new_n89_));
  nand4  g60(.a(x11), .b(new_n40_), .c(new_n89_), .d(x00), .O(new_n90_));
  nand2  g61(.a(new_n90_), .b(new_n39_), .O(new_n91_));
  nand2  g62(.a(new_n91_), .b(new_n30_), .O(new_n92_));
  nand3  g63(.a(new_n86_), .b(x01), .c(x00), .O(new_n93_));
  nand2  g64(.a(new_n93_), .b(new_n92_), .O(z11));
  nand4  g65(.a(x11), .b(new_n40_), .c(new_n61_), .d(x00), .O(new_n95_));
