...
module FAU ( 
  ...
  nand4  g32(.a(x11), .b(new_n59_), .c(x09), .d(x04), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n61_), .c(new_n59_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n58_), .c(x12), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(x11), .O(z08));
  nand4  g36(.a(new_n60_), .b(new_n51_), .c(x09), .d(x04), .O(new_n66_));
  ...
  nand4  g42(.a(new_n51_), .b(x12), .c(x11), .d(new_n59_), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(new_n39_), .c(new_n58_), .O(z10));
  inv1   g44(.a(new_n72_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x09), .c(x01), .d(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z11));
  nand4  g47(.a(x11), .b(new_n59_), .c(new_n39_), .d(x00), .O(new_n77_));
  nor2   g48(.a(new_n77_), .b(new_n38_), .O(z12));
endmodule
