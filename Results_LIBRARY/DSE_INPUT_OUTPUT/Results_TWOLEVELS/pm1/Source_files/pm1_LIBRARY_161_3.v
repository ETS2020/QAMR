...
module FAU ( 
  ...
  aoi21  g14(.a(new_n43_), .b(new_n38_), .c(new_n31_), .O(z03));
  aoi21  g15(.a(new_n38_), .b(new_n34_), .c(x14), .O(z04));
  ...
  aoi21  g21(.a(new_n38_), .b(new_n34_), .c(x15), .O(z07));
  ...
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n52_), .d(x00), .O(new_n76_));
