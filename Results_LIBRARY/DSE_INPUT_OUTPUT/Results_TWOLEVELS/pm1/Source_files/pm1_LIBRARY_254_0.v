...
module FAU ( 
  ...
  aoi21  g22(.a(new_n43_), .b(new_n33_), .c(x15), .O(z07));
  ...
  oai21  g34(.a(new_n63_), .b(new_n58_), .c(new_n44_), .O(z09));
  inv1   g35(.a(x09), .O(new_n65_));
  nand4  g36(.a(new_n47_), .b(x12), .c(x11), .d(new_n54_), .O(new_n66_));
  nor3   g37(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z10));
  inv1   g38(.a(x01), .O(new_n68_));
  nand3  g39(.a(new_n54_), .b(new_n68_), .c(x00), .O(new_n69_));
  ...
  oai21  g47(.a(new_n76_), .b(new_n75_), .c(new_n44_), .O(z12));
endmodule
