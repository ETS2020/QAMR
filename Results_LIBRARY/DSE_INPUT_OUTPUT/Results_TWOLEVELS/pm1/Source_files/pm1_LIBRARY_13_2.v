...
module FAU ( 
  ...
  oai21  g31(.a(new_n59_), .b(x11), .c(new_n36_), .O(new_n61_));
  nand3  g32(.a(x04), .b(x03), .c(x02), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n36_), .c(x09), .O(new_n63_));
