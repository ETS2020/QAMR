...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n37_,
    ...
    new_n50_, new_n51_, new_n52_, new_n53_, new_n55_, new_n58_, new_n61_;
  ...
  nand3  g12(.a(new_n41_), .b(new_n40_), .c(new_n31_), .O(z02));
  ...
  inv1   g25(.a(new_n46_), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x15), .O(z07));
  nand2  g27(.a(new_n41_), .b(new_n40_), .O(z08));
  nand3  g28(.a(new_n35_), .b(new_n32_), .c(new_n31_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n55_), .O(z09));
  nand3  g30(.a(new_n36_), .b(new_n30_), .c(x00), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(new_n32_), .c(new_n31_), .O(z11));
  zero   g32(.O(z10));
  zero   g33(.O(z12));
endmodule
