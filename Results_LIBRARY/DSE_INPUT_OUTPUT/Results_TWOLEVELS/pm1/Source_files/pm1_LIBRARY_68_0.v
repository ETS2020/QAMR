...
module FAU ( 
  ...
  inv1   g42(.a(x12), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x11), .c(new_n56_), .d(x00), .O(new_n75_));
  inv1   g46(.a(new_n75_), .O(z11));
  nand4  g47(.a(x11), .b(new_n56_), .c(new_n67_), .d(x00), .O(new_n77_));
  nor2   g48(.a(new_n77_), .b(new_n72_), .O(z12));
endmodule
