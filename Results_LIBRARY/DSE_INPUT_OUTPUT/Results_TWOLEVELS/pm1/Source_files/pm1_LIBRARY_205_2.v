...
module FAU ( 
  ...
  oai21  g19(.a(new_n48_), .b(new_n44_), .c(new_n35_), .O(new_n49_));
  ...
  nand4  g26(.a(x11), .b(new_n53_), .c(x09), .d(x04), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nor2   g28(.a(new_n57_), .b(new_n34_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x12), .c(new_n53_), .d(x00), .O(z08));
  ...
  and2   g40(.a(new_n69_), .b(x00), .O(z10));
  nand3  g41(.a(new_n69_), .b(x01), .c(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z11));
  nand4  g43(.a(x12), .b(new_n53_), .c(new_n67_), .d(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x12), .c(new_n34_), .O(z12));
endmodule
