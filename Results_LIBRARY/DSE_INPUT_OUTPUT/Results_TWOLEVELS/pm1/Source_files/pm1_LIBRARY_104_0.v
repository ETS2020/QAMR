...
module FAU ( 
  ...
  nor2   g28(.a(new_n48_), .b(new_n30_), .O(new_n58_));
  ...
  oai21  g35(.a(new_n64_), .b(new_n61_), .c(new_n53_), .O(z09));
  ...
  nand2  g40(.a(new_n69_), .b(new_n53_), .O(z10));
  ...
  nor2   g48(.a(new_n77_), .b(new_n48_), .O(z12));
endmodule
