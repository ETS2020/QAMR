...
module FAU ( 
  ...
  nor4   g16(.a(new_n45_), .b(new_n33_), .c(new_n32_), .d(new_n44_), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(new_n41_), .c(new_n42_), .O(z02));
  nand4  g18(.a(new_n34_), .b(x11), .c(x08), .d(x07), .O(new_n48_));
  nand4  g19(.a(new_n48_), .b(x12), .c(x11), .d(x09), .O(z03));
  nand2  g20(.a(new_n41_), .b(x10), .O(new_n50_));
  ...
  nand2  g28(.a(new_n57_), .b(new_n50_), .O(z06));
  nor2   g29(.a(new_n51_), .b(x15), .O(z07));
  nand3  g30(.a(x04), .b(x03), .c(x02), .O(new_n60_));
  nand3  g31(.a(x12), .b(x11), .c(x09), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  aoi21  g33(.a(new_n41_), .b(new_n32_), .c(new_n62_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n55_), .c(new_n30_), .d(x00), .O(z08));
  nand2  g35(.a(new_n41_), .b(new_n32_), .O(new_n65_));
  nand4  g36(.a(new_n60_), .b(new_n54_), .c(x09), .d(x04), .O(new_n66_));
  ...
  nand4  g41(.a(new_n60_), .b(x12), .c(x11), .d(new_n30_), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(x09), .c(x00), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n50_), .O(z10));
  nand4  g45(.a(new_n60_), .b(x12), .c(x09), .d(x01), .O(new_n75_));
  oai21  g46(.a(x12), .b(x01), .c(new_n75_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(x11), .c(new_n30_), .d(x00), .O(new_n77_));
  inv1   g48(.a(new_n77_), .O(z11));
  nand2  g49(.a(new_n44_), .b(x00), .O(new_n79_));
  nand3  g50(.a(x12), .b(x11), .c(new_n30_), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(new_n50_), .O(z12));
endmodule
