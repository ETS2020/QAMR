...
module FAU ( 
  ...
  oai21  g27(.a(new_n55_), .b(new_n48_), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g35(.a(new_n64_), .b(new_n31_), .c(x00), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(z09));
  inv1   g37(.a(x09), .O(new_n67_));
  nand4  g38(.a(new_n48_), .b(x12), .c(x11), .d(new_n31_), .O(new_n68_));
  nor3   g39(.a(new_n68_), .b(new_n67_), .c(new_n54_), .O(new_n69_));
  or2    g40(.a(new_n69_), .b(new_n45_), .O(z10));
  nand4  g41(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n71_));
  oai21  g42(.a(x12), .b(x01), .c(new_n71_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(x11), .c(new_n31_), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z11));
  nand4  g45(.a(x11), .b(new_n31_), .c(new_n67_), .d(x00), .O(new_n75_));
