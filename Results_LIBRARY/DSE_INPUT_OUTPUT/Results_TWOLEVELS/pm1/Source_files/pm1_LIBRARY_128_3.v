...
module FAU ( 
  ...
  aoi21  g32(.a(new_n32_), .b(new_n31_), .c(new_n61_), .O(new_n62_));
  ...
  nand3  g36(.a(new_n54_), .b(x14), .c(x09), .O(new_n66_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n57_), .O(z09));
  nand4  g41(.a(new_n54_), .b(new_n34_), .c(x12), .d(x11), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n59_), .c(x09), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z10));
  nand4  g45(.a(new_n54_), .b(x12), .c(x09), .d(x01), .O(new_n75_));
  ...
  nand2  g49(.a(new_n78_), .b(new_n57_), .O(z11));
