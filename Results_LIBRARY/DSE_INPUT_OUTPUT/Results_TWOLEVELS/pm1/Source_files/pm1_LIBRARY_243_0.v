...
module FAU ( 
  ...
  and2   g00(.a(x06), .b(x05), .O(new_n30_));
  nand4  g01(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n31_));
  nand3  g02(.a(new_n31_), .b(x08), .c(x07), .O(new_n32_));
  inv1   g03(.a(new_n32_), .O(new_n33_));
  nand3  g04(.a(new_n33_), .b(new_n30_), .c(x11), .O(z00));
  inv1   g05(.a(x11), .O(new_n35_));
  aoi21  g06(.a(new_n33_), .b(new_n30_), .c(new_n35_), .O(z01));
  ...
  nand2  g13(.a(new_n40_), .b(new_n31_), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x11), .O(new_n44_));
  oai21  g15(.a(new_n42_), .b(x11), .c(new_n44_), .O(z03));
  ...
  nand2  g40(.a(new_n42_), .b(new_n69_), .O(new_n70_));
  ...
  nand4  g44(.a(x11), .b(new_n54_), .c(new_n65_), .d(x00), .O(new_n74_));
