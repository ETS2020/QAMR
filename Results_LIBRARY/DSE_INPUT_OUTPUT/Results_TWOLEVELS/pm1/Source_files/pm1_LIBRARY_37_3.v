...
module FAU ( 
  ...
  nand3  g11(.a(new_n40_), .b(new_n37_), .c(new_n30_), .O(z01));
  inv1   g12(.a(x00), .O(new_n42_));
  oai21  g13(.a(x10), .b(new_n42_), .c(new_n40_), .O(new_n43_));
  nand3  g14(.a(new_n32_), .b(new_n35_), .c(x00), .O(new_n44_));
  oai21  g15(.a(new_n32_), .b(x06), .c(new_n44_), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n30_), .O(new_n46_));
  nor2   g17(.a(new_n30_), .b(x10), .O(new_n47_));
  aoi21  g18(.a(new_n47_), .b(x00), .c(x01), .O(new_n48_));
  or2    g19(.a(new_n48_), .b(x12), .O(new_n49_));
  ...
  nand3  g25(.a(new_n54_), .b(new_n38_), .c(x00), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n49_), .c(new_n46_), .d(new_n43_), .O(z02));
  inv1   g27(.a(x01), .O(new_n57_));
  nor2   g28(.a(new_n30_), .b(new_n57_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n35_), .c(new_n57_), .d(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n32_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n31_), .c(x09), .O(z03));
  nor2   g32(.a(new_n39_), .b(x14), .O(z04));
  nand2  g33(.a(new_n40_), .b(x13), .O(z05));
  inv1   g34(.a(new_n51_), .O(new_n64_));
  nand3  g35(.a(x12), .b(new_n30_), .c(new_n38_), .O(new_n65_));
  oai21  g36(.a(new_n64_), .b(new_n39_), .c(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x09), .c(x01), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(z06));
  nand2  g39(.a(new_n40_), .b(x15), .O(z07));
  nand4  g40(.a(x12), .b(x11), .c(x09), .d(new_n38_), .O(new_n70_));
  ...
  nand3  g44(.a(new_n73_), .b(new_n65_), .c(new_n43_), .O(z08));
  nand3  g45(.a(new_n52_), .b(x12), .c(x11), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(x06), .c(new_n71_), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(new_n35_), .c(x00), .O(new_n77_));
  inv1   g48(.a(new_n77_), .O(z09));
  nand4  g49(.a(new_n51_), .b(x11), .c(new_n35_), .d(x09), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(new_n42_), .c(new_n38_), .O(new_n80_));
  and2   g51(.a(new_n80_), .b(x12), .O(z10));
  nand4  g52(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n82_));
  oai21  g53(.a(x12), .b(x01), .c(new_n82_), .O(new_n83_));
  nand4  g54(.a(new_n83_), .b(x11), .c(new_n35_), .d(x00), .O(new_n84_));
  nand2  g55(.a(new_n84_), .b(new_n40_), .O(z11));
  inv1   g56(.a(x09), .O(new_n86_));
  nand4  g57(.a(new_n47_), .b(new_n86_), .c(new_n38_), .d(x00), .O(new_n87_));
