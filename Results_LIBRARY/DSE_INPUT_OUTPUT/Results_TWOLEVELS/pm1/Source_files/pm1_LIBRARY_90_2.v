...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    new_n38_, new_n40_, new_n42_, new_n44_, new_n45_, new_n47_, new_n48_,
    new_n49_, new_n50_, new_n53_, new_n54_, new_n55_, new_n57_, new_n58_,
  ...
  nor2   g07(.a(x15), .b(z05), .O(new_n37_));
  inv1   g08(.a(new_n37_), .O(new_n38_));
  nand4  g09(.a(new_n38_), .b(new_n35_), .c(new_n33_), .d(new_n30_), .O(z00));
  inv1   g10(.a(x12), .O(new_n40_));
  inv1   g11(.a(x15), .O(z07));
  aoi21  g12(.a(z07), .b(x13), .c(new_n40_), .O(new_n42_));
  ...
  aoi21  g32(.a(new_n61_), .b(new_n58_), .c(new_n37_), .O(z08));
  inv1   g33(.a(x10), .O(new_n63_));
  xnor2a g34(.a(x12), .b(x11), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n38_), .c(new_n63_), .d(x00), .O(new_n65_));
  ...
  nand2  g41(.a(new_n70_), .b(new_n38_), .O(z10));
  nand4  g42(.a(new_n67_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  nand2  g43(.a(new_n40_), .b(new_n30_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x11), .c(new_n63_), .d(x00), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n38_), .O(z11));
  nand4  g47(.a(new_n42_), .b(x11), .c(new_n63_), .d(new_n47_), .O(new_n77_));
