...
module FAU ( 
  ...
  nand4  g34(.a(new_n63_), .b(new_n35_), .c(new_n57_), .d(x00), .O(new_n64_));
  ...
  nand2  g45(.a(new_n74_), .b(new_n35_), .O(z11));
  inv1   g46(.a(x09), .O(new_n76_));
  nor2   g47(.a(new_n31_), .b(new_n54_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(x11), .c(new_n57_), .d(new_n76_), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n53_), .O(z12));
endmodule
