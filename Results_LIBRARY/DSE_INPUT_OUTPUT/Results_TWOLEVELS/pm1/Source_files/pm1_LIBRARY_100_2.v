...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
    ...
    new_n53_, new_n55_, new_n59_, new_n60_, new_n63_, new_n64_, new_n65_,
  ...
  nand4  g06(.a(x08), .b(x07), .c(new_n35_), .d(x05), .O(new_n36_));
  aoi21  g07(.a(new_n36_), .b(x15), .c(new_n35_), .O(new_n37_));
  oai22  g08(.a(new_n37_), .b(new_n30_), .c(new_n34_), .d(new_n33_), .O(z00));
  nand2  g09(.a(x07), .b(x05), .O(new_n39_));
  nand3  g10(.a(x15), .b(x11), .c(x08), .O(new_n40_));
  ...
  oai21  g15(.a(new_n44_), .b(new_n31_), .c(x06), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(x11), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(new_n42_), .c(x12), .O(z01));
  oai21  g18(.a(new_n31_), .b(x11), .c(new_n35_), .O(new_n48_));
  nand2  g19(.a(x12), .b(new_n30_), .O(new_n49_));
  oai21  g20(.a(new_n44_), .b(new_n30_), .c(new_n49_), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(x15), .O(new_n51_));
  inv1   g22(.a(x12), .O(new_n52_));
  nor2   g23(.a(new_n33_), .b(new_n52_), .O(new_n53_));
  nand4  g24(.a(new_n53_), .b(new_n51_), .c(new_n48_), .d(x09), .O(z02));
  nand2  g25(.a(new_n53_), .b(new_n30_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n42_), .c(x12), .d(x09), .O(z03));
  nand2  g27(.a(new_n32_), .b(x14), .O(z04));
  nand2  g28(.a(new_n32_), .b(x13), .O(z05));
  nand4  g29(.a(new_n49_), .b(x04), .c(x03), .d(x02), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(x09), .c(x01), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n32_), .O(z06));
  nor2   g32(.a(x15), .b(x06), .O(z07));
  ...
  nor2   g39(.a(new_n33_), .b(x10), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(new_n68_), .c(new_n55_), .d(x00), .O(z08));
  ...
  nand2  g48(.a(new_n77_), .b(new_n32_), .O(z09));
  nand4  g49(.a(new_n64_), .b(new_n32_), .c(x12), .d(x11), .O(new_n79_));
  ...
  nand4  g56(.a(new_n85_), .b(new_n32_), .c(x11), .d(new_n63_), .O(new_n86_));
  nor2   g57(.a(new_n86_), .b(new_n83_), .O(z11));
  nand3  g58(.a(new_n53_), .b(x11), .c(new_n63_), .O(new_n88_));
