...
module FAU ( 
  ...
  and2   g04(.a(x10), .b(x03), .O(new_n34_));
  ...
  nand3  g23(.a(new_n52_), .b(new_n37_), .c(x04), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(x09), .c(x01), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n35_), .O(z06));
  nand2  g26(.a(new_n35_), .b(x15), .O(z07));
  ...
  aoi21  g31(.a(new_n46_), .b(new_n36_), .c(new_n60_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n37_), .c(new_n57_), .d(x00), .O(z08));
  nand2  g33(.a(new_n46_), .b(new_n36_), .O(new_n63_));
  nand4  g34(.a(new_n58_), .b(new_n52_), .c(x09), .d(x04), .O(new_n64_));
  ...
  nand4  g39(.a(new_n58_), .b(x12), .c(x11), .d(new_n57_), .O(new_n69_));
  ...
  nor2   g48(.a(new_n77_), .b(new_n46_), .O(z12));
endmodule
