...
module FAU ( 
  ...
  nand2  g08(.a(x13), .b(new_n30_), .O(new_n38_));
  ...
  nor2   g20(.a(x13), .b(new_n30_), .O(z05));
  ...
  aoi21  g26(.a(new_n47_), .b(new_n30_), .c(x15), .O(z07));
  inv1   g27(.a(x10), .O(new_n57_));
  nand3  g28(.a(x04), .b(x03), .c(x02), .O(new_n58_));
  nand3  g29(.a(x12), .b(x11), .c(x09), .O(new_n59_));
  oai22  g30(.a(new_n59_), .b(new_n58_), .c(new_n38_), .d(x11), .O(new_n60_));
  ...
  nand3  g34(.a(new_n63_), .b(new_n61_), .c(new_n52_), .O(z08));
  inv1   g35(.a(x00), .O(new_n65_));
  oai21  g36(.a(new_n62_), .b(x11), .c(x13), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n30_), .O(new_n67_));
  nand4  g38(.a(new_n58_), .b(new_n51_), .c(x09), .d(x04), .O(new_n68_));
  ...
  nand3  g47(.a(x13), .b(new_n30_), .c(new_n76_), .O(new_n77_));
