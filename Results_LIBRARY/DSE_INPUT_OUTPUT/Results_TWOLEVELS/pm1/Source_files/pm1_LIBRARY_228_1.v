...
module FAU ( 
  ...
  nand4  g18(.a(new_n47_), .b(new_n43_), .c(x09), .d(x01), .O(new_n48_));
  ...
  nor2   g24(.a(new_n53_), .b(new_n47_), .O(new_n54_));
  aoi21  g25(.a(new_n52_), .b(new_n42_), .c(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n43_), .c(new_n51_), .d(x00), .O(z08));
  nand2  g27(.a(new_n52_), .b(new_n42_), .O(new_n57_));
  ...
  nand3  g34(.a(new_n47_), .b(x11), .c(new_n51_), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x09), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x11), .c(new_n52_), .O(z10));
  nand4  g38(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  nand3  g39(.a(new_n52_), .b(x11), .c(new_n30_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(new_n51_), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n43_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand4  g44(.a(x11), .b(new_n51_), .c(new_n73_), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x11), .c(new_n52_), .O(z12));
endmodule
