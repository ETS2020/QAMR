...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n36_, new_n37_,
    new_n39_, new_n40_, new_n41_, new_n42_, new_n43_, new_n45_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n58_, new_n60_, new_n61_;
  ...
  oai21  g15(.a(x10), .b(new_n39_), .c(new_n30_), .O(new_n45_));
  nand3  g16(.a(new_n45_), .b(new_n41_), .c(new_n32_), .O(z03));
  nor2   g17(.a(new_n30_), .b(new_n32_), .O(z10));
  nor2   g18(.a(z10), .b(x14), .O(z04));
  nor2   g19(.a(z10), .b(x13), .O(z05));
  ...
  inv1   g26(.a(z10), .O(new_n56_));
  nand3  g27(.a(new_n56_), .b(new_n45_), .c(new_n41_), .O(z08));
  ...
  nand4  g31(.a(x11), .b(new_n35_), .c(new_n60_), .d(x00), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(x12), .O(z11));
  zero   g33(.O(z12));
endmodule
