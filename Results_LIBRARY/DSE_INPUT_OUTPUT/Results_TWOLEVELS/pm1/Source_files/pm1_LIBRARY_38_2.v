...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_,
    ...
    new_n61_, new_n63_, new_n66_, new_n67_, new_n70_, new_n71_, new_n72_,
  ...
  oai21  g20(.a(new_n41_), .b(x04), .c(new_n30_), .O(new_n50_));
  ...
  nand2  g33(.a(new_n30_), .b(x04), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(x14), .O(z04));
  aoi21  g35(.a(new_n30_), .b(x04), .c(x13), .O(z05));
  nand4  g36(.a(x11), .b(x04), .c(x03), .d(x02), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x09), .c(x01), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n63_), .O(z06));
  nand2  g39(.a(new_n63_), .b(x15), .O(z07));
  nand3  g40(.a(x04), .b(x03), .c(x02), .O(new_n70_));
  nand3  g41(.a(x12), .b(x11), .c(x09), .O(new_n71_));
  nor2   g42(.a(x12), .b(x11), .O(new_n72_));
  nand2  g43(.a(new_n72_), .b(new_n37_), .O(new_n73_));
  oai21  g44(.a(new_n71_), .b(new_n70_), .c(new_n73_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(new_n40_), .c(x00), .O(new_n75_));
  aoi21  g46(.a(new_n30_), .b(x04), .c(new_n39_), .O(new_n76_));
  aoi21  g47(.a(x12), .b(new_n32_), .c(new_n76_), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n75_), .O(z08));
  inv1   g49(.a(new_n71_), .O(new_n79_));
  oai21  g50(.a(new_n72_), .b(new_n79_), .c(new_n37_), .O(new_n80_));
  nand4  g51(.a(x09), .b(new_n37_), .c(x03), .d(x02), .O(new_n81_));
  ...
  nand4  g56(.a(new_n70_), .b(x12), .c(x11), .d(new_n40_), .O(new_n86_));
  nor3   g57(.a(new_n86_), .b(new_n59_), .c(new_n38_), .O(z10));
  nand3  g58(.a(x12), .b(x09), .c(x01), .O(new_n88_));
  inv1   g59(.a(new_n88_), .O(new_n89_));
  nor2   g60(.a(x12), .b(x01), .O(new_n90_));
  oai21  g61(.a(new_n90_), .b(new_n89_), .c(new_n37_), .O(new_n91_));
  nand2  g62(.a(x03), .b(x02), .O(new_n92_));
  nand4  g63(.a(new_n92_), .b(x12), .c(x09), .d(x01), .O(new_n93_));
  nand2  g64(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g65(.a(new_n94_), .b(x11), .c(new_n40_), .d(x00), .O(new_n95_));
  inv1   g66(.a(new_n95_), .O(z11));
  nand2  g67(.a(new_n59_), .b(x00), .O(new_n97_));
  nand3  g68(.a(x12), .b(x11), .c(new_n40_), .O(new_n98_));
  oai21  g69(.a(new_n98_), .b(new_n97_), .c(new_n63_), .O(z12));
endmodule
