...
module FAU ( 
  ...
  oai21  g15(.a(new_n44_), .b(x15), .c(x11), .O(z02));
  inv1   g16(.a(new_n43_), .O(new_n46_));
  nand4  g17(.a(new_n41_), .b(new_n36_), .c(x08), .d(x07), .O(new_n47_));
  nand4  g18(.a(new_n47_), .b(new_n46_), .c(new_n36_), .d(x11), .O(z03));
  oai21  g19(.a(new_n36_), .b(new_n30_), .c(x14), .O(z04));
  ...
  oai22  g24(.a(new_n53_), .b(new_n50_), .c(new_n38_), .d(x11), .O(new_n54_));
  nand3  g25(.a(new_n54_), .b(x09), .c(x01), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(z06));
  nand2  g27(.a(x15), .b(new_n30_), .O(z07));
  inv1   g28(.a(x10), .O(new_n58_));
  nand4  g29(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(new_n60_));
  nor2   g31(.a(x15), .b(new_n38_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n60_), .c(new_n58_), .d(x09), .O(new_n62_));
  inv1   g33(.a(x00), .O(new_n63_));
  nor2   g34(.a(x10), .b(new_n63_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n62_), .c(new_n36_), .d(x11), .O(z08));
  ...
  nand4  g42(.a(new_n52_), .b(new_n36_), .c(x12), .d(new_n58_), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(x09), .c(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(new_n36_), .c(new_n30_), .O(z10));
  nand4  g46(.a(new_n52_), .b(x12), .c(x09), .d(x01), .O(new_n76_));
  oai21  g47(.a(x12), .b(x01), .c(new_n76_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(new_n36_), .c(x11), .d(new_n58_), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n63_), .O(z11));
  inv1   g50(.a(x09), .O(new_n80_));
  nand4  g51(.a(x11), .b(new_n58_), .c(new_n80_), .d(x00), .O(new_n81_));
  nor3   g52(.a(new_n81_), .b(x15), .c(new_n38_), .O(z12));
endmodule
