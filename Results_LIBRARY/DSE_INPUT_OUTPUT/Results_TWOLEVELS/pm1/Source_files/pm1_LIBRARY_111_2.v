...
module FAU ( 
  ...
  oai22  g09(.a(new_n38_), .b(new_n33_), .c(x12), .d(x09), .O(z01));
  ...
  oai21  g13(.a(new_n42_), .b(new_n33_), .c(x12), .O(new_n43_));
  ...
  nand4  g21(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n51_));
  ...
  aoi21  g30(.a(x12), .b(new_n33_), .c(x10), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n59_), .c(new_n54_), .d(x00), .O(z08));
  nand3  g32(.a(new_n33_), .b(new_n55_), .c(x00), .O(new_n62_));
  ...
  oai21  g36(.a(new_n65_), .b(new_n31_), .c(new_n30_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(x11), .c(new_n55_), .d(x00), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n64_), .O(z09));
  inv1   g39(.a(x00), .O(new_n69_));
  nand4  g40(.a(new_n65_), .b(x12), .c(x11), .d(new_n55_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n31_), .c(new_n69_), .O(z10));
  nand4  g42(.a(new_n65_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  inv1   g43(.a(x01), .O(new_n73_));
  nand3  g44(.a(new_n30_), .b(new_n31_), .c(new_n73_), .O(new_n74_));
  ...
  nand2  g48(.a(new_n31_), .b(x00), .O(new_n78_));
  nand3  g49(.a(x12), .b(x11), .c(new_n55_), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(z12));
endmodule
