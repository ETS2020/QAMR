...
module FAU ( 
  ...
  oai21  g13(.a(new_n42_), .b(new_n31_), .c(x11), .O(z02));
  ...
  nand2  g18(.a(new_n31_), .b(x11), .O(new_n48_));
  ...
  nand4  g32(.a(new_n61_), .b(new_n59_), .c(x09), .d(x04), .O(new_n62_));
  inv1   g33(.a(x00), .O(new_n63_));
  nor2   g34(.a(x10), .b(new_n63_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n62_), .c(x12), .d(x11), .O(z08));
  oai21  g36(.a(new_n64_), .b(x11), .c(new_n31_), .O(new_n66_));
  oai21  g37(.a(new_n53_), .b(new_n40_), .c(new_n31_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n59_), .d(x00), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n66_), .O(z09));
  ...
  nand4  g45(.a(x11), .b(new_n59_), .c(new_n40_), .d(x00), .O(new_n75_));
