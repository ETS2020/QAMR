...
module FAU ( 
  ...
  oai21  g04(.a(new_n30_), .b(x11), .c(new_n33_), .O(z00));
  ...
  nand2  g14(.a(new_n36_), .b(x14), .O(z04));
  aoi21  g15(.a(new_n30_), .b(new_n35_), .c(x13), .O(z05));
  aoi21  g16(.a(x09), .b(x01), .c(new_n30_), .O(new_n46_));
  ...
  nor2   g24(.a(new_n30_), .b(new_n35_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(new_n51_), .d(x09), .O(new_n55_));
  ...
  oai21  g31(.a(new_n60_), .b(new_n57_), .c(new_n36_), .O(z09));
  inv1   g32(.a(x09), .O(new_n62_));
  nand4  g33(.a(new_n47_), .b(x12), .c(x11), .d(new_n51_), .O(new_n63_));
  ...
  nand2  g42(.a(new_n54_), .b(new_n51_), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(new_n71_), .c(new_n36_), .O(z12));
endmodule
