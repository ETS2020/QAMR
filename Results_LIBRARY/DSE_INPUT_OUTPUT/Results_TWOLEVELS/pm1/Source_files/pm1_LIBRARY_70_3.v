...
module FAU ( 
  ...
  nand4  g14(.a(new_n43_), .b(new_n41_), .c(new_n32_), .d(x12), .O(z02));
  nand3  g15(.a(x11), .b(x08), .c(x07), .O(new_n45_));
  oai21  g16(.a(new_n45_), .b(new_n36_), .c(x11), .O(new_n46_));
  oai21  g17(.a(new_n46_), .b(new_n42_), .c(new_n32_), .O(new_n47_));
  ...
  nor2   g22(.a(new_n37_), .b(new_n36_), .O(new_n52_));
  aoi21  g23(.a(new_n52_), .b(x11), .c(x13), .O(z05));
  ...
  nand3  g32(.a(new_n43_), .b(new_n32_), .c(x12), .O(new_n62_));
  oai21  g33(.a(new_n62_), .b(new_n54_), .c(new_n61_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  nand2  g35(.a(new_n32_), .b(new_n35_), .O(new_n65_));
  nor2   g36(.a(new_n49_), .b(x10), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(x00), .O(z08));
  and2   g38(.a(x03), .b(x02), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n54_), .c(x09), .d(x04), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(new_n32_), .c(x12), .d(x11), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n61_), .O(new_n71_));
  nand3  g42(.a(new_n71_), .b(new_n60_), .c(x00), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(z09));
  nand4  g44(.a(new_n54_), .b(new_n32_), .c(x12), .d(x11), .O(new_n74_));
  ...
  nor2   g52(.a(x13), .b(new_n35_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(new_n60_), .c(new_n42_), .d(x00), .O(new_n83_));
  aoi21  g54(.a(new_n83_), .b(new_n32_), .c(new_n30_), .O(z12));
endmodule
