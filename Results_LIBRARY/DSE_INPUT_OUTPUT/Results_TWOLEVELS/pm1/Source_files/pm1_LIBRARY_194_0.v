...
module FAU ( 
  ...
  nand2  g05(.a(new_n34_), .b(x13), .O(new_n35_));
  ...
  nand2  g23(.a(x14), .b(x11), .O(new_n53_));
  oai21  g24(.a(x14), .b(z05), .c(new_n53_), .O(new_n54_));
  ...
  nor2   g33(.a(new_n37_), .b(new_n36_), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x13), .c(x14), .O(z04));
  inv1   g35(.a(x11), .O(new_n65_));
  nand2  g36(.a(x12), .b(new_n65_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(x04), .c(x03), .d(x02), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n43_), .c(x09), .d(x01), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z06));
  aoi21  g40(.a(new_n42_), .b(z05), .c(x15), .O(z07));
  inv1   g41(.a(x00), .O(new_n71_));
  oai21  g42(.a(z05), .b(new_n65_), .c(new_n42_), .O(new_n72_));
  ...
  nand2  g49(.a(new_n32_), .b(new_n65_), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n57_), .O(new_n80_));
  nand4  g51(.a(new_n80_), .b(new_n43_), .c(new_n30_), .d(x00), .O(new_n81_));
  inv1   g52(.a(new_n81_), .O(z09));
  nand3  g53(.a(x04), .b(x03), .c(x02), .O(new_n83_));
  nand4  g54(.a(new_n83_), .b(x12), .c(x11), .d(new_n30_), .O(new_n84_));
  inv1   g55(.a(new_n84_), .O(new_n85_));
  nand3  g56(.a(new_n85_), .b(x09), .c(x00), .O(new_n86_));
  nand2  g57(.a(new_n86_), .b(new_n43_), .O(z10));
  nand4  g58(.a(new_n83_), .b(x12), .c(x09), .d(x01), .O(new_n88_));
  oai21  g59(.a(x12), .b(x01), .c(new_n88_), .O(new_n89_));
  nand4  g60(.a(new_n89_), .b(new_n43_), .c(x11), .d(new_n30_), .O(new_n90_));
  nor2   g61(.a(new_n90_), .b(new_n71_), .O(z11));
  nand2  g62(.a(new_n56_), .b(x00), .O(new_n92_));
  nand3  g63(.a(x12), .b(x11), .c(new_n30_), .O(new_n93_));
  oai21  g64(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z12));
endmodule
