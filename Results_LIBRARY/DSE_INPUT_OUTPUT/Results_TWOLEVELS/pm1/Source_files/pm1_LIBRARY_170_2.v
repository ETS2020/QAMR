...
module FAU ( 
  ...
  oai22  g31(.a(new_n60_), .b(new_n59_), .c(x12), .d(x11), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n58_), .c(new_n31_), .O(new_n62_));
  oai21  g33(.a(new_n33_), .b(x10), .c(x12), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n62_), .O(z08));
  oai21  g35(.a(x11), .b(new_n58_), .c(new_n31_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  nand4  g37(.a(new_n59_), .b(new_n52_), .c(x09), .d(x04), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x12), .c(x11), .d(new_n31_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n58_), .c(new_n66_), .O(z09));
  nand4  g40(.a(new_n59_), .b(x12), .c(x11), .d(new_n31_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n40_), .c(new_n58_), .O(z10));
  nand4  g42(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  inv1   g43(.a(x01), .O(new_n73_));
  nand2  g44(.a(new_n30_), .b(new_n73_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n31_), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand2  g48(.a(new_n40_), .b(x00), .O(new_n78_));
  nand3  g49(.a(x12), .b(x11), .c(new_n31_), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(new_n78_), .c(new_n51_), .O(z12));
endmodule
