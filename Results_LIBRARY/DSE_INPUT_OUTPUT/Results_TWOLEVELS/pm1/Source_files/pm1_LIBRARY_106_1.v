...
module FAU ( 
  ...
  oai21  g29(.a(x10), .b(new_n58_), .c(new_n33_), .O(new_n59_));
  ...
  nand2  g34(.a(x11), .b(new_n63_), .O(new_n64_));
  ...
  nand4  g38(.a(new_n49_), .b(new_n53_), .c(x09), .d(x00), .O(new_n68_));
  ...
  nand4  g44(.a(x11), .b(new_n53_), .c(new_n63_), .d(x00), .O(new_n74_));
