...
module FAU ( 
  ...
  nand3  g34(.a(new_n30_), .b(x03), .c(x02), .O(new_n64_));
  ...
  aoi21  g44(.a(new_n73_), .b(x04), .c(new_n37_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x11), .c(new_n54_), .d(x09), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n71_), .O(z10));
  nand3  g47(.a(new_n42_), .b(new_n37_), .c(new_n47_), .O(new_n77_));
  nand3  g48(.a(new_n74_), .b(x09), .c(x01), .O(new_n78_));
