...
module FAU ( 
  ...
  oai21  g15(.a(x10), .b(new_n38_), .c(new_n32_), .O(new_n45_));
  nand3  g16(.a(new_n45_), .b(new_n44_), .c(new_n31_), .O(z03));
  nor2   g17(.a(new_n32_), .b(new_n31_), .O(z12));
  ...
  nand3  g29(.a(new_n34_), .b(new_n30_), .c(x00), .O(new_n60_));
