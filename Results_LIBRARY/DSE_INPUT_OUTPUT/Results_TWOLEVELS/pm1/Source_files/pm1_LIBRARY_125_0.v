...
module FAU ( 
  ...
  oai21  g04(.a(x12), .b(x07), .c(x11), .O(new_n34_));
  inv1   g05(.a(x10), .O(new_n35_));
  nand3  g06(.a(x11), .b(new_n35_), .c(x00), .O(new_n36_));
  nand3  g07(.a(new_n36_), .b(new_n32_), .c(x07), .O(new_n37_));
  ...
  nand3  g11(.a(new_n40_), .b(new_n32_), .c(x07), .O(new_n41_));
  nand3  g12(.a(x08), .b(x06), .c(x05), .O(new_n42_));
  nand3  g13(.a(x11), .b(x09), .c(x07), .O(new_n43_));
  ...
  nand2  g19(.a(x11), .b(x09), .O(new_n49_));
  nor2   g20(.a(x12), .b(x07), .O(new_n50_));
  aoi21  g21(.a(new_n49_), .b(x12), .c(new_n50_), .O(new_n51_));
  oai21  g22(.a(new_n48_), .b(new_n46_), .c(new_n51_), .O(z03));
  nor2   g23(.a(new_n50_), .b(x14), .O(z04));
  ...
  nand3  g35(.a(new_n32_), .b(new_n31_), .c(x07), .O(new_n65_));
  ...
  oai22  g39(.a(x12), .b(x07), .c(x10), .d(new_n68_), .O(new_n69_));
  ...
  nand4  g47(.a(new_n62_), .b(x12), .c(x11), .d(new_n35_), .O(new_n77_));
  nor3   g48(.a(new_n77_), .b(new_n76_), .c(new_n68_), .O(z10));
  nand2  g49(.a(new_n30_), .b(x00), .O(new_n79_));
  nand2  g50(.a(x11), .b(new_n35_), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(x07), .O(new_n81_));
  ...
  nand2  g56(.a(new_n76_), .b(x00), .O(new_n86_));
  nand2  g57(.a(new_n63_), .b(new_n35_), .O(new_n87_));
  oai21  g58(.a(new_n87_), .b(new_n86_), .c(new_n55_), .O(z12));
endmodule
