...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(new_n36_), .O(new_n37_));
  nand4  g08(.a(new_n37_), .b(new_n35_), .c(new_n33_), .d(new_n30_), .O(z00));
  inv1   g09(.a(x12), .O(new_n39_));
  aoi21  g10(.a(x15), .b(new_n36_), .c(new_n39_), .O(new_n40_));
  ...
  nand4  g27(.a(new_n37_), .b(new_n39_), .c(new_n56_), .d(x00), .O(new_n57_));
  ...
  nand2  g46(.a(new_n39_), .b(new_n30_), .O(new_n76_));
  nand2  g47(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g48(.a(new_n77_), .b(new_n37_), .c(x11), .d(new_n56_), .O(new_n78_));
  nor2   g49(.a(new_n78_), .b(new_n74_), .O(z11));
  nand4  g50(.a(new_n40_), .b(x11), .c(new_n56_), .d(new_n45_), .O(new_n80_));
