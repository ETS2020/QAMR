...
module FAU ( 
  ...
  nand2  g03(.a(x15), .b(x13), .O(new_n33_));
  ...
  nor2   g07(.a(new_n36_), .b(new_n32_), .O(new_n37_));
  ...
  nand2  g20(.a(new_n49_), .b(new_n33_), .O(z06));
  ...
  nand2  g39(.a(new_n68_), .b(new_n33_), .O(z09));
  nand4  g40(.a(new_n61_), .b(new_n33_), .c(x12), .d(x11), .O(new_n70_));
  ...
  nand4  g46(.a(new_n75_), .b(new_n33_), .c(x11), .d(new_n55_), .O(new_n76_));
  nor2   g47(.a(new_n76_), .b(new_n52_), .O(z11));
  inv1   g48(.a(x09), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(x00), .O(new_n79_));
  nand3  g50(.a(x12), .b(x11), .c(new_n55_), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(new_n33_), .O(z12));
endmodule
