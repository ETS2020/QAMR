...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(z05), .O(new_n36_));
  ...
  nand2  g12(.a(new_n36_), .b(new_n41_), .O(new_n42_));
  nand2  g13(.a(x08), .b(x07), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(new_n32_), .c(x11), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n42_), .c(new_n39_), .d(x09), .O(z02));
  inv1   g16(.a(new_n32_), .O(new_n46_));
  nand4  g17(.a(new_n46_), .b(x11), .c(x08), .d(x07), .O(new_n47_));
  nand4  g18(.a(new_n47_), .b(new_n42_), .c(new_n39_), .d(x09), .O(z03));
  nor2   g19(.a(new_n38_), .b(x14), .O(z04));
  ...
  nand2  g23(.a(new_n52_), .b(new_n36_), .O(z06));
  nand2  g24(.a(x15), .b(x13), .O(z07));
  ...
  nand4  g49(.a(new_n78_), .b(new_n36_), .c(x11), .d(new_n58_), .O(new_n79_));
  ...
  oai21  g54(.a(new_n83_), .b(new_n82_), .c(new_n36_), .O(z12));
endmodule
