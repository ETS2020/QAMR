...
module FAU ( 
  ...
  nand4  g25(.a(new_n46_), .b(new_n39_), .c(new_n32_), .d(x02), .O(new_n47_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x03), .O(new_n53_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(new_n55_), .d(x03), .O(z4));
endmodule
