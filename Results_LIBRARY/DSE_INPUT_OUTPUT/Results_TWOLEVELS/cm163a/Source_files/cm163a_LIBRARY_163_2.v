...
module FAU ( 
  ...
  nand3  g20(.a(new_n41_), .b(new_n27_), .c(new_n26_), .O(new_n42_));
  ...
  inv1   g25(.a(new_n28_), .O(new_n47_));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n23_), .c(new_n24_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n23_), .c(new_n53_), .O(z3));
  inv1   g33(.a(x03), .O(new_n55_));
  inv1   g34(.a(x15), .O(new_n56_));
  aoi21  g35(.a(new_n24_), .b(x00), .c(new_n56_), .O(new_n57_));
