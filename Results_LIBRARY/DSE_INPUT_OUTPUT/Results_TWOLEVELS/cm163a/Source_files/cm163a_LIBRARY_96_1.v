...
module FAU ( 
  ...
  aoi21  g15(.a(new_n29_), .b(x02), .c(new_n30_), .O(new_n37_));
  oai22  g16(.a(x09), .b(x05), .c(x04), .d(x01), .O(new_n38_));
  aoi21  g17(.a(new_n37_), .b(x04), .c(new_n38_), .O(new_n39_));
  nand3  g18(.a(new_n39_), .b(new_n36_), .c(new_n33_), .O(z1));
  ...
  nand4  g23(.a(new_n44_), .b(new_n30_), .c(new_n29_), .d(x02), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(new_n22_), .O(new_n46_));
  nand3  g25(.a(new_n30_), .b(x03), .c(x02), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(x12), .c(new_n29_), .O(new_n48_));
  ...
  nand4  g34(.a(new_n55_), .b(new_n30_), .c(new_n29_), .d(x02), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n54_), .c(new_n22_), .O(new_n57_));
  nand4  g36(.a(new_n44_), .b(new_n30_), .c(x03), .d(x02), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(x13), .c(new_n29_), .O(new_n59_));
