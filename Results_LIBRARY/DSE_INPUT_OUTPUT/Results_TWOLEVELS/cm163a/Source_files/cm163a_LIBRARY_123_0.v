...
module FAU ( 
  ...
  nand3  g10(.a(new_n31_), .b(new_n28_), .c(x05), .O(z0));
  ...
  nand2  g23(.a(new_n42_), .b(new_n44_), .O(new_n45_));
  nor3   g24(.a(new_n45_), .b(new_n22_), .c(x09), .O(new_n46_));
  ...
  oai21  g32(.a(new_n45_), .b(new_n22_), .c(x13), .O(new_n54_));
  nor3   g33(.a(x13), .b(x12), .c(x11), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n25_), .c(x02), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n54_), .c(new_n30_), .O(new_n57_));
  ...
  oai22  g41(.a(new_n62_), .b(new_n61_), .c(x09), .d(x05), .O(z4));
endmodule
