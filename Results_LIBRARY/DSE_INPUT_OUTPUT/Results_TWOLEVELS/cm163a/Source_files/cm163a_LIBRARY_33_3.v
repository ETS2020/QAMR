...
module FAU ( 
  ...
  nand3  g28(.a(new_n46_), .b(new_n36_), .c(new_n25_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n23_), .c(new_n49_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x04), .O(new_n52_));
  inv1   g31(.a(x06), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n30_), .O(new_n54_));
  nand4  g33(.a(new_n54_), .b(new_n52_), .c(new_n48_), .d(new_n45_), .O(z2));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n22_), .O(new_n57_));
  nand4  g36(.a(new_n46_), .b(new_n36_), .c(x03), .d(x02), .O(new_n58_));
  ...
  nand3  g41(.a(new_n39_), .b(x13), .c(x09), .O(new_n63_));
  ...
  nand4  g46(.a(x10), .b(new_n25_), .c(x08), .d(x03), .O(new_n68_));
  nor3   g47(.a(new_n68_), .b(new_n39_), .c(new_n67_), .O(z4));
endmodule
