...
module FAU ( 
  ...
  nand2  g15(.a(new_n36_), .b(x03), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n23_), .O(new_n38_));
  aoi21  g17(.a(new_n23_), .b(x02), .c(new_n35_), .O(new_n39_));
  ...
  oai21  g23(.a(x11), .b(new_n27_), .c(x12), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n35_), .c(new_n23_), .d(x02), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n45_), .c(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n46_), .b(new_n23_), .O(new_n49_));
  ...
  nand3  g32(.a(new_n46_), .b(new_n35_), .c(x02), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x13), .O(new_n55_));
  nor2   g34(.a(x13), .b(x12), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(new_n35_), .c(new_n23_), .d(x02), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n55_), .c(new_n22_), .O(new_n58_));
  and2   g37(.a(x13), .b(x09), .O(new_n59_));
