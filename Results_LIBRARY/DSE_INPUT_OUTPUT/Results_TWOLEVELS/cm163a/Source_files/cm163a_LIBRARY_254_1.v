...
module FAU ( 
  ...
  nand3  g16(.a(new_n28_), .b(x11), .c(x07), .O(new_n38_));
  inv1   g17(.a(x11), .O(new_n39_));
  nand3  g18(.a(new_n27_), .b(new_n39_), .c(new_n25_), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n38_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(x04), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n37_), .O(z1));
  nand2  g22(.a(new_n23_), .b(new_n33_), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n32_), .c(x07), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x11), .O(new_n47_));
  nand2  g26(.a(new_n28_), .b(x12), .O(new_n48_));
  nand3  g27(.a(new_n45_), .b(new_n39_), .c(new_n25_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n26_), .c(new_n48_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x04), .O(new_n51_));
  inv1   g30(.a(x06), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n32_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n51_), .c(new_n47_), .d(new_n44_), .O(z2));
  nand4  g33(.a(new_n45_), .b(new_n25_), .c(x03), .d(x02), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x13), .O(new_n56_));
  nor2   g35(.a(x13), .b(x12), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n27_), .c(new_n25_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n56_), .c(x11), .O(new_n59_));
  nand3  g38(.a(x13), .b(x11), .c(x07), .O(new_n60_));
  inv1   g39(.a(new_n60_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  nand3  g41(.a(new_n39_), .b(new_n22_), .c(new_n32_), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n62_), .c(new_n44_), .O(z3));
