...
module FAU ( 
  ...
  nand4  g14(.a(new_n35_), .b(new_n27_), .c(x03), .d(x02), .O(new_n36_));
  ...
  nand4  g22(.a(new_n43_), .b(new_n27_), .c(x03), .d(x02), .O(new_n44_));
  ...
  nand3  g29(.a(new_n50_), .b(new_n35_), .c(new_n27_), .O(new_n51_));
