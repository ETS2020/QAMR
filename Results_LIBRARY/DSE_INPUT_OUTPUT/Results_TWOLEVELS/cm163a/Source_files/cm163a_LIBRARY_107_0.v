...
module FAU ( 
  ...
  oai21  g15(.a(new_n36_), .b(new_n27_), .c(x08), .O(new_n37_));
  ...
  oai21  g27(.a(new_n48_), .b(new_n27_), .c(x08), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  aoi21  g29(.a(x11), .b(x08), .c(x09), .O(new_n51_));
  ...
  nand2  g36(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  nand2  g37(.a(new_n47_), .b(new_n35_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n27_), .c(x13), .O(new_n60_));
  nor3   g39(.a(x13), .b(x12), .c(x11), .O(new_n61_));
  nand3  g40(.a(new_n61_), .b(new_n40_), .c(x02), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n60_), .c(new_n22_), .O(new_n63_));
