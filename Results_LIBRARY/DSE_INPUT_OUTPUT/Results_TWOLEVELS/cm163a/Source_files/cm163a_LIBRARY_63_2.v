...
module FAU ( 
  ...
  nand3  g09(.a(new_n30_), .b(x02), .c(new_n28_), .O(new_n31_));
  oai21  g10(.a(new_n27_), .b(new_n22_), .c(new_n31_), .O(new_n32_));
  nand2  g11(.a(new_n32_), .b(x04), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(new_n25_), .O(z0));
  ...
  nand3  g17(.a(new_n27_), .b(new_n38_), .c(new_n22_), .O(new_n39_));
  ...
  nand3  g21(.a(new_n42_), .b(new_n41_), .c(new_n36_), .O(z1));
  ...
  nand3  g29(.a(new_n50_), .b(new_n38_), .c(x04), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n26_), .c(new_n28_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nor2   g32(.a(new_n27_), .b(new_n50_), .O(new_n54_));
  ...
  nand2  g38(.a(new_n50_), .b(new_n38_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n26_), .c(x13), .O(new_n61_));
  nor3   g40(.a(x13), .b(x12), .c(x11), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n30_), .c(x02), .O(new_n63_));
  aoi21  g42(.a(new_n63_), .b(new_n61_), .c(x01), .O(new_n64_));
  and2   g43(.a(x13), .b(x09), .O(new_n65_));
