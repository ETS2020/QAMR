...
module FAU ( 
  ...
  nand3  g09(.a(new_n24_), .b(x03), .c(x02), .O(new_n31_));
  ...
  nand2  g15(.a(new_n29_), .b(x11), .O(new_n37_));
  inv1   g16(.a(x11), .O(new_n38_));
  nand4  g17(.a(new_n38_), .b(new_n24_), .c(x03), .d(x02), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n22_), .O(new_n40_));
  ...
  nand2  g23(.a(new_n44_), .b(new_n27_), .O(new_n45_));
  ...
  nand2  g32(.a(new_n53_), .b(new_n45_), .O(z2));
  nand3  g33(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  inv1   g34(.a(x13), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n51_), .c(new_n38_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n55_), .c(x00), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n24_), .O(new_n59_));
  nand3  g38(.a(new_n49_), .b(x13), .c(x04), .O(new_n60_));
  inv1   g39(.a(x07), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n23_), .O(new_n62_));
  nand4  g41(.a(new_n62_), .b(new_n60_), .c(new_n59_), .d(new_n28_), .O(z3));
  nand2  g42(.a(x08), .b(x03), .O(new_n64_));
  nand3  g43(.a(x15), .b(x14), .c(x10), .O(new_n65_));
  oai21  g44(.a(new_n65_), .b(new_n64_), .c(new_n27_), .O(z4));
endmodule
