...
module FAU ( 
  ...
  nor2   g13(.a(new_n34_), .b(new_n23_), .O(new_n35_));
  and2   g14(.a(x03), .b(x02), .O(new_n36_));
  nor2   g15(.a(x11), .b(x09), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand4  g17(.a(new_n38_), .b(new_n35_), .c(new_n32_), .d(x05), .O(z1));
  nor3   g18(.a(x12), .b(x11), .c(x09), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n36_), .c(new_n38_), .d(x12), .O(new_n41_));
  ...
  nand4  g25(.a(new_n46_), .b(new_n26_), .c(x03), .d(x02), .O(new_n47_));
  ...
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(new_n33_), .O(z4));
endmodule
