...
module FAU ( 
  ...
  nand2  g28(.a(new_n49_), .b(new_n25_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n24_), .O(new_n52_));
  nand4  g31(.a(new_n52_), .b(new_n47_), .c(new_n45_), .d(new_n41_), .O(z2));
  nor2   g32(.a(x07), .b(x04), .O(new_n54_));
  inv1   g33(.a(x13), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n30_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n54_), .c(x09), .O(new_n57_));
  aoi21  g36(.a(new_n49_), .b(new_n25_), .c(new_n55_), .O(new_n58_));
  nand3  g37(.a(new_n55_), .b(new_n43_), .c(new_n33_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n26_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n58_), .c(x04), .O(new_n61_));
  nand3  g40(.a(new_n61_), .b(new_n57_), .c(new_n23_), .O(z3));
  inv1   g41(.a(x03), .O(new_n63_));
  inv1   g42(.a(x15), .O(new_n64_));
  aoi21  g43(.a(new_n24_), .b(new_n30_), .c(new_n64_), .O(new_n65_));
