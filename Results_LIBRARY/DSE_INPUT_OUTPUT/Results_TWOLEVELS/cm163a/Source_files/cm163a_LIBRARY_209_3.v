...
module FAU ( 
  ...
  aoi21  g24(.a(new_n39_), .b(new_n24_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand3  g26(.a(new_n45_), .b(new_n47_), .c(new_n33_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n25_), .c(x04), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n46_), .c(new_n22_), .O(new_n50_));
