...
module FAU ( 
  ...
  nand4  g11(.a(new_n32_), .b(new_n29_), .c(x05), .d(x01), .O(z0));
  ...
  nand3  g19(.a(new_n40_), .b(new_n35_), .c(new_n22_), .O(new_n41_));
  ...
  oai21  g26(.a(new_n41_), .b(new_n23_), .c(x13), .O(new_n48_));
  ...
  aoi21  g34(.a(x05), .b(new_n44_), .c(new_n55_), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(x14), .c(x10), .d(x08), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n25_), .O(z4));
endmodule
