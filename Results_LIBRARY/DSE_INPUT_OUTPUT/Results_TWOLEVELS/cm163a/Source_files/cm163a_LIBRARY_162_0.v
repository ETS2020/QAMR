...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x13), .O(new_n23_));
  ...
  aoi21  g35(.a(new_n56_), .b(new_n28_), .c(new_n55_), .O(new_n57_));
  nand4  g36(.a(x15), .b(new_n55_), .c(new_n44_), .d(new_n46_), .O(new_n58_));
