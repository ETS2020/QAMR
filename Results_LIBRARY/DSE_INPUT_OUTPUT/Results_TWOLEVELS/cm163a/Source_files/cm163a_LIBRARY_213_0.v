...
module FAU ( 
  ...
  nand4  g12(.a(new_n33_), .b(new_n30_), .c(new_n24_), .d(x05), .O(z0));
  ...
  aoi21  g17(.a(new_n38_), .b(new_n36_), .c(new_n32_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n35_), .c(new_n24_), .O(new_n40_));
  nand3  g19(.a(x15), .b(new_n32_), .c(new_n22_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n40_), .O(z1));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n32_), .c(new_n35_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(z2));
  ...
  aoi21  g38(.a(new_n59_), .b(new_n32_), .c(new_n35_), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand3  g41(.a(x15), .b(x14), .c(x10), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n62_), .c(new_n24_), .O(z4));
endmodule
