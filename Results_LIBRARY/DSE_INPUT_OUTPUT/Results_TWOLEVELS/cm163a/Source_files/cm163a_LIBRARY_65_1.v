...
module FAU ( 
  ...
  inv1   g27(.a(x14), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n47_), .O(z2));
  nand3  g30(.a(new_n43_), .b(new_n35_), .c(new_n22_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n23_), .c(x13), .O(new_n53_));
  ...
  nand4  g38(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(x05), .c(new_n49_), .O(z4));
endmodule
