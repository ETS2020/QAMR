...
module FAU ( 
  ...
  aoi21  g18(.a(x11), .b(x05), .c(x09), .O(new_n40_));
  ...
  aoi21  g23(.a(new_n44_), .b(new_n23_), .c(new_n24_), .O(new_n45_));
  oai21  g24(.a(new_n43_), .b(new_n23_), .c(new_n45_), .O(z2));
  inv1   g25(.a(new_n28_), .O(new_n47_));
  oai21  g26(.a(x12), .b(x11), .c(x05), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n26_), .c(x03), .d(x02), .O(new_n49_));
