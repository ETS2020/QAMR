...
module FAU ( 
  ...
  nand4  g13(.a(new_n34_), .b(new_n23_), .c(x03), .d(x02), .O(new_n35_));
  ...
  nand4  g20(.a(new_n25_), .b(new_n41_), .c(new_n34_), .d(new_n23_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n40_), .c(new_n30_), .O(new_n43_));
  nor2   g22(.a(x06), .b(x04), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(new_n22_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x05), .O(z2));
  nand3  g25(.a(new_n41_), .b(new_n34_), .c(new_n23_), .O(new_n47_));
  ...
  aoi21  g37(.a(new_n58_), .b(new_n57_), .c(new_n22_), .O(z4));
endmodule
