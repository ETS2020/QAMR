...
module FAU ( 
  ...
  nand4  g13(.a(new_n34_), .b(new_n27_), .c(x03), .d(x02), .O(new_n35_));
  ...
  aoi21  g29(.a(new_n43_), .b(new_n42_), .c(new_n50_), .O(new_n51_));
  inv1   g30(.a(x12), .O(new_n52_));
  nand3  g31(.a(new_n50_), .b(new_n52_), .c(new_n34_), .O(new_n53_));
  ...
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x05), .d(new_n22_), .O(z4));
endmodule
