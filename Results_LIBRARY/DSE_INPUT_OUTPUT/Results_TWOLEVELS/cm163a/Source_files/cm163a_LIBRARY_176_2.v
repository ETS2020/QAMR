...
module FAU ( 
  ...
  nor3   g30(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n52_));
  oai21  g31(.a(new_n48_), .b(new_n28_), .c(new_n52_), .O(z3));
  nand2  g32(.a(x08), .b(x03), .O(new_n54_));
  nand3  g33(.a(x15), .b(x14), .c(x10), .O(new_n55_));
  oai22  g34(.a(new_n55_), .b(new_n54_), .c(x08), .d(new_n49_), .O(z4));
endmodule
