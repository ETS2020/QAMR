...
module FAU ( 
  ...
  nand4  g14(.a(new_n35_), .b(new_n24_), .c(x04), .d(x03), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x05), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(x02), .O(new_n38_));
  oai21  g17(.a(new_n35_), .b(new_n23_), .c(x05), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n22_), .O(new_n40_));
  nor2   g19(.a(new_n29_), .b(new_n35_), .O(new_n41_));
  ...
  nand3  g26(.a(new_n35_), .b(new_n24_), .c(x03), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x12), .O(new_n49_));
  nor2   g28(.a(x12), .b(x11), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n24_), .c(x03), .d(x02), .O(new_n51_));
  ...
  nand2  g37(.a(new_n24_), .b(x03), .O(new_n59_));
  nand2  g38(.a(new_n45_), .b(new_n35_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n59_), .c(x13), .O(new_n61_));
