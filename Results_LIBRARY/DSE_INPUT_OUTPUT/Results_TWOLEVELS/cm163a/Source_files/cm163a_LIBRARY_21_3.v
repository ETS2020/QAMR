...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x09), .O(new_n22_));
  ...
  nand3  g18(.a(x11), .b(new_n39_), .c(x09), .O(new_n40_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n29_), .c(new_n39_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x09), .O(new_n48_));
  nand2  g27(.a(new_n37_), .b(x12), .O(new_n49_));
  nor2   g28(.a(x12), .b(x11), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n24_), .c(new_n23_), .O(new_n51_));
  ...
  oai21  g36(.a(new_n57_), .b(new_n29_), .c(new_n39_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(x09), .O(new_n59_));
  aoi21  g38(.a(new_n50_), .b(new_n24_), .c(new_n57_), .O(new_n60_));
  nand3  g39(.a(new_n57_), .b(new_n46_), .c(new_n36_), .O(new_n61_));
  nor2   g40(.a(new_n61_), .b(new_n25_), .O(new_n62_));
  oai21  g41(.a(new_n62_), .b(new_n60_), .c(x04), .O(new_n63_));
  inv1   g42(.a(x07), .O(new_n64_));
  nand2  g43(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  nand4  g44(.a(new_n65_), .b(new_n63_), .c(new_n59_), .d(new_n45_), .O(z3));
  nand4  g45(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n67_));
  aoi21  g46(.a(new_n67_), .b(new_n23_), .c(new_n39_), .O(z4));
endmodule
