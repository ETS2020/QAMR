...
module FAU ( 
  ...
  nand4  g25(.a(new_n24_), .b(new_n42_), .c(new_n35_), .d(new_n22_), .O(new_n47_));
  ...
  nand2  g33(.a(new_n42_), .b(new_n35_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n23_), .c(x13), .O(new_n56_));
  nor3   g35(.a(x13), .b(x12), .c(x11), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n26_), .c(x02), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n56_), .c(new_n31_), .O(new_n59_));
  ...
  oai22  g43(.a(new_n64_), .b(new_n63_), .c(x09), .d(x05), .O(z4));
endmodule
