...
module FAU ( 
  ...
  oai21  g23(.a(x11), .b(x09), .c(x04), .O(new_n45_));
  oai21  g24(.a(new_n25_), .b(x09), .c(new_n45_), .O(new_n46_));
  ...
  nor2   g31(.a(new_n52_), .b(new_n30_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n51_), .c(x09), .O(new_n54_));
  aoi21  g33(.a(new_n48_), .b(new_n25_), .c(new_n52_), .O(new_n55_));
  inv1   g34(.a(x12), .O(new_n56_));
  nand3  g35(.a(new_n52_), .b(new_n56_), .c(new_n33_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n26_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n55_), .c(x04), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n54_), .c(new_n23_), .O(z3));
  inv1   g39(.a(x03), .O(new_n61_));
  inv1   g40(.a(x15), .O(new_n62_));
  aoi21  g41(.a(new_n24_), .b(new_n30_), .c(new_n62_), .O(new_n63_));
