...
module FAU ( 
  ...
  nand2  g16(.a(new_n23_), .b(new_n37_), .O(new_n38_));
  nand3  g17(.a(new_n38_), .b(new_n36_), .c(x05), .O(z1));
  ...
  aoi21  g24(.a(new_n34_), .b(x04), .c(new_n40_), .O(new_n46_));
  oai22  g25(.a(new_n46_), .b(new_n22_), .c(new_n45_), .d(new_n40_), .O(z2));
  nand2  g26(.a(x11), .b(x05), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n22_), .c(new_n26_), .O(new_n49_));
  ...
  nand2  g34(.a(new_n55_), .b(x04), .O(new_n56_));
