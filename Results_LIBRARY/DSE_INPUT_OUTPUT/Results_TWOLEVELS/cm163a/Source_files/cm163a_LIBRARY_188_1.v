...
module FAU ( 
  ...
  aoi21  g20(.a(x15), .b(new_n22_), .c(x12), .O(new_n42_));
  nand4  g21(.a(new_n42_), .b(new_n34_), .c(new_n24_), .d(x03), .O(new_n43_));
  nand3  g22(.a(new_n35_), .b(new_n23_), .c(x12), .O(new_n44_));
  oai21  g23(.a(new_n43_), .b(new_n41_), .c(new_n44_), .O(new_n45_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n54_), .c(new_n34_), .d(new_n24_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n22_), .O(new_n57_));
  nand4  g36(.a(new_n25_), .b(new_n54_), .c(new_n34_), .d(new_n24_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(x13), .c(x04), .O(new_n59_));
  inv1   g38(.a(x07), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n30_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(new_n59_), .c(new_n57_), .d(new_n51_), .O(z3));
  nand4  g41(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n63_));
  aoi21  g42(.a(new_n63_), .b(x13), .c(new_n52_), .O(z4));
endmodule
