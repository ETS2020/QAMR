...
module FAU ( 
  ...
  nand3  g21(.a(new_n42_), .b(new_n22_), .c(x03), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x12), .O(new_n44_));
  nor2   g23(.a(x12), .b(x11), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n24_), .c(new_n22_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(new_n29_), .O(new_n47_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n39_), .c(new_n42_), .O(new_n52_));
  oai22  g31(.a(new_n52_), .b(new_n23_), .c(new_n51_), .d(new_n39_), .O(new_n53_));
  aoi21  g32(.a(new_n33_), .b(new_n24_), .c(new_n51_), .O(new_n54_));
  aoi21  g33(.a(new_n53_), .b(new_n22_), .c(new_n54_), .O(new_n55_));
  inv1   g34(.a(x07), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n29_), .c(new_n30_), .O(new_n57_));
  oai21  g36(.a(new_n55_), .b(new_n29_), .c(new_n57_), .O(z3));
  inv1   g37(.a(x03), .O(new_n59_));
  inv1   g38(.a(x15), .O(new_n60_));
  aoi21  g39(.a(new_n30_), .b(x02), .c(new_n60_), .O(new_n61_));
