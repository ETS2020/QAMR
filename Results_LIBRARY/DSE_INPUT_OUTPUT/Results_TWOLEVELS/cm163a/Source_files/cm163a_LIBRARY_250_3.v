...
module FAU ( 
  ...
  nand3  g08(.a(new_n29_), .b(new_n27_), .c(new_n25_), .O(new_n30_));
  nand2  g09(.a(new_n30_), .b(x04), .O(new_n31_));
  inv1   g10(.a(x05), .O(new_n32_));
  nand2  g11(.a(new_n25_), .b(new_n32_), .O(new_n33_));
  ...
  nand2  g19(.a(new_n40_), .b(new_n25_), .O(new_n41_));
  nand2  g20(.a(new_n29_), .b(x11), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n25_), .O(new_n43_));
  ...
  aoi21  g30(.a(new_n38_), .b(new_n37_), .c(new_n51_), .O(new_n52_));
  inv1   g31(.a(x11), .O(new_n53_));
  nand3  g32(.a(new_n51_), .b(new_n53_), .c(new_n28_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n26_), .c(new_n25_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n52_), .c(x04), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n50_), .c(new_n33_), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(new_n25_), .d(new_n22_), .O(z4));
endmodule
