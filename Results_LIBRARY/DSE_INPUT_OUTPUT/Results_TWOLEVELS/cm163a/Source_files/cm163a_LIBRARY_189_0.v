...
module FAU ( 
  ...
  nand4  g22(.a(new_n24_), .b(new_n43_), .c(new_n35_), .d(new_n22_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n42_), .c(new_n31_), .O(new_n45_));
  nor2   g24(.a(x06), .b(x04), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n45_), .c(x05), .O(new_n47_));
  inv1   g26(.a(x05), .O(new_n48_));
  nand2  g27(.a(x07), .b(new_n48_), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n47_), .O(z2));
  nand3  g29(.a(new_n43_), .b(new_n35_), .c(new_n22_), .O(new_n51_));
  ...
  oai22  g39(.a(new_n60_), .b(new_n59_), .c(x07), .d(x05), .O(z4));
endmodule
