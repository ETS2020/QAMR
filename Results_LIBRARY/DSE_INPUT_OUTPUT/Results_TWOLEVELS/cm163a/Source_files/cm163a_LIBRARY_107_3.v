...
module FAU ( 
  ...
  nand4  g39(.a(new_n26_), .b(new_n60_), .c(new_n46_), .d(new_n37_), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n59_), .c(x09), .O(new_n62_));
  nor3   g41(.a(new_n60_), .b(new_n29_), .c(x08), .O(new_n63_));
  ...
  nand4  g46(.a(x10), .b(new_n29_), .c(x08), .d(x03), .O(new_n68_));
