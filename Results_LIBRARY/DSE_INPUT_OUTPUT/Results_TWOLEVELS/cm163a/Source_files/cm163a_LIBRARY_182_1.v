...
module FAU ( 
  ...
  nand2  g10(.a(new_n30_), .b(x12), .O(new_n32_));
  nor2   g11(.a(x12), .b(x11), .O(new_n33_));
  nand4  g12(.a(new_n33_), .b(new_n22_), .c(x03), .d(x02), .O(new_n34_));
  nand4  g13(.a(new_n34_), .b(new_n32_), .c(x05), .d(x04), .O(z2));
  inv1   g14(.a(x04), .O(new_n36_));
  inv1   g15(.a(new_n24_), .O(new_n37_));
  nor3   g16(.a(x13), .b(x12), .c(x11), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n37_), .c(new_n34_), .d(x13), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n36_), .c(x05), .O(z3));
  inv1   g19(.a(x03), .O(new_n41_));
  inv1   g20(.a(x15), .O(new_n42_));
  aoi21  g21(.a(x05), .b(new_n36_), .c(new_n42_), .O(new_n43_));
