...
module FAU ( 
  ...
  aoi21  g16(.a(new_n32_), .b(new_n23_), .c(new_n37_), .O(new_n38_));
  ...
  nand3  g22(.a(new_n43_), .b(x05), .c(new_n28_), .O(new_n44_));
  ...
  aoi21  g32(.a(new_n29_), .b(new_n28_), .c(new_n53_), .O(new_n54_));
