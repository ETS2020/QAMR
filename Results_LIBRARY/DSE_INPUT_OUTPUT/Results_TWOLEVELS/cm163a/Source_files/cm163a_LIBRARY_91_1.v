...
module FAU ( 
  ...
  nand2  g11(.a(x03), .b(x02), .O(new_n33_));
  inv1   g12(.a(x11), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x04), .O(new_n35_));
  oai22  g14(.a(new_n35_), .b(new_n33_), .c(x04), .d(x01), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n23_), .O(new_n37_));
  nand3  g16(.a(new_n26_), .b(x11), .c(x04), .O(new_n38_));
  nand3  g17(.a(new_n38_), .b(new_n37_), .c(new_n24_), .O(z1));
  inv1   g18(.a(x06), .O(new_n40_));
  oai21  g19(.a(x09), .b(new_n40_), .c(new_n30_), .O(new_n41_));
  nand3  g20(.a(new_n34_), .b(x03), .c(x02), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x12), .O(new_n43_));
  nor2   g22(.a(x12), .b(x11), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(new_n25_), .c(new_n23_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x04), .O(new_n47_));
  nand2  g26(.a(x12), .b(x09), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n47_), .c(new_n41_), .d(new_n24_), .O(z2));
  inv1   g28(.a(x07), .O(new_n50_));
  oai21  g29(.a(x09), .b(new_n50_), .c(new_n30_), .O(new_n51_));
  inv1   g30(.a(x13), .O(new_n52_));
  aoi21  g31(.a(new_n44_), .b(new_n25_), .c(new_n52_), .O(new_n53_));
  inv1   g32(.a(x12), .O(new_n54_));
  nand3  g33(.a(new_n52_), .b(new_n54_), .c(new_n34_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n26_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n53_), .c(x04), .O(new_n57_));
  nand2  g36(.a(x13), .b(x09), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(new_n57_), .c(new_n51_), .d(new_n24_), .O(z3));
