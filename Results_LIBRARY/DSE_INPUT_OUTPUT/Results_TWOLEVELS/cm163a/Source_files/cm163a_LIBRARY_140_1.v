...
module FAU ( 
  ...
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(new_n30_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n31_), .c(new_n34_), .O(new_n47_));
  nand2  g26(.a(x06), .b(x04), .O(new_n48_));
  oai21  g27(.a(x08), .b(x06), .c(new_n48_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n26_), .c(x12), .O(new_n50_));
  inv1   g29(.a(new_n50_), .O(new_n51_));
  nor3   g30(.a(x08), .b(x06), .c(x04), .O(new_n52_));
  ...
  nand3  g37(.a(new_n55_), .b(new_n58_), .c(new_n36_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n26_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n57_), .c(x04), .O(new_n61_));
  inv1   g40(.a(x07), .O(new_n62_));
  nand2  g41(.a(new_n62_), .b(new_n30_), .O(new_n63_));
  nand4  g42(.a(new_n63_), .b(new_n61_), .c(new_n34_), .d(x05), .O(z3));
  nand4  g43(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n65_));
  aoi21  g44(.a(new_n65_), .b(x06), .c(new_n22_), .O(z4));
endmodule
