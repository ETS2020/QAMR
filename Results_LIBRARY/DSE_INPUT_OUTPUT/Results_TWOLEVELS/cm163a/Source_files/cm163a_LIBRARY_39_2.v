...
module FAU ( 
  ...
  aoi21  g18(.a(x11), .b(x07), .c(x09), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n33_), .c(new_n39_), .O(new_n41_));
  nand3  g20(.a(new_n39_), .b(new_n32_), .c(new_n25_), .O(new_n42_));
  ...
  aoi21  g25(.a(new_n45_), .b(new_n22_), .c(new_n46_), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n44_), .c(x05), .O(z2));
  oai21  g27(.a(new_n42_), .b(new_n23_), .c(x13), .O(new_n49_));
  ...
  nand3  g32(.a(new_n53_), .b(x07), .c(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x05), .O(z3));
  inv1   g34(.a(x03), .O(new_n56_));
  inv1   g35(.a(x15), .O(new_n57_));
  aoi21  g36(.a(new_n46_), .b(x05), .c(new_n57_), .O(new_n58_));
