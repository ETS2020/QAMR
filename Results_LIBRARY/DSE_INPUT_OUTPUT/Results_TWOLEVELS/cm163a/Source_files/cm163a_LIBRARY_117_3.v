...
module FAU ( 
  ...
  oai21  g09(.a(new_n30_), .b(x00), .c(x09), .O(new_n31_));
  nand3  g10(.a(new_n31_), .b(new_n29_), .c(new_n25_), .O(z0));
  nand2  g11(.a(x09), .b(x00), .O(new_n33_));
  ...
  nor3   g18(.a(new_n37_), .b(new_n26_), .c(x00), .O(new_n40_));
  ...
  nand4  g25(.a(new_n46_), .b(new_n37_), .c(x03), .d(x02), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n45_), .c(x09), .O(new_n48_));
  nor3   g27(.a(new_n46_), .b(new_n26_), .c(x00), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n44_), .O(z2));
  nand2  g30(.a(new_n33_), .b(new_n24_), .O(new_n52_));
  inv1   g31(.a(x13), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n23_), .c(new_n22_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x09), .O(new_n55_));
  and2   g34(.a(new_n47_), .b(x13), .O(new_n56_));
  nand3  g35(.a(new_n26_), .b(x03), .c(x02), .O(new_n57_));
  nand3  g36(.a(new_n53_), .b(new_n46_), .c(new_n37_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n56_), .c(x04), .O(new_n60_));
  inv1   g39(.a(x07), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n23_), .O(new_n62_));
  nand4  g41(.a(new_n62_), .b(new_n60_), .c(new_n55_), .d(new_n52_), .O(z3));
  nand2  g42(.a(x08), .b(x03), .O(new_n64_));
  nand3  g43(.a(x15), .b(x14), .c(x10), .O(new_n65_));
  oai21  g44(.a(new_n65_), .b(new_n64_), .c(new_n33_), .O(z4));
endmodule
