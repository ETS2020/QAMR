...
module FAU ( 
  ...
  nand3  g06(.a(new_n26_), .b(new_n27_), .c(new_n22_), .O(new_n28_));
  ...
  nand3  g30(.a(new_n34_), .b(x03), .c(x02), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x13), .O(new_n53_));
  nor2   g32(.a(x13), .b(x11), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n26_), .c(new_n22_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n53_), .c(x12), .O(new_n56_));
  and2   g35(.a(x13), .b(x09), .O(new_n57_));
