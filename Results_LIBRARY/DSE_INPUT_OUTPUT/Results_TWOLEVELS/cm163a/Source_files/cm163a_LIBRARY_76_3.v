...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x13), .O(new_n23_));
  ...
  oai21  g13(.a(new_n34_), .b(x14), .c(x13), .O(new_n35_));
  ...
  nand3  g50(.a(x10), .b(x08), .c(x03), .O(new_n72_));
  inv1   g51(.a(new_n72_), .O(new_n73_));
  nand4  g52(.a(new_n73_), .b(x15), .c(x14), .d(new_n60_), .O(new_n74_));
  inv1   g53(.a(new_n74_), .O(z4));
endmodule
