...
module FAU ( 
  ...
  oai21  g14(.a(new_n35_), .b(new_n30_), .c(x13), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x09), .O(new_n37_));
  nand4  g16(.a(new_n35_), .b(new_n24_), .c(x03), .d(x02), .O(new_n38_));
  ...
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(x13), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x09), .O(new_n46_));
  nand3  g25(.a(new_n35_), .b(x03), .c(x02), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x12), .O(new_n48_));
  nor2   g27(.a(x12), .b(x11), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n25_), .c(new_n24_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x04), .O(new_n52_));
  inv1   g31(.a(x06), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n30_), .O(new_n54_));
  nand4  g33(.a(new_n54_), .b(new_n52_), .c(new_n46_), .d(new_n34_), .O(z2));
  inv1   g34(.a(x07), .O(new_n56_));
  nor2   g35(.a(x09), .b(x04), .O(new_n57_));
  nor2   g36(.a(new_n22_), .b(new_n24_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nor3   g38(.a(x12), .b(x11), .c(x09), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n25_), .c(new_n22_), .O(new_n61_));
  nand3  g40(.a(new_n22_), .b(new_n44_), .c(new_n35_), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(new_n26_), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n61_), .c(x04), .O(new_n64_));
  nand3  g43(.a(new_n64_), .b(new_n59_), .c(new_n34_), .O(z3));
  inv1   g44(.a(x03), .O(new_n66_));
  and2   g45(.a(new_n23_), .b(x15), .O(new_n67_));
  nand4  g46(.a(new_n67_), .b(x14), .c(x10), .d(x08), .O(new_n68_));
  nor2   g47(.a(new_n68_), .b(new_n66_), .O(z4));
endmodule
