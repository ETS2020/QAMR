...
module FAU ( 
  ...
  nand3  g12(.a(new_n27_), .b(x11), .c(x04), .O(new_n34_));
  ...
  nand2  g17(.a(new_n38_), .b(new_n24_), .O(new_n39_));
  nor2   g18(.a(x13), .b(x12), .O(new_n40_));
  ...
  nand2  g22(.a(new_n24_), .b(new_n36_), .O(new_n44_));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n45_));
  inv1   g24(.a(x11), .O(new_n46_));
  nand3  g25(.a(x13), .b(new_n46_), .c(new_n25_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n45_), .c(x13), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n22_), .O(new_n49_));
  nand3  g28(.a(new_n26_), .b(new_n46_), .c(new_n25_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x12), .c(x04), .O(new_n51_));
  inv1   g30(.a(x06), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n31_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n51_), .c(new_n49_), .d(new_n44_), .O(z2));
  oai21  g33(.a(x07), .b(x04), .c(x05), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n24_), .O(new_n56_));
  nand4  g35(.a(new_n26_), .b(new_n22_), .c(new_n46_), .d(new_n25_), .O(new_n57_));
