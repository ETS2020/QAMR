...
module FAU ( 
  ...
  nand3  g09(.a(x11), .b(x09), .c(x04), .O(new_n31_));
  oai21  g10(.a(x04), .b(x01), .c(new_n31_), .O(new_n32_));
  ...
  oai21  g18(.a(new_n39_), .b(new_n34_), .c(new_n22_), .O(new_n40_));
  ...
  nand3  g25(.a(new_n23_), .b(new_n46_), .c(new_n37_), .O(new_n47_));
  ...
  nand3  g32(.a(new_n51_), .b(new_n46_), .c(new_n37_), .O(new_n54_));
  ...
  oai22  g40(.a(new_n61_), .b(new_n60_), .c(new_n22_), .d(x05), .O(z4));
endmodule
