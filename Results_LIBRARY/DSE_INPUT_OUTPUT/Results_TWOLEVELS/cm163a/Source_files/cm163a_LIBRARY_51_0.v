...
module FAU ( 
  ...
  aoi22  g13(.a(new_n34_), .b(new_n33_), .c(new_n26_), .d(x11), .O(new_n35_));
  inv1   g14(.a(x01), .O(new_n36_));
  aoi21  g15(.a(new_n22_), .b(new_n36_), .c(new_n30_), .O(new_n37_));
  oai21  g16(.a(new_n35_), .b(new_n22_), .c(new_n37_), .O(z1));
  aoi21  g17(.a(x11), .b(x05), .c(x09), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n33_), .O(new_n40_));
  nor3   g19(.a(x12), .b(x11), .c(x09), .O(new_n41_));
  aoi22  g20(.a(new_n41_), .b(new_n33_), .c(new_n40_), .d(x12), .O(new_n42_));
