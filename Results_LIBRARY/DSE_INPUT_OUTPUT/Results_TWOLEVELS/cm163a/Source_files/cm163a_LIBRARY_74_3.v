...
module FAU ( 
  ...
  nand2  g01(.a(x08), .b(x07), .O(new_n23_));
  ...
  aoi21  g19(.a(new_n31_), .b(new_n40_), .c(new_n22_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n39_), .c(new_n32_), .O(z1));
  ...
  nand3  g39(.a(new_n60_), .b(new_n58_), .c(new_n24_), .O(z3));
  inv1   g40(.a(x14), .O(new_n62_));
  inv1   g41(.a(x15), .O(new_n63_));
  nand4  g42(.a(x10), .b(x08), .c(new_n59_), .d(x03), .O(new_n64_));
