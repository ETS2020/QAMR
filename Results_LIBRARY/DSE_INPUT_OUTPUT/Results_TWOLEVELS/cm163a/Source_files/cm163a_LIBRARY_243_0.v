...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n61_, new_n62_;
  nor2   g00(.a(x10), .b(x08), .O(new_n22_));
  ...
  nand4  g20(.a(new_n41_), .b(new_n39_), .c(new_n34_), .d(x05), .O(z1));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n48_), .c(new_n22_), .O(z2));
  ...
  aoi21  g38(.a(new_n59_), .b(new_n57_), .c(new_n22_), .O(z3));
