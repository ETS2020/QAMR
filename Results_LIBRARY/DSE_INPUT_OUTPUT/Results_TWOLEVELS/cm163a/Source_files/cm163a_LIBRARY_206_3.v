...
module FAU ( 
  ...
  nand4  g17(.a(new_n38_), .b(x03), .c(x02), .d(new_n22_), .O(new_n39_));
  nand4  g18(.a(new_n39_), .b(new_n34_), .c(new_n33_), .d(x05), .O(z1));
  oai21  g19(.a(new_n37_), .b(new_n24_), .c(x12), .O(new_n41_));
  ...
  nand3  g27(.a(new_n48_), .b(new_n36_), .c(new_n35_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n24_), .c(x13), .O(new_n50_));
  nor3   g29(.a(x13), .b(x12), .c(x11), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n27_), .c(x02), .O(new_n52_));
  ...
  nand2  g36(.a(x05), .b(x01), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(x15), .c(x14), .d(x10), .O(new_n59_));
  nor3   g38(.a(new_n59_), .b(new_n57_), .c(new_n26_), .O(z4));
endmodule
