...
module FAU ( 
  ...
  nand3  g06(.a(new_n26_), .b(new_n22_), .c(new_n27_), .O(new_n28_));
  ...
  or2    g18(.a(x04), .b(x01), .O(new_n40_));
  nand4  g19(.a(new_n40_), .b(new_n39_), .c(new_n37_), .d(new_n33_), .O(z1));
  oai21  g20(.a(x06), .b(x04), .c(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n23_), .O(new_n43_));
  nand3  g22(.a(new_n34_), .b(x03), .c(x02), .O(new_n44_));
  ...
  aoi21  g26(.a(new_n47_), .b(new_n45_), .c(x07), .O(new_n48_));
  inv1   g27(.a(x12), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n43_), .O(z2));
  inv1   g31(.a(x13), .O(new_n53_));
  aoi21  g32(.a(new_n46_), .b(new_n26_), .c(new_n53_), .O(new_n54_));
  nand3  g33(.a(new_n53_), .b(new_n49_), .c(new_n34_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n38_), .c(x04), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n54_), .c(new_n27_), .O(new_n57_));
  nand3  g36(.a(x13), .b(x09), .c(x04), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n57_), .c(new_n33_), .O(z3));
  nand2  g38(.a(x08), .b(x03), .O(new_n60_));
  nand3  g39(.a(x15), .b(x14), .c(x10), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n23_), .O(z4));
endmodule
