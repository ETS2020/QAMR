...
module FAU ( 
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x13), .O(new_n44_));
  ...
  aoi21  g28(.a(new_n48_), .b(x04), .c(new_n49_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n46_), .c(x05), .O(z3));
  inv1   g30(.a(x03), .O(new_n52_));
  inv1   g31(.a(x15), .O(new_n53_));
  aoi21  g32(.a(new_n46_), .b(x05), .c(new_n53_), .O(new_n54_));
