...
module FAU ( 
  ...
  nand4  g13(.a(new_n34_), .b(new_n32_), .c(new_n22_), .d(x05), .O(z1));
  nand2  g14(.a(new_n30_), .b(x12), .O(new_n36_));
  inv1   g15(.a(x12), .O(new_n37_));
  nand4  g16(.a(new_n37_), .b(new_n28_), .c(x03), .d(x02), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(new_n36_), .c(new_n24_), .O(new_n39_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n29_), .c(new_n28_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n43_), .c(new_n24_), .O(new_n46_));
