...
module FAU ( 
  ...
  nand3  g30(.a(new_n36_), .b(new_n22_), .c(x03), .O(new_n52_));
  and2   g31(.a(new_n52_), .b(x12), .O(new_n53_));
  ...
  oai21  g36(.a(new_n57_), .b(new_n28_), .c(x05), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n26_), .O(new_n59_));
  nand2  g38(.a(x13), .b(x12), .O(new_n60_));
  nand2  g39(.a(x03), .b(x02), .O(new_n61_));
  nand3  g40(.a(new_n57_), .b(new_n46_), .c(new_n36_), .O(new_n62_));
  oai21  g41(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n22_), .O(new_n64_));
  nand2  g43(.a(new_n52_), .b(x13), .O(new_n65_));
  aoi21  g44(.a(new_n65_), .b(new_n64_), .c(new_n28_), .O(new_n66_));
  nor2   g45(.a(x07), .b(x04), .O(new_n67_));
  oai21  g46(.a(new_n67_), .b(new_n66_), .c(x05), .O(new_n68_));
  nand2  g47(.a(new_n68_), .b(new_n59_), .O(z3));
  nand2  g48(.a(x08), .b(x03), .O(new_n70_));
  nand3  g49(.a(x15), .b(x14), .c(x10), .O(new_n71_));
  oai22  g50(.a(new_n71_), .b(new_n70_), .c(x05), .d(new_n26_), .O(z4));
endmodule
