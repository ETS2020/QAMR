...
module FAU ( 
  ...
  nand3  g13(.a(new_n24_), .b(new_n34_), .c(new_n22_), .O(new_n35_));
  ...
  nand2  g17(.a(new_n30_), .b(x01), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n38_), .O(z1));
  inv1   g19(.a(x12), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n34_), .c(new_n22_), .O(new_n42_));
  ...
  oai21  g25(.a(new_n44_), .b(new_n29_), .c(new_n46_), .O(z2));
  ...
  nand2  g34(.a(new_n55_), .b(new_n39_), .O(z3));
  inv1   g35(.a(x01), .O(new_n57_));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n30_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  nand4  g38(.a(new_n59_), .b(x14), .c(x10), .d(x08), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n49_), .O(z4));
endmodule
