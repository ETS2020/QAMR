...
module FAU ( 
  ...
  oai21  g14(.a(new_n35_), .b(new_n24_), .c(x04), .O(new_n36_));
  aoi21  g15(.a(new_n28_), .b(x11), .c(new_n36_), .O(new_n37_));
  oai21  g16(.a(new_n37_), .b(x01), .c(x05), .O(z1));
  inv1   g17(.a(new_n24_), .O(new_n39_));
  nand2  g18(.a(x11), .b(new_n22_), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n39_), .c(new_n33_), .O(new_n41_));
  inv1   g20(.a(x12), .O(new_n42_));
  nand3  g21(.a(new_n42_), .b(new_n34_), .c(new_n33_), .O(new_n43_));
  ...
  aoi21  g25(.a(x05), .b(x01), .c(new_n46_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n23_), .c(new_n47_), .O(z2));
  oai21  g27(.a(new_n43_), .b(new_n24_), .c(x13), .O(new_n49_));
  ...
  nand2  g34(.a(x05), .b(x01), .O(new_n56_));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z4));
endmodule
