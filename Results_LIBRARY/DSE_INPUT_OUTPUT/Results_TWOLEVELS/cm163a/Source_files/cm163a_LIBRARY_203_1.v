...
module FAU ( 
  ...
  nand3  g19(.a(new_n33_), .b(new_n24_), .c(x04), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n23_), .c(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n38_), .O(new_n43_));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n22_), .c(new_n29_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n22_), .c(new_n53_), .O(z3));
  inv1   g33(.a(x03), .O(new_n55_));
  inv1   g34(.a(x15), .O(new_n56_));
  aoi21  g35(.a(x12), .b(new_n29_), .c(new_n56_), .O(new_n57_));
