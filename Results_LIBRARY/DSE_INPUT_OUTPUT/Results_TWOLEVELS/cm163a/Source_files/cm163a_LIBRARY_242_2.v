...
module FAU ( 
  ...
  nand3  g15(.a(new_n27_), .b(new_n36_), .c(new_n22_), .O(new_n37_));
  ...
  nand2  g26(.a(x11), .b(new_n28_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n27_), .c(new_n22_), .O(new_n49_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n26_), .c(x13), .O(new_n56_));
  ...
  aoi21  g39(.a(new_n60_), .b(new_n56_), .c(x08), .O(new_n61_));
  ...
  nand4  g45(.a(x10), .b(x09), .c(x08), .d(x03), .O(new_n67_));
