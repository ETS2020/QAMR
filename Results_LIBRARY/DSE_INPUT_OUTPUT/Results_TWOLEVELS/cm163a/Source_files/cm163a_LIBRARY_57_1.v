...
module FAU ( 
  ...
  oai21  g20(.a(new_n30_), .b(new_n29_), .c(new_n39_), .O(new_n42_));
  nand2  g21(.a(new_n35_), .b(x12), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(new_n34_), .c(new_n22_), .O(new_n45_));
  ...
  aoi21  g37(.a(x06), .b(new_n30_), .c(new_n58_), .O(new_n59_));
