...
module FAU ( 
  ...
  aoi22  g21(.a(new_n42_), .b(new_n34_), .c(new_n41_), .d(x12), .O(new_n43_));
  inv1   g22(.a(x05), .O(new_n44_));
  nor2   g23(.a(x06), .b(x04), .O(new_n45_));
  nor3   g24(.a(new_n45_), .b(x07), .c(new_n44_), .O(new_n46_));
  oai21  g25(.a(new_n43_), .b(new_n23_), .c(new_n46_), .O(z2));
  inv1   g26(.a(x13), .O(new_n48_));
  aoi21  g27(.a(new_n42_), .b(new_n34_), .c(new_n48_), .O(new_n49_));
  inv1   g28(.a(x12), .O(new_n50_));
  nand3  g29(.a(new_n48_), .b(new_n50_), .c(new_n33_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n27_), .c(x04), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n49_), .c(new_n22_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(x05), .O(z3));
  inv1   g33(.a(x03), .O(new_n55_));
  inv1   g34(.a(x08), .O(new_n56_));
  nand2  g35(.a(x07), .b(x05), .O(new_n57_));
  nand4  g36(.a(new_n57_), .b(x15), .c(x14), .d(x10), .O(new_n58_));
  nor3   g37(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(z4));
endmodule
