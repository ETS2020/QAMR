...
module FAU ( 
  ...
  aoi22  g23(.a(new_n44_), .b(new_n35_), .c(new_n43_), .d(x12), .O(new_n45_));
  aoi21  g24(.a(new_n31_), .b(new_n22_), .c(new_n30_), .O(new_n46_));
  oai21  g25(.a(new_n45_), .b(new_n22_), .c(new_n46_), .O(z2));
