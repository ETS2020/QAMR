...
module FAU ( 
  ...
  oai21  g08(.a(new_n29_), .b(new_n28_), .c(x10), .O(new_n30_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n26_), .c(x02), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n50_), .c(new_n22_), .O(new_n53_));
  nor2   g32(.a(x07), .b(x04), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(x10), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x05), .O(z3));
  inv1   g35(.a(x15), .O(new_n57_));
  nand4  g36(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n58_));
