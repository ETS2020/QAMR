...
module FAU ( 
  ...
  nand2  g17(.a(x15), .b(new_n38_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n37_), .O(z1));
  nand2  g19(.a(new_n34_), .b(x12), .O(new_n41_));
  inv1   g20(.a(x12), .O(new_n42_));
  nand4  g21(.a(new_n24_), .b(new_n42_), .c(new_n33_), .d(new_n22_), .O(new_n43_));
  ...
  nand3  g26(.a(new_n42_), .b(new_n33_), .c(new_n22_), .O(new_n48_));
  ...
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(x15), .d(x05), .O(z4));
endmodule
