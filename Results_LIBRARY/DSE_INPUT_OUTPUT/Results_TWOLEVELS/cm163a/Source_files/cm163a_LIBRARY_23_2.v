...
module FAU ( 
  ...
  nand4  g09(.a(new_n30_), .b(new_n27_), .c(x15), .d(x05), .O(z0));
  ...
  oai21  g15(.a(new_n36_), .b(new_n35_), .c(x15), .O(new_n37_));
  ...
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(x15), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x05), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x15), .d(new_n43_), .O(z4));
endmodule
