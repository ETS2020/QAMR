...
module FAU ( 
  ...
  nand3  g05(.a(new_n26_), .b(x15), .c(x09), .O(new_n27_));
  ...
  nand3  g17(.a(x15), .b(x11), .c(x09), .O(new_n39_));
  ...
  nand3  g41(.a(x15), .b(x13), .c(x09), .O(new_n63_));
  ...
  nor2   g46(.a(new_n67_), .b(new_n22_), .O(z4));
endmodule
