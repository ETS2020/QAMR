...
module FAU ( 
  ...
  nand3  g11(.a(new_n32_), .b(x04), .c(x02), .O(new_n33_));
  ...
  nand3  g18(.a(new_n39_), .b(new_n37_), .c(new_n35_), .O(z1));
  inv1   g19(.a(x12), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n32_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n23_), .c(new_n22_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x03), .O(new_n44_));
  nand3  g23(.a(new_n32_), .b(x03), .c(x02), .O(new_n45_));
  ...
  nand3  g29(.a(new_n50_), .b(new_n41_), .c(new_n32_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n23_), .c(new_n22_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x03), .O(new_n53_));
  nand4  g32(.a(new_n41_), .b(new_n32_), .c(x03), .d(x02), .O(new_n54_));
  ...
  nand3  g36(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(z3));
  inv1   g37(.a(x14), .O(new_n59_));
  inv1   g38(.a(x15), .O(new_n60_));
  nand4  g39(.a(x10), .b(new_n22_), .c(x08), .d(x03), .O(new_n61_));
