...
module FAU ( 
  ...
  and2   g16(.a(x12), .b(x04), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n37_), .c(x11), .O(new_n39_));
  ...
  nand4  g22(.a(new_n43_), .b(new_n41_), .c(x11), .d(x05), .O(z3));
  inv1   g23(.a(x05), .O(new_n45_));
  nand2  g24(.a(x08), .b(x03), .O(new_n46_));
  nand3  g25(.a(x15), .b(x14), .c(x10), .O(new_n47_));
  oai22  g26(.a(new_n47_), .b(new_n46_), .c(x11), .d(new_n45_), .O(z4));
endmodule
