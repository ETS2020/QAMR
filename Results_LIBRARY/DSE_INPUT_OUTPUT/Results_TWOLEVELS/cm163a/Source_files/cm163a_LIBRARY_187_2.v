...
module FAU ( 
  ...
  oai21  g04(.a(new_n25_), .b(new_n22_), .c(new_n23_), .O(new_n26_));
  ...
  nand4  g11(.a(new_n32_), .b(new_n29_), .c(new_n27_), .d(x05), .O(z0));
  oai21  g12(.a(x04), .b(x01), .c(x05), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(new_n29_), .O(new_n35_));
  nand3  g14(.a(new_n23_), .b(x12), .c(x11), .O(new_n36_));
  inv1   g15(.a(x11), .O(new_n37_));
  nand3  g16(.a(new_n25_), .b(new_n37_), .c(new_n22_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(x04), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n35_), .O(z1));
  nand2  g20(.a(new_n23_), .b(x12), .O(new_n42_));
  nand2  g21(.a(x12), .b(new_n37_), .O(new_n43_));
