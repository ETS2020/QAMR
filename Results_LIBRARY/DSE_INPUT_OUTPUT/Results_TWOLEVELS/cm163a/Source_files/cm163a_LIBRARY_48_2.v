...
module FAU ( 
  ...
  aoi21  g14(.a(x12), .b(x04), .c(new_n23_), .O(new_n36_));
  oai21  g15(.a(new_n36_), .b(new_n22_), .c(new_n35_), .O(z2));
  oai21  g16(.a(x13), .b(new_n22_), .c(x04), .O(new_n38_));
  nand2  g17(.a(x07), .b(x05), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n26_), .O(new_n40_));
  nand2  g19(.a(x09), .b(new_n23_), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n40_), .c(new_n38_), .O(z3));
