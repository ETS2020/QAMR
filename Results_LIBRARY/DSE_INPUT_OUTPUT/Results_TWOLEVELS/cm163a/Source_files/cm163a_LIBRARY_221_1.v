...
module FAU ( 
  ...
  oai21  g12(.a(new_n33_), .b(new_n29_), .c(new_n22_), .O(new_n34_));
  oai21  g13(.a(new_n34_), .b(new_n23_), .c(x12), .O(new_n35_));
  inv1   g14(.a(x12), .O(new_n36_));
  nand4  g15(.a(new_n24_), .b(new_n36_), .c(new_n33_), .d(new_n22_), .O(new_n37_));
  nand4  g16(.a(new_n37_), .b(new_n35_), .c(x05), .d(x04), .O(z2));
  aoi21  g17(.a(new_n36_), .b(new_n33_), .c(new_n29_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n25_), .c(x13), .O(new_n40_));
  ...
  aoi21  g25(.a(x05), .b(new_n29_), .c(new_n46_), .O(new_n47_));
