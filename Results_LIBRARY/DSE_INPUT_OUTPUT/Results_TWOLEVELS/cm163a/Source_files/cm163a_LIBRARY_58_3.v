...
module FAU ( 
  ...
  nor3   g17(.a(new_n36_), .b(new_n25_), .c(x08), .O(new_n39_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n30_), .c(new_n44_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x09), .O(new_n47_));
  nand2  g26(.a(new_n37_), .b(x12), .O(new_n48_));
  nand3  g27(.a(new_n45_), .b(new_n36_), .c(new_n25_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n23_), .c(new_n48_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x04), .O(new_n51_));
  inv1   g30(.a(x06), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n30_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n51_), .c(new_n47_), .d(new_n43_), .O(z2));
  oai21  g33(.a(x07), .b(x04), .c(x05), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n22_), .O(new_n56_));
  nand4  g35(.a(new_n45_), .b(new_n36_), .c(x03), .d(x02), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x13), .O(new_n58_));
  nor2   g37(.a(x13), .b(x12), .O(new_n59_));
  nand4  g38(.a(new_n59_), .b(new_n36_), .c(x03), .d(x02), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(x09), .O(new_n61_));
  nand2  g40(.a(x13), .b(x09), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(x08), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n61_), .c(x04), .O(new_n64_));
  nand2  g43(.a(new_n64_), .b(new_n56_), .O(z3));
  nand4  g44(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n66_));
  aoi21  g45(.a(new_n66_), .b(new_n25_), .c(new_n44_), .O(z4));
endmodule
