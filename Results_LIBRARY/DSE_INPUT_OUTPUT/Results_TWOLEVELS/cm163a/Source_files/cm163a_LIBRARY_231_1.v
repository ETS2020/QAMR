...
module FAU ( 
  ...
  aoi21  g26(.a(new_n31_), .b(new_n22_), .c(new_n30_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n47_), .O(z2));
  ...
  nand2  g36(.a(new_n57_), .b(new_n32_), .O(z3));
  inv1   g37(.a(x15), .O(new_n59_));
  aoi21  g38(.a(x06), .b(new_n30_), .c(new_n59_), .O(new_n60_));
