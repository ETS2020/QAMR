...
module FAU ( 
  ...
  nand2  g16(.a(new_n29_), .b(new_n37_), .O(new_n38_));
  nand4  g17(.a(new_n38_), .b(new_n36_), .c(new_n22_), .d(x05), .O(z1));
  oai21  g18(.a(x06), .b(x04), .c(x05), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(new_n22_), .O(new_n41_));
  nand2  g20(.a(new_n25_), .b(x12), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  nand3  g22(.a(new_n24_), .b(new_n43_), .c(new_n23_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n42_), .c(x11), .O(new_n45_));
  inv1   g24(.a(x13), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(x12), .c(x11), .O(new_n47_));
  ...
  nand2  g30(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  nand2  g31(.a(new_n44_), .b(x13), .O(new_n53_));
  nand4  g32(.a(new_n24_), .b(new_n46_), .c(new_n43_), .d(new_n23_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n33_), .c(x04), .O(new_n56_));
