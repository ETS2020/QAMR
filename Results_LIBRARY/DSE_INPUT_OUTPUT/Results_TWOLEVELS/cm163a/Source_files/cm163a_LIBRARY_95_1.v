...
module FAU ( 
  ...
  oai21  g13(.a(x12), .b(new_n34_), .c(new_n31_), .O(new_n35_));
  ...
  nand3  g19(.a(new_n40_), .b(new_n35_), .c(new_n24_), .O(z1));
  ...
  nand3  g24(.a(new_n23_), .b(new_n37_), .c(new_n25_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n44_), .c(new_n45_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x04), .O(new_n48_));
  nand2  g27(.a(new_n27_), .b(x12), .O(new_n49_));
  nand4  g28(.a(new_n49_), .b(new_n48_), .c(new_n43_), .d(new_n24_), .O(z2));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n51_));
  inv1   g30(.a(x13), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n37_), .c(new_n25_), .O(new_n53_));
  oai22  g32(.a(new_n53_), .b(new_n51_), .c(x07), .d(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n23_), .O(new_n55_));
  nand4  g34(.a(new_n26_), .b(new_n23_), .c(new_n37_), .d(new_n25_), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(x13), .c(x04), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n55_), .c(new_n24_), .O(z3));
  inv1   g37(.a(x03), .O(new_n59_));
  inv1   g38(.a(x15), .O(new_n60_));
  aoi21  g39(.a(x12), .b(new_n31_), .c(new_n60_), .O(new_n61_));
