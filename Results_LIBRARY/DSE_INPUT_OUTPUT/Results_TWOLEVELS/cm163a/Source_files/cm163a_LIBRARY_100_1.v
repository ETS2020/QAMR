...
module FAU ( 
  ...
  aoi21  g06(.a(x09), .b(new_n26_), .c(new_n27_), .O(new_n28_));
  nand2  g07(.a(new_n28_), .b(new_n25_), .O(z0));
  ...
  oai21  g16(.a(new_n35_), .b(new_n31_), .c(new_n37_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x04), .O(new_n39_));
  inv1   g18(.a(x01), .O(new_n40_));
  inv1   g19(.a(x05), .O(new_n41_));
  aoi21  g20(.a(new_n30_), .b(new_n40_), .c(new_n41_), .O(new_n42_));
  nand3  g21(.a(new_n42_), .b(new_n39_), .c(new_n33_), .O(z1));
  inv1   g22(.a(x12), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(new_n22_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n26_), .O(new_n46_));
  aoi21  g25(.a(new_n36_), .b(x02), .c(new_n44_), .O(new_n47_));
  ...
  aoi21  g32(.a(new_n53_), .b(new_n30_), .c(new_n41_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n52_), .c(new_n46_), .O(z2));
  inv1   g34(.a(x13), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n30_), .c(new_n22_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n26_), .O(new_n58_));
  aoi21  g37(.a(new_n49_), .b(new_n35_), .c(new_n56_), .O(new_n59_));
  nand3  g38(.a(new_n56_), .b(new_n44_), .c(new_n31_), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n23_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  inv1   g41(.a(x07), .O(new_n63_));
  aoi21  g42(.a(new_n63_), .b(new_n30_), .c(new_n41_), .O(new_n64_));
