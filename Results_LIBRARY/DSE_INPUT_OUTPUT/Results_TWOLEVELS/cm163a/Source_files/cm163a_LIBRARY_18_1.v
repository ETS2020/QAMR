...
module FAU ( 
  ...
  nand4  g11(.a(new_n31_), .b(new_n22_), .c(x03), .d(x02), .O(new_n33_));
  ...
  nand2  g15(.a(new_n33_), .b(x12), .O(new_n37_));
  nor2   g16(.a(x12), .b(x11), .O(new_n38_));
  nand3  g17(.a(new_n38_), .b(new_n23_), .c(new_n22_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n28_), .O(new_n40_));
  nor2   g19(.a(x06), .b(x04), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(x01), .O(new_n42_));
