...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n61_;
  nand2  g00(.a(x11), .b(x06), .O(new_n22_));
  ...
  nand3  g12(.a(new_n24_), .b(new_n32_), .c(new_n23_), .O(new_n34_));
  ...
  oai21  g22(.a(new_n43_), .b(new_n32_), .c(x04), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  nand4  g24(.a(new_n43_), .b(new_n23_), .c(x03), .d(x02), .O(new_n46_));
  oai21  g25(.a(new_n33_), .b(new_n43_), .c(new_n46_), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n32_), .c(x04), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n45_), .c(new_n41_), .O(z2));
  ...
  nand4  g32(.a(new_n24_), .b(new_n53_), .c(new_n43_), .d(new_n23_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n52_), .c(x11), .O(new_n55_));
  nor3   g34(.a(new_n53_), .b(new_n32_), .c(x06), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(x04), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n51_), .O(z3));
  inv1   g37(.a(x03), .O(new_n59_));
  inv1   g38(.a(x08), .O(new_n60_));
  nand4  g39(.a(new_n22_), .b(x15), .c(x14), .d(x10), .O(new_n61_));
