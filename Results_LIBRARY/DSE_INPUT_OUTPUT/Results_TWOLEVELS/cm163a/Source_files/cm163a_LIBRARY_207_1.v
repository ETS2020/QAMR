...
module FAU ( 
  ...
  nand2  g07(.a(x05), .b(x02), .O(new_n29_));
  ...
  nand4  g24(.a(new_n45_), .b(new_n43_), .c(x05), .d(x02), .O(z2));
  ...
  nand2  g30(.a(new_n33_), .b(x13), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n51_), .c(new_n28_), .O(new_n53_));
  ...
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(x02), .O(z4));
endmodule
