...
module FAU ( 
  ...
  aoi22  g19(.a(new_n40_), .b(new_n23_), .c(new_n34_), .d(x12), .O(new_n41_));
  ...
  aoi21  g24(.a(new_n40_), .b(new_n23_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand3  g26(.a(new_n45_), .b(new_n47_), .c(new_n33_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n24_), .c(x05), .O(new_n49_));
  ...
  aoi21  g34(.a(new_n29_), .b(new_n28_), .c(new_n55_), .O(new_n56_));
