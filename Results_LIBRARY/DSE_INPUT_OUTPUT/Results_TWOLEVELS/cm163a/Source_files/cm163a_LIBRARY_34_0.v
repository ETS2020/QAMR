...
module FAU ( 
  ...
  oai21  g31(.a(x07), .b(x04), .c(new_n30_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n44_), .O(new_n54_));
  oai21  g33(.a(new_n52_), .b(new_n34_), .c(new_n54_), .O(z3));
  nand4  g34(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n29_), .O(z4));
endmodule
