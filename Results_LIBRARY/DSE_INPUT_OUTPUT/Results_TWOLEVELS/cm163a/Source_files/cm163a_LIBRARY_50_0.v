...
module FAU ( 
  ...
  nor2   g00(.a(x14), .b(x12), .O(new_n22_));
  ...
  aoi21  g13(.a(new_n34_), .b(new_n33_), .c(x11), .O(new_n35_));
  ...
  or2    g19(.a(x04), .b(x01), .O(new_n41_));
  nand4  g20(.a(new_n41_), .b(new_n40_), .c(new_n23_), .d(x05), .O(z1));
  nand2  g21(.a(x12), .b(x11), .O(new_n43_));
  inv1   g22(.a(x11), .O(new_n44_));
  nand3  g23(.a(x14), .b(new_n33_), .c(new_n44_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n32_), .c(x03), .d(x02), .O(new_n47_));
  ...
  nand4  g35(.a(new_n44_), .b(new_n32_), .c(x03), .d(x02), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x14), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n33_), .c(new_n56_), .O(new_n59_));
  nand4  g38(.a(x14), .b(new_n56_), .c(new_n33_), .d(new_n44_), .O(new_n60_));
