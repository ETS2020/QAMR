...
module FAU ( 
  ...
  nand3  g05(.a(new_n26_), .b(x09), .c(x01), .O(new_n27_));
  ...
  nand2  g13(.a(new_n34_), .b(x01), .O(new_n35_));
  ...
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(new_n28_), .O(new_n42_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n36_), .c(x01), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x09), .O(new_n48_));
  nand2  g27(.a(x12), .b(x11), .O(new_n49_));
  nand4  g28(.a(new_n46_), .b(new_n38_), .c(x03), .d(x02), .O(new_n50_));
  ...
  nand4  g39(.a(new_n60_), .b(new_n38_), .c(x03), .d(x02), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n59_), .c(x09), .O(new_n62_));
  nand3  g41(.a(x13), .b(x09), .c(x01), .O(new_n63_));
