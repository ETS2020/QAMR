...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(x11), .O(new_n39_));
  inv1   g18(.a(x11), .O(new_n40_));
  inv1   g19(.a(x12), .O(new_n41_));
  nand4  g20(.a(new_n41_), .b(new_n40_), .c(new_n22_), .d(x03), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n39_), .c(new_n23_), .O(new_n43_));
  nand3  g22(.a(new_n26_), .b(x12), .c(x05), .O(new_n44_));
  inv1   g23(.a(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n43_), .c(x04), .O(new_n46_));
  nor2   g25(.a(x06), .b(new_n31_), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n30_), .c(new_n31_), .d(x02), .O(new_n48_));
