...
module FAU ( 
  ...
  nand2  g10(.a(new_n25_), .b(x02), .O(new_n32_));
  ...
  inv1   g35(.a(x05), .O(new_n57_));
  nand4  g36(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n57_), .c(new_n28_), .O(z4));
endmodule
