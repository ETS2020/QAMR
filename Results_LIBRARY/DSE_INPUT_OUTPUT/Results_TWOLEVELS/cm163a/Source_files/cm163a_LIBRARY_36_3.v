...
module FAU ( 
  ...
  nor2   g29(.a(new_n39_), .b(new_n48_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n50_), .c(x04), .O(new_n52_));
  nand2  g31(.a(new_n25_), .b(new_n35_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n52_), .c(new_n46_), .d(new_n34_), .O(z2));
  inv1   g33(.a(x13), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n35_), .c(new_n25_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x09), .O(new_n57_));
  oai21  g36(.a(x12), .b(x11), .c(new_n28_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n39_), .c(new_n55_), .O(new_n59_));
  nand3  g38(.a(new_n55_), .b(new_n48_), .c(new_n36_), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n29_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  inv1   g41(.a(x07), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n35_), .O(new_n64_));
  nand4  g43(.a(new_n64_), .b(new_n62_), .c(new_n57_), .d(new_n34_), .O(z3));
