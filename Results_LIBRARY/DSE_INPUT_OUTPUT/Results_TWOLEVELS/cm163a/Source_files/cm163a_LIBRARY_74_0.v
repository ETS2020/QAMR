...
module FAU ( 
  ...
  oai21  g01(.a(x08), .b(x07), .c(new_n22_), .O(new_n23_));
  ...
  nor2   g09(.a(x08), .b(x07), .O(new_n31_));
  aoi21  g10(.a(new_n30_), .b(new_n29_), .c(new_n31_), .O(new_n32_));
  nand3  g11(.a(new_n32_), .b(new_n28_), .c(new_n23_), .O(z0));
  ...
  aoi21  g18(.a(new_n30_), .b(new_n39_), .c(new_n22_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n38_), .c(new_n31_), .O(z1));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n30_), .c(new_n22_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n48_), .c(new_n31_), .O(z2));
  inv1   g30(.a(x07), .O(new_n52_));
  nand2  g31(.a(x08), .b(x04), .O(new_n53_));
  ...
  nand3  g36(.a(new_n55_), .b(new_n42_), .c(new_n45_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n26_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n57_), .c(x04), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n54_), .c(new_n23_), .O(z3));
