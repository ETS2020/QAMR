...
module FAU ( 
  ...
  nand4  g19(.a(new_n40_), .b(new_n38_), .c(new_n24_), .d(x05), .O(z1));
  inv1   g20(.a(x02), .O(new_n42_));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x12), .O(new_n43_));
  nand4  g22(.a(new_n43_), .b(new_n35_), .c(new_n25_), .d(x03), .O(new_n44_));
  nand3  g23(.a(new_n36_), .b(new_n24_), .c(x12), .O(new_n45_));
  ...
  nand4  g33(.a(x15), .b(new_n54_), .c(new_n35_), .d(new_n25_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n53_), .c(x15), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n22_), .O(new_n57_));
  nand4  g36(.a(new_n26_), .b(new_n54_), .c(new_n35_), .d(new_n25_), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(x13), .c(x04), .O(new_n59_));
  inv1   g38(.a(x07), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n31_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(new_n59_), .c(new_n57_), .d(new_n52_), .O(z3));
