...
module FAU ( 
  ...
  nand2  g07(.a(x07), .b(x05), .O(new_n29_));
  ...
  nand2  g28(.a(new_n49_), .b(new_n46_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x07), .c(x04), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x05), .O(z3));
  inv1   g31(.a(x03), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  inv1   g33(.a(x15), .O(new_n55_));
  aoi21  g34(.a(new_n54_), .b(x05), .c(new_n55_), .O(new_n56_));
