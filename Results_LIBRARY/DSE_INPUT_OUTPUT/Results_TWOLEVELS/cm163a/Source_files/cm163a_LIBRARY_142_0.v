...
module FAU ( 
  ...
  nor2   g00(.a(x10), .b(x07), .O(new_n22_));
  ...
  nand3  g32(.a(new_n52_), .b(new_n43_), .c(new_n53_), .O(new_n54_));
  oai22  g33(.a(new_n54_), .b(new_n26_), .c(new_n45_), .d(new_n52_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x04), .c(new_n31_), .O(new_n56_));
  inv1   g35(.a(x10), .O(new_n57_));
  nand2  g36(.a(x07), .b(x04), .O(new_n58_));
  oai21  g37(.a(new_n57_), .b(x07), .c(new_n58_), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n26_), .c(x13), .O(new_n60_));
  inv1   g39(.a(x07), .O(new_n61_));
  nand3  g40(.a(x10), .b(new_n61_), .c(new_n30_), .O(new_n62_));
  and2   g41(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  oai21  g42(.a(new_n56_), .b(new_n22_), .c(new_n63_), .O(z3));
  nand2  g43(.a(x08), .b(x03), .O(new_n65_));
  nand3  g44(.a(x15), .b(x14), .c(x10), .O(new_n66_));
  oai21  g45(.a(new_n66_), .b(new_n65_), .c(new_n34_), .O(z4));
endmodule
