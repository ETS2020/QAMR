...
module FAU ( 
  ...
  and2   g18(.a(new_n34_), .b(x12), .O(new_n40_));
  nor4   g19(.a(new_n22_), .b(x12), .c(x11), .d(x09), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(x04), .O(new_n42_));
  inv1   g21(.a(x06), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n29_), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(new_n42_), .c(x05), .O(z2));
  ...
  oai21  g33(.a(new_n54_), .b(new_n49_), .c(new_n50_), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n48_), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(new_n50_), .d(x05), .O(z4));
endmodule
