...
module FAU ( 
  ...
  aoi21  g16(.a(new_n37_), .b(new_n35_), .c(x08), .O(new_n38_));
  ...
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(new_n28_), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(new_n22_), .O(new_n60_));
  nand4  g39(.a(new_n49_), .b(new_n48_), .c(new_n44_), .d(new_n22_), .O(new_n61_));
  ...
  aoi21  g45(.a(new_n66_), .b(x09), .c(new_n28_), .O(z4));
endmodule
