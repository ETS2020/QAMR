...
module FAU ( 
  ...
  nand3  g25(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  ...
  aoi21  g31(.a(new_n35_), .b(x02), .c(new_n50_), .O(new_n53_));
  oai22  g32(.a(x09), .b(x05), .c(x06), .d(x04), .O(new_n54_));
  aoi21  g33(.a(new_n53_), .b(x04), .c(new_n54_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n52_), .c(new_n49_), .O(z2));
  nand2  g35(.a(x04), .b(x02), .O(new_n57_));
  inv1   g36(.a(x13), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(new_n50_), .c(new_n35_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n57_), .c(new_n23_), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(x03), .O(new_n61_));
  oai21  g40(.a(new_n58_), .b(new_n28_), .c(x05), .O(new_n62_));
  nand2  g41(.a(new_n62_), .b(new_n27_), .O(new_n63_));
  aoi21  g42(.a(new_n46_), .b(x02), .c(new_n58_), .O(new_n64_));
  oai22  g43(.a(x09), .b(x05), .c(x07), .d(x04), .O(new_n65_));
  aoi21  g44(.a(new_n64_), .b(x04), .c(new_n65_), .O(new_n66_));
  nand3  g45(.a(new_n66_), .b(new_n63_), .c(new_n61_), .O(z3));
