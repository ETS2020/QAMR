...
module FAU ( 
  ...
  oai21  g16(.a(new_n37_), .b(x14), .c(x13), .O(new_n38_));
  ...
  inv1   g28(.a(new_n27_), .O(new_n50_));
  nor2   g29(.a(x11), .b(x09), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n50_), .c(new_n36_), .O(new_n52_));
  nor4   g31(.a(new_n27_), .b(x12), .c(x11), .d(x09), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(x04), .O(new_n54_));
  inv1   g33(.a(x05), .O(new_n55_));
  inv1   g34(.a(x06), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(new_n30_), .c(new_n55_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n54_), .c(new_n25_), .O(z2));
  ...
  nand3  g46(.a(new_n41_), .b(new_n24_), .c(x13), .O(new_n68_));
  nand2  g47(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g48(.a(new_n69_), .b(x04), .O(new_n70_));
  nand2  g49(.a(new_n70_), .b(new_n60_), .O(z3));
  nand4  g50(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n72_));
  aoi21  g51(.a(new_n72_), .b(new_n23_), .c(new_n24_), .O(z4));
endmodule
