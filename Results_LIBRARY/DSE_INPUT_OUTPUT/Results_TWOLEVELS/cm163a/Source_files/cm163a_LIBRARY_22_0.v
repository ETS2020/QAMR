...
module FAU ( 
  ...
  nor3   g15(.a(new_n22_), .b(x11), .c(x09), .O(new_n37_));
  nand4  g16(.a(new_n37_), .b(x04), .c(x03), .d(x02), .O(new_n38_));
  ...
  aoi21  g22(.a(new_n43_), .b(new_n42_), .c(x12), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n41_), .c(new_n24_), .d(x03), .O(new_n45_));
  nand3  g24(.a(new_n25_), .b(new_n41_), .c(new_n24_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x12), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n40_), .c(new_n47_), .O(new_n48_));
  ...
  nand3  g33(.a(new_n43_), .b(new_n54_), .c(x08), .O(new_n55_));
