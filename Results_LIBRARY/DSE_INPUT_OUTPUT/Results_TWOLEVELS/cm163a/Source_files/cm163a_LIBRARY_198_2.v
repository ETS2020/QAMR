...
module FAU ( 
  ...
  oai21  g08(.a(new_n29_), .b(new_n26_), .c(new_n27_), .O(new_n30_));
  ...
  aoi21  g16(.a(new_n37_), .b(new_n35_), .c(x07), .O(new_n38_));
  nor2   g17(.a(new_n36_), .b(new_n22_), .O(new_n39_));
  ...
  nand2  g27(.a(x11), .b(new_n28_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n44_), .c(new_n22_), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(x12), .c(x04), .O(new_n51_));
  or2    g30(.a(x06), .b(x04), .O(new_n52_));
  nand4  g31(.a(new_n52_), .b(new_n51_), .c(new_n48_), .d(new_n43_), .O(z2));
  inv1   g32(.a(x13), .O(new_n54_));
  aoi21  g33(.a(new_n45_), .b(new_n44_), .c(new_n54_), .O(new_n55_));
  nand3  g34(.a(new_n22_), .b(x03), .c(x02), .O(new_n56_));
  inv1   g35(.a(x12), .O(new_n57_));
  nand3  g36(.a(new_n54_), .b(new_n57_), .c(new_n36_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(x04), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n55_), .c(new_n28_), .O(new_n60_));
  nand3  g39(.a(x13), .b(x09), .c(x04), .O(new_n61_));
  nand3  g40(.a(new_n61_), .b(new_n60_), .c(new_n43_), .O(z3));
  inv1   g41(.a(x03), .O(new_n63_));
  inv1   g42(.a(x15), .O(new_n64_));
  aoi21  g43(.a(new_n22_), .b(x07), .c(new_n64_), .O(new_n65_));
