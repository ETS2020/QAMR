...
module FAU ( 
  ...
  nand3  g15(.a(new_n26_), .b(x11), .c(new_n36_), .O(new_n37_));
  inv1   g16(.a(x11), .O(new_n38_));
  nand3  g17(.a(new_n25_), .b(new_n38_), .c(new_n24_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x04), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n35_), .O(z1));
  nand2  g21(.a(new_n22_), .b(new_n31_), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(new_n36_), .O(new_n45_));
  ...
  nand2  g33(.a(x13), .b(x11), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x04), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n36_), .O(new_n57_));
  nand4  g36(.a(new_n44_), .b(new_n24_), .c(x03), .d(x02), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(x13), .O(new_n59_));
  nor2   g38(.a(x13), .b(x12), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n25_), .c(new_n24_), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n38_), .c(x04), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n57_), .c(new_n43_), .O(z3));
  nand2  g43(.a(x08), .b(x03), .O(new_n65_));
  nand3  g44(.a(x15), .b(x14), .c(x10), .O(new_n66_));
  oai21  g45(.a(new_n66_), .b(new_n65_), .c(new_n22_), .O(z4));
endmodule
