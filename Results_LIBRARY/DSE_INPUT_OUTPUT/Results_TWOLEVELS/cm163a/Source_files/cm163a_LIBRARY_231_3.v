...
module FAU ( 
  ...
  oai21  g17(.a(new_n33_), .b(x06), .c(new_n26_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n24_), .c(x12), .O(new_n40_));
  and2   g19(.a(x05), .b(x04), .O(new_n41_));
  inv1   g20(.a(x12), .O(new_n42_));
  nand3  g21(.a(new_n42_), .b(new_n33_), .c(new_n26_), .O(new_n43_));
  or2    g22(.a(new_n43_), .b(new_n24_), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n41_), .c(new_n40_), .d(new_n22_), .O(z2));
  oai21  g24(.a(new_n43_), .b(new_n24_), .c(x13), .O(new_n46_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n46_), .c(new_n23_), .O(new_n51_));
