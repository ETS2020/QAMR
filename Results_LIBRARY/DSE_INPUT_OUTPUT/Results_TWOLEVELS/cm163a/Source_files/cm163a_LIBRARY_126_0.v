...
module FAU ( 
  ...
  nand4  g25(.a(new_n46_), .b(new_n39_), .c(new_n23_), .d(x02), .O(new_n47_));
  ...
  and2   g30(.a(x13), .b(x12), .O(new_n52_));
  nor2   g31(.a(x13), .b(x12), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n36_), .c(new_n52_), .O(new_n54_));
  oai21  g33(.a(x11), .b(new_n27_), .c(x13), .O(new_n55_));
  oai21  g34(.a(new_n54_), .b(new_n27_), .c(new_n55_), .O(new_n56_));
  or2    g35(.a(x07), .b(x04), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x05), .O(new_n58_));
  aoi21  g37(.a(new_n56_), .b(x04), .c(new_n58_), .O(new_n59_));
