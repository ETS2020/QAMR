...
module FAU ( 
  ...
  nor3   g16(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n38_));
  oai21  g17(.a(new_n34_), .b(new_n22_), .c(new_n38_), .O(z1));
  ...
  nand3  g22(.a(new_n43_), .b(x06), .c(x04), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z2));
  inv1   g24(.a(new_n26_), .O(new_n46_));
  oai21  g25(.a(x12), .b(x11), .c(x06), .O(new_n47_));
  ...
  oai21  g29(.a(x07), .b(x04), .c(x06), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n35_), .O(new_n52_));
  oai21  g31(.a(new_n50_), .b(new_n22_), .c(new_n52_), .O(z3));
  inv1   g32(.a(x03), .O(new_n54_));
  inv1   g33(.a(x15), .O(new_n55_));
  aoi21  g34(.a(new_n36_), .b(x05), .c(new_n55_), .O(new_n56_));
