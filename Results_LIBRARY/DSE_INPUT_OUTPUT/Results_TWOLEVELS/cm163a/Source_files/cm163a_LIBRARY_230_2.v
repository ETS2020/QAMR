...
module FAU ( 
  ...
  nand3  g16(.a(x13), .b(x11), .c(x09), .O(new_n38_));
  inv1   g17(.a(new_n38_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n37_), .c(x04), .O(new_n40_));
  ...
  nand3  g24(.a(new_n25_), .b(new_n45_), .c(new_n35_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(x09), .O(new_n47_));
  nand3  g26(.a(x13), .b(x12), .c(x09), .O(new_n48_));
  inv1   g27(.a(new_n48_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n47_), .c(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n43_), .O(z2));
  inv1   g30(.a(x05), .O(new_n52_));
  nand2  g31(.a(new_n23_), .b(new_n52_), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  nor2   g33(.a(x09), .b(x04), .O(new_n55_));
  nor2   g34(.a(new_n22_), .b(new_n24_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(new_n57_));
  nor3   g36(.a(x12), .b(x11), .c(x09), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n25_), .c(new_n22_), .O(new_n59_));
  nand3  g38(.a(new_n22_), .b(new_n45_), .c(new_n35_), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n26_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n57_), .c(new_n53_), .O(z3));
  inv1   g42(.a(x03), .O(new_n64_));
  and2   g43(.a(new_n23_), .b(x15), .O(new_n65_));
  nand4  g44(.a(new_n65_), .b(x14), .c(x10), .d(x08), .O(new_n66_));
  nor2   g45(.a(new_n66_), .b(new_n64_), .O(z4));
endmodule
