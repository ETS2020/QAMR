...
module FAU ( 
  ...
  nand4  g18(.a(new_n39_), .b(new_n31_), .c(new_n22_), .d(x03), .O(new_n40_));
  ...
  aoi21  g34(.a(x05), .b(new_n51_), .c(new_n55_), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(x14), .c(x10), .d(x08), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n24_), .O(z4));
endmodule
