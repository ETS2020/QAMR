...
module FAU ( 
  ...
  nand3  g12(.a(new_n27_), .b(new_n33_), .c(new_n26_), .O(new_n34_));
  ...
  nand2  g16(.a(new_n24_), .b(new_n22_), .O(new_n38_));
  ...
  nand3  g22(.a(new_n40_), .b(new_n33_), .c(new_n26_), .O(new_n44_));
  ...
  inv1   g28(.a(new_n28_), .O(new_n50_));
  oai21  g29(.a(x12), .b(x11), .c(x05), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n26_), .c(x03), .d(x02), .O(new_n52_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n23_), .c(new_n24_), .O(new_n56_));
  oai21  g35(.a(new_n54_), .b(new_n23_), .c(new_n56_), .O(z3));
