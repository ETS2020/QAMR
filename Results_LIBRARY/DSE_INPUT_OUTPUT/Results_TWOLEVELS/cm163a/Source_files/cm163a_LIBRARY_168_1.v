...
module FAU ( 
  ...
  aoi21  g07(.a(x14), .b(new_n22_), .c(x09), .O(new_n29_));
  ...
  aoi21  g22(.a(x14), .b(new_n22_), .c(x12), .O(new_n44_));
  ...
  nor3   g34(.a(x14), .b(x13), .c(x12), .O(new_n56_));
  ...
  nand4  g44(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n66_));
  aoi21  g45(.a(new_n66_), .b(x13), .c(new_n65_), .O(z4));
endmodule
