...
module FAU ( 
  ...
  nand2  g07(.a(new_n23_), .b(x08), .O(new_n29_));
  ...
  inv1   g26(.a(new_n27_), .O(new_n48_));
  nand2  g27(.a(x11), .b(x08), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n48_), .c(new_n23_), .O(new_n50_));
  ...
  nand4  g33(.a(new_n54_), .b(new_n51_), .c(new_n47_), .d(new_n43_), .O(z2));
  nand3  g34(.a(x04), .b(x03), .c(x02), .O(new_n56_));
  inv1   g35(.a(x13), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n44_), .c(new_n36_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(x08), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(new_n23_), .O(new_n60_));
  nand4  g39(.a(new_n49_), .b(new_n48_), .c(new_n44_), .d(new_n23_), .O(new_n61_));
  nand3  g40(.a(new_n61_), .b(x13), .c(x04), .O(new_n62_));
  inv1   g41(.a(x07), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  nand4  g43(.a(new_n64_), .b(new_n62_), .c(new_n60_), .d(new_n43_), .O(z3));
