...
module FAU ( 
  ...
  nand3  g11(.a(new_n26_), .b(x11), .c(x04), .O(new_n33_));
  inv1   g12(.a(new_n33_), .O(new_n34_));
  oai21  g13(.a(x04), .b(x01), .c(x05), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n34_), .c(new_n23_), .O(new_n36_));
  inv1   g15(.a(x11), .O(new_n37_));
  nand4  g16(.a(new_n23_), .b(new_n37_), .c(new_n24_), .d(x04), .O(new_n38_));
  ...
  aoi21  g21(.a(new_n22_), .b(x08), .c(x12), .O(new_n43_));
  nand4  g22(.a(new_n43_), .b(new_n37_), .c(new_n24_), .d(x03), .O(new_n44_));
  nand3  g23(.a(new_n25_), .b(new_n37_), .c(new_n24_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x12), .O(new_n46_));
  oai21  g25(.a(new_n44_), .b(new_n42_), .c(new_n46_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x04), .O(new_n48_));
  inv1   g27(.a(x06), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n30_), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n48_), .c(new_n23_), .d(x05), .O(z2));
  nand2  g30(.a(x13), .b(x12), .O(new_n52_));
  inv1   g31(.a(x08), .O(new_n53_));
  inv1   g32(.a(x12), .O(new_n54_));
  nand3  g33(.a(new_n22_), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n52_), .c(x11), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(new_n24_), .c(x03), .d(x02), .O(new_n57_));
  nand2  g36(.a(new_n45_), .b(x13), .O(new_n58_));
  ...
  nand2  g41(.a(new_n62_), .b(new_n60_), .O(z3));
  inv1   g42(.a(x14), .O(new_n64_));
  inv1   g43(.a(x15), .O(new_n65_));
  nand4  g44(.a(x13), .b(x10), .c(x08), .d(x03), .O(new_n66_));
