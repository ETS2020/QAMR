...
module FAU ( 
  ...
  oai21  g11(.a(new_n29_), .b(new_n22_), .c(new_n32_), .O(new_n33_));
  ...
  oai21  g24(.a(new_n40_), .b(new_n23_), .c(x13), .O(new_n46_));
  ...
  nand2  g32(.a(new_n29_), .b(new_n32_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n53_), .O(z3));
  inv1   g34(.a(x15), .O(new_n56_));
  aoi21  g35(.a(new_n29_), .b(x01), .c(new_n56_), .O(new_n57_));
  nand4  g36(.a(new_n57_), .b(x14), .c(x10), .d(x08), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n47_), .O(z4));
endmodule
