...
module FAU ( 
  ...
  nand4  g25(.a(new_n46_), .b(new_n35_), .c(x04), .d(x02), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n23_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x03), .O(new_n49_));
  oai21  g28(.a(new_n46_), .b(new_n28_), .c(x05), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n27_), .O(new_n51_));
  oai21  g30(.a(new_n35_), .b(x09), .c(x02), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(x12), .c(x04), .O(new_n53_));
  inv1   g32(.a(x06), .O(new_n54_));
  aoi22  g33(.a(new_n23_), .b(new_n39_), .c(new_n54_), .d(new_n28_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(new_n53_), .c(new_n51_), .d(new_n49_), .O(z2));
  oai21  g35(.a(x07), .b(x04), .c(x05), .O(new_n57_));
  oai21  g36(.a(new_n23_), .b(new_n27_), .c(new_n57_), .O(new_n58_));
  nand3  g37(.a(new_n46_), .b(new_n35_), .c(x02), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(x13), .O(new_n60_));
  nor2   g39(.a(x13), .b(x12), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(new_n35_), .c(x03), .d(x02), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n60_), .c(x09), .O(new_n63_));
  inv1   g42(.a(x13), .O(new_n64_));
  nor2   g43(.a(new_n64_), .b(x03), .O(new_n65_));
  oai21  g44(.a(new_n65_), .b(new_n63_), .c(x04), .O(new_n66_));
  nand2  g45(.a(new_n66_), .b(new_n58_), .O(z3));
  nand4  g46(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n68_));
  aoi21  g47(.a(new_n68_), .b(new_n23_), .c(new_n27_), .O(z4));
endmodule
