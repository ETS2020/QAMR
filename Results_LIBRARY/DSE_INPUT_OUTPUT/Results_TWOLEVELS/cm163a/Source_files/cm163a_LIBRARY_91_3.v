...
module FAU ( 
  ...
  aoi21  g13(.a(new_n34_), .b(new_n32_), .c(new_n26_), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n29_), .c(new_n30_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n28_), .O(z1));
  nand2  g16(.a(x06), .b(x05), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n26_), .O(new_n39_));
  nand3  g18(.a(x12), .b(x11), .c(x04), .O(new_n40_));
  nand2  g19(.a(new_n40_), .b(x05), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n30_), .O(new_n42_));
  nand2  g21(.a(new_n31_), .b(x12), .O(new_n43_));
  inv1   g22(.a(x12), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n33_), .c(x03), .d(x02), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n43_), .c(new_n30_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x04), .O(new_n47_));
  nand3  g26(.a(new_n47_), .b(new_n42_), .c(new_n39_), .O(z2));
  ...
  nand3  g32(.a(new_n44_), .b(x03), .c(x02), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(x13), .O(new_n55_));
  nor2   g34(.a(x13), .b(x12), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(new_n33_), .c(x03), .d(x02), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n55_), .c(new_n30_), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(x04), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n53_), .c(new_n50_), .O(z3));
  nand2  g39(.a(x08), .b(x03), .O(new_n61_));
  nand3  g40(.a(x15), .b(x14), .c(x10), .O(new_n62_));
  oai22  g41(.a(new_n62_), .b(new_n61_), .c(new_n30_), .d(new_n26_), .O(z4));
endmodule
