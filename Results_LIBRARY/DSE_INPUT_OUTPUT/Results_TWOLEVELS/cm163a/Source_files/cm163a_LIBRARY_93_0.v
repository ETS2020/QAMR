...
module FAU ( 
  ...
  nand3  g12(.a(new_n33_), .b(new_n22_), .c(new_n26_), .O(new_n34_));
  ...
  nand2  g20(.a(new_n41_), .b(x11), .O(new_n42_));
  nand2  g21(.a(new_n27_), .b(x12), .O(new_n43_));
  nand4  g22(.a(new_n33_), .b(new_n40_), .c(new_n22_), .d(new_n26_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n43_), .c(new_n23_), .O(new_n45_));
  ...
  nand2  g30(.a(new_n40_), .b(new_n26_), .O(new_n52_));
