...
module FAU ( 
  ...
  aoi21  g17(.a(x11), .b(x06), .c(x09), .O(new_n39_));
  ...
  oai21  g26(.a(x12), .b(x11), .c(x06), .O(new_n48_));
  ...
  oai21  g30(.a(x07), .b(x04), .c(x06), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n43_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n22_), .c(new_n53_), .O(z3));
  inv1   g33(.a(x03), .O(new_n55_));
  inv1   g34(.a(x15), .O(new_n56_));
  aoi21  g35(.a(new_n44_), .b(x05), .c(new_n56_), .O(new_n57_));
