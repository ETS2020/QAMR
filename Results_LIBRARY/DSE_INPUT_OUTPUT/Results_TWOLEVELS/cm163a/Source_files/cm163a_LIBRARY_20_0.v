...
module FAU ( 
  ...
  nand2  g17(.a(x06), .b(new_n38_), .O(new_n39_));
  ...
  nand2  g26(.a(x12), .b(x05), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n33_), .c(new_n24_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n22_), .c(x13), .O(new_n50_));
  nor2   g29(.a(x13), .b(x12), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n33_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n25_), .c(new_n50_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(x04), .O(new_n54_));
  inv1   g33(.a(x07), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n29_), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n54_), .c(x05), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(x06), .d(x05), .O(z4));
endmodule
