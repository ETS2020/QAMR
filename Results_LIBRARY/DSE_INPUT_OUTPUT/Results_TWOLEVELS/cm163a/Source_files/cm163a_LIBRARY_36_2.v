...
module FAU ( 
  ...
  nand3  g08(.a(new_n29_), .b(new_n27_), .c(new_n22_), .O(new_n30_));
  ...
  oai21  g16(.a(new_n37_), .b(new_n28_), .c(new_n22_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n27_), .O(new_n39_));
  nand3  g18(.a(new_n27_), .b(x03), .c(x02), .O(new_n40_));
  ...
  nand4  g23(.a(new_n44_), .b(new_n41_), .c(new_n39_), .d(new_n35_), .O(z1));
  oai21  g24(.a(x11), .b(x09), .c(x04), .O(new_n46_));
  oai21  g25(.a(new_n29_), .b(x09), .c(new_n46_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x12), .O(new_n48_));
  inv1   g27(.a(x12), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n36_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n28_), .c(new_n22_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n27_), .O(new_n52_));
  nand2  g31(.a(new_n22_), .b(new_n43_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n52_), .c(new_n48_), .d(new_n35_), .O(z2));
  inv1   g33(.a(x13), .O(new_n55_));
  inv1   g34(.a(new_n40_), .O(new_n56_));
  nand2  g35(.a(new_n50_), .b(new_n22_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  nand3  g37(.a(new_n55_), .b(new_n49_), .c(new_n36_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n40_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n58_), .c(x04), .O(new_n61_));
  nor2   g40(.a(x07), .b(x04), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(new_n23_), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n61_), .c(new_n35_), .O(z3));
  inv1   g43(.a(x03), .O(new_n65_));
  inv1   g44(.a(x15), .O(new_n66_));
  nor2   g45(.a(new_n23_), .b(new_n66_), .O(new_n67_));
  nand4  g46(.a(new_n67_), .b(x14), .c(x10), .d(x08), .O(new_n68_));
  nor2   g47(.a(new_n68_), .b(new_n65_), .O(z4));
endmodule
