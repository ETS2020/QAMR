...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(new_n23_), .O(new_n24_));
  ...
  nand3  g21(.a(new_n42_), .b(new_n40_), .c(new_n26_), .O(z1));
  ...
  aoi21  g33(.a(new_n54_), .b(new_n28_), .c(new_n23_), .O(new_n55_));
  nand3  g34(.a(new_n23_), .b(new_n44_), .c(new_n47_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n29_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n55_), .c(x04), .O(new_n58_));
  nor2   g37(.a(x07), .b(x04), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n58_), .c(new_n26_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand3  g41(.a(x15), .b(x14), .c(x10), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n62_), .c(new_n25_), .O(z4));
endmodule
