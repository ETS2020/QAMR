...
module FAU ( 
  ...
  aoi21  g13(.a(x11), .b(x04), .c(new_n27_), .O(new_n35_));
  oai21  g14(.a(x09), .b(new_n31_), .c(x11), .O(new_n36_));
  ...
  oai21  g20(.a(new_n35_), .b(x03), .c(new_n41_), .O(z1));
  nand2  g21(.a(x12), .b(x04), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x05), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n26_), .O(new_n45_));
  nand3  g24(.a(new_n37_), .b(new_n22_), .c(x02), .O(new_n46_));
  ...
  nand3  g35(.a(new_n48_), .b(new_n22_), .c(x02), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x13), .O(new_n58_));
  nor2   g37(.a(x09), .b(new_n26_), .O(new_n59_));
  nor3   g38(.a(x13), .b(x12), .c(x11), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n59_), .c(x02), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n58_), .c(new_n28_), .O(new_n62_));
  ...
  aoi21  g45(.a(new_n66_), .b(x05), .c(new_n26_), .O(z4));
endmodule
