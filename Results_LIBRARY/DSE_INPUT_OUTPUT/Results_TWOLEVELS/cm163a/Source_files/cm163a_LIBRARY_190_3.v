...
module FAU ( 
  ...
  nor3   g21(.a(new_n42_), .b(x14), .c(new_n41_), .O(new_n43_));
  oai21  g22(.a(new_n40_), .b(new_n29_), .c(new_n43_), .O(z2));
  inv1   g23(.a(new_n25_), .O(new_n45_));
  nand2  g24(.a(new_n39_), .b(new_n24_), .O(new_n46_));
  ...
  nor3   g28(.a(new_n49_), .b(x14), .c(new_n41_), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n29_), .c(new_n50_), .O(z3));
  nand4  g30(.a(x15), .b(x10), .c(x08), .d(x03), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n41_), .c(new_n22_), .O(z4));
endmodule
