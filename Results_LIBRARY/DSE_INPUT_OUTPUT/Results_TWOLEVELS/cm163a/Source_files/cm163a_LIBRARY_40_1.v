...
module FAU ( 
  ...
  aoi21  g20(.a(new_n31_), .b(new_n40_), .c(new_n41_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n39_), .c(new_n34_), .O(z1));
  inv1   g22(.a(x12), .O(new_n44_));
  aoi21  g23(.a(new_n36_), .b(new_n26_), .c(new_n44_), .O(new_n45_));
  ...
  nand4  g30(.a(new_n51_), .b(new_n49_), .c(new_n23_), .d(x05), .O(z2));
  ...
  aoi21  g38(.a(new_n59_), .b(new_n31_), .c(new_n41_), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(new_n34_), .O(z3));
  inv1   g40(.a(x14), .O(new_n62_));
  nand3  g41(.a(x15), .b(x08), .c(x03), .O(new_n63_));
  aoi21  g42(.a(new_n63_), .b(x10), .c(new_n62_), .O(z4));
endmodule
