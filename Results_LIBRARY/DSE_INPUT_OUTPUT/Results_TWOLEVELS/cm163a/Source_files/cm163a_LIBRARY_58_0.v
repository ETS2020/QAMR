...
module FAU ( 
  ...
  oai21  g08(.a(new_n26_), .b(new_n23_), .c(new_n29_), .O(new_n30_));
  ...
  nand4  g13(.a(new_n34_), .b(new_n31_), .c(new_n24_), .d(x05), .O(z0));
  oai21  g14(.a(x04), .b(x01), .c(x05), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n24_), .O(new_n37_));
  nand2  g16(.a(new_n25_), .b(x11), .O(new_n38_));
  inv1   g17(.a(x11), .O(new_n39_));
  nand3  g18(.a(new_n26_), .b(new_n39_), .c(new_n23_), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(new_n38_), .c(new_n22_), .O(new_n41_));
  nor2   g20(.a(new_n39_), .b(new_n23_), .O(new_n42_));
  ...
  nand3  g26(.a(new_n47_), .b(new_n39_), .c(x04), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n25_), .c(x08), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  nand3  g29(.a(new_n40_), .b(x12), .c(x04), .O(new_n51_));
  inv1   g30(.a(x06), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n33_), .O(new_n53_));
  nand4  g32(.a(new_n53_), .b(new_n51_), .c(new_n50_), .d(new_n46_), .O(z2));
  oai21  g33(.a(x07), .b(x04), .c(x05), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n24_), .O(new_n56_));
  nand2  g35(.a(new_n47_), .b(new_n39_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n25_), .c(x13), .O(new_n58_));
  nor3   g37(.a(x13), .b(x12), .c(x11), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n28_), .c(x02), .O(new_n60_));
