...
module FAU ( 
  ...
  nand2  g16(.a(new_n37_), .b(new_n27_), .O(new_n38_));
  ...
  oai21  g22(.a(new_n23_), .b(new_n22_), .c(new_n33_), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  aoi21  g24(.a(new_n37_), .b(new_n27_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x11), .O(new_n47_));
  nand3  g26(.a(new_n45_), .b(new_n47_), .c(new_n25_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n26_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n46_), .c(x04), .O(new_n50_));
  aoi21  g29(.a(new_n22_), .b(new_n32_), .c(new_n24_), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n50_), .c(new_n44_), .O(z2));
  inv1   g31(.a(x13), .O(new_n53_));
  nor3   g32(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n27_), .c(new_n53_), .O(new_n55_));
  nand3  g34(.a(new_n53_), .b(new_n45_), .c(new_n47_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n28_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n55_), .c(x04), .O(new_n58_));
  nor2   g37(.a(x07), .b(x04), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n58_), .c(new_n44_), .O(z3));
  nand4  g40(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n22_), .c(new_n23_), .O(z4));
endmodule
