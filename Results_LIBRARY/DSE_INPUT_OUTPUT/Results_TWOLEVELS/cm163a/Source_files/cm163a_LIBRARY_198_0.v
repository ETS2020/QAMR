...
module FAU ( 
  ...
  nand3  g07(.a(new_n28_), .b(new_n23_), .c(x07), .O(new_n29_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n27_), .c(x07), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n23_), .O(new_n47_));
  aoi21  g26(.a(x11), .b(x07), .c(x09), .O(new_n48_));
  ...
  and2   g32(.a(x13), .b(x04), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(x09), .O(new_n55_));
  nand2  g34(.a(new_n44_), .b(new_n36_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n27_), .c(x13), .O(new_n57_));
  ...
  nand2  g40(.a(new_n61_), .b(new_n57_), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(x07), .c(x04), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n55_), .c(new_n43_), .O(z3));
  and2   g43(.a(new_n24_), .b(x15), .O(new_n65_));
  nand4  g44(.a(new_n65_), .b(x14), .c(x10), .d(x08), .O(new_n66_));
  nor2   g45(.a(new_n66_), .b(new_n58_), .O(z4));
endmodule
