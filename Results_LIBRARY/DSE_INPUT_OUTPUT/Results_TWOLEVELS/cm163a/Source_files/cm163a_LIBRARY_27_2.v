...
module FAU ( 
  ...
  oai21  g17(.a(new_n38_), .b(new_n23_), .c(x05), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n22_), .O(new_n40_));
  aoi21  g19(.a(new_n24_), .b(x02), .c(new_n38_), .O(new_n41_));
  nor2   g20(.a(x04), .b(x01), .O(new_n42_));
  aoi21  g21(.a(new_n41_), .b(x04), .c(new_n42_), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n40_), .c(new_n37_), .O(z1));
  nand2  g23(.a(x04), .b(x02), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n38_), .c(new_n24_), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n34_), .b(x02), .c(new_n46_), .O(new_n52_));
  nor2   g31(.a(x06), .b(x04), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x04), .c(new_n53_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n51_), .c(new_n49_), .O(z2));
  nand3  g34(.a(new_n24_), .b(x04), .c(x02), .O(new_n56_));
  inv1   g35(.a(x13), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n46_), .c(new_n38_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(x05), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(x03), .O(new_n60_));
  oai21  g39(.a(new_n57_), .b(new_n23_), .c(x05), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n22_), .O(new_n62_));
  nand4  g41(.a(new_n46_), .b(new_n38_), .c(new_n24_), .d(x02), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(x13), .c(x04), .O(new_n64_));
  inv1   g43(.a(x07), .O(new_n65_));
  nand2  g44(.a(new_n65_), .b(new_n23_), .O(new_n66_));
  nand4  g45(.a(new_n66_), .b(new_n64_), .c(new_n62_), .d(new_n60_), .O(z3));
  nand4  g46(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n68_));
  aoi21  g47(.a(new_n68_), .b(x05), .c(new_n22_), .O(z4));
endmodule
