...
module FAU ( 
  ...
  nor2   g00(.a(x09), .b(x01), .O(new_n22_));
  ...
  nand4  g07(.a(new_n26_), .b(x03), .c(x02), .d(x01), .O(new_n29_));
  ...
  oai21  g13(.a(new_n26_), .b(new_n34_), .c(new_n33_), .O(new_n35_));
  ...
  nand3  g19(.a(new_n28_), .b(new_n38_), .c(new_n26_), .O(new_n41_));
  oai21  g20(.a(new_n40_), .b(new_n38_), .c(new_n41_), .O(new_n42_));
  ...
  nand2  g25(.a(new_n46_), .b(x01), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n34_), .c(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x09), .O(new_n50_));
  nand3  g29(.a(new_n48_), .b(new_n38_), .c(x04), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n27_), .c(x01), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(new_n26_), .O(new_n53_));
  nor2   g32(.a(new_n28_), .b(new_n48_), .O(new_n54_));
  nor2   g33(.a(x06), .b(x04), .O(new_n55_));
  aoi21  g34(.a(new_n54_), .b(x04), .c(new_n55_), .O(new_n56_));
  nand4  g35(.a(new_n56_), .b(new_n53_), .c(new_n50_), .d(new_n47_), .O(z2));
  oai21  g36(.a(x12), .b(x11), .c(x01), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(new_n26_), .c(x03), .d(x02), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(x13), .O(new_n60_));
  nor3   g39(.a(x13), .b(x12), .c(x11), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n40_), .O(new_n62_));
  nand2  g41(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(x04), .O(new_n64_));
  nor2   g43(.a(x07), .b(x04), .O(new_n65_));
  nor2   g44(.a(new_n65_), .b(new_n22_), .O(new_n66_));
  nand3  g45(.a(new_n66_), .b(new_n64_), .c(new_n37_), .O(z3));
