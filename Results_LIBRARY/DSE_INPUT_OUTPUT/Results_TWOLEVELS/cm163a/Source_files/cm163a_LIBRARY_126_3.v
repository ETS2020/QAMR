...
module FAU ( 
  ...
  nand3  g09(.a(x04), .b(x03), .c(x02), .O(new_n31_));
  ...
  nand2  g13(.a(x09), .b(x03), .O(new_n35_));
  oai21  g14(.a(x04), .b(x01), .c(x05), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  inv1   g16(.a(x02), .O(new_n38_));
  nand2  g17(.a(x11), .b(new_n38_), .O(new_n39_));
  inv1   g18(.a(x11), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(x03), .c(x02), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n39_), .c(x09), .O(new_n42_));
  nor2   g21(.a(new_n40_), .b(x03), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x04), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n37_), .O(z1));
  oai21  g24(.a(x06), .b(x04), .c(x05), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n35_), .O(new_n47_));
  oai21  g26(.a(x11), .b(new_n38_), .c(x12), .O(new_n48_));
  ...
  nor2   g30(.a(new_n49_), .b(x03), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x04), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n47_), .O(z2));
  oai21  g33(.a(x07), .b(x04), .c(x05), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n35_), .O(new_n56_));
  nand3  g35(.a(new_n49_), .b(new_n40_), .c(x02), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x13), .O(new_n58_));
  nor2   g37(.a(x13), .b(x12), .O(new_n59_));
  nand4  g38(.a(new_n59_), .b(new_n40_), .c(x03), .d(x02), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(x09), .O(new_n61_));
  inv1   g40(.a(x13), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(x03), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n61_), .c(x04), .O(new_n64_));
  nand2  g43(.a(new_n64_), .b(new_n56_), .O(z3));
  nand4  g44(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n66_));
  aoi21  g45(.a(new_n66_), .b(new_n23_), .c(new_n27_), .O(z4));
endmodule
