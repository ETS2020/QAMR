...
module FAU ( 
  ...
  nand3  g18(.a(x13), .b(x11), .c(x09), .O(new_n40_));
  ...
  nand2  g23(.a(new_n23_), .b(new_n44_), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n31_), .c(x13), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x09), .O(new_n48_));
  nand2  g27(.a(new_n38_), .b(x12), .O(new_n49_));
  nor2   g28(.a(x12), .b(x11), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n26_), .c(new_n24_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x04), .O(new_n53_));
  inv1   g32(.a(x06), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n31_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(new_n53_), .c(new_n48_), .d(new_n45_), .O(z2));
  inv1   g35(.a(x07), .O(new_n57_));
  nor2   g36(.a(x09), .b(x04), .O(new_n58_));
  nor2   g37(.a(new_n22_), .b(new_n24_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  nor3   g39(.a(x12), .b(x11), .c(x09), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n26_), .c(new_n22_), .O(new_n62_));
  nand3  g41(.a(new_n22_), .b(new_n46_), .c(new_n37_), .O(new_n63_));
  nor2   g42(.a(new_n63_), .b(new_n27_), .O(new_n64_));
  oai21  g43(.a(new_n64_), .b(new_n62_), .c(x04), .O(new_n65_));
  nand3  g44(.a(new_n65_), .b(new_n60_), .c(new_n45_), .O(z3));
  inv1   g45(.a(x03), .O(new_n67_));
  and2   g46(.a(new_n23_), .b(x15), .O(new_n68_));
