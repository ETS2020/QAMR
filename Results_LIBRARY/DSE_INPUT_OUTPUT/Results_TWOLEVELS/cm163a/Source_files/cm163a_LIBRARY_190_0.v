...
module FAU ( 
  ...
  nand2  g16(.a(x14), .b(new_n37_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(z1));
  and2   g18(.a(new_n33_), .b(x12), .O(new_n40_));
  nor3   g19(.a(x12), .b(x11), .c(x09), .O(new_n41_));
  and2   g20(.a(new_n41_), .b(new_n23_), .O(new_n42_));
  ...
  aoi21  g26(.a(new_n41_), .b(new_n23_), .c(new_n47_), .O(new_n48_));
  inv1   g27(.a(x12), .O(new_n49_));
  nand3  g28(.a(new_n47_), .b(new_n49_), .c(new_n32_), .O(new_n50_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(x14), .d(x05), .O(z4));
endmodule
