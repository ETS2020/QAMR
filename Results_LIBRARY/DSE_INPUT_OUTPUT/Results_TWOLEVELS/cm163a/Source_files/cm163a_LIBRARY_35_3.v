...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(new_n33_), .c(new_n40_), .O(new_n41_));
  inv1   g20(.a(x11), .O(new_n42_));
  nand3  g21(.a(new_n40_), .b(new_n42_), .c(new_n26_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n24_), .c(x04), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n41_), .c(new_n22_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x05), .O(z2));
  oai21  g25(.a(new_n43_), .b(new_n24_), .c(x13), .O(new_n47_));
  ...
  nor3   g37(.a(new_n58_), .b(new_n56_), .c(new_n48_), .O(z4));
endmodule
