...
module FAU ( 
  ...
  nand3  g10(.a(new_n31_), .b(new_n22_), .c(x03), .O(new_n32_));
  ...
  nand4  g15(.a(new_n36_), .b(new_n34_), .c(x05), .d(x02), .O(z1));
  nand2  g16(.a(new_n32_), .b(x12), .O(new_n38_));
  inv1   g17(.a(x12), .O(new_n39_));
  nand3  g18(.a(new_n25_), .b(new_n39_), .c(new_n31_), .O(new_n40_));
  ...
  nand4  g25(.a(new_n46_), .b(new_n39_), .c(new_n31_), .d(x03), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n22_), .O(new_n49_));
  nand2  g28(.a(new_n32_), .b(x13), .O(new_n50_));
