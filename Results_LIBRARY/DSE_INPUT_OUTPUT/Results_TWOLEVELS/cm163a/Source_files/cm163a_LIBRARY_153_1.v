...
module FAU ( 
  ...
  nand4  g26(.a(new_n47_), .b(new_n40_), .c(new_n32_), .d(x03), .O(new_n48_));
  ...
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(x02), .O(new_n54_));
  ...
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(x02), .O(z4));
endmodule
