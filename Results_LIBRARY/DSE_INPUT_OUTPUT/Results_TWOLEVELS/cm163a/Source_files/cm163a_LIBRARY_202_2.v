...
module FAU ( 
  ...
  nand2  g07(.a(x10), .b(x05), .O(new_n29_));
  ...
  inv1   g20(.a(x10), .O(new_n42_));
  nor2   g21(.a(x06), .b(x04), .O(new_n43_));
  nor3   g22(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(new_n44_));
  oai21  g23(.a(new_n40_), .b(new_n28_), .c(new_n44_), .O(z2));
