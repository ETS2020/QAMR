...
module FAU ( 
  ...
  oai21  g19(.a(new_n37_), .b(new_n28_), .c(new_n38_), .O(new_n41_));
  ...
  aoi21  g27(.a(new_n43_), .b(new_n23_), .c(new_n48_), .O(new_n49_));
  ...
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(new_n38_), .d(x05), .O(z4));
endmodule
