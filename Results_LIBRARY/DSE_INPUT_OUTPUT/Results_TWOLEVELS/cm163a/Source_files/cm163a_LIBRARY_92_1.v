...
module FAU ( 
  ...
  oai21  g12(.a(x09), .b(new_n33_), .c(new_n22_), .O(new_n34_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n44_), .c(new_n38_), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n29_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x04), .O(new_n62_));
  inv1   g41(.a(x07), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n33_), .O(new_n64_));
  nand4  g43(.a(new_n64_), .b(new_n62_), .c(new_n57_), .d(new_n36_), .O(z3));
