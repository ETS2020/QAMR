...
module FAU ( 
  ...
  oai21  g19(.a(new_n30_), .b(new_n22_), .c(new_n31_), .O(new_n41_));
  nand2  g20(.a(new_n36_), .b(x12), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n35_), .c(new_n25_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n23_), .c(new_n42_), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(x05), .c(x04), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n41_), .O(z2));
  oai21  g26(.a(new_n44_), .b(new_n23_), .c(x13), .O(new_n48_));
  ...
  nand2  g34(.a(new_n55_), .b(new_n32_), .O(z3));
  inv1   g35(.a(x15), .O(new_n57_));
  aoi21  g36(.a(x06), .b(new_n30_), .c(new_n57_), .O(new_n58_));
  nand4  g37(.a(new_n58_), .b(x14), .c(x10), .d(x08), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n49_), .O(z4));
endmodule
