...
module FAU ( 
  ...
  nand3  g14(.a(new_n25_), .b(new_n24_), .c(x04), .O(new_n36_));
  ...
  nand2  g19(.a(new_n30_), .b(new_n40_), .O(new_n41_));
  nand4  g20(.a(new_n41_), .b(new_n39_), .c(new_n38_), .d(new_n34_), .O(z1));
  oai21  g21(.a(x06), .b(x04), .c(x05), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n23_), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  nand2  g24(.a(new_n26_), .b(new_n35_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n22_), .c(new_n45_), .O(new_n47_));
  nand3  g26(.a(new_n35_), .b(new_n45_), .c(new_n22_), .O(new_n48_));
  ...
  nand2  g30(.a(x13), .b(x11), .O(new_n52_));
  oai21  g31(.a(new_n48_), .b(new_n26_), .c(new_n52_), .O(new_n53_));
  ...
  nand3  g36(.a(new_n57_), .b(new_n54_), .c(new_n34_), .O(z3));
