...
module FAU ( 
  ...
  nand4  g09(.a(new_n30_), .b(new_n27_), .c(x06), .d(x05), .O(z0));
  ...
  nand3  g19(.a(new_n40_), .b(new_n33_), .c(new_n22_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n23_), .c(new_n39_), .O(new_n42_));
  nand3  g21(.a(new_n42_), .b(x06), .c(x04), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x05), .O(z2));
  oai21  g23(.a(new_n41_), .b(new_n23_), .c(x13), .O(new_n45_));
