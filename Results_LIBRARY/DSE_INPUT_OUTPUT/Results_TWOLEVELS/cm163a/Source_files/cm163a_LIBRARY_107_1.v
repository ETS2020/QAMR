...
module FAU ( 
  ...
  oai21  g15(.a(new_n36_), .b(new_n35_), .c(x08), .O(new_n37_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n35_), .c(x08), .O(new_n47_));
  ...
  nor2   g30(.a(new_n39_), .b(new_n46_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x04), .O(new_n53_));
  inv1   g32(.a(x06), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n35_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(new_n53_), .c(new_n48_), .d(new_n34_), .O(z2));
  oai21  g35(.a(x07), .b(x04), .c(x05), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n23_), .O(new_n58_));
  nand2  g37(.a(new_n50_), .b(x13), .O(new_n59_));
  nor2   g38(.a(x13), .b(x12), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n39_), .c(new_n36_), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n59_), .c(x09), .O(new_n62_));
  nand3  g41(.a(x13), .b(x09), .c(x08), .O(new_n63_));
