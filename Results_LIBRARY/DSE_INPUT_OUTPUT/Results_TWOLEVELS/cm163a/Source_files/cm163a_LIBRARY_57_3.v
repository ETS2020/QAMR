...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(new_n25_), .c(new_n40_), .O(new_n41_));
  inv1   g20(.a(x11), .O(new_n42_));
  nand3  g21(.a(new_n40_), .b(new_n42_), .c(new_n23_), .O(new_n43_));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n47_), .c(new_n30_), .O(new_n52_));
