...
module FAU ( 
  ...
  nand2  g20(.a(new_n24_), .b(x12), .O(new_n42_));
  nor2   g21(.a(x12), .b(x11), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n23_), .c(new_n22_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n42_), .c(new_n28_), .O(new_n45_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n23_), .c(new_n49_), .O(new_n51_));
  nand3  g30(.a(new_n49_), .b(new_n39_), .c(new_n32_), .O(new_n52_));
  ...
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(x11), .d(x05), .O(z4));
endmodule
