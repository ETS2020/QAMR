...
module FAU ( 
  ...
  nand4  g08(.a(new_n29_), .b(new_n26_), .c(x06), .d(x05), .O(z0));
  ...
  nand3  g18(.a(new_n39_), .b(new_n23_), .c(new_n22_), .O(new_n40_));
  ...
  aoi22  g24(.a(new_n45_), .b(new_n44_), .c(new_n40_), .d(x13), .O(new_n46_));
  inv1   g25(.a(x05), .O(new_n47_));
  inv1   g26(.a(x06), .O(new_n48_));
  nor2   g27(.a(x07), .b(x04), .O(new_n49_));
  nor3   g28(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n50_));
  oai21  g29(.a(new_n46_), .b(new_n28_), .c(new_n50_), .O(z3));
  nand2  g30(.a(x08), .b(x03), .O(new_n52_));
  nand3  g31(.a(x15), .b(x14), .c(x10), .O(new_n53_));
  oai22  g32(.a(new_n53_), .b(new_n52_), .c(x06), .d(new_n47_), .O(z4));
endmodule
