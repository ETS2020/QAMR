...
module FAU ( 
  ...
  oai21  g24(.a(new_n26_), .b(new_n42_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  aoi21  g26(.a(x11), .b(x06), .c(x09), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n28_), .c(new_n47_), .O(new_n49_));
  nand3  g28(.a(new_n47_), .b(new_n35_), .c(new_n26_), .O(new_n50_));
  ...
  nand3  g42(.a(new_n63_), .b(new_n61_), .c(new_n34_), .O(z3));
  inv1   g43(.a(x03), .O(new_n65_));
  inv1   g44(.a(x15), .O(new_n66_));
  nor2   g45(.a(new_n22_), .b(new_n66_), .O(new_n67_));
