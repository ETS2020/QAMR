...
module FAU ( 
  ...
  nor3   g07(.a(new_n28_), .b(x11), .c(new_n27_), .O(new_n29_));
  ...
  nand3  g13(.a(new_n23_), .b(new_n22_), .c(x04), .O(new_n35_));
  nand4  g14(.a(new_n35_), .b(new_n34_), .c(new_n31_), .d(x05), .O(z1));
  nand2  g15(.a(new_n24_), .b(x12), .O(new_n37_));
  nor2   g16(.a(x12), .b(x09), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n23_), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n37_), .c(new_n33_), .O(new_n40_));
  nor2   g19(.a(x06), .b(x04), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(new_n31_), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(x05), .O(z2));
  nor3   g22(.a(x13), .b(x12), .c(x09), .O(new_n44_));
  aoi22  g23(.a(new_n44_), .b(new_n23_), .c(new_n39_), .d(x13), .O(new_n45_));
  nor2   g24(.a(x07), .b(x04), .O(new_n46_));
  nor3   g25(.a(new_n46_), .b(x11), .c(new_n27_), .O(new_n47_));
  oai21  g26(.a(new_n45_), .b(new_n33_), .c(new_n47_), .O(z3));
  nand2  g27(.a(x08), .b(x03), .O(new_n49_));
  nand3  g28(.a(x15), .b(x14), .c(x10), .O(new_n50_));
  oai22  g29(.a(new_n50_), .b(new_n49_), .c(new_n31_), .d(new_n27_), .O(z4));
endmodule
