...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(x00), .O(new_n23_));
  nand2  g02(.a(new_n23_), .b(new_n22_), .O(new_n24_));
  inv1   g03(.a(x05), .O(new_n25_));
  oai21  g04(.a(x12), .b(x04), .c(new_n25_), .O(new_n26_));
  ...
  nand3  g10(.a(new_n31_), .b(new_n26_), .c(new_n24_), .O(z0));
  nand2  g11(.a(new_n29_), .b(x11), .O(new_n33_));
  nor2   g12(.a(x11), .b(x09), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(new_n28_), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n33_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(x04), .O(new_n37_));
  inv1   g16(.a(x01), .O(new_n38_));
  nand3  g17(.a(x12), .b(new_n22_), .c(new_n38_), .O(new_n39_));
  nand3  g18(.a(new_n39_), .b(new_n37_), .c(new_n26_), .O(z1));
  ...
  nand4  g24(.a(new_n28_), .b(new_n45_), .c(new_n44_), .d(new_n27_), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n43_), .c(new_n42_), .d(new_n26_), .O(z2));
  nor2   g26(.a(x07), .b(x04), .O(new_n48_));
  inv1   g27(.a(x13), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n48_), .c(x12), .O(new_n51_));
  aoi21  g30(.a(new_n34_), .b(new_n28_), .c(new_n49_), .O(new_n52_));
  nand3  g31(.a(new_n49_), .b(new_n45_), .c(new_n44_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n29_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n52_), .c(x04), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(new_n51_), .c(new_n26_), .O(z3));
  inv1   g35(.a(x03), .O(new_n57_));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n45_), .b(new_n22_), .c(new_n58_), .O(new_n59_));
