...
module FAU ( 
  ...
  aoi21  g20(.a(new_n33_), .b(new_n32_), .c(new_n41_), .O(new_n42_));
  inv1   g21(.a(x11), .O(new_n43_));
  nand3  g22(.a(new_n41_), .b(new_n43_), .c(new_n24_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n22_), .c(x05), .O(new_n45_));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n32_), .c(new_n50_), .O(new_n52_));
  ...
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x05), .d(x04), .O(z4));
endmodule
