...
module FAU ( 
  ...
  nor4   g17(.a(new_n24_), .b(x15), .c(x11), .d(x09), .O(new_n39_));
  ...
  nand3  g26(.a(new_n25_), .b(new_n35_), .c(new_n22_), .O(new_n48_));
  ...
  nand4  g35(.a(new_n56_), .b(new_n35_), .c(x03), .d(x02), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n36_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n22_), .c(new_n55_), .O(new_n59_));
  nand3  g38(.a(new_n44_), .b(new_n36_), .c(new_n55_), .O(new_n60_));
  ...
  nand4  g43(.a(x10), .b(x09), .c(x08), .d(x03), .O(new_n65_));
  nor3   g44(.a(new_n65_), .b(new_n36_), .c(new_n64_), .O(z4));
endmodule
