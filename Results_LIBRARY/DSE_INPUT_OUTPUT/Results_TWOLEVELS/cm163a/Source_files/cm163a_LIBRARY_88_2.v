...
module FAU ( 
  ...
  oai21  g07(.a(new_n28_), .b(new_n27_), .c(x14), .O(new_n29_));
  ...
  nand2  g14(.a(x14), .b(x05), .O(new_n36_));
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x14), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z2));
  inv1   g24(.a(new_n26_), .O(new_n46_));
  oai21  g25(.a(x12), .b(x11), .c(x14), .O(new_n47_));
  ...
  oai21  g30(.a(x07), .b(x04), .c(x14), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n51_), .O(new_n53_));
