...
module FAU ( 
  ...
  nand2  g13(.a(new_n34_), .b(x09), .O(new_n35_));
  nand4  g14(.a(new_n35_), .b(new_n33_), .c(x03), .d(x02), .O(new_n36_));
  ...
  nand3  g21(.a(new_n33_), .b(x03), .c(x02), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(x12), .O(new_n44_));
  nand3  g23(.a(new_n34_), .b(new_n33_), .c(new_n25_), .O(new_n45_));
  ...
  nand4  g33(.a(new_n54_), .b(new_n25_), .c(x03), .d(x02), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n53_), .c(x12), .O(new_n56_));
  nand4  g35(.a(new_n34_), .b(new_n33_), .c(x03), .d(x02), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(x13), .c(new_n25_), .O(new_n58_));
  inv1   g37(.a(new_n58_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n56_), .c(x04), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n52_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand3  g41(.a(x15), .b(x14), .c(x10), .O(new_n63_));
  oai21  g42(.a(new_n63_), .b(new_n62_), .c(new_n22_), .O(z4));
endmodule
