...
module FAU ( 
  ...
  nand2  g16(.a(x12), .b(x11), .O(new_n38_));
  inv1   g17(.a(x11), .O(new_n39_));
  inv1   g18(.a(x12), .O(new_n40_));
  nand4  g19(.a(new_n40_), .b(new_n39_), .c(new_n22_), .d(x02), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n38_), .c(new_n37_), .O(new_n42_));
  nand3  g21(.a(new_n24_), .b(x12), .c(x05), .O(new_n43_));
  inv1   g22(.a(new_n43_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n42_), .c(x04), .O(new_n45_));
  nor2   g24(.a(x06), .b(new_n29_), .O(new_n46_));
  aoi22  g25(.a(new_n46_), .b(new_n28_), .c(new_n29_), .d(x03), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n45_), .O(z2));
  inv1   g27(.a(new_n24_), .O(new_n49_));
  nor2   g28(.a(x12), .b(x11), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n23_), .c(new_n22_), .O(new_n51_));
