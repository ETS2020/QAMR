...
module FAU ( 
  ...
  nand3  g17(.a(new_n25_), .b(x11), .c(x04), .O(new_n39_));
  inv1   g18(.a(x01), .O(new_n40_));
  nand2  g19(.a(new_n29_), .b(new_n40_), .O(new_n41_));
  nand4  g20(.a(new_n41_), .b(new_n39_), .c(new_n38_), .d(new_n33_), .O(z1));
  ...
  nand3  g28(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(z2));
  ...
  oai21  g33(.a(new_n54_), .b(new_n51_), .c(new_n34_), .O(new_n55_));
  ...
  nand4  g38(.a(new_n59_), .b(new_n57_), .c(new_n56_), .d(new_n33_), .O(z3));
