...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(new_n31_), .O(new_n32_));
  ...
  aoi21  g18(.a(new_n22_), .b(new_n39_), .c(new_n31_), .O(new_n40_));
  oai21  g19(.a(new_n38_), .b(new_n22_), .c(new_n40_), .O(z1));
  nand2  g20(.a(new_n36_), .b(x12), .O(new_n42_));
  nor2   g21(.a(x12), .b(x11), .O(new_n43_));
  nand4  g22(.a(new_n43_), .b(new_n34_), .c(x03), .d(x02), .O(new_n44_));
  ...
  nand2  g26(.a(new_n47_), .b(new_n32_), .O(z2));
  inv1   g27(.a(x12), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n35_), .c(new_n34_), .O(new_n50_));
  ...
  nand2  g35(.a(new_n56_), .b(new_n32_), .O(z3));
