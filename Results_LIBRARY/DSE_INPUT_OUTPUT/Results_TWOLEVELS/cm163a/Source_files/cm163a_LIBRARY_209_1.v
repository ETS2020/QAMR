...
module FAU ( 
  ...
  nand3  g20(.a(new_n41_), .b(new_n33_), .c(new_n24_), .O(new_n42_));
  ...
  oai21  g26(.a(new_n29_), .b(new_n22_), .c(new_n38_), .O(new_n48_));
  ...
  aoi21  g35(.a(x07), .b(new_n29_), .c(new_n56_), .O(new_n57_));
