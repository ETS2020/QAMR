...
module FAU ( 
  ...
  aoi21  g16(.a(new_n37_), .b(new_n32_), .c(new_n28_), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n24_), .c(x13), .O(new_n39_));
  ...
  oai22  g25(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(x04), .O(z4));
endmodule
