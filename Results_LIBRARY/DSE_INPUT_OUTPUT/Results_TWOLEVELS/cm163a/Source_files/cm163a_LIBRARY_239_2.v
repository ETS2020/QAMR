...
module FAU ( 
  ...
  aoi22  g20(.a(new_n41_), .b(new_n26_), .c(new_n40_), .d(x12), .O(new_n42_));
  inv1   g21(.a(x05), .O(new_n43_));
  inv1   g22(.a(x06), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n22_), .c(new_n43_), .O(new_n45_));
  oai21  g24(.a(new_n42_), .b(new_n22_), .c(new_n45_), .O(z2));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n22_), .c(new_n43_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n22_), .c(new_n53_), .O(z3));
  inv1   g33(.a(x03), .O(new_n55_));
  inv1   g34(.a(x15), .O(new_n56_));
  aoi21  g35(.a(new_n43_), .b(x04), .c(new_n56_), .O(new_n57_));
