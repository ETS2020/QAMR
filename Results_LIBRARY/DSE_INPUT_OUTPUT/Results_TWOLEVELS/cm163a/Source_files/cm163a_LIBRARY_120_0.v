...
module FAU ( 
  ...
  nor3   g18(.a(new_n22_), .b(x11), .c(x09), .O(new_n40_));
  nand4  g19(.a(new_n40_), .b(x04), .c(x03), .d(x02), .O(new_n41_));
  ...
  aoi21  g25(.a(new_n46_), .b(new_n45_), .c(x12), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(new_n44_), .c(new_n34_), .d(x03), .O(new_n48_));
  nand2  g27(.a(new_n44_), .b(new_n34_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n24_), .c(x12), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n43_), .c(new_n50_), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x04), .O(new_n52_));
  inv1   g31(.a(x06), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  nand4  g33(.a(new_n54_), .b(new_n52_), .c(new_n23_), .d(x05), .O(z2));
  ...
  nand3  g38(.a(x15), .b(new_n45_), .c(new_n59_), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n44_), .O(new_n62_));
  nand2  g41(.a(x13), .b(x11), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand4  g43(.a(new_n64_), .b(new_n34_), .c(x03), .d(x02), .O(new_n65_));
  nand2  g44(.a(new_n35_), .b(x13), .O(new_n66_));
  nand2  g45(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g46(.a(new_n67_), .b(x04), .O(new_n68_));
  nand2  g47(.a(new_n68_), .b(new_n57_), .O(z3));
  nand2  g48(.a(x08), .b(x03), .O(new_n70_));
  nand3  g49(.a(x15), .b(x14), .c(x10), .O(new_n71_));
  oai21  g50(.a(new_n71_), .b(new_n70_), .c(new_n23_), .O(z4));
endmodule
