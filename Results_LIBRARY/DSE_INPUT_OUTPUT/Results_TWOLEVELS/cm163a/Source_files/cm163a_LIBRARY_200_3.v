...
module FAU ( 
  ...
  nand2  g00(.a(x09), .b(x08), .O(new_n22_));
  ...
  nor3   g17(.a(new_n36_), .b(new_n28_), .c(x08), .O(new_n39_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n25_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x09), .O(new_n47_));
  nand2  g26(.a(x12), .b(x11), .O(new_n48_));
  nand4  g27(.a(new_n45_), .b(new_n36_), .c(x03), .d(x02), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n48_), .c(x09), .O(new_n50_));
  aoi21  g29(.a(x03), .b(x02), .c(new_n45_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n50_), .c(x04), .O(new_n52_));
  inv1   g31(.a(x06), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n44_), .O(new_n54_));
  nand4  g33(.a(new_n54_), .b(new_n52_), .c(new_n47_), .d(new_n43_), .O(z2));
  inv1   g34(.a(x13), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n44_), .c(new_n25_), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x09), .O(new_n58_));
  nand2  g37(.a(x13), .b(x11), .O(new_n59_));
  nor2   g38(.a(x13), .b(x12), .O(new_n60_));
  nand4  g39(.a(new_n60_), .b(new_n36_), .c(x03), .d(x02), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n59_), .c(x09), .O(new_n62_));
  inv1   g41(.a(x03), .O(new_n63_));
  nor2   g42(.a(x12), .b(new_n63_), .O(new_n64_));
  aoi21  g43(.a(new_n64_), .b(x02), .c(new_n56_), .O(new_n65_));
  oai21  g44(.a(new_n65_), .b(new_n62_), .c(x04), .O(new_n66_));
  inv1   g45(.a(x07), .O(new_n67_));
  nand2  g46(.a(new_n67_), .b(new_n44_), .O(new_n68_));
  nand4  g47(.a(new_n68_), .b(new_n66_), .c(new_n58_), .d(new_n43_), .O(z3));
  nand4  g48(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n70_));
  aoi21  g49(.a(new_n70_), .b(new_n28_), .c(new_n25_), .O(z4));
endmodule
