...
module FAU ( 
  ...
  nand3  g15(.a(new_n36_), .b(x04), .c(x01), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(x05), .O(z1));
  nand2  g17(.a(new_n35_), .b(x12), .O(new_n39_));
  ...
  nand3  g25(.a(new_n46_), .b(new_n34_), .c(new_n33_), .O(new_n47_));
  ...
  oai22  g36(.a(new_n57_), .b(new_n56_), .c(new_n55_), .d(x01), .O(z4));
endmodule
