...
module FAU ( 
  ...
  nand2  g36(.a(new_n24_), .b(new_n48_), .O(new_n58_));
  nor2   g37(.a(x13), .b(x12), .O(new_n59_));
  nand3  g38(.a(x15), .b(x13), .c(x12), .O(new_n60_));
  inv1   g39(.a(new_n60_), .O(new_n61_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(new_n33_), .O(new_n62_));
  nand3  g41(.a(x15), .b(x13), .c(x11), .O(new_n63_));
  nand2  g42(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand4  g43(.a(new_n64_), .b(new_n32_), .c(x03), .d(x02), .O(new_n65_));
  nand2  g44(.a(new_n39_), .b(x13), .O(new_n66_));
  nand2  g45(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g46(.a(new_n67_), .b(x04), .O(new_n68_));
  inv1   g47(.a(x07), .O(new_n69_));
  aoi22  g48(.a(new_n23_), .b(x13), .c(new_n69_), .d(new_n28_), .O(new_n70_));
  nand3  g49(.a(new_n70_), .b(new_n68_), .c(new_n58_), .O(z3));
  nand2  g50(.a(x08), .b(x03), .O(new_n72_));
  nand3  g51(.a(x15), .b(x14), .c(x10), .O(new_n73_));
  oai21  g52(.a(new_n73_), .b(new_n72_), .c(new_n24_), .O(z4));
endmodule
