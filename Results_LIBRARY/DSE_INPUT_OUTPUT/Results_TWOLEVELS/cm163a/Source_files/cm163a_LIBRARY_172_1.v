...
module FAU ( 
  ...
  nand3  g10(.a(new_n31_), .b(new_n30_), .c(x03), .O(new_n32_));
  aoi21  g11(.a(new_n32_), .b(new_n29_), .c(new_n27_), .O(new_n33_));
  nor2   g12(.a(x04), .b(x01), .O(new_n34_));
  oai21  g13(.a(new_n34_), .b(new_n33_), .c(x02), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x05), .O(z1));
  inv1   g15(.a(x12), .O(new_n37_));
  aoi21  g16(.a(x11), .b(x02), .c(x09), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(x03), .c(new_n37_), .O(new_n39_));
  nand4  g18(.a(new_n37_), .b(new_n31_), .c(new_n30_), .d(x03), .O(new_n40_));
  ...
  nor3   g23(.a(new_n44_), .b(new_n43_), .c(new_n22_), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(new_n42_), .O(z2));
  nand2  g25(.a(x13), .b(x12), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  nand4  g27(.a(new_n48_), .b(new_n37_), .c(new_n31_), .d(x03), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n30_), .O(new_n51_));
  nand2  g30(.a(new_n32_), .b(x13), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n51_), .c(new_n27_), .O(new_n53_));
  nor2   g32(.a(x07), .b(x04), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(x02), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(x05), .O(z3));
  nand2  g35(.a(x08), .b(x03), .O(new_n57_));
  nand3  g36(.a(x15), .b(x14), .c(x10), .O(new_n58_));
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(new_n43_), .d(x02), .O(z4));
endmodule
