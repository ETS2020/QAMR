...
module FAU ( 
  ...
  inv1   g13(.a(new_n25_), .O(new_n35_));
  nor2   g14(.a(x11), .b(x09), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n34_), .c(x05), .O(new_n38_));
  ...
  oai21  g30(.a(new_n46_), .b(new_n25_), .c(x13), .O(new_n52_));
  ...
  oai22  g40(.a(new_n61_), .b(new_n60_), .c(x05), .d(new_n22_), .O(z4));
endmodule
