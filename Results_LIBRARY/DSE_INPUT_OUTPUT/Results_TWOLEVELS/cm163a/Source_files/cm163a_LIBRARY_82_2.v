...
module FAU ( 
  ...
  aoi22  g11(.a(new_n32_), .b(new_n27_), .c(new_n28_), .d(x11), .O(new_n33_));
  ...
  aoi21  g17(.a(x11), .b(x05), .c(x09), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n27_), .c(new_n38_), .O(new_n40_));
  inv1   g19(.a(x11), .O(new_n41_));
  nand3  g20(.a(new_n38_), .b(new_n41_), .c(new_n25_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n26_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n40_), .c(x04), .O(new_n44_));
  inv1   g23(.a(x06), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n35_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n44_), .O(z2));
  nand2  g26(.a(x07), .b(x05), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n22_), .O(new_n49_));
  oai21  g28(.a(new_n42_), .b(new_n26_), .c(x13), .O(new_n50_));
  ...
  nand2  g33(.a(new_n54_), .b(new_n50_), .O(new_n55_));
  nand3  g34(.a(new_n55_), .b(x05), .c(x04), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n49_), .O(z3));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n35_), .b(x04), .c(new_n58_), .O(new_n59_));
  nand4  g38(.a(new_n59_), .b(x14), .c(x10), .d(x08), .O(new_n60_));
  nor2   g39(.a(new_n60_), .b(new_n51_), .O(z4));
endmodule
