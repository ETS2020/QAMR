...
module FAU ( 
  ...
  oai21  g16(.a(new_n37_), .b(new_n22_), .c(new_n33_), .O(z1));
  ...
  nand4  g21(.a(new_n27_), .b(new_n42_), .c(new_n34_), .d(new_n25_), .O(new_n43_));
  ...
  nand3  g27(.a(new_n42_), .b(new_n34_), .c(new_n25_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n26_), .c(x13), .O(new_n50_));
