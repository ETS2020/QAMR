...
module FAU ( 
  ...
  aoi21  g16(.a(new_n37_), .b(new_n35_), .c(new_n31_), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n34_), .c(new_n23_), .O(new_n39_));
  inv1   g18(.a(x15), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n31_), .c(new_n22_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n39_), .O(z1));
  inv1   g21(.a(new_n23_), .O(new_n43_));
  ...
  aoi21  g29(.a(new_n50_), .b(new_n31_), .c(new_n34_), .O(new_n51_));
  ...
  aoi21  g38(.a(new_n59_), .b(new_n31_), .c(new_n34_), .O(new_n60_));
  aoi21  g39(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(z3));
  nand4  g40(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(x01), .c(new_n40_), .O(z4));
endmodule
