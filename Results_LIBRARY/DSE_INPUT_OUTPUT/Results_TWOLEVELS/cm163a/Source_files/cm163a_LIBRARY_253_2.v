...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n38_, new_n39_, new_n41_, new_n42_, new_n43_, new_n45_;
  ...
  nand4  g18(.a(new_n39_), .b(new_n38_), .c(new_n32_), .d(x05), .O(z2));
  inv1   g19(.a(new_n32_), .O(new_n41_));
  nor2   g20(.a(x07), .b(x04), .O(new_n42_));
  aoi21  g21(.a(x13), .b(x04), .c(new_n42_), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(x05), .c(new_n41_), .O(z3));
  nand4  g23(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(x09), .c(new_n22_), .O(z4));
endmodule
