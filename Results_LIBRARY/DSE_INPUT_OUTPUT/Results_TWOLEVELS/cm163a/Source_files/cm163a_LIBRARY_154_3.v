...
module FAU ( 
  ...
  nor3   g22(.a(new_n43_), .b(x15), .c(new_n42_), .O(new_n44_));
  ...
  nor3   g30(.a(new_n51_), .b(x15), .c(new_n42_), .O(new_n52_));
  oai21  g31(.a(new_n50_), .b(new_n32_), .c(new_n52_), .O(z3));
  nand4  g32(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n42_), .c(new_n28_), .O(z4));
endmodule
