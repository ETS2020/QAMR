...
module FAU ( 
  ...
  nor2   g12(.a(new_n25_), .b(new_n33_), .O(new_n34_));
  ...
  nand3  g22(.a(new_n43_), .b(new_n27_), .c(x03), .O(new_n44_));
  ...
  nand4  g32(.a(new_n53_), .b(new_n27_), .c(x03), .d(x02), .O(new_n54_));
  ...
  aoi21  g36(.a(new_n57_), .b(new_n24_), .c(new_n22_), .O(new_n58_));
  oai21  g37(.a(new_n56_), .b(new_n24_), .c(new_n58_), .O(z3));
  inv1   g38(.a(x15), .O(new_n60_));
  aoi21  g39(.a(new_n22_), .b(x02), .c(new_n60_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(x14), .c(x10), .d(x08), .O(new_n62_));
  nor2   g41(.a(new_n62_), .b(new_n25_), .O(z4));
endmodule
