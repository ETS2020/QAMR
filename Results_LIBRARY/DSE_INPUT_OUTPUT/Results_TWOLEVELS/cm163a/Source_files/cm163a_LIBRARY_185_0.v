...
module FAU ( 
  ...
  oai21  g28(.a(new_n49_), .b(new_n28_), .c(x05), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n26_), .O(new_n51_));
  aoi21  g30(.a(new_n35_), .b(x03), .c(new_n49_), .O(new_n52_));
  nor2   g31(.a(x06), .b(x04), .O(new_n53_));
  aoi21  g32(.a(new_n52_), .b(x04), .c(new_n53_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n51_), .c(new_n48_), .O(z2));
  inv1   g34(.a(x11), .O(new_n56_));
  inv1   g35(.a(x13), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n49_), .c(new_n56_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n23_), .c(x05), .O(new_n59_));
  nand2  g38(.a(new_n59_), .b(x02), .O(new_n60_));
  ...
  nand2  g44(.a(new_n65_), .b(x05), .O(new_n66_));
  nand2  g45(.a(new_n66_), .b(new_n60_), .O(z3));
  nand2  g46(.a(x08), .b(x03), .O(new_n68_));
  nand3  g47(.a(x15), .b(x14), .c(x10), .O(new_n69_));
  oai22  g48(.a(new_n69_), .b(new_n68_), .c(x05), .d(x02), .O(z4));
endmodule
