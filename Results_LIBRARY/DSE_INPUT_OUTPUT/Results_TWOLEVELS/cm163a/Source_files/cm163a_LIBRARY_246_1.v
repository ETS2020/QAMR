...
module FAU ( 
  ...
  nand2  g11(.a(x13), .b(new_n22_), .O(new_n33_));
  ...
  nand4  g23(.a(new_n44_), .b(new_n23_), .c(x03), .d(x02), .O(new_n45_));
  ...
  nand4  g28(.a(new_n49_), .b(new_n47_), .c(new_n33_), .d(x05), .O(z2));
  oai21  g29(.a(x07), .b(x04), .c(x05), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(new_n33_), .O(new_n52_));
  nand3  g31(.a(new_n45_), .b(x13), .c(x10), .O(new_n53_));
  inv1   g32(.a(new_n25_), .O(new_n54_));
  nor3   g33(.a(x13), .b(x12), .c(x11), .O(new_n55_));
  nand2  g34(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n53_), .O(new_n57_));
  ...
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n33_), .O(z4));
endmodule
