...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(new_n28_), .O(new_n29_));
  ...
  nand2  g32(.a(new_n53_), .b(new_n33_), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n29_), .c(x05), .O(new_n55_));
  inv1   g34(.a(new_n55_), .O(new_n56_));
  oai21  g35(.a(new_n52_), .b(new_n33_), .c(new_n56_), .O(z3));
