...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x08), .O(new_n23_));
  ...
  oai21  g13(.a(new_n34_), .b(x08), .c(x13), .O(new_n35_));
  ...
  inv1   g26(.a(new_n23_), .O(new_n48_));
  inv1   g27(.a(new_n24_), .O(new_n49_));
  nor2   g28(.a(x11), .b(x09), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n49_), .c(new_n33_), .O(new_n51_));
  nor4   g30(.a(new_n24_), .b(x12), .c(x11), .d(x09), .O(new_n52_));
  ...
  nand3  g40(.a(new_n61_), .b(new_n33_), .c(new_n32_), .O(new_n62_));
  oai21  g41(.a(new_n60_), .b(x08), .c(new_n62_), .O(new_n63_));
  nand4  g42(.a(new_n63_), .b(new_n31_), .c(x03), .d(x02), .O(new_n64_));
  nand3  g43(.a(new_n38_), .b(x13), .c(new_n43_), .O(new_n65_));
  nand2  g44(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g45(.a(new_n66_), .b(x04), .O(new_n67_));
  nand2  g46(.a(new_n67_), .b(new_n59_), .O(z3));
  nand3  g47(.a(x10), .b(x08), .c(x03), .O(new_n69_));
  inv1   g48(.a(new_n69_), .O(new_n70_));
  nand4  g49(.a(new_n70_), .b(x15), .c(x14), .d(new_n61_), .O(new_n71_));
  inv1   g50(.a(new_n71_), .O(z4));
endmodule
