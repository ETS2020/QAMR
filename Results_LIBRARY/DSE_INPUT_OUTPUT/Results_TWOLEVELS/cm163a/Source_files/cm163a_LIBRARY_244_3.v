...
module FAU ( 
  ...
  inv1   g24(.a(new_n25_), .O(new_n46_));
  ...
  nor3   g29(.a(new_n50_), .b(x14), .c(new_n49_), .O(new_n51_));
  oai21  g30(.a(new_n48_), .b(new_n29_), .c(new_n51_), .O(z3));
  inv1   g31(.a(x15), .O(new_n53_));
  nand4  g32(.a(x10), .b(x08), .c(new_n49_), .d(x03), .O(new_n54_));
  nor3   g33(.a(new_n54_), .b(new_n53_), .c(new_n22_), .O(z4));
endmodule
