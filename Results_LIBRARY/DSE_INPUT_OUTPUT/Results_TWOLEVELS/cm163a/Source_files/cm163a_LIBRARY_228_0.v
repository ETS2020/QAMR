...
module FAU ( 
  ...
  nand4  g10(.a(new_n31_), .b(new_n28_), .c(new_n24_), .d(x05), .O(z0));
  ...
  nand3  g28(.a(new_n49_), .b(new_n25_), .c(new_n23_), .O(new_n50_));
  ...
  oai21  g35(.a(new_n56_), .b(new_n54_), .c(x06), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(new_n23_), .O(new_n58_));
  nand3  g37(.a(new_n50_), .b(x13), .c(x04), .O(new_n59_));
  inv1   g38(.a(x07), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n30_), .O(new_n61_));
  nand4  g40(.a(new_n61_), .b(new_n59_), .c(new_n58_), .d(new_n34_), .O(z3));
