...
module FAU ( 
  ...
  aoi21  g20(.a(new_n36_), .b(new_n28_), .c(new_n41_), .O(new_n42_));
  nand2  g21(.a(x03), .b(x02), .O(new_n43_));
  inv1   g22(.a(x11), .O(new_n44_));
  nand3  g23(.a(new_n41_), .b(new_n44_), .c(new_n27_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n42_), .c(x04), .O(new_n47_));
  inv1   g26(.a(x06), .O(new_n48_));
  nand3  g27(.a(x12), .b(new_n48_), .c(new_n22_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n47_), .c(new_n26_), .O(z2));
  inv1   g29(.a(x13), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n41_), .c(x05), .O(new_n52_));
  nand2  g31(.a(new_n52_), .b(x04), .O(new_n53_));
  nand2  g32(.a(x12), .b(x07), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n22_), .O(new_n55_));
  aoi21  g34(.a(new_n36_), .b(new_n28_), .c(new_n51_), .O(new_n56_));
  nand3  g35(.a(new_n51_), .b(new_n44_), .c(new_n27_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n43_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(new_n41_), .O(new_n59_));
  nand2  g38(.a(x12), .b(new_n25_), .O(new_n60_));
  nand4  g39(.a(new_n60_), .b(new_n59_), .c(new_n55_), .d(new_n53_), .O(z3));
  nand2  g40(.a(x08), .b(x03), .O(new_n62_));
  nand3  g41(.a(x15), .b(x14), .c(x10), .O(new_n63_));
  oai22  g42(.a(new_n63_), .b(new_n62_), .c(x12), .d(x04), .O(z4));
endmodule
