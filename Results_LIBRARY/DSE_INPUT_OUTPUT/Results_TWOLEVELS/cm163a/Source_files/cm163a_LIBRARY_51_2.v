...
module FAU ( 
  ...
  aoi21  g12(.a(new_n22_), .b(new_n33_), .c(new_n23_), .O(new_n34_));
  oai21  g13(.a(new_n32_), .b(new_n22_), .c(new_n34_), .O(z1));
  aoi21  g14(.a(x11), .b(x05), .c(x09), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n26_), .O(new_n37_));
  nor3   g16(.a(x12), .b(x11), .c(x09), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n26_), .c(new_n37_), .d(x12), .O(new_n39_));
  ...
  oai21  g22(.a(x12), .b(x11), .c(x05), .O(new_n44_));
