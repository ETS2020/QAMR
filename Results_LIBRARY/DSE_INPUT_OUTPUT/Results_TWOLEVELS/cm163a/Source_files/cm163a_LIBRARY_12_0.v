...
module FAU ( 
  ...
  oai21  g06(.a(new_n22_), .b(new_n27_), .c(x09), .O(new_n28_));
  ...
  nand2  g13(.a(x11), .b(new_n27_), .O(new_n35_));
  inv1   g14(.a(x11), .O(new_n36_));
  nand3  g15(.a(new_n36_), .b(new_n23_), .c(x02), .O(new_n37_));
  ...
  nand2  g21(.a(new_n42_), .b(new_n24_), .O(new_n43_));
  oai21  g22(.a(x11), .b(new_n27_), .c(x12), .O(new_n44_));
  inv1   g23(.a(x12), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n36_), .c(new_n23_), .d(x02), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(new_n22_), .O(new_n47_));
  nor2   g26(.a(new_n45_), .b(new_n23_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n47_), .c(x04), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n43_), .O(z2));
  inv1   g29(.a(x05), .O(new_n51_));
  nand2  g30(.a(new_n24_), .b(new_n51_), .O(new_n52_));
  inv1   g31(.a(x13), .O(new_n53_));
  nor2   g32(.a(x09), .b(new_n27_), .O(new_n54_));
  oai21  g33(.a(x12), .b(x11), .c(x03), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(new_n56_));
  nand2  g35(.a(new_n23_), .b(x02), .O(new_n57_));
  nand3  g36(.a(new_n53_), .b(new_n45_), .c(new_n36_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n56_), .c(x04), .O(new_n60_));
  nor2   g39(.a(x07), .b(x04), .O(new_n61_));
  aoi21  g40(.a(new_n23_), .b(new_n22_), .c(new_n61_), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n60_), .c(new_n52_), .O(z3));
