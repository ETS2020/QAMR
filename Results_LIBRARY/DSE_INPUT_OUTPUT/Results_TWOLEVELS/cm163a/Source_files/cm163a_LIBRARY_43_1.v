...
module FAU ( 
  ...
  nand3  g08(.a(x11), .b(x09), .c(x04), .O(new_n30_));
  oai21  g09(.a(x04), .b(x01), .c(new_n30_), .O(new_n31_));
  ...
  oai21  g16(.a(new_n37_), .b(new_n33_), .c(new_n25_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n32_), .O(z1));
  nand3  g18(.a(x12), .b(x09), .c(x04), .O(new_n40_));
  oai21  g19(.a(x06), .b(x04), .c(new_n40_), .O(new_n41_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n33_), .c(new_n25_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n42_), .O(z2));
  nand3  g27(.a(x13), .b(x09), .c(x04), .O(new_n49_));
  ...
  nand4  g32(.a(new_n53_), .b(new_n35_), .c(x03), .d(x02), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n52_), .c(new_n22_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n33_), .c(new_n25_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n51_), .O(z3));
  inv1   g36(.a(x03), .O(new_n58_));
  inv1   g37(.a(x15), .O(new_n59_));
  aoi21  g38(.a(x09), .b(new_n33_), .c(new_n59_), .O(new_n60_));
