...
module FAU ( 
  ...
  inv1   g07(.a(new_n26_), .O(new_n29_));
  nand3  g08(.a(new_n29_), .b(new_n28_), .c(new_n22_), .O(new_n30_));
  ...
  nand2  g13(.a(x11), .b(x09), .O(new_n35_));
  oai21  g14(.a(x11), .b(x04), .c(new_n35_), .O(new_n36_));
  nand2  g15(.a(new_n36_), .b(new_n34_), .O(new_n37_));
  nand2  g16(.a(new_n35_), .b(new_n30_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(x04), .O(new_n39_));
  inv1   g18(.a(x05), .O(new_n40_));
  nand2  g19(.a(new_n23_), .b(new_n40_), .O(new_n41_));
  nand3  g20(.a(new_n41_), .b(new_n39_), .c(new_n37_), .O(z1));
  ...
  nor2   g27(.a(new_n46_), .b(new_n22_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n44_), .O(z2));
  inv1   g30(.a(x13), .O(new_n52_));
  nand3  g31(.a(new_n52_), .b(new_n46_), .c(x04), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n26_), .c(new_n28_), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n22_), .O(new_n55_));
  nand2  g34(.a(x12), .b(new_n28_), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n29_), .c(new_n22_), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(x13), .c(x04), .O(new_n58_));
  or2    g37(.a(x07), .b(x04), .O(new_n59_));
  nand4  g38(.a(new_n59_), .b(new_n58_), .c(new_n55_), .d(new_n41_), .O(z3));
