...
module FAU ( 
  ...
  nand2  g14(.a(x07), .b(x05), .O(new_n36_));
  ...
  oai21  g22(.a(new_n43_), .b(new_n42_), .c(x07), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x05), .O(z2));
  nand2  g24(.a(new_n41_), .b(x13), .O(new_n46_));
  nor2   g25(.a(x13), .b(x12), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n31_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n26_), .c(new_n46_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(x07), .c(x04), .O(new_n50_));
  ...
  nor2   g35(.a(new_n56_), .b(new_n52_), .O(z4));
endmodule
