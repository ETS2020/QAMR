...
module FAU ( 
  ...
  nand3  g36(.a(new_n22_), .b(x03), .c(x02), .O(new_n58_));
  nand3  g37(.a(new_n37_), .b(new_n55_), .c(new_n44_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  ...
  aoi21  g42(.a(new_n63_), .b(x13), .c(new_n22_), .O(z4));
endmodule
