...
module FAU ( 
  ...
  nand3  g21(.a(x04), .b(x03), .c(x02), .O(new_n43_));
  inv1   g22(.a(new_n43_), .O(new_n44_));
  nor3   g23(.a(x12), .b(x11), .c(x09), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n44_), .c(new_n42_), .O(new_n46_));
  aoi21  g25(.a(new_n35_), .b(x04), .c(new_n31_), .O(new_n47_));
  oai22  g26(.a(new_n47_), .b(new_n41_), .c(new_n46_), .d(new_n31_), .O(z2));
  nand2  g27(.a(x13), .b(x04), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(x05), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x12), .O(new_n51_));
  nand2  g30(.a(new_n35_), .b(x13), .O(new_n52_));
  nor3   g31(.a(x13), .b(x12), .c(x11), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n25_), .c(x02), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n52_), .c(new_n30_), .O(new_n55_));
  ...
  aoi21  g38(.a(new_n41_), .b(new_n31_), .c(new_n59_), .O(new_n60_));
