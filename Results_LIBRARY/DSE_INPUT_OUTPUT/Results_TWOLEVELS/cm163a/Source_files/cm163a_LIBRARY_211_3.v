...
module FAU ( 
  ...
  nor3   g16(.a(new_n37_), .b(x15), .c(new_n36_), .O(new_n38_));
  ...
  oai21  g26(.a(x12), .b(x11), .c(new_n22_), .O(new_n48_));
  ...
  nor3   g31(.a(new_n52_), .b(x15), .c(new_n36_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n23_), .c(new_n53_), .O(z3));
  nand4  g33(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(new_n36_), .c(new_n22_), .O(z4));
endmodule
