...
module FAU ( 
  ...
  nor3   g16(.a(new_n37_), .b(x14), .c(new_n36_), .O(new_n38_));
  ...
  nor3   g31(.a(new_n52_), .b(x14), .c(new_n36_), .O(new_n53_));
  oai21  g32(.a(new_n51_), .b(new_n23_), .c(new_n53_), .O(z3));
  inv1   g33(.a(x15), .O(new_n55_));
  nand4  g34(.a(x10), .b(x08), .c(new_n36_), .d(x03), .O(new_n56_));
  nor3   g35(.a(new_n56_), .b(new_n55_), .c(new_n22_), .O(z4));
endmodule
