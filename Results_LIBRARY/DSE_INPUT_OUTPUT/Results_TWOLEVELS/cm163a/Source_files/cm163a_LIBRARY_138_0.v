...
module FAU ( 
  ...
  aoi21  g26(.a(new_n35_), .b(x04), .c(new_n41_), .O(new_n48_));
  oai22  g27(.a(new_n48_), .b(new_n42_), .c(new_n47_), .d(new_n41_), .O(z2));
  nand2  g28(.a(x13), .b(x04), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(x05), .O(new_n51_));
  nand2  g30(.a(new_n51_), .b(x12), .O(new_n52_));
  ...
  aoi21  g34(.a(new_n55_), .b(new_n53_), .c(new_n30_), .O(new_n56_));
