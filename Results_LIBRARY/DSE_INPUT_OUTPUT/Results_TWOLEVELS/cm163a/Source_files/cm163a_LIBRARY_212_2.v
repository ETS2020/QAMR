...
module FAU ( 
  ...
  aoi21  g22(.a(new_n43_), .b(new_n27_), .c(new_n42_), .O(new_n44_));
  ...
  oai21  g29(.a(new_n45_), .b(new_n26_), .c(x13), .O(new_n51_));
  ...
  oai22  g39(.a(new_n60_), .b(new_n59_), .c(x05), .d(new_n22_), .O(z4));
endmodule
