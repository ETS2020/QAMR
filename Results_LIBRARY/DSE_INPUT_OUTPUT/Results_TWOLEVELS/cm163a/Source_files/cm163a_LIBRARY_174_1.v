...
module FAU ( 
  ...
  nor2   g01(.a(new_n22_), .b(x14), .O(new_n23_));
  ...
  aoi21  g21(.a(new_n35_), .b(new_n25_), .c(new_n42_), .O(new_n43_));
  nand2  g22(.a(x03), .b(x02), .O(new_n44_));
  inv1   g23(.a(x11), .O(new_n45_));
  nand3  g24(.a(new_n42_), .b(new_n45_), .c(new_n24_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n43_), .c(x04), .O(new_n48_));
  inv1   g27(.a(x06), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n30_), .c(new_n31_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n48_), .c(new_n23_), .O(z2));
  oai21  g30(.a(new_n22_), .b(x14), .c(new_n31_), .O(new_n52_));
  inv1   g31(.a(x13), .O(new_n53_));
  nor3   g32(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n25_), .c(new_n53_), .O(new_n55_));
  nand3  g34(.a(new_n53_), .b(new_n42_), .c(new_n45_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n26_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n55_), .c(x04), .O(new_n58_));
  nor2   g37(.a(x07), .b(x04), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n23_), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n58_), .c(new_n52_), .O(z3));
  nand3  g40(.a(x10), .b(x08), .c(x03), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(x14), .c(new_n22_), .O(z4));
endmodule
