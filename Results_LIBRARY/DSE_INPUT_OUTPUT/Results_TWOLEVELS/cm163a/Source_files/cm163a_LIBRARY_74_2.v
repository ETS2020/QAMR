...
module FAU ( 
  ...
  nor2   g02(.a(x08), .b(new_n23_), .O(new_n24_));
  ...
  aoi21  g12(.a(new_n33_), .b(new_n32_), .c(new_n24_), .O(new_n34_));
  nand3  g13(.a(new_n34_), .b(new_n31_), .c(new_n26_), .O(z0));
  nand2  g14(.a(new_n29_), .b(x11), .O(new_n36_));
  ...
  nand3  g35(.a(new_n54_), .b(new_n44_), .c(new_n47_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n29_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n56_), .c(x04), .O(new_n59_));
  aoi21  g38(.a(new_n23_), .b(new_n33_), .c(new_n24_), .O(new_n60_));
  nand3  g39(.a(new_n60_), .b(new_n59_), .c(new_n26_), .O(z3));
