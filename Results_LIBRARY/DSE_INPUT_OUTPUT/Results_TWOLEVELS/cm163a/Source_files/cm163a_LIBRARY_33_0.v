...
module FAU ( 
  ...
  oai21  g06(.a(new_n26_), .b(new_n22_), .c(new_n27_), .O(new_n28_));
  ...
  nand2  g15(.a(new_n25_), .b(x15), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(new_n22_), .c(new_n36_), .O(new_n38_));
  nor4   g17(.a(new_n25_), .b(new_n23_), .c(x11), .d(x09), .O(new_n39_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n26_), .c(x04), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x15), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n22_), .O(new_n47_));
  nand3  g26(.a(new_n26_), .b(new_n36_), .c(new_n22_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(x12), .c(x04), .O(new_n49_));
  inv1   g28(.a(x06), .O(new_n50_));
  nand2  g29(.a(new_n50_), .b(new_n31_), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n49_), .c(new_n47_), .d(new_n43_), .O(z2));
  ...
  nand4  g35(.a(new_n56_), .b(new_n36_), .c(x03), .d(x02), .O(new_n57_));
  nand2  g36(.a(new_n57_), .b(x15), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(new_n22_), .c(new_n55_), .O(new_n59_));
  nand3  g38(.a(new_n44_), .b(x15), .c(new_n55_), .O(new_n60_));
  ...
  nor2   g43(.a(new_n64_), .b(new_n23_), .O(z4));
endmodule
