...
module FAU ( 
  ...
  oai21  g02(.a(new_n23_), .b(x03), .c(x05), .O(z0));
  nor2   g03(.a(x04), .b(x01), .O(new_n25_));
  aoi21  g04(.a(x11), .b(x04), .c(new_n25_), .O(new_n26_));
  oai21  g05(.a(new_n26_), .b(x03), .c(x05), .O(z1));
  inv1   g06(.a(x03), .O(new_n28_));
  nand2  g07(.a(x12), .b(x04), .O(new_n29_));
  inv1   g08(.a(x04), .O(new_n30_));
  inv1   g09(.a(x06), .O(new_n31_));
  nand2  g10(.a(new_n31_), .b(new_n30_), .O(new_n32_));
  nand4  g11(.a(new_n32_), .b(new_n29_), .c(x05), .d(new_n28_), .O(z2));
  nand2  g12(.a(x13), .b(x04), .O(new_n34_));
  inv1   g13(.a(x07), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(new_n30_), .O(new_n36_));
  nand4  g15(.a(new_n36_), .b(new_n34_), .c(x05), .d(new_n28_), .O(z3));
  inv1   g16(.a(x14), .O(new_n38_));
  inv1   g17(.a(x15), .O(new_n39_));
  inv1   g18(.a(x05), .O(new_n40_));
  nand4  g19(.a(x10), .b(x08), .c(new_n40_), .d(x03), .O(new_n41_));
