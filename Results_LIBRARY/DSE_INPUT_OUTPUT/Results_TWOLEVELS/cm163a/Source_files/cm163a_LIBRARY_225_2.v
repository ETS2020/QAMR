...
module FAU ( 
  ...
  nand4  g19(.a(new_n24_), .b(new_n40_), .c(new_n33_), .d(new_n22_), .O(new_n41_));
  ...
  nand3  g24(.a(new_n40_), .b(new_n33_), .c(new_n22_), .O(new_n46_));
  ...
  oai22  g37(.a(new_n58_), .b(new_n57_), .c(x15), .d(new_n56_), .O(z4));
endmodule
