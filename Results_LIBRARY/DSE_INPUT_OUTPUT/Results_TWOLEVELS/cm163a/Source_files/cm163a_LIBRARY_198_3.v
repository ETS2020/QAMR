...
module FAU ( 
  ...
  nor3   g17(.a(new_n36_), .b(new_n28_), .c(x07), .O(new_n39_));
  ...
  inv1   g29(.a(new_n26_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n45_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n50_), .c(x04), .O(new_n53_));
  inv1   g32(.a(x06), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n44_), .O(new_n55_));
  nand4  g34(.a(new_n55_), .b(new_n53_), .c(new_n47_), .d(new_n43_), .O(z2));
  inv1   g35(.a(x13), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n28_), .c(x04), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(new_n25_), .O(new_n59_));
  nand2  g38(.a(new_n49_), .b(x13), .O(new_n60_));
  nand4  g39(.a(new_n51_), .b(new_n57_), .c(new_n45_), .d(new_n36_), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g41(.a(new_n62_), .b(new_n28_), .c(x04), .O(new_n63_));
  nand3  g42(.a(new_n63_), .b(new_n59_), .c(new_n43_), .O(z3));
