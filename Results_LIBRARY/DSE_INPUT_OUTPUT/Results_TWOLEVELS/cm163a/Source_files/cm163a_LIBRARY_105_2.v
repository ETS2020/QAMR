...
module FAU ( 
  ...
  aoi21  g17(.a(new_n29_), .b(x11), .c(new_n38_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n22_), .c(new_n34_), .O(z1));
  ...
  nand3  g25(.a(new_n46_), .b(x05), .c(x04), .O(new_n47_));
  ...
  nand3  g30(.a(new_n51_), .b(new_n36_), .c(new_n35_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n25_), .c(x13), .O(new_n53_));
  nor3   g32(.a(x13), .b(x12), .c(x11), .O(new_n54_));
  nand3  g33(.a(new_n54_), .b(new_n28_), .c(x02), .O(new_n55_));
