...
module FAU ( 
  ...
  nand2  g24(.a(x09), .b(x03), .O(new_n46_));
  oai21  g25(.a(x06), .b(x04), .c(x05), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  oai21  g27(.a(x11), .b(new_n42_), .c(x12), .O(new_n49_));
  inv1   g28(.a(x12), .O(new_n50_));
  nand4  g29(.a(new_n50_), .b(new_n35_), .c(x03), .d(x02), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n49_), .c(x09), .O(new_n52_));
  nor2   g31(.a(new_n50_), .b(x03), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(x04), .O(new_n54_));
  nand2  g33(.a(new_n54_), .b(new_n48_), .O(z2));
  oai21  g34(.a(x07), .b(x04), .c(x05), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n46_), .O(new_n57_));
  nand3  g36(.a(new_n50_), .b(new_n35_), .c(x02), .O(new_n58_));
  nand2  g37(.a(new_n58_), .b(x13), .O(new_n59_));
  nor2   g38(.a(x13), .b(x12), .O(new_n60_));
  nand4  g39(.a(new_n60_), .b(new_n35_), .c(x03), .d(x02), .O(new_n61_));
  aoi21  g40(.a(new_n61_), .b(new_n59_), .c(x09), .O(new_n62_));
  inv1   g41(.a(x13), .O(new_n63_));
  nor2   g42(.a(new_n63_), .b(x03), .O(new_n64_));
  oai21  g43(.a(new_n64_), .b(new_n62_), .c(x04), .O(new_n65_));
  nand2  g44(.a(new_n65_), .b(new_n57_), .O(z3));
  nand4  g45(.a(x15), .b(x14), .c(x10), .d(x08), .O(new_n67_));
  aoi21  g46(.a(new_n67_), .b(new_n23_), .c(new_n27_), .O(z4));
endmodule
