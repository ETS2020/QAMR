...
module FAU ( 
  ...
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(x15), .O(new_n45_));
  nand2  g24(.a(new_n45_), .b(x05), .O(z2));
  inv1   g25(.a(new_n26_), .O(new_n47_));
  oai21  g26(.a(x12), .b(x11), .c(x15), .O(new_n48_));
