...
module FAU ( 
  ...
  nand2  g07(.a(x04), .b(x02), .O(new_n29_));
  ...
  oai21  g38(.a(x12), .b(x09), .c(x03), .O(new_n60_));
  nand3  g39(.a(new_n31_), .b(x03), .c(x02), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n30_), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(new_n63_));
  nand3  g42(.a(new_n30_), .b(x03), .c(x02), .O(new_n64_));
  nand3  g43(.a(new_n59_), .b(new_n44_), .c(new_n31_), .O(new_n65_));
  nor2   g44(.a(new_n65_), .b(new_n64_), .O(new_n66_));
