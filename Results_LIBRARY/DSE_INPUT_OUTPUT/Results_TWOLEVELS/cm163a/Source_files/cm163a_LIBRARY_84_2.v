...
module FAU ( 
  ...
  nand4  g08(.a(new_n29_), .b(new_n26_), .c(x15), .d(x05), .O(z0));
  ...
  oai21  g19(.a(x06), .b(x04), .c(x15), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  oai21  g21(.a(new_n39_), .b(new_n28_), .c(new_n42_), .O(z2));
  inv1   g22(.a(new_n24_), .O(new_n44_));
  nand2  g23(.a(new_n38_), .b(new_n23_), .O(new_n45_));
  nor3   g24(.a(x13), .b(x12), .c(x11), .O(new_n46_));
  aoi22  g25(.a(new_n46_), .b(new_n44_), .c(new_n45_), .d(x13), .O(new_n47_));
  oai21  g26(.a(x07), .b(x04), .c(x15), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n40_), .O(new_n49_));
