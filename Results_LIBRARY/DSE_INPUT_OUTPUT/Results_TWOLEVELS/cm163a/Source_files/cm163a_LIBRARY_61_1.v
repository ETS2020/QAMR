...
module FAU ( 
  ...
  nand3  g19(.a(new_n40_), .b(new_n22_), .c(x04), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n23_), .c(x05), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n33_), .O(new_n43_));
  ...
  nand3  g31(.a(new_n50_), .b(new_n40_), .c(new_n33_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n25_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n52_), .c(x04), .O(new_n55_));
  inv1   g34(.a(x07), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n29_), .O(new_n57_));
  nand3  g36(.a(new_n57_), .b(new_n55_), .c(x05), .O(z3));
  nand2  g37(.a(x08), .b(x03), .O(new_n59_));
  nand3  g38(.a(x15), .b(x14), .c(x10), .O(new_n60_));
  oai22  g39(.a(new_n60_), .b(new_n59_), .c(new_n33_), .d(x05), .O(z4));
endmodule
