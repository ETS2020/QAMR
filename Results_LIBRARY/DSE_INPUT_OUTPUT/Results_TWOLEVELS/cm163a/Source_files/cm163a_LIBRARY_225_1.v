...
module FAU ( 
  ...
  nand4  g22(.a(new_n24_), .b(new_n43_), .c(new_n33_), .d(new_n22_), .O(new_n44_));
  ...
  nand2  g26(.a(new_n47_), .b(new_n40_), .O(z2));
  nand3  g27(.a(new_n43_), .b(new_n33_), .c(new_n22_), .O(new_n49_));
  ...
  nand2  g36(.a(new_n57_), .b(new_n40_), .O(z3));
  nand4  g37(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n59_));
  aoi21  g38(.a(new_n59_), .b(x05), .c(new_n39_), .O(z4));
endmodule
