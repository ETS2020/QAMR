...
module FAU ( 
  ...
  nand2  g00(.a(x15), .b(x13), .O(new_n22_));
  ...
  nand4  g21(.a(new_n42_), .b(new_n23_), .c(x03), .d(x02), .O(new_n43_));
  ...
  nand4  g26(.a(new_n47_), .b(new_n45_), .c(new_n22_), .d(x05), .O(z2));
  oai21  g27(.a(x07), .b(x04), .c(x05), .O(new_n49_));
  nand2  g28(.a(new_n49_), .b(new_n22_), .O(new_n50_));
  inv1   g29(.a(x15), .O(new_n51_));
  nand3  g30(.a(new_n43_), .b(new_n51_), .c(x13), .O(new_n52_));
  inv1   g31(.a(new_n25_), .O(new_n53_));
  ...
  aoi21  g39(.a(new_n60_), .b(new_n59_), .c(new_n51_), .O(z4));
endmodule
