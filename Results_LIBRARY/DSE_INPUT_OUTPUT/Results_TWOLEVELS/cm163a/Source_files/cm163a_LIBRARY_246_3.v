...
module FAU ( 
  ...
  nand4  g19(.a(new_n40_), .b(new_n38_), .c(new_n22_), .d(x05), .O(z1));
  ...
  aoi21  g41(.a(new_n62_), .b(new_n61_), .c(new_n53_), .O(z4));
endmodule
