...
module FAU ( 
  ...
  nand3  g18(.a(new_n39_), .b(new_n22_), .c(x04), .O(new_n40_));
  inv1   g19(.a(new_n40_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n23_), .c(new_n38_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(x12), .c(x05), .O(z2));
  nand4  g22(.a(new_n39_), .b(new_n22_), .c(x03), .d(x02), .O(new_n44_));
