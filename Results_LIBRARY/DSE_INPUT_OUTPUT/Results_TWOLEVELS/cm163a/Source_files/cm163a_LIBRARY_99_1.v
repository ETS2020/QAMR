...
module FAU ( 
  ...
  oai21  g25(.a(new_n46_), .b(new_n31_), .c(new_n42_), .O(new_n47_));
  nand2  g26(.a(x06), .b(x04), .O(new_n48_));
  oai21  g27(.a(x07), .b(x06), .c(new_n48_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n26_), .c(x12), .O(new_n50_));
  inv1   g29(.a(new_n50_), .O(new_n51_));
  nor3   g30(.a(x07), .b(x06), .c(x04), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g32(.a(new_n53_), .b(new_n47_), .O(z2));
  aoi21  g33(.a(x06), .b(x04), .c(new_n22_), .O(new_n55_));
  inv1   g34(.a(new_n26_), .O(new_n56_));
  nor3   g35(.a(x13), .b(x12), .c(x11), .O(new_n57_));
  aoi22  g36(.a(new_n57_), .b(new_n56_), .c(new_n45_), .d(x13), .O(new_n58_));
  aoi22  g37(.a(new_n42_), .b(new_n31_), .c(new_n22_), .d(new_n30_), .O(new_n59_));
  oai21  g38(.a(new_n58_), .b(new_n55_), .c(new_n59_), .O(z3));
  nand2  g39(.a(x08), .b(x03), .O(new_n61_));
  nand3  g40(.a(x15), .b(x14), .c(x10), .O(new_n62_));
  oai21  g41(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z4));
endmodule
