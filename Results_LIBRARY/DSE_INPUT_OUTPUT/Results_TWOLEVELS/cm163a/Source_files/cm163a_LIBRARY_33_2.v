...
module FAU ( 
  ...
  nand3  g18(.a(x15), .b(x11), .c(x09), .O(new_n40_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n31_), .c(x15), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(x09), .O(new_n48_));
  nand2  g27(.a(new_n38_), .b(x12), .O(new_n49_));
  nand3  g28(.a(new_n46_), .b(new_n37_), .c(new_n26_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n24_), .c(new_n49_), .O(new_n51_));
  ...
  nand4  g36(.a(new_n46_), .b(new_n37_), .c(x03), .d(x02), .O(new_n58_));
