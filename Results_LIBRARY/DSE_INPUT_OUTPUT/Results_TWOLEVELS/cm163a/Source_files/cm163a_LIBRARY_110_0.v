...
module FAU ( 
  ...
  inv1   g14(.a(x02), .O(new_n36_));
  inv1   g15(.a(x04), .O(new_n37_));
  oai21  g16(.a(new_n32_), .b(new_n37_), .c(x05), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  aoi21  g18(.a(new_n22_), .b(x03), .c(new_n32_), .O(new_n40_));
  nor2   g19(.a(x04), .b(x01), .O(new_n41_));
  aoi21  g20(.a(new_n40_), .b(x04), .c(new_n41_), .O(new_n42_));
  nand3  g21(.a(new_n42_), .b(new_n39_), .c(new_n35_), .O(z1));
  nor2   g22(.a(x12), .b(x11), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(new_n22_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n31_), .c(x05), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x02), .O(new_n47_));
  nand4  g26(.a(new_n32_), .b(new_n22_), .c(x03), .d(x02), .O(new_n48_));
  ...
  nand2  g33(.a(new_n54_), .b(new_n32_), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n23_), .c(x05), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(x02), .O(new_n57_));
  nand4  g36(.a(new_n44_), .b(new_n22_), .c(x03), .d(x02), .O(new_n58_));
  nand3  g37(.a(new_n58_), .b(x13), .c(x04), .O(new_n59_));
  inv1   g38(.a(x07), .O(new_n60_));
  nand2  g39(.a(new_n60_), .b(new_n37_), .O(new_n61_));
  nand2  g40(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g41(.a(new_n62_), .b(x05), .O(new_n63_));
