...
module FAU ( 
  ...
  aoi22  g10(.a(new_n31_), .b(new_n26_), .c(new_n27_), .d(x11), .O(new_n32_));
  inv1   g11(.a(x01), .O(new_n33_));
  inv1   g12(.a(x05), .O(new_n34_));
  aoi21  g13(.a(new_n22_), .b(new_n33_), .c(new_n34_), .O(new_n35_));
  oai21  g14(.a(new_n32_), .b(new_n22_), .c(new_n35_), .O(z1));
  aoi21  g15(.a(x11), .b(x05), .c(x09), .O(new_n37_));
  nand2  g16(.a(new_n37_), .b(new_n26_), .O(new_n38_));
  nor3   g17(.a(x12), .b(x11), .c(x09), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n26_), .c(new_n38_), .d(x12), .O(new_n40_));
  inv1   g19(.a(x06), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n22_), .c(new_n34_), .O(new_n42_));
  oai21  g21(.a(new_n40_), .b(new_n22_), .c(new_n42_), .O(z2));
  inv1   g22(.a(new_n27_), .O(new_n44_));
  oai21  g23(.a(x12), .b(x11), .c(x05), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n25_), .c(x03), .d(x02), .O(new_n46_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n22_), .c(new_n34_), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n22_), .c(new_n50_), .O(z3));
  inv1   g30(.a(x03), .O(new_n52_));
  inv1   g31(.a(x15), .O(new_n53_));
  aoi21  g32(.a(new_n34_), .b(x04), .c(new_n53_), .O(new_n54_));
