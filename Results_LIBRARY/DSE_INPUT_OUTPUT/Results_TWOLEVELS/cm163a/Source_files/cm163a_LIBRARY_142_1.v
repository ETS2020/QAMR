...
module FAU ( 
  ...
  nand4  g21(.a(new_n42_), .b(new_n40_), .c(new_n35_), .d(x05), .O(z1));
  ...
  inv1   g32(.a(x11), .O(new_n54_));
  nand3  g33(.a(new_n53_), .b(new_n44_), .c(new_n54_), .O(new_n55_));
  oai22  g34(.a(new_n55_), .b(new_n27_), .c(new_n46_), .d(new_n53_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x04), .c(new_n32_), .O(new_n57_));
  nand2  g36(.a(x07), .b(x04), .O(new_n58_));
  oai21  g37(.a(x10), .b(x07), .c(new_n58_), .O(new_n59_));
  nand3  g38(.a(new_n59_), .b(new_n27_), .c(x13), .O(new_n60_));
  inv1   g39(.a(x07), .O(new_n61_));
  nand3  g40(.a(new_n22_), .b(new_n61_), .c(new_n31_), .O(new_n62_));
  and2   g41(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  oai21  g42(.a(new_n57_), .b(new_n23_), .c(new_n63_), .O(z3));
  nand4  g43(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n65_));
  aoi21  g44(.a(new_n65_), .b(x07), .c(new_n22_), .O(z4));
endmodule
