...
module FAU ( 
  ...
  oai21  g28(.a(new_n49_), .b(new_n24_), .c(x04), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n47_), .c(new_n28_), .O(new_n51_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(z4));
endmodule
