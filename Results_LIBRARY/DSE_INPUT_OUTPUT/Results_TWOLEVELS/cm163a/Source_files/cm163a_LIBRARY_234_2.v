...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(x05), .O(new_n28_));
  ...
  oai21  g24(.a(x06), .b(x04), .c(x15), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  oai21  g26(.a(new_n44_), .b(new_n22_), .c(new_n47_), .O(z2));
  ...
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(x15), .O(new_n54_));
