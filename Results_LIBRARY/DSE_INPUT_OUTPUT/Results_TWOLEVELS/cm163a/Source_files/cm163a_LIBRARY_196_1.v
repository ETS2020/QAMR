...
module FAU ( 
  ...
  nand3  g20(.a(new_n41_), .b(new_n39_), .c(x05), .O(z1));
  ...
  aoi21  g31(.a(new_n52_), .b(new_n35_), .c(new_n31_), .O(new_n53_));
  nand3  g32(.a(new_n31_), .b(new_n43_), .c(new_n45_), .O(new_n54_));
  ...
  oai22  g40(.a(new_n61_), .b(new_n60_), .c(new_n31_), .d(x05), .O(z4));
endmodule
