...
module FAU ( 
  ...
  nor3   g30(.a(new_n51_), .b(x08), .c(new_n36_), .O(new_n52_));
  oai21  g31(.a(new_n50_), .b(new_n23_), .c(new_n52_), .O(z3));
  nand4  g32(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n36_), .c(new_n22_), .O(z4));
endmodule
