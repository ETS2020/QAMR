...
module FAU ( 
  ...
  aoi21  g13(.a(x15), .b(x04), .c(new_n34_), .O(new_n35_));
  nor2   g14(.a(x11), .b(x09), .O(new_n36_));
  aoi22  g15(.a(new_n36_), .b(new_n26_), .c(new_n27_), .d(x11), .O(new_n37_));
  inv1   g16(.a(x05), .O(new_n38_));
  nand2  g17(.a(x05), .b(x04), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n34_), .c(x15), .d(new_n38_), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n31_), .c(new_n38_), .O(new_n50_));
  ...
  aoi21  g37(.a(new_n58_), .b(new_n31_), .c(new_n38_), .O(new_n59_));
