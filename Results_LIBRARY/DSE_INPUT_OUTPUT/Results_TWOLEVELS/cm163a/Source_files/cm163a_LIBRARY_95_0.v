...
module FAU ( 
  ...
  nand2  g11(.a(x12), .b(x01), .O(new_n33_));
  ...
  nand3  g18(.a(new_n39_), .b(new_n34_), .c(new_n23_), .O(z1));
  ...
  nand4  g24(.a(new_n25_), .b(new_n45_), .c(new_n44_), .d(new_n24_), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n43_), .c(new_n42_), .d(new_n23_), .O(z2));
  ...
  aoi21  g30(.a(new_n36_), .b(new_n25_), .c(new_n49_), .O(new_n52_));
  ...
  nand3  g34(.a(new_n55_), .b(new_n51_), .c(new_n23_), .O(z3));
  inv1   g35(.a(x03), .O(new_n57_));
  inv1   g36(.a(x15), .O(new_n58_));
  aoi21  g37(.a(new_n45_), .b(new_n30_), .c(new_n58_), .O(new_n59_));
