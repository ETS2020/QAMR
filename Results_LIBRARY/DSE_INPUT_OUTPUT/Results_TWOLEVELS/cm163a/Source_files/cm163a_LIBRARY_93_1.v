...
module FAU ( 
  ...
  oai21  g12(.a(new_n33_), .b(new_n23_), .c(new_n31_), .O(new_n34_));
  nand2  g13(.a(new_n34_), .b(x04), .O(new_n35_));
  inv1   g14(.a(x01), .O(new_n36_));
  nand2  g15(.a(new_n22_), .b(new_n36_), .O(new_n37_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n42_), .c(new_n32_), .O(new_n47_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n42_), .c(new_n32_), .O(new_n56_));
  nand2  g35(.a(new_n56_), .b(new_n51_), .O(z3));
  nand2  g36(.a(x08), .b(x03), .O(new_n58_));
  nand3  g37(.a(x15), .b(x14), .c(x10), .O(new_n59_));
  oai22  g38(.a(new_n59_), .b(new_n58_), .c(new_n32_), .d(x05), .O(z4));
endmodule
