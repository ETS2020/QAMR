...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n60_, new_n62_;
  nand2  g00(.a(x10), .b(x07), .O(new_n22_));
  ...
  aoi21  g33(.a(new_n54_), .b(x04), .c(new_n53_), .O(new_n55_));
  nor2   g34(.a(x12), .b(x11), .O(new_n56_));
  nand3  g35(.a(new_n56_), .b(new_n25_), .c(new_n24_), .O(new_n57_));
  nor3   g36(.a(x13), .b(x12), .c(x11), .O(new_n58_));
  aoi22  g37(.a(new_n58_), .b(new_n36_), .c(new_n57_), .d(x13), .O(new_n59_));
  aoi22  g38(.a(new_n22_), .b(new_n31_), .c(new_n53_), .d(new_n30_), .O(new_n60_));
  oai21  g39(.a(new_n59_), .b(new_n55_), .c(new_n60_), .O(z3));
  nand4  g40(.a(x15), .b(x14), .c(x08), .d(x03), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(new_n53_), .c(new_n54_), .O(z4));
endmodule
