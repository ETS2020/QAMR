...
module FAU ( 
  ...
  oai21  g21(.a(new_n22_), .b(x06), .c(new_n32_), .O(new_n43_));
  inv1   g22(.a(x06), .O(new_n44_));
  oai21  g23(.a(x08), .b(new_n31_), .c(new_n44_), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  aoi21  g25(.a(new_n36_), .b(new_n26_), .c(new_n46_), .O(new_n47_));
  inv1   g26(.a(x11), .O(new_n48_));
  nand3  g27(.a(new_n46_), .b(new_n48_), .c(new_n24_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n25_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n47_), .c(x04), .O(new_n51_));
  nand3  g30(.a(new_n51_), .b(new_n45_), .c(new_n43_), .O(z2));
  inv1   g31(.a(x13), .O(new_n53_));
  nor3   g32(.a(x12), .b(x11), .c(x09), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n26_), .c(new_n53_), .O(new_n55_));
  nand3  g34(.a(new_n53_), .b(new_n46_), .c(new_n48_), .O(new_n56_));
  ...
  nand3  g39(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(z3));
  nand4  g40(.a(x15), .b(x14), .c(x10), .d(x03), .O(new_n62_));
  aoi21  g41(.a(new_n62_), .b(x06), .c(new_n22_), .O(z4));
endmodule
