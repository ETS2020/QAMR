...
module FAU ( 
  ...
  nor2   g23(.a(new_n57_), .b(new_n49_), .O(new_n58_));
  ...
  nand2  g38(.a(new_n65_), .b(x04), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n74_), .d(new_n37_), .O(z06));
  ...
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n74_), .d(new_n37_), .O(z07));
  ...
  nand4  g55(.a(new_n50_), .b(new_n35_), .c(new_n89_), .d(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n81_), .d(new_n80_), .O(new_n92_));
  ...
  nand2  g61(.a(x13), .b(new_n56_), .O(new_n96_));
  nor2   g62(.a(x12), .b(x11), .O(new_n97_));
  nor2   g63(.a(x17), .b(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n76_), .d(x08), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n96_), .c(new_n57_), .O(new_n100_));
  nor2   g66(.a(new_n89_), .b(x07), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n100_), .c(x06), .O(new_n102_));
  oai21  g68(.a(new_n89_), .b(x06), .c(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n50_), .c(x04), .O(new_n104_));
  nand2  g70(.a(new_n97_), .b(new_n76_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x13), .c(new_n36_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n104_), .c(new_n74_), .O(z09));
  inv1   g73(.a(x00), .O(new_n108_));
  nand2  g74(.a(new_n63_), .b(x02), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(x16), .c(x09), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(x08), .c(x07), .d(x06), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n108_), .c(new_n50_), .d(new_n39_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n37_), .O(new_n113_));
  nand4  g79(.a(new_n50_), .b(new_n35_), .c(new_n89_), .d(new_n88_), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(new_n115_));
  nand4  g81(.a(new_n115_), .b(new_n81_), .c(new_n80_), .d(new_n68_), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(new_n117_));
  nand4  g83(.a(new_n117_), .b(x08), .c(x07), .d(x06), .O(new_n118_));
  aoi21  g84(.a(new_n118_), .b(new_n113_), .c(new_n46_), .O(z10));
  nand2  g85(.a(new_n37_), .b(new_n41_), .O(z11));
  inv1   g86(.a(x16), .O(new_n121_));
  oai21  g87(.a(new_n121_), .b(x02), .c(new_n63_), .O(new_n122_));
  nand3  g88(.a(new_n122_), .b(new_n37_), .c(x04), .O(new_n123_));
  inv1   g89(.a(new_n123_), .O(z12));
  aoi21  g90(.a(x17), .b(new_n89_), .c(new_n46_), .O(z13));
