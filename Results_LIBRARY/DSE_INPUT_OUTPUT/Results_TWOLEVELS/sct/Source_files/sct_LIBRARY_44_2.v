...
module FAU ( 
  ...
  aoi21  g58(.a(new_n89_), .b(new_n35_), .c(new_n51_), .O(new_n93_));
  ...
  nand2  g63(.a(new_n97_), .b(new_n37_), .O(z10));
  nand2  g64(.a(new_n37_), .b(new_n39_), .O(z11));
  oai21  g65(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n37_), .c(x04), .O(new_n101_));
