...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n47_), .O(new_n65_));
  ...
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n68_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n65_), .d(new_n47_), .O(z07));
  nand2  g45(.a(new_n78_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n72_), .b(new_n76_), .c(new_n82_), .d(new_n81_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n65_), .d(new_n47_), .O(z08));
  nand2  g50(.a(new_n83_), .b(x13), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n64_), .c(new_n47_), .O(new_n87_));
  inv1   g53(.a(x10), .O(new_n88_));
  inv1   g54(.a(x00), .O(new_n89_));
  nand3  g55(.a(new_n49_), .b(new_n38_), .c(x04), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n82_), .c(new_n81_), .d(new_n88_), .O(new_n92_));
  ...
  nor2   g61(.a(x17), .b(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n77_), .c(new_n82_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n49_), .c(new_n68_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  nand2  g67(.a(new_n61_), .b(x02), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n47_), .c(x16), .d(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n44_), .O(z10));
  nor2   g70(.a(new_n39_), .b(new_n35_), .O(z11));
  oai21  g71(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n47_), .c(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z12));
  aoi21  g74(.a(x17), .b(new_n89_), .c(new_n44_), .O(z13));
