...
module FAU ( 
  ...
  oai21  g10(.a(new_n36_), .b(x15), .c(new_n44_), .O(new_n45_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(new_n37_), .O(z05));
  nand2  g37(.a(new_n70_), .b(x10), .O(new_n72_));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n57_), .c(x08), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n66_), .d(new_n37_), .O(z06));
  inv1   g41(.a(new_n37_), .O(new_n76_));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n76_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n73_), .b(new_n79_), .c(new_n84_), .d(new_n78_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  aoi21  g52(.a(new_n80_), .b(x12), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n76_), .O(z08));
  ...
  aoi21  g60(.a(new_n85_), .b(x13), .c(new_n76_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n66_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  inv1   g63(.a(x16), .O(new_n98_));
  aoi21  g64(.a(new_n62_), .b(x02), .c(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n89_), .b(new_n84_), .c(new_n78_), .d(new_n77_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n97_), .c(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n69_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n49_), .c(new_n50_), .d(new_n39_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n37_), .O(z10));
  nand2  g71(.a(new_n37_), .b(new_n41_), .O(z11));
  nor3   g72(.a(new_n76_), .b(new_n98_), .c(x02), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(x03), .c(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n37_), .O(z12));
  nand2  g75(.a(new_n37_), .b(new_n46_), .O(z13));
  oai21  g76(.a(new_n35_), .b(new_n46_), .c(new_n37_), .O(z14));
endmodule
