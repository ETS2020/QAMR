...
module FAU ( 
  ...
  nand4  g19(.a(new_n53_), .b(new_n50_), .c(new_n47_), .d(x04), .O(new_n54_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n64_), .c(new_n40_), .O(z08));
  ...
  aoi21  g58(.a(new_n83_), .b(x13), .c(new_n40_), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n97_), .b(new_n36_), .c(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n69_), .c(x08), .d(x07), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n48_), .c(new_n50_), .d(new_n37_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n47_), .O(z10));
  nor2   g68(.a(new_n40_), .b(new_n49_), .O(z11));
  ...
  nor3   g74(.a(new_n40_), .b(new_n108_), .c(new_n44_), .O(z14));
endmodule
