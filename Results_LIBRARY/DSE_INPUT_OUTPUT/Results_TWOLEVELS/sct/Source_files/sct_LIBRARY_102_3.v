...
module FAU ( 
  ...
  aoi21  g26(.a(new_n60_), .b(x16), .c(new_n41_), .O(new_n61_));
  ...
  nand4  g31(.a(new_n65_), .b(new_n63_), .c(new_n61_), .d(new_n42_), .O(z05));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n67_), .c(new_n43_), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n67_), .c(new_n43_), .O(z08));
  ...
  nand4  g55(.a(new_n89_), .b(new_n80_), .c(new_n74_), .d(new_n73_), .O(new_n90_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n74_), .c(new_n73_), .d(new_n35_), .O(new_n95_));
  oai21  g61(.a(x01), .b(new_n35_), .c(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n47_), .c(new_n64_), .d(x08), .O(new_n97_));
