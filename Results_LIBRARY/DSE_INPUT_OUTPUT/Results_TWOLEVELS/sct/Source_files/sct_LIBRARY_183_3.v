...
module FAU ( 
  ...
  oai21  g21(.a(x03), .b(new_n40_), .c(x16), .O(new_n56_));
  ...
  nor2   g30(.a(x03), .b(new_n40_), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n46_), .c(new_n36_), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x16), .O(new_n67_));
  nand2  g33(.a(new_n38_), .b(new_n46_), .O(new_n68_));
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n68_), .d(new_n67_), .O(z05));
  nor2   g39(.a(new_n56_), .b(new_n46_), .O(new_n74_));
  nand2  g40(.a(new_n72_), .b(x10), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand4  g42(.a(new_n60_), .b(new_n76_), .c(new_n71_), .d(x08), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(x04), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n74_), .c(new_n36_), .O(new_n79_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n76_), .d(new_n71_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n82_), .c(new_n68_), .d(new_n67_), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n83_), .c(new_n76_), .d(new_n71_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(new_n69_), .O(new_n89_));
  aoi21  g55(.a(new_n85_), .b(x12), .c(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n68_), .c(new_n67_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  oai21  g58(.a(new_n89_), .b(new_n92_), .c(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n38_), .O(new_n94_));
  aoi21  g60(.a(new_n51_), .b(x16), .c(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n87_), .c(new_n83_), .d(new_n76_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n71_), .c(x08), .d(x07), .O(new_n98_));
  inv1   g64(.a(new_n65_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n36_), .c(x16), .O(new_n100_));
  oai21  g66(.a(new_n98_), .b(new_n49_), .c(new_n100_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n94_), .O(z09));
  nand2  g69(.a(new_n56_), .b(x00), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n96_), .c(x09), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  nand3  g72(.a(new_n99_), .b(x16), .c(x14), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n38_), .O(z10));
  nor2   g76(.a(new_n37_), .b(new_n40_), .O(z11));
  oai21  g77(.a(new_n36_), .b(new_n35_), .c(x03), .O(new_n112_));
  nand3  g78(.a(new_n36_), .b(x16), .c(new_n40_), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n112_), .c(new_n46_), .O(z12));
  aoi21  g80(.a(x17), .b(x16), .c(new_n46_), .O(z13));
