...
module FAU ( 
  ...
  nor2   g40(.a(new_n64_), .b(new_n43_), .O(new_n75_));
  nand3  g41(.a(new_n57_), .b(new_n65_), .c(x08), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x10), .O(new_n77_));
  nor2   g43(.a(x10), .b(x09), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n57_), .c(x08), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n47_), .O(z06));
  ...
  nand3  g51(.a(new_n85_), .b(new_n67_), .c(new_n65_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  aoi21  g53(.a(new_n79_), .b(x11), .c(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n81_), .c(new_n38_), .O(z07));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n78_), .b(new_n67_), .c(new_n90_), .d(new_n83_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  aoi21  g58(.a(new_n86_), .b(x12), .c(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n81_), .c(new_n38_), .O(z08));
  nand2  g60(.a(new_n91_), .b(x13), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  inv1   g62(.a(new_n76_), .O(new_n97_));
  nand4  g63(.a(new_n85_), .b(new_n97_), .c(new_n96_), .d(new_n90_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n95_), .c(new_n75_), .d(new_n47_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand3  g66(.a(x17), .b(new_n96_), .c(new_n90_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n84_), .c(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n50_), .c(new_n65_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x07), .c(x06), .O(new_n105_));
  nand4  g71(.a(new_n49_), .b(new_n47_), .c(x16), .d(x14), .O(new_n106_));
  ...
  nor2   g78(.a(new_n70_), .b(new_n43_), .O(z14));
endmodule
