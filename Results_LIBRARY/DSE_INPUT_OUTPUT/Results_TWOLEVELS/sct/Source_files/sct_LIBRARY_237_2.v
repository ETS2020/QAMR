...
module FAU ( 
  ...
  nand2  g46(.a(new_n77_), .b(x10), .O(new_n81_));
  ...
  nor2   g50(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n40_), .O(z06));
  oai21  g52(.a(new_n75_), .b(new_n44_), .c(new_n47_), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(x11), .O(new_n88_));
  inv1   g54(.a(new_n68_), .O(new_n89_));
  nor2   g55(.a(x11), .b(x10), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n76_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n87_), .d(new_n47_), .O(z07));
  ...
  nand4  g61(.a(new_n95_), .b(new_n93_), .c(new_n87_), .d(new_n47_), .O(z08));
  nand2  g62(.a(new_n95_), .b(x13), .O(new_n97_));
  inv1   g63(.a(new_n77_), .O(new_n98_));
  nor2   g64(.a(x13), .b(x12), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n90_), .c(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n97_), .c(new_n87_), .d(new_n47_), .O(z09));
  inv1   g67(.a(x11), .O(new_n102_));
  nor2   g68(.a(x10), .b(x00), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n99_), .c(new_n102_), .O(new_n104_));
  oai21  g70(.a(new_n35_), .b(new_n36_), .c(new_n104_), .O(new_n105_));
  ...
  nand4  g74(.a(new_n50_), .b(new_n47_), .c(x16), .d(x14), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n44_), .O(z10));
  nor2   g76(.a(new_n40_), .b(new_n65_), .O(z11));
  nand2  g77(.a(new_n66_), .b(new_n49_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n47_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nand2  g80(.a(new_n47_), .b(new_n44_), .O(z13));
