...
module FAU ( 
  ...
  nand3  g19(.a(new_n53_), .b(x02), .c(new_n39_), .O(new_n54_));
  ...
  nand3  g36(.a(new_n70_), .b(x16), .c(new_n39_), .O(new_n71_));
  ...
  aoi21  g63(.a(new_n53_), .b(x02), .c(new_n36_), .O(new_n98_));
  ...
  nand3  g72(.a(x16), .b(new_n35_), .c(new_n39_), .O(new_n107_));
