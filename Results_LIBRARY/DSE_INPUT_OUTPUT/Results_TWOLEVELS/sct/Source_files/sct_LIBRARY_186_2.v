...
module FAU ( 
  ...
  nor2   g51(.a(new_n74_), .b(new_n42_), .O(new_n86_));
  ...
  nand3  g66(.a(new_n49_), .b(x04), .c(new_n36_), .O(new_n101_));
  ...
  nand4  g74(.a(new_n108_), .b(new_n89_), .c(new_n88_), .d(new_n36_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n63_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n75_), .c(x08), .d(x07), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n47_), .c(new_n49_), .d(new_n37_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n46_), .O(z10));
  nor2   g80(.a(new_n43_), .b(new_n48_), .O(z11));
  nor2   g81(.a(new_n43_), .b(new_n62_), .O(new_n116_));
  aoi21  g82(.a(new_n116_), .b(new_n48_), .c(x03), .O(new_n117_));
  oai21  g83(.a(new_n117_), .b(new_n42_), .c(new_n46_), .O(z12));
  nand2  g84(.a(new_n46_), .b(new_n42_), .O(z13));
