...
module FAU ( 
  ...
  nand2  g41(.a(x12), .b(new_n75_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n68_), .d(x08), .O(new_n77_));
  ...
  nand3  g47(.a(new_n81_), .b(new_n48_), .c(x04), .O(new_n82_));
  ...
  nand4  g52(.a(new_n83_), .b(new_n86_), .c(new_n36_), .d(new_n75_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n65_), .O(z07));
  nand3  g54(.a(x16), .b(new_n36_), .c(new_n35_), .O(new_n89_));
  oai21  g55(.a(new_n36_), .b(new_n75_), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(new_n47_), .b(new_n43_), .O(new_n92_));
  inv1   g58(.a(x16), .O(new_n93_));
  nand3  g59(.a(new_n75_), .b(new_n74_), .c(new_n68_), .O(new_n94_));
  oai22  g60(.a(new_n94_), .b(new_n66_), .c(new_n93_), .d(new_n61_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n36_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n92_), .c(new_n91_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n48_), .b(new_n98_), .c(new_n75_), .d(new_n74_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(x09), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(x08), .c(x07), .d(x06), .O(new_n101_));
  nand3  g67(.a(new_n83_), .b(new_n56_), .c(x08), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x13), .O(new_n103_));
  oai21  g69(.a(new_n101_), .b(new_n43_), .c(new_n103_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n36_), .O(new_n105_));
  nand2  g71(.a(x13), .b(x11), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n105_), .c(new_n65_), .O(z09));
  inv1   g73(.a(x00), .O(new_n108_));
  inv1   g74(.a(x14), .O(new_n109_));
  and2   g75(.a(new_n48_), .b(new_n68_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(x08), .c(x07), .d(x06), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n108_), .c(new_n48_), .d(new_n109_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nand4  g79(.a(new_n48_), .b(new_n98_), .c(new_n36_), .d(new_n75_), .O(new_n114_));
  ...
  oai21  g84(.a(new_n93_), .b(x02), .c(new_n61_), .O(new_n119_));
  nand3  g85(.a(new_n119_), .b(new_n47_), .c(x04), .O(new_n120_));
  inv1   g86(.a(new_n120_), .O(z12));
  aoi21  g87(.a(x12), .b(new_n75_), .c(new_n43_), .O(z13));
