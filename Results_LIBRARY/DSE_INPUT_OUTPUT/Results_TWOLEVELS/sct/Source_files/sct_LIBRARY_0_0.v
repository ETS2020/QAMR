...
module FAU ( 
  ...
  nand3  g21(.a(x16), .b(new_n47_), .c(x02), .O(new_n56_));
  nand2  g22(.a(new_n48_), .b(x15), .O(new_n57_));
  ...
  oai21  g37(.a(new_n43_), .b(x02), .c(new_n47_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x16), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n71_), .O(z05));
  nand2  g40(.a(new_n36_), .b(new_n43_), .O(new_n75_));
  nand2  g41(.a(new_n69_), .b(x10), .O(new_n76_));
  nor2   g42(.a(x10), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n61_), .c(x08), .O(new_n78_));
  and2   g44(.a(new_n78_), .b(new_n36_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n75_), .d(new_n73_), .O(z06));
  nand2  g46(.a(new_n78_), .b(x11), .O(new_n81_));
  nor4   g47(.a(new_n66_), .b(x11), .c(x10), .d(x09), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(new_n43_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n36_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n73_), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nor2   g53(.a(new_n82_), .b(new_n87_), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  inv1   g55(.a(new_n66_), .O(new_n90_));
  nand4  g56(.a(new_n77_), .b(new_n90_), .c(new_n87_), .d(new_n89_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n88_), .c(new_n36_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n73_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n58_), .b(new_n95_), .c(new_n87_), .d(new_n89_), .O(new_n96_));
  ...
  oai21  g67(.a(new_n48_), .b(new_n47_), .c(new_n36_), .O(new_n102_));
  aoi21  g68(.a(new_n91_), .b(x13), .c(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n101_), .c(new_n75_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  inv1   g71(.a(x10), .O(new_n106_));
  nand4  g72(.a(new_n95_), .b(new_n87_), .c(new_n89_), .d(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n58_), .c(new_n68_), .d(x08), .O(new_n109_));
  ...
  nor2   g79(.a(new_n35_), .b(new_n38_), .O(z11));
  aoi21  g80(.a(x16), .b(new_n38_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n43_), .c(new_n36_), .O(z12));
  nor2   g82(.a(new_n35_), .b(new_n43_), .O(z13));
