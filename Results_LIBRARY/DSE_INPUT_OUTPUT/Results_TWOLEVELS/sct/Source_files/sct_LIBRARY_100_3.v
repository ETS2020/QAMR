...
module FAU ( 
  ...
  nand3  g16(.a(new_n36_), .b(new_n50_), .c(x02), .O(new_n51_));
  ...
  nand2  g23(.a(new_n50_), .b(x02), .O(new_n58_));
  ...
  nand2  g31(.a(new_n38_), .b(new_n46_), .O(new_n66_));
  nand2  g32(.a(x04), .b(new_n40_), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n50_), .c(x17), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(x17), .c(x16), .O(new_n69_));
  nand3  g35(.a(x08), .b(x07), .c(x06), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x09), .O(new_n71_));
  inv1   g37(.a(x09), .O(new_n72_));
  nand3  g38(.a(new_n61_), .b(new_n72_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n69_), .d(new_n66_), .O(z05));
  inv1   g40(.a(x10), .O(new_n75_));
  nand4  g41(.a(new_n61_), .b(new_n75_), .c(new_n72_), .d(x08), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x04), .O(new_n77_));
  aoi21  g43(.a(new_n73_), .b(x10), .c(new_n77_), .O(new_n78_));
  nand2  g44(.a(new_n68_), .b(x16), .O(new_n79_));
  oai21  g45(.a(new_n78_), .b(new_n37_), .c(new_n79_), .O(z06));
  ...
  oai21  g50(.a(new_n84_), .b(new_n37_), .c(new_n79_), .O(z07));
  nor2   g51(.a(new_n81_), .b(x09), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n73_), .c(x12), .O(new_n87_));
  nand2  g53(.a(new_n75_), .b(new_n72_), .O(new_n88_));
  nor4   g54(.a(new_n88_), .b(new_n70_), .c(x12), .d(x11), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n87_), .c(new_n69_), .d(new_n66_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  oai21  g58(.a(new_n89_), .b(new_n92_), .c(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n38_), .O(new_n94_));
  inv1   g60(.a(x11), .O(new_n95_));
  inv1   g61(.a(x12), .O(new_n96_));
  nand4  g62(.a(new_n52_), .b(new_n92_), .c(new_n96_), .d(new_n95_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x10), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n72_), .c(x08), .d(x07), .O(new_n99_));
  nand3  g65(.a(new_n36_), .b(x16), .c(new_n40_), .O(new_n100_));
  oai21  g66(.a(new_n99_), .b(new_n49_), .c(new_n100_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand3  g68(.a(new_n36_), .b(x16), .c(x03), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n102_), .c(new_n94_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nand3  g71(.a(new_n81_), .b(new_n92_), .c(new_n96_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n52_), .c(new_n72_), .d(x08), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(x07), .c(x06), .O(new_n110_));
  nand4  g76(.a(new_n58_), .b(new_n36_), .c(x16), .d(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n46_), .O(z10));
  nor2   g78(.a(new_n37_), .b(new_n40_), .O(z11));
  nand2  g79(.a(new_n100_), .b(new_n50_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n38_), .O(z12));
  aoi21  g82(.a(x17), .b(x16), .c(new_n46_), .O(z13));
  aoi21  g83(.a(new_n35_), .b(new_n46_), .c(new_n36_), .O(z14));
endmodule
