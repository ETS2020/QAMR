...
module FAU ( 
  ...
  oai21  g41(.a(new_n66_), .b(new_n46_), .c(new_n49_), .O(new_n76_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n76_), .d(new_n49_), .O(z06));
  inv1   g47(.a(new_n66_), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand4  g50(.a(new_n69_), .b(new_n84_), .c(new_n83_), .d(new_n67_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  aoi21  g52(.a(new_n80_), .b(x11), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n82_), .c(new_n41_), .O(z07));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n79_), .b(new_n69_), .c(new_n89_), .d(new_n84_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  aoi21  g57(.a(new_n85_), .b(x12), .c(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n82_), .c(new_n41_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n51_), .b(new_n94_), .c(new_n89_), .d(new_n84_), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n83_), .c(new_n67_), .d(x08), .O(new_n97_));
  ...
  nand3  g66(.a(new_n100_), .b(new_n99_), .c(new_n76_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n103_));
  nand4  g69(.a(new_n94_), .b(new_n89_), .c(new_n84_), .d(new_n83_), .O(new_n104_));
  ...
  aoi21  g79(.a(x17), .b(new_n102_), .c(new_n46_), .O(z13));
  aoi21  g80(.a(new_n46_), .b(x00), .c(new_n40_), .O(z14));
endmodule
