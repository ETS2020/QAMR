...
module FAU ( 
  ...
  aoi21  g37(.a(new_n63_), .b(x16), .c(new_n44_), .O(new_n72_));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n40_), .O(z08));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n64_), .c(new_n40_), .O(z09));
  ...
  nand2  g65(.a(new_n99_), .b(new_n39_), .O(z10));
  nor2   g66(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g67(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n39_), .c(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z12));
  nor2   g70(.a(new_n40_), .b(new_n44_), .O(z13));
  nor2   g71(.a(new_n36_), .b(new_n44_), .O(z14));
endmodule
