...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n45_), .c(new_n37_), .O(new_n65_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n37_), .O(z05));
  nand2  g36(.a(new_n69_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n56_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(new_n37_), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n65_), .d(new_n37_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n81_), .c(new_n36_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n49_), .b(new_n87_), .c(new_n82_), .d(new_n77_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(x10), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n68_), .c(x08), .d(x07), .O(new_n90_));
  nand2  g56(.a(x16), .b(new_n41_), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n48_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  oai21  g59(.a(new_n62_), .b(new_n61_), .c(x04), .O(new_n94_));
  aoi21  g60(.a(new_n83_), .b(x13), .c(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n93_), .c(new_n36_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand4  g63(.a(new_n87_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  and2   g65(.a(new_n99_), .b(new_n49_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n68_), .c(x08), .d(x07), .O(new_n101_));
  oai22  g67(.a(new_n101_), .b(new_n48_), .c(new_n49_), .d(new_n39_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n37_), .c(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z10));
  nand2  g70(.a(new_n37_), .b(new_n41_), .O(z11));
  nor2   g71(.a(new_n36_), .b(new_n62_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n41_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n45_), .c(new_n37_), .O(z12));
