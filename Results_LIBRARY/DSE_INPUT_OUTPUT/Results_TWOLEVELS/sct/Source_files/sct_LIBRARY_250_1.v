...
module FAU ( 
  ...
  nor2   g01(.a(new_n35_), .b(x00), .O(new_n36_));
  ...
  nand2  g29(.a(x04), .b(new_n39_), .O(new_n64_));
  ...
  oai21  g35(.a(new_n69_), .b(new_n65_), .c(new_n37_), .O(new_n70_));
  ...
  oai21  g40(.a(new_n65_), .b(new_n45_), .c(new_n37_), .O(new_n75_));
  nand3  g41(.a(new_n58_), .b(new_n66_), .c(x08), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x10), .O(new_n77_));
  nor2   g43(.a(x10), .b(x09), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n58_), .c(x08), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n37_), .O(z06));
  nand2  g46(.a(new_n79_), .b(x11), .O(new_n81_));
  nor2   g47(.a(x11), .b(x10), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n68_), .c(new_n66_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n75_), .d(new_n37_), .O(z07));
  nand2  g50(.a(new_n83_), .b(x12), .O(new_n85_));
  nor2   g51(.a(x12), .b(x11), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n78_), .c(new_n68_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n75_), .d(new_n37_), .O(z08));
  nand2  g54(.a(new_n87_), .b(x13), .O(new_n89_));
  inv1   g55(.a(new_n76_), .O(new_n90_));
  nor2   g56(.a(x13), .b(x12), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n82_), .c(new_n90_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n89_), .c(new_n75_), .d(new_n37_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  inv1   g60(.a(x12), .O(new_n95_));
  nor2   g61(.a(x17), .b(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n82_), .c(new_n95_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n51_), .c(new_n66_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  nand4  g67(.a(new_n50_), .b(new_n37_), .c(x16), .d(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(z10));
  nor2   g69(.a(new_n36_), .b(new_n39_), .O(z11));
  nor2   g70(.a(new_n36_), .b(new_n63_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n39_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n45_), .c(new_n37_), .O(z12));
  nand2  g73(.a(new_n37_), .b(new_n45_), .O(z13));
  aoi21  g74(.a(new_n45_), .b(x00), .c(new_n35_), .O(z14));
endmodule
