...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n64_, new_n66_, new_n68_, new_n71_, new_n72_, new_n74_, new_n76_;
  ...
  nand3  g33(.a(new_n46_), .b(x16), .c(x14), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(new_n50_), .c(new_n42_), .O(z10));
  aoi21  g35(.a(x06), .b(x04), .c(new_n35_), .O(z11));
  oai21  g36(.a(new_n47_), .b(x02), .c(new_n45_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n50_), .c(x04), .O(new_n72_));
  inv1   g38(.a(new_n72_), .O(z12));
  oai21  g39(.a(x16), .b(x02), .c(new_n50_), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n48_), .c(new_n42_), .O(z13));
