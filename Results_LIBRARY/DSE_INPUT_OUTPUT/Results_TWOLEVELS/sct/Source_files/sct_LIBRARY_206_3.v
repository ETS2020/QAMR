...
module FAU ( 
  ...
  nand2  g17(.a(new_n49_), .b(x07), .O(new_n52_));
  aoi21  g18(.a(new_n52_), .b(new_n46_), .c(new_n43_), .O(z03));
  ...
  aoi21  g29(.a(x16), .b(new_n35_), .c(x06), .O(new_n64_));
  nand3  g30(.a(x16), .b(new_n46_), .c(x03), .O(new_n65_));
