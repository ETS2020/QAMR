...
module FAU ( 
  ...
  nand3  g17(.a(new_n36_), .b(x06), .c(x04), .O(new_n52_));
  ...
  oai21  g27(.a(x09), .b(new_n42_), .c(new_n36_), .O(new_n62_));
  oai21  g28(.a(new_n56_), .b(new_n48_), .c(x09), .O(new_n63_));
  ...
  oai21  g34(.a(x10), .b(new_n42_), .c(new_n36_), .O(new_n69_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n49_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n69_), .O(z06));
  oai21  g42(.a(x11), .b(new_n42_), .c(new_n36_), .O(new_n77_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n80_), .d(new_n64_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n79_), .c(new_n49_), .O(new_n85_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n72_), .c(new_n89_), .d(new_n81_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(new_n49_), .d(x04), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n49_), .b(new_n92_), .c(new_n89_), .d(new_n81_), .O(new_n93_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n92_), .b(new_n89_), .c(new_n81_), .d(new_n80_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n49_), .c(new_n64_), .d(x08), .O(new_n101_));
  ...
  aoi21  g71(.a(new_n105_), .b(new_n103_), .c(new_n42_), .O(z10));
  nor2   g72(.a(new_n37_), .b(new_n35_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n35_), .c(x03), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n42_), .O(z12));
