...
module FAU ( 
  ...
  nor2   g20(.a(new_n54_), .b(new_n36_), .O(new_n55_));
  ...
  oai21  g56(.a(new_n87_), .b(new_n36_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  oai21  g58(.a(x13), .b(new_n42_), .c(new_n36_), .O(new_n93_));
  ...
  oai21  g72(.a(new_n106_), .b(new_n42_), .c(new_n105_), .O(z12));
