...
module FAU ( 
  ...
  inv1   g55(.a(x17), .O(new_n90_));
  nand3  g56(.a(new_n50_), .b(x04), .c(new_n40_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n82_), .c(new_n78_), .d(new_n77_), .O(new_n93_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n78_), .c(new_n77_), .d(new_n40_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n40_), .c(new_n98_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n69_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n49_), .c(new_n50_), .d(new_n38_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n48_), .O(z10));
  nand2  g71(.a(new_n48_), .b(new_n35_), .O(z11));
  nor2   g72(.a(new_n41_), .b(new_n97_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n35_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n45_), .c(new_n48_), .O(z12));
  nand2  g75(.a(new_n48_), .b(new_n45_), .O(z13));
  nor2   g76(.a(new_n90_), .b(new_n45_), .O(z14));
endmodule
