...
module FAU ( 
  ...
  oai21  g29(.a(new_n63_), .b(new_n43_), .c(new_n42_), .O(new_n64_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n42_), .O(z05));
  nand2  g35(.a(new_n68_), .b(x10), .O(new_n70_));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n57_), .c(x08), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .d(new_n42_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n64_), .d(new_n42_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n64_), .d(new_n42_), .O(z08));
  inv1   g49(.a(new_n42_), .O(new_n84_));
  inv1   g50(.a(new_n63_), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n81_), .c(new_n76_), .d(new_n75_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n68_), .c(x04), .O(new_n88_));
  aoi21  g54(.a(new_n82_), .b(x13), .c(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n85_), .c(new_n84_), .O(z09));
  aoi21  g56(.a(new_n87_), .b(new_n35_), .c(new_n49_), .O(new_n91_));
  ...
  nand2  g61(.a(new_n95_), .b(new_n42_), .O(z10));
  nor2   g62(.a(new_n84_), .b(new_n36_), .O(z11));
  oai21  g63(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n42_), .c(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z12));
  nor2   g66(.a(new_n84_), .b(new_n43_), .O(z13));
  nand2  g67(.a(new_n42_), .b(x17), .O(new_n102_));
  nor2   g68(.a(new_n102_), .b(new_n43_), .O(z14));
endmodule
