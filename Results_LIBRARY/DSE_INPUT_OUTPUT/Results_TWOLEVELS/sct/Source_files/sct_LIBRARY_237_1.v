...
module FAU ( 
  ...
  nand3  g39(.a(new_n57_), .b(new_n65_), .c(x08), .O(new_n74_));
  ...
  nor2   g45(.a(new_n79_), .b(new_n40_), .O(z06));
  oai21  g46(.a(new_n64_), .b(new_n44_), .c(new_n39_), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(x11), .O(new_n82_));
  nor2   g48(.a(x11), .b(x10), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n67_), .c(new_n65_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n39_), .O(z07));
  ...
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n81_), .d(new_n39_), .O(z08));
  nand2  g55(.a(new_n88_), .b(x13), .O(new_n90_));
  inv1   g56(.a(new_n74_), .O(new_n91_));
  nor2   g57(.a(x13), .b(x12), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n83_), .c(new_n91_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n81_), .d(new_n39_), .O(z09));
  inv1   g60(.a(x11), .O(new_n95_));
  nor2   g61(.a(x10), .b(x01), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n92_), .c(new_n95_), .O(new_n97_));
  ...
  nor2   g69(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g70(.a(new_n62_), .b(x02), .c(new_n48_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n39_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nand2  g73(.a(new_n39_), .b(new_n44_), .O(z13));
