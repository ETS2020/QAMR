...
module FAU ( 
  ...
  nand2  g19(.a(new_n47_), .b(x02), .O(new_n54_));
  ...
  nand3  g29(.a(new_n54_), .b(x16), .c(x04), .O(new_n64_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n65_), .c(new_n36_), .O(new_n71_));
  nand2  g37(.a(new_n70_), .b(new_n35_), .O(new_n72_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n65_), .c(new_n36_), .O(new_n78_));
  ...
  oai21  g52(.a(new_n86_), .b(new_n65_), .c(new_n36_), .O(new_n87_));
  nand2  g53(.a(new_n86_), .b(new_n35_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n87_), .O(z07));
  inv1   g55(.a(new_n54_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n43_), .c(new_n36_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x16), .O(new_n92_));
  nand2  g58(.a(new_n52_), .b(new_n43_), .O(z13));
  nand2  g59(.a(new_n85_), .b(x12), .O(new_n94_));
  inv1   g60(.a(x12), .O(new_n95_));
  nand4  g61(.a(new_n75_), .b(new_n84_), .c(new_n95_), .d(new_n83_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n94_), .c(z13), .d(new_n92_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n49_), .b(new_n98_), .c(new_n95_), .d(new_n83_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(x10), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n68_), .c(x08), .d(x07), .O(new_n101_));
  nand3  g67(.a(new_n54_), .b(new_n36_), .c(x16), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n46_), .c(new_n102_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  aoi21  g70(.a(new_n96_), .b(x13), .c(new_n37_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n104_), .c(z13), .O(z09));
  inv1   g72(.a(x00), .O(new_n107_));
  nand4  g73(.a(new_n98_), .b(new_n95_), .c(new_n83_), .d(new_n82_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n49_), .c(new_n68_), .d(x08), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(x07), .c(x06), .O(new_n112_));
  inv1   g78(.a(new_n102_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(x14), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n112_), .c(new_n43_), .O(z10));
  nand2  g81(.a(new_n52_), .b(new_n38_), .O(z11));
  oai21  g82(.a(new_n36_), .b(new_n35_), .c(x03), .O(new_n117_));
  nand3  g83(.a(new_n36_), .b(x16), .c(new_n38_), .O(new_n118_));
  aoi21  g84(.a(new_n118_), .b(new_n117_), .c(new_n43_), .O(z12));
  nand2  g85(.a(x17), .b(x04), .O(new_n120_));
  nand2  g86(.a(new_n120_), .b(new_n52_), .O(z14));
endmodule
