...
module FAU ( 
  ...
  oai21  g34(.a(new_n68_), .b(new_n64_), .c(new_n45_), .O(new_n69_));
  ...
  nor2   g46(.a(new_n64_), .b(new_n41_), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(x11), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand4  g50(.a(new_n67_), .b(new_n84_), .c(new_n83_), .d(new_n65_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n82_), .c(new_n81_), .d(new_n45_), .O(z07));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n76_), .b(new_n67_), .c(new_n87_), .d(new_n84_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  aoi21  g55(.a(new_n85_), .b(x12), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n74_), .c(new_n42_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n87_), .c(new_n84_), .d(new_n83_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n75_), .c(x04), .O(new_n94_));
  aoi21  g60(.a(new_n88_), .b(x13), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g68(.a(new_n102_), .b(new_n45_), .O(z10));
  nand2  g69(.a(new_n45_), .b(new_n62_), .O(z11));
  oai21  g70(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n45_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nand2  g73(.a(new_n45_), .b(new_n41_), .O(z13));
