...
module FAU ( 
  ...
  nand2  g29(.a(x04), .b(new_n41_), .O(new_n64_));
  ...
  nor2   g44(.a(new_n78_), .b(new_n65_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(new_n36_), .O(z06));
  oai21  g46(.a(new_n65_), .b(new_n46_), .c(new_n37_), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(x11), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand4  g50(.a(new_n68_), .b(new_n84_), .c(new_n83_), .d(new_n66_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n82_), .c(new_n81_), .d(new_n37_), .O(z07));
  nand2  g52(.a(new_n85_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n76_), .b(new_n68_), .c(new_n88_), .d(new_n84_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n81_), .d(new_n37_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n50_), .b(new_n35_), .c(new_n91_), .d(new_n88_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n84_), .c(new_n83_), .d(x04), .O(new_n94_));
  nand2  g60(.a(x13), .b(x10), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(x09), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand3  g63(.a(new_n88_), .b(new_n84_), .c(new_n66_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n67_), .c(x13), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n81_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n62_), .b(x02), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(x16), .c(x09), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(x08), .c(x07), .d(x06), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n101_), .c(new_n50_), .d(new_n39_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n37_), .O(new_n106_));
  nand4  g72(.a(new_n93_), .b(new_n84_), .c(new_n83_), .d(new_n66_), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(x08), .c(x07), .d(x06), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n106_), .c(new_n46_), .O(z10));
  nand2  g76(.a(new_n37_), .b(new_n41_), .O(z11));
  oai21  g77(.a(new_n63_), .b(x02), .c(new_n62_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n37_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  aoi21  g80(.a(x17), .b(new_n91_), .c(new_n46_), .O(z13));
  nand3  g81(.a(x17), .b(x13), .c(x04), .O(new_n116_));
