...
module FAU ( 
  ...
  oai21  g34(.a(new_n67_), .b(new_n62_), .c(new_n68_), .O(new_n69_));
  ...
  oai21  g46(.a(new_n74_), .b(x17), .c(new_n80_), .O(z05));
  nor2   g47(.a(new_n76_), .b(new_n46_), .O(new_n82_));
  nand2  g48(.a(new_n78_), .b(x10), .O(new_n83_));
  nor2   g49(.a(x10), .b(x09), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n57_), .c(x08), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n40_), .O(z06));
  ...
  nand4  g61(.a(new_n84_), .b(new_n90_), .c(new_n95_), .d(new_n89_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  aoi21  g63(.a(new_n91_), .b(x12), .c(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n87_), .c(new_n41_), .O(z08));
  nand2  g65(.a(new_n96_), .b(x13), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n87_), .c(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n40_), .O(new_n102_));
  nand3  g68(.a(new_n50_), .b(x04), .c(new_n62_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(x17), .c(x13), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n95_), .c(new_n89_), .d(new_n88_), .O(new_n105_));
  nor2   g71(.a(new_n105_), .b(x09), .O(new_n106_));
  ...
  nand4  g75(.a(new_n109_), .b(new_n89_), .c(new_n88_), .d(new_n62_), .O(new_n110_));
  inv1   g76(.a(x17), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x00), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n110_), .c(new_n65_), .O(new_n113_));
  nand4  g79(.a(new_n113_), .b(new_n77_), .c(x08), .d(x07), .O(new_n114_));
  oai22  g80(.a(new_n114_), .b(new_n49_), .c(new_n50_), .d(new_n38_), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n40_), .O(z10));
  nor2   g83(.a(new_n41_), .b(new_n35_), .O(z11));
  nand3  g84(.a(new_n40_), .b(x16), .c(new_n35_), .O(new_n119_));
  nand2  g85(.a(new_n119_), .b(new_n63_), .O(new_n120_));
  nand2  g86(.a(new_n120_), .b(x04), .O(new_n121_));
  nand2  g87(.a(new_n121_), .b(new_n40_), .O(z12));
  nand2  g88(.a(new_n40_), .b(new_n46_), .O(z13));
  nand3  g89(.a(x17), .b(x04), .c(new_n62_), .O(new_n124_));
