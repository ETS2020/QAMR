...
module FAU ( 
  ...
  nand3  g14(.a(new_n48_), .b(x02), .c(new_n38_), .O(new_n49_));
  ...
  nand2  g38(.a(new_n53_), .b(new_n44_), .O(z13));
  ...
  nand4  g55(.a(new_n55_), .b(new_n89_), .c(new_n86_), .d(new_n81_), .O(new_n90_));
  ...
  aoi21  g63(.a(new_n48_), .b(x02), .c(new_n39_), .O(new_n98_));
