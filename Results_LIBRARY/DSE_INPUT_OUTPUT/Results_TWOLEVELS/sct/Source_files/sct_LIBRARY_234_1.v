...
module FAU ( 
  ...
  nand2  g09(.a(x17), .b(new_n35_), .O(new_n44_));
  ...
  nand4  g16(.a(new_n50_), .b(new_n44_), .c(new_n46_), .d(x04), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(z02));
  xor2a  g18(.a(x07), .b(x06), .O(new_n53_));
  nand3  g19(.a(new_n53_), .b(new_n50_), .c(x04), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n44_), .O(z03));
  ...
  nand2  g26(.a(new_n60_), .b(new_n44_), .O(z04));
  oai21  g27(.a(new_n42_), .b(x02), .c(new_n47_), .O(new_n62_));
  aoi21  g28(.a(new_n62_), .b(x16), .c(new_n42_), .O(new_n63_));
  ...
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(new_n44_), .O(z05));
  nand2  g34(.a(new_n67_), .b(x10), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n57_), .c(x08), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n63_), .d(new_n44_), .O(z06));
  inv1   g38(.a(new_n44_), .O(new_n73_));
  nand2  g39(.a(new_n62_), .b(x16), .O(new_n74_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n74_), .c(new_n73_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n82_), .c(new_n76_), .d(new_n75_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n67_), .c(x04), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x13), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n74_), .c(new_n73_), .O(z09));
  ...
  nand2  g63(.a(new_n97_), .b(new_n44_), .O(z10));
  and2   g64(.a(new_n44_), .b(x02), .O(z11));
  oai21  g65(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n44_), .c(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z12));
  aoi21  g68(.a(x17), .b(new_n35_), .c(new_n42_), .O(z13));
  nand3  g69(.a(x17), .b(x04), .c(x01), .O(new_n104_));
