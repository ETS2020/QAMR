...
module FAU ( 
  ...
  nand2  g16(.a(new_n50_), .b(new_n41_), .O(z03));
  ...
  nand4  g44(.a(new_n69_), .b(new_n75_), .c(new_n78_), .d(new_n74_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x04), .O(new_n80_));
  aoi21  g46(.a(new_n76_), .b(x12), .c(new_n80_), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n60_), .c(new_n42_), .O(z08));
  nand2  g48(.a(new_n79_), .b(x13), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n60_), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n41_), .O(new_n85_));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n46_), .b(x04), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(x01), .c(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n78_), .c(new_n74_), .d(new_n73_), .O(new_n89_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n74_), .c(new_n73_), .d(new_n86_), .O(new_n94_));
  oai21  g60(.a(x01), .b(new_n86_), .c(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n46_), .c(new_n65_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  nand2  g64(.a(new_n58_), .b(x02), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n41_), .c(x16), .d(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n98_), .c(new_n40_), .O(z10));
  nor2   g67(.a(new_n42_), .b(new_n35_), .O(z11));
  inv1   g68(.a(x16), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(x02), .c(new_n58_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n41_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z12));
  nor2   g72(.a(new_n42_), .b(new_n40_), .O(z13));
  nand2  g73(.a(x17), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n41_), .O(z14));
endmodule
