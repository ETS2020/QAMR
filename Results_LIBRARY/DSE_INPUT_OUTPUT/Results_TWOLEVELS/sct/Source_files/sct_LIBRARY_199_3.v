...
module FAU ( 
  ...
  oai22  g29(.a(new_n63_), .b(new_n35_), .c(new_n59_), .d(x02), .O(new_n64_));
  ...
  nand2  g35(.a(x04), .b(new_n36_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n60_), .c(new_n59_), .O(new_n71_));
  inv1   g37(.a(x09), .O(new_n72_));
  nand3  g38(.a(new_n54_), .b(new_n72_), .c(x08), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n66_), .c(x04), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n71_), .c(new_n35_), .O(new_n75_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n77_), .c(new_n43_), .O(z06));
  nor2   g48(.a(new_n71_), .b(new_n41_), .O(new_n83_));
  nand2  g49(.a(new_n79_), .b(x11), .O(new_n84_));
  inv1   g50(.a(x10), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  inv1   g52(.a(new_n65_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n72_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n84_), .c(new_n83_), .d(new_n42_), .O(z07));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n78_), .b(new_n87_), .c(new_n90_), .d(new_n86_), .O(new_n91_));
  ...
  nand3  g61(.a(new_n95_), .b(new_n77_), .c(x04), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n42_), .O(new_n97_));
  nand3  g63(.a(new_n47_), .b(x04), .c(new_n35_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(x01), .c(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n90_), .c(new_n86_), .d(new_n85_), .O(new_n100_));
  ...
  nand4  g70(.a(new_n104_), .b(new_n86_), .c(new_n85_), .d(new_n35_), .O(new_n105_));
  oai21  g71(.a(x01), .b(new_n35_), .c(new_n105_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n47_), .c(new_n72_), .d(x08), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(x07), .c(x06), .O(new_n109_));
  nand4  g75(.a(new_n61_), .b(new_n42_), .c(x16), .d(x14), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n41_), .O(z10));
  nor2   g77(.a(new_n43_), .b(new_n36_), .O(z11));
  oai21  g78(.a(new_n59_), .b(x02), .c(new_n60_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n42_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n42_), .b(new_n41_), .O(z13));
