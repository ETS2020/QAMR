...
module FAU ( 
  ...
  nor2   g41(.a(new_n66_), .b(new_n46_), .O(new_n76_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n69_), .c(new_n67_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n80_), .b(x11), .c(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n65_), .c(new_n41_), .O(z07));
  inv1   g52(.a(x11), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n79_), .b(new_n69_), .c(new_n88_), .d(new_n87_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  aoi21  g56(.a(new_n83_), .b(x12), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n65_), .c(new_n41_), .O(z08));
  nand2  g58(.a(new_n89_), .b(x13), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n65_), .c(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n49_), .O(new_n95_));
  inv1   g61(.a(x10), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand3  g63(.a(new_n51_), .b(new_n40_), .c(x04), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n88_), .c(new_n87_), .d(new_n96_), .O(new_n100_));
  ...
  aoi21  g70(.a(new_n63_), .b(x02), .c(new_n104_), .O(new_n105_));
  nor2   g71(.a(x17), .b(x13), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n82_), .c(new_n88_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n97_), .c(new_n105_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n67_), .c(x08), .d(x07), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n50_), .c(new_n51_), .d(new_n38_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n49_), .O(z10));
  nor2   g78(.a(new_n41_), .b(new_n35_), .O(z11));
  nor2   g79(.a(new_n41_), .b(new_n104_), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n35_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n46_), .c(new_n49_), .O(z12));
  nand2  g82(.a(new_n49_), .b(new_n46_), .O(z13));
  nand3  g83(.a(x17), .b(x04), .c(x00), .O(new_n118_));
