...
module FAU ( 
  ...
  oai21  g15(.a(x03), .b(new_n42_), .c(x16), .O(new_n50_));
  ...
  nor2   g24(.a(new_n53_), .b(new_n35_), .O(new_n59_));
  ...
  oai21  g32(.a(x06), .b(new_n47_), .c(x15), .O(new_n67_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n36_), .c(new_n78_), .d(new_n77_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n68_), .d(new_n66_), .O(z06));
  nand2  g47(.a(x08), .b(x07), .O(new_n82_));
  nor2   g48(.a(x11), .b(x10), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n77_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n82_), .c(new_n36_), .O(new_n85_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n68_), .d(new_n66_), .O(z07));
  nand2  g56(.a(new_n86_), .b(x12), .O(new_n91_));
  nor2   g57(.a(x15), .b(x12), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n83_), .c(new_n69_), .d(new_n59_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n91_), .c(new_n68_), .d(new_n66_), .O(z08));
  inv1   g60(.a(x11), .O(new_n95_));
  inv1   g61(.a(x12), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n50_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n98_));
  ...
  oai21  g68(.a(new_n100_), .b(new_n47_), .c(new_n102_), .O(new_n103_));
  ...
  nand4  g73(.a(new_n83_), .b(new_n36_), .c(new_n97_), .d(new_n96_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  and2   g75(.a(new_n109_), .b(new_n50_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n77_), .c(x08), .d(x07), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n35_), .c(new_n50_), .d(new_n40_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n38_), .O(z10));
  nor2   g80(.a(new_n37_), .b(new_n42_), .O(z11));
  nand3  g81(.a(new_n38_), .b(x16), .c(new_n42_), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(new_n117_));
  oai21  g83(.a(new_n117_), .b(x03), .c(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n38_), .O(z12));
  nor2   g85(.a(new_n37_), .b(new_n47_), .O(z13));
