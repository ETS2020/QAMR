...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(new_n47_), .c(new_n38_), .d(x04), .O(new_n51_));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n61_), .c(new_n39_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n63_), .d(new_n38_), .O(z08));
  ...
  nand3  g53(.a(new_n47_), .b(x04), .c(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(x01), .c(x13), .O(new_n89_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n74_), .c(new_n73_), .d(new_n87_), .O(new_n95_));
  oai21  g61(.a(x01), .b(new_n87_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g69(.a(new_n38_), .b(x16), .c(new_n35_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n59_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n38_), .O(z12));
  nor2   g73(.a(new_n39_), .b(new_n43_), .O(z13));
