...
module FAU ( 
  ...
  nand2  g15(.a(new_n49_), .b(new_n45_), .O(z03));
  ...
  nand4  g20(.a(new_n54_), .b(new_n45_), .c(new_n44_), .d(x04), .O(new_n55_));
  ...
  nand3  g37(.a(new_n71_), .b(new_n52_), .c(x08), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n59_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n45_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n68_), .O(z06));
  nand3  g41(.a(new_n58_), .b(new_n45_), .c(x16), .O(new_n76_));
  nand2  g42(.a(new_n72_), .b(x11), .O(new_n77_));
  inv1   g43(.a(x10), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  nand4  g45(.a(new_n63_), .b(new_n79_), .c(new_n78_), .d(new_n61_), .O(new_n80_));
  and2   g46(.a(new_n80_), .b(new_n45_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n76_), .d(new_n68_), .O(z07));
  nand2  g48(.a(new_n80_), .b(x12), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n71_), .b(new_n63_), .c(new_n84_), .d(new_n79_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(new_n59_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n45_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n68_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n44_), .b(new_n89_), .c(new_n84_), .d(new_n79_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n78_), .c(new_n61_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(x07), .c(x06), .d(x04), .O(new_n94_));
  nand2  g60(.a(new_n85_), .b(x13), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n68_), .c(new_n45_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n94_), .c(new_n76_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  inv1   g65(.a(x16), .O(new_n100_));
  aoi21  g66(.a(new_n57_), .b(x02), .c(new_n100_), .O(new_n101_));
  nand4  g67(.a(new_n89_), .b(new_n84_), .c(new_n79_), .d(new_n78_), .O(new_n102_));
  ...
  nand3  g75(.a(new_n45_), .b(x16), .c(new_n35_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n57_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n45_), .O(z12));
  aoi21  g79(.a(x05), .b(x01), .c(new_n38_), .O(z13));
  nand3  g80(.a(new_n45_), .b(x17), .c(x04), .O(new_n115_));
