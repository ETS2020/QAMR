...
module FAU ( 
  ...
  nand2  g31(.a(x16), .b(new_n48_), .O(new_n66_));
  oai21  g32(.a(new_n65_), .b(new_n36_), .c(new_n66_), .O(new_n67_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n74_), .c(new_n43_), .O(z06));
  inv1   g50(.a(x10), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  inv1   g52(.a(new_n68_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n75_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  aoi21  g55(.a(new_n81_), .b(x11), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n74_), .c(new_n43_), .O(z07));
  inv1   g57(.a(x12), .O(new_n92_));
  nand4  g58(.a(new_n80_), .b(new_n87_), .c(new_n92_), .d(new_n86_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  aoi21  g60(.a(new_n88_), .b(x12), .c(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n74_), .c(new_n43_), .O(z08));
  nand2  g62(.a(new_n93_), .b(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n74_), .c(x04), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n47_), .O(new_n99_));
  nand3  g65(.a(new_n49_), .b(x04), .c(new_n36_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n35_), .c(x13), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n92_), .c(new_n86_), .d(new_n85_), .O(new_n102_));
  ...
  nand2  g71(.a(x01), .b(x00), .O(new_n106_));
  nor2   g72(.a(x13), .b(x12), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n86_), .c(new_n85_), .d(new_n36_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n106_), .c(new_n63_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n75_), .c(x08), .d(x07), .O(new_n110_));
  oai22  g76(.a(new_n110_), .b(new_n46_), .c(new_n49_), .d(new_n37_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n47_), .O(z10));
  nor2   g79(.a(new_n43_), .b(new_n48_), .O(z11));
  nand2  g80(.a(new_n66_), .b(new_n61_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n47_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n47_), .b(new_n42_), .O(z13));
