...
module FAU ( 
  ...
  nor2   g50(.a(new_n73_), .b(new_n44_), .O(new_n85_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n85_), .d(new_n39_), .O(z07));
  ...
  nand3  g65(.a(new_n48_), .b(x04), .c(new_n35_), .O(new_n100_));
  ...
  inv1   g71(.a(x01), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x00), .O(new_n107_));
  nor2   g73(.a(x13), .b(x12), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n88_), .c(new_n87_), .d(new_n35_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n62_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n74_), .c(x08), .d(x07), .O(new_n111_));
  nor2   g77(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  aoi21  g78(.a(new_n62_), .b(x14), .c(new_n112_), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n44_), .c(new_n39_), .O(z10));
  nor2   g80(.a(new_n40_), .b(new_n36_), .O(z11));
  nand3  g81(.a(new_n39_), .b(x16), .c(new_n36_), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n39_), .O(z12));
  nor2   g85(.a(new_n40_), .b(new_n44_), .O(z13));
  nand3  g86(.a(new_n39_), .b(x17), .c(x04), .O(new_n121_));
