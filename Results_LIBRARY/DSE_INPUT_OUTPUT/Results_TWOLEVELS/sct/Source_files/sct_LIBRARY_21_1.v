...
module FAU ( 
  ...
  oai21  g29(.a(new_n63_), .b(new_n41_), .c(new_n47_), .O(new_n64_));
  ...
  nand3  g52(.a(new_n48_), .b(x04), .c(new_n42_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n35_), .c(x13), .O(new_n88_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n76_), .c(new_n75_), .d(new_n42_), .O(new_n94_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n47_), .c(x16), .d(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n98_), .c(new_n41_), .O(z10));
  nand2  g67(.a(new_n47_), .b(new_n36_), .O(z11));
