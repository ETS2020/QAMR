...
module FAU ( 
  ...
  aoi21  g15(.a(new_n49_), .b(x17), .c(x06), .O(z02));
  inv1   g16(.a(x06), .O(new_n51_));
  nand3  g17(.a(x17), .b(x07), .c(new_n51_), .O(new_n52_));
  ...
  oai21  g22(.a(new_n56_), .b(new_n51_), .c(x08), .O(new_n57_));
  ...
  oai21  g33(.a(new_n67_), .b(x09), .c(new_n51_), .O(new_n68_));
  oai21  g34(.a(new_n58_), .b(new_n56_), .c(x09), .O(new_n69_));
  ...
  nor2   g41(.a(new_n58_), .b(new_n56_), .O(new_n76_));
  ...
  nand3  g45(.a(x17), .b(x10), .c(new_n51_), .O(new_n80_));
  ...
  nand3  g52(.a(x17), .b(x11), .c(new_n51_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n66_), .O(z07));
  oai21  g54(.a(new_n67_), .b(x12), .c(new_n51_), .O(new_n89_));
  ...
  nand3  g60(.a(new_n94_), .b(new_n89_), .c(new_n66_), .O(z08));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n48_), .b(new_n96_), .c(new_n91_), .d(new_n83_), .O(new_n97_));
  ...
  nand3  g69(.a(x17), .b(x13), .c(new_n51_), .O(new_n104_));
