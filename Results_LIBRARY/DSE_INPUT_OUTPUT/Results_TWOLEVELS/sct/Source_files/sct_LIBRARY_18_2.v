...
module FAU ( 
  ...
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n44_), .O(z07));
  ...
  aoi21  g62(.a(new_n96_), .b(new_n43_), .c(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n68_), .c(x08), .d(x07), .O(new_n98_));
  oai22  g64(.a(new_n98_), .b(new_n48_), .c(new_n49_), .d(new_n35_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n47_), .O(z10));
  nand2  g67(.a(new_n47_), .b(new_n37_), .O(z11));
  oai21  g68(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n47_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z12));
  nand2  g71(.a(new_n47_), .b(new_n42_), .O(z13));
  inv1   g72(.a(x17), .O(new_n107_));
  nor3   g73(.a(new_n44_), .b(new_n107_), .c(new_n42_), .O(z14));
endmodule
