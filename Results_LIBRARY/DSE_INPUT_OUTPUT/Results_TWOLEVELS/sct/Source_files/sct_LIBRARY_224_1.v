...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n65_), .d(new_n37_), .O(z07));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n63_), .c(new_n36_), .O(z08));
  ...
  nand3  g56(.a(new_n49_), .b(new_n35_), .c(x04), .O(new_n91_));
  ...
  nand3  g63(.a(new_n97_), .b(new_n77_), .c(new_n81_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n49_), .c(new_n68_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n61_), .b(x02), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n37_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n102_), .c(new_n45_), .O(z10));
  nor2   g71(.a(new_n36_), .b(new_n39_), .O(z11));
  inv1   g72(.a(x16), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(x02), .c(new_n61_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n37_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nand2  g76(.a(new_n37_), .b(new_n45_), .O(z13));
