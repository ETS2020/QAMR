...
module FAU ( 
  ...
  aoi21  g58(.a(new_n85_), .b(x13), .c(new_n39_), .O(new_n93_));
  ...
  nand4  g63(.a(new_n87_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n95_), .c(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n68_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n46_), .c(new_n49_), .d(new_n36_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n47_), .O(z10));
  nand2  g69(.a(new_n47_), .b(new_n48_), .O(z11));
  oai21  g70(.a(new_n96_), .b(x02), .c(new_n61_), .O(new_n105_));
