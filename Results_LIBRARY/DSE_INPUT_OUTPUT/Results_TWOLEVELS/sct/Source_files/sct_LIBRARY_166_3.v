...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n63_, new_n65_, new_n67_, new_n69_, new_n70_, new_n71_, new_n74_,
  ...
  aoi21  g27(.a(x16), .b(new_n37_), .c(x07), .O(new_n62_));
  nand3  g28(.a(x16), .b(new_n47_), .c(x03), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(x04), .O(z07));
  inv1   g30(.a(x12), .O(new_n65_));
  nand4  g31(.a(new_n63_), .b(new_n62_), .c(new_n65_), .d(x04), .O(z08));
  aoi21  g32(.a(new_n56_), .b(x16), .c(x13), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(x07), .c(x04), .O(z09));
  inv1   g34(.a(x16), .O(new_n69_));
  aoi21  g35(.a(new_n55_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(x14), .c(new_n47_), .O(new_n71_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n47_), .c(new_n43_), .O(z14));
endmodule
