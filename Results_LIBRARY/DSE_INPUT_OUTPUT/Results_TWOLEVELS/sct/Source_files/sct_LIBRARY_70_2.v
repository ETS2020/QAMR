...
module FAU ( 
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n65_), .d(new_n47_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n71_), .b(new_n79_), .c(new_n82_), .d(new_n78_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n80_), .b(x12), .c(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n63_), .c(new_n43_), .O(z08));
  nand2  g52(.a(new_n83_), .b(x13), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n63_), .c(x04), .O(new_n88_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n82_), .c(new_n78_), .d(new_n77_), .O(new_n92_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n78_), .c(new_n77_), .d(new_n36_), .O(new_n97_));
  ...
  nand2  g70(.a(new_n47_), .b(new_n48_), .O(z11));
