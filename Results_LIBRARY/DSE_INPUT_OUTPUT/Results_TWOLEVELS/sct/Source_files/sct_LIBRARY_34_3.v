...
module FAU ( 
  ...
  nand2  g27(.a(new_n36_), .b(x14), .O(new_n62_));
  inv1   g28(.a(x02), .O(new_n63_));
  nand2  g29(.a(x17), .b(x14), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  oai21  g31(.a(new_n62_), .b(new_n47_), .c(new_n65_), .O(new_n66_));
  and2   g32(.a(new_n66_), .b(x04), .O(new_n67_));
  nor2   g33(.a(x14), .b(new_n47_), .O(new_n68_));
  ...
  nand2  g42(.a(new_n45_), .b(new_n41_), .O(new_n77_));
  ...
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(new_n45_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n69_), .O(z08));
  nand2  g61(.a(new_n66_), .b(x16), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  oai21  g63(.a(new_n49_), .b(x14), .c(new_n62_), .O(new_n98_));
  ...
  oai21  g67(.a(new_n101_), .b(new_n46_), .c(new_n96_), .O(new_n102_));
  ...
  nand4  g71(.a(new_n105_), .b(new_n104_), .c(new_n45_), .d(x04), .O(new_n106_));
  ...
  nand2  g80(.a(new_n47_), .b(x02), .O(new_n115_));
  nand4  g81(.a(new_n115_), .b(new_n36_), .c(x16), .d(x14), .O(new_n116_));
  aoi21  g82(.a(new_n116_), .b(new_n114_), .c(new_n41_), .O(z10));
  nor2   g83(.a(new_n42_), .b(new_n63_), .O(z11));
  nand3  g84(.a(new_n64_), .b(x16), .c(new_n63_), .O(new_n119_));
  nand2  g85(.a(new_n45_), .b(x03), .O(new_n120_));
  aoi21  g86(.a(new_n120_), .b(new_n119_), .c(new_n41_), .O(z12));
  aoi21  g87(.a(x17), .b(x14), .c(new_n41_), .O(z13));
  aoi21  g88(.a(new_n35_), .b(new_n41_), .c(new_n36_), .O(z14));
endmodule
