...
module FAU ( 
  ...
  nand2  g31(.a(x15), .b(x00), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(new_n44_), .O(new_n67_));
  ...
  nor2   g38(.a(new_n72_), .b(new_n39_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n69_), .c(new_n67_), .d(new_n65_), .O(z05));
  nand2  g40(.a(new_n64_), .b(x16), .O(new_n75_));
  ...
  nand2  g46(.a(new_n80_), .b(new_n67_), .O(z06));
  ...
  and2   g52(.a(new_n86_), .b(new_n38_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n82_), .c(new_n67_), .d(new_n65_), .O(z07));
  nand2  g54(.a(new_n86_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n77_), .b(new_n90_), .c(new_n84_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n85_), .c(new_n39_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n89_), .c(new_n67_), .d(new_n65_), .O(z08));
  oai21  g60(.a(new_n91_), .b(new_n68_), .c(x13), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n90_), .c(new_n84_), .d(new_n83_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n72_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n95_), .c(new_n75_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n38_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n67_), .O(z09));
  aoi21  g68(.a(new_n97_), .b(new_n41_), .c(new_n51_), .O(new_n103_));
  ...
  nand3  g75(.a(new_n38_), .b(x16), .c(new_n35_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n49_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n38_), .O(z12));
  nand2  g79(.a(new_n38_), .b(new_n44_), .O(z13));
