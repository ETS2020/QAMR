...
module FAU ( 
  ...
  nor2   g06(.a(x18), .b(new_n40_), .O(new_n41_));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n41_), .O(z08));
  ...
  aoi21  g60(.a(new_n85_), .b(x13), .c(new_n41_), .O(new_n95_));
  ...
  nor2   g74(.a(new_n41_), .b(new_n45_), .O(z13));
