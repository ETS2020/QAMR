...
module FAU ( 
  ...
  nand4  g60(.a(new_n82_), .b(new_n89_), .c(new_n94_), .d(new_n88_), .O(new_n95_));
  ...
  oai21  g64(.a(new_n75_), .b(new_n44_), .c(new_n48_), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n50_), .b(new_n100_), .c(new_n94_), .d(new_n88_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n87_), .c(new_n76_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(x07), .c(x06), .d(x04), .O(new_n105_));
  aoi21  g71(.a(new_n95_), .b(x13), .c(new_n40_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n105_), .c(new_n99_), .O(z09));
  nand2  g73(.a(x01), .b(x00), .O(new_n108_));
  nand4  g74(.a(new_n100_), .b(new_n94_), .c(new_n88_), .d(new_n87_), .O(new_n109_));
  aoi22  g75(.a(new_n109_), .b(new_n108_), .c(new_n63_), .d(x16), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n76_), .c(x08), .d(x07), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n47_), .c(new_n50_), .d(new_n36_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n48_), .O(z10));
  nor2   g80(.a(new_n40_), .b(new_n49_), .O(z11));
  nand2  g81(.a(new_n66_), .b(new_n62_), .O(new_n116_));
