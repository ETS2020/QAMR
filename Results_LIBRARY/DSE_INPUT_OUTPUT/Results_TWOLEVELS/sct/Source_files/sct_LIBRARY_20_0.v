...
module FAU ( 
  ...
  oai21  g42(.a(new_n63_), .b(new_n42_), .c(new_n46_), .O(new_n77_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n77_), .d(new_n46_), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n77_), .d(new_n46_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n48_), .b(new_n88_), .c(new_n85_), .d(new_n80_), .O(new_n89_));
  ...
  oai21  g58(.a(new_n91_), .b(new_n47_), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  oai21  g60(.a(new_n61_), .b(new_n60_), .c(x04), .O(new_n95_));
  aoi21  g61(.a(new_n86_), .b(x13), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n43_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n88_), .b(new_n85_), .c(new_n80_), .d(new_n79_), .O(new_n99_));
  ...
  oai22  g68(.a(new_n102_), .b(new_n47_), .c(new_n48_), .d(new_n37_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n46_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z10));
  nand2  g71(.a(new_n46_), .b(new_n35_), .O(z11));
  nor3   g72(.a(new_n43_), .b(new_n61_), .c(x02), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(x03), .c(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n46_), .O(z12));
  nor2   g75(.a(new_n43_), .b(new_n42_), .O(z13));
  inv1   g76(.a(x17), .O(new_n111_));
  nor3   g77(.a(new_n43_), .b(new_n111_), .c(new_n42_), .O(z14));
endmodule
