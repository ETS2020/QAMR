...
module FAU ( 
  ...
  aoi21  g50(.a(new_n84_), .b(new_n63_), .c(new_n39_), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n49_), .b(new_n86_), .c(new_n81_), .d(new_n77_), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n76_), .c(new_n68_), .d(x08), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(x07), .c(x06), .d(x04), .O(new_n91_));
  aoi21  g57(.a(new_n82_), .b(x13), .c(new_n39_), .O(new_n92_));
  ...
  nand4  g62(.a(new_n86_), .b(new_n81_), .c(new_n77_), .d(new_n76_), .O(new_n97_));
  ...
  nor2   g68(.a(new_n39_), .b(new_n48_), .O(z11));
