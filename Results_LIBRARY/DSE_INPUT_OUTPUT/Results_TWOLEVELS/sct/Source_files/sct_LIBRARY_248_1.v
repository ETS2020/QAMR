...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n64_), .d(new_n46_), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n62_), .c(new_n43_), .O(z08));
  ...
  nand3  g53(.a(new_n48_), .b(x04), .c(new_n42_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n35_), .c(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n80_), .c(new_n76_), .d(new_n75_), .O(new_n90_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n76_), .c(new_n75_), .d(new_n42_), .O(new_n95_));
  ...
  nor2   g68(.a(new_n43_), .b(new_n36_), .O(z11));
  inv1   g69(.a(x16), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(x02), .c(new_n60_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n46_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nor2   g73(.a(new_n43_), .b(new_n41_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n46_), .O(z14));
endmodule
