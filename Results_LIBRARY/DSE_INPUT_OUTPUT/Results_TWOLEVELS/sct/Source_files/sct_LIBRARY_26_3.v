...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n64_, new_n65_, new_n67_, new_n69_, new_n72_, new_n73_, new_n75_,
  ...
  aoi21  g15(.a(new_n49_), .b(new_n46_), .c(new_n43_), .O(z02));
  ...
  oai21  g29(.a(new_n43_), .b(x02), .c(new_n47_), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(x16), .c(x12), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(x06), .c(x04), .O(z08));
  aoi21  g32(.a(new_n64_), .b(x16), .c(x13), .O(new_n67_));
  oai21  g33(.a(new_n67_), .b(x06), .c(x04), .O(z09));
  nand3  g34(.a(new_n49_), .b(x14), .c(new_n46_), .O(new_n69_));
  nor2   g35(.a(new_n69_), .b(new_n43_), .O(z10));
  aoi21  g36(.a(x06), .b(x04), .c(new_n37_), .O(z11));
  oai21  g37(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n46_), .c(x04), .O(new_n73_));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n46_), .c(new_n43_), .O(z14));
endmodule
