...
module FAU ( 
  ...
  aoi21  g36(.a(new_n70_), .b(new_n64_), .c(new_n39_), .O(z05));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n39_), .O(z08));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n64_), .c(new_n39_), .O(z09));
  ...
  nor2   g66(.a(new_n39_), .b(new_n36_), .O(z11));
  ...
  nor2   g70(.a(new_n39_), .b(new_n43_), .O(z13));
