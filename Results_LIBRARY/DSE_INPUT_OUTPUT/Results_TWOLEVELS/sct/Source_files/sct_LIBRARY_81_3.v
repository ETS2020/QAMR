...
module FAU ( 
  ...
  nand3  g18(.a(x09), .b(x07), .c(new_n47_), .O(new_n53_));
  aoi21  g19(.a(new_n53_), .b(new_n52_), .c(x01), .O(new_n54_));
  nand2  g20(.a(x07), .b(new_n47_), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n52_), .c(x09), .O(new_n56_));
  ...
  nand4  g34(.a(new_n48_), .b(x07), .c(new_n47_), .d(x04), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(x08), .c(x07), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(x09), .c(new_n41_), .O(new_n71_));
  nand3  g37(.a(new_n60_), .b(new_n42_), .c(x08), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n68_), .O(z05));
  oai21  g39(.a(x10), .b(x01), .c(x09), .O(new_n74_));
  nand3  g40(.a(x08), .b(x07), .c(x06), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x10), .O(new_n76_));
  inv1   g42(.a(x10), .O(new_n77_));
  nand4  g43(.a(new_n60_), .b(new_n77_), .c(new_n42_), .d(x08), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n68_), .O(z06));
  inv1   g45(.a(x11), .O(new_n80_));
  nor2   g46(.a(x10), .b(new_n59_), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n60_), .c(new_n80_), .O(new_n82_));
  nand3  g48(.a(new_n80_), .b(new_n77_), .c(x08), .O(new_n83_));
  nor3   g49(.a(new_n83_), .b(new_n51_), .c(new_n47_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n82_), .c(new_n42_), .O(new_n85_));
  nand3  g51(.a(x11), .b(x09), .c(new_n41_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n68_), .O(z07));
  inv1   g53(.a(x12), .O(new_n88_));
  inv1   g54(.a(new_n75_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n80_), .d(new_n77_), .O(new_n90_));
  oai21  g56(.a(new_n84_), .b(new_n88_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n42_), .O(new_n92_));
  nand3  g58(.a(x12), .b(x09), .c(new_n41_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n68_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n48_), .b(new_n95_), .c(new_n88_), .d(new_n80_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n77_), .c(new_n42_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(x07), .c(x06), .d(x04), .O(new_n100_));
  aoi21  g66(.a(new_n95_), .b(new_n41_), .c(new_n42_), .O(new_n101_));
  aoi21  g67(.a(new_n90_), .b(x13), .c(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n100_), .c(new_n68_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  inv1   g70(.a(x03), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x02), .c(new_n65_), .O(new_n106_));
  nand4  g72(.a(new_n95_), .b(new_n88_), .c(new_n80_), .d(new_n77_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n104_), .c(new_n106_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n42_), .c(x08), .d(x07), .O(new_n109_));
  ...
  oai21  g80(.a(new_n65_), .b(x02), .c(new_n105_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n46_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nor2   g83(.a(new_n43_), .b(new_n40_), .O(z13));
