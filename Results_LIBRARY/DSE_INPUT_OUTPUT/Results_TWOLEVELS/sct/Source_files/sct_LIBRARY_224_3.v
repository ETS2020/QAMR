...
module FAU ( 
  ...
  nand2  g18(.a(new_n52_), .b(new_n35_), .O(z03));
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n35_), .O(z05));
  nand2  g35(.a(new_n68_), .b(x10), .O(new_n70_));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n55_), .c(x08), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .d(new_n35_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n64_), .d(new_n35_), .O(z07));
  ...
  nand3  g54(.a(new_n48_), .b(x04), .c(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x17), .c(x13), .O(new_n90_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n76_), .c(new_n75_), .d(new_n88_), .O(new_n96_));
  oai21  g62(.a(x17), .b(new_n88_), .c(new_n96_), .O(new_n97_));
  ...
  nand4  g67(.a(new_n101_), .b(new_n35_), .c(x16), .d(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n44_), .O(z10));
  nor2   g69(.a(new_n40_), .b(new_n37_), .O(z11));
  inv1   g70(.a(x16), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(x02), .c(new_n60_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n35_), .c(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z12));
  nand2  g74(.a(new_n35_), .b(new_n44_), .O(z13));
  nand3  g75(.a(x17), .b(x04), .c(new_n88_), .O(new_n110_));
