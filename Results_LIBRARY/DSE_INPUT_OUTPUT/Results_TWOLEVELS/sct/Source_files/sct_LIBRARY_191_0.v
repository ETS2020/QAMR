...
module FAU ( 
  ...
  aoi21  g26(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(new_n61_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n50_), .d(x04), .O(z05));
  ...
  aoi21  g53(.a(new_n78_), .b(x12), .c(new_n87_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n43_), .c(new_n84_), .O(z08));
  inv1   g55(.a(new_n46_), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n50_), .b(new_n92_), .c(new_n91_), .d(new_n76_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x10), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n67_), .c(x08), .d(x07), .O(new_n95_));
  nand3  g61(.a(new_n81_), .b(new_n71_), .c(new_n77_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(x13), .c(new_n87_), .O(new_n97_));
  oai21  g63(.a(new_n95_), .b(new_n45_), .c(new_n97_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n90_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand4  g67(.a(new_n92_), .b(new_n91_), .c(new_n76_), .d(new_n75_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n87_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n67_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n45_), .c(new_n50_), .d(new_n39_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n56_), .O(z10));
  nand2  g73(.a(new_n56_), .b(new_n36_), .O(z11));
  nand2  g74(.a(x16), .b(new_n36_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n85_), .c(new_n43_), .O(z12));
