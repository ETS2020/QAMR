...
module FAU ( 
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .d(new_n46_), .O(z06));
  nand2  g39(.a(new_n72_), .b(x11), .O(new_n74_));
  inv1   g40(.a(new_n65_), .O(new_n75_));
  nor2   g41(.a(x11), .b(x10), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n67_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n64_), .d(new_n46_), .O(z07));
  nand2  g44(.a(new_n77_), .b(x12), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n71_), .b(new_n75_), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n79_), .c(new_n64_), .d(new_n46_), .O(z08));
  nand2  g49(.a(new_n82_), .b(x13), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n63_), .c(new_n46_), .O(new_n86_));
  inv1   g52(.a(x10), .O(new_n87_));
  inv1   g53(.a(x00), .O(new_n88_));
  nand3  g54(.a(new_n48_), .b(new_n38_), .c(x04), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n81_), .c(new_n80_), .d(new_n87_), .O(new_n91_));
  ...
  nor2   g60(.a(x17), .b(x13), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n76_), .c(new_n81_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n48_), .c(new_n67_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(x07), .c(x06), .O(new_n100_));
  nand2  g66(.a(new_n60_), .b(x02), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n46_), .c(x16), .d(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n43_), .O(z10));
  nor2   g69(.a(new_n39_), .b(new_n35_), .O(z11));
  nor2   g70(.a(new_n39_), .b(new_n61_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n35_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n43_), .c(new_n46_), .O(z12));
  aoi21  g73(.a(x17), .b(new_n88_), .c(new_n43_), .O(z13));
  nand3  g74(.a(x17), .b(x04), .c(x00), .O(new_n109_));
