...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n115_, new_n118_;
  nand2  g00(.a(x17), .b(x05), .O(new_n35_));
  ...
  nand2  g25(.a(new_n59_), .b(new_n35_), .O(z04));
  ...
  oai21  g35(.a(new_n69_), .b(new_n64_), .c(new_n35_), .O(new_n70_));
  nand2  g36(.a(x17), .b(x05), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n42_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n70_), .O(z05));
  nand3  g39(.a(new_n62_), .b(new_n35_), .c(x16), .O(new_n74_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n74_), .d(new_n72_), .O(z06));
  ...
  nand3  g49(.a(new_n83_), .b(new_n80_), .c(new_n63_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n35_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n72_), .O(z07));
  nand2  g52(.a(new_n83_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n76_), .b(new_n67_), .c(new_n88_), .d(new_n82_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n87_), .c(new_n63_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n35_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n72_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n49_), .b(new_n93_), .c(new_n88_), .d(new_n82_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n81_), .c(new_n65_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(x07), .c(x06), .d(x04), .O(new_n98_));
  nand2  g64(.a(new_n89_), .b(x13), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n72_), .c(new_n35_), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n98_), .c(new_n74_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  inv1   g69(.a(x16), .O(new_n104_));
  aoi21  g70(.a(new_n61_), .b(x02), .c(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n93_), .b(new_n88_), .c(new_n82_), .d(new_n81_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n103_), .c(new_n105_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n65_), .c(x08), .d(x07), .O(new_n108_));
  oai22  g74(.a(new_n108_), .b(new_n48_), .c(new_n49_), .d(new_n37_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n35_), .O(z10));
  aoi21  g77(.a(x17), .b(x05), .c(new_n39_), .O(z11));
  nand3  g78(.a(new_n35_), .b(x16), .c(new_n39_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n61_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n35_), .O(z12));
  aoi21  g82(.a(x17), .b(x05), .c(new_n42_), .O(z13));
  nand3  g83(.a(x17), .b(new_n44_), .c(x04), .O(new_n118_));
