...
module FAU ( 
  ...
  nand2  g00(.a(x17), .b(x12), .O(new_n35_));
  ...
  nand4  g16(.a(new_n50_), .b(new_n35_), .c(new_n49_), .d(x04), .O(new_n51_));
  ...
  nor2   g36(.a(new_n70_), .b(new_n65_), .O(new_n71_));
  nor2   g37(.a(new_n71_), .b(new_n36_), .O(z05));
  oai21  g38(.a(new_n65_), .b(new_n46_), .c(new_n35_), .O(new_n73_));
  nand2  g39(.a(new_n69_), .b(x10), .O(new_n74_));
  nor2   g40(.a(x10), .b(x09), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n57_), .c(x08), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n35_), .O(z06));
  nand2  g43(.a(new_n76_), .b(x11), .O(new_n78_));
  inv1   g44(.a(x10), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  inv1   g46(.a(new_n66_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n68_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n73_), .d(new_n35_), .O(z07));
  inv1   g49(.a(x17), .O(new_n84_));
  nand3  g50(.a(new_n82_), .b(new_n84_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n75_), .b(new_n81_), .c(new_n86_), .d(new_n80_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n73_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n50_), .b(new_n89_), .c(new_n80_), .d(new_n79_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(x09), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(x08), .c(x07), .d(x06), .O(new_n92_));
  nand2  g58(.a(new_n82_), .b(x13), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n46_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n86_), .O(new_n95_));
  nand3  g61(.a(new_n84_), .b(x13), .c(x12), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n73_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  and2   g64(.a(new_n50_), .b(new_n68_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(x08), .c(x07), .d(x06), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n98_), .c(new_n50_), .d(new_n40_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n35_), .O(new_n102_));
  nand4  g68(.a(new_n50_), .b(new_n89_), .c(new_n86_), .d(new_n80_), .O(new_n103_));
  nor3   g69(.a(new_n103_), .b(x10), .c(x09), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(x08), .c(x07), .d(x06), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n102_), .c(new_n46_), .O(z10));
  nor2   g72(.a(new_n36_), .b(new_n37_), .O(z11));
  nand3  g73(.a(new_n35_), .b(x16), .c(new_n37_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n62_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n35_), .O(z12));
  aoi21  g77(.a(x17), .b(x12), .c(new_n46_), .O(z13));
  nand3  g78(.a(x17), .b(new_n86_), .c(x04), .O(new_n113_));
