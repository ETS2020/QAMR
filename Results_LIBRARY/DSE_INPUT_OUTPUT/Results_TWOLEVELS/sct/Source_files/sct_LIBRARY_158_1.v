...
module FAU ( 
  ...
  oai21  g28(.a(new_n62_), .b(new_n40_), .c(new_n46_), .O(new_n63_));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n73_), .c(new_n42_), .O(z07));
  ...
  aoi21  g56(.a(new_n83_), .b(x13), .c(new_n42_), .O(new_n91_));
  ...
  nand4  g60(.a(new_n85_), .b(new_n82_), .c(new_n75_), .d(new_n74_), .O(new_n95_));
  ...
  nand2  g66(.a(new_n100_), .b(new_n46_), .O(z10));
  nand2  g67(.a(new_n46_), .b(new_n35_), .O(z11));
  nor2   g68(.a(new_n42_), .b(new_n60_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n35_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n40_), .c(new_n46_), .O(z12));
  nor2   g71(.a(new_n42_), .b(new_n40_), .O(z13));
  nand2  g72(.a(x17), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n46_), .O(z14));
endmodule
