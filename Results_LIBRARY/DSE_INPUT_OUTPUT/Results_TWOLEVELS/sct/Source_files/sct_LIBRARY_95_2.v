...
module FAU ( 
  ...
  aoi21  g22(.a(x15), .b(new_n56_), .c(new_n35_), .O(new_n57_));
  nor2   g23(.a(new_n56_), .b(new_n35_), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(x15), .c(new_n55_), .O(new_n59_));
  oai21  g25(.a(new_n57_), .b(new_n55_), .c(new_n59_), .O(new_n60_));
  ...
  nor2   g38(.a(new_n55_), .b(new_n56_), .O(new_n73_));
  ...
  nand4  g46(.a(new_n80_), .b(x15), .c(new_n79_), .d(new_n78_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n68_), .d(new_n65_), .O(z06));
  nor2   g48(.a(x10), .b(x09), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n73_), .c(new_n66_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n35_), .c(x11), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  nand4  g52(.a(new_n83_), .b(new_n80_), .c(x15), .d(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n68_), .d(new_n65_), .O(z07));
  nor3   g54(.a(x11), .b(x10), .c(x09), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n73_), .c(new_n66_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n35_), .c(x12), .O(new_n91_));
  nor2   g57(.a(x11), .b(x10), .O(new_n92_));
  nor2   g58(.a(new_n66_), .b(x12), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n69_), .d(new_n58_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n68_), .d(new_n65_), .O(z08));
  inv1   g61(.a(x12), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n49_), .b(new_n97_), .c(new_n96_), .d(new_n86_), .O(new_n98_));
  nor3   g64(.a(new_n98_), .b(x10), .c(x09), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(x08), .c(x07), .d(x06), .O(new_n100_));
  nand3  g66(.a(new_n96_), .b(new_n86_), .c(new_n79_), .O(new_n101_));
  ...
  nand4  g73(.a(new_n92_), .b(x15), .c(new_n97_), .d(new_n96_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  and2   g75(.a(new_n109_), .b(new_n49_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n78_), .c(x08), .d(x07), .O(new_n111_));
