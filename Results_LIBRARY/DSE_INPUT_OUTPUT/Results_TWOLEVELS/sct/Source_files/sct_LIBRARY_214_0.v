...
module FAU ( 
  ...
  nor2   g01(.a(x14), .b(x01), .O(new_n36_));
  ...
  oai21  g35(.a(new_n69_), .b(new_n42_), .c(new_n35_), .O(new_n70_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n73_), .c(new_n37_), .O(new_n77_));
  ...
  oai21  g50(.a(new_n84_), .b(new_n36_), .c(new_n71_), .O(z07));
  ...
  oai21  g55(.a(new_n89_), .b(new_n86_), .c(new_n37_), .O(new_n90_));
  ...
  oai21  g61(.a(new_n48_), .b(new_n35_), .c(new_n69_), .O(new_n96_));
  ...
  nor2   g76(.a(new_n36_), .b(new_n65_), .O(z11));
