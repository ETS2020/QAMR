...
module FAU ( 
  ...
  nand4  g25(.a(new_n59_), .b(new_n50_), .c(new_n45_), .d(x04), .O(new_n60_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n64_), .d(new_n45_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n64_), .d(new_n45_), .O(z08));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n84_), .c(new_n42_), .O(z09));
  ...
  nand2  g61(.a(new_n95_), .b(new_n45_), .O(z10));
  nor2   g62(.a(new_n42_), .b(new_n36_), .O(z11));
  oai21  g63(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n45_), .c(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z12));
  nor2   g66(.a(new_n42_), .b(new_n41_), .O(z13));
  inv1   g67(.a(x17), .O(new_n102_));
  nor3   g68(.a(new_n42_), .b(new_n102_), .c(new_n41_), .O(z14));
endmodule
