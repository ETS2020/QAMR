...
module FAU ( 
  ...
  aoi21  g56(.a(new_n90_), .b(new_n63_), .c(new_n36_), .O(z09));
  ...
  nand2  g63(.a(new_n97_), .b(new_n35_), .O(z10));
  nor2   g64(.a(new_n36_), .b(new_n37_), .O(z11));
  nand3  g65(.a(new_n35_), .b(x16), .c(new_n37_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n35_), .O(z12));
  nand2  g69(.a(new_n35_), .b(new_n43_), .O(z13));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nor2   g71(.a(new_n105_), .b(x18), .O(z14));
endmodule
