...
module FAU ( 
  ...
  nand4  g19(.a(new_n49_), .b(x08), .c(new_n46_), .d(x04), .O(new_n54_));
  ...
  aoi21  g25(.a(x16), .b(new_n37_), .c(x06), .O(new_n60_));
  nand3  g26(.a(x16), .b(new_n46_), .c(x03), .O(new_n61_));
  ...
  aoi21  g36(.a(x06), .b(x04), .c(new_n37_), .O(z11));
  ...
  nor2   g41(.a(x03), .b(x02), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(x16), .c(x02), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n46_), .c(x04), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(z13));
  inv1   g45(.a(x17), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(new_n46_), .c(new_n43_), .O(z14));
endmodule
