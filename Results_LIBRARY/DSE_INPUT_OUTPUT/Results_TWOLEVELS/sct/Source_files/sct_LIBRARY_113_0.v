...
module FAU ( 
  ...
  oai22  g07(.a(new_n41_), .b(new_n35_), .c(new_n36_), .d(x04), .O(z01));
  inv1   g08(.a(x06), .O(new_n43_));
  inv1   g09(.a(x02), .O(new_n44_));
  oai21  g10(.a(x03), .b(new_n44_), .c(x16), .O(new_n45_));
  nand2  g11(.a(new_n36_), .b(new_n35_), .O(new_n46_));
  nand4  g12(.a(new_n46_), .b(new_n45_), .c(new_n43_), .d(x04), .O(new_n47_));
  ...
  aoi21  g39(.a(new_n73_), .b(new_n61_), .c(new_n69_), .O(z06));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n61_), .c(new_n69_), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n63_), .d(new_n46_), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n45_), .b(new_n86_), .c(new_n83_), .d(new_n76_), .O(new_n87_));
  ...
  aoi21  g57(.a(new_n84_), .b(x13), .c(new_n69_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n63_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  inv1   g60(.a(x16), .O(new_n95_));
  aoi21  g61(.a(new_n58_), .b(x02), .c(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n86_), .b(new_n83_), .c(new_n76_), .d(new_n75_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n94_), .c(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n66_), .c(x08), .d(x07), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n43_), .c(new_n45_), .d(new_n37_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n46_), .O(z10));
  nand2  g68(.a(new_n46_), .b(new_n44_), .O(z11));
  nor3   g69(.a(new_n69_), .b(new_n95_), .c(x02), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(x03), .c(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n46_), .O(z12));
  nor2   g72(.a(new_n69_), .b(new_n59_), .O(z13));
  nand2  g73(.a(new_n46_), .b(x17), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n59_), .O(z14));
endmodule
