...
module FAU ( 
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n66_), .d(new_n37_), .O(z07));
  ...
  aoi21  g51(.a(new_n80_), .b(x12), .c(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n82_), .c(new_n36_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n50_), .b(new_n88_), .c(new_n83_), .d(new_n78_), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(x10), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n69_), .c(x08), .d(x07), .O(new_n91_));
  nand2  g57(.a(x16), .b(new_n41_), .O(new_n92_));
  oai21  g58(.a(new_n91_), .b(new_n49_), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  oai21  g60(.a(new_n63_), .b(new_n62_), .c(x04), .O(new_n95_));
  aoi21  g61(.a(new_n84_), .b(x13), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n36_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n88_), .b(new_n83_), .c(new_n78_), .d(new_n77_), .O(new_n99_));
  ...
  nor2   g72(.a(new_n36_), .b(new_n63_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n41_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n46_), .c(new_n37_), .O(z12));
  nand2  g75(.a(new_n37_), .b(new_n46_), .O(z13));
  aoi21  g76(.a(x18), .b(new_n46_), .c(new_n35_), .O(z14));
endmodule
