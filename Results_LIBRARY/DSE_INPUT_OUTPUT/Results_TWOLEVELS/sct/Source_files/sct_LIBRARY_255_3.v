...
module FAU ( 
  ...
  nand2  g03(.a(x17), .b(x01), .O(new_n38_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n38_), .O(z05));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n63_), .c(new_n39_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n38_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n69_), .c(x04), .O(new_n89_));
  aoi21  g55(.a(new_n85_), .b(x13), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n63_), .c(new_n39_), .O(z09));
  ...
  nand2  g68(.a(new_n38_), .b(new_n43_), .O(z13));
  inv1   g69(.a(x01), .O(new_n104_));
  nand3  g70(.a(x17), .b(x04), .c(new_n104_), .O(new_n105_));
