...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n94_, new_n95_, new_n98_, new_n100_;
  ...
  oai21  g33(.a(x11), .b(new_n41_), .c(new_n35_), .O(new_n68_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n61_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n70_), .c(new_n47_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n68_), .O(z07));
  nand2  g43(.a(new_n74_), .b(x12), .O(new_n78_));
  inv1   g44(.a(x12), .O(new_n79_));
  nand4  g45(.a(new_n65_), .b(new_n73_), .c(new_n79_), .d(new_n72_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n47_), .d(x04), .O(z08));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n47_), .b(new_n82_), .c(new_n79_), .d(new_n72_), .O(new_n83_));
  nor3   g49(.a(new_n83_), .b(x10), .c(x09), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(x08), .c(x07), .d(x06), .O(new_n85_));
  nand2  g51(.a(new_n80_), .b(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n47_), .d(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  nand4  g54(.a(new_n82_), .b(new_n79_), .c(new_n72_), .d(new_n71_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n47_), .c(new_n61_), .d(x08), .O(new_n91_));
  ...
  aoi21  g61(.a(new_n95_), .b(new_n93_), .c(new_n41_), .O(z10));
  nor2   g62(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g63(.a(x16), .b(new_n37_), .c(x03), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n41_), .O(z12));
  nand2  g65(.a(x17), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n46_), .O(z14));
  buf    g67(.a(x04), .O(z13));
endmodule
