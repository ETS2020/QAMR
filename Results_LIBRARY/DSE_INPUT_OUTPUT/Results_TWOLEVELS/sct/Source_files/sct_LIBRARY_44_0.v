...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n36_), .O(new_n65_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n35_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n36_), .O(z08));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n75_), .c(new_n35_), .O(z09));
  ...
  nand2  g64(.a(new_n36_), .b(new_n38_), .O(z11));
  ...
  nor2   g68(.a(new_n35_), .b(new_n44_), .O(z13));
