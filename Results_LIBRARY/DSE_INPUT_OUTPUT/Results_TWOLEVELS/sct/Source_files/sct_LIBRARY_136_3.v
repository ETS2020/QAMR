...
module FAU ( 
  ...
  nand4  g20(.a(new_n54_), .b(new_n51_), .c(new_n38_), .d(x04), .O(new_n55_));
  ...
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n38_), .O(new_n65_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(new_n38_), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n65_), .d(new_n38_), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n65_), .d(new_n38_), .O(z08));
  ...
  aoi21  g57(.a(new_n87_), .b(new_n91_), .c(new_n50_), .O(new_n92_));
  ...
  nand3  g64(.a(new_n38_), .b(x16), .c(new_n35_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n48_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n38_), .O(z12));
  aoi21  g68(.a(x17), .b(x00), .c(new_n44_), .O(z13));
  inv1   g69(.a(x17), .O(new_n104_));
  aoi21  g70(.a(new_n44_), .b(new_n91_), .c(new_n104_), .O(z14));
endmodule
