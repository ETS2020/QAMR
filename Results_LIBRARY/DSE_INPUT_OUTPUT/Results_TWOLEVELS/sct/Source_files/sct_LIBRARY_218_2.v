...
module FAU ( 
  ...
  nor2   g06(.a(x15), .b(new_n40_), .O(new_n41_));
  ...
  nand2  g20(.a(new_n54_), .b(new_n49_), .O(z03));
  ...
  oai21  g31(.a(new_n65_), .b(new_n45_), .c(new_n49_), .O(new_n66_));
  ...
  aoi21  g47(.a(new_n74_), .b(x11), .c(new_n81_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n76_), .c(new_n41_), .O(z07));
  nand2  g49(.a(new_n80_), .b(x12), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n73_), .b(new_n79_), .c(new_n85_), .d(new_n78_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n66_), .d(new_n49_), .O(z08));
  ...
  aoi21  g61(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n96_));
  nand4  g62(.a(new_n88_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n40_), .c(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n69_), .c(x08), .d(x07), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n48_), .c(new_n50_), .d(new_n38_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n49_), .O(z10));
  nor2   g68(.a(new_n41_), .b(new_n35_), .O(z11));
  nor2   g69(.a(new_n41_), .b(new_n63_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n35_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n45_), .c(new_n49_), .O(z12));
  nand2  g72(.a(new_n49_), .b(new_n45_), .O(z13));
