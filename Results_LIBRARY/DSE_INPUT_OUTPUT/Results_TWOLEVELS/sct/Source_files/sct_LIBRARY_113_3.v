...
module FAU ( 
  ...
  nand3  g26(.a(new_n60_), .b(new_n47_), .c(x16), .O(new_n61_));
  oai21  g27(.a(new_n38_), .b(new_n41_), .c(new_n42_), .O(new_n62_));
  ...
  and2   g32(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n64_), .c(new_n62_), .d(new_n61_), .O(z05));
  nand2  g34(.a(new_n60_), .b(x16), .O(new_n69_));
  ...
  nand2  g48(.a(new_n82_), .b(new_n62_), .O(z07));
  nand2  g49(.a(new_n80_), .b(x12), .O(new_n84_));
  inv1   g50(.a(new_n47_), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n71_), .b(new_n86_), .c(new_n78_), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n79_), .c(new_n85_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n84_), .c(new_n62_), .d(new_n61_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n46_), .b(new_n91_), .c(new_n86_), .d(new_n78_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n77_), .c(new_n65_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(x07), .c(x06), .d(x04), .O(new_n96_));
  oai21  g62(.a(new_n87_), .b(new_n63_), .c(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n62_), .c(new_n47_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n96_), .c(new_n61_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  inv1   g67(.a(x16), .O(new_n102_));
  aoi21  g68(.a(new_n59_), .b(x02), .c(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n91_), .b(new_n86_), .c(new_n78_), .d(new_n77_), .O(new_n104_));
  ...
  nand2  g76(.a(new_n47_), .b(new_n35_), .O(z11));
  nand3  g77(.a(new_n47_), .b(x16), .c(new_n35_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n59_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n47_), .O(z12));
  nor2   g81(.a(new_n85_), .b(new_n42_), .O(z13));
