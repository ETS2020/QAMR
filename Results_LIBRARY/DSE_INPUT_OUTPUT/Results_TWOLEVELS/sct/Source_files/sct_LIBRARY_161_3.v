...
module FAU ( 
  ...
  aoi21  g56(.a(new_n90_), .b(new_n79_), .c(new_n43_), .O(z07));
  nor2   g57(.a(new_n73_), .b(new_n41_), .O(new_n92_));
  nand2  g58(.a(new_n88_), .b(x12), .O(new_n93_));
  inv1   g59(.a(x12), .O(new_n94_));
  nand4  g60(.a(new_n80_), .b(new_n87_), .c(new_n94_), .d(new_n86_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n47_), .O(z08));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n94_), .c(new_n86_), .d(new_n85_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n75_), .c(x04), .O(new_n99_));
  aoi21  g65(.a(new_n95_), .b(x13), .c(new_n99_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n79_), .c(new_n43_), .O(z09));
  inv1   g67(.a(x14), .O(new_n102_));
  nand2  g68(.a(new_n42_), .b(x00), .O(new_n103_));
  aoi22  g69(.a(new_n103_), .b(new_n98_), .c(new_n49_), .d(x16), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n74_), .c(x08), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n46_), .c(new_n50_), .d(new_n102_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n47_), .O(z10));
  nor2   g74(.a(new_n43_), .b(new_n36_), .O(z11));
  ...
  nand3  g79(.a(new_n47_), .b(x17), .c(x04), .O(new_n114_));
