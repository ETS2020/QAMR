...
module FAU ( 
  ...
  oai21  g06(.a(x12), .b(x05), .c(new_n36_), .O(new_n41_));
  ...
  nand3  g37(.a(new_n71_), .b(new_n67_), .c(new_n46_), .O(new_n72_));
  ...
  nand4  g43(.a(new_n64_), .b(new_n70_), .c(new_n74_), .d(new_n69_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n46_), .d(x04), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n46_), .b(new_n80_), .c(new_n74_), .d(new_n69_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(x10), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n60_), .c(x08), .d(x07), .O(new_n83_));
  inv1   g49(.a(new_n46_), .O(new_n84_));
  aoi21  g50(.a(new_n78_), .b(x13), .c(new_n84_), .O(new_n85_));
  oai21  g51(.a(new_n83_), .b(new_n45_), .c(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n75_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  nand4  g55(.a(new_n80_), .b(new_n74_), .c(new_n69_), .d(new_n68_), .O(new_n90_));
  ...
  nand2  g60(.a(new_n84_), .b(x14), .O(new_n95_));
  ...
  nand2  g65(.a(new_n74_), .b(new_n36_), .O(z13));
