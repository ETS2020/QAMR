...
module FAU ( 
  ...
  nand2  g00(.a(x18), .b(x05), .O(new_n35_));
  ...
  aoi21  g11(.a(new_n43_), .b(new_n45_), .c(new_n36_), .O(new_n46_));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n63_), .c(new_n36_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n63_), .c(new_n36_), .O(z08));
  ...
  aoi21  g58(.a(new_n83_), .b(x13), .c(new_n36_), .O(new_n93_));
  ...
  oai22  g66(.a(new_n100_), .b(new_n48_), .c(new_n49_), .d(new_n40_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n35_), .O(z10));
  nor2   g69(.a(new_n36_), .b(new_n37_), .O(z11));
  nand3  g70(.a(new_n35_), .b(x16), .c(new_n37_), .O(new_n105_));
  ...
  nor2   g74(.a(new_n36_), .b(new_n45_), .O(z13));
  nand2  g75(.a(x17), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n35_), .O(z14));
endmodule
