...
module FAU ( 
  ...
  nand3  g18(.a(x15), .b(x07), .c(new_n52_), .O(new_n53_));
  ...
  nor2   g24(.a(new_n58_), .b(new_n52_), .O(new_n59_));
  ...
  oai21  g32(.a(new_n48_), .b(new_n45_), .c(new_n52_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(x16), .c(x03), .O(new_n68_));
  oai21  g34(.a(new_n48_), .b(x09), .c(new_n52_), .O(new_n69_));
  nor2   g35(.a(new_n57_), .b(new_n58_), .O(new_n70_));
  inv1   g36(.a(new_n70_), .O(new_n71_));
  nor2   g37(.a(x09), .b(new_n57_), .O(new_n72_));
  aoi22  g38(.a(new_n72_), .b(new_n59_), .c(new_n71_), .d(x09), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n69_), .c(new_n68_), .d(new_n66_), .O(z05));
  nand2  g40(.a(new_n72_), .b(x07), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x10), .O(new_n76_));
  inv1   g42(.a(x09), .O(new_n77_));
  inv1   g43(.a(x10), .O(new_n78_));
  nand3  g44(.a(new_n70_), .b(new_n78_), .c(new_n77_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand3  g47(.a(x15), .b(x10), .c(new_n52_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n68_), .d(new_n66_), .O(z06));
  oai21  g49(.a(new_n48_), .b(x11), .c(new_n52_), .O(new_n84_));
  nand2  g50(.a(new_n70_), .b(x06), .O(new_n85_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n84_), .c(new_n68_), .d(new_n66_), .O(z07));
  inv1   g55(.a(x12), .O(new_n90_));
  aoi21  g56(.a(new_n87_), .b(new_n70_), .c(new_n90_), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  nand3  g58(.a(new_n90_), .b(new_n92_), .c(new_n78_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n75_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n91_), .c(x06), .O(new_n95_));
  nand3  g61(.a(x15), .b(x12), .c(new_n52_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n68_), .d(new_n66_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n49_), .b(new_n98_), .c(new_n90_), .d(new_n92_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(x10), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n77_), .c(x08), .d(x07), .O(new_n101_));
  oai21  g67(.a(new_n93_), .b(new_n75_), .c(x13), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n45_), .c(new_n102_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x06), .O(new_n104_));
  nand3  g70(.a(x15), .b(x13), .c(new_n52_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n104_), .c(new_n68_), .d(new_n66_), .O(z09));
  inv1   g72(.a(x00), .O(new_n107_));
  inv1   g73(.a(new_n49_), .O(new_n108_));
  nand4  g74(.a(new_n98_), .b(new_n90_), .c(new_n92_), .d(new_n78_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n108_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n77_), .c(x08), .d(x07), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n52_), .c(new_n49_), .d(new_n38_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n36_), .O(z10));
  nor2   g80(.a(new_n35_), .b(new_n40_), .O(z11));
  nor3   g81(.a(new_n35_), .b(new_n64_), .c(x02), .O(new_n116_));
  oai21  g82(.a(new_n116_), .b(x03), .c(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n36_), .O(z12));
  aoi21  g84(.a(new_n48_), .b(new_n52_), .c(new_n45_), .O(z13));
