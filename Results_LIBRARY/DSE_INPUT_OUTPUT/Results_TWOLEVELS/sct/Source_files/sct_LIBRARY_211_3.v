...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_,
    ...
    new_n94_, new_n95_, new_n98_, new_n99_, new_n100_, new_n103_;
  ...
  oai21  g29(.a(new_n63_), .b(new_n43_), .c(new_n38_), .O(new_n64_));
  ...
  inv1   g49(.a(new_n63_), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n76_), .d(new_n75_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n68_), .c(x04), .O(new_n87_));
  aoi21  g53(.a(new_n82_), .b(x13), .c(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n84_), .c(new_n39_), .O(z09));
  ...
  nand2  g61(.a(new_n95_), .b(new_n38_), .O(z10));
  nand2  g62(.a(new_n38_), .b(new_n35_), .O(z11));
  nand3  g63(.a(new_n38_), .b(x16), .c(new_n35_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n47_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n38_), .O(z12));
  nand2  g67(.a(new_n38_), .b(new_n43_), .O(z13));
  inv1   g68(.a(x17), .O(new_n103_));
  aoi21  g69(.a(new_n43_), .b(new_n90_), .c(new_n103_), .O(z14));
endmodule
