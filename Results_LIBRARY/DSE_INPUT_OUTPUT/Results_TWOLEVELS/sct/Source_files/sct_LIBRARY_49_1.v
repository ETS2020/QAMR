...
module FAU ( 
  ...
  nor2   g30(.a(new_n56_), .b(new_n43_), .O(new_n65_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n65_), .c(x01), .O(new_n71_));
  nand2  g37(.a(new_n70_), .b(new_n38_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n71_), .O(z05));
  nand2  g39(.a(new_n69_), .b(x10), .O(new_n74_));
  inv1   g40(.a(x10), .O(new_n75_));
  nand4  g41(.a(new_n60_), .b(new_n75_), .c(new_n68_), .d(x08), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(x04), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n65_), .c(x01), .O(new_n78_));
  nand2  g44(.a(new_n77_), .b(new_n38_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n78_), .O(z06));
  oai21  g46(.a(new_n55_), .b(new_n43_), .c(x01), .O(new_n81_));
  nand2  g47(.a(new_n76_), .b(x11), .O(new_n82_));
  inv1   g48(.a(x11), .O(new_n83_));
  inv1   g49(.a(new_n66_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n75_), .d(new_n68_), .O(new_n85_));
  aoi21  g51(.a(new_n38_), .b(new_n43_), .c(new_n44_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .d(new_n81_), .O(z07));
  nand2  g53(.a(new_n85_), .b(x12), .O(new_n88_));
  nand2  g54(.a(new_n75_), .b(new_n68_), .O(new_n89_));
  nor4   g55(.a(new_n89_), .b(new_n66_), .c(x12), .d(x11), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n86_), .d(new_n81_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  oai21  g59(.a(new_n90_), .b(new_n93_), .c(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n53_), .O(new_n95_));
  inv1   g61(.a(x12), .O(new_n96_));
  nand4  g62(.a(new_n50_), .b(new_n93_), .c(new_n96_), .d(new_n83_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x10), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n68_), .c(x08), .d(x07), .O(new_n99_));
  nand2  g65(.a(new_n55_), .b(x01), .O(new_n100_));
  ...
  nand4  g70(.a(new_n93_), .b(new_n96_), .c(new_n83_), .d(new_n75_), .O(new_n105_));
  ...
  nand3  g75(.a(new_n55_), .b(x14), .c(x01), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n43_), .O(z10));
  nor2   g77(.a(new_n44_), .b(new_n35_), .O(z11));
  nand2  g78(.a(new_n38_), .b(x03), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n100_), .c(new_n43_), .O(z12));
  nor2   g80(.a(new_n44_), .b(new_n43_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n44_), .b(new_n116_), .c(new_n43_), .O(z14));
endmodule
