...
module FAU ( 
  ...
  aoi21  g29(.a(new_n53_), .b(x02), .c(new_n36_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n39_), .O(new_n65_));
  ...
  nor2   g37(.a(new_n49_), .b(new_n44_), .O(new_n72_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n72_), .c(new_n39_), .O(new_n77_));
  ...
  oai21  g51(.a(new_n85_), .b(new_n72_), .c(new_n39_), .O(new_n86_));
  ...
  nand2  g58(.a(new_n47_), .b(new_n44_), .O(new_n93_));
  nand2  g59(.a(new_n64_), .b(new_n39_), .O(new_n94_));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n49_), .b(new_n95_), .c(new_n90_), .d(new_n82_), .O(new_n96_));
  nor2   g62(.a(new_n96_), .b(x10), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n68_), .c(x08), .d(x07), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n48_), .c(new_n94_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  aoi21  g66(.a(new_n91_), .b(x13), .c(new_n40_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n100_), .c(new_n93_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand4  g69(.a(new_n95_), .b(new_n90_), .c(new_n82_), .d(new_n81_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n64_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n68_), .c(x08), .d(x07), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(new_n48_), .O(new_n107_));
  aoi21  g73(.a(new_n64_), .b(x14), .c(new_n107_), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n44_), .c(new_n47_), .O(z10));
  nand2  g75(.a(new_n47_), .b(new_n35_), .O(z11));
  nand2  g76(.a(new_n36_), .b(x03), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n94_), .c(new_n44_), .O(z12));
  nor2   g78(.a(new_n40_), .b(new_n44_), .O(z13));
