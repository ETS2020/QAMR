...
module FAU ( 
  ...
  nand2  g27(.a(x04), .b(new_n39_), .O(new_n62_));
  ...
  oai21  g33(.a(new_n67_), .b(new_n63_), .c(new_n37_), .O(new_n68_));
  nand2  g34(.a(new_n35_), .b(x10), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(x18), .c(x04), .O(new_n70_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n63_), .c(new_n37_), .O(new_n77_));
  inv1   g43(.a(x10), .O(new_n78_));
  oai21  g44(.a(new_n42_), .b(new_n44_), .c(x12), .O(new_n79_));
  ...
  oai21  g49(.a(new_n63_), .b(new_n44_), .c(new_n37_), .O(new_n84_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n37_), .O(z07));
  nand3  g56(.a(new_n35_), .b(new_n88_), .c(new_n78_), .O(new_n91_));
  nand4  g57(.a(x18), .b(x12), .c(x10), .d(x04), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(x09), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(x08), .c(x07), .d(x06), .O(new_n94_));
  nand3  g60(.a(new_n74_), .b(x18), .c(x04), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x18), .c(new_n88_), .O(new_n96_));
  ...
  aoi21  g70(.a(x18), .b(new_n99_), .c(new_n35_), .O(new_n105_));
  ...
  nand2  g81(.a(new_n115_), .b(new_n37_), .O(new_n116_));
  aoi21  g82(.a(new_n116_), .b(new_n109_), .c(new_n44_), .O(z10));
  nor2   g83(.a(new_n36_), .b(new_n39_), .O(z11));
  ...
  nand2  g90(.a(new_n124_), .b(x18), .O(new_n125_));
  aoi21  g91(.a(new_n125_), .b(x12), .c(new_n44_), .O(z13));
  inv1   g92(.a(x17), .O(new_n127_));
  nor3   g93(.a(new_n36_), .b(new_n127_), .c(new_n44_), .O(z14));
endmodule
