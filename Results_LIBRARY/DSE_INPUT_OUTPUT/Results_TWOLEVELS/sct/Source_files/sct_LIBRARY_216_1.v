...
module FAU ( 
  ...
  and2   g33(.a(x08), .b(x06), .O(new_n68_));
  ...
  nand3  g37(.a(new_n35_), .b(x09), .c(new_n57_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(z05));
  inv1   g39(.a(x10), .O(new_n74_));
  inv1   g40(.a(new_n69_), .O(new_n75_));
  nand3  g41(.a(new_n68_), .b(new_n74_), .c(new_n67_), .O(new_n76_));
  ...
  oai21  g52(.a(x17), .b(x12), .c(new_n57_), .O(new_n87_));
  nand2  g53(.a(new_n84_), .b(new_n68_), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n74_), .d(new_n67_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n51_), .b(new_n95_), .c(new_n90_), .d(new_n89_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n74_), .c(new_n67_), .d(x08), .O(new_n98_));
  ...
  aoi21  g72(.a(new_n106_), .b(x02), .c(new_n63_), .O(new_n107_));
  ...
  nand2  g79(.a(new_n37_), .b(new_n41_), .O(z11));
  oai21  g80(.a(new_n63_), .b(x02), .c(new_n106_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n37_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  aoi21  g83(.a(x17), .b(new_n57_), .c(new_n47_), .O(z13));
  nand3  g84(.a(x17), .b(x07), .c(x04), .O(new_n119_));
