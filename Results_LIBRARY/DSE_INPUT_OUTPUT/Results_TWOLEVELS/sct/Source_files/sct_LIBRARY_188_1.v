...
module FAU ( 
  ...
  oai21  g02(.a(x17), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  oai21  g03(.a(x02), .b(new_n35_), .c(new_n37_), .O(z00));
  nand2  g04(.a(x17), .b(new_n35_), .O(new_n39_));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n65_), .c(new_n40_), .O(z05));
  ...
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n39_), .O(z06));
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n73_), .d(new_n39_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n49_), .b(new_n89_), .c(new_n86_), .d(new_n79_), .O(new_n90_));
  ...
  aoi21  g61(.a(x16), .b(x03), .c(new_n44_), .O(new_n96_));
  nand2  g62(.a(new_n87_), .b(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n39_), .O(z09));
  ...
  and2   g67(.a(new_n101_), .b(new_n49_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n68_), .c(x08), .d(x07), .O(new_n103_));
  oai22  g69(.a(new_n103_), .b(new_n47_), .c(new_n49_), .d(new_n36_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n39_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z10));
  nor2   g72(.a(new_n40_), .b(new_n48_), .O(z11));
  nand2  g73(.a(new_n93_), .b(new_n61_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n39_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  aoi21  g76(.a(x17), .b(new_n35_), .c(new_n44_), .O(z13));
  nand3  g77(.a(x17), .b(x04), .c(x01), .O(new_n112_));
