...
module FAU ( 
  ...
  nand4  g52(.a(new_n75_), .b(new_n66_), .c(new_n86_), .d(new_n81_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  aoi21  g54(.a(new_n82_), .b(x12), .c(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n73_), .c(new_n40_), .O(z08));
  oai21  g56(.a(new_n63_), .b(new_n44_), .c(new_n39_), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n48_), .b(new_n92_), .c(new_n86_), .d(new_n81_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n80_), .c(new_n64_), .d(x08), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x07), .c(x06), .d(x04), .O(new_n97_));
  aoi21  g63(.a(new_n87_), .b(x13), .c(new_n40_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n91_), .O(z09));
  aoi21  g65(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n100_));
  nand4  g66(.a(new_n92_), .b(new_n86_), .c(new_n81_), .d(new_n80_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n35_), .c(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n64_), .c(x08), .d(x07), .O(new_n103_));
  nand2  g69(.a(new_n100_), .b(x14), .O(new_n104_));
  oai21  g70(.a(new_n103_), .b(new_n47_), .c(new_n104_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n39_), .O(z10));
  nor2   g73(.a(new_n40_), .b(new_n36_), .O(z11));
  oai21  g74(.a(new_n61_), .b(x02), .c(new_n60_), .O(new_n109_));
