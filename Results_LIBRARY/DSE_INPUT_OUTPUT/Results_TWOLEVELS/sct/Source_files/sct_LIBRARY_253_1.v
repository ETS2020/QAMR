...
module FAU ( 
  ...
  oai21  g39(.a(new_n64_), .b(new_n73_), .c(new_n48_), .O(new_n74_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n65_), .c(new_n36_), .O(z07));
  ...
  nand4  g56(.a(new_n49_), .b(new_n90_), .c(new_n87_), .d(new_n80_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x10), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n68_), .c(x08), .d(x07), .O(new_n93_));
  nand2  g59(.a(x16), .b(new_n37_), .O(new_n94_));
  ...
  aoi21  g64(.a(new_n98_), .b(new_n96_), .c(new_n36_), .O(z09));
  ...
  oai22  g70(.a(new_n104_), .b(new_n47_), .c(new_n49_), .d(new_n40_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n48_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z10));
  nand2  g73(.a(new_n48_), .b(new_n37_), .O(z11));
  nor2   g74(.a(new_n36_), .b(new_n62_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n37_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n73_), .c(new_n48_), .O(z12));
  inv1   g77(.a(x15), .O(new_n112_));
  aoi21  g78(.a(x17), .b(new_n112_), .c(new_n73_), .O(z13));
  aoi21  g79(.a(x15), .b(new_n73_), .c(new_n35_), .O(z14));
endmodule
