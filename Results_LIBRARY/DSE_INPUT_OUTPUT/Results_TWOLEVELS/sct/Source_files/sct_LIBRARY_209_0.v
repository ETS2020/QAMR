...
module FAU ( 
  ...
  aoi21  g34(.a(new_n68_), .b(new_n62_), .c(new_n43_), .O(z05));
  aoi21  g35(.a(new_n61_), .b(x16), .c(new_n42_), .O(new_n70_));
  nand2  g36(.a(new_n66_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n55_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n70_), .d(new_n46_), .O(z06));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n62_), .c(new_n43_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n62_), .c(new_n43_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n48_), .b(new_n87_), .c(new_n82_), .d(new_n76_), .O(new_n88_));
