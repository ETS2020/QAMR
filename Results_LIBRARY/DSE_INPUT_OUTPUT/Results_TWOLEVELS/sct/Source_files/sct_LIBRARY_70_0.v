...
module FAU ( 
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n64_), .d(new_n46_), .O(z07));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n70_), .b(new_n78_), .c(new_n81_), .d(new_n77_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  aoi21  g49(.a(new_n79_), .b(x12), .c(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n62_), .c(new_n42_), .O(z08));
  nand2  g51(.a(new_n82_), .b(x13), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n62_), .c(x04), .O(new_n87_));
  ...
  nand2  g61(.a(new_n76_), .b(x01), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n81_), .c(new_n77_), .O(new_n98_));
  ...
  nand2  g71(.a(new_n46_), .b(new_n47_), .O(z11));
