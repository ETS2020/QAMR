...
module FAU ( 
  ...
  oai22  g31(.a(new_n65_), .b(new_n42_), .c(new_n61_), .d(x02), .O(new_n66_));
  ...
  nand2  g37(.a(x04), .b(new_n48_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n62_), .c(new_n61_), .O(new_n73_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n73_), .c(new_n42_), .O(new_n77_));
  oai21  g43(.a(new_n71_), .b(new_n35_), .c(new_n77_), .O(z05));
  nor2   g44(.a(new_n73_), .b(new_n41_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(x10), .O(new_n80_));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n56_), .c(x08), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n46_), .O(z06));
  ...
  nand4  g59(.a(new_n81_), .b(new_n87_), .c(new_n93_), .d(new_n86_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n92_), .c(new_n79_), .d(new_n46_), .O(z08));
  nand2  g61(.a(new_n94_), .b(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n84_), .c(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n46_), .O(new_n98_));
  nand3  g64(.a(new_n49_), .b(x04), .c(new_n42_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n35_), .c(x13), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n93_), .c(new_n86_), .d(new_n85_), .O(new_n101_));
  ...
  nand4  g71(.a(new_n105_), .b(new_n86_), .c(new_n85_), .d(new_n42_), .O(new_n106_));
  oai21  g72(.a(new_n35_), .b(new_n42_), .c(new_n106_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n49_), .c(new_n74_), .d(x08), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(x07), .c(x06), .O(new_n110_));
  nand4  g76(.a(new_n63_), .b(new_n46_), .c(x16), .d(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n41_), .O(z10));
  nor2   g78(.a(new_n43_), .b(new_n48_), .O(z11));
  nor2   g79(.a(new_n43_), .b(new_n61_), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n48_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n41_), .c(new_n46_), .O(z12));
  nand2  g82(.a(new_n46_), .b(new_n41_), .O(z13));
  nand2  g83(.a(x17), .b(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n46_), .O(z14));
endmodule
