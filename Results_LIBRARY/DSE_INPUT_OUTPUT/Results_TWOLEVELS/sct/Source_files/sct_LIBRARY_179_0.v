...
module FAU ( 
  ...
  nand4  g38(.a(new_n72_), .b(new_n68_), .c(new_n47_), .d(x04), .O(z07));
  ...
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n47_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n43_), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n47_), .b(new_n80_), .c(new_n75_), .d(new_n70_), .O(new_n81_));
  nor3   g47(.a(new_n81_), .b(x10), .c(x09), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(x08), .c(x07), .d(x06), .O(new_n83_));
  nand2  g49(.a(new_n76_), .b(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n47_), .d(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand4  g52(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n47_), .c(new_n61_), .d(x08), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(x07), .c(x06), .O(new_n91_));
  inv1   g57(.a(new_n47_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n42_), .O(z10));
  nand2  g60(.a(new_n45_), .b(new_n36_), .O(z11));
  aoi21  g61(.a(x16), .b(new_n36_), .c(x03), .O(new_n96_));
  nor2   g62(.a(new_n96_), .b(new_n42_), .O(z12));
