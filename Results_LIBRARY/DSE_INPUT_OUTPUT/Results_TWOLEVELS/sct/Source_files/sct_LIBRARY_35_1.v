...
module FAU ( 
  ...
  nor2   g71(.a(new_n36_), .b(new_n41_), .O(z11));
  oai21  g72(.a(new_n98_), .b(x02), .c(new_n63_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n37_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nand2  g75(.a(new_n37_), .b(new_n47_), .O(z13));
  aoi21  g76(.a(new_n47_), .b(x00), .c(new_n35_), .O(z14));
endmodule
