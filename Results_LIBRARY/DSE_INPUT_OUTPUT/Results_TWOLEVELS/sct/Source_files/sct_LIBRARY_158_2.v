...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n42_), .c(new_n47_), .O(new_n65_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n43_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n47_), .O(z08));
  ...
  aoi21  g58(.a(new_n85_), .b(x13), .c(new_n43_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n65_), .O(z09));
  aoi21  g60(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n95_));
  nand4  g61(.a(new_n87_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n36_), .c(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n68_), .c(x08), .d(x07), .O(new_n98_));
  oai22  g64(.a(new_n98_), .b(new_n46_), .c(new_n49_), .d(new_n37_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n47_), .O(z10));
  nand2  g67(.a(new_n47_), .b(new_n48_), .O(z11));
  nor2   g68(.a(new_n43_), .b(new_n62_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n48_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n42_), .c(new_n47_), .O(z12));
  nor2   g71(.a(new_n43_), .b(new_n42_), .O(z13));
