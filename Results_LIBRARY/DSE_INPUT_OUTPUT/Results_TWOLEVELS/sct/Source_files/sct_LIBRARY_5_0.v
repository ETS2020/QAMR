...
module FAU ( 
  ...
  oai21  g38(.a(new_n63_), .b(new_n41_), .c(new_n46_), .O(new_n73_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n79_), .c(new_n42_), .O(z07));
  ...
  nand4  g56(.a(new_n48_), .b(new_n90_), .c(new_n87_), .d(new_n81_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n80_), .c(new_n64_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x07), .c(x06), .d(x04), .O(new_n95_));
  aoi21  g61(.a(new_n88_), .b(x13), .c(new_n42_), .O(new_n96_));
  ...
  nand4  g65(.a(new_n90_), .b(new_n87_), .c(new_n81_), .d(new_n80_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n98_), .c(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n64_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n45_), .c(new_n48_), .d(new_n36_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n46_), .O(z10));
