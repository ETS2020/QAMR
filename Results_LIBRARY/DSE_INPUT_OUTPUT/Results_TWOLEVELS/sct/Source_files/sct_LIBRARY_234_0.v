...
module FAU ( 
  ...
  nor2   g07(.a(x17), .b(x01), .O(new_n42_));
  ...
  oai21  g27(.a(new_n41_), .b(x02), .c(new_n47_), .O(new_n62_));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n63_), .c(new_n42_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n63_), .c(new_n42_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n82_), .c(new_n76_), .d(new_n75_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n69_), .c(x04), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x13), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n63_), .c(new_n42_), .O(z09));
  ...
  nor2   g64(.a(new_n42_), .b(new_n36_), .O(z11));
  oai21  g65(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n46_), .c(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z12));
  nor2   g68(.a(new_n42_), .b(new_n41_), .O(z13));
