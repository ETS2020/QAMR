...
module FAU ( 
  ...
  inv1   g29(.a(x17), .O(new_n64_));
  aoi21  g30(.a(new_n51_), .b(x16), .c(x09), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n66_));
  nand2  g32(.a(x16), .b(new_n35_), .O(new_n67_));
  oai21  g33(.a(new_n66_), .b(new_n40_), .c(new_n67_), .O(new_n68_));
  ...
  nand2  g40(.a(x04), .b(new_n35_), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n50_), .c(new_n74_), .O(new_n76_));
  inv1   g42(.a(x09), .O(new_n77_));
  nand3  g43(.a(new_n59_), .b(new_n77_), .c(x08), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n70_), .c(x04), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n76_), .c(new_n40_), .O(new_n80_));
  oai21  g46(.a(new_n73_), .b(new_n64_), .c(new_n80_), .O(z05));
  nor2   g47(.a(new_n76_), .b(new_n45_), .O(new_n82_));
  nand2  g48(.a(new_n78_), .b(x10), .O(new_n83_));
  nor2   g49(.a(x10), .b(x09), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n59_), .c(x08), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n49_), .O(z06));
  ...
  aoi21  g58(.a(new_n85_), .b(x11), .c(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n87_), .c(new_n41_), .O(z07));
  nand2  g60(.a(new_n91_), .b(x12), .O(new_n95_));
  inv1   g61(.a(x12), .O(new_n96_));
  nand4  g62(.a(new_n84_), .b(new_n90_), .c(new_n96_), .d(new_n89_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n95_), .c(new_n82_), .d(new_n49_), .O(z08));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n89_), .d(new_n88_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n78_), .c(x04), .O(new_n101_));
  aoi21  g67(.a(new_n97_), .b(x13), .c(new_n101_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n87_), .c(new_n41_), .O(z09));
  nand2  g69(.a(x17), .b(x00), .O(new_n104_));
  aoi22  g70(.a(new_n104_), .b(new_n100_), .c(new_n51_), .d(x16), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n77_), .c(x08), .d(x07), .O(new_n106_));
  oai22  g72(.a(new_n106_), .b(new_n48_), .c(new_n52_), .d(new_n38_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n49_), .O(z10));
  nand2  g75(.a(new_n49_), .b(new_n35_), .O(z11));
  nor2   g76(.a(new_n41_), .b(new_n74_), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n35_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n45_), .c(new_n49_), .O(z12));
  nand2  g79(.a(new_n49_), .b(new_n45_), .O(z13));
  nor2   g80(.a(new_n64_), .b(new_n45_), .O(z14));
endmodule
