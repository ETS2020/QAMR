...
module FAU ( 
  ...
  inv1   g31(.a(x17), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(x09), .c(new_n55_), .O(new_n67_));
  oai21  g33(.a(new_n57_), .b(new_n48_), .c(x09), .O(new_n68_));
  inv1   g34(.a(x09), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(x08), .c(x07), .d(x06), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n67_), .d(new_n65_), .O(z05));
  nand3  g37(.a(new_n69_), .b(x08), .c(x06), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  nor2   g40(.a(new_n57_), .b(new_n48_), .O(new_n75_));
  ...
  nand3  g44(.a(x17), .b(x10), .c(new_n55_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n65_), .O(z06));
  oai21  g46(.a(new_n66_), .b(x11), .c(new_n55_), .O(new_n81_));
  ...
  nand3  g58(.a(x17), .b(x12), .c(new_n55_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n65_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n49_), .b(new_n95_), .c(new_n87_), .d(new_n89_), .O(new_n96_));
  ...
  oai21  g65(.a(new_n98_), .b(new_n45_), .c(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x07), .O(new_n101_));
  nand3  g67(.a(x17), .b(x13), .c(new_n55_), .O(new_n102_));
  ...
  nand4  g72(.a(new_n106_), .b(new_n49_), .c(new_n69_), .d(x08), .O(new_n107_));
  ...
  nand4  g77(.a(new_n111_), .b(x17), .c(x16), .d(x14), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n109_), .c(new_n45_), .O(z10));
  nor2   g79(.a(new_n35_), .b(new_n40_), .O(z11));
  oai21  g80(.a(new_n62_), .b(x02), .c(new_n110_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n36_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nor2   g83(.a(new_n35_), .b(new_n45_), .O(z13));
  oai21  g84(.a(new_n66_), .b(new_n45_), .c(new_n36_), .O(z14));
endmodule
