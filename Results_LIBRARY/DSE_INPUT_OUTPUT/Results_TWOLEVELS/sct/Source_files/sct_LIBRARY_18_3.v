...
module FAU ( 
  ...
  nand4  g21(.a(new_n55_), .b(new_n46_), .c(new_n41_), .d(x04), .O(new_n56_));
  ...
  nand4  g47(.a(new_n69_), .b(new_n75_), .c(new_n81_), .d(new_n74_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n62_), .d(new_n41_), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n46_), .b(new_n84_), .c(new_n81_), .d(new_n74_), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n73_), .c(new_n65_), .d(x08), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(x07), .c(x06), .d(x04), .O(new_n89_));
  aoi21  g55(.a(new_n82_), .b(x13), .c(new_n42_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n62_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  aoi21  g58(.a(new_n58_), .b(x02), .c(new_n59_), .O(new_n93_));
  nand4  g59(.a(new_n84_), .b(new_n81_), .c(new_n74_), .d(new_n73_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n92_), .c(new_n93_), .O(new_n95_));
  ...
  nand2  g65(.a(new_n99_), .b(new_n41_), .O(z10));
  ...
  nand2  g70(.a(new_n41_), .b(new_n40_), .O(z13));
