...
module FAU ( 
  ...
  oai21  g01(.a(x17), .b(new_n35_), .c(x01), .O(new_n36_));
  oai21  g02(.a(x14), .b(x01), .c(new_n36_), .O(z00));
  inv1   g03(.a(x18), .O(new_n38_));
  nor2   g04(.a(new_n38_), .b(x15), .O(new_n39_));
  inv1   g05(.a(x04), .O(new_n40_));
  nand2  g06(.a(x17), .b(x01), .O(new_n41_));
  ...
  nand4  g15(.a(new_n49_), .b(new_n41_), .c(new_n45_), .d(x04), .O(new_n50_));
  ...
  nand2  g25(.a(new_n59_), .b(new_n41_), .O(z04));
  oai21  g26(.a(new_n40_), .b(x02), .c(new_n46_), .O(new_n61_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n65_), .c(x08), .O(new_n66_));
  ...
  nand2  g37(.a(new_n61_), .b(x16), .O(new_n72_));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n72_), .c(new_n42_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n69_), .b(new_n75_), .c(new_n80_), .d(new_n74_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n76_), .b(x12), .c(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n72_), .c(new_n42_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n80_), .c(new_n74_), .d(new_n73_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n66_), .c(x04), .O(new_n87_));
  aoi21  g53(.a(new_n81_), .b(x13), .c(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n72_), .c(new_n42_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  aoi21  g56(.a(new_n86_), .b(new_n90_), .c(new_n48_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n65_), .c(x08), .d(x07), .O(new_n92_));
  nand2  g58(.a(new_n48_), .b(x14), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n45_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n41_), .O(z10));
  nor2   g62(.a(new_n42_), .b(new_n35_), .O(z11));
  oai21  g63(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n41_), .c(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z12));
  aoi21  g66(.a(x17), .b(x01), .c(new_n40_), .O(z13));
  inv1   g67(.a(x01), .O(new_n102_));
  nand3  g68(.a(x17), .b(x04), .c(new_n102_), .O(new_n103_));
