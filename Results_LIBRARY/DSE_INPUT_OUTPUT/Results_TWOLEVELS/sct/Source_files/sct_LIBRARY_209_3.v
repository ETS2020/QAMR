...
module FAU ( 
  ...
  oai22  g68(.a(new_n102_), .b(new_n47_), .c(new_n48_), .d(new_n97_), .O(new_n103_));
  ...
  nand3  g73(.a(new_n107_), .b(new_n46_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nand2  g75(.a(new_n46_), .b(new_n41_), .O(z13));
  aoi21  g76(.a(new_n41_), .b(new_n42_), .c(new_n36_), .O(z14));
endmodule
