...
module FAU ( 
  ...
  inv1   g34(.a(new_n42_), .O(new_n69_));
  ...
  aoi21  g60(.a(new_n59_), .b(x02), .c(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n86_), .b(new_n83_), .c(new_n76_), .d(new_n75_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n35_), .c(new_n95_), .O(new_n97_));
  ...
  oai21  g69(.a(new_n94_), .b(x02), .c(new_n59_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n42_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z12));
  nor2   g72(.a(new_n69_), .b(new_n43_), .O(z13));
