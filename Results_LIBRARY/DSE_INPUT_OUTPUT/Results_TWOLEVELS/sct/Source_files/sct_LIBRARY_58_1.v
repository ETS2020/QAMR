...
module FAU ( 
  ...
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n73_), .c(new_n49_), .O(new_n79_));
  ...
  nand3  g49(.a(new_n83_), .b(new_n68_), .c(new_n77_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n49_), .d(x04), .O(z08));
  inv1   g51(.a(x12), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n49_), .b(new_n87_), .c(new_n86_), .d(new_n76_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(x10), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n74_), .c(x08), .d(x07), .O(new_n90_));
  inv1   g56(.a(new_n49_), .O(new_n91_));
  nand4  g57(.a(new_n83_), .b(new_n64_), .c(new_n75_), .d(x07), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x13), .c(new_n91_), .O(new_n93_));
  oai21  g59(.a(new_n90_), .b(new_n35_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  oai21  g61(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n75_), .b(x04), .O(new_n99_));
  nand3  g65(.a(new_n87_), .b(new_n86_), .c(new_n76_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n99_), .c(new_n98_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n49_), .c(new_n74_), .d(x08), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n56_), .c(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x06), .O(new_n104_));
  nand3  g70(.a(new_n91_), .b(x14), .c(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n104_), .O(z10));
  nor2   g72(.a(new_n36_), .b(new_n37_), .O(z11));
  aoi21  g73(.a(x16), .b(new_n37_), .c(x03), .O(new_n108_));
  nor2   g74(.a(new_n108_), .b(new_n43_), .O(z12));
