...
module FAU ( 
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .d(new_n39_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n64_), .d(new_n39_), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n62_), .c(new_n40_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n48_), .b(new_n85_), .c(new_n80_), .d(new_n76_), .O(new_n86_));
  inv1   g52(.a(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n75_), .c(new_n67_), .d(x08), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(x07), .c(x06), .d(x04), .O(new_n90_));
  aoi21  g56(.a(new_n81_), .b(x13), .c(new_n40_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n64_), .O(z09));
  inv1   g58(.a(x16), .O(new_n93_));
  aoi21  g59(.a(new_n60_), .b(x02), .c(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n85_), .b(new_n80_), .c(new_n76_), .d(new_n75_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n38_), .c(new_n94_), .O(new_n96_));
  ...
  nand2  g66(.a(new_n100_), .b(new_n39_), .O(z10));
  nor2   g67(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g68(.a(new_n93_), .b(x02), .c(new_n60_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n39_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z12));
  nand2  g71(.a(new_n39_), .b(new_n44_), .O(z13));
  nand2  g72(.a(new_n39_), .b(x17), .O(new_n107_));
  nor2   g73(.a(new_n107_), .b(new_n44_), .O(z14));
endmodule
