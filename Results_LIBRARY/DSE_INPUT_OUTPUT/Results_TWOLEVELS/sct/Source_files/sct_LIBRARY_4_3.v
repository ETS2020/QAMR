...
module FAU ( 
  ...
  nand4  g17(.a(new_n51_), .b(new_n40_), .c(new_n48_), .d(x04), .O(new_n52_));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n86_), .c(new_n41_), .O(z07));
  nand2  g59(.a(new_n90_), .b(x12), .O(new_n94_));
  inv1   g60(.a(x12), .O(new_n95_));
  nand4  g61(.a(new_n83_), .b(new_n89_), .c(new_n95_), .d(new_n88_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n94_), .c(new_n81_), .d(new_n40_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n95_), .c(new_n88_), .d(new_n87_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n77_), .c(x04), .O(new_n100_));
  aoi21  g66(.a(new_n96_), .b(x13), .c(new_n100_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n86_), .c(new_n41_), .O(z09));
  inv1   g68(.a(x17), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x00), .O(new_n104_));
  aoi22  g70(.a(new_n104_), .b(new_n99_), .c(new_n50_), .d(x16), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n76_), .c(x08), .d(x07), .O(new_n106_));
  oai22  g72(.a(new_n106_), .b(new_n48_), .c(new_n51_), .d(new_n38_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n40_), .O(z10));
  nand2  g75(.a(new_n40_), .b(new_n35_), .O(z11));
  nand3  g76(.a(new_n40_), .b(x16), .c(new_n35_), .O(new_n111_));
  ...
  nand2  g80(.a(new_n40_), .b(new_n45_), .O(z13));
  nand3  g81(.a(x17), .b(x04), .c(new_n63_), .O(new_n116_));
