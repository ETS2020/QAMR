...
module FAU ( 
  ...
  nor2   g08(.a(x17), .b(x14), .O(new_n43_));
  ...
  nand3  g30(.a(x16), .b(x04), .c(new_n48_), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n64_), .c(new_n62_), .d(x04), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  oai21  g33(.a(new_n36_), .b(new_n42_), .c(new_n37_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(x16), .c(x03), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(new_n67_), .O(z05));
  and2   g36(.a(new_n64_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n56_), .c(x08), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n65_), .c(x04), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n71_), .c(new_n47_), .O(new_n75_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n65_), .c(x04), .O(new_n81_));
  aoi21  g47(.a(new_n73_), .b(x11), .c(new_n81_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n43_), .c(new_n69_), .O(z07));
  nand2  g49(.a(new_n65_), .b(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  nand2  g51(.a(new_n80_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n72_), .b(new_n79_), .c(new_n87_), .d(new_n78_), .O(new_n88_));
  and2   g54(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n85_), .d(new_n69_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n49_), .b(new_n91_), .c(new_n87_), .d(new_n78_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n77_), .c(new_n63_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(x07), .c(x06), .d(x04), .O(new_n96_));
  aoi21  g62(.a(new_n88_), .b(x13), .c(new_n43_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(new_n85_), .d(new_n69_), .O(z09));
  ...
  nand4  g68(.a(new_n91_), .b(new_n87_), .c(new_n78_), .d(new_n77_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n99_), .c(new_n102_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n63_), .c(x08), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n46_), .c(new_n49_), .d(new_n36_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n47_), .O(z10));
  nor2   g74(.a(new_n43_), .b(new_n48_), .O(z11));
  oai21  g75(.a(new_n101_), .b(x02), .c(new_n100_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n47_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nand2  g78(.a(new_n47_), .b(new_n42_), .O(z13));
  oai21  g79(.a(new_n37_), .b(new_n42_), .c(new_n47_), .O(z14));
endmodule
