...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n107_, new_n108_, new_n110_, new_n112_, new_n113_, new_n116_;
  inv1   g00(.a(x14), .O(new_n35_));
  aoi21  g01(.a(x16), .b(x01), .c(new_n35_), .O(new_n36_));
  oai22  g02(.a(new_n36_), .b(x02), .c(x14), .d(x01), .O(z00));
  nor2   g03(.a(x16), .b(new_n35_), .O(new_n38_));
  ...
  oai21  g30(.a(new_n48_), .b(new_n42_), .c(x16), .O(new_n65_));
  ...
  aoi21  g35(.a(new_n35_), .b(new_n42_), .c(new_n38_), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n69_), .c(new_n67_), .d(new_n65_), .O(z05));
  aoi21  g37(.a(new_n47_), .b(x02), .c(new_n42_), .O(new_n72_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n72_), .c(x16), .O(new_n77_));
  nand2  g43(.a(new_n76_), .b(new_n35_), .O(new_n78_));
  ...
  oai21  g51(.a(new_n85_), .b(new_n72_), .c(x16), .O(new_n86_));
  nand2  g52(.a(new_n85_), .b(new_n35_), .O(new_n87_));
  ...
  nand2  g60(.a(new_n94_), .b(new_n45_), .O(new_n95_));
  aoi21  g61(.a(new_n55_), .b(new_n53_), .c(x13), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n90_), .c(new_n82_), .d(new_n81_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n68_), .c(x08), .d(x07), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n46_), .c(new_n49_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n95_), .O(z09));
  nand2  g68(.a(new_n49_), .b(x00), .O(new_n103_));
  ...
  nand2  g76(.a(new_n45_), .b(new_n110_), .O(z11));
  nand2  g77(.a(new_n45_), .b(x03), .O(new_n112_));
  nand2  g78(.a(x16), .b(new_n110_), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n112_), .c(new_n42_), .O(z12));
  nor2   g80(.a(new_n38_), .b(new_n42_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n38_), .b(new_n116_), .c(new_n42_), .O(z14));
endmodule
