...
module FAU ( 
  ...
  oai21  g36(.a(new_n70_), .b(new_n65_), .c(x18), .O(new_n71_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n65_), .c(x18), .O(new_n78_));
  ...
  nand2  g81(.a(new_n52_), .b(new_n37_), .O(z11));
  oai21  g82(.a(x18), .b(new_n35_), .c(x03), .O(new_n117_));
  nand3  g83(.a(x18), .b(x16), .c(new_n37_), .O(new_n118_));
