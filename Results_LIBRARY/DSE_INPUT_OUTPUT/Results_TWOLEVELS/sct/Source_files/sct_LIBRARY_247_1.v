...
module FAU ( 
  ...
  nand3  g07(.a(x18), .b(new_n35_), .c(new_n41_), .O(new_n42_));
  ...
  aoi21  g15(.a(new_n49_), .b(x02), .c(new_n35_), .O(new_n50_));
  ...
  nand3  g20(.a(x05), .b(new_n49_), .c(x02), .O(new_n55_));
  ...
  nor2   g30(.a(new_n51_), .b(new_n44_), .O(new_n65_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n65_), .c(x05), .O(new_n71_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n65_), .c(x05), .O(new_n78_));
  ...
  oai21  g52(.a(new_n86_), .b(new_n65_), .c(x05), .O(new_n87_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n90_), .c(x04), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n65_), .c(x05), .O(new_n94_));
  nand2  g60(.a(new_n93_), .b(new_n35_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n94_), .O(z08));
  nand2  g62(.a(new_n47_), .b(new_n44_), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n56_), .b(new_n98_), .c(new_n91_), .d(new_n83_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(x10), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n68_), .c(x08), .d(x07), .O(new_n101_));
  nand2  g67(.a(new_n50_), .b(x05), .O(new_n102_));
  oai21  g68(.a(new_n101_), .b(new_n48_), .c(new_n102_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  aoi21  g70(.a(new_n92_), .b(x13), .c(new_n36_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n104_), .c(new_n97_), .O(z09));
  inv1   g72(.a(x00), .O(new_n107_));
  nand4  g73(.a(new_n98_), .b(new_n91_), .c(new_n83_), .d(new_n82_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n56_), .c(new_n68_), .d(x08), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(x07), .c(x06), .O(new_n112_));
  nand3  g78(.a(new_n50_), .b(x14), .c(x05), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n112_), .c(new_n44_), .O(z10));
  nor2   g80(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g81(.a(new_n35_), .b(x05), .c(x03), .O(new_n116_));
  nand3  g82(.a(x16), .b(x05), .c(new_n37_), .O(new_n117_));
  aoi21  g83(.a(new_n117_), .b(new_n116_), .c(new_n44_), .O(z12));
  nor2   g84(.a(new_n36_), .b(new_n44_), .O(z13));
  nand2  g85(.a(x17), .b(x04), .O(new_n120_));
  nand2  g86(.a(new_n120_), .b(new_n47_), .O(z14));
endmodule
