...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n47_), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n72_), .d(new_n47_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n74_), .b(new_n80_), .c(new_n83_), .d(new_n79_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  aoi21  g51(.a(new_n81_), .b(x12), .c(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n63_), .c(new_n59_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n46_), .b(new_n88_), .c(new_n83_), .d(new_n79_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n78_), .c(new_n66_), .d(x08), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(x07), .c(x06), .d(x04), .O(new_n93_));
  aoi21  g59(.a(new_n84_), .b(x13), .c(new_n59_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n72_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  inv1   g62(.a(x16), .O(new_n97_));
  aoi21  g63(.a(new_n60_), .b(x02), .c(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n88_), .b(new_n83_), .c(new_n79_), .d(new_n78_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n96_), .c(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n66_), .c(x08), .d(x07), .O(new_n101_));
  oai22  g67(.a(new_n101_), .b(new_n44_), .c(new_n46_), .d(new_n37_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n47_), .O(z10));
  nor2   g70(.a(new_n59_), .b(new_n45_), .O(z11));
  nor3   g71(.a(new_n59_), .b(new_n97_), .c(x02), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(x03), .c(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n47_), .O(z12));
  nand2  g74(.a(new_n47_), .b(new_n61_), .O(z13));
