...
module FAU ( 
  ...
  aoi21  g32(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g33(.a(x08), .b(x07), .c(x06), .O(new_n68_));
  aoi21  g34(.a(new_n68_), .b(x09), .c(new_n67_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n40_), .c(new_n64_), .O(z05));
  oai21  g36(.a(new_n62_), .b(new_n54_), .c(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n55_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n47_), .d(x04), .O(z06));
  nand2  g40(.a(new_n73_), .b(x11), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  inv1   g43(.a(new_n68_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n61_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n47_), .d(x04), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n47_), .d(x04), .O(z08));
  inv1   g50(.a(new_n43_), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n47_), .b(new_n86_), .c(new_n82_), .d(new_n77_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n61_), .c(x08), .d(x07), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x13), .c(new_n67_), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n42_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n85_), .O(z09));
  inv1   g59(.a(new_n36_), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand4  g61(.a(new_n86_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n95_), .c(new_n67_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n61_), .c(x08), .d(x07), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(new_n42_), .O(new_n99_));
  aoi21  g65(.a(new_n67_), .b(x14), .c(new_n99_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n40_), .c(new_n94_), .O(z10));
  nor2   g67(.a(new_n36_), .b(new_n35_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n35_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n40_), .c(new_n94_), .O(z12));
