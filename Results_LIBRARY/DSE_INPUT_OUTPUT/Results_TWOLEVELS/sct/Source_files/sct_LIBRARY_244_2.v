...
module FAU ( 
  ...
  inv1   g48(.a(new_n77_), .O(new_n83_));
  nor2   g49(.a(x10), .b(x09), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n58_), .c(x08), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  aoi21  g52(.a(new_n79_), .b(x10), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n83_), .c(new_n41_), .O(z06));
  oai21  g54(.a(new_n77_), .b(new_n46_), .c(new_n49_), .O(new_n89_));
  nand2  g55(.a(new_n85_), .b(x11), .O(new_n90_));
  inv1   g56(.a(x10), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(new_n70_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n78_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n89_), .d(new_n49_), .O(z07));
  inv1   g61(.a(x12), .O(new_n96_));
  nand4  g62(.a(new_n84_), .b(new_n93_), .c(new_n96_), .d(new_n92_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  aoi21  g64(.a(new_n94_), .b(x12), .c(new_n98_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n83_), .c(new_n41_), .O(z08));
  inv1   g66(.a(x13), .O(new_n101_));
  nand4  g67(.a(new_n51_), .b(new_n101_), .c(new_n96_), .d(new_n92_), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n91_), .c(new_n78_), .d(x08), .O(new_n104_));
  ...
  nand3  g73(.a(new_n107_), .b(new_n106_), .c(new_n89_), .O(z09));
  nand4  g74(.a(new_n101_), .b(new_n96_), .c(new_n92_), .d(new_n91_), .O(new_n109_));
  ...
  nand2  g85(.a(new_n49_), .b(new_n46_), .O(z13));
  nor2   g86(.a(new_n63_), .b(new_n46_), .O(z14));
endmodule
