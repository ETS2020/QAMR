...
module FAU ( 
  ...
  nor2   g05(.a(x18), .b(x00), .O(new_n40_));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n63_), .c(new_n40_), .O(z06));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n63_), .c(new_n40_), .O(z07));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n63_), .c(new_n40_), .O(z08));
  ...
  aoi21  g59(.a(new_n84_), .b(x13), .c(new_n40_), .O(new_n94_));
  ...
  nor2   g74(.a(new_n40_), .b(new_n44_), .O(z13));
