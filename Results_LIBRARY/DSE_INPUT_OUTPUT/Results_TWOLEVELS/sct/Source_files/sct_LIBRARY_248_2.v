...
module FAU ( 
  ...
  oai21  g27(.a(new_n41_), .b(x02), .c(new_n61_), .O(new_n62_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(new_n46_), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n65_), .d(new_n46_), .O(z07));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n63_), .c(new_n43_), .O(z08));
  ...
  nand3  g54(.a(new_n49_), .b(x04), .c(new_n42_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n35_), .c(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n81_), .c(new_n77_), .d(new_n76_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n77_), .c(new_n76_), .d(new_n42_), .O(new_n96_));
  oai21  g62(.a(new_n35_), .b(new_n42_), .c(new_n96_), .O(new_n97_));
  ...
  nor2   g69(.a(new_n43_), .b(new_n48_), .O(z11));
  inv1   g70(.a(x16), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(x02), .c(new_n61_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n46_), .c(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z12));
  nor2   g74(.a(new_n43_), .b(new_n41_), .O(z13));
  nand2  g75(.a(x17), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n46_), .O(z14));
endmodule
