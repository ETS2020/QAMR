...
module FAU ( 
  ...
  nand2  g24(.a(new_n58_), .b(x10), .O(new_n59_));
  ...
  nand2  g32(.a(x04), .b(new_n41_), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(new_n65_), .c(new_n66_), .O(new_n68_));
  or2    g34(.a(new_n68_), .b(new_n46_), .O(new_n69_));
  ...
  nor2   g39(.a(x09), .b(new_n56_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n72_), .c(new_n70_), .d(new_n37_), .O(z05));
  nand4  g42(.a(new_n60_), .b(new_n50_), .c(x08), .d(x04), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(new_n74_), .c(new_n35_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n69_), .c(x17), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(x04), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n68_), .c(new_n35_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n79_), .O(z06));
  oai21  g48(.a(new_n58_), .b(x11), .c(x10), .O(new_n83_));
  ...
  nand4  g58(.a(new_n84_), .b(new_n92_), .c(new_n89_), .d(new_n88_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n35_), .O(new_n95_));
  nand3  g61(.a(x17), .b(x12), .c(x10), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n70_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n50_), .b(new_n98_), .c(new_n92_), .d(new_n89_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n35_), .c(new_n88_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(x07), .c(x06), .d(x04), .O(new_n103_));
  aoi21  g69(.a(x17), .b(new_n98_), .c(new_n35_), .O(new_n104_));
  aoi21  g70(.a(new_n93_), .b(x13), .c(new_n104_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n103_), .c(new_n70_), .O(z09));
  inv1   g72(.a(x00), .O(new_n107_));
  aoi21  g73(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n108_));
  nand4  g74(.a(new_n98_), .b(new_n92_), .c(new_n89_), .d(new_n35_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n108_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n88_), .c(x08), .d(x07), .O(new_n111_));
  ...
  nor2   g85(.a(new_n58_), .b(new_n46_), .O(z14));
endmodule
