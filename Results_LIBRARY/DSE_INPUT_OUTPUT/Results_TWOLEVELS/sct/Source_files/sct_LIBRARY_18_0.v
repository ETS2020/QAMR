...
module FAU ( 
  ...
  oai22  g64(.a(new_n98_), .b(new_n48_), .c(new_n49_), .d(new_n36_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n47_), .O(z10));
  nand2  g67(.a(new_n47_), .b(new_n38_), .O(z11));
  ...
  nand2  g71(.a(new_n47_), .b(new_n43_), .O(z13));
  inv1   g72(.a(x17), .O(new_n107_));
  nor3   g73(.a(new_n44_), .b(new_n107_), .c(new_n43_), .O(z14));
endmodule
