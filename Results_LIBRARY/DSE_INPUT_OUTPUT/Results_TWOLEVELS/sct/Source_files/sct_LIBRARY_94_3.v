...
module FAU ( 
  ...
  oai21  g29(.a(new_n63_), .b(new_n44_), .c(new_n39_), .O(new_n64_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n64_), .d(new_n39_), .O(z08));
  nand2  g49(.a(new_n82_), .b(x13), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n63_), .c(new_n39_), .O(new_n86_));
  nand3  g52(.a(new_n48_), .b(x04), .c(new_n35_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(x01), .c(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n81_), .c(new_n76_), .d(new_n75_), .O(new_n89_));
  ...
  nand4  g59(.a(new_n93_), .b(new_n76_), .c(new_n75_), .d(new_n35_), .O(new_n94_));
  oai21  g60(.a(x01), .b(new_n35_), .c(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n48_), .c(new_n67_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  nand2  g64(.a(new_n60_), .b(x02), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n39_), .c(x16), .d(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n98_), .c(new_n44_), .O(z10));
  nor2   g67(.a(new_n40_), .b(new_n36_), .O(z11));
  oai21  g68(.a(new_n61_), .b(x02), .c(new_n60_), .O(new_n103_));
