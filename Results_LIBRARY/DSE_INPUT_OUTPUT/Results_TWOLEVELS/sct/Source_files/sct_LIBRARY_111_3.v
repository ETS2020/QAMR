...
module FAU ( 
  ...
  aoi21  g33(.a(new_n67_), .b(new_n36_), .c(new_n35_), .O(new_n68_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n36_), .c(new_n74_), .d(new_n66_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n73_), .c(new_n65_), .O(z06));
  inv1   g43(.a(x11), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n74_), .c(new_n66_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n56_), .c(new_n36_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x08), .O(new_n81_));
  nand3  g47(.a(new_n74_), .b(new_n66_), .c(x08), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n56_), .c(x11), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n65_), .O(z07));
  inv1   g50(.a(x12), .O(new_n85_));
  inv1   g51(.a(new_n67_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n78_), .d(new_n74_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n36_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x08), .O(new_n89_));
  oai21  g55(.a(new_n79_), .b(new_n69_), .c(x12), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n65_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n50_), .b(new_n92_), .c(new_n85_), .d(new_n78_), .O(new_n93_));
  ...
  inv1   g67(.a(new_n50_), .O(new_n102_));
  nand4  g68(.a(new_n92_), .b(new_n85_), .c(new_n78_), .d(new_n74_), .O(new_n103_));
  ...
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n46_), .O(z10));
  nand2  g76(.a(new_n38_), .b(new_n40_), .O(z11));
  inv1   g77(.a(x03), .O(new_n112_));
  oai21  g78(.a(new_n62_), .b(x02), .c(new_n112_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n38_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  aoi21  g81(.a(x17), .b(x08), .c(new_n46_), .O(z13));
