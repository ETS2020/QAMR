...
module FAU ( 
  ...
  nand2  g08(.a(new_n35_), .b(new_n42_), .O(new_n43_));
  inv1   g09(.a(x04), .O(new_n44_));
  nand2  g10(.a(x05), .b(new_n44_), .O(new_n45_));
  nand3  g11(.a(new_n45_), .b(new_n43_), .c(new_n41_), .O(z01));
  inv1   g12(.a(x06), .O(new_n47_));
  inv1   g13(.a(x02), .O(new_n48_));
  oai21  g14(.a(x03), .b(new_n48_), .c(x16), .O(new_n49_));
  nand4  g15(.a(new_n49_), .b(new_n43_), .c(new_n47_), .d(x04), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z02));
  xor2a  g17(.a(x07), .b(x06), .O(new_n52_));
  nand4  g18(.a(new_n52_), .b(new_n49_), .c(new_n43_), .d(x04), .O(new_n53_));
  ...
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n43_), .O(new_n65_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n43_), .O(z05));
  nand2  g36(.a(new_n69_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n56_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(new_n43_), .O(z06));
  inv1   g40(.a(new_n43_), .O(new_n75_));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n76_), .c(new_n75_), .O(z07));
  ...
  aoi21  g63(.a(new_n97_), .b(new_n42_), .c(new_n96_), .O(new_n98_));
  ...
  nand2  g67(.a(new_n101_), .b(new_n43_), .O(z10));
  nand2  g68(.a(new_n43_), .b(new_n48_), .O(z11));
  nor3   g69(.a(new_n75_), .b(new_n62_), .c(x02), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(x03), .c(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n43_), .O(z12));
  nor2   g72(.a(new_n75_), .b(new_n44_), .O(z13));
  nand2  g73(.a(x17), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n43_), .O(z14));
endmodule
