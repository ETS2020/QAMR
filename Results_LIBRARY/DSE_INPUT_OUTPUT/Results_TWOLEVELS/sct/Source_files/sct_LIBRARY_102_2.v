...
module FAU ( 
  ...
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(new_n47_), .O(z05));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n69_), .c(new_n43_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n69_), .c(new_n43_), .O(z08));
  ...
  nand4  g62(.a(new_n96_), .b(new_n76_), .c(new_n75_), .d(new_n36_), .O(new_n97_));
  oai21  g63(.a(new_n35_), .b(new_n36_), .c(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n49_), .c(new_n66_), .d(x08), .O(new_n99_));
