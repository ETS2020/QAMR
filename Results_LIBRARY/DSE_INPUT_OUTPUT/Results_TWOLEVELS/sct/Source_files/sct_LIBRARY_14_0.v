...
module FAU ( 
  ...
  oai21  g28(.a(new_n45_), .b(x02), .c(new_n49_), .O(new_n63_));
  ...
  nand4  g48(.a(new_n68_), .b(new_n82_), .c(new_n81_), .d(new_n66_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n79_), .b(x11), .c(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n64_), .c(new_n41_), .O(z07));
  nand2  g52(.a(new_n83_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n78_), .b(new_n68_), .c(new_n88_), .d(new_n82_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n75_), .d(new_n40_), .O(z08));
  nand2  g56(.a(new_n89_), .b(x13), .O(new_n91_));
  inv1   g57(.a(new_n76_), .O(new_n92_));
  nor2   g58(.a(x13), .b(x12), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n82_), .d(new_n81_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n75_), .d(new_n40_), .O(z09));
  nand2  g61(.a(new_n81_), .b(x01), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n88_), .c(new_n82_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n96_), .c(new_n39_), .O(new_n99_));
  ...
  nand4  g68(.a(new_n50_), .b(new_n40_), .c(x16), .d(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n45_), .O(z10));
  inv1   g70(.a(x02), .O(new_n105_));
  nand2  g71(.a(new_n40_), .b(new_n105_), .O(z11));
  nand3  g72(.a(new_n40_), .b(x16), .c(new_n105_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n49_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n40_), .O(z12));
  nor2   g76(.a(new_n41_), .b(new_n45_), .O(z13));
