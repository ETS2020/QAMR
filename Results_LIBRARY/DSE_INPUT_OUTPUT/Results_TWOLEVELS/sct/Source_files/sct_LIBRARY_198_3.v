...
module FAU ( 
  ...
  nand2  g30(.a(x16), .b(new_n40_), .O(new_n65_));
  ...
  oai21  g45(.a(new_n74_), .b(new_n45_), .c(new_n38_), .O(new_n80_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n80_), .d(new_n38_), .O(z07));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n90_), .c(new_n37_), .O(z08));
