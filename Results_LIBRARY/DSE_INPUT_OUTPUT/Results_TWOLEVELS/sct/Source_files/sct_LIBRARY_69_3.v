...
module FAU ( 
  ...
  oai21  g60(.a(x17), .b(new_n86_), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g69(.a(new_n103_), .b(new_n59_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n38_), .O(z12));
  aoi21  g72(.a(x17), .b(x00), .c(new_n43_), .O(z13));
  nand3  g73(.a(x17), .b(x04), .c(new_n86_), .O(new_n108_));
