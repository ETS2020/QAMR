...
module FAU ( 
  ...
  nand2  g31(.a(x16), .b(new_n49_), .O(new_n66_));
  oai21  g32(.a(new_n65_), .b(new_n39_), .c(new_n66_), .O(new_n67_));
  ...
  nand2  g39(.a(x04), .b(new_n49_), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n62_), .c(new_n73_), .O(new_n75_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n81_), .d(new_n48_), .O(z07));
  ...
  aoi21  g62(.a(new_n96_), .b(new_n92_), .c(new_n40_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n50_), .b(new_n98_), .c(new_n93_), .d(new_n88_), .O(new_n99_));
  ...
  aoi21  g69(.a(new_n94_), .b(x13), .c(new_n40_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n81_), .O(z09));
  nand2  g71(.a(x01), .b(x00), .O(new_n106_));
  nand4  g72(.a(new_n98_), .b(new_n93_), .c(new_n88_), .d(new_n87_), .O(new_n107_));
  aoi22  g73(.a(new_n107_), .b(new_n106_), .c(new_n63_), .d(x16), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n76_), .c(x08), .d(x07), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n47_), .c(new_n50_), .d(new_n36_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n48_), .O(z10));
  nand2  g78(.a(new_n48_), .b(new_n49_), .O(z11));
  nor2   g79(.a(new_n40_), .b(new_n73_), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n49_), .c(x03), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n44_), .c(new_n48_), .O(z12));
  nand2  g82(.a(new_n48_), .b(new_n44_), .O(z13));
