...
module FAU ( 
  ...
  aoi21  g58(.a(new_n88_), .b(new_n92_), .c(new_n51_), .O(new_n93_));
  ...
  oai21  g67(.a(new_n101_), .b(new_n44_), .c(new_n47_), .O(z12));
  aoi21  g68(.a(x17), .b(new_n92_), .c(new_n44_), .O(z13));
  aoi21  g69(.a(new_n44_), .b(x00), .c(new_n38_), .O(z14));
endmodule
