...
module FAU ( 
  ...
  aoi21  g36(.a(new_n70_), .b(new_n64_), .c(new_n37_), .O(z05));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n37_), .O(z07));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n37_), .O(z08));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n64_), .c(new_n37_), .O(z09));
  ...
  nand2  g66(.a(new_n46_), .b(new_n38_), .O(z11));
  ...
  aoi21  g70(.a(x18), .b(x17), .c(new_n43_), .O(z13));
  aoi21  g71(.a(new_n36_), .b(new_n43_), .c(new_n35_), .O(z14));
endmodule
