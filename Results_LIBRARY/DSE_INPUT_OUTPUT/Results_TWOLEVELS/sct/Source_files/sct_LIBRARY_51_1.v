...
module FAU ( 
  ...
  oai21  g33(.a(new_n36_), .b(new_n41_), .c(x17), .O(new_n68_));
  ...
  nand2  g78(.a(new_n47_), .b(new_n41_), .O(z13));
  aoi21  g79(.a(x14), .b(new_n41_), .c(new_n42_), .O(z14));
endmodule
