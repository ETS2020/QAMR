...
module FAU ( 
  ...
  aoi21  g41(.a(new_n75_), .b(new_n64_), .c(new_n40_), .O(z06));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n66_), .d(new_n48_), .O(z08));
  ...
  aoi21  g59(.a(new_n86_), .b(x13), .c(new_n40_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n66_), .O(z09));
  inv1   g61(.a(x16), .O(new_n96_));
  aoi21  g62(.a(new_n62_), .b(x02), .c(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n88_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n36_), .c(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n69_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n47_), .c(new_n50_), .d(new_n37_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n48_), .O(z10));
  nand2  g69(.a(new_n48_), .b(new_n49_), .O(z11));
  oai21  g70(.a(new_n96_), .b(x02), .c(new_n62_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n48_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nor2   g73(.a(new_n40_), .b(new_n44_), .O(z13));
