...
module FAU ( 
  ...
  nand4  g19(.a(new_n53_), .b(new_n50_), .c(new_n46_), .d(x04), .O(new_n54_));
  ...
  nand4  g25(.a(new_n59_), .b(new_n50_), .c(new_n46_), .d(x04), .O(new_n60_));
  inv1   g26(.a(new_n60_), .O(z04));
  inv1   g27(.a(x16), .O(new_n62_));
  inv1   g28(.a(x02), .O(new_n63_));
  nand2  g29(.a(x04), .b(new_n63_), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(new_n48_), .c(new_n62_), .O(new_n65_));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n75_), .c(new_n39_), .O(z06));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n75_), .c(new_n39_), .O(z07));
  nor2   g53(.a(new_n65_), .b(new_n43_), .O(new_n88_));
  nand2  g54(.a(new_n84_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n77_), .b(new_n68_), .c(new_n90_), .d(new_n83_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n46_), .O(z08));
  nand2  g58(.a(new_n91_), .b(x13), .O(new_n93_));
  inv1   g59(.a(new_n76_), .O(new_n94_));
  nor2   g60(.a(x13), .b(x12), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n83_), .d(new_n82_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n93_), .c(new_n88_), .d(new_n46_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n82_), .b(x01), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n90_), .c(new_n83_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n99_), .c(new_n98_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n50_), .c(new_n66_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x07), .c(x06), .O(new_n105_));
  nand4  g71(.a(new_n49_), .b(new_n46_), .c(x16), .d(x14), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n43_), .O(z10));
  nand2  g73(.a(new_n46_), .b(new_n63_), .O(z11));
  oai21  g74(.a(new_n62_), .b(x02), .c(new_n48_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n46_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nor2   g77(.a(new_n39_), .b(new_n43_), .O(z13));
  nand2  g78(.a(x17), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n46_), .O(z14));
endmodule
