...
module FAU ( 
  ...
  aoi21  g38(.a(new_n72_), .b(new_n48_), .c(new_n71_), .O(new_n73_));
  ...
  nand2  g44(.a(new_n75_), .b(x10), .O(new_n79_));
  nor2   g45(.a(x10), .b(x09), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n57_), .c(x08), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n79_), .c(x04), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(new_n73_), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n40_), .O(z06));
  oai21  g50(.a(new_n73_), .b(new_n44_), .c(new_n39_), .O(new_n85_));
  nand2  g51(.a(new_n81_), .b(x11), .O(new_n86_));
  inv1   g52(.a(new_n66_), .O(new_n87_));
  nor2   g53(.a(x11), .b(x10), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n87_), .c(new_n74_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n85_), .d(new_n39_), .O(z07));
  ...
  nand4  g59(.a(new_n93_), .b(new_n91_), .c(new_n85_), .d(new_n39_), .O(z08));
  ...
  nand4  g64(.a(new_n98_), .b(new_n95_), .c(new_n85_), .d(new_n39_), .O(z09));
  inv1   g65(.a(x11), .O(new_n100_));
  nor2   g66(.a(x10), .b(x00), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n97_), .c(new_n100_), .O(new_n102_));
  oai21  g68(.a(x01), .b(new_n35_), .c(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n50_), .c(new_n74_), .d(x08), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(x07), .c(x06), .O(new_n106_));
  nand4  g72(.a(new_n49_), .b(new_n39_), .c(x16), .d(x14), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n106_), .c(new_n44_), .O(z10));
  nor2   g74(.a(new_n40_), .b(new_n36_), .O(z11));
  nand2  g75(.a(new_n64_), .b(new_n48_), .O(new_n110_));
