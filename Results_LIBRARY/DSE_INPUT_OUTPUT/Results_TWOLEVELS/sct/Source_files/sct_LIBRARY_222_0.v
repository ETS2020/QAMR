...
module FAU ( 
  ...
  nor2   g05(.a(x17), .b(x00), .O(new_n40_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n76_), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  aoi21  g49(.a(new_n78_), .b(x12), .c(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n63_), .c(new_n40_), .O(z08));
  nand2  g51(.a(new_n82_), .b(x13), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n63_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n47_), .O(new_n88_));
  inv1   g54(.a(x10), .O(new_n89_));
  inv1   g55(.a(x00), .O(new_n90_));
  nand3  g56(.a(new_n49_), .b(x17), .c(x04), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n81_), .c(new_n80_), .d(new_n89_), .O(new_n93_));
  ...
  nand2  g62(.a(new_n61_), .b(x02), .O(new_n97_));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n77_), .b(x17), .c(new_n98_), .d(new_n81_), .O(new_n99_));
  aoi22  g65(.a(new_n99_), .b(new_n90_), .c(new_n97_), .d(x16), .O(new_n100_));
  ...
  nand2  g70(.a(new_n47_), .b(new_n35_), .O(z11));
  nand3  g71(.a(new_n47_), .b(x16), .c(new_n35_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n61_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n47_), .O(z12));
  nand2  g75(.a(new_n47_), .b(new_n44_), .O(z13));
