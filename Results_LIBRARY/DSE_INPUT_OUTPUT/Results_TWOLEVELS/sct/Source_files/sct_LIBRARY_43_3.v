...
module FAU ( 
  ...
  nand4  g18(.a(new_n52_), .b(new_n49_), .c(new_n41_), .d(x04), .O(new_n53_));
  ...
  nand4  g24(.a(new_n58_), .b(new_n49_), .c(new_n41_), .d(x04), .O(new_n59_));
  inv1   g25(.a(new_n59_), .O(z04));
  nand2  g26(.a(x04), .b(new_n35_), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(new_n46_), .c(new_n47_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n40_), .c(new_n41_), .O(new_n63_));
  ...
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(new_n41_), .O(z05));
  nand2  g34(.a(new_n67_), .b(x10), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n56_), .c(x08), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n63_), .d(new_n41_), .O(z06));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n63_), .d(new_n41_), .O(z07));
  ...
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n63_), .d(new_n41_), .O(z08));
  inv1   g48(.a(new_n62_), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n67_), .c(x04), .O(new_n86_));
  aoi21  g52(.a(new_n81_), .b(x13), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n83_), .c(new_n42_), .O(z09));
  ...
  nand2  g60(.a(new_n94_), .b(new_n41_), .O(z10));
  nor2   g61(.a(new_n42_), .b(new_n35_), .O(z11));
  oai21  g62(.a(new_n47_), .b(x02), .c(new_n46_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n41_), .c(x04), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(z12));
  nor2   g65(.a(new_n42_), .b(new_n40_), .O(z13));
  nand3  g66(.a(new_n41_), .b(x17), .c(x04), .O(new_n101_));
