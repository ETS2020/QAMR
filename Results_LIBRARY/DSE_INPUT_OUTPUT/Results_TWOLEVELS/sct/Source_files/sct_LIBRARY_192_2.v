...
module FAU ( 
  ...
  oai21  g40(.a(new_n67_), .b(new_n47_), .c(new_n37_), .O(new_n75_));
  nand3  g41(.a(x17), .b(new_n70_), .c(x08), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n58_), .c(x10), .O(new_n77_));
  nand4  g43(.a(new_n59_), .b(new_n35_), .c(new_n70_), .d(x08), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(z06));
  inv1   g45(.a(x17), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(x11), .c(x10), .O(new_n81_));
  ...
  oai21  g51(.a(new_n80_), .b(x12), .c(x10), .O(new_n86_));
  ...
  nand4  g60(.a(new_n51_), .b(new_n94_), .c(new_n89_), .d(new_n87_), .O(new_n95_));
  ...
  nand3  g67(.a(x17), .b(x13), .c(x10), .O(new_n102_));
  ...
  nand2  g77(.a(new_n37_), .b(new_n41_), .O(z11));
  ...
  nor2   g81(.a(new_n36_), .b(new_n47_), .O(z13));
  nor2   g82(.a(new_n80_), .b(new_n47_), .O(z14));
endmodule
