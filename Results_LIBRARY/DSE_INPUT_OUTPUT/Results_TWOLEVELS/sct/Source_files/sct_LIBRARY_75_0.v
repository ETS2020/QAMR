...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(new_n47_), .c(new_n36_), .d(x04), .O(new_n51_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n54_), .c(x04), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n68_), .c(x17), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n64_), .O(z05));
  oai21  g39(.a(new_n68_), .b(new_n43_), .c(new_n36_), .O(new_n74_));
  inv1   g40(.a(x17), .O(new_n75_));
  nand3  g41(.a(x08), .b(x07), .c(x06), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n75_), .c(new_n69_), .O(new_n78_));
  nor4   g44(.a(new_n76_), .b(new_n75_), .c(x10), .d(x09), .O(new_n79_));
  aoi21  g45(.a(new_n78_), .b(x10), .c(new_n79_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n74_), .O(z06));
  nor2   g47(.a(x10), .b(new_n53_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n55_), .c(new_n75_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(x09), .c(x11), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nor2   g51(.a(x10), .b(x09), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n77_), .c(x17), .d(new_n85_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n84_), .c(new_n74_), .O(z07));
  inv1   g54(.a(x10), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n85_), .c(new_n89_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n76_), .c(x17), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n69_), .O(new_n93_));
  nand3  g59(.a(new_n85_), .b(new_n89_), .c(new_n69_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n76_), .c(x12), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n93_), .c(new_n74_), .O(z08));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n47_), .b(x17), .c(new_n97_), .d(new_n90_), .O(new_n98_));
  nor3   g64(.a(new_n98_), .b(x11), .c(x10), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(x08), .c(x07), .d(x06), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n43_), .c(x17), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n69_), .O(new_n102_));
  nand3  g68(.a(new_n86_), .b(new_n90_), .c(new_n85_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n76_), .c(x13), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n102_), .c(new_n74_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  inv1   g72(.a(new_n47_), .O(new_n107_));
  nand4  g73(.a(new_n97_), .b(new_n90_), .c(new_n85_), .d(new_n89_), .O(new_n108_));
  ...
  nand2  g78(.a(new_n112_), .b(x17), .O(new_n113_));
  nand3  g79(.a(new_n107_), .b(x14), .c(x09), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n113_), .c(new_n43_), .O(z10));
  nor2   g81(.a(new_n35_), .b(new_n38_), .O(z11));
  nor3   g82(.a(new_n35_), .b(new_n66_), .c(x02), .O(new_n117_));
  oai21  g83(.a(new_n117_), .b(x03), .c(x04), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n36_), .O(z12));
  nor2   g85(.a(new_n35_), .b(new_n43_), .O(z13));
  nor2   g86(.a(new_n75_), .b(new_n43_), .O(z14));
endmodule
