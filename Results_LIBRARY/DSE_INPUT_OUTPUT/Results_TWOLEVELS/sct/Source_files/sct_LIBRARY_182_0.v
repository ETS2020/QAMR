...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n45_), .c(new_n36_), .O(new_n65_));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n81_), .c(new_n35_), .O(z08));
  ...
  aoi21  g61(.a(new_n95_), .b(new_n93_), .c(new_n35_), .O(z09));
  ...
  nand2  g70(.a(new_n36_), .b(new_n40_), .O(z11));
  nor3   g71(.a(new_n35_), .b(new_n62_), .c(x02), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(x03), .c(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n36_), .O(z12));
