...
module FAU ( 
  ...
  nand3  g36(.a(new_n70_), .b(new_n62_), .c(x04), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n47_), .O(new_n72_));
  inv1   g38(.a(x10), .O(new_n73_));
  inv1   g39(.a(x12), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n43_), .c(x11), .O(new_n75_));
  ...
  oai21  g46(.a(new_n80_), .b(new_n43_), .c(new_n73_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(x12), .c(x11), .O(new_n82_));
  inv1   g48(.a(new_n65_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n36_), .c(new_n73_), .d(new_n67_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n82_), .c(new_n64_), .O(z07));
  nand3  g51(.a(x08), .b(x07), .c(x06), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n48_), .O(new_n87_));
  nand4  g53(.a(new_n55_), .b(x11), .c(new_n73_), .d(x08), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n73_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n67_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n87_), .c(new_n43_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(x09), .c(x12), .O(new_n92_));
  nor2   g58(.a(x10), .b(x09), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n83_), .c(new_n74_), .d(new_n36_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n92_), .c(new_n64_), .O(z08));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n48_), .b(new_n96_), .c(new_n74_), .d(new_n73_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x09), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(x08), .c(x07), .d(x06), .O(new_n99_));
  nand3  g65(.a(new_n93_), .b(new_n55_), .c(x08), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x13), .O(new_n101_));
  oai21  g67(.a(new_n99_), .b(new_n43_), .c(new_n101_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n36_), .O(new_n103_));
  nand2  g69(.a(x13), .b(x12), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n64_), .O(z09));
  inv1   g71(.a(x00), .O(new_n106_));
  inv1   g72(.a(x14), .O(new_n107_));
  and2   g73(.a(new_n48_), .b(new_n67_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(x08), .c(x07), .d(x06), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n106_), .c(new_n48_), .d(new_n107_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n47_), .O(new_n111_));
  nand3  g77(.a(new_n48_), .b(new_n96_), .c(new_n74_), .O(new_n112_));
  nor4   g78(.a(new_n112_), .b(x11), .c(x10), .d(x09), .O(new_n113_));
  nand4  g79(.a(new_n113_), .b(x08), .c(x07), .d(x06), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n111_), .c(new_n43_), .O(z10));
  nor2   g81(.a(new_n37_), .b(new_n35_), .O(z11));
  inv1   g82(.a(x16), .O(new_n117_));
  oai21  g83(.a(new_n117_), .b(x02), .c(new_n60_), .O(new_n118_));
  nand3  g84(.a(new_n118_), .b(new_n47_), .c(x04), .O(new_n119_));
  inv1   g85(.a(new_n119_), .O(z12));
  oai21  g86(.a(new_n80_), .b(new_n36_), .c(new_n90_), .O(new_n121_));
  nand2  g87(.a(new_n121_), .b(x12), .O(new_n122_));
  aoi21  g88(.a(new_n122_), .b(x11), .c(new_n43_), .O(z13));
