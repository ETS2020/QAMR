...
module FAU ( 
  ...
  nand2  g05(.a(new_n37_), .b(new_n36_), .O(new_n40_));
  ...
  nand4  g21(.a(new_n55_), .b(new_n52_), .c(new_n40_), .d(x04), .O(new_n56_));
  ...
  nand3  g30(.a(x16), .b(x04), .c(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x04), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(new_n40_), .O(new_n67_));
  oai21  g33(.a(new_n36_), .b(new_n45_), .c(new_n37_), .O(new_n68_));
  ...
  nor2   g40(.a(new_n74_), .b(new_n41_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n69_), .d(new_n67_), .O(z05));
  inv1   g42(.a(x10), .O(new_n77_));
  nor2   g43(.a(new_n74_), .b(new_n77_), .O(new_n78_));
  ...
  oai21  g47(.a(new_n81_), .b(new_n78_), .c(new_n40_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n69_), .O(z06));
  inv1   g49(.a(x11), .O(new_n84_));
  inv1   g50(.a(new_n70_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n77_), .d(new_n72_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n65_), .c(x04), .O(new_n87_));
  aoi21  g53(.a(new_n80_), .b(x11), .c(new_n87_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n41_), .c(new_n69_), .O(z07));
  ...
  nand3  g58(.a(new_n92_), .b(new_n65_), .c(x04), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(new_n40_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n69_), .O(z08));
  nand2  g61(.a(new_n92_), .b(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n91_), .c(new_n84_), .d(new_n77_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n74_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n96_), .c(new_n65_), .d(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n40_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n69_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  aoi21  g70(.a(new_n98_), .b(new_n104_), .c(new_n51_), .O(new_n105_));
  ...
  nand2  g75(.a(new_n109_), .b(new_n40_), .O(z10));
  nand2  g76(.a(new_n40_), .b(new_n64_), .O(z11));
  nor3   g77(.a(new_n41_), .b(new_n50_), .c(x02), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(x03), .c(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n40_), .O(z12));
  nor2   g80(.a(new_n41_), .b(new_n45_), .O(z13));
  nor2   g81(.a(new_n37_), .b(new_n45_), .O(z14));
endmodule
