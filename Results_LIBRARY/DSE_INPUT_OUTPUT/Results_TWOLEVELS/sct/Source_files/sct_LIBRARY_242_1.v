...
module FAU ( 
  ...
  oai21  g28(.a(new_n62_), .b(new_n40_), .c(new_n45_), .O(new_n63_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n63_), .d(new_n45_), .O(z08));
  nand2  g50(.a(new_n83_), .b(x13), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n73_), .c(x04), .O(new_n86_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n75_), .c(new_n74_), .d(new_n41_), .O(new_n96_));
  ...
  oai21  g70(.a(new_n60_), .b(x02), .c(new_n59_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n45_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nor2   g73(.a(new_n42_), .b(new_n40_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n45_), .O(z14));
endmodule
