...
module FAU ( 
  ...
  nand3  g01(.a(x03), .b(new_n35_), .c(x01), .O(new_n36_));
  oai21  g02(.a(x14), .b(x01), .c(new_n36_), .O(z00));
  inv1   g03(.a(x18), .O(new_n38_));
  nor2   g04(.a(new_n38_), .b(x15), .O(new_n39_));
  inv1   g05(.a(x04), .O(new_n40_));
  inv1   g06(.a(x01), .O(new_n41_));
  nor2   g07(.a(x03), .b(new_n41_), .O(new_n42_));
  ...
  oai21  g32(.a(x16), .b(new_n40_), .c(x03), .O(new_n67_));
  ...
  nand3  g44(.a(x04), .b(new_n35_), .c(new_n41_), .O(new_n79_));
  ...
  oai21  g59(.a(new_n93_), .b(new_n90_), .c(new_n53_), .O(new_n94_));
  ...
  oai21  g65(.a(new_n99_), .b(new_n42_), .c(new_n81_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n97_), .b(new_n101_), .c(new_n55_), .O(new_n102_));
  ...
  nand2  g75(.a(new_n109_), .b(new_n45_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n53_), .O(z12));
  nor2   g78(.a(new_n42_), .b(new_n40_), .O(z13));
