...
module FAU ( 
  ...
  oai21  g40(.a(new_n65_), .b(new_n46_), .c(new_n37_), .O(new_n75_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n75_), .d(new_n37_), .O(z07));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n86_), .c(new_n36_), .O(z08));
  ...
  aoi21  g63(.a(new_n88_), .b(x13), .c(new_n36_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n75_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n101_));
  nand4  g67(.a(new_n92_), .b(new_n87_), .c(new_n83_), .d(new_n82_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n101_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n66_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n49_), .c(new_n50_), .d(new_n39_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n37_), .O(z10));
  nand2  g73(.a(new_n37_), .b(new_n41_), .O(z11));
  nor2   g74(.a(new_n36_), .b(new_n63_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n41_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n46_), .c(new_n37_), .O(z12));
  aoi21  g77(.a(x17), .b(new_n100_), .c(new_n46_), .O(z13));
  aoi21  g78(.a(new_n46_), .b(x00), .c(new_n35_), .O(z14));
endmodule
