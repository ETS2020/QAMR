...
module FAU ( 
  ...
  nor2   g32(.a(new_n66_), .b(x09), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(x08), .c(x07), .d(x06), .O(new_n68_));
  nand2  g34(.a(x16), .b(new_n35_), .O(new_n69_));
  oai21  g35(.a(new_n68_), .b(new_n40_), .c(new_n69_), .O(new_n70_));
  nand3  g36(.a(x08), .b(x07), .c(x06), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x09), .O(new_n72_));
  nand2  g38(.a(x16), .b(x03), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(x04), .O(new_n74_));
  aoi21  g40(.a(new_n70_), .b(x04), .c(new_n74_), .O(new_n75_));
  nand2  g41(.a(x04), .b(new_n35_), .O(new_n76_));
  aoi21  g42(.a(new_n76_), .b(new_n64_), .c(new_n65_), .O(new_n77_));
  inv1   g43(.a(x09), .O(new_n78_));
  nand3  g44(.a(new_n58_), .b(new_n78_), .c(x08), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n72_), .c(x04), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n77_), .c(new_n40_), .O(new_n81_));
  oai21  g47(.a(new_n75_), .b(new_n63_), .c(new_n81_), .O(z05));
  nor2   g48(.a(new_n77_), .b(new_n46_), .O(new_n83_));
  ...
  inv1   g56(.a(new_n71_), .O(new_n91_));
  ...
  nand2  g66(.a(new_n97_), .b(x13), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n88_), .c(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n49_), .O(new_n103_));
  nand3  g69(.a(new_n51_), .b(x04), .c(new_n40_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n63_), .c(x13), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n96_), .c(new_n90_), .d(new_n89_), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(x09), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(x08), .c(x07), .d(x06), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n103_), .O(z09));
  nor2   g75(.a(x13), .b(x12), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n90_), .c(new_n89_), .d(new_n40_), .O(new_n111_));
  nand2  g77(.a(x17), .b(x00), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n111_), .c(new_n66_), .O(new_n113_));
  nand4  g79(.a(new_n113_), .b(new_n78_), .c(x08), .d(x07), .O(new_n114_));
  oai22  g80(.a(new_n114_), .b(new_n50_), .c(new_n51_), .d(new_n38_), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n49_), .O(z10));
  nor2   g83(.a(new_n41_), .b(new_n35_), .O(z11));
  nor2   g84(.a(new_n41_), .b(new_n65_), .O(new_n119_));
  aoi21  g85(.a(new_n119_), .b(new_n35_), .c(x03), .O(new_n120_));
  oai21  g86(.a(new_n120_), .b(new_n46_), .c(new_n49_), .O(z12));
  nand2  g87(.a(new_n49_), .b(new_n46_), .O(z13));
  nor2   g88(.a(new_n63_), .b(new_n46_), .O(z14));
endmodule
