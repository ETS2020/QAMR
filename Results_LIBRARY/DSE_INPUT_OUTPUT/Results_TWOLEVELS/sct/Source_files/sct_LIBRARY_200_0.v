...
module FAU ( 
  ...
  nand3  g36(.a(new_n49_), .b(x04), .c(x00), .O(new_n71_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n36_), .O(z06));
  ...
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n75_), .d(new_n36_), .O(z07));
  nand2  g51(.a(new_n84_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n78_), .b(new_n67_), .c(new_n87_), .d(new_n83_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(x04), .O(new_n89_));
  or2    g55(.a(new_n89_), .b(new_n64_), .O(new_n90_));
  and2   g56(.a(new_n90_), .b(new_n36_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n49_), .b(new_n92_), .c(new_n87_), .d(new_n83_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x09), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x08), .c(x07), .d(x06), .O(new_n95_));
  nand2  g61(.a(x13), .b(x12), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n45_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  aoi21  g64(.a(new_n84_), .b(x13), .c(new_n35_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(new_n75_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  aoi21  g67(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n102_));
  nand4  g68(.a(new_n92_), .b(new_n87_), .c(new_n83_), .d(new_n82_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n102_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n65_), .c(x08), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n48_), .c(new_n49_), .d(new_n38_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n36_), .O(z10));
  nand2  g74(.a(new_n36_), .b(new_n40_), .O(z11));
  nor3   g75(.a(new_n35_), .b(new_n62_), .c(x02), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(x03), .c(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n36_), .O(z12));
  nor2   g78(.a(new_n35_), .b(new_n45_), .O(z13));
  oai21  g79(.a(new_n70_), .b(new_n45_), .c(new_n36_), .O(z14));
endmodule
