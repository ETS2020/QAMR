...
module FAU ( 
  ...
  oai21  g33(.a(x17), .b(x09), .c(new_n57_), .O(new_n68_));
  ...
  oai21  g38(.a(x17), .b(x10), .c(new_n57_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n73_), .d(new_n67_), .O(z06));
  inv1   g44(.a(x11), .O(new_n79_));
  aoi21  g45(.a(new_n76_), .b(new_n59_), .c(new_n79_), .O(new_n80_));
  nor4   g46(.a(new_n58_), .b(x11), .c(x10), .d(x09), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n80_), .c(x08), .O(new_n82_));
  nand3  g48(.a(new_n35_), .b(x11), .c(new_n57_), .O(new_n83_));
  ...
  nand3  g56(.a(new_n35_), .b(x12), .c(new_n57_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n67_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n51_), .b(new_n93_), .c(new_n85_), .d(new_n79_), .O(new_n94_));
  ...
  aoi21  g64(.a(new_n35_), .b(new_n93_), .c(x08), .O(new_n99_));
  aoi21  g65(.a(new_n88_), .b(x13), .c(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n98_), .c(new_n67_), .O(z09));
  ...
  nand4  g70(.a(new_n104_), .b(new_n51_), .c(new_n70_), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n49_), .c(new_n51_), .d(new_n40_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x08), .O(new_n107_));
  inv1   g73(.a(x03), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x02), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n35_), .c(x16), .d(x14), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n107_), .c(new_n46_), .O(z10));
  nor2   g77(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g78(.a(new_n64_), .b(x02), .c(new_n108_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n50_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n50_), .b(new_n46_), .O(z13));
  nand3  g82(.a(x17), .b(x08), .c(x04), .O(new_n117_));
