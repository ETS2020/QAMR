...
module FAU ( 
  ...
  oai21  g04(.a(new_n36_), .b(x01), .c(new_n38_), .O(z00));
  inv1   g05(.a(x00), .O(new_n40_));
  nor2   g06(.a(x01), .b(new_n40_), .O(new_n41_));
  ...
  nand4  g19(.a(new_n53_), .b(new_n49_), .c(new_n48_), .d(x04), .O(new_n54_));
  ...
  nand4  g28(.a(new_n62_), .b(new_n53_), .c(new_n49_), .d(x04), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(z04));
  oai21  g30(.a(new_n45_), .b(x02), .c(new_n50_), .O(new_n65_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n68_), .d(new_n49_), .O(z07));
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n68_), .d(new_n49_), .O(z08));
  ...
  aoi21  g59(.a(new_n90_), .b(new_n40_), .c(new_n52_), .O(new_n94_));
  ...
  nand2  g64(.a(new_n98_), .b(new_n49_), .O(z10));
  nor2   g65(.a(new_n41_), .b(new_n37_), .O(z11));
  oai21  g66(.a(new_n51_), .b(x02), .c(new_n50_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n49_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  nand2  g69(.a(new_n49_), .b(new_n45_), .O(z13));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n49_), .O(z14));
endmodule
