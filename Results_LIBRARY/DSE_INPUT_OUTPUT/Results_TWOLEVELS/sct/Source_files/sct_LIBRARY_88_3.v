...
module FAU ( 
  ...
  nand3  g19(.a(new_n53_), .b(x02), .c(new_n38_), .O(new_n54_));
  ...
  oai21  g35(.a(new_n44_), .b(x02), .c(new_n53_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(x16), .c(new_n38_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n69_), .O(z05));
  nand2  g38(.a(new_n47_), .b(new_n44_), .O(z13));
  ...
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n74_), .d(z13), .O(z07));
  nand2  g50(.a(new_n83_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n76_), .b(new_n82_), .c(new_n86_), .d(new_n81_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n74_), .d(z13), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n49_), .b(new_n89_), .c(new_n86_), .d(new_n81_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n80_), .c(new_n66_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(x07), .c(x06), .d(x04), .O(new_n94_));
  nand2  g60(.a(new_n87_), .b(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n74_), .d(z13), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  aoi21  g63(.a(new_n53_), .b(x02), .c(new_n39_), .O(new_n98_));
  nand4  g64(.a(new_n89_), .b(new_n86_), .c(new_n81_), .d(new_n80_), .O(new_n99_));
  ...
  nand2  g71(.a(new_n47_), .b(new_n35_), .O(z11));
  nand3  g72(.a(x16), .b(new_n35_), .c(new_n38_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n53_), .O(new_n108_));
