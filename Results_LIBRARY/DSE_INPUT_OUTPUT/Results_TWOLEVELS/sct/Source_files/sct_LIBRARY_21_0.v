...
module FAU ( 
  ...
  oai21  g28(.a(new_n62_), .b(new_n41_), .c(new_n46_), .O(new_n63_));
  ...
  nand3  g52(.a(new_n47_), .b(x04), .c(x01), .O(new_n87_));
  ...
  nand2  g58(.a(new_n74_), .b(x01), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n80_), .c(new_n75_), .O(new_n95_));
  ...
  nand2  g68(.a(new_n46_), .b(new_n36_), .O(z11));
  ...
  nor2   g72(.a(new_n42_), .b(new_n41_), .O(z13));
