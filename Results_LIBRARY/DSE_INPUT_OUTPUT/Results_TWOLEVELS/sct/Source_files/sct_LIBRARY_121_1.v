...
module FAU ( 
  ...
  nor2   g52(.a(new_n64_), .b(new_n44_), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(x12), .O(new_n88_));
  nor2   g54(.a(x12), .b(x11), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n76_), .c(new_n67_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n39_), .O(z08));
  nand2  g57(.a(new_n90_), .b(x13), .O(new_n92_));
  inv1   g58(.a(new_n75_), .O(new_n93_));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n93_), .c(new_n82_), .d(new_n81_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n92_), .c(new_n87_), .d(new_n39_), .O(z09));
  nor2   g62(.a(x10), .b(x01), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n94_), .c(new_n82_), .O(new_n98_));
  ...
  nand4  g68(.a(new_n49_), .b(new_n39_), .c(x16), .d(x14), .O(new_n103_));
