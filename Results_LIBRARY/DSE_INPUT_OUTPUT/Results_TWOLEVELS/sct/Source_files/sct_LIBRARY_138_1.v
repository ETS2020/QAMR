...
module FAU ( 
  ...
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n64_), .d(new_n47_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n79_), .c(new_n64_), .d(new_n47_), .O(z08));
  ...
  nor2   g60(.a(x15), .b(x13), .O(new_n95_));
  ...
  oai21  g70(.a(new_n61_), .b(x02), .c(new_n60_), .O(new_n105_));
  ...
  nand2  g75(.a(new_n109_), .b(new_n47_), .O(z14));
endmodule
