...
module FAU ( 
  ...
  nand2  g32(.a(x16), .b(new_n41_), .O(new_n67_));
  ...
  aoi21  g59(.a(new_n93_), .b(new_n87_), .c(new_n36_), .O(z07));
  ...
  nand4  g63(.a(new_n97_), .b(new_n95_), .c(new_n82_), .d(new_n37_), .O(z08));
  ...
  aoi21  g68(.a(new_n102_), .b(new_n87_), .c(new_n36_), .O(z09));
