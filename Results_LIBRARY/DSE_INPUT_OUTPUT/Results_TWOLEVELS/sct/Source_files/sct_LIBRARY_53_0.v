...
module FAU ( 
  ...
  nand3  g22(.a(x14), .b(x08), .c(new_n36_), .O(new_n57_));
  ...
  oai21  g29(.a(new_n37_), .b(new_n44_), .c(new_n36_), .O(new_n64_));
  ...
  nand3  g36(.a(x14), .b(x09), .c(new_n36_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .d(new_n63_), .O(z05));
  ...
  nand3  g43(.a(x14), .b(x10), .c(new_n36_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n65_), .d(new_n63_), .O(z06));
  oai21  g45(.a(new_n37_), .b(x11), .c(new_n36_), .O(new_n80_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n65_), .d(new_n63_), .O(z07));
  oai21  g51(.a(new_n37_), .b(x12), .c(new_n36_), .O(new_n86_));
  nand2  g52(.a(new_n83_), .b(new_n67_), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n73_), .d(new_n66_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n81_), .O(new_n91_));
  aoi21  g57(.a(new_n87_), .b(x12), .c(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n86_), .c(new_n65_), .d(new_n63_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n50_), .b(new_n94_), .c(new_n89_), .d(new_n88_), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n73_), .c(new_n66_), .d(x08), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(x07), .c(x06), .d(x04), .O(new_n99_));
  aoi21  g65(.a(x14), .b(new_n94_), .c(x07), .O(new_n100_));
  nand4  g66(.a(new_n74_), .b(new_n89_), .c(new_n88_), .d(new_n73_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(x13), .c(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n99_), .c(new_n65_), .d(new_n63_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  inv1   g70(.a(x03), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x02), .c(new_n61_), .O(new_n106_));
  nand4  g72(.a(new_n94_), .b(new_n89_), .c(new_n88_), .d(new_n73_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n104_), .c(new_n106_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n66_), .c(x08), .d(x07), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n48_), .c(new_n50_), .d(new_n37_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n47_), .O(z10));
  nor2   g78(.a(new_n40_), .b(new_n49_), .O(z11));
  nor3   g79(.a(new_n40_), .b(new_n61_), .c(x02), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(x03), .c(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n47_), .O(z12));
