...
module FAU ( 
  ...
  aoi21  g29(.a(new_n63_), .b(x16), .c(x09), .O(new_n64_));
  nand4  g30(.a(new_n64_), .b(x08), .c(x07), .d(x06), .O(new_n65_));
  nand2  g31(.a(x16), .b(new_n39_), .O(new_n66_));
  oai21  g32(.a(new_n65_), .b(new_n61_), .c(new_n66_), .O(new_n67_));
  ...
  nand3  g42(.a(new_n56_), .b(new_n76_), .c(x08), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n69_), .c(x04), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n75_), .c(new_n61_), .O(new_n79_));
  oai21  g45(.a(new_n72_), .b(x17), .c(new_n79_), .O(z05));
  oai21  g46(.a(new_n75_), .b(new_n44_), .c(new_n35_), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(x10), .O(new_n82_));
  nor2   g48(.a(x10), .b(x09), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n56_), .c(x08), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n35_), .O(z06));
  ...
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n81_), .d(new_n35_), .O(z07));
  inv1   g57(.a(new_n75_), .O(new_n92_));
  inv1   g58(.a(x12), .O(new_n93_));
  nand4  g59(.a(new_n83_), .b(new_n89_), .c(new_n93_), .d(new_n88_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  aoi21  g61(.a(new_n90_), .b(x12), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n92_), .c(new_n45_), .O(z08));
  inv1   g63(.a(x13), .O(new_n98_));
  nand4  g64(.a(new_n49_), .b(new_n98_), .c(new_n93_), .d(new_n88_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n87_), .c(new_n76_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(x07), .c(x06), .d(x04), .O(new_n103_));
  aoi21  g69(.a(new_n94_), .b(x13), .c(new_n45_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n103_), .c(new_n81_), .O(z09));
  nand4  g71(.a(new_n98_), .b(new_n93_), .c(new_n88_), .d(new_n87_), .O(new_n106_));
  inv1   g72(.a(x17), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x00), .O(new_n108_));
  aoi22  g74(.a(new_n108_), .b(new_n106_), .c(new_n63_), .d(x16), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n76_), .c(x08), .d(x07), .O(new_n110_));
  ...
  nand2  g79(.a(new_n35_), .b(new_n39_), .O(z11));
  nand3  g80(.a(new_n35_), .b(x16), .c(new_n39_), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n62_), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n35_), .O(z12));
  aoi21  g84(.a(x17), .b(x00), .c(new_n44_), .O(z13));
  aoi21  g85(.a(new_n44_), .b(new_n61_), .c(new_n107_), .O(z14));
endmodule
