...
module FAU ( 
  ...
  oai21  g58(.a(new_n74_), .b(new_n44_), .c(new_n47_), .O(new_n93_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n94_), .c(new_n93_), .d(new_n47_), .O(z08));
  ...
  oai22  g76(.a(new_n110_), .b(new_n48_), .c(new_n49_), .d(new_n106_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n47_), .O(z10));
  nor2   g79(.a(new_n40_), .b(new_n36_), .O(z11));
  ...
  nand3  g84(.a(new_n47_), .b(x17), .c(x04), .O(new_n119_));
