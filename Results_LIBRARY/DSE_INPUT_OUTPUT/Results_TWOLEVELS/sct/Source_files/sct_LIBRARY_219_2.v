...
module FAU ( 
  ...
  aoi21  g47(.a(new_n81_), .b(new_n64_), .c(new_n36_), .O(z07));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n64_), .c(new_n36_), .O(z08));
  ...
  aoi21  g59(.a(new_n84_), .b(x13), .c(new_n36_), .O(new_n94_));
  ...
  nand4  g63(.a(new_n88_), .b(new_n83_), .c(new_n77_), .d(new_n76_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n35_), .c(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n69_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n49_), .c(new_n50_), .d(new_n39_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n37_), .O(z10));
  nor2   g69(.a(new_n36_), .b(new_n41_), .O(z11));
  nor2   g70(.a(new_n36_), .b(new_n96_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n41_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n46_), .c(new_n37_), .O(z12));
  nor2   g73(.a(new_n36_), .b(new_n46_), .O(z13));
