...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n117_;
  nor2   g00(.a(x11), .b(x06), .O(new_n35_));
  ...
  nand4  g15(.a(new_n49_), .b(x11), .c(new_n48_), .d(x04), .O(new_n50_));
  inv1   g16(.a(new_n50_), .O(z02));
  nand3  g17(.a(x11), .b(x07), .c(new_n48_), .O(new_n52_));
  ...
  nand3  g22(.a(x11), .b(x08), .c(new_n48_), .O(new_n57_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(new_n65_), .O(z05));
  oai21  g38(.a(new_n66_), .b(x10), .c(new_n48_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n73_), .d(new_n65_), .O(z06));
  nand3  g44(.a(new_n49_), .b(new_n48_), .c(x04), .O(new_n79_));
  nand3  g45(.a(new_n76_), .b(x08), .c(x07), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x11), .O(new_n83_));
  oai21  g49(.a(new_n81_), .b(new_n48_), .c(new_n66_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n65_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nor2   g52(.a(new_n81_), .b(new_n86_), .O(new_n87_));
  nor4   g53(.a(new_n74_), .b(x12), .c(x11), .d(x10), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n87_), .c(x06), .O(new_n89_));
  nand2  g55(.a(x12), .b(x11), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n65_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n49_), .b(new_n92_), .c(new_n86_), .d(new_n66_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x10), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n70_), .c(x08), .d(x07), .O(new_n95_));
  inv1   g61(.a(x10), .O(new_n96_));
  nand3  g62(.a(new_n86_), .b(new_n96_), .c(new_n70_), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n68_), .c(x13), .O(new_n98_));
  oai21  g64(.a(new_n95_), .b(new_n45_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g70(.a(new_n104_), .b(x02), .c(new_n62_), .O(new_n105_));
  nand4  g71(.a(new_n92_), .b(new_n86_), .c(new_n66_), .d(new_n96_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n103_), .c(new_n105_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n70_), .c(x08), .d(x07), .O(new_n108_));
  oai22  g74(.a(new_n108_), .b(new_n48_), .c(new_n49_), .d(new_n39_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n61_), .O(z10));
  nand2  g77(.a(new_n61_), .b(new_n36_), .O(z11));
  oai21  g78(.a(new_n62_), .b(x02), .c(new_n104_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n61_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n61_), .b(new_n45_), .O(z13));
  inv1   g82(.a(x17), .O(new_n117_));
  nor3   g83(.a(new_n35_), .b(new_n117_), .c(new_n45_), .O(z14));
endmodule
