...
module FAU ( 
  ...
  nand3  g50(.a(new_n84_), .b(new_n66_), .c(new_n64_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n80_), .c(new_n74_), .d(new_n36_), .O(z07));
  ...
  aoi21  g56(.a(new_n85_), .b(x12), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n87_), .c(new_n35_), .O(z08));
  nand2  g58(.a(new_n89_), .b(x13), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  inv1   g60(.a(new_n75_), .O(new_n95_));
  nand4  g61(.a(new_n84_), .b(new_n95_), .c(new_n94_), .d(new_n88_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n93_), .c(new_n74_), .d(new_n36_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand3  g64(.a(x17), .b(new_n94_), .c(new_n88_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n83_), .c(new_n98_), .O(new_n100_));
  ...
  nand4  g69(.a(new_n48_), .b(new_n36_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n43_), .O(z10));
  nand2  g71(.a(new_n36_), .b(new_n38_), .O(z11));
  oai21  g72(.a(new_n61_), .b(x02), .c(new_n47_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n36_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nand2  g75(.a(new_n36_), .b(new_n43_), .O(z13));
  oai21  g76(.a(new_n69_), .b(new_n43_), .c(new_n36_), .O(z14));
endmodule
