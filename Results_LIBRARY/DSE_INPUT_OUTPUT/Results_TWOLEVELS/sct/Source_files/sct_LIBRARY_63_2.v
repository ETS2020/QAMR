...
module FAU ( 
  ...
  oai21  g59(.a(new_n75_), .b(new_n44_), .c(new_n48_), .O(new_n94_));
  nand2  g60(.a(new_n90_), .b(x12), .O(new_n95_));
  inv1   g61(.a(x12), .O(new_n96_));
  nand4  g62(.a(new_n82_), .b(new_n89_), .c(new_n96_), .d(new_n88_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n95_), .c(new_n94_), .d(new_n48_), .O(z08));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n50_), .b(new_n99_), .c(new_n96_), .d(new_n88_), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n87_), .c(new_n76_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(x07), .c(x06), .d(x04), .O(new_n104_));
  aoi21  g70(.a(new_n97_), .b(x13), .c(new_n40_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n104_), .c(new_n94_), .O(z09));
  nand2  g72(.a(x01), .b(x00), .O(new_n107_));
  nand4  g73(.a(new_n99_), .b(new_n96_), .c(new_n88_), .d(new_n87_), .O(new_n108_));
  aoi22  g74(.a(new_n108_), .b(new_n107_), .c(new_n63_), .d(x16), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n76_), .c(x08), .d(x07), .O(new_n110_));
  oai22  g76(.a(new_n110_), .b(new_n47_), .c(new_n50_), .d(new_n37_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n48_), .O(z10));
  nand2  g79(.a(new_n48_), .b(new_n49_), .O(z11));
  nand2  g80(.a(new_n66_), .b(new_n62_), .O(new_n115_));
