...
module FAU ( 
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n66_), .d(new_n39_), .O(z08));
  ...
  aoi21  g57(.a(new_n91_), .b(new_n64_), .c(new_n40_), .O(z09));
  ...
  nor2   g65(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g66(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n39_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  nand2  g69(.a(new_n39_), .b(new_n44_), .O(z13));
  nor2   g70(.a(new_n36_), .b(new_n44_), .O(z14));
endmodule
