...
module FAU ( 
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n36_), .O(z07));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n36_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n84_), .c(new_n78_), .d(new_n77_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n68_), .c(x04), .O(new_n91_));
  aoi21  g57(.a(new_n85_), .b(x13), .c(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n64_), .c(new_n36_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  aoi21  g60(.a(new_n90_), .b(new_n94_), .c(new_n50_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n67_), .c(x08), .d(x07), .O(new_n96_));
  ...
  nand2  g66(.a(new_n46_), .b(new_n37_), .O(z11));
  ...
  aoi21  g70(.a(new_n41_), .b(x17), .c(new_n43_), .O(z13));
  aoi21  g71(.a(x18), .b(new_n43_), .c(new_n35_), .O(z14));
endmodule
