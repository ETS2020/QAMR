...
module FAU ( 
  ...
  aoi21  g29(.a(x04), .b(new_n36_), .c(x03), .O(new_n64_));
  ...
  oai21  g38(.a(new_n67_), .b(x10), .c(new_n56_), .O(new_n73_));
  nand3  g39(.a(new_n70_), .b(x07), .c(x06), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x10), .O(new_n75_));
  nor2   g41(.a(x10), .b(x09), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n58_), .c(x08), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n73_), .d(new_n66_), .O(z06));
  inv1   g44(.a(x11), .O(new_n79_));
  aoi21  g45(.a(new_n76_), .b(new_n58_), .c(new_n79_), .O(new_n80_));
  nor4   g46(.a(new_n57_), .b(x11), .c(x10), .d(x09), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n80_), .c(x08), .O(new_n82_));
  nand3  g48(.a(x17), .b(x11), .c(new_n56_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n66_), .O(z07));
  inv1   g50(.a(x12), .O(new_n85_));
  inv1   g51(.a(x10), .O(new_n86_));
  inv1   g52(.a(new_n74_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n79_), .d(new_n86_), .O(new_n88_));
  oai21  g54(.a(new_n81_), .b(new_n85_), .c(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x08), .O(new_n90_));
  nand3  g56(.a(x17), .b(x12), .c(new_n56_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n66_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n50_), .b(new_n93_), .c(new_n85_), .d(new_n79_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n86_), .c(new_n70_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(x07), .c(x06), .d(x04), .O(new_n98_));
  aoi21  g64(.a(x17), .b(new_n93_), .c(x08), .O(new_n99_));
  aoi21  g65(.a(new_n88_), .b(x13), .c(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n98_), .c(new_n66_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  nand4  g68(.a(new_n93_), .b(new_n85_), .c(new_n79_), .d(new_n86_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n50_), .c(new_n70_), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n48_), .c(new_n50_), .d(new_n39_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x08), .O(new_n107_));
  inv1   g73(.a(x03), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x02), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(x17), .c(x16), .d(x14), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n107_), .c(new_n45_), .O(z10));
  nor2   g77(.a(new_n35_), .b(new_n36_), .O(z11));
  oai21  g78(.a(new_n63_), .b(x02), .c(new_n108_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n49_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nand2  g81(.a(new_n49_), .b(new_n45_), .O(z13));
  nor2   g82(.a(new_n67_), .b(new_n45_), .O(z14));
endmodule
