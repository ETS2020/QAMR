...
module FAU ( 
  ...
  inv1   g15(.a(new_n41_), .O(new_n50_));
  ...
  nand4  g26(.a(new_n60_), .b(new_n51_), .c(new_n50_), .d(x04), .O(new_n61_));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n65_), .c(new_n41_), .O(z06));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n65_), .c(new_n41_), .O(z07));
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n67_), .d(new_n50_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n51_), .b(new_n89_), .c(new_n86_), .d(new_n79_), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n78_), .c(new_n70_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(x07), .c(x06), .d(x04), .O(new_n94_));
  aoi21  g60(.a(new_n87_), .b(x13), .c(new_n41_), .O(new_n95_));
  ...
  nand4  g64(.a(new_n89_), .b(new_n86_), .c(new_n79_), .d(new_n78_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n40_), .c(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n70_), .c(x08), .d(x07), .O(new_n101_));
  oai22  g67(.a(new_n101_), .b(new_n49_), .c(new_n51_), .d(new_n38_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n50_), .O(z10));
  nor2   g70(.a(new_n41_), .b(new_n35_), .O(z11));
  nor2   g71(.a(new_n41_), .b(new_n97_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n35_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n46_), .c(new_n50_), .O(z12));
  nand2  g74(.a(new_n50_), .b(new_n46_), .O(z13));
