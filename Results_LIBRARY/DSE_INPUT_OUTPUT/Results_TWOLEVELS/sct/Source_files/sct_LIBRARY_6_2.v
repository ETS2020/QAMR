...
module FAU ( 
  ...
  oai21  g35(.a(new_n58_), .b(new_n56_), .c(x09), .O(new_n70_));
  inv1   g36(.a(x03), .O(new_n71_));
  inv1   g37(.a(x16), .O(new_n72_));
  nand2  g38(.a(x04), .b(new_n41_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n71_), .c(new_n72_), .O(new_n74_));
  nand3  g40(.a(x08), .b(x07), .c(x06), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x04), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n74_), .c(new_n35_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n70_), .c(new_n69_), .O(z05));
  oai21  g44(.a(new_n74_), .b(new_n46_), .c(new_n37_), .O(new_n79_));
  inv1   g45(.a(x10), .O(new_n80_));
  inv1   g46(.a(new_n75_), .O(new_n81_));
  inv1   g47(.a(new_n60_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(x08), .O(new_n83_));
  oai21  g49(.a(new_n81_), .b(new_n80_), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n35_), .O(new_n85_));
  nand3  g51(.a(x17), .b(x10), .c(x09), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(z06));
  nand2  g53(.a(new_n83_), .b(x11), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  nand4  g55(.a(new_n82_), .b(new_n89_), .c(new_n80_), .d(x08), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n35_), .O(new_n92_));
  nand3  g58(.a(x17), .b(x11), .c(x09), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n79_), .O(z07));
  oai21  g60(.a(new_n58_), .b(x12), .c(x09), .O(new_n95_));
  nor2   g61(.a(x12), .b(x11), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n80_), .c(new_n35_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  aoi22  g64(.a(new_n98_), .b(new_n81_), .c(new_n90_), .d(x12), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n95_), .c(new_n79_), .O(z08));
  inv1   g66(.a(x12), .O(new_n101_));
  inv1   g67(.a(x13), .O(new_n102_));
  nand4  g68(.a(new_n50_), .b(new_n102_), .c(new_n101_), .d(new_n89_), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n80_), .c(new_n35_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(x07), .c(x06), .d(x04), .O(new_n107_));
  aoi21  g73(.a(x17), .b(new_n102_), .c(new_n35_), .O(new_n108_));
  nand3  g74(.a(new_n96_), .b(new_n81_), .c(new_n80_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(x13), .c(new_n108_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n107_), .c(new_n79_), .O(z09));
  inv1   g77(.a(x00), .O(new_n112_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n89_), .d(new_n80_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g80(.a(new_n114_), .b(new_n50_), .c(x08), .d(x07), .O(new_n115_));
  oai22  g81(.a(new_n115_), .b(new_n49_), .c(new_n50_), .d(new_n39_), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n35_), .O(new_n117_));
  nand2  g83(.a(new_n71_), .b(x02), .O(new_n118_));
  nand4  g84(.a(new_n118_), .b(x17), .c(x16), .d(x14), .O(new_n119_));
  aoi21  g85(.a(new_n119_), .b(new_n117_), .c(new_n46_), .O(z10));
  nor2   g86(.a(new_n36_), .b(new_n41_), .O(z11));
  nor2   g87(.a(new_n36_), .b(new_n72_), .O(new_n122_));
  aoi21  g88(.a(new_n122_), .b(new_n41_), .c(x03), .O(new_n123_));
  oai21  g89(.a(new_n123_), .b(new_n46_), .c(new_n37_), .O(z12));
  nor2   g90(.a(new_n36_), .b(new_n46_), .O(z13));
  nor2   g91(.a(new_n58_), .b(new_n46_), .O(z14));
endmodule
