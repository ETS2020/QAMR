...
module FAU ( 
  ...
  oai21  g29(.a(new_n40_), .b(x01), .c(new_n43_), .O(new_n64_));
  ...
  nand3  g53(.a(new_n73_), .b(new_n87_), .c(new_n80_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n81_), .c(new_n48_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n86_), .c(new_n64_), .d(new_n63_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n47_), .b(new_n92_), .c(new_n87_), .d(new_n80_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n79_), .c(new_n67_), .d(x08), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x07), .c(x06), .d(x04), .O(new_n97_));
  oai21  g63(.a(new_n88_), .b(new_n65_), .c(x13), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n64_), .c(new_n49_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n97_), .c(new_n63_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  inv1   g68(.a(x16), .O(new_n103_));
  aoi21  g69(.a(new_n61_), .b(x02), .c(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n92_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n102_), .c(new_n104_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n67_), .c(x08), .d(x07), .O(new_n107_));
  oai22  g73(.a(new_n107_), .b(new_n46_), .c(new_n47_), .d(new_n35_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n49_), .O(z10));
  nand2  g76(.a(new_n49_), .b(new_n37_), .O(z11));
  nor2   g77(.a(new_n48_), .b(new_n103_), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n37_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n43_), .c(new_n49_), .O(z12));
  nor2   g80(.a(new_n48_), .b(new_n43_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n48_), .b(new_n116_), .c(new_n43_), .O(z14));
endmodule
