...
module FAU ( 
  ...
  nand4  g20(.a(new_n54_), .b(new_n51_), .c(new_n46_), .d(x04), .O(new_n55_));
  ...
  nand4  g26(.a(new_n60_), .b(new_n51_), .c(new_n46_), .d(x04), .O(new_n61_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(new_n46_), .O(z05));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n39_), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n66_), .d(new_n46_), .O(z08));
  ...
  aoi21  g57(.a(new_n91_), .b(new_n64_), .c(new_n39_), .O(z09));
  ...
  nand2  g64(.a(new_n98_), .b(new_n46_), .O(z10));
  nor2   g65(.a(new_n39_), .b(new_n36_), .O(z11));
  oai21  g66(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n46_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  nand2  g69(.a(new_n46_), .b(new_n43_), .O(z13));
