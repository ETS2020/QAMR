...
module FAU ( 
  ...
  aoi21  g38(.a(new_n72_), .b(new_n61_), .c(new_n42_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n63_), .d(new_n46_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n69_), .b(new_n77_), .c(new_n80_), .d(new_n76_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n78_), .b(x12), .c(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n61_), .c(new_n42_), .O(z08));
  nand2  g50(.a(new_n81_), .b(x13), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n61_), .c(x04), .O(new_n86_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n76_), .c(new_n75_), .d(new_n41_), .O(new_n96_));
  ...
  nand2  g69(.a(new_n46_), .b(new_n35_), .O(z11));
