...
module FAU ( 
  ...
  nor2   g06(.a(x18), .b(x15), .O(new_n41_));
  aoi21  g07(.a(x15), .b(x04), .c(new_n41_), .O(new_n42_));
  inv1   g08(.a(x04), .O(new_n43_));
  nand3  g09(.a(new_n35_), .b(x05), .c(new_n43_), .O(new_n44_));
  ...
  oai21  g45(.a(x15), .b(x04), .c(new_n79_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n48_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n82_));
  nor3   g48(.a(new_n82_), .b(x10), .c(x09), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(x08), .c(x07), .d(x06), .O(new_n84_));
  nand2  g50(.a(new_n77_), .b(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n48_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand4  g53(.a(new_n81_), .b(new_n76_), .c(new_n71_), .d(new_n70_), .O(new_n88_));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n92_), .c(new_n43_), .O(z10));
  nand2  g61(.a(new_n46_), .b(new_n37_), .O(z11));
  aoi21  g62(.a(x16), .b(new_n37_), .c(x03), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(new_n43_), .O(z12));
