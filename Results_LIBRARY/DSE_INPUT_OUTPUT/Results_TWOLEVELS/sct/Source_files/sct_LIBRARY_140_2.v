...
module FAU ( 
  ...
  aoi21  g41(.a(new_n75_), .b(new_n64_), .c(new_n36_), .O(z06));
  ...
  aoi21  g49(.a(new_n63_), .b(x16), .c(new_n43_), .O(new_n84_));
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(new_n47_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n78_), .d(new_n77_), .O(new_n90_));
  ...
  nor2   g67(.a(new_n36_), .b(new_n49_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n37_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n43_), .c(new_n47_), .O(z12));
  nand2  g70(.a(new_n47_), .b(new_n43_), .O(z13));
