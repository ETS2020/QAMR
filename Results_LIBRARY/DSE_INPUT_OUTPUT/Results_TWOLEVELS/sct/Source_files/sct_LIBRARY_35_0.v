...
module FAU ( 
  ...
  aoi21  g52(.a(new_n86_), .b(new_n64_), .c(new_n35_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n50_), .b(new_n88_), .c(new_n83_), .d(new_n77_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n76_), .c(new_n69_), .d(x08), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(x07), .c(x06), .d(x04), .O(new_n93_));
  aoi21  g59(.a(new_n84_), .b(x13), .c(new_n35_), .O(new_n94_));
  ...
  nor2   g70(.a(new_n35_), .b(new_n40_), .O(z11));
  ...
  nand2  g74(.a(new_n36_), .b(new_n46_), .O(z13));
