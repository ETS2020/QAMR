...
module FAU ( 
  ...
  aoi21  g48(.a(new_n82_), .b(new_n76_), .c(new_n40_), .O(z07));
  ...
  nand3  g54(.a(new_n88_), .b(new_n76_), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n48_), .O(new_n90_));
  nand3  g56(.a(new_n50_), .b(x04), .c(new_n39_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n35_), .c(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n93_));
  ...
  nand4  g63(.a(new_n97_), .b(new_n78_), .c(new_n77_), .d(new_n39_), .O(new_n98_));
  oai21  g64(.a(new_n35_), .b(new_n39_), .c(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n50_), .c(new_n69_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n62_), .b(x02), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n48_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n102_), .c(new_n44_), .O(z10));
  nor2   g71(.a(new_n40_), .b(new_n49_), .O(z11));
  nor2   g72(.a(new_n40_), .b(new_n63_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n49_), .c(x03), .O(new_n108_));
