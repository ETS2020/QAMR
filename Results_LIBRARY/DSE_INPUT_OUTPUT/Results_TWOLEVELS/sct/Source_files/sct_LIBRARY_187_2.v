...
module FAU ( 
  ...
  oai21  g37(.a(x13), .b(new_n71_), .c(x17), .O(new_n72_));
  ...
  nor2   g47(.a(new_n81_), .b(new_n36_), .O(z06));
  oai21  g48(.a(new_n65_), .b(new_n46_), .c(new_n37_), .O(new_n83_));
  nand2  g49(.a(new_n79_), .b(x11), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nand4  g51(.a(new_n68_), .b(new_n85_), .c(new_n71_), .d(new_n66_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n83_), .d(new_n37_), .O(z07));
  nand2  g53(.a(new_n86_), .b(x12), .O(new_n88_));
  nor2   g54(.a(x12), .b(x11), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n78_), .c(new_n68_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(new_n83_), .d(new_n37_), .O(z08));
  inv1   g57(.a(x12), .O(new_n92_));
  nand4  g58(.a(new_n50_), .b(new_n35_), .c(new_n92_), .d(new_n85_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n71_), .c(x04), .O(new_n95_));
  nand3  g61(.a(x17), .b(x13), .c(x10), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n95_), .c(x09), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(x08), .c(x07), .d(x06), .O(new_n98_));
  nand3  g64(.a(new_n89_), .b(new_n68_), .c(new_n66_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(x17), .c(x13), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n98_), .c(new_n83_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  nand2  g68(.a(new_n62_), .b(x02), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(x16), .c(x09), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(x08), .c(x07), .d(x06), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n102_), .c(new_n50_), .d(new_n39_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n37_), .O(new_n107_));
  nor3   g73(.a(new_n93_), .b(x10), .c(x09), .O(new_n108_));
  ...
  nor2   g80(.a(new_n36_), .b(new_n46_), .O(z13));
