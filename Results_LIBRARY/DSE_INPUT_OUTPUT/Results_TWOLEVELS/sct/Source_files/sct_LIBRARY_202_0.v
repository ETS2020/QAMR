...
module FAU ( 
  ...
  nor2   g07(.a(x02), .b(x01), .O(new_n42_));
  ...
  nor2   g26(.a(new_n48_), .b(new_n47_), .O(new_n61_));
  oai22  g27(.a(new_n61_), .b(new_n60_), .c(x16), .d(new_n35_), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n59_), .c(x04), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(z04));
  oai21  g30(.a(new_n48_), .b(x02), .c(x04), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x01), .O(new_n66_));
  oai21  g32(.a(new_n61_), .b(new_n41_), .c(x02), .O(new_n67_));
  ...
  nand3  g44(.a(x04), .b(new_n60_), .c(x01), .O(new_n79_));
  oai21  g45(.a(new_n47_), .b(new_n60_), .c(new_n79_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x16), .O(new_n81_));
  oai21  g47(.a(new_n78_), .b(new_n42_), .c(new_n81_), .O(z06));
  ...
  aoi21  g53(.a(new_n76_), .b(x11), .c(new_n87_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n42_), .c(new_n81_), .O(z07));
  nand2  g55(.a(new_n86_), .b(x12), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand3  g57(.a(new_n75_), .b(new_n91_), .c(new_n84_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n85_), .c(new_n42_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n67_), .d(new_n66_), .O(z08));
  oai21  g61(.a(new_n92_), .b(new_n68_), .c(x13), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n91_), .c(new_n84_), .d(new_n83_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n72_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n96_), .c(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n45_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n81_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  aoi21  g70(.a(new_n98_), .b(new_n104_), .c(new_n49_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n70_), .c(x08), .d(x07), .O(new_n106_));
  ...
  nand2  g76(.a(new_n60_), .b(x01), .O(z11));
  aoi21  g77(.a(x16), .b(x04), .c(new_n35_), .O(new_n112_));
  oai22  g78(.a(new_n112_), .b(x02), .c(new_n41_), .d(new_n47_), .O(z12));
  nand2  g79(.a(new_n45_), .b(new_n41_), .O(z13));
  inv1   g80(.a(x17), .O(new_n115_));
  nor3   g81(.a(new_n42_), .b(new_n115_), .c(new_n41_), .O(z14));
endmodule
