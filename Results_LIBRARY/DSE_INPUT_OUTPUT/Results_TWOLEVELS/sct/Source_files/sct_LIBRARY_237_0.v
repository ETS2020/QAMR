...
module FAU ( 
  ...
  nand3  g40(.a(new_n57_), .b(new_n66_), .c(x08), .O(new_n75_));
  ...
  nor2   g46(.a(new_n80_), .b(new_n39_), .O(z06));
  oai21  g47(.a(new_n65_), .b(new_n43_), .c(new_n46_), .O(new_n82_));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n46_), .O(z07));
  nand2  g52(.a(new_n85_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n77_), .b(new_n68_), .c(new_n89_), .d(new_n88_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n87_), .c(new_n82_), .d(new_n46_), .O(z08));
  nand2  g57(.a(new_n90_), .b(x13), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  inv1   g59(.a(new_n75_), .O(new_n94_));
  nand4  g60(.a(new_n84_), .b(new_n94_), .c(new_n93_), .d(new_n89_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n92_), .c(new_n82_), .d(new_n46_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  inv1   g63(.a(x10), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x01), .O(new_n99_));
  nand3  g65(.a(new_n93_), .b(new_n89_), .c(new_n88_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n99_), .c(new_n97_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n50_), .c(new_n66_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x07), .c(x06), .O(new_n104_));
  nand4  g70(.a(new_n49_), .b(new_n46_), .c(x16), .d(x14), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n43_), .O(z10));
  nor2   g72(.a(new_n39_), .b(new_n63_), .O(z11));
  oai21  g73(.a(new_n62_), .b(x02), .c(new_n48_), .O(new_n108_));
  ...
  nor3   g78(.a(new_n39_), .b(new_n112_), .c(new_n43_), .O(z14));
endmodule
