...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n46_), .c(new_n45_), .d(x04), .O(new_n50_));
  ...
  oai21  g26(.a(new_n41_), .b(x02), .c(new_n47_), .O(new_n61_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n64_), .c(new_n62_), .d(new_n46_), .O(z05));
  ...
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n62_), .d(new_n46_), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n70_), .b(new_n78_), .c(new_n82_), .d(new_n77_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n46_), .c(x04), .O(new_n84_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n67_), .c(new_n41_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n62_), .d(new_n46_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand2  g59(.a(new_n76_), .b(x01), .O(new_n94_));
  nand3  g60(.a(new_n88_), .b(new_n82_), .c(new_n77_), .O(new_n95_));
  oai21  g61(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  ...
  nand4  g65(.a(new_n48_), .b(new_n46_), .c(x16), .d(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n41_), .O(z10));
  inv1   g67(.a(x02), .O(new_n102_));
  nand2  g68(.a(new_n46_), .b(new_n102_), .O(z11));
  aoi21  g69(.a(x16), .b(new_n102_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n41_), .c(new_n46_), .O(z12));
  nand2  g71(.a(new_n46_), .b(new_n41_), .O(z13));
  inv1   g72(.a(x17), .O(new_n107_));
  nor3   g73(.a(new_n42_), .b(new_n107_), .c(new_n41_), .O(z14));
endmodule
