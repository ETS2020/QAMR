...
module FAU ( 
  ...
  oai21  g33(.a(new_n67_), .b(new_n64_), .c(new_n36_), .O(new_n68_));
  nand2  g34(.a(x12), .b(x04), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n43_), .c(x09), .O(new_n70_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n64_), .c(new_n36_), .O(new_n77_));
  inv1   g43(.a(x10), .O(new_n78_));
  nand2  g44(.a(new_n69_), .b(new_n43_), .O(new_n79_));
  ...
  oai21  g49(.a(new_n64_), .b(new_n45_), .c(new_n36_), .O(new_n84_));
  ...
  aoi21  g56(.a(new_n90_), .b(x11), .c(new_n35_), .O(new_n91_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n98_), .c(new_n84_), .d(new_n36_), .O(z08));
  inv1   g66(.a(x13), .O(new_n101_));
  nand4  g67(.a(new_n49_), .b(x18), .c(new_n101_), .d(new_n85_), .O(new_n102_));
  nor3   g68(.a(new_n102_), .b(x10), .c(x09), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(x08), .c(x07), .d(x06), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n45_), .c(x18), .O(new_n105_));
  ...
  oai22  g78(.a(new_n112_), .b(new_n110_), .c(new_n49_), .d(new_n38_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n36_), .O(new_n114_));
  nand4  g80(.a(new_n49_), .b(x18), .c(new_n101_), .d(new_n95_), .O(new_n115_));
  ...
  nor2   g86(.a(new_n35_), .b(new_n40_), .O(z11));
  oai21  g87(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n122_));
  nand3  g88(.a(new_n122_), .b(new_n36_), .c(x04), .O(new_n123_));
  ...
  aoi21  g93(.a(new_n127_), .b(new_n43_), .c(new_n45_), .O(z13));
  inv1   g94(.a(x17), .O(new_n129_));
  nor3   g95(.a(new_n35_), .b(new_n129_), .c(new_n45_), .O(z14));
endmodule
