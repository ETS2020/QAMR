...
module FAU ( 
  ...
  nand3  g16(.a(new_n35_), .b(new_n50_), .c(x02), .O(new_n51_));
  ...
  aoi21  g29(.a(new_n50_), .b(x02), .c(new_n36_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n46_), .c(new_n35_), .O(new_n65_));
  ...
  aoi21  g35(.a(new_n36_), .b(new_n46_), .c(new_n37_), .O(new_n70_));
  ...
  and2   g47(.a(new_n64_), .b(x04), .O(new_n82_));
  ...
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(x04), .O(new_n86_));
  ...
  nand2  g55(.a(new_n38_), .b(new_n46_), .O(z13));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n52_), .b(new_n91_), .c(new_n84_), .d(new_n78_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(x10), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n68_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(new_n64_), .b(new_n35_), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n49_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  aoi21  g63(.a(new_n85_), .b(x13), .c(new_n37_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(z13), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n91_), .b(new_n84_), .c(new_n78_), .d(new_n77_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n52_), .c(new_n68_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(x07), .c(x06), .d(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z10));
  nor2   g72(.a(new_n37_), .b(new_n41_), .O(z11));
  oai21  g73(.a(new_n36_), .b(new_n35_), .c(x03), .O(new_n108_));
  nand3  g74(.a(x16), .b(new_n35_), .c(new_n41_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n46_), .O(z12));
