...
module FAU ( 
  ...
  nand3  g11(.a(x07), .b(x05), .c(new_n36_), .O(new_n46_));
  ...
  nor2   g22(.a(new_n37_), .b(new_n48_), .O(new_n57_));
  ...
  oai21  g36(.a(new_n70_), .b(new_n36_), .c(new_n65_), .O(z05));
  nand3  g37(.a(new_n57_), .b(new_n62_), .c(x08), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  nand4  g40(.a(new_n57_), .b(new_n74_), .c(new_n62_), .d(x08), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n49_), .d(x04), .O(z06));
  nand2  g42(.a(new_n75_), .b(x11), .O(new_n77_));
  inv1   g43(.a(x11), .O(new_n78_));
  inv1   g44(.a(new_n69_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n78_), .c(new_n74_), .d(new_n62_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n77_), .c(new_n49_), .d(x04), .O(z07));
  inv1   g47(.a(x12), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(new_n74_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n63_), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x07), .O(new_n85_));
  aoi21  g51(.a(new_n80_), .b(x12), .c(new_n68_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n36_), .c(new_n85_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n49_), .b(new_n88_), .c(new_n82_), .d(new_n78_), .O(new_n89_));
  nor3   g55(.a(new_n89_), .b(x10), .c(x09), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(x08), .c(x07), .d(x06), .O(new_n91_));
  nand4  g57(.a(new_n82_), .b(new_n78_), .c(new_n74_), .d(new_n62_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n69_), .c(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n91_), .c(new_n49_), .d(x04), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand4  g61(.a(new_n88_), .b(new_n82_), .c(new_n78_), .d(new_n74_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n95_), .c(new_n68_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n62_), .c(x08), .d(x07), .O(new_n98_));
  ...
  nand2  g67(.a(new_n101_), .b(new_n38_), .O(z10));
  nand2  g68(.a(new_n38_), .b(new_n39_), .O(z11));
  nand2  g69(.a(x16), .b(new_n39_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n66_), .c(new_n36_), .O(z12));
  nand2  g71(.a(x07), .b(new_n36_), .O(z13));
