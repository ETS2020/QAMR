...
module FAU ( 
  ...
  oai21  g05(.a(new_n39_), .b(x15), .c(new_n36_), .O(new_n40_));
  oai22  g06(.a(new_n40_), .b(x01), .c(new_n36_), .d(x04), .O(z01));
  inv1   g07(.a(x06), .O(new_n42_));
  oai21  g08(.a(x03), .b(new_n35_), .c(x16), .O(new_n43_));
  inv1   g09(.a(x01), .O(new_n44_));
  nor2   g10(.a(x05), .b(new_n44_), .O(new_n45_));
  inv1   g11(.a(new_n45_), .O(new_n46_));
  nand4  g12(.a(new_n46_), .b(new_n43_), .c(new_n42_), .d(x04), .O(new_n47_));
  inv1   g13(.a(new_n47_), .O(z02));
  xor2a  g14(.a(x07), .b(x06), .O(new_n49_));
  nand3  g15(.a(new_n49_), .b(new_n43_), .c(x04), .O(new_n50_));
  nand2  g16(.a(new_n50_), .b(new_n46_), .O(z03));
  ...
  nand4  g21(.a(new_n55_), .b(new_n46_), .c(new_n43_), .d(x04), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z04));
  inv1   g23(.a(x03), .O(new_n58_));
  inv1   g24(.a(x04), .O(new_n59_));
  oai21  g25(.a(new_n59_), .b(x02), .c(new_n58_), .O(new_n60_));
  ...
  nand3  g32(.a(new_n53_), .b(new_n66_), .c(x08), .O(new_n67_));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n61_), .c(new_n45_), .O(z06));
  ...
  aoi21  g44(.a(new_n70_), .b(x11), .c(new_n78_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n61_), .c(new_n45_), .O(z07));
  nand2  g46(.a(new_n77_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n69_), .b(new_n76_), .c(new_n82_), .d(new_n75_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n63_), .d(new_n46_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n43_), .b(new_n85_), .c(new_n82_), .d(new_n75_), .O(new_n86_));
  ...
  aoi21  g56(.a(new_n83_), .b(x13), .c(new_n45_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n90_), .c(new_n63_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  inv1   g59(.a(x16), .O(new_n94_));
  aoi21  g60(.a(new_n58_), .b(x02), .c(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n85_), .b(new_n82_), .c(new_n75_), .d(new_n74_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n93_), .c(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n66_), .c(x08), .d(x07), .O(new_n98_));
  nand2  g64(.a(new_n95_), .b(x14), .O(new_n99_));
  oai21  g65(.a(new_n98_), .b(new_n42_), .c(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n46_), .O(z10));
  nand2  g68(.a(new_n46_), .b(new_n35_), .O(z11));
  nor2   g69(.a(new_n45_), .b(new_n94_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n35_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n59_), .c(new_n46_), .O(z12));
  nor2   g72(.a(new_n45_), .b(new_n59_), .O(z13));
  inv1   g73(.a(x17), .O(new_n108_));
  nor3   g74(.a(new_n45_), .b(new_n108_), .c(new_n59_), .O(z14));
endmodule
