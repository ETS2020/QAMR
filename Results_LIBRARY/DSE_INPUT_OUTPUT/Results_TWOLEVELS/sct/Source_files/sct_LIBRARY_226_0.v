...
module FAU ( 
  ...
  oai21  g52(.a(new_n64_), .b(new_n43_), .c(new_n46_), .O(new_n87_));
  ...
  oai22  g70(.a(new_n104_), .b(new_n47_), .c(new_n49_), .d(new_n36_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n46_), .O(z10));
  nor2   g73(.a(new_n39_), .b(new_n48_), .O(z11));
  ...
  nand2  g77(.a(new_n46_), .b(new_n43_), .O(z13));
