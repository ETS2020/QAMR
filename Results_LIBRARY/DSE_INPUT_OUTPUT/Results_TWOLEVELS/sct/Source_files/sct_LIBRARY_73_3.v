...
module FAU ( 
  ...
  aoi21  g44(.a(new_n78_), .b(new_n62_), .c(new_n40_), .O(z07));
  nor2   g45(.a(new_n75_), .b(x09), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n68_), .c(x12), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  inv1   g49(.a(new_n65_), .O(new_n84_));
  nand4  g50(.a(new_n70_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n81_), .c(new_n64_), .d(new_n39_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n48_), .b(new_n87_), .c(new_n83_), .d(new_n82_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(x10), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(x08), .c(x07), .d(x06), .O(new_n90_));
  oai21  g56(.a(x11), .b(x10), .c(x13), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n44_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n67_), .O(new_n93_));
  nand4  g59(.a(new_n55_), .b(new_n83_), .c(new_n67_), .d(x08), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(x13), .c(new_n40_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n93_), .c(new_n64_), .O(z09));
  inv1   g62(.a(x16), .O(new_n97_));
  aoi21  g63(.a(new_n60_), .b(x02), .c(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n75_), .b(new_n87_), .c(new_n83_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n35_), .c(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n67_), .c(x08), .d(x07), .O(new_n101_));
  nor2   g67(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  aoi21  g68(.a(new_n98_), .b(x14), .c(new_n102_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n44_), .c(new_n39_), .O(z10));
  nand2  g70(.a(new_n39_), .b(new_n36_), .O(z11));
  oai21  g71(.a(new_n97_), .b(x02), .c(new_n60_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n39_), .c(x04), .O(new_n107_));
