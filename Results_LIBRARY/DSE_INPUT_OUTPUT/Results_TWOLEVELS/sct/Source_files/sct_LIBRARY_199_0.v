...
module FAU ( 
  ...
  aoi21  g43(.a(new_n77_), .b(new_n62_), .c(new_n42_), .O(z06));
  ...
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n79_), .d(new_n45_), .O(z07));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n62_), .c(new_n42_), .O(z08));
  nand2  g55(.a(new_n86_), .b(x13), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n62_), .c(x04), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n45_), .O(new_n92_));
  inv1   g58(.a(x00), .O(new_n93_));
  nand3  g59(.a(new_n48_), .b(x04), .c(x01), .O(new_n94_));
  ...
  nand2  g65(.a(new_n81_), .b(x01), .O(new_n100_));
  inv1   g66(.a(x13), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n85_), .c(new_n82_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n100_), .c(new_n93_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(x07), .c(x06), .O(new_n106_));
  nand2  g72(.a(new_n60_), .b(x02), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n45_), .c(x16), .d(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n106_), .c(new_n41_), .O(z10));
  nor2   g75(.a(new_n42_), .b(new_n47_), .O(z11));
  inv1   g76(.a(x16), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(x02), .c(new_n60_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n45_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nand2  g80(.a(new_n45_), .b(new_n41_), .O(z13));
  nand2  g81(.a(x17), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n45_), .O(z14));
endmodule
