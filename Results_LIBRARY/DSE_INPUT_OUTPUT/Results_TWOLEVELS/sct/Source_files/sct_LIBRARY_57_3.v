...
module FAU ( 
  ...
  aoi21  g02(.a(x01), .b(new_n35_), .c(new_n36_), .O(new_n37_));
  ...
  nand3  g28(.a(new_n62_), .b(x14), .c(new_n35_), .O(new_n63_));
  nand2  g29(.a(new_n36_), .b(new_n48_), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(new_n63_), .c(new_n43_), .O(new_n65_));
  nor2   g31(.a(x14), .b(new_n61_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n65_), .c(x16), .O(new_n67_));
  nand2  g33(.a(new_n47_), .b(new_n43_), .O(new_n68_));
  ...
  nand4  g42(.a(new_n56_), .b(new_n76_), .c(new_n71_), .d(x08), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  aoi21  g44(.a(new_n72_), .b(x10), .c(new_n78_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n39_), .c(new_n67_), .O(z06));
  inv1   g46(.a(new_n69_), .O(new_n81_));
  nor2   g47(.a(x11), .b(x10), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n71_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n77_), .b(x11), .c(new_n84_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n39_), .c(new_n67_), .O(z07));
  nand2  g52(.a(new_n83_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n76_), .d(new_n71_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n69_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(new_n39_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n87_), .c(new_n68_), .d(new_n67_), .O(z08));
  nand2  g59(.a(new_n64_), .b(new_n63_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x16), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n49_), .b(new_n96_), .c(new_n89_), .d(new_n88_), .O(new_n97_));
  nor3   g63(.a(new_n97_), .b(x10), .c(x09), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(x08), .c(x07), .d(x06), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(x00), .c(new_n95_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  oai21  g67(.a(new_n91_), .b(new_n96_), .c(x04), .O(new_n102_));
  nor2   g68(.a(x13), .b(x12), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n82_), .c(new_n73_), .O(new_n104_));
  nand2  g70(.a(x16), .b(x03), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  aoi22  g72(.a(new_n106_), .b(new_n36_), .c(new_n102_), .d(new_n47_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n101_), .O(z09));
  nand4  g74(.a(new_n103_), .b(new_n88_), .c(new_n76_), .d(new_n35_), .O(new_n109_));
  oai21  g75(.a(x14), .b(new_n35_), .c(new_n109_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n49_), .c(new_n71_), .d(x08), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(x07), .c(x06), .O(new_n113_));
  nand4  g79(.a(new_n62_), .b(x16), .c(x14), .d(new_n35_), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n113_), .c(new_n43_), .O(z10));
  nor2   g81(.a(new_n39_), .b(new_n48_), .O(z11));
  nand2  g82(.a(x16), .b(x14), .O(new_n117_));
  oai21  g83(.a(new_n117_), .b(x02), .c(new_n61_), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n35_), .O(new_n119_));
  inv1   g85(.a(x16), .O(new_n120_));
  oai21  g86(.a(new_n120_), .b(x02), .c(new_n61_), .O(new_n121_));
  nand2  g87(.a(new_n121_), .b(new_n36_), .O(new_n122_));
  aoi21  g88(.a(new_n122_), .b(new_n119_), .c(new_n43_), .O(z12));
  nor2   g89(.a(new_n39_), .b(new_n43_), .O(z13));
