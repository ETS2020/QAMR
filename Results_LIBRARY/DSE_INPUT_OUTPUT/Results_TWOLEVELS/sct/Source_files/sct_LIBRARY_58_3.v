...
module FAU ( 
  ...
  nand3  g23(.a(x16), .b(new_n50_), .c(x03), .O(new_n58_));
  ...
  aoi21  g32(.a(new_n62_), .b(x16), .c(x13), .O(new_n67_));
  ...
  oai21  g37(.a(new_n47_), .b(x02), .c(new_n45_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n50_), .c(x04), .O(new_n73_));
  inv1   g39(.a(new_n73_), .O(z12));
  nand2  g40(.a(x16), .b(x02), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(x02), .c(new_n50_), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n42_), .O(z13));
  inv1   g43(.a(x17), .O(new_n78_));
  aoi21  g44(.a(new_n78_), .b(new_n50_), .c(new_n42_), .O(z14));
endmodule
