...
module FAU ( 
  ...
  nand4  g23(.a(new_n37_), .b(new_n57_), .c(x07), .d(x06), .O(new_n58_));
  ...
  oai21  g32(.a(new_n47_), .b(x02), .c(new_n66_), .O(new_n67_));
  ...
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n70_), .d(new_n37_), .O(z05));
  nand2  g41(.a(new_n74_), .b(x10), .O(new_n76_));
  nor4   g42(.a(new_n61_), .b(x10), .c(x09), .d(new_n57_), .O(new_n77_));
  nor2   g43(.a(new_n77_), .b(new_n47_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n68_), .O(new_n79_));
  and2   g45(.a(new_n79_), .b(new_n37_), .O(z06));
  nand4  g46(.a(new_n61_), .b(new_n51_), .c(x17), .d(x08), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n47_), .O(new_n82_));
  inv1   g48(.a(x10), .O(new_n83_));
  nand4  g49(.a(x17), .b(new_n83_), .c(new_n73_), .d(x08), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n82_), .c(x11), .O(new_n85_));
  inv1   g51(.a(new_n71_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n35_), .c(new_n83_), .d(new_n73_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n70_), .O(z07));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n86_), .b(new_n89_), .c(new_n83_), .d(new_n73_), .O(new_n90_));
  oai21  g56(.a(new_n77_), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n35_), .O(new_n92_));
  nand3  g58(.a(x17), .b(x12), .c(x11), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n70_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n51_), .b(new_n95_), .c(new_n89_), .d(new_n83_), .O(new_n96_));
  ...
  nand3  g67(.a(x17), .b(x13), .c(x11), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n70_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  and2   g70(.a(new_n51_), .b(new_n73_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  oai22  g72(.a(new_n106_), .b(new_n104_), .c(new_n51_), .d(new_n39_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n37_), .O(new_n108_));
  nand3  g74(.a(new_n51_), .b(new_n95_), .c(new_n89_), .O(new_n109_));
  nor4   g75(.a(new_n109_), .b(x11), .c(x10), .d(x09), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(x08), .c(x07), .d(x06), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n108_), .c(new_n47_), .O(z10));
  nor2   g78(.a(new_n36_), .b(new_n41_), .O(z11));
  inv1   g79(.a(x16), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(x02), .c(new_n66_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n37_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n37_), .b(new_n47_), .O(z13));
  nor2   g84(.a(new_n59_), .b(new_n47_), .O(z14));
endmodule
