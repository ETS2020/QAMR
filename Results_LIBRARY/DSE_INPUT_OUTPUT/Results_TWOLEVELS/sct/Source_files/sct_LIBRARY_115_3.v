...
module FAU ( 
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n80_), .d(new_n38_), .O(z06));
  ...
  aoi21  g57(.a(new_n91_), .b(new_n85_), .c(new_n39_), .O(z07));
  nor2   g58(.a(x12), .b(x11), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n82_), .c(new_n88_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  aoi21  g61(.a(new_n89_), .b(x12), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n85_), .c(new_n39_), .O(z08));
  nand2  g63(.a(new_n94_), .b(x13), .O(new_n98_));
  inv1   g64(.a(new_n76_), .O(new_n99_));
  nor2   g65(.a(x13), .b(x12), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n99_), .c(new_n87_), .d(new_n86_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n98_), .c(new_n80_), .d(new_n38_), .O(z09));
  nand4  g68(.a(new_n100_), .b(new_n87_), .c(new_n86_), .d(new_n62_), .O(new_n103_));
  ...
  aoi21  g79(.a(x17), .b(x00), .c(new_n44_), .O(z13));
  nand3  g80(.a(x17), .b(x04), .c(new_n62_), .O(new_n115_));
