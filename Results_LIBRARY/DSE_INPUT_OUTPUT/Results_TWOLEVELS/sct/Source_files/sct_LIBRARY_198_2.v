...
module FAU ( 
  ...
  nand2  g37(.a(x04), .b(new_n39_), .O(new_n72_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n80_), .d(new_n37_), .O(z07));
  inv1   g55(.a(new_n74_), .O(new_n90_));
  ...
  aoi21  g59(.a(new_n88_), .b(x12), .c(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n90_), .c(new_n36_), .O(z08));
  nand2  g61(.a(new_n92_), .b(x13), .O(new_n96_));
  inv1   g62(.a(new_n76_), .O(new_n97_));
  nor2   g63(.a(x13), .b(x12), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n87_), .c(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n80_), .d(new_n37_), .O(z09));
  inv1   g66(.a(x11), .O(new_n101_));
  nor2   g67(.a(x10), .b(x00), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n98_), .c(new_n101_), .O(new_n103_));
  oai21  g69(.a(new_n62_), .b(new_n35_), .c(new_n103_), .O(new_n104_));
  ...
  nand4  g73(.a(new_n49_), .b(new_n37_), .c(x16), .d(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z10));
  nand2  g75(.a(new_n37_), .b(new_n39_), .O(z11));
  nand2  g76(.a(new_n65_), .b(new_n48_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n37_), .c(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z12));
  nand2  g79(.a(new_n37_), .b(new_n44_), .O(z13));
  oai21  g80(.a(new_n62_), .b(new_n44_), .c(new_n37_), .O(z14));
endmodule
