...
module FAU ( 
  ...
  nor2   g06(.a(x01), .b(x00), .O(new_n41_));
  ...
  nand4  g19(.a(new_n53_), .b(new_n50_), .c(new_n49_), .d(x04), .O(new_n54_));
  ...
  nand4  g25(.a(new_n59_), .b(new_n50_), .c(new_n49_), .d(x04), .O(new_n60_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(new_n49_), .O(z05));
  nand2  g37(.a(new_n70_), .b(x10), .O(new_n72_));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n57_), .c(x08), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n66_), .d(new_n49_), .O(z06));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n66_), .d(new_n49_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n64_), .c(new_n41_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n50_), .b(new_n87_), .c(new_n82_), .d(new_n78_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n77_), .c(new_n69_), .d(x08), .O(new_n90_));
  inv1   g56(.a(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(x07), .c(x06), .d(x04), .O(new_n92_));
  aoi21  g58(.a(new_n83_), .b(x13), .c(new_n41_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n92_), .c(new_n66_), .O(z09));
  inv1   g60(.a(x16), .O(new_n95_));
  aoi21  g61(.a(new_n62_), .b(x02), .c(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n87_), .b(new_n82_), .c(new_n78_), .d(new_n77_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n35_), .c(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n69_), .c(x08), .d(x07), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n48_), .c(new_n50_), .d(new_n36_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n49_), .O(z10));
  nand2  g68(.a(new_n49_), .b(new_n38_), .O(z11));
  oai21  g69(.a(new_n95_), .b(x02), .c(new_n62_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n49_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z12));
  nor2   g72(.a(new_n41_), .b(new_n45_), .O(z13));
  inv1   g73(.a(x17), .O(new_n108_));
  nor3   g74(.a(new_n41_), .b(new_n108_), .c(new_n45_), .O(z14));
endmodule
