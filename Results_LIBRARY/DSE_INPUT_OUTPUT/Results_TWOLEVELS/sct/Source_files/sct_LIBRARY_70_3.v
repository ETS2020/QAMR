...
module FAU ( 
  ...
  aoi21  g38(.a(new_n72_), .b(new_n61_), .c(new_n43_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n63_), .d(new_n42_), .O(z07));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n61_), .c(new_n43_), .O(z08));
  nand2  g50(.a(new_n81_), .b(x13), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n61_), .c(x04), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(new_n42_), .O(new_n87_));
  nand3  g53(.a(new_n47_), .b(x04), .c(new_n35_), .O(new_n88_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n76_), .c(new_n75_), .d(new_n35_), .O(new_n95_));
  oai21  g61(.a(x01), .b(new_n35_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n42_), .c(x16), .d(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n41_), .O(z10));
  nand2  g68(.a(new_n42_), .b(new_n36_), .O(z11));
  inv1   g69(.a(x16), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(x02), .c(new_n59_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n42_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nor2   g73(.a(new_n43_), .b(new_n41_), .O(z13));
  nand3  g74(.a(new_n42_), .b(x17), .c(x04), .O(new_n109_));
