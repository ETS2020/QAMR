...
module FAU ( 
  ...
  nor2   g20(.a(new_n42_), .b(new_n47_), .O(new_n55_));
  ...
  inv1   g51(.a(new_n43_), .O(new_n86_));
  ...
  aoi21  g56(.a(new_n84_), .b(x13), .c(new_n64_), .O(new_n91_));
  ...
  nand2  g66(.a(new_n64_), .b(x14), .O(new_n101_));
  ...
  nor2   g70(.a(new_n104_), .b(new_n40_), .O(z12));
  nand2  g71(.a(x17), .b(x04), .O(new_n106_));
  oai21  g72(.a(x07), .b(x04), .c(new_n106_), .O(z14));
  buf    g73(.a(x04), .O(z13));
endmodule
