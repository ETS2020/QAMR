...
module FAU ( 
  ...
  nand2  g16(.a(new_n50_), .b(new_n40_), .O(z02));
  ...
  nand2  g25(.a(new_n59_), .b(new_n40_), .O(z04));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n65_), .d(new_n40_), .O(z07));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n63_), .c(new_n41_), .O(z08));
  ...
  nand3  g55(.a(new_n49_), .b(x04), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x17), .c(x13), .O(new_n91_));
  ...
  nand2  g61(.a(new_n61_), .b(x02), .O(new_n96_));
  nor2   g62(.a(x13), .b(x12), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n77_), .c(new_n76_), .d(new_n89_), .O(new_n98_));
  aoi22  g64(.a(new_n98_), .b(new_n89_), .c(new_n96_), .d(x16), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n68_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n48_), .c(new_n49_), .d(new_n38_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n40_), .O(z10));
  nand2  g69(.a(new_n40_), .b(new_n35_), .O(z11));
  nand3  g70(.a(new_n40_), .b(x16), .c(new_n35_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n61_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n40_), .O(z12));
  nand2  g74(.a(new_n40_), .b(new_n45_), .O(z13));
  nand3  g75(.a(x17), .b(x04), .c(new_n89_), .O(new_n110_));
