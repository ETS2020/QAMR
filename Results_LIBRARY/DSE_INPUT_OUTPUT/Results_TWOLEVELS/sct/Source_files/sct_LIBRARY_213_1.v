...
module FAU ( 
  ...
  oai21  g32(.a(new_n66_), .b(new_n62_), .c(new_n46_), .O(new_n67_));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n61_), .c(new_n42_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n73_), .b(new_n65_), .c(new_n84_), .d(new_n79_), .O(new_n85_));
  ...
  nand2  g56(.a(new_n90_), .b(new_n46_), .O(new_n91_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n84_), .c(new_n79_), .d(new_n78_), .O(new_n95_));
  ...
  nand4  g67(.a(new_n101_), .b(new_n79_), .c(new_n78_), .d(new_n41_), .O(new_n102_));
  ...
  oai21  g72(.a(new_n106_), .b(new_n40_), .c(new_n46_), .O(z10));
  nor2   g73(.a(new_n42_), .b(new_n35_), .O(z11));
  oai21  g74(.a(new_n99_), .b(x02), .c(new_n59_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n46_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n46_), .b(new_n40_), .O(z13));
