...
module FAU ( 
  ...
  inv1   g22(.a(new_n43_), .O(new_n57_));
  oai21  g23(.a(x03), .b(new_n35_), .c(x16), .O(new_n58_));
  ...
  and2   g38(.a(new_n72_), .b(new_n57_), .O(new_n73_));
  ...
  nand2  g60(.a(new_n94_), .b(new_n57_), .O(new_n95_));
  nand4  g61(.a(new_n51_), .b(new_n93_), .c(new_n88_), .d(new_n87_), .O(new_n96_));
  ...
  aoi21  g69(.a(new_n50_), .b(new_n48_), .c(x13), .O(new_n104_));
  ...
  oai21  g81(.a(new_n115_), .b(new_n42_), .c(new_n57_), .O(z12));
