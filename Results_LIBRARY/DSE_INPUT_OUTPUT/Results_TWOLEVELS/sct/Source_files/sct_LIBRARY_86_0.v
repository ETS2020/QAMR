...
module FAU ( 
  ...
  nor2   g39(.a(new_n64_), .b(new_n43_), .O(new_n74_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n46_), .O(z06));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n63_), .c(new_n39_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n77_), .b(new_n67_), .c(new_n86_), .d(new_n81_), .O(new_n87_));
  ...
  nand2  g66(.a(new_n80_), .b(x01), .O(new_n101_));
  inv1   g67(.a(x13), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n86_), .c(new_n81_), .O(new_n103_));
  ...
  nand4  g74(.a(new_n108_), .b(new_n46_), .c(x16), .d(x14), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n43_), .O(z10));
  nand2  g76(.a(new_n46_), .b(new_n48_), .O(z11));
  nand3  g77(.a(new_n46_), .b(x16), .c(new_n48_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n61_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n46_), .O(z12));
  nor2   g81(.a(new_n39_), .b(new_n43_), .O(z13));
