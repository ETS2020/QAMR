...
module FAU ( 
  ...
  nand3  g24(.a(new_n58_), .b(new_n52_), .c(x04), .O(new_n59_));
  ...
  nand4  g30(.a(new_n64_), .b(new_n62_), .c(new_n52_), .d(x04), .O(z05));
  nand2  g31(.a(new_n64_), .b(x10), .O(new_n66_));
  nor2   g32(.a(x10), .b(x09), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n56_), .c(x08), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n52_), .d(x04), .O(z06));
  ...
  aoi21  g42(.a(new_n68_), .b(x11), .c(new_n76_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n40_), .c(new_n75_), .O(z07));
  oai21  g44(.a(new_n73_), .b(new_n61_), .c(x12), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  inv1   g46(.a(new_n61_), .O(new_n81_));
  nand4  g47(.a(new_n67_), .b(new_n81_), .c(new_n80_), .d(new_n72_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n79_), .c(new_n52_), .d(x04), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n52_), .b(new_n84_), .c(new_n80_), .d(new_n72_), .O(new_n85_));
  nor3   g51(.a(new_n85_), .b(x10), .c(x09), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(x08), .c(x07), .d(x06), .O(new_n87_));
  nand2  g53(.a(new_n82_), .b(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n52_), .d(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand4  g56(.a(new_n84_), .b(new_n80_), .c(new_n72_), .d(new_n71_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n52_), .c(new_n63_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(x07), .c(x06), .O(new_n95_));
  nand2  g61(.a(new_n76_), .b(x14), .O(new_n96_));
  ...
  oai21  g67(.a(x06), .b(x04), .c(new_n101_), .O(z14));
  buf    g68(.a(x04), .O(z13));
endmodule
