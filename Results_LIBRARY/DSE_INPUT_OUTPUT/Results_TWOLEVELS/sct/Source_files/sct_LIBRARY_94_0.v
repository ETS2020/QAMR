...
module FAU ( 
  ...
  nand3  g54(.a(new_n49_), .b(x04), .c(x01), .O(new_n89_));
  ...
  nand2  g60(.a(new_n76_), .b(x01), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n82_), .c(new_n77_), .O(new_n97_));
  ...
  nor2   g70(.a(new_n39_), .b(new_n48_), .O(z11));
  ...
  nand2  g74(.a(new_n47_), .b(new_n43_), .O(z13));
