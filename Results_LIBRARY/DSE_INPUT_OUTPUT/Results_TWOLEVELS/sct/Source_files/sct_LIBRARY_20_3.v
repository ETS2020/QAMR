...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(x01), .O(new_n42_));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n63_), .c(new_n43_), .O(z05));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n63_), .c(new_n43_), .O(z06));
  oai21  g41(.a(new_n62_), .b(new_n41_), .c(new_n42_), .O(new_n76_));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n76_), .d(new_n42_), .O(z08));
  ...
  aoi21  g61(.a(new_n95_), .b(new_n93_), .c(new_n43_), .O(z09));
  ...
  nand2  g71(.a(new_n42_), .b(new_n35_), .O(z11));
  nand3  g72(.a(new_n42_), .b(x16), .c(new_n35_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n59_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n42_), .O(z12));
  nor2   g76(.a(new_n43_), .b(new_n41_), .O(z13));
  nand3  g77(.a(new_n42_), .b(x17), .c(x04), .O(new_n112_));
