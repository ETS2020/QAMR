...
module FAU ( 
  ...
  oai21  g27(.a(new_n61_), .b(new_n41_), .c(new_n43_), .O(new_n62_));
  ...
  nand4  g32(.a(new_n66_), .b(new_n64_), .c(new_n62_), .d(new_n43_), .O(z05));
  ...
  aoi22  g38(.a(new_n72_), .b(new_n68_), .c(x18), .d(x01), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n62_), .d(new_n43_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n62_), .d(new_n43_), .O(z08));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n46_), .b(new_n84_), .c(new_n81_), .d(new_n76_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(x10), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n65_), .c(x08), .d(x07), .O(new_n87_));
  ...
  aoi21  g56(.a(x16), .b(x03), .c(new_n41_), .O(new_n91_));
  nand2  g57(.a(new_n82_), .b(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n43_), .O(z09));
  inv1   g59(.a(x14), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand4  g61(.a(new_n84_), .b(new_n81_), .c(new_n76_), .d(new_n75_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  and2   g63(.a(new_n97_), .b(new_n46_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n65_), .c(x08), .d(x07), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n45_), .c(new_n46_), .d(new_n94_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n43_), .c(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z10));
  nand2  g68(.a(new_n43_), .b(new_n35_), .O(z11));
  nand2  g69(.a(new_n88_), .b(new_n58_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n43_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z12));
  nand2  g72(.a(new_n43_), .b(new_n41_), .O(z13));
  nand3  g73(.a(new_n43_), .b(x17), .c(x04), .O(new_n108_));
