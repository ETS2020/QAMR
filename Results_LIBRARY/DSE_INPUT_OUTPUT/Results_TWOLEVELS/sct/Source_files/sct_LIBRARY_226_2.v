...
module FAU ( 
  ...
  oai21  g59(.a(new_n75_), .b(new_n44_), .c(new_n47_), .O(new_n94_));
  ...
  oai22  g76(.a(new_n110_), .b(new_n48_), .c(new_n50_), .d(new_n37_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n47_), .O(z10));
  nor2   g79(.a(new_n40_), .b(new_n49_), .O(z11));
