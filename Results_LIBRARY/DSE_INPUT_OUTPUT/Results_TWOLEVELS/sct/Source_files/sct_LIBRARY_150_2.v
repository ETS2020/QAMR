...
module FAU ( 
  ...
  nor2   g51(.a(new_n85_), .b(new_n39_), .O(z06));
  oai21  g52(.a(new_n75_), .b(new_n44_), .c(new_n48_), .O(new_n87_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n88_), .c(new_n87_), .d(new_n48_), .O(z07));
  ...
  nand4  g61(.a(new_n95_), .b(new_n93_), .c(new_n87_), .d(new_n48_), .O(z08));
  ...
  nand4  g66(.a(new_n100_), .b(new_n97_), .c(new_n87_), .d(new_n48_), .O(z09));
  ...
  nor2   g77(.a(new_n39_), .b(new_n73_), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n35_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n44_), .c(new_n48_), .O(z12));
  nand2  g80(.a(new_n48_), .b(new_n44_), .O(z13));
