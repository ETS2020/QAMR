...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(new_n38_), .c(new_n47_), .d(x04), .O(new_n51_));
  ...
  nand2  g45(.a(new_n76_), .b(x10), .O(new_n80_));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n57_), .c(x08), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(x04), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n74_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(new_n39_), .O(z06));
  oai21  g51(.a(new_n74_), .b(new_n44_), .c(new_n38_), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(x11), .O(new_n87_));
  inv1   g53(.a(new_n67_), .O(new_n88_));
  nor2   g54(.a(x11), .b(x10), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n75_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n87_), .c(new_n86_), .d(new_n38_), .O(z07));
  nand2  g57(.a(new_n90_), .b(x12), .O(new_n92_));
  nor2   g58(.a(x12), .b(x11), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n81_), .c(new_n88_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n92_), .c(new_n86_), .d(new_n38_), .O(z08));
  nand2  g61(.a(new_n94_), .b(x13), .O(new_n96_));
  inv1   g62(.a(new_n76_), .O(new_n97_));
  nor2   g63(.a(x13), .b(x12), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n89_), .c(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n86_), .d(new_n38_), .O(z09));
  inv1   g66(.a(x11), .O(new_n101_));
  nor2   g67(.a(x10), .b(x00), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n98_), .c(new_n101_), .O(new_n103_));
  oai21  g69(.a(x17), .b(new_n62_), .c(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n50_), .c(new_n75_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(x07), .c(x06), .O(new_n107_));
  nand4  g73(.a(new_n49_), .b(new_n38_), .c(x16), .d(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z10));
  nor2   g75(.a(new_n39_), .b(new_n35_), .O(z11));
  nand3  g76(.a(new_n38_), .b(x16), .c(new_n35_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n48_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n38_), .O(z12));
  nand2  g80(.a(new_n38_), .b(new_n44_), .O(z13));
  nand3  g81(.a(x17), .b(x04), .c(new_n62_), .O(new_n116_));
