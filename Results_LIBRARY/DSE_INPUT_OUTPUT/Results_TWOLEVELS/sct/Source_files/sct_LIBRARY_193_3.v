...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n35_), .c(new_n46_), .d(x04), .O(new_n50_));
  ...
  nand2  g29(.a(x16), .b(new_n37_), .O(new_n64_));
  ...
  nand2  g37(.a(x04), .b(new_n37_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n47_), .c(new_n71_), .O(new_n73_));
  ...
  oai21  g43(.a(new_n70_), .b(x17), .c(new_n77_), .O(z05));
  oai21  g44(.a(new_n73_), .b(new_n42_), .c(new_n35_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(x10), .O(new_n80_));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n56_), .c(x08), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n35_), .O(z06));
  inv1   g49(.a(new_n73_), .O(new_n84_));
  ...
  aoi21  g55(.a(new_n82_), .b(x11), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n84_), .c(new_n43_), .O(z07));
  nand2  g57(.a(new_n88_), .b(x12), .O(new_n92_));
  nor2   g58(.a(x12), .b(x11), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n81_), .c(new_n87_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n92_), .c(new_n79_), .d(new_n35_), .O(z08));
  nand2  g61(.a(new_n94_), .b(x13), .O(new_n96_));
  inv1   g62(.a(new_n75_), .O(new_n97_));
  nor2   g63(.a(x13), .b(x12), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n86_), .d(new_n85_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n96_), .c(new_n79_), .d(new_n35_), .O(z09));
  nand4  g66(.a(new_n98_), .b(new_n86_), .c(new_n85_), .d(new_n61_), .O(new_n101_));
  oai21  g67(.a(x17), .b(new_n61_), .c(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n49_), .c(new_n74_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x07), .c(x06), .O(new_n105_));
  nand4  g71(.a(new_n48_), .b(new_n35_), .c(x16), .d(x14), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n42_), .O(z10));
  nand2  g73(.a(new_n35_), .b(new_n37_), .O(z11));
  nand2  g74(.a(new_n64_), .b(new_n47_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n35_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  aoi21  g77(.a(x17), .b(x00), .c(new_n42_), .O(z13));
  nand3  g78(.a(x17), .b(x04), .c(new_n61_), .O(new_n113_));
