...
module FAU ( 
  ...
  and2   g00(.a(x07), .b(x06), .O(new_n35_));
  ...
  nand2  g10(.a(x07), .b(x06), .O(new_n45_));
  ...
  nand4  g21(.a(new_n49_), .b(new_n45_), .c(x08), .d(x04), .O(new_n56_));
  inv1   g22(.a(new_n56_), .O(z04));
  inv1   g23(.a(x09), .O(new_n58_));
  oai21  g24(.a(new_n42_), .b(x02), .c(new_n47_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x16), .O(new_n60_));
  nand4  g26(.a(new_n60_), .b(new_n45_), .c(new_n58_), .d(x04), .O(z05));
  nor2   g27(.a(x10), .b(new_n42_), .O(new_n62_));
  aoi21  g28(.a(new_n62_), .b(new_n60_), .c(new_n35_), .O(z06));
  nor2   g29(.a(x11), .b(new_n42_), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(new_n60_), .c(new_n35_), .O(z07));
  nor2   g31(.a(x12), .b(new_n42_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n60_), .c(new_n35_), .O(z08));
  inv1   g33(.a(x13), .O(new_n68_));
  nand4  g34(.a(new_n60_), .b(new_n45_), .c(new_n68_), .d(x04), .O(z09));
  nand4  g35(.a(new_n48_), .b(new_n45_), .c(x16), .d(x14), .O(new_n70_));
  nor2   g36(.a(new_n70_), .b(new_n42_), .O(z10));
  nand2  g37(.a(new_n45_), .b(new_n36_), .O(z11));
  nand3  g38(.a(new_n45_), .b(x16), .c(new_n36_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n47_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n45_), .O(z12));
  nand4  g42(.a(new_n35_), .b(x16), .c(new_n47_), .d(new_n36_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n45_), .O(z13));
  nand3  g45(.a(new_n45_), .b(x17), .c(x04), .O(new_n80_));
