...
module FAU ( 
  ...
  oai22  g32(.a(new_n66_), .b(new_n39_), .c(new_n62_), .d(x02), .O(new_n67_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n74_), .c(new_n39_), .O(new_n78_));
  ...
  nor2   g51(.a(new_n74_), .b(new_n44_), .O(new_n86_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n86_), .d(new_n48_), .O(z07));
  ...
  nand3  g66(.a(new_n50_), .b(x04), .c(new_n39_), .O(new_n101_));
  ...
  nand4  g73(.a(new_n107_), .b(new_n89_), .c(new_n88_), .d(new_n39_), .O(new_n108_));
  oai21  g74(.a(new_n35_), .b(new_n39_), .c(new_n108_), .O(new_n109_));
  ...
  nand4  g78(.a(new_n64_), .b(new_n48_), .c(x16), .d(x14), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n112_), .c(new_n44_), .O(z10));
  nor2   g80(.a(new_n40_), .b(new_n49_), .O(z11));
  oai21  g81(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n116_));
