...
module FAU ( 
  ...
  oai21  g31(.a(new_n64_), .b(new_n38_), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n74_), .c(new_n38_), .O(new_n78_));
  ...
  nand4  g59(.a(new_n81_), .b(new_n88_), .c(new_n93_), .d(new_n87_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  aoi21  g61(.a(new_n89_), .b(x12), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n80_), .c(new_n40_), .O(z08));
  oai21  g63(.a(new_n74_), .b(new_n44_), .c(new_n48_), .O(new_n98_));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n49_), .b(new_n99_), .c(new_n93_), .d(new_n87_), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n86_), .c(new_n75_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(x07), .c(x06), .d(x04), .O(new_n104_));
  aoi21  g70(.a(new_n94_), .b(x13), .c(new_n40_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n104_), .c(new_n98_), .O(z09));
  inv1   g72(.a(x14), .O(new_n107_));
  nand2  g73(.a(new_n39_), .b(x00), .O(new_n108_));
  nand4  g74(.a(new_n99_), .b(new_n93_), .c(new_n87_), .d(new_n86_), .O(new_n109_));
  aoi22  g75(.a(new_n109_), .b(new_n108_), .c(new_n62_), .d(x16), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n75_), .c(x08), .d(x07), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n47_), .c(new_n49_), .d(new_n107_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n48_), .O(z10));
  nor2   g80(.a(new_n40_), .b(new_n35_), .O(z11));
  nand2  g81(.a(new_n65_), .b(new_n61_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n48_), .c(x04), .O(new_n117_));
  inv1   g83(.a(new_n117_), .O(z12));
  nand2  g84(.a(new_n48_), .b(new_n44_), .O(z13));
