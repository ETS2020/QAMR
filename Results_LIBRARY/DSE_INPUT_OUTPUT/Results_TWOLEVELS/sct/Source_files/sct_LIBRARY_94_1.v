...
module FAU ( 
  ...
  oai21  g29(.a(new_n63_), .b(new_n43_), .c(new_n47_), .O(new_n64_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n47_), .O(z05));
  nand2  g35(.a(new_n68_), .b(x10), .O(new_n70_));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n55_), .c(x08), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .d(new_n47_), .O(z06));
  ...
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n64_), .d(new_n47_), .O(z07));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n64_), .d(new_n47_), .O(z08));
  nand2  g49(.a(new_n82_), .b(x13), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n63_), .c(new_n47_), .O(new_n86_));
  inv1   g52(.a(x00), .O(new_n87_));
  nand3  g53(.a(new_n48_), .b(x04), .c(new_n38_), .O(new_n88_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n76_), .c(new_n75_), .d(new_n38_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  ...
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n43_), .O(z10));
  ...
  nand2  g72(.a(new_n47_), .b(new_n43_), .O(z13));
