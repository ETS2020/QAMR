...
module FAU ( 
  ...
  nor3   g35(.a(new_n69_), .b(new_n66_), .c(x08), .O(new_n70_));
  aoi21  g36(.a(new_n68_), .b(x08), .c(new_n70_), .O(new_n71_));
  ...
  nand3  g43(.a(x17), .b(x10), .c(new_n55_), .O(new_n78_));
  ...
  nand3  g48(.a(x17), .b(x11), .c(new_n55_), .O(new_n83_));
  ...
  nand3  g55(.a(x17), .b(x12), .c(new_n55_), .O(new_n90_));
  ...
  aoi21  g63(.a(x17), .b(new_n92_), .c(x08), .O(new_n98_));
  ...
  nand4  g69(.a(new_n103_), .b(new_n49_), .c(new_n66_), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n48_), .c(new_n49_), .d(new_n38_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x08), .O(new_n106_));
  inv1   g72(.a(x03), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x02), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(x17), .c(x16), .d(x14), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n106_), .c(new_n45_), .O(z10));
  ...
  nor2   g80(.a(new_n35_), .b(new_n45_), .O(z13));
  oai21  g81(.a(new_n69_), .b(new_n45_), .c(new_n36_), .O(z14));
endmodule
