...
module FAU ( 
  ...
  nor2   g01(.a(new_n35_), .b(x17), .O(new_n36_));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n63_), .c(new_n36_), .O(z08));
  ...
  nand2  g65(.a(new_n45_), .b(new_n37_), .O(z11));
  ...
  nor2   g69(.a(new_n36_), .b(new_n42_), .O(z13));
