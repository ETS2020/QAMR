...
module FAU ( 
  ...
  nor2   g05(.a(new_n39_), .b(x00), .O(new_n40_));
  ...
  nand2  g28(.a(x04), .b(new_n36_), .O(new_n63_));
  ...
  oai21  g34(.a(new_n68_), .b(new_n64_), .c(new_n48_), .O(new_n69_));
  ...
  oai21  g39(.a(new_n64_), .b(new_n44_), .c(new_n48_), .O(new_n74_));
  nand3  g40(.a(new_n56_), .b(new_n65_), .c(x08), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x10), .O(new_n76_));
  nor2   g42(.a(x10), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n56_), .c(x08), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n48_), .O(z06));
  ...
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n74_), .d(new_n48_), .O(z07));
  inv1   g50(.a(new_n64_), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n77_), .b(new_n67_), .c(new_n86_), .d(new_n82_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  aoi21  g54(.a(new_n83_), .b(x12), .c(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n85_), .c(new_n40_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n49_), .b(new_n91_), .c(new_n86_), .d(new_n82_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n81_), .c(new_n65_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(x07), .c(x06), .d(x04), .O(new_n96_));
  aoi21  g62(.a(new_n87_), .b(x13), .c(new_n40_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n74_), .O(z09));
  aoi21  g64(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n99_));
  nand4  g65(.a(new_n91_), .b(new_n86_), .c(new_n82_), .d(new_n81_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n35_), .c(new_n99_), .O(new_n101_));
  ...
  nand2  g71(.a(new_n105_), .b(new_n48_), .O(z10));
  nand2  g72(.a(new_n48_), .b(new_n36_), .O(z11));
  nor2   g73(.a(new_n40_), .b(new_n62_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n36_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n44_), .c(new_n48_), .O(z12));
  nand2  g76(.a(new_n48_), .b(new_n44_), .O(z13));
  inv1   g77(.a(x17), .O(new_n112_));
  nor3   g78(.a(new_n40_), .b(new_n112_), .c(new_n44_), .O(z14));
endmodule
