...
module FAU ( 
  ...
  nor2   g01(.a(new_n35_), .b(x02), .O(new_n36_));
  ...
  nand2  g14(.a(new_n35_), .b(new_n42_), .O(new_n49_));
  ...
  inv1   g21(.a(new_n43_), .O(new_n56_));
  inv1   g22(.a(x02), .O(new_n57_));
  oai21  g23(.a(x03), .b(new_n57_), .c(x16), .O(new_n58_));
  ...
  nand2  g31(.a(new_n56_), .b(new_n41_), .O(new_n66_));
  oai21  g32(.a(new_n41_), .b(x02), .c(new_n47_), .O(new_n67_));
  ...
  and2   g38(.a(new_n72_), .b(new_n56_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n68_), .d(new_n66_), .O(z05));
  nand2  g40(.a(new_n72_), .b(x10), .O(new_n75_));
  nor4   g41(.a(new_n60_), .b(x10), .c(x09), .d(new_n59_), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n68_), .d(new_n66_), .O(z06));
  inv1   g44(.a(new_n76_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x11), .O(new_n80_));
  nor4   g46(.a(new_n69_), .b(x11), .c(x10), .d(x09), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n43_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n68_), .d(new_n66_), .O(z07));
  inv1   g49(.a(new_n81_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x10), .O(new_n86_));
  inv1   g52(.a(x11), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n71_), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(new_n69_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n43_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n85_), .c(new_n68_), .d(new_n66_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  oai21  g59(.a(new_n90_), .b(new_n93_), .c(x04), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n56_), .O(new_n95_));
  inv1   g61(.a(new_n36_), .O(new_n96_));
  nand4  g62(.a(new_n50_), .b(new_n93_), .c(new_n88_), .d(new_n87_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x10), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n71_), .c(x08), .d(x07), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n46_), .c(new_n96_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(x16), .b(x03), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n95_), .O(z09));
  aoi21  g69(.a(new_n49_), .b(new_n48_), .c(x13), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n88_), .c(new_n87_), .d(new_n86_), .O(new_n105_));
  nand2  g71(.a(new_n58_), .b(x00), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(x09), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(x08), .c(x07), .d(x06), .O(new_n108_));
  inv1   g74(.a(new_n58_), .O(new_n109_));
  ...
  nand2  g78(.a(new_n112_), .b(new_n56_), .O(z10));
  nand2  g79(.a(new_n56_), .b(new_n57_), .O(z11));
  oai21  g80(.a(new_n36_), .b(x03), .c(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n56_), .O(z12));
  nor2   g82(.a(new_n43_), .b(new_n41_), .O(z13));
  inv1   g83(.a(x17), .O(new_n118_));
  nor3   g84(.a(new_n43_), .b(new_n118_), .c(new_n41_), .O(z14));
endmodule
