...
module FAU ( 
  ...
  aoi21  g37(.a(new_n71_), .b(new_n65_), .c(new_n43_), .O(z05));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n65_), .c(new_n43_), .O(z06));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n65_), .c(new_n43_), .O(z07));
  nor2   g50(.a(new_n64_), .b(new_n42_), .O(new_n85_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n46_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n49_), .b(new_n90_), .c(new_n87_), .d(new_n79_), .O(new_n91_));
  ...
  oai21  g62(.a(new_n62_), .b(new_n61_), .c(x04), .O(new_n97_));
  aoi21  g63(.a(new_n88_), .b(x13), .c(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n96_), .c(new_n43_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n90_), .b(new_n87_), .c(new_n79_), .d(new_n78_), .O(new_n101_));
  ...
  nor2   g73(.a(new_n43_), .b(new_n48_), .O(z11));
  nand2  g74(.a(new_n94_), .b(new_n61_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n46_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  aoi21  g77(.a(x17), .b(new_n35_), .c(new_n42_), .O(z13));
  aoi21  g78(.a(new_n42_), .b(x01), .c(new_n37_), .O(z14));
endmodule
