...
module FAU ( 
  ...
  nand2  g27(.a(new_n61_), .b(x14), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n40_), .O(new_n63_));
  nand3  g29(.a(x17), .b(x14), .c(x03), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(new_n63_), .c(new_n45_), .O(new_n65_));
  ...
  nand3  g37(.a(new_n56_), .b(new_n71_), .c(x08), .O(new_n72_));
  ...
  oai21  g45(.a(new_n79_), .b(new_n36_), .c(new_n68_), .O(z06));
  ...
  oai21  g52(.a(new_n86_), .b(new_n36_), .c(new_n68_), .O(z07));
  nand2  g53(.a(new_n37_), .b(new_n45_), .O(z13));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n76_), .b(new_n83_), .c(new_n89_), .d(new_n82_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n37_), .O(new_n91_));
  ...
  nand4  g62(.a(new_n49_), .b(new_n96_), .c(new_n89_), .d(new_n82_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x10), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n71_), .c(x08), .d(x07), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n48_), .c(new_n95_), .O(new_n100_));
  ...
  nand4  g69(.a(new_n103_), .b(new_n102_), .c(new_n37_), .d(x04), .O(new_n104_));
  ...
  nand4  g77(.a(new_n108_), .b(x17), .c(x16), .d(x14), .O(new_n112_));
  ...
  nor2   g81(.a(new_n36_), .b(new_n40_), .O(z11));
  nand3  g82(.a(new_n62_), .b(x16), .c(new_n40_), .O(new_n117_));
  nand2  g83(.a(new_n37_), .b(x03), .O(new_n118_));
  aoi21  g84(.a(new_n118_), .b(new_n117_), .c(new_n45_), .O(z12));
  oai21  g85(.a(new_n61_), .b(new_n45_), .c(new_n37_), .O(z14));
endmodule
