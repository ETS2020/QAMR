...
module FAU ( 
  ...
  aoi21  g46(.a(new_n80_), .b(new_n74_), .c(new_n39_), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n64_), .d(new_n46_), .O(z08));
  ...
  inv1   g54(.a(x17), .O(new_n89_));
  nand3  g55(.a(new_n48_), .b(x04), .c(new_n38_), .O(new_n90_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n76_), .c(new_n75_), .d(new_n38_), .O(new_n97_));
  oai21  g63(.a(new_n89_), .b(new_n38_), .c(new_n97_), .O(new_n98_));
  ...
  nand2  g70(.a(new_n46_), .b(new_n35_), .O(z11));
  nor2   g71(.a(new_n39_), .b(new_n61_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n35_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n43_), .c(new_n46_), .O(z12));
  nand2  g74(.a(new_n46_), .b(new_n43_), .O(z13));
  nor2   g75(.a(new_n89_), .b(new_n43_), .O(z14));
endmodule
