...
module FAU ( 
  ...
  nor2   g08(.a(x01), .b(new_n36_), .O(new_n43_));
  ...
  nand2  g30(.a(x16), .b(new_n48_), .O(new_n65_));
  oai21  g31(.a(new_n64_), .b(new_n36_), .c(new_n65_), .O(new_n66_));
  ...
  nand2  g38(.a(x04), .b(new_n48_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n61_), .c(new_n72_), .O(new_n74_));
  ...
  oai21  g44(.a(new_n71_), .b(new_n35_), .c(new_n78_), .O(z05));
  oai21  g45(.a(new_n74_), .b(new_n42_), .c(new_n47_), .O(new_n80_));
  nand2  g46(.a(new_n76_), .b(x10), .O(new_n81_));
  nor2   g47(.a(x10), .b(x09), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n56_), .c(x08), .O(new_n83_));
  ...
  aoi21  g57(.a(new_n91_), .b(new_n85_), .c(new_n43_), .O(z07));
  nand2  g58(.a(new_n89_), .b(x12), .O(new_n93_));
  inv1   g59(.a(x12), .O(new_n94_));
  nand4  g60(.a(new_n82_), .b(new_n88_), .c(new_n94_), .d(new_n87_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n93_), .c(new_n80_), .d(new_n47_), .O(z08));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n49_), .b(new_n97_), .c(new_n94_), .d(new_n87_), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n86_), .c(new_n75_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(x07), .c(x06), .d(x04), .O(new_n102_));
  aoi21  g68(.a(new_n95_), .b(x13), .c(new_n43_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n102_), .c(new_n80_), .O(z09));
  nand2  g70(.a(x01), .b(x00), .O(new_n105_));
  nand4  g71(.a(new_n97_), .b(new_n94_), .c(new_n87_), .d(new_n86_), .O(new_n106_));
  aoi22  g72(.a(new_n106_), .b(new_n105_), .c(new_n62_), .d(x16), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n75_), .c(x08), .d(x07), .O(new_n108_));
  oai22  g74(.a(new_n108_), .b(new_n46_), .c(new_n49_), .d(new_n37_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n47_), .O(z10));
  nor2   g77(.a(new_n43_), .b(new_n48_), .O(z11));
  nand2  g78(.a(new_n65_), .b(new_n61_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n47_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nor2   g81(.a(new_n43_), .b(new_n42_), .O(z13));
