...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n48_), .O(new_n65_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(new_n48_), .O(z06));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n40_), .O(z07));
  ...
  nand3  g55(.a(new_n49_), .b(x04), .c(new_n39_), .O(new_n90_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n77_), .c(new_n76_), .d(new_n39_), .O(new_n97_));
  ...
  nand4  g68(.a(new_n102_), .b(new_n48_), .c(x16), .d(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n44_), .O(z10));
  nor2   g70(.a(new_n40_), .b(new_n36_), .O(z11));
  nor2   g71(.a(new_n40_), .b(new_n62_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n36_), .c(x03), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n44_), .c(new_n48_), .O(z12));
