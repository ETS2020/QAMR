...
module FAU ( 
  ...
  nand3  g02(.a(x18), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  oai21  g03(.a(x02), .b(new_n35_), .c(new_n37_), .O(z00));
  inv1   g04(.a(x18), .O(new_n39_));
  nand2  g05(.a(x05), .b(x04), .O(new_n40_));
  nand3  g06(.a(new_n40_), .b(new_n39_), .c(x01), .O(new_n41_));
  inv1   g07(.a(x05), .O(new_n42_));
  nor2   g08(.a(new_n42_), .b(x04), .O(new_n43_));
  inv1   g09(.a(x15), .O(new_n44_));
  nor2   g10(.a(new_n44_), .b(x05), .O(new_n45_));
  oai21  g11(.a(new_n45_), .b(new_n43_), .c(x18), .O(new_n46_));
  nand2  g12(.a(new_n46_), .b(new_n41_), .O(z01));
  ...
  nand4  g28(.a(new_n62_), .b(new_n53_), .c(new_n52_), .d(x04), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(z04));
  inv1   g30(.a(x04), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(x02), .c(new_n49_), .O(new_n66_));
  ...
  oai21  g40(.a(x18), .b(x01), .c(new_n65_), .O(new_n75_));
  ...
  aoi21  g69(.a(new_n98_), .b(new_n103_), .c(new_n51_), .O(new_n104_));
  ...
  and2   g75(.a(new_n53_), .b(x02), .O(z11));
  nand2  g76(.a(new_n53_), .b(x16), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(x02), .c(new_n49_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n53_), .O(z12));
  aoi21  g80(.a(new_n39_), .b(new_n35_), .c(new_n65_), .O(z13));
