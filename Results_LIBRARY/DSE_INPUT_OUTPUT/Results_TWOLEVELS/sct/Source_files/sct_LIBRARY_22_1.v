...
module FAU ( 
  ...
  aoi21  g14(.a(new_n36_), .b(x02), .c(new_n48_), .O(new_n49_));
  ...
  oai21  g27(.a(new_n48_), .b(new_n36_), .c(x04), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(x01), .O(new_n63_));
  oai21  g29(.a(new_n48_), .b(x02), .c(x04), .O(new_n64_));
  ...
  inv1   g42(.a(x02), .O(new_n77_));
  nand3  g43(.a(x04), .b(new_n36_), .c(new_n77_), .O(new_n78_));
  oai21  g44(.a(new_n36_), .b(new_n35_), .c(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x16), .O(new_n80_));
  oai21  g46(.a(new_n76_), .b(new_n43_), .c(new_n80_), .O(z06));
  ...
  aoi21  g52(.a(new_n74_), .b(x11), .c(new_n86_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n43_), .c(new_n80_), .O(z07));
  and2   g54(.a(new_n85_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n73_), .b(new_n84_), .c(new_n90_), .d(new_n83_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n89_), .c(new_n46_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n80_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n90_), .c(new_n83_), .d(new_n82_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n69_), .c(x04), .O(new_n97_));
  aoi21  g63(.a(new_n91_), .b(x13), .c(new_n97_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n43_), .c(new_n80_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n96_), .b(new_n100_), .c(new_n49_), .O(new_n101_));
  ...
  nor2   g72(.a(new_n43_), .b(new_n77_), .O(z11));
  oai21  g73(.a(x04), .b(new_n35_), .c(x03), .O(new_n108_));
  nand4  g74(.a(x16), .b(x04), .c(new_n36_), .d(new_n77_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n108_), .O(z12));
  aoi21  g76(.a(x03), .b(new_n35_), .c(new_n42_), .O(z13));
