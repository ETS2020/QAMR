...
module FAU ( 
  ...
  nand4  g27(.a(new_n61_), .b(new_n51_), .c(new_n37_), .d(x04), .O(new_n62_));
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n68_), .d(new_n37_), .O(z05));
  ...
  nand2  g44(.a(x17), .b(new_n78_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n71_), .d(x08), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(x07), .c(x06), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n76_), .O(z06));
  nand3  g49(.a(new_n58_), .b(new_n51_), .c(x08), .O(new_n84_));
  nand2  g50(.a(x16), .b(new_n41_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n84_), .c(new_n47_), .O(new_n86_));
  aoi21  g52(.a(x16), .b(x03), .c(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n71_), .c(x08), .d(x04), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n86_), .c(x11), .O(new_n89_));
  nand3  g55(.a(new_n35_), .b(new_n77_), .c(new_n71_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n69_), .c(new_n35_), .O(new_n91_));
  aoi22  g57(.a(new_n91_), .b(new_n78_), .c(new_n67_), .d(new_n35_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n89_), .O(z07));
  nand3  g59(.a(new_n77_), .b(new_n71_), .c(x08), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n58_), .c(new_n35_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x12), .O(new_n97_));
  inv1   g63(.a(new_n72_), .O(new_n98_));
  nor2   g64(.a(x17), .b(x12), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n98_), .c(new_n78_), .d(new_n77_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n97_), .c(new_n68_), .O(z08));
  inv1   g67(.a(x12), .O(new_n102_));
  inv1   g68(.a(x13), .O(new_n103_));
  nand4  g69(.a(new_n51_), .b(new_n103_), .c(new_n102_), .d(new_n78_), .O(new_n104_));
  nor3   g70(.a(new_n104_), .b(x10), .c(x09), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  nand3  g72(.a(new_n102_), .b(new_n77_), .c(new_n71_), .O(new_n107_));
  ...
  nand2  g76(.a(x13), .b(x11), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n110_), .c(new_n68_), .O(z09));
  inv1   g78(.a(x00), .O(new_n113_));
  and2   g79(.a(new_n51_), .b(new_n71_), .O(new_n114_));
  nand4  g80(.a(new_n114_), .b(x08), .c(x07), .d(x06), .O(new_n115_));
  oai22  g81(.a(new_n115_), .b(new_n113_), .c(new_n51_), .d(new_n39_), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n37_), .O(new_n117_));
  nand4  g83(.a(new_n51_), .b(new_n35_), .c(new_n103_), .d(new_n102_), .O(new_n118_));
  inv1   g84(.a(new_n118_), .O(new_n119_));
  nand4  g85(.a(new_n119_), .b(new_n78_), .c(new_n77_), .d(new_n71_), .O(new_n120_));
  inv1   g86(.a(new_n120_), .O(new_n121_));
  nand4  g87(.a(new_n121_), .b(x08), .c(x07), .d(x06), .O(new_n122_));
  aoi21  g88(.a(new_n122_), .b(new_n117_), .c(new_n47_), .O(z10));
  nor2   g89(.a(new_n36_), .b(new_n41_), .O(z11));
  nand2  g90(.a(new_n85_), .b(new_n64_), .O(new_n125_));
  nand3  g91(.a(new_n125_), .b(new_n37_), .c(x04), .O(new_n126_));
  inv1   g92(.a(new_n126_), .O(z12));
  nand2  g93(.a(new_n37_), .b(new_n47_), .O(z13));
  nand3  g94(.a(x17), .b(x11), .c(x04), .O(new_n129_));
