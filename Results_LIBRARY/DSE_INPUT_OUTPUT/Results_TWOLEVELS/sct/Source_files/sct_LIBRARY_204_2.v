...
module FAU ( 
  ...
  nor2   g12(.a(x05), .b(new_n39_), .O(new_n47_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n63_), .c(new_n47_), .O(z07));
  inv1   g48(.a(x04), .O(new_n83_));
  nor2   g49(.a(new_n62_), .b(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n79_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n71_), .b(new_n78_), .c(new_n86_), .d(new_n77_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(new_n48_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n45_), .b(new_n89_), .c(new_n86_), .d(new_n77_), .O(new_n90_));
  ...
  oai21  g59(.a(new_n92_), .b(new_n44_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  aoi21  g61(.a(x16), .b(x03), .c(new_n83_), .O(new_n96_));
  nand2  g62(.a(new_n87_), .b(x13), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n48_), .O(z09));
  inv1   g64(.a(x14), .O(new_n99_));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n89_), .b(new_n86_), .c(new_n77_), .d(new_n76_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  and2   g68(.a(new_n102_), .b(new_n45_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n66_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n44_), .c(new_n45_), .d(new_n99_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n48_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z10));
  nor2   g73(.a(new_n47_), .b(new_n35_), .O(z11));
  nor2   g74(.a(new_n47_), .b(new_n60_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n35_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n83_), .c(new_n48_), .O(z12));
  nor2   g77(.a(new_n47_), .b(new_n83_), .O(z13));
  inv1   g78(.a(x17), .O(new_n113_));
  nor3   g79(.a(new_n47_), .b(new_n113_), .c(new_n83_), .O(z14));
endmodule
