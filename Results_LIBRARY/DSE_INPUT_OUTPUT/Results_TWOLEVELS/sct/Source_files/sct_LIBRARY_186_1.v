...
module FAU ( 
  ...
  nand4  g67(.a(new_n101_), .b(new_n81_), .c(new_n80_), .d(new_n41_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n92_), .c(new_n100_), .O(new_n103_));
  ...
  oai21  g72(.a(new_n106_), .b(new_n40_), .c(new_n45_), .O(z10));
  nor2   g73(.a(new_n42_), .b(new_n35_), .O(z11));
  nor2   g74(.a(new_n42_), .b(new_n99_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n35_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n40_), .c(new_n45_), .O(z12));
  nand2  g77(.a(new_n45_), .b(new_n40_), .O(z13));
