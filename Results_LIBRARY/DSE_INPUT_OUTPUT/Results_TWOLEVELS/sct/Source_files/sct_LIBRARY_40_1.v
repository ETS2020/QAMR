...
module FAU ( 
  ...
  nand3  g23(.a(new_n35_), .b(x08), .c(new_n49_), .O(new_n58_));
  oai21  g24(.a(new_n57_), .b(new_n49_), .c(new_n58_), .O(new_n59_));
  ...
  oai21  g32(.a(x17), .b(x09), .c(new_n49_), .O(new_n67_));
  ...
  nand3  g45(.a(new_n35_), .b(x10), .c(new_n49_), .O(new_n80_));
  ...
  nand3  g50(.a(new_n35_), .b(x11), .c(new_n49_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n66_), .O(z07));
  oai21  g52(.a(x17), .b(x12), .c(new_n49_), .O(new_n87_));
  ...
  nor3   g57(.a(new_n91_), .b(new_n68_), .c(new_n49_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n87_), .c(new_n66_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n50_), .b(new_n95_), .c(new_n88_), .d(new_n90_), .O(new_n96_));
  ...
  aoi21  g66(.a(new_n35_), .b(new_n95_), .c(x06), .O(new_n101_));
  ...
  nand4  g74(.a(new_n108_), .b(new_n50_), .c(new_n70_), .d(x08), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n105_), .c(new_n50_), .d(new_n40_), .O(new_n110_));
  ...
  nand2  g81(.a(new_n62_), .b(new_n37_), .O(z11));
  nor2   g82(.a(new_n36_), .b(new_n63_), .O(new_n117_));
  aoi21  g83(.a(new_n117_), .b(new_n37_), .c(x03), .O(new_n118_));
  oai21  g84(.a(new_n118_), .b(new_n46_), .c(new_n62_), .O(z12));
  nand2  g85(.a(new_n62_), .b(new_n46_), .O(z13));
