...
module FAU ( 
  ...
  nand4  g18(.a(new_n48_), .b(x08), .c(new_n45_), .d(x04), .O(new_n53_));
  ...
  oai21  g26(.a(new_n42_), .b(x02), .c(new_n46_), .O(new_n61_));
  ...
  aoi21  g31(.a(new_n61_), .b(x16), .c(x13), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(x06), .c(x04), .O(z09));
  nand4  g33(.a(new_n47_), .b(x16), .c(x14), .d(new_n45_), .O(new_n68_));
  nor2   g34(.a(new_n68_), .b(new_n42_), .O(z10));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n45_), .c(new_n42_), .O(z14));
endmodule
