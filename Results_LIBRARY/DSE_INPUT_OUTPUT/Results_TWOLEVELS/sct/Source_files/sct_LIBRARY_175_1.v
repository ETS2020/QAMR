...
module FAU ( 
  ...
  aoi21  g15(.a(new_n49_), .b(x02), .c(new_n38_), .O(new_n50_));
  ...
  nand2  g28(.a(new_n47_), .b(new_n44_), .O(z13));
  inv1   g29(.a(x00), .O(new_n64_));
  oai21  g30(.a(new_n44_), .b(x02), .c(new_n49_), .O(new_n65_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(z13), .O(z05));
  ...
  nand3  g41(.a(new_n65_), .b(x16), .c(x00), .O(new_n76_));
  oai21  g42(.a(new_n75_), .b(new_n39_), .c(new_n76_), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n78_), .c(new_n66_), .d(z13), .O(z07));
  nand2  g48(.a(new_n81_), .b(x12), .O(new_n83_));
  nor2   g49(.a(x12), .b(x11), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n72_), .c(new_n79_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n66_), .d(z13), .O(z08));
  nand2  g52(.a(new_n85_), .b(x13), .O(new_n87_));
  inv1   g53(.a(new_n70_), .O(new_n88_));
  nor2   g54(.a(x13), .b(x12), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n80_), .c(new_n88_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n87_), .c(new_n66_), .d(z13), .O(z09));
  inv1   g57(.a(x12), .O(new_n92_));
  nor2   g58(.a(x16), .b(x13), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n80_), .c(new_n92_), .O(new_n94_));
  oai21  g60(.a(new_n50_), .b(new_n64_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g67(.a(x16), .b(new_n35_), .c(x00), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n49_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n47_), .O(z12));
  inv1   g71(.a(x17), .O(new_n106_));
  nor3   g72(.a(new_n39_), .b(new_n106_), .c(new_n44_), .O(z14));
endmodule
