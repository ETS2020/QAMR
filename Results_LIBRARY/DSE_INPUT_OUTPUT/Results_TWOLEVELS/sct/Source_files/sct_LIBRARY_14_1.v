...
module FAU ( 
  ...
  oai21  g39(.a(new_n64_), .b(new_n44_), .c(new_n39_), .O(new_n74_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n39_), .O(z06));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n80_), .c(new_n40_), .O(z07));
  ...
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n74_), .d(new_n39_), .O(z08));
  nand2  g56(.a(new_n89_), .b(x13), .O(new_n91_));
  inv1   g57(.a(new_n75_), .O(new_n92_));
  nor2   g58(.a(x13), .b(x12), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n82_), .d(new_n81_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n91_), .c(new_n74_), .d(new_n39_), .O(z09));
  nor2   g61(.a(x10), .b(x01), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n93_), .c(new_n82_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n38_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n50_), .c(new_n65_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  nand4  g67(.a(new_n49_), .b(new_n39_), .c(x16), .d(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n44_), .O(z10));
  nand2  g69(.a(new_n39_), .b(new_n35_), .O(z11));
  nor2   g70(.a(new_n40_), .b(new_n62_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n35_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n44_), .c(new_n39_), .O(z12));
  nor2   g73(.a(new_n40_), .b(new_n44_), .O(z13));
  nand2  g74(.a(new_n39_), .b(x17), .O(new_n109_));
