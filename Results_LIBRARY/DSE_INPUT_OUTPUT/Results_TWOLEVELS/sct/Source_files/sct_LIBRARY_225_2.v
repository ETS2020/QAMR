...
module FAU ( 
  ...
  nand4  g24(.a(new_n58_), .b(new_n49_), .c(new_n46_), .d(x04), .O(new_n59_));
  ...
  oai21  g32(.a(new_n65_), .b(new_n42_), .c(new_n66_), .O(new_n67_));
  ...
  aoi21  g39(.a(new_n73_), .b(new_n61_), .c(new_n62_), .O(new_n74_));
  ...
  oai21  g43(.a(new_n77_), .b(new_n74_), .c(new_n42_), .O(new_n78_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n80_), .c(new_n43_), .O(z06));
  nor2   g51(.a(new_n74_), .b(new_n41_), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(x11), .O(new_n87_));
  inv1   g53(.a(x10), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  inv1   g55(.a(new_n68_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n75_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n87_), .c(new_n86_), .d(new_n46_), .O(z07));
  inv1   g58(.a(x12), .O(new_n93_));
  nand4  g59(.a(new_n81_), .b(new_n90_), .c(new_n93_), .d(new_n89_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  aoi21  g61(.a(new_n91_), .b(x12), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n80_), .c(new_n43_), .O(z08));
  nand2  g63(.a(new_n94_), .b(x13), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n80_), .c(x04), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n46_), .O(new_n100_));
  nand3  g66(.a(new_n49_), .b(x04), .c(new_n42_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n35_), .c(x13), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n93_), .c(new_n89_), .d(new_n88_), .O(new_n103_));
  ...
  nand4  g74(.a(new_n108_), .b(new_n89_), .c(new_n88_), .d(new_n42_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n107_), .c(new_n63_), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(new_n75_), .c(x08), .d(x07), .O(new_n111_));
  oai22  g77(.a(new_n111_), .b(new_n47_), .c(new_n49_), .d(new_n36_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n46_), .O(z10));
  nand2  g80(.a(new_n46_), .b(new_n48_), .O(z11));
  nand2  g81(.a(new_n66_), .b(new_n61_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n46_), .c(x04), .O(new_n117_));
  inv1   g83(.a(new_n117_), .O(z12));
  nand2  g84(.a(new_n46_), .b(new_n41_), .O(z13));
  inv1   g85(.a(x17), .O(new_n120_));
  nor3   g86(.a(new_n43_), .b(new_n120_), .c(new_n41_), .O(z14));
endmodule
