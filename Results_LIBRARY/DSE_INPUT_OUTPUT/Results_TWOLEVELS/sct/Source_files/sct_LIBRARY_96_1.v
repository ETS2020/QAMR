...
module FAU ( 
  ...
  nand4  g21(.a(new_n55_), .b(new_n46_), .c(new_n45_), .d(x04), .O(new_n56_));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n61_), .c(new_n36_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n70_), .b(new_n75_), .c(new_n80_), .d(new_n74_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n76_), .b(x12), .c(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n61_), .c(new_n36_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n46_), .b(new_n85_), .c(new_n80_), .d(new_n74_), .O(new_n86_));
  inv1   g52(.a(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n73_), .c(new_n66_), .d(x08), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(x07), .c(x06), .d(x04), .O(new_n90_));
  aoi21  g56(.a(new_n81_), .b(x13), .c(new_n36_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n85_), .b(new_n80_), .c(new_n74_), .d(new_n73_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n93_), .c(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n66_), .c(x08), .d(x07), .O(new_n98_));
  oai22  g64(.a(new_n98_), .b(new_n44_), .c(new_n46_), .d(new_n40_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n45_), .O(z10));
  nor2   g67(.a(new_n36_), .b(new_n37_), .O(z11));
  nor2   g68(.a(new_n36_), .b(new_n94_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n37_), .c(x03), .O(new_n104_));
  oai21  g70(.a(new_n104_), .b(new_n59_), .c(new_n45_), .O(z12));
  inv1   g71(.a(x05), .O(new_n106_));
  aoi21  g72(.a(x18), .b(new_n106_), .c(new_n59_), .O(z13));
  nand2  g73(.a(x17), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n45_), .O(z14));
endmodule
