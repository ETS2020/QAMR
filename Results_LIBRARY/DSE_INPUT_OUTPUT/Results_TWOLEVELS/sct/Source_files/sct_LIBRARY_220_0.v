...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n115_, new_n118_;
  nor2   g00(.a(x18), .b(x07), .O(new_n35_));
  ...
  nand3  g23(.a(x18), .b(x08), .c(new_n52_), .O(new_n58_));
  ...
  nor3   g35(.a(new_n42_), .b(new_n66_), .c(x07), .O(new_n70_));
  aoi21  g36(.a(new_n69_), .b(x07), .c(new_n70_), .O(new_n71_));
  ...
  nand3  g43(.a(x18), .b(x10), .c(new_n52_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n65_), .O(z06));
  oai21  g45(.a(new_n42_), .b(x11), .c(new_n52_), .O(new_n80_));
  ...
  oai21  g56(.a(new_n90_), .b(new_n87_), .c(x07), .O(new_n91_));
  nand3  g57(.a(x18), .b(x12), .c(new_n52_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n65_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n49_), .b(new_n94_), .c(new_n86_), .d(new_n88_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x10), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n66_), .c(x08), .d(x06), .O(new_n97_));
  oai21  g63(.a(new_n89_), .b(new_n68_), .c(x13), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n44_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x07), .O(new_n100_));
  nand3  g66(.a(x18), .b(x13), .c(new_n52_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n100_), .c(new_n65_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand4  g69(.a(new_n94_), .b(new_n86_), .c(new_n88_), .d(new_n74_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n49_), .c(new_n66_), .d(x08), .O(new_n106_));
  oai22  g72(.a(new_n106_), .b(new_n47_), .c(new_n49_), .d(new_n39_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x07), .O(new_n108_));
  inv1   g74(.a(x03), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x02), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(x18), .c(x16), .d(x14), .O(new_n111_));
