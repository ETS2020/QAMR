...
module FAU ( 
  ...
  nor2   g07(.a(new_n35_), .b(new_n41_), .O(new_n42_));
  ...
  nand2  g13(.a(new_n47_), .b(new_n41_), .O(new_n48_));
  ...
  oai22  g28(.a(new_n55_), .b(x01), .c(x16), .d(x02), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n62_), .c(x04), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(z04));
  oai21  g31(.a(new_n50_), .b(new_n45_), .c(x04), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(new_n41_), .O(new_n67_));
  oai21  g33(.a(x16), .b(new_n40_), .c(new_n35_), .O(new_n68_));
  ...
  nor2   g39(.a(new_n73_), .b(new_n42_), .O(new_n74_));
  ...
  oai22  g45(.a(new_n40_), .b(x02), .c(new_n45_), .d(x01), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x16), .O(new_n81_));
  oai21  g47(.a(new_n79_), .b(new_n42_), .c(new_n81_), .O(z06));
  ...
  aoi21  g53(.a(new_n77_), .b(x11), .c(new_n87_), .O(new_n88_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n68_), .d(new_n67_), .O(z08));
  oai21  g61(.a(new_n92_), .b(new_n69_), .c(x13), .O(new_n96_));
  ...
  aoi21  g70(.a(new_n98_), .b(new_n104_), .c(new_n55_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n71_), .c(x08), .d(x07), .O(new_n106_));
  nand2  g72(.a(new_n55_), .b(x14), .O(new_n107_));
  ...
  oai21  g77(.a(new_n111_), .b(new_n40_), .c(new_n53_), .O(z12));
  nand2  g78(.a(new_n53_), .b(new_n40_), .O(z13));
  nand3  g79(.a(new_n53_), .b(x17), .c(x04), .O(new_n114_));
