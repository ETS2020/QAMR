...
module FAU ( 
  ...
  nand2  g28(.a(x04), .b(new_n39_), .O(new_n63_));
  aoi21  g29(.a(new_n63_), .b(new_n61_), .c(new_n62_), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n44_), .c(new_n35_), .O(new_n65_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(new_n45_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n35_), .O(z08));
  ...
  aoi21  g58(.a(new_n85_), .b(x13), .c(new_n45_), .O(new_n93_));
  ...
  oai22  g65(.a(new_n99_), .b(new_n48_), .c(new_n49_), .d(new_n37_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n35_), .O(z10));
  nand2  g68(.a(new_n35_), .b(new_n39_), .O(z11));
  nand3  g69(.a(new_n35_), .b(x16), .c(new_n39_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n61_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n35_), .O(z12));
  nand2  g73(.a(new_n35_), .b(new_n44_), .O(z13));
  nand3  g74(.a(x17), .b(x04), .c(new_n95_), .O(new_n109_));
