...
module FAU ( 
  ...
  oai21  g38(.a(new_n65_), .b(new_n44_), .c(new_n47_), .O(new_n73_));
  nand3  g39(.a(new_n69_), .b(x17), .c(x10), .O(new_n74_));
  nand4  g40(.a(new_n57_), .b(new_n35_), .c(new_n68_), .d(x08), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(z06));
  inv1   g42(.a(x17), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(x11), .c(x10), .O(new_n78_));
  inv1   g44(.a(new_n66_), .O(new_n79_));
  nor3   g45(.a(x11), .b(x10), .c(x09), .O(new_n80_));
  aoi22  g46(.a(new_n80_), .b(new_n79_), .c(new_n69_), .d(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n73_), .O(z07));
  inv1   g48(.a(x11), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n68_), .c(x08), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n56_), .c(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n79_), .b(new_n86_), .c(new_n83_), .d(new_n68_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n35_), .O(new_n89_));
  nand3  g55(.a(x17), .b(x12), .c(x10), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n73_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n49_), .b(new_n92_), .c(new_n86_), .d(new_n83_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n35_), .c(new_n68_), .d(x08), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x07), .c(x06), .d(x04), .O(new_n97_));
  aoi21  g63(.a(x17), .b(new_n92_), .c(new_n35_), .O(new_n98_));
  aoi21  g64(.a(new_n87_), .b(x13), .c(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n97_), .c(new_n73_), .O(z09));
  nor3   g66(.a(new_n93_), .b(x10), .c(x09), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(x08), .c(x07), .d(x06), .O(new_n102_));
  inv1   g68(.a(x00), .O(new_n103_));
  aoi21  g69(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n104_));
  nor2   g70(.a(new_n104_), .b(x09), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  nand2  g72(.a(new_n104_), .b(x14), .O(new_n107_));
  oai21  g73(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n47_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n102_), .c(new_n44_), .O(z10));
  nor2   g76(.a(new_n36_), .b(new_n37_), .O(z11));
  nor2   g77(.a(new_n36_), .b(new_n63_), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n37_), .c(x03), .O(new_n113_));
  oai21  g79(.a(new_n113_), .b(new_n44_), .c(new_n47_), .O(z12));
  nor2   g80(.a(new_n36_), .b(new_n44_), .O(z13));
  oai21  g81(.a(new_n77_), .b(new_n44_), .c(new_n47_), .O(z14));
endmodule
