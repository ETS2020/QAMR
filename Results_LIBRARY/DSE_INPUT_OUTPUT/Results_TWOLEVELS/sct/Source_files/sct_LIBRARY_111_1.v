...
module FAU ( 
  ...
  nand3  g41(.a(new_n59_), .b(new_n75_), .c(new_n70_), .O(new_n76_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n67_), .O(z06));
  ...
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n67_), .O(z07));
  oai21  g52(.a(x17), .b(x12), .c(new_n57_), .O(new_n87_));
  nand2  g53(.a(new_n84_), .b(new_n59_), .O(new_n88_));
  ...
  nand3  g59(.a(new_n93_), .b(new_n87_), .c(new_n67_), .O(z08));
  ...
  oai21  g66(.a(new_n98_), .b(new_n47_), .c(new_n100_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x08), .O(new_n102_));
  nand3  g68(.a(new_n35_), .b(x13), .c(new_n57_), .O(new_n103_));
  ...
  nand4  g73(.a(new_n107_), .b(new_n51_), .c(new_n70_), .d(x07), .O(new_n108_));
  oai22  g74(.a(new_n108_), .b(new_n50_), .c(new_n51_), .d(new_n39_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x08), .O(new_n110_));
  inv1   g76(.a(x03), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x02), .O(new_n112_));
  nand4  g78(.a(new_n112_), .b(new_n35_), .c(x16), .d(x14), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n110_), .c(new_n47_), .O(z10));
  ...
  aoi21  g84(.a(x17), .b(new_n57_), .c(new_n47_), .O(z13));
  aoi21  g85(.a(x08), .b(new_n47_), .c(new_n35_), .O(z14));
endmodule
