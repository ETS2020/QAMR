...
module FAU ( 
  ...
  aoi21  g44(.a(new_n78_), .b(new_n60_), .c(new_n42_), .O(z07));
  nand2  g45(.a(new_n76_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand4  g47(.a(new_n68_), .b(new_n75_), .c(new_n81_), .d(new_n74_), .O(new_n82_));
  ...
  aoi21  g59(.a(new_n58_), .b(x02), .c(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n84_), .b(new_n81_), .c(new_n74_), .d(new_n73_), .O(new_n95_));
  ...
  nand2  g66(.a(new_n100_), .b(new_n41_), .O(z10));
  nand2  g67(.a(new_n41_), .b(new_n35_), .O(z11));
  oai21  g68(.a(new_n93_), .b(x02), .c(new_n58_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n41_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z12));
  nor2   g71(.a(new_n42_), .b(new_n40_), .O(z13));
  nand3  g72(.a(new_n41_), .b(x17), .c(x04), .O(new_n107_));
