...
module FAU ( 
  ...
  aoi21  g57(.a(new_n91_), .b(new_n75_), .c(new_n39_), .O(z08));
  nor2   g58(.a(new_n65_), .b(new_n43_), .O(new_n93_));
  nand2  g59(.a(new_n89_), .b(x13), .O(new_n94_));
  inv1   g60(.a(new_n76_), .O(new_n95_));
  nor2   g61(.a(x13), .b(x12), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n83_), .d(new_n82_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n94_), .c(new_n93_), .d(new_n46_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n82_), .b(x01), .O(new_n100_));
  inv1   g66(.a(x13), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n88_), .c(new_n83_), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n50_), .c(new_n66_), .d(x08), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(x07), .c(x06), .O(new_n106_));
  nand4  g72(.a(new_n49_), .b(new_n46_), .c(x16), .d(x14), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n106_), .c(new_n43_), .O(z10));
  nor2   g74(.a(new_n39_), .b(new_n63_), .O(z11));
  oai21  g75(.a(new_n62_), .b(x02), .c(new_n48_), .O(new_n110_));
  ...
  nor3   g80(.a(new_n39_), .b(new_n114_), .c(new_n43_), .O(z14));
endmodule
