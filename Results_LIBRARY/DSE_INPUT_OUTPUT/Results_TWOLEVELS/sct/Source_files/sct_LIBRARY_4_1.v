...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n47_), .O(z06));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n80_), .c(new_n39_), .O(z07));
  nand2  g52(.a(new_n83_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n77_), .b(new_n67_), .c(new_n88_), .d(new_n82_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n74_), .d(new_n47_), .O(z08));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n80_), .c(new_n39_), .O(z09));
  ...
  nand2  g68(.a(new_n47_), .b(new_n35_), .O(z11));
  nor2   g69(.a(new_n39_), .b(new_n49_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n35_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n43_), .c(new_n47_), .O(z12));
