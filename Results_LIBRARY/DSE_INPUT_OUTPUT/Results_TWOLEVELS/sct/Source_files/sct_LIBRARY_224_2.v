...
module FAU ( 
  ...
  nand3  g55(.a(new_n49_), .b(x04), .c(new_n35_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n81_), .c(new_n77_), .d(new_n76_), .O(new_n92_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n77_), .c(new_n76_), .d(new_n35_), .O(new_n97_));
  oai21  g63(.a(new_n89_), .b(new_n35_), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g68(.a(new_n102_), .b(new_n37_), .c(x16), .d(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n45_), .O(z10));
  nor2   g70(.a(new_n36_), .b(new_n39_), .O(z11));
  inv1   g71(.a(x16), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(x02), .c(new_n61_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n37_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nand2  g75(.a(new_n37_), .b(new_n45_), .O(z13));
  nor2   g76(.a(new_n89_), .b(new_n45_), .O(z14));
endmodule
