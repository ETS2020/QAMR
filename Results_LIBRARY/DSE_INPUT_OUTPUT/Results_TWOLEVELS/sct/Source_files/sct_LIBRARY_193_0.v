...
module FAU ( 
  ...
  nand4  g15(.a(new_n49_), .b(new_n36_), .c(new_n46_), .d(x04), .O(new_n50_));
  ...
  oai21  g39(.a(new_n63_), .b(new_n43_), .c(new_n36_), .O(new_n74_));
  nand3  g40(.a(new_n56_), .b(new_n64_), .c(x08), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x10), .O(new_n76_));
  inv1   g42(.a(x10), .O(new_n77_));
  nand4  g43(.a(new_n56_), .b(new_n77_), .c(new_n64_), .d(x08), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n74_), .d(new_n36_), .O(z06));
  inv1   g45(.a(new_n63_), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n77_), .c(new_n64_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n65_), .c(x04), .O(new_n83_));
  aoi21  g49(.a(new_n78_), .b(x11), .c(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n80_), .c(new_n35_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n81_), .c(new_n64_), .O(new_n87_));
  oai22  g53(.a(new_n87_), .b(new_n65_), .c(new_n86_), .d(new_n81_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n77_), .O(new_n89_));
  aoi21  g55(.a(new_n78_), .b(x12), .c(new_n35_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n74_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n86_), .c(new_n81_), .d(new_n64_), .O(new_n93_));
  oai22  g59(.a(new_n93_), .b(new_n65_), .c(new_n92_), .d(new_n81_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n77_), .O(new_n95_));
  nand4  g61(.a(new_n66_), .b(new_n86_), .c(new_n77_), .d(new_n64_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(x13), .c(new_n35_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n95_), .c(new_n74_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand2  g65(.a(new_n81_), .b(new_n77_), .O(new_n100_));
  nand3  g66(.a(x17), .b(new_n92_), .c(new_n86_), .O(new_n101_));
  ...
  nand4  g71(.a(new_n48_), .b(new_n36_), .c(x16), .d(x14), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n43_), .O(z10));
  nand2  g73(.a(new_n36_), .b(new_n38_), .O(z11));
  oai21  g74(.a(new_n61_), .b(x02), .c(new_n47_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n36_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nor2   g77(.a(new_n35_), .b(new_n43_), .O(z13));
  nor2   g78(.a(new_n69_), .b(new_n43_), .O(z14));
endmodule
