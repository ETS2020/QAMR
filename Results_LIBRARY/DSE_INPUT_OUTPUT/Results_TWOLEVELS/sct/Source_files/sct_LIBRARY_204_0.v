...
module FAU ( 
  ...
  nor2   g13(.a(x05), .b(x01), .O(new_n48_));
  ...
  aoi21  g36(.a(new_n70_), .b(new_n64_), .c(new_n48_), .O(z05));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n64_), .c(new_n48_), .O(z06));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n48_), .O(z07));
  ...
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n49_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n46_), .b(new_n90_), .c(new_n87_), .d(new_n78_), .O(new_n91_));
  ...
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n49_), .O(z09));
  ...
  and2   g68(.a(new_n102_), .b(new_n46_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n67_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n45_), .c(new_n46_), .d(new_n36_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n49_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z10));
  nor2   g73(.a(new_n48_), .b(new_n38_), .O(z11));
  nor3   g74(.a(new_n48_), .b(new_n61_), .c(x02), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(x03), .c(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n49_), .O(z12));
  nor2   g77(.a(new_n48_), .b(new_n84_), .O(z13));
  inv1   g78(.a(x17), .O(new_n113_));
  nor3   g79(.a(new_n48_), .b(new_n113_), .c(new_n84_), .O(z14));
endmodule
