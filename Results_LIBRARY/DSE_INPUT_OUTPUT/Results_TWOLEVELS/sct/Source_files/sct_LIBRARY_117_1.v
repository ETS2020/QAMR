...
module FAU ( 
  ...
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n63_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n49_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n71_), .O(z06));
  nand3  g44(.a(new_n62_), .b(new_n49_), .c(x16), .O(new_n79_));
  ...
  and2   g49(.a(new_n83_), .b(new_n49_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n79_), .d(new_n71_), .O(z07));
  nand2  g51(.a(new_n83_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n74_), .b(new_n67_), .c(new_n87_), .d(new_n82_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n63_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n49_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n71_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n47_), .b(new_n92_), .c(new_n87_), .d(new_n82_), .O(new_n93_));
  ...
  nand3  g64(.a(new_n98_), .b(new_n71_), .c(new_n49_), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n97_), .c(new_n79_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  inv1   g68(.a(x16), .O(new_n103_));
  aoi21  g69(.a(new_n61_), .b(x02), .c(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n92_), .b(new_n87_), .c(new_n82_), .d(new_n81_), .O(new_n105_));
  ...
  nor2   g76(.a(new_n48_), .b(new_n46_), .O(z11));
  oai21  g77(.a(new_n103_), .b(x02), .c(new_n61_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n49_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nand2  g80(.a(new_n49_), .b(new_n39_), .O(z13));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n48_), .b(new_n116_), .c(new_n39_), .O(z14));
endmodule
