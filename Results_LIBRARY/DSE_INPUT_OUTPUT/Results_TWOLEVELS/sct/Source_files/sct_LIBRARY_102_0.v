...
module FAU ( 
  ...
  aoi21  g27(.a(new_n61_), .b(x16), .c(new_n41_), .O(new_n62_));
  ...
  nand4  g32(.a(new_n66_), .b(new_n64_), .c(new_n62_), .d(new_n46_), .O(z05));
  ...
  aoi21  g38(.a(new_n72_), .b(new_n68_), .c(new_n42_), .O(z06));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n68_), .c(new_n42_), .O(z07));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n68_), .c(new_n42_), .O(z08));
  ...
  nand4  g57(.a(new_n91_), .b(new_n81_), .c(new_n75_), .d(new_n74_), .O(new_n92_));
  ...
  nand2  g61(.a(new_n74_), .b(x01), .O(new_n96_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n48_), .c(new_n65_), .d(x08), .O(new_n100_));
  ...
  oai21  g73(.a(new_n107_), .b(x02), .c(new_n60_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n46_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nor2   g76(.a(new_n42_), .b(new_n41_), .O(z13));
  inv1   g77(.a(x17), .O(new_n112_));
  nor3   g78(.a(new_n42_), .b(new_n112_), .c(new_n41_), .O(z14));
endmodule
