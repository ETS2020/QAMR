...
module FAU ( 
  ...
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n63_), .d(new_n45_), .O(z08));
  nand2  g48(.a(new_n81_), .b(x13), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n61_), .c(x04), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n45_), .O(new_n85_));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n47_), .b(x17), .c(x04), .O(new_n87_));
  ...
  nand3  g60(.a(x17), .b(new_n94_), .c(new_n80_), .O(new_n95_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n45_), .c(x16), .d(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n42_), .O(z10));
  nor2   g68(.a(new_n38_), .b(new_n35_), .O(z11));
  nand3  g69(.a(new_n45_), .b(x16), .c(new_n35_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n59_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n45_), .O(z12));
  nor2   g73(.a(new_n38_), .b(new_n42_), .O(z13));
