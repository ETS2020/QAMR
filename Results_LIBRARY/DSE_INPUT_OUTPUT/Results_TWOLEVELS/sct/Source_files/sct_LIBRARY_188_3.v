...
module FAU ( 
  ...
  oai21  g36(.a(new_n62_), .b(new_n43_), .c(new_n38_), .O(new_n71_));
  ...
  nand4  g50(.a(new_n73_), .b(new_n78_), .c(new_n84_), .d(new_n77_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n71_), .d(new_n38_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n47_), .b(new_n87_), .c(new_n84_), .d(new_n77_), .O(new_n88_));
  ...
  aoi21  g59(.a(x16), .b(x03), .c(new_n43_), .O(new_n94_));
  nand2  g60(.a(new_n85_), .b(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n38_), .O(z09));
  inv1   g62(.a(x14), .O(new_n97_));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n87_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n99_));
  ...
  nand2  g72(.a(new_n91_), .b(new_n59_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n38_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  aoi21  g75(.a(x17), .b(x01), .c(new_n43_), .O(z13));
  inv1   g76(.a(x01), .O(new_n111_));
  nand3  g77(.a(x17), .b(x04), .c(new_n111_), .O(new_n112_));
