...
module FAU ( 
  ...
  nand2  g30(.a(x16), .b(new_n64_), .O(new_n65_));
  oai21  g31(.a(new_n63_), .b(new_n36_), .c(new_n65_), .O(new_n66_));
  ...
  nand2  g37(.a(x04), .b(new_n64_), .O(new_n72_));
  ...
  aoi21  g57(.a(new_n91_), .b(new_n80_), .c(new_n43_), .O(z07));
  nor2   g58(.a(new_n74_), .b(new_n42_), .O(new_n93_));
  ...
  nand4  g64(.a(new_n98_), .b(new_n95_), .c(new_n87_), .d(new_n86_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n76_), .c(x04), .O(new_n100_));
  aoi21  g66(.a(new_n96_), .b(x13), .c(new_n100_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n80_), .c(new_n43_), .O(z09));
  nand2  g68(.a(x01), .b(x00), .O(new_n103_));
  aoi22  g69(.a(new_n103_), .b(new_n99_), .c(new_n49_), .d(x16), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n75_), .c(x08), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n46_), .c(new_n50_), .d(new_n37_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n47_), .O(z10));
  nor2   g74(.a(new_n43_), .b(new_n64_), .O(z11));
  nand2  g75(.a(new_n65_), .b(new_n48_), .O(new_n110_));
  ...
  nor3   g80(.a(new_n43_), .b(new_n114_), .c(new_n42_), .O(z14));
endmodule
