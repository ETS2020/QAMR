...
module FAU ( 
  ...
  nor2   g40(.a(new_n65_), .b(new_n45_), .O(new_n75_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n39_), .O(z06));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n81_), .c(new_n40_), .O(z07));
  nor2   g52(.a(x12), .b(x11), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n78_), .c(new_n68_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x12), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n81_), .c(new_n40_), .O(z08));
  nand2  g57(.a(new_n88_), .b(x13), .O(new_n92_));
  inv1   g58(.a(new_n76_), .O(new_n93_));
  nor2   g59(.a(x13), .b(x12), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n82_), .c(new_n93_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n92_), .c(new_n75_), .d(new_n39_), .O(z09));
  inv1   g62(.a(x12), .O(new_n97_));
  nor2   g63(.a(x17), .b(x13), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n82_), .c(new_n97_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n38_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n51_), .c(new_n66_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  nand4  g69(.a(new_n50_), .b(new_n39_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n45_), .O(z10));
  nor2   g71(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g72(.a(new_n63_), .b(x02), .c(new_n49_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n39_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  aoi21  g75(.a(x17), .b(new_n38_), .c(new_n45_), .O(z13));
