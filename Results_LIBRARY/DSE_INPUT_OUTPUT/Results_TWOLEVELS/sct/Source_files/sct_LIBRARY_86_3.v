...
module FAU ( 
  ...
  oai22  g30(.a(new_n64_), .b(new_n35_), .c(new_n60_), .d(x02), .O(new_n65_));
  ...
  nand3  g39(.a(new_n55_), .b(new_n73_), .c(x08), .O(new_n74_));
  ...
  nor2   g43(.a(new_n72_), .b(new_n44_), .O(new_n78_));
  nand2  g44(.a(new_n74_), .b(x10), .O(new_n79_));
  nor2   g45(.a(x10), .b(x09), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n55_), .c(x08), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n78_), .d(new_n39_), .O(z06));
  ...
  aoi21  g54(.a(new_n81_), .b(x11), .c(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n83_), .c(new_n40_), .O(z07));
  inv1   g56(.a(x12), .O(new_n91_));
  nand4  g57(.a(new_n80_), .b(new_n86_), .c(new_n91_), .d(new_n85_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  aoi21  g59(.a(new_n87_), .b(x12), .c(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n83_), .c(new_n40_), .O(z08));
  nand2  g61(.a(new_n92_), .b(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n83_), .c(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n39_), .O(new_n98_));
  ...
  nand4  g71(.a(new_n105_), .b(new_n85_), .c(new_n84_), .d(new_n35_), .O(new_n106_));
  oai21  g72(.a(x01), .b(new_n35_), .c(new_n106_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n48_), .c(new_n73_), .d(x08), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(x07), .c(x06), .O(new_n110_));
  nand4  g76(.a(new_n62_), .b(new_n39_), .c(x16), .d(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n44_), .O(z10));
  nand2  g78(.a(new_n39_), .b(new_n36_), .O(z11));
  nand3  g79(.a(new_n39_), .b(x16), .c(new_n36_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n61_), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n39_), .O(z12));
  nor2   g83(.a(new_n40_), .b(new_n44_), .O(z13));
  nand3  g84(.a(new_n39_), .b(x17), .c(x04), .O(new_n119_));
