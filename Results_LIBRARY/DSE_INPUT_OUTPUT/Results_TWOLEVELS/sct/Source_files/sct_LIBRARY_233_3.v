...
module FAU ( 
  ...
  oai21  g43(.a(new_n64_), .b(new_n44_), .c(new_n47_), .O(new_n78_));
  ...
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n47_), .O(z09));
  inv1   g64(.a(x14), .O(new_n99_));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n89_), .b(new_n86_), .c(new_n81_), .d(new_n80_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  and2   g68(.a(new_n102_), .b(new_n49_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n68_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n48_), .c(new_n49_), .d(new_n99_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n47_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z10));
  nand2  g73(.a(new_n47_), .b(new_n35_), .O(z11));
  nand3  g74(.a(new_n47_), .b(x16), .c(new_n35_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n61_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n47_), .O(z12));
  nand2  g78(.a(new_n47_), .b(new_n44_), .O(z13));
  aoi21  g79(.a(new_n44_), .b(new_n39_), .c(new_n36_), .O(z14));
endmodule
