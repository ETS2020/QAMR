...
module FAU ( 
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n65_), .d(new_n37_), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n65_), .d(new_n37_), .O(z08));
  ...
  aoi21  g55(.a(new_n89_), .b(new_n63_), .c(new_n36_), .O(z09));
  ...
  nand2  g67(.a(new_n37_), .b(new_n43_), .O(z13));
