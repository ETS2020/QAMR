...
module FAU ( 
  ...
  oai21  g15(.a(x16), .b(x01), .c(new_n49_), .O(new_n50_));
  ...
  nand4  g59(.a(new_n54_), .b(new_n93_), .c(new_n88_), .d(new_n82_), .O(new_n94_));
  ...
  oai21  g65(.a(new_n36_), .b(new_n48_), .c(new_n39_), .O(new_n100_));
  aoi21  g66(.a(new_n90_), .b(x13), .c(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(z13), .O(z09));
  aoi21  g68(.a(new_n48_), .b(x02), .c(new_n36_), .O(new_n103_));
  ...
  nand2  g80(.a(new_n114_), .b(new_n39_), .O(z14));
endmodule
