...
module FAU ( 
  ...
  nand3  g10(.a(new_n44_), .b(x07), .c(new_n42_), .O(new_n45_));
  ...
  oai21  g21(.a(new_n55_), .b(new_n48_), .c(x08), .O(new_n56_));
  ...
  nor2   g32(.a(new_n57_), .b(new_n48_), .O(new_n67_));
  nand3  g33(.a(new_n66_), .b(x08), .c(x06), .O(new_n68_));
  oai21  g34(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x07), .O(new_n70_));
  nand3  g36(.a(x09), .b(new_n55_), .c(x05), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z05));
  nand2  g38(.a(new_n68_), .b(x10), .O(new_n73_));
  inv1   g39(.a(x10), .O(new_n74_));
  nand3  g40(.a(new_n67_), .b(new_n74_), .c(new_n66_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x07), .O(new_n77_));
  nand3  g43(.a(x10), .b(new_n55_), .c(x05), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n65_), .O(z06));
  and2   g45(.a(new_n75_), .b(x11), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  nand4  g47(.a(new_n67_), .b(new_n81_), .c(new_n74_), .d(new_n66_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  oai21  g49(.a(new_n83_), .b(new_n80_), .c(x07), .O(new_n84_));
  nand3  g50(.a(x11), .b(new_n55_), .c(x05), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(z07));
  oai21  g52(.a(x12), .b(new_n42_), .c(new_n55_), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n81_), .c(new_n74_), .d(new_n66_), .O(new_n89_));
  nor4   g55(.a(new_n89_), .b(new_n57_), .c(new_n55_), .d(new_n48_), .O(new_n90_));
  aoi21  g56(.a(new_n82_), .b(x12), .c(new_n90_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n87_), .c(new_n65_), .O(z08));
  inv1   g58(.a(x04), .O(new_n93_));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n49_), .b(new_n94_), .c(new_n88_), .d(new_n81_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x10), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n66_), .c(x08), .d(x06), .O(new_n97_));
  nand3  g63(.a(new_n88_), .b(new_n81_), .c(new_n74_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n68_), .c(x13), .O(new_n99_));
  oai21  g65(.a(new_n97_), .b(new_n93_), .c(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x07), .O(new_n101_));
  nand3  g67(.a(x13), .b(new_n55_), .c(x05), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n65_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand4  g70(.a(new_n94_), .b(new_n88_), .c(new_n81_), .d(new_n74_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n49_), .c(new_n66_), .d(x08), .O(new_n107_));
  oai22  g73(.a(new_n107_), .b(new_n48_), .c(new_n49_), .d(new_n39_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x07), .O(new_n109_));
  inv1   g75(.a(new_n49_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(x14), .c(x05), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n109_), .c(new_n93_), .O(z10));
  nor2   g78(.a(new_n35_), .b(new_n36_), .O(z11));
  inv1   g79(.a(x03), .O(new_n114_));
  oai21  g80(.a(new_n62_), .b(x02), .c(new_n114_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n47_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n47_), .b(new_n93_), .O(z13));
