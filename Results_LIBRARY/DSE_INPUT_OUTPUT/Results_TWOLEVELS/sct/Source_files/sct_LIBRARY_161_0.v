...
module FAU ( 
  ...
  nand2  g28(.a(x04), .b(new_n62_), .O(new_n63_));
  aoi21  g29(.a(new_n63_), .b(new_n47_), .c(new_n48_), .O(new_n64_));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n74_), .c(new_n42_), .O(z06));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n74_), .c(new_n42_), .O(z07));
  nor2   g52(.a(new_n64_), .b(new_n41_), .O(new_n87_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(z08));
  ...
  aoi21  g61(.a(new_n95_), .b(new_n74_), .c(new_n42_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  aoi21  g63(.a(new_n93_), .b(new_n97_), .c(new_n49_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n65_), .c(x08), .d(x07), .O(new_n99_));
  ...
  nand2  g68(.a(new_n102_), .b(new_n46_), .O(z10));
  nor2   g69(.a(new_n42_), .b(new_n62_), .O(z11));
  oai21  g70(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n46_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nand2  g73(.a(new_n46_), .b(new_n41_), .O(z13));
  inv1   g74(.a(x17), .O(new_n109_));
  nor3   g75(.a(new_n42_), .b(new_n109_), .c(new_n41_), .O(z14));
endmodule
