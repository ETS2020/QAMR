...
module FAU ( 
  ...
  nand3  g06(.a(new_n40_), .b(x15), .c(new_n39_), .O(new_n41_));
  inv1   g07(.a(x04), .O(new_n42_));
  nor2   g08(.a(x18), .b(x05), .O(new_n43_));
  aoi21  g09(.a(x05), .b(new_n42_), .c(new_n43_), .O(new_n44_));
  oai21  g10(.a(new_n44_), .b(x15), .c(new_n41_), .O(z01));
  inv1   g11(.a(x06), .O(new_n46_));
  oai21  g12(.a(x03), .b(new_n35_), .c(x16), .O(new_n47_));
  nor2   g13(.a(new_n36_), .b(new_n39_), .O(new_n48_));
  ...
  nand3  g28(.a(new_n62_), .b(new_n49_), .c(x16), .O(new_n63_));
  oai21  g29(.a(new_n36_), .b(new_n39_), .c(new_n42_), .O(new_n64_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(new_n71_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n49_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n64_), .O(z07));
  nand2  g51(.a(new_n82_), .b(x12), .O(new_n86_));
  nor2   g52(.a(x12), .b(x11), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n73_), .c(new_n81_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n71_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n49_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n64_), .O(z08));
  inv1   g57(.a(x12), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n47_), .b(new_n93_), .c(new_n92_), .d(new_n80_), .O(new_n94_));
  ...
  aoi21  g66(.a(new_n87_), .b(new_n79_), .c(x09), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n68_), .c(x13), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n100_), .c(new_n64_), .d(new_n49_), .O(z09));
  inv1   g69(.a(x14), .O(new_n104_));
  inv1   g70(.a(x00), .O(new_n105_));
  nand4  g71(.a(new_n93_), .b(new_n92_), .c(new_n80_), .d(new_n79_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  and2   g73(.a(new_n107_), .b(new_n47_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n67_), .c(x08), .d(x07), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n46_), .c(new_n47_), .d(new_n104_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n49_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z10));
  nand2  g78(.a(new_n49_), .b(new_n35_), .O(z11));
  nand3  g79(.a(new_n49_), .b(x16), .c(new_n35_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n61_), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n49_), .O(z12));
  nor2   g83(.a(new_n48_), .b(new_n42_), .O(z13));
  nand2  g84(.a(x17), .b(x04), .O(new_n119_));
  nand2  g85(.a(new_n119_), .b(new_n49_), .O(z14));
endmodule
