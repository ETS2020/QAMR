...
module FAU ( 
  ...
  nor2   g16(.a(new_n50_), .b(new_n42_), .O(new_n51_));
  ...
  nand3  g27(.a(new_n61_), .b(new_n54_), .c(x04), .O(new_n62_));
  ...
  aoi21  g34(.a(new_n48_), .b(x02), .c(new_n50_), .O(new_n69_));
  nand3  g35(.a(x08), .b(x07), .c(x06), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(x09), .c(new_n69_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n42_), .c(new_n68_), .O(z05));
  oai21  g38(.a(new_n66_), .b(new_n58_), .c(x10), .O(new_n73_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n54_), .d(x04), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n54_), .d(x04), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n54_), .b(new_n87_), .c(new_n84_), .d(new_n79_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(x10), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n65_), .c(x08), .d(x07), .O(new_n90_));
  aoi21  g56(.a(new_n85_), .b(x13), .c(new_n69_), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n43_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  nand2  g59(.a(x06), .b(new_n42_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n93_), .O(z09));
  inv1   g61(.a(new_n35_), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand4  g63(.a(new_n87_), .b(new_n84_), .c(new_n79_), .d(new_n78_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n65_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n43_), .c(new_n54_), .d(new_n39_), .O(new_n101_));
  ...
  aoi21  g71(.a(new_n105_), .b(new_n48_), .c(new_n42_), .O(z12));
