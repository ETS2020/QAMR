...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n41_,
    ...
    new_n109_;
  nor2   g00(.a(x17), .b(x05), .O(new_n35_));
  ...
  nand2  g08(.a(x18), .b(x17), .O(new_n43_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n36_), .O(z06));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n63_), .c(new_n35_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand3  g50(.a(new_n74_), .b(new_n84_), .c(new_n78_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n64_), .c(x04), .O(new_n86_));
  aoi21  g52(.a(new_n80_), .b(x12), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n63_), .c(new_n35_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n49_), .b(new_n89_), .c(new_n84_), .d(new_n78_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(x09), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(x08), .c(x07), .d(x06), .O(new_n92_));
  oai21  g58(.a(x12), .b(x11), .c(x13), .O(new_n93_));
  oai21  g59(.a(new_n92_), .b(new_n45_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n77_), .O(new_n95_));
  aoi21  g61(.a(new_n75_), .b(x13), .c(new_n35_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n72_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand2  g64(.a(new_n61_), .b(x02), .O(new_n99_));
  nand4  g65(.a(new_n89_), .b(new_n84_), .c(new_n78_), .d(new_n77_), .O(new_n100_));
  aoi22  g66(.a(new_n100_), .b(new_n98_), .c(new_n99_), .d(x16), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n66_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n48_), .c(new_n49_), .d(new_n38_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n36_), .O(z10));
  nor2   g71(.a(new_n35_), .b(new_n40_), .O(z11));
  nand3  g72(.a(new_n36_), .b(x16), .c(new_n40_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n61_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n36_), .O(z12));
  nor2   g76(.a(new_n35_), .b(new_n45_), .O(z13));
