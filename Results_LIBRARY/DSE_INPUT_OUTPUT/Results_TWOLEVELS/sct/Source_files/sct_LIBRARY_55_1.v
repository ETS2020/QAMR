...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n72_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n71_), .c(new_n48_), .O(new_n77_));
  ...
  nand3  g47(.a(new_n81_), .b(new_n66_), .c(new_n75_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n48_), .d(x04), .O(z08));
  inv1   g49(.a(x12), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n48_), .b(new_n85_), .c(new_n84_), .d(new_n74_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n72_), .c(x08), .d(x07), .O(new_n88_));
  inv1   g54(.a(new_n48_), .O(new_n89_));
  nand4  g55(.a(new_n81_), .b(new_n62_), .c(new_n73_), .d(x07), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x13), .c(new_n89_), .O(new_n91_));
  oai21  g57(.a(new_n88_), .b(new_n35_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  oai21  g59(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n93_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand4  g62(.a(new_n85_), .b(new_n84_), .c(new_n74_), .d(new_n73_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n48_), .c(new_n72_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  nand2  g67(.a(new_n89_), .b(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n101_), .c(new_n43_), .O(z10));
  inv1   g69(.a(new_n36_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n37_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n37_), .c(x03), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(new_n43_), .O(z12));
  nand2  g73(.a(x17), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n104_), .O(z14));
  buf    g75(.a(x04), .O(z13));
endmodule
