...
module FAU ( 
  ...
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z13));
  inv1   g27(.a(x03), .O(new_n62_));
  oai21  g28(.a(new_n43_), .b(x02), .c(new_n62_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(new_n35_), .c(x16), .O(new_n64_));
  ...
  nor2   g43(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n74_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  nand3  g46(.a(new_n63_), .b(x16), .c(x01), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n80_), .O(z07));
  inv1   g48(.a(x12), .O(new_n83_));
  nor2   g49(.a(new_n77_), .b(new_n83_), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  inv1   g51(.a(new_n65_), .O(new_n86_));
  nand4  g52(.a(new_n71_), .b(new_n86_), .c(new_n83_), .d(new_n85_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n84_), .c(new_n45_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n81_), .O(z08));
  nor2   g56(.a(x03), .b(new_n48_), .O(new_n91_));
  nor3   g57(.a(x13), .b(x12), .c(x11), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n71_), .c(new_n86_), .d(new_n91_), .O(new_n93_));
  nand2  g59(.a(x16), .b(new_n48_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n35_), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n75_), .b(new_n37_), .c(new_n96_), .d(new_n83_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(new_n68_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n95_), .c(x04), .O(new_n99_));
  aoi21  g65(.a(new_n62_), .b(x01), .c(new_n37_), .O(new_n100_));
  aoi21  g66(.a(new_n87_), .b(x13), .c(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(z13), .O(z09));
  nand3  g68(.a(new_n62_), .b(x02), .c(x01), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x16), .O(new_n104_));
  inv1   g70(.a(x00), .O(new_n105_));
  inv1   g71(.a(x10), .O(new_n106_));
  nand4  g72(.a(new_n96_), .b(new_n83_), .c(new_n85_), .d(new_n106_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n104_), .c(new_n67_), .d(x08), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(x07), .c(x06), .O(new_n111_));
  nor2   g77(.a(new_n49_), .b(new_n36_), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(x01), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n111_), .c(new_n43_), .O(z10));
  nand2  g80(.a(new_n45_), .b(new_n48_), .O(z11));
  oai21  g81(.a(new_n94_), .b(new_n35_), .c(new_n62_), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n45_), .O(z12));
  nand2  g84(.a(new_n45_), .b(x17), .O(new_n119_));
  nor2   g85(.a(new_n119_), .b(new_n43_), .O(z14));
endmodule
