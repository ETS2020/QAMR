...
module FAU ( 
  ...
  oai21  g61(.a(new_n87_), .b(new_n38_), .c(new_n95_), .O(new_n96_));
  ...
  nor2   g69(.a(new_n39_), .b(new_n61_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n35_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n43_), .c(new_n46_), .O(z12));
  nor2   g72(.a(new_n39_), .b(new_n43_), .O(z13));
  nor2   g73(.a(new_n87_), .b(new_n43_), .O(z14));
endmodule
