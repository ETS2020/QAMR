...
module FAU ( 
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n44_), .O(z05));
  nand2  g36(.a(new_n69_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n57_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(new_n44_), .O(z06));
  inv1   g40(.a(new_n44_), .O(new_n75_));
  ...
  aoi21  g47(.a(new_n81_), .b(new_n63_), .c(new_n75_), .O(z07));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n63_), .c(new_n75_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n83_), .c(new_n77_), .d(new_n76_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n69_), .c(x04), .O(new_n90_));
  aoi21  g56(.a(new_n84_), .b(x13), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n63_), .c(new_n75_), .O(z09));
  ...
  nand2  g64(.a(new_n98_), .b(new_n44_), .O(z10));
  nor2   g65(.a(new_n75_), .b(new_n35_), .O(z11));
  oai21  g66(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n44_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  nor2   g69(.a(new_n75_), .b(new_n42_), .O(z13));
  nor2   g70(.a(new_n36_), .b(new_n42_), .O(z14));
endmodule
