...
module FAU ( 
  ...
  nand2  g04(.a(x01), .b(x00), .O(new_n39_));
  ...
  aoi21  g27(.a(new_n49_), .b(x16), .c(x09), .O(new_n62_));
  ...
  nand3  g40(.a(new_n57_), .b(new_n74_), .c(x08), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n67_), .c(x04), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n73_), .c(new_n35_), .O(new_n77_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n79_), .c(new_n40_), .O(z06));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n79_), .c(new_n40_), .O(z07));
  nor2   g57(.a(x12), .b(x11), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n80_), .c(new_n87_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  aoi21  g60(.a(new_n88_), .b(x12), .c(new_n94_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n79_), .c(new_n40_), .O(z08));
  nor2   g62(.a(new_n73_), .b(new_n44_), .O(new_n97_));
  nand2  g63(.a(new_n93_), .b(x13), .O(new_n98_));
  inv1   g64(.a(new_n75_), .O(new_n99_));
  nor2   g65(.a(x13), .b(x12), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n99_), .c(new_n86_), .d(new_n85_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n98_), .c(new_n97_), .d(new_n39_), .O(z09));
  nand4  g68(.a(new_n100_), .b(new_n86_), .c(new_n85_), .d(new_n35_), .O(new_n103_));
  oai21  g69(.a(x01), .b(new_n35_), .c(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n50_), .c(new_n74_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(x07), .c(x06), .O(new_n107_));
  nand4  g73(.a(new_n49_), .b(new_n39_), .c(x16), .d(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z10));
  nor2   g75(.a(new_n40_), .b(new_n36_), .O(z11));
  nand2  g76(.a(new_n64_), .b(new_n48_), .O(new_n111_));
