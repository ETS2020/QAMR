...
module FAU ( 
  ...
  oai21  g31(.a(new_n65_), .b(new_n45_), .c(new_n37_), .O(new_n66_));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n76_), .c(new_n36_), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n66_), .d(new_n37_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n70_), .c(x04), .O(new_n90_));
  aoi21  g56(.a(new_n86_), .b(x13), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n76_), .c(new_n36_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  aoi21  g59(.a(new_n89_), .b(new_n93_), .c(new_n51_), .O(new_n94_));
  ...
  nand2  g65(.a(new_n37_), .b(new_n39_), .O(z11));
  oai21  g66(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n37_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  aoi21  g69(.a(x17), .b(new_n93_), .c(new_n45_), .O(z13));
  aoi21  g70(.a(new_n45_), .b(x00), .c(new_n35_), .O(z14));
endmodule
