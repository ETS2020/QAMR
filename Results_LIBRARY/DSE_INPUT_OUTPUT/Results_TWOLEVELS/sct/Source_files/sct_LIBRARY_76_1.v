...
module FAU ( 
  ...
  nand2  g14(.a(new_n35_), .b(new_n48_), .O(new_n49_));
  ...
  aoi21  g30(.a(new_n46_), .b(x02), .c(new_n42_), .O(new_n65_));
  ...
  oai21  g55(.a(new_n65_), .b(new_n42_), .c(x16), .O(new_n90_));
  nand2  g56(.a(new_n85_), .b(x12), .O(new_n91_));
  inv1   g57(.a(x12), .O(new_n92_));
  nand4  g58(.a(new_n75_), .b(new_n84_), .c(new_n92_), .d(new_n83_), .O(new_n93_));
  aoi21  g59(.a(new_n35_), .b(new_n42_), .c(new_n36_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n93_), .c(new_n91_), .d(new_n90_), .O(z08));
  nand2  g61(.a(new_n53_), .b(new_n42_), .O(z13));
  inv1   g62(.a(x13), .O(new_n97_));
  nand4  g63(.a(new_n50_), .b(new_n97_), .c(new_n92_), .d(new_n83_), .O(new_n98_));
  nor2   g64(.a(new_n98_), .b(x10), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n68_), .c(x08), .d(x07), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n45_), .c(new_n56_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  aoi21  g68(.a(new_n93_), .b(x13), .c(new_n36_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n102_), .c(z13), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nand4  g71(.a(new_n97_), .b(new_n92_), .c(new_n83_), .d(new_n82_), .O(new_n106_));
  ...
  nand2  g76(.a(new_n55_), .b(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n42_), .O(z10));
  nand2  g78(.a(new_n53_), .b(new_n37_), .O(z11));
  nand2  g79(.a(new_n53_), .b(x03), .O(new_n114_));
  nand2  g80(.a(x16), .b(new_n37_), .O(new_n115_));
  aoi21  g81(.a(new_n115_), .b(new_n114_), .c(new_n42_), .O(z12));
  nand2  g82(.a(x17), .b(x04), .O(new_n117_));
  nand2  g83(.a(new_n117_), .b(new_n53_), .O(z14));
endmodule
