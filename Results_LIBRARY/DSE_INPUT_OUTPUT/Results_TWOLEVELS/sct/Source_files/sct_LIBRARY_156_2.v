...
module FAU ( 
  ...
  oai21  g31(.a(new_n65_), .b(new_n46_), .c(new_n37_), .O(new_n66_));
  ...
  aoi21  g59(.a(new_n86_), .b(x13), .c(new_n36_), .O(new_n94_));
  ...
  oai22  g65(.a(new_n99_), .b(new_n49_), .c(new_n50_), .d(new_n39_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n37_), .O(z10));
  nand2  g68(.a(new_n37_), .b(new_n41_), .O(z11));
  nor2   g69(.a(new_n36_), .b(new_n63_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n41_), .c(x03), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n46_), .c(new_n37_), .O(z12));
