...
module FAU ( 
  ...
  nand2  g09(.a(x16), .b(x01), .O(new_n44_));
  nand3  g10(.a(new_n44_), .b(new_n43_), .c(new_n41_), .O(z01));
  inv1   g11(.a(x06), .O(new_n46_));
  nor2   g12(.a(x03), .b(new_n35_), .O(new_n47_));
  ...
  nand2  g26(.a(new_n44_), .b(new_n42_), .O(z13));
  inv1   g27(.a(x03), .O(new_n62_));
  oai21  g28(.a(new_n42_), .b(x02), .c(new_n62_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(x01), .c(x16), .O(new_n64_));
