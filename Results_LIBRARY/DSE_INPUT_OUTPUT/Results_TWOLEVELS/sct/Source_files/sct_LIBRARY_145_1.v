...
module FAU ( 
  ...
  aoi21  g38(.a(new_n68_), .b(x10), .c(new_n72_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n62_), .c(new_n40_), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n64_), .d(new_n39_), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n64_), .d(new_n39_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n48_), .b(new_n85_), .c(new_n82_), .d(new_n77_), .O(new_n86_));
  inv1   g52(.a(new_n86_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n76_), .c(new_n67_), .d(x08), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(x07), .c(x06), .d(x04), .O(new_n90_));
  aoi21  g56(.a(new_n83_), .b(x13), .c(new_n40_), .O(new_n91_));
  ...
  nand4  g60(.a(new_n85_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n95_));
