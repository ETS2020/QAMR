...
module FAU ( 
  ...
  inv1   g42(.a(new_n37_), .O(new_n77_));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n65_), .c(new_n77_), .O(z07));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n65_), .c(new_n77_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n51_), .b(new_n90_), .c(new_n85_), .d(new_n79_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n78_), .c(new_n70_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x07), .c(x06), .d(x04), .O(new_n95_));
  aoi21  g61(.a(new_n86_), .b(x13), .c(new_n77_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n67_), .O(z09));
  inv1   g63(.a(x16), .O(new_n98_));
  aoi21  g64(.a(new_n63_), .b(x02), .c(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n90_), .b(new_n85_), .c(new_n79_), .d(new_n78_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n35_), .c(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n70_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n50_), .c(new_n51_), .d(new_n39_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n37_), .O(z10));
  nor2   g71(.a(new_n77_), .b(new_n41_), .O(z11));
  nor3   g72(.a(new_n77_), .b(new_n98_), .c(x02), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(x03), .c(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n37_), .O(z12));
  nor2   g75(.a(new_n77_), .b(new_n47_), .O(z13));
  nor2   g76(.a(new_n36_), .b(new_n47_), .O(z14));
endmodule
