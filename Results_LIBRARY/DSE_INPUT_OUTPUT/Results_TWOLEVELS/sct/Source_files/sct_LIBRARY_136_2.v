...
module FAU ( 
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n66_), .d(new_n47_), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n66_), .d(new_n47_), .O(z08));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n86_), .c(new_n39_), .O(z09));
  ...
  nand2  g62(.a(new_n96_), .b(new_n47_), .O(z10));
  nand2  g63(.a(new_n47_), .b(new_n35_), .O(z11));
  nor2   g64(.a(new_n39_), .b(new_n50_), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n35_), .c(x03), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n44_), .c(new_n47_), .O(z12));
  nor2   g67(.a(new_n39_), .b(new_n44_), .O(z13));
