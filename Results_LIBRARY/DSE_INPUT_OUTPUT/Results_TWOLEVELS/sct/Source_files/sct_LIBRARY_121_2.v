...
module FAU ( 
  ...
  nor2   g59(.a(new_n75_), .b(new_n44_), .O(new_n94_));
  nand2  g60(.a(new_n90_), .b(x12), .O(new_n95_));
  nor2   g61(.a(x12), .b(x11), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n82_), .c(new_n89_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n95_), .c(new_n94_), .d(new_n47_), .O(z08));
  nand2  g64(.a(new_n97_), .b(x13), .O(new_n99_));
  ...
  nand4  g68(.a(new_n102_), .b(new_n99_), .c(new_n94_), .d(new_n47_), .O(z09));
  nand4  g69(.a(new_n101_), .b(new_n88_), .c(new_n87_), .d(new_n39_), .O(new_n104_));
  oai21  g70(.a(new_n35_), .b(new_n39_), .c(new_n104_), .O(new_n105_));
  ...
  nand2  g76(.a(new_n47_), .b(new_n65_), .O(z11));
