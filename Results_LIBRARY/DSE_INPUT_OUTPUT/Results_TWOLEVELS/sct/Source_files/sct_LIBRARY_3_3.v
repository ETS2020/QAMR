...
module FAU ( 
  ...
  aoi21  g61(.a(new_n95_), .b(new_n79_), .c(new_n39_), .O(z08));
  nor2   g62(.a(new_n73_), .b(new_n43_), .O(new_n97_));
  ...
  nand4  g67(.a(new_n101_), .b(new_n98_), .c(new_n97_), .d(new_n38_), .O(z09));
  nand4  g68(.a(new_n100_), .b(new_n86_), .c(new_n85_), .d(new_n61_), .O(new_n103_));
  oai21  g69(.a(x01), .b(new_n61_), .c(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n49_), .c(new_n74_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(x07), .c(x06), .O(new_n107_));
  nand4  g73(.a(new_n48_), .b(new_n38_), .c(x16), .d(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n43_), .O(z10));
  nor2   g75(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g76(.a(new_n64_), .b(new_n47_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n38_), .c(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z12));
  nand2  g79(.a(new_n38_), .b(new_n43_), .O(z13));
