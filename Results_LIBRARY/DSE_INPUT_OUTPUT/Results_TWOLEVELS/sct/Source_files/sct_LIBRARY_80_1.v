...
module FAU ( 
  ...
  nand4  g48(.a(new_n50_), .b(x07), .c(new_n49_), .d(x04), .O(new_n83_));
  nor2   g49(.a(x10), .b(x09), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(x08), .d(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x11), .O(new_n86_));
  inv1   g52(.a(new_n68_), .O(new_n87_));
  nand4  g53(.a(new_n84_), .b(new_n87_), .c(new_n35_), .d(new_n77_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n86_), .c(new_n67_), .O(z07));
  nand3  g55(.a(new_n84_), .b(new_n58_), .c(x08), .O(new_n90_));
  ...
  nor2   g60(.a(x17), .b(x12), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n77_), .d(new_n76_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n93_), .c(new_n67_), .O(z08));
  inv1   g63(.a(x12), .O(new_n98_));
  inv1   g64(.a(x13), .O(new_n99_));
  nand4  g65(.a(new_n50_), .b(new_n35_), .c(new_n99_), .d(new_n98_), .O(new_n100_));
  nor3   g66(.a(new_n100_), .b(x10), .c(x09), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(x08), .c(x07), .d(x06), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n45_), .c(new_n35_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n77_), .O(new_n104_));
  nand3  g70(.a(new_n84_), .b(new_n98_), .c(new_n77_), .O(new_n105_));
  ...
  and2   g74(.a(new_n50_), .b(new_n70_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(x08), .c(x07), .d(x06), .O(new_n110_));
  oai22  g76(.a(new_n110_), .b(new_n108_), .c(new_n50_), .d(new_n40_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n48_), .O(new_n112_));
  inv1   g78(.a(new_n100_), .O(new_n113_));
  nand4  g79(.a(new_n113_), .b(new_n77_), .c(new_n76_), .d(new_n70_), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(new_n115_));
  nand4  g81(.a(new_n115_), .b(x08), .c(x07), .d(x06), .O(new_n116_));
  aoi21  g82(.a(new_n116_), .b(new_n112_), .c(new_n45_), .O(z10));
  nand2  g83(.a(new_n48_), .b(new_n37_), .O(z11));
  nor2   g84(.a(new_n36_), .b(new_n64_), .O(new_n119_));
  aoi21  g85(.a(new_n119_), .b(new_n37_), .c(x03), .O(new_n120_));
  oai21  g86(.a(new_n120_), .b(new_n45_), .c(new_n48_), .O(z12));
  nand2  g87(.a(new_n48_), .b(new_n45_), .O(z13));
  nand3  g88(.a(x17), .b(x11), .c(x04), .O(new_n123_));
