...
module FAU ( 
  ...
  aoi21  g58(.a(new_n89_), .b(new_n35_), .c(new_n50_), .O(new_n93_));
  ...
  nand2  g63(.a(new_n97_), .b(new_n39_), .O(z10));
  nor2   g64(.a(new_n40_), .b(new_n36_), .O(z11));
  nand3  g65(.a(new_n39_), .b(x16), .c(new_n36_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n39_), .O(z12));
