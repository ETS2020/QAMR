...
module FAU ( 
  ...
  aoi21  g38(.a(new_n72_), .b(new_n60_), .c(new_n71_), .O(new_n73_));
  ...
  oai21  g44(.a(new_n73_), .b(new_n41_), .c(new_n47_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(x10), .O(new_n80_));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n55_), .c(x08), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n47_), .O(z06));
  ...
  nand4  g60(.a(new_n94_), .b(new_n92_), .c(new_n79_), .d(new_n47_), .O(z08));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n48_), .b(new_n96_), .c(new_n93_), .d(new_n86_), .O(new_n97_));
  ...
  aoi21  g67(.a(new_n94_), .b(x13), .c(new_n43_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n79_), .O(z09));
  inv1   g69(.a(x14), .O(new_n104_));
  nand2  g70(.a(new_n42_), .b(x00), .O(new_n105_));
  nand4  g71(.a(new_n96_), .b(new_n93_), .c(new_n86_), .d(new_n85_), .O(new_n106_));
  aoi22  g72(.a(new_n106_), .b(new_n105_), .c(new_n61_), .d(x16), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n74_), .c(x08), .d(x07), .O(new_n108_));
  oai22  g74(.a(new_n108_), .b(new_n46_), .c(new_n48_), .d(new_n104_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(x04), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n47_), .O(z10));
  nor2   g77(.a(new_n43_), .b(new_n36_), .O(z11));
  nand2  g78(.a(new_n64_), .b(new_n60_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n47_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  nor2   g81(.a(new_n43_), .b(new_n41_), .O(z13));
