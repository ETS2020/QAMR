...
module FAU ( 
  ...
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n67_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  aoi21  g44(.a(new_n72_), .b(x11), .c(new_n78_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n62_), .c(new_n39_), .O(z07));
  nand2  g46(.a(new_n77_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n71_), .b(new_n76_), .c(new_n82_), .d(new_n75_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n64_), .d(new_n47_), .O(z08));
  ...
  nand3  g54(.a(new_n48_), .b(x04), .c(x01), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n82_), .c(new_n75_), .d(new_n74_), .O(new_n91_));
  ...
  nand2  g60(.a(new_n74_), .b(x01), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n82_), .c(new_n75_), .O(new_n97_));
  ...
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n43_), .O(z10));
  nor2   g70(.a(new_n39_), .b(new_n36_), .O(z11));
  nand3  g71(.a(new_n47_), .b(x16), .c(new_n36_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n60_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n47_), .O(z12));
  nor2   g75(.a(new_n39_), .b(new_n43_), .O(z13));
