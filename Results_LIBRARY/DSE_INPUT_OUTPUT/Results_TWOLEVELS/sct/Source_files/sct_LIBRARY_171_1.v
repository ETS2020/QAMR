...
module FAU ( 
  ...
  aoi21  g08(.a(x05), .b(new_n42_), .c(new_n39_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n63_), .b(new_n42_), .c(new_n46_), .O(new_n64_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n64_), .d(new_n46_), .O(z08));
  ...
  nand2  g61(.a(new_n95_), .b(new_n46_), .O(z10));
  nand2  g62(.a(new_n46_), .b(new_n35_), .O(z11));
  nor2   g63(.a(new_n39_), .b(new_n48_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n35_), .c(x03), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n42_), .c(new_n46_), .O(z12));
  nand2  g66(.a(new_n46_), .b(new_n42_), .O(z13));
