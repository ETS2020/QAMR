...
module FAU ( 
  ...
  nor2   g09(.a(x01), .b(x00), .O(new_n44_));
  ...
  nand2  g68(.a(new_n48_), .b(new_n38_), .O(z11));
  ...
  nor2   g72(.a(new_n44_), .b(new_n43_), .O(z13));
  inv1   g73(.a(x17), .O(new_n108_));
  nor3   g74(.a(new_n44_), .b(new_n108_), .c(new_n43_), .O(z14));
endmodule
