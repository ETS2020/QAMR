...
module FAU ( 
  ...
  and2   g08(.a(x18), .b(x05), .O(new_n43_));
  nor2   g09(.a(x18), .b(x17), .O(new_n44_));
  oai21  g10(.a(new_n44_), .b(new_n43_), .c(new_n42_), .O(new_n45_));
  and2   g11(.a(x18), .b(x15), .O(new_n46_));
  nor2   g12(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  oai21  g13(.a(new_n47_), .b(x05), .c(new_n45_), .O(z01));
  ...
  oai21  g30(.a(new_n42_), .b(x02), .c(new_n50_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n37_), .c(x16), .O(new_n66_));
  oai21  g32(.a(x18), .b(new_n35_), .c(new_n42_), .O(new_n67_));
  ...
  and2   g43(.a(new_n77_), .b(new_n37_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n67_), .d(new_n66_), .O(z06));
  nand2  g45(.a(new_n77_), .b(x11), .O(new_n80_));
  inv1   g46(.a(x10), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(new_n68_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n70_), .O(new_n84_));
  and2   g50(.a(new_n84_), .b(new_n37_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n80_), .c(new_n67_), .d(new_n66_), .O(z07));
  nand2  g52(.a(new_n65_), .b(x16), .O(new_n87_));
  ...
  nand3  g56(.a(new_n90_), .b(new_n88_), .c(new_n87_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n37_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n67_), .O(z08));
  nand2  g59(.a(new_n90_), .b(x13), .O(new_n94_));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n89_), .c(new_n82_), .d(new_n81_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n72_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n94_), .c(new_n87_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n37_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n67_), .O(z09));
  inv1   g67(.a(x00), .O(new_n102_));
  aoi21  g68(.a(new_n96_), .b(new_n102_), .c(new_n52_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n70_), .c(x08), .d(x07), .O(new_n104_));
  nand2  g70(.a(new_n52_), .b(x14), .O(new_n105_));
  oai21  g71(.a(new_n104_), .b(new_n49_), .c(new_n105_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n37_), .O(z10));
  nor2   g74(.a(new_n36_), .b(new_n39_), .O(z11));
  oai21  g75(.a(new_n51_), .b(x02), .c(new_n50_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n37_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nand2  g78(.a(new_n37_), .b(new_n42_), .O(z13));
  nand3  g79(.a(x18), .b(x17), .c(x04), .O(new_n114_));
