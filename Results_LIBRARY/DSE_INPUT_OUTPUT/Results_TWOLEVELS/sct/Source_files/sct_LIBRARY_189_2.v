...
module FAU ( 
  ...
  nor2   g06(.a(x04), .b(x01), .O(new_n41_));
  aoi21  g07(.a(new_n40_), .b(x04), .c(new_n41_), .O(new_n42_));
  inv1   g08(.a(x01), .O(new_n43_));
  inv1   g09(.a(x04), .O(new_n44_));
  nand3  g10(.a(x05), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  oai21  g11(.a(new_n42_), .b(new_n39_), .c(new_n45_), .O(z01));
  ...
  nor2   g18(.a(x04), .b(new_n43_), .O(new_n53_));
  ...
  inv1   g42(.a(new_n41_), .O(new_n77_));
  ...
  oai21  g57(.a(new_n87_), .b(new_n47_), .c(new_n91_), .O(new_n92_));
  ...
  nor2   g64(.a(new_n98_), .b(new_n47_), .O(new_n99_));
  aoi21  g65(.a(new_n90_), .b(x14), .c(new_n99_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n44_), .c(new_n54_), .O(z10));
  nor2   g67(.a(new_n53_), .b(new_n35_), .O(z11));
  aoi21  g68(.a(x16), .b(new_n35_), .c(x03), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n44_), .c(new_n54_), .O(z12));
  nand2  g70(.a(new_n44_), .b(new_n43_), .O(z13));
