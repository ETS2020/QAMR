...
module FAU ( 
  ...
  oai21  g01(.a(x15), .b(new_n35_), .c(x01), .O(new_n36_));
  oai21  g02(.a(x14), .b(x01), .c(new_n36_), .O(z00));
  inv1   g03(.a(x18), .O(new_n38_));
  nor2   g04(.a(new_n38_), .b(x15), .O(new_n39_));
  inv1   g05(.a(x04), .O(new_n40_));
  nand2  g06(.a(x15), .b(x01), .O(new_n41_));
  ...
  oai21  g24(.a(new_n40_), .b(x02), .c(new_n58_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x16), .O(new_n60_));
  nand3  g26(.a(x08), .b(x07), .c(x06), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x09), .O(new_n62_));
  inv1   g28(.a(x09), .O(new_n63_));
  nand3  g29(.a(new_n53_), .b(new_n63_), .c(x08), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n62_), .c(x04), .O(new_n65_));
  inv1   g31(.a(new_n65_), .O(new_n66_));
  aoi21  g32(.a(new_n66_), .b(new_n60_), .c(new_n42_), .O(z05));
  nor2   g33(.a(x10), .b(x09), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n53_), .c(x08), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x04), .O(new_n70_));
  aoi21  g36(.a(new_n64_), .b(x10), .c(new_n70_), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n60_), .c(new_n42_), .O(z06));
  aoi21  g38(.a(new_n59_), .b(x16), .c(new_n40_), .O(new_n73_));
  nand2  g39(.a(new_n69_), .b(x11), .O(new_n74_));
  inv1   g40(.a(x10), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  inv1   g42(.a(new_n61_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n63_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n74_), .c(new_n73_), .d(new_n41_), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n68_), .b(new_n77_), .c(new_n80_), .d(new_n76_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n78_), .b(x12), .c(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n60_), .c(new_n42_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n46_), .b(new_n85_), .c(new_n80_), .d(new_n76_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n63_), .c(x08), .d(x07), .O(new_n88_));
  nand2  g54(.a(x16), .b(new_n35_), .O(new_n89_));
  oai21  g55(.a(new_n88_), .b(new_n45_), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  aoi21  g57(.a(x16), .b(x03), .c(new_n40_), .O(new_n92_));
  nand2  g58(.a(new_n81_), .b(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n41_), .O(z09));
  inv1   g60(.a(x14), .O(new_n95_));
  inv1   g61(.a(x00), .O(new_n96_));
  nand4  g62(.a(new_n85_), .b(new_n80_), .c(new_n76_), .d(new_n75_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  and2   g64(.a(new_n98_), .b(new_n46_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n63_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n45_), .c(new_n46_), .d(new_n95_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n41_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z10));
  nor2   g69(.a(new_n42_), .b(new_n35_), .O(z11));
  nand2  g70(.a(new_n89_), .b(new_n58_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n41_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nand2  g73(.a(new_n41_), .b(new_n40_), .O(z13));
  nand3  g74(.a(new_n41_), .b(x17), .c(x04), .O(new_n109_));
