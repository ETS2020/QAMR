...
module FAU ( 
  ...
  aoi21  g23(.a(new_n36_), .b(new_n48_), .c(new_n57_), .O(new_n58_));
  nand3  g24(.a(new_n35_), .b(x07), .c(x06), .O(new_n59_));
  oai21  g25(.a(new_n58_), .b(new_n35_), .c(new_n59_), .O(new_n60_));
  nand3  g26(.a(new_n60_), .b(new_n50_), .c(x04), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(new_n53_), .O(z04));
  ...
  aoi22  g36(.a(new_n70_), .b(x09), .c(new_n69_), .d(x08), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n66_), .O(z05));
  nor2   g38(.a(new_n57_), .b(new_n48_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n73_), .b(new_n67_), .c(x08), .O(new_n78_));
  ...
  inv1   g48(.a(new_n70_), .O(new_n83_));
  nand4  g49(.a(new_n74_), .b(new_n83_), .c(new_n36_), .d(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n66_), .O(z07));
  nor3   g51(.a(x11), .b(x10), .c(x09), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n73_), .c(x17), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n35_), .c(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(new_n78_), .O(new_n90_));
  nor2   g56(.a(x11), .b(x10), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n36_), .d(new_n89_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n66_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n50_), .b(new_n36_), .c(new_n94_), .d(new_n89_), .O(new_n95_));
  nor3   g61(.a(new_n95_), .b(x11), .c(x10), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n67_), .c(x07), .d(x06), .O(new_n97_));
  oai21  g63(.a(new_n97_), .b(new_n45_), .c(new_n36_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(x08), .O(new_n99_));
  nand3  g65(.a(new_n74_), .b(new_n89_), .c(new_n82_), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(new_n70_), .c(x13), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(new_n66_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  inv1   g69(.a(new_n50_), .O(new_n104_));
  nand3  g70(.a(new_n91_), .b(new_n94_), .c(new_n89_), .O(new_n105_));
  ...
  nor2   g78(.a(new_n37_), .b(new_n38_), .O(z11));
  inv1   g79(.a(x03), .O(new_n114_));
  oai21  g80(.a(new_n63_), .b(x02), .c(new_n114_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n53_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n53_), .b(new_n45_), .O(z13));
