...
module FAU ( 
  ...
  oai21  g42(.a(new_n67_), .b(new_n48_), .c(new_n42_), .O(new_n77_));
  nand3  g43(.a(new_n59_), .b(new_n68_), .c(x08), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x10), .O(new_n79_));
  nor2   g45(.a(x10), .b(x09), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n59_), .c(x08), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n77_), .d(new_n42_), .O(z06));
  inv1   g48(.a(new_n67_), .O(new_n83_));
  inv1   g49(.a(x10), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nand4  g51(.a(new_n70_), .b(new_n85_), .c(new_n84_), .d(new_n68_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  aoi21  g53(.a(new_n81_), .b(x11), .c(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n83_), .c(new_n43_), .O(z07));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n80_), .b(new_n70_), .c(new_n90_), .d(new_n85_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  aoi21  g58(.a(new_n86_), .b(x12), .c(new_n92_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n83_), .c(new_n43_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n52_), .b(new_n95_), .c(new_n90_), .d(new_n85_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n84_), .c(new_n68_), .d(x08), .O(new_n98_));
  ...
  nand3  g67(.a(new_n101_), .b(new_n100_), .c(new_n77_), .O(z09));
  aoi21  g68(.a(new_n64_), .b(x02), .c(new_n65_), .O(new_n103_));
  nand4  g69(.a(new_n95_), .b(new_n90_), .c(new_n85_), .d(new_n84_), .O(new_n104_));
  ...
  nor2   g79(.a(new_n43_), .b(new_n48_), .O(z13));
  oai21  g80(.a(new_n41_), .b(new_n48_), .c(new_n42_), .O(z14));
endmodule
