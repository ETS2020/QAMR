...
module FAU ( 
  ...
  nor2   g10(.a(new_n36_), .b(x15), .O(new_n45_));
  ...
  nand2  g29(.a(x04), .b(new_n42_), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(new_n62_), .c(new_n63_), .O(new_n65_));
  oai21  g31(.a(new_n65_), .b(new_n46_), .c(new_n38_), .O(new_n66_));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n82_), .c(new_n37_), .O(z08));
  ...
  nand2  g57(.a(x16), .b(new_n42_), .O(new_n92_));
  ...
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n37_), .O(z09));
  ...
  oai22  g68(.a(new_n102_), .b(new_n49_), .c(new_n50_), .d(new_n40_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n38_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z10));
  nand2  g71(.a(new_n38_), .b(new_n42_), .O(z11));
  nand3  g72(.a(new_n38_), .b(x16), .c(new_n42_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n62_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n38_), .O(z12));
  nand2  g76(.a(new_n38_), .b(new_n46_), .O(z13));
  aoi21  g77(.a(new_n36_), .b(new_n46_), .c(new_n35_), .O(z14));
endmodule
