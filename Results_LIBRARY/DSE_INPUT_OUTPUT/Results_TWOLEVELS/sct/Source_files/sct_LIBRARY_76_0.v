...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n117_;
  nor2   g00(.a(x18), .b(x16), .O(new_n35_));
  ...
  nand2  g14(.a(x18), .b(new_n48_), .O(new_n49_));
  ...
  nand2  g37(.a(new_n70_), .b(x18), .O(new_n72_));
  ...
  nand2  g44(.a(new_n77_), .b(x18), .O(new_n79_));
  ...
  nand2  g53(.a(new_n86_), .b(x18), .O(new_n88_));
  ...
  aoi21  g59(.a(x18), .b(new_n42_), .c(new_n35_), .O(new_n94_));
  ...
  aoi21  g68(.a(new_n93_), .b(x13), .c(new_n35_), .O(new_n103_));
  ...
  nand2  g78(.a(new_n53_), .b(new_n36_), .O(z11));
