...
module FAU ( 
  ...
  nand2  g29(.a(new_n53_), .b(x02), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n43_), .c(x16), .O(new_n65_));
  nand3  g31(.a(x08), .b(x07), .c(x06), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x09), .O(new_n67_));
  nand2  g33(.a(new_n43_), .b(x01), .O(new_n68_));
  inv1   g34(.a(x09), .O(new_n69_));
  nand3  g35(.a(new_n59_), .b(new_n69_), .c(x08), .O(new_n70_));
  and2   g36(.a(new_n70_), .b(new_n46_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n65_), .O(z05));
  aoi21  g38(.a(new_n53_), .b(x02), .c(new_n43_), .O(new_n73_));
  ...
  nand2  g44(.a(new_n77_), .b(x01), .O(new_n79_));
  ...
  nand2  g53(.a(new_n86_), .b(x01), .O(new_n88_));
  ...
  nand3  g57(.a(new_n91_), .b(new_n68_), .c(new_n46_), .O(new_n92_));
  aoi21  g58(.a(new_n85_), .b(x12), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n65_), .O(z08));
  nand2  g60(.a(new_n46_), .b(new_n43_), .O(new_n95_));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n49_), .b(new_n96_), .c(new_n90_), .d(new_n83_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x10), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n69_), .c(x08), .d(x07), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n47_), .c(new_n49_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  aoi21  g67(.a(new_n91_), .b(x13), .c(new_n39_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n95_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand4  g70(.a(new_n96_), .b(new_n90_), .c(new_n83_), .d(new_n82_), .O(new_n105_));
  aoi22  g71(.a(new_n105_), .b(new_n104_), .c(new_n64_), .d(x16), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n69_), .c(x08), .d(x07), .O(new_n107_));
  oai22  g73(.a(new_n107_), .b(new_n47_), .c(new_n49_), .d(new_n36_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n46_), .O(z10));
  nand2  g76(.a(new_n46_), .b(new_n48_), .O(z11));
  nand2  g77(.a(new_n46_), .b(x03), .O(new_n112_));
  nand2  g78(.a(x16), .b(new_n48_), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(new_n112_), .c(new_n43_), .O(z12));
  nor2   g80(.a(new_n39_), .b(new_n43_), .O(z13));
