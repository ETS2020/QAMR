...
module FAU ( 
  ...
  inv1   g13(.a(new_n39_), .O(new_n48_));
  ...
  nand4  g20(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(x04), .O(new_n55_));
  ...
  nand2  g31(.a(x16), .b(new_n35_), .O(new_n66_));
  oai21  g32(.a(new_n65_), .b(new_n38_), .c(new_n66_), .O(new_n67_));
  ...
  nand2  g38(.a(x04), .b(new_n35_), .O(new_n73_));
  ...
  oai21  g44(.a(new_n78_), .b(new_n75_), .c(new_n38_), .O(new_n79_));
  oai21  g45(.a(new_n72_), .b(new_n63_), .c(new_n79_), .O(z05));
  nor2   g46(.a(new_n75_), .b(new_n44_), .O(new_n81_));
  nand2  g47(.a(new_n77_), .b(x10), .O(new_n82_));
  nor2   g48(.a(x10), .b(x09), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n58_), .c(x08), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n81_), .d(new_n48_), .O(z06));
  inv1   g51(.a(new_n75_), .O(new_n86_));
  ...
  aoi21  g57(.a(new_n84_), .b(x11), .c(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n86_), .c(new_n39_), .O(z07));
  nor2   g59(.a(x12), .b(x11), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n83_), .c(new_n89_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x04), .O(new_n96_));
  aoi21  g62(.a(new_n90_), .b(x12), .c(new_n96_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n86_), .c(new_n39_), .O(z08));
  nand2  g64(.a(new_n95_), .b(x13), .O(new_n99_));
  inv1   g65(.a(new_n77_), .O(new_n100_));
  nor2   g66(.a(x13), .b(x12), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n100_), .c(new_n88_), .d(new_n87_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n99_), .c(new_n81_), .d(new_n48_), .O(z09));
  nand4  g69(.a(new_n101_), .b(new_n88_), .c(new_n87_), .d(new_n38_), .O(new_n104_));
  oai21  g70(.a(new_n63_), .b(new_n38_), .c(new_n104_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n51_), .c(new_n76_), .d(x08), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(x07), .c(x06), .O(new_n108_));
  nand4  g74(.a(new_n50_), .b(new_n48_), .c(x16), .d(x14), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n44_), .O(z10));
  nor2   g76(.a(new_n39_), .b(new_n35_), .O(z11));
  nand2  g77(.a(new_n66_), .b(new_n49_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n48_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nor2   g80(.a(new_n39_), .b(new_n44_), .O(z13));
  nor2   g81(.a(new_n63_), .b(new_n44_), .O(z14));
endmodule
