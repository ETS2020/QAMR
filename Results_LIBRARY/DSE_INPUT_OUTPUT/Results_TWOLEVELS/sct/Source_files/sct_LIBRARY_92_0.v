...
module FAU ( 
  ...
  aoi21  g23(.a(new_n57_), .b(new_n55_), .c(new_n36_), .O(new_n58_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n64_), .O(new_n80_));
  ...
  inv1   g51(.a(new_n44_), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n48_), .b(new_n87_), .c(new_n83_), .d(new_n78_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(x10), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n64_), .c(x08), .d(x07), .O(new_n90_));
  aoi21  g56(.a(new_n84_), .b(x13), .c(new_n71_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n87_), .b(new_n83_), .c(new_n78_), .d(new_n77_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(x07), .c(x06), .O(new_n100_));
  nand2  g66(.a(new_n71_), .b(x14), .O(new_n101_));
