...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n64_, new_n66_, new_n68_, new_n72_, new_n73_, new_n75_;
  ...
  oai21  g20(.a(new_n42_), .b(x02), .c(new_n46_), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(x16), .c(x09), .O(new_n56_));
  oai21  g22(.a(new_n56_), .b(x06), .c(x04), .O(z05));
  inv1   g23(.a(x10), .O(new_n58_));
  aoi21  g24(.a(x16), .b(new_n35_), .c(x06), .O(new_n59_));
  nand3  g25(.a(x16), .b(new_n45_), .c(x03), .O(new_n60_));
  nand4  g26(.a(new_n60_), .b(new_n59_), .c(new_n58_), .d(x04), .O(z06));
  inv1   g27(.a(x11), .O(new_n62_));
  nand4  g28(.a(new_n60_), .b(new_n59_), .c(new_n62_), .d(x04), .O(z07));
  aoi21  g29(.a(new_n55_), .b(x16), .c(x12), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(x06), .c(x04), .O(z08));
  aoi21  g31(.a(new_n55_), .b(x16), .c(x13), .O(new_n66_));
  ...
  aoi21  g36(.a(new_n59_), .b(new_n46_), .c(new_n42_), .O(z12));
  nand2  g37(.a(x16), .b(x02), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(x02), .c(new_n45_), .O(new_n73_));
  nor2   g39(.a(new_n73_), .b(new_n42_), .O(z13));
  inv1   g40(.a(x17), .O(new_n75_));
  aoi21  g41(.a(new_n75_), .b(new_n45_), .c(new_n42_), .O(z14));
endmodule
