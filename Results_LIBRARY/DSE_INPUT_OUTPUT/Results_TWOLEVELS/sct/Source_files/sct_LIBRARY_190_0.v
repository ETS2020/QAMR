...
module FAU ( 
  ...
  nand3  g02(.a(x15), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  oai21  g03(.a(x02), .b(new_n35_), .c(new_n37_), .O(z00));
  inv1   g04(.a(x04), .O(new_n39_));
  nor2   g05(.a(x18), .b(x05), .O(new_n40_));
  aoi21  g06(.a(x05), .b(new_n39_), .c(new_n40_), .O(new_n41_));
  nand2  g07(.a(x05), .b(x04), .O(new_n42_));
  nand2  g08(.a(new_n42_), .b(x15), .O(new_n43_));
  oai21  g09(.a(new_n41_), .b(new_n35_), .c(new_n43_), .O(z01));
  inv1   g10(.a(x06), .O(new_n45_));
  inv1   g11(.a(x02), .O(new_n46_));
  oai21  g12(.a(x03), .b(new_n46_), .c(x16), .O(new_n47_));
  nor2   g13(.a(x15), .b(x01), .O(new_n48_));
  ...
  aoi21  g28(.a(new_n62_), .b(x16), .c(new_n39_), .O(new_n63_));
  ...
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(new_n49_), .O(z05));
  nand2  g34(.a(new_n62_), .b(x16), .O(new_n69_));
  nor2   g35(.a(x10), .b(x09), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n56_), .c(x08), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x04), .O(new_n72_));
  aoi21  g38(.a(new_n67_), .b(x10), .c(new_n72_), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(new_n69_), .c(new_n48_), .O(z06));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n69_), .c(new_n48_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n69_), .c(new_n48_), .O(z08));
  ...
  nand2  g56(.a(x16), .b(new_n46_), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n45_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  aoi21  g59(.a(x16), .b(x03), .c(new_n39_), .O(new_n94_));
  nand2  g60(.a(new_n83_), .b(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n49_), .O(z09));
  ...
  and2   g65(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n66_), .c(x08), .d(x07), .O(new_n101_));
  oai22  g67(.a(new_n101_), .b(new_n45_), .c(new_n47_), .d(new_n36_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n49_), .c(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z10));
  nand2  g70(.a(new_n49_), .b(new_n46_), .O(z11));
  nand3  g71(.a(new_n49_), .b(x16), .c(new_n46_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n61_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n49_), .O(z12));
  nor2   g75(.a(new_n48_), .b(new_n39_), .O(z13));
