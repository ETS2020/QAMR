...
module FAU ( 
  ...
  aoi21  g09(.a(new_n35_), .b(x05), .c(x15), .O(new_n44_));
  inv1   g10(.a(x18), .O(new_n45_));
  aoi21  g11(.a(new_n45_), .b(new_n35_), .c(x15), .O(new_n46_));
  oai22  g12(.a(new_n46_), .b(x05), .c(new_n44_), .d(x04), .O(z01));
  ...
  nand4  g24(.a(new_n58_), .b(new_n49_), .c(new_n37_), .d(x04), .O(new_n59_));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n65_), .c(new_n36_), .O(z05));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n65_), .c(new_n36_), .O(z06));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n65_), .c(new_n36_), .O(z07));
  inv1   g50(.a(x04), .O(new_n85_));
  nor2   g51(.a(new_n64_), .b(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n81_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n73_), .b(new_n80_), .c(new_n88_), .d(new_n79_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(new_n37_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n49_), .b(new_n91_), .c(new_n88_), .d(new_n79_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(x10), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n68_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(x16), .b(new_n41_), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n48_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  aoi21  g63(.a(x16), .b(x03), .c(new_n85_), .O(new_n98_));
  nand2  g64(.a(new_n89_), .b(x13), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n37_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand4  g67(.a(new_n91_), .b(new_n88_), .c(new_n79_), .d(new_n78_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  and2   g69(.a(new_n103_), .b(new_n49_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n68_), .c(x08), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n48_), .c(new_n49_), .d(new_n39_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n37_), .c(x04), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(z10));
  nor2   g74(.a(new_n36_), .b(new_n41_), .O(z11));
  nand2  g75(.a(new_n95_), .b(new_n61_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(new_n37_), .c(x04), .O(new_n111_));
  inv1   g77(.a(new_n111_), .O(z12));
  nand2  g78(.a(new_n37_), .b(new_n85_), .O(z13));
  aoi21  g79(.a(x15), .b(new_n85_), .c(new_n35_), .O(z14));
endmodule
