...
module FAU ( 
  ...
  aoi21  g34(.a(new_n68_), .b(new_n62_), .c(new_n59_), .O(z05));
  aoi21  g35(.a(new_n61_), .b(x16), .c(new_n41_), .O(new_n70_));
  nand2  g36(.a(new_n66_), .b(x10), .O(new_n71_));
  nor2   g37(.a(x10), .b(x09), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n54_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n70_), .d(new_n44_), .O(z06));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n62_), .c(new_n59_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n62_), .c(new_n59_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n47_), .b(new_n87_), .c(new_n82_), .d(new_n76_), .O(new_n88_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n44_), .O(z09));
  inv1   g62(.a(x14), .O(new_n97_));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n87_), .b(new_n82_), .c(new_n76_), .d(new_n75_), .O(new_n99_));
  ...
  nand3  g69(.a(new_n103_), .b(new_n44_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z10));
  nor2   g71(.a(new_n59_), .b(new_n35_), .O(z11));
  ...
  oai21  g76(.a(new_n43_), .b(new_n41_), .c(new_n44_), .O(z14));
endmodule
