...
module FAU ( 
  ...
  inv1   g001(.a(x18), .O(new_n36_));
  nor2   g002(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  inv1   g003(.a(new_n37_), .O(new_n38_));
  inv1   g004(.a(x01), .O(new_n39_));
  inv1   g005(.a(x14), .O(new_n40_));
  nand2  g006(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  inv1   g007(.a(x02), .O(new_n42_));
  nand2  g008(.a(new_n42_), .b(x01), .O(new_n43_));
  nand3  g009(.a(new_n43_), .b(new_n41_), .c(new_n38_), .O(z00));
  nor2   g010(.a(new_n36_), .b(x15), .O(new_n45_));
  inv1   g011(.a(x04), .O(new_n46_));
  aoi21  g012(.a(x05), .b(new_n46_), .c(new_n37_), .O(new_n47_));
  oai21  g013(.a(new_n45_), .b(x05), .c(new_n47_), .O(z01));
  inv1   g014(.a(x06), .O(new_n49_));
  nand2  g015(.a(x18), .b(x13), .O(new_n50_));
  oai21  g016(.a(x03), .b(new_n42_), .c(x16), .O(new_n51_));
  ...
  nand3  g021(.a(new_n38_), .b(x07), .c(new_n49_), .O(new_n56_));
  ...
  nand2  g030(.a(new_n64_), .b(new_n38_), .O(z04));
  aoi21  g031(.a(x16), .b(new_n42_), .c(new_n46_), .O(new_n66_));
  inv1   g032(.a(new_n66_), .O(new_n67_));
  nand2  g033(.a(new_n67_), .b(new_n38_), .O(new_n68_));
  oai21  g034(.a(x18), .b(new_n46_), .c(x13), .O(new_n69_));
  ...
  nor2   g041(.a(new_n75_), .b(new_n37_), .O(new_n76_));
  ...
  nand2  g045(.a(new_n79_), .b(new_n38_), .O(new_n80_));
  inv1   g046(.a(x09), .O(new_n81_));
  oai21  g047(.a(x12), .b(x11), .c(new_n35_), .O(new_n82_));
  nand3  g048(.a(new_n82_), .b(new_n36_), .c(x04), .O(new_n83_));
  ...
  oai21  g058(.a(new_n92_), .b(new_n67_), .c(new_n38_), .O(new_n93_));
  nand2  g059(.a(new_n35_), .b(x12), .O(new_n94_));
  nand3  g060(.a(new_n94_), .b(new_n36_), .c(x04), .O(new_n95_));
  ...
  aoi21  g067(.a(new_n101_), .b(x18), .c(x12), .O(new_n102_));
  ...
  aoi21  g074(.a(new_n108_), .b(x12), .c(new_n37_), .O(new_n109_));
  ...
  nor2   g078(.a(x18), .b(new_n35_), .O(new_n113_));
  nand2  g079(.a(new_n113_), .b(new_n54_), .O(new_n114_));
  aoi21  g080(.a(new_n114_), .b(new_n112_), .c(new_n49_), .O(new_n115_));
  nand2  g081(.a(new_n113_), .b(new_n49_), .O(new_n116_));
  inv1   g082(.a(new_n116_), .O(new_n117_));
  oai21  g083(.a(new_n117_), .b(new_n115_), .c(new_n51_), .O(new_n118_));
  inv1   g084(.a(x12), .O(new_n119_));
  aoi21  g085(.a(new_n119_), .b(new_n89_), .c(x10), .O(new_n120_));
  nand4  g086(.a(new_n120_), .b(x08), .c(x07), .d(x06), .O(new_n121_));
  nand4  g087(.a(new_n121_), .b(new_n78_), .c(new_n81_), .d(x08), .O(new_n122_));
  nand3  g088(.a(new_n122_), .b(new_n36_), .c(x13), .O(new_n123_));
  nand2  g089(.a(new_n123_), .b(new_n118_), .O(new_n124_));
  nand2  g090(.a(new_n124_), .b(x04), .O(new_n125_));
  nand4  g091(.a(new_n125_), .b(new_n70_), .c(new_n66_), .d(new_n38_), .O(z09));
  inv1   g092(.a(x00), .O(new_n127_));
  inv1   g093(.a(x03), .O(new_n128_));
  inv1   g094(.a(x16), .O(new_n129_));
  aoi21  g095(.a(new_n128_), .b(x02), .c(new_n129_), .O(new_n130_));
  nor2   g096(.a(new_n130_), .b(x09), .O(new_n131_));
  nand4  g097(.a(new_n131_), .b(x08), .c(x07), .d(x06), .O(new_n132_));
  oai22  g098(.a(new_n132_), .b(new_n127_), .c(new_n51_), .d(new_n40_), .O(new_n133_));
  nand2  g099(.a(new_n133_), .b(new_n38_), .O(new_n134_));
  nand4  g100(.a(new_n51_), .b(new_n35_), .c(new_n119_), .d(new_n89_), .O(new_n135_));
  nor3   g101(.a(new_n135_), .b(x10), .c(x09), .O(new_n136_));
  nand4  g102(.a(new_n136_), .b(x08), .c(x07), .d(x06), .O(new_n137_));
  aoi21  g103(.a(new_n137_), .b(new_n134_), .c(new_n46_), .O(z10));
  nand2  g104(.a(new_n38_), .b(new_n42_), .O(z11));
  nand3  g105(.a(new_n38_), .b(x16), .c(new_n42_), .O(new_n140_));
  nand2  g106(.a(new_n140_), .b(new_n128_), .O(new_n141_));
  nand2  g107(.a(new_n141_), .b(x04), .O(new_n142_));
  nand2  g108(.a(new_n142_), .b(new_n38_), .O(z12));
  aoi21  g109(.a(x07), .b(x06), .c(new_n130_), .O(new_n144_));
  oai21  g110(.a(new_n144_), .b(new_n122_), .c(x13), .O(new_n145_));
  nand4  g111(.a(new_n119_), .b(new_n89_), .c(new_n78_), .d(new_n81_), .O(new_n146_));
  inv1   g112(.a(new_n146_), .O(new_n147_));
  aoi21  g113(.a(new_n147_), .b(new_n106_), .c(new_n130_), .O(new_n148_));
  nand2  g114(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g115(.a(new_n149_), .b(new_n36_), .O(new_n150_));
  aoi21  g116(.a(new_n150_), .b(x13), .c(new_n46_), .O(z13));
  nand2  g117(.a(x17), .b(x04), .O(new_n152_));
  nand2  g118(.a(new_n152_), .b(new_n38_), .O(z14));
endmodule
