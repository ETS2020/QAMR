...
module FAU ( 
  ...
  oai21  g28(.a(new_n43_), .b(x02), .c(new_n48_), .O(new_n63_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n64_), .c(new_n39_), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n66_), .d(new_n47_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n66_), .d(new_n47_), .O(z08));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n64_), .c(new_n39_), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  aoi21  g58(.a(new_n88_), .b(new_n92_), .c(new_n50_), .O(new_n93_));
  ...
  nor2   g64(.a(new_n39_), .b(new_n36_), .O(z11));
  oai21  g65(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n47_), .c(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z12));
  nand2  g68(.a(new_n47_), .b(new_n43_), .O(z13));
