...
module FAU ( 
  ...
  oai21  g02(.a(new_n36_), .b(x09), .c(new_n35_), .O(new_n37_));
  oai21  g03(.a(x02), .b(new_n35_), .c(new_n37_), .O(z00));
  inv1   g04(.a(x18), .O(new_n39_));
  nor2   g05(.a(new_n39_), .b(x15), .O(new_n40_));
  inv1   g06(.a(x04), .O(new_n41_));
  inv1   g07(.a(x09), .O(new_n42_));
  ...
  nand2  g30(.a(new_n64_), .b(new_n46_), .O(z04));
  ...
  nand4  g35(.a(new_n49_), .b(x07), .c(new_n47_), .d(x04), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(x08), .c(x07), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(x09), .c(x01), .O(new_n72_));
  nand3  g38(.a(new_n61_), .b(new_n42_), .c(x08), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n69_), .O(z05));
  oai21  g40(.a(x10), .b(new_n35_), .c(x09), .O(new_n75_));
  nand3  g41(.a(x08), .b(x07), .c(x06), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x10), .O(new_n77_));
  inv1   g43(.a(x10), .O(new_n78_));
  nand4  g44(.a(new_n61_), .b(new_n78_), .c(new_n42_), .d(x08), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n69_), .O(z06));
  inv1   g46(.a(x11), .O(new_n81_));
  nor2   g47(.a(x10), .b(new_n60_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n61_), .c(new_n81_), .O(new_n83_));
  nand3  g49(.a(new_n81_), .b(new_n78_), .c(x08), .O(new_n84_));
  nor3   g50(.a(new_n84_), .b(new_n52_), .c(new_n47_), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n83_), .c(new_n42_), .O(new_n86_));
  nand3  g52(.a(x11), .b(x09), .c(x01), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n69_), .O(z07));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(new_n76_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n81_), .d(new_n78_), .O(new_n91_));
  oai21  g57(.a(new_n85_), .b(new_n89_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n42_), .O(new_n93_));
  nand3  g59(.a(x12), .b(x09), .c(x01), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n93_), .c(new_n69_), .O(z08));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n49_), .b(new_n96_), .c(new_n89_), .d(new_n81_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n78_), .c(new_n42_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(x07), .c(x06), .d(x04), .O(new_n101_));
  aoi21  g67(.a(new_n96_), .b(x01), .c(new_n42_), .O(new_n102_));
  aoi21  g68(.a(new_n91_), .b(x13), .c(new_n102_), .O(new_n103_));
  ...
  nand4  g73(.a(new_n96_), .b(new_n89_), .c(new_n81_), .d(new_n78_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n105_), .c(new_n107_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n42_), .c(x08), .d(x07), .O(new_n110_));
  oai22  g76(.a(new_n110_), .b(new_n47_), .c(new_n49_), .d(new_n36_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n46_), .O(z10));
  nand2  g79(.a(new_n46_), .b(new_n48_), .O(z11));
  oai21  g80(.a(new_n66_), .b(x02), .c(new_n106_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n46_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nor2   g83(.a(new_n43_), .b(new_n41_), .O(z13));
  inv1   g84(.a(x17), .O(new_n119_));
  nor3   g85(.a(new_n43_), .b(new_n119_), .c(new_n41_), .O(z14));
endmodule
