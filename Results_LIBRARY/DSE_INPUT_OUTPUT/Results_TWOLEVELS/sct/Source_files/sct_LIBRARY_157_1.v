...
module FAU ( 
  ...
  nand3  g19(.a(x15), .b(new_n53_), .c(x02), .O(new_n54_));
  ...
  oai21  g36(.a(new_n70_), .b(x02), .c(new_n53_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(x16), .c(x15), .O(new_n72_));
  ...
  aoi21  g42(.a(new_n67_), .b(x10), .c(new_n76_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n36_), .c(new_n72_), .O(z06));
  nand2  g44(.a(new_n75_), .b(x11), .O(new_n79_));
  nor4   g45(.a(new_n64_), .b(x11), .c(x10), .d(x09), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n37_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n72_), .O(z07));
  ...
  nand4  g54(.a(new_n74_), .b(new_n88_), .c(new_n85_), .d(new_n87_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n86_), .c(new_n37_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n72_), .O(z08));
  nand2  g58(.a(new_n37_), .b(new_n70_), .O(z13));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n49_), .b(new_n94_), .c(new_n85_), .d(new_n87_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x10), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n66_), .c(x08), .d(x07), .O(new_n97_));
  nand3  g63(.a(x16), .b(x15), .c(new_n41_), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n48_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  aoi21  g66(.a(x15), .b(new_n53_), .c(new_n35_), .O(new_n101_));
  aoi21  g67(.a(new_n89_), .b(x13), .c(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n100_), .c(z13), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  aoi21  g70(.a(new_n53_), .b(x02), .c(new_n35_), .O(new_n105_));
  inv1   g71(.a(x10), .O(new_n106_));
  nand4  g72(.a(new_n94_), .b(new_n85_), .c(new_n87_), .d(new_n106_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n104_), .c(new_n105_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n66_), .c(x08), .d(x07), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n48_), .c(new_n49_), .d(new_n39_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n37_), .O(z10));
  nor2   g78(.a(new_n36_), .b(new_n41_), .O(z11));
  nand2  g79(.a(new_n98_), .b(new_n53_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n37_), .O(z12));
  inv1   g82(.a(x17), .O(new_n117_));
  nor3   g83(.a(new_n36_), .b(new_n117_), .c(new_n70_), .O(z14));
endmodule
