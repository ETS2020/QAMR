...
module FAU ( 
  ...
  nand2  g04(.a(x01), .b(new_n35_), .O(new_n39_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n66_), .d(new_n39_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n66_), .d(new_n39_), .O(z08));
  ...
  aoi21  g56(.a(new_n90_), .b(new_n64_), .c(new_n40_), .O(z09));
  ...
  nand2  g62(.a(new_n96_), .b(new_n39_), .O(z10));
  nor2   g63(.a(new_n40_), .b(new_n36_), .O(z11));
  oai21  g64(.a(new_n49_), .b(x02), .c(new_n48_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n39_), .c(x04), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(z12));
  nand2  g67(.a(new_n39_), .b(new_n44_), .O(z13));
