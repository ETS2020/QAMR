...
module FAU ( 
  ...
  nand2  g23(.a(new_n57_), .b(new_n38_), .O(z04));
  ...
  oai21  g30(.a(new_n63_), .b(new_n59_), .c(new_n64_), .O(new_n65_));
  ...
  nand2  g37(.a(new_n71_), .b(new_n60_), .O(new_n72_));
  and2   g38(.a(new_n72_), .b(x16), .O(new_n73_));
  inv1   g39(.a(x09), .O(new_n74_));
  nand3  g40(.a(new_n54_), .b(new_n74_), .c(x08), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n67_), .c(x04), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n73_), .c(new_n59_), .O(new_n77_));
  oai21  g43(.a(new_n70_), .b(x01), .c(new_n77_), .O(z05));
  oai21  g44(.a(new_n73_), .b(new_n43_), .c(new_n38_), .O(new_n79_));
  nand2  g45(.a(new_n75_), .b(x10), .O(new_n80_));
  nor2   g46(.a(x10), .b(x09), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n54_), .c(x08), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n38_), .O(z06));
  ...
  nand4  g54(.a(new_n88_), .b(new_n84_), .c(new_n79_), .d(new_n38_), .O(z07));
  inv1   g55(.a(new_n73_), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand4  g57(.a(new_n81_), .b(new_n87_), .c(new_n91_), .d(new_n86_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  aoi21  g59(.a(new_n88_), .b(x12), .c(new_n93_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n90_), .c(new_n39_), .O(z08));
  inv1   g61(.a(x13), .O(new_n96_));
  nand4  g62(.a(new_n47_), .b(new_n96_), .c(new_n91_), .d(new_n86_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n85_), .c(new_n74_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(x07), .c(x06), .d(x04), .O(new_n101_));
  aoi21  g67(.a(new_n92_), .b(x13), .c(new_n39_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n79_), .O(z09));
  inv1   g69(.a(x14), .O(new_n104_));
  inv1   g70(.a(x01), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x00), .O(new_n106_));
  nand4  g72(.a(new_n96_), .b(new_n91_), .c(new_n86_), .d(new_n85_), .O(new_n107_));
  aoi22  g73(.a(new_n107_), .b(new_n106_), .c(new_n61_), .d(x16), .O(new_n108_));
  ...
  nand2  g78(.a(new_n38_), .b(new_n35_), .O(z11));
  nand3  g79(.a(new_n38_), .b(x16), .c(new_n35_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n60_), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n38_), .O(z12));
  nand2  g83(.a(new_n38_), .b(new_n43_), .O(z13));
