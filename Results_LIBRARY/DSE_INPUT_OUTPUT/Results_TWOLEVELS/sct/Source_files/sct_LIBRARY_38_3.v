...
module FAU ( 
  ...
  oai21  g16(.a(new_n50_), .b(x02), .c(new_n35_), .O(new_n51_));
  nand2  g17(.a(new_n36_), .b(new_n50_), .O(new_n52_));
  ...
  oai21  g24(.a(x03), .b(new_n40_), .c(x16), .O(new_n59_));
  ...
  nand3  g37(.a(x04), .b(new_n35_), .c(new_n40_), .O(new_n72_));
  nand2  g38(.a(new_n36_), .b(x03), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x16), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n71_), .O(z05));
  nor2   g42(.a(x10), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n61_), .c(x08), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x04), .O(new_n79_));
  aoi21  g45(.a(new_n69_), .b(x10), .c(new_n79_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n37_), .c(new_n75_), .O(z06));
  ...
  aoi21  g52(.a(new_n78_), .b(x11), .c(new_n86_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n37_), .c(new_n75_), .O(z07));
  oai21  g54(.a(x17), .b(x16), .c(x03), .O(new_n89_));
  oai21  g55(.a(new_n50_), .b(x02), .c(x04), .O(new_n90_));
  ...
  nand4  g60(.a(new_n77_), .b(new_n83_), .c(new_n94_), .d(new_n93_), .O(new_n95_));
  nand2  g61(.a(new_n36_), .b(new_n46_), .O(new_n96_));
  and2   g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n92_), .c(new_n91_), .d(new_n89_), .O(z08));
  nand4  g64(.a(new_n68_), .b(x07), .c(x06), .d(x04), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n84_), .b(new_n50_), .c(new_n100_), .d(new_n94_), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n99_), .c(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n38_), .O(new_n103_));
  nand4  g69(.a(x08), .b(x07), .c(x06), .d(x02), .O(new_n104_));
  nand4  g70(.a(new_n77_), .b(new_n100_), .c(new_n94_), .d(new_n93_), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n104_), .c(new_n50_), .d(x02), .O(new_n106_));
  ...
  nand3  g76(.a(new_n84_), .b(new_n100_), .c(new_n94_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g78(.a(new_n112_), .b(new_n53_), .c(new_n82_), .d(x08), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(x07), .c(x06), .O(new_n115_));
  oai21  g81(.a(x03), .b(x02), .c(new_n73_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(x16), .c(x14), .O(new_n117_));
  aoi21  g83(.a(new_n117_), .b(new_n115_), .c(new_n46_), .O(z10));
  nor2   g84(.a(new_n37_), .b(new_n40_), .O(z11));
  nand3  g85(.a(x16), .b(new_n35_), .c(new_n40_), .O(new_n120_));
  aoi21  g86(.a(new_n120_), .b(new_n73_), .c(new_n46_), .O(z12));
  aoi21  g87(.a(x17), .b(x03), .c(new_n46_), .O(z13));
  aoi21  g88(.a(new_n46_), .b(new_n35_), .c(new_n36_), .O(z14));
endmodule
