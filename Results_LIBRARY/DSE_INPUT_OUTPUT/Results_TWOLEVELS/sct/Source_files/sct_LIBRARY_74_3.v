...
module FAU ( 
  ...
  nand2  g22(.a(new_n56_), .b(new_n43_), .O(z04));
  inv1   g23(.a(x16), .O(new_n58_));
  aoi21  g24(.a(x04), .b(new_n35_), .c(x03), .O(new_n59_));
  oai21  g25(.a(new_n59_), .b(new_n58_), .c(x04), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n43_), .O(new_n61_));
  inv1   g27(.a(x01), .O(new_n62_));
  inv1   g28(.a(x09), .O(new_n63_));
  nand2  g29(.a(x08), .b(x07), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  nand3  g31(.a(new_n53_), .b(new_n63_), .c(x08), .O(new_n66_));
  oai21  g32(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(new_n67_));
  aoi22  g33(.a(new_n67_), .b(new_n62_), .c(x09), .d(new_n45_), .O(new_n68_));
  ...
  nand3  g39(.a(new_n73_), .b(new_n53_), .c(x08), .O(new_n74_));
  oai21  g40(.a(new_n72_), .b(new_n70_), .c(new_n74_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n62_), .O(new_n76_));
  nand2  g42(.a(x10), .b(new_n45_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n61_), .O(z06));
  inv1   g44(.a(x11), .O(new_n79_));
  aoi21  g45(.a(new_n73_), .b(new_n65_), .c(new_n79_), .O(new_n80_));
  nand2  g46(.a(new_n79_), .b(new_n70_), .O(new_n81_));
  inv1   g47(.a(new_n81_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n65_), .c(new_n63_), .d(x06), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n80_), .c(new_n62_), .O(new_n85_));
  nand2  g51(.a(x11), .b(new_n45_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n85_), .c(new_n61_), .O(z07));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n72_), .b(new_n88_), .c(new_n79_), .d(new_n70_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n62_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x06), .O(new_n91_));
  nand2  g57(.a(new_n83_), .b(x12), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n61_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n46_), .b(new_n94_), .c(new_n88_), .d(new_n79_), .O(new_n95_));
  ...
  nand2  g65(.a(new_n99_), .b(new_n62_), .O(new_n100_));
  nand2  g66(.a(x13), .b(new_n45_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n100_), .c(new_n61_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  inv1   g69(.a(new_n46_), .O(new_n104_));
  nand3  g70(.a(new_n82_), .b(new_n94_), .c(new_n88_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n103_), .c(new_n104_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n63_), .c(x08), .d(x07), .O(new_n107_));
  nand2  g73(.a(new_n104_), .b(x14), .O(new_n108_));
  oai21  g74(.a(new_n107_), .b(new_n45_), .c(new_n108_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n62_), .O(new_n110_));
  nand3  g76(.a(new_n104_), .b(x14), .c(new_n45_), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n41_), .O(z10));
  nand2  g78(.a(new_n43_), .b(new_n35_), .O(z11));
  inv1   g79(.a(x03), .O(new_n114_));
  oai21  g80(.a(new_n58_), .b(x02), .c(new_n114_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n43_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n43_), .b(new_n41_), .O(z13));
  nand2  g84(.a(x17), .b(x04), .O(new_n119_));
  nand2  g85(.a(new_n119_), .b(new_n43_), .O(z14));
endmodule
