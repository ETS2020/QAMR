...
module FAU ( 
  ...
  nand4  g35(.a(new_n58_), .b(new_n69_), .c(new_n65_), .d(x08), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n54_), .d(x04), .O(z06));
  nand2  g37(.a(x08), .b(x07), .O(new_n72_));
  nor2   g38(.a(x11), .b(x10), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n65_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n72_), .c(x04), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(x06), .O(new_n76_));
  aoi21  g42(.a(new_n48_), .b(x02), .c(new_n50_), .O(new_n77_));
  aoi21  g43(.a(new_n70_), .b(x11), .c(new_n77_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n41_), .c(new_n76_), .O(z07));
  ...
  or2    g51(.a(new_n74_), .b(new_n63_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(x12), .c(new_n77_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n41_), .c(new_n85_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n54_), .b(new_n89_), .c(new_n82_), .d(new_n81_), .O(new_n90_));
  nor3   g56(.a(new_n90_), .b(x10), .c(x09), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(x08), .c(x07), .d(x06), .O(new_n92_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n69_), .d(new_n65_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n63_), .c(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n92_), .c(new_n54_), .d(x04), .O(z09));
  inv1   g61(.a(new_n35_), .O(new_n96_));
  inv1   g62(.a(x00), .O(new_n97_));
  nand3  g63(.a(new_n73_), .b(new_n89_), .c(new_n82_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n77_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n65_), .c(x08), .d(x07), .O(new_n100_));
  nand2  g66(.a(new_n77_), .b(x14), .O(new_n101_));
  oai21  g67(.a(new_n100_), .b(new_n43_), .c(new_n101_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n96_), .O(z10));
  nor2   g70(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n36_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n41_), .c(new_n96_), .O(z12));
  nand2  g73(.a(x06), .b(new_n41_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n96_), .O(z14));
endmodule
