...
module FAU ( 
  ...
  inv1   g07(.a(x00), .O(new_n42_));
  nor2   g08(.a(x01), .b(new_n42_), .O(new_n43_));
  ...
  oai21  g30(.a(new_n64_), .b(new_n41_), .c(new_n47_), .O(new_n65_));
  ...
  nand3  g53(.a(new_n49_), .b(x04), .c(new_n42_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n35_), .c(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n90_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n77_), .c(new_n76_), .d(new_n42_), .O(new_n95_));
  oai21  g61(.a(new_n35_), .b(new_n42_), .c(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n49_), .c(new_n68_), .d(x08), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(x07), .c(x06), .O(new_n99_));
  nand2  g65(.a(new_n61_), .b(x02), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n47_), .c(x16), .d(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n41_), .O(z10));
  nand2  g68(.a(new_n47_), .b(new_n48_), .O(z11));
  oai21  g69(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n47_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z12));
  nor2   g72(.a(new_n43_), .b(new_n41_), .O(z13));
  nand2  g73(.a(x17), .b(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n47_), .O(z14));
endmodule
