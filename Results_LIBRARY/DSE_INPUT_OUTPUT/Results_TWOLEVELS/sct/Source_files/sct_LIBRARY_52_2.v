...
module FAU ( 
  ...
  nand3  g54(.a(new_n49_), .b(x04), .c(new_n38_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(x13), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n91_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n77_), .c(new_n76_), .d(new_n38_), .O(new_n96_));
  oai21  g62(.a(new_n88_), .b(new_n38_), .c(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n49_), .c(new_n68_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(x07), .c(x06), .O(new_n100_));
  nand2  g66(.a(new_n61_), .b(x02), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n47_), .c(x16), .d(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n44_), .O(z10));
  nor2   g69(.a(new_n39_), .b(new_n35_), .O(z11));
  oai21  g70(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n47_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nor2   g73(.a(new_n39_), .b(new_n44_), .O(z13));
  nor2   g74(.a(new_n88_), .b(new_n44_), .O(z14));
endmodule
