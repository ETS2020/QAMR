...
module FAU ( 
  ...
  nand4  g68(.a(new_n102_), .b(new_n83_), .c(new_n82_), .d(x01), .O(new_n103_));
  aoi22  g69(.a(new_n103_), .b(new_n94_), .c(new_n101_), .d(x16), .O(new_n104_));
  ...
  nor2   g74(.a(new_n39_), .b(new_n48_), .O(z11));
  nand3  g75(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n61_), .O(new_n111_));
