...
module FAU ( 
  ...
  nand2  g04(.a(new_n38_), .b(x00), .O(new_n39_));
  ...
  nand2  g11(.a(new_n45_), .b(x15), .O(new_n46_));
  oai21  g12(.a(new_n44_), .b(x00), .c(new_n46_), .O(z01));
  ...
  oai21  g28(.a(new_n42_), .b(x02), .c(new_n49_), .O(new_n63_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(new_n39_), .O(z05));
  nand2  g37(.a(new_n70_), .b(x10), .O(new_n72_));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n58_), .c(x08), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n66_), .d(new_n39_), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n66_), .d(new_n39_), .O(z07));
  nor2   g46(.a(x12), .b(x11), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n73_), .c(new_n77_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  aoi21  g49(.a(new_n79_), .b(x12), .c(new_n83_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n64_), .c(new_n40_), .O(z08));
  nand2  g51(.a(new_n82_), .b(x13), .O(new_n86_));
  inv1   g52(.a(new_n70_), .O(new_n87_));
  nor2   g53(.a(x13), .b(x12), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n78_), .c(new_n87_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n66_), .d(new_n39_), .O(z09));
  inv1   g56(.a(x11), .O(new_n91_));
  nor2   g57(.a(x10), .b(x00), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n91_), .O(new_n93_));
  nand2  g59(.a(x15), .b(x00), .O(new_n94_));
  ...
  nand4  g64(.a(new_n50_), .b(new_n39_), .c(x16), .d(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n42_), .O(z10));
  nor2   g66(.a(new_n40_), .b(new_n35_), .O(z11));
  ...
  nand2  g73(.a(new_n107_), .b(new_n39_), .O(z14));
endmodule
