...
module FAU ( 
  ...
  oai21  g37(.a(new_n44_), .b(x02), .c(new_n48_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x16), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n71_), .O(z05));
  nand2  g40(.a(new_n53_), .b(new_n44_), .O(z13));
  ...
  and2   g52(.a(new_n86_), .b(new_n53_), .O(new_n87_));
  ...
  aoi21  g71(.a(new_n48_), .b(x02), .c(new_n37_), .O(new_n106_));
  ...
  oai22  g75(.a(new_n109_), .b(new_n47_), .c(new_n56_), .d(new_n36_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n53_), .O(z10));
  nor2   g78(.a(new_n40_), .b(new_n55_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n55_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n44_), .c(new_n53_), .O(z12));
  nand2  g81(.a(x17), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n53_), .O(z14));
endmodule
