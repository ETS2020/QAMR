...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n64_, new_n66_, new_n68_, new_n71_, new_n73_, new_n74_, new_n76_;
  ...
  oai21  g22(.a(new_n42_), .b(x02), .c(new_n45_), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(x16), .O(new_n58_));
  nand4  g24(.a(new_n58_), .b(new_n56_), .c(new_n50_), .d(x04), .O(z05));
  aoi21  g25(.a(new_n57_), .b(x16), .c(x10), .O(new_n60_));
  oai21  g26(.a(new_n60_), .b(x06), .c(x04), .O(z06));
  aoi21  g27(.a(new_n57_), .b(x16), .c(x11), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(x06), .c(x04), .O(z07));
  inv1   g29(.a(x12), .O(new_n64_));
  nand4  g30(.a(new_n58_), .b(new_n64_), .c(new_n50_), .d(x04), .O(z08));
  aoi21  g31(.a(new_n57_), .b(x16), .c(x13), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(x06), .c(x04), .O(z09));
  nand4  g33(.a(new_n46_), .b(x16), .c(x14), .d(new_n50_), .O(new_n68_));
  nor2   g34(.a(new_n68_), .b(new_n42_), .O(z10));
  aoi21  g35(.a(x06), .b(x04), .c(new_n35_), .O(z11));
  aoi21  g36(.a(x16), .b(new_n35_), .c(x06), .O(new_n71_));
  aoi21  g37(.a(new_n71_), .b(new_n45_), .c(new_n42_), .O(z12));
  nand2  g38(.a(x16), .b(x02), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(x02), .c(new_n50_), .O(new_n74_));
  nor2   g40(.a(new_n74_), .b(new_n42_), .O(z13));
  inv1   g41(.a(x17), .O(new_n76_));
  aoi21  g42(.a(new_n76_), .b(new_n50_), .c(new_n42_), .O(z14));
endmodule
