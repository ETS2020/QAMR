...
module FAU ( 
  ...
  nor3   g33(.a(new_n49_), .b(new_n44_), .c(x02), .O(new_n68_));
  ...
  oai21  g38(.a(new_n39_), .b(new_n44_), .c(new_n72_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(x16), .c(x03), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n71_), .O(z05));
  oai21  g41(.a(new_n68_), .b(new_n44_), .c(new_n37_), .O(new_n76_));
  nand2  g42(.a(new_n67_), .b(x10), .O(new_n77_));
  nor2   g43(.a(x10), .b(x09), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n59_), .c(x08), .O(new_n79_));
  and2   g45(.a(new_n79_), .b(new_n37_), .O(new_n80_));
  ...
  nor2   g49(.a(new_n83_), .b(new_n36_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n76_), .d(new_n74_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nor2   g52(.a(new_n83_), .b(new_n86_), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(new_n64_), .O(new_n89_));
  nand4  g55(.a(new_n78_), .b(new_n89_), .c(new_n86_), .d(new_n88_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n69_), .c(x04), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n87_), .c(new_n37_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n74_), .O(z08));
  inv1   g59(.a(x10), .O(new_n94_));
  inv1   g60(.a(x13), .O(new_n95_));
  oai21  g61(.a(new_n50_), .b(new_n72_), .c(new_n39_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n86_), .d(new_n88_), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n94_), .c(new_n66_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(x07), .c(x06), .d(x04), .O(new_n101_));
  aoi21  g67(.a(new_n90_), .b(x13), .c(new_n36_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n101_), .c(new_n76_), .d(new_n74_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand4  g70(.a(new_n95_), .b(new_n86_), .c(new_n88_), .d(new_n94_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n96_), .c(new_n66_), .d(x08), .O(new_n107_));
  ...
  nor2   g77(.a(new_n36_), .b(new_n35_), .O(z11));
  ...
  nor2   g81(.a(new_n36_), .b(new_n44_), .O(z13));
  oai21  g82(.a(new_n72_), .b(new_n44_), .c(new_n37_), .O(z14));
endmodule
