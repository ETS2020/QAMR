...
module FAU ( 
  ...
  oai21  g11(.a(new_n43_), .b(new_n40_), .c(new_n45_), .O(z01));
  ...
  oai21  g28(.a(new_n41_), .b(x02), .c(new_n49_), .O(new_n63_));
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(new_n47_), .O(z05));
  nand2  g37(.a(new_n70_), .b(x10), .O(new_n72_));
  nor2   g38(.a(x10), .b(x09), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n58_), .c(x08), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n66_), .d(new_n47_), .O(z06));
  ...
  nand3  g47(.a(new_n81_), .b(new_n77_), .c(new_n69_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n76_), .c(new_n66_), .d(new_n47_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n73_), .b(new_n77_), .c(new_n84_), .d(new_n79_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x04), .O(new_n86_));
  aoi21  g52(.a(new_n82_), .b(x12), .c(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n64_), .c(new_n38_), .O(z08));
  nand2  g54(.a(new_n85_), .b(x13), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  inv1   g56(.a(new_n70_), .O(new_n91_));
  nand4  g57(.a(new_n81_), .b(new_n91_), .c(new_n90_), .d(new_n84_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n89_), .c(new_n66_), .d(new_n47_), .O(z09));
  nand3  g59(.a(x15), .b(new_n90_), .c(new_n84_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n80_), .c(new_n40_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n51_), .c(new_n69_), .d(x08), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x07), .c(x06), .O(new_n98_));
  nand4  g64(.a(new_n50_), .b(new_n47_), .c(x16), .d(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n41_), .O(z10));
  nor2   g66(.a(new_n38_), .b(new_n35_), .O(z11));
  inv1   g67(.a(x16), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(x02), .c(new_n49_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n47_), .c(x04), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(z12));
  nand2  g71(.a(new_n47_), .b(new_n41_), .O(z13));
  nand2  g72(.a(x17), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n47_), .O(z14));
endmodule
