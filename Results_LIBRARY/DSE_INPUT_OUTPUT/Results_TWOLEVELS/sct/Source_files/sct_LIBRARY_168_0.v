...
module FAU ( 
  ...
  aoi21  g08(.a(x17), .b(x05), .c(x15), .O(new_n43_));
  inv1   g09(.a(x18), .O(new_n44_));
  aoi21  g10(.a(new_n44_), .b(x17), .c(x15), .O(new_n45_));
  ...
  nand4  g23(.a(new_n57_), .b(new_n48_), .c(new_n36_), .d(x04), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n64_), .c(new_n35_), .O(z06));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n35_), .O(z07));
  inv1   g49(.a(x04), .O(new_n84_));
  nor2   g50(.a(new_n63_), .b(new_n84_), .O(new_n85_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n36_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n48_), .b(new_n90_), .c(new_n87_), .d(new_n78_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x10), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n67_), .c(x08), .d(x07), .O(new_n93_));
  nand2  g59(.a(x16), .b(new_n40_), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n47_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x04), .O(new_n96_));
  aoi21  g62(.a(x16), .b(x03), .c(new_n84_), .O(new_n97_));
  nand2  g63(.a(new_n88_), .b(x13), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n36_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n90_), .b(new_n87_), .c(new_n78_), .d(new_n77_), .O(new_n101_));
  ...
  oai22  g70(.a(new_n104_), .b(new_n47_), .c(new_n48_), .d(new_n38_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n36_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z10));
  nor2   g73(.a(new_n35_), .b(new_n40_), .O(z11));
  nand2  g74(.a(new_n94_), .b(new_n60_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n36_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n36_), .b(new_n84_), .O(z13));
