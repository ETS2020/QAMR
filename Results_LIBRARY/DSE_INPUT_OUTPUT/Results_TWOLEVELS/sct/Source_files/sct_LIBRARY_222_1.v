...
module FAU ( 
  ...
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n66_), .d(new_n48_), .O(z07));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  nand4  g48(.a(new_n73_), .b(new_n77_), .c(new_n82_), .d(new_n81_), .O(new_n83_));
  ...
  nand3  g53(.a(new_n87_), .b(new_n64_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n48_), .O(new_n89_));
  inv1   g55(.a(x10), .O(new_n90_));
  inv1   g56(.a(x00), .O(new_n91_));
  nand3  g57(.a(new_n50_), .b(new_n40_), .c(x04), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n82_), .c(new_n81_), .d(new_n90_), .O(new_n94_));
  ...
  nor2   g65(.a(x17), .b(x13), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n78_), .c(new_n82_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n91_), .c(new_n99_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n69_), .c(x08), .d(x07), .O(new_n103_));
  oai22  g69(.a(new_n103_), .b(new_n49_), .c(new_n50_), .d(new_n38_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n48_), .O(z10));
  nand2  g72(.a(new_n48_), .b(new_n35_), .O(z11));
  nor2   g73(.a(new_n41_), .b(new_n98_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n35_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n45_), .c(new_n48_), .O(z12));
  nand2  g76(.a(new_n48_), .b(new_n45_), .O(z13));
  nand3  g77(.a(x17), .b(x04), .c(x00), .O(new_n112_));
