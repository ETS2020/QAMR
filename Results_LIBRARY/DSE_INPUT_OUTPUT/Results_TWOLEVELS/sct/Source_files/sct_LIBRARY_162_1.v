...
module FAU ( 
  ...
  aoi21  g44(.a(new_n72_), .b(x11), .c(new_n78_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n74_), .c(new_n39_), .O(z07));
  nand2  g46(.a(new_n77_), .b(x12), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n71_), .b(new_n75_), .c(new_n83_), .d(new_n82_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n64_), .d(new_n46_), .O(z08));
  nand2  g51(.a(new_n84_), .b(x13), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n74_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n46_), .O(new_n88_));
  inv1   g54(.a(x10), .O(new_n89_));
  inv1   g55(.a(x00), .O(new_n90_));
  nand3  g56(.a(new_n48_), .b(new_n38_), .c(x04), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(x13), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n83_), .c(new_n82_), .d(new_n89_), .O(new_n93_));
  ...
  nand3  g63(.a(new_n97_), .b(new_n76_), .c(new_n83_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  ...
  nand4  g69(.a(new_n103_), .b(new_n46_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n102_), .c(new_n43_), .O(z10));
  nand2  g71(.a(new_n46_), .b(new_n35_), .O(z11));
  nor2   g72(.a(new_n39_), .b(new_n61_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n35_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n43_), .c(new_n46_), .O(z12));
  nand2  g75(.a(new_n46_), .b(new_n43_), .O(z13));
  nand3  g76(.a(x17), .b(x04), .c(x00), .O(new_n111_));
