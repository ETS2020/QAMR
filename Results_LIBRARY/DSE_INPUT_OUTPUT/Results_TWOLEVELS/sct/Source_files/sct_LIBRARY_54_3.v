...
module FAU ( 
  ...
  aoi21  g09(.a(new_n35_), .b(x15), .c(new_n36_), .O(new_n44_));
  ...
  nand4  g16(.a(new_n50_), .b(new_n38_), .c(new_n46_), .d(x04), .O(new_n51_));
  ...
  oai21  g28(.a(new_n62_), .b(x02), .c(new_n47_), .O(new_n63_));
  ...
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n66_), .d(new_n38_), .O(z06));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n66_), .d(new_n38_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n64_), .c(new_n37_), .O(z08));
  inv1   g52(.a(x13), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n82_), .c(new_n78_), .d(new_n77_), .O(new_n88_));
  ...
  nand2  g63(.a(new_n97_), .b(new_n38_), .O(z10));
  nor2   g64(.a(new_n37_), .b(new_n40_), .O(z11));
  oai21  g65(.a(new_n48_), .b(x02), .c(new_n47_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n38_), .c(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z12));
  nand2  g68(.a(new_n38_), .b(new_n62_), .O(z13));
  nor3   g69(.a(x18), .b(new_n35_), .c(new_n62_), .O(z14));
endmodule
