...
module FAU ( 
  ...
  nor2   g02(.a(new_n36_), .b(x11), .O(new_n37_));
  ...
  nand2  g37(.a(new_n71_), .b(new_n46_), .O(new_n72_));
  inv1   g38(.a(x10), .O(new_n73_));
  inv1   g39(.a(x11), .O(new_n74_));
  nand2  g40(.a(x12), .b(new_n74_), .O(new_n75_));
  ...
  nand4  g45(.a(new_n55_), .b(new_n73_), .c(new_n67_), .d(x08), .O(new_n80_));
  nand4  g46(.a(new_n36_), .b(new_n74_), .c(new_n73_), .d(new_n67_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n65_), .O(new_n82_));
  aoi21  g48(.a(new_n80_), .b(x11), .c(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n64_), .O(z07));
  nand3  g50(.a(x16), .b(new_n36_), .c(new_n35_), .O(new_n85_));
  oai21  g51(.a(new_n36_), .b(new_n74_), .c(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  nand2  g53(.a(new_n46_), .b(new_n43_), .O(new_n88_));
  inv1   g54(.a(x16), .O(new_n89_));
  nand3  g55(.a(new_n74_), .b(new_n73_), .c(new_n67_), .O(new_n90_));
  oai22  g56(.a(new_n90_), .b(new_n65_), .c(new_n89_), .d(new_n60_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n36_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n87_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n48_), .b(new_n94_), .c(new_n74_), .d(new_n73_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x09), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand2  g63(.a(new_n80_), .b(x13), .O(new_n98_));
  ...
  and2   g70(.a(new_n48_), .b(new_n67_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  oai22  g72(.a(new_n106_), .b(new_n103_), .c(new_n48_), .d(new_n104_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n46_), .O(new_n108_));
  nand4  g74(.a(new_n48_), .b(new_n94_), .c(new_n36_), .d(new_n74_), .O(new_n109_));
  nor3   g75(.a(new_n109_), .b(x10), .c(x09), .O(new_n110_));
  nand4  g76(.a(new_n110_), .b(x08), .c(x07), .d(x06), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n108_), .c(new_n43_), .O(z10));
  nor2   g78(.a(new_n37_), .b(new_n35_), .O(z11));
  oai21  g79(.a(new_n89_), .b(x02), .c(new_n60_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n46_), .c(x04), .O(new_n115_));
  inv1   g81(.a(new_n115_), .O(z12));
  aoi21  g82(.a(x12), .b(new_n74_), .c(new_n43_), .O(z13));
