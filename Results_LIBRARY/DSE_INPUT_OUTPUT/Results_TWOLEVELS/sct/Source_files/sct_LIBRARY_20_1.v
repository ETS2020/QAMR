...
module FAU ( 
  ...
  aoi21  g37(.a(new_n71_), .b(new_n65_), .c(new_n44_), .O(z05));
  ...
  aoi21  g42(.a(new_n76_), .b(new_n65_), .c(new_n44_), .O(z06));
  oai21  g43(.a(new_n64_), .b(new_n43_), .c(new_n47_), .O(new_n78_));
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n78_), .d(new_n47_), .O(z08));
  ...
  oai21  g59(.a(new_n92_), .b(new_n48_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  oai21  g61(.a(new_n62_), .b(new_n61_), .c(x04), .O(new_n96_));
  aoi21  g62(.a(new_n87_), .b(x13), .c(new_n96_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n95_), .c(new_n44_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand4  g65(.a(new_n89_), .b(new_n86_), .c(new_n81_), .d(new_n80_), .O(new_n100_));
  ...
  oai22  g69(.a(new_n103_), .b(new_n48_), .c(new_n49_), .d(new_n37_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n47_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z10));
  nand2  g72(.a(new_n47_), .b(new_n35_), .O(z11));
  nor2   g73(.a(new_n44_), .b(new_n62_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n35_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n43_), .c(new_n47_), .O(z12));
  nor2   g76(.a(new_n44_), .b(new_n43_), .O(z13));
  inv1   g77(.a(x17), .O(new_n112_));
  nor3   g78(.a(new_n44_), .b(new_n112_), .c(new_n43_), .O(z14));
endmodule
