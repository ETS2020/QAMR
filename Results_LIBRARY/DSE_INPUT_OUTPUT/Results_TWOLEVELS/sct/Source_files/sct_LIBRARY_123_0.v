...
module FAU ( 
  ...
  nand4  g52(.a(new_n56_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n87_));
  ...
  oai21  g58(.a(new_n52_), .b(new_n50_), .c(x04), .O(new_n93_));
  ...
  nand4  g63(.a(new_n86_), .b(new_n83_), .c(new_n78_), .d(new_n77_), .O(new_n98_));
  aoi22  g64(.a(new_n98_), .b(new_n97_), .c(new_n51_), .d(x16), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n69_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n45_), .c(new_n56_), .d(new_n39_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n96_), .O(z10));
  nor2   g69(.a(new_n35_), .b(new_n36_), .O(z11));
  aoi21  g70(.a(new_n90_), .b(new_n50_), .c(new_n43_), .O(z12));
  nand2  g71(.a(x06), .b(new_n43_), .O(z13));
  nand2  g72(.a(x17), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n96_), .O(z14));
endmodule
