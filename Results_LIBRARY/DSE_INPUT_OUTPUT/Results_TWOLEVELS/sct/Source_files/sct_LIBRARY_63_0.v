...
module FAU ( 
  ...
  nand2  g28(.a(x04), .b(new_n48_), .O(new_n63_));
  ...
  nand3  g40(.a(new_n56_), .b(new_n65_), .c(x08), .O(new_n75_));
  nor2   g41(.a(x10), .b(x09), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n56_), .c(x08), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x04), .O(new_n78_));
  aoi21  g44(.a(new_n75_), .b(x10), .c(new_n78_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n74_), .c(new_n39_), .O(z06));
  inv1   g46(.a(x10), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  nand4  g48(.a(new_n67_), .b(new_n82_), .c(new_n81_), .d(new_n65_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n77_), .b(x11), .c(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n74_), .c(new_n39_), .O(z07));
  oai21  g52(.a(new_n64_), .b(new_n43_), .c(new_n47_), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  nand4  g55(.a(new_n76_), .b(new_n67_), .c(new_n89_), .d(new_n82_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n47_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n49_), .b(new_n92_), .c(new_n89_), .d(new_n82_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n81_), .c(new_n65_), .d(x08), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x07), .c(x06), .d(x04), .O(new_n97_));
  aoi21  g63(.a(new_n90_), .b(x13), .c(new_n39_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n87_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n101_));
  nand4  g67(.a(new_n92_), .b(new_n89_), .c(new_n82_), .d(new_n81_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n101_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n65_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n46_), .c(new_n49_), .d(new_n36_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n47_), .O(z10));
  nand2  g73(.a(new_n47_), .b(new_n48_), .O(z11));
  oai21  g74(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n47_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n47_), .b(new_n43_), .O(z13));
  inv1   g78(.a(x17), .O(new_n113_));
  nor3   g79(.a(new_n39_), .b(new_n113_), .c(new_n43_), .O(z14));
endmodule
