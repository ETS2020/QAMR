...
module FAU ( 
  ...
  oai21  g47(.a(new_n76_), .b(new_n46_), .c(new_n40_), .O(new_n82_));
  ...
  nand4  g66(.a(new_n50_), .b(new_n100_), .c(new_n95_), .d(new_n89_), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n88_), .c(new_n77_), .d(x08), .O(new_n103_));
  ...
  nand4  g73(.a(new_n100_), .b(new_n95_), .c(new_n89_), .d(new_n88_), .O(new_n108_));
  ...
  aoi21  g86(.a(x17), .b(x00), .c(new_n46_), .O(z13));
  aoi21  g87(.a(new_n46_), .b(new_n62_), .c(new_n109_), .O(z14));
endmodule
