...
module FAU ( 
  ...
  nand4  g67(.a(new_n101_), .b(new_n82_), .c(new_n81_), .d(x01), .O(new_n102_));
  aoi22  g68(.a(new_n102_), .b(new_n93_), .c(new_n100_), .d(x16), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n64_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n46_), .c(new_n48_), .d(new_n36_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n45_), .O(z10));
  nor2   g73(.a(new_n42_), .b(new_n47_), .O(z11));
  nand3  g74(.a(new_n45_), .b(x16), .c(new_n47_), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n60_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n45_), .O(z12));
  nand2  g78(.a(new_n45_), .b(new_n41_), .O(z13));
