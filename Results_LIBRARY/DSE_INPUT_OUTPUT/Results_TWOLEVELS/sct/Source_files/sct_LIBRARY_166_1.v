...
module FAU ( 
  ...
  nor2   g20(.a(new_n36_), .b(new_n47_), .O(new_n55_));
  ...
  oai21  g25(.a(x09), .b(new_n42_), .c(new_n36_), .O(new_n60_));
  oai21  g26(.a(new_n54_), .b(new_n47_), .c(x09), .O(new_n61_));
  ...
  oai21  g32(.a(x10), .b(new_n42_), .c(new_n36_), .O(new_n67_));
  nand3  g33(.a(new_n62_), .b(x08), .c(x06), .O(new_n68_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n76_), .d(new_n62_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n48_), .d(x04), .O(z07));
  nand2  g47(.a(new_n80_), .b(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n79_), .b(new_n70_), .c(new_n83_), .d(new_n77_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n48_), .d(x04), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n48_), .b(new_n86_), .c(new_n83_), .d(new_n77_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n62_), .c(x08), .d(x07), .O(new_n89_));
  inv1   g55(.a(new_n48_), .O(new_n90_));
  inv1   g56(.a(new_n68_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n83_), .c(new_n77_), .d(new_n76_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x13), .c(new_n90_), .O(new_n93_));
  oai21  g59(.a(new_n89_), .b(new_n47_), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  oai21  g61(.a(x13), .b(new_n42_), .c(new_n36_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(z09));
  inv1   g63(.a(x00), .O(new_n98_));
  nand4  g64(.a(new_n86_), .b(new_n83_), .c(new_n77_), .d(new_n76_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n48_), .c(new_n62_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  nand2  g69(.a(new_n90_), .b(x14), .O(new_n104_));
  ...
  nor2   g73(.a(new_n107_), .b(new_n42_), .O(z12));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  oai21  g75(.a(new_n36_), .b(x04), .c(new_n109_), .O(z14));
  buf    g76(.a(x04), .O(z13));
endmodule
