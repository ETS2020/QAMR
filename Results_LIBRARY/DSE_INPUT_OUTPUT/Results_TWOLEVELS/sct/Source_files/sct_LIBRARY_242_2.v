...
module FAU ( 
  ...
  oai21  g30(.a(new_n64_), .b(new_n42_), .c(new_n46_), .O(new_n65_));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n46_), .O(z08));
  nand2  g52(.a(new_n85_), .b(x13), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n75_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n46_), .O(new_n89_));
  nand3  g55(.a(new_n49_), .b(x04), .c(new_n36_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n35_), .c(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n84_), .c(new_n77_), .d(new_n76_), .O(new_n92_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n77_), .c(new_n76_), .d(new_n36_), .O(new_n97_));
  oai21  g63(.a(new_n35_), .b(new_n36_), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g68(.a(new_n102_), .b(new_n46_), .c(x16), .d(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n42_), .O(z10));
  nor2   g70(.a(new_n43_), .b(new_n48_), .O(z11));
  ...
  nor2   g74(.a(new_n43_), .b(new_n42_), .O(z13));
