...
module FAU ( 
  ...
  nand4  g32(.a(new_n66_), .b(new_n63_), .c(new_n48_), .d(x04), .O(z05));
  nand2  g33(.a(new_n66_), .b(x10), .O(new_n68_));
  nor2   g34(.a(x10), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n64_), .c(x08), .O(new_n70_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n72_), .c(new_n48_), .d(x04), .O(z07));
  oai21  g46(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n81_));
  nand2  g47(.a(x08), .b(x07), .O(new_n82_));
  oai21  g48(.a(new_n77_), .b(new_n82_), .c(x12), .O(new_n83_));
  nor2   g49(.a(x12), .b(x11), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n69_), .c(new_n73_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n83_), .c(new_n48_), .O(new_n86_));
  ...
  nand4  g56(.a(new_n48_), .b(new_n90_), .c(new_n89_), .d(new_n76_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x10), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n74_), .c(x08), .d(x07), .O(new_n93_));
  inv1   g59(.a(new_n48_), .O(new_n94_));
  nand4  g60(.a(new_n84_), .b(new_n65_), .c(new_n75_), .d(x07), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x13), .c(new_n94_), .O(new_n96_));
  oai21  g62(.a(new_n93_), .b(new_n35_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  oai21  g64(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n98_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  nand2  g67(.a(new_n75_), .b(x04), .O(new_n102_));
  nand3  g68(.a(new_n90_), .b(new_n89_), .c(new_n76_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n48_), .c(new_n74_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(x07), .c(new_n43_), .O(new_n107_));
  nand3  g73(.a(new_n94_), .b(x14), .c(x04), .O(new_n108_));
  oai21  g74(.a(new_n107_), .b(new_n35_), .c(new_n108_), .O(z10));
  nand2  g75(.a(new_n54_), .b(new_n37_), .O(z11));
  aoi21  g76(.a(x16), .b(new_n37_), .c(x03), .O(new_n111_));
  nor2   g77(.a(new_n111_), .b(new_n43_), .O(z12));
