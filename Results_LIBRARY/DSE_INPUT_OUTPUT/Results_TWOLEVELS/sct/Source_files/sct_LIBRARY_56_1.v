...
module FAU ( 
  ...
  oai21  g36(.a(new_n70_), .b(new_n67_), .c(new_n37_), .O(new_n71_));
  nor2   g37(.a(new_n36_), .b(x09), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(x08), .c(x07), .d(x06), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n71_), .O(z05));
  inv1   g40(.a(new_n67_), .O(new_n75_));
  nor2   g41(.a(x09), .b(new_n57_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x10), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n37_), .O(new_n80_));
  nor3   g46(.a(new_n36_), .b(x10), .c(x09), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(x08), .c(x07), .d(x06), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n80_), .O(z06));
  inv1   g49(.a(x09), .O(new_n84_));
  inv1   g50(.a(x10), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(x08), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n58_), .c(x11), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n67_), .c(new_n37_), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand2  g57(.a(x17), .b(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n90_), .c(new_n85_), .d(new_n84_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x08), .c(x07), .d(x06), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n89_), .O(z07));
  oai21  g62(.a(new_n67_), .b(new_n47_), .c(new_n37_), .O(new_n97_));
  nand2  g63(.a(new_n90_), .b(new_n85_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n84_), .c(x08), .d(x06), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n76_), .c(new_n52_), .d(x07), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x12), .O(new_n101_));
  inv1   g67(.a(new_n77_), .O(new_n102_));
  nor2   g68(.a(x17), .b(x12), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n102_), .c(new_n90_), .d(new_n85_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n101_), .c(new_n97_), .O(z08));
  inv1   g71(.a(x13), .O(new_n106_));
  nand4  g72(.a(new_n51_), .b(new_n35_), .c(new_n106_), .d(new_n90_), .O(new_n107_));
  nor3   g73(.a(new_n107_), .b(x10), .c(x09), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(x08), .c(x07), .d(x06), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n47_), .c(new_n35_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n91_), .O(new_n111_));
  nand4  g77(.a(new_n91_), .b(new_n90_), .c(new_n85_), .d(new_n84_), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n68_), .c(x13), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n111_), .c(new_n97_), .O(z09));
  inv1   g80(.a(x00), .O(new_n115_));
  and2   g81(.a(new_n51_), .b(new_n84_), .O(new_n116_));
  nand4  g82(.a(new_n116_), .b(x08), .c(x07), .d(x06), .O(new_n117_));
  oai22  g83(.a(new_n117_), .b(new_n115_), .c(new_n51_), .d(new_n39_), .O(new_n118_));
  nand2  g84(.a(new_n118_), .b(new_n37_), .O(new_n119_));
  nand4  g85(.a(new_n51_), .b(new_n35_), .c(new_n106_), .d(new_n91_), .O(new_n120_));
  inv1   g86(.a(new_n120_), .O(new_n121_));
  nand4  g87(.a(new_n121_), .b(new_n90_), .c(new_n85_), .d(new_n84_), .O(new_n122_));
  inv1   g88(.a(new_n122_), .O(new_n123_));
  nand4  g89(.a(new_n123_), .b(x08), .c(x07), .d(x06), .O(new_n124_));
  aoi21  g90(.a(new_n124_), .b(new_n119_), .c(new_n47_), .O(z10));
  nor2   g91(.a(new_n36_), .b(new_n41_), .O(z11));
  nor2   g92(.a(new_n36_), .b(new_n65_), .O(new_n127_));
  aoi21  g93(.a(new_n127_), .b(new_n41_), .c(x03), .O(new_n128_));
  oai21  g94(.a(new_n128_), .b(new_n47_), .c(new_n37_), .O(z12));
  aoi21  g95(.a(x17), .b(new_n91_), .c(new_n47_), .O(z13));
  nand3  g96(.a(x17), .b(x12), .c(x04), .O(new_n131_));
  inv1   g97(.a(new_n131_), .O(z14));
endmodule
