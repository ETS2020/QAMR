...
module FAU ( 
  ...
  nand2  g27(.a(x04), .b(new_n47_), .O(new_n62_));
  aoi21  g28(.a(new_n62_), .b(new_n60_), .c(new_n61_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(new_n41_), .c(new_n45_), .O(new_n64_));
  ...
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n45_), .O(z05));
  nand2  g35(.a(new_n68_), .b(x10), .O(new_n70_));
  nor2   g36(.a(x10), .b(x09), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n55_), .c(x08), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .d(new_n45_), .O(z06));
  ...
  aoi21  g45(.a(new_n72_), .b(x11), .c(new_n79_), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(new_n74_), .c(new_n42_), .O(z07));
  nand2  g47(.a(new_n78_), .b(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n71_), .b(new_n77_), .c(new_n83_), .d(new_n76_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n64_), .d(new_n45_), .O(z08));
  nand2  g51(.a(new_n84_), .b(x13), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n74_), .c(x04), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n45_), .O(new_n88_));
  inv1   g54(.a(x00), .O(new_n89_));
  nand3  g55(.a(new_n48_), .b(x04), .c(x01), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n83_), .c(new_n76_), .d(new_n75_), .O(new_n92_));
  ...
  nand2  g61(.a(new_n75_), .b(x01), .O(new_n96_));
  inv1   g62(.a(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n83_), .c(new_n76_), .O(new_n98_));
  oai21  g64(.a(new_n98_), .b(new_n96_), .c(new_n89_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n48_), .c(new_n67_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n60_), .b(x02), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n45_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n102_), .c(new_n41_), .O(z10));
  nor2   g71(.a(new_n42_), .b(new_n47_), .O(z11));
  oai21  g72(.a(new_n61_), .b(x02), .c(new_n60_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n45_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nor2   g75(.a(new_n42_), .b(new_n41_), .O(z13));
  nand2  g76(.a(x17), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n45_), .O(z14));
endmodule
