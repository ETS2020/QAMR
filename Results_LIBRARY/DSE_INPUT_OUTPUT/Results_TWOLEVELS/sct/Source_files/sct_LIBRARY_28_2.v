...
module FAU ( 
  ...
  oai21  g32(.a(new_n66_), .b(new_n47_), .c(new_n36_), .O(new_n67_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(new_n36_), .O(z05));
  ...
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n67_), .d(new_n36_), .O(z08));
  ...
  nor2   g77(.a(new_n37_), .b(new_n47_), .O(z13));
  oai21  g78(.a(new_n35_), .b(new_n47_), .c(new_n36_), .O(z14));
endmodule
