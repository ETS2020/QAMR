...
module FAU ( 
  ...
  nand3  g13(.a(new_n47_), .b(new_n45_), .c(new_n40_), .O(z01));
  ...
  nand4  g19(.a(new_n53_), .b(new_n40_), .c(new_n49_), .d(x04), .O(new_n54_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(new_n40_), .O(z05));
  nand2  g38(.a(new_n71_), .b(x10), .O(new_n73_));
  nor2   g39(.a(x10), .b(x09), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n60_), .c(x08), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n67_), .d(new_n40_), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n67_), .d(new_n40_), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n67_), .d(new_n40_), .O(z08));
  ...
  aoi21  g56(.a(new_n85_), .b(x13), .c(new_n90_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n87_), .c(new_n41_), .O(z09));
  aoi21  g58(.a(new_n89_), .b(new_n38_), .c(new_n52_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n70_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(new_n52_), .b(x14), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n49_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n40_), .O(z10));
  nand2  g64(.a(new_n40_), .b(new_n35_), .O(z11));
  nor3   g65(.a(new_n41_), .b(new_n51_), .c(x02), .O(new_n100_));
  oai21  g66(.a(new_n100_), .b(x03), .c(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n40_), .O(z12));
  nand2  g68(.a(new_n40_), .b(new_n46_), .O(z13));
  oai21  g69(.a(new_n39_), .b(new_n46_), .c(new_n40_), .O(z14));
endmodule
