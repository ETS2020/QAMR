...
module FAU ( 
  ...
  nor2   g08(.a(new_n35_), .b(x15), .O(new_n43_));
  ...
  nand3  g18(.a(new_n35_), .b(new_n52_), .c(x06), .O(new_n53_));
  ...
  nand3  g36(.a(new_n35_), .b(x09), .c(new_n52_), .O(new_n71_));
  ...
  nand3  g43(.a(new_n35_), .b(x10), .c(new_n52_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n65_), .O(z06));
  oai21  g45(.a(x18), .b(x11), .c(new_n52_), .O(new_n80_));
  ...
  nand3  g57(.a(new_n35_), .b(x12), .c(new_n52_), .O(new_n92_));
  ...
  nand3  g66(.a(new_n35_), .b(x13), .c(new_n52_), .O(new_n101_));
  ...
  nand4  g76(.a(new_n110_), .b(new_n35_), .c(x16), .d(x14), .O(new_n111_));
