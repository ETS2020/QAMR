...
module FAU ( 
  ...
  aoi21  g56(.a(new_n90_), .b(new_n86_), .c(new_n44_), .O(z09));
  aoi21  g57(.a(new_n88_), .b(new_n43_), .c(new_n51_), .O(new_n92_));
  ...
  nor2   g63(.a(new_n44_), .b(new_n37_), .O(z11));
  oai21  g64(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n47_), .c(x04), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(z12));
  nor2   g67(.a(new_n44_), .b(new_n42_), .O(z13));
  inv1   g68(.a(x17), .O(new_n103_));
  nor3   g69(.a(new_n44_), .b(new_n103_), .c(new_n42_), .O(z14));
endmodule
