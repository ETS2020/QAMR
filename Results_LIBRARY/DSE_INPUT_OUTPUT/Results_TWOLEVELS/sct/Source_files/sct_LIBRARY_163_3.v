...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n53_, new_n55_, new_n56_, new_n58_, new_n60_, new_n61_, new_n62_,
  ...
  oai21  g20(.a(new_n35_), .b(x02), .c(new_n46_), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(x16), .c(x09), .O(new_n56_));
  oai21  g22(.a(new_n56_), .b(x06), .c(x04), .O(z05));
  aoi21  g23(.a(new_n55_), .b(x16), .c(x10), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(x06), .c(x04), .O(z06));
  inv1   g25(.a(x11), .O(new_n60_));
  aoi21  g26(.a(x16), .b(new_n38_), .c(x06), .O(new_n61_));
  nand3  g27(.a(x16), .b(new_n36_), .c(x03), .O(new_n62_));
  nand4  g28(.a(new_n62_), .b(new_n61_), .c(new_n60_), .d(x04), .O(z07));
  inv1   g29(.a(x12), .O(new_n64_));
  nand4  g30(.a(new_n62_), .b(new_n61_), .c(new_n64_), .d(x04), .O(z08));
  inv1   g31(.a(x13), .O(new_n66_));
  nand4  g32(.a(new_n62_), .b(new_n61_), .c(new_n66_), .d(x04), .O(z09));
  ...
  nand3  g43(.a(x17), .b(new_n36_), .c(x04), .O(new_n78_));
