...
module FAU ( 
  ...
  nand4  g48(.a(new_n82_), .b(new_n74_), .c(new_n48_), .d(x04), .O(z07));
  oai21  g49(.a(x12), .b(new_n43_), .c(new_n35_), .O(new_n84_));
  oai21  g50(.a(new_n80_), .b(new_n62_), .c(x12), .O(new_n85_));
  nor2   g51(.a(x12), .b(x11), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n76_), .c(new_n71_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n48_), .O(new_n88_));
  ...
  nand4  g58(.a(new_n48_), .b(new_n92_), .c(new_n91_), .d(new_n79_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x10), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n77_), .c(x08), .d(x07), .O(new_n95_));
  inv1   g61(.a(new_n48_), .O(new_n96_));
  nand4  g62(.a(new_n86_), .b(new_n65_), .c(new_n78_), .d(x07), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x13), .c(new_n96_), .O(new_n98_));
  oai21  g64(.a(new_n95_), .b(new_n35_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  oai21  g66(.a(x13), .b(new_n43_), .c(new_n35_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n78_), .b(x04), .O(new_n104_));
  nand3  g70(.a(new_n92_), .b(new_n91_), .c(new_n79_), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(new_n104_), .c(new_n103_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n48_), .c(new_n77_), .d(x08), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(x07), .c(new_n43_), .O(new_n109_));
  nand3  g75(.a(new_n96_), .b(x14), .c(x04), .O(new_n110_));
  oai21  g76(.a(new_n109_), .b(new_n35_), .c(new_n110_), .O(z10));
