...
module FAU ( 
  ...
  nand2  g20(.a(new_n54_), .b(new_n38_), .O(z02));
  ...
  nand2  g30(.a(x04), .b(new_n40_), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(new_n50_), .c(new_n51_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n46_), .c(new_n38_), .O(new_n67_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(new_n38_), .O(z05));
  nand2  g38(.a(new_n71_), .b(x10), .O(new_n73_));
  nor2   g39(.a(x10), .b(x09), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n60_), .c(x08), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n67_), .d(new_n38_), .O(z06));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n77_), .c(new_n37_), .O(z07));
  nand2  g50(.a(new_n81_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n74_), .b(new_n80_), .c(new_n86_), .d(new_n79_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n67_), .d(new_n38_), .O(z08));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n77_), .c(new_n37_), .O(z09));
  aoi21  g59(.a(new_n90_), .b(new_n35_), .c(new_n52_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n70_), .c(x08), .d(x07), .O(new_n95_));
  nand2  g61(.a(new_n52_), .b(x14), .O(new_n96_));
  ...
  nand2  g65(.a(new_n38_), .b(new_n40_), .O(z11));
  oai21  g66(.a(new_n51_), .b(x02), .c(new_n50_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n38_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z12));
  aoi21  g69(.a(x17), .b(x00), .c(new_n46_), .O(z13));
  aoi21  g70(.a(new_n46_), .b(new_n35_), .c(new_n36_), .O(z14));
endmodule
