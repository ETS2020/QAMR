...
module FAU ( 
  ...
  inv1   g08(.a(x00), .O(new_n43_));
  nor2   g09(.a(x01), .b(new_n43_), .O(new_n44_));
  aoi21  g10(.a(x05), .b(new_n42_), .c(new_n44_), .O(new_n45_));
  oai21  g11(.a(new_n41_), .b(x05), .c(new_n45_), .O(z01));
  inv1   g12(.a(x06), .O(new_n47_));
  inv1   g13(.a(new_n44_), .O(new_n48_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n48_), .O(z05));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n63_), .c(new_n44_), .O(z06));
  ...
  nand4  g50(.a(new_n71_), .b(new_n78_), .c(new_n84_), .d(new_n77_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n48_), .O(z08));
  ...
  aoi21  g58(.a(new_n85_), .b(x13), .c(new_n44_), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n97_), .b(new_n43_), .c(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n68_), .c(x08), .d(x07), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n47_), .c(new_n49_), .d(new_n35_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n48_), .O(z10));
  nand2  g68(.a(new_n48_), .b(new_n37_), .O(z11));
  ...
  nor2   g72(.a(new_n44_), .b(new_n42_), .O(z13));
  inv1   g73(.a(x17), .O(new_n108_));
  nor3   g74(.a(new_n44_), .b(new_n108_), .c(new_n42_), .O(z14));
endmodule
