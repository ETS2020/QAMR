...
module FAU ( 
  ...
  nor2   g27(.a(x03), .b(new_n61_), .O(new_n62_));
  nor2   g28(.a(new_n62_), .b(new_n42_), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(new_n41_), .c(x14), .O(new_n64_));
  ...
  aoi21  g34(.a(new_n42_), .b(new_n41_), .c(new_n43_), .O(new_n69_));
  ...
  nor3   g46(.a(new_n62_), .b(new_n42_), .c(new_n41_), .O(new_n81_));
  nand2  g47(.a(new_n79_), .b(x12), .O(new_n82_));
  inv1   g48(.a(x12), .O(new_n83_));
  nand4  g49(.a(new_n72_), .b(new_n78_), .c(new_n83_), .d(new_n77_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n82_), .c(x04), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(new_n81_), .c(x14), .O(new_n86_));
  nand2  g52(.a(new_n85_), .b(new_n42_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(z08));
  inv1   g54(.a(new_n43_), .O(new_n89_));
  nand4  g55(.a(x08), .b(x07), .c(x06), .d(x04), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n72_), .b(new_n91_), .c(new_n83_), .d(new_n77_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n90_), .c(x04), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  oai21  g60(.a(new_n62_), .b(new_n41_), .c(x14), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x16), .O(new_n96_));
  nand2  g62(.a(new_n84_), .b(x13), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n94_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  nand4  g65(.a(new_n91_), .b(new_n83_), .c(new_n77_), .d(new_n76_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n89_), .c(new_n67_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x07), .c(x06), .O(new_n104_));
  nand2  g70(.a(new_n63_), .b(x14), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n41_), .O(z10));
  nor2   g72(.a(new_n43_), .b(new_n61_), .O(z11));
  oai21  g73(.a(new_n42_), .b(x14), .c(x03), .O(new_n108_));
  nand3  g74(.a(x16), .b(x14), .c(new_n61_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n41_), .O(z12));
  nand2  g76(.a(new_n89_), .b(new_n41_), .O(z13));
  nand2  g77(.a(x17), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n89_), .O(z14));
endmodule
