...
module FAU ( 
  ...
  oai22  g31(.a(new_n65_), .b(new_n36_), .c(new_n61_), .d(x02), .O(new_n66_));
  ...
  oai21  g42(.a(new_n76_), .b(new_n73_), .c(new_n36_), .O(new_n77_));
  ...
  nor2   g50(.a(new_n73_), .b(new_n42_), .O(new_n85_));
  ...
  nand4  g72(.a(new_n106_), .b(new_n88_), .c(new_n87_), .d(new_n36_), .O(new_n107_));
  oai21  g73(.a(new_n35_), .b(new_n36_), .c(new_n107_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n49_), .c(new_n74_), .d(x08), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(new_n110_));
  nand3  g76(.a(new_n110_), .b(x07), .c(x06), .O(new_n111_));
  nand4  g77(.a(new_n63_), .b(new_n46_), .c(x16), .d(x14), .O(new_n112_));
  aoi21  g78(.a(new_n112_), .b(new_n111_), .c(new_n42_), .O(z10));
  nor2   g79(.a(new_n43_), .b(new_n48_), .O(z11));
  oai21  g80(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n46_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nand2  g83(.a(new_n46_), .b(new_n42_), .O(z13));
  nand2  g84(.a(x17), .b(x04), .O(new_n119_));
  nand2  g85(.a(new_n119_), .b(new_n46_), .O(z14));
endmodule
