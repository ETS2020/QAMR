...
module FAU ( 
  ...
  oai21  g42(.a(new_n63_), .b(new_n44_), .c(new_n39_), .O(new_n77_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n77_), .d(new_n39_), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n77_), .d(new_n39_), .O(z08));
  ...
  nand4  g65(.a(new_n88_), .b(new_n85_), .c(new_n80_), .d(new_n79_), .O(new_n100_));
  ...
  nor2   g73(.a(new_n40_), .b(new_n61_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n35_), .c(x03), .O(new_n109_));
  oai21  g75(.a(new_n109_), .b(new_n44_), .c(new_n39_), .O(z12));
  nand2  g76(.a(new_n39_), .b(new_n44_), .O(z13));
  oai21  g77(.a(new_n38_), .b(new_n44_), .c(new_n39_), .O(z14));
endmodule
