...
module FAU ( 
  ...
  nor2   g05(.a(new_n36_), .b(new_n39_), .O(new_n40_));
  ...
  nand3  g22(.a(new_n49_), .b(x02), .c(new_n39_), .O(new_n57_));
  ...
  oai21  g30(.a(new_n50_), .b(new_n44_), .c(new_n39_), .O(new_n65_));
  ...
  aoi21  g35(.a(new_n36_), .b(new_n44_), .c(new_n40_), .O(new_n70_));
  ...
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n70_), .d(new_n65_), .O(z06));
  nor2   g41(.a(new_n51_), .b(new_n44_), .O(new_n76_));
  ...
  nand3  g47(.a(new_n81_), .b(new_n77_), .c(x04), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n76_), .c(new_n39_), .O(new_n83_));
  nand2  g49(.a(new_n82_), .b(new_n36_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n83_), .O(z07));
  nand2  g51(.a(new_n81_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n73_), .b(new_n80_), .c(new_n87_), .d(new_n79_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n70_), .d(new_n65_), .O(z08));
  nand2  g55(.a(new_n47_), .b(new_n44_), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n58_), .b(new_n91_), .c(new_n87_), .d(new_n79_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(x10), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n68_), .c(x08), .d(x07), .O(new_n94_));
  nand2  g60(.a(new_n50_), .b(new_n39_), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n48_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  aoi21  g63(.a(new_n88_), .b(x13), .c(new_n40_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n90_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n91_), .b(new_n87_), .c(new_n79_), .d(new_n78_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n58_), .c(new_n68_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x07), .c(x06), .O(new_n105_));
  nand3  g71(.a(new_n50_), .b(x14), .c(new_n39_), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n44_), .O(z10));
  nor2   g73(.a(new_n40_), .b(new_n35_), .O(z11));
  nand2  g74(.a(new_n36_), .b(x03), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n95_), .c(new_n44_), .O(z12));
  nor2   g76(.a(new_n40_), .b(new_n44_), .O(z13));
  nand3  g77(.a(new_n47_), .b(x17), .c(x04), .O(new_n112_));
