...
module FAU ( 
  ...
  aoi21  g41(.a(new_n75_), .b(new_n71_), .c(new_n35_), .O(z06));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n71_), .c(new_n35_), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n65_), .d(new_n47_), .O(z08));
  ...
  nand4  g56(.a(new_n90_), .b(new_n68_), .c(x08), .d(x07), .O(new_n91_));
  ...
  oai21  g60(.a(new_n62_), .b(new_n61_), .c(x04), .O(new_n95_));
  aoi21  g61(.a(new_n86_), .b(x13), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n35_), .O(z09));
  ...
  oai22  g68(.a(new_n102_), .b(new_n48_), .c(new_n49_), .d(new_n39_), .O(new_n103_));
  ...
  nor2   g75(.a(new_n35_), .b(new_n44_), .O(z13));
