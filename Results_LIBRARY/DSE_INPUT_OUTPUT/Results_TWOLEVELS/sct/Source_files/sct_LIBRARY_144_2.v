...
module FAU ( 
  ...
  aoi21  g57(.a(new_n91_), .b(new_n64_), .c(new_n36_), .O(z09));
  ...
  nor2   g66(.a(new_n36_), .b(new_n49_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n37_), .c(x03), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(new_n43_), .c(new_n46_), .O(z12));
  nand2  g69(.a(new_n46_), .b(new_n43_), .O(z13));
  nand3  g70(.a(x18), .b(x17), .c(x04), .O(new_n105_));
