...
module FAU ( 
  ...
  nand2  g21(.a(new_n47_), .b(x02), .O(new_n56_));
  ...
  aoi21  g31(.a(new_n47_), .b(x02), .c(new_n42_), .O(new_n66_));
  ...
  oai21  g37(.a(new_n71_), .b(new_n66_), .c(x16), .O(new_n72_));
  nand2  g38(.a(new_n71_), .b(x01), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(z05));
  nand2  g40(.a(new_n70_), .b(x10), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand4  g42(.a(new_n61_), .b(new_n76_), .c(new_n69_), .d(x08), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(x04), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n66_), .c(x16), .O(new_n79_));
  nand2  g45(.a(new_n78_), .b(x01), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n79_), .O(z06));
  oai21  g47(.a(new_n56_), .b(new_n42_), .c(x16), .O(new_n82_));
  nand2  g48(.a(new_n77_), .b(x11), .O(new_n83_));
  nand2  g49(.a(new_n42_), .b(x01), .O(new_n84_));
  nor4   g50(.a(new_n67_), .b(x11), .c(x10), .d(x09), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n43_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(z07));
  inv1   g53(.a(new_n85_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x12), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n76_), .d(new_n69_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n67_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n43_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n89_), .c(new_n84_), .d(new_n82_), .O(z08));
  inv1   g61(.a(x13), .O(new_n96_));
  oai21  g62(.a(new_n93_), .b(new_n96_), .c(x04), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n54_), .O(new_n98_));
  nand4  g64(.a(new_n51_), .b(new_n96_), .c(new_n91_), .d(new_n90_), .O(new_n99_));
  nor2   g65(.a(new_n99_), .b(x10), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n69_), .c(x08), .d(x07), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n46_), .c(new_n57_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n98_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  nand4  g71(.a(new_n96_), .b(new_n91_), .c(new_n90_), .d(new_n76_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n51_), .c(new_n69_), .d(x08), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(x07), .c(x06), .O(new_n110_));
  nand3  g76(.a(new_n56_), .b(x16), .c(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n42_), .O(z10));
  nor2   g78(.a(new_n43_), .b(new_n35_), .O(z11));
  nand2  g79(.a(new_n54_), .b(x03), .O(new_n114_));
  nand2  g80(.a(x16), .b(new_n35_), .O(new_n115_));
  aoi21  g81(.a(new_n115_), .b(new_n114_), .c(new_n42_), .O(z12));
  nor2   g82(.a(new_n43_), .b(new_n42_), .O(z13));
  inv1   g83(.a(x17), .O(new_n118_));
  nor3   g84(.a(new_n43_), .b(new_n118_), .c(new_n42_), .O(z14));
endmodule
