...
module FAU ( 
  ...
  aoi21  g16(.a(new_n50_), .b(x06), .c(new_n36_), .O(z04));
  inv1   g17(.a(x16), .O(new_n52_));
  oai21  g18(.a(new_n52_), .b(x02), .c(x06), .O(new_n53_));
  ...
  nand3  g24(.a(x16), .b(x06), .c(x03), .O(new_n59_));
  and2   g25(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand4  g26(.a(new_n60_), .b(new_n56_), .c(new_n54_), .d(x04), .O(z05));
  ...
  and2   g31(.a(new_n65_), .b(new_n59_), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n62_), .c(new_n54_), .d(x04), .O(z06));
  ...
  and2   g36(.a(new_n70_), .b(new_n59_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n68_), .c(new_n54_), .d(x04), .O(z07));
  inv1   g38(.a(x03), .O(new_n73_));
  oai21  g39(.a(new_n36_), .b(x02), .c(new_n73_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x16), .O(new_n75_));
  nand2  g41(.a(new_n70_), .b(x12), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  inv1   g43(.a(new_n58_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n69_), .d(new_n63_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n76_), .c(new_n75_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x06), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(z08));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n46_), .b(new_n83_), .c(new_n77_), .d(new_n69_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(x10), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n57_), .c(x08), .d(x07), .O(new_n86_));
  nand2  g52(.a(x16), .b(new_n35_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n86_), .c(new_n36_), .O(new_n88_));
  nand2  g54(.a(new_n79_), .b(x13), .O(new_n89_));
  oai21  g55(.a(new_n52_), .b(new_n73_), .c(new_n89_), .O(new_n90_));
  ...
  nand4  g60(.a(new_n83_), .b(new_n77_), .c(new_n69_), .d(new_n63_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n46_), .c(new_n57_), .d(x08), .O(new_n97_));
  oai22  g63(.a(new_n97_), .b(new_n45_), .c(new_n46_), .d(new_n93_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(x06), .c(x04), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(z10));
  nor2   g66(.a(z02), .b(new_n35_), .O(z11));
  nand2  g67(.a(new_n87_), .b(new_n73_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x06), .c(x04), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(z12));
  and2   g70(.a(x06), .b(x04), .O(z13));
  inv1   g71(.a(x17), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(x06), .c(new_n36_), .O(z14));
endmodule
