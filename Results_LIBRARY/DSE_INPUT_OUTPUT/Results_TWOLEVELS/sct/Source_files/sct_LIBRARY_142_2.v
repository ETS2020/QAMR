...
module FAU ( 
  ...
  nor2   g05(.a(x09), .b(new_n39_), .O(new_n40_));
  ...
  nand4  g25(.a(new_n59_), .b(new_n49_), .c(new_n47_), .d(x04), .O(new_n60_));
  inv1   g26(.a(new_n60_), .O(z04));
  nand3  g27(.a(new_n56_), .b(new_n49_), .c(x08), .O(new_n62_));
  nand2  g28(.a(x16), .b(new_n35_), .O(new_n63_));
  ...
  nand2  g34(.a(x04), .b(new_n35_), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n67_), .c(new_n68_), .O(new_n70_));
  nand3  g36(.a(new_n57_), .b(new_n36_), .c(x08), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x04), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(new_n70_), .c(new_n39_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n66_), .O(z05));
  oai21  g40(.a(new_n70_), .b(new_n44_), .c(new_n47_), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand3  g42(.a(new_n57_), .b(new_n76_), .c(x08), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(x01), .c(new_n36_), .O(new_n79_));
  nand2  g45(.a(new_n71_), .b(x10), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n75_), .O(z06));
  ...
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n36_), .O(new_n86_));
  oai21  g52(.a(new_n78_), .b(new_n82_), .c(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n39_), .O(new_n88_));
  nand2  g54(.a(x11), .b(x09), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n75_), .O(z07));
  nand3  g56(.a(new_n85_), .b(new_n57_), .c(x08), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x12), .O(new_n92_));
  nor2   g58(.a(x12), .b(x11), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n84_), .c(new_n76_), .d(new_n36_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n39_), .O(new_n96_));
  nand2  g62(.a(x12), .b(x09), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n75_), .O(z08));
  inv1   g64(.a(x12), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand4  g66(.a(new_n49_), .b(new_n100_), .c(new_n99_), .d(new_n82_), .O(new_n101_));
  nor2   g67(.a(new_n101_), .b(x10), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(x08), .c(x07), .d(x06), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n44_), .c(new_n39_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n36_), .O(new_n105_));
  nand2  g71(.a(new_n94_), .b(x13), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(new_n105_), .c(new_n75_), .O(z09));
  inv1   g73(.a(x00), .O(new_n108_));
  aoi21  g74(.a(new_n67_), .b(x02), .c(new_n68_), .O(new_n109_));
  nand3  g75(.a(new_n85_), .b(new_n100_), .c(new_n99_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n108_), .c(new_n109_), .O(new_n111_));
  nand4  g77(.a(new_n111_), .b(new_n36_), .c(x08), .d(x07), .O(new_n112_));
  nand2  g78(.a(new_n109_), .b(x14), .O(new_n113_));
  oai21  g79(.a(new_n112_), .b(new_n48_), .c(new_n113_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n39_), .O(new_n115_));
  nand3  g81(.a(new_n109_), .b(x14), .c(x09), .O(new_n116_));
  aoi21  g82(.a(new_n116_), .b(new_n115_), .c(new_n44_), .O(z10));
  nor2   g83(.a(new_n40_), .b(new_n35_), .O(z11));
  nor2   g84(.a(new_n40_), .b(new_n68_), .O(new_n119_));
  aoi21  g85(.a(new_n119_), .b(new_n35_), .c(x03), .O(new_n120_));
  oai21  g86(.a(new_n120_), .b(new_n44_), .c(new_n47_), .O(z12));
  nor2   g87(.a(new_n40_), .b(new_n44_), .O(z13));
  inv1   g88(.a(x17), .O(new_n123_));
  nor3   g89(.a(new_n40_), .b(new_n123_), .c(new_n44_), .O(z14));
endmodule
