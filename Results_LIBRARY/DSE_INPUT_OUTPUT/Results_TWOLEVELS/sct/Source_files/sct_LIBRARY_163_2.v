...
module FAU ( 
  ...
  aoi21  g27(.a(new_n55_), .b(x09), .c(new_n61_), .O(new_n62_));
  oai21  g28(.a(new_n62_), .b(new_n54_), .c(x04), .O(z05));
  ...
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n58_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x06), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(x04), .O(z06));
  inv1   g36(.a(x16), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(x02), .c(x06), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x04), .O(new_n73_));
  nand2  g39(.a(new_n67_), .b(x11), .O(new_n74_));
  inv1   g40(.a(x11), .O(new_n75_));
  nand4  g41(.a(new_n66_), .b(new_n75_), .c(new_n65_), .d(new_n59_), .O(new_n76_));
  nand3  g42(.a(x16), .b(x06), .c(x03), .O(new_n77_));
  and2   g43(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n75_), .d(new_n65_), .O(new_n83_));
  and2   g49(.a(new_n83_), .b(new_n77_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n80_), .c(new_n73_), .d(x04), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n48_), .b(new_n86_), .c(new_n81_), .d(new_n75_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n59_), .c(x08), .d(x07), .O(new_n89_));
  nand2  g55(.a(x16), .b(new_n37_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(x06), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  nand2  g58(.a(new_n77_), .b(x04), .O(new_n93_));
  aoi21  g59(.a(new_n83_), .b(x13), .c(new_n93_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(new_n92_), .O(z09));
  inv1   g61(.a(x00), .O(new_n96_));
  nand4  g62(.a(new_n86_), .b(new_n81_), .c(new_n75_), .d(new_n65_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n48_), .c(new_n59_), .d(x08), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n47_), .c(new_n48_), .d(new_n40_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x06), .c(x04), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(z10));
  nor2   g68(.a(z02), .b(new_n37_), .O(z11));
  nand2  g69(.a(new_n90_), .b(new_n56_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x06), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z12));
  nor2   g72(.a(new_n54_), .b(new_n35_), .O(z13));
