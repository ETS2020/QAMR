...
module FAU ( 
  ...
  nand2  g39(.a(new_n53_), .b(new_n44_), .O(z13));
  ...
  nand4  g56(.a(new_n56_), .b(new_n90_), .c(new_n87_), .d(new_n82_), .O(new_n91_));
  ...
  aoi21  g64(.a(new_n48_), .b(x02), .c(new_n39_), .O(new_n99_));
  ...
  oai22  g68(.a(new_n102_), .b(new_n47_), .c(new_n56_), .d(new_n36_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n53_), .O(z10));
  nor2   g71(.a(new_n40_), .b(new_n55_), .O(z11));
  nand3  g72(.a(x16), .b(new_n55_), .c(x01), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n53_), .O(z12));
