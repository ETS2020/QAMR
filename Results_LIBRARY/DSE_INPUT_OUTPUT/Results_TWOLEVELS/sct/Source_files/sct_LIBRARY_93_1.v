...
module FAU ( 
  ...
  oai22  g68(.a(new_n102_), .b(new_n49_), .c(new_n51_), .d(new_n38_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n50_), .O(z10));
  nor2   g71(.a(new_n41_), .b(new_n35_), .O(z11));
  nor2   g72(.a(new_n41_), .b(new_n98_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n35_), .c(x03), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(new_n46_), .c(new_n50_), .O(z12));
  nand2  g75(.a(new_n50_), .b(new_n46_), .O(z13));
