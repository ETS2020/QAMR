...
module FAU ( 
  ...
  oai21  g10(.a(new_n36_), .b(x15), .c(new_n35_), .O(new_n45_));
  ...
  nand4  g23(.a(new_n57_), .b(new_n48_), .c(new_n37_), .d(x04), .O(new_n58_));
  ...
  aoi21  g46(.a(new_n80_), .b(new_n63_), .c(new_n38_), .O(z07));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n63_), .c(new_n38_), .O(z08));
  ...
  oai22  g66(.a(new_n100_), .b(new_n47_), .c(new_n48_), .d(new_n42_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n37_), .O(z10));
  nor2   g69(.a(new_n38_), .b(new_n39_), .O(z11));
  nor3   g70(.a(new_n38_), .b(new_n96_), .c(x02), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(x03), .c(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n37_), .O(z12));
  nor2   g73(.a(new_n38_), .b(new_n61_), .O(z13));
