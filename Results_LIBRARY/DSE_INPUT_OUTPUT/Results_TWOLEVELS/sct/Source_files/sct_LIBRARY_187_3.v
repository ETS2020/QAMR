...
module FAU ( 
  ...
  nand3  g12(.a(new_n46_), .b(new_n44_), .c(new_n35_), .O(z01));
  ...
  oai21  g34(.a(new_n68_), .b(new_n64_), .c(new_n35_), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  inv1   g36(.a(x17), .O(new_n71_));
  oai21  g37(.a(x13), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(x13), .c(x09), .O(new_n73_));
  ...
  aoi21  g47(.a(x17), .b(x13), .c(new_n81_), .O(z06));
  oai21  g48(.a(new_n64_), .b(new_n45_), .c(new_n35_), .O(new_n83_));
  nand2  g49(.a(new_n79_), .b(x11), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nand4  g51(.a(new_n67_), .b(new_n85_), .c(new_n70_), .d(new_n65_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n83_), .d(new_n35_), .O(z07));
  nand2  g53(.a(new_n86_), .b(x12), .O(new_n88_));
  nor2   g54(.a(x12), .b(x11), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n78_), .c(new_n67_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n88_), .c(new_n83_), .d(new_n35_), .O(z08));
  inv1   g57(.a(x12), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n49_), .b(new_n93_), .c(new_n92_), .d(new_n85_), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n70_), .c(x04), .O(new_n96_));
  nand3  g62(.a(new_n71_), .b(x13), .c(x10), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(x09), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(x08), .c(x07), .d(x06), .O(new_n99_));
  nand3  g65(.a(new_n89_), .b(new_n67_), .c(new_n65_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n71_), .c(x13), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n99_), .c(new_n83_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand2  g69(.a(new_n61_), .b(x02), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(x16), .c(x09), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  oai22  g72(.a(new_n106_), .b(new_n103_), .c(new_n49_), .d(new_n37_), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n35_), .O(new_n108_));
  nor3   g74(.a(new_n94_), .b(x10), .c(x09), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(x08), .c(x07), .d(x06), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n108_), .c(new_n45_), .O(z10));
  nand2  g77(.a(new_n35_), .b(new_n39_), .O(z11));
  oai21  g78(.a(new_n62_), .b(x02), .c(new_n61_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n35_), .c(x04), .O(new_n114_));
  inv1   g80(.a(new_n114_), .O(z12));
  aoi21  g81(.a(x17), .b(x13), .c(new_n45_), .O(z13));
  nand3  g82(.a(x17), .b(new_n93_), .c(x04), .O(new_n117_));
