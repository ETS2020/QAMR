...
module FAU ( 
  ...
  oai21  g33(.a(new_n67_), .b(new_n63_), .c(new_n47_), .O(new_n68_));
  ...
  aoi21  g43(.a(new_n77_), .b(new_n62_), .c(new_n39_), .O(z06));
  nor2   g44(.a(new_n63_), .b(new_n43_), .O(new_n79_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n79_), .d(new_n47_), .O(z07));
  ...
  nand2  g57(.a(new_n91_), .b(new_n47_), .O(new_n92_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n85_), .c(new_n82_), .d(new_n81_), .O(new_n96_));
  ...
  aoi21  g66(.a(new_n60_), .b(x02), .c(new_n100_), .O(new_n101_));
  nor2   g67(.a(x13), .b(x12), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n82_), .c(new_n81_), .d(new_n38_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n93_), .c(new_n101_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n64_), .c(x08), .d(x07), .O(new_n105_));
  nor2   g71(.a(new_n105_), .b(new_n46_), .O(new_n106_));
  aoi21  g72(.a(new_n101_), .b(x14), .c(new_n106_), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(new_n43_), .c(new_n47_), .O(z10));
  nor2   g74(.a(new_n39_), .b(new_n35_), .O(z11));
  nor2   g75(.a(new_n39_), .b(new_n100_), .O(new_n110_));
