...
module FAU ( 
  ...
  nand2  g30(.a(x04), .b(new_n38_), .O(new_n65_));
  aoi21  g31(.a(new_n65_), .b(new_n63_), .c(new_n64_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n46_), .c(new_n49_), .O(new_n67_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(new_n49_), .O(z05));
  ...
  aoi21  g42(.a(new_n71_), .b(x10), .c(new_n76_), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(new_n73_), .c(new_n37_), .O(z06));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n73_), .c(new_n37_), .O(z07));
  nand2  g51(.a(new_n82_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n74_), .b(new_n81_), .c(new_n87_), .d(new_n80_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n67_), .d(new_n49_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n51_), .b(new_n90_), .c(new_n87_), .d(new_n80_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x10), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n70_), .c(x08), .d(x07), .O(new_n93_));
  nand2  g59(.a(x16), .b(new_n38_), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n50_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x04), .O(new_n96_));
  oai21  g62(.a(new_n64_), .b(new_n63_), .c(x04), .O(new_n97_));
  aoi21  g63(.a(new_n88_), .b(x13), .c(new_n97_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n96_), .c(new_n37_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  nand4  g66(.a(new_n90_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  and2   g68(.a(new_n102_), .b(new_n51_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n70_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n50_), .c(new_n51_), .d(new_n41_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n49_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z10));
  nor2   g73(.a(new_n37_), .b(new_n38_), .O(z11));
  nand2  g74(.a(new_n94_), .b(new_n63_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n49_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  aoi21  g77(.a(x17), .b(x15), .c(new_n46_), .O(z13));
  aoi21  g78(.a(new_n35_), .b(new_n46_), .c(new_n36_), .O(z14));
endmodule
