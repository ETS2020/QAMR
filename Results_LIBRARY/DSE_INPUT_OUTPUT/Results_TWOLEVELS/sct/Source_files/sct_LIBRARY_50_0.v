...
module FAU ( 
  ...
  oai21  g33(.a(new_n67_), .b(new_n63_), .c(new_n45_), .O(new_n68_));
  nand3  g34(.a(new_n48_), .b(x04), .c(x00), .O(new_n69_));
  aoi21  g35(.a(new_n69_), .b(new_n35_), .c(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(x08), .c(x07), .d(x06), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n68_), .O(z05));
  nor2   g38(.a(new_n63_), .b(new_n41_), .O(new_n73_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n73_), .d(new_n45_), .O(z06));
  ...
  aoi21  g49(.a(new_n83_), .b(new_n62_), .c(new_n42_), .O(z07));
  nand2  g50(.a(new_n81_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n76_), .b(new_n66_), .c(new_n86_), .d(new_n80_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n73_), .d(new_n45_), .O(z08));
  nand2  g54(.a(new_n87_), .b(x13), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n62_), .c(x04), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n45_), .O(new_n91_));
  inv1   g57(.a(x00), .O(new_n92_));
  nand3  g58(.a(new_n48_), .b(x04), .c(x01), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n86_), .c(new_n80_), .d(new_n79_), .O(new_n95_));
  ...
  nand2  g64(.a(new_n79_), .b(x01), .O(new_n99_));
  inv1   g65(.a(x13), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n86_), .c(new_n80_), .O(new_n101_));
  ...
  nand4  g72(.a(new_n106_), .b(new_n45_), .c(x16), .d(x14), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n105_), .c(new_n41_), .O(z10));
  nor2   g74(.a(new_n42_), .b(new_n47_), .O(z11));
  nand3  g75(.a(new_n45_), .b(x16), .c(new_n47_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n45_), .O(z12));
  nand2  g79(.a(new_n45_), .b(new_n41_), .O(z13));
  nand2  g80(.a(x17), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n45_), .O(z14));
endmodule
