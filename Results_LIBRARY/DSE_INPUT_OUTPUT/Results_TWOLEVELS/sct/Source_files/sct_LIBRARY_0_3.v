...
module FAU ( 
  ...
  nand3  g22(.a(new_n35_), .b(new_n49_), .c(x02), .O(new_n57_));
  ...
  oai21  g36(.a(new_n45_), .b(x02), .c(new_n49_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(x16), .c(new_n35_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n70_), .O(z05));
  nand2  g39(.a(new_n38_), .b(new_n45_), .O(new_n74_));
  oai21  g40(.a(new_n71_), .b(x15), .c(x16), .O(new_n75_));
  nand2  g41(.a(new_n68_), .b(x10), .O(new_n76_));
  nor2   g42(.a(x10), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n60_), .c(x08), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(z06));
  ...
  nand2  g50(.a(new_n84_), .b(new_n72_), .O(z07));
  ...
  oai21  g57(.a(new_n91_), .b(new_n87_), .c(new_n38_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n72_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n58_), .b(new_n94_), .c(new_n86_), .d(new_n88_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x10), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n67_), .c(x08), .d(x07), .O(new_n97_));
  nand3  g63(.a(x16), .b(new_n35_), .c(new_n40_), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n48_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  aoi21  g66(.a(new_n35_), .b(new_n49_), .c(new_n36_), .O(new_n101_));
  aoi21  g67(.a(new_n90_), .b(x13), .c(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n100_), .c(new_n74_), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  inv1   g70(.a(x10), .O(new_n105_));
  nand4  g71(.a(new_n94_), .b(new_n86_), .c(new_n88_), .d(new_n105_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(new_n58_), .c(new_n67_), .d(x08), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(x07), .c(x06), .O(new_n110_));
  nand3  g76(.a(new_n50_), .b(new_n35_), .c(x14), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n110_), .c(new_n45_), .O(z10));
  nor2   g78(.a(new_n37_), .b(new_n40_), .O(z11));
  nand2  g79(.a(new_n98_), .b(new_n49_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n38_), .O(z12));
  nor2   g82(.a(new_n37_), .b(new_n45_), .O(z13));
