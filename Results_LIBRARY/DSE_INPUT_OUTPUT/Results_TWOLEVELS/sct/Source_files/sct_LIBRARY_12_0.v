...
module FAU ( 
  ...
  nand3  g37(.a(new_n50_), .b(x04), .c(x00), .O(new_n72_));
  aoi21  g38(.a(new_n72_), .b(new_n71_), .c(x09), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(x08), .c(x07), .d(x06), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(new_n70_), .O(z05));
  nor2   g41(.a(new_n65_), .b(new_n45_), .O(new_n76_));
  nand3  g42(.a(new_n57_), .b(new_n66_), .c(x08), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x10), .O(new_n78_));
  nor2   g44(.a(x10), .b(x09), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n57_), .c(x08), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n78_), .c(new_n76_), .d(new_n48_), .O(z06));
  ...
  nand2  g69(.a(new_n62_), .b(x02), .O(new_n104_));
  inv1   g70(.a(x13), .O(new_n105_));
  nand4  g71(.a(new_n82_), .b(x17), .c(new_n105_), .d(new_n88_), .O(new_n106_));
  aoi22  g72(.a(new_n106_), .b(new_n97_), .c(new_n104_), .d(x16), .O(new_n107_));
  ...
  nor2   g77(.a(new_n40_), .b(new_n35_), .O(z11));
  nand3  g78(.a(new_n48_), .b(x16), .c(new_n35_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n62_), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(x04), .O(new_n115_));
  nand2  g81(.a(new_n115_), .b(new_n48_), .O(z12));
  nand2  g82(.a(new_n48_), .b(new_n45_), .O(z13));
  nor2   g83(.a(new_n71_), .b(new_n45_), .O(z14));
endmodule
