...
module FAU ( 
  ...
  aoi21  g28(.a(x04), .b(new_n40_), .c(x03), .O(new_n63_));
  ...
  nor3   g36(.a(new_n70_), .b(new_n66_), .c(x07), .O(new_n71_));
  aoi21  g37(.a(new_n69_), .b(x07), .c(new_n71_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n65_), .O(z05));
  inv1   g39(.a(x10), .O(new_n74_));
  inv1   g40(.a(new_n68_), .O(new_n75_));
  nand3  g41(.a(new_n67_), .b(new_n74_), .c(new_n66_), .O(new_n76_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n65_), .O(z06));
  oai21  g46(.a(new_n70_), .b(x11), .c(new_n56_), .O(new_n81_));
  ...
  nand3  g51(.a(new_n85_), .b(new_n81_), .c(new_n65_), .O(z07));
  oai21  g52(.a(new_n70_), .b(x12), .c(new_n56_), .O(new_n87_));
  nand2  g53(.a(new_n84_), .b(new_n67_), .O(new_n88_));
  inv1   g54(.a(x11), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n74_), .d(new_n66_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(new_n82_), .O(new_n92_));
  aoi21  g58(.a(new_n88_), .b(x12), .c(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n87_), .c(new_n65_), .O(z08));
  inv1   g60(.a(x13), .O(new_n95_));
  nand4  g61(.a(new_n50_), .b(new_n95_), .c(new_n90_), .d(new_n89_), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n74_), .c(new_n66_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(x07), .c(x06), .d(x04), .O(new_n100_));
  aoi21  g66(.a(x17), .b(new_n95_), .c(x07), .O(new_n101_));
  nand4  g67(.a(new_n75_), .b(new_n90_), .c(new_n89_), .d(new_n74_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(x13), .c(new_n101_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n100_), .c(new_n65_), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  inv1   g71(.a(x03), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(x02), .c(new_n62_), .O(new_n107_));
  nand4  g73(.a(new_n95_), .b(new_n90_), .c(new_n89_), .d(new_n74_), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n105_), .c(new_n107_), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n66_), .c(x08), .d(x07), .O(new_n110_));
  oai22  g76(.a(new_n110_), .b(new_n49_), .c(new_n50_), .d(new_n38_), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n36_), .O(z10));
  nand2  g79(.a(new_n36_), .b(new_n40_), .O(z11));
  oai21  g80(.a(new_n62_), .b(x02), .c(new_n106_), .O(new_n115_));
  nand3  g81(.a(new_n115_), .b(new_n36_), .c(x04), .O(new_n116_));
  inv1   g82(.a(new_n116_), .O(z12));
  nor2   g83(.a(new_n35_), .b(new_n46_), .O(z13));
  nor2   g84(.a(new_n70_), .b(new_n46_), .O(z14));
endmodule
