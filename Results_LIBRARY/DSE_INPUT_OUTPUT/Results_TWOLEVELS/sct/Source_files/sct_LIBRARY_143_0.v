...
module FAU ( 
  ...
  nor2   g08(.a(x18), .b(x01), .O(new_n43_));
  ...
  oai21  g29(.a(new_n63_), .b(new_n42_), .c(new_n47_), .O(new_n64_));
  ...
  aoi21  g39(.a(new_n68_), .b(x10), .c(new_n73_), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(new_n70_), .c(new_n43_), .O(z06));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n64_), .d(new_n47_), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n64_), .d(new_n47_), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n48_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n67_), .c(x08), .d(x07), .O(new_n89_));
  nand2  g55(.a(x16), .b(new_n35_), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n46_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  aoi21  g58(.a(x16), .b(x03), .c(new_n42_), .O(new_n93_));
  nand2  g59(.a(new_n84_), .b(x13), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n47_), .O(z09));
  ...
  and2   g64(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n67_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n46_), .c(new_n48_), .d(new_n37_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(new_n47_), .c(x04), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(z10));
  nand2  g69(.a(new_n47_), .b(new_n35_), .O(z11));
  nand2  g70(.a(new_n90_), .b(new_n60_), .O(new_n105_));
  nand3  g71(.a(new_n105_), .b(new_n47_), .c(x04), .O(new_n106_));
  inv1   g72(.a(new_n106_), .O(z12));
  nand2  g73(.a(new_n47_), .b(new_n42_), .O(z13));
  inv1   g74(.a(x17), .O(new_n109_));
  nor3   g75(.a(new_n43_), .b(new_n109_), .c(new_n42_), .O(z14));
endmodule
