...
module FAU ( 
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n45_), .O(z05));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n65_), .d(new_n45_), .O(z08));
  ...
  nand2  g63(.a(new_n97_), .b(new_n45_), .O(z10));
  nor2   g64(.a(new_n36_), .b(new_n37_), .O(z11));
  nor2   g65(.a(new_n36_), .b(new_n48_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n37_), .c(x03), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n42_), .c(new_n45_), .O(z12));
  nand2  g68(.a(new_n45_), .b(new_n42_), .O(z13));
