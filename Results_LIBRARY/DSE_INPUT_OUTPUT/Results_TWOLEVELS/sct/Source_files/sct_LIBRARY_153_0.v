...
module FAU ( 
  ...
  nand2  g05(.a(new_n35_), .b(new_n36_), .O(new_n40_));
  ...
  nand4  g16(.a(new_n50_), .b(new_n40_), .c(new_n48_), .d(x04), .O(new_n51_));
  ...
  oai21  g35(.a(new_n69_), .b(new_n65_), .c(new_n40_), .O(new_n70_));
  ...
  oai21  g40(.a(new_n65_), .b(new_n45_), .c(new_n40_), .O(new_n75_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n40_), .O(z06));
  ...
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n75_), .d(new_n40_), .O(z07));
  inv1   g51(.a(new_n65_), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n78_), .b(new_n68_), .c(new_n87_), .d(new_n83_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  aoi21  g55(.a(new_n84_), .b(x12), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n86_), .c(new_n41_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n50_), .b(new_n92_), .c(new_n87_), .d(new_n83_), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n82_), .c(new_n66_), .d(x08), .O(new_n95_));
  inv1   g61(.a(new_n95_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x07), .c(x06), .d(x04), .O(new_n97_));
  aoi21  g63(.a(new_n88_), .b(x13), .c(new_n41_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n75_), .O(z09));
  aoi21  g65(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n100_));
  nand4  g66(.a(new_n92_), .b(new_n87_), .c(new_n83_), .d(new_n82_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n36_), .c(new_n100_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n66_), .c(x08), .d(x07), .O(new_n103_));
  oai22  g69(.a(new_n103_), .b(new_n48_), .c(new_n50_), .d(new_n37_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n40_), .O(z10));
  nand2  g72(.a(new_n40_), .b(new_n49_), .O(z11));
  nor3   g73(.a(new_n41_), .b(new_n63_), .c(x02), .O(new_n108_));
  oai21  g74(.a(new_n108_), .b(x03), .c(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n40_), .O(z12));
  nand2  g76(.a(new_n40_), .b(new_n45_), .O(z13));
  nand2  g77(.a(new_n40_), .b(x17), .O(new_n112_));
  nor2   g78(.a(new_n112_), .b(new_n45_), .O(z14));
endmodule
