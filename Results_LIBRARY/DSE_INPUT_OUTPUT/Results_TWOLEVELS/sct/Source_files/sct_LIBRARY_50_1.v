...
module FAU ( 
  ...
  aoi21  g50(.a(new_n84_), .b(new_n79_), .c(new_n43_), .O(z07));
  nand2  g51(.a(new_n82_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n76_), .b(new_n66_), .c(new_n87_), .d(new_n81_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n73_), .d(new_n46_), .O(z08));
  nand2  g55(.a(new_n88_), .b(x13), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n79_), .c(x04), .O(new_n91_));
  ...
  nand4  g60(.a(new_n94_), .b(new_n87_), .c(new_n81_), .d(new_n80_), .O(new_n95_));
  ...
  nand4  g65(.a(new_n99_), .b(new_n81_), .c(new_n80_), .d(new_n42_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n35_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n48_), .c(new_n64_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x07), .c(x06), .O(new_n104_));
  nand2  g70(.a(new_n60_), .b(x02), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n46_), .c(x16), .d(x14), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n104_), .c(new_n41_), .O(z10));
  nor2   g73(.a(new_n43_), .b(new_n36_), .O(z11));
  nor2   g74(.a(new_n43_), .b(new_n61_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n36_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n41_), .c(new_n46_), .O(z12));
