...
module FAU ( 
  ...
  nor2   g06(.a(new_n37_), .b(x01), .O(new_n41_));
  ...
  nand3  g36(.a(new_n58_), .b(new_n67_), .c(x08), .O(new_n71_));
  inv1   g37(.a(new_n71_), .O(new_n72_));
  nor4   g38(.a(new_n72_), .b(new_n70_), .c(new_n66_), .d(new_n45_), .O(new_n73_));
  nor2   g39(.a(new_n73_), .b(new_n41_), .O(z05));
  oai21  g40(.a(new_n66_), .b(new_n45_), .c(new_n49_), .O(new_n75_));
  nand3  g41(.a(new_n71_), .b(x10), .c(x01), .O(new_n76_));
  nand4  g42(.a(new_n58_), .b(new_n37_), .c(new_n67_), .d(x08), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(z06));
  inv1   g44(.a(x11), .O(new_n79_));
  nor2   g45(.a(new_n72_), .b(new_n79_), .O(new_n80_));
  nor4   g46(.a(new_n57_), .b(x11), .c(x09), .d(new_n56_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n80_), .c(new_n37_), .O(new_n82_));
  nand3  g48(.a(x11), .b(x10), .c(x01), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n75_), .O(z07));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n69_), .b(new_n85_), .c(new_n79_), .d(new_n67_), .O(new_n86_));
  oai21  g52(.a(new_n81_), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n37_), .O(new_n88_));
  nand3  g54(.a(x12), .b(x10), .c(x01), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n75_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n50_), .b(new_n91_), .c(new_n85_), .d(new_n79_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(x09), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(x08), .c(x07), .d(x06), .O(new_n94_));
  nand2  g60(.a(new_n86_), .b(x13), .O(new_n95_));
  oai21  g61(.a(new_n94_), .b(new_n45_), .c(new_n95_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n37_), .O(new_n97_));
  nand3  g63(.a(x13), .b(x10), .c(x01), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n97_), .c(new_n75_), .O(z09));
  inv1   g65(.a(x00), .O(new_n100_));
  aoi21  g66(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n101_));
  nand4  g67(.a(new_n91_), .b(new_n85_), .c(new_n79_), .d(new_n37_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n101_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n67_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n48_), .c(new_n50_), .d(new_n38_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n49_), .O(z10));
  nand2  g73(.a(new_n49_), .b(new_n35_), .O(z11));
  nor2   g74(.a(new_n41_), .b(new_n64_), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(new_n35_), .c(x03), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(new_n45_), .c(new_n49_), .O(z12));
  nand2  g77(.a(new_n49_), .b(new_n45_), .O(z13));
