...
module FAU ( 
  ...
  aoi21  g44(.a(new_n78_), .b(new_n63_), .c(new_n40_), .O(z06));
  nor2   g45(.a(new_n64_), .b(new_n44_), .O(new_n80_));
  ...
  nand4  g50(.a(new_n84_), .b(new_n81_), .c(new_n80_), .d(new_n48_), .O(z07));
  ...
  aoi21  g55(.a(new_n89_), .b(new_n63_), .c(new_n40_), .O(z08));
  ...
  nand3  g59(.a(new_n49_), .b(x04), .c(new_n39_), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n35_), .c(x13), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n86_), .c(new_n83_), .d(new_n82_), .O(new_n96_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n83_), .c(new_n82_), .d(new_n39_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n35_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n49_), .c(new_n65_), .d(x08), .O(new_n103_));
  inv1   g69(.a(new_n103_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(x07), .c(x06), .O(new_n105_));
  nand2  g71(.a(new_n61_), .b(x02), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n48_), .c(x16), .d(x14), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n105_), .c(new_n44_), .O(z10));
  nor2   g74(.a(new_n40_), .b(new_n36_), .O(z11));
  inv1   g75(.a(x16), .O(new_n110_));
  oai21  g76(.a(new_n110_), .b(x02), .c(new_n61_), .O(new_n111_));
  nand3  g77(.a(new_n111_), .b(new_n48_), .c(x04), .O(new_n112_));
  inv1   g78(.a(new_n112_), .O(z12));
  nand2  g79(.a(new_n48_), .b(new_n44_), .O(z13));
