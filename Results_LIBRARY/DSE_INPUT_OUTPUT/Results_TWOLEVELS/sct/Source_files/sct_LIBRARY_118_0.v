...
module FAU ( 
  ...
  nor2   g06(.a(x16), .b(x14), .O(new_n41_));
  ...
  oai21  g16(.a(x16), .b(new_n35_), .c(new_n50_), .O(new_n51_));
  ...
  nand2  g23(.a(new_n49_), .b(x02), .O(new_n58_));
  ...
  oai21  g31(.a(new_n58_), .b(new_n45_), .c(x16), .O(new_n66_));
  ...
  oai21  g52(.a(new_n86_), .b(new_n73_), .c(x16), .O(new_n87_));
  nand2  g53(.a(new_n86_), .b(x14), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n87_), .O(z07));
  nand2  g55(.a(new_n85_), .b(x12), .O(new_n90_));
  inv1   g56(.a(x12), .O(new_n91_));
  nand4  g57(.a(new_n75_), .b(new_n84_), .c(new_n91_), .d(new_n83_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n90_), .c(new_n71_), .d(new_n66_), .O(z08));
  nand2  g59(.a(new_n57_), .b(new_n45_), .O(z13));
  inv1   g60(.a(x13), .O(new_n95_));
  nand2  g61(.a(new_n50_), .b(new_n35_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n91_), .d(new_n83_), .O(new_n97_));
  nor2   g63(.a(new_n97_), .b(x10), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n69_), .c(x08), .d(x07), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n48_), .c(new_n59_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x04), .O(new_n101_));
  aoi21  g67(.a(new_n92_), .b(x13), .c(new_n41_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(z13), .O(z09));
  inv1   g69(.a(x00), .O(new_n104_));
  nand4  g70(.a(new_n95_), .b(new_n91_), .c(new_n83_), .d(new_n82_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g72(.a(new_n106_), .b(new_n96_), .c(new_n69_), .d(x08), .O(new_n107_));
  inv1   g73(.a(new_n107_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(x07), .c(x06), .O(new_n109_));
  nand3  g75(.a(new_n58_), .b(x16), .c(x14), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n45_), .O(z10));
  nand2  g77(.a(new_n57_), .b(new_n38_), .O(z11));
  nand2  g78(.a(new_n57_), .b(x03), .O(new_n113_));
  nand2  g79(.a(x16), .b(new_n38_), .O(new_n114_));
  aoi21  g80(.a(new_n114_), .b(new_n113_), .c(new_n45_), .O(z12));
  inv1   g81(.a(x17), .O(new_n116_));
  nor3   g82(.a(new_n41_), .b(new_n116_), .c(new_n45_), .O(z14));
endmodule
