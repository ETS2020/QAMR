...
module FAU ( 
  ...
  aoi21  g28(.a(new_n62_), .b(new_n60_), .c(new_n42_), .O(new_n63_));
  ...
  oai21  g32(.a(new_n42_), .b(x02), .c(new_n48_), .O(new_n67_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n68_), .d(x04), .O(z06));
  ...
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n68_), .d(x04), .O(z07));
  ...
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n68_), .d(x04), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n57_), .b(new_n88_), .c(new_n85_), .d(new_n80_), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(x10), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n71_), .c(x08), .d(x07), .O(new_n91_));
  ...
  oai21  g60(.a(new_n50_), .b(new_n48_), .c(x04), .O(new_n95_));
  ...
  aoi22  g65(.a(new_n99_), .b(new_n98_), .c(new_n49_), .d(x16), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n71_), .c(x08), .d(x07), .O(new_n101_));
  oai22  g67(.a(new_n101_), .b(new_n43_), .c(new_n57_), .d(new_n39_), .O(new_n102_));
  ...
  oai21  g72(.a(new_n106_), .b(new_n42_), .c(new_n53_), .O(z12));
