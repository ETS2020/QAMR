...
module FAU ( 
  ...
  aoi21  g62(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n97_));
  nand4  g63(.a(new_n88_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n96_), .c(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n69_), .c(x08), .d(x07), .O(new_n100_));
  oai22  g66(.a(new_n100_), .b(new_n48_), .c(new_n50_), .d(new_n38_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n49_), .O(z10));
  nor2   g69(.a(new_n41_), .b(new_n35_), .O(z11));
  nor2   g70(.a(new_n41_), .b(new_n63_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n35_), .c(x03), .O(new_n106_));
  oai21  g72(.a(new_n106_), .b(new_n45_), .c(new_n49_), .O(z12));
  nand2  g73(.a(new_n49_), .b(new_n45_), .O(z13));
  nand2  g74(.a(x17), .b(x04), .O(new_n109_));
  nand2  g75(.a(new_n109_), .b(new_n49_), .O(z14));
endmodule
