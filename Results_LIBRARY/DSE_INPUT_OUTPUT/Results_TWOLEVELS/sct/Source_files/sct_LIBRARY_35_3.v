...
module FAU ( 
  ...
  oai21  g30(.a(new_n48_), .b(x02), .c(new_n64_), .O(new_n65_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n68_), .d(new_n38_), .O(z06));
  inv1   g43(.a(x10), .O(new_n78_));
  inv1   g44(.a(x11), .O(new_n79_));
  inv1   g45(.a(new_n69_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n71_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n76_), .b(x11), .c(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n66_), .c(new_n37_), .O(z07));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n66_), .c(new_n37_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n52_), .b(new_n90_), .c(new_n85_), .d(new_n79_), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n78_), .c(new_n71_), .d(x08), .O(new_n93_));
  inv1   g59(.a(new_n93_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x07), .c(x06), .d(x04), .O(new_n95_));
  aoi21  g61(.a(new_n86_), .b(x13), .c(new_n37_), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(new_n68_), .O(z09));
  inv1   g63(.a(x16), .O(new_n98_));
  aoi21  g64(.a(new_n64_), .b(x02), .c(new_n98_), .O(new_n99_));
  nand4  g65(.a(new_n90_), .b(new_n85_), .c(new_n79_), .d(new_n78_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n35_), .c(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n71_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n51_), .c(new_n52_), .d(new_n40_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n38_), .O(z10));
  nor2   g71(.a(new_n37_), .b(new_n42_), .O(z11));
  oai21  g72(.a(new_n98_), .b(x02), .c(new_n64_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n38_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nand2  g75(.a(new_n38_), .b(new_n48_), .O(z13));
  aoi21  g76(.a(new_n48_), .b(new_n35_), .c(new_n36_), .O(z14));
endmodule
