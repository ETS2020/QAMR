...
module FAU ( 
  ...
  nand3  g29(.a(new_n63_), .b(new_n61_), .c(new_n46_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x04), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n59_), .O(z05));
  oai21  g32(.a(x10), .b(new_n41_), .c(new_n35_), .O(new_n67_));
  ...
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n46_), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x04), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n67_), .O(z06));
  oai21  g40(.a(x11), .b(new_n41_), .c(new_n35_), .O(new_n75_));
  inv1   g41(.a(new_n60_), .O(new_n76_));
  nand2  g42(.a(new_n70_), .b(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x11), .O(new_n78_));
  inv1   g44(.a(x10), .O(new_n79_));
  inv1   g45(.a(x11), .O(new_n80_));
  nand2  g46(.a(new_n76_), .b(x06), .O(new_n81_));
  inv1   g47(.a(new_n81_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n62_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n78_), .c(new_n46_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n75_), .O(z07));
  nand2  g52(.a(new_n83_), .b(x12), .O(new_n87_));
  inv1   g53(.a(x12), .O(new_n88_));
  nand4  g54(.a(new_n82_), .b(new_n70_), .c(new_n88_), .d(new_n80_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n87_), .c(new_n46_), .d(x04), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n46_), .b(new_n91_), .c(new_n88_), .d(new_n80_), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(x10), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n62_), .c(x08), .d(x07), .O(new_n94_));
  inv1   g60(.a(new_n46_), .O(new_n95_));
  inv1   g61(.a(new_n68_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n88_), .c(new_n80_), .d(new_n79_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(x13), .c(new_n95_), .O(new_n98_));
  oai21  g64(.a(new_n94_), .b(new_n35_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  oai21  g66(.a(x13), .b(new_n41_), .c(new_n35_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(new_n100_), .O(z09));
  inv1   g68(.a(x00), .O(new_n103_));
  nand4  g69(.a(new_n91_), .b(new_n88_), .c(new_n80_), .d(new_n79_), .O(new_n104_));
  ...
  inv1   g79(.a(new_n112_), .O(new_n114_));
  aoi21  g80(.a(new_n46_), .b(new_n35_), .c(new_n114_), .O(new_n115_));
  oai21  g81(.a(new_n115_), .b(new_n41_), .c(new_n35_), .O(z13));
