...
module FAU ( 
  ...
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n67_), .d(new_n40_), .O(z08));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n65_), .c(new_n41_), .O(z09));
  aoi21  g59(.a(new_n90_), .b(new_n39_), .c(new_n51_), .O(new_n94_));
  ...
  nor2   g66(.a(new_n41_), .b(new_n100_), .O(z11));
  nor3   g67(.a(new_n41_), .b(new_n50_), .c(x02), .O(new_n102_));
  oai21  g68(.a(new_n102_), .b(x03), .c(x04), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n40_), .O(z12));
  nand2  g70(.a(new_n40_), .b(new_n45_), .O(z13));
  nand2  g71(.a(new_n40_), .b(x17), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(new_n45_), .O(z14));
endmodule
