...
module FAU ( 
  ...
  oai21  g32(.a(new_n64_), .b(new_n36_), .c(new_n66_), .O(new_n67_));
  ...
  nand2  g39(.a(x04), .b(new_n65_), .O(new_n74_));
  ...
  oai21  g44(.a(new_n78_), .b(new_n75_), .c(new_n36_), .O(new_n79_));
  oai21  g45(.a(new_n72_), .b(new_n35_), .c(new_n79_), .O(z05));
  oai21  g46(.a(new_n75_), .b(new_n44_), .c(new_n48_), .O(new_n81_));
  ...
  aoi21  g58(.a(new_n92_), .b(new_n86_), .c(new_n40_), .O(z07));
  nand2  g59(.a(new_n90_), .b(x12), .O(new_n94_));
  nor2   g60(.a(x12), .b(x11), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n83_), .c(new_n89_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n94_), .c(new_n81_), .d(new_n48_), .O(z08));
  nand2  g63(.a(new_n96_), .b(x13), .O(new_n98_));
  inv1   g64(.a(new_n77_), .O(new_n99_));
  nor2   g65(.a(x13), .b(x12), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n99_), .c(new_n88_), .d(new_n87_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n98_), .c(new_n81_), .d(new_n48_), .O(z09));
  nand4  g68(.a(new_n100_), .b(new_n88_), .c(new_n87_), .d(new_n36_), .O(new_n103_));
  oai21  g69(.a(new_n35_), .b(new_n36_), .c(new_n103_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n51_), .c(new_n76_), .d(x08), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(new_n106_));
  nand3  g72(.a(new_n106_), .b(x07), .c(x06), .O(new_n107_));
  nand4  g73(.a(new_n50_), .b(new_n48_), .c(x16), .d(x14), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z10));
  nand2  g75(.a(new_n48_), .b(new_n65_), .O(z11));
  nor2   g76(.a(new_n40_), .b(new_n73_), .O(new_n111_));
  aoi21  g77(.a(new_n111_), .b(new_n65_), .c(x03), .O(new_n112_));
  oai21  g78(.a(new_n112_), .b(new_n44_), .c(new_n48_), .O(z12));
  nor2   g79(.a(new_n40_), .b(new_n44_), .O(z13));
