...
module FAU ( 
  ...
  aoi21  g35(.a(new_n69_), .b(new_n63_), .c(new_n39_), .O(z05));
  ...
  nand4  g40(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(new_n38_), .O(z06));
  ...
  aoi21  g52(.a(new_n86_), .b(new_n63_), .c(new_n39_), .O(z08));
  ...
  aoi21  g57(.a(new_n91_), .b(new_n63_), .c(new_n39_), .O(z09));
  ...
  nor2   g65(.a(new_n39_), .b(new_n35_), .O(z11));
  ...
  aoi21  g69(.a(x17), .b(x01), .c(new_n43_), .O(z13));
  inv1   g70(.a(x01), .O(new_n105_));
  nand3  g71(.a(x17), .b(x04), .c(new_n105_), .O(new_n106_));
