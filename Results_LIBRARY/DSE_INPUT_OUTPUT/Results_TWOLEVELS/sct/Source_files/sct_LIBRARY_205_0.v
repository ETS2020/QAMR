...
module FAU ( 
  ...
  nand2  g03(.a(new_n37_), .b(x13), .O(new_n38_));
  oai21  g04(.a(new_n38_), .b(x01), .c(new_n36_), .O(z00));
  nor2   g05(.a(x13), .b(x01), .O(new_n40_));
  ...
  nor2   g36(.a(new_n40_), .b(x09), .O(new_n71_));
  ...
  nand2  g41(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  inv1   g42(.a(x10), .O(new_n77_));
  nand4  g43(.a(new_n57_), .b(new_n77_), .c(new_n66_), .d(x08), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x04), .O(new_n79_));
  aoi21  g45(.a(new_n76_), .b(x10), .c(new_n79_), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(new_n74_), .c(new_n40_), .O(z06));
  nor2   g47(.a(new_n65_), .b(new_n44_), .O(new_n82_));
  nand2  g48(.a(new_n78_), .b(x11), .O(new_n83_));
  inv1   g49(.a(x11), .O(new_n84_));
  nand4  g50(.a(new_n68_), .b(new_n84_), .c(new_n77_), .d(new_n66_), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n47_), .O(z07));
  nand2  g52(.a(new_n85_), .b(x12), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n74_), .c(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  inv1   g55(.a(x12), .O(new_n90_));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n49_), .b(new_n91_), .c(x04), .d(x01), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n84_), .d(new_n77_), .O(new_n94_));
  ...
  nand3  g63(.a(new_n75_), .b(x06), .c(x01), .O(new_n98_));
  nand4  g64(.a(new_n91_), .b(new_n90_), .c(new_n84_), .d(new_n77_), .O(new_n99_));
  oai22  g65(.a(new_n99_), .b(new_n98_), .c(new_n91_), .d(x06), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(new_n49_), .c(x07), .O(new_n101_));
  nand3  g67(.a(new_n47_), .b(x16), .c(new_n35_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(x16), .b(x03), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(x04), .c(new_n40_), .O(new_n106_));
  nand4  g72(.a(new_n57_), .b(x10), .c(new_n66_), .d(x08), .O(new_n107_));
  nor2   g73(.a(x12), .b(x11), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n107_), .c(new_n75_), .d(x07), .O(new_n109_));
  aoi21  g75(.a(new_n109_), .b(x13), .c(new_n106_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n104_), .O(z09));
  inv1   g77(.a(x00), .O(new_n112_));
  nand2  g78(.a(new_n62_), .b(x02), .O(new_n113_));
  aoi21  g79(.a(new_n113_), .b(x16), .c(x09), .O(new_n114_));
  nand4  g80(.a(new_n114_), .b(x08), .c(x07), .d(x06), .O(new_n115_));
  oai22  g81(.a(new_n115_), .b(new_n112_), .c(new_n49_), .d(new_n37_), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand4  g83(.a(new_n49_), .b(new_n91_), .c(new_n90_), .d(new_n84_), .O(new_n118_));
  inv1   g84(.a(new_n118_), .O(new_n119_));
  nand4  g85(.a(new_n119_), .b(new_n77_), .c(new_n66_), .d(x08), .O(new_n120_));
  inv1   g86(.a(new_n120_), .O(new_n121_));
  nand4  g87(.a(new_n121_), .b(x07), .c(x06), .d(x01), .O(new_n122_));
  aoi21  g88(.a(new_n122_), .b(new_n117_), .c(new_n44_), .O(z10));
  nor2   g89(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g90(.a(new_n63_), .b(x02), .c(new_n62_), .O(new_n125_));
  nand3  g91(.a(new_n125_), .b(new_n47_), .c(x04), .O(new_n126_));
  inv1   g92(.a(new_n126_), .O(z12));
  nand2  g93(.a(new_n47_), .b(new_n44_), .O(z13));
  inv1   g94(.a(x17), .O(new_n129_));
  nor3   g95(.a(new_n40_), .b(new_n129_), .c(new_n44_), .O(z14));
endmodule
