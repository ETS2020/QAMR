...
module FAU ( 
  ...
  nand2  g74(.a(new_n36_), .b(new_n44_), .O(z13));
  inv1   g75(.a(x17), .O(new_n110_));
  aoi21  g76(.a(new_n44_), .b(x00), .c(new_n110_), .O(z14));
endmodule
