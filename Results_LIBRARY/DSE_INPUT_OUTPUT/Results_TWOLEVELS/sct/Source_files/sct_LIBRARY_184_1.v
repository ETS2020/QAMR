...
module FAU ( 
  ...
  oai21  g28(.a(new_n43_), .b(x02), .c(new_n49_), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n47_), .c(x16), .O(new_n64_));
  oai21  g30(.a(new_n38_), .b(x00), .c(new_n43_), .O(new_n65_));
  ...
  and2   g41(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n65_), .d(new_n64_), .O(z06));
  ...
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n65_), .d(new_n64_), .O(z07));
  nand2  g49(.a(new_n63_), .b(x16), .O(new_n84_));
  nand2  g50(.a(new_n81_), .b(x12), .O(new_n85_));
  nor2   g51(.a(x12), .b(x11), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n74_), .c(new_n79_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n85_), .c(new_n84_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n65_), .O(z08));
  ...
  aoi21  g60(.a(new_n94_), .b(new_n70_), .c(new_n39_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n91_), .c(new_n65_), .d(new_n64_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  inv1   g63(.a(x12), .O(new_n98_));
  nor2   g64(.a(x15), .b(x13), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n80_), .c(new_n98_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n51_), .c(new_n68_), .d(x08), .O(new_n102_));
  inv1   g68(.a(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(x07), .c(x06), .O(new_n104_));
  nand4  g70(.a(new_n50_), .b(new_n47_), .c(x16), .d(x14), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n43_), .O(z10));
  nor2   g72(.a(new_n39_), .b(new_n35_), .O(z11));
