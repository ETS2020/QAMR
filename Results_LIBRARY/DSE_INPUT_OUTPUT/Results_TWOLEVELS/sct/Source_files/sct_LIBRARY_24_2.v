...
module FAU ( 
  ...
  nand2  g32(.a(x16), .b(new_n49_), .O(new_n67_));
  oai21  g33(.a(new_n66_), .b(new_n36_), .c(new_n67_), .O(new_n68_));
  ...
  aoi21  g40(.a(new_n74_), .b(new_n62_), .c(new_n63_), .O(new_n75_));
  inv1   g41(.a(x09), .O(new_n76_));
  nand3  g42(.a(new_n57_), .b(new_n76_), .c(x08), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n70_), .c(x04), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n75_), .c(new_n36_), .O(new_n79_));
  oai21  g45(.a(new_n73_), .b(new_n35_), .c(new_n79_), .O(z05));
  ...
  nor2   g52(.a(new_n75_), .b(new_n44_), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(x11), .O(new_n88_));
  inv1   g54(.a(x10), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  inv1   g56(.a(new_n69_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n76_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(new_n87_), .d(new_n48_), .O(z07));
  inv1   g59(.a(x12), .O(new_n94_));
  nand4  g60(.a(new_n82_), .b(new_n91_), .c(new_n94_), .d(new_n90_), .O(new_n95_));
  ...
  nand3  g65(.a(new_n99_), .b(new_n81_), .c(x04), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand3  g67(.a(new_n50_), .b(x04), .c(new_n36_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n35_), .c(x13), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n94_), .c(new_n90_), .d(new_n89_), .O(new_n104_));
  nor2   g70(.a(new_n104_), .b(x09), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(x08), .c(x07), .d(x06), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n101_), .O(z09));
  nand2  g73(.a(x01), .b(x00), .O(new_n108_));
  nor2   g74(.a(x13), .b(x12), .O(new_n109_));
  nand4  g75(.a(new_n109_), .b(new_n90_), .c(new_n89_), .d(new_n36_), .O(new_n110_));
  aoi21  g76(.a(new_n110_), .b(new_n108_), .c(new_n64_), .O(new_n111_));
  nand4  g77(.a(new_n111_), .b(new_n76_), .c(x08), .d(x07), .O(new_n112_));
  oai22  g78(.a(new_n112_), .b(new_n47_), .c(new_n50_), .d(new_n37_), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(x04), .O(new_n114_));
  nand2  g80(.a(new_n114_), .b(new_n48_), .O(z10));
  nor2   g81(.a(new_n40_), .b(new_n49_), .O(z11));
  nor2   g82(.a(new_n40_), .b(new_n63_), .O(new_n117_));
  aoi21  g83(.a(new_n117_), .b(new_n49_), .c(x03), .O(new_n118_));
  oai21  g84(.a(new_n118_), .b(new_n44_), .c(new_n48_), .O(z12));
  nor2   g85(.a(new_n40_), .b(new_n44_), .O(z13));
  inv1   g86(.a(x17), .O(new_n121_));
  nor3   g87(.a(new_n40_), .b(new_n121_), .c(new_n44_), .O(z14));
endmodule
