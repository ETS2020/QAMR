...
module FAU ( 
  ...
  nand3  g36(.a(new_n35_), .b(x09), .c(new_n56_), .O(new_n71_));
  ...
  nand3  g43(.a(new_n35_), .b(x10), .c(new_n56_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n77_), .c(new_n65_), .O(z06));
  oai21  g45(.a(x12), .b(x11), .c(new_n56_), .O(new_n80_));
  nand2  g46(.a(new_n75_), .b(x11), .O(new_n81_));
  nor3   g47(.a(x11), .b(x10), .c(x09), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n67_), .c(x06), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n80_), .d(new_n65_), .O(z07));
  aoi21  g50(.a(new_n82_), .b(new_n67_), .c(new_n35_), .O(new_n85_));
  nor4   g51(.a(new_n68_), .b(x12), .c(x11), .d(x10), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n85_), .c(x06), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n65_), .O(z08));
  inv1   g54(.a(x11), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n49_), .b(new_n90_), .c(new_n89_), .d(new_n74_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x09), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(x08), .c(x07), .d(x06), .O(new_n93_));
  nand2  g59(.a(new_n83_), .b(x13), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n46_), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n35_), .O(new_n96_));
  nand3  g62(.a(x13), .b(x12), .c(x06), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n96_), .c(new_n65_), .O(z09));
  inv1   g64(.a(x00), .O(new_n99_));
  inv1   g65(.a(x03), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(x02), .c(new_n62_), .O(new_n101_));
  nand4  g67(.a(new_n90_), .b(new_n35_), .c(new_n89_), .d(new_n74_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n99_), .c(new_n101_), .O(new_n103_));
  nand4  g69(.a(new_n103_), .b(new_n66_), .c(x08), .d(x07), .O(new_n104_));
  oai22  g70(.a(new_n104_), .b(new_n56_), .c(new_n49_), .d(new_n40_), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n52_), .O(z10));
  nor2   g73(.a(new_n36_), .b(new_n37_), .O(z11));
  oai21  g74(.a(new_n62_), .b(x02), .c(new_n100_), .O(new_n109_));
  nand3  g75(.a(new_n109_), .b(new_n52_), .c(x04), .O(new_n110_));
  inv1   g76(.a(new_n110_), .O(z12));
  nand2  g77(.a(new_n52_), .b(new_n46_), .O(z13));
  nand2  g78(.a(x17), .b(x04), .O(new_n113_));
  nand2  g79(.a(new_n113_), .b(new_n52_), .O(z14));
endmodule
