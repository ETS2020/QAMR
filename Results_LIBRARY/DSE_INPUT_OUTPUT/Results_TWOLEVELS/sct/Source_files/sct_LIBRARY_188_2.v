...
module FAU ( 
  ...
  aoi21  g36(.a(new_n70_), .b(new_n64_), .c(new_n40_), .O(z05));
  oai21  g37(.a(new_n63_), .b(new_n44_), .c(new_n39_), .O(new_n72_));
  nand2  g38(.a(new_n68_), .b(x10), .O(new_n73_));
  nor2   g39(.a(x10), .b(x09), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n55_), .c(x08), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n39_), .O(z06));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n64_), .c(new_n40_), .O(z07));
  nand2  g49(.a(new_n80_), .b(x12), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n74_), .b(new_n79_), .c(new_n85_), .d(new_n78_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n84_), .c(new_n72_), .d(new_n39_), .O(z08));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n48_), .b(new_n88_), .c(new_n85_), .d(new_n78_), .O(new_n89_));
  ...
  aoi21  g60(.a(x16), .b(x03), .c(new_n44_), .O(new_n95_));
  nand2  g61(.a(new_n86_), .b(x13), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n39_), .O(z09));
  inv1   g63(.a(x14), .O(new_n98_));
  inv1   g64(.a(x00), .O(new_n99_));
  nand4  g65(.a(new_n88_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n100_));
  ...
  oai22  g69(.a(new_n103_), .b(new_n47_), .c(new_n48_), .d(new_n98_), .O(new_n104_));
  nand3  g70(.a(new_n104_), .b(new_n39_), .c(x04), .O(new_n105_));
  inv1   g71(.a(new_n105_), .O(z10));
  nor2   g72(.a(new_n40_), .b(new_n35_), .O(z11));
  nand2  g73(.a(new_n92_), .b(new_n60_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n39_), .c(x04), .O(new_n109_));
  inv1   g75(.a(new_n109_), .O(z12));
  nor2   g76(.a(new_n40_), .b(new_n44_), .O(z13));
  nor2   g77(.a(new_n36_), .b(new_n44_), .O(z14));
endmodule
