...
module FAU ( 
  ...
  nand3  g17(.a(new_n43_), .b(x06), .c(x04), .O(new_n52_));
  oai21  g18(.a(new_n43_), .b(x06), .c(new_n52_), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(new_n37_), .O(z03));
  inv1   g21(.a(x08), .O(new_n56_));
  nor2   g22(.a(new_n43_), .b(new_n48_), .O(new_n57_));
  ...
  oai21  g27(.a(x09), .b(new_n36_), .c(new_n43_), .O(new_n62_));
  ...
  nand3  g32(.a(new_n66_), .b(new_n64_), .c(new_n49_), .O(new_n67_));
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n49_), .d(x04), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n74_), .c(new_n49_), .d(x04), .O(z07));
  oai21  g48(.a(x12), .b(new_n36_), .c(new_n43_), .O(new_n83_));
  oai21  g49(.a(new_n79_), .b(new_n63_), .c(x12), .O(new_n84_));
  inv1   g50(.a(x12), .O(new_n85_));
  nand4  g51(.a(new_n76_), .b(new_n71_), .c(new_n85_), .d(new_n78_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n84_), .c(new_n49_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n83_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n49_), .b(new_n90_), .c(new_n85_), .d(new_n78_), .O(new_n91_));
  ...
  nand4  g62(.a(new_n90_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n49_), .c(new_n65_), .d(x08), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n48_), .c(x04), .O(new_n100_));
  ...
  nand2  g70(.a(new_n37_), .b(new_n38_), .O(z11));
  aoi21  g71(.a(x16), .b(new_n38_), .c(x03), .O(new_n106_));
  nor2   g72(.a(new_n106_), .b(new_n36_), .O(z12));
  nand2  g73(.a(new_n43_), .b(new_n36_), .O(z13));
