...
module FAU ( 
  ...
  nor2   g06(.a(x17), .b(x01), .O(new_n41_));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n66_), .c(new_n41_), .O(z07));
  nand2  g51(.a(new_n82_), .b(x12), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n76_), .b(new_n81_), .c(new_n87_), .d(new_n80_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n86_), .c(new_n74_), .d(new_n48_), .O(z08));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n50_), .b(new_n90_), .c(new_n87_), .d(new_n80_), .O(new_n91_));
