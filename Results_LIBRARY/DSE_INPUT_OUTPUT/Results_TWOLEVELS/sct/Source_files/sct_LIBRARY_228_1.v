...
module FAU ( 
  ...
  nand3  g23(.a(new_n35_), .b(x08), .c(new_n52_), .O(new_n58_));
  ...
  oai21  g31(.a(x15), .b(x09), .c(new_n52_), .O(new_n66_));
  ...
  oai21  g37(.a(x15), .b(x10), .c(new_n52_), .O(new_n72_));
  ...
  aoi21  g64(.a(new_n35_), .b(new_n93_), .c(x06), .O(new_n99_));
  ...
  oai22  g75(.a(new_n109_), .b(new_n52_), .c(new_n49_), .d(new_n39_), .O(new_n110_));
  ...
  nand2  g82(.a(new_n37_), .b(new_n46_), .O(z13));
