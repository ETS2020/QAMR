...
module FAU ( 
  ...
  aoi21  g43(.a(new_n77_), .b(new_n66_), .c(new_n43_), .O(z06));
  ...
  aoi21  g50(.a(new_n84_), .b(new_n66_), .c(new_n43_), .O(z07));
  ...
  nand4  g65(.a(new_n90_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n40_), .c(new_n99_), .O(new_n101_));
  nand4  g67(.a(new_n101_), .b(new_n71_), .c(x08), .d(x07), .O(new_n102_));
  oai22  g68(.a(new_n102_), .b(new_n51_), .c(new_n52_), .d(new_n38_), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n42_), .O(z10));
  nor2   g71(.a(new_n43_), .b(new_n35_), .O(z11));
  nor3   g72(.a(new_n43_), .b(new_n98_), .c(x02), .O(new_n107_));
  oai21  g73(.a(new_n107_), .b(x03), .c(x04), .O(new_n108_));
  nand2  g74(.a(new_n108_), .b(new_n42_), .O(z12));
  nand2  g75(.a(new_n42_), .b(new_n48_), .O(z13));
  nor2   g76(.a(new_n41_), .b(new_n48_), .O(z14));
endmodule
