...
module FAU ( 
  ...
  nand4  g18(.a(new_n52_), .b(new_n38_), .c(new_n51_), .d(x04), .O(new_n53_));
  ...
  oai21  g31(.a(new_n48_), .b(x02), .c(new_n65_), .O(new_n66_));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n69_), .d(new_n38_), .O(z05));
  nand2  g40(.a(new_n73_), .b(x10), .O(new_n75_));
  nor4   g41(.a(new_n59_), .b(x10), .c(x09), .d(new_n58_), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(new_n48_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n67_), .O(new_n78_));
  and2   g44(.a(new_n78_), .b(new_n38_), .O(z06));
  inv1   g45(.a(new_n70_), .O(new_n80_));
  inv1   g46(.a(x10), .O(new_n81_));
  nand4  g47(.a(new_n80_), .b(new_n36_), .c(new_n81_), .d(new_n72_), .O(new_n82_));
  nor3   g48(.a(x11), .b(x10), .c(x09), .O(new_n83_));
  aoi22  g49(.a(new_n83_), .b(new_n80_), .c(new_n82_), .d(x11), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n69_), .O(z07));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n80_), .b(new_n86_), .c(new_n81_), .d(new_n72_), .O(new_n87_));
  oai21  g53(.a(new_n76_), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n35_), .O(new_n89_));
  nand3  g55(.a(new_n36_), .b(x12), .c(x11), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n89_), .c(new_n69_), .O(z08));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n52_), .b(new_n92_), .c(new_n86_), .d(new_n81_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x09), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(x08), .c(x07), .d(x06), .O(new_n95_));
  nand2  g61(.a(new_n87_), .b(x13), .O(new_n96_));
  oai21  g62(.a(new_n95_), .b(new_n48_), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n35_), .O(new_n98_));
  nand3  g64(.a(new_n36_), .b(x13), .c(x11), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(new_n69_), .O(z09));
  inv1   g66(.a(x00), .O(new_n101_));
  and2   g67(.a(new_n52_), .b(new_n72_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(x08), .c(x07), .d(x06), .O(new_n103_));
  oai22  g69(.a(new_n103_), .b(new_n101_), .c(new_n52_), .d(new_n40_), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n38_), .O(new_n105_));
  nand3  g71(.a(new_n52_), .b(new_n92_), .c(new_n86_), .O(new_n106_));
  nor4   g72(.a(new_n106_), .b(x11), .c(x10), .d(x09), .O(new_n107_));
  nand4  g73(.a(new_n107_), .b(x08), .c(x07), .d(x06), .O(new_n108_));
  aoi21  g74(.a(new_n108_), .b(new_n105_), .c(new_n48_), .O(z10));
  nor2   g75(.a(new_n37_), .b(new_n42_), .O(z11));
  inv1   g76(.a(x16), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(x02), .c(new_n65_), .O(new_n112_));
  nand3  g78(.a(new_n112_), .b(new_n38_), .c(x04), .O(new_n113_));
  inv1   g79(.a(new_n113_), .O(z12));
  nand2  g80(.a(new_n38_), .b(new_n48_), .O(z13));
  nand3  g81(.a(x17), .b(new_n35_), .c(x04), .O(new_n116_));
