...
module FAU ( 
  ...
  nand2  g14(.a(new_n36_), .b(new_n42_), .O(new_n49_));
  ...
  oai21  g34(.a(new_n41_), .b(x02), .c(new_n47_), .O(new_n69_));
  ...
  oai21  g41(.a(new_n75_), .b(new_n43_), .c(new_n70_), .O(z06));
  ...
  nor2   g53(.a(new_n87_), .b(new_n43_), .O(new_n88_));
