...
module FAU ( 
  ...
  aoi21  g26(.a(x04), .b(new_n48_), .c(x03), .O(new_n61_));
  ...
  nand3  g39(.a(new_n66_), .b(new_n72_), .c(new_n64_), .O(new_n74_));
  ...
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n63_), .O(z06));
  and2   g44(.a(new_n74_), .b(x11), .O(new_n79_));
  nor4   g45(.a(new_n65_), .b(x11), .c(x10), .d(x09), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n79_), .c(x08), .O(new_n81_));
  nand3  g47(.a(x11), .b(new_n36_), .c(x01), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n63_), .O(z07));
  inv1   g49(.a(x12), .O(new_n84_));
  inv1   g50(.a(x11), .O(new_n85_));
  nand4  g51(.a(new_n73_), .b(new_n84_), .c(new_n85_), .d(new_n72_), .O(new_n86_));
  oai21  g52(.a(new_n80_), .b(new_n84_), .c(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x08), .O(new_n88_));
  nand3  g54(.a(x12), .b(new_n36_), .c(x01), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n88_), .c(new_n63_), .O(z08));
  inv1   g56(.a(x13), .O(new_n91_));
  nand4  g57(.a(new_n49_), .b(new_n91_), .c(new_n84_), .d(new_n85_), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n72_), .c(new_n64_), .d(x08), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(x07), .c(x06), .d(x04), .O(new_n96_));
  aoi21  g62(.a(new_n91_), .b(x01), .c(x08), .O(new_n97_));
  ...
  nand4  g68(.a(new_n91_), .b(new_n84_), .c(new_n85_), .d(new_n72_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n100_), .c(new_n102_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n64_), .c(x08), .d(x07), .O(new_n105_));
  oai22  g71(.a(new_n105_), .b(new_n47_), .c(new_n49_), .d(new_n37_), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(x04), .O(new_n107_));
  nand2  g73(.a(new_n107_), .b(new_n45_), .O(z10));
  inv1   g74(.a(new_n45_), .O(new_n109_));
  nor2   g75(.a(new_n109_), .b(new_n48_), .O(z11));
  nor3   g76(.a(new_n109_), .b(new_n60_), .c(x02), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(x03), .c(x04), .O(new_n112_));
  nand2  g78(.a(new_n112_), .b(new_n45_), .O(z12));
  nor2   g79(.a(new_n109_), .b(new_n43_), .O(z13));
