...
module FAU ( 
  ...
  nand2  g09(.a(new_n36_), .b(x01), .O(new_n44_));
  ...
  aoi21  g39(.a(new_n73_), .b(new_n62_), .c(new_n59_), .O(z06));
  aoi21  g40(.a(new_n61_), .b(x16), .c(new_n42_), .O(new_n75_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n75_), .d(new_n44_), .O(z07));
  ...
  nand4  g53(.a(new_n47_), .b(new_n87_), .c(new_n82_), .d(new_n78_), .O(new_n88_));
  ...
  aoi21  g59(.a(x16), .b(x03), .c(new_n42_), .O(new_n94_));
  ...
  nand2  g76(.a(new_n44_), .b(x17), .O(new_n111_));
  nor2   g77(.a(new_n111_), .b(new_n42_), .O(z14));
endmodule
