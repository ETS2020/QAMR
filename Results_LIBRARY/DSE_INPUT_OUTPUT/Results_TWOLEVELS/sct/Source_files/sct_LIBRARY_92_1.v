...
module FAU ( 
  ...
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n48_), .d(x04), .O(z05));
  oai21  g32(.a(x10), .b(new_n36_), .c(new_n43_), .O(new_n67_));
  nand3  g33(.a(new_n63_), .b(x08), .c(x07), .O(new_n68_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n48_), .d(x04), .O(z07));
  ...
  aoi21  g57(.a(new_n91_), .b(x13), .c(new_n89_), .O(new_n92_));
  oai21  g58(.a(new_n88_), .b(new_n43_), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x04), .O(new_n94_));
  oai21  g60(.a(x13), .b(new_n36_), .c(new_n43_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n94_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand4  g63(.a(new_n85_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n48_), .c(new_n63_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n89_), .b(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n36_), .O(z10));
