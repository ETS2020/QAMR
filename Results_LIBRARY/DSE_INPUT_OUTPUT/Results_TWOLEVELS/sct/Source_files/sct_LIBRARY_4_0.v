...
module FAU ( 
  ...
  nand3  g37(.a(new_n53_), .b(x04), .c(x00), .O(new_n72_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n89_), .c(new_n76_), .d(new_n40_), .O(z08));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n90_), .c(new_n84_), .d(new_n83_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n77_), .c(x04), .O(new_n95_));
  aoi21  g61(.a(new_n91_), .b(x13), .c(new_n95_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n82_), .c(new_n41_), .O(z09));
  aoi21  g63(.a(new_n94_), .b(new_n38_), .c(new_n52_), .O(new_n98_));
  ...
  nor3   g70(.a(new_n41_), .b(new_n51_), .c(x02), .O(new_n105_));
  oai21  g71(.a(new_n105_), .b(x03), .c(x04), .O(new_n106_));
  nand2  g72(.a(new_n106_), .b(new_n40_), .O(z12));
  nand2  g73(.a(new_n40_), .b(new_n46_), .O(z13));
  nor2   g74(.a(new_n39_), .b(new_n46_), .O(z14));
endmodule
