...
module FAU ( 
  ...
  nand2  g12(.a(new_n46_), .b(x15), .O(new_n47_));
  oai21  g13(.a(new_n45_), .b(new_n38_), .c(new_n47_), .O(z01));
  ...
  nand2  g29(.a(new_n63_), .b(new_n40_), .O(z04));
  oai21  g30(.a(new_n43_), .b(x02), .c(new_n50_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x16), .O(new_n66_));
  nand2  g32(.a(new_n66_), .b(x04), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n40_), .O(new_n68_));
  ...
  nand4  g38(.a(new_n72_), .b(new_n70_), .c(new_n68_), .d(new_n40_), .O(z05));
  ...
  inv1   g47(.a(new_n69_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n71_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n79_), .c(new_n68_), .d(new_n40_), .O(z07));
  nand2  g50(.a(new_n83_), .b(x12), .O(new_n85_));
  inv1   g51(.a(x12), .O(new_n86_));
  nand4  g52(.a(new_n74_), .b(new_n82_), .c(new_n86_), .d(new_n81_), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n85_), .c(new_n68_), .d(new_n40_), .O(z08));
  inv1   g54(.a(x13), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n86_), .c(new_n81_), .d(new_n80_), .O(new_n90_));
  oai21  g56(.a(new_n90_), .b(new_n72_), .c(x04), .O(new_n91_));
  aoi21  g57(.a(new_n87_), .b(x13), .c(new_n91_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n66_), .c(new_n41_), .O(z09));
  aoi21  g59(.a(new_n90_), .b(new_n38_), .c(new_n52_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n71_), .c(x08), .d(x07), .O(new_n95_));
  ...
  nand2  g64(.a(new_n98_), .b(new_n40_), .O(z10));
  nand2  g65(.a(new_n40_), .b(new_n35_), .O(z11));
  nor3   g66(.a(new_n41_), .b(new_n51_), .c(x02), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(x03), .c(x04), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n40_), .O(z12));
  nand2  g69(.a(new_n40_), .b(new_n43_), .O(z13));
  nand2  g70(.a(x17), .b(x04), .O(new_n105_));
  nand2  g71(.a(new_n105_), .b(new_n40_), .O(z14));
endmodule
