...
module FAU ( 
  ...
  nand4  g26(.a(new_n60_), .b(new_n51_), .c(new_n48_), .d(x04), .O(new_n61_));
  ...
  nand4  g69(.a(new_n103_), .b(new_n100_), .c(new_n99_), .d(new_n48_), .O(z09));
  nand4  g70(.a(new_n102_), .b(new_n88_), .c(new_n87_), .d(new_n36_), .O(new_n105_));
  oai21  g71(.a(new_n35_), .b(new_n36_), .c(new_n105_), .O(new_n106_));
  ...
  nand4  g75(.a(new_n50_), .b(new_n48_), .c(x16), .d(x14), .O(new_n110_));
