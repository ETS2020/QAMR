...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(new_n39_), .c(new_n47_), .d(x04), .O(new_n51_));
  ...
  nand4  g25(.a(new_n59_), .b(new_n50_), .c(new_n39_), .d(x04), .O(new_n60_));
  ...
  oai21  g34(.a(new_n68_), .b(new_n64_), .c(new_n39_), .O(new_n69_));
  ...
  aoi21  g45(.a(new_n79_), .b(new_n74_), .c(new_n40_), .O(z06));
  ...
  aoi21  g51(.a(new_n85_), .b(new_n74_), .c(new_n40_), .O(z07));
  nor2   g52(.a(x12), .b(x11), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n76_), .c(new_n67_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  aoi21  g55(.a(new_n83_), .b(x12), .c(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n74_), .c(new_n40_), .O(z08));
  nor2   g57(.a(new_n64_), .b(new_n44_), .O(new_n92_));
  nand2  g58(.a(new_n88_), .b(x13), .O(new_n93_));
  inv1   g59(.a(new_n75_), .O(new_n94_));
  nor2   g60(.a(x13), .b(x12), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n94_), .c(new_n82_), .d(new_n81_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n93_), .c(new_n92_), .d(new_n39_), .O(z09));
  nor2   g63(.a(x10), .b(x01), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(new_n95_), .c(new_n82_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n38_), .O(new_n100_));
  nand4  g66(.a(new_n100_), .b(new_n50_), .c(new_n65_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  nand4  g69(.a(new_n49_), .b(new_n39_), .c(x16), .d(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n44_), .O(z10));
  nor2   g71(.a(new_n40_), .b(new_n35_), .O(z11));
  oai21  g72(.a(new_n62_), .b(x02), .c(new_n48_), .O(new_n107_));
  nand3  g73(.a(new_n107_), .b(new_n39_), .c(x04), .O(new_n108_));
  inv1   g74(.a(new_n108_), .O(z12));
  nor2   g75(.a(new_n40_), .b(new_n44_), .O(z13));
