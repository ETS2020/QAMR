...
module FAU ( 
  ...
  oai21  g32(.a(x15), .b(new_n46_), .c(new_n52_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(x16), .c(x03), .O(new_n68_));
  oai21  g34(.a(x15), .b(x09), .c(new_n52_), .O(new_n69_));
  ...
  nand3  g47(.a(new_n35_), .b(x10), .c(new_n52_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n68_), .d(new_n66_), .O(z06));
  oai21  g49(.a(x15), .b(x11), .c(new_n52_), .O(new_n84_));
  ...
  nand3  g61(.a(new_n35_), .b(x12), .c(new_n52_), .O(new_n96_));
  ...
  nand3  g70(.a(new_n35_), .b(x13), .c(new_n52_), .O(new_n105_));
  ...
  aoi21  g84(.a(x15), .b(new_n52_), .c(new_n46_), .O(z13));
