...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n73_, new_n74_, new_n76_;
  ...
  oai21  g27(.a(new_n61_), .b(x06), .c(x04), .O(z07));
  aoi21  g28(.a(new_n56_), .b(x16), .c(x12), .O(new_n63_));
  oai21  g29(.a(new_n63_), .b(x06), .c(x04), .O(z08));
  inv1   g30(.a(x13), .O(new_n65_));
  aoi21  g31(.a(x16), .b(new_n37_), .c(x06), .O(new_n66_));
  nand3  g32(.a(x16), .b(new_n46_), .c(x03), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n66_), .c(new_n65_), .d(x04), .O(z09));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n47_), .c(new_n43_), .O(z12));
