...
module FAU ( 
  ...
  nand3  g02(.a(x16), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  oai21  g03(.a(x02), .b(new_n35_), .c(new_n37_), .O(z00));
  nor2   g04(.a(x16), .b(x01), .O(new_n39_));
  ...
  oai21  g20(.a(x16), .b(new_n35_), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g35(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  oai21  g36(.a(new_n43_), .b(x02), .c(new_n53_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x16), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n70_), .O(z05));
  nand2  g39(.a(new_n46_), .b(new_n43_), .O(z13));
  nand2  g40(.a(new_n68_), .b(x10), .O(new_n75_));
  inv1   g41(.a(x10), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n67_), .O(new_n77_));
  nor3   g43(.a(new_n77_), .b(new_n59_), .c(new_n58_), .O(new_n78_));
  nor2   g44(.a(new_n78_), .b(new_n39_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(z13), .d(new_n72_), .O(z06));
  ...
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n76_), .d(new_n67_), .O(new_n85_));
  and2   g51(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n82_), .c(z13), .d(new_n72_), .O(z07));
  nand2  g53(.a(new_n85_), .b(x12), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(new_n77_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n84_), .c(new_n89_), .d(new_n83_), .O(new_n91_));
  and2   g57(.a(new_n91_), .b(new_n46_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n88_), .c(z13), .d(new_n72_), .O(z08));
  inv1   g59(.a(x13), .O(new_n94_));
  nand4  g60(.a(new_n49_), .b(new_n94_), .c(new_n89_), .d(new_n83_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(x10), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n67_), .c(x08), .d(x07), .O(new_n97_));
  nand2  g63(.a(x16), .b(new_n48_), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(new_n47_), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(x04), .O(new_n100_));
  inv1   g66(.a(x16), .O(new_n101_));
  oai21  g67(.a(new_n101_), .b(new_n53_), .c(new_n46_), .O(new_n102_));
  aoi21  g68(.a(new_n91_), .b(x13), .c(new_n102_), .O(new_n103_));
  nand3  g69(.a(new_n103_), .b(new_n100_), .c(z13), .O(z09));
  inv1   g70(.a(x00), .O(new_n105_));
  aoi21  g71(.a(new_n53_), .b(x02), .c(new_n101_), .O(new_n106_));
  nand4  g72(.a(new_n94_), .b(new_n89_), .c(new_n83_), .d(new_n76_), .O(new_n107_));
  aoi21  g73(.a(new_n107_), .b(new_n105_), .c(new_n106_), .O(new_n108_));
  nand4  g74(.a(new_n108_), .b(new_n67_), .c(x08), .d(x07), .O(new_n109_));
  oai22  g75(.a(new_n109_), .b(new_n47_), .c(new_n49_), .d(new_n36_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(x04), .O(new_n111_));
  nand2  g77(.a(new_n111_), .b(new_n46_), .O(z10));
  nor2   g78(.a(new_n39_), .b(new_n48_), .O(z11));
  aoi21  g79(.a(x16), .b(new_n48_), .c(x03), .O(new_n114_));
  oai21  g80(.a(new_n114_), .b(new_n43_), .c(new_n46_), .O(z12));
  nand2  g81(.a(x17), .b(x04), .O(new_n116_));
  nand2  g82(.a(new_n116_), .b(new_n46_), .O(z14));
endmodule
