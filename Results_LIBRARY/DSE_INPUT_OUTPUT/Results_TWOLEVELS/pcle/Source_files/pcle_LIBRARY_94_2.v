...
module FAU ( 
  ...
  oai21  g17(.a(new_n42_), .b(x01), .c(x08), .O(new_n46_));
  xor2a  g18(.a(x12), .b(x11), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(new_n42_), .c(x09), .O(new_n48_));
  ...
  nand4  g25(.a(new_n53_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n54_));
  nand2  g26(.a(new_n40_), .b(x02), .O(new_n55_));
  ...
  oai21  g31(.a(new_n59_), .b(new_n50_), .c(new_n58_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n61_));
  nand2  g33(.a(new_n40_), .b(x03), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z4));
  oai21  g35(.a(new_n42_), .b(x04), .c(x08), .O(new_n64_));
  oai21  g36(.a(x12), .b(x08), .c(x11), .O(new_n65_));
  nand2  g37(.a(x14), .b(x13), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n65_), .c(x15), .O(new_n67_));
  nand4  g39(.a(new_n51_), .b(new_n34_), .c(x14), .d(x13), .O(new_n68_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n85_));
  nand2  g57(.a(new_n40_), .b(x06), .O(new_n86_));
  ...
  nand4  g67(.a(new_n95_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n96_));
