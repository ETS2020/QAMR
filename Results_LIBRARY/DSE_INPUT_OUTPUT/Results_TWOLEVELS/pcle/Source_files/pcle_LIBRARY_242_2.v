...
module FAU ( 
  ...
  nand2  g01(.a(new_n29_), .b(x07), .O(new_n30_));
  ...
  aoi21  g42(.a(x08), .b(x04), .c(new_n39_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z5));
  nand2  g44(.a(new_n40_), .b(x05), .O(new_n73_));
  oai21  g45(.a(new_n34_), .b(new_n32_), .c(x16), .O(new_n74_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n42_), .c(x09), .d(new_n31_), .O(new_n78_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n42_), .c(x09), .d(new_n31_), .O(new_n86_));
  ...
  nand3  g65(.a(new_n93_), .b(new_n42_), .c(new_n31_), .O(new_n94_));
