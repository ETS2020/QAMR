...
module FAU ( 
  ...
  nand2  g07(.a(x10), .b(x08), .O(new_n36_));
  ...
  oai21  g14(.a(new_n39_), .b(x01), .c(x08), .O(new_n43_));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand3  g16(.a(new_n44_), .b(new_n39_), .c(x09), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n43_), .O(z2));
  oai21  g18(.a(new_n39_), .b(x02), .c(x08), .O(new_n47_));
  ...
  nand3  g23(.a(new_n51_), .b(new_n39_), .c(x09), .O(new_n52_));
  ...
  nand3  g48(.a(new_n76_), .b(new_n39_), .c(x09), .O(new_n77_));
  ...
  nor2   g61(.a(new_n54_), .b(new_n48_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n81_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n49_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n94_));
  nand2  g66(.a(new_n37_), .b(x07), .O(new_n95_));
