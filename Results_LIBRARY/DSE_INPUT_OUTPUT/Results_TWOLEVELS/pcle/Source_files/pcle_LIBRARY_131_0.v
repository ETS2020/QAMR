...
module FAU ( 
  ...
  nand4  g26(.a(new_n54_), .b(x09), .c(new_n31_), .d(x00), .O(new_n55_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(new_n39_), .c(new_n80_), .O(z6));
  inv1   g53(.a(x17), .O(new_n82_));
  nand3  g54(.a(x16), .b(x12), .c(x11), .O(new_n83_));
  aoi21  g55(.a(new_n74_), .b(x00), .c(new_n83_), .O(new_n84_));
  nand4  g56(.a(new_n82_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(new_n58_), .c(new_n84_), .d(new_n82_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n32_), .c(x09), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x00), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n31_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  nand2  g63(.a(new_n74_), .b(x00), .O(new_n92_));
  and2   g64(.a(x17), .b(x16), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(new_n92_), .c(new_n60_), .O(new_n94_));
  ...
  aoi21  g70(.a(new_n98_), .b(x09), .c(new_n39_), .O(new_n99_));
