...
module FAU ( 
  ...
  nand3  g16(.a(x10), .b(x08), .c(x01), .O(new_n45_));
  ...
  nand3  g24(.a(new_n52_), .b(new_n38_), .c(x09), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n47_), .O(z3));
  oai21  g26(.a(new_n38_), .b(x03), .c(x08), .O(new_n55_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n38_), .c(x09), .O(new_n61_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n38_), .c(x09), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n63_), .O(z5));
  oai21  g42(.a(new_n38_), .b(x05), .c(x08), .O(new_n71_));
  ...
  nand3  g48(.a(new_n76_), .b(new_n38_), .c(x09), .O(new_n77_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n83_));
  nand3  g55(.a(x10), .b(x08), .c(x06), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n83_), .O(z7));
  oai21  g57(.a(new_n38_), .b(x07), .c(x08), .O(new_n86_));
  ...
  nand3  g64(.a(new_n92_), .b(new_n38_), .c(x09), .O(new_n93_));
