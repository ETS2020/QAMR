...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x01), .c(new_n37_), .O(new_n39_));
  ...
  oai21  g15(.a(new_n38_), .b(x08), .c(x01), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n38_), .c(x09), .d(new_n37_), .O(new_n46_));
  ...
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(new_n30_), .O(new_n52_));
  aoi21  g24(.a(new_n52_), .b(new_n37_), .c(x01), .O(new_n53_));
  nand2  g25(.a(x08), .b(x02), .O(new_n54_));
  oai21  g26(.a(new_n53_), .b(x10), .c(new_n54_), .O(z3));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n57_), .c(x10), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(x09), .c(new_n37_), .d(new_n29_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n56_), .O(z4));
  nand2  g35(.a(new_n50_), .b(new_n29_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n59_), .c(x14), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand4  g39(.a(new_n59_), .b(new_n67_), .c(x14), .d(x13), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(new_n30_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n37_), .c(x01), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(x10), .c(new_n71_), .O(z5));
  nand3  g44(.a(new_n64_), .b(new_n59_), .c(new_n33_), .O(new_n73_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n37_), .c(x01), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x10), .c(new_n80_), .O(z6));
  nand2  g53(.a(new_n39_), .b(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n31_), .c(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nand3  g57(.a(new_n33_), .b(new_n85_), .c(x16), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n31_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n38_), .c(x09), .d(new_n37_), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(x01), .c(new_n82_), .O(z7));
  nand2  g61(.a(new_n39_), .b(x07), .O(new_n90_));
  nand3  g62(.a(new_n33_), .b(x17), .c(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n31_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n75_), .b(new_n67_), .O(new_n93_));
  nor2   g65(.a(new_n58_), .b(new_n50_), .O(new_n94_));
  nor2   g66(.a(x18), .b(new_n85_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n59_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n92_), .c(x10), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n37_), .d(new_n29_), .O(new_n98_));
