...
module FAU ( 
  ...
  oai22  g21(.a(new_n49_), .b(x05), .c(new_n47_), .d(new_n46_), .O(z2));
  ...
  oai21  g37(.a(new_n47_), .b(new_n59_), .c(new_n65_), .O(z4));
  inv1   g38(.a(x09), .O(new_n67_));
  aoi21  g39(.a(x13), .b(x12), .c(x05), .O(new_n68_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n70_), .c(new_n67_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n32_), .c(x05), .O(new_n74_));
  ...
  nand3  g54(.a(x10), .b(x08), .c(x05), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(x05), .c(new_n83_), .O(z6));
  inv1   g56(.a(x06), .O(new_n85_));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n60_), .c(x17), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n60_), .c(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n91_));
  oai22  g63(.a(new_n91_), .b(x05), .c(new_n47_), .d(new_n85_), .O(z7));
  nand2  g64(.a(x16), .b(x15), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n31_), .O(new_n94_));
  nand3  g66(.a(x17), .b(x14), .c(x13), .O(new_n95_));
  inv1   g67(.a(new_n95_), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(new_n94_), .c(new_n62_), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(x18), .O(new_n98_));
  inv1   g70(.a(new_n93_), .O(new_n99_));
  nor2   g71(.a(new_n30_), .b(new_n54_), .O(new_n100_));
  nor2   g72(.a(x18), .b(new_n88_), .O(new_n101_));
  nand4  g73(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n62_), .O(new_n102_));
  aoi21  g74(.a(new_n102_), .b(new_n98_), .c(new_n67_), .O(new_n103_));
  aoi21  g75(.a(new_n103_), .b(new_n32_), .c(x05), .O(new_n104_));
