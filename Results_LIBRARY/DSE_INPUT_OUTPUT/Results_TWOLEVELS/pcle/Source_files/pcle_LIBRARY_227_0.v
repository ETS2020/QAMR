...
module FAU ( 
  ...
  oai22  g18(.a(new_n46_), .b(new_n43_), .c(new_n41_), .d(new_n40_), .O(z1));
  inv1   g19(.a(x01), .O(new_n48_));
  inv1   g20(.a(x06), .O(new_n49_));
  xor2a  g21(.a(x12), .b(x11), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n51_));
  oai22  g23(.a(new_n51_), .b(new_n49_), .c(new_n41_), .d(new_n48_), .O(z2));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n42_), .c(new_n49_), .O(new_n58_));
  ...
  nand4  g36(.a(new_n64_), .b(x09), .c(new_n42_), .d(x06), .O(new_n65_));
  oai21  g37(.a(new_n41_), .b(new_n61_), .c(new_n65_), .O(z4));
  inv1   g38(.a(x04), .O(new_n67_));
  nand4  g39(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n68_));
  inv1   g40(.a(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n33_), .b(x14), .c(x13), .O(new_n70_));
  oai22  g42(.a(new_n70_), .b(new_n53_), .c(new_n69_), .d(new_n33_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(new_n49_), .c(new_n41_), .d(new_n67_), .O(z5));
  inv1   g45(.a(x16), .O(new_n74_));
  nand2  g46(.a(x14), .b(x13), .O(new_n75_));
  nand3  g47(.a(x15), .b(x12), .c(x11), .O(new_n76_));
  aoi21  g48(.a(new_n75_), .b(x06), .c(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n74_), .b(x15), .c(x14), .O(new_n78_));
  oai22  g50(.a(new_n78_), .b(new_n30_), .c(new_n77_), .d(new_n74_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x09), .c(new_n42_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(x06), .O(new_n81_));
  ...
  nand3  g58(.a(new_n34_), .b(new_n35_), .c(x16), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n30_), .c(new_n86_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n44_), .c(x09), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n42_), .c(new_n49_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n30_), .c(x18), .O(new_n93_));
  nor2   g65(.a(new_n74_), .b(new_n33_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n69_), .c(new_n36_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(x10), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x09), .c(new_n42_), .d(x06), .O(new_n97_));
