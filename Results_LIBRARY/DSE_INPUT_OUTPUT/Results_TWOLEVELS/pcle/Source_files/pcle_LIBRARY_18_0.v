...
module FAU ( 
  ...
  oai22  g47(.a(new_n75_), .b(new_n46_), .c(new_n41_), .d(new_n69_), .O(z5));
  ...
  oai22  g56(.a(new_n84_), .b(new_n46_), .c(new_n41_), .d(new_n77_), .O(z6));
  ...
  oai22  g64(.a(new_n92_), .b(new_n46_), .c(new_n41_), .d(new_n86_), .O(z7));
  nand2  g65(.a(new_n87_), .b(x03), .O(new_n94_));
  and2   g66(.a(x17), .b(x13), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n94_), .c(new_n64_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x18), .O(new_n97_));
  nor2   g69(.a(new_n81_), .b(new_n70_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n72_), .c(new_n29_), .d(x17), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n97_), .c(new_n62_), .O(new_n100_));
