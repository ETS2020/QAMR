...
module FAU ( 
  ...
  nand2  g37(.a(new_n32_), .b(x05), .O(new_n67_));
  nand4  g38(.a(x11), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  nor2   g39(.a(x16), .b(new_n62_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x14), .c(x13), .d(x12), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n68_), .c(new_n67_), .O(z6));
  nand2  g42(.a(x17), .b(x09), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(x08), .c(new_n38_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n31_), .O(new_n74_));
  nand2  g45(.a(x08), .b(x06), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n74_), .O(z7));
  nand2  g47(.a(x18), .b(x09), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(x08), .c(new_n38_), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n31_), .O(new_n79_));
  nand2  g50(.a(x08), .b(x07), .O(new_n80_));
