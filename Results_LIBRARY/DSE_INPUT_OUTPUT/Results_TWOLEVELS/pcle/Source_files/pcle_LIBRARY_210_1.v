...
module FAU ( 
  ...
  nor3   g06(.a(x14), .b(x11), .c(x10), .O(new_n36_));
  ...
  aoi21  g24(.a(new_n53_), .b(new_n35_), .c(x14), .O(new_n54_));
  nand2  g25(.a(x08), .b(x03), .O(new_n55_));
  oai21  g26(.a(new_n54_), .b(x10), .c(new_n55_), .O(z4));
  nand2  g27(.a(x15), .b(x09), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(x08), .c(new_n40_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n31_), .O(new_n59_));
  nand2  g30(.a(x08), .b(x04), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n59_), .O(z5));
  nand2  g32(.a(new_n32_), .b(x05), .O(new_n62_));
  nand4  g33(.a(new_n35_), .b(x16), .c(new_n40_), .d(new_n31_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n62_), .O(z6));
  nand2  g35(.a(new_n32_), .b(x06), .O(new_n65_));
  nand4  g36(.a(new_n35_), .b(x17), .c(new_n40_), .d(new_n31_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(z7));
  nand2  g38(.a(new_n32_), .b(x07), .O(new_n68_));
  nand4  g39(.a(new_n35_), .b(x18), .c(new_n40_), .d(new_n31_), .O(new_n69_));
