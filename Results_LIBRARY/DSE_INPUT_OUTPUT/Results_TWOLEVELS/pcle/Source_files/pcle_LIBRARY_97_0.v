...
module FAU ( 
  ...
  nand2  g36(.a(x14), .b(x11), .O(new_n65_));
  aoi21  g37(.a(new_n64_), .b(x09), .c(new_n65_), .O(new_n66_));
  nand3  g38(.a(new_n63_), .b(x14), .c(x13), .O(new_n67_));
  oai22  g39(.a(new_n67_), .b(new_n47_), .c(new_n66_), .d(new_n63_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n31_), .c(new_n62_), .O(new_n69_));
  ...
  inv1   g65(.a(new_n88_), .O(new_n94_));
  nor2   g66(.a(new_n56_), .b(new_n46_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n82_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n48_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n93_), .c(x10), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(new_n62_), .c(new_n30_), .O(new_n99_));
