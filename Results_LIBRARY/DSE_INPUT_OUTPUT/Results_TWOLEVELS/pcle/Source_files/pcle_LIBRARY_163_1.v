...
module FAU ( 
  ...
  nor3   g06(.a(x15), .b(x11), .c(x10), .O(new_n35_));
  ...
  aoi21  g20(.a(new_n48_), .b(new_n43_), .c(x15), .O(new_n49_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n53_), .c(new_n33_), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n43_), .c(x15), .O(new_n57_));
  nand2  g29(.a(x08), .b(x03), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x10), .c(new_n58_), .O(z4));
  inv1   g31(.a(x04), .O(new_n60_));
  nand3  g32(.a(new_n34_), .b(x11), .c(new_n39_), .O(new_n61_));
  nand4  g33(.a(new_n29_), .b(x14), .c(x13), .d(x12), .O(new_n62_));
  oai22  g34(.a(new_n62_), .b(new_n61_), .c(new_n32_), .d(new_n60_), .O(z5));
  ...
  inv1   g45(.a(x07), .O(new_n74_));
  nand4  g46(.a(new_n34_), .b(x18), .c(new_n29_), .d(new_n39_), .O(new_n75_));
  oai21  g47(.a(new_n32_), .b(new_n74_), .c(new_n75_), .O(z8));
endmodule
