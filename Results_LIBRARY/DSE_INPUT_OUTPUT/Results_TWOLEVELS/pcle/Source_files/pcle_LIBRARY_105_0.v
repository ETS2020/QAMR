...
module FAU ( 
  ...
  aoi21  g07(.a(new_n35_), .b(x07), .c(x08), .O(z0));
  inv1   g08(.a(x07), .O(new_n37_));
  nor2   g09(.a(x11), .b(x10), .O(new_n38_));
  aoi21  g10(.a(new_n38_), .b(x09), .c(new_n37_), .O(new_n39_));
  ...
  nand2  g16(.a(new_n44_), .b(x07), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n42_), .O(new_n46_));
  ...
  nand4  g26(.a(new_n54_), .b(x09), .c(new_n42_), .d(x07), .O(new_n55_));
  ...
  nand3  g31(.a(new_n49_), .b(new_n59_), .c(x13), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n58_), .c(x10), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(x09), .c(new_n42_), .d(x07), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(z4));
  nand2  g36(.a(new_n52_), .b(x07), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n49_), .c(x14), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x15), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand4  g40(.a(new_n49_), .b(new_n68_), .c(x14), .d(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n67_), .c(x10), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(x09), .c(new_n37_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(x08), .c(new_n72_), .O(z5));
  nand3  g45(.a(new_n65_), .b(new_n49_), .c(new_n33_), .O(new_n74_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(x10), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(x09), .c(new_n37_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x08), .c(new_n81_), .O(z6));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n31_), .c(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nand4  g57(.a(new_n33_), .b(new_n77_), .c(new_n85_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n84_), .c(x10), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(x09), .c(new_n37_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(x08), .c(new_n89_), .O(z7));
  nand2  g62(.a(x18), .b(new_n52_), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n30_), .c(new_n42_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x07), .O(new_n93_));
  nand3  g65(.a(x14), .b(x12), .c(x11), .O(new_n94_));
  nand3  g66(.a(x17), .b(x16), .c(x15), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n94_), .c(x18), .O(new_n96_));
  nor2   g68(.a(new_n76_), .b(new_n68_), .O(new_n97_));
  nor2   g69(.a(new_n59_), .b(new_n52_), .O(new_n98_));
  nor2   g70(.a(x18), .b(new_n85_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n49_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n96_), .c(x10), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(x09), .c(new_n37_), .O(new_n102_));
  oai21  g74(.a(new_n102_), .b(x08), .c(new_n93_), .O(z8));
endmodule
