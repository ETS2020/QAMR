...
module FAU ( 
  ...
  nand4  g22(.a(new_n30_), .b(x12), .c(x11), .d(new_n29_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand3  g24(.a(new_n52_), .b(x09), .c(new_n31_), .O(new_n53_));
  aoi21  g25(.a(x08), .b(x02), .c(new_n40_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n53_), .O(z3));
  nand2  g27(.a(new_n32_), .b(x14), .O(new_n56_));
  nand3  g28(.a(new_n34_), .b(x12), .c(x11), .O(new_n57_));
  aoi21  g29(.a(new_n57_), .b(new_n56_), .c(new_n30_), .O(new_n58_));
  nand3  g30(.a(x14), .b(new_n30_), .c(new_n29_), .O(new_n59_));
  ...
  oai21  g34(.a(new_n61_), .b(x08), .c(new_n62_), .O(z4));
  nand2  g35(.a(x14), .b(x13), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n29_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n50_), .c(new_n35_), .O(new_n66_));
  nand3  g38(.a(new_n35_), .b(x14), .c(x13), .O(new_n67_));
  nor2   g39(.a(new_n67_), .b(new_n32_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n66_), .c(x09), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x04), .c(new_n40_), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(x08), .c(new_n70_), .O(z5));
  nand2  g43(.a(new_n41_), .b(x05), .O(new_n72_));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n32_), .c(x16), .O(new_n74_));
  ...
  nand2  g51(.a(new_n79_), .b(new_n72_), .O(z6));
  ...
  nand4  g58(.a(new_n86_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n81_), .O(z7));
  inv1   g60(.a(x18), .O(new_n89_));
  nand3  g61(.a(x17), .b(x16), .c(x15), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n64_), .c(new_n29_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n50_), .c(new_n89_), .O(new_n92_));
  nand4  g64(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n93_));
  nand4  g65(.a(new_n89_), .b(x17), .c(x16), .d(x15), .O(new_n94_));
  nor2   g66(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n92_), .c(x09), .O(new_n96_));
  aoi21  g68(.a(x08), .b(x07), .c(new_n40_), .O(new_n97_));
  oai21  g69(.a(new_n96_), .b(x08), .c(new_n97_), .O(z8));
endmodule
