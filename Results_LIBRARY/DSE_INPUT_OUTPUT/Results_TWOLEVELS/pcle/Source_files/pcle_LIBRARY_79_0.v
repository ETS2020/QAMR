...
module FAU ( 
  ...
  aoi21  g43(.a(new_n71_), .b(new_n68_), .c(new_n66_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n30_), .c(new_n58_), .O(new_n73_));
  ...
  nand4  g50(.a(new_n70_), .b(new_n78_), .c(x15), .d(x14), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n77_), .c(new_n66_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n30_), .c(new_n58_), .O(new_n81_));
  ...
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(x15), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(new_n66_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n30_), .c(new_n58_), .O(new_n90_));
  ...
  oai21  g66(.a(new_n94_), .b(new_n67_), .c(x18), .O(new_n95_));
  nand4  g67(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n67_), .c(new_n95_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x13), .c(new_n31_), .d(x09), .O(new_n98_));
  oai22  g70(.a(new_n98_), .b(x08), .c(new_n57_), .d(new_n93_), .O(z8));
endmodule
