...
module FAU ( 
  ...
  oai21  g11(.a(x14), .b(new_n31_), .c(x08), .O(new_n40_));
  ...
  oai21  g27(.a(new_n40_), .b(new_n49_), .c(new_n55_), .O(z3));
  ...
  inv1   g31(.a(new_n57_), .O(new_n60_));
  nor2   g32(.a(new_n60_), .b(new_n46_), .O(new_n61_));
  ...
  nand2  g36(.a(x15), .b(x09), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(x08), .c(new_n31_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n46_), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(x14), .c(x13), .O(new_n69_));
  oai22  g41(.a(new_n69_), .b(new_n50_), .c(new_n60_), .d(new_n68_), .O(new_n70_));
  ...
  oai21  g52(.a(new_n40_), .b(new_n74_), .c(new_n80_), .O(z6));
  ...
  oai21  g60(.a(new_n40_), .b(new_n82_), .c(new_n88_), .O(z7));
  ...
  nand4  g65(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n96_));
  oai21  g68(.a(new_n40_), .b(new_n90_), .c(new_n96_), .O(z8));
endmodule
