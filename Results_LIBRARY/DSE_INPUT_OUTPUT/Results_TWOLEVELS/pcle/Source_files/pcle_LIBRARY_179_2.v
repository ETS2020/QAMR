...
module FAU ( 
  ...
  nand2  g17(.a(x10), .b(x08), .O(new_n46_));
  ...
  nand2  g26(.a(new_n47_), .b(x02), .O(new_n55_));
  ...
  nand3  g31(.a(new_n51_), .b(new_n33_), .c(x13), .O(new_n60_));
  ...
  oai22  g38(.a(new_n66_), .b(new_n50_), .c(new_n65_), .d(new_n34_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n68_));
  nand2  g40(.a(new_n47_), .b(x04), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  oai21  g42(.a(new_n39_), .b(x05), .c(x08), .O(new_n71_));
  ...
  nand3  g49(.a(new_n77_), .b(new_n39_), .c(x09), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n71_), .O(z6));
  oai21  g51(.a(new_n39_), .b(x06), .c(x08), .O(new_n80_));
  nand3  g52(.a(x16), .b(x15), .c(x14), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n74_), .c(x17), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n74_), .c(new_n82_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n39_), .c(x09), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n80_), .O(z7));
  nand4  g59(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n74_), .c(x18), .O(new_n89_));
  nor2   g61(.a(new_n75_), .b(new_n34_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n83_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n90_), .c(new_n65_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n94_));
  nand2  g66(.a(new_n47_), .b(x07), .O(new_n95_));
