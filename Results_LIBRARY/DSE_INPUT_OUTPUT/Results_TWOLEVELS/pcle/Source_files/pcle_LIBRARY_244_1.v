...
module FAU ( 
  ...
  nand4  g32(.a(new_n60_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n61_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  aoi21  g43(.a(x14), .b(x13), .c(x10), .O(new_n72_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n74_), .c(new_n47_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x10), .c(new_n42_), .O(new_n78_));
  ...
  nand3  g54(.a(new_n32_), .b(new_n33_), .c(x16), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n57_), .c(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(z7));
  nand2  g59(.a(new_n75_), .b(new_n29_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n58_), .c(new_n32_), .d(x17), .O(new_n89_));
