...
module FAU ( 
  ...
  nor2   g14(.a(x08), .b(x03), .O(new_n43_));
  ...
  oai22  g20(.a(new_n48_), .b(x03), .c(new_n41_), .d(new_n46_), .O(z2));
  ...
  oai21  g29(.a(new_n33_), .b(x08), .c(x03), .O(new_n58_));
  oai21  g30(.a(x12), .b(x03), .c(x13), .O(new_n59_));
  ...
  oai21  g38(.a(x12), .b(x03), .c(x11), .O(new_n67_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n78_), .c(x15), .d(x14), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n77_), .c(new_n66_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n32_), .c(x03), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z6));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n79_), .c(x17), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nor2   g60(.a(new_n70_), .b(new_n30_), .O(new_n89_));
  nand4  g61(.a(new_n80_), .b(new_n89_), .c(new_n88_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n66_), .O(new_n91_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n79_), .c(x18), .O(new_n96_));
  inv1   g68(.a(new_n68_), .O(new_n97_));
  nor2   g69(.a(new_n78_), .b(new_n70_), .O(new_n98_));
  ...
  aoi21  g73(.a(new_n101_), .b(new_n32_), .c(x03), .O(new_n102_));
