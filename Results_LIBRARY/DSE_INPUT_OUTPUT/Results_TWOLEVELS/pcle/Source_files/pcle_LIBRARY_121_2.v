...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x11), .c(new_n30_), .O(new_n39_));
  ...
  nand2  g16(.a(new_n44_), .b(new_n40_), .O(z1));
  nand2  g17(.a(new_n39_), .b(x01), .O(new_n46_));
  nand3  g18(.a(x12), .b(new_n41_), .c(new_n31_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n42_), .c(new_n46_), .O(z2));
  xor2a  g20(.a(x13), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n50_));
  aoi22  g22(.a(new_n38_), .b(x11), .c(x08), .d(x02), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n50_), .O(z3));
  inv1   g24(.a(x14), .O(new_n53_));
  nand3  g25(.a(new_n53_), .b(x13), .c(new_n31_), .O(new_n54_));
  oai21  g26(.a(new_n54_), .b(new_n42_), .c(x12), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(x11), .O(new_n56_));
  inv1   g28(.a(x13), .O(new_n57_));
  nor2   g29(.a(new_n57_), .b(new_n41_), .O(new_n58_));
  nor2   g30(.a(new_n58_), .b(new_n53_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x03), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n60_), .c(new_n56_), .O(z4));
  nand2  g34(.a(new_n39_), .b(x04), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nor2   g36(.a(new_n53_), .b(new_n57_), .O(new_n65_));
  nand4  g37(.a(new_n64_), .b(x14), .c(x13), .d(x11), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x12), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n41_), .O(new_n69_));
  ...
  nand3  g44(.a(new_n31_), .b(x09), .c(new_n30_), .O(new_n73_));
  nor2   g45(.a(x16), .b(new_n64_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n65_), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n73_), .c(x12), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x11), .O(new_n77_));
  nor2   g49(.a(new_n64_), .b(new_n53_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n58_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x16), .c(new_n31_), .O(new_n80_));
  inv1   g52(.a(new_n80_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x09), .c(new_n30_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n77_), .O(z6));
  nand3  g56(.a(new_n43_), .b(x13), .c(new_n31_), .O(new_n85_));
  inv1   g57(.a(x17), .O(new_n86_));
  nand3  g58(.a(new_n78_), .b(new_n86_), .c(x16), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n85_), .c(x12), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(x11), .O(new_n89_));
  nand3  g61(.a(x16), .b(x15), .c(x14), .O(new_n90_));
  inv1   g62(.a(new_n90_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n58_), .c(new_n86_), .O(new_n92_));
  ...
  nand4  g67(.a(new_n78_), .b(new_n29_), .c(x17), .d(x16), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n85_), .c(x12), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(x11), .O(new_n98_));
  nand2  g70(.a(new_n65_), .b(x11), .O(new_n99_));
  inv1   g71(.a(new_n99_), .O(new_n100_));
  nand3  g72(.a(x17), .b(x16), .c(x15), .O(new_n101_));
  inv1   g73(.a(new_n101_), .O(new_n102_));
  aoi21  g74(.a(new_n102_), .b(new_n100_), .c(new_n29_), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n104_));
  nand2  g76(.a(x08), .b(x07), .O(new_n105_));
  nand3  g77(.a(new_n105_), .b(new_n104_), .c(new_n98_), .O(z8));
endmodule
