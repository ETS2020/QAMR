...
module FAU ( 
  ...
  nor2   g64(.a(new_n59_), .b(new_n49_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n84_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n51_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n97_));
  oai21  g69(.a(new_n48_), .b(new_n89_), .c(new_n97_), .O(z8));
endmodule
