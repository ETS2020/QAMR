...
module FAU ( 
  ...
  nor2   g24(.a(new_n39_), .b(new_n29_), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(x02), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n52_), .O(z3));
  oai21  g27(.a(new_n39_), .b(x03), .c(x08), .O(new_n56_));
  oai21  g28(.a(x12), .b(x08), .c(x13), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n41_), .c(x14), .O(new_n58_));
  nand3  g30(.a(new_n49_), .b(new_n33_), .c(x13), .O(new_n59_));
  ...
  nand2  g39(.a(new_n53_), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  oai21  g41(.a(new_n39_), .b(x05), .c(x08), .O(new_n70_));
  ...
  nand3  g56(.a(new_n84_), .b(new_n39_), .c(x09), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n79_), .O(z7));
  nand4  g58(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n73_), .c(x18), .O(new_n88_));
  nor2   g60(.a(new_n74_), .b(new_n34_), .O(new_n89_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n93_));
