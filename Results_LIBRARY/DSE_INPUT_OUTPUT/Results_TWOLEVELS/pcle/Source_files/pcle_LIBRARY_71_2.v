...
module FAU ( 
  ...
  oai22  g31(.a(new_n59_), .b(new_n49_), .c(new_n58_), .d(new_n56_), .O(new_n60_));
  ...
  oai21  g51(.a(new_n31_), .b(x06), .c(x08), .O(new_n80_));
  nor2   g52(.a(new_n75_), .b(new_n64_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n50_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n72_), .c(x17), .O(new_n83_));
  nor2   g55(.a(x17), .b(new_n75_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n58_), .c(x15), .d(x14), .O(new_n85_));
  ...
  nand4  g63(.a(new_n81_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n94_));
  oai21  g66(.a(new_n45_), .b(new_n89_), .c(new_n94_), .O(z8));
endmodule
