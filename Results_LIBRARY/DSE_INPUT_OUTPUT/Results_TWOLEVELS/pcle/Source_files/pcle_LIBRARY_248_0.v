...
module FAU ( 
  ...
  nand3  g25(.a(new_n31_), .b(x18), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g33(.a(x18), .b(new_n59_), .c(x13), .O(new_n62_));
  ...
  nand4  g44(.a(new_n72_), .b(x18), .c(new_n42_), .d(x09), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(x08), .c(new_n41_), .d(new_n69_), .O(z5));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n30_), .c(x16), .O(new_n76_));
  and2   g48(.a(x15), .b(x14), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n61_), .c(x18), .d(new_n33_), .O(new_n78_));
  ...
  nand3  g57(.a(new_n77_), .b(new_n34_), .c(x16), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n60_), .c(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x18), .c(new_n42_), .d(x09), .O(new_n88_));
  ...
  nand4  g65(.a(new_n93_), .b(x18), .c(new_n42_), .d(x09), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(x08), .c(new_n41_), .d(new_n90_), .O(z8));
endmodule
