...
module FAU ( 
  ...
  nor2   g10(.a(new_n36_), .b(new_n38_), .O(z3));
  nand2  g11(.a(x08), .b(x03), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n30_), .O(z4));
  inv1   g13(.a(x04), .O(new_n42_));
  nor2   g14(.a(new_n36_), .b(new_n42_), .O(z5));
  inv1   g15(.a(x05), .O(new_n44_));
  nor2   g16(.a(new_n36_), .b(new_n44_), .O(z6));
  inv1   g17(.a(x06), .O(new_n46_));
  nor2   g18(.a(new_n36_), .b(new_n46_), .O(z7));
  inv1   g19(.a(x07), .O(new_n48_));
  nor2   g20(.a(new_n36_), .b(new_n48_), .O(z8));
endmodule
