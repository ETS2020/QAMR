...
module FAU ( 
  ...
  nand3  g21(.a(x14), .b(new_n29_), .c(new_n35_), .O(new_n50_));
  oai22  g22(.a(new_n50_), .b(new_n34_), .c(new_n32_), .d(new_n49_), .O(z4));
  nand2  g23(.a(x15), .b(x09), .O(new_n52_));
  ...
  inv1   g33(.a(x06), .O(new_n62_));
  nand3  g34(.a(x17), .b(new_n29_), .c(new_n35_), .O(new_n63_));
  oai22  g35(.a(new_n63_), .b(new_n34_), .c(new_n32_), .d(new_n62_), .O(z7));
  inv1   g36(.a(x07), .O(new_n65_));
  nand3  g37(.a(x18), .b(new_n29_), .c(new_n35_), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n34_), .c(new_n32_), .d(new_n65_), .O(z8));
endmodule
