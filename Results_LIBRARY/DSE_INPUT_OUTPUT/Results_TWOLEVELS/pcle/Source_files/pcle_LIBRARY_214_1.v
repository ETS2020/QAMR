...
module FAU ( 
  ...
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(x10), .c(new_n42_), .O(new_n53_));
  ...
  oai21  g30(.a(new_n58_), .b(new_n48_), .c(new_n57_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x03), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(z4));
  oai21  g34(.a(x13), .b(x10), .c(x14), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(new_n48_), .c(x15), .O(new_n64_));
  and2   g36(.a(x12), .b(x11), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n33_), .c(x14), .d(x13), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n64_), .c(new_n47_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(x10), .c(new_n42_), .O(new_n68_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n76_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n84_));
  ...
  nor2   g61(.a(new_n32_), .b(new_n50_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n81_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n65_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n94_));
