...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(x09), .c(x08), .O(z0));
  inv1   g12(.a(x09), .O(new_n41_));
  inv1   g13(.a(x10), .O(new_n42_));
  aoi21  g14(.a(new_n29_), .b(new_n42_), .c(new_n41_), .O(new_n43_));
  nand2  g15(.a(x08), .b(x00), .O(new_n44_));
  oai21  g16(.a(new_n43_), .b(x08), .c(new_n44_), .O(z1));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  aoi21  g18(.a(new_n46_), .b(new_n42_), .c(new_n41_), .O(new_n47_));
  nand2  g19(.a(x08), .b(x01), .O(new_n48_));
  oai21  g20(.a(new_n47_), .b(x08), .c(new_n48_), .O(z2));
  inv1   g21(.a(x08), .O(new_n50_));
  nand2  g22(.a(x12), .b(x11), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(x13), .O(new_n52_));
  nand3  g24(.a(new_n32_), .b(x12), .c(x11), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n52_), .c(x10), .O(new_n54_));
  oai21  g26(.a(new_n54_), .b(new_n41_), .c(new_n50_), .O(new_n55_));
  ...
  nand2  g31(.a(new_n34_), .b(x13), .O(new_n60_));
  oai22  g32(.a(new_n60_), .b(new_n51_), .c(new_n59_), .d(new_n34_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n42_), .c(x09), .d(new_n50_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(z4));
  oai21  g36(.a(x13), .b(new_n41_), .c(x14), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n51_), .c(x15), .O(new_n66_));
  inv1   g38(.a(new_n51_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n35_), .c(x14), .d(x13), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(x10), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n41_), .c(new_n50_), .O(new_n70_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n42_), .c(x09), .d(new_n50_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  nand2  g52(.a(new_n35_), .b(x09), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n59_), .c(x16), .d(x14), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  nor2   g55(.a(x17), .b(new_n75_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n59_), .c(new_n36_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n83_), .c(x10), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n41_), .c(new_n50_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n87_), .O(z7));
  nand3  g61(.a(new_n36_), .b(x17), .c(x16), .O(new_n90_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n67_), .c(x14), .d(x13), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n42_), .c(x09), .d(new_n50_), .O(new_n97_));
