...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x11), .O(new_n30_));
  ...
  nand2  g13(.a(new_n41_), .b(x12), .O(new_n42_));
  ...
  oai21  g26(.a(x12), .b(x10), .c(x08), .O(new_n55_));
  ...
  nand3  g38(.a(new_n31_), .b(new_n66_), .c(x14), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(new_n56_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n69_));
  oai21  g41(.a(new_n55_), .b(new_n63_), .c(new_n69_), .O(z5));
  inv1   g42(.a(x05), .O(new_n71_));
  oai21  g43(.a(new_n35_), .b(new_n30_), .c(x16), .O(new_n72_));
  nand3  g44(.a(new_n32_), .b(x15), .c(x14), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n30_), .c(new_n72_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(x12), .c(new_n39_), .d(x09), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(x08), .c(new_n55_), .d(new_n71_), .O(z6));
  nand2  g48(.a(new_n35_), .b(x12), .O(new_n77_));
  nand3  g49(.a(x16), .b(x13), .c(x11), .O(new_n78_));
  inv1   g50(.a(new_n78_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n77_), .c(new_n33_), .O(new_n80_));
  nand3  g52(.a(new_n33_), .b(x16), .c(x15), .O(new_n81_));
  ...
  inv1   g59(.a(x09), .O(new_n88_));
  aoi21  g60(.a(x15), .b(x14), .c(new_n56_), .O(new_n89_));
  nand4  g61(.a(x17), .b(x16), .c(x13), .d(x11), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n89_), .c(x18), .O(new_n91_));
  inv1   g63(.a(new_n64_), .O(new_n92_));
  nor2   g64(.a(new_n32_), .b(new_n66_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n34_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n91_), .c(new_n88_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n29_), .c(new_n56_), .O(new_n96_));
