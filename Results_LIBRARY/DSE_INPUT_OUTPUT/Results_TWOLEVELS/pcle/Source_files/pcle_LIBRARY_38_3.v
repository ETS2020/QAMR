...
module FAU ( 
  ...
  oai22  g38(.a(new_n66_), .b(new_n48_), .c(new_n65_), .d(new_n34_), .O(new_n67_));
  ...
  inv1   g54(.a(new_n56_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(x16), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n80_), .c(x08), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(x10), .c(x09), .O(new_n86_));
