...
module FAU ( 
  ...
  oai21  g54(.a(new_n82_), .b(new_n52_), .c(x16), .O(new_n83_));
  ...
  oai22  g60(.a(new_n88_), .b(new_n59_), .c(new_n41_), .d(new_n81_), .O(z6));
  inv1   g61(.a(x06), .O(new_n90_));
  nand3  g62(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n84_), .c(x17), .O(new_n92_));
  ...
  oai22  g68(.a(new_n96_), .b(new_n59_), .c(new_n41_), .d(new_n90_), .O(z7));
  nand2  g69(.a(x16), .b(x15), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(x04), .O(new_n99_));
  nand3  g71(.a(x17), .b(x14), .c(x13), .O(new_n100_));
  inv1   g72(.a(new_n100_), .O(new_n101_));
  nand3  g73(.a(new_n101_), .b(new_n99_), .c(new_n65_), .O(new_n102_));
  nand2  g74(.a(new_n102_), .b(x18), .O(new_n103_));
  nor2   g75(.a(new_n30_), .b(new_n54_), .O(new_n104_));
  inv1   g76(.a(new_n98_), .O(new_n105_));
  nor2   g77(.a(x18), .b(new_n93_), .O(new_n106_));
  nand4  g78(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n65_), .O(new_n107_));
  aoi21  g79(.a(new_n107_), .b(new_n103_), .c(new_n60_), .O(new_n108_));
  aoi21  g80(.a(new_n108_), .b(new_n31_), .c(new_n59_), .O(new_n109_));
  nand2  g81(.a(x08), .b(x07), .O(new_n110_));
  oai21  g82(.a(new_n109_), .b(x10), .c(new_n110_), .O(z8));
endmodule
