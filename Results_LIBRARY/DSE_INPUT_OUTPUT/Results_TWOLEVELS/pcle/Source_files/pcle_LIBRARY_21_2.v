...
module FAU ( 
  ...
  nand2  g33(.a(new_n42_), .b(x04), .O(new_n62_));
  ...
  nand4  g39(.a(new_n67_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n62_), .O(z5));
  nand2  g41(.a(new_n42_), .b(x05), .O(new_n70_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n70_), .O(z6));
  nand2  g48(.a(x17), .b(x09), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x08), .c(new_n29_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n41_), .O(new_n79_));
  nand2  g51(.a(x13), .b(x12), .O(new_n80_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n79_), .O(z7));
  nand2  g60(.a(x18), .b(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n29_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n41_), .O(new_n91_));
  nand3  g63(.a(x14), .b(x13), .c(x12), .O(new_n92_));
  nand3  g64(.a(x17), .b(x16), .c(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n92_), .c(x18), .O(new_n94_));
  inv1   g66(.a(x18), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x17), .c(x16), .d(x15), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n63_), .c(new_n94_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n98_));
  nand2  g70(.a(x08), .b(x07), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n98_), .c(new_n91_), .O(z8));
endmodule
