...
module FAU ( 
  ...
  nor2   g10(.a(x09), .b(new_n29_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  inv1   g12(.a(x10), .O(new_n41_));
  nand4  g13(.a(new_n31_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n40_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n45_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n41_), .c(x09), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n48_), .O(z3));
  oai21  g27(.a(x09), .b(x03), .c(x08), .O(new_n56_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n41_), .c(x09), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n56_), .O(z4));
  oai21  g34(.a(x09), .b(x04), .c(x08), .O(new_n63_));
  ...
  nand3  g39(.a(new_n67_), .b(new_n41_), .c(x09), .O(new_n68_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n41_), .c(x09), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n70_), .O(z6));
  oai21  g49(.a(x09), .b(x06), .c(x08), .O(new_n78_));
  ...
  nand3  g55(.a(new_n83_), .b(new_n41_), .c(x09), .O(new_n84_));
  ...
  nor2   g59(.a(new_n73_), .b(new_n34_), .O(new_n88_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n92_));
  nand2  g64(.a(new_n39_), .b(x07), .O(new_n93_));
