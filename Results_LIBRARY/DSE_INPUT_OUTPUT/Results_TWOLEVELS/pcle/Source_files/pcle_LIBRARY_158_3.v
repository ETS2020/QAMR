...
module FAU ( 
  ...
  aoi21  g13(.a(x09), .b(x05), .c(new_n41_), .O(new_n42_));
  ...
  oai21  g22(.a(new_n50_), .b(x05), .c(new_n47_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n41_), .c(x05), .O(new_n57_));
  nand2  g29(.a(x08), .b(x02), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n30_), .c(new_n58_), .O(z3));
  nand2  g31(.a(new_n31_), .b(x14), .O(new_n60_));
  and2   g32(.a(x12), .b(x11), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n33_), .c(x13), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n60_), .c(x10), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n41_), .c(x05), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(new_n30_), .c(new_n65_), .O(z4));
  nand4  g38(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x15), .O(new_n68_));
  nand4  g40(.a(new_n61_), .b(new_n34_), .c(x14), .d(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(x10), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n41_), .c(x05), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(new_n30_), .c(new_n72_), .O(z5));
  oai21  g45(.a(x09), .b(x08), .c(x05), .O(new_n74_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n74_), .O(z6));
  nand2  g53(.a(new_n42_), .b(x06), .O(new_n82_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x05), .c(new_n82_), .O(z7));
  nand2  g60(.a(new_n42_), .b(x07), .O(new_n89_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n37_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n91_), .c(x10), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x09), .c(new_n41_), .d(new_n29_), .O(new_n96_));
