...
module FAU ( 
  ...
  oai21  g22(.a(new_n29_), .b(x10), .c(x08), .O(new_n51_));
  inv1   g23(.a(x09), .O(new_n52_));
  nor2   g24(.a(new_n52_), .b(x08), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(x14), .c(new_n29_), .d(new_n31_), .O(new_n54_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n54_), .O(z4));
  nand2  g27(.a(x15), .b(x09), .O(new_n56_));
  ...
  nand4  g38(.a(new_n53_), .b(x17), .c(new_n29_), .d(new_n31_), .O(new_n67_));
  oai21  g39(.a(new_n51_), .b(new_n66_), .c(new_n67_), .O(z7));
  inv1   g40(.a(x07), .O(new_n69_));
  nand4  g41(.a(new_n53_), .b(x18), .c(new_n29_), .d(new_n31_), .O(new_n70_));
  oai21  g42(.a(new_n51_), .b(new_n69_), .c(new_n70_), .O(z8));
endmodule
