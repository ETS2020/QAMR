...
module FAU ( 
  ...
  nand3  g32(.a(new_n60_), .b(new_n32_), .c(x13), .O(new_n61_));
  ...
  oai22  g40(.a(new_n68_), .b(new_n50_), .c(new_n67_), .d(new_n33_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(x09), .c(x10), .O(new_n70_));
  ...
  nand3  g63(.a(new_n91_), .b(new_n89_), .c(new_n60_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x18), .O(new_n93_));
  inv1   g65(.a(new_n88_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n67_), .c(new_n36_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(new_n49_), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(x10), .c(new_n44_), .O(new_n97_));
