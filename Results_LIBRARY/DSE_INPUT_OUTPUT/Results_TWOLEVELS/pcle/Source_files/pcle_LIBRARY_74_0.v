...
module FAU ( 
  ...
  aoi21  g16(.a(new_n44_), .b(new_n39_), .c(new_n43_), .O(new_n45_));
  ...
  oai21  g24(.a(new_n52_), .b(new_n43_), .c(new_n40_), .O(new_n53_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n84_));
  oai21  g56(.a(new_n38_), .b(new_n78_), .c(new_n84_), .O(z7));
  ...
  nand4  g61(.a(new_n86_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n64_), .c(new_n89_), .d(new_n86_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n39_), .c(new_n43_), .O(new_n92_));
