...
module FAU ( 
  ...
  inv1   g51(.a(new_n73_), .O(new_n80_));
  nand2  g52(.a(new_n63_), .b(new_n31_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n80_), .c(x16), .d(x14), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nor2   g56(.a(new_n63_), .b(new_n57_), .O(new_n85_));
  nand4  g57(.a(new_n80_), .b(new_n85_), .c(new_n84_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n83_), .c(new_n54_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x10), .c(new_n30_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z7));
  nand3  g62(.a(new_n85_), .b(x17), .c(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n73_), .c(x18), .O(new_n92_));
