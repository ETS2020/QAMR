...
module FAU ( 
  ...
  aoi21  g16(.a(new_n44_), .b(new_n30_), .c(new_n43_), .O(new_n45_));
  ...
  oai21  g24(.a(new_n52_), .b(new_n43_), .c(new_n31_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n43_), .c(new_n31_), .O(new_n61_));
  ...
  oai21  g42(.a(new_n39_), .b(new_n64_), .c(new_n70_), .O(z5));
  inv1   g43(.a(x05), .O(new_n72_));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n48_), .c(x16), .O(new_n74_));
  ...
  oai21  g50(.a(new_n39_), .b(new_n72_), .c(new_n78_), .O(z6));
  inv1   g51(.a(new_n56_), .O(new_n80_));
  nand2  g52(.a(new_n58_), .b(x09), .O(new_n81_));
  nor2   g53(.a(new_n75_), .b(new_n65_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(x17), .O(new_n84_));
  nor2   g56(.a(x17), .b(new_n75_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n80_), .c(x15), .d(x14), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n84_), .c(x08), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n43_), .c(new_n31_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z7));
  and2   g62(.a(x17), .b(x16), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n81_), .c(new_n80_), .d(x15), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x18), .O(new_n93_));
  nand4  g65(.a(new_n82_), .b(new_n67_), .c(new_n29_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n93_), .c(x08), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n43_), .c(new_n31_), .O(new_n96_));
