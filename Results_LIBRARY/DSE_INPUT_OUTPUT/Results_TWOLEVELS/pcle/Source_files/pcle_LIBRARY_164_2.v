...
module FAU ( 
  ...
  oai21  g24(.a(x10), .b(new_n31_), .c(x08), .O(new_n53_));
  ...
  nand4  g30(.a(new_n58_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n59_));
  ...
  oai21  g38(.a(new_n53_), .b(new_n61_), .c(new_n66_), .O(z4));
  ...
  oai22  g44(.a(new_n72_), .b(new_n54_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(x05), .c(new_n53_), .d(new_n68_), .O(z5));
  oai21  g47(.a(new_n33_), .b(x08), .c(x05), .O(new_n76_));
  inv1   g48(.a(x16), .O(new_n77_));
  nand3  g49(.a(x14), .b(x13), .c(x12), .O(new_n78_));
  nand2  g50(.a(x15), .b(x11), .O(new_n79_));
  aoi21  g51(.a(new_n78_), .b(new_n31_), .c(new_n79_), .O(new_n80_));
  nand3  g52(.a(new_n77_), .b(x15), .c(x14), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(new_n62_), .c(new_n80_), .d(new_n77_), .O(new_n82_));
  ...
  oai21  g62(.a(new_n90_), .b(new_n62_), .c(new_n87_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(x05), .c(new_n53_), .d(new_n85_), .O(z7));
  inv1   g65(.a(x09), .O(new_n94_));
  inv1   g66(.a(new_n62_), .O(new_n95_));
  nand2  g67(.a(new_n77_), .b(new_n31_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n89_), .c(new_n95_), .d(x17), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(x18), .O(new_n98_));
  nor2   g70(.a(new_n77_), .b(new_n69_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n71_), .c(new_n29_), .d(x17), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n32_), .c(x05), .O(new_n102_));
  nand2  g74(.a(x08), .b(x07), .O(new_n103_));
  oai21  g75(.a(new_n102_), .b(x10), .c(new_n103_), .O(z8));
endmodule
