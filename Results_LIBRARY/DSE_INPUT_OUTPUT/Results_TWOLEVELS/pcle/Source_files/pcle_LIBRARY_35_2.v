...
module FAU ( 
  ...
  nand2  g29(.a(new_n57_), .b(new_n50_), .O(new_n58_));
  ...
  nand2  g39(.a(new_n67_), .b(new_n50_), .O(new_n68_));
  ...
  oai21  g44(.a(new_n72_), .b(new_n33_), .c(new_n70_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x04), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(new_n68_), .O(z5));
  ...
  oai21  g61(.a(new_n89_), .b(new_n79_), .c(new_n87_), .O(new_n90_));
  ...
  inv1   g70(.a(x18), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(x17), .c(x16), .d(x15), .O(new_n100_));
