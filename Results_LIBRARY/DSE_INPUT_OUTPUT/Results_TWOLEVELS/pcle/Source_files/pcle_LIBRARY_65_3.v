...
module FAU ( 
  ...
  aoi21  g34(.a(x08), .b(x03), .c(new_n54_), .O(new_n63_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n48_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n71_));
  oai21  g43(.a(new_n40_), .b(new_n65_), .c(new_n71_), .O(z5));
  inv1   g44(.a(x16), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x15), .c(x14), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(new_n57_), .c(new_n73_), .d(x14), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n31_), .O(new_n76_));
  nand2  g48(.a(x15), .b(x13), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n48_), .c(x16), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x09), .c(new_n30_), .O(new_n80_));
  aoi21  g52(.a(x08), .b(x05), .c(new_n54_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(z6));
  inv1   g54(.a(x17), .O(new_n83_));
  nand2  g55(.a(x16), .b(x15), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n59_), .c(new_n31_), .O(new_n85_));
  nand2  g57(.a(new_n57_), .b(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(new_n87_));
  nand4  g59(.a(new_n83_), .b(x16), .c(x15), .d(x14), .O(new_n88_));
  nor2   g60(.a(new_n88_), .b(new_n57_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n87_), .c(x09), .O(new_n90_));
  aoi21  g62(.a(x08), .b(x06), .c(new_n54_), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x08), .c(new_n91_), .O(z7));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  aoi22  g65(.a(new_n93_), .b(new_n31_), .c(new_n57_), .d(x16), .O(new_n94_));
  inv1   g66(.a(new_n84_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n68_), .c(new_n29_), .d(x17), .O(new_n96_));
  oai21  g68(.a(new_n94_), .b(new_n29_), .c(new_n96_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(x09), .c(new_n30_), .O(new_n98_));
  aoi21  g70(.a(x08), .b(x07), .c(new_n54_), .O(new_n99_));
