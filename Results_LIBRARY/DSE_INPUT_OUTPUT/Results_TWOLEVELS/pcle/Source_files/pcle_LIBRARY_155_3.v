...
module FAU ( 
  ...
  nand3  g09(.a(new_n29_), .b(x08), .c(x00), .O(new_n38_));
  ...
  aoi21  g32(.a(x08), .b(x03), .c(new_n52_), .O(new_n61_));
  ...
  aoi21  g40(.a(x08), .b(x04), .c(new_n52_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  oai21  g42(.a(x10), .b(x08), .c(x05), .O(new_n71_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n83_));
  aoi21  g55(.a(x08), .b(x06), .c(new_n52_), .O(new_n84_));
  ...
  aoi21  g64(.a(x08), .b(x07), .c(new_n52_), .O(new_n93_));
