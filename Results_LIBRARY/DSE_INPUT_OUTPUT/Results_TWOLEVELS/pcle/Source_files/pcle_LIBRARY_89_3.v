...
module FAU ( 
  ...
  nand2  g13(.a(x12), .b(x10), .O(new_n42_));
  ...
  nand3  g19(.a(new_n47_), .b(x09), .c(new_n31_), .O(new_n48_));
  ...
  nand3  g26(.a(new_n33_), .b(x12), .c(x11), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n33_), .c(new_n55_), .O(new_n56_));
  nand4  g28(.a(new_n56_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n57_));
  oai21  g29(.a(new_n43_), .b(new_n52_), .c(new_n57_), .O(z3));
  nand2  g30(.a(x13), .b(x12), .O(new_n59_));
  aoi22  g31(.a(new_n59_), .b(new_n29_), .c(x12), .d(new_n32_), .O(new_n60_));
  nand3  g32(.a(new_n54_), .b(new_n35_), .c(x13), .O(new_n61_));
  oai21  g33(.a(new_n60_), .b(new_n35_), .c(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(x09), .c(new_n31_), .O(new_n63_));
  aoi21  g35(.a(x08), .b(x03), .c(new_n49_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(z4));
  inv1   g37(.a(x04), .O(new_n66_));
  nand2  g38(.a(x14), .b(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n53_), .c(x15), .O(new_n68_));
  nand3  g40(.a(new_n36_), .b(x14), .c(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n53_), .c(new_n68_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n71_));
  oai21  g43(.a(new_n43_), .b(new_n66_), .c(new_n71_), .O(z5));
  ...
  oai21  g51(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n81_));
  oai21  g53(.a(new_n43_), .b(new_n73_), .c(new_n81_), .O(z6));
  ...
  nand4  g60(.a(new_n76_), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(x17), .c(new_n29_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(x09), .c(new_n31_), .O(new_n92_));
  aoi21  g64(.a(x08), .b(x06), .c(new_n49_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n92_), .O(z7));
  nand2  g66(.a(x18), .b(new_n32_), .O(new_n95_));
  ...
  nand4  g73(.a(new_n101_), .b(x14), .c(x13), .d(x12), .O(new_n102_));
  nand3  g74(.a(new_n102_), .b(x18), .c(new_n29_), .O(new_n103_));
  nand2  g75(.a(new_n103_), .b(new_n99_), .O(new_n104_));
  nand3  g76(.a(new_n104_), .b(x09), .c(new_n31_), .O(new_n105_));
  aoi21  g77(.a(x08), .b(x07), .c(new_n49_), .O(new_n106_));
