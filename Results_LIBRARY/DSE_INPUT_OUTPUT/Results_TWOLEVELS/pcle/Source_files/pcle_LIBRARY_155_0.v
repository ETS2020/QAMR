...
module FAU ( 
  ...
  oai21  g10(.a(x10), .b(x05), .c(x08), .O(new_n39_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n40_), .c(new_n52_), .O(new_n58_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n40_), .c(new_n52_), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n70_), .c(new_n29_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n40_), .c(new_n52_), .O(new_n74_));
  ...
  aoi21  g53(.a(new_n81_), .b(x09), .c(new_n52_), .O(new_n82_));
  oai22  g54(.a(new_n82_), .b(x10), .c(new_n40_), .d(new_n52_), .O(z6));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n40_), .c(new_n52_), .O(new_n89_));
  ...
  inv1   g65(.a(new_n69_), .O(new_n94_));
  nor2   g66(.a(new_n79_), .b(new_n71_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n86_), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n93_), .c(new_n29_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n40_), .c(new_n52_), .O(new_n99_));
