...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n46_));
  ...
  nand4  g39(.a(new_n67_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n63_), .O(z5));
  inv1   g41(.a(x16), .O(new_n70_));
  nand2  g42(.a(x14), .b(x13), .O(new_n71_));
  nand3  g43(.a(x15), .b(x12), .c(x11), .O(new_n72_));
  aoi21  g44(.a(new_n71_), .b(x09), .c(new_n72_), .O(new_n73_));
  nand3  g45(.a(new_n70_), .b(x15), .c(x14), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(new_n57_), .c(new_n73_), .d(new_n70_), .O(new_n75_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n85_));
