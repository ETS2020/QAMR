...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(new_n51_), .c(new_n29_), .O(new_n52_));
  ...
  nand4  g30(.a(new_n58_), .b(x09), .c(new_n29_), .d(x04), .O(new_n59_));
  ...
  nand4  g36(.a(new_n64_), .b(x09), .c(new_n29_), .d(x04), .O(new_n65_));
  ...
  nand3  g42(.a(new_n70_), .b(new_n38_), .c(x09), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n29_), .c(new_n51_), .O(z5));
  nand2  g44(.a(new_n52_), .b(x05), .O(new_n73_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n51_), .c(new_n73_), .O(z6));
  inv1   g53(.a(x17), .O(new_n82_));
  nand4  g54(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n83_));
  nand2  g55(.a(x16), .b(x11), .O(new_n84_));
  aoi21  g56(.a(new_n83_), .b(x04), .c(new_n84_), .O(new_n85_));
  nand4  g57(.a(new_n74_), .b(new_n31_), .c(new_n82_), .d(x16), .O(new_n86_));
  oai21  g58(.a(new_n85_), .b(new_n82_), .c(new_n86_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(x09), .c(new_n29_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(x04), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n38_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n90_), .O(z7));
  nand2  g64(.a(new_n52_), .b(x07), .O(new_n93_));
  ...
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n29_), .d(x04), .O(new_n99_));
