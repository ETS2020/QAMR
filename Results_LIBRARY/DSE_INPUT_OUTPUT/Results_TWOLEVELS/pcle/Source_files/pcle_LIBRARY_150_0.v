...
module FAU ( 
  ...
  aoi21  g36(.a(new_n64_), .b(new_n31_), .c(new_n45_), .O(z4));
  nand4  g37(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x15), .O(new_n67_));
  nor2   g39(.a(x15), .b(new_n30_), .O(new_n68_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n45_), .c(new_n74_), .O(z6));
  inv1   g53(.a(x15), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x03), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n61_), .c(x16), .d(x14), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(x17), .O(new_n85_));
  inv1   g57(.a(x17), .O(new_n86_));
  nor2   g58(.a(new_n82_), .b(new_n30_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n61_), .c(new_n86_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(new_n51_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n31_), .c(new_n45_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z7));
  nand2  g64(.a(new_n46_), .b(x07), .O(new_n93_));
  nand3  g65(.a(new_n87_), .b(x17), .c(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n60_), .c(x18), .O(new_n95_));
  inv1   g67(.a(new_n66_), .O(new_n96_));
  ...
  nand4  g71(.a(new_n99_), .b(x09), .c(new_n31_), .d(x03), .O(new_n100_));
