...
module FAU ( 
  ...
  nand3  g16(.a(x12), .b(new_n30_), .c(new_n29_), .O(new_n45_));
  oai21  g17(.a(x12), .b(new_n30_), .c(new_n45_), .O(new_n46_));
  ...
  nor2   g21(.a(new_n40_), .b(new_n31_), .O(new_n50_));
  ...
  oai22  g34(.a(new_n62_), .b(new_n53_), .c(new_n61_), .d(new_n34_), .O(new_n63_));
  ...
  oai21  g57(.a(new_n85_), .b(new_n32_), .c(new_n29_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x11), .O(new_n87_));
  nand3  g59(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n61_), .c(new_n84_), .O(new_n90_));
  ...
  nand2  g65(.a(new_n50_), .b(x07), .O(new_n94_));
  nand4  g66(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n60_), .c(x18), .O(new_n96_));
  nor2   g68(.a(new_n74_), .b(new_n35_), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n84_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n68_), .O(new_n99_));
