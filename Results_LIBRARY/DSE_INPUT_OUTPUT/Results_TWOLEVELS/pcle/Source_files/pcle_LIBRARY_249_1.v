...
module FAU ( 
  ...
  nand4  g33(.a(new_n61_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n62_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n69_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n77_));
  ...
  nand4  g58(.a(x17), .b(x13), .c(x12), .d(x11), .O(new_n87_));
  aoi21  g59(.a(new_n80_), .b(new_n29_), .c(new_n87_), .O(new_n88_));
  nand4  g60(.a(new_n36_), .b(x17), .c(x16), .d(x15), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(new_n65_), .c(new_n88_), .d(new_n36_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(x09), .c(x10), .O(new_n91_));
