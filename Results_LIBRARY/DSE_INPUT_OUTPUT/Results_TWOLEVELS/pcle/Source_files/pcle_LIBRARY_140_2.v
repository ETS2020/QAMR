...
module FAU ( 
  ...
  aoi21  g26(.a(new_n54_), .b(x09), .c(x03), .O(new_n55_));
  ...
  oai22  g32(.a(new_n60_), .b(new_n50_), .c(new_n59_), .d(new_n30_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n31_), .O(z4));
  ...
  oai21  g42(.a(new_n69_), .b(x03), .c(new_n70_), .O(z5));
  nand3  g43(.a(x15), .b(x14), .c(x13), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n50_), .c(x16), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand4  g46(.a(new_n59_), .b(new_n74_), .c(x15), .d(x14), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n73_), .c(x10), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(x09), .c(x03), .O(new_n77_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n59_), .c(x15), .d(x14), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n81_), .c(x10), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(x09), .c(x03), .O(new_n85_));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n89_), .c(x10), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(x09), .c(x03), .O(new_n93_));
