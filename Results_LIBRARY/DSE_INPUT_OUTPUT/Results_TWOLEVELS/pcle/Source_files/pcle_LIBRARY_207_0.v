...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n93_, new_n94_;
  nor2   g00(.a(x09), .b(x02), .O(new_n29_));
  ...
  nand2  g35(.a(new_n44_), .b(x04), .O(new_n64_));
  ...
  nor2   g60(.a(new_n74_), .b(new_n65_), .O(new_n89_));
  nor2   g61(.a(x18), .b(new_n82_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(new_n67_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n93_));
  aoi21  g65(.a(x08), .b(x07), .c(new_n29_), .O(new_n94_));
