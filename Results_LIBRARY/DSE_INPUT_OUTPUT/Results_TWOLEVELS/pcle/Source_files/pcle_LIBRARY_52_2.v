...
module FAU ( 
  ...
  oai21  g11(.a(x15), .b(new_n29_), .c(x08), .O(new_n40_));
  ...
  aoi21  g24(.a(new_n52_), .b(new_n50_), .c(new_n41_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n54_));
  oai21  g26(.a(new_n40_), .b(new_n49_), .c(new_n54_), .O(z3));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n58_), .c(new_n41_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n62_));
  oai21  g34(.a(new_n40_), .b(new_n56_), .c(new_n62_), .O(z4));
  inv1   g35(.a(x04), .O(new_n64_));
  nand4  g36(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(x15), .c(new_n31_), .d(x09), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(x08), .c(new_n40_), .d(new_n64_), .O(z5));
  inv1   g39(.a(x05), .O(new_n68_));
  oai21  g40(.a(new_n34_), .b(new_n32_), .c(x16), .O(new_n69_));
  inv1   g41(.a(x16), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(x14), .c(x13), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n32_), .c(new_n69_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(x15), .c(new_n31_), .d(x09), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(x08), .c(new_n40_), .d(new_n68_), .O(z6));
  nand3  g46(.a(x16), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n32_), .c(x17), .O(new_n76_));
  inv1   g48(.a(new_n57_), .O(new_n77_));
  nor2   g49(.a(x17), .b(new_n70_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n77_), .c(x14), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n76_), .c(x10), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n30_), .c(new_n41_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(new_n29_), .c(new_n82_), .O(z7));
  nand3  g55(.a(x17), .b(x16), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n57_), .c(x18), .O(new_n85_));
  inv1   g57(.a(x18), .O(new_n86_));
  and2   g58(.a(x16), .b(x14), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n77_), .c(new_n86_), .d(x17), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(x10), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n30_), .c(new_n41_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x07), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(new_n29_), .c(new_n91_), .O(z8));
endmodule
