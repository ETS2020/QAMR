...
module FAU ( 
  ...
  aoi21  g24(.a(new_n52_), .b(new_n50_), .c(new_n30_), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n38_), .c(x00), .O(new_n54_));
  nand2  g26(.a(x08), .b(x02), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(x10), .c(new_n55_), .O(z3));
  aoi21  g28(.a(new_n42_), .b(x00), .c(new_n38_), .O(new_n57_));
  ...
  nand2  g37(.a(new_n51_), .b(new_n29_), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n38_), .c(x00), .O(new_n72_));
  nand2  g44(.a(x08), .b(x04), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(x10), .c(new_n73_), .O(z5));
  nand3  g46(.a(new_n66_), .b(new_n61_), .c(new_n33_), .O(new_n75_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n38_), .c(x00), .O(new_n81_));
  ...
  nand3  g59(.a(new_n33_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n31_), .c(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n42_), .c(x09), .d(new_n38_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x00), .c(new_n84_), .O(z7));
  nand2  g63(.a(new_n57_), .b(x07), .O(new_n92_));
  nand3  g64(.a(new_n33_), .b(x17), .c(x16), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n31_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n77_), .b(new_n69_), .O(new_n95_));
  nor2   g67(.a(new_n60_), .b(new_n51_), .O(new_n96_));
  ...
  nand4  g71(.a(new_n99_), .b(x09), .c(new_n38_), .d(new_n29_), .O(new_n100_));
