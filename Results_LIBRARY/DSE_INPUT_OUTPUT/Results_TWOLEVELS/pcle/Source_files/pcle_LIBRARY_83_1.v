...
module FAU ( 
  ...
  nand4  g24(.a(new_n52_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n53_));
  nand2  g25(.a(x08), .b(x02), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n53_), .O(z3));
  inv1   g27(.a(x09), .O(new_n56_));
  oai21  g28(.a(x12), .b(x10), .c(x13), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n40_), .c(x14), .O(new_n58_));
  nand3  g30(.a(new_n50_), .b(new_n32_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n58_), .c(new_n56_), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(x10), .c(new_n44_), .O(new_n61_));
  ...
  oai22  g39(.a(new_n67_), .b(new_n64_), .c(new_n66_), .d(new_n33_), .O(new_n68_));
  ...
  nand2  g43(.a(new_n32_), .b(new_n29_), .O(new_n72_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n74_), .c(new_n56_), .O(new_n79_));
  ...
  nand3  g55(.a(new_n83_), .b(new_n76_), .c(new_n72_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(x17), .O(new_n85_));
  nand4  g57(.a(new_n76_), .b(new_n34_), .c(new_n35_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n85_), .c(new_n56_), .O(new_n87_));
  ...
  nand4  g64(.a(new_n83_), .b(new_n66_), .c(new_n36_), .d(x17), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n92_), .c(new_n56_), .O(new_n94_));
