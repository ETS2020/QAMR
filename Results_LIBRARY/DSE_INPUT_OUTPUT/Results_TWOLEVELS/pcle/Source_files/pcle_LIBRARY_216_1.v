...
module FAU ( 
  ...
  oai21  g50(.a(new_n79_), .b(new_n54_), .c(x17), .O(new_n80_));
  inv1   g51(.a(x17), .O(new_n81_));
  nand4  g52(.a(new_n81_), .b(x16), .c(x15), .d(x14), .O(new_n82_));
  oai21  g53(.a(new_n82_), .b(new_n54_), .c(new_n80_), .O(new_n83_));
  ...
  nand4  g57(.a(new_n57_), .b(new_n30_), .c(x09), .d(new_n32_), .O(new_n87_));
  inv1   g58(.a(new_n71_), .O(new_n88_));
  nand4  g59(.a(new_n88_), .b(new_n31_), .c(x17), .d(x16), .O(new_n89_));
  oai22  g60(.a(new_n89_), .b(new_n87_), .c(new_n40_), .d(new_n86_), .O(z8));
  zero   g61(.O(z0));
endmodule
