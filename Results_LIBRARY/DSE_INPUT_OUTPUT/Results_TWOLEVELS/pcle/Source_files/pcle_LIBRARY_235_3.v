...
module FAU ( 
  ...
  oai22  g32(.a(new_n60_), .b(new_n49_), .c(new_n59_), .d(new_n57_), .O(new_n61_));
  ...
  oai21  g51(.a(new_n78_), .b(new_n38_), .c(new_n79_), .O(z6));
  ...
  oai21  g60(.a(new_n48_), .b(new_n81_), .c(new_n88_), .O(z7));
  nand2  g61(.a(new_n72_), .b(new_n31_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n85_), .c(new_n59_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x18), .O(new_n92_));
  nor2   g64(.a(new_n72_), .b(new_n65_), .O(new_n93_));
