...
module FAU ( 
  ...
  nand2  g46(.a(new_n33_), .b(x01), .O(new_n75_));
  ...
  oai21  g54(.a(new_n82_), .b(x01), .c(new_n76_), .O(z6));
  inv1   g55(.a(new_n59_), .O(new_n84_));
  nand2  g56(.a(new_n69_), .b(new_n31_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n84_), .c(x16), .d(x14), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x17), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nor2   g60(.a(new_n69_), .b(new_n30_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n84_), .c(new_n88_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n50_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n32_), .c(x01), .O(new_n92_));
  ...
  inv1   g69(.a(new_n67_), .O(new_n98_));
  nor2   g70(.a(x18), .b(new_n88_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n98_), .c(x16), .d(x15), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n97_), .c(new_n50_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n32_), .c(x01), .O(new_n102_));
