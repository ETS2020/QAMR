...
module FAU ( 
  ...
  aoi21  g17(.a(new_n45_), .b(x09), .c(x10), .O(new_n46_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n69_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n77_));
  nand2  g49(.a(x08), .b(x05), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z6));
  aoi21  g51(.a(x14), .b(x13), .c(x10), .O(new_n80_));
  nand4  g52(.a(x16), .b(x15), .c(x12), .d(x11), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n80_), .c(x17), .O(new_n82_));
  nand4  g54(.a(new_n59_), .b(new_n34_), .c(new_n35_), .d(x16), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n82_), .c(new_n49_), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(x10), .c(new_n41_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(z7));
  inv1   g59(.a(new_n50_), .O(new_n88_));
  nand2  g60(.a(x14), .b(x13), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n29_), .O(new_n90_));
  nand3  g62(.a(x17), .b(x16), .c(x15), .O(new_n91_));
  inv1   g63(.a(new_n91_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n90_), .c(new_n88_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x18), .O(new_n94_));
  nor2   g66(.a(new_n74_), .b(new_n33_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n66_), .c(new_n36_), .d(x17), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n94_), .c(new_n49_), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(x10), .c(new_n41_), .O(new_n98_));
