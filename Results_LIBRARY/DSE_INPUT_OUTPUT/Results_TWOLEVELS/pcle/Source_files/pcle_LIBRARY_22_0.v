...
module FAU ( 
  ...
  oai22  g44(.a(new_n72_), .b(new_n62_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n74_));
  oai21  g46(.a(new_n59_), .b(new_n68_), .c(new_n74_), .O(z5));
  inv1   g47(.a(x05), .O(new_n76_));
  nand3  g48(.a(x15), .b(x14), .c(x13), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n62_), .c(x16), .O(new_n78_));
  ...
  oai21  g54(.a(new_n59_), .b(new_n76_), .c(new_n82_), .O(z6));
  inv1   g55(.a(x12), .O(new_n84_));
  nand3  g56(.a(x17), .b(new_n31_), .c(new_n30_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x09), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g59(.a(x13), .b(x11), .O(new_n88_));
  nand3  g60(.a(x16), .b(x15), .c(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n88_), .c(x17), .O(new_n90_));
