...
module FAU ( 
  ...
  oai21  g59(.a(new_n42_), .b(x07), .c(x08), .O(new_n88_));
  inv1   g60(.a(x18), .O(new_n89_));
  nand4  g61(.a(x17), .b(x13), .c(x12), .d(x11), .O(new_n90_));
  aoi21  g62(.a(new_n80_), .b(new_n29_), .c(new_n90_), .O(new_n91_));
  nand4  g63(.a(new_n89_), .b(x17), .c(x16), .d(x15), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(new_n64_), .c(new_n91_), .d(new_n89_), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(new_n42_), .c(x09), .O(new_n94_));
