...
module FAU ( 
  ...
  nor2   g46(.a(x16), .b(new_n64_), .O(new_n75_));
  ...
  nor2   g56(.a(new_n64_), .b(new_n56_), .O(new_n85_));
  ...
  nand4  g64(.a(new_n81_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(new_n94_));
