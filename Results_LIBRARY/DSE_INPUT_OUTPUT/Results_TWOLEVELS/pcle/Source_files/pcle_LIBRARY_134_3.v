...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(x12), .c(x11), .d(new_n31_), .O(new_n51_));
  ...
  oai21  g37(.a(new_n60_), .b(new_n50_), .c(new_n31_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n49_), .c(new_n65_), .O(new_n67_));
  nor4   g39(.a(new_n48_), .b(x15), .c(new_n60_), .d(new_n50_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n67_), .c(x09), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x04), .c(new_n54_), .O(new_n70_));
  ...
  aoi21  g46(.a(new_n74_), .b(new_n49_), .c(new_n72_), .O(new_n75_));
  nor4   g47(.a(new_n58_), .b(x16), .c(new_n65_), .d(new_n60_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n75_), .c(x09), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x05), .c(new_n54_), .O(new_n78_));
