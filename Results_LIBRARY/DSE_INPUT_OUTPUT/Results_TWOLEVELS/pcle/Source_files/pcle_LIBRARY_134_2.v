...
module FAU ( 
  ...
  aoi22  g25(.a(new_n50_), .b(x10), .c(x08), .d(x02), .O(new_n54_));
  ...
  oai21  g51(.a(new_n79_), .b(new_n57_), .c(new_n78_), .O(new_n80_));
