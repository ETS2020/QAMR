...
module FAU ( 
  ...
  nor3   g06(.a(x16), .b(x11), .c(x10), .O(new_n35_));
  ...
  nand4  g12(.a(new_n40_), .b(new_n29_), .c(new_n39_), .d(x09), .O(new_n41_));
  oai22  g13(.a(new_n41_), .b(x08), .c(new_n32_), .d(new_n38_), .O(z2));
  inv1   g14(.a(x08), .O(new_n43_));
  nand2  g15(.a(x12), .b(x11), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(x13), .O(new_n45_));
  inv1   g17(.a(x13), .O(new_n46_));
  nand3  g18(.a(new_n46_), .b(x12), .c(x11), .O(new_n47_));
  aoi21  g19(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n43_), .c(x16), .O(new_n49_));
  nand2  g21(.a(x08), .b(x02), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(x10), .c(new_n50_), .O(z3));
  nand3  g23(.a(x13), .b(x12), .c(x11), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(x14), .O(new_n53_));
  inv1   g25(.a(x14), .O(new_n54_));
  and2   g26(.a(x12), .b(x11), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n54_), .c(x13), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n53_), .c(new_n33_), .O(new_n57_));
  aoi21  g29(.a(new_n57_), .b(new_n43_), .c(x16), .O(new_n58_));
  nand2  g30(.a(x08), .b(x03), .O(new_n59_));
  oai21  g31(.a(new_n58_), .b(x10), .c(new_n59_), .O(z4));
  nand2  g32(.a(x14), .b(x13), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n44_), .c(x15), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  nand4  g35(.a(new_n55_), .b(new_n63_), .c(x14), .d(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n33_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n43_), .c(x16), .O(new_n66_));
  nand2  g38(.a(x08), .b(x04), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(x10), .c(new_n67_), .O(z5));
  nand3  g40(.a(x11), .b(x09), .c(new_n43_), .O(new_n69_));
  ...
  nand4  g47(.a(new_n34_), .b(x17), .c(new_n29_), .d(new_n39_), .O(new_n76_));
  oai21  g48(.a(new_n32_), .b(new_n75_), .c(new_n76_), .O(z7));
  nand2  g49(.a(x18), .b(x09), .O(new_n78_));
