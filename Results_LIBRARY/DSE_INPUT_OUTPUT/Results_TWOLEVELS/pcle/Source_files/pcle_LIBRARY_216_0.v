...
module FAU ( 
  ...
  aoi21  g12(.a(new_n40_), .b(new_n38_), .c(new_n29_), .O(new_n41_));
  ...
  inv1   g23(.a(new_n49_), .O(new_n52_));
  nand3  g24(.a(new_n52_), .b(x18), .c(new_n51_), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n50_), .c(new_n39_), .O(new_n54_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n61_), .c(x13), .O(new_n62_));
  ...
  oai22  g54(.a(new_n82_), .b(x08), .c(new_n45_), .d(new_n76_), .O(z6));
  ...
  oai22  g62(.a(new_n90_), .b(x08), .c(new_n45_), .d(new_n84_), .O(z7));
  ...
  nand4  g67(.a(new_n95_), .b(x18), .c(new_n31_), .d(x09), .O(new_n96_));
  oai22  g68(.a(new_n96_), .b(x08), .c(new_n45_), .d(new_n92_), .O(z8));
endmodule
