...
module FAU ( 
  ...
  nand2  g10(.a(new_n29_), .b(x10), .O(new_n39_));
  ...
  nor2   g38(.a(new_n58_), .b(new_n51_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n53_), .O(new_n68_));
  ...
  aoi21  g45(.a(x08), .b(x04), .c(new_n64_), .O(new_n74_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n67_), .c(new_n53_), .d(new_n42_), .O(new_n94_));
  ...
  aoi21  g70(.a(new_n98_), .b(new_n60_), .c(new_n29_), .O(new_n99_));
