...
module FAU ( 
  ...
  nand3  g27(.a(new_n55_), .b(new_n54_), .c(new_n39_), .O(z3));
  ...
  oai21  g54(.a(new_n74_), .b(new_n49_), .c(x17), .O(new_n83_));
  ...
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n82_), .O(z7));
  nand2  g61(.a(x18), .b(x09), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x08), .c(new_n31_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n38_), .O(new_n92_));
  nand3  g64(.a(x17), .b(x15), .c(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n58_), .c(x18), .O(new_n94_));
  nand4  g66(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n66_), .c(new_n94_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n97_));
  nand2  g69(.a(x08), .b(x07), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n92_), .O(z8));
endmodule
