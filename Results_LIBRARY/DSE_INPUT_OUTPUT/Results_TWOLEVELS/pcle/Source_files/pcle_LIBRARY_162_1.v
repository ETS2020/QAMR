...
module FAU ( 
  ...
  nor3   g05(.a(x16), .b(x11), .c(x10), .O(new_n35_));
  ...
  nand4  g20(.a(new_n49_), .b(new_n39_), .c(x09), .d(new_n44_), .O(new_n50_));
  oai21  g21(.a(new_n32_), .b(new_n43_), .c(new_n50_), .O(z3));
  ...
  aoi21  g28(.a(new_n57_), .b(new_n54_), .c(x16), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n39_), .c(x09), .d(new_n44_), .O(new_n59_));
  oai21  g30(.a(new_n32_), .b(new_n52_), .c(new_n59_), .O(z4));
  nand2  g31(.a(x13), .b(x11), .O(new_n61_));
  oai21  g32(.a(x16), .b(x12), .c(x14), .O(new_n62_));
  ...
  aoi21  g36(.a(new_n65_), .b(new_n63_), .c(new_n33_), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n44_), .c(x16), .O(new_n67_));
  nand2  g38(.a(x08), .b(x04), .O(new_n68_));
  oai21  g39(.a(new_n67_), .b(x10), .c(new_n68_), .O(z5));
  nand3  g40(.a(x11), .b(x09), .c(new_n44_), .O(new_n70_));
  ...
  inv1   g46(.a(x06), .O(new_n76_));
  nand4  g47(.a(new_n34_), .b(x17), .c(new_n31_), .d(new_n39_), .O(new_n77_));
  oai21  g48(.a(new_n32_), .b(new_n76_), .c(new_n77_), .O(z7));
  inv1   g49(.a(x07), .O(new_n79_));
  nand4  g50(.a(new_n34_), .b(x18), .c(new_n31_), .d(new_n39_), .O(new_n80_));
  oai21  g51(.a(new_n32_), .b(new_n79_), .c(new_n80_), .O(z8));
  zero   g52(.O(z0));
endmodule
