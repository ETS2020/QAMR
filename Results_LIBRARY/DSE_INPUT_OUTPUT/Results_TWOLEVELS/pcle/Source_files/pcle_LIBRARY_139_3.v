...
module FAU ( 
  ...
  aoi21  g13(.a(new_n41_), .b(new_n39_), .c(x10), .O(z1));
  ...
  nand4  g23(.a(new_n51_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n52_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n69_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n76_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n85_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n94_));
