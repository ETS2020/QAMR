...
module FAU ( 
  ...
  oai21  g04(.a(x07), .b(x01), .c(x18), .O(new_n33_));
  ...
  nor2   g10(.a(x07), .b(x01), .O(new_n39_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n62_));
  ...
  nand3  g38(.a(new_n51_), .b(x14), .c(x13), .O(new_n67_));
  ...
  nand4  g42(.a(new_n70_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n71_), .c(new_n39_), .O(z5));
  nor2   g45(.a(new_n65_), .b(new_n59_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n51_), .c(x13), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(x16), .O(new_n76_));
  nand3  g48(.a(new_n31_), .b(x15), .c(x14), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n57_), .c(new_n76_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x05), .c(new_n39_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z6));
  nor2   g53(.a(new_n31_), .b(new_n65_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n57_), .c(x17), .O(new_n84_));
  nand3  g56(.a(new_n74_), .b(new_n32_), .c(x16), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n57_), .c(new_n84_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n87_), .c(new_n39_), .O(z7));
  nand3  g61(.a(new_n74_), .b(x17), .c(x16), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n57_), .c(x18), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n32_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n82_), .c(new_n68_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n95_));
