...
module FAU ( 
  ...
  oai21  g21(.a(new_n33_), .b(new_n34_), .c(new_n49_), .O(new_n50_));
  ...
  aoi21  g31(.a(x08), .b(x03), .c(new_n52_), .O(new_n60_));
  ...
  aoi21  g39(.a(x08), .b(x04), .c(new_n52_), .O(new_n68_));
  ...
  nand2  g43(.a(new_n33_), .b(new_n29_), .O(new_n72_));
  nand4  g44(.a(new_n30_), .b(x15), .c(x14), .d(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(x09), .c(new_n31_), .O(new_n75_));
  aoi21  g47(.a(x08), .b(x05), .c(new_n52_), .O(new_n76_));
  ...
  oai21  g56(.a(new_n41_), .b(new_n78_), .c(new_n84_), .O(z7));
  inv1   g57(.a(x18), .O(new_n86_));
  oai21  g58(.a(new_n81_), .b(new_n30_), .c(new_n29_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n71_), .c(new_n86_), .O(new_n88_));
  nand4  g60(.a(new_n86_), .b(x17), .c(x16), .d(x15), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n62_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n88_), .c(x09), .O(new_n91_));
  aoi21  g63(.a(x08), .b(x07), .c(new_n52_), .O(new_n92_));
