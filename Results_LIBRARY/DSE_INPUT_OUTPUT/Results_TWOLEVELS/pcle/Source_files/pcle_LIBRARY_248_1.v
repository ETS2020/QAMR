...
module FAU ( 
  ...
  aoi21  g19(.a(new_n47_), .b(new_n45_), .c(new_n42_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n33_), .c(x18), .O(new_n49_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n54_), .c(x13), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n53_), .c(new_n42_), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n33_), .c(x18), .O(new_n57_));
  nand2  g29(.a(x08), .b(x03), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x10), .c(new_n58_), .O(z4));
  inv1   g31(.a(x04), .O(new_n60_));
  nand3  g32(.a(new_n43_), .b(x14), .c(x13), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(x15), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(x14), .c(x13), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n44_), .c(new_n62_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(x08), .c(new_n32_), .d(new_n60_), .O(z5));
  nand2  g39(.a(new_n29_), .b(new_n54_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n43_), .c(x15), .d(x13), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x16), .O(new_n70_));
  inv1   g42(.a(new_n52_), .O(new_n71_));
  nor2   g43(.a(x16), .b(new_n63_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n71_), .c(x14), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n70_), .c(new_n42_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n33_), .c(x18), .O(new_n75_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n84_));
  oai22  g56(.a(new_n84_), .b(x08), .c(new_n32_), .d(new_n78_), .O(z7));
  inv1   g57(.a(x07), .O(new_n86_));
  nand4  g58(.a(new_n43_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n87_));
  nand3  g59(.a(x15), .b(x14), .c(x13), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n29_), .c(x17), .d(x16), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n87_), .c(new_n32_), .d(new_n86_), .O(z8));
endmodule
