...
module FAU ( 
  ...
  nand4  g25(.a(new_n53_), .b(new_n31_), .c(x09), .d(new_n40_), .O(new_n54_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n31_), .c(x09), .d(new_n40_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x03), .c(new_n41_), .O(new_n63_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n40_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n41_), .O(new_n71_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n31_), .c(x09), .d(new_n40_), .O(new_n78_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n31_), .c(x09), .d(new_n40_), .O(new_n86_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n31_), .c(x09), .d(new_n40_), .O(new_n95_));
