...
module FAU ( 
  ...
  nand3  g05(.a(new_n33_), .b(new_n31_), .c(new_n30_), .O(new_n34_));
  ...
  nand4  g11(.a(new_n39_), .b(new_n36_), .c(new_n35_), .d(x16), .O(new_n40_));
  aoi21  g12(.a(new_n40_), .b(x09), .c(new_n29_), .O(z0));
  inv1   g13(.a(x00), .O(new_n42_));
  oai21  g14(.a(new_n29_), .b(x09), .c(x08), .O(new_n43_));
  ...
  nand2  g29(.a(new_n51_), .b(x03), .O(new_n58_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n32_), .c(x15), .O(new_n68_));
  nand3  g40(.a(new_n29_), .b(x14), .c(x13), .O(new_n69_));
  ...
  nand2  g44(.a(new_n51_), .b(x05), .O(new_n73_));
  ...
  oai21  g62(.a(new_n90_), .b(new_n34_), .c(x09), .O(new_n91_));
