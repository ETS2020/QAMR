...
module FAU ( 
  ...
  oai21  g17(.a(x03), .b(x02), .c(x08), .O(new_n46_));
  ...
  oai21  g32(.a(new_n30_), .b(new_n54_), .c(new_n60_), .O(z4));
  ...
  nand3  g39(.a(x08), .b(x04), .c(new_n54_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  oai21  g41(.a(x05), .b(x03), .c(x08), .O(new_n70_));
  ...
  oai21  g49(.a(x06), .b(x03), .c(x08), .O(new_n78_));
  ...
  oai21  g57(.a(x07), .b(x03), .c(x08), .O(new_n86_));
