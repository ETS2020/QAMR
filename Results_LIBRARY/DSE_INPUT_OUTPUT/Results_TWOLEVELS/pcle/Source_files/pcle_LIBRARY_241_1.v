...
module FAU ( 
  ...
  aoi21  g39(.a(new_n68_), .b(new_n33_), .c(x18), .O(new_n69_));
  ...
  aoi21  g49(.a(new_n78_), .b(new_n33_), .c(x18), .O(new_n79_));
  ...
  oai21  g54(.a(new_n83_), .b(new_n74_), .c(x17), .O(new_n84_));
  inv1   g55(.a(x17), .O(new_n85_));
  nand4  g56(.a(new_n85_), .b(x16), .c(x15), .d(x14), .O(new_n86_));
  oai21  g57(.a(new_n86_), .b(new_n74_), .c(new_n84_), .O(new_n87_));
  nand4  g58(.a(new_n87_), .b(new_n31_), .c(new_n34_), .d(x09), .O(new_n88_));
  oai22  g59(.a(new_n88_), .b(x08), .c(new_n32_), .d(new_n82_), .O(z7));
  nand3  g60(.a(new_n57_), .b(x09), .c(new_n33_), .O(new_n90_));
  inv1   g61(.a(new_n90_), .O(new_n91_));
  nand3  g62(.a(x17), .b(x16), .c(x15), .O(new_n92_));
  nor3   g63(.a(new_n92_), .b(new_n56_), .c(new_n47_), .O(new_n93_));
  aoi21  g64(.a(new_n93_), .b(new_n91_), .c(x18), .O(new_n94_));
  nand2  g65(.a(x08), .b(x07), .O(new_n95_));
  oai21  g66(.a(new_n94_), .b(x10), .c(new_n95_), .O(z8));
  zero   g67(.O(z0));
endmodule
