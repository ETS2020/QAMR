...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x13), .c(new_n30_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  aoi21  g12(.a(new_n38_), .b(x13), .c(x11), .O(new_n41_));
  ...
  aoi21  g29(.a(new_n49_), .b(x17), .c(new_n51_), .O(new_n58_));
  nand3  g30(.a(x17), .b(new_n57_), .c(x13), .O(new_n59_));
  oai22  g31(.a(new_n59_), .b(new_n49_), .c(new_n58_), .d(new_n57_), .O(new_n60_));
  ...
  aoi21  g37(.a(new_n65_), .b(x17), .c(new_n51_), .O(new_n66_));
  nand3  g38(.a(x13), .b(x12), .c(x11), .O(new_n67_));
  nand3  g39(.a(x17), .b(new_n64_), .c(x14), .O(new_n68_));
  ...
  nand4  g43(.a(x11), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n72_));
  nor2   g44(.a(new_n38_), .b(x16), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(x15), .c(x14), .d(x12), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n72_), .c(x17), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(x13), .O(new_n76_));
  inv1   g48(.a(x16), .O(new_n77_));
  nor4   g49(.a(new_n49_), .b(new_n64_), .c(new_n57_), .d(new_n51_), .O(new_n78_));
  nor2   g50(.a(new_n78_), .b(new_n77_), .O(new_n79_));
