...
module FAU ( 
  ...
  inv1   g48(.a(new_n58_), .O(new_n77_));
  ...
  nand4  g61(.a(new_n89_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n45_), .c(new_n41_), .d(new_n83_), .O(z7));
  nand2  g63(.a(new_n76_), .b(x01), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n87_), .c(new_n77_), .d(x17), .O(new_n93_));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n94_), .c(new_n49_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n31_), .c(new_n45_), .O(new_n99_));
