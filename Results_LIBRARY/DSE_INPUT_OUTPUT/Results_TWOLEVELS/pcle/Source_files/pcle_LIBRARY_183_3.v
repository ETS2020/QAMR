...
module FAU ( 
  ...
  aoi21  g15(.a(new_n43_), .b(new_n39_), .c(x10), .O(new_n44_));
  nand2  g16(.a(x08), .b(x01), .O(new_n45_));
  oai21  g17(.a(new_n44_), .b(new_n29_), .c(new_n45_), .O(z2));
  aoi21  g18(.a(x10), .b(x09), .c(new_n39_), .O(new_n47_));
  ...
  nand4  g25(.a(new_n53_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n54_));
  ...
  oai22  g38(.a(new_n66_), .b(new_n49_), .c(new_n65_), .d(new_n34_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n68_));
  ...
  oai21  g46(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n39_), .c(x10), .O(new_n76_));
  nand2  g48(.a(x08), .b(x05), .O(new_n77_));
  oai21  g49(.a(new_n76_), .b(new_n29_), .c(new_n77_), .O(z6));
  nand3  g50(.a(x16), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n72_), .c(x17), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(x16), .c(x15), .d(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n72_), .c(new_n80_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n39_), .c(x10), .O(new_n84_));
  ...
  oai21  g60(.a(new_n88_), .b(new_n72_), .c(x18), .O(new_n89_));
  nor2   g61(.a(x18), .b(new_n81_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n65_), .c(x16), .d(x15), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n93_));
