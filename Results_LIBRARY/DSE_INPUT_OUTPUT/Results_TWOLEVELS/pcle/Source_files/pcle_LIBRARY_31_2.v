...
module FAU ( 
  ...
  nand3  g12(.a(new_n40_), .b(new_n39_), .c(new_n29_), .O(new_n41_));
  aoi21  g13(.a(new_n41_), .b(new_n38_), .c(new_n37_), .O(z1));
  xor2a  g14(.a(x12), .b(x11), .O(new_n43_));
  nand3  g15(.a(new_n43_), .b(new_n39_), .c(new_n29_), .O(new_n44_));
  nand2  g16(.a(x08), .b(x01), .O(new_n45_));
  aoi21  g17(.a(new_n45_), .b(new_n44_), .c(new_n37_), .O(z2));
