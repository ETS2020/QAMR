...
module FAU ( 
  ...
  oai21  g26(.a(x12), .b(x10), .c(x13), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(new_n38_), .c(x14), .O(new_n56_));
  inv1   g28(.a(x14), .O(new_n57_));
  nand3  g29(.a(new_n48_), .b(new_n57_), .c(x13), .O(new_n58_));
  ...
  nand4  g38(.a(new_n48_), .b(new_n66_), .c(x14), .d(x13), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(new_n54_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(x10), .c(new_n30_), .O(new_n69_));
  ...
  nand2  g53(.a(new_n66_), .b(new_n31_), .O(new_n82_));
  ...
  nand4  g58(.a(new_n81_), .b(new_n86_), .c(new_n85_), .d(x16), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(new_n54_), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(x10), .c(new_n30_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  and2   g63(.a(x17), .b(x16), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n82_), .c(new_n81_), .d(x14), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x18), .O(new_n94_));
  inv1   g66(.a(new_n64_), .O(new_n95_));
  nor2   g67(.a(new_n75_), .b(new_n66_), .O(new_n96_));
  nor2   g68(.a(x18), .b(new_n85_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n48_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n94_), .c(new_n54_), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(x10), .c(new_n30_), .O(new_n100_));
