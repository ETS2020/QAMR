...
module FAU ( 
  ...
  oai21  g42(.a(new_n70_), .b(new_n49_), .c(new_n68_), .O(new_n71_));
  ...
  oai21  g55(.a(new_n75_), .b(new_n49_), .c(x17), .O(new_n84_));
  ...
  oai21  g63(.a(new_n91_), .b(x08), .c(new_n31_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n39_), .O(new_n93_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n67_), .c(new_n95_), .O(new_n97_));
