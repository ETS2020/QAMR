...
module FAU ( 
  ...
  oai21  g36(.a(new_n51_), .b(new_n59_), .c(new_n64_), .O(z4));
  inv1   g37(.a(x09), .O(new_n66_));
  aoi21  g38(.a(x13), .b(x12), .c(x00), .O(new_n67_));
  ...
  oai21  g62(.a(new_n90_), .b(new_n60_), .c(new_n87_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(x00), .c(new_n51_), .d(new_n85_), .O(z7));
  nand2  g65(.a(new_n78_), .b(new_n31_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n89_), .c(new_n79_), .d(x17), .O(new_n95_));
  ...
  aoi21  g73(.a(new_n101_), .b(new_n32_), .c(x00), .O(new_n102_));
