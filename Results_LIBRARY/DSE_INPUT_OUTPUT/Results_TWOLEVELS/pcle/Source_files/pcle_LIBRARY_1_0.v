...
module FAU ( 
  ...
  nand3  g28(.a(new_n56_), .b(new_n38_), .c(x09), .O(new_n57_));
  aoi21  g29(.a(new_n57_), .b(new_n39_), .c(new_n47_), .O(z3));
  inv1   g30(.a(x12), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(x02), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(x13), .c(x11), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(x14), .O(new_n62_));
  inv1   g34(.a(x14), .O(new_n63_));
  nand3  g35(.a(new_n54_), .b(new_n63_), .c(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n29_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n39_), .c(new_n47_), .O(new_n66_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n38_), .c(x09), .d(new_n39_), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(new_n47_), .c(new_n48_), .d(new_n69_), .O(z5));
  nand2  g48(.a(new_n63_), .b(x02), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n54_), .c(x15), .d(x13), .O(new_n78_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n39_), .c(new_n47_), .O(new_n84_));
  ...
  nand3  g61(.a(new_n32_), .b(new_n33_), .c(x16), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n30_), .c(new_n89_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n38_), .c(x09), .d(new_n39_), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(new_n47_), .c(new_n48_), .d(new_n87_), .O(z7));
  nand2  g65(.a(new_n80_), .b(x02), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n32_), .c(new_n81_), .d(x17), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x18), .O(new_n96_));
  nor2   g68(.a(new_n80_), .b(new_n70_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n72_), .c(new_n34_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n96_), .c(new_n29_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n39_), .c(new_n47_), .O(new_n100_));
