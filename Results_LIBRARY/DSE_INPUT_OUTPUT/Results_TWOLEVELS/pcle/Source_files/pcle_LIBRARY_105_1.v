...
module FAU ( 
  ...
  nand3  g03(.a(new_n31_), .b(x09), .c(new_n29_), .O(new_n32_));
  nand3  g04(.a(x15), .b(x14), .c(x13), .O(new_n33_));
  inv1   g05(.a(new_n33_), .O(new_n34_));
  nand4  g06(.a(new_n34_), .b(x18), .c(x17), .d(x16), .O(new_n35_));
  oai22  g07(.a(new_n35_), .b(new_n32_), .c(new_n29_), .d(x07), .O(z0));
  ...
  nand3  g23(.a(x08), .b(x07), .c(x02), .O(new_n52_));
  ...
  nand3  g31(.a(x08), .b(x07), .c(x03), .O(new_n60_));
  ...
  oai21  g42(.a(new_n33_), .b(new_n30_), .c(x16), .O(new_n71_));
  ...
  oai21  g57(.a(x13), .b(x08), .c(x12), .O(new_n86_));
  nand4  g58(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  nor3   g59(.a(new_n87_), .b(new_n86_), .c(new_n40_), .O(new_n88_));
  nor2   g60(.a(new_n72_), .b(new_n63_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n65_), .c(new_n85_), .d(x17), .O(new_n90_));
  oai21  g62(.a(new_n88_), .b(new_n85_), .c(new_n90_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n39_), .c(x09), .O(new_n92_));
