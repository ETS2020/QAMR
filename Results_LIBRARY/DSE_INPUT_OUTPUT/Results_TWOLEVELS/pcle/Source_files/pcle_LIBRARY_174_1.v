...
module FAU ( 
  ...
  nand3  g07(.a(new_n29_), .b(new_n35_), .c(new_n34_), .O(new_n36_));
  oai21  g08(.a(new_n36_), .b(new_n33_), .c(new_n31_), .O(z1));
  xor2a  g09(.a(x12), .b(x11), .O(new_n38_));
  nand3  g10(.a(new_n38_), .b(new_n34_), .c(x09), .O(new_n39_));
  ...
  aoi21  g19(.a(new_n47_), .b(new_n45_), .c(x18), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n34_), .c(x09), .d(new_n32_), .O(new_n49_));
  ...
  inv1   g26(.a(new_n44_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n54_), .c(x13), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n53_), .c(x18), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n34_), .c(x09), .d(new_n32_), .O(new_n58_));
  nand2  g30(.a(x08), .b(x03), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z4));
  aoi21  g32(.a(x13), .b(x12), .c(x18), .O(new_n61_));
  nand2  g33(.a(x14), .b(x11), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n61_), .c(x15), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand4  g36(.a(new_n55_), .b(new_n64_), .c(x14), .d(x13), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(x10), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(x09), .c(x18), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(x08), .c(new_n68_), .O(z5));
  nand3  g41(.a(x15), .b(x14), .c(x11), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n61_), .c(x16), .O(new_n71_));
  inv1   g43(.a(new_n52_), .O(new_n72_));
  nor2   g44(.a(x16), .b(new_n64_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(x14), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n71_), .c(x10), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(x09), .c(x18), .O(new_n76_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n72_), .c(new_n81_), .d(x16), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n80_), .c(x10), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(x09), .c(x18), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  oai21  g58(.a(new_n85_), .b(x08), .c(new_n86_), .O(z7));
  nand3  g59(.a(new_n55_), .b(new_n34_), .c(x09), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  nand3  g61(.a(x17), .b(x16), .c(x15), .O(new_n90_));
  nor3   g62(.a(new_n90_), .b(new_n54_), .c(new_n46_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n89_), .c(x18), .O(new_n92_));
