...
module FAU ( 
  ...
  aoi21  g08(.a(new_n36_), .b(x05), .c(new_n29_), .O(z0));
  inv1   g09(.a(x05), .O(new_n38_));
  ...
  oai21  g14(.a(new_n41_), .b(new_n29_), .c(new_n42_), .O(z1));
  inv1   g15(.a(x10), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(new_n44_), .c(new_n39_), .O(new_n46_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n39_), .c(new_n38_), .O(new_n56_));
  nand2  g28(.a(x08), .b(x02), .O(new_n57_));
  oai21  g29(.a(new_n56_), .b(new_n29_), .c(new_n57_), .O(z3));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n39_), .c(new_n38_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  oai21  g35(.a(new_n62_), .b(new_n29_), .c(new_n63_), .O(z4));
  aoi21  g36(.a(x09), .b(new_n38_), .c(new_n39_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x04), .O(new_n66_));
  nand4  g38(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n67_));
  inv1   g39(.a(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n33_), .b(x14), .c(x13), .O(new_n69_));
  oai22  g41(.a(new_n69_), .b(new_n51_), .c(new_n68_), .d(new_n33_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n44_), .c(x09), .d(new_n39_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n38_), .c(new_n66_), .O(z5));
  inv1   g44(.a(x16), .O(new_n73_));
  nand3  g45(.a(x14), .b(x13), .c(x12), .O(new_n74_));
  nand2  g46(.a(x15), .b(x11), .O(new_n75_));
  aoi21  g47(.a(new_n74_), .b(x05), .c(new_n75_), .O(new_n76_));
  nand3  g48(.a(new_n73_), .b(x15), .c(x14), .O(new_n77_));
  oai22  g49(.a(new_n77_), .b(new_n30_), .c(new_n76_), .d(new_n73_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n44_), .c(new_n38_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(new_n29_), .c(new_n80_), .O(z6));
  nand2  g53(.a(new_n65_), .b(x06), .O(new_n82_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n44_), .c(x09), .d(new_n39_), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n38_), .c(new_n82_), .O(z7));
  nand2  g61(.a(new_n65_), .b(x07), .O(new_n90_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n68_), .c(x16), .d(x15), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n92_), .c(x10), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x09), .c(new_n39_), .d(x05), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n90_), .O(z8));
endmodule
