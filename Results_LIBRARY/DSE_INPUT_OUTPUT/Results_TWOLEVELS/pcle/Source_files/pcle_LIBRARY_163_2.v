...
module FAU ( 
  ...
  nand2  g43(.a(x16), .b(x09), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(x08), .c(new_n29_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n65_), .O(new_n74_));
  inv1   g46(.a(x16), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x15), .c(x14), .O(new_n76_));
  oai22  g48(.a(new_n76_), .b(new_n56_), .c(new_n67_), .d(new_n75_), .O(new_n77_));
  ...
  oai21  g65(.a(new_n93_), .b(new_n56_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n75_), .b(new_n65_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n86_), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n67_), .O(new_n97_));
