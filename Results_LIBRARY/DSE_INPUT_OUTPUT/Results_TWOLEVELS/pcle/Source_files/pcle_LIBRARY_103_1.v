...
module FAU ( 
  ...
  nand2  g53(.a(new_n39_), .b(x08), .O(new_n82_));
  ...
  oai21  g60(.a(new_n82_), .b(new_n81_), .c(new_n88_), .O(z7));
  inv1   g61(.a(x07), .O(new_n90_));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n57_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n75_), .b(new_n65_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n67_), .c(new_n29_), .d(x17), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n96_));
  oai21  g68(.a(new_n82_), .b(new_n90_), .c(new_n96_), .O(z8));
endmodule
