...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n55_), .c(new_n30_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(x10), .c(new_n40_), .O(new_n58_));
  nand2  g30(.a(x08), .b(x03), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z4));
  oai21  g32(.a(x12), .b(x10), .c(x11), .O(new_n61_));
  nand2  g33(.a(x14), .b(x13), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n61_), .c(x15), .O(new_n63_));
  nand4  g35(.a(new_n48_), .b(new_n34_), .c(x14), .d(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n63_), .c(new_n30_), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(x10), .c(new_n40_), .O(new_n66_));
  ...
  oai21  g59(.a(new_n87_), .b(new_n72_), .c(x18), .O(new_n88_));
  inv1   g60(.a(new_n62_), .O(new_n89_));
  nor2   g61(.a(new_n73_), .b(new_n34_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n81_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n48_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n94_));
