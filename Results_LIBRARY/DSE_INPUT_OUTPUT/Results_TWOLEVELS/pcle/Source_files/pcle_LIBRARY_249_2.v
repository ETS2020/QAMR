...
module FAU ( 
  ...
  oai21  g28(.a(new_n56_), .b(new_n47_), .c(new_n55_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n58_));
  nand2  g30(.a(x10), .b(x08), .O(new_n59_));
  ...
  oai21  g37(.a(new_n65_), .b(new_n47_), .c(new_n64_), .O(new_n66_));
  ...
  aoi21  g60(.a(new_n78_), .b(new_n29_), .c(new_n88_), .O(new_n89_));
  nand4  g61(.a(new_n87_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n63_), .c(new_n89_), .d(new_n87_), .O(new_n91_));
