...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x05), .c(new_n29_), .O(z0));
  ...
  nand4  g16(.a(new_n44_), .b(x09), .c(new_n41_), .d(x05), .O(new_n45_));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n41_), .c(new_n40_), .O(new_n57_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n41_), .c(new_n40_), .O(new_n64_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n41_), .c(new_n40_), .O(new_n71_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n48_), .c(new_n40_), .O(new_n79_));
  oai22  g51(.a(new_n79_), .b(new_n29_), .c(new_n41_), .d(new_n40_), .O(z6));
  ...
  oai21  g58(.a(new_n86_), .b(new_n40_), .c(new_n81_), .O(z7));
  ...
  aoi21  g65(.a(new_n93_), .b(new_n90_), .c(x10), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x09), .c(new_n41_), .d(x05), .O(new_n95_));
