...
module FAU ( 
  ...
  oai21  g10(.a(x16), .b(new_n31_), .c(x08), .O(new_n39_));
  ...
  oai22  g38(.a(new_n66_), .b(new_n49_), .c(new_n65_), .d(new_n63_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  aoi22  g41(.a(new_n69_), .b(x10), .c(x08), .d(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n68_), .O(z5));
  nand3  g43(.a(x11), .b(x09), .c(new_n30_), .O(new_n72_));
  nor2   g44(.a(new_n63_), .b(new_n58_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x13), .c(x12), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n72_), .c(new_n31_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n69_), .O(new_n76_));
  nand2  g48(.a(new_n73_), .b(x13), .O(new_n77_));
  inv1   g49(.a(new_n77_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n50_), .c(new_n69_), .O(new_n79_));
  ...
  oai21  g56(.a(new_n84_), .b(new_n56_), .c(x17), .O(new_n85_));
  nor2   g57(.a(x17), .b(new_n69_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n73_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n56_), .c(new_n85_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n89_));
  oai21  g61(.a(new_n39_), .b(new_n83_), .c(new_n89_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n56_), .c(x18), .O(new_n93_));
  nor2   g65(.a(new_n69_), .b(new_n63_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n65_), .c(new_n29_), .d(x17), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n97_));
  oai21  g69(.a(new_n39_), .b(new_n91_), .c(new_n97_), .O(z8));
endmodule
