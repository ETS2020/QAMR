...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(new_n31_), .c(x09), .d(new_n32_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n45_), .O(z3));
  inv1   g24(.a(x03), .O(new_n53_));
  nand3  g25(.a(new_n31_), .b(x09), .c(new_n32_), .O(new_n54_));
  nand4  g26(.a(new_n29_), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  oai22  g27(.a(new_n55_), .b(new_n54_), .c(new_n40_), .d(new_n53_), .O(z4));
  inv1   g28(.a(x04), .O(new_n57_));
  inv1   g29(.a(x09), .O(new_n58_));
  nor2   g30(.a(new_n58_), .b(x08), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(x15), .c(new_n29_), .d(new_n31_), .O(new_n60_));
  oai21  g32(.a(new_n40_), .b(new_n57_), .c(new_n60_), .O(z5));
  nand2  g33(.a(x16), .b(x09), .O(new_n62_));
  ...
  nand4  g44(.a(new_n59_), .b(x18), .c(new_n29_), .d(new_n31_), .O(new_n73_));
