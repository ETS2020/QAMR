...
module FAU ( 
  ...
  and2   g24(.a(x13), .b(x11), .O(new_n53_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(new_n46_), .O(new_n58_));
  ...
  nand3  g35(.a(new_n63_), .b(x14), .c(x11), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(x15), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand3  g38(.a(new_n53_), .b(new_n66_), .c(x14), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(new_n61_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n30_), .c(new_n46_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(x10), .c(new_n70_), .O(z5));
  nand2  g43(.a(new_n47_), .b(x05), .O(new_n72_));
  nand3  g44(.a(new_n53_), .b(x15), .c(x14), .O(new_n73_));
  ...
  nand4  g49(.a(new_n77_), .b(x12), .c(new_n31_), .d(x09), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(x08), .c(new_n72_), .O(z6));
  nand2  g51(.a(new_n66_), .b(x12), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n53_), .c(x16), .d(x14), .O(new_n81_));
  ...
  aoi21  g58(.a(new_n86_), .b(new_n82_), .c(new_n61_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n30_), .c(new_n46_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(x10), .c(new_n89_), .O(z7));
  and2   g62(.a(x17), .b(x16), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n84_), .c(new_n80_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x18), .O(new_n93_));
  nor2   g65(.a(new_n75_), .b(new_n66_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n84_), .c(new_n29_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(new_n61_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n30_), .c(new_n46_), .O(new_n97_));
