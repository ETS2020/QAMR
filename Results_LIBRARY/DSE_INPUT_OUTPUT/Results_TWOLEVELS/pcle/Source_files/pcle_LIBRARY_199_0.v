...
module FAU ( 
  ...
  nand4  g27(.a(new_n55_), .b(x09), .c(new_n31_), .d(x03), .O(new_n56_));
  oai21  g28(.a(new_n41_), .b(new_n50_), .c(new_n56_), .O(z3));
  inv1   g29(.a(x12), .O(new_n58_));
  nand4  g30(.a(x14), .b(new_n58_), .c(new_n32_), .d(x09), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n31_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(x03), .O(new_n61_));
  inv1   g33(.a(x09), .O(new_n62_));
  oai21  g34(.a(new_n53_), .b(new_n42_), .c(x14), .O(new_n63_));
  inv1   g35(.a(new_n51_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n30_), .c(x13), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n46_), .c(new_n32_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n61_), .O(z4));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n70_), .c(new_n62_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n31_), .c(new_n46_), .O(new_n74_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n78_), .c(new_n62_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n31_), .c(new_n46_), .O(new_n84_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n62_), .O(new_n91_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n80_), .c(x18), .O(new_n96_));
  inv1   g68(.a(new_n69_), .O(new_n97_));
  nor2   g69(.a(new_n79_), .b(new_n71_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n97_), .c(new_n29_), .d(x17), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n96_), .c(new_n62_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n31_), .c(new_n46_), .O(new_n101_));
