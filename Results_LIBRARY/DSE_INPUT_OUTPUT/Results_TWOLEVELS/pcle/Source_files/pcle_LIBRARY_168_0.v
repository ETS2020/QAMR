...
module FAU ( 
  ...
  inv1   g15(.a(x15), .O(new_n44_));
  aoi21  g16(.a(new_n44_), .b(new_n31_), .c(new_n30_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(x01), .O(new_n46_));
  xor2a  g18(.a(x12), .b(x11), .O(new_n47_));
  nand4  g19(.a(new_n47_), .b(x15), .c(new_n31_), .d(x09), .O(new_n48_));
  oai21  g20(.a(new_n48_), .b(x08), .c(new_n46_), .O(z2));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n30_), .c(new_n44_), .O(new_n56_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n60_), .c(new_n50_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n30_), .c(new_n44_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(x10), .c(new_n65_), .O(z4));
  oai21  g38(.a(new_n61_), .b(new_n53_), .c(x12), .O(new_n67_));
  inv1   g39(.a(x12), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n67_), .c(x11), .O(new_n70_));
  ...
  nand3  g51(.a(new_n79_), .b(x14), .c(x13), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n51_), .c(new_n78_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(x15), .c(new_n31_), .d(x09), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(x08), .c(new_n76_), .O(z6));
  nand2  g55(.a(new_n45_), .b(x06), .O(new_n84_));
  nand3  g56(.a(x16), .b(x14), .c(x13), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n51_), .c(x17), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(x16), .c(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n59_), .c(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x15), .c(new_n31_), .d(x09), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x08), .c(new_n84_), .O(z7));
  inv1   g63(.a(new_n59_), .O(new_n92_));
  nand2  g64(.a(new_n79_), .b(x15), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(x17), .d(x14), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x18), .O(new_n95_));
  nor2   g67(.a(new_n79_), .b(new_n61_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n92_), .c(new_n29_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n95_), .c(new_n50_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n30_), .c(new_n44_), .O(new_n99_));
  nand2  g71(.a(x08), .b(x07), .O(new_n100_));
  oai21  g72(.a(new_n99_), .b(x10), .c(new_n100_), .O(z8));
endmodule
