...
module FAU ( 
  ...
  oai21  g28(.a(new_n56_), .b(new_n40_), .c(x14), .O(new_n57_));
  ...
  oai21  g52(.a(new_n39_), .b(new_n73_), .c(new_n80_), .O(z6));
  ...
  oai21  g60(.a(new_n39_), .b(new_n82_), .c(new_n88_), .O(z7));
  ...
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n65_), .d(new_n50_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n97_));
  oai21  g69(.a(new_n39_), .b(new_n90_), .c(new_n97_), .O(z8));
endmodule
