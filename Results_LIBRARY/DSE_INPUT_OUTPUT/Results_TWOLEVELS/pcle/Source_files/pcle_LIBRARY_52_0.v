...
module FAU ( 
  ...
  nand3  g38(.a(new_n38_), .b(x14), .c(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n30_), .c(new_n66_), .O(new_n68_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n71_), .O(z6));
  nand3  g49(.a(x17), .b(new_n41_), .c(new_n29_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x09), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n38_), .O(new_n80_));
  nand3  g52(.a(x16), .b(x14), .c(x13), .O(new_n81_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n80_), .O(z7));
  nand3  g60(.a(x18), .b(new_n41_), .c(new_n29_), .O(new_n89_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n65_), .c(new_n93_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n97_));
  nand2  g69(.a(x08), .b(x07), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n91_), .O(z8));
endmodule
