...
module FAU ( 
  ...
  nand2  g32(.a(new_n60_), .b(x06), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(new_n59_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n31_), .c(new_n46_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x03), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(x10), .c(new_n68_), .O(z4));
  and2   g41(.a(x14), .b(x13), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n61_), .c(x11), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x15), .O(new_n72_));
  inv1   g44(.a(x15), .O(new_n73_));
  nand4  g45(.a(new_n64_), .b(new_n73_), .c(x14), .d(x13), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n72_), .c(new_n59_), .O(new_n75_));
  ...
  aoi21  g56(.a(new_n84_), .b(new_n80_), .c(new_n59_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n31_), .c(new_n46_), .O(new_n86_));
  ...
  nand3  g65(.a(new_n93_), .b(new_n32_), .c(x09), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n31_), .c(new_n46_), .O(z7));
  inv1   g67(.a(x07), .O(new_n96_));
  nand4  g68(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n82_), .c(x18), .O(new_n98_));
  nor2   g70(.a(new_n81_), .b(new_n73_), .O(new_n99_));
  nor2   g71(.a(x18), .b(new_n91_), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(new_n99_), .c(new_n70_), .d(new_n64_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n98_), .c(x10), .O(new_n102_));
  nand4  g74(.a(new_n102_), .b(x09), .c(new_n31_), .d(x06), .O(new_n103_));
  oai21  g75(.a(new_n47_), .b(new_n96_), .c(new_n103_), .O(z8));
endmodule
