...
module FAU ( 
  ...
  aoi21  g41(.a(x14), .b(x13), .c(x10), .O(new_n70_));
  nand3  g42(.a(x15), .b(x12), .c(x11), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n70_), .c(x16), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  nand4  g45(.a(new_n58_), .b(new_n73_), .c(x15), .d(x14), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n72_), .c(x08), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(x10), .c(x09), .O(new_n76_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n58_), .c(x15), .d(x14), .O(new_n83_));
  ...
  nor2   g62(.a(new_n73_), .b(new_n34_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n65_), .c(new_n90_), .d(x17), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n94_));
