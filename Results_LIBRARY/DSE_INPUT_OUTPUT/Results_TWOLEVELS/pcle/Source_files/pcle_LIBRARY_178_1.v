...
module FAU ( 
  ...
  aoi21  g22(.a(new_n50_), .b(new_n48_), .c(new_n30_), .O(new_n51_));
  oai21  g23(.a(new_n51_), .b(x10), .c(new_n46_), .O(new_n52_));
  ...
  nand2  g28(.a(new_n33_), .b(x13), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n47_), .c(new_n56_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n59_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n66_));
  ...
  nand3  g49(.a(x16), .b(x12), .c(x11), .O(new_n78_));
  aoi21  g50(.a(new_n69_), .b(new_n29_), .c(new_n78_), .O(new_n79_));
  nand4  g51(.a(new_n77_), .b(x16), .c(x15), .d(x14), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(new_n55_), .c(new_n79_), .d(new_n77_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(x09), .c(x10), .O(new_n82_));
