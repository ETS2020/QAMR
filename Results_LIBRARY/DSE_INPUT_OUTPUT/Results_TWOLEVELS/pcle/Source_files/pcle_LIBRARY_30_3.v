...
module FAU ( 
  ...
  oai22  g31(.a(new_n59_), .b(new_n48_), .c(new_n58_), .d(new_n33_), .O(new_n60_));
  ...
  nand2  g35(.a(new_n50_), .b(new_n30_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n63_), .c(x14), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x15), .O(new_n66_));
  nand4  g38(.a(new_n63_), .b(new_n34_), .c(x14), .d(x13), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(x10), .c(x09), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  and2   g43(.a(x15), .b(x14), .O(new_n72_));
  nand3  g44(.a(new_n64_), .b(new_n63_), .c(new_n72_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x16), .O(new_n74_));
  inv1   g46(.a(x16), .O(new_n75_));
  nand4  g47(.a(new_n58_), .b(new_n75_), .c(x15), .d(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n74_), .c(x08), .O(new_n77_));
  ...
  nand3  g55(.a(new_n72_), .b(new_n83_), .c(x16), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n57_), .c(new_n82_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n39_), .c(x10), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  oai21  g59(.a(new_n86_), .b(new_n29_), .c(new_n87_), .O(z7));
  ...
  nor2   g64(.a(new_n33_), .b(new_n50_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n83_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n63_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n97_));
