...
module FAU ( 
  ...
  oai22  g46(.a(new_n74_), .b(new_n57_), .c(new_n73_), .d(x12), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n31_), .O(new_n76_));
  nor2   g48(.a(new_n64_), .b(new_n59_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x13), .c(x11), .O(new_n78_));
  ...
  aoi21  g53(.a(x08), .b(x05), .c(new_n70_), .O(new_n82_));
  ...
  nor2   g58(.a(x17), .b(new_n73_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n77_), .O(new_n88_));
  ...
  nor2   g66(.a(new_n73_), .b(new_n64_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n98_));
  oai21  g70(.a(new_n40_), .b(new_n92_), .c(new_n98_), .O(z8));
endmodule
