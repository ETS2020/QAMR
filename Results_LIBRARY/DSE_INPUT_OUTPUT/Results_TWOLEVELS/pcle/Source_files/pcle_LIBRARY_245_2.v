...
module FAU ( 
  ...
  oai21  g08(.a(x15), .b(new_n29_), .c(new_n36_), .O(z0));
  ...
  oai22  g49(.a(new_n77_), .b(new_n56_), .c(new_n68_), .d(new_n76_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n79_));
  ...
  nand4  g61(.a(new_n89_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n90_), .c(new_n84_), .O(z7));
  nand2  g64(.a(x18), .b(x09), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(x08), .c(new_n29_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n38_), .O(new_n95_));
  nand3  g67(.a(x17), .b(x16), .c(x14), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n56_), .c(x18), .O(new_n97_));
  inv1   g69(.a(x18), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x17), .c(x16), .d(x15), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n67_), .c(new_n97_), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n101_));
