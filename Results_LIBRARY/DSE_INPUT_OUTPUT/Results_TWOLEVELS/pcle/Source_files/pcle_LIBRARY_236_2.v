...
module FAU ( 
  ...
  oai21  g36(.a(new_n40_), .b(new_n58_), .c(new_n64_), .O(z4));
  ...
  aoi21  g53(.a(x08), .b(x05), .c(new_n73_), .O(new_n82_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n66_), .c(new_n53_), .d(new_n42_), .O(new_n94_));
