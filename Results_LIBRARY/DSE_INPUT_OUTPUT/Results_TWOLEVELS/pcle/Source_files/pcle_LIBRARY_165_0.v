...
module FAU ( 
  ...
  nor2   g10(.a(new_n29_), .b(new_n31_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  inv1   g12(.a(x10), .O(new_n41_));
  inv1   g13(.a(x11), .O(new_n42_));
  nand4  g14(.a(new_n42_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n43_));
  nand2  g15(.a(new_n43_), .b(new_n40_), .O(z1));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n46_));
  ...
  nand4  g24(.a(new_n52_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n53_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n56_), .O(z4));
  nand2  g35(.a(x14), .b(x13), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n32_), .c(x15), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(x14), .c(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n32_), .c(new_n65_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x04), .c(new_n29_), .O(new_n70_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n77_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n84_));
  aoi21  g56(.a(x08), .b(x06), .c(new_n29_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n84_), .O(z7));
  inv1   g58(.a(x18), .O(new_n87_));
  nor2   g59(.a(x10), .b(x08), .O(new_n88_));
  nand3  g60(.a(x17), .b(x16), .c(x15), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n64_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n88_), .c(new_n50_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x09), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n87_), .O(new_n93_));
  nand4  g65(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  inv1   g66(.a(new_n94_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n59_), .c(new_n87_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n97_));
