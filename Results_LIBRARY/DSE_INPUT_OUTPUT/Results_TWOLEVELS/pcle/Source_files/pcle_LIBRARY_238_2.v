...
module FAU ( 
  ...
  oai21  g35(.a(new_n39_), .b(x04), .c(x08), .O(new_n64_));
  aoi21  g36(.a(x13), .b(x12), .c(x08), .O(new_n65_));
  ...
  nand3  g41(.a(new_n69_), .b(new_n39_), .c(x09), .O(new_n70_));
  ...
  nand2  g68(.a(new_n47_), .b(x07), .O(new_n97_));
