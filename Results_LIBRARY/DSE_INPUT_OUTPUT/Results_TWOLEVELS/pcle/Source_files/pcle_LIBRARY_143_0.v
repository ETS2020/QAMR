...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(new_n31_), .c(x11), .d(new_n29_), .O(new_n36_));
  aoi21  g08(.a(new_n36_), .b(x09), .c(x10), .O(z0));
  ...
  aoi21  g15(.a(new_n43_), .b(new_n38_), .c(new_n29_), .O(new_n44_));
  ...
  aoi21  g36(.a(new_n30_), .b(x09), .c(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n33_), .b(x14), .c(x13), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n51_), .c(new_n65_), .d(new_n33_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n29_), .c(new_n38_), .O(new_n68_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n43_), .c(x09), .d(new_n29_), .O(new_n77_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n29_), .c(new_n38_), .O(new_n84_));
  ...
  nor2   g62(.a(new_n32_), .b(new_n50_), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n81_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n52_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n43_), .c(x09), .d(new_n29_), .O(new_n95_));
