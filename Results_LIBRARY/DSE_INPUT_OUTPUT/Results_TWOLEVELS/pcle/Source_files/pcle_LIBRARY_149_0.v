...
module FAU ( 
  ...
  nand3  g33(.a(new_n53_), .b(new_n34_), .c(x13), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n61_), .c(x08), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(new_n58_), .c(new_n44_), .O(new_n64_));
  ...
  oai21  g43(.a(new_n71_), .b(new_n58_), .c(new_n44_), .O(new_n72_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n43_), .c(new_n58_), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n43_), .c(new_n58_), .O(new_n89_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(x08), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n58_), .c(new_n44_), .O(new_n98_));
