...
module FAU ( 
  ...
  nand4  g48(.a(new_n76_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n77_));
  nand2  g49(.a(new_n47_), .b(x05), .O(new_n78_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n85_));
  nand2  g57(.a(new_n47_), .b(x06), .O(new_n86_));
