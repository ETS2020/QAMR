...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(new_n40_), .O(new_n46_));
  inv1   g18(.a(x12), .O(new_n47_));
  nand3  g19(.a(x17), .b(new_n47_), .c(x11), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n46_), .c(new_n29_), .O(new_n49_));
  aoi21  g21(.a(new_n49_), .b(new_n45_), .c(new_n41_), .O(new_n50_));
  ...
  nand3  g26(.a(new_n32_), .b(x17), .c(new_n54_), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n53_), .c(new_n29_), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n45_), .c(new_n41_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n65_), .b(x09), .c(new_n45_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x17), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n60_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x03), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z4));
  inv1   g42(.a(x04), .O(new_n71_));
  oai21  g43(.a(x17), .b(x10), .c(x08), .O(new_n72_));
  oai21  g44(.a(new_n36_), .b(new_n31_), .c(x15), .O(new_n73_));
  nand3  g45(.a(new_n33_), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n31_), .c(new_n73_), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(x17), .c(new_n60_), .d(x09), .O(new_n76_));
  oai22  g48(.a(new_n76_), .b(x08), .c(new_n72_), .d(new_n71_), .O(z5));
  nand3  g49(.a(x15), .b(x14), .c(x13), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n31_), .c(x16), .O(new_n79_));
  and2   g51(.a(x15), .b(x14), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n63_), .c(x17), .d(new_n34_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n79_), .c(new_n29_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n45_), .c(new_n41_), .O(new_n83_));
  ...
  nand4  g61(.a(new_n89_), .b(x17), .c(new_n60_), .d(x09), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(x08), .c(new_n72_), .d(new_n86_), .O(z7));
  nand3  g63(.a(x16), .b(x15), .c(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n62_), .c(x18), .O(new_n93_));
  nand4  g65(.a(new_n80_), .b(new_n63_), .c(new_n35_), .d(x16), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n93_), .c(new_n29_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n45_), .c(new_n41_), .O(new_n96_));
