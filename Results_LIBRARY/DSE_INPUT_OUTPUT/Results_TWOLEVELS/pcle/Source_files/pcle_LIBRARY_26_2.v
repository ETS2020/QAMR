...
module FAU ( 
  ...
  oai21  g32(.a(x12), .b(x02), .c(x13), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n41_), .c(x14), .O(new_n62_));
  ...
  aoi21  g40(.a(new_n39_), .b(x02), .c(new_n40_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x04), .O(new_n70_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(x02), .c(new_n70_), .O(z5));
  nand2  g49(.a(new_n69_), .b(x05), .O(new_n78_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n32_), .c(new_n80_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(x02), .c(new_n78_), .O(z6));
  aoi21  g57(.a(x15), .b(x14), .c(x02), .O(new_n86_));
  nand4  g58(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n86_), .c(x17), .O(new_n88_));
  inv1   g60(.a(x17), .O(new_n89_));
  nand4  g61(.a(new_n34_), .b(new_n33_), .c(new_n89_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n30_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n40_), .c(x02), .O(new_n92_));
  nand2  g64(.a(x08), .b(x06), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x10), .c(new_n93_), .O(z7));
  nand2  g66(.a(new_n69_), .b(x07), .O(new_n95_));
  ...
  nand4  g70(.a(new_n98_), .b(new_n73_), .c(x16), .d(x15), .O(new_n99_));
