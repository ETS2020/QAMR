...
module FAU ( 
  ...
  oai21  g60(.a(new_n75_), .b(new_n56_), .c(new_n30_), .O(new_n89_));
  nor2   g61(.a(new_n83_), .b(new_n64_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n89_), .c(new_n50_), .d(x13), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x18), .O(new_n92_));
  nor2   g64(.a(new_n75_), .b(new_n64_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n94_));
