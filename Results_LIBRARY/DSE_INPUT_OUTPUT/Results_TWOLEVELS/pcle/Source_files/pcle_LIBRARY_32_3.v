...
module FAU ( 
  ...
  inv1   g14(.a(new_n29_), .O(new_n43_));
  nor2   g15(.a(new_n43_), .b(new_n30_), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(x01), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n47_));
  ...
  nand4  g25(.a(new_n53_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n54_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n61_));
  aoi21  g33(.a(x08), .b(x03), .c(new_n43_), .O(new_n62_));
  ...
  aoi21  g41(.a(x08), .b(x04), .c(new_n43_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand2  g43(.a(new_n44_), .b(x05), .O(new_n72_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n72_), .O(z6));
  nand2  g50(.a(new_n44_), .b(x06), .O(new_n79_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n94_));
