...
module FAU ( 
  ...
  oai21  g14(.a(x08), .b(new_n42_), .c(x00), .O(new_n43_));
  inv1   g15(.a(x10), .O(new_n44_));
  inv1   g16(.a(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n43_), .O(z1));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n49_));
  nand2  g21(.a(x08), .b(x01), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(new_n49_), .c(new_n31_), .O(z2));
  ...
  nand4  g27(.a(new_n55_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n56_));
  ...
  nand4  g35(.a(new_n63_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n30_), .O(z4));
  ...
  oai22  g42(.a(new_n70_), .b(new_n33_), .c(new_n69_), .d(new_n67_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x04), .c(new_n30_), .O(new_n73_));
  ...
  oai21  g48(.a(new_n76_), .b(new_n59_), .c(new_n75_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x05), .c(new_n30_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  nand3  g52(.a(x16), .b(x15), .c(x14), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n59_), .c(x17), .O(new_n82_));
  nand4  g54(.a(new_n36_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n59_), .c(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n85_), .c(new_n30_), .O(z7));
  nand4  g59(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n59_), .c(x18), .O(new_n89_));
  nor2   g61(.a(new_n35_), .b(new_n67_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n69_), .c(new_n37_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n44_), .c(x09), .d(new_n32_), .O(new_n93_));
