...
module FAU ( 
  ...
  nand2  g19(.a(new_n45_), .b(x08), .O(new_n48_));
  ...
  inv1   g33(.a(new_n45_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x03), .c(new_n62_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n61_), .O(z4));
  ...
  aoi21  g42(.a(x08), .b(x04), .c(new_n62_), .O(new_n71_));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n62_), .O(new_n79_));
  ...
  oai21  g67(.a(new_n48_), .b(new_n89_), .c(new_n95_), .O(z8));
endmodule
