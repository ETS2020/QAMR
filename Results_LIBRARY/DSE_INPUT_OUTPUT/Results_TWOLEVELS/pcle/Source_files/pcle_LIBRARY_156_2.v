...
module FAU ( 
  ...
  nor3   g51(.a(new_n75_), .b(new_n49_), .c(new_n51_), .O(new_n80_));
  ...
  oai22  g61(.a(new_n89_), .b(new_n58_), .c(new_n80_), .d(new_n88_), .O(new_n90_));
  ...
  nor2   g68(.a(x18), .b(new_n88_), .O(new_n97_));
