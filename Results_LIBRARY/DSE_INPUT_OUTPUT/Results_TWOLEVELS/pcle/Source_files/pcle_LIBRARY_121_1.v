...
module FAU ( 
  ...
  aoi21  g11(.a(x12), .b(new_n39_), .c(new_n30_), .O(new_n40_));
  ...
  nand3  g17(.a(new_n42_), .b(x11), .c(new_n31_), .O(new_n46_));
  oai21  g18(.a(new_n46_), .b(new_n38_), .c(new_n45_), .O(z2));
  xor2a  g19(.a(x13), .b(x12), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n49_));
  aoi22  g21(.a(x12), .b(new_n39_), .c(x08), .d(x02), .O(new_n50_));
  nand2  g22(.a(new_n50_), .b(new_n49_), .O(z3));
  inv1   g23(.a(x14), .O(new_n52_));
  nand3  g24(.a(new_n52_), .b(x13), .c(new_n31_), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(new_n38_), .c(x11), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x12), .O(new_n55_));
  inv1   g27(.a(x13), .O(new_n56_));
  nor2   g28(.a(new_n56_), .b(new_n42_), .O(new_n57_));
  nor2   g29(.a(new_n57_), .b(new_n52_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x03), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n59_), .c(new_n55_), .O(z4));
  nand2  g33(.a(new_n40_), .b(x04), .O(new_n62_));
  inv1   g34(.a(x15), .O(new_n63_));
  nor2   g35(.a(new_n52_), .b(new_n56_), .O(new_n64_));
  nand4  g36(.a(new_n63_), .b(x14), .c(x13), .d(x12), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x11), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n42_), .O(new_n68_));
  ...
  nor2   g44(.a(x16), .b(new_n63_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n64_), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n72_), .c(x11), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(x12), .O(new_n76_));
  nor2   g48(.a(new_n63_), .b(new_n52_), .O(new_n77_));
  ...
  nand4  g55(.a(x13), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nand3  g57(.a(new_n77_), .b(new_n85_), .c(x16), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n84_), .c(x11), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x12), .O(new_n88_));
  nand3  g60(.a(x16), .b(x15), .c(x14), .O(new_n89_));
  inv1   g61(.a(new_n89_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n57_), .c(new_n85_), .O(new_n91_));
  ...
  nand4  g66(.a(new_n77_), .b(new_n29_), .c(x17), .d(x16), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n84_), .c(x11), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x12), .O(new_n97_));
  nand2  g69(.a(new_n64_), .b(x12), .O(new_n98_));
  inv1   g70(.a(new_n98_), .O(new_n99_));
  nand3  g71(.a(x17), .b(x16), .c(x15), .O(new_n100_));
  inv1   g72(.a(new_n100_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n99_), .c(new_n29_), .O(new_n102_));
