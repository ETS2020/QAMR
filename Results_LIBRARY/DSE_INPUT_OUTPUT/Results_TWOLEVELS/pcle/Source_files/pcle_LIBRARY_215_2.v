...
module FAU ( 
  ...
  aoi21  g11(.a(x18), .b(x08), .c(x11), .O(new_n40_));
  nand3  g12(.a(new_n40_), .b(new_n39_), .c(x09), .O(new_n41_));
  ...
  nor2   g39(.a(new_n37_), .b(new_n29_), .O(new_n68_));
  ...
  nand2  g55(.a(new_n68_), .b(x06), .O(new_n84_));
