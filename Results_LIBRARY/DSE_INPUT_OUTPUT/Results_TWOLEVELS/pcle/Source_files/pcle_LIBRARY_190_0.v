...
module FAU ( 
  ...
  oai21  g09(.a(x11), .b(x08), .c(x09), .O(new_n38_));
  nand2  g10(.a(new_n38_), .b(new_n31_), .O(new_n39_));
  nand2  g11(.a(x08), .b(x00), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n39_), .O(z1));
  inv1   g13(.a(x01), .O(new_n42_));
  oai21  g14(.a(x10), .b(x09), .c(x08), .O(new_n43_));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n45_));
  oai21  g17(.a(new_n43_), .b(new_n42_), .c(new_n45_), .O(z2));
  ...
  oai21  g24(.a(new_n52_), .b(new_n47_), .c(new_n31_), .O(new_n53_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n58_), .c(x13), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n57_), .c(x08), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n47_), .c(new_n31_), .O(new_n62_));
  ...
  aoi21  g41(.a(new_n69_), .b(new_n30_), .c(new_n47_), .O(new_n70_));
  ...
  oai21  g51(.a(new_n43_), .b(new_n73_), .c(new_n79_), .O(z6));
  ...
  oai21  g57(.a(new_n85_), .b(new_n56_), .c(new_n83_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n87_));
  oai21  g59(.a(new_n43_), .b(new_n81_), .c(new_n87_), .O(z7));
  nand2  g60(.a(x16), .b(x15), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(x09), .O(new_n90_));
  nand3  g62(.a(x17), .b(x14), .c(x13), .O(new_n91_));
  inv1   g63(.a(new_n91_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n90_), .c(new_n59_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x18), .O(new_n94_));
  inv1   g66(.a(new_n89_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n67_), .c(new_n29_), .d(x17), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n94_), .c(x08), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n47_), .c(new_n31_), .O(new_n98_));
