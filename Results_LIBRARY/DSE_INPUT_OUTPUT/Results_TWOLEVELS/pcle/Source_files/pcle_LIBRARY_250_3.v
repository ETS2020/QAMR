...
module FAU ( 
  ...
  nand2  g30(.a(x11), .b(new_n31_), .O(new_n59_));
  ...
  oai21  g44(.a(new_n40_), .b(new_n66_), .c(new_n72_), .O(z5));
  inv1   g45(.a(x16), .O(new_n74_));
  nand2  g46(.a(new_n48_), .b(x14), .O(new_n75_));
  nand3  g47(.a(x15), .b(x14), .c(x13), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n31_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  nor4   g50(.a(new_n57_), .b(x16), .c(new_n67_), .d(new_n60_), .O(new_n79_));
  ...
  nor2   g65(.a(new_n74_), .b(new_n67_), .O(new_n94_));
