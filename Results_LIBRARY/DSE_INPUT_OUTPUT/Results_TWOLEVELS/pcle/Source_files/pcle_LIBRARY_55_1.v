...
module FAU ( 
  ...
  nand2  g30(.a(new_n32_), .b(x13), .O(new_n59_));
  oai22  g31(.a(new_n59_), .b(new_n50_), .c(new_n58_), .d(new_n32_), .O(new_n60_));
  ...
  aoi21  g36(.a(x13), .b(x12), .c(x10), .O(new_n65_));
  nand2  g37(.a(x14), .b(x11), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n65_), .c(x15), .O(new_n67_));
  nand4  g39(.a(new_n51_), .b(new_n33_), .c(x14), .d(x13), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n67_), .c(new_n64_), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(x10), .c(new_n41_), .O(new_n70_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n58_), .c(x16), .d(x14), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  nand4  g55(.a(new_n58_), .b(new_n34_), .c(new_n35_), .d(x16), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n83_), .c(new_n64_), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(x10), .c(new_n41_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  nand3  g60(.a(new_n34_), .b(x17), .c(x16), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n57_), .c(x18), .O(new_n90_));
  nand4  g62(.a(new_n36_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  inv1   g63(.a(new_n91_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n51_), .c(x14), .d(x13), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n95_));
