...
module FAU ( 
  ...
  nand4  g18(.a(new_n46_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n47_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n70_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n94_));
