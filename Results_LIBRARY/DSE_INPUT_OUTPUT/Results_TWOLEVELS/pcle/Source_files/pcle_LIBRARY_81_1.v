...
module FAU ( 
  ...
  oai21  g24(.a(new_n52_), .b(x10), .c(new_n39_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n60_), .b(x10), .c(new_n39_), .O(new_n61_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n84_));
  ...
  oai21  g65(.a(new_n93_), .b(x10), .c(new_n39_), .O(new_n94_));
