...
module FAU ( 
  ...
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n53_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n29_), .c(new_n52_), .O(new_n66_));
  ...
  nand4  g41(.a(new_n31_), .b(new_n32_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(new_n71_));
  ...
  oai21  g47(.a(new_n75_), .b(new_n30_), .c(x16), .O(new_n76_));
  inv1   g48(.a(new_n61_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n33_), .c(x15), .d(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n76_), .c(new_n53_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n29_), .c(new_n52_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x10), .c(new_n81_), .O(z6));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n61_), .c(x18), .O(new_n84_));
  nand4  g56(.a(new_n34_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(new_n61_), .c(new_n84_), .d(new_n34_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(x09), .c(new_n29_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x18), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n39_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  nand2  g63(.a(new_n52_), .b(new_n39_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(x08), .c(x07), .O(new_n93_));
  inv1   g65(.a(new_n83_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n77_), .c(x17), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x18), .c(new_n39_), .d(x09), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(x08), .c(new_n93_), .O(z8));
endmodule
