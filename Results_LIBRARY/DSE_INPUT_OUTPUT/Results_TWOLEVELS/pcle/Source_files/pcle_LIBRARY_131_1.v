...
module FAU ( 
  ...
  nand3  g10(.a(new_n38_), .b(new_n31_), .c(x09), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(new_n30_), .O(z1));
  inv1   g12(.a(x00), .O(new_n41_));
  oai21  g13(.a(x01), .b(new_n41_), .c(x08), .O(new_n42_));
  ...
  nand3  g23(.a(x08), .b(x02), .c(x00), .O(new_n52_));
  ...
  nand3  g31(.a(x08), .b(x03), .c(x00), .O(new_n60_));
  ...
  nand3  g39(.a(x08), .b(x04), .c(x00), .O(new_n68_));
  ...
  nand3  g47(.a(x08), .b(x05), .c(x00), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  oai21  g49(.a(x06), .b(new_n41_), .c(x08), .O(new_n78_));
  ...
  oai21  g57(.a(x07), .b(new_n41_), .c(x08), .O(new_n86_));
