...
module FAU ( 
  ...
  aoi21  g29(.a(new_n57_), .b(new_n45_), .c(x03), .O(new_n58_));
  nand2  g30(.a(x08), .b(x02), .O(new_n59_));
  oai21  g31(.a(new_n58_), .b(x10), .c(new_n59_), .O(z3));
  oai21  g32(.a(new_n31_), .b(x08), .c(x03), .O(new_n61_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n31_), .c(x09), .d(new_n45_), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n45_), .c(x03), .O(new_n73_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n62_), .c(new_n78_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n31_), .c(x09), .d(new_n45_), .O(new_n82_));
  oai22  g54(.a(new_n82_), .b(x03), .c(new_n41_), .d(new_n76_), .O(z6));
  inv1   g55(.a(x15), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n40_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n63_), .c(x16), .d(x14), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x17), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nor2   g60(.a(new_n84_), .b(new_n30_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n63_), .c(new_n88_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n52_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n45_), .c(x03), .O(new_n92_));
  nand2  g64(.a(x08), .b(x06), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x10), .c(new_n93_), .O(z7));
  and2   g66(.a(x17), .b(x16), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n85_), .c(new_n63_), .d(x14), .O(new_n96_));
  ...
  aoi21  g73(.a(new_n101_), .b(new_n45_), .c(x03), .O(new_n102_));
