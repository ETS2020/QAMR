...
module FAU ( 
  ...
  nand3  g12(.a(new_n40_), .b(new_n38_), .c(x09), .O(new_n41_));
  nand2  g13(.a(new_n41_), .b(new_n39_), .O(z1));
  xor2a  g14(.a(x12), .b(x11), .O(new_n43_));
  nand4  g15(.a(new_n43_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n44_));
  ...
  oai21  g20(.a(new_n38_), .b(x02), .c(x08), .O(new_n49_));
  ...
  nand3  g26(.a(new_n54_), .b(new_n38_), .c(x09), .O(new_n55_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n62_));
  nand2  g34(.a(new_n46_), .b(x03), .O(new_n63_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n70_));
  nand2  g42(.a(new_n46_), .b(x04), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z5));
  oai21  g44(.a(new_n38_), .b(x05), .c(x08), .O(new_n73_));
  nand2  g45(.a(new_n57_), .b(new_n29_), .O(new_n74_));
  ...
  nand3  g51(.a(new_n79_), .b(new_n38_), .c(x09), .O(new_n80_));
  ...
  nand3  g55(.a(new_n32_), .b(new_n33_), .c(x16), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n58_), .c(new_n83_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n86_));
  nand2  g58(.a(new_n46_), .b(x06), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  oai21  g60(.a(new_n38_), .b(x07), .c(x08), .O(new_n89_));
  nand2  g61(.a(new_n77_), .b(new_n29_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n59_), .c(new_n32_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x18), .O(new_n92_));
  nor2   g64(.a(new_n77_), .b(new_n65_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n67_), .c(new_n34_), .d(x17), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n38_), .c(x09), .O(new_n96_));
