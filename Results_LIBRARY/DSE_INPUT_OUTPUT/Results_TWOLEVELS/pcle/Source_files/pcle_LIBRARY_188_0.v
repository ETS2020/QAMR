...
module FAU ( 
  ...
  oai21  g30(.a(new_n58_), .b(new_n38_), .c(new_n46_), .O(new_n59_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n37_), .c(new_n38_), .O(new_n66_));
  nand2  g38(.a(x08), .b(x04), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(x10), .c(new_n67_), .O(z5));
  nand2  g40(.a(new_n46_), .b(new_n38_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(x08), .c(x05), .O(new_n70_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n46_), .c(x09), .d(new_n37_), .O(new_n76_));
  ...
  oai21  g63(.a(new_n91_), .b(new_n38_), .c(new_n46_), .O(new_n92_));
