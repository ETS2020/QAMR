...
module FAU ( 
  ...
  nand3  g19(.a(new_n47_), .b(new_n46_), .c(new_n44_), .O(z2));
  ...
  nand3  g26(.a(new_n54_), .b(new_n38_), .c(new_n52_), .O(new_n55_));
  ...
  oai21  g33(.a(new_n54_), .b(new_n60_), .c(new_n61_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(x13), .O(new_n63_));
  nand3  g35(.a(new_n38_), .b(x14), .c(new_n52_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n59_), .O(z4));
  nand2  g39(.a(new_n50_), .b(x04), .O(new_n68_));
  nand3  g40(.a(x14), .b(x12), .c(x11), .O(new_n69_));
  nor2   g41(.a(x15), .b(new_n60_), .O(new_n70_));
  aoi22  g42(.a(new_n70_), .b(new_n54_), .c(new_n69_), .d(x15), .O(new_n71_));
  nand3  g43(.a(new_n38_), .b(x15), .c(new_n52_), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(new_n52_), .c(new_n72_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n68_), .O(z5));
  nand2  g47(.a(x09), .b(new_n30_), .O(new_n76_));
  nand3  g48(.a(new_n38_), .b(x16), .c(new_n31_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n76_), .c(new_n38_), .O(new_n78_));
  ...
  nand2  g60(.a(new_n50_), .b(x06), .O(new_n89_));
  nand3  g61(.a(x16), .b(x15), .c(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n53_), .c(x17), .O(new_n91_));
  nand3  g63(.a(new_n38_), .b(x16), .c(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n69_), .c(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x13), .c(new_n31_), .d(x09), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(x08), .c(new_n89_), .O(z7));
  nand2  g67(.a(new_n50_), .b(x07), .O(new_n96_));
  oai21  g68(.a(new_n90_), .b(new_n53_), .c(x18), .O(new_n97_));
  nand4  g69(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(new_n69_), .c(new_n97_), .O(new_n99_));
  nand2  g71(.a(new_n99_), .b(x13), .O(new_n100_));
