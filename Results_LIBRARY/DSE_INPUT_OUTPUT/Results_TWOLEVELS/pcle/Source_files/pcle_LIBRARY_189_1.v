...
module FAU ( 
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n69_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n78_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n74_), .c(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n85_));
  ...
  nor2   g61(.a(new_n75_), .b(new_n33_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n66_), .c(new_n36_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n93_));
