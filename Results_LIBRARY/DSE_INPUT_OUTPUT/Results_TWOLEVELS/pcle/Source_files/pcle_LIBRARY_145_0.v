...
module FAU ( 
  ...
  aoi21  g15(.a(new_n43_), .b(new_n30_), .c(new_n38_), .O(new_n44_));
  ...
  aoi21  g46(.a(new_n73_), .b(x09), .c(new_n74_), .O(new_n75_));
  nand3  g47(.a(new_n72_), .b(x15), .c(x14), .O(new_n76_));
  oai22  g48(.a(new_n76_), .b(new_n57_), .c(new_n75_), .d(new_n72_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n30_), .c(new_n38_), .O(new_n78_));
  ...
  nor2   g63(.a(new_n72_), .b(new_n65_), .O(new_n92_));
