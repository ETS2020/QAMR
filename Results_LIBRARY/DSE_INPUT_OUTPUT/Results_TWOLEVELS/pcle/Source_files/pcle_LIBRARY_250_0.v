...
module FAU ( 
  ...
  nand2  g31(.a(x14), .b(new_n41_), .O(new_n60_));
  nand2  g32(.a(x13), .b(x12), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(x11), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n30_), .c(new_n50_), .O(new_n64_));
  ...
  nand3  g43(.a(new_n71_), .b(new_n70_), .c(x13), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n69_), .c(new_n50_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n74_));
  oai21  g46(.a(new_n40_), .b(new_n67_), .c(new_n74_), .O(z5));
  nand2  g47(.a(x15), .b(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n52_), .c(x16), .O(new_n77_));
  inv1   g49(.a(x16), .O(new_n78_));
  nand4  g50(.a(new_n71_), .b(new_n78_), .c(x15), .d(x13), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n77_), .c(new_n51_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n30_), .c(new_n50_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x05), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(x10), .c(new_n82_), .O(z6));
  inv1   g55(.a(x06), .O(new_n84_));
  nand3  g56(.a(x16), .b(x15), .c(x13), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n52_), .c(x17), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(x16), .c(x15), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n68_), .c(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x14), .c(new_n31_), .d(x09), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(x08), .c(new_n40_), .d(new_n84_), .O(z7));
  inv1   g63(.a(x07), .O(new_n92_));
  nand3  g64(.a(x17), .b(x16), .c(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n68_), .c(x18), .O(new_n94_));
  nand4  g66(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n68_), .c(new_n94_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x14), .c(new_n31_), .d(x09), .O(new_n97_));
  oai22  g69(.a(new_n97_), .b(x08), .c(new_n40_), .d(new_n92_), .O(z8));
endmodule
