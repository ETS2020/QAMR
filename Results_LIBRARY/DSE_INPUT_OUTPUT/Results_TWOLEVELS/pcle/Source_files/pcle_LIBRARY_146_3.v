...
module FAU ( 
  ...
  nand4  g38(.a(new_n50_), .b(new_n66_), .c(x14), .d(x13), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(x08), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(x10), .c(x09), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand3  g43(.a(x15), .b(x14), .c(x11), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n63_), .c(x16), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand4  g46(.a(new_n58_), .b(new_n74_), .c(x15), .d(x14), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n73_), .c(x08), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(x10), .c(x09), .O(new_n77_));
  ...
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(x16), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n57_), .c(new_n82_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n87_));
  oai21  g59(.a(new_n44_), .b(new_n80_), .c(new_n87_), .O(z7));
  nand2  g60(.a(new_n74_), .b(new_n31_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n84_), .c(new_n58_), .d(x17), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nor2   g63(.a(new_n74_), .b(new_n66_), .O(new_n92_));
  nor2   g64(.a(new_n56_), .b(new_n49_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n83_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n50_), .O(new_n95_));
