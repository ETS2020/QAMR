...
module FAU ( 
  ...
  aoi21  g15(.a(new_n43_), .b(new_n29_), .c(new_n42_), .O(new_n44_));
  ...
  oai21  g23(.a(new_n51_), .b(new_n42_), .c(new_n37_), .O(new_n52_));
  ...
  nand3  g29(.a(new_n57_), .b(new_n31_), .c(x13), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n56_), .c(x08), .O(new_n59_));
  ...
  oai21  g49(.a(new_n64_), .b(new_n71_), .c(new_n77_), .O(z6));
  ...
  nand4  g56(.a(new_n84_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n85_));
  oai21  g57(.a(new_n64_), .b(new_n79_), .c(new_n85_), .O(z7));
  nand2  g58(.a(x16), .b(x15), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x09), .O(new_n88_));
  nand3  g60(.a(x17), .b(x14), .c(x13), .O(new_n89_));
  inv1   g61(.a(new_n89_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n88_), .c(new_n57_), .O(new_n91_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n42_), .c(new_n37_), .O(new_n96_));
