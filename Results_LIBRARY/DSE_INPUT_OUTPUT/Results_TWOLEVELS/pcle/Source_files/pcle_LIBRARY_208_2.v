...
module FAU ( 
  ...
  nand4  g52(.a(new_n80_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n81_));
  nand3  g53(.a(x10), .b(x08), .c(x06), .O(new_n82_));
  ...
  nor2   g57(.a(new_n71_), .b(new_n32_), .O(new_n86_));
  nor2   g58(.a(x18), .b(new_n78_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n63_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n90_));
  nand3  g62(.a(x10), .b(x08), .c(x07), .O(new_n91_));
