...
module FAU ( 
  ...
  aoi21  g25(.a(new_n53_), .b(new_n31_), .c(new_n39_), .O(new_n54_));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n31_), .c(new_n39_), .O(new_n61_));
  ...
  oai22  g42(.a(new_n70_), .b(new_n39_), .c(new_n44_), .d(new_n64_), .O(z5));
  ...
  oai22  g50(.a(new_n78_), .b(new_n39_), .c(new_n44_), .d(new_n72_), .O(z6));
  ...
  aoi21  g64(.a(new_n92_), .b(new_n90_), .c(x10), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x09), .c(new_n31_), .d(x00), .O(new_n94_));
