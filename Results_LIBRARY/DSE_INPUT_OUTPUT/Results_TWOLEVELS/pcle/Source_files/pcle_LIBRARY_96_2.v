...
module FAU ( 
  ...
  aoi21  g11(.a(x17), .b(x10), .c(x11), .O(new_n40_));
  ...
  nand2  g59(.a(new_n87_), .b(new_n81_), .O(new_n88_));
  oai21  g60(.a(new_n79_), .b(new_n55_), .c(x18), .O(new_n89_));
  inv1   g61(.a(x18), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n64_), .c(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n93_));
  nand2  g65(.a(x08), .b(x07), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n93_), .c(new_n88_), .O(z8));
endmodule
