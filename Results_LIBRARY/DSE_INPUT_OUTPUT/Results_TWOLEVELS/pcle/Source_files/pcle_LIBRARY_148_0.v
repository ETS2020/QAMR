...
module FAU ( 
  ...
  inv1   g35(.a(x12), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(x09), .O(new_n65_));
  nor2   g37(.a(new_n56_), .b(new_n48_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n65_), .c(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x15), .O(new_n68_));
  inv1   g40(.a(x15), .O(new_n69_));
  nand4  g41(.a(new_n50_), .b(new_n69_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(x08), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n63_), .c(new_n31_), .O(new_n72_));
  ...
  oai21  g48(.a(new_n76_), .b(new_n49_), .c(x16), .O(new_n77_));
  ...
  oai21  g53(.a(new_n39_), .b(new_n75_), .c(new_n81_), .O(z6));
  nand2  g54(.a(new_n69_), .b(x09), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n58_), .c(x16), .d(x14), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(x17), .O(new_n85_));
  inv1   g57(.a(x17), .O(new_n86_));
  nor2   g58(.a(new_n69_), .b(new_n56_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n58_), .c(new_n86_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(x08), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n63_), .c(new_n31_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n90_), .O(z7));
  and2   g64(.a(x17), .b(x16), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n83_), .c(new_n58_), .d(x14), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x18), .O(new_n95_));
  nor2   g67(.a(new_n78_), .b(new_n69_), .O(new_n96_));
  nor2   g68(.a(x18), .b(new_n86_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n66_), .d(new_n50_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n95_), .c(x08), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n63_), .c(new_n31_), .O(new_n100_));
