...
module FAU ( 
  ...
  aoi21  g22(.a(new_n50_), .b(new_n48_), .c(x16), .O(new_n51_));
  ...
  and2   g29(.a(x12), .b(x11), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n57_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(x16), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n33_), .c(x09), .d(new_n39_), .O(new_n61_));
  oai21  g33(.a(new_n32_), .b(new_n54_), .c(new_n61_), .O(z4));
  aoi21  g34(.a(x13), .b(x12), .c(x16), .O(new_n63_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(new_n35_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n39_), .c(x16), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(x10), .c(new_n70_), .O(z5));
  nand3  g43(.a(x11), .b(x09), .c(new_n39_), .O(new_n72_));
  ...
  nand2  g49(.a(x17), .b(x09), .O(new_n78_));
  ...
  nand4  g55(.a(new_n36_), .b(x18), .c(new_n29_), .d(new_n33_), .O(new_n84_));
  oai21  g56(.a(new_n32_), .b(new_n83_), .c(new_n84_), .O(z8));
endmodule
