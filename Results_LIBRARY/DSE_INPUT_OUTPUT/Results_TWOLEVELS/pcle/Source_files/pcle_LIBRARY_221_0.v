...
module FAU ( 
  ...
  nand2  g11(.a(new_n31_), .b(x05), .O(new_n40_));
  oai21  g12(.a(x10), .b(x05), .c(x08), .O(new_n41_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n31_), .c(new_n46_), .O(new_n65_));
  ...
  oai22  g44(.a(new_n72_), .b(new_n51_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(new_n46_), .c(new_n41_), .d(new_n68_), .O(z5));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n31_), .c(new_n46_), .O(z6));
  aoi21  g55(.a(x15), .b(x14), .c(new_n46_), .O(new_n84_));
  nand4  g56(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n84_), .c(x17), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  nor2   g59(.a(new_n69_), .b(new_n30_), .O(new_n88_));
  inv1   g60(.a(new_n78_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n86_), .c(new_n58_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n31_), .c(new_n46_), .O(new_n92_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n78_), .c(x18), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n87_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n71_), .c(x16), .d(x15), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n97_), .c(x10), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(x09), .c(new_n31_), .d(x05), .O(new_n101_));
  oai21  g73(.a(new_n41_), .b(new_n95_), .c(new_n101_), .O(z8));
endmodule
