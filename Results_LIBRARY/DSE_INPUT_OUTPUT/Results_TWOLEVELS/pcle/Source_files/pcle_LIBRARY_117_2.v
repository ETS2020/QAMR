...
module FAU ( 
  ...
  aoi21  g17(.a(new_n33_), .b(x05), .c(new_n32_), .O(new_n46_));
  ...
  oai21  g21(.a(new_n49_), .b(x05), .c(new_n47_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n32_), .c(x05), .O(new_n57_));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n32_), .c(x05), .O(new_n65_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n32_), .c(x05), .O(new_n73_));
  ...
  nor2   g60(.a(new_n70_), .b(new_n30_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n84_), .c(new_n88_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n51_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n32_), .c(x05), .O(new_n92_));
  nand2  g64(.a(x08), .b(x06), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x10), .c(new_n93_), .O(z7));
  nand2  g66(.a(new_n46_), .b(x07), .O(new_n95_));
  nand3  g67(.a(new_n89_), .b(x17), .c(x16), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n60_), .c(x18), .O(new_n97_));
  inv1   g69(.a(new_n68_), .O(new_n98_));
  nor2   g70(.a(x18), .b(new_n88_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n98_), .c(x16), .d(x15), .O(new_n100_));
