...
module FAU ( 
  ...
  oai21  g49(.a(new_n77_), .b(x10), .c(new_n47_), .O(new_n78_));
  ...
  oai21  g58(.a(new_n86_), .b(x10), .c(new_n47_), .O(new_n87_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n95_));
