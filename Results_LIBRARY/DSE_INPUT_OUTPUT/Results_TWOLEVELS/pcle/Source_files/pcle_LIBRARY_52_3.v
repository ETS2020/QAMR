...
module FAU ( 
  ...
  nand2  g31(.a(new_n32_), .b(x04), .O(new_n60_));
  nand4  g32(.a(x11), .b(new_n35_), .c(x09), .d(new_n31_), .O(new_n61_));
  nand4  g33(.a(new_n37_), .b(x14), .c(x13), .d(x12), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z5));
  nand2  g35(.a(new_n32_), .b(x05), .O(new_n64_));
  nand3  g36(.a(x16), .b(new_n37_), .c(new_n35_), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n34_), .c(new_n64_), .O(z6));
  nand3  g38(.a(x17), .b(new_n35_), .c(new_n31_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n37_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x09), .O(new_n69_));
  nand2  g41(.a(x08), .b(x06), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z7));
  nand3  g43(.a(x18), .b(new_n35_), .c(new_n31_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n37_), .O(new_n73_));
