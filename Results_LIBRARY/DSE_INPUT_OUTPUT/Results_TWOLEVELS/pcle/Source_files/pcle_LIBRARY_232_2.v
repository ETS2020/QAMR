...
module FAU ( 
  ...
  oai22  g39(.a(new_n67_), .b(new_n49_), .c(new_n66_), .d(new_n33_), .O(new_n68_));
  ...
  nand2  g50(.a(new_n55_), .b(x05), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  oai21  g52(.a(new_n39_), .b(x06), .c(x08), .O(new_n81_));
  inv1   g53(.a(new_n74_), .O(new_n82_));
  nand2  g54(.a(new_n33_), .b(new_n29_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n82_), .c(x16), .d(x14), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(x17), .O(new_n85_));
  inv1   g57(.a(x17), .O(new_n86_));
  nand4  g58(.a(new_n82_), .b(new_n34_), .c(new_n86_), .d(x16), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n39_), .c(x09), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n81_), .O(z7));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n74_), .c(x18), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n86_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n66_), .c(x16), .d(x15), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n96_));
  nand2  g68(.a(new_n55_), .b(x07), .O(new_n97_));
