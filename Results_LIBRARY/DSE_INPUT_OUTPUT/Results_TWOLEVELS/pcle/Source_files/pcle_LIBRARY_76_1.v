...
module FAU ( 
  ...
  oai21  g25(.a(new_n53_), .b(x10), .c(new_n40_), .O(new_n54_));
  ...
  oai21  g32(.a(new_n60_), .b(x10), .c(new_n40_), .O(new_n61_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n76_));
  nand2  g48(.a(x08), .b(x05), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z6));
  inv1   g50(.a(new_n57_), .O(new_n79_));
  nand2  g51(.a(new_n33_), .b(new_n29_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n79_), .c(x16), .d(x14), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x17), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n79_), .b(new_n34_), .c(new_n83_), .d(x16), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(x10), .c(new_n40_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  and2   g60(.a(x17), .b(x16), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n80_), .c(new_n79_), .d(x14), .O(new_n90_));
  ...
  aoi21  g65(.a(new_n93_), .b(new_n91_), .c(new_n48_), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(x10), .c(new_n40_), .O(new_n95_));
