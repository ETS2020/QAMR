...
module FAU ( 
  ...
  nand2  g02(.a(x06), .b(x03), .O(new_n31_));
  ...
  inv1   g09(.a(new_n31_), .O(new_n38_));
  ...
  nor2   g20(.a(new_n30_), .b(new_n41_), .O(new_n49_));
  ...
  nor2   g43(.a(new_n63_), .b(new_n58_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x05), .c(new_n38_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  oai21  g52(.a(x08), .b(x03), .c(x06), .O(new_n81_));
  nor2   g53(.a(new_n75_), .b(new_n63_), .O(new_n82_));
  ...
  nand4  g64(.a(new_n82_), .b(new_n66_), .c(new_n92_), .d(x17), .O(new_n93_));
