...
module FAU ( 
  ...
  aoi21  g11(.a(x18), .b(x10), .c(new_n31_), .O(new_n40_));
  ...
  nand2  g27(.a(new_n35_), .b(x13), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n32_), .c(new_n55_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n58_));
  aoi22  g30(.a(x18), .b(x10), .c(x08), .d(x03), .O(new_n59_));
  ...
  nand2  g40(.a(new_n40_), .b(x05), .O(new_n69_));
