...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(new_n32_), .c(x11), .d(x09), .O(new_n36_));
  ...
  nand4  g15(.a(new_n43_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n44_));
  ...
  nand3  g20(.a(new_n31_), .b(x12), .c(x11), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n51_));
  ...
  oai22  g29(.a(new_n57_), .b(new_n47_), .c(new_n56_), .d(new_n54_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n59_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  inv1   g41(.a(x16), .O(new_n70_));
  nor3   g42(.a(new_n47_), .b(new_n33_), .c(new_n31_), .O(new_n71_));
  nand3  g43(.a(new_n70_), .b(x15), .c(x14), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(new_n55_), .c(new_n71_), .d(new_n70_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n74_));
  ...
  nand2  g50(.a(x16), .b(x11), .O(new_n79_));
  aoi21  g51(.a(new_n78_), .b(new_n29_), .c(new_n79_), .O(new_n80_));
  inv1   g52(.a(new_n33_), .O(new_n81_));
  nand4  g53(.a(new_n56_), .b(new_n81_), .c(new_n77_), .d(x16), .O(new_n82_));
  oai21  g54(.a(new_n80_), .b(new_n77_), .c(new_n82_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(x09), .c(x10), .O(new_n84_));
  nand2  g56(.a(x08), .b(x06), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(x08), .c(new_n85_), .O(z7));
  nand3  g58(.a(new_n81_), .b(x17), .c(x16), .O(new_n87_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n92_));
