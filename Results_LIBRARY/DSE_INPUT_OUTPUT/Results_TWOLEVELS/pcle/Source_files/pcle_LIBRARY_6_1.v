...
module FAU ( 
  ...
  nand4  g15(.a(x12), .b(x11), .c(x09), .d(new_n43_), .O(new_n44_));
  ...
  nand4  g21(.a(new_n34_), .b(x14), .c(new_n29_), .d(new_n39_), .O(new_n50_));
  oai21  g22(.a(new_n32_), .b(new_n49_), .c(new_n50_), .O(z4));
