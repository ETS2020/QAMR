...
module FAU ( 
  ...
  nand4  g32(.a(new_n60_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n61_));
  ...
  oai21  g41(.a(new_n69_), .b(x10), .c(new_n44_), .O(new_n70_));
  ...
  oai21  g57(.a(new_n85_), .b(x10), .c(new_n44_), .O(new_n86_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n44_), .O(new_n95_));
