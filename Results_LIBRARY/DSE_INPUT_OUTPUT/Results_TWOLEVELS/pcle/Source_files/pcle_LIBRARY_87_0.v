...
module FAU ( 
  ...
  oai21  g18(.a(x10), .b(x05), .c(x08), .O(new_n47_));
  ...
  nand4  g28(.a(new_n56_), .b(x09), .c(new_n31_), .d(x05), .O(new_n57_));
  ...
  nand3  g42(.a(new_n67_), .b(x14), .c(x13), .O(new_n71_));
  oai22  g43(.a(new_n71_), .b(new_n52_), .c(new_n70_), .d(new_n67_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(x09), .c(new_n31_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x05), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  ...
  nand3  g54(.a(new_n82_), .b(new_n32_), .c(x09), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n31_), .c(new_n46_), .O(z6));
  ...
  oai22  g63(.a(new_n91_), .b(new_n46_), .c(new_n47_), .d(new_n85_), .O(z7));
  inv1   g64(.a(x09), .O(new_n93_));
  nand2  g65(.a(x16), .b(x15), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x05), .O(new_n95_));
  nand3  g67(.a(x17), .b(x14), .c(x13), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n95_), .c(new_n62_), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(x18), .O(new_n99_));
  inv1   g71(.a(new_n94_), .O(new_n100_));
  nor2   g72(.a(new_n30_), .b(new_n54_), .O(new_n101_));
  nor2   g73(.a(x18), .b(new_n88_), .O(new_n102_));
  nand4  g74(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n62_), .O(new_n103_));
  aoi21  g75(.a(new_n103_), .b(new_n99_), .c(new_n93_), .O(new_n104_));
  aoi21  g76(.a(new_n104_), .b(new_n31_), .c(new_n46_), .O(new_n105_));
  nand2  g77(.a(x08), .b(x07), .O(new_n106_));
  oai21  g78(.a(new_n105_), .b(x10), .c(new_n106_), .O(z8));
endmodule
