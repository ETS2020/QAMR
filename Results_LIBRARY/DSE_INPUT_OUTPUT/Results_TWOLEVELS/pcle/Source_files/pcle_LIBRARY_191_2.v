...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x02), .c(new_n37_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  nor2   g12(.a(x11), .b(x10), .O(new_n41_));
  nand4  g13(.a(new_n41_), .b(x09), .c(new_n37_), .d(new_n29_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n40_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand3  g16(.a(new_n44_), .b(x09), .c(new_n37_), .O(new_n45_));
  ...
  nand4  g26(.a(new_n54_), .b(x09), .c(new_n37_), .d(new_n29_), .O(new_n55_));
  nand3  g27(.a(x10), .b(x08), .c(x02), .O(new_n56_));
  ...
  nand4  g35(.a(new_n63_), .b(x09), .c(new_n37_), .d(new_n29_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n58_), .O(z4));
  aoi21  g37(.a(x13), .b(x12), .c(x02), .O(new_n66_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n30_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n37_), .c(x02), .O(new_n72_));
  nand2  g44(.a(x08), .b(x04), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(x10), .c(new_n73_), .O(z5));
  nand3  g46(.a(x15), .b(x14), .c(x11), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n66_), .c(x16), .O(new_n76_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n37_), .c(x02), .O(new_n81_));
  ...
  nand4  g58(.a(new_n33_), .b(new_n78_), .c(new_n86_), .d(x16), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n85_), .c(new_n30_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n37_), .c(x02), .O(new_n89_));
  ...
  nand4  g71(.a(new_n99_), .b(x09), .c(new_n37_), .d(new_n29_), .O(new_n100_));
