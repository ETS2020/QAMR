...
module FAU ( 
  ...
  nor2   g22(.a(new_n50_), .b(new_n40_), .O(new_n51_));
  ...
  nand2  g27(.a(x14), .b(new_n50_), .O(new_n56_));
  inv1   g28(.a(x14), .O(new_n57_));
  nand3  g29(.a(new_n51_), .b(new_n57_), .c(x13), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n56_), .c(x10), .O(new_n59_));
  aoi21  g31(.a(x13), .b(x11), .c(new_n57_), .O(new_n60_));
  ...
  oai21  g35(.a(new_n61_), .b(x08), .c(new_n63_), .O(z4));
  nand3  g36(.a(x13), .b(x12), .c(x11), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand3  g39(.a(new_n51_), .b(new_n67_), .c(x13), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(new_n57_), .O(new_n69_));
  nand3  g41(.a(x15), .b(new_n57_), .c(new_n31_), .O(new_n70_));
  inv1   g42(.a(new_n70_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n69_), .c(x09), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x04), .c(new_n62_), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(x08), .c(new_n73_), .O(z5));
  inv1   g46(.a(x16), .O(new_n75_));
  oai21  g47(.a(new_n67_), .b(new_n57_), .c(new_n31_), .O(new_n76_));
  nand2  g48(.a(new_n65_), .b(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  nor4   g50(.a(new_n65_), .b(x16), .c(new_n67_), .d(new_n57_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n78_), .c(x09), .O(new_n80_));
  aoi21  g52(.a(x08), .b(x05), .c(new_n62_), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x08), .c(new_n81_), .O(z6));
  inv1   g54(.a(x06), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n65_), .c(x17), .O(new_n85_));
  inv1   g57(.a(x17), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n65_), .c(new_n85_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n89_));
  oai21  g61(.a(new_n44_), .b(new_n83_), .c(new_n89_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n65_), .c(x18), .O(new_n93_));
  nor2   g65(.a(new_n75_), .b(new_n67_), .O(new_n94_));
  nor2   g66(.a(new_n57_), .b(new_n49_), .O(new_n95_));
  ...
  oai21  g71(.a(new_n44_), .b(new_n91_), .c(new_n99_), .O(z8));
endmodule
