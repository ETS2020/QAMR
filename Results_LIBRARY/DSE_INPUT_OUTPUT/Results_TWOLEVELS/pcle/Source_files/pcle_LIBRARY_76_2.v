...
module FAU ( 
  ...
  oai21  g16(.a(new_n41_), .b(x01), .c(x08), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand3  g18(.a(new_n46_), .b(new_n41_), .c(x09), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n45_), .O(z2));
  oai21  g20(.a(new_n41_), .b(x02), .c(x08), .O(new_n49_));
  ...
  nand3  g26(.a(new_n54_), .b(new_n41_), .c(x09), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n49_), .O(z3));
  oai21  g28(.a(new_n41_), .b(x03), .c(x08), .O(new_n57_));
  nand3  g29(.a(x13), .b(x12), .c(x11), .O(new_n58_));
  inv1   g30(.a(new_n58_), .O(new_n59_));
  nand2  g31(.a(new_n32_), .b(x13), .O(new_n60_));
  oai22  g32(.a(new_n60_), .b(new_n50_), .c(new_n59_), .d(new_n32_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n41_), .c(x09), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n57_), .O(z4));
  oai21  g35(.a(new_n41_), .b(x04), .c(x08), .O(new_n64_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n41_), .c(x09), .O(new_n69_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n77_));
  oai21  g49(.a(new_n40_), .b(new_n71_), .c(new_n77_), .O(z6));
  oai21  g50(.a(new_n41_), .b(x06), .c(x08), .O(new_n79_));
  nand2  g51(.a(new_n33_), .b(new_n29_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n59_), .c(x16), .d(x14), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x17), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n59_), .b(new_n34_), .c(new_n83_), .d(x16), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n41_), .c(x09), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n79_), .O(z7));
  oai21  g59(.a(new_n41_), .b(x07), .c(x08), .O(new_n88_));
  and2   g60(.a(x17), .b(x16), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n80_), .c(new_n59_), .d(x14), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n83_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n66_), .c(x16), .d(x15), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n41_), .c(x09), .O(new_n95_));
