...
module FAU ( 
  ...
  aoi21  g16(.a(new_n44_), .b(new_n41_), .c(x10), .O(new_n45_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n30_), .c(x09), .d(new_n41_), .O(new_n84_));
  oai21  g56(.a(new_n40_), .b(new_n78_), .c(new_n84_), .O(z7));
  inv1   g57(.a(x18), .O(new_n86_));
  nand3  g58(.a(x16), .b(x14), .c(x13), .O(new_n87_));
  nand4  g59(.a(x17), .b(x15), .c(x12), .d(x11), .O(new_n88_));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n41_), .c(x10), .O(new_n92_));
  nand2  g64(.a(x08), .b(x07), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(new_n29_), .c(new_n93_), .O(z8));
endmodule
