...
module FAU ( 
  ...
  oai21  g33(.a(x16), .b(x13), .c(x14), .O(new_n62_));
  ...
  inv1   g52(.a(x07), .O(new_n81_));
  nand2  g53(.a(x09), .b(new_n32_), .O(new_n82_));
  nand3  g54(.a(x18), .b(new_n29_), .c(new_n31_), .O(new_n83_));
  oai22  g55(.a(new_n83_), .b(new_n82_), .c(new_n40_), .d(new_n81_), .O(z8));
endmodule
