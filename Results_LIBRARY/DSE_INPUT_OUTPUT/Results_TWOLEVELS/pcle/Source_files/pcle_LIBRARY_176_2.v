...
module FAU ( 
  ...
  oai22  g51(.a(new_n79_), .b(new_n57_), .c(new_n70_), .d(new_n78_), .O(new_n80_));
  ...
  oai21  g62(.a(new_n41_), .b(new_n84_), .c(new_n90_), .O(z7));
  nand2  g63(.a(x18), .b(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(new_n31_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n39_), .O(new_n94_));
  ...
  oai21  g69(.a(new_n97_), .b(new_n69_), .c(new_n96_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n99_));
  nand2  g71(.a(x08), .b(x07), .O(new_n100_));
  nand3  g72(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z8));
endmodule
