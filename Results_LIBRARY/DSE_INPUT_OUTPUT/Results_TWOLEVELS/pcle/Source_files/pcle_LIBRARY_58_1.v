...
module FAU ( 
  ...
  nand2  g56(.a(new_n32_), .b(x07), .O(new_n85_));
  nor2   g57(.a(new_n45_), .b(x10), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(x09), .c(new_n31_), .O(new_n87_));
  inv1   g59(.a(new_n70_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n29_), .c(x17), .d(x16), .O(new_n89_));
