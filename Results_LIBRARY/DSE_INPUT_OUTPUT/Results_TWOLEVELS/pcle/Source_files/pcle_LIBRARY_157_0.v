...
module FAU ( 
  ...
  nand2  g21(.a(new_n49_), .b(x03), .O(new_n50_));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n41_), .c(new_n54_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x02), .O(new_n61_));
  oai21  g33(.a(new_n60_), .b(x10), .c(new_n61_), .O(z3));
  inv1   g34(.a(new_n30_), .O(new_n63_));
  nand2  g35(.a(new_n32_), .b(x13), .O(new_n64_));
  oai22  g36(.a(new_n64_), .b(new_n55_), .c(new_n63_), .d(new_n32_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n40_), .c(x09), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n41_), .c(new_n54_), .O(z4));
  nand4  g39(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x15), .O(new_n69_));
  inv1   g41(.a(new_n55_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n33_), .c(x14), .d(x13), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n29_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n41_), .c(new_n54_), .O(new_n73_));
  ...
  nand4  g50(.a(new_n63_), .b(new_n78_), .c(x15), .d(x14), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n77_), .c(new_n29_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n41_), .c(new_n54_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x05), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(x10), .c(new_n82_), .O(z6));
  aoi21  g55(.a(new_n40_), .b(new_n54_), .c(new_n41_), .O(new_n84_));
  ...
  nand4  g61(.a(new_n89_), .b(new_n40_), .c(x09), .d(new_n41_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n54_), .c(new_n85_), .O(z7));
  ...
  nor2   g67(.a(new_n78_), .b(new_n33_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n36_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n94_), .c(x10), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n41_), .d(x03), .O(new_n99_));
