...
module FAU ( 
  ...
  oai21  g21(.a(x10), .b(x04), .c(x08), .O(new_n50_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n41_), .c(new_n49_), .O(new_n68_));
  ...
  oai22  g45(.a(new_n73_), .b(new_n55_), .c(new_n72_), .d(new_n33_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n40_), .c(x09), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n41_), .c(new_n49_), .O(z5));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n41_), .c(new_n49_), .O(new_n83_));
  ...
  nand4  g59(.a(new_n34_), .b(new_n80_), .c(new_n35_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n87_), .c(new_n29_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n41_), .c(new_n49_), .O(new_n90_));
  ...
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n41_), .d(x04), .O(new_n99_));
  oai21  g71(.a(new_n50_), .b(new_n93_), .c(new_n99_), .O(z8));
endmodule
