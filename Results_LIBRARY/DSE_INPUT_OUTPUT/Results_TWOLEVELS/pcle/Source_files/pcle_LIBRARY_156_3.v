...
module FAU ( 
  ...
  inv1   g24(.a(new_n39_), .O(new_n53_));
  ...
  nand3  g30(.a(new_n49_), .b(new_n56_), .c(x13), .O(new_n59_));
  ...
  oai21  g43(.a(new_n40_), .b(new_n64_), .c(new_n71_), .O(z5));
  ...
  nand3  g48(.a(new_n49_), .b(x15), .c(x13), .O(new_n77_));
  ...
  aoi21  g52(.a(x08), .b(x05), .c(new_n53_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(z6));
  inv1   g54(.a(x17), .O(new_n83_));
  aoi21  g55(.a(x16), .b(x13), .c(x10), .O(new_n84_));
  nand3  g56(.a(new_n49_), .b(x15), .c(x14), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(x16), .c(new_n84_), .O(new_n86_));
  nor2   g58(.a(new_n65_), .b(new_n56_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n58_), .c(new_n83_), .d(x16), .O(new_n88_));
  oai21  g60(.a(new_n86_), .b(new_n83_), .c(new_n88_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(x09), .c(new_n30_), .O(new_n90_));
  aoi21  g62(.a(x08), .b(x06), .c(new_n53_), .O(new_n91_));
  ...
  nor2   g67(.a(x18), .b(new_n83_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n68_), .c(x16), .d(x15), .O(new_n97_));
