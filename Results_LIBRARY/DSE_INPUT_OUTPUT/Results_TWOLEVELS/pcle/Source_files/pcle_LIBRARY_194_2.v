...
module FAU ( 
  ...
  nor2   g16(.a(new_n30_), .b(new_n32_), .O(new_n45_));
  ...
  nand2  g68(.a(x18), .b(x09), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(x08), .c(new_n29_), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(new_n66_), .O(new_n99_));
  nand3  g71(.a(x17), .b(x16), .c(x15), .O(new_n100_));
  oai21  g72(.a(new_n100_), .b(new_n70_), .c(x18), .O(new_n101_));
  nand4  g73(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n102_));
  inv1   g74(.a(x18), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(x17), .c(x16), .d(x15), .O(new_n104_));
  oai21  g76(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(new_n105_));
  nand4  g77(.a(new_n105_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n106_));
  nand2  g78(.a(x08), .b(x07), .O(new_n107_));
  nand3  g79(.a(new_n107_), .b(new_n106_), .c(new_n99_), .O(z8));
endmodule
