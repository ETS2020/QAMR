...
module FAU ( 
  ...
  nand2  g32(.a(new_n60_), .b(new_n30_), .O(z4));
  ...
  oai22  g37(.a(new_n65_), .b(new_n48_), .c(new_n64_), .d(new_n62_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n67_));
  nand3  g39(.a(x08), .b(x04), .c(x03), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  oai21  g41(.a(x05), .b(new_n38_), .c(x08), .O(new_n70_));
  ...
  oai21  g49(.a(x06), .b(new_n38_), .c(x08), .O(new_n78_));
