...
module FAU ( 
  ...
  aoi21  g16(.a(new_n44_), .b(new_n30_), .c(x10), .O(new_n45_));
  ...
  oai21  g33(.a(new_n61_), .b(x10), .c(x09), .O(new_n62_));
  ...
  aoi21  g52(.a(x15), .b(x14), .c(x10), .O(new_n81_));
  nand4  g53(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n81_), .c(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  inv1   g56(.a(new_n56_), .O(new_n85_));
  nand2  g57(.a(x15), .b(x14), .O(new_n86_));
  inv1   g58(.a(new_n86_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n83_), .c(x08), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x10), .c(x09), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n90_), .O(z7));
  nand2  g64(.a(new_n86_), .b(new_n31_), .O(new_n93_));
  nand3  g65(.a(x17), .b(x16), .c(x13), .O(new_n94_));
  inv1   g66(.a(new_n94_), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n93_), .c(new_n59_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x18), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n84_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n68_), .c(x16), .d(x15), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n97_), .c(x08), .O(new_n100_));
  oai21  g72(.a(new_n100_), .b(x10), .c(x09), .O(new_n101_));
