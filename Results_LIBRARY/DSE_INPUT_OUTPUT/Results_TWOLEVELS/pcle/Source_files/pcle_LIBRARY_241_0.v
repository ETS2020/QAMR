...
module FAU ( 
  ...
  aoi21  g35(.a(new_n63_), .b(new_n60_), .c(new_n58_), .O(new_n64_));
  ...
  nor2   g50(.a(x16), .b(new_n70_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n58_), .O(new_n81_));
  ...
  nand2  g65(.a(x18), .b(new_n88_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x16), .c(x15), .d(x14), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x13), .O(new_n96_));
  nand2  g68(.a(x18), .b(new_n53_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n96_), .c(x12), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(x11), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n93_), .c(new_n58_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n30_), .c(new_n29_), .O(new_n101_));
