...
module FAU ( 
  ...
  nand3  g53(.a(x16), .b(x15), .c(x11), .O(new_n82_));
  aoi21  g54(.a(new_n81_), .b(new_n30_), .c(new_n82_), .O(new_n83_));
  nand4  g55(.a(new_n80_), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai22  g56(.a(new_n84_), .b(new_n56_), .c(new_n83_), .d(new_n80_), .O(new_n85_));
