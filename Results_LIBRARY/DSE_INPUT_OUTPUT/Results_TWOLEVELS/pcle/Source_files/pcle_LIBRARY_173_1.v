...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(new_n32_), .c(x13), .d(x12), .O(new_n36_));
  aoi21  g08(.a(new_n36_), .b(new_n29_), .c(x08), .O(z0));
  aoi21  g09(.a(new_n31_), .b(x09), .c(x10), .O(new_n38_));
  nand2  g10(.a(x08), .b(x00), .O(new_n39_));
  oai21  g11(.a(new_n38_), .b(x08), .c(new_n39_), .O(z1));
  ...
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n51_));
  nand2  g23(.a(x08), .b(x02), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(z3));
  oai21  g25(.a(x12), .b(x10), .c(x13), .O(new_n54_));
  oai21  g26(.a(new_n54_), .b(new_n31_), .c(x14), .O(new_n55_));
  inv1   g27(.a(x14), .O(new_n56_));
  nand3  g28(.a(new_n48_), .b(new_n56_), .c(x13), .O(new_n57_));
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(new_n30_), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(x10), .c(new_n45_), .O(new_n59_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n47_), .c(new_n64_), .d(new_n62_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  inv1   g41(.a(x16), .O(new_n70_));
  nor3   g42(.a(new_n47_), .b(new_n33_), .c(new_n46_), .O(new_n71_));
  nand3  g43(.a(x13), .b(x12), .c(x11), .O(new_n72_));
  nand3  g44(.a(new_n70_), .b(x15), .c(x14), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n75_));
  nand2  g47(.a(x08), .b(x05), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  aoi21  g49(.a(x15), .b(x14), .c(x10), .O(new_n78_));
  nand4  g50(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n78_), .c(x17), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  inv1   g53(.a(new_n33_), .O(new_n82_));
  inv1   g54(.a(new_n72_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(x16), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n80_), .c(new_n30_), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(x10), .c(new_n45_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  nand2  g60(.a(new_n33_), .b(new_n29_), .O(new_n89_));
  nand3  g61(.a(x17), .b(x16), .c(x13), .O(new_n90_));
  inv1   g62(.a(new_n90_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n89_), .c(new_n48_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x18), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n81_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n64_), .c(x16), .d(x15), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(new_n30_), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(x10), .c(new_n45_), .O(new_n97_));
