...
module FAU ( 
  ...
  nand3  g33(.a(new_n41_), .b(x08), .c(x04), .O(new_n62_));
  ...
  nand3  g49(.a(new_n41_), .b(x08), .c(x06), .O(new_n78_));
  nand3  g50(.a(x16), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n55_), .c(x17), .O(new_n80_));
  nand4  g52(.a(new_n30_), .b(x16), .c(x15), .d(x14), .O(new_n81_));
  ...
  nand4  g58(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n87_));
  aoi22  g59(.a(new_n87_), .b(new_n29_), .c(new_n86_), .d(x17), .O(new_n88_));
  nor2   g60(.a(new_n72_), .b(new_n63_), .O(new_n89_));
  nor2   g61(.a(x18), .b(new_n30_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(new_n65_), .O(new_n91_));
  oai21  g63(.a(new_n88_), .b(new_n85_), .c(new_n91_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(x09), .c(new_n31_), .O(new_n93_));
  aoi21  g65(.a(x08), .b(x07), .c(new_n40_), .O(new_n94_));
