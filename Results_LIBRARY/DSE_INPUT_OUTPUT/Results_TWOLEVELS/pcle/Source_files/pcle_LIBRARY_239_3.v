...
module FAU ( 
  ...
  nand3  g07(.a(x18), .b(x17), .c(x15), .O(new_n36_));
  ...
  nand2  g11(.a(x16), .b(x10), .O(new_n40_));
  ...
  nand2  g17(.a(new_n40_), .b(x08), .O(new_n46_));
  ...
  nand2  g30(.a(new_n35_), .b(x13), .O(new_n59_));
  oai22  g31(.a(new_n59_), .b(new_n32_), .c(new_n58_), .d(new_n35_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n61_));
  oai21  g33(.a(new_n46_), .b(new_n56_), .c(new_n61_), .O(z4));
  ...
  oai22  g38(.a(new_n66_), .b(new_n32_), .c(new_n65_), .d(new_n63_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n68_));
  aoi21  g40(.a(x08), .b(x04), .c(new_n53_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  nand3  g42(.a(new_n30_), .b(x15), .c(x14), .O(new_n71_));
  oai22  g43(.a(new_n71_), .b(new_n57_), .c(new_n30_), .d(x13), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n29_), .O(new_n73_));
  nand2  g45(.a(x15), .b(x14), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n32_), .c(x16), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x09), .c(new_n31_), .O(new_n77_));
  aoi21  g49(.a(x08), .b(x05), .c(new_n53_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z6));
  nand3  g51(.a(x15), .b(x14), .c(x13), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n32_), .c(x17), .O(new_n81_));
  inv1   g53(.a(x17), .O(new_n82_));
  nand4  g54(.a(new_n58_), .b(new_n82_), .c(x15), .d(x14), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n81_), .c(new_n30_), .O(new_n84_));
  nand3  g56(.a(x17), .b(new_n30_), .c(new_n29_), .O(new_n85_));
  inv1   g57(.a(new_n85_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n84_), .c(x09), .O(new_n87_));
  aoi21  g59(.a(x08), .b(x06), .c(new_n53_), .O(new_n88_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n65_), .c(x16), .d(x15), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n96_));
  oai21  g68(.a(new_n46_), .b(new_n90_), .c(new_n96_), .O(z8));
endmodule
