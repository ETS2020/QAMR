...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(x03), .O(new_n39_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n61_), .c(x10), .O(z4));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n78_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n77_), .O(z6));
  ...
  oai21  g59(.a(new_n40_), .b(new_n81_), .c(new_n87_), .O(z7));
  ...
  aoi21  g66(.a(x08), .b(x07), .c(new_n78_), .O(new_n95_));
