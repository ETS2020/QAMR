...
module FAU ( 
  ...
  nand2  g33(.a(new_n61_), .b(x08), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n54_), .c(new_n60_), .O(z4));
  oai21  g35(.a(x09), .b(x04), .c(x08), .O(new_n64_));
  oai21  g36(.a(x13), .b(x08), .c(x14), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n48_), .c(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand4  g39(.a(new_n49_), .b(new_n67_), .c(x14), .d(x13), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n31_), .c(x09), .O(new_n70_));
  ...
  oai21  g50(.a(new_n62_), .b(new_n72_), .c(new_n78_), .O(z6));
