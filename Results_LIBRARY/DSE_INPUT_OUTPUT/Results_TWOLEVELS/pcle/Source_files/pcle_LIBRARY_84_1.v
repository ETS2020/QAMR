...
module FAU ( 
  ...
  oai21  g33(.a(new_n61_), .b(x10), .c(new_n41_), .O(new_n62_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(z7));
  nand4  g59(.a(x17), .b(x13), .c(x12), .d(x11), .O(new_n88_));
  aoi21  g60(.a(new_n81_), .b(new_n29_), .c(new_n88_), .O(new_n89_));
  nand4  g61(.a(new_n36_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n65_), .c(new_n89_), .d(new_n36_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(x09), .c(x10), .O(new_n92_));
