...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n51_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n54_), .c(new_n56_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n59_));
  ...
  nand4  g37(.a(new_n48_), .b(new_n33_), .c(x14), .d(x13), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n65_), .c(new_n62_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(x10), .c(new_n39_), .O(new_n68_));
  ...
  nor2   g61(.a(new_n32_), .b(new_n47_), .O(new_n90_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n94_));
