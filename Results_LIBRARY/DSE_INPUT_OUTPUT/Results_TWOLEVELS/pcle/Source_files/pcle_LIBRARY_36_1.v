...
module FAU ( 
  ...
  nand3  g43(.a(new_n71_), .b(new_n70_), .c(new_n39_), .O(z5));
  ...
  oai21  g51(.a(new_n49_), .b(new_n73_), .c(new_n79_), .O(z6));
  ...
  oai21  g59(.a(new_n49_), .b(new_n81_), .c(new_n87_), .O(z7));
  ...
  oai21  g67(.a(new_n49_), .b(new_n89_), .c(new_n95_), .O(z8));
endmodule
