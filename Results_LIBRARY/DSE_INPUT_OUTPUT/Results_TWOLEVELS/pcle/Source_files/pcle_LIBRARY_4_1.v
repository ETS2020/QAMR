...
module FAU ( 
  ...
  oai21  g12(.a(new_n40_), .b(x05), .c(x08), .O(new_n41_));
  nor2   g13(.a(x11), .b(x10), .O(new_n42_));
  nand4  g14(.a(new_n42_), .b(x09), .c(new_n31_), .d(x05), .O(new_n43_));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n31_), .c(new_n46_), .O(new_n55_));
  nand2  g27(.a(x08), .b(x02), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(new_n40_), .c(new_n56_), .O(z3));
  ...
  nand4  g34(.a(new_n62_), .b(x09), .c(new_n31_), .d(x05), .O(new_n63_));
  oai21  g35(.a(new_n41_), .b(new_n58_), .c(new_n63_), .O(z4));
  ...
  oai22  g43(.a(new_n71_), .b(new_n46_), .c(new_n41_), .d(new_n65_), .O(z5));
  ...
  nand3  g49(.a(new_n77_), .b(new_n32_), .c(x09), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n31_), .c(new_n46_), .O(z6));
  inv1   g51(.a(x17), .O(new_n80_));
  nand3  g52(.a(x16), .b(x12), .c(x11), .O(new_n81_));
  aoi21  g53(.a(new_n73_), .b(x05), .c(new_n81_), .O(new_n82_));
  nand4  g54(.a(new_n80_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai22  g55(.a(new_n83_), .b(new_n59_), .c(new_n82_), .d(new_n80_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n32_), .c(new_n31_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x05), .O(new_n86_));
