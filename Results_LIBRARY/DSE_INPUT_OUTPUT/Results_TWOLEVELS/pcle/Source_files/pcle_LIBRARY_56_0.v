...
module FAU ( 
  ...
  nand4  g30(.a(new_n58_), .b(new_n39_), .c(x09), .d(new_n38_), .O(new_n59_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n39_), .c(x09), .d(new_n38_), .O(new_n66_));
  ...
  oai22  g45(.a(new_n73_), .b(new_n55_), .c(new_n72_), .d(new_n69_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n39_), .c(new_n46_), .O(new_n75_));
