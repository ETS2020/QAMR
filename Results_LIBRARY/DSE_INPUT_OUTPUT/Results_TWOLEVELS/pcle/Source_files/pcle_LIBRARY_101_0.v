...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(x17), .c(new_n31_), .d(x09), .O(new_n46_));
  oai22  g18(.a(new_n46_), .b(x08), .c(new_n40_), .d(new_n44_), .O(z2));
  inv1   g19(.a(x17), .O(new_n48_));
  ...
  nand3  g25(.a(new_n53_), .b(x17), .c(new_n52_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n51_), .c(new_n49_), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n30_), .c(new_n48_), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n61_), .c(new_n48_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n65_));
  oai21  g37(.a(new_n40_), .b(new_n59_), .c(new_n65_), .O(z4));
  nand2  g38(.a(x14), .b(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n50_), .c(x15), .O(new_n68_));
  inv1   g40(.a(x15), .O(new_n69_));
  nand3  g41(.a(x17), .b(new_n69_), .c(x14), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n60_), .c(new_n68_), .O(new_n71_));
  ...
  nor2   g52(.a(new_n48_), .b(x16), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n78_), .c(new_n49_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n30_), .c(new_n48_), .O(new_n84_));
  ...
  nand3  g61(.a(new_n89_), .b(x12), .c(x11), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x17), .c(new_n31_), .d(x09), .O(new_n91_));
  oai22  g63(.a(new_n91_), .b(x08), .c(new_n40_), .d(new_n87_), .O(z7));
  inv1   g64(.a(x07), .O(new_n93_));
  nand3  g65(.a(x16), .b(x15), .c(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n60_), .c(x18), .O(new_n95_));
  nand3  g67(.a(new_n80_), .b(new_n29_), .c(x16), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n60_), .c(new_n95_), .O(new_n97_));
