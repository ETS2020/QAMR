...
module FAU ( 
  ...
  nand3  g29(.a(new_n57_), .b(x09), .c(new_n29_), .O(new_n58_));
  ...
  oai22  g36(.a(new_n64_), .b(new_n31_), .c(new_n63_), .d(new_n61_), .O(new_n65_));
  ...
  nor2   g57(.a(new_n70_), .b(new_n61_), .O(new_n86_));
