...
module FAU ( 
  ...
  aoi21  g13(.a(x09), .b(x07), .c(new_n41_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(x00), .O(new_n43_));
  nor2   g15(.a(x11), .b(x10), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(x09), .c(new_n41_), .d(new_n29_), .O(new_n45_));
  ...
  aoi21  g30(.a(new_n58_), .b(new_n41_), .c(x07), .O(new_n59_));
  nand2  g31(.a(x08), .b(x02), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(new_n30_), .c(new_n60_), .O(z3));
  nand2  g33(.a(new_n31_), .b(x14), .O(new_n62_));
  and2   g34(.a(x12), .b(x11), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n33_), .c(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(x10), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n41_), .c(x07), .O(new_n66_));
  nand2  g38(.a(x08), .b(x03), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n30_), .c(new_n67_), .O(z4));
  nand4  g40(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x15), .O(new_n70_));
  nand4  g42(.a(new_n63_), .b(new_n34_), .c(x14), .d(x13), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(x10), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n41_), .c(x07), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n30_), .c(new_n74_), .O(z5));
  ...
  nand4  g53(.a(new_n81_), .b(new_n47_), .c(x09), .d(new_n41_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(x07), .c(new_n76_), .O(z6));
  ...
  nand4  g60(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n41_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x07), .c(new_n84_), .O(z7));
  ...
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n37_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n92_), .c(x10), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x09), .c(new_n41_), .d(new_n29_), .O(new_n97_));
  nand3  g69(.a(new_n30_), .b(x08), .c(x07), .O(new_n98_));
