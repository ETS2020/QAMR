...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(new_n43_), .O(new_n46_));
  inv1   g18(.a(x12), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(x11), .O(new_n48_));
  ...
  nand2  g28(.a(x13), .b(new_n43_), .O(new_n57_));
  aoi21  g29(.a(new_n48_), .b(new_n57_), .c(new_n56_), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n29_), .c(new_n55_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x02), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(x10), .c(new_n60_), .O(z3));
  nand2  g33(.a(new_n30_), .b(x14), .O(new_n62_));
  inv1   g34(.a(x14), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(x12), .c(x11), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n56_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n29_), .c(new_n55_), .O(new_n66_));
  ...
  nand3  g43(.a(new_n31_), .b(new_n71_), .c(x14), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n70_), .c(new_n56_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n29_), .c(new_n55_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x04), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(x10), .c(new_n75_), .O(z5));
  inv1   g48(.a(x05), .O(new_n77_));
  oai21  g49(.a(new_n35_), .b(new_n30_), .c(x16), .O(new_n78_));
  nand3  g50(.a(new_n32_), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n30_), .c(new_n78_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(x13), .c(new_n42_), .d(x09), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(x08), .c(new_n41_), .d(new_n77_), .O(z6));
  inv1   g54(.a(x06), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n30_), .c(x17), .O(new_n85_));
  nand3  g57(.a(new_n33_), .b(x16), .c(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n69_), .c(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x13), .c(new_n42_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n41_), .d(new_n83_), .O(z7));
  inv1   g61(.a(new_n69_), .O(new_n90_));
  nand2  g62(.a(new_n32_), .b(x13), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(x17), .d(x15), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x18), .O(new_n93_));
  nor2   g65(.a(new_n32_), .b(new_n71_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n90_), .c(new_n34_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(new_n56_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n29_), .c(new_n55_), .O(new_n97_));
