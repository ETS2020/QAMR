...
module FAU ( 
  ...
  nand4  g19(.a(new_n47_), .b(x17), .c(new_n31_), .d(x09), .O(new_n48_));
  ...
  nand4  g24(.a(x17), .b(new_n52_), .c(x12), .d(x11), .O(new_n53_));
  aoi21  g25(.a(new_n53_), .b(new_n51_), .c(new_n40_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n30_), .c(new_n39_), .O(new_n55_));
  ...
  nor2   g52(.a(new_n39_), .b(x16), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n60_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n79_), .c(new_n40_), .O(new_n83_));
  ...
  oai22  g63(.a(new_n91_), .b(x08), .c(new_n46_), .d(new_n87_), .O(z7));
  ...
  oai22  g70(.a(new_n98_), .b(x08), .c(new_n46_), .d(new_n93_), .O(z8));
endmodule
