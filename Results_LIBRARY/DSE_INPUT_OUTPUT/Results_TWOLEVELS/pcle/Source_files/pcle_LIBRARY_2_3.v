...
module FAU ( 
  ...
  aoi21  g28(.a(x08), .b(x02), .c(new_n56_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n55_), .O(z3));
  ...
  oai22  g34(.a(new_n62_), .b(new_n51_), .c(new_n61_), .d(new_n59_), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n64_));
  aoi21  g36(.a(x08), .b(x03), .c(new_n56_), .O(new_n65_));
  ...
  oai21  g43(.a(new_n71_), .b(new_n51_), .c(new_n69_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n73_));
  oai21  g45(.a(new_n40_), .b(new_n67_), .c(new_n73_), .O(z5));
  inv1   g46(.a(x05), .O(new_n75_));
  nand3  g47(.a(x15), .b(x14), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n51_), .c(x16), .O(new_n77_));
  ...
  oai21  g53(.a(new_n40_), .b(new_n75_), .c(new_n81_), .O(z6));
  nand2  g54(.a(new_n52_), .b(new_n42_), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  inv1   g56(.a(new_n68_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n83_), .c(new_n31_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x16), .O(new_n88_));
  nand3  g60(.a(x16), .b(x15), .c(x14), .O(new_n89_));
  inv1   g61(.a(new_n89_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n61_), .c(new_n84_), .O(new_n91_));
  ...
  nand4  g66(.a(new_n85_), .b(new_n29_), .c(x17), .d(x15), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n83_), .c(new_n31_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x16), .O(new_n97_));
  nand4  g69(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n98_));
  inv1   g70(.a(new_n98_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n61_), .c(new_n29_), .O(new_n100_));
