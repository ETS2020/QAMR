...
module FAU ( 
  ...
  nand3  g16(.a(new_n44_), .b(new_n32_), .c(x09), .O(new_n45_));
  ...
  aoi21  g26(.a(new_n54_), .b(x09), .c(new_n39_), .O(new_n55_));
  ...
  aoi21  g33(.a(new_n61_), .b(x09), .c(new_n39_), .O(new_n62_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n39_), .c(new_n71_), .O(z5));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n74_), .c(x10), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(x09), .c(new_n39_), .O(new_n79_));
  ...
  aoi21  g58(.a(new_n86_), .b(x09), .c(new_n39_), .O(new_n87_));
  ...
  aoi21  g65(.a(new_n93_), .b(new_n91_), .c(x10), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(x09), .c(new_n39_), .O(new_n95_));
