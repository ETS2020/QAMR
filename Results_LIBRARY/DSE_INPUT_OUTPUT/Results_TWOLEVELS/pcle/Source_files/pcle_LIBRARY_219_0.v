...
module FAU ( 
  ...
  oai21  g24(.a(new_n52_), .b(new_n38_), .c(new_n31_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n38_), .c(new_n31_), .O(new_n61_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n48_), .c(new_n66_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  oai21  g42(.a(new_n44_), .b(new_n64_), .c(new_n70_), .O(z5));
  ...
  oai21  g50(.a(new_n44_), .b(new_n72_), .c(new_n78_), .O(z6));
  ...
  oai21  g58(.a(new_n44_), .b(new_n80_), .c(new_n86_), .O(z7));
  nand4  g59(.a(x17), .b(x13), .c(x12), .d(x11), .O(new_n88_));
  aoi21  g60(.a(new_n81_), .b(x09), .c(new_n88_), .O(new_n89_));
  nand4  g61(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n65_), .c(new_n89_), .d(new_n29_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n30_), .c(new_n38_), .O(new_n92_));
