...
module FAU ( 
  ...
  aoi21  g16(.a(x13), .b(new_n44_), .c(new_n31_), .O(new_n45_));
  ...
  nand4  g21(.a(new_n49_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n50_));
  aoi22  g22(.a(x13), .b(new_n44_), .c(x08), .d(x01), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n50_), .O(z2));
  nand2  g24(.a(new_n45_), .b(x02), .O(new_n53_));
  xor2a  g25(.a(x13), .b(x12), .O(new_n54_));
  nand4  g26(.a(new_n54_), .b(x11), .c(new_n30_), .d(x09), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(x08), .c(new_n53_), .O(z3));
  nand3  g28(.a(new_n36_), .b(x12), .c(new_n30_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n32_), .c(x11), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(x13), .O(new_n59_));
  nand2  g31(.a(x13), .b(x12), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(new_n61_));
  nor2   g33(.a(new_n61_), .b(new_n36_), .O(new_n62_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n66_), .c(x11), .O(new_n68_));
  ...
  aoi21  g72(.a(new_n100_), .b(new_n71_), .c(new_n40_), .O(new_n101_));
