...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n93_, new_n94_;
  nor2   g00(.a(x09), .b(x05), .O(new_n29_));
  ...
  nand4  g31(.a(new_n59_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n60_));
  aoi21  g32(.a(x08), .b(x03), .c(new_n29_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(z4));
  nor2   g34(.a(new_n29_), .b(new_n31_), .O(new_n63_));
  ...
  nand2  g50(.a(new_n63_), .b(x06), .O(new_n79_));
  ...
  nand2  g58(.a(new_n63_), .b(x07), .O(new_n87_));
