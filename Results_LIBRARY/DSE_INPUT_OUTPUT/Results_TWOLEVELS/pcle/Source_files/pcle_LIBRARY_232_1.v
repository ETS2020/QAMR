...
module FAU ( 
  ...
  oai21  g27(.a(new_n55_), .b(new_n37_), .c(x14), .O(new_n56_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n77_));
  nand2  g49(.a(x08), .b(x05), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z6));
  aoi21  g51(.a(x15), .b(x14), .c(x10), .O(new_n80_));
  nand4  g52(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n80_), .c(x17), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  inv1   g55(.a(new_n73_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n32_), .c(new_n83_), .d(x16), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n82_), .c(new_n54_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(x10), .c(new_n45_), .O(new_n87_));
