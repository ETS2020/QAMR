...
module FAU ( 
  ...
  aoi21  g33(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(x10), .c(new_n44_), .O(new_n63_));
  ...
  inv1   g47(.a(new_n59_), .O(new_n76_));
  nor2   g48(.a(x16), .b(new_n33_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n76_), .c(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(new_n49_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(x10), .c(new_n44_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(z6));
  and2   g54(.a(x16), .b(x15), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n73_), .c(new_n76_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(x17), .O(new_n85_));
  nand4  g57(.a(new_n76_), .b(new_n34_), .c(new_n35_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n85_), .c(new_n49_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x10), .c(new_n44_), .O(new_n88_));
  ...
  nand4  g64(.a(new_n83_), .b(new_n67_), .c(new_n36_), .d(x17), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n92_), .c(new_n49_), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(x10), .c(new_n44_), .O(new_n95_));
