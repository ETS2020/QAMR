...
module FAU ( 
  ...
  aoi21  g14(.a(new_n42_), .b(x06), .c(new_n41_), .O(new_n43_));
  ...
  oai21  g22(.a(new_n50_), .b(x06), .c(new_n48_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n41_), .c(x06), .O(new_n57_));
  ...
  oai21  g43(.a(new_n71_), .b(x06), .c(new_n66_), .O(z5));
  aoi21  g44(.a(x14), .b(x13), .c(x06), .O(new_n73_));
  nand3  g45(.a(x15), .b(x12), .c(x11), .O(new_n74_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(new_n30_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n41_), .c(x06), .O(new_n80_));
  ...
  nand3  g59(.a(x10), .b(x08), .c(x06), .O(new_n88_));
  oai21  g60(.a(new_n87_), .b(x06), .c(new_n88_), .O(z7));
  ...
  nor2   g64(.a(new_n76_), .b(new_n34_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n68_), .c(new_n37_), .d(x17), .O(new_n94_));
