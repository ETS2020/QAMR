...
module FAU ( 
  ...
  nand3  g28(.a(new_n50_), .b(new_n33_), .c(x13), .O(new_n57_));
  ...
  nand2  g59(.a(new_n40_), .b(x07), .O(new_n88_));
  nand4  g60(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n73_), .c(x18), .O(new_n90_));
  inv1   g62(.a(new_n63_), .O(new_n91_));
  nor2   g63(.a(new_n74_), .b(new_n34_), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n82_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n50_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n96_));
