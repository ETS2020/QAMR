...
module FAU ( 
  ...
  aoi21  g19(.a(new_n48_), .b(new_n43_), .c(x17), .O(new_n49_));
  ...
  aoi21  g28(.a(new_n57_), .b(new_n54_), .c(x17), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n39_), .c(x09), .d(new_n43_), .O(new_n59_));
  oai21  g30(.a(new_n32_), .b(new_n52_), .c(new_n59_), .O(z4));
  nand2  g31(.a(new_n31_), .b(new_n46_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n56_), .c(x14), .O(new_n62_));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n43_), .c(x17), .O(new_n67_));
  nand2  g38(.a(x08), .b(x04), .O(new_n68_));
  oai21  g39(.a(new_n67_), .b(x10), .c(new_n68_), .O(z5));
  nand4  g40(.a(new_n61_), .b(new_n56_), .c(x15), .d(x14), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(x16), .O(new_n71_));
  inv1   g42(.a(new_n53_), .O(new_n72_));
  nor2   g43(.a(x16), .b(new_n64_), .O(new_n73_));
  nand3  g44(.a(new_n73_), .b(new_n72_), .c(x14), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(new_n71_), .c(new_n33_), .O(new_n75_));
  aoi21  g46(.a(new_n75_), .b(new_n43_), .c(x17), .O(new_n76_));
  nand2  g47(.a(x08), .b(x05), .O(new_n77_));
  oai21  g48(.a(new_n76_), .b(x10), .c(new_n77_), .O(z6));
  inv1   g49(.a(x06), .O(new_n79_));
  nand3  g50(.a(new_n56_), .b(new_n34_), .c(new_n39_), .O(new_n80_));
  nor2   g51(.a(new_n55_), .b(new_n46_), .O(new_n81_));
  nand4  g52(.a(new_n81_), .b(new_n31_), .c(x16), .d(x15), .O(new_n82_));
  oai22  g53(.a(new_n82_), .b(new_n80_), .c(new_n32_), .d(new_n79_), .O(z7));
  inv1   g54(.a(x07), .O(new_n84_));
  nand4  g55(.a(new_n34_), .b(x18), .c(new_n31_), .d(new_n39_), .O(new_n85_));
  oai21  g56(.a(new_n32_), .b(new_n84_), .c(new_n85_), .O(z8));
  zero   g57(.O(z0));
endmodule
