...
module FAU ( 
  ...
  aoi21  g09(.a(new_n37_), .b(x09), .c(x08), .O(z0));
  inv1   g10(.a(x08), .O(new_n39_));
  oai21  g11(.a(x11), .b(x10), .c(x09), .O(new_n40_));
  ...
  oai21  g19(.a(new_n46_), .b(x08), .c(new_n47_), .O(z2));
  nand2  g20(.a(x12), .b(x11), .O(new_n49_));
  inv1   g21(.a(new_n49_), .O(new_n50_));
  nand3  g22(.a(new_n31_), .b(x12), .c(x11), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(new_n31_), .c(new_n51_), .O(new_n52_));
  ...
  nand3  g30(.a(new_n50_), .b(new_n33_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n58_), .c(x10), .O(new_n60_));
  ...
  nand4  g39(.a(new_n67_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  nand2  g42(.a(new_n33_), .b(x09), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n50_), .c(x15), .d(x13), .O(new_n72_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n74_), .c(x15), .d(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n73_), .c(x10), .O(new_n78_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n75_), .c(new_n83_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z7));
  nand2  g62(.a(new_n74_), .b(x09), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n76_), .c(new_n85_), .d(x17), .O(new_n92_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n44_), .c(new_n39_), .O(new_n97_));
