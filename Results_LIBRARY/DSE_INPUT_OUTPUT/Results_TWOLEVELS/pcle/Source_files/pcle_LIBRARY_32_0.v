...
module FAU ( 
  ...
  aoi21  g08(.a(new_n36_), .b(x00), .c(x10), .O(z0));
  inv1   g09(.a(x00), .O(new_n38_));
  inv1   g10(.a(x08), .O(new_n39_));
  inv1   g11(.a(x11), .O(new_n40_));
  aoi21  g12(.a(new_n40_), .b(x09), .c(new_n38_), .O(new_n41_));
  oai22  g13(.a(new_n41_), .b(x10), .c(new_n39_), .d(new_n38_), .O(z1));
  inv1   g14(.a(x01), .O(new_n43_));
  oai21  g15(.a(x10), .b(x00), .c(x08), .O(new_n44_));
  inv1   g16(.a(x10), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(new_n45_), .c(x09), .d(new_n39_), .O(new_n47_));
  oai22  g19(.a(new_n47_), .b(new_n38_), .c(new_n44_), .d(new_n43_), .O(z2));
  ...
  nand4  g26(.a(new_n54_), .b(x09), .c(new_n39_), .d(x00), .O(new_n55_));
  oai21  g27(.a(new_n44_), .b(new_n49_), .c(new_n55_), .O(z3));
  inv1   g28(.a(x12), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x00), .O(new_n58_));
  ...
  nand3  g39(.a(new_n67_), .b(new_n58_), .c(x11), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x15), .O(new_n69_));
  nand4  g41(.a(new_n61_), .b(new_n33_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(new_n29_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n39_), .c(new_n38_), .O(new_n72_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n45_), .c(x09), .d(new_n39_), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(new_n38_), .c(new_n44_), .d(new_n75_), .O(z6));
  ...
  nand4  g60(.a(new_n88_), .b(new_n45_), .c(x09), .d(new_n39_), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(new_n38_), .c(new_n44_), .d(new_n83_), .O(z7));
  ...
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n67_), .d(new_n61_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(x10), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n39_), .d(x00), .O(new_n98_));
  oai21  g70(.a(new_n44_), .b(new_n91_), .c(new_n98_), .O(z8));
endmodule
