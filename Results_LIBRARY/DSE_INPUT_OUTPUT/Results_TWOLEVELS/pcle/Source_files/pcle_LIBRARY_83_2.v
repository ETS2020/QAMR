...
module FAU ( 
  ...
  oai21  g37(.a(new_n65_), .b(new_n49_), .c(new_n64_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n67_));
  nand2  g39(.a(new_n46_), .b(x04), .O(new_n68_));
  ...
  nor2   g62(.a(new_n74_), .b(new_n34_), .O(new_n91_));
  ...
  nand3  g66(.a(new_n94_), .b(new_n39_), .c(x09), .O(new_n95_));
