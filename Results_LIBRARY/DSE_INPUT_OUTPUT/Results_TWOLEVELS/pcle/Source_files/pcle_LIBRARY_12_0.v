...
module FAU ( 
  ...
  oai22  g48(.a(new_n76_), .b(new_n58_), .c(new_n75_), .d(new_n73_), .O(new_n77_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n58_), .c(new_n83_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n88_));
  oai21  g60(.a(new_n39_), .b(new_n81_), .c(new_n88_), .O(z7));
  nand2  g61(.a(new_n73_), .b(x09), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n85_), .c(new_n59_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x18), .O(new_n92_));
  nor2   g64(.a(new_n73_), .b(new_n64_), .O(new_n93_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n92_), .c(x08), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n43_), .c(new_n31_), .O(new_n98_));
