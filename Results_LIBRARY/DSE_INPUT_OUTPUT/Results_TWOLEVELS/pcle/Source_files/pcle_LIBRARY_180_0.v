...
module FAU ( 
  ...
  aoi21  g20(.a(new_n40_), .b(new_n48_), .c(new_n41_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(x01), .O(new_n50_));
  xor2a  g22(.a(x12), .b(x11), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n40_), .c(x09), .d(new_n41_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(new_n48_), .c(new_n50_), .O(z2));
  ...
  nand4  g31(.a(new_n59_), .b(x09), .c(new_n41_), .d(x04), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n54_), .O(z3));
  nand2  g33(.a(new_n49_), .b(x03), .O(new_n62_));
  ...
  nand4  g38(.a(new_n66_), .b(x09), .c(new_n41_), .d(x04), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n62_), .O(z4));
  nand2  g40(.a(x13), .b(x12), .O(new_n69_));
  nand2  g41(.a(x14), .b(x11), .O(new_n70_));
  aoi21  g42(.a(new_n69_), .b(x04), .c(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n33_), .b(x14), .c(x13), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(new_n55_), .c(new_n71_), .d(new_n33_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(x09), .c(new_n48_), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(x10), .c(new_n41_), .d(new_n48_), .O(z5));
  nand2  g47(.a(new_n49_), .b(x05), .O(new_n76_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n48_), .c(new_n76_), .O(z6));
  inv1   g55(.a(new_n30_), .O(new_n84_));
  nand2  g56(.a(new_n33_), .b(x04), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n84_), .c(x16), .d(x14), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x17), .O(new_n87_));
  nand4  g59(.a(new_n34_), .b(new_n84_), .c(new_n35_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n87_), .c(new_n29_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n41_), .c(new_n48_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z7));
  nand2  g64(.a(new_n49_), .b(x07), .O(new_n93_));
  nand3  g65(.a(new_n34_), .b(x17), .c(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n30_), .c(x18), .O(new_n95_));
  nand4  g67(.a(new_n36_), .b(x17), .c(x16), .d(x15), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n64_), .c(x14), .d(x13), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n95_), .c(x10), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(x09), .c(new_n41_), .d(x04), .O(new_n100_));
