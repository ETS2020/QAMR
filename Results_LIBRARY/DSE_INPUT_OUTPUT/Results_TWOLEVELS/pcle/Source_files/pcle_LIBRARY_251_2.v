...
module FAU ( 
  ...
  or2    g25(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand3  g26(.a(new_n52_), .b(x12), .c(x11), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n54_), .c(x10), .O(new_n56_));
  ...
  nand3  g33(.a(new_n53_), .b(new_n30_), .c(x13), .O(new_n62_));
  ...
  aoi21  g38(.a(x13), .b(x12), .c(x06), .O(new_n67_));
  nand2  g39(.a(x14), .b(x11), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n67_), .c(x15), .O(new_n69_));
  inv1   g41(.a(x15), .O(new_n70_));
  nand4  g42(.a(new_n53_), .b(new_n70_), .c(x14), .d(x13), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(new_n72_));
  ...
  nand3  g47(.a(x15), .b(x14), .c(x11), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n67_), .c(x16), .O(new_n77_));
  inv1   g49(.a(x16), .O(new_n78_));
  inv1   g50(.a(new_n60_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n78_), .c(x15), .d(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n66_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n32_), .c(x06), .O(new_n82_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n60_), .c(new_n86_), .O(new_n90_));
  ...
  nand2  g65(.a(new_n78_), .b(new_n31_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n88_), .c(new_n79_), .d(x17), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x18), .O(new_n96_));
  nor2   g68(.a(new_n78_), .b(new_n70_), .O(new_n97_));
  nor2   g69(.a(new_n30_), .b(new_n52_), .O(new_n98_));
  nor2   g70(.a(x18), .b(new_n87_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n53_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n96_), .c(new_n66_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n32_), .c(x06), .O(new_n102_));
