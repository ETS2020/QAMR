...
module FAU ( 
  ...
  nand2  g45(.a(new_n32_), .b(new_n45_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(x08), .c(x05), .O(new_n75_));
  ...
  oai21  g53(.a(new_n81_), .b(new_n45_), .c(new_n75_), .O(z6));
  ...
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(new_n49_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n31_), .c(new_n45_), .O(new_n89_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(new_n49_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n31_), .c(new_n45_), .O(new_n98_));
