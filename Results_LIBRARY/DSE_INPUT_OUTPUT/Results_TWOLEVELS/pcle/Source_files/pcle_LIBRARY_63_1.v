...
module FAU ( 
  ...
  nor2   g19(.a(new_n30_), .b(new_n39_), .O(new_n48_));
  nand3  g20(.a(new_n31_), .b(x12), .c(x11), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(new_n31_), .c(new_n49_), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n43_), .O(new_n51_));
  ...
  nand4  g29(.a(new_n57_), .b(new_n29_), .c(x09), .d(new_n43_), .O(new_n58_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n29_), .c(x09), .d(new_n43_), .O(new_n66_));
  ...
  inv1   g57(.a(x09), .O(new_n86_));
  nand4  g58(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n54_), .c(x18), .O(new_n88_));
  nor2   g60(.a(x18), .b(new_n78_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n63_), .c(x16), .d(x15), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n86_), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x10), .c(new_n43_), .O(new_n92_));
