...
module FAU ( 
  ...
  oai21  g30(.a(new_n58_), .b(new_n46_), .c(new_n56_), .O(new_n59_));
  ...
  oai22  g38(.a(new_n66_), .b(new_n46_), .c(new_n65_), .d(new_n63_), .O(new_n67_));
