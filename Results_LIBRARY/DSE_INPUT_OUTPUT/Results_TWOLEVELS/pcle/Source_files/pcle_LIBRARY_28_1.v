...
module FAU ( 
  ...
  nand4  g50(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n79_));
  nand2  g51(.a(x16), .b(x11), .O(new_n80_));
  aoi21  g52(.a(new_n79_), .b(new_n31_), .c(new_n80_), .O(new_n81_));
  and2   g53(.a(x15), .b(x14), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n56_), .c(new_n78_), .d(x16), .O(new_n83_));
  ...
  nand3  g59(.a(new_n82_), .b(x17), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n55_), .c(x18), .O(new_n89_));
  nor2   g61(.a(x18), .b(new_n78_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n64_), .c(x16), .d(x15), .O(new_n91_));
