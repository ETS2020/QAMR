...
module FAU ( 
  ...
  oai21  g21(.a(new_n43_), .b(new_n47_), .c(new_n49_), .O(z2));
  ...
  oai21  g32(.a(new_n60_), .b(new_n35_), .c(new_n58_), .O(new_n61_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n35_), .c(new_n66_), .O(new_n69_));
  ...
  nand3  g45(.a(x11), .b(x09), .c(new_n32_), .O(new_n74_));
  nand4  g46(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n74_), .c(new_n29_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  inv1   g49(.a(new_n37_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n36_), .c(new_n73_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n77_), .O(z6));
  nand3  g54(.a(new_n31_), .b(x08), .c(x06), .O(new_n83_));
  ...
  oai21  g63(.a(new_n33_), .b(new_n91_), .c(new_n29_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n73_), .O(new_n93_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n65_), .c(new_n95_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n98_));
  nand2  g70(.a(x08), .b(x07), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n98_), .c(new_n93_), .O(z8));
endmodule
