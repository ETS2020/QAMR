...
module FAU ( 
  ...
  nand4  g17(.a(x12), .b(x11), .c(x09), .d(new_n39_), .O(new_n46_));
  ...
  nand2  g22(.a(x14), .b(x09), .O(new_n51_));
  ...
  nand4  g33(.a(new_n34_), .b(x16), .c(new_n29_), .d(new_n38_), .O(new_n62_));
  oai21  g34(.a(new_n32_), .b(new_n61_), .c(new_n62_), .O(z6));
  inv1   g35(.a(x06), .O(new_n64_));
  nand4  g36(.a(new_n34_), .b(x17), .c(new_n29_), .d(new_n38_), .O(new_n65_));
  oai21  g37(.a(new_n32_), .b(new_n64_), .c(new_n65_), .O(z7));
  nand2  g38(.a(x18), .b(x09), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(x08), .c(new_n29_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n38_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x07), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z8));
endmodule
