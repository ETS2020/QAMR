...
module FAU ( 
  ...
  oai21  g38(.a(new_n66_), .b(new_n48_), .c(x15), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(x14), .c(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n48_), .c(new_n67_), .O(new_n70_));
  ...
  oai22  g54(.a(new_n82_), .b(new_n58_), .c(new_n81_), .d(x11), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(x16), .O(new_n84_));
  nor2   g56(.a(new_n76_), .b(new_n68_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(x14), .c(x13), .d(x12), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(x17), .c(new_n31_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(x09), .c(new_n30_), .O(new_n89_));
  aoi21  g61(.a(x08), .b(x06), .c(new_n54_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  nand2  g63(.a(x18), .b(new_n40_), .O(new_n92_));
  nand4  g64(.a(new_n29_), .b(x17), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n58_), .c(new_n92_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x16), .O(new_n95_));
  nand3  g67(.a(x14), .b(x13), .c(x12), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x17), .c(x16), .d(x15), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(x18), .c(new_n31_), .O(new_n99_));
  nand2  g71(.a(new_n99_), .b(new_n95_), .O(new_n100_));
  nand3  g72(.a(new_n100_), .b(x09), .c(new_n30_), .O(new_n101_));
  aoi21  g73(.a(x08), .b(x07), .c(new_n54_), .O(new_n102_));
