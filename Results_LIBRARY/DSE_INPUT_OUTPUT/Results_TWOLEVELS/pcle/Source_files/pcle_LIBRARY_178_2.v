...
module FAU ( 
  ...
  oai21  g19(.a(new_n39_), .b(x02), .c(x08), .O(new_n48_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n39_), .c(x09), .O(new_n54_));
  ...
  oai22  g30(.a(new_n58_), .b(new_n49_), .c(new_n57_), .d(new_n32_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n60_));
  nor2   g32(.a(new_n39_), .b(new_n29_), .O(new_n61_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n76_));
  nand2  g48(.a(new_n61_), .b(x05), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z6));
  oai21  g50(.a(new_n39_), .b(x06), .c(x08), .O(new_n79_));
  aoi21  g51(.a(x15), .b(x14), .c(x08), .O(new_n80_));
  nand4  g52(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n80_), .c(x17), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n57_), .b(new_n34_), .c(new_n83_), .d(x16), .O(new_n84_));
  ...
  nor2   g61(.a(new_n73_), .b(new_n33_), .O(new_n90_));
  ...
  nand2  g66(.a(new_n61_), .b(x07), .O(new_n95_));
