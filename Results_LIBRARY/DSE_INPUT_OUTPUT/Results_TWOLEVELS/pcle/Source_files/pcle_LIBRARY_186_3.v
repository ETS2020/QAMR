...
module FAU ( 
  ...
  nand2  g25(.a(new_n53_), .b(x08), .O(new_n54_));
  oai21  g26(.a(new_n54_), .b(new_n46_), .c(new_n52_), .O(z3));
  ...
  oai21  g34(.a(new_n54_), .b(new_n56_), .c(new_n62_), .O(z4));
  ...
  oai21  g42(.a(new_n54_), .b(new_n64_), .c(new_n70_), .O(z5));
  ...
  oai21  g50(.a(new_n54_), .b(new_n72_), .c(new_n78_), .O(z6));
  ...
  oai21  g58(.a(new_n54_), .b(new_n80_), .c(new_n86_), .O(z7));
  ...
  oai21  g66(.a(new_n54_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
