...
module FAU ( 
  ...
  nand4  g43(.a(new_n55_), .b(x17), .c(new_n32_), .d(new_n29_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z7));
  nand2  g45(.a(x18), .b(x09), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(x08), .c(new_n32_), .O(new_n75_));
