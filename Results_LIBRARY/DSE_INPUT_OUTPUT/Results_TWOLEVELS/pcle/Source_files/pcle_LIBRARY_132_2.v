...
module FAU ( 
  ...
  nor2   g27(.a(new_n30_), .b(new_n45_), .O(new_n56_));
  ...
  nand4  g34(.a(new_n62_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n63_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n70_));
  ...
  nand2  g51(.a(new_n56_), .b(x06), .O(new_n80_));
