...
module FAU ( 
  ...
  inv1   g27(.a(new_n40_), .O(new_n56_));
  ...
  oai21  g35(.a(new_n63_), .b(new_n50_), .c(new_n61_), .O(new_n64_));
  ...
  oai22  g43(.a(new_n71_), .b(new_n50_), .c(new_n70_), .d(new_n68_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n73_));
  oai21  g45(.a(new_n42_), .b(new_n67_), .c(new_n73_), .O(z5));
  ...
  aoi21  g60(.a(x08), .b(x06), .c(new_n56_), .O(new_n89_));
