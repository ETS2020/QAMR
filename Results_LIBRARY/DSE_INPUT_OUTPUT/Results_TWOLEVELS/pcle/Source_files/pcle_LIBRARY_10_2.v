...
module FAU ( 
  ...
  nor2   g14(.a(x08), .b(x04), .O(new_n43_));
  ...
  oai21  g32(.a(x12), .b(x04), .c(x13), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n42_), .c(x14), .O(new_n62_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n32_), .c(x04), .O(new_n66_));
  nand2  g38(.a(x08), .b(x03), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(x10), .c(new_n67_), .O(z4));
  oai21  g40(.a(new_n33_), .b(x08), .c(x04), .O(new_n69_));
  oai21  g41(.a(x12), .b(x04), .c(x11), .O(new_n70_));
  nor2   g42(.a(new_n30_), .b(new_n55_), .O(new_n71_));
  inv1   g43(.a(new_n71_), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n70_), .c(x15), .O(new_n73_));
  inv1   g45(.a(x15), .O(new_n74_));
  nand4  g46(.a(new_n63_), .b(new_n74_), .c(x14), .d(x13), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n69_), .O(z5));
  inv1   g50(.a(x05), .O(new_n79_));
  nand3  g51(.a(x15), .b(x14), .c(x13), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n53_), .c(x16), .O(new_n81_));
  ...
  oai22  g58(.a(new_n86_), .b(x04), .c(new_n41_), .d(new_n79_), .O(z6));
  ...
  nand4  g65(.a(new_n93_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(x04), .c(new_n41_), .d(new_n88_), .O(z7));
  nand2  g67(.a(x16), .b(x15), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n31_), .O(new_n97_));
  nand3  g69(.a(x17), .b(x14), .c(x13), .O(new_n98_));
  inv1   g70(.a(new_n98_), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n97_), .c(new_n63_), .O(new_n100_));
  nand2  g72(.a(new_n100_), .b(x18), .O(new_n101_));
  inv1   g73(.a(new_n96_), .O(new_n102_));
  nor2   g74(.a(x18), .b(new_n91_), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(new_n102_), .c(new_n71_), .d(new_n63_), .O(new_n104_));
  aoi21  g76(.a(new_n104_), .b(new_n101_), .c(new_n60_), .O(new_n105_));
  aoi21  g77(.a(new_n105_), .b(new_n32_), .c(x04), .O(new_n106_));
