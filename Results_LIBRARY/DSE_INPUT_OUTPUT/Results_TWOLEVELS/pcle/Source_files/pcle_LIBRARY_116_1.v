...
module FAU ( 
  ...
  inv1   g59(.a(new_n55_), .O(new_n88_));
  nand2  g60(.a(new_n73_), .b(new_n31_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n82_), .c(new_n88_), .d(x17), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nor2   g63(.a(new_n73_), .b(new_n63_), .O(new_n92_));
