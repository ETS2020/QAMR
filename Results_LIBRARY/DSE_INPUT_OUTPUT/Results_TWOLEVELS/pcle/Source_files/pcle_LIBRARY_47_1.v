...
module FAU ( 
  ...
  nor2   g01(.a(new_n29_), .b(x06), .O(new_n30_));
  ...
  oai22  g40(.a(new_n68_), .b(new_n33_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n64_), .O(z5));
  nand2  g43(.a(new_n40_), .b(x05), .O(new_n72_));
  oai21  g44(.a(new_n35_), .b(new_n33_), .c(x16), .O(new_n73_));
