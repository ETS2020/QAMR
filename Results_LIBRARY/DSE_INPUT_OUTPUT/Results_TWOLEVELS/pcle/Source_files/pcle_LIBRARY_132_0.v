...
module FAU ( 
  ...
  nand2  g19(.a(new_n47_), .b(x18), .O(new_n48_));
  ...
  oai21  g33(.a(x18), .b(x10), .c(x08), .O(new_n62_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n64_), .c(new_n52_), .O(new_n67_));
  ...
  nand4  g42(.a(new_n31_), .b(new_n32_), .c(x14), .d(x13), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n53_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n29_), .c(new_n52_), .O(new_n73_));
  ...
  nand3  g50(.a(new_n33_), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n63_), .c(new_n78_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(x18), .c(new_n39_), .d(x09), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(x08), .c(new_n62_), .d(new_n76_), .O(z6));
  inv1   g54(.a(x06), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n63_), .c(x17), .O(new_n85_));
  nand4  g57(.a(new_n34_), .b(x16), .c(x15), .d(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n63_), .c(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x18), .c(new_n39_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n62_), .d(new_n83_), .O(z7));
  nand2  g61(.a(x17), .b(x16), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x15), .O(new_n92_));
  nor2   g64(.a(new_n52_), .b(x14), .O(new_n93_));
  aoi21  g65(.a(new_n92_), .b(x14), .c(new_n93_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x13), .c(x12), .d(x11), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(x09), .c(new_n29_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x18), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n39_), .O(new_n98_));
