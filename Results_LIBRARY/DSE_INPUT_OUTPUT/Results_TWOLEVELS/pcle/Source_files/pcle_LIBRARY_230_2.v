...
module FAU ( 
  ...
  nand2  g27(.a(new_n49_), .b(x03), .O(new_n56_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n62_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n81_));
  ...
  oai21  g59(.a(new_n87_), .b(new_n76_), .c(x17), .O(new_n88_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n92_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n57_), .c(x18), .O(new_n97_));
  nor2   g69(.a(new_n78_), .b(new_n65_), .O(new_n98_));
  nor2   g70(.a(x18), .b(new_n89_), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n98_), .c(new_n67_), .O(new_n100_));
  nand2  g72(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand4  g73(.a(new_n101_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n102_));
