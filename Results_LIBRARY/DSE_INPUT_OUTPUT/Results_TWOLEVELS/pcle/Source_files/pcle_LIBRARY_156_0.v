...
module FAU ( 
  ...
  nand3  g14(.a(x16), .b(new_n42_), .c(new_n31_), .O(new_n43_));
  ...
  nand2  g18(.a(new_n46_), .b(x16), .O(new_n47_));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n30_), .c(new_n39_), .O(new_n65_));
  ...
  nand4  g45(.a(new_n73_), .b(x16), .c(new_n31_), .d(x09), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(x08), .c(new_n68_), .O(z5));
  nand2  g47(.a(x16), .b(new_n42_), .O(new_n76_));
  nand2  g48(.a(x16), .b(new_n71_), .O(new_n77_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n30_), .c(new_n39_), .O(new_n81_));
  ...
  nor2   g58(.a(x17), .b(new_n71_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(x14), .O(new_n88_));
  ...
  nand4  g67(.a(new_n29_), .b(x17), .c(x15), .d(x14), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n60_), .c(new_n95_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x16), .c(new_n31_), .d(x09), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(x08), .c(new_n93_), .O(z8));
endmodule
