...
module FAU ( 
  ...
  nand4  g24(.a(new_n52_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n53_));
  nand2  g25(.a(new_n39_), .b(x02), .O(new_n54_));
  ...
  nand4  g31(.a(new_n59_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n60_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n67_));
  nand2  g39(.a(new_n39_), .b(x04), .O(new_n68_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n75_));
  nand2  g47(.a(new_n39_), .b(x05), .O(new_n76_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n83_));
