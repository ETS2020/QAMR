...
module FAU ( 
  ...
  nand3  g28(.a(new_n56_), .b(new_n55_), .c(new_n41_), .O(z3));
  nand3  g29(.a(x13), .b(x12), .c(x11), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(new_n39_), .c(new_n31_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n40_), .O(new_n60_));
  nand3  g32(.a(new_n58_), .b(x14), .c(new_n31_), .O(new_n61_));
  ...
  oai21  g44(.a(new_n42_), .b(new_n66_), .c(new_n72_), .O(z5));
  inv1   g45(.a(x16), .O(new_n74_));
  oai21  g46(.a(new_n39_), .b(new_n74_), .c(new_n31_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n40_), .O(new_n76_));
  nand2  g48(.a(x15), .b(x13), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n50_), .c(x16), .O(new_n78_));
  nand3  g50(.a(new_n74_), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n58_), .c(new_n78_), .O(new_n80_));
