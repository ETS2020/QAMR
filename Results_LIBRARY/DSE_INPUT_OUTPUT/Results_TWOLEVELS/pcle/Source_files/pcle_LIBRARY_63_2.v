...
module FAU ( 
  ...
  oai22  g37(.a(new_n65_), .b(new_n48_), .c(new_n64_), .d(new_n32_), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n72_), .b(new_n29_), .c(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n71_), .b(x15), .c(x14), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(new_n56_), .c(new_n74_), .d(new_n71_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n37_), .c(x09), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n70_), .O(z6));
  oai21  g50(.a(new_n37_), .b(x06), .c(x08), .O(new_n79_));
  inv1   g51(.a(x17), .O(new_n80_));
  nand3  g52(.a(x16), .b(x15), .c(x11), .O(new_n81_));
  aoi21  g53(.a(new_n72_), .b(new_n29_), .c(new_n81_), .O(new_n82_));
  nand4  g54(.a(new_n80_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai22  g55(.a(new_n83_), .b(new_n56_), .c(new_n82_), .d(new_n80_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n37_), .c(x09), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n79_), .O(z7));
  oai21  g58(.a(new_n37_), .b(x07), .c(x08), .O(new_n87_));
