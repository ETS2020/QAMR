...
module FAU ( 
  ...
  aoi21  g13(.a(x09), .b(new_n40_), .c(new_n41_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(x00), .O(new_n43_));
  nor2   g15(.a(x11), .b(x10), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(x09), .c(new_n41_), .d(x07), .O(new_n45_));
  ...
  nand2  g21(.a(new_n49_), .b(x07), .O(new_n50_));
  ...
  aoi21  g30(.a(new_n58_), .b(new_n41_), .c(new_n40_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x02), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(new_n29_), .c(new_n60_), .O(z3));
  ...
  oai21  g39(.a(new_n66_), .b(new_n29_), .c(new_n67_), .O(z4));
  nand4  g40(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x15), .O(new_n70_));
  nand4  g42(.a(new_n63_), .b(new_n33_), .c(x14), .d(x13), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(x10), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n41_), .c(new_n40_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n29_), .c(new_n74_), .O(z5));
  ...
  oai21  g54(.a(new_n82_), .b(new_n40_), .c(new_n76_), .O(z6));
  ...
  oai21  g61(.a(new_n89_), .b(new_n40_), .c(new_n84_), .O(z7));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n30_), .c(x18), .O(new_n92_));
  nand4  g64(.a(new_n36_), .b(x17), .c(x16), .d(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n69_), .c(new_n92_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n47_), .c(x09), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n41_), .c(new_n40_), .O(z8));
endmodule
