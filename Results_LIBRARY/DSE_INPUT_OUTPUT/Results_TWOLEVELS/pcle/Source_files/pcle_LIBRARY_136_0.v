...
module FAU ( 
  ...
  oai21  g32(.a(new_n60_), .b(new_n47_), .c(new_n31_), .O(new_n61_));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n30_), .c(new_n47_), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n30_), .c(new_n47_), .O(new_n77_));
  ...
  oai21  g66(.a(new_n39_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
