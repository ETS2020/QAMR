...
module FAU ( 
  ...
  nand3  g23(.a(new_n35_), .b(x13), .c(new_n29_), .O(new_n52_));
  nand3  g24(.a(new_n37_), .b(x12), .c(x11), .O(new_n53_));
  ...
  oai21  g36(.a(new_n44_), .b(new_n58_), .c(new_n64_), .O(z4));
  ...
  oai21  g60(.a(new_n88_), .b(new_n35_), .c(x17), .O(new_n89_));
  inv1   g61(.a(x17), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n59_), .c(new_n89_), .O(new_n92_));
  ...
  oai21  g68(.a(new_n96_), .b(x08), .c(new_n29_), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n37_), .O(new_n98_));
  nand3  g70(.a(x17), .b(x16), .c(x15), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n69_), .c(x18), .O(new_n100_));
  ...
  nand4  g76(.a(new_n104_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n105_));
