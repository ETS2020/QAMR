...
module FAU ( 
  ...
  nand2  g12(.a(new_n40_), .b(x03), .O(new_n41_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n52_), .O(new_n81_));
  ...
  oai21  g57(.a(x10), .b(x03), .c(x08), .O(new_n86_));
  ...
  oai22  g64(.a(new_n92_), .b(new_n51_), .c(new_n86_), .d(new_n85_), .O(z7));
  ...
  nand4  g72(.a(new_n100_), .b(x09), .c(new_n31_), .d(x03), .O(new_n101_));
  oai21  g73(.a(new_n86_), .b(new_n94_), .c(new_n101_), .O(z8));
endmodule
