...
module FAU ( 
  ...
  nor2   g37(.a(new_n59_), .b(new_n49_), .O(new_n66_));
  inv1   g38(.a(new_n66_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n65_), .c(x15), .O(new_n68_));
  inv1   g40(.a(x15), .O(new_n69_));
  nand4  g41(.a(new_n51_), .b(new_n69_), .c(x14), .d(x13), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n31_), .c(x09), .O(new_n72_));
  ...
  nor2   g62(.a(new_n77_), .b(new_n69_), .O(new_n91_));
  nand3  g63(.a(x17), .b(x14), .c(x13), .O(new_n92_));
  nor2   g64(.a(new_n92_), .b(new_n50_), .O(new_n93_));
  oai21  g65(.a(new_n91_), .b(x08), .c(new_n93_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x18), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n85_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n91_), .c(new_n66_), .d(new_n51_), .O(new_n97_));
