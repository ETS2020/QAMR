...
module FAU ( 
  ...
  nand3  g32(.a(new_n51_), .b(new_n60_), .c(x13), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n59_), .c(x08), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n38_), .c(new_n31_), .O(new_n63_));
  ...
  oai21  g44(.a(new_n48_), .b(new_n66_), .c(new_n72_), .O(z5));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n30_), .c(new_n38_), .O(new_n80_));
  ...
  oai21  g69(.a(new_n48_), .b(new_n91_), .c(new_n97_), .O(z8));
endmodule
