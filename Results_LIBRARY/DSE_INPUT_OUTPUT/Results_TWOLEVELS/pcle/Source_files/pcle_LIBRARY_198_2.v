...
module FAU ( 
  ...
  aoi21  g12(.a(x16), .b(x10), .c(x11), .O(new_n41_));
  ...
  nand2  g22(.a(new_n34_), .b(x13), .O(new_n51_));
  ...
  nand2  g51(.a(new_n45_), .b(x06), .O(new_n80_));
  ...
  oai21  g60(.a(new_n33_), .b(new_n88_), .c(new_n29_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n75_), .O(new_n90_));
  ...
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n90_), .O(z8));
endmodule
