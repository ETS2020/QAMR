...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(x13), .c(new_n31_), .d(x09), .O(new_n46_));
  oai22  g18(.a(new_n46_), .b(x08), .c(new_n40_), .d(new_n44_), .O(z2));
  nand2  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(x13), .c(x09), .d(new_n30_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(x13), .O(new_n50_));
  nand2  g22(.a(new_n50_), .b(new_n31_), .O(new_n51_));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(new_n55_), .O(new_n60_));
  ...
  inv1   g38(.a(new_n56_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n66_), .c(x14), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n65_), .c(new_n63_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n30_), .c(new_n55_), .O(new_n70_));
  ...
  nand4  g47(.a(new_n67_), .b(new_n75_), .c(x15), .d(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n74_), .c(new_n63_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n30_), .c(new_n55_), .O(new_n78_));
  ...
  nand4  g58(.a(new_n86_), .b(x13), .c(new_n31_), .d(x09), .O(new_n87_));
  oai22  g59(.a(new_n87_), .b(x08), .c(new_n40_), .d(new_n81_), .O(z7));
