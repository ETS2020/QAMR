...
module FAU ( 
  ...
  oai21  g35(.a(new_n45_), .b(new_n57_), .c(new_n63_), .O(z4));
  ...
  inv1   g42(.a(new_n39_), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x04), .c(new_n71_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n70_), .O(z5));
  ...
  oai21  g51(.a(new_n30_), .b(new_n38_), .c(new_n79_), .O(z6));
  ...
  oai21  g59(.a(new_n45_), .b(new_n81_), .c(new_n87_), .O(z7));
  ...
  aoi21  g66(.a(x08), .b(x07), .c(new_n71_), .O(new_n95_));
