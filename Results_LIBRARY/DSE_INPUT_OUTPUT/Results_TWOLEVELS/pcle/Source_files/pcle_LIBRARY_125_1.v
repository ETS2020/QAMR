...
module FAU ( 
  ...
  nand2  g03(.a(x03), .b(new_n31_), .O(new_n32_));
  ...
  oai21  g16(.a(x08), .b(x03), .c(new_n31_), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n44_), .c(new_n29_), .d(x09), .O(new_n46_));
  oai21  g18(.a(new_n40_), .b(new_n31_), .c(new_n46_), .O(z2));
  inv1   g19(.a(new_n32_), .O(new_n48_));
  inv1   g20(.a(x13), .O(new_n49_));
  nor2   g21(.a(new_n30_), .b(new_n41_), .O(new_n50_));
  nand3  g22(.a(new_n49_), .b(x12), .c(x11), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(new_n49_), .c(new_n51_), .O(new_n52_));
  nand4  g24(.a(new_n52_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n53_));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(z7));
