...
module FAU ( 
  ...
  nand2  g03(.a(x07), .b(new_n31_), .O(new_n32_));
  ...
  nand3  g18(.a(new_n46_), .b(new_n45_), .c(new_n32_), .O(z2));
  ...
  aoi21  g33(.a(x08), .b(x03), .c(new_n48_), .O(new_n62_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(z5));
  nor2   g44(.a(new_n67_), .b(new_n58_), .O(new_n73_));
  ...
  oai21  g62(.a(x08), .b(new_n31_), .c(x07), .O(new_n91_));
  nand3  g63(.a(new_n73_), .b(x17), .c(x16), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n56_), .c(x18), .O(new_n93_));
  inv1   g65(.a(x18), .O(new_n94_));
  nand3  g66(.a(new_n82_), .b(new_n94_), .c(x17), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n65_), .c(new_n93_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n97_));
