...
module FAU ( 
  ...
  nand4  g16(.a(new_n44_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n45_));
  ...
  oai21  g24(.a(new_n52_), .b(new_n47_), .c(new_n37_), .O(new_n53_));
  ...
  nand3  g30(.a(new_n58_), .b(new_n31_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(x08), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(new_n47_), .c(new_n37_), .O(new_n61_));
  ...
  oai22  g39(.a(new_n67_), .b(new_n48_), .c(new_n66_), .d(new_n32_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n69_));
  oai21  g41(.a(new_n43_), .b(new_n64_), .c(new_n69_), .O(z5));
  nand2  g42(.a(new_n31_), .b(x09), .O(new_n71_));
  ...
  oai21  g49(.a(new_n77_), .b(new_n47_), .c(new_n37_), .O(new_n78_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n88_));
  oai21  g60(.a(new_n43_), .b(new_n81_), .c(new_n88_), .O(z7));
  nand2  g61(.a(new_n74_), .b(x09), .O(new_n90_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n47_), .c(new_n37_), .O(new_n96_));
