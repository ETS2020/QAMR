...
module FAU ( 
  ...
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(new_n47_), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(x10), .c(new_n42_), .O(new_n61_));
  ...
  nand3  g53(.a(new_n32_), .b(new_n33_), .c(x16), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n56_), .c(new_n81_), .O(new_n83_));
  ...
  inv1   g58(.a(new_n56_), .O(new_n87_));
  nand2  g59(.a(new_n74_), .b(new_n29_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n87_), .c(new_n32_), .d(x17), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(x18), .O(new_n90_));
  nor2   g62(.a(new_n74_), .b(new_n64_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n66_), .c(new_n34_), .d(x17), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n90_), .c(new_n47_), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(x10), .c(new_n42_), .O(new_n94_));
