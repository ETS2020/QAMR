...
module FAU ( 
  ...
  oai21  g24(.a(x12), .b(new_n52_), .c(x08), .O(new_n53_));
  ...
  oai21  g31(.a(new_n53_), .b(new_n51_), .c(new_n59_), .O(z4));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(new_n38_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n67_));
  oai21  g39(.a(new_n53_), .b(new_n61_), .c(new_n67_), .O(z5));
  inv1   g40(.a(x05), .O(new_n69_));
  nand2  g41(.a(x15), .b(x14), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n54_), .c(x16), .O(new_n71_));
  ...
  oai22  g47(.a(new_n75_), .b(x08), .c(new_n53_), .d(new_n69_), .O(z6));
  ...
  nand3  g52(.a(new_n77_), .b(x16), .c(x15), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(new_n62_), .c(new_n80_), .d(new_n77_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n31_), .c(new_n30_), .O(new_n83_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n62_), .c(x18), .O(new_n90_));
  nand4  g62(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n62_), .c(new_n90_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(x12), .c(new_n31_), .d(x09), .O(new_n93_));
  oai22  g65(.a(new_n93_), .b(x08), .c(new_n53_), .d(new_n88_), .O(z8));
endmodule
