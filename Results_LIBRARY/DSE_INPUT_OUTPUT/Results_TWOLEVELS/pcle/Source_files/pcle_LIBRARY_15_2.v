...
module FAU ( 
  ...
  oai21  g24(.a(new_n45_), .b(new_n47_), .c(new_n52_), .O(z3));
  oai21  g25(.a(new_n31_), .b(x03), .c(x08), .O(new_n54_));
  oai21  g26(.a(x12), .b(x08), .c(x13), .O(new_n55_));
  ...
  oai21  g41(.a(new_n45_), .b(new_n62_), .c(new_n69_), .O(z5));
  ...
  oai21  g50(.a(new_n45_), .b(new_n71_), .c(new_n78_), .O(z6));
  oai21  g51(.a(new_n31_), .b(x06), .c(x08), .O(new_n80_));
  aoi21  g52(.a(x15), .b(x14), .c(x08), .O(new_n81_));
  nand3  g53(.a(new_n49_), .b(x16), .c(x13), .O(new_n82_));
  ...
  oai21  g62(.a(new_n90_), .b(new_n74_), .c(x18), .O(new_n91_));
