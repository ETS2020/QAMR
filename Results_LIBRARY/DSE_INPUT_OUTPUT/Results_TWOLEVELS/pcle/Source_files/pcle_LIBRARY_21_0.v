...
module FAU ( 
  ...
  nand2  g16(.a(x09), .b(new_n29_), .O(new_n45_));
  nand2  g17(.a(new_n41_), .b(x08), .O(new_n46_));
  inv1   g18(.a(x12), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(x11), .c(new_n39_), .O(new_n48_));
  oai22  g20(.a(new_n48_), .b(new_n45_), .c(new_n46_), .d(new_n44_), .O(z2));
  inv1   g21(.a(x02), .O(new_n50_));
  xor2a  g22(.a(x13), .b(x12), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(x11), .c(new_n39_), .d(x09), .O(new_n52_));
  oai22  g24(.a(new_n52_), .b(x08), .c(new_n46_), .d(new_n50_), .O(z3));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(new_n40_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n59_));
  oai21  g31(.a(new_n46_), .b(new_n54_), .c(new_n59_), .O(z4));
  ...
  nand3  g36(.a(new_n31_), .b(new_n64_), .c(x14), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(new_n40_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n67_));
  oai21  g39(.a(new_n46_), .b(new_n61_), .c(new_n67_), .O(z5));
  inv1   g40(.a(x05), .O(new_n69_));
  oai21  g41(.a(new_n35_), .b(new_n30_), .c(x16), .O(new_n70_));
  nand3  g42(.a(new_n32_), .b(x15), .c(x14), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n30_), .c(new_n70_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(x11), .c(new_n39_), .d(x09), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(x08), .c(new_n46_), .d(new_n69_), .O(z6));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  nand2  g47(.a(x16), .b(x12), .O(new_n76_));
  aoi21  g48(.a(new_n75_), .b(x11), .c(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n33_), .b(x16), .c(x15), .O(new_n78_));
  oai22  g50(.a(new_n78_), .b(new_n62_), .c(new_n77_), .d(new_n33_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x09), .c(new_n29_), .O(new_n80_));
  ...
  nand3  g56(.a(x17), .b(x16), .c(x12), .O(new_n85_));
  aoi21  g57(.a(new_n75_), .b(x11), .c(new_n85_), .O(new_n86_));
  nand4  g58(.a(new_n34_), .b(x17), .c(x16), .d(x15), .O(new_n87_));
  oai22  g59(.a(new_n87_), .b(new_n62_), .c(new_n86_), .d(new_n34_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(x09), .c(new_n29_), .O(new_n89_));
