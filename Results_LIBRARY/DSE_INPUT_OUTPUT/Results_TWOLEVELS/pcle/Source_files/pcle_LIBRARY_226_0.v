...
module FAU ( 
  ...
  nand4  g51(.a(x12), .b(x11), .c(new_n40_), .d(new_n31_), .O(new_n80_));
  nand4  g52(.a(x16), .b(x15), .c(x14), .d(x13), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n80_), .c(x09), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  inv1   g56(.a(new_n84_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n59_), .c(new_n79_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n83_), .O(z7));
  nand2  g61(.a(new_n48_), .b(x07), .O(new_n90_));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n58_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n74_), .b(new_n64_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n79_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n93_), .c(new_n66_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n97_));
