...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n93_, new_n94_;
  nor2   g00(.a(x09), .b(x07), .O(new_n29_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n61_));
  ...
  oai22  g39(.a(new_n67_), .b(new_n32_), .c(new_n66_), .d(new_n64_), .O(new_n68_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n85_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n41_), .c(x09), .d(new_n31_), .O(new_n93_));
