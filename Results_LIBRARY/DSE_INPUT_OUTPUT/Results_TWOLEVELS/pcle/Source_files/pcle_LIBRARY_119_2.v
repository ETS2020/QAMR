...
module FAU ( 
  ...
  nand4  g21(.a(new_n49_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n50_));
  ...
  nand4  g26(.a(new_n54_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n55_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x03), .c(new_n30_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(z4));
  nand2  g36(.a(new_n43_), .b(x04), .O(new_n65_));
  ...
  nand4  g42(.a(new_n70_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n71_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n78_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n85_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n32_), .c(x09), .d(new_n42_), .O(new_n95_));
