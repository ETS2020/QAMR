...
module FAU ( 
  ...
  nand4  g25(.a(new_n53_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n54_));
  ...
  oai22  g32(.a(new_n60_), .b(new_n32_), .c(new_n59_), .d(new_n57_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n62_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n32_), .c(new_n66_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n70_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n72_), .O(z6));
  nand4  g50(.a(x12), .b(x11), .c(x09), .d(new_n31_), .O(new_n79_));
  nand4  g51(.a(x16), .b(x15), .c(x14), .d(x13), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n29_), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  inv1   g55(.a(new_n83_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n59_), .c(new_n29_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(z7));
  nand2  g60(.a(x18), .b(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n43_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n29_), .O(new_n91_));
  oai21  g63(.a(new_n83_), .b(new_n58_), .c(x18), .O(new_n92_));
  inv1   g64(.a(x18), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x17), .c(x16), .d(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n65_), .c(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n43_), .c(x09), .d(new_n31_), .O(new_n96_));
