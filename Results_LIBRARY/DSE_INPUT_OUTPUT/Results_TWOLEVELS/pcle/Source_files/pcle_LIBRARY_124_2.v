...
module FAU ( 
  ...
  nand2  g24(.a(x10), .b(x08), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(new_n46_), .c(new_n52_), .O(z3));
  ...
  nor2   g36(.a(new_n58_), .b(new_n47_), .O(new_n65_));
  ...
  oai21  g52(.a(new_n53_), .b(new_n73_), .c(new_n80_), .O(z6));
  inv1   g53(.a(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n76_), .c(x17), .O(new_n84_));
