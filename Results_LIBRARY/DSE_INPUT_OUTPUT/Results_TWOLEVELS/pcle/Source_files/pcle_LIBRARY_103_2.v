...
module FAU ( 
  ...
  aoi21  g29(.a(new_n57_), .b(new_n32_), .c(x03), .O(new_n58_));
  nand2  g30(.a(x08), .b(x02), .O(new_n59_));
  oai21  g31(.a(new_n58_), .b(x10), .c(new_n59_), .O(z3));
  oai21  g32(.a(new_n33_), .b(x08), .c(x03), .O(new_n61_));
  nand3  g33(.a(x13), .b(x12), .c(x11), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(new_n63_));
  nand2  g35(.a(new_n30_), .b(x13), .O(new_n64_));
  oai22  g36(.a(new_n64_), .b(new_n53_), .c(new_n63_), .d(new_n30_), .O(new_n65_));
  ...
  nor2   g41(.a(x15), .b(new_n30_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x13), .c(x12), .d(x11), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n52_), .O(new_n72_));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n77_), .c(new_n52_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n32_), .c(x03), .O(new_n81_));
  nand2  g53(.a(x08), .b(x05), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(x10), .c(new_n82_), .O(z6));
  inv1   g55(.a(x06), .O(new_n84_));
  oai21  g56(.a(x10), .b(new_n31_), .c(x08), .O(new_n85_));
  ...
  oai22  g63(.a(new_n91_), .b(x03), .c(new_n85_), .d(new_n84_), .O(z7));
