...
module FAU ( 
  ...
  nand3  g26(.a(new_n54_), .b(new_n42_), .c(x09), .O(new_n55_));
  ...
  oai21  g38(.a(new_n66_), .b(new_n50_), .c(new_n65_), .O(new_n67_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n76_));
  nand2  g48(.a(new_n40_), .b(x05), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z6));
  oai21  g50(.a(new_n42_), .b(x06), .c(x08), .O(new_n79_));
  inv1   g51(.a(x17), .O(new_n80_));
  nand3  g52(.a(x16), .b(x12), .c(x11), .O(new_n81_));
  aoi21  g53(.a(new_n71_), .b(new_n29_), .c(new_n81_), .O(new_n82_));
  nand4  g54(.a(new_n80_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai22  g55(.a(new_n83_), .b(new_n57_), .c(new_n82_), .d(new_n80_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n42_), .c(x09), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n79_), .O(z7));
  oai21  g58(.a(new_n42_), .b(x07), .c(x08), .O(new_n87_));
  inv1   g59(.a(x18), .O(new_n88_));
  nand2  g60(.a(new_n71_), .b(new_n29_), .O(new_n89_));
  nand4  g61(.a(x17), .b(x16), .c(x12), .d(x11), .O(new_n90_));
  inv1   g62(.a(new_n90_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  nand4  g64(.a(new_n88_), .b(x17), .c(x16), .d(x15), .O(new_n93_));
  nor2   g65(.a(new_n93_), .b(new_n64_), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n92_), .c(new_n42_), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n30_), .c(new_n87_), .O(z8));
endmodule
