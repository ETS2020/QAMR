...
module FAU ( 
  ...
  nand3  g44(.a(x11), .b(x09), .c(new_n32_), .O(new_n73_));
  nand4  g45(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n73_), .c(new_n29_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nor2   g48(.a(new_n35_), .b(new_n33_), .O(new_n77_));
  nor2   g49(.a(new_n77_), .b(new_n72_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(new_n76_), .O(z6));
  nand2  g53(.a(x17), .b(x09), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(x08), .c(new_n29_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n72_), .O(new_n84_));
  oai21  g56(.a(new_n35_), .b(new_n33_), .c(x17), .O(new_n85_));
  ...
  nand2  g63(.a(new_n40_), .b(x07), .O(new_n92_));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n57_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n72_), .b(new_n64_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n86_), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n66_), .O(new_n97_));
