...
module FAU ( 
  ...
  nand3  g39(.a(x18), .b(new_n67_), .c(x14), .O(new_n68_));
  ...
  inv1   g49(.a(new_n58_), .O(new_n78_));
  and2   g50(.a(x15), .b(x14), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n78_), .c(x18), .d(new_n77_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n76_), .c(new_n39_), .O(new_n81_));
  ...
  nor2   g59(.a(new_n77_), .b(new_n67_), .O(new_n88_));
  nor2   g60(.a(new_n29_), .b(x17), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n86_), .c(new_n39_), .O(new_n91_));
  ...
  oai22  g71(.a(new_n99_), .b(x08), .c(new_n45_), .d(new_n95_), .O(z8));
endmodule
