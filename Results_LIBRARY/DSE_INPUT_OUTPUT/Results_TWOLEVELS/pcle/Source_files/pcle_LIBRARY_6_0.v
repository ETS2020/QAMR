...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(x13), .c(x09), .d(new_n29_), .O(new_n51_));
  ...
  oai21  g34(.a(new_n41_), .b(new_n56_), .c(new_n62_), .O(z4));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(new_n64_), .O(new_n69_));
  ...
  nand4  g45(.a(new_n31_), .b(new_n32_), .c(x15), .d(x14), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n73_), .c(new_n64_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n29_), .c(new_n57_), .O(new_n76_));
  ...
  inv1   g52(.a(new_n65_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n33_), .c(x16), .d(x15), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(new_n64_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n29_), .c(new_n57_), .O(new_n84_));
  nand2  g56(.a(x08), .b(x06), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(x10), .c(new_n85_), .O(z7));
  nand3  g58(.a(x17), .b(x16), .c(x15), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n65_), .c(x18), .O(new_n88_));
  and2   g60(.a(x16), .b(x15), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n81_), .c(new_n34_), .d(x17), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n64_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n29_), .c(new_n57_), .O(new_n92_));
