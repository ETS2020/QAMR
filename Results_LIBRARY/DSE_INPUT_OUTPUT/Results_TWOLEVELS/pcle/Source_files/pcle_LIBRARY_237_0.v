...
module FAU ( 
  ...
  inv1   g14(.a(x16), .O(new_n43_));
  nor2   g15(.a(new_n43_), .b(x11), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  oai22  g17(.a(new_n45_), .b(new_n40_), .c(new_n41_), .d(new_n39_), .O(z1));
  inv1   g18(.a(x01), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(x16), .c(new_n42_), .d(x09), .O(new_n49_));
  oai22  g21(.a(new_n49_), .b(x08), .c(new_n41_), .d(new_n47_), .O(z2));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n29_), .c(new_n43_), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n29_), .c(new_n43_), .O(new_n64_));
  ...
  aoi21  g41(.a(new_n69_), .b(new_n29_), .c(new_n43_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(x10), .c(new_n71_), .O(z5));
  inv1   g44(.a(x11), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(x12), .O(new_n75_));
  inv1   g47(.a(x12), .O(new_n76_));
  nand2  g48(.a(x16), .b(new_n76_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n44_), .c(x09), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(x08), .c(x16), .O(new_n80_));
  ...
  nand3  g58(.a(new_n33_), .b(x15), .c(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n59_), .c(new_n86_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x16), .c(new_n42_), .d(x09), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x08), .c(new_n41_), .d(new_n84_), .O(z7));
  nand3  g62(.a(x17), .b(x15), .c(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n59_), .c(x18), .O(new_n92_));
  inv1   g64(.a(new_n59_), .O(new_n93_));
  nor2   g65(.a(new_n32_), .b(new_n61_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n34_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n92_), .c(new_n51_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n29_), .c(new_n43_), .O(new_n97_));
