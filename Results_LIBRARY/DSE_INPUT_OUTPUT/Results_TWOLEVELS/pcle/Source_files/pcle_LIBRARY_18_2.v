...
module FAU ( 
  ...
  oai22  g20(.a(new_n48_), .b(x03), .c(new_n41_), .d(new_n45_), .O(z2));
  ...
  nand4  g27(.a(new_n55_), .b(x09), .c(new_n46_), .d(new_n40_), .O(new_n56_));
  oai21  g28(.a(new_n41_), .b(new_n50_), .c(new_n56_), .O(z3));
  oai21  g29(.a(new_n31_), .b(x08), .c(x03), .O(new_n58_));
  ...
  nand4  g35(.a(new_n63_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n64_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(x03), .c(new_n41_), .d(new_n74_), .O(z6));
  ...
  nand4  g60(.a(new_n88_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x03), .c(new_n41_), .d(new_n83_), .O(z7));
  inv1   g62(.a(x09), .O(new_n91_));
  nand2  g63(.a(new_n84_), .b(new_n40_), .O(new_n92_));
  and2   g64(.a(x17), .b(x13), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(new_n92_), .c(new_n61_), .O(new_n94_));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n95_), .c(new_n91_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n46_), .c(x03), .O(new_n99_));
