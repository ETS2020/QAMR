...
module FAU ( 
  ...
  aoi21  g09(.a(new_n37_), .b(x09), .c(x10), .O(new_n38_));
  ...
  oai21  g23(.a(new_n51_), .b(x10), .c(new_n45_), .O(new_n52_));
  ...
  oai21  g31(.a(new_n59_), .b(x10), .c(new_n45_), .O(new_n60_));
  ...
  nand4  g39(.a(new_n67_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n68_));
  ...
  inv1   g54(.a(new_n55_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n32_), .c(new_n82_), .d(x16), .O(new_n84_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n29_), .c(x09), .d(new_n45_), .O(new_n94_));
