...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(x09), .O(new_n39_));
  ...
  nand2  g31(.a(new_n57_), .b(x13), .O(new_n60_));
  oai22  g32(.a(new_n60_), .b(new_n50_), .c(new_n59_), .d(new_n57_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n62_));
  oai21  g34(.a(new_n40_), .b(new_n56_), .c(new_n62_), .O(z4));
  aoi21  g35(.a(x13), .b(x12), .c(x10), .O(new_n64_));
  nand2  g36(.a(x14), .b(x11), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n64_), .c(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand4  g39(.a(new_n51_), .b(new_n67_), .c(x14), .d(x13), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(x08), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(x10), .c(x09), .O(new_n70_));
  ...
  nand2  g52(.a(new_n67_), .b(new_n31_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n59_), .c(x16), .d(x14), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nor2   g56(.a(new_n67_), .b(new_n57_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n59_), .c(new_n84_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n83_), .c(x08), .O(new_n87_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n81_), .c(new_n59_), .d(x14), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x18), .O(new_n93_));
  nor2   g65(.a(new_n57_), .b(new_n49_), .O(new_n94_));
  nor2   g66(.a(new_n76_), .b(new_n67_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n84_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n51_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n93_), .c(x08), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(x10), .c(x09), .O(new_n99_));
