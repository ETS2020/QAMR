...
module FAU ( 
  ...
  aoi21  g18(.a(x10), .b(x09), .c(new_n30_), .O(new_n47_));
  ...
  nand3  g29(.a(new_n50_), .b(new_n57_), .c(x13), .O(new_n58_));
  ...
  nand3  g35(.a(new_n50_), .b(x14), .c(x13), .O(new_n64_));
  ...
  nand2  g42(.a(new_n57_), .b(new_n31_), .O(new_n71_));
  ...
  oai21  g50(.a(new_n78_), .b(x10), .c(x09), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z6));
  nand2  g53(.a(new_n47_), .b(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n75_), .c(x17), .O(new_n84_));
  ...
  oai21  g63(.a(new_n91_), .b(new_n75_), .c(x18), .O(new_n92_));
  ...
  nand2  g67(.a(new_n95_), .b(new_n90_), .O(z8));
endmodule
