...
module FAU ( 
  ...
  nand2  g37(.a(x14), .b(x11), .O(new_n66_));
  aoi21  g38(.a(new_n65_), .b(x09), .c(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n64_), .b(x14), .c(x13), .O(new_n68_));
  oai22  g40(.a(new_n68_), .b(new_n50_), .c(new_n67_), .d(new_n64_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n30_), .c(new_n43_), .O(new_n70_));
  ...
  aoi21  g46(.a(new_n65_), .b(x09), .c(new_n74_), .O(new_n75_));
  nand3  g47(.a(new_n73_), .b(x15), .c(x14), .O(new_n76_));
  oai22  g48(.a(new_n76_), .b(new_n57_), .c(new_n75_), .d(new_n73_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n30_), .c(new_n43_), .O(new_n78_));
  ...
  nor2   g63(.a(new_n73_), .b(new_n64_), .O(new_n92_));
  ...
  oai21  g69(.a(new_n39_), .b(new_n89_), .c(new_n97_), .O(z8));
endmodule
