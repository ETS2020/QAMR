...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n32_, new_n34_, new_n36_, new_n38_, new_n40_,
    new_n42_, new_n43_, new_n44_, new_n46_, new_n48_;
  ...
  nand2  g05(.a(x08), .b(x01), .O(new_n34_));
  nand2  g06(.a(new_n34_), .b(new_n30_), .O(z2));
  nand2  g07(.a(x08), .b(x02), .O(new_n36_));
  nand2  g08(.a(new_n36_), .b(new_n30_), .O(z3));
  nand2  g09(.a(x08), .b(x03), .O(new_n38_));
  nand2  g10(.a(new_n38_), .b(new_n30_), .O(z4));
  nand2  g11(.a(x08), .b(x04), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n30_), .O(z5));
  inv1   g13(.a(x05), .O(new_n42_));
  inv1   g14(.a(x09), .O(new_n43_));
  oai21  g15(.a(x10), .b(new_n43_), .c(x08), .O(new_n44_));
  nor2   g16(.a(new_n44_), .b(new_n42_), .O(z6));
