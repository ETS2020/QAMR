...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n51_));
  aoi21  g23(.a(x08), .b(x02), .c(new_n44_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(z3));
  nor2   g25(.a(new_n44_), .b(new_n30_), .O(new_n54_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n61_));
  ...
  aoi21  g40(.a(x08), .b(x04), .c(new_n44_), .O(new_n69_));
  ...
  nand2  g49(.a(new_n54_), .b(x06), .O(new_n78_));
  ...
  nand2  g57(.a(new_n54_), .b(x07), .O(new_n86_));
