...
module FAU ( 
  ...
  oai21  g25(.a(new_n53_), .b(new_n38_), .c(new_n39_), .O(new_n54_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n31_), .c(x13), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(new_n31_), .c(new_n60_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n57_), .O(z4));
  nand2  g35(.a(new_n51_), .b(x09), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n48_), .c(x14), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x15), .O(new_n66_));
  nand4  g38(.a(new_n48_), .b(new_n32_), .c(x14), .d(x13), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n38_), .c(new_n39_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  and2   g43(.a(x15), .b(x14), .O(new_n72_));
  nand3  g44(.a(new_n64_), .b(new_n48_), .c(new_n72_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x16), .O(new_n74_));
  inv1   g46(.a(x16), .O(new_n75_));
  nand4  g47(.a(new_n59_), .b(new_n75_), .c(x15), .d(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n74_), .c(x08), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n38_), .c(new_n39_), .O(new_n78_));
  ...
  nor2   g63(.a(new_n75_), .b(new_n32_), .O(new_n92_));
  nor2   g64(.a(new_n31_), .b(new_n51_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n83_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n48_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n97_));
