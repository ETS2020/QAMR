...
module FAU ( 
  ...
  nor2   g23(.a(new_n31_), .b(new_n29_), .O(new_n52_));
  nand3  g24(.a(new_n32_), .b(x12), .c(x11), .O(new_n53_));
  oai21  g25(.a(new_n52_), .b(new_n32_), .c(new_n53_), .O(new_n54_));
  nand4  g26(.a(new_n54_), .b(new_n44_), .c(x09), .d(new_n43_), .O(new_n55_));
  ...
  nand3  g31(.a(new_n52_), .b(new_n34_), .c(x13), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(new_n34_), .c(new_n60_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n44_), .c(x09), .d(new_n43_), .O(new_n62_));
  oai21  g34(.a(new_n42_), .b(new_n57_), .c(new_n62_), .O(z4));
  inv1   g35(.a(x09), .O(new_n64_));
  nand2  g36(.a(new_n31_), .b(x09), .O(new_n65_));
  and2   g37(.a(x14), .b(x13), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n65_), .c(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x15), .O(new_n68_));
  nand4  g40(.a(new_n52_), .b(new_n35_), .c(x14), .d(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(x08), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n64_), .c(new_n44_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z5));
  oai21  g45(.a(x12), .b(new_n64_), .c(x11), .O(new_n74_));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n74_), .c(x16), .O(new_n76_));
  inv1   g48(.a(x16), .O(new_n77_));
  nand4  g49(.a(new_n59_), .b(new_n77_), .c(x15), .d(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n76_), .c(x08), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n64_), .c(new_n44_), .O(new_n80_));
  ...
  nand4  g57(.a(new_n59_), .b(new_n36_), .c(new_n85_), .d(x16), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n43_), .c(new_n64_), .O(new_n88_));
  ...
  nor2   g64(.a(new_n77_), .b(new_n35_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n85_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n66_), .d(new_n52_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n92_), .c(x08), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n64_), .c(new_n44_), .O(new_n97_));
