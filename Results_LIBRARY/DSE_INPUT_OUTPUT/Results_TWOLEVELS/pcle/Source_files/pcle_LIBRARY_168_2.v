...
module FAU ( 
  ...
  nand3  g41(.a(new_n51_), .b(x14), .c(x13), .O(new_n70_));
  ...
  oai21  g54(.a(new_n45_), .b(new_n76_), .c(new_n82_), .O(z6));
  ...
  oai21  g62(.a(new_n45_), .b(new_n84_), .c(new_n90_), .O(z7));
  ...
  oai21  g69(.a(new_n97_), .b(new_n70_), .c(new_n96_), .O(new_n98_));
