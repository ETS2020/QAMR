...
module FAU ( 
  ...
  nand4  g16(.a(new_n44_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n45_));
  nand2  g17(.a(new_n38_), .b(x01), .O(new_n46_));
  ...
  nand2  g25(.a(new_n38_), .b(x02), .O(new_n54_));
  ...
  nand4  g31(.a(new_n59_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n60_));
  ...
  nand3  g48(.a(new_n76_), .b(new_n40_), .c(x09), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n70_), .O(z6));
  oai21  g50(.a(new_n40_), .b(x06), .c(x08), .O(new_n79_));
  ...
  nand3  g56(.a(new_n84_), .b(new_n40_), .c(x09), .O(new_n85_));
  ...
  nor2   g60(.a(new_n71_), .b(new_n32_), .O(new_n89_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n93_));
  nand2  g65(.a(new_n38_), .b(x07), .O(new_n94_));
