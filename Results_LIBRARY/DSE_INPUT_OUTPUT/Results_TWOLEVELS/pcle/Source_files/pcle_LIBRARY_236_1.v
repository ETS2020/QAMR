...
module FAU ( 
  ...
  nand4  g29(.a(new_n58_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n59_));
  oai21  g30(.a(new_n32_), .b(new_n52_), .c(new_n59_), .O(z4));
  inv1   g31(.a(x09), .O(new_n61_));
  aoi21  g32(.a(x13), .b(x12), .c(x18), .O(new_n62_));
  nand2  g33(.a(x14), .b(x11), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n62_), .c(x15), .O(new_n64_));
  inv1   g35(.a(x15), .O(new_n65_));
  nand4  g36(.a(new_n56_), .b(new_n65_), .c(x14), .d(x13), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(new_n67_));
  ...
  nand3  g41(.a(x15), .b(x14), .c(x11), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n62_), .c(x16), .O(new_n72_));
  inv1   g43(.a(new_n53_), .O(new_n73_));
  nor2   g44(.a(x16), .b(new_n65_), .O(new_n74_));
  nand3  g45(.a(new_n74_), .b(new_n73_), .c(x14), .O(new_n75_));
  aoi21  g46(.a(new_n75_), .b(new_n72_), .c(new_n61_), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(new_n33_), .c(x18), .O(new_n77_));
  nand2  g48(.a(x08), .b(x05), .O(new_n78_));
  oai21  g49(.a(new_n77_), .b(x10), .c(new_n78_), .O(z6));
  ...
  nand4  g54(.a(new_n83_), .b(new_n73_), .c(new_n82_), .d(x16), .O(new_n84_));
  aoi21  g55(.a(new_n84_), .b(new_n81_), .c(new_n61_), .O(new_n85_));
  ...
  nand3  g59(.a(new_n56_), .b(x09), .c(new_n33_), .O(new_n89_));
  inv1   g60(.a(new_n89_), .O(new_n90_));
  nand3  g61(.a(x17), .b(x16), .c(x15), .O(new_n91_));
  nor3   g62(.a(new_n91_), .b(new_n55_), .c(new_n47_), .O(new_n92_));
  aoi21  g63(.a(new_n92_), .b(new_n90_), .c(x18), .O(new_n93_));
  nand2  g64(.a(x08), .b(x07), .O(new_n94_));
  oai21  g65(.a(new_n93_), .b(x10), .c(new_n94_), .O(z8));
  zero   g66(.O(z0));
endmodule
