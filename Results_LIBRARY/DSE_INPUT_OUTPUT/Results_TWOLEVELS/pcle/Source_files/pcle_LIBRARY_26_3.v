...
module FAU ( 
  ...
  aoi21  g25(.a(new_n53_), .b(new_n52_), .c(x10), .O(z3));
  ...
  nand2  g43(.a(new_n63_), .b(x05), .O(new_n72_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n84_));
  aoi21  g56(.a(x08), .b(x06), .c(new_n29_), .O(new_n85_));
