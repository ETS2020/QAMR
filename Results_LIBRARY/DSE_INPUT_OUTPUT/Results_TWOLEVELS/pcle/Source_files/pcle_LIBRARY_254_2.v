...
module FAU ( 
  ...
  nor2   g03(.a(x08), .b(x06), .O(new_n32_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n45_), .c(x06), .O(new_n58_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n45_), .c(x06), .O(new_n66_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n31_), .c(x09), .d(new_n45_), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(x06), .c(new_n41_), .d(new_n69_), .O(z5));
  ...
  oai22  g55(.a(new_n83_), .b(x06), .c(new_n41_), .d(new_n77_), .O(z6));
  ...
  nand3  g62(.a(x10), .b(x08), .c(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x06), .c(new_n91_), .O(z7));
  nand2  g64(.a(new_n85_), .b(new_n40_), .O(new_n93_));
  and2   g65(.a(x17), .b(x13), .O(new_n94_));
  ...
  aoi21  g70(.a(new_n98_), .b(new_n96_), .c(new_n52_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n45_), .c(x06), .O(new_n100_));
