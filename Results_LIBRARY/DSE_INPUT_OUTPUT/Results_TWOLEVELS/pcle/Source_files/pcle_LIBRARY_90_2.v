...
module FAU ( 
  ...
  nand2  g23(.a(x10), .b(x08), .O(new_n52_));
  inv1   g24(.a(new_n52_), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(x02), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n51_), .O(z3));
  ...
  oai22  g31(.a(new_n59_), .b(new_n46_), .c(new_n58_), .d(new_n56_), .O(new_n60_));
  ...
  oai22  g39(.a(new_n67_), .b(new_n46_), .c(new_n66_), .d(new_n64_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n69_));
  nand2  g41(.a(new_n53_), .b(x04), .O(new_n70_));
  ...
  nand2  g49(.a(new_n53_), .b(x05), .O(new_n78_));
  ...
  nand2  g66(.a(new_n53_), .b(x07), .O(new_n95_));
