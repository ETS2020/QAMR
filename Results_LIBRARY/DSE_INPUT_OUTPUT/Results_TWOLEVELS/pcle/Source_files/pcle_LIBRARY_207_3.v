...
module FAU ( 
  ...
  aoi21  g14(.a(new_n42_), .b(new_n41_), .c(x02), .O(new_n43_));
  nand2  g15(.a(x08), .b(x00), .O(new_n44_));
  oai21  g16(.a(new_n43_), .b(new_n30_), .c(new_n44_), .O(z1));
  inv1   g17(.a(x01), .O(new_n46_));
  oai21  g18(.a(new_n30_), .b(new_n29_), .c(x08), .O(new_n47_));
  inv1   g19(.a(x10), .O(new_n48_));
  xor2a  g20(.a(x12), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n50_));
  oai22  g22(.a(new_n50_), .b(x02), .c(new_n47_), .d(new_n46_), .O(z2));
  oai21  g23(.a(x09), .b(x08), .c(x02), .O(new_n52_));
  ...
  nand4  g29(.a(new_n57_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n52_), .O(z3));
  inv1   g31(.a(x03), .O(new_n60_));
  nand2  g32(.a(new_n31_), .b(x14), .O(new_n61_));
  nand3  g33(.a(new_n55_), .b(new_n33_), .c(x13), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n61_), .c(x10), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(x09), .c(new_n41_), .d(new_n29_), .O(new_n64_));
  oai21  g36(.a(new_n47_), .b(new_n60_), .c(new_n64_), .O(z4));
  inv1   g37(.a(x04), .O(new_n66_));
  nand3  g38(.a(new_n55_), .b(x14), .c(x13), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x15), .O(new_n68_));
  nand3  g40(.a(new_n34_), .b(x14), .c(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n54_), .c(new_n68_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n71_));
  oai22  g43(.a(new_n71_), .b(x02), .c(new_n47_), .d(new_n66_), .O(z5));
  ...
  nand4  g50(.a(new_n78_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n79_));
  oai22  g51(.a(new_n79_), .b(x02), .c(new_n47_), .d(new_n73_), .O(z6));
  ...
  nand4  g57(.a(new_n85_), .b(new_n48_), .c(x09), .d(new_n41_), .O(new_n86_));
  oai22  g58(.a(new_n86_), .b(x02), .c(new_n47_), .d(new_n81_), .O(z7));
  ...
  nand3  g64(.a(new_n92_), .b(new_n48_), .c(new_n41_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n29_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x09), .O(new_n95_));
