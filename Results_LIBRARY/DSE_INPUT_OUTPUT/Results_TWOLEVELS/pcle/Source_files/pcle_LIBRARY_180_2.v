...
module FAU ( 
  ...
  nand4  g31(.a(new_n59_), .b(x09), .c(new_n42_), .d(new_n29_), .O(new_n60_));
  ...
  oai21  g40(.a(new_n41_), .b(x08), .c(x04), .O(new_n69_));
  aoi21  g41(.a(x13), .b(x12), .c(x04), .O(new_n70_));
  nand2  g42(.a(x14), .b(x11), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n70_), .c(x15), .O(new_n72_));
  nand4  g44(.a(new_n64_), .b(new_n34_), .c(x14), .d(x13), .O(new_n73_));
  ...
  nand2  g48(.a(new_n49_), .b(x05), .O(new_n77_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(x04), .c(new_n77_), .O(z6));
  inv1   g56(.a(new_n31_), .O(new_n85_));
  nand2  g57(.a(new_n34_), .b(new_n29_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n85_), .c(x16), .d(x14), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x17), .O(new_n88_));
  nand4  g60(.a(new_n35_), .b(new_n85_), .c(new_n36_), .d(x16), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n88_), .c(new_n30_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n42_), .c(x04), .O(new_n91_));
  nand2  g63(.a(x08), .b(x06), .O(new_n92_));
  oai21  g64(.a(new_n91_), .b(x10), .c(new_n92_), .O(z7));
  nand2  g65(.a(new_n49_), .b(x07), .O(new_n94_));
  nand3  g66(.a(new_n35_), .b(x17), .c(x16), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n31_), .c(x18), .O(new_n96_));
  nand4  g68(.a(new_n37_), .b(x17), .c(x16), .d(x15), .O(new_n97_));
  inv1   g69(.a(new_n97_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n64_), .c(x14), .d(x13), .O(new_n99_));
