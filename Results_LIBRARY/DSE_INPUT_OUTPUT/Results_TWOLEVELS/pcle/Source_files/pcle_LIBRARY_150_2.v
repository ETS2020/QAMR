...
module FAU ( 
  ...
  aoi21  g17(.a(new_n33_), .b(x03), .c(new_n32_), .O(new_n46_));
  ...
  oai21  g21(.a(new_n49_), .b(x03), .c(new_n47_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n32_), .c(x03), .O(new_n57_));
  ...
  nand3  g37(.a(x10), .b(x08), .c(x03), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(z4));
  oai21  g39(.a(x13), .b(x03), .c(x14), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n52_), .c(x15), .O(new_n69_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n32_), .c(x03), .O(new_n73_));
  ...
  nand2  g56(.a(new_n70_), .b(new_n31_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n84_), .c(x16), .d(x14), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x17), .O(new_n87_));
  nor2   g59(.a(new_n70_), .b(new_n30_), .O(new_n88_));
  nor2   g60(.a(x17), .b(new_n79_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(new_n84_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n51_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n32_), .c(x03), .O(new_n92_));
  nand2  g64(.a(x08), .b(x06), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x10), .c(new_n93_), .O(z7));
  nand2  g66(.a(new_n46_), .b(x07), .O(new_n95_));
  nand3  g67(.a(new_n88_), .b(x17), .c(x16), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n60_), .c(x18), .O(new_n97_));
  nand4  g69(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n98_));
  inv1   g70(.a(new_n98_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n62_), .c(x14), .d(x13), .O(new_n100_));
