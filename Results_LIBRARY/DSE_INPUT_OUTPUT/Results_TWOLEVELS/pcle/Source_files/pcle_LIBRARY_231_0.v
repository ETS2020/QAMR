...
module FAU ( 
  ...
  nand3  g26(.a(new_n32_), .b(x12), .c(x11), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n32_), .c(new_n55_), .O(new_n56_));
  nand4  g28(.a(new_n56_), .b(new_n44_), .c(x09), .d(new_n43_), .O(new_n57_));
  oai21  g29(.a(new_n42_), .b(new_n52_), .c(new_n57_), .O(z3));
  nand2  g30(.a(new_n31_), .b(x09), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(x13), .c(x11), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(x14), .O(new_n61_));
  nand3  g33(.a(new_n54_), .b(new_n34_), .c(x13), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n61_), .c(x08), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(new_n47_), .c(new_n44_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n64_), .O(z4));
  and2   g38(.a(x14), .b(x13), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n59_), .c(x11), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x15), .O(new_n69_));
  nand4  g41(.a(new_n54_), .b(new_n35_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(x08), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n47_), .c(new_n44_), .O(new_n72_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n43_), .c(new_n47_), .O(new_n89_));
  ...
  nor2   g66(.a(new_n78_), .b(new_n35_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n86_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n67_), .d(new_n54_), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n44_), .c(x09), .d(new_n43_), .O(new_n99_));
  oai21  g71(.a(new_n42_), .b(new_n92_), .c(new_n99_), .O(z8));
endmodule
