...
module FAU ( 
  ...
  aoi21  g53(.a(new_n81_), .b(x09), .c(new_n51_), .O(new_n82_));
  oai22  g54(.a(new_n82_), .b(x10), .c(new_n31_), .d(new_n51_), .O(z6));
  ...
  nor2   g68(.a(new_n79_), .b(new_n71_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n29_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n95_), .c(x10), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(x09), .c(new_n31_), .d(x05), .O(new_n100_));
  oai21  g72(.a(new_n41_), .b(new_n93_), .c(new_n100_), .O(z8));
endmodule
