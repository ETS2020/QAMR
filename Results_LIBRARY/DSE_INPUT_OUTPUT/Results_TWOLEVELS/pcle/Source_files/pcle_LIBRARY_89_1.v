...
module FAU ( 
  ...
  nand3  g08(.a(new_n29_), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  oai22  g09(.a(new_n37_), .b(new_n34_), .c(new_n32_), .d(new_n31_), .O(z1));
  nand2  g10(.a(x11), .b(x09), .O(new_n39_));
  oai21  g11(.a(new_n39_), .b(x08), .c(new_n29_), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n35_), .O(new_n41_));
  nand2  g13(.a(x08), .b(x01), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n41_), .O(z2));
  inv1   g15(.a(x02), .O(new_n44_));
  nand3  g16(.a(x13), .b(new_n29_), .c(new_n35_), .O(new_n45_));
  oai22  g17(.a(new_n45_), .b(new_n34_), .c(new_n32_), .d(new_n44_), .O(z3));
  nand2  g18(.a(x14), .b(x09), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(x08), .c(new_n29_), .O(new_n48_));
  ...
  nand3  g24(.a(x15), .b(new_n29_), .c(new_n35_), .O(new_n53_));
  oai22  g25(.a(new_n53_), .b(new_n34_), .c(new_n32_), .d(new_n52_), .O(z5));
  inv1   g26(.a(x05), .O(new_n55_));
  nand3  g27(.a(x16), .b(new_n29_), .c(new_n35_), .O(new_n56_));
  oai22  g28(.a(new_n56_), .b(new_n34_), .c(new_n32_), .d(new_n55_), .O(z6));
  nand2  g29(.a(x17), .b(x09), .O(new_n58_));
  ...
  nand2  g34(.a(x18), .b(x09), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(x08), .c(new_n29_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n35_), .O(new_n65_));
  nand2  g37(.a(x08), .b(x07), .O(new_n66_));
