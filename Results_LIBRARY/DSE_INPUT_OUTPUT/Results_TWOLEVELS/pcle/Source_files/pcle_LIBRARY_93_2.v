...
module FAU ( 
  ...
  nor2   g43(.a(new_n66_), .b(new_n55_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(x11), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n63_), .c(x16), .O(new_n74_));
  ...
  oai21  g66(.a(new_n52_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
