...
module FAU ( 
  ...
  nand2  g03(.a(new_n31_), .b(x01), .O(new_n32_));
  ...
  nand3  g14(.a(new_n42_), .b(new_n39_), .c(new_n32_), .O(z1));
  inv1   g15(.a(x01), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n32_), .c(new_n29_), .d(x09), .O(new_n46_));
  nand2  g18(.a(x08), .b(x03), .O(new_n47_));
  oai22  g19(.a(new_n47_), .b(new_n44_), .c(new_n46_), .d(x08), .O(z2));
  inv1   g20(.a(new_n32_), .O(new_n49_));
  inv1   g21(.a(x13), .O(new_n50_));
  nor2   g22(.a(new_n30_), .b(new_n41_), .O(new_n51_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n64_), .c(new_n66_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n49_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z5));
  nor2   g44(.a(new_n67_), .b(new_n59_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n51_), .c(x13), .O(new_n74_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x05), .c(new_n49_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z6));
  nor2   g53(.a(new_n76_), .b(new_n67_), .O(new_n82_));
  ...
  nand2  g57(.a(new_n85_), .b(new_n73_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n57_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n88_), .c(new_n49_), .O(z7));
  nand3  g62(.a(new_n73_), .b(x17), .c(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n57_), .c(x18), .O(new_n92_));
  inv1   g64(.a(x18), .O(new_n93_));
  nand3  g65(.a(new_n82_), .b(new_n93_), .c(x17), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n65_), .c(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n96_));
  aoi21  g68(.a(x08), .b(x07), .c(new_n49_), .O(new_n97_));
