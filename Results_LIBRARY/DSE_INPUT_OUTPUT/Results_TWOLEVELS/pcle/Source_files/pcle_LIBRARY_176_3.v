...
module FAU ( 
  ...
  nand2  g38(.a(new_n49_), .b(new_n31_), .O(new_n67_));
  ...
  nand2  g44(.a(new_n65_), .b(x16), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand4  g46(.a(new_n49_), .b(new_n74_), .c(x14), .d(x13), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n73_), .c(new_n64_), .O(new_n76_));
  nand3  g48(.a(x16), .b(new_n64_), .c(new_n31_), .O(new_n77_));
  inv1   g49(.a(new_n77_), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n76_), .c(x09), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x05), .c(new_n53_), .O(new_n80_));
  ...
  aoi22  g62(.a(new_n90_), .b(new_n31_), .c(new_n65_), .d(x15), .O(new_n91_));
  ...
  aoi21  g67(.a(x08), .b(x07), .c(new_n53_), .O(new_n96_));
