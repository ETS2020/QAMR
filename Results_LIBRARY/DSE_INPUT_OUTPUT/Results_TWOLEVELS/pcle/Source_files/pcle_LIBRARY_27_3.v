...
module FAU ( 
  ...
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(x09), .d(new_n45_), .O(new_n46_));
  oai21  g18(.a(new_n44_), .b(new_n43_), .c(new_n46_), .O(z1));
  inv1   g19(.a(x01), .O(new_n48_));
  xor2a  g20(.a(x12), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n30_), .c(x09), .d(new_n45_), .O(new_n50_));
  oai21  g22(.a(new_n44_), .b(new_n48_), .c(new_n50_), .O(z2));
  ...
  oai21  g27(.a(new_n55_), .b(x10), .c(x09), .O(new_n56_));
  ...
  oai22  g34(.a(new_n62_), .b(new_n52_), .c(new_n61_), .d(new_n36_), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n30_), .c(x09), .d(new_n45_), .O(new_n64_));
  oai21  g36(.a(new_n44_), .b(new_n59_), .c(new_n64_), .O(z4));
  oai21  g37(.a(x13), .b(x10), .c(x14), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n52_), .c(x15), .O(new_n67_));
  inv1   g39(.a(new_n52_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n37_), .c(x14), .d(x13), .O(new_n69_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n30_), .c(x09), .d(new_n45_), .O(new_n80_));
  oai21  g52(.a(new_n44_), .b(new_n74_), .c(new_n80_), .O(z6));
  ...
  nand4  g57(.a(new_n61_), .b(new_n38_), .c(new_n85_), .d(x16), .O(new_n86_));
  ...
  nor2   g65(.a(new_n36_), .b(new_n34_), .O(new_n94_));
  nor2   g66(.a(new_n77_), .b(new_n37_), .O(new_n95_));
