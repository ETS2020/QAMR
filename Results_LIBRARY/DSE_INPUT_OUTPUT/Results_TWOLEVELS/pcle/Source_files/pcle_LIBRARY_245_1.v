...
module FAU ( 
  ...
  aoi21  g19(.a(new_n47_), .b(new_n45_), .c(x15), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n43_), .O(z3));
  nand2  g22(.a(new_n42_), .b(x03), .O(new_n51_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n53_), .c(x15), .O(new_n56_));
  nand4  g28(.a(new_n56_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n51_), .O(z4));
  nand3  g30(.a(x11), .b(x09), .c(new_n33_), .O(new_n59_));
  nand3  g31(.a(x14), .b(x13), .c(x12), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(new_n59_), .c(new_n29_), .O(new_n61_));
