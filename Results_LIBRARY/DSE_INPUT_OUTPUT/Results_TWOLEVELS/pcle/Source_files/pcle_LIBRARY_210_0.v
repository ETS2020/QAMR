...
module FAU ( 
  ...
  oai21  g27(.a(new_n40_), .b(new_n48_), .c(new_n55_), .O(z3));
  nand3  g28(.a(x13), .b(x12), .c(x11), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(x14), .c(x09), .d(new_n30_), .O(new_n58_));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n30_), .c(new_n49_), .O(new_n69_));
  ...
  nand3  g47(.a(new_n75_), .b(x15), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n50_), .c(new_n74_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(x14), .c(new_n31_), .d(x09), .O(new_n78_));
  oai22  g50(.a(new_n78_), .b(x08), .c(new_n40_), .d(new_n72_), .O(z6));
  inv1   g51(.a(x06), .O(new_n80_));
  nand3  g52(.a(x16), .b(x15), .c(x13), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n50_), .c(x17), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x16), .c(x15), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n64_), .c(new_n82_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(x14), .c(new_n31_), .d(x09), .O(new_n86_));
  oai22  g58(.a(new_n86_), .b(x08), .c(new_n40_), .d(new_n80_), .O(z7));
  ...
  nand4  g64(.a(new_n92_), .b(x14), .c(new_n31_), .d(x09), .O(new_n93_));
  oai22  g65(.a(new_n93_), .b(x08), .c(new_n40_), .d(new_n88_), .O(z8));
endmodule
