...
module FAU ( 
  ...
  oai21  g23(.a(x10), .b(x07), .c(x08), .O(new_n52_));
  ...
  nand4  g30(.a(new_n58_), .b(x09), .c(new_n31_), .d(x07), .O(new_n59_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(new_n59_), .O(z3));
  ...
  nand4  g37(.a(new_n65_), .b(x09), .c(new_n31_), .d(x07), .O(new_n66_));
  oai21  g38(.a(new_n52_), .b(new_n61_), .c(new_n66_), .O(z4));
  inv1   g39(.a(x07), .O(new_n68_));
  inv1   g40(.a(x09), .O(new_n69_));
  nand2  g41(.a(new_n56_), .b(x07), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n53_), .c(x14), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x15), .O(new_n72_));
  inv1   g44(.a(x15), .O(new_n73_));
  nand4  g45(.a(new_n53_), .b(new_n73_), .c(x14), .d(x13), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n31_), .c(new_n68_), .O(new_n76_));
  nand2  g48(.a(x08), .b(x04), .O(new_n77_));
  oai21  g49(.a(new_n76_), .b(x10), .c(new_n77_), .O(z5));
  and2   g50(.a(x15), .b(x14), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n70_), .c(new_n53_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(x16), .O(new_n81_));
  inv1   g53(.a(x16), .O(new_n82_));
  inv1   g54(.a(new_n62_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n82_), .c(x15), .d(x14), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n81_), .c(new_n69_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n31_), .c(new_n68_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x05), .O(new_n87_));
  oai21  g59(.a(new_n86_), .b(x10), .c(new_n87_), .O(z6));
  nand3  g60(.a(x16), .b(x15), .c(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n62_), .c(x17), .O(new_n90_));
  inv1   g62(.a(x17), .O(new_n91_));
  nand4  g63(.a(new_n79_), .b(new_n83_), .c(new_n91_), .d(x16), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n90_), .c(new_n69_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n31_), .c(new_n68_), .O(new_n94_));
  nand2  g66(.a(x08), .b(x06), .O(new_n95_));
  oai21  g67(.a(new_n94_), .b(x10), .c(new_n95_), .O(z7));
  nand3  g68(.a(new_n79_), .b(x17), .c(x16), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n62_), .c(x18), .O(new_n98_));
  nor2   g70(.a(new_n82_), .b(new_n73_), .O(new_n99_));
  nor2   g71(.a(new_n30_), .b(new_n56_), .O(new_n100_));
  nor2   g72(.a(x18), .b(new_n91_), .O(new_n101_));
  nand4  g73(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n53_), .O(new_n102_));
  nand2  g74(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nand3  g75(.a(new_n103_), .b(new_n32_), .c(x09), .O(new_n104_));
  aoi21  g76(.a(new_n104_), .b(new_n31_), .c(new_n68_), .O(z8));
endmodule
