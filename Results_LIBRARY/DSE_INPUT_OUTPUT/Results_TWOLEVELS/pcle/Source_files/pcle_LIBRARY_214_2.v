...
module FAU ( 
  ...
  oai21  g19(.a(new_n37_), .b(x02), .c(x08), .O(new_n48_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n37_), .c(x09), .O(new_n54_));
  ...
  oai21  g30(.a(new_n58_), .b(new_n49_), .c(new_n57_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n60_));
  nand2  g32(.a(new_n45_), .b(x03), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(z4));
  oai21  g34(.a(new_n37_), .b(x04), .c(x08), .O(new_n63_));
  nand4  g35(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n32_), .b(x14), .c(x13), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n49_), .c(new_n65_), .d(new_n32_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n37_), .c(x09), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n63_), .O(z5));
  nand3  g41(.a(x15), .b(x14), .c(x13), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n49_), .c(x16), .O(new_n71_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n75_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n83_));
  ...
  nor2   g59(.a(new_n72_), .b(new_n32_), .O(new_n88_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n92_));
