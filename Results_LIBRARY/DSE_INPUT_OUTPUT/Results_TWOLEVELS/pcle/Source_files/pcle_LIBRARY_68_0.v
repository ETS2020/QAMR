...
module FAU ( 
  ...
  nor2   g67(.a(new_n32_), .b(new_n63_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n88_), .c(new_n34_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n95_), .c(new_n52_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n29_), .c(new_n51_), .O(new_n99_));
