...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(x09), .c(new_n42_), .O(new_n49_));
  ...
  aoi21  g25(.a(new_n44_), .b(x00), .c(new_n42_), .O(new_n54_));
  ...
  nand2  g34(.a(new_n62_), .b(new_n55_), .O(z3));
  oai21  g35(.a(x12), .b(x00), .c(x13), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n45_), .c(x14), .O(new_n65_));
  nand3  g37(.a(new_n56_), .b(new_n34_), .c(x13), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n65_), .c(new_n30_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n42_), .c(x00), .O(new_n68_));
  nand2  g40(.a(x08), .b(x03), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(x10), .c(new_n69_), .O(z4));
  nand2  g42(.a(new_n54_), .b(x04), .O(new_n71_));
  nand3  g43(.a(new_n56_), .b(x14), .c(x13), .O(new_n72_));
  inv1   g44(.a(new_n72_), .O(new_n73_));
  nand3  g45(.a(new_n35_), .b(x14), .c(x13), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(new_n57_), .c(new_n73_), .d(new_n35_), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(x00), .c(new_n71_), .O(z5));
  nand2  g49(.a(new_n34_), .b(new_n29_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n56_), .c(x15), .d(x13), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(x16), .O(new_n80_));
  inv1   g52(.a(x16), .O(new_n81_));
  nand4  g53(.a(new_n33_), .b(new_n81_), .c(x15), .d(x14), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(new_n30_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n42_), .c(x00), .O(new_n84_));
  nand2  g56(.a(x08), .b(x05), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(x10), .c(new_n85_), .O(z6));
  nand2  g58(.a(new_n54_), .b(x06), .O(new_n87_));
  nand3  g59(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n32_), .c(x17), .O(new_n89_));
  inv1   g61(.a(x17), .O(new_n90_));
  nand3  g62(.a(new_n36_), .b(new_n90_), .c(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n32_), .c(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(x00), .c(new_n87_), .O(z7));
  nand2  g66(.a(new_n54_), .b(x07), .O(new_n95_));
  nand3  g67(.a(new_n36_), .b(x17), .c(x16), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n32_), .c(x18), .O(new_n97_));
  nor2   g69(.a(new_n81_), .b(new_n35_), .O(new_n98_));
