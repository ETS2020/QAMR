...
module FAU ( 
  ...
  oai21  g37(.a(new_n65_), .b(new_n51_), .c(new_n32_), .O(new_n66_));
  oai21  g38(.a(new_n31_), .b(new_n51_), .c(new_n66_), .O(z4));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n31_), .c(new_n51_), .O(new_n73_));
  ...
  nand2  g56(.a(new_n70_), .b(x03), .O(new_n85_));
  ...
  and2   g66(.a(x17), .b(x16), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n85_), .c(new_n84_), .d(x14), .O(new_n96_));
  ...
  aoi21  g72(.a(new_n100_), .b(new_n97_), .c(new_n52_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n31_), .c(new_n51_), .O(new_n102_));
