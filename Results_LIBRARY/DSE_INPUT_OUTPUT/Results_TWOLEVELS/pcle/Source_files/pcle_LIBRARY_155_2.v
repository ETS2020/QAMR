...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n42_), .c(x05), .O(new_n57_));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n42_), .c(x05), .O(new_n65_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n42_), .c(x05), .O(new_n73_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n39_), .c(x09), .d(new_n42_), .O(new_n82_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n42_), .c(x05), .O(new_n89_));
  ...
  aoi21  g70(.a(new_n98_), .b(new_n42_), .c(x05), .O(new_n99_));
