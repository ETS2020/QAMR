...
module FAU ( 
  ...
  nand4  g35(.a(new_n63_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n64_));
  oai21  g36(.a(new_n41_), .b(new_n58_), .c(new_n64_), .O(z4));
  nand4  g37(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(x15), .c(x09), .d(new_n29_), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n29_), .c(new_n51_), .O(new_n76_));
  ...
  inv1   g52(.a(new_n59_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n33_), .c(x16), .d(x14), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(new_n72_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n29_), .c(new_n51_), .O(new_n84_));
  nand2  g56(.a(x08), .b(x06), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(x10), .c(new_n85_), .O(z7));
  nand3  g58(.a(x17), .b(x16), .c(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n59_), .c(x18), .O(new_n88_));
  and2   g60(.a(x16), .b(x14), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n81_), .c(new_n34_), .d(x17), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n72_), .O(new_n91_));
