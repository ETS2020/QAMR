...
module FAU ( 
  ...
  inv1   g13(.a(new_n29_), .O(new_n42_));
  ...
  nand4  g18(.a(new_n46_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n44_), .O(z2));
  nand2  g20(.a(new_n43_), .b(x02), .O(new_n49_));
  nand2  g21(.a(new_n31_), .b(x13), .O(new_n50_));
  inv1   g22(.a(x13), .O(new_n51_));
  nand3  g23(.a(new_n51_), .b(x12), .c(x11), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n54_));
  ...
  oai21  g31(.a(new_n59_), .b(new_n31_), .c(new_n57_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n61_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x04), .c(new_n42_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand2  g43(.a(new_n43_), .b(x05), .O(new_n72_));
  oai21  g44(.a(new_n33_), .b(new_n31_), .c(x16), .O(new_n73_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n77_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n84_));
  aoi21  g56(.a(x08), .b(x06), .c(new_n42_), .O(new_n85_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n45_), .c(x09), .d(new_n30_), .O(new_n94_));
