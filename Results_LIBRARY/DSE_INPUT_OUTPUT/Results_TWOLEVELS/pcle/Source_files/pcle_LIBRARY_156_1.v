...
module FAU ( 
  ...
  aoi21  g21(.a(new_n50_), .b(new_n30_), .c(x16), .O(new_n51_));
  ...
  aoi21  g28(.a(new_n57_), .b(new_n55_), .c(new_n34_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n30_), .c(x16), .O(new_n59_));
  ...
  oai21  g37(.a(new_n66_), .b(new_n46_), .c(new_n64_), .O(new_n67_));
  ...
  oai21  g47(.a(new_n76_), .b(x08), .c(new_n39_), .O(new_n77_));
  ...
  nand4  g52(.a(new_n35_), .b(x18), .c(new_n39_), .d(new_n31_), .O(new_n82_));
