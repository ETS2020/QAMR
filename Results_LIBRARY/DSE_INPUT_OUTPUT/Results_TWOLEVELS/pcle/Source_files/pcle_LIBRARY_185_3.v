...
module FAU ( 
  ...
  nor2   g27(.a(new_n40_), .b(new_n31_), .O(new_n56_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n32_), .c(new_n59_), .O(new_n61_));
  ...
  aoi21  g46(.a(new_n74_), .b(new_n50_), .c(new_n72_), .O(new_n75_));
  nand3  g47(.a(new_n72_), .b(x15), .c(x14), .O(new_n76_));
  nor2   g48(.a(new_n76_), .b(new_n58_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n75_), .c(x09), .O(new_n78_));
  aoi21  g50(.a(x08), .b(x05), .c(new_n40_), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(x08), .c(new_n79_), .O(z6));
  nand2  g52(.a(new_n56_), .b(x06), .O(new_n81_));
  ...
  nand2  g68(.a(new_n96_), .b(new_n91_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(new_n89_), .O(z8));
endmodule
