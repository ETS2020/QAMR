...
module FAU ( 
  ...
  oai21  g16(.a(x08), .b(x00), .c(x01), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n47_));
  ...
  nand4  g24(.a(new_n52_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n31_), .c(new_n58_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n54_), .O(z4));
  ...
  aoi21  g48(.a(x08), .b(x05), .c(new_n54_), .O(new_n77_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x06), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n83_), .c(new_n54_), .O(z7));
  nand4  g57(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n57_), .c(x18), .O(new_n87_));
  nor2   g59(.a(new_n33_), .b(new_n65_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n67_), .c(new_n35_), .d(x17), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n91_));
  aoi21  g63(.a(x08), .b(x07), .c(new_n54_), .O(new_n92_));
