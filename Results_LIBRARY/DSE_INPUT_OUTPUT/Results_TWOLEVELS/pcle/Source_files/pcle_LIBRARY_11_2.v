...
module FAU ( 
  ...
  oai21  g28(.a(new_n42_), .b(x03), .c(x08), .O(new_n57_));
  oai21  g29(.a(x12), .b(x08), .c(x13), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(new_n43_), .c(x14), .O(new_n59_));
  nand3  g31(.a(new_n51_), .b(new_n33_), .c(x13), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n42_), .c(x09), .O(new_n62_));
  ...
  oai21  g43(.a(new_n42_), .b(x05), .c(x08), .O(new_n72_));
  ...
  nand3  g50(.a(new_n78_), .b(new_n42_), .c(x09), .O(new_n79_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n75_), .c(x18), .O(new_n90_));
  nor2   g62(.a(new_n76_), .b(new_n34_), .O(new_n91_));
  ...
  nand2  g67(.a(new_n95_), .b(new_n90_), .O(new_n96_));
