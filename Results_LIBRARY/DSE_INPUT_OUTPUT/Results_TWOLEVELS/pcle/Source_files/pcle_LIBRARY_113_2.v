...
module FAU ( 
  ...
  aoi21  g11(.a(x09), .b(new_n32_), .c(x10), .O(new_n40_));
  ...
  oai21  g25(.a(new_n53_), .b(new_n52_), .c(x09), .O(new_n54_));
  aoi21  g26(.a(x08), .b(x02), .c(new_n30_), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(x08), .c(new_n55_), .O(z3));
  inv1   g28(.a(x11), .O(new_n57_));
  nand2  g29(.a(x14), .b(x09), .O(new_n58_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n66_));
  nand2  g38(.a(x08), .b(x03), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n66_), .c(new_n60_), .O(z4));
  nand2  g40(.a(new_n43_), .b(x04), .O(new_n69_));
  ...
  oai22  g45(.a(new_n73_), .b(new_n33_), .c(new_n72_), .d(new_n70_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n69_), .O(z5));
  nand2  g48(.a(new_n43_), .b(x05), .O(new_n77_));
  oai21  g49(.a(new_n35_), .b(new_n33_), .c(x16), .O(new_n78_));
  ...
  oai21  g57(.a(new_n85_), .b(x08), .c(new_n29_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n57_), .O(new_n87_));
  nand3  g59(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n61_), .c(x17), .O(new_n89_));
  inv1   g61(.a(x17), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n79_), .c(new_n89_), .O(new_n92_));
  ...
  nand2  g67(.a(new_n43_), .b(x07), .O(new_n96_));
  nand4  g68(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n79_), .c(x18), .O(new_n98_));
  nor2   g70(.a(new_n80_), .b(new_n70_), .O(new_n99_));
  nor2   g71(.a(x18), .b(new_n90_), .O(new_n100_));
  nand3  g72(.a(new_n100_), .b(new_n99_), .c(new_n72_), .O(new_n101_));
