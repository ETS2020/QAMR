...
module FAU ( 
  ...
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n52_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n31_), .c(new_n51_), .O(new_n83_));
  ...
  nor2   g59(.a(new_n71_), .b(new_n30_), .O(new_n88_));
  nor2   g60(.a(x17), .b(new_n79_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(new_n80_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n52_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n31_), .c(new_n51_), .O(new_n92_));
  nand2  g64(.a(x08), .b(x06), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x10), .c(new_n93_), .O(z7));
  nand3  g66(.a(new_n88_), .b(x17), .c(x16), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n61_), .c(x18), .O(new_n96_));
  ...
  nand3  g72(.a(new_n100_), .b(new_n32_), .c(x09), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n31_), .c(new_n51_), .O(z8));
endmodule
