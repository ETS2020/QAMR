...
module FAU ( 
  ...
  oai21  g23(.a(new_n39_), .b(x08), .c(x02), .O(new_n52_));
  ...
  nand4  g29(.a(new_n57_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n58_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n40_), .c(x02), .O(new_n64_));
  ...
  nand4  g41(.a(new_n55_), .b(new_n69_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n30_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n40_), .c(x02), .O(new_n72_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n40_), .c(x02), .O(new_n81_));
  ...
  nand3  g58(.a(new_n33_), .b(new_n34_), .c(x16), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n31_), .c(new_n86_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x02), .c(new_n48_), .d(new_n84_), .O(z7));
  nand2  g62(.a(new_n77_), .b(new_n29_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n33_), .c(new_n78_), .d(x17), .O(new_n92_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(new_n30_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n40_), .c(x02), .O(new_n98_));
