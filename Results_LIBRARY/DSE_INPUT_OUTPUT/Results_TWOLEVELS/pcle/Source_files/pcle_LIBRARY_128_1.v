...
module FAU ( 
  ...
  nor2   g10(.a(new_n38_), .b(x09), .O(new_n39_));
  ...
  nand3  g16(.a(new_n38_), .b(x11), .c(x09), .O(new_n45_));
  oai21  g17(.a(new_n38_), .b(x11), .c(new_n45_), .O(new_n46_));
  ...
  xnor2a g21(.a(x13), .b(x11), .O(new_n50_));
  nand3  g22(.a(x13), .b(new_n38_), .c(x09), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(new_n38_), .c(new_n51_), .O(new_n52_));
  nand3  g24(.a(new_n52_), .b(new_n31_), .c(new_n30_), .O(new_n53_));
  aoi21  g25(.a(x08), .b(x02), .c(new_n39_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n53_), .O(z3));
  inv1   g27(.a(x03), .O(new_n56_));
  nand2  g28(.a(new_n40_), .b(x08), .O(new_n57_));
  ...
  nand2  g33(.a(new_n58_), .b(x13), .O(new_n62_));
  ...
  oai21  g36(.a(new_n57_), .b(new_n56_), .c(new_n64_), .O(z4));
  inv1   g37(.a(x15), .O(new_n66_));
  inv1   g38(.a(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n38_), .c(x09), .O(new_n68_));
  oai21  g40(.a(new_n58_), .b(new_n42_), .c(x12), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(new_n70_));
  nor4   g42(.a(new_n61_), .b(x15), .c(new_n58_), .d(new_n67_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n70_), .c(new_n31_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x04), .c(new_n39_), .O(new_n73_));
  ...
  oai21  g53(.a(new_n57_), .b(new_n75_), .c(new_n81_), .O(z6));
  inv1   g54(.a(x17), .O(new_n83_));
  nand2  g55(.a(x16), .b(x11), .O(new_n84_));
  nand4  g56(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n85_));
  aoi22  g57(.a(new_n85_), .b(x09), .c(new_n84_), .d(x12), .O(new_n86_));
  nor2   g58(.a(new_n66_), .b(new_n58_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n60_), .c(new_n83_), .d(x16), .O(new_n88_));
  oai21  g60(.a(new_n86_), .b(new_n83_), .c(new_n88_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n31_), .c(new_n30_), .O(new_n90_));
  aoi21  g62(.a(x08), .b(x06), .c(new_n39_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n90_), .O(z7));
  nand3  g64(.a(x17), .b(x16), .c(x11), .O(new_n93_));
  aoi22  g65(.a(new_n93_), .b(x12), .c(new_n85_), .d(x09), .O(new_n94_));
  nand4  g66(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n95_));
  nand4  g67(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n96_));
  oai22  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n29_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n31_), .c(new_n30_), .O(new_n98_));
  aoi21  g70(.a(x08), .b(x07), .c(new_n39_), .O(new_n99_));
