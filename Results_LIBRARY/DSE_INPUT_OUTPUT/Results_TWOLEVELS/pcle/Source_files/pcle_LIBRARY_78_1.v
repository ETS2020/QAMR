...
module FAU ( 
  ...
  nand2  g16(.a(new_n39_), .b(x02), .O(new_n45_));
  nand4  g17(.a(new_n42_), .b(x13), .c(new_n29_), .d(new_n31_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n45_), .O(z3));
  nand2  g19(.a(new_n39_), .b(x03), .O(new_n48_));
  nand4  g20(.a(new_n42_), .b(x14), .c(new_n29_), .d(new_n31_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n48_), .O(z4));
  nand2  g22(.a(x15), .b(x09), .O(new_n51_));
  oai21  g23(.a(new_n51_), .b(x08), .c(new_n29_), .O(new_n52_));
  ...
  nand2  g32(.a(x17), .b(x09), .O(new_n61_));
  ...
  nand2  g37(.a(new_n39_), .b(x07), .O(new_n66_));
  nand4  g38(.a(new_n42_), .b(x18), .c(new_n29_), .d(new_n31_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(z8));
endmodule
