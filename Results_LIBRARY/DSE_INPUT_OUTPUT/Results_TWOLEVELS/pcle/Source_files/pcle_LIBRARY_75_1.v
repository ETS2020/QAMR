...
module FAU ( 
  ...
  nor2   g16(.a(z0), .b(new_n32_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(x02), .O(new_n46_));
  ...
  aoi21  g22(.a(new_n50_), .b(new_n48_), .c(x17), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n31_), .c(x09), .d(new_n32_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n46_), .O(z3));
  nand2  g25(.a(new_n45_), .b(x03), .O(new_n54_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n29_), .c(new_n31_), .d(x09), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(x08), .c(new_n70_), .O(z6));
  nand4  g49(.a(x12), .b(x11), .c(x09), .d(new_n32_), .O(new_n78_));
  nand4  g50(.a(x16), .b(x15), .c(x14), .d(x13), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n78_), .c(new_n29_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n31_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n81_), .O(z7));
  nand2  g55(.a(x18), .b(x09), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(x08), .c(new_n29_), .O(new_n85_));
