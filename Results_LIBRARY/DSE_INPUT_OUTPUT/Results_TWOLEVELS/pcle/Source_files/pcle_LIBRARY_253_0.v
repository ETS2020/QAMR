...
module FAU ( 
  ...
  oai21  g16(.a(x14), .b(x10), .c(x08), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(x14), .c(new_n31_), .d(x09), .O(new_n47_));
  ...
  oai21  g28(.a(new_n45_), .b(new_n49_), .c(new_n56_), .O(z3));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n30_), .c(new_n50_), .O(new_n62_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n67_), .c(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n66_), .c(new_n58_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n30_), .c(new_n50_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(x10), .c(new_n72_), .O(z5));
  nand2  g45(.a(x15), .b(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n51_), .c(x16), .O(new_n75_));
  inv1   g47(.a(x16), .O(new_n76_));
  nand4  g48(.a(new_n68_), .b(new_n76_), .c(x15), .d(x13), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n75_), .c(new_n58_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n30_), .c(new_n50_), .O(new_n79_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n51_), .c(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(x16), .c(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n65_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x14), .c(new_n31_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n45_), .d(new_n82_), .O(z7));
  inv1   g61(.a(x07), .O(new_n90_));
  nand3  g62(.a(x17), .b(x16), .c(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n65_), .c(x18), .O(new_n92_));
  nand4  g64(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n65_), .c(new_n92_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x14), .c(new_n31_), .d(x09), .O(new_n95_));
  oai22  g67(.a(new_n95_), .b(x08), .c(new_n45_), .d(new_n90_), .O(z8));
endmodule
