...
module FAU ( 
  ...
  nand4  g33(.a(new_n61_), .b(x09), .c(new_n31_), .d(x01), .O(new_n62_));
  ...
  oai22  g42(.a(new_n70_), .b(new_n45_), .c(new_n41_), .d(new_n64_), .O(z5));
  inv1   g43(.a(x16), .O(new_n72_));
  nand3  g44(.a(x14), .b(x13), .c(x12), .O(new_n73_));
  nand2  g45(.a(x15), .b(x11), .O(new_n74_));
  aoi21  g46(.a(new_n73_), .b(x01), .c(new_n74_), .O(new_n75_));
  ...
  aoi21  g56(.a(new_n73_), .b(x01), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g61(.a(new_n89_), .b(new_n32_), .O(new_n90_));
