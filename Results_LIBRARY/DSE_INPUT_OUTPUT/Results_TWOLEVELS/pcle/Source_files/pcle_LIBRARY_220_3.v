...
module FAU ( 
  ...
  oai21  g15(.a(new_n31_), .b(new_n38_), .c(x08), .O(new_n44_));
  ...
  oai21  g26(.a(new_n44_), .b(new_n48_), .c(new_n54_), .O(z3));
  oai21  g27(.a(x12), .b(x10), .c(x13), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n39_), .c(x14), .O(new_n57_));
  ...
  oai21  g49(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n79_));
  oai21  g51(.a(new_n44_), .b(new_n72_), .c(new_n79_), .O(z6));
  inv1   g52(.a(x06), .O(new_n81_));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n75_), .c(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n75_), .c(new_n83_), .O(new_n86_));
  ...
  oai21  g62(.a(new_n90_), .b(new_n75_), .c(x18), .O(new_n91_));
