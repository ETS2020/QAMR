...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n51_));
  nand2  g23(.a(new_n37_), .b(x02), .O(new_n52_));
  ...
  nand3  g28(.a(new_n48_), .b(new_n54_), .c(x13), .O(new_n57_));
  ...
  aoi21  g34(.a(x13), .b(x12), .c(x08), .O(new_n63_));
  ...
  oai21  g58(.a(new_n39_), .b(x07), .c(x08), .O(new_n87_));
  nand2  g59(.a(new_n74_), .b(new_n29_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n56_), .c(new_n32_), .d(x17), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(x18), .O(new_n90_));
  nor2   g62(.a(new_n74_), .b(new_n66_), .O(new_n91_));
  nor2   g63(.a(new_n54_), .b(new_n47_), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n81_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n48_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n39_), .c(x09), .O(new_n96_));
