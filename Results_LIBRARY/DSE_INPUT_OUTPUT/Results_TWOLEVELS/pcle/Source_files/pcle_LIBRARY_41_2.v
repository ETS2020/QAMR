...
module FAU ( 
  ...
  oai21  g17(.a(x10), .b(new_n31_), .c(x08), .O(new_n46_));
  xor2a  g18(.a(x12), .b(x11), .O(new_n47_));
  nand4  g19(.a(new_n47_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n48_));
  oai22  g20(.a(new_n48_), .b(x00), .c(new_n46_), .d(new_n45_), .O(z2));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n32_), .c(x00), .O(new_n56_));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n60_), .c(new_n50_), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n32_), .c(x00), .O(new_n63_));
  ...
  oai22  g44(.a(new_n72_), .b(x00), .c(new_n46_), .d(new_n66_), .O(z5));
  ...
  oai22  g52(.a(new_n80_), .b(x00), .c(new_n46_), .d(new_n74_), .O(z6));
