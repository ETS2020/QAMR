...
module FAU ( 
  ...
  nand3  g18(.a(new_n46_), .b(new_n45_), .c(new_n42_), .O(z2));
  inv1   g19(.a(x02), .O(new_n48_));
  nand2  g20(.a(new_n42_), .b(x08), .O(new_n49_));
  ...
  inv1   g34(.a(new_n42_), .O(new_n63_));
  ...
  nand3  g48(.a(new_n41_), .b(x15), .c(x14), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n57_), .c(new_n76_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n79_));
  oai21  g51(.a(new_n49_), .b(new_n74_), .c(new_n79_), .O(z6));
  ...
  nor2   g63(.a(new_n41_), .b(new_n66_), .O(new_n92_));
