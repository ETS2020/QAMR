...
module FAU ( 
  ...
  aoi21  g27(.a(new_n55_), .b(new_n46_), .c(x01), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n46_), .c(x01), .O(new_n64_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n50_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n46_), .c(x01), .O(new_n72_));
  ...
  inv1   g49(.a(new_n59_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n77_), .c(x15), .d(x14), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n76_), .c(new_n50_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n46_), .c(x01), .O(new_n81_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n59_), .c(new_n86_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n91_));
  oai22  g63(.a(new_n91_), .b(x01), .c(new_n41_), .d(new_n84_), .O(z7));
  nand2  g64(.a(new_n77_), .b(new_n40_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n88_), .c(new_n78_), .d(x17), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x18), .O(new_n95_));
  inv1   g67(.a(new_n67_), .O(new_n96_));
  nor2   g68(.a(new_n77_), .b(new_n69_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n29_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n95_), .c(new_n50_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n46_), .c(x01), .O(new_n100_));
