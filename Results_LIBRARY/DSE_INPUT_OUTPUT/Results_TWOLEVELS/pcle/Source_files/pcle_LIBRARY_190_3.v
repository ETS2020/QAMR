...
module FAU ( 
  ...
  aoi21  g41(.a(new_n69_), .b(new_n30_), .c(x10), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n38_), .c(new_n71_), .O(z5));
  ...
  nand2  g61(.a(new_n89_), .b(new_n31_), .O(new_n90_));
  ...
  oai21  g69(.a(new_n97_), .b(x10), .c(x09), .O(new_n98_));
