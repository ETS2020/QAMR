...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n93_, new_n94_;
  and2   g00(.a(x10), .b(x02), .O(new_n29_));
  ...
  oai21  g19(.a(x10), .b(x08), .c(x02), .O(new_n48_));
  ...
  nor2   g26(.a(new_n29_), .b(new_n31_), .O(new_n55_));
  ...
  nand2  g35(.a(new_n55_), .b(x04), .O(new_n64_));
  ...
  nand2  g58(.a(new_n55_), .b(x07), .O(new_n87_));
