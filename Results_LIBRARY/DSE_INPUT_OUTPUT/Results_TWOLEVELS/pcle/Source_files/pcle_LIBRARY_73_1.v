...
module FAU ( 
  ...
  aoi21  g10(.a(new_n31_), .b(x09), .c(x10), .O(new_n39_));
  ...
  nand4  g23(.a(new_n51_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n52_));
  nand2  g24(.a(x08), .b(x02), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n52_), .O(z3));
  oai21  g26(.a(x12), .b(x10), .c(x13), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(new_n31_), .c(x14), .O(new_n56_));
  nand4  g28(.a(new_n33_), .b(x13), .c(x12), .d(x11), .O(new_n57_));
  aoi21  g29(.a(new_n57_), .b(new_n56_), .c(new_n30_), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(x10), .c(new_n42_), .O(new_n59_));
  ...
  nand3  g35(.a(new_n34_), .b(x14), .c(x13), .O(new_n64_));
  oai22  g36(.a(new_n64_), .b(new_n47_), .c(new_n63_), .d(new_n34_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n66_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n71_), .c(x17), .O(new_n79_));
  inv1   g51(.a(x17), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(x16), .c(x15), .d(x14), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n71_), .c(new_n79_), .O(new_n82_));
  ...
  nand4  g60(.a(new_n88_), .b(new_n63_), .c(x16), .d(x15), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n91_));
