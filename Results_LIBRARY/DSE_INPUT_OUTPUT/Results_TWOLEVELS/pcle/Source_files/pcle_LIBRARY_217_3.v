...
module FAU ( 
  ...
  nand2  g10(.a(x15), .b(x10), .O(new_n39_));
  ...
  nor2   g38(.a(x15), .b(new_n59_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n51_), .c(x13), .d(new_n31_), .O(new_n68_));
  ...
  aoi22  g63(.a(new_n90_), .b(x15), .c(new_n91_), .d(new_n31_), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n85_), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(x16), .c(x15), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(new_n90_), .c(new_n92_), .d(new_n29_), .O(new_n95_));
