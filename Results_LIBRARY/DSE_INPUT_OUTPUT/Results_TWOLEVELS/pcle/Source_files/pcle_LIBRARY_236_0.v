...
module FAU ( 
  ...
  aoi21  g35(.a(new_n63_), .b(new_n60_), .c(new_n29_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n65_));
  oai21  g37(.a(new_n40_), .b(new_n58_), .c(new_n65_), .O(z4));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n67_), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(new_n67_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n30_), .c(new_n29_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z7));
  nand2  g64(.a(x18), .b(new_n41_), .O(new_n93_));
  nand3  g65(.a(x17), .b(x16), .c(x15), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x14), .O(new_n95_));
  nand2  g67(.a(x18), .b(new_n61_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(x13), .O(new_n98_));
  nand2  g70(.a(x18), .b(new_n53_), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n100_));
  nand2  g72(.a(new_n100_), .b(x11), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n93_), .c(new_n67_), .O(new_n102_));
  aoi21  g74(.a(new_n102_), .b(new_n30_), .c(new_n29_), .O(new_n103_));
