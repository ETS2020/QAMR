...
module FAU ( 
  ...
  nor2   g53(.a(new_n64_), .b(new_n56_), .O(new_n82_));
  ...
  oai21  g58(.a(new_n39_), .b(new_n79_), .c(new_n86_), .O(z7));
  oai21  g59(.a(new_n31_), .b(x07), .c(x08), .O(new_n88_));
  nand2  g60(.a(new_n74_), .b(new_n30_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n82_), .c(new_n58_), .d(x17), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nor2   g63(.a(new_n74_), .b(new_n64_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n31_), .c(x09), .O(new_n95_));
