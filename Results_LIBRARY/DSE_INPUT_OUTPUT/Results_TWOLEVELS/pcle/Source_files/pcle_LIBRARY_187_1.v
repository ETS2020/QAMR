...
module FAU ( 
  ...
  nand3  g19(.a(new_n46_), .b(x12), .c(x11), .O(new_n48_));
  oai21  g20(.a(new_n47_), .b(new_n46_), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g27(.a(new_n47_), .b(new_n53_), .c(x13), .O(new_n56_));
  ...
  nand4  g37(.a(new_n47_), .b(new_n65_), .c(x14), .d(x13), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(x10), .c(new_n30_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  nand3  g42(.a(x15), .b(x14), .c(x11), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n62_), .c(x16), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  nand4  g45(.a(new_n55_), .b(new_n73_), .c(x15), .d(x14), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n72_), .c(new_n61_), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(x10), .c(new_n30_), .O(new_n76_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n54_), .c(new_n80_), .O(new_n84_));
  ...
  nand2  g59(.a(new_n73_), .b(new_n31_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n82_), .c(new_n55_), .d(x17), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(x18), .O(new_n90_));
  nor2   g62(.a(new_n73_), .b(new_n65_), .O(new_n91_));
  nor2   g63(.a(new_n53_), .b(new_n46_), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n81_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n47_), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n90_), .c(new_n61_), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(x10), .c(new_n30_), .O(new_n96_));
