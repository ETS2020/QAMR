...
module FAU ( 
  ...
  oai21  g27(.a(new_n39_), .b(x03), .c(x08), .O(new_n56_));
  nand3  g28(.a(x13), .b(x12), .c(x11), .O(new_n57_));
  inv1   g29(.a(new_n57_), .O(new_n58_));
  nand2  g30(.a(new_n32_), .b(x13), .O(new_n59_));
  oai22  g31(.a(new_n59_), .b(new_n49_), .c(new_n58_), .d(new_n32_), .O(new_n60_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n49_), .c(new_n64_), .d(new_n33_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n67_));
  nor2   g39(.a(new_n39_), .b(new_n29_), .O(new_n68_));
  ...
  nand4  g55(.a(new_n58_), .b(new_n34_), .c(new_n83_), .d(x16), .O(new_n84_));
  ...
  nand2  g66(.a(new_n68_), .b(x07), .O(new_n95_));
