...
module FAU ( 
  ...
  oai21  g29(.a(new_n57_), .b(new_n30_), .c(new_n55_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n39_), .c(new_n29_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x03), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n59_), .c(new_n37_), .O(z4));
  oai21  g33(.a(new_n37_), .b(x04), .c(x08), .O(new_n62_));
  ...
  oai22  g38(.a(new_n66_), .b(new_n30_), .c(new_n65_), .d(new_n63_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n62_), .O(z5));
  oai21  g41(.a(new_n32_), .b(new_n30_), .c(x16), .O(new_n70_));
  ...
  nand3  g45(.a(new_n73_), .b(new_n39_), .c(new_n29_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n74_), .c(new_n37_), .O(z6));
  ...
  nand4  g54(.a(new_n82_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n83_));
  ...
  nor2   g58(.a(new_n71_), .b(new_n63_), .O(new_n87_));
  nor2   g59(.a(x18), .b(new_n80_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n65_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n39_), .c(new_n29_), .O(new_n91_));
  nand2  g63(.a(x08), .b(x07), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n91_), .c(new_n37_), .O(z8));
endmodule
