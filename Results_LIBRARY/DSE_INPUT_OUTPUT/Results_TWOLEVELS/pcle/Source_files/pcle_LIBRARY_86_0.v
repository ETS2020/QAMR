...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n112_;
  nor2   g00(.a(x13), .b(x11), .O(new_n29_));
  ...
  nand3  g19(.a(x13), .b(new_n47_), .c(new_n31_), .O(new_n48_));
  ...
  oai21  g38(.a(new_n66_), .b(new_n34_), .c(new_n64_), .O(new_n67_));
  ...
  nand3  g42(.a(new_n33_), .b(x15), .c(new_n31_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x13), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n47_), .O(new_n73_));
  ...
  nand2  g54(.a(x16), .b(new_n55_), .O(new_n83_));
  nand3  g55(.a(new_n36_), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n63_), .c(new_n83_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x11), .O(new_n86_));
  nand3  g58(.a(new_n35_), .b(x15), .c(x14), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(x16), .c(x13), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n31_), .c(x09), .d(new_n44_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n82_), .O(z6));
  nand2  g63(.a(x17), .b(new_n55_), .O(new_n92_));
  nand3  g64(.a(new_n37_), .b(x16), .c(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n74_), .c(new_n92_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x11), .O(new_n95_));
  nand2  g67(.a(new_n76_), .b(x13), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(x16), .c(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n34_), .c(x17), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(new_n95_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n31_), .c(x09), .d(new_n44_), .O(new_n100_));
  aoi21  g72(.a(x08), .b(x06), .c(new_n29_), .O(new_n101_));
  nand2  g73(.a(new_n101_), .b(new_n100_), .O(z7));
  nand2  g74(.a(x18), .b(new_n55_), .O(new_n103_));
  nand4  g75(.a(new_n38_), .b(x17), .c(x16), .d(x15), .O(new_n104_));
  oai21  g76(.a(new_n104_), .b(new_n74_), .c(new_n103_), .O(new_n105_));
  nand2  g77(.a(new_n105_), .b(x11), .O(new_n106_));
  nand3  g78(.a(x14), .b(x12), .c(x11), .O(new_n107_));
  nand3  g79(.a(new_n96_), .b(x17), .c(x16), .O(new_n108_));
  oai21  g80(.a(new_n108_), .b(new_n107_), .c(x18), .O(new_n109_));
  nand2  g81(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand4  g82(.a(new_n110_), .b(new_n31_), .c(x09), .d(new_n44_), .O(new_n111_));
  aoi21  g83(.a(x08), .b(x07), .c(new_n29_), .O(new_n112_));
  nand2  g84(.a(new_n112_), .b(new_n111_), .O(z8));
endmodule
