...
module FAU ( 
  ...
  oai21  g11(.a(x15), .b(new_n31_), .c(x08), .O(new_n40_));
  ...
  nand3  g40(.a(new_n51_), .b(x14), .c(x13), .O(new_n69_));
  ...
  oai21  g61(.a(new_n40_), .b(new_n83_), .c(new_n89_), .O(z7));
  oai21  g62(.a(new_n39_), .b(new_n29_), .c(new_n31_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n64_), .O(new_n92_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n69_), .c(new_n94_), .O(new_n96_));
