...
module FAU ( 
  ...
  aoi21  g26(.a(new_n54_), .b(new_n30_), .c(new_n41_), .O(new_n55_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n59_), .c(new_n49_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n30_), .c(new_n41_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(x10), .c(new_n65_), .O(z4));
  inv1   g38(.a(x11), .O(new_n67_));
  nand2  g39(.a(x14), .b(x13), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x12), .O(new_n69_));
  inv1   g41(.a(x12), .O(new_n70_));
  nand2  g42(.a(x15), .b(new_n70_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n67_), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n42_), .c(x09), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(x08), .c(x15), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n31_), .O(new_n75_));
  nand2  g47(.a(x08), .b(x04), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z5));
  nand2  g49(.a(x14), .b(x13), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n50_), .c(x16), .O(new_n79_));
  inv1   g51(.a(x16), .O(new_n80_));
  nand4  g52(.a(new_n61_), .b(new_n80_), .c(x14), .d(x13), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n79_), .c(new_n49_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n30_), .c(new_n41_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z6));
  inv1   g57(.a(x06), .O(new_n86_));
  nand3  g58(.a(x16), .b(x14), .c(x13), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n50_), .c(x17), .O(new_n88_));
  inv1   g60(.a(x17), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(x16), .c(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n58_), .c(new_n88_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(x15), .c(new_n31_), .d(x09), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(x08), .c(new_n40_), .d(new_n86_), .O(z7));
  inv1   g65(.a(new_n58_), .O(new_n94_));
  nand2  g66(.a(new_n80_), .b(x15), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(x17), .d(x14), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x18), .O(new_n97_));
  nor2   g69(.a(new_n80_), .b(new_n60_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n94_), .c(new_n29_), .d(x17), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n97_), .c(new_n49_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n30_), .c(new_n41_), .O(new_n101_));
