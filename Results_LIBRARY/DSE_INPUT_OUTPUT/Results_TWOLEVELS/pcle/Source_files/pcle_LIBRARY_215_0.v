...
module FAU ( 
  ...
  nor2   g01(.a(x10), .b(new_n29_), .O(new_n30_));
  ...
  oai21  g29(.a(new_n56_), .b(x08), .c(new_n57_), .O(z3));
  ...
  nand3  g35(.a(x18), .b(new_n63_), .c(x13), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n31_), .c(new_n62_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n60_), .c(x09), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x18), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n59_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x03), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z4));
  oai21  g42(.a(new_n36_), .b(new_n31_), .c(x15), .O(new_n71_));
  nand3  g43(.a(new_n33_), .b(x14), .c(x13), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n31_), .c(new_n71_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(x18), .c(new_n60_), .d(x09), .O(new_n74_));
  nand2  g46(.a(x08), .b(x04), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(x08), .c(new_n75_), .O(z5));
  nand3  g48(.a(x15), .b(x14), .c(x13), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n31_), .c(x16), .O(new_n78_));
  nand3  g50(.a(new_n34_), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n61_), .c(new_n78_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(x18), .c(new_n60_), .d(x09), .O(new_n81_));
  ...
  nand4  g57(.a(new_n35_), .b(x16), .c(x15), .d(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n61_), .c(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x18), .c(new_n60_), .d(x09), .O(new_n88_));
  ...
  nand4  g64(.a(new_n92_), .b(x13), .c(x12), .d(x11), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x18), .c(new_n60_), .d(x09), .O(new_n94_));
