...
module FAU ( 
  ...
  aoi21  g25(.a(new_n53_), .b(new_n37_), .c(new_n36_), .O(new_n54_));
  nand2  g26(.a(x08), .b(x02), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(x10), .c(new_n55_), .O(z3));
  aoi21  g28(.a(new_n38_), .b(new_n36_), .c(new_n37_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x03), .O(new_n58_));
  nand2  g30(.a(new_n30_), .b(x14), .O(new_n59_));
  inv1   g31(.a(x14), .O(new_n60_));
  nand3  g32(.a(new_n48_), .b(new_n60_), .c(x13), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n59_), .c(x10), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(x09), .c(new_n37_), .d(x00), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n58_), .O(z4));
  nand2  g36(.a(new_n51_), .b(x00), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n48_), .c(x14), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x15), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand4  g40(.a(new_n48_), .b(new_n68_), .c(x14), .d(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n67_), .c(new_n29_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n37_), .c(new_n36_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(x10), .c(new_n72_), .O(z5));
  nand3  g45(.a(new_n65_), .b(new_n48_), .c(new_n32_), .O(new_n74_));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n37_), .c(new_n36_), .O(new_n80_));
  ...
  nand3  g58(.a(new_n32_), .b(new_n86_), .c(x16), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n30_), .c(new_n85_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n38_), .c(x09), .d(new_n37_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n36_), .c(new_n83_), .O(z7));
  nand2  g62(.a(new_n57_), .b(x07), .O(new_n91_));
  nand3  g63(.a(new_n32_), .b(x17), .c(x16), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n30_), .c(x18), .O(new_n93_));
  nor2   g65(.a(new_n76_), .b(new_n68_), .O(new_n94_));
  nor2   g66(.a(new_n60_), .b(new_n51_), .O(new_n95_));
  ...
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n37_), .d(x00), .O(new_n99_));
