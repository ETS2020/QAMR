...
module FAU ( 
  ...
  aoi21  g33(.a(x08), .b(x03), .c(new_n39_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z4));
  inv1   g35(.a(new_n39_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(x08), .c(x04), .O(new_n65_));
  inv1   g37(.a(x12), .O(new_n66_));
  nand2  g38(.a(x15), .b(new_n50_), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(x14), .c(x13), .d(new_n38_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(new_n70_));
  nor2   g42(.a(new_n68_), .b(x12), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n70_), .c(x11), .O(new_n72_));
  oai21  g44(.a(new_n58_), .b(new_n41_), .c(x15), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n65_), .O(z5));
  oai21  g48(.a(new_n68_), .b(x08), .c(x05), .O(new_n77_));
  nand3  g49(.a(x15), .b(x14), .c(x13), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n48_), .c(x16), .O(new_n79_));
  ...
  nand2  g56(.a(x09), .b(new_n30_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  nand3  g58(.a(x17), .b(new_n68_), .c(new_n31_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n85_), .c(new_n86_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n38_), .O(new_n89_));
  nand3  g61(.a(x16), .b(x14), .c(x13), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n48_), .c(x17), .O(new_n91_));
  inv1   g63(.a(x17), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(x16), .c(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n56_), .c(new_n91_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n86_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x15), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n89_), .O(z7));
  nand4  g70(.a(new_n29_), .b(x17), .c(x16), .d(x14), .O(new_n99_));
  oai22  g71(.a(new_n99_), .b(new_n56_), .c(new_n29_), .d(x16), .O(new_n100_));
  nand2  g72(.a(new_n100_), .b(x15), .O(new_n101_));
  nand3  g73(.a(x17), .b(x15), .c(x14), .O(new_n102_));
  oai21  g74(.a(new_n102_), .b(new_n56_), .c(x18), .O(new_n103_));
  nand2  g75(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand4  g76(.a(new_n104_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n105_));
  aoi21  g77(.a(x08), .b(x07), .c(new_n39_), .O(new_n106_));
