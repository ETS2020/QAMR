...
module FAU ( 
  ...
  oai21  g43(.a(new_n31_), .b(x05), .c(x08), .O(new_n72_));
  nor2   g44(.a(new_n67_), .b(new_n55_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n63_), .c(x16), .O(new_n75_));
  inv1   g47(.a(x16), .O(new_n76_));
  nand4  g48(.a(new_n57_), .b(new_n76_), .c(x15), .d(x14), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n31_), .c(x09), .O(new_n79_));
  ...
  oai21  g59(.a(new_n39_), .b(new_n81_), .c(new_n87_), .O(z7));
  oai21  g60(.a(new_n31_), .b(x07), .c(x08), .O(new_n89_));
  aoi21  g61(.a(new_n76_), .b(new_n30_), .c(new_n84_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n73_), .c(new_n57_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x18), .O(new_n92_));
  nor2   g64(.a(new_n76_), .b(new_n67_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n84_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n64_), .d(new_n49_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(new_n31_), .c(x09), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n89_), .O(z8));
endmodule
