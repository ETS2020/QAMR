...
module FAU ( 
  ...
  aoi21  g37(.a(new_n65_), .b(new_n32_), .c(x00), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n71_), .c(new_n60_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n32_), .c(x00), .O(new_n75_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n79_), .c(new_n60_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n32_), .c(x00), .O(new_n85_));
  ...
  oai22  g66(.a(new_n94_), .b(x00), .c(new_n52_), .d(new_n88_), .O(z7));
  inv1   g67(.a(x07), .O(new_n96_));
  nand4  g68(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n81_), .c(x18), .O(new_n98_));
  inv1   g70(.a(new_n70_), .O(new_n99_));
  nor2   g71(.a(new_n80_), .b(new_n72_), .O(new_n100_));
  nor2   g72(.a(x18), .b(new_n91_), .O(new_n101_));
  nand4  g73(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n63_), .O(new_n102_));
  aoi21  g74(.a(new_n102_), .b(new_n98_), .c(x10), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n104_));
  oai21  g76(.a(new_n52_), .b(new_n96_), .c(new_n104_), .O(z8));
endmodule
