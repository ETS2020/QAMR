...
module FAU ( 
  ...
  aoi21  g11(.a(x09), .b(x02), .c(new_n39_), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(x00), .O(new_n41_));
  nor2   g13(.a(x11), .b(x10), .O(new_n42_));
  nand4  g14(.a(new_n42_), .b(x09), .c(new_n39_), .d(new_n29_), .O(new_n43_));
  ...
  nand4  g19(.a(new_n47_), .b(new_n46_), .c(x09), .d(new_n39_), .O(new_n48_));
  oai21  g20(.a(new_n48_), .b(x02), .c(new_n45_), .O(z2));
  oai21  g21(.a(x09), .b(x08), .c(x02), .O(new_n50_));
  ...
  nand4  g27(.a(new_n55_), .b(new_n46_), .c(x09), .d(new_n39_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n50_), .O(z3));
  nand2  g29(.a(new_n32_), .b(x14), .O(new_n58_));
  inv1   g30(.a(x14), .O(new_n59_));
  nand3  g31(.a(new_n53_), .b(new_n59_), .c(x13), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n58_), .c(x10), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n39_), .c(x02), .O(new_n62_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n52_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n46_), .c(x09), .d(new_n39_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(x02), .c(new_n65_), .O(z5));
  ...
  oai21  g49(.a(new_n77_), .b(new_n32_), .c(new_n75_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n46_), .c(x09), .d(new_n39_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(x02), .c(new_n73_), .O(z6));
  aoi21  g52(.a(x15), .b(x14), .c(x02), .O(new_n81_));
  nand4  g53(.a(x16), .b(x13), .c(x12), .d(x11), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n81_), .c(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nand4  g56(.a(new_n34_), .b(new_n33_), .c(new_n84_), .d(x16), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n83_), .c(x10), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n39_), .c(x02), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  oai21  g60(.a(new_n87_), .b(new_n30_), .c(new_n88_), .O(z7));
  ...
  nand4  g67(.a(new_n95_), .b(x09), .c(new_n39_), .d(new_n29_), .O(new_n96_));
