...
module FAU ( 
  ...
  oai21  g39(.a(new_n67_), .b(new_n31_), .c(new_n65_), .O(new_n68_));
  ...
  aoi21  g48(.a(x08), .b(x05), .c(new_n43_), .O(new_n77_));
  ...
  aoi21  g56(.a(x08), .b(x06), .c(new_n43_), .O(new_n85_));
  ...
  nor2   g62(.a(new_n73_), .b(new_n66_), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n81_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
