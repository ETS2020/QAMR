...
module FAU ( 
  ...
  nand4  g16(.a(new_n44_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(new_n42_), .c(new_n31_), .O(z1));
  inv1   g18(.a(x00), .O(new_n47_));
  oai21  g19(.a(x08), .b(new_n47_), .c(x01), .O(new_n48_));
  xor2a  g20(.a(x12), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n50_));
  ...
  nand4  g27(.a(new_n55_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n56_));
  ...
  nand4  g35(.a(new_n63_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n64_));
  ...
  nand4  g43(.a(new_n71_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n78_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n85_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n43_), .c(x09), .d(new_n32_), .O(new_n93_));
