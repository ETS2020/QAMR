...
module FAU ( 
  ...
  nand2  g13(.a(new_n41_), .b(new_n38_), .O(new_n42_));
  nand2  g14(.a(x08), .b(x00), .O(new_n43_));
  nand2  g15(.a(new_n43_), .b(new_n42_), .O(z1));
  nand2  g16(.a(x12), .b(new_n38_), .O(new_n45_));
  nand2  g17(.a(x08), .b(x01), .O(new_n46_));
  nand2  g18(.a(x09), .b(new_n30_), .O(new_n47_));
  inv1   g19(.a(new_n47_), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n39_), .c(x11), .d(new_n31_), .O(new_n49_));
  nand3  g21(.a(new_n49_), .b(new_n46_), .c(new_n45_), .O(z2));
  nand3  g22(.a(new_n45_), .b(x08), .c(x02), .O(new_n51_));
  inv1   g23(.a(x13), .O(new_n52_));
  nand3  g24(.a(new_n52_), .b(x12), .c(x11), .O(new_n53_));
  oai21  g25(.a(new_n52_), .b(x12), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g30(.a(new_n58_), .b(new_n47_), .c(x11), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(x12), .O(new_n60_));
  aoi21  g32(.a(x13), .b(x12), .c(new_n57_), .O(new_n61_));
  ...
  oai21  g38(.a(new_n66_), .b(new_n40_), .c(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x12), .O(new_n68_));
  nand3  g40(.a(x14), .b(x13), .c(x12), .O(new_n69_));
  inv1   g41(.a(new_n69_), .O(new_n70_));
  nor2   g42(.a(new_n70_), .b(new_n65_), .O(new_n71_));
  ...
  nand3  g46(.a(new_n45_), .b(x08), .c(x05), .O(new_n75_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n76_), .c(new_n78_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x11), .O(new_n82_));
  nand2  g54(.a(x16), .b(new_n39_), .O(new_n83_));
  ...
  nand3  g58(.a(new_n48_), .b(x13), .c(new_n31_), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nor2   g60(.a(new_n65_), .b(new_n57_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(x16), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n87_), .c(x11), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x12), .O(new_n92_));
  nand3  g64(.a(x16), .b(x15), .c(x14), .O(new_n93_));
  nor2   g65(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  nor2   g66(.a(new_n94_), .b(new_n88_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n96_));
  nand2  g68(.a(x08), .b(x06), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(z7));
  nand4  g70(.a(new_n89_), .b(new_n29_), .c(x17), .d(x16), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n87_), .c(x11), .O(new_n100_));
  nand2  g72(.a(new_n100_), .b(x12), .O(new_n101_));
  nand3  g73(.a(x17), .b(x16), .c(x15), .O(new_n102_));
  inv1   g74(.a(new_n102_), .O(new_n103_));
  aoi21  g75(.a(new_n103_), .b(new_n70_), .c(new_n29_), .O(new_n104_));
