...
module FAU ( 
  ...
  nand2  g22(.a(new_n41_), .b(x08), .O(new_n51_));
  nand3  g23(.a(new_n34_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n33_), .b(new_n34_), .c(new_n52_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n54_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n54_), .O(z3));
  ...
  oai21  g31(.a(new_n59_), .b(new_n32_), .c(new_n58_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n61_));
  oai21  g33(.a(new_n51_), .b(new_n56_), .c(new_n61_), .O(z4));
  ...
  aoi21  g40(.a(x08), .b(x04), .c(new_n40_), .O(new_n69_));
  ...
  oai21  g49(.a(new_n51_), .b(new_n71_), .c(new_n77_), .O(z6));
  nand2  g50(.a(x17), .b(new_n63_), .O(new_n79_));
  nand4  g51(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n57_), .c(new_n79_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x09), .O(new_n82_));
  nand3  g54(.a(x16), .b(x14), .c(x13), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n32_), .c(x17), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n31_), .c(new_n30_), .O(new_n86_));
  aoi21  g58(.a(x08), .b(x06), .c(new_n40_), .O(new_n87_));
  ...
  nor2   g63(.a(x18), .b(new_n29_), .O(new_n92_));
  ...
  oai21  g67(.a(new_n51_), .b(new_n89_), .c(new_n95_), .O(z8));
endmodule
