...
module FAU ( 
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(new_n29_), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n39_), .c(new_n52_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x02), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(x10), .c(new_n60_), .O(z3));
  inv1   g33(.a(x03), .O(new_n62_));
  oai21  g34(.a(x10), .b(x05), .c(x08), .O(new_n63_));
  nand2  g35(.a(new_n30_), .b(x14), .O(new_n64_));
  nand3  g36(.a(new_n53_), .b(new_n32_), .c(x13), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(x10), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(x09), .c(new_n39_), .d(x05), .O(new_n67_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n67_), .O(z4));
  nand2  g40(.a(new_n56_), .b(x05), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n53_), .c(x14), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(x15), .O(new_n71_));
  nand4  g43(.a(new_n53_), .b(new_n33_), .c(x14), .d(x13), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n71_), .c(new_n29_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n39_), .c(new_n52_), .O(new_n74_));
  ...
  nand3  g53(.a(new_n81_), .b(new_n38_), .c(x09), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n39_), .c(new_n52_), .O(z6));
  ...
  nand3  g59(.a(new_n34_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n30_), .c(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n38_), .c(x09), .d(new_n39_), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(new_n52_), .c(new_n63_), .d(new_n84_), .O(z7));
  inv1   g63(.a(x07), .O(new_n92_));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n30_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n79_), .b(new_n33_), .O(new_n95_));
  nor2   g67(.a(new_n32_), .b(new_n56_), .O(new_n96_));
  nor2   g68(.a(x18), .b(new_n87_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n53_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n94_), .c(x10), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(x09), .c(new_n39_), .d(x05), .O(new_n100_));
  oai21  g72(.a(new_n63_), .b(new_n92_), .c(new_n100_), .O(z8));
endmodule
