...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(x16), .c(new_n31_), .d(x09), .O(new_n46_));
  oai22  g18(.a(new_n46_), .b(x08), .c(new_n40_), .d(new_n44_), .O(z2));
  inv1   g19(.a(x16), .O(new_n48_));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n30_), .c(new_n48_), .O(new_n55_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n30_), .c(new_n48_), .O(new_n64_));
  ...
  oai22  g45(.a(new_n73_), .b(x08), .c(new_n40_), .d(new_n67_), .O(z5));
  nand2  g46(.a(x16), .b(new_n41_), .O(new_n75_));
  nand2  g47(.a(x16), .b(new_n70_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x14), .c(x13), .O(new_n77_));
  nor2   g49(.a(new_n48_), .b(x12), .O(new_n78_));
  aoi21  g50(.a(new_n77_), .b(x12), .c(new_n78_), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n41_), .c(new_n75_), .O(new_n80_));
  ...
  nor2   g57(.a(new_n70_), .b(new_n60_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n61_), .c(x13), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x17), .O(new_n88_));
  inv1   g60(.a(new_n58_), .O(new_n89_));
  nor2   g61(.a(x17), .b(new_n70_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(x14), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n88_), .c(new_n49_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n30_), .c(new_n48_), .O(new_n93_));
  nand2  g65(.a(x08), .b(x06), .O(new_n94_));
  oai21  g66(.a(new_n93_), .b(x10), .c(new_n94_), .O(z7));
  nand3  g67(.a(x17), .b(x15), .c(x14), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n58_), .c(x18), .O(new_n97_));
  nand4  g69(.a(new_n86_), .b(new_n89_), .c(new_n29_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n97_), .c(new_n49_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n30_), .c(new_n48_), .O(new_n100_));
