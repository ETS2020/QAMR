...
module FAU ( 
  ...
  oai21  g18(.a(x16), .b(x10), .c(x08), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(x16), .c(new_n39_), .d(x09), .O(new_n49_));
  ...
  oai21  g39(.a(new_n35_), .b(new_n30_), .c(x15), .O(new_n68_));
  nand4  g40(.a(new_n31_), .b(new_n32_), .c(x14), .d(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(new_n70_));
  ...
  nand2  g45(.a(new_n32_), .b(x14), .O(new_n74_));
  nand2  g46(.a(x16), .b(new_n63_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(x13), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x12), .O(new_n77_));
  inv1   g49(.a(x12), .O(new_n78_));
  nand2  g50(.a(x16), .b(new_n78_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n77_), .c(x11), .O(new_n80_));
  ...
  nand3  g57(.a(x15), .b(x14), .c(x13), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n30_), .c(x17), .O(new_n87_));
  inv1   g59(.a(new_n61_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n33_), .c(x15), .d(x14), .O(new_n89_));
  ...
  nand4  g68(.a(new_n34_), .b(x17), .c(x15), .d(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n61_), .c(new_n96_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x16), .c(new_n39_), .d(x09), .O(new_n99_));
  oai22  g71(.a(new_n99_), .b(x08), .c(new_n47_), .d(new_n94_), .O(z8));
endmodule
