...
module FAU ( 
  ...
  nand4  g24(.a(x16), .b(new_n52_), .c(x12), .d(x11), .O(new_n53_));
  ...
  nand3  g32(.a(x16), .b(new_n58_), .c(x13), .O(new_n61_));
  ...
  oai21  g41(.a(new_n69_), .b(new_n50_), .c(x15), .O(new_n70_));
  inv1   g42(.a(x15), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(x14), .c(x13), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n50_), .c(new_n70_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(x16), .c(new_n31_), .d(x09), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(x08), .c(new_n40_), .d(new_n68_), .O(z5));
  inv1   g47(.a(x05), .O(new_n76_));
  nor2   g48(.a(new_n71_), .b(new_n58_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(x13), .c(x12), .d(x11), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(x16), .c(new_n31_), .d(x09), .O(new_n79_));
  oai22  g51(.a(new_n79_), .b(x08), .c(new_n40_), .d(new_n76_), .O(z6));
  nand3  g52(.a(x15), .b(x14), .c(x13), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n50_), .c(x17), .O(new_n82_));
  nor2   g54(.a(x17), .b(new_n71_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n60_), .c(x14), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n82_), .c(new_n49_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n30_), .c(new_n48_), .O(new_n86_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n60_), .c(new_n29_), .d(x17), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n90_), .c(new_n49_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n30_), .c(new_n48_), .O(new_n94_));
