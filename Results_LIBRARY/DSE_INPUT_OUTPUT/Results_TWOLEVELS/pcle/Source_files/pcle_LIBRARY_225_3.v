...
module FAU ( 
  ...
  oai21  g39(.a(new_n67_), .b(new_n49_), .c(new_n65_), .O(new_n68_));
  ...
  nand2  g60(.a(x18), .b(new_n66_), .O(new_n89_));
  nand4  g61(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n64_), .c(new_n89_), .O(new_n91_));
  ...
  aoi21  g68(.a(x08), .b(x07), .c(new_n70_), .O(new_n97_));
