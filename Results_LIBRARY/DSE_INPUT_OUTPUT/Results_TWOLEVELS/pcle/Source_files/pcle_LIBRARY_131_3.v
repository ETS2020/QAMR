...
module FAU ( 
  ...
  oai21  g12(.a(new_n30_), .b(new_n38_), .c(new_n40_), .O(z1));
  oai21  g13(.a(x01), .b(x00), .c(x08), .O(new_n42_));
  ...
  nand3  g23(.a(x08), .b(x02), .c(new_n38_), .O(new_n52_));
  ...
  nand3  g31(.a(x08), .b(x03), .c(new_n38_), .O(new_n60_));
  ...
  nand3  g39(.a(x08), .b(x04), .c(new_n38_), .O(new_n68_));
  ...
  nand3  g47(.a(x08), .b(x05), .c(new_n38_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  oai21  g49(.a(x06), .b(x00), .c(x08), .O(new_n78_));
  ...
  oai21  g57(.a(x07), .b(x00), .c(x08), .O(new_n86_));
