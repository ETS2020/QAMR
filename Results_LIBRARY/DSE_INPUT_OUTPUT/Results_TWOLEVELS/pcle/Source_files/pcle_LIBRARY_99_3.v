...
module FAU ( 
  ...
  nand3  g09(.a(x18), .b(x17), .c(x15), .O(new_n38_));
  ...
  nand3  g23(.a(new_n36_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n33_), .b(new_n36_), .c(new_n52_), .O(new_n53_));
  ...
  nand2  g30(.a(new_n37_), .b(x13), .O(new_n59_));
  oai22  g31(.a(new_n59_), .b(new_n32_), .c(new_n58_), .d(new_n37_), .O(new_n60_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n70_));
  ...
  nand3  g46(.a(new_n30_), .b(x15), .c(x14), .O(new_n75_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n34_), .c(new_n29_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x16), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  inv1   g55(.a(new_n83_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n58_), .c(new_n79_), .O(new_n85_));
  ...
  nor2   g63(.a(new_n30_), .b(new_n65_), .O(new_n92_));
