...
module FAU ( 
  ...
  nand2  g11(.a(x14), .b(x10), .O(new_n40_));
  ...
  nand2  g16(.a(new_n40_), .b(x08), .O(new_n45_));
  ...
  nand2  g34(.a(new_n46_), .b(x04), .O(new_n63_));
  ...
  nand4  g43(.a(new_n71_), .b(x15), .c(x13), .d(x12), .O(new_n72_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n33_), .c(new_n71_), .O(new_n77_));
  ...
  nand2  g52(.a(x17), .b(new_n71_), .O(new_n81_));
  ...
  nand2  g57(.a(new_n76_), .b(new_n33_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(x17), .c(new_n29_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(x09), .c(new_n31_), .O(new_n89_));
  aoi22  g61(.a(x14), .b(x10), .c(x08), .d(x06), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  nand2  g63(.a(new_n46_), .b(x07), .O(new_n92_));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n57_), .c(x18), .O(new_n94_));
  nor2   g66(.a(x18), .b(new_n82_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n65_), .c(x16), .d(x15), .O(new_n96_));
