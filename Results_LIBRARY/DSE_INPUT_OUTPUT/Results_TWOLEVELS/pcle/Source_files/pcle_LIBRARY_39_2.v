...
module FAU ( 
  ...
  nand2  g31(.a(new_n41_), .b(x03), .O(new_n60_));
  ...
  nand4  g36(.a(new_n64_), .b(x09), .c(new_n39_), .d(new_n29_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n60_), .O(z4));
  aoi21  g38(.a(x13), .b(x12), .c(x07), .O(new_n67_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n39_), .c(x07), .O(new_n72_));
  ...
  oai21  g53(.a(new_n81_), .b(x07), .c(new_n75_), .O(z6));
  ...
  nand4  g60(.a(new_n88_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x07), .c(new_n83_), .O(z7));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n31_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n78_), .b(new_n34_), .O(new_n93_));
  nor2   g65(.a(new_n33_), .b(new_n55_), .O(new_n94_));
  nor2   g66(.a(x18), .b(new_n86_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n62_), .O(new_n96_));
