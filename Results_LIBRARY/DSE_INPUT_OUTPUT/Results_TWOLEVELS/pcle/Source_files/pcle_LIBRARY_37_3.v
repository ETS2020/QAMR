...
module FAU ( 
  ...
  nand4  g31(.a(new_n34_), .b(x13), .c(x12), .d(x11), .O(new_n60_));
  ...
  nand2  g35(.a(x15), .b(new_n43_), .O(new_n64_));
  nand4  g36(.a(new_n35_), .b(x14), .c(x13), .d(x11), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n30_), .O(new_n66_));
  nand3  g38(.a(x14), .b(x13), .c(x12), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x15), .c(new_n29_), .O(new_n68_));
  inv1   g40(.a(new_n68_), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n66_), .c(x09), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n40_), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(x08), .c(new_n71_), .O(z5));
  nand2  g44(.a(x16), .b(new_n43_), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(x15), .c(x14), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n32_), .c(new_n73_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x12), .O(new_n77_));
  nor2   g49(.a(new_n35_), .b(new_n34_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x13), .c(x12), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x16), .c(new_n29_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x09), .c(new_n31_), .O(new_n82_));
  aoi21  g54(.a(x08), .b(x05), .c(new_n40_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n82_), .O(z6));
  nand2  g56(.a(new_n41_), .b(x06), .O(new_n85_));
  ...
  nor2   g69(.a(new_n74_), .b(new_n35_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(x17), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n96_), .c(new_n95_), .O(new_n100_));
