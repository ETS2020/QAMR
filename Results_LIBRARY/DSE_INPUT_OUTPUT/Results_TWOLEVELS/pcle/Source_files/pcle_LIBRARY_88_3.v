...
module FAU ( 
  ...
  nand2  g22(.a(new_n38_), .b(x08), .O(new_n51_));
  ...
  nand2  g38(.a(x15), .b(new_n40_), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(x14), .c(x13), .d(x11), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n67_), .c(new_n43_), .O(new_n70_));
  nand3  g42(.a(x14), .b(x13), .c(x12), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(x15), .c(new_n31_), .O(new_n72_));
  inv1   g44(.a(new_n72_), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n70_), .c(x09), .O(new_n74_));
  aoi21  g46(.a(x08), .b(x04), .c(new_n47_), .O(new_n75_));
  ...
  oai21  g55(.a(new_n51_), .b(new_n77_), .c(new_n83_), .O(z6));
  inv1   g56(.a(x17), .O(new_n85_));
  nand3  g57(.a(x14), .b(x13), .c(x11), .O(new_n86_));
  nand3  g58(.a(new_n85_), .b(x16), .c(x15), .O(new_n87_));
  oai22  g59(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(x11), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(x12), .O(new_n89_));
  nor2   g61(.a(new_n54_), .b(new_n43_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(x17), .c(new_n31_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(x09), .c(new_n30_), .O(new_n94_));
  aoi21  g66(.a(x08), .b(x06), .c(new_n47_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n94_), .O(z7));
  nand2  g68(.a(x18), .b(new_n40_), .O(new_n97_));
  nand4  g69(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(new_n86_), .c(new_n97_), .O(new_n99_));
  nand2  g71(.a(new_n99_), .b(x12), .O(new_n100_));
  inv1   g72(.a(new_n71_), .O(new_n101_));
  nand4  g73(.a(new_n101_), .b(x17), .c(x16), .d(x15), .O(new_n102_));
  nand3  g74(.a(new_n102_), .b(x18), .c(new_n31_), .O(new_n103_));
  nand2  g75(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  nand3  g76(.a(new_n104_), .b(x09), .c(new_n30_), .O(new_n105_));
  aoi21  g77(.a(x08), .b(x07), .c(new_n47_), .O(new_n106_));
