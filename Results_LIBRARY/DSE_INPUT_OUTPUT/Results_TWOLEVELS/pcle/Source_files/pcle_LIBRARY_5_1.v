...
module FAU ( 
  ...
  aoi21  g12(.a(x15), .b(new_n40_), .c(new_n30_), .O(new_n41_));
  ...
  aoi21  g35(.a(new_n62_), .b(x09), .c(new_n63_), .O(new_n64_));
  nand3  g36(.a(x12), .b(x11), .c(x09), .O(new_n65_));
  nand3  g37(.a(new_n29_), .b(x14), .c(x13), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n29_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n31_), .c(new_n30_), .O(new_n68_));
  aoi22  g40(.a(x15), .b(new_n40_), .c(x08), .d(x04), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  nand2  g42(.a(new_n41_), .b(x05), .O(new_n71_));
  ...
  nand2  g50(.a(new_n41_), .b(x06), .O(new_n79_));
  ...
  nand2  g68(.a(new_n96_), .b(new_n87_), .O(z8));
endmodule
