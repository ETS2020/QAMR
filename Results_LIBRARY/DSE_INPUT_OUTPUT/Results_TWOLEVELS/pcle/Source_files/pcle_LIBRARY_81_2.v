...
module FAU ( 
  ...
  nand3  g24(.a(new_n52_), .b(new_n39_), .c(x09), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n47_), .O(z3));
  oai21  g26(.a(new_n39_), .b(x03), .c(x08), .O(new_n55_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n39_), .c(x09), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n55_), .O(z4));
  oai21  g34(.a(new_n39_), .b(x04), .c(x08), .O(new_n63_));
  ...
  nand3  g52(.a(new_n32_), .b(new_n33_), .c(x16), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n57_), .c(new_n80_), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n83_));
  nand3  g55(.a(x10), .b(x08), .c(x06), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n83_), .O(z7));
  oai21  g57(.a(new_n39_), .b(x07), .c(x08), .O(new_n86_));
  nand2  g58(.a(new_n74_), .b(new_n29_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n58_), .c(new_n32_), .d(x17), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(x18), .O(new_n89_));
  nor2   g61(.a(new_n74_), .b(new_n64_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n66_), .c(new_n34_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n39_), .c(x09), .O(new_n93_));
