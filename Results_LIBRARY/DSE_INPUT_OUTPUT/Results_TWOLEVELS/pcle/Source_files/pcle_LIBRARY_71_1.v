...
module FAU ( 
  ...
  nand3  g30(.a(new_n47_), .b(new_n56_), .c(x13), .O(new_n59_));
  ...
  nand2  g43(.a(new_n56_), .b(new_n31_), .O(new_n72_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n58_), .c(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n74_), .c(new_n46_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x10), .c(new_n30_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  and2   g52(.a(x16), .b(x15), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n72_), .c(new_n58_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nor2   g56(.a(new_n66_), .b(new_n56_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n58_), .c(new_n84_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n83_), .c(new_n46_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x10), .c(new_n30_), .O(new_n88_));
  ...
  nand3  g64(.a(new_n81_), .b(new_n29_), .c(x17), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n64_), .c(new_n92_), .O(new_n94_));
