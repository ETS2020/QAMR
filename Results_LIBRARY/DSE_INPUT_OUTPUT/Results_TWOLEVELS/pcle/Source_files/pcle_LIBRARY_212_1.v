...
module FAU ( 
  ...
  aoi21  g32(.a(x08), .b(x03), .c(new_n44_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(z4));
  nand2  g34(.a(new_n47_), .b(x04), .O(new_n63_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n69_));
  ...
  aoi21  g47(.a(x08), .b(x05), .c(new_n44_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  nand2  g49(.a(new_n47_), .b(x06), .O(new_n78_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n84_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n93_));
