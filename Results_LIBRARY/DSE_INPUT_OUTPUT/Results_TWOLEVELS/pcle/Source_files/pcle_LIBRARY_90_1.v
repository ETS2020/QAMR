...
module FAU ( 
  ...
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n51_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n67_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n92_));
