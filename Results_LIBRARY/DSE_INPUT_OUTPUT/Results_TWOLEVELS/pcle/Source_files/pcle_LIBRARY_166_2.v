...
module FAU ( 
  ...
  oai21  g18(.a(new_n36_), .b(x02), .c(x08), .O(new_n47_));
  ...
  nand3  g24(.a(new_n52_), .b(new_n36_), .c(x09), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n47_), .O(z3));
  oai21  g26(.a(new_n36_), .b(x03), .c(x08), .O(new_n55_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n36_), .c(x09), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n55_), .O(z4));
  oai21  g34(.a(new_n36_), .b(x04), .c(x08), .O(new_n63_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n36_), .c(x09), .O(new_n69_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n36_), .c(x09), .d(new_n29_), .O(new_n76_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n36_), .c(x09), .d(new_n29_), .O(new_n84_));
  nand2  g56(.a(new_n44_), .b(x06), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n84_), .O(z7));
  oai21  g58(.a(new_n36_), .b(x07), .c(x08), .O(new_n87_));
  ...
  nand3  g63(.a(new_n91_), .b(new_n89_), .c(new_n50_), .O(new_n92_));
  ...
  nand3  g68(.a(new_n96_), .b(new_n36_), .c(x09), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n87_), .O(z8));
endmodule
