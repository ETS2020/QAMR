...
module FAU ( 
  ...
  nand3  g23(.a(x15), .b(new_n37_), .c(new_n31_), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n36_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(x09), .O(new_n55_));
  nand2  g26(.a(x08), .b(x04), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n55_), .O(z5));
  inv1   g28(.a(x05), .O(new_n58_));
  nand3  g29(.a(x16), .b(new_n36_), .c(new_n37_), .O(new_n59_));
  oai22  g30(.a(new_n59_), .b(new_n50_), .c(new_n49_), .d(new_n58_), .O(z6));
  nand3  g31(.a(x17), .b(new_n37_), .c(new_n31_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n36_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(x09), .O(new_n63_));
  nand2  g34(.a(x08), .b(x06), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n63_), .O(z7));
  nand3  g36(.a(x18), .b(new_n37_), .c(new_n31_), .O(new_n66_));
