...
module FAU ( 
  ...
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(new_n46_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(x10), .c(new_n30_), .O(new_n53_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n58_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(new_n46_), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(x10), .c(new_n30_), .O(new_n61_));
  nand2  g33(.a(x08), .b(x03), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z4));
  nand3  g35(.a(new_n47_), .b(x14), .c(x13), .O(new_n64_));
  ...
  nand2  g43(.a(new_n58_), .b(new_n31_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n47_), .c(x15), .d(x13), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x16), .O(new_n74_));
  inv1   g46(.a(new_n56_), .O(new_n75_));
  nor2   g47(.a(x16), .b(new_n66_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n75_), .c(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n74_), .c(new_n46_), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(x10), .c(new_n30_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z6));
  and2   g53(.a(x16), .b(x15), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n72_), .c(new_n75_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nor2   g57(.a(new_n66_), .b(new_n58_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n75_), .c(new_n85_), .d(x16), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(new_n46_), .O(new_n88_));
  ...
  nand3  g65(.a(new_n82_), .b(new_n29_), .c(x17), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n64_), .c(new_n93_), .O(new_n95_));
